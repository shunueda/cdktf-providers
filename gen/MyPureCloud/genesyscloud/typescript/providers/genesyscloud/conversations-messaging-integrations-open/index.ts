// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_open
...
export interface ConversationsMessagingIntegrationsOpenConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_open#id ConversationsMessagingIntegrationsOpen#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_open#messaging_setting_id ConversationsMessagingIntegrationsOpen#messaging_setting_id}
  */
  readonly messagingSettingId?: string;
  /**
  * The name of the Open messaging integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_open#name ConversationsMessagingIntegrationsOpen#name}
  */
  readonly name: string;
  /**
  * The outbound notification webhook signature secret token. This token must be longer than 15 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_open#outbound_notification_webhook_signature_secret_token ConversationsMessagingIntegrationsOpen#outbound_notification_webhook_signature_secret_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_open#outbound_notification_webhook_url ConversationsMessagingIntegrationsOpen#outbound_notification_webhook_url}
  */
  readonly outboundNotificationWebhookUrl: string;
  /**
  * Reference to supported content profile associated with the integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_open#supported_content_id ConversationsMessagingIntegrationsOpen#supported_content_id}
  */
  readonly supportedContentId?: string;
  /**
  * The user specified headers for the Open messaging integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_open#webhook_headers ConversationsMessagingIntegrationsOpen#webhook_headers}
  */
  readonly webhookHeaders?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_open genesyscloud_conversations_messaging_integrations_open}
*/
export class ConversationsMessagingIntegrationsOpen extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_open genesyscloud_conversations_messaging_integrations_open} Resource
  *
  * @param scope The scope in which to define this construct
