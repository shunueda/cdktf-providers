// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/architect_ivr
...
export interface ArchitectIvrConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/architect_ivr#closed_hours_flow_id ArchitectIvr#closed_hours_flow_id}
  */
  readonly closedHoursFlowId?: string;
  /**
  * IVR Config description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/architect_ivr#description ArchitectIvr#description}
  */
  readonly description?: string;
  /**
  * Division ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/architect_ivr#division_id ArchitectIvr#division_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/architect_ivr#dnis ArchitectIvr#dnis}
  */
  readonly dnis?: string[];
  /**
  * ID of inbound call flow for holidays.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/architect_ivr#holiday_hours_flow_id ArchitectIvr#holiday_hours_flow_id}
  */
  readonly holidayHoursFlowId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/architect_ivr#id ArchitectIvr#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/architect_ivr#name ArchitectIvr#name}
  */
  readonly name: string;
  /**
  * ID of inbound call flow for open hours.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/architect_ivr#open_hours_flow_id ArchitectIvr#open_hours_flow_id}
  */
  readonly openHoursFlowId?: string;
  /**
  * Schedule group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/architect_ivr#schedule_group_id ArchitectIvr#schedule_group_id}
  */
  readonly scheduleGroupId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/architect_ivr genesyscloud_architect_ivr}
*/
export class ArchitectIvr extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ArchitectIvr that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/architect_ivr#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/architect_ivr genesyscloud_architect_ivr} Resource
  *
  * @param scope The scope in which to define this construct
