// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/telephony_providers_edges_trunk
...
export interface TelephonyProvidersEdgesTrunkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/telephony_providers_edges_trunk#edge_group_id TelephonyProvidersEdgesTrunk#edge_group_id}
  */
  readonly edgeGroupId?: string;
  /**
  * The edge associated with this trunk. Either this or "edge_group_id" must be set
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/telephony_providers_edges_trunk#edge_id TelephonyProvidersEdgesTrunk#edge_id}
  */
  readonly edgeId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/telephony_providers_edges_trunk#id TelephonyProvidersEdgesTrunk#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/telephony_providers_edges_trunk#name TelephonyProvidersEdgesTrunk#name}
  */
  readonly name?: string;
  /**
  * The trunk base settings reference
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/telephony_providers_edges_trunk#trunk_base_settings_id TelephonyProvidersEdgesTrunk#trunk_base_settings_id}
  */
  readonly trunkBaseSettingsId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/telephony_providers_edges_trunk genesyscloud_telephony_providers_edges_trunk}
*/
export class TelephonyProvidersEdgesTrunk extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/telephony_providers_edges_trunk genesyscloud_telephony_providers_edges_trunk} Resource
  *
  * @param scope The scope in which to define this construct
