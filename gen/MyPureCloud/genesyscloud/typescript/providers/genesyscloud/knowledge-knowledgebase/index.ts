// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/knowledge_knowledgebase
...
export interface KnowledgeKnowledgebaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/knowledge_knowledgebase#core_language KnowledgeKnowledgebase#core_language}
  */
  readonly coreLanguage: string;
  /**
  * Knowledge base description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/knowledge_knowledgebase#description KnowledgeKnowledgebase#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/knowledge_knowledgebase#id KnowledgeKnowledgebase#id}
  *
  ...
  * Knowledge base name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/knowledge_knowledgebase#name KnowledgeKnowledgebase#name}
  */
  readonly name?: string;
  /**
  * Flag that indicates the knowledge base is published
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/knowledge_knowledgebase#published KnowledgeKnowledgebase#published}
  */
  readonly published?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/knowledge_knowledgebase genesyscloud_knowledge_knowledgebase}
*/
export class KnowledgeKnowledgebase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KnowledgeKnowledgebase that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/knowledge_knowledgebase#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/knowledge_knowledgebase genesyscloud_knowledge_knowledgebase} Resource
  *
  * @param scope The scope in which to define this construct
