// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/webdeployments_deployment
...
export interface WebdeploymentsDeploymentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/webdeployments_deployment#allow_all_domains WebdeploymentsDeployment#allow_all_domains}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/webdeployments_deployment#allowed_domains WebdeploymentsDeployment#allowed_domains}
  */
  readonly allowedDomains?: string[];
  /**
  * Deployment description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/webdeployments_deployment#description WebdeploymentsDeployment#description}
  */
  readonly description?: string;
  /**
  * A reference to the inboundshortmessage flow used by this deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/webdeployments_deployment#flow_id WebdeploymentsDeployment#flow_id}
  */
  readonly flowId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/webdeployments_deployment#id WebdeploymentsDeployment#id}
  *
  ...
  * Deployment name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/webdeployments_deployment#name WebdeploymentsDeployment#name}
  */
  readonly name: string;
  /**
  * The current status of the deployment. Valid values: Pending, Active, Inactive, Error, Deleting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/webdeployments_deployment#status WebdeploymentsDeployment#status}
  */
  readonly status?: string;
  /**
  * configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/webdeployments_deployment#configuration WebdeploymentsDeployment#configuration}
  */
...
export interface WebdeploymentsDeploymentConfiguration {
  ...
  */
  readonly id: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/webdeployments_deployment#version WebdeploymentsDeployment#version}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/webdeployments_deployment genesyscloud_webdeployments_deployment}
*/
export class WebdeploymentsDeployment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebdeploymentsDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/webdeployments_deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/webdeployments_deployment genesyscloud_webdeployments_deployment} Resource
  *
  * @param scope The scope in which to define this construct
