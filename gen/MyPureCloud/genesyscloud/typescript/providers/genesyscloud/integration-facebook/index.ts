// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook
...
export interface IntegrationFacebookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook#app_id IntegrationFacebook#app_id}
  */
  readonly appId?: string;
  /**
  * The app Secret of Facebook app. The appSecret is required when appId is provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook#app_secret IntegrationFacebook#app_secret}
  */
  readonly appSecret?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook#id IntegrationFacebook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook#messaging_setting_id IntegrationFacebook#messaging_setting_id}
  */
  readonly messagingSettingId?: string;
  /**
  * The name of the Facebook Integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook#name IntegrationFacebook#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook#page_access_token IntegrationFacebook#page_access_token}
  */
  readonly pageAccessToken?: string;
  /**
  * The page Id of Facebook page. The pageId is required when userAccessToken is provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook#page_id IntegrationFacebook#page_id}
  */
  readonly pageId?: string;
  /**
  * The SupportedContent unique identifier associated with this integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook#supported_content_id IntegrationFacebook#supported_content_id}
  */
  ...
  * 			Either pageAccessToken or userAccessToken should be provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook#user_access_token IntegrationFacebook#user_access_token}
  */
  readonly userAccessToken?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook#timeouts IntegrationFacebook#timeouts}
  */
  readonly timeouts?: IntegrationFacebookTimeouts;
}
export interface IntegrationFacebookTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook#read IntegrationFacebook#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook#update IntegrationFacebook#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook genesyscloud_integration_facebook}
*/
export class IntegrationFacebook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationFacebook that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/integration_facebook genesyscloud_integration_facebook} Resource
  *
  * @param scope The scope in which to define this construct
