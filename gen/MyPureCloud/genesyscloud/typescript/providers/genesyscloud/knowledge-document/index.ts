// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document
...
export interface KnowledgeDocumentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document#id KnowledgeDocument#id}
  *
  ...
  * Knowledge base id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document#knowledge_base_id KnowledgeDocument#knowledge_base_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document#published KnowledgeDocument#published}
  */
  readonly published?: boolean | cdktf.IResolvable;
  /**
  * knowledge_document block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document#knowledge_document KnowledgeDocument#knowledge_document}
  */
...
export interface KnowledgeDocumentKnowledgeDocumentAlternatives {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document#autocomplete KnowledgeDocument#autocomplete}
  */
  readonly autocomplete?: boolean | cdktf.IResolvable;
  /**
  * Alternate phrasing to the document title.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document#phrase KnowledgeDocument#phrase}
  */
...
export interface KnowledgeDocumentKnowledgeDocument {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document#category_name KnowledgeDocument#category_name}
  */
  readonly categoryName?: string;
  /**
  * The names of labels associated with the document.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document#label_names KnowledgeDocument#label_names}
  */
  readonly labelNames?: string[];
  /**
  * Document title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document#title KnowledgeDocument#title}
  */
  readonly title: string;
  /**
  * Indicates if the knowledge document should be included in search results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document#visible KnowledgeDocument#visible}
  */
  readonly visible: boolean | cdktf.IResolvable;
  /**
  * alternatives block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document#alternatives KnowledgeDocument#alternatives}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document genesyscloud_knowledge_document}
*/
export class KnowledgeDocument extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KnowledgeDocument that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/knowledge_document genesyscloud_knowledge_document} Resource
  *
  * @param scope The scope in which to define this construct
