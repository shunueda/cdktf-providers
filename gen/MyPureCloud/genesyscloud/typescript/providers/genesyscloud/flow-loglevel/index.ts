// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/flow_loglevel
...
export interface FlowLoglevelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/flow_loglevel#flow_id FlowLoglevel#flow_id}
  */
  readonly flowId: string;
  /**
  * The logLevel for this characteristics set
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/flow_loglevel#flow_log_level FlowLoglevel#flow_log_level}
  */
  readonly flowLogLevel: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/flow_loglevel#id FlowLoglevel#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/flow_loglevel genesyscloud_flow_loglevel}
*/
export class FlowLoglevel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FlowLoglevel that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/flow_loglevel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/flow_loglevel genesyscloud_flow_loglevel} Resource
  *
  * @param scope The scope in which to define this construct
