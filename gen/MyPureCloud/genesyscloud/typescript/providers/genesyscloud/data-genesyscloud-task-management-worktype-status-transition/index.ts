// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/data-sources/task_management_worktype_status_transition
...
export interface DataGenesyscloudTaskManagementWorktypeStatusTransitionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/data-sources/task_management_worktype_status_transition#id DataGenesyscloudTaskManagementWorktypeStatusTransition#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/data-sources/task_management_worktype_status_transition#name DataGenesyscloudTaskManagementWorktypeStatusTransition#name}
  */
  readonly name: string;
  /**
  * The id of the worktype the status belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/data-sources/task_management_worktype_status_transition#worktype_id DataGenesyscloudTaskManagementWorktypeStatusTransition#worktype_id}
  */
  readonly worktypeId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/data-sources/task_management_worktype_status_transition genesyscloud_task_management_worktype_status_transition}
*/
export class DataGenesyscloudTaskManagementWorktypeStatusTransition extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/data-sources/task_management_worktype_status_transition genesyscloud_task_management_worktype_status_transition} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataGenesyscloudTaskManagementWorktypeStatusTransitionConfig
  */
  public constructor(scope: Construct, id: string, config: DataGenesyscloudTaskManagementWorktypeStatusTransitionConfig) {
    super(scope, id, {
