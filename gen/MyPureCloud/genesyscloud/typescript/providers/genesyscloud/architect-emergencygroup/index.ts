// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_emergencygroup
...
export interface ArchitectEmergencygroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_emergencygroup#description ArchitectEmergencygroup#description}
  */
  readonly description?: string;
  /**
  * The division to which this emergency group will belong. If not set, the home division will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_emergencygroup#division_id ArchitectEmergencygroup#division_id}
  */
  readonly divisionId?: string;
  /**
  * The state of the emergency group. Defaults to false/inactive. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_emergencygroup#enabled ArchitectEmergencygroup#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_emergencygroup#id ArchitectEmergencygroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_emergencygroup#name ArchitectEmergencygroup#name}
  */
  readonly name: string;
  /**
  * emergency_call_flows block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_emergencygroup#emergency_call_flows ArchitectEmergencygroup#emergency_call_flows}
  */
...
export interface ArchitectEmergencygroupEmergencyCallFlows {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_emergencygroup#emergency_flow_id ArchitectEmergencygroup#emergency_flow_id}
  */
  readonly emergencyFlowId: string;
  /**
  * The IDs of the connected IVRs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_emergencygroup#ivr_ids ArchitectEmergencygroup#ivr_ids}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_emergencygroup genesyscloud_architect_emergencygroup}
*/
export class ArchitectEmergencygroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ArchitectEmergencygroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_emergencygroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_emergencygroup genesyscloud_architect_emergencygroup} Resource
  *
  * @param scope The scope in which to define this construct
