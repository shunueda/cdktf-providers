...
export class DataGenesyscloudConversationsMessagingIntegrationsApple extends cdktf.TerraformDataSource {
  ...
  * @param options DataGenesyscloudConversationsMessagingIntegrationsAppleConfig
  */
  public constructor(scope: Construct, id: string, config: DataGenesyscloudConversationsMessagingIntegrationsAppleConfig) {
    super(scope, id, {
