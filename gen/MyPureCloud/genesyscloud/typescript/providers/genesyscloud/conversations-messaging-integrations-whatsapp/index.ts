// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_whatsapp
...
export interface ConversationsMessagingIntegrationsWhatsappConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_whatsapp#embedded_signup_access_token ConversationsMessagingIntegrationsWhatsapp#embedded_signup_access_token}
  */
  readonly embeddedSignupAccessToken: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_whatsapp#id ConversationsMessagingIntegrationsWhatsapp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_whatsapp#messaging_setting_id ConversationsMessagingIntegrationsWhatsapp#messaging_setting_id}
  */
  readonly messagingSettingId?: string;
  /**
  * The name of the WhatsApp Integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_whatsapp#name ConversationsMessagingIntegrationsWhatsapp#name}
  */
  readonly name: string;
  /**
  * Reference to supported content profile associated with the integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_whatsapp#supported_content_id ConversationsMessagingIntegrationsWhatsapp#supported_content_id}
  */
  readonly supportedContentId?: string;
  /**
  * activate_whatsapp block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_whatsapp#activate_whatsapp ConversationsMessagingIntegrationsWhatsapp#activate_whatsapp}
  */
...
export interface ConversationsMessagingIntegrationsWhatsappActivateWhatsapp {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_whatsapp#phone_number ConversationsMessagingIntegrationsWhatsapp#phone_number}
  */
  readonly phoneNumber: string;
  /**
  * Specify the two-step verification PIN for that phone number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_whatsapp#pin ConversationsMessagingIntegrationsWhatsapp#pin}
  */
  readonly pin: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_whatsapp genesyscloud_conversations_messaging_integrations_whatsapp}
*/
export class ConversationsMessagingIntegrationsWhatsapp extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/conversations_messaging_integrations_whatsapp genesyscloud_conversations_messaging_integrations_whatsapp} Resource
  *
  * @param scope The scope in which to define this construct
