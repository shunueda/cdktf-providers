// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/script
...
export interface ScriptConfig extends cdktf.TerraformMetaArguments {
  ...
  * Specify division id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/script#division_id Script#division_id}
  */
  readonly divisionId?: string;
  /**
  * Hash value of the script file content. Used to detect changes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/script#file_content_hash Script#file_content_hash}
  */
  readonly fileContentHash?: string;
  /**
  * Path to the script file to upload.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/script#filepath Script#filepath}
  */
  readonly filepath: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/script#id Script#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/script#script_name Script#script_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/script#substitutions Script#substitutions}
  */
  readonly substitutions?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/script genesyscloud_script}
*/
export class Script extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Script that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/script#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/script genesyscloud_script} Resource
  *
  * @param scope The scope in which to define this construct
