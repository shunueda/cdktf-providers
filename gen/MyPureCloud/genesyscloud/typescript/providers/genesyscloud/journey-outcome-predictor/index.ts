// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/journey_outcome_predictor
...
export interface JourneyOutcomePredictorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/journey_outcome_predictor#id JourneyOutcomePredictor#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/journey_outcome_predictor#outcome_id JourneyOutcomePredictor#outcome_id}
  */
  readonly outcomeId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/journey_outcome_predictor genesyscloud_journey_outcome_predictor}
*/
export class JourneyOutcomePredictor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing JourneyOutcomePredictor that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/journey_outcome_predictor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/journey_outcome_predictor genesyscloud_journey_outcome_predictor} Resource
  *
  * @param scope The scope in which to define this construct
