// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/data-sources/task_management_worktype_flow_datebased_rule
...
export interface DataGenesyscloudTaskManagementWorktypeFlowDatebasedRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/data-sources/task_management_worktype_flow_datebased_rule#id DataGenesyscloudTaskManagementWorktypeFlowDatebasedRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/data-sources/task_management_worktype_flow_datebased_rule#name DataGenesyscloudTaskManagementWorktypeFlowDatebasedRule#name}
  */
  readonly name: string;
  /**
  * The Worktype ID of the Rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/data-sources/task_management_worktype_flow_datebased_rule#worktype_id DataGenesyscloudTaskManagementWorktypeFlowDatebasedRule#worktype_id}
  */
  readonly worktypeId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/data-sources/task_management_worktype_flow_datebased_rule genesyscloud_task_management_worktype_flow_datebased_rule}
*/
export class DataGenesyscloudTaskManagementWorktypeFlowDatebasedRule extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/data-sources/task_management_worktype_flow_datebased_rule genesyscloud_task_management_worktype_flow_datebased_rule} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataGenesyscloudTaskManagementWorktypeFlowDatebasedRuleConfig
  */
  public constructor(scope: Construct, id: string, config: DataGenesyscloudTaskManagementWorktypeFlowDatebasedRuleConfig) {
    super(scope, id, {
