// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/journey_view_schedule
...
export interface JourneyViewScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/journey_view_schedule#frequency JourneyViewSchedule#frequency}
  */
  readonly frequency: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/journey_view_schedule#id JourneyViewSchedule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/journey_view_schedule#journey_view_id JourneyViewSchedule#journey_view_id}
  */
  readonly journeyViewId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/journey_view_schedule genesyscloud_journey_view_schedule}
*/
export class JourneyViewSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing JourneyViewSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/journey_view_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/journey_view_schedule genesyscloud_journey_view_schedule} Resource
  *
  * @param scope The scope in which to define this construct
