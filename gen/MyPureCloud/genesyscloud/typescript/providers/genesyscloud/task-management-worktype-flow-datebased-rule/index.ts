// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_datebased_rule
...
export interface TaskManagementWorktypeFlowDatebasedRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_datebased_rule#id TaskManagementWorktypeFlowDatebasedRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_datebased_rule#name TaskManagementWorktypeFlowDatebasedRule#name}
  */
  readonly name: string;
  /**
  * The Worktype ID of the Rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_datebased_rule#worktype_id TaskManagementWorktypeFlowDatebasedRule#worktype_id}
  */
  readonly worktypeId: string;
  /**
  * condition block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_datebased_rule#condition TaskManagementWorktypeFlowDatebasedRule#condition}
  */
...
export interface TaskManagementWorktypeFlowDatebasedRuleCondition {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_datebased_rule#attribute TaskManagementWorktypeFlowDatebasedRule#attribute}
  */
  readonly attribute: string;
  /**
  * The time in minutes before or after the date attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_datebased_rule#relative_minutes_to_invocation TaskManagementWorktypeFlowDatebasedRule#relative_minutes_to_invocation}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_datebased_rule genesyscloud_task_management_worktype_flow_datebased_rule}
*/
export class TaskManagementWorktypeFlowDatebasedRule extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_datebased_rule genesyscloud_task_management_worktype_flow_datebased_rule} Resource
  *
  * @param scope The scope in which to define this construct
