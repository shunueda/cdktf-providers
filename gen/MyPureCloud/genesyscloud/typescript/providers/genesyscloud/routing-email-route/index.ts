// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route
...
export interface RoutingEmailRouteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#allow_multiple_actions RoutingEmailRoute#allow_multiple_actions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#domain_id RoutingEmailRoute#domain_id}
  */
  readonly domainId: string;
  /**
  * The flow to use for processing the email. This should not be set if a queue_id is specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#flow_id RoutingEmailRoute#flow_id}
  */
  readonly flowId?: string;
  /**
  * The sender email to use for outgoing replies. This should not be set if reply_email_address is specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#from_email RoutingEmailRoute#from_email}
  */
  readonly fromEmail?: string;
  /**
  * The sender name to use for outgoing replies.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#from_name RoutingEmailRoute#from_name}
  */
  readonly fromName: string;
  /**
  * The configuration to indicate how the history of a conversation has to be included in a draft. Defaults to `Optional`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#history_inclusion RoutingEmailRoute#history_inclusion}
  */
  readonly historyInclusion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#id RoutingEmailRoute#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#language_id RoutingEmailRoute#language_id}
  */
  readonly languageId?: string;
  /**
  * The search pattern that the mailbox name should match.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#pattern RoutingEmailRoute#pattern}
  */
  readonly pattern: string;
  /**
  * The priority to use for routing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#priority RoutingEmailRoute#priority}
  */
  readonly priority?: number;
  /**
  * The queue to route the emails to. This should not be set if a flow_id is specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#queue_id RoutingEmailRoute#queue_id}
  */
  readonly queueId?: string;
  /**
  * The skills to use for routing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#skill_ids RoutingEmailRoute#skill_ids}
  */
  readonly skillIds?: string[];
  /**
  * The flow to use for processing inbound emails that have been marked as spam.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#spam_flow_id RoutingEmailRoute#spam_flow_id}
  */
  readonly spamFlowId?: string;
  /**
  * auto_bcc block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#auto_bcc RoutingEmailRoute#auto_bcc}
  */
  readonly autoBcc?: RoutingEmailRouteAutoBcc[] | cdktf.IResolvable;
  /**
  * reply_email_address block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#reply_email_address RoutingEmailRoute#reply_email_address}
  */
...
export interface RoutingEmailRouteAutoBcc {
  ...
  * Email address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#email RoutingEmailRoute#email}
  */
  readonly email: string;
  /**
  * Name associated with the email.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#name RoutingEmailRoute#name}
  */
...
export interface RoutingEmailRouteReplyEmailAddress {
  ...
  * ID of the route.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#route_id RoutingEmailRoute#route_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#self_reference_route RoutingEmailRoute#self_reference_route}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route genesyscloud_routing_email_route}
*/
export class RoutingEmailRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoutingEmailRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/routing_email_route genesyscloud_routing_email_route} Resource
  *
  * @param scope The scope in which to define this construct
