// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/architect_schedules
...
export interface ArchitectSchedulesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/architect_schedules#description ArchitectSchedules#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/architect_schedules#division_id ArchitectSchedules#division_id}
  */
  readonly divisionId?: string;
  /**
  * Date time is represented as an ISO-8601 string without a timezone. For example: 2006-01-02T15:04:05.000000.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/architect_schedules#end ArchitectSchedules#end}
  */
  readonly end: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/architect_schedules#id ArchitectSchedules#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/architect_schedules#name ArchitectSchedules#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/architect_schedules#rrule ArchitectSchedules#rrule}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/architect_schedules#start ArchitectSchedules#start}
  */
  readonly start: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/architect_schedules genesyscloud_architect_schedules}
*/
export class ArchitectSchedules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ArchitectSchedules that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/architect_schedules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/architect_schedules genesyscloud_architect_schedules} Resource
  *
  * @param scope The scope in which to define this construct
