// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/data-sources/task_management_worktype_status
...
export interface DataGenesyscloudTaskManagementWorktypeStatusConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/data-sources/task_management_worktype_status#id DataGenesyscloudTaskManagementWorktypeStatus#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/data-sources/task_management_worktype_status#name DataGenesyscloudTaskManagementWorktypeStatus#name}
  */
  readonly name: string;
  /**
  * The id of the worktype the status belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/data-sources/task_management_worktype_status#worktype_id DataGenesyscloudTaskManagementWorktypeStatus#worktype_id}
  */
  readonly worktypeId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/data-sources/task_management_worktype_status genesyscloud_task_management_worktype_status}
*/
export class DataGenesyscloudTaskManagementWorktypeStatus extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/data-sources/task_management_worktype_status genesyscloud_task_management_worktype_status} Data Source
  *
  * @param scope The scope in which to define this construct
