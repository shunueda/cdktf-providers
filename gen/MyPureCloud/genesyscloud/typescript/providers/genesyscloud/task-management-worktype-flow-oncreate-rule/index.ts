// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_oncreate_rule
...
export interface TaskManagementWorktypeFlowOncreateRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_oncreate_rule#id TaskManagementWorktypeFlowOncreateRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_oncreate_rule#name TaskManagementWorktypeFlowOncreateRule#name}
  */
  readonly name: string;
  /**
  * The Worktype ID of the Rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_oncreate_rule#worktype_id TaskManagementWorktypeFlowOncreateRule#worktype_id}
  */
  readonly worktypeId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_oncreate_rule genesyscloud_task_management_worktype_flow_oncreate_rule}
*/
export class TaskManagementWorktypeFlowOncreateRule extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/task_management_worktype_flow_oncreate_rule genesyscloud_task_management_worktype_flow_oncreate_rule} Resource
  *
  * @param scope The scope in which to define this construct
