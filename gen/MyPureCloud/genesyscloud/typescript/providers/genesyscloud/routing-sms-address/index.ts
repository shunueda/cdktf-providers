// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/routing_sms_address
...
export interface RoutingSmsAddressConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/routing_sms_address#auto_correct_address RoutingSmsAddress#auto_correct_address}
  */
  readonly autoCorrectAddress?: boolean | cdktf.IResolvable;
  /**
  * The city in which this address is in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/routing_sms_address#city RoutingSmsAddress#city}
  */
  readonly city: string;
  /**
  * The ISO country code of this address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/routing_sms_address#country_code RoutingSmsAddress#country_code}
  */
  readonly countryCode: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/routing_sms_address#id RoutingSmsAddress#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/routing_sms_address#name RoutingSmsAddress#name}
  */
  readonly name?: string;
  /**
  * The postal code this address is in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/routing_sms_address#postal_code RoutingSmsAddress#postal_code}
  */
  readonly postalCode: string;
  /**
  * The state or region this address is in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/routing_sms_address#region RoutingSmsAddress#region}
  */
  readonly region: string;
  /**
  * The number and street address where this address is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/routing_sms_address#street RoutingSmsAddress#street}
  */
  readonly street: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/routing_sms_address genesyscloud_routing_sms_address}
*/
export class RoutingSmsAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoutingSmsAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/routing_sms_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/routing_sms_address genesyscloud_routing_sms_address} Resource
  *
  * @param scope The scope in which to define this construct
