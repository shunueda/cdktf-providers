// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_datatable_row
...
export interface ArchitectDatatableRowConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_datatable_row#datatable_id ArchitectDatatableRow#datatable_id}
  */
  readonly datatableId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_datatable_row#id ArchitectDatatableRow#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_datatable_row#key_value ArchitectDatatableRow#key_value}
  */
  readonly keyValue: string;
  /**
  * JSON object containing properties and values for this row. Defaults will be set for missing properties.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_datatable_row#properties_json ArchitectDatatableRow#properties_json}
  */
  readonly propertiesJson?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_datatable_row genesyscloud_architect_datatable_row}
*/
export class ArchitectDatatableRow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ArchitectDatatableRow that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_datatable_row#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/architect_datatable_row genesyscloud_architect_datatable_row} Resource
  *
  * @param scope The scope in which to define this construct
