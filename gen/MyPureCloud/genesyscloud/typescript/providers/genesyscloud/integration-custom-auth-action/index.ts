// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action
...
export interface IntegrationCustomAuthActionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action#id IntegrationCustomAuthAction#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action#integration_id IntegrationCustomAuthAction#integration_id}
  */
  readonly integrationId: string;
  /**
  * Name of the action to override the default name. Can be up to 256 characters long
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action#name IntegrationCustomAuthAction#name}
  */
  readonly name?: string;
  /**
  * config_request block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action#config_request IntegrationCustomAuthAction#config_request}
  */
  readonly configRequest?: IntegrationCustomAuthActionConfigRequest;
  /**
  * config_response block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action#config_response IntegrationCustomAuthAction#config_response}
  */
...
export interface IntegrationCustomAuthActionConfigRequest {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action#headers IntegrationCustomAuthAction#headers}
  */
  readonly headers?: { [key: string]: string };
  /**
  * Velocity template to define request body sent to 3rd party service. Any instances of '${' must be properly escaped as '$${'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action#request_template IntegrationCustomAuthAction#request_template}
  */
  readonly requestTemplate?: string;
  /**
  * HTTP method to use for request (GET | PUT | POST | PATCH | DELETE).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action#request_type IntegrationCustomAuthAction#request_type}
  */
  readonly requestType: string;
  /**
  * URL that may include placeholders for requests to 3rd party service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action#request_url_template IntegrationCustomAuthAction#request_url_template}
  */
...
export interface IntegrationCustomAuthActionConfigResponse {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action#success_template IntegrationCustomAuthAction#success_template}
  */
  readonly successTemplate?: string;
  /**
  * Map 'attribute name' and 'JSON path' pairs used to extract data from REST response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action#translation_map IntegrationCustomAuthAction#translation_map}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action#translation_map_defaults IntegrationCustomAuthAction#translation_map_defaults}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action genesyscloud_integration_custom_auth_action}
*/
export class IntegrationCustomAuthAction extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.71.1/docs/resources/integration_custom_auth_action genesyscloud_integration_custom_auth_action} Resource
  *
  * @param scope The scope in which to define this construct
