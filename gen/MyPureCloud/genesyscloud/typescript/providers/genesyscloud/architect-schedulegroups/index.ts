// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/architect_schedulegroups
...
export interface ArchitectSchedulegroupsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/architect_schedulegroups#closed_schedules_id ArchitectSchedulegroups#closed_schedules_id}
  */
  readonly closedSchedulesId?: string[];
  /**
  * Description of the schedule group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/architect_schedulegroups#description ArchitectSchedulegroups#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/architect_schedulegroups#division_id ArchitectSchedulegroups#division_id}
  */
  readonly divisionId?: string;
  /**
  * The schedules defining the hours an organization is closed for the holidays.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/architect_schedulegroups#holiday_schedules_id ArchitectSchedulegroups#holiday_schedules_id}
  */
  readonly holidaySchedulesId?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/architect_schedulegroups#id ArchitectSchedulegroups#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/architect_schedulegroups#name ArchitectSchedulegroups#name}
  */
  readonly name: string;
  /**
  * The schedules defining the hours an organization is open.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/architect_schedulegroups#open_schedules_id ArchitectSchedulegroups#open_schedules_id}
  */
  readonly openSchedulesId: string[];
  /**
  * The timezone the schedules are a part of.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/architect_schedulegroups#time_zone ArchitectSchedulegroups#time_zone}
  */
  readonly timeZone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/architect_schedulegroups genesyscloud_architect_schedulegroups}
*/
export class ArchitectSchedulegroups extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ArchitectSchedulegroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/architect_schedulegroups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.73.0/docs/resources/architect_schedulegroups genesyscloud_architect_schedulegroups} Resource
  *
  * @param scope The scope in which to define this construct
