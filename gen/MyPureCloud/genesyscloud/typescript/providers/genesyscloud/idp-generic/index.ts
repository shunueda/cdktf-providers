// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic
...
export interface IdpGenericConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#certificates IdpGeneric#certificates}
  */
  readonly certificates: string[];
  /**
  * True if Generic provider is disabled. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#disabled IdpGeneric#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * True if the Genesys Cloud authentication request should be compressed. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#endpoint_compression IdpGeneric#endpoint_compression}
  */
  readonly endpointCompression?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#id IdpGeneric#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#issuer_uri IdpGeneric#issuer_uri}
  */
  readonly issuerUri: string;
  /**
  * Base64 encoded SVG image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#logo_image_data IdpGeneric#logo_image_data}
  */
  readonly logoImageData?: string;
  /**
  * Name of the provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#name IdpGeneric#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#name_identifier_format IdpGeneric#name_identifier_format}
  */
  readonly nameIdentifierFormat?: string;
  /**
  * String used to identify Genesys Cloud to the identity provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#relying_party_identifier IdpGeneric#relying_party_identifier}
  */
  readonly relyingPartyIdentifier?: string;
  /**
  * Valid values: HTTP Redirect, HTTP Post
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#slo_binding IdpGeneric#slo_binding}
  */
  readonly sloBinding?: string;
  /**
  * Provided on app creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#slo_uri IdpGeneric#slo_uri}
  */
  readonly sloUri?: string;
  /**
  * Target URI provided by the provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#target_uri IdpGeneric#target_uri}
  */
  readonly targetUri?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#timeouts IdpGeneric#timeouts}
  */
  readonly timeouts?: IdpGenericTimeouts;
}
export interface IdpGenericTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#read IdpGeneric#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#update IdpGeneric#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic genesyscloud_idp_generic}
*/
export class IdpGeneric extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdpGeneric that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.70.0/docs/resources/idp_generic genesyscloud_idp_generic} Resource
  *
  * @param scope The scope in which to define this construct
