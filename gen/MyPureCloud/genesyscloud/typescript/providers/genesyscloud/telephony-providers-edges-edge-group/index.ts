// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/telephony_providers_edges_edge_group
...
export interface TelephonyProvidersEdgesEdgeGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/telephony_providers_edges_edge_group#description TelephonyProvidersEdgesEdgeGroup#description}
  */
  readonly description?: string;
  /**
  * Is this edge group hybrid. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/telephony_providers_edges_edge_group#hybrid TelephonyProvidersEdgesEdgeGroup#hybrid}
  */
  readonly hybrid?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/telephony_providers_edges_edge_group#id TelephonyProvidersEdgesEdgeGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/telephony_providers_edges_edge_group#managed TelephonyProvidersEdgesEdgeGroup#managed}
  */
  readonly managed?: boolean | cdktf.IResolvable;
  /**
  * The name of the entity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/telephony_providers_edges_edge_group#name TelephonyProvidersEdgesEdgeGroup#name}
  */
  readonly name: string;
  /**
  * A list of trunk base settings IDs of trunkType "PHONE" to inherit to edge logical interface for phone communication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/telephony_providers_edges_edge_group#phone_trunk_base_ids TelephonyProvidersEdgesEdgeGroup#phone_trunk_base_ids}
  */
  readonly phoneTrunkBaseIds: string[];
  /**
  * Indicates if the resource is active, inactive, or deleted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/telephony_providers_edges_edge_group#state TelephonyProvidersEdgesEdgeGroup#state}
  */
  readonly state?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/telephony_providers_edges_edge_group genesyscloud_telephony_providers_edges_edge_group}
*/
export class TelephonyProvidersEdgesEdgeGroup extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/telephony_providers_edges_edge_group genesyscloud_telephony_providers_edges_edge_group} Resource
  *
  * @param scope The scope in which to define this construct
