// https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/externalusers_identity
...
export interface ExternalusersIdentityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/externalusers_identity#authority_name ExternalusersIdentity#authority_name}
  */
  readonly authorityName: string;
  /**
  * The identifier for the user within the Authority that owns the external identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/externalusers_identity#external_key ExternalusersIdentity#external_key}
  */
  readonly externalKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/externalusers_identity#id ExternalusersIdentity#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/externalusers_identity#user_id ExternalusersIdentity#user_id}
  */
  readonly userId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/externalusers_identity genesyscloud_externalusers_identity}
*/
export class ExternalusersIdentity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExternalusersIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/externalusers_identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mypurecloud/genesyscloud/1.72.2/docs/resources/externalusers_identity genesyscloud_externalusers_identity} Resource
  *
  * @param scope The scope in which to define this construct
