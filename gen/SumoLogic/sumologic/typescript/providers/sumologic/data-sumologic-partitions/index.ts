// https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/data-sources/partitions
...
export interface DataSumologicPartitionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/data-sources/partitions#id DataSumologicPartitions#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/data-sources/partitions sumologic_partitions}
*/
export class DataSumologicPartitions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSumologicPartitions that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/data-sources/partitions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/data-sources/partitions sumologic_partitions} Data Source
  *
  * @param scope The scope in which to define this construct
