// https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/content_permission
...
export interface ContentPermissionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/content_permission#content_id ContentPermission#content_id}
  */
  readonly contentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/content_permission#id ContentPermission#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/content_permission#notification_message ContentPermission#notification_message}
  */
  readonly notificationMessage?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/content_permission#notify_recipient ContentPermission#notify_recipient}
  */
  readonly notifyRecipient: boolean | cdktf.IResolvable;
  /**
  * permission block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/content_permission#permission ContentPermission#permission}
  */
  readonly permission: ContentPermissionPermission[] | cdktf.IResolvable;
}
export interface ContentPermissionPermission {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/content_permission#permission_name ContentPermission#permission_name}
  */
  readonly permissionName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/content_permission#source_id ContentPermission#source_id}
  */
  readonly sourceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/content_permission#source_type ContentPermission#source_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/content_permission sumologic_content_permission}
*/
export class ContentPermission extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContentPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/content_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/content_permission sumologic_content_permission} Resource
  *
  * @param scope The scope in which to define this construct
