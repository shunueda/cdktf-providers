// https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/apps
...
export interface DataSumologicAppsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/apps#author DataSumologicApps#author}
  */
  readonly author?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/apps#name DataSumologicApps#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/apps sumologic_apps}
*/
export class DataSumologicApps extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSumologicApps that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/apps#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/apps sumologic_apps} Data Source
  *
  * @param scope The scope in which to define this construct
