// https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/cloud_to_cloud_source
...
export interface CloudToCloudSourceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/cloud_to_cloud_source#collector_id CloudToCloudSource#collector_id}
  */
  readonly collectorId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/cloud_to_cloud_source#config CloudToCloudSource#config}
  */
  readonly config: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/cloud_to_cloud_source#id CloudToCloudSource#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/cloud_to_cloud_source#schema_ref CloudToCloudSource#schema_ref}
  */
  readonly schemaRef: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/cloud_to_cloud_source sumologic_cloud_to_cloud_source}
*/
export class CloudToCloudSource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudToCloudSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/cloud_to_cloud_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/cloud_to_cloud_source sumologic_cloud_to_cloud_source} Resource
  *
  * @param scope The scope in which to define this construct
