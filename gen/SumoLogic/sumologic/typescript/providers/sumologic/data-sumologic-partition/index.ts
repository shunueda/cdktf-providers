// https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/partition
...
export interface DataSumologicPartitionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/partition#id DataSumologicPartition#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/partition sumologic_partition}
*/
export class DataSumologicPartition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSumologicPartition that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/partition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/partition sumologic_partition} Data Source
  *
  * @param scope The scope in which to define this construct
