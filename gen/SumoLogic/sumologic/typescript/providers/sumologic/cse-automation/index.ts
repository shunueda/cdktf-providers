// https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_automation
...
export interface CseAutomationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_automation#cse_resource_sub_types CseAutomation#cse_resource_sub_types}
  */
  readonly cseResourceSubTypes?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_automation#cse_resource_type CseAutomation#cse_resource_type}
  */
  readonly cseResourceType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_automation#enabled CseAutomation#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_automation#execution_types CseAutomation#execution_types}
  */
  readonly executionTypes: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_automation#id CseAutomation#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_automation#playbook_id CseAutomation#playbook_id}
  */
  readonly playbookId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_automation sumologic_cse_automation}
*/
export class CseAutomation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CseAutomation that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_automation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_automation sumologic_cse_automation} Resource
  *
  * @param scope The scope in which to define this construct
