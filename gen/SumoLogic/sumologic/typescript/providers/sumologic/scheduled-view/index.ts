// https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view
...
export interface ScheduledViewConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view#auto_pause_enabled ScheduledView#auto_pause_enabled}
  */
  readonly autoPauseEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view#data_forwarding_id ScheduledView#data_forwarding_id}
  */
  readonly dataForwardingId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view#id ScheduledView#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view#index_id ScheduledView#index_id}
  */
  readonly indexId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view#index_name ScheduledView#index_name}
  */
  readonly indexName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view#parsing_mode ScheduledView#parsing_mode}
  */
  readonly parsingMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view#query ScheduledView#query}
  */
  readonly query: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view#reduce_retention_period_immediately ScheduledView#reduce_retention_period_immediately}
  */
  readonly reduceRetentionPeriodImmediately?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view#retention_period ScheduledView#retention_period}
  */
  readonly retentionPeriod?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view#start_time ScheduledView#start_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view#time_zone ScheduledView#time_zone}
  */
  readonly timeZone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view sumologic_scheduled_view}
*/
export class ScheduledView extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScheduledView that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.0/docs/resources/scheduled_view sumologic_scheduled_view} Resource
  *
  * @param scope The scope in which to define this construct
