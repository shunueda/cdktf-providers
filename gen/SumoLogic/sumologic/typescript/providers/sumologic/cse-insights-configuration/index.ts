// https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_insights_configuration
...
export interface CseInsightsConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_insights_configuration#global_signal_suppression_window CseInsightsConfiguration#global_signal_suppression_window}
  */
  readonly globalSignalSuppressionWindow?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_insights_configuration#id CseInsightsConfiguration#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_insights_configuration#lookback_days CseInsightsConfiguration#lookback_days}
  */
  readonly lookbackDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_insights_configuration#threshold CseInsightsConfiguration#threshold}
  */
  readonly threshold?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_insights_configuration sumologic_cse_insights_configuration}
*/
export class CseInsightsConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CseInsightsConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_insights_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_insights_configuration sumologic_cse_insights_configuration} Resource
  *
  * @param scope The scope in which to define this construct
