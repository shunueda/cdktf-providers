// https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_entity_criticality_config
...
export interface CseEntityCriticalityConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_entity_criticality_config#id CseEntityCriticalityConfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_entity_criticality_config#name CseEntityCriticalityConfig#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_entity_criticality_config#severity_expression CseEntityCriticalityConfig#severity_expression}
  */
  readonly severityExpression: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_entity_criticality_config sumologic_cse_entity_criticality_config}
*/
export class CseEntityCriticalityConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CseEntityCriticalityConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_entity_criticality_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/resources/cse_entity_criticality_config sumologic_cse_entity_criticality_config} Resource
  *
  * @param scope The scope in which to define this construct
