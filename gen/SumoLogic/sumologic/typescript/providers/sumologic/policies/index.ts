// https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/policies
...
export interface PoliciesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/policies#audit Policies#audit}
  */
  readonly audit: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/policies#data_access_level Policies#data_access_level}
  */
  readonly dataAccessLevel: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/policies#id Policies#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/policies#max_user_session_timeout Policies#max_user_session_timeout}
  */
  readonly maxUserSessionTimeout: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/policies#search_audit Policies#search_audit}
  */
  readonly searchAudit: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/policies#share_dashboards_outside_organization Policies#share_dashboards_outside_organization}
  */
  readonly shareDashboardsOutsideOrganization: boolean | cdktf.IResolvable;
  /**
  * user_concurrent_sessions_limit block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/policies#user_concurrent_sessions_limit Policies#user_concurrent_sessions_limit}
  */
...
export interface PoliciesUserConcurrentSessionsLimit {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/policies#enabled Policies#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/policies#max_concurrent_sessions Policies#max_concurrent_sessions}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/policies sumologic_policies}
*/
export class Policies extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Policies that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/policies sumologic_policies} Resource
  *
  * @param scope The scope in which to define this construct
