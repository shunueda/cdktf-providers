// https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/data-sources/user
...
export interface DataSumologicUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/data-sources/user#email DataSumologicUser#email}
  */
  readonly email?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/data-sources/user#id DataSumologicUser#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/data-sources/user sumologic_user}
*/
export class DataSumologicUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSumologicUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.2.1/docs/data-sources/user sumologic_user} Data Source
  *
  * @param scope The scope in which to define this construct
