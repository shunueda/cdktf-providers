// https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/folder
...
export interface DataSumologicFolderConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/folder#path DataSumologicFolder#path}
  */
  readonly path: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/folder sumologic_folder}
*/
export class DataSumologicFolder extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSumologicFolder that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/folder#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/data-sources/folder sumologic_folder} Data Source
  *
  * @param scope The scope in which to define this construct
