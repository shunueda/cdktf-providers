// https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/data_forwarding_rule
...
export interface DataForwardingRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/data_forwarding_rule#destination_id DataForwardingRule#destination_id}
  */
  readonly destinationId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/data_forwarding_rule#enabled DataForwardingRule#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/data_forwarding_rule#file_format DataForwardingRule#file_format}
  */
  readonly fileFormat?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/data_forwarding_rule#format DataForwardingRule#format}
  */
  readonly format?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/data_forwarding_rule#id DataForwardingRule#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/data_forwarding_rule#index_id DataForwardingRule#index_id}
  */
  readonly indexId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/data_forwarding_rule#payload_schema DataForwardingRule#payload_schema}
  */
  readonly payloadSchema?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/data_forwarding_rule sumologic_data_forwarding_rule}
*/
export class DataForwardingRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataForwardingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/data_forwarding_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/data_forwarding_rule sumologic_data_forwarding_rule} Resource
  *
  * @param scope The scope in which to define this construct
