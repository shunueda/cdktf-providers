// https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_network_block
...
export interface CseNetworkBlockConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_network_block#address_block CseNetworkBlock#address_block}
  */
  readonly addressBlock: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_network_block#id CseNetworkBlock#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_network_block#internal CseNetworkBlock#internal}
  */
  readonly internal?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_network_block#label CseNetworkBlock#label}
  */
  readonly label?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_network_block#suppresses_signals CseNetworkBlock#suppresses_signals}
  */
  readonly suppressesSignals?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_network_block sumologic_cse_network_block}
*/
export class CseNetworkBlock extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CseNetworkBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_network_block#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.8/docs/resources/cse_network_block sumologic_cse_network_block} Resource
  *
  * @param scope The scope in which to define this construct
