// https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/hierarchy
...
export interface HierarchyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/hierarchy#id Hierarchy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/hierarchy#name Hierarchy#name}
  */
  readonly name: string;
  /**
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/hierarchy#filter Hierarchy#filter}
  */
  readonly filter?: HierarchyFilter;
  /**
  * level block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/hierarchy#level Hierarchy#level}
  */
  readonly level: HierarchyLevel[] | cdktf.IResolvable;
}
export interface HierarchyFilter {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/hierarchy#key Hierarchy#key}
  */
  readonly key: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/hierarchy#value Hierarchy#value}
  */
...
export function hierarchyFilterToHclTerraform(struct?: HierarchyFilterOutputReference | HierarchyFilter): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface HierarchyLevelNextLevelNextLevelsWithConditions {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/hierarchy#condition Hierarchy#condition}
  */
...
export function hierarchyLevelNextLevelNextLevelsWithConditionsToHclTerraform(struct?: HierarchyLevelNextLevelNextLevelsWithConditions | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    level: {
      value: cdktf.listMapperHcl(hierarchyLevelToHclTerraform, true)(struct!.level),
      isBlock: true,
      type: "list",
      storageClassType: "HierarchyLevelList",
    },
  };
...
export interface HierarchyLevelNextLevel {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/hierarchy#entity_type Hierarchy#entity_type}
  */
  readonly entityType: string;
  /**
  * next_level block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/hierarchy#next_level Hierarchy#next_level}
  */
  readonly nextLevel?: HierarchyLevelNextLevel;
  /**
  * next_levels_with_conditions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/hierarchy#next_levels_with_conditions Hierarchy#next_levels_with_conditions}
  */
...
export function hierarchyLevelNextLevelToHclTerraform(struct?: HierarchyLevelNextLevelOutputReference | HierarchyLevelNextLevel): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    next_level: {
      value: hierarchyLevelNextLevelToHclTerraform(struct!.nextLevel),
      isBlock: true,
      type: "list",
      storageClassType: "HierarchyLevelNextLevelList",
    },
    next_levels_with_conditions: {
      value: cdktf.listMapperHcl(hierarchyLevelNextLevelNextLevelsWithConditionsToHclTerraform, true)(struct!.nextLevelsWithConditions),
      isBlock: true,
      type: "list",
      storageClassType: "HierarchyLevelNextLevelNextLevelsWithConditionsList",
    },
  };
...
export function hierarchyLevelNextLevelsWithConditionsToHclTerraform(struct?: HierarchyLevelNextLevelsWithConditions | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function hierarchyLevelToHclTerraform(struct?: HierarchyLevel | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    next_levels_with_conditions: {
      value: cdktf.listMapperHcl(hierarchyLevelNextLevelsWithConditionsToHclTerraform, true)(struct!.nextLevelsWithConditions),
      isBlock: true,
      type: "list",
      storageClassType: "HierarchyLevelNextLevelsWithConditionsList",
    },
  };
...
/**
* Represents a {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/hierarchy sumologic_hierarchy}
*/
export class Hierarchy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Hierarchy that should be imported. Refer to the {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/hierarchy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Hierarchy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sumologic_hierarchy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sumologic/sumologic/3.1.7/docs/resources/hierarchy sumologic_hierarchy} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: hierarchyFilterToHclTerraform(this._filter.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "HierarchyFilterList",
      },
      level: {
        value: cdktf.listMapperHcl(hierarchyLevelToHclTerraform, true)(this._level.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "HierarchyLevelList",
      },
