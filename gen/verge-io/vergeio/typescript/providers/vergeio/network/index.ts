// https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network
...
export interface NetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#bond_interfaces_args Network#bond_interfaces_args}
  */
  readonly bondInterfacesArgs?: number[];
  /**
  * Is DHCP enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#dhcp_enabled Network#dhcp_enabled}
  */
  readonly dhcpEnabled?: boolean | cdktf.IResolvable;
  /**
  * Is DHCP sequential
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#dhcp_sequential Network#dhcp_sequential}
  */
  readonly dhcpSequential?: boolean | cdktf.IResolvable;
  /**
  * DHCP start address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#dhcp_start Network#dhcp_start}
  */
  readonly dhcpStart?: string;
  /**
  * DHCP stop address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#dhcp_stop Network#dhcp_stop}
  */
  readonly dhcpStop?: string;
  /**
  * Is DHCP dynamic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#dynamic_dhcp Network#dynamic_dhcp}
  */
  readonly dynamicDhcp?: boolean | cdktf.IResolvable;
  /**
  * Enable bonding
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#enable_bonding Network#enable_bonding}
  */
  readonly enableBonding?: boolean | cdktf.IResolvable;
  /**
  * Network state
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#enabled Network#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Key/ID of the physical network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#interface_vnet Network#interface_vnet}
  */
  readonly interfaceVnet?: number;
  /**
  * IP address assigned to network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#ipaddress Network#ipaddress}
  */
  readonly ipaddress?: string;
  /**
  * IP address type of the vnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#ipaddress_type Network#ipaddress_type}
  */
  readonly ipaddressType?: string;
  /**
  * VLAN ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#layer2_id Network#layer2_id}
  */
  readonly layer2Id?: number;
  /**
  * Layer2 type of the vnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#layer2_type Network#layer2_type}
  */
  readonly layer2Type?: string;
  /**
  * Network MTU
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#mtu Network#mtu}
  */
  readonly mtu?: number;
  /**
  * Unique network name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#name Network#name}
  */
  readonly name: string;
  /**
  * Network address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#network Network#network}
  */
  readonly network?: string;
  /**
  * What to do on power loss
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#on_power_loss Network#on_power_loss}
  */
  readonly onPowerLoss?: string;
  /**
  * Power state of the network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#powerstate Network#powerstate}
  */
  readonly powerstate?: string;
  /**
  * Type of Network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#type Network#type}
  */
  readonly type?: string;
  /**
  * Vnet default gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#vnet_default_gateway Network#vnet_default_gateway}
  */
  readonly vnetDefaultGateway?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network vergeio_network}
*/
export class Network extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Network that should be imported. Refer to the {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.1/docs/resources/network vergeio_network} Resource
  *
  * @param scope The scope in which to define this construct
