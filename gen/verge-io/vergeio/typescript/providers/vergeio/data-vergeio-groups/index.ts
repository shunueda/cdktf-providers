// https://registry.terraform.io/providers/verge-io/vergeio/2.7.3/docs/data-sources/groups
...
export interface DataVergeioGroupsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Filter by name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.3/docs/data-sources/groups#filter_name DataVergeioGroups#filter_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.3/docs/data-sources/groups vergeio_groups}
*/
export class DataVergeioGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVergeioGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.3/docs/data-sources/groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.3/docs/data-sources/groups vergeio_groups} Data Source
  *
  * @param scope The scope in which to define this construct
