// https://registry.terraform.io/providers/verge-io/vergeio/2.7.2/docs/resources/member
...
export interface MemberConfig extends cdktf.TerraformMetaArguments {
  ...
  * Group id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.2/docs/resources/member#group Member#group}
  */
  readonly group?: number;
  /**
  * Unique member name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.2/docs/resources/member#member Member#member}
  */
  readonly member?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.2/docs/resources/member vergeio_member}
*/
export class Member extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Member that should be imported. Refer to the {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.2/docs/resources/member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/verge-io/vergeio/2.7.2/docs/resources/member vergeio_member} Resource
  *
  * @param scope The scope in which to define this construct
