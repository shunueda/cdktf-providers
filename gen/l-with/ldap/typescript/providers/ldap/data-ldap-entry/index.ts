// https://registry.terraform.io/providers/l-with/ldap/0.11.1/docs/data-sources/entry
...
export interface DataLdapEntryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/l-with/ldap/0.11.1/docs/data-sources/entry#base64encode_attribute_patterns DataLdapEntry#base64encode_attribute_patterns}
  */
  readonly base64EncodeAttributePatterns?: string[];
  /**
  * list of attributes to be encoded to base64
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/l-with/ldap/0.11.1/docs/data-sources/entry#base64encode_attributes DataLdapEntry#base64encode_attributes}
  */
  readonly base64EncodeAttributes?: string[];
  /**
  * DN of the LDAP entry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/l-with/ldap/0.11.1/docs/data-sources/entry#dn DataLdapEntry#dn}
  */
  readonly dn?: string;
  /**
  * filter for selecting the LDAP entry, ignored if 'dn' is used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/l-with/ldap/0.11.1/docs/data-sources/entry#filter DataLdapEntry#filter}
  */
  readonly filter?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/l-with/ldap/0.11.1/docs/data-sources/entry#id DataLdapEntry#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/l-with/ldap/0.11.1/docs/data-sources/entry#ignore_attribute_patterns DataLdapEntry#ignore_attribute_patterns}
  */
  readonly ignoreAttributePatterns?: string[];
  /**
  * list of attributes to ignore
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/l-with/ldap/0.11.1/docs/data-sources/entry#ignore_attributes DataLdapEntry#ignore_attributes}
  */
  readonly ignoreAttributes?: string[];
  /**
  * OU where LDAP entry will be searched
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/l-with/ldap/0.11.1/docs/data-sources/entry#ou DataLdapEntry#ou}
  */
  readonly ou?: string;
  /**
  * list of attributes to which reading is restricted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/l-with/ldap/0.11.1/docs/data-sources/entry#restrict_attributes DataLdapEntry#restrict_attributes}
  */
  readonly restrictAttributes?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/l-with/ldap/0.11.1/docs/data-sources/entry ldap_entry}
*/
export class DataLdapEntry extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLdapEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/l-with/ldap/0.11.1/docs/data-sources/entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/l-with/ldap/0.11.1/docs/data-sources/entry ldap_entry} Data Source
  *
  * @param scope The scope in which to define this construct
