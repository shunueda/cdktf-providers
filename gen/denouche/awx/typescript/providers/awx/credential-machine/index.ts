// https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine
...
export interface CredentialMachineConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine#become_method CredentialMachine#become_method}
  */
  readonly becomeMethod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine#become_password CredentialMachine#become_password}
  */
  readonly becomePassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine#become_username CredentialMachine#become_username}
  */
  readonly becomeUsername?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine#description CredentialMachine#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine#id CredentialMachine#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine#name CredentialMachine#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine#organization_id CredentialMachine#organization_id}
  */
  readonly organizationId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine#password CredentialMachine#password}
  */
  readonly password?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine#ssh_key_data CredentialMachine#ssh_key_data}
  */
  readonly sshKeyData?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine#ssh_key_unlock CredentialMachine#ssh_key_unlock}
  */
  readonly sshKeyUnlock?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine#ssh_public_key_data CredentialMachine#ssh_public_key_data}
  */
  readonly sshPublicKeyData?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine#username CredentialMachine#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine awx_credential_machine}
*/
export class CredentialMachine extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CredentialMachine that should be imported. Refer to the {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_machine awx_credential_machine} Resource
  *
  * @param scope The scope in which to define this construct
