// https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/job_template_notification_template_started
...
export interface JobTemplateNotificationTemplateStartedConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/job_template_notification_template_started#id JobTemplateNotificationTemplateStarted#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/job_template_notification_template_started#job_template_id JobTemplateNotificationTemplateStarted#job_template_id}
  */
  readonly jobTemplateId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/job_template_notification_template_started#notification_template_id JobTemplateNotificationTemplateStarted#notification_template_id}
  */
  readonly notificationTemplateId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/job_template_notification_template_started awx_job_template_notification_template_started}
*/
export class JobTemplateNotificationTemplateStarted extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing JobTemplateNotificationTemplateStarted that should be imported. Refer to the {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/job_template_notification_template_started#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/job_template_notification_template_started awx_job_template_notification_template_started} Resource
  *
  * @param scope The scope in which to define this construct
