// https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_notification_template_error
...
export interface WorkflowJobTemplateNotificationTemplateErrorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_notification_template_error#id WorkflowJobTemplateNotificationTemplateError#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_notification_template_error#notification_template_id WorkflowJobTemplateNotificationTemplateError#notification_template_id}
  */
  readonly notificationTemplateId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_notification_template_error#workflow_job_template_id WorkflowJobTemplateNotificationTemplateError#workflow_job_template_id}
  */
  readonly workflowJobTemplateId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_notification_template_error awx_workflow_job_template_notification_template_error}
*/
export class WorkflowJobTemplateNotificationTemplateError extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowJobTemplateNotificationTemplateError that should be imported. Refer to the {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_notification_template_error#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_notification_template_error awx_workflow_job_template_notification_template_error} Resource
  *
  * @param scope The scope in which to define this construct
