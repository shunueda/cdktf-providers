// https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/data-sources/credential
...
export interface DataAwxCredentialConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/data-sources/credential#id DataAwxCredential#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/data-sources/credential awx_credential}
*/
export class DataAwxCredential extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwxCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/data-sources/credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/data-sources/credential awx_credential} Data Source
  *
  * @param scope The scope in which to define this construct
