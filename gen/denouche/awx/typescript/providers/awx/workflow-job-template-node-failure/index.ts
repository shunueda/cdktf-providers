// https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure
...
export interface WorkflowJobTemplateNodeFailureConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#all_parents_must_converge WorkflowJobTemplateNodeFailure#all_parents_must_converge}
  */
  readonly allParentsMustConverge?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#diff_mode WorkflowJobTemplateNodeFailure#diff_mode}
  */
  readonly diffMode?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#extra_data WorkflowJobTemplateNodeFailure#extra_data}
  */
  readonly extraData?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#id WorkflowJobTemplateNodeFailure#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#identifier WorkflowJobTemplateNodeFailure#identifier}
  */
  readonly identifier: string;
  /**
  * Inventory applied as a prompt, assuming job template prompts for inventory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#inventory_id WorkflowJobTemplateNodeFailure#inventory_id}
  */
  readonly inventoryId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#job_tags WorkflowJobTemplateNodeFailure#job_tags}
  */
  readonly jobTags?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#job_type WorkflowJobTemplateNodeFailure#job_type}
  */
  readonly jobType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#limit WorkflowJobTemplateNodeFailure#limit}
  */
  readonly limit?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#scm_branch WorkflowJobTemplateNodeFailure#scm_branch}
  */
  readonly scmBranch?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#skip_tags WorkflowJobTemplateNodeFailure#skip_tags}
  */
  readonly skipTags?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#unified_job_template_id WorkflowJobTemplateNodeFailure#unified_job_template_id}
  */
  readonly unifiedJobTemplateId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#verbosity WorkflowJobTemplateNodeFailure#verbosity}
  */
  readonly verbosity?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#workflow_job_template_id WorkflowJobTemplateNodeFailure#workflow_job_template_id}
  */
  readonly workflowJobTemplateId: number;
  /**
  * The workflow_job_template_node id from with the new node will start
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#workflow_job_template_node_id WorkflowJobTemplateNodeFailure#workflow_job_template_node_id}
  */
  readonly workflowJobTemplateNodeId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure awx_workflow_job_template_node_failure}
*/
export class WorkflowJobTemplateNodeFailure extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowJobTemplateNodeFailure that should be imported. Refer to the {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_failure awx_workflow_job_template_node_failure} Resource
  *
  * @param scope The scope in which to define this construct
