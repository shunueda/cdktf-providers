// https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_schedule
...
export interface WorkflowJobTemplateScheduleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_schedule#description WorkflowJobTemplateSchedule#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_schedule#enabled WorkflowJobTemplateSchedule#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Extra data to be pass for the schedule (YAML format)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_schedule#extra_data WorkflowJobTemplateSchedule#extra_data}
  */
  readonly extraData?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_schedule#id WorkflowJobTemplateSchedule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_schedule#inventory WorkflowJobTemplateSchedule#inventory}
  */
  readonly inventory?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_schedule#name WorkflowJobTemplateSchedule#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_schedule#rrule WorkflowJobTemplateSchedule#rrule}
  */
  readonly rrule: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_schedule#unified_job_template_id WorkflowJobTemplateSchedule#unified_job_template_id}
  */
  readonly unifiedJobTemplateId?: number;
  /**
  * The workflow_job_template id for this schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_schedule#workflow_job_template_id WorkflowJobTemplateSchedule#workflow_job_template_id}
  */
  readonly workflowJobTemplateId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_schedule awx_workflow_job_template_schedule}
*/
export class WorkflowJobTemplateSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowJobTemplateSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_schedule awx_workflow_job_template_schedule} Resource
  *
  * @param scope The scope in which to define this construct
