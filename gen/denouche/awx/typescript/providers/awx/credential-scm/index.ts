// https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_scm
...
export interface CredentialScmConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_scm#description CredentialScm#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_scm#id CredentialScm#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_scm#name CredentialScm#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_scm#organization_id CredentialScm#organization_id}
  */
  readonly organizationId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_scm#password CredentialScm#password}
  */
  readonly password?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_scm#ssh_key_data CredentialScm#ssh_key_data}
  */
  readonly sshKeyData?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_scm#ssh_key_unlock CredentialScm#ssh_key_unlock}
  */
  readonly sshKeyUnlock?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_scm#username CredentialScm#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_scm awx_credential_scm}
*/
export class CredentialScm extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CredentialScm that should be imported. Refer to the {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_scm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/credential_scm awx_credential_scm} Resource
  *
  * @param scope The scope in which to define this construct
