// https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/organization
...
export interface OrganizationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/organization#custom_virtualenv Organization#custom_virtualenv}
  */
  readonly customVirtualenv?: string;
  /**
  * The default execution environment for jobs run by this organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/organization#default_environment Organization#default_environment}
  */
  readonly defaultEnvironment?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/organization#description Organization#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/organization#id Organization#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/organization#max_hosts Organization#max_hosts}
  */
  readonly maxHosts?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/organization#name Organization#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/organization awx_organization}
*/
export class Organization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Organization that should be imported. Refer to the {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/organization awx_organization} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _defaultEnvironment?: number; 
  public get defaultEnvironment() {
    return this.getNumberAttribute('default_environment');
  }
  public set defaultEnvironment(value: number) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      default_environment: cdktf.numberToTerraform(this._defaultEnvironment),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      default_environment: {
        value: cdktf.numberToHclTerraform(this._defaultEnvironment),
        isBlock: false,
        type: "simple",
