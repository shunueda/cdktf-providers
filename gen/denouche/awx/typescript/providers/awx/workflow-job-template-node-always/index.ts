// https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always
...
export interface WorkflowJobTemplateNodeAlwaysConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#all_parents_must_converge WorkflowJobTemplateNodeAlways#all_parents_must_converge}
  */
  readonly allParentsMustConverge?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#diff_mode WorkflowJobTemplateNodeAlways#diff_mode}
  */
  readonly diffMode?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#extra_data WorkflowJobTemplateNodeAlways#extra_data}
  */
  readonly extraData?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#id WorkflowJobTemplateNodeAlways#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#identifier WorkflowJobTemplateNodeAlways#identifier}
  */
  readonly identifier: string;
  /**
  * Inventory applied as a prompt, assuming job template prompts for inventory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#inventory_id WorkflowJobTemplateNodeAlways#inventory_id}
  */
  readonly inventoryId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#job_tags WorkflowJobTemplateNodeAlways#job_tags}
  */
  readonly jobTags?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#job_type WorkflowJobTemplateNodeAlways#job_type}
  */
  readonly jobType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#limit WorkflowJobTemplateNodeAlways#limit}
  */
  readonly limit?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#scm_branch WorkflowJobTemplateNodeAlways#scm_branch}
  */
  readonly scmBranch?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#skip_tags WorkflowJobTemplateNodeAlways#skip_tags}
  */
  readonly skipTags?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#unified_job_template_id WorkflowJobTemplateNodeAlways#unified_job_template_id}
  */
  readonly unifiedJobTemplateId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#verbosity WorkflowJobTemplateNodeAlways#verbosity}
  */
  readonly verbosity?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#workflow_job_template_id WorkflowJobTemplateNodeAlways#workflow_job_template_id}
  */
  readonly workflowJobTemplateId: number;
  /**
  * The workflow_job_template_node id from with the new node will start
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#workflow_job_template_node_id WorkflowJobTemplateNodeAlways#workflow_job_template_node_id}
  */
  readonly workflowJobTemplateNodeId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always awx_workflow_job_template_node_always}
*/
export class WorkflowJobTemplateNodeAlways extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowJobTemplateNodeAlways that should be imported. Refer to the {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/denouche/awx/0.29.1/docs/resources/workflow_job_template_node_always awx_workflow_job_template_node_always} Resource
  *
  * @param scope The scope in which to define this construct
