// https://registry.terraform.io/providers/pablovarela/slack/1.2.2/docs
...
export class SlackProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing SlackProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/pablovarela/slack/1.2.2/docs#import import section} in the documentation of this resource for the id to use
