// https://registry.terraform.io/providers/pablovarela/slack/1.2.2/docs/data-sources/user
...
export class DataSlackUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSlackUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/pablovarela/slack/1.2.2/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
