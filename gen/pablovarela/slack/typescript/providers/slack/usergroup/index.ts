// https://registry.terraform.io/providers/pablovarela/slack/1.2.2/docs/resources/usergroup
...
/**
* Represents a {@link https://registry.terraform.io/providers/pablovarela/slack/1.2.2/docs/resources/usergroup slack_usergroup}
*/
export class Usergroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Usergroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/pablovarela/slack/1.2.2/docs/resources/usergroup#import import section} in the documentation of this resource for the id to use
