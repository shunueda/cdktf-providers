// https://registry.terraform.io/providers/terraform-aws-modules/http/2.4.1/docs
...
export interface HttpProviderConfig {
  ...
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-aws-modules/http/2.4.1/docs#alias HttpProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-aws-modules/http/2.4.1/docs http}
*/
export class HttpProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing HttpProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-aws-modules/http/2.4.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-aws-modules/http/2.4.1/docs http} Resource
  *
  * @param scope The scope in which to define this construct
