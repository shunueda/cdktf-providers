// https://registry.terraform.io/providers/render-oss/render/1.7.5/docs/data-sources/env_group
...
export interface DataRenderEnvGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/render-oss/render/1.7.5/docs/data-sources/env_group#id DataRenderEnvGroup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/render-oss/render/1.7.5/docs/data-sources/env_group render_env_group}
*/
export class DataRenderEnvGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRenderEnvGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/render-oss/render/1.7.5/docs/data-sources/env_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/render-oss/render/1.7.5/docs/data-sources/env_group render_env_group} Data Source
  *
  * @param scope The scope in which to define this construct
