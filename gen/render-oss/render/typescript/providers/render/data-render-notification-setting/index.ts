// https://registry.terraform.io/providers/render-oss/render/1.8.0/docs/data-sources/notification_setting
...
/**
* Represents a {@link https://registry.terraform.io/providers/render-oss/render/1.8.0/docs/data-sources/notification_setting render_notification_setting}
*/
export class DataRenderNotificationSetting extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRenderNotificationSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/render-oss/render/1.8.0/docs/data-sources/notification_setting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/render-oss/render/1.8.0/docs/data-sources/notification_setting render_notification_setting} Data Source
  *
  * @param scope The scope in which to define this construct
