// https://registry.terraform.io/providers/render-oss/render/1.8.0/docs/data-sources/project
...
export interface DataRenderProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/render-oss/render/1.8.0/docs/data-sources/project#id DataRenderProject#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/render-oss/render/1.8.0/docs/data-sources/project render_project}
*/
export class DataRenderProject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRenderProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/render-oss/render/1.8.0/docs/data-sources/project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/render-oss/render/1.8.0/docs/data-sources/project render_project} Data Source
  *
  * @param scope The scope in which to define this construct
