// https://registry.terraform.io/providers/render-oss/render/1.8.0/docs/data-sources/log_stream
...
export interface DataRenderLogStreamConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/render-oss/render/1.8.0/docs/data-sources/log_stream#endpoint DataRenderLogStream#endpoint}
  */
  readonly endpoint?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/render-oss/render/1.8.0/docs/data-sources/log_stream render_log_stream}
*/
export class DataRenderLogStream extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRenderLogStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/render-oss/render/1.8.0/docs/data-sources/log_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/render-oss/render/1.8.0/docs/data-sources/log_stream render_log_stream} Data Source
  *
  * @param scope The scope in which to define this construct
