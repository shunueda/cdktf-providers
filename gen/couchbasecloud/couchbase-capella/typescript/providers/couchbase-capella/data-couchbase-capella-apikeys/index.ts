// https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.7.0/docs/data-sources/apikeys
...
export interface DataCouchbaseCapellaApikeysConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.7.0/docs/data-sources/apikeys#organization_id DataCouchbaseCapellaApikeys#organization_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.7.0/docs/data-sources/apikeys couchbase-capella_apikeys}
*/
export class DataCouchbaseCapellaApikeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCouchbaseCapellaApikeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.7.0/docs/data-sources/apikeys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.7.0/docs/data-sources/apikeys couchbase-capella_apikeys} Data Source
  *
  * @param scope The scope in which to define this construct
