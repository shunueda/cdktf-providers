// https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets
...
export interface DataCouchbaseCapellaBucketsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets#cluster_id DataCouchbaseCapellaBuckets#cluster_id}
  */
  readonly clusterId: string;
  /**
  * The GUID4 ID of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets#organization_id DataCouchbaseCapellaBuckets#organization_id}
  */
  readonly organizationId: string;
  /**
  * The GUID4 ID of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets#project_id DataCouchbaseCapellaBuckets#project_id}
  */
...
export interface DataCouchbaseCapellaBucketsData {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets#bucket_conflict_resolution DataCouchbaseCapellaBuckets#bucket_conflict_resolution}
  */
  readonly bucketConflictResolution?: string;
  /**
  * Durability of the bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets#durability_level DataCouchbaseCapellaBuckets#durability_level}
  */
  readonly durabilityLevel?: string;
  /**
  * Eviction policy for the bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets#eviction_policy DataCouchbaseCapellaBuckets#eviction_policy}
  */
  readonly evictionPolicy?: string;
  /**
  * Determines whether flushing is enabled in the bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets#flush DataCouchbaseCapellaBuckets#flush}
  */
  readonly flush?: boolean | cdktf.IResolvable;
  /**
  * Bucket size in MB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets#memory_allocation_in_mb DataCouchbaseCapellaBuckets#memory_allocation_in_mb}
  */
  readonly memoryAllocationInMb?: number;
  /**
  * Number of replicas for the data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets#replicas DataCouchbaseCapellaBuckets#replicas}
  */
  readonly replicas?: number;
  /**
  * The bucket storage engine type (Magma or Couchstore).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets#storage_backend DataCouchbaseCapellaBuckets#storage_backend}
  */
  readonly storageBackend?: string;
  /**
  * Time-to-live (TTL) for items in the bucket, in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets#time_to_live_in_seconds DataCouchbaseCapellaBuckets#time_to_live_in_seconds}
  */
  readonly timeToLiveInSeconds?: number;
  /**
  * The bucket type (Couchbase or Ephemeral).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets#type DataCouchbaseCapellaBuckets#type}
  */
...
export class DataCouchbaseCapellaBucketsDataList extends cdktf.ComplexList {
  public internalValue? : DataCouchbaseCapellaBucketsData[] | cdktf.IResolvable
...
/**
* Represents a {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets couchbase-capella_buckets}
*/
export class DataCouchbaseCapellaBuckets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCouchbaseCapellaBuckets that should be imported. Refer to the {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/couchbasecloud/couchbase-capella/1.5.3/docs/data-sources/buckets couchbase-capella_buckets} Data Source
  *
  * @param scope The scope in which to define this construct
