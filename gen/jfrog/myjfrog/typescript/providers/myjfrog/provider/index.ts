// https://registry.terraform.io/providers/jfrog/myjfrog/1.0.2/docs
...
export interface MyjfrogProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/myjfrog/1.0.2/docs#api_token MyjfrogProvider#api_token}
  */
  readonly apiToken?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/myjfrog/1.0.2/docs#alias MyjfrogProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/myjfrog/1.0.2/docs myjfrog}
*/
export class MyjfrogProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing MyjfrogProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/myjfrog/1.0.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/myjfrog/1.0.2/docs myjfrog} Resource
  *
  * @param scope The scope in which to define this construct
