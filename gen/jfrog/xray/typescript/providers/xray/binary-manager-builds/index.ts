// https://registry.terraform.io/providers/jfrog/xray/3.1.3/docs/resources/binary_manager_builds
...
export interface BinaryManagerBuildsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.3/docs/resources/binary_manager_builds#id BinaryManagerBuilds#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.3/docs/resources/binary_manager_builds#indexed_builds BinaryManagerBuilds#indexed_builds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.3/docs/resources/binary_manager_builds#project_key BinaryManagerBuilds#project_key}
  */
  readonly projectKey?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/xray/3.1.3/docs/resources/binary_manager_builds xray_binary_manager_builds}
*/
export class BinaryManagerBuilds extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BinaryManagerBuilds that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/xray/3.1.3/docs/resources/binary_manager_builds#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/xray/3.1.3/docs/resources/binary_manager_builds xray_binary_manager_builds} Resource
  *
  * @param scope The scope in which to define this construct
