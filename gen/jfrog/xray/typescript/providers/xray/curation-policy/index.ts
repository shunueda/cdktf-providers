// https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy
...
export interface CurationPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#condition_id CurationPolicy#condition_id}
  */
  readonly conditionId: string;
  /**
  * List of JFrog Access groups used by waiver_request_config=manual
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#decision_owners CurationPolicy#decision_owners}
  */
  readonly decisionOwners?: string[];
  /**
  * List of label waivers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#label_waivers CurationPolicy#label_waivers}
  */
  readonly labelWaivers?: CurationPolicyLabelWaivers[] | cdktf.IResolvable;
  /**
  * Name of policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#name CurationPolicy#name}
  */
  readonly name: string;
  /**
  * List of email addresses that receive notifications when the policy causes a package to be blocked.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#notify_emails CurationPolicy#notify_emails}
  */
  readonly notifyEmails?: string[];
  /**
  * Used with scope: pkg_types. List of package types to include.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#pkg_types_include CurationPolicy#pkg_types_include}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#policy_action CurationPolicy#policy_action}
  */
  readonly policyAction: string;
  /**
  * Used with scope: all_repos. List of repositories to exclude.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#repo_exclude CurationPolicy#repo_exclude}
  */
  readonly repoExclude?: string[];
  /**
  * Used with scope: specific_repos. List of repositories to include.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#repo_include CurationPolicy#repo_include}
  */
  readonly repoInclude?: string[];
  /**
  * One of: all_repos, specific_repos or pkg_types.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#scope CurationPolicy#scope}
  */
  readonly scope: string;
  /**
  * One of: forbidden, manual or auto_approved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#waiver_request_config CurationPolicy#waiver_request_config}
  */
  readonly waiverRequestConfig?: string;
  /**
  * List of package waivers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#waivers CurationPolicy#waivers}
  */
...
export interface CurationPolicyLabelWaivers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#justification CurationPolicy#justification}
  */
  readonly justification: string;
  /**
  * A label from the custom Catalog.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#label CurationPolicy#label}
  */
...
export interface CurationPolicyWaivers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#all_versions CurationPolicy#all_versions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#pkg_name CurationPolicy#pkg_name}
  */
  readonly pkgName: string;
  /**
  * Package type. One of: npm, PyPI, Maven, Go, NuGet, Conan, Gems, Gradle, HuggingFaceML or Docker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#pkg_type CurationPolicy#pkg_type}
  */
  readonly pkgType: string;
  /**
  * List of specific versions of the package from the Catalog.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#pkg_versions CurationPolicy#pkg_versions}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy xray_curation_policy}
*/
export class CurationPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CurationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/curation_policy xray_curation_policy} Resource
  *
  * @param scope The scope in which to define this construct
