// https://registry.terraform.io/providers/jfrog/xray/3.1.4/docs/resources/settings
...
export interface SettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.4/docs/resources/settings#allow_blocked Settings#allow_blocked}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.4/docs/resources/settings#allow_when_unavailable Settings#allow_when_unavailable}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.4/docs/resources/settings#block_unfinished_scans_timeout Settings#block_unfinished_scans_timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.4/docs/resources/settings#block_unscanned_timeout Settings#block_unscanned_timeout}
  */
  readonly blockUnscannedTimeout?: number;
  /**
  * The time of the Xray DB sync daily update job. Format `HH:mm`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.4/docs/resources/settings#db_sync_updates_time Settings#db_sync_updates_time}
  */
  readonly dbSyncUpdatesTime: string;
  /**
  * Determines whether Xray is currently enabled. Default value: `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.4/docs/resources/settings#enabled Settings#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/xray/3.1.4/docs/resources/settings xray_settings}
*/
export class Settings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Settings that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/xray/3.1.4/docs/resources/settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/xray/3.1.4/docs/resources/settings xray_settings} Resource
  *
  * @param scope The scope in which to define this construct
