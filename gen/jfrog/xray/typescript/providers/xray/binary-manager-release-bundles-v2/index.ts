// https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/binary_manager_release_bundles_v2
...
export interface BinaryManagerReleaseBundlesV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/binary_manager_release_bundles_v2#id BinaryManagerReleaseBundlesV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/binary_manager_release_bundles_v2#indexed_release_bundle_v2 BinaryManagerReleaseBundlesV2#indexed_release_bundle_v2}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/binary_manager_release_bundles_v2#project_key BinaryManagerReleaseBundlesV2#project_key}
  */
  readonly projectKey?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/binary_manager_release_bundles_v2 xray_binary_manager_release_bundles_v2}
*/
export class BinaryManagerReleaseBundlesV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BinaryManagerReleaseBundlesV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/binary_manager_release_bundles_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/xray/3.1.2/docs/resources/binary_manager_release_bundles_v2 xray_binary_manager_release_bundles_v2} Resource
  *
  * @param scope The scope in which to define this construct
