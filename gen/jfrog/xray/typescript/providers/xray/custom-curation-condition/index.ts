// https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs/resources/custom_curation_condition
...
export interface CustomCurationConditionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs/resources/custom_curation_condition#condition_template_id CustomCurationCondition#condition_template_id}
  */
  readonly conditionTemplateId: string;
  /**
  * The name of the condition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs/resources/custom_curation_condition#name CustomCurationCondition#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs/resources/custom_curation_condition#param_values CustomCurationCondition#param_values}
  */
  readonly paramValues: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs/resources/custom_curation_condition xray_custom_curation_condition}
*/
export class CustomCurationCondition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomCurationCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs/resources/custom_curation_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs/resources/custom_curation_condition xray_custom_curation_condition} Resource
  *
  * @param scope The scope in which to define this construct
