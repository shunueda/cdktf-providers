// https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs
...
export interface XrayProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs#access_token XrayProvider#access_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs#oidc_provider_name XrayProvider#oidc_provider_name}
  */
  readonly oidcProviderName?: string;
  /**
  * Skip version check. Default to false if not set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs#skip_xray_version_check XrayProvider#skip_xray_version_check}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs#tfc_credential_tag_name XrayProvider#tfc_credential_tag_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs#url XrayProvider#url}
  */
  readonly url?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs#alias XrayProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs xray}
*/
export class XrayProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing XrayProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/xray/3.1.5/docs xray} Resource
  *
  * @param scope The scope in which to define this construct
