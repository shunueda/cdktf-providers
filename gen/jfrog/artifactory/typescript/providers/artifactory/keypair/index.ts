// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/keypair
...
export interface KeypairConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/keypair#alias Keypair#alias}
  */
  readonly alias: string;
  /**
  * A unique identifier for the Key Pair record.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/keypair#pair_name Keypair#pair_name}
  */
  readonly pairName: string;
  /**
  * Key Pair type. Supported types - GPG and RSA.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/keypair#pair_type Keypair#pair_type}
  */
  readonly pairType: string;
  /**
  * Passphrase will be used to decrypt the private key. Validated server side.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/keypair#passphrase Keypair#passphrase}
  */
  readonly passphrase?: string;
  /**
  * Private key. PEM format will be validated. Must not include extranous spaces or tabs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/keypair#private_key Keypair#private_key}
  */
  readonly privateKey: string;
  /**
  * Public key. PEM format will be validated. Must not include extranous spaces or tabs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/keypair#public_key Keypair#public_key}
  */
  readonly publicKey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/keypair artifactory_keypair}
*/
export class Keypair extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Keypair that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/keypair#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/keypair artifactory_keypair} Resource
  *
  * @param scope The scope in which to define this construct
