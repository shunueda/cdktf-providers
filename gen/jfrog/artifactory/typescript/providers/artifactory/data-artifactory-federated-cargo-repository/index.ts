// https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository
...
export interface DataArtifactoryFederatedCargoRepositoryConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#anonymous_access DataArtifactoryFederatedCargoRepository#anonymous_access}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#archive_browsing_enabled DataArtifactoryFederatedCargoRepository#archive_browsing_enabled}
  */
  readonly archiveBrowsingEnabled?: boolean | cdktf.IResolvable;
  /**
  * When set, the repository does not participate in artifact resolution and new artifacts cannot be deployed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#blacked_out DataArtifactoryFederatedCargoRepository#blacked_out}
  */
  readonly blackedOut?: boolean | cdktf.IResolvable;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#cdn_redirect DataArtifactoryFederatedCargoRepository#cdn_redirect}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#cleanup_on_delete DataArtifactoryFederatedCargoRepository#cleanup_on_delete}
  */
  readonly cleanupOnDelete?: boolean | cdktf.IResolvable;
  /**
  * Public description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#description DataArtifactoryFederatedCargoRepository#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#disable_proxy DataArtifactoryFederatedCargoRepository#disable_proxy}
  */
  readonly disableProxy?: boolean | cdktf.IResolvable;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from the cloud storage provider. Available in Enterprise+ and Edge licenses only.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#download_direct DataArtifactoryFederatedCargoRepository#download_direct}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#enable_sparse_index DataArtifactoryFederatedCargoRepository#enable_sparse_index}
  */
  readonly enableSparseIndex?: boolean | cdktf.IResolvable;
  /**
  * List of artifact patterns to exclude when evaluating artifact requests, in the form of `x/y/** /z/*`.By default no artifacts are excluded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#excludes_pattern DataArtifactoryFederatedCargoRepository#excludes_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  readonly excludesPattern?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#id DataArtifactoryFederatedCargoRepository#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#includes_pattern DataArtifactoryFederatedCargoRepository#includes_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  readonly includesPattern?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#index_compression_formats DataArtifactoryFederatedCargoRepository#index_compression_formats}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#key DataArtifactoryFederatedCargoRepository#key}
  */
  readonly key: string;
  /**
  * Internal description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#notes DataArtifactoryFederatedCargoRepository#notes}
  */
  readonly notes?: string;
  /**
  * Setting repositories with priority will cause metadata to be merged only from repositories set with this field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#priority_resolution DataArtifactoryFederatedCargoRepository#priority_resolution}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#project_environments DataArtifactoryFederatedCargoRepository#project_environments}
  */
  readonly projectEnvironments?: string[];
  /**
  * Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#project_key DataArtifactoryFederatedCargoRepository#project_key}
  */
  readonly projectKey?: string;
  /**
  * List of property set name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#property_sets DataArtifactoryFederatedCargoRepository#property_sets}
  */
  readonly propertySets?: string[];
  /**
  * Proxy key from Artifactory Proxies settings. Can't be set if `disable_proxy = true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#proxy DataArtifactoryFederatedCargoRepository#proxy}
  */
  readonly proxy?: string;
  /**
  * Repository layout key for the federated repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#repo_layout_ref DataArtifactoryFederatedCargoRepository#repo_layout_ref}
  */
  readonly repoLayoutRef?: string;
  /**
  * Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via Xray settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#xray_index DataArtifactoryFederatedCargoRepository#xray_index}
  */
  readonly xrayIndex?: boolean | cdktf.IResolvable;
  /**
  * member block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#member DataArtifactoryFederatedCargoRepository#member}
  */
  readonly member?: DataArtifactoryFederatedCargoRepositoryMember[] | cdktf.IResolvable;
}
export interface DataArtifactoryFederatedCargoRepositoryMember {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#access_token DataArtifactoryFederatedCargoRepository#access_token}
  */
  readonly accessToken?: string;
  /**
  * Represents the active state of the federated member. It is supported to change the enabled status of my own member. The config will be updated on the other federated members automatically.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#enabled DataArtifactoryFederatedCargoRepository#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Full URL to ending with the repositoryName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#url DataArtifactoryFederatedCargoRepository#url}
  */
  readonly url: string;
}

export function dataArtifactoryFederatedCargoRepositoryMemberToTerraform(struct?: DataArtifactoryFederatedCargoRepositoryMember | cdktf.IResolvable): any {
...
export function dataArtifactoryFederatedCargoRepositoryMemberToHclTerraform(struct?: DataArtifactoryFederatedCargoRepositoryMember | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataArtifactoryFederatedCargoRepositoryMemberOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataArtifactoryFederatedCargoRepositoryMember | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataArtifactoryFederatedCargoRepositoryMember | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataArtifactoryFederatedCargoRepositoryMemberList extends cdktf.ComplexList {
  public internalValue? : DataArtifactoryFederatedCargoRepositoryMember[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataArtifactoryFederatedCargoRepositoryMemberOutputReference {
    return new DataArtifactoryFederatedCargoRepositoryMemberOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository artifactory_federated_cargo_repository}
*/
export class DataArtifactoryFederatedCargoRepository extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "artifactory_federated_cargo_repository";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataArtifactoryFederatedCargoRepository resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataArtifactoryFederatedCargoRepository to import
  * @param importFromId The id of the existing DataArtifactoryFederatedCargoRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataArtifactoryFederatedCargoRepository to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "artifactory_federated_cargo_repository", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_cargo_repository artifactory_federated_cargo_repository} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataArtifactoryFederatedCargoRepositoryConfig
  */
  public constructor(scope: Construct, id: string, config: DataArtifactoryFederatedCargoRepositoryConfig) {
    super(scope, id, {
    ...
    this._anonymousAccess = config.anonymousAccess;
    ...
    this._enableSparseIndex = config.enableSparseIndex;
  ...
  private _anonymousAccess?: boolean | cdktf.IResolvable; 
  public get anonymousAccess() {
    return this.getBooleanAttribute('anonymous_access');
  }
  public set anonymousAccess(value: boolean | cdktf.IResolvable) {
    this._anonymousAccess = value;
  }
  public resetAnonymousAccess() {
    this._anonymousAccess = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  // enable_sparse_index - computed: false, optional: true, required: false
  private _enableSparseIndex?: boolean | cdktf.IResolvable; 
  public get enableSparseIndex() {
    return this.getBooleanAttribute('enable_sparse_index');
  }
  public set enableSparseIndex(value: boolean | cdktf.IResolvable) {
    this._enableSparseIndex = value;
  }
  public resetEnableSparseIndex() {
    this._enableSparseIndex = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get enableSparseIndexInput() {
    return this._enableSparseIndex;
  }
  ...
  private _member = new DataArtifactoryFederatedCargoRepositoryMemberList(this, "member", true);
  public get member() {
    return this._member;
  }
  public putMember(value: DataArtifactoryFederatedCargoRepositoryMember[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      anonymous_access: cdktf.booleanToTerraform(this._anonymousAccess),
      ...
      enable_sparse_index: cdktf.booleanToTerraform(this._enableSparseIndex),
      ...
      member: cdktf.listMapper(dataArtifactoryFederatedCargoRepositoryMemberToTerraform, true)(this._member.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      anonymous_access: {
        value: cdktf.booleanToHclTerraform(this._anonymousAccess),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      enable_sparse_index: {
        value: cdktf.booleanToHclTerraform(this._enableSparseIndex),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      member: {
        value: cdktf.listMapperHcl(dataArtifactoryFederatedCargoRepositoryMemberToHclTerraform, true)(this._member.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataArtifactoryFederatedCargoRepositoryMemberList",
      },
    };
