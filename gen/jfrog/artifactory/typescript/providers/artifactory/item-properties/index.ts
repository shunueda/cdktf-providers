// https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/item_properties
...
export interface ItemPropertiesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/item_properties#is_recursive ItemProperties#is_recursive}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/item_properties#item_path ItemProperties#item_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/item_properties#properties ItemProperties#properties}
  */
  readonly properties: { [key: string]: string[] } | cdktf.IResolvable;
  /**
  * Respository key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/item_properties#repo_key ItemProperties#repo_key}
  */
  readonly repoKey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/item_properties artifactory_item_properties}
*/
export class ItemProperties extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ItemProperties that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/item_properties#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/item_properties artifactory_item_properties} Resource
  *
  * @param scope The scope in which to define this construct
