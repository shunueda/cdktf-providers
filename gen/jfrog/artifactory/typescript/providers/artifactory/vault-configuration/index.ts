// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration
...
export interface VaultConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration#config VaultConfiguration#config}
  */
  readonly config: VaultConfigurationConfigA;
  /**
  * Name of the Vault configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration#name VaultConfiguration#name}
  */
...
export interface VaultConfigurationConfigAuth {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration#certificate VaultConfiguration#certificate}
  */
  readonly certificate?: string;
  /**
  * Private key (in PEM format) for `Certificate` type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration#certificate_key VaultConfiguration#certificate_key}
  */
  readonly certificateKey?: string;
  /**
  * Role ID for `AppRole` type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration#role_id VaultConfiguration#role_id}
  */
  readonly roleId?: string;
  /**
  * Secret ID for `AppRole` type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration#secret_id VaultConfiguration#secret_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration#type VaultConfiguration#type}
  */
...
export interface VaultConfigurationConfigMounts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration#path VaultConfiguration#path}
  */
...
export interface VaultConfigurationConfigA {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration#auth VaultConfiguration#auth}
  */
  readonly auth: VaultConfigurationConfigAuth;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration#mounts VaultConfiguration#mounts}
  */
  readonly mounts: VaultConfigurationConfigMounts[] | cdktf.IResolvable;
  /**
  * The base URL of the Vault server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration#url VaultConfiguration#url}
  */
  readonly url: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration artifactory_vault_configuration}
*/
export class VaultConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VaultConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/vault_configuration artifactory_vault_configuration} Resource
  *
  * @param scope The scope in which to define this construct
