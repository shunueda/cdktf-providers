// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook
...
export interface DistributionWebhookConfig extends cdktf.TerraformMetaArguments {
  /**
  * Description of webhook. Max length 1000 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#description DistributionWebhook#description}
  */
  readonly description?: string;
  /**
  * Status of webhook. Default to `true`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#enabled DistributionWebhook#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#event_types DistributionWebhook#event_types}
  */
  readonly eventTypes: string[];
  /**
  * Key of webhook. Must be between 2 and 200 characters. Cannot contain spaces.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#key DistributionWebhook#key}
  */
  readonly key: string;
  /**
  * criteria block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#criteria DistributionWebhook#criteria}
  */
  readonly criteria?: DistributionWebhookCriteria[] | cdktf.IResolvable;
  /**
  * handler block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#handler DistributionWebhook#handler}
  */
...
export interface DistributionWebhookCriteria {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#any_release_bundle DistributionWebhook#any_release_bundle}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#exclude_patterns DistributionWebhook#exclude_patterns}
  */
  ...
  * For example: `product_*`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#include_patterns DistributionWebhook#include_patterns}
  */
  readonly includePatterns?: string[];
  /**
  * Trigger on this list of release bundle names
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#registered_release_bundle_names DistributionWebhook#registered_release_bundle_names}
  */
  readonly registeredReleaseBundleNames?: string[];
}

export function distributionWebhookCriteriaToTerraform(struct?: DistributionWebhookCriteria | cdktf.IResolvable): any {
...
export function distributionWebhookCriteriaToHclTerraform(struct?: DistributionWebhookCriteria | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DistributionWebhookCriteriaOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DistributionWebhookCriteria | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DistributionWebhookCriteria | cdktf.IResolvable | undefined) {
    if (value === undefined) {
  ...
  // registered_release_bundle_names - computed: false, optional: true, required: false
  ...
  public resetRegisteredReleaseBundleNames() {
    this._registeredReleaseBundleNames = undefined;
  }
  // Temporarily expose input value. Use with caution.
...
export class DistributionWebhookCriteriaList extends cdktf.ComplexList {
  public internalValue? : DistributionWebhookCriteria[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DistributionWebhookCriteriaOutputReference {
    return new DistributionWebhookCriteriaOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DistributionWebhookHandler {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#custom_http_headers DistributionWebhook#custom_http_headers}
  */
  readonly customHttpHeaders?: { [key: string]: string };
  /**
  * Proxy key from Artifactory Proxies setting
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#proxy DistributionWebhook#proxy}
  */
  readonly proxy?: string;
  /**
  * Secret authentication token that will be sent to the configured URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#secret DistributionWebhook#secret}
  */
  readonly secret?: string;
  /**
  * Specifies the URL that the Webhook invokes. This will be the URL that Artifactory will send an HTTP POST request to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#url DistributionWebhook#url}
  */
  readonly url: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#use_secret_for_signing DistributionWebhook#use_secret_for_signing}
  */
  readonly useSecretForSigning?: boolean | cdktf.IResolvable;
}

export function distributionWebhookHandlerToTerraform(struct?: DistributionWebhookHandler | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function distributionWebhookHandlerToHclTerraform(struct?: DistributionWebhookHandler | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DistributionWebhookHandlerOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DistributionWebhookHandler | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DistributionWebhookHandler | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DistributionWebhookHandlerList extends cdktf.ComplexList {
  public internalValue? : DistributionWebhookHandler[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DistributionWebhookHandlerOutputReference {
    return new DistributionWebhookHandlerOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook artifactory_distribution_webhook}
*/
export class DistributionWebhook extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "artifactory_distribution_webhook";
  ...
  * @param importFromId The id of the existing DistributionWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "artifactory_distribution_webhook", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/distribution_webhook artifactory_distribution_webhook} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DistributionWebhookConfig
  */
  public constructor(scope: Construct, id: string, config: DistributionWebhookConfig) {
    super(scope, id, {
  ...
  private _criteria = new DistributionWebhookCriteriaList(this, "criteria", true);
  public get criteria() {
    return this._criteria;
  }
  public putCriteria(value: DistributionWebhookCriteria[] | cdktf.IResolvable) {
  ...
  private _handler = new DistributionWebhookHandlerList(this, "handler", true);
  public get handler() {
    return this._handler;
  }
  public putHandler(value: DistributionWebhookHandler[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      criteria: cdktf.listMapper(distributionWebhookCriteriaToTerraform, true)(this._criteria.internalValue),
      handler: cdktf.listMapper(distributionWebhookHandlerToTerraform, true)(this._handler.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      criteria: {
        value: cdktf.listMapperHcl(distributionWebhookCriteriaToHclTerraform, true)(this._criteria.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DistributionWebhookCriteriaList",
      },
      handler: {
        value: cdktf.listMapperHcl(distributionWebhookHandlerToHclTerraform, true)(this._handler.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DistributionWebhookHandlerList",
      },
    };
