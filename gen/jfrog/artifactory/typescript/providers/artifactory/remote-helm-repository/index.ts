// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository
...
export interface RemoteHelmRepositoryConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#allow_any_host_auth RemoteHelmRepository#allow_any_host_auth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#archive_browsing_enabled RemoteHelmRepository#archive_browsing_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#assumed_offline_period_secs RemoteHelmRepository#assumed_offline_period_secs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#blacked_out RemoteHelmRepository#blacked_out}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#block_mismatching_mime_types RemoteHelmRepository#block_mismatching_mime_types}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#bypass_head_requests RemoteHelmRepository#bypass_head_requests}
  */
  readonly bypassHeadRequests?: boolean | cdktf.IResolvable;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#cdn_redirect RemoteHelmRepository#cdn_redirect}
  */
  readonly cdnRedirect?: boolean | cdktf.IResolvable;
  /**
  * Client TLS certificate name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#client_tls_certificate RemoteHelmRepository#client_tls_certificate}
  */
  readonly clientTlsCertificate?: string;
  /**
  * Public description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#description RemoteHelmRepository#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#disable_proxy RemoteHelmRepository#disable_proxy}
  */
  readonly disableProxy?: boolean | cdktf.IResolvable;
  /**
  * Whether to disable URL normalization. Default is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#disable_url_normalization RemoteHelmRepository#disable_url_normalization}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#download_direct RemoteHelmRepository#download_direct}
  */
  readonly downloadDirect?: boolean | cdktf.IResolvable;
  /**
  * Enables cookie management if the remote repository uses cookies to manage client state.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#enable_cookie_management RemoteHelmRepository#enable_cookie_management}
  */
  readonly enableCookieManagement?: boolean | cdktf.IResolvable;
  /**
  * List of artifact patterns to exclude when evaluating artifact requests, in the form of `x/y/** /z/*`.By default no artifacts are excluded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#excludes_pattern RemoteHelmRepository#excludes_pattern}
   *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#external_dependencies_enabled RemoteHelmRepository#external_dependencies_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#external_dependencies_patterns RemoteHelmRepository#external_dependencies_patterns}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#hard_fail RemoteHelmRepository#hard_fail}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#helm_charts_base_url RemoteHelmRepository#helm_charts_base_url}
  */
  readonly helmChartsBaseUrl?: string;
  /**
  * List of comma-separated artifact patterns to include when evaluating artifact requests in the form of `x/y/** /z/*`. When used, only artifacts matching one of the include patterns are served. By default, all artifacts are included (`** /*`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#includes_pattern RemoteHelmRepository#includes_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#key RemoteHelmRepository#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#list_remote_folder_items RemoteHelmRepository#list_remote_folder_items}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#local_address RemoteHelmRepository#local_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#metadata_retrieval_timeout_secs RemoteHelmRepository#metadata_retrieval_timeout_secs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#mismatching_mime_types_override_list RemoteHelmRepository#mismatching_mime_types_override_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#missed_cache_period_seconds RemoteHelmRepository#missed_cache_period_seconds}
  */
  readonly missedCachePeriodSeconds?: number;
  /**
  * Internal description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#notes RemoteHelmRepository#notes}
  */
  readonly notes?: string;
  /**
  * If set, Artifactory does not try to fetch remote artifacts. Only locally-cached artifacts are retrieved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#offline RemoteHelmRepository#offline}
  */
  readonly offline?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#password RemoteHelmRepository#password}
  */
  readonly password?: string;
  /**
  * Setting repositories with priority will cause metadata to be merged only from repositories set with this field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#priority_resolution RemoteHelmRepository#priority_resolution}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#project_environments RemoteHelmRepository#project_environments}
  */
  readonly projectEnvironments?: string[];
  /**
  * Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#project_key RemoteHelmRepository#project_key}
  */
  readonly projectKey?: string;
  /**
  * List of property set name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#property_sets RemoteHelmRepository#property_sets}
  */
  readonly propertySets?: string[];
  /**
  * Proxy key from Artifactory Proxies settings. Can't be set if `disable_proxy = true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#proxy RemoteHelmRepository#proxy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#query_params RemoteHelmRepository#query_params}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#remote_repo_layout_ref RemoteHelmRepository#remote_repo_layout_ref}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#repo_layout_ref RemoteHelmRepository#repo_layout_ref}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#retrieval_cache_period_seconds RemoteHelmRepository#retrieval_cache_period_seconds}
  */
  readonly retrievalCachePeriodSeconds?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#share_configuration RemoteHelmRepository#share_configuration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#socket_timeout_millis RemoteHelmRepository#socket_timeout_millis}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#store_artifacts_locally RemoteHelmRepository#store_artifacts_locally}
  */
  readonly storeArtifactsLocally?: boolean | cdktf.IResolvable;
  /**
  * When set, remote artifacts are fetched along with their properties.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#synchronize_properties RemoteHelmRepository#synchronize_properties}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#unused_artifacts_cleanup_period_hours RemoteHelmRepository#unused_artifacts_cleanup_period_hours}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#url RemoteHelmRepository#url}
  */
  readonly url: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#username RemoteHelmRepository#username}
  */
  readonly username?: string;
  /**
  * Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via Xray settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#xray_index RemoteHelmRepository#xray_index}
  */
  readonly xrayIndex?: boolean | cdktf.IResolvable;
  /**
  * content_synchronisation block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#content_synchronisation RemoteHelmRepository#content_synchronisation}
  */
  readonly contentSynchronisation?: RemoteHelmRepositoryContentSynchronisation[] | cdktf.IResolvable;
}
export interface RemoteHelmRepositoryContentSynchronisation {
  /**
  * If set, Remote repository proxies a local or remote repository from another instance of Artifactory. Default value is 'false'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#enabled RemoteHelmRepository#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * If set, properties for artifacts that have been cached in this repository will be updated if they are modified in the artifact hosted at the remote Artifactory instance. The trigger to synchronize the properties is download of the artifact from the remote repository cache of the local Artifactory instance. Default value is 'false'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#properties_enabled RemoteHelmRepository#properties_enabled}
  */
  readonly propertiesEnabled?: boolean | cdktf.IResolvable;
  /**
  * If set, Artifactory displays an indication on cached items if they have been deleted from the corresponding repository in the remote Artifactory instance. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#source_origin_absence_detection RemoteHelmRepository#source_origin_absence_detection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#statistics_enabled RemoteHelmRepository#statistics_enabled}
  */
  readonly statisticsEnabled?: boolean | cdktf.IResolvable;
}

export function remoteHelmRepositoryContentSynchronisationToTerraform(struct?: RemoteHelmRepositoryContentSynchronisation | cdktf.IResolvable): any {
...
export function remoteHelmRepositoryContentSynchronisationToHclTerraform(struct?: RemoteHelmRepositoryContentSynchronisation | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class RemoteHelmRepositoryContentSynchronisationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RemoteHelmRepositoryContentSynchronisation | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: RemoteHelmRepositoryContentSynchronisation | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class RemoteHelmRepositoryContentSynchronisationList extends cdktf.ComplexList {
  public internalValue? : RemoteHelmRepositoryContentSynchronisation[] | cdktf.IResolvable
  ...
  */
  public get(index: number): RemoteHelmRepositoryContentSynchronisationOutputReference {
    return new RemoteHelmRepositoryContentSynchronisationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository artifactory_remote_helm_repository}
*/
export class RemoteHelmRepository extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a RemoteHelmRepository resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the RemoteHelmRepository to import
  * @param importFromId The id of the existing RemoteHelmRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the RemoteHelmRepository to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/remote_helm_repository artifactory_remote_helm_repository} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options RemoteHelmRepositoryConfig
  */
  public constructor(scope: Construct, id: string, config: RemoteHelmRepositoryConfig) {
    super(scope, id, {
  ...
  public get externalDependenciesPatterns() {
    return cdktf.Fn.tolist(this.getListAttribute('external_dependencies_patterns'));
  }
  ...
  // helm_charts_base_url - computed: true, optional: true, required: false
  ...
  private _contentSynchronisation = new RemoteHelmRepositoryContentSynchronisationList(this, "content_synchronisation", false);
  public get contentSynchronisation() {
    return this._contentSynchronisation;
  }
  public putContentSynchronisation(value: RemoteHelmRepositoryContentSynchronisation[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      content_synchronisation: cdktf.listMapper(remoteHelmRepositoryContentSynchronisationToTerraform, true)(this._contentSynchronisation.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      content_synchronisation: {
        value: cdktf.listMapperHcl(remoteHelmRepositoryContentSynchronisationToHclTerraform, true)(this._contentSynchronisation.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "RemoteHelmRepositoryContentSynchronisationList",
      },
    };
