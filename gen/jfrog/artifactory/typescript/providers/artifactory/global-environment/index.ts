// https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/global_environment
...
export interface GlobalEnvironmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/global_environment#name GlobalEnvironment#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/global_environment artifactory_global_environment}
*/
export class GlobalEnvironment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlobalEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/global_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/global_environment artifactory_global_environment} Resource
  *
  * @param scope The scope in which to define this construct
