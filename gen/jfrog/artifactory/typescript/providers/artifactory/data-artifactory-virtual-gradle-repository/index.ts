// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository
...
export interface DataArtifactoryVirtualGradleRepositoryConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#artifactory_requests_can_retrieve_remote_artifacts DataArtifactoryVirtualGradleRepository#artifactory_requests_can_retrieve_remote_artifacts}
  */
  readonly artifactoryRequestsCanRetrieveRemoteArtifacts?: boolean | cdktf.IResolvable;
  /**
  * Default repository to deploy artifacts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#default_deployment_repo DataArtifactoryVirtualGradleRepository#default_deployment_repo}
  */
  readonly defaultDeploymentRepo?: string;
  /**
  * Public description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#description DataArtifactoryVirtualGradleRepository#description}
  */
  readonly description?: string;
  /**
  * List of artifact patterns to exclude when evaluating artifact requests, in the form of `x/y/** /z/*`.By default no artifacts are excluded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#excludes_pattern DataArtifactoryVirtualGradleRepository#excludes_pattern}
   *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#force_maven_authentication DataArtifactoryVirtualGradleRepository#force_maven_authentication}
  */
  readonly forceMavenAuthentication?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#id DataArtifactoryVirtualGradleRepository#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#includes_pattern DataArtifactoryVirtualGradleRepository#includes_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#key DataArtifactoryVirtualGradleRepository#key}
  */
  readonly key: string;
  /**
  * The keypair used to sign artifacts
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#key_pair DataArtifactoryVirtualGradleRepository#key_pair}
  */
  readonly keyPair?: string;
  /**
  * Internal description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#notes DataArtifactoryVirtualGradleRepository#notes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#pom_repository_references_cleanup_policy DataArtifactoryVirtualGradleRepository#pom_repository_references_cleanup_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#project_environments DataArtifactoryVirtualGradleRepository#project_environments}
  */
  readonly projectEnvironments?: string[];
  /**
  * Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#project_key DataArtifactoryVirtualGradleRepository#project_key}
  */
  readonly projectKey?: string;
  /**
  * Repository layout key for the virtual repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#repo_layout_ref DataArtifactoryVirtualGradleRepository#repo_layout_ref}
  */
  readonly repoLayoutRef?: string;
  /**
  * The effective list of actual repositories included in this virtual repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#repositories DataArtifactoryVirtualGradleRepository#repositories}
  */
  readonly repositories?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository artifactory_virtual_gradle_repository}
*/
export class DataArtifactoryVirtualGradleRepository extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "artifactory_virtual_gradle_repository";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataArtifactoryVirtualGradleRepository resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataArtifactoryVirtualGradleRepository to import
  * @param importFromId The id of the existing DataArtifactoryVirtualGradleRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataArtifactoryVirtualGradleRepository to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "artifactory_virtual_gradle_repository", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/virtual_gradle_repository artifactory_virtual_gradle_repository} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataArtifactoryVirtualGradleRepositoryConfig
  */
  public constructor(scope: Construct, id: string, config: DataArtifactoryVirtualGradleRepositoryConfig) {
    super(scope, id, {
      terraformResourceType: 'artifactory_virtual_gradle_repository',
