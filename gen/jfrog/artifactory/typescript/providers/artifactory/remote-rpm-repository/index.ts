// https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository
...
export interface RemoteRpmRepositoryConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#allow_any_host_auth RemoteRpmRepository#allow_any_host_auth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#archive_browsing_enabled RemoteRpmRepository#archive_browsing_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#assumed_offline_period_secs RemoteRpmRepository#assumed_offline_period_secs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#blacked_out RemoteRpmRepository#blacked_out}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#block_mismatching_mime_types RemoteRpmRepository#block_mismatching_mime_types}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#bypass_head_requests RemoteRpmRepository#bypass_head_requests}
  */
  readonly bypassHeadRequests?: boolean | cdktf.IResolvable;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#cdn_redirect RemoteRpmRepository#cdn_redirect}
  */
  readonly cdnRedirect?: boolean | cdktf.IResolvable;
  /**
  * Client TLS certificate name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#client_tls_certificate RemoteRpmRepository#client_tls_certificate}
  */
  readonly clientTlsCertificate?: string;
  /**
  * Public description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#description RemoteRpmRepository#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#disable_proxy RemoteRpmRepository#disable_proxy}
  */
  readonly disableProxy?: boolean | cdktf.IResolvable;
  /**
  * Whether to disable URL normalization. Default is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#disable_url_normalization RemoteRpmRepository#disable_url_normalization}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#download_direct RemoteRpmRepository#download_direct}
  */
  readonly downloadDirect?: boolean | cdktf.IResolvable;
  /**
  * Enables cookie management if the remote repository uses cookies to manage client state.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#enable_cookie_management RemoteRpmRepository#enable_cookie_management}
  */
  readonly enableCookieManagement?: boolean | cdktf.IResolvable;
  /**
  * List of artifact patterns to exclude when evaluating artifact requests, in the form of `x/y/** /z/*`.By default no artifacts are excluded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#excludes_pattern RemoteRpmRepository#excludes_pattern}
   *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#hard_fail RemoteRpmRepository#hard_fail}
  */
  readonly hardFail?: boolean | cdktf.IResolvable;
  /**
  * List of comma-separated artifact patterns to include when evaluating artifact requests in the form of `x/y/** /z/*`. When used, only artifacts matching one of the include patterns are served. By default, all artifacts are included (`** /*`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#includes_pattern RemoteRpmRepository#includes_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#key RemoteRpmRepository#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#list_remote_folder_items RemoteRpmRepository#list_remote_folder_items}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#local_address RemoteRpmRepository#local_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#metadata_retrieval_timeout_secs RemoteRpmRepository#metadata_retrieval_timeout_secs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#mismatching_mime_types_override_list RemoteRpmRepository#mismatching_mime_types_override_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#missed_cache_period_seconds RemoteRpmRepository#missed_cache_period_seconds}
  */
  readonly missedCachePeriodSeconds?: number;
  /**
  * Internal description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#notes RemoteRpmRepository#notes}
  */
  readonly notes?: string;
  /**
  * If set, Artifactory does not try to fetch remote artifacts. Only locally-cached artifacts are retrieved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#offline RemoteRpmRepository#offline}
  */
  readonly offline?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#password RemoteRpmRepository#password}
  */
  readonly password?: string;
  /**
  * Setting repositories with priority will cause metadata to be merged only from repositories set with this field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#priority_resolution RemoteRpmRepository#priority_resolution}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#project_environments RemoteRpmRepository#project_environments}
  */
  readonly projectEnvironments?: string[];
  /**
  * Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#project_key RemoteRpmRepository#project_key}
  */
  readonly projectKey?: string;
  /**
  * List of property set name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#property_sets RemoteRpmRepository#property_sets}
  */
  readonly propertySets?: string[];
  /**
  * Proxy key from Artifactory Proxies settings. Can't be set if `disable_proxy = true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#proxy RemoteRpmRepository#proxy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#query_params RemoteRpmRepository#query_params}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#remote_repo_layout_ref RemoteRpmRepository#remote_repo_layout_ref}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#repo_layout_ref RemoteRpmRepository#repo_layout_ref}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#retrieval_cache_period_seconds RemoteRpmRepository#retrieval_cache_period_seconds}
  */
  readonly retrievalCachePeriodSeconds?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#share_configuration RemoteRpmRepository#share_configuration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#socket_timeout_millis RemoteRpmRepository#socket_timeout_millis}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#store_artifacts_locally RemoteRpmRepository#store_artifacts_locally}
  */
  readonly storeArtifactsLocally?: boolean | cdktf.IResolvable;
  /**
  * When set, remote artifacts are fetched along with their properties.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#synchronize_properties RemoteRpmRepository#synchronize_properties}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#unused_artifacts_cleanup_period_hours RemoteRpmRepository#unused_artifacts_cleanup_period_hours}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#url RemoteRpmRepository#url}
  */
  readonly url: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#username RemoteRpmRepository#username}
  */
  readonly username?: string;
  /**
  * Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via Xray settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#xray_index RemoteRpmRepository#xray_index}
  */
  readonly xrayIndex?: boolean | cdktf.IResolvable;
  /**
  * content_synchronisation block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#content_synchronisation RemoteRpmRepository#content_synchronisation}
  */
  readonly contentSynchronisation?: RemoteRpmRepositoryContentSynchronisation[] | cdktf.IResolvable;
}
export interface RemoteRpmRepositoryContentSynchronisation {
  /**
  * If set, Remote repository proxies a local or remote repository from another instance of Artifactory. Default value is 'false'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#enabled RemoteRpmRepository#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * If set, properties for artifacts that have been cached in this repository will be updated if they are modified in the artifact hosted at the remote Artifactory instance. The trigger to synchronize the properties is download of the artifact from the remote repository cache of the local Artifactory instance. Default value is 'false'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#properties_enabled RemoteRpmRepository#properties_enabled}
  */
  readonly propertiesEnabled?: boolean | cdktf.IResolvable;
  /**
  * If set, Artifactory displays an indication on cached items if they have been deleted from the corresponding repository in the remote Artifactory instance. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#source_origin_absence_detection RemoteRpmRepository#source_origin_absence_detection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#statistics_enabled RemoteRpmRepository#statistics_enabled}
  */
  readonly statisticsEnabled?: boolean | cdktf.IResolvable;
}

export function remoteRpmRepositoryContentSynchronisationToTerraform(struct?: RemoteRpmRepositoryContentSynchronisation | cdktf.IResolvable): any {
...
export function remoteRpmRepositoryContentSynchronisationToHclTerraform(struct?: RemoteRpmRepositoryContentSynchronisation | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class RemoteRpmRepositoryContentSynchronisationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RemoteRpmRepositoryContentSynchronisation | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: RemoteRpmRepositoryContentSynchronisation | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class RemoteRpmRepositoryContentSynchronisationList extends cdktf.ComplexList {
  public internalValue? : RemoteRpmRepositoryContentSynchronisation[] | cdktf.IResolvable
  ...
  */
  public get(index: number): RemoteRpmRepositoryContentSynchronisationOutputReference {
    return new RemoteRpmRepositoryContentSynchronisationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository artifactory_remote_rpm_repository}
*/
export class RemoteRpmRepository extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "artifactory_remote_rpm_repository";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a RemoteRpmRepository resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the RemoteRpmRepository to import
  * @param importFromId The id of the existing RemoteRpmRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the RemoteRpmRepository to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "artifactory_remote_rpm_repository", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_rpm_repository artifactory_remote_rpm_repository} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options RemoteRpmRepositoryConfig
  */
  public constructor(scope: Construct, id: string, config: RemoteRpmRepositoryConfig) {
    super(scope, id, {
      terraformResourceType: 'artifactory_remote_rpm_repository',
  ...
  private _contentSynchronisation = new RemoteRpmRepositoryContentSynchronisationList(this, "content_synchronisation", false);
  public get contentSynchronisation() {
    return this._contentSynchronisation;
  }
  public putContentSynchronisation(value: RemoteRpmRepositoryContentSynchronisation[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      content_synchronisation: cdktf.listMapper(remoteRpmRepositoryContentSynchronisationToTerraform, true)(this._contentSynchronisation.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      content_synchronisation: {
        value: cdktf.listMapperHcl(remoteRpmRepositoryContentSynchronisationToHclTerraform, true)(this._contentSynchronisation.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "RemoteRpmRepositoryContentSynchronisationList",
      },
    };
