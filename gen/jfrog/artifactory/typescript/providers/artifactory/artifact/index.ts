// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/artifact
...
export interface ArtifactConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/artifact#content_base64 Artifact#content_base64}
  */
  readonly contentBase64?: string;
  /**
  * Path to the source file. Conflicts with `content_base64`. Either one of these attribute must be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/artifact#file_path Artifact#file_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/artifact#path Artifact#path}
  */
  readonly path: string;
  /**
  * Name of the respository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/artifact#repository Artifact#repository}
  */
  readonly repository: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/artifact artifactory_artifact}
*/
export class Artifact extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Artifact that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/artifact#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/artifact artifactory_artifact} Resource
  *
  * @param scope The scope in which to define this construct
