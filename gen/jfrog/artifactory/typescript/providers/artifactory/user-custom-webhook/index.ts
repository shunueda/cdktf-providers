// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook
...
export interface UserCustomWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook#description UserCustomWebhook#description}
  */
  readonly description?: string;
  /**
  * Status of webhook. Default to `true`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook#enabled UserCustomWebhook#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook#event_types UserCustomWebhook#event_types}
  */
  readonly eventTypes: string[];
  /**
  * Key of webhook. Must be between 2 and 200 characters. Cannot contain spaces.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook#key UserCustomWebhook#key}
  */
  readonly key: string;
  /**
  * handler block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook#handler UserCustomWebhook#handler}
  */
...
export interface UserCustomWebhookHandler {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook#http_headers UserCustomWebhook#http_headers}
  */
  readonly httpHeaders?: { [key: string]: string };
  /**
  * Specifies the HTTP Method for URL that the Webhook invokes. Allowed values are: `GET`, `POST`, `PUT`, `PATCH`, `DELETE`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook#method UserCustomWebhook#method}
  */
  readonly method?: string;
  /**
  * This attribute is used to build the request body. Used in custom webhooks
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook#payload UserCustomWebhook#payload}
  */
  readonly payload?: string;
  /**
  * Proxy key from Artifactory Proxies setting
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook#proxy UserCustomWebhook#proxy}
  */
  readonly proxy?: string;
  /**
  * A set of sensitive values that will be injected in the request (headers and/or payload), comprise of key/value pair.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook#secrets UserCustomWebhook#secrets}
  */
  readonly secrets?: { [key: string]: string };
  /**
  * Specifies the URL that the Webhook invokes. This will be the URL that Artifactory will send an HTTP POST request to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook#url UserCustomWebhook#url}
  */
  readonly url: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook artifactory_user_custom_webhook}
*/
export class UserCustomWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserCustomWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_custom_webhook artifactory_user_custom_webhook} Resource
  *
  * @param scope The scope in which to define this construct
