// https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/anonymous_user
...
export interface AnonymousUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/anonymous_user#name AnonymousUser#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/anonymous_user artifactory_anonymous_user}
*/
export class AnonymousUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AnonymousUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/anonymous_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/anonymous_user artifactory_anonymous_user} Resource
  *
  * @param scope The scope in which to define this construct
