// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook
...
export interface ReleaseBundleCustomWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#description ReleaseBundleCustomWebhook#description}
  */
  readonly description?: string;
  /**
  * Status of webhook. Default to `true`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#enabled ReleaseBundleCustomWebhook#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#event_types ReleaseBundleCustomWebhook#event_types}
  */
  readonly eventTypes: string[];
  /**
  * Key of webhook. Must be between 2 and 200 characters. Cannot contain spaces.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#key ReleaseBundleCustomWebhook#key}
  */
  readonly key: string;
  /**
  * criteria block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#criteria ReleaseBundleCustomWebhook#criteria}
  */
  readonly criteria?: ReleaseBundleCustomWebhookCriteria[] | cdktf.IResolvable;
  /**
  * handler block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#handler ReleaseBundleCustomWebhook#handler}
  */
...
export interface ReleaseBundleCustomWebhookCriteria {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#any_release_bundle ReleaseBundleCustomWebhook#any_release_bundle}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#exclude_patterns ReleaseBundleCustomWebhook#exclude_patterns}
  */
  ...
  * For example: `product_*`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#include_patterns ReleaseBundleCustomWebhook#include_patterns}
  */
  readonly includePatterns?: string[];
  /**
  * Trigger on this list of release bundle names
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#registered_release_bundle_names ReleaseBundleCustomWebhook#registered_release_bundle_names}
  */
...
export interface ReleaseBundleCustomWebhookHandler {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#http_headers ReleaseBundleCustomWebhook#http_headers}
  */
  readonly httpHeaders?: { [key: string]: string };
  /**
  * Specifies the HTTP Method for URL that the Webhook invokes. Allowed values are: `GET`, `POST`, `PUT`, `PATCH`, `DELETE`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#method ReleaseBundleCustomWebhook#method}
  */
  readonly method?: string;
  /**
  * This attribute is used to build the request body. Used in custom webhooks
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#payload ReleaseBundleCustomWebhook#payload}
  */
  readonly payload?: string;
  /**
  * Proxy key from Artifactory Proxies setting
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#proxy ReleaseBundleCustomWebhook#proxy}
  */
  readonly proxy?: string;
  /**
  * A set of sensitive values that will be injected in the request (headers and/or payload), comprise of key/value pair.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#secrets ReleaseBundleCustomWebhook#secrets}
  */
  readonly secrets?: { [key: string]: string };
  /**
  * Specifies the URL that the Webhook invokes. This will be the URL that Artifactory will send an HTTP POST request to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#url ReleaseBundleCustomWebhook#url}
  */
  readonly url: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook artifactory_release_bundle_custom_webhook}
*/
export class ReleaseBundleCustomWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ReleaseBundleCustomWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_custom_webhook artifactory_release_bundle_custom_webhook} Resource
  *
  * @param scope The scope in which to define this construct
