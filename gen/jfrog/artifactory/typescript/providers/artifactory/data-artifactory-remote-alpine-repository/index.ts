// https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository
...
export interface DataArtifactoryRemoteAlpineRepositoryConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#allow_any_host_auth DataArtifactoryRemoteAlpineRepository#allow_any_host_auth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#archive_browsing_enabled DataArtifactoryRemoteAlpineRepository#archive_browsing_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#assumed_offline_period_secs DataArtifactoryRemoteAlpineRepository#assumed_offline_period_secs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#blacked_out DataArtifactoryRemoteAlpineRepository#blacked_out}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#block_mismatching_mime_types DataArtifactoryRemoteAlpineRepository#block_mismatching_mime_types}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#bypass_head_requests DataArtifactoryRemoteAlpineRepository#bypass_head_requests}
  */
  readonly bypassHeadRequests?: boolean | cdktf.IResolvable;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#cdn_redirect DataArtifactoryRemoteAlpineRepository#cdn_redirect}
  */
  readonly cdnRedirect?: boolean | cdktf.IResolvable;
  /**
  * Client TLS certificate name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#client_tls_certificate DataArtifactoryRemoteAlpineRepository#client_tls_certificate}
  */
  readonly clientTlsCertificate?: string;
  /**
  * Public description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#description DataArtifactoryRemoteAlpineRepository#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#disable_proxy DataArtifactoryRemoteAlpineRepository#disable_proxy}
  */
  readonly disableProxy?: boolean | cdktf.IResolvable;
  /**
  * Whether to disable URL normalization, default is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#disable_url_normalization DataArtifactoryRemoteAlpineRepository#disable_url_normalization}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#download_direct DataArtifactoryRemoteAlpineRepository#download_direct}
  */
  readonly downloadDirect?: boolean | cdktf.IResolvable;
  /**
  * Enables cookie management if the remote repository uses cookies to manage client state.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#enable_cookie_management DataArtifactoryRemoteAlpineRepository#enable_cookie_management}
  */
  readonly enableCookieManagement?: boolean | cdktf.IResolvable;
  /**
  * List of artifact patterns to exclude when evaluating artifact requests, in the form of `x/y/** /z/*`.By default no artifacts are excluded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#excludes_pattern DataArtifactoryRemoteAlpineRepository#excludes_pattern}
   *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#hard_fail DataArtifactoryRemoteAlpineRepository#hard_fail}
  */
  readonly hardFail?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#id DataArtifactoryRemoteAlpineRepository#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#includes_pattern DataArtifactoryRemoteAlpineRepository#includes_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#key DataArtifactoryRemoteAlpineRepository#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#list_remote_folder_items DataArtifactoryRemoteAlpineRepository#list_remote_folder_items}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#local_address DataArtifactoryRemoteAlpineRepository#local_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#metadata_retrieval_timeout_secs DataArtifactoryRemoteAlpineRepository#metadata_retrieval_timeout_secs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#mismatching_mime_types_override_list DataArtifactoryRemoteAlpineRepository#mismatching_mime_types_override_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#missed_cache_period_seconds DataArtifactoryRemoteAlpineRepository#missed_cache_period_seconds}
  */
  readonly missedCachePeriodSeconds?: number;
  /**
  * Internal description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#notes DataArtifactoryRemoteAlpineRepository#notes}
  */
  readonly notes?: string;
  /**
  * If set, Artifactory does not try to fetch remote artifacts. Only locally-cached artifacts are retrieved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#offline DataArtifactoryRemoteAlpineRepository#offline}
  */
  readonly offline?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#password DataArtifactoryRemoteAlpineRepository#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#priority_resolution DataArtifactoryRemoteAlpineRepository#priority_resolution}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#project_environments DataArtifactoryRemoteAlpineRepository#project_environments}
  */
  readonly projectEnvironments?: string[];
  /**
  * Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#project_key DataArtifactoryRemoteAlpineRepository#project_key}
  */
  readonly projectKey?: string;
  /**
  * List of property set names
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#property_sets DataArtifactoryRemoteAlpineRepository#property_sets}
  */
  readonly propertySets?: string[];
  /**
  * Proxy key from Artifactory Proxies settings. Can't be set if `disable_proxy = true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#proxy DataArtifactoryRemoteAlpineRepository#proxy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#query_params DataArtifactoryRemoteAlpineRepository#query_params}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#remote_repo_layout_ref DataArtifactoryRemoteAlpineRepository#remote_repo_layout_ref}
  */
  readonly remoteRepoLayoutRef?: string;
  /**
  * Repository layout key for the remote repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#repo_layout_ref DataArtifactoryRemoteAlpineRepository#repo_layout_ref}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#retrieval_cache_period_seconds DataArtifactoryRemoteAlpineRepository#retrieval_cache_period_seconds}
  */
  readonly retrievalCachePeriodSeconds?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#share_configuration DataArtifactoryRemoteAlpineRepository#share_configuration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#socket_timeout_millis DataArtifactoryRemoteAlpineRepository#socket_timeout_millis}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#store_artifacts_locally DataArtifactoryRemoteAlpineRepository#store_artifacts_locally}
  */
  readonly storeArtifactsLocally?: boolean | cdktf.IResolvable;
  /**
  * When set, remote artifacts are fetched along with their properties.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#synchronize_properties DataArtifactoryRemoteAlpineRepository#synchronize_properties}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#unused_artifacts_cleanup_period_hours DataArtifactoryRemoteAlpineRepository#unused_artifacts_cleanup_period_hours}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#url DataArtifactoryRemoteAlpineRepository#url}
  */
  readonly url?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#username DataArtifactoryRemoteAlpineRepository#username}
  */
  readonly username?: string;
  /**
  * Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via Xray settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#xray_index DataArtifactoryRemoteAlpineRepository#xray_index}
  */
  readonly xrayIndex?: boolean | cdktf.IResolvable;
  /**
  * content_synchronisation block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#content_synchronisation DataArtifactoryRemoteAlpineRepository#content_synchronisation}
  */
  readonly contentSynchronisation?: DataArtifactoryRemoteAlpineRepositoryContentSynchronisation;
}
export interface DataArtifactoryRemoteAlpineRepositoryContentSynchronisation {
  /**
  * If set, Remote repository proxies a local or remote repository from another instance of Artifactory. Default value is 'false'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#enabled DataArtifactoryRemoteAlpineRepository#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * If set, properties for artifacts that have been cached in this repository will be updated if they are modified in the artifact hosted at the remote Artifactory instance. The trigger to synchronize the properties is download of the artifact from the remote repository cache of the local Artifactory instance. Default value is 'false'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#properties_enabled DataArtifactoryRemoteAlpineRepository#properties_enabled}
  */
  readonly propertiesEnabled?: boolean | cdktf.IResolvable;
  /**
  * If set, Artifactory displays an indication on cached items if they have been deleted from the corresponding repository in the remote Artifactory instance. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#source_origin_absence_detection DataArtifactoryRemoteAlpineRepository#source_origin_absence_detection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#statistics_enabled DataArtifactoryRemoteAlpineRepository#statistics_enabled}
  */
  readonly statisticsEnabled?: boolean | cdktf.IResolvable;
}

export function dataArtifactoryRemoteAlpineRepositoryContentSynchronisationToTerraform(struct?: DataArtifactoryRemoteAlpineRepositoryContentSynchronisationOutputReference | DataArtifactoryRemoteAlpineRepositoryContentSynchronisation): any {
...
export function dataArtifactoryRemoteAlpineRepositoryContentSynchronisationToHclTerraform(struct?: DataArtifactoryRemoteAlpineRepositoryContentSynchronisationOutputReference | DataArtifactoryRemoteAlpineRepositoryContentSynchronisation): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataArtifactoryRemoteAlpineRepositoryContentSynchronisationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataArtifactoryRemoteAlpineRepositoryContentSynchronisation | undefined {
  ...
  public set internalValue(value: DataArtifactoryRemoteAlpineRepositoryContentSynchronisation | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository artifactory_remote_alpine_repository}
*/
export class DataArtifactoryRemoteAlpineRepository extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "artifactory_remote_alpine_repository";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataArtifactoryRemoteAlpineRepository resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataArtifactoryRemoteAlpineRepository to import
  * @param importFromId The id of the existing DataArtifactoryRemoteAlpineRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataArtifactoryRemoteAlpineRepository to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "artifactory_remote_alpine_repository", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/remote_alpine_repository artifactory_remote_alpine_repository} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataArtifactoryRemoteAlpineRepositoryConfig
  */
  public constructor(scope: Construct, id: string, config: DataArtifactoryRemoteAlpineRepositoryConfig) {
    super(scope, id, {
  ...
  private _contentSynchronisation = new DataArtifactoryRemoteAlpineRepositoryContentSynchronisationOutputReference(this, "content_synchronisation");
  public get contentSynchronisation() {
    return this._contentSynchronisation;
  }
  public putContentSynchronisation(value: DataArtifactoryRemoteAlpineRepositoryContentSynchronisation) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      content_synchronisation: dataArtifactoryRemoteAlpineRepositoryContentSynchronisationToTerraform(this._contentSynchronisation.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      content_synchronisation: {
        value: dataArtifactoryRemoteAlpineRepositoryContentSynchronisationToHclTerraform(this._contentSynchronisation.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataArtifactoryRemoteAlpineRepositoryContentSynchronisationList",
      },
    };
