// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository
...
export interface LocalDebianRepositoryConfig extends cdktf.TerraformMetaArguments {
  /**
  * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
  * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#archive_browsing_enabled LocalDebianRepository#archive_browsing_enabled}
  */
  readonly archiveBrowsingEnabled?: boolean | cdktf.IResolvable;
  /**
  * When set, the repository does not participate in artifact resolution and new artifacts cannot be deployed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#blacked_out LocalDebianRepository#blacked_out}
  */
  readonly blackedOut?: boolean | cdktf.IResolvable;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#cdn_redirect LocalDebianRepository#cdn_redirect}
  */
  readonly cdnRedirect?: boolean | cdktf.IResolvable;
  /**
  * When set, enable indexing with debug symbols (.ddeb).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#ddeb_supported LocalDebianRepository#ddeb_supported}
  */
  readonly ddebSupported?: boolean | cdktf.IResolvable;
  /**
  * Public description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#description LocalDebianRepository#description}
  */
  readonly description?: string;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from the cloud storage provider. Available in Enterprise+ and Edge licenses only.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#download_direct LocalDebianRepository#download_direct}
  */
  readonly downloadDirect?: boolean | cdktf.IResolvable;
  /**
  * List of artifact patterns to exclude when evaluating artifact requests, in the form of `x/y/** /z/*`.By default no artifacts are excluded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#excludes_pattern LocalDebianRepository#excludes_pattern}
   *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#includes_pattern LocalDebianRepository#includes_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  readonly includesPattern?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#index_compression_formats LocalDebianRepository#index_compression_formats}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#key LocalDebianRepository#key}
  */
  readonly key: string;
  /**
  * Internal description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#notes LocalDebianRepository#notes}
  */
  readonly notes?: string;
  /**
  * Primary keypair used to sign artifacts. Default value is empty.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#primary_keypair_ref LocalDebianRepository#primary_keypair_ref}
  */
  readonly primaryKeypairRef?: string;
  /**
  * Setting repositories with priority will cause metadata to be merged only from repositories set with this field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#priority_resolution LocalDebianRepository#priority_resolution}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#project_environments LocalDebianRepository#project_environments}
  */
  readonly projectEnvironments?: string[];
  /**
  * Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#project_key LocalDebianRepository#project_key}
  */
  readonly projectKey?: string;
  /**
  * List of property set name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#property_sets LocalDebianRepository#property_sets}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#repo_layout_ref LocalDebianRepository#repo_layout_ref}
  */
  readonly repoLayoutRef?: string;
  /**
  * Secondary keypair used to sign artifacts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#secondary_keypair_ref LocalDebianRepository#secondary_keypair_ref}
  */
  readonly secondaryKeypairRef?: string;
  /**
  * When set, the repository will use the deprecated trivial layout.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#trivial_layout LocalDebianRepository#trivial_layout}
  */
  readonly trivialLayout?: boolean | cdktf.IResolvable;
  /**
  * Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via Xray settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#xray_index LocalDebianRepository#xray_index}
  */
  readonly xrayIndex?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository artifactory_local_debian_repository}
*/
export class LocalDebianRepository extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a LocalDebianRepository resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the LocalDebianRepository to import
  * @param importFromId The id of the existing LocalDebianRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the LocalDebianRepository to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_debian_repository artifactory_local_debian_repository} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options LocalDebianRepositoryConfig
  */
  public constructor(scope: Construct, id: string, config: LocalDebianRepositoryConfig) {
    super(scope, id, {
    ...
    this._ddebSupported = config.ddebSupported;
  ...
  // ddeb_supported - computed: true, optional: true, required: false
  private _ddebSupported?: boolean | cdktf.IResolvable; 
  public get ddebSupported() {
    return this.getBooleanAttribute('ddeb_supported');
  }
  public set ddebSupported(value: boolean | cdktf.IResolvable) {
    this._ddebSupported = value;
  }
  public resetDdebSupported() {
    this._ddebSupported = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get ddebSupportedInput() {
    return this._ddebSupported;
  }
  ...
  // index_compression_formats - computed: true, optional: true, required: false
  ...
  // secondary_keypair_ref - computed: true, optional: true, required: false
  ...
  // trivial_layout - computed: true, optional: true, required: false
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ddeb_supported: cdktf.booleanToTerraform(this._ddebSupported),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ddeb_supported: {
        value: cdktf.booleanToHclTerraform(this._ddebSupported),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
