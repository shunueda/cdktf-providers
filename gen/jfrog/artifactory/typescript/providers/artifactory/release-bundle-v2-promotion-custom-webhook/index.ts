// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook
...
export interface ReleaseBundleV2PromotionCustomWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#description ReleaseBundleV2PromotionCustomWebhook#description}
  */
  readonly description?: string;
  /**
  * Status of webhook. Default to `true`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#enabled ReleaseBundleV2PromotionCustomWebhook#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#event_types ReleaseBundleV2PromotionCustomWebhook#event_types}
  */
  readonly eventTypes: string[];
  /**
  * Key of webhook. Must be between 2 and 200 characters. Cannot contain spaces.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#key ReleaseBundleV2PromotionCustomWebhook#key}
  */
  readonly key: string;
  /**
  * criteria block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#criteria ReleaseBundleV2PromotionCustomWebhook#criteria}
  */
  readonly criteria?: ReleaseBundleV2PromotionCustomWebhookCriteria[] | cdktf.IResolvable;
  /**
  * handler block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#handler ReleaseBundleV2PromotionCustomWebhook#handler}
  */
...
export interface ReleaseBundleV2PromotionCustomWebhookCriteria {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#exclude_patterns ReleaseBundleV2PromotionCustomWebhook#exclude_patterns}
  */
  readonly excludePatterns?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#include_patterns ReleaseBundleV2PromotionCustomWebhook#include_patterns}
  */
  readonly includePatterns?: string[];
  /**
  * Trigger on this list of environments
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#selected_environments ReleaseBundleV2PromotionCustomWebhook#selected_environments}
  */
...
export interface ReleaseBundleV2PromotionCustomWebhookHandler {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#http_headers ReleaseBundleV2PromotionCustomWebhook#http_headers}
  */
  readonly httpHeaders?: { [key: string]: string };
  /**
  * Specifies the HTTP Method for URL that the Webhook invokes. Allowed values are: `GET`, `POST`, `PUT`, `PATCH`, `DELETE`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#method ReleaseBundleV2PromotionCustomWebhook#method}
  */
  readonly method?: string;
  /**
  * This attribute is used to build the request body. Used in custom webhooks
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#payload ReleaseBundleV2PromotionCustomWebhook#payload}
  */
  readonly payload?: string;
  /**
  * Proxy key from Artifactory Proxies setting
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#proxy ReleaseBundleV2PromotionCustomWebhook#proxy}
  */
  readonly proxy?: string;
  /**
  * A set of sensitive values that will be injected in the request (headers and/or payload), comprise of key/value pair.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#secrets ReleaseBundleV2PromotionCustomWebhook#secrets}
  */
  readonly secrets?: { [key: string]: string };
  /**
  * Specifies the URL that the Webhook invokes. This will be the URL that Artifactory will send an HTTP POST request to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#url ReleaseBundleV2PromotionCustomWebhook#url}
  */
  readonly url: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook artifactory_release_bundle_v2_promotion_custom_webhook}
*/
export class ReleaseBundleV2PromotionCustomWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ReleaseBundleV2PromotionCustomWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/release_bundle_v2_promotion_custom_webhook artifactory_release_bundle_v2_promotion_custom_webhook} Resource
  *
  * @param scope The scope in which to define this construct
