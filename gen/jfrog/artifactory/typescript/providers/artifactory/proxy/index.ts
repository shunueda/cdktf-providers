// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/proxy
...
export interface ProxyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/proxy#host Proxy#host}
  */
  readonly host: string;
  /**
  * The unique ID of the proxy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/proxy#key Proxy#key}
  */
  readonly key: string;
  /**
  * The proxy domain/realm name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/proxy#nt_domain Proxy#nt_domain}
  */
  readonly ntDomain?: string;
  /**
  * The computer name of the machine (the machine connecting to the NTLM proxy).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/proxy#nt_host Proxy#nt_host}
  */
  readonly ntHost?: string;
  /**
  * The proxy password when authentication credentials are required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/proxy#password Proxy#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/proxy#platform_default Proxy#platform_default}
  */
  readonly platformDefault?: boolean | cdktf.IResolvable;
  /**
  * The proxy port number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/proxy#port Proxy#port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/proxy#redirect_to_hosts Proxy#redirect_to_hosts}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/proxy#services Proxy#services}
  */
  readonly services?: string[];
  /**
  * The proxy username when authentication credentials are required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/proxy#username Proxy#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/proxy artifactory_proxy}
*/
export class Proxy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Proxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/proxy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/proxy artifactory_proxy} Resource
  *
  * @param scope The scope in which to define this construct
