// https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication
...
export interface LocalRepositoryMultiReplicationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#cron_exp LocalRepositoryMultiReplication#cron_exp}
  */
  readonly cronExp: string;
  /**
  * When set, each event will trigger replication of the artifacts changed in this event. This can be any type of event on artifact, e.g. add, deleted or property change. Default value is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#enable_event_replication LocalRepositoryMultiReplication#enable_event_replication}
  */
  readonly enableEventReplication?: boolean | cdktf.IResolvable;
  /**
  * Repository name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#repo_key LocalRepositoryMultiReplication#repo_key}
  */
  readonly repoKey: string;
  /**
  * replication block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#replication LocalRepositoryMultiReplication#replication}
  */
...
export interface LocalRepositoryMultiReplicationReplication {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#check_binary_existence_in_filestore LocalRepositoryMultiReplication#check_binary_existence_in_filestore}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#disable_proxy LocalRepositoryMultiReplication#disable_proxy}
  */
  readonly disableProxy?: boolean | cdktf.IResolvable;
  /**
  * When set, enables replication of this repository to the target specified in `url` attribute. Default value is `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#enabled LocalRepositoryMultiReplication#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * List of artifact patterns to exclude when evaluating artifact requests, in the form of x/y/** /z/*. By default no artifacts are excluded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#exclude_path_prefix_pattern LocalRepositoryMultiReplication#exclude_path_prefix_pattern}
   *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#include_path_prefix_pattern LocalRepositoryMultiReplication#include_path_prefix_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#password LocalRepositoryMultiReplication#password}
  */
  readonly password?: string;
  /**
  * A proxy configuration to use when communicating with the remote instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#proxy LocalRepositoryMultiReplication#proxy}
  */
  readonly proxy?: string;
  /**
  * The network timeout in milliseconds to use for remote operations.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#socket_timeout_millis LocalRepositoryMultiReplication#socket_timeout_millis}
  */
  readonly socketTimeoutMillis?: number;
  /**
  * When set, items that were deleted locally should also be deleted remotely (also applies to properties metadata). Note that enabling this option, will delete artifacts on the target that do not exist in the source repository. Default value is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#sync_deletes LocalRepositoryMultiReplication#sync_deletes}
  */
  readonly syncDeletes?: boolean | cdktf.IResolvable;
  /**
  * When set, the task also synchronizes the properties of replicated artifacts. Default value is `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#sync_properties LocalRepositoryMultiReplication#sync_properties}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#sync_statistics LocalRepositoryMultiReplication#sync_statistics}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#url LocalRepositoryMultiReplication#url}
  */
  readonly url: string;
  /**
  * The HTTP authentication username.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#username LocalRepositoryMultiReplication#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication artifactory_local_repository_multi_replication}
*/
export class LocalRepositoryMultiReplication extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LocalRepositoryMultiReplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/local_repository_multi_replication artifactory_local_repository_multi_replication} Resource
  *
  * @param scope The scope in which to define this construct
