// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_webhook
...
export interface UserWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_webhook#description UserWebhook#description}
  */
  readonly description?: string;
  /**
  * Status of webhook. Default to `true`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_webhook#enabled UserWebhook#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_webhook#event_types UserWebhook#event_types}
  */
  readonly eventTypes: string[];
  /**
  * Key of webhook. Must be between 2 and 200 characters. Cannot contain spaces.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_webhook#key UserWebhook#key}
  */
  readonly key: string;
  /**
  * handler block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_webhook#handler UserWebhook#handler}
  */
...
export interface UserWebhookHandler {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_webhook#custom_http_headers UserWebhook#custom_http_headers}
  */
  readonly customHttpHeaders?: { [key: string]: string };
  /**
  * Proxy key from Artifactory Proxies setting
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_webhook#proxy UserWebhook#proxy}
  */
  readonly proxy?: string;
  /**
  * Secret authentication token that will be sent to the configured URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_webhook#secret UserWebhook#secret}
  */
  readonly secret?: string;
  /**
  * Specifies the URL that the Webhook invokes. This will be the URL that Artifactory will send an HTTP POST request to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_webhook#url UserWebhook#url}
  */
  readonly url: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_webhook#use_secret_for_signing UserWebhook#use_secret_for_signing}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_webhook artifactory_user_webhook}
*/
export class UserWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/user_webhook artifactory_user_webhook} Resource
  *
  * @param scope The scope in which to define this construct
