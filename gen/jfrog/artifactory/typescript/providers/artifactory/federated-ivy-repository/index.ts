// https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository
...
export interface FederatedIvyRepositoryConfig extends cdktf.TerraformMetaArguments {
  /**
  * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
  * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#archive_browsing_enabled FederatedIvyRepository#archive_browsing_enabled}
  */
  readonly archiveBrowsingEnabled?: boolean | cdktf.IResolvable;
  /**
  * When set, the repository does not participate in artifact resolution and new artifacts cannot be deployed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#blacked_out FederatedIvyRepository#blacked_out}
  */
  readonly blackedOut?: boolean | cdktf.IResolvable;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#cdn_redirect FederatedIvyRepository#cdn_redirect}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#checksum_policy_type FederatedIvyRepository#checksum_policy_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#cleanup_on_delete FederatedIvyRepository#cleanup_on_delete}
  */
  readonly cleanupOnDelete?: boolean | cdktf.IResolvable;
  /**
  * Public description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#description FederatedIvyRepository#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#disable_proxy FederatedIvyRepository#disable_proxy}
  */
  readonly disableProxy?: boolean | cdktf.IResolvable;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from the cloud storage provider. Available in Enterprise+ and Edge licenses only.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#download_direct FederatedIvyRepository#download_direct}
  */
  readonly downloadDirect?: boolean | cdktf.IResolvable;
  /**
  * List of artifact patterns to exclude when evaluating artifact requests, in the form of `x/y/** /z/*`.By default no artifacts are excluded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#excludes_pattern FederatedIvyRepository#excludes_pattern}
   *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#handle_releases FederatedIvyRepository#handle_releases}
  */
  readonly handleReleases?: boolean | cdktf.IResolvable;
  /**
  * If set, Artifactory allows you to deploy snapshot artifacts into this repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#handle_snapshots FederatedIvyRepository#handle_snapshots}
  */
  readonly handleSnapshots?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#id FederatedIvyRepository#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#includes_pattern FederatedIvyRepository#includes_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#key FederatedIvyRepository#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#max_unique_snapshots FederatedIvyRepository#max_unique_snapshots}
  */
  readonly maxUniqueSnapshots?: number;
  /**
  * Internal description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#notes FederatedIvyRepository#notes}
  */
  readonly notes?: string;
  /**
  * Setting repositories with priority will cause metadata to be merged only from repositories set with this field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#priority_resolution FederatedIvyRepository#priority_resolution}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#project_environments FederatedIvyRepository#project_environments}
  */
  readonly projectEnvironments?: string[];
  /**
  * Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#project_key FederatedIvyRepository#project_key}
  */
  readonly projectKey?: string;
  /**
  * List of property set name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#property_sets FederatedIvyRepository#property_sets}
  */
  readonly propertySets?: string[];
  /**
  * Proxy key from Artifactory Proxies settings. Can't be set if `disable_proxy = true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#proxy FederatedIvyRepository#proxy}
  */
  readonly proxy?: string;
  /**
  * Repository layout key for the federated repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#repo_layout_ref FederatedIvyRepository#repo_layout_ref}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#snapshot_version_behavior FederatedIvyRepository#snapshot_version_behavior}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#suppress_pom_consistency_checks FederatedIvyRepository#suppress_pom_consistency_checks}
  */
  readonly suppressPomConsistencyChecks?: boolean | cdktf.IResolvable;
  /**
  * Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via Xray settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#xray_index FederatedIvyRepository#xray_index}
  */
  readonly xrayIndex?: boolean | cdktf.IResolvable;
  /**
  * member block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#member FederatedIvyRepository#member}
  */
  readonly member: FederatedIvyRepositoryMember[] | cdktf.IResolvable;
}
export interface FederatedIvyRepositoryMember {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#access_token FederatedIvyRepository#access_token}
  */
  readonly accessToken?: string;
  /**
  * Represents the active state of the federated member. It is supported to change the enabled status of my own member. The config will be updated on the other federated members automatically.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#enabled FederatedIvyRepository#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Full URL to ending with the repositoryName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#url FederatedIvyRepository#url}
  */
  readonly url: string;
}

export function federatedIvyRepositoryMemberToTerraform(struct?: FederatedIvyRepositoryMember | cdktf.IResolvable): any {
...
export function federatedIvyRepositoryMemberToHclTerraform(struct?: FederatedIvyRepositoryMember | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class FederatedIvyRepositoryMemberOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): FederatedIvyRepositoryMember | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: FederatedIvyRepositoryMember | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class FederatedIvyRepositoryMemberList extends cdktf.ComplexList {
  public internalValue? : FederatedIvyRepositoryMember[] | cdktf.IResolvable
  ...
  */
  public get(index: number): FederatedIvyRepositoryMemberOutputReference {
    return new FederatedIvyRepositoryMemberOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository artifactory_federated_ivy_repository}
*/
export class FederatedIvyRepository extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "artifactory_federated_ivy_repository";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a FederatedIvyRepository resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the FederatedIvyRepository to import
  * @param importFromId The id of the existing FederatedIvyRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the FederatedIvyRepository to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "artifactory_federated_ivy_repository", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/federated_ivy_repository artifactory_federated_ivy_repository} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options FederatedIvyRepositoryConfig
  */
  public constructor(scope: Construct, id: string, config: FederatedIvyRepositoryConfig) {
    super(scope, id, {
  ...
  private _member = new FederatedIvyRepositoryMemberList(this, "member", true);
  public get member() {
    return this._member;
  }
  public putMember(value: FederatedIvyRepositoryMember[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      member: cdktf.listMapper(federatedIvyRepositoryMemberToTerraform, true)(this._member.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      member: {
        value: cdktf.listMapperHcl(federatedIvyRepositoryMemberToHclTerraform, true)(this._member.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "FederatedIvyRepositoryMemberList",
      },
    };
