// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/mail_server
...
export interface MailServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/mail_server#artifactory_url MailServer#artifactory_url}
  */
  readonly artifactoryUrl?: string;
  /**
  * When set, mail notifications are enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/mail_server#enabled MailServer#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * The 'from' address header to use in all outgoing messages.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/mail_server#from MailServer#from}
  */
  readonly from?: string;
  /**
  * The mail server IP address / DNS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/mail_server#host MailServer#host}
  */
  readonly host: string;
  /**
  * The password for authentication with the mail server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/mail_server#password MailServer#password}
  */
  readonly password?: string;
  /**
  * The port number of the mail server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/mail_server#port MailServer#port}
  */
  readonly port: number;
  /**
  * A prefix to use for the subject of all outgoing mails.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/mail_server#subject_prefix MailServer#subject_prefix}
  */
  readonly subjectPrefix?: string;
  /**
  * When set to 'true', uses a secure connection to the mail server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/mail_server#use_ssl MailServer#use_ssl}
  */
  readonly useSsl?: boolean | cdktf.IResolvable;
  /**
  * When set to 'true', uses Transport Layer Security when connecting to the mail server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/mail_server#use_tls MailServer#use_tls}
  */
  readonly useTls?: boolean | cdktf.IResolvable;
  /**
  * The username for authentication with the mail server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/mail_server#username MailServer#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/mail_server artifactory_mail_server}
*/
export class MailServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MailServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/mail_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/mail_server artifactory_mail_server} Resource
  *
  * @param scope The scope in which to define this construct
