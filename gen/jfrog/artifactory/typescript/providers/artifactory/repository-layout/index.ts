// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/repository_layout
...
export interface RepositoryLayoutConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/repository_layout#artifact_path_pattern RepositoryLayout#artifact_path_pattern}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/repository_layout#descriptor_path_pattern RepositoryLayout#descriptor_path_pattern}
  */
  readonly descriptorPathPattern?: string;
  /**
  * When set, `descriptor_path_pattern` will be used. Default to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/repository_layout#distinctive_descriptor_path_pattern RepositoryLayout#distinctive_descriptor_path_pattern}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/repository_layout#file_integration_revision_regexp RepositoryLayout#file_integration_revision_regexp}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/repository_layout#folder_integration_revision_regexp RepositoryLayout#folder_integration_revision_regexp}
  */
  readonly folderIntegrationRevisionRegexp: string;
  /**
  * Layout name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/repository_layout#name RepositoryLayout#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/repository_layout artifactory_repository_layout}
*/
export class RepositoryLayout extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RepositoryLayout that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/repository_layout#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/repository_layout artifactory_repository_layout} Resource
  *
  * @param scope The scope in which to define this construct
