// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication
...
export interface LocalRepositorySingleReplicationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#check_binary_existence_in_filestore LocalRepositorySingleReplication#check_binary_existence_in_filestore}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#cron_exp LocalRepositorySingleReplication#cron_exp}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#disable_proxy LocalRepositorySingleReplication#disable_proxy}
  */
  readonly disableProxy?: boolean | cdktf.IResolvable;
  /**
  * When set, each event will trigger replication of the artifacts changed in this event. This can be any type of event on artifact, e.g. add, deleted or property change. Default value is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#enable_event_replication LocalRepositorySingleReplication#enable_event_replication}
  */
  readonly enableEventReplication?: boolean | cdktf.IResolvable;
  /**
  * When set, enables replication of this repository to the target specified in `url` attribute. Default value is `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#enabled LocalRepositorySingleReplication#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * List of artifact patterns to exclude when evaluating artifact requests, in the form of x/y/** /z/*. By default no artifacts are excluded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#exclude_path_prefix_pattern LocalRepositorySingleReplication#exclude_path_prefix_pattern}
   *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#include_path_prefix_pattern LocalRepositorySingleReplication#include_path_prefix_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#password LocalRepositorySingleReplication#password}
  */
  readonly password?: string;
  /**
  * A proxy configuration to use when communicating with the remote instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#proxy LocalRepositorySingleReplication#proxy}
  */
  readonly proxy?: string;
  /**
  * Repository name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#repo_key LocalRepositorySingleReplication#repo_key}
  */
  readonly repoKey: string;
  /**
  * The network timeout in milliseconds to use for remote operations.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#socket_timeout_millis LocalRepositorySingleReplication#socket_timeout_millis}
  */
  readonly socketTimeoutMillis?: number;
  /**
  * When set, items that were deleted locally should also be deleted remotely (also applies to properties metadata). Note that enabling this option, will delete artifacts on the target that do not exist in the source repository. Default value is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#sync_deletes LocalRepositorySingleReplication#sync_deletes}
  */
  readonly syncDeletes?: boolean | cdktf.IResolvable;
  /**
  * When set, the task also synchronizes the properties of replicated artifacts. Default value is `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#sync_properties LocalRepositorySingleReplication#sync_properties}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#sync_statistics LocalRepositorySingleReplication#sync_statistics}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#url LocalRepositorySingleReplication#url}
  */
  readonly url: string;
  /**
  * The HTTP authentication username.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#username LocalRepositorySingleReplication#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication artifactory_local_repository_single_replication}
*/
export class LocalRepositorySingleReplication extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LocalRepositorySingleReplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/local_repository_single_replication artifactory_local_repository_single_replication} Resource
  *
  * @param scope The scope in which to define this construct
