// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/user
...
export interface DataArtifactoryUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/user#admin DataArtifactoryUser#admin}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/user#disable_ui_access DataArtifactoryUser#disable_ui_access}
  */
  readonly disableUiAccess?: boolean | cdktf.IResolvable;
  /**
  * Email for user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/user#email DataArtifactoryUser#email}
  */
  readonly email?: string;
  /**
  * List of groups this user is a part of.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/user#groups DataArtifactoryUser#groups}
  */
  readonly groups?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/user#id DataArtifactoryUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/user#internal_password_disabled DataArtifactoryUser#internal_password_disabled}
  */
  readonly internalPasswordDisabled?: boolean | cdktf.IResolvable;
  /**
  * Username for user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/user#name DataArtifactoryUser#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/user#profile_updatable DataArtifactoryUser#profile_updatable}
  */
  readonly profileUpdatable?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/user artifactory_user}
*/
export class DataArtifactoryUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataArtifactoryUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/user artifactory_user} Data Source
  *
  * @param scope The scope in which to define this construct
