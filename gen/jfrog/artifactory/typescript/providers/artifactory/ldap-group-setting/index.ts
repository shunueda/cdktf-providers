// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_group_setting
...
export interface LdapGroupSettingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_group_setting#description_attribute LdapGroupSetting#description_attribute}
  */
  readonly descriptionAttribute: string;
  /**
  * The LDAP filter used to search for group entries. Used for importing groups.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_group_setting#filter LdapGroupSetting#filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_group_setting#group_base_dn LdapGroupSetting#group_base_dn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_group_setting#group_member_attribute LdapGroupSetting#group_member_attribute}
  */
  readonly groupMemberAttribute: string;
  /**
  * Attribute on the group entry denoting the group name. Used when importing groups.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_group_setting#group_name_attribute LdapGroupSetting#group_name_attribute}
  */
  readonly groupNameAttribute: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_group_setting#id LdapGroupSetting#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_group_setting#ldap_setting_key LdapGroupSetting#ldap_setting_key}
  */
  readonly ldapSettingKey: string;
  /**
  * Ldap group setting name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_group_setting#name LdapGroupSetting#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_group_setting#strategy LdapGroupSetting#strategy}
  */
  readonly strategy: string;
  /**
  * When set, enables deep search through the sub-tree of the LDAP URL + Search Base. True by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_group_setting#sub_tree LdapGroupSetting#sub_tree}
  */
  readonly subTree?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_group_setting artifactory_ldap_group_setting}
*/
export class LdapGroupSetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LdapGroupSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_group_setting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_group_setting artifactory_ldap_group_setting} Resource
  *
  * @param scope The scope in which to define this construct
