// https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository
...
export interface RemoteIvyRepositoryConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#allow_any_host_auth RemoteIvyRepository#allow_any_host_auth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#archive_browsing_enabled RemoteIvyRepository#archive_browsing_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#assumed_offline_period_secs RemoteIvyRepository#assumed_offline_period_secs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#blacked_out RemoteIvyRepository#blacked_out}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#block_mismatching_mime_types RemoteIvyRepository#block_mismatching_mime_types}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#bypass_head_requests RemoteIvyRepository#bypass_head_requests}
  */
  readonly bypassHeadRequests?: boolean | cdktf.IResolvable;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#cdn_redirect RemoteIvyRepository#cdn_redirect}
  */
  readonly cdnRedirect?: boolean | cdktf.IResolvable;
  /**
  * Client TLS certificate name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#client_tls_certificate RemoteIvyRepository#client_tls_certificate}
  */
  readonly clientTlsCertificate?: string;
  /**
  * Public description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#description RemoteIvyRepository#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#disable_proxy RemoteIvyRepository#disable_proxy}
  */
  readonly disableProxy?: boolean | cdktf.IResolvable;
  /**
  * Whether to disable URL normalization. Default is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#disable_url_normalization RemoteIvyRepository#disable_url_normalization}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#download_direct RemoteIvyRepository#download_direct}
  */
  readonly downloadDirect?: boolean | cdktf.IResolvable;
  /**
  * Enables cookie management if the remote repository uses cookies to manage client state.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#enable_cookie_management RemoteIvyRepository#enable_cookie_management}
  */
  readonly enableCookieManagement?: boolean | cdktf.IResolvable;
  /**
  * List of artifact patterns to exclude when evaluating artifact requests, in the form of `x/y/** /z/*`.By default no artifacts are excluded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#excludes_pattern RemoteIvyRepository#excludes_pattern}
   *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#fetch_jars_eagerly RemoteIvyRepository#fetch_jars_eagerly}
  */
  readonly fetchJarsEagerly?: boolean | cdktf.IResolvable;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#fetch_sources_eagerly RemoteIvyRepository#fetch_sources_eagerly}
  */
  readonly fetchSourcesEagerly?: boolean | cdktf.IResolvable;
  /**
  * If set, Artifactory allows you to deploy release artifacts into this repository. Default value is 'true'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#handle_releases RemoteIvyRepository#handle_releases}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#handle_snapshots RemoteIvyRepository#handle_snapshots}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#hard_fail RemoteIvyRepository#hard_fail}
  */
  readonly hardFail?: boolean | cdktf.IResolvable;
  /**
  * List of comma-separated artifact patterns to include when evaluating artifact requests in the form of `x/y/** /z/*`. When used, only artifacts matching one of the include patterns are served. By default, all artifacts are included (`** /*`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#includes_pattern RemoteIvyRepository#includes_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#key RemoteIvyRepository#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#list_remote_folder_items RemoteIvyRepository#list_remote_folder_items}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#local_address RemoteIvyRepository#local_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#max_unique_snapshots RemoteIvyRepository#max_unique_snapshots}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#metadata_retrieval_timeout_secs RemoteIvyRepository#metadata_retrieval_timeout_secs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#mismatching_mime_types_override_list RemoteIvyRepository#mismatching_mime_types_override_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#missed_cache_period_seconds RemoteIvyRepository#missed_cache_period_seconds}
  */
  readonly missedCachePeriodSeconds?: number;
  /**
  * Internal description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#notes RemoteIvyRepository#notes}
  */
  readonly notes?: string;
  /**
  * If set, Artifactory does not try to fetch remote artifacts. Only locally-cached artifacts are retrieved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#offline RemoteIvyRepository#offline}
  */
  readonly offline?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#password RemoteIvyRepository#password}
  */
  readonly password?: string;
  /**
  * Setting repositories with priority will cause metadata to be merged only from repositories set with this field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#priority_resolution RemoteIvyRepository#priority_resolution}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#project_environments RemoteIvyRepository#project_environments}
  */
  readonly projectEnvironments?: string[];
  /**
  * Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#project_key RemoteIvyRepository#project_key}
  */
  readonly projectKey?: string;
  /**
  * List of property set name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#property_sets RemoteIvyRepository#property_sets}
  */
  readonly propertySets?: string[];
  /**
  * Proxy key from Artifactory Proxies settings. Can't be set if `disable_proxy = true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#proxy RemoteIvyRepository#proxy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#query_params RemoteIvyRepository#query_params}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#reject_invalid_jars RemoteIvyRepository#reject_invalid_jars}
  */
  readonly rejectInvalidJars?: boolean | cdktf.IResolvable;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#remote_repo_checksum_policy_type RemoteIvyRepository#remote_repo_checksum_policy_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#remote_repo_layout_ref RemoteIvyRepository#remote_repo_layout_ref}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#repo_layout_ref RemoteIvyRepository#repo_layout_ref}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#retrieval_cache_period_seconds RemoteIvyRepository#retrieval_cache_period_seconds}
  */
  readonly retrievalCachePeriodSeconds?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#share_configuration RemoteIvyRepository#share_configuration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#socket_timeout_millis RemoteIvyRepository#socket_timeout_millis}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#store_artifacts_locally RemoteIvyRepository#store_artifacts_locally}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#suppress_pom_consistency_checks RemoteIvyRepository#suppress_pom_consistency_checks}
  */
  readonly suppressPomConsistencyChecks?: boolean | cdktf.IResolvable;
  /**
  * When set, remote artifacts are fetched along with their properties.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#synchronize_properties RemoteIvyRepository#synchronize_properties}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#unused_artifacts_cleanup_period_hours RemoteIvyRepository#unused_artifacts_cleanup_period_hours}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#url RemoteIvyRepository#url}
  */
  readonly url: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#username RemoteIvyRepository#username}
  */
  readonly username?: string;
  /**
  * Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via Xray settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#xray_index RemoteIvyRepository#xray_index}
  */
  readonly xrayIndex?: boolean | cdktf.IResolvable;
  /**
  * content_synchronisation block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#content_synchronisation RemoteIvyRepository#content_synchronisation}
  */
  readonly contentSynchronisation?: RemoteIvyRepositoryContentSynchronisation[] | cdktf.IResolvable;
}
export interface RemoteIvyRepositoryContentSynchronisation {
  /**
  * If set, Remote repository proxies a local or remote repository from another instance of Artifactory. Default value is 'false'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#enabled RemoteIvyRepository#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * If set, properties for artifacts that have been cached in this repository will be updated if they are modified in the artifact hosted at the remote Artifactory instance. The trigger to synchronize the properties is download of the artifact from the remote repository cache of the local Artifactory instance. Default value is 'false'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#properties_enabled RemoteIvyRepository#properties_enabled}
  */
  readonly propertiesEnabled?: boolean | cdktf.IResolvable;
  /**
  * If set, Artifactory displays an indication on cached items if they have been deleted from the corresponding repository in the remote Artifactory instance. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#source_origin_absence_detection RemoteIvyRepository#source_origin_absence_detection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#statistics_enabled RemoteIvyRepository#statistics_enabled}
  */
  readonly statisticsEnabled?: boolean | cdktf.IResolvable;
}

export function remoteIvyRepositoryContentSynchronisationToTerraform(struct?: RemoteIvyRepositoryContentSynchronisation | cdktf.IResolvable): any {
...
export function remoteIvyRepositoryContentSynchronisationToHclTerraform(struct?: RemoteIvyRepositoryContentSynchronisation | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class RemoteIvyRepositoryContentSynchronisationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RemoteIvyRepositoryContentSynchronisation | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: RemoteIvyRepositoryContentSynchronisation | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class RemoteIvyRepositoryContentSynchronisationList extends cdktf.ComplexList {
  public internalValue? : RemoteIvyRepositoryContentSynchronisation[] | cdktf.IResolvable
  ...
  */
  public get(index: number): RemoteIvyRepositoryContentSynchronisationOutputReference {
    return new RemoteIvyRepositoryContentSynchronisationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository artifactory_remote_ivy_repository}
*/
export class RemoteIvyRepository extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "artifactory_remote_ivy_repository";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a RemoteIvyRepository resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the RemoteIvyRepository to import
  * @param importFromId The id of the existing RemoteIvyRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the RemoteIvyRepository to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "artifactory_remote_ivy_repository", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/resources/remote_ivy_repository artifactory_remote_ivy_repository} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options RemoteIvyRepositoryConfig
  */
  public constructor(scope: Construct, id: string, config: RemoteIvyRepositoryConfig) {
    super(scope, id, {
    ...
    this._fetchJarsEagerly = config.fetchJarsEagerly;
    this._fetchSourcesEagerly = config.fetchSourcesEagerly;
    ...
    this._rejectInvalidJars = config.rejectInvalidJars;
    this._remoteRepoChecksumPolicyType = config.remoteRepoChecksumPolicyType;
  ...
  // fetch_jars_eagerly - computed: true, optional: true, required: false
  private _fetchJarsEagerly?: boolean | cdktf.IResolvable; 
  public get fetchJarsEagerly() {
    return this.getBooleanAttribute('fetch_jars_eagerly');
  }
  public set fetchJarsEagerly(value: boolean | cdktf.IResolvable) {
    this._fetchJarsEagerly = value;
  }
  public resetFetchJarsEagerly() {
    this._fetchJarsEagerly = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get fetchJarsEagerlyInput() {
    return this._fetchJarsEagerly;
  }

  // fetch_sources_eagerly - computed: true, optional: true, required: false
  private _fetchSourcesEagerly?: boolean | cdktf.IResolvable; 
  public get fetchSourcesEagerly() {
    return this.getBooleanAttribute('fetch_sources_eagerly');
  }
  public set fetchSourcesEagerly(value: boolean | cdktf.IResolvable) {
    this._fetchSourcesEagerly = value;
  }
  public resetFetchSourcesEagerly() {
    this._fetchSourcesEagerly = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get fetchSourcesEagerlyInput() {
    return this._fetchSourcesEagerly;
  }

  // handle_releases - computed: true, optional: true, required: false
  ...
  // handle_snapshots - computed: true, optional: true, required: false
  ...
  // max_unique_snapshots - computed: true, optional: true, required: false
  ...
  // reject_invalid_jars - computed: true, optional: true, required: false
  private _rejectInvalidJars?: boolean | cdktf.IResolvable; 
  public get rejectInvalidJars() {
    return this.getBooleanAttribute('reject_invalid_jars');
  }
  public set rejectInvalidJars(value: boolean | cdktf.IResolvable) {
    this._rejectInvalidJars = value;
  }
  public resetRejectInvalidJars() {
    this._rejectInvalidJars = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get rejectInvalidJarsInput() {
    return this._rejectInvalidJars;
  }

  // remote_repo_checksum_policy_type - computed: true, optional: true, required: false
  private _remoteRepoChecksumPolicyType?: string; 
  public get remoteRepoChecksumPolicyType() {
    return this.getStringAttribute('remote_repo_checksum_policy_type');
  }
  public set remoteRepoChecksumPolicyType(value: string) {
    this._remoteRepoChecksumPolicyType = value;
  }
  public resetRemoteRepoChecksumPolicyType() {
    this._remoteRepoChecksumPolicyType = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get remoteRepoChecksumPolicyTypeInput() {
    return this._remoteRepoChecksumPolicyType;
  }
  ...
  // suppress_pom_consistency_checks - computed: true, optional: true, required: false
  ...
  private _contentSynchronisation = new RemoteIvyRepositoryContentSynchronisationList(this, "content_synchronisation", false);
  public get contentSynchronisation() {
    return this._contentSynchronisation;
  }
  public putContentSynchronisation(value: RemoteIvyRepositoryContentSynchronisation[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      fetch_jars_eagerly: cdktf.booleanToTerraform(this._fetchJarsEagerly),
      fetch_sources_eagerly: cdktf.booleanToTerraform(this._fetchSourcesEagerly),
      ...
      reject_invalid_jars: cdktf.booleanToTerraform(this._rejectInvalidJars),
      remote_repo_checksum_policy_type: cdktf.stringToTerraform(this._remoteRepoChecksumPolicyType),
      ...
      content_synchronisation: cdktf.listMapper(remoteIvyRepositoryContentSynchronisationToTerraform, true)(this._contentSynchronisation.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      fetch_jars_eagerly: {
        value: cdktf.booleanToHclTerraform(this._fetchJarsEagerly),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      fetch_sources_eagerly: {
        value: cdktf.booleanToHclTerraform(this._fetchSourcesEagerly),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      reject_invalid_jars: {
        value: cdktf.booleanToHclTerraform(this._rejectInvalidJars),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      remote_repo_checksum_policy_type: {
        value: cdktf.stringToHclTerraform(this._remoteRepoChecksumPolicyType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      content_synchronisation: {
        value: cdktf.listMapperHcl(remoteIvyRepositoryContentSynchronisationToHclTerraform, true)(this._contentSynchronisation.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "RemoteIvyRepositoryContentSynchronisationList",
      },
    };
