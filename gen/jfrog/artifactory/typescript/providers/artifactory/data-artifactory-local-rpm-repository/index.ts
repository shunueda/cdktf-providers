// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository
...
export interface DataArtifactoryLocalRpmRepositoryConfig extends cdktf.TerraformMetaArguments {
  /**
  * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
  * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#archive_browsing_enabled DataArtifactoryLocalRpmRepository#archive_browsing_enabled}
  */
  readonly archiveBrowsingEnabled?: boolean | cdktf.IResolvable;
  /**
  * When set, the repository does not participate in artifact resolution and new artifacts cannot be deployed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#blacked_out DataArtifactoryLocalRpmRepository#blacked_out}
  */
  readonly blackedOut?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#calculate_yum_metadata DataArtifactoryLocalRpmRepository#calculate_yum_metadata}
  */
  readonly calculateYumMetadata?: boolean | cdktf.IResolvable;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#cdn_redirect DataArtifactoryLocalRpmRepository#cdn_redirect}
  */
  readonly cdnRedirect?: boolean | cdktf.IResolvable;
  /**
  * Public description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#description DataArtifactoryLocalRpmRepository#description}
  */
  readonly description?: string;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from the cloud storage provider. Available in Enterprise+ and Edge licenses only.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#download_direct DataArtifactoryLocalRpmRepository#download_direct}
  */
  readonly downloadDirect?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#enable_file_lists_indexing DataArtifactoryLocalRpmRepository#enable_file_lists_indexing}
  */
  readonly enableFileListsIndexing?: boolean | cdktf.IResolvable;
  /**
  * List of artifact patterns to exclude when evaluating artifact requests, in the form of `x/y/** /z/*`.By default no artifacts are excluded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#excludes_pattern DataArtifactoryLocalRpmRepository#excludes_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  readonly excludesPattern?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#id DataArtifactoryLocalRpmRepository#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#includes_pattern DataArtifactoryLocalRpmRepository#includes_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#key DataArtifactoryLocalRpmRepository#key}
  */
  readonly key: string;
  /**
  * Internal description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#notes DataArtifactoryLocalRpmRepository#notes}
  */
  readonly notes?: string;
  /**
  * Primary keypair used to sign artifacts. Default value is empty.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#primary_keypair_ref DataArtifactoryLocalRpmRepository#primary_keypair_ref}
  */
  readonly primaryKeypairRef?: string;
  /**
  * Setting repositories with priority will cause metadata to be merged only from repositories set with this field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#priority_resolution DataArtifactoryLocalRpmRepository#priority_resolution}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#project_environments DataArtifactoryLocalRpmRepository#project_environments}
  */
  readonly projectEnvironments?: string[];
  /**
  * Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#project_key DataArtifactoryLocalRpmRepository#project_key}
  */
  readonly projectKey?: string;
  /**
  * List of property set name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#property_sets DataArtifactoryLocalRpmRepository#property_sets}
  */
  readonly propertySets?: string[];
  /**
  * Repository layout key for the local repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#repo_layout_ref DataArtifactoryLocalRpmRepository#repo_layout_ref}
  */
  readonly repoLayoutRef?: string;
  /**
  * Secondary keypair used to sign artifacts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#secondary_keypair_ref DataArtifactoryLocalRpmRepository#secondary_keypair_ref}
  */
  readonly secondaryKeypairRef?: string;
  /**
  * Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via Xray settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#xray_index DataArtifactoryLocalRpmRepository#xray_index}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#yum_group_file_names DataArtifactoryLocalRpmRepository#yum_group_file_names}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#yum_root_depth DataArtifactoryLocalRpmRepository#yum_root_depth}
  */
  readonly yumRootDepth?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository artifactory_local_rpm_repository}
*/
export class DataArtifactoryLocalRpmRepository extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataArtifactoryLocalRpmRepository resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataArtifactoryLocalRpmRepository to import
  * @param importFromId The id of the existing DataArtifactoryLocalRpmRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataArtifactoryLocalRpmRepository to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/data-sources/local_rpm_repository artifactory_local_rpm_repository} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataArtifactoryLocalRpmRepositoryConfig
  */
  public constructor(scope: Construct, id: string, config: DataArtifactoryLocalRpmRepositoryConfig) {
    super(scope, id, {
