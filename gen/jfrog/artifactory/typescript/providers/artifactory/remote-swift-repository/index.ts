// https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository
...
export interface RemoteSwiftRepositoryConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#allow_any_host_auth RemoteSwiftRepository#allow_any_host_auth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#archive_browsing_enabled RemoteSwiftRepository#archive_browsing_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#assumed_offline_period_secs RemoteSwiftRepository#assumed_offline_period_secs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#blacked_out RemoteSwiftRepository#blacked_out}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#block_mismatching_mime_types RemoteSwiftRepository#block_mismatching_mime_types}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#bypass_head_requests RemoteSwiftRepository#bypass_head_requests}
  */
  readonly bypassHeadRequests?: boolean | cdktf.IResolvable;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#cdn_redirect RemoteSwiftRepository#cdn_redirect}
  */
  readonly cdnRedirect?: boolean | cdktf.IResolvable;
  /**
  * Client TLS certificate name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#client_tls_certificate RemoteSwiftRepository#client_tls_certificate}
  */
  readonly clientTlsCertificate?: string;
  /**
  * Public description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#description RemoteSwiftRepository#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#disable_proxy RemoteSwiftRepository#disable_proxy}
  */
  readonly disableProxy?: boolean | cdktf.IResolvable;
  /**
  * Whether to disable URL normalization. Default is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#disable_url_normalization RemoteSwiftRepository#disable_url_normalization}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#download_direct RemoteSwiftRepository#download_direct}
  */
  readonly downloadDirect?: boolean | cdktf.IResolvable;
  /**
  * Enables cookie management if the remote repository uses cookies to manage client state.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#enable_cookie_management RemoteSwiftRepository#enable_cookie_management}
  */
  readonly enableCookieManagement?: boolean | cdktf.IResolvable;
  /**
  * List of artifact patterns to exclude when evaluating artifact requests, in the form of `x/y/** /z/*`.By default no artifacts are excluded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#excludes_pattern RemoteSwiftRepository#excludes_pattern}
   *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#hard_fail RemoteSwiftRepository#hard_fail}
  */
  readonly hardFail?: boolean | cdktf.IResolvable;
  /**
  * List of comma-separated artifact patterns to include when evaluating artifact requests in the form of `x/y/** /z/*`. When used, only artifacts matching one of the include patterns are served. By default, all artifacts are included (`** /*`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#includes_pattern RemoteSwiftRepository#includes_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#key RemoteSwiftRepository#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#list_remote_folder_items RemoteSwiftRepository#list_remote_folder_items}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#local_address RemoteSwiftRepository#local_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#metadata_retrieval_timeout_secs RemoteSwiftRepository#metadata_retrieval_timeout_secs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#mismatching_mime_types_override_list RemoteSwiftRepository#mismatching_mime_types_override_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#missed_cache_period_seconds RemoteSwiftRepository#missed_cache_period_seconds}
  */
  readonly missedCachePeriodSeconds?: number;
  /**
  * Internal description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#notes RemoteSwiftRepository#notes}
  */
  readonly notes?: string;
  /**
  * If set, Artifactory does not try to fetch remote artifacts. Only locally-cached artifacts are retrieved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#offline RemoteSwiftRepository#offline}
  */
  readonly offline?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#password RemoteSwiftRepository#password}
  */
  readonly password?: string;
  /**
  * Setting repositories with priority will cause metadata to be merged only from repositories set with this field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#priority_resolution RemoteSwiftRepository#priority_resolution}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#project_environments RemoteSwiftRepository#project_environments}
  */
  readonly projectEnvironments?: string[];
  /**
  * Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#project_key RemoteSwiftRepository#project_key}
  */
  readonly projectKey?: string;
  /**
  * List of property set name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#property_sets RemoteSwiftRepository#property_sets}
  */
  readonly propertySets?: string[];
  /**
  * Proxy key from Artifactory Proxies settings. Can't be set if `disable_proxy = true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#proxy RemoteSwiftRepository#proxy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#query_params RemoteSwiftRepository#query_params}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#remote_repo_layout_ref RemoteSwiftRepository#remote_repo_layout_ref}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#repo_layout_ref RemoteSwiftRepository#repo_layout_ref}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#retrieval_cache_period_seconds RemoteSwiftRepository#retrieval_cache_period_seconds}
  */
  readonly retrievalCachePeriodSeconds?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#share_configuration RemoteSwiftRepository#share_configuration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#socket_timeout_millis RemoteSwiftRepository#socket_timeout_millis}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#store_artifacts_locally RemoteSwiftRepository#store_artifacts_locally}
  */
  readonly storeArtifactsLocally?: boolean | cdktf.IResolvable;
  /**
  * When set, remote artifacts are fetched along with their properties.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#synchronize_properties RemoteSwiftRepository#synchronize_properties}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#unused_artifacts_cleanup_period_hours RemoteSwiftRepository#unused_artifacts_cleanup_period_hours}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#url RemoteSwiftRepository#url}
  */
  readonly url: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#username RemoteSwiftRepository#username}
  */
  readonly username?: string;
  /**
  * Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via Xray settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#xray_index RemoteSwiftRepository#xray_index}
  */
  readonly xrayIndex?: boolean | cdktf.IResolvable;
  /**
  * content_synchronisation block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#content_synchronisation RemoteSwiftRepository#content_synchronisation}
  */
  readonly contentSynchronisation?: RemoteSwiftRepositoryContentSynchronisation[] | cdktf.IResolvable;
}
export interface RemoteSwiftRepositoryContentSynchronisation {
  /**
  * If set, Remote repository proxies a local or remote repository from another instance of Artifactory. Default value is 'false'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#enabled RemoteSwiftRepository#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * If set, properties for artifacts that have been cached in this repository will be updated if they are modified in the artifact hosted at the remote Artifactory instance. The trigger to synchronize the properties is download of the artifact from the remote repository cache of the local Artifactory instance. Default value is 'false'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#properties_enabled RemoteSwiftRepository#properties_enabled}
  */
  readonly propertiesEnabled?: boolean | cdktf.IResolvable;
  /**
  * If set, Artifactory displays an indication on cached items if they have been deleted from the corresponding repository in the remote Artifactory instance. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#source_origin_absence_detection RemoteSwiftRepository#source_origin_absence_detection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#statistics_enabled RemoteSwiftRepository#statistics_enabled}
  */
  readonly statisticsEnabled?: boolean | cdktf.IResolvable;
}

export function remoteSwiftRepositoryContentSynchronisationToTerraform(struct?: RemoteSwiftRepositoryContentSynchronisation | cdktf.IResolvable): any {
...
export function remoteSwiftRepositoryContentSynchronisationToHclTerraform(struct?: RemoteSwiftRepositoryContentSynchronisation | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class RemoteSwiftRepositoryContentSynchronisationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RemoteSwiftRepositoryContentSynchronisation | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: RemoteSwiftRepositoryContentSynchronisation | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class RemoteSwiftRepositoryContentSynchronisationList extends cdktf.ComplexList {
  public internalValue? : RemoteSwiftRepositoryContentSynchronisation[] | cdktf.IResolvable
  ...
  */
  public get(index: number): RemoteSwiftRepositoryContentSynchronisationOutputReference {
    return new RemoteSwiftRepositoryContentSynchronisationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository artifactory_remote_swift_repository}
*/
export class RemoteSwiftRepository extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a RemoteSwiftRepository resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the RemoteSwiftRepository to import
  * @param importFromId The id of the existing RemoteSwiftRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the RemoteSwiftRepository to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/remote_swift_repository artifactory_remote_swift_repository} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options RemoteSwiftRepositoryConfig
  */
  public constructor(scope: Construct, id: string, config: RemoteSwiftRepositoryConfig) {
    super(scope, id, {
  ...
  private _contentSynchronisation = new RemoteSwiftRepositoryContentSynchronisationList(this, "content_synchronisation", false);
  public get contentSynchronisation() {
    return this._contentSynchronisation;
  }
  public putContentSynchronisation(value: RemoteSwiftRepositoryContentSynchronisation[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      content_synchronisation: cdktf.listMapper(remoteSwiftRepositoryContentSynchronisationToTerraform, true)(this._contentSynchronisation.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      content_synchronisation: {
        value: cdktf.listMapperHcl(remoteSwiftRepositoryContentSynchronisationToHclTerraform, true)(this._contentSynchronisation.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "RemoteSwiftRepositoryContentSynchronisationList",
      },
    };
