// https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2
...
export interface LdapSettingV2Config extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#allow_user_to_access_profile LdapSettingV2#allow_user_to_access_profile}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#auto_create_user LdapSettingV2#auto_create_user}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#email_attribute LdapSettingV2#email_attribute}
  */
  readonly emailAttribute?: string;
  /**
  * Flag to enable or disable the ldap setting. Default value is `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#enabled LdapSettingV2#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Ldap setting name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#key LdapSettingV2#key}
  */
  readonly key: string;
  /**
  * When this is set to `true`, an empty or missing usernames array will detach all users from the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#ldap_poisoning_protection LdapSettingV2#ldap_poisoning_protection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#ldap_url LdapSettingV2#ldap_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#manager_dn LdapSettingV2#manager_dn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#manager_password LdapSettingV2#manager_password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#paging_support_enabled LdapSettingV2#paging_support_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#search_base LdapSettingV2#search_base}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#search_filter LdapSettingV2#search_filter}
  */
  readonly searchFilter?: string;
  /**
  * When set, enables deep search through the sub tree of the LDAP URL + search base. Default value is `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#search_sub_tree LdapSettingV2#search_sub_tree}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#user_dn_pattern LdapSettingV2#user_dn_pattern}
  */
  readonly userDnPattern?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2 artifactory_ldap_setting_v2}
*/
export class LdapSettingV2 extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "artifactory_ldap_setting_v2";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a LdapSettingV2 resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the LdapSettingV2 to import
  * @param importFromId The id of the existing LdapSettingV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the LdapSettingV2 to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "artifactory_ldap_setting_v2", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.1/docs/resources/ldap_setting_v2 artifactory_ldap_setting_v2} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options LdapSettingV2Config
  */
  public constructor(scope: Construct, id: string, config: LdapSettingV2Config) {
    super(scope, id, {
      terraformResourceType: 'artifactory_ldap_setting_v2',
  ...
  // ldap_poisoning_protection - computed: true, optional: true, required: false
  ...
  // manager_dn - computed: true, optional: true, required: false
  ...
  // paging_support_enabled - computed: true, optional: true, required: false
  ...
  // search_base - computed: true, optional: true, required: false
  ...
  // search_sub_tree - computed: true, optional: true, required: false
  ...
  // user_dn_pattern - computed: true, optional: true, required: false
