// https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository
...
export interface DataArtifactoryFederatedDockerV2RepositoryConfig extends cdktf.TerraformMetaArguments {
  /**
  * When set, you may view content such as HTML or Javadoc files directly from Artifactory.
  * This may not be safe and therefore requires strict content moderation to prevent malicious users from uploading content that may compromise security (e.g., cross-site scripting attacks).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#archive_browsing_enabled DataArtifactoryFederatedDockerV2Repository#archive_browsing_enabled}
  */
  readonly archiveBrowsingEnabled?: boolean | cdktf.IResolvable;
  /**
  * When set, the repository does not participate in artifact resolution and new artifacts cannot be deployed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#blacked_out DataArtifactoryFederatedDockerV2Repository#blacked_out}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#block_pushing_schema1 DataArtifactoryFederatedDockerV2Repository#block_pushing_schema1}
  */
  readonly blockPushingSchema1?: boolean | cdktf.IResolvable;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from AWS CloudFront. Available in Enterprise+ and Edge licenses only. Default value is 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#cdn_redirect DataArtifactoryFederatedDockerV2Repository#cdn_redirect}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#cleanup_on_delete DataArtifactoryFederatedDockerV2Repository#cleanup_on_delete}
  */
  readonly cleanupOnDelete?: boolean | cdktf.IResolvable;
  /**
  * Public description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#description DataArtifactoryFederatedDockerV2Repository#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#disable_proxy DataArtifactoryFederatedDockerV2Repository#disable_proxy}
  */
  readonly disableProxy?: boolean | cdktf.IResolvable;
  /**
  * When set, download requests to this repository will redirect the client to download the artifact directly from the cloud storage provider. Available in Enterprise+ and Edge licenses only.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#download_direct DataArtifactoryFederatedDockerV2Repository#download_direct}
  */
  readonly downloadDirect?: boolean | cdktf.IResolvable;
  /**
  * List of artifact patterns to exclude when evaluating artifact requests, in the form of `x/y/** /z/*`.By default no artifacts are excluded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#excludes_pattern DataArtifactoryFederatedDockerV2Repository#excludes_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  readonly excludesPattern?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#id DataArtifactoryFederatedDockerV2Repository#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#includes_pattern DataArtifactoryFederatedDockerV2Repository#includes_pattern}
   *
  * Note: The above comment contained a comment block ending sequence (* followed by /). We have introduced a space between to prevent syntax errors. Please ignore the space.
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#key DataArtifactoryFederatedDockerV2Repository#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#max_unique_tags DataArtifactoryFederatedDockerV2Repository#max_unique_tags}
  */
  readonly maxUniqueTags?: number;
  /**
  * Internal description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#notes DataArtifactoryFederatedDockerV2Repository#notes}
  */
  readonly notes?: string;
  /**
  * Setting repositories with priority will cause metadata to be merged only from repositories set with this field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#priority_resolution DataArtifactoryFederatedDockerV2Repository#priority_resolution}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#project_environments DataArtifactoryFederatedDockerV2Repository#project_environments}
  */
  readonly projectEnvironments?: string[];
  /**
  * Project key for assigning this repository to. Must be 2 - 32 lowercase alphanumeric and hyphen characters. When assigning repository to a project, repository key must be prefixed with project key, separated by a dash.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#project_key DataArtifactoryFederatedDockerV2Repository#project_key}
  */
  readonly projectKey?: string;
  /**
  * List of property set name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#property_sets DataArtifactoryFederatedDockerV2Repository#property_sets}
  */
  readonly propertySets?: string[];
  /**
  * Proxy key from Artifactory Proxies settings. Can't be set if `disable_proxy = true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#proxy DataArtifactoryFederatedDockerV2Repository#proxy}
  */
  readonly proxy?: string;
  /**
  * Repository layout key for the federated repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#repo_layout_ref DataArtifactoryFederatedDockerV2Repository#repo_layout_ref}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#tag_retention DataArtifactoryFederatedDockerV2Repository#tag_retention}
  */
  readonly tagRetention?: number;
  /**
  * Enable Indexing In Xray. Repository will be indexed with the default retention period. You will be able to change it via Xray settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#xray_index DataArtifactoryFederatedDockerV2Repository#xray_index}
  */
  readonly xrayIndex?: boolean | cdktf.IResolvable;
  /**
  * member block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#member DataArtifactoryFederatedDockerV2Repository#member}
  */
  readonly member?: DataArtifactoryFederatedDockerV2RepositoryMember[] | cdktf.IResolvable;
}
export interface DataArtifactoryFederatedDockerV2RepositoryMember {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#access_token DataArtifactoryFederatedDockerV2Repository#access_token}
  */
  readonly accessToken?: string;
  /**
  * Represents the active state of the federated member. It is supported to change the enabled status of my own member. The config will be updated on the other federated members automatically.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#enabled DataArtifactoryFederatedDockerV2Repository#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Full URL to ending with the repositoryName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#url DataArtifactoryFederatedDockerV2Repository#url}
  */
  readonly url: string;
}

export function dataArtifactoryFederatedDockerV2RepositoryMemberToTerraform(struct?: DataArtifactoryFederatedDockerV2RepositoryMember | cdktf.IResolvable): any {
...
export function dataArtifactoryFederatedDockerV2RepositoryMemberToHclTerraform(struct?: DataArtifactoryFederatedDockerV2RepositoryMember | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataArtifactoryFederatedDockerV2RepositoryMemberOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataArtifactoryFederatedDockerV2RepositoryMember | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataArtifactoryFederatedDockerV2RepositoryMember | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataArtifactoryFederatedDockerV2RepositoryMemberList extends cdktf.ComplexList {
  public internalValue? : DataArtifactoryFederatedDockerV2RepositoryMember[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataArtifactoryFederatedDockerV2RepositoryMemberOutputReference {
    return new DataArtifactoryFederatedDockerV2RepositoryMemberOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository artifactory_federated_docker_v2_repository}
*/
export class DataArtifactoryFederatedDockerV2Repository extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataArtifactoryFederatedDockerV2Repository resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataArtifactoryFederatedDockerV2Repository to import
  * @param importFromId The id of the existing DataArtifactoryFederatedDockerV2Repository that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataArtifactoryFederatedDockerV2Repository to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/data-sources/federated_docker_v2_repository artifactory_federated_docker_v2_repository} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataArtifactoryFederatedDockerV2RepositoryConfig
  */
  public constructor(scope: Construct, id: string, config: DataArtifactoryFederatedDockerV2RepositoryConfig) {
    super(scope, id, {
  ...
  private _member = new DataArtifactoryFederatedDockerV2RepositoryMemberList(this, "member", true);
  public get member() {
    return this._member;
  }
  public putMember(value: DataArtifactoryFederatedDockerV2RepositoryMember[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      member: cdktf.listMapper(dataArtifactoryFederatedDockerV2RepositoryMemberToTerraform, true)(this._member.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      member: {
        value: cdktf.listMapperHcl(dataArtifactoryFederatedDockerV2RepositoryMemberToHclTerraform, true)(this._member.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataArtifactoryFederatedDockerV2RepositoryMemberList",
      },
    };
