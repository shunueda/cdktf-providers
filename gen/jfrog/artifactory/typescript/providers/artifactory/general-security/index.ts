// https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/general_security
...
export interface GeneralSecurityConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/general_security#enable_anonymous_access GeneralSecurity#enable_anonymous_access}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/general_security#encryption_policy GeneralSecurity#encryption_policy}
  */
  readonly encryptionPolicy?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/general_security artifactory_general_security}
*/
export class GeneralSecurity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GeneralSecurity that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/general_security#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/general_security artifactory_general_security} Resource
  *
  * @param scope The scope in which to define this construct
