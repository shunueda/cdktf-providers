// https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/password_expiration_policy
...
export interface PasswordExpirationPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/password_expiration_policy#enabled PasswordExpirationPolicy#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Name of the resource. Only used for importing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/password_expiration_policy#name PasswordExpirationPolicy#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/password_expiration_policy#notify_by_email PasswordExpirationPolicy#notify_by_email}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/password_expiration_policy#password_max_age PasswordExpirationPolicy#password_max_age}
  */
  readonly passwordMaxAge: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/password_expiration_policy artifactory_password_expiration_policy}
*/
export class PasswordExpirationPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PasswordExpirationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/password_expiration_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/password_expiration_policy artifactory_password_expiration_policy} Resource
  *
  * @param scope The scope in which to define this construct
