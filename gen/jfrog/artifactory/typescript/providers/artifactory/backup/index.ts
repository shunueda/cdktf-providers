// https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/backup
...
export interface BackupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/backup#create_archive Backup#create_archive}
  */
  readonly createArchive?: boolean | cdktf.IResolvable;
  /**
  * Cron expression to control the backup frequency.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/backup#cron_exp Backup#cron_exp}
  */
  readonly cronExp: string;
  /**
  * Flag to enable or disable the backup config. Default value is `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/backup#enabled Backup#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * When set to true, new repositories will not be automatically added to the backup. Default value is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/backup#exclude_new_repositories Backup#exclude_new_repositories}
  */
  readonly excludeNewRepositories?: boolean | cdktf.IResolvable;
  /**
  * List of excluded repositories from the backup.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/backup#excluded_repositories Backup#excluded_repositories}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/backup#export_mission_control Backup#export_mission_control}
  */
  readonly exportMissionControl?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/backup#key Backup#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/backup#retention_period_hours Backup#retention_period_hours}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/backup#send_mail_on_error Backup#send_mail_on_error}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/backup#verify_disk_space Backup#verify_disk_space}
  */
  readonly verifyDiskSpace?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/backup artifactory_backup}
*/
export class Backup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Backup that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.10.1/docs/resources/backup artifactory_backup} Resource
  *
  * @param scope The scope in which to define this construct
