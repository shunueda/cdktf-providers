// https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/data-sources/fileinfo
...
export interface DataArtifactoryFileinfoConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/data-sources/fileinfo#id DataArtifactoryFileinfo#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/data-sources/fileinfo#path DataArtifactoryFileinfo#path}
  */
  readonly path: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/data-sources/fileinfo#repository DataArtifactoryFileinfo#repository}
  */
  readonly repository: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/data-sources/fileinfo artifactory_fileinfo}
*/
export class DataArtifactoryFileinfo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataArtifactoryFileinfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/data-sources/fileinfo#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/artifactory/12.11.0/docs/data-sources/fileinfo artifactory_fileinfo} Data Source
  *
  * @param scope The scope in which to define this construct
