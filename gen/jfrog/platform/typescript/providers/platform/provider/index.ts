...
export class PlatformProvider extends cdktf.TerraformProvider {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "platform";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "platform", importId: importFromId, provider });
      }
