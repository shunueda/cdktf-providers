// https://registry.terraform.io/providers/jfrog/distribution/1.3.0/docs
...
export interface DistributionProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/distribution/1.3.0/docs#access_token DistributionProvider#access_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/distribution/1.3.0/docs#oidc_provider_name DistributionProvider#oidc_provider_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/distribution/1.3.0/docs#tfc_credential_tag_name DistributionProvider#tfc_credential_tag_name}
  */
  readonly tfcCredentialTagName?: string;
  /**
  * JFrog Platform URL. This can also be sourced from the `JFROG_URL` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/distribution/1.3.0/docs#url DistributionProvider#url}
  */
  readonly url?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jfrog/distribution/1.3.0/docs#alias DistributionProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jfrog/distribution/1.3.0/docs distribution}
*/
export class DistributionProvider extends cdktf.TerraformProvider {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "distribution";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DistributionProvider resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DistributionProvider to import
  * @param importFromId The id of the existing DistributionProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/jfrog/distribution/1.3.0/docs#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DistributionProvider to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "distribution", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jfrog/distribution/1.3.0/docs distribution} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DistributionProviderConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DistributionProviderConfig = {}) {
    super(scope, id, {
