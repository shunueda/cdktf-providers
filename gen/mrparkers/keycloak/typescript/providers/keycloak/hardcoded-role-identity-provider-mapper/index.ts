// https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/hardcoded_role_identity_provider_mapper
...
export interface HardcodedRoleIdentityProviderMapperConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/hardcoded_role_identity_provider_mapper#extra_config HardcodedRoleIdentityProviderMapper#extra_config}
  */
  readonly extraConfig?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/hardcoded_role_identity_provider_mapper#id HardcodedRoleIdentityProviderMapper#id}
  *
  ...
  * IDP Alias
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/hardcoded_role_identity_provider_mapper#identity_provider_alias HardcodedRoleIdentityProviderMapper#identity_provider_alias}
  */
  readonly identityProviderAlias: string;
  /**
  * IDP Mapper Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/hardcoded_role_identity_provider_mapper#name HardcodedRoleIdentityProviderMapper#name}
  */
  readonly name: string;
  /**
  * Realm Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/hardcoded_role_identity_provider_mapper#realm HardcodedRoleIdentityProviderMapper#realm}
  */
  readonly realm: string;
  /**
  * Role Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/hardcoded_role_identity_provider_mapper#role HardcodedRoleIdentityProviderMapper#role}
  */
  readonly role?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/hardcoded_role_identity_provider_mapper keycloak_hardcoded_role_identity_provider_mapper}
*/
export class HardcodedRoleIdentityProviderMapper extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HardcodedRoleIdentityProviderMapper that should be imported. Refer to the {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/hardcoded_role_identity_provider_mapper#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/hardcoded_role_identity_provider_mapper keycloak_hardcoded_role_identity_provider_mapper} Resource
  *
  * @param scope The scope in which to define this construct
