// https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/saml_script_protocol_mapper
...
export interface SamlScriptProtocolMapperConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/saml_script_protocol_mapper#client_id SamlScriptProtocolMapper#client_id}
  */
  readonly clientId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/saml_script_protocol_mapper#client_scope_id SamlScriptProtocolMapper#client_scope_id}
  */
  readonly clientScopeId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/saml_script_protocol_mapper#friendly_name SamlScriptProtocolMapper#friendly_name}
  */
  readonly friendlyName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/saml_script_protocol_mapper#id SamlScriptProtocolMapper#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/saml_script_protocol_mapper#name SamlScriptProtocolMapper#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/saml_script_protocol_mapper#realm_id SamlScriptProtocolMapper#realm_id}
  */
  readonly realmId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/saml_script_protocol_mapper#saml_attribute_name SamlScriptProtocolMapper#saml_attribute_name}
  */
  readonly samlAttributeName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/saml_script_protocol_mapper#saml_attribute_name_format SamlScriptProtocolMapper#saml_attribute_name_format}
  */
  readonly samlAttributeNameFormat: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/saml_script_protocol_mapper#script SamlScriptProtocolMapper#script}
  */
  readonly script: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/saml_script_protocol_mapper#single_value_attribute SamlScriptProtocolMapper#single_value_attribute}
  */
  readonly singleValueAttribute?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/saml_script_protocol_mapper keycloak_saml_script_protocol_mapper}
*/
export class SamlScriptProtocolMapper extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SamlScriptProtocolMapper that should be imported. Refer to the {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/saml_script_protocol_mapper#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/saml_script_protocol_mapper keycloak_saml_script_protocol_mapper} Resource
  *
  * @param scope The scope in which to define this construct
