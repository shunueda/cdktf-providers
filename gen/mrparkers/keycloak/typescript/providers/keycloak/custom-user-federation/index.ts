// https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation
...
export interface CustomUserFederationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation#cache_policy CustomUserFederation#cache_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation#changed_sync_period CustomUserFederation#changed_sync_period}
  */
  readonly changedSyncPeriod?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation#config CustomUserFederation#config}
  */
  readonly config?: { [key: string]: string };
  /**
  * When false, this provider will not be used when performing queries for users.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation#enabled CustomUserFederation#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * How frequently Keycloak should sync all users, in seconds. Omit this property to disable periodic full sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation#full_sync_period CustomUserFederation#full_sync_period}
  */
  readonly fullSyncPeriod?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation#id CustomUserFederation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation#name CustomUserFederation#name}
  */
  readonly name: string;
  /**
  * The parent_id of the generated component. will use realm_id if not specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation#parent_id CustomUserFederation#parent_id}
  */
  readonly parentId?: string;
  /**
  * Priority of this provider when looking up users. Lower values are first.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation#priority CustomUserFederation#priority}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation#provider_id CustomUserFederation#provider_id}
  */
  readonly providerId: string;
  /**
  * The realm (name) this provider will provide user federation for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation#realm_id CustomUserFederation#realm_id}
  */
  readonly realmId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation keycloak_custom_user_federation}
*/
export class CustomUserFederation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomUserFederation that should be imported. Refer to the {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/custom_user_federation keycloak_custom_user_federation} Resource
  *
  * @param scope The scope in which to define this construct
