// https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/default_groups
...
export interface DefaultGroupsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/default_groups#group_ids DefaultGroups#group_ids}
  */
  readonly groupIds: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/default_groups#id DefaultGroups#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/default_groups#realm_id DefaultGroups#realm_id}
  */
  readonly realmId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/default_groups keycloak_default_groups}
*/
export class DefaultGroups extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/default_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/default_groups keycloak_default_groups} Resource
  *
  * @param scope The scope in which to define this construct
