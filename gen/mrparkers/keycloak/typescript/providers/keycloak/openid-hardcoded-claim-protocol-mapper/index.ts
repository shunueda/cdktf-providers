// https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper
...
export interface OpenidHardcodedClaimProtocolMapperConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper#add_to_access_token OpenidHardcodedClaimProtocolMapper#add_to_access_token}
  */
  readonly addToAccessToken?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the attribute should be a claim in the id token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper#add_to_id_token OpenidHardcodedClaimProtocolMapper#add_to_id_token}
  */
  readonly addToIdToken?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the attribute should appear in the userinfo response body.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper#add_to_userinfo OpenidHardcodedClaimProtocolMapper#add_to_userinfo}
  */
  readonly addToUserinfo?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper#claim_name OpenidHardcodedClaimProtocolMapper#claim_name}
  */
  readonly claimName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper#claim_value OpenidHardcodedClaimProtocolMapper#claim_value}
  */
  readonly claimValue: string;
  /**
  * Claim type used when serializing tokens.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper#claim_value_type OpenidHardcodedClaimProtocolMapper#claim_value_type}
  */
  readonly claimValueType?: string;
  /**
  * The mapper's associated client. Cannot be used at the same time as client_scope_id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper#client_id OpenidHardcodedClaimProtocolMapper#client_id}
  */
  readonly clientId?: string;
  /**
  * The mapper's associated client scope. Cannot be used at the same time as client_id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper#client_scope_id OpenidHardcodedClaimProtocolMapper#client_scope_id}
  */
  readonly clientScopeId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper#id OpenidHardcodedClaimProtocolMapper#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper#name OpenidHardcodedClaimProtocolMapper#name}
  */
  readonly name: string;
  /**
  * The realm id where the associated client or client scope exists.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper#realm_id OpenidHardcodedClaimProtocolMapper#realm_id}
  */
  readonly realmId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper keycloak_openid_hardcoded_claim_protocol_mapper}
*/
export class OpenidHardcodedClaimProtocolMapper extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpenidHardcodedClaimProtocolMapper that should be imported. Refer to the {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_hardcoded_claim_protocol_mapper keycloak_openid_hardcoded_claim_protocol_mapper} Resource
  *
  * @param scope The scope in which to define this construct
