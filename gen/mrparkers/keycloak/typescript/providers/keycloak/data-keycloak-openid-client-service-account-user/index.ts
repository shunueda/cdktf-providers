// https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/data-sources/openid_client_service_account_user
...
export interface DataKeycloakOpenidClientServiceAccountUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/data-sources/openid_client_service_account_user#client_id DataKeycloakOpenidClientServiceAccountUser#client_id}
  */
  readonly clientId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/data-sources/openid_client_service_account_user#id DataKeycloakOpenidClientServiceAccountUser#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/data-sources/openid_client_service_account_user#realm_id DataKeycloakOpenidClientServiceAccountUser#realm_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/data-sources/openid_client_service_account_user keycloak_openid_client_service_account_user}
*/
export class DataKeycloakOpenidClientServiceAccountUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKeycloakOpenidClientServiceAccountUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/data-sources/openid_client_service_account_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/data-sources/openid_client_service_account_user keycloak_openid_client_service_account_user} Data Source
  *
  * @param scope The scope in which to define this construct
