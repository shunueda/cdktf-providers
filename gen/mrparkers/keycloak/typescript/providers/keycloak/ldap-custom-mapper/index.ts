// https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/ldap_custom_mapper
...
export interface LdapCustomMapperConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/ldap_custom_mapper#config LdapCustomMapper#config}
  */
  readonly config?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/ldap_custom_mapper#id LdapCustomMapper#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/ldap_custom_mapper#ldap_user_federation_id LdapCustomMapper#ldap_user_federation_id}
  */
  readonly ldapUserFederationId: string;
  /**
  * Display name of the mapper when displayed in the console.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/ldap_custom_mapper#name LdapCustomMapper#name}
  */
  readonly name: string;
  /**
  * ID of the custom LDAP mapper.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/ldap_custom_mapper#provider_id LdapCustomMapper#provider_id}
  */
  readonly providerId: string;
  /**
  * Fully-qualified name of the Java class implementing the custom LDAP mapper.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/ldap_custom_mapper#provider_type LdapCustomMapper#provider_type}
  */
  readonly providerType: string;
  /**
  * The realm in which the ldap user federation provider exists.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/ldap_custom_mapper#realm_id LdapCustomMapper#realm_id}
  */
  readonly realmId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/ldap_custom_mapper keycloak_ldap_custom_mapper}
*/
export class LdapCustomMapper extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LdapCustomMapper that should be imported. Refer to the {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/ldap_custom_mapper#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/ldap_custom_mapper keycloak_ldap_custom_mapper} Resource
  *
  * @param scope The scope in which to define this construct
