// https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/user_template_importer_identity_provider_mapper
...
export interface UserTemplateImporterIdentityProviderMapperConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/user_template_importer_identity_provider_mapper#extra_config UserTemplateImporterIdentityProviderMapper#extra_config}
  */
  readonly extraConfig?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/user_template_importer_identity_provider_mapper#id UserTemplateImporterIdentityProviderMapper#id}
  *
  ...
  * IDP Alias
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/user_template_importer_identity_provider_mapper#identity_provider_alias UserTemplateImporterIdentityProviderMapper#identity_provider_alias}
  */
  readonly identityProviderAlias: string;
  /**
  * IDP Mapper Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/user_template_importer_identity_provider_mapper#name UserTemplateImporterIdentityProviderMapper#name}
  */
  readonly name: string;
  /**
  * Realm Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/user_template_importer_identity_provider_mapper#realm UserTemplateImporterIdentityProviderMapper#realm}
  */
  readonly realm: string;
  /**
  * Username For Template Import
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/user_template_importer_identity_provider_mapper#template UserTemplateImporterIdentityProviderMapper#template}
  */
  readonly template?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/user_template_importer_identity_provider_mapper keycloak_user_template_importer_identity_provider_mapper}
*/
export class UserTemplateImporterIdentityProviderMapper extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserTemplateImporterIdentityProviderMapper that should be imported. Refer to the {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/user_template_importer_identity_provider_mapper#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/user_template_importer_identity_provider_mapper keycloak_user_template_importer_identity_provider_mapper} Resource
  *
  * @param scope The scope in which to define this construct
