// https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/authentication_subflow
...
export interface AuthenticationSubflowConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/authentication_subflow#alias AuthenticationSubflow#alias}
  */
  readonly alias: string;
  /**
  * Might be needed to be set with certain custom subflow with specific authenticator, in general this will remain empty
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/authentication_subflow#authenticator AuthenticationSubflow#authenticator}
  */
  readonly authenticator?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/authentication_subflow#description AuthenticationSubflow#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/authentication_subflow#id AuthenticationSubflow#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/authentication_subflow#parent_flow_alias AuthenticationSubflow#parent_flow_alias}
  */
  readonly parentFlowAlias: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/authentication_subflow#provider_id AuthenticationSubflow#provider_id}
  */
  readonly providerId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/authentication_subflow#realm_id AuthenticationSubflow#realm_id}
  */
  readonly realmId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/authentication_subflow#requirement AuthenticationSubflow#requirement}
  */
  readonly requirement?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/authentication_subflow keycloak_authentication_subflow}
*/
export class AuthenticationSubflow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthenticationSubflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/authentication_subflow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/authentication_subflow keycloak_authentication_subflow} Resource
  *
  * @param scope The scope in which to define this construct
