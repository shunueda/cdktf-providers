// https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper
...
export interface OpenidUserAttributeProtocolMapperConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper#add_to_access_token OpenidUserAttributeProtocolMapper#add_to_access_token}
  */
  readonly addToAccessToken?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the attribute should be a claim in the id token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper#add_to_id_token OpenidUserAttributeProtocolMapper#add_to_id_token}
  */
  readonly addToIdToken?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the attribute should appear in the userinfo response body.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper#add_to_userinfo OpenidUserAttributeProtocolMapper#add_to_userinfo}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper#aggregate_attributes OpenidUserAttributeProtocolMapper#aggregate_attributes}
  */
  readonly aggregateAttributes?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper#claim_name OpenidUserAttributeProtocolMapper#claim_name}
  */
  readonly claimName: string;
  /**
  * Claim type used when serializing tokens.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper#claim_value_type OpenidUserAttributeProtocolMapper#claim_value_type}
  */
  readonly claimValueType?: string;
  /**
  * The mapper's associated client. Cannot be used at the same time as client_scope_id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper#client_id OpenidUserAttributeProtocolMapper#client_id}
  */
  readonly clientId?: string;
  /**
  * The mapper's associated client scope. Cannot be used at the same time as client_id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper#client_scope_id OpenidUserAttributeProtocolMapper#client_scope_id}
  */
  readonly clientScopeId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper#id OpenidUserAttributeProtocolMapper#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper#multivalued OpenidUserAttributeProtocolMapper#multivalued}
  */
  readonly multivalued?: boolean | cdktf.IResolvable;
  /**
  * A human-friendly name that will appear in the Keycloak console.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper#name OpenidUserAttributeProtocolMapper#name}
  */
  readonly name: string;
  /**
  * The realm id where the associated client or client scope exists.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper#realm_id OpenidUserAttributeProtocolMapper#realm_id}
  */
  readonly realmId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper#user_attribute OpenidUserAttributeProtocolMapper#user_attribute}
  */
  readonly userAttribute: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper keycloak_openid_user_attribute_protocol_mapper}
*/
export class OpenidUserAttributeProtocolMapper extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpenidUserAttributeProtocolMapper that should be imported. Refer to the {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mrparkers/keycloak/4.4.0/docs/resources/openid_user_attribute_protocol_mapper keycloak_openid_user_attribute_protocol_mapper} Resource
  *
  * @param scope The scope in which to define this construct
