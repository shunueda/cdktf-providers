// https://registry.terraform.io/providers/bdwyertech/chef/0.3.17/docs
...
export interface ChefProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bdwyertech/chef/0.3.17/docs#allow_unverified_ssl ChefProvider#allow_unverified_ssl}
  */
  readonly allowUnverifiedSsl?: boolean | cdktf.IResolvable;
  /**
  * Name of a registered client within the Chef server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bdwyertech/chef/0.3.17/docs#client_name ChefProvider#client_name}
  */
  readonly clientName: string;
  /**
  * PEM-formatted private key for client authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bdwyertech/chef/0.3.17/docs#key_material ChefProvider#key_material}
  */
  readonly keyMaterial?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bdwyertech/chef/0.3.17/docs#private_key_pem ChefProvider#private_key_pem}
  */
  readonly privateKeyPem?: string;
  /**
  * URL of the root of the target Chef server or organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bdwyertech/chef/0.3.17/docs#server_url ChefProvider#server_url}
  */
  readonly serverUrl: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bdwyertech/chef/0.3.17/docs#alias ChefProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bdwyertech/chef/0.3.17/docs chef}
*/
export class ChefProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ChefProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/bdwyertech/chef/0.3.17/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bdwyertech/chef/0.3.17/docs chef} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ChefProviderConfig) {
    super(scope, id, {
      ...
      terraformProviderSource: 'bdwyertech/chef'
    });
