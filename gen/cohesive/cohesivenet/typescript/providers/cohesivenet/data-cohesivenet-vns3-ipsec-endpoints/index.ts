...
export interface DataCohesivenetVns3IpsecEndpointsResponse {
}

export function dataCohesivenetVns3IpsecEndpointsResponseToTerraform(struct?: DataCohesivenetVns3IpsecEndpointsResponse): any {
...
export function dataCohesivenetVns3IpsecEndpointsResponseToHclTerraform(struct?: DataCohesivenetVns3IpsecEndpointsResponse): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCohesivenetVns3IpsecEndpointsResponseOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCohesivenetVns3IpsecEndpointsResponse | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCohesivenetVns3IpsecEndpointsResponse | undefined) {
    if (value === undefined) {
  ...
  // endpointid - computed: true, optional: false, required: false
  public get endpointid() {
    return this.getNumberAttribute('endpointid');
  }
...
export class DataCohesivenetVns3IpsecEndpointsResponseList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataCohesivenetVns3IpsecEndpointsResponseOutputReference {
    return new DataCohesivenetVns3IpsecEndpointsResponseOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataCohesivenetVns3IpsecEndpoints extends cdktf.TerraformDataSource {
  ...
  * @param options DataCohesivenetVns3IpsecEndpointsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataCohesivenetVns3IpsecEndpointsConfig = {}) {
    super(scope, id, {
  ...
  private _response = new DataCohesivenetVns3IpsecEndpointsResponseList(this, "response", false);
  public get response() {
