...
export interface DataCohesivenetVns3ContainerNetworkResponse {
}

export function dataCohesivenetVns3ContainerNetworkResponseToTerraform(struct?: DataCohesivenetVns3ContainerNetworkResponse): any {
...
export function dataCohesivenetVns3ContainerNetworkResponseToHclTerraform(struct?: DataCohesivenetVns3ContainerNetworkResponse): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCohesivenetVns3ContainerNetworkResponseOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCohesivenetVns3ContainerNetworkResponse | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCohesivenetVns3ContainerNetworkResponse | undefined) {
    if (value === undefined) {
...
export class DataCohesivenetVns3ContainerNetworkResponseList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataCohesivenetVns3ContainerNetworkResponseOutputReference {
    return new DataCohesivenetVns3ContainerNetworkResponseOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataCohesivenetVns3ContainerNetwork extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cohesivenet_vns3_container_network";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "cohesivenet_vns3_container_network", importId: importFromId, provider });
      }
  ...
  * @param options DataCohesivenetVns3ContainerNetworkConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataCohesivenetVns3ContainerNetworkConfig = {}) {
    super(scope, id, {
  ...
  private _response = new DataCohesivenetVns3ContainerNetworkResponseList(this, "response", false);
  public get response() {
