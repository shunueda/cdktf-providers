// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim
...
export interface DataSolacebrokerMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim#msg_vpn_name DataSolacebrokerMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim#oauth_jwt_claim_name DataSolacebrokerMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim#oauth_jwt_claim_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim#rest_consumer_name DataSolacebrokerMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim#rest_consumer_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim#rest_delivery_point_name DataSolacebrokerMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim#rest_delivery_point_name}
  */
  readonly restDeliveryPointName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim solacebroker_msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim}
*/
export class DataSolacebrokerMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim solacebroker_msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim} Data Source
  *
  * @param scope The scope in which to define this construct
