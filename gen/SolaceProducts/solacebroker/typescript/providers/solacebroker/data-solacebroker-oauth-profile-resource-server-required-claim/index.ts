// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/oauth_profile_resource_server_required_claim
...
export interface DataSolacebrokerOauthProfileResourceServerRequiredClaimConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/oauth_profile_resource_server_required_claim#oauth_profile_name DataSolacebrokerOauthProfileResourceServerRequiredClaim#oauth_profile_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/oauth_profile_resource_server_required_claim#resource_server_required_claim_name DataSolacebrokerOauthProfileResourceServerRequiredClaim#resource_server_required_claim_name}
  */
  readonly resourceServerRequiredClaimName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/oauth_profile_resource_server_required_claim solacebroker_oauth_profile_resource_server_required_claim}
*/
export class DataSolacebrokerOauthProfileResourceServerRequiredClaim extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerOauthProfileResourceServerRequiredClaim that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/oauth_profile_resource_server_required_claim#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/oauth_profile_resource_server_required_claim solacebroker_oauth_profile_resource_server_required_claim} Data Source
  *
  * @param scope The scope in which to define this construct
