// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_replicated_topic
...
export interface DataSolacebrokerMsgVpnReplicatedTopicConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_replicated_topic#msg_vpn_name DataSolacebrokerMsgVpnReplicatedTopic#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_replicated_topic#replicated_topic DataSolacebrokerMsgVpnReplicatedTopic#replicated_topic}
  */
  readonly replicatedTopic: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_replicated_topic solacebroker_msg_vpn_replicated_topic}
*/
export class DataSolacebrokerMsgVpnReplicatedTopic extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnReplicatedTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_replicated_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_replicated_topic solacebroker_msg_vpn_replicated_topic} Data Source
  *
  * @param scope The scope in which to define this construct
