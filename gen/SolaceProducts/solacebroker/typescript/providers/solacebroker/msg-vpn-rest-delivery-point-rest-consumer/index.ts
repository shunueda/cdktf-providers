...
export interface MsgVpnRestDeliveryPointRestConsumerConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class MsgVpnRestDeliveryPointRestConsumer extends cdktf.TerraformResource {
  ...
  * @param options MsgVpnRestDeliveryPointRestConsumerConfig
  */
  public constructor(scope: Construct, id: string, config: MsgVpnRestDeliveryPointRestConsumerConfig) {
    super(scope, id, {
