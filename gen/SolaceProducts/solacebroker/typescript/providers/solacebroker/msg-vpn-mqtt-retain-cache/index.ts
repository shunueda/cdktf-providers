...
export interface MsgVpnMqttRetainCacheConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class MsgVpnMqttRetainCache extends cdktf.TerraformResource {
  ...
  * @param options MsgVpnMqttRetainCacheConfig
  */
  public constructor(scope: Construct, id: string, config: MsgVpnMqttRetainCacheConfig) {
    super(scope, id, {
