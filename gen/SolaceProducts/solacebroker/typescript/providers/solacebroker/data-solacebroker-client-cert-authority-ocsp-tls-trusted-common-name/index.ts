// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/client_cert_authority_ocsp_tls_trusted_common_name
...
export interface DataSolacebrokerClientCertAuthorityOcspTlsTrustedCommonNameConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/client_cert_authority_ocsp_tls_trusted_common_name#cert_authority_name DataSolacebrokerClientCertAuthorityOcspTlsTrustedCommonName#cert_authority_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/client_cert_authority_ocsp_tls_trusted_common_name#ocsp_tls_trusted_common_name DataSolacebrokerClientCertAuthorityOcspTlsTrustedCommonName#ocsp_tls_trusted_common_name}
  */
  readonly ocspTlsTrustedCommonName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/client_cert_authority_ocsp_tls_trusted_common_name solacebroker_client_cert_authority_ocsp_tls_trusted_common_name}
*/
export class DataSolacebrokerClientCertAuthorityOcspTlsTrustedCommonName extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerClientCertAuthorityOcspTlsTrustedCommonName that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/client_cert_authority_ocsp_tls_trusted_common_name#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/client_cert_authority_ocsp_tls_trusted_common_name solacebroker_client_cert_authority_ocsp_tls_trusted_common_name} Data Source
  *
  * @param scope The scope in which to define this construct
