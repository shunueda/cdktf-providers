// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/dmr_cluster_cert_matching_rule_condition
...
export interface DmrClusterCertMatchingRuleConditionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/dmr_cluster_cert_matching_rule_condition#attribute DmrClusterCertMatchingRuleCondition#attribute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/dmr_cluster_cert_matching_rule_condition#dmr_cluster_name DmrClusterCertMatchingRuleCondition#dmr_cluster_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only". The default value is `""`. Note that this attribute requires replacement of the resource when updated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/dmr_cluster_cert_matching_rule_condition#expression DmrClusterCertMatchingRuleCondition#expression}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/dmr_cluster_cert_matching_rule_condition#rule_name DmrClusterCertMatchingRuleCondition#rule_name}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/dmr_cluster_cert_matching_rule_condition#source DmrClusterCertMatchingRuleCondition#source}
  */
  readonly source: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/dmr_cluster_cert_matching_rule_condition solacebroker_dmr_cluster_cert_matching_rule_condition}
*/
export class DmrClusterCertMatchingRuleCondition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DmrClusterCertMatchingRuleCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/dmr_cluster_cert_matching_rule_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/dmr_cluster_cert_matching_rule_condition solacebroker_dmr_cluster_cert_matching_rule_condition} Resource
  *
  * @param scope The scope in which to define this construct
