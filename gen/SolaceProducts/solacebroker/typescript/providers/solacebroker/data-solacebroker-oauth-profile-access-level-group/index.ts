// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/oauth_profile_access_level_group
...
export interface DataSolacebrokerOauthProfileAccessLevelGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/oauth_profile_access_level_group#group_name DataSolacebrokerOauthProfileAccessLevelGroup#group_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/oauth_profile_access_level_group#oauth_profile_name DataSolacebrokerOauthProfileAccessLevelGroup#oauth_profile_name}
  */
  readonly oauthProfileName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/oauth_profile_access_level_group solacebroker_oauth_profile_access_level_group}
*/
export class DataSolacebrokerOauthProfileAccessLevelGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerOauthProfileAccessLevelGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/oauth_profile_access_level_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/oauth_profile_access_level_group solacebroker_oauth_profile_access_level_group} Data Source
  *
  * @param scope The scope in which to define this construct
