// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer
...
export interface DataSolacebrokerMsgVpnRestDeliveryPointRestConsumerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer#msg_vpn_name DataSolacebrokerMsgVpnRestDeliveryPointRestConsumer#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer#rest_consumer_name DataSolacebrokerMsgVpnRestDeliveryPointRestConsumer#rest_consumer_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer#rest_delivery_point_name DataSolacebrokerMsgVpnRestDeliveryPointRestConsumer#rest_delivery_point_name}
  */
  readonly restDeliveryPointName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer solacebroker_msg_vpn_rest_delivery_point_rest_consumer}
*/
export class DataSolacebrokerMsgVpnRestDeliveryPointRestConsumer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnRestDeliveryPointRestConsumer that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_rest_delivery_point_rest_consumer solacebroker_msg_vpn_rest_delivery_point_rest_consumer} Data Source
  *
  * @param scope The scope in which to define this construct
