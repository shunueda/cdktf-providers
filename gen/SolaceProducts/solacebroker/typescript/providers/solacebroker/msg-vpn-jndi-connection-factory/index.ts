...
export interface MsgVpnJndiConnectionFactoryConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class MsgVpnJndiConnectionFactory extends cdktf.TerraformResource {
  ...
  * @param options MsgVpnJndiConnectionFactoryConfig
  */
  public constructor(scope: Construct, id: string, config: MsgVpnJndiConnectionFactoryConfig) {
    super(scope, id, {
