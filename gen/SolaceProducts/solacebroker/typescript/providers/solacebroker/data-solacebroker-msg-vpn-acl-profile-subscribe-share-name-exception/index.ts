// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_subscribe_share_name_exception
...
export interface DataSolacebrokerMsgVpnAclProfileSubscribeShareNameExceptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_subscribe_share_name_exception#acl_profile_name DataSolacebrokerMsgVpnAclProfileSubscribeShareNameException#acl_profile_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_subscribe_share_name_exception#msg_vpn_name DataSolacebrokerMsgVpnAclProfileSubscribeShareNameException#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_subscribe_share_name_exception#subscribe_share_name_exception DataSolacebrokerMsgVpnAclProfileSubscribeShareNameException#subscribe_share_name_exception}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_subscribe_share_name_exception#subscribe_share_name_exception_syntax DataSolacebrokerMsgVpnAclProfileSubscribeShareNameException#subscribe_share_name_exception_syntax}
  */
  readonly subscribeShareNameExceptionSyntax: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_subscribe_share_name_exception solacebroker_msg_vpn_acl_profile_subscribe_share_name_exception}
*/
export class DataSolacebrokerMsgVpnAclProfileSubscribeShareNameException extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnAclProfileSubscribeShareNameException that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_subscribe_share_name_exception#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_subscribe_share_name_exception solacebroker_msg_vpn_acl_profile_subscribe_share_name_exception} Data Source
  *
  * @param scope The scope in which to define this construct
