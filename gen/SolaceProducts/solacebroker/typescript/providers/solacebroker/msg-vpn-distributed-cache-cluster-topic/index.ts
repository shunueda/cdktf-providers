...
export interface MsgVpnDistributedCacheClusterTopicConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class MsgVpnDistributedCacheClusterTopic extends cdktf.TerraformResource {
  ...
  * @param options MsgVpnDistributedCacheClusterTopicConfig
  */
  public constructor(scope: Construct, id: string, config: MsgVpnDistributedCacheClusterTopicConfig) {
    super(scope, id, {
