// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/about_user_msg_vpn
...
export interface DataSolacebrokerAboutUserMsgVpnConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/about_user_msg_vpn#msg_vpn_name DataSolacebrokerAboutUserMsgVpn#msg_vpn_name}
  */
  readonly msgVpnName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/about_user_msg_vpn solacebroker_about_user_msg_vpn}
*/
export class DataSolacebrokerAboutUserMsgVpn extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerAboutUserMsgVpn that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/about_user_msg_vpn#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/about_user_msg_vpn solacebroker_about_user_msg_vpn} Data Source
  *
  * @param scope The scope in which to define this construct
