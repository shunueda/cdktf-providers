// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_jndi_connection_factory
...
export interface DataSolacebrokerMsgVpnJndiConnectionFactoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_jndi_connection_factory#connection_factory_name DataSolacebrokerMsgVpnJndiConnectionFactory#connection_factory_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_jndi_connection_factory#msg_vpn_name DataSolacebrokerMsgVpnJndiConnectionFactory#msg_vpn_name}
  */
  readonly msgVpnName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_jndi_connection_factory solacebroker_msg_vpn_jndi_connection_factory}
*/
export class DataSolacebrokerMsgVpnJndiConnectionFactory extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnJndiConnectionFactory that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_jndi_connection_factory#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_jndi_connection_factory solacebroker_msg_vpn_jndi_connection_factory} Data Source
  *
  * @param scope The scope in which to define this construct
