...
export interface MsgVpnQueueSubscriptionConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class MsgVpnQueueSubscription extends cdktf.TerraformResource {
  ...
  * @param options MsgVpnQueueSubscriptionConfig
  */
  public constructor(scope: Construct, id: string, config: MsgVpnQueueSubscriptionConfig) {
    super(scope, id, {
