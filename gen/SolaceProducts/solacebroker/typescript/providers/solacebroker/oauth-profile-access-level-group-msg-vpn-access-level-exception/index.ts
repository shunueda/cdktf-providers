...
export interface OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class OauthProfileAccessLevelGroupMsgVpnAccessLevelException extends cdktf.TerraformResource {
  ...
  * @param options OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionConfig
  */
  public constructor(scope: Construct, id: string, config: OauthProfileAccessLevelGroupMsgVpnAccessLevelExceptionConfig) {
    super(scope, id, {
