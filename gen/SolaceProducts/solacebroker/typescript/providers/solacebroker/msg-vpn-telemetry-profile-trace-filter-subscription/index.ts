...
export interface MsgVpnTelemetryProfileTraceFilterSubscriptionConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class MsgVpnTelemetryProfileTraceFilterSubscription extends cdktf.TerraformResource {
  ...
  * @param options MsgVpnTelemetryProfileTraceFilterSubscriptionConfig
  */
  public constructor(scope: Construct, id: string, config: MsgVpnTelemetryProfileTraceFilterSubscriptionConfig) {
    super(scope, id, {
