...
export interface DataSolacebrokerMsgVpnSequencedTopicConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DataSolacebrokerMsgVpnSequencedTopic extends cdktf.TerraformDataSource {
  ...
  * @param options DataSolacebrokerMsgVpnSequencedTopicConfig
  */
  public constructor(scope: Construct, id: string, config: DataSolacebrokerMsgVpnSequencedTopicConfig) {
    super(scope, id, {
