// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_publish_topic_exception
...
export interface DataSolacebrokerMsgVpnAclProfilePublishTopicExceptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_publish_topic_exception#acl_profile_name DataSolacebrokerMsgVpnAclProfilePublishTopicException#acl_profile_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_publish_topic_exception#msg_vpn_name DataSolacebrokerMsgVpnAclProfilePublishTopicException#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_publish_topic_exception#publish_topic_exception DataSolacebrokerMsgVpnAclProfilePublishTopicException#publish_topic_exception}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_publish_topic_exception#publish_topic_exception_syntax DataSolacebrokerMsgVpnAclProfilePublishTopicException#publish_topic_exception_syntax}
  */
  readonly publishTopicExceptionSyntax: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_publish_topic_exception solacebroker_msg_vpn_acl_profile_publish_topic_exception}
*/
export class DataSolacebrokerMsgVpnAclProfilePublishTopicException extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnAclProfilePublishTopicException that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_publish_topic_exception#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_acl_profile_publish_topic_exception solacebroker_msg_vpn_acl_profile_publish_topic_exception} Data Source
  *
  * @param scope The scope in which to define this construct
