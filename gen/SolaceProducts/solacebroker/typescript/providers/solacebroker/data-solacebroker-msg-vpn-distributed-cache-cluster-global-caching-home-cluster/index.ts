// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_distributed_cache_cluster_global_caching_home_cluster
...
export interface DataSolacebrokerMsgVpnDistributedCacheClusterGlobalCachingHomeClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_distributed_cache_cluster_global_caching_home_cluster#cache_name DataSolacebrokerMsgVpnDistributedCacheClusterGlobalCachingHomeCluster#cache_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_distributed_cache_cluster_global_caching_home_cluster#cluster_name DataSolacebrokerMsgVpnDistributedCacheClusterGlobalCachingHomeCluster#cluster_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_distributed_cache_cluster_global_caching_home_cluster#home_cluster_name DataSolacebrokerMsgVpnDistributedCacheClusterGlobalCachingHomeCluster#home_cluster_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_distributed_cache_cluster_global_caching_home_cluster#msg_vpn_name DataSolacebrokerMsgVpnDistributedCacheClusterGlobalCachingHomeCluster#msg_vpn_name}
  */
  readonly msgVpnName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_distributed_cache_cluster_global_caching_home_cluster solacebroker_msg_vpn_distributed_cache_cluster_global_caching_home_cluster}
*/
export class DataSolacebrokerMsgVpnDistributedCacheClusterGlobalCachingHomeCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnDistributedCacheClusterGlobalCachingHomeCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_distributed_cache_cluster_global_caching_home_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_distributed_cache_cluster_global_caching_home_cluster solacebroker_msg_vpn_distributed_cache_cluster_global_caching_home_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
