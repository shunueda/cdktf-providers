// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/dmr_cluster_cert_matching_rule
...
export interface DataSolacebrokerDmrClusterCertMatchingRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/dmr_cluster_cert_matching_rule#dmr_cluster_name DataSolacebrokerDmrClusterCertMatchingRule#dmr_cluster_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/dmr_cluster_cert_matching_rule#rule_name DataSolacebrokerDmrClusterCertMatchingRule#rule_name}
  */
  readonly ruleName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/dmr_cluster_cert_matching_rule solacebroker_dmr_cluster_cert_matching_rule}
*/
export class DataSolacebrokerDmrClusterCertMatchingRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerDmrClusterCertMatchingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/dmr_cluster_cert_matching_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/dmr_cluster_cert_matching_rule solacebroker_dmr_cluster_cert_matching_rule} Data Source
  *
  * @param scope The scope in which to define this construct
