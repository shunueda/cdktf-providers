...
export interface MsgVpnDistributedCacheConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class MsgVpnDistributedCache extends cdktf.TerraformResource {
  ...
  * @param options MsgVpnDistributedCacheConfig
  */
  public constructor(scope: Construct, id: string, config: MsgVpnDistributedCacheConfig) {
    super(scope, id, {
