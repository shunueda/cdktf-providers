...
export interface MsgVpnDistributedCacheClusterGlobalCachingHomeClusterConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class MsgVpnDistributedCacheClusterGlobalCachingHomeCluster extends cdktf.TerraformResource {
  ...
  * @param options MsgVpnDistributedCacheClusterGlobalCachingHomeClusterConfig
  */
  public constructor(scope: Construct, id: string, config: MsgVpnDistributedCacheClusterGlobalCachingHomeClusterConfig) {
    super(scope, id, {
