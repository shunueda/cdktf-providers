...
export interface MsgVpnBridgeConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class MsgVpnBridge extends cdktf.TerraformResource {
  ...
  * @param options MsgVpnBridgeConfig
  */
  public constructor(scope: Construct, id: string, config: MsgVpnBridgeConfig) {
    super(scope, id, {
