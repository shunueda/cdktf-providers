// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_acl_profile_subscribe_topic_exception
...
export interface MsgVpnAclProfileSubscribeTopicExceptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_acl_profile_subscribe_topic_exception#acl_profile_name MsgVpnAclProfileSubscribeTopicException#acl_profile_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_acl_profile_subscribe_topic_exception#msg_vpn_name MsgVpnAclProfileSubscribeTopicException#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_acl_profile_subscribe_topic_exception#subscribe_topic_exception MsgVpnAclProfileSubscribeTopicException#subscribe_topic_exception}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_acl_profile_subscribe_topic_exception#subscribe_topic_exception_syntax MsgVpnAclProfileSubscribeTopicException#subscribe_topic_exception_syntax}
  */
  readonly subscribeTopicExceptionSyntax: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_acl_profile_subscribe_topic_exception solacebroker_msg_vpn_acl_profile_subscribe_topic_exception}
*/
export class MsgVpnAclProfileSubscribeTopicException extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MsgVpnAclProfileSubscribeTopicException that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_acl_profile_subscribe_topic_exception#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_acl_profile_subscribe_topic_exception solacebroker_msg_vpn_acl_profile_subscribe_topic_exception} Resource
  *
  * @param scope The scope in which to define this construct
