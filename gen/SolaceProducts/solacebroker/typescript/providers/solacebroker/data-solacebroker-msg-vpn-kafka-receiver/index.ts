// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_kafka_receiver
...
export interface DataSolacebrokerMsgVpnKafkaReceiverConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_kafka_receiver#kafka_receiver_name DataSolacebrokerMsgVpnKafkaReceiver#kafka_receiver_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_kafka_receiver#msg_vpn_name DataSolacebrokerMsgVpnKafkaReceiver#msg_vpn_name}
  */
  readonly msgVpnName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_kafka_receiver solacebroker_msg_vpn_kafka_receiver}
*/
export class DataSolacebrokerMsgVpnKafkaReceiver extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnKafkaReceiver that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_kafka_receiver#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_kafka_receiver solacebroker_msg_vpn_kafka_receiver} Data Source
  *
  * @param scope The scope in which to define this construct
