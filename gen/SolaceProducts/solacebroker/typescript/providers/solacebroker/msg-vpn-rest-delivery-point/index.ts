// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_rest_delivery_point
...
export interface MsgVpnRestDeliveryPointConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_rest_delivery_point#client_profile_name MsgVpnRestDeliveryPoint#client_profile_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_rest_delivery_point#enabled MsgVpnRestDeliveryPoint#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_rest_delivery_point#msg_vpn_name MsgVpnRestDeliveryPoint#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_rest_delivery_point#rest_delivery_point_name MsgVpnRestDeliveryPoint#rest_delivery_point_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_rest_delivery_point#service MsgVpnRestDeliveryPoint#service}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only". The minimum access scope/level required to change this attribute is "vpn/read-write". Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `""`. Available since SEMP API version 2.19.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_rest_delivery_point#vendor MsgVpnRestDeliveryPoint#vendor}
  */
  readonly vendor?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_rest_delivery_point solacebroker_msg_vpn_rest_delivery_point}
*/
export class MsgVpnRestDeliveryPoint extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a MsgVpnRestDeliveryPoint resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the MsgVpnRestDeliveryPoint to import
  * @param importFromId The id of the existing MsgVpnRestDeliveryPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_rest_delivery_point#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the MsgVpnRestDeliveryPoint to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_rest_delivery_point solacebroker_msg_vpn_rest_delivery_point} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options MsgVpnRestDeliveryPointConfig
  */
  public constructor(scope: Construct, id: string, config: MsgVpnRestDeliveryPointConfig) {
    super(scope, id, {
