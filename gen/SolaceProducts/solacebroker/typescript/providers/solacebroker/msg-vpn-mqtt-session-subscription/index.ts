// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_mqtt_session_subscription
...
export interface MsgVpnMqttSessionSubscriptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_mqtt_session_subscription#mqtt_session_client_id MsgVpnMqttSessionSubscription#mqtt_session_client_id}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_mqtt_session_subscription#mqtt_session_virtual_router MsgVpnMqttSessionSubscription#mqtt_session_virtual_router}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_mqtt_session_subscription#msg_vpn_name MsgVpnMqttSessionSubscription#msg_vpn_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_mqtt_session_subscription#subscription_qos MsgVpnMqttSessionSubscription#subscription_qos}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_mqtt_session_subscription#subscription_topic MsgVpnMqttSessionSubscription#subscription_topic}
  */
  readonly subscriptionTopic: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_mqtt_session_subscription solacebroker_msg_vpn_mqtt_session_subscription}
*/
export class MsgVpnMqttSessionSubscription extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MsgVpnMqttSessionSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_mqtt_session_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_mqtt_session_subscription solacebroker_msg_vpn_mqtt_session_subscription} Resource
  *
  * @param scope The scope in which to define this construct
