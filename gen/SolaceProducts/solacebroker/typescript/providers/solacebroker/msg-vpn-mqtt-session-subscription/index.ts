// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_mqtt_session_subscription
...
export interface MsgVpnMqttSessionSubscriptionConfig extends cdktf.TerraformMetaArguments {
  /**
  * The Client ID of the MQTT Session, which corresponds to the ClientId provided in the MQTT CONNECT packet.
  * 
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_mqtt_session_subscription#mqtt_session_client_id MsgVpnMqttSessionSubscription#mqtt_session_client_id}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_mqtt_session_subscription#mqtt_session_virtual_router MsgVpnMqttSessionSubscription#mqtt_session_virtual_router}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_mqtt_session_subscription#msg_vpn_name MsgVpnMqttSessionSubscription#msg_vpn_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_mqtt_session_subscription#subscription_qos MsgVpnMqttSessionSubscription#subscription_qos}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_mqtt_session_subscription#subscription_topic MsgVpnMqttSessionSubscription#subscription_topic}
  */
  readonly subscriptionTopic: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_mqtt_session_subscription solacebroker_msg_vpn_mqtt_session_subscription}
*/
export class MsgVpnMqttSessionSubscription extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a MsgVpnMqttSessionSubscription resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the MsgVpnMqttSessionSubscription to import
  * @param importFromId The id of the existing MsgVpnMqttSessionSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_mqtt_session_subscription#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the MsgVpnMqttSessionSubscription to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/msg_vpn_mqtt_session_subscription solacebroker_msg_vpn_mqtt_session_subscription} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options MsgVpnMqttSessionSubscriptionConfig
  */
  public constructor(scope: Construct, id: string, config: MsgVpnMqttSessionSubscriptionConfig) {
    super(scope, id, {
