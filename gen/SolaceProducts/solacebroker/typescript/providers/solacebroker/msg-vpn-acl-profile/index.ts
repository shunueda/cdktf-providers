...
export interface MsgVpnAclProfileConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class MsgVpnAclProfile extends cdktf.TerraformResource {
  ...
  * @param options MsgVpnAclProfileConfig
  */
  public constructor(scope: Construct, id: string, config: MsgVpnAclProfileConfig) {
    super(scope, id, {
