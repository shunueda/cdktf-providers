// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_mqtt_retain_cache
...
export interface DataSolacebrokerMsgVpnMqttRetainCacheConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_mqtt_retain_cache#cache_name DataSolacebrokerMsgVpnMqttRetainCache#cache_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_mqtt_retain_cache#msg_vpn_name DataSolacebrokerMsgVpnMqttRetainCache#msg_vpn_name}
  */
  readonly msgVpnName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_mqtt_retain_cache solacebroker_msg_vpn_mqtt_retain_cache}
*/
export class DataSolacebrokerMsgVpnMqttRetainCache extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnMqttRetainCache that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_mqtt_retain_cache#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_mqtt_retain_cache solacebroker_msg_vpn_mqtt_retain_cache} Data Source
  *
  * @param scope The scope in which to define this construct
