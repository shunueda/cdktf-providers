...
export interface MsgVpnProxyConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class MsgVpnProxy extends cdktf.TerraformResource {
  ...
  * @param options MsgVpnProxyConfig
  */
  public constructor(scope: Construct, id: string, config: MsgVpnProxyConfig) {
    super(scope, id, {
