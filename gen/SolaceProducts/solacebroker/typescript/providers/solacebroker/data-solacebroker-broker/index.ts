...
export class DataSolacebrokerBroker extends cdktf.TerraformDataSource {
  ...
  */
  ...
  // guaranteed_msging_msg_spool_sync_mirrored_msg_ack_timeout - computed: true, optional: false, required: false
  ...
  // guaranteed_msging_msg_spool_sync_mirrored_spool_file_ack_timeout - computed: true, optional: false, required: false
  ...
  // service_mate_link_enabled - computed: true, optional: false, required: false
  public get serviceMateLinkEnabled() {
    return this.getBooleanAttribute('service_mate_link_enabled');
  }

  // service_mate_link_listen_port - computed: true, optional: false, required: false
  ...
  // service_redundancy_enabled - computed: true, optional: false, required: false
  public get serviceRedundancyEnabled() {
    return this.getBooleanAttribute('service_redundancy_enabled');
  }

  // service_redundancy_first_listen_port - computed: true, optional: false, required: false
