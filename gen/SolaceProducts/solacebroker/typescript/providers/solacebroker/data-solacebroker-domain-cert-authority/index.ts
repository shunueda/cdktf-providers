// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/domain_cert_authority
...
export interface DataSolacebrokerDomainCertAuthorityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/domain_cert_authority#cert_authority_name DataSolacebrokerDomainCertAuthority#cert_authority_name}
  */
  readonly certAuthorityName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/domain_cert_authority solacebroker_domain_cert_authority}
*/
export class DataSolacebrokerDomainCertAuthority extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerDomainCertAuthority that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/domain_cert_authority#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/domain_cert_authority solacebroker_domain_cert_authority} Data Source
  *
  * @param scope The scope in which to define this construct
