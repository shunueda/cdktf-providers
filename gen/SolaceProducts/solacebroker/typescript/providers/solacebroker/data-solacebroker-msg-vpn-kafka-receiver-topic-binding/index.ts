// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_kafka_receiver_topic_binding
...
export interface DataSolacebrokerMsgVpnKafkaReceiverTopicBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_kafka_receiver_topic_binding#kafka_receiver_name DataSolacebrokerMsgVpnKafkaReceiverTopicBinding#kafka_receiver_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_kafka_receiver_topic_binding#msg_vpn_name DataSolacebrokerMsgVpnKafkaReceiverTopicBinding#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_kafka_receiver_topic_binding#topic_name DataSolacebrokerMsgVpnKafkaReceiverTopicBinding#topic_name}
  */
  readonly topicName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_kafka_receiver_topic_binding solacebroker_msg_vpn_kafka_receiver_topic_binding}
*/
export class DataSolacebrokerMsgVpnKafkaReceiverTopicBinding extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnKafkaReceiverTopicBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_kafka_receiver_topic_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_kafka_receiver_topic_binding solacebroker_msg_vpn_kafka_receiver_topic_binding} Data Source
  *
  * @param scope The scope in which to define this construct
