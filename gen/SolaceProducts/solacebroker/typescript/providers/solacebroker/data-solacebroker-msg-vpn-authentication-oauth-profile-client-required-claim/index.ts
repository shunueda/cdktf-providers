// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_authentication_oauth_profile_client_required_claim
...
export interface DataSolacebrokerMsgVpnAuthenticationOauthProfileClientRequiredClaimConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_authentication_oauth_profile_client_required_claim#client_required_claim_name DataSolacebrokerMsgVpnAuthenticationOauthProfileClientRequiredClaim#client_required_claim_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_authentication_oauth_profile_client_required_claim#msg_vpn_name DataSolacebrokerMsgVpnAuthenticationOauthProfileClientRequiredClaim#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_authentication_oauth_profile_client_required_claim#oauth_profile_name DataSolacebrokerMsgVpnAuthenticationOauthProfileClientRequiredClaim#oauth_profile_name}
  */
  readonly oauthProfileName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_authentication_oauth_profile_client_required_claim solacebroker_msg_vpn_authentication_oauth_profile_client_required_claim}
*/
export class DataSolacebrokerMsgVpnAuthenticationOauthProfileClientRequiredClaim extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnAuthenticationOauthProfileClientRequiredClaim that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_authentication_oauth_profile_client_required_claim#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_authentication_oauth_profile_client_required_claim solacebroker_msg_vpn_authentication_oauth_profile_client_required_claim} Data Source
  *
  * @param scope The scope in which to define this construct
