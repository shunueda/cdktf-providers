// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/oauth_profile_resource_server_required_claim
...
export interface OauthProfileResourceServerRequiredClaimConfig extends cdktf.TerraformMetaArguments {
  /**
  * The name of the OAuth profile.
  * 
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/oauth_profile_resource_server_required_claim#oauth_profile_name OauthProfileResourceServerRequiredClaim#oauth_profile_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/oauth_profile_resource_server_required_claim#resource_server_required_claim_name OauthProfileResourceServerRequiredClaim#resource_server_required_claim_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/oauth_profile_resource_server_required_claim#resource_server_required_claim_value OauthProfileResourceServerRequiredClaim#resource_server_required_claim_value}
  */
  readonly resourceServerRequiredClaimValue: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/oauth_profile_resource_server_required_claim solacebroker_oauth_profile_resource_server_required_claim}
*/
export class OauthProfileResourceServerRequiredClaim extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a OauthProfileResourceServerRequiredClaim resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the OauthProfileResourceServerRequiredClaim to import
  * @param importFromId The id of the existing OauthProfileResourceServerRequiredClaim that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/oauth_profile_resource_server_required_claim#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the OauthProfileResourceServerRequiredClaim to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/oauth_profile_resource_server_required_claim solacebroker_oauth_profile_resource_server_required_claim} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options OauthProfileResourceServerRequiredClaimConfig
  */
  public constructor(scope: Construct, id: string, config: OauthProfileResourceServerRequiredClaimConfig) {
    super(scope, id, {
