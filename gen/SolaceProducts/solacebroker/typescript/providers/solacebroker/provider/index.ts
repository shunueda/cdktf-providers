// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs
...
export interface SolacebrokerProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs#bearer_token SolacebrokerProvider#bearer_token}
  */
  readonly bearerToken?: string;
  /**
  * Disable validation of server SSL certificates, accept/ignore self-signed. The default value is false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs#insecure_skip_verify SolacebrokerProvider#insecure_skip_verify}
  */
  readonly insecureSkipVerify?: boolean | cdktf.IResolvable;
  /**
  * The password to connect to the broker with. Requires username and conflicts with bearer_token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs#password SolacebrokerProvider#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs#request_min_interval SolacebrokerProvider#request_min_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs#request_timeout_duration SolacebrokerProvider#request_timeout_duration}
  */
  readonly requestTimeoutDuration?: string;
  /**
  * The number of retries for a SEMP call. The default value is 10.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs#retries SolacebrokerProvider#retries}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs#retry_max_interval SolacebrokerProvider#retry_max_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs#retry_min_interval SolacebrokerProvider#retry_min_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs#skip_api_check SolacebrokerProvider#skip_api_check}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs#url SolacebrokerProvider#url}
  */
  readonly url: string;
  /**
  * The username to connect to the broker with.  Requires password and conflicts with bearer_token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs#username SolacebrokerProvider#username}
  */
  readonly username?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs#alias SolacebrokerProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs solacebroker}
*/
export class SolacebrokerProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing SolacebrokerProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs solacebroker} Resource
  *
  * @param scope The scope in which to define this construct
