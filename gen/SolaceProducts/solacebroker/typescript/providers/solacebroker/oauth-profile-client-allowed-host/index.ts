// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/oauth_profile_client_allowed_host
...
export interface OauthProfileClientAllowedHostConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/oauth_profile_client_allowed_host#allowed_host OauthProfileClientAllowedHost#allowed_host}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/oauth_profile_client_allowed_host#oauth_profile_name OauthProfileClientAllowedHost#oauth_profile_name}
  */
  readonly oauthProfileName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/oauth_profile_client_allowed_host solacebroker_oauth_profile_client_allowed_host}
*/
export class OauthProfileClientAllowedHost extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OauthProfileClientAllowedHost that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/oauth_profile_client_allowed_host#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/oauth_profile_client_allowed_host solacebroker_oauth_profile_client_allowed_host} Resource
  *
  * @param scope The scope in which to define this construct
