...
export interface MsgVpnRestDeliveryPointQueueBindingRequestHeaderConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class MsgVpnRestDeliveryPointQueueBindingRequestHeader extends cdktf.TerraformResource {
  ...
  * @param options MsgVpnRestDeliveryPointQueueBindingRequestHeaderConfig
  */
  public constructor(scope: Construct, id: string, config: MsgVpnRestDeliveryPointQueueBindingRequestHeaderConfig) {
    super(scope, id, {
