// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_bridge_remote_subscription
...
export interface MsgVpnBridgeRemoteSubscriptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_bridge_remote_subscription#bridge_name MsgVpnBridgeRemoteSubscription#bridge_name}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_bridge_remote_subscription#bridge_virtual_router MsgVpnBridgeRemoteSubscription#bridge_virtual_router}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_bridge_remote_subscription#deliver_always_enabled MsgVpnBridgeRemoteSubscription#deliver_always_enabled}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_bridge_remote_subscription#msg_vpn_name MsgVpnBridgeRemoteSubscription#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_bridge_remote_subscription#remote_subscription_topic MsgVpnBridgeRemoteSubscription#remote_subscription_topic}
  */
  readonly remoteSubscriptionTopic: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_bridge_remote_subscription solacebroker_msg_vpn_bridge_remote_subscription}
*/
export class MsgVpnBridgeRemoteSubscription extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MsgVpnBridgeRemoteSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_bridge_remote_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/resources/msg_vpn_bridge_remote_subscription solacebroker_msg_vpn_bridge_remote_subscription} Resource
  *
  * @param scope The scope in which to define this construct
