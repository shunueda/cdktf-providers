// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_authentication_oauth_profile_resource_server_required_claim
...
export interface DataSolacebrokerMsgVpnAuthenticationOauthProfileResourceServerRequiredClaimConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_authentication_oauth_profile_resource_server_required_claim#msg_vpn_name DataSolacebrokerMsgVpnAuthenticationOauthProfileResourceServerRequiredClaim#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_authentication_oauth_profile_resource_server_required_claim#oauth_profile_name DataSolacebrokerMsgVpnAuthenticationOauthProfileResourceServerRequiredClaim#oauth_profile_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_authentication_oauth_profile_resource_server_required_claim#resource_server_required_claim_name DataSolacebrokerMsgVpnAuthenticationOauthProfileResourceServerRequiredClaim#resource_server_required_claim_name}
  */
  readonly resourceServerRequiredClaimName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_authentication_oauth_profile_resource_server_required_claim solacebroker_msg_vpn_authentication_oauth_profile_resource_server_required_claim}
*/
export class DataSolacebrokerMsgVpnAuthenticationOauthProfileResourceServerRequiredClaim extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnAuthenticationOauthProfileResourceServerRequiredClaim that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_authentication_oauth_profile_resource_server_required_claim#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_authentication_oauth_profile_resource_server_required_claim solacebroker_msg_vpn_authentication_oauth_profile_resource_server_required_claim} Data Source
  *
  * @param scope The scope in which to define this construct
