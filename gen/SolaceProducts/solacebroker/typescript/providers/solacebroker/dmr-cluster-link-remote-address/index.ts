...
export interface DmrClusterLinkRemoteAddressConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DmrClusterLinkRemoteAddress extends cdktf.TerraformResource {
  ...
  * @param options DmrClusterLinkRemoteAddressConfig
  */
  public constructor(scope: Construct, id: string, config: DmrClusterLinkRemoteAddressConfig) {
    super(scope, id, {
