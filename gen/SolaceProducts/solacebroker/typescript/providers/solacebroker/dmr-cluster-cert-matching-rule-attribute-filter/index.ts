...
export interface DmrClusterCertMatchingRuleAttributeFilterConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DmrClusterCertMatchingRuleAttributeFilter extends cdktf.TerraformResource {
  ...
  * @param options DmrClusterCertMatchingRuleAttributeFilterConfig
  */
  public constructor(scope: Construct, id: string, config: DmrClusterCertMatchingRuleAttributeFilterConfig) {
    super(scope, id, {
