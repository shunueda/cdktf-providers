// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/dmr_cluster_link_attribute
...
export interface DmrClusterLinkAttributeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/dmr_cluster_link_attribute#attribute_name DmrClusterLinkAttribute#attribute_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/dmr_cluster_link_attribute#attribute_value DmrClusterLinkAttribute#attribute_value}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/dmr_cluster_link_attribute#dmr_cluster_name DmrClusterLinkAttribute#dmr_cluster_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/dmr_cluster_link_attribute#remote_node_name DmrClusterLinkAttribute#remote_node_name}
  */
  readonly remoteNodeName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/dmr_cluster_link_attribute solacebroker_dmr_cluster_link_attribute}
*/
export class DmrClusterLinkAttribute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DmrClusterLinkAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/dmr_cluster_link_attribute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/resources/dmr_cluster_link_attribute solacebroker_dmr_cluster_link_attribute} Resource
  *
  * @param scope The scope in which to define this construct
