// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding_request_header
...
export interface DataSolacebrokerMsgVpnRestDeliveryPointQueueBindingRequestHeaderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding_request_header#header_name DataSolacebrokerMsgVpnRestDeliveryPointQueueBindingRequestHeader#header_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding_request_header#msg_vpn_name DataSolacebrokerMsgVpnRestDeliveryPointQueueBindingRequestHeader#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding_request_header#queue_binding_name DataSolacebrokerMsgVpnRestDeliveryPointQueueBindingRequestHeader#queue_binding_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding_request_header#rest_delivery_point_name DataSolacebrokerMsgVpnRestDeliveryPointQueueBindingRequestHeader#rest_delivery_point_name}
  */
  readonly restDeliveryPointName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding_request_header solacebroker_msg_vpn_rest_delivery_point_queue_binding_request_header}
*/
export class DataSolacebrokerMsgVpnRestDeliveryPointQueueBindingRequestHeader extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnRestDeliveryPointQueueBindingRequestHeader that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding_request_header#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.3.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding_request_header solacebroker_msg_vpn_rest_delivery_point_queue_binding_request_header} Data Source
  *
  * @param scope The scope in which to define this construct
