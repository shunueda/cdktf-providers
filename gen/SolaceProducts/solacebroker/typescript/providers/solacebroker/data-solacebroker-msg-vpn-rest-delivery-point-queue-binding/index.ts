// https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding
...
export interface DataSolacebrokerMsgVpnRestDeliveryPointQueueBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding#msg_vpn_name DataSolacebrokerMsgVpnRestDeliveryPointQueueBinding#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding#queue_binding_name DataSolacebrokerMsgVpnRestDeliveryPointQueueBinding#queue_binding_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding#rest_delivery_point_name DataSolacebrokerMsgVpnRestDeliveryPointQueueBinding#rest_delivery_point_name}
  */
  readonly restDeliveryPointName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding solacebroker_msg_vpn_rest_delivery_point_queue_binding}
*/
export class DataSolacebrokerMsgVpnRestDeliveryPointQueueBinding extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnRestDeliveryPointQueueBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebroker/1.2.0/docs/data-sources/msg_vpn_rest_delivery_point_queue_binding solacebroker_msg_vpn_rest_delivery_point_queue_binding} Data Source
  *
  * @param scope The scope in which to define this construct
