// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_telemetry_profile_trace_filter
...
export interface DataSolacebrokerMsgVpnTelemetryProfileTraceFilterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_telemetry_profile_trace_filter#msg_vpn_name DataSolacebrokerMsgVpnTelemetryProfileTraceFilter#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_telemetry_profile_trace_filter#telemetry_profile_name DataSolacebrokerMsgVpnTelemetryProfileTraceFilter#telemetry_profile_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_telemetry_profile_trace_filter#trace_filter_name DataSolacebrokerMsgVpnTelemetryProfileTraceFilter#trace_filter_name}
  */
  readonly traceFilterName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_telemetry_profile_trace_filter solacebroker_msg_vpn_telemetry_profile_trace_filter}
*/
export class DataSolacebrokerMsgVpnTelemetryProfileTraceFilter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnTelemetryProfileTraceFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_telemetry_profile_trace_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_telemetry_profile_trace_filter solacebroker_msg_vpn_telemetry_profile_trace_filter} Data Source
  *
  * @param scope The scope in which to define this construct
