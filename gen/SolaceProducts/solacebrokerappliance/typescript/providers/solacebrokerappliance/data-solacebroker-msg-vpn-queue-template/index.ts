// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_queue_template
...
export interface DataSolacebrokerMsgVpnQueueTemplateConfig extends cdktf.TerraformMetaArguments {
  /**
  * The name of the Message VPN.
  * 
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_queue_template#msg_vpn_name DataSolacebrokerMsgVpnQueueTemplate#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_queue_template#queue_template_name DataSolacebrokerMsgVpnQueueTemplate#queue_template_name}
  */
  readonly queueTemplateName: string;
}
export interface DataSolacebrokerMsgVpnQueueTemplateEventBindCountThreshold {
}

export function dataSolacebrokerMsgVpnQueueTemplateEventBindCountThresholdToTerraform(struct?: DataSolacebrokerMsgVpnQueueTemplateEventBindCountThreshold): any {
...
export function dataSolacebrokerMsgVpnQueueTemplateEventBindCountThresholdToHclTerraform(struct?: DataSolacebrokerMsgVpnQueueTemplateEventBindCountThreshold): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSolacebrokerMsgVpnQueueTemplateEventBindCountThresholdOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSolacebrokerMsgVpnQueueTemplateEventBindCountThreshold | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSolacebrokerMsgVpnQueueTemplateEventBindCountThreshold | undefined) {
    if (value === undefined) {
...
export interface DataSolacebrokerMsgVpnQueueTemplateEventMsgSpoolUsageThreshold {
}

export function dataSolacebrokerMsgVpnQueueTemplateEventMsgSpoolUsageThresholdToTerraform(struct?: DataSolacebrokerMsgVpnQueueTemplateEventMsgSpoolUsageThreshold): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataSolacebrokerMsgVpnQueueTemplateEventMsgSpoolUsageThresholdToHclTerraform(struct?: DataSolacebrokerMsgVpnQueueTemplateEventMsgSpoolUsageThreshold): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSolacebrokerMsgVpnQueueTemplateEventMsgSpoolUsageThresholdOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSolacebrokerMsgVpnQueueTemplateEventMsgSpoolUsageThreshold | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSolacebrokerMsgVpnQueueTemplateEventMsgSpoolUsageThreshold | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export interface DataSolacebrokerMsgVpnQueueTemplateEventRejectLowPriorityMsgLimitThreshold {
}

export function dataSolacebrokerMsgVpnQueueTemplateEventRejectLowPriorityMsgLimitThresholdToTerraform(struct?: DataSolacebrokerMsgVpnQueueTemplateEventRejectLowPriorityMsgLimitThreshold): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataSolacebrokerMsgVpnQueueTemplateEventRejectLowPriorityMsgLimitThresholdToHclTerraform(struct?: DataSolacebrokerMsgVpnQueueTemplateEventRejectLowPriorityMsgLimitThreshold): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSolacebrokerMsgVpnQueueTemplateEventRejectLowPriorityMsgLimitThresholdOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSolacebrokerMsgVpnQueueTemplateEventRejectLowPriorityMsgLimitThreshold | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSolacebrokerMsgVpnQueueTemplateEventRejectLowPriorityMsgLimitThreshold | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_queue_template solacebroker_msg_vpn_queue_template}
*/
export class DataSolacebrokerMsgVpnQueueTemplate extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataSolacebrokerMsgVpnQueueTemplate resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataSolacebrokerMsgVpnQueueTemplate to import
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnQueueTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_queue_template#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataSolacebrokerMsgVpnQueueTemplate to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_queue_template solacebroker_msg_vpn_queue_template} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataSolacebrokerMsgVpnQueueTemplateConfig
  */
  public constructor(scope: Construct, id: string, config: DataSolacebrokerMsgVpnQueueTemplateConfig) {
    super(scope, id, {
  ...
  // durability_override - computed: true, optional: false, required: false
  ...
  private _eventBindCountThreshold = new DataSolacebrokerMsgVpnQueueTemplateEventBindCountThresholdOutputReference(this, "event_bind_count_threshold");
  ...
  private _eventMsgSpoolUsageThreshold = new DataSolacebrokerMsgVpnQueueTemplateEventMsgSpoolUsageThresholdOutputReference(this, "event_msg_spool_usage_threshold");
  ...
  private _eventRejectLowPriorityMsgLimitThreshold = new DataSolacebrokerMsgVpnQueueTemplateEventRejectLowPriorityMsgLimitThresholdOutputReference(this, "event_reject_low_priority_msg_limit_threshold");
  ...
  // queue_name_filter - computed: true, optional: false, required: false
