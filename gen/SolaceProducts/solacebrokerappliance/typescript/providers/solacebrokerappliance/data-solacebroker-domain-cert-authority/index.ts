// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_domain_cert_authority
...
export interface DataSolacebrokerDomainCertAuthorityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_domain_cert_authority#cert_authority_name DataSolacebrokerDomainCertAuthority#cert_authority_name}
  */
  readonly certAuthorityName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_domain_cert_authority solacebroker_domain_cert_authority}
*/
export class DataSolacebrokerDomainCertAuthority extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_domain_cert_authority solacebroker_domain_cert_authority} Data Source
  *
  * @param scope The scope in which to define this construct
