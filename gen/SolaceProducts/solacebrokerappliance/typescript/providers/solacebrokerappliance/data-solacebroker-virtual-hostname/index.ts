// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_virtual_hostname
...
export interface DataSolacebrokerVirtualHostnameConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_virtual_hostname#virtual_hostname DataSolacebrokerVirtualHostname#virtual_hostname}
  */
  readonly virtualHostname: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_virtual_hostname solacebroker_virtual_hostname}
*/
export class DataSolacebrokerVirtualHostname extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_virtual_hostname solacebroker_virtual_hostname} Data Source
  *
  * @param scope The scope in which to define this construct
