// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_replay_log_topic_filter_subscription
...
export interface DataSolacebrokerMsgVpnReplayLogTopicFilterSubscriptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_replay_log_topic_filter_subscription#msg_vpn_name DataSolacebrokerMsgVpnReplayLogTopicFilterSubscription#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_replay_log_topic_filter_subscription#replay_log_name DataSolacebrokerMsgVpnReplayLogTopicFilterSubscription#replay_log_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_replay_log_topic_filter_subscription#topic_filter_subscription DataSolacebrokerMsgVpnReplayLogTopicFilterSubscription#topic_filter_subscription}
  */
  readonly topicFilterSubscription: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_replay_log_topic_filter_subscription solacebroker_msg_vpn_replay_log_topic_filter_subscription}
*/
export class DataSolacebrokerMsgVpnReplayLogTopicFilterSubscription extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnReplayLogTopicFilterSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_replay_log_topic_filter_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_replay_log_topic_filter_subscription solacebroker_msg_vpn_replay_log_topic_filter_subscription} Data Source
  *
  * @param scope The scope in which to define this construct
