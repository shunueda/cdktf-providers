// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_dmr_cluster_cert_matching_rule
...
export interface SolacebrokerDmrClusterCertMatchingRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_dmr_cluster_cert_matching_rule#dmr_cluster_name SolacebrokerDmrClusterCertMatchingRule#dmr_cluster_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_dmr_cluster_cert_matching_rule#enabled SolacebrokerDmrClusterCertMatchingRule#enabled}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_dmr_cluster_cert_matching_rule#rule_name SolacebrokerDmrClusterCertMatchingRule#rule_name}
  */
  readonly ruleName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_dmr_cluster_cert_matching_rule solacebroker_dmr_cluster_cert_matching_rule}
*/
export class SolacebrokerDmrClusterCertMatchingRule extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_dmr_cluster_cert_matching_rule solacebroker_dmr_cluster_cert_matching_rule} Resource
  *
  * @param scope The scope in which to define this construct
