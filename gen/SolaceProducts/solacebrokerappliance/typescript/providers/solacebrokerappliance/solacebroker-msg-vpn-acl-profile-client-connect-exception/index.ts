// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_acl_profile_client_connect_exception
...
export interface SolacebrokerMsgVpnAclProfileClientConnectExceptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_acl_profile_client_connect_exception#acl_profile_name SolacebrokerMsgVpnAclProfileClientConnectException#acl_profile_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_acl_profile_client_connect_exception#msg_vpn_name SolacebrokerMsgVpnAclProfileClientConnectException#msg_vpn_name}
  */
  readonly msgVpnName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_acl_profile_client_connect_exception solacebroker_msg_vpn_acl_profile_client_connect_exception}
*/
export class SolacebrokerMsgVpnAclProfileClientConnectException extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_acl_profile_client_connect_exception solacebroker_msg_vpn_acl_profile_client_connect_exception} Resource
  *
  * @param scope The scope in which to define this construct
