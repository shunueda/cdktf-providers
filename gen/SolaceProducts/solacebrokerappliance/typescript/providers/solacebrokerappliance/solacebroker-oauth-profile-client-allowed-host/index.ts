// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_oauth_profile_client_allowed_host
...
export interface SolacebrokerOauthProfileClientAllowedHostConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_oauth_profile_client_allowed_host#allowed_host SolacebrokerOauthProfileClientAllowedHost#allowed_host}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_oauth_profile_client_allowed_host#oauth_profile_name SolacebrokerOauthProfileClientAllowedHost#oauth_profile_name}
  */
  readonly oauthProfileName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_oauth_profile_client_allowed_host solacebroker_oauth_profile_client_allowed_host}
*/
export class SolacebrokerOauthProfileClientAllowedHost extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_oauth_profile_client_allowed_host solacebroker_oauth_profile_client_allowed_host} Resource
  *
  * @param scope The scope in which to define this construct
