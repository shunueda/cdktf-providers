// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_telemetry_profile_trace_filter_subscription
...
export interface SolacebrokerMsgVpnTelemetryProfileTraceFilterSubscriptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_telemetry_profile_trace_filter_subscription#msg_vpn_name SolacebrokerMsgVpnTelemetryProfileTraceFilterSubscription#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_telemetry_profile_trace_filter_subscription#subscription SolacebrokerMsgVpnTelemetryProfileTraceFilterSubscription#subscription}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_telemetry_profile_trace_filter_subscription#subscription_syntax SolacebrokerMsgVpnTelemetryProfileTraceFilterSubscription#subscription_syntax}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_telemetry_profile_trace_filter_subscription#telemetry_profile_name SolacebrokerMsgVpnTelemetryProfileTraceFilterSubscription#telemetry_profile_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_telemetry_profile_trace_filter_subscription#trace_filter_name SolacebrokerMsgVpnTelemetryProfileTraceFilterSubscription#trace_filter_name}
  */
  readonly traceFilterName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_telemetry_profile_trace_filter_subscription solacebroker_msg_vpn_telemetry_profile_trace_filter_subscription}
*/
export class SolacebrokerMsgVpnTelemetryProfileTraceFilterSubscription extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_telemetry_profile_trace_filter_subscription solacebroker_msg_vpn_telemetry_profile_trace_filter_subscription} Resource
  *
  * @param scope The scope in which to define this construct
