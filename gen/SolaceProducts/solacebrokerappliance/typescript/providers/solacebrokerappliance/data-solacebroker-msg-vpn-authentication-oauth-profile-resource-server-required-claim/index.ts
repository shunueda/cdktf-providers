...
export interface DataSolacebrokerMsgVpnAuthenticationOauthProfileResourceServerRequiredClaimConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DataSolacebrokerMsgVpnAuthenticationOauthProfileResourceServerRequiredClaim extends cdktf.TerraformDataSource {
  ...
  * @param options DataSolacebrokerMsgVpnAuthenticationOauthProfileResourceServerRequiredClaimConfig
  */
  public constructor(scope: Construct, id: string, config: DataSolacebrokerMsgVpnAuthenticationOauthProfileResourceServerRequiredClaimConfig) {
    super(scope, id, {
