// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_msg_vpn_replay_log_topic_filter_subscription
...
export interface SolacebrokerMsgVpnReplayLogTopicFilterSubscriptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_msg_vpn_replay_log_topic_filter_subscription#msg_vpn_name SolacebrokerMsgVpnReplayLogTopicFilterSubscription#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_msg_vpn_replay_log_topic_filter_subscription#replay_log_name SolacebrokerMsgVpnReplayLogTopicFilterSubscription#replay_log_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_msg_vpn_replay_log_topic_filter_subscription#topic_filter_subscription SolacebrokerMsgVpnReplayLogTopicFilterSubscription#topic_filter_subscription}
  */
  readonly topicFilterSubscription: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_msg_vpn_replay_log_topic_filter_subscription solacebroker_msg_vpn_replay_log_topic_filter_subscription}
*/
export class SolacebrokerMsgVpnReplayLogTopicFilterSubscription extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_msg_vpn_replay_log_topic_filter_subscription solacebroker_msg_vpn_replay_log_topic_filter_subscription} Resource
  *
  * @param scope The scope in which to define this construct
