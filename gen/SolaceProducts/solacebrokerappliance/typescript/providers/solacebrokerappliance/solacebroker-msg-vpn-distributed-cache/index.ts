// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_distributed_cache
...
export interface SolacebrokerMsgVpnDistributedCacheConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_distributed_cache#cache_name SolacebrokerMsgVpnDistributedCache#cache_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_distributed_cache#cache_virtual_router SolacebrokerMsgVpnDistributedCache#cache_virtual_router}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_distributed_cache#enabled SolacebrokerMsgVpnDistributedCache#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_distributed_cache#heartbeat SolacebrokerMsgVpnDistributedCache#heartbeat}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_distributed_cache#msg_vpn_name SolacebrokerMsgVpnDistributedCache#msg_vpn_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_distributed_cache#scheduled_delete_msg_day_list SolacebrokerMsgVpnDistributedCache#scheduled_delete_msg_day_list}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only". The minimum access scope/level required to change this attribute is "vpn/read-write". Changes to this attribute are synchronized to HA mates and replication sites via config-sync. The default value is `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_distributed_cache#scheduled_delete_msg_time_list SolacebrokerMsgVpnDistributedCache#scheduled_delete_msg_time_list}
  */
  readonly scheduledDeleteMsgTimeList?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_distributed_cache solacebroker_msg_vpn_distributed_cache}
*/
export class SolacebrokerMsgVpnDistributedCache extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_distributed_cache solacebroker_msg_vpn_distributed_cache} Resource
  *
  * @param scope The scope in which to define this construct
