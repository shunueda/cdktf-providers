// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_domain_cert_authority
...
export interface SolacebrokerDomainCertAuthorityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_domain_cert_authority#cert_authority_name SolacebrokerDomainCertAuthority#cert_authority_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_domain_cert_authority#cert_content SolacebrokerDomainCertAuthority#cert_content}
  */
  readonly certContent?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_domain_cert_authority solacebroker_domain_cert_authority}
*/
export class SolacebrokerDomainCertAuthority extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_domain_cert_authority solacebroker_domain_cert_authority} Resource
  *
  * @param scope The scope in which to define this construct
