// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_mqtt_session_subscription
...
export interface SolacebrokerMsgVpnMqttSessionSubscriptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_mqtt_session_subscription#mqtt_session_client_id SolacebrokerMsgVpnMqttSessionSubscription#mqtt_session_client_id}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_mqtt_session_subscription#mqtt_session_virtual_router SolacebrokerMsgVpnMqttSessionSubscription#mqtt_session_virtual_router}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_mqtt_session_subscription#msg_vpn_name SolacebrokerMsgVpnMqttSessionSubscription#msg_vpn_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_mqtt_session_subscription#subscription_qos SolacebrokerMsgVpnMqttSessionSubscription#subscription_qos}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_mqtt_session_subscription#subscription_topic SolacebrokerMsgVpnMqttSessionSubscription#subscription_topic}
  */
  readonly subscriptionTopic: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_mqtt_session_subscription solacebroker_msg_vpn_mqtt_session_subscription}
*/
export class SolacebrokerMsgVpnMqttSessionSubscription extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_mqtt_session_subscription solacebroker_msg_vpn_mqtt_session_subscription} Resource
  *
  * @param scope The scope in which to define this construct
