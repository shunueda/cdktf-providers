...
export interface SolacebrokerMsgVpnAclProfileSubscribeTopicExceptionConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class SolacebrokerMsgVpnAclProfileSubscribeTopicException extends cdktf.TerraformResource {
  ...
  * @param options SolacebrokerMsgVpnAclProfileSubscribeTopicExceptionConfig
  */
  public constructor(scope: Construct, id: string, config: SolacebrokerMsgVpnAclProfileSubscribeTopicExceptionConfig) {
    super(scope, id, {
