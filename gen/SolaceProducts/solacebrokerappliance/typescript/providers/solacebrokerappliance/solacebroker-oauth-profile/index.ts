...
export interface SolacebrokerOauthProfileConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class SolacebrokerOauthProfile extends cdktf.TerraformResource {
  ...
  * @param options SolacebrokerOauthProfileConfig
  */
  public constructor(scope: Construct, id: string, config: SolacebrokerOauthProfileConfig) {
    super(scope, id, {
