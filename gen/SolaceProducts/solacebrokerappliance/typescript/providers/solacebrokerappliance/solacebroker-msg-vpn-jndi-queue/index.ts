// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_jndi_queue
...
export interface SolacebrokerMsgVpnJndiQueueConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_jndi_queue#msg_vpn_name SolacebrokerMsgVpnJndiQueue#msg_vpn_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_jndi_queue#physical_name SolacebrokerMsgVpnJndiQueue#physical_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_jndi_queue#queue_name SolacebrokerMsgVpnJndiQueue#queue_name}
  */
  readonly queueName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_jndi_queue solacebroker_msg_vpn_jndi_queue}
*/
export class SolacebrokerMsgVpnJndiQueue extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_jndi_queue solacebroker_msg_vpn_jndi_queue} Resource
  *
  * @param scope The scope in which to define this construct
