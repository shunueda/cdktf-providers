// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_oauth_profile_client_authorization_parameter
...
export interface DataSolacebrokerOauthProfileClientAuthorizationParameterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_oauth_profile_client_authorization_parameter#authorization_parameter_name DataSolacebrokerOauthProfileClientAuthorizationParameter#authorization_parameter_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_oauth_profile_client_authorization_parameter#oauth_profile_name DataSolacebrokerOauthProfileClientAuthorizationParameter#oauth_profile_name}
  */
  readonly oauthProfileName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_oauth_profile_client_authorization_parameter solacebroker_oauth_profile_client_authorization_parameter}
*/
export class DataSolacebrokerOauthProfileClientAuthorizationParameter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerOauthProfileClientAuthorizationParameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_oauth_profile_client_authorization_parameter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_oauth_profile_client_authorization_parameter solacebroker_oauth_profile_client_authorization_parameter} Data Source
  *
  * @param scope The scope in which to define this construct
