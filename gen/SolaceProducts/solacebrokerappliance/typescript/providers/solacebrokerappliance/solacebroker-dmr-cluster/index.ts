...
export interface SolacebrokerDmrClusterConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class SolacebrokerDmrCluster extends cdktf.TerraformResource {
  ...
  * @param options SolacebrokerDmrClusterConfig
  */
  public constructor(scope: Construct, id: string, config: SolacebrokerDmrClusterConfig) {
    super(scope, id, {
