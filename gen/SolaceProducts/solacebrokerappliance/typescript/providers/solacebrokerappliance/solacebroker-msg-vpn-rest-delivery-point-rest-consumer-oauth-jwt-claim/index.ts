// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim
...
export interface SolacebrokerMsgVpnRestDeliveryPointRestConsumerOauthJwtClaimConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim#msg_vpn_name SolacebrokerMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim#rest_consumer_name SolacebrokerMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim#rest_consumer_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim solacebroker_msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim}
*/
export class SolacebrokerMsgVpnRestDeliveryPointRestConsumerOauthJwtClaim extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/resources/solacebroker_msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim solacebroker_msg_vpn_rest_delivery_point_rest_consumer_oauth_jwt_claim} Resource
  *
  * @param scope The scope in which to define this construct
