// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_dmr_cluster_link
...
export interface DataSolacebrokerDmrClusterLinkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_dmr_cluster_link#dmr_cluster_name DataSolacebrokerDmrClusterLink#dmr_cluster_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_dmr_cluster_link#remote_node_name DataSolacebrokerDmrClusterLink#remote_node_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_dmr_cluster_link solacebroker_dmr_cluster_link}
*/
export class DataSolacebrokerDmrClusterLink extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerDmrClusterLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_dmr_cluster_link#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_dmr_cluster_link solacebroker_dmr_cluster_link} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // client_profile_tcp_slow_start_after_idle_enabled - computed: true, optional: false, required: false
