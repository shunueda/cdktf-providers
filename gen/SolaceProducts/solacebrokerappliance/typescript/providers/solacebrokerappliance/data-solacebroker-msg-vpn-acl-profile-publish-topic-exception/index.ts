// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_acl_profile_publish_topic_exception
...
export interface DataSolacebrokerMsgVpnAclProfilePublishTopicExceptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_acl_profile_publish_topic_exception#acl_profile_name DataSolacebrokerMsgVpnAclProfilePublishTopicException#acl_profile_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_acl_profile_publish_topic_exception#msg_vpn_name DataSolacebrokerMsgVpnAclProfilePublishTopicException#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_acl_profile_publish_topic_exception#publish_topic_exception DataSolacebrokerMsgVpnAclProfilePublishTopicException#publish_topic_exception}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_acl_profile_publish_topic_exception#publish_topic_exception_syntax DataSolacebrokerMsgVpnAclProfilePublishTopicException#publish_topic_exception_syntax}
  */
  readonly publishTopicExceptionSyntax: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_acl_profile_publish_topic_exception solacebroker_msg_vpn_acl_profile_publish_topic_exception}
*/
export class DataSolacebrokerMsgVpnAclProfilePublishTopicException extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_acl_profile_publish_topic_exception solacebroker_msg_vpn_acl_profile_publish_topic_exception} Data Source
  *
  * @param scope The scope in which to define this construct
