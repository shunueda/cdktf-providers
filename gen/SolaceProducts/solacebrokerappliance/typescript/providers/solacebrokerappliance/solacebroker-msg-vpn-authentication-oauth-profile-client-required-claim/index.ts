// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_msg_vpn_authentication_oauth_profile_client_required_claim
...
export interface SolacebrokerMsgVpnAuthenticationOauthProfileClientRequiredClaimConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_msg_vpn_authentication_oauth_profile_client_required_claim#client_required_claim_name SolacebrokerMsgVpnAuthenticationOauthProfileClientRequiredClaim#client_required_claim_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_msg_vpn_authentication_oauth_profile_client_required_claim#client_required_claim_value SolacebrokerMsgVpnAuthenticationOauthProfileClientRequiredClaim#client_required_claim_value}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_msg_vpn_authentication_oauth_profile_client_required_claim#msg_vpn_name SolacebrokerMsgVpnAuthenticationOauthProfileClientRequiredClaim#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_msg_vpn_authentication_oauth_profile_client_required_claim#oauth_profile_name SolacebrokerMsgVpnAuthenticationOauthProfileClientRequiredClaim#oauth_profile_name}
  */
  readonly oauthProfileName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_msg_vpn_authentication_oauth_profile_client_required_claim solacebroker_msg_vpn_authentication_oauth_profile_client_required_claim}
*/
export class SolacebrokerMsgVpnAuthenticationOauthProfileClientRequiredClaim extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/resources/solacebroker_msg_vpn_authentication_oauth_profile_client_required_claim solacebroker_msg_vpn_authentication_oauth_profile_client_required_claim} Resource
  *
  * @param scope The scope in which to define this construct
