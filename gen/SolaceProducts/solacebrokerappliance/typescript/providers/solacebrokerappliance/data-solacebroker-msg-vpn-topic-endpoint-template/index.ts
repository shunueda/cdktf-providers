// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_topic_endpoint_template
...
export interface DataSolacebrokerMsgVpnTopicEndpointTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_topic_endpoint_template#msg_vpn_name DataSolacebrokerMsgVpnTopicEndpointTemplate#msg_vpn_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "vpn/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_topic_endpoint_template#topic_endpoint_template_name DataSolacebrokerMsgVpnTopicEndpointTemplate#topic_endpoint_template_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_topic_endpoint_template solacebroker_msg_vpn_topic_endpoint_template}
*/
export class DataSolacebrokerMsgVpnTopicEndpointTemplate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerMsgVpnTopicEndpointTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_topic_endpoint_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_msg_vpn_topic_endpoint_template solacebroker_msg_vpn_topic_endpoint_template} Data Source
  *
  * @param scope The scope in which to define this construct
