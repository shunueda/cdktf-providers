// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_dmr_cluster_cert_matching_rule_condition
...
export interface DataSolacebrokerDmrClusterCertMatchingRuleConditionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_dmr_cluster_cert_matching_rule_condition#dmr_cluster_name DataSolacebrokerDmrClusterCertMatchingRuleCondition#dmr_cluster_name}
  */
  ...
  * The minimum access scope/level required to retrieve this attribute is "global/read-only".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_dmr_cluster_cert_matching_rule_condition#rule_name DataSolacebrokerDmrClusterCertMatchingRuleCondition#rule_name}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_dmr_cluster_cert_matching_rule_condition#source DataSolacebrokerDmrClusterCertMatchingRuleCondition#source}
  */
  readonly source: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_dmr_cluster_cert_matching_rule_condition solacebroker_dmr_cluster_cert_matching_rule_condition}
*/
export class DataSolacebrokerDmrClusterCertMatchingRuleCondition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerDmrClusterCertMatchingRuleCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_dmr_cluster_cert_matching_rule_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.3.0/docs/data-sources/solacebroker_dmr_cluster_cert_matching_rule_condition solacebroker_dmr_cluster_cert_matching_rule_condition} Data Source
  *
  * @param scope The scope in which to define this construct
