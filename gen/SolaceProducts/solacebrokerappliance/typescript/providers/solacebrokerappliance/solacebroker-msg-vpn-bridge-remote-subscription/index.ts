...
export interface SolacebrokerMsgVpnBridgeRemoteSubscriptionConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class SolacebrokerMsgVpnBridgeRemoteSubscription extends cdktf.TerraformResource {
  ...
  * @param options SolacebrokerMsgVpnBridgeRemoteSubscriptionConfig
  */
  public constructor(scope: Construct, id: string, config: SolacebrokerMsgVpnBridgeRemoteSubscriptionConfig) {
    super(scope, id, {
