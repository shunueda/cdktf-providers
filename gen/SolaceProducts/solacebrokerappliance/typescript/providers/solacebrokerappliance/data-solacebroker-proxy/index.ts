// https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_proxy
...
export interface DataSolacebrokerProxyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_proxy#proxy_name DataSolacebrokerProxy#proxy_name}
  */
  readonly proxyName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_proxy solacebroker_proxy}
*/
export class DataSolacebrokerProxy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolacebrokerProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_proxy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/solaceproducts/solacebrokerappliance/1.2.0/docs/data-sources/solacebroker_proxy solacebroker_proxy} Data Source
  *
  * @param scope The scope in which to define this construct
