// https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/data_partition_rule
...
export interface DataPartitionRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/data_partition_rule#account_id DataPartitionRule#account_id}
  */
  readonly accountId?: number;
  /**
  * The description of the data partition rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/data_partition_rule#description DataPartitionRule#description}
  */
  readonly description?: string;
  /**
  * Whether or not this data partition rule is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/data_partition_rule#enabled DataPartitionRule#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/data_partition_rule#id DataPartitionRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/data_partition_rule#nrql DataPartitionRule#nrql}
  */
  readonly nrql: string;
  /**
  * The retention policy of the data partition data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/data_partition_rule#retention_policy DataPartitionRule#retention_policy}
  */
  readonly retentionPolicy: string;
  /**
  * The name of the data partition where logs will be allocated once the rule is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/data_partition_rule#target_data_partition DataPartitionRule#target_data_partition}
  */
  readonly targetDataPartition: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/data_partition_rule#timeouts DataPartitionRule#timeouts}
  */
  readonly timeouts?: DataPartitionRuleTimeouts;
}
export interface DataPartitionRuleTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/data_partition_rule#create DataPartitionRule#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/data_partition_rule newrelic_data_partition_rule}
*/
export class DataPartitionRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataPartitionRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/data_partition_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/data_partition_rule newrelic_data_partition_rule} Resource
  *
  * @param scope The scope in which to define this construct
