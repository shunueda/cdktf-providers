// https://registry.terraform.io/providers/newrelic/newrelic/3.75.2/docs/resources/synthetics_broken_links_monitor
...
export class SyntheticsBrokenLinksMonitor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SyntheticsBrokenLinksMonitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.75.2/docs/resources/synthetics_broken_links_monitor#import import section} in the documentation of this resource for the id to use
