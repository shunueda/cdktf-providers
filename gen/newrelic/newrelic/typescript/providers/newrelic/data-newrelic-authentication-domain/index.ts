// https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/data-sources/authentication_domain
...
export interface DataNewrelicAuthenticationDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/data-sources/authentication_domain#name DataNewrelicAuthenticationDomain#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/data-sources/authentication_domain newrelic_authentication_domain}
*/
export class DataNewrelicAuthenticationDomain extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicAuthenticationDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/data-sources/authentication_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/data-sources/authentication_domain newrelic_authentication_domain} Data Source
  *
  * @param scope The scope in which to define this construct
