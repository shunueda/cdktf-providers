// https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow
...
export interface WorkflowConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#account_id Workflow#account_id}
  */
  readonly accountId?: number;
  /**
  * Indicates whether the destinations are enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#destinations_enabled Workflow#destinations_enabled}
  */
  readonly destinationsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether the workflow is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#enabled Workflow#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether the enrichments are enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#enrichments_enabled Workflow#enrichments_enabled}
  */
  readonly enrichmentsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#id Workflow#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#muting_rules_handling Workflow#muting_rules_handling}
  */
  readonly mutingRulesHandling: string;
  /**
  * (Required) The name of the workflow.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#name Workflow#name}
  */
  readonly name: string;
  /**
  * destination block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#destination Workflow#destination}
  */
  readonly destination: WorkflowDestination[] | cdktf.IResolvable;
  /**
  * enrichments block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#enrichments Workflow#enrichments}
  */
  readonly enrichments?: WorkflowEnrichments;
  /**
  * issues_filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#issues_filter Workflow#issues_filter}
  */
...
export interface WorkflowDestination {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#channel_id Workflow#channel_id}
  */
  readonly channelId: string;
  /**
  * List of triggers to notify about in this destination configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#notification_triggers Workflow#notification_triggers}
  */
  readonly notificationTriggers?: string[];
  /**
  * Update original notification message (Slack channels only)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#update_original_message Workflow#update_original_message}
  */
...
export interface WorkflowEnrichmentsNrqlConfiguration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#query Workflow#query}
  */
...
export interface WorkflowEnrichmentsNrql {
  ...
  * configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#configuration Workflow#configuration}
  */
...
export interface WorkflowEnrichments {
  ...
  * nrql block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#nrql Workflow#nrql}
  */
...
export interface WorkflowIssuesFilterPredicate {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#attribute Workflow#attribute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#operator Workflow#operator}
  */
  readonly operator: string;
  /**
  * List of predicate values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#values Workflow#values}
  */
...
export interface WorkflowIssuesFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#type Workflow#type}
  */
  readonly type: string;
  /**
  * predicate block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#predicate Workflow#predicate}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow newrelic_workflow}
*/
export class Workflow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Workflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/workflow newrelic_workflow} Resource
  *
  * @param scope The scope in which to define this construct
