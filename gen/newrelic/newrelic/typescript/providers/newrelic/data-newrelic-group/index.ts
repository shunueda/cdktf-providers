// https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/data-sources/group
...
export interface DataNewrelicGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/data-sources/group#authentication_domain_id DataNewrelicGroup#authentication_domain_id}
  */
  readonly authenticationDomainId: string;
  /**
  * The name of the group to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/data-sources/group#name DataNewrelicGroup#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/data-sources/group newrelic_group}
*/
export class DataNewrelicGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/data-sources/group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/data-sources/group newrelic_group} Data Source
  *
  * @param scope The scope in which to define this construct
