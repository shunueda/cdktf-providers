// https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy_channel
...
export interface AlertPolicyChannelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy_channel#account_id AlertPolicyChannel#account_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy_channel#channel_ids AlertPolicyChannel#channel_ids}
  */
  readonly channelIds: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy_channel#id AlertPolicyChannel#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy_channel#policy_id AlertPolicyChannel#policy_id}
  */
  readonly policyId: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy_channel#timeouts AlertPolicyChannel#timeouts}
  */
  readonly timeouts?: AlertPolicyChannelTimeouts;
}
export interface AlertPolicyChannelTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy_channel#create AlertPolicyChannel#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy_channel newrelic_alert_policy_channel}
*/
export class AlertPolicyChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AlertPolicyChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy_channel newrelic_alert_policy_channel} Resource
  *
  * @param scope The scope in which to define this construct
