// https://registry.terraform.io/providers/newrelic/newrelic/3.76.1/docs/data-sources/test_grok_pattern
...
export class DataNewrelicTestGrokPattern extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicTestGrokPattern that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.1/docs/data-sources/test_grok_pattern#import import section} in the documentation of this resource for the id to use
