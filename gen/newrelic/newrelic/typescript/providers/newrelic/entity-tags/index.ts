// https://registry.terraform.io/providers/newrelic/newrelic/3.75.2/docs/resources/entity_tags
...
export class EntityTags extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EntityTags that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.75.2/docs/resources/entity_tags#import import section} in the documentation of this resource for the id to use
