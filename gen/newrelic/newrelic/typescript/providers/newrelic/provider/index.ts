// https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs
...
export interface NewrelicProviderConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#account_id NewrelicProvider#account_id}
  */
  readonly accountId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#admin_api_key NewrelicProvider#admin_api_key}
  */
  readonly adminApiKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#api_key NewrelicProvider#api_key}
  */
  readonly apiKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#api_url NewrelicProvider#api_url}
  */
  readonly apiUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#cacert_file NewrelicProvider#cacert_file}
  */
  readonly cacertFile?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#infrastructure_api_url NewrelicProvider#infrastructure_api_url}
  */
  readonly infrastructureApiUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#insecure_skip_verify NewrelicProvider#insecure_skip_verify}
  */
  readonly insecureSkipVerify?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#insights_insert_key NewrelicProvider#insights_insert_key}
  */
  readonly insightsInsertKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#insights_insert_url NewrelicProvider#insights_insert_url}
  */
  readonly insightsInsertUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#insights_query_url NewrelicProvider#insights_query_url}
  */
  readonly insightsQueryUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#nerdgraph_api_url NewrelicProvider#nerdgraph_api_url}
  */
  readonly nerdgraphApiUrl?: string;
  /**
  * The data center for which your New Relic account is configured. Only one region per provider block is permitted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#region NewrelicProvider#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#synthetics_api_url NewrelicProvider#synthetics_api_url}
  */
  readonly syntheticsApiUrl?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#alias NewrelicProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs newrelic}
*/
export class NewrelicProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing NewrelicProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs newrelic} Resource
  *
  * @param scope The scope in which to define this construct
