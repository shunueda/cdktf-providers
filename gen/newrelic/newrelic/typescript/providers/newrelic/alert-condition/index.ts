// https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition
...
export interface AlertConditionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#condition_scope AlertCondition#condition_scope}
  */
  readonly conditionScope?: string;
  /**
  * Whether the condition is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#enabled AlertCondition#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The instance IDs associated with this condition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#entities AlertCondition#entities}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#gc_metric AlertCondition#gc_metric}
  */
  readonly gcMetric?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#id AlertCondition#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#metric AlertCondition#metric}
  */
  readonly metric: string;
  /**
  * The title of the condition. Must be between 1 and 128 characters, inclusive.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#name AlertCondition#name}
  */
  readonly name: string;
  /**
  * The ID of the policy where this condition should be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#policy_id AlertCondition#policy_id}
  */
  readonly policyId: number;
  /**
  * Runbook URL to display in notifications.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#runbook_url AlertCondition#runbook_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#type AlertCondition#type}
  */
  readonly type: string;
  /**
  * A custom metric to be evaluated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#user_defined_metric AlertCondition#user_defined_metric}
  */
  readonly userDefinedMetric?: string;
  /**
  * One of: (average, min, max, total, sample_size, percent, rate).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#user_defined_value_function AlertCondition#user_defined_value_function}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#violation_close_timer AlertCondition#violation_close_timer}
  */
  readonly violationCloseTimer?: number;
  /**
  * term block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#term AlertCondition#term}
  */
...
export interface AlertConditionTerm {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#duration AlertCondition#duration}
  */
  readonly duration: number;
  /**
  * One of (above, below, equal). Defaults to equal.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#operator AlertCondition#operator}
  */
  readonly operator?: string;
  /**
  * One of (critical, warning). Defaults to critical.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#priority AlertCondition#priority}
  */
  readonly priority?: string;
  /**
  * Must be 0 or greater.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#threshold AlertCondition#threshold}
  */
  readonly threshold: number;
  /**
  * One of (all, any).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#time_function AlertCondition#time_function}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition newrelic_alert_condition}
*/
export class AlertCondition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AlertCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_condition newrelic_alert_condition} Resource
  *
  * @param scope The scope in which to define this construct
