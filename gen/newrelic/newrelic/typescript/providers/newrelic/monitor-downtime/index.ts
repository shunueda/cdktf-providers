// https://registry.terraform.io/providers/newrelic/newrelic/3.75.2/docs/resources/monitor_downtime
...
export class MonitorDowntime extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorDowntime that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.75.2/docs/resources/monitor_downtime#import import section} in the documentation of this resource for the id to use
