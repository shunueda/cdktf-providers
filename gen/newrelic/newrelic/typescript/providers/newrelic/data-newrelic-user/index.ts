// https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/data-sources/user
...
export interface DataNewrelicUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/data-sources/user#authentication_domain_id DataNewrelicUser#authentication_domain_id}
  */
  readonly authenticationDomainId: string;
  /**
  * The email ID of the user to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/data-sources/user#email_id DataNewrelicUser#email_id}
  */
  readonly emailId?: string;
  /**
  * The name of the user to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/data-sources/user#name DataNewrelicUser#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/data-sources/user newrelic_user}
*/
export class DataNewrelicUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/data-sources/user newrelic_user} Data Source
  *
  * @param scope The scope in which to define this construct
