// https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/resources/key_transaction
...
export interface KeyTransactionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/resources/key_transaction#apdex_index KeyTransaction#apdex_index}
  */
  readonly apdexIndex: number;
  /**
  * The GUID of the application.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/resources/key_transaction#application_guid KeyTransaction#application_guid}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/resources/key_transaction#browser_apdex_target KeyTransaction#browser_apdex_target}
  */
  readonly browserApdexTarget: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/resources/key_transaction#id KeyTransaction#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/resources/key_transaction#metric_name KeyTransaction#metric_name}
  */
  readonly metricName: string;
  /**
  * The name of the key transaction.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/resources/key_transaction#name KeyTransaction#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/resources/key_transaction newrelic_key_transaction}
*/
export class KeyTransaction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KeyTransaction that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/resources/key_transaction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.0/docs/resources/key_transaction newrelic_key_transaction} Resource
  *
  * @param scope The scope in which to define this construct
