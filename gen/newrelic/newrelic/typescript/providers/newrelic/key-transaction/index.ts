// https://registry.terraform.io/providers/newrelic/newrelic/3.75.2/docs/resources/key_transaction
...
export class KeyTransaction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KeyTransaction that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.75.2/docs/resources/key_transaction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.75.2/docs/resources/key_transaction newrelic_key_transaction} Resource
  *
  * @param scope The scope in which to define this construct
