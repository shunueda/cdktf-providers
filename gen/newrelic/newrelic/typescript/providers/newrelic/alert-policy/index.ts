// https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy
...
export interface AlertPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy#account_id AlertPolicy#account_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy#channel_ids AlertPolicy#channel_ids}
  */
  readonly channelIds?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy#id AlertPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy#incident_preference AlertPolicy#incident_preference}
  */
  readonly incidentPreference?: string;
  /**
  * The name of the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy#name AlertPolicy#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy newrelic_alert_policy}
*/
export class AlertPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AlertPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.76.4/docs/resources/alert_policy newrelic_alert_policy} Resource
  *
  * @param scope The scope in which to define this construct
