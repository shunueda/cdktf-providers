// https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/maintenance_windows
...
export interface MaintenanceWindowsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/maintenance_windows#ends_at MaintenanceWindows#ends_at}
  */
  readonly endsAt: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/maintenance_windows#id MaintenanceWindows#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/maintenance_windows#name MaintenanceWindows#name}
  */
  readonly name: string;
  /**
  * The date on which the maintenance window should stop repeating.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/maintenance_windows#repeat_ends_at MaintenanceWindows#repeat_ends_at}
  */
  readonly repeatEndsAt?: string;
  /**
  * The repeat interval of the maintenance window from the first occurrence.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/maintenance_windows#repeat_interval MaintenanceWindows#repeat_interval}
  */
  readonly repeatInterval?: number;
  /**
  * The repeat cadence for the maintenance window. Possible values `DAY`, `WEEK` and `MONTH`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/maintenance_windows#repeat_unit MaintenanceWindows#repeat_unit}
  */
  readonly repeatUnit?: string;
  /**
  * The start date of the maintenance window.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/maintenance_windows#starts_at MaintenanceWindows#starts_at}
  */
  readonly startsAt: string;
  /**
  * The names of the checks and groups maintenance window should apply to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/maintenance_windows#tags MaintenanceWindows#tags}
  */
  readonly tags?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/maintenance_windows checkly_maintenance_windows}
*/
export class MaintenanceWindows extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MaintenanceWindows that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/maintenance_windows#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/maintenance_windows checkly_maintenance_windows} Resource
  *
  * @param scope The scope in which to define this construct
