// https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/trigger_check
...
export interface TriggerCheckConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/trigger_check#check_id TriggerCheck#check_id}
  */
  readonly checkId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/trigger_check#id TriggerCheck#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/trigger_check#token TriggerCheck#token}
  */
  readonly token?: string;
  /**
  * The request URL to trigger the check run.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/trigger_check#url TriggerCheck#url}
  */
  readonly url?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/trigger_check checkly_trigger_check}
*/
export class TriggerCheck extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TriggerCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/trigger_check#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkly/checkly/1.16.0/docs/resources/trigger_check checkly_trigger_check} Resource
  *
  * @param scope The scope in which to define this construct
