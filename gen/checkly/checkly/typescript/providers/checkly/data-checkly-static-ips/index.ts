// https://registry.terraform.io/providers/checkly/checkly/1.17.1/docs/data-sources/static_ips
...
export interface DataChecklyStaticIpsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.17.1/docs/data-sources/static_ips#ip_family DataChecklyStaticIps#ip_family}
  */
  readonly ipFamily?: string;
  /**
  * Specify the locations you want to get static IPs for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/checkly/checkly/1.17.1/docs/data-sources/static_ips#locations DataChecklyStaticIps#locations}
  */
  readonly locations?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/checkly/checkly/1.17.1/docs/data-sources/static_ips checkly_static_ips}
*/
export class DataChecklyStaticIps extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataChecklyStaticIps that should be imported. Refer to the {@link https://registry.terraform.io/providers/checkly/checkly/1.17.1/docs/data-sources/static_ips#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/checkly/checkly/1.17.1/docs/data-sources/static_ips checkly_static_ips} Data Source
  *
  * @param scope The scope in which to define this construct
