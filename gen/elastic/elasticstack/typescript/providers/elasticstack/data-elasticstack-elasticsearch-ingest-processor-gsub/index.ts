// https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_gsub
...
export interface DataElasticstackElasticsearchIngestProcessorGsubConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_gsub#description DataElasticstackElasticsearchIngestProcessorGsub#description}
  */
  readonly description?: string;
  /**
  * The field to apply the replacement to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_gsub#field DataElasticstackElasticsearchIngestProcessorGsub#field}
  */
  readonly field: string;
  /**
  * Conditionally execute the processor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_gsub#if DataElasticstackElasticsearchIngestProcessorGsub#if}
  */
  readonly if?: string;
  /**
  * Ignore failures for the processor. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_gsub#ignore_failure DataElasticstackElasticsearchIngestProcessorGsub#ignore_failure}
  */
  readonly ignoreFailure?: boolean | cdktf.IResolvable;
  /**
  * If `true` and `field` does not exist or is `null`, the processor quietly exits without modifying the document.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_gsub#ignore_missing DataElasticstackElasticsearchIngestProcessorGsub#ignore_missing}
  */
  readonly ignoreMissing?: boolean | cdktf.IResolvable;
  /**
  * Handle failures for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_gsub#on_failure DataElasticstackElasticsearchIngestProcessorGsub#on_failure}
  */
  readonly onFailure?: string[];
  /**
  * The pattern to be replaced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_gsub#pattern DataElasticstackElasticsearchIngestProcessorGsub#pattern}
  */
  readonly pattern: string;
  /**
  * The string to replace the matching patterns with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_gsub#replacement DataElasticstackElasticsearchIngestProcessorGsub#replacement}
  */
  readonly replacement: string;
  /**
  * Identifier for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_gsub#tag DataElasticstackElasticsearchIngestProcessorGsub#tag}
  */
  readonly tag?: string;
  /**
  * The field to assign the converted value to, by default `field` is updated in-place.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_gsub#target_field DataElasticstackElasticsearchIngestProcessorGsub#target_field}
  */
  readonly targetField?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_gsub elasticstack_elasticsearch_ingest_processor_gsub}
*/
export class DataElasticstackElasticsearchIngestProcessorGsub extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataElasticstackElasticsearchIngestProcessorGsub that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_gsub#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_gsub elasticstack_elasticsearch_ingest_processor_gsub} Data Source
  *
  * @param scope The scope in which to define this construct
