// https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_script
...
export interface DataElasticstackElasticsearchIngestProcessorScriptConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_script#description DataElasticstackElasticsearchIngestProcessorScript#description}
  */
  readonly description?: string;
  /**
  * Conditionally execute the processor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_script#if DataElasticstackElasticsearchIngestProcessorScript#if}
  */
  readonly if?: string;
  /**
  * Ignore failures for the processor. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_script#ignore_failure DataElasticstackElasticsearchIngestProcessorScript#ignore_failure}
  */
  readonly ignoreFailure?: boolean | cdktf.IResolvable;
  /**
  * Script language.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_script#lang DataElasticstackElasticsearchIngestProcessorScript#lang}
  */
  readonly lang?: string;
  /**
  * Handle failures for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_script#on_failure DataElasticstackElasticsearchIngestProcessorScript#on_failure}
  */
  readonly onFailure?: string[];
  /**
  * Object containing parameters for the script.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_script#params DataElasticstackElasticsearchIngestProcessorScript#params}
  */
  readonly params?: string;
  /**
  * ID of a stored script. If no `source` is specified, this parameter is required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_script#script_id DataElasticstackElasticsearchIngestProcessorScript#script_id}
  */
  readonly scriptId?: string;
  /**
  * Inline script. If no id is specified, this parameter is required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_script#source DataElasticstackElasticsearchIngestProcessorScript#source}
  */
  readonly source?: string;
  /**
  * Identifier for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_script#tag DataElasticstackElasticsearchIngestProcessorScript#tag}
  */
  readonly tag?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_script elasticstack_elasticsearch_ingest_processor_script}
*/
export class DataElasticstackElasticsearchIngestProcessorScript extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataElasticstackElasticsearchIngestProcessorScript that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_script#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_script elasticstack_elasticsearch_ingest_processor_script} Data Source
  *
  * @param scope The scope in which to define this construct
