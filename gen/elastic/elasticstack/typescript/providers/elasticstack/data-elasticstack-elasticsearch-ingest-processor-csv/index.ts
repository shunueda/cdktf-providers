// https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv
...
export interface DataElasticstackElasticsearchIngestProcessorCsvConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv#description DataElasticstackElasticsearchIngestProcessorCsv#description}
  */
  readonly description?: string;
  /**
  * Value used to fill empty fields, empty fields will be skipped if this is not provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv#empty_value DataElasticstackElasticsearchIngestProcessorCsv#empty_value}
  */
  readonly emptyValue?: string;
  /**
  * The field to extract data from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv#field DataElasticstackElasticsearchIngestProcessorCsv#field}
  */
  readonly field: string;
  /**
  * Conditionally execute the processor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv#if DataElasticstackElasticsearchIngestProcessorCsv#if}
  */
  readonly if?: string;
  /**
  * Ignore failures for the processor. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv#ignore_failure DataElasticstackElasticsearchIngestProcessorCsv#ignore_failure}
  */
  readonly ignoreFailure?: boolean | cdktf.IResolvable;
  /**
  * If `true` and `field` does not exist or is `null`, the processor quietly exits without modifying the document.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv#ignore_missing DataElasticstackElasticsearchIngestProcessorCsv#ignore_missing}
  */
  readonly ignoreMissing?: boolean | cdktf.IResolvable;
  /**
  * Handle failures for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv#on_failure DataElasticstackElasticsearchIngestProcessorCsv#on_failure}
  */
  readonly onFailure?: string[];
  /**
  * Quote used in CSV, has to be single character string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv#quote DataElasticstackElasticsearchIngestProcessorCsv#quote}
  */
  readonly quote?: string;
  /**
  * Separator used in CSV, has to be single character string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv#separator DataElasticstackElasticsearchIngestProcessorCsv#separator}
  */
  readonly separator?: string;
  /**
  * Identifier for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv#tag DataElasticstackElasticsearchIngestProcessorCsv#tag}
  */
  readonly tag?: string;
  /**
  * The array of fields to assign extracted values to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv#target_fields DataElasticstackElasticsearchIngestProcessorCsv#target_fields}
  */
  readonly targetFields: string[];
  /**
  * Trim whitespaces in unquoted fields.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv#trim DataElasticstackElasticsearchIngestProcessorCsv#trim}
  */
  readonly trim?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv elasticstack_elasticsearch_ingest_processor_csv}
*/
export class DataElasticstackElasticsearchIngestProcessorCsv extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataElasticstackElasticsearchIngestProcessorCsv that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_csv elasticstack_elasticsearch_ingest_processor_csv} Data Source
  *
  * @param scope The scope in which to define this construct
