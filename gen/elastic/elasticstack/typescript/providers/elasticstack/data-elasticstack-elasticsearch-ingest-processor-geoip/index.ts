// https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_geoip
...
export interface DataElasticstackElasticsearchIngestProcessorGeoipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_geoip#database_file DataElasticstackElasticsearchIngestProcessorGeoip#database_file}
  */
  readonly databaseFile?: string;
  /**
  * The field to get the ip address from for the geographical lookup.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_geoip#field DataElasticstackElasticsearchIngestProcessorGeoip#field}
  */
  readonly field: string;
  /**
  * If `true` only first found geoip data will be returned, even if field contains array.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_geoip#first_only DataElasticstackElasticsearchIngestProcessorGeoip#first_only}
  */
  readonly firstOnly?: boolean | cdktf.IResolvable;
  /**
  * If `true` and `field` does not exist, the processor quietly exits without modifying the document.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_geoip#ignore_missing DataElasticstackElasticsearchIngestProcessorGeoip#ignore_missing}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_geoip#properties DataElasticstackElasticsearchIngestProcessorGeoip#properties}
  */
  readonly properties?: string[];
  /**
  * The field that will hold the geographical information looked up from the MaxMind database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_geoip#target_field DataElasticstackElasticsearchIngestProcessorGeoip#target_field}
  */
  readonly targetField?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_geoip elasticstack_elasticsearch_ingest_processor_geoip}
*/
export class DataElasticstackElasticsearchIngestProcessorGeoip extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataElasticstackElasticsearchIngestProcessorGeoip that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_geoip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_geoip elasticstack_elasticsearch_ingest_processor_geoip} Data Source
  *
  * @param scope The scope in which to define this construct
