// https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_user_agent
...
export interface DataElasticstackElasticsearchIngestProcessorUserAgentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_user_agent#extract_device_type DataElasticstackElasticsearchIngestProcessorUserAgent#extract_device_type}
  */
  readonly extractDeviceType?: boolean | cdktf.IResolvable;
  /**
  * The field containing the user agent string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_user_agent#field DataElasticstackElasticsearchIngestProcessorUserAgent#field}
  */
  readonly field: string;
  /**
  * If `true` and `field` does not exist or is `null`, the processor quietly exits without modifying the document.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_user_agent#ignore_missing DataElasticstackElasticsearchIngestProcessorUserAgent#ignore_missing}
  */
  readonly ignoreMissing?: boolean | cdktf.IResolvable;
  /**
  * Controls what properties are added to `target_field`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_user_agent#properties DataElasticstackElasticsearchIngestProcessorUserAgent#properties}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_user_agent#regex_file DataElasticstackElasticsearchIngestProcessorUserAgent#regex_file}
  */
  readonly regexFile?: string;
  /**
  * The field that will be filled with the user agent details.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_user_agent#target_field DataElasticstackElasticsearchIngestProcessorUserAgent#target_field}
  */
  readonly targetField?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_user_agent elasticstack_elasticsearch_ingest_processor_user_agent}
*/
export class DataElasticstackElasticsearchIngestProcessorUserAgent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataElasticstackElasticsearchIngestProcessorUserAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_user_agent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_user_agent elasticstack_elasticsearch_ingest_processor_user_agent} Data Source
  *
  * @param scope The scope in which to define this construct
