// https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/elasticsearch_watch
...
export interface ElasticsearchWatchConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/elasticsearch_watch#actions ElasticsearchWatch#actions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/elasticsearch_watch#active ElasticsearchWatch#active}
  */
  readonly active?: boolean | cdktf.IResolvable;
  /**
  * The condition that defines if the actions should be run.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/elasticsearch_watch#condition ElasticsearchWatch#condition}
  */
  readonly condition?: string;
  /**
  * The input that defines the input that loads the data for the watch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/elasticsearch_watch#input ElasticsearchWatch#input}
  */
  readonly input?: string;
  /**
  * Metadata json that will be copied into the history entries.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/elasticsearch_watch#metadata ElasticsearchWatch#metadata}
  */
  readonly metadata?: string;
  /**
  * Minimum time in milliseconds between actions being run. Defaults to 5000.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/elasticsearch_watch#throttle_period_in_millis ElasticsearchWatch#throttle_period_in_millis}
  */
  readonly throttlePeriodInMillis?: number;
  /**
  * Processes the watch payload to prepare it for the watch actions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/elasticsearch_watch#transform ElasticsearchWatch#transform}
  */
  readonly transform?: string;
  /**
  * The trigger that defines when the watch should run.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/elasticsearch_watch#trigger ElasticsearchWatch#trigger}
  */
  readonly trigger: string;
  /**
  * Identifier for the watch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/elasticsearch_watch#watch_id ElasticsearchWatch#watch_id}
  */
  readonly watchId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/elasticsearch_watch elasticstack_elasticsearch_watch}
*/
export class ElasticsearchWatch extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticsearchWatch that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/elasticsearch_watch#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/elasticsearch_watch elasticstack_elasticsearch_watch} Resource
  *
  * @param scope The scope in which to define this construct
