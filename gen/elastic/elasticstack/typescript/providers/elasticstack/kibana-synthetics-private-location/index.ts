// https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_synthetics_private_location
...
export interface KibanaSyntheticsPrivateLocationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_synthetics_private_location#agent_policy_id KibanaSyntheticsPrivateLocation#agent_policy_id}
  */
  readonly agentPolicyId: string;
  /**
  * Geographic coordinates (WGS84) for the location
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_synthetics_private_location#geo KibanaSyntheticsPrivateLocation#geo}
  */
  readonly geo?: KibanaSyntheticsPrivateLocationGeo;
  /**
  * A label for the private location, used as unique identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_synthetics_private_location#label KibanaSyntheticsPrivateLocation#label}
  */
  readonly label: string;
  /**
  * An array of tags to categorize the private location.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_synthetics_private_location#tags KibanaSyntheticsPrivateLocation#tags}
  */
...
export interface KibanaSyntheticsPrivateLocationGeo {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_synthetics_private_location#lat KibanaSyntheticsPrivateLocation#lat}
  */
  readonly lat: number;
  /**
  * The longitude of the location.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_synthetics_private_location#lon KibanaSyntheticsPrivateLocation#lon}
  */
  readonly lon: number;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_synthetics_private_location elasticstack_kibana_synthetics_private_location}
*/
export class KibanaSyntheticsPrivateLocation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KibanaSyntheticsPrivateLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_synthetics_private_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_synthetics_private_location elasticstack_kibana_synthetics_private_location} Resource
  *
  * @param scope The scope in which to define this construct
