// https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_fingerprint
...
export interface DataElasticstackElasticsearchIngestProcessorFingerprintConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_fingerprint#description DataElasticstackElasticsearchIngestProcessorFingerprint#description}
  */
  readonly description?: string;
  /**
  * Array of fields to include in the fingerprint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_fingerprint#fields DataElasticstackElasticsearchIngestProcessorFingerprint#fields}
  */
  readonly fields: string[];
  /**
  * Conditionally execute the processor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_fingerprint#if DataElasticstackElasticsearchIngestProcessorFingerprint#if}
  */
  readonly if?: string;
  /**
  * Ignore failures for the processor. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_fingerprint#ignore_failure DataElasticstackElasticsearchIngestProcessorFingerprint#ignore_failure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_fingerprint#ignore_missing DataElasticstackElasticsearchIngestProcessorFingerprint#ignore_missing}
  */
  readonly ignoreMissing?: boolean | cdktf.IResolvable;
  /**
  * The hash method used to compute the fingerprint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_fingerprint#method DataElasticstackElasticsearchIngestProcessorFingerprint#method}
  */
  readonly method?: string;
  /**
  * Handle failures for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_fingerprint#on_failure DataElasticstackElasticsearchIngestProcessorFingerprint#on_failure}
  */
  readonly onFailure?: string[];
  /**
  * Salt value for the hash function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_fingerprint#salt DataElasticstackElasticsearchIngestProcessorFingerprint#salt}
  */
  readonly salt?: string;
  /**
  * Identifier for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_fingerprint#tag DataElasticstackElasticsearchIngestProcessorFingerprint#tag}
  */
  readonly tag?: string;
  /**
  * Output field for the fingerprint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_fingerprint#target_field DataElasticstackElasticsearchIngestProcessorFingerprint#target_field}
  */
  readonly targetField?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_fingerprint elasticstack_elasticsearch_ingest_processor_fingerprint}
*/
export class DataElasticstackElasticsearchIngestProcessorFingerprint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataElasticstackElasticsearchIngestProcessorFingerprint that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_fingerprint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_fingerprint elasticstack_elasticsearch_ingest_processor_fingerprint} Data Source
  *
  * @param scope The scope in which to define this construct
