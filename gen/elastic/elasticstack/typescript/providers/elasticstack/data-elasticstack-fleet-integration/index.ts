// https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/fleet_integration
...
export interface DataElasticstackFleetIntegrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/fleet_integration#name DataElasticstackFleetIntegration#name}
  */
  readonly name: string;
  /**
  * Include prerelease packages.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/fleet_integration#prerelease DataElasticstackFleetIntegration#prerelease}
  */
  readonly prerelease?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/fleet_integration elasticstack_fleet_integration}
*/
export class DataElasticstackFleetIntegration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataElasticstackFleetIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/fleet_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/fleet_integration elasticstack_fleet_integration} Data Source
  *
  * @param scope The scope in which to define this construct
