// https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name
...
export interface DataElasticstackElasticsearchIngestProcessorDateIndexNameConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name#date_formats DataElasticstackElasticsearchIngestProcessorDateIndexName#date_formats}
  */
  readonly dateFormats?: string[];
  /**
  * How to round the date when formatting the date into the index name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name#date_rounding DataElasticstackElasticsearchIngestProcessorDateIndexName#date_rounding}
  */
  readonly dateRounding: string;
  /**
  * Description of the processor. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name#description DataElasticstackElasticsearchIngestProcessorDateIndexName#description}
  */
  readonly description?: string;
  /**
  * The field to get the date or timestamp from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name#field DataElasticstackElasticsearchIngestProcessorDateIndexName#field}
  */
  readonly field: string;
  /**
  * Conditionally execute the processor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name#if DataElasticstackElasticsearchIngestProcessorDateIndexName#if}
  */
  readonly if?: string;
  /**
  * Ignore failures for the processor. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name#ignore_failure DataElasticstackElasticsearchIngestProcessorDateIndexName#ignore_failure}
  */
  readonly ignoreFailure?: boolean | cdktf.IResolvable;
  /**
  * The format to be used when printing the parsed date into the index name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name#index_name_format DataElasticstackElasticsearchIngestProcessorDateIndexName#index_name_format}
  */
  readonly indexNameFormat?: string;
  /**
  * A prefix of the index name to be prepended before the printed date.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name#index_name_prefix DataElasticstackElasticsearchIngestProcessorDateIndexName#index_name_prefix}
  */
  readonly indexNamePrefix?: string;
  /**
  * The locale to use when parsing the date from the document being preprocessed, relevant when parsing month names or week days.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name#locale DataElasticstackElasticsearchIngestProcessorDateIndexName#locale}
  */
  readonly locale?: string;
  /**
  * Handle failures for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name#on_failure DataElasticstackElasticsearchIngestProcessorDateIndexName#on_failure}
  */
  readonly onFailure?: string[];
  /**
  * Identifier for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name#tag DataElasticstackElasticsearchIngestProcessorDateIndexName#tag}
  */
  readonly tag?: string;
  /**
  * The timezone to use when parsing the date and when date math index supports resolves expressions into concrete index names.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name#timezone DataElasticstackElasticsearchIngestProcessorDateIndexName#timezone}
  */
  readonly timezone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name elasticstack_elasticsearch_ingest_processor_date_index_name}
*/
export class DataElasticstackElasticsearchIngestProcessorDateIndexName extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataElasticstackElasticsearchIngestProcessorDateIndexName that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_date_index_name elasticstack_elasticsearch_ingest_processor_date_index_name} Data Source
  *
  * @param scope The scope in which to define this construct
