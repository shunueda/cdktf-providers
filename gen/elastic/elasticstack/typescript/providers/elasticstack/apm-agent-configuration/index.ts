// https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/resources/apm_agent_configuration
...
export interface ApmAgentConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/resources/apm_agent_configuration#agent_name ApmAgentConfiguration#agent_name}
  */
  readonly agentName?: string;
  /**
  * The environment of the service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/resources/apm_agent_configuration#service_environment ApmAgentConfiguration#service_environment}
  */
  readonly serviceEnvironment?: string;
  /**
  * The name of the service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/resources/apm_agent_configuration#service_name ApmAgentConfiguration#service_name}
  */
  readonly serviceName: string;
  /**
  * Agent configuration settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/resources/apm_agent_configuration#settings ApmAgentConfiguration#settings}
  */
  readonly settings: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/resources/apm_agent_configuration elasticstack_apm_agent_configuration}
*/
export class ApmAgentConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApmAgentConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/resources/apm_agent_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/resources/apm_agent_configuration elasticstack_apm_agent_configuration} Resource
  *
  * @param scope The scope in which to define this construct
