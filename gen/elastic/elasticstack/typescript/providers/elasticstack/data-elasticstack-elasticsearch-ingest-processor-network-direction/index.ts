// https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction
...
export interface DataElasticstackElasticsearchIngestProcessorNetworkDirectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction#description DataElasticstackElasticsearchIngestProcessorNetworkDirection#description}
  */
  readonly description?: string;
  /**
  * Field containing the destination IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction#destination_ip DataElasticstackElasticsearchIngestProcessorNetworkDirection#destination_ip}
  */
  readonly destinationIp?: string;
  /**
  * Conditionally execute the processor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction#if DataElasticstackElasticsearchIngestProcessorNetworkDirection#if}
  */
  readonly if?: string;
  /**
  * Ignore failures for the processor. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction#ignore_failure DataElasticstackElasticsearchIngestProcessorNetworkDirection#ignore_failure}
  */
  readonly ignoreFailure?: boolean | cdktf.IResolvable;
  /**
  * If `true` and `field` does not exist or is `null`, the processor quietly exits without modifying the document.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction#ignore_missing DataElasticstackElasticsearchIngestProcessorNetworkDirection#ignore_missing}
  */
  readonly ignoreMissing?: boolean | cdktf.IResolvable;
  /**
  * List of internal networks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction#internal_networks DataElasticstackElasticsearchIngestProcessorNetworkDirection#internal_networks}
  */
  readonly internalNetworks?: string[];
  /**
  * A field on the given document to read the internal_networks configuration from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction#internal_networks_field DataElasticstackElasticsearchIngestProcessorNetworkDirection#internal_networks_field}
  */
  readonly internalNetworksField?: string;
  /**
  * Handle failures for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction#on_failure DataElasticstackElasticsearchIngestProcessorNetworkDirection#on_failure}
  */
  readonly onFailure?: string[];
  /**
  * Field containing the source IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction#source_ip DataElasticstackElasticsearchIngestProcessorNetworkDirection#source_ip}
  */
  readonly sourceIp?: string;
  /**
  * Identifier for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction#tag DataElasticstackElasticsearchIngestProcessorNetworkDirection#tag}
  */
  readonly tag?: string;
  /**
  * Output field for the network direction.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction#target_field DataElasticstackElasticsearchIngestProcessorNetworkDirection#target_field}
  */
  readonly targetField?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction elasticstack_elasticsearch_ingest_processor_network_direction}
*/
export class DataElasticstackElasticsearchIngestProcessorNetworkDirection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataElasticstackElasticsearchIngestProcessorNetworkDirection that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/elasticsearch_ingest_processor_network_direction elasticstack_elasticsearch_ingest_processor_network_direction} Data Source
  *
  * @param scope The scope in which to define this construct
