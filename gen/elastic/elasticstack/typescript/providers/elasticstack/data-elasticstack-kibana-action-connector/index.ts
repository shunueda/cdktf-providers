// https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/kibana_action_connector
...
export interface DataElasticstackKibanaActionConnectorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/kibana_action_connector#connector_type_id DataElasticstackKibanaActionConnector#connector_type_id}
  */
  readonly connectorTypeId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/kibana_action_connector#id DataElasticstackKibanaActionConnector#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/kibana_action_connector#name DataElasticstackKibanaActionConnector#name}
  */
  readonly name: string;
  /**
  * An identifier for the space. If space_id is not provided, the default space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/kibana_action_connector#space_id DataElasticstackKibanaActionConnector#space_id}
  */
  readonly spaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/kibana_action_connector elasticstack_kibana_action_connector}
*/
export class DataElasticstackKibanaActionConnector extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataElasticstackKibanaActionConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/kibana_action_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.0/docs/data-sources/kibana_action_connector elasticstack_kibana_action_connector} Data Source
  *
  * @param scope The scope in which to define this construct
