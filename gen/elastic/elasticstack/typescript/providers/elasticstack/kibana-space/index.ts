// https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_space
...
export interface KibanaSpaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_space#color KibanaSpace#color}
  */
  readonly color?: string;
  /**
  * The description for the space.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_space#description KibanaSpace#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_space#disabled_features KibanaSpace#disabled_features}
  */
  readonly disabledFeatures?: string[];
  /**
  * The data-URL encoded image to display in the space avatar.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_space#image_url KibanaSpace#image_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_space#initials KibanaSpace#initials}
  */
  readonly initials?: string;
  /**
  * The display name for the space.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_space#name KibanaSpace#name}
  */
  readonly name: string;
  /**
  * The solution view for the space. Valid options are `security`, `oblt`, `es`, or `classic`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_space#solution KibanaSpace#solution}
  */
  readonly solution?: string;
  /**
  * The space ID that is part of the Kibana URL when inside the space.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_space#space_id KibanaSpace#space_id}
  */
  readonly spaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_space elasticstack_kibana_space}
*/
export class KibanaSpace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KibanaSpace that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_space#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/resources/kibana_space elasticstack_kibana_space} Resource
  *
  * @param scope The scope in which to define this construct
