// https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date
...
export interface DataElasticstackElasticsearchIngestProcessorDateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date#description DataElasticstackElasticsearchIngestProcessorDate#description}
  */
  readonly description?: string;
  /**
  * The field to get the date from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date#field DataElasticstackElasticsearchIngestProcessorDate#field}
  */
  readonly field: string;
  /**
  * An array of the expected date formats.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date#formats DataElasticstackElasticsearchIngestProcessorDate#formats}
  */
  readonly formats: string[];
  /**
  * Conditionally execute the processor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date#if DataElasticstackElasticsearchIngestProcessorDate#if}
  */
  readonly if?: string;
  /**
  * Ignore failures for the processor. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date#ignore_failure DataElasticstackElasticsearchIngestProcessorDate#ignore_failure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date#locale DataElasticstackElasticsearchIngestProcessorDate#locale}
  */
  readonly locale?: string;
  /**
  * Handle failures for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date#on_failure DataElasticstackElasticsearchIngestProcessorDate#on_failure}
  */
  readonly onFailure?: string[];
  /**
  * The format to use when writing the date to `target_field`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date#output_format DataElasticstackElasticsearchIngestProcessorDate#output_format}
  */
  readonly outputFormat?: string;
  /**
  * Identifier for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date#tag DataElasticstackElasticsearchIngestProcessorDate#tag}
  */
  readonly tag?: string;
  /**
  * The field that will hold the parsed date.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date#target_field DataElasticstackElasticsearchIngestProcessorDate#target_field}
  */
  readonly targetField?: string;
  /**
  * The timezone to use when parsing the date.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date#timezone DataElasticstackElasticsearchIngestProcessorDate#timezone}
  */
  readonly timezone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date elasticstack_elasticsearch_ingest_processor_date}
*/
export class DataElasticstackElasticsearchIngestProcessorDate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataElasticstackElasticsearchIngestProcessorDate that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.2/docs/data-sources/elasticsearch_ingest_processor_date elasticstack_elasticsearch_ingest_processor_date} Data Source
  *
  * @param scope The scope in which to define this construct
