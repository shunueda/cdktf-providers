// https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_uri_parts
...
export interface DataElasticstackElasticsearchIngestProcessorUriPartsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_uri_parts#description DataElasticstackElasticsearchIngestProcessorUriParts#description}
  */
  readonly description?: string;
  /**
  * Field containing the URI string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_uri_parts#field DataElasticstackElasticsearchIngestProcessorUriParts#field}
  */
  readonly field: string;
  /**
  * Conditionally execute the processor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_uri_parts#if DataElasticstackElasticsearchIngestProcessorUriParts#if}
  */
  readonly if?: string;
  /**
  * Ignore failures for the processor. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_uri_parts#ignore_failure DataElasticstackElasticsearchIngestProcessorUriParts#ignore_failure}
  */
  readonly ignoreFailure?: boolean | cdktf.IResolvable;
  /**
  * If true, the processor copies the unparsed URI to `<target_field>.original.`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_uri_parts#keep_original DataElasticstackElasticsearchIngestProcessorUriParts#keep_original}
  */
  readonly keepOriginal?: boolean | cdktf.IResolvable;
  /**
  * Handle failures for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_uri_parts#on_failure DataElasticstackElasticsearchIngestProcessorUriParts#on_failure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_uri_parts#remove_if_successful DataElasticstackElasticsearchIngestProcessorUriParts#remove_if_successful}
  */
  readonly removeIfSuccessful?: boolean | cdktf.IResolvable;
  /**
  * Identifier for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_uri_parts#tag DataElasticstackElasticsearchIngestProcessorUriParts#tag}
  */
  readonly tag?: string;
  /**
  * Output field for the URI object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_uri_parts#target_field DataElasticstackElasticsearchIngestProcessorUriParts#target_field}
  */
  readonly targetField?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_uri_parts elasticstack_elasticsearch_ingest_processor_uri_parts}
*/
export class DataElasticstackElasticsearchIngestProcessorUriParts extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataElasticstackElasticsearchIngestProcessorUriParts that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_uri_parts#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.13.1/docs/data-sources/elasticsearch_ingest_processor_uri_parts elasticstack_elasticsearch_ingest_processor_uri_parts} Data Source
  *
  * @param scope The scope in which to define this construct
