// https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set
...
export interface DataElasticstackElasticsearchIngestProcessorSetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set#copy_from DataElasticstackElasticsearchIngestProcessorSet#copy_from}
  */
  readonly copyFrom?: string;
  /**
  * Description of the processor. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set#description DataElasticstackElasticsearchIngestProcessorSet#description}
  */
  readonly description?: string;
  /**
  * The field to insert, upsert, or update.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set#field DataElasticstackElasticsearchIngestProcessorSet#field}
  */
  readonly field: string;
  /**
  * Conditionally execute the processor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set#if DataElasticstackElasticsearchIngestProcessorSet#if}
  */
  readonly if?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set#ignore_empty_value DataElasticstackElasticsearchIngestProcessorSet#ignore_empty_value}
  */
  readonly ignoreEmptyValue?: boolean | cdktf.IResolvable;
  /**
  * Ignore failures for the processor. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set#ignore_failure DataElasticstackElasticsearchIngestProcessorSet#ignore_failure}
  */
  readonly ignoreFailure?: boolean | cdktf.IResolvable;
  /**
  * The media type for encoding value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set#media_type DataElasticstackElasticsearchIngestProcessorSet#media_type}
  */
  readonly mediaType?: string;
  /**
  * Handle failures for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set#on_failure DataElasticstackElasticsearchIngestProcessorSet#on_failure}
  */
  readonly onFailure?: string[];
  /**
  * If processor will update fields with pre-existing non-null-valued field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set#override DataElasticstackElasticsearchIngestProcessorSet#override}
  */
  readonly override?: boolean | cdktf.IResolvable;
  /**
  * Identifier for the processor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set#tag DataElasticstackElasticsearchIngestProcessorSet#tag}
  */
  readonly tag?: string;
  /**
  * The value to be set for the field. Supports template snippets. May specify only one of `value` or `copy_from`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set#value DataElasticstackElasticsearchIngestProcessorSet#value}
  */
  readonly value?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set elasticstack_elasticsearch_ingest_processor_set}
*/
export class DataElasticstackElasticsearchIngestProcessorSet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataElasticstackElasticsearchIngestProcessorSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/elasticstack/0.12.1/docs/data-sources/elasticsearch_ingest_processor_set elasticstack_elasticsearch_ingest_processor_set} Data Source
  *
  * @param scope The scope in which to define this construct
