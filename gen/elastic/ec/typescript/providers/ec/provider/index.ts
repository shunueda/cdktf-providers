// https://registry.terraform.io/providers/elastic/ec/0.12.4/docs
...
export interface EcProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs#apikey EcProvider#apikey}
  */
  readonly apikey?: string;
  /**
  * Endpoint where the terraform provider will point to. Defaults to "https://api.elastic-cloud.com".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs#endpoint EcProvider#endpoint}
  */
  readonly endpoint?: string;
  /**
  * Allow the provider to skip TLS validation on its outgoing HTTP calls.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs#insecure EcProvider#insecure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs#password EcProvider#password}
  */
  readonly password?: string;
  /**
  * Timeout used for individual HTTP calls. Defaults to "1m".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs#timeout EcProvider#timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs#username EcProvider#username}
  */
  readonly username?: string;
  /**
  * When set, a "request.log" file will be written with all outgoing HTTP requests. Defaults to "false".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs#verbose EcProvider#verbose}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs#verbose_credentials EcProvider#verbose_credentials}
  */
  readonly verboseCredentials?: boolean | cdktf.IResolvable;
  /**
  * Timeout used for individual HTTP calls. Defaults to "1m".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs#verbose_file EcProvider#verbose_file}
  */
  readonly verboseFile?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs#alias EcProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs ec}
*/
export class EcProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing EcProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs ec} Resource
  *
  * @param scope The scope in which to define this construct
