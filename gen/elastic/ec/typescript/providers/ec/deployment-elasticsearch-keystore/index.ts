// https://registry.terraform.io/providers/elastic/ec/0.12.4/docs/resources/deployment_elasticsearch_keystore
...
export interface DeploymentElasticsearchKeystoreConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs/resources/deployment_elasticsearch_keystore#as_file DeploymentElasticsearchKeystore#as_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs/resources/deployment_elasticsearch_keystore#deployment_id DeploymentElasticsearchKeystore#deployment_id}
  */
  readonly deploymentId: string;
  /**
  * Name for the keystore setting, if the setting already exists in the Elasticsearch cluster, it will be overridden.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs/resources/deployment_elasticsearch_keystore#setting_name DeploymentElasticsearchKeystore#setting_name}
  */
  readonly settingName: string;
  /**
  * Value of this setting. This can either be a string or a JSON object that is stored as a JSON string in the keystore.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs/resources/deployment_elasticsearch_keystore#value DeploymentElasticsearchKeystore#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs/resources/deployment_elasticsearch_keystore ec_deployment_elasticsearch_keystore}
*/
export class DeploymentElasticsearchKeystore extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeploymentElasticsearchKeystore that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs/resources/deployment_elasticsearch_keystore#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs/resources/deployment_elasticsearch_keystore ec_deployment_elasticsearch_keystore} Resource
  *
  * @param scope The scope in which to define this construct
