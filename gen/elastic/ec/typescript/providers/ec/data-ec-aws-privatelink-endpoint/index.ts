// https://registry.terraform.io/providers/elastic/ec/0.12.4/docs/data-sources/aws_privatelink_endpoint
...
export interface DataEcAwsPrivatelinkEndpointConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs/data-sources/aws_privatelink_endpoint#region DataEcAwsPrivatelinkEndpoint#region}
  */
  readonly region: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs/data-sources/aws_privatelink_endpoint ec_aws_privatelink_endpoint}
*/
export class DataEcAwsPrivatelinkEndpoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEcAwsPrivatelinkEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs/data-sources/aws_privatelink_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/ec/0.12.4/docs/data-sources/aws_privatelink_endpoint ec_aws_privatelink_endpoint} Data Source
  *
  * @param scope The scope in which to define this construct
