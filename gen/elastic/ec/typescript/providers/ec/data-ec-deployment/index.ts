// https://registry.terraform.io/providers/elastic/ec/0.12.3/docs/data-sources/deployment
...
export interface DataEcDeploymentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/elastic/ec/0.12.3/docs/data-sources/deployment#id DataEcDeployment#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/elastic/ec/0.12.3/docs/data-sources/deployment ec_deployment}
*/
export class DataEcDeployment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEcDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/elastic/ec/0.12.3/docs/data-sources/deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/elastic/ec/0.12.3/docs/data-sources/deployment ec_deployment} Data Source
  *
  * @param scope The scope in which to define this construct
