// https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/oci_credentials
...
export interface OciCredentialsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/oci_credentials#fingerprint OciCredentials#fingerprint}
  */
  readonly fingerprint: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/oci_credentials#id OciCredentials#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/oci_credentials#name OciCredentials#name}
  */
  readonly name: string;
  /**
  * OCI API private key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/oci_credentials#private_key OciCredentials#private_key}
  */
  readonly privateKey: string;
  /**
  * the env0 project id to associate the credentials with
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/oci_credentials#project_id OciCredentials#project_id}
  */
  readonly projectId?: string;
  /**
  * OCI region
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/oci_credentials#region OciCredentials#region}
  */
  readonly region: string;
  /**
  * OCI tenancy OCID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/oci_credentials#tenancy_ocid OciCredentials#tenancy_ocid}
  */
  readonly tenancyOcid: string;
  /**
  * OCI user OCID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/oci_credentials#user_ocid OciCredentials#user_ocid}
  */
  readonly userOcid: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/oci_credentials env0_oci_credentials}
*/
export class OciCredentials extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OciCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/oci_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/oci_credentials env0_oci_credentials} Resource
  *
  * @param scope The scope in which to define this construct
