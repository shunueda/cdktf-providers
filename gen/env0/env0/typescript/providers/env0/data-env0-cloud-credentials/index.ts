// https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/cloud_credentials
...
export interface DataEnv0CloudCredentialsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/cloud_credentials#credential_type DataEnv0CloudCredentials#credential_type}
  */
  readonly credentialType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/cloud_credentials#id DataEnv0CloudCredentials#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/cloud_credentials env0_cloud_credentials}
*/
export class DataEnv0CloudCredentials extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0CloudCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/cloud_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/cloud_credentials env0_cloud_credentials} Data Source
  *
  * @param scope The scope in which to define this construct
