// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_cloud_configuration
...
export interface GcpCloudConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_cloud_configuration#credential_configuration_file_content GcpCloudConfiguration#credential_configuration_file_content}
  */
  readonly credentialConfigurationFileContent: string;
  /**
  * the GCP project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_cloud_configuration#gcp_project_id GcpCloudConfiguration#gcp_project_id}
  */
  readonly gcpProjectId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_cloud_configuration#id GcpCloudConfiguration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_cloud_configuration#name GcpCloudConfiguration#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_cloud_configuration env0_gcp_cloud_configuration}
*/
export class GcpCloudConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GcpCloudConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_cloud_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_cloud_configuration env0_gcp_cloud_configuration} Resource
  *
  * @param scope The scope in which to define this construct
