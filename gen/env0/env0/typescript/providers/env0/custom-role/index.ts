// https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/custom_role
...
export interface CustomRoleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/custom_role#id CustomRole#id}
  *
  ...
  * Defaults to 'false'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/custom_role#is_default_role CustomRole#is_default_role}
  */
  readonly isDefaultRole?: boolean | cdktf.IResolvable;
  /**
  * The name of the custom role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/custom_role#name CustomRole#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/custom_role#permissions CustomRole#permissions}
  */
  readonly permissions: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/custom_role env0_custom_role}
*/
export class CustomRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/custom_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/custom_role env0_custom_role} Resource
  *
  * @param scope The scope in which to define this construct
