// https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/notification_project_assignment
...
export interface NotificationProjectAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/notification_project_assignment#event_names NotificationProjectAssignment#event_names}
  */
  readonly eventNames: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/notification_project_assignment#id NotificationProjectAssignment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/notification_project_assignment#notification_endpoint_id NotificationProjectAssignment#notification_endpoint_id}
  */
  readonly notificationEndpointId: string;
  /**
  * id of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/notification_project_assignment#project_id NotificationProjectAssignment#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/notification_project_assignment env0_notification_project_assignment}
*/
export class NotificationProjectAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NotificationProjectAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/notification_project_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/notification_project_assignment env0_notification_project_assignment} Resource
  *
  * @param scope The scope in which to define this construct
