// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/environment_output_configuration_variable
...
export interface EnvironmentOutputConfigurationVariableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/environment_output_configuration_variable#description EnvironmentOutputConfigurationVariable#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/environment_output_configuration_variable#id EnvironmentOutputConfigurationVariable#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/environment_output_configuration_variable#is_read_only EnvironmentOutputConfigurationVariable#is_read_only}
  */
  readonly isReadOnly?: boolean | cdktf.IResolvable;
  /**
  * set to 'true' if the value of this variable is required in lower scopes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/environment_output_configuration_variable#is_required EnvironmentOutputConfigurationVariable#is_required}
  */
  readonly isRequired?: boolean | cdktf.IResolvable;
  /**
  * the name of the variable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/environment_output_configuration_variable#name EnvironmentOutputConfigurationVariable#name}
  */
  readonly name: string;
  /**
  * the environment id of the output
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/environment_output_configuration_variable#output_environment_id EnvironmentOutputConfigurationVariable#output_environment_id}
  */
  readonly outputEnvironmentId: string;
  /**
  * the name of the output value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/environment_output_configuration_variable#output_name EnvironmentOutputConfigurationVariable#output_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/environment_output_configuration_variable#scope EnvironmentOutputConfigurationVariable#scope}
  */
  readonly scope?: string;
  /**
  * the id of the of the resource to assign to (E.g. the environment id)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/environment_output_configuration_variable#scope_id EnvironmentOutputConfigurationVariable#scope_id}
  */
  readonly scopeId: string;
  /**
  * defaults to 'environment'. Set to 'terraform' to create a terraform output variable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/environment_output_configuration_variable#type EnvironmentOutputConfigurationVariable#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/environment_output_configuration_variable env0_environment_output_configuration_variable}
*/
export class EnvironmentOutputConfigurationVariable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnvironmentOutputConfigurationVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/environment_output_configuration_variable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/environment_output_configuration_variable env0_environment_output_configuration_variable} Resource
  *
  * @param scope The scope in which to define this construct
