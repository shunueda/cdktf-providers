// https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/user
...
export interface DataEnv0UserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/user#email DataEnv0User#email}
  */
  readonly email: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/user env0_user}
*/
export class DataEnv0User extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0User that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/user env0_user} Data Source
  *
  * @param scope The scope in which to define this construct
