// https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable
...
export interface ConfigurationVariableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#description ConfigurationVariable#description}
  */
  readonly description?: string;
  /**
  * limit possible values to values from this list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#enum ConfigurationVariable#enum}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#environment_id ConfigurationVariable#environment_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#format ConfigurationVariable#format}
  */
  readonly format?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#id ConfigurationVariable#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#is_read_only ConfigurationVariable#is_read_only}
  */
  readonly isReadOnly?: boolean | cdktf.IResolvable;
  /**
  * the value of this variable must be set by lower scopes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#is_required ConfigurationVariable#is_required}
  */
  readonly isRequired?: boolean | cdktf.IResolvable;
  /**
  * is the variable sensitive, defaults to false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#is_sensitive ConfigurationVariable#is_sensitive}
  */
  readonly isSensitive?: boolean | cdktf.IResolvable;
  /**
  * name to give the configuration variable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#name ConfigurationVariable#name}
  */
  readonly name: string;
  /**
  * create the variable under this project, not globally
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#project_id ConfigurationVariable#project_id}
  */
  readonly projectId?: string;
  /**
  * the value of this variable must match provided regular expression (enforced only in env0 UI)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#regex ConfigurationVariable#regex}
  */
  readonly regex?: string;
  /**
  * soft delete the configuration variable, once removed from the configuration it won't be deleted from env0
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#soft_delete ConfigurationVariable#soft_delete}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#sub_environment_alias ConfigurationVariable#sub_environment_alias}
  */
  readonly subEnvironmentAlias?: string;
  /**
  * create the variable under this template, not globally
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#template_id ConfigurationVariable#template_id}
  */
  readonly templateId?: string;
  /**
  * default 'environment'. set to 'terraform' to create a terraform variable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#type ConfigurationVariable#type}
  */
  readonly type?: string;
  /**
  * value for the configuration variable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#value ConfigurationVariable#value}
  */
  readonly value?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable env0_configuration_variable}
*/
export class ConfigurationVariable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigurationVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/configuration_variable env0_configuration_variable} Resource
  *
  * @param scope The scope in which to define this construct
