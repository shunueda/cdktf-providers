// https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/api_key
...
export interface ApiKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/api_key#id ApiKey#id}
  *
  ...
  * the api key name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/api_key#name ApiKey#name}
  */
  readonly name: string;
  /**
  * if set to 'true' will omit the api_key_secret from the state. This would mean that the api_key_secret cannot be used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/api_key#omit_api_key_secret ApiKey#omit_api_key_secret}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/api_key#organization_role ApiKey#organization_role}
  */
  readonly organizationRole?: string;
  /**
  * project_permissions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/api_key#project_permissions ApiKey#project_permissions}
  */
...
export interface ApiKeyProjectPermissions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/api_key#project_id ApiKey#project_id}
  */
  readonly projectId: string;
  /**
  * The role for this project. Must be one of: Planner, Viewer, Deployer, Admin
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/api_key#project_role ApiKey#project_role}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/api_key env0_api_key}
*/
export class ApiKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/api_key env0_api_key} Resource
  *
  * @param scope The scope in which to define this construct
