// https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/github_installation_id
...
export interface DataEnv0GithubInstallationIdConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/github_installation_id#id DataEnv0GithubInstallationId#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/github_installation_id#repository DataEnv0GithubInstallationId#repository}
  */
  readonly repository: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/github_installation_id env0_github_installation_id}
*/
export class DataEnv0GithubInstallationId extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0GithubInstallationId that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/github_installation_id#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/github_installation_id env0_github_installation_id} Data Source
  *
  * @param scope The scope in which to define this construct
