// https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/workflow_triggers
...
export interface DataEnv0WorkflowTriggersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/workflow_triggers#environment_id DataEnv0WorkflowTriggers#environment_id}
  */
  readonly environmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/workflow_triggers#id DataEnv0WorkflowTriggers#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/workflow_triggers env0_workflow_triggers}
*/
export class DataEnv0WorkflowTriggers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0WorkflowTriggers that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/workflow_triggers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/workflow_triggers env0_workflow_triggers} Data Source
  *
  * @param scope The scope in which to define this construct
