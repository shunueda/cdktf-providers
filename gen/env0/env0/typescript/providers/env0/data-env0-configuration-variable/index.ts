// https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable
...
export interface DataEnv0ConfigurationVariableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable#deployment_log_id DataEnv0ConfigurationVariable#deployment_log_id}
  */
  readonly deploymentLogId?: string;
  /**
  * a description of the variable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable#description DataEnv0ConfigurationVariable#description}
  */
  readonly description?: string;
  /**
  * search for the variable under this environment, not globally
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable#environment_id DataEnv0ConfigurationVariable#environment_id}
  */
  readonly environmentId?: string;
  /**
  * id of the configuration variable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable#id DataEnv0ConfigurationVariable#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable#is_read_only DataEnv0ConfigurationVariable#is_read_only}
  */
  readonly isReadOnly?: boolean | cdktf.IResolvable;
  /**
  * specifies if the value of this variable must be set by lower scopes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable#is_required DataEnv0ConfigurationVariable#is_required}
  */
  readonly isRequired?: boolean | cdktf.IResolvable;
  /**
  * the name of the configuration variable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable#name DataEnv0ConfigurationVariable#name}
  */
  readonly name?: string;
  /**
  * search for the variable under this project, not globally
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable#project_id DataEnv0ConfigurationVariable#project_id}
  */
  readonly projectId?: string;
  /**
  * specifies a regular expression to validate variable value (enforced only in env0 UI)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable#regex DataEnv0ConfigurationVariable#regex}
  */
  readonly regex?: string;
  /**
  * search for the variable for sub templates of a workflow. Requires template_id as well
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable#sub_environment_alias DataEnv0ConfigurationVariable#sub_environment_alias}
  */
  readonly subEnvironmentAlias?: string;
  /**
  * search for the variable under this template, not globally
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable#template_id DataEnv0ConfigurationVariable#template_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable#type DataEnv0ConfigurationVariable#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable env0_configuration_variable}
*/
export class DataEnv0ConfigurationVariable extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0ConfigurationVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/configuration_variable env0_configuration_variable} Data Source
  *
  * @param scope The scope in which to define this construct
