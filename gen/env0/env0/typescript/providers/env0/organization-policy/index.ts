// https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/organization_policy
...
export interface OrganizationPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/organization_policy#default_ttl OrganizationPolicy#default_ttl}
  */
  readonly defaultTtl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/organization_policy#do_not_consider_merge_commits_for_pr_plans OrganizationPolicy#do_not_consider_merge_commits_for_pr_plans}
  */
  readonly doNotConsiderMergeCommitsForPrPlans?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/organization_policy#do_not_report_skipped_status_checks OrganizationPolicy#do_not_report_skipped_status_checks}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/organization_policy#enable_oidc OrganizationPolicy#enable_oidc}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/organization_policy#enforce_pr_commenter_permissions OrganizationPolicy#enforce_pr_commenter_permissions}
  */
  readonly enforcePrCommenterPermissions?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/organization_policy#id OrganizationPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/organization_policy#max_ttl OrganizationPolicy#max_ttl}
  */
  readonly maxTtl?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/organization_policy env0_organization_policy}
*/
export class OrganizationPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/organization_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/organization_policy env0_organization_policy} Resource
  *
  * @param scope The scope in which to define this construct
