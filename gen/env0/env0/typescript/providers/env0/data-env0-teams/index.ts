// https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/teams
...
export interface DataEnv0TeamsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/teams#filter DataEnv0Teams#filter}
  */
  readonly filter?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/teams#id DataEnv0Teams#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/teams env0_teams}
*/
export class DataEnv0Teams extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0Teams that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/teams#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/teams env0_teams} Data Source
  *
  * @param scope The scope in which to define this construct
