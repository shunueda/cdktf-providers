// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/project_policy
...
export interface DataEnv0ProjectPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  * id of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/project_policy#project_id DataEnv0ProjectPolicy#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/project_policy env0_project_policy}
*/
export class DataEnv0ProjectPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0ProjectPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/project_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/project_policy env0_project_policy} Data Source
  *
  * @param scope The scope in which to define this construct
