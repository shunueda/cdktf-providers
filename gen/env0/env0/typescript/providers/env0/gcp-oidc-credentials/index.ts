// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_oidc_credentials
...
export interface GcpOidcCredentialsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_oidc_credentials#credential_configuration_file_content GcpOidcCredentials#credential_configuration_file_content}
  */
  readonly credentialConfigurationFileContent: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_oidc_credentials#id GcpOidcCredentials#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_oidc_credentials#name GcpOidcCredentials#name}
  */
  readonly name: string;
  /**
  * the env0 project id to associate the credentials with
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_oidc_credentials#project_id GcpOidcCredentials#project_id}
  */
  readonly projectId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_oidc_credentials env0_gcp_oidc_credentials}
*/
export class GcpOidcCredentials extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GcpOidcCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_oidc_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/gcp_oidc_credentials env0_gcp_oidc_credentials} Resource
  *
  * @param scope The scope in which to define this construct
