// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/vcs_connection
...
export interface VcsConnectionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/vcs_connection#id VcsConnection#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/vcs_connection#name VcsConnection#name}
  */
  readonly name: string;
  /**
  * the VCS type (BitBucketServer, GitLabEnterprise, or GitHubEnterprise)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/vcs_connection#type VcsConnection#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/vcs_connection#url VcsConnection#url}
  */
  readonly url: string;
  /**
  * VCS agent key. Use a custom agent key or 'ENV0_DEFAULT' to use the default env0 agent
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/vcs_connection#vcs_agent_key VcsConnection#vcs_agent_key}
  */
  readonly vcsAgentKey?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/vcs_connection env0_vcs_connection}
*/
export class VcsConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VcsConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/vcs_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/vcs_connection env0_vcs_connection} Resource
  *
  * @param scope The scope in which to define this construct
