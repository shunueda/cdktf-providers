// https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/cost_credentials_project_assignment
...
export interface CostCredentialsProjectAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/cost_credentials_project_assignment#credential_id CostCredentialsProjectAssignment#credential_id}
  */
  readonly credentialId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/cost_credentials_project_assignment#id CostCredentialsProjectAssignment#id}
  *
  ...
  * id of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/cost_credentials_project_assignment#project_id CostCredentialsProjectAssignment#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/cost_credentials_project_assignment env0_cost_credentials_project_assignment}
*/
export class CostCredentialsProjectAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CostCredentialsProjectAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/cost_credentials_project_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/cost_credentials_project_assignment env0_cost_credentials_project_assignment} Resource
  *
  * @param scope The scope in which to define this construct
