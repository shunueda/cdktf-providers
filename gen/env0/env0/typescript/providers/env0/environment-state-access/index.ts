// https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/environment_state_access
...
export interface EnvironmentStateAccessConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/environment_state_access#accessible_from_entire_organization EnvironmentStateAccess#accessible_from_entire_organization}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/environment_state_access#allowed_project_ids EnvironmentStateAccess#allowed_project_ids}
  */
  readonly allowedProjectIds?: string[];
  /**
  * id of the environment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/environment_state_access#environment_id EnvironmentStateAccess#environment_id}
  */
  readonly environmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/environment_state_access#id EnvironmentStateAccess#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/environment_state_access env0_environment_state_access}
*/
export class EnvironmentStateAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnvironmentStateAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/environment_state_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/resources/environment_state_access env0_environment_state_access} Resource
  *
  * @param scope The scope in which to define this construct
