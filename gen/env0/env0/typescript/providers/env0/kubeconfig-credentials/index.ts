// https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/kubeconfig_credentials
...
export interface KubeconfigCredentialsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/kubeconfig_credentials#id KubeconfigCredentials#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/kubeconfig_credentials#kube_config KubeconfigCredentials#kube_config}
  */
  readonly kubeConfig: string;
  /**
  * name for the credentials
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/kubeconfig_credentials#name KubeconfigCredentials#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/kubeconfig_credentials env0_kubeconfig_credentials}
*/
export class KubeconfigCredentials extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubeconfigCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/kubeconfig_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/kubeconfig_credentials env0_kubeconfig_credentials} Resource
  *
  * @param scope The scope in which to define this construct
