// https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/organization
...
export interface DataEnv0OrganizationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/organization#id DataEnv0Organization#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/organization env0_organization}
*/
export class DataEnv0Organization extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0Organization that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/organization env0_organization} Data Source
  *
  * @param scope The scope in which to define this construct
