// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/agents
...
export interface DataEnv0AgentsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/agents#id DataEnv0Agents#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/agents env0_agents}
*/
export class DataEnv0Agents extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0Agents that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/agents#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/agents env0_agents} Data Source
  *
  * @param scope The scope in which to define this construct
