// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow
...
export interface CustomFlowConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#bitbucket_client_key CustomFlow#bitbucket_client_key}
  */
  readonly bitbucketClientKey?: string;
  /**
  * the env0 application installation id on the relevant github repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#github_installation_id CustomFlow#github_installation_id}
  */
  readonly githubInstallationId?: number;
  /**
  * the project id of the relevant repository (deprecated)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#gitlab_project_id CustomFlow#gitlab_project_id}
  */
  readonly gitlabProjectId?: number;
  /**
  * true if this custom flow integrates with azure dev ops repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#is_azure_devops CustomFlow#is_azure_devops}
  */
  readonly isAzureDevops?: boolean | cdktf.IResolvable;
  /**
  * true if this custom flow uses bitbucket server repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#is_bitbucket_server CustomFlow#is_bitbucket_server}
  */
  readonly isBitbucketServer?: boolean | cdktf.IResolvable;
  /**
  * true if this custom flow uses github enterprise repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#is_github_enterprise CustomFlow#is_github_enterprise}
  */
  readonly isGithubEnterprise?: boolean | cdktf.IResolvable;
  /**
  * true if this custom flow integrates with gitlab repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#is_gitlab CustomFlow#is_gitlab}
  */
  readonly isGitlab?: boolean | cdktf.IResolvable;
  /**
  * true if this custom flow uses gitlab enterprise repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#is_gitlab_enterprise CustomFlow#is_gitlab_enterprise}
  */
  readonly isGitlabEnterprise?: boolean | cdktf.IResolvable;
  /**
  * name for the custom flow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#name CustomFlow#name}
  */
  readonly name: string;
  /**
  * terraform / terragrunt file folder inside source code. Should be the full path including the .yaml/.yml file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#path CustomFlow#path}
  */
  readonly path?: string;
  /**
  * repository url for the custom flow source code
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#repository CustomFlow#repository}
  */
  readonly repository: string;
  /**
  * source code revision (branch / tag) to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#revision CustomFlow#revision}
  */
  readonly revision?: string;
  /**
  * an array of references to 'data_ssh_key' to use when accessing git over ssh
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#ssh_keys CustomFlow#ssh_keys}
  */
  readonly sshKeys?: { [key: string]: string }[] | cdktf.IResolvable;
  /**
  * the git token id to be used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#token_id CustomFlow#token_id}
  */
  readonly tokenId?: string;
  /**
  * the VCS connection id to be used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#vcs_connection_id CustomFlow#vcs_connection_id}
  */
  readonly vcsConnectionId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow env0_custom_flow}
*/
export class CustomFlow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomFlow that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/custom_flow env0_custom_flow} Resource
  *
  * @param scope The scope in which to define this construct
