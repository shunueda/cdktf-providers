// https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/project_budget
...
export interface ProjectBudgetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/project_budget#amount ProjectBudget#amount}
  */
  readonly amount: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/project_budget#id ProjectBudget#id}
  *
  ...
  * id of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/project_budget#project_id ProjectBudget#project_id}
  */
  readonly projectId: string;
  /**
  * list of notification thresholds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/project_budget#thresholds ProjectBudget#thresholds}
  */
  readonly thresholds?: number[];
  /**
  * budget timeframe (valid values: WEEKLY, MONTHLY, QUARTERLY, YEARLY)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/project_budget#timeframe ProjectBudget#timeframe}
  */
  readonly timeframe: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/project_budget env0_project_budget}
*/
export class ProjectBudget extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectBudget that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/project_budget#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/project_budget env0_project_budget} Resource
  *
  * @param scope The scope in which to define this construct
