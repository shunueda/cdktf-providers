// https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/module_testing_project
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/module_testing_project env0_module_testing_project}
*/
export class DataEnv0ModuleTestingProject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0ModuleTestingProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/module_testing_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/module_testing_project env0_module_testing_project} Data Source
  *
  * @param scope The scope in which to define this construct
