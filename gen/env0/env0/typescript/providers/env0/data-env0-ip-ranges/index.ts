// https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/ip_ranges
...
export interface DataEnv0IpRangesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/ip_ranges#id DataEnv0IpRanges#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/ip_ranges env0_ip_ranges}
*/
export class DataEnv0IpRanges extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0IpRanges that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/ip_ranges#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/ip_ranges env0_ip_ranges} Data Source
  *
  * @param scope The scope in which to define this construct
