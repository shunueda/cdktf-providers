// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/user_project_assignment
...
export interface UserProjectAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/user_project_assignment#custom_role_id UserProjectAssignment#custom_role_id}
  */
  readonly customRoleId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/user_project_assignment#id UserProjectAssignment#id}
  *
  ...
  * id of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/user_project_assignment#project_id UserProjectAssignment#project_id}
  */
  readonly projectId: string;
  /**
  * the assigned role (Admin, Planner, Viewer, Deployer)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/user_project_assignment#role UserProjectAssignment#role}
  */
  readonly role?: string;
  /**
  * id of the user. Note: can also be an id of a "User" API key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/user_project_assignment#user_id UserProjectAssignment#user_id}
  */
  readonly userId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/user_project_assignment env0_user_project_assignment}
*/
export class UserProjectAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserProjectAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/user_project_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/user_project_assignment env0_user_project_assignment} Resource
  *
  * @param scope The scope in which to define this construct
