// https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/project
...
export interface DataEnv0ProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  * id of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/project#id DataEnv0Project#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/project#name DataEnv0Project#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/project#parent_project_id DataEnv0Project#parent_project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/project#parent_project_name DataEnv0Project#parent_project_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/project#parent_project_path DataEnv0Project#parent_project_path}
  */
  readonly parentProjectPath?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/project env0_project}
*/
export class DataEnv0Project extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0Project that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/project env0_project} Data Source
  *
  * @param scope The scope in which to define this construct
