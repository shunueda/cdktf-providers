// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_cloud_configuration
...
export interface AwsCloudConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  * the AWS account id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_cloud_configuration#account_id AwsCloudConfiguration#account_id}
  */
  readonly accountId: string;
  /**
  * the CloudTrail bucket name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_cloud_configuration#bucket_name AwsCloudConfiguration#bucket_name}
  */
  readonly bucketName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_cloud_configuration#id AwsCloudConfiguration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_cloud_configuration#name AwsCloudConfiguration#name}
  */
  readonly name: string;
  /**
  * an optional bucket prefix (folder)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_cloud_configuration#prefix AwsCloudConfiguration#prefix}
  */
  readonly prefix?: string;
  /**
  * a list of AWS regions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_cloud_configuration#regions AwsCloudConfiguration#regions}
  */
  readonly regions: string[];
  /**
  * If 'true' than the prefix will be under 'AWSLogs' folder (default: false)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_cloud_configuration#should_prefix_under_logs_folder AwsCloudConfiguration#should_prefix_under_logs_folder}
  */
  readonly shouldPrefixUnderLogsFolder?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_cloud_configuration env0_aws_cloud_configuration}
*/
export class AwsCloudConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsCloudConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_cloud_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_cloud_configuration env0_aws_cloud_configuration} Resource
  *
  * @param scope The scope in which to define this construct
