// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/variable_set_assignment
...
export interface VariableSetAssignmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/variable_set_assignment#id VariableSetAssignment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/variable_set_assignment#scope VariableSetAssignment#scope}
  */
  readonly scope: string;
  /**
  * the resource(scope)id (e.g. template id)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/variable_set_assignment#scope_id VariableSetAssignment#scope_id}
  */
  readonly scopeId: string;
  /**
  * list of variable sets
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/variable_set_assignment#set_ids VariableSetAssignment#set_ids}
  */
  readonly setIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/variable_set_assignment env0_variable_set_assignment}
*/
export class VariableSetAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VariableSetAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/variable_set_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/variable_set_assignment env0_variable_set_assignment} Resource
  *
  * @param scope The scope in which to define this construct
