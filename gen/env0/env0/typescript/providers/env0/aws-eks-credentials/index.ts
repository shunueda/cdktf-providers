// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_eks_credentials
...
export interface AwsEksCredentialsConfig extends cdktf.TerraformMetaArguments {
  ...
  * eks cluster name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_eks_credentials#cluster_name AwsEksCredentials#cluster_name}
  */
  readonly clusterName: string;
  /**
  * the AWS region of the eks cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_eks_credentials#cluster_region AwsEksCredentials#cluster_region}
  */
  readonly clusterRegion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_eks_credentials#id AwsEksCredentials#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_eks_credentials#name AwsEksCredentials#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_eks_credentials env0_aws_eks_credentials}
*/
export class AwsEksCredentials extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsEksCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_eks_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/aws_eks_credentials env0_aws_eks_credentials} Resource
  *
  * @param scope The scope in which to define this construct
