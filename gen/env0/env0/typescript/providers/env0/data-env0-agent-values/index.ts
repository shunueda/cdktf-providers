// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/agent_values
...
export interface DataEnv0AgentValuesConfig extends cdktf.TerraformMetaArguments {
  ...
  * the agent key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/agent_values#agent_key DataEnv0AgentValues#agent_key}
  */
  readonly agentKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/agent_values#id DataEnv0AgentValues#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/agent_values env0_agent_values}
*/
export class DataEnv0AgentValues extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0AgentValues that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/agent_values#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/agent_values env0_agent_values} Data Source
  *
  * @param scope The scope in which to define this construct
