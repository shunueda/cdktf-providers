// https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration
...
export interface EnvironmentDiscoveryConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#auto_deploy_by_custom_glob EnvironmentDiscoveryConfiguration#auto_deploy_by_custom_glob}
  */
  readonly autoDeployByCustomGlob?: string;
  /**
  * bitbucket client
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#bitbucket_client_key EnvironmentDiscoveryConfiguration#bitbucket_client_key}
  */
  readonly bitbucketClientKey?: string;
  /**
  * create new environments from pull requests (default: false)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#create_new_environments_from_pull_requests EnvironmentDiscoveryConfiguration#create_new_environments_from_pull_requests}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#environment_placement EnvironmentDiscoveryConfiguration#environment_placement}
  */
  readonly environmentPlacement?: string;
  /**
  * github repository id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#github_installation_id EnvironmentDiscoveryConfiguration#github_installation_id}
  */
  readonly githubInstallationId?: number;
  /**
  * gitlab project id (deprecated)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#gitlab_project_id EnvironmentDiscoveryConfiguration#gitlab_project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#glob_pattern EnvironmentDiscoveryConfiguration#glob_pattern}
  */
  readonly globPattern?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#id EnvironmentDiscoveryConfiguration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#is_azure_devops EnvironmentDiscoveryConfiguration#is_azure_devops}
  */
  readonly isAzureDevops?: boolean | cdktf.IResolvable;
  /**
  * set to true if Bitbucket Server is used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#is_bitbucket_server EnvironmentDiscoveryConfiguration#is_bitbucket_server}
  */
  readonly isBitbucketServer?: boolean | cdktf.IResolvable;
  /**
  * set to true if GitHub Enterprise is used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#is_github_enterprise EnvironmentDiscoveryConfiguration#is_github_enterprise}
  */
  readonly isGithubEnterprise?: boolean | cdktf.IResolvable;
  /**
  * set to true if GitLab Enterprise is used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#is_gitlab_enterprise EnvironmentDiscoveryConfiguration#is_gitlab_enterprise}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#is_terragrunt_run_all EnvironmentDiscoveryConfiguration#is_terragrunt_run_all}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#opentofu_version EnvironmentDiscoveryConfiguration#opentofu_version}
  */
  readonly opentofuVersion?: string;
  /**
  * the project id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#project_id EnvironmentDiscoveryConfiguration#project_id}
  */
  readonly projectId: string;
  /**
  * the repository to run discovery on
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#repository EnvironmentDiscoveryConfiguration#repository}
  */
  readonly repository?: string;
  /**
  * Regex to select repositories for discovery-file configuration (enables discoveryFileConfiguration mode)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#repository_regex EnvironmentDiscoveryConfiguration#repository_regex}
  */
  readonly repositoryRegex?: string;
  /**
  * number of times to retry when deploy fails (between 1 and 3)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#retries_on_deploy EnvironmentDiscoveryConfiguration#retries_on_deploy}
  */
  readonly retriesOnDeploy?: number;
  /**
  * number of times to retry when destroy fails (between 1 and 3)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#retries_on_destroy EnvironmentDiscoveryConfiguration#retries_on_destroy}
  */
  readonly retriesOnDestroy?: number;
  /**
  * retry (on deploy) if error matches the specified regex
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#retry_on_deploy_only_when_matches_regex EnvironmentDiscoveryConfiguration#retry_on_deploy_only_when_matches_regex}
  */
  readonly retryOnDeployOnlyWhenMatchesRegex?: string;
  /**
  * retry (on destroy) if error matches the specified regex
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#retry_on_destroy_only_when_matches_regex EnvironmentDiscoveryConfiguration#retry_on_destroy_only_when_matches_regex}
  */
  readonly retryOnDestroyOnlyWhenMatchesRegex?: string;
  /**
  * start files Glob matching from this folder only
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#root_path EnvironmentDiscoveryConfiguration#root_path}
  */
  readonly rootPath?: string;
  /**
  * The ssh key id that will be available during deployment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#ssh_key_id EnvironmentDiscoveryConfiguration#ssh_key_id}
  */
  readonly sshKeyId?: string;
  /**
  * The ssh key name that will be available during deployment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#ssh_key_name EnvironmentDiscoveryConfiguration#ssh_key_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#terraform_version EnvironmentDiscoveryConfiguration#terraform_version}
  */
  readonly terraformVersion?: string;
  /**
  * The binary to use with Terragrunt. Valid values: 'opentofu' and 'terraform' (default: 'opentofu')
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#terragrunt_tf_binary EnvironmentDiscoveryConfiguration#terragrunt_tf_binary}
  */
  readonly terragruntTfBinary?: string;
  /**
  * the Terragrunt version to use (example: 0.52.0)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#terragrunt_version EnvironmentDiscoveryConfiguration#terragrunt_version}
  */
  readonly terragruntVersion?: string;
  /**
  * a token id to be used with 'gitlab' or 'azure_devops'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#token_id EnvironmentDiscoveryConfiguration#token_id}
  */
  readonly tokenId?: string;
  /**
  * the infrastructure type use. Valid values: 'opentofu', 'terraform', 'terragrunt', 'workflow' (default: 'opentofu')
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#type EnvironmentDiscoveryConfiguration#type}
  */
  readonly type?: string;
  /**
  * the VCS connection id to be used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#vcs_connection_id EnvironmentDiscoveryConfiguration#vcs_connection_id}
  */
  readonly vcsConnectionId?: string;
  /**
  * the Workspace namimg strategy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#workspace_naming EnvironmentDiscoveryConfiguration#workspace_naming}
  */
  readonly workspaceNaming?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration env0_environment_discovery_configuration}
*/
export class EnvironmentDiscoveryConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnvironmentDiscoveryConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/resources/environment_discovery_configuration env0_environment_discovery_configuration} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: EnvironmentDiscoveryConfigurationConfig) {
    ...
    this._repositoryRegex = config.repositoryRegex;
  ...
  // environment_placement - computed: true, optional: true, required: false
  ...
  // glob_pattern - computed: false, optional: true, required: false
  ...
  public resetGlobPattern() {
    this._globPattern = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  // repository_regex - computed: false, optional: true, required: false
  private _repositoryRegex?: string; 
  public get repositoryRegex() {
    return this.getStringAttribute('repository_regex');
  }
  public set repositoryRegex(value: string) {
    this._repositoryRegex = value;
  }
  public resetRepositoryRegex() {
    this._repositoryRegex = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get repositoryRegexInput() {
    return this._repositoryRegex;
  }
  ...
  // workspace_naming - computed: true, optional: true, required: false
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      repository_regex: cdktf.stringToTerraform(this._repositoryRegex),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      repository_regex: {
        value: cdktf.stringToHclTerraform(this._repositoryRegex),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
