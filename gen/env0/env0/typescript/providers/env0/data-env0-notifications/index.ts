// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/notifications
...
export interface DataEnv0NotificationsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/notifications#id DataEnv0Notifications#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/notifications env0_notifications}
*/
export class DataEnv0Notifications extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0Notifications that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/notifications#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/notifications env0_notifications} Data Source
  *
  * @param scope The scope in which to define this construct
