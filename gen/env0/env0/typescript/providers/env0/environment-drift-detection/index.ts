// https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/environment_drift_detection
...
export interface EnvironmentDriftDetectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/environment_drift_detection#auto_drift_remediation EnvironmentDriftDetection#auto_drift_remediation}
  */
  readonly autoDriftRemediation?: string;
  /**
  * Cron expression for scheduled drift detection of the environment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/environment_drift_detection#cron EnvironmentDriftDetection#cron}
  */
  readonly cron: string;
  /**
  * The environment's id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/environment_drift_detection#environment_id EnvironmentDriftDetection#environment_id}
  */
  readonly environmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/environment_drift_detection#id EnvironmentDriftDetection#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/environment_drift_detection env0_environment_drift_detection}
*/
export class EnvironmentDriftDetection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnvironmentDriftDetection that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/environment_drift_detection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/resources/environment_drift_detection env0_environment_drift_detection} Resource
  *
  * @param scope The scope in which to define this construct
