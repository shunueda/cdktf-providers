// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/workflow_trigger
...
export interface WorkflowTriggerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/workflow_trigger#downstream_environment_id WorkflowTrigger#downstream_environment_id}
  */
  readonly downstreamEnvironmentId: string;
  /**
  * id of the source environment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/workflow_trigger#environment_id WorkflowTrigger#environment_id}
  */
  readonly environmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/workflow_trigger#id WorkflowTrigger#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/workflow_trigger env0_workflow_trigger}
*/
export class WorkflowTrigger extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/workflow_trigger#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/resources/workflow_trigger env0_workflow_trigger} Resource
  *
  * @param scope The scope in which to define this construct
