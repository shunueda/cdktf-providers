// https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/projects
...
export interface DataEnv0ProjectsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/projects#id DataEnv0Projects#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/projects#include_archived_projects DataEnv0Projects#include_archived_projects}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/projects env0_projects}
*/
export class DataEnv0Projects extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0Projects that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/projects#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.4/docs/data-sources/projects env0_projects} Data Source
  *
  * @param scope The scope in which to define this construct
