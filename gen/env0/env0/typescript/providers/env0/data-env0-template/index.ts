// https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/template
...
export interface DataEnv0TemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  * id of the template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/template#id DataEnv0Template#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/template#name DataEnv0Template#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/template env0_template}
*/
export class DataEnv0Template extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0Template that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.7/docs/data-sources/template env0_template} Data Source
  *
  * @param scope The scope in which to define this construct
