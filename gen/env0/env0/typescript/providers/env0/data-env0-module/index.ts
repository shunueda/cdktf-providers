// https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/module
...
export interface DataEnv0ModuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/module#bitbucket_client_key DataEnv0Module#bitbucket_client_key}
  */
  readonly bitbucketClientKey?: string;
  /**
  * the env0 application installation id on the relevant github repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/module#github_installation_id DataEnv0Module#github_installation_id}
  */
  readonly githubInstallationId?: number;
  /**
  * id of the module
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/module#id DataEnv0Module#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/module#is_azure_devops DataEnv0Module#is_azure_devops}
  */
  readonly isAzureDevops?: boolean | cdktf.IResolvable;
  /**
  * the name of the module
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/module#module_name DataEnv0Module#module_name}
  */
  readonly moduleName?: string;
  /**
  * the token id used for integration with GitLab
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/module#token_id DataEnv0Module#token_id}
  */
  readonly tokenId?: string;
  /**
  * the token name used for integration with GitLab
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/module#token_name DataEnv0Module#token_name}
  */
  readonly tokenName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/module env0_module}
*/
export class DataEnv0Module extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0Module that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/module#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.8/docs/data-sources/module env0_module} Data Source
  *
  * @param scope The scope in which to define this construct
