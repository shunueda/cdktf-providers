// https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/custom_roles
...
export interface DataEnv0CustomRolesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/custom_roles#id DataEnv0CustomRoles#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/custom_roles env0_custom_roles}
*/
export class DataEnv0CustomRoles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEnv0CustomRoles that should be imported. Refer to the {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/custom_roles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/env0/env0/1.29.6/docs/data-sources/custom_roles env0_custom_roles} Data Source
  *
  * @param scope The scope in which to define this construct
