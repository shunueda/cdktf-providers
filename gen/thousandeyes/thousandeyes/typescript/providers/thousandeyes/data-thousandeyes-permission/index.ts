// https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs/data-sources/permission
...
export interface DataThousandeyesPermissionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs/data-sources/permission#id DataThousandeyesPermission#id}
  *
  ...
  * Permission name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs/data-sources/permission#permission_name DataThousandeyesPermission#permission_name}
  */
  readonly permissionName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs/data-sources/permission thousandeyes_permission}
*/
export class DataThousandeyesPermission extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataThousandeyesPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs/data-sources/permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs/data-sources/permission thousandeyes_permission} Data Source
  *
  * @param scope The scope in which to define this construct
