// https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs
...
export interface ThousandeyesProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs#account_group_id ThousandeyesProvider#account_group_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs#api_endpoint ThousandeyesProvider#api_endpoint}
  */
  readonly apiEndpoint?: string;
  /**
  * Enable the API SDK logs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs#api_sdk_logs_enabled ThousandeyesProvider#api_sdk_logs_enabled}
  */
  readonly apiSdkLogsEnabled?: boolean | cdktf.IResolvable;
  /**
  * The timeout value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs#timeout ThousandeyesProvider#timeout}
  */
  readonly timeout?: number;
  /**
  * The ThousandEyes organization's authentication token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs#token ThousandeyesProvider#token}
  */
  readonly token: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs#alias ThousandeyesProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs thousandeyes}
*/
export class ThousandeyesProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ThousandeyesProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/thousandeyes/thousandeyes/3.1.2/docs thousandeyes} Resource
  *
  * @param scope The scope in which to define this construct
