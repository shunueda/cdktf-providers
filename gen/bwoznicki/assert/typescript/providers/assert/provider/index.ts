// https://registry.terraform.io/providers/bwoznicki/assert/0.0.1/docs
...
export interface AssertProviderConfig {
  ...
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bwoznicki/assert/0.0.1/docs#alias AssertProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bwoznicki/assert/0.0.1/docs assert}
*/
export class AssertProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing AssertProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/bwoznicki/assert/0.0.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bwoznicki/assert/0.0.1/docs assert} Resource
  *
  * @param scope The scope in which to define this construct
