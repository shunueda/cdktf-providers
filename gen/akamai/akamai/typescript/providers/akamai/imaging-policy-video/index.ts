// https://registry.terraform.io/providers/akamai/akamai/9.1.0/docs/resources/imaging_policy_video
...
export interface ImagingPolicyVideoConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akamai/akamai/9.1.0/docs/resources/imaging_policy_video#activate_on_production ImagingPolicyVideo#activate_on_production}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akamai/akamai/9.1.0/docs/resources/imaging_policy_video#contract_id ImagingPolicyVideo#contract_id}
  */
  readonly contractId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akamai/akamai/9.1.0/docs/resources/imaging_policy_video#id ImagingPolicyVideo#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akamai/akamai/9.1.0/docs/resources/imaging_policy_video#json ImagingPolicyVideo#json}
  */
  readonly json: string;
  /**
  * Unique identifier for a Policy. It is not possible to modify the id of the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akamai/akamai/9.1.0/docs/resources/imaging_policy_video#policy_id ImagingPolicyVideo#policy_id}
  */
  readonly policyId: string;
  /**
  * Unique identifier for the Image & Video Manager Policy Set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akamai/akamai/9.1.0/docs/resources/imaging_policy_video#policyset_id ImagingPolicyVideo#policyset_id}
  */
  readonly policysetId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/akamai/akamai/9.1.0/docs/resources/imaging_policy_video akamai_imaging_policy_video}
*/
export class ImagingPolicyVideo extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a ImagingPolicyVideo resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ImagingPolicyVideo to import
  * @param importFromId The id of the existing ImagingPolicyVideo that should be imported. Refer to the {@link https://registry.terraform.io/providers/akamai/akamai/9.1.0/docs/resources/imaging_policy_video#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/akamai/akamai/9.1.0/docs/resources/imaging_policy_video akamai_imaging_policy_video} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ImagingPolicyVideoConfig
  */
  public constructor(scope: Construct, id: string, config: ImagingPolicyVideoConfig) {
    super(scope, id, {
