...
export interface ClusterRoleTemplateBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function clusterRoleTemplateBindingTimeoutsToTerraform(struct?: ClusterRoleTemplateBindingTimeouts | cdktf.IResolvable): any {
...
export function clusterRoleTemplateBindingTimeoutsToHclTerraform(struct?: ClusterRoleTemplateBindingTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ClusterRoleTemplateBindingTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ClusterRoleTemplateBindingTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ClusterRoleTemplateBindingTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ClusterRoleTemplateBinding extends cdktf.TerraformResource {
  ...
  * @param options ClusterRoleTemplateBindingConfig
  */
  public constructor(scope: Construct, id: string, config: ClusterRoleTemplateBindingConfig) {
    super(scope, id, {
    ...
    this._userPrincipalId = config.userPrincipalId;
  ...
  // role_template_id - computed: false, optional: false, required: true
  ...
  // user_principal_id - computed: true, optional: true, required: false
  ...
  private _timeouts = new ClusterRoleTemplateBindingTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ClusterRoleTemplateBindingTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      user_principal_id: cdktf.stringToTerraform(this._userPrincipalId),
      timeouts: clusterRoleTemplateBindingTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      user_principal_id: {
        value: cdktf.stringToHclTerraform(this._userPrincipalId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      timeouts: {
        value: clusterRoleTemplateBindingTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ClusterRoleTemplateBindingTimeouts",
      },
    };
