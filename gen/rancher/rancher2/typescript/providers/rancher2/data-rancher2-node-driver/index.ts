// https://registry.terraform.io/providers/rancher/rancher2/7.9.0/docs/data-sources/node_driver
...
export interface DataRancher2NodeDriverConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/7.9.0/docs/data-sources/node_driver#id DataRancher2NodeDriver#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/7.9.0/docs/data-sources/node_driver#name DataRancher2NodeDriver#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/7.9.0/docs/data-sources/node_driver#url DataRancher2NodeDriver#url}
  */
  readonly url?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rancher/rancher2/7.9.0/docs/data-sources/node_driver rancher2_node_driver}
*/
export class DataRancher2NodeDriver extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRancher2NodeDriver that should be imported. Refer to the {@link https://registry.terraform.io/providers/rancher/rancher2/7.9.0/docs/data-sources/node_driver#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rancher/rancher2/7.9.0/docs/data-sources/node_driver rancher2_node_driver} Data Source
  *
  * @param scope The scope in which to define this construct
