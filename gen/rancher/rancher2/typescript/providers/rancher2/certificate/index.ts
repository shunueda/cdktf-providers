...
export class Certificate extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "rancher2_certificate";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "rancher2_certificate", importId: importFromId, provider });
      }
  ...
  */
  ...
  private _certs?: string; 
  public get certs() {
    return this.getStringAttribute('certs');
  }
  public set certs(value: string) {
    this._certs = value;
  }
  // Temporarily expose input value. Use with caution.
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      certs: cdktf.stringToTerraform(this._certs),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      certs: {
        value: cdktf.stringToHclTerraform(this._certs),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
