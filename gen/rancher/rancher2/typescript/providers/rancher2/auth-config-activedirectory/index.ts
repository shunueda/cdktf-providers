...
export class AuthConfigActivedirectory extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "rancher2_auth_config_activedirectory";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "rancher2_auth_config_activedirectory", importId: importFromId, provider });
      }
  ...
  * @param options AuthConfigActivedirectoryConfig
  */
  public constructor(scope: Construct, id: string, config: AuthConfigActivedirectoryConfig) {
    super(scope, id, {
    ...
    this._defaultLoginDomain = config.defaultLoginDomain;
  ...
  // default_login_domain - computed: false, optional: true, required: false
  private _defaultLoginDomain?: string; 
  public get defaultLoginDomain() {
    return this.getStringAttribute('default_login_domain');
  }
  public set defaultLoginDomain(value: string) {
    this._defaultLoginDomain = value;
  }
  public resetDefaultLoginDomain() {
    this._defaultLoginDomain = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get defaultLoginDomainInput() {
    return this._defaultLoginDomain;
  }
  ...
  // user_disabled_bit_mask - computed: false, optional: true, required: false
  ...
  // user_search_filter - computed: true, optional: true, required: false
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      default_login_domain: cdktf.stringToTerraform(this._defaultLoginDomain),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      default_login_domain: {
        value: cdktf.stringToHclTerraform(this._defaultLoginDomain),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
