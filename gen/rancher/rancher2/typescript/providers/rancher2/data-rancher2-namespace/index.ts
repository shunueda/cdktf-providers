// https://registry.terraform.io/providers/rancher/rancher2/7.9.0/docs/data-sources/namespace
...
export interface DataRancher2NamespaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/7.9.0/docs/data-sources/namespace#id DataRancher2Namespace#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/7.9.0/docs/data-sources/namespace#name DataRancher2Namespace#name}
  */
  readonly name: string;
  /**
  * Project ID where k8s namespace belongs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rancher/rancher2/7.9.0/docs/data-sources/namespace#project_id DataRancher2Namespace#project_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rancher/rancher2/7.9.0/docs/data-sources/namespace rancher2_namespace}
*/
export class DataRancher2Namespace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRancher2Namespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/rancher/rancher2/7.9.0/docs/data-sources/namespace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rancher/rancher2/7.9.0/docs/data-sources/namespace rancher2_namespace} Data Source
  *
  * @param scope The scope in which to define this construct
