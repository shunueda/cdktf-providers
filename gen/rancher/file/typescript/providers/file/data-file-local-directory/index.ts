// https://registry.terraform.io/providers/rancher/file/2.2.2/docs/data-sources/local_directory
...
export function dataFileLocalDirectoryFilesToTerraform(struct?: DataFileLocalDirectoryFiles): any {
...
export function dataFileLocalDirectoryFilesToHclTerraform(struct?: DataFileLocalDirectoryFiles): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataFileLocalDirectoryFilesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataFileLocalDirectoryFiles | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataFileLocalDirectoryFiles | undefined) {
    if (value === undefined) {
  ...
  public get isDirectory() {
    return this.getStringAttribute('is_directory');
  }
...
export class DataFileLocalDirectoryFilesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataFileLocalDirectoryFilesOutputReference {
    return new DataFileLocalDirectoryFilesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class DataFileLocalDirectory extends cdktf.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataFileLocalDirectoryConfig) {
    super(scope, id, {
  ...
  private _files = new DataFileLocalDirectoryFilesList(this, "files", false);
  public get files() {
    return this._files;
  }
