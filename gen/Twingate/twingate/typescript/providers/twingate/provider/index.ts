// https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs
...
export interface TwingateProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#api_token TwingateProvider#api_token}
  */
  readonly apiToken?: string;
  /**
  * Specifies the cache settings for the provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#cache TwingateProvider#cache}
  */
  readonly cache?: TwingateProviderCache;
  /**
  * A default set of tags applied globally to all resources created by the provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#default_tags TwingateProvider#default_tags}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#http_max_retry TwingateProvider#http_max_retry}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#http_timeout TwingateProvider#http_timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#network TwingateProvider#network}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#url TwingateProvider#url}
  */
  readonly url?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#alias TwingateProvider#alias}
  */
...
export interface TwingateProviderCacheGroupsFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#is_active TwingateProvider#is_active}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#name TwingateProvider#name}
  */
  readonly name?: string;
  /**
  * Match when the value exist in the name of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#name_contains TwingateProvider#name_contains}
  */
  readonly nameContains?: string;
  /**
  * Match when the exact value does not exist in the name of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#name_exclude TwingateProvider#name_exclude}
  */
  readonly nameExclude?: string;
  /**
  * The name of the group must start with the value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#name_prefix TwingateProvider#name_prefix}
  */
  readonly namePrefix?: string;
  /**
  * The regular expression match of the name of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#name_regexp TwingateProvider#name_regexp}
  */
  readonly nameRegexp?: string;
  /**
  * The name of the group must end with the value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#name_suffix TwingateProvider#name_suffix}
  */
  readonly nameSuffix?: string;
  /**
  * Returns groups that match a list of types. valid types: `MANUAL`, `SYNCED`, `SYSTEM`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#types TwingateProvider#types}
  */
...
export interface TwingateProviderCacheResourcesFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#tags TwingateProvider#tags}
  */
...
export interface TwingateProviderCache {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#groups_enabled TwingateProvider#groups_enabled}
  */
  readonly groupsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Specifies the filter for the groups to be cached.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#groups_filter TwingateProvider#groups_filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#resource_enabled TwingateProvider#resource_enabled}
  */
  readonly resourceEnabled?: boolean | cdktf.IResolvable;
  /**
  * Specifies the filter for the resources to be cached.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#resources_filter TwingateProvider#resources_filter}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs twingate}
*/
export class TwingateProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing TwingateProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/twingate/twingate/3.5.0/docs twingate} Resource
  *
  * @param scope The scope in which to define this construct
