// https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/group
...
export interface DataTwingateGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/group#id DataTwingateGroup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/group twingate_group}
*/
export class DataTwingateGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTwingateGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/group twingate_group} Data Source
  *
  * @param scope The scope in which to define this construct
