// https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/security_policy
...
export interface DataTwingateSecurityPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/security_policy#id DataTwingateSecurityPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/security_policy#name DataTwingateSecurityPolicy#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/security_policy twingate_security_policy}
*/
export class DataTwingateSecurityPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTwingateSecurityPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/security_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/security_policy twingate_security_policy} Data Source
  *
  * @param scope The scope in which to define this construct
