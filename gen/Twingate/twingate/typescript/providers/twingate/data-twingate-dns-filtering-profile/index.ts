// https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/dns_filtering_profile
...
export interface DataTwingateDnsFilteringProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/dns_filtering_profile#id DataTwingateDnsFilteringProfile#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/dns_filtering_profile twingate_dns_filtering_profile}
*/
export class DataTwingateDnsFilteringProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTwingateDnsFilteringProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/dns_filtering_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/twingate/twingate/3.6.0/docs/data-sources/dns_filtering_profile twingate_dns_filtering_profile} Data Source
  *
  * @param scope The scope in which to define this construct
