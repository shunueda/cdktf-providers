// https://registry.terraform.io/providers/astronomer/astro/1.0.11/docs/resources/hybrid_cluster_workspace_authorization
...
export interface HybridClusterWorkspaceAuthorizationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/astronomer/astro/1.0.11/docs/resources/hybrid_cluster_workspace_authorization#cluster_id HybridClusterWorkspaceAuthorization#cluster_id}
  */
  readonly clusterId: string;
  /**
  * The IDs of the workspaces to authorize for the hybrid cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/astronomer/astro/1.0.11/docs/resources/hybrid_cluster_workspace_authorization#workspace_ids HybridClusterWorkspaceAuthorization#workspace_ids}
  */
  readonly workspaceIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/astronomer/astro/1.0.11/docs/resources/hybrid_cluster_workspace_authorization astro_hybrid_cluster_workspace_authorization}
*/
export class HybridClusterWorkspaceAuthorization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HybridClusterWorkspaceAuthorization that should be imported. Refer to the {@link https://registry.terraform.io/providers/astronomer/astro/1.0.11/docs/resources/hybrid_cluster_workspace_authorization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/astronomer/astro/1.0.11/docs/resources/hybrid_cluster_workspace_authorization astro_hybrid_cluster_workspace_authorization} Resource
  *
  * @param scope The scope in which to define this construct
