// https://registry.terraform.io/providers/astronomer/astro/1.0.10/docs/data-sources/api_token
...
export interface DataAstroApiTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/astronomer/astro/1.0.10/docs/data-sources/api_token#id DataAstroApiToken#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/astronomer/astro/1.0.10/docs/data-sources/api_token astro_api_token}
*/
export class DataAstroApiToken extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAstroApiToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/astronomer/astro/1.0.10/docs/data-sources/api_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/astronomer/astro/1.0.10/docs/data-sources/api_token astro_api_token} Data Source
  *
  * @param scope The scope in which to define this construct
