// https://registry.terraform.io/providers/astronomer/astro/1.0.11/docs/data-sources/team
...
export interface DataAstroTeamConfig extends cdktf.TerraformMetaArguments {
  ...
  * Team ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/astronomer/astro/1.0.11/docs/data-sources/team#id DataAstroTeam#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/astronomer/astro/1.0.11/docs/data-sources/team astro_team}
*/
export class DataAstroTeam extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAstroTeam that should be imported. Refer to the {@link https://registry.terraform.io/providers/astronomer/astro/1.0.11/docs/data-sources/team#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/astronomer/astro/1.0.11/docs/data-sources/team astro_team} Data Source
  *
  * @param scope The scope in which to define this construct
