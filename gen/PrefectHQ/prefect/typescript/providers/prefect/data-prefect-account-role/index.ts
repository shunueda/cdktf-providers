// https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/data-sources/account_role
...
export interface DataPrefectAccountRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/data-sources/account_role#account_id DataPrefectAccountRole#account_id}
  */
  readonly accountId?: string;
  /**
  * Name of the Account Role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/data-sources/account_role#name DataPrefectAccountRole#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/data-sources/account_role prefect_account_role}
*/
export class DataPrefectAccountRole extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPrefectAccountRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/data-sources/account_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/data-sources/account_role prefect_account_role} Data Source
  *
  * @param scope The scope in which to define this construct
