// https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/workspace_access
...
export interface WorkspaceAccessConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/workspace_access#accessor_id WorkspaceAccess#accessor_id}
  */
  readonly accessorId: string;
  /**
  * USER | SERVICE_ACCOUNT | TEAM
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/workspace_access#accessor_type WorkspaceAccess#accessor_type}
  */
  readonly accessorType: string;
  /**
  * Account ID (UUID) where the workspace is located
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/workspace_access#account_id WorkspaceAccess#account_id}
  */
  readonly accountId?: string;
  /**
  * Workspace ID (UUID) to grant access to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/workspace_access#workspace_id WorkspaceAccess#workspace_id}
  */
  readonly workspaceId?: string;
  /**
  * Workspace Role ID (UUID) to grant to accessor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/workspace_access#workspace_role_id WorkspaceAccess#workspace_role_id}
  */
  readonly workspaceRoleId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/workspace_access prefect_workspace_access}
*/
export class WorkspaceAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspaceAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/workspace_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/workspace_access prefect_workspace_access} Resource
  *
  * @param scope The scope in which to define this construct
