// https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_queue
...
export interface WorkQueueConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_queue#account_id WorkQueue#account_id}
  */
  readonly accountId?: string;
  /**
  * The concurrency limit applied to this work queue
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_queue#concurrency_limit WorkQueue#concurrency_limit}
  */
  readonly concurrencyLimit?: number;
  /**
  * Description of the work queue
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_queue#description WorkQueue#description}
  */
  readonly description?: string;
  /**
  * Whether this work queue is paused
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_queue#is_paused WorkQueue#is_paused}
  */
  readonly isPaused?: boolean | cdktf.IResolvable;
  /**
  * Name of the work queue
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_queue#name WorkQueue#name}
  */
  readonly name: string;
  /**
  * The priority of this work queue
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_queue#priority WorkQueue#priority}
  */
  readonly priority?: number;
  /**
  * The name of the work pool associated with this work queue
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_queue#work_pool_name WorkQueue#work_pool_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_queue#workspace_id WorkQueue#workspace_id}
  */
  readonly workspaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_queue prefect_work_queue}
*/
export class WorkQueue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_queue prefect_work_queue} Resource
  *
  * @param scope The scope in which to define this construct
