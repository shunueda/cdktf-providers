// https://registry.terraform.io/providers/prefecthq/prefect/2.90.1/docs/resources/global_concurrency_limit
...
export interface GlobalConcurrencyLimitConfig extends cdktf.TerraformMetaArguments {
  ...
  * Account ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.1/docs/resources/global_concurrency_limit#account_id GlobalConcurrencyLimit#account_id}
  */
  readonly accountId?: string;
  /**
  * Whether the global concurrency limit is active.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.1/docs/resources/global_concurrency_limit#active GlobalConcurrencyLimit#active}
  */
  readonly active?: boolean | cdktf.IResolvable;
  /**
  * The number of active slots.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.1/docs/resources/global_concurrency_limit#active_slots GlobalConcurrencyLimit#active_slots}
  */
  readonly activeSlots?: number;
  /**
  * The maximum number of tasks that can run simultaneously.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.1/docs/resources/global_concurrency_limit#limit GlobalConcurrencyLimit#limit}
  */
  readonly limit: number;
  /**
  * The name of the global concurrency limit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.1/docs/resources/global_concurrency_limit#name GlobalConcurrencyLimit#name}
  */
  readonly name: string;
  /**
  * Slot Decay Per Second (number or null)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.1/docs/resources/global_concurrency_limit#slot_decay_per_second GlobalConcurrencyLimit#slot_decay_per_second}
  */
  readonly slotDecayPerSecond?: number;
  /**
  * Workspace ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.1/docs/resources/global_concurrency_limit#workspace_id GlobalConcurrencyLimit#workspace_id}
  */
  readonly workspaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.1/docs/resources/global_concurrency_limit prefect_global_concurrency_limit}
*/
export class GlobalConcurrencyLimit extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlobalConcurrencyLimit that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.1/docs/resources/global_concurrency_limit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.1/docs/resources/global_concurrency_limit prefect_global_concurrency_limit} Resource
  *
  * @param scope The scope in which to define this construct
