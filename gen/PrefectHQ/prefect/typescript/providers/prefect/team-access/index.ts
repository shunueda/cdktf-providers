// https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/team_access
...
export interface TeamAccessConfig extends cdktf.TerraformMetaArguments {
  ...
  * Account ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/team_access#account_id TeamAccess#account_id}
  */
  readonly accountId?: string;
  /**
  * Member Actor ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/team_access#member_actor_id TeamAccess#member_actor_id}
  */
  readonly memberActorId: string;
  /**
  * Member ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/team_access#member_id TeamAccess#member_id}
  */
  readonly memberId: string;
  /**
  * Member Type (user | service_account)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/team_access#member_type TeamAccess#member_type}
  */
  readonly memberType: string;
  /**
  * Team ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/team_access#team_id TeamAccess#team_id}
  */
  readonly teamId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/team_access prefect_team_access}
*/
export class TeamAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/team_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/team_access prefect_team_access} Resource
  *
  * @param scope The scope in which to define this construct
