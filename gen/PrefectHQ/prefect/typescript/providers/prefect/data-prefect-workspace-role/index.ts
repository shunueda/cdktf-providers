// https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/workspace_role
...
export interface DataPrefectWorkspaceRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/workspace_role#account_id DataPrefectWorkspaceRole#account_id}
  */
  readonly accountId?: string;
  /**
  * Name of the Workspace Role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/workspace_role#name DataPrefectWorkspaceRole#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/workspace_role prefect_workspace_role}
*/
export class DataPrefectWorkspaceRole extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPrefectWorkspaceRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/workspace_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/workspace_role prefect_workspace_role} Data Source
  *
  * @param scope The scope in which to define this construct
