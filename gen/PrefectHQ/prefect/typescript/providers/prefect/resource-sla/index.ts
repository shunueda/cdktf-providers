// https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla
...
export interface ResourceSlaConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla#account_id ResourceSla#account_id}
  */
  readonly accountId?: string;
  /**
  * The ID of the Prefect resource to set the SLA for, in the format of `prefect.<resource_type>.<resource_id>`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla#resource_id ResourceSla#resource_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla#slas ResourceSla#slas}
  */
  readonly slas: ResourceSlaSlas[] | cdktf.IResolvable;
  /**
  * Workspace ID (UUID), defaults to the workspace set in the provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla#workspace_id ResourceSla#workspace_id}
  */
...
export interface ResourceSlaSlas {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla#duration ResourceSla#duration}
  */
  readonly duration?: number;
  /**
  * Whether the SLA is enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla#enabled ResourceSla#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * (Freshness SLA) The event to expect for this SLA.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla#expected_event ResourceSla#expected_event}
  */
  readonly expectedEvent?: string;
  /**
  * Name of the SLA
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla#name ResourceSla#name}
  */
  readonly name: string;
  /**
  * Resource that owns this SLA
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla#owner_resource ResourceSla#owner_resource}
  */
  readonly ownerResource?: string;
  /**
  * (Freshness SLA) The resource to match for this SLA. Use `jsonencode()`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla#resource_match ResourceSla#resource_match}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla#severity ResourceSla#severity}
  */
  readonly severity?: string;
  /**
  * (Frequency SLA) The amount of time after a flow run is considered stale.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla#stale_after ResourceSla#stale_after}
  */
  readonly staleAfter?: number;
  /**
  * (Freshness SLA or Lateness SLA) The amount of time after a flow run is considered stale or late.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla#within ResourceSla#within}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla prefect_resource_sla}
*/
export class ResourceSla extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourceSla that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/resources/resource_sla prefect_resource_sla} Resource
  *
  * @param scope The scope in which to define this construct
