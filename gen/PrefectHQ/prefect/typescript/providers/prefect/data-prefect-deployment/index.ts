// https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/deployment
...
export interface DataPrefectDeploymentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/deployment#account_id DataPrefectDeployment#account_id}
  */
  readonly accountId?: string;
  /**
  * Flow name associated with the deployment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/deployment#flow_name DataPrefectDeployment#flow_name}
  */
  readonly flowName?: string;
  /**
  * Deployment ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/deployment#id DataPrefectDeployment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/deployment#name DataPrefectDeployment#name}
  */
  readonly name?: string;
  /**
  * Workspace ID (UUID) to associate deployment to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/deployment#workspace_id DataPrefectDeployment#workspace_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/deployment prefect_deployment}
*/
export class DataPrefectDeployment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPrefectDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/deployment prefect_deployment} Data Source
  *
  * @param scope The scope in which to define this construct
