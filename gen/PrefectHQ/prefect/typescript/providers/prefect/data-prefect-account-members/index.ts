// https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/data-sources/account_members
...
export interface DataPrefectAccountMembersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/data-sources/account_members#account_id DataPrefectAccountMembers#account_id}
  */
...
export interface DataPrefectAccountMembersMembers {
  ...
  * Member email
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/data-sources/account_members#email DataPrefectAccountMembers#email}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/data-sources/account_members prefect_account_members}
*/
export class DataPrefectAccountMembers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPrefectAccountMembers that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/data-sources/account_members#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/data-sources/account_members prefect_account_members} Data Source
  *
  * @param scope The scope in which to define this construct
