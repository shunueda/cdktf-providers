// https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/workspace
...
export interface DataPrefectWorkspaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/workspace#account_id DataPrefectWorkspace#account_id}
  */
  readonly accountId?: string;
  /**
  * Unique handle for the workspace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/workspace#handle DataPrefectWorkspace#handle}
  */
  readonly handle?: string;
  /**
  * Workspace ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/workspace#id DataPrefectWorkspace#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/workspace prefect_workspace}
*/
export class DataPrefectWorkspace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPrefectWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/workspace prefect_workspace} Data Source
  *
  * @param scope The scope in which to define this construct
