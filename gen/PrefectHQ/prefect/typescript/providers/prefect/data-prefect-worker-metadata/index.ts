// https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/worker_metadata
...
export interface DataPrefectWorkerMetadataConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/worker_metadata#account_id DataPrefectWorkerMetadata#account_id}
  */
  readonly accountId?: string;
  /**
  * Workspace ID (UUID), defaults to the workspace set in the provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/worker_metadata#workspace_id DataPrefectWorkerMetadata#workspace_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/worker_metadata prefect_worker_metadata}
*/
export class DataPrefectWorkerMetadata extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPrefectWorkerMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/worker_metadata#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.0/docs/data-sources/worker_metadata prefect_worker_metadata} Data Source
  *
  * @param scope The scope in which to define this construct
