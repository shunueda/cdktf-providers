// https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/block_type
...
export interface BlockTypeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/block_type#account_id BlockType#account_id}
  */
  readonly accountId?: string;
  /**
  * A code snippet demonstrating use of the corresponding block.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/block_type#code_example BlockType#code_example}
  */
  readonly codeExample?: string;
  /**
  * A short blurb about the corresponding block's intended use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/block_type#description BlockType#description}
  */
  readonly description?: string;
  /**
  * Web URL for the block type's documentation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/block_type#documentation_url BlockType#documentation_url}
  */
  readonly documentationUrl?: string;
  /**
  * Web URL for the block type's logo.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/block_type#logo_url BlockType#logo_url}
  */
  readonly logoUrl?: string;
  /**
  * The name of the block type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/block_type#name BlockType#name}
  */
  readonly name: string;
  /**
  * The slug of the block type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/block_type#slug BlockType#slug}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/block_type#workspace_id BlockType#workspace_id}
  */
  readonly workspaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/block_type prefect_block_type}
*/
export class BlockType extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BlockType that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/block_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/block_type prefect_block_type} Resource
  *
  * @param scope The scope in which to define this construct
