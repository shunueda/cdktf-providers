// https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/account
...
export interface DataPrefectAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  * Account ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/account#id DataPrefectAccount#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/account#settings DataPrefectAccount#settings}
  */
...
export interface DataPrefectAccountSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/account#ai_log_summaries DataPrefectAccount#ai_log_summaries}
  */
  readonly aiLogSummaries?: boolean | cdktf.IResolvable;
  /**
  * Whether or not this account allows public workspaces
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/account#allow_public_workspaces DataPrefectAccount#allow_public_workspaces}
  */
  readonly allowPublicWorkspaces?: boolean | cdktf.IResolvable;
  /**
  * Whether to enable the use of managed work pools
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/account#managed_execution DataPrefectAccount#managed_execution}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/account prefect_account}
*/
export class DataPrefectAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPrefectAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.2/docs/data-sources/account prefect_account} Data Source
  *
  * @param scope The scope in which to define this construct
