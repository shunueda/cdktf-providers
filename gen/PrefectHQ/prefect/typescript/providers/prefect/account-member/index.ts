// https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/account_member
...
export interface AccountMemberConfig extends cdktf.TerraformMetaArguments {
  ...
  * Account ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/account_member#account_id AccountMember#account_id}
  */
  readonly accountId?: string;
  /**
  * Acount Role ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/account_member#account_role_id AccountMember#account_role_id}
  */
  readonly accountRoleId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/account_member prefect_account_member}
*/
export class AccountMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/account_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/resources/account_member prefect_account_member} Resource
  *
  * @param scope The scope in which to define this construct
