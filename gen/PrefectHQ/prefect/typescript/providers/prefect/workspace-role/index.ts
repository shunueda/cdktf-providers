// https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/workspace_role
...
export interface WorkspaceRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/workspace_role#description WorkspaceRole#description}
  */
  readonly description?: string;
  /**
  * Workspace Role ID (UUID), whose permissions are inherited by this Workspace Role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/workspace_role#inherited_role_id WorkspaceRole#inherited_role_id}
  */
  readonly inheritedRoleId?: string;
  /**
  * Name of the Workspace Role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/workspace_role#name WorkspaceRole#name}
  */
  readonly name: string;
  /**
  * List of scopes linked to the Workspace Role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/workspace_role#scopes WorkspaceRole#scopes}
  */
  readonly scopes?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/workspace_role prefect_workspace_role}
*/
export class WorkspaceRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkspaceRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/workspace_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.91.0/docs/resources/workspace_role prefect_workspace_role} Resource
  *
  * @param scope The scope in which to define this construct
