// https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/work_pool
...
export interface WorkPoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/work_pool#account_id WorkPool#account_id}
  */
  readonly accountId?: string;
  /**
  * The base job template for the work pool, as a JSON string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/work_pool#base_job_template WorkPool#base_job_template}
  */
  readonly baseJobTemplate?: string;
  /**
  * The concurrency limit applied to this work pool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/work_pool#concurrency_limit WorkPool#concurrency_limit}
  */
  readonly concurrencyLimit?: number;
  /**
  * Description of the work pool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/work_pool#description WorkPool#description}
  */
  readonly description?: string;
  /**
  * Name of the work pool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/work_pool#name WorkPool#name}
  */
  readonly name: string;
  /**
  * Whether this work pool is paused
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/work_pool#paused WorkPool#paused}
  */
  readonly paused?: boolean | cdktf.IResolvable;
  /**
  * Type of the work pool, eg. kubernetes, ecs, process, etc.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/work_pool#type WorkPool#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/work_pool#workspace_id WorkPool#workspace_id}
  */
  readonly workspaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/work_pool prefect_work_pool}
*/
export class WorkPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/work_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/work_pool prefect_work_pool} Resource
  *
  * @param scope The scope in which to define this construct
