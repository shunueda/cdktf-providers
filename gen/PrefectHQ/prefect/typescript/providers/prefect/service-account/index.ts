// https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/service_account
...
export interface ServiceAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/service_account#account_id ServiceAccount#account_id}
  */
  readonly accountId?: string;
  /**
  * Account Role name of the service account (one of: Admin, Member, Owner)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/service_account#account_role_name ServiceAccount#account_role_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/service_account#api_key_expiration ServiceAccount#api_key_expiration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/service_account#api_key_keepers ServiceAccount#api_key_keepers}
  */
  readonly apiKeyKeepers?: { [key: string]: string };
  /**
  * Name of the service account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/service_account#name ServiceAccount#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/service_account#old_key_expires_in_seconds ServiceAccount#old_key_expires_in_seconds}
  */
  readonly oldKeyExpiresInSeconds?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/service_account prefect_service_account}
*/
export class ServiceAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/service_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.0/docs/resources/service_account prefect_service_account} Resource
  *
  * @param scope The scope in which to define this construct
