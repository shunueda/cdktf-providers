// https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_pool_access
...
export interface WorkPoolAccessConfig extends cdktf.TerraformMetaArguments {
  ...
  * Account ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_pool_access#account_id WorkPoolAccess#account_id}
  */
  readonly accountId?: string;
  /**
  * List of actor IDs with manage access to the Work Pool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_pool_access#manage_actor_ids WorkPoolAccess#manage_actor_ids}
  */
  readonly manageActorIds?: string[];
  /**
  * List of team IDs with manage access to the Work Pool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_pool_access#manage_team_ids WorkPoolAccess#manage_team_ids}
  */
  readonly manageTeamIds?: string[];
  /**
  * List of actor IDs with run access to the Work Pool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_pool_access#run_actor_ids WorkPoolAccess#run_actor_ids}
  */
  readonly runActorIds?: string[];
  /**
  * List of team IDs with run access to the Work Pool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_pool_access#run_team_ids WorkPoolAccess#run_team_ids}
  */
  readonly runTeamIds?: string[];
  /**
  * List of actor IDs with view access to the Work Pool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_pool_access#view_actor_ids WorkPoolAccess#view_actor_ids}
  */
  readonly viewActorIds?: string[];
  /**
  * List of team IDs with view access to the Work Pool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_pool_access#view_team_ids WorkPoolAccess#view_team_ids}
  */
  readonly viewTeamIds?: string[];
  /**
  * The name of the Work Pool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_pool_access#work_pool_name WorkPoolAccess#work_pool_name}
  */
  readonly workPoolName: string;
  /**
  * Workspace ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_pool_access#workspace_id WorkPoolAccess#workspace_id}
  */
  readonly workspaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_pool_access prefect_work_pool_access}
*/
export class WorkPoolAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkPoolAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_pool_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.90.4/docs/resources/work_pool_access prefect_work_pool_access} Resource
  *
  * @param scope The scope in which to define this construct
