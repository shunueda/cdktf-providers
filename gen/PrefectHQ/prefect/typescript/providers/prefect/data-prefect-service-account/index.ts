// https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/data-sources/service_account
...
export interface DataPrefectServiceAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/data-sources/service_account#account_id DataPrefectServiceAccount#account_id}
  */
  readonly accountId?: string;
  /**
  * Service Account ID (UUID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/data-sources/service_account#id DataPrefectServiceAccount#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/data-sources/service_account#name DataPrefectServiceAccount#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/data-sources/service_account prefect_service_account}
*/
export class DataPrefectServiceAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPrefectServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/data-sources/service_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/prefecthq/prefect/2.92.1/docs/data-sources/service_account prefect_service_account} Data Source
  *
  * @param scope The scope in which to define this construct
