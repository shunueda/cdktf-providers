// https://registry.terraform.io/providers/integrations/github/6.8.3/docs
...
export class GithubProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing GithubProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.3/docs#import import section} in the documentation of this resource for the id to use
