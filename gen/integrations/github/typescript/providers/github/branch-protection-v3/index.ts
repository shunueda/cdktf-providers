// https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/branch_protection_v3
...
export class BranchProtectionV3 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BranchProtectionV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/branch_protection_v3#import import section} in the documentation of this resource for the id to use
