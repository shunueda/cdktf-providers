// https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/issue_labels
...
export class IssueLabels extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IssueLabels that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/issue_labels#import import section} in the documentation of this resource for the id to use
