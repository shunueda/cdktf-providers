// https://registry.terraform.io/providers/integrations/github/6.8.2/docs/resources/team_sync_group_mapping
...
export class TeamSyncGroupMapping extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamSyncGroupMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/resources/team_sync_group_mapping#import import section} in the documentation of this resource for the id to use
