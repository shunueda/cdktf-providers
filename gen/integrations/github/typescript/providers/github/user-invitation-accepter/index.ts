// https://registry.terraform.io/providers/integrations/github/6.8.2/docs/resources/user_invitation_accepter
...
export class UserInvitationAccepter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserInvitationAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/resources/user_invitation_accepter#import import section} in the documentation of this resource for the id to use
