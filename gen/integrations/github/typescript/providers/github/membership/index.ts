// https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/membership
...
export class Membership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Membership that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/membership#import import section} in the documentation of this resource for the id to use
