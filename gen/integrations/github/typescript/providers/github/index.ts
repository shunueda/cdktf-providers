...
export * as actionsHostedRunner from './actions-hosted-runner';
...
export * as enterpriseActionsWorkflowPermissions from './enterprise-actions-workflow-permissions';
export * as enterpriseOrganization from './enterprise-organization';
export * as enterpriseSecurityAnalysisSettings from './enterprise-security-analysis-settings';
...
export * as organizationCustomProperties from './organization-custom-properties';
export * as organizationCustomRole from './organization-custom-role';
export * as organizationProject from './organization-project';
export * as organizationRepositoryRole from './organization-repository-role';
export * as organizationRole from './organization-role';
export * as organizationRoleTeam from './organization-role-team';
export * as organizationRoleTeamAssignment from './organization-role-team-assignment';
export * as organizationRoleUser from './organization-role-user';
...
export * as repositoryCustomProperty from './repository-custom-property';
...
export * as dataGithubOrganizationCustomProperties from './data-github-organization-custom-properties';
...
export * as dataGithubOrganizationRepositoryRole from './data-github-organization-repository-role';
export * as dataGithubOrganizationRepositoryRoles from './data-github-organization-repository-roles';
export * as dataGithubOrganizationRole from './data-github-organization-role';
export * as dataGithubOrganizationRoleTeams from './data-github-organization-role-teams';
export * as dataGithubOrganizationRoleUsers from './data-github-organization-role-users';
export * as dataGithubOrganizationRoles from './data-github-organization-roles';
export * as dataGithubOrganizationSecurityManagers from './data-github-organization-security-managers';
...
export * as dataGithubRepositoryCustomProperties from './data-github-repository-custom-properties';
...
export * as dataGithubRepositoryEnvironmentDeploymentPolicies from './data-github-repository-environment-deployment-policies';
