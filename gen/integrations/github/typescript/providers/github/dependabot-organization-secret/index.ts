// https://registry.terraform.io/providers/integrations/github/6.8.2/docs/resources/dependabot_organization_secret
...
export class DependabotOrganizationSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DependabotOrganizationSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/resources/dependabot_organization_secret#import import section} in the documentation of this resource for the id to use
