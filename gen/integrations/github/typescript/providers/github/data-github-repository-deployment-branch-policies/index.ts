// https://registry.terraform.io/providers/integrations/github/6.8.2/docs/data-sources/repository_deployment_branch_policies
...
export class DataGithubRepositoryDeploymentBranchPolicies extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubRepositoryDeploymentBranchPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/data-sources/repository_deployment_branch_policies#import import section} in the documentation of this resource for the id to use
