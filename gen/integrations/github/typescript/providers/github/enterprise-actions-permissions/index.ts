// https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/enterprise_actions_permissions
...
export class EnterpriseActionsPermissions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnterpriseActionsPermissions that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/enterprise_actions_permissions#import import section} in the documentation of this resource for the id to use
