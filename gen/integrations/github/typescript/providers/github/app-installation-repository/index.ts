// https://registry.terraform.io/providers/integrations/github/6.7.5/docs/resources/app_installation_repository
...
export class AppInstallationRepository extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppInstallationRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.7.5/docs/resources/app_installation_repository#import import section} in the documentation of this resource for the id to use
