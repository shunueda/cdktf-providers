// https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/branch_default
...
export class BranchDefault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BranchDefault that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/branch_default#import import section} in the documentation of this resource for the id to use
