// https://registry.terraform.io/providers/integrations/github/6.8.2/docs/data-sources/organization_role
...
export class DataGithubOrganizationRole extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubOrganizationRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/data-sources/organization_role#import import section} in the documentation of this resource for the id to use
