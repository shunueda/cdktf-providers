// https://registry.terraform.io/providers/integrations/github/6.7.5/docs/resources/user_gpg_key
...
export class UserGpgKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserGpgKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.7.5/docs/resources/user_gpg_key#import import section} in the documentation of this resource for the id to use
