// https://registry.terraform.io/providers/integrations/github/6.8.2/docs/resources/team
...
export class Team extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Team that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/resources/team#import import section} in the documentation of this resource for the id to use
