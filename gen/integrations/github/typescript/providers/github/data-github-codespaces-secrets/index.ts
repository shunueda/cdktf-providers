// https://registry.terraform.io/providers/integrations/github/6.8.2/docs/data-sources/codespaces_secrets
...
export interface DataGithubCodespacesSecretsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/data-sources/codespaces_secrets#full_name DataGithubCodespacesSecrets#full_name}
  */
  readonly fullName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/data-sources/codespaces_secrets#id DataGithubCodespacesSecrets#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/data-sources/codespaces_secrets#name DataGithubCodespacesSecrets#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/data-sources/codespaces_secrets github_codespaces_secrets}
*/
export class DataGithubCodespacesSecrets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubCodespacesSecrets that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/data-sources/codespaces_secrets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/data-sources/codespaces_secrets github_codespaces_secrets} Data Source
  *
  * @param scope The scope in which to define this construct
