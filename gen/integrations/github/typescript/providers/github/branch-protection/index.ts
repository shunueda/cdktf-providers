// https://registry.terraform.io/providers/integrations/github/6.8.2/docs/resources/branch_protection
...
export class BranchProtection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BranchProtection that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/resources/branch_protection#import import section} in the documentation of this resource for the id to use
