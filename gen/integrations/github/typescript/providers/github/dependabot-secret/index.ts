// https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/dependabot_secret
...
export class DependabotSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DependabotSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/dependabot_secret#import import section} in the documentation of this resource for the id to use
