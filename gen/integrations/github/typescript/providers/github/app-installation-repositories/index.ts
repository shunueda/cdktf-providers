// https://registry.terraform.io/providers/integrations/github/6.7.5/docs/resources/app_installation_repositories
...
export class AppInstallationRepositories extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppInstallationRepositories that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.7.5/docs/resources/app_installation_repositories#import import section} in the documentation of this resource for the id to use
