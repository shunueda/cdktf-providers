// https://registry.terraform.io/providers/integrations/github/6.8.2/docs/data-sources/team
...
export class DataGithubTeam extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGithubTeam that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.2/docs/data-sources/team#import import section} in the documentation of this resource for the id to use
