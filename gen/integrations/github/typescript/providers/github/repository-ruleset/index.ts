// https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/repository_ruleset
...
export class RepositoryRuleset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RepositoryRuleset that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/repository_ruleset#import import section} in the documentation of this resource for the id to use
  ...
  public constructor(scope: Construct, id: string, config: RepositoryRulesetConfig) {
    super(scope, id, {
      ...
      terraformGeneratorMetadata: {
        ...
        providerVersionConstraint: '6.8.3'
      },
