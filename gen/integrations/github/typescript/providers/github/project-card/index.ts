// https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/project_card
...
export class ProjectCard extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectCard that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/project_card#import import section} in the documentation of this resource for the id to use
