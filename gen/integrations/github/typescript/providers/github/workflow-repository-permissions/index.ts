// https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/workflow_repository_permissions
...
export class WorkflowRepositoryPermissions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowRepositoryPermissions that should be imported. Refer to the {@link https://registry.terraform.io/providers/integrations/github/6.8.3/docs/resources/workflow_repository_permissions#import import section} in the documentation of this resource for the id to use
