// https://registry.terraform.io/providers/alekc/kubectl/2.1.3/docs/resources/server_version
...
export interface ServerVersionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/kubectl/2.1.3/docs/resources/server_version#id ServerVersion#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/kubectl/2.1.3/docs/resources/server_version#triggers ServerVersion#triggers}
  */
  readonly triggers?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/alekc/kubectl/2.1.3/docs/resources/server_version kubectl_server_version}
*/
export class ServerVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServerVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/alekc/kubectl/2.1.3/docs/resources/server_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/alekc/kubectl/2.1.3/docs/resources/server_version kubectl_server_version} Resource
  *
  * @param scope The scope in which to define this construct
