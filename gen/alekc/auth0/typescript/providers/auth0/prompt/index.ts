// https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/prompt
...
export interface PromptConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/prompt#id Prompt#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/prompt#identifier_first Prompt#identifier_first}
  */
  readonly identifierFirst?: boolean | cdktf.IResolvable;
  /**
  * Which login experience to use. Options include `classic` and `new`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/prompt#universal_login_experience Prompt#universal_login_experience}
  */
  readonly universalLoginExperience?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/prompt auth0_prompt}
*/
export class Prompt extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Prompt that should be imported. Refer to the {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/prompt#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/prompt auth0_prompt} Resource
  *
  * @param scope The scope in which to define this construct
