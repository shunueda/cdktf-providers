// https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/custom_domain
...
export interface CustomDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/custom_domain#domain CustomDomain#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/custom_domain#id CustomDomain#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Provisioning type for the custom domain. Valid options are: auth0_managed_certs, self_managed_certs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/custom_domain#type CustomDomain#type}
  */
  readonly type: string;
  /**
  * Domain verification method. Options include `txt`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/custom_domain#verification_method CustomDomain#verification_method}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/custom_domain auth0_custom_domain}
*/
export class CustomDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/custom_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/custom_domain auth0_custom_domain} Resource
  *
  * @param scope The scope in which to define this construct
