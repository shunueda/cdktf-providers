// https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant
...
export interface TenantConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#allowed_logout_urls Tenant#allowed_logout_urls}
  */
  readonly allowedLogoutUrls?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#default_audience Tenant#default_audience}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#default_directory Tenant#default_directory}
  */
  readonly defaultDirectory?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#default_redirection_uri Tenant#default_redirection_uri}
  */
  readonly defaultRedirectionUri?: string;
  /**
  * Supported locales for the user interface. The first locale in the list will be used to set the default locale
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#enabled_locales Tenant#enabled_locales}
  */
  readonly enabledLocales?: string[];
  /**
  * Friendly name for the tenant
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#friendly_name Tenant#friendly_name}
  */
  readonly friendlyName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#id Tenant#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#idle_session_lifetime Tenant#idle_session_lifetime}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#picture_url Tenant#picture_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#sandbox_version Tenant#sandbox_version}
  */
  readonly sandboxVersion?: string;
  /**
  * Number of hours during which a session will stay valid
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#session_lifetime Tenant#session_lifetime}
  */
  readonly sessionLifetime?: number;
  /**
  * Support email address for authenticating users
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#support_email Tenant#support_email}
  */
  readonly supportEmail?: string;
  /**
  * Support URL for authenticating users
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#support_url Tenant#support_url}
  */
  readonly supportUrl?: string;
  /**
  * change_password block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#change_password Tenant#change_password}
  */
  readonly changePassword?: TenantChangePassword;
  /**
  * error_page block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#error_page Tenant#error_page}
  */
  readonly errorPage?: TenantErrorPage;
  /**
  * flags block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#flags Tenant#flags}
  */
  readonly flags?: TenantFlags;
  /**
  * guardian_mfa_page block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#guardian_mfa_page Tenant#guardian_mfa_page}
  */
  readonly guardianMfaPage?: TenantGuardianMfaPage;
  /**
  * universal_login block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#universal_login Tenant#universal_login}
  */
  readonly universalLogin?: TenantUniversalLogin;
}
export interface TenantChangePassword {
  /**
  * Indicates whether or not to use the custom change password page
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#enabled Tenant#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * HTML format with supported Liquid syntax. Customized content of the change password page
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#html Tenant#html}
  */
...
export interface TenantErrorPage {
  ...
  */
  readonly html: string;
  /**
  * Indicates whether or not to show the link to logs as part of the default error page
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#show_log_link Tenant#show_log_link}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#url Tenant#url}
  */
  readonly url: string;
}
...
export interface TenantFlags {
  /**
  * Indicates whether or not to use the older v1 change password flow. Not recommended except for backward compatibility
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#change_pwd_flow_v1 Tenant#change_pwd_flow_v1}
  */
  readonly changePwdFlowV1?: boolean | cdktf.IResolvable;
  /**
  * Indicated whether or not classic Universal Login prompts include additional security headers to prevent clickjacking
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#disable_clickjack_protection_headers Tenant#disable_clickjack_protection_headers}
  */
  readonly disableClickjackProtectionHeaders?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether or not the APIs section is enabled for the tenant
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#enable_apis_section Tenant#enable_apis_section}
  */
  readonly enableApisSection?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether or not all current connections should be enabled when a new client is created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#enable_client_connections Tenant#enable_client_connections}
  */
  readonly enableClientConnections?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether or not the tenant allows custom domains in emails
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#enable_custom_domain_in_emails Tenant#enable_custom_domain_in_emails}
  */
  readonly enableCustomDomainInEmails?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether or not the tenant allows dynamic client registration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#enable_dynamic_client_registration Tenant#enable_dynamic_client_registration}
  */
  readonly enableDynamicClientRegistration?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether or not to use the older v2 legacy logs search
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#enable_legacy_logs_search_v2 Tenant#enable_legacy_logs_search_v2}
  */
  readonly enableLegacyLogsSearchV2?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether or not advanced API Authorization scenarios are enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#enable_pipeline2 Tenant#enable_pipeline2}
  */
  readonly enablePipeline2?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether or not the public sign up process shows a user_exists error if the user already exists
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#enable_public_signup_user_exists_error Tenant#enable_public_signup_user_exists_error}
  */
  readonly enablePublicSignupUserExistsError?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether or not the tenant uses universal login
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#universal_login Tenant#universal_login}
  */
  readonly universalLogin?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#use_scope_descriptions_for_consent Tenant#use_scope_descriptions_for_consent}
  */
...
export interface TenantUniversalLoginColors {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#page_background Tenant#page_background}
  */
  readonly pageBackground?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#primary Tenant#primary}
  */
...
export interface TenantUniversalLogin {
  ...
  * colors block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#colors Tenant#colors}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant auth0_tenant}
*/
export class Tenant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Tenant that should be imported. Refer to the {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/alekc/auth0/1.1.3/docs/resources/tenant auth0_tenant} Resource
  *
  * @param scope The scope in which to define this construct
