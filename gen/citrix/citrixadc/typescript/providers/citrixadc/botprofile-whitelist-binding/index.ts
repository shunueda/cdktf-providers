// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_whitelist_binding
...
export interface BotprofileWhitelistBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_whitelist_binding#bot_bind_comment BotprofileWhitelistBinding#bot_bind_comment}
  */
  readonly botBindComment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_whitelist_binding#bot_whitelist BotprofileWhitelistBinding#bot_whitelist}
  */
  readonly botWhitelist?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_whitelist_binding#bot_whitelist_enabled BotprofileWhitelistBinding#bot_whitelist_enabled}
  */
  readonly botWhitelistEnabled?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_whitelist_binding#bot_whitelist_type BotprofileWhitelistBinding#bot_whitelist_type}
  */
  readonly botWhitelistType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_whitelist_binding#bot_whitelist_value BotprofileWhitelistBinding#bot_whitelist_value}
  */
  readonly botWhitelistValue: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_whitelist_binding#id BotprofileWhitelistBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_whitelist_binding#log BotprofileWhitelistBinding#log}
  */
  readonly log?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_whitelist_binding#logmessage BotprofileWhitelistBinding#logmessage}
  */
  readonly logmessage?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_whitelist_binding#name BotprofileWhitelistBinding#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_whitelist_binding citrixadc_botprofile_whitelist_binding}
*/
export class BotprofileWhitelistBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BotprofileWhitelistBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_whitelist_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_whitelist_binding citrixadc_botprofile_whitelist_binding} Resource
  *
  * @param scope The scope in which to define this construct
