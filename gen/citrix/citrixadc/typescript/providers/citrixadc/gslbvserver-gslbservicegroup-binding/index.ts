// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/gslbvserver_gslbservicegroup_binding
...
export interface GslbvserverGslbservicegroupBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/gslbvserver_gslbservicegroup_binding#id GslbvserverGslbservicegroupBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/gslbvserver_gslbservicegroup_binding#name GslbvserverGslbservicegroupBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/gslbvserver_gslbservicegroup_binding#order GslbvserverGslbservicegroupBinding#order}
  */
  readonly order?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/gslbvserver_gslbservicegroup_binding#servicegroupname GslbvserverGslbservicegroupBinding#servicegroupname}
  */
  readonly servicegroupname: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/gslbvserver_gslbservicegroup_binding citrixadc_gslbvserver_gslbservicegroup_binding}
*/
export class GslbvserverGslbservicegroupBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GslbvserverGslbservicegroupBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/gslbvserver_gslbservicegroup_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/gslbvserver_gslbservicegroup_binding citrixadc_gslbvserver_gslbservicegroup_binding} Resource
  *
  * @param scope The scope in which to define this construct
