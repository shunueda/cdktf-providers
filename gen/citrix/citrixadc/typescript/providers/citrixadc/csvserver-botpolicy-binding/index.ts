// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/csvserver_botpolicy_binding
...
export interface CsvserverBotpolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/csvserver_botpolicy_binding#bindpoint CsvserverBotpolicyBinding#bindpoint}
  */
  readonly bindpoint?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/csvserver_botpolicy_binding#gotopriorityexpression CsvserverBotpolicyBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/csvserver_botpolicy_binding#id CsvserverBotpolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/csvserver_botpolicy_binding#invoke CsvserverBotpolicyBinding#invoke}
  */
  readonly invoke?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/csvserver_botpolicy_binding#labelname CsvserverBotpolicyBinding#labelname}
  */
  readonly labelname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/csvserver_botpolicy_binding#labeltype CsvserverBotpolicyBinding#labeltype}
  */
  readonly labeltype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/csvserver_botpolicy_binding#name CsvserverBotpolicyBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/csvserver_botpolicy_binding#policyname CsvserverBotpolicyBinding#policyname}
  */
  readonly policyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/csvserver_botpolicy_binding#priority CsvserverBotpolicyBinding#priority}
  */
  readonly priority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/csvserver_botpolicy_binding#targetlbvserver CsvserverBotpolicyBinding#targetlbvserver}
  */
  readonly targetlbvserver?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/csvserver_botpolicy_binding citrixadc_csvserver_botpolicy_binding}
*/
export class CsvserverBotpolicyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CsvserverBotpolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/csvserver_botpolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/csvserver_botpolicy_binding citrixadc_csvserver_botpolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
