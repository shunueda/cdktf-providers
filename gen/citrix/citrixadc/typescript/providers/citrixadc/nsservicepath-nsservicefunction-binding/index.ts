// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsservicepath_nsservicefunction_binding
...
export interface NsservicepathNsservicefunctionBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsservicepath_nsservicefunction_binding#id NsservicepathNsservicefunctionBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsservicepath_nsservicefunction_binding#index NsservicepathNsservicefunctionBinding#index}
  */
  readonly index: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsservicepath_nsservicefunction_binding#servicefunction NsservicepathNsservicefunctionBinding#servicefunction}
  */
  readonly servicefunction: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsservicepath_nsservicefunction_binding#servicepathname NsservicepathNsservicefunctionBinding#servicepathname}
  */
  readonly servicepathname: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsservicepath_nsservicefunction_binding citrixadc_nsservicepath_nsservicefunction_binding}
*/
export class NsservicepathNsservicefunctionBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NsservicepathNsservicefunctionBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsservicepath_nsservicefunction_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsservicepath_nsservicefunction_binding citrixadc_nsservicepath_nsservicefunction_binding} Resource
  *
  * @param scope The scope in which to define this construct
