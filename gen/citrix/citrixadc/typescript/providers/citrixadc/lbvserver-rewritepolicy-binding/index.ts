// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbvserver_rewritepolicy_binding
...
export interface LbvserverRewritepolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbvserver_rewritepolicy_binding#bindpoint LbvserverRewritepolicyBinding#bindpoint}
  */
  readonly bindpoint?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbvserver_rewritepolicy_binding#gotopriorityexpression LbvserverRewritepolicyBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbvserver_rewritepolicy_binding#id LbvserverRewritepolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbvserver_rewritepolicy_binding#invoke LbvserverRewritepolicyBinding#invoke}
  */
  readonly invoke?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbvserver_rewritepolicy_binding#labelname LbvserverRewritepolicyBinding#labelname}
  */
  readonly labelname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbvserver_rewritepolicy_binding#labeltype LbvserverRewritepolicyBinding#labeltype}
  */
  readonly labeltype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbvserver_rewritepolicy_binding#name LbvserverRewritepolicyBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbvserver_rewritepolicy_binding#policyname LbvserverRewritepolicyBinding#policyname}
  */
  readonly policyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbvserver_rewritepolicy_binding#priority LbvserverRewritepolicyBinding#priority}
  */
  readonly priority?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbvserver_rewritepolicy_binding citrixadc_lbvserver_rewritepolicy_binding}
*/
export class LbvserverRewritepolicyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbvserverRewritepolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbvserver_rewritepolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbvserver_rewritepolicy_binding citrixadc_lbvserver_rewritepolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
