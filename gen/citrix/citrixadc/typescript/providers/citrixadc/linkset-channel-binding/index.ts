// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/linkset_channel_binding
...
export interface LinksetChannelBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/linkset_channel_binding#id LinksetChannelBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/linkset_channel_binding#ifnum LinksetChannelBinding#ifnum}
  */
  readonly ifnum: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/linkset_channel_binding#linkset_id LinksetChannelBinding#linkset_id}
  */
  readonly linksetId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/linkset_channel_binding citrixadc_linkset_channel_binding}
*/
export class LinksetChannelBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LinksetChannelBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/linkset_channel_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/linkset_channel_binding citrixadc_linkset_channel_binding} Resource
  *
  * @param scope The scope in which to define this construct
