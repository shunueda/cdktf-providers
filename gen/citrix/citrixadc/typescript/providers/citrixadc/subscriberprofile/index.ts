// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberprofile
...
export interface SubscriberprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberprofile#id Subscriberprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberprofile#ip Subscriberprofile#ip}
  */
  readonly ip: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberprofile#servicepath Subscriberprofile#servicepath}
  */
  readonly servicepath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberprofile#subscriberrules Subscriberprofile#subscriberrules}
  */
  readonly subscriberrules?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberprofile#subscriptionidtype Subscriberprofile#subscriptionidtype}
  */
  readonly subscriptionidtype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberprofile#subscriptionidvalue Subscriberprofile#subscriptionidvalue}
  */
  readonly subscriptionidvalue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberprofile#vlan Subscriberprofile#vlan}
  */
  readonly vlan?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberprofile citrixadc_subscriberprofile}
*/
export class Subscriberprofile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Subscriberprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberprofile citrixadc_subscriberprofile} Resource
  *
  * @param scope The scope in which to define this construct
