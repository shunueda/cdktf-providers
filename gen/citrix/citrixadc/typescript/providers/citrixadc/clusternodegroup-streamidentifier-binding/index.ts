// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_streamidentifier_binding
...
export interface ClusternodegroupStreamidentifierBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_streamidentifier_binding#id ClusternodegroupStreamidentifierBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_streamidentifier_binding#identifiername ClusternodegroupStreamidentifierBinding#identifiername}
  */
  readonly identifiername: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_streamidentifier_binding#name ClusternodegroupStreamidentifierBinding#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_streamidentifier_binding citrixadc_clusternodegroup_streamidentifier_binding}
*/
export class ClusternodegroupStreamidentifierBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusternodegroupStreamidentifierBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_streamidentifier_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_streamidentifier_binding citrixadc_clusternodegroup_streamidentifier_binding} Resource
  *
  * @param scope The scope in which to define this construct
