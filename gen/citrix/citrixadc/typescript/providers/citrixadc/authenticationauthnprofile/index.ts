// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationauthnprofile
...
export interface AuthenticationauthnprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationauthnprofile#authenticationdomain Authenticationauthnprofile#authenticationdomain}
  */
  readonly authenticationdomain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationauthnprofile#authenticationhost Authenticationauthnprofile#authenticationhost}
  */
  readonly authenticationhost?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationauthnprofile#authenticationlevel Authenticationauthnprofile#authenticationlevel}
  */
  readonly authenticationlevel?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationauthnprofile#authnvsname Authenticationauthnprofile#authnvsname}
  */
  readonly authnvsname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationauthnprofile#id Authenticationauthnprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationauthnprofile#name Authenticationauthnprofile#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationauthnprofile citrixadc_authenticationauthnprofile}
*/
export class Authenticationauthnprofile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Authenticationauthnprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationauthnprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationauthnprofile citrixadc_authenticationauthnprofile} Resource
  *
  * @param scope The scope in which to define this construct
