// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup
...
export interface LbgroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup#backuppersistencetimeout Lbgroup#backuppersistencetimeout}
  */
  readonly backuppersistencetimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup#cookiedomain Lbgroup#cookiedomain}
  */
  readonly cookiedomain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup#cookiename Lbgroup#cookiename}
  */
  readonly cookiename?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup#id Lbgroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup#name Lbgroup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup#persistencebackup Lbgroup#persistencebackup}
  */
  readonly persistencebackup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup#persistencetype Lbgroup#persistencetype}
  */
  readonly persistencetype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup#persistmask Lbgroup#persistmask}
  */
  readonly persistmask?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup#rule Lbgroup#rule}
  */
  readonly rule?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup#timeout Lbgroup#timeout}
  */
  readonly timeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup#usevserverpersistency Lbgroup#usevserverpersistency}
  */
  readonly usevserverpersistency?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup#v6persistmasklen Lbgroup#v6persistmasklen}
  */
  readonly v6Persistmasklen?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup citrixadc_lbgroup}
*/
export class Lbgroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lbgroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbgroup citrixadc_lbgroup} Resource
  *
  * @param scope The scope in which to define this construct
