// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditnslogglobal_auditnslogpolicy_binding
...
export interface AuditnslogglobalAuditnslogpolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditnslogglobal_auditnslogpolicy_binding#builtin AuditnslogglobalAuditnslogpolicyBinding#builtin}
  */
  readonly builtin?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditnslogglobal_auditnslogpolicy_binding#globalbindtype AuditnslogglobalAuditnslogpolicyBinding#globalbindtype}
  */
  readonly globalbindtype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditnslogglobal_auditnslogpolicy_binding#id AuditnslogglobalAuditnslogpolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditnslogglobal_auditnslogpolicy_binding#policyname AuditnslogglobalAuditnslogpolicyBinding#policyname}
  */
  readonly policyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditnslogglobal_auditnslogpolicy_binding#priority AuditnslogglobalAuditnslogpolicyBinding#priority}
  */
  readonly priority: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditnslogglobal_auditnslogpolicy_binding citrixadc_auditnslogglobal_auditnslogpolicy_binding}
*/
export class AuditnslogglobalAuditnslogpolicyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuditnslogglobalAuditnslogpolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditnslogglobal_auditnslogpolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditnslogglobal_auditnslogpolicy_binding citrixadc_auditnslogglobal_auditnslogpolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
