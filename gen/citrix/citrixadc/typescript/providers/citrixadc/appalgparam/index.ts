// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appalgparam
...
export interface AppalgparamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appalgparam#id Appalgparam#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appalgparam#pptpgreidletimeout Appalgparam#pptpgreidletimeout}
  */
  readonly pptpgreidletimeout: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appalgparam citrixadc_appalgparam}
*/
export class Appalgparam extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Appalgparam that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appalgparam#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appalgparam citrixadc_appalgparam} Resource
  *
  * @param scope The scope in which to define this construct
