// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cachepolicylabel
...
export interface CachepolicylabelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cachepolicylabel#evaluates Cachepolicylabel#evaluates}
  */
  readonly evaluates?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cachepolicylabel#id Cachepolicylabel#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cachepolicylabel#labelname Cachepolicylabel#labelname}
  */
  readonly labelname: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cachepolicylabel citrixadc_cachepolicylabel}
*/
export class Cachepolicylabel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cachepolicylabel that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cachepolicylabel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cachepolicylabel citrixadc_cachepolicylabel} Resource
  *
  * @param scope The scope in which to define this construct
