// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/locationfile
...
export interface LocationfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/locationfile#format Locationfile#format}
  */
  readonly format?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/locationfile#id Locationfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/locationfile#locationfile Locationfile#locationfile}
  */
  readonly locationfile: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/locationfile#src Locationfile#src}
  */
  readonly src?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/locationfile citrixadc_locationfile}
*/
export class Locationfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Locationfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/locationfile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/locationfile citrixadc_locationfile} Resource
  *
  * @param scope The scope in which to define this construct
