// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/data-sources/nsversion
...
export interface DataCitrixadcNsversionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/data-sources/nsversion#id DataCitrixadcNsversion#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/data-sources/nsversion#installedversion DataCitrixadcNsversion#installedversion}
  */
  readonly installedversion?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/data-sources/nsversion citrixadc_nsversion}
*/
export class DataCitrixadcNsversion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixadcNsversion that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/data-sources/nsversion#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/data-sources/nsversion citrixadc_nsversion} Data Source
  *
  * @param scope The scope in which to define this construct
