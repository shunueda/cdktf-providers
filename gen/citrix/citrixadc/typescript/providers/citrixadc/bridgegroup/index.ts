// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup
...
export interface BridgegroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup#bridgegroup_id Bridgegroup#bridgegroup_id}
  */
  readonly bridgegroupId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup#dynamicrouting Bridgegroup#dynamicrouting}
  */
  readonly dynamicrouting?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup#id Bridgegroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup#ipv6dynamicrouting Bridgegroup#ipv6dynamicrouting}
  */
  readonly ipv6Dynamicrouting?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup citrixadc_bridgegroup}
*/
export class Bridgegroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Bridgegroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup citrixadc_bridgegroup} Resource
  *
  * @param scope The scope in which to define this construct
