// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/csvserver_authorizationpolicy_binding
...
export interface CsvserverAuthorizationpolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/csvserver_authorizationpolicy_binding#bindpoint CsvserverAuthorizationpolicyBinding#bindpoint}
  */
  readonly bindpoint?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/csvserver_authorizationpolicy_binding#gotopriorityexpression CsvserverAuthorizationpolicyBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/csvserver_authorizationpolicy_binding#id CsvserverAuthorizationpolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/csvserver_authorizationpolicy_binding#invoke CsvserverAuthorizationpolicyBinding#invoke}
  */
  readonly invoke?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/csvserver_authorizationpolicy_binding#labelname CsvserverAuthorizationpolicyBinding#labelname}
  */
  readonly labelname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/csvserver_authorizationpolicy_binding#labeltype CsvserverAuthorizationpolicyBinding#labeltype}
  */
  readonly labeltype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/csvserver_authorizationpolicy_binding#name CsvserverAuthorizationpolicyBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/csvserver_authorizationpolicy_binding#policyname CsvserverAuthorizationpolicyBinding#policyname}
  */
  readonly policyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/csvserver_authorizationpolicy_binding#priority CsvserverAuthorizationpolicyBinding#priority}
  */
  readonly priority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/csvserver_authorizationpolicy_binding#targetlbvserver CsvserverAuthorizationpolicyBinding#targetlbvserver}
  */
  readonly targetlbvserver?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/csvserver_authorizationpolicy_binding citrixadc_csvserver_authorizationpolicy_binding}
*/
export class CsvserverAuthorizationpolicyBinding extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "citrixadc_csvserver_authorizationpolicy_binding";
  ...
  * @param importFromId The id of the existing CsvserverAuthorizationpolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/csvserver_authorizationpolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "citrixadc_csvserver_authorizationpolicy_binding", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/csvserver_authorizationpolicy_binding citrixadc_csvserver_authorizationpolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options CsvserverAuthorizationpolicyBindingConfig
  */
  public constructor(scope: Construct, id: string, config: CsvserverAuthorizationpolicyBindingConfig) {
    super(scope, id, {
