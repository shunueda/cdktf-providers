// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_crvserver_binding
...
export interface ClusternodegroupCrvserverBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_crvserver_binding#id ClusternodegroupCrvserverBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_crvserver_binding#name ClusternodegroupCrvserverBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_crvserver_binding#vserver ClusternodegroupCrvserverBinding#vserver}
  */
  readonly vserver: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_crvserver_binding citrixadc_clusternodegroup_crvserver_binding}
*/
export class ClusternodegroupCrvserverBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusternodegroupCrvserverBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_crvserver_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_crvserver_binding citrixadc_clusternodegroup_crvserver_binding} Resource
  *
  * @param scope The scope in which to define this construct
