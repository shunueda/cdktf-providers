// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditmessageaction
...
export interface AuditmessageactionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditmessageaction#bypasssafetycheck Auditmessageaction#bypasssafetycheck}
  */
  readonly bypasssafetycheck?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditmessageaction#id Auditmessageaction#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditmessageaction#loglevel Auditmessageaction#loglevel}
  */
  readonly loglevel?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditmessageaction#logtonewnslog Auditmessageaction#logtonewnslog}
  */
  readonly logtonewnslog?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditmessageaction#name Auditmessageaction#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditmessageaction#stringbuilderexpr Auditmessageaction#stringbuilderexpr}
  */
  readonly stringbuilderexpr?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditmessageaction citrixadc_auditmessageaction}
*/
export class Auditmessageaction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Auditmessageaction that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditmessageaction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditmessageaction citrixadc_auditmessageaction} Resource
  *
  * @param scope The scope in which to define this construct
