// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/feoparameter
...
export interface FeoparameterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/feoparameter#cssinlinethressize Feoparameter#cssinlinethressize}
  */
  readonly cssinlinethressize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/feoparameter#id Feoparameter#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/feoparameter#imginlinethressize Feoparameter#imginlinethressize}
  */
  readonly imginlinethressize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/feoparameter#jpegqualitypercent Feoparameter#jpegqualitypercent}
  */
  readonly jpegqualitypercent?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/feoparameter#jsinlinethressize Feoparameter#jsinlinethressize}
  */
  readonly jsinlinethressize?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/feoparameter citrixadc_feoparameter}
*/
export class Feoparameter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Feoparameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/feoparameter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/feoparameter citrixadc_feoparameter} Resource
  *
  * @param scope The scope in which to define this construct
