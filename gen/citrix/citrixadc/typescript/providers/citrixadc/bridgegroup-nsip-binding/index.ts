// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup_nsip_binding
...
export interface BridgegroupNsipBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup_nsip_binding#bridgegroup_id BridgegroupNsipBinding#bridgegroup_id}
  */
  readonly bridgegroupId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup_nsip_binding#id BridgegroupNsipBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup_nsip_binding#ipaddress BridgegroupNsipBinding#ipaddress}
  */
  readonly ipaddress: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup_nsip_binding#netmask BridgegroupNsipBinding#netmask}
  */
  readonly netmask?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup_nsip_binding#ownergroup BridgegroupNsipBinding#ownergroup}
  */
  readonly ownergroup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup_nsip_binding#td BridgegroupNsipBinding#td}
  */
  readonly td?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup_nsip_binding citrixadc_bridgegroup_nsip_binding}
*/
export class BridgegroupNsipBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BridgegroupNsipBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup_nsip_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/bridgegroup_nsip_binding citrixadc_bridgegroup_nsip_binding} Resource
  *
  * @param scope The scope in which to define this construct
