// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslcipher
...
export interface SslcipherConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslcipher#ciphergroupname Sslcipher#ciphergroupname}
  */
  readonly ciphergroupname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslcipher#id Sslcipher#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslcipher#ciphersuitebinding Sslcipher#ciphersuitebinding}
  */
  readonly ciphersuitebinding?: SslcipherCiphersuitebinding[] | cdktf.IResolvable;
}
export interface SslcipherCiphersuitebinding {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslcipher#ciphername Sslcipher#ciphername}
  */
  readonly ciphername: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslcipher#cipherpriority Sslcipher#cipherpriority}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslcipher citrixadc_sslcipher}
*/
export class Sslcipher extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sslcipher that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslcipher#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslcipher citrixadc_sslcipher} Resource
  *
  * @param scope The scope in which to define this construct
