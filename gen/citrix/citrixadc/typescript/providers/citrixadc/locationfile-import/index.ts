// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/locationfile_import
...
export interface LocationfileImportConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/locationfile_import#format LocationfileImport#format}
  */
  readonly format?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/locationfile_import#id LocationfileImport#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/locationfile_import#locationfile LocationfileImport#locationfile}
  */
  readonly locationfile: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/locationfile_import#src LocationfileImport#src}
  */
  readonly src: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/locationfile_import citrixadc_locationfile_import}
*/
export class LocationfileImport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LocationfileImport that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/locationfile_import#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/locationfile_import citrixadc_locationfile_import} Resource
  *
  * @param scope The scope in which to define this construct
