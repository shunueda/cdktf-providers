// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnappsprofile_port_binding
...
export interface LsnappsprofilePortBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnappsprofile_port_binding#appsprofilename LsnappsprofilePortBinding#appsprofilename}
  */
  readonly appsprofilename: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnappsprofile_port_binding#id LsnappsprofilePortBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnappsprofile_port_binding#lsnport LsnappsprofilePortBinding#lsnport}
  */
  readonly lsnport: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnappsprofile_port_binding citrixadc_lsnappsprofile_port_binding}
*/
export class LsnappsprofilePortBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LsnappsprofilePortBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnappsprofile_port_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnappsprofile_port_binding citrixadc_lsnappsprofile_port_binding} Resource
  *
  * @param scope The scope in which to define this construct
