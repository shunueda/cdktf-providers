// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ip6tunnelparam
...
export interface Ip6TunnelparamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ip6tunnelparam#dropfrag Ip6Tunnelparam#dropfrag}
  */
  readonly dropfrag?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ip6tunnelparam#dropfragcputhreshold Ip6Tunnelparam#dropfragcputhreshold}
  */
  readonly dropfragcputhreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ip6tunnelparam#id Ip6Tunnelparam#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ip6tunnelparam#srcip Ip6Tunnelparam#srcip}
  */
  readonly srcip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ip6tunnelparam#srciproundrobin Ip6Tunnelparam#srciproundrobin}
  */
  readonly srciproundrobin?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ip6tunnelparam#useclientsourceipv6 Ip6Tunnelparam#useclientsourceipv6}
  */
  readonly useclientsourceipv6?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ip6tunnelparam citrixadc_ip6tunnelparam}
*/
export class Ip6Tunnelparam extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ip6Tunnelparam that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ip6tunnelparam#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ip6tunnelparam citrixadc_ip6tunnelparam} Resource
  *
  * @param scope The scope in which to define this construct
