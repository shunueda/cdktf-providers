// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnglobal_vpnurlpolicy_binding
...
export interface VpnglobalVpnurlpolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnglobal_vpnurlpolicy_binding#builtin VpnglobalVpnurlpolicyBinding#builtin}
  */
  readonly builtin?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnglobal_vpnurlpolicy_binding#gotopriorityexpression VpnglobalVpnurlpolicyBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnglobal_vpnurlpolicy_binding#groupextraction VpnglobalVpnurlpolicyBinding#groupextraction}
  */
  readonly groupextraction?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnglobal_vpnurlpolicy_binding#id VpnglobalVpnurlpolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnglobal_vpnurlpolicy_binding#policyname VpnglobalVpnurlpolicyBinding#policyname}
  */
  readonly policyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnglobal_vpnurlpolicy_binding#priority VpnglobalVpnurlpolicyBinding#priority}
  */
  readonly priority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnglobal_vpnurlpolicy_binding#secondary VpnglobalVpnurlpolicyBinding#secondary}
  */
  readonly secondary?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnglobal_vpnurlpolicy_binding citrixadc_vpnglobal_vpnurlpolicy_binding}
*/
export class VpnglobalVpnurlpolicyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnglobalVpnurlpolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnglobal_vpnurlpolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnglobal_vpnurlpolicy_binding citrixadc_vpnglobal_vpnurlpolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
