// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnformssoaction
...
export interface VpnformssoactionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnformssoaction#actionurl Vpnformssoaction#actionurl}
  */
  readonly actionurl: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnformssoaction#id Vpnformssoaction#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnformssoaction#name Vpnformssoaction#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnformssoaction#namevaluepair Vpnformssoaction#namevaluepair}
  */
  readonly namevaluepair?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnformssoaction#nvtype Vpnformssoaction#nvtype}
  */
  readonly nvtype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnformssoaction#passwdfield Vpnformssoaction#passwdfield}
  */
  readonly passwdfield: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnformssoaction#responsesize Vpnformssoaction#responsesize}
  */
  readonly responsesize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnformssoaction#ssosuccessrule Vpnformssoaction#ssosuccessrule}
  */
  readonly ssosuccessrule: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnformssoaction#submitmethod Vpnformssoaction#submitmethod}
  */
  readonly submitmethod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnformssoaction#userfield Vpnformssoaction#userfield}
  */
  readonly userfield: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnformssoaction citrixadc_vpnformssoaction}
*/
export class Vpnformssoaction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Vpnformssoaction that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnformssoaction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnformssoaction citrixadc_vpnformssoaction} Resource
  *
  * @param scope The scope in which to define this construct
