// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnrtspalgprofile
...
export interface LsnrtspalgprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnrtspalgprofile#id Lsnrtspalgprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnrtspalgprofile#rtspalgprofilename Lsnrtspalgprofile#rtspalgprofilename}
  */
  readonly rtspalgprofilename: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnrtspalgprofile#rtspidletimeout Lsnrtspalgprofile#rtspidletimeout}
  */
  readonly rtspidletimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnrtspalgprofile#rtspportrange Lsnrtspalgprofile#rtspportrange}
  */
  readonly rtspportrange?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnrtspalgprofile#rtsptransportprotocol Lsnrtspalgprofile#rtsptransportprotocol}
  */
  readonly rtsptransportprotocol?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnrtspalgprofile citrixadc_lsnrtspalgprofile}
*/
export class Lsnrtspalgprofile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lsnrtspalgprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnrtspalgprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsnrtspalgprofile citrixadc_lsnrtspalgprofile} Resource
  *
  * @param scope The scope in which to define this construct
