// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsaction
...
export interface DnsactionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsaction#actionname Dnsaction#actionname}
  */
  readonly actionname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsaction#actiontype Dnsaction#actiontype}
  */
  readonly actiontype: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsaction#dnsprofilename Dnsaction#dnsprofilename}
  */
  readonly dnsprofilename?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsaction#id Dnsaction#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsaction#ipaddress Dnsaction#ipaddress}
  */
  readonly ipaddress?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsaction#preferredloclist Dnsaction#preferredloclist}
  */
  readonly preferredloclist?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsaction#ttl Dnsaction#ttl}
  */
  readonly ttl?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsaction#viewname Dnsaction#viewname}
  */
  readonly viewname?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsaction citrixadc_dnsaction}
*/
export class Dnsaction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Dnsaction that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsaction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsaction citrixadc_dnsaction} Resource
  *
  * @param scope The scope in which to define this construct
