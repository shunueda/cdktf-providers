// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_blacklist_binding
...
export interface BotprofileBlacklistBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_blacklist_binding#bot_bind_comment BotprofileBlacklistBinding#bot_bind_comment}
  */
  readonly botBindComment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_blacklist_binding#bot_blacklist BotprofileBlacklistBinding#bot_blacklist}
  */
  readonly botBlacklist?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_blacklist_binding#bot_blacklist_action BotprofileBlacklistBinding#bot_blacklist_action}
  */
  readonly botBlacklistAction?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_blacklist_binding#bot_blacklist_enabled BotprofileBlacklistBinding#bot_blacklist_enabled}
  */
  readonly botBlacklistEnabled?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_blacklist_binding#bot_blacklist_type BotprofileBlacklistBinding#bot_blacklist_type}
  */
  readonly botBlacklistType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_blacklist_binding#bot_blacklist_value BotprofileBlacklistBinding#bot_blacklist_value}
  */
  readonly botBlacklistValue: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_blacklist_binding#id BotprofileBlacklistBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_blacklist_binding#logmessage BotprofileBlacklistBinding#logmessage}
  */
  readonly logmessage?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_blacklist_binding#name BotprofileBlacklistBinding#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_blacklist_binding citrixadc_botprofile_blacklist_binding}
*/
export class BotprofileBlacklistBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BotprofileBlacklistBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_blacklist_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_blacklist_binding citrixadc_botprofile_blacklist_binding} Resource
  *
  * @param scope The scope in which to define this construct
