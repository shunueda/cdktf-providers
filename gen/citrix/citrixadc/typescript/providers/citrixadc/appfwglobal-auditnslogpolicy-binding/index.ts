// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwglobal_auditnslogpolicy_binding
...
export interface AppfwglobalAuditnslogpolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwglobal_auditnslogpolicy_binding#gotopriorityexpression AppfwglobalAuditnslogpolicyBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwglobal_auditnslogpolicy_binding#id AppfwglobalAuditnslogpolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwglobal_auditnslogpolicy_binding#invoke AppfwglobalAuditnslogpolicyBinding#invoke}
  */
  readonly invoke?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwglobal_auditnslogpolicy_binding#labelname AppfwglobalAuditnslogpolicyBinding#labelname}
  */
  readonly labelname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwglobal_auditnslogpolicy_binding#labeltype AppfwglobalAuditnslogpolicyBinding#labeltype}
  */
  readonly labeltype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwglobal_auditnslogpolicy_binding#policyname AppfwglobalAuditnslogpolicyBinding#policyname}
  */
  readonly policyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwglobal_auditnslogpolicy_binding#priority AppfwglobalAuditnslogpolicyBinding#priority}
  */
  readonly priority: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwglobal_auditnslogpolicy_binding#state AppfwglobalAuditnslogpolicyBinding#state}
  */
  readonly state?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwglobal_auditnslogpolicy_binding#type AppfwglobalAuditnslogpolicyBinding#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwglobal_auditnslogpolicy_binding citrixadc_appfwglobal_auditnslogpolicy_binding}
*/
export class AppfwglobalAuditnslogpolicyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppfwglobalAuditnslogpolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwglobal_auditnslogpolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwglobal_auditnslogpolicy_binding citrixadc_appfwglobal_auditnslogpolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
