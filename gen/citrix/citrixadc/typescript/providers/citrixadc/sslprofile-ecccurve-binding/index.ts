// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_ecccurve_binding
...
export interface SslprofileEcccurveBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_ecccurve_binding#ecccurvename SslprofileEcccurveBinding#ecccurvename}
  */
  readonly ecccurvename: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_ecccurve_binding#id SslprofileEcccurveBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_ecccurve_binding#name SslprofileEcccurveBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_ecccurve_binding#remove_existing_ecccurve_binding SslprofileEcccurveBinding#remove_existing_ecccurve_binding}
  */
  readonly removeExistingEcccurveBinding: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_ecccurve_binding citrixadc_sslprofile_ecccurve_binding}
*/
export class SslprofileEcccurveBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslprofileEcccurveBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_ecccurve_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_ecccurve_binding citrixadc_sslprofile_ecccurve_binding} Resource
  *
  * @param scope The scope in which to define this construct
