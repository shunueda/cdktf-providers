// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nstrafficdomain_bridgegroup_binding
...
export interface NstrafficdomainBridgegroupBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nstrafficdomain_bridgegroup_binding#bridgegroup NstrafficdomainBridgegroupBinding#bridgegroup}
  */
  readonly bridgegroup: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nstrafficdomain_bridgegroup_binding#id NstrafficdomainBridgegroupBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nstrafficdomain_bridgegroup_binding#td NstrafficdomainBridgegroupBinding#td}
  */
  readonly td: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nstrafficdomain_bridgegroup_binding citrixadc_nstrafficdomain_bridgegroup_binding}
*/
export class NstrafficdomainBridgegroupBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NstrafficdomainBridgegroupBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nstrafficdomain_bridgegroup_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nstrafficdomain_bridgegroup_binding citrixadc_nstrafficdomain_bridgegroup_binding} Resource
  *
  * @param scope The scope in which to define this construct
