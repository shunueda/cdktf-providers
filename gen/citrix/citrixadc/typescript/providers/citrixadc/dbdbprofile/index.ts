// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/dbdbprofile
...
export interface DbdbprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/dbdbprofile#conmultiplex Dbdbprofile#conmultiplex}
  */
  readonly conmultiplex?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/dbdbprofile#enablecachingconmuxoff Dbdbprofile#enablecachingconmuxoff}
  */
  readonly enablecachingconmuxoff?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/dbdbprofile#id Dbdbprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/dbdbprofile#interpretquery Dbdbprofile#interpretquery}
  */
  readonly interpretquery?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/dbdbprofile#kcdaccount Dbdbprofile#kcdaccount}
  */
  readonly kcdaccount?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/dbdbprofile#name Dbdbprofile#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/dbdbprofile#stickiness Dbdbprofile#stickiness}
  */
  readonly stickiness?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/dbdbprofile citrixadc_dbdbprofile}
*/
export class Dbdbprofile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Dbdbprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/dbdbprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/dbdbprofile citrixadc_dbdbprofile} Resource
  *
  * @param scope The scope in which to define this construct
