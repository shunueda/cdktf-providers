// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/radiusnode
...
export interface RadiusnodeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/radiusnode#id Radiusnode#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/radiusnode#nodeprefix Radiusnode#nodeprefix}
  */
  readonly nodeprefix: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/radiusnode#radkey Radiusnode#radkey}
  */
  readonly radkey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/radiusnode citrixadc_radiusnode}
*/
export class Radiusnode extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Radiusnode that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/radiusnode#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/radiusnode citrixadc_radiusnode} Resource
  *
  * @param scope The scope in which to define this construct
