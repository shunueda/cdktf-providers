// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vlan_channel_binding
...
export interface VlanChannelBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vlan_channel_binding#id VlanChannelBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vlan_channel_binding#ifnum VlanChannelBinding#ifnum}
  */
  readonly ifnum: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vlan_channel_binding#ownergroup VlanChannelBinding#ownergroup}
  */
  readonly ownergroup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vlan_channel_binding#tagged VlanChannelBinding#tagged}
  */
  readonly tagged?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vlan_channel_binding#vlanid VlanChannelBinding#vlanid}
  */
  readonly vlanid: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vlan_channel_binding citrixadc_vlan_channel_binding}
*/
export class VlanChannelBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VlanChannelBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vlan_channel_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vlan_channel_binding citrixadc_vlan_channel_binding} Resource
  *
  * @param scope The scope in which to define this construct
