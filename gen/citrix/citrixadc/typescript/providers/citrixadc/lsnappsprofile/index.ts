// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnappsprofile
...
export interface LsnappsprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnappsprofile#appsprofilename Lsnappsprofile#appsprofilename}
  */
  readonly appsprofilename: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnappsprofile#filtering Lsnappsprofile#filtering}
  */
  readonly filtering?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnappsprofile#id Lsnappsprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnappsprofile#ippooling Lsnappsprofile#ippooling}
  */
  readonly ippooling?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnappsprofile#l2info Lsnappsprofile#l2info}
  */
  readonly l2Info?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnappsprofile#mapping Lsnappsprofile#mapping}
  */
  readonly mapping?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnappsprofile#tcpproxy Lsnappsprofile#tcpproxy}
  */
  readonly tcpproxy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnappsprofile#td Lsnappsprofile#td}
  */
  readonly td?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnappsprofile#transportprotocol Lsnappsprofile#transportprotocol}
  */
  readonly transportprotocol: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnappsprofile citrixadc_lsnappsprofile}
*/
export class Lsnappsprofile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lsnappsprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnappsprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnappsprofile citrixadc_lsnappsprofile} Resource
  *
  * @param scope The scope in which to define this construct
