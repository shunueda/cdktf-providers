// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_vpnnexthopserver_binding
...
export interface VpnvserverVpnnexthopserverBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_vpnnexthopserver_binding#id VpnvserverVpnnexthopserverBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_vpnnexthopserver_binding#name VpnvserverVpnnexthopserverBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_vpnnexthopserver_binding#nexthopserver VpnvserverVpnnexthopserverBinding#nexthopserver}
  */
  readonly nexthopserver: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_vpnnexthopserver_binding citrixadc_vpnvserver_vpnnexthopserver_binding}
*/
export class VpnvserverVpnnexthopserverBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnvserverVpnnexthopserverBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_vpnnexthopserver_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_vpnnexthopserver_binding citrixadc_vpnvserver_vpnnexthopserver_binding} Resource
  *
  * @param scope The scope in which to define this construct
