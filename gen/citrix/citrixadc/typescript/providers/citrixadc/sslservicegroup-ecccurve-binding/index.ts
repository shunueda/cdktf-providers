// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslservicegroup_ecccurve_binding
...
export interface SslservicegroupEcccurveBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslservicegroup_ecccurve_binding#ecccurvename SslservicegroupEcccurveBinding#ecccurvename}
  */
  readonly ecccurvename: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslservicegroup_ecccurve_binding#id SslservicegroupEcccurveBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslservicegroup_ecccurve_binding#servicegroupname SslservicegroupEcccurveBinding#servicegroupname}
  */
  readonly servicegroupname: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslservicegroup_ecccurve_binding citrixadc_sslservicegroup_ecccurve_binding}
*/
export class SslservicegroupEcccurveBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslservicegroupEcccurveBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslservicegroup_ecccurve_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslservicegroup_ecccurve_binding citrixadc_sslservicegroup_ecccurve_binding} Resource
  *
  * @param scope The scope in which to define this construct
