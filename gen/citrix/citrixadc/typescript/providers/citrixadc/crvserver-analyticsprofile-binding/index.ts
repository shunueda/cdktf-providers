// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/crvserver_analyticsprofile_binding
...
export interface CrvserverAnalyticsprofileBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/crvserver_analyticsprofile_binding#analyticsprofile CrvserverAnalyticsprofileBinding#analyticsprofile}
  */
  readonly analyticsprofile?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/crvserver_analyticsprofile_binding#id CrvserverAnalyticsprofileBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/crvserver_analyticsprofile_binding#name CrvserverAnalyticsprofileBinding#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/crvserver_analyticsprofile_binding citrixadc_crvserver_analyticsprofile_binding}
*/
export class CrvserverAnalyticsprofileBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CrvserverAnalyticsprofileBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/crvserver_analyticsprofile_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/crvserver_analyticsprofile_binding citrixadc_crvserver_analyticsprofile_binding} Resource
  *
  * @param scope The scope in which to define this construct
