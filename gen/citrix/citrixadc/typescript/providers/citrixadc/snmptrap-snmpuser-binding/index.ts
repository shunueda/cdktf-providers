// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/snmptrap_snmpuser_binding
...
export interface SnmptrapSnmpuserBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/snmptrap_snmpuser_binding#id SnmptrapSnmpuserBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/snmptrap_snmpuser_binding#securitylevel SnmptrapSnmpuserBinding#securitylevel}
  */
  readonly securitylevel?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/snmptrap_snmpuser_binding#td SnmptrapSnmpuserBinding#td}
  */
  readonly td?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/snmptrap_snmpuser_binding#trapclass SnmptrapSnmpuserBinding#trapclass}
  */
  readonly trapclass: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/snmptrap_snmpuser_binding#trapdestination SnmptrapSnmpuserBinding#trapdestination}
  */
  readonly trapdestination: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/snmptrap_snmpuser_binding#username SnmptrapSnmpuserBinding#username}
  */
  readonly username: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/snmptrap_snmpuser_binding#version SnmptrapSnmpuserBinding#version}
  */
  readonly version?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/snmptrap_snmpuser_binding citrixadc_snmptrap_snmpuser_binding}
*/
export class SnmptrapSnmpuserBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnmptrapSnmpuserBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/snmptrap_snmpuser_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/snmptrap_snmpuser_binding citrixadc_snmptrap_snmpuser_binding} Resource
  *
  * @param scope The scope in which to define this construct
