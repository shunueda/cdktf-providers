// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemgroup_nspartition_binding
...
export interface SystemgroupNspartitionBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemgroup_nspartition_binding#groupname SystemgroupNspartitionBinding#groupname}
  */
  readonly groupname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemgroup_nspartition_binding#id SystemgroupNspartitionBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemgroup_nspartition_binding#partitionname SystemgroupNspartitionBinding#partitionname}
  */
  readonly partitionname: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemgroup_nspartition_binding citrixadc_systemgroup_nspartition_binding}
*/
export class SystemgroupNspartitionBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemgroupNspartitionBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemgroup_nspartition_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemgroup_nspartition_binding citrixadc_systemgroup_nspartition_binding} Resource
  *
  * @param scope The scope in which to define this construct
