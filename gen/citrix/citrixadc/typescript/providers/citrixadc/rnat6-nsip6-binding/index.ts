// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat6_nsip6_binding
...
export interface Rnat6Nsip6BindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat6_nsip6_binding#id Rnat6Nsip6Binding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat6_nsip6_binding#name Rnat6Nsip6Binding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat6_nsip6_binding#natip6 Rnat6Nsip6Binding#natip6}
  */
  readonly natip6: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat6_nsip6_binding#ownergroup Rnat6Nsip6Binding#ownergroup}
  */
  readonly ownergroup?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat6_nsip6_binding citrixadc_rnat6_nsip6_binding}
*/
export class Rnat6Nsip6Binding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Rnat6Nsip6Binding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat6_nsip6_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat6_nsip6_binding citrixadc_rnat6_nsip6_binding} Resource
  *
  * @param scope The scope in which to define this construct
