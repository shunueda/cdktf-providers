// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnszone
...
export interface DnszoneConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnszone#dnssecoffload Dnszone#dnssecoffload}
  */
  readonly dnssecoffload?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnszone#id Dnszone#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnszone#keyname Dnszone#keyname}
  */
  readonly keyname?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnszone#nsec Dnszone#nsec}
  */
  readonly nsec?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnszone#proxymode Dnszone#proxymode}
  */
  readonly proxymode: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnszone#type Dnszone#type}
  */
  readonly type?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnszone#zonename Dnszone#zonename}
  */
  readonly zonename: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnszone citrixadc_dnszone}
*/
export class Dnszone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Dnszone that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnszone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnszone citrixadc_dnszone} Resource
  *
  * @param scope The scope in which to define this construct
