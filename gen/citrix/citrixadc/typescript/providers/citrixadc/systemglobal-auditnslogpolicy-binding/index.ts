// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systemglobal_auditnslogpolicy_binding
...
export interface SystemglobalAuditnslogpolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systemglobal_auditnslogpolicy_binding#builtin SystemglobalAuditnslogpolicyBinding#builtin}
  */
  readonly builtin?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systemglobal_auditnslogpolicy_binding#feature SystemglobalAuditnslogpolicyBinding#feature}
  */
  readonly feature?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systemglobal_auditnslogpolicy_binding#globalbindtype SystemglobalAuditnslogpolicyBinding#globalbindtype}
  */
  readonly globalbindtype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systemglobal_auditnslogpolicy_binding#gotopriorityexpression SystemglobalAuditnslogpolicyBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systemglobal_auditnslogpolicy_binding#id SystemglobalAuditnslogpolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systemglobal_auditnslogpolicy_binding#nextfactor SystemglobalAuditnslogpolicyBinding#nextfactor}
  */
  readonly nextfactor?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systemglobal_auditnslogpolicy_binding#policyname SystemglobalAuditnslogpolicyBinding#policyname}
  */
  readonly policyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systemglobal_auditnslogpolicy_binding#priority SystemglobalAuditnslogpolicyBinding#priority}
  */
  readonly priority: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systemglobal_auditnslogpolicy_binding citrixadc_systemglobal_auditnslogpolicy_binding}
*/
export class SystemglobalAuditnslogpolicyBinding extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "citrixadc_systemglobal_auditnslogpolicy_binding";
  ...
  * @param importFromId The id of the existing SystemglobalAuditnslogpolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systemglobal_auditnslogpolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "citrixadc_systemglobal_auditnslogpolicy_binding", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systemglobal_auditnslogpolicy_binding citrixadc_systemglobal_auditnslogpolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options SystemglobalAuditnslogpolicyBindingConfig
  */
  public constructor(scope: Construct, id: string, config: SystemglobalAuditnslogpolicyBindingConfig) {
    super(scope, id, {
