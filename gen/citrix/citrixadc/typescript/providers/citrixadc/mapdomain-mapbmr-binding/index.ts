// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/mapdomain_mapbmr_binding
...
export interface MapdomainMapbmrBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/mapdomain_mapbmr_binding#id MapdomainMapbmrBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/mapdomain_mapbmr_binding#mapbmrname MapdomainMapbmrBinding#mapbmrname}
  */
  readonly mapbmrname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/mapdomain_mapbmr_binding#name MapdomainMapbmrBinding#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/mapdomain_mapbmr_binding citrixadc_mapdomain_mapbmr_binding}
*/
export class MapdomainMapbmrBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MapdomainMapbmrBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/mapdomain_mapbmr_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/mapdomain_mapbmr_binding citrixadc_mapdomain_mapbmr_binding} Resource
  *
  * @param scope The scope in which to define this construct
