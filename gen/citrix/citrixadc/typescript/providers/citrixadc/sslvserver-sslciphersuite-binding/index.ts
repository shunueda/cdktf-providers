// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslvserver_sslciphersuite_binding
...
export interface SslvserverSslciphersuiteBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslvserver_sslciphersuite_binding#ciphername SslvserverSslciphersuiteBinding#ciphername}
  */
  readonly ciphername: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslvserver_sslciphersuite_binding#description SslvserverSslciphersuiteBinding#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslvserver_sslciphersuite_binding#id SslvserverSslciphersuiteBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslvserver_sslciphersuite_binding#vservername SslvserverSslciphersuiteBinding#vservername}
  */
  readonly vservername: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslvserver_sslciphersuite_binding citrixadc_sslvserver_sslciphersuite_binding}
*/
export class SslvserverSslciphersuiteBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslvserverSslciphersuiteBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslvserver_sslciphersuite_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslvserver_sslciphersuite_binding citrixadc_sslvserver_sslciphersuite_binding} Resource
  *
  * @param scope The scope in which to define this construct
