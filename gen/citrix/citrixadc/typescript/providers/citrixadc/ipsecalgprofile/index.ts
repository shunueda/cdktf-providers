// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/ipsecalgprofile
...
export interface IpsecalgprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/ipsecalgprofile#connfailover Ipsecalgprofile#connfailover}
  */
  readonly connfailover?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/ipsecalgprofile#espgatetimeout Ipsecalgprofile#espgatetimeout}
  */
  readonly espgatetimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/ipsecalgprofile#espsessiontimeout Ipsecalgprofile#espsessiontimeout}
  */
  readonly espsessiontimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/ipsecalgprofile#id Ipsecalgprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/ipsecalgprofile#ikesessiontimeout Ipsecalgprofile#ikesessiontimeout}
  */
  readonly ikesessiontimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/ipsecalgprofile#name Ipsecalgprofile#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/ipsecalgprofile citrixadc_ipsecalgprofile}
*/
export class Ipsecalgprofile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ipsecalgprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/ipsecalgprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/ipsecalgprofile citrixadc_ipsecalgprofile} Resource
  *
  * @param scope The scope in which to define this construct
