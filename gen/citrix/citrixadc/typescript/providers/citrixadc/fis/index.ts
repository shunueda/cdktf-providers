// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/fis
...
export interface FisConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/fis#id Fis#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/fis#name Fis#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/fis#ownernode Fis#ownernode}
  */
  readonly ownernode?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/fis citrixadc_fis}
*/
export class Fis extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Fis that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/fis#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/fis citrixadc_fis} Resource
  *
  * @param scope The scope in which to define this construct
