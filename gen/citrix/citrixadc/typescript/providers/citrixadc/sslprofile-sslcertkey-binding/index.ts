// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcertkey_binding
...
export interface SslprofileSslcertkeyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcertkey_binding#cipherpriority SslprofileSslcertkeyBinding#cipherpriority}
  */
  readonly cipherpriority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcertkey_binding#id SslprofileSslcertkeyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcertkey_binding#name SslprofileSslcertkeyBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcertkey_binding#sslicacertkey SslprofileSslcertkeyBinding#sslicacertkey}
  */
  readonly sslicacertkey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcertkey_binding citrixadc_sslprofile_sslcertkey_binding}
*/
export class SslprofileSslcertkeyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslprofileSslcertkeyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcertkey_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcertkey_binding citrixadc_sslprofile_sslcertkey_binding} Resource
  *
  * @param scope The scope in which to define this construct
