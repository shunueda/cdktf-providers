// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/interfacepair
...
export interface InterfacepairConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/interfacepair#id Interfacepair#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/interfacepair#ifnum Interfacepair#ifnum}
  */
  readonly ifnum: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/interfacepair#interface_id Interfacepair#interface_id}
  */
  readonly interfaceId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/interfacepair citrixadc_interfacepair}
*/
export class Interfacepair extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Interfacepair that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/interfacepair#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/interfacepair citrixadc_interfacepair} Resource
  *
  * @param scope The scope in which to define this construct
