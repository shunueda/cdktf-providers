// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_logexpression_binding
...
export interface BotprofileLogexpressionBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_logexpression_binding#bot_bind_comment BotprofileLogexpressionBinding#bot_bind_comment}
  */
  readonly botBindComment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_logexpression_binding#bot_log_expression_enabled BotprofileLogexpressionBinding#bot_log_expression_enabled}
  */
  readonly botLogExpressionEnabled?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_logexpression_binding#bot_log_expression_name BotprofileLogexpressionBinding#bot_log_expression_name}
  */
  readonly botLogExpressionName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_logexpression_binding#bot_log_expression_value BotprofileLogexpressionBinding#bot_log_expression_value}
  */
  readonly botLogExpressionValue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_logexpression_binding#id BotprofileLogexpressionBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_logexpression_binding#logexpression BotprofileLogexpressionBinding#logexpression}
  */
  readonly logexpression?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_logexpression_binding#logmessage BotprofileLogexpressionBinding#logmessage}
  */
  readonly logmessage?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_logexpression_binding#name BotprofileLogexpressionBinding#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_logexpression_binding citrixadc_botprofile_logexpression_binding}
*/
export class BotprofileLogexpressionBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BotprofileLogexpressionBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_logexpression_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/botprofile_logexpression_binding citrixadc_botprofile_logexpression_binding} Resource
  *
  * @param scope The scope in which to define this construct
