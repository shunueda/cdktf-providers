// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_staserver_binding
...
export interface VpnvserverStaserverBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_staserver_binding#id VpnvserverStaserverBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_staserver_binding#name VpnvserverStaserverBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_staserver_binding#staaddresstype VpnvserverStaserverBinding#staaddresstype}
  */
  readonly staaddresstype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_staserver_binding#staserver VpnvserverStaserverBinding#staserver}
  */
  readonly staserver: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_staserver_binding citrixadc_vpnvserver_staserver_binding}
*/
export class VpnvserverStaserverBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnvserverStaserverBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_staserver_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_staserver_binding citrixadc_vpnvserver_staserver_binding} Resource
  *
  * @param scope The scope in which to define this construct
