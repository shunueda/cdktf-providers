// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/smppparam
...
export interface SmppparamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/smppparam#addrnpi Smppparam#addrnpi}
  */
  readonly addrnpi?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/smppparam#addrrange Smppparam#addrrange}
  */
  readonly addrrange?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/smppparam#addrton Smppparam#addrton}
  */
  readonly addrton?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/smppparam#clientmode Smppparam#clientmode}
  */
  readonly clientmode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/smppparam#id Smppparam#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/smppparam#msgqueue Smppparam#msgqueue}
  */
  readonly msgqueue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/smppparam#msgqueuesize Smppparam#msgqueuesize}
  */
  readonly msgqueuesize?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/smppparam citrixadc_smppparam}
*/
export class Smppparam extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Smppparam that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/smppparam#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/smppparam citrixadc_smppparam} Resource
  *
  * @param scope The scope in which to define this construct
