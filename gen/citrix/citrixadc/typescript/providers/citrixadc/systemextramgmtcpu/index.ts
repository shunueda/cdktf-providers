// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemextramgmtcpu
...
export interface SystemextramgmtcpuConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemextramgmtcpu#enabled Systemextramgmtcpu#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemextramgmtcpu#id Systemextramgmtcpu#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemextramgmtcpu#reachable_poll_delay Systemextramgmtcpu#reachable_poll_delay}
  */
  readonly reachablePollDelay?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemextramgmtcpu#reachable_poll_interval Systemextramgmtcpu#reachable_poll_interval}
  */
  readonly reachablePollInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemextramgmtcpu#reachable_poll_timeout Systemextramgmtcpu#reachable_poll_timeout}
  */
  readonly reachablePollTimeout?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemextramgmtcpu#reachable_timeout Systemextramgmtcpu#reachable_timeout}
  */
  readonly reachableTimeout?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemextramgmtcpu#reboot Systemextramgmtcpu#reboot}
  */
  readonly reboot?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemextramgmtcpu citrixadc_systemextramgmtcpu}
*/
export class Systemextramgmtcpu extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Systemextramgmtcpu that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemextramgmtcpu#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/systemextramgmtcpu citrixadc_systemextramgmtcpu} Resource
  *
  * @param scope The scope in which to define this construct
