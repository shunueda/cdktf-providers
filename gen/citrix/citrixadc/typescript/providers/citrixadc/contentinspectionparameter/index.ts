// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/contentinspectionparameter
...
export interface ContentinspectionparameterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/contentinspectionparameter#id Contentinspectionparameter#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/contentinspectionparameter#undefaction Contentinspectionparameter#undefaction}
  */
  readonly undefaction?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/contentinspectionparameter citrixadc_contentinspectionparameter}
*/
export class Contentinspectionparameter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Contentinspectionparameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/contentinspectionparameter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/contentinspectionparameter citrixadc_contentinspectionparameter} Resource
  *
  * @param scope The scope in which to define this construct
