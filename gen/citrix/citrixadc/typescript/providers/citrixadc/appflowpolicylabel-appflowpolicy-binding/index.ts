// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appflowpolicylabel_appflowpolicy_binding
...
export interface AppflowpolicylabelAppflowpolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appflowpolicylabel_appflowpolicy_binding#gotopriorityexpression AppflowpolicylabelAppflowpolicyBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appflowpolicylabel_appflowpolicy_binding#id AppflowpolicylabelAppflowpolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appflowpolicylabel_appflowpolicy_binding#invoke AppflowpolicylabelAppflowpolicyBinding#invoke}
  */
  readonly invoke?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appflowpolicylabel_appflowpolicy_binding#invokelabelname AppflowpolicylabelAppflowpolicyBinding#invokelabelname}
  */
  readonly invokelabelname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appflowpolicylabel_appflowpolicy_binding#labelname AppflowpolicylabelAppflowpolicyBinding#labelname}
  */
  readonly labelname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appflowpolicylabel_appflowpolicy_binding#labeltype AppflowpolicylabelAppflowpolicyBinding#labeltype}
  */
  readonly labeltype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appflowpolicylabel_appflowpolicy_binding#policyname AppflowpolicylabelAppflowpolicyBinding#policyname}
  */
  readonly policyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appflowpolicylabel_appflowpolicy_binding#priority AppflowpolicylabelAppflowpolicyBinding#priority}
  */
  readonly priority?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appflowpolicylabel_appflowpolicy_binding citrixadc_appflowpolicylabel_appflowpolicy_binding}
*/
export class AppflowpolicylabelAppflowpolicyBinding extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "citrixadc_appflowpolicylabel_appflowpolicy_binding";
  ...
  * @param importFromId The id of the existing AppflowpolicylabelAppflowpolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appflowpolicylabel_appflowpolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "citrixadc_appflowpolicylabel_appflowpolicy_binding", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appflowpolicylabel_appflowpolicy_binding citrixadc_appflowpolicylabel_appflowpolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AppflowpolicylabelAppflowpolicyBindingConfig
  */
  public constructor(scope: Construct, id: string, config: AppflowpolicylabelAppflowpolicyBindingConfig) {
    super(scope, id, {
