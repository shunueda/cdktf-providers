// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vxlanvlanmap_vxlan_binding
...
export interface VxlanvlanmapVxlanBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vxlanvlanmap_vxlan_binding#id VxlanvlanmapVxlanBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vxlanvlanmap_vxlan_binding#name VxlanvlanmapVxlanBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vxlanvlanmap_vxlan_binding#vlan VxlanvlanmapVxlanBinding#vlan}
  */
  readonly vlan?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vxlanvlanmap_vxlan_binding#vxlan VxlanvlanmapVxlanBinding#vxlan}
  */
  readonly vxlan: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vxlanvlanmap_vxlan_binding citrixadc_vxlanvlanmap_vxlan_binding}
*/
export class VxlanvlanmapVxlanBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VxlanvlanmapVxlanBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vxlanvlanmap_vxlan_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vxlanvlanmap_vxlan_binding citrixadc_vxlanvlanmap_vxlan_binding} Resource
  *
  * @param scope The scope in which to define this construct
