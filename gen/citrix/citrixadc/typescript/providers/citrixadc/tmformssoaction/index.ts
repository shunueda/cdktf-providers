// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/tmformssoaction
...
export interface TmformssoactionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/tmformssoaction#actionurl Tmformssoaction#actionurl}
  */
  readonly actionurl: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/tmformssoaction#id Tmformssoaction#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/tmformssoaction#name Tmformssoaction#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/tmformssoaction#namevaluepair Tmformssoaction#namevaluepair}
  */
  readonly namevaluepair?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/tmformssoaction#nvtype Tmformssoaction#nvtype}
  */
  readonly nvtype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/tmformssoaction#passwdfield Tmformssoaction#passwdfield}
  */
  readonly passwdfield: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/tmformssoaction#responsesize Tmformssoaction#responsesize}
  */
  readonly responsesize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/tmformssoaction#ssosuccessrule Tmformssoaction#ssosuccessrule}
  */
  readonly ssosuccessrule: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/tmformssoaction#submitmethod Tmformssoaction#submitmethod}
  */
  readonly submitmethod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/tmformssoaction#userfield Tmformssoaction#userfield}
  */
  readonly userfield: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/tmformssoaction citrixadc_tmformssoaction}
*/
export class Tmformssoaction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Tmformssoaction that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/tmformssoaction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/tmformssoaction citrixadc_tmformssoaction} Resource
  *
  * @param scope The scope in which to define this construct
