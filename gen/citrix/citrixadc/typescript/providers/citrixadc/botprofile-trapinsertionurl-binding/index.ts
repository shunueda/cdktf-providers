// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_trapinsertionurl_binding
...
export interface BotprofileTrapinsertionurlBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_trapinsertionurl_binding#bot_bind_comment BotprofileTrapinsertionurlBinding#bot_bind_comment}
  */
  readonly botBindComment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_trapinsertionurl_binding#bot_trap_url BotprofileTrapinsertionurlBinding#bot_trap_url}
  */
  readonly botTrapUrl: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_trapinsertionurl_binding#bot_trap_url_insertion_enabled BotprofileTrapinsertionurlBinding#bot_trap_url_insertion_enabled}
  */
  readonly botTrapUrlInsertionEnabled?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_trapinsertionurl_binding#id BotprofileTrapinsertionurlBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_trapinsertionurl_binding#logmessage BotprofileTrapinsertionurlBinding#logmessage}
  */
  readonly logmessage?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_trapinsertionurl_binding#name BotprofileTrapinsertionurlBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_trapinsertionurl_binding#trapinsertionurl BotprofileTrapinsertionurlBinding#trapinsertionurl}
  */
  readonly trapinsertionurl?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_trapinsertionurl_binding citrixadc_botprofile_trapinsertionurl_binding}
*/
export class BotprofileTrapinsertionurlBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BotprofileTrapinsertionurlBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_trapinsertionurl_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_trapinsertionurl_binding citrixadc_botprofile_trapinsertionurl_binding} Resource
  *
  * @param scope The scope in which to define this construct
