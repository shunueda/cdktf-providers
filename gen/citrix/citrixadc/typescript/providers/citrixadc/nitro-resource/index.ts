// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nitro_resource
...
export interface NitroResourceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nitro_resource#attributes NitroResource#attributes}
  */
  readonly attributes?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nitro_resource#id NitroResource#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nitro_resource#non_updateable_attributes NitroResource#non_updateable_attributes}
  */
  readonly nonUpdateableAttributes?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nitro_resource#workflow NitroResource#workflow}
  */
  readonly workflow: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nitro_resource#workflows_file NitroResource#workflows_file}
  */
  readonly workflowsFile: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nitro_resource citrixadc_nitro_resource}
*/
export class NitroResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NitroResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nitro_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nitro_resource citrixadc_nitro_resource} Resource
  *
  * @param scope The scope in which to define this construct
