// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat_clear
...
export interface RnatClearConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat_clear#id RnatClear#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat_clear#rnatsname RnatClear#rnatsname}
  */
  readonly rnatsname?: string;
  /**
  * rnat block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat_clear#rnat RnatClear#rnat}
  */
  readonly rnat?: RnatClearRnat[] | cdktf.IResolvable;
}
export interface RnatClearRnat {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat_clear#aclname RnatClear#aclname}
  */
  readonly aclname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat_clear#natip RnatClear#natip}
  */
  readonly natip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat_clear#natip2 RnatClear#natip2}
  */
  readonly natip2?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat_clear#netmask RnatClear#netmask}
  */
  readonly netmask?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat_clear#network RnatClear#network}
  */
  readonly network?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat_clear#redirectport RnatClear#redirectport}
  */
  readonly redirectport?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat_clear#td RnatClear#td}
  */
  readonly td?: number;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat_clear citrixadc_rnat_clear}
*/
export class RnatClear extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RnatClear that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat_clear#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rnat_clear citrixadc_rnat_clear} Resource
  *
  * @param scope The scope in which to define this construct
