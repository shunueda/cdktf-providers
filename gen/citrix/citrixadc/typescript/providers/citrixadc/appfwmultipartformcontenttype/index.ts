// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwmultipartformcontenttype
...
export interface AppfwmultipartformcontenttypeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwmultipartformcontenttype#id Appfwmultipartformcontenttype#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwmultipartformcontenttype#isregex Appfwmultipartformcontenttype#isregex}
  */
  readonly isregex?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwmultipartformcontenttype#multipartformcontenttypevalue Appfwmultipartformcontenttype#multipartformcontenttypevalue}
  */
  readonly multipartformcontenttypevalue: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwmultipartformcontenttype citrixadc_appfwmultipartformcontenttype}
*/
export class Appfwmultipartformcontenttype extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Appfwmultipartformcontenttype that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwmultipartformcontenttype#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appfwmultipartformcontenttype citrixadc_appfwmultipartformcontenttype} Resource
  *
  * @param scope The scope in which to define this construct
