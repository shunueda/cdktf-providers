// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/systembackup_restore
...
export interface SystembackupRestoreConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/systembackup_restore#filename SystembackupRestore#filename}
  */
  readonly filename: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/systembackup_restore#id SystembackupRestore#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/systembackup_restore#skipbackup SystembackupRestore#skipbackup}
  */
  readonly skipbackup?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/systembackup_restore citrixadc_systembackup_restore}
*/
export class SystembackupRestore extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystembackupRestore that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/systembackup_restore#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/systembackup_restore citrixadc_systembackup_restore} Resource
  *
  * @param scope The scope in which to define this construct
