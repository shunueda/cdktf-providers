// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaauser_vpnurl_binding
...
export interface AaauserVpnurlBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaauser_vpnurl_binding#gotopriorityexpression AaauserVpnurlBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaauser_vpnurl_binding#id AaauserVpnurlBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaauser_vpnurl_binding#urlname AaauserVpnurlBinding#urlname}
  */
  readonly urlname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaauser_vpnurl_binding#username AaauserVpnurlBinding#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaauser_vpnurl_binding citrixadc_aaauser_vpnurl_binding}
*/
export class AaauserVpnurlBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AaauserVpnurlBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaauser_vpnurl_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaauser_vpnurl_binding citrixadc_aaauser_vpnurl_binding} Resource
  *
  * @param scope The scope in which to define this construct
