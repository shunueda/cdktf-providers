// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/iptunnelparam
...
export interface IptunnelparamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/iptunnelparam#dropfrag Iptunnelparam#dropfrag}
  */
  readonly dropfrag?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/iptunnelparam#dropfragcputhreshold Iptunnelparam#dropfragcputhreshold}
  */
  readonly dropfragcputhreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/iptunnelparam#enablestrictrx Iptunnelparam#enablestrictrx}
  */
  readonly enablestrictrx?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/iptunnelparam#enablestricttx Iptunnelparam#enablestricttx}
  */
  readonly enablestricttx?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/iptunnelparam#id Iptunnelparam#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/iptunnelparam#mac Iptunnelparam#mac}
  */
  readonly mac?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/iptunnelparam#srcip Iptunnelparam#srcip}
  */
  readonly srcip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/iptunnelparam#srciproundrobin Iptunnelparam#srciproundrobin}
  */
  readonly srciproundrobin?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/iptunnelparam#useclientsourceip Iptunnelparam#useclientsourceip}
  */
  readonly useclientsourceip?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/iptunnelparam citrixadc_iptunnelparam}
*/
export class Iptunnelparam extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Iptunnelparam that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/iptunnelparam#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/iptunnelparam citrixadc_iptunnelparam} Resource
  *
  * @param scope The scope in which to define this construct
