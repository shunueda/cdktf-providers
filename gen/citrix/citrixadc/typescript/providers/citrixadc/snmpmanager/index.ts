// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpmanager
...
export interface SnmpmanagerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpmanager#domainresolveretry Snmpmanager#domainresolveretry}
  */
  readonly domainresolveretry?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpmanager#id Snmpmanager#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpmanager#ipaddress Snmpmanager#ipaddress}
  */
  readonly ipaddress: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpmanager#netmask Snmpmanager#netmask}
  */
  readonly netmask?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpmanager citrixadc_snmpmanager}
*/
export class Snmpmanager extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Snmpmanager that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpmanager#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpmanager citrixadc_snmpmanager} Resource
  *
  * @param scope The scope in which to define this construct
