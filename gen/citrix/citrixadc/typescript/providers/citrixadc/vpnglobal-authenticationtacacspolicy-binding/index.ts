// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_authenticationtacacspolicy_binding
...
export interface VpnglobalAuthenticationtacacspolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_authenticationtacacspolicy_binding#gotopriorityexpression VpnglobalAuthenticationtacacspolicyBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_authenticationtacacspolicy_binding#groupextraction VpnglobalAuthenticationtacacspolicyBinding#groupextraction}
  */
  readonly groupextraction?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_authenticationtacacspolicy_binding#id VpnglobalAuthenticationtacacspolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_authenticationtacacspolicy_binding#policyname VpnglobalAuthenticationtacacspolicyBinding#policyname}
  */
  readonly policyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_authenticationtacacspolicy_binding#priority VpnglobalAuthenticationtacacspolicyBinding#priority}
  */
  readonly priority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_authenticationtacacspolicy_binding#secondary VpnglobalAuthenticationtacacspolicyBinding#secondary}
  */
  readonly secondary?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_authenticationtacacspolicy_binding citrixadc_vpnglobal_authenticationtacacspolicy_binding}
*/
export class VpnglobalAuthenticationtacacspolicyBinding extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "citrixadc_vpnglobal_authenticationtacacspolicy_binding";
  ...
  * @param importFromId The id of the existing VpnglobalAuthenticationtacacspolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_authenticationtacacspolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "citrixadc_vpnglobal_authenticationtacacspolicy_binding", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_authenticationtacacspolicy_binding citrixadc_vpnglobal_authenticationtacacspolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options VpnglobalAuthenticationtacacspolicyBindingConfig
  */
  public constructor(scope: Construct, id: string, config: VpnglobalAuthenticationtacacspolicyBindingConfig) {
    super(scope, id, {
