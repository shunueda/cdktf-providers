// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsspparams
...
export interface NsspparamsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsspparams#basethreshold Nsspparams#basethreshold}
  */
  readonly basethreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsspparams#id Nsspparams#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsspparams#throttle Nsspparams#throttle}
  */
  readonly throttle?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsspparams citrixadc_nsspparams}
*/
export class Nsspparams extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Nsspparams that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsspparams#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsspparams citrixadc_nsspparams} Resource
  *
  * @param scope The scope in which to define this construct
