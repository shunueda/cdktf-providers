// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/netbridge
...
export interface NetbridgeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/netbridge#id Netbridge#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/netbridge#name Netbridge#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/netbridge#vxlanvlanmap Netbridge#vxlanvlanmap}
  */
  readonly vxlanvlanmap?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/netbridge citrixadc_netbridge}
*/
export class Netbridge extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Netbridge that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/netbridge#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/netbridge citrixadc_netbridge} Resource
  *
  * @param scope The scope in which to define this construct
