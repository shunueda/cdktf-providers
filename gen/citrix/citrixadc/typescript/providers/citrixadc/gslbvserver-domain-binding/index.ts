// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/gslbvserver_domain_binding
...
export interface GslbvserverDomainBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/gslbvserver_domain_binding#backupip GslbvserverDomainBinding#backupip}
  */
  readonly backupip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/gslbvserver_domain_binding#backupipflag GslbvserverDomainBinding#backupipflag}
  */
  readonly backupipflag?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/gslbvserver_domain_binding#cookiedomain GslbvserverDomainBinding#cookiedomain}
  */
  readonly cookiedomain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/gslbvserver_domain_binding#cookiedomainflag GslbvserverDomainBinding#cookiedomainflag}
  */
  readonly cookiedomainflag?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/gslbvserver_domain_binding#cookietimeout GslbvserverDomainBinding#cookietimeout}
  */
  readonly cookietimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/gslbvserver_domain_binding#domainname GslbvserverDomainBinding#domainname}
  */
  readonly domainname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/gslbvserver_domain_binding#id GslbvserverDomainBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/gslbvserver_domain_binding#name GslbvserverDomainBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/gslbvserver_domain_binding#sitedomainttl GslbvserverDomainBinding#sitedomainttl}
  */
  readonly sitedomainttl?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/gslbvserver_domain_binding#ttl GslbvserverDomainBinding#ttl}
  */
  readonly ttl?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/gslbvserver_domain_binding citrixadc_gslbvserver_domain_binding}
*/
export class GslbvserverDomainBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GslbvserverDomainBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/gslbvserver_domain_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/gslbvserver_domain_binding citrixadc_gslbvserver_domain_binding} Resource
  *
  * @param scope The scope in which to define this construct
