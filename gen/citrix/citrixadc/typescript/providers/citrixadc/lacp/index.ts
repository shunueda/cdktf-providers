// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lacp
...
export interface LacpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lacp#id Lacp#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lacp#ownernode Lacp#ownernode}
  */
  readonly ownernode?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lacp#syspriority Lacp#syspriority}
  */
  readonly syspriority: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lacp citrixadc_lacp}
*/
export class Lacp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lacp that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lacp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lacp citrixadc_lacp} Resource
  *
  * @param scope The scope in which to define this construct
