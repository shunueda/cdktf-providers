// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaauser_intranetip6_binding
...
export interface AaauserIntranetip6BindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaauser_intranetip6_binding#gotopriorityexpression AaauserIntranetip6Binding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaauser_intranetip6_binding#id AaauserIntranetip6Binding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaauser_intranetip6_binding#intranetip6 AaauserIntranetip6Binding#intranetip6}
  */
  readonly intranetip6: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaauser_intranetip6_binding#numaddr AaauserIntranetip6Binding#numaddr}
  */
  readonly numaddr?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaauser_intranetip6_binding#username AaauserIntranetip6Binding#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaauser_intranetip6_binding citrixadc_aaauser_intranetip6_binding}
*/
export class AaauserIntranetip6Binding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AaauserIntranetip6Binding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaauser_intranetip6_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaauser_intranetip6_binding citrixadc_aaauser_intranetip6_binding} Resource
  *
  * @param scope The scope in which to define this construct
