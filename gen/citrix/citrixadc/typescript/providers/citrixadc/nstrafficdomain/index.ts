// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nstrafficdomain
...
export interface NstrafficdomainConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nstrafficdomain#aliasname Nstrafficdomain#aliasname}
  */
  readonly aliasname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nstrafficdomain#id Nstrafficdomain#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nstrafficdomain#td Nstrafficdomain#td}
  */
  readonly td: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nstrafficdomain#vmac Nstrafficdomain#vmac}
  */
  readonly vmac?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nstrafficdomain citrixadc_nstrafficdomain}
*/
export class Nstrafficdomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Nstrafficdomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nstrafficdomain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nstrafficdomain citrixadc_nstrafficdomain} Resource
  *
  * @param scope The scope in which to define this construct
