// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/pcpprofile
...
export interface PcpprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/pcpprofile#announcemulticount Pcpprofile#announcemulticount}
  */
  readonly announcemulticount?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/pcpprofile#id Pcpprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/pcpprofile#mapping Pcpprofile#mapping}
  */
  readonly mapping?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/pcpprofile#maxmaplife Pcpprofile#maxmaplife}
  */
  readonly maxmaplife?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/pcpprofile#minmaplife Pcpprofile#minmaplife}
  */
  readonly minmaplife?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/pcpprofile#name Pcpprofile#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/pcpprofile#peer Pcpprofile#peer}
  */
  readonly peer?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/pcpprofile#thirdparty Pcpprofile#thirdparty}
  */
  readonly thirdparty?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/pcpprofile citrixadc_pcpprofile}
*/
export class Pcpprofile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Pcpprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/pcpprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/pcpprofile citrixadc_pcpprofile} Resource
  *
  * @param scope The scope in which to define this construct
