// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslvserver_sslcertkey_binding
...
export interface SslvserverSslcertkeyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslvserver_sslcertkey_binding#ca SslvserverSslcertkeyBinding#ca}
  */
  readonly ca?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslvserver_sslcertkey_binding#certkeyname SslvserverSslcertkeyBinding#certkeyname}
  */
  readonly certkeyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslvserver_sslcertkey_binding#crlcheck SslvserverSslcertkeyBinding#crlcheck}
  */
  readonly crlcheck?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslvserver_sslcertkey_binding#id SslvserverSslcertkeyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslvserver_sslcertkey_binding#ocspcheck SslvserverSslcertkeyBinding#ocspcheck}
  */
  readonly ocspcheck?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslvserver_sslcertkey_binding#skipcaname SslvserverSslcertkeyBinding#skipcaname}
  */
  readonly skipcaname?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslvserver_sslcertkey_binding#snicert SslvserverSslcertkeyBinding#snicert}
  */
  readonly snicert?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslvserver_sslcertkey_binding#vservername SslvserverSslcertkeyBinding#vservername}
  */
  readonly vservername: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslvserver_sslcertkey_binding citrixadc_sslvserver_sslcertkey_binding}
*/
export class SslvserverSslcertkeyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslvserverSslcertkeyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslvserver_sslcertkey_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslvserver_sslcertkey_binding citrixadc_sslvserver_sslcertkey_binding} Resource
  *
  * @param scope The scope in which to define this construct
