// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/authenticationpolicylabel_authenticationpolicy_binding
...
export interface AuthenticationpolicylabelAuthenticationpolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/authenticationpolicylabel_authenticationpolicy_binding#gotopriorityexpression AuthenticationpolicylabelAuthenticationpolicyBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/authenticationpolicylabel_authenticationpolicy_binding#id AuthenticationpolicylabelAuthenticationpolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/authenticationpolicylabel_authenticationpolicy_binding#labelname AuthenticationpolicylabelAuthenticationpolicyBinding#labelname}
  */
  readonly labelname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/authenticationpolicylabel_authenticationpolicy_binding#nextfactor AuthenticationpolicylabelAuthenticationpolicyBinding#nextfactor}
  */
  readonly nextfactor?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/authenticationpolicylabel_authenticationpolicy_binding#policyname AuthenticationpolicylabelAuthenticationpolicyBinding#policyname}
  */
  readonly policyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/authenticationpolicylabel_authenticationpolicy_binding#priority AuthenticationpolicylabelAuthenticationpolicyBinding#priority}
  */
  readonly priority: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/authenticationpolicylabel_authenticationpolicy_binding citrixadc_authenticationpolicylabel_authenticationpolicy_binding}
*/
export class AuthenticationpolicylabelAuthenticationpolicyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthenticationpolicylabelAuthenticationpolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/authenticationpolicylabel_authenticationpolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/authenticationpolicylabel_authenticationpolicy_binding citrixadc_authenticationpolicylabel_authenticationpolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
