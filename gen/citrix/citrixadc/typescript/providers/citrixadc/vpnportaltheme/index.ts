// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnportaltheme
...
export interface VpnportalthemeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnportaltheme#basetheme Vpnportaltheme#basetheme}
  */
  readonly basetheme: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnportaltheme#id Vpnportaltheme#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnportaltheme#name Vpnportaltheme#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnportaltheme citrixadc_vpnportaltheme}
*/
export class Vpnportaltheme extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Vpnportaltheme that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnportaltheme#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnportaltheme citrixadc_vpnportaltheme} Resource
  *
  * @param scope The scope in which to define this construct
