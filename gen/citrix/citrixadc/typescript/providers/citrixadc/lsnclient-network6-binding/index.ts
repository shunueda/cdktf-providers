// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_network6_binding
...
export interface LsnclientNetwork6BindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_network6_binding#clientname LsnclientNetwork6Binding#clientname}
  */
  readonly clientname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_network6_binding#id LsnclientNetwork6Binding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_network6_binding#network6 LsnclientNetwork6Binding#network6}
  */
  readonly network6: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_network6_binding#td LsnclientNetwork6Binding#td}
  */
  readonly td?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_network6_binding citrixadc_lsnclient_network6_binding}
*/
export class LsnclientNetwork6Binding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LsnclientNetwork6Binding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_network6_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_network6_binding citrixadc_lsnclient_network6_binding} Resource
  *
  * @param scope The scope in which to define this construct
