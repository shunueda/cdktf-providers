// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbvserver_analyticsprofile_binding
...
export interface LbvserverAnalyticsprofileBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbvserver_analyticsprofile_binding#analyticsprofile LbvserverAnalyticsprofileBinding#analyticsprofile}
  */
  readonly analyticsprofile: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbvserver_analyticsprofile_binding#id LbvserverAnalyticsprofileBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbvserver_analyticsprofile_binding#name LbvserverAnalyticsprofileBinding#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbvserver_analyticsprofile_binding citrixadc_lbvserver_analyticsprofile_binding}
*/
export class LbvserverAnalyticsprofileBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbvserverAnalyticsprofileBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbvserver_analyticsprofile_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbvserver_analyticsprofile_binding citrixadc_lbvserver_analyticsprofile_binding} Resource
  *
  * @param scope The scope in which to define this construct
