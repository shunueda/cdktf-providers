// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsview
...
export interface DnsviewConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsview#id Dnsview#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsview#viewname Dnsview#viewname}
  */
  readonly viewname: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsview citrixadc_dnsview}
*/
export class Dnsview extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Dnsview that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsview#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/dnsview citrixadc_dnsview} Resource
  *
  * @param scope The scope in which to define this construct
