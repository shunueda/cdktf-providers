// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nspartition_vlan_binding
...
export interface NspartitionVlanBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nspartition_vlan_binding#id NspartitionVlanBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nspartition_vlan_binding#partitionname NspartitionVlanBinding#partitionname}
  */
  readonly partitionname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nspartition_vlan_binding#vlan NspartitionVlanBinding#vlan}
  */
  readonly vlan: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nspartition_vlan_binding citrixadc_nspartition_vlan_binding}
*/
export class NspartitionVlanBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NspartitionVlanBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nspartition_vlan_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nspartition_vlan_binding citrixadc_nspartition_vlan_binding} Resource
  *
  * @param scope The scope in which to define this construct
