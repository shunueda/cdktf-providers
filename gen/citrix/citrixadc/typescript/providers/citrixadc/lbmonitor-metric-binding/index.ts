// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmonitor_metric_binding
...
export interface LbmonitorMetricBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmonitor_metric_binding#id LbmonitorMetricBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmonitor_metric_binding#metric LbmonitorMetricBinding#metric}
  */
  readonly metric: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmonitor_metric_binding#metricthreshold LbmonitorMetricBinding#metricthreshold}
  */
  readonly metricthreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmonitor_metric_binding#metricweight LbmonitorMetricBinding#metricweight}
  */
  readonly metricweight?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmonitor_metric_binding#monitorname LbmonitorMetricBinding#monitorname}
  */
  readonly monitorname: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmonitor_metric_binding citrixadc_lbmonitor_metric_binding}
*/
export class LbmonitorMetricBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbmonitorMetricBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmonitor_metric_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmonitor_metric_binding citrixadc_lbmonitor_metric_binding} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // metricweight - computed: false, optional: true, required: false
