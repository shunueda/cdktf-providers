// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnparameter
...
export interface LsnparameterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnparameter#id Lsnparameter#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnparameter#memlimit Lsnparameter#memlimit}
  */
  readonly memlimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnparameter#sessionsync Lsnparameter#sessionsync}
  */
  readonly sessionsync?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnparameter#subscrsessionremoval Lsnparameter#subscrsessionremoval}
  */
  readonly subscrsessionremoval?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnparameter citrixadc_lsnparameter}
*/
export class Lsnparameter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lsnparameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnparameter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnparameter citrixadc_lsnparameter} Resource
  *
  * @param scope The scope in which to define this construct
