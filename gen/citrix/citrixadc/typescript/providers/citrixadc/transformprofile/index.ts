// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformprofile
...
export interface TransformprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformprofile#comment Transformprofile#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformprofile#id Transformprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformprofile#name Transformprofile#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformprofile#onlytransformabsurlinbody Transformprofile#onlytransformabsurlinbody}
  */
  readonly onlytransformabsurlinbody?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformprofile#type Transformprofile#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformprofile citrixadc_transformprofile}
*/
export class Transformprofile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Transformprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformprofile citrixadc_transformprofile} Resource
  *
  * @param scope The scope in which to define this construct
