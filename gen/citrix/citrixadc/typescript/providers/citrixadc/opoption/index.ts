// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/opoption
...
export interface OpoptionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/opoption#id Opoption#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/opoption#partitionnameintrap Opoption#partitionnameintrap}
  */
  readonly partitionnameintrap?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/opoption#severityinfointrap Opoption#severityinfointrap}
  */
  readonly severityinfointrap?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/opoption#snmpset Opoption#snmpset}
  */
  readonly snmpset?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/opoption#snmptraplogging Opoption#snmptraplogging}
  */
  readonly snmptraplogging?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/opoption#snmptraplogginglevel Opoption#snmptraplogginglevel}
  */
  readonly snmptraplogginglevel?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/opoption citrixadc_opoption}
*/
export class Opoption extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Opoption that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/opoption#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/opoption citrixadc_opoption} Resource
  *
  * @param scope The scope in which to define this construct
