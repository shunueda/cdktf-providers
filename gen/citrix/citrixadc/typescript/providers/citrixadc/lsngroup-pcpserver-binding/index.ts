// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsngroup_pcpserver_binding
...
export interface LsngroupPcpserverBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsngroup_pcpserver_binding#groupname LsngroupPcpserverBinding#groupname}
  */
  readonly groupname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsngroup_pcpserver_binding#id LsngroupPcpserverBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsngroup_pcpserver_binding#pcpserver LsngroupPcpserverBinding#pcpserver}
  */
  readonly pcpserver: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsngroup_pcpserver_binding citrixadc_lsngroup_pcpserver_binding}
*/
export class LsngroupPcpserverBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LsngroupPcpserverBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsngroup_pcpserver_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsngroup_pcpserver_binding citrixadc_lsngroup_pcpserver_binding} Resource
  *
  * @param scope The scope in which to define this construct
