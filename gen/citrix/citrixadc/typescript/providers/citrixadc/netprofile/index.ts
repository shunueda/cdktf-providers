// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/netprofile
...
export interface NetprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/netprofile#id Netprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/netprofile#mbf Netprofile#mbf}
  */
  readonly mbf?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/netprofile#name Netprofile#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/netprofile#overridelsn Netprofile#overridelsn}
  */
  readonly overridelsn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/netprofile#proxyprotocol Netprofile#proxyprotocol}
  */
  readonly proxyprotocol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/netprofile#proxyprotocolaftertlshandshake Netprofile#proxyprotocolaftertlshandshake}
  */
  readonly proxyprotocolaftertlshandshake?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/netprofile#proxyprotocoltxversion Netprofile#proxyprotocoltxversion}
  */
  readonly proxyprotocoltxversion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/netprofile#srcip Netprofile#srcip}
  */
  readonly srcip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/netprofile#srcippersistency Netprofile#srcippersistency}
  */
  readonly srcippersistency?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/netprofile#td Netprofile#td}
  */
  readonly td?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/netprofile citrixadc_netprofile}
*/
export class Netprofile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Netprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/netprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/netprofile citrixadc_netprofile} Resource
  *
  * @param scope The scope in which to define this construct
