// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/service_lbmonitor_binding
...
export interface ServiceLbmonitorBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/service_lbmonitor_binding#id ServiceLbmonitorBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/service_lbmonitor_binding#monitor_name ServiceLbmonitorBinding#monitor_name}
  */
  readonly monitorName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/service_lbmonitor_binding#monstate ServiceLbmonitorBinding#monstate}
  */
  readonly monstate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/service_lbmonitor_binding#name ServiceLbmonitorBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/service_lbmonitor_binding#passive ServiceLbmonitorBinding#passive}
  */
  readonly passive?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/service_lbmonitor_binding#weight ServiceLbmonitorBinding#weight}
  */
  readonly weight?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/service_lbmonitor_binding citrixadc_service_lbmonitor_binding}
*/
export class ServiceLbmonitorBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceLbmonitorBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/service_lbmonitor_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/service_lbmonitor_binding citrixadc_service_lbmonitor_binding} Resource
  *
  * @param scope The scope in which to define this construct
