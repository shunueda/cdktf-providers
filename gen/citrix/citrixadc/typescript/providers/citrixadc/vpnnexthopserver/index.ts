// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnnexthopserver
...
export interface VpnnexthopserverConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnnexthopserver#id Vpnnexthopserver#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnnexthopserver#name Vpnnexthopserver#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnnexthopserver#nexthopfqdn Vpnnexthopserver#nexthopfqdn}
  */
  readonly nexthopfqdn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnnexthopserver#nexthopip Vpnnexthopserver#nexthopip}
  */
  readonly nexthopip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnnexthopserver#nexthopport Vpnnexthopserver#nexthopport}
  */
  readonly nexthopport: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnnexthopserver#resaddresstype Vpnnexthopserver#resaddresstype}
  */
  readonly resaddresstype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnnexthopserver#secure Vpnnexthopserver#secure}
  */
  readonly secure?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnnexthopserver citrixadc_vpnnexthopserver}
*/
export class Vpnnexthopserver extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Vpnnexthopserver that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnnexthopserver#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/vpnnexthopserver citrixadc_vpnnexthopserver} Resource
  *
  * @param scope The scope in which to define this construct
