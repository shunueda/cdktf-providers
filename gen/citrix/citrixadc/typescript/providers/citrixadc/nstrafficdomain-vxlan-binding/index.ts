// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nstrafficdomain_vxlan_binding
...
export interface NstrafficdomainVxlanBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nstrafficdomain_vxlan_binding#id NstrafficdomainVxlanBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nstrafficdomain_vxlan_binding#td NstrafficdomainVxlanBinding#td}
  */
  readonly td: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nstrafficdomain_vxlan_binding#vxlan NstrafficdomainVxlanBinding#vxlan}
  */
  readonly vxlan: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nstrafficdomain_vxlan_binding citrixadc_nstrafficdomain_vxlan_binding}
*/
export class NstrafficdomainVxlanBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NstrafficdomainVxlanBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nstrafficdomain_vxlan_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nstrafficdomain_vxlan_binding citrixadc_nstrafficdomain_vxlan_binding} Resource
  *
  * @param scope The scope in which to define this construct
