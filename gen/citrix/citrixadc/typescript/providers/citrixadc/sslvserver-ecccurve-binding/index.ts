// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslvserver_ecccurve_binding
...
export interface SslvserverEcccurveBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslvserver_ecccurve_binding#ecccurvename SslvserverEcccurveBinding#ecccurvename}
  */
  readonly ecccurvename: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslvserver_ecccurve_binding#id SslvserverEcccurveBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslvserver_ecccurve_binding#vservername SslvserverEcccurveBinding#vservername}
  */
  readonly vservername: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslvserver_ecccurve_binding citrixadc_sslvserver_ecccurve_binding}
*/
export class SslvserverEcccurveBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslvserverEcccurveBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslvserver_ecccurve_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslvserver_ecccurve_binding citrixadc_sslvserver_ecccurve_binding} Resource
  *
  * @param scope The scope in which to define this construct
