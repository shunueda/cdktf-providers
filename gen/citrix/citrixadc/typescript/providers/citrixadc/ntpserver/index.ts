// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpserver
...
export interface NtpserverConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpserver#autokey Ntpserver#autokey}
  */
  readonly autokey?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpserver#id Ntpserver#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpserver#key Ntpserver#key}
  */
  readonly key?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpserver#maxpoll Ntpserver#maxpoll}
  */
  readonly maxpoll?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpserver#minpoll Ntpserver#minpoll}
  */
  readonly minpoll?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpserver#preferredntpserver Ntpserver#preferredntpserver}
  */
  readonly preferredntpserver?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpserver#serverip Ntpserver#serverip}
  */
  readonly serverip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpserver#servername Ntpserver#servername}
  */
  readonly servername?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpserver citrixadc_ntpserver}
*/
export class Ntpserver extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ntpserver that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpserver#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpserver citrixadc_ntpserver} Resource
  *
  * @param scope The scope in which to define this construct
