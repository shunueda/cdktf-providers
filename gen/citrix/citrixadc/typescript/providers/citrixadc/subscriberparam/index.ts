// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberparam
...
export interface SubscriberparamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberparam#id Subscriberparam#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberparam#idleaction Subscriberparam#idleaction}
  */
  readonly idleaction?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberparam#idlettl Subscriberparam#idlettl}
  */
  readonly idlettl?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberparam#interfacetype Subscriberparam#interfacetype}
  */
  readonly interfacetype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberparam#ipv6prefixlookuplist Subscriberparam#ipv6prefixlookuplist}
  */
  readonly ipv6Prefixlookuplist?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberparam#keytype Subscriberparam#keytype}
  */
  readonly keytype?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberparam citrixadc_subscriberparam}
*/
export class Subscriberparam extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Subscriberparam that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberparam#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/subscriberparam citrixadc_subscriberparam} Resource
  *
  * @param scope The scope in which to define this construct
