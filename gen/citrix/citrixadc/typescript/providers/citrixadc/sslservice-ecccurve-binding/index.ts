// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslservice_ecccurve_binding
...
export interface SslserviceEcccurveBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslservice_ecccurve_binding#ecccurvename SslserviceEcccurveBinding#ecccurvename}
  */
  readonly ecccurvename?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslservice_ecccurve_binding#id SslserviceEcccurveBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslservice_ecccurve_binding#servicename SslserviceEcccurveBinding#servicename}
  */
  readonly servicename?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslservice_ecccurve_binding citrixadc_sslservice_ecccurve_binding}
*/
export class SslserviceEcccurveBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslserviceEcccurveBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslservice_ecccurve_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslservice_ecccurve_binding citrixadc_sslservice_ecccurve_binding} Resource
  *
  * @param scope The scope in which to define this construct
