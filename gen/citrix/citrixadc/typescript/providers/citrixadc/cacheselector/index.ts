// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/cacheselector
...
export interface CacheselectorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/cacheselector#id Cacheselector#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/cacheselector#rule Cacheselector#rule}
  */
  readonly rule: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/cacheselector#selectorname Cacheselector#selectorname}
  */
  readonly selectorname: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/cacheselector citrixadc_cacheselector}
*/
export class Cacheselector extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cacheselector that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/cacheselector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/cacheselector citrixadc_cacheselector} Resource
  *
  * @param scope The scope in which to define this construct
