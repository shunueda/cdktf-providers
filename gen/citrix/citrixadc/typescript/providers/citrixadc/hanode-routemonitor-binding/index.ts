// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/hanode_routemonitor_binding
...
export interface HanodeRoutemonitorBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/hanode_routemonitor_binding#hanode_id HanodeRoutemonitorBinding#hanode_id}
  */
  readonly hanodeId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/hanode_routemonitor_binding#id HanodeRoutemonitorBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/hanode_routemonitor_binding#netmask HanodeRoutemonitorBinding#netmask}
  */
  readonly netmask: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/hanode_routemonitor_binding#routemonitor HanodeRoutemonitorBinding#routemonitor}
  */
  readonly routemonitor: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/hanode_routemonitor_binding citrixadc_hanode_routemonitor_binding}
*/
export class HanodeRoutemonitorBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HanodeRoutemonitorBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/hanode_routemonitor_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/hanode_routemonitor_binding citrixadc_hanode_routemonitor_binding} Resource
  *
  * @param scope The scope in which to define this construct
