// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/subscriberradiusinterface
...
export interface SubscriberradiusinterfaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/subscriberradiusinterface#id Subscriberradiusinterface#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/subscriberradiusinterface#listeningservice Subscriberradiusinterface#listeningservice}
  */
  readonly listeningservice?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/subscriberradiusinterface#radiusinterimasstart Subscriberradiusinterface#radiusinterimasstart}
  */
  readonly radiusinterimasstart?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/subscriberradiusinterface citrixadc_subscriberradiusinterface}
*/
export class Subscriberradiusinterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Subscriberradiusinterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/subscriberradiusinterface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/subscriberradiusinterface citrixadc_subscriberradiusinterface} Resource
  *
  * @param scope The scope in which to define this construct
