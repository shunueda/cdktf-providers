// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rsskeytype
...
export interface RsskeytypeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rsskeytype#id Rsskeytype#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rsskeytype#rsstype Rsskeytype#rsstype}
  */
  readonly rsstype: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rsskeytype citrixadc_rsskeytype}
*/
export class Rsskeytype extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Rsskeytype that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rsskeytype#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/rsskeytype citrixadc_rsskeytype} Resource
  *
  * @param scope The scope in which to define this construct
