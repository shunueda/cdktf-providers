// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsratecontrol
...
export interface NsratecontrolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsratecontrol#icmpthreshold Nsratecontrol#icmpthreshold}
  */
  readonly icmpthreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsratecontrol#id Nsratecontrol#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsratecontrol#tcprstthreshold Nsratecontrol#tcprstthreshold}
  */
  readonly tcprstthreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsratecontrol#tcpthreshold Nsratecontrol#tcpthreshold}
  */
  readonly tcpthreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsratecontrol#udpthreshold Nsratecontrol#udpthreshold}
  */
  readonly udpthreshold?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsratecontrol citrixadc_nsratecontrol}
*/
export class Nsratecontrol extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Nsratecontrol that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsratecontrol#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsratecontrol citrixadc_nsratecontrol} Resource
  *
  * @param scope The scope in which to define this construct
