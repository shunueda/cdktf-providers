// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/dnspolicylabel_dnspolicy_binding
...
export interface DnspolicylabelDnspolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/dnspolicylabel_dnspolicy_binding#gotopriorityexpression DnspolicylabelDnspolicyBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/dnspolicylabel_dnspolicy_binding#id DnspolicylabelDnspolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/dnspolicylabel_dnspolicy_binding#invoke DnspolicylabelDnspolicyBinding#invoke}
  */
  readonly invoke?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/dnspolicylabel_dnspolicy_binding#invokelabelname DnspolicylabelDnspolicyBinding#invokelabelname}
  */
  readonly invokelabelname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/dnspolicylabel_dnspolicy_binding#labelname DnspolicylabelDnspolicyBinding#labelname}
  */
  readonly labelname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/dnspolicylabel_dnspolicy_binding#labeltype DnspolicylabelDnspolicyBinding#labeltype}
  */
  readonly labeltype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/dnspolicylabel_dnspolicy_binding#policyname DnspolicylabelDnspolicyBinding#policyname}
  */
  readonly policyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/dnspolicylabel_dnspolicy_binding#priority DnspolicylabelDnspolicyBinding#priority}
  */
  readonly priority: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/dnspolicylabel_dnspolicy_binding citrixadc_dnspolicylabel_dnspolicy_binding}
*/
export class DnspolicylabelDnspolicyBinding extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "citrixadc_dnspolicylabel_dnspolicy_binding";
  ...
  * @param importFromId The id of the existing DnspolicylabelDnspolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/dnspolicylabel_dnspolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "citrixadc_dnspolicylabel_dnspolicy_binding", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/dnspolicylabel_dnspolicy_binding citrixadc_dnspolicylabel_dnspolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DnspolicylabelDnspolicyBindingConfig
  */
  public constructor(scope: Construct, id: string, config: DnspolicylabelDnspolicyBindingConfig) {
    super(scope, id, {
