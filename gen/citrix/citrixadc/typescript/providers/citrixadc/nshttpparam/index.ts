// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam
...
export interface NshttpparamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam#conmultiplex Nshttpparam#conmultiplex}
  */
  readonly conmultiplex?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam#dropinvalreqs Nshttpparam#dropinvalreqs}
  */
  readonly dropinvalreqs?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam#http2serverside Nshttpparam#http2serverside}
  */
  readonly http2Serverside?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam#id Nshttpparam#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam#ignoreconnectcodingscheme Nshttpparam#ignoreconnectcodingscheme}
  */
  readonly ignoreconnectcodingscheme?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam#insnssrvrhdr Nshttpparam#insnssrvrhdr}
  */
  readonly insnssrvrhdr?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam#logerrresp Nshttpparam#logerrresp}
  */
  readonly logerrresp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam#markconnreqinval Nshttpparam#markconnreqinval}
  */
  readonly markconnreqinval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam#markhttp09inval Nshttpparam#markhttp09inval}
  */
  readonly markhttp09Inval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam#maxreusepool Nshttpparam#maxreusepool}
  */
  readonly maxreusepool?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam#nssrvrhdr Nshttpparam#nssrvrhdr}
  */
  readonly nssrvrhdr?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam citrixadc_nshttpparam}
*/
export class Nshttpparam extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Nshttpparam that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nshttpparam citrixadc_nshttpparam} Resource
  *
  * @param scope The scope in which to define this construct
