// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nslimitidentifier
...
export interface NslimitidentifierConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nslimitidentifier#id Nslimitidentifier#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nslimitidentifier#limitidentifier Nslimitidentifier#limitidentifier}
  */
  readonly limitidentifier: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nslimitidentifier#limittype Nslimitidentifier#limittype}
  */
  readonly limittype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nslimitidentifier#maxbandwidth Nslimitidentifier#maxbandwidth}
  */
  readonly maxbandwidth?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nslimitidentifier#mode Nslimitidentifier#mode}
  */
  readonly mode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nslimitidentifier#selectorname Nslimitidentifier#selectorname}
  */
  readonly selectorname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nslimitidentifier#threshold Nslimitidentifier#threshold}
  */
  readonly threshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nslimitidentifier#timeslice Nslimitidentifier#timeslice}
  */
  readonly timeslice?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nslimitidentifier#trapsintimeslice Nslimitidentifier#trapsintimeslice}
  */
  readonly trapsintimeslice?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nslimitidentifier citrixadc_nslimitidentifier}
*/
export class Nslimitidentifier extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Nslimitidentifier that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nslimitidentifier#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nslimitidentifier citrixadc_nslimitidentifier} Resource
  *
  * @param scope The scope in which to define this construct
