// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaapreauthenticationparameter
...
export interface AaapreauthenticationparameterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaapreauthenticationparameter#deletefiles Aaapreauthenticationparameter#deletefiles}
  */
  readonly deletefiles?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaapreauthenticationparameter#id Aaapreauthenticationparameter#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaapreauthenticationparameter#killprocess Aaapreauthenticationparameter#killprocess}
  */
  readonly killprocess?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaapreauthenticationparameter#preauthenticationaction Aaapreauthenticationparameter#preauthenticationaction}
  */
  readonly preauthenticationaction?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaapreauthenticationparameter#rule Aaapreauthenticationparameter#rule}
  */
  readonly rule?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaapreauthenticationparameter citrixadc_aaapreauthenticationparameter}
*/
export class Aaapreauthenticationparameter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Aaapreauthenticationparameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaapreauthenticationparameter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/aaapreauthenticationparameter citrixadc_aaapreauthenticationparameter} Resource
  *
  * @param scope The scope in which to define this construct
