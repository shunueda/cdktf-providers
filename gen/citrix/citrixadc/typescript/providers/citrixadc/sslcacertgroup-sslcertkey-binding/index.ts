// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcacertgroup_sslcertkey_binding
...
export interface SslcacertgroupSslcertkeyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcacertgroup_sslcertkey_binding#cacertgroupname SslcacertgroupSslcertkeyBinding#cacertgroupname}
  */
  readonly cacertgroupname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcacertgroup_sslcertkey_binding#certkeyname SslcacertgroupSslcertkeyBinding#certkeyname}
  */
  readonly certkeyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcacertgroup_sslcertkey_binding#crlcheck SslcacertgroupSslcertkeyBinding#crlcheck}
  */
  readonly crlcheck?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcacertgroup_sslcertkey_binding#id SslcacertgroupSslcertkeyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcacertgroup_sslcertkey_binding#ocspcheck SslcacertgroupSslcertkeyBinding#ocspcheck}
  */
  readonly ocspcheck?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcacertgroup_sslcertkey_binding citrixadc_sslcacertgroup_sslcertkey_binding}
*/
export class SslcacertgroupSslcertkeyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslcacertgroupSslcertkeyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcacertgroup_sslcertkey_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcacertgroup_sslcertkey_binding citrixadc_sslcacertgroup_sslcertkey_binding} Resource
  *
  * @param scope The scope in which to define this construct
