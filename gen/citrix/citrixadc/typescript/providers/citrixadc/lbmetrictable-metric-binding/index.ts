// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmetrictable_metric_binding
...
export interface LbmetrictableMetricBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmetrictable_metric_binding#id LbmetrictableMetricBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmetrictable_metric_binding#metric LbmetrictableMetricBinding#metric}
  */
  readonly metric: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmetrictable_metric_binding#metrictable LbmetrictableMetricBinding#metrictable}
  */
  readonly metrictable: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmetrictable_metric_binding#snmpoid LbmetrictableMetricBinding#snmpoid}
  */
  readonly snmpoid: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmetrictable_metric_binding citrixadc_lbmetrictable_metric_binding}
*/
export class LbmetrictableMetricBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbmetrictableMetricBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmetrictable_metric_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lbmetrictable_metric_binding citrixadc_lbmetrictable_metric_binding} Resource
  *
  * @param scope The scope in which to define this construct
