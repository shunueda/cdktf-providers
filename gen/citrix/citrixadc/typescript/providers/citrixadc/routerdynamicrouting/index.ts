// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/routerdynamicrouting
...
export interface RouterdynamicroutingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/routerdynamicrouting#commandlines Routerdynamicrouting#commandlines}
  */
  readonly commandlines?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/routerdynamicrouting#id Routerdynamicrouting#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/routerdynamicrouting#nodeid Routerdynamicrouting#nodeid}
  */
  readonly nodeid?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/routerdynamicrouting citrixadc_routerdynamicrouting}
*/
export class Routerdynamicrouting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Routerdynamicrouting that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/routerdynamicrouting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/routerdynamicrouting citrixadc_routerdynamicrouting} Resource
  *
  * @param scope The scope in which to define this construct
