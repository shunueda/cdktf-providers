// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/tmglobal_tmtrafficpolicy_binding
...
export interface TmglobalTmtrafficpolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/tmglobal_tmtrafficpolicy_binding#globalbindtype TmglobalTmtrafficpolicyBinding#globalbindtype}
  */
  readonly globalbindtype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/tmglobal_tmtrafficpolicy_binding#gotopriorityexpression TmglobalTmtrafficpolicyBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/tmglobal_tmtrafficpolicy_binding#id TmglobalTmtrafficpolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/tmglobal_tmtrafficpolicy_binding#policyname TmglobalTmtrafficpolicyBinding#policyname}
  */
  readonly policyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/tmglobal_tmtrafficpolicy_binding#priority TmglobalTmtrafficpolicyBinding#priority}
  */
  readonly priority: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/tmglobal_tmtrafficpolicy_binding#type TmglobalTmtrafficpolicyBinding#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/tmglobal_tmtrafficpolicy_binding citrixadc_tmglobal_tmtrafficpolicy_binding}
*/
export class TmglobalTmtrafficpolicyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TmglobalTmtrafficpolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/tmglobal_tmtrafficpolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/tmglobal_tmtrafficpolicy_binding citrixadc_tmglobal_tmtrafficpolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
