// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/cspolicylabel
...
export interface CspolicylabelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/cspolicylabel#cspolicylabeltype Cspolicylabel#cspolicylabeltype}
  */
  readonly cspolicylabeltype: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/cspolicylabel#id Cspolicylabel#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/cspolicylabel#labelname Cspolicylabel#labelname}
  */
  readonly labelname: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/cspolicylabel citrixadc_cspolicylabel}
*/
export class Cspolicylabel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cspolicylabel that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/cspolicylabel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/cspolicylabel citrixadc_cspolicylabel} Resource
  *
  * @param scope The scope in which to define this construct
