// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpuser
...
export interface SnmpuserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpuser#authpasswd Snmpuser#authpasswd}
  */
  readonly authpasswd?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpuser#authtype Snmpuser#authtype}
  */
  readonly authtype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpuser#group Snmpuser#group}
  */
  readonly group: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpuser#id Snmpuser#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpuser#name Snmpuser#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpuser#privpasswd Snmpuser#privpasswd}
  */
  readonly privpasswd?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpuser#privtype Snmpuser#privtype}
  */
  readonly privtype?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpuser citrixadc_snmpuser}
*/
export class Snmpuser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Snmpuser that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpuser#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/snmpuser citrixadc_snmpuser} Resource
  *
  * @param scope The scope in which to define this construct
