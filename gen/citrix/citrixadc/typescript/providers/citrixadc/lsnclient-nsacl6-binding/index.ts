// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_nsacl6_binding
...
export interface LsnclientNsacl6BindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_nsacl6_binding#acl6name LsnclientNsacl6Binding#acl6name}
  */
  readonly acl6Name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_nsacl6_binding#clientname LsnclientNsacl6Binding#clientname}
  */
  readonly clientname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_nsacl6_binding#id LsnclientNsacl6Binding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_nsacl6_binding#td LsnclientNsacl6Binding#td}
  */
  readonly td?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_nsacl6_binding citrixadc_lsnclient_nsacl6_binding}
*/
export class LsnclientNsacl6Binding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LsnclientNsacl6Binding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_nsacl6_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnclient_nsacl6_binding citrixadc_lsnclient_nsacl6_binding} Resource
  *
  * @param scope The scope in which to define this construct
