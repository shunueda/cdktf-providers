// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/mapdomain
...
export interface MapdomainConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/mapdomain#id Mapdomain#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/mapdomain#mapdmrname Mapdomain#mapdmrname}
  */
  readonly mapdmrname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/mapdomain#name Mapdomain#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/mapdomain citrixadc_mapdomain}
*/
export class Mapdomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Mapdomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/mapdomain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/mapdomain citrixadc_mapdomain} Resource
  *
  * @param scope The scope in which to define this construct
