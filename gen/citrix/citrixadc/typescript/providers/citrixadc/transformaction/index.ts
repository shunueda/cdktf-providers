// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction
...
export interface TransformactionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction#comment Transformaction#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction#cookiedomainfrom Transformaction#cookiedomainfrom}
  */
  readonly cookiedomainfrom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction#cookiedomaininto Transformaction#cookiedomaininto}
  */
  readonly cookiedomaininto?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction#id Transformaction#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction#name Transformaction#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction#priority Transformaction#priority}
  */
  readonly priority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction#profilename Transformaction#profilename}
  */
  readonly profilename?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction#requrlfrom Transformaction#requrlfrom}
  */
  readonly requrlfrom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction#requrlinto Transformaction#requrlinto}
  */
  readonly requrlinto?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction#resurlfrom Transformaction#resurlfrom}
  */
  readonly resurlfrom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction#resurlinto Transformaction#resurlinto}
  */
  readonly resurlinto?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction#state Transformaction#state}
  */
  readonly state?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction citrixadc_transformaction}
*/
export class Transformaction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Transformaction that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/transformaction citrixadc_transformaction} Resource
  *
  * @param scope The scope in which to define this construct
