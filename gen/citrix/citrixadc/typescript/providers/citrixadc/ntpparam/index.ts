// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpparam
...
export interface NtpparamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpparam#authentication Ntpparam#authentication}
  */
  readonly authentication?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpparam#autokeylogsec Ntpparam#autokeylogsec}
  */
  readonly autokeylogsec?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpparam#id Ntpparam#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpparam#revokelogsec Ntpparam#revokelogsec}
  */
  readonly revokelogsec?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpparam#trustedkey Ntpparam#trustedkey}
  */
  readonly trustedkey?: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpparam citrixadc_ntpparam}
*/
export class Ntpparam extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ntpparam that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpparam#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/ntpparam citrixadc_ntpparam} Resource
  *
  * @param scope The scope in which to define this construct
