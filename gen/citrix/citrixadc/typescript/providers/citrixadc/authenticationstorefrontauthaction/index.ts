// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/authenticationstorefrontauthaction
...
export interface AuthenticationstorefrontauthactionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/authenticationstorefrontauthaction#defaultauthenticationgroup Authenticationstorefrontauthaction#defaultauthenticationgroup}
  */
  readonly defaultauthenticationgroup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/authenticationstorefrontauthaction#domain Authenticationstorefrontauthaction#domain}
  */
  readonly domain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/authenticationstorefrontauthaction#id Authenticationstorefrontauthaction#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/authenticationstorefrontauthaction#name Authenticationstorefrontauthaction#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/authenticationstorefrontauthaction#serverurl Authenticationstorefrontauthaction#serverurl}
  */
  readonly serverurl: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/authenticationstorefrontauthaction citrixadc_authenticationstorefrontauthaction}
*/
export class Authenticationstorefrontauthaction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Authenticationstorefrontauthaction that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/authenticationstorefrontauthaction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/authenticationstorefrontauthaction citrixadc_authenticationstorefrontauthaction} Resource
  *
  * @param scope The scope in which to define this construct
