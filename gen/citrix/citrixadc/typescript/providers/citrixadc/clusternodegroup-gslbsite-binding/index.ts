// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/clusternodegroup_gslbsite_binding
...
export interface ClusternodegroupGslbsiteBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/clusternodegroup_gslbsite_binding#gslbsite ClusternodegroupGslbsiteBinding#gslbsite}
  */
  readonly gslbsite: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/clusternodegroup_gslbsite_binding#id ClusternodegroupGslbsiteBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/clusternodegroup_gslbsite_binding#name ClusternodegroupGslbsiteBinding#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/clusternodegroup_gslbsite_binding citrixadc_clusternodegroup_gslbsite_binding}
*/
export class ClusternodegroupGslbsiteBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusternodegroupGslbsiteBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/clusternodegroup_gslbsite_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/clusternodegroup_gslbsite_binding citrixadc_clusternodegroup_gslbsite_binding} Resource
  *
  * @param scope The scope in which to define this construct
