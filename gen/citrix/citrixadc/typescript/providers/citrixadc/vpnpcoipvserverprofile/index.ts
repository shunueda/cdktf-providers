// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipvserverprofile
...
export interface VpnpcoipvserverprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipvserverprofile#id Vpnpcoipvserverprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipvserverprofile#logindomain Vpnpcoipvserverprofile#logindomain}
  */
  readonly logindomain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipvserverprofile#name Vpnpcoipvserverprofile#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipvserverprofile#udpport Vpnpcoipvserverprofile#udpport}
  */
  readonly udpport?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipvserverprofile citrixadc_vpnpcoipvserverprofile}
*/
export class Vpnpcoipvserverprofile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Vpnpcoipvserverprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipvserverprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipvserverprofile citrixadc_vpnpcoipvserverprofile} Resource
  *
  * @param scope The scope in which to define this construct
