// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systembackup_create
...
export interface SystembackupCreateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systembackup_create#comment SystembackupCreate#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systembackup_create#filename SystembackupCreate#filename}
  */
  readonly filename: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systembackup_create#id SystembackupCreate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systembackup_create#includekernel SystembackupCreate#includekernel}
  */
  readonly includekernel?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systembackup_create#level SystembackupCreate#level}
  */
  readonly level?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systembackup_create#uselocaltimezone SystembackupCreate#uselocaltimezone}
  */
  readonly uselocaltimezone?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systembackup_create citrixadc_systembackup_create}
*/
export class SystembackupCreate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystembackupCreate that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systembackup_create#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/systembackup_create citrixadc_systembackup_create} Resource
  *
  * @param scope The scope in which to define this construct
