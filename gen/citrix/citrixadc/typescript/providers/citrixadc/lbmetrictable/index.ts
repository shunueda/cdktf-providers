// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lbmetrictable
...
export interface LbmetrictableConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lbmetrictable#id Lbmetrictable#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lbmetrictable#metrictable Lbmetrictable#metrictable}
  */
  readonly metrictable: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lbmetrictable citrixadc_lbmetrictable}
*/
export class Lbmetrictable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lbmetrictable that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lbmetrictable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lbmetrictable citrixadc_lbmetrictable} Resource
  *
  * @param scope The scope in which to define this construct
