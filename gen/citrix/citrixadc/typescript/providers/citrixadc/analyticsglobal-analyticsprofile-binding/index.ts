// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/analyticsglobal_analyticsprofile_binding
...
export interface AnalyticsglobalAnalyticsprofileBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/analyticsglobal_analyticsprofile_binding#analyticsprofile AnalyticsglobalAnalyticsprofileBinding#analyticsprofile}
  */
  readonly analyticsprofile: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/analyticsglobal_analyticsprofile_binding#id AnalyticsglobalAnalyticsprofileBinding#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/analyticsglobal_analyticsprofile_binding citrixadc_analyticsglobal_analyticsprofile_binding}
*/
export class AnalyticsglobalAnalyticsprofileBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AnalyticsglobalAnalyticsprofileBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/analyticsglobal_analyticsprofile_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/analyticsglobal_analyticsprofile_binding citrixadc_analyticsglobal_analyticsprofile_binding} Resource
  *
  * @param scope The scope in which to define this construct
