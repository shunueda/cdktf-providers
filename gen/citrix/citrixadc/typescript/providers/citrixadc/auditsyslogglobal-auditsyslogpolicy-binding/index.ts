// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditsyslogglobal_auditsyslogpolicy_binding
...
export interface AuditsyslogglobalAuditsyslogpolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditsyslogglobal_auditsyslogpolicy_binding#builtin AuditsyslogglobalAuditsyslogpolicyBinding#builtin}
  */
  readonly builtin?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditsyslogglobal_auditsyslogpolicy_binding#feature AuditsyslogglobalAuditsyslogpolicyBinding#feature}
  */
  readonly feature?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditsyslogglobal_auditsyslogpolicy_binding#globalbindtype AuditsyslogglobalAuditsyslogpolicyBinding#globalbindtype}
  */
  readonly globalbindtype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditsyslogglobal_auditsyslogpolicy_binding#id AuditsyslogglobalAuditsyslogpolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditsyslogglobal_auditsyslogpolicy_binding#policyname AuditsyslogglobalAuditsyslogpolicyBinding#policyname}
  */
  readonly policyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditsyslogglobal_auditsyslogpolicy_binding#priority AuditsyslogglobalAuditsyslogpolicyBinding#priority}
  */
  readonly priority: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditsyslogglobal_auditsyslogpolicy_binding citrixadc_auditsyslogglobal_auditsyslogpolicy_binding}
*/
export class AuditsyslogglobalAuditsyslogpolicyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuditsyslogglobalAuditsyslogpolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditsyslogglobal_auditsyslogpolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/auditsyslogglobal_auditsyslogpolicy_binding citrixadc_auditsyslogglobal_auditsyslogpolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
