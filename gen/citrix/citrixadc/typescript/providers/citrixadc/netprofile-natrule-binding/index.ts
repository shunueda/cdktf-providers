// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/netprofile_natrule_binding
...
export interface NetprofileNatruleBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/netprofile_natrule_binding#id NetprofileNatruleBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/netprofile_natrule_binding#name NetprofileNatruleBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/netprofile_natrule_binding#natrule NetprofileNatruleBinding#natrule}
  */
  readonly natrule: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/netprofile_natrule_binding#netmask NetprofileNatruleBinding#netmask}
  */
  readonly netmask?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/netprofile_natrule_binding#rewriteip NetprofileNatruleBinding#rewriteip}
  */
  readonly rewriteip?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/netprofile_natrule_binding citrixadc_netprofile_natrule_binding}
*/
export class NetprofileNatruleBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetprofileNatruleBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/netprofile_natrule_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/netprofile_natrule_binding citrixadc_netprofile_natrule_binding} Resource
  *
  * @param scope The scope in which to define this construct
