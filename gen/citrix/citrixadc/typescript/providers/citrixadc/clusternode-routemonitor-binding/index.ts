// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/clusternode_routemonitor_binding
...
export interface ClusternodeRoutemonitorBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/clusternode_routemonitor_binding#id ClusternodeRoutemonitorBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/clusternode_routemonitor_binding#netmask ClusternodeRoutemonitorBinding#netmask}
  */
  readonly netmask: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/clusternode_routemonitor_binding#nodeid ClusternodeRoutemonitorBinding#nodeid}
  */
  readonly nodeid: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/clusternode_routemonitor_binding#routemonitor ClusternodeRoutemonitorBinding#routemonitor}
  */
  readonly routemonitor: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/clusternode_routemonitor_binding citrixadc_clusternode_routemonitor_binding}
*/
export class ClusternodeRoutemonitorBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusternodeRoutemonitorBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/clusternode_routemonitor_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/clusternode_routemonitor_binding citrixadc_clusternode_routemonitor_binding} Resource
  *
  * @param scope The scope in which to define this construct
