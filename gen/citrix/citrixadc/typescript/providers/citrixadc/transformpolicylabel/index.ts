// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformpolicylabel
...
export interface TransformpolicylabelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformpolicylabel#id Transformpolicylabel#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformpolicylabel#labelname Transformpolicylabel#labelname}
  */
  readonly labelname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformpolicylabel#policylabeltype Transformpolicylabel#policylabeltype}
  */
  readonly policylabeltype: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformpolicylabel citrixadc_transformpolicylabel}
*/
export class Transformpolicylabel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Transformpolicylabel that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformpolicylabel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/transformpolicylabel citrixadc_transformpolicylabel} Resource
  *
  * @param scope The scope in which to define this construct
