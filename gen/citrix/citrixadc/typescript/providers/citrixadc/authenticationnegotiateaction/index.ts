// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationnegotiateaction
...
export interface AuthenticationnegotiateactionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationnegotiateaction#defaultauthenticationgroup Authenticationnegotiateaction#defaultauthenticationgroup}
  */
  readonly defaultauthenticationgroup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationnegotiateaction#domain Authenticationnegotiateaction#domain}
  */
  readonly domain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationnegotiateaction#domainuser Authenticationnegotiateaction#domainuser}
  */
  readonly domainuser?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationnegotiateaction#domainuserpasswd Authenticationnegotiateaction#domainuserpasswd}
  */
  readonly domainuserpasswd?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationnegotiateaction#id Authenticationnegotiateaction#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationnegotiateaction#keytab Authenticationnegotiateaction#keytab}
  */
  readonly keytab?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationnegotiateaction#name Authenticationnegotiateaction#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationnegotiateaction#ntlmpath Authenticationnegotiateaction#ntlmpath}
  */
  readonly ntlmpath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationnegotiateaction#ou Authenticationnegotiateaction#ou}
  */
  readonly ou?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationnegotiateaction citrixadc_authenticationnegotiateaction}
*/
export class Authenticationnegotiateaction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Authenticationnegotiateaction that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationnegotiateaction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationnegotiateaction citrixadc_authenticationnegotiateaction} Resource
  *
  * @param scope The scope in which to define this construct
