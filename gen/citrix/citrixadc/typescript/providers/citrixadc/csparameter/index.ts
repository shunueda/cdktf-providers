// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/csparameter
...
export interface CsparameterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/csparameter#id Csparameter#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/csparameter#stateupdate Csparameter#stateupdate}
  */
  readonly stateupdate?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/csparameter citrixadc_csparameter}
*/
export class Csparameter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Csparameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/csparameter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/csparameter citrixadc_csparameter} Resource
  *
  * @param scope The scope in which to define this construct
