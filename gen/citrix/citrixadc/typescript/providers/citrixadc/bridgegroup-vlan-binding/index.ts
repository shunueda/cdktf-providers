// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/bridgegroup_vlan_binding
...
export interface BridgegroupVlanBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/bridgegroup_vlan_binding#bridgegroup_id BridgegroupVlanBinding#bridgegroup_id}
  */
  readonly bridgegroupId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/bridgegroup_vlan_binding#id BridgegroupVlanBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/bridgegroup_vlan_binding#vlan BridgegroupVlanBinding#vlan}
  */
  readonly vlan: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/bridgegroup_vlan_binding citrixadc_bridgegroup_vlan_binding}
*/
export class BridgegroupVlanBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BridgegroupVlanBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/bridgegroup_vlan_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/bridgegroup_vlan_binding citrixadc_bridgegroup_vlan_binding} Resource
  *
  * @param scope The scope in which to define this construct
