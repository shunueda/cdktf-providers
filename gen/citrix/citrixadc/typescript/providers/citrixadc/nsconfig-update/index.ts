// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsconfig_update
...
export interface NsconfigUpdateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsconfig_update#id NsconfigUpdate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsconfig_update#ifnum NsconfigUpdate#ifnum}
  */
  readonly ifnum?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsconfig_update#ipaddress NsconfigUpdate#ipaddress}
  */
  readonly ipaddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsconfig_update#netmask NsconfigUpdate#netmask}
  */
  readonly netmask?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsconfig_update#nsvlan NsconfigUpdate#nsvlan}
  */
  readonly nsvlan?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsconfig_update#tagged NsconfigUpdate#tagged}
  */
  readonly tagged?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsconfig_update citrixadc_nsconfig_update}
*/
export class NsconfigUpdate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NsconfigUpdate that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsconfig_update#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/nsconfig_update citrixadc_nsconfig_update} Resource
  *
  * @param scope The scope in which to define this construct
