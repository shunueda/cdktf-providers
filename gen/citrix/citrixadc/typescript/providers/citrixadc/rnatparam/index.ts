// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/rnatparam
...
export interface RnatparamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/rnatparam#id Rnatparam#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/rnatparam#srcippersistency Rnatparam#srcippersistency}
  */
  readonly srcippersistency?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/rnatparam#tcpproxy Rnatparam#tcpproxy}
  */
  readonly tcpproxy?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/rnatparam citrixadc_rnatparam}
*/
export class Rnatparam extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Rnatparam that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/rnatparam#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/rnatparam citrixadc_rnatparam} Resource
  *
  * @param scope The scope in which to define this construct
