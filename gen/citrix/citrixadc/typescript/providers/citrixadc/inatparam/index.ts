// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/inatparam
...
export interface InatparamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/inatparam#id Inatparam#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/inatparam#nat46fragheader Inatparam#nat46fragheader}
  */
  readonly nat46Fragheader?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/inatparam#nat46ignoretos Inatparam#nat46ignoretos}
  */
  readonly nat46Ignoretos?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/inatparam#nat46v6mtu Inatparam#nat46v6mtu}
  */
  readonly nat46V6Mtu?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/inatparam#nat46v6prefix Inatparam#nat46v6prefix}
  */
  readonly nat46V6Prefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/inatparam#nat46zerochecksum Inatparam#nat46zerochecksum}
  */
  readonly nat46Zerochecksum?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/inatparam#td Inatparam#td}
  */
  readonly td?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/inatparam citrixadc_inatparam}
*/
export class Inatparam extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Inatparam that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/inatparam#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/inatparam citrixadc_inatparam} Resource
  *
  * @param scope The scope in which to define this construct
