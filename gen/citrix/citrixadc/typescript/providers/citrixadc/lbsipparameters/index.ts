// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbsipparameters
...
export interface LbsipparametersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbsipparameters#addrportvip Lbsipparameters#addrportvip}
  */
  readonly addrportvip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbsipparameters#id Lbsipparameters#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbsipparameters#retrydur Lbsipparameters#retrydur}
  */
  readonly retrydur?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbsipparameters#rnatdstport Lbsipparameters#rnatdstport}
  */
  readonly rnatdstport?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbsipparameters#rnatsecuredstport Lbsipparameters#rnatsecuredstport}
  */
  readonly rnatsecuredstport?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbsipparameters#rnatsecuresrcport Lbsipparameters#rnatsecuresrcport}
  */
  readonly rnatsecuresrcport?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbsipparameters#rnatsrcport Lbsipparameters#rnatsrcport}
  */
  readonly rnatsrcport?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbsipparameters#sip503ratethreshold Lbsipparameters#sip503ratethreshold}
  */
  readonly sip503Ratethreshold?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbsipparameters citrixadc_lbsipparameters}
*/
export class Lbsipparameters extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lbsipparameters that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbsipparameters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lbsipparameters citrixadc_lbsipparameters} Resource
  *
  * @param scope The scope in which to define this construct
