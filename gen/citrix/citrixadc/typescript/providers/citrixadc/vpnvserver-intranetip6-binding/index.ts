// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_intranetip6_binding
...
export interface VpnvserverIntranetip6BindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_intranetip6_binding#id VpnvserverIntranetip6Binding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_intranetip6_binding#intranetip6 VpnvserverIntranetip6Binding#intranetip6}
  */
  readonly intranetip6: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_intranetip6_binding#name VpnvserverIntranetip6Binding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_intranetip6_binding#numaddr VpnvserverIntranetip6Binding#numaddr}
  */
  readonly numaddr?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_intranetip6_binding citrixadc_vpnvserver_intranetip6_binding}
*/
export class VpnvserverIntranetip6Binding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnvserverIntranetip6Binding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_intranetip6_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnvserver_intranetip6_binding citrixadc_vpnvserver_intranetip6_binding} Resource
  *
  * @param scope The scope in which to define this construct
