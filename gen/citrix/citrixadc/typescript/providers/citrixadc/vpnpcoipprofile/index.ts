// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipprofile
...
export interface VpnpcoipprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipprofile#conserverurl Vpnpcoipprofile#conserverurl}
  */
  readonly conserverurl: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipprofile#icvverification Vpnpcoipprofile#icvverification}
  */
  readonly icvverification?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipprofile#id Vpnpcoipprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipprofile#name Vpnpcoipprofile#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipprofile#sessionidletimeout Vpnpcoipprofile#sessionidletimeout}
  */
  readonly sessionidletimeout?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipprofile citrixadc_vpnpcoipprofile}
*/
export class Vpnpcoipprofile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Vpnpcoipprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnpcoipprofile citrixadc_vpnpcoipprofile} Resource
  *
  * @param scope The scope in which to define this construct
