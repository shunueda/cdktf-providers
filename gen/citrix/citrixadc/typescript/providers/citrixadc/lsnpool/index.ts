// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnpool
...
export interface LsnpoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnpool#id Lsnpool#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnpool#maxportrealloctmq Lsnpool#maxportrealloctmq}
  */
  readonly maxportrealloctmq?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnpool#nattype Lsnpool#nattype}
  */
  readonly nattype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnpool#poolname Lsnpool#poolname}
  */
  readonly poolname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnpool#portblockallocation Lsnpool#portblockallocation}
  */
  readonly portblockallocation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnpool#portrealloctimeout Lsnpool#portrealloctimeout}
  */
  readonly portrealloctimeout?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnpool citrixadc_lsnpool}
*/
export class Lsnpool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lsnpool that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnpool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/lsnpool citrixadc_lsnpool} Resource
  *
  * @param scope The scope in which to define this construct
