// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsngroup_lsnlogprofile_binding
...
export interface LsngroupLsnlogprofileBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsngroup_lsnlogprofile_binding#groupname LsngroupLsnlogprofileBinding#groupname}
  */
  readonly groupname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsngroup_lsnlogprofile_binding#id LsngroupLsnlogprofileBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsngroup_lsnlogprofile_binding#logprofilename LsngroupLsnlogprofileBinding#logprofilename}
  */
  readonly logprofilename: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsngroup_lsnlogprofile_binding citrixadc_lsngroup_lsnlogprofile_binding}
*/
export class LsngroupLsnlogprofileBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LsngroupLsnlogprofileBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsngroup_lsnlogprofile_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/lsngroup_lsnlogprofile_binding citrixadc_lsngroup_lsnlogprofile_binding} Resource
  *
  * @param scope The scope in which to define this construct
