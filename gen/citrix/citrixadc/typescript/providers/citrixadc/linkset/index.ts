// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/linkset
...
export interface LinksetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/linkset#id Linkset#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/linkset#interfacebinding Linkset#interfacebinding}
  */
  readonly interfacebinding?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/linkset#linkset_id Linkset#linkset_id}
  */
  readonly linksetId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/linkset citrixadc_linkset}
*/
export class Linkset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Linkset that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/linkset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/linkset citrixadc_linkset} Resource
  *
  * @param scope The scope in which to define this construct
