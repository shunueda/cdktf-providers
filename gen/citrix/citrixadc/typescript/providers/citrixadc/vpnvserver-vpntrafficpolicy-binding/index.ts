// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnvserver_vpntrafficpolicy_binding
...
export interface VpnvserverVpntrafficpolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnvserver_vpntrafficpolicy_binding#bindpoint VpnvserverVpntrafficpolicyBinding#bindpoint}
  */
  readonly bindpoint?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnvserver_vpntrafficpolicy_binding#gotopriorityexpression VpnvserverVpntrafficpolicyBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnvserver_vpntrafficpolicy_binding#groupextraction VpnvserverVpntrafficpolicyBinding#groupextraction}
  */
  readonly groupextraction?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnvserver_vpntrafficpolicy_binding#id VpnvserverVpntrafficpolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnvserver_vpntrafficpolicy_binding#name VpnvserverVpntrafficpolicyBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnvserver_vpntrafficpolicy_binding#policy VpnvserverVpntrafficpolicyBinding#policy}
  */
  readonly policy: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnvserver_vpntrafficpolicy_binding#priority VpnvserverVpntrafficpolicyBinding#priority}
  */
  readonly priority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnvserver_vpntrafficpolicy_binding#secondary VpnvserverVpntrafficpolicyBinding#secondary}
  */
  readonly secondary?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnvserver_vpntrafficpolicy_binding citrixadc_vpnvserver_vpntrafficpolicy_binding}
*/
export class VpnvserverVpntrafficpolicyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnvserverVpntrafficpolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnvserver_vpntrafficpolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/vpnvserver_vpntrafficpolicy_binding citrixadc_vpnvserver_vpntrafficpolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
