// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/ip6tunnel
...
export interface Ip6TunnelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/ip6tunnel#id Ip6Tunnel#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/ip6tunnel#local Ip6Tunnel#local}
  */
  readonly local: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/ip6tunnel#name Ip6Tunnel#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/ip6tunnel#ownergroup Ip6Tunnel#ownergroup}
  */
  readonly ownergroup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/ip6tunnel#remote Ip6Tunnel#remote}
  */
  readonly remote: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/ip6tunnel citrixadc_ip6tunnel}
*/
export class Ip6Tunnel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ip6Tunnel that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/ip6tunnel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/ip6tunnel citrixadc_ip6tunnel} Resource
  *
  * @param scope The scope in which to define this construct
