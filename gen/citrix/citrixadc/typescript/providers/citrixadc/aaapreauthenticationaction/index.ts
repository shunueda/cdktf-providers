// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaapreauthenticationaction
...
export interface AaapreauthenticationactionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaapreauthenticationaction#defaultepagroup Aaapreauthenticationaction#defaultepagroup}
  */
  readonly defaultepagroup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaapreauthenticationaction#deletefiles Aaapreauthenticationaction#deletefiles}
  */
  readonly deletefiles?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaapreauthenticationaction#id Aaapreauthenticationaction#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaapreauthenticationaction#killprocess Aaapreauthenticationaction#killprocess}
  */
  readonly killprocess?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaapreauthenticationaction#name Aaapreauthenticationaction#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaapreauthenticationaction#preauthenticationaction Aaapreauthenticationaction#preauthenticationaction}
  */
  readonly preauthenticationaction?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaapreauthenticationaction citrixadc_aaapreauthenticationaction}
*/
export class Aaapreauthenticationaction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Aaapreauthenticationaction that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaapreauthenticationaction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaapreauthenticationaction citrixadc_aaapreauthenticationaction} Resource
  *
  * @param scope The scope in which to define this construct
