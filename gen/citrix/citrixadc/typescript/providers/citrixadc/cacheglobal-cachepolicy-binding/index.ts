// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cacheglobal_cachepolicy_binding
...
export interface CacheglobalCachepolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cacheglobal_cachepolicy_binding#gotopriorityexpression CacheglobalCachepolicyBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cacheglobal_cachepolicy_binding#id CacheglobalCachepolicyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cacheglobal_cachepolicy_binding#invoke CacheglobalCachepolicyBinding#invoke}
  */
  readonly invoke?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cacheglobal_cachepolicy_binding#labelname CacheglobalCachepolicyBinding#labelname}
  */
  readonly labelname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cacheglobal_cachepolicy_binding#labeltype CacheglobalCachepolicyBinding#labeltype}
  */
  readonly labeltype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cacheglobal_cachepolicy_binding#policy CacheglobalCachepolicyBinding#policy}
  */
  readonly policy: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cacheglobal_cachepolicy_binding#precededefrules CacheglobalCachepolicyBinding#precededefrules}
  */
  readonly precededefrules?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cacheglobal_cachepolicy_binding#priority CacheglobalCachepolicyBinding#priority}
  */
  readonly priority: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cacheglobal_cachepolicy_binding#type CacheglobalCachepolicyBinding#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cacheglobal_cachepolicy_binding citrixadc_cacheglobal_cachepolicy_binding}
*/
export class CacheglobalCachepolicyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CacheglobalCachepolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cacheglobal_cachepolicy_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/cacheglobal_cachepolicy_binding citrixadc_cacheglobal_cachepolicy_binding} Resource
  *
  * @param scope The scope in which to define this construct
