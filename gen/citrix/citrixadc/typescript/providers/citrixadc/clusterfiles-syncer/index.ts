// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusterfiles_syncer
...
export interface ClusterfilesSyncerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusterfiles_syncer#id ClusterfilesSyncer#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusterfiles_syncer#mode ClusterfilesSyncer#mode}
  */
  readonly mode: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusterfiles_syncer#timestamp ClusterfilesSyncer#timestamp}
  */
  readonly timestamp: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusterfiles_syncer citrixadc_clusterfiles_syncer}
*/
export class ClusterfilesSyncer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusterfilesSyncer that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusterfiles_syncer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusterfiles_syncer citrixadc_clusterfiles_syncer} Resource
  *
  * @param scope The scope in which to define this construct
