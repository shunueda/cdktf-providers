// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationepaaction
...
export interface AuthenticationepaactionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationepaaction#csecexpr Authenticationepaaction#csecexpr}
  */
  readonly csecexpr: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationepaaction#defaultepagroup Authenticationepaaction#defaultepagroup}
  */
  readonly defaultepagroup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationepaaction#deletefiles Authenticationepaaction#deletefiles}
  */
  readonly deletefiles?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationepaaction#id Authenticationepaaction#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationepaaction#killprocess Authenticationepaaction#killprocess}
  */
  readonly killprocess?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationepaaction#name Authenticationepaaction#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationepaaction#quarantinegroup Authenticationepaaction#quarantinegroup}
  */
  readonly quarantinegroup?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationepaaction citrixadc_authenticationepaaction}
*/
export class Authenticationepaaction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Authenticationepaaction that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationepaaction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationepaaction citrixadc_authenticationepaaction} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // csecexpr - computed: false, optional: false, required: true
