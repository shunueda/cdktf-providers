// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_intranetip_binding
...
export interface VpnglobalIntranetipBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_intranetip_binding#gotopriorityexpression VpnglobalIntranetipBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_intranetip_binding#id VpnglobalIntranetipBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_intranetip_binding#intranetip VpnglobalIntranetipBinding#intranetip}
  */
  readonly intranetip: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_intranetip_binding#netmask VpnglobalIntranetipBinding#netmask}
  */
  readonly netmask: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_intranetip_binding citrixadc_vpnglobal_intranetip_binding}
*/
export class VpnglobalIntranetipBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnglobalIntranetipBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_intranetip_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/vpnglobal_intranetip_binding citrixadc_vpnglobal_intranetip_binding} Resource
  *
  * @param scope The scope in which to define this construct
