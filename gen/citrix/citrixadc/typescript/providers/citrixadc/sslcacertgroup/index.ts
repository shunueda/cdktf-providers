// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslcacertgroup
...
export interface SslcacertgroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslcacertgroup#cacertgroupname Sslcacertgroup#cacertgroupname}
  */
  readonly cacertgroupname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslcacertgroup#id Sslcacertgroup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslcacertgroup citrixadc_sslcacertgroup}
*/
export class Sslcacertgroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sslcacertgroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslcacertgroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/sslcacertgroup citrixadc_sslcacertgroup} Resource
  *
  * @param scope The scope in which to define this construct
