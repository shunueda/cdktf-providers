// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/data-sources/sslcipher_sslvserver_bindings
...
export interface DataCitrixadcSslcipherSslvserverBindingsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/data-sources/sslcipher_sslvserver_bindings#ciphername DataCitrixadcSslcipherSslvserverBindings#ciphername}
  */
  readonly ciphername: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/data-sources/sslcipher_sslvserver_bindings#id DataCitrixadcSslcipherSslvserverBindings#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/data-sources/sslcipher_sslvserver_bindings citrixadc_sslcipher_sslvserver_bindings}
*/
export class DataCitrixadcSslcipherSslvserverBindings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCitrixadcSslcipherSslvserverBindings that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/data-sources/sslcipher_sslvserver_bindings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/data-sources/sslcipher_sslvserver_bindings citrixadc_sslcipher_sslvserver_bindings} Data Source
  *
  * @param scope The scope in which to define this construct
