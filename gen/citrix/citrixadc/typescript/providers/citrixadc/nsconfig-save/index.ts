// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nsconfig_save
...
export interface NsconfigSaveConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nsconfig_save#all NsconfigSave#all}
  */
  readonly all?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nsconfig_save#concurrent_save_interval NsconfigSave#concurrent_save_interval}
  */
  readonly concurrentSaveInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nsconfig_save#concurrent_save_ok NsconfigSave#concurrent_save_ok}
  */
  readonly concurrentSaveOk?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nsconfig_save#concurrent_save_retries NsconfigSave#concurrent_save_retries}
  */
  readonly concurrentSaveRetries?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nsconfig_save#concurrent_save_timeout NsconfigSave#concurrent_save_timeout}
  */
  readonly concurrentSaveTimeout?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nsconfig_save#id NsconfigSave#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nsconfig_save#save_on_destroy NsconfigSave#save_on_destroy}
  */
  readonly saveOnDestroy?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nsconfig_save#timestamp NsconfigSave#timestamp}
  */
  readonly timestamp: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nsconfig_save citrixadc_nsconfig_save}
*/
export class NsconfigSave extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NsconfigSave that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nsconfig_save#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/nsconfig_save citrixadc_nsconfig_save} Resource
  *
  * @param scope The scope in which to define this construct
