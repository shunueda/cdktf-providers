// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnlogprofile
...
export interface LsnlogprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnlogprofile#analyticsprofile Lsnlogprofile#analyticsprofile}
  */
  readonly analyticsprofile?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnlogprofile#id Lsnlogprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnlogprofile#logcompact Lsnlogprofile#logcompact}
  */
  readonly logcompact?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnlogprofile#logipfix Lsnlogprofile#logipfix}
  */
  readonly logipfix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnlogprofile#logprofilename Lsnlogprofile#logprofilename}
  */
  readonly logprofilename: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnlogprofile#logsessdeletion Lsnlogprofile#logsessdeletion}
  */
  readonly logsessdeletion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnlogprofile#logsubscrinfo Lsnlogprofile#logsubscrinfo}
  */
  readonly logsubscrinfo?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnlogprofile citrixadc_lsnlogprofile}
*/
export class Lsnlogprofile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lsnlogprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnlogprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/lsnlogprofile citrixadc_lsnlogprofile} Resource
  *
  * @param scope The scope in which to define this construct
