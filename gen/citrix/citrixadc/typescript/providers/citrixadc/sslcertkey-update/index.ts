// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcertkey_update
...
export interface SslcertkeyUpdateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcertkey_update#cert SslcertkeyUpdate#cert}
  */
  readonly cert?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcertkey_update#certkey SslcertkeyUpdate#certkey}
  */
  readonly certkey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcertkey_update#fipskey SslcertkeyUpdate#fipskey}
  */
  readonly fipskey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcertkey_update#id SslcertkeyUpdate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcertkey_update#inform SslcertkeyUpdate#inform}
  */
  readonly inform?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcertkey_update#key SslcertkeyUpdate#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcertkey_update#linkcertkeyname SslcertkeyUpdate#linkcertkeyname}
  */
  readonly linkcertkeyname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcertkey_update#nodomaincheck SslcertkeyUpdate#nodomaincheck}
  */
  readonly nodomaincheck?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcertkey_update#passplain SslcertkeyUpdate#passplain}
  */
  readonly passplain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcertkey_update#password SslcertkeyUpdate#password}
  */
  readonly password?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcertkey_update citrixadc_sslcertkey_update}
*/
export class SslcertkeyUpdate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslcertkeyUpdate that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcertkey_update#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslcertkey_update citrixadc_sslcertkey_update} Resource
  *
  * @param scope The scope in which to define this construct
