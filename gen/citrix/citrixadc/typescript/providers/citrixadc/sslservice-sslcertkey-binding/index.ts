// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslservice_sslcertkey_binding
...
export interface SslserviceSslcertkeyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslservice_sslcertkey_binding#ca SslserviceSslcertkeyBinding#ca}
  */
  readonly ca?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslservice_sslcertkey_binding#certkeyname SslserviceSslcertkeyBinding#certkeyname}
  */
  readonly certkeyname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslservice_sslcertkey_binding#crlcheck SslserviceSslcertkeyBinding#crlcheck}
  */
  readonly crlcheck?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslservice_sslcertkey_binding#id SslserviceSslcertkeyBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslservice_sslcertkey_binding#ocspcheck SslserviceSslcertkeyBinding#ocspcheck}
  */
  readonly ocspcheck?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslservice_sslcertkey_binding#servicename SslserviceSslcertkeyBinding#servicename}
  */
  readonly servicename: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslservice_sslcertkey_binding#skipcaname SslserviceSslcertkeyBinding#skipcaname}
  */
  readonly skipcaname?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslservice_sslcertkey_binding#snicert SslserviceSslcertkeyBinding#snicert}
  */
  readonly snicert?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslservice_sslcertkey_binding citrixadc_sslservice_sslcertkey_binding}
*/
export class SslserviceSslcertkeyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslserviceSslcertkeyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslservice_sslcertkey_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/sslservice_sslcertkey_binding citrixadc_sslservice_sslcertkey_binding} Resource
  *
  * @param scope The scope in which to define this construct
