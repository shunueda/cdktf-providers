// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsvpxparam
...
export interface NsvpxparamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsvpxparam#cpuyield Nsvpxparam#cpuyield}
  */
  readonly cpuyield?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsvpxparam#id Nsvpxparam#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsvpxparam#kvmvirtiomultiqueue Nsvpxparam#kvmvirtiomultiqueue}
  */
  readonly kvmvirtiomultiqueue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsvpxparam#masterclockcpu1 Nsvpxparam#masterclockcpu1}
  */
  readonly masterclockcpu1?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsvpxparam#ownernode Nsvpxparam#ownernode}
  */
  readonly ownernode?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsvpxparam citrixadc_nsvpxparam}
*/
export class Nsvpxparam extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Nsvpxparam that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsvpxparam#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/nsvpxparam citrixadc_nsvpxparam} Resource
  *
  * @param scope The scope in which to define this construct
