// https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaagroup_intranetip_binding
...
export interface AaagroupIntranetipBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaagroup_intranetip_binding#gotopriorityexpression AaagroupIntranetipBinding#gotopriorityexpression}
  */
  readonly gotopriorityexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaagroup_intranetip_binding#groupname AaagroupIntranetipBinding#groupname}
  */
  readonly groupname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaagroup_intranetip_binding#id AaagroupIntranetipBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaagroup_intranetip_binding#intranetip AaagroupIntranetipBinding#intranetip}
  */
  readonly intranetip: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaagroup_intranetip_binding#netmask AaagroupIntranetipBinding#netmask}
  */
  readonly netmask: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaagroup_intranetip_binding citrixadc_aaagroup_intranetip_binding}
*/
export class AaagroupIntranetipBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AaagroupIntranetipBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaagroup_intranetip_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.0.0/docs/resources/aaagroup_intranetip_binding citrixadc_aaagroup_intranetip_binding} Resource
  *
  * @param scope The scope in which to define this construct
