// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appqoeparameter
...
export interface AppqoeparameterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appqoeparameter#avgwaitingclient Appqoeparameter#avgwaitingclient}
  */
  readonly avgwaitingclient?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appqoeparameter#dosattackthresh Appqoeparameter#dosattackthresh}
  */
  readonly dosattackthresh?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appqoeparameter#id Appqoeparameter#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appqoeparameter#maxaltrespbandwidth Appqoeparameter#maxaltrespbandwidth}
  */
  readonly maxaltrespbandwidth?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appqoeparameter#sessionlife Appqoeparameter#sessionlife}
  */
  readonly sessionlife?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appqoeparameter citrixadc_appqoeparameter}
*/
export class Appqoeparameter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Appqoeparameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appqoeparameter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/appqoeparameter citrixadc_appqoeparameter} Resource
  *
  * @param scope The scope in which to define this construct
