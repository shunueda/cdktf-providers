// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_lbvserver_binding
...
export interface ClusternodegroupLbvserverBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_lbvserver_binding#id ClusternodegroupLbvserverBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_lbvserver_binding#name ClusternodegroupLbvserverBinding#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_lbvserver_binding#vserver ClusternodegroupLbvserverBinding#vserver}
  */
  readonly vserver: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_lbvserver_binding citrixadc_clusternodegroup_lbvserver_binding}
*/
export class ClusternodegroupLbvserverBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusternodegroupLbvserverBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_lbvserver_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/clusternodegroup_lbvserver_binding citrixadc_clusternodegroup_lbvserver_binding} Resource
  *
  * @param scope The scope in which to define this construct
