// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationloginschema
...
export interface AuthenticationloginschemaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationloginschema#authenticationschema Authenticationloginschema#authenticationschema}
  */
  readonly authenticationschema: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationloginschema#authenticationstrength Authenticationloginschema#authenticationstrength}
  */
  readonly authenticationstrength?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationloginschema#id Authenticationloginschema#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationloginschema#name Authenticationloginschema#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationloginschema#passwdexpression Authenticationloginschema#passwdexpression}
  */
  readonly passwdexpression?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationloginschema#passwordcredentialindex Authenticationloginschema#passwordcredentialindex}
  */
  readonly passwordcredentialindex?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationloginschema#ssocredentials Authenticationloginschema#ssocredentials}
  */
  readonly ssocredentials?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationloginschema#usercredentialindex Authenticationloginschema#usercredentialindex}
  */
  readonly usercredentialindex?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationloginschema#userexpression Authenticationloginschema#userexpression}
  */
  readonly userexpression?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationloginschema citrixadc_authenticationloginschema}
*/
export class Authenticationloginschema extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Authenticationloginschema that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationloginschema#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/authenticationloginschema citrixadc_authenticationloginschema} Resource
  *
  * @param scope The scope in which to define this construct
