// https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcipher_binding
...
export interface SslprofileSslcipherBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcipher_binding#ciphername SslprofileSslcipherBinding#ciphername}
  */
  readonly ciphername: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcipher_binding#cipherpriority SslprofileSslcipherBinding#cipherpriority}
  */
  readonly cipherpriority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcipher_binding#id SslprofileSslcipherBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcipher_binding#name SslprofileSslcipherBinding#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcipher_binding citrixadc_sslprofile_sslcipher_binding}
*/
export class SslprofileSslcipherBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslprofileSslcipherBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcipher_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/2.1.0/docs/resources/sslprofile_sslcipher_binding citrixadc_sslprofile_sslcipher_binding} Resource
  *
  * @param scope The scope in which to define this construct
