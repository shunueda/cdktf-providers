// https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_ipreputation_binding
...
export interface BotprofileIpreputationBindingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_ipreputation_binding#bot_bind_comment BotprofileIpreputationBinding#bot_bind_comment}
  */
  readonly botBindComment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_ipreputation_binding#bot_iprep_action BotprofileIpreputationBinding#bot_iprep_action}
  */
  readonly botIprepAction?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_ipreputation_binding#bot_iprep_enabled BotprofileIpreputationBinding#bot_iprep_enabled}
  */
  readonly botIprepEnabled?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_ipreputation_binding#bot_ipreputation BotprofileIpreputationBinding#bot_ipreputation}
  */
  readonly botIpreputation?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_ipreputation_binding#category BotprofileIpreputationBinding#category}
  */
  readonly category: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_ipreputation_binding#id BotprofileIpreputationBinding#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_ipreputation_binding#logmessage BotprofileIpreputationBinding#logmessage}
  */
  readonly logmessage?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_ipreputation_binding#name BotprofileIpreputationBinding#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_ipreputation_binding citrixadc_botprofile_ipreputation_binding}
*/
export class BotprofileIpreputationBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BotprofileIpreputationBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_ipreputation_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrixadc/1.45.0/docs/resources/botprofile_ipreputation_binding citrixadc_botprofile_ipreputation_binding} Resource
  *
  * @param scope The scope in which to define this construct
