// https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor
...
export interface XenserverHypervisorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor#addresses XenserverHypervisor#addresses}
  */
  readonly addresses: string[];
  /**
  * Maximum number of actions that can execute in parallel on the hypervisor. Default is 40.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor#max_absolute_active_actions XenserverHypervisor#max_absolute_active_actions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor#max_absolute_new_actions_per_minute XenserverHypervisor#max_absolute_new_actions_per_minute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor#max_power_actions_percentage_of_machines XenserverHypervisor#max_power_actions_percentage_of_machines}
  */
  readonly maxPowerActionsPercentageOfMachines?: number;
  /**
  * Metadata for the Hypervisor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor#metadata XenserverHypervisor#metadata}
  */
  readonly metadata?: XenserverHypervisorMetadata[] | cdktf.IResolvable;
  /**
  * Name of the hypervisor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor#name XenserverHypervisor#name}
  */
  readonly name: string;
  /**
  * Password of the hypervisor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor#password XenserverHypervisor#password}
  */
  readonly password: string;
  /**
  * Password format of the hypervisor. Choose between Base64 and PlainText.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor#password_format XenserverHypervisor#password_format}
  */
  readonly passwordFormat: string;
  /**
  * The IDs of the scopes for the hypervisor to be a part of.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor#scopes XenserverHypervisor#scopes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor#ssl_thumbprints XenserverHypervisor#ssl_thumbprints}
  */
  readonly sslThumbprints?: string[];
  /**
  * Username of the hypervisor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor#username XenserverHypervisor#username}
  */
  readonly username: string;
  /**
  * Id of the zone the hypervisor is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor#zone XenserverHypervisor#zone}
  */
...
export interface XenserverHypervisorMetadata {
  ...
  * Metadata value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor#value XenserverHypervisor#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor citrix_xenserver_hypervisor}
*/
export class XenserverHypervisor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing XenserverHypervisor that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/xenserver_hypervisor citrix_xenserver_hypervisor} Resource
  *
  * @param scope The scope in which to define this construct
