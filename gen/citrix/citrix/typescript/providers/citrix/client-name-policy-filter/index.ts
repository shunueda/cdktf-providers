// https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/client_name_policy_filter
...
export interface ClientNamePolicyFilterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/client_name_policy_filter#allowed ClientNamePolicyFilter#allowed}
  */
  readonly allowed: boolean | cdktf.IResolvable;
  /**
  * Name of the client to be filtered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/client_name_policy_filter#client_name ClientNamePolicyFilter#client_name}
  */
  readonly clientName: string;
  /**
  * Indicate whether the filter is being enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/client_name_policy_filter#enabled ClientNamePolicyFilter#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Id of the policy to which the filter belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/client_name_policy_filter#policy_id ClientNamePolicyFilter#policy_id}
  */
  readonly policyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/client_name_policy_filter citrix_client_name_policy_filter}
*/
export class ClientNamePolicyFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClientNamePolicyFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/client_name_policy_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/citrix/citrix/1.0.30/docs/resources/client_name_policy_filter citrix_client_name_policy_filter} Resource
  *
  * @param scope The scope in which to define this construct
