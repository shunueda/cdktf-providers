// https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/application_key
...
export interface DataB2ApplicationKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/application_key#id DataB2ApplicationKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/application_key#key_name DataB2ApplicationKey#key_name}
  */
  readonly keyName: string;
  /**
  * When present, restricts access to files whose names start with the prefix.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/application_key#name_prefix DataB2ApplicationKey#name_prefix}
  */
  readonly namePrefix?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/application_key b2_application_key}
*/
export class DataB2ApplicationKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataB2ApplicationKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/application_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/application_key b2_application_key} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // bucket_ids - computed: true, optional: false, required: false
