// https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/bucket
...
export interface DataB2BucketConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/bucket#bucket_name DataB2Bucket#bucket_name}
  */
  readonly bucketName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/bucket#id DataB2Bucket#id}
  *
...
export class DataB2BucketLifecycleRulesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // days_from_starting_to_canceling_unfinished_large_files - computed: true, optional: false, required: false
...
/**
* Represents a {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/bucket b2_bucket}
*/
export class DataB2Bucket extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataB2Bucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/bucket b2_bucket} Data Source
  *
  * @param scope The scope in which to define this construct
