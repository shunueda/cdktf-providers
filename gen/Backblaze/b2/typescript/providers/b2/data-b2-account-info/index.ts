// https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs/data-sources/account_info
...
export interface DataB2AccountInfoConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs/data-sources/account_info#id DataB2AccountInfo#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs/data-sources/account_info b2_account_info}
*/
export class DataB2AccountInfo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataB2AccountInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs/data-sources/account_info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs/data-sources/account_info b2_account_info} Data Source
  *
  * @param scope The scope in which to define this construct
