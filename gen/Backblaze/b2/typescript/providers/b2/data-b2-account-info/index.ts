// https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/account_info
...
export interface DataB2AccountInfoConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/account_info#id DataB2AccountInfo#id}
  *
...
export interface DataB2AccountInfoAllowedBuckets {
}

export function dataB2AccountInfoAllowedBucketsToTerraform(struct?: DataB2AccountInfoAllowedBuckets): any {
...
export function dataB2AccountInfoAllowedBucketsToHclTerraform(struct?: DataB2AccountInfoAllowedBuckets): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataB2AccountInfoAllowedBucketsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataB2AccountInfoAllowedBuckets | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataB2AccountInfoAllowedBuckets | undefined) {
    if (value === undefined) {
...
export class DataB2AccountInfoAllowedBucketsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataB2AccountInfoAllowedBucketsOutputReference {
    return new DataB2AccountInfoAllowedBucketsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataB2AccountInfoAllowedOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _buckets = new DataB2AccountInfoAllowedBucketsList(this, "buckets", false);
  public get buckets() {
...
/**
* Represents a {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/account_info b2_account_info}
*/
export class DataB2AccountInfo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataB2AccountInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/account_info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/backblaze/b2/0.12.0/docs/data-sources/account_info b2_account_info} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // absolute_minimum_part_size - computed: true, optional: false, required: false
  public get absoluteMinimumPartSize() {
    return this.getNumberAttribute('absolute_minimum_part_size');
  }
  ...
  // recommended_part_size - computed: true, optional: false, required: false
  public get recommendedPartSize() {
    return this.getNumberAttribute('recommended_part_size');
  }
