// https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs/resources/application_key
...
export interface ApplicationKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs/resources/application_key#bucket_id ApplicationKey#bucket_id}
  */
  readonly bucketId?: string;
  /**
  * A set of strings, each one naming a capability the key has.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs/resources/application_key#capabilities ApplicationKey#capabilities}
  */
  readonly capabilities: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs/resources/application_key#id ApplicationKey#id}
  *
  ...
  * The name of the key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs/resources/application_key#key_name ApplicationKey#key_name}
  */
  readonly keyName: string;
  /**
  * When present, restricts access to files whose names start with the prefix.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs/resources/application_key#name_prefix ApplicationKey#name_prefix}
  */
  readonly namePrefix?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs/resources/application_key b2_application_key}
*/
export class ApplicationKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs/resources/application_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs/resources/application_key b2_application_key} Resource
  *
  * @param scope The scope in which to define this construct
