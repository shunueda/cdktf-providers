// https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs
...
export interface B2ProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs#application_key B2Provider#application_key}
  */
  readonly applicationKey?: string;
  /**
  * B2 Application Key ID (B2_APPLICATION_KEY_ID env)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs#application_key_id B2Provider#application_key_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs#endpoint B2Provider#endpoint}
  */
  readonly endpoint?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs#alias B2Provider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs b2}
*/
export class B2Provider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing B2Provider that should be imported. Refer to the {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/backblaze/b2/0.10.0/docs b2} Resource
  *
  * @param scope The scope in which to define this construct
