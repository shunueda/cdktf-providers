// https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/cloud_account_log_profile_association
...
export interface CloudAccountLogProfileAssociationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/cloud_account_log_profile_association#csp_account_name CloudAccountLogProfileAssociation#csp_account_name}
  */
  readonly cspAccountName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/cloud_account_log_profile_association#id CloudAccountLogProfileAssociation#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/cloud_account_log_profile_association#log_profile_id CloudAccountLogProfileAssociation#log_profile_id}
  */
  readonly logProfileId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/cloud_account_log_profile_association valtix_cloud_account_log_profile_association}
*/
export class CloudAccountLogProfileAssociation extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "valtix_cloud_account_log_profile_association";
  ...
  * @param importFromId The id of the existing CloudAccountLogProfileAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/cloud_account_log_profile_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "valtix_cloud_account_log_profile_association", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/cloud_account_log_profile_association valtix_cloud_account_log_profile_association} Resource
  *
  * @param scope The scope in which to define this construct
