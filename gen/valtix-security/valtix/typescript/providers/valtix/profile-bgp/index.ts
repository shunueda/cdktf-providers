// https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp
...
export interface ProfileBgpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#description ProfileBgp#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#id ProfileBgp#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#local_as ProfileBgp#local_as}
  */
  readonly localAs: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#name ProfileBgp#name}
  */
  readonly name: string;
  /**
  * neighbor block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#neighbor ProfileBgp#neighbor}
  */
  readonly neighbor?: ProfileBgpNeighbor[] | cdktf.IResolvable;
}
export interface ProfileBgpNeighborRouteMapInCidr {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#ip ProfileBgp#ip}
  */
  readonly ip: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#mask ProfileBgp#mask}
  */
...
export interface ProfileBgpNeighbor {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#autonomous_system ProfileBgp#autonomous_system}
  */
  readonly autonomousSystem: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#ip_address ProfileBgp#ip_address}
  */
  readonly ipAddress: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#route_map_in_as_path_prepend ProfileBgp#route_map_in_as_path_prepend}
  */
  readonly routeMapInAsPathPrepend?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#route_map_in_local_pref ProfileBgp#route_map_in_local_pref}
  */
  readonly routeMapInLocalPref?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#route_map_out_as_path_prepend ProfileBgp#route_map_out_as_path_prepend}
  */
  readonly routeMapOutAsPathPrepend?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#route_map_out_local_pref ProfileBgp#route_map_out_local_pref}
  */
  readonly routeMapOutLocalPref?: number;
  /**
  * route_map_in_cidr block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#route_map_in_cidr ProfileBgp#route_map_in_cidr}
  */
  readonly routeMapInCidr?: ProfileBgpNeighborRouteMapInCidr[] | cdktf.IResolvable;
  /**
  * route_map_out_cidr block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#route_map_out_cidr ProfileBgp#route_map_out_cidr}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp valtix_profile_bgp}
*/
export class ProfileBgp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProfileBgp that should be imported. Refer to the {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/valtix-security/valtix/25.9.2/docs/resources/profile_bgp valtix_profile_bgp} Resource
  *
  * @param scope The scope in which to define this construct
