// https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/data-sources/rule_group_alerting
...
export interface DataLokiRuleGroupAlertingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/data-sources/rule_group_alerting#id DataLokiRuleGroupAlerting#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/data-sources/rule_group_alerting#name DataLokiRuleGroupAlerting#name}
  */
  readonly name: string;
  /**
  * Alerting Rule group namespace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/data-sources/rule_group_alerting#namespace DataLokiRuleGroupAlerting#namespace}
  */
  readonly namespace?: string;
  /**
  * The Organization ID. If not set, the Org ID defined in the provider block will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/data-sources/rule_group_alerting#org_id DataLokiRuleGroupAlerting#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/data-sources/rule_group_alerting loki_rule_group_alerting}
*/
export class DataLokiRuleGroupAlerting extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLokiRuleGroupAlerting that should be imported. Refer to the {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/data-sources/rule_group_alerting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/data-sources/rule_group_alerting loki_rule_group_alerting} Data Source
  *
  * @param scope The scope in which to define this construct
