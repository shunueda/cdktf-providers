// https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rules
...
export interface RulesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rules#content Rules#content}
  */
  readonly content?: string;
  /**
  * Path to YAML file containing rule groups. Mutually exclusive with 'content'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rules#content_file Rules#content_file}
  */
  readonly contentFile?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rules#id Rules#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rules#ignore_groups Rules#ignore_groups}
  */
  readonly ignoreGroups?: string[];
  /**
  * The namespace for the rule groups
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rules#namespace Rules#namespace}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rules#only_groups Rules#only_groups}
  */
  readonly onlyGroups?: string[];
  /**
  * The Organization ID. If not set, the Org ID defined in the provider block will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rules#org_id Rules#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rules loki_rules}
*/
export class Rules extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "loki_rules";
  ...
  * @param importFromId The id of the existing Rules that should be imported. Refer to the {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rules#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Rules to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "loki_rules", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rules loki_rules} Resource
  *
  * @param scope The scope in which to define this construct
