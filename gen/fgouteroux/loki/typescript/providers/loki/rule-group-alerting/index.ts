// https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting
...
export interface RuleGroupAlertingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting#id RuleGroupAlerting#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting#interval RuleGroupAlerting#interval}
  */
  readonly interval?: string;
  /**
  * Alerting Rule group name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting#name RuleGroupAlerting#name}
  */
  readonly name: string;
  /**
  * Alerting Rule group namespace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting#namespace RuleGroupAlerting#namespace}
  */
  readonly namespace?: string;
  /**
  * The Organization ID. If not set, the Org ID defined in the provider block will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting#org_id RuleGroupAlerting#org_id}
  */
  readonly orgId?: string;
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting#rule RuleGroupAlerting#rule}
  */
...
export interface RuleGroupAlertingRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting#alert RuleGroupAlerting#alert}
  */
  readonly alert: string;
  /**
  * Annotations to add to each alert.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting#annotations RuleGroupAlerting#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * The LogQL expression to evaluate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting#expr RuleGroupAlerting#expr}
  */
  readonly expr: string;
  /**
  * The duration for which the condition must be true before an alert fires.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting#for RuleGroupAlerting#for}
  */
  readonly for?: string;
  /**
  * Labels to add or overwrite for each alert.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting#labels RuleGroupAlerting#labels}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting loki_rule_group_alerting}
*/
export class RuleGroupAlerting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RuleGroupAlerting that should be imported. Refer to the {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fgouteroux/loki/1.0.1/docs/resources/rule_group_alerting loki_rule_group_alerting} Resource
  *
  * @param scope The scope in which to define this construct
