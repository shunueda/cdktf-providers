// https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording
...
export interface RuleGroupRecordingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording#evaluation_delay RuleGroupRecording#evaluation_delay}
  */
  readonly evaluationDelay?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording#id RuleGroupRecording#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording#interval RuleGroupRecording#interval}
  */
  readonly interval?: string;
  /**
  * Recording Rule group name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording#name RuleGroupRecording#name}
  */
  readonly name: string;
  /**
  * Recording Rule group namespace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording#namespace RuleGroupRecording#namespace}
  */
  readonly namespace?: string;
  /**
  * The Organization ID. If not set, the Org ID defined in the provider block will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording#org_id RuleGroupRecording#org_id}
  */
  readonly orgId?: string;
  /**
  * The duration by which to delay the execution of the recording rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording#query_offset RuleGroupRecording#query_offset}
  */
  readonly queryOffset?: string;
  /**
  * Allows aggregating data from multiple tenants while evaluating a rule group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording#source_tenants RuleGroupRecording#source_tenants}
  */
  readonly sourceTenants?: string[];
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording#rule RuleGroupRecording#rule}
  */
...
export interface RuleGroupRecordingRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording#expr RuleGroupRecording#expr}
  */
  readonly expr: string;
  /**
  * Labels to add or overwrite before storing the result.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording#labels RuleGroupRecording#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The name of the time series to output to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording#record RuleGroupRecording#record}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording mimir_rule_group_recording}
*/
export class RuleGroupRecording extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RuleGroupRecording that should be imported. Refer to the {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fgouteroux/mimir/1.0.9/docs/resources/rule_group_recording mimir_rule_group_recording} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: RuleGroupRecordingConfig) {
    ...
    this._queryOffset = config.queryOffset;
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      query_offset: cdktf.stringToTerraform(this._queryOffset),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      query_offset: {
        value: cdktf.stringToHclTerraform(this._queryOffset),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
