// https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/online_stores
...
export interface DataDatabricksOnlineStoresConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/online_stores#page_size DataDatabricksOnlineStores#page_size}
  */
  readonly pageSize?: number;
}
export interface DataDatabricksOnlineStoresOnlineStores {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/online_stores#name DataDatabricksOnlineStores#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/online_stores databricks_online_stores}
*/
export class DataDatabricksOnlineStores extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksOnlineStores that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/online_stores#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/online_stores databricks_online_stores} Data Source
  *
  * @param scope The scope in which to define this construct
