// https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/tag_policy
...
export interface DataDatabricksTagPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/tag_policy#tag_key DataDatabricksTagPolicy#tag_key}
  */
  readonly tagKey: string;
}
export interface DataDatabricksTagPolicyValues {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/tag_policy#name DataDatabricksTagPolicy#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/tag_policy databricks_tag_policy}
*/
export class DataDatabricksTagPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksTagPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/tag_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/tag_policy databricks_tag_policy} Data Source
  *
  * @param scope The scope in which to define this construct
