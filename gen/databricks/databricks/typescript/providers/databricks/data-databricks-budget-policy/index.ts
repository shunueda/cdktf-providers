// https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/budget_policy
...
export interface DataDatabricksBudgetPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/budget_policy#policy_id DataDatabricksBudgetPolicy#policy_id}
  */
  readonly policyId: string;
}
export interface DataDatabricksBudgetPolicyCustomTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/budget_policy#key DataDatabricksBudgetPolicy#key}
  */
  readonly key: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/budget_policy#value DataDatabricksBudgetPolicy#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/budget_policy databricks_budget_policy}
*/
export class DataDatabricksBudgetPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksBudgetPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/budget_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/budget_policy databricks_budget_policy} Data Source
  *
  * @param scope The scope in which to define this construct
