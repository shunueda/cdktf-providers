// https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/tag_policies
...
export interface DataDatabricksTagPoliciesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/tag_policies#page_size DataDatabricksTagPolicies#page_size}
  */
  readonly pageSize?: number;
}
export interface DataDatabricksTagPoliciesTagPoliciesValues {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/tag_policies#name DataDatabricksTagPolicies#name}
  */
...
export interface DataDatabricksTagPoliciesTagPolicies {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/tag_policies#tag_key DataDatabricksTagPolicies#tag_key}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/tag_policies databricks_tag_policies}
*/
export class DataDatabricksTagPolicies extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatabricksTagPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/tag_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/databricks/databricks/1.100.0/docs/data-sources/tag_policies databricks_tag_policies} Data Source
  *
  * @param scope The scope in which to define this construct
