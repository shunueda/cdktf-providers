// https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_topic
...
export interface DmsRocketmqTopicConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_topic#id DmsRocketmqTopic#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_topic#instance_id DmsRocketmqTopic#instance_id}
  */
  readonly instanceId: string;
  /**
  * Specifies the name of the topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_topic#name DmsRocketmqTopic#name}
  */
  readonly name: string;
  /**
  * Specifies the permissions of the topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_topic#permission DmsRocketmqTopic#permission}
  */
  readonly permission?: string;
  /**
  * Specifies the number of queues.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_topic#queue_num DmsRocketmqTopic#queue_num}
  */
  readonly queueNum?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_topic#region DmsRocketmqTopic#region}
  */
  readonly region?: string;
  /**
  * Specifies the total number of read queues.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_topic#total_read_queue_num DmsRocketmqTopic#total_read_queue_num}
  */
  readonly totalReadQueueNum?: number;
  /**
  * Specifies the total number of write queues.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_topic#total_write_queue_num DmsRocketmqTopic#total_write_queue_num}
  */
  readonly totalWriteQueueNum?: number;
  /**
  * brokers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_topic#brokers DmsRocketmqTopic#brokers}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_topic flexibleengine_dms_rocketmq_topic}
*/
export class DmsRocketmqTopic extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "flexibleengine_dms_rocketmq_topic";
  ...
  * @param importFromId The id of the existing DmsRocketmqTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_topic#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DmsRocketmqTopic to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "flexibleengine_dms_rocketmq_topic", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_topic flexibleengine_dms_rocketmq_topic} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DmsRocketmqTopicConfig) {
    super(scope, id, {
      terraformResourceType: 'flexibleengine_dms_rocketmq_topic',
