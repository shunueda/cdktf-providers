// https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer
...
export interface ApigCustomAuthorizerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer#cache_age ApigCustomAuthorizer#cache_age}
  */
  readonly cacheAge?: number;
  /**
  * The URN of the FGS function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer#function_urn ApigCustomAuthorizer#function_urn}
  */
  readonly functionUrn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer#id ApigCustomAuthorizer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer#instance_id ApigCustomAuthorizer#instance_id}
  */
  readonly instanceId: string;
  /**
  * Whether to send the body.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer#is_body_send ApigCustomAuthorizer#is_body_send}
  */
  readonly isBodySend?: boolean | cdktf.IResolvable;
  /**
  * The name of the custom authorizer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer#name ApigCustomAuthorizer#name}
  */
  readonly name: string;
  /**
  * The region where the custom authorizer is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer#region ApigCustomAuthorizer#region}
  */
  readonly region?: string;
  /**
  * The custom authorization type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer#type ApigCustomAuthorizer#type}
  */
  readonly type?: string;
  /**
  * The user data for custom authorizer function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer#user_data ApigCustomAuthorizer#user_data}
  */
  readonly userData?: string;
  /**
  * identity block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer#identity ApigCustomAuthorizer#identity}
  */
...
export interface ApigCustomAuthorizerIdentity {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer#location ApigCustomAuthorizer#location}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer#validation ApigCustomAuthorizer#validation}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer flexibleengine_apig_custom_authorizer}
*/
export class ApigCustomAuthorizer extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "flexibleengine_apig_custom_authorizer";
  ...
  * @param importFromId The id of the existing ApigCustomAuthorizer that should be imported. Refer to the {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "flexibleengine_apig_custom_authorizer", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_custom_authorizer flexibleengine_apig_custom_authorizer} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ApigCustomAuthorizerConfig) {
    super(scope, id, {
      terraformResourceType: 'flexibleengine_apig_custom_authorizer',
