// https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy
...
export interface CbrPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#backup_quantity CbrPolicy#backup_quantity}
  */
  readonly backupQuantity?: number;
  /**
  * The ID of the replication destination project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#destination_project_id CbrPolicy#destination_project_id}
  */
  readonly destinationProjectId?: string;
  /**
  * The name of the replication destination region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#destination_region CbrPolicy#destination_region}
  */
  readonly destinationRegion?: string;
  /**
  * Whether to enable the acceleration function to shorten the replication time for cross-region
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#enable_acceleration CbrPolicy#enable_acceleration}
  */
  readonly enableAcceleration?: boolean | cdktf.IResolvable;
  /**
  * Whether to enable the CBR policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#enabled CbrPolicy#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#id CbrPolicy#id}
  *
  ...
  * The policy name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#name CbrPolicy#name}
  */
  readonly name: string;
  /**
  * The region where the policy is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#region CbrPolicy#region}
  */
  readonly region?: string;
  /**
  * The duration (in days) for retained backups.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#time_period CbrPolicy#time_period}
  */
  readonly timePeriod?: number;
  /**
  * The UTC time zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#time_zone CbrPolicy#time_zone}
  */
  readonly timeZone?: string;
  /**
  * The protection type of the CBR policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#type CbrPolicy#type}
  */
  readonly type: string;
  /**
  * backup_cycle block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#backup_cycle CbrPolicy#backup_cycle}
  */
  readonly backupCycle: CbrPolicyBackupCycle;
  /**
  * long_term_retention block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#long_term_retention CbrPolicy#long_term_retention}
  */
...
export interface CbrPolicyBackupCycle {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#days CbrPolicy#days}
  */
  readonly days?: string;
  /**
  * The execution time of the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#execution_times CbrPolicy#execution_times}
  */
  readonly executionTimes: string[];
  /**
  * The number of days between each backup.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#interval CbrPolicy#interval}
  */
...
export interface CbrPolicyLongTermRetention {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#daily CbrPolicy#daily}
  */
  readonly daily?: number;
  /**
  * How often (after how many incremental backups) a full backup is performed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#full_backup_interval CbrPolicy#full_backup_interval}
  */
  readonly fullBackupInterval?: number;
  /**
  * The latest backup of each month is saved in the long term.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#monthly CbrPolicy#monthly}
  */
  readonly monthly?: number;
  /**
  * The latest backup of each week is saved in the long term.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#weekly CbrPolicy#weekly}
  */
  readonly weekly?: number;
  /**
  * The latest backup of each year is saved in the long term.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#yearly CbrPolicy#yearly}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy flexibleengine_cbr_policy}
*/
export class CbrPolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "flexibleengine_cbr_policy";
  ...
  * @param importFromId The id of the existing CbrPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the CbrPolicy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "flexibleengine_cbr_policy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_policy flexibleengine_cbr_policy} Resource
  *
  * @param scope The scope in which to define this construct
