// https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault
...
export interface CbrVaultConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#auto_bind CbrVault#auto_bind}
  */
  readonly autoBind?: boolean | cdktf.IResolvable;
  /**
  * Whether to enable auto capacity expansion for the vault.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#auto_expand CbrVault#auto_expand}
  */
  readonly autoExpand?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#auto_pay CbrVault#auto_pay}
  */
  readonly autoPay?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#auto_renew CbrVault#auto_renew}
  */
  readonly autoRenew?: string;
  /**
  * The backup name prefix.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#backup_name_prefix CbrVault#backup_name_prefix}
  */
  readonly backupNamePrefix?: string;
  /**
  * The rules for automatic association.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#bind_rules CbrVault#bind_rules}
  */
  readonly bindRules?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#charging_mode CbrVault#charging_mode}
  */
  readonly chargingMode?: string;
  /**
  * The consistent level (specification) of the vault.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#consistent_level CbrVault#consistent_level}
  */
  readonly consistentLevel?: string;
  /**
  * The enterprise project ID to which the vault belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#enterprise_project_id CbrVault#enterprise_project_id}
  */
  readonly enterpriseProjectId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#id CbrVault#id}
  *
  ...
  * The vault name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#name CbrVault#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#period CbrVault#period}
  */
  readonly period?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#period_unit CbrVault#period_unit}
  */
  readonly periodUnit?: string;
  /**
  * schema:Deprecated; Using parameter 'policy' instead.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#policy_id CbrVault#policy_id}
  */
  readonly policyId?: string;
  /**
  * The protection type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#protection_type CbrVault#protection_type}
  */
  readonly protectionType: string;
  /**
  * The region where the vault is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#region CbrVault#region}
  */
  readonly region?: string;
  /**
  * The capacity of the vault, in GB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#size CbrVault#size}
  */
  readonly size: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#tags CbrVault#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The vault type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#type CbrVault#type}
  */
  readonly type: string;
  /**
  * policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#policy CbrVault#policy}
  */
  readonly policy?: CbrVaultPolicy[] | cdktf.IResolvable;
  /**
  * resources block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#resources CbrVault#resources}
  */
  readonly resources?: CbrVaultResources[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#timeouts CbrVault#timeouts}
  */
...
export interface CbrVaultPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#destination_vault_id CbrVault#destination_vault_id}
  */
...
export interface CbrVaultResources {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#excludes CbrVault#excludes}
  */
  readonly excludes?: string[];
  /**
  * The array of disk or SFS file systems which will be included in the backup.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#includes CbrVault#includes}
  */
  readonly includes?: string[];
  /**
  * The ID of the ECS instance to be backed up.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#server_id CbrVault#server_id}
  */
...
export interface CbrVaultTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#create CbrVault#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#delete CbrVault#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault flexibleengine_cbr_vault}
*/
export class CbrVault extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "flexibleengine_cbr_vault";
  ...
  * @param importFromId The id of the existing CbrVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the CbrVault to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "flexibleengine_cbr_vault", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/cbr_vault flexibleengine_cbr_vault} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: CbrVaultConfig) {
    super(scope, id, {
      terraformResourceType: 'flexibleengine_cbr_vault',
