// https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/modelarts_dataset_version
...
export interface ModelartsDatasetVersionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/modelarts_dataset_version#dataset_id ModelartsDatasetVersion#dataset_id}
  */
  readonly datasetId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/modelarts_dataset_version#description ModelartsDatasetVersion#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/modelarts_dataset_version#hard_example ModelartsDatasetVersion#hard_example}
  */
  readonly hardExample?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/modelarts_dataset_version#id ModelartsDatasetVersion#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/modelarts_dataset_version#name ModelartsDatasetVersion#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/modelarts_dataset_version#region ModelartsDatasetVersion#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/modelarts_dataset_version#split_ratio ModelartsDatasetVersion#split_ratio}
  */
  readonly splitRatio?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/modelarts_dataset_version#timeouts ModelartsDatasetVersion#timeouts}
  */
  readonly timeouts?: ModelartsDatasetVersionTimeouts;
}
export interface ModelartsDatasetVersionTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/modelarts_dataset_version#create ModelartsDatasetVersion#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/modelarts_dataset_version flexibleengine_modelarts_dataset_version}
*/
export class ModelartsDatasetVersion extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "flexibleengine_modelarts_dataset_version";
  ...
  * @param importFromId The id of the existing ModelartsDatasetVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/modelarts_dataset_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "flexibleengine_modelarts_dataset_version", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/modelarts_dataset_version flexibleengine_modelarts_dataset_version} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ModelartsDatasetVersionConfig) {
    super(scope, id, {
      terraformResourceType: 'flexibleengine_modelarts_dataset_version',
