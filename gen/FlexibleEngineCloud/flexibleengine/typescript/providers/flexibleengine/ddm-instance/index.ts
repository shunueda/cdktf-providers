// https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance
...
export interface DdmInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#admin_password DdmInstance#admin_password}
  */
  readonly adminPassword?: string;
  /**
  * Specifies the username of the administrator.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#admin_user DdmInstance#admin_user}
  */
  readonly adminUser?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#auto_renew DdmInstance#auto_renew}
  */
  readonly autoRenew?: string;
  /**
  * Specifies the list of availability zones.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#availability_zones DdmInstance#availability_zones}
  */
  readonly availabilityZones: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#charging_mode DdmInstance#charging_mode}
  */
  readonly chargingMode?: string;
  /**
  * Specifies whether data stored on the associated DB instances is deleted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#delete_rds_data DdmInstance#delete_rds_data}
  */
  readonly deleteRdsData?: string;
  /**
  * Specifies the ID of an Engine.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#engine_id DdmInstance#engine_id}
  */
  readonly engineId: string;
  /**
  * Specifies the enterprise project id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#enterprise_project_id DdmInstance#enterprise_project_id}
  */
  readonly enterpriseProjectId?: string;
  /**
  * Specifies the ID of a product.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#flavor_id DdmInstance#flavor_id}
  */
  readonly flavorId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#id DdmInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#name DdmInstance#name}
  */
  readonly name: string;
  /**
  * Specifies the number of nodes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#node_num DdmInstance#node_num}
  */
  readonly nodeNum: number;
  /**
  * Specifies the ID of parameter group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#param_group_id DdmInstance#param_group_id}
  */
  readonly paramGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#period DdmInstance#period}
  */
  readonly period?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#period_unit DdmInstance#period_unit}
  */
  readonly periodUnit?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#region DdmInstance#region}
  */
  readonly region?: string;
  /**
  * Specifies the ID of a security group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#security_group_id DdmInstance#security_group_id}
  */
  readonly securityGroupId: string;
  /**
  * Specifies the ID of a subnet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#subnet_id DdmInstance#subnet_id}
  */
  readonly subnetId: string;
  /**
  * Specifies the time zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#time_zone DdmInstance#time_zone}
  */
  readonly timeZone?: string;
  /**
  * Specifies the ID of a VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#vpc_id DdmInstance#vpc_id}
  */
  readonly vpcId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#timeouts DdmInstance#timeouts}
  */
...
export interface DdmInstanceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#create DdmInstance#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#delete DdmInstance#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#update DdmInstance#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance flexibleengine_ddm_instance}
*/
export class DdmInstance extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "flexibleengine_ddm_instance";
  ...
  * @param importFromId The id of the existing DdmInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DdmInstance to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "flexibleengine_ddm_instance", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/ddm_instance flexibleengine_ddm_instance} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DdmInstanceConfig) {
    super(scope, id, {
      terraformResourceType: 'flexibleengine_ddm_instance',
