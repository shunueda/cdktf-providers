// https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_api_publishment
...
export interface ApigApiPublishmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_api_publishment#api_id ApigApiPublishment#api_id}
  */
  readonly apiId: string;
  /**
  * The description of the current publishment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_api_publishment#description ApigApiPublishment#description}
  */
  readonly description?: string;
  /**
  * The ID of the environment to which the current version of the API will be published or has been published.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_api_publishment#env_id ApigApiPublishment#env_id}
  */
  readonly envId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_api_publishment#id ApigApiPublishment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_api_publishment#instance_id ApigApiPublishment#instance_id}
  */
  readonly instanceId: string;
  /**
  * The region in which to publish API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_api_publishment#region ApigApiPublishment#region}
  */
  readonly region?: string;
  /**
  * The version ID of the current publishment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_api_publishment#version_id ApigApiPublishment#version_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_api_publishment flexibleengine_apig_api_publishment}
*/
export class ApigApiPublishment extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "flexibleengine_apig_api_publishment";
  ...
  * @param importFromId The id of the existing ApigApiPublishment that should be imported. Refer to the {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_api_publishment#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ApigApiPublishment to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "flexibleengine_apig_api_publishment", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_api_publishment flexibleengine_apig_api_publishment} Resource
  *
  * @param scope The scope in which to define this construct
