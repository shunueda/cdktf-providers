// https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection
...
export interface DliDatasourceConnectionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection#id DliDatasourceConnection#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection#name DliDatasourceConnection#name}
  */
  readonly name: string;
  /**
  * List of queue names that are available for datasource connections.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection#queues DliDatasourceConnection#queues}
  */
  readonly queues?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection#region DliDatasourceConnection#region}
  */
  readonly region?: string;
  /**
  * The route table ID associated with the subnet of the service to be connected.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection#route_table_id DliDatasourceConnection#route_table_id}
  */
  readonly routeTableId?: string;
  /**
  * The subnet ID of the service to be connected.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection#subnet_id DliDatasourceConnection#subnet_id}
  */
  readonly subnetId: string;
  /**
  * The key/value pairs to associate with the datasource connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection#tags DliDatasourceConnection#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The VPC ID of the service to be connected.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection#vpc_id DliDatasourceConnection#vpc_id}
  */
  readonly vpcId: string;
  /**
  * hosts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection#hosts DliDatasourceConnection#hosts}
  */
  readonly hosts?: DliDatasourceConnectionHosts[] | cdktf.IResolvable;
  /**
  * routes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection#routes DliDatasourceConnection#routes}
  */
...
export interface DliDatasourceConnectionHosts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection#ip DliDatasourceConnection#ip}
  */
  readonly ip: string;
  /**
...
export interface DliDatasourceConnectionRoutes {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection#cidr DliDatasourceConnection#cidr}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection flexibleengine_dli_datasource_connection}
*/
export class DliDatasourceConnection extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "flexibleengine_dli_datasource_connection";
  ...
  * @param importFromId The id of the existing DliDatasourceConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "flexibleengine_dli_datasource_connection", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dli_datasource_connection flexibleengine_dli_datasource_connection} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DliDatasourceConnectionConfig) {
    super(scope, id, {
      terraformResourceType: 'flexibleengine_dli_datasource_connection',
