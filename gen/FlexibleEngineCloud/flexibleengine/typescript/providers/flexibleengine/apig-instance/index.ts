// https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance
...
export interface ApigInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#availability_zones ApigInstance#availability_zones}
  */
  readonly availabilityZones?: string[];
  /**
  * schema: Deprecated; The name list of availability zones for the dedicated instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#available_zones ApigInstance#available_zones}
  */
  readonly availableZones?: string[];
  /**
  * The egress bandwidth size of the dedicated instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#bandwidth_size ApigInstance#bandwidth_size}
  */
  readonly bandwidthSize?: number;
  /**
  * The description of the dedicated instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#description ApigInstance#description}
  */
  readonly description?: string;
  /**
  * The edition of the dedicated instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#edition ApigInstance#edition}
  */
  readonly edition: string;
  /**
  * The EIP ID associated with the dedicated instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#eip_id ApigInstance#eip_id}
  */
  readonly eipId?: string;
  /**
  * The enterprise project ID to which the dedicated instance belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#enterprise_project_id ApigInstance#enterprise_project_id}
  */
  readonly enterpriseProjectId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#id ApigInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#ipv6_enable ApigInstance#ipv6_enable}
  */
  readonly ipv6Enable?: boolean | cdktf.IResolvable;
  /**
  * The type of loadbalancer provider used by the instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#loadbalancer_provider ApigInstance#loadbalancer_provider}
  */
  readonly loadbalancerProvider?: string;
  /**
  * The start time of the maintenance time window.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#maintain_begin ApigInstance#maintain_begin}
  */
  readonly maintainBegin?: string;
  /**
  * The name of the dedicated instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#name ApigInstance#name}
  */
  readonly name: string;
  /**
  * The region in which to create the dedicated instance resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#region ApigInstance#region}
  */
  readonly region?: string;
  /**
  * The ID of the security group to which the dedicated instance belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#security_group_id ApigInstance#security_group_id}
  */
  readonly securityGroupId: string;
  /**
  * The ID of the VPC subnet used to create the dedicated instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#subnet_id ApigInstance#subnet_id}
  */
  readonly subnetId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#tags ApigInstance#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The ID of the VPC used to create the dedicated instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#vpc_id ApigInstance#vpc_id}
  */
  readonly vpcId: string;
  /**
  * Name of the VPC endpoint service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#vpcep_service_name ApigInstance#vpcep_service_name}
  */
  readonly vpcepServiceName?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#timeouts ApigInstance#timeouts}
  */
  readonly timeouts?: ApigInstanceTimeouts;
}
export interface ApigInstanceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#create ApigInstance#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#delete ApigInstance#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#update ApigInstance#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance flexibleengine_apig_instance}
*/
export class ApigInstance extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "flexibleengine_apig_instance";
  ...
  * @param importFromId The id of the existing ApigInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ApigInstance to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "flexibleengine_apig_instance", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/apig_instance flexibleengine_apig_instance} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ApigInstanceConfig) {
    super(scope, id, {
      terraformResourceType: 'flexibleengine_apig_instance',
