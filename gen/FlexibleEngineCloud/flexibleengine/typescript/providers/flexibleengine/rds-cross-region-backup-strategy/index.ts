// https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy
...
export interface RdsCrossRegionBackupStrategyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy#backup_type RdsCrossRegionBackupStrategy#backup_type}
  */
  readonly backupType: string;
  /**
  * Specifies the target project ID for the cross-region backup policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy#destination_project_id RdsCrossRegionBackupStrategy#destination_project_id}
  */
  readonly destinationProjectId: string;
  /**
  * Specifies the target region ID for the cross-region backup policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy#destination_region RdsCrossRegionBackupStrategy#destination_region}
  */
  readonly destinationRegion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy#id RdsCrossRegionBackupStrategy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy#instance_id RdsCrossRegionBackupStrategy#instance_id}
  */
  readonly instanceId: string;
  /**
  * Specifies the number of days to retain the generated backup files.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy#keep_days RdsCrossRegionBackupStrategy#keep_days}
  */
  readonly keepDays: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy#region RdsCrossRegionBackupStrategy#region}
  */
  readonly region?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy#timeouts RdsCrossRegionBackupStrategy#timeouts}
  */
  readonly timeouts?: RdsCrossRegionBackupStrategyTimeouts;
}
export interface RdsCrossRegionBackupStrategyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy#create RdsCrossRegionBackupStrategy#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy#delete RdsCrossRegionBackupStrategy#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy#update RdsCrossRegionBackupStrategy#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy flexibleengine_rds_cross_region_backup_strategy}
*/
export class RdsCrossRegionBackupStrategy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "flexibleengine_rds_cross_region_backup_strategy";
  ...
  * @param importFromId The id of the existing RdsCrossRegionBackupStrategy that should be imported. Refer to the {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "flexibleengine_rds_cross_region_backup_strategy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/rds_cross_region_backup_strategy flexibleengine_rds_cross_region_backup_strategy} Resource
  *
  * @param scope The scope in which to define this construct
