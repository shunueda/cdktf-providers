// https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user
...
export interface DmsRocketmqUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user#access_key DmsRocketmqUser#access_key}
  */
  readonly accessKey: string;
  /**
  * Specifies whether the user is an administrator.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user#admin DmsRocketmqUser#admin}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user#default_group_perm DmsRocketmqUser#default_group_perm}
  */
  ...
  * Value options: **PUB|SUB**, **PUB**, **SUB**, **DENY**.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user#default_topic_perm DmsRocketmqUser#default_topic_perm}
  */
  readonly defaultTopicPerm?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user#id DmsRocketmqUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user#instance_id DmsRocketmqUser#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user#region DmsRocketmqUser#region}
  */
  readonly region?: string;
  /**
  * Specifies the secret key of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user#secret_key DmsRocketmqUser#secret_key}
  */
  readonly secretKey: string;
  /**
  * Specifies the IP address whitelist.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user#white_remote_address DmsRocketmqUser#white_remote_address}
  */
  readonly whiteRemoteAddress?: string;
  /**
  * group_perms block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user#group_perms DmsRocketmqUser#group_perms}
  */
  readonly groupPerms?: DmsRocketmqUserGroupPerms[] | cdktf.IResolvable;
  /**
  * topic_perms block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user#topic_perms DmsRocketmqUser#topic_perms}
  */
...
export interface DmsRocketmqUserGroupPerms {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user#name DmsRocketmqUser#name}
  */
  ...
  * Value options: **PUB|SUB**, **PUB**, **SUB**, **DENY**.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user#perm DmsRocketmqUser#perm}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user flexibleengine_dms_rocketmq_user}
*/
export class DmsRocketmqUser extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "flexibleengine_dms_rocketmq_user";
  ...
  * @param importFromId The id of the existing DmsRocketmqUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DmsRocketmqUser to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "flexibleengine_dms_rocketmq_user", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/dms_rocketmq_user flexibleengine_dms_rocketmq_user} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DmsRocketmqUserConfig) {
    super(scope, id, {
      terraformResourceType: 'flexibleengine_dms_rocketmq_user',
