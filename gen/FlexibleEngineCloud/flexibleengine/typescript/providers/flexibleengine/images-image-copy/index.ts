// https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy
...
export interface ImagesImageCopyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#agency_name ImagesImageCopy#agency_name}
  */
  readonly agencyName?: string;
  /**
  * Specifies the description of the copy image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#description ImagesImageCopy#description}
  */
  readonly description?: string;
  /**
  * Specifies the enterprise project id of the image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#enterprise_project_id ImagesImageCopy#enterprise_project_id}
  */
  readonly enterpriseProjectId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#id ImagesImageCopy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#kms_key_id ImagesImageCopy#kms_key_id}
  */
  readonly kmsKeyId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#max_ram ImagesImageCopy#max_ram}
  */
  readonly maxRam?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#min_ram ImagesImageCopy#min_ram}
  */
  readonly minRam?: number;
  /**
  * Specifies the name of the copy image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#name ImagesImageCopy#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#region ImagesImageCopy#region}
  */
  readonly region?: string;
  /**
  * Specifies the ID of the source image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#source_image_id ImagesImageCopy#source_image_id}
  */
  readonly sourceImageId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#tags ImagesImageCopy#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Specifies the target region name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#target_region ImagesImageCopy#target_region}
  */
  readonly targetRegion?: string;
  /**
  * Specifies the ID of the vault.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#vault_id ImagesImageCopy#vault_id}
  */
  readonly vaultId?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#timeouts ImagesImageCopy#timeouts}
  */
  readonly timeouts?: ImagesImageCopyTimeouts;
}
export interface ImagesImageCopyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#create ImagesImageCopy#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#delete ImagesImageCopy#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy flexibleengine_images_image_copy}
*/
export class ImagesImageCopy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "flexibleengine_images_image_copy";
  ...
  * @param importFromId The id of the existing ImagesImageCopy that should be imported. Refer to the {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ImagesImageCopy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "flexibleengine_images_image_copy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/images_image_copy flexibleengine_images_image_copy} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ImagesImageCopyConfig) {
    super(scope, id, {
      terraformResourceType: 'flexibleengine_images_image_copy',
