// https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/nat_private_dnat_rule
...
export interface NatPrivateDnatRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/nat_private_dnat_rule#backend_interface_id NatPrivateDnatRule#backend_interface_id}
  */
  readonly backendInterfaceId?: string;
  /**
  * The private IP address of the backend instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/nat_private_dnat_rule#backend_private_ip NatPrivateDnatRule#backend_private_ip}
  */
  readonly backendPrivateIp?: string;
  /**
  * The description of the DNAT rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/nat_private_dnat_rule#description NatPrivateDnatRule#description}
  */
  readonly description?: string;
  /**
  * The private NAT gateway ID to which the DNAT rule belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/nat_private_dnat_rule#gateway_id NatPrivateDnatRule#gateway_id}
  */
  readonly gatewayId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/nat_private_dnat_rule#id NatPrivateDnatRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/nat_private_dnat_rule#internal_service_port NatPrivateDnatRule#internal_service_port}
  */
  readonly internalServicePort?: number;
  /**
  * The protocol type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/nat_private_dnat_rule#protocol NatPrivateDnatRule#protocol}
  */
  readonly protocol?: string;
  /**
  * The region where the DNAT rule is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/nat_private_dnat_rule#region NatPrivateDnatRule#region}
  */
  readonly region?: string;
  /**
  * The ID of the transit IP for private NAT.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/nat_private_dnat_rule#transit_ip_id NatPrivateDnatRule#transit_ip_id}
  */
  readonly transitIpId: string;
  /**
  * The port of the transit IP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/nat_private_dnat_rule#transit_service_port NatPrivateDnatRule#transit_service_port}
  */
  readonly transitServicePort?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/nat_private_dnat_rule flexibleengine_nat_private_dnat_rule}
*/
export class NatPrivateDnatRule extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "flexibleengine_nat_private_dnat_rule";
  ...
  * @param importFromId The id of the existing NatPrivateDnatRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/nat_private_dnat_rule#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the NatPrivateDnatRule to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "flexibleengine_nat_private_dnat_rule", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/flexibleenginecloud/flexibleengine/1.46.0/docs/resources/nat_private_dnat_rule flexibleengine_nat_private_dnat_rule} Resource
  *
  * @param scope The scope in which to define this construct
