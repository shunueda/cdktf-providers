// https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user
...
export interface IamUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user#email IamUser#email}
  */
  readonly email: string;
  /**
  * The member's first name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user#first_name IamUser#first_name}
  */
  readonly firstName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user#id IamUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user#last_name IamUser#last_name}
  */
  readonly lastName?: string;
  /**
  * The member's locale
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user#locale IamUser#locale}
  */
  readonly locale?: string;
  /**
  * ID of organization the resource is associated to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user#organization_id IamUser#organization_id}
  */
  readonly organizationId?: string;
  /**
  * The member's password for first access
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user#password IamUser#password}
  */
  readonly password?: string;
  /**
  * The member's phone number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user#phone_number IamUser#phone_number}
  */
  readonly phoneNumber?: string;
  /**
  * Whether or not to send an email containing the member's password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user#send_password_email IamUser#send_password_email}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user#send_welcome_email IamUser#send_welcome_email}
  */
  readonly sendWelcomeEmail?: boolean | cdktf.IResolvable;
  /**
  * The tags associated with the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user#tags IamUser#tags}
  */
  readonly tags?: string[];
  /**
  * The member's username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user#username IamUser#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user scaleway_iam_user}
*/
export class IamUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/iam_user scaleway_iam_user} Resource
  *
  * @param scope The scope in which to define this construct
