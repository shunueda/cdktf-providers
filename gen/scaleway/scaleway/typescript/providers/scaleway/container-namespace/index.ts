// https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace
...
export interface ContainerNamespaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#activate_vpc_integration ContainerNamespace#activate_vpc_integration}
  */
  readonly activateVpcIntegration?: boolean | cdktf.IResolvable;
  /**
  * The description of the container namespace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#description ContainerNamespace#description}
  */
  readonly description?: string;
  /**
  * Destroy registry on deletion
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#destroy_registry ContainerNamespace#destroy_registry}
  */
  readonly destroyRegistry?: boolean | cdktf.IResolvable;
  /**
  * The environment variables of the container namespace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#environment_variables ContainerNamespace#environment_variables}
  */
  readonly environmentVariables?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#id ContainerNamespace#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#name ContainerNamespace#name}
  */
  readonly name?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#project_id ContainerNamespace#project_id}
  */
  readonly projectId?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#region ContainerNamespace#region}
  */
  readonly region?: string;
  /**
  * The secret environment variables of the container namespace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#secret_environment_variables ContainerNamespace#secret_environment_variables}
  */
  readonly secretEnvironmentVariables?: { [key: string]: string };
  /**
  * List of tags ["tag1", "tag2", ...] attached to the container namespace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#tags ContainerNamespace#tags}
  */
  readonly tags?: string[];
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#timeouts ContainerNamespace#timeouts}
  */
  readonly timeouts?: ContainerNamespaceTimeouts;
}
export interface ContainerNamespaceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#create ContainerNamespace#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#default ContainerNamespace#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#delete ContainerNamespace#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#read ContainerNamespace#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#update ContainerNamespace#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace scaleway_container_namespace}
*/
export class ContainerNamespace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/container_namespace scaleway_container_namespace} Resource
  *
  * @param scope The scope in which to define this construct
