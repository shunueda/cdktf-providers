// https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iam_group
...
export interface IamGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iam_group#application_ids IamGroup#application_ids}
  */
  readonly applicationIds?: string[];
  /**
  * The description of the iam group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iam_group#description IamGroup#description}
  */
  readonly description?: string;
  /**
  * Handle user and application memberships externally
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iam_group#external_membership IamGroup#external_membership}
  */
  readonly externalMembership?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iam_group#id IamGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iam_group#name IamGroup#name}
  */
  readonly name?: string;
  /**
  * ID of organization the resource is associated to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iam_group#organization_id IamGroup#organization_id}
  */
  readonly organizationId?: string;
  /**
  * The tags associated with the application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iam_group#tags IamGroup#tags}
  */
  readonly tags?: string[];
  /**
  * List of IDs of the users attached to the group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iam_group#user_ids IamGroup#user_ids}
  */
  readonly userIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iam_group scaleway_iam_group}
*/
export class IamGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iam_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iam_group scaleway_iam_group} Resource
  *
  * @param scope The scope in which to define this construct
