// https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/mnq_sns_topic
...
export interface MnqSnsTopicConfig extends cdktf.TerraformMetaArguments {
  ...
  * SNS access key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/mnq_sns_topic#access_key MnqSnsTopic#access_key}
  */
  readonly accessKey: string;
  /**
  * Specifies whether to enable content-based deduplication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/mnq_sns_topic#content_based_deduplication MnqSnsTopic#content_based_deduplication}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/mnq_sns_topic#fifo_topic MnqSnsTopic#fifo_topic}
  */
  readonly fifoTopic?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/mnq_sns_topic#id MnqSnsTopic#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/mnq_sns_topic#name MnqSnsTopic#name}
  */
  readonly name?: string;
  /**
  * Creates a unique name beginning with the specified prefix.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/mnq_sns_topic#name_prefix MnqSnsTopic#name_prefix}
  */
  readonly namePrefix?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/mnq_sns_topic#project_id MnqSnsTopic#project_id}
  */
  readonly projectId?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/mnq_sns_topic#region MnqSnsTopic#region}
  */
  readonly region?: string;
  /**
  * SNS secret key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/mnq_sns_topic#secret_key MnqSnsTopic#secret_key}
  */
  readonly secretKey: string;
  /**
  * SNS endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/mnq_sns_topic#sns_endpoint MnqSnsTopic#sns_endpoint}
  */
  readonly snsEndpoint?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/mnq_sns_topic scaleway_mnq_sns_topic}
*/
export class MnqSnsTopic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MnqSnsTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/mnq_sns_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/mnq_sns_topic scaleway_mnq_sns_topic} Resource
  *
  * @param scope The scope in which to define this construct
