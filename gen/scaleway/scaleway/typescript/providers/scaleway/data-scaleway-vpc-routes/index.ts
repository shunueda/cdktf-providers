// https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/data-sources/vpc_routes
...
export interface DataScalewayVpcRoutesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/data-sources/vpc_routes#id DataScalewayVpcRoutes#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/data-sources/vpc_routes#is_ipv6 DataScalewayVpcRoutes#is_ipv6}
  */
  readonly isIpv6?: boolean | cdktf.IResolvable;
  /**
  * Only routes with a matching next hop private network ID will be returned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/data-sources/vpc_routes#nexthop_private_network_id DataScalewayVpcRoutes#nexthop_private_network_id}
  */
  readonly nexthopPrivateNetworkId?: string;
  /**
  * Only routes with a matching next hop resource ID will be returned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/data-sources/vpc_routes#nexthop_resource_id DataScalewayVpcRoutes#nexthop_resource_id}
  */
  readonly nexthopResourceId?: string;
  /**
  * Only Routes with a matching next hop resource type will be returned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/data-sources/vpc_routes#nexthop_resource_type DataScalewayVpcRoutes#nexthop_resource_type}
  */
  readonly nexthopResourceType?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/data-sources/vpc_routes#region DataScalewayVpcRoutes#region}
  */
  readonly region?: string;
  /**
  * Routes with these exact tags are listed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/data-sources/vpc_routes#tags DataScalewayVpcRoutes#tags}
  */
  readonly tags?: string[];
  /**
  * Only routes within this VPC will be returned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/data-sources/vpc_routes#vpc_id DataScalewayVpcRoutes#vpc_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/data-sources/vpc_routes scaleway_vpc_routes}
*/
export class DataScalewayVpcRoutes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayVpcRoutes that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/data-sources/vpc_routes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/data-sources/vpc_routes scaleway_vpc_routes} Data Source
  *
  * @param scope The scope in which to define this construct
