// https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/edge_services_dns_stage
...
export interface EdgeServicesDnsStageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/edge_services_dns_stage#backend_stage_id EdgeServicesDnsStage#backend_stage_id}
  */
  readonly backendStageId?: string;
  /**
  * The cache stage ID the DNS stage will be linked to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/edge_services_dns_stage#cache_stage_id EdgeServicesDnsStage#cache_stage_id}
  */
  readonly cacheStageId?: string;
  /**
  * Fully Qualified Domain Name (in the format subdomain.example.com) to attach to the stage
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/edge_services_dns_stage#fqdns EdgeServicesDnsStage#fqdns}
  */
  readonly fqdns?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/edge_services_dns_stage#id EdgeServicesDnsStage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/edge_services_dns_stage#pipeline_id EdgeServicesDnsStage#pipeline_id}
  */
  readonly pipelineId: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/edge_services_dns_stage#project_id EdgeServicesDnsStage#project_id}
  */
  readonly projectId?: string;
  /**
  * The TLS stage ID the DNS stage will be linked to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/edge_services_dns_stage#tls_stage_id EdgeServicesDnsStage#tls_stage_id}
  */
  readonly tlsStageId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/edge_services_dns_stage scaleway_edge_services_dns_stage}
*/
export class EdgeServicesDnsStage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EdgeServicesDnsStage that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/edge_services_dns_stage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.65.1/docs/resources/edge_services_dns_stage scaleway_edge_services_dns_stage} Resource
  *
  * @param scope The scope in which to define this construct
