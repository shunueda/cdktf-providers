// https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function
...
export interface FunctionResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#deploy FunctionResource#deploy}
  */
  readonly deploy?: boolean | cdktf.IResolvable;
  /**
  * The description of the function
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#description FunctionResource#description}
  */
  readonly description?: string;
  /**
  * The environment variables of the function
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#environment_variables FunctionResource#environment_variables}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#handler FunctionResource#handler}
  */
  readonly handler: string;
  /**
  * HTTP traffic configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#http_option FunctionResource#http_option}
  */
  readonly httpOption?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#id FunctionResource#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#max_scale FunctionResource#max_scale}
  */
  readonly maxScale?: number;
  /**
  * Memory limit in MB for your function, defaults to 256MB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#memory_limit FunctionResource#memory_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#min_scale FunctionResource#min_scale}
  */
  readonly minScale?: number;
  /**
  * The name of the function
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#name FunctionResource#name}
  */
  readonly name?: string;
  /**
  * The namespace ID associated with this function
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#namespace_id FunctionResource#namespace_id}
  */
  readonly namespaceId: string;
  /**
  * Privacy of the function. Can be either `private` or `public`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#privacy FunctionResource#privacy}
  */
  readonly privacy: string;
  /**
  * ID of the Private Network the container is connected to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#private_network_id FunctionResource#private_network_id}
  */
  readonly privateNetworkId?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#project_id FunctionResource#project_id}
  */
  readonly projectId?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#region FunctionResource#region}
  */
  readonly region?: string;
  /**
  * Runtime of the function
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#runtime FunctionResource#runtime}
  */
  readonly runtime: string;
  /**
  * Execution environment of the function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#sandbox FunctionResource#sandbox}
  */
  readonly sandbox?: string;
  /**
  * The secret environment variables to be injected into your function at runtime.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#secret_environment_variables FunctionResource#secret_environment_variables}
  */
  readonly secretEnvironmentVariables?: { [key: string]: string };
  /**
  * List of tags ["tag1", "tag2", ...] attached to the function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#tags FunctionResource#tags}
  */
  readonly tags?: string[];
  /**
  * Holds the max duration (in seconds) the function is allowed for responding to a request
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#timeout FunctionResource#timeout}
  */
  readonly timeout?: number;
  /**
  * Location of the zip file to upload containing your function sources
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#zip_file FunctionResource#zip_file}
  */
  readonly zipFile?: string;
  /**
  * The hash of your source zip file, changing it will re-apply function. Can be any string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#zip_hash FunctionResource#zip_hash}
  */
  readonly zipHash?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#timeouts FunctionResource#timeouts}
  */
  readonly timeouts?: FunctionResourceTimeouts;
}
export interface FunctionResourceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#create FunctionResource#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#default FunctionResource#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#delete FunctionResource#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#read FunctionResource#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#update FunctionResource#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function scaleway_function}
*/
export class FunctionResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FunctionResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/function scaleway_function} Resource
  *
  * @param scope The scope in which to define this construct
