// https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub
...
export interface IotHubConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub#device_auto_provisioning IotHub#device_auto_provisioning}
  */
  readonly deviceAutoProvisioning?: boolean | cdktf.IResolvable;
  /**
  * Whether to enable the hub events or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub#disable_events IotHub#disable_events}
  */
  readonly disableEvents?: boolean | cdktf.IResolvable;
  /**
  * Whether to enable the hub or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub#enabled IotHub#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Topic prefix for the hub events
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub#events_topic_prefix IotHub#events_topic_prefix}
  */
  readonly eventsTopicPrefix?: string;
  /**
  * Custom user provided certificate authority
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub#hub_ca IotHub#hub_ca}
  */
  readonly hubCa?: string;
  /**
  * Challenge certificate for the user provided hub CA
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub#hub_ca_challenge IotHub#hub_ca_challenge}
  */
  readonly hubCaChallenge?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub#id IotHub#id}
  *
  ...
  * The name of the hub
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub#name IotHub#name}
  */
  readonly name: string;
  /**
  * The product plan of the hub
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub#product_plan IotHub#product_plan}
  */
  readonly productPlan: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub#project_id IotHub#project_id}
  */
  readonly projectId?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub#region IotHub#region}
  */
  readonly region?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub#timeouts IotHub#timeouts}
  */
  readonly timeouts?: IotHubTimeouts;
}
export interface IotHubTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub#default IotHub#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub scaleway_iot_hub}
*/
export class IotHub extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotHub that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/iot_hub scaleway_iot_hub} Resource
  *
  * @param scope The scope in which to define this construct
