// https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage
...
export interface EdgeServicesRouteStageConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage#id EdgeServicesRouteStage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage#pipeline_id EdgeServicesRouteStage#pipeline_id}
  */
  readonly pipelineId: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage#project_id EdgeServicesRouteStage#project_id}
  */
  readonly projectId?: string;
  /**
  * The ID of the WAF stage HTTP requests should be forwarded to when no rules are matched
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage#waf_stage_id EdgeServicesRouteStage#waf_stage_id}
  */
  readonly wafStageId?: string;
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage#rule EdgeServicesRouteStage#rule}
  */
...
export interface EdgeServicesRouteStageRuleRuleHttpMatchPathFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage#path_filter_type EdgeServicesRouteStage#path_filter_type}
  */
  readonly pathFilterType: string;
  /**
  * The value to be matched for the HTTP URL path
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage#value EdgeServicesRouteStage#value}
  */
...
export interface EdgeServicesRouteStageRuleRuleHttpMatch {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage#method_filters EdgeServicesRouteStage#method_filters}
  */
  readonly methodFilters?: string[];
  /**
  * path_filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage#path_filter EdgeServicesRouteStage#path_filter}
  */
...
export interface EdgeServicesRouteStageRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage#backend_stage_id EdgeServicesRouteStage#backend_stage_id}
  */
  readonly backendStageId: string;
  /**
  * rule_http_match block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage#rule_http_match EdgeServicesRouteStage#rule_http_match}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage scaleway_edge_services_route_stage}
*/
export class EdgeServicesRouteStage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EdgeServicesRouteStage that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/edge_services_route_stage scaleway_edge_services_route_stage} Resource
  *
  * @param scope The scope in which to define this construct
