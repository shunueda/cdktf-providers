// https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/data-sources/vpc_public_gateway_ip
...
export interface DataScalewayVpcPublicGatewayIpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/data-sources/vpc_public_gateway_ip#id DataScalewayVpcPublicGatewayIp#id}
  *
  ...
  * The ID of the IP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/data-sources/vpc_public_gateway_ip#ip_id DataScalewayVpcPublicGatewayIp#ip_id}
  */
  readonly ipId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/data-sources/vpc_public_gateway_ip scaleway_vpc_public_gateway_ip}
*/
export class DataScalewayVpcPublicGatewayIp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayVpcPublicGatewayIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/data-sources/vpc_public_gateway_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/data-sources/vpc_public_gateway_ip scaleway_vpc_public_gateway_ip} Data Source
  *
  * @param scope The scope in which to define this construct
