// https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume
...
export interface BlockVolumeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#id BlockVolume#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#instance_volume_id BlockVolume#instance_volume_id}
  */
  readonly instanceVolumeId?: string;
  /**
  * The maximum IO/s expected, must match available options
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#iops BlockVolume#iops}
  */
  readonly iops: number;
  /**
  * The volume name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#name BlockVolume#name}
  */
  readonly name?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#project_id BlockVolume#project_id}
  */
  readonly projectId?: string;
  /**
  * The volume size in GB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#size_in_gb BlockVolume#size_in_gb}
  */
  readonly sizeInGb?: number;
  /**
  * The snapshot to create the volume from
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#snapshot_id BlockVolume#snapshot_id}
  */
  readonly snapshotId?: string;
  /**
  * The tags associated with the volume
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#tags BlockVolume#tags}
  */
  readonly tags?: string[];
  /**
  * The zone you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#zone BlockVolume#zone}
  */
  readonly zone?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#timeouts BlockVolume#timeouts}
  */
  readonly timeouts?: BlockVolumeTimeouts;
}
export interface BlockVolumeTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#create BlockVolume#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#default BlockVolume#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#delete BlockVolume#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#read BlockVolume#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume scaleway_block_volume}
*/
export class BlockVolume extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BlockVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/resources/block_volume scaleway_block_volume} Resource
  *
  * @param scope The scope in which to define this construct
