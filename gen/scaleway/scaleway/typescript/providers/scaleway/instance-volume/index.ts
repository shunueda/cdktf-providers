// https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume
...
export interface InstanceVolumeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#from_snapshot_id InstanceVolume#from_snapshot_id}
  */
  readonly fromSnapshotId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#id InstanceVolume#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#migrate_to_sbs InstanceVolume#migrate_to_sbs}
  */
  readonly migrateToSbs?: boolean | cdktf.IResolvable;
  /**
  * The name of the volume
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#name InstanceVolume#name}
  */
  readonly name?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#project_id InstanceVolume#project_id}
  */
  readonly projectId?: string;
  /**
  * The size of the volume in gigabyte
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#size_in_gb InstanceVolume#size_in_gb}
  */
  readonly sizeInGb?: number;
  /**
  * The tags associated with the volume
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#tags InstanceVolume#tags}
  */
  readonly tags?: string[];
  /**
  * The volume type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#type InstanceVolume#type}
  */
  readonly type: string;
  /**
  * The zone you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#zone InstanceVolume#zone}
  */
  readonly zone?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#timeouts InstanceVolume#timeouts}
  */
  readonly timeouts?: InstanceVolumeTimeouts;
}
export interface InstanceVolumeTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#create InstanceVolume#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#default InstanceVolume#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#delete InstanceVolume#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#update InstanceVolume#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume scaleway_instance_volume}
*/
export class InstanceVolume extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InstanceVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.64.0/docs/resources/instance_volume scaleway_instance_volume} Resource
  *
  * @param scope The scope in which to define this construct
