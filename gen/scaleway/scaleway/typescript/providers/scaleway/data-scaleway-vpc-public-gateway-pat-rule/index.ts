// https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/data-sources/vpc_public_gateway_pat_rule
...
export interface DataScalewayVpcPublicGatewayPatRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/data-sources/vpc_public_gateway_pat_rule#id DataScalewayVpcPublicGatewayPatRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/data-sources/vpc_public_gateway_pat_rule#pat_rule_id DataScalewayVpcPublicGatewayPatRule#pat_rule_id}
  */
  readonly patRuleId: string;
  /**
  * The zone you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/data-sources/vpc_public_gateway_pat_rule#zone DataScalewayVpcPublicGatewayPatRule#zone}
  */
  readonly zone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/data-sources/vpc_public_gateway_pat_rule scaleway_vpc_public_gateway_pat_rule}
*/
export class DataScalewayVpcPublicGatewayPatRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayVpcPublicGatewayPatRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/data-sources/vpc_public_gateway_pat_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/data-sources/vpc_public_gateway_pat_rule scaleway_vpc_public_gateway_pat_rule} Data Source
  *
  * @param scope The scope in which to define this construct
