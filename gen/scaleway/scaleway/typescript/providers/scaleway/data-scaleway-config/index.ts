// https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/data-sources/config
...
export interface DataScalewayConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/data-sources/config#id DataScalewayConfig#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/data-sources/config scaleway_config}
*/
export class DataScalewayConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/data-sources/config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.63.0/docs/data-sources/config scaleway_config} Data Source
  *
  * @param scope The scope in which to define this construct
