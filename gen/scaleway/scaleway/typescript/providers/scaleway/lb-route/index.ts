// https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/lb_route
...
export interface LbRouteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/lb_route#backend_id LbRoute#backend_id}
  */
  readonly backendId: string;
  /**
  * The frontend ID origin of redirection
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/lb_route#frontend_id LbRoute#frontend_id}
  */
  readonly frontendId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/lb_route#id LbRoute#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/lb_route#match_host_header LbRoute#match_host_header}
  */
  readonly matchHostHeader?: string;
  /**
  * Value to match in the URL beginning path from an incoming request
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/lb_route#match_path_begin LbRoute#match_path_begin}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/lb_route#match_sni LbRoute#match_sni}
  */
  readonly matchSni?: string;
  /**
  * If true, all subdomains will match
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/lb_route#match_subdomains LbRoute#match_subdomains}
  */
  readonly matchSubdomains?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/lb_route#timeouts LbRoute#timeouts}
  */
  readonly timeouts?: LbRouteTimeouts;
}
export interface LbRouteTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/lb_route#default LbRoute#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/lb_route scaleway_lb_route}
*/
export class LbRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/lb_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.62.0/docs/resources/lb_route scaleway_lb_route} Resource
  *
  * @param scope The scope in which to define this construct
