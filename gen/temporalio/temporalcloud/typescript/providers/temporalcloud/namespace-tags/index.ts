...
export interface NamespaceTagsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function namespaceTagsTimeoutsToTerraform(struct?: NamespaceTagsTimeouts | cdktf.IResolvable): any {
...
export function namespaceTagsTimeoutsToHclTerraform(struct?: NamespaceTagsTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class NamespaceTagsTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NamespaceTagsTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: NamespaceTagsTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class NamespaceTags extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "temporalcloud_namespace_tags";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "temporalcloud_namespace_tags", importId: importFromId, provider });
      }
  ...
  * @param options NamespaceTagsConfig
  */
  public constructor(scope: Construct, id: string, config: NamespaceTagsConfig) {
    super(scope, id, {
  ...
  private _timeouts = new NamespaceTagsTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: NamespaceTagsTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: namespaceTagsTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: namespaceTagsTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "NamespaceTagsTimeouts",
      },
    };
