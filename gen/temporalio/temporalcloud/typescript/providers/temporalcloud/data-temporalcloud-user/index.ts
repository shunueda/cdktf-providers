// https://registry.terraform.io/providers/temporalio/temporalcloud/1.1.2/docs/data-sources/user
...
export interface DataTemporalcloudUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/temporalio/temporalcloud/1.1.2/docs/data-sources/user#id DataTemporalcloudUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/temporalio/temporalcloud/1.1.2/docs/data-sources/user#namespace_accesses DataTemporalcloudUser#namespace_accesses}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/temporalio/temporalcloud/1.1.2/docs/data-sources/user temporalcloud_user}
*/
export class DataTemporalcloudUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTemporalcloudUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/temporalio/temporalcloud/1.1.2/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/temporalio/temporalcloud/1.1.2/docs/data-sources/user temporalcloud_user} Data Source
  *
  * @param scope The scope in which to define this construct
