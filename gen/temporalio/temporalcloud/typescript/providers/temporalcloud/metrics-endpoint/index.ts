...
export interface MetricsEndpointConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function metricsEndpointTimeoutsToTerraform(struct?: MetricsEndpointTimeouts | cdktf.IResolvable): any {
...
export function metricsEndpointTimeoutsToHclTerraform(struct?: MetricsEndpointTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class MetricsEndpointTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MetricsEndpointTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: MetricsEndpointTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class MetricsEndpoint extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "temporalcloud_metrics_endpoint";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "temporalcloud_metrics_endpoint", importId: importFromId, provider });
      }
  ...
  * @param options MetricsEndpointConfig
  */
  public constructor(scope: Construct, id: string, config: MetricsEndpointConfig) {
    super(scope, id, {
  ...
  // accepted_client_ca - computed: false, optional: false, required: true
  ...
  private _timeouts = new MetricsEndpointTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: MetricsEndpointTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: metricsEndpointTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: metricsEndpointTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "MetricsEndpointTimeouts",
      },
    };
