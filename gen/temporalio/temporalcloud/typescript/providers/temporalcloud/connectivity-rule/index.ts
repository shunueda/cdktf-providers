...
export interface ConnectivityRuleConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function connectivityRuleTimeoutsToTerraform(struct?: ConnectivityRuleTimeouts | cdktf.IResolvable): any {
...
export function connectivityRuleTimeoutsToHclTerraform(struct?: ConnectivityRuleTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ConnectivityRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ConnectivityRuleTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ConnectivityRuleTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ConnectivityRule extends cdktf.TerraformResource {
  ...
  * @param options ConnectivityRuleConfig
  */
  public constructor(scope: Construct, id: string, config: ConnectivityRuleConfig) {
    super(scope, id, {
  ...
  private _timeouts = new ConnectivityRuleTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ConnectivityRuleTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: connectivityRuleTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: connectivityRuleTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ConnectivityRuleTimeouts",
      },
    };
