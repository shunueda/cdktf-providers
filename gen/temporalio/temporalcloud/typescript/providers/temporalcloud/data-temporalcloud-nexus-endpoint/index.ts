// https://registry.terraform.io/providers/temporalio/temporalcloud/1.1.2/docs/data-sources/nexus_endpoint
...
export interface DataTemporalcloudNexusEndpointConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/temporalio/temporalcloud/1.1.2/docs/data-sources/nexus_endpoint#description DataTemporalcloudNexusEndpoint#description}
  */
  readonly description?: string;
  /**
  * The unique identifier of the Nexus Endpoint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/temporalio/temporalcloud/1.1.2/docs/data-sources/nexus_endpoint#id DataTemporalcloudNexusEndpoint#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/temporalio/temporalcloud/1.1.2/docs/data-sources/nexus_endpoint temporalcloud_nexus_endpoint}
*/
export class DataTemporalcloudNexusEndpoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTemporalcloudNexusEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/temporalio/temporalcloud/1.1.2/docs/data-sources/nexus_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/temporalio/temporalcloud/1.1.2/docs/data-sources/nexus_endpoint temporalcloud_nexus_endpoint} Data Source
  *
  * @param scope The scope in which to define this construct
