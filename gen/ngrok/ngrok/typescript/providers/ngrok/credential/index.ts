// https://registry.terraform.io/providers/ngrok/ngrok/0.5.0/docs/resources/credential
...
export interface CredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ngrok/ngrok/0.5.0/docs/resources/credential#acl Credential#acl}
  */
  readonly acl?: string[];
  /**
  * human-readable description of who or what will use the credential to authenticate. Optional, max 255 bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ngrok/ngrok/0.5.0/docs/resources/credential#description Credential#description}
  */
  readonly description?: string;
  /**
  * arbitrary user-defined machine-readable data of this credential. Optional, max 4096 bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ngrok/ngrok/0.5.0/docs/resources/credential#metadata Credential#metadata}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ngrok/ngrok/0.5.0/docs/resources/credential#owner_id Credential#owner_id}
  */
  readonly ownerId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ngrok/ngrok/0.5.0/docs/resources/credential ngrok_credential}
*/
export class Credential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Credential that should be imported. Refer to the {@link https://registry.terraform.io/providers/ngrok/ngrok/0.5.0/docs/resources/credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ngrok/ngrok/0.5.0/docs/resources/credential ngrok_credential} Resource
  *
  * @param scope The scope in which to define this construct
