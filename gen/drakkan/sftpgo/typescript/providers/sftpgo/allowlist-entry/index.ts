...
export interface AllowlistEntryConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class AllowlistEntry extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sftpgo_allowlist_entry";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sftpgo_allowlist_entry", importId: importFromId, provider });
      }
  ...
  * @param options AllowlistEntryConfig
  */
  public constructor(scope: Construct, id: string, config: AllowlistEntryConfig) {
    super(scope, id, {
