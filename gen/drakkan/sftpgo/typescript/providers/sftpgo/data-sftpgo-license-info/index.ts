// https://registry.terraform.io/providers/drakkan/sftpgo/0.0.18/docs/data-sources/license_info
...
/**
* Represents a {@link https://registry.terraform.io/providers/drakkan/sftpgo/0.0.18/docs/data-sources/license_info sftpgo_license_info}
*/
export class DataSftpgoLicenseInfo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSftpgoLicenseInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/drakkan/sftpgo/0.0.18/docs/data-sources/license_info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/drakkan/sftpgo/0.0.18/docs/data-sources/license_info sftpgo_license_info} Data Source
  *
  * @param scope The scope in which to define this construct
