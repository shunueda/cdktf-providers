// https://registry.terraform.io/providers/drakkan/sftpgo/0.0.18/docs/data-sources/rlsafelist_entries
...
/**
* Represents a {@link https://registry.terraform.io/providers/drakkan/sftpgo/0.0.18/docs/data-sources/rlsafelist_entries sftpgo_rlsafelist_entries}
*/
export class DataSftpgoRlsafelistEntries extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSftpgoRlsafelistEntries that should be imported. Refer to the {@link https://registry.terraform.io/providers/drakkan/sftpgo/0.0.18/docs/data-sources/rlsafelist_entries#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/drakkan/sftpgo/0.0.18/docs/data-sources/rlsafelist_entries sftpgo_rlsafelist_entries} Data Source
  *
  * @param scope The scope in which to define this construct
