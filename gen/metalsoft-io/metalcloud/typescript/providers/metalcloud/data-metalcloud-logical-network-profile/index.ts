// https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.0.10/docs/data-sources/logical_network_profile
...
export interface DataMetalcloudLogicalNetworkProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  * Fabric Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.0.10/docs/data-sources/logical_network_profile#fabric_id DataMetalcloudLogicalNetworkProfile#fabric_id}
  */
  readonly fabricId: string;
  /**
  * Logical Network Profile label
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.0.10/docs/data-sources/logical_network_profile#label DataMetalcloudLogicalNetworkProfile#label}
  */
  readonly label: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.0.10/docs/data-sources/logical_network_profile metalcloud_logical_network_profile}
*/
export class DataMetalcloudLogicalNetworkProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMetalcloudLogicalNetworkProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.0.10/docs/data-sources/logical_network_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.0.10/docs/data-sources/logical_network_profile metalcloud_logical_network_profile} Data Source
  *
  * @param scope The scope in which to define this construct
