// https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/extension_instance
...
export interface ExtensionInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  * Extension Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/extension_instance#extension_id ExtensionInstance#extension_id}
  */
  readonly extensionId: string;
  /**
  * Extension Instance infrastructure Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/extension_instance#infrastructure_id ExtensionInstance#infrastructure_id}
  */
  readonly infrastructureId: string;
  /**
  * Input variables for the extension instance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/extension_instance#input_variables ExtensionInstance#input_variables}
  */
  readonly inputVariables?: ExtensionInstanceInputVariables[] | cdktf.IResolvable;
  /**
  * Extension Instance label
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/extension_instance#label ExtensionInstance#label}
  */
...
export interface ExtensionInstanceInputVariables {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/extension_instance#value_bool ExtensionInstance#value_bool}
  */
  readonly valueBool?: boolean | cdktf.IResolvable;
  /**
  * Integer value of the input variable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/extension_instance#value_int ExtensionInstance#value_int}
  */
  readonly valueInt?: number;
  /**
  * String value of the input variable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/extension_instance#value_str ExtensionInstance#value_str}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/extension_instance metalcloud_extension_instance}
*/
export class ExtensionInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExtensionInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/extension_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/extension_instance metalcloud_extension_instance} Resource
  *
  * @param scope The scope in which to define this construct
