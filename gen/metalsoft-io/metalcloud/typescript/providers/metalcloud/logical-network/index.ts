// https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/logical_network
...
export interface LogicalNetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  * Infrastructure Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/logical_network#infrastructure_id LogicalNetwork#infrastructure_id}
  */
  readonly infrastructureId: string;
  /**
  * Logical Network label
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/logical_network#label LogicalNetwork#label}
  */
  readonly label: string;
  /**
  * Logical Network Profile Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/logical_network#logical_network_profile_id LogicalNetwork#logical_network_profile_id}
  */
  readonly logicalNetworkProfileId: string;
  /**
  * Logical Network name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/logical_network#name LogicalNetwork#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/logical_network metalcloud_logical_network}
*/
export class LogicalNetwork extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogicalNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/logical_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/resources/logical_network metalcloud_logical_network} Resource
  *
  * @param scope The scope in which to define this construct
