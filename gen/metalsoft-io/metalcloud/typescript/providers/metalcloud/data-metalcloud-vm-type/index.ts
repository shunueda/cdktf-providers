// https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/data-sources/vm_type
...
export interface DataMetalcloudVmTypeConfig extends cdktf.TerraformMetaArguments {
  ...
  * VM type label
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/data-sources/vm_type#label DataMetalcloudVmType#label}
  */
  readonly label: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/data-sources/vm_type metalcloud_vm_type}
*/
export class DataMetalcloudVmType extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMetalcloudVmType that should be imported. Refer to the {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/data-sources/vm_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/metalsoft-io/metalcloud/7.1.0/docs/data-sources/vm_type metalcloud_vm_type} Data Source
  *
  * @param scope The scope in which to define this construct
