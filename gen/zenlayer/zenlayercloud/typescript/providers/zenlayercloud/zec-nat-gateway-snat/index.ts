// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_nat_gateway_snat
...
export interface ZecNatGatewaySnatConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_nat_gateway_snat#eip_ids ZecNatGatewaySnat#eip_ids}
  */
  readonly eipIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_nat_gateway_snat#id ZecNatGatewaySnat#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_nat_gateway_snat#is_all_eip ZecNatGatewaySnat#is_all_eip}
  */
  readonly isAllEip?: boolean | cdktf.IResolvable;
  /**
  * ID of the NAT gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_nat_gateway_snat#nat_gateway_id ZecNatGatewaySnat#nat_gateway_id}
  */
  readonly natGatewayId: string;
  /**
  * Source CIDR blocks to be associated with the SNAT entry. Cannot be used with `subnet_ids`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_nat_gateway_snat#source_cidr_blocks ZecNatGatewaySnat#source_cidr_blocks}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_nat_gateway_snat#subnet_ids ZecNatGatewaySnat#subnet_ids}
  */
  readonly subnetIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_nat_gateway_snat zenlayercloud_zec_nat_gateway_snat}
*/
export class ZecNatGatewaySnat extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZecNatGatewaySnat that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_nat_gateway_snat#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_nat_gateway_snat zenlayercloud_zec_nat_gateway_snat} Resource
  *
  * @param scope The scope in which to define this construct
