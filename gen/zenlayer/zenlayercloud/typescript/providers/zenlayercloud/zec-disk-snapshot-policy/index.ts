// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/zec_disk_snapshot_policy
...
export interface ZecDiskSnapshotPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/zec_disk_snapshot_policy#availability_zone ZecDiskSnapshotPolicy#availability_zone}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/zec_disk_snapshot_policy#hours ZecDiskSnapshotPolicy#hours}
  */
  readonly hours: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/zec_disk_snapshot_policy#id ZecDiskSnapshotPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/zec_disk_snapshot_policy#name ZecDiskSnapshotPolicy#name}
  */
  readonly name?: string;
  /**
  * The days of week when the auto snapshot policy is triggered. Valid values: `1` to `7`. 1: Monday, 2: Tuesday ~ 7: Sunday.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/zec_disk_snapshot_policy#repeat_week_days ZecDiskSnapshotPolicy#repeat_week_days}
  */
  readonly repeatWeekDays: number[];
  /**
  * The ID of resource group grouped snapshot policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/zec_disk_snapshot_policy#resource_group_id ZecDiskSnapshotPolicy#resource_group_id}
  */
  readonly resourceGroupId?: string;
  /**
  * The retention days of the auto snapshot policy. Valid values: `1` to `65535` or `-1` for no expired. Default is `-1`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/zec_disk_snapshot_policy#retention_days ZecDiskSnapshotPolicy#retention_days}
  */
  readonly retentionDays?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/zec_disk_snapshot_policy zenlayercloud_zec_disk_snapshot_policy}
*/
export class ZecDiskSnapshotPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZecDiskSnapshotPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/zec_disk_snapshot_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/zec_disk_snapshot_policy zenlayercloud_zec_disk_snapshot_policy} Resource
  *
  * @param scope The scope in which to define this construct
