// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance
...
export interface ZvmInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#availability_zone ZvmInstance#availability_zone}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#force_delete ZvmInstance#force_delete}
  */
  readonly forceDelete?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#id ZvmInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#image_id ZvmInstance#image_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#instance_charge_prepaid_period ZvmInstance#instance_charge_prepaid_period}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#instance_charge_type ZvmInstance#instance_charge_type}
  */
  readonly instanceChargeType?: string;
  /**
  * The name of the instance. The max length of instance_name is 64, and default value is `Terraform-Instance`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#instance_name ZvmInstance#instance_name}
  */
  readonly instanceName?: string;
  /**
  * The type of the instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#instance_type ZvmInstance#instance_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#internet_charge_type ZvmInstance#internet_charge_type}
  */
  readonly internetChargeType: string;
  /**
  * Maximum outgoing bandwidth to the public network, measured in Mbps (Mega bits per second).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#internet_max_bandwidth_out ZvmInstance#internet_max_bandwidth_out}
  */
  readonly internetMaxBandwidthOut?: number;
  /**
  * The key pair id to use for the instance. Changing `key_id` will cause the instance reset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#key_id ZvmInstance#key_id}
  */
  readonly keyId?: string;
  /**
  * Password for the instance. The max length of password is 16.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#password ZvmInstance#password}
  */
  readonly password?: string;
  /**
  * The resource group id the instance belongs to, default to Default Resource Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#resource_group_id ZvmInstance#resource_group_id}
  */
  readonly resourceGroupId?: string;
  /**
  * The ID of a VPC subnet. If you want to create instances in a VPC network, this parameter must be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#subnet_id ZvmInstance#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * Size of the system disk. unit is GB. If modified, the instance may force stop.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#system_disk_size ZvmInstance#system_disk_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#traffic_package_size ZvmInstance#traffic_package_size}
  */
  readonly trafficPackageSize?: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#timeouts ZvmInstance#timeouts}
  */
  readonly timeouts?: ZvmInstanceTimeouts;
}
export interface ZvmInstanceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#create ZvmInstance#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#update ZvmInstance#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance zenlayercloud_zvm_instance}
*/
export class ZvmInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZvmInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zvm_instance zenlayercloud_zvm_instance} Resource
  *
  * @param scope The scope in which to define this construct
