// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip
...
export interface ZecEipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip#bandwidth ZecEip#bandwidth}
  */
  readonly bandwidth: number;
  /**
  * Bandwidth cluster ID. Required when `internet_charge_type` is `BandwidthCluster`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip#bandwidth_cluster_id ZecEip#bandwidth_cluster_id}
  */
  readonly bandwidthClusterId?: string;
  /**
  * CIDR ID, the elastic ip will allocated from given CIDR.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip#cidr_id ZecEip#cidr_id}
  */
  readonly cidrId?: string;
  /**
  * The Data transfer package. Measured in TB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip#flow_package_size ZecEip#flow_package_size}
  */
  readonly flowPackageSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip#id ZecEip#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip#internet_charge_type ZecEip#internet_charge_type}
  */
  readonly internetChargeType: string;
  /**
  * Network types of public IPv4. Valid values: `CN2Line`, `LocalLine`, `ChinaTelecom`, `ChinaUnicom`, `ChinaMobile`, `Cogent`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip#ip_network_type ZecEip#ip_network_type}
  */
  readonly ipNetworkType?: string;
  /**
  * Name of the elastic IP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip#name ZecEip#name}
  */
  readonly name: string;
  /**
  * Remote region ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip#peer_region_id ZecEip#peer_region_id}
  */
  readonly peerRegionId?: string;
  /**
  * The region ID that the elastic IP locates at.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip#region_id ZecEip#region_id}
  */
  readonly regionId: string;
  /**
  * Resource group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip#resource_group_id ZecEip#resource_group_id}
  */
  readonly resourceGroupId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip zenlayercloud_zec_eip}
*/
export class ZecEip extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZecEip that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_eip zenlayercloud_zec_eip} Resource
  *
  * @param scope The scope in which to define this construct
