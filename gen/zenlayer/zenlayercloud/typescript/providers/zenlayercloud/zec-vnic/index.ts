// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_vnic
...
export interface ZecVnicConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_vnic#id ZecVnic#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_vnic#ipv6_bandwidth ZecVnic#ipv6_bandwidth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_vnic#ipv6_bandwidth_cluster_id ZecVnic#ipv6_bandwidth_cluster_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_vnic#ipv6_internet_charge_type ZecVnic#ipv6_internet_charge_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_vnic#ipv6_traffic_package_size ZecVnic#ipv6_traffic_package_size}
  */
  readonly ipv6TrafficPackageSize?: number;
  /**
  * The name of the vNIC. maximum length is 63.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_vnic#name ZecVnic#name}
  */
  readonly name?: string;
  /**
  * The resource group id the vNIC belongs to, default to ID of Default Resource Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_vnic#resource_group_id ZecVnic#resource_group_id}
  */
  readonly resourceGroupId?: string;
  /**
  * The ID of a security group. If absent, the security group under VPC will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_vnic#security_group_id ZecVnic#security_group_id}
  */
  readonly securityGroupId?: string;
  /**
  * The stack type of the subnet. Valid values: `IPv4`, `IPv6`, `IPv4_IPv6`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_vnic#stack_type ZecVnic#stack_type}
  */
  readonly stackType?: string;
  /**
  * The ID of a VPC subnet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_vnic#subnet_id ZecVnic#subnet_id}
  */
  readonly subnetId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_vnic zenlayercloud_zec_vnic}
*/
export class ZecVnic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZecVnic that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_vnic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_vnic zenlayercloud_zec_vnic} Resource
  *
  * @param scope The scope in which to define this construct
