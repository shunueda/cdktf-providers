// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/data-sources/sdn_cloud_regions
...
export interface DataZenlayercloudSdnCloudRegionsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/data-sources/sdn_cloud_regions#cloud_type DataZenlayercloudSdnCloudRegions#cloud_type}
  */
  readonly cloudType: string;
  /**
  * Google Paring key, which is required when cloud type is `GOOGLE`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/data-sources/sdn_cloud_regions#google_pairing_key DataZenlayercloudSdnCloudRegions#google_pairing_key}
  */
  readonly googlePairingKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/data-sources/sdn_cloud_regions#id DataZenlayercloudSdnCloudRegions#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/data-sources/sdn_cloud_regions#product DataZenlayercloudSdnCloudRegions#product}
  */
  readonly product?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/data-sources/sdn_cloud_regions#result_output_file DataZenlayercloudSdnCloudRegions#result_output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/data-sources/sdn_cloud_regions zenlayercloud_sdn_cloud_regions}
*/
export class DataZenlayercloudSdnCloudRegions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZenlayercloudSdnCloudRegions that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/data-sources/sdn_cloud_regions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/data-sources/sdn_cloud_regions zenlayercloud_sdn_cloud_regions} Data Source
  *
  * @param scope The scope in which to define this construct
