// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/disk
...
export interface DiskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/disk#availability_zone Disk#availability_zone}
  */
  readonly availabilityZone: string;
  /**
  * The tenancy (time unit is month) of the prepaid disk.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/disk#charge_prepaid_period Disk#charge_prepaid_period}
  */
  readonly chargePrepaidPeriod?: number;
  /**
  * Charge type of disk.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/disk#charge_type Disk#charge_type}
  */
  readonly chargeType?: string;
  /**
  * The size of disk. Unit: GB. The minimum value is 20 GB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/disk#disk_size Disk#disk_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/disk#force_delete Disk#force_delete}
  */
  readonly forceDelete?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/disk#id Disk#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/disk#name Disk#name}
  */
  readonly name?: string;
  /**
  * The resource group id the disk belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/disk#resource_group_id Disk#resource_group_id}
  */
  readonly resourceGroupId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/disk zenlayercloud_disk}
*/
export class Disk extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Disk that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/disk#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/disk zenlayercloud_disk} Resource
  *
  * @param scope The scope in which to define this construct
