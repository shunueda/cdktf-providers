// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/data-sources/bmc_images
...
export interface DataZenlayercloudBmcImagesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/data-sources/bmc_images#catalog DataZenlayercloudBmcImages#catalog}
  */
  readonly catalog?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/data-sources/bmc_images#id DataZenlayercloudBmcImages#id}
  *
  ...
  * ID of the image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/data-sources/bmc_images#image_id DataZenlayercloudBmcImages#image_id}
  */
  readonly imageId?: string;
  /**
  * Name of the image, such as `CentOS7.4-x86_64`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/data-sources/bmc_images#image_name DataZenlayercloudBmcImages#image_name}
  */
  readonly imageName?: string;
  /**
  * The image type. Valid values: 'PUBLIC_IMAGE', 'CUSTOM_IMAGE'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/data-sources/bmc_images#image_type DataZenlayercloudBmcImages#image_type}
  */
  readonly imageType?: string;
  /**
  * Filter images which are supported to install on specified instance type, such as `M6C`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/data-sources/bmc_images#instance_type_id DataZenlayercloudBmcImages#instance_type_id}
  */
  readonly instanceTypeId?: string;
  /**
  * os type of the image. Valid values: 'windows', 'linux'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/data-sources/bmc_images#os_type DataZenlayercloudBmcImages#os_type}
  */
  readonly osType?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/data-sources/bmc_images#result_output_file DataZenlayercloudBmcImages#result_output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/data-sources/bmc_images zenlayercloud_bmc_images}
*/
export class DataZenlayercloudBmcImages extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZenlayercloudBmcImages that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/data-sources/bmc_images#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/data-sources/bmc_images zenlayercloud_bmc_images} Data Source
  *
  * @param scope The scope in which to define this construct
