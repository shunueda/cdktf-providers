// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_nat_gateway
...
export interface ZecNatGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_nat_gateway#enable_icmp_reply ZecNatGateway#enable_icmp_reply}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_nat_gateway#force_delete ZecNatGateway#force_delete}
  */
  readonly forceDelete?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_nat_gateway#id ZecNatGateway#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_nat_gateway#is_all_subnets ZecNatGateway#is_all_subnets}
  */
  readonly isAllSubnets?: boolean | cdktf.IResolvable;
  /**
  * The name of the NAT gateway, the default value is 'Terraform-Subnet'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_nat_gateway#name ZecNatGateway#name}
  */
  readonly name?: string;
  /**
  * The region that the NAT gateway locates at.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_nat_gateway#region_id ZecNatGateway#region_id}
  */
  readonly regionId: string;
  /**
  * The resource group id the NAT gateway belongs to, default to ID of Default Resource Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_nat_gateway#resource_group_id ZecNatGateway#resource_group_id}
  */
  readonly resourceGroupId?: string;
  /**
  * The ID of a security group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_nat_gateway#security_group_id ZecNatGateway#security_group_id}
  */
  readonly securityGroupId: string;
  /**
  * IDs of the subnets to be associated. The subnets must belong to the specified VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_nat_gateway#subnet_ids ZecNatGateway#subnet_ids}
  */
  readonly subnetIds?: string[];
  /**
  * ID of the VPC to be associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_nat_gateway#vpc_id ZecNatGateway#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_nat_gateway zenlayercloud_zec_nat_gateway}
*/
export class ZecNatGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZecNatGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_nat_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zec_nat_gateway zenlayercloud_zec_nat_gateway} Resource
  *
  * @param scope The scope in which to define this construct
