// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_border_gateway
...
export interface ZecBorderGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_border_gateway#advertised_cidrs ZecBorderGateway#advertised_cidrs}
  */
  readonly advertisedCidrs?: string[];
  /**
  * Subnet route advertisement.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_border_gateway#advertised_subnet ZecBorderGateway#advertised_subnet}
  */
  readonly advertisedSubnet?: string;
  /**
  * Autonomous System Number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_border_gateway#asn ZecBorderGateway#asn}
  */
  readonly asn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_border_gateway#id ZecBorderGateway#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_border_gateway#name ZecBorderGateway#name}
  */
  readonly name: string;
  /**
  * Region ID of the border gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_border_gateway#region_id ZecBorderGateway#region_id}
  */
  readonly regionId: string;
  /**
  * VPC ID that the border gateway belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_border_gateway#vpc_id ZecBorderGateway#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_border_gateway zenlayercloud_zec_border_gateway}
*/
export class ZecBorderGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZecBorderGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_border_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_border_gateway zenlayercloud_zec_border_gateway} Resource
  *
  * @param scope The scope in which to define this construct
