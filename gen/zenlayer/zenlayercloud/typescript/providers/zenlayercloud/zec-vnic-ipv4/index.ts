// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_vnic_ipv4
...
export interface ZecVnicIpv4Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_vnic_ipv4#id ZecVnicIpv4#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_vnic_ipv4#secondary_private_ip_addresses ZecVnicIpv4#secondary_private_ip_addresses}
  */
  readonly secondaryPrivateIpAddresses?: string[];
  /**
  * The number of newly-applied private IP addresses.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_vnic_ipv4#secondary_private_ip_count ZecVnicIpv4#secondary_private_ip_count}
  */
  readonly secondaryPrivateIpCount?: number;
  /**
  * The ID of the vNIC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_vnic_ipv4#vnic_id ZecVnicIpv4#vnic_id}
  */
  readonly vnicId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_vnic_ipv4 zenlayercloud_zec_vnic_ipv4}
*/
export class ZecVnicIpv4 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZecVnicIpv4 that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_vnic_ipv4#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_vnic_ipv4 zenlayercloud_zec_vnic_ipv4} Resource
  *
  * @param scope The scope in which to define this construct
