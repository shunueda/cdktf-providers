// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_nat_gateway_dnat
...
export interface ZecNatGatewayDnatConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_nat_gateway_dnat#eip_id ZecNatGatewayDnat#eip_id}
  */
  readonly eipId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_nat_gateway_dnat#id ZecNatGatewayDnat#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_nat_gateway_dnat#nat_gateway_id ZecNatGatewayDnat#nat_gateway_id}
  */
  readonly natGatewayId: string;
  /**
  * The private ip address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_nat_gateway_dnat#private_ip_address ZecNatGatewayDnat#private_ip_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_nat_gateway_dnat#private_port ZecNatGatewayDnat#private_port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_nat_gateway_dnat#protocol ZecNatGatewayDnat#protocol}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_nat_gateway_dnat#public_port ZecNatGatewayDnat#public_port}
  */
  readonly publicPort?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_nat_gateway_dnat zenlayercloud_zec_nat_gateway_dnat}
*/
export class ZecNatGatewayDnat extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZecNatGatewayDnat that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_nat_gateway_dnat#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_nat_gateway_dnat zenlayercloud_zec_nat_gateway_dnat} Resource
  *
  * @param scope The scope in which to define this construct
