// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_border_gateway_association
...
export interface ZecBorderGatewayAssociationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_border_gateway_association#id ZecBorderGatewayAssociation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_border_gateway_association#nat_id ZecBorderGatewayAssociation#nat_id}
  */
  readonly natId: string;
  /**
  * ID of the border gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_border_gateway_association#zbg_id ZecBorderGatewayAssociation#zbg_id}
  */
  readonly zbgId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_border_gateway_association zenlayercloud_zec_border_gateway_association}
*/
export class ZecBorderGatewayAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZecBorderGatewayAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_border_gateway_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zec_border_gateway_association zenlayercloud_zec_border_gateway_association} Resource
  *
  * @param scope The scope in which to define this construct
