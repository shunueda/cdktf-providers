// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zlb_instance
...
export interface ZlbInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zlb_instance#id ZlbInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zlb_instance#region_id ZlbInstance#region_id}
  */
  readonly regionId: string;
  /**
  * The resource group id the load balancer belongs to, default to Default Resource Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zlb_instance#resource_group_id ZlbInstance#resource_group_id}
  */
  readonly resourceGroupId?: string;
  /**
  * The ID of VPC that the load balancer instance belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zlb_instance#vpc_id ZlbInstance#vpc_id}
  */
  readonly vpcId: string;
  /**
  * The name of the load balancer instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zlb_instance#zlb_name ZlbInstance#zlb_name}
  */
  readonly zlbName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zlb_instance zenlayercloud_zlb_instance}
*/
export class ZlbInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZlbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zlb_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs/resources/zlb_instance zenlayercloud_zlb_instance} Resource
  *
  * @param scope The scope in which to define this construct
