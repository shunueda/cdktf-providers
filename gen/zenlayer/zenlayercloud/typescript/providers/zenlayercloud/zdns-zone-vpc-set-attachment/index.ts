// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/zdns_zone_vpc_set_attachment
...
export interface ZdnsZoneVpcSetAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/zdns_zone_vpc_set_attachment#id ZdnsZoneVpcSetAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/zdns_zone_vpc_set_attachment#vpc_ids ZdnsZoneVpcSetAttachment#vpc_ids}
  */
  readonly vpcIds: string[];
  /**
  * The ID of the private zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/zdns_zone_vpc_set_attachment#zone_id ZdnsZoneVpcSetAttachment#zone_id}
  */
  readonly zoneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/zdns_zone_vpc_set_attachment zenlayercloud_zdns_zone_vpc_set_attachment}
*/
export class ZdnsZoneVpcSetAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZdnsZoneVpcSetAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/zdns_zone_vpc_set_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/zdns_zone_vpc_set_attachment zenlayercloud_zdns_zone_vpc_set_attachment} Resource
  *
  * @param scope The scope in which to define this construct
