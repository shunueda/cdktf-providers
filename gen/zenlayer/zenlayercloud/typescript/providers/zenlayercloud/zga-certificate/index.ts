// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/zga_certificate
...
export interface ZgaCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/zga_certificate#certificate ZgaCertificate#certificate}
  */
  readonly certificate: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/zga_certificate#id ZgaCertificate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/zga_certificate#key ZgaCertificate#key}
  */
  readonly key: string;
  /**
  * The label of the certificate. Modification is not supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/zga_certificate#label ZgaCertificate#label}
  */
  readonly label?: string;
  /**
  * The resource group id the certificate belongs to, default to Default Resource Group. Modification is not supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/zga_certificate#resource_group_id ZgaCertificate#resource_group_id}
  */
  readonly resourceGroupId?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/zga_certificate#timeouts ZgaCertificate#timeouts}
  */
  readonly timeouts?: ZgaCertificateTimeouts;
}
export interface ZgaCertificateTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/zga_certificate#create ZgaCertificate#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/zga_certificate zenlayercloud_zga_certificate}
*/
export class ZgaCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZgaCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/zga_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/zga_certificate zenlayercloud_zga_certificate} Resource
  *
  * @param scope The scope in which to define this construct
