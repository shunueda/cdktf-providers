// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zdns_zone
...
export interface ZdnsZoneConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zdns_zone#id ZdnsZone#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zdns_zone#proxy_pattern ZdnsZone#proxy_pattern}
  */
  readonly proxyPattern?: string;
  /**
  * Remarks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zdns_zone#remark ZdnsZone#remark}
  */
  readonly remark?: string;
  /**
  * The resource group id the private zone belongs to, default to Default Resource Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zdns_zone#resource_group_id ZdnsZone#resource_group_id}
  */
  readonly resourceGroupId?: string;
  /**
  * The name of the private zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zdns_zone#zone_name ZdnsZone#zone_name}
  */
  readonly zoneName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zdns_zone zenlayercloud_zdns_zone}
*/
export class ZdnsZone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZdnsZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zdns_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zdns_zone zenlayercloud_zdns_zone} Resource
  *
  * @param scope The scope in which to define this construct
