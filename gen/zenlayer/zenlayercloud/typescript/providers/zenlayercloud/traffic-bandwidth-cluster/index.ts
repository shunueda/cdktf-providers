// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/traffic_bandwidth_cluster
...
export interface TrafficBandwidthClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/traffic_bandwidth_cluster#area_code TrafficBandwidthCluster#area_code}
  */
  readonly areaCode: string;
  /**
  * Bandwidth commitment. Measured in Mbps. Default value: `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/traffic_bandwidth_cluster#commit_bandwidth_mbps TrafficBandwidthCluster#commit_bandwidth_mbps}
  */
  readonly commitBandwidthMbps?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/traffic_bandwidth_cluster#id TrafficBandwidthCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/traffic_bandwidth_cluster#internet_charge_type TrafficBandwidthCluster#internet_charge_type}
  */
  readonly internetChargeType: string;
  /**
  * The name of the bandwidth cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/traffic_bandwidth_cluster#name TrafficBandwidthCluster#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/traffic_bandwidth_cluster#network_type TrafficBandwidthCluster#network_type}
  */
  readonly networkType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/traffic_bandwidth_cluster zenlayercloud_traffic_bandwidth_cluster}
*/
export class TrafficBandwidthCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrafficBandwidthCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/traffic_bandwidth_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.14/docs/resources/traffic_bandwidth_cluster zenlayercloud_traffic_bandwidth_cluster} Resource
  *
  * @param scope The scope in which to define this construct
