// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/bmc_eip
...
export interface BmcEipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/bmc_eip#availability_zone BmcEip#availability_zone}
  */
  readonly availabilityZone: string;
  /**
  * The tenancy (time unit is month) of the prepaid EIP, NOTE: it only works when eip_charge_type is set to `PREPAID`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/bmc_eip#eip_charge_prepaid_period BmcEip#eip_charge_prepaid_period}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/bmc_eip#eip_charge_type BmcEip#eip_charge_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/bmc_eip#force_delete BmcEip#force_delete}
  */
  readonly forceDelete?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/bmc_eip#id BmcEip#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/bmc_eip#resource_group_id BmcEip#resource_group_id}
  */
  readonly resourceGroupId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/bmc_eip zenlayercloud_bmc_eip}
*/
export class BmcEip extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BmcEip that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/bmc_eip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.9/docs/resources/bmc_eip zenlayercloud_bmc_eip} Resource
  *
  * @param scope The scope in which to define this construct
