// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/data-sources/security_groups
...
export interface DataZenlayercloudSecurityGroupsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/data-sources/security_groups#id DataZenlayercloudSecurityGroups#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/data-sources/security_groups#name DataZenlayercloudSecurityGroups#name}
  */
  readonly name?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/data-sources/security_groups#result_output_file DataZenlayercloudSecurityGroups#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * ID of the security group to be queried..
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/data-sources/security_groups#security_group_id DataZenlayercloudSecurityGroups#security_group_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/data-sources/security_groups zenlayercloud_security_groups}
*/
export class DataZenlayercloudSecurityGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZenlayercloudSecurityGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/data-sources/security_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/data-sources/security_groups zenlayercloud_security_groups} Data Source
  *
  * @param scope The scope in which to define this construct
