// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs
...
export interface ZenlayercloudProviderConfig {
  ...
  * Access Key Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs#access_key_id ZenlayercloudProvider#access_key_id}
  */
  readonly accessKeyId?: string;
  /**
  * Access Key Password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs#access_key_password ZenlayercloudProvider#access_key_password}
  */
  readonly accessKeyPassword?: string;
  /**
  * The maximum timeout of the client request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs#client_timeout ZenlayercloudProvider#client_timeout}
  */
  readonly clientTimeout?: number;
  /**
  * The root domain of the API request, Default is `console.zenlayer.com`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs#domain ZenlayercloudProvider#domain}
  */
  readonly domain?: string;
  /**
  * The scheme of the API request. Valid values: `HTTP` and `HTTPS`. Default is `HTTPS`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs#scheme ZenlayercloudProvider#scheme}
  */
  readonly scheme?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs#alias ZenlayercloudProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs zenlayercloud}
*/
export class ZenlayercloudProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ZenlayercloudProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.10/docs zenlayercloud} Resource
  *
  * @param scope The scope in which to define this construct
