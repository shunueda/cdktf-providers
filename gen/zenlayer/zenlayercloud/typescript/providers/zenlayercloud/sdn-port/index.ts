// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/sdn_port
...
export interface SdnPortConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/sdn_port#business_entity_name SdnPort#business_entity_name}
  */
  readonly businessEntityName: string;
  /**
  * ID of data center.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/sdn_port#datacenter SdnPort#datacenter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/sdn_port#force_delete SdnPort#force_delete}
  */
  readonly forceDelete?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/sdn_port#id SdnPort#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/sdn_port#name SdnPort#name}
  */
  readonly name?: string;
  /**
  * Type of port. eg. 1G/10G/40G.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/sdn_port#port_type SdnPort#port_type}
  */
  readonly portType: string;
  /**
  * Description of port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/sdn_port#remarks SdnPort#remarks}
  */
  readonly remarks?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/sdn_port zenlayercloud_sdn_port}
*/
export class SdnPort extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SdnPort that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/sdn_port#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/resources/sdn_port zenlayercloud_sdn_port} Resource
  *
  * @param scope The scope in which to define this construct
