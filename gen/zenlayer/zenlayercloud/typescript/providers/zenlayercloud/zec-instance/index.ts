// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance
...
export interface ZecInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#availability_zone ZecInstance#availability_zone}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#disable_qga_agent ZecInstance#disable_qga_agent}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#enable_ip_forwarding ZecInstance#enable_ip_forwarding}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#force_delete ZecInstance#force_delete}
  */
  readonly forceDelete?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#id ZecInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#image_id ZecInstance#image_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#instance_name ZecInstance#instance_name}
  */
  readonly instanceName?: string;
  /**
  * The type of the ZEC instance. such as `z2a.cpu.4`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#instance_type ZecInstance#instance_type}
  */
  readonly instanceType: string;
  /**
  * The key pair id to use for the ZEC instance. Changing `key_id` will cause the ZEC instance reset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#key_id ZecInstance#key_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#password ZecInstance#password}
  */
  readonly password?: string;
  /**
  * The resource group id the ZEC instance belongs to, default to Default Resource Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#resource_group_id ZecInstance#resource_group_id}
  */
  readonly resourceGroupId?: string;
  /**
  * Set instance to running or stop. Default value is true, the instance will shutdown when this flag is false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#running_flag ZecInstance#running_flag}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#security_group_id ZecInstance#security_group_id}
  */
  readonly securityGroupId?: string;
  /**
  * The ID of a VPC subnet. Note: The **IPv6 only** stack subnet is not support for instance creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#subnet_id ZecInstance#subnet_id}
  */
  readonly subnetId: string;
  /**
  * Category of the system disk. Valid values: `Standard NVMe SSD`, `Basic NVMe SSD`, Default is `Standard NVMe SSD`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#system_disk_category ZecInstance#system_disk_category}
  */
  readonly systemDiskCategory?: string;
  /**
  * Size of the system disk. unit is GiB. If modified, the ZEC instance may force stop.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#system_disk_size ZecInstance#system_disk_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#time_zone ZecInstance#time_zone}
  */
  readonly timeZone?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#timeouts ZecInstance#timeouts}
  */
  readonly timeouts?: ZecInstanceTimeouts;
}
export interface ZecInstanceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#create ZecInstance#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#update ZecInstance#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance zenlayercloud_zec_instance}
*/
export class ZecInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZecInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.12/docs/resources/zec_instance zenlayercloud_zec_instance} Resource
  *
  * @param scope The scope in which to define this construct
