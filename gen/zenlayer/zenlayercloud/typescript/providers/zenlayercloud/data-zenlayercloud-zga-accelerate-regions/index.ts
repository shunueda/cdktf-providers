// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/data-sources/zga_accelerate_regions
...
export interface DataZenlayercloudZgaAccelerateRegionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/data-sources/zga_accelerate_regions#id DataZenlayercloudZgaAccelerateRegions#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/data-sources/zga_accelerate_regions#name_regex DataZenlayercloudZgaAccelerateRegions#name_regex}
  */
  readonly nameRegex?: string;
  /**
  * ID of the origin region, such as `FR`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/data-sources/zga_accelerate_regions#origin_region_id DataZenlayercloudZgaAccelerateRegions#origin_region_id}
  */
  readonly originRegionId: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/data-sources/zga_accelerate_regions#result_output_file DataZenlayercloudZgaAccelerateRegions#result_output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/data-sources/zga_accelerate_regions zenlayercloud_zga_accelerate_regions}
*/
export class DataZenlayercloudZgaAccelerateRegions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZenlayercloudZgaAccelerateRegions that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/data-sources/zga_accelerate_regions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.11/docs/data-sources/zga_accelerate_regions zenlayercloud_zga_accelerate_regions} Data Source
  *
  * @param scope The scope in which to define this construct
