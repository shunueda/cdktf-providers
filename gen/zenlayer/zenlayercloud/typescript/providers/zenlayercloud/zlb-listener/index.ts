// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener
...
export interface ZlbListenerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#health_check_conn_timeout ZlbListener#health_check_conn_timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#health_check_delay_loop ZlbListener#health_check_delay_loop}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#health_check_delay_try ZlbListener#health_check_delay_try}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#health_check_enabled ZlbListener#health_check_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#health_check_http_get_url ZlbListener#health_check_http_get_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#health_check_http_status_code ZlbListener#health_check_http_status_code}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#health_check_port ZlbListener#health_check_port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#health_check_retry ZlbListener#health_check_retry}
  */
  readonly healthCheckRetry?: number;
  /**
  * Health check protocols. Valid values: `PING_CHECK`, `TCP`, `HTTP_GET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#health_check_type ZlbListener#health_check_type}
  */
  readonly healthCheckType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#id ZlbListener#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Forwarding mode of the listener. Valid values: `DR`(stands for Direct Routing), `FNAT`(stands for Full NAT), `DNAT`(stands for Destination NAT). Default is `FNAT`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#kind ZlbListener#kind}
  */
  readonly kind?: string;
  /**
  * The name of the load balancer listener.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#listener_name ZlbListener#listener_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#port ZlbListener#port}
  */
  readonly port: string;
  /**
  * The protocol of listener. Valid values: `TCP`, `UDP`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#protocol ZlbListener#protocol}
  */
  readonly protocol: string;
  /**
  * Scheduling algorithm of the listener. Valid values: `mh`, `rr`, `wrr`, `lc`, `wlc`, `sh`, `dh`. Default value: `mh`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#scheduler ZlbListener#scheduler}
  */
  readonly scheduler?: string;
  /**
  * The ID of load balancer that the listener belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#zlb_id ZlbListener#zlb_id}
  */
  readonly zlbId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#timeouts ZlbListener#timeouts}
  */
  readonly timeouts?: ZlbListenerTimeouts;
}
export interface ZlbListenerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#create ZlbListener#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#delete ZlbListener#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#update ZlbListener#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener zenlayercloud_zlb_listener}
*/
export class ZlbListener extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZlbListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.17/docs/resources/zlb_listener zenlayercloud_zlb_listener} Resource
  *
  * @param scope The scope in which to define this construct
