// https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_eip_association
...
export interface ZecEipAssociationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_eip_association#associated_id ZecEipAssociation#associated_id}
  */
  readonly associatedId: string;
  /**
  * Type of the associated instance. Valid values: LB(Load balancer.), NIC(vNic), NAT(NAT gateway).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_eip_association#associated_type ZecEipAssociation#associated_type}
  */
  readonly associatedType: string;
  /**
  * Elastic IP bind type. Effective when the elastic IP is assigned to a vNIC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_eip_association#bind_type ZecEipAssociation#bind_type}
  */
  readonly bindType?: string;
  /**
  * ID of the elastic IP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_eip_association#eip_id ZecEipAssociation#eip_id}
  */
  readonly eipId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_eip_association#id ZecEipAssociation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_eip_association#private_ip_address ZecEipAssociation#private_ip_address}
  */
  readonly privateIpAddress?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_eip_association zenlayercloud_zec_eip_association}
*/
export class ZecEipAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZecEipAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_eip_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zenlayer/zenlayercloud/0.2.8/docs/resources/zec_eip_association zenlayercloud_zec_eip_association} Resource
  *
  * @param scope The scope in which to define this construct
