// https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/password_age_policy
...
export interface PasswordAgePolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/password_age_policy#expire_warn_days PasswordAgePolicy#expire_warn_days}
  */
  readonly expireWarnDays: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/password_age_policy#id PasswordAgePolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/password_age_policy#max_age_days PasswordAgePolicy#max_age_days}
  */
  readonly maxAgeDays: number;
  /**
  * ID of the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/password_age_policy#org_id PasswordAgePolicy#org_id}
  */
  readonly orgId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/password_age_policy zitadel_password_age_policy}
*/
export class PasswordAgePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PasswordAgePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/password_age_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/password_age_policy zitadel_password_age_policy} Resource
  *
  * @param scope The scope in which to define this construct
