// https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es
...
export interface OrgIdpGithubEsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#authorization_endpoint OrgIdpGithubEs#authorization_endpoint}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#auto_linking OrgIdpGithubEs#auto_linking}
  */
  readonly autoLinking?: string;
  /**
  * client id generated by the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#client_id OrgIdpGithubEs#client_id}
  */
  readonly clientId: string;
  /**
  * client secret generated by the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#client_secret OrgIdpGithubEs#client_secret}
  */
  readonly clientSecret: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#id OrgIdpGithubEs#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#is_auto_creation OrgIdpGithubEs#is_auto_creation}
  */
  readonly isAutoCreation: boolean | cdktf.IResolvable;
  /**
  * enable if a the ZITADEL account fields should be updated automatically on each login
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#is_auto_update OrgIdpGithubEs#is_auto_update}
  */
  readonly isAutoUpdate: boolean | cdktf.IResolvable;
  /**
  * enable if users should be able to create a new account in ZITADEL when using an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#is_creation_allowed OrgIdpGithubEs#is_creation_allowed}
  */
  readonly isCreationAllowed: boolean | cdktf.IResolvable;
  /**
  * enable if users should be able to link an existing ZITADEL user with an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#is_linking_allowed OrgIdpGithubEs#is_linking_allowed}
  */
  readonly isLinkingAllowed: boolean | cdktf.IResolvable;
  /**
  * Name of the IDP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#name OrgIdpGithubEs#name}
  */
  readonly name?: string;
  /**
  * ID of the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#org_id OrgIdpGithubEs#org_id}
  */
  readonly orgId?: string;
  /**
  * the scopes requested by ZITADEL during the request on the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#scopes OrgIdpGithubEs#scopes}
  */
  readonly scopes?: string[];
  /**
  * the providers token endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#token_endpoint OrgIdpGithubEs#token_endpoint}
  */
  readonly tokenEndpoint: string;
  /**
  * the providers user endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#user_endpoint OrgIdpGithubEs#user_endpoint}
  */
  readonly userEndpoint: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es zitadel_org_idp_github_es}
*/
export class OrgIdpGithubEs extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgIdpGithubEs that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github_es zitadel_org_idp_github_es} Resource
  *
  * @param scope The scope in which to define this construct
