// https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy
...
export interface LoginPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#allow_domain_discovery LoginPolicy#allow_domain_discovery}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#allow_external_idp LoginPolicy#allow_external_idp}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#allow_register LoginPolicy#allow_register}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#default_redirect_uri LoginPolicy#default_redirect_uri}
  */
  readonly defaultRedirectUri: string;
  /**
  * defines if user can additionally (to the loginname) be identified by their verified email address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#disable_login_with_email LoginPolicy#disable_login_with_email}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#disable_login_with_phone LoginPolicy#disable_login_with_phone}
  */
  readonly disableLoginWithPhone?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#external_login_check_lifetime LoginPolicy#external_login_check_lifetime}
  */
  readonly externalLoginCheckLifetime: string;
  /**
  * defines if a user MUST use a multi factor to log in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#force_mfa LoginPolicy#force_mfa}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#force_mfa_local_only LoginPolicy#force_mfa_local_only}
  */
  readonly forceMfaLocalOnly: boolean | cdktf.IResolvable;
  /**
  * defines if password reset link should be shown in the login screen
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#hide_password_reset LoginPolicy#hide_password_reset}
  */
  readonly hidePasswordReset: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#id LoginPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#idps LoginPolicy#idps}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#ignore_unknown_usernames LoginPolicy#ignore_unknown_usernames}
  */
  readonly ignoreUnknownUsernames: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#mfa_init_skip_lifetime LoginPolicy#mfa_init_skip_lifetime}
  */
  readonly mfaInitSkipLifetime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#multi_factor_check_lifetime LoginPolicy#multi_factor_check_lifetime}
  */
  readonly multiFactorCheckLifetime: string;
  /**
  * allowed multi factors
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#multi_factors LoginPolicy#multi_factors}
  */
  readonly multiFactors?: string[];
  /**
  * ID of the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#org_id LoginPolicy#org_id}
  */
  readonly orgId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#password_check_lifetime LoginPolicy#password_check_lifetime}
  */
  readonly passwordCheckLifetime: string;
  /**
  * defines if passwordless is allowed for users
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#passwordless_type LoginPolicy#passwordless_type}
  */
  readonly passwordlessType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#second_factor_check_lifetime LoginPolicy#second_factor_check_lifetime}
  */
  readonly secondFactorCheckLifetime: string;
  /**
  * allowed second factors
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#second_factors LoginPolicy#second_factors}
  */
  readonly secondFactors?: string[];
  /**
  * defines if a user is allowed to login with his username and password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#user_login LoginPolicy#user_login}
  */
  readonly userLogin: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy zitadel_login_policy}
*/
export class LoginPolicy extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "zitadel_login_policy";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a LoginPolicy resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the LoginPolicy to import
  * @param importFromId The id of the existing LoginPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the LoginPolicy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "zitadel_login_policy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/login_policy zitadel_login_policy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options LoginPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: LoginPolicyConfig) {
    super(scope, id, {
      terraformResourceType: 'zitadel_login_policy',
