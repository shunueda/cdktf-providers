// https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy
...
export interface DefaultLabelPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * hex value for background color
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#background_color DefaultLabelPolicy#background_color}
  */
  readonly backgroundColor: string;
  /**
  * hex value for background color dark theme
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#background_color_dark DefaultLabelPolicy#background_color_dark}
  */
  readonly backgroundColorDark: string;
  /**
  * disable watermark
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#disable_watermark DefaultLabelPolicy#disable_watermark}
  */
  readonly disableWatermark: boolean | cdktf.IResolvable;
  /**
  * hex value for font color
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#font_color DefaultLabelPolicy#font_color}
  */
  readonly fontColor: string;
  /**
  * hex value for font color dark theme
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#font_color_dark DefaultLabelPolicy#font_color_dark}
  */
  readonly fontColorDark: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#font_hash DefaultLabelPolicy#font_hash}
  */
  readonly fontHash?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#font_path DefaultLabelPolicy#font_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#hide_login_name_suffix DefaultLabelPolicy#hide_login_name_suffix}
  */
  readonly hideLoginNameSuffix: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#icon_dark_hash DefaultLabelPolicy#icon_dark_hash}
  */
  readonly iconDarkHash?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#icon_dark_path DefaultLabelPolicy#icon_dark_path}
  */
  readonly iconDarkPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#icon_hash DefaultLabelPolicy#icon_hash}
  */
  readonly iconHash?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#icon_path DefaultLabelPolicy#icon_path}
  */
  readonly iconPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#id DefaultLabelPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#logo_dark_hash DefaultLabelPolicy#logo_dark_hash}
  */
  readonly logoDarkHash?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#logo_dark_path DefaultLabelPolicy#logo_dark_path}
  */
  readonly logoDarkPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#logo_hash DefaultLabelPolicy#logo_hash}
  */
  readonly logoHash?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#logo_path DefaultLabelPolicy#logo_path}
  */
  readonly logoPath?: string;
  /**
  * hex value for primary color
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#primary_color DefaultLabelPolicy#primary_color}
  */
  readonly primaryColor: string;
  /**
  * hex value for primary color dark theme
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#primary_color_dark DefaultLabelPolicy#primary_color_dark}
  */
  readonly primaryColorDark: string;
  /**
  * set the label policy active after creating/updating
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#set_active DefaultLabelPolicy#set_active}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#theme_mode DefaultLabelPolicy#theme_mode}
  */
  readonly themeMode?: string;
  /**
  * hex value for warn color
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#warn_color DefaultLabelPolicy#warn_color}
  */
  readonly warnColor: string;
  /**
  * hex value for warn color dark theme
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#warn_color_dark DefaultLabelPolicy#warn_color_dark}
  */
  readonly warnColorDark: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy zitadel_default_label_policy}
*/
export class DefaultLabelPolicy extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "zitadel_default_label_policy";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DefaultLabelPolicy resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DefaultLabelPolicy to import
  * @param importFromId The id of the existing DefaultLabelPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DefaultLabelPolicy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "zitadel_default_label_policy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/default_label_policy zitadel_default_label_policy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DefaultLabelPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: DefaultLabelPolicyConfig) {
    super(scope, id, {
      terraformResourceType: 'zitadel_default_label_policy',
