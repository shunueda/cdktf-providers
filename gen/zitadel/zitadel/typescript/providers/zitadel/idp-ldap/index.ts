// https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap
...
export interface IdpLdapConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#auto_linking IdpLdap#auto_linking}
  */
  readonly autoLinking?: string;
  /**
  * User attribute for the avatar url
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#avatar_url_attribute IdpLdap#avatar_url_attribute}
  */
  readonly avatarUrlAttribute?: string;
  /**
  * Base DN for LDAP connections
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#base_dn IdpLdap#base_dn}
  */
  readonly baseDn: string;
  /**
  * Bind DN for LDAP connections
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#bind_dn IdpLdap#bind_dn}
  */
  readonly bindDn: string;
  /**
  * Bind password for LDAP connections
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#bind_password IdpLdap#bind_password}
  */
  readonly bindPassword: string;
  /**
  * User attribute for the display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#display_name_attribute IdpLdap#display_name_attribute}
  */
  readonly displayNameAttribute?: string;
  /**
  * User attribute for the email
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#email_attribute IdpLdap#email_attribute}
  */
  readonly emailAttribute?: string;
  /**
  * User attribute for the email verified state
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#email_verified_attribute IdpLdap#email_verified_attribute}
  */
  readonly emailVerifiedAttribute?: string;
  /**
  * User attribute for the first name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#first_name_attribute IdpLdap#first_name_attribute}
  */
  readonly firstNameAttribute?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#id IdpLdap#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#id_attribute IdpLdap#id_attribute}
  */
  readonly idAttribute?: string;
  /**
  * enable if a new account in ZITADEL should be created automatically on login with an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#is_auto_creation IdpLdap#is_auto_creation}
  */
  readonly isAutoCreation: boolean | cdktf.IResolvable;
  /**
  * enable if a the ZITADEL account fields should be updated automatically on each login
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#is_auto_update IdpLdap#is_auto_update}
  */
  readonly isAutoUpdate: boolean | cdktf.IResolvable;
  /**
  * enable if users should be able to create a new account in ZITADEL when using an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#is_creation_allowed IdpLdap#is_creation_allowed}
  */
  readonly isCreationAllowed: boolean | cdktf.IResolvable;
  /**
  * enable if users should be able to link an existing ZITADEL user with an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#is_linking_allowed IdpLdap#is_linking_allowed}
  */
  readonly isLinkingAllowed: boolean | cdktf.IResolvable;
  /**
  * User attribute for the last name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#last_name_attribute IdpLdap#last_name_attribute}
  */
  readonly lastNameAttribute?: string;
  /**
  * Name of the IDP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#name IdpLdap#name}
  */
  readonly name?: string;
  /**
  * User attribute for the nick name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#nick_name_attribute IdpLdap#nick_name_attribute}
  */
  readonly nickNameAttribute?: string;
  /**
  * User attribute for the phone
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#phone_attribute IdpLdap#phone_attribute}
  */
  readonly phoneAttribute?: string;
  /**
  * User attribute for the phone verified state
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#phone_verified_attribute IdpLdap#phone_verified_attribute}
  */
  readonly phoneVerifiedAttribute?: string;
  /**
  * User attribute for the preferred language
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#preferred_language_attribute IdpLdap#preferred_language_attribute}
  */
  readonly preferredLanguageAttribute?: string;
  /**
  * User attribute for the preferred username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#preferred_username_attribute IdpLdap#preferred_username_attribute}
  */
  readonly preferredUsernameAttribute?: string;
  /**
  * User attribute for the profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#profile_attribute IdpLdap#profile_attribute}
  */
  readonly profileAttribute?: string;
  /**
  * Servers to try in order for establishing LDAP connections
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#servers IdpLdap#servers}
  */
  readonly servers: string[];
  /**
  * Wether to use StartTLS for LDAP connections
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#start_tls IdpLdap#start_tls}
  */
  readonly startTls: boolean | cdktf.IResolvable;
  /**
  * Timeout for LDAP connections
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#timeout IdpLdap#timeout}
  */
  readonly timeout: string;
  /**
  * User base for LDAP connections
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#user_base IdpLdap#user_base}
  */
  readonly userBase: string;
  /**
  * User filters for LDAP connections
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#user_filters IdpLdap#user_filters}
  */
  readonly userFilters: string[];
  /**
  * User object classes for LDAP connections
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#user_object_classes IdpLdap#user_object_classes}
  */
  readonly userObjectClasses: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap zitadel_idp_ldap}
*/
export class IdpLdap extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a IdpLdap resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the IdpLdap to import
  * @param importFromId The id of the existing IdpLdap that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IdpLdap to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_ldap zitadel_idp_ldap} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IdpLdapConfig
  */
  public constructor(scope: Construct, id: string, config: IdpLdapConfig) {
    super(scope, id, {
