// https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/data-sources/idp_gitlab_self_hosted
...
export interface DataZitadelIdpGitlabSelfHostedConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/data-sources/idp_gitlab_self_hosted#id DataZitadelIdpGitlabSelfHosted#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/data-sources/idp_gitlab_self_hosted zitadel_idp_gitlab_self_hosted}
*/
export class DataZitadelIdpGitlabSelfHosted extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZitadelIdpGitlabSelfHosted that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/data-sources/idp_gitlab_self_hosted#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/data-sources/idp_gitlab_self_hosted zitadel_idp_gitlab_self_hosted} Data Source
  *
  * @param scope The scope in which to define this construct
