// https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth
...
export interface OrgIdpOauthConfig extends cdktf.TerraformMetaArguments {
  /**
  * The authorization endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#authorization_endpoint OrgIdpOauth#authorization_endpoint}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#auto_linking OrgIdpOauth#auto_linking}
  */
  readonly autoLinking?: string;
  /**
  * client id generated by the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#client_id OrgIdpOauth#client_id}
  */
  readonly clientId: string;
  /**
  * client secret generated by the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#client_secret OrgIdpOauth#client_secret}
  */
  readonly clientSecret: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#id OrgIdpOauth#id}
  *
  ...
  * The id attribute
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#id_attribute OrgIdpOauth#id_attribute}
  */
  readonly idAttribute: string;
  /**
  * enable if a new account in ZITADEL should be created automatically on login with an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#is_auto_creation OrgIdpOauth#is_auto_creation}
  */
  readonly isAutoCreation: boolean | cdktf.IResolvable;
  /**
  * enable if a the ZITADEL account fields should be updated automatically on each login
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#is_auto_update OrgIdpOauth#is_auto_update}
  */
  readonly isAutoUpdate: boolean | cdktf.IResolvable;
  /**
  * enable if users should be able to create a new account in ZITADEL when using an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#is_creation_allowed OrgIdpOauth#is_creation_allowed}
  */
  readonly isCreationAllowed: boolean | cdktf.IResolvable;
  /**
  * enable if users should be able to link an existing ZITADEL user with an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#is_linking_allowed OrgIdpOauth#is_linking_allowed}
  */
  readonly isLinkingAllowed: boolean | cdktf.IResolvable;
  /**
  * Name of the IDP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#name OrgIdpOauth#name}
  */
  readonly name?: string;
  /**
  * ID of the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#org_id OrgIdpOauth#org_id}
  */
  readonly orgId?: string;
  /**
  * the scopes requested by ZITADEL during the request on the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#scopes OrgIdpOauth#scopes}
  */
  readonly scopes?: string[];
  /**
  * The token endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#token_endpoint OrgIdpOauth#token_endpoint}
  */
  readonly tokenEndpoint: string;
  /**
  * The user endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#user_endpoint OrgIdpOauth#user_endpoint}
  */
  readonly userEndpoint: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth zitadel_org_idp_oauth}
*/
export class OrgIdpOauth extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "zitadel_org_idp_oauth";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a OrgIdpOauth resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the OrgIdpOauth to import
  * @param importFromId The id of the existing OrgIdpOauth that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the OrgIdpOauth to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "zitadel_org_idp_oauth", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_oauth zitadel_org_idp_oauth} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options OrgIdpOauthConfig
  */
  public constructor(scope: Construct, id: string, config: OrgIdpOauthConfig) {
    super(scope, id, {
      terraformResourceType: 'zitadel_org_idp_oauth',
  ...
  // id_attribute - computed: false, optional: false, required: true
  ...
  // user_endpoint - computed: false, optional: false, required: true
