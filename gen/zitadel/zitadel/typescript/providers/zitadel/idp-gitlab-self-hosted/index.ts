// https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted
...
export interface IdpGitlabSelfHostedConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted#auto_linking IdpGitlabSelfHosted#auto_linking}
  */
  readonly autoLinking?: string;
  /**
  * client id generated by the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted#client_id IdpGitlabSelfHosted#client_id}
  */
  readonly clientId: string;
  /**
  * client secret generated by the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted#client_secret IdpGitlabSelfHosted#client_secret}
  */
  readonly clientSecret: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted#id IdpGitlabSelfHosted#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted#is_auto_creation IdpGitlabSelfHosted#is_auto_creation}
  */
  readonly isAutoCreation: boolean | cdktf.IResolvable;
  /**
  * enable if a the ZITADEL account fields should be updated automatically on each login
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted#is_auto_update IdpGitlabSelfHosted#is_auto_update}
  */
  readonly isAutoUpdate: boolean | cdktf.IResolvable;
  /**
  * enable if users should be able to create a new account in ZITADEL when using an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted#is_creation_allowed IdpGitlabSelfHosted#is_creation_allowed}
  */
  readonly isCreationAllowed: boolean | cdktf.IResolvable;
  /**
  * enable if users should be able to link an existing ZITADEL user with an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted#is_linking_allowed IdpGitlabSelfHosted#is_linking_allowed}
  */
  readonly isLinkingAllowed: boolean | cdktf.IResolvable;
  /**
  * the providers issuer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted#issuer IdpGitlabSelfHosted#issuer}
  */
  readonly issuer: string;
  /**
  * Name of the IDP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted#name IdpGitlabSelfHosted#name}
  */
  readonly name?: string;
  /**
  * the scopes requested by ZITADEL during the request on the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted#scopes IdpGitlabSelfHosted#scopes}
  */
  readonly scopes?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted zitadel_idp_gitlab_self_hosted}
*/
export class IdpGitlabSelfHosted extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdpGitlabSelfHosted that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/idp_gitlab_self_hosted zitadel_idp_gitlab_self_hosted} Resource
  *
  * @param scope The scope in which to define this construct
