// https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github
...
export interface OrgIdpGithubConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github#auto_linking OrgIdpGithub#auto_linking}
  */
  readonly autoLinking?: string;
  /**
  * client id generated by the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github#client_id OrgIdpGithub#client_id}
  */
  readonly clientId: string;
  /**
  * client secret generated by the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github#client_secret OrgIdpGithub#client_secret}
  */
  readonly clientSecret: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github#id OrgIdpGithub#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github#is_auto_creation OrgIdpGithub#is_auto_creation}
  */
  readonly isAutoCreation: boolean | cdktf.IResolvable;
  /**
  * enable if a the ZITADEL account fields should be updated automatically on each login
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github#is_auto_update OrgIdpGithub#is_auto_update}
  */
  readonly isAutoUpdate: boolean | cdktf.IResolvable;
  /**
  * enable if users should be able to create a new account in ZITADEL when using an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github#is_creation_allowed OrgIdpGithub#is_creation_allowed}
  */
  readonly isCreationAllowed: boolean | cdktf.IResolvable;
  /**
  * enable if users should be able to link an existing ZITADEL user with an external account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github#is_linking_allowed OrgIdpGithub#is_linking_allowed}
  */
  readonly isLinkingAllowed: boolean | cdktf.IResolvable;
  /**
  * Name of the IDP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github#name OrgIdpGithub#name}
  */
  readonly name?: string;
  /**
  * ID of the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github#org_id OrgIdpGithub#org_id}
  */
  readonly orgId?: string;
  /**
  * the scopes requested by ZITADEL during the request on the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github#scopes OrgIdpGithub#scopes}
  */
  readonly scopes?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github zitadel_org_idp_github}
*/
export class OrgIdpGithub extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a OrgIdpGithub resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the OrgIdpGithub to import
  * @param importFromId The id of the existing OrgIdpGithub that should be imported. Refer to the {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the OrgIdpGithub to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zitadel/zitadel/2.3.0/docs/resources/org_idp_github zitadel_org_idp_github} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options OrgIdpGithubConfig
  */
  public constructor(scope: Construct, id: string, config: OrgIdpGithubConfig) {
    super(scope, id, {
