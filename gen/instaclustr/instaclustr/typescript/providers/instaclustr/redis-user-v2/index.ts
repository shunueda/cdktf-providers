// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/redis_user_v2
...
export interface RedisUserV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/redis_user_v2#cluster_id RedisUserV2#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/redis_user_v2#id RedisUserV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/redis_user_v2#initial_permissions RedisUserV2#initial_permissions}
  */
  readonly initialPermissions: string;
  /**
  * Password for the Redis user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/redis_user_v2#password RedisUserV2#password}
  */
  readonly password: string;
  /**
  * Username of the Redis user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/redis_user_v2#username RedisUserV2#username}
  */
  readonly username: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/redis_user_v2#timeouts RedisUserV2#timeouts}
  */
  readonly timeouts?: RedisUserV2Timeouts;
}
export interface RedisUserV2Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/redis_user_v2#default RedisUserV2#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/redis_user_v2 instaclustr_redis_user_v2}
*/
export class RedisUserV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisUserV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/redis_user_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/redis_user_v2 instaclustr_redis_user_v2} Resource
  *
  * @param scope The scope in which to define this construct
