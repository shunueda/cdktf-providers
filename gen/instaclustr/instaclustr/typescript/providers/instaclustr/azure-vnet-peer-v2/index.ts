// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2
...
export interface AzureVnetPeerV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#cdc_id AzureVnetPeerV2#cdc_id}
  */
  readonly cdcId: string;
  /**
  * Resource Group Name of the Data Centre Virtual Network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#data_centre_resource_group AzureVnetPeerV2#data_centre_resource_group}
  */
  readonly dataCentreResourceGroup?: string;
  /**
  * Subscription ID of the Data Centre Virtual Network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#data_centre_subscription_id AzureVnetPeerV2#data_centre_subscription_id}
  */
  readonly dataCentreSubscriptionId?: string;
  /**
  * The name of the Data Centre Virtual Network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#data_centre_virtual_network_name AzureVnetPeerV2#data_centre_virtual_network_name}
  */
  readonly dataCentreVirtualNetworkName?: string;
  /**
  * Reason for Peering Connection Failure.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#failure_reason AzureVnetPeerV2#failure_reason}
  */
  readonly failureReason?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#id AzureVnetPeerV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#name AzureVnetPeerV2#name}
  */
  readonly name?: string;
  /**
  * ID of the Active Directory Object to give peering permissions to, required for cross subscription peering.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#peer_ad_object_id AzureVnetPeerV2#peer_ad_object_id}
  */
  readonly peerAdObjectId?: string;
  /**
  * Resource Group Name of the Virtual Network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#peer_resource_group AzureVnetPeerV2#peer_resource_group}
  */
  readonly peerResourceGroup: string;
  /**
  * The subnets for the peering VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#peer_subnets AzureVnetPeerV2#peer_subnets}
  */
  readonly peerSubnets: string[];
  /**
  * Subscription ID of the Virtual Network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#peer_subscription_id AzureVnetPeerV2#peer_subscription_id}
  */
  readonly peerSubscriptionId: string;
  /**
  * The name of the VPC Network you wish to peer to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#peer_virtual_network_name AzureVnetPeerV2#peer_virtual_network_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#status_code AzureVnetPeerV2#status_code}
  */
  readonly statusCode?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#timeouts AzureVnetPeerV2#timeouts}
  */
  readonly timeouts?: AzureVnetPeerV2Timeouts;
}
export interface AzureVnetPeerV2Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#default AzureVnetPeerV2#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2 instaclustr_azure_vnet_peer_v2}
*/
export class AzureVnetPeerV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureVnetPeerV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/azure_vnet_peer_v2 instaclustr_azure_vnet_peer_v2} Resource
  *
  * @param scope The scope in which to define this construct
