// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.25/docs/data-sources/cluster_waiter_v2_instance
...
export interface DataInstaclustrClusterWaiterV2InstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.25/docs/data-sources/cluster_waiter_v2_instance#cluster_id DataInstaclustrClusterWaiterV2Instance#cluster_id}
  */
  readonly clusterId?: string;
  /**
  * Indicates if the cluster is currently performing any restructuring operation such as being created or resized
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.25/docs/data-sources/cluster_waiter_v2_instance#current_cluster_operation_status DataInstaclustrClusterWaiterV2Instance#current_cluster_operation_status}
  */
  readonly currentClusterOperationStatus?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.25/docs/data-sources/cluster_waiter_v2_instance#id DataInstaclustrClusterWaiterV2Instance#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.25/docs/data-sources/cluster_waiter_v2_instance instaclustr_cluster_waiter_v2_instance}
*/
export class DataInstaclustrClusterWaiterV2Instance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataInstaclustrClusterWaiterV2Instance that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.25/docs/data-sources/cluster_waiter_v2_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.25/docs/data-sources/cluster_waiter_v2_instance instaclustr_cluster_waiter_v2_instance} Data Source
  *
  * @param scope The scope in which to define this construct
