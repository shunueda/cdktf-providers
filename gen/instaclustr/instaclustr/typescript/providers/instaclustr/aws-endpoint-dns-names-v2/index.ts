// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_endpoint_dns_names_v2
...
export interface AwsEndpointDnsNamesV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_endpoint_dns_names_v2#aws_endpoint_dns_names AwsEndpointDnsNamesV2#aws_endpoint_dns_names}
  */
  readonly awsEndpointDnsNames: string[];
  /**
  * ID of the cluster data center
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_endpoint_dns_names_v2#cluster_data_center_id AwsEndpointDnsNamesV2#cluster_data_center_id}
  */
  readonly clusterDataCenterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_endpoint_dns_names_v2#id AwsEndpointDnsNamesV2#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_endpoint_dns_names_v2#timeouts AwsEndpointDnsNamesV2#timeouts}
  */
  readonly timeouts?: AwsEndpointDnsNamesV2Timeouts;
}
export interface AwsEndpointDnsNamesV2Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_endpoint_dns_names_v2#default AwsEndpointDnsNamesV2#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_endpoint_dns_names_v2 instaclustr_aws_endpoint_dns_names_v2}
*/
export class AwsEndpointDnsNamesV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsEndpointDnsNamesV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_endpoint_dns_names_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_endpoint_dns_names_v2 instaclustr_aws_endpoint_dns_names_v2} Resource
  *
  * @param scope The scope in which to define this construct
