// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.31/docs/resources/kafka_user_v5
...
export interface KafkaUserV5Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.31/docs/resources/kafka_user_v5#auth_mechanism KafkaUserV5#auth_mechanism}
  */
  readonly authMechanism: string;
  /**
  * ID of the Kafka cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.31/docs/resources/kafka_user_v5#cluster_id KafkaUserV5#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Indicates if the cluster is currently performing any operation such as being created, updated, or deleted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.31/docs/resources/kafka_user_v5#current_operation_status KafkaUserV5#current_operation_status}
  */
  readonly currentOperationStatus?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.31/docs/resources/kafka_user_v5#id KafkaUserV5#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.31/docs/resources/kafka_user_v5#password KafkaUserV5#password}
  */
  readonly password?: string;
  /**
  * Scram Mechanism for SASL authentication. Valid values: SCRAM-SHA-256, SCRAM-SHA-512
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.31/docs/resources/kafka_user_v5#sasl_scram_mechanism KafkaUserV5#sasl_scram_mechanism}
  */
  readonly saslScramMechanism?: string;
  /**
  * Username of the Kafka user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.31/docs/resources/kafka_user_v5#username KafkaUserV5#username}
  */
  readonly username: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.31/docs/resources/kafka_user_v5#timeouts KafkaUserV5#timeouts}
  */
  readonly timeouts?: KafkaUserV5Timeouts;
}
export interface KafkaUserV5Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.31/docs/resources/kafka_user_v5#default KafkaUserV5#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.31/docs/resources/kafka_user_v5 instaclustr_kafka_user_v5}
*/
export class KafkaUserV5 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KafkaUserV5 that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.31/docs/resources/kafka_user_v5#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.31/docs/resources/kafka_user_v5 instaclustr_kafka_user_v5} Resource
  *
  * @param scope The scope in which to define this construct
