// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/data-sources/aws_endpoint_dns_names_v2_instance
...
export interface DataInstaclustrAwsEndpointDnsNamesV2InstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/data-sources/aws_endpoint_dns_names_v2_instance#aws_endpoint_dns_names DataInstaclustrAwsEndpointDnsNamesV2Instance#aws_endpoint_dns_names}
  */
  readonly awsEndpointDnsNames?: string[];
  /**
  * ID of the cluster data center
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/data-sources/aws_endpoint_dns_names_v2_instance#cluster_data_center_id DataInstaclustrAwsEndpointDnsNamesV2Instance#cluster_data_center_id}
  */
  readonly clusterDataCenterId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/data-sources/aws_endpoint_dns_names_v2_instance#id DataInstaclustrAwsEndpointDnsNamesV2Instance#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/data-sources/aws_endpoint_dns_names_v2_instance instaclustr_aws_endpoint_dns_names_v2_instance}
*/
export class DataInstaclustrAwsEndpointDnsNamesV2Instance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataInstaclustrAwsEndpointDnsNamesV2Instance that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/data-sources/aws_endpoint_dns_names_v2_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/data-sources/aws_endpoint_dns_names_v2_instance instaclustr_aws_endpoint_dns_names_v2_instance} Data Source
  *
  * @param scope The scope in which to define this construct
