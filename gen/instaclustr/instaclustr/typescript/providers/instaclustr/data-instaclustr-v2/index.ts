// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2
...
export interface DataInstaclustrV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2#cloud_provider DataInstaclustrV2#cloud_provider}
  */
  readonly cloudProvider?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2#id DataInstaclustrV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2#name DataInstaclustrV2#name}
  */
  readonly name?: string;
  /**
  * PCI configuration (enabled/disabled).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2#pci DataInstaclustrV2#pci}
  */
  readonly pci?: boolean | cdktf.IResolvable;
  /**
  * The region of the Zero Inbound Access gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2#region DataInstaclustrV2#region}
  */
  readonly region?: string;
  /**
  * The status of the Zero Inbound Access gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2#status DataInstaclustrV2#status}
  */
  readonly status?: string;
  /**
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2#filter DataInstaclustrV2#filter}
  */
  readonly filter?: DataInstaclustrV2Filter[] | cdktf.IResolvable;
  /**
  * tag block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2#tag DataInstaclustrV2#tag}
  */
...
export interface DataInstaclustrV2Filter {
  ...
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2#values DataInstaclustrV2#values}
  */
...
export interface DataInstaclustrV2Tag {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2#key DataInstaclustrV2#key}
  */
  readonly key?: string;
  /**
  * Value of the tag for the Data Centre.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2#value DataInstaclustrV2#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2 instaclustr_v2}
*/
export class DataInstaclustrV2 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataInstaclustrV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/data-sources/v2 instaclustr_v2} Data Source
  *
  * @param scope The scope in which to define this construct
