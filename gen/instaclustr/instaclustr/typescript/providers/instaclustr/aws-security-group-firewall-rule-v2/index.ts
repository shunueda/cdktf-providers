// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_security_group_firewall_rule_v2
...
export interface AwsSecurityGroupFirewallRuleV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_security_group_firewall_rule_v2#cluster_id AwsSecurityGroupFirewallRuleV2#cluster_id}
  */
  readonly clusterId: string;
  /**
  * The reason (if needed) for the deferred status of the AWS security group firewall rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_security_group_firewall_rule_v2#deferred_reason AwsSecurityGroupFirewallRuleV2#deferred_reason}
  */
  readonly deferredReason?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_security_group_firewall_rule_v2#id AwsSecurityGroupFirewallRuleV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_security_group_firewall_rule_v2#security_group_id AwsSecurityGroupFirewallRuleV2#security_group_id}
  */
  readonly securityGroupId: string;
  /**
  * The status of the AWS security group firewall rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_security_group_firewall_rule_v2#status AwsSecurityGroupFirewallRuleV2#status}
  */
  readonly status?: string;
  /**
  * The type of firewall rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_security_group_firewall_rule_v2#type AwsSecurityGroupFirewallRuleV2#type}
  */
  readonly type: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_security_group_firewall_rule_v2#timeouts AwsSecurityGroupFirewallRuleV2#timeouts}
  */
  readonly timeouts?: AwsSecurityGroupFirewallRuleV2Timeouts;
}
export interface AwsSecurityGroupFirewallRuleV2Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_security_group_firewall_rule_v2#create AwsSecurityGroupFirewallRuleV2#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_security_group_firewall_rule_v2#default AwsSecurityGroupFirewallRuleV2#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_security_group_firewall_rule_v2 instaclustr_aws_security_group_firewall_rule_v2}
*/
export class AwsSecurityGroupFirewallRuleV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsSecurityGroupFirewallRuleV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_security_group_firewall_rule_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/aws_security_group_firewall_rule_v2 instaclustr_aws_security_group_firewall_rule_v2} Resource
  *
  * @param scope The scope in which to define this construct
