// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.37/docs/resources/kafka_user_v4
...
export interface KafkaUserV4Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.37/docs/resources/kafka_user_v4#auth_mechanism KafkaUserV4#auth_mechanism}
  */
  readonly authMechanism: string;
  /**
  * ID of the Kafka cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.37/docs/resources/kafka_user_v4#cluster_id KafkaUserV4#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.37/docs/resources/kafka_user_v4#id KafkaUserV4#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.37/docs/resources/kafka_user_v4#override_existing_user KafkaUserV4#override_existing_user}
  */
  readonly overrideExistingUser?: boolean | cdktf.IResolvable;
  /**
  * Password for the Kafka user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.37/docs/resources/kafka_user_v4#password KafkaUserV4#password}
  */
  readonly password?: string;
  /**
  * Scram Mechanism for SASL authentication. Valid values: SCRAM-SHA-256, SCRAM-SHA-512
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.37/docs/resources/kafka_user_v4#sasl_scram_mechanism KafkaUserV4#sasl_scram_mechanism}
  */
  readonly saslScramMechanism?: string;
  /**
  * Username of the Kafka user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.37/docs/resources/kafka_user_v4#username KafkaUserV4#username}
  */
  readonly username: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.37/docs/resources/kafka_user_v4#timeouts KafkaUserV4#timeouts}
  */
  readonly timeouts?: KafkaUserV4Timeouts;
}
export interface KafkaUserV4Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.37/docs/resources/kafka_user_v4#default KafkaUserV4#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.37/docs/resources/kafka_user_v4 instaclustr_kafka_user_v4}
*/
export class KafkaUserV4 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KafkaUserV4 that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.37/docs/resources/kafka_user_v4#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.37/docs/resources/kafka_user_v4 instaclustr_kafka_user_v4} Resource
  *
  * @param scope The scope in which to define this construct
