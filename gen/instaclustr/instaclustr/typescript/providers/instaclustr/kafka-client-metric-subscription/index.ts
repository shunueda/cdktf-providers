// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/kafka_client_metric_subscription
...
export interface KafkaClientMetricSubscriptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/kafka_client_metric_subscription#clients KafkaClientMetricSubscription#clients}
  */
  readonly clients?: string;
  /**
  * ID of the Kafka cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/kafka_client_metric_subscription#cluster_id KafkaClientMetricSubscription#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/kafka_client_metric_subscription#id KafkaClientMetricSubscription#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/kafka_client_metric_subscription#interval KafkaClientMetricSubscription#interval}
  */
  readonly interval?: number;
  /**
  * The metrics to subscribe to. Wild card values are supported here.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/kafka_client_metric_subscription#metrics KafkaClientMetricSubscription#metrics}
  */
  readonly metrics?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/kafka_client_metric_subscription#timeouts KafkaClientMetricSubscription#timeouts}
  */
  readonly timeouts?: KafkaClientMetricSubscriptionTimeouts;
}
export interface KafkaClientMetricSubscriptionTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/kafka_client_metric_subscription#default KafkaClientMetricSubscription#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/kafka_client_metric_subscription instaclustr_kafka_client_metric_subscription}
*/
export class KafkaClientMetricSubscription extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KafkaClientMetricSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/kafka_client_metric_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.30/docs/resources/kafka_client_metric_subscription instaclustr_kafka_client_metric_subscription} Resource
  *
  * @param scope The scope in which to define this construct
