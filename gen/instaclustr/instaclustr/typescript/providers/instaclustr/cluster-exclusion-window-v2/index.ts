// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/cluster_exclusion_window_v2
...
export interface ClusterExclusionWindowV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/cluster_exclusion_window_v2#cluster_id ClusterExclusionWindowV2#cluster_id}
  */
  readonly clusterId: string;
  /**
  * The day of the week that this exclusion window starts on
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/cluster_exclusion_window_v2#day_of_week ClusterExclusionWindowV2#day_of_week}
  */
  readonly dayOfWeek: string;
  /**
  * The duration (in hours) of this exclusion window
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/cluster_exclusion_window_v2#duration_in_hours ClusterExclusionWindowV2#duration_in_hours}
  */
  readonly durationInHours: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/cluster_exclusion_window_v2#id ClusterExclusionWindowV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/cluster_exclusion_window_v2#start_hour ClusterExclusionWindowV2#start_hour}
  */
  readonly startHour: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/cluster_exclusion_window_v2#timeouts ClusterExclusionWindowV2#timeouts}
  */
  readonly timeouts?: ClusterExclusionWindowV2Timeouts;
}
export interface ClusterExclusionWindowV2Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/cluster_exclusion_window_v2#default ClusterExclusionWindowV2#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/cluster_exclusion_window_v2 instaclustr_cluster_exclusion_window_v2}
*/
export class ClusterExclusionWindowV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusterExclusionWindowV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/cluster_exclusion_window_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.26/docs/resources/cluster_exclusion_window_v2 instaclustr_cluster_exclusion_window_v2} Resource
  *
  * @param scope The scope in which to define this construct
