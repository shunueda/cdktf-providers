// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2
...
export interface GcpVpcPeerV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2#cdc_id GcpVpcPeerV2#cdc_id}
  */
  readonly cdcId: string;
  /**
  * GCP Project ID of the Data Centre.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2#data_centre_project_id GcpVpcPeerV2#data_centre_project_id}
  */
  readonly dataCentreProjectId?: string;
  /**
  * Vpc Network Name of the Data Centre VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2#data_centre_vpc_network_name GcpVpcPeerV2#data_centre_vpc_network_name}
  */
  readonly dataCentreVpcNetworkName?: string;
  /**
  * Reason for Peering Connection Failure.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2#failure_reason GcpVpcPeerV2#failure_reason}
  */
  readonly failureReason?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2#id GcpVpcPeerV2#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2#name GcpVpcPeerV2#name}
  */
  readonly name?: string;
  /**
  * The project ID of the owner of the accepter VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2#peer_project_id GcpVpcPeerV2#peer_project_id}
  */
  readonly peerProjectId: string;
  /**
  * The subnets for the peering VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2#peer_subnets GcpVpcPeerV2#peer_subnets}
  */
  readonly peerSubnets: string[];
  /**
  * The name of the VPC Network you wish to peer to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2#peer_vpc_network_name GcpVpcPeerV2#peer_vpc_network_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2#status_code GcpVpcPeerV2#status_code}
  */
  readonly statusCode?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2#timeouts GcpVpcPeerV2#timeouts}
  */
  readonly timeouts?: GcpVpcPeerV2Timeouts;
}
export interface GcpVpcPeerV2Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2#default GcpVpcPeerV2#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2 instaclustr_gcp_vpc_peer_v2}
*/
export class GcpVpcPeerV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GcpVpcPeerV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.34/docs/resources/gcp_vpc_peer_v2 instaclustr_gcp_vpc_peer_v2} Resource
  *
  * @param scope The scope in which to define this construct
