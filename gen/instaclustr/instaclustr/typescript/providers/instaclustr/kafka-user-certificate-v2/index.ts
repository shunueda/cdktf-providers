// https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.33/docs/resources/kafka_user_certificate_v2
...
export interface KafkaUserCertificateV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.33/docs/resources/kafka_user_certificate_v2#cluster_id KafkaUserCertificateV2#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Certificate signing request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.33/docs/resources/kafka_user_certificate_v2#csr KafkaUserCertificateV2#csr}
  */
  readonly csr: string;
  /**
  * Date certificate expires.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.33/docs/resources/kafka_user_certificate_v2#expiry_date KafkaUserCertificateV2#expiry_date}
  */
  readonly expiryDate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.33/docs/resources/kafka_user_certificate_v2#id KafkaUserCertificateV2#id}
  *
  ...
  * The Kafka username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.33/docs/resources/kafka_user_certificate_v2#kafka_username KafkaUserCertificateV2#kafka_username}
  */
  readonly kafkaUsername: string;
  /**
  * Generated client signed certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.33/docs/resources/kafka_user_certificate_v2#signed_certificate KafkaUserCertificateV2#signed_certificate}
  */
  readonly signedCertificate?: string;
  /**
  * Number of months for which the certificate will be valid.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.33/docs/resources/kafka_user_certificate_v2#valid_period KafkaUserCertificateV2#valid_period}
  */
  readonly validPeriod: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.33/docs/resources/kafka_user_certificate_v2#timeouts KafkaUserCertificateV2#timeouts}
  */
  readonly timeouts?: KafkaUserCertificateV2Timeouts;
}
export interface KafkaUserCertificateV2Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.33/docs/resources/kafka_user_certificate_v2#default KafkaUserCertificateV2#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.33/docs/resources/kafka_user_certificate_v2 instaclustr_kafka_user_certificate_v2}
*/
export class KafkaUserCertificateV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KafkaUserCertificateV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.33/docs/resources/kafka_user_certificate_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/instaclustr/instaclustr/2.1.33/docs/resources/kafka_user_certificate_v2 instaclustr_kafka_user_certificate_v2} Resource
  *
  * @param scope The scope in which to define this construct
