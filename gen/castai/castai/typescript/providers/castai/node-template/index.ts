...
export interface NodeTemplatePriceAdjustmentConfiguration {
  /**
...
export function nodeTemplatePriceAdjustmentConfigurationToTerraform(struct?: NodeTemplatePriceAdjustmentConfigurationOutputReference | NodeTemplatePriceAdjustmentConfiguration): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    instance_type_adjustments: cdktf.hashMapper(cdktf.stringToTerraform)(struct!.instanceTypeAdjustments),
  }
}


export function nodeTemplatePriceAdjustmentConfigurationToHclTerraform(struct?: NodeTemplatePriceAdjustmentConfigurationOutputReference | NodeTemplatePriceAdjustmentConfiguration): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    instance_type_adjustments: {
      value: cdktf.hashMapperHcl(cdktf.stringToHclTerraform)(struct!.instanceTypeAdjustments),
      isBlock: false,
      type: "map",
...
export class NodeTemplatePriceAdjustmentConfigurationOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): NodeTemplatePriceAdjustmentConfiguration | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._instanceTypeAdjustments !== undefined) {
      hasAnyValues = true;
      internalValueResult.instanceTypeAdjustments = this._instanceTypeAdjustments;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: NodeTemplatePriceAdjustmentConfiguration | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._instanceTypeAdjustments = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._instanceTypeAdjustments = value.instanceTypeAdjustments;
    }
  }

  // instance_type_adjustments - computed: false, optional: true, required: false
  private _instanceTypeAdjustments?: { [key: string]: string }; 
  public get instanceTypeAdjustments() {
    return this.getStringMapAttribute('instance_type_adjustments');
  }
  public set instanceTypeAdjustments(value: { [key: string]: string }) {
    this._instanceTypeAdjustments = value;
  }
  public resetInstanceTypeAdjustments() {
    this._instanceTypeAdjustments = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get instanceTypeAdjustmentsInput() {
    return this._instanceTypeAdjustments;
  }
}
...
export class NodeTemplate extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: NodeTemplateConfig) {
    ...
    this._priceAdjustmentConfiguration.internalValue = config.priceAdjustmentConfiguration;
  ...
  // price_adjustment_configuration - computed: false, optional: true, required: false
  private _priceAdjustmentConfiguration = new NodeTemplatePriceAdjustmentConfigurationOutputReference(this, "price_adjustment_configuration");
  public get priceAdjustmentConfiguration() {
    return this._priceAdjustmentConfiguration;
  }
  public putPriceAdjustmentConfiguration(value: NodeTemplatePriceAdjustmentConfiguration) {
    this._priceAdjustmentConfiguration.internalValue = value;
  }
  public resetPriceAdjustmentConfiguration() {
    this._priceAdjustmentConfiguration.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get priceAdjustmentConfigurationInput() {
    return this._priceAdjustmentConfiguration.internalValue;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      price_adjustment_configuration: nodeTemplatePriceAdjustmentConfigurationToTerraform(this._priceAdjustmentConfiguration.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      price_adjustment_configuration: {
        value: nodeTemplatePriceAdjustmentConfigurationToHclTerraform(this._priceAdjustmentConfiguration.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "NodeTemplatePriceAdjustmentConfigurationList",
      },
      timeouts: {
