// https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule
...
export interface SecurityRuntimeRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule#category SecurityRuntimeRule#category}
  */
  readonly category?: string;
  /**
  * Whether the rule is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule#enabled SecurityRuntimeRule#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule#id SecurityRuntimeRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule#labels SecurityRuntimeRule#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Unique name of the runtime security rule. Name is used as resource identifier in Terraform.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule#name SecurityRuntimeRule#name}
  */
  readonly name: string;
  /**
  * Optional CEL expression for resource selection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule#resource_selector SecurityRuntimeRule#resource_selector}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule#rule_engine_type SecurityRuntimeRule#rule_engine_type}
  */
  readonly ruleEngineType?: string;
  /**
  * CEL rule expression text.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule#rule_text SecurityRuntimeRule#rule_text}
  */
  readonly ruleText: string;
  /**
  * Severity of the rule. One of SEVERITY_CRITICAL, SEVERITY_HIGH, SEVERITY_MEDIUM, SEVERITY_LOW, SEVERITY_NONE.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule#severity SecurityRuntimeRule#severity}
  */
  readonly severity: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule#timeouts SecurityRuntimeRule#timeouts}
  */
  readonly timeouts?: SecurityRuntimeRuleTimeouts;
}
export interface SecurityRuntimeRuleTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule#create SecurityRuntimeRule#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule#delete SecurityRuntimeRule#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule#read SecurityRuntimeRule#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule castai_security_runtime_rule}
*/
export class SecurityRuntimeRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityRuntimeRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/security_runtime_rule castai_security_runtime_rule} Resource
  *
  * @param scope The scope in which to define this construct
