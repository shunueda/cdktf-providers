// https://registry.terraform.io/providers/castai/castai/8.1.0/docs/resources/allocation_group
...
export interface AllocationGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.1.0/docs/resources/allocation_group#cluster_ids AllocationGroup#cluster_ids}
  */
  readonly clusterIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.1.0/docs/resources/allocation_group#id AllocationGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.1.0/docs/resources/allocation_group#labels AllocationGroup#labels}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.1.0/docs/resources/allocation_group#labels_operator AllocationGroup#labels_operator}
  */
  readonly labelsOperator?: string;
  /**
  * Allocation group name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.1.0/docs/resources/allocation_group#name AllocationGroup#name}
  */
  readonly name: string;
  /**
  * List of cluster namespaces to track
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.1.0/docs/resources/allocation_group#namespaces AllocationGroup#namespaces}
  */
  readonly namespaces?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/castai/castai/8.1.0/docs/resources/allocation_group castai_allocation_group}
*/
export class AllocationGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AllocationGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/castai/castai/8.1.0/docs/resources/allocation_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/castai/castai/8.1.0/docs/resources/allocation_group castai_allocation_group} Resource
  *
  * @param scope The scope in which to define this construct
