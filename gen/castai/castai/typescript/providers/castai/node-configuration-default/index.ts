// https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/node_configuration_default
...
export interface NodeConfigurationDefaultConfig extends cdktf.TerraformMetaArguments {
  ...
  * CAST AI cluster id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/node_configuration_default#cluster_id NodeConfigurationDefault#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Id of the node configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/node_configuration_default#configuration_id NodeConfigurationDefault#configuration_id}
  */
  readonly configurationId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/node_configuration_default#id NodeConfigurationDefault#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/node_configuration_default#timeouts NodeConfigurationDefault#timeouts}
  */
  readonly timeouts?: NodeConfigurationDefaultTimeouts;
}
export interface NodeConfigurationDefaultTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/node_configuration_default#create NodeConfigurationDefault#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/node_configuration_default#delete NodeConfigurationDefault#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/node_configuration_default#read NodeConfigurationDefault#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/node_configuration_default castai_node_configuration_default}
*/
export class NodeConfigurationDefault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NodeConfigurationDefault that should be imported. Refer to the {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/node_configuration_default#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/resources/node_configuration_default castai_node_configuration_default} Resource
  *
  * @param scope The scope in which to define this construct
