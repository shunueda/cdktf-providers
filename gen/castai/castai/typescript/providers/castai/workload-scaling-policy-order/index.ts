// https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/workload_scaling_policy_order
...
export interface WorkloadScalingPolicyOrderConfig extends cdktf.TerraformMetaArguments {
  ...
  * CAST AI cluster id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/workload_scaling_policy_order#cluster_id WorkloadScalingPolicyOrder#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/workload_scaling_policy_order#id WorkloadScalingPolicyOrder#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/workload_scaling_policy_order#policy_ids WorkloadScalingPolicyOrder#policy_ids}
  */
  readonly policyIds: string[];
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/workload_scaling_policy_order#timeouts WorkloadScalingPolicyOrder#timeouts}
  */
  readonly timeouts?: WorkloadScalingPolicyOrderTimeouts;
}
export interface WorkloadScalingPolicyOrderTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/workload_scaling_policy_order#create WorkloadScalingPolicyOrder#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/workload_scaling_policy_order#delete WorkloadScalingPolicyOrder#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/workload_scaling_policy_order#update WorkloadScalingPolicyOrder#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/workload_scaling_policy_order castai_workload_scaling_policy_order}
*/
export class WorkloadScalingPolicyOrder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkloadScalingPolicyOrder that should be imported. Refer to the {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/workload_scaling_policy_order#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/workload_scaling_policy_order castai_workload_scaling_policy_order} Resource
  *
  * @param scope The scope in which to define this construct
