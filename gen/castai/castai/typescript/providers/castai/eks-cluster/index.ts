// https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/eks_cluster
...
export interface EksClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of AWS account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/eks_cluster#account_id EksCluster#account_id}
  */
  readonly accountId: string;
  /**
  * AWS IAM role ARN that will be assumed by CAST AI user. This role should allow `sts:AssumeRole` action for CAST AI user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/eks_cluster#assume_role_arn EksCluster#assume_role_arn}
  */
  readonly assumeRoleArn?: string;
  /**
  * Should CAST AI remove nodes managed by CAST AI on disconnect
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/eks_cluster#delete_nodes_on_disconnect EksCluster#delete_nodes_on_disconnect}
  */
  readonly deleteNodesOnDisconnect?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/eks_cluster#id EksCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/eks_cluster#name EksCluster#name}
  */
  readonly name: string;
  /**
  * AWS region where the cluster is placed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/eks_cluster#region EksCluster#region}
  */
  readonly region: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/eks_cluster#timeouts EksCluster#timeouts}
  */
  readonly timeouts?: EksClusterTimeouts;
}
export interface EksClusterTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/eks_cluster#create EksCluster#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/eks_cluster#delete EksCluster#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/eks_cluster#update EksCluster#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/eks_cluster castai_eks_cluster}
*/
export class EksCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EksCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/eks_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/eks_cluster castai_eks_cluster} Resource
  *
  * @param scope The scope in which to define this construct
