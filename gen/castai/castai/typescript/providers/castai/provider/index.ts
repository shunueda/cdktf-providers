// https://registry.terraform.io/providers/castai/castai/7.73.1/docs
...
export interface CastaiProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs#api_token CastaiProvider#api_token}
  */
  readonly apiToken: string;
  /**
  * CAST.AI API url.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs#api_url CastaiProvider#api_url}
  */
  readonly apiUrl?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs#alias CastaiProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs castai}
*/
export class CastaiProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing CastaiProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs castai} Resource
  *
  * @param scope The scope in which to define this construct
