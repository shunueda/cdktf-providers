// https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/gke_cluster
...
export interface GkeClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/gke_cluster#credentials_json GkeCluster#credentials_json}
  */
  readonly credentialsJson?: string;
  /**
  * Should CAST AI remove nodes managed by CAST.AI on disconnect
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/gke_cluster#delete_nodes_on_disconnect GkeCluster#delete_nodes_on_disconnect}
  */
  readonly deleteNodesOnDisconnect?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/gke_cluster#id GkeCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/gke_cluster#location GkeCluster#location}
  */
  readonly location: string;
  /**
  * GKE cluster name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/gke_cluster#name GkeCluster#name}
  */
  readonly name: string;
  /**
  * GCP project id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/gke_cluster#project_id GkeCluster#project_id}
  */
  readonly projectId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/gke_cluster#timeouts GkeCluster#timeouts}
  */
  readonly timeouts?: GkeClusterTimeouts;
}
export interface GkeClusterTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/gke_cluster#create GkeCluster#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/gke_cluster#delete GkeCluster#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/gke_cluster#update GkeCluster#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/gke_cluster castai_gke_cluster}
*/
export class GkeCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GkeCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/gke_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/castai/castai/8.6.0/docs/resources/gke_cluster castai_gke_cluster} Resource
  *
  * @param scope The scope in which to define this construct
