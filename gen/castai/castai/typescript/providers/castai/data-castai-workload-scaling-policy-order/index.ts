// https://registry.terraform.io/providers/castai/castai/7.73.1/docs/data-sources/workload_scaling_policy_order
...
export interface DataCastaiWorkloadScalingPolicyOrderConfig extends cdktf.TerraformMetaArguments {
  ...
  * CAST AI cluster id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/data-sources/workload_scaling_policy_order#cluster_id DataCastaiWorkloadScalingPolicyOrder#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/data-sources/workload_scaling_policy_order#id DataCastaiWorkloadScalingPolicyOrder#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/data-sources/workload_scaling_policy_order castai_workload_scaling_policy_order}
*/
export class DataCastaiWorkloadScalingPolicyOrder extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCastaiWorkloadScalingPolicyOrder that should be imported. Refer to the {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/data-sources/workload_scaling_policy_order#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/castai/castai/7.73.1/docs/data-sources/workload_scaling_policy_order castai_workload_scaling_policy_order} Data Source
  *
  * @param scope The scope in which to define this construct
