// https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/organization_members
...
export interface OrganizationMembersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/organization_members#id OrganizationMembers#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/organization_members#members OrganizationMembers#members}
  */
  readonly members?: string[];
  /**
  * CAST AI organization ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/organization_members#organization_id OrganizationMembers#organization_id}
  */
  readonly organizationId: string;
  /**
  * A list of email addresses corresponding to users who should be given owner access to the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/organization_members#owners OrganizationMembers#owners}
  */
  readonly owners?: string[];
  /**
  * A list of email addresses corresponding to users who should be given viewer access to the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/organization_members#viewers OrganizationMembers#viewers}
  */
  readonly viewers?: string[];
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/organization_members#timeouts OrganizationMembers#timeouts}
  */
  readonly timeouts?: OrganizationMembersTimeouts;
}
export interface OrganizationMembersTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/organization_members#create OrganizationMembers#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/organization_members#delete OrganizationMembers#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/organization_members#update OrganizationMembers#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/organization_members castai_organization_members}
*/
export class OrganizationMembers extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationMembers that should be imported. Refer to the {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/organization_members#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/castai/castai/8.4.0/docs/resources/organization_members castai_organization_members} Resource
  *
  * @param scope The scope in which to define this construct
