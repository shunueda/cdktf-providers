// https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig
...
export interface DataNetskopebwanGatewayBgpconfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig#bfd_interval DataNetskopebwanGatewayBgpconfig#bfd_interval}
  */
  readonly bfdInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig#bfd_multiplier DataNetskopebwanGatewayBgpconfig#bfd_multiplier}
  */
  readonly bfdMultiplier?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig#bfd_recv_interval DataNetskopebwanGatewayBgpconfig#bfd_recv_interval}
  */
  readonly bfdRecvInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig#gateway_id DataNetskopebwanGatewayBgpconfig#gateway_id}
  */
  readonly gatewayId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig#id DataNetskopebwanGatewayBgpconfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig#is_bfd_enabled DataNetskopebwanGatewayBgpconfig#is_bfd_enabled}
  */
  readonly isBfdEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig#local_as DataNetskopebwanGatewayBgpconfig#local_as}
  */
  readonly localAs?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig#name DataNetskopebwanGatewayBgpconfig#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig#neighbor DataNetskopebwanGatewayBgpconfig#neighbor}
  */
  readonly neighbor?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig#remote_as DataNetskopebwanGatewayBgpconfig#remote_as}
  */
  readonly remoteAs?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig#router_id DataNetskopebwanGatewayBgpconfig#router_id}
  */
  readonly routerId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig netskopebwan_gateway_bgpconfig}
*/
export class DataNetskopebwanGatewayBgpconfig extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataNetskopebwanGatewayBgpconfig resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataNetskopebwanGatewayBgpconfig to import
  * @param importFromId The id of the existing DataNetskopebwanGatewayBgpconfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataNetskopebwanGatewayBgpconfig to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/data-sources/gateway_bgpconfig netskopebwan_gateway_bgpconfig} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataNetskopebwanGatewayBgpconfigConfig
  */
  public constructor(scope: Construct, id: string, config: DataNetskopebwanGatewayBgpconfigConfig) {
    super(scope, id, {
