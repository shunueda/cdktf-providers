// https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant
...
export interface TenantConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#ancestor_tenants Tenant#ancestor_tenants}
  */
  readonly ancestorTenants?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#date_created Tenant#date_created}
  */
  readonly dateCreated?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#date_modified Tenant#date_modified}
  */
  readonly dateModified?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#description Tenant#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#domain_names Tenant#domain_names}
  */
  readonly domainNames?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#id Tenant#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#is_disabled Tenant#is_disabled}
  */
  readonly isDisabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#name Tenant#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#parent_id Tenant#parent_id}
  */
  readonly parentId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#rest_api_end_point Tenant#rest_api_end_point}
  */
  readonly restApiEndPoint?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#tenant_type Tenant#tenant_type}
  */
  readonly tenantType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#tenant_type_input Tenant#tenant_type_input}
  */
  readonly tenantTypeInput?: string;
  /**
  * created_by block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#created_by Tenant#created_by}
  */
  readonly createdBy?: TenantCreatedBy;
  /**
  * modified_by block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#modified_by Tenant#modified_by}
  */
  readonly modifiedBy?: TenantModifiedBy;
}
export interface TenantCreatedBy {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#email Tenant#email}
  */
...
export function tenantCreatedByToTerraform(struct?: TenantCreatedByOutputReference | TenantCreatedBy): any {
...
export function tenantCreatedByToHclTerraform(struct?: TenantCreatedByOutputReference | TenantCreatedBy): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class TenantCreatedByOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): TenantCreatedBy | undefined {
  ...
  public set internalValue(value: TenantCreatedBy | undefined) {
    if (value === undefined) {
...
export function tenantModifiedByToTerraform(struct?: TenantModifiedByOutputReference | TenantModifiedBy): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function tenantModifiedByToHclTerraform(struct?: TenantModifiedByOutputReference | TenantModifiedBy): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class TenantModifiedByOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): TenantModifiedBy | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._email !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: TenantModifiedBy | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._email = undefined;
      this._id = undefined;
...
/**
* Represents a {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant netskopebwan_tenant}
*/
export class Tenant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Tenant that should be imported. Refer to the {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netskopeoss/netskopebwan/0.0.2/docs/resources/tenant netskopebwan_tenant} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _createdBy = new TenantCreatedByOutputReference(this, "created_by");
  public get createdBy() {
    return this._createdBy;
  }
  public putCreatedBy(value: TenantCreatedBy) {
  ...
  private _modifiedBy = new TenantModifiedByOutputReference(this, "modified_by");
  public get modifiedBy() {
    return this._modifiedBy;
  }
  public putModifiedBy(value: TenantModifiedBy) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      created_by: tenantCreatedByToTerraform(this._createdBy.internalValue),
      modified_by: tenantModifiedByToTerraform(this._modifiedBy.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      created_by: {
        value: tenantCreatedByToHclTerraform(this._createdBy.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "TenantCreatedByList",
      },
      modified_by: {
        value: tenantModifiedByToHclTerraform(this._modifiedBy.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "TenantModifiedByList",
      },
    };
