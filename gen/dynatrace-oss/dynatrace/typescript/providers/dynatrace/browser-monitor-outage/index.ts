// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/browser_monitor_outage
...
export interface BrowserMonitorOutageConfig extends cdktf.TerraformMetaArguments {
  /**
  * (Field has overlap with `dynatrace_browser_monitor`) Alert if all locations are unable to access my web application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/browser_monitor_outage#global_consecutive_outage_count_threshold BrowserMonitorOutage#global_consecutive_outage_count_threshold}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/browser_monitor_outage#global_outages BrowserMonitorOutage#global_outages}
  */
  readonly globalOutages: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/browser_monitor_outage#id BrowserMonitorOutage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/browser_monitor_outage#local_consecutive_outage_count_threshold BrowserMonitorOutage#local_consecutive_outage_count_threshold}
  */
  readonly localConsecutiveOutageCountThreshold?: number;
  /**
  * (Field has overlap with `dynatrace_browser_monitor`) Alert if at least
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/browser_monitor_outage#local_location_outage_count_threshold BrowserMonitorOutage#local_location_outage_count_threshold}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/browser_monitor_outage#local_outages BrowserMonitorOutage#local_outages}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/browser_monitor_outage#retry_on_error BrowserMonitorOutage#retry_on_error}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/browser_monitor_outage#scope BrowserMonitorOutage#scope}
  */
  readonly scope?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/browser_monitor_outage dynatrace_browser_monitor_outage}
*/
export class BrowserMonitorOutage extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "dynatrace_browser_monitor_outage";
  ...
  * @param importFromId The id of the existing BrowserMonitorOutage that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/browser_monitor_outage#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "dynatrace_browser_monitor_outage", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/browser_monitor_outage dynatrace_browser_monitor_outage} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options BrowserMonitorOutageConfig
  */
  public constructor(scope: Construct, id: string, config: BrowserMonitorOutageConfig) {
    super(scope, id, {
  ...
  // retry_on_error - computed: false, optional: false, required: true
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      retry_on_error: cdktf.booleanToTerraform(this._retryOnError),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      retry_on_error: {
        value: cdktf.booleanToHclTerraform(this._retryOnError),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
