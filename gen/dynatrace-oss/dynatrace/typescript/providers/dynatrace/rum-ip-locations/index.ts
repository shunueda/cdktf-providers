// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_ip_locations
...
export interface RumIpLocationsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_ip_locations#city RumIpLocations#city}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_ip_locations#country_code RumIpLocations#country_code}
  */
  readonly countryCode: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_ip_locations#id RumIpLocations#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_ip_locations#ip RumIpLocations#ip}
  */
  readonly ip: string;
  /**
  * IP range end
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_ip_locations#ip_to RumIpLocations#ip_to}
  */
  readonly ipTo?: string;
  /**
  * Latitude
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_ip_locations#latitude RumIpLocations#latitude}
  */
  readonly latitude?: number;
  /**
  * Longitude
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_ip_locations#longitude RumIpLocations#longitude}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_ip_locations#region_code RumIpLocations#region_code}
  */
  readonly regionCode?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_ip_locations dynatrace_rum_ip_locations}
*/
export class RumIpLocations extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RumIpLocations that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_ip_locations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_ip_locations dynatrace_rum_ip_locations} Resource
  *
  * @param scope The scope in which to define this construct
