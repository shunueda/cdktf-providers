// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/process_group_rum
...
export interface ProcessGroupRumConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/process_group_rum#enable ProcessGroupRum#enable}
  */
  readonly enable: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/process_group_rum#id ProcessGroupRum#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/process_group_rum#process_group_id ProcessGroupRum#process_group_id}
  */
  readonly processGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/process_group_rum dynatrace_process_group_rum}
*/
export class ProcessGroupRum extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProcessGroupRum that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/process_group_rum#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/process_group_rum dynatrace_process_group_rum} Resource
  *
  * @param scope The scope in which to define this construct
