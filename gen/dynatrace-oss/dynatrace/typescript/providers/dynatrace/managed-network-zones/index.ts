// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_network_zones
...
export interface ManagedNetworkZonesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_network_zones#alternative_zones ManagedNetworkZones#alternative_zones}
  */
  readonly alternativeZones?: string[];
  /**
  * A short description of the network zone
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_network_zones#description ManagedNetworkZones#description}
  */
  readonly description?: string;
  /**
  * The fallback mode of the network zone. Possible values: `ANY_ACTIVE_GATE`, `NONE`, `ONLY_DEFAULT_ZONE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_network_zones#fallback_mode ManagedNetworkZones#fallback_mode}
  */
  readonly fallbackMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_network_zones#id ManagedNetworkZones#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_network_zones#name ManagedNetworkZones#name}
  */
  readonly name?: string;
  /**
  * The number of ActiveGates in the network zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_network_zones#num_of_configured_activegates ManagedNetworkZones#num_of_configured_activegates}
  */
  readonly numOfConfiguredActivegates?: number;
  /**
  * The number of OneAgents that are configured to use the network zone as primary.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_network_zones#num_of_configured_oneagents ManagedNetworkZones#num_of_configured_oneagents}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_network_zones#num_of_oneagents_from_other_zones ManagedNetworkZones#num_of_oneagents_from_other_zones}
  */
  readonly numOfOneagentsFromOtherZones?: number;
  /**
  * The number of OneAgents that are using ActiveGates in the network zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_network_zones#num_of_oneagents_using ManagedNetworkZones#num_of_oneagents_using}
  */
  readonly numOfOneagentsUsing?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_network_zones dynatrace_managed_network_zones}
*/
export class ManagedNetworkZones extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedNetworkZones that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_network_zones#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_network_zones dynatrace_managed_network_zones} Resource
  *
  * @param scope The scope in which to define this construct
