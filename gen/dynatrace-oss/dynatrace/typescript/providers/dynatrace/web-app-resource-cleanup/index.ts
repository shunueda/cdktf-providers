// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_resource_cleanup
...
export interface WebAppResourceCleanupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_resource_cleanup#id WebAppResourceCleanup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_resource_cleanup#insert_after WebAppResourceCleanup#insert_after}
  */
  readonly insertAfter?: string;
  /**
  * For example: *Mask journeyId*
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_resource_cleanup#name WebAppResourceCleanup#name}
  */
  readonly name: string;
  /**
  * For example: `(.*)(journeyId=)-?\d+(.*)`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_resource_cleanup#regular_expression WebAppResourceCleanup#regular_expression}
  */
  readonly regularExpression: string;
  /**
  * For example: `$1$2\*$3`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_resource_cleanup#replace_with WebAppResourceCleanup#replace_with}
  */
  readonly replaceWith: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_resource_cleanup dynatrace_web_app_resource_cleanup}
*/
export class WebAppResourceCleanup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebAppResourceCleanup that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_resource_cleanup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_resource_cleanup dynatrace_web_app_resource_cleanup} Resource
  *
  * @param scope The scope in which to define this construct
