// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent
...
export interface LogOneagentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#container_timezone_heuristic_enabled LogOneagent#container_timezone_heuristic_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#containers_logs_detection_enabled LogOneagent#containers_logs_detection_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#date_search_limit_bytes LogOneagent#date_search_limit_bytes}
  */
  readonly dateSearchLimitBytes: number;
  /**
  * Default timezone for agent if more specific configurations is not defined.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#default_timezone LogOneagent#default_timezone}
  */
  readonly defaultTimezone: string;
  /**
  * Defines the maximum timeout value, in seconds, for the query extracting Windows Event Logs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#event_log_query_timeout_sec LogOneagent#event_log_query_timeout_sec}
  */
  readonly eventLogQueryTimeoutSec: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#id LogOneagent#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#iisdetection_enabled LogOneagent#iisdetection_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#log_scanner_linux_nfs_enabled LogOneagent#log_scanner_linux_nfs_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#max_lgis_per_entity_count LogOneagent#max_lgis_per_entity_count}
  */
  readonly maxLgisPerEntityCount: number;
  /**
  * Defines the minimum number of bytes in log file required for binary detection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#min_binary_detection_limit_bytes LogOneagent#min_binary_detection_limit_bytes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#monitor_own_logs_enabled LogOneagent#monitor_own_logs_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#open_log_files_detection_enabled LogOneagent#open_log_files_detection_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#scope LogOneagent#scope}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#severity_detection_limit_bytes LogOneagent#severity_detection_limit_bytes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#severity_detection_lines_limit LogOneagent#severity_detection_lines_limit}
  */
  readonly severityDetectionLinesLimit: number;
  /**
  * Linux: syslog, message log Windows: system, application, security event logs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#system_logs_detection_enabled LogOneagent#system_logs_detection_enabled}
  */
  readonly systemLogsDetectionEnabled: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent dynatrace_log_oneagent}
*/
export class LogOneagent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogOneagent that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_oneagent dynatrace_log_oneagent} Resource
  *
  * @param scope The scope in which to define this construct
