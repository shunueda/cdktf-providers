// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/grail_metrics_allowall
...
export interface GrailMetricsAllowallConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/grail_metrics_allowall#allow_all GrailMetricsAllowall#allow_all}
  */
  readonly allowAll: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/grail_metrics_allowall#id GrailMetricsAllowall#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/grail_metrics_allowall dynatrace_grail_metrics_allowall}
*/
export class GrailMetricsAllowall extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GrailMetricsAllowall that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/grail_metrics_allowall#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/grail_metrics_allowall dynatrace_grail_metrics_allowall} Resource
  *
  * @param scope The scope in which to define this construct
