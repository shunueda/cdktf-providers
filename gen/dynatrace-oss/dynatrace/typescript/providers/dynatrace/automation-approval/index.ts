// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/automation_approval
...
export interface AutomationApprovalConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/automation_approval#id AutomationApproval#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/automation_approval#workflow_app_access_approval_enabled AutomationApproval#workflow_app_access_approval_enabled}
  */
  readonly workflowAppAccessApprovalEnabled: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/automation_approval dynatrace_automation_approval}
*/
export class AutomationApproval extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutomationApproval that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/automation_approval#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/automation_approval dynatrace_automation_approval} Resource
  *
  * @param scope The scope in which to define this construct
