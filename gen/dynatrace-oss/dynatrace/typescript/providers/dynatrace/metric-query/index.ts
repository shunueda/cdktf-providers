// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/metric_query
...
export interface MetricQueryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/metric_query#id MetricQuery#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/metric_query#metric_id MetricQuery#metric_id}
  */
  readonly metricId: string;
  /**
  * Query
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/metric_query#metric_selector MetricQuery#metric_selector}
  */
  readonly metricSelector: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/metric_query dynatrace_metric_query}
*/
export class MetricQuery extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MetricQuery that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/metric_query#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/metric_query dynatrace_metric_query} Resource
  *
  * @param scope The scope in which to define this construct
