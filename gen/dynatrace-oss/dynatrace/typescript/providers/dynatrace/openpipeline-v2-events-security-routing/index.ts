// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_security_routing
...
export interface OpenpipelineV2EventsSecurityRoutingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_security_routing#id OpenpipelineV2EventsSecurityRouting#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_security_routing#routing_entries OpenpipelineV2EventsSecurityRouting#routing_entries}
  */
...
export interface OpenpipelineV2EventsSecurityRoutingRoutingEntriesRoutingEntry {
  ...
  * Builtin Pipeline ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_security_routing#builtin_pipeline_id OpenpipelineV2EventsSecurityRouting#builtin_pipeline_id}
  */
  readonly builtinPipelineId?: string;
  /**
  * no documentation available
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_security_routing#description OpenpipelineV2EventsSecurityRouting#description}
  */
  readonly description: string;
  /**
  * This setting is enabled (`true`) or disabled (`false`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_security_routing#enabled OpenpipelineV2EventsSecurityRouting#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Query which determines whether the record should be routed to the target pipeline of this rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_security_routing#matcher OpenpipelineV2EventsSecurityRouting#matcher}
  */
  readonly matcher: string;
  /**
  * Pipeline ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_security_routing#pipeline_id OpenpipelineV2EventsSecurityRouting#pipeline_id}
  */
  readonly pipelineId?: string;
  /**
  * Pipeline Type. Possible Values: `builtin`, `custom`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_security_routing#pipeline_type OpenpipelineV2EventsSecurityRouting#pipeline_type}
  */
...
export interface OpenpipelineV2EventsSecurityRoutingRoutingEntries {
  ...
  * routing_entry block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_security_routing#routing_entry OpenpipelineV2EventsSecurityRouting#routing_entry}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_security_routing dynatrace_openpipeline_v2_events_security_routing}
*/
export class OpenpipelineV2EventsSecurityRouting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpenpipelineV2EventsSecurityRouting that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_security_routing#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_security_routing dynatrace_openpipeline_v2_events_security_routing} Resource
  *
  * @param scope The scope in which to define this construct
