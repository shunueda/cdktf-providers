...
OpenpipelineV2UserEventsPipelinesMetadataListStruct, 
openpipelineV2UserEventsPipelinesMetadataListStructToTerraform, 
openpipelineV2UserEventsPipelinesMetadataListStructToHclTerraform, 
OpenpipelineV2UserEventsPipelinesMetadataListStructOutputReference, 
...
OpenpipelineV2UserEventsPipelinesSmartscapeEdgeExtraction, 
openpipelineV2UserEventsPipelinesSmartscapeEdgeExtractionToTerraform, 
openpipelineV2UserEventsPipelinesSmartscapeEdgeExtractionToHclTerraform, 
OpenpipelineV2UserEventsPipelinesSmartscapeEdgeExtractionOutputReference, 
OpenpipelineV2UserEventsPipelinesSmartscapeNodeExtraction, 
openpipelineV2UserEventsPipelinesSmartscapeNodeExtractionToTerraform, 
openpipelineV2UserEventsPipelinesSmartscapeNodeExtractionToHclTerraform, 
OpenpipelineV2UserEventsPipelinesSmartscapeNodeExtractionOutputReference, 
...
export interface OpenpipelineV2UserEventsPipelinesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Custom pipeline id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_user_events_pipelines#custom_id OpenpipelineV2UserEventsPipelines#custom_id}
  */
  readonly customId: string;
  /**
  * Display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_user_events_pipelines#display_name OpenpipelineV2UserEventsPipelines#display_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_user_events_pipelines#data_extraction OpenpipelineV2UserEventsPipelines#data_extraction}
  */
  ...
  * metadata_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_user_events_pipelines#metadata_list OpenpipelineV2UserEventsPipelines#metadata_list}
  */
  readonly metadataList?: OpenpipelineV2UserEventsPipelinesMetadataListStruct;
  /**
  * metric_extraction block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_user_events_pipelines#metric_extraction OpenpipelineV2UserEventsPipelines#metric_extraction}
  */
  readonly metricExtraction?: OpenpipelineV2UserEventsPipelinesMetricExtraction;
  /**
  * processing block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_user_events_pipelines#processing OpenpipelineV2UserEventsPipelines#processing}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_user_events_pipelines#smartscape_edge_extraction OpenpipelineV2UserEventsPipelines#smartscape_edge_extraction}
  */
  readonly smartscapeEdgeExtraction?: OpenpipelineV2UserEventsPipelinesSmartscapeEdgeExtraction;
  /**
  * smartscape_node_extraction block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_user_events_pipelines#smartscape_node_extraction OpenpipelineV2UserEventsPipelines#smartscape_node_extraction}
  */
  readonly smartscapeNodeExtraction?: OpenpipelineV2UserEventsPipelinesSmartscapeNodeExtraction;
  /**
  * storage block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_user_events_pipelines#storage OpenpipelineV2UserEventsPipelines#storage}
  */
  readonly storage?: OpenpipelineV2UserEventsPipelinesStorage;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_user_events_pipelines dynatrace_openpipeline_v2_user_events_pipelines}
*/
export class OpenpipelineV2UserEventsPipelines extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpenpipelineV2UserEventsPipelines that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_user_events_pipelines#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_user_events_pipelines dynatrace_openpipeline_v2_user_events_pipelines} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _metadataList = new OpenpipelineV2UserEventsPipelinesMetadataListStructOutputReference(this, "metadata_list");
  public get metadataList() {
    return this._metadataList;
  }
  public putMetadataList(value: OpenpipelineV2UserEventsPipelinesMetadataListStruct) {
  ...
  private _smartscapeEdgeExtraction = new OpenpipelineV2UserEventsPipelinesSmartscapeEdgeExtractionOutputReference(this, "smartscape_edge_extraction");
  public get smartscapeEdgeExtraction() {
    return this._smartscapeEdgeExtraction;
  }
  public putSmartscapeEdgeExtraction(value: OpenpipelineV2UserEventsPipelinesSmartscapeEdgeExtraction) {
  ...
  private _smartscapeNodeExtraction = new OpenpipelineV2UserEventsPipelinesSmartscapeNodeExtractionOutputReference(this, "smartscape_node_extraction");
  public get smartscapeNodeExtraction() {
    return this._smartscapeNodeExtraction;
  }
  public putSmartscapeNodeExtraction(value: OpenpipelineV2UserEventsPipelinesSmartscapeNodeExtraction) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      metadata_list: openpipelineV2UserEventsPipelinesMetadataListStructToTerraform(this._metadataList.internalValue),
      ...
      smartscape_edge_extraction: openpipelineV2UserEventsPipelinesSmartscapeEdgeExtractionToTerraform(this._smartscapeEdgeExtraction.internalValue),
      smartscape_node_extraction: openpipelineV2UserEventsPipelinesSmartscapeNodeExtractionToTerraform(this._smartscapeNodeExtraction.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      metadata_list: {
        value: openpipelineV2UserEventsPipelinesMetadataListStructToHclTerraform(this._metadataList.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OpenpipelineV2UserEventsPipelinesMetadataListStructList",
      },
      metric_extraction: {
      ...
      smartscape_edge_extraction: {
        value: openpipelineV2UserEventsPipelinesSmartscapeEdgeExtractionToHclTerraform(this._smartscapeEdgeExtraction.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OpenpipelineV2UserEventsPipelinesSmartscapeEdgeExtractionList",
      },
      smartscape_node_extraction: {
        value: openpipelineV2UserEventsPipelinesSmartscapeNodeExtractionToHclTerraform(this._smartscapeNodeExtraction.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OpenpipelineV2UserEventsPipelinesSmartscapeNodeExtractionList",
      },
      storage: {
