// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_security_context
...
export interface LogSecurityContextConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_security_context#id LogSecurityContext#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_security_context#insert_after LogSecurityContext#insert_after}
  */
  readonly insertAfter?: string;
  /**
  * security_context_rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_security_context#security_context_rule LogSecurityContext#security_context_rule}
  */
...
export interface LogSecurityContextSecurityContextRule {
  ...
  * Matcher
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_security_context#query LogSecurityContext#query}
  */
  readonly query: string;
  /**
  * Rule name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_security_context#rule_name LogSecurityContext#rule_name}
  */
  readonly ruleName: string;
  /**
  * Literal value to be set
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_security_context#value LogSecurityContext#value}
  */
  readonly value?: string;
  /**
  * Possible Values: `FIELD`, `LITERAL`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_security_context#value_source LogSecurityContext#value_source}
  */
  readonly valueSource: string;
  /**
  * Name of field used to copy value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_security_context#value_source_field LogSecurityContext#value_source_field}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_security_context dynatrace_log_security_context}
*/
export class LogSecurityContext extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogSecurityContext that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_security_context#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/log_security_context dynatrace_log_security_context} Resource
  *
  * @param scope The scope in which to define this construct
