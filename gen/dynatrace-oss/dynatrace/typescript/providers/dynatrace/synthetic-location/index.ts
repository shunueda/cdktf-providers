// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location
...
export interface SyntheticLocationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#auto_update_chromium SyntheticLocation#auto_update_chromium}
  */
  readonly autoUpdateChromium?: boolean | cdktf.IResolvable;
  /**
  * The alerting of location outage is enabled (`true`) or disabled (`false`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#availability_location_outage SyntheticLocation#availability_location_outage}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#availability_node_outage SyntheticLocation#availability_node_outage}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#availability_notifications_enabled SyntheticLocation#availability_notifications_enabled}
  */
  readonly availabilityNotificationsEnabled?: boolean | cdktf.IResolvable;
  /**
  * The city of the location
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#city SyntheticLocation#city}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#country_code SyntheticLocation#country_code}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#deployment_type SyntheticLocation#deployment_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#fips_mode SyntheticLocation#fips_mode}
  */
  readonly fipsMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#id SyntheticLocation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#latitude SyntheticLocation#latitude}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#location_node_outage_delay_in_minutes SyntheticLocation#location_node_outage_delay_in_minutes}
  */
  readonly locationNodeOutageDelayInMinutes?: number;
  /**
  * The longitude of the location in `DDD.dddd` format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#longitude SyntheticLocation#longitude}
  */
  readonly longitude: number;
  /**
  * The maximum number of Active Gates required for that location. Not required when `deployment_type` is set to `STANDARD`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#max_active_gate_count SyntheticLocation#max_active_gate_count}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#min_active_gate_count SyntheticLocation#min_active_gate_count}
  */
  readonly minActiveGateCount?: number;
  /**
  * Boolean value describes if icmp monitors will be executed on this location
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#nam_execution_supported SyntheticLocation#nam_execution_supported}
  */
  readonly namExecutionSupported?: boolean | cdktf.IResolvable;
  /**
  * The name of the location
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#name SyntheticLocation#name}
  */
  readonly name: string;
  /**
  * Possible values: `UNSUPPORTED`, `XS`, `S` and `M`. Not required when `deployment_type` is set to `STANDARD`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#node_size SyntheticLocation#node_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#nodes SyntheticLocation#nodes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#region_code SyntheticLocation#region_code}
  */
  readonly regionCode?: string;
  /**
  * Boolean value describes which kubernetes version will be used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#use_new_kubernetes_version SyntheticLocation#use_new_kubernetes_version}
  */
  readonly useNewKubernetesVersion?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location dynatrace_synthetic_location}
*/
export class SyntheticLocation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SyntheticLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/synthetic_location dynatrace_synthetic_location} Resource
  *
  * @param scope The scope in which to define this construct
