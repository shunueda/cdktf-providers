// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/session_replay_resource_capture
...
export interface SessionReplayResourceCaptureConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/session_replay_resource_capture#application_id SessionReplayResourceCapture#application_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/session_replay_resource_capture#enable_resource_capturing SessionReplayResourceCapture#enable_resource_capturing}
  */
  readonly enableResourceCapturing: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/session_replay_resource_capture#id SessionReplayResourceCapture#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/session_replay_resource_capture#resource_capture_url_exclusion_pattern_list SessionReplayResourceCapture#resource_capture_url_exclusion_pattern_list}
  */
  readonly resourceCaptureUrlExclusionPatternList?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/session_replay_resource_capture dynatrace_session_replay_resource_capture}
*/
export class SessionReplayResourceCapture extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SessionReplayResourceCapture that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/session_replay_resource_capture#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/session_replay_resource_capture dynatrace_session_replay_resource_capture} Resource
  *
  * @param scope The scope in which to define this construct
