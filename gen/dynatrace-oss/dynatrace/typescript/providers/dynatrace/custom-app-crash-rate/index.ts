// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate
...
export interface CustomAppCrashRateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate#id CustomAppCrashRate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate#scope CustomAppCrashRate#scope}
  */
  readonly scope?: string;
  /**
  * crash_rate_increase block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate#crash_rate_increase CustomAppCrashRate#crash_rate_increase}
  */
...
export interface CustomAppCrashRateCrashRateIncreaseCrashRateIncreaseAuto {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate#baseline_violation_percentage CustomAppCrashRate#baseline_violation_percentage}
  */
  readonly baselineViolationPercentage: number;
  /**
  * Amount of users
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate#concurrent_users CustomAppCrashRate#concurrent_users}
  */
  readonly concurrentUsers: number;
  /**
  * Possible Values: `Low`, `Medium`, `High`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate#sensitivity CustomAppCrashRate#sensitivity}
  */
...
export interface CustomAppCrashRateCrashRateIncreaseCrashRateIncreaseFixed {
  ...
  * Absolute threshold
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate#absolute_crash_rate CustomAppCrashRate#absolute_crash_rate}
  */
...
export interface CustomAppCrashRateCrashRateIncrease {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate#detection_mode CustomAppCrashRate#detection_mode}
  */
  readonly detectionMode?: string;
  /**
  * This setting is enabled (`true`) or disabled (`false`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate#enabled CustomAppCrashRate#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * crash_rate_increase_auto block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate#crash_rate_increase_auto CustomAppCrashRate#crash_rate_increase_auto}
  */
  readonly crashRateIncreaseAuto?: CustomAppCrashRateCrashRateIncreaseCrashRateIncreaseAuto;
  /**
  * crash_rate_increase_fixed block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate#crash_rate_increase_fixed CustomAppCrashRate#crash_rate_increase_fixed}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate dynatrace_custom_app_crash_rate}
*/
export class CustomAppCrashRate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomAppCrashRate that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/custom_app_crash_rate dynatrace_custom_app_crash_rate} Resource
  *
  * @param scope The scope in which to define this construct
