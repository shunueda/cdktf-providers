// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/infraops_app_settings
...
export interface InfraopsAppSettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/infraops_app_settings#id InfraopsAppSettings#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/infraops_app_settings#interface_saturation_threshold InfraopsAppSettings#interface_saturation_threshold}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/infraops_app_settings#invex_dql_query_limit InfraopsAppSettings#invex_dql_query_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/infraops_app_settings#invex_dql_sort_limit InfraopsAppSettings#invex_dql_sort_limit}
  */
  readonly invexDqlSortLimit?: number;
  /**
  * When set to true, the app will display monitoring candidates in the Hosts table
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/infraops_app_settings#show_monitoring_candidates InfraopsAppSettings#show_monitoring_candidates}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/infraops_app_settings#show_standalone_hosts InfraopsAppSettings#show_standalone_hosts}
  */
  readonly showStandaloneHosts: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/infraops_app_settings dynatrace_infraops_app_settings}
*/
export class InfraopsAppSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InfraopsAppSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/infraops_app_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/infraops_app_settings dynatrace_infraops_app_settings} Resource
  *
  * @param scope The scope in which to define this construct
