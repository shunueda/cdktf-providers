// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking
...
export interface IssueTrackingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking#enabled IssueTracking#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking#id IssueTracking#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking#insert_after IssueTracking#insert_after}
  */
  readonly insertAfter?: string;
  /**
  * Set a label to identify these issues, for example, `release_blocker` or `non-critical`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking#issuelabel IssueTracking#issuelabel}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking#issuequery IssueTracking#issuequery}
  */
  readonly issuequery: string;
  /**
  * Possible Values: `ERROR`, `INFO`, `RESOLVED`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking#issuetheme IssueTracking#issuetheme}
  */
  readonly issuetheme: string;
  /**
  * Possible Values: `GITHUB`, `GITLAB`, `JIRA`, `JIRA_CLOUD`, `JIRA_ON_PREMISE`, `SERVICENOW`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking#issuetrackersystem IssueTracking#issuetrackersystem}
  */
  readonly issuetrackersystem: string;
  /**
  * Password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking#password IssueTracking#password}
  */
  readonly password?: string;
  /**
  * Token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking#token IssueTracking#token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking#url IssueTracking#url}
  */
  readonly url: string;
  /**
  * Username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking#username IssueTracking#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking dynatrace_issue_tracking}
*/
export class IssueTracking extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IssueTracking that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/issue_tracking dynatrace_issue_tracking} Resource
  *
  * @param scope The scope in which to define this construct
