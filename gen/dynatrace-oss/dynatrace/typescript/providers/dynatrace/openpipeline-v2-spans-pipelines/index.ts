...
OpenpipelineV2SpansPipelinesSmartscapeEdgeExtraction, 
openpipelineV2SpansPipelinesSmartscapeEdgeExtractionToTerraform, 
openpipelineV2SpansPipelinesSmartscapeEdgeExtractionToHclTerraform, 
OpenpipelineV2SpansPipelinesSmartscapeEdgeExtractionOutputReference, 
OpenpipelineV2SpansPipelinesSmartscapeNodeExtraction, 
openpipelineV2SpansPipelinesSmartscapeNodeExtractionToTerraform, 
openpipelineV2SpansPipelinesSmartscapeNodeExtractionToHclTerraform, 
OpenpipelineV2SpansPipelinesSmartscapeNodeExtractionOutputReference, 
...
export class OpenpipelineV2SpansPipelines extends cdktf.TerraformResource {
  ...
  */
  ...
  private _smartscapeEdgeExtraction = new OpenpipelineV2SpansPipelinesSmartscapeEdgeExtractionOutputReference(this, "smartscape_edge_extraction");
  public get smartscapeEdgeExtraction() {
    return this._smartscapeEdgeExtraction;
  }
  public putSmartscapeEdgeExtraction(value: OpenpipelineV2SpansPipelinesSmartscapeEdgeExtraction) {
  ...
  private _smartscapeNodeExtraction = new OpenpipelineV2SpansPipelinesSmartscapeNodeExtractionOutputReference(this, "smartscape_node_extraction");
  public get smartscapeNodeExtraction() {
    return this._smartscapeNodeExtraction;
  }
  public putSmartscapeNodeExtraction(value: OpenpipelineV2SpansPipelinesSmartscapeNodeExtraction) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      smartscape_edge_extraction: openpipelineV2SpansPipelinesSmartscapeEdgeExtractionToTerraform(this._smartscapeEdgeExtraction.internalValue),
      smartscape_node_extraction: openpipelineV2SpansPipelinesSmartscapeNodeExtractionToTerraform(this._smartscapeNodeExtraction.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      smartscape_edge_extraction: {
        value: openpipelineV2SpansPipelinesSmartscapeEdgeExtractionToHclTerraform(this._smartscapeEdgeExtraction.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OpenpipelineV2SpansPipelinesSmartscapeEdgeExtractionList",
      },
      smartscape_node_extraction: {
        value: openpipelineV2SpansPipelinesSmartscapeNodeExtractionToHclTerraform(this._smartscapeNodeExtraction.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OpenpipelineV2SpansPipelinesSmartscapeNodeExtractionList",
      },
      storage: {
