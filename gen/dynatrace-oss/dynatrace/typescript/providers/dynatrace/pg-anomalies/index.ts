// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/pg_anomalies
...
export interface PgAnomaliesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/pg_anomalies#id PgAnomalies#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/pg_anomalies#pg_id PgAnomalies#pg_id}
  */
  readonly pgId: string;
  /**
  * availability block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/pg_anomalies#availability PgAnomalies#availability}
  */
...
export interface PgAnomaliesAvailability {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/pg_anomalies#method PgAnomalies#method}
  */
  readonly method: string;
  /**
  * Alert if the number of active processes in the group is lower than this value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/pg_anomalies#minimum_threshold PgAnomalies#minimum_threshold}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/pg_anomalies dynatrace_pg_anomalies}
*/
export class PgAnomalies extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PgAnomalies that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/pg_anomalies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/pg_anomalies dynatrace_pg_anomalies} Resource
  *
  * @param scope The scope in which to define this construct
