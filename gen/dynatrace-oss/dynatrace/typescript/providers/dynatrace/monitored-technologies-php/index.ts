// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/monitored_technologies_php
...
export interface MonitoredTechnologiesPhpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/monitored_technologies_php#enable_php_cli_server MonitoredTechnologiesPhp#enable_php_cli_server}
  */
  readonly enablePhpCliServer?: boolean | cdktf.IResolvable;
  /**
  * This setting is enabled (`true`) or disabled (`false`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/monitored_technologies_php#enabled MonitoredTechnologiesPhp#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Requires PHP monitoring enabled and from Dynatrace OneAgent version 1.191 it's ignored and permanently enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/monitored_technologies_php#enabled_fast_cgi MonitoredTechnologiesPhp#enabled_fast_cgi}
  */
  readonly enabledFastCgi?: boolean | cdktf.IResolvable;
  /**
  * The scope of this settings. If the settings should cover the whole environment, just don't specify any scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/monitored_technologies_php#host_id MonitoredTechnologiesPhp#host_id}
  */
  readonly hostId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/monitored_technologies_php#id MonitoredTechnologiesPhp#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/monitored_technologies_php dynatrace_monitored_technologies_php}
*/
export class MonitoredTechnologiesPhp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitoredTechnologiesPhp that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/monitored_technologies_php#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/monitored_technologies_php dynatrace_monitored_technologies_php} Resource
  *
  * @param scope The scope in which to define this construct
