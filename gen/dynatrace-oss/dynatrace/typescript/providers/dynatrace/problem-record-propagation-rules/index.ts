// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/problem_record_propagation_rules
...
export interface ProblemRecordPropagationRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/problem_record_propagation_rules#enabled ProblemRecordPropagationRules#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/problem_record_propagation_rules#id ProblemRecordPropagationRules#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/problem_record_propagation_rules#source_attribute_key ProblemRecordPropagationRules#source_attribute_key}
  */
  readonly sourceAttributeKey: string;
  /**
  * Attribute key under which the propagated event data will be stored on the problem.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/problem_record_propagation_rules#target_attribute_key ProblemRecordPropagationRules#target_attribute_key}
  */
  readonly targetAttributeKey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/problem_record_propagation_rules dynatrace_problem_record_propagation_rules}
*/
export class ProblemRecordPropagationRules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProblemRecordPropagationRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/problem_record_propagation_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/problem_record_propagation_rules dynatrace_problem_record_propagation_rules} Resource
  *
  * @param scope The scope in which to define this construct
