// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/extension_execution_remote
...
export interface ExtensionExecutionRemoteConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/extension_execution_remote#id ExtensionExecutionRemote#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/extension_execution_remote#performance_profile ExtensionExecutionRemote#performance_profile}
  */
  readonly performanceProfile: string;
  /**
  * The scope of this setting (ENVIRONMENT_ACTIVE_GATE)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/extension_execution_remote#scope ExtensionExecutionRemote#scope}
  */
  readonly scope: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/extension_execution_remote dynatrace_extension_execution_remote}
*/
export class ExtensionExecutionRemote extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExtensionExecutionRemote that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/extension_execution_remote#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/extension_execution_remote dynatrace_extension_execution_remote} Resource
  *
  * @param scope The scope in which to define this construct
