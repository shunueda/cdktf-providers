// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification
...
export interface TrelloNotificationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification#active TrelloNotification#active}
  */
  readonly active: boolean | cdktf.IResolvable;
  /**
  * The application key for the Trello account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification#application_key TrelloNotification#application_key}
  */
  readonly applicationKey: string;
  /**
  * The application token for the Trello account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification#authorization_token TrelloNotification#authorization_token}
  */
  readonly authorizationToken?: string;
  /**
  * The Trello board to which the card should be assigned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification#board_id TrelloNotification#board_id}
  */
  readonly boardId: string;
  /**
  * The description of the Trello card.   You can use same placeholders as in card text
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification#description TrelloNotification#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification#id TrelloNotification#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification#legacy_id TrelloNotification#legacy_id}
  */
  readonly legacyId?: string;
  /**
  * The Trello list to which the card should be assigned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification#list_id TrelloNotification#list_id}
  */
  readonly listId: string;
  /**
  * The name of the notification configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification#name TrelloNotification#name}
  */
  readonly name: string;
  /**
  * The ID of the associated alerting profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification#profile TrelloNotification#profile}
  */
  readonly profile: string;
  /**
  * The Trello list to which the card of the resolved problem should be assigned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification#resolved_list_id TrelloNotification#resolved_list_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification#text TrelloNotification#text}
  */
  readonly text: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification dynatrace_trello_notification}
*/
export class TrelloNotification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrelloNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/trello_notification dynatrace_trello_notification} Resource
  *
  * @param scope The scope in which to define this construct
