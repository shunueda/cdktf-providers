// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo
...
export interface SloConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#denominator Slo#denominator}
  */
  readonly denominator?: string;
  /**
  * The custom description of the SLO (optional)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#description Slo#description}
  */
  readonly description?: string;
  /**
  * The SLO is enabled (`false`) or disabled (`true`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#disabled Slo#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * The evaluation type of the SLO. Currently only `AGGREGATE` is supported
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#evaluation Slo#evaluation}
  */
  readonly evaluation: string;
  /**
  * The entity filter for the SLO evaluation. Use the [syntax of entity selector](https://dt-url.net/entityselector)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#filter Slo#filter}
  */
  readonly filter?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#id Slo#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#metric_expression Slo#metric_expression}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#metric_name Slo#metric_name}
  */
  readonly metricName?: string;
  /**
  * The name of the rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#name Slo#name}
  */
  readonly name: string;
  /**
  * The metric for the count of successes (the numerator in rate calculation)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#numerator Slo#numerator}
  */
  readonly numerator?: string;
  /**
  * The percentage-based metric for the calculation of the SLO
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#rate Slo#rate}
  */
  readonly rate?: string;
  /**
  * The target value of the SLO
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#target Slo#target}
  */
  readonly target: number;
  /**
  * The timeframe for the SLO evaluation. Use the syntax of the global timeframe selector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#timeframe Slo#timeframe}
  */
  readonly timeframe: string;
  /**
  * The warning value of the SLO. At warning state the SLO is still fulfilled but is getting close to failure
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#warning Slo#warning}
  */
  readonly warning: number;
  /**
  * error_budget_burn_rate block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#error_budget_burn_rate Slo#error_budget_burn_rate}
  */
...
export interface SloErrorBudgetBurnRate {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#burn_rate_visualization_enabled Slo#burn_rate_visualization_enabled}
  */
  readonly burnRateVisualizationEnabled?: boolean | cdktf.IResolvable;
  /**
  * The threshold between a slow and a fast burn rate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#fast_burn_threshold Slo#fast_burn_threshold}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo dynatrace_slo}
*/
export class Slo extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Slo that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/slo dynatrace_slo} Resource
  *
  * @param scope The scope in which to define this construct
