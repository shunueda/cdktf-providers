// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/synthetic_availability
...
export interface SyntheticAvailabilityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/synthetic_availability#exclude_maintenance_windows SyntheticAvailability#exclude_maintenance_windows}
  */
  readonly excludeMaintenanceWindows: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/synthetic_availability#id SyntheticAvailability#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/synthetic_availability dynatrace_synthetic_availability}
*/
export class SyntheticAvailability extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SyntheticAvailability that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/synthetic_availability#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/synthetic_availability dynatrace_synthetic_availability} Resource
  *
  * @param scope The scope in which to define this construct
