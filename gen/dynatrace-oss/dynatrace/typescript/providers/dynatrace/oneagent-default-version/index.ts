// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/oneagent_default_version
...
export interface OneagentDefaultVersionConfig extends cdktf.TerraformMetaArguments {
  ...
  * Default version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/oneagent_default_version#default_version OneagentDefaultVersion#default_version}
  */
  readonly defaultVersion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/oneagent_default_version#id OneagentDefaultVersion#id}
  *
  ...
  * Revision
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/oneagent_default_version#revision OneagentDefaultVersion#revision}
  */
  readonly revision?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/oneagent_default_version dynatrace_oneagent_default_version}
*/
export class OneagentDefaultVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OneagentDefaultVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/oneagent_default_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/oneagent_default_version dynatrace_oneagent_default_version} Resource
  *
  * @param scope The scope in which to define this construct
