// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/mobile_app_key_performance
...
export interface MobileAppKeyPerformanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/mobile_app_key_performance#frustrating_if_reported_or_web_request_error MobileAppKeyPerformance#frustrating_if_reported_or_web_request_error}
  */
  readonly frustratingIfReportedOrWebRequestError: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/mobile_app_key_performance#id MobileAppKeyPerformance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/mobile_app_key_performance#scope MobileAppKeyPerformance#scope}
  */
  readonly scope: string;
  /**
  * thresholds block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/mobile_app_key_performance#thresholds MobileAppKeyPerformance#thresholds}
  */
...
export interface MobileAppKeyPerformanceThresholds {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/mobile_app_key_performance#frustrating_threshold_seconds MobileAppKeyPerformance#frustrating_threshold_seconds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/mobile_app_key_performance#tolerable_threshold_seconds MobileAppKeyPerformance#tolerable_threshold_seconds}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/mobile_app_key_performance dynatrace_mobile_app_key_performance}
*/
export class MobileAppKeyPerformance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MobileAppKeyPerformance that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/mobile_app_key_performance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/mobile_app_key_performance dynatrace_mobile_app_key_performance} Resource
  *
  * @param scope The scope in which to define this construct
