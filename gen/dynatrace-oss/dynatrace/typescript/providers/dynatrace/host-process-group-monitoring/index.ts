// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/host_process_group_monitoring
...
export interface HostProcessGroupMonitoringConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/host_process_group_monitoring#host_id HostProcessGroupMonitoring#host_id}
  */
  readonly hostId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/host_process_group_monitoring#id HostProcessGroupMonitoring#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/host_process_group_monitoring#monitoring_state HostProcessGroupMonitoring#monitoring_state}
  */
  readonly monitoringState: string;
  /**
  * Process group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/host_process_group_monitoring#process_group HostProcessGroupMonitoring#process_group}
  */
  readonly processGroup: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/host_process_group_monitoring dynatrace_host_process_group_monitoring}
*/
export class HostProcessGroupMonitoring extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HostProcessGroupMonitoring that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/host_process_group_monitoring#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/host_process_group_monitoring dynatrace_host_process_group_monitoring} Resource
  *
  * @param scope The scope in which to define this construct
