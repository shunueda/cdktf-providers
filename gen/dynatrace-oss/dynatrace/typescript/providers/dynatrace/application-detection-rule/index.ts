// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/application_detection_rule
...
export interface ApplicationDetectionRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/application_detection_rule#application_identifier ApplicationDetectionRule#application_identifier}
  */
  readonly applicationIdentifier: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/application_detection_rule#id ApplicationDetectionRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/application_detection_rule#name ApplicationDetectionRule#name}
  */
  readonly name?: string;
  /**
  * The order of the rule in the rules list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/application_detection_rule#order ApplicationDetectionRule#order}
  */
  readonly order?: string;
  /**
  * filter_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/application_detection_rule#filter_config ApplicationDetectionRule#filter_config}
  */
...
export interface ApplicationDetectionRuleFilterConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/application_detection_rule#application_match_target ApplicationDetectionRule#application_match_target}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/application_detection_rule#application_match_type ApplicationDetectionRule#application_match_type}
  */
  readonly applicationMatchType: string;
  /**
  * The value to look for with the application detection rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/application_detection_rule#pattern ApplicationDetectionRule#pattern}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/application_detection_rule dynatrace_application_detection_rule}
*/
export class ApplicationDetectionRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationDetectionRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/application_detection_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/application_detection_rule dynatrace_application_detection_rule} Resource
  *
  * @param scope The scope in which to define this construct
