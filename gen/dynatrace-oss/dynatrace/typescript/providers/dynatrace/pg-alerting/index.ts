// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/pg_alerting
...
export interface PgAlertingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/pg_alerting#alerting_mode PgAlerting#alerting_mode}
  */
  readonly alertingMode?: string;
  /**
  * Enable (`true`) or disable (`false`) process group availability monitoring
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/pg_alerting#enabled PgAlerting#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/pg_alerting#id PgAlerting#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/pg_alerting#minimum_instance_threshold PgAlerting#minimum_instance_threshold}
  */
  readonly minimumInstanceThreshold?: number;
  /**
  * The process group ID for availability monitoring
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/pg_alerting#process_group PgAlerting#process_group}
  */
  readonly processGroup: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/pg_alerting dynatrace_pg_alerting}
*/
export class PgAlerting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PgAlerting that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/pg_alerting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/pg_alerting dynatrace_pg_alerting} Resource
  *
  * @param scope The scope in which to define this construct
