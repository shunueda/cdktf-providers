// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token
...
export interface ApiTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token#creation_date ApiToken#creation_date}
  */
  readonly creationDate?: string;
  /**
  * The token is enabled (true) or disabled (false), default disabled (false).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token#enabled ApiToken#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The expiration date of the token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token#expiration_date ApiToken#expiration_date}
  */
  readonly expirationDate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token#id ApiToken#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token#last_used_date ApiToken#last_used_date}
  */
  readonly lastUsedDate?: string;
  /**
  * Token last used IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token#last_used_ip_address ApiToken#last_used_ip_address}
  */
  readonly lastUsedIpAddress?: string;
  /**
  * Token last modified date in ISO 8601 format (yyyy-MM-dd'T'HH:mm:ss.SSS'Z').
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token#modified_date ApiToken#modified_date}
  */
  readonly modifiedDate?: string;
  /**
  * The name of the token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token#name ApiToken#name}
  */
  readonly name: string;
  /**
  * The owner of the token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token#owner ApiToken#owner}
  */
  readonly owner?: string;
  /**
  * The token is a personal access token (true) or an API token (false).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token#personal_access_token ApiToken#personal_access_token}
  */
  readonly personalAccessToken?: boolean | cdktf.IResolvable;
  /**
  * A list of the scopes to be assigned to the token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token#scopes ApiToken#scopes}
  */
  readonly scopes: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token dynatrace_api_token}
*/
export class ApiToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/api_token dynatrace_api_token} Resource
  *
  * @param scope The scope in which to define this construct
