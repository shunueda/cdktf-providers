// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/dashboards_presets
...
export interface DashboardsPresetsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/dashboards_presets#enable_dashboard_presets DashboardsPresets#enable_dashboard_presets}
  */
  readonly enableDashboardPresets: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/dashboards_presets#id DashboardsPresets#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/dashboards_presets#dashboard_presets_list DashboardsPresets#dashboard_presets_list}
  */
...
export interface DashboardsPresetsDashboardPresetsListDashboardPresets {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/dashboards_presets#dashboard_preset DashboardsPresets#dashboard_preset}
  */
  readonly dashboardPreset: string;
  /**
  * User group to show selected dashboard preset to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/dashboards_presets#user_group DashboardsPresets#user_group}
  */
...
export interface DashboardsPresetsDashboardPresetsListStruct {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/dashboards_presets#dashboard_presets DashboardsPresets#dashboard_presets}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/dashboards_presets dynatrace_dashboards_presets}
*/
export class DashboardsPresets extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DashboardsPresets that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/dashboards_presets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/dashboards_presets dynatrace_dashboards_presets} Resource
  *
  * @param scope The scope in which to define this construct
