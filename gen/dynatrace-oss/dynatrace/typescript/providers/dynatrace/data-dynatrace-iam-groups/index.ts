// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/data-sources/iam_groups
...
export interface DataDynatraceIamGroupsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/data-sources/iam_groups#id DataDynatraceIamGroups#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/data-sources/iam_groups dynatrace_iam_groups}
*/
export class DataDynatraceIamGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDynatraceIamGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/data-sources/iam_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/data-sources/iam_groups dynatrace_iam_groups} Data Source
  *
  * @param scope The scope in which to define this construct
