// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/document
...
export interface DocumentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/document#content Document#content}
  */
  readonly content: string;
  /**
  * If provided, this will be the id of the document. If not provided, a system-generated id is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/document#custom_id Document#custom_id}
  */
  readonly customId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/document#id Document#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/document#name Document#name}
  */
  readonly name: string;
  /**
  * Specifies whether the document is private or readable by everybody
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/document#private Document#private}
  */
  readonly private?: boolean | cdktf.IResolvable;
  /**
  * Type of the document. Possible Values are `dashboard`, `launchpad` and `notebook`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/document#type Document#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/document dynatrace_document}
*/
export class Document extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Document that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/document#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/document dynatrace_document} Resource
  *
  * @param scope The scope in which to define this construct
