// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/managed_public_endpoints
...
export interface ManagedPublicEndpointsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/managed_public_endpoints#additional_web_ui_addresses ManagedPublicEndpoints#additional_web_ui_addresses}
  */
  readonly additionalWebUiAddresses?: string[];
  /**
  * Beacon forwarder address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/managed_public_endpoints#beacon_forwarder_address ManagedPublicEndpoints#beacon_forwarder_address}
  */
  readonly beaconForwarderAddress?: string;
  /**
  * CDN address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/managed_public_endpoints#cdn_address ManagedPublicEndpoints#cdn_address}
  */
  readonly cdnAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/managed_public_endpoints#id ManagedPublicEndpoints#id}
  *
  ...
  * Web UI address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/managed_public_endpoints#web_ui_address ManagedPublicEndpoints#web_ui_address}
  */
  readonly webUiAddress?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/managed_public_endpoints dynatrace_managed_public_endpoints}
*/
export class ManagedPublicEndpoints extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedPublicEndpoints that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/managed_public_endpoints#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/managed_public_endpoints dynatrace_managed_public_endpoints} Resource
  *
  * @param scope The scope in which to define this construct
