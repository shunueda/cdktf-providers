// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/grail_security_context
...
export interface GrailSecurityContextConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/grail_security_context#destination_property GrailSecurityContext#destination_property}
  */
  readonly destinationProperty: string;
  /**
  * Type of the entity whose security context to override.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/grail_security_context#entity_type GrailSecurityContext#entity_type}
  */
  readonly entityType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/grail_security_context#id GrailSecurityContext#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/grail_security_context#insert_after GrailSecurityContext#insert_after}
  */
  readonly insertAfter?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/grail_security_context dynatrace_grail_security_context}
*/
export class GrailSecurityContext extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GrailSecurityContext that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/grail_security_context#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/grail_security_context dynatrace_grail_security_context} Resource
  *
  * @param scope The scope in which to define this construct
