// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/aws_connection_role_arn
...
export interface AwsConnectionRoleArnConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/aws_connection_role_arn#aws_connection_id AwsConnectionRoleArn#aws_connection_id}
  */
  readonly awsConnectionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/aws_connection_role_arn#id AwsConnectionRoleArn#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/aws_connection_role_arn#role_arn AwsConnectionRoleArn#role_arn}
  */
  readonly roleArn: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/aws_connection_role_arn#timeouts AwsConnectionRoleArn#timeouts}
  */
  readonly timeouts?: AwsConnectionRoleArnTimeouts;
}
export interface AwsConnectionRoleArnTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/aws_connection_role_arn#create AwsConnectionRoleArn#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/aws_connection_role_arn dynatrace_aws_connection_role_arn}
*/
export class AwsConnectionRoleArn extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsConnectionRoleArn that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/aws_connection_role_arn#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/aws_connection_role_arn dynatrace_aws_connection_role_arn} Resource
  *
  * @param scope The scope in which to define this construct
