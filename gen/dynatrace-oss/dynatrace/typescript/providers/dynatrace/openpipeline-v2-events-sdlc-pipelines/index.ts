...
OpenpipelineV2EventsSdlcPipelinesMetadataListStruct, 
openpipelineV2EventsSdlcPipelinesMetadataListStructToTerraform, 
openpipelineV2EventsSdlcPipelinesMetadataListStructToHclTerraform, 
OpenpipelineV2EventsSdlcPipelinesMetadataListStructOutputReference, 
...
export interface OpenpipelineV2EventsSdlcPipelinesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Custom pipeline id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#custom_id OpenpipelineV2EventsSdlcPipelines#custom_id}
  */
  readonly customId: string;
  /**
  * Display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#display_name OpenpipelineV2EventsSdlcPipelines#display_name}
  */
  readonly displayName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#id OpenpipelineV2EventsSdlcPipelines#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#cost_allocation OpenpipelineV2EventsSdlcPipelines#cost_allocation}
  */
  readonly costAllocation?: OpenpipelineV2EventsSdlcPipelinesCostAllocation;
  /**
  * data_extraction block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#data_extraction OpenpipelineV2EventsSdlcPipelines#data_extraction}
  */
  readonly dataExtraction?: OpenpipelineV2EventsSdlcPipelinesDataExtraction;
  /**
  * davis block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#davis OpenpipelineV2EventsSdlcPipelines#davis}
  */
  readonly davis?: OpenpipelineV2EventsSdlcPipelinesDavis;
  /**
  * metadata_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#metadata_list OpenpipelineV2EventsSdlcPipelines#metadata_list}
  */
  readonly metadataList?: OpenpipelineV2EventsSdlcPipelinesMetadataListStruct;
  /**
  * metric_extraction block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#metric_extraction OpenpipelineV2EventsSdlcPipelines#metric_extraction}
  */
  readonly metricExtraction?: OpenpipelineV2EventsSdlcPipelinesMetricExtraction;
  /**
  * processing block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#processing OpenpipelineV2EventsSdlcPipelines#processing}
  */
  readonly processing?: OpenpipelineV2EventsSdlcPipelinesProcessing;
  /**
  * product_allocation block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#product_allocation OpenpipelineV2EventsSdlcPipelines#product_allocation}
  */
  readonly productAllocation?: OpenpipelineV2EventsSdlcPipelinesProductAllocation;
  /**
  * security_context block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#security_context OpenpipelineV2EventsSdlcPipelines#security_context}
  */
  readonly securityContext?: OpenpipelineV2EventsSdlcPipelinesSecurityContext;
  /**
  * smartscape_edge_extraction block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#smartscape_edge_extraction OpenpipelineV2EventsSdlcPipelines#smartscape_edge_extraction}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#smartscape_node_extraction OpenpipelineV2EventsSdlcPipelines#smartscape_node_extraction}
  */
  readonly smartscapeNodeExtraction?: OpenpipelineV2EventsSdlcPipelinesSmartscapeNodeExtraction;
  /**
  * storage block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#storage OpenpipelineV2EventsSdlcPipelines#storage}
  */
  readonly storage?: OpenpipelineV2EventsSdlcPipelinesStorage;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines dynatrace_openpipeline_v2_events_sdlc_pipelines}
*/
export class OpenpipelineV2EventsSdlcPipelines extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpenpipelineV2EventsSdlcPipelines that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_events_sdlc_pipelines dynatrace_openpipeline_v2_events_sdlc_pipelines} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _metadataList = new OpenpipelineV2EventsSdlcPipelinesMetadataListStructOutputReference(this, "metadata_list");
  public get metadataList() {
    return this._metadataList;
  }
  public putMetadataList(value: OpenpipelineV2EventsSdlcPipelinesMetadataListStruct) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      metadata_list: openpipelineV2EventsSdlcPipelinesMetadataListStructToTerraform(this._metadataList.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      metadata_list: {
        value: openpipelineV2EventsSdlcPipelinesMetadataListStructToHclTerraform(this._metadataList.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OpenpipelineV2EventsSdlcPipelinesMetadataListStructList",
      },
      metric_extraction: {
