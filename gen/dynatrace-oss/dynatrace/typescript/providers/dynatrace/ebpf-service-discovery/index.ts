// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/ebpf_service_discovery
...
export interface EbpfServiceDiscoveryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/ebpf_service_discovery#ebpf EbpfServiceDiscovery#ebpf}
  */
  readonly ebpf: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/ebpf_service_discovery#id EbpfServiceDiscovery#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/ebpf_service_discovery#scope EbpfServiceDiscovery#scope}
  */
  readonly scope?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/ebpf_service_discovery dynatrace_ebpf_service_discovery}
*/
export class EbpfServiceDiscovery extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EbpfServiceDiscovery that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/ebpf_service_discovery#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/ebpf_service_discovery dynatrace_ebpf_service_discovery} Resource
  *
  * @param scope The scope in which to define this construct
