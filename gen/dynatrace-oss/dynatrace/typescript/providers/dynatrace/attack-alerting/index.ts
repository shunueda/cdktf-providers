// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/attack_alerting
...
export interface AttackAlertingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/attack_alerting#enabled AttackAlerting#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Attack State
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/attack_alerting#enabled_attack_mitigations AttackAlerting#enabled_attack_mitigations}
  */
  readonly enabledAttackMitigations?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/attack_alerting#id AttackAlerting#id}
  *
  ...
  * Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/attack_alerting#name AttackAlerting#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/attack_alerting dynatrace_attack_alerting}
*/
export class AttackAlerting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AttackAlerting that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/attack_alerting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/attack_alerting dynatrace_attack_alerting} Resource
  *
  * @param scope The scope in which to define this construct
