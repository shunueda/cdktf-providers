// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/oneagent_default_mode
...
export interface OneagentDefaultModeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/oneagent_default_mode#default_mode OneagentDefaultMode#default_mode}
  */
  readonly defaultMode: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/oneagent_default_mode#id OneagentDefaultMode#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/oneagent_default_mode dynatrace_oneagent_default_mode}
*/
export class OneagentDefaultMode extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OneagentDefaultMode that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/oneagent_default_mode#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/oneagent_default_mode dynatrace_oneagent_default_mode} Resource
  *
  * @param scope The scope in which to define this construct
