// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_location
...
export interface DataDynatraceSyntheticLocationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_location#cloud_platform DataDynatraceSyntheticLocation#cloud_platform}
  */
  readonly cloudPlatform?: string;
  /**
  * The unique ID of the location
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_location#entity_id DataDynatraceSyntheticLocation#entity_id}
  */
  readonly entityId?: string;
  /**
  * The Dynatrace GeoLocation ID of the location
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_location#geo_location_id DataDynatraceSyntheticLocation#geo_location_id}
  */
  readonly geoLocationId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_location#id DataDynatraceSyntheticLocation#id}
  *
  ...
  *  Only applicable to `PUBLIC` locations
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_location#ips DataDynatraceSyntheticLocation#ips}
  */
  readonly ips?: string[];
  /**
  * The name of the location
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_location#name DataDynatraceSyntheticLocation#name}
  */
  readonly name?: string;
  /**
  * The release stage of the location
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_location#stage DataDynatraceSyntheticLocation#stage}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_location#status DataDynatraceSyntheticLocation#status}
  */
  readonly status?: string;
  /**
  * The type of the location. Supported values are `PUBLIC`, `PRIVATE` and `CLUSTER`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_location#type DataDynatraceSyntheticLocation#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_location dynatrace_synthetic_location}
*/
export class DataDynatraceSyntheticLocation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDynatraceSyntheticLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_location dynatrace_synthetic_location} Data Source
  *
  * @param scope The scope in which to define this construct
