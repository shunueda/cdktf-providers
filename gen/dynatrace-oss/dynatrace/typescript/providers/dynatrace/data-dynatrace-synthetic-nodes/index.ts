// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_nodes
...
export interface DataDynatraceSyntheticNodesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_nodes#id DataDynatraceSyntheticNodes#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_nodes dynatrace_synthetic_nodes}
*/
export class DataDynatraceSyntheticNodes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDynatraceSyntheticNodes that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_nodes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/synthetic_nodes dynatrace_synthetic_nodes} Data Source
  *
  * @param scope The scope in which to define this construct
