// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/problem_fields
...
export interface ProblemFieldsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/problem_fields#enabled ProblemFields#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Field from the event that will be extracted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/problem_fields#event_field ProblemFields#event_field}
  */
  readonly eventField: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/problem_fields#id ProblemFields#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/problem_fields#problem_field ProblemFields#problem_field}
  */
  readonly problemField: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/problem_fields dynatrace_problem_fields}
*/
export class ProblemFields extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProblemFields that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/problem_fields#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/problem_fields dynatrace_problem_fields} Resource
  *
  * @param scope The scope in which to define this construct
