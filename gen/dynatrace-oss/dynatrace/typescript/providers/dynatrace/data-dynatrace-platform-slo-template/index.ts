// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/platform_slo_template
...
export interface DataDynatracePlatformSloTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/platform_slo_template#name DataDynatracePlatformSloTemplate#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/platform_slo_template dynatrace_platform_slo_template}
*/
export class DataDynatracePlatformSloTemplate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDynatracePlatformSloTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/platform_slo_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/data-sources/platform_slo_template dynatrace_platform_slo_template} Data Source
  *
  * @param scope The scope in which to define this construct
