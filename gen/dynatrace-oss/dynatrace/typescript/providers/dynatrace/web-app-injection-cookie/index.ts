// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_injection_cookie
...
export interface WebAppInjectionCookieConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_injection_cookie#application_id WebAppInjectionCookie#application_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_injection_cookie#cookie_placement_domain WebAppInjectionCookie#cookie_placement_domain}
  */
  readonly cookiePlacementDomain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_injection_cookie#id WebAppInjectionCookie#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_injection_cookie#same_site_cookie_attribute WebAppInjectionCookie#same_site_cookie_attribute}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_injection_cookie#use_secure_cookie_attribute WebAppInjectionCookie#use_secure_cookie_attribute}
  */
  readonly useSecureCookieAttribute: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_injection_cookie dynatrace_web_app_injection_cookie}
*/
export class WebAppInjectionCookie extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebAppInjectionCookie that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_injection_cookie#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/web_app_injection_cookie dynatrace_web_app_injection_cookie} Resource
  *
  * @param scope The scope in which to define this construct
