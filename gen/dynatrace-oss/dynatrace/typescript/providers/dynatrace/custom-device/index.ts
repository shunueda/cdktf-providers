// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device
...
export interface CustomDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device#config_url CustomDevice#config_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device#custom_device_id CustomDevice#custom_device_id}
  */
  readonly customDeviceId?: string;
  /**
  * The name of the custom device, displayed in the UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device#display_name CustomDevice#display_name}
  */
  readonly displayName: string;
  /**
  * The list of DNS names related to the custom device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device#dns_names CustomDevice#dns_names}
  */
  readonly dnsNames?: string[];
  /**
  * The icon to be displayed for your custom component within Smartscape. Provide the full URL of the icon file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device#favicon_url CustomDevice#favicon_url}
  */
  readonly faviconUrl?: string;
  /**
  * User defined group of entity. Changing the group requires a new custom device to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device#group CustomDevice#group}
  */
  readonly group?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device#id CustomDevice#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device#ip_addresses CustomDevice#ip_addresses}
  */
  readonly ipAddresses?: string[];
  /**
  * The list of ports the custom devices listens to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device#listen_ports CustomDevice#listen_ports}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device#properties CustomDevice#properties}
  */
  readonly properties?: { [key: string]: string };
  /**
  * The list of key-value pair properties that will be shown beneath the infographics of your custom device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device#props CustomDevice#props}
  */
  readonly props?: string;
  /**
  * The technology type definition of the custom device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device#type CustomDevice#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device#ui_based CustomDevice#ui_based}
  */
  readonly uiBased?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device dynatrace_custom_device}
*/
export class CustomDevice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/custom_device dynatrace_custom_device} Resource
  *
  * @param scope The scope in which to define this construct
