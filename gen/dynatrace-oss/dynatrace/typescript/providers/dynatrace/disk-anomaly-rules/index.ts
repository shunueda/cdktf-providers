// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules
...
export interface DiskAnomalyRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#enabled DiskAnomalyRules#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * The scope of this settings. If the settings should cover the whole environment, just don't specify any scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#host_group_id DiskAnomalyRules#host_group_id}
  */
  readonly hostGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#id DiskAnomalyRules#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#metric DiskAnomalyRules#metric}
  */
  readonly metric: string;
  /**
  * Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#name DiskAnomalyRules#name}
  */
  readonly name: string;
  /**
  * Only apply to hosts that have the following tags
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#tag_filters DiskAnomalyRules#tag_filters}
  */
  readonly tagFilters?: string[];
  /**
  * Alert if higher than
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#threshold_milliseconds DiskAnomalyRules#threshold_milliseconds}
  */
  readonly thresholdMilliseconds?: number;
  /**
  * Alert if lower than
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#threshold_percent DiskAnomalyRules#threshold_percent}
  */
  readonly thresholdPercent?: number;
  /**
  * disk_name_filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#disk_name_filter DiskAnomalyRules#disk_name_filter}
  */
  readonly diskNameFilter: DiskAnomalyRulesDiskNameFilter;
  /**
  * sample_limit block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#sample_limit DiskAnomalyRules#sample_limit}
  */
...
export interface DiskAnomalyRulesDiskNameFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#operator DiskAnomalyRules#operator}
  */
  readonly operator: string;
  /**
  * Matching text
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#value DiskAnomalyRules#value}
  */
...
export interface DiskAnomalyRulesSampleLimit {
  ...
  * .. within the last
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#samples DiskAnomalyRules#samples}
  */
  readonly samples: number;
  /**
  * Minimum number of violating samples
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#violating_samples DiskAnomalyRules#violating_samples}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules dynatrace_disk_anomaly_rules}
*/
export class DiskAnomalyRules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DiskAnomalyRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/disk_anomaly_rules dynatrace_disk_anomaly_rules} Resource
  *
  * @param scope The scope in which to define this construct
