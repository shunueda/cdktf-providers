// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/data-sources/application_detection_rules
...
export interface DataDynatraceApplicationDetectionRulesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/data-sources/application_detection_rules#id DataDynatraceApplicationDetectionRules#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/data-sources/application_detection_rules dynatrace_application_detection_rules}
*/
export class DataDynatraceApplicationDetectionRules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDynatraceApplicationDetectionRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/data-sources/application_detection_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/data-sources/application_detection_rules dynatrace_application_detection_rules} Data Source
  *
  * @param scope The scope in which to define this construct
