...
OpenpipelineV2SystemEventsPipelinesMetadataListStruct, 
openpipelineV2SystemEventsPipelinesMetadataListStructToTerraform, 
openpipelineV2SystemEventsPipelinesMetadataListStructToHclTerraform, 
OpenpipelineV2SystemEventsPipelinesMetadataListStructOutputReference, 
...
OpenpipelineV2SystemEventsPipelinesSmartscapeEdgeExtraction, 
openpipelineV2SystemEventsPipelinesSmartscapeEdgeExtractionToTerraform, 
openpipelineV2SystemEventsPipelinesSmartscapeEdgeExtractionToHclTerraform, 
OpenpipelineV2SystemEventsPipelinesSmartscapeEdgeExtractionOutputReference, 
OpenpipelineV2SystemEventsPipelinesSmartscapeNodeExtraction, 
openpipelineV2SystemEventsPipelinesSmartscapeNodeExtractionToTerraform, 
openpipelineV2SystemEventsPipelinesSmartscapeNodeExtractionToHclTerraform, 
OpenpipelineV2SystemEventsPipelinesSmartscapeNodeExtractionOutputReference, 
...
export interface OpenpipelineV2SystemEventsPipelinesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Custom pipeline id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_system_events_pipelines#custom_id OpenpipelineV2SystemEventsPipelines#custom_id}
  */
  readonly customId: string;
  /**
  * Display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_system_events_pipelines#display_name OpenpipelineV2SystemEventsPipelines#display_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_system_events_pipelines#data_extraction OpenpipelineV2SystemEventsPipelines#data_extraction}
  */
  ...
  * metadata_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_system_events_pipelines#metadata_list OpenpipelineV2SystemEventsPipelines#metadata_list}
  */
  readonly metadataList?: OpenpipelineV2SystemEventsPipelinesMetadataListStruct;
  /**
  * metric_extraction block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_system_events_pipelines#metric_extraction OpenpipelineV2SystemEventsPipelines#metric_extraction}
  */
  readonly metricExtraction?: OpenpipelineV2SystemEventsPipelinesMetricExtraction;
  /**
  * processing block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_system_events_pipelines#processing OpenpipelineV2SystemEventsPipelines#processing}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_system_events_pipelines#smartscape_edge_extraction OpenpipelineV2SystemEventsPipelines#smartscape_edge_extraction}
  */
  readonly smartscapeEdgeExtraction?: OpenpipelineV2SystemEventsPipelinesSmartscapeEdgeExtraction;
  /**
  * smartscape_node_extraction block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_system_events_pipelines#smartscape_node_extraction OpenpipelineV2SystemEventsPipelines#smartscape_node_extraction}
  */
  readonly smartscapeNodeExtraction?: OpenpipelineV2SystemEventsPipelinesSmartscapeNodeExtraction;
  /**
  * storage block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_system_events_pipelines#storage OpenpipelineV2SystemEventsPipelines#storage}
  */
  readonly storage?: OpenpipelineV2SystemEventsPipelinesStorage;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_system_events_pipelines dynatrace_openpipeline_v2_system_events_pipelines}
*/
export class OpenpipelineV2SystemEventsPipelines extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpenpipelineV2SystemEventsPipelines that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_system_events_pipelines#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/openpipeline_v2_system_events_pipelines dynatrace_openpipeline_v2_system_events_pipelines} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _metadataList = new OpenpipelineV2SystemEventsPipelinesMetadataListStructOutputReference(this, "metadata_list");
  public get metadataList() {
    return this._metadataList;
  }
  public putMetadataList(value: OpenpipelineV2SystemEventsPipelinesMetadataListStruct) {
  ...
  private _smartscapeEdgeExtraction = new OpenpipelineV2SystemEventsPipelinesSmartscapeEdgeExtractionOutputReference(this, "smartscape_edge_extraction");
  public get smartscapeEdgeExtraction() {
    return this._smartscapeEdgeExtraction;
  }
  public putSmartscapeEdgeExtraction(value: OpenpipelineV2SystemEventsPipelinesSmartscapeEdgeExtraction) {
  ...
  private _smartscapeNodeExtraction = new OpenpipelineV2SystemEventsPipelinesSmartscapeNodeExtractionOutputReference(this, "smartscape_node_extraction");
  public get smartscapeNodeExtraction() {
    return this._smartscapeNodeExtraction;
  }
  public putSmartscapeNodeExtraction(value: OpenpipelineV2SystemEventsPipelinesSmartscapeNodeExtraction) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      metadata_list: openpipelineV2SystemEventsPipelinesMetadataListStructToTerraform(this._metadataList.internalValue),
      ...
      smartscape_edge_extraction: openpipelineV2SystemEventsPipelinesSmartscapeEdgeExtractionToTerraform(this._smartscapeEdgeExtraction.internalValue),
      smartscape_node_extraction: openpipelineV2SystemEventsPipelinesSmartscapeNodeExtractionToTerraform(this._smartscapeNodeExtraction.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      metadata_list: {
        value: openpipelineV2SystemEventsPipelinesMetadataListStructToHclTerraform(this._metadataList.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OpenpipelineV2SystemEventsPipelinesMetadataListStructList",
      },
      metric_extraction: {
      ...
      smartscape_edge_extraction: {
        value: openpipelineV2SystemEventsPipelinesSmartscapeEdgeExtractionToHclTerraform(this._smartscapeEdgeExtraction.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OpenpipelineV2SystemEventsPipelinesSmartscapeEdgeExtractionList",
      },
      smartscape_node_extraction: {
        value: openpipelineV2SystemEventsPipelinesSmartscapeNodeExtractionToHclTerraform(this._smartscapeNodeExtraction.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OpenpipelineV2SystemEventsPipelinesSmartscapeNodeExtractionList",
      },
      storage: {
