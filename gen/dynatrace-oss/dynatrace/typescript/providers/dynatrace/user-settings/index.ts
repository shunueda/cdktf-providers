// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/user_settings
...
export interface UserSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/user_settings#auto_language UserSettings#auto_language}
  */
  readonly autoLanguage: boolean | cdktf.IResolvable;
  /**
  * Region - use browser default
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/user_settings#auto_region UserSettings#auto_region}
  */
  readonly autoRegion: boolean | cdktf.IResolvable;
  /**
  * Theme - use browser default
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/user_settings#auto_theme UserSettings#auto_theme}
  */
  readonly autoTheme: boolean | cdktf.IResolvable;
  /**
  * Timezone - use browser default
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/user_settings#auto_timezone UserSettings#auto_timezone}
  */
  readonly autoTimezone: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/user_settings#id UserSettings#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/user_settings#language UserSettings#language}
  */
  readonly language?: string;
  /**
  * Region
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/user_settings#region UserSettings#region}
  */
  readonly region?: string;
  /**
  * The scope of this setting (user, userdefaults)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/user_settings#scope UserSettings#scope}
  */
  readonly scope: string;
  /**
  * Possible Values: `Dark`, `Light`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/user_settings#theme UserSettings#theme}
  */
  readonly theme?: string;
  /**
  * Timezone
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/user_settings#timezone UserSettings#timezone}
  */
  readonly timezone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/user_settings dynatrace_user_settings}
*/
export class UserSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/user_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/user_settings dynatrace_user_settings} Resource
  *
  * @param scope The scope in which to define this construct
