// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/oneagent_features
...
export interface OneagentFeaturesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/oneagent_features#enabled OneagentFeatures#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Activate this feature also in OneAgents only fulfilling the minimum Opt-In version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/oneagent_features#forcible OneagentFeatures#forcible}
  */
  readonly forcible?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/oneagent_features#id OneagentFeatures#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/oneagent_features#instrumentation OneagentFeatures#instrumentation}
  */
  readonly instrumentation?: boolean | cdktf.IResolvable;
  /**
  * Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/oneagent_features#key OneagentFeatures#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/oneagent_features#scope OneagentFeatures#scope}
  */
  readonly scope?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/oneagent_features dynatrace_oneagent_features}
*/
export class OneagentFeatures extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OneagentFeatures that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/oneagent_features#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/oneagent_features dynatrace_oneagent_features} Resource
  *
  * @param scope The scope in which to define this construct
