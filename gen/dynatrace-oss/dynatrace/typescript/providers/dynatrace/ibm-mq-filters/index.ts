// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/ibm_mq_filters
...
export interface IbmMqFiltersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/ibm_mq_filters#cics_mq_queue_id_excludes IbmMqFilters#cics_mq_queue_id_excludes}
  */
  readonly cicsMqQueueIdExcludes?: string[];
  /**
  * CICS: Included MQ queues
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/ibm_mq_filters#cics_mq_queue_id_includes IbmMqFilters#cics_mq_queue_id_includes}
  */
  readonly cicsMqQueueIdIncludes?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/ibm_mq_filters#id IbmMqFilters#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/ibm_mq_filters#ims_cr_trn_id_excludes IbmMqFilters#ims_cr_trn_id_excludes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/ibm_mq_filters#ims_cr_trn_id_includes IbmMqFilters#ims_cr_trn_id_includes}
  */
  readonly imsCrTrnIdIncludes?: string[];
  /**
  * IMS: Excluded MQ queues
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/ibm_mq_filters#ims_mq_queue_id_excludes IbmMqFilters#ims_mq_queue_id_excludes}
  */
  readonly imsMqQueueIdExcludes?: string[];
  /**
  * IMS: Included MQ queues
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/ibm_mq_filters#ims_mq_queue_id_includes IbmMqFilters#ims_mq_queue_id_includes}
  */
  readonly imsMqQueueIdIncludes?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/ibm_mq_filters dynatrace_ibm_mq_filters}
*/
export class IbmMqFilters extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IbmMqFilters that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/ibm_mq_filters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/ibm_mq_filters dynatrace_ibm_mq_filters} Resource
  *
  * @param scope The scope in which to define this construct
