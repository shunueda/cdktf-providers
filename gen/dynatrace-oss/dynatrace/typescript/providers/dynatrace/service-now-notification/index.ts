// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification
...
export interface ServiceNowNotificationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification#active ServiceNowNotification#active}
  */
  readonly active: boolean | cdktf.IResolvable;
  /**
  * Send events into ServiceNow ITOM
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification#events ServiceNowNotification#events}
  */
  readonly events?: boolean | cdktf.IResolvable;
  /**
  * Use text format for problem details instead of HTML.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification#format_problem_details_as_text ServiceNowNotification#format_problem_details_as_text}
  */
  readonly formatProblemDetailsAsText?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification#id ServiceNowNotification#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification#incidents ServiceNowNotification#incidents}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification#instance ServiceNowNotification#instance}
  */
  readonly instance?: string;
  /**
  * The ID of these settings when referred to from resources requiring the REST API V1 keys
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification#legacy_id ServiceNowNotification#legacy_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification#message ServiceNowNotification#message}
  */
  readonly message: string;
  /**
  * The name of the notification configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification#name ServiceNowNotification#name}
  */
  readonly name: string;
  /**
  * The password to the ServiceNow account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification#password ServiceNowNotification#password}
  */
  readonly password?: string;
  /**
  * The ID of the associated alerting profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification#profile ServiceNowNotification#profile}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification#url ServiceNowNotification#url}
  */
  readonly url?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification#username ServiceNowNotification#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification dynatrace_service_now_notification}
*/
export class ServiceNowNotification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceNowNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/service_now_notification dynatrace_service_now_notification} Resource
  *
  * @param scope The scope in which to define this construct
