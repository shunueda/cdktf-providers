// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/container_builtin_rule
...
export interface ContainerBuiltinRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/container_builtin_rule#id ContainerBuiltinRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/container_builtin_rule#ignore_docker_pause_container ContainerBuiltinRule#ignore_docker_pause_container}
  */
  readonly ignoreDockerPauseContainer: boolean | cdktf.IResolvable;
  /**
  * Disable monitoring of platform internal pause containers in Kubernetes and OpenShift.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/container_builtin_rule#ignore_kubernetes_pause_container ContainerBuiltinRule#ignore_kubernetes_pause_container}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/container_builtin_rule#ignore_open_shift_build_pod_name ContainerBuiltinRule#ignore_open_shift_build_pod_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/container_builtin_rule#ignore_open_shift_sdn_namespace ContainerBuiltinRule#ignore_open_shift_sdn_namespace}
  */
  readonly ignoreOpenShiftSdnNamespace: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/container_builtin_rule dynatrace_container_builtin_rule}
*/
export class ContainerBuiltinRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerBuiltinRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/container_builtin_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/container_builtin_rule dynatrace_container_builtin_rule} Resource
  *
  * @param scope The scope in which to define this construct
