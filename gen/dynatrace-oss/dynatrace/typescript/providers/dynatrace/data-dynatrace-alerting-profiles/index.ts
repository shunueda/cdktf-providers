// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/data-sources/alerting_profiles
...
export interface DataDynatraceAlertingProfilesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/data-sources/alerting_profiles#id DataDynatraceAlertingProfiles#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/data-sources/alerting_profiles#profiles DataDynatraceAlertingProfiles#profiles}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/data-sources/alerting_profiles dynatrace_alerting_profiles}
*/
export class DataDynatraceAlertingProfiles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDynatraceAlertingProfiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/data-sources/alerting_profiles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/data-sources/alerting_profiles dynatrace_alerting_profiles} Data Source
  *
  * @param scope The scope in which to define this construct
