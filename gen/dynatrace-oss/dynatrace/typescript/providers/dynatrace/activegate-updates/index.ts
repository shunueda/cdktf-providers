// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/activegate_updates
...
export interface ActivegateUpdatesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/activegate_updates#auto_update ActivegateUpdates#auto_update}
  */
  readonly autoUpdate: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/activegate_updates#id ActivegateUpdates#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/activegate_updates#scope ActivegateUpdates#scope}
  */
  readonly scope?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/activegate_updates dynatrace_activegate_updates}
*/
export class ActivegateUpdates extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ActivegateUpdates that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/activegate_updates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/activegate_updates dynatrace_activegate_updates} Resource
  *
  * @param scope The scope in which to define this construct
