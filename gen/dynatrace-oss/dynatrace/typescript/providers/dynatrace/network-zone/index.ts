// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/network_zone
...
export interface NetworkZoneConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/network_zone#alternative_zones NetworkZone#alternative_zones}
  */
  readonly alternativeZones?: string[];
  /**
  * A short description of the network zone
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/network_zone#description NetworkZone#description}
  */
  readonly description?: string;
  /**
  * The fallback mode of the network zone. Possible values: `ANY_ACTIVE_GATE`, `NONE`, `ONLY_DEFAULT_ZONE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/network_zone#fallback_mode NetworkZone#fallback_mode}
  */
  readonly fallbackMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/network_zone#id NetworkZone#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/network_zone#name NetworkZone#name}
  */
  readonly name?: string;
  /**
  * The number of ActiveGates in the network zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/network_zone#num_of_configured_activegates NetworkZone#num_of_configured_activegates}
  */
  readonly numOfConfiguredActivegates?: number;
  /**
  * The number of OneAgents that are configured to use the network zone as primary.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/network_zone#num_of_configured_oneagents NetworkZone#num_of_configured_oneagents}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/network_zone#num_of_oneagents_from_other_zones NetworkZone#num_of_oneagents_from_other_zones}
  */
  readonly numOfOneagentsFromOtherZones?: number;
  /**
  * The number of OneAgents that are using ActiveGates in the network zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/network_zone#num_of_oneagents_using NetworkZone#num_of_oneagents_using}
  */
  readonly numOfOneagentsUsing?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/network_zone dynatrace_network_zone}
*/
export class NetworkZone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/network_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/network_zone dynatrace_network_zone} Resource
  *
  * @param scope The scope in which to define this construct
