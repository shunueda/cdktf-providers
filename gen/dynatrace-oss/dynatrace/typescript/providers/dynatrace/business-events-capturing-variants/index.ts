// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/business_events_capturing_variants
...
export interface BusinessEventsCapturingVariantsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/business_events_capturing_variants#content_type_matcher BusinessEventsCapturingVariants#content_type_matcher}
  */
  readonly contentTypeMatcher: string;
  /**
  * Content-type match value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/business_events_capturing_variants#content_type_value BusinessEventsCapturingVariants#content_type_value}
  */
  readonly contentTypeValue: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/business_events_capturing_variants#id BusinessEventsCapturingVariants#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/business_events_capturing_variants#insert_after BusinessEventsCapturingVariants#insert_after}
  */
  readonly insertAfter?: string;
  /**
  * Possible Values: `JSON`, `Raw`, `Text`, `URLencoded`, `XML`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/business_events_capturing_variants#parser BusinessEventsCapturingVariants#parser}
  */
  readonly parser: string;
  /**
  * The scope of this setting (HOST, HOST_GROUP). Omit this property if you want to cover the whole environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/business_events_capturing_variants#scope BusinessEventsCapturingVariants#scope}
  */
  readonly scope?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/business_events_capturing_variants dynatrace_business_events_capturing_variants}
*/
export class BusinessEventsCapturingVariants extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BusinessEventsCapturingVariants that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/business_events_capturing_variants#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/business_events_capturing_variants dynatrace_business_events_capturing_variants} Resource
  *
  * @param scope The scope in which to define this construct
