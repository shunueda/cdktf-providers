// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/json_dashboard_base
...
export interface JsonDashboardBaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/json_dashboard_base#contents JsonDashboardBase#contents}
  */
  readonly contents?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/json_dashboard_base#id JsonDashboardBase#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/json_dashboard_base dynatrace_json_dashboard_base}
*/
export class JsonDashboardBase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing JsonDashboardBase that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/json_dashboard_base#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/json_dashboard_base dynatrace_json_dashboard_base} Resource
  *
  * @param scope The scope in which to define this construct
