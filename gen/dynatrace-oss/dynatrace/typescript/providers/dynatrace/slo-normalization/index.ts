// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/slo_normalization
...
export interface SloNormalizationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/slo_normalization#id SloNormalization#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/slo_normalization#normalize SloNormalization#normalize}
  */
  readonly normalize: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/slo_normalization dynatrace_slo_normalization}
*/
export class SloNormalization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SloNormalization that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/slo_normalization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/slo_normalization dynatrace_slo_normalization} Resource
  *
  * @param scope The scope in which to define this construct
