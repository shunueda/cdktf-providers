// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/geolocation
...
export interface GeolocationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/geolocation#display_worldmap Geolocation#display_worldmap}
  */
  readonly displayWorldmap: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/geolocation#id Geolocation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/geolocation#scope Geolocation#scope}
  */
  readonly scope?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/geolocation dynatrace_geolocation}
*/
export class Geolocation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Geolocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/geolocation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/geolocation dynatrace_geolocation} Resource
  *
  * @param scope The scope in which to define this construct
