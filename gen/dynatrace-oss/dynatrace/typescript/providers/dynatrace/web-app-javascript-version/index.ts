// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/web_app_javascript_version
...
export interface WebAppJavascriptVersionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/web_app_javascript_version#custom_javascript_version WebAppJavascriptVersion#custom_javascript_version}
  */
  readonly customJavascriptVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/web_app_javascript_version#id WebAppJavascriptVersion#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/web_app_javascript_version dynatrace_web_app_javascript_version}
*/
export class WebAppJavascriptVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebAppJavascriptVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/web_app_javascript_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/web_app_javascript_version dynatrace_web_app_javascript_version} Resource
  *
  * @param scope The scope in which to define this construct
