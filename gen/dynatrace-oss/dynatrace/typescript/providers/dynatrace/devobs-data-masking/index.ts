// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/devobs_data_masking
...
export interface DevobsDataMaskingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/devobs_data_masking#enabled DevobsDataMasking#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/devobs_data_masking#id DevobsDataMasking#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/devobs_data_masking#insert_after DevobsDataMasking#insert_after}
  */
  readonly insertAfter?: string;
  /**
  * no documentation available
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/devobs_data_masking#replacement_pattern DevobsDataMasking#replacement_pattern}
  */
  readonly replacementPattern?: string;
  /**
  * Possible Values: `SHA256`, `STRING`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/devobs_data_masking#replacement_type DevobsDataMasking#replacement_type}
  */
  readonly replacementType: string;
  /**
  * Rule Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/devobs_data_masking#rule_name DevobsDataMasking#rule_name}
  */
  readonly ruleName: string;
  /**
  * no documentation available
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/devobs_data_masking#rule_regex DevobsDataMasking#rule_regex}
  */
  readonly ruleRegex?: string;
  /**
  * Possible Values: `REGEX`, `VAR_NAME`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/devobs_data_masking#rule_type DevobsDataMasking#rule_type}
  */
  readonly ruleType: string;
  /**
  * no documentation available
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/devobs_data_masking#rule_var_name DevobsDataMasking#rule_var_name}
  */
  readonly ruleVarName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/devobs_data_masking dynatrace_devobs_data_masking}
*/
export class DevobsDataMasking extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DevobsDataMasking that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/devobs_data_masking#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/devobs_data_masking dynatrace_devobs_data_masking} Resource
  *
  * @param scope The scope in which to define this construct
