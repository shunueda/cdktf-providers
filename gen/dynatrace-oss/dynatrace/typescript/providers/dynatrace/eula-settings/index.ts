// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/eula_settings
...
export interface EulaSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/eula_settings#enable_eula EulaSettings#enable_eula}
  */
  readonly enableEula: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/eula_settings#id EulaSettings#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/eula_settings#scope EulaSettings#scope}
  */
  readonly scope?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/eula_settings dynatrace_eula_settings}
*/
export class EulaSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EulaSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/eula_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.1/docs/resources/eula_settings dynatrace_eula_settings} Resource
  *
  * @param scope The scope in which to define this construct
