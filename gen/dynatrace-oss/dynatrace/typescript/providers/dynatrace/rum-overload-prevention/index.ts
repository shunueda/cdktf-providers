// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_overload_prevention
...
export interface RumOverloadPreventionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_overload_prevention#id RumOverloadPrevention#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_overload_prevention#overload_prevention_limit RumOverloadPrevention#overload_prevention_limit}
  */
  readonly overloadPreventionLimit: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_overload_prevention dynatrace_rum_overload_prevention}
*/
export class RumOverloadPrevention extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RumOverloadPrevention that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_overload_prevention#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/rum_overload_prevention dynatrace_rum_overload_prevention} Resource
  *
  * @param scope The scope in which to define this construct
