// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/usability_analytics
...
export interface UsabilityAnalyticsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/usability_analytics#application_id UsabilityAnalytics#application_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/usability_analytics#detect_rage_clicks UsabilityAnalytics#detect_rage_clicks}
  */
  readonly detectRageClicks: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/usability_analytics#id UsabilityAnalytics#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/usability_analytics dynatrace_usability_analytics}
*/
export class UsabilityAnalytics extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UsabilityAnalytics that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/usability_analytics#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/usability_analytics dynatrace_usability_analytics} Resource
  *
  * @param scope The scope in which to define this construct
