// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/data-sources/azure_supported_services
...
export interface DataDynatraceAzureSupportedServicesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/data-sources/azure_supported_services#except DataDynatraceAzureSupportedServices#except}
  */
  readonly except?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/data-sources/azure_supported_services#id DataDynatraceAzureSupportedServices#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/data-sources/azure_supported_services dynatrace_azure_supported_services}
*/
export class DataDynatraceAzureSupportedServices extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDynatraceAzureSupportedServices that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/data-sources/azure_supported_services#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/data-sources/azure_supported_services dynatrace_azure_supported_services} Data Source
  *
  * @param scope The scope in which to define this construct
