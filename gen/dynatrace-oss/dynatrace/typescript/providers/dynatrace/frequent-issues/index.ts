// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/frequent_issues
...
export interface FrequentIssuesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/frequent_issues#detect_apps FrequentIssues#detect_apps}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/frequent_issues#detect_env FrequentIssues#detect_env}
  */
  readonly detectEnv?: boolean | cdktf.IResolvable;
  /**
  * Detect frequent issues within infrastructure, enabled (`true`) or disabled (`false`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/frequent_issues#detect_infra FrequentIssues#detect_infra}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/frequent_issues#detect_txn FrequentIssues#detect_txn}
  */
  readonly detectTxn: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/frequent_issues#id FrequentIssues#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/frequent_issues dynatrace_frequent_issues}
*/
export class FrequentIssues extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FrequentIssues that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/frequent_issues#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/frequent_issues dynatrace_frequent_issues} Resource
  *
  * @param scope The scope in which to define this construct
