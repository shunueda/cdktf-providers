// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_remote_access
...
export interface ManagedRemoteAccessConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_remote_access#id ManagedRemoteAccess#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_remote_access#reason ManagedRemoteAccess#reason}
  */
  readonly reason: string;
  /**
  * For how many days access is requested, cannot be changed once created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_remote_access#requested_days ManagedRemoteAccess#requested_days}
  */
  readonly requestedDays: number;
  /**
  * Requested role, cannot be changed once created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_remote_access#role ManagedRemoteAccess#role}
  */
  readonly role: string;
  /**
  * Access request state. Automatically set as `ACCEPTED` on create, state can be changed in subsequent updates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_remote_access#state ManagedRemoteAccess#state}
  */
  readonly state?: string;
  /**
  * User id, cannot be changed once created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_remote_access#user_id ManagedRemoteAccess#user_id}
  */
  readonly userId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_remote_access dynatrace_managed_remote_access}
*/
export class ManagedRemoteAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedRemoteAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_remote_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.87.1/docs/resources/managed_remote_access dynatrace_managed_remote_access} Resource
  *
  * @param scope The scope in which to define this construct
