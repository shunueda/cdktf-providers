// https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/msteams_connection
...
export interface MsteamsConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  * Optional
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/msteams_connection#channel_name MsteamsConnection#channel_name}
  */
  readonly channelName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/msteams_connection#id MsteamsConnection#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/msteams_connection#name MsteamsConnection#name}
  */
  readonly name: string;
  /**
  * Optional
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/msteams_connection#team_name MsteamsConnection#team_name}
  */
  readonly teamName?: string;
  /**
  * The Webhook URL that links to the channel
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/msteams_connection#webhook MsteamsConnection#webhook}
  */
  readonly webhook: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/msteams_connection dynatrace_msteams_connection}
*/
export class MsteamsConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MsteamsConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/msteams_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dynatrace-oss/dynatrace/1.88.0/docs/resources/msteams_connection dynatrace_msteams_connection} Resource
  *
  * @param scope The scope in which to define this construct
