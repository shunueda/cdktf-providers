...
export class DavisCopilot extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DavisCopilotConfig) {
    ...
    this._enableDocumentSuggestion = config.enableDocumentSuggestion;
  ...
  // enable_document_suggestion - computed: false, optional: true, required: false
  private _enableDocumentSuggestion?: boolean | cdktf.IResolvable; 
  public get enableDocumentSuggestion() {
    return this.getBooleanAttribute('enable_document_suggestion');
  }
  public set enableDocumentSuggestion(value: boolean | cdktf.IResolvable) {
    this._enableDocumentSuggestion = value;
  }
  public resetEnableDocumentSuggestion() {
    this._enableDocumentSuggestion = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get enableDocumentSuggestionInput() {
    return this._enableDocumentSuggestion;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      enable_document_suggestion: cdktf.booleanToTerraform(this._enableDocumentSuggestion),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      enable_document_suggestion: {
        value: cdktf.booleanToHclTerraform(this._enableDocumentSuggestion),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
