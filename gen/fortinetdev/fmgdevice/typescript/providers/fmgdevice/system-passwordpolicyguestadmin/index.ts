// https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin
...
export interface SystemPasswordpolicyguestadminConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#apply_to SystemPasswordpolicyguestadmin#apply_to}
  */
  readonly applyTo?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#change_4_characters SystemPasswordpolicyguestadmin#change_4_characters}
  */
  readonly change4Characters?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#device_name SystemPasswordpolicyguestadmin#device_name}
  */
  readonly deviceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#expire_day SystemPasswordpolicyguestadmin#expire_day}
  */
  readonly expireDay?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#expire_status SystemPasswordpolicyguestadmin#expire_status}
  */
  readonly expireStatus?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#id SystemPasswordpolicyguestadmin#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#min_change_characters SystemPasswordpolicyguestadmin#min_change_characters}
  */
  readonly minChangeCharacters?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#min_lower_case_letter SystemPasswordpolicyguestadmin#min_lower_case_letter}
  */
  readonly minLowerCaseLetter?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#min_non_alphanumeric SystemPasswordpolicyguestadmin#min_non_alphanumeric}
  */
  readonly minNonAlphanumeric?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#min_number SystemPasswordpolicyguestadmin#min_number}
  */
  readonly minNumber?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#min_upper_case_letter SystemPasswordpolicyguestadmin#min_upper_case_letter}
  */
  readonly minUpperCaseLetter?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#minimum_length SystemPasswordpolicyguestadmin#minimum_length}
  */
  readonly minimumLength?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#reuse_password SystemPasswordpolicyguestadmin#reuse_password}
  */
  readonly reusePassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#reuse_password_limit SystemPasswordpolicyguestadmin#reuse_password_limit}
  */
  readonly reusePasswordLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#status SystemPasswordpolicyguestadmin#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin fmgdevice_system_passwordpolicyguestadmin}
*/
export class SystemPasswordpolicyguestadmin extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fmgdevice_system_passwordpolicyguestadmin";
  ...
  * @param importFromId The id of the existing SystemPasswordpolicyguestadmin that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fmgdevice_system_passwordpolicyguestadmin", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicyguestadmin fmgdevice_system_passwordpolicyguestadmin} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SystemPasswordpolicyguestadminConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fmgdevice_system_passwordpolicyguestadmin',
  ...
  // change_4_characters - computed: false, optional: true, required: false
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      apply_to: cdktf.listMapper(cdktf.stringToTerraform, false)(this._applyTo),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      apply_to: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._applyTo),
        isBlock: false,
        type: "set",
