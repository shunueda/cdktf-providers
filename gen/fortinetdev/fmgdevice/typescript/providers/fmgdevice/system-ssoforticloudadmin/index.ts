// https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssoforticloudadmin
...
export interface SystemSsoforticloudadminConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssoforticloudadmin#accprofile SystemSsoforticloudadmin#accprofile}
  */
  readonly accprofile?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssoforticloudadmin#device_name SystemSsoforticloudadmin#device_name}
  */
  readonly deviceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssoforticloudadmin#gui_default_dashboard_template SystemSsoforticloudadmin#gui_default_dashboard_template}
  */
  readonly guiDefaultDashboardTemplate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssoforticloudadmin#gui_ignore_invalid_signature_version SystemSsoforticloudadmin#gui_ignore_invalid_signature_version}
  */
  readonly guiIgnoreInvalidSignatureVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssoforticloudadmin#gui_ignore_release_overview_version SystemSsoforticloudadmin#gui_ignore_release_overview_version}
  */
  readonly guiIgnoreReleaseOverviewVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssoforticloudadmin#id SystemSsoforticloudadmin#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssoforticloudadmin#name SystemSsoforticloudadmin#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssoforticloudadmin#vdom SystemSsoforticloudadmin#vdom}
  */
  readonly vdom?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssoforticloudadmin fmgdevice_system_ssoforticloudadmin}
*/
export class SystemSsoforticloudadmin extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fmgdevice_system_ssoforticloudadmin";
  ...
  * @param importFromId The id of the existing SystemSsoforticloudadmin that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssoforticloudadmin#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fmgdevice_system_ssoforticloudadmin", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssoforticloudadmin fmgdevice_system_ssoforticloudadmin} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SystemSsoforticloudadminConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fmgdevice_system_ssoforticloudadmin',
