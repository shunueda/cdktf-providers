// https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy
...
export interface SystemPasswordpolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#apply_to SystemPasswordpolicy#apply_to}
  */
  readonly applyTo?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#change_4_characters SystemPasswordpolicy#change_4_characters}
  */
  readonly change4Characters?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#device_name SystemPasswordpolicy#device_name}
  */
  readonly deviceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#expire_day SystemPasswordpolicy#expire_day}
  */
  readonly expireDay?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#expire_status SystemPasswordpolicy#expire_status}
  */
  readonly expireStatus?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#id SystemPasswordpolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#login_lockout_upon_downgrade SystemPasswordpolicy#login_lockout_upon_downgrade}
  */
  readonly loginLockoutUponDowngrade?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#min_change_characters SystemPasswordpolicy#min_change_characters}
  */
  readonly minChangeCharacters?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#min_lower_case_letter SystemPasswordpolicy#min_lower_case_letter}
  */
  readonly minLowerCaseLetter?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#min_non_alphanumeric SystemPasswordpolicy#min_non_alphanumeric}
  */
  readonly minNonAlphanumeric?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#min_number SystemPasswordpolicy#min_number}
  */
  readonly minNumber?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#min_upper_case_letter SystemPasswordpolicy#min_upper_case_letter}
  */
  readonly minUpperCaseLetter?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#minimum_length SystemPasswordpolicy#minimum_length}
  */
  readonly minimumLength?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#reuse_password SystemPasswordpolicy#reuse_password}
  */
  readonly reusePassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#reuse_password_limit SystemPasswordpolicy#reuse_password_limit}
  */
  readonly reusePasswordLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#status SystemPasswordpolicy#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy fmgdevice_system_passwordpolicy}
*/
export class SystemPasswordpolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fmgdevice_system_passwordpolicy";
  ...
  * @param importFromId The id of the existing SystemPasswordpolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fmgdevice_system_passwordpolicy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_passwordpolicy fmgdevice_system_passwordpolicy} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SystemPasswordpolicyConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fmgdevice_system_passwordpolicy',
