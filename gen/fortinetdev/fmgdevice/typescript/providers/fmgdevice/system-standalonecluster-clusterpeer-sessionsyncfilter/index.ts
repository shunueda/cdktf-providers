// https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter
...
export interface SystemStandaloneclusterClusterpeerSessionsyncfilterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter#cluster_peer SystemStandaloneclusterClusterpeerSessionsyncfilter#cluster_peer}
  */
  readonly clusterPeer: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter#device_name SystemStandaloneclusterClusterpeerSessionsyncfilter#device_name}
  */
  readonly deviceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter#dstaddr SystemStandaloneclusterClusterpeerSessionsyncfilter#dstaddr}
  */
  readonly dstaddr?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter#dstaddr6 SystemStandaloneclusterClusterpeerSessionsyncfilter#dstaddr6}
  */
  readonly dstaddr6?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter#dstintf SystemStandaloneclusterClusterpeerSessionsyncfilter#dstintf}
  */
  readonly dstintf?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter#dynamic_sort_subtable SystemStandaloneclusterClusterpeerSessionsyncfilter#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter#id SystemStandaloneclusterClusterpeerSessionsyncfilter#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter#srcaddr SystemStandaloneclusterClusterpeerSessionsyncfilter#srcaddr}
  */
  readonly srcaddr?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter#srcaddr6 SystemStandaloneclusterClusterpeerSessionsyncfilter#srcaddr6}
  */
  readonly srcaddr6?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter#srcintf SystemStandaloneclusterClusterpeerSessionsyncfilter#srcintf}
  */
  readonly srcintf?: string[];
  /**
  * custom_service block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter#custom_service SystemStandaloneclusterClusterpeerSessionsyncfilter#custom_service}
  */
...
export interface SystemStandaloneclusterClusterpeerSessionsyncfilterCustomService {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter#dst_port_range SystemStandaloneclusterClusterpeerSessionsyncfilter#dst_port_range}
  */
  ...
  */
  readonly id?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter#src_port_range SystemStandaloneclusterClusterpeerSessionsyncfilter#src_port_range}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter fmgdevice_system_standalonecluster_clusterpeer_sessionsyncfilter}
*/
export class SystemStandaloneclusterClusterpeerSessionsyncfilter extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fmgdevice_system_standalonecluster_clusterpeer_sessionsyncfilter";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a SystemStandaloneclusterClusterpeerSessionsyncfilter resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the SystemStandaloneclusterClusterpeerSessionsyncfilter to import
  * @param importFromId The id of the existing SystemStandaloneclusterClusterpeerSessionsyncfilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SystemStandaloneclusterClusterpeerSessionsyncfilter to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fmgdevice_system_standalonecluster_clusterpeer_sessionsyncfilter", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_standalonecluster_clusterpeer_sessionsyncfilter fmgdevice_system_standalonecluster_clusterpeer_sessionsyncfilter} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options SystemStandaloneclusterClusterpeerSessionsyncfilterConfig
  */
  public constructor(scope: Construct, id: string, config: SystemStandaloneclusterClusterpeerSessionsyncfilterConfig) {
    super(scope, id, {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      custom_service: cdktf.listMapper(systemStandaloneclusterClusterpeerSessionsyncfilterCustomServiceToTerraform, true)(this._customService.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      custom_service: {
        value: cdktf.listMapperHcl(systemStandaloneclusterClusterpeerSessionsyncfilterCustomServiceToHclTerraform, true)(this._customService.internalValue),
        isBlock: true,
        type: "list",
