// https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist
...
export interface WirelesscontrollerHotspot20AnqpnairealmNailistConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist#anqp_nai_realm WirelesscontrollerHotspot20AnqpnairealmNailist#anqp_nai_realm}
  */
  readonly anqpNaiRealm: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist#device_name WirelesscontrollerHotspot20AnqpnairealmNailist#device_name}
  */
  readonly deviceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist#device_vdom WirelesscontrollerHotspot20AnqpnairealmNailist#device_vdom}
  */
  readonly deviceVdom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist#dynamic_sort_subtable WirelesscontrollerHotspot20AnqpnairealmNailist#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist#encoding WirelesscontrollerHotspot20AnqpnairealmNailist#encoding}
  */
  readonly encoding?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist#id WirelesscontrollerHotspot20AnqpnairealmNailist#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist#nai_realm WirelesscontrollerHotspot20AnqpnairealmNailist#nai_realm}
  */
  readonly naiRealm?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist#name WirelesscontrollerHotspot20AnqpnairealmNailist#name}
  */
  readonly name?: string;
  /**
  * eap_method block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist#eap_method WirelesscontrollerHotspot20AnqpnairealmNailist#eap_method}
  */
...
export interface WirelesscontrollerHotspot20AnqpnairealmNailistEapMethodAuthParam {
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist#index WirelesscontrollerHotspot20AnqpnairealmNailist#index}
  */
  readonly index?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist#val WirelesscontrollerHotspot20AnqpnairealmNailist#val}
  */
  readonly val?: string;
}
...
export interface WirelesscontrollerHotspot20AnqpnairealmNailistEapMethod {
  ...
  */
  readonly index?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist#method WirelesscontrollerHotspot20AnqpnairealmNailist#method}
  */
  readonly method?: string;
  /**
  * auth_param block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist#auth_param WirelesscontrollerHotspot20AnqpnairealmNailist#auth_param}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist fmgdevice_wirelesscontroller_hotspot20_anqpnairealm_nailist}
*/
export class WirelesscontrollerHotspot20AnqpnairealmNailist extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fmgdevice_wirelesscontroller_hotspot20_anqpnairealm_nailist";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a WirelesscontrollerHotspot20AnqpnairealmNailist resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the WirelesscontrollerHotspot20AnqpnairealmNailist to import
  * @param importFromId The id of the existing WirelesscontrollerHotspot20AnqpnairealmNailist that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the WirelesscontrollerHotspot20AnqpnairealmNailist to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fmgdevice_wirelesscontroller_hotspot20_anqpnairealm_nailist", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_hotspot20_anqpnairealm_nailist fmgdevice_wirelesscontroller_hotspot20_anqpnairealm_nailist} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options WirelesscontrollerHotspot20AnqpnairealmNailistConfig
  */
  public constructor(scope: Construct, id: string, config: WirelesscontrollerHotspot20AnqpnairealmNailistConfig) {
    super(scope, id, {
      terraformResourceType: 'fmgdevice_wirelesscontroller_hotspot20_anqpnairealm_nailist',
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      eap_method: cdktf.listMapper(wirelesscontrollerHotspot20AnqpnairealmNailistEapMethodToTerraform, true)(this._eapMethod.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      eap_method: {
        value: cdktf.listMapperHcl(wirelesscontrollerHotspot20AnqpnairealmNailistEapMethodToHclTerraform, true)(this._eapMethod.internalValue),
        isBlock: true,
        type: "list",
