// https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssofortigatecloudadmin
...
export interface SystemSsofortigatecloudadminConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssofortigatecloudadmin#accprofile SystemSsofortigatecloudadmin#accprofile}
  */
  readonly accprofile?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssofortigatecloudadmin#device_name SystemSsofortigatecloudadmin#device_name}
  */
  readonly deviceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssofortigatecloudadmin#gui_default_dashboard_template SystemSsofortigatecloudadmin#gui_default_dashboard_template}
  */
  readonly guiDefaultDashboardTemplate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssofortigatecloudadmin#gui_ignore_invalid_signature_version SystemSsofortigatecloudadmin#gui_ignore_invalid_signature_version}
  */
  readonly guiIgnoreInvalidSignatureVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssofortigatecloudadmin#gui_ignore_release_overview_version SystemSsofortigatecloudadmin#gui_ignore_release_overview_version}
  */
  readonly guiIgnoreReleaseOverviewVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssofortigatecloudadmin#id SystemSsofortigatecloudadmin#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssofortigatecloudadmin#name SystemSsofortigatecloudadmin#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssofortigatecloudadmin#vdom SystemSsofortigatecloudadmin#vdom}
  */
  readonly vdom?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssofortigatecloudadmin fmgdevice_system_ssofortigatecloudadmin}
*/
export class SystemSsofortigatecloudadmin extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fmgdevice_system_ssofortigatecloudadmin";
  ...
  * @param importFromId The id of the existing SystemSsofortigatecloudadmin that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssofortigatecloudadmin#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fmgdevice_system_ssofortigatecloudadmin", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_ssofortigatecloudadmin fmgdevice_system_ssofortigatecloudadmin} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SystemSsofortigatecloudadminConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fmgdevice_system_ssofortigatecloudadmin',
