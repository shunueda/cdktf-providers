// https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice
...
export interface ZtnaTrafficforwardproxyreverseserviceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice#device_name ZtnaTrafficforwardproxyreverseservice#device_name}
  */
  readonly deviceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice#device_vdom ZtnaTrafficforwardproxyreverseservice#device_vdom}
  */
  readonly deviceVdom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice#dynamic_sort_subtable ZtnaTrafficforwardproxyreverseservice#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice#id ZtnaTrafficforwardproxyreverseservice#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice#remote_servers ZtnaTrafficforwardproxyreverseservice#remote_servers}
  */
...
export interface ZtnaTrafficforwardproxyreverseserviceRemoteServers {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice#address ZtnaTrafficforwardproxyreverseservice#address}
  */
  readonly address?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice#certificate ZtnaTrafficforwardproxyreverseservice#certificate}
  */
  readonly certificate?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice#health_check_interval ZtnaTrafficforwardproxyreverseservice#health_check_interval}
  */
  readonly healthCheckInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice#name ZtnaTrafficforwardproxyreverseservice#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice#port ZtnaTrafficforwardproxyreverseservice#port}
  */
  readonly port?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice#ssl_max_version ZtnaTrafficforwardproxyreverseservice#ssl_max_version}
  */
  readonly sslMaxVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice#status ZtnaTrafficforwardproxyreverseservice#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice#trusted_server_ca ZtnaTrafficforwardproxyreverseservice#trusted_server_ca}
  */
...
export function ztnaTrafficforwardproxyreverseserviceRemoteServersToTerraform(struct?: ZtnaTrafficforwardproxyreverseserviceRemoteServers | cdktf.IResolvable): any {
  ...
  return {
    ...
    trusted_server_ca: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.trustedServerCa),
  }
}
...
export function ztnaTrafficforwardproxyreverseserviceRemoteServersToHclTerraform(struct?: ZtnaTrafficforwardproxyreverseserviceRemoteServers | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    trusted_server_ca: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.trustedServerCa),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice fmgdevice_ztna_trafficforwardproxyreverseservice}
*/
export class ZtnaTrafficforwardproxyreverseservice extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fmgdevice_ztna_trafficforwardproxyreverseservice";
  ...
  * @param importFromId The id of the existing ZtnaTrafficforwardproxyreverseservice that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fmgdevice_ztna_trafficforwardproxyreverseservice", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ztna_trafficforwardproxyreverseservice fmgdevice_ztna_trafficforwardproxyreverseservice} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ZtnaTrafficforwardproxyreverseserviceConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fmgdevice_ztna_trafficforwardproxyreverseservice',
