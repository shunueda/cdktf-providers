// https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade
...
export interface SystemDeviceupgradeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#device_name SystemDeviceupgrade#device_name}
  */
  readonly deviceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#device_type SystemDeviceupgrade#device_type}
  */
  readonly deviceType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#dynamic_sort_subtable SystemDeviceupgrade#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#failure_reason SystemDeviceupgrade#failure_reason}
  */
  readonly failureReason?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#ha_reboot_controller SystemDeviceupgrade#ha_reboot_controller}
  */
  readonly haRebootController?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#id SystemDeviceupgrade#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#ignore_signing_errors SystemDeviceupgrade#ignore_signing_errors}
  */
  readonly ignoreSigningErrors?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#initial_version SystemDeviceupgrade#initial_version}
  */
  readonly initialVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#maximum_minutes SystemDeviceupgrade#maximum_minutes}
  */
  readonly maximumMinutes?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#next_path_index SystemDeviceupgrade#next_path_index}
  */
  readonly nextPathIndex?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#serial SystemDeviceupgrade#serial}
  */
  readonly serial?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#setup_time SystemDeviceupgrade#setup_time}
  */
  readonly setupTime?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#starter_admin SystemDeviceupgrade#starter_admin}
  */
  readonly starterAdmin?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#status SystemDeviceupgrade#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#time SystemDeviceupgrade#time}
  */
  readonly time?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#timing SystemDeviceupgrade#timing}
  */
  readonly timing?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#upgrade_path SystemDeviceupgrade#upgrade_path}
  */
  readonly upgradePath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#vdom SystemDeviceupgrade#vdom}
  */
  readonly vdom?: string[];
  /**
  * known_ha_members block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#known_ha_members SystemDeviceupgrade#known_ha_members}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade fmgdevice_system_deviceupgrade}
*/
export class SystemDeviceupgrade extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fmgdevice_system_deviceupgrade";
  ...
  * @param importFromId The id of the existing SystemDeviceupgrade that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fmgdevice_system_deviceupgrade", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_deviceupgrade fmgdevice_system_deviceupgrade} Resource
  *
  * @param scope The scope in which to define this construct
