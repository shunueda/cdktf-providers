// https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller
...
export interface WirelesscontrollerIntercontrollerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller#device_name WirelesscontrollerIntercontroller#device_name}
  */
  readonly deviceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller#dynamic_sort_subtable WirelesscontrollerIntercontroller#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller#fast_failover_max WirelesscontrollerIntercontroller#fast_failover_max}
  */
  readonly fastFailoverMax?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller#fast_failover_wait WirelesscontrollerIntercontroller#fast_failover_wait}
  */
  readonly fastFailoverWait?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller#id WirelesscontrollerIntercontroller#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller#inter_controller_key WirelesscontrollerIntercontroller#inter_controller_key}
  */
  readonly interControllerKey?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller#inter_controller_mode WirelesscontrollerIntercontroller#inter_controller_mode}
  */
  readonly interControllerMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller#inter_controller_pri WirelesscontrollerIntercontroller#inter_controller_pri}
  */
  readonly interControllerPri?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller#l3_roaming WirelesscontrollerIntercontroller#l3_roaming}
  */
  readonly l3Roaming?: string;
  /**
  * inter_controller_peer block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller#inter_controller_peer WirelesscontrollerIntercontroller#inter_controller_peer}
  */
...
export interface WirelesscontrollerIntercontrollerInterControllerPeer {
  ...
  */
  readonly id?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller#peer_ip WirelesscontrollerIntercontroller#peer_ip}
  */
  readonly peerIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller#peer_port WirelesscontrollerIntercontroller#peer_port}
  */
  readonly peerPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller#peer_priority WirelesscontrollerIntercontroller#peer_priority}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller fmgdevice_wirelesscontroller_intercontroller}
*/
export class WirelesscontrollerIntercontroller extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fmgdevice_wirelesscontroller_intercontroller";
  ...
  * @param importFromId The id of the existing WirelesscontrollerIntercontroller that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fmgdevice_wirelesscontroller_intercontroller", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/wirelesscontroller_intercontroller fmgdevice_wirelesscontroller_intercontroller} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: WirelesscontrollerIntercontrollerConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fmgdevice_wirelesscontroller_intercontroller',
  ...
  // inter_controller_key - computed: true, optional: true, required: false
  private _interControllerKey?: string[]; 
  public get interControllerKey() {
    return cdktf.Fn.tolist(this.getListAttribute('inter_controller_key'));
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      inter_controller_key: cdktf.listMapper(cdktf.stringToTerraform, false)(this._interControllerKey),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      inter_controller_key: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._interControllerKey),
        isBlock: false,
        type: "set",
