// https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade
...
export interface SystemFederatedupgradeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#device_name SystemFederatedupgrade#device_name}
  */
  readonly deviceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#dry_run SystemFederatedupgrade#dry_run}
  */
  readonly dryRun?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#dynamic_sort_subtable SystemFederatedupgrade#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#failure_device SystemFederatedupgrade#failure_device}
  */
  readonly failureDevice?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#failure_reason SystemFederatedupgrade#failure_reason}
  */
  readonly failureReason?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#ha_reboot_controller SystemFederatedupgrade#ha_reboot_controller}
  */
  readonly haRebootController?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#id SystemFederatedupgrade#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#ignore_signing_errors SystemFederatedupgrade#ignore_signing_errors}
  */
  readonly ignoreSigningErrors?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#initial_version SystemFederatedupgrade#initial_version}
  */
  readonly initialVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#next_path_index SystemFederatedupgrade#next_path_index}
  */
  readonly nextPathIndex?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#source SystemFederatedupgrade#source}
  */
  readonly source?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#starter_admin SystemFederatedupgrade#starter_admin}
  */
  readonly starterAdmin?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#status SystemFederatedupgrade#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#upgrade_id SystemFederatedupgrade#upgrade_id}
  */
  readonly upgradeId?: number;
  /**
  * known_ha_members block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#known_ha_members SystemFederatedupgrade#known_ha_members}
  */
  readonly knownHaMembers?: SystemFederatedupgradeKnownHaMembers[] | cdktf.IResolvable;
  /**
  * node_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#node_list SystemFederatedupgrade#node_list}
  */
...
export interface SystemFederatedupgradeKnownHaMembers {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#serial SystemFederatedupgrade#serial}
  */
...
export interface SystemFederatedupgradeNodeListStruct {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#coordinating_fortigate SystemFederatedupgrade#coordinating_fortigate}
  */
  readonly coordinatingFortigate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#device_type SystemFederatedupgrade#device_type}
  */
  readonly deviceType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#maximum_minutes SystemFederatedupgrade#maximum_minutes}
  */
  ...
  */
  readonly serial?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#setup_time SystemFederatedupgrade#setup_time}
  */
  readonly setupTime?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#time SystemFederatedupgrade#time}
  */
  readonly time?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#timing SystemFederatedupgrade#timing}
  */
  readonly timing?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#upgrade_path SystemFederatedupgrade#upgrade_path}
  */
...
export function systemFederatedupgradeNodeListStructToTerraform(struct?: SystemFederatedupgradeNodeListStruct | cdktf.IResolvable): any {
  ...
  return {
    ...
    serial: cdktf.stringToTerraform(struct!.serial),
    setup_time: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.setupTime),
...
export function systemFederatedupgradeNodeListStructToHclTerraform(struct?: SystemFederatedupgradeNodeListStruct | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    setup_time: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.setupTime),
      isBlock: false,
      type: "set",
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade fmgdevice_system_federatedupgrade}
*/
export class SystemFederatedupgrade extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fmgdevice_system_federatedupgrade";
  ...
  * @param importFromId The id of the existing SystemFederatedupgrade that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fmgdevice_system_federatedupgrade", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_federatedupgrade fmgdevice_system_federatedupgrade} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SystemFederatedupgradeConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fmgdevice_system_federatedupgrade',
