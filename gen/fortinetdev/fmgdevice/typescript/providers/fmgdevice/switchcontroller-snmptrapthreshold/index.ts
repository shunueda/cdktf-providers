// https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/switchcontroller_snmptrapthreshold
...
export interface SwitchcontrollerSnmptrapthresholdConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/switchcontroller_snmptrapthreshold#device_name SwitchcontrollerSnmptrapthreshold#device_name}
  */
  readonly deviceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/switchcontroller_snmptrapthreshold#device_vdom SwitchcontrollerSnmptrapthreshold#device_vdom}
  */
  readonly deviceVdom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/switchcontroller_snmptrapthreshold#id SwitchcontrollerSnmptrapthreshold#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/switchcontroller_snmptrapthreshold#trap_high_cpu_threshold SwitchcontrollerSnmptrapthreshold#trap_high_cpu_threshold}
  */
  readonly trapHighCpuThreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/switchcontroller_snmptrapthreshold#trap_log_full_threshold SwitchcontrollerSnmptrapthreshold#trap_log_full_threshold}
  */
  readonly trapLogFullThreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/switchcontroller_snmptrapthreshold#trap_low_memory_threshold SwitchcontrollerSnmptrapthreshold#trap_low_memory_threshold}
  */
  readonly trapLowMemoryThreshold?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/switchcontroller_snmptrapthreshold fmgdevice_switchcontroller_snmptrapthreshold}
*/
export class SwitchcontrollerSnmptrapthreshold extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fmgdevice_switchcontroller_snmptrapthreshold";
  ...
  * @param importFromId The id of the existing SwitchcontrollerSnmptrapthreshold that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/switchcontroller_snmptrapthreshold#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fmgdevice_switchcontroller_snmptrapthreshold", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/switchcontroller_snmptrapthreshold fmgdevice_switchcontroller_snmptrapthreshold} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SwitchcontrollerSnmptrapthresholdConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fmgdevice_switchcontroller_snmptrapthreshold',
