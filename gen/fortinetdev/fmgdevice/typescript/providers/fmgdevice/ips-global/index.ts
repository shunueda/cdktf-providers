// https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global
...
export interface IpsGlobalConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#anomaly_mode IpsGlobal#anomaly_mode}
  */
  readonly anomalyMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#av_mem_limit IpsGlobal#av_mem_limit}
  */
  readonly avMemLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#cp_accel_mode IpsGlobal#cp_accel_mode}
  */
  readonly cpAccelMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#database IpsGlobal#database}
  */
  readonly database?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#deep_app_insp_db_limit IpsGlobal#deep_app_insp_db_limit}
  */
  readonly deepAppInspDbLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#deep_app_insp_timeout IpsGlobal#deep_app_insp_timeout}
  */
  readonly deepAppInspTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#device_name IpsGlobal#device_name}
  */
  readonly deviceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#engine_count IpsGlobal#engine_count}
  */
  readonly engineCount?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#exclude_signatures IpsGlobal#exclude_signatures}
  */
  readonly excludeSignatures?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#fail_open IpsGlobal#fail_open}
  */
  readonly failOpen?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#id IpsGlobal#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#intelligent_mode IpsGlobal#intelligent_mode}
  */
  readonly intelligentMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#ips_reserve_cpu IpsGlobal#ips_reserve_cpu}
  */
  readonly ipsReserveCpu?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#ngfw_max_scan_range IpsGlobal#ngfw_max_scan_range}
  */
  readonly ngfwMaxScanRange?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#np_accel_mode IpsGlobal#np_accel_mode}
  */
  readonly npAccelMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#packet_log_queue_depth IpsGlobal#packet_log_queue_depth}
  */
  readonly packetLogQueueDepth?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#session_limit_mode IpsGlobal#session_limit_mode}
  */
  readonly sessionLimitMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#skype_client_public_ipaddr IpsGlobal#skype_client_public_ipaddr}
  */
  readonly skypeClientPublicIpaddr?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#socket_size IpsGlobal#socket_size}
  */
  readonly socketSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#sync_session_ttl IpsGlobal#sync_session_ttl}
  */
  readonly syncSessionTtl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#traffic_submit IpsGlobal#traffic_submit}
  */
  readonly trafficSubmit?: string;
  /**
  * tls_active_probe block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#tls_active_probe IpsGlobal#tls_active_probe}
  */
  readonly tlsActiveProbe?: IpsGlobalTlsActiveProbe;
}
export interface IpsGlobalTlsActiveProbe {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#interface IpsGlobal#interface}
  */
  readonly interface?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#interface_select_method IpsGlobal#interface_select_method}
  */
  readonly interfaceSelectMethod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#source_ip IpsGlobal#source_ip}
  */
  readonly sourceIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#source_ip6 IpsGlobal#source_ip6}
  */
  readonly sourceIp6?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#vdom IpsGlobal#vdom}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global fmgdevice_ips_global}
*/
export class IpsGlobal extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fmgdevice_ips_global";
  ...
  * @param importFromId The id of the existing IpsGlobal that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IpsGlobal to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fmgdevice_ips_global", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/ips_global fmgdevice_ips_global} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // anomaly_mode - computed: false, optional: true, required: false
  ...
  // cp_accel_mode - computed: false, optional: true, required: false
  ...
  // ips_reserve_cpu - computed: false, optional: true, required: false
  ...
  // np_accel_mode - computed: false, optional: true, required: false
