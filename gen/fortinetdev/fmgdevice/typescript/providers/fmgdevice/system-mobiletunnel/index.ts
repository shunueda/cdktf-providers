// https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel
...
export interface SystemMobiletunnelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#device_name SystemMobiletunnel#device_name}
  */
  readonly deviceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#device_vdom SystemMobiletunnel#device_vdom}
  */
  readonly deviceVdom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#dynamic_sort_subtable SystemMobiletunnel#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#hash_algorithm SystemMobiletunnel#hash_algorithm}
  */
  readonly hashAlgorithm?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#home_address SystemMobiletunnel#home_address}
  */
  readonly homeAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#home_agent SystemMobiletunnel#home_agent}
  */
  readonly homeAgent?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#id SystemMobiletunnel#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#lifetime SystemMobiletunnel#lifetime}
  */
  readonly lifetime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#n_mhae_key SystemMobiletunnel#n_mhae_key}
  */
  readonly nMhaeKey?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#n_mhae_key_type SystemMobiletunnel#n_mhae_key_type}
  */
  readonly nMhaeKeyType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#n_mhae_spi SystemMobiletunnel#n_mhae_spi}
  */
  readonly nMhaeSpi?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#name SystemMobiletunnel#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#reg_interval SystemMobiletunnel#reg_interval}
  */
  readonly regInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#reg_retry SystemMobiletunnel#reg_retry}
  */
  readonly regRetry?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#renew_interval SystemMobiletunnel#renew_interval}
  */
  readonly renewInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#roaming_interface SystemMobiletunnel#roaming_interface}
  */
  readonly roamingInterface?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#status SystemMobiletunnel#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#tunnel_mode SystemMobiletunnel#tunnel_mode}
  */
  readonly tunnelMode?: string;
  /**
  * network block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#network SystemMobiletunnel#network}
  */
...
export interface SystemMobiletunnelNetwork {
  ...
  */
  readonly id?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#interface SystemMobiletunnel#interface}
  */
  readonly interface?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#prefix SystemMobiletunnel#prefix}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel fmgdevice_system_mobiletunnel}
*/
export class SystemMobiletunnel extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fmgdevice_system_mobiletunnel";
  ...
  * @param importFromId The id of the existing SystemMobiletunnel that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SystemMobiletunnel to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fmgdevice_system_mobiletunnel", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/system_mobiletunnel fmgdevice_system_mobiletunnel} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SystemMobiletunnelConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fmgdevice_system_mobiletunnel',
  ...
  // home_agent - computed: true, optional: true, required: false
  ...
  public resetHomeAgent() {
    this._homeAgent = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  // n_mhae_key - computed: true, optional: true, required: false
  private _nMhaeKey?: string[]; 
  public get nMhaeKey() {
    return cdktf.Fn.tolist(this.getListAttribute('n_mhae_key'));
  }
  ...
  // n_mhae_key_type - computed: true, optional: true, required: false
  ...
  public resetNMhaeKeyType() {
    this._nMhaeKeyType = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  // n_mhae_spi - computed: true, optional: true, required: false
  ...
  public resetNMhaeSpi() {
    this._nMhaeSpi = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  // reg_interval - computed: true, optional: true, required: false
  ...
  public resetRegInterval() {
    this._regInterval = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  // reg_retry - computed: true, optional: true, required: false
  ...
  public resetRegRetry() {
    this._regRetry = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  // renew_interval - computed: true, optional: true, required: false
  ...
  // roaming_interface - computed: true, optional: true, required: false
  private _roamingInterface?: string[]; 
  public get roamingInterface() {
    return cdktf.Fn.tolist(this.getListAttribute('roaming_interface'));
  }
  public set roamingInterface(value: string[]) {
    this._roamingInterface = value;
  }
  public resetRoamingInterface() {
    this._roamingInterface = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      n_mhae_key: cdktf.listMapper(cdktf.stringToTerraform, false)(this._nMhaeKey),
      ...
      roaming_interface: cdktf.listMapper(cdktf.stringToTerraform, false)(this._roamingInterface),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      n_mhae_key: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._nMhaeKey),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      ...
      roaming_interface: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._roamingInterface),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
