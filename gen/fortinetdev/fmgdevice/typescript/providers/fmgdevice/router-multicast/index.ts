// https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast
...
export interface RouterMulticastConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#device_name RouterMulticast#device_name}
  */
  readonly deviceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#device_vdom RouterMulticast#device_vdom}
  */
  readonly deviceVdom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#dynamic_sort_subtable RouterMulticast#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#id RouterMulticast#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#multicast_routing RouterMulticast#multicast_routing}
  */
  readonly multicastRouting?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#route_limit RouterMulticast#route_limit}
  */
  readonly routeLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#route_threshold RouterMulticast#route_threshold}
  */
  readonly routeThreshold?: number;
  /**
  * interface block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#interface RouterMulticast#interface}
  */
  readonly interface?: RouterMulticastInterface[] | cdktf.IResolvable;
  /**
  * pim_sm_global block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#pim_sm_global RouterMulticast#pim_sm_global}
  */
  readonly pimSmGlobal?: RouterMulticastPimSmGlobal;
  /**
  * pim_sm_global_vrf block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#pim_sm_global_vrf RouterMulticast#pim_sm_global_vrf}
  */
  readonly pimSmGlobalVrf?: RouterMulticastPimSmGlobalVrf[] | cdktf.IResolvable;
}
export interface RouterMulticastInterfaceIgmp {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#access_group RouterMulticast#access_group}
  */
  readonly accessGroup?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#immediate_leave_group RouterMulticast#immediate_leave_group}
  */
  readonly immediateLeaveGroup?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#last_member_query_count RouterMulticast#last_member_query_count}
  */
  readonly lastMemberQueryCount?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#last_member_query_interval RouterMulticast#last_member_query_interval}
  */
  readonly lastMemberQueryInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#query_interval RouterMulticast#query_interval}
  */
  readonly queryInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#query_max_response_time RouterMulticast#query_max_response_time}
  */
  readonly queryMaxResponseTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#query_timeout RouterMulticast#query_timeout}
  */
  readonly queryTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#router_alert_check RouterMulticast#router_alert_check}
  */
  readonly routerAlertCheck?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#version RouterMulticast#version}
  */
...
export interface RouterMulticastInterfaceJoinGroup {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#address RouterMulticast#address}
  */
...
export interface RouterMulticastInterface {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#bfd RouterMulticast#bfd}
  */
  readonly bfd?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#cisco_exclude_genid RouterMulticast#cisco_exclude_genid}
  */
  readonly ciscoExcludeGenid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#dr_priority RouterMulticast#dr_priority}
  */
  readonly drPriority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#hello_holdtime RouterMulticast#hello_holdtime}
  */
  readonly helloHoldtime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#hello_interval RouterMulticast#hello_interval}
  */
  readonly helloInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#multicast_flow RouterMulticast#multicast_flow}
  */
  readonly multicastFlow?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#name RouterMulticast#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#neighbour_filter RouterMulticast#neighbour_filter}
  */
  readonly neighbourFilter?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#passive RouterMulticast#passive}
  */
  readonly passive?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#pim_mode RouterMulticast#pim_mode}
  */
  readonly pimMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#propagation_delay RouterMulticast#propagation_delay}
  */
  readonly propagationDelay?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#rp_candidate RouterMulticast#rp_candidate}
  */
  readonly rpCandidate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#rp_candidate_group RouterMulticast#rp_candidate_group}
  */
  readonly rpCandidateGroup?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#rp_candidate_interval RouterMulticast#rp_candidate_interval}
  */
  readonly rpCandidateInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#rp_candidate_priority RouterMulticast#rp_candidate_priority}
  */
  readonly rpCandidatePriority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#rpf_nbr_fail_back RouterMulticast#rpf_nbr_fail_back}
  */
  readonly rpfNbrFailBack?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#rpf_nbr_fail_back_filter RouterMulticast#rpf_nbr_fail_back_filter}
  */
  readonly rpfNbrFailBackFilter?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#state_refresh_interval RouterMulticast#state_refresh_interval}
  */
  readonly stateRefreshInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#static_group RouterMulticast#static_group}
  */
  readonly staticGroup?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#ttl_threshold RouterMulticast#ttl_threshold}
  */
  readonly ttlThreshold?: number;
  /**
  * igmp block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#igmp RouterMulticast#igmp}
  */
  readonly igmp?: RouterMulticastInterfaceIgmp;
  /**
  * join_group block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#join_group RouterMulticast#join_group}
  */
...
export function routerMulticastInterfaceToTerraform(struct?: RouterMulticastInterface | cdktf.IResolvable): any {
  ...
  return {
    ...
    multicast_flow: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.multicastFlow),
    name: cdktf.stringToTerraform(struct!.name),
    neighbour_filter: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.neighbourFilter),
    ...
    rp_candidate_group: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.rpCandidateGroup),
    ...
    rpf_nbr_fail_back_filter: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.rpfNbrFailBackFilter),
    state_refresh_interval: cdktf.numberToTerraform(struct!.stateRefreshInterval),
    static_group: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.staticGroup),
...
export function routerMulticastInterfaceToHclTerraform(struct?: RouterMulticastInterface | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    multicast_flow: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.multicastFlow),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
    ...
    neighbour_filter: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.neighbourFilter),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
    ...
    rp_candidate_group: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.rpCandidateGroup),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
    ...
    rpf_nbr_fail_back_filter: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.rpfNbrFailBackFilter),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
    ...
    static_group: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.staticGroup),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
...
export interface RouterMulticastPimSmGlobalRpAddress {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#group RouterMulticast#group}
  */
  ...
  */
  readonly id?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#ip_address RouterMulticast#ip_address}
  */
...
export interface RouterMulticastPimSmGlobal {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#accept_register_list RouterMulticast#accept_register_list}
  */
  readonly acceptRegisterList?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#accept_source_list RouterMulticast#accept_source_list}
  */
  readonly acceptSourceList?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#bsr_allow_quick_refresh RouterMulticast#bsr_allow_quick_refresh}
  */
  readonly bsrAllowQuickRefresh?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#bsr_candidate RouterMulticast#bsr_candidate}
  */
  readonly bsrCandidate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#bsr_hash RouterMulticast#bsr_hash}
  */
  readonly bsrHash?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#bsr_interface RouterMulticast#bsr_interface}
  */
  readonly bsrInterface?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#bsr_priority RouterMulticast#bsr_priority}
  */
  readonly bsrPriority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#cisco_crp_prefix RouterMulticast#cisco_crp_prefix}
  */
  readonly ciscoCrpPrefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#cisco_ignore_rp_set_priority RouterMulticast#cisco_ignore_rp_set_priority}
  */
  readonly ciscoIgnoreRpSetPriority?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#cisco_register_checksum RouterMulticast#cisco_register_checksum}
  */
  readonly ciscoRegisterChecksum?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#cisco_register_checksum_group RouterMulticast#cisco_register_checksum_group}
  */
  readonly ciscoRegisterChecksumGroup?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#join_prune_holdtime RouterMulticast#join_prune_holdtime}
  */
  readonly joinPruneHoldtime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#message_interval RouterMulticast#message_interval}
  */
  readonly messageInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#null_register_retries RouterMulticast#null_register_retries}
  */
  readonly nullRegisterRetries?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#pim_use_sdwan RouterMulticast#pim_use_sdwan}
  */
  readonly pimUseSdwan?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#register_rate_limit RouterMulticast#register_rate_limit}
  */
  readonly registerRateLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#register_rp_reachability RouterMulticast#register_rp_reachability}
  */
  readonly registerRpReachability?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#register_source RouterMulticast#register_source}
  */
  readonly registerSource?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#register_source_interface RouterMulticast#register_source_interface}
  */
  readonly registerSourceInterface?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#register_source_ip RouterMulticast#register_source_ip}
  */
  readonly registerSourceIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#register_supression RouterMulticast#register_supression}
  */
  readonly registerSupression?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#rp_register_keepalive RouterMulticast#rp_register_keepalive}
  */
  readonly rpRegisterKeepalive?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#spt_threshold RouterMulticast#spt_threshold}
  */
  readonly sptThreshold?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#spt_threshold_group RouterMulticast#spt_threshold_group}
  */
  readonly sptThresholdGroup?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#ssm RouterMulticast#ssm}
  */
  readonly ssm?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#ssm_range RouterMulticast#ssm_range}
  */
  readonly ssmRange?: string[];
  /**
  * rp_address block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#rp_address RouterMulticast#rp_address}
  */
...
export function routerMulticastPimSmGlobalToTerraform(struct?: RouterMulticastPimSmGlobalOutputReference | RouterMulticastPimSmGlobal): any {
  ...
  return {
    accept_register_list: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.acceptRegisterList),
    accept_source_list: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.acceptSourceList),
    ...
    bsr_interface: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.bsrInterface),
    ...
    cisco_register_checksum_group: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.ciscoRegisterChecksumGroup),
    ...
    register_source_interface: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.registerSourceInterface),
    ...
    spt_threshold_group: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.sptThresholdGroup),
    ssm: cdktf.stringToTerraform(struct!.ssm),
    ssm_range: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.ssmRange),
...
export function routerMulticastPimSmGlobalToHclTerraform(struct?: RouterMulticastPimSmGlobalOutputReference | RouterMulticastPimSmGlobal): any {
  ...
  const attrs = {
    accept_register_list: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.acceptRegisterList),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
    accept_source_list: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.acceptSourceList),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
    ...
    bsr_interface: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.bsrInterface),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
    ...
    cisco_register_checksum_group: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.ciscoRegisterChecksumGroup),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
    ...
    register_source_interface: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.registerSourceInterface),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
    ...
    spt_threshold_group: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.sptThresholdGroup),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
    ...
    ssm_range: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.ssmRange),
      isBlock: false,
      type: "set",
      storageClassType: "stringList",
    },
...
export interface RouterMulticastPimSmGlobalVrf {
  ...
  */
  readonly ciscoCrpPrefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#vrf RouterMulticast#vrf}
  */
  readonly vrf?: number;
  /**
  * rp_address block
...
export class RouterMulticastPimSmGlobalVrfOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // bsr_allow_quick_refresh - computed: false, optional: true, required: false
  private _bsrAllowQuickRefresh?: string; 
  public get bsrAllowQuickRefresh() {
    return this.getStringAttribute('bsr_allow_quick_refresh');
  }
  ...
  // cisco_crp_prefix - computed: false, optional: true, required: false
  private _ciscoCrpPrefix?: string; 
  public get ciscoCrpPrefix() {
    return this.getStringAttribute('cisco_crp_prefix');
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast fmgdevice_router_multicast}
*/
export class RouterMulticast extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fmgdevice_router_multicast";
  ...
  * @param importFromId The id of the existing RouterMulticast that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the RouterMulticast to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fmgdevice_router_multicast", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fmgdevice/1.2.1/docs/resources/router_multicast fmgdevice_router_multicast} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // route_threshold - computed: true, optional: true, required: false
