// https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/system_fortimanager
...
export interface SystemFortimanagerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/system_fortimanager#central_mgmt_auto_backup SystemFortimanager#central_mgmt_auto_backup}
  */
  readonly centralMgmtAutoBackup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/system_fortimanager#central_mgmt_schedule_config_restore SystemFortimanager#central_mgmt_schedule_config_restore}
  */
  readonly centralMgmtScheduleConfigRestore?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/system_fortimanager#central_mgmt_schedule_script_restore SystemFortimanager#central_mgmt_schedule_script_restore}
  */
  readonly centralMgmtScheduleScriptRestore?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/system_fortimanager#id SystemFortimanager#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/system_fortimanager#ip SystemFortimanager#ip}
  */
  readonly ip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/system_fortimanager#ipsec SystemFortimanager#ipsec}
  */
  readonly ipsec?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/system_fortimanager fortiswitch_system_fortimanager}
*/
export class SystemFortimanager extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemFortimanager that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/system_fortimanager#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/system_fortimanager fortiswitch_system_fortimanager} Resource
  *
  * @param scope The scope in which to define this construct
