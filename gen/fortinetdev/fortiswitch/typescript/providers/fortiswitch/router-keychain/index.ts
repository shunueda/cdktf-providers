// https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/router_keychain
...
export interface RouterKeychainConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/router_keychain#dynamic_sort_subtable RouterKeychain#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/router_keychain#id RouterKeychain#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/router_keychain#name RouterKeychain#name}
  */
  readonly name?: string;
  /**
  * key block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/router_keychain#key RouterKeychain#key}
  */
  readonly key?: RouterKeychainKey[] | cdktf.IResolvable;
}
export interface RouterKeychainKey {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/router_keychain#accept_lifetime RouterKeychain#accept_lifetime}
  */
  ...
  */
  readonly id?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/router_keychain#key_string RouterKeychain#key_string}
  */
  readonly keyString?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/router_keychain#send_lifetime RouterKeychain#send_lifetime}
  */
...
export class RouterKeychainKeyOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // accept_lifetime - computed: true, optional: true, required: false
  ...
  // send_lifetime - computed: true, optional: true, required: false
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/router_keychain fortiswitch_router_keychain}
*/
export class RouterKeychain extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortiswitch_router_keychain";
  ...
  * @param importFromId The id of the existing RouterKeychain that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/router_keychain#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the RouterKeychain to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortiswitch_router_keychain", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/router_keychain fortiswitch_router_keychain} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: RouterKeychainConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortiswitch_router_keychain',
