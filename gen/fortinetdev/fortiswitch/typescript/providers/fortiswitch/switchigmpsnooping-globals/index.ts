// https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/switchigmpsnooping_globals
...
export interface SwitchigmpsnoopingGlobalsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/switchigmpsnooping_globals#aging_time SwitchigmpsnoopingGlobals#aging_time}
  */
  readonly agingTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/switchigmpsnooping_globals#id SwitchigmpsnoopingGlobals#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/switchigmpsnooping_globals#leave_response_timeout SwitchigmpsnoopingGlobals#leave_response_timeout}
  */
  readonly leaveResponseTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/switchigmpsnooping_globals#proxy_report_interval SwitchigmpsnoopingGlobals#proxy_report_interval}
  */
  readonly proxyReportInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/switchigmpsnooping_globals#query_interval SwitchigmpsnoopingGlobals#query_interval}
  */
  readonly queryInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/switchigmpsnooping_globals#query_max_response_timeout SwitchigmpsnoopingGlobals#query_max_response_timeout}
  */
  readonly queryMaxResponseTimeout?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/switchigmpsnooping_globals fortiswitch_switchigmpsnooping_globals}
*/
export class SwitchigmpsnoopingGlobals extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortiswitch_switchigmpsnooping_globals";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a SwitchigmpsnoopingGlobals resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the SwitchigmpsnoopingGlobals to import
  * @param importFromId The id of the existing SwitchigmpsnoopingGlobals that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/switchigmpsnooping_globals#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SwitchigmpsnoopingGlobals to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortiswitch_switchigmpsnooping_globals", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortiswitch/1.1.6/docs/resources/switchigmpsnooping_globals fortiswitch_switchigmpsnooping_globals} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options SwitchigmpsnoopingGlobalsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: SwitchigmpsnoopingGlobalsConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortiswitch_switchigmpsnooping_globals',
