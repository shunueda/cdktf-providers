// https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_log_fospolicystats
...
export interface SystemLogFospolicystatsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_log_fospolicystats#id SystemLogFospolicystats#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_log_fospolicystats#retention_days SystemLogFospolicystats#retention_days}
  */
  readonly retentionDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_log_fospolicystats#sampling_interval SystemLogFospolicystats#sampling_interval}
  */
  readonly samplingInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_log_fospolicystats#status SystemLogFospolicystats#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_log_fospolicystats fortianalyzer_system_log_fospolicystats}
*/
export class SystemLogFospolicystats extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemLogFospolicystats that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_log_fospolicystats#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_log_fospolicystats fortianalyzer_system_log_fospolicystats} Resource
  *
  * @param scope The scope in which to define this construct
