// https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_fortiview_autocache
...
export interface SystemFortiviewAutocacheConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_fortiview_autocache#aggressive_fortiview SystemFortiviewAutocache#aggressive_fortiview}
  */
  readonly aggressiveFortiview?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_fortiview_autocache#id SystemFortiviewAutocache#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_fortiview_autocache#incr_fortiview SystemFortiviewAutocache#incr_fortiview}
  */
  readonly incrFortiview?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_fortiview_autocache#interval SystemFortiviewAutocache#interval}
  */
  readonly interval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_fortiview_autocache#status SystemFortiviewAutocache#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_fortiview_autocache fortianalyzer_system_fortiview_autocache}
*/
export class SystemFortiviewAutocache extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemFortiviewAutocache that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_fortiview_autocache#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_fortiview_autocache fortianalyzer_system_fortiview_autocache} Resource
  *
  * @param scope The scope in which to define this construct
