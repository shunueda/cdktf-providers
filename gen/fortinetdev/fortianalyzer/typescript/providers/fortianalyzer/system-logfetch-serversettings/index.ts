// https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logfetch_serversettings
...
export interface SystemLogfetchServersettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logfetch_serversettings#id SystemLogfetchServersettings#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logfetch_serversettings#max_conn_per_session SystemLogfetchServersettings#max_conn_per_session}
  */
  readonly maxConnPerSession?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logfetch_serversettings#max_sessions SystemLogfetchServersettings#max_sessions}
  */
  readonly maxSessions?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logfetch_serversettings#session_timeout SystemLogfetchServersettings#session_timeout}
  */
  readonly sessionTimeout?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logfetch_serversettings fortianalyzer_system_logfetch_serversettings}
*/
export class SystemLogfetchServersettings extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortianalyzer_system_logfetch_serversettings";
  ...
  * @param importFromId The id of the existing SystemLogfetchServersettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logfetch_serversettings#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortianalyzer_system_logfetch_serversettings", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logfetch_serversettings fortianalyzer_system_logfetch_serversettings} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SystemLogfetchServersettingsConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortianalyzer_system_logfetch_serversettings',
