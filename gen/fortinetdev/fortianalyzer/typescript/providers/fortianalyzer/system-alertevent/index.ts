...
export class SystemAlertevent extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortianalyzer_system_alertevent";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortianalyzer_system_alertevent", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: SystemAlerteventConfig = {}) {
    ...
    this._enableGenericTextUnitary = config.enableGenericTextUnitary;
    this._enableSeverityFilter = config.enableSeverityFilter;
    this._enableSeverityFilterUnitary = config.enableSeverityFilterUnitary;
    ...
    this._severityLevelCompUnitary = config.severityLevelCompUnitary;
  ...
  // enable_generic_text_unitary - computed: true, optional: true, required: false
  private _enableGenericTextUnitary?: string; 
  public get enableGenericTextUnitary() {
    return this.getStringAttribute('enable_generic_text_unitary');
  }
  public set enableGenericTextUnitary(value: string) {
    this._enableGenericTextUnitary = value;
  }
  public resetEnableGenericTextUnitary() {
    this._enableGenericTextUnitary = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get enableGenericTextUnitaryInput() {
    return this._enableGenericTextUnitary;
  }
  ...
  // enable_severity_filter_unitary - computed: true, optional: true, required: false
  private _enableSeverityFilterUnitary?: string; 
  public get enableSeverityFilterUnitary() {
    return this.getStringAttribute('enable_severity_filter_unitary');
  }
  public set enableSeverityFilterUnitary(value: string) {
    this._enableSeverityFilterUnitary = value;
  }
  public resetEnableSeverityFilterUnitary() {
    this._enableSeverityFilterUnitary = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get enableSeverityFilterUnitaryInput() {
    return this._enableSeverityFilterUnitary;
  }
  ...
  // severity_level_comp_unitary - computed: true, optional: true, required: false
  private _severityLevelCompUnitary?: string; 
  public get severityLevelCompUnitary() {
    return this.getStringAttribute('severity_level_comp_unitary');
  }
  public set severityLevelCompUnitary(value: string) {
    this._severityLevelCompUnitary = value;
  }
  public resetSeverityLevelCompUnitary() {
    this._severityLevelCompUnitary = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get severityLevelCompUnitaryInput() {
    return this._severityLevelCompUnitary;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      enable_generic_text_unitary: cdktf.stringToTerraform(this._enableGenericTextUnitary),
      enable_severity_filter: cdktf.listMapper(cdktf.stringToTerraform, false)(this._enableSeverityFilter),
      enable_severity_filter_unitary: cdktf.stringToTerraform(this._enableSeverityFilterUnitary),
      ...
      severity_level_comp_unitary: cdktf.stringToTerraform(this._severityLevelCompUnitary),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      enable_generic_text_unitary: {
        value: cdktf.stringToHclTerraform(this._enableGenericTextUnitary),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      enable_severity_filter_unitary: {
        value: cdktf.stringToHclTerraform(this._enableSeverityFilterUnitary),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      severity_level_comp_unitary: {
        value: cdktf.stringToHclTerraform(this._severityLevelCompUnitary),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
