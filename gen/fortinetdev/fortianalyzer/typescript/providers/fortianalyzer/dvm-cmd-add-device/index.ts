...
export class DvmCmdAddDeviceDeviceOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // adm_pass - computed: false, optional: true, required: false
...
export class DvmCmdAddDevice extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortianalyzer_dvm_cmd_add_device";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortianalyzer_dvm_cmd_add_device", importId: importFromId, provider });
      }
