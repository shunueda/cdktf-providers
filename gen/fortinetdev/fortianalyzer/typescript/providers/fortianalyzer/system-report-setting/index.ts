// https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting
...
export interface SystemReportSettingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting#aggregate_report SystemReportSetting#aggregate_report}
  */
  readonly aggregateReport?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting#capwap_port SystemReportSetting#capwap_port}
  */
  readonly capwapPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting#capwap_service SystemReportSetting#capwap_service}
  */
  readonly capwapService?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting#exclude_capwap SystemReportSetting#exclude_capwap}
  */
  readonly excludeCapwap?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting#hcache_lossless SystemReportSetting#hcache_lossless}
  */
  readonly hcacheLossless?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting#id SystemReportSetting#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting#ldap_cache_timeout SystemReportSetting#ldap_cache_timeout}
  */
  readonly ldapCacheTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting#max_rpt_pdf_rows SystemReportSetting#max_rpt_pdf_rows}
  */
  readonly maxRptPdfRows?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting#max_table_rows SystemReportSetting#max_table_rows}
  */
  readonly maxTableRows?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting#report_priority SystemReportSetting#report_priority}
  */
  readonly reportPriority?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting#template_auto_install SystemReportSetting#template_auto_install}
  */
  readonly templateAutoInstall?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting#week_start SystemReportSetting#week_start}
  */
  readonly weekStart?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting fortianalyzer_system_report_setting}
*/
export class SystemReportSetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemReportSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_report_setting fortianalyzer_system_report_setting} Resource
  *
  * @param scope The scope in which to define this construct
