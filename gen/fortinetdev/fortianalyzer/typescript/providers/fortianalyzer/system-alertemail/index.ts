// https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_alertemail
...
export interface SystemAlertemailConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_alertemail#authentication SystemAlertemail#authentication}
  */
  readonly authentication?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_alertemail#fromaddress SystemAlertemail#fromaddress}
  */
  readonly fromaddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_alertemail#fromname SystemAlertemail#fromname}
  */
  readonly fromname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_alertemail#id SystemAlertemail#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_alertemail#smtppassword SystemAlertemail#smtppassword}
  */
  readonly smtppassword?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_alertemail#smtpport SystemAlertemail#smtpport}
  */
  readonly smtpport?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_alertemail#smtpserver SystemAlertemail#smtpserver}
  */
  readonly smtpserver?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_alertemail#smtpuser SystemAlertemail#smtpuser}
  */
  readonly smtpuser?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_alertemail fortianalyzer_system_alertemail}
*/
export class SystemAlertemail extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortianalyzer_system_alertemail";
  ...
  * @param importFromId The id of the existing SystemAlertemail that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_alertemail#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SystemAlertemail to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortianalyzer_system_alertemail", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_alertemail fortianalyzer_system_alertemail} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // fromaddress - computed: false, optional: true, required: false
  ...
  // fromname - computed: false, optional: true, required: false
  ...
  // smtppassword - computed: false, optional: true, required: false
  ...
  // smtpserver - computed: false, optional: true, required: false
