// https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders
...
export interface SystemSamlServiceprovidersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders#id SystemSamlServiceproviders#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders#idp_entity_id SystemSamlServiceproviders#idp_entity_id}
  */
  readonly idpEntityId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders#idp_single_logout_url SystemSamlServiceproviders#idp_single_logout_url}
  */
  readonly idpSingleLogoutUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders#idp_single_sign_on_url SystemSamlServiceproviders#idp_single_sign_on_url}
  */
  readonly idpSingleSignOnUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders#name SystemSamlServiceproviders#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders#prefix SystemSamlServiceproviders#prefix}
  */
  readonly prefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders#sp_adom SystemSamlServiceproviders#sp_adom}
  */
  readonly spAdom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders#sp_cert SystemSamlServiceproviders#sp_cert}
  */
  readonly spCert?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders#sp_entity_id SystemSamlServiceproviders#sp_entity_id}
  */
  readonly spEntityId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders#sp_profile SystemSamlServiceproviders#sp_profile}
  */
  readonly spProfile?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders#sp_single_logout_url SystemSamlServiceproviders#sp_single_logout_url}
  */
  readonly spSingleLogoutUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders#sp_single_sign_on_url SystemSamlServiceproviders#sp_single_sign_on_url}
  */
  readonly spSingleSignOnUrl?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders fortianalyzer_system_saml_serviceproviders}
*/
export class SystemSamlServiceproviders extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortianalyzer_system_saml_serviceproviders";
  ...
  * @param importFromId The id of the existing SystemSamlServiceproviders that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortianalyzer_system_saml_serviceproviders", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.1/docs/resources/system_saml_serviceproviders fortianalyzer_system_saml_serviceproviders} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SystemSamlServiceprovidersConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortianalyzer_system_saml_serviceproviders',
