...
export class DvmdbAdom extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortianalyzer_dvmdb_adom";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortianalyzer_dvmdb_adom", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: DvmdbAdomConfig = {}) {
    ...
    this._restrictedPrdsUnitary = config.restrictedPrdsUnitary;
  ...
  // restricted_prds_unitary - computed: true, optional: true, required: false
  private _restrictedPrdsUnitary?: string; 
  public get restrictedPrdsUnitary() {
    return this.getStringAttribute('restricted_prds_unitary');
  }
  public set restrictedPrdsUnitary(value: string) {
    this._restrictedPrdsUnitary = value;
  }
  public resetRestrictedPrdsUnitary() {
    this._restrictedPrdsUnitary = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get restrictedPrdsUnitaryInput() {
    return this._restrictedPrdsUnitary;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      restricted_prds_unitary: cdktf.stringToTerraform(this._restrictedPrdsUnitary),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      restricted_prds_unitary: {
        value: cdktf.stringToHclTerraform(this._restrictedPrdsUnitary),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
