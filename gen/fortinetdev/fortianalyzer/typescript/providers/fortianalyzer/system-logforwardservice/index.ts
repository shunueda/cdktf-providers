// https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logforwardservice
...
export interface SystemLogforwardserviceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logforwardservice#accept_aggregation SystemLogforwardservice#accept_aggregation}
  */
  readonly acceptAggregation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logforwardservice#aggregation_disk_quota SystemLogforwardservice#aggregation_disk_quota}
  */
  readonly aggregationDiskQuota?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logforwardservice#collector_auth SystemLogforwardservice#collector_auth}
  */
  readonly collectorAuth?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logforwardservice#id SystemLogforwardservice#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logforwardservice fortianalyzer_system_logforwardservice}
*/
export class SystemLogforwardservice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemLogforwardservice that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logforwardservice#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortianalyzer/1.5.2/docs/resources/system_logforwardservice fortianalyzer_system_logforwardservice} Resource
  *
  * @param scope The scope in which to define this construct
