// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache
...
export interface WanoptWebcacheConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#always_revalidate WanoptWebcache#always_revalidate}
  */
  readonly alwaysRevalidate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#cache_by_default WanoptWebcache#cache_by_default}
  */
  readonly cacheByDefault?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#cache_cookie WanoptWebcache#cache_cookie}
  */
  readonly cacheCookie?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#cache_expired WanoptWebcache#cache_expired}
  */
  readonly cacheExpired?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#default_ttl WanoptWebcache#default_ttl}
  */
  readonly defaultTtl?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#external WanoptWebcache#external}
  */
  readonly external?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#fresh_factor WanoptWebcache#fresh_factor}
  */
  readonly freshFactor?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#host_validate WanoptWebcache#host_validate}
  */
  readonly hostValidate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#id WanoptWebcache#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#ignore_conditional WanoptWebcache#ignore_conditional}
  */
  readonly ignoreConditional?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#ignore_ie_reload WanoptWebcache#ignore_ie_reload}
  */
  readonly ignoreIeReload?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#ignore_ims WanoptWebcache#ignore_ims}
  */
  readonly ignoreIms?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#ignore_pnc WanoptWebcache#ignore_pnc}
  */
  readonly ignorePnc?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#max_object_size WanoptWebcache#max_object_size}
  */
  readonly maxObjectSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#max_ttl WanoptWebcache#max_ttl}
  */
  readonly maxTtl?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#min_ttl WanoptWebcache#min_ttl}
  */
  readonly minTtl?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#neg_resp_time WanoptWebcache#neg_resp_time}
  */
  readonly negRespTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#reval_pnc WanoptWebcache#reval_pnc}
  */
  readonly revalPnc?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#vdomparam WanoptWebcache#vdomparam}
  */
  readonly vdomparam?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache fortios_wanopt_webcache}
*/
export class WanoptWebcache extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortios_wanopt_webcache";
  ...
  * @param importFromId The id of the existing WanoptWebcache that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the WanoptWebcache to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortios_wanopt_webcache", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wanopt_webcache fortios_wanopt_webcache} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: WanoptWebcacheConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortios_wanopt_webcache',
  ...
  // always_revalidate - computed: true, optional: true, required: false
