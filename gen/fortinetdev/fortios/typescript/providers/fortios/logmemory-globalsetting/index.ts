// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logmemory_globalsetting
...
export interface LogmemoryGlobalsettingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logmemory_globalsetting#full_final_warning_threshold LogmemoryGlobalsetting#full_final_warning_threshold}
  */
  readonly fullFinalWarningThreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logmemory_globalsetting#full_first_warning_threshold LogmemoryGlobalsetting#full_first_warning_threshold}
  */
  readonly fullFirstWarningThreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logmemory_globalsetting#full_second_warning_threshold LogmemoryGlobalsetting#full_second_warning_threshold}
  */
  readonly fullSecondWarningThreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logmemory_globalsetting#id LogmemoryGlobalsetting#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logmemory_globalsetting#max_size LogmemoryGlobalsetting#max_size}
  */
  readonly maxSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logmemory_globalsetting#vdomparam LogmemoryGlobalsetting#vdomparam}
  */
  readonly vdomparam?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logmemory_globalsetting fortios_logmemory_globalsetting}
*/
export class LogmemoryGlobalsetting extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortios_logmemory_globalsetting";
  ...
  * @param importFromId The id of the existing LogmemoryGlobalsetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logmemory_globalsetting#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortios_logmemory_globalsetting", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logmemory_globalsetting fortios_logmemory_globalsetting} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: LogmemoryGlobalsettingConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortios_logmemory_globalsetting',
