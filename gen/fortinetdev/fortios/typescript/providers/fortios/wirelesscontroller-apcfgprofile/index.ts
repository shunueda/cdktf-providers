// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile
...
export interface WirelesscontrollerApcfgprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#ac_ip WirelesscontrollerApcfgprofile#ac_ip}
  */
  readonly acIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#ac_port WirelesscontrollerApcfgprofile#ac_port}
  */
  readonly acPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#ac_timer WirelesscontrollerApcfgprofile#ac_timer}
  */
  readonly acTimer?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#ac_type WirelesscontrollerApcfgprofile#ac_type}
  */
  readonly acType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#ap_family WirelesscontrollerApcfgprofile#ap_family}
  */
  readonly apFamily?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#comment WirelesscontrollerApcfgprofile#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#dynamic_sort_subtable WirelesscontrollerApcfgprofile#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#get_all_tables WirelesscontrollerApcfgprofile#get_all_tables}
  */
  readonly fetchAllTables?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#id WirelesscontrollerApcfgprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#name WirelesscontrollerApcfgprofile#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#vdomparam WirelesscontrollerApcfgprofile#vdomparam}
  */
  readonly vdomparam?: string;
  /**
  * command_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#command_list WirelesscontrollerApcfgprofile#command_list}
  */
...
export interface WirelesscontrollerApcfgprofileCommandListStruct {
  ...
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#passwd_value WirelesscontrollerApcfgprofile#passwd_value}
  */
  readonly passwdValue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#type WirelesscontrollerApcfgprofile#type}
  */
  readonly type?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#value WirelesscontrollerApcfgprofile#value}
  */
...
export function wirelesscontrollerApcfgprofileCommandListStructToTerraform(struct?: WirelesscontrollerApcfgprofileCommandListStruct | cdktf.IResolvable): any {
  ...
  return {
    ...
    passwd_value: cdktf.stringToTerraform(struct!.passwdValue),
...
export function wirelesscontrollerApcfgprofileCommandListStructToHclTerraform(struct?: WirelesscontrollerApcfgprofileCommandListStruct | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    passwd_value: {
      value: cdktf.stringToHclTerraform(struct!.passwdValue),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class WirelesscontrollerApcfgprofileCommandListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // passwd_value - computed: false, optional: true, required: false
  private _passwdValue?: string; 
  public get passwdValue() {
    return this.getStringAttribute('passwd_value');
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile fortios_wirelesscontroller_apcfgprofile}
*/
export class WirelesscontrollerApcfgprofile extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortios_wirelesscontroller_apcfgprofile";
  ...
  * @param importFromId The id of the existing WirelesscontrollerApcfgprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortios_wirelesscontroller_apcfgprofile", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_apcfgprofile fortios_wirelesscontroller_apcfgprofile} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: WirelesscontrollerApcfgprofileConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortios_wirelesscontroller_apcfgprofile',
