// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile
...
export interface WirelesscontrollerBleprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#advertising WirelesscontrollerBleprofile#advertising}
  */
  readonly advertising?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#beacon_interval WirelesscontrollerBleprofile#beacon_interval}
  */
  readonly beaconInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#ble_scanning WirelesscontrollerBleprofile#ble_scanning}
  */
  readonly bleScanning?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#comment WirelesscontrollerBleprofile#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#eddystone_instance WirelesscontrollerBleprofile#eddystone_instance}
  */
  readonly eddystoneInstance?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#eddystone_namespace WirelesscontrollerBleprofile#eddystone_namespace}
  */
  readonly eddystoneNamespace?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#eddystone_url WirelesscontrollerBleprofile#eddystone_url}
  */
  readonly eddystoneUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#eddystone_url_encode_hex WirelesscontrollerBleprofile#eddystone_url_encode_hex}
  */
  readonly eddystoneUrlEncodeHex?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#ibeacon_uuid WirelesscontrollerBleprofile#ibeacon_uuid}
  */
  readonly ibeaconUuid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#id WirelesscontrollerBleprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#major_id WirelesscontrollerBleprofile#major_id}
  */
  readonly majorId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#minor_id WirelesscontrollerBleprofile#minor_id}
  */
  readonly minorId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#name WirelesscontrollerBleprofile#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#scan_interval WirelesscontrollerBleprofile#scan_interval}
  */
  readonly scanInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#scan_period WirelesscontrollerBleprofile#scan_period}
  */
  readonly scanPeriod?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#scan_threshold WirelesscontrollerBleprofile#scan_threshold}
  */
  readonly scanThreshold?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#scan_time WirelesscontrollerBleprofile#scan_time}
  */
  readonly scanTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#scan_type WirelesscontrollerBleprofile#scan_type}
  */
  readonly scanType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#scan_window WirelesscontrollerBleprofile#scan_window}
  */
  readonly scanWindow?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#txpower WirelesscontrollerBleprofile#txpower}
  */
  readonly txpower?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#vdomparam WirelesscontrollerBleprofile#vdomparam}
  */
  readonly vdomparam?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile fortios_wirelesscontroller_bleprofile}
*/
export class WirelesscontrollerBleprofile extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortios_wirelesscontroller_bleprofile";
  ...
  * @param importFromId The id of the existing WirelesscontrollerBleprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortios_wirelesscontroller_bleprofile", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/wirelesscontroller_bleprofile fortios_wirelesscontroller_bleprofile} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: WirelesscontrollerBleprofileConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortios_wirelesscontroller_bleprofile',
  ...
  // advertising - computed: false, optional: true, required: false
  private _advertising?: string; 
  public get advertising() {
    return this.getStringAttribute('advertising');
  }
  ...
  // scan_period - computed: true, optional: true, required: false
  ...
  // scan_window - computed: true, optional: true, required: false
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      advertising: cdktf.stringToTerraform(this._advertising),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      advertising: {
        value: cdktf.stringToHclTerraform(this._advertising),
        isBlock: false,
        type: "simple",
