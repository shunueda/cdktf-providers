// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_switchprofile
...
export interface SwitchcontrollerSwitchprofileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_switchprofile#id SwitchcontrollerSwitchprofile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_switchprofile#login SwitchcontrollerSwitchprofile#login}
  */
  readonly login?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_switchprofile#login_passwd SwitchcontrollerSwitchprofile#login_passwd}
  */
  readonly loginPasswd?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_switchprofile#login_passwd_override SwitchcontrollerSwitchprofile#login_passwd_override}
  */
  readonly loginPasswdOverride?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_switchprofile#name SwitchcontrollerSwitchprofile#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_switchprofile#revision_backup_on_logout SwitchcontrollerSwitchprofile#revision_backup_on_logout}
  */
  readonly revisionBackupOnLogout?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_switchprofile#revision_backup_on_upgrade SwitchcontrollerSwitchprofile#revision_backup_on_upgrade}
  */
  readonly revisionBackupOnUpgrade?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_switchprofile#vdomparam SwitchcontrollerSwitchprofile#vdomparam}
  */
  readonly vdomparam?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_switchprofile fortios_switchcontroller_switchprofile}
*/
export class SwitchcontrollerSwitchprofile extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortios_switchcontroller_switchprofile";
  ...
  * @param importFromId The id of the existing SwitchcontrollerSwitchprofile that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_switchprofile#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortios_switchcontroller_switchprofile", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_switchprofile fortios_switchcontroller_switchprofile} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SwitchcontrollerSwitchprofileConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortios_switchcontroller_switchprofile',
