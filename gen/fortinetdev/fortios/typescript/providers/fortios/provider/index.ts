// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs
...
export interface FortiosProviderConfig {
  /**
  * CA Bundle file content
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#cabundlecontent FortiosProvider#cabundlecontent}
  */
  readonly cabundlecontent?: string;
  /**
  * CA Bundle file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#cabundlefile FortiosProvider#cabundlefile}
  */
  readonly cabundlefile?: string;
  /**
  * CA certtificate(Optional)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#cacert FortiosProvider#cacert}
  */
  readonly cacert?: string;
  /**
  * User certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#clientcert FortiosProvider#clientcert}
  */
  readonly clientcert?: string;
  /**
  * User private key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#clientkey FortiosProvider#clientkey}
  */
  readonly clientkey?: string;
  /**
  * CA Bundle file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#fmg_cabundlefile FortiosProvider#fmg_cabundlefile}
  */
  readonly fmgCabundlefile?: string;
  /**
  * Hostname/IP address of the FortiManager to connect to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#fmg_hostname FortiosProvider#fmg_hostname}
  */
  readonly fmgHostname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#fmg_insecure FortiosProvider#fmg_insecure}
  */
  readonly fmgInsecure?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#fmg_passwd FortiosProvider#fmg_passwd}
  */
  readonly fmgPasswd?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#fmg_username FortiosProvider#fmg_username}
  */
  readonly fmgUsername?: string;
  /**
  * The hostname/IP address of the FortiOS to be connected
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#hostname FortiosProvider#hostname}
  */
  readonly hostname?: string;
  /**
  * HTTP proxy address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#http_proxy FortiosProvider#http_proxy}
  */
  readonly httpProxy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#insecure FortiosProvider#insecure}
  */
  readonly insecure?: boolean | cdktf.IResolvable;
  /**
  * The password of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#password FortiosProvider#password}
  */
  readonly password?: string;
  /**
  * Enable/disable peer authentication, can be 'enable' or 'disable'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#peerauth FortiosProvider#peerauth}
  */
  readonly peerauth?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#token FortiosProvider#token}
  */
  readonly token?: string;
  /**
  * The username of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#username FortiosProvider#username}
  */
  readonly username?: string;
  /**
  * Vdom name of FortiOS. It will apply to all resources. Specify variable `vdomparam` on each resource will override the vdom value on that resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#vdom FortiosProvider#vdom}
  */
  readonly vdom?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#alias FortiosProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs fortios}
*/
export class FortiosProvider extends cdktf.TerraformProvider {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortios";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a FortiosProvider resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the FortiosProvider to import
  * @param importFromId The id of the existing FortiosProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the FortiosProvider to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortios", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs fortios} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options FortiosProviderConfig = {}
  */
  public constructor(scope: Construct, id: string, config: FortiosProviderConfig = {}) {
    super(scope, id, {
