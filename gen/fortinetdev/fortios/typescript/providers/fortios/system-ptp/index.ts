// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp
...
export interface SystemPtpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp#delay_mechanism SystemPtp#delay_mechanism}
  */
  readonly delayMechanism?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp#dynamic_sort_subtable SystemPtp#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp#get_all_tables SystemPtp#get_all_tables}
  */
  readonly fetchAllTables?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp#id SystemPtp#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp#interface SystemPtp#interface}
  */
  readonly interface: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp#mode SystemPtp#mode}
  */
  readonly mode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp#request_interval SystemPtp#request_interval}
  */
  readonly requestInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp#server_mode SystemPtp#server_mode}
  */
  readonly serverMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp#status SystemPtp#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp#vdomparam SystemPtp#vdomparam}
  */
  readonly vdomparam?: string;
  /**
  * server_interface block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp#server_interface SystemPtp#server_interface}
  */
...
export interface SystemPtpServerInterface {
  ...
  */
  readonly id?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp#server_interface_name SystemPtp#server_interface_name}
  */
...
export function systemPtpServerInterfaceToTerraform(struct?: SystemPtpServerInterface | cdktf.IResolvable): any {
  ...
  return {
    ...
    server_interface_name: cdktf.stringToTerraform(struct!.serverInterfaceName),
  }
}
...
export function systemPtpServerInterfaceToHclTerraform(struct?: SystemPtpServerInterface | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    server_interface_name: {
      value: cdktf.stringToHclTerraform(struct!.serverInterfaceName),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class SystemPtpServerInterfaceOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // server_interface_name - computed: false, optional: true, required: false
  private _serverInterfaceName?: string; 
  public get serverInterfaceName() {
    return this.getStringAttribute('server_interface_name');
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp fortios_system_ptp}
*/
export class SystemPtp extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortios_system_ptp";
  ...
  * @param importFromId The id of the existing SystemPtp that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SystemPtp to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortios_system_ptp", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_ptp fortios_system_ptp} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SystemPtpConfig) {
    super(scope, id, {
      terraformResourceType: 'fortios_system_ptp',
