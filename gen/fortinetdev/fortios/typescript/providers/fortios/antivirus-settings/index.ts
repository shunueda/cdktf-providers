// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/antivirus_settings
...
export interface AntivirusSettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/antivirus_settings#cache_clean_result AntivirusSettings#cache_clean_result}
  */
  readonly cacheCleanResult?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/antivirus_settings#cache_infected_result AntivirusSettings#cache_infected_result}
  */
  readonly cacheInfectedResult?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/antivirus_settings#default_db AntivirusSettings#default_db}
  */
  readonly defaultDb?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/antivirus_settings#grayware AntivirusSettings#grayware}
  */
  readonly grayware?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/antivirus_settings#id AntivirusSettings#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/antivirus_settings#machine_learning_detection AntivirusSettings#machine_learning_detection}
  */
  readonly machineLearningDetection?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/antivirus_settings#override_timeout AntivirusSettings#override_timeout}
  */
  readonly overrideTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/antivirus_settings#use_extreme_db AntivirusSettings#use_extreme_db}
  */
  readonly useExtremeDb?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/antivirus_settings#vdomparam AntivirusSettings#vdomparam}
  */
  readonly vdomparam?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/antivirus_settings fortios_antivirus_settings}
*/
export class AntivirusSettings extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortios_antivirus_settings";
  ...
  * @param importFromId The id of the existing AntivirusSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/antivirus_settings#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AntivirusSettings to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortios_antivirus_settings", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/antivirus_settings fortios_antivirus_settings} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: AntivirusSettingsConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortios_antivirus_settings',
  ...
  // cache_clean_result - computed: true, optional: true, required: false
