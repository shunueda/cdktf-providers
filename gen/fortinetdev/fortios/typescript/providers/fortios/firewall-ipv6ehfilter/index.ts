// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/firewall_ipv6ehfilter
...
export interface FirewallIpv6EhfilterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/firewall_ipv6ehfilter#auth FirewallIpv6Ehfilter#auth}
  */
  readonly auth?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/firewall_ipv6ehfilter#dest_opt FirewallIpv6Ehfilter#dest_opt}
  */
  readonly destOpt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/firewall_ipv6ehfilter#fragment FirewallIpv6Ehfilter#fragment}
  */
  readonly fragment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/firewall_ipv6ehfilter#hdopt_type FirewallIpv6Ehfilter#hdopt_type}
  */
  readonly hdoptType?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/firewall_ipv6ehfilter#hop_opt FirewallIpv6Ehfilter#hop_opt}
  */
  readonly hopOpt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/firewall_ipv6ehfilter#id FirewallIpv6Ehfilter#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/firewall_ipv6ehfilter#no_next FirewallIpv6Ehfilter#no_next}
  */
  readonly noNext?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/firewall_ipv6ehfilter#routing FirewallIpv6Ehfilter#routing}
  */
  readonly routing?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/firewall_ipv6ehfilter#routing_type FirewallIpv6Ehfilter#routing_type}
  */
  readonly routingType?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/firewall_ipv6ehfilter#vdomparam FirewallIpv6Ehfilter#vdomparam}
  */
  readonly vdomparam?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/firewall_ipv6ehfilter fortios_firewall_ipv6ehfilter}
*/
export class FirewallIpv6Ehfilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FirewallIpv6Ehfilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/firewall_ipv6ehfilter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/firewall_ipv6ehfilter fortios_firewall_ipv6ehfilter} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // hdopt_type - computed: false, optional: true, required: false
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      hdopt_type: cdktf.numberToTerraform(this._hdoptType),
      ...
      routing_type: cdktf.numberToTerraform(this._routingType),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      hdopt_type: {
        value: cdktf.numberToHclTerraform(this._hdoptType),
        isBlock: false,
        type: "simple",
      ...
      routing_type: {
        value: cdktf.numberToHclTerraform(this._routingType),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
