// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca
...
export interface VpncertificateCaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#auto_update_days VpncertificateCa#auto_update_days}
  */
  readonly autoUpdateDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#auto_update_days_warning VpncertificateCa#auto_update_days_warning}
  */
  readonly autoUpdateDaysWarning?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#ca VpncertificateCa#ca}
  */
  readonly ca: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#ca_identifier VpncertificateCa#ca_identifier}
  */
  readonly caIdentifier?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#est_url VpncertificateCa#est_url}
  */
  readonly estUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#fabric_ca VpncertificateCa#fabric_ca}
  */
  readonly fabricCa?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#id VpncertificateCa#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#last_updated VpncertificateCa#last_updated}
  */
  readonly lastUpdated?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#name VpncertificateCa#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#obsolete VpncertificateCa#obsolete}
  */
  readonly obsolete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#range VpncertificateCa#range}
  */
  readonly range?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#scep_url VpncertificateCa#scep_url}
  */
  readonly scepUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#source VpncertificateCa#source}
  */
  readonly source?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#source_ip VpncertificateCa#source_ip}
  */
  readonly sourceIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#ssl_inspection_trusted VpncertificateCa#ssl_inspection_trusted}
  */
  readonly sslInspectionTrusted?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#trusted VpncertificateCa#trusted}
  */
  readonly trusted?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#vdomparam VpncertificateCa#vdomparam}
  */
  readonly vdomparam?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca fortios_vpncertificate_ca}
*/
export class VpncertificateCa extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortios_vpncertificate_ca";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a VpncertificateCa resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the VpncertificateCa to import
  * @param importFromId The id of the existing VpncertificateCa that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the VpncertificateCa to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortios_vpncertificate_ca", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/vpncertificate_ca fortios_vpncertificate_ca} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options VpncertificateCaConfig
  */
  public constructor(scope: Construct, id: string, config: VpncertificateCaConfig) {
    super(scope, id, {
      terraformResourceType: 'fortios_vpncertificate_ca',
