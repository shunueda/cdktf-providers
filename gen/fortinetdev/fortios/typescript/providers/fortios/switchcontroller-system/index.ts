// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system
...
export interface SwitchcontrollerSystemConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#caputp_echo_interval SwitchcontrollerSystem#caputp_echo_interval}
  */
  readonly caputpEchoInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#caputp_max_retransmit SwitchcontrollerSystem#caputp_max_retransmit}
  */
  readonly caputpMaxRetransmit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#data_sync_interval SwitchcontrollerSystem#data_sync_interval}
  */
  readonly dataSyncInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#dynamic_periodic_interval SwitchcontrollerSystem#dynamic_periodic_interval}
  */
  readonly dynamicPeriodicInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#id SwitchcontrollerSystem#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#iot_holdoff SwitchcontrollerSystem#iot_holdoff}
  */
  readonly iotHoldoff?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#iot_mac_idle SwitchcontrollerSystem#iot_mac_idle}
  */
  readonly iotMacIdle?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#iot_scan_interval SwitchcontrollerSystem#iot_scan_interval}
  */
  readonly iotScanInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#iot_weight_threshold SwitchcontrollerSystem#iot_weight_threshold}
  */
  readonly iotWeightThreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#nac_periodic_interval SwitchcontrollerSystem#nac_periodic_interval}
  */
  readonly nacPeriodicInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#parallel_process SwitchcontrollerSystem#parallel_process}
  */
  readonly parallelProcess?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#parallel_process_override SwitchcontrollerSystem#parallel_process_override}
  */
  readonly parallelProcessOverride?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#tunnel_mode SwitchcontrollerSystem#tunnel_mode}
  */
  readonly tunnelMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#vdomparam SwitchcontrollerSystem#vdomparam}
  */
  readonly vdomparam?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system fortios_switchcontroller_system}
*/
export class SwitchcontrollerSystem extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortios_switchcontroller_system";
  ...
  * @param importFromId The id of the existing SwitchcontrollerSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortios_switchcontroller_system", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/switchcontroller_system fortios_switchcontroller_system} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SwitchcontrollerSystemConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortios_switchcontroller_system',
  ...
  // caputp_echo_interval - computed: true, optional: true, required: false
