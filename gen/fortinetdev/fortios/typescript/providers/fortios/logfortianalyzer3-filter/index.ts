// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter
...
export interface Logfortianalyzer3FilterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#anomaly Logfortianalyzer3Filter#anomaly}
  */
  readonly anomaly?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#debug Logfortianalyzer3Filter#debug}
  */
  readonly debug?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#dlp_archive Logfortianalyzer3Filter#dlp_archive}
  */
  readonly dlpArchive?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#dns Logfortianalyzer3Filter#dns}
  */
  readonly dns?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#dynamic_sort_subtable Logfortianalyzer3Filter#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#filter Logfortianalyzer3Filter#filter}
  */
  readonly filter?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#filter_type Logfortianalyzer3Filter#filter_type}
  */
  readonly filterType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#forti_switch Logfortianalyzer3Filter#forti_switch}
  */
  readonly fortiSwitch?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#forward_traffic Logfortianalyzer3Filter#forward_traffic}
  */
  readonly forwardTraffic?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#get_all_tables Logfortianalyzer3Filter#get_all_tables}
  */
  readonly fetchAllTables?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#gtp Logfortianalyzer3Filter#gtp}
  */
  readonly gtp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#http_transaction Logfortianalyzer3Filter#http_transaction}
  */
  readonly httpTransaction?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#id Logfortianalyzer3Filter#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#local_traffic Logfortianalyzer3Filter#local_traffic}
  */
  readonly localTraffic?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#multicast_traffic Logfortianalyzer3Filter#multicast_traffic}
  */
  readonly multicastTraffic?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#netscan_discovery Logfortianalyzer3Filter#netscan_discovery}
  */
  readonly netscanDiscovery?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#netscan_vulnerability Logfortianalyzer3Filter#netscan_vulnerability}
  */
  readonly netscanVulnerability?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#severity Logfortianalyzer3Filter#severity}
  */
  readonly severity?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#sniffer_traffic Logfortianalyzer3Filter#sniffer_traffic}
  */
  readonly snifferTraffic?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#ssh Logfortianalyzer3Filter#ssh}
  */
  readonly ssh?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#vdomparam Logfortianalyzer3Filter#vdomparam}
  */
  readonly vdomparam?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#voip Logfortianalyzer3Filter#voip}
  */
  readonly voip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#ztna_traffic Logfortianalyzer3Filter#ztna_traffic}
  */
  readonly ztnaTraffic?: string;
  /**
  * free_style block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#free_style Logfortianalyzer3Filter#free_style}
  */
  readonly freeStyle?: Logfortianalyzer3FilterFreeStyle[] | cdktf.IResolvable;
}
export interface Logfortianalyzer3FilterFreeStyle {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#category Logfortianalyzer3Filter#category}
  */
...
export function logfortianalyzer3FilterFreeStyleToTerraform(struct?: Logfortianalyzer3FilterFreeStyle | cdktf.IResolvable): any {
...
export function logfortianalyzer3FilterFreeStyleToHclTerraform(struct?: Logfortianalyzer3FilterFreeStyle | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Logfortianalyzer3FilterFreeStyleOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): Logfortianalyzer3FilterFreeStyle | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: Logfortianalyzer3FilterFreeStyle | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class Logfortianalyzer3FilterFreeStyleList extends cdktf.ComplexList {
  public internalValue? : Logfortianalyzer3FilterFreeStyle[] | cdktf.IResolvable
  ...
  */
  public get(index: number): Logfortianalyzer3FilterFreeStyleOutputReference {
    return new Logfortianalyzer3FilterFreeStyleOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter fortios_logfortianalyzer3_filter}
*/
export class Logfortianalyzer3Filter extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortios_logfortianalyzer3_filter";
  ...
  * @param importFromId The id of the existing Logfortianalyzer3Filter that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortios_logfortianalyzer3_filter", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/logfortianalyzer3_filter fortios_logfortianalyzer3_filter} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: Logfortianalyzer3FilterConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortios_logfortianalyzer3_filter',
  ...
  private _freeStyle = new Logfortianalyzer3FilterFreeStyleList(this, "free_style", false);
  public get freeStyle() {
    return this._freeStyle;
  }
  public putFreeStyle(value: Logfortianalyzer3FilterFreeStyle[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      free_style: cdktf.listMapper(logfortianalyzer3FilterFreeStyleToTerraform, true)(this._freeStyle.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      free_style: {
        value: cdktf.listMapperHcl(logfortianalyzer3FilterFreeStyleToHclTerraform, true)(this._freeStyle.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "Logfortianalyzer3FilterFreeStyleList",
      },
    };
