// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit
...
export interface FtpproxyExplicitConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit#id FtpproxyExplicit#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit#incoming_ip FtpproxyExplicit#incoming_ip}
  */
  readonly incomingIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit#incoming_port FtpproxyExplicit#incoming_port}
  */
  readonly incomingPort?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit#outgoing_ip FtpproxyExplicit#outgoing_ip}
  */
  readonly outgoingIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit#sec_default_action FtpproxyExplicit#sec_default_action}
  */
  readonly secDefaultAction?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit#server_data_mode FtpproxyExplicit#server_data_mode}
  */
  readonly serverDataMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit#ssl FtpproxyExplicit#ssl}
  */
  readonly ssl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit#ssl_algorithm FtpproxyExplicit#ssl_algorithm}
  */
  readonly sslAlgorithm?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit#ssl_cert FtpproxyExplicit#ssl_cert}
  */
  readonly sslCert?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit#ssl_dh_bits FtpproxyExplicit#ssl_dh_bits}
  */
  readonly sslDhBits?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit#status FtpproxyExplicit#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit#vdomparam FtpproxyExplicit#vdomparam}
  */
  readonly vdomparam?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit fortios_ftpproxy_explicit}
*/
export class FtpproxyExplicit extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortios_ftpproxy_explicit";
  ...
  * @param importFromId The id of the existing FtpproxyExplicit that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the FtpproxyExplicit to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortios_ftpproxy_explicit", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/ftpproxy_explicit fortios_ftpproxy_explicit} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: FtpproxyExplicitConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortios_ftpproxy_explicit',
  ...
  public get incomingPort() {
    return this.getStringAttribute('incoming_port');
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      incoming_port: cdktf.stringToTerraform(this._incomingPort),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      incoming_port: {
        value: cdktf.stringToHclTerraform(this._incomingPort),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
