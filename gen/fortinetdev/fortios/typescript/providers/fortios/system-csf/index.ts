// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf
...
export interface SystemCsfConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#accept_auth_by_cert SystemCsf#accept_auth_by_cert}
  */
  readonly acceptAuthByCert?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#authorization_request_type SystemCsf#authorization_request_type}
  */
  readonly authorizationRequestType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#certificate SystemCsf#certificate}
  */
  readonly certificate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#configuration_sync SystemCsf#configuration_sync}
  */
  readonly configurationSync?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#downstream_access SystemCsf#downstream_access}
  */
  readonly downstreamAccess?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#downstream_accprofile SystemCsf#downstream_accprofile}
  */
  readonly downstreamAccprofile?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#dynamic_sort_subtable SystemCsf#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#fabric_object_unification SystemCsf#fabric_object_unification}
  */
  readonly fabricObjectUnification?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#fabric_workers SystemCsf#fabric_workers}
  */
  readonly fabricWorkers?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#file_mgmt SystemCsf#file_mgmt}
  */
  readonly fileMgmt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#file_quota SystemCsf#file_quota}
  */
  readonly fileQuota?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#file_quota_warning SystemCsf#file_quota_warning}
  */
  readonly fileQuotaWarning?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#fixed_key SystemCsf#fixed_key}
  */
  readonly fixedKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#forticloud_account_enforcement SystemCsf#forticloud_account_enforcement}
  */
  readonly forticloudAccountEnforcement?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#get_all_tables SystemCsf#get_all_tables}
  */
  readonly fetchAllTables?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#group_name SystemCsf#group_name}
  */
  readonly groupName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#group_password SystemCsf#group_password}
  */
  readonly groupPassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#id SystemCsf#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#legacy_authentication SystemCsf#legacy_authentication}
  */
  readonly legacyAuthentication?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#log_unification SystemCsf#log_unification}
  */
  readonly logUnification?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#management_ip SystemCsf#management_ip}
  */
  readonly managementIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#management_port SystemCsf#management_port}
  */
  readonly managementPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#saml_configuration_sync SystemCsf#saml_configuration_sync}
  */
  readonly samlConfigurationSync?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#source_ip SystemCsf#source_ip}
  */
  readonly sourceIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#status SystemCsf#status}
  */
  readonly status: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#uid SystemCsf#uid}
  */
  readonly uid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#upstream SystemCsf#upstream}
  */
  readonly upstream?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#upstream_interface SystemCsf#upstream_interface}
  */
  readonly upstreamInterface?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#upstream_interface_select_method SystemCsf#upstream_interface_select_method}
  */
  readonly upstreamInterfaceSelectMethod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#upstream_ip SystemCsf#upstream_ip}
  */
  readonly upstreamIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#upstream_port SystemCsf#upstream_port}
  */
  readonly upstreamPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#vdomparam SystemCsf#vdomparam}
  */
  readonly vdomparam?: string;
  /**
  * fabric_connector block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#fabric_connector SystemCsf#fabric_connector}
  */
  readonly fabricConnector?: SystemCsfFabricConnector[] | cdktf.IResolvable;
  /**
  * fabric_device block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#fabric_device SystemCsf#fabric_device}
  */
  readonly fabricDevice?: SystemCsfFabricDevice[] | cdktf.IResolvable;
  /**
  * trusted_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#trusted_list SystemCsf#trusted_list}
  */
  readonly trustedList?: SystemCsfTrustedListStruct[] | cdktf.IResolvable;
}
export interface SystemCsfFabricConnectorVdom {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#name SystemCsf#name}
  */
  readonly name?: string;
}

export function systemCsfFabricConnectorVdomToTerraform(struct?: SystemCsfFabricConnectorVdom | cdktf.IResolvable): any {
...
export function systemCsfFabricConnectorVdomToHclTerraform(struct?: SystemCsfFabricConnectorVdom | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SystemCsfFabricConnectorVdomOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SystemCsfFabricConnectorVdom | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SystemCsfFabricConnectorVdom | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SystemCsfFabricConnectorVdomList extends cdktf.ComplexList {
  public internalValue? : SystemCsfFabricConnectorVdom[] | cdktf.IResolvable
  ...
  */
  public get(index: number): SystemCsfFabricConnectorVdomOutputReference {
    return new SystemCsfFabricConnectorVdomOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface SystemCsfFabricConnector {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#accprofile SystemCsf#accprofile}
  */
  readonly accprofile?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#configuration_write_access SystemCsf#configuration_write_access}
  */
  readonly configurationWriteAccess?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#serial SystemCsf#serial}
  */
  readonly serial?: string;
  /**
  * vdom block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#vdom SystemCsf#vdom}
  */
  readonly vdom?: SystemCsfFabricConnectorVdom[] | cdktf.IResolvable;
}
...
export function systemCsfFabricConnectorToTerraform(struct?: SystemCsfFabricConnector | cdktf.IResolvable): any {
  ...
  return {
    ...
    vdom: cdktf.listMapper(systemCsfFabricConnectorVdomToTerraform, true)(struct!.vdom),
  }
}
...
export function systemCsfFabricConnectorToHclTerraform(struct?: SystemCsfFabricConnector | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    vdom: {
      value: cdktf.listMapperHcl(systemCsfFabricConnectorVdomToHclTerraform, true)(struct!.vdom),
      isBlock: true,
      type: "set",
      storageClassType: "SystemCsfFabricConnectorVdomList",
    },
  };
...
export class SystemCsfFabricConnectorOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _vdom = new SystemCsfFabricConnectorVdomList(this, "vdom", true);
  public get vdom() {
    return this._vdom;
  }
  public putVdom(value: SystemCsfFabricConnectorVdom[] | cdktf.IResolvable) {
...
export interface SystemCsfFabricDevice {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#access_token SystemCsf#access_token}
  */
  readonly accessToken?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#device_ip SystemCsf#device_ip}
  */
  readonly deviceIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#device_type SystemCsf#device_type}
  */
  readonly deviceType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#https_port SystemCsf#https_port}
  */
  readonly httpsPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#login SystemCsf#login}
  */
  ...
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#password SystemCsf#password}
  */
...
export interface SystemCsfTrustedListStruct {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#action SystemCsf#action}
  */
  readonly action?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#authorization_type SystemCsf#authorization_type}
  */
  ...
  */
  readonly certificate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#downstream_authorization SystemCsf#downstream_authorization}
  */
  readonly downstreamAuthorization?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#ha_members SystemCsf#ha_members}
  */
  readonly haMembers?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#index SystemCsf#index}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf fortios_system_csf}
*/
export class SystemCsf extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemCsf that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/system_csf fortios_system_csf} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // fixed_key - computed: false, optional: true, required: false
  ...
  // upstream_interface_select_method - computed: true, optional: true, required: false
  ...
  // upstream_ip - computed: true, optional: true, required: false
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      fixed_key: {
        value: cdktf.stringToHclTerraform(this._fixedKey),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      group_password: {
        value: cdktf.stringToHclTerraform(this._groupPassword),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
