// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine
...
export interface UserQuarantineConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#dynamic_sort_subtable UserQuarantine#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#firewall_groups UserQuarantine#firewall_groups}
  */
  readonly firewallGroups?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#get_all_tables UserQuarantine#get_all_tables}
  */
  readonly fetchAllTables?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#id UserQuarantine#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#quarantine UserQuarantine#quarantine}
  */
  readonly quarantine?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#traffic_policy UserQuarantine#traffic_policy}
  */
  readonly trafficPolicy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#vdomparam UserQuarantine#vdomparam}
  */
  readonly vdomparam?: string;
  /**
  * targets block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#targets UserQuarantine#targets}
  */
  readonly targets?: UserQuarantineTargets[] | cdktf.IResolvable;
}
export interface UserQuarantineTargetsMacs {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#description UserQuarantine#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#drop UserQuarantine#drop}
  */
  readonly drop?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#entry_id UserQuarantine#entry_id}
  */
  readonly entryId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#mac UserQuarantine#mac}
  */
  readonly mac?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#parent UserQuarantine#parent}
  */
...
export interface UserQuarantineTargets {
  ...
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#entry UserQuarantine#entry}
  */
  readonly entry?: string;
  /**
  * macs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#macs UserQuarantine#macs}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine fortios_user_quarantine}
*/
export class UserQuarantine extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortios_user_quarantine";
  ...
  * @param importFromId The id of the existing UserQuarantine that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the UserQuarantine to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortios_user_quarantine", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/user_quarantine fortios_user_quarantine} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: UserQuarantineConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortios_user_quarantine',
  ...
  // firewall_groups - computed: false, optional: true, required: false
  private _firewallGroups?: string; 
  public get firewallGroups() {
    return this.getStringAttribute('firewall_groups');
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      firewall_groups: cdktf.stringToTerraform(this._firewallGroups),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      firewall_groups: {
        value: cdktf.stringToHclTerraform(this._firewallGroups),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
