// https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard
...
export interface WebfilterFortiguardConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#cache_mem_percent WebfilterFortiguard#cache_mem_percent}
  */
  readonly cacheMemPercent?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#cache_mem_permille WebfilterFortiguard#cache_mem_permille}
  */
  readonly cacheMemPermille?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#cache_mode WebfilterFortiguard#cache_mode}
  */
  readonly cacheMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#cache_prefix_match WebfilterFortiguard#cache_prefix_match}
  */
  readonly cachePrefixMatch?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#close_ports WebfilterFortiguard#close_ports}
  */
  readonly closePorts?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#embed_image WebfilterFortiguard#embed_image}
  */
  readonly embedImage?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#id WebfilterFortiguard#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#ovrd_auth_https WebfilterFortiguard#ovrd_auth_https}
  */
  readonly ovrdAuthHttps?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#ovrd_auth_port WebfilterFortiguard#ovrd_auth_port}
  */
  readonly ovrdAuthPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#ovrd_auth_port_http WebfilterFortiguard#ovrd_auth_port_http}
  */
  readonly ovrdAuthPortHttp?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#ovrd_auth_port_https WebfilterFortiguard#ovrd_auth_port_https}
  */
  readonly ovrdAuthPortHttps?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#ovrd_auth_port_https_flow WebfilterFortiguard#ovrd_auth_port_https_flow}
  */
  readonly ovrdAuthPortHttpsFlow?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#ovrd_auth_port_warning WebfilterFortiguard#ovrd_auth_port_warning}
  */
  readonly ovrdAuthPortWarning?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#request_packet_size_limit WebfilterFortiguard#request_packet_size_limit}
  */
  readonly requestPacketSizeLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#vdomparam WebfilterFortiguard#vdomparam}
  */
  readonly vdomparam?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#warn_auth_https WebfilterFortiguard#warn_auth_https}
  */
  readonly warnAuthHttps?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard fortios_webfilter_fortiguard}
*/
export class WebfilterFortiguard extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortios_webfilter_fortiguard";
  ...
  * @param importFromId The id of the existing WebfilterFortiguard that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortios_webfilter_fortiguard", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortios/1.23.0/docs/resources/webfilter_fortiguard fortios_webfilter_fortiguard} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: WebfilterFortiguardConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortios_webfilter_fortiguard',
    ...
    this._ovrdAuthPort = config.ovrdAuthPort;
  ...
  // ovrd_auth_port - computed: false, optional: true, required: false
  private _ovrdAuthPort?: number; 
  public get ovrdAuthPort() {
    return this.getNumberAttribute('ovrd_auth_port');
  }
  public set ovrdAuthPort(value: number) {
    this._ovrdAuthPort = value;
  }
  public resetOvrdAuthPort() {
    this._ovrdAuthPort = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get ovrdAuthPortInput() {
    return this._ovrdAuthPort;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ovrd_auth_port: cdktf.numberToTerraform(this._ovrdAuthPort),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ovrd_auth_port: {
        value: cdktf.numberToHclTerraform(this._ovrdAuthPort),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
