...
export class ObjectWebproxyIsolatorserver extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_webproxy_isolatorserver";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_webproxy_isolatorserver", importId: importFromId, provider });
      }
  ...
  * @param options ObjectWebproxyIsolatorserverConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ObjectWebproxyIsolatorserverConfig = {}) {
    super(scope, id, {
