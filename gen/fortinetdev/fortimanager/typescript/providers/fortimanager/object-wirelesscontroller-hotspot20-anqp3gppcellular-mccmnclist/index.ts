...
export class ObjectWirelesscontrollerHotspot20Anqp3GppcellularMccmnclist extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_wirelesscontroller_hotspot20_anqp3gppcellular_mccmnclist";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_wirelesscontroller_hotspot20_anqp3gppcellular_mccmnclist", importId: importFromId, provider });
      }
  ...
  * @param options ObjectWirelesscontrollerHotspot20Anqp3GppcellularMccmnclistConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectWirelesscontrollerHotspot20Anqp3GppcellularMccmnclistConfig) {
    super(scope, id, {
