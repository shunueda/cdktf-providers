...
export class ObjectEmailfilterProfileSmtpA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_emailfilter_profile_smtp";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_emailfilter_profile_smtp", importId: importFromId, provider });
      }
  ...
  * @param options ObjectEmailfilterProfileSmtpAConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectEmailfilterProfileSmtpAConfig) {
    super(scope, id, {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      hdrip: cdktf.stringToTerraform(this._hdrip),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      hdrip: {
        value: cdktf.stringToHclTerraform(this._hdrip),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
