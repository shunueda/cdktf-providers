...
export class ObjectSystemGeoipcountry extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_system_geoipcountry";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_system_geoipcountry", importId: importFromId, provider });
      }
  ...
  * @param options ObjectSystemGeoipcountryConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ObjectSystemGeoipcountryConfig = {}) {
    super(scope, id, {
