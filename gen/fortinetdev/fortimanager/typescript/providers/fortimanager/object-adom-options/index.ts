// https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_adom_options
...
export interface ObjectAdomOptionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_adom_options#adom ObjectAdomOptions#adom}
  */
  readonly adom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_adom_options#assign_excluded ObjectAdomOptions#assign_excluded}
  */
  readonly assignExcluded?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_adom_options#assign_name ObjectAdomOptions#assign_name}
  */
  readonly assignName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_adom_options#id ObjectAdomOptions#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_adom_options#scopetype ObjectAdomOptions#scopetype}
  */
  readonly scopetype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_adom_options#specify_assign_pkg_list ObjectAdomOptions#specify_assign_pkg_list}
  */
  readonly specifyAssignPkgList?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_adom_options fortimanager_object_adom_options}
*/
export class ObjectAdomOptions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObjectAdomOptions that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_adom_options#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_adom_options fortimanager_object_adom_options} Resource
  *
  * @param scope The scope in which to define this construct
