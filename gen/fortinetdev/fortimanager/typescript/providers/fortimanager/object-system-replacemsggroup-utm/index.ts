...
export class ObjectSystemReplacemsggroupUtmA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_system_replacemsggroup_utm";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_system_replacemsggroup_utm", importId: importFromId, provider });
      }
  ...
  * @param options ObjectSystemReplacemsggroupUtmAConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectSystemReplacemsggroupUtmAConfig) {
    super(scope, id, {
