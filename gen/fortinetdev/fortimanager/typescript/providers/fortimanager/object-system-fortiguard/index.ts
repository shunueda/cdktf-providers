...
export class ObjectSystemFortiguard extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_system_fortiguard";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_system_fortiguard", importId: importFromId, provider });
      }
  ...
  * @param options ObjectSystemFortiguardConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ObjectSystemFortiguardConfig = {}) {
    super(scope, id, {
  ...
  // auto_join_forticloud - computed: false, optional: true, required: false
  ...
  // outbreak_prevention_expiration - computed: false, optional: true, required: false
  ...
  // outbreak_prevention_timeout - computed: true, optional: true, required: false
  ...
  public resetOutbreakPreventionTimeout() {
    this._outbreakPreventionTimeout = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  // sdns_options - computed: true, optional: true, required: false
  private _sdnsOptions?: string[]; 
  public get sdnsOptions() {
    return cdktf.Fn.tolist(this.getListAttribute('sdns_options'));
  }
  ...
  // sdns_server_ip - computed: true, optional: true, required: false
  private _sdnsServerIp?: string[]; 
  public get sdnsServerIp() {
    return cdktf.Fn.tolist(this.getListAttribute('sdns_server_ip'));
  }
  ...
  // videofilter_expiration - computed: false, optional: true, required: false
  ...
  // webfilter_expiration - computed: false, optional: true, required: false
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sdns_options: cdktf.listMapper(cdktf.stringToTerraform, false)(this._sdnsOptions),
      sdns_server_ip: cdktf.listMapper(cdktf.stringToTerraform, false)(this._sdnsServerIp),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sdns_options: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._sdnsOptions),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      sdns_server_ip: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._sdnsServerIp),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
