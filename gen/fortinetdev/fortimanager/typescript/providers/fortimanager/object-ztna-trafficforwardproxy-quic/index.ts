// https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic
...
export interface ObjectZtnaTrafficforwardproxyQuicAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic#ack_delay_exponent ObjectZtnaTrafficforwardproxyQuicA#ack_delay_exponent}
  */
  readonly ackDelayExponent?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic#active_connection_id_limit ObjectZtnaTrafficforwardproxyQuicA#active_connection_id_limit}
  */
  readonly activeConnectionIdLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic#active_migration ObjectZtnaTrafficforwardproxyQuicA#active_migration}
  */
  readonly activeMigration?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic#adom ObjectZtnaTrafficforwardproxyQuicA#adom}
  */
  readonly adom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic#grease_quic_bit ObjectZtnaTrafficforwardproxyQuicA#grease_quic_bit}
  */
  readonly greaseQuicBit?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic#id ObjectZtnaTrafficforwardproxyQuicA#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic#max_ack_delay ObjectZtnaTrafficforwardproxyQuicA#max_ack_delay}
  */
  readonly maxAckDelay?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic#max_datagram_frame_size ObjectZtnaTrafficforwardproxyQuicA#max_datagram_frame_size}
  */
  readonly maxDatagramFrameSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic#max_idle_timeout ObjectZtnaTrafficforwardproxyQuicA#max_idle_timeout}
  */
  readonly maxIdleTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic#max_udp_payload_size ObjectZtnaTrafficforwardproxyQuicA#max_udp_payload_size}
  */
  readonly maxUdpPayloadSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic#scopetype ObjectZtnaTrafficforwardproxyQuicA#scopetype}
  */
  readonly scopetype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic#traffic_forward_proxy ObjectZtnaTrafficforwardproxyQuicA#traffic_forward_proxy}
  */
  readonly trafficForwardProxy: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic fortimanager_object_ztna_trafficforwardproxy_quic}
*/
export class ObjectZtnaTrafficforwardproxyQuicA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_ztna_trafficforwardproxy_quic";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a ObjectZtnaTrafficforwardproxyQuicA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ObjectZtnaTrafficforwardproxyQuicA to import
  * @param importFromId The id of the existing ObjectZtnaTrafficforwardproxyQuicA that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ObjectZtnaTrafficforwardproxyQuicA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_ztna_trafficforwardproxy_quic", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_trafficforwardproxy_quic fortimanager_object_ztna_trafficforwardproxy_quic} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ObjectZtnaTrafficforwardproxyQuicAConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectZtnaTrafficforwardproxyQuicAConfig) {
    super(scope, id, {
      terraformResourceType: 'fortimanager_object_ztna_trafficforwardproxy_quic',
