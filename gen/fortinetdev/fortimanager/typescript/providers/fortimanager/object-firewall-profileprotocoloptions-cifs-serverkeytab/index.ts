...
export class ObjectFirewallProfileprotocoloptionsCifsServerkeytab extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_firewall_profileprotocoloptions_cifs_serverkeytab";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_firewall_profileprotocoloptions_cifs_serverkeytab", importId: importFromId, provider });
      }
  ...
  * @param options ObjectFirewallProfileprotocoloptionsCifsServerkeytabConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectFirewallProfileprotocoloptionsCifsServerkeytabConfig) {
    super(scope, id, {
