...
export function objectDynamicMulticastInterfaceDynamicMappingScopeAToTerraform(struct?: ObjectDynamicMulticastInterfaceDynamicMappingScopeA | cdktf.IResolvable): any {
...
export function objectDynamicMulticastInterfaceDynamicMappingScopeAToHclTerraform(struct?: ObjectDynamicMulticastInterfaceDynamicMappingScopeA | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ObjectDynamicMulticastInterfaceDynamicMappingScopeAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ObjectDynamicMulticastInterfaceDynamicMappingScopeA | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ObjectDynamicMulticastInterfaceDynamicMappingScopeA | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ObjectDynamicMulticastInterfaceDynamicMappingScopeAList extends cdktf.ComplexList {
  public internalValue? : ObjectDynamicMulticastInterfaceDynamicMappingScopeA[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ObjectDynamicMulticastInterfaceDynamicMappingScopeAOutputReference {
    return new ObjectDynamicMulticastInterfaceDynamicMappingScopeAOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ObjectDynamicMulticastInterfaceDynamicMappingA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_dynamic_multicast_interface_dynamic_mapping";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_dynamic_multicast_interface_dynamic_mapping", importId: importFromId, provider });
      }
  ...
  * @param options ObjectDynamicMulticastInterfaceDynamicMappingAConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectDynamicMulticastInterfaceDynamicMappingAConfig) {
    super(scope, id, {
  ...
  private _scope = new ObjectDynamicMulticastInterfaceDynamicMappingScopeAList(this, "_scope", false);
  public get scope() {
    return this._scope;
  }
  public putScope(value: ObjectDynamicMulticastInterfaceDynamicMappingScopeA[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      local_intf: cdktf.stringToTerraform(this._localIntf),
      scopetype: cdktf.stringToTerraform(this._scopetype),
      _scope: cdktf.listMapper(objectDynamicMulticastInterfaceDynamicMappingScopeAToTerraform, true)(this._scope.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      local_intf: {
        value: cdktf.stringToHclTerraform(this._localIntf),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      _scope: {
        value: cdktf.listMapperHcl(objectDynamicMulticastInterfaceDynamicMappingScopeAToHclTerraform, true)(this._scope.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ObjectDynamicMulticastInterfaceDynamicMappingScopeAList",
      },
    };
