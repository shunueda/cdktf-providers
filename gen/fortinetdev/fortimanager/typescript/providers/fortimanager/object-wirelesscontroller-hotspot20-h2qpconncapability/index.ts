...
export class ObjectWirelesscontrollerHotspot20H2Qpconncapability extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_wirelesscontroller_hotspot20_h2qpconncapability";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_wirelesscontroller_hotspot20_h2qpconncapability", importId: importFromId, provider });
      }
  ...
  * @param options ObjectWirelesscontrollerHotspot20H2QpconncapabilityConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ObjectWirelesscontrollerHotspot20H2QpconncapabilityConfig = {}) {
    super(scope, id, {
