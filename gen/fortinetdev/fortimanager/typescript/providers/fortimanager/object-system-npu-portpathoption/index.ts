// https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_portpathoption
...
export interface ObjectSystemNpuPortpathoptionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_portpathoption#adom ObjectSystemNpuPortpathoption#adom}
  */
  readonly adom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_portpathoption#id ObjectSystemNpuPortpathoption#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_portpathoption#ports_using_npu ObjectSystemNpuPortpathoption#ports_using_npu}
  */
  readonly portsUsingNpu?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_portpathoption#scopetype ObjectSystemNpuPortpathoption#scopetype}
  */
  readonly scopetype?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_portpathoption fortimanager_object_system_npu_portpathoption}
*/
export class ObjectSystemNpuPortpathoption extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObjectSystemNpuPortpathoption that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_portpathoption#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_portpathoption fortimanager_object_system_npu_portpathoption} Resource
  *
  * @param scope The scope in which to define this construct
