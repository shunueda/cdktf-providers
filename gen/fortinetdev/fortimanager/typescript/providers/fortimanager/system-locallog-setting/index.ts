// https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_locallog_setting
...
export interface SystemLocallogSettingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_locallog_setting#id SystemLocallogSetting#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_locallog_setting#log_daemon_crash SystemLocallogSetting#log_daemon_crash}
  */
  readonly logDaemonCrash?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_locallog_setting#log_interval_adom_perf_stats SystemLocallogSetting#log_interval_adom_perf_stats}
  */
  readonly logIntervalAdomPerfStats?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_locallog_setting#log_interval_dev_no_logging SystemLocallogSetting#log_interval_dev_no_logging}
  */
  readonly logIntervalDevNoLogging?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_locallog_setting#log_interval_disk_full SystemLocallogSetting#log_interval_disk_full}
  */
  readonly logIntervalDiskFull?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_locallog_setting#log_interval_gbday_exceeded SystemLocallogSetting#log_interval_gbday_exceeded}
  */
  readonly logIntervalGbdayExceeded?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_locallog_setting#no_log_detection_threshold SystemLocallogSetting#no_log_detection_threshold}
  */
  readonly noLogDetectionThreshold?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_locallog_setting fortimanager_system_locallog_setting}
*/
export class SystemLocallogSetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemLocallogSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_locallog_setting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_locallog_setting fortimanager_system_locallog_setting} Resource
  *
  * @param scope The scope in which to define this construct
