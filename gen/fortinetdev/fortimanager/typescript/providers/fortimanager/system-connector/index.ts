// https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_connector
...
export interface SystemConnectorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_connector#cloud_orchest_refresh_interval SystemConnector#cloud_orchest_refresh_interval}
  */
  readonly cloudOrchestRefreshInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_connector#conn_refresh_interval SystemConnector#conn_refresh_interval}
  */
  readonly connRefreshInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_connector#conn_ssl_protocol SystemConnector#conn_ssl_protocol}
  */
  readonly connSslProtocol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_connector#faznotify_msg_queue_max SystemConnector#faznotify_msg_queue_max}
  */
  readonly faznotifyMsgQueueMax?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_connector#faznotify_msg_timeout SystemConnector#faznotify_msg_timeout}
  */
  readonly faznotifyMsgTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_connector#fsso_refresh_interval SystemConnector#fsso_refresh_interval}
  */
  readonly fssoRefreshInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_connector#fsso_sess_timeout SystemConnector#fsso_sess_timeout}
  */
  readonly fssoSessTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_connector#id SystemConnector#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_connector#px_refresh_interval SystemConnector#px_refresh_interval}
  */
  readonly pxRefreshInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_connector#px_svr_timeout SystemConnector#px_svr_timeout}
  */
  readonly pxSvrTimeout?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_connector fortimanager_system_connector}
*/
export class SystemConnector extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_connector fortimanager_system_connector} Resource
  *
  * @param scope The scope in which to define this construct
