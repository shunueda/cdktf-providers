...
export class PackagesFirewallMulticastpolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_packages_firewall_multicastpolicy";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_packages_firewall_multicastpolicy", importId: importFromId, provider });
      }
  ...
  * @param options PackagesFirewallMulticastpolicyConfig
  */
  public constructor(scope: Construct, id: string, config: PackagesFirewallMulticastpolicyConfig) {
    super(scope, id, {
