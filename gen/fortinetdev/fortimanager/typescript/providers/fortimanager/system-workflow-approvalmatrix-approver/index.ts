// https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_workflow_approvalmatrix_approver
...
export interface SystemWorkflowApprovalmatrixApproverAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_workflow_approvalmatrix_approver#approval_matrix SystemWorkflowApprovalmatrixApproverA#approval_matrix}
  */
  readonly approvalMatrix: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_workflow_approvalmatrix_approver#id SystemWorkflowApprovalmatrixApproverA#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_workflow_approvalmatrix_approver#member SystemWorkflowApprovalmatrixApproverA#member}
  */
  readonly member?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_workflow_approvalmatrix_approver#seq_num SystemWorkflowApprovalmatrixApproverA#seq_num}
  */
  readonly seqNum?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_workflow_approvalmatrix_approver fortimanager_system_workflow_approvalmatrix_approver}
*/
export class SystemWorkflowApprovalmatrixApproverA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemWorkflowApprovalmatrixApproverA that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_workflow_approvalmatrix_approver#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_workflow_approvalmatrix_approver fortimanager_system_workflow_approvalmatrix_approver} Resource
  *
  * @param scope The scope in which to define this construct
