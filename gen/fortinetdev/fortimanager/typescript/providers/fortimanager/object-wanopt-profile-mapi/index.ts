...
export class ObjectWanoptProfileMapiA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_wanopt_profile_mapi";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_wanopt_profile_mapi", importId: importFromId, provider });
      }
  ...
  * @param options ObjectWanoptProfileMapiAConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectWanoptProfileMapiAConfig) {
    super(scope, id, {
