// https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/securityconsole_package_cancel_install
...
export interface SecurityconsolePackageCancelInstallConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/securityconsole_package_cancel_install#fmgadom SecurityconsolePackageCancelInstall#fmgadom}
  */
  readonly fmgadom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/securityconsole_package_cancel_install#force_recreate SecurityconsolePackageCancelInstall#force_recreate}
  */
  readonly forceRecreate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/securityconsole_package_cancel_install#id SecurityconsolePackageCancelInstall#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/securityconsole_package_cancel_install fortimanager_securityconsole_package_cancel_install}
*/
export class SecurityconsolePackageCancelInstall extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityconsolePackageCancelInstall that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/securityconsole_package_cancel_install#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/securityconsole_package_cancel_install fortimanager_securityconsole_package_cancel_install} Resource
  *
  * @param scope The scope in which to define this construct
