...
export class ObjectWirelesscontrollerHotspot20H2Qptermsandconditions extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_wirelesscontroller_hotspot20_h2qptermsandconditions";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_wirelesscontroller_hotspot20_h2qptermsandconditions", importId: importFromId, provider });
      }
  ...
  * @param options ObjectWirelesscontrollerHotspot20H2QptermsandconditionsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ObjectWirelesscontrollerHotspot20H2QptermsandconditionsConfig = {}) {
    super(scope, id, {
