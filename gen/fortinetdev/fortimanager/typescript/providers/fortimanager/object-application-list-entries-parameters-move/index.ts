...
export class ObjectApplicationListEntriesParametersMove extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_application_list_entries_parameters_move";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_application_list_entries_parameters_move", importId: importFromId, provider });
      }
  ...
  * @param options ObjectApplicationListEntriesParametersMoveConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectApplicationListEntriesParametersMoveConfig) {
    super(scope, id, {
