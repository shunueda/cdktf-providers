...
export class PackagesFirewallShapingpolicyMove extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_packages_firewall_shapingpolicy_move";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_packages_firewall_shapingpolicy_move", importId: importFromId, provider });
      }
  ...
  * @param options PackagesFirewallShapingpolicyMoveConfig
  */
  public constructor(scope: Construct, id: string, config: PackagesFirewallShapingpolicyMoveConfig) {
    super(scope, id, {
    ...
    this._shapingPolicy = config.shapingPolicy;
  ...
  // shaping_policy - computed: false, optional: false, required: true
  private _shapingPolicy?: string; 
  public get shapingPolicy() {
    return this.getStringAttribute('shaping_policy');
  }
  public set shapingPolicy(value: string) {
    this._shapingPolicy = value;
  }
  // Temporarily expose input value. Use with caution.
  public get shapingPolicyInput() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      shaping_policy: cdktf.stringToTerraform(this._shapingPolicy),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      shaping_policy: {
        value: cdktf.stringToHclTerraform(this._shapingPolicy),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
