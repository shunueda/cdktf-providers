...
export class ObjectExtendercontrollerExtenderprofileCellularModem2A extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_extendercontroller_extenderprofile_cellular_modem2";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_extendercontroller_extenderprofile_cellular_modem2", importId: importFromId, provider });
      }
  ...
  * @param options ObjectExtendercontrollerExtenderprofileCellularModem2AConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectExtendercontrollerExtenderprofileCellularModem2AConfig) {
    super(scope, id, {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      auto_switch: objectExtendercontrollerExtenderprofileCellularModem2AutoSwitchAToTerraform(this._autoSwitch.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      auto_switch: {
        value: objectExtendercontrollerExtenderprofileCellularModem2AutoSwitchAToHclTerraform(this._autoSwitch.internalValue),
        isBlock: true,
        type: "list",
