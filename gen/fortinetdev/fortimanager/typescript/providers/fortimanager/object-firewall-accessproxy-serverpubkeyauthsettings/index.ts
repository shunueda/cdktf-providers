...
export class ObjectFirewallAccessproxyServerpubkeyauthsettings extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_firewall_accessproxy_serverpubkeyauthsettings";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_firewall_accessproxy_serverpubkeyauthsettings", importId: importFromId, provider });
      }
  ...
  * @param options ObjectFirewallAccessproxyServerpubkeyauthsettingsConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectFirewallAccessproxyServerpubkeyauthsettingsConfig) {
    super(scope, id, {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      cert_extension: cdktf.listMapper(objectFirewallAccessproxyServerpubkeyauthsettingsCertExtensionToTerraform, true)(this._certExtension.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      cert_extension: {
        value: cdktf.listMapperHcl(objectFirewallAccessproxyServerpubkeyauthsettingsCertExtensionToHclTerraform, true)(this._certExtension.internalValue),
        isBlock: true,
        type: "list",
