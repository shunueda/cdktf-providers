...
export class ObjectWirelesscontrollerWtpprofileLbsA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_wirelesscontroller_wtpprofile_lbs";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_wirelesscontroller_wtpprofile_lbs", importId: importFromId, provider });
      }
  ...
  * @param options ObjectWirelesscontrollerWtpprofileLbsAConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectWirelesscontrollerWtpprofileLbsAConfig) {
    super(scope, id, {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      polestar_asset_addrgrp_list: cdktf.stringToTerraform(this._polestarAssetAddrgrpList),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      polestar_asset_addrgrp_list: {
        value: cdktf.stringToHclTerraform(this._polestarAssetAddrgrpList),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
