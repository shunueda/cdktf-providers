...
export class ObjectSystemReplacemsggroupAutomationA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_system_replacemsggroup_automation";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_system_replacemsggroup_automation", importId: importFromId, provider });
      }
  ...
  * @param options ObjectSystemReplacemsggroupAutomationAConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectSystemReplacemsggroupAutomationAConfig) {
    super(scope, id, {
