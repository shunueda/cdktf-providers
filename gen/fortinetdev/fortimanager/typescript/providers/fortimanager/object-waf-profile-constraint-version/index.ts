...
export class ObjectWafProfileConstraintVersionA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_waf_profile_constraint_version";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_waf_profile_constraint_version", importId: importFromId, provider });
      }
  ...
  * @param options ObjectWafProfileConstraintVersionAConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectWafProfileConstraintVersionAConfig) {
    super(scope, id, {
