...
export class PackagesFirewallInterfacepolicy6Move extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_packages_firewall_interfacepolicy6_move";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_packages_firewall_interfacepolicy6_move", importId: importFromId, provider });
      }
  ...
  * @param options PackagesFirewallInterfacepolicy6MoveConfig
  */
  public constructor(scope: Construct, id: string, config: PackagesFirewallInterfacepolicy6MoveConfig) {
    super(scope, id, {
    ...
    this._id = config.id;
    this._interfacePolicy6 = config.interfacePolicy6;
  ...
  // interface_policy6 - computed: false, optional: false, required: true
  private _interfacePolicy6?: string; 
  public get interfacePolicy6() {
    return this.getStringAttribute('interface_policy6');
  }
  public set interfacePolicy6(value: string) {
    this._interfacePolicy6 = value;
  }
  // Temporarily expose input value. Use with caution.
  public get interfacePolicy6Input() {
    return this._interfacePolicy6;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      interface_policy6: cdktf.stringToTerraform(this._interfacePolicy6),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      interface_policy6: {
        value: cdktf.stringToHclTerraform(this._interfacePolicy6),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
