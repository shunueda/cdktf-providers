...
export class ObjectWirelesscontrollerQosprofile extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_wirelesscontroller_qosprofile";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_wirelesscontroller_qosprofile", importId: importFromId, provider });
      }
  ...
  * @param options ObjectWirelesscontrollerQosprofileConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ObjectWirelesscontrollerQosprofileConfig = {}) {
    super(scope, id, {
  ...
  // wmm_be_dscp - computed: true, optional: true, required: false
