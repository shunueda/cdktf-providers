...
export class ObjectDlpDictionaryEntriesA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_dlp_dictionary_entries";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_dlp_dictionary_entries", importId: importFromId, provider });
      }
  ...
  * @param options ObjectDlpDictionaryEntriesAConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectDlpDictionaryEntriesAConfig) {
    super(scope, id, {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ignore_case: cdktf.stringToTerraform(this._ignoreCase),
