...
export function objectSpamfilterBwordEntriesToTerraform(struct?: ObjectSpamfilterBwordEntries | cdktf.IResolvable): any {
...
export function objectSpamfilterBwordEntriesToHclTerraform(struct?: ObjectSpamfilterBwordEntries | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ObjectSpamfilterBwordEntriesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ObjectSpamfilterBwordEntries | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ObjectSpamfilterBwordEntries | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ObjectSpamfilterBwordEntriesList extends cdktf.ComplexList {
  public internalValue? : ObjectSpamfilterBwordEntries[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ObjectSpamfilterBwordEntriesOutputReference {
    return new ObjectSpamfilterBwordEntriesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ObjectSpamfilterBword extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_spamfilter_bword";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_spamfilter_bword", importId: importFromId, provider });
      }
  ...
  * @param options ObjectSpamfilterBwordConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ObjectSpamfilterBwordConfig = {}) {
    super(scope, id, {
  ...
  private _entries = new ObjectSpamfilterBwordEntriesList(this, "entries", false);
  public get entries() {
    return this._entries;
  }
  public putEntries(value: ObjectSpamfilterBwordEntries[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      entries: cdktf.listMapper(objectSpamfilterBwordEntriesToTerraform, true)(this._entries.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      entries: {
        value: cdktf.listMapperHcl(objectSpamfilterBwordEntriesToHclTerraform, true)(this._entries.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ObjectSpamfilterBwordEntriesList",
      },
    };
