...
export class ObjectUserPxgrid extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_user_pxgrid";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_user_pxgrid", importId: importFromId, provider });
      }
  ...
  * @param options ObjectUserPxgridConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ObjectUserPxgridConfig = {}) {
    super(scope, id, {
