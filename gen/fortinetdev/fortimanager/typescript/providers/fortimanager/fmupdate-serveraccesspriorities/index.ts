// https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/fmupdate_serveraccesspriorities
...
export interface FmupdateServeraccessprioritiesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/fmupdate_serveraccesspriorities#access_public FmupdateServeraccesspriorities#access_public}
  */
  readonly accessPublic?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/fmupdate_serveraccesspriorities#av_ips FmupdateServeraccesspriorities#av_ips}
  */
  readonly avIps?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/fmupdate_serveraccesspriorities#dynamic_sort_subtable FmupdateServeraccesspriorities#dynamic_sort_subtable}
  */
  readonly dynamicSortSubtable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/fmupdate_serveraccesspriorities#id FmupdateServeraccesspriorities#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/fmupdate_serveraccesspriorities#web_spam FmupdateServeraccesspriorities#web_spam}
  */
  readonly webSpam?: string;
  /**
  * private_server block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/fmupdate_serveraccesspriorities#private_server FmupdateServeraccesspriorities#private_server}
  */
...
export interface FmupdateServeraccessprioritiesPrivateServer {
  ...
  */
  readonly id?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/fmupdate_serveraccesspriorities#ip FmupdateServeraccesspriorities#ip}
  */
  readonly ip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/fmupdate_serveraccesspriorities#ip6 FmupdateServeraccesspriorities#ip6}
  */
  readonly ip6?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/fmupdate_serveraccesspriorities#time_zone FmupdateServeraccesspriorities#time_zone}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/fmupdate_serveraccesspriorities fortimanager_fmupdate_serveraccesspriorities}
*/
export class FmupdateServeraccesspriorities extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_fmupdate_serveraccesspriorities";
  ...
  * @param importFromId The id of the existing FmupdateServeraccesspriorities that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/fmupdate_serveraccesspriorities#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_fmupdate_serveraccesspriorities", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/fmupdate_serveraccesspriorities fortimanager_fmupdate_serveraccesspriorities} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: FmupdateServeraccessprioritiesConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'fortimanager_fmupdate_serveraccesspriorities',
