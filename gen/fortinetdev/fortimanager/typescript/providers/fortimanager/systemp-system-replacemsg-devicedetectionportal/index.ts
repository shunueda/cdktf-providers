...
export class SystempSystemReplacemsgDevicedetectionportal extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_systemp_system_replacemsg_devicedetectionportal";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_systemp_system_replacemsg_devicedetectionportal", importId: importFromId, provider });
      }
  ...
  * @param options SystempSystemReplacemsgDevicedetectionportalConfig
  */
  public constructor(scope: Construct, id: string, config: SystempSystemReplacemsgDevicedetectionportalConfig) {
    super(scope, id, {
