...
export class ObjectFirewallAccessproxy6ApigatewaySslciphersuites extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_firewall_accessproxy6_apigateway_sslciphersuites";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_firewall_accessproxy6_apigateway_sslciphersuites", importId: importFromId, provider });
      }
  ...
  * @param options ObjectFirewallAccessproxy6ApigatewaySslciphersuitesConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectFirewallAccessproxy6ApigatewaySslciphersuitesConfig) {
    super(scope, id, {
