...
export class PackagesGlobalHeaderShapingpolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_packages_global_header_shapingpolicy";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_packages_global_header_shapingpolicy", importId: importFromId, provider });
      }
  ...
  * @param options PackagesGlobalHeaderShapingpolicyConfig
  */
  public constructor(scope: Construct, id: string, config: PackagesGlobalHeaderShapingpolicyConfig) {
    super(scope, id, {
