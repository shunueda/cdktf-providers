...
export function securityconsolePackageCommitScopeToTerraform(struct?: SecurityconsolePackageCommitScope | cdktf.IResolvable): any {
...
export function securityconsolePackageCommitScopeToHclTerraform(struct?: SecurityconsolePackageCommitScope | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SecurityconsolePackageCommitScopeOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SecurityconsolePackageCommitScope | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SecurityconsolePackageCommitScope | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SecurityconsolePackageCommitScopeList extends cdktf.ComplexList {
  public internalValue? : SecurityconsolePackageCommitScope[] | cdktf.IResolvable
  ...
  */
  public get(index: number): SecurityconsolePackageCommitScopeOutputReference {
    return new SecurityconsolePackageCommitScopeOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class SecurityconsolePackageCommit extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_securityconsole_package_commit";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_securityconsole_package_commit", importId: importFromId, provider });
      }
  ...
  * @param options SecurityconsolePackageCommitConfig = {}
  */
  public constructor(scope: Construct, id: string, config: SecurityconsolePackageCommitConfig = {}) {
    super(scope, id, {
  ...
  private _scope = new SecurityconsolePackageCommitScopeList(this, "scope", false);
  public get scope() {
    return this._scope;
  }
  public putScope(value: SecurityconsolePackageCommitScope[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      scope: cdktf.listMapper(securityconsolePackageCommitScopeToTerraform, true)(this._scope.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      scope: {
        value: cdktf.listMapperHcl(securityconsolePackageCommitScopeToHclTerraform, true)(this._scope.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "SecurityconsolePackageCommitScopeList",
      },
    };
