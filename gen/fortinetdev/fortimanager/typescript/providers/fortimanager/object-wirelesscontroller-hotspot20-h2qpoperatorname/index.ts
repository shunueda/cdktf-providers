...
export function objectWirelesscontrollerHotspot20H2QpoperatornameValueListStructToTerraform(struct?: ObjectWirelesscontrollerHotspot20H2QpoperatornameValueListStruct | cdktf.IResolvable): any {
...
export function objectWirelesscontrollerHotspot20H2QpoperatornameValueListStructToHclTerraform(struct?: ObjectWirelesscontrollerHotspot20H2QpoperatornameValueListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ObjectWirelesscontrollerHotspot20H2QpoperatornameValueListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ObjectWirelesscontrollerHotspot20H2QpoperatornameValueListStruct | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ObjectWirelesscontrollerHotspot20H2QpoperatornameValueListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ObjectWirelesscontrollerHotspot20H2QpoperatornameValueListStructList extends cdktf.ComplexList {
  public internalValue? : ObjectWirelesscontrollerHotspot20H2QpoperatornameValueListStruct[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ObjectWirelesscontrollerHotspot20H2QpoperatornameValueListStructOutputReference {
    return new ObjectWirelesscontrollerHotspot20H2QpoperatornameValueListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ObjectWirelesscontrollerHotspot20H2Qpoperatorname extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_wirelesscontroller_hotspot20_h2qpoperatorname";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_wirelesscontroller_hotspot20_h2qpoperatorname", importId: importFromId, provider });
      }
  ...
  * @param options ObjectWirelesscontrollerHotspot20H2QpoperatornameConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ObjectWirelesscontrollerHotspot20H2QpoperatornameConfig = {}) {
    super(scope, id, {
  ...
  private _valueList = new ObjectWirelesscontrollerHotspot20H2QpoperatornameValueListStructList(this, "value_list", false);
  public get valueList() {
    return this._valueList;
  }
  public putValueList(value: ObjectWirelesscontrollerHotspot20H2QpoperatornameValueListStruct[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      value_list: cdktf.listMapper(objectWirelesscontrollerHotspot20H2QpoperatornameValueListStructToTerraform, true)(this._valueList.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      value_list: {
        value: cdktf.listMapperHcl(objectWirelesscontrollerHotspot20H2QpoperatornameValueListStructToHclTerraform, true)(this._valueList.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ObjectWirelesscontrollerHotspot20H2QpoperatornameValueListStructList",
      },
    };
