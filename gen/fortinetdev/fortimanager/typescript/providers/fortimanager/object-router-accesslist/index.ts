...
export function objectRouterAccesslistRuleToTerraform(struct?: ObjectRouterAccesslistRule | cdktf.IResolvable): any {
...
export function objectRouterAccesslistRuleToHclTerraform(struct?: ObjectRouterAccesslistRule | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ObjectRouterAccesslistRuleOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ObjectRouterAccesslistRule | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ObjectRouterAccesslistRule | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ObjectRouterAccesslistRuleList extends cdktf.ComplexList {
  public internalValue? : ObjectRouterAccesslistRule[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ObjectRouterAccesslistRuleOutputReference {
    return new ObjectRouterAccesslistRuleOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ObjectRouterAccesslist extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_router_accesslist";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_router_accesslist", importId: importFromId, provider });
      }
  ...
  * @param options ObjectRouterAccesslistConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ObjectRouterAccesslistConfig = {}) {
    super(scope, id, {
  ...
  private _rule = new ObjectRouterAccesslistRuleList(this, "rule", false);
  public get rule() {
    return this._rule;
  }
  public putRule(value: ObjectRouterAccesslistRule[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rule: cdktf.listMapper(objectRouterAccesslistRuleToTerraform, true)(this._rule.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      rule: {
        value: cdktf.listMapperHcl(objectRouterAccesslistRuleToHclTerraform, true)(this._rule.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ObjectRouterAccesslistRuleList",
      },
    };
