// https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_admin_user_ipsfilter
...
export interface SystemAdminUserIpsfilterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_admin_user_ipsfilter#id SystemAdminUserIpsfilter#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_admin_user_ipsfilter#ips_filter_name SystemAdminUserIpsfilter#ips_filter_name}
  */
  readonly ipsFilterName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_admin_user_ipsfilter#user SystemAdminUserIpsfilter#user}
  */
  readonly user: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_admin_user_ipsfilter fortimanager_system_admin_user_ipsfilter}
*/
export class SystemAdminUserIpsfilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemAdminUserIpsfilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_admin_user_ipsfilter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.14.0/docs/resources/system_admin_user_ipsfilter fortimanager_system_admin_user_ipsfilter} Resource
  *
  * @param scope The scope in which to define this construct
