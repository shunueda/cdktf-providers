...
export class ObjectWirelesscontrollerArrpprofile extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_wirelesscontroller_arrpprofile";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_wirelesscontroller_arrpprofile", importId: importFromId, provider });
      }
  ...
  * @param options ObjectWirelesscontrollerArrpprofileConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ObjectWirelesscontrollerArrpprofileConfig = {}) {
    super(scope, id, {
