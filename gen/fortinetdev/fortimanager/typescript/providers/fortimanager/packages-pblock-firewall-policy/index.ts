...
export class PackagesPblockFirewallPolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_packages_pblock_firewall_policy";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_packages_pblock_firewall_policy", importId: importFromId, provider });
      }
  ...
  * @param options PackagesPblockFirewallPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: PackagesPblockFirewallPolicyConfig) {
    super(scope, id, {
  ...
  // rtp_addr - computed: true, optional: true, required: false
  private _rtpAddr?: string[]; 
  public get rtpAddr() {
    return cdktf.Fn.tolist(this.getListAttribute('rtp_addr'));
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      rtp_addr: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._rtpAddr),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
