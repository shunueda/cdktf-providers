...
export class ObjectSshfilterProfileShellcommands extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_sshfilter_profile_shellcommands";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_sshfilter_profile_shellcommands", importId: importFromId, provider });
      }
  ...
  * @param options ObjectSshfilterProfileShellcommandsConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectSshfilterProfileShellcommandsConfig) {
    super(scope, id, {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      alert: cdktf.stringToTerraform(this._alert),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      alert: {
        value: cdktf.stringToHclTerraform(this._alert),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
