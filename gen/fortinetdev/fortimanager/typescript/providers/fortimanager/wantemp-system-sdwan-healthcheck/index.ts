...
export class WantempSystemSdwanHealthcheck extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_wantemp_system_sdwan_healthcheck";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_wantemp_system_sdwan_healthcheck", importId: importFromId, provider });
      }
  ...
  * @param options WantempSystemSdwanHealthcheckConfig
  */
  public constructor(scope: Construct, id: string, config: WantempSystemSdwanHealthcheckConfig) {
    super(scope, id, {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sla: cdktf.listMapper(wantempSystemSdwanHealthcheckSlaToTerraform, true)(this._sla.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sla: {
        value: cdktf.listMapperHcl(wantempSystemSdwanHealthcheckSlaToHclTerraform, true)(this._sla.internalValue),
        isBlock: true,
        type: "list",
