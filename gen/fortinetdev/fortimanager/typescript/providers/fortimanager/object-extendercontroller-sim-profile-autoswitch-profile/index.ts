...
export class ObjectExtendercontrollerSimProfileAutoswitchProfile extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_extendercontroller_sim_profile_autoswitch_profile";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_extendercontroller_sim_profile_autoswitch_profile", importId: importFromId, provider });
      }
  ...
  * @param options ObjectExtendercontrollerSimProfileAutoswitchProfileConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectExtendercontrollerSimProfileAutoswitchProfileConfig) {
    super(scope, id, {
    ...
    this._simProfile = config.simProfile;
  ...
  // sim_profile - computed: false, optional: false, required: true
  private _simProfile?: string; 
  public get simProfile() {
    return this.getStringAttribute('sim_profile');
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sim_profile: cdktf.stringToTerraform(this._simProfile),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sim_profile: {
        value: cdktf.stringToHclTerraform(this._simProfile),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
