...
export class ObjectAntivirusProfileSshA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_antivirus_profile_ssh";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_antivirus_profile_ssh", importId: importFromId, provider });
      }
  ...
  * @param options ObjectAntivirusProfileSshAConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectAntivirusProfileSshAConfig) {
    super(scope, id, {
