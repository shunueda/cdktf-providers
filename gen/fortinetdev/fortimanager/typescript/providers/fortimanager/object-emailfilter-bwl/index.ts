...
export function objectEmailfilterBwlEntriesToTerraform(struct?: ObjectEmailfilterBwlEntries | cdktf.IResolvable): any {
...
export function objectEmailfilterBwlEntriesToHclTerraform(struct?: ObjectEmailfilterBwlEntries | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ObjectEmailfilterBwlEntriesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ObjectEmailfilterBwlEntries | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ObjectEmailfilterBwlEntries | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ObjectEmailfilterBwlEntriesList extends cdktf.ComplexList {
  public internalValue? : ObjectEmailfilterBwlEntries[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ObjectEmailfilterBwlEntriesOutputReference {
    return new ObjectEmailfilterBwlEntriesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ObjectEmailfilterBwl extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_emailfilter_bwl";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_emailfilter_bwl", importId: importFromId, provider });
      }
  ...
  * @param options ObjectEmailfilterBwlConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ObjectEmailfilterBwlConfig = {}) {
    super(scope, id, {
  ...
  private _entries = new ObjectEmailfilterBwlEntriesList(this, "entries", false);
  public get entries() {
    return this._entries;
  }
  public putEntries(value: ObjectEmailfilterBwlEntries[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      entries: cdktf.listMapper(objectEmailfilterBwlEntriesToTerraform, true)(this._entries.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      entries: {
        value: cdktf.listMapperHcl(objectEmailfilterBwlEntriesToHclTerraform, true)(this._entries.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ObjectEmailfilterBwlEntriesList",
      },
    };
