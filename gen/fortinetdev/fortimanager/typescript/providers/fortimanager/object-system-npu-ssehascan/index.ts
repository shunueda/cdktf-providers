// https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_ssehascan
...
export interface ObjectSystemNpuSsehascanConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_ssehascan#adom ObjectSystemNpuSsehascan#adom}
  */
  readonly adom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_ssehascan#gap ObjectSystemNpuSsehascan#gap}
  */
  readonly gap?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_ssehascan#id ObjectSystemNpuSsehascan#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_ssehascan#max_session_cnt ObjectSystemNpuSsehascan#max_session_cnt}
  */
  readonly maxSessionCnt?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_ssehascan#min_duration ObjectSystemNpuSsehascan#min_duration}
  */
  readonly minDuration?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_ssehascan#scopetype ObjectSystemNpuSsehascan#scopetype}
  */
  readonly scopetype?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_ssehascan fortimanager_object_system_npu_ssehascan}
*/
export class ObjectSystemNpuSsehascan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObjectSystemNpuSsehascan that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_ssehascan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_system_npu_ssehascan fortimanager_object_system_npu_ssehascan} Resource
  *
  * @param scope The scope in which to define this construct
