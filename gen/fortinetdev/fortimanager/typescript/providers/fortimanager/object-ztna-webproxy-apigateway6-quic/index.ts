// https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic
...
export interface ObjectZtnaWebproxyApigateway6QuicAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic#ack_delay_exponent ObjectZtnaWebproxyApigateway6QuicA#ack_delay_exponent}
  */
  readonly ackDelayExponent?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic#active_connection_id_limit ObjectZtnaWebproxyApigateway6QuicA#active_connection_id_limit}
  */
  readonly activeConnectionIdLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic#active_migration ObjectZtnaWebproxyApigateway6QuicA#active_migration}
  */
  readonly activeMigration?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic#adom ObjectZtnaWebproxyApigateway6QuicA#adom}
  */
  readonly adom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic#api_gateway6 ObjectZtnaWebproxyApigateway6QuicA#api_gateway6}
  */
  readonly apiGateway6: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic#grease_quic_bit ObjectZtnaWebproxyApigateway6QuicA#grease_quic_bit}
  */
  readonly greaseQuicBit?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic#id ObjectZtnaWebproxyApigateway6QuicA#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic#max_ack_delay ObjectZtnaWebproxyApigateway6QuicA#max_ack_delay}
  */
  readonly maxAckDelay?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic#max_datagram_frame_size ObjectZtnaWebproxyApigateway6QuicA#max_datagram_frame_size}
  */
  readonly maxDatagramFrameSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic#max_idle_timeout ObjectZtnaWebproxyApigateway6QuicA#max_idle_timeout}
  */
  readonly maxIdleTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic#max_udp_payload_size ObjectZtnaWebproxyApigateway6QuicA#max_udp_payload_size}
  */
  readonly maxUdpPayloadSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic#scopetype ObjectZtnaWebproxyApigateway6QuicA#scopetype}
  */
  readonly scopetype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic#web_proxy ObjectZtnaWebproxyApigateway6QuicA#web_proxy}
  */
  readonly webProxy: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic fortimanager_object_ztna_webproxy_apigateway6_quic}
*/
export class ObjectZtnaWebproxyApigateway6QuicA extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_ztna_webproxy_apigateway6_quic";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a ObjectZtnaWebproxyApigateway6QuicA resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ObjectZtnaWebproxyApigateway6QuicA to import
  * @param importFromId The id of the existing ObjectZtnaWebproxyApigateway6QuicA that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ObjectZtnaWebproxyApigateway6QuicA to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_ztna_webproxy_apigateway6_quic", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_ztna_webproxy_apigateway6_quic fortimanager_object_ztna_webproxy_apigateway6_quic} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ObjectZtnaWebproxyApigateway6QuicAConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectZtnaWebproxyApigateway6QuicAConfig) {
    super(scope, id, {
      terraformResourceType: 'fortimanager_object_ztna_webproxy_apigateway6_quic',
