...
export class ObjectFspVlanDynamicMappingDhcpserverOptionsA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_fsp_vlan_dynamic_mapping_dhcpserver_options";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_fsp_vlan_dynamic_mapping_dhcpserver_options", importId: importFromId, provider });
      }
  ...
  * @param options ObjectFspVlanDynamicMappingDhcpserverOptionsAConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectFspVlanDynamicMappingDhcpserverOptionsAConfig) {
    super(scope, id, {
