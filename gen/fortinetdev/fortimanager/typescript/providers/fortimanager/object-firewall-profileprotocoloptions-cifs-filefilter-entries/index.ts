...
export class ObjectFirewallProfileprotocoloptionsCifsFilefilterEntries extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_firewall_profileprotocoloptions_cifs_filefilter_entries";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_firewall_profileprotocoloptions_cifs_filefilter_entries", importId: importFromId, provider });
      }
  ...
  * @param options ObjectFirewallProfileprotocoloptionsCifsFilefilterEntriesConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectFirewallProfileprotocoloptionsCifsFilefilterEntriesConfig) {
    super(scope, id, {
