// https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_report_autocache
...
export interface SystemReportAutocacheConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_report_autocache#aggressive_schedule SystemReportAutocache#aggressive_schedule}
  */
  readonly aggressiveSchedule?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_report_autocache#id SystemReportAutocache#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_report_autocache#order SystemReportAutocache#order}
  */
  readonly order?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_report_autocache#sche_rpt_only SystemReportAutocache#sche_rpt_only}
  */
  readonly scheRptOnly?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_report_autocache#status SystemReportAutocache#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_report_autocache fortimanager_system_report_autocache}
*/
export class SystemReportAutocache extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemReportAutocache that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_report_autocache#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/system_report_autocache fortimanager_system_report_autocache} Resource
  *
  * @param scope The scope in which to define this construct
