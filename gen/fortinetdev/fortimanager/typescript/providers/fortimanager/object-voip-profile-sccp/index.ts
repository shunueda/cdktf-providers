// https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_voip_profile_sccp
...
export interface ObjectVoipProfileSccpAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_voip_profile_sccp#adom ObjectVoipProfileSccpA#adom}
  */
  readonly adom?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_voip_profile_sccp#block_mcast ObjectVoipProfileSccpA#block_mcast}
  */
  readonly blockMcast?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_voip_profile_sccp#id ObjectVoipProfileSccpA#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_voip_profile_sccp#log_call_summary ObjectVoipProfileSccpA#log_call_summary}
  */
  readonly logCallSummary?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_voip_profile_sccp#log_violations ObjectVoipProfileSccpA#log_violations}
  */
  readonly logViolations?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_voip_profile_sccp#max_calls ObjectVoipProfileSccpA#max_calls}
  */
  readonly maxCalls?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_voip_profile_sccp#profile ObjectVoipProfileSccpA#profile}
  */
  readonly profile: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_voip_profile_sccp#scopetype ObjectVoipProfileSccpA#scopetype}
  */
  readonly scopetype?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_voip_profile_sccp#status ObjectVoipProfileSccpA#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_voip_profile_sccp#verify_header ObjectVoipProfileSccpA#verify_header}
  */
  readonly verifyHeader?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_voip_profile_sccp fortimanager_object_voip_profile_sccp}
*/
export class ObjectVoipProfileSccpA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObjectVoipProfileSccpA that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_voip_profile_sccp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortimanager/1.15.0/docs/resources/object_voip_profile_sccp fortimanager_object_voip_profile_sccp} Resource
  *
  * @param scope The scope in which to define this construct
