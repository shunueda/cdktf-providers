...
export class ObjectSystemReplacemsggroupCustommessage extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortimanager_object_system_replacemsggroup_custommessage";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortimanager_object_system_replacemsggroup_custommessage", importId: importFromId, provider });
      }
  ...
  * @param options ObjectSystemReplacemsggroupCustommessageConfig
  */
  public constructor(scope: Construct, id: string, config: ObjectSystemReplacemsggroupCustommessageConfig) {
    super(scope, id, {
