// https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles
...
export interface EndpointSandboxProfilesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#authentication EndpointSandboxProfiles#authentication}
  */
  readonly authentication?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#detection_verdict_level EndpointSandboxProfiles#detection_verdict_level}
  */
  readonly detectionVerdictLevel?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#exceptions EndpointSandboxProfiles#exceptions}
  */
  readonly exceptions?: EndpointSandboxProfilesExceptions;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#file_submission_options EndpointSandboxProfiles#file_submission_options}
  */
  readonly fileSubmissionOptions?: EndpointSandboxProfilesFileSubmissionOptions;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#host_name EndpointSandboxProfiles#host_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#notification_type EndpointSandboxProfiles#notification_type}
  */
  readonly notificationType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#password EndpointSandboxProfiles#password}
  */
  readonly password?: string;
  /**
  * The primary key of the object. Can be found in the response from the get request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#primary_key EndpointSandboxProfiles#primary_key}
  */
  readonly primaryKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#remediation_actions EndpointSandboxProfiles#remediation_actions}
  */
  readonly remediationActions?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#sandbox_mode EndpointSandboxProfiles#sandbox_mode}
  */
  readonly sandboxMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#timeout_awaiting_sandbox_results EndpointSandboxProfiles#timeout_awaiting_sandbox_results}
  */
  readonly timeoutAwaitingSandboxResults?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#username EndpointSandboxProfiles#username}
  */
  readonly username?: string;
}
export interface EndpointSandboxProfilesExceptions {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#exclude_files_from_trusted_sources EndpointSandboxProfiles#exclude_files_from_trusted_sources}
  */
  readonly excludeFilesFromTrustedSources?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#files EndpointSandboxProfiles#files}
  */
  readonly files?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#folders EndpointSandboxProfiles#folders}
  */
  readonly folders?: string[];
}

export function endpointSandboxProfilesExceptionsToTerraform(struct?: EndpointSandboxProfilesExceptions | cdktf.IResolvable): any {
...
export function endpointSandboxProfilesExceptionsToHclTerraform(struct?: EndpointSandboxProfilesExceptions | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class EndpointSandboxProfilesExceptionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EndpointSandboxProfilesExceptions | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: EndpointSandboxProfilesExceptions | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export interface EndpointSandboxProfilesFileSubmissionOptions {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#all_email_downloads EndpointSandboxProfiles#all_email_downloads}
  */
  readonly allEmailDownloads?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#all_files_mapped_network_drives EndpointSandboxProfiles#all_files_mapped_network_drives}
  */
  readonly allFilesMappedNetworkDrives?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#all_files_removable_media EndpointSandboxProfiles#all_files_removable_media}
  */
  readonly allFilesRemovableMedia?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#all_web_downloads EndpointSandboxProfiles#all_web_downloads}
  */
  readonly allWebDownloads?: string;
}

export function endpointSandboxProfilesFileSubmissionOptionsToTerraform(struct?: EndpointSandboxProfilesFileSubmissionOptions | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function endpointSandboxProfilesFileSubmissionOptionsToHclTerraform(struct?: EndpointSandboxProfilesFileSubmissionOptions | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class EndpointSandboxProfilesFileSubmissionOptionsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): EndpointSandboxProfilesFileSubmissionOptions | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: EndpointSandboxProfilesFileSubmissionOptions | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles fortisase_endpoint_sandbox_profiles}
*/
export class EndpointSandboxProfiles extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a EndpointSandboxProfiles resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the EndpointSandboxProfiles to import
  * @param importFromId The id of the existing EndpointSandboxProfiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the EndpointSandboxProfiles to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/resources/endpoint_sandbox_profiles fortisase_endpoint_sandbox_profiles} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options EndpointSandboxProfilesConfig
  */
  public constructor(scope: Construct, id: string, config: EndpointSandboxProfilesConfig) {
    super(scope, id, {
  ...
  private _exceptions = new EndpointSandboxProfilesExceptionsOutputReference(this, "exceptions");
  public get exceptions() {
    return this._exceptions;
  }
  public putExceptions(value: EndpointSandboxProfilesExceptions) {
  ...
  private _fileSubmissionOptions = new EndpointSandboxProfilesFileSubmissionOptionsOutputReference(this, "file_submission_options");
  public get fileSubmissionOptions() {
    return this._fileSubmissionOptions;
  }
  public putFileSubmissionOptions(value: EndpointSandboxProfilesFileSubmissionOptions) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      exceptions: endpointSandboxProfilesExceptionsToTerraform(this._exceptions.internalValue),
      file_submission_options: endpointSandboxProfilesFileSubmissionOptionsToTerraform(this._fileSubmissionOptions.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      exceptions: {
        value: endpointSandboxProfilesExceptionsToHclTerraform(this._exceptions.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "EndpointSandboxProfilesExceptions",
      },
      file_submission_options: {
        value: endpointSandboxProfilesFileSubmissionOptionsToHclTerraform(this._fileSubmissionOptions.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "EndpointSandboxProfilesFileSubmissionOptions",
      },
      host_name: {
