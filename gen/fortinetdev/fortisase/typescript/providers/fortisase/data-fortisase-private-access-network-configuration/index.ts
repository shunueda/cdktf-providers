// https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/data-sources/private_access_network_configuration
...
export interface DataFortisasePrivateAccessNetworkConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Autonomous System Number (ASN).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/data-sources/private_access_network_configuration#as_number DataFortisasePrivateAccessNetworkConfiguration#as_number}
  */
  readonly asNumber?: string;
  /**
  * BGP Routing Design.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/data-sources/private_access_network_configuration#bgp_design DataFortisasePrivateAccessNetworkConfiguration#bgp_design}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/data-sources/private_access_network_configuration#bgp_router_ids_subnet DataFortisasePrivateAccessNetworkConfiguration#bgp_router_ids_subnet}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/data-sources/private_access_network_configuration#recursive_next_hop DataFortisasePrivateAccessNetworkConfiguration#recursive_next_hop}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/data-sources/private_access_network_configuration#sdwan_health_check_vm DataFortisasePrivateAccessNetworkConfiguration#sdwan_health_check_vm}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/data-sources/private_access_network_configuration#sdwan_rule_enable DataFortisasePrivateAccessNetworkConfiguration#sdwan_rule_enable}
  */
  readonly sdwanRuleEnable?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/data-sources/private_access_network_configuration fortisase_private_access_network_configuration}
*/
export class DataFortisasePrivateAccessNetworkConfiguration extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataFortisasePrivateAccessNetworkConfiguration resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataFortisasePrivateAccessNetworkConfiguration to import
  * @param importFromId The id of the existing DataFortisasePrivateAccessNetworkConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/data-sources/private_access_network_configuration#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataFortisasePrivateAccessNetworkConfiguration to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fortinetdev/fortisase/1.0.0/docs/data-sources/private_access_network_configuration fortisase_private_access_network_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataFortisasePrivateAccessNetworkConfigurationConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataFortisasePrivateAccessNetworkConfigurationConfig = {}) {
    super(scope, id, {
