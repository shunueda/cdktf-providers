...
export class EntitlementsVm extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fortiflexvm_entitlements_vm";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fortiflexvm_entitlements_vm", importId: importFromId, provider });
      }
  ...
  * @param options EntitlementsVmConfig
  */
  public constructor(scope: Construct, id: string, config: EntitlementsVmConfig) {
    super(scope, id, {
    ...
    this._skipPending = config.skipPending;
  ...
  // skip_pending - computed: false, optional: true, required: false
  private _skipPending?: boolean | cdktf.IResolvable; 
  public get skipPending() {
    return this.getBooleanAttribute('skip_pending');
  }
  public set skipPending(value: boolean | cdktf.IResolvable) {
    this._skipPending = value;
  }
  public resetSkipPending() {
    this._skipPending = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get skipPendingInput() {
    return this._skipPending;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      skip_pending: cdktf.booleanToTerraform(this._skipPending),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      skip_pending: {
        value: cdktf.booleanToHclTerraform(this._skipPending),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
