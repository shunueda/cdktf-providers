// https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance
...
export interface RedisInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  * Instance name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#name RedisInstance#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#parameters RedisInstance#parameters}
  */
  readonly parameters?: RedisInstanceParameters;
  /**
  * The selected plan name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#plan_name RedisInstance#plan_name}
  */
  readonly planName: string;
  /**
  * STACKIT project ID to which the instance is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#project_id RedisInstance#project_id}
  */
  readonly projectId: string;
  /**
  * The service version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#version RedisInstance#version}
  */
...
export interface RedisInstanceParameters {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#down_after_milliseconds RedisInstance#down_after_milliseconds}
  */
  readonly downAfterMilliseconds?: number;
  /**
  * Enable monitoring.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#enable_monitoring RedisInstance#enable_monitoring}
  */
  readonly enableMonitoring?: boolean | cdktf.IResolvable;
  /**
  * The failover timeout in milliseconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#failover_timeout RedisInstance#failover_timeout}
  */
  readonly failoverTimeout?: number;
  /**
  * Graphite server URL (host and port). If set, monitoring with Graphite will be enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#graphite RedisInstance#graphite}
  */
  readonly graphite?: string;
  /**
  * The lazy eviction enablement (yes or no).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#lazyfree_lazy_eviction RedisInstance#lazyfree_lazy_eviction}
  */
  readonly lazyfreeLazyEviction?: string;
  /**
  * The lazy expire enablement (yes or no).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#lazyfree_lazy_expire RedisInstance#lazyfree_lazy_expire}
  */
  readonly lazyfreeLazyExpire?: string;
  /**
  * The Lua time limit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#lua_time_limit RedisInstance#lua_time_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#max_disk_threshold RedisInstance#max_disk_threshold}
  */
  readonly maxDiskThreshold?: number;
  /**
  * The maximum number of clients.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#maxclients RedisInstance#maxclients}
  */
  readonly maxclients?: number;
  /**
  * The policy to handle the maximum memory (volatile-lru, noeviction, etc).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#maxmemory_policy RedisInstance#maxmemory_policy}
  */
  readonly maxmemoryPolicy?: string;
  /**
  * The maximum memory samples.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#maxmemory_samples RedisInstance#maxmemory_samples}
  */
  readonly maxmemorySamples?: number;
  /**
  * The frequency in seconds at which metrics are emitted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#metrics_frequency RedisInstance#metrics_frequency}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#metrics_prefix RedisInstance#metrics_prefix}
  */
  readonly metricsPrefix?: string;
  /**
  * The minimum replicas maximum lag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#min_replicas_max_lag RedisInstance#min_replicas_max_lag}
  */
  readonly minReplicasMaxLag?: number;
  /**
  * The ID of the STACKIT monitoring instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#monitoring_instance_id RedisInstance#monitoring_instance_id}
  */
  readonly monitoringInstanceId?: string;
  /**
  * The notify keyspace events.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#notify_keyspace_events RedisInstance#notify_keyspace_events}
  */
  readonly notifyKeyspaceEvents?: string;
  /**
  * Comma separated list of IP networks in CIDR notation which are allowed to access this instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#sgw_acl RedisInstance#sgw_acl}
  */
  readonly sgwAcl?: string;
  /**
  * The snapshot configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#snapshot RedisInstance#snapshot}
  */
  readonly snapshot?: string;
  /**
  * List of syslog servers to send logs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#syslog RedisInstance#syslog}
  */
  readonly syslog?: string[];
  /**
  * List of TLS ciphers to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#tls_ciphers RedisInstance#tls_ciphers}
  */
  readonly tlsCiphers?: string[];
  /**
  * TLS cipher suites to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#tls_ciphersuites RedisInstance#tls_ciphersuites}
  */
  readonly tlsCiphersuites?: string;
  /**
  * TLS protocol to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#tls_protocols RedisInstance#tls_protocols}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance stackit_redis_instance}
*/
export class RedisInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/redis_instance stackit_redis_instance} Resource
  *
  * @param scope The scope in which to define this construct
