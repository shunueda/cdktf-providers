// https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/routing_table_route
...
export interface DataStackitRoutingTableRouteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/routing_table_route#network_area_id DataStackitRoutingTableRoute#network_area_id}
  */
  readonly networkAreaId: string;
  /**
  * STACKIT organization ID to which the routing table is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/routing_table_route#organization_id DataStackitRoutingTableRoute#organization_id}
  */
  readonly organizationId: string;
  /**
  * The resource region. If not defined, the provider region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/routing_table_route#region DataStackitRoutingTableRoute#region}
  */
  readonly region?: string;
  /**
  * Route ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/routing_table_route#route_id DataStackitRoutingTableRoute#route_id}
  */
  readonly routeId: string;
  /**
  * The routing tables ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/routing_table_route#routing_table_id DataStackitRoutingTableRoute#routing_table_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/routing_table_route stackit_routing_table_route}
*/
export class DataStackitRoutingTableRoute extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitRoutingTableRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/routing_table_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/routing_table_route stackit_routing_table_route} Data Source
  *
  * @param scope The scope in which to define this construct
