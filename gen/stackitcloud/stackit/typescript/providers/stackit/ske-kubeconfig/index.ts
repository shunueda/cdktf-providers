// https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/ske_kubeconfig
...
export interface SkeKubeconfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/ske_kubeconfig#cluster_name SkeKubeconfig#cluster_name}
  */
  readonly clusterName: string;
  /**
  * Expiration time of the kubeconfig, in seconds. Defaults to `3600`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/ske_kubeconfig#expiration SkeKubeconfig#expiration}
  */
  readonly expiration?: number;
  /**
  * STACKIT project ID to which the cluster is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/ske_kubeconfig#project_id SkeKubeconfig#project_id}
  */
  readonly projectId: string;
  /**
  * If set to true, the provider will check if the kubeconfig has expired and will generated a new valid one in-place
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/ske_kubeconfig#refresh SkeKubeconfig#refresh}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/ske_kubeconfig#refresh_before SkeKubeconfig#refresh_before}
  */
  readonly refreshBefore?: number;
  /**
  * The resource region. If not defined, the provider region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/ske_kubeconfig#region SkeKubeconfig#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/ske_kubeconfig stackit_ske_kubeconfig}
*/
export class SkeKubeconfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SkeKubeconfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/ske_kubeconfig#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/ske_kubeconfig stackit_ske_kubeconfig} Resource
  *
  * @param scope The scope in which to define this construct
