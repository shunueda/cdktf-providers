// https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule
...
export interface SecurityGroupRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#description SecurityGroupRule#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#direction SecurityGroupRule#direction}
  */
  readonly direction: string;
  /**
  * The ethertype which the rule should match.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#ether_type SecurityGroupRule#ether_type}
  */
  readonly etherType?: string;
  /**
  * ICMP Parameters. These parameters should only be provided if the protocol is ICMP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#icmp_parameters SecurityGroupRule#icmp_parameters}
  */
  readonly icmpParameters?: SecurityGroupRuleIcmpParameters;
  /**
  * The remote IP range which the rule should match.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#ip_range SecurityGroupRule#ip_range}
  */
  readonly ipRange?: string;
  /**
  * The range of ports. This should only be provided if the protocol is not ICMP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#port_range SecurityGroupRule#port_range}
  */
  readonly portRange?: SecurityGroupRulePortRange;
  /**
  * STACKIT project ID to which the security group rule is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#project_id SecurityGroupRule#project_id}
  */
  readonly projectId: string;
  /**
  * The internet protocol which the rule should match.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#protocol SecurityGroupRule#protocol}
  */
  readonly protocol?: SecurityGroupRuleProtocol;
  /**
  * The remote security group which the rule should match.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#remote_security_group_id SecurityGroupRule#remote_security_group_id}
  */
  readonly remoteSecurityGroupId?: string;
  /**
  * The security group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#security_group_id SecurityGroupRule#security_group_id}
  */
...
export interface SecurityGroupRuleIcmpParameters {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#code SecurityGroupRule#code}
  */
  readonly code: number;
  /**
  * ICMP type. Can be set if the protocol is ICMP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#type SecurityGroupRule#type}
  */
...
export interface SecurityGroupRulePortRange {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#max SecurityGroupRule#max}
  */
  readonly max: number;
  /**
  * The minimum port number. Should be less or equal to the maximum.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#min SecurityGroupRule#min}
  */
  readonly min: number;
}
...
export interface SecurityGroupRuleProtocol {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#name SecurityGroupRule#name}
  */
  readonly name?: string;
  /**
  * The protocol number which the rule should match. Either `name` or `number` must be provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#number SecurityGroupRule#number}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule stackit_security_group_rule}
*/
export class SecurityGroupRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityGroupRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/security_group_rule stackit_security_group_rule} Resource
  *
  * @param scope The scope in which to define this construct
