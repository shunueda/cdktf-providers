// https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/data-sources/server_update_schedule
...
export class DataStackitServerUpdateSchedule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitServerUpdateSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/data-sources/server_update_schedule#import import section} in the documentation of this resource for the id to use
