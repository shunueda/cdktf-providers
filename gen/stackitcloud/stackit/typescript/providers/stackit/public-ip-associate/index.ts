// https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/public_ip_associate
...
export interface PublicIpAssociateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/public_ip_associate#network_interface_id PublicIpAssociate#network_interface_id}
  */
  readonly networkInterfaceId: string;
  /**
  * STACKIT project ID to which the public IP is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/public_ip_associate#project_id PublicIpAssociate#project_id}
  */
  readonly projectId: string;
  /**
  * The public IP ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/public_ip_associate#public_ip_id PublicIpAssociate#public_ip_id}
  */
  readonly publicIpId: string;
  /**
  * The resource region. If not defined, the provider region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/public_ip_associate#region PublicIpAssociate#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/public_ip_associate stackit_public_ip_associate}
*/
export class PublicIpAssociate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PublicIpAssociate that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/public_ip_associate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/public_ip_associate stackit_public_ip_associate} Resource
  *
  * @param scope The scope in which to define this construct
