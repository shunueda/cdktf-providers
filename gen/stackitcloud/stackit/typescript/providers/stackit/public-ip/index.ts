// https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/public_ip
...
export interface PublicIpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/public_ip#labels PublicIp#labels}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/public_ip#network_interface_id PublicIp#network_interface_id}
  */
  readonly networkInterfaceId?: string;
  /**
  * STACKIT project ID to which the public IP is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/public_ip#project_id PublicIp#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/public_ip stackit_public_ip}
*/
export class PublicIp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PublicIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/public_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/public_ip stackit_public_ip} Resource
  *
  * @param scope The scope in which to define this construct
