// https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/data-sources/key_pair
...
export interface DataStackitKeyPairConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/data-sources/key_pair#name DataStackitKeyPair#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/data-sources/key_pair stackit_key_pair}
*/
export class DataStackitKeyPair extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitKeyPair that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/data-sources/key_pair#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/data-sources/key_pair stackit_key_pair} Data Source
  *
  * @param scope The scope in which to define this construct
