// https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance
...
export interface MongodbflexInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#acl MongodbflexInstance#acl}
  */
  readonly acl: string[];
  /**
  * The backup schedule. Should follow the cron scheduling system format (e.g. "0 0 * * *").
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#backup_schedule MongodbflexInstance#backup_schedule}
  */
  readonly backupSchedule: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#flavor MongodbflexInstance#flavor}
  */
  readonly flavor: MongodbflexInstanceFlavor;
  /**
  * Instance name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#name MongodbflexInstance#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#options MongodbflexInstance#options}
  */
  readonly options: MongodbflexInstanceOptions;
  /**
  * STACKIT project ID to which the instance is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#project_id MongodbflexInstance#project_id}
  */
  readonly projectId: string;
  /**
  * The resource region. If not defined, the provider region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#region MongodbflexInstance#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#replicas MongodbflexInstance#replicas}
  */
  readonly replicas: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#storage MongodbflexInstance#storage}
  */
  readonly storage: MongodbflexInstanceStorage;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#version MongodbflexInstance#version}
  */
  readonly version: string;
}
export interface MongodbflexInstanceFlavor {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#cpu MongodbflexInstance#cpu}
  */
  readonly cpu: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#ram MongodbflexInstance#ram}
  */
  readonly ram: number;
}
...
export interface MongodbflexInstanceOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#daily_snapshot_retention_days MongodbflexInstance#daily_snapshot_retention_days}
  */
  readonly dailySnapshotRetentionDays?: number;
  /**
  * The number of months that monthly backups will be retained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#monthly_snapshot_retention_months MongodbflexInstance#monthly_snapshot_retention_months}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#point_in_time_window_hours MongodbflexInstance#point_in_time_window_hours}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#snapshot_retention_days MongodbflexInstance#snapshot_retention_days}
  */
  readonly snapshotRetentionDays?: number;
  /**
  * Type of the MongoDB Flex instance. Possible values are: `Replica`, `Sharded`, `Single`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#type MongodbflexInstance#type}
  */
  readonly type: string;
  /**
  * The number of weeks that weekly backups will be retained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#weekly_snapshot_retention_weeks MongodbflexInstance#weekly_snapshot_retention_weeks}
  */
...
export interface MongodbflexInstanceStorage {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#class MongodbflexInstance#class}
  */
  readonly class: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#size MongodbflexInstance#size}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance stackit_mongodbflex_instance}
*/
export class MongodbflexInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MongodbflexInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/mongodbflex_instance stackit_mongodbflex_instance} Resource
  *
  * @param scope The scope in which to define this construct
