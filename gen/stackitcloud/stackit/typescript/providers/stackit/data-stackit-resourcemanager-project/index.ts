// https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/resourcemanager_project
...
export interface DataStackitResourcemanagerProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/resourcemanager_project#container_id DataStackitResourcemanagerProject#container_id}
  */
  readonly containerId?: string;
  /**
  * Project UUID identifier. This is the ID that can be used in most of the other resources to identify the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/resourcemanager_project#project_id DataStackitResourcemanagerProject#project_id}
  */
  readonly projectId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/resourcemanager_project stackit_resourcemanager_project}
*/
export class DataStackitResourcemanagerProject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitResourcemanagerProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/resourcemanager_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/resourcemanager_project stackit_resourcemanager_project} Data Source
  *
  * @param scope The scope in which to define this construct
