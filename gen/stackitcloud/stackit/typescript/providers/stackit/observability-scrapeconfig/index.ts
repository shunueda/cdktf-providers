// https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig
...
export interface ObservabilityScrapeconfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#basic_auth ObservabilityScrapeconfig#basic_auth}
  */
  readonly basicAuth?: ObservabilityScrapeconfigBasicAuth;
  /**
  * Observability instance ID to which the scraping job is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#instance_id ObservabilityScrapeconfig#instance_id}
  */
  readonly instanceId: string;
  /**
  * Specifies the job scraping url path. E.g. `/metrics`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#metrics_path ObservabilityScrapeconfig#metrics_path}
  */
  readonly metricsPath: string;
  /**
  * Specifies the name of the scraping job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#name ObservabilityScrapeconfig#name}
  */
  readonly name: string;
  /**
  * STACKIT project ID to which the scraping job is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#project_id ObservabilityScrapeconfig#project_id}
  */
  readonly projectId: string;
  /**
  * A SAML2 configuration block.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#saml2 ObservabilityScrapeconfig#saml2}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#sample_limit ObservabilityScrapeconfig#sample_limit}
  */
  readonly sampleLimit?: number;
  /**
  * Specifies the http scheme. Defaults to `https`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#scheme ObservabilityScrapeconfig#scheme}
  */
  readonly scheme?: string;
  /**
  * Specifies the scrape interval as duration string. Defaults to `5m`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#scrape_interval ObservabilityScrapeconfig#scrape_interval}
  */
  readonly scrapeInterval?: string;
  /**
  * Specifies the scrape timeout as duration string. Defaults to `2m`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#scrape_timeout ObservabilityScrapeconfig#scrape_timeout}
  */
  readonly scrapeTimeout?: string;
  /**
  * The targets list (specified by the static config).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#targets ObservabilityScrapeconfig#targets}
  */
...
export interface ObservabilityScrapeconfigBasicAuth {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#password ObservabilityScrapeconfig#password}
  */
  readonly password: string;
  /**
  * Specifies basic auth username.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#username ObservabilityScrapeconfig#username}
  */
...
export interface ObservabilityScrapeconfigSaml2 {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#enable_url_parameters ObservabilityScrapeconfig#enable_url_parameters}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig stackit_observability_scrapeconfig}
*/
export class ObservabilityScrapeconfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObservabilityScrapeconfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/observability_scrapeconfig stackit_observability_scrapeconfig} Resource
  *
  * @param scope The scope in which to define this construct
