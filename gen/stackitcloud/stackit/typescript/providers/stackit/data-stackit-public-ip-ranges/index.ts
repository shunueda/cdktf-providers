// https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/public_ip_ranges
...
export class DataStackitPublicIpRanges extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitPublicIpRanges that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/public_ip_ranges#import import section} in the documentation of this resource for the id to use
