// https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/scf_platform
...
export interface DataStackitScfPlatformConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/scf_platform#platform_id DataStackitScfPlatform#platform_id}
  */
  readonly platformId: string;
  /**
  * The ID of the project associated with the platform
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/scf_platform#project_id DataStackitScfPlatform#project_id}
  */
  readonly projectId: string;
  /**
  * The region where the platform is located. If not defined, the provider region is used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/scf_platform#region DataStackitScfPlatform#region}
  */
...
export class DataStackitScfPlatform extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitScfPlatform that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/scf_platform#import import section} in the documentation of this resource for the id to use
