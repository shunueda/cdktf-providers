// https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/network_interface
...
export interface NetworkInterfaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/network_interface#allowed_addresses NetworkInterface#allowed_addresses}
  */
  readonly allowedAddresses?: string[];
  /**
  * The IPv4 address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/network_interface#ipv4 NetworkInterface#ipv4}
  */
  readonly ipv4?: string;
  /**
  * Labels are key-value string pairs which can be attached to a network interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/network_interface#labels NetworkInterface#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The name of the network interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/network_interface#name NetworkInterface#name}
  */
  readonly name?: string;
  /**
  * The network ID to which the network interface is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/network_interface#network_id NetworkInterface#network_id}
  */
  readonly networkId: string;
  /**
  * STACKIT project ID to which the network is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/network_interface#project_id NetworkInterface#project_id}
  */
  readonly projectId: string;
  /**
  * The Network Interface Security. If set to false, then no security groups will apply to this network interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/network_interface#security NetworkInterface#security}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/network_interface#security_group_ids NetworkInterface#security_group_ids}
  */
  readonly securityGroupIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/network_interface stackit_network_interface}
*/
export class NetworkInterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/network_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/network_interface stackit_network_interface} Resource
  *
  * @param scope The scope in which to define this construct
