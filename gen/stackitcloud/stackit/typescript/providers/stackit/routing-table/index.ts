// https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/routing_table
...
export interface RoutingTableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/routing_table#description RoutingTable#description}
  */
  readonly description?: string;
  /**
  * Labels are key-value string pairs which can be attached to a resource container
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/routing_table#labels RoutingTable#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The name of the routing table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/routing_table#name RoutingTable#name}
  */
  readonly name: string;
  /**
  * The network area ID to which the routing table is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/routing_table#network_area_id RoutingTable#network_area_id}
  */
  readonly networkAreaId: string;
  /**
  * STACKIT organization ID to which the routing table is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/routing_table#organization_id RoutingTable#organization_id}
  */
  readonly organizationId: string;
  /**
  * The resource region. If not defined, the provider region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/routing_table#region RoutingTable#region}
  */
  readonly region?: string;
  /**
  * This controls whether the routes for project-to-project communication are created automatically or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/routing_table#system_routes RoutingTable#system_routes}
  */
  readonly systemRoutes?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/routing_table stackit_routing_table}
*/
export class RoutingTable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoutingTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/routing_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/routing_table stackit_routing_table} Resource
  *
  * @param scope The scope in which to define this construct
