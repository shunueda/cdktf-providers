// https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/data-sources/routing_table_routes
...
export interface DataStackitRoutingTableRoutesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/data-sources/routing_table_routes#network_area_id DataStackitRoutingTableRoutes#network_area_id}
  */
  readonly networkAreaId: string;
  /**
  * STACKIT organization ID to which the routing table is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/data-sources/routing_table_routes#organization_id DataStackitRoutingTableRoutes#organization_id}
  */
  readonly organizationId: string;
  /**
  * The datasource region. If not defined, the provider region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/data-sources/routing_table_routes#region DataStackitRoutingTableRoutes#region}
  */
  readonly region?: string;
  /**
  * The routing tables ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/data-sources/routing_table_routes#routing_table_id DataStackitRoutingTableRoutes#routing_table_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/data-sources/routing_table_routes stackit_routing_table_routes}
*/
export class DataStackitRoutingTableRoutes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitRoutingTableRoutes that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/data-sources/routing_table_routes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/data-sources/routing_table_routes stackit_routing_table_routes} Data Source
  *
  * @param scope The scope in which to define this construct
