// https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs
...
export class StackitProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing StackitProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: StackitProviderConfig = {}) {
    ...
    this._sfsCustomEndpoint = config.sfsCustomEndpoint;
  ...
  // sfs_custom_endpoint - computed: false, optional: true, required: false
  private _sfsCustomEndpoint?: string; 
  public get sfsCustomEndpoint() {
    return this._sfsCustomEndpoint;
  }
  public set sfsCustomEndpoint(value: string | undefined) {
    this._sfsCustomEndpoint = value;
  }
  public resetSfsCustomEndpoint() {
    this._sfsCustomEndpoint = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get sfsCustomEndpointInput() {
    return this._sfsCustomEndpoint;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sfs_custom_endpoint: cdktf.stringToTerraform(this._sfsCustomEndpoint),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sfs_custom_endpoint: {
        value: cdktf.stringToHclTerraform(this._sfsCustomEndpoint),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
