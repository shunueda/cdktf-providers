// https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs
...
export class StackitProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing StackitProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs#import import section} in the documentation of this resource for the id to use
