// https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance
...
export interface SqlserverflexInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#acl SqlserverflexInstance#acl}
  */
  readonly acl?: string[];
  /**
  * The backup schedule. Should follow the cron scheduling system format (e.g. "0 0 * * *")
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#backup_schedule SqlserverflexInstance#backup_schedule}
  */
  readonly backupSchedule?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#flavor SqlserverflexInstance#flavor}
  */
  readonly flavor: SqlserverflexInstanceFlavor;
  /**
  * Instance name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#name SqlserverflexInstance#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#options SqlserverflexInstance#options}
  */
  readonly options?: SqlserverflexInstanceOptions;
  /**
  * STACKIT project ID to which the instance is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#project_id SqlserverflexInstance#project_id}
  */
  readonly projectId: string;
  /**
  * The resource region. If not defined, the provider region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#region SqlserverflexInstance#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#storage SqlserverflexInstance#storage}
  */
  readonly storage?: SqlserverflexInstanceStorage;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#version SqlserverflexInstance#version}
  */
  readonly version?: string;
}
export interface SqlserverflexInstanceFlavor {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#cpu SqlserverflexInstance#cpu}
  */
  readonly cpu: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#ram SqlserverflexInstance#ram}
  */
  readonly ram: number;
}
...
export interface SqlserverflexInstanceOptions {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#retention_days SqlserverflexInstance#retention_days}
  */
...
export interface SqlserverflexInstanceStorage {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#class SqlserverflexInstance#class}
  */
  readonly class?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#size SqlserverflexInstance#size}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance stackit_sqlserverflex_instance}
*/
export class SqlserverflexInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlserverflexInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/sqlserverflex_instance stackit_sqlserverflex_instance} Resource
  *
  * @param scope The scope in which to define this construct
