// https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/scf_organization
...
export interface ScfOrganizationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/scf_organization#name ScfOrganization#name}
  */
  readonly name: string;
  /**
  * The ID of the platform associated with the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/scf_organization#platform_id ScfOrganization#platform_id}
  */
  readonly platformId?: string;
  /**
  * The ID of the project associated with the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/scf_organization#project_id ScfOrganization#project_id}
  */
  readonly projectId: string;
  /**
  * The ID of the quota associated with the organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/scf_organization#quota_id ScfOrganization#quota_id}
  */
  readonly quotaId?: string;
  /**
  * The resource region. If not defined, the provider region is used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/scf_organization#region ScfOrganization#region}
  */
  readonly region?: string;
  /**
  * A boolean indicating whether the organization is suspended
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/scf_organization#suspended ScfOrganization#suspended}
  */
  readonly suspended?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/scf_organization stackit_scf_organization}
*/
export class ScfOrganization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScfOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/scf_organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/resources/scf_organization stackit_scf_organization} Resource
  *
  * @param scope The scope in which to define this construct
