// https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/network
...
export interface DataStackitNetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  * The network ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/network#network_id DataStackitNetwork#network_id}
  */
  readonly networkId: string;
  /**
  * STACKIT project ID to which the network is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/network#project_id DataStackitNetwork#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/network#region DataStackitNetwork#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/network stackit_network}
*/
export class DataStackitNetwork extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/network stackit_network} Data Source
  *
  * @param scope The scope in which to define this construct
