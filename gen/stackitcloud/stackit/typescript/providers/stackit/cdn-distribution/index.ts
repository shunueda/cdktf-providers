// https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution
...
export interface CdnDistributionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution#config CdnDistribution#config}
  */
  readonly config: CdnDistributionConfigA;
  /**
  * STACKIT project ID associated with the distribution
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution#project_id CdnDistribution#project_id}
  */
...
export interface CdnDistributionConfigBackend {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution#geofencing CdnDistribution#geofencing}
  */
  readonly geofencing?: { [key: string]: string[] } | cdktf.IResolvable;
  /**
  * The configured origin request headers for the backend
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution#origin_request_headers CdnDistribution#origin_request_headers}
  */
  readonly originRequestHeaders?: { [key: string]: string };
  /**
  * The configured backend type for the distribution
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution#origin_url CdnDistribution#origin_url}
  */
  readonly originUrl: string;
  /**
  * The configured backend type. Possible values are: `http`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution#type CdnDistribution#type}
  */
...
export interface CdnDistributionConfigOptimizer {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution#enabled CdnDistribution#enabled}
  */
...
export interface CdnDistributionConfigA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution#backend CdnDistribution#backend}
  */
  readonly backend: CdnDistributionConfigBackend;
  /**
  * The configured countries where distribution of content is blocked
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution#blocked_countries CdnDistribution#blocked_countries}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution#optimizer CdnDistribution#optimizer}
  */
  readonly optimizer?: CdnDistributionConfigOptimizer;
  /**
  * The configured regions where content will be hosted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution#regions CdnDistribution#regions}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution stackit_cdn_distribution}
*/
export class CdnDistribution extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnDistribution that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/cdn_distribution stackit_cdn_distribution} Resource
  *
  * @param scope The scope in which to define this construct
