// https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network
...
export interface NetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#ipv4_gateway Network#ipv4_gateway}
  */
  readonly ipv4Gateway?: string;
  /**
  * The IPv4 nameservers of the network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#ipv4_nameservers Network#ipv4_nameservers}
  */
  readonly ipv4Nameservers?: string[];
  /**
  * The IPv4 prefix of the network (CIDR).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#ipv4_prefix Network#ipv4_prefix}
  */
  readonly ipv4Prefix?: string;
  /**
  * The IPv4 prefix length of the network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#ipv4_prefix_length Network#ipv4_prefix_length}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#ipv6_gateway Network#ipv6_gateway}
  */
  readonly ipv6Gateway?: string;
  /**
  * The IPv6 nameservers of the network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#ipv6_nameservers Network#ipv6_nameservers}
  */
  readonly ipv6Nameservers?: string[];
  /**
  * The IPv6 prefix of the network (CIDR).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#ipv6_prefix Network#ipv6_prefix}
  */
  readonly ipv6Prefix?: string;
  /**
  * The IPv6 prefix length of the network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#ipv6_prefix_length Network#ipv6_prefix_length}
  */
  readonly ipv6PrefixLength?: number;
  /**
  * Labels are key-value string pairs which can be attached to a resource container
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#labels Network#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The name of the network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#name Network#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#nameservers Network#nameservers}
  */
  readonly nameservers?: string[];
  /**
  * If set to `true`, the network doesn't have a gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#no_ipv4_gateway Network#no_ipv4_gateway}
  */
  readonly noIpv4Gateway?: boolean | cdktf.IResolvable;
  /**
  * If set to `true`, the network doesn't have a gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#no_ipv6_gateway Network#no_ipv6_gateway}
  */
  readonly noIpv6Gateway?: boolean | cdktf.IResolvable;
  /**
  * STACKIT project ID to which the network is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#project_id Network#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#region Network#region}
  */
  readonly region?: string;
  /**
  * If set to `true`, the network is routed and therefore accessible from other networks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#routed Network#routed}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#routing_table_id Network#routing_table_id}
  */
  readonly routingTableId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network stackit_network}
*/
export class Network extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Network that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/network stackit_network} Resource
  *
  * @param scope The scope in which to define this construct
