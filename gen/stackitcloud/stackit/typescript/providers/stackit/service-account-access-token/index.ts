// https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/resources/service_account_access_token
...
export interface ServiceAccountAccessTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/resources/service_account_access_token#project_id ServiceAccountAccessToken#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/resources/service_account_access_token#rotate_when_changed ServiceAccountAccessToken#rotate_when_changed}
  */
  readonly rotateWhenChanged?: { [key: string]: string };
  /**
  * Email address linked to the service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/resources/service_account_access_token#service_account_email ServiceAccountAccessToken#service_account_email}
  */
  readonly serviceAccountEmail: string;
  /**
  * Specifies the token's validity duration in days. If unspecified, defaults to 90 days.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/resources/service_account_access_token#ttl_days ServiceAccountAccessToken#ttl_days}
  */
  readonly ttlDays?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/resources/service_account_access_token stackit_service_account_access_token}
*/
export class ServiceAccountAccessToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccountAccessToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/resources/service_account_access_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/resources/service_account_access_token stackit_service_account_access_token} Resource
  *
  * @param scope The scope in which to define this construct
