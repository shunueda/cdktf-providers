// https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/observability_logalertgroup
...
export interface ObservabilityLogalertgroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/observability_logalertgroup#instance_id ObservabilityLogalertgroup#instance_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/observability_logalertgroup#interval ObservabilityLogalertgroup#interval}
  */
  readonly interval?: string;
  /**
  * The name of the log alert group. Is the identifier and must be unique in the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/observability_logalertgroup#name ObservabilityLogalertgroup#name}
  */
  readonly name: string;
  /**
  * STACKIT project ID to which the log alert group is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/observability_logalertgroup#project_id ObservabilityLogalertgroup#project_id}
  */
  readonly projectId: string;
  /**
  * Rules for the log alert group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/observability_logalertgroup#rules ObservabilityLogalertgroup#rules}
  */
...
export interface ObservabilityLogalertgroupRules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/observability_logalertgroup#alert ObservabilityLogalertgroup#alert}
  */
  readonly alert: string;
  /**
  * A map of key:value. Annotations to add or overwrite for each alert
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/observability_logalertgroup#annotations ObservabilityLogalertgroup#annotations}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/observability_logalertgroup#expression ObservabilityLogalertgroup#expression}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/observability_logalertgroup#for ObservabilityLogalertgroup#for}
  */
  readonly for?: string;
  /**
  * A map of key:value. Labels to add or overwrite for each alert
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/observability_logalertgroup#labels ObservabilityLogalertgroup#labels}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/observability_logalertgroup stackit_observability_logalertgroup}
*/
export class ObservabilityLogalertgroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObservabilityLogalertgroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/observability_logalertgroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/observability_logalertgroup stackit_observability_logalertgroup} Resource
  *
  * @param scope The scope in which to define this construct
