// https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/service_account_key
...
export interface ServiceAccountKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/service_account_key#project_id ServiceAccountKey#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/service_account_key#public_key ServiceAccountKey#public_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/service_account_key#rotate_when_changed ServiceAccountKey#rotate_when_changed}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/service_account_key#service_account_email ServiceAccountKey#service_account_email}
  */
  readonly serviceAccountEmail: string;
  /**
  * Specifies the key's validity duration in days. If left unspecified, the key is considered valid until it is deleted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/service_account_key#ttl_days ServiceAccountKey#ttl_days}
  */
  readonly ttlDays?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/service_account_key stackit_service_account_key}
*/
export class ServiceAccountKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccountKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/service_account_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/resources/service_account_key stackit_service_account_key} Resource
  *
  * @param scope The scope in which to define this construct
