// https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/routing_table_route
...
export interface RoutingTableRouteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/routing_table_route#destination RoutingTableRoute#destination}
  */
  readonly destination: RoutingTableRouteDestination;
  /**
  * Labels are key-value string pairs which can be attached to a resource container
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/routing_table_route#labels RoutingTableRoute#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The network area ID to which the routing table is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/routing_table_route#network_area_id RoutingTableRoute#network_area_id}
  */
  readonly networkAreaId: string;
  /**
  * Next hop destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/routing_table_route#next_hop RoutingTableRoute#next_hop}
  */
  readonly nextHop: RoutingTableRouteNextHop;
  /**
  * STACKIT organization ID to which the routing table is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/routing_table_route#organization_id RoutingTableRoute#organization_id}
  */
  readonly organizationId: string;
  /**
  * The resource region. If not defined, the provider region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/routing_table_route#region RoutingTableRoute#region}
  */
  readonly region?: string;
  /**
  * The routing tables ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/routing_table_route#routing_table_id RoutingTableRoute#routing_table_id}
  */
...
export interface RoutingTableRouteDestination {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/routing_table_route#type RoutingTableRoute#type}
  */
  readonly type: string;
  /**
  * An CIDR string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/routing_table_route#value RoutingTableRoute#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/routing_table_route stackit_routing_table_route}
*/
export class RoutingTableRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoutingTableRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/routing_table_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.76.0/docs/resources/routing_table_route stackit_routing_table_route} Resource
  *
  * @param scope The scope in which to define this construct
