// https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/kms_wrapping_key
...
export interface DataStackitKmsWrappingKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/kms_wrapping_key#keyring_id DataStackitKmsWrappingKey#keyring_id}
  */
  readonly keyringId: string;
  /**
  * STACKIT project ID to which the keyring is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/kms_wrapping_key#project_id DataStackitKmsWrappingKey#project_id}
  */
  readonly projectId: string;
  /**
  * The resource region. If not defined, the provider region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/kms_wrapping_key#region DataStackitKmsWrappingKey#region}
  */
  readonly region?: string;
  /**
  * The ID of the wrapping key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/kms_wrapping_key#wrapping_key_id DataStackitKmsWrappingKey#wrapping_key_id}
  */
  readonly wrappingKeyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/kms_wrapping_key stackit_kms_wrapping_key}
*/
export class DataStackitKmsWrappingKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitKmsWrappingKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/kms_wrapping_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.72.0/docs/data-sources/kms_wrapping_key stackit_kms_wrapping_key} Data Source
  *
  * @param scope The scope in which to define this construct
