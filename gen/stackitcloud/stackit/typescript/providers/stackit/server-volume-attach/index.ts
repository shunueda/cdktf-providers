// https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/server_volume_attach
...
export interface ServerVolumeAttachConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/server_volume_attach#project_id ServerVolumeAttach#project_id}
  */
  readonly projectId: string;
  /**
  * The resource region. If not defined, the provider region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/server_volume_attach#region ServerVolumeAttach#region}
  */
  readonly region?: string;
  /**
  * The server ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/server_volume_attach#server_id ServerVolumeAttach#server_id}
  */
  readonly serverId: string;
  /**
  * The volume ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/server_volume_attach#volume_id ServerVolumeAttach#volume_id}
  */
...
export class ServerVolumeAttach extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServerVolumeAttach that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/server_volume_attach#import import section} in the documentation of this resource for the id to use
