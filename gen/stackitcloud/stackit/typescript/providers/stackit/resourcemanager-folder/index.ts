// https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/resourcemanager_folder
...
export interface ResourcemanagerFolderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/resourcemanager_folder#labels ResourcemanagerFolder#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The name of the folder.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/resourcemanager_folder#name ResourcemanagerFolder#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/resourcemanager_folder#owner_email ResourcemanagerFolder#owner_email}
  */
  readonly ownerEmail: string;
  /**
  * Parent resource identifier. Both container ID (user-friendly) and UUID are supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/resourcemanager_folder#parent_container_id ResourcemanagerFolder#parent_container_id}
  */
...
export class ResourcemanagerFolder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourcemanagerFolder that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/resourcemanager_folder#import import section} in the documentation of this resource for the id to use
