// https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/authorization_project_role_assignment
...
export interface AuthorizationProjectRoleAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/authorization_project_role_assignment#resource_id AuthorizationProjectRoleAssignment#resource_id}
  */
  readonly resourceId: string;
  /**
  * Role to be assigned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/authorization_project_role_assignment#role AuthorizationProjectRoleAssignment#role}
  */
  readonly role: string;
  /**
  * Identifier of user, service account or client. Usually email address or name in case of clients
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/authorization_project_role_assignment#subject AuthorizationProjectRoleAssignment#subject}
  */
...
export class AuthorizationProjectRoleAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthorizationProjectRoleAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/authorization_project_role_assignment#import import section} in the documentation of this resource for the id to use
