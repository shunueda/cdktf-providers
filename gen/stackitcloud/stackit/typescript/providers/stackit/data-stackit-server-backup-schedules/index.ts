// https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/server_backup_schedules
...
export interface DataStackitServerBackupSchedulesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/server_backup_schedules#project_id DataStackitServerBackupSchedules#project_id}
  */
  readonly projectId: string;
  /**
  * The resource region. If not defined, the provider region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/server_backup_schedules#region DataStackitServerBackupSchedules#region}
  */
  readonly region?: string;
  /**
  * Server ID (UUID) to which the backup schedule is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/server_backup_schedules#server_id DataStackitServerBackupSchedules#server_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/server_backup_schedules stackit_server_backup_schedules}
*/
export class DataStackitServerBackupSchedules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitServerBackupSchedules that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/server_backup_schedules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/server_backup_schedules stackit_server_backup_schedules} Data Source
  *
  * @param scope The scope in which to define this construct
