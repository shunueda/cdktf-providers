// https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/data-sources/affinity_group
...
export interface DataStackitAffinityGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/data-sources/affinity_group#affinity_group_id DataStackitAffinityGroup#affinity_group_id}
  */
  readonly affinityGroupId: string;
  /**
  * STACKIT Project ID to which the affinity group is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/data-sources/affinity_group#project_id DataStackitAffinityGroup#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/data-sources/affinity_group stackit_affinity_group}
*/
export class DataStackitAffinityGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitAffinityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/data-sources/affinity_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/data-sources/affinity_group stackit_affinity_group} Data Source
  *
  * @param scope The scope in which to define this construct
