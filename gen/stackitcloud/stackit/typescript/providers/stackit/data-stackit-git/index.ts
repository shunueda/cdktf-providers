// https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/git
...
export interface DataStackitGitConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/git#instance_id DataStackitGit#instance_id}
  */
  readonly instanceId: string;
  /**
  * STACKIT project ID to which the git instance is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/git#project_id DataStackitGit#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/git stackit_git}
*/
export class DataStackitGit extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitGit that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/git#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/git stackit_git} Data Source
  *
  * @param scope The scope in which to define this construct
