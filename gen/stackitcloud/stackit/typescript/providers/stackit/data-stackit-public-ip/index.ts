// https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/data-sources/public_ip
...
export interface DataStackitPublicIpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/data-sources/public_ip#project_id DataStackitPublicIp#project_id}
  */
  readonly projectId: string;
  /**
  * The public IP ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/data-sources/public_ip#public_ip_id DataStackitPublicIp#public_ip_id}
  */
  readonly publicIpId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/data-sources/public_ip stackit_public_ip}
*/
export class DataStackitPublicIp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitPublicIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/data-sources/public_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.70.0/docs/data-sources/public_ip stackit_public_ip} Data Source
  *
  * @param scope The scope in which to define this construct
