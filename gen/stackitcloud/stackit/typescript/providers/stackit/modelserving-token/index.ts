// https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/modelserving_token
...
export interface ModelservingTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/modelserving_token#description ModelservingToken#description}
  */
  readonly description?: string;
  /**
  * Name of the AI model serving auth token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/modelserving_token#name ModelservingToken#name}
  */
  readonly name: string;
  /**
  * STACKIT project ID to which the AI model serving auth token is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/modelserving_token#project_id ModelservingToken#project_id}
  */
  readonly projectId: string;
  /**
  * Region to which the AI model serving auth token is associated. If not defined, the provider region is used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/modelserving_token#region ModelservingToken#region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/modelserving_token#rotate_when_changed ModelservingToken#rotate_when_changed}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/modelserving_token#ttl_duration ModelservingToken#ttl_duration}
  */
  readonly ttlDuration?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/modelserving_token stackit_modelserving_token}
*/
export class ModelservingToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ModelservingToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/modelserving_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/resources/modelserving_token stackit_modelserving_token} Resource
  *
  * @param scope The scope in which to define this construct
