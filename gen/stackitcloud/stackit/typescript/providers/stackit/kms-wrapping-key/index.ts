// https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/kms_wrapping_key
...
export interface KmsWrappingKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/kms_wrapping_key#access_scope KmsWrappingKey#access_scope}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/kms_wrapping_key#algorithm KmsWrappingKey#algorithm}
  */
  readonly algorithm: string;
  /**
  * A user chosen description to distinguish multiple wrapping keys.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/kms_wrapping_key#description KmsWrappingKey#description}
  */
  readonly description?: string;
  /**
  * The display name to distinguish multiple wrapping keys.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/kms_wrapping_key#display_name KmsWrappingKey#display_name}
  */
  readonly displayName: string;
  /**
  * The ID of the associated keyring
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/kms_wrapping_key#keyring_id KmsWrappingKey#keyring_id}
  */
  readonly keyringId: string;
  /**
  * STACKIT project ID to which the keyring is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/kms_wrapping_key#project_id KmsWrappingKey#project_id}
  */
  readonly projectId: string;
  /**
  * The underlying system that is responsible for protecting the key material. Possible values are: `software`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/kms_wrapping_key#protection KmsWrappingKey#protection}
  */
  readonly protection: string;
  /**
  * The purpose for which the key will be used. Possible values are: `wrap_symmetric_key`, `wrap_asymmetric_key`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/kms_wrapping_key#purpose KmsWrappingKey#purpose}
  */
  readonly purpose: string;
  /**
  * The resource region. If not defined, the provider region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/kms_wrapping_key#region KmsWrappingKey#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/kms_wrapping_key stackit_kms_wrapping_key}
*/
export class KmsWrappingKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsWrappingKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/kms_wrapping_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/kms_wrapping_key stackit_kms_wrapping_key} Resource
  *
  * @param scope The scope in which to define this construct
