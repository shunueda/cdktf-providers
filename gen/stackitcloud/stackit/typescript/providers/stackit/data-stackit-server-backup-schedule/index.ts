// https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/server_backup_schedule
...
export class DataStackitServerBackupSchedule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitServerBackupSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/server_backup_schedule#import import section} in the documentation of this resource for the id to use
