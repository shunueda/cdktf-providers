// https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/git
...
export interface GitConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/git#acl Git#acl}
  */
  readonly acl?: string[];
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/git#flavor Git#flavor}
  */
  readonly flavor?: string;
  /**
  * Unique name linked to the git instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/git#name Git#name}
  */
  readonly name: string;
  /**
  * STACKIT project ID to which the git instance is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/git#project_id Git#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/git stackit_git}
*/
export class Git extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Git that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/git#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.75.0/docs/resources/git stackit_git} Resource
  *
  * @param scope The scope in which to define this construct
