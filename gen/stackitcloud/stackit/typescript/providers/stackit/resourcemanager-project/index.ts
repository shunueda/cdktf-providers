// https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/resourcemanager_project
...
export interface ResourcemanagerProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/resourcemanager_project#labels ResourcemanagerProject#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Project name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/resourcemanager_project#name ResourcemanagerProject#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/resourcemanager_project#owner_email ResourcemanagerProject#owner_email}
  */
  readonly ownerEmail: string;
  /**
  * Parent resource identifier. Both container ID (user-friendly) and UUID are supported
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/resourcemanager_project#parent_container_id ResourcemanagerProject#parent_container_id}
  */
  readonly parentContainerId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/resourcemanager_project stackit_resourcemanager_project}
*/
export class ResourcemanagerProject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourcemanagerProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/resourcemanager_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/resources/resourcemanager_project stackit_resourcemanager_project} Resource
  *
  * @param scope The scope in which to define this construct
