// https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/observability_logalertgroup
...
export interface DataStackitObservabilityLogalertgroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/observability_logalertgroup#instance_id DataStackitObservabilityLogalertgroup#instance_id}
  */
  readonly instanceId: string;
  /**
  * The name of the log alert group. Is the identifier and must be unique in the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/observability_logalertgroup#name DataStackitObservabilityLogalertgroup#name}
  */
  readonly name: string;
  /**
  * STACKIT project ID to which the log alert group is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/observability_logalertgroup#project_id DataStackitObservabilityLogalertgroup#project_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/observability_logalertgroup stackit_observability_logalertgroup}
*/
export class DataStackitObservabilityLogalertgroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitObservabilityLogalertgroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/observability_logalertgroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.73.0/docs/data-sources/observability_logalertgroup stackit_observability_logalertgroup} Data Source
  *
  * @param scope The scope in which to define this construct
