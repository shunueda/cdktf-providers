// https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/data-sources/rabbitmq_credential
...
export interface DataStackitRabbitmqCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  * The credential's ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/data-sources/rabbitmq_credential#credential_id DataStackitRabbitmqCredential#credential_id}
  */
  readonly credentialId: string;
  /**
  * ID of the RabbitMQ instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/data-sources/rabbitmq_credential#instance_id DataStackitRabbitmqCredential#instance_id}
  */
  readonly instanceId: string;
  /**
  * STACKIT project ID to which the instance is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/data-sources/rabbitmq_credential#project_id DataStackitRabbitmqCredential#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/data-sources/rabbitmq_credential stackit_rabbitmq_credential}
*/
export class DataStackitRabbitmqCredential extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitRabbitmqCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/data-sources/rabbitmq_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.74.0/docs/data-sources/rabbitmq_credential stackit_rabbitmq_credential} Data Source
  *
  * @param scope The scope in which to define this construct
