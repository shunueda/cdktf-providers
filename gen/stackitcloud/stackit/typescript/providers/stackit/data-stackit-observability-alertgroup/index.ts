// https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/observability_alertgroup
...
export interface DataStackitObservabilityAlertgroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/observability_alertgroup#instance_id DataStackitObservabilityAlertgroup#instance_id}
  */
  readonly instanceId: string;
  /**
  * The name of the alert group. Is the identifier and must be unique in the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/observability_alertgroup#name DataStackitObservabilityAlertgroup#name}
  */
  readonly name: string;
  /**
  * STACKIT project ID to which the alert group is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/observability_alertgroup#project_id DataStackitObservabilityAlertgroup#project_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/observability_alertgroup stackit_observability_alertgroup}
*/
export class DataStackitObservabilityAlertgroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitObservabilityAlertgroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/observability_alertgroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.69.0/docs/data-sources/observability_alertgroup stackit_observability_alertgroup} Data Source
  *
  * @param scope The scope in which to define this construct
