// https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance
...
export interface OpensearchInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  * Instance name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#name OpensearchInstance#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#parameters OpensearchInstance#parameters}
  */
  readonly parameters?: OpensearchInstanceParameters;
  /**
  * The selected plan name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#plan_name OpensearchInstance#plan_name}
  */
  readonly planName: string;
  /**
  * STACKIT project ID to which the instance is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#project_id OpensearchInstance#project_id}
  */
  readonly projectId: string;
  /**
  * The service version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#version OpensearchInstance#version}
  */
...
export interface OpensearchInstanceParameters {
  ...
  * Enable monitoring.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#enable_monitoring OpensearchInstance#enable_monitoring}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#graphite OpensearchInstance#graphite}
  */
  readonly graphite?: string;
  /**
  * The garbage collector to use for OpenSearch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#java_garbage_collector OpensearchInstance#java_garbage_collector}
  */
  readonly javaGarbageCollector?: string;
  /**
  * The amount of memory (in MB) allocated as heap by the JVM for OpenSearch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#java_heapspace OpensearchInstance#java_heapspace}
  */
  readonly javaHeapspace?: number;
  /**
  * The amount of memory (in MB) used by the JVM to store metadata for OpenSearch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#java_maxmetaspace OpensearchInstance#java_maxmetaspace}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#max_disk_threshold OpensearchInstance#max_disk_threshold}
  */
  readonly maxDiskThreshold?: number;
  /**
  * The frequency in seconds at which metrics are emitted (in seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#metrics_frequency OpensearchInstance#metrics_frequency}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#metrics_prefix OpensearchInstance#metrics_prefix}
  */
  readonly metricsPrefix?: string;
  /**
  * The ID of the STACKIT monitoring instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#monitoring_instance_id OpensearchInstance#monitoring_instance_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#plugins OpensearchInstance#plugins}
  */
  readonly plugins?: string[];
  /**
  * Comma separated list of IP networks in CIDR notation which are allowed to access this instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#sgw_acl OpensearchInstance#sgw_acl}
  */
  readonly sgwAcl?: string;
  /**
  * List of syslog servers to send logs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#syslog OpensearchInstance#syslog}
  */
  readonly syslog?: string[];
  /**
  * List of TLS ciphers to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#tls_ciphers OpensearchInstance#tls_ciphers}
  */
  readonly tlsCiphers?: string[];
  /**
  * The TLS protocol to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#tls_protocols OpensearchInstance#tls_protocols}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance stackit_opensearch_instance}
*/
export class OpensearchInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpensearchInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stackitcloud/stackit/0.71.0/docs/resources/opensearch_instance stackit_opensearch_instance} Resource
  *
  * @param scope The scope in which to define this construct
