// https://registry.terraform.io/providers/kbst/kustomization/0.9.7/docs/data-sources/build
...
export interface DataKustomizationBuildConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.7/docs/data-sources/build#id DataKustomizationBuild#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.7/docs/data-sources/build#path DataKustomizationBuild#path}
  */
  readonly path: string;
  /**
  * kustomize_options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.7/docs/data-sources/build#kustomize_options DataKustomizationBuild#kustomize_options}
  */
  readonly kustomizeOptions?: DataKustomizationBuildKustomizeOptions;
}
export interface DataKustomizationBuildKustomizeOptions {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.7/docs/data-sources/build#enable_alpha_plugins DataKustomizationBuild#enable_alpha_plugins}
  */
  readonly enableAlphaPlugins?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.7/docs/data-sources/build#enable_exec DataKustomizationBuild#enable_exec}
  */
  readonly enableExec?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.7/docs/data-sources/build#enable_helm DataKustomizationBuild#enable_helm}
  */
  readonly enableHelm?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.7/docs/data-sources/build#enable_star DataKustomizationBuild#enable_star}
  */
  readonly enableStar?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.7/docs/data-sources/build#helm_path DataKustomizationBuild#helm_path}
  */
  readonly helmPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.7/docs/data-sources/build#load_restrictor DataKustomizationBuild#load_restrictor}
  */
  readonly loadRestrictor?: string;
}

export function dataKustomizationBuildKustomizeOptionsToTerraform(struct?: DataKustomizationBuildKustomizeOptionsOutputReference | DataKustomizationBuildKustomizeOptions): any {
...
export function dataKustomizationBuildKustomizeOptionsToHclTerraform(struct?: DataKustomizationBuildKustomizeOptionsOutputReference | DataKustomizationBuildKustomizeOptions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataKustomizationBuildKustomizeOptionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataKustomizationBuildKustomizeOptions | undefined {
  ...
  public set internalValue(value: DataKustomizationBuildKustomizeOptions | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.7/docs/data-sources/build kustomization_build}
*/
export class DataKustomizationBuild extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "kustomization_build";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataKustomizationBuild resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataKustomizationBuild to import
  * @param importFromId The id of the existing DataKustomizationBuild that should be imported. Refer to the {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.7/docs/data-sources/build#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataKustomizationBuild to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "kustomization_build", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kbst/kustomization/0.9.7/docs/data-sources/build kustomization_build} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataKustomizationBuildConfig
  */
  public constructor(scope: Construct, id: string, config: DataKustomizationBuildConfig) {
    super(scope, id, {
      terraformResourceType: 'kustomization_build',
  ...
  private _kustomizeOptions = new DataKustomizationBuildKustomizeOptionsOutputReference(this, "kustomize_options");
  public get kustomizeOptions() {
    return this._kustomizeOptions;
  }
  public putKustomizeOptions(value: DataKustomizationBuildKustomizeOptions) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      kustomize_options: dataKustomizationBuildKustomizeOptionsToTerraform(this._kustomizeOptions.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      kustomize_options: {
        value: dataKustomizationBuildKustomizeOptionsToHclTerraform(this._kustomizeOptions.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataKustomizationBuildKustomizeOptionsList",
      },
    };
