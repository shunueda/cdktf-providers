...
export interface DataZillizcloudDatabasesConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataZillizcloudDatabasesItems {
}

export function dataZillizcloudDatabasesItemsToTerraform(struct?: DataZillizcloudDatabasesItems): any {
...
export function dataZillizcloudDatabasesItemsToHclTerraform(struct?: DataZillizcloudDatabasesItems): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataZillizcloudDatabasesItemsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataZillizcloudDatabasesItems | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataZillizcloudDatabasesItems | undefined) {
    if (value === undefined) {
...
export class DataZillizcloudDatabasesItemsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataZillizcloudDatabasesItemsOutputReference {
    return new DataZillizcloudDatabasesItemsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataZillizcloudDatabases extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "zillizcloud_databases";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "zillizcloud_databases", importId: importFromId, provider });
      }
  ...
  * @param options DataZillizcloudDatabasesConfig
  */
  public constructor(scope: Construct, id: string, config: DataZillizcloudDatabasesConfig) {
    super(scope, id, {
  ...
  private _items = new DataZillizcloudDatabasesItemsList(this, "items", false);
  public get items() {
    return this._items;
  }
