...
export interface DataZillizcloudIndexesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Collection name
  *
...
export interface DataZillizcloudIndexesItems {
}

export function dataZillizcloudIndexesItemsToTerraform(struct?: DataZillizcloudIndexesItems): any {
...
export function dataZillizcloudIndexesItemsToHclTerraform(struct?: DataZillizcloudIndexesItems): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataZillizcloudIndexesItemsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataZillizcloudIndexesItems | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataZillizcloudIndexesItems | undefined) {
    if (value === undefined) {
...
export class DataZillizcloudIndexesItemsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataZillizcloudIndexesItemsOutputReference {
    return new DataZillizcloudIndexesItemsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataZillizcloudIndexes extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "zillizcloud_indexes";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "zillizcloud_indexes", importId: importFromId, provider });
      }
  ...
  * @param options DataZillizcloudIndexesConfig
  */
  public constructor(scope: Construct, id: string, config: DataZillizcloudIndexesConfig) {
    super(scope, id, {
  ...
  private _items = new DataZillizcloudIndexesItemsList(this, "items", false);
  public get items() {
    return this._items;
  }
