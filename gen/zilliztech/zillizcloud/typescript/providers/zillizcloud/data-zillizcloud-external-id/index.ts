// https://registry.terraform.io/providers/zilliztech/zillizcloud/0.6.23/docs/data-sources/external_id
...
/**
* Represents a {@link https://registry.terraform.io/providers/zilliztech/zillizcloud/0.6.23/docs/data-sources/external_id zillizcloud_external_id}
*/
export class DataZillizcloudExternalId extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZillizcloudExternalId that should be imported. Refer to the {@link https://registry.terraform.io/providers/zilliztech/zillizcloud/0.6.23/docs/data-sources/external_id#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zilliztech/zillizcloud/0.6.23/docs/data-sources/external_id zillizcloud_external_id} Data Source
  *
  * @param scope The scope in which to define this construct
