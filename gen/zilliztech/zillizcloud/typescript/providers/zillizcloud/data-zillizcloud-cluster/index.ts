// https://registry.terraform.io/providers/zilliztech/zillizcloud/0.6.24/docs/data-sources/cluster
...
export interface DataZillizcloudClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zilliztech/zillizcloud/0.6.24/docs/data-sources/cluster#id DataZillizcloudCluster#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/zilliztech/zillizcloud/0.6.24/docs/data-sources/cluster zillizcloud_cluster}
*/
export class DataZillizcloudCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataZillizcloudCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/zilliztech/zillizcloud/0.6.24/docs/data-sources/cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zilliztech/zillizcloud/0.6.24/docs/data-sources/cluster zillizcloud_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
