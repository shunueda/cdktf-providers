// https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/sudo_rule_allowcmd_membership
...
export interface SudoRuleAllowcmdMembershipConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/sudo_rule_allowcmd_membership#id SudoRuleAllowcmdMembership#id}
  *
  ...
  * Sudo rule name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/sudo_rule_allowcmd_membership#name SudoRuleAllowcmdMembership#name}
  */
  readonly name: string;
  /**
  * Sudo command to allow by the sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/sudo_rule_allowcmd_membership#sudocmd SudoRuleAllowcmdMembership#sudocmd}
  */
  readonly sudocmd?: string;
  /**
  * Sudo command group to allow by the sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/sudo_rule_allowcmd_membership#sudocmd_group SudoRuleAllowcmdMembership#sudocmd_group}
  */
  readonly sudocmdGroup?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/sudo_rule_allowcmd_membership freeipa_sudo_rule_allowcmd_membership}
*/
export class SudoRuleAllowcmdMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SudoRuleAllowcmdMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/sudo_rule_allowcmd_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/sudo_rule_allowcmd_membership freeipa_sudo_rule_allowcmd_membership} Resource
  *
  * @param scope The scope in which to define this construct
