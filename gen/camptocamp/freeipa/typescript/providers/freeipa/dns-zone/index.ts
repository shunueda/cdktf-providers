// https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone
...
export interface DnsZoneConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#admin_email_address DnsZone#admin_email_address}
  */
  readonly adminEmailAddress?: string;
  /**
  * Allow inline DNSSEC signing of records in the zone
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#allow_inline_dnssec_signing DnsZone#allow_inline_dnssec_signing}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#allow_prt_sync DnsZone#allow_prt_sync}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#allow_query DnsZone#allow_query}
  */
  readonly allowQuery?: string;
  /**
  * Semicolon separated list of IP addresses or networks which are allowed to transfer the zone
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#allow_transfer DnsZone#allow_transfer}
  */
  readonly allowTransfer?: string;
  /**
  * Authoritative nameserver domain name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#authoritative_nameserver DnsZone#authoritative_nameserver}
  */
  readonly authoritativeNameserver?: string;
  /**
  * BIND update policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#bind_update_policy DnsZone#bind_update_policy}
  */
  readonly bindUpdatePolicy?: string;
  /**
  * Time to live for records without explicit TTL definition
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#default_ttl DnsZone#default_ttl}
  */
  readonly defaultTtl?: number;
  /**
  * Allow disabled the zone
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#disable_zone DnsZone#disable_zone}
  */
  readonly disableZone?: boolean | cdktf.IResolvable;
  /**
  * Allow dynamic updates
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#dynamic_updates DnsZone#dynamic_updates}
  */
  readonly dynamicUpdates?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#id DnsZone#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#is_reverse_zone DnsZone#is_reverse_zone}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#nsec3param_record DnsZone#nsec3param_record}
  */
  readonly nsec3ParamRecord?: string;
  /**
  * Force DNS zone creation even if nameserver is not resolvable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#skip_nameserver_check DnsZone#skip_nameserver_check}
  */
  readonly skipNameserverCheck?: boolean | cdktf.IResolvable;
  /**
  * Force DNS zone creation even if it will overlap with an existing zone
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#skip_overlap_check DnsZone#skip_overlap_check}
  */
  readonly skipOverlapCheck?: boolean | cdktf.IResolvable;
  /**
  * SOA record expire time
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#soa_expire DnsZone#soa_expire}
  */
  readonly soaExpire?: number;
  /**
  * How long should negative responses be cached
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#soa_minimum DnsZone#soa_minimum}
  */
  readonly soaMinimum?: number;
  /**
  * SOA record refresh time
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#soa_refresh DnsZone#soa_refresh}
  */
  readonly soaRefresh?: number;
  /**
  * SOA record retry time
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#soa_retry DnsZone#soa_retry}
  */
  readonly soaRetry?: number;
  /**
  * SOA record serial number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#soa_serial_number DnsZone#soa_serial_number}
  */
  readonly soaSerialNumber?: number;
  /**
  * Time to live for records at zone apex
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#ttl DnsZone#ttl}
  */
  readonly ttl?: number;
  /**
  * Per-zone forwarders. A custom port can be specified for each forwarder using a standard format IP_ADDRESS port PORT
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#zone_forwarders DnsZone#zone_forwarders}
  */
  readonly zoneForwarders?: string[];
  /**
  * Zone name (FQDN)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#zone_name DnsZone#zone_name}
  */
  readonly zoneName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone freeipa_dns_zone}
*/
export class DnsZone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/camptocamp/freeipa/1.0.0/docs/resources/dns_zone freeipa_dns_zone} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // allow_inline_dnssec_signing - computed: false, optional: true, required: false
  ...
  // allow_prt_sync - computed: false, optional: true, required: false
  ...
  // disable_zone - computed: false, optional: true, required: false
  ...
  // is_reverse_zone - computed: false, optional: true, required: false
  ...
  // skip_nameserver_check - computed: false, optional: true, required: false
  ...
  // skip_overlap_check - computed: false, optional: true, required: false
  ...
  // soa_minimum - computed: false, optional: true, required: false
  ...
  // soa_serial_number - computed: false, optional: true, required: false
