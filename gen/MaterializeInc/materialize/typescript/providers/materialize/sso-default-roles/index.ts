// https://registry.terraform.io/providers/materializeinc/materialize/0.9.3/docs/resources/sso_default_roles
...
export interface SsoDefaultRolesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.3/docs/resources/sso_default_roles#id SsoDefaultRoles#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.3/docs/resources/sso_default_roles#roles SsoDefaultRoles#roles}
  */
  readonly roles: string[];
  /**
  * The ID of the associated SSO configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.3/docs/resources/sso_default_roles#sso_config_id SsoDefaultRoles#sso_config_id}
  */
  readonly ssoConfigId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.3/docs/resources/sso_default_roles materialize_sso_default_roles}
*/
export class SsoDefaultRoles extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsoDefaultRoles that should be imported. Refer to the {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.3/docs/resources/sso_default_roles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.3/docs/resources/sso_default_roles materialize_sso_default_roles} Resource
  *
  * @param scope The scope in which to define this construct
