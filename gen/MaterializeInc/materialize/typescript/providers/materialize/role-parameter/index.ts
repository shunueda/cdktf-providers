// https://registry.terraform.io/providers/materializeinc/materialize/0.10.0/docs/resources/role_parameter
...
export interface RoleParameterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.10.0/docs/resources/role_parameter#id RoleParameter#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.10.0/docs/resources/role_parameter#region RoleParameter#region}
  */
  readonly region?: string;
  /**
  * The name of the role to grant privilege to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.10.0/docs/resources/role_parameter#role_name RoleParameter#role_name}
  */
  readonly roleName: string;
  /**
  * The name of the session variable to modify.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.10.0/docs/resources/role_parameter#variable_name RoleParameter#variable_name}
  */
  readonly variableName: string;
  /**
  * The value to assign to the session variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.10.0/docs/resources/role_parameter#variable_value RoleParameter#variable_value}
  */
  readonly variableValue: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/materializeinc/materialize/0.10.0/docs/resources/role_parameter materialize_role_parameter}
*/
export class RoleParameter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoleParameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/materializeinc/materialize/0.10.0/docs/resources/role_parameter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/materializeinc/materialize/0.10.0/docs/resources/role_parameter materialize_role_parameter} Resource
  *
  * @param scope The scope in which to define this construct
