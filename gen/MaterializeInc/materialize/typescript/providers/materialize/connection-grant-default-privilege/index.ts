// https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/connection_grant_default_privilege
...
export interface ConnectionGrantDefaultPrivilegeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/connection_grant_default_privilege#database_name ConnectionGrantDefaultPrivilege#database_name}
  */
  readonly databaseName?: string;
  /**
  * The role name that will gain the default privilege. Use the `PUBLIC` pseudo-role to grant privileges to all roles.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/connection_grant_default_privilege#grantee_name ConnectionGrantDefaultPrivilege#grantee_name}
  */
  readonly granteeName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/connection_grant_default_privilege#id ConnectionGrantDefaultPrivilege#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/connection_grant_default_privilege#privilege ConnectionGrantDefaultPrivilege#privilege}
  */
  readonly privilege: string;
  /**
  * The region to use for the resource connection. If not set, the default region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/connection_grant_default_privilege#region ConnectionGrantDefaultPrivilege#region}
  */
  readonly region?: string;
  /**
  * The default privilege will apply only to objects created in this schema, if specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/connection_grant_default_privilege#schema_name ConnectionGrantDefaultPrivilege#schema_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/connection_grant_default_privilege#target_role_name ConnectionGrantDefaultPrivilege#target_role_name}
  */
  readonly targetRoleName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/connection_grant_default_privilege materialize_connection_grant_default_privilege}
*/
export class ConnectionGrantDefaultPrivilege extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectionGrantDefaultPrivilege that should be imported. Refer to the {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/connection_grant_default_privilege#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/connection_grant_default_privilege materialize_connection_grant_default_privilege} Resource
  *
  * @param scope The scope in which to define this construct
