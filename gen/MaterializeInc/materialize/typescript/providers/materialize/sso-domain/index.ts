// https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/sso_domain
...
export interface SsoDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/sso_domain#domain SsoDomain#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/sso_domain#id SsoDomain#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/sso_domain#sso_config_id SsoDomain#sso_config_id}
  */
  readonly ssoConfigId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/sso_domain materialize_sso_domain}
*/
export class SsoDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsoDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/sso_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.5/docs/resources/sso_domain materialize_sso_domain} Resource
  *
  * @param scope The scope in which to define this construct
