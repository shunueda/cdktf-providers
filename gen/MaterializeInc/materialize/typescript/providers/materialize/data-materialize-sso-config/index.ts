// https://registry.terraform.io/providers/materializeinc/materialize/0.10.0/docs/data-sources/sso_config
...
export interface DataMaterializeSsoConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.10.0/docs/data-sources/sso_config#id DataMaterializeSsoConfig#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/materializeinc/materialize/0.10.0/docs/data-sources/sso_config materialize_sso_config}
*/
export class DataMaterializeSsoConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMaterializeSsoConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/materializeinc/materialize/0.10.0/docs/data-sources/sso_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/materializeinc/materialize/0.10.0/docs/data-sources/sso_config materialize_sso_config} Data Source
  *
  * @param scope The scope in which to define this construct
