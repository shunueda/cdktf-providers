// https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/data-sources/user
...
export interface DataMaterializeUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/data-sources/user#email DataMaterializeUser#email}
  */
  readonly email: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/data-sources/user materialize_user}
*/
export class DataMaterializeUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMaterializeUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/data-sources/user materialize_user} Data Source
  *
  * @param scope The scope in which to define this construct
