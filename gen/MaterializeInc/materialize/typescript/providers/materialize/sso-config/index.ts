// https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/sso_config
...
export interface SsoConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/sso_config#enabled SsoConfig#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/sso_config#id SsoConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/sso_config#oidc_client_id SsoConfig#oidc_client_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/sso_config#oidc_secret SsoConfig#oidc_secret}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/sso_config#public_certificate SsoConfig#public_certificate}
  */
  readonly publicCertificate: string;
  /**
  * Indicates whether the SSO request needs to be digitally signed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/sso_config#sign_request SsoConfig#sign_request}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/sso_config#sso_endpoint SsoConfig#sso_endpoint}
  */
  readonly ssoEndpoint: string;
  /**
  * Defines the type of SSO protocol being used (e.g., saml, oidc).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/sso_config#type SsoConfig#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/sso_config materialize_sso_config}
*/
export class SsoConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsoConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/sso_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/sso_config materialize_sso_config} Resource
  *
  * @param scope The scope in which to define this construct
