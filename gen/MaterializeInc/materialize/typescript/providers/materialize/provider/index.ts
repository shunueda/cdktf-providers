// https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs
...
export interface MaterializeProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs#base_endpoint MaterializeProvider#base_endpoint}
  */
  readonly baseEndpoint?: string;
  /**
  * The endpoint for the Materialize Cloud API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs#cloud_endpoint MaterializeProvider#cloud_endpoint}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs#database MaterializeProvider#database}
  */
  readonly database?: string;
  /**
  * The default region if not specified in the resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs#default_region MaterializeProvider#default_region}
  */
  readonly defaultRegion?: string;
  /**
  * The endpoint for the Materialize API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs#endpoint MaterializeProvider#endpoint}
  */
  readonly endpoint?: string;
  /**
  * The Materialize host. Can also come from the `MZ_HOST` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs#host MaterializeProvider#host}
  */
  readonly host?: string;
  /**
  * Materialize host. Can also come from the `MZ_PASSWORD` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs#password MaterializeProvider#password}
  */
  readonly password?: string;
  /**
  * The Materialize SQL port. Can also come from the `MZ_PORT` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs#port MaterializeProvider#port}
  */
  readonly port?: number;
  /**
  * For testing purposes, the SSL mode to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs#sslmode MaterializeProvider#sslmode}
  */
  readonly sslmode?: string;
  /**
  * The Materialize username. Can also come from the `MZ_USERNAME` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs#username MaterializeProvider#username}
  */
  readonly username?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs#alias MaterializeProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs materialize}
*/
export class MaterializeProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing MaterializeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs materialize} Resource
  *
  * @param scope The scope in which to define this construct
