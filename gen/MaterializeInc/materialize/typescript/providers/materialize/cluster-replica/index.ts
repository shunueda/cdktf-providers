// https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/cluster_replica
...
export interface ClusterReplicaConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/cluster_replica#availability_zone ClusterReplica#availability_zone}
  */
  readonly availabilityZone?: string;
  /**
  * The cluster whose resources you want to create an additional computation of.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/cluster_replica#cluster_name ClusterReplica#cluster_name}
  */
  readonly clusterName: string;
  /**
  * Comment on an object in the database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/cluster_replica#comment ClusterReplica#comment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/cluster_replica#disk ClusterReplica#disk}
  */
  readonly disk?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/cluster_replica#id ClusterReplica#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/cluster_replica#introspection_debugging ClusterReplica#introspection_debugging}
  */
  readonly introspectionDebugging?: boolean | cdktf.IResolvable;
  /**
  * The interval at which to collect introspection data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/cluster_replica#introspection_interval ClusterReplica#introspection_interval}
  */
  readonly introspectionInterval?: string;
  /**
  * The identifier for the replica.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/cluster_replica#name ClusterReplica#name}
  */
  readonly name: string;
  /**
  * The region to use for the resource connection. If not set, the default region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/cluster_replica#region ClusterReplica#region}
  */
  readonly region?: string;
  /**
  * The size of the replica.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/cluster_replica#size ClusterReplica#size}
  */
  readonly size: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/cluster_replica materialize_cluster_replica}
*/
export class ClusterReplica extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusterReplica that should be imported. Refer to the {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/cluster_replica#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.4/docs/resources/cluster_replica materialize_cluster_replica} Resource
  *
  * @param scope The scope in which to define this construct
