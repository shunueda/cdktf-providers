// https://registry.terraform.io/providers/materializeinc/materialize/0.9.2/docs/resources/materialized_view
...
export interface MaterializedViewConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.2/docs/resources/materialized_view#cluster_name MaterializedView#cluster_name}
  */
  readonly clusterName: string;
  /**
  * Comment on an object in the database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.2/docs/resources/materialized_view#comment MaterializedView#comment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.2/docs/resources/materialized_view#database_name MaterializedView#database_name}
  */
  readonly databaseName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.2/docs/resources/materialized_view#id MaterializedView#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.2/docs/resources/materialized_view#name MaterializedView#name}
  */
  readonly name: string;
  /**
  * A list of columns for which to create non-null assertions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.2/docs/resources/materialized_view#not_null_assertion MaterializedView#not_null_assertion}
  */
  readonly notNullAssertion?: string[];
  /**
  * The owernship role of the object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.2/docs/resources/materialized_view#ownership_role MaterializedView#ownership_role}
  */
  readonly ownershipRole?: string;
  /**
  * The region to use for the resource connection. If not set, the default region is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.2/docs/resources/materialized_view#region MaterializedView#region}
  */
  readonly region?: string;
  /**
  * The identifier for the materialized view schema in Materialize. Defaults to `public`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.2/docs/resources/materialized_view#schema_name MaterializedView#schema_name}
  */
  readonly schemaName?: string;
  /**
  * The SQL statement for the materialized view.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.2/docs/resources/materialized_view#statement MaterializedView#statement}
  */
  readonly statement: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.2/docs/resources/materialized_view materialize_materialized_view}
*/
export class MaterializedView extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MaterializedView that should be imported. Refer to the {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.2/docs/resources/materialized_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/materializeinc/materialize/0.9.2/docs/resources/materialized_view materialize_materialized_view} Resource
  *
  * @param scope The scope in which to define this construct
