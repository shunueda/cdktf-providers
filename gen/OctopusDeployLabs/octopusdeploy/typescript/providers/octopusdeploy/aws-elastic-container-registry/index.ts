// https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry
...
export interface AwsElasticContainerRegistryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry#access_key AwsElasticContainerRegistry#access_key}
  */
  readonly accessKey?: string;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry#name AwsElasticContainerRegistry#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry#oidc_authentication AwsElasticContainerRegistry#oidc_authentication}
  */
  readonly oidcAuthentication?: AwsElasticContainerRegistryOidcAuthentication;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry#package_acquisition_location_options AwsElasticContainerRegistry#package_acquisition_location_options}
  */
  readonly packageAcquisitionLocationOptions?: string[];
  /**
  * The AWS region where the registry resides.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry#region AwsElasticContainerRegistry#region}
  */
  readonly region: string;
  /**
  * The AWS secret key to use when authenticating against Amazon Web Services.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry#secret_key AwsElasticContainerRegistry#secret_key}
  */
  readonly secretKey?: string;
  /**
  * The space ID associated with this aws elastic container registry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry#space_id AwsElasticContainerRegistry#space_id}
  */
...
export interface AwsElasticContainerRegistryOidcAuthentication {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry#audience AwsElasticContainerRegistry#audience}
  */
  readonly audience?: string;
  /**
  * The Amazon Resource Name (ARN) of the role that the caller is assuming.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry#role_arn AwsElasticContainerRegistry#role_arn}
  */
  readonly roleArn?: string;
  /**
  * Assumed role session duration (in seconds)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry#session_duration AwsElasticContainerRegistry#session_duration}
  */
  readonly sessionDuration?: string;
  /**
  * Keys to include in a deployment or runbook. Valid options are `space`, `feed`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry#subject_keys AwsElasticContainerRegistry#subject_keys}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry octopusdeploy_aws_elastic_container_registry}
*/
export class AwsElasticContainerRegistry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsElasticContainerRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/aws_elastic_container_registry octopusdeploy_aws_elastic_container_registry} Resource
  *
  * @param scope The scope in which to define this construct
