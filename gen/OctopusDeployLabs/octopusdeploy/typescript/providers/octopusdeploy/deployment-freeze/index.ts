// https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze
...
export interface DeploymentFreezeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#end DeploymentFreeze#end}
  */
  readonly end: string;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#name DeploymentFreeze#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#recurring_schedule DeploymentFreeze#recurring_schedule}
  */
  readonly recurringSchedule?: DeploymentFreezeRecurringSchedule;
  /**
  * The start time of the freeze, must be RFC3339 format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#start DeploymentFreeze#start}
  */
...
export interface DeploymentFreezeRecurringSchedule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#date_of_month DeploymentFreeze#date_of_month}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#day_number_of_month DeploymentFreeze#day_number_of_month}
  */
  readonly dayNumberOfMonth?: string;
  /**
  * The day of the week for monthly schedules when using DayOfMonth type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#day_of_week DeploymentFreeze#day_of_week}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#days_of_week DeploymentFreeze#days_of_week}
  */
  readonly daysOfWeek?: string[];
  /**
  * Number of occurrences after which the schedule should end
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#end_after_occurrences DeploymentFreeze#end_after_occurrences}
  */
  readonly endAfterOccurrences?: number;
  /**
  * The date when the recurring schedule should end
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#end_on_date DeploymentFreeze#end_on_date}
  */
  readonly endOnDate?: string;
  /**
  * When the recurring schedule should end (Never, OnDate, AfterOccurrences)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#end_type DeploymentFreeze#end_type}
  */
  readonly endType: string;
  /**
  * Type of monthly schedule (DayOfMonth, DateOfMonth)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#monthly_schedule_type DeploymentFreeze#monthly_schedule_type}
  */
  readonly monthlyScheduleType?: string;
  /**
  * Type of recurring schedule (Daily, Weekly, Monthly, Annually)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#type DeploymentFreeze#type}
  */
  readonly type: string;
  /**
  * The unit value for the schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#unit DeploymentFreeze#unit}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze octopusdeploy_deployment_freeze}
*/
export class DeploymentFreeze extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeploymentFreeze that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze octopusdeploy_deployment_freeze} Resource
  *
  * @param scope The scope in which to define this construct
