// https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/space
...
export interface SpaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/space#description Space#description}
  */
  readonly description?: string;
  /**
  * Specifies if this space is the default space in Octopus.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/space#is_default Space#is_default}
  */
  readonly isDefault?: boolean | cdktf.IResolvable;
  /**
  * Specifies the status of the task queue for this space.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/space#is_task_queue_stopped Space#is_task_queue_stopped}
  */
  readonly isTaskQueueStopped?: boolean | cdktf.IResolvable;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/space#name Space#name}
  */
  readonly name: string;
  /**
  * The unique slug of this space
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/space#slug Space#slug}
  */
  readonly slug?: string;
  /**
  * A list of user IDs designated to be managers of this space.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/space#space_managers_team_members Space#space_managers_team_members}
  */
  readonly spaceManagersTeamMembers?: string[];
  /**
  * A list of team IDs designated to be managers of this space.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/space#space_managers_teams Space#space_managers_teams}
  */
  readonly spaceManagersTeams?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/space octopusdeploy_space}
*/
export class Space extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Space that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/space#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/space octopusdeploy_space} Resource
  *
  * @param scope The scope in which to define this construct
