// https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_tenant
...
export interface DeploymentFreezeTenantConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_tenant#deploymentfreeze_id DeploymentFreezeTenant#deploymentfreeze_id}
  */
  readonly deploymentfreezeId: string;
  /**
  * The environment ID associated with this freeze scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_tenant#environment_id DeploymentFreezeTenant#environment_id}
  */
  readonly environmentId: string;
  /**
  * The project ID associated with this freeze scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_tenant#project_id DeploymentFreezeTenant#project_id}
  */
  readonly projectId: string;
  /**
  * The tenant ID associated with this freeze scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_tenant#tenant_id DeploymentFreezeTenant#tenant_id}
  */
  readonly tenantId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_tenant octopusdeploy_deployment_freeze_tenant}
*/
export class DeploymentFreezeTenant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeploymentFreezeTenant that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_tenant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_tenant octopusdeploy_deployment_freeze_tenant} Resource
  *
  * @param scope The scope in which to define this construct
