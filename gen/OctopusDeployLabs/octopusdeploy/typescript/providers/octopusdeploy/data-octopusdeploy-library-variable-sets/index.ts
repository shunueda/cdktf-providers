// https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/data-sources/library_variable_sets
...
export interface DataOctopusdeployLibraryVariableSetsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/data-sources/library_variable_sets#content_type DataOctopusdeployLibraryVariableSets#content_type}
  */
  readonly contentType?: string;
  /**
  * A filter to search by a list of IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/data-sources/library_variable_sets#ids DataOctopusdeployLibraryVariableSets#ids}
  */
  readonly ids?: string[];
  /**
  * A filter to search by a partial name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/data-sources/library_variable_sets#partial_name DataOctopusdeployLibraryVariableSets#partial_name}
  */
  readonly partialName?: string;
  /**
  * A filter to specify the number of items to skip in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/data-sources/library_variable_sets#skip DataOctopusdeployLibraryVariableSets#skip}
  */
  readonly skip?: number;
  /**
  * The space ID associated with this library variable set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/data-sources/library_variable_sets#space_id DataOctopusdeployLibraryVariableSets#space_id}
  */
  readonly spaceId?: string;
  /**
  * A filter to specify the number of items to take (or return) in the response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/data-sources/library_variable_sets#take DataOctopusdeployLibraryVariableSets#take}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/data-sources/library_variable_sets octopusdeploy_library_variable_sets}
*/
export class DataOctopusdeployLibraryVariableSets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOctopusdeployLibraryVariableSets that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/data-sources/library_variable_sets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/data-sources/library_variable_sets octopusdeploy_library_variable_sets} Data Source
  *
  * @param scope The scope in which to define this construct
