// https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/polling_subscription_id
...
export interface PollingSubscriptionIdConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/polling_subscription_id#dependencies PollingSubscriptionId#dependencies}
  */
  readonly dependencies?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/polling_subscription_id octopusdeploy_polling_subscription_id}
*/
export class PollingSubscriptionId extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PollingSubscriptionId that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/polling_subscription_id#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/polling_subscription_id octopusdeploy_polling_subscription_id} Resource
  *
  * @param scope The scope in which to define this construct
