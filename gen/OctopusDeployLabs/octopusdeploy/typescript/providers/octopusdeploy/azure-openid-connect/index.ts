// https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect
...
export interface AzureOpenidConnectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#account_test_subject_keys AzureOpenidConnect#account_test_subject_keys}
  */
  readonly accountTestSubjectKeys?: string[];
  /**
  * The application ID of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#application_id AzureOpenidConnect#application_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#audience AzureOpenidConnect#audience}
  */
  readonly audience?: string;
  /**
  * The authentication endpoint URI for this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#authentication_endpoint AzureOpenidConnect#authentication_endpoint}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#azure_environment AzureOpenidConnect#azure_environment}
  */
  readonly azureEnvironment?: string;
  /**
  * The description of this Azure OpenID Connect account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#description AzureOpenidConnect#description}
  */
  readonly description?: string;
  /**
  * A list of environment IDs associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#environments AzureOpenidConnect#environments}
  */
  readonly environments?: string[];
  /**
  * Keys to include in a deployment or runbook. Valid options are `space`, `environment`, `project`, `tenant`, `runbook`, `account`, `type`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#execution_subject_keys AzureOpenidConnect#execution_subject_keys}
  */
  readonly executionSubjectKeys?: string[];
  /**
  * Keys to include in a health check. Valid options are `space`, `account`, `target`, `type`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#health_subject_keys AzureOpenidConnect#health_subject_keys}
  */
  readonly healthSubjectKeys?: string[];
  /**
  * The unique ID for this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#id AzureOpenidConnect#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#name AzureOpenidConnect#name}
  */
  readonly name: string;
  /**
  * The resource manager endpoint URI for this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#resource_manager_endpoint AzureOpenidConnect#resource_manager_endpoint}
  */
  readonly resourceManagerEndpoint?: string;
  /**
  * The space ID associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#space_id AzureOpenidConnect#space_id}
  */
  readonly spaceId?: string;
  /**
  * The subscription ID of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#subscription_id AzureOpenidConnect#subscription_id}
  */
  readonly subscriptionId: string;
  /**
  * The tenant ID of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#tenant_id AzureOpenidConnect#tenant_id}
  */
  readonly tenantId: string;
  /**
  * A list of tenant tags associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#tenant_tags AzureOpenidConnect#tenant_tags}
  */
  readonly tenantTags?: string[];
  /**
  * The tenanted deployment mode of the resource. Valid account types are `Untenanted`, `TenantedOrUntenanted`, or `Tenanted`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#tenanted_deployment_participation AzureOpenidConnect#tenanted_deployment_participation}
  */
  readonly tenantedDeploymentParticipation?: string;
  /**
  * A list of tenant IDs associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#tenants AzureOpenidConnect#tenants}
  */
  readonly tenants?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect octopusdeploy_azure_openid_connect}
*/
export class AzureOpenidConnect extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureOpenidConnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_openid_connect octopusdeploy_azure_openid_connect} Resource
  *
  * @param scope The scope in which to define this construct
