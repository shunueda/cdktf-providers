// https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry
...
export interface AzureContainerRegistryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry#api_version AzureContainerRegistry#api_version}
  */
  readonly apiVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry#feed_uri AzureContainerRegistry#feed_uri}
  */
  readonly feedUri: string;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry#name AzureContainerRegistry#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry#oidc_authentication AzureContainerRegistry#oidc_authentication}
  */
  readonly oidcAuthentication?: AzureContainerRegistryOidcAuthentication;
  /**
  * The password associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry#password AzureContainerRegistry#password}
  */
  readonly password?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry#registry_path AzureContainerRegistry#registry_path}
  */
  readonly registryPath?: string;
  /**
  * The space ID associated with this Azure container registry feed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry#space_id AzureContainerRegistry#space_id}
  */
  readonly spaceId?: string;
  /**
  * The username associated with this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry#username AzureContainerRegistry#username}
  */
...
export interface AzureContainerRegistryOidcAuthentication {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry#audience AzureContainerRegistry#audience}
  */
  readonly audience?: string;
  /**
  * Unique identifier representing the application requesting authentication
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry#client_id AzureContainerRegistry#client_id}
  */
  readonly clientId?: string;
  /**
  * Keys to include in a deployment or runbook. Valid options are `space`, `feed`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry#subject_keys AzureContainerRegistry#subject_keys}
  */
  readonly subjectKeys?: string[];
  /**
  * Unique identifier representing the Azure AD instance hosting the authenticating application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry#tenant_id AzureContainerRegistry#tenant_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry octopusdeploy_azure_container_registry}
*/
export class AzureContainerRegistry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureContainerRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/azure_container_registry octopusdeploy_azure_container_registry} Resource
  *
  * @param scope The scope in which to define this construct
