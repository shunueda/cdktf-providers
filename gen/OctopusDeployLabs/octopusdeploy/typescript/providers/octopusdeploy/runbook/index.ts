// https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook
...
export interface RunbookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#default_guided_failure_mode Runbook#default_guided_failure_mode}
  */
  readonly defaultGuidedFailureMode?: string;
  /**
  * The description of this runbook.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#description Runbook#description}
  */
  readonly description?: string;
  /**
  * Determines how the runbook is scoped to environments.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#environment_scope Runbook#environment_scope}
  */
  readonly environmentScope?: string;
  /**
  * When environment_scope is set to "Specified", this is the list of environments the runbook can be run against.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#environments Runbook#environments}
  */
  readonly environments?: string[];
  /**
  * Whether to force packages to be re-downloaded or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#force_package_download Runbook#force_package_download}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#multi_tenancy_mode Runbook#multi_tenancy_mode}
  */
  readonly multiTenancyMode?: string;
  /**
  * The name of the runbook in Octopus Deploy. This name must be unique.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#name Runbook#name}
  */
  readonly name: string;
  /**
  * The project that this runbook belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#project_id Runbook#project_id}
  */
  readonly projectId: string;
  /**
  * The space ID associated with this runbook.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#space_id Runbook#space_id}
  */
  readonly spaceId?: string;
  /**
  * connectivity_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#connectivity_policy Runbook#connectivity_policy}
  */
  readonly connectivityPolicy?: RunbookConnectivityPolicy[] | cdktf.IResolvable;
  /**
  * retention_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#retention_policy Runbook#retention_policy}
  */
  readonly retentionPolicy?: RunbookRetentionPolicy[] | cdktf.IResolvable;
}
export interface RunbookConnectivityPolicy {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#allow_deployments_to_no_targets Runbook#allow_deployments_to_no_targets}
  */
  readonly allowDeploymentsToNoTargets?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#exclude_unhealthy_targets Runbook#exclude_unhealthy_targets}
  */
  readonly excludeUnhealthyTargets?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#skip_machine_behavior Runbook#skip_machine_behavior}
  */
  readonly skipMachineBehavior?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#target_roles Runbook#target_roles}
  */
...
export interface RunbookRetentionPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#quantity_to_keep Runbook#quantity_to_keep}
  */
  readonly quantityToKeep?: number;
  /**
  * Indicates if items should never be deleted. The default value is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#should_keep_forever Runbook#should_keep_forever}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook octopusdeploy_runbook}
*/
export class Runbook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Runbook that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/runbook octopusdeploy_runbook} Resource
  *
  * @param scope The scope in which to define this construct
