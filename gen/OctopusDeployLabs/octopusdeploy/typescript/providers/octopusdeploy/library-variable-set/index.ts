// https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/library_variable_set
...
export interface LibraryVariableSetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/library_variable_set#description LibraryVariableSet#description}
  */
  readonly description?: string;
  /**
  * The name of this resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/library_variable_set#name LibraryVariableSet#name}
  */
  readonly name: string;
  /**
  * The space ID associated with this library variable set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/library_variable_set#space_id LibraryVariableSet#space_id}
  */
  readonly spaceId?: string;
  /**
  * template block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/library_variable_set#template LibraryVariableSet#template}
  */
...
export interface LibraryVariableSetTemplate {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/library_variable_set#default_value LibraryVariableSet#default_value}
  */
  readonly defaultValue?: string;
  /**
  * The display settings for the parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/library_variable_set#display_settings LibraryVariableSet#display_settings}
  */
  readonly displaySettings?: { [key: string]: string };
  /**
  * The help presented alongside the parameter input.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/library_variable_set#help_text LibraryVariableSet#help_text}
  */
  readonly helpText?: string;
  /**
  * The label shown beside the parameter when presented in the deployment process. Example: `Server name`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/library_variable_set#label LibraryVariableSet#label}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/library_variable_set octopusdeploy_library_variable_set}
*/
export class LibraryVariableSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LibraryVariableSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/library_variable_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/library_variable_set octopusdeploy_library_variable_set} Resource
  *
  * @param scope The scope in which to define this construct
