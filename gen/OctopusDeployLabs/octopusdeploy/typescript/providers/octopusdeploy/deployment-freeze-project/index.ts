// https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_project
...
export interface DeploymentFreezeProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_project#deploymentfreeze_id DeploymentFreezeProject#deploymentfreeze_id}
  */
  readonly deploymentfreezeId: string;
  /**
  * The environment IDs associated with this project deployment freeze scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_project#environment_ids DeploymentFreezeProject#environment_ids}
  */
  readonly environmentIds?: string[];
  /**
  * The project ID associated with this freeze scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_project#project_id DeploymentFreezeProject#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_project octopusdeploy_deployment_freeze_project}
*/
export class DeploymentFreezeProject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeploymentFreezeProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/octopusdeploylabs/octopusdeploy/0.43.2/docs/resources/deployment_freeze_project octopusdeploy_deployment_freeze_project} Resource
  *
  * @param scope The scope in which to define this construct
