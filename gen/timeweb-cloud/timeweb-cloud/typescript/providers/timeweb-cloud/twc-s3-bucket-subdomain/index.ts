// https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_s3_bucket_subdomain
...
export interface TwcS3BucketSubdomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_s3_bucket_subdomain#bucket_id TwcS3BucketSubdomain#bucket_id}
  */
  readonly bucketId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_s3_bucket_subdomain#id TwcS3BucketSubdomain#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_s3_bucket_subdomain#release_cert TwcS3BucketSubdomain#release_cert}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_s3_bucket_subdomain#subdomain TwcS3BucketSubdomain#subdomain}
  */
  readonly subdomain: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_s3_bucket_subdomain twc_s3_bucket_subdomain}
*/
export class TwcS3BucketSubdomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TwcS3BucketSubdomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_s3_bucket_subdomain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_s3_bucket_subdomain twc_s3_bucket_subdomain} Resource
  *
  * @param scope The scope in which to define this construct
