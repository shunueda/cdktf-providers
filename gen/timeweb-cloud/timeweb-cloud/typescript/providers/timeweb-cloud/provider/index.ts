// https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs
...
export interface TimewebCloudProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs#token TimewebCloudProvider#token}
  */
  readonly token?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs#alias TimewebCloudProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs timeweb-cloud}
*/
export class TimewebCloudProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing TimewebCloudProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs timeweb-cloud} Resource
  *
  * @param scope The scope in which to define this construct
