// https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_server_disk_backup
...
export interface TwcServerDiskBackupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Comment for backup
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_server_disk_backup#comment TwcServerDiskBackup#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_server_disk_backup#id TwcServerDiskBackup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_server_disk_backup#source_server_disk_id TwcServerDiskBackup#source_server_disk_id}
  */
  readonly sourceServerDiskId: number;
  /**
  * Server ID for which disk backups should be created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_server_disk_backup#source_server_id TwcServerDiskBackup#source_server_id}
  */
  readonly sourceServerId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_server_disk_backup twc_server_disk_backup}
*/
export class TwcServerDiskBackup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TwcServerDiskBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_server_disk_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_server_disk_backup twc_server_disk_backup} Resource
  *
  * @param scope The scope in which to define this construct
