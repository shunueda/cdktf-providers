// https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets
...
export interface DataTwcPresetsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#availability_zone DataTwcPresets#availability_zone}
  */
  readonly availabilityZone?: string;
  /**
  * Network bandwidth capacity of specified preset
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#bandwidth DataTwcPresets#bandwidth}
  */
  readonly bandwidth?: number;
  /**
  * CPU count of specified preset
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#cpu DataTwcPresets#cpu}
  */
  readonly cpu?: number;
  /**
  * CPU frequency for the created server (`3.3`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#cpu_frequency DataTwcPresets#cpu_frequency}
  */
  readonly cpuFrequency?: string;
  /**
  * Short description of specified preset
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#description_short DataTwcPresets#description_short}
  */
  readonly descriptionShort?: string;
  /**
  * Disk size of specified preset
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#disk DataTwcPresets#disk}
  */
  readonly disk?: number;
  /**
  * Disk type for the created server (`ssd`, `nvme`, `hdd`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#disk_type DataTwcPresets#disk_type}
  */
  readonly diskType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#id DataTwcPresets#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#is_allowed_local_network DataTwcPresets#is_allowed_local_network}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#location DataTwcPresets#location}
  */
  readonly location?: string;
  /**
  * Preset type for the created server (`premium`, `standard`, `high_cpu`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#preset_type DataTwcPresets#preset_type}
  */
  readonly presetType?: string;
  /**
  * RAM size of specified preset
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#ram DataTwcPresets#ram}
  */
  readonly ram?: number;
  /**
  * price_filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#price_filter DataTwcPresets#price_filter}
  */
...
export interface DataTwcPresetsPriceFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#from DataTwcPresets#from}
  */
  readonly from: number;
  /**
  * Maximum price (inclusive)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#to DataTwcPresets#to}
  */
  readonly to: number;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets twc_presets}
*/
export class DataTwcPresets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTwcPresets that should be imported. Refer to the {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/data-sources/twc_presets twc_presets} Data Source
  *
  * @param scope The scope in which to define this construct
