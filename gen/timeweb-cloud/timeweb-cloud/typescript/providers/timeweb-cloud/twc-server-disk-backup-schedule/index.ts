// https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.7/docs/resources/twc_server_disk_backup_schedule
...
export interface TwcServerDiskBackupScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.7/docs/resources/twc_server_disk_backup_schedule#copy_count TwcServerDiskBackupSchedule#copy_count}
  */
  readonly copyCount: number;
  /**
  * Creation date for first backup
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.7/docs/resources/twc_server_disk_backup_schedule#creation_start_at TwcServerDiskBackupSchedule#creation_start_at}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.7/docs/resources/twc_server_disk_backup_schedule#day_of_week TwcServerDiskBackupSchedule#day_of_week}
  */
  readonly dayOfWeek?: number;
  /**
  * Enable auto backups
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.7/docs/resources/twc_server_disk_backup_schedule#enabled TwcServerDiskBackupSchedule#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.7/docs/resources/twc_server_disk_backup_schedule#id TwcServerDiskBackupSchedule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.7/docs/resources/twc_server_disk_backup_schedule#interval TwcServerDiskBackupSchedule#interval}
  */
  readonly interval: string;
  /**
  * Disk ID for which backup should be configured
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.7/docs/resources/twc_server_disk_backup_schedule#source_server_disk_id TwcServerDiskBackupSchedule#source_server_disk_id}
  */
  readonly sourceServerDiskId: number;
  /**
  * Server ID for which disk auto backups should be configured
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.7/docs/resources/twc_server_disk_backup_schedule#source_server_id TwcServerDiskBackupSchedule#source_server_id}
  */
  readonly sourceServerId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.7/docs/resources/twc_server_disk_backup_schedule twc_server_disk_backup_schedule}
*/
export class TwcServerDiskBackupSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TwcServerDiskBackupSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.7/docs/resources/twc_server_disk_backup_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.7/docs/resources/twc_server_disk_backup_schedule twc_server_disk_backup_schedule} Resource
  *
  * @param scope The scope in which to define this construct
