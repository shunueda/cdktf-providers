// https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon
...
export interface TwcK8SAddonConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon#cluster_id TwcK8SAddon#cluster_id}
  */
  readonly clusterId: number;
  /**
  * Config type (`basic`, `custom`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon#config_type TwcK8SAddon#config_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon#type TwcK8SAddon#type}
  */
  readonly type: string;
  /**
  * Version of the config
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon#version TwcK8SAddon#version}
  */
  readonly version?: string;
  /**
  * YAML configuration for addon
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon#yaml_config TwcK8SAddon#yaml_config}
  */
  readonly yamlConfig?: string;
  /**
  * config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon#config TwcK8SAddon#config}
  */
...
export interface TwcK8SAddonConfigA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon#access_key TwcK8SAddon#access_key}
  */
  readonly accessKey: string;
  /**
  * Endpoint of the config
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon#endpoint TwcK8SAddon#endpoint}
  */
  readonly endpoint: string;
  /**
  * Name of the config
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon#name TwcK8SAddon#name}
  */
  readonly name: string;
  /**
  * Region of the config
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon#region TwcK8SAddon#region}
  */
  readonly region: string;
  /**
  * Secret key of the config
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon#secret_key TwcK8SAddon#secret_key}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon twc_k8s_addon}
*/
export class TwcK8SAddon extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TwcK8SAddon that should be imported. Refer to the {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_k8s_addon twc_k8s_addon} Resource
  *
  * @param scope The scope in which to define this construct
