// https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb
...
export interface TwcLbConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#algo TwcLb#algo}
  */
  readonly algo?: string;
  /**
  * Availability zone for load balancer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#availability_zone TwcLb#availability_zone}
  */
  readonly availabilityZone?: string;
  /**
  * Client timeout
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#client_timeout TwcLb#client_timeout}
  */
  readonly clientTimeout?: number;
  /**
  * Connection timeout
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#connect_timeout TwcLb#connect_timeout}
  */
  readonly connectTimeout?: number;
  /**
  * Floating IP ID for server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#floating_ip_id TwcLb#floating_ip_id}
  */
  readonly floatingIpId?: string;
  /**
  * Http request timeout
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#httprequest_timeout TwcLb#httprequest_timeout}
  */
  readonly httprequestTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#id TwcLb#id}
  *
  ...
  * Backends IPs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#ips TwcLb#ips}
  */
  readonly ips?: string[];
  /**
  * Keep alive connection from balancer to backend server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#is_keepalive TwcLb#is_keepalive}
  */
  readonly isKeepalive?: boolean | cdktf.IResolvable;
  /**
  * Automatic redirect HTTP to HTTPS
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#is_ssl TwcLb#is_ssl}
  */
  readonly isSsl?: boolean | cdktf.IResolvable;
  /**
  * Save user session for balancing to same backend server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#is_sticky TwcLb#is_sticky}
  */
  readonly isSticky?: boolean | cdktf.IResolvable;
  /**
  * Use PROXY-protocol for communicating with backend server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#is_use_proxy TwcLb#is_use_proxy}
  */
  readonly isUseProxy?: boolean | cdktf.IResolvable;
  /**
  * Maximum number of connections to backend server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#maxconn TwcLb#maxconn}
  */
  readonly maxconn?: number;
  /**
  * Name for balancer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#name TwcLb#name}
  */
  readonly name: string;
  /**
  * Preset ID for balancer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#preset_id TwcLb#preset_id}
  */
  readonly presetId: number;
  /**
  * Project ID for created balancer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#project_id TwcLb#project_id}
  */
  readonly projectId?: number;
  /**
  * Server timeout
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#server_timeout TwcLb#server_timeout}
  */
  readonly serverTimeout?: number;
  /**
  * health_check block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#health_check TwcLb#health_check}
  */
  readonly healthCheck?: TwcLbHealthCheck;
  /**
  * local_network block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#local_network TwcLb#local_network}
  */
...
export interface TwcLbHealthCheck {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#fall TwcLb#fall}
  */
  readonly fall?: number;
  /**
  * Interval in seconds for active backend health check
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#inter TwcLb#inter}
  */
  readonly inter?: number;
  /**
  * Path for active backend health check
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#path TwcLb#path}
  */
  readonly path?: string;
  /**
  * TCP port for active backend health check
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#port TwcLb#port}
  */
  readonly port?: number;
  /**
  * Protocol for active backend health check
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#proto TwcLb#proto}
  */
  readonly proto?: string;
  /**
  * Success requests count threshold for active backend health check
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#rise TwcLb#rise}
  */
  readonly rise?: number;
  /**
  * Timeout for active backend health check
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#timeout TwcLb#timeout}
  */
...
export interface TwcLbLocalNetwork {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#ip TwcLb#ip}
  */
  readonly ip?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb twc_lb}
*/
export class TwcLb extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TwcLb that should be imported. Refer to the {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.6/docs/resources/twc_lb twc_lb} Resource
  *
  * @param scope The scope in which to define this construct
