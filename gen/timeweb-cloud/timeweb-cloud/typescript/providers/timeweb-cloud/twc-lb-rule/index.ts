// https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/resources/twc_lb_rule
...
export interface TwcLbRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/resources/twc_lb_rule#balancer_port TwcLbRule#balancer_port}
  */
  readonly balancerPort: number;
  /**
  * Balancer incoming traffic protocol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/resources/twc_lb_rule#balancer_proto TwcLbRule#balancer_proto}
  */
  readonly balancerProto: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/resources/twc_lb_rule#id TwcLbRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/resources/twc_lb_rule#lb_id TwcLbRule#lb_id}
  */
  readonly lbId: number;
  /**
  * Server incoming traffic TCP port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/resources/twc_lb_rule#server_port TwcLbRule#server_port}
  */
  readonly serverPort: number;
  /**
  * Server incoming traffic protocol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/resources/twc_lb_rule#server_proto TwcLbRule#server_proto}
  */
  readonly serverProto: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/resources/twc_lb_rule twc_lb_rule}
*/
export class TwcLbRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TwcLbRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/resources/twc_lb_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/timeweb-cloud/timeweb-cloud/1.6.8/docs/resources/twc_lb_rule twc_lb_rule} Resource
  *
  * @param scope The scope in which to define this construct
