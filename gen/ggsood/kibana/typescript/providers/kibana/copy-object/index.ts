// https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/copy_object
...
export interface CopyObjectConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/copy_object#force_update CopyObject#force_update}
  */
  readonly forceUpdate?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/copy_object#id CopyObject#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/copy_object#include_reference CopyObject#include_reference}
  */
  readonly includeReference?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/copy_object#name CopyObject#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/copy_object#overwrite CopyObject#overwrite}
  */
  readonly overwrite?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/copy_object#source_space CopyObject#source_space}
  */
  readonly sourceSpace?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/copy_object#target_spaces CopyObject#target_spaces}
  */
  readonly targetSpaces: string[];
  /**
  * object block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/copy_object#object CopyObject#object}
  */
...
export interface CopyObjectObject {
  ...
  */
  readonly id: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/copy_object#type CopyObject#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/copy_object kibana_copy_object}
*/
export class CopyObject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CopyObject that should be imported. Refer to the {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/copy_object#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/copy_object kibana_copy_object} Resource
  *
  * @param scope The scope in which to define this construct
