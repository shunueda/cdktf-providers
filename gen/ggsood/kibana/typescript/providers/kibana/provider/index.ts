// https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs
...
export interface KibanaProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs#cacert_files KibanaProvider#cacert_files}
  */
  readonly cacertFiles?: string[];
  /**
  * Enable debug log level in provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs#debug KibanaProvider#debug}
  */
  readonly debug?: boolean | cdktf.IResolvable;
  /**
  * Disable SSL verification of API calls
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs#insecure KibanaProvider#insecure}
  */
  readonly insecure?: boolean | cdktf.IResolvable;
  /**
  * Password to use to connect to Kibana using basic auth
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs#password KibanaProvider#password}
  */
  readonly password?: string;
  /**
  * Nummber time it retry connexion before failed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs#retry KibanaProvider#retry}
  */
  readonly retry?: number;
  /**
  * Kibana URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs#url KibanaProvider#url}
  */
  readonly url: string;
  /**
  * Username to use to connect to Kibana using basic auth
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs#username KibanaProvider#username}
  */
  readonly username?: string;
  /**
  * Wait time in second before retry connexion
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs#wait_before_retry KibanaProvider#wait_before_retry}
  */
  readonly waitBeforeRetry?: number;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs#alias KibanaProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs kibana}
*/
export class KibanaProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing KibanaProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs kibana} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: KibanaProviderConfig) {
    super(scope, id, {
      ...
      terraformProviderSource: 'ggsood/kibana'
    });
