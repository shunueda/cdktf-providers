// https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/user_space
...
export interface UserSpaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/user_space#color UserSpace#color}
  */
  readonly color?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/user_space#description UserSpace#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/user_space#disabled_features UserSpace#disabled_features}
  */
  readonly disabledFeatures?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/user_space#id UserSpace#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/user_space#initials UserSpace#initials}
  */
  readonly initials?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/user_space#name UserSpace#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/user_space kibana_user_space}
*/
export class UserSpace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserSpace that should be imported. Refer to the {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/user_space#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ggsood/kibana/1.0.5/docs/resources/user_space kibana_user_space} Resource
  *
  * @param scope The scope in which to define this construct
