...
export interface OpensearchSecurityPluginConfigConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function opensearchSecurityPluginConfigTimeoutsToTerraform(struct?: OpensearchSecurityPluginConfigTimeouts | cdktf.IResolvable): any {
...
export function opensearchSecurityPluginConfigTimeoutsToHclTerraform(struct?: OpensearchSecurityPluginConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class OpensearchSecurityPluginConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OpensearchSecurityPluginConfigTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: OpensearchSecurityPluginConfigTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class OpensearchSecurityPluginConfig extends cdktf.TerraformResource {
  ...
  * @param options OpensearchSecurityPluginConfigConfig
  */
  public constructor(scope: Construct, id: string, config: OpensearchSecurityPluginConfigConfig) {
    super(scope, id, {
  ...
  private _timeouts = new OpensearchSecurityPluginConfigTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: OpensearchSecurityPluginConfigTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: opensearchSecurityPluginConfigTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: opensearchSecurityPluginConfigTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "OpensearchSecurityPluginConfigTimeouts",
      },
    };
