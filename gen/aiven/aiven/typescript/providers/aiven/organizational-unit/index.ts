...
export function organizationalUnitTimeoutsToTerraform(struct?: OrganizationalUnitTimeouts | cdktf.IResolvable): any {
...
export function organizationalUnitTimeoutsToHclTerraform(struct?: OrganizationalUnitTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class OrganizationalUnitTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OrganizationalUnitTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: OrganizationalUnitTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class OrganizationalUnit extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new OrganizationalUnitTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: OrganizationalUnitTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: organizationalUnitTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: organizationalUnitTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "OrganizationalUnitTimeouts",
      },
    };
