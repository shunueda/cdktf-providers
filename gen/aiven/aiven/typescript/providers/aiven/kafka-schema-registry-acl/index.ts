...
export function kafkaSchemaRegistryAclTimeoutsToTerraform(struct?: KafkaSchemaRegistryAclTimeouts | cdktf.IResolvable): any {
...
export function kafkaSchemaRegistryAclTimeoutsToHclTerraform(struct?: KafkaSchemaRegistryAclTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class KafkaSchemaRegistryAclTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): KafkaSchemaRegistryAclTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: KafkaSchemaRegistryAclTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class KafkaSchemaRegistryAcl extends cdktf.TerraformResource {
  ...
  * @param options KafkaSchemaRegistryAclConfig
  */
  public constructor(scope: Construct, id: string, config: KafkaSchemaRegistryAclConfig) {
    super(scope, id, {
  ...
  private _timeouts = new KafkaSchemaRegistryAclTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: KafkaSchemaRegistryAclTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: kafkaSchemaRegistryAclTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: kafkaSchemaRegistryAclTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "KafkaSchemaRegistryAclTimeouts",
      },
    };
