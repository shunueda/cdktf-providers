// https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/influxdb
...
export interface DataAivenInfluxdbConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/influxdb#id DataAivenInfluxdb#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/influxdb#project DataAivenInfluxdb#project}
  */
  readonly project: string;
  /**
  * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/influxdb#service_name DataAivenInfluxdb#service_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/influxdb aiven_influxdb}
*/
export class DataAivenInfluxdb extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAivenInfluxdb that should be imported. Refer to the {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/influxdb#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/influxdb aiven_influxdb} Data Source
  *
  * @param scope The scope in which to define this construct
