// https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/project
...
export interface DataAivenProjectConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/project#id DataAivenProject#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/project#project DataAivenProject#project}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/project aiven_project}
*/
export class DataAivenProject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAivenProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/project aiven_project} Data Source
  *
  * @param scope The scope in which to define this construct
