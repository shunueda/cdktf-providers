...
export function organizationUserGroupMemberTimeoutsToTerraform(struct?: OrganizationUserGroupMemberTimeouts | cdktf.IResolvable): any {
...
export function organizationUserGroupMemberTimeoutsToHclTerraform(struct?: OrganizationUserGroupMemberTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class OrganizationUserGroupMemberTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OrganizationUserGroupMemberTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: OrganizationUserGroupMemberTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class OrganizationUserGroupMember extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "aiven_organization_user_group_member";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aiven_organization_user_group_member", importId: importFromId, provider });
      }
  ...
  * @param options OrganizationUserGroupMemberConfig
  */
  public constructor(scope: Construct, id: string, config: OrganizationUserGroupMemberConfig) {
    super(scope, id, {
  ...
  private _timeouts = new OrganizationUserGroupMemberTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: OrganizationUserGroupMemberTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: organizationUserGroupMemberTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: organizationUserGroupMemberTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "OrganizationUserGroupMemberTimeouts",
      },
    };
