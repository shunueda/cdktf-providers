// https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/aws_privatelink
...
export interface DataAivenAwsPrivatelinkConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/aws_privatelink#id DataAivenAwsPrivatelink#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/aws_privatelink#project DataAivenAwsPrivatelink#project}
  */
  readonly project: string;
  /**
  * The name of the service that this resource belongs to. To set up proper dependencies please refer to this variable as a reference. Changing this property forces recreation of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/aws_privatelink#service_name DataAivenAwsPrivatelink#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/aws_privatelink aiven_aws_privatelink}
*/
export class DataAivenAwsPrivatelink extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAivenAwsPrivatelink that should be imported. Refer to the {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/aws_privatelink#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/aws_privatelink aiven_aws_privatelink} Data Source
  *
  * @param scope The scope in which to define this construct
