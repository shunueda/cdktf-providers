// https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/azure_privatelink
...
export interface DataAivenAzurePrivatelinkConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/azure_privatelink#id DataAivenAzurePrivatelink#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/azure_privatelink#project DataAivenAzurePrivatelink#project}
  */
  readonly project: string;
  /**
  * The name of the service that this resource belongs to. To set up proper dependencies please refer to this variable as a reference. Changing this property forces recreation of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/azure_privatelink#service_name DataAivenAzurePrivatelink#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/azure_privatelink aiven_azure_privatelink}
*/
export class DataAivenAzurePrivatelink extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAivenAzurePrivatelink that should be imported. Refer to the {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/azure_privatelink#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/azure_privatelink aiven_azure_privatelink} Data Source
  *
  * @param scope The scope in which to define this construct
