// https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/kafka_mirrormaker
...
export interface DataAivenKafkaMirrormakerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/kafka_mirrormaker#id DataAivenKafkaMirrormaker#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/kafka_mirrormaker#project DataAivenKafkaMirrormaker#project}
  */
  readonly project: string;
  /**
  * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/kafka_mirrormaker#service_name DataAivenKafkaMirrormaker#service_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/kafka_mirrormaker aiven_kafka_mirrormaker}
*/
export class DataAivenKafkaMirrormaker extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAivenKafkaMirrormaker that should be imported. Refer to the {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/kafka_mirrormaker#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/kafka_mirrormaker aiven_kafka_mirrormaker} Data Source
  *
  * @param scope The scope in which to define this construct
