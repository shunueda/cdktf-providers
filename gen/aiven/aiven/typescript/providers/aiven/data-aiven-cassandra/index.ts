// https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/cassandra
...
export interface DataAivenCassandraConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/cassandra#id DataAivenCassandra#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/cassandra#project DataAivenCassandra#project}
  */
  readonly project: string;
  /**
  * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/cassandra#service_name DataAivenCassandra#service_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/cassandra aiven_cassandra}
*/
export class DataAivenCassandra extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAivenCassandra that should be imported. Refer to the {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/cassandra#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/cassandra aiven_cassandra} Data Source
  *
  * @param scope The scope in which to define this construct
