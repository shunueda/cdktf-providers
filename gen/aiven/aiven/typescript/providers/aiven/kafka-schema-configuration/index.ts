...
export interface KafkaSchemaConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function kafkaSchemaConfigurationTimeoutsToTerraform(struct?: KafkaSchemaConfigurationTimeouts | cdktf.IResolvable): any {
...
export function kafkaSchemaConfigurationTimeoutsToHclTerraform(struct?: KafkaSchemaConfigurationTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class KafkaSchemaConfigurationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): KafkaSchemaConfigurationTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: KafkaSchemaConfigurationTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class KafkaSchemaConfiguration extends cdktf.TerraformResource {
  ...
  * @param options KafkaSchemaConfigurationConfig
  */
  public constructor(scope: Construct, id: string, config: KafkaSchemaConfigurationConfig) {
    super(scope, id, {
  ...
  private _timeouts = new KafkaSchemaConfigurationTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: KafkaSchemaConfigurationTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: kafkaSchemaConfigurationTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: kafkaSchemaConfigurationTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "KafkaSchemaConfigurationTimeouts",
      },
    };
