// https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/mysql
...
export interface DataAivenMysqlConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/mysql#id DataAivenMysql#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/mysql#project DataAivenMysql#project}
  */
  readonly project: string;
  /**
  * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/mysql#service_name DataAivenMysql#service_name}
  */
...
export class DataAivenMysqlMysqlUserConfigMigrationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // dump_tool - computed: true, optional: false, required: false
  public get dumpTool() {
...
/**
* Represents a {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/mysql aiven_mysql}
*/
export class DataAivenMysql extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAivenMysql that should be imported. Refer to the {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/mysql#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/mysql aiven_mysql} Data Source
  *
  * @param scope The scope in which to define this construct
