...
export interface GcpVpcPeeringConnectionConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function gcpVpcPeeringConnectionTimeoutsToTerraform(struct?: GcpVpcPeeringConnectionTimeouts | cdktf.IResolvable): any {
...
export function gcpVpcPeeringConnectionTimeoutsToHclTerraform(struct?: GcpVpcPeeringConnectionTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GcpVpcPeeringConnectionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GcpVpcPeeringConnectionTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GcpVpcPeeringConnectionTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class GcpVpcPeeringConnection extends cdktf.TerraformResource {
  ...
  * @param options GcpVpcPeeringConnectionConfig
  */
  public constructor(scope: Construct, id: string, config: GcpVpcPeeringConnectionConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GcpVpcPeeringConnectionTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GcpVpcPeeringConnectionTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: gcpVpcPeeringConnectionTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: gcpVpcPeeringConnectionTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GcpVpcPeeringConnectionTimeouts",
      },
    };
