...
export class DataAivenMysqlUser extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "aiven_mysql_user";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aiven_mysql_user", importId: importFromId, provider });
      }
  ...
  * @param options DataAivenMysqlUserConfig
  */
  public constructor(scope: Construct, id: string, config: DataAivenMysqlUserConfig) {
    super(scope, id, {
