// https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/kafka_schema_configuration
...
export interface DataAivenKafkaSchemaConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/kafka_schema_configuration#id DataAivenKafkaSchemaConfiguration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/kafka_schema_configuration#project DataAivenKafkaSchemaConfiguration#project}
  */
  readonly project: string;
  /**
  * The name of the service that this resource belongs to. To set up proper dependencies please refer to this variable as a reference. Changing this property forces recreation of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/kafka_schema_configuration#service_name DataAivenKafkaSchemaConfiguration#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/kafka_schema_configuration aiven_kafka_schema_configuration}
*/
export class DataAivenKafkaSchemaConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAivenKafkaSchemaConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/kafka_schema_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aiven/aiven/4.46.1/docs/data-sources/kafka_schema_configuration aiven_kafka_schema_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
