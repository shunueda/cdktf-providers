// https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/redis
...
export interface DataAivenRedisConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/redis#id DataAivenRedis#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/redis#project DataAivenRedis#project}
  */
  readonly project: string;
  /**
  * Specifies the actual name of the service. The name cannot be changed later without destroying and re-creating the service so name should be picked based on intended service usage rather than current attributes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/redis#service_name DataAivenRedis#service_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/redis aiven_redis}
*/
export class DataAivenRedis extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAivenRedis that should be imported. Refer to the {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/redis#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aiven/aiven/4.48.0/docs/data-sources/redis aiven_redis} Data Source
  *
  * @param scope The scope in which to define this construct
