...
export function gcpPrivatelinkConnectionApprovalTimeoutsToTerraform(struct?: GcpPrivatelinkConnectionApprovalTimeouts | cdktf.IResolvable): any {
...
export function gcpPrivatelinkConnectionApprovalTimeoutsToHclTerraform(struct?: GcpPrivatelinkConnectionApprovalTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GcpPrivatelinkConnectionApprovalTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GcpPrivatelinkConnectionApprovalTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GcpPrivatelinkConnectionApprovalTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class GcpPrivatelinkConnectionApproval extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "aiven_gcp_privatelink_connection_approval";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aiven_gcp_privatelink_connection_approval", importId: importFromId, provider });
      }
  ...
  * @param options GcpPrivatelinkConnectionApprovalConfig
  */
  public constructor(scope: Construct, id: string, config: GcpPrivatelinkConnectionApprovalConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GcpPrivatelinkConnectionApprovalTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GcpPrivatelinkConnectionApprovalTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: gcpPrivatelinkConnectionApprovalTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: gcpPrivatelinkConnectionApprovalTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GcpPrivatelinkConnectionApprovalTimeouts",
      },
    };
