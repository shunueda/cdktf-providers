...
export interface AccountTeamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function accountTeamMemberTimeoutsToTerraform(struct?: AccountTeamMemberTimeouts | cdktf.IResolvable): any {
...
export function accountTeamMemberTimeoutsToHclTerraform(struct?: AccountTeamMemberTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AccountTeamMemberTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AccountTeamMemberTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AccountTeamMemberTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class AccountTeamMember extends cdktf.TerraformResource {
  ...
  * @param options AccountTeamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: AccountTeamMemberConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AccountTeamMemberTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AccountTeamMemberTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: accountTeamMemberTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: accountTeamMemberTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "AccountTeamMemberTimeouts",
      },
    };
