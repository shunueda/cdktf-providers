// https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/grant_application_role
...
export interface GrantApplicationRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/grant_application_role#application_name GrantApplicationRole#application_name}
  */
  readonly applicationName?: string;
  /**
  * Specifies the identifier for the application role to grant.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/grant_application_role#application_role_name GrantApplicationRole#application_role_name}
  */
  readonly applicationRoleName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/grant_application_role#id GrantApplicationRole#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/grant_application_role#parent_account_role_name GrantApplicationRole#parent_account_role_name}
  */
  readonly parentAccountRoleName?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/grant_application_role#timeouts GrantApplicationRole#timeouts}
  */
  readonly timeouts?: GrantApplicationRoleTimeouts;
}
export interface GrantApplicationRoleTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/grant_application_role#create GrantApplicationRole#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/grant_application_role#delete GrantApplicationRole#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/grant_application_role#read GrantApplicationRole#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/grant_application_role#update GrantApplicationRole#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/grant_application_role snowflake_grant_application_role}
*/
export class GrantApplicationRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GrantApplicationRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/grant_application_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/grant_application_role snowflake_grant_application_role} Resource
  *
  * @param scope The scope in which to define this construct
