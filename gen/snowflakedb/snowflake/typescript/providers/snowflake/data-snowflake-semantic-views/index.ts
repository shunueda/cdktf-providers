...
export class DataSnowflakeSemanticViewsSemanticViewsShowOutputOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSnowflakeSemanticViewsSemanticViewsShowOutput | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSnowflakeSemanticViewsSemanticViewsShowOutput | undefined) {
    if (value === undefined) {
...
export class DataSnowflakeSemanticViewsSemanticViewsShowOutputList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSnowflakeSemanticViewsSemanticViewsShowOutputOutputReference {
    return new DataSnowflakeSemanticViewsSemanticViewsShowOutputOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSnowflakeSemanticViewsSemanticViewsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSnowflakeSemanticViewsSemanticViews | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSnowflakeSemanticViewsSemanticViews | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _showOutput = new DataSnowflakeSemanticViewsSemanticViewsShowOutputList(this, "show_output", false);
  public get showOutput() {
    return this._showOutput;
  }
}

export class DataSnowflakeSemanticViewsSemanticViewsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSnowflakeSemanticViewsSemanticViewsOutputReference {
    return new DataSnowflakeSemanticViewsSemanticViewsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSnowflakeSemanticViewsInOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSnowflakeSemanticViewsIn | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataSnowflakeSemanticViewsIn | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataSnowflakeSemanticViewsLimitOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSnowflakeSemanticViewsLimit | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataSnowflakeSemanticViewsLimit | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataSnowflakeSemanticViews extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "snowflake_semantic_views";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "snowflake_semantic_views", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: DataSnowflakeSemanticViewsConfig = {}) {
    super(scope, id, {
  ...
  // semantic_views - computed: true, optional: false, required: false
  private _semanticViews = new DataSnowflakeSemanticViewsSemanticViewsList(this, "semantic_views", false);
  public get semanticViews() {
    return this._semanticViews;
  }
  ...
  private _in = new DataSnowflakeSemanticViewsInOutputReference(this, "in");
  public get in() {
    return this._in;
  }
  public putIn(value: DataSnowflakeSemanticViewsIn) {
  ...
  private _limit = new DataSnowflakeSemanticViewsLimitOutputReference(this, "limit");
  public get limit() {
    return this._limit;
  }
  public putLimit(value: DataSnowflakeSemanticViewsLimit) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      in: dataSnowflakeSemanticViewsInToTerraform(this._in.internalValue),
      limit: dataSnowflakeSemanticViewsLimitToTerraform(this._limit.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      in: {
        value: dataSnowflakeSemanticViewsInToHclTerraform(this._in.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataSnowflakeSemanticViewsInList",
      },
      limit: {
        value: dataSnowflakeSemanticViewsLimitToHclTerraform(this._limit.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataSnowflakeSemanticViewsLimitList",
      },
    };
