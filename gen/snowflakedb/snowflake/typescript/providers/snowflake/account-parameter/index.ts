// https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/account_parameter
...
export interface AccountParameterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/account_parameter#id AccountParameter#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/account_parameter#key AccountParameter#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/account_parameter#value AccountParameter#value}
  */
  readonly value: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/account_parameter#timeouts AccountParameter#timeouts}
  */
  readonly timeouts?: AccountParameterTimeouts;
}
export interface AccountParameterTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/account_parameter#create AccountParameter#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/account_parameter#delete AccountParameter#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/account_parameter#read AccountParameter#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/account_parameter#update AccountParameter#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/account_parameter snowflake_account_parameter}
*/
export class AccountParameter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountParameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/account_parameter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/account_parameter snowflake_account_parameter} Resource
  *
  * @param scope The scope in which to define this construct
