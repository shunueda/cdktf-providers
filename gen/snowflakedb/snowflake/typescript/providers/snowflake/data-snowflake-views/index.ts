// https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views
...
export interface DataSnowflakeViewsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views#id DataSnowflakeViews#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views#like DataSnowflakeViews#like}
  */
  readonly like?: string;
  /**
  * Filters the output with **case-sensitive** characters indicating the beginning of the object name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views#starts_with DataSnowflakeViews#starts_with}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views#with_describe DataSnowflakeViews#with_describe}
  */
  readonly withDescribe?: boolean | cdktf.IResolvable;
  /**
  * in block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views#in DataSnowflakeViews#in}
  */
  readonly in?: DataSnowflakeViewsIn;
  /**
  * limit block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views#limit DataSnowflakeViews#limit}
  */
...
export class DataSnowflakeViewsViewsDescribeOutputOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSnowflakeViewsViewsDescribeOutput | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSnowflakeViewsViewsDescribeOutput | undefined) {
    if (value === undefined) {
...
export class DataSnowflakeViewsViewsDescribeOutputList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSnowflakeViewsViewsDescribeOutputOutputReference {
    return new DataSnowflakeViewsViewsDescribeOutputOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSnowflakeViewsViewsShowOutputOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSnowflakeViewsViewsShowOutput | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSnowflakeViewsViewsShowOutput | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataSnowflakeViewsViewsShowOutputList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSnowflakeViewsViewsShowOutputOutputReference {
    return new DataSnowflakeViewsViewsShowOutputOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSnowflakeViewsViewsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _describeOutput = new DataSnowflakeViewsViewsDescribeOutputList(this, "describe_output", false);
  public get describeOutput() {
    return this._describeOutput;
  }

  // show_output - computed: true, optional: false, required: false
  private _showOutput = new DataSnowflakeViewsViewsShowOutputList(this, "show_output", false);
...
export interface DataSnowflakeViewsIn {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views#account DataSnowflakeViews#account}
  */
  readonly account?: boolean | cdktf.IResolvable;
  /**
  * Returns records for the current database in use or for a specified database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views#database DataSnowflakeViews#database}
  */
  readonly database?: string;
  /**
  * Returns records for the current schema in use or a specified schema. Use fully qualified name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views#schema DataSnowflakeViews#schema}
  */
...
export class DataSnowflakeViewsInOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSnowflakeViewsIn | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataSnowflakeViewsIn | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface DataSnowflakeViewsLimit {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views#from DataSnowflakeViews#from}
  */
  readonly from?: string;
  /**
  * The maximum number of rows to return.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views#rows DataSnowflakeViews#rows}
  */
...
export class DataSnowflakeViewsLimitOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSnowflakeViewsLimit | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataSnowflakeViewsLimit | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views snowflake_views}
*/
export class DataSnowflakeViews extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSnowflakeViews that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/views snowflake_views} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _in = new DataSnowflakeViewsInOutputReference(this, "in");
  public get in() {
    return this._in;
  }
  public putIn(value: DataSnowflakeViewsIn) {
  ...
  private _limit = new DataSnowflakeViewsLimitOutputReference(this, "limit");
  public get limit() {
    return this._limit;
  }
  public putLimit(value: DataSnowflakeViewsLimit) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      in: {
        value: dataSnowflakeViewsInToHclTerraform(this._in.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataSnowflakeViewsInList",
      },
      limit: {
        value: dataSnowflakeViewsLimitToHclTerraform(this._limit.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataSnowflakeViewsLimitList",
      },
    };
