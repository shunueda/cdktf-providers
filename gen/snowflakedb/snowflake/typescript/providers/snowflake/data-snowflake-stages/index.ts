// https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/stages
...
export interface DataSnowflakeStagesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/stages#database DataSnowflakeStages#database}
  */
  readonly database: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/stages#id DataSnowflakeStages#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/stages#schema DataSnowflakeStages#schema}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/stages snowflake_stages}
*/
export class DataSnowflakeStages extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSnowflakeStages that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/stages#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "snowflake_stages", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/data-sources/stages snowflake_stages} Data Source
  *
  * @param scope The scope in which to define this construct
