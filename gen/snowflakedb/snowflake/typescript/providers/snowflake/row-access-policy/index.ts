// https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy
...
export interface RowAccessPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy#body RowAccessPolicy#body}
  */
  readonly body: string;
  /**
  * Specifies a comment for the row access policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy#comment RowAccessPolicy#comment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy#database RowAccessPolicy#database}
  */
  readonly database: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy#id RowAccessPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy#name RowAccessPolicy#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy#schema RowAccessPolicy#schema}
  */
  readonly schema: string;
  /**
  * argument block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy#argument RowAccessPolicy#argument}
  */
  readonly argument: RowAccessPolicyArgument[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy#timeouts RowAccessPolicy#timeouts}
  */
...
export class RowAccessPolicyDescribeOutputSignatureOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RowAccessPolicyDescribeOutputSignature | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: RowAccessPolicyDescribeOutputSignature | undefined) {
    if (value === undefined) {
...
export class RowAccessPolicyDescribeOutputSignatureList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): RowAccessPolicyDescribeOutputSignatureOutputReference {
    return new RowAccessPolicyDescribeOutputSignatureOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class RowAccessPolicyDescribeOutputOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RowAccessPolicyDescribeOutput | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: RowAccessPolicyDescribeOutput | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _signature = new RowAccessPolicyDescribeOutputSignatureList(this, "signature", false);
...
export class RowAccessPolicyDescribeOutputList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): RowAccessPolicyDescribeOutputOutputReference {
    return new RowAccessPolicyDescribeOutputOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class RowAccessPolicyShowOutputOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RowAccessPolicyShowOutput | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: RowAccessPolicyShowOutput | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class RowAccessPolicyShowOutputList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): RowAccessPolicyShowOutputOutputReference {
    return new RowAccessPolicyShowOutputOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface RowAccessPolicyArgument {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy#type RowAccessPolicy#type}
  */
...
export class RowAccessPolicyArgumentList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): RowAccessPolicyArgumentOutputReference {
    return new RowAccessPolicyArgumentOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface RowAccessPolicyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy#create RowAccessPolicy#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy#delete RowAccessPolicy#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy#read RowAccessPolicy#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy#update RowAccessPolicy#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy snowflake_row_access_policy}
*/
export class RowAccessPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RowAccessPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.12.0/docs/resources/row_access_policy snowflake_row_access_policy} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _describeOutput = new RowAccessPolicyDescribeOutputList(this, "describe_output", false);
  ...
  private _showOutput = new RowAccessPolicyShowOutputList(this, "show_output", false);
  public get showOutput() {
    return this._showOutput;
  }

  // argument - computed: false, optional: false, required: true
  private _argument = new RowAccessPolicyArgumentList(this, "argument", false);
  public get argument() {
  ...
  private _timeouts = new RowAccessPolicyTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: RowAccessPolicyTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: rowAccessPolicyTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "RowAccessPolicyTimeouts",
      },
    };
