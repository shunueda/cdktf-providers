// https://registry.terraform.io/providers/ns1-terraform/ns1/2.7.2/docs/resources/redirect_certificate
...
export interface RedirectCertificateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ns1-terraform/ns1/2.7.2/docs/resources/redirect_certificate#domain RedirectCertificate#domain}
  */
  readonly domain: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ns1-terraform/ns1/2.7.2/docs/resources/redirect_certificate ns1_redirect_certificate}
*/
export class RedirectCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedirectCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/ns1-terraform/ns1/2.7.2/docs/resources/redirect_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ns1-terraform/ns1/2.7.2/docs/resources/redirect_certificate ns1_redirect_certificate} Resource
  *
  * @param scope The scope in which to define this construct
