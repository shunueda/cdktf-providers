// https://registry.terraform.io/providers/ns1-terraform/ns1/2.7.3/docs/resources/notifylist
...
export interface NotifylistConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ns1-terraform/ns1/2.7.3/docs/resources/notifylist#id Notifylist#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ns1-terraform/ns1/2.7.3/docs/resources/notifylist#name Notifylist#name}
  */
  readonly name: string;
  /**
  * notifications block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ns1-terraform/ns1/2.7.3/docs/resources/notifylist#notifications Notifylist#notifications}
  */
  readonly notifications?: NotifylistNotifications[] | cdktf.IResolvable;
}
export interface NotifylistNotifications {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ns1-terraform/ns1/2.7.3/docs/resources/notifylist#config Notifylist#config}
  */
  readonly config: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ns1-terraform/ns1/2.7.3/docs/resources/notifylist#type Notifylist#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ns1-terraform/ns1/2.7.3/docs/resources/notifylist ns1_notifylist}
*/
export class Notifylist extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Notifylist that should be imported. Refer to the {@link https://registry.terraform.io/providers/ns1-terraform/ns1/2.7.3/docs/resources/notifylist#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ns1-terraform/ns1/2.7.3/docs/resources/notifylist ns1_notifylist} Resource
  *
  * @param scope The scope in which to define this construct
