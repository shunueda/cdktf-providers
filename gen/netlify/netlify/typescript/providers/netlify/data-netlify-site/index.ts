// https://registry.terraform.io/providers/netlify/netlify/0.3.2/docs/data-sources/site
...
export interface DataNetlifySiteConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.3.2/docs/data-sources/site#id DataNetlifySite#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.3.2/docs/data-sources/site#name DataNetlifySite#name}
  */
  readonly name?: string;
  /**
  * Required if name is specified and a default team was not configured in the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netlify/netlify/0.3.2/docs/data-sources/site#team_slug DataNetlifySite#team_slug}
  */
  readonly teamSlug?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netlify/netlify/0.3.2/docs/data-sources/site netlify_site}
*/
export class DataNetlifySite extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetlifySite that should be imported. Refer to the {@link https://registry.terraform.io/providers/netlify/netlify/0.3.2/docs/data-sources/site#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netlify/netlify/0.3.2/docs/data-sources/site netlify_site} Data Source
  *
  * @param scope The scope in which to define this construct
