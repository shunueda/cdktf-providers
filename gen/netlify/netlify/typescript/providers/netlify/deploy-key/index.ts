// https://registry.terraform.io/providers/netlify/netlify/0.4.0/docs/resources/deploy_key
...
/**
* Represents a {@link https://registry.terraform.io/providers/netlify/netlify/0.4.0/docs/resources/deploy_key netlify_deploy_key}
*/
export class DeployKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeployKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/netlify/netlify/0.4.0/docs/resources/deploy_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netlify/netlify/0.4.0/docs/resources/deploy_key netlify_deploy_key} Resource
  *
  * @param scope The scope in which to define this construct
