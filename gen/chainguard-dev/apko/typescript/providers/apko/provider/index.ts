// https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs
...
export interface ApkoProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs#build_repositories ApkoProvider#build_repositories}
  */
  readonly buildRepositories?: string[];
  /**
  * Default annotations to add
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs#default_annotations ApkoProvider#default_annotations}
  */
  readonly defaultAnnotations?: { [key: string]: string };
  /**
  * Default architectures to build for
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs#default_archs ApkoProvider#default_archs}
  */
  readonly defaultArchs?: string[];
  /**
  * Default image layering configuration when not specified in the config
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs#default_layering ApkoProvider#default_layering}
  */
  readonly defaultLayering?: ApkoProviderDefaultLayering;
  /**
  * Additional keys to use for package verification
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs#extra_keyring ApkoProvider#extra_keyring}
  */
  readonly extraKeyring?: string[];
  /**
  * Additional packages to install
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs#extra_packages ApkoProvider#extra_packages}
  */
  readonly extraPackages?: string[];
  /**
  * Additional repositories to search for packages
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs#extra_repositories ApkoProvider#extra_repositories}
  */
  readonly extraRepositories?: string[];
  /**
  * Whether to plan offline
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs#plan_offline ApkoProvider#plan_offline}
  */
  readonly planOffline?: boolean | cdktf.IResolvable;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs#alias ApkoProvider#alias}
  */
...
export interface ApkoProviderDefaultLayering {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs#budget ApkoProvider#budget}
  */
  readonly budget: number;
  /**
  * Layering strategy, currently only 'origin' is supported
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs#strategy ApkoProvider#strategy}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs apko}
*/
export class ApkoProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ApkoProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs apko} Resource
  *
  * @param scope The scope in which to define this construct
