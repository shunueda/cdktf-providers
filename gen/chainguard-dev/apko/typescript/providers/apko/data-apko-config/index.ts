// https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs/data-sources/config
...
export interface DataApkoConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs/data-sources/config#config_contents DataApkoConfig#config_contents}
  */
  readonly configContents?: string;
  /**
  * A map from the APK architecture to the config for that architecture.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs/data-sources/config#configs DataApkoConfig#configs}
  */
  readonly configs?: { [key: string]: DataApkoConfigConfigs } | cdktf.IResolvable;
  /**
  * Default annotations to add.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs/data-sources/config#default_annotations DataApkoConfig#default_annotations}
  */
  readonly defaultAnnotations?: { [key: string]: string };
  /**
  * A list of extra packages to install.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs/data-sources/config#extra_packages DataApkoConfig#extra_packages}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs/data-sources/config apko_config}
*/
export class DataApkoConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataApkoConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs/data-sources/config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/apko/0.30.30/docs/data-sources/config apko_config} Data Source
  *
  * @param scope The scope in which to define this construct
