// https://registry.terraform.io/providers/chainguard-dev/helm/0.0.10/docs/resources/chart
...
export interface ChartConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.10/docs/resources/chart#json_patches Chart#json_patches}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.10/docs/resources/chart#package_arch Chart#package_arch}
  */
  readonly packageArch?: string;
  /**
  * The name of the package to fetch from the package repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.10/docs/resources/chart#package_name Chart#package_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.10/docs/resources/chart#package_version Chart#package_version}
  */
  readonly packageVersion?: string;
  /**
  * The repo in the OCI registry where the Helm chart will be pushed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.10/docs/resources/chart#repo Chart#repo}
  */
  readonly repo: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.10/docs/resources/chart helm_chart}
*/
export class Chart extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Chart that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.10/docs/resources/chart#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/helm/0.0.10/docs/resources/chart helm_chart} Resource
  *
  * @param scope The scope in which to define this construct
