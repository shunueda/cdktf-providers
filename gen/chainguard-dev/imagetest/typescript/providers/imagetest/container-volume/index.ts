// https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.102/docs/resources/container_volume
...
export interface ContainerVolumeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.102/docs/resources/container_volume#inventory ContainerVolume#inventory}
  */
  readonly inventory: ContainerVolumeInventory;
  /**
  * A name for this volume resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.102/docs/resources/container_volume#name ContainerVolume#name}
  */
  readonly name: string;
}
export interface ContainerVolumeInventory {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.102/docs/resources/container_volume#seed ContainerVolume#seed}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.102/docs/resources/container_volume imagetest_container_volume}
*/
export class ContainerVolume extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.102/docs/resources/container_volume#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.102/docs/resources/container_volume imagetest_container_volume} Resource
  *
  * @param scope The scope in which to define this construct
