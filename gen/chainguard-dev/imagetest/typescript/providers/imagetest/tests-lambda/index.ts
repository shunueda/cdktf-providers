// https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.107/docs/resources/tests_lambda
...
export interface TestsLambdaConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.107/docs/resources/tests_lambda#execution_role TestsLambda#execution_role}
  */
  readonly executionRole: string;
  /**
  * The image ref to deploy and test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.107/docs/resources/tests_lambda#image_ref TestsLambda#image_ref}
  */
  readonly imageRef: string;
  /**
  * The AWS region to deploy the test in. If not provided, the default region will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.107/docs/resources/tests_lambda#region TestsLambda#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.107/docs/resources/tests_lambda imagetest_tests_lambda}
*/
export class TestsLambda extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TestsLambda that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.107/docs/resources/tests_lambda#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.107/docs/resources/tests_lambda imagetest_tests_lambda} Resource
  *
  * @param scope The scope in which to define this construct
