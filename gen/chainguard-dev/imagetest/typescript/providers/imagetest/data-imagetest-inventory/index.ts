// https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/data-sources/inventory
...
/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/data-sources/inventory imagetest_inventory}
*/
export class DataImagetestInventory extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataImagetestInventory that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/data-sources/inventory#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/data-sources/inventory imagetest_inventory} Data Source
  *
  * @param scope The scope in which to define this construct
