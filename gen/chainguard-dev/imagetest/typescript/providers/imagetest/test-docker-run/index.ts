// https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run
...
export interface TestDockerRunConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run#cmd TestDockerRun#cmd}
  */
  readonly cmd?: string[];
  /**
  * A descriptor of the feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run#description TestDockerRun#description}
  */
  readonly description?: string;
  /**
  * The command or set of commands that should be run at this step
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run#entrypoint TestDockerRun#entrypoint}
  */
  readonly entrypoint?: string[];
  /**
  * The full image reference to use for the container.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run#image TestDockerRun#image}
  */
  readonly image: string;
  /**
  * A set of labels used to optionally filter execution of the feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run#labels TestDockerRun#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The list of mounts to create on the container.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run#mounts TestDockerRun#mounts}
  */
  readonly mounts?: TestDockerRunMounts[] | cdktf.IResolvable;
  /**
  * The name of the feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run#name TestDockerRun#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run#timeouts TestDockerRun#timeouts}
  */
  readonly timeouts?: TestDockerRunTimeouts;
  /**
  * The user to run the command as.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run#user TestDockerRun#user}
  */
...
export interface TestDockerRunMounts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run#destination TestDockerRun#destination}
  */
  readonly destination: string;
  /**
  * Whether the mount should be read only.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run#read_only TestDockerRun#read_only}
  */
  readonly readOnly?: boolean | cdktf.IResolvable;
  /**
  * The relative or absolute path on the host to the source directory to mount.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run#source TestDockerRun#source}
  */
...
export interface TestDockerRunTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run#create TestDockerRun#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run imagetest_test_docker_run}
*/
export class TestDockerRun extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TestDockerRun that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/imagetest/0.0.109/docs/resources/test_docker_run imagetest_test_docker_run} Resource
  *
  * @param scope The scope in which to define this construct
