// https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs/data-sources/image_repo
...
export interface DataChainguardImageRepoConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs/data-sources/image_repo#id DataChainguardImageRepo#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs/data-sources/image_repo#name DataChainguardImageRepo#name}
  */
  readonly name?: string;
  /**
  * The UIDP of the group in which to lookup the repo.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs/data-sources/image_repo#parent_id DataChainguardImageRepo#parent_id}
  */
...
export interface DataChainguardImageRepoItems {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs/data-sources/image_repo#active_tags DataChainguardImageRepo#active_tags}
  */
  readonly activeTags?: string[];
  /**
  * Known aliases for a given image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs/data-sources/image_repo#aliases DataChainguardImageRepo#aliases}
  */
  readonly aliases?: string[];
  /**
  * List of bundles associated with this repo (a-z freeform keywords for sales purposes).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs/data-sources/image_repo#bundles DataChainguardImageRepo#bundles}
  */
  readonly bundles?: string[];
  /**
  * The README for this repo.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs/data-sources/image_repo#readme DataChainguardImageRepo#readme}
  */
  readonly readme?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs/data-sources/image_repo#sync_config DataChainguardImageRepo#sync_config}
  */
  readonly syncConfig?: DataChainguardImageRepoItemsSyncConfig;
  /**
  * Image tier associated with this repo.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs/data-sources/image_repo#tier DataChainguardImageRepo#tier}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs/data-sources/image_repo chainguard_image_repo}
*/
export class DataChainguardImageRepo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataChainguardImageRepo that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs/data-sources/image_repo#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs/data-sources/image_repo chainguard_image_repo} Data Source
  *
  * @param scope The scope in which to define this construct
