// https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo
...
export interface ImageRepoConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#active_tags ImageRepo#active_tags}
  */
  readonly activeTags?: string[];
  /**
  * Known aliases for a given image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#aliases ImageRepo#aliases}
  */
  readonly aliases?: string[];
  /**
  * List of bundles associated with this repo (valid ones: `application|base|byol|ai|ai-gpu|featured|fips`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#bundles ImageRepo#bundles}
  */
  readonly bundles?: string[];
  /**
  * The name of this repo.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#name ImageRepo#name}
  */
  readonly name: string;
  /**
  * The group that owns the repo.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#parent_id ImageRepo#parent_id}
  */
  readonly parentId: string;
  /**
  * The README for this repo.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#readme ImageRepo#readme}
  */
  readonly readme?: string;
  /**
  * Image tier associated with this repo.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#tier ImageRepo#tier}
  */
  readonly tier?: string;
  /**
  * sync_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#sync_config ImageRepo#sync_config}
  */
...
export interface ImageRepoSyncConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#amazon ImageRepo#amazon}
  */
  readonly amazon?: string;
  /**
  * A json-encoded APKO configuration to overlay on rebuilds of images being synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#apko_overlay ImageRepo#apko_overlay}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#azure ImageRepo#azure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#expiration ImageRepo#expiration}
  */
  readonly expiration?: string;
  /**
  * The Google repository under which to create a new repository with the same name as the source repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#google ImageRepo#google}
  */
  readonly google?: string;
  /**
  * Controls whether the image grace period functionality is enabled or not. Defaults to false if not provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#grace_period ImageRepo#grace_period}
  */
  readonly gracePeriod?: boolean | cdktf.IResolvable;
  /**
  * The source repository to sync images from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#source ImageRepo#source}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo chainguard_image_repo}
*/
export class ImageRepo extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImageRepo that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/image_repo chainguard_image_repo} Resource
  *
  * @param scope The scope in which to define this construct
