// https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/group
...
export interface GroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/group#description Group#description}
  */
  readonly description?: string;
  /**
  * Name of this IAM group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/group#name Group#name}
  */
  readonly name: string;
  /**
  * Parent IAM group of this group. If not set, this group is assumed to be a root group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/group#parent_id Group#parent_id}
  */
  readonly parentId?: string;
  /**
  * Whether the organization has been verified by a Chainguardian. Only applicable to root groups.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/group#verified Group#verified}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/group#verified_protection Group#verified_protection}
  */
  readonly verifiedProtection?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/group chainguard_group}
*/
export class Group extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Group that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.41/docs/resources/group chainguard_group} Resource
  *
  * @param scope The scope in which to define this construct
