// https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.38/docs/data-sources/identity
...
export interface DataChainguardIdentityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.38/docs/data-sources/identity#issuer DataChainguardIdentity#issuer}
  */
  readonly issuer: string;
  /**
  * The exact subject of the identity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.38/docs/data-sources/identity#subject DataChainguardIdentity#subject}
  */
  readonly subject: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.38/docs/data-sources/identity chainguard_identity}
*/
export class DataChainguardIdentity extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataChainguardIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.38/docs/data-sources/identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.38/docs/data-sources/identity chainguard_identity} Data Source
  *
  * @param scope The scope in which to define this construct
