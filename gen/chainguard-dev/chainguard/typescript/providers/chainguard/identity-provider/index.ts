// https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/identity_provider
...
export interface IdentityProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/identity_provider#default_role IdentityProvider#default_role}
  */
  readonly defaultRole: string;
  /**
  * A longer description of the purpose of this identity provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/identity_provider#description IdentityProvider#description}
  */
  readonly description?: string;
  /**
  * The name of this identity provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/identity_provider#name IdentityProvider#name}
  */
  readonly name: string;
  /**
  * The group containing this identity provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/identity_provider#parent_id IdentityProvider#parent_id}
  */
  readonly parentId: string;
  /**
  * oidc block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/identity_provider#oidc IdentityProvider#oidc}
  */
...
export interface IdentityProviderOidc {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/identity_provider#additional_scopes IdentityProvider#additional_scopes}
  */
  readonly additionalScopes?: string[];
  /**
  * Client ID for OIDC identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/identity_provider#client_id IdentityProvider#client_id}
  */
  readonly clientId?: string;
  /**
  * Client secret for OIDC identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/identity_provider#client_secret IdentityProvider#client_secret}
  */
  readonly clientSecret?: string;
  /**
  * Issuer URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/identity_provider#issuer IdentityProvider#issuer}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/identity_provider chainguard_identity_provider}
*/
export class IdentityProvider extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/identity_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/identity_provider chainguard_identity_provider} Resource
  *
  * @param scope The scope in which to define this construct
