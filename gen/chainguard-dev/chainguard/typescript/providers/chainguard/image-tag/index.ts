// https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.37/docs/resources/image_tag
...
export interface ImageTagConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.37/docs/resources/image_tag#bundles ImageTag#bundles}
  */
  readonly bundles?: string[];
  /**
  * The name of this tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.37/docs/resources/image_tag#name ImageTag#name}
  */
  readonly name: string;
  /**
  * The repo that owns the repo.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.37/docs/resources/image_tag#repo_id ImageTag#repo_id}
  */
  readonly repoId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.37/docs/resources/image_tag chainguard_image_tag}
*/
export class ImageTag extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImageTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.37/docs/resources/image_tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.37/docs/resources/image_tag chainguard_image_tag} Resource
  *
  * @param scope The scope in which to define this construct
