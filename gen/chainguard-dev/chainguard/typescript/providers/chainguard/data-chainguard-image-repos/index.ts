// https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.38/docs/data-sources/image_repos
...
export interface DataChainguardImageReposConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.38/docs/data-sources/image_repos#name DataChainguardImageRepos#name}
  */
  readonly name?: string;
  /**
  * Filter repositories by parent group UIDP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.38/docs/data-sources/image_repos#parent_id DataChainguardImageRepos#parent_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.38/docs/data-sources/image_repos chainguard_image_repos}
*/
export class DataChainguardImageRepos extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataChainguardImageRepos that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.38/docs/data-sources/image_repos#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.38/docs/data-sources/image_repos chainguard_image_repos} Data Source
  *
  * @param scope The scope in which to define this construct
