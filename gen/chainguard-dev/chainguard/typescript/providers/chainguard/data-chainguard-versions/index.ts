// https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/data-sources/versions
...
export interface DataChainguardVersionsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/data-sources/versions#package DataChainguardVersions#package}
  */
  readonly package: string;
  /**
  * A package variant (e.g. fips).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/data-sources/versions#variant DataChainguardVersions#variant}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/data-sources/versions chainguard_versions}
*/
export class DataChainguardVersions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataChainguardVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/data-sources/versions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/data-sources/versions chainguard_versions} Data Source
  *
  * @param scope The scope in which to define this construct
