// https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.37/docs/resources/apko_build
...
export interface ApkoBuildConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.37/docs/resources/apko_build#config ApkoBuild#config}
  */
  readonly config: string;
  /**
  * The layer media type to build.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.37/docs/resources/apko_build#media_type ApkoBuild#media_type}
  */
  readonly mediaType?: string;
  /**
  * The UIDP of the repository in which to build the image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.37/docs/resources/apko_build#repo ApkoBuild#repo}
  */
  readonly repo: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.37/docs/resources/apko_build chainguard_apko_build}
*/
export class ApkoBuild extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApkoBuild that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.37/docs/resources/apko_build#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.37/docs/resources/apko_build chainguard_apko_build} Resource
  *
  * @param scope The scope in which to define this construct
