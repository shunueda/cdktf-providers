// https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/image_repo_deployment
...
export interface ImageRepoDeploymentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/image_repo_deployment#charts ImageRepoDeployment#charts}
  */
  readonly charts: ImageRepoDeploymentCharts[] | cdktf.IResolvable;
  /**
  * The UIDP of the repository this deployment belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/image_repo_deployment#id ImageRepoDeployment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/image_repo_deployment#ignore_errors ImageRepoDeployment#ignore_errors}
  */
...
export interface ImageRepoDeploymentCharts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/image_repo_deployment#repo ImageRepoDeployment#repo}
  */
  readonly repo: string;
  /**
  * Link to the Helm chart source code (e.g., 'https://github.com/kyverno/kyverno').
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/image_repo_deployment#source ImageRepoDeployment#source}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/image_repo_deployment chainguard_image_repo_deployment}
*/
export class ImageRepoDeployment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImageRepoDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/image_repo_deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.40/docs/resources/image_repo_deployment chainguard_image_repo_deployment} Resource
  *
  * @param scope The scope in which to define this construct
