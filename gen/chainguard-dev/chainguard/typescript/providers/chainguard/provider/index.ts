// https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs
...
export interface ChainguardProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs#console_api ChainguardProvider#console_api}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs#version_stream_allows ChainguardProvider#version_stream_allows}
  */
  readonly versionStreamAllows?: string[];
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs#alias ChainguardProvider#alias}
  */
  readonly alias?: string;
  /**
  * login_options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs#login_options ChainguardProvider#login_options}
  */
...
export interface ChainguardProviderLoginOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs#auth0_connection ChainguardProvider#auth0_connection}
  */
  readonly auth0Connection?: string;
  /**
  * Disable automatic login when Chainguard token is expired.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs#disabled ChainguardProvider#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs#enable_refresh_tokens ChainguardProvider#enable_refresh_tokens}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs#identity_id ChainguardProvider#identity_id}
  */
  readonly identityId?: string;
  /**
  * UIDP of the identity provider authenticate with for OIDC token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs#identity_provider_id ChainguardProvider#identity_provider_id}
  */
  readonly identityProviderId?: string;
  /**
  * A path to an OIDC identity token, or explicit identity token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs#identity_token ChainguardProvider#identity_token}
  */
  readonly identityToken?: string;
  /**
  * Verified organization name for determining identity provider to obtain OIDC token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs#organization_name ChainguardProvider#organization_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs chainguard}
*/
export class ChainguardProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ChainguardProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chainguard-dev/chainguard/0.1.42/docs chainguard} Resource
  *
  * @param scope The scope in which to define this construct
