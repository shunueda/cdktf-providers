// https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_notification_template_started
...
export interface WorkflowJobTemplateNotificationTemplateStartedConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_notification_template_started#id WorkflowJobTemplateNotificationTemplateStarted#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_notification_template_started#notification_template_id WorkflowJobTemplateNotificationTemplateStarted#notification_template_id}
  */
  readonly notificationTemplateId: number;
  /**
  * The ID of the workflow job template to associate the notification template with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_notification_template_started#workflow_job_template_id WorkflowJobTemplateNotificationTemplateStarted#workflow_job_template_id}
  */
  readonly workflowJobTemplateId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_notification_template_started awx_workflow_job_template_notification_template_started}
*/
export class WorkflowJobTemplateNotificationTemplateStarted extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowJobTemplateNotificationTemplateStarted that should be imported. Refer to the {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_notification_template_started#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_notification_template_started awx_workflow_job_template_notification_template_started} Resource
  *
  * @param scope The scope in which to define this construct
