// https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/schedule
...
export interface ScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/schedule#description Schedule#description}
  */
  readonly description?: string;
  /**
  * Enable or disable the schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/schedule#enabled Schedule#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Extra data to be pass for the schedule (YAML format)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/schedule#extra_data Schedule#extra_data}
  */
  readonly extraData?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/schedule#id Schedule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/schedule#inventory Schedule#inventory}
  */
  readonly inventory?: number;
  /**
  * Name of the schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/schedule#name Schedule#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/schedule#rrule Schedule#rrule}
  */
  readonly rrule: string;
  /**
  * The ID of the Unified Job Template to be scheduled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/schedule#unified_job_template_id Schedule#unified_job_template_id}
  */
  readonly unifiedJobTemplateId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/schedule awx_schedule}
*/
export class Schedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Schedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/schedule awx_schedule} Resource
  *
  * @param scope The scope in which to define this construct
