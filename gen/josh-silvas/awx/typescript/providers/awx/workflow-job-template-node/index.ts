// https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node
...
export interface WorkflowJobTemplateNodeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#all_parents_must_converge WorkflowJobTemplateNode#all_parents_must_converge}
  */
  readonly allParentsMustConverge?: boolean | cdktf.IResolvable;
  /**
  * Enable diff mode for the job template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#diff_mode WorkflowJobTemplateNode#diff_mode}
  */
  readonly diffMode?: boolean | cdktf.IResolvable;
  /**
  * Extra data for the workflow job template node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#extra_data WorkflowJobTemplateNode#extra_data}
  */
  readonly extraData?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#id WorkflowJobTemplateNode#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Unique identifier for the workflow job template node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#identifier WorkflowJobTemplateNode#identifier}
  */
  readonly identifier: string;
  /**
  * Inventory applied as a prompt, assuming job template prompts for inventory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#inventory_id WorkflowJobTemplateNode#inventory_id}
  */
  readonly inventoryId?: number;
  /**
  * Tags to use for the job template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#job_tags WorkflowJobTemplateNode#job_tags}
  */
  readonly jobTags?: string;
  /**
  * Type of job to run.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#job_type WorkflowJobTemplateNode#job_type}
  */
  readonly jobType?: string;
  /**
  * Limit the job template to a specific host or group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#limit WorkflowJobTemplateNode#limit}
  */
  readonly limit?: string;
  /**
  * SCM branch to use for the job template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#scm_branch WorkflowJobTemplateNode#scm_branch}
  */
  readonly scmBranch?: string;
  /**
  * Tags to skip for the job template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#skip_tags WorkflowJobTemplateNode#skip_tags}
  */
  readonly skipTags?: string;
  /**
  * Unified job template ID to use for the workflow job template node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#unified_job_template_id WorkflowJobTemplateNode#unified_job_template_id}
  */
  readonly unifiedJobTemplateId: number;
  /**
  * Verbosity level for the job template. One of 0, 1, 2, 3, 4 or 5.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#verbosity WorkflowJobTemplateNode#verbosity}
  */
  readonly verbosity?: number;
  /**
  * Workflow job template ID to use for the workflow job template node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#workflow_job_template_id WorkflowJobTemplateNode#workflow_job_template_id}
  */
  readonly workflowJobTemplateId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node awx_workflow_job_template_node}
*/
export class WorkflowJobTemplateNode extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowJobTemplateNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node awx_workflow_job_template_node} Resource
  *
  * @param scope The scope in which to define this construct
