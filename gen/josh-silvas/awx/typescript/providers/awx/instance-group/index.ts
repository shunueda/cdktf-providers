// https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/instance_group
...
export interface InstanceGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/instance_group#credential_id InstanceGroup#credential_id}
  */
  readonly credentialId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/instance_group#id InstanceGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/instance_group#is_container_group InstanceGroup#is_container_group}
  */
  readonly isContainerGroup?: boolean | cdktf.IResolvable;
  /**
  * The name of the instance group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/instance_group#name InstanceGroup#name}
  */
  readonly name: string;
  /**
  * The pod spec override for the instance group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/instance_group#pod_spec_override InstanceGroup#pod_spec_override}
  */
  readonly podSpecOverride?: string;
  /**
  * The minimum number of instances to run in the instance group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/instance_group#policy_instance_minimum InstanceGroup#policy_instance_minimum}
  */
  readonly policyInstanceMinimum?: number;
  /**
  * The percentage of instances to run in the instance group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/instance_group#policy_instance_percentage InstanceGroup#policy_instance_percentage}
  */
  readonly policyInstancePercentage?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/instance_group awx_instance_group}
*/
export class InstanceGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InstanceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/instance_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/instance_group awx_instance_group} Resource
  *
  * @param scope The scope in which to define this construct
