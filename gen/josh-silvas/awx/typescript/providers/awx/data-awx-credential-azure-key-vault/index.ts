// https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/data-sources/credential_azure_key_vault
...
export interface DataAwxCredentialAzureKeyVaultConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/data-sources/credential_azure_key_vault#credential_id DataAwxCredentialAzureKeyVault#credential_id}
  */
  readonly credentialId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/data-sources/credential_azure_key_vault#id DataAwxCredentialAzureKeyVault#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/data-sources/credential_azure_key_vault awx_credential_azure_key_vault}
*/
export class DataAwxCredentialAzureKeyVault extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwxCredentialAzureKeyVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/data-sources/credential_azure_key_vault#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/data-sources/credential_azure_key_vault awx_credential_azure_key_vault} Data Source
  *
  * @param scope The scope in which to define this construct
