// https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template
...
export interface WorkflowJobTemplateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#allow_simultaneous WorkflowJobTemplate#allow_simultaneous}
  */
  readonly allowSimultaneous?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#ask_inventory_on_launch WorkflowJobTemplate#ask_inventory_on_launch}
  */
  readonly askInventoryOnLaunch?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#ask_limit_on_launch WorkflowJobTemplate#ask_limit_on_launch}
  */
  readonly askLimitOnLaunch?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#ask_scm_branch_on_launch WorkflowJobTemplate#ask_scm_branch_on_launch}
  */
  readonly askScmBranchOnLaunch?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#ask_variables_on_launch WorkflowJobTemplate#ask_variables_on_launch}
  */
  readonly askVariablesOnLaunch?: boolean | cdktf.IResolvable;
  /**
  * Optional description of this workflow job template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#description WorkflowJobTemplate#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#id WorkflowJobTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#inventory_id WorkflowJobTemplate#inventory_id}
  */
  readonly inventoryId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#limit WorkflowJobTemplate#limit}
  */
  readonly limit?: string;
  /**
  * Name of this workflow job template. (string, required)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#name WorkflowJobTemplate#name}
  */
  readonly name: string;
  /**
  * The organization used to determine access to this template. (id, default=``)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#organization_id WorkflowJobTemplate#organization_id}
  */
  readonly organizationId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#scm_branch WorkflowJobTemplate#scm_branch}
  */
  readonly scmBranch?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#survey_enabled WorkflowJobTemplate#survey_enabled}
  */
  readonly surveyEnabled?: boolean | cdktf.IResolvable;
  /**
  * Extra variables used by Ansible in YAML or JSON format. (string, default=``)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#variables WorkflowJobTemplate#variables}
  */
  readonly variables?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#webhook_credential WorkflowJobTemplate#webhook_credential}
  */
  readonly webhookCredential?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#webhook_service WorkflowJobTemplate#webhook_service}
  */
  readonly webhookService?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template awx_workflow_job_template}
*/
export class WorkflowJobTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowJobTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template awx_workflow_job_template} Resource
  *
  * @param scope The scope in which to define this construct
