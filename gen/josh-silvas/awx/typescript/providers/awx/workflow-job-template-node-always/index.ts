// https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always
...
export interface WorkflowJobTemplateNodeAlwaysConfig extends cdktf.TerraformMetaArguments {
  /**
  * Whether all parents must converge before this node can start
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#all_parents_must_converge WorkflowJobTemplateNodeAlways#all_parents_must_converge}
  */
  readonly allParentsMustConverge?: boolean | cdktf.IResolvable;
  /**
  * Whether to enable diff mode for the job template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#diff_mode WorkflowJobTemplateNodeAlways#diff_mode}
  */
  readonly diffMode?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#extra_data WorkflowJobTemplateNodeAlways#extra_data}
  */
  readonly extraData?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#id WorkflowJobTemplateNodeAlways#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#identifier WorkflowJobTemplateNodeAlways#identifier}
  */
  readonly identifier: string;
  /**
  * Inventory applied as a prompt, assuming job template prompts for inventory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#inventory_id WorkflowJobTemplateNodeAlways#inventory_id}
  */
  readonly inventoryId?: number;
  /**
  * A list of job tags to use for the job template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#job_tags WorkflowJobTemplateNodeAlways#job_tags}
  */
  readonly jobTags?: string;
  /**
  * The type of job to run.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#job_type WorkflowJobTemplateNodeAlways#job_type}
  */
  readonly jobType?: string;
  /**
  * A host pattern to limit the job template to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#limit WorkflowJobTemplateNodeAlways#limit}
  */
  readonly limit?: string;
  /**
  * The SCM branch to use for the job template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#scm_branch WorkflowJobTemplateNodeAlways#scm_branch}
  */
  readonly scmBranch?: string;
  /**
  * A list of job tags to skip for the job template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#skip_tags WorkflowJobTemplateNodeAlways#skip_tags}
  */
  readonly skipTags?: string;
  /**
  * The unified job template id to which the node belongs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#unified_job_template_id WorkflowJobTemplateNodeAlways#unified_job_template_id}
  */
  readonly unifiedJobTemplateId: number;
  /**
  * The verbosity level for the job template. Can be one of 0, 1, 2, 3, or 4.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#verbosity WorkflowJobTemplateNodeAlways#verbosity}
  */
  readonly verbosity?: number;
  /**
  * The workflow job template id to which the node belongs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#workflow_job_template_id WorkflowJobTemplateNodeAlways#workflow_job_template_id}
  */
  readonly workflowJobTemplateId: number;
  /**
  * The workflow_job_template_node id from with the new node will start
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#workflow_job_template_node_id WorkflowJobTemplateNodeAlways#workflow_job_template_node_id}
  */
  readonly workflowJobTemplateNodeId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always awx_workflow_job_template_node_always}
*/
export class WorkflowJobTemplateNodeAlways extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "awx_workflow_job_template_node_always";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a WorkflowJobTemplateNodeAlways resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the WorkflowJobTemplateNodeAlways to import
  * @param importFromId The id of the existing WorkflowJobTemplateNodeAlways that should be imported. Refer to the {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the WorkflowJobTemplateNodeAlways to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "awx_workflow_job_template_node_always", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/workflow_job_template_node_always awx_workflow_job_template_node_always} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options WorkflowJobTemplateNodeAlwaysConfig
  */
  public constructor(scope: Construct, id: string, config: WorkflowJobTemplateNodeAlwaysConfig) {
    super(scope, id, {
