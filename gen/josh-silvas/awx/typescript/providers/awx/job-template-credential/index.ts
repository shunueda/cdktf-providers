// https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/job_template_credential
...
export interface JobTemplateCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/job_template_credential#credential_id JobTemplateCredential#credential_id}
  */
  readonly credentialId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/job_template_credential#id JobTemplateCredential#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/job_template_credential#job_template_id JobTemplateCredential#job_template_id}
  */
  readonly jobTemplateId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/job_template_credential awx_job_template_credential}
*/
export class JobTemplateCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing JobTemplateCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/job_template_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/josh-silvas/awx/1.7.5/docs/resources/job_template_credential awx_job_template_credential} Resource
  *
  * @param scope The scope in which to define this construct
