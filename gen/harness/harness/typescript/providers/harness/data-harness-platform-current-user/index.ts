// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_current_user
...
export interface DataHarnessPlatformCurrentUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_current_user#id DataHarnessPlatformCurrentUser#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_current_user harness_platform_current_user}
*/
export class DataHarnessPlatformCurrentUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarnessPlatformCurrentUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_current_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_current_user harness_platform_current_user} Data Source
  *
  * @param scope The scope in which to define this construct
