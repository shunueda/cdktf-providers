// https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_iacm_default_pipeline
...
export interface DataHarnessPlatformIacmDefaultPipelineConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_iacm_default_pipeline#id DataHarnessPlatformIacmDefaultPipeline#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_iacm_default_pipeline#operation DataHarnessPlatformIacmDefaultPipeline#operation}
  */
  readonly operation: string;
  /**
  * Organization identifier of the organization the default pipelines resides in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_iacm_default_pipeline#org_id DataHarnessPlatformIacmDefaultPipeline#org_id}
  */
  readonly orgId: string;
  /**
  * Project identifier of the project the default pipelines resides in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_iacm_default_pipeline#project_id DataHarnessPlatformIacmDefaultPipeline#project_id}
  */
  readonly projectId: string;
  /**
  * The provisioner associated with this default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_iacm_default_pipeline#provisioner_type DataHarnessPlatformIacmDefaultPipeline#provisioner_type}
  */
  readonly provisionerType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_iacm_default_pipeline harness_platform_iacm_default_pipeline}
*/
export class DataHarnessPlatformIacmDefaultPipeline extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarnessPlatformIacmDefaultPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_iacm_default_pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_iacm_default_pipeline harness_platform_iacm_default_pipeline} Data Source
  *
  * @param scope The scope in which to define this construct
