// https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_hub
...
export interface ChaosHubConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_hub#connector_id ChaosHub#connector_id}
  */
  readonly connectorId: string;
  /**
  * Scope of the Git connector (PROJECT, ORGANISATION, or ACCOUNT)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_hub#connector_scope ChaosHub#connector_scope}
  */
  readonly connectorScope?: string;
  /**
  * Description of the chaos hub
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_hub#description ChaosHub#description}
  */
  readonly description?: string;
  /**
  * Whether this is the default chaos hub
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_hub#is_default ChaosHub#is_default}
  */
  readonly isDefault?: boolean | cdktf.IResolvable;
  /**
  * Name of the chaos hub
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_hub#name ChaosHub#name}
  */
  readonly name: string;
  /**
  * The organization ID of the chaos hub
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_hub#org_id ChaosHub#org_id}
  */
  readonly orgId?: string;
  /**
  * The project ID of the chaos hub
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_hub#project_id ChaosHub#project_id}
  */
  readonly projectId?: string;
  /**
  * Git repository branch
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_hub#repo_branch ChaosHub#repo_branch}
  */
  readonly repoBranch: string;
  /**
  * Name of the Git repository (required for account-level connectors)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_hub#repo_name ChaosHub#repo_name}
  */
  readonly repoName?: string;
  /**
  * Tags to associate with the chaos hub
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_hub#tags ChaosHub#tags}
  */
  readonly tags?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_hub harness_chaos_hub}
*/
export class ChaosHub extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChaosHub that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_hub#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_hub harness_chaos_hub} Resource
  *
  * @param scope The scope in which to define this construct
