// https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred
...
export interface PlatformGitopsRepoCredConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#account_id PlatformGitopsRepoCred#account_id}
  */
  readonly accountId?: string;
  /**
  * Agent identifier of the Repository Credentials.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#agent_id PlatformGitopsRepoCred#agent_id}
  */
  readonly agentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#id PlatformGitopsRepoCred#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#identifier PlatformGitopsRepoCred#identifier}
  */
  readonly identifier: string;
  /**
  * Organization identifier of the Repository Credentials.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#org_id PlatformGitopsRepoCred#org_id}
  */
  readonly orgId?: string;
  /**
  * Project identifier of the Repository Credentials.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#project_id PlatformGitopsRepoCred#project_id}
  */
  readonly projectId?: string;
  /**
  * Indicates if the GitOps repository credential should be updated if existing and inserted if not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#upsert PlatformGitopsRepoCred#upsert}
  */
  readonly upsert?: boolean | cdktf.IResolvable;
  /**
  * creds block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#creds PlatformGitopsRepoCred#creds}
  */
...
export interface PlatformGitopsRepoCredCreds {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#enable_oci PlatformGitopsRepoCred#enable_oci}
  */
  readonly enableOci?: boolean | cdktf.IResolvable;
  /**
  * Specifies the GitHub API URL for GitHub app authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#github_app_enterprise_base_url PlatformGitopsRepoCred#github_app_enterprise_base_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#github_app_id PlatformGitopsRepoCred#github_app_id}
  */
  readonly githubAppId?: string;
  /**
  * Specifies the ID of the installed GitHub App for GitHub app authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#github_app_installation_id PlatformGitopsRepoCred#github_app_installation_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#github_app_private_key PlatformGitopsRepoCred#github_app_private_key}
  */
  readonly githubAppPrivateKey?: string;
  /**
  * Password or PAT to be used for authenticating the remote repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#password PlatformGitopsRepoCred#password}
  */
  readonly password?: string;
  /**
  * SSH Key in PEM format for authenticating the repository. Used only for Git repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#ssh_private_key PlatformGitopsRepoCred#ssh_private_key}
  */
  readonly sshPrivateKey?: string;
  /**
  * Certificate in PEM format for authenticating at the repo server. This is used for mTLS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#tls_client_cert_data PlatformGitopsRepoCred#tls_client_cert_data}
  */
  readonly tlsClientCertData?: string;
  /**
  * Private key in PEM format for authenticating at the repo server. This is used for mTLS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#tls_client_cert_key PlatformGitopsRepoCred#tls_client_cert_key}
  */
  readonly tlsClientCertKey?: string;
  /**
  * Type specifies the type of the repoCreds.Can be either 'git' or 'helm. 'git' is assumed if empty or absent
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#type PlatformGitopsRepoCred#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#url PlatformGitopsRepoCred#url}
  */
  readonly url?: string;
  /**
  * Username to be used for authenticating the remote repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#username PlatformGitopsRepoCred#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred harness_platform_gitops_repo_cred}
*/
export class PlatformGitopsRepoCred extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformGitopsRepoCred that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_repo_cred harness_platform_gitops_repo_cred} Resource
  *
  * @param scope The scope in which to define this construct
