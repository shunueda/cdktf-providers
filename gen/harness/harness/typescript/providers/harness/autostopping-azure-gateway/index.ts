// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway
...
export interface AutostoppingAzureGatewayConfig extends cdktf.TerraformMetaArguments {
  /**
  * ID of Azure AppGateway for importing. Required only for importing exiging AppGateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#app_gateway_id AutostoppingAzureGateway#app_gateway_id}
  */
  readonly appGatewayId?: string;
  /**
  * Region in which azure cloud function will be provisioned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#azure_func_region AutostoppingAzureGateway#azure_func_region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#certificate_id AutostoppingAzureGateway#certificate_id}
  */
  readonly certificateId?: string;
  /**
  * Id of the cloud connector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#cloud_connector_id AutostoppingAzureGateway#cloud_connector_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#delete_cloud_resources_on_destroy AutostoppingAzureGateway#delete_cloud_resources_on_destroy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#frontend_ip AutostoppingAzureGateway#frontend_ip}
  */
  readonly frontendIp?: string;
  /**
  * Hostname for the proxy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#host_name AutostoppingAzureGateway#host_name}
  */
  readonly hostName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#id AutostoppingAzureGateway#id}
  *
  ...
  * Name of the proxy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#name AutostoppingAzureGateway#name}
  */
  readonly name: string;
  /**
  * Region in which cloud resources are hosted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#region AutostoppingAzureGateway#region}
  */
  readonly region: string;
  /**
  * Resource group in which cloud resources are hosted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#resource_group AutostoppingAzureGateway#resource_group}
  */
  readonly resourceGroup: string;
  /**
  * Size of machine used for the gateway. Required only for creating new AppGateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#sku_size AutostoppingAzureGateway#sku_size}
  */
  readonly skuSize?: string;
  /**
  * Subnet in which cloud resources are hosted. Required only for creating new AppGateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#subnet_id AutostoppingAzureGateway#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * VNet in which cloud resources are hosted. Required only for creating new AppGateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#vpc AutostoppingAzureGateway#vpc}
  */
  readonly vpc: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway harness_autostopping_azure_gateway}
*/
export class AutostoppingAzureGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutostoppingAzureGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/autostopping_azure_gateway harness_autostopping_azure_gateway} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AutostoppingAzureGatewayConfig
  */
  public constructor(scope: Construct, id: string, config: AutostoppingAzureGatewayConfig) {
    super(scope, id, {
