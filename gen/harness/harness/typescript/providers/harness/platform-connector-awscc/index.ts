// https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc
...
export interface PlatformConnectorAwsccConfig extends cdktf.TerraformMetaArguments {
  ...
  * The AWS account id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#account_id PlatformConnectorAwscc#account_id}
  */
  readonly accountId: string;
  /**
  * Description of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#description PlatformConnectorAwscc#description}
  */
  readonly description?: string;
  /**
  * The features enabled for the connector. Valid values are BILLING, OPTIMIZATION, VISIBILITY, GOVERNANCE.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#features_enabled PlatformConnectorAwscc#features_enabled}
  */
  readonly featuresEnabled: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#id PlatformConnectorAwscc#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#identifier PlatformConnectorAwscc#identifier}
  */
  readonly identifier: string;
  /**
  * Name of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#name PlatformConnectorAwscc#name}
  */
  readonly name: string;
  /**
  * Unique identifier of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#org_id PlatformConnectorAwscc#org_id}
  */
  readonly orgId?: string;
  /**
  * Unique identifier of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#project_id PlatformConnectorAwscc#project_id}
  */
  readonly projectId?: string;
  /**
  * The cost and usage report name. Provided in the delivery options when the template is opened in the AWS console.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#report_name PlatformConnectorAwscc#report_name}
  */
  readonly reportName?: string;
  /**
  * The name of s3 bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#s3_bucket PlatformConnectorAwscc#s3_bucket}
  */
  readonly s3Bucket?: string;
  /**
  * Tags to associate with the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#tags PlatformConnectorAwscc#tags}
  */
  readonly tags?: string[];
  /**
  * cross_account_access block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#cross_account_access PlatformConnectorAwscc#cross_account_access}
  */
...
export interface PlatformConnectorAwsccCrossAccountAccess {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#external_id PlatformConnectorAwscc#external_id}
  */
  readonly externalId: string;
  /**
  * The ARN of the role to use for cross-account access.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#role_arn PlatformConnectorAwscc#role_arn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc harness_platform_connector_awscc}
*/
export class PlatformConnectorAwscc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformConnectorAwscc that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_awscc harness_platform_connector_awscc} Resource
  *
  * @param scope The scope in which to define this construct
