// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement
...
export interface GovernanceRuleEnforcementConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement#cloud_provider GovernanceRuleEnforcement#cloud_provider}
  */
  readonly cloudProvider: string;
  /**
  * Description for rule enforcement.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement#description GovernanceRuleEnforcement#description}
  */
  readonly description?: string;
  /**
  * Execution schedule in cron format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement#execution_schedule GovernanceRuleEnforcement#execution_schedule}
  */
  readonly executionSchedule: string;
  /**
  * Timezone for the execution schedule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement#execution_timezone GovernanceRuleEnforcement#execution_timezone}
  */
  readonly executionTimezone: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement#id GovernanceRuleEnforcement#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement#is_dry_run GovernanceRuleEnforcement#is_dry_run}
  */
  readonly isDryRun?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the rule enforcement is enabled. This by default is set to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement#is_enabled GovernanceRuleEnforcement#is_enabled}
  */
  readonly isEnabled?: boolean | cdktf.IResolvable;
  /**
  * Name of the rule enforcement.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement#name GovernanceRuleEnforcement#name}
  */
  readonly name: string;
  /**
  * List of rule IDs. Either rule_ids or rule_set_ids should be provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement#rule_ids GovernanceRuleEnforcement#rule_ids}
  */
  readonly ruleIds?: string[];
  /**
  * List of rule set IDs. Either rule_ids or rule_set_ids should be provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement#rule_set_ids GovernanceRuleEnforcement#rule_set_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement#target_accounts GovernanceRuleEnforcement#target_accounts}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement#target_regions GovernanceRuleEnforcement#target_regions}
  */
  readonly targetRegions?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement harness_governance_rule_enforcement}
*/
export class GovernanceRuleEnforcement extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GovernanceRuleEnforcement that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/governance_rule_enforcement harness_governance_rule_enforcement} Resource
  *
  * @param scope The scope in which to define this construct
