// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_delegatetoken
...
export interface PlatformDelegatetokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_delegatetoken#account_id PlatformDelegatetoken#account_id}
  */
  readonly accountId: string;
  /**
  * Time when the delegate token is created. This is an epoch timestamp.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_delegatetoken#created_at PlatformDelegatetoken#created_at}
  */
  readonly createdAt?: number;
  /**
  * created by details
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_delegatetoken#created_by PlatformDelegatetoken#created_by}
  */
  readonly createdBy?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_delegatetoken#id PlatformDelegatetoken#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_delegatetoken#name PlatformDelegatetoken#name}
  */
  readonly name: string;
  /**
  * Org Identifier for the Entity
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_delegatetoken#org_id PlatformDelegatetoken#org_id}
  */
  readonly orgId?: string;
  /**
  * Project Identifier for the Entity
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_delegatetoken#project_id PlatformDelegatetoken#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_delegatetoken#revoke_after PlatformDelegatetoken#revoke_after}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_delegatetoken#token_status PlatformDelegatetoken#token_status}
  */
  readonly tokenStatus?: string;
  /**
  * Value of the delegate token. Encoded in base64.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_delegatetoken#value PlatformDelegatetoken#value}
  */
  readonly value?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_delegatetoken harness_platform_delegatetoken}
*/
export class PlatformDelegatetoken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformDelegatetoken that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_delegatetoken#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_delegatetoken harness_platform_delegatetoken} Resource
  *
  * @param scope The scope in which to define this construct
