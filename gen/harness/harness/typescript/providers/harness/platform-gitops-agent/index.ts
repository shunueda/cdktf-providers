// https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent
...
export interface PlatformGitopsAgentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#account_id PlatformGitopsAgent#account_id}
  */
  readonly accountId?: string;
  /**
  * Description of the GitOps agent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#description PlatformGitopsAgent#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#id PlatformGitopsAgent#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#identifier PlatformGitopsAgent#identifier}
  */
  readonly identifier: string;
  /**
  * Name of the GitOps agent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#name PlatformGitopsAgent#name}
  */
  readonly name: string;
  /**
  * The Operator to use for the Harness GitOps agent. Enum: "ARGO" "FLAMINGO"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#operator PlatformGitopsAgent#operator}
  */
  readonly operator?: string;
  /**
  * Organization identifier of the GitOps agent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#org_id PlatformGitopsAgent#org_id}
  */
  readonly orgId?: string;
  /**
  * Project identifier of the GitOps agent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#project_id PlatformGitopsAgent#project_id}
  */
  readonly projectId?: string;
  /**
  * Tags for the GitOps agents. These can be used to search or filter the GitOps agents.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#tags PlatformGitopsAgent#tags}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#type PlatformGitopsAgent#type}
  */
  readonly type: string;
  /**
  * metadata block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#metadata PlatformGitopsAgent#metadata}
  */
...
export interface PlatformGitopsAgentMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#high_availability PlatformGitopsAgent#high_availability}
  */
  readonly highAvailability?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the agent is namespaced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#is_namespaced PlatformGitopsAgent#is_namespaced}
  */
  readonly isNamespaced?: boolean | cdktf.IResolvable;
  /**
  * The kubernetes namespace where the agent should be installed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#namespace PlatformGitopsAgent#namespace}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent harness_platform_gitops_agent}
*/
export class PlatformGitopsAgent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformGitopsAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_gitops_agent harness_platform_gitops_agent} Resource
  *
  * @param scope The scope in which to define this construct
