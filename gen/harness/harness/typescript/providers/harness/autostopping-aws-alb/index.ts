// https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb
...
export interface AutostoppingAwsAlbConfig extends cdktf.TerraformMetaArguments {
  /**
  * Arn of AWS ALB to be imported. Required only for importing existing ALB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb#alb_arn AutostoppingAwsAlb#alb_arn}
  */
  readonly albArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb#certificate_id AutostoppingAwsAlb#certificate_id}
  */
  readonly certificateId?: string;
  /**
  * Id of the cloud connector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb#cloud_connector_id AutostoppingAwsAlb#cloud_connector_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb#delete_cloud_resources_on_destroy AutostoppingAwsAlb#delete_cloud_resources_on_destroy}
  */
  readonly deleteCloudResourcesOnDestroy: boolean | cdktf.IResolvable;
  /**
  * Hostname for the proxy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb#host_name AutostoppingAwsAlb#host_name}
  */
  readonly hostName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb#id AutostoppingAwsAlb#id}
  *
  ...
  * Name of the proxy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb#name AutostoppingAwsAlb#name}
  */
  readonly name: string;
  /**
  * Region in which cloud resources are hosted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb#region AutostoppingAwsAlb#region}
  */
  readonly region: string;
  /**
  * Route 53 hosted zone id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb#route53_hosted_zone_id AutostoppingAwsAlb#route53_hosted_zone_id}
  */
  readonly route53HostedZoneId?: string;
  /**
  * Security Group to define the security rules that determine the inbound and outbound traffic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb#security_groups AutostoppingAwsAlb#security_groups}
  */
  readonly securityGroups?: string[];
  /**
  * VPC in which cloud resources are hosted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb#vpc AutostoppingAwsAlb#vpc}
  */
  readonly vpc: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb harness_autostopping_aws_alb}
*/
export class AutostoppingAwsAlb extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutostoppingAwsAlb that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_aws_alb harness_autostopping_aws_alb} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AutostoppingAwsAlbConfig
  */
  public constructor(scope: Construct, id: string, config: AutostoppingAwsAlbConfig) {
    super(scope, id, {
