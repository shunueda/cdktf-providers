// https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module
...
export interface PlatformInfraModuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#created PlatformInfraModule#created}
  */
  readonly created?: number;
  /**
  * Description of the module.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#description PlatformInfraModule#description}
  */
  readonly description?: string;
  /**
  * Unique identifier of the module.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#id PlatformInfraModule#id}
  *
  ...
  * Name of the module.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#name PlatformInfraModule#name}
  */
  readonly name: string;
  /**
  * For account connectors, the repository where the module can be found
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#repository PlatformInfraModule#repository}
  */
  readonly repository?: string;
  /**
  * Name of the branch to fetch the code from. This cannot be set if repository commit is set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#repository_branch PlatformInfraModule#repository_branch}
  */
  readonly repositoryBranch?: string;
  /**
  * Tag to fetch the code from. This cannot be set if repository branch is set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#repository_commit PlatformInfraModule#repository_commit}
  */
  readonly repositoryCommit?: string;
  /**
  * Reference to the connector to be used to fetch the code.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#repository_connector PlatformInfraModule#repository_connector}
  */
  readonly repositoryConnector?: string;
  /**
  * Path to the module within the repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#repository_path PlatformInfraModule#repository_path}
  */
  readonly repositoryPath?: string;
  /**
  * URL of the repository where the module is stored.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#repository_url PlatformInfraModule#repository_url}
  */
  readonly repositoryUrl?: string;
  /**
  * Timestamp when the module was last synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#synced PlatformInfraModule#synced}
  */
  readonly synced?: number;
  /**
  * Provider of the module.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#system PlatformInfraModule#system}
  */
  readonly systemAttribute: string;
  /**
  * Git tags associated with the module.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#tags PlatformInfraModule#tags}
  */
  readonly tags?: string;
  /**
  * List of versions of the module.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#versions PlatformInfraModule#versions}
  */
  readonly versions?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module harness_platform_infra_module}
*/
export class PlatformInfraModule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformInfraModule that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module harness_platform_infra_module} Resource
  *
  * @param scope The scope in which to define this construct
