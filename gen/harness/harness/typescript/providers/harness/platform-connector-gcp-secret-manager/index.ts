// https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager
...
export interface PlatformConnectorGcpSecretManagerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#credentials_ref PlatformConnectorGcpSecretManager#credentials_ref}
  */
  readonly credentialsRef?: string;
  /**
  * The delegates to inherit the credentials from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#delegate_selectors PlatformConnectorGcpSecretManager#delegate_selectors}
  */
  readonly delegateSelectors?: string[];
  /**
  * Description of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#description PlatformConnectorGcpSecretManager#description}
  */
  readonly description?: string;
  /**
  * Execute on delegate or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#execute_on_delegate PlatformConnectorGcpSecretManager#execute_on_delegate}
  */
  readonly executeOnDelegate?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#id PlatformConnectorGcpSecretManager#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#identifier PlatformConnectorGcpSecretManager#identifier}
  */
  readonly identifier: string;
  /**
  * Inherit configuration from delegate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#inherit_from_delegate PlatformConnectorGcpSecretManager#inherit_from_delegate}
  */
  readonly inheritFromDelegate?: boolean | cdktf.IResolvable;
  /**
  * Set this flag to set this secret manager as default secret manager.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#is_default PlatformConnectorGcpSecretManager#is_default}
  */
  readonly isDefault?: boolean | cdktf.IResolvable;
  /**
  * Name of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#name PlatformConnectorGcpSecretManager#name}
  */
  readonly name: string;
  /**
  * Unique identifier of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#org_id PlatformConnectorGcpSecretManager#org_id}
  */
  readonly orgId?: string;
  /**
  * Unique identifier of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#project_id PlatformConnectorGcpSecretManager#project_id}
  */
  readonly projectId?: string;
  /**
  * Tags to associate with the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#tags PlatformConnectorGcpSecretManager#tags}
  */
  readonly tags?: string[];
  /**
  * oidc_authentication block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#oidc_authentication PlatformConnectorGcpSecretManager#oidc_authentication}
  */
...
export interface PlatformConnectorGcpSecretManagerOidcAuthentication {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#gcp_project_id PlatformConnectorGcpSecretManager#gcp_project_id}
  */
  readonly gcpProjectId: string;
  /**
  * The OIDC provider ID value configured in GCP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#provider_id PlatformConnectorGcpSecretManager#provider_id}
  */
  readonly providerId: string;
  /**
  * The service account linked to workload identity pool while setting GCP workload identity provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#service_account_email PlatformConnectorGcpSecretManager#service_account_email}
  */
  readonly serviceAccountEmail: string;
  /**
  * The workload pool ID value created in GCP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#workload_pool_id PlatformConnectorGcpSecretManager#workload_pool_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager harness_platform_connector_gcp_secret_manager}
*/
export class PlatformConnectorGcpSecretManager extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformConnectorGcpSecretManager that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_connector_gcp_secret_manager harness_platform_connector_gcp_secret_manager} Resource
  *
  * @param scope The scope in which to define this construct
