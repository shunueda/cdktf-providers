// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/application
...
export interface DataHarnessApplicationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/application#description DataHarnessApplication#description}
  */
  readonly description?: string;
  /**
  * The id of the git sync connector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/application#git_sync_connector_id DataHarnessApplication#git_sync_connector_id}
  */
  readonly gitSyncConnectorId?: string;
  /**
  * True if git sync is enabled on this application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/application#git_sync_enabled DataHarnessApplication#git_sync_enabled}
  */
  readonly gitSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * Unique identifier of the application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/application#id DataHarnessApplication#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/application#is_manual_trigger_authorized DataHarnessApplication#is_manual_trigger_authorized}
  */
  readonly isManualTriggerAuthorized?: boolean | cdktf.IResolvable;
  /**
  * The name of the application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/application#name DataHarnessApplication#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/application harness_application}
*/
export class DataHarnessApplication extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarnessApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/application harness_application} Data Source
  *
  * @param scope The scope in which to define this construct
