// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider
...
export interface PlatformProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider#description PlatformProvider#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider#id PlatformProvider#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider#identifier PlatformProvider#identifier}
  */
  readonly identifier: string;
  /**
  * The name of the provider entity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider#name PlatformProvider#name}
  */
  readonly name: string;
  /**
  * spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider#spec PlatformProvider#spec}
  */
...
export interface PlatformProviderSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider#client_id PlatformProvider#client_id}
  */
  readonly clientId?: string;
  /**
  * Client Secret Ref of the OAuth app to connect
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider#client_secret_ref PlatformProvider#client_secret_ref}
  */
  readonly clientSecretRef?: string;
  /**
  * Delegate selectors to fetch the access token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider#delegate_selectors PlatformProvider#delegate_selectors}
  */
  readonly delegateSelectors?: string[];
  /**
  * Host domain of the provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider#domain PlatformProvider#domain}
  */
  readonly domain?: string;
  /**
  * Secret Manager Ref to store the access/refresh tokens
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider#secret_manager_ref PlatformProvider#secret_manager_ref}
  */
  readonly secretManagerRef?: string;
  /**
  * The type of the provider entity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider#type PlatformProvider#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider harness_platform_provider}
*/
export class PlatformProvider extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_provider harness_platform_provider} Resource
  *
  * @param scope The scope in which to define this construct
