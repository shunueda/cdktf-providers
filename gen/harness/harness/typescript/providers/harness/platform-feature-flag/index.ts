// https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag
...
export interface PlatformFeatureFlagConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#archived PlatformFeatureFlag#archived}
  */
  readonly archived?: boolean | cdktf.IResolvable;
  /**
  * Which of the variations to use when the flag is toggled to off state
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#default_off_variation PlatformFeatureFlag#default_off_variation}
  */
  readonly defaultOffVariation: string;
  /**
  * Which of the variations to use when the flag is toggled to on state
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#default_on_variation PlatformFeatureFlag#default_on_variation}
  */
  readonly defaultOnVariation: string;
  /**
  * Description of the Feature Flag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#description PlatformFeatureFlag#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#id PlatformFeatureFlag#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#identifier PlatformFeatureFlag#identifier}
  */
  readonly identifier: string;
  /**
  * The type of data the flag represents. Valid values are `boolean`, `int`, `string`, `json`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#kind PlatformFeatureFlag#kind}
  */
  readonly kind: string;
  /**
  * Name of the Feature Flag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#name PlatformFeatureFlag#name}
  */
  readonly name: string;
  /**
  * Organization Identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#org_id PlatformFeatureFlag#org_id}
  */
  readonly orgId: string;
  /**
  * The owner of the flag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#owner PlatformFeatureFlag#owner}
  */
  readonly owner?: string;
  /**
  * Whether or not the flag is permanent. If it is, it will never be flagged as stale
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#permanent PlatformFeatureFlag#permanent}
  */
  readonly permanent: boolean | cdktf.IResolvable;
  /**
  * Project Identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#project_id PlatformFeatureFlag#project_id}
  */
  readonly projectId: string;
  /**
  * environment block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#environment PlatformFeatureFlag#environment}
  */
  readonly environment?: PlatformFeatureFlagEnvironment[] | cdktf.IResolvable;
  /**
  * tags block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#tags PlatformFeatureFlag#tags}
  */
  readonly tags?: PlatformFeatureFlagTags[] | cdktf.IResolvable;
  /**
  * variation block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#variation PlatformFeatureFlag#variation}
  */
...
export interface PlatformFeatureFlagEnvironmentAddTargetRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#targets PlatformFeatureFlag#targets}
  */
...
export interface PlatformFeatureFlagEnvironment {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#state PlatformFeatureFlag#state}
  */
  readonly state?: string;
  /**
  * add_target_rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#add_target_rule PlatformFeatureFlag#add_target_rule}
  */
...
export interface PlatformFeatureFlagVariation {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#value PlatformFeatureFlag#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag harness_platform_feature_flag}
*/
export class PlatformFeatureFlag extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformFeatureFlag that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_feature_flag harness_platform_feature_flag} Resource
  *
  * @param scope The scope in which to define this construct
