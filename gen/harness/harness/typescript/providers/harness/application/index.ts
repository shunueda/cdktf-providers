// https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/application
...
export interface ApplicationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/application#description Application#description}
  */
  readonly description?: string;
  /**
  * When this is set to true, all manual triggers will require API Key authorization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/application#is_manual_trigger_authorized Application#is_manual_trigger_authorized}
  */
  readonly isManualTriggerAuthorized?: boolean | cdktf.IResolvable;
  /**
  * The name of the application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/application#name Application#name}
  */
  readonly name: string;
  /**
  * Tags to associate with the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/application#tags Application#tags}
  */
  readonly tags?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/application harness_application}
*/
export class Application extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Application that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/application harness_application} Resource
  *
  * @param scope The scope in which to define this construct
