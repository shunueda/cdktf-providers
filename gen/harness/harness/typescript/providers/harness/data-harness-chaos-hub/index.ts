// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/chaos_hub
...
export interface DataHarnessChaosHubConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/chaos_hub#id DataHarnessChaosHub#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/chaos_hub#name DataHarnessChaosHub#name}
  */
  readonly name: string;
  /**
  * The organization ID of the chaos hub
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/chaos_hub#org_id DataHarnessChaosHub#org_id}
  */
  readonly orgId?: string;
  /**
  * The project ID of the chaos hub
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/chaos_hub#project_id DataHarnessChaosHub#project_id}
  */
  readonly projectId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/chaos_hub harness_chaos_hub}
*/
export class DataHarnessChaosHub extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarnessChaosHub that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/chaos_hub#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/chaos_hub harness_chaos_hub} Data Source
  *
  * @param scope The scope in which to define this construct
