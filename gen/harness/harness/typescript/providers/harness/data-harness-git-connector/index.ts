// https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/git_connector
...
export interface DataHarnessGitConnectorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/git_connector#id DataHarnessGitConnector#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/git_connector#name DataHarnessGitConnector#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/git_connector harness_git_connector}
*/
export class DataHarnessGitConnector extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarnessGitConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/git_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/git_connector harness_git_connector} Data Source
  *
  * @param scope The scope in which to define this construct
