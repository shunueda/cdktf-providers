// https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing
...
export interface PlatformInfraModuleTestingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#id PlatformInfraModuleTesting#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#module_id PlatformInfraModuleTesting#module_id}
  */
  readonly moduleId: string;
  /**
  * Organization identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#org PlatformInfraModuleTesting#org}
  */
  readonly org: string;
  /**
  * List of pipeline IDs to create webhooks for triggering test executions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#pipelines PlatformInfraModuleTesting#pipelines}
  */
  readonly pipelines: string[];
  /**
  * Project identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#project PlatformInfraModuleTesting#project}
  */
  readonly project: string;
  /**
  * Provider connector for testing purposes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#provider_connector PlatformInfraModuleTesting#provider_connector}
  */
  readonly providerConnector: string;
  /**
  * Provisioner type for testing purposes (e.g., terraform, tofu)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#provisioner_type PlatformInfraModuleTesting#provisioner_type}
  */
  readonly provisionerType: string;
  /**
  * Provisioner version for testing purposes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#provisioner_version PlatformInfraModuleTesting#provisioner_version}
  */
  readonly provisionerVersion: string;
  /**
  * Pipeline ID to create webhooks for releases
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#release_pipeline PlatformInfraModuleTesting#release_pipeline}
  */
  readonly releasePipeline?: string;
  /**
  * Whether testing is enabled for the module
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#testing_enabled PlatformInfraModuleTesting#testing_enabled}
  */
  readonly testingEnabled?: boolean | cdktf.IResolvable;
  /**
  * Timestamp when the module was last modified
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#updated PlatformInfraModuleTesting#updated}
  */
  readonly updated?: number;
  /**
  * Versions of the module
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#versions PlatformInfraModuleTesting#versions}
  */
  readonly versions?: string[];
  /**
  * testing_metadata block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#testing_metadata PlatformInfraModuleTesting#testing_metadata}
  */
  readonly testingMetadata?: PlatformInfraModuleTestingTestingMetadata;
}
export interface PlatformInfraModuleTestingTestingMetadata {
  /**
  * Account is the internal customer account ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#account PlatformInfraModuleTesting#account}
  */
...
export function platformInfraModuleTestingTestingMetadataToTerraform(struct?: PlatformInfraModuleTestingTestingMetadataOutputReference | PlatformInfraModuleTestingTestingMetadata): any {
...
export function platformInfraModuleTestingTestingMetadataToHclTerraform(struct?: PlatformInfraModuleTestingTestingMetadataOutputReference | PlatformInfraModuleTestingTestingMetadata): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PlatformInfraModuleTestingTestingMetadataOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PlatformInfraModuleTestingTestingMetadata | undefined {
  ...
  public set internalValue(value: PlatformInfraModuleTestingTestingMetadata | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing harness_platform_infra_module_testing}
*/
export class PlatformInfraModuleTesting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformInfraModuleTesting that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_infra_module_testing harness_platform_infra_module_testing} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options PlatformInfraModuleTestingConfig
  */
  public constructor(scope: Construct, id: string, config: PlatformInfraModuleTestingConfig) {
    super(scope, id, {
  ...
  private _testingMetadata = new PlatformInfraModuleTestingTestingMetadataOutputReference(this, "testing_metadata");
  public get testingMetadata() {
    return this._testingMetadata;
  }
  public putTestingMetadata(value: PlatformInfraModuleTestingTestingMetadata) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      testing_metadata: platformInfraModuleTestingTestingMetadataToTerraform(this._testingMetadata.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      testing_metadata: {
        value: platformInfraModuleTestingTestingMetadataToHclTerraform(this._testingMetadata.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "PlatformInfraModuleTestingTestingMetadataList",
      },
    };
