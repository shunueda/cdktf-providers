// https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_iacm_default_pipeline
...
export interface PlatformIacmDefaultPipelineConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_iacm_default_pipeline#id PlatformIacmDefaultPipeline#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_iacm_default_pipeline#operation PlatformIacmDefaultPipeline#operation}
  */
  readonly operation: string;
  /**
  * Organization identifier of the organization the default pipelines resides in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_iacm_default_pipeline#org_id PlatformIacmDefaultPipeline#org_id}
  */
  readonly orgId: string;
  /**
  * The pipeline associated with this default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_iacm_default_pipeline#pipeline PlatformIacmDefaultPipeline#pipeline}
  */
  readonly pipeline: string;
  /**
  * Project identifier of the project the default pipelines resides in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_iacm_default_pipeline#project_id PlatformIacmDefaultPipeline#project_id}
  */
  readonly projectId: string;
  /**
  * The provisioner associated with this default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_iacm_default_pipeline#provisioner_type PlatformIacmDefaultPipeline#provisioner_type}
  */
  readonly provisionerType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_iacm_default_pipeline harness_platform_iacm_default_pipeline}
*/
export class PlatformIacmDefaultPipeline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformIacmDefaultPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_iacm_default_pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_iacm_default_pipeline harness_platform_iacm_default_pipeline} Resource
  *
  * @param scope The scope in which to define this construct
