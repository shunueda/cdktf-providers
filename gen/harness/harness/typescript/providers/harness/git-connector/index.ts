// https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector
...
export interface GitConnectorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#branch GitConnector#branch}
  */
  readonly branch?: string;
  /**
  * Delegate selectors to apply to this git connector.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#delegate_selectors GitConnector#delegate_selectors}
  */
  readonly delegateSelectors?: string[];
  /**
  * Boolean indicating whether or not to generate a webhook url.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#generate_webhook_url GitConnector#generate_webhook_url}
  */
  readonly generateWebhookUrl?: boolean | cdktf.IResolvable;
  /**
  * Name of the git connector.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#name GitConnector#name}
  */
  readonly name: string;
  /**
  * The id of the secret for connecting to the git repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#password_secret_id GitConnector#password_secret_id}
  */
  readonly passwordSecretId?: string;
  /**
  * The id of the SSH secret to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#ssh_setting_id GitConnector#ssh_setting_id}
  */
  readonly sshSettingId?: string;
  /**
  * The URL of the git repository or account/organization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#url GitConnector#url}
  */
  readonly url: string;
  /**
  * The type of git url being used. Options are `ACCOUNT`, and `REPO.`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#url_type GitConnector#url_type}
  */
  readonly urlType: string;
  /**
  * The name of the user used to connect to the git repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#username GitConnector#username}
  */
  readonly username?: string;
  /**
  * commit_details block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#commit_details GitConnector#commit_details}
  */
  readonly commitDetails?: GitConnectorCommitDetails;
  /**
  * usage_scope block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#usage_scope GitConnector#usage_scope}
  */
...
export interface GitConnectorCommitDetails {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#author_email_id GitConnector#author_email_id}
  */
  readonly authorEmailId?: string;
  /**
  * The name of the author
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#author_name GitConnector#author_name}
  */
  readonly authorName?: string;
  /**
  * Commit message
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#message GitConnector#message}
  */
...
export interface GitConnectorUsageScope {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#application_id GitConnector#application_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#environment_filter_type GitConnector#environment_filter_type}
  */
  readonly environmentFilterType?: string;
  /**
  * Id of the id of the specific environment to scope to. Cannot be used with `environment_filter_type`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#environment_id GitConnector#environment_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector harness_git_connector}
*/
export class GitConnector extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GitConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/git_connector harness_git_connector} Resource
  *
  * @param scope The scope in which to define this construct
