// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_infra_modules
...
export interface DataHarnessPlatformInfraModulesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_infra_modules#id DataHarnessPlatformInfraModules#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_infra_modules harness_platform_infra_modules}
*/
export class DataHarnessPlatformInfraModules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarnessPlatformInfraModules that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_infra_modules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_infra_modules harness_platform_infra_modules} Data Source
  *
  * @param scope The scope in which to define this construct
