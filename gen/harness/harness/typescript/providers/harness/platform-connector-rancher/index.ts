// https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher
...
export interface PlatformConnectorRancherConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher#delegate_selectors PlatformConnectorRancher#delegate_selectors}
  */
  readonly delegateSelectors?: string[];
  /**
  * Description of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher#description PlatformConnectorRancher#description}
  */
  readonly description?: string;
  /**
  * Enable this flag for force deletion of connector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher#force_delete PlatformConnectorRancher#force_delete}
  */
  readonly forceDelete?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher#id PlatformConnectorRancher#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher#identifier PlatformConnectorRancher#identifier}
  */
  readonly identifier: string;
  /**
  * Name of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher#name PlatformConnectorRancher#name}
  */
  readonly name: string;
  /**
  * Unique identifier of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher#org_id PlatformConnectorRancher#org_id}
  */
  readonly orgId?: string;
  /**
  * Unique identifier of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher#project_id PlatformConnectorRancher#project_id}
  */
  readonly projectId?: string;
  /**
  * The URL of the Rancher cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher#rancher_url PlatformConnectorRancher#rancher_url}
  */
  readonly rancherUrl: string;
  /**
  * Tags to associate with the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher#tags PlatformConnectorRancher#tags}
  */
  readonly tags?: string[];
  /**
  * bearer_token block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher#bearer_token PlatformConnectorRancher#bearer_token}
  */
...
export interface PlatformConnectorRancherBearerToken {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher#bearer_token_ref PlatformConnectorRancher#bearer_token_ref}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher harness_platform_connector_rancher}
*/
export class PlatformConnectorRancher extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformConnectorRancher that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_connector_rancher harness_platform_connector_rancher} Resource
  *
  * @param scope The scope in which to define this construct
