// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy
...
export interface PlatformPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#description PlatformPolicy#description}
  */
  readonly description?: string;
  /**
  * Base branch for the new git branch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#git_base_branch PlatformPolicy#git_base_branch}
  */
  readonly gitBaseBranch?: string;
  /**
  * Git branch for the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#git_branch PlatformPolicy#git_branch}
  */
  readonly gitBranch?: string;
  /**
  * Git commit message for the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#git_commit_msg PlatformPolicy#git_commit_msg}
  */
  readonly gitCommitMsg?: string;
  /**
  * The existing commit sha of the file being updated
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#git_commit_sha PlatformPolicy#git_commit_sha}
  */
  readonly gitCommitSha?: string;
  /**
  * Git connector reference for the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#git_connector_ref PlatformPolicy#git_connector_ref}
  */
  readonly gitConnectorRef?: string;
  /**
  * The existing file id of the file being updated, not required for bitbucket files
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#git_file_id PlatformPolicy#git_file_id}
  */
  readonly gitFileId?: string;
  /**
  * Flag to import the policy from git.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#git_import PlatformPolicy#git_import}
  */
  readonly gitImport?: boolean | cdktf.IResolvable;
  /**
  * Flag to create a new branch for the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#git_is_new_branch PlatformPolicy#git_is_new_branch}
  */
  readonly gitIsNewBranch?: boolean | cdktf.IResolvable;
  /**
  * Git path for the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#git_path PlatformPolicy#git_path}
  */
  readonly gitPath?: string;
  /**
  * Git repository for the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#git_repo PlatformPolicy#git_repo}
  */
  readonly gitRepo?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#id PlatformPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#identifier PlatformPolicy#identifier}
  */
  readonly identifier: string;
  /**
  * Name of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#name PlatformPolicy#name}
  */
  readonly name: string;
  /**
  * Unique identifier of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#org_id PlatformPolicy#org_id}
  */
  readonly orgId?: string;
  /**
  * Unique identifier of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#project_id PlatformPolicy#project_id}
  */
  readonly projectId?: string;
  /**
  * Rego code for the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#rego PlatformPolicy#rego}
  */
  readonly rego: string;
  /**
  * Tags to associate with the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#tags PlatformPolicy#tags}
  */
  readonly tags?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy harness_platform_policy}
*/
export class PlatformPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_policy harness_platform_policy} Resource
  *
  * @param scope The scope in which to define this construct
