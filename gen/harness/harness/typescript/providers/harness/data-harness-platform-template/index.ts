// https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template
...
export interface DataHarnessPlatformTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#branch_name DataHarnessPlatformTemplate#branch_name}
  */
  readonly branchName?: string;
  /**
  * Defines child template type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#child_type DataHarnessPlatformTemplate#child_type}
  */
  readonly childType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#id DataHarnessPlatformTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#identifier DataHarnessPlatformTemplate#identifier}
  */
  readonly identifier?: string;
  /**
  * True if given version for template to be set as stable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#is_stable DataHarnessPlatformTemplate#is_stable}
  */
  readonly isStable?: boolean | cdktf.IResolvable;
  /**
  * Name of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#name DataHarnessPlatformTemplate#name}
  */
  readonly name?: string;
  /**
  * Unique identifier of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#org_id DataHarnessPlatformTemplate#org_id}
  */
  readonly orgId?: string;
  /**
  * Unique identifier of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#project_id DataHarnessPlatformTemplate#project_id}
  */
  readonly projectId?: string;
  /**
  * Scope of template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#scope DataHarnessPlatformTemplate#scope}
  */
  readonly scope?: string;
  /**
  * Version Label for Template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#version DataHarnessPlatformTemplate#version}
  */
  readonly version?: string;
  /**
  * git_details block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#git_details DataHarnessPlatformTemplate#git_details}
  */
...
export interface DataHarnessPlatformTemplateGitDetails {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#file_path DataHarnessPlatformTemplate#file_path}
  */
  readonly filePath?: string;
  /**
  * File url of the Entity in the repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#file_url DataHarnessPlatformTemplate#file_url}
  */
  readonly fileUrl?: string;
  /**
  * Last commit identifier (for Git Repositories other than Github). To be provided only when updating Pipeline.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#last_commit_id DataHarnessPlatformTemplate#last_commit_id}
  */
  readonly lastCommitId?: string;
  /**
  * Last object identifier (for Github). To be provided only when updating Pipeline.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#last_object_id DataHarnessPlatformTemplate#last_object_id}
  */
  readonly lastObjectId?: string;
  /**
  * Name of the repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#repo_name DataHarnessPlatformTemplate#repo_name}
  */
  readonly repoName?: string;
  /**
  * Repo url of the Entity in the repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#repo_url DataHarnessPlatformTemplate#repo_url}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template harness_platform_template}
*/
export class DataHarnessPlatformTemplate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarnessPlatformTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/platform_template harness_platform_template} Data Source
  *
  * @param scope The scope in which to define this construct
