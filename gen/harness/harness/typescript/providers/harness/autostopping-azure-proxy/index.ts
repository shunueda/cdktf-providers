// https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy
...
export interface AutostoppingAzureProxyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#allocate_static_ip AutostoppingAzureProxy#allocate_static_ip}
  */
  readonly allocateStaticIp?: boolean | cdktf.IResolvable;
  /**
  * Harness NG API key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#api_key AutostoppingAzureProxy#api_key}
  */
  readonly apiKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#certificate_id AutostoppingAzureProxy#certificate_id}
  */
  readonly certificateId?: string;
  /**
  * Id of the cloud connector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#cloud_connector_id AutostoppingAzureProxy#cloud_connector_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#delete_cloud_resources_on_destroy AutostoppingAzureProxy#delete_cloud_resources_on_destroy}
  */
  readonly deleteCloudResourcesOnDestroy: boolean | cdktf.IResolvable;
  /**
  * Hostname for the proxy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#host_name AutostoppingAzureProxy#host_name}
  */
  readonly hostName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#id AutostoppingAzureProxy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#keypair AutostoppingAzureProxy#keypair}
  */
  readonly keypair: string;
  /**
  * Type of instance to be used for proxy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#machine_type AutostoppingAzureProxy#machine_type}
  */
  readonly machineType: string;
  /**
  * Name of the proxy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#name AutostoppingAzureProxy#name}
  */
  readonly name: string;
  /**
  * Region in which cloud resources are hosted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#region AutostoppingAzureProxy#region}
  */
  readonly region: string;
  /**
  * Resource group in which cloud resources are hosted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#resource_group AutostoppingAzureProxy#resource_group}
  */
  readonly resourceGroup: string;
  /**
  * Security Group to define the security rules that determine the inbound and outbound traffic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#security_groups AutostoppingAzureProxy#security_groups}
  */
  readonly securityGroups?: string[];
  /**
  * Subnet in which cloud resources are hosted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#subnet_id AutostoppingAzureProxy#subnet_id}
  */
  readonly subnetId: string;
  /**
  * VPC in which cloud resources are hosted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#vpc AutostoppingAzureProxy#vpc}
  */
  readonly vpc: string;
  /**
  * certificates block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#certificates AutostoppingAzureProxy#certificates}
  */
...
export interface AutostoppingAzureProxyCertificates {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#cert_secret_id AutostoppingAzureProxy#cert_secret_id}
  */
  readonly certSecretId: string;
  /**
  * ID of certificate key uploaded to vault
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#key_secret_id AutostoppingAzureProxy#key_secret_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy harness_autostopping_azure_proxy}
*/
export class AutostoppingAzureProxy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutostoppingAzureProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/autostopping_azure_proxy harness_autostopping_azure_proxy} Resource
  *
  * @param scope The scope in which to define this construct
