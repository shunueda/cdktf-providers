// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_input_set
...
export interface DataHarnessPlatformInputSetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_input_set#id DataHarnessPlatformInputSet#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_input_set#identifier DataHarnessPlatformInputSet#identifier}
  */
  readonly identifier?: string;
  /**
  * Name of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_input_set#name DataHarnessPlatformInputSet#name}
  */
  readonly name?: string;
  /**
  * Unique identifier of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_input_set#org_id DataHarnessPlatformInputSet#org_id}
  */
  readonly orgId: string;
  /**
  * Identifier of the pipeline
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_input_set#pipeline_id DataHarnessPlatformInputSet#pipeline_id}
  */
  readonly pipelineId: string;
  /**
  * Unique identifier of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_input_set#project_id DataHarnessPlatformInputSet#project_id}
  */
  readonly projectId: string;
  /**
  * git_details block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_input_set#git_details DataHarnessPlatformInputSet#git_details}
  */
...
export interface DataHarnessPlatformInputSetGitDetails {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_input_set#base_branch DataHarnessPlatformInputSet#base_branch}
  */
  readonly baseBranch?: string;
  /**
  * Last commit identifier (for Git Repositories other than Github). To be provided only when updating Pipeline.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_input_set#last_commit_id DataHarnessPlatformInputSet#last_commit_id}
  */
  readonly lastCommitId?: string;
  /**
  * Last object identifier (for Github). To be provided only when updating Pipeline.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_input_set#last_object_id DataHarnessPlatformInputSet#last_object_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_input_set harness_platform_input_set}
*/
export class DataHarnessPlatformInputSet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarnessPlatformInputSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_input_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_input_set harness_platform_input_set} Data Source
  *
  * @param scope The scope in which to define this construct
