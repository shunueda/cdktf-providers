// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_tanzu
...
export interface CloudproviderTanzuConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_tanzu#endpoint CloudproviderTanzu#endpoint}
  */
  readonly endpoint: string;
  /**
  * The name of the cloud provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_tanzu#name CloudproviderTanzu#name}
  */
  readonly name: string;
  /**
  * The name of the Harness secret containing the password to use to authenticate to Tanzu.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_tanzu#password_secret_name CloudproviderTanzu#password_secret_name}
  */
  readonly passwordSecretName: string;
  /**
  * Skip validation of Tanzu configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_tanzu#skip_validation CloudproviderTanzu#skip_validation}
  */
  readonly skipValidation?: boolean | cdktf.IResolvable;
  /**
  * The username to use to authenticate to Tanzu.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_tanzu#username CloudproviderTanzu#username}
  */
  readonly username?: string;
  /**
  * The name of the Harness secret containing the username to authenticate to Tanzu with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_tanzu#username_secret_name CloudproviderTanzu#username_secret_name}
  */
  readonly usernameSecretName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_tanzu harness_cloudprovider_tanzu}
*/
export class CloudproviderTanzu extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudproviderTanzu that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_tanzu#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_tanzu harness_cloudprovider_tanzu} Resource
  *
  * @param scope The scope in which to define this construct
