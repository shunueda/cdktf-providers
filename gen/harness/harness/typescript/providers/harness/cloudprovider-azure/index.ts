// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_azure
...
export interface CloudproviderAzureConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_azure#client_id CloudproviderAzure#client_id}
  */
  readonly clientId: string;
  /**
  * The type of environment. Valid options are [AZURE AZURE_US_GOVERNMENT]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_azure#environment_type CloudproviderAzure#environment_type}
  */
  readonly environmentType?: string;
  /**
  * The Name of the Harness secret containing the key for the Azure application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_azure#key CloudproviderAzure#key}
  */
  readonly key: string;
  /**
  * The name of the cloud provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_azure#name CloudproviderAzure#name}
  */
  readonly name: string;
  /**
  * The tenant id for the Azure application
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_azure#tenant_id CloudproviderAzure#tenant_id}
  */
  readonly tenantId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_azure harness_cloudprovider_azure}
*/
export class CloudproviderAzure extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudproviderAzure that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_azure#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_azure harness_cloudprovider_azure} Resource
  *
  * @param scope The scope in which to define this construct
