// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token
...
export interface DataHarnessPlatformTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#account_id DataHarnessPlatformToken#account_id}
  */
  readonly accountId: string;
  /**
  * Identifier of the API Key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#apikey_id DataHarnessPlatformToken#apikey_id}
  */
  readonly apikeyId: string;
  /**
  * Type of the API Key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#apikey_type DataHarnessPlatformToken#apikey_type}
  */
  readonly apikeyType: string;
  /**
  * Email Id of the user who created the Token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#email DataHarnessPlatformToken#email}
  */
  readonly email?: string;
  /**
  * Encoded password of the Token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#encoded_password DataHarnessPlatformToken#encoded_password}
  */
  readonly encodedPassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#id DataHarnessPlatformToken#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#identifier DataHarnessPlatformToken#identifier}
  */
  readonly identifier: string;
  /**
  * Name of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#name DataHarnessPlatformToken#name}
  */
  readonly name?: string;
  /**
  * Unique identifier of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#org_id DataHarnessPlatformToken#org_id}
  */
  readonly orgId?: string;
  /**
  * Parent Entity Identifier of the API Key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#parent_id DataHarnessPlatformToken#parent_id}
  */
  readonly parentId: string;
  /**
  * Unique identifier of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#project_id DataHarnessPlatformToken#project_id}
  */
  readonly projectId?: string;
  /**
  * Scheduled expiry time in milliseconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#scheduled_expire_time DataHarnessPlatformToken#scheduled_expire_time}
  */
  readonly scheduledExpireTime?: number;
  /**
  * Name of the user who created the Token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#username DataHarnessPlatformToken#username}
  */
  readonly username?: string;
  /**
  * Boolean value to indicate if Token is valid or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#valid DataHarnessPlatformToken#valid}
  */
  readonly valid?: boolean | cdktf.IResolvable;
  /**
  * This is the time from which the Token is valid. The time is in milliseconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#valid_from DataHarnessPlatformToken#valid_from}
  */
  readonly validFrom?: number;
  /**
  * This is the time till which the Token is valid. The time is in milliseconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#valid_to DataHarnessPlatformToken#valid_to}
  */
  readonly validTo?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token harness_platform_token}
*/
export class DataHarnessPlatformToken extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarnessPlatformToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_token harness_platform_token} Data Source
  *
  * @param scope The scope in which to define this construct
