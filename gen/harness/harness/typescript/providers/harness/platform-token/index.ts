// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token
...
export interface PlatformTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#account_id PlatformToken#account_id}
  */
  readonly accountId: string;
  /**
  * Identifier of the API Key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#apikey_id PlatformToken#apikey_id}
  */
  readonly apikeyId: string;
  /**
  * Type of the API Key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#apikey_type PlatformToken#apikey_type}
  */
  readonly apikeyType: string;
  /**
  * Description of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#description PlatformToken#description}
  */
  readonly description?: string;
  /**
  * Email Id of the user who created the Token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#email PlatformToken#email}
  */
  readonly email?: string;
  /**
  * Encoded password of the Token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#encoded_password PlatformToken#encoded_password}
  */
  readonly encodedPassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#id PlatformToken#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#identifier PlatformToken#identifier}
  */
  readonly identifier: string;
  /**
  * Name of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#name PlatformToken#name}
  */
  readonly name: string;
  /**
  * Unique identifier of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#org_id PlatformToken#org_id}
  */
  readonly orgId?: string;
  /**
  * Parent Entity Identifier of the API Key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#parent_id PlatformToken#parent_id}
  */
  readonly parentId: string;
  /**
  * Unique identifier of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#project_id PlatformToken#project_id}
  */
  readonly projectId?: string;
  /**
  * Scheduled expiry time in milliseconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#scheduled_expire_time PlatformToken#scheduled_expire_time}
  */
  readonly scheduledExpireTime?: number;
  /**
  * Tags to associate with the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#tags PlatformToken#tags}
  */
  readonly tags?: string[];
  /**
  * Name of the user who created the Token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#username PlatformToken#username}
  */
  readonly username?: string;
  /**
  * Boolean value to indicate if Token is valid or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#valid PlatformToken#valid}
  */
  readonly valid?: boolean | cdktf.IResolvable;
  /**
  * This is the time from which the Token is valid. The time is in milliseconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#valid_from PlatformToken#valid_from}
  */
  readonly validFrom?: number;
  /**
  * This is the time till which the Token is valid. The time is in milliseconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#valid_to PlatformToken#valid_to}
  */
  readonly validTo?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token harness_platform_token}
*/
export class PlatformToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_token harness_platform_token} Resource
  *
  * @param scope The scope in which to define this construct
