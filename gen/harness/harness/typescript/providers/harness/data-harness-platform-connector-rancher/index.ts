// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_connector_rancher
...
export interface DataHarnessPlatformConnectorRancherConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_connector_rancher#id DataHarnessPlatformConnectorRancher#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_connector_rancher#identifier DataHarnessPlatformConnectorRancher#identifier}
  */
  readonly identifier: string;
  /**
  * Name of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_connector_rancher#name DataHarnessPlatformConnectorRancher#name}
  */
  readonly name?: string;
  /**
  * Unique identifier of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_connector_rancher#org_id DataHarnessPlatformConnectorRancher#org_id}
  */
  readonly orgId?: string;
  /**
  * Unique identifier of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_connector_rancher#project_id DataHarnessPlatformConnectorRancher#project_id}
  */
  readonly projectId?: string;
  /**
  * bearer_token block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_connector_rancher#bearer_token DataHarnessPlatformConnectorRancher#bearer_token}
  */
...
export interface DataHarnessPlatformConnectorRancherBearerToken {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_connector_rancher#password_ref DataHarnessPlatformConnectorRancher#password_ref}
  */
  readonly passwordRef: string;
  /**
  * The URL of the Rancher cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_connector_rancher#rancher_url DataHarnessPlatformConnectorRancher#rancher_url}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_connector_rancher harness_platform_connector_rancher}
*/
export class DataHarnessPlatformConnectorRancher extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarnessPlatformConnectorRancher that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_connector_rancher#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/data-sources/platform_connector_rancher harness_platform_connector_rancher} Data Source
  *
  * @param scope The scope in which to define this construct
