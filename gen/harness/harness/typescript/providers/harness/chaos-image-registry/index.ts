// https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry
...
export interface ChaosImageRegistryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#id ChaosImageRegistry#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#infra_id ChaosImageRegistry#infra_id}
  */
  readonly infraId?: string;
  /**
  * Whether this is the default registry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#is_default ChaosImageRegistry#is_default}
  */
  readonly isDefault?: boolean | cdktf.IResolvable;
  /**
  * Whether override is allowed for this registry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#is_override_allowed ChaosImageRegistry#is_override_allowed}
  */
  readonly isOverrideAllowed?: boolean | cdktf.IResolvable;
  /**
  * Whether the registry is private
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#is_private ChaosImageRegistry#is_private}
  */
  readonly isPrivate: boolean | cdktf.IResolvable;
  /**
  * The organization ID of the image registry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#org_id ChaosImageRegistry#org_id}
  */
  readonly orgId?: string;
  /**
  * The project ID of the image registry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#project_id ChaosImageRegistry#project_id}
  */
  readonly projectId?: string;
  /**
  * The registry account name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#registry_account ChaosImageRegistry#registry_account}
  */
  readonly registryAccount: string;
  /**
  * The registry server URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#registry_server ChaosImageRegistry#registry_server}
  */
  readonly registryServer: string;
  /**
  * The name of the secret for authentication
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#secret_name ChaosImageRegistry#secret_name}
  */
  readonly secretName?: string;
  /**
  * Whether to use custom images
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#use_custom_images ChaosImageRegistry#use_custom_images}
  */
  readonly useCustomImages?: boolean | cdktf.IResolvable;
  /**
  * custom_images block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#custom_images ChaosImageRegistry#custom_images}
  */
  readonly customImages?: ChaosImageRegistryCustomImages[] | cdktf.IResolvable;
}
export interface ChaosImageRegistryCustomImages {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#ddcr ChaosImageRegistry#ddcr}
  */
  readonly ddcr?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#ddcr_fault ChaosImageRegistry#ddcr_fault}
  */
  readonly ddcrFault?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#ddcr_lib ChaosImageRegistry#ddcr_lib}
  */
  readonly ddcrLib?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#log_watcher ChaosImageRegistry#log_watcher}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry harness_chaos_image_registry}
*/
export class ChaosImageRegistry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChaosImageRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/chaos_image_registry harness_chaos_image_registry} Resource
  *
  * @param scope The scope in which to define this construct
