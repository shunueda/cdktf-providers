// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws
...
export interface CloudproviderAwsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#access_key_id CloudproviderAws#access_key_id}
  */
  readonly accessKeyId?: string;
  /**
  * The name of the Harness secret containing the AWS access key id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#access_key_id_secret_name CloudproviderAws#access_key_id_secret_name}
  */
  readonly accessKeyIdSecretName?: string;
  /**
  * Select the Delegate to use via one of its Selectors.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#delegate_selector CloudproviderAws#delegate_selector}
  */
  readonly delegateSelector?: string;
  /**
  * The name of the cloud provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#name CloudproviderAws#name}
  */
  readonly name: string;
  /**
  * The name of the Harness secret containing the AWS secret access key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#secret_access_key_secret_name CloudproviderAws#secret_access_key_secret_name}
  */
  readonly secretAccessKeySecretName?: string;
  /**
  * Use the EC2 Instance Profile for Service Accounts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#use_ec2_iam_credentials CloudproviderAws#use_ec2_iam_credentials}
  */
  readonly useEc2IamCredentials?: boolean | cdktf.IResolvable;
  /**
  * Use the AWS IAM Role for Service Accounts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#use_irsa CloudproviderAws#use_irsa}
  */
  readonly useIrsa?: boolean | cdktf.IResolvable;
  /**
  * assume_cross_account_role block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#assume_cross_account_role CloudproviderAws#assume_cross_account_role}
  */
  readonly assumeCrossAccountRole?: CloudproviderAwsAssumeCrossAccountRole;
  /**
  * usage_scope block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#usage_scope CloudproviderAws#usage_scope}
  */
...
export interface CloudproviderAwsAssumeCrossAccountRole {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#external_id CloudproviderAws#external_id}
  */
  readonly externalId?: string;
  /**
  * This is an IAM role in the target deployment AWS account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#role_arn CloudproviderAws#role_arn}
  */
...
export interface CloudproviderAwsUsageScope {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#application_id CloudproviderAws#application_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#environment_filter_type CloudproviderAws#environment_filter_type}
  */
  readonly environmentFilterType?: string;
  /**
  * Id of the id of the specific environment to scope to. Cannot be used with `environment_filter_type`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#environment_id CloudproviderAws#environment_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws harness_cloudprovider_aws}
*/
export class CloudproviderAws extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudproviderAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/cloudprovider_aws harness_cloudprovider_aws} Resource
  *
  * @param scope The scope in which to define this construct
