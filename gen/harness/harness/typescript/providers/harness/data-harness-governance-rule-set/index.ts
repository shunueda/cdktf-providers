// https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/governance_rule_set
...
export interface DataHarnessGovernanceRuleSetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/governance_rule_set#id DataHarnessGovernanceRuleSet#id}
  *
  ...
  * Id of rule set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/governance_rule_set#rule_set_id DataHarnessGovernanceRuleSet#rule_set_id}
  */
  readonly ruleSetId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/governance_rule_set harness_governance_rule_set}
*/
export class DataHarnessGovernanceRuleSet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarnessGovernanceRuleSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/governance_rule_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/governance_rule_set harness_governance_rule_set} Data Source
  *
  * @param scope The scope in which to define this construct
