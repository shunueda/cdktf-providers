// https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_template_filters
...
export interface PlatformTemplateFiltersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_template_filters#filter_visibility PlatformTemplateFilters#filter_visibility}
  */
  readonly filterVisibility?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_template_filters#id PlatformTemplateFilters#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_template_filters#identifier PlatformTemplateFilters#identifier}
  */
  readonly identifier: string;
  /**
  * Name of the template filters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_template_filters#name PlatformTemplateFilters#name}
  */
  readonly name: string;
  /**
  * Organization Identifier for the Entity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_template_filters#org_id PlatformTemplateFilters#org_id}
  */
  readonly orgId?: string;
  /**
  * Project Identifier for the Entity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_template_filters#project_id PlatformTemplateFilters#project_id}
  */
  readonly projectId?: string;
  /**
  * Type of template filters. Currently supported types are { Template}
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_template_filters#type PlatformTemplateFilters#type}
  */
  readonly type: string;
  /**
  * filter_properties block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_template_filters#filter_properties PlatformTemplateFilters#filter_properties}
  */
...
export interface PlatformTemplateFiltersFilterProperties {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_template_filters#filter_type PlatformTemplateFilters#filter_type}
  */
  readonly filterType: string;
  /**
  * Tags to associate with the resource. Tags should be in the form `name:value`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_template_filters#tags PlatformTemplateFilters#tags}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_template_filters harness_platform_template_filters}
*/
export class PlatformTemplateFilters extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformTemplateFilters that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_template_filters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_template_filters harness_platform_template_filters} Resource
  *
  * @param scope The scope in which to define this construct
