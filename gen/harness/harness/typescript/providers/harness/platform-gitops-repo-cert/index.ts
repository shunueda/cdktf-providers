// https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert
...
export interface PlatformGitopsRepoCertConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#account_id PlatformGitopsRepoCert#account_id}
  */
  readonly accountId?: string;
  /**
  * Agent identifier of the GitOps repository certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#agent_id PlatformGitopsRepoCert#agent_id}
  */
  readonly agentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#id PlatformGitopsRepoCert#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#org_id PlatformGitopsRepoCert#org_id}
  */
  readonly orgId?: string;
  /**
  * Project identifier of the GitOps repository certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#project_id PlatformGitopsRepoCert#project_id}
  */
  readonly projectId?: string;
  /**
  * request block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#request PlatformGitopsRepoCert#request}
  */
...
export interface PlatformGitopsRepoCertRequestCertificatesItems {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#cert_data PlatformGitopsRepoCert#cert_data}
  */
  readonly certData?: string;
  /**
  * CertInfo will hold additional certificate info, dependent on the certificate type .
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#cert_info PlatformGitopsRepoCert#cert_info}
  */
  readonly certInfo?: string;
  /**
  * CertSubType specifies the sub type of the cert, i.e. ssh-rsa.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#cert_sub_type PlatformGitopsRepoCert#cert_sub_type}
  */
  readonly certSubType?: string;
  /**
  * CertType specifies the type of the certificate - currently one of https or ssh.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#cert_type PlatformGitopsRepoCert#cert_type}
  */
  readonly certType?: string;
  /**
  * ServerName specifies the DNS name of the server this certificate is intended.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#server_name PlatformGitopsRepoCert#server_name}
  */
...
export interface PlatformGitopsRepoCertRequestCertificatesMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#continue PlatformGitopsRepoCert#continue}
  */
  readonly continue?: string;
  /**
  * subsequent items in the list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#remaining_item_count PlatformGitopsRepoCert#remaining_item_count}
  */
  readonly remainingItemCount?: string;
  /**
  * Identifies the server's internal version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#resource_version PlatformGitopsRepoCert#resource_version}
  */
  readonly resourceVersion?: string;
  /**
  * selfLink is a URL representing this object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#self_link PlatformGitopsRepoCert#self_link}
  */
...
export interface PlatformGitopsRepoCertRequestCertificates {
  ...
  * items block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#items PlatformGitopsRepoCert#items}
  */
  readonly items?: PlatformGitopsRepoCertRequestCertificatesItems[] | cdktf.IResolvable;
  /**
  * metadata block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#metadata PlatformGitopsRepoCert#metadata}
  */
...
export interface PlatformGitopsRepoCertRequest {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#upsert PlatformGitopsRepoCert#upsert}
  */
  readonly upsert?: boolean | cdktf.IResolvable;
  /**
  * certificates block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#certificates PlatformGitopsRepoCert#certificates}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert harness_platform_gitops_repo_cert}
*/
export class PlatformGitopsRepoCert extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformGitopsRepoCert that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.4/docs/resources/platform_gitops_repo_cert harness_platform_gitops_repo_cert} Resource
  *
  * @param scope The scope in which to define this construct
