// https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy
...
export interface AutostoppingAwsProxyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Boolean value to indicate if proxy vm needs to have static IP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#allocate_static_ip AutostoppingAwsProxy#allocate_static_ip}
  */
  readonly allocateStaticIp?: boolean | cdktf.IResolvable;
  /**
  * Harness NG API key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#api_key AutostoppingAwsProxy#api_key}
  */
  readonly apiKey: string;
  /**
  * Id of the cloud connector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#cloud_connector_id AutostoppingAwsProxy#cloud_connector_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#delete_cloud_resources_on_destroy AutostoppingAwsProxy#delete_cloud_resources_on_destroy}
  */
  readonly deleteCloudResourcesOnDestroy: boolean | cdktf.IResolvable;
  /**
  * Hostname for the proxy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#host_name AutostoppingAwsProxy#host_name}
  */
  readonly hostName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#id AutostoppingAwsProxy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#keypair AutostoppingAwsProxy#keypair}
  */
  readonly keypair?: string;
  /**
  * Machine instance type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#machine_type AutostoppingAwsProxy#machine_type}
  */
  readonly machineType: string;
  /**
  * Name of the proxy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#name AutostoppingAwsProxy#name}
  */
  readonly name: string;
  /**
  * Region in which cloud resources are hosted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#region AutostoppingAwsProxy#region}
  */
  readonly region: string;
  /**
  * Route 53 hosted zone id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#route53_hosted_zone_id AutostoppingAwsProxy#route53_hosted_zone_id}
  */
  readonly route53HostedZoneId?: string;
  /**
  * Security Group to define the security rules that determine the inbound and outbound traffic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#security_groups AutostoppingAwsProxy#security_groups}
  */
  readonly securityGroups?: string[];
  /**
  * VPC in which cloud resources are hosted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#vpc AutostoppingAwsProxy#vpc}
  */
  readonly vpc: string;
  /**
  * certificates block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#certificates AutostoppingAwsProxy#certificates}
  */
...
export interface AutostoppingAwsProxyCertificates {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#cert_secret_id AutostoppingAwsProxy#cert_secret_id}
  */
  readonly certSecretId: string;
  /**
  * Private key secret ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#key_secret_id AutostoppingAwsProxy#key_secret_id}
  */
  readonly keySecretId: string;
}

export function autostoppingAwsProxyCertificatesToTerraform(struct?: AutostoppingAwsProxyCertificatesOutputReference | AutostoppingAwsProxyCertificates): any {
...
export function autostoppingAwsProxyCertificatesToHclTerraform(struct?: AutostoppingAwsProxyCertificatesOutputReference | AutostoppingAwsProxyCertificates): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AutostoppingAwsProxyCertificatesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AutostoppingAwsProxyCertificates | undefined {
  ...
  public set internalValue(value: AutostoppingAwsProxyCertificates | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy harness_autostopping_aws_proxy}
*/
export class AutostoppingAwsProxy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutostoppingAwsProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/autostopping_aws_proxy harness_autostopping_aws_proxy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AutostoppingAwsProxyConfig
  */
  public constructor(scope: Construct, id: string, config: AutostoppingAwsProxyConfig) {
    super(scope, id, {
  ...
  private _certificates = new AutostoppingAwsProxyCertificatesOutputReference(this, "certificates");
  public get certificates() {
    return this._certificates;
  }
  public putCertificates(value: AutostoppingAwsProxyCertificates) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      certificates: autostoppingAwsProxyCertificatesToTerraform(this._certificates.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      certificates: {
        value: autostoppingAwsProxyCertificatesToHclTerraform(this._certificates.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AutostoppingAwsProxyCertificatesList",
      },
    };
