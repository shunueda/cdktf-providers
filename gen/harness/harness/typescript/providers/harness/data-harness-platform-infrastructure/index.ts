// https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure
...
export interface DataHarnessPlatformInfrastructureConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure#env_id DataHarnessPlatformInfrastructure#env_id}
  */
  readonly envId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure#id DataHarnessPlatformInfrastructure#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure#identifier DataHarnessPlatformInfrastructure#identifier}
  */
  readonly identifier: string;
  /**
  * Name of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure#name DataHarnessPlatformInfrastructure#name}
  */
  readonly name?: string;
  /**
  * Unique identifier of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure#org_id DataHarnessPlatformInfrastructure#org_id}
  */
  readonly orgId?: string;
  /**
  * Unique identifier of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure#project_id DataHarnessPlatformInfrastructure#project_id}
  */
  readonly projectId?: string;
  /**
  * git_details block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure#git_details DataHarnessPlatformInfrastructure#git_details}
  */
...
export interface DataHarnessPlatformInfrastructureGitDetails {
  ...
  * Name of the branch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure#branch DataHarnessPlatformInfrastructure#branch}
  */
  readonly branch?: string;
  /**
  * If the Entity is to be fetched from cache
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure#load_from_cache DataHarnessPlatformInfrastructure#load_from_cache}
  */
  readonly loadFromCache?: string;
  /**
  * Load Infrastructure yaml from fallback branch
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure#load_from_fallback_branch DataHarnessPlatformInfrastructure#load_from_fallback_branch}
  */
  readonly loadFromFallbackBranch?: boolean | cdktf.IResolvable;
  /**
  * Repo name of remote Infrastructure
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure#repo_name DataHarnessPlatformInfrastructure#repo_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure harness_platform_infrastructure}
*/
export class DataHarnessPlatformInfrastructure extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarnessPlatformInfrastructure that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/data-sources/platform_infrastructure harness_platform_infrastructure} Data Source
  *
  * @param scope The scope in which to define this construct
