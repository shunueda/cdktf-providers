// https://registry.terraform.io/providers/harness/harness/0.39.2/docs
...
export interface HarnessProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs#account_id HarnessProvider#account_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs#api_key HarnessProvider#api_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs#endpoint HarnessProvider#endpoint}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs#platform_api_key HarnessProvider#platform_api_key}
  */
  readonly platformApiKey?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs#alias HarnessProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs harness}
*/
export class HarnessProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing HarnessProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs harness} Resource
  *
  * @param scope The scope in which to define this construct
