// https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/governance_rule_enforcement
...
export interface DataHarnessGovernanceRuleEnforcementConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/governance_rule_enforcement#enforcement_id DataHarnessGovernanceRuleEnforcement#enforcement_id}
  */
  readonly enforcementId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/governance_rule_enforcement#id DataHarnessGovernanceRuleEnforcement#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/governance_rule_enforcement harness_governance_rule_enforcement}
*/
export class DataHarnessGovernanceRuleEnforcement extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarnessGovernanceRuleEnforcement that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/governance_rule_enforcement#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/data-sources/governance_rule_enforcement harness_governance_rule_enforcement} Data Source
  *
  * @param scope The scope in which to define this construct
