// https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry
...
export interface PlatformHarRegistryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Allowed artifact patterns
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#allowed_pattern PlatformHarRegistry#allowed_pattern}
  */
  readonly allowedPattern?: string[];
  /**
  * Blocked artifact patterns
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#blocked_pattern PlatformHarRegistry#blocked_pattern}
  */
  readonly blockedPattern?: string[];
  /**
  * Description of the registry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#description PlatformHarRegistry#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#id PlatformHarRegistry#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#identifier PlatformHarRegistry#identifier}
  */
  readonly identifier: string;
  /**
  * Type of package (DOCKER, HELM, MAVEN, etc.)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#package_type PlatformHarRegistry#package_type}
  */
  readonly packageType: string;
  /**
  * Parent reference for the registry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#parent_ref PlatformHarRegistry#parent_ref}
  */
  readonly parentRef?: string;
  /**
  * Space reference for the registry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#space_ref PlatformHarRegistry#space_ref}
  */
  readonly spaceRef?: string;
  /**
  * config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#config PlatformHarRegistry#config}
  */
  readonly config?: PlatformHarRegistryConfigA;
}
export interface PlatformHarRegistryConfigAuth {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#access_key PlatformHarRegistry#access_key}
  */
  readonly accessKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#access_key_identifier PlatformHarRegistry#access_key_identifier}
  */
  readonly accessKeyIdentifier?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#access_key_secret_path PlatformHarRegistry#access_key_secret_path}
  */
  readonly accessKeySecretPath?: string;
  /**
  * Type of authentication (UserPassword, Anonymous)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#auth_type PlatformHarRegistry#auth_type}
  */
  readonly authType: string;
  /**
  * Secret identifier for UserPassword auth type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#secret_identifier PlatformHarRegistry#secret_identifier}
  */
  readonly secretIdentifier?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#secret_key_identifier PlatformHarRegistry#secret_key_identifier}
  */
  readonly secretKeyIdentifier?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#secret_key_secret_path PlatformHarRegistry#secret_key_secret_path}
  */
  readonly secretKeySecretPath?: string;
  /**
  * Secret space path for UserPassword auth type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#secret_space_path PlatformHarRegistry#secret_space_path}
  */
  readonly secretSpacePath?: string;
  /**
  * User name for UserPassword auth type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#user_name PlatformHarRegistry#user_name}
  */
  readonly userName?: string;
}

export function platformHarRegistryConfigAuthToTerraform(struct?: PlatformHarRegistryConfigAuthOutputReference | PlatformHarRegistryConfigAuth): any {
...
export function platformHarRegistryConfigAuthToHclTerraform(struct?: PlatformHarRegistryConfigAuthOutputReference | PlatformHarRegistryConfigAuth): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PlatformHarRegistryConfigAuthOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PlatformHarRegistryConfigAuth | undefined {
  ...
  public set internalValue(value: PlatformHarRegistryConfigAuth | undefined) {
    if (value === undefined) {
...
export interface PlatformHarRegistryConfigA {
  /**
  ...
  * Upstream source
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#source PlatformHarRegistry#source}
  */
  readonly source?: string;
  /**
  * Type of registry (VIRTUAL or UPSTREAM)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#type PlatformHarRegistry#type}
  */
  readonly type: string;
  /**
  * List of upstream proxies for VIRTUAL registry type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#upstream_proxies PlatformHarRegistry#upstream_proxies}
  */
  readonly upstreamProxies?: string[];
  /**
  * URL of the upstream (required if type=UPSTREAM & package_type=HELM)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#url PlatformHarRegistry#url}
  */
  readonly url?: string;
  /**
  * auth block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#auth PlatformHarRegistry#auth}
  */
  readonly auth?: PlatformHarRegistryConfigAuth;
}

export function platformHarRegistryConfigAToTerraform(struct?: PlatformHarRegistryConfigAOutputReference | PlatformHarRegistryConfigA): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    auth: platformHarRegistryConfigAuthToTerraform(struct!.auth),
  }
}


export function platformHarRegistryConfigAToHclTerraform(struct?: PlatformHarRegistryConfigAOutputReference | PlatformHarRegistryConfigA): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    auth: {
      value: platformHarRegistryConfigAuthToHclTerraform(struct!.auth),
      isBlock: true,
      type: "list",
      storageClassType: "PlatformHarRegistryConfigAuthList",
    },
  };
...
export class PlatformHarRegistryConfigAOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): PlatformHarRegistryConfigA | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._authType !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: PlatformHarRegistryConfigA | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._authType = undefined;
  ...
  private _auth = new PlatformHarRegistryConfigAuthOutputReference(this, "auth");
  public get auth() {
    return this._auth;
  }
  public putAuth(value: PlatformHarRegistryConfigAuth) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry harness_platform_har_registry}
*/
export class PlatformHarRegistry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformHarRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.0/docs/resources/platform_har_registry harness_platform_har_registry} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options PlatformHarRegistryConfig
  */
  public constructor(scope: Construct, id: string, config: PlatformHarRegistryConfig) {
    super(scope, id, {
  ...
  private _config = new PlatformHarRegistryConfigAOutputReference(this, "config");
  public get config() {
    return this._config;
  }
  public putConfig(value: PlatformHarRegistryConfigA) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      config: platformHarRegistryConfigAToTerraform(this._config.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      config: {
        value: platformHarRegistryConfigAToHclTerraform(this._config.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "PlatformHarRegistryConfigAList",
      },
    };
