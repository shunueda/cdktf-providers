// https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup
...
export interface PlatformUsergroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#description PlatformUsergroup#description}
  */
  readonly description?: string;
  /**
  * Whether the user group is externally managed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#externally_managed PlatformUsergroup#externally_managed}
  */
  readonly externallyManaged?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#id PlatformUsergroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#identifier PlatformUsergroup#identifier}
  */
  readonly identifier: string;
  /**
  * Name of the linked SSO.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#linked_sso_display_name PlatformUsergroup#linked_sso_display_name}
  */
  readonly linkedSsoDisplayName?: string;
  /**
  * The SSO account ID that the user group is linked to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#linked_sso_id PlatformUsergroup#linked_sso_id}
  */
  readonly linkedSsoId?: string;
  /**
  * Type of linked SSO.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#linked_sso_type PlatformUsergroup#linked_sso_type}
  */
  readonly linkedSsoType?: string;
  /**
  * Name of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#name PlatformUsergroup#name}
  */
  readonly name: string;
  /**
  * Unique identifier of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#org_id PlatformUsergroup#org_id}
  */
  readonly orgId?: string;
  /**
  * Unique identifier of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#project_id PlatformUsergroup#project_id}
  */
  readonly projectId?: string;
  /**
  * Identifier of the userGroup in SSO.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#sso_group_id PlatformUsergroup#sso_group_id}
  */
  readonly ssoGroupId?: string;
  /**
  * Name of the SSO userGroup.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#sso_group_name PlatformUsergroup#sso_group_name}
  */
  readonly ssoGroupName?: string;
  /**
  * Whether sso is linked or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#sso_linked PlatformUsergroup#sso_linked}
  */
  readonly ssoLinked?: boolean | cdktf.IResolvable;
  /**
  * Tags to associate with the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#tags PlatformUsergroup#tags}
  */
  readonly tags?: string[];
  /**
  * List of user emails in the UserGroup. Either provide list of users or list of user emails.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#user_emails PlatformUsergroup#user_emails}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#users PlatformUsergroup#users}
  */
  readonly users?: string[];
  /**
  * notification_configs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#notification_configs PlatformUsergroup#notification_configs}
  */
...
export interface PlatformUsergroupNotificationConfigs {
  ...
  * Group email.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#group_email PlatformUsergroup#group_email}
  */
  readonly groupEmail?: string;
  /**
  * Url of Microsoft teams webhook.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#microsoft_teams_webhook_url PlatformUsergroup#microsoft_teams_webhook_url}
  */
  readonly microsoftTeamsWebhookUrl?: string;
  /**
  * Pager duty key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#pager_duty_key PlatformUsergroup#pager_duty_key}
  */
  readonly pagerDutyKey?: string;
  /**
  * Send email to all the group members.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#send_email_to_all_users PlatformUsergroup#send_email_to_all_users}
  */
  readonly sendEmailToAllUsers?: boolean | cdktf.IResolvable;
  /**
  * Url of slack webhook.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#slack_webhook_url PlatformUsergroup#slack_webhook_url}
  */
  readonly slackWebhookUrl?: string;
  /**
  * Can be one of EMAIL, SLACK, PAGERDUTY, MSTEAMS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#type PlatformUsergroup#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup harness_platform_usergroup}
*/
export class PlatformUsergroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformUsergroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_usergroup harness_platform_usergroup} Resource
  *
  * @param scope The scope in which to define this construct
