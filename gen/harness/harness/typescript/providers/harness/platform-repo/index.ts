// https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo
...
export interface PlatformRepoConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#default_branch PlatformRepo#default_branch}
  */
  readonly defaultBranch?: string;
  /**
  * Description of the repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#description PlatformRepo#description}
  */
  readonly description?: string;
  /**
  * Repository should be created with specified predefined gitignore file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#git_ignore PlatformRepo#git_ignore}
  */
  readonly gitIgnore?: string;
  /**
  * Identifier of the repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#identifier PlatformRepo#identifier}
  */
  readonly identifier: string;
  /**
  * Repository should be created with specified predefined license file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#license PlatformRepo#license}
  */
  readonly license?: string;
  /**
  * Unique identifier of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#org_id PlatformRepo#org_id}
  */
  readonly orgId?: string;
  /**
  * Unique identifier of the project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#project_id PlatformRepo#project_id}
  */
  readonly projectId?: string;
  /**
  * Repository should be created with readme file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#readme PlatformRepo#readme}
  */
  readonly readme?: boolean | cdktf.IResolvable;
  /**
  * source block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#source PlatformRepo#source}
  */
...
export interface PlatformRepoSource {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#host PlatformRepo#host}
  */
  readonly host?: string;
  /**
  * The password for authentication when importing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#password PlatformRepo#password}
  */
  readonly password?: string;
  /**
  * The full identifier of the repository on the SCM provider's platform.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#repo PlatformRepo#repo}
  */
  readonly repo?: string;
  /**
  * The type of SCM provider (github, gitlab, bitbucket, stash, gitea, gogs) when importing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#type PlatformRepo#type}
  */
  readonly type?: string;
  /**
  * The username for authentication when importing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#username PlatformRepo#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo harness_platform_repo}
*/
export class PlatformRepo extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformRepo that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/resources/platform_repo harness_platform_repo} Resource
  *
  * @param scope The scope in which to define this construct
