// https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards
...
export interface PlatformDashboardsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards#created_at PlatformDashboards#created_at}
  */
  readonly createdAt?: string;
  /**
  * Unique identifier of the Template Dashboard to create from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards#dashboard_id PlatformDashboards#dashboard_id}
  */
  readonly dashboardId: string;
  /**
  * Data Sources within the Dashboard.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards#data_source PlatformDashboards#data_source}
  */
  readonly dataSource?: string[];
  /**
  * Description of the Dashboard.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards#description PlatformDashboards#description}
  */
  readonly description?: string;
  /**
  * The Folder ID that the Dashboard belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards#folder_id PlatformDashboards#folder_id}
  */
  readonly folderId?: string;
  /**
  * Data Models within the Dashboard.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards#models PlatformDashboards#models}
  */
  readonly models?: string[];
  /**
  * Name of the Dashboard.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards#name PlatformDashboards#name}
  */
  readonly name?: string;
  /**
  * The Folder ID that the Dashboard belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards#resource_identifier PlatformDashboards#resource_identifier}
  */
  readonly resourceIdentifier: string;
  /**
  * Title of the Dashboard.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards#title PlatformDashboards#title}
  */
  readonly title?: string;
  /**
  * Type of the dashboard.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards#type PlatformDashboards#type}
  */
  readonly type?: string;
  /**
  * View count of the dashboard.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards#view_count PlatformDashboards#view_count}
  */
  readonly viewCount?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards harness_platform_dashboards}
*/
export class PlatformDashboards extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlatformDashboards that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.2/docs/resources/platform_dashboards harness_platform_dashboards} Resource
  *
  * @param scope The scope in which to define this construct
