// https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/platform_dashboards
...
export interface DataHarnessPlatformDashboardsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/platform_dashboards#id DataHarnessPlatformDashboards#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/platform_dashboards#identifier DataHarnessPlatformDashboards#identifier}
  */
  readonly identifier?: string;
  /**
  * Name of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/platform_dashboards#name DataHarnessPlatformDashboards#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/platform_dashboards harness_platform_dashboards}
*/
export class DataHarnessPlatformDashboards extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarnessPlatformDashboards that should be imported. Refer to the {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/platform_dashboards#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harness/harness/0.39.3/docs/data-sources/platform_dashboards harness_platform_dashboards} Data Source
  *
  * @param scope The scope in which to define this construct
