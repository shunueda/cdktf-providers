// https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration
...
export interface JiraIntegrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration#api_token JiraIntegration#api_token}
  */
  readonly apiToken?: string;
  /**
  * Jira display name for the assignee
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration#assignee_display_name JiraIntegration#assignee_display_name}
  */
  readonly assigneeDisplayName?: string;
  /**
  * Jira user name for the assignee
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration#assignee_name JiraIntegration#assignee_name}
  */
  readonly assigneeName: string;
  /**
  * Authentication method used when creating the Jira integration. One of `EmailAndToken` or `UsernameAndPassword`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration#auth_method JiraIntegration#auth_method}
  */
  readonly authMethod: string;
  /**
  * Base URL of the Jira instance that's integrated with SignalFx.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration#base_url JiraIntegration#base_url}
  */
  readonly baseUrl: string;
  /**
  * Whether the integration is enabled or not
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration#enabled JiraIntegration#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration#id JiraIntegration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration#issue_type JiraIntegration#issue_type}
  */
  readonly issueType: string;
  /**
  * Name of the integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration#name JiraIntegration#name}
  */
  readonly name: string;
  /**
  * Password used to authenticate the Jira integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration#password JiraIntegration#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration#project_key JiraIntegration#project_key}
  */
  readonly projectKey: string;
  /**
  * Email address used to authenticate the Jira integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration#user_email JiraIntegration#user_email}
  */
  readonly userEmail?: string;
  /**
  * User name used to authenticate the Jira integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration#username JiraIntegration#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration signalfx_jira_integration}
*/
export class JiraIntegration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing JiraIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.22.3/docs/resources/jira_integration signalfx_jira_integration} Resource
  *
  * @param scope The scope in which to define this construct
