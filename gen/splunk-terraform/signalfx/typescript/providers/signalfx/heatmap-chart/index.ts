// https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart
...
export interface HeatmapChartConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#description HeatmapChart#description}
  */
  readonly description?: string;
  /**
  * (false by default) If false, samples a subset of the output MTS, which improves UI performance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#disable_sampling HeatmapChart#disable_sampling}
  */
  readonly disableSampling?: boolean | cdktf.IResolvable;
  /**
  * Properties to group by in the heatmap (in nesting order)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#group_by HeatmapChart#group_by}
  */
  readonly groupBy?: string[];
  /**
  * (false by default) Whether to show the timestamp in the chart
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#hide_timestamp HeatmapChart#hide_timestamp}
  */
  readonly hideTimestamp?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#id HeatmapChart#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#max_delay HeatmapChart#max_delay}
  */
  readonly maxDelay?: number;
  /**
  * The minimum resolution (in seconds) to use for computing the underlying program
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#minimum_resolution HeatmapChart#minimum_resolution}
  */
  readonly minimumResolution?: number;
  /**
  * Name of the chart
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#name HeatmapChart#name}
  */
  readonly name: string;
  /**
  * Signalflow program text for the chart. More info at "https://developers.signalfx.com/docs/signalflow-overview"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#program_text HeatmapChart#program_text}
  */
  readonly programText: string;
  /**
  * How often (in seconds) to refresh the values of the heatmap
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#refresh_interval HeatmapChart#refresh_interval}
  */
  readonly refreshInterval?: number;
  /**
  * The property to use when sorting the elements. Must be prepended with + for ascending or - for descending (e.g. -foo)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#sort_by HeatmapChart#sort_by}
  */
  readonly sortBy?: string;
  /**
  * Tags associated with the resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#tags HeatmapChart#tags}
  */
  readonly tags?: string[];
  /**
  * The property value is a string that denotes the geographic region associated with the time zone, (e.g. Australia/Sydney)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#timezone HeatmapChart#timezone}
  */
  readonly timezone?: string;
  /**
  * (Metric by default) Must be "Metric" or "Binary"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#unit_prefix HeatmapChart#unit_prefix}
  */
  readonly unitPrefix?: string;
  /**
  * color_range block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#color_range HeatmapChart#color_range}
  */
  readonly colorRange?: HeatmapChartColorRange;
  /**
  * color_scale block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#color_scale HeatmapChart#color_scale}
  */
...
export interface HeatmapChartColorRange {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#color HeatmapChart#color}
  */
  readonly color: string;
  /**
  * The maximum value within the coloring range
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#max_value HeatmapChart#max_value}
  */
  readonly maxValue?: number;
  /**
  * The minimum value within the coloring range
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#min_value HeatmapChart#min_value}
  */
...
export interface HeatmapChartColorScale {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#gt HeatmapChart#gt}
  */
  readonly gt?: number;
  /**
  * Indicates the lower threshold inclusive value for this range
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#gte HeatmapChart#gte}
  */
  readonly gte?: number;
  /**
  * Indicates the upper threshold non-inculsive value for this range
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#lt HeatmapChart#lt}
  */
  readonly lt?: number;
  /**
  * Indicates the upper threshold inclusive value for this range
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#lte HeatmapChart#lte}
  */
  readonly lte?: number;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart signalfx_heatmap_chart}
*/
export class HeatmapChart extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HeatmapChart that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/heatmap_chart signalfx_heatmap_chart} Resource
  *
  * @param scope The scope in which to define this construct
