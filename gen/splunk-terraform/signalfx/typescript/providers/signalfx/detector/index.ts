// https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector
...
export interface DetectorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#authorized_writer_teams Detector#authorized_writer_teams}
  */
  readonly authorizedWriterTeams?: string[];
  /**
  * User IDs that have write access to this dashboard
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#authorized_writer_users Detector#authorized_writer_users}
  */
  readonly authorizedWriterUsers?: string[];
  /**
  * Description of the detector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#description Detector#description}
  */
  readonly description?: string;
  /**
  * Indicates how a detector was created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#detector_origin Detector#detector_origin}
  */
  readonly detectorOrigin?: string;
  /**
  * (false by default) When false, samples a subset of the output MTS in the visualization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#disable_sampling Detector#disable_sampling}
  */
  readonly disableSampling?: boolean | cdktf.IResolvable;
  /**
  * Seconds since epoch. Used for visualization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#end_time Detector#end_time}
  */
  readonly endTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#id Detector#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#max_delay Detector#max_delay}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#min_delay Detector#min_delay}
  */
  readonly minDelay?: number;
  /**
  * Name of the detector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#name Detector#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#parent_detector_id Detector#parent_detector_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#program_text Detector#program_text}
  */
  readonly programText: string;
  /**
  * (true by default) When true, markers will be drawn for each datapoint within the visualization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#show_data_markers Detector#show_data_markers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#show_event_lines Detector#show_event_lines}
  */
  readonly showEventLines?: boolean | cdktf.IResolvable;
  /**
  * Seconds since epoch. Used for visualization
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#start_time Detector#start_time}
  */
  readonly startTime?: number;
  /**
  * Tags associated with the detector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#tags Detector#tags}
  */
  readonly tags?: string[];
  /**
  * Team IDs to associate the detector to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#teams Detector#teams}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#time_range Detector#time_range}
  */
  readonly timeRange?: number;
  /**
  * The property value is a string that denotes the geographic region associated with the time zone, (e.g. Australia/Sydney)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#timezone Detector#timezone}
  */
  readonly timezone?: string;
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#rule Detector#rule}
  */
  readonly rule: DetectorRule[] | cdktf.IResolvable;
  /**
  * viz_options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#viz_options Detector#viz_options}
  */
...
export interface DetectorRuleReminderNotification {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#interval_ms Detector#interval_ms}
  */
  readonly intervalMs: number;
  /**
  * The duration during which repeat notifications are sent, in milliseconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#timeout_ms Detector#timeout_ms}
  */
  readonly timeoutMs?: number;
  /**
  * Type of reminder notification. Currently, the only supported value is TIMEOUT.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#type Detector#type}
  */
...
export interface DetectorRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#detect_label Detector#detect_label}
  */
  readonly detectLabel: string;
  /**
  * (default: false) When true, notifications and events will not be generated for the detect label
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#disabled Detector#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#notifications Detector#notifications}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#parameterized_body Detector#parameterized_body}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#parameterized_subject Detector#parameterized_subject}
  */
  readonly parameterizedSubject?: string;
  /**
  * URL of page to consult when an alert is triggered
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#runbook_url Detector#runbook_url}
  */
  readonly runbookUrl?: string;
  /**
  * The severity of the rule, must be one of: Critical, Warning, Major, Minor, Info
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#severity Detector#severity}
  */
  readonly severity: string;
  /**
  * Plain text suggested first course of action, such as a command to execute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#tip Detector#tip}
  */
  readonly tip?: string;
  /**
  * reminder_notification block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#reminder_notification Detector#reminder_notification}
  */
...
export interface DetectorVizOptions {
  ...
  * Color to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#color Detector#color}
  */
  readonly color?: string;
  /**
  * Specifies an alternate value for the Plot Name column of the Data Table associated with the chart.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#display_name Detector#display_name}
  */
  readonly displayName?: string;
  /**
  * The label used in the publish statement that displays the plot (metric time series data) you want to customize
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#label Detector#label}
  */
  readonly label: string;
  /**
  * An arbitrary prefix to display with the value of this plot
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#value_prefix Detector#value_prefix}
  */
  readonly valuePrefix?: string;
  /**
  * An arbitrary suffix to display with the value of this plot
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#value_suffix Detector#value_suffix}
  */
  readonly valueSuffix?: string;
  /**
  * A unit to attach to this plot. Units support automatic scaling (eg thousands of bytes will be displayed as kilobytes)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#value_unit Detector#value_unit}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector signalfx_detector}
*/
export class Detector extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Detector that should be imported. Refer to the {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/splunk-terraform/signalfx/9.23.1/docs/resources/detector signalfx_detector} Resource
  *
  * @param scope The scope in which to define this construct
