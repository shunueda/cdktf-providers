// https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/function_assurance_policy
...
export interface DataAquasecFunctionAssurancePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/function_assurance_policy#name DataAquasecFunctionAssurancePolicy#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/function_assurance_policy aquasec_function_assurance_policy}
*/
export class DataAquasecFunctionAssurancePolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAquasecFunctionAssurancePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/function_assurance_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/function_assurance_policy aquasec_function_assurance_policy} Data Source
  *
  * @param scope The scope in which to define this construct
