// https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/aqua_api_key
...
export interface AquaApiKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/aqua_api_key#description AquaApiKey#description}
  */
  readonly description: string;
  /**
  * Whether the apikey is enabled or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/aqua_api_key#enabled AquaApiKey#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The date of the API key's expiry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/aqua_api_key#expiration AquaApiKey#expiration}
  */
  readonly expiration?: number;
  /**
  * The group ID that is associated with the API key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/aqua_api_key#group_id AquaApiKey#group_id}
  */
  readonly groupId?: number;
  /**
  * List of IP addresses the API key can be used from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/aqua_api_key#ip_addresses AquaApiKey#ip_addresses}
  */
  readonly ipAddresses?: string[];
  /**
  * List of permission IDs for the API key, if empty the APIkey has global admin permissions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/aqua_api_key#permission_ids AquaApiKey#permission_ids}
  */
  readonly permissionIds?: number[];
  /**
  * The roles that will be assigned to the API key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/aqua_api_key#roles AquaApiKey#roles}
  */
  readonly roles?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/aqua_api_key aquasec_aqua_api_key}
*/
export class AquaApiKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AquaApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/aqua_api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/aqua_api_key aquasec_aqua_api_key} Resource
  *
  * @param scope The scope in which to define this construct
