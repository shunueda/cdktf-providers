// https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/enforcer_groups
...
export interface DataAquasecEnforcerGroupsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/enforcer_groups#forensics DataAquasecEnforcerGroups#forensics}
  */
  readonly forensics?: boolean | cdktf.IResolvable;
  /**
  * The ID of the Enforcer group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/enforcer_groups#group_id DataAquasecEnforcerGroups#group_id}
  */
  readonly groupId: string;
  /**
  * Select Enabled to send activity logs in your host to the Aqua Server for forensics purposes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/enforcer_groups#host_forensics_collection DataAquasecEnforcerGroups#host_forensics_collection}
  */
  readonly hostForensicsCollection?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/enforcer_groups#id DataAquasecEnforcerGroups#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/enforcer_groups aquasec_enforcer_groups}
*/
export class DataAquasecEnforcerGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAquasecEnforcerGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/enforcer_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/enforcer_groups aquasec_enforcer_groups} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // unified_mode - computed: true, optional: false, required: false
  public get unifiedMode() {
    return this.getBooleanAttribute('unified_mode');
  }
