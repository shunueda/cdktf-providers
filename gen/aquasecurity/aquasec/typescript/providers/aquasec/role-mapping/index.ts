// https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/role_mapping
...
export interface RoleMappingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/role_mapping#id RoleMapping#id}
  *
  ...
  * ldap block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/role_mapping#ldap RoleMapping#ldap}
  */
  readonly ldap?: RoleMappingLdap;
  /**
  * oauth2 block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/role_mapping#oauth2 RoleMapping#oauth2}
  */
  readonly oauth2?: RoleMappingOauth2;
  /**
  * openid block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/role_mapping#openid RoleMapping#openid}
  */
  readonly openid?: RoleMappingOpenid;
  /**
  * saml block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/role_mapping#saml RoleMapping#saml}
  */
...
export interface RoleMappingLdap {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/role_mapping#role_mapping RoleMapping#role_mapping}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/role_mapping aquasec_role_mapping}
*/
export class RoleMapping extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoleMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/role_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/resources/role_mapping aquasec_role_mapping} Resource
  *
  * @param scope The scope in which to define this construct
