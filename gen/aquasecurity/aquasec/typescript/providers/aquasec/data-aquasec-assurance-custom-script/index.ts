// https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs/data-sources/assurance_custom_script
...
export interface DataAquasecAssuranceCustomScriptConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs/data-sources/assurance_custom_script#id DataAquasecAssuranceCustomScript#id}
  *
  ...
  * ID of the script
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs/data-sources/assurance_custom_script#script_id DataAquasecAssuranceCustomScript#script_id}
  */
  readonly scriptId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs/data-sources/assurance_custom_script aquasec_assurance_custom_script}
*/
export class DataAquasecAssuranceCustomScript extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAquasecAssuranceCustomScript that should be imported. Refer to the {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs/data-sources/assurance_custom_script#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs/data-sources/assurance_custom_script aquasec_assurance_custom_script} Data Source
  *
  * @param scope The scope in which to define this construct
