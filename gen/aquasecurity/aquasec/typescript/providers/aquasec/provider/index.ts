// https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs
...
export interface AquasecProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs#allowed_endpoints AquasecProvider#allowed_endpoints}
  */
  readonly allowedEndpoints?: string[];
  /**
  * API key for authentication. If set, API key mode is used instead of token-based auth.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs#aqua_api_key AquasecProvider#aqua_api_key}
  */
  readonly aquaApiKey?: string;
  /**
  * Shared secret for API key HMAC signing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs#aqua_api_secret AquasecProvider#aqua_api_secret}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs#aqua_url AquasecProvider#aqua_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs#ca_certificate_path AquasecProvider#ca_certificate_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs#config_path AquasecProvider#config_path}
  */
  readonly configPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs#csp_roles AquasecProvider#csp_roles}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs#password AquasecProvider#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs#username AquasecProvider#username}
  */
  readonly username?: string;
  /**
  * Skip provider credential validation when set to false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs#validate AquasecProvider#validate}
  */
  readonly validate?: boolean | cdktf.IResolvable;
  /**
  * Lifetime of the token, in minutes. Set between 1 and 1500. Once the token expires, need to generate a new one
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs#validity AquasecProvider#validity}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs#verify_tls AquasecProvider#verify_tls}
  */
  readonly verifyTls?: boolean | cdktf.IResolvable;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs#alias AquasecProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs aquasec}
*/
export class AquasecProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing AquasecProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs aquasec} Resource
  *
  * @param scope The scope in which to define this construct
