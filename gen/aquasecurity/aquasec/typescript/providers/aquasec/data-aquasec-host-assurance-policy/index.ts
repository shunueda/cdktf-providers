// https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs/data-sources/host_assurance_policy
...
export interface DataAquasecHostAssurancePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs/data-sources/host_assurance_policy#name DataAquasecHostAssurancePolicy#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs/data-sources/host_assurance_policy aquasec_host_assurance_policy}
*/
export class DataAquasecHostAssurancePolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAquasecHostAssurancePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs/data-sources/host_assurance_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.11.0/docs/data-sources/host_assurance_policy aquasec_host_assurance_policy} Data Source
  *
  * @param scope The scope in which to define this construct
