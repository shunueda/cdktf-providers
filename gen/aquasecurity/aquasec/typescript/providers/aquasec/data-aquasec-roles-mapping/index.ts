// https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/roles_mapping
...
export interface DataAquasecRolesMappingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/roles_mapping#id DataAquasecRolesMapping#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/roles_mapping aquasec_roles_mapping}
*/
export class DataAquasecRolesMapping extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAquasecRolesMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/roles_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aquasecurity/aquasec/0.12.1/docs/data-sources/roles_mapping aquasec_roles_mapping} Data Source
  *
  * @param scope The scope in which to define this construct
