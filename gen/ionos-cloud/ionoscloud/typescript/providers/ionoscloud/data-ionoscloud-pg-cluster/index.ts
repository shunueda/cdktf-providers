// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.20/docs/data-sources/pg_cluster
...
export class DataIonoscloudPgCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIonoscloudPgCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.20/docs/data-sources/pg_cluster#import import section} in the documentation of this resource for the id to use
