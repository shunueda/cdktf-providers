...
export * as dataIonoscloudObjectStorageAccesskey from './data-ionoscloud-object-storage-accesskey';
export * as dataIonoscloudObjectStorageRegion from './data-ionoscloud-object-storage-region';
