// https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.20/docs/data-sources/vcpu_server
...
export class DataIonoscloudVcpuServer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIonoscloudVcpuServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/ionoscloud/6.7.20/docs/data-sources/vcpu_server#import import section} in the documentation of this resource for the id to use
