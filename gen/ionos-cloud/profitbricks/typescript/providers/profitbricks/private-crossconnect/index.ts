// https://registry.terraform.io/providers/ionos-cloud/profitbricks/1.6.5/docs/resources/private_crossconnect
...
export interface PrivateCrossconnectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/profitbricks/1.6.5/docs/resources/private_crossconnect#description PrivateCrossconnect#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/profitbricks/1.6.5/docs/resources/private_crossconnect#id PrivateCrossconnect#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/profitbricks/1.6.5/docs/resources/private_crossconnect#name PrivateCrossconnect#name}
  */
  readonly name: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/profitbricks/1.6.5/docs/resources/private_crossconnect#timeouts PrivateCrossconnect#timeouts}
  */
...
export function privateCrossconnectConnectableDatacentersToTerraform(struct?: PrivateCrossconnectConnectableDatacenters): any {
...
export function privateCrossconnectConnectableDatacentersToHclTerraform(struct?: PrivateCrossconnectConnectableDatacenters): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PrivateCrossconnectConnectableDatacentersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PrivateCrossconnectConnectableDatacenters | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: PrivateCrossconnectConnectableDatacenters | undefined) {
    if (value === undefined) {
...
export function privateCrossconnectPeersToTerraform(struct?: PrivateCrossconnectPeers): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function privateCrossconnectPeersToHclTerraform(struct?: PrivateCrossconnectPeers): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PrivateCrossconnectPeersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PrivateCrossconnectPeers | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: PrivateCrossconnectPeers | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export interface PrivateCrossconnectTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/profitbricks/1.6.5/docs/resources/private_crossconnect#create PrivateCrossconnect#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/profitbricks/1.6.5/docs/resources/private_crossconnect#default PrivateCrossconnect#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/profitbricks/1.6.5/docs/resources/private_crossconnect#delete PrivateCrossconnect#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ionos-cloud/profitbricks/1.6.5/docs/resources/private_crossconnect#update PrivateCrossconnect#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ionos-cloud/profitbricks/1.6.5/docs/resources/private_crossconnect profitbricks_private_crossconnect}
*/
export class PrivateCrossconnect extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateCrossconnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/ionos-cloud/profitbricks/1.6.5/docs/resources/private_crossconnect#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ionos-cloud/profitbricks/1.6.5/docs/resources/private_crossconnect profitbricks_private_crossconnect} Resource
  *
  * @param scope The scope in which to define this construct
