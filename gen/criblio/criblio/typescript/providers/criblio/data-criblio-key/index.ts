...
export interface DataCriblioKeyConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DataCriblioKey extends cdktf.TerraformDataSource {
  ...
  * @param options DataCriblioKeyConfig
  */
  public constructor(scope: Construct, id: string, config: DataCriblioKeyConfig) {
    super(scope, id, {
