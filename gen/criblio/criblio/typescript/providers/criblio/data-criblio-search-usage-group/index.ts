// https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/data-sources/search_usage_group
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/data-sources/search_usage_group criblio_search_usage_group}
*/
export class DataCriblioSearchUsageGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioSearchUsageGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/data-sources/search_usage_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/data-sources/search_usage_group criblio_search_usage_group} Data Source
  *
  * @param scope The scope in which to define this construct
