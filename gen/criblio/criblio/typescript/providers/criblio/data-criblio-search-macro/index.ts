// https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/search_macro
...
export interface DataCriblioSearchMacroConfig extends cdktf.TerraformMetaArguments {
  ...
  * Unique ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/search_macro#id DataCriblioSearchMacro#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/search_macro criblio_search_macro}
*/
export class DataCriblioSearchMacro extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioSearchMacro that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/search_macro#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/search_macro criblio_search_macro} Data Source
  *
  * @param scope The scope in which to define this construct
