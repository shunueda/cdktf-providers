// https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/data-sources/workspace
...
export interface DataCriblioWorkspaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/data-sources/workspace#organization_id DataCriblioWorkspace#organization_id}
  */
  readonly organizationId: string;
  /**
  * The <code>id</code> of the Workspace to get.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/data-sources/workspace#workspace_id DataCriblioWorkspace#workspace_id}
  */
  readonly workspaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/data-sources/workspace criblio_workspace}
*/
export class DataCriblioWorkspace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/data-sources/workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/data-sources/workspace criblio_workspace} Data Source
  *
  * @param scope The scope in which to define this construct
