// https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/pipeline
...
export interface DataCriblioPipelineConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/pipeline#group_id DataCriblioPipeline#group_id}
  */
  readonly groupId: string;
  /**
  * Unique ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/pipeline#id DataCriblioPipeline#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/pipeline criblio_pipeline}
*/
export class DataCriblioPipeline extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/pipeline criblio_pipeline} Data Source
  *
  * @param scope The scope in which to define this construct
