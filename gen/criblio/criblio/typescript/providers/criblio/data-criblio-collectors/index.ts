// https://registry.terraform.io/providers/criblio/criblio/1.20.62/docs/data-sources/collectors
...
export interface DataCriblioCollectorsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.62/docs/data-sources/collectors#group_id DataCriblioCollectors#group_id}
  */
  readonly groupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.62/docs/data-sources/collectors criblio_collectors}
*/
export class DataCriblioCollectors extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioCollectors that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.62/docs/data-sources/collectors#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.62/docs/data-sources/collectors criblio_collectors} Data Source
  *
  * @param scope The scope in which to define this construct
