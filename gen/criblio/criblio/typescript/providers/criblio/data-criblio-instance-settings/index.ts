// https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/instance_settings
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/instance_settings criblio_instance_settings}
*/
export class DataCriblioInstanceSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioInstanceSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/instance_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/instance_settings criblio_instance_settings} Data Source
  *
  * @param scope The scope in which to define this construct
