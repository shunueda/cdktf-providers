// https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/data-sources/search_dataset_provider
...
export interface DataCriblioSearchDatasetProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  * Unique ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/data-sources/search_dataset_provider#id DataCriblioSearchDatasetProvider#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/data-sources/search_dataset_provider criblio_search_dataset_provider}
*/
export class DataCriblioSearchDatasetProvider extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioSearchDatasetProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/data-sources/search_dataset_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/data-sources/search_dataset_provider criblio_search_dataset_provider} Data Source
  *
  * @param scope The scope in which to define this construct
