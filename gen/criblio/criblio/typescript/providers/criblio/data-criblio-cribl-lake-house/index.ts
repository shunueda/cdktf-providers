// https://registry.terraform.io/providers/criblio/criblio/1.20.60/docs/data-sources/cribl_lake_house
...
export interface DataCriblioCriblLakeHouseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.60/docs/data-sources/cribl_lake_house#id DataCriblioCriblLakeHouse#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.60/docs/data-sources/cribl_lake_house criblio_cribl_lake_house}
*/
export class DataCriblioCriblLakeHouse extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioCriblLakeHouse that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.60/docs/data-sources/cribl_lake_house#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.60/docs/data-sources/cribl_lake_house criblio_cribl_lake_house} Data Source
  *
  * @param scope The scope in which to define this construct
