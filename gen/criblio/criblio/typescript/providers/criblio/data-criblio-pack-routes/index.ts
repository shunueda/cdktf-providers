// https://registry.terraform.io/providers/criblio/criblio/1.18.21/docs/data-sources/pack_routes
...
export interface DataCriblioPackRoutesConfig extends cdktf.TerraformMetaArguments {
  ...
  * group Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.18.21/docs/data-sources/pack_routes#group_id DataCriblioPackRoutes#group_id}
  */
  readonly groupId: string;
  /**
  * pack ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.18.21/docs/data-sources/pack_routes#pack DataCriblioPackRoutes#pack}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.18.21/docs/data-sources/pack_routes criblio_pack_routes}
*/
export class DataCriblioPackRoutes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioPackRoutes that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.18.21/docs/data-sources/pack_routes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.18.21/docs/data-sources/pack_routes criblio_pack_routes} Data Source
  *
  * @param scope The scope in which to define this construct
