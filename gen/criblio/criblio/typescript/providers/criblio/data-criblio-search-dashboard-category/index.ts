// https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/data-sources/search_dashboard_category
...
export interface DataCriblioSearchDashboardCategoryConfig extends cdktf.TerraformMetaArguments {
  ...
  * Unique ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/data-sources/search_dashboard_category#id DataCriblioSearchDashboardCategory#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/data-sources/search_dashboard_category criblio_search_dashboard_category}
*/
export class DataCriblioSearchDashboardCategory extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioSearchDashboardCategory that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/data-sources/search_dashboard_category#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/data-sources/search_dashboard_category criblio_search_dashboard_category} Data Source
  *
  * @param scope The scope in which to define this construct
