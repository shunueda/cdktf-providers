// https://registry.terraform.io/providers/criblio/criblio/1.20.23/docs/data-sources/search_saved_query
...
export interface DataCriblioSearchSavedQueryConfig extends cdktf.TerraformMetaArguments {
  ...
  * Unique ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.23/docs/data-sources/search_saved_query#id DataCriblioSearchSavedQuery#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.23/docs/data-sources/search_saved_query criblio_search_saved_query}
*/
export class DataCriblioSearchSavedQuery extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioSearchSavedQuery that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.23/docs/data-sources/search_saved_query#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.23/docs/data-sources/search_saved_query criblio_search_saved_query} Data Source
  *
  * @param scope The scope in which to define this construct
