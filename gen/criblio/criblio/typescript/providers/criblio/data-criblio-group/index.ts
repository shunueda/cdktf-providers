// https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/group
...
export interface DataCriblioGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/group#fields DataCriblioGroup#fields}
  */
  readonly fields?: string;
  /**
  * Group id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/group#id DataCriblioGroup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/group criblio_group}
*/
export class DataCriblioGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/group criblio_group} Data Source
  *
  * @param scope The scope in which to define this construct
