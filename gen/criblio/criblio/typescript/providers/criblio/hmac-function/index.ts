// https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/resources/hmac_function
...
export interface HmacFunctionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/resources/hmac_function#description HmacFunction#description}
  */
  readonly description?: string;
  /**
  * The consumer group to which this instance belongs. Defaults to 'Cribl'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/resources/hmac_function#group_id HmacFunction#group_id}
  */
  readonly groupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/resources/hmac_function#header_expression HmacFunction#header_expression}
  */
  readonly headerExpression: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/resources/hmac_function#header_name HmacFunction#header_name}
  */
  readonly headerName: string;
  /**
  * Unique ID to PATCH
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/resources/hmac_function#id HmacFunction#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/resources/hmac_function#lib HmacFunction#lib}
  */
  readonly lib: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/resources/hmac_function#string_builders HmacFunction#string_builders}
  */
  readonly stringBuilders: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/resources/hmac_function#string_delim HmacFunction#string_delim}
  */
  readonly stringDelim?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/resources/hmac_function criblio_hmac_function}
*/
export class HmacFunction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HmacFunction that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/resources/hmac_function#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.32/docs/resources/hmac_function criblio_hmac_function} Resource
  *
  * @param scope The scope in which to define this construct
