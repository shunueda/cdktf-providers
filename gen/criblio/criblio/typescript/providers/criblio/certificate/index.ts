// https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/resources/certificate
...
export interface CertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/resources/certificate#ca Certificate#ca}
  */
  readonly ca?: string;
  /**
  * Drag/drop or upload host certificate in PEM/Base64 format, or paste its contents here
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/resources/certificate#cert Certificate#cert}
  */
  readonly cert: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/resources/certificate#description Certificate#description}
  */
  readonly description?: string;
  /**
  * Unique ID to PATCH
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/resources/certificate#id Certificate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/resources/certificate#in_use Certificate#in_use}
  */
  readonly inUse?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/resources/certificate#passphrase Certificate#passphrase}
  */
  readonly passphrase?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/resources/certificate#priv_key Certificate#priv_key}
  */
  readonly privKey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/resources/certificate criblio_certificate}
*/
export class Certificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Certificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/resources/certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/resources/certificate criblio_certificate} Resource
  *
  * @param scope The scope in which to define this construct
