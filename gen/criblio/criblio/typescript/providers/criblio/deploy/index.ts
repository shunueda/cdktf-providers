// https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/resources/deploy
...
export interface DeployConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/resources/deploy#id Deploy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/resources/deploy#version Deploy#version}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/resources/deploy criblio_deploy}
*/
export class Deploy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Deploy that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/resources/deploy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/resources/deploy criblio_deploy} Resource
  *
  * @param scope The scope in which to define this construct
