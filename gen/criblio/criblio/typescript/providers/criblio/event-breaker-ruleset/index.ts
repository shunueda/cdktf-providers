// https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset
...
export interface EventBreakerRulesetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#description EventBreakerRuleset#description}
  */
  readonly description?: string;
  /**
  * The consumer group to which this instance belongs. Defaults to 'Cribl'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#group_id EventBreakerRuleset#group_id}
  */
  readonly groupId: string;
  /**
  * Unique ID to PATCH
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#id EventBreakerRuleset#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#lib EventBreakerRuleset#lib}
  */
  readonly lib?: string;
  /**
  * The  minimum number of characters in _raw to determine which rule to use. Default: 256
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#min_raw_length EventBreakerRuleset#min_raw_length}
  */
  readonly minRawLength?: number;
  /**
  * A list of rules that will be applied, in order, to the input data stream
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#rules EventBreakerRuleset#rules}
  */
  readonly rules?: EventBreakerRulesetRules[] | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#tags EventBreakerRuleset#tags}
  */
  readonly tags?: string;
}
export interface EventBreakerRulesetRulesFields {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#name EventBreakerRuleset#name}
  */
  readonly name?: string;
  /**
  * The JavaScript expression used to compute the field's value (can be constant)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#value EventBreakerRuleset#value}
  */
...
export interface EventBreakerRulesetRulesTimestamp {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#format EventBreakerRuleset#format}
  */
  readonly format?: string;
  /**
  * Default: 150
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#length EventBreakerRuleset#length}
  */
  readonly length?: number;
  /**
  * Default: "auto"; must be one of ["auto", "format", "current"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#type EventBreakerRuleset#type}
  */
...
export interface EventBreakerRulesetRules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#condition EventBreakerRuleset#condition}
  */
  readonly condition?: string;
  /**
  * Disable this breaker rule (enabled by default). Default: false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#disabled EventBreakerRuleset#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#event_breaker_regex EventBreakerRuleset#event_breaker_regex}
  */
  readonly eventBreakerRegex?: string;
  /**
  * Key-value pairs to be added to each event
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#fields EventBreakerRuleset#fields}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#max_event_bytes EventBreakerRuleset#max_event_bytes}
  */
  ...
  * Default: false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#parser_enabled EventBreakerRuleset#parser_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#should_use_data_raw EventBreakerRuleset#should_use_data_raw}
  */
  readonly shouldUseDataRaw?: boolean | cdktf.IResolvable;
  /**
  * Auto, manual format (strptime), or current time
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#timestamp EventBreakerRuleset#timestamp}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#timestamp_anchor_regex EventBreakerRuleset#timestamp_anchor_regex}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#timestamp_earliest EventBreakerRuleset#timestamp_earliest}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#timestamp_latest EventBreakerRuleset#timestamp_latest}
  */
  readonly timestampLatest?: string;
  /**
  * Timezone to assign to timestamps without timezone info. Default: "local"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#timestamp_timezone EventBreakerRuleset#timestamp_timezone}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset criblio_event_breaker_ruleset}
*/
export class EventBreakerRuleset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventBreakerRuleset that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/resources/event_breaker_ruleset criblio_event_breaker_ruleset} Resource
  *
  * @param scope The scope in which to define this construct
