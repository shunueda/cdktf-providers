// https://registry.terraform.io/providers/criblio/criblio/1.20.27/docs/data-sources/source
...
export interface DataCriblioSourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.27/docs/data-sources/source#group_id DataCriblioSource#group_id}
  */
  readonly groupId: string;
  /**
  * Unique ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.27/docs/data-sources/source#id DataCriblioSource#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.27/docs/data-sources/source criblio_source}
*/
export class DataCriblioSource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.27/docs/data-sources/source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.27/docs/data-sources/source criblio_source} Data Source
  *
  * @param scope The scope in which to define this construct
