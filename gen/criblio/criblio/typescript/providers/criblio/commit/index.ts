// https://registry.terraform.io/providers/criblio/criblio/1.20.60/docs/resources/commit
...
export interface CommitConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.60/docs/resources/commit#effective Commit#effective}
  */
  readonly effective?: boolean | cdktf.IResolvable;
  /**
  * Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.60/docs/resources/commit#files Commit#files}
  */
  readonly files?: string[];
  /**
  * Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.60/docs/resources/commit#group Commit#group}
  */
  readonly group?: string;
  /**
  * Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.60/docs/resources/commit#message Commit#message}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.60/docs/resources/commit criblio_commit}
*/
export class Commit extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Commit that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.60/docs/resources/commit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.60/docs/resources/commit criblio_commit} Resource
  *
  * @param scope The scope in which to define this construct
