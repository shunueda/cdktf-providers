// https://registry.terraform.io/providers/criblio/criblio/1.20.64/docs/data-sources/group_system_settings
...
export interface DataCriblioGroupSystemSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.64/docs/data-sources/group_system_settings#group_id DataCriblioGroupSystemSettings#group_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.64/docs/data-sources/group_system_settings criblio_group_system_settings}
*/
export class DataCriblioGroupSystemSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioGroupSystemSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.64/docs/data-sources/group_system_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.64/docs/data-sources/group_system_settings criblio_group_system_settings} Data Source
  *
  * @param scope The scope in which to define this construct
