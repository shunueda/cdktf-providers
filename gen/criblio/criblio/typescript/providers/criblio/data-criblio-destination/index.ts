// https://registry.terraform.io/providers/criblio/criblio/1.20.27/docs/data-sources/destination
...
export interface DataCriblioDestinationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.27/docs/data-sources/destination#group_id DataCriblioDestination#group_id}
  */
  readonly groupId: string;
  /**
  * Unique ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.27/docs/data-sources/destination#id DataCriblioDestination#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.27/docs/data-sources/destination criblio_destination}
*/
export class DataCriblioDestination extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.27/docs/data-sources/destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.27/docs/data-sources/destination criblio_destination} Data Source
  *
  * @param scope The scope in which to define this construct
