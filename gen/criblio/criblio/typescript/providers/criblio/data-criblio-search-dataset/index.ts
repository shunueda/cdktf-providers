// https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/search_dataset
...
export interface DataCriblioSearchDatasetConfig extends cdktf.TerraformMetaArguments {
  ...
  * Unique ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/search_dataset#id DataCriblioSearchDataset#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/search_dataset criblio_search_dataset}
*/
export class DataCriblioSearchDataset extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioSearchDataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/search_dataset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/search_dataset criblio_search_dataset} Data Source
  *
  * @param scope The scope in which to define this construct
