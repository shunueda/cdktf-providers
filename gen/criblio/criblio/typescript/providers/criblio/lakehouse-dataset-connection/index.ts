// https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/resources/lakehouse_dataset_connection
...
export interface LakehouseDatasetConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/resources/lakehouse_dataset_connection#lake_dataset_id LakehouseDatasetConnection#lake_dataset_id}
  */
  readonly lakeDatasetId: string;
  /**
  * The ID of the lakehouse
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/resources/lakehouse_dataset_connection#lakehouse_id LakehouseDatasetConnection#lakehouse_id}
  */
  readonly lakehouseId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/resources/lakehouse_dataset_connection#request_body LakehouseDatasetConnection#request_body}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/resources/lakehouse_dataset_connection criblio_lakehouse_dataset_connection}
*/
export class LakehouseDatasetConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LakehouseDatasetConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/resources/lakehouse_dataset_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/resources/lakehouse_dataset_connection criblio_lakehouse_dataset_connection} Resource
  *
  * @param scope The scope in which to define this construct
