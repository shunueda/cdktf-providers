// https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/pack_pipeline
...
export interface DataCriblioPackPipelineConfig extends cdktf.TerraformMetaArguments {
  ...
  * group Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/pack_pipeline#group_id DataCriblioPackPipeline#group_id}
  */
  readonly groupId: string;
  /**
  * Unique ID to GET for pack
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/pack_pipeline#id DataCriblioPackPipeline#id}
  *
  ...
  * pack ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/pack_pipeline#pack DataCriblioPackPipeline#pack}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/pack_pipeline criblio_pack_pipeline}
*/
export class DataCriblioPackPipeline extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioPackPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/pack_pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/pack_pipeline criblio_pack_pipeline} Data Source
  *
  * @param scope The scope in which to define this construct
