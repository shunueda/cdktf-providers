// https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/regex
...
export interface DataCriblioRegexConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/regex#group_id DataCriblioRegex#group_id}
  */
  readonly groupId: string;
  /**
  * Unique ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/regex#id DataCriblioRegex#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/regex criblio_regex}
*/
export class DataCriblioRegex extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioRegex that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/regex#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.59/docs/data-sources/regex criblio_regex} Data Source
  *
  * @param scope The scope in which to define this construct
