// https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/data-sources/project
...
export interface DataCriblioProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/data-sources/project#group_id DataCriblioProject#group_id}
  */
  readonly groupId: string;
  /**
  * Unique ID to GET
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/data-sources/project#id DataCriblioProject#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/data-sources/project criblio_project}
*/
export class DataCriblioProject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/data-sources/project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/data-sources/project criblio_project} Data Source
  *
  * @param scope The scope in which to define this construct
