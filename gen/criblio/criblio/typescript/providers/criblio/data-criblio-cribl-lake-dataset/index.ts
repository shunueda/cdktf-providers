// https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/cribl_lake_dataset
...
export interface DataCriblioCriblLakeDatasetConfig extends cdktf.TerraformMetaArguments {
  ...
  * dataset id to get
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/cribl_lake_dataset#id DataCriblioCriblLakeDataset#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/cribl_lake_dataset#lake_id DataCriblioCriblLakeDataset#lake_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/cribl_lake_dataset criblio_cribl_lake_dataset}
*/
export class DataCriblioCriblLakeDataset extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioCriblLakeDataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/cribl_lake_dataset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.33/docs/data-sources/cribl_lake_dataset criblio_cribl_lake_dataset} Data Source
  *
  * @param scope The scope in which to define this construct
