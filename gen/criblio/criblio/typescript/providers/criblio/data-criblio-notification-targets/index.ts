// https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/data-sources/notification_targets
...
/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/data-sources/notification_targets criblio_notification_targets}
*/
export class DataCriblioNotificationTargets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioNotificationTargets that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/data-sources/notification_targets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.72/docs/data-sources/notification_targets criblio_notification_targets} Data Source
  *
  * @param scope The scope in which to define this construct
