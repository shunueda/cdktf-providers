// https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs
...
export interface CriblioProviderConfig {
  ...
  * HTTP Bearer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs#bearer_auth CriblioProvider#bearer_auth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs#client_id CriblioProvider#client_id}
  */
  readonly clientId?: string;
  /**
  * OAuth2 Client Credentials Flow client secret. Configurable via environment variable `CRIBL_CLIENT_SECRET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs#client_secret CriblioProvider#client_secret}
  */
  readonly clientSecret?: string;
  /**
  * Cribl Cloud domain name (defaults to cribl.cloud)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs#cloud_domain CriblioProvider#cloud_domain}
  */
  readonly cloudDomain?: string;
  /**
  * The Organization ID (defaults to ian)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs#organization_id CriblioProvider#organization_id}
  */
  readonly organizationId?: string;
  /**
  * Server URL (defaults to https://{workspaceId}-{organizationId}.{cloudDomain})
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs#server_url CriblioProvider#server_url}
  */
  readonly serverUrl?: string;
  /**
  * OAuth2 Client Credentials Flow token URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs#token_url CriblioProvider#token_url}
  */
  readonly tokenUrl?: string;
  /**
  * The Workspace name (defaults to main)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs#workspace_id CriblioProvider#workspace_id}
  */
  readonly workspaceId?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs#alias CriblioProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs criblio}
*/
export class CriblioProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing CriblioProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs criblio} Resource
  *
  * @param scope The scope in which to define this construct
