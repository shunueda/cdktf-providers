// https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/data-sources/parser_lib_entry
...
export interface DataCriblioParserLibEntryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/data-sources/parser_lib_entry#group_id DataCriblioParserLibEntry#group_id}
  */
  readonly groupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/data-sources/parser_lib_entry criblio_parser_lib_entry}
*/
export class DataCriblioParserLibEntry extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCriblioParserLibEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/data-sources/parser_lib_entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/criblio/criblio/1.20.48/docs/data-sources/parser_lib_entry criblio_parser_lib_entry} Data Source
  *
  * @param scope The scope in which to define this construct
