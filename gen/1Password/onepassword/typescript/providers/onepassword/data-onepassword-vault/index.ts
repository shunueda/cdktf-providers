// https://registry.terraform.io/providers/1password/onepassword/2.2.1/docs/data-sources/vault
...
export interface DataOnepasswordVaultConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/1password/onepassword/2.2.1/docs/data-sources/vault#name DataOnepasswordVault#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/1password/onepassword/2.2.1/docs/data-sources/vault#uuid DataOnepasswordVault#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/1password/onepassword/2.2.1/docs/data-sources/vault onepassword_vault}
*/
export class DataOnepasswordVault extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOnepasswordVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/1password/onepassword/2.2.1/docs/data-sources/vault#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/1password/onepassword/2.2.1/docs/data-sources/vault onepassword_vault} Data Source
  *
  * @param scope The scope in which to define this construct
