// https://registry.terraform.io/providers/1password/onepassword/2.2.0/docs/data-sources/item
...
export interface DataOnepasswordItemConfig extends cdktf.TerraformMetaArguments {
  ...
  * Secure Note value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/1password/onepassword/2.2.0/docs/data-sources/item#note_value DataOnepasswordItem#note_value}
  */
  readonly noteValue?: string;
  /**
  * The title of the item to retrieve. This field will be populated with the title of the item if the item it looked up by its UUID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/1password/onepassword/2.2.0/docs/data-sources/item#title DataOnepasswordItem#title}
  */
  readonly title?: string;
  /**
  * The UUID of the item to retrieve. This field will be populated with the UUID of the item if the item it looked up by its title.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/1password/onepassword/2.2.0/docs/data-sources/item#uuid DataOnepasswordItem#uuid}
  */
  readonly uuid?: string;
  /**
  * The UUID of the vault the item is in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/1password/onepassword/2.2.0/docs/data-sources/item#vault DataOnepasswordItem#vault}
  */
  readonly vault: string;
  /**
  * file block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/1password/onepassword/2.2.0/docs/data-sources/item#file DataOnepasswordItem#file}
  */
  readonly file?: DataOnepasswordItemFile[] | cdktf.IResolvable;
  /**
  * section block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/1password/onepassword/2.2.0/docs/data-sources/item#section DataOnepasswordItem#section}
  */
...
export interface DataOnepasswordItemSection {
  ...
  * field block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/1password/onepassword/2.2.0/docs/data-sources/item#field DataOnepasswordItem#field}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/1password/onepassword/2.2.0/docs/data-sources/item onepassword_item}
*/
export class DataOnepasswordItem extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOnepasswordItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/1password/onepassword/2.2.0/docs/data-sources/item#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/1password/onepassword/2.2.0/docs/data-sources/item onepassword_item} Data Source
  *
  * @param scope The scope in which to define this construct
