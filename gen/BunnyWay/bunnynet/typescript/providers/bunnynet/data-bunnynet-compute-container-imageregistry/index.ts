// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/compute_container_imageregistry
...
export interface DataBunnynetComputeContainerImageregistryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/compute_container_imageregistry#registry DataBunnynetComputeContainerImageregistry#registry}
  */
  readonly registry: string;
  /**
  * The username used to authenticate to the registry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/compute_container_imageregistry#username DataBunnynetComputeContainerImageregistry#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/compute_container_imageregistry bunnynet_compute_container_imageregistry}
*/
export class DataBunnynetComputeContainerImageregistry extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBunnynetComputeContainerImageregistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/compute_container_imageregistry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/compute_container_imageregistry bunnynet_compute_container_imageregistry} Data Source
  *
  * @param scope The scope in which to define this construct
