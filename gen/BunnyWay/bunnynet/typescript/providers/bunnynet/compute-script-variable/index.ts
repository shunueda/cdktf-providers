// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/compute_script_variable
...
export interface ComputeScriptVariableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/compute_script_variable#default_value ComputeScriptVariable#default_value}
  */
  readonly defaultValue: string;
  /**
  * The name of the environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/compute_script_variable#name ComputeScriptVariable#name}
  */
  readonly name: string;
  /**
  * Indicates whether the environment variable is required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/compute_script_variable#required ComputeScriptVariable#required}
  */
  readonly required: boolean | cdktf.IResolvable;
  /**
  * The ID of the associated compute script.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/compute_script_variable#script ComputeScriptVariable#script}
  */
  readonly script: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/compute_script_variable bunnynet_compute_script_variable}
*/
export class ComputeScriptVariable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeScriptVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/compute_script_variable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/compute_script_variable bunnynet_compute_script_variable} Resource
  *
  * @param scope The scope in which to define this construct
