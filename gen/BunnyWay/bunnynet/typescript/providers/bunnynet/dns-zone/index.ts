// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/dns_zone
...
export interface DnsZoneConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/dns_zone#domain DnsZone#domain}
  */
  readonly domain: string;
  /**
  * Indicates whether DNS logs are anonymized.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/dns_zone#log_anonymized DnsZone#log_anonymized}
  */
  readonly logAnonymized?: boolean | cdktf.IResolvable;
  /**
  * Options: `Drop`, `OneDigit`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/dns_zone#log_anonymized_style DnsZone#log_anonymized_style}
  */
  readonly logAnonymizedStyle?: string;
  /**
  * Indicates whether permanent logging for DNS queries is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/dns_zone#log_enabled DnsZone#log_enabled}
  */
  readonly logEnabled?: boolean | cdktf.IResolvable;
  /**
  * The primary nameserver for the DNS zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/dns_zone#nameserver1 DnsZone#nameserver1}
  */
  readonly nameserver1?: string;
  /**
  * The secondary nameserver for the DNS zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/dns_zone#nameserver2 DnsZone#nameserver2}
  */
  readonly nameserver2?: string;
  /**
  * Indicates whether custom nameservers are used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/dns_zone#nameserver_custom DnsZone#nameserver_custom}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/dns_zone#soa_email DnsZone#soa_email}
  */
  readonly soaEmail?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/dns_zone bunnynet_dns_zone}
*/
export class DnsZone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/dns_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/dns_zone bunnynet_dns_zone} Resource
  *
  * @param scope The scope in which to define this construct
