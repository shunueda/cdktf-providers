// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule
...
export interface PullzoneEdgeruleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#action PullzoneEdgerule#action}
  */
  readonly action?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#action_parameter1 PullzoneEdgerule#action_parameter1}
  */
  readonly actionParameter1?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#action_parameter2 PullzoneEdgerule#action_parameter2}
  */
  readonly actionParameter2?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#action_parameter3 PullzoneEdgerule#action_parameter3}
  */
  readonly actionParameter3?: string;
  /**
  * List of actions for the edge rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#actions PullzoneEdgerule#actions}
  */
  readonly actions?: PullzoneEdgeruleActions[] | cdktf.IResolvable;
  /**
  * The description of the edge rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#description PullzoneEdgerule#description}
  */
  readonly description?: string;
  /**
  * Indicates whether the edge rule is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#enabled PullzoneEdgerule#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Options: `MatchAll`, `MatchAny`, `MatchNone`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#match_type PullzoneEdgerule#match_type}
  */
  readonly matchType?: string;
  /**
  * The priority of the edge rule. The lower number is executed first.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#priority PullzoneEdgerule#priority}
  */
  readonly priority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#pullzone PullzoneEdgerule#pullzone}
  */
  readonly pullzone: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#triggers PullzoneEdgerule#triggers}
  */
  readonly triggers: PullzoneEdgeruleTriggers[] | cdktf.IResolvable;
}
export interface PullzoneEdgeruleActions {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#parameter1 PullzoneEdgerule#parameter1}
  */
  readonly parameter1?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#parameter2 PullzoneEdgerule#parameter2}
  */
  readonly parameter2?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#parameter3 PullzoneEdgerule#parameter3}
  */
  readonly parameter3?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#type PullzoneEdgerule#type}
  */
...
export interface PullzoneEdgeruleTriggers {
  ...
  */
  readonly parameter2: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#patterns PullzoneEdgerule#patterns}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule bunnynet_pullzone_edgerule}
*/
export class PullzoneEdgerule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PullzoneEdgerule that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/pullzone_edgerule bunnynet_pullzone_edgerule} Resource
  *
  * @param scope The scope in which to define this construct
