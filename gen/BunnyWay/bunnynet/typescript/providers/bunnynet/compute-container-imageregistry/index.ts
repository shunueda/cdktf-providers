// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/compute_container_imageregistry
...
export interface ComputeContainerImageregistryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/compute_container_imageregistry#registry ComputeContainerImageregistry#registry}
  */
  readonly registry: string;
  /**
  * The token used to authenticate to the registry. If you are importing a resource, declare the token as an empty string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/compute_container_imageregistry#token ComputeContainerImageregistry#token}
  */
  readonly token: string;
  /**
  * The username used to authenticate to the registry.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/compute_container_imageregistry#username ComputeContainerImageregistry#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/compute_container_imageregistry bunnynet_compute_container_imageregistry}
*/
export class ComputeContainerImageregistry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeContainerImageregistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/compute_container_imageregistry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/compute_container_imageregistry bunnynet_compute_container_imageregistry} Resource
  *
  * @param scope The scope in which to define this construct
