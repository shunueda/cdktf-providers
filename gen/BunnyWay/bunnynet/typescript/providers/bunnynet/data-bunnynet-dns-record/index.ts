// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/data-sources/dns_record
...
export interface DataBunnynetDnsRecordConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/data-sources/dns_record#id DataBunnynetDnsRecord#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/data-sources/dns_record#name DataBunnynetDnsRecord#name}
  */
  readonly name: string;
  /**
  * Options: `A`, `AAAA`, `CAA`, `CNAME`, `Flatten`, `MX`, `NS`, `PTR`, `PullZone`, `Redirect`, `SRV`, `Script`, `TXT`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/data-sources/dns_record#type DataBunnynetDnsRecord#type}
  */
  readonly type: string;
  /**
  * ID of the related DNS zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/data-sources/dns_record#zone DataBunnynetDnsRecord#zone}
  */
  readonly zone: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/data-sources/dns_record bunnynet_dns_record}
*/
export class DataBunnynetDnsRecord extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBunnynetDnsRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/data-sources/dns_record#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/data-sources/dns_record bunnynet_dns_record} Data Source
  *
  * @param scope The scope in which to define this construct
