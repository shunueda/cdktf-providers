// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/pullzone_hostname
...
export interface PullzoneHostnameConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/pullzone_hostname#certificate PullzoneHostname#certificate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/pullzone_hostname#certificate_key PullzoneHostname#certificate_key}
  */
  readonly certificateKey?: string;
  /**
  * Indicates whether SSL should be enforced for the hostname.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/pullzone_hostname#force_ssl PullzoneHostname#force_ssl}
  */
  readonly forceSsl?: boolean | cdktf.IResolvable;
  /**
  * The hostname value for the domain name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/pullzone_hostname#name PullzoneHostname#name}
  */
  readonly name: string;
  /**
  * The ID of the linked pull zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/pullzone_hostname#pullzone PullzoneHostname#pullzone}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/pullzone_hostname#tls_enabled PullzoneHostname#tls_enabled}
  */
  readonly tlsEnabled?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/pullzone_hostname bunnynet_pullzone_hostname}
*/
export class PullzoneHostname extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PullzoneHostname that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/pullzone_hostname#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/pullzone_hostname bunnynet_pullzone_hostname} Resource
  *
  * @param scope The scope in which to define this construct
