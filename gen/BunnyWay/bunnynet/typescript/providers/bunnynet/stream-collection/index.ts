// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/resources/stream_collection
...
export interface StreamCollectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/resources/stream_collection#library StreamCollection#library}
  */
  readonly library: number;
  /**
  * The name of the stream collection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/resources/stream_collection#name StreamCollection#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/resources/stream_collection bunnynet_stream_collection}
*/
export class StreamCollection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamCollection that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/resources/stream_collection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/resources/stream_collection bunnynet_stream_collection} Resource
  *
  * @param scope The scope in which to define this construct
