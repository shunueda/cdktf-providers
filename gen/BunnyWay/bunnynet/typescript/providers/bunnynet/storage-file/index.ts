// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/storage_file
...
export interface StorageFileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/storage_file#content StorageFile#content}
  */
  readonly content?: string;
  /**
  * Specifies the content type of the file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/storage_file#content_type StorageFile#content_type}
  */
  readonly contentType?: string;
  /**
  * The path of the file within the storage zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/storage_file#path StorageFile#path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/storage_file#source StorageFile#source}
  */
  readonly source?: string;
  /**
  * The ID of the storage zone where the file is stored.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/storage_file#zone StorageFile#zone}
  */
  readonly zone: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/storage_file bunnynet_storage_file}
*/
export class StorageFile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/storage_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs/resources/storage_file bunnynet_storage_file} Resource
  *
  * @param scope The scope in which to define this construct
