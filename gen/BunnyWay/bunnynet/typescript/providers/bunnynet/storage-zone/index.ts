// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/storage_zone
...
export interface StorageZoneConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/storage_zone#custom_404_file_path StorageZone#custom_404_file_path}
  */
  readonly custom404FilePath?: string;
  /**
  * The name of the storage zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/storage_zone#name StorageZone#name}
  */
  readonly name: string;
  /**
  * The region where the storage zone is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/storage_zone#region StorageZone#region}
  */
  readonly region: string;
  /**
  * A set of regions for data replication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/storage_zone#replication_regions StorageZone#replication_regions}
  */
  readonly replicationRegions?: string[];
  /**
  * Indicates whether to rewrite 404 errors to 200 status.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/storage_zone#rewrite_404_to_200 StorageZone#rewrite_404_to_200}
  */
  readonly rewrite404To200?: boolean | cdktf.IResolvable;
  /**
  * Options: `Edge`, `Standard`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/storage_zone#zone_tier StorageZone#zone_tier}
  */
  readonly zoneTier: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/storage_zone bunnynet_storage_zone}
*/
export class StorageZone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/storage_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/resources/storage_zone bunnynet_storage_zone} Resource
  *
  * @param scope The scope in which to define this construct
