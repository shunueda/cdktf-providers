// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/pullzone_access_list
...
export interface PullzoneAccessListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/pullzone_access_list#action PullzoneAccessList#action}
  */
  readonly action: string;
  /**
  * Indicated whether the Access List is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/pullzone_access_list#enabled PullzoneAccessList#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The Access List entries.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/pullzone_access_list#entries PullzoneAccessList#entries}
  */
  readonly entries: string[];
  /**
  * The Access List name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/pullzone_access_list#name PullzoneAccessList#name}
  */
  readonly name: string;
  /**
  * The ID of the linked pullzone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/pullzone_access_list#pullzone PullzoneAccessList#pullzone}
  */
  readonly pullzone: number;
  /**
  * Options: `ASN`, `CIDR`, `Country`, `IP`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/pullzone_access_list#type PullzoneAccessList#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/pullzone_access_list bunnynet_pullzone_access_list}
*/
export class PullzoneAccessList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PullzoneAccessList that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/pullzone_access_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/resources/pullzone_access_list bunnynet_pullzone_access_list} Resource
  *
  * @param scope The scope in which to define this construct
