// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record
...
export interface DnsRecordConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#accelerated DnsRecord#accelerated}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#comment DnsRecord#comment}
  */
  readonly comment?: string;
  /**
  * Indicates whether the DNS record is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#enabled DnsRecord#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Flags for advanced DNS settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#flags DnsRecord#flags}
  */
  readonly flags?: number;
  /**
  * The latitude for geolocation-based routing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#geolocation_lat DnsRecord#geolocation_lat}
  */
  readonly geolocationLat?: number;
  /**
  * The longitude for geolocation-based routing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#geolocation_long DnsRecord#geolocation_long}
  */
  readonly geolocationLong?: number;
  /**
  * The latency zone for latency-based routing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#latency_zone DnsRecord#latency_zone}
  */
  readonly latencyZone?: string;
  /**
  * Options: `Http`, `Monitor`, `None`, `Ping`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#monitor_type DnsRecord#monitor_type}
  */
  readonly monitorType?: string;
  /**
  * The name of the DNS record. Use <code>name = ""</code> for apex domain records.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#name DnsRecord#name}
  */
  readonly name: string;
  /**
  * The port number for services that require a specific port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#port DnsRecord#port}
  */
  readonly port?: number;
  /**
  * The priority of the DNS record.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#priority DnsRecord#priority}
  */
  readonly priority?: number;
  /**
  * The ID of the linked pullzone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#pullzone_id DnsRecord#pullzone_id}
  */
  readonly pullzoneId?: number;
  /**
  * Options: `Geolocation`, `Latency`, `None`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#smart_routing_type DnsRecord#smart_routing_type}
  */
  readonly smartRoutingType?: string;
  /**
  * A tag for the DNS record.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#tag DnsRecord#tag}
  */
  readonly tag?: string;
  /**
  * The time-to-live value for the DNS record.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#ttl DnsRecord#ttl}
  */
  readonly ttl?: number;
  /**
  * Options: `A`, `AAAA`, `CAA`, `CNAME`, `Flatten`, `MX`, `NS`, `PTR`, `PullZone`, `Redirect`, `SRV`, `Script`, `TXT`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#type DnsRecord#type}
  */
  readonly type: string;
  /**
  * The value of the DNS record.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#value DnsRecord#value}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#weight DnsRecord#weight}
  */
  readonly weight?: number;
  /**
  * ID of the related DNS zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#zone DnsRecord#zone}
  */
  readonly zone: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record bunnynet_dns_record}
*/
export class DnsRecord extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.3/docs/resources/dns_record bunnynet_dns_record} Resource
  *
  * @param scope The scope in which to define this construct
