// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/region
...
export interface DataBunnynetRegionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/region#region_code DataBunnynetRegion#region_code}
  */
  readonly regionCode: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/region bunnynet_region}
*/
export class DataBunnynetRegion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBunnynetRegion that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/region#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/region bunnynet_region} Data Source
  *
  * @param scope The scope in which to define this construct
