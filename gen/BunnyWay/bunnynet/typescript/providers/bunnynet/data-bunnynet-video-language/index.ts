// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/video_language
...
export interface DataBunnynetVideoLanguageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/video_language#code DataBunnynetVideoLanguage#code}
  */
  readonly code: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/video_language bunnynet_video_language}
*/
export class DataBunnynetVideoLanguage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBunnynetVideoLanguage that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/video_language#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.1/docs/data-sources/video_language bunnynet_video_language} Data Source
  *
  * @param scope The scope in which to define this construct
