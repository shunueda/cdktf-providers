// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/data-sources/compute_container_app_container
...
export interface DataBunnynetComputeContainerAppContainerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/data-sources/compute_container_app_container#app DataBunnynetComputeContainerAppContainer#app}
  */
  readonly app: string;
  /**
  * The container name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/data-sources/compute_container_app_container#name DataBunnynetComputeContainerAppContainer#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/data-sources/compute_container_app_container bunnynet_compute_container_app_container}
*/
export class DataBunnynetComputeContainerAppContainer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBunnynetComputeContainerAppContainer that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/data-sources/compute_container_app_container#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.0/docs/data-sources/compute_container_app_container bunnynet_compute_container_app_container} Data Source
  *
  * @param scope The scope in which to define this construct
