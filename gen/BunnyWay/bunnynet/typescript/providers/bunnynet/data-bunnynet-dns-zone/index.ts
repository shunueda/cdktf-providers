// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/data-sources/dns_zone
...
export interface DataBunnynetDnsZoneConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/data-sources/dns_zone#dnssec_enabled DataBunnynetDnsZone#dnssec_enabled}
  */
  readonly dnssecEnabled?: boolean | cdktf.IResolvable;
  /**
  * The domain name for the DNS zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/data-sources/dns_zone#domain DataBunnynetDnsZone#domain}
  */
  readonly domain: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/data-sources/dns_zone bunnynet_dns_zone}
*/
export class DataBunnynetDnsZone extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBunnynetDnsZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/data-sources/dns_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.4/docs/data-sources/dns_zone bunnynet_dns_zone} Data Source
  *
  * @param scope The scope in which to define this construct
