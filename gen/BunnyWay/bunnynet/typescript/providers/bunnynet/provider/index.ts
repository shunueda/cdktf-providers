// https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs
...
export interface BunnynetProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs#api_key BunnynetProvider#api_key}
  */
  readonly apiKey?: string;
  /**
  * Optional. The API URL. Defaults to `https://api.bunny.net`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs#api_url BunnynetProvider#api_url}
  */
  readonly apiUrl?: string;
  /**
  * Optional. The Container API URL. Defaults to `https://api-mc.opsbunny.net`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs#container_api_url BunnynetProvider#container_api_url}
  */
  readonly containerApiUrl?: string;
  /**
  * Optional. The Stream API URL. Defaults to `https://video.bunnycdn.com`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs#stream_api_url BunnynetProvider#stream_api_url}
  */
  readonly streamApiUrl?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs#alias BunnynetProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs bunnynet}
*/
export class BunnynetProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing BunnynetProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bunnyway/bunnynet/0.11.2/docs bunnynet} Resource
  *
  * @param scope The scope in which to define this construct
