// https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline
...
export interface EntityMatchingPipelineConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#description EntityMatchingPipeline#description}
  */
  readonly description?: string;
  /**
  * The display name for the instance. Can be updated without creating a new resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#display_name EntityMatchingPipeline#display_name}
  */
  readonly displayName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#id EntityMatchingPipeline#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#location EntityMatchingPipeline#location}
  */
  readonly location: string;
  /**
  * Unique client assigned immutable identifier. Can not be updated without creating a new resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#name EntityMatchingPipeline#name}
  */
  readonly name: string;
  /**
  * RerunInterval is the time between scheduled re-runs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#rerun_interval EntityMatchingPipeline#rerun_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#similarity_score_cutoff EntityMatchingPipeline#similarity_score_cutoff}
  */
  readonly similarityScoreCutoff?: number;
  /**
  * List of source node types to be used in the entity matching pipeline.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#source_node_filter EntityMatchingPipeline#source_node_filter}
  */
  readonly sourceNodeFilter: string[];
  /**
  * List of target node types to be used in the entity matching pipeline.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#target_node_filter EntityMatchingPipeline#target_node_filter}
  */
  readonly targetNodeFilter: string[];
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#timeouts EntityMatchingPipeline#timeouts}
  */
  readonly timeouts?: EntityMatchingPipelineTimeouts;
}
export interface EntityMatchingPipelineTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#create EntityMatchingPipeline#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#default EntityMatchingPipeline#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#delete EntityMatchingPipeline#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#read EntityMatchingPipeline#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#update EntityMatchingPipeline#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline indykite_entity_matching_pipeline}
*/
export class EntityMatchingPipeline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EntityMatchingPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/entity_matching_pipeline indykite_entity_matching_pipeline} Resource
  *
  * @param scope The scope in which to define this construct
