// https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline
...
export interface IngestPipelineConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#app_agent_token IngestPipeline#app_agent_token}
  */
  readonly appAgentToken: string;
  /**
  * Your own description of the resource. Must be less than or equal to 65000 UTF-8 bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#description IngestPipeline#description}
  */
  readonly description?: string;
  /**
  * The display name for the instance. Can be updated without creating a new resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#display_name IngestPipeline#display_name}
  */
  readonly displayName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#id IngestPipeline#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#location IngestPipeline#location}
  */
  readonly location: string;
  /**
  * Unique client assigned immutable identifier. Can not be updated without creating a new resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#name IngestPipeline#name}
  */
  readonly name: string;
  /**
  * List of operations is no longer used. All previously saved values are ignored.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#operations IngestPipeline#operations}
  */
  readonly operations?: string[];
  /**
  * List of sources to be used in the ingest pipeline.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#sources IngestPipeline#sources}
  */
  readonly sources: string[];
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#timeouts IngestPipeline#timeouts}
  */
  readonly timeouts?: IngestPipelineTimeouts;
}
export interface IngestPipelineTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#create IngestPipeline#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#default IngestPipeline#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#delete IngestPipeline#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#read IngestPipeline#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#update IngestPipeline#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline indykite_ingest_pipeline}
*/
export class IngestPipeline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IngestPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/indykite/indykite/0.29.0/docs/resources/ingest_pipeline indykite_ingest_pipeline} Resource
  *
  * @param scope The scope in which to define this construct
