...
export interface RealmKeystoreAesGeneratedConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class RealmKeystoreAesGenerated extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "keycloak_realm_keystore_aes_generated";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "keycloak_realm_keystore_aes_generated", importId: importFromId, provider });
      }
  ...
  * @param options RealmKeystoreAesGeneratedConfig
  */
  public constructor(scope: Construct, id: string, config: RealmKeystoreAesGeneratedConfig) {
    super(scope, id, {
