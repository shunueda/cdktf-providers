// https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/openid_client_scope
...
export interface DataKeycloakOpenidClientScopeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/openid_client_scope#id DataKeycloakOpenidClientScope#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/openid_client_scope#name DataKeycloakOpenidClientScope#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/openid_client_scope#realm_id DataKeycloakOpenidClientScope#realm_id}
  */
  readonly realmId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/openid_client_scope keycloak_openid_client_scope}
*/
export class DataKeycloakOpenidClientScope extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKeycloakOpenidClientScope that should be imported. Refer to the {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/openid_client_scope#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/openid_client_scope keycloak_openid_client_scope} Data Source
  *
  * @param scope The scope in which to define this construct
