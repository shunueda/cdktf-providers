// https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_optional_client_scopes
...
export interface RealmOptionalClientScopesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_optional_client_scopes#id RealmOptionalClientScopes#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_optional_client_scopes#optional_scopes RealmOptionalClientScopes#optional_scopes}
  */
  readonly optionalScopes: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_optional_client_scopes#realm_id RealmOptionalClientScopes#realm_id}
  */
  readonly realmId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_optional_client_scopes keycloak_realm_optional_client_scopes}
*/
export class RealmOptionalClientScopes extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RealmOptionalClientScopes that should be imported. Refer to the {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_optional_client_scopes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_optional_client_scopes keycloak_realm_optional_client_scopes} Resource
  *
  * @param scope The scope in which to define this construct
