// https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_localization
...
export interface RealmLocalizationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_localization#id RealmLocalization#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_localization#locale RealmLocalization#locale}
  */
  readonly locale: string;
  /**
  * The realm in which the texts exists.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_localization#realm_id RealmLocalization#realm_id}
  */
  readonly realmId: string;
  /**
  * The mapping of localization texts keys to values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_localization#texts RealmLocalization#texts}
  */
  readonly texts?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_localization keycloak_realm_localization}
*/
export class RealmLocalization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RealmLocalization that should be imported. Refer to the {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_localization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/resources/realm_localization keycloak_realm_localization} Resource
  *
  * @param scope The scope in which to define this construct
