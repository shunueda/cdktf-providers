...
export class OidcIdentityProvider extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: OidcIdentityProviderConfig) {
    ...
    this._disableTypeClaimCheck = config.disableTypeClaimCheck;
  ...
  // disable_type_claim_check - computed: false, optional: true, required: false
  private _disableTypeClaimCheck?: boolean | cdktf.IResolvable; 
  public get disableTypeClaimCheck() {
    return this.getBooleanAttribute('disable_type_claim_check');
  }
  public set disableTypeClaimCheck(value: boolean | cdktf.IResolvable) {
    this._disableTypeClaimCheck = value;
  }
  public resetDisableTypeClaimCheck() {
    this._disableTypeClaimCheck = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get disableTypeClaimCheckInput() {
    return this._disableTypeClaimCheck;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      disable_type_claim_check: cdktf.booleanToTerraform(this._disableTypeClaimCheck),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      disable_type_claim_check: {
        value: cdktf.booleanToHclTerraform(this._disableTypeClaimCheck),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
