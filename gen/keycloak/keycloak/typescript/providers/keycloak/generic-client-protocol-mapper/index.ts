...
export interface GenericClientProtocolMapperConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GenericClientProtocolMapper extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "keycloak_generic_client_protocol_mapper";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "keycloak_generic_client_protocol_mapper", importId: importFromId, provider });
      }
  ...
  * @param options GenericClientProtocolMapperConfig
  */
  public constructor(scope: Construct, id: string, config: GenericClientProtocolMapperConfig) {
    super(scope, id, {
