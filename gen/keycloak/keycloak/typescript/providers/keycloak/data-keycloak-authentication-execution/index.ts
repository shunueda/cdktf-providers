// https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/authentication_execution
...
export interface DataKeycloakAuthenticationExecutionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/authentication_execution#id DataKeycloakAuthenticationExecution#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/authentication_execution#parent_flow_alias DataKeycloakAuthenticationExecution#parent_flow_alias}
  */
  readonly parentFlowAlias: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/authentication_execution#provider_id DataKeycloakAuthenticationExecution#provider_id}
  */
  readonly providerId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/authentication_execution#realm_id DataKeycloakAuthenticationExecution#realm_id}
  */
  readonly realmId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/authentication_execution keycloak_authentication_execution}
*/
export class DataKeycloakAuthenticationExecution extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKeycloakAuthenticationExecution that should be imported. Refer to the {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/authentication_execution#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/data-sources/authentication_execution keycloak_authentication_execution} Data Source
  *
  * @param scope The scope in which to define this construct
