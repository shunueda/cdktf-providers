...
export interface HardcodedAttributeMapperConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class HardcodedAttributeMapper extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "keycloak_hardcoded_attribute_mapper";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "keycloak_hardcoded_attribute_mapper", importId: importFromId, provider });
      }
  ...
  * @param options HardcodedAttributeMapperConfig
  */
  public constructor(scope: Construct, id: string, config: HardcodedAttributeMapperConfig) {
    super(scope, id, {
