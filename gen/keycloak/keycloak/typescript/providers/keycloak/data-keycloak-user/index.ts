// https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/data-sources/user
...
export interface DataKeycloakUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/data-sources/user#id DataKeycloakUser#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/data-sources/user#realm_id DataKeycloakUser#realm_id}
  */
  readonly realmId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/data-sources/user#username DataKeycloakUser#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/data-sources/user keycloak_user}
*/
export class DataKeycloakUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKeycloakUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/keycloak/keycloak/5.5.0/docs/data-sources/user keycloak_user} Data Source
  *
  * @param scope The scope in which to define this construct
