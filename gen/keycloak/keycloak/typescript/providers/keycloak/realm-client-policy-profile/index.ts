// https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/realm_client_policy_profile
...
export interface RealmClientPolicyProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/realm_client_policy_profile#description RealmClientPolicyProfile#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/realm_client_policy_profile#id RealmClientPolicyProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/realm_client_policy_profile#name RealmClientPolicyProfile#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/realm_client_policy_profile#realm_id RealmClientPolicyProfile#realm_id}
  */
  readonly realmId: string;
  /**
  * executor block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/realm_client_policy_profile#executor RealmClientPolicyProfile#executor}
  */
  readonly executor?: RealmClientPolicyProfileExecutor[] | cdktf.IResolvable;
}
export interface RealmClientPolicyProfileExecutor {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/realm_client_policy_profile#configuration RealmClientPolicyProfile#configuration}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/realm_client_policy_profile keycloak_realm_client_policy_profile}
*/
export class RealmClientPolicyProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RealmClientPolicyProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/realm_client_policy_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/realm_client_policy_profile keycloak_realm_client_policy_profile} Resource
  *
  * @param scope The scope in which to define this construct
