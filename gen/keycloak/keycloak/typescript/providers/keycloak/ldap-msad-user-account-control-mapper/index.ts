// https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/ldap_msad_user_account_control_mapper
...
export interface LdapMsadUserAccountControlMapperConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/ldap_msad_user_account_control_mapper#id LdapMsadUserAccountControlMapper#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/ldap_msad_user_account_control_mapper#ldap_password_policy_hints_enabled LdapMsadUserAccountControlMapper#ldap_password_policy_hints_enabled}
  */
  readonly ldapPasswordPolicyHintsEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ldap user federation provider to attach this mapper to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/ldap_msad_user_account_control_mapper#ldap_user_federation_id LdapMsadUserAccountControlMapper#ldap_user_federation_id}
  */
  readonly ldapUserFederationId: string;
  /**
  * Display name of the mapper when displayed in the console.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/ldap_msad_user_account_control_mapper#name LdapMsadUserAccountControlMapper#name}
  */
  readonly name: string;
  /**
  * The realm in which the ldap user federation provider exists.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/ldap_msad_user_account_control_mapper#realm_id LdapMsadUserAccountControlMapper#realm_id}
  */
  readonly realmId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/ldap_msad_user_account_control_mapper keycloak_ldap_msad_user_account_control_mapper}
*/
export class LdapMsadUserAccountControlMapper extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LdapMsadUserAccountControlMapper that should be imported. Refer to the {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/ldap_msad_user_account_control_mapper#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/keycloak/keycloak/5.6.0/docs/resources/ldap_msad_user_account_control_mapper keycloak_ldap_msad_user_account_control_mapper} Resource
  *
  * @param scope The scope in which to define this construct
