// https://registry.terraform.io/providers/artie-labs/artie/2.3.6/docs
...
export interface ArtieProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/artie-labs/artie/2.3.6/docs#api_key ArtieProvider#api_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/artie-labs/artie/2.3.6/docs#endpoint ArtieProvider#endpoint}
  */
  readonly endpoint?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/artie-labs/artie/2.3.6/docs#alias ArtieProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/artie-labs/artie/2.3.6/docs artie}
*/
export class ArtieProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ArtieProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/artie-labs/artie/2.3.6/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/artie-labs/artie/2.3.6/docs artie} Resource
  *
  * @param scope The scope in which to define this construct
