// https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/resources/protection_group_bucket
...
export interface ProtectionGroupBucketConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/resources/protection_group_bucket#bucket_id ProtectionGroupBucket#bucket_id}
  */
  readonly bucketId: string;
  /**
  * Unique identifier of the Protection Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/resources/protection_group_bucket#protection_group_id ProtectionGroupBucket#protection_group_id}
  */
  readonly protectionGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/resources/protection_group_bucket clumio_protection_group_bucket}
*/
export class ProtectionGroupBucket extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProtectionGroupBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/resources/protection_group_bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/resources/protection_group_bucket clumio_protection_group_bucket} Resource
  *
  * @param scope The scope in which to define this construct
