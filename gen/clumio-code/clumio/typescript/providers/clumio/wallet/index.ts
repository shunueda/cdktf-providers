// https://registry.terraform.io/providers/clumio-code/clumio/0.16.1/docs/resources/wallet
...
export interface WalletConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.16.1/docs/resources/wallet#account_native_id Wallet#account_native_id}
  */
  readonly accountNativeId: string;
  /**
  * The AWS region where the wallet is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.16.1/docs/resources/wallet#aws_region Wallet#aws_region}
  */
  readonly awsRegion?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/clumio-code/clumio/0.16.1/docs/resources/wallet clumio_wallet}
*/
export class Wallet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Wallet that should be imported. Refer to the {@link https://registry.terraform.io/providers/clumio-code/clumio/0.16.1/docs/resources/wallet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clumio-code/clumio/0.16.1/docs/resources/wallet clumio_wallet} Resource
  *
  * @param scope The scope in which to define this construct
