// https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/data-sources/protection_group_asset
...
export interface DataClumioProtectionGroupAssetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/data-sources/protection_group_asset#bucket_id DataClumioProtectionGroupAsset#bucket_id}
  */
  readonly bucketId: string;
  /**
  * Unique identifier of the Protection Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/data-sources/protection_group_asset#protection_group_id DataClumioProtectionGroupAsset#protection_group_id}
  */
  readonly protectionGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/data-sources/protection_group_asset clumio_protection_group_asset}
*/
export class DataClumioProtectionGroupAsset extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataClumioProtectionGroupAsset that should be imported. Refer to the {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/data-sources/protection_group_asset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/data-sources/protection_group_asset clumio_protection_group_asset} Data Source
  *
  * @param scope The scope in which to define this construct
