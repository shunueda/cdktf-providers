// https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/resources/aws_connection
...
export interface AwsConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/resources/aws_connection#account_native_id AwsConnection#account_native_id}
  */
  readonly accountNativeId: string;
  /**
  * Region of the AWS account to be linked with Clumio.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/resources/aws_connection#aws_region AwsConnection#aws_region}
  */
  readonly awsRegion: string;
  /**
  * Brief description to denote details of the connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/resources/aws_connection#description AwsConnection#description}
  */
  readonly description?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/resources/aws_connection clumio_aws_connection}
*/
export class AwsConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/resources/aws_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clumio-code/clumio/0.17.0/docs/resources/aws_connection clumio_aws_connection} Resource
  *
  * @param scope The scope in which to define this construct
