// https://registry.terraform.io/providers/strongdm/sdm/15.40.0/docs/resources/proxy_cluster_key
...
export interface ProxyClusterKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/strongdm/sdm/15.40.0/docs/resources/proxy_cluster_key#id ProxyClusterKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/strongdm/sdm/15.40.0/docs/resources/proxy_cluster_key#proxy_cluster_id ProxyClusterKey#proxy_cluster_id}
  */
  readonly proxyClusterId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/strongdm/sdm/15.40.0/docs/resources/proxy_cluster_key#timeouts ProxyClusterKey#timeouts}
  */
  readonly timeouts?: ProxyClusterKeyTimeouts;
}
export interface ProxyClusterKeyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/strongdm/sdm/15.40.0/docs/resources/proxy_cluster_key#create ProxyClusterKey#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/strongdm/sdm/15.40.0/docs/resources/proxy_cluster_key#default ProxyClusterKey#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/strongdm/sdm/15.40.0/docs/resources/proxy_cluster_key#delete ProxyClusterKey#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/strongdm/sdm/15.40.0/docs/resources/proxy_cluster_key#read ProxyClusterKey#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/strongdm/sdm/15.40.0/docs/resources/proxy_cluster_key sdm_proxy_cluster_key}
*/
export class ProxyClusterKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProxyClusterKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/strongdm/sdm/15.40.0/docs/resources/proxy_cluster_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/strongdm/sdm/15.40.0/docs/resources/proxy_cluster_key sdm_proxy_cluster_key} Resource
  *
  * @param scope The scope in which to define this construct
