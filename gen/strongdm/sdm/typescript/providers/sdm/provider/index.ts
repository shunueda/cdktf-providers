// https://registry.terraform.io/providers/strongdm/sdm/15.33.0/docs
...
export interface SdmProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/strongdm/sdm/15.33.0/docs#api_access_key SdmProvider#api_access_key}
  */
  readonly apiAccessKey?: string;
  /**
  * A base64 encoded secret key used to authenticate with the StrongDM API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/strongdm/sdm/15.33.0/docs#api_secret_key SdmProvider#api_secret_key}
  */
  readonly apiSecretKey?: string;
  /**
  * The host and port of the StrongDM API endpoint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/strongdm/sdm/15.33.0/docs#host SdmProvider#host}
  */
  readonly host?: string;
  /**
  * Whether experienced rate limits should cause the client to sleep instead of erroring out
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/strongdm/sdm/15.33.0/docs#retry_rate_limit_errors SdmProvider#retry_rate_limit_errors}
  */
  readonly retryRateLimitErrors?: boolean | cdktf.IResolvable;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/strongdm/sdm/15.33.0/docs#alias SdmProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/strongdm/sdm/15.33.0/docs sdm}
*/
export class SdmProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing SdmProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/strongdm/sdm/15.33.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/strongdm/sdm/15.33.0/docs sdm} Resource
  *
  * @param scope The scope in which to define this construct
