// https://registry.terraform.io/providers/drfaust92/google/4.16.4/docs/data-sources/monitoring_uptime_check_ips
...
export interface DataGoogleMonitoringUptimeCheckIpsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/drfaust92/google/4.16.4/docs/data-sources/monitoring_uptime_check_ips#id DataGoogleMonitoringUptimeCheckIps#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/drfaust92/google/4.16.4/docs/data-sources/monitoring_uptime_check_ips google_monitoring_uptime_check_ips}
*/
export class DataGoogleMonitoringUptimeCheckIps extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleMonitoringUptimeCheckIps that should be imported. Refer to the {@link https://registry.terraform.io/providers/drfaust92/google/4.16.4/docs/data-sources/monitoring_uptime_check_ips#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/drfaust92/google/4.16.4/docs/data-sources/monitoring_uptime_check_ips google_monitoring_uptime_check_ips} Data Source
  *
  * @param scope The scope in which to define this construct
