// https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration
...
export interface BetteruptimePrometheusIntegrationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Whether to call when a new incident is created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration#call BetteruptimePrometheusIntegration#call}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration#critical_alert BetteruptimePrometheusIntegration#critical_alert}
  */
  readonly criticalAlert?: boolean | cdktf.IResolvable;
  /**
  * Whether to send an email when a new incident is created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration#email BetteruptimePrometheusIntegration#email}
  */
  readonly email?: boolean | cdktf.IResolvable;
  /**
  * The name of the AWS CloudWatch Integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration#name BetteruptimePrometheusIntegration#name}
  */
  readonly name?: string;
  /**
  * Is the AWS CloudWatch integration paused.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration#paused BetteruptimePrometheusIntegration#paused}
  */
  readonly paused?: boolean | cdktf.IResolvable;
  /**
  * ID of the escalation policy associated with the AWS CloudWatch integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration#policy_id BetteruptimePrometheusIntegration#policy_id}
  */
  readonly policyId?: number;
  /**
  * Whether to send a push notification when a new incident is created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration#push BetteruptimePrometheusIntegration#push}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration#recovery_period BetteruptimePrometheusIntegration#recovery_period}
  */
  readonly recoveryPeriod?: number;
  /**
  * Whether to send an SMS when a new incident is created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration#sms BetteruptimePrometheusIntegration#sms}
  */
  readonly sms?: boolean | cdktf.IResolvable;
  /**
  * Used to specify the team the resource should be created in when using global tokens.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration#team_name BetteruptimePrometheusIntegration#team_name}
  */
  readonly teamName?: string;
  /**
  * How long we wait before escalating the incident alert to the team. In seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration#team_wait BetteruptimePrometheusIntegration#team_wait}
  */
  readonly teamWait?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration betteruptime_prometheus_integration}
*/
export class BetteruptimePrometheusIntegration extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "betteruptime_prometheus_integration";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a BetteruptimePrometheusIntegration resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the BetteruptimePrometheusIntegration to import
  * @param importFromId The id of the existing BetteruptimePrometheusIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the BetteruptimePrometheusIntegration to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "betteruptime_prometheus_integration", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_prometheus_integration betteruptime_prometheus_integration} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options BetteruptimePrometheusIntegrationConfig = {}
  */
  public constructor(scope: Construct, id: string, config: BetteruptimePrometheusIntegrationConfig = {}) {
    super(scope, id, {
