// https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration
...
export interface BetteruptimeElasticIntegrationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Whether to call when a new incident is created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration#call BetteruptimeElasticIntegration#call}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration#critical_alert BetteruptimeElasticIntegration#critical_alert}
  */
  readonly criticalAlert?: boolean | cdktf.IResolvable;
  /**
  * Whether to send an email when a new incident is created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration#email BetteruptimeElasticIntegration#email}
  */
  readonly email?: boolean | cdktf.IResolvable;
  /**
  * The name of the Elastic Integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration#name BetteruptimeElasticIntegration#name}
  */
  readonly name?: string;
  /**
  * Is the Elastic integration paused.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration#paused BetteruptimeElasticIntegration#paused}
  */
  readonly paused?: boolean | cdktf.IResolvable;
  /**
  * ID of the escalation policy associated with the Elastic integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration#policy_id BetteruptimeElasticIntegration#policy_id}
  */
  readonly policyId?: number;
  /**
  * Whether to send a push notification when a new incident is created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration#push BetteruptimeElasticIntegration#push}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration#recovery_period BetteruptimeElasticIntegration#recovery_period}
  */
  readonly recoveryPeriod?: number;
  /**
  * Whether to send an SMS when a new incident is created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration#sms BetteruptimeElasticIntegration#sms}
  */
  readonly sms?: boolean | cdktf.IResolvable;
  /**
  * Used to specify the team the resource should be created in when using global tokens.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration#team_name BetteruptimeElasticIntegration#team_name}
  */
  readonly teamName?: string;
  /**
  * How long we wait before escalating the incident alert to the team. In seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration#team_wait BetteruptimeElasticIntegration#team_wait}
  */
  readonly teamWait?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration betteruptime_elastic_integration}
*/
export class BetteruptimeElasticIntegration extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "betteruptime_elastic_integration";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a BetteruptimeElasticIntegration resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the BetteruptimeElasticIntegration to import
  * @param importFromId The id of the existing BetteruptimeElasticIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the BetteruptimeElasticIntegration to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "betteruptime_elastic_integration", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/betterstackhq/better-uptime/0.20.4/docs/resources/betteruptime_elastic_integration betteruptime_elastic_integration} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options BetteruptimeElasticIntegrationConfig = {}
  */
  public constructor(scope: Construct, id: string, config: BetteruptimeElasticIntegrationConfig = {}) {
    super(scope, id, {
