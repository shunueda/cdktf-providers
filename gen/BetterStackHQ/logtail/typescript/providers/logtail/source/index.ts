// https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source
...
export interface SourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#data_region Source#data_region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#ingesting_paused Source#ingesting_paused}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#live_tail_pattern Source#live_tail_pattern}
  */
  readonly liveTailPattern?: string;
  /**
  * Data retention for logs in days. There might be additional charges for longer retention.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#logs_retention Source#logs_retention}
  */
  readonly logsRetention?: number;
  /**
  * Data retention for metrics in days. There might be additional charges for longer retention.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#metrics_retention Source#metrics_retention}
  */
  readonly metricsRetention?: number;
  /**
  * The name of this source.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#name Source#name}
  */
  ...
  *     - `vercel_integration`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#platform Source#platform}
  */
  readonly platform: string;
  /**
  * For scrape platform types, how often to scrape the URLs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#scrape_frequency_secs Source#scrape_frequency_secs}
  */
  readonly scrapeFrequencySecs?: number;
  /**
  * Basic auth password for scraping.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#scrape_request_basic_auth_password Source#scrape_request_basic_auth_password}
  */
  readonly scrapeRequestBasicAuthPassword?: string;
  /**
  * Basic auth username for scraping.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#scrape_request_basic_auth_user Source#scrape_request_basic_auth_user}
  */
  readonly scrapeRequestBasicAuthUser?: string;
  /**
  * An array of request headers, each containing `name` and `value` fields.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#scrape_request_headers Source#scrape_request_headers}
  */
  readonly scrapeRequestHeaders?: { [key: string]: string }[] | cdktf.IResolvable;
  /**
  * For scrape platform types, the set of urls to scrape.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#scrape_urls Source#scrape_urls}
  */
  readonly scrapeUrls?: string[];
  /**
  * The ID of the source group this source belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#source_group_id Source#source_group_id}
  */
  readonly sourceGroupId?: number;
  /**
  * Used to specify the team the resource should be created in when using global tokens.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#team_name Source#team_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#vrl_transformation Source#vrl_transformation}
  */
  readonly vrlTransformation?: string;
  /**
  * custom_bucket block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#custom_bucket Source#custom_bucket}
  */
...
export interface SourceCustomBucket {
  ...
  * Access key ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#access_key_id Source#access_key_id}
  */
  readonly accessKeyId: string;
  /**
  * Bucket endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#endpoint Source#endpoint}
  */
  readonly endpoint: string;
  /**
  * Whether we should keep data in the bucket after the retention period.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#keep_data_after_retention Source#keep_data_after_retention}
  */
  ...
  * Secret access key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#secret_access_key Source#secret_access_key}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source logtail_source}
*/
export class Source extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Source that should be imported. Refer to the {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/resources/source logtail_source} Resource
  *
  * @param scope The scope in which to define this construct
