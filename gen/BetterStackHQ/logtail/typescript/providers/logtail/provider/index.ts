// https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs
...
export interface LogtailProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs#api_token LogtailProvider#api_token}
  */
  readonly apiToken: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs#alias LogtailProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs logtail}
*/
export class LogtailProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing LogtailProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs logtail} Resource
  *
  * @param scope The scope in which to define this construct
