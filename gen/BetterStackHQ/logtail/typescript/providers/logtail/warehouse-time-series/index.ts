// https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/warehouse_time_series
...
export interface WarehouseTimeSeriesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/warehouse_time_series#aggregations WarehouseTimeSeries#aggregations}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/warehouse_time_series#expression_index WarehouseTimeSeries#expression_index}
  */
  readonly expressionIndex?: string;
  /**
  * The name of the time series. Must contain only letters, numbers, and underscores.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/warehouse_time_series#name WarehouseTimeSeries#name}
  */
  readonly name: string;
  /**
  * The ID of the Warehouse source to create the time series for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/warehouse_time_series#source_id WarehouseTimeSeries#source_id}
  */
  readonly sourceId: string;
  /**
  * The SQL expression used to compute the time series. For example `JSONExtract(raw, 'response_time', 'Nullable(Float64)')`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/warehouse_time_series#sql_expression WarehouseTimeSeries#sql_expression}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/warehouse_time_series#type WarehouseTimeSeries#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/warehouse_time_series#vector_dimension WarehouseTimeSeries#vector_dimension}
  */
  readonly vectorDimension?: number;
  /**
  * The distance function to use for vector similarity (e.g., `cosine`, `l2`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/warehouse_time_series#vector_distance_function WarehouseTimeSeries#vector_distance_function}
  */
  readonly vectorDistanceFunction?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/warehouse_time_series logtail_warehouse_time_series}
*/
export class WarehouseTimeSeries extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WarehouseTimeSeries that should be imported. Refer to the {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/warehouse_time_series#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/warehouse_time_series logtail_warehouse_time_series} Resource
  *
  * @param scope The scope in which to define this construct
