// https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/connection
...
export interface ConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/connection#client_type Connection#client_type}
  */
  readonly clientType: string;
  /**
  * Data region or private cluster name. Permitted values: `us_east`, `us_west`, `germany`, `singapore`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/connection#data_region Connection#data_region}
  */
  readonly dataRegion?: string;
  /**
  * Array of IP addresses or CIDR ranges that are allowed to use this connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/connection#ip_allowlist Connection#ip_allowlist}
  */
  readonly ipAllowlist?: string[];
  /**
  * A descriptive note for the connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/connection#note Connection#note}
  */
  readonly note?: string;
  /**
  * Array of team IDs to associate with the connection. Only one of `team_names` or `team_ids` should be provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/connection#team_ids Connection#team_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/connection#team_names Connection#team_names}
  */
  readonly teamNames?: string[];
  /**
  * ISO 8601 timestamp when the connection expires.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/connection#valid_until Connection#valid_until}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/connection logtail_connection}
*/
export class Connection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Connection that should be imported. Refer to the {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/connection logtail_connection} Resource
  *
  * @param scope The scope in which to define this construct
