// https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source
...
export interface WarehouseSourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#data_region WarehouseSource#data_region}
  */
  readonly dataRegion?: string;
  /**
  * The retention period for event data in days. Default is 9999999 days (effectively infinite).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#events_retention WarehouseSource#events_retention}
  */
  readonly eventsRetention?: number;
  /**
  * This property allows you to temporarily pause data ingesting for this source.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#ingesting_paused WarehouseSource#ingesting_paused}
  */
  readonly ingestingPaused?: boolean | cdktf.IResolvable;
  /**
  * A display template for live tail messages. Default is `"{status} {message}"`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#live_tail_pattern WarehouseSource#live_tail_pattern}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#name WarehouseSource#name}
  */
  readonly name: string;
  /**
  * Used to specify the team the resource should be created in when using global tokens.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#team_name WarehouseSource#team_name}
  */
  readonly teamName?: string;
  /**
  * The retention period for time series data in days. Default is 9999999 days (effectively infinite).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#time_series_retention WarehouseSource#time_series_retention}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#vrl_transformation WarehouseSource#vrl_transformation}
  */
  readonly vrlTransformation?: string;
  /**
  * The ID of the warehouse source group this source belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#warehouse_source_group_id WarehouseSource#warehouse_source_group_id}
  */
  readonly warehouseSourceGroupId: number;
  /**
  * custom_bucket block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#custom_bucket WarehouseSource#custom_bucket}
  */
...
export interface WarehouseSourceCustomBucket {
  ...
  * Access key ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#access_key_id WarehouseSource#access_key_id}
  */
  readonly accessKeyId: string;
  /**
  * Bucket endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#endpoint WarehouseSource#endpoint}
  */
  readonly endpoint: string;
  /**
  * Whether we should keep data in the bucket after the retention period.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#keep_data_after_retention WarehouseSource#keep_data_after_retention}
  */
  ...
  * Secret access key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#secret_access_key WarehouseSource#secret_access_key}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source logtail_warehouse_source}
*/
export class WarehouseSource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WarehouseSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_source logtail_warehouse_source} Resource
  *
  * @param scope The scope in which to define this construct
