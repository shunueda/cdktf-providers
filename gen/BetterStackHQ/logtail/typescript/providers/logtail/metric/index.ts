// https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/metric
...
export interface MetricConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/metric#aggregations Metric#aggregations}
  */
  readonly aggregations: string[];
  /**
  * The name of this metric.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/metric#name Metric#name}
  */
  readonly name: string;
  /**
  * The ID of the source this metric belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/metric#source_id Metric#source_id}
  */
  readonly sourceId: string;
  /**
  * The SQL expression used to extract the metric value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/metric#sql_expression Metric#sql_expression}
  */
  readonly sqlExpression: string;
  /**
  * The type of the metric.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/metric#type Metric#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/metric logtail_metric}
*/
export class Metric extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Metric that should be imported. Refer to the {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/metric#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/resources/metric logtail_metric} Resource
  *
  * @param scope The scope in which to define this construct
