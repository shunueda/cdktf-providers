// https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/data-sources/connection
...
export interface DataLogtailConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/data-sources/connection#id DataLogtailConnection#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/data-sources/connection logtail_connection}
*/
export class DataLogtailConnection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLogtailConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/data-sources/connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.3/docs/data-sources/connection logtail_connection} Data Source
  *
  * @param scope The scope in which to define this construct
