// https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/data-sources/source_group
...
export interface DataLogtailSourceGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/data-sources/source_group#name DataLogtailSourceGroup#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/data-sources/source_group logtail_source_group}
*/
export class DataLogtailSourceGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLogtailSourceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/data-sources/source_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.2/docs/data-sources/source_group logtail_source_group} Data Source
  *
  * @param scope The scope in which to define this construct
