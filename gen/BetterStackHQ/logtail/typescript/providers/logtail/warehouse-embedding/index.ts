// https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_embedding
...
export interface WarehouseEmbeddingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_embedding#dimension WarehouseEmbedding#dimension}
  */
  readonly dimension: number;
  /**
  * The source column name containing the text to embed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_embedding#embed_from WarehouseEmbedding#embed_from}
  */
  readonly embedFrom: string;
  /**
  * The target column name where the generated embeddings will be stored.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_embedding#embed_to WarehouseEmbedding#embed_to}
  */
  readonly embedTo: string;
  /**
  * The name of the embedding model to use (e.g., `embeddinggemma:300m`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_embedding#model WarehouseEmbedding#model}
  */
  readonly model: string;
  /**
  * The ID of the Warehouse source to create the embedding for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_embedding#source_id WarehouseEmbedding#source_id}
  */
  readonly sourceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_embedding logtail_warehouse_embedding}
*/
export class WarehouseEmbedding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WarehouseEmbedding that should be imported. Refer to the {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_embedding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/betterstackhq/logtail/0.7.1/docs/resources/warehouse_embedding logtail_warehouse_embedding} Resource
  *
  * @param scope The scope in which to define this construct
