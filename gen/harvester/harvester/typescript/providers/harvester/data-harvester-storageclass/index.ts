// https://registry.terraform.io/providers/harvester/harvester/1.6.0/docs/data-sources/storageclass
...
export interface DataHarvesterStorageclassConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harvester/harvester/1.6.0/docs/data-sources/storageclass#id DataHarvesterStorageclass#id}
  *
  ...
  * A unique name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harvester/harvester/1.6.0/docs/data-sources/storageclass#name DataHarvesterStorageclass#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harvester/harvester/1.6.0/docs/data-sources/storageclass harvester_storageclass}
*/
export class DataHarvesterStorageclass extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHarvesterStorageclass that should be imported. Refer to the {@link https://registry.terraform.io/providers/harvester/harvester/1.6.0/docs/data-sources/storageclass#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harvester/harvester/1.6.0/docs/data-sources/storageclass harvester_storageclass} Data Source
  *
  * @param scope The scope in which to define this construct
