// https://registry.terraform.io/providers/harvester/harvester/1.7.0/docs/resources/bootstrap
...
export interface BootstrapConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harvester/harvester/1.7.0/docs/resources/bootstrap#api_url Bootstrap#api_url}
  */
  readonly apiUrl: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harvester/harvester/1.7.0/docs/resources/bootstrap#id Bootstrap#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harvester/harvester/1.7.0/docs/resources/bootstrap#initial_password Bootstrap#initial_password}
  */
  readonly initialPassword?: string;
  /**
  * Path to store the kubeconfig file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harvester/harvester/1.7.0/docs/resources/bootstrap#kubeconfig Bootstrap#kubeconfig}
  */
  readonly kubeconfig?: string;
  /**
  * New password for admin user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/harvester/harvester/1.7.0/docs/resources/bootstrap#password Bootstrap#password}
  */
  readonly password: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/harvester/harvester/1.7.0/docs/resources/bootstrap harvester_bootstrap}
*/
export class Bootstrap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Bootstrap that should be imported. Refer to the {@link https://registry.terraform.io/providers/harvester/harvester/1.7.0/docs/resources/bootstrap#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/harvester/harvester/1.7.0/docs/resources/bootstrap harvester_bootstrap} Resource
  *
  * @param scope The scope in which to define this construct
