...
export interface CloudinitSecretConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function cloudinitSecretTimeoutsToTerraform(struct?: CloudinitSecretTimeouts | cdktf.IResolvable): any {
...
export function cloudinitSecretTimeoutsToHclTerraform(struct?: CloudinitSecretTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CloudinitSecretTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CloudinitSecretTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: CloudinitSecretTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class CloudinitSecret extends cdktf.TerraformResource {
  ...
  * @param options CloudinitSecretConfig
  */
  public constructor(scope: Construct, id: string, config: CloudinitSecretConfig) {
    super(scope, id, {
    ...
    this._networkDataBase64 = config.networkDataBase64;
  ...
  private _timeouts = new CloudinitSecretTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: CloudinitSecretTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      network_data_base64: cdktf.stringToTerraform(this._networkDataBase64),
      tags: cdktf.hashMapper(cdktf.stringToTerraform)(this._tags),
      user_data: cdktf.stringToTerraform(this._userData),
      user_data_base64: cdktf.stringToTerraform(this._userDataBase64),
      timeouts: cloudinitSecretTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      network_data: {
        value: cdktf.stringToHclTerraform(this._networkData),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      network_data_base64: {
        value: cdktf.stringToHclTerraform(this._networkDataBase64),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      timeouts: {
        value: cloudinitSecretTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "CloudinitSecretTimeouts",
      },
    };
