// https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/branding
...
export interface DataAuth0BrandingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/branding#id DataAuth0Branding#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/branding auth0_branding}
*/
export class DataAuth0Branding extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0Branding that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/branding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/branding auth0_branding} Data Source
  *
  * @param scope The scope in which to define this construct
