// https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer
...
export interface PromptScreenRendererConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer#context_configuration PromptScreenRenderer#context_configuration}
  */
  readonly contextConfiguration?: string[];
  /**
  * Override Universal Login default head tags
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer#default_head_tags_disabled PromptScreenRenderer#default_head_tags_disabled}
  */
  readonly defaultHeadTagsDisabled?: boolean | cdktf.IResolvable;
  /**
  * An array of head tags
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer#head_tags PromptScreenRenderer#head_tags}
  */
  readonly headTags?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer#id PromptScreenRenderer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer#prompt_type PromptScreenRenderer#prompt_type}
  */
  readonly promptType: string;
  /**
  * Rendering modeOptions are: `standard`, `advanced`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer#rendering_mode PromptScreenRenderer#rendering_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer#screen_name PromptScreenRenderer#screen_name}
  */
  readonly screenName: string;
  /**
  * Use page template with ACUL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer#use_page_template PromptScreenRenderer#use_page_template}
  */
  readonly usePageTemplate?: boolean | cdktf.IResolvable;
  /**
  * filters block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer#filters PromptScreenRenderer#filters}
  */
...
export interface PromptScreenRendererFilters {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer#clients PromptScreenRenderer#clients}
  */
  readonly clients?: string;
  /**
  * An array of domains identified by id or a metadata key/value pair. Entity Limit: 25.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer#domains PromptScreenRenderer#domains}
  */
  readonly domains?: string;
  /**
  * Type of match to apply. Options: `includes_any`, `excludes_any`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer#match_type PromptScreenRenderer#match_type}
  */
  readonly matchType: string;
  /**
  * An array of organizations identified by id or a metadata key/value pair. Entity Limit: 25.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer#organizations PromptScreenRenderer#organizations}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer auth0_prompt_screen_renderer}
*/
export class PromptScreenRenderer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PromptScreenRenderer that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_renderer auth0_prompt_screen_renderer} Resource
  *
  * @param scope The scope in which to define this construct
