// https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/data-sources/connection_profile
...
export interface DataAuth0ConnectionProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/data-sources/connection_profile#id DataAuth0ConnectionProfile#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/data-sources/connection_profile auth0_connection_profile}
*/
export class DataAuth0ConnectionProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0ConnectionProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/data-sources/connection_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/data-sources/connection_profile auth0_connection_profile} Data Source
  *
  * @param scope The scope in which to define this construct
