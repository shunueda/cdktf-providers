// https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream
...
export interface LogStreamConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#filters LogStream#filters}
  */
  readonly filters?: { [key: string]: string }[] | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#id LogStream#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#is_priority LogStream#is_priority}
  */
  readonly isPriority?: boolean | cdktf.IResolvable;
  /**
  * Name of the log stream.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#name LogStream#name}
  */
  readonly name: string;
  /**
  * The optional datetime (ISO 8601) to start streaming logs from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#start_from LogStream#start_from}
  */
  readonly startFrom?: string;
  /**
  * The current status of the log stream. Options are "active", "paused", "suspended".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#status LogStream#status}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#type LogStream#type}
  */
  readonly type: string;
  /**
  * pii_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#pii_config LogStream#pii_config}
  */
  readonly piiConfig?: LogStreamPiiConfig;
  /**
  * sink block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#sink LogStream#sink}
  */
...
export interface LogStreamPiiConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#algorithm LogStream#algorithm}
  */
  readonly algorithm?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#log_fields LogStream#log_fields}
  */
  readonly logFields: string[];
  /**
  * The method to use for PII handling. Options are `hash` or `mask`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#method LogStream#method}
  */
...
export interface LogStreamSink {
  ...
  * The AWS Account ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#aws_account_id LogStream#aws_account_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#aws_partner_event_source LogStream#aws_partner_event_source}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#aws_region LogStream#aws_region}
  */
  readonly awsRegion?: string;
  /**
  * Name of the Partner Topic to be used with Azure. Generally should not be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#azure_partner_topic LogStream#azure_partner_topic}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#azure_region LogStream#azure_region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#azure_resource_group LogStream#azure_resource_group}
  */
  readonly azureResourceGroup?: string;
  /**
  * The unique alphanumeric string that identifies your Azure subscription.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#azure_subscription_id LogStream#azure_subscription_id}
  */
  readonly azureSubscriptionId?: string;
  /**
  * The Datadog API key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#datadog_api_key LogStream#datadog_api_key}
  */
  readonly datadogApiKey?: string;
  /**
  * The Datadog region. Possible values: `us`, `eu`, `us3`, `us5`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#datadog_region LogStream#datadog_region}
  */
  readonly datadogRegion?: string;
  /**
  * Sent in the HTTP "Authorization" header with each request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#http_authorization LogStream#http_authorization}
  */
  readonly httpAuthorization?: string;
  /**
  * The format of data sent over HTTP. Options are "JSONLINES", "JSONARRAY" or "JSONOBJECT"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#http_content_format LogStream#http_content_format}
  */
  readonly httpContentFormat?: string;
  /**
  * The "Content-Type" header to send over HTTP. Common value is "application/json".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#http_content_type LogStream#http_content_type}
  */
  readonly httpContentType?: string;
  /**
  * Additional HTTP headers to be included as part of the HTTP request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#http_custom_headers LogStream#http_custom_headers}
  */
  readonly httpCustomHeaders?: { [key: string]: string }[] | cdktf.IResolvable;
  /**
  * The HTTP endpoint to send streaming logs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#http_endpoint LogStream#http_endpoint}
  */
  readonly httpEndpoint?: string;
  /**
  * The Mixpanel project ID, found on the Project Settings page.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#mixpanel_project_id LogStream#mixpanel_project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#mixpanel_region LogStream#mixpanel_region}
  */
  readonly mixpanelRegion?: string;
  /**
  * The Mixpanel Service Account password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#mixpanel_service_account_password LogStream#mixpanel_service_account_password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#mixpanel_service_account_username LogStream#mixpanel_service_account_username}
  */
  readonly mixpanelServiceAccountUsername?: string;
  /**
  * The [Segment Write Key](https://segment.com/docs/connections/find-writekey/).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#segment_write_key LogStream#segment_write_key}
  */
  readonly segmentWriteKey?: string;
  /**
  * The Splunk domain name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#splunk_domain LogStream#splunk_domain}
  */
  readonly splunkDomain?: string;
  /**
  * The Splunk port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#splunk_port LogStream#splunk_port}
  */
  readonly splunkPort?: string;
  /**
  * This toggle should be turned off when using self-signed certificates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#splunk_secure LogStream#splunk_secure}
  */
  readonly splunkSecure?: boolean | cdktf.IResolvable;
  /**
  * The Splunk access token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#splunk_token LogStream#splunk_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#sumo_source_address LogStream#sumo_source_address}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream auth0_log_stream}
*/
export class LogStream extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/log_stream auth0_log_stream} Resource
  *
  * @param scope The scope in which to define this construct
