// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/self_service_profile_custom_text
...
export interface SelfServiceProfileCustomTextConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/self_service_profile_custom_text#body SelfServiceProfileCustomText#body}
  */
  readonly body: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/self_service_profile_custom_text#id SelfServiceProfileCustomText#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/self_service_profile_custom_text#language SelfServiceProfileCustomText#language}
  */
  readonly language: string;
  /**
  * The page where the custom text is shown
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/self_service_profile_custom_text#page SelfServiceProfileCustomText#page}
  */
  readonly page: string;
  /**
  * The id of the self-service profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/self_service_profile_custom_text#sso_id SelfServiceProfileCustomText#sso_id}
  */
  readonly ssoId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/self_service_profile_custom_text auth0_self_service_profile_custom_text}
*/
export class SelfServiceProfileCustomText extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SelfServiceProfileCustomText that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/self_service_profile_custom_text#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/self_service_profile_custom_text auth0_self_service_profile_custom_text} Resource
  *
  * @param scope The scope in which to define this construct
