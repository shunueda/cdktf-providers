// https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/branding
...
export interface BrandingConfig extends cdktf.TerraformMetaArguments {
  ...
  * URL for the favicon.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/branding#favicon_url Branding#favicon_url}
  */
  readonly faviconUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/branding#id Branding#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/branding#logo_url Branding#logo_url}
  */
  readonly logoUrl?: string;
  /**
  * colors block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/branding#colors Branding#colors}
  */
  readonly colors?: BrandingColors;
  /**
  * font block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/branding#font Branding#font}
  */
  readonly font?: BrandingFont;
  /**
  * universal_login block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/branding#universal_login Branding#universal_login}
  */
...
export interface BrandingColors {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/branding#page_background Branding#page_background}
  */
  readonly pageBackground?: string;
  /**
  * Primary button background color in hexadecimal.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/branding#primary Branding#primary}
  */
...
export interface BrandingFont {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/branding#url Branding#url}
  */
  readonly url: string;
}
...
export interface BrandingUniversalLogin {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/branding#body Branding#body}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/branding auth0_branding}
*/
export class Branding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Branding that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/branding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/branding auth0_branding} Resource
  *
  * @param scope The scope in which to define this construct
