// https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/self_service_profile
...
export interface DataAuth0SelfServiceProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/self_service_profile#id DataAuth0SelfServiceProfile#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/self_service_profile auth0_self_service_profile}
*/
export class DataAuth0SelfServiceProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0SelfServiceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/self_service_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/self_service_profile auth0_self_service_profile} Data Source
  *
  * @param scope The scope in which to define this construct
