// https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/organization
...
export interface DataAuth0OrganizationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/organization#id DataAuth0Organization#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/organization#name DataAuth0Organization#name}
  */
  readonly name?: string;
  /**
  * The ID of the organization. If not provided, `name` must be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/organization#organization_id DataAuth0Organization#organization_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/organization auth0_organization}
*/
export class DataAuth0Organization extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0Organization that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/organization auth0_organization} Data Source
  *
  * @param scope The scope in which to define this construct
