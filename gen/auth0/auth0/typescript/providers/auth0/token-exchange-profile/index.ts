// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/token_exchange_profile
...
export interface TokenExchangeProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/token_exchange_profile#action_id TokenExchangeProfile#action_id}
  */
  readonly actionId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/token_exchange_profile#id TokenExchangeProfile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/token_exchange_profile#name TokenExchangeProfile#name}
  */
  readonly name: string;
  /**
  * Type of the subject token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/token_exchange_profile#subject_token_type TokenExchangeProfile#subject_token_type}
  */
  readonly subjectTokenType?: string;
  /**
  * Type of the token exchange profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/token_exchange_profile#type TokenExchangeProfile#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/token_exchange_profile auth0_token_exchange_profile}
*/
export class TokenExchangeProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TokenExchangeProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/token_exchange_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/token_exchange_profile auth0_token_exchange_profile} Resource
  *
  * @param scope The scope in which to define this construct
