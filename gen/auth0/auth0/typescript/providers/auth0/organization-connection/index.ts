// https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/organization_connection
...
export interface OrganizationConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/organization_connection#assign_membership_on_login OrganizationConnection#assign_membership_on_login}
  */
  readonly assignMembershipOnLogin?: boolean | cdktf.IResolvable;
  /**
  * The ID of the connection to enable for the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/organization_connection#connection_id OrganizationConnection#connection_id}
  */
  readonly connectionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/organization_connection#id OrganizationConnection#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/organization_connection#is_signup_enabled OrganizationConnection#is_signup_enabled}
  */
  readonly isSignupEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the organization to enable the connection for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/organization_connection#organization_id OrganizationConnection#organization_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/organization_connection#show_as_button OrganizationConnection#show_as_button}
  */
  readonly showAsButton?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/organization_connection auth0_organization_connection}
*/
export class OrganizationConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/organization_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/organization_connection auth0_organization_connection} Resource
  *
  * @param scope The scope in which to define this construct
