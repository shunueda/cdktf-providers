// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/connection_keys
...
export interface ConnectionKeysConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/connection_keys#connection_id ConnectionKeys#connection_id}
  */
  readonly connectionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/connection_keys#id ConnectionKeys#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/connection_keys#triggers ConnectionKeys#triggers}
  */
  readonly triggers: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/connection_keys auth0_connection_keys}
*/
export class ConnectionKeys extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectionKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/connection_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/connection_keys auth0_connection_keys} Resource
  *
  * @param scope The scope in which to define this construct
