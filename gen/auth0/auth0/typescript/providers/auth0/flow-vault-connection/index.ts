// https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/flow_vault_connection
...
export interface FlowVaultConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/flow_vault_connection#account_name FlowVaultConnection#account_name}
  */
  readonly accountName?: string;
  /**
  * App identifier of the vault connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/flow_vault_connection#app_id FlowVaultConnection#app_id}
  */
  readonly appId: string;
  /**
  * Environment of the vault connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/flow_vault_connection#environment FlowVaultConnection#environment}
  */
  readonly environment?: string;
  /**
  * Fingerprint of the vault connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/flow_vault_connection#fingerprint FlowVaultConnection#fingerprint}
  */
  readonly fingerprint?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/flow_vault_connection#id FlowVaultConnection#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/flow_vault_connection#name FlowVaultConnection#name}
  */
  readonly name: string;
  /**
  * Configuration of the vault connection. (Mapping information must be provided as key/value pairs)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/flow_vault_connection#setup FlowVaultConnection#setup}
  */
  readonly setup?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/flow_vault_connection auth0_flow_vault_connection}
*/
export class FlowVaultConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FlowVaultConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/flow_vault_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/flow_vault_connection auth0_flow_vault_connection} Resource
  *
  * @param scope The scope in which to define this construct
