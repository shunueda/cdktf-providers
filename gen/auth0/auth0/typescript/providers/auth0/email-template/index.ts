// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/email_template
...
export interface EmailTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/email_template#body EmailTemplate#body}
  */
  readonly body: string;
  /**
  * Indicates whether the template is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/email_template#enabled EmailTemplate#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/email_template#from EmailTemplate#from}
  */
  readonly from: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/email_template#id EmailTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/email_template#include_email_in_redirect EmailTemplate#include_email_in_redirect}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/email_template#result_url EmailTemplate#result_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/email_template#subject EmailTemplate#subject}
  */
  readonly subject: string;
  /**
  * Syntax of the template body. You can use either text or HTML with Liquid syntax.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/email_template#syntax EmailTemplate#syntax}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/email_template#template EmailTemplate#template}
  */
  readonly template: string;
  /**
  * Number of seconds during which the link within the email will be valid.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/email_template#url_lifetime_in_seconds EmailTemplate#url_lifetime_in_seconds}
  */
  readonly urlLifetimeInSeconds?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/email_template auth0_email_template}
*/
export class EmailTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/email_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/email_template auth0_email_template} Resource
  *
  * @param scope The scope in which to define this construct
