// https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/user_permission
...
export interface UserPermissionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/user_permission#id UserPermission#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/user_permission#permission UserPermission#permission}
  */
  readonly permission: string;
  /**
  * Identifier of the resource server that the permission is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/user_permission#resource_server_identifier UserPermission#resource_server_identifier}
  */
  readonly resourceServerIdentifier: string;
  /**
  * ID of the user to associate the permission to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/user_permission#user_id UserPermission#user_id}
  */
  readonly userId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/user_permission auth0_user_permission}
*/
export class UserPermission extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/user_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/user_permission auth0_user_permission} Resource
  *
  * @param scope The scope in which to define this construct
