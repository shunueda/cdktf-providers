// https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile
...
export interface SelfServiceProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile#allowed_strategies SelfServiceProfile#allowed_strategies}
  */
  readonly allowedStrategies?: string[];
  /**
  * The description of the self-service Profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile#description SelfServiceProfile#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile#id SelfServiceProfile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile#name SelfServiceProfile#name}
  */
  readonly name: string;
  /**
  * The ID of the user attribute profile to use for this self-service profile. Cannot be used with user_attributes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile#user_attribute_profile_id SelfServiceProfile#user_attribute_profile_id}
  */
  readonly userAttributeProfileId?: string;
  /**
  * branding block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile#branding SelfServiceProfile#branding}
  */
  readonly branding?: SelfServiceProfileBranding;
  /**
  * user_attributes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile#user_attributes SelfServiceProfile#user_attributes}
  */
...
export interface SelfServiceProfileBrandingColors {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile#primary SelfServiceProfile#primary}
  */
...
export interface SelfServiceProfileBranding {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile#logo_url SelfServiceProfile#logo_url}
  */
  readonly logoUrl?: string;
  /**
  * colors block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile#colors SelfServiceProfile#colors}
  */
...
export interface SelfServiceProfileUserAttributes {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile#is_optional SelfServiceProfile#is_optional}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile auth0_self_service_profile}
*/
export class SelfServiceProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SelfServiceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/self_service_profile auth0_self_service_profile} Resource
  *
  * @param scope The scope in which to define this construct
