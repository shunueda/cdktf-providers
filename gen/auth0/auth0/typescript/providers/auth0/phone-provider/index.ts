// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/phone_provider
...
export interface PhoneProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/phone_provider#disabled PhoneProvider#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/phone_provider#id PhoneProvider#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/phone_provider#name PhoneProvider#name}
  */
  readonly name: string;
  /**
  * configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/phone_provider#configuration PhoneProvider#configuration}
  */
  readonly configuration: PhoneProviderConfiguration;
  /**
  * credentials block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/phone_provider#credentials PhoneProvider#credentials}
  */
...
export interface PhoneProviderConfiguration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/phone_provider#default_from PhoneProvider#default_from}
  */
  readonly defaultFrom?: string;
  /**
  * Media set supported by a given provider to deliver a notification
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/phone_provider#delivery_methods PhoneProvider#delivery_methods}
  */
  readonly deliveryMethods: string[];
  /**
  * Twilio Messaging Service SID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/phone_provider#mssid PhoneProvider#mssid}
  */
  readonly mssid?: string;
  /**
  * Twilio Account SID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/phone_provider#sid PhoneProvider#sid}
  */
  readonly sid?: string;
}
...
export interface PhoneProviderCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/phone_provider#auth_token PhoneProvider#auth_token}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/phone_provider auth0_phone_provider}
*/
export class PhoneProvider extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PhoneProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/phone_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/phone_provider auth0_phone_provider} Resource
  *
  * @param scope The scope in which to define this construct
