// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/client_grants
...
export interface DataAuth0ClientGrantsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/client_grants#audience DataAuth0ClientGrants#audience}
  */
  readonly audience?: string;
  /**
  * The ID of the client to filter by.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/client_grants#client_id DataAuth0ClientGrants#client_id}
  */
  readonly clientId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/client_grants#id DataAuth0ClientGrants#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/client_grants auth0_client_grants}
*/
export class DataAuth0ClientGrants extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0ClientGrants that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/client_grants#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/client_grants auth0_client_grants} Data Source
  *
  * @param scope The scope in which to define this construct
