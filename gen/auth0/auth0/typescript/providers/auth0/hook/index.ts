// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/hook
...
export interface HookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/hook#dependencies Hook#dependencies}
  */
  readonly dependencies?: { [key: string]: string };
  /**
  * Whether the hook is enabled, or disabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/hook#enabled Hook#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/hook#id Hook#id}
  *
  ...
  * Name of this hook.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/hook#name Hook#name}
  */
  readonly name: string;
  /**
  * Code to be executed when this hook runs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/hook#script Hook#script}
  */
  readonly script: string;
  /**
  * The secrets associated with the hook.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/hook#secrets Hook#secrets}
  */
  readonly secrets?: { [key: string]: string };
  /**
  * Execution stage of this rule. Can be credentials-exchange, pre-user-registration, post-user-registration, post-change-password, or send-phone-message.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/hook#trigger_id Hook#trigger_id}
  */
  readonly triggerId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/hook auth0_hook}
*/
export class Hook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Hook that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/hook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/hook auth0_hook} Resource
  *
  * @param scope The scope in which to define this construct
