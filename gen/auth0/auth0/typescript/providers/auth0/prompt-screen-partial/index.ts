// https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial
...
export interface PromptScreenPartialConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial#id PromptScreenPartial#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial#prompt_type PromptScreenPartial#prompt_type}
  */
  readonly promptType: string;
  /**
  * The name of the screen associated with the partials
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial#screen_name PromptScreenPartial#screen_name}
  */
  readonly screenName: string;
  /**
  * insertion_points block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial#insertion_points PromptScreenPartial#insertion_points}
  */
...
export interface PromptScreenPartialInsertionPoints {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial#form_content PromptScreenPartial#form_content}
  */
  readonly formContent?: string;
  /**
  * Content that goes at the end of the form.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial#form_content_end PromptScreenPartial#form_content_end}
  */
  readonly formContentEnd?: string;
  /**
  * Content that goes at the start of the form.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial#form_content_start PromptScreenPartial#form_content_start}
  */
  readonly formContentStart?: string;
  /**
  * Footer content for the end of the footer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial#form_footer_end PromptScreenPartial#form_footer_end}
  */
  readonly formFooterEnd?: string;
  /**
  * Footer content for the start of the footer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial#form_footer_start PromptScreenPartial#form_footer_start}
  */
  readonly formFooterStart?: string;
  /**
  * Actions that go at the end of secondary actions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial#secondary_actions_end PromptScreenPartial#secondary_actions_end}
  */
  readonly secondaryActionsEnd?: string;
  /**
  * Actions that go at the start of secondary actions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial#secondary_actions_start PromptScreenPartial#secondary_actions_start}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial auth0_prompt_screen_partial}
*/
export class PromptScreenPartial extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PromptScreenPartial that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/prompt_screen_partial auth0_prompt_screen_partial} Resource
  *
  * @param scope The scope in which to define this construct
