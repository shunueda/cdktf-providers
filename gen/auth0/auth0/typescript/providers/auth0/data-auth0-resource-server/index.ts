// https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/resource_server
...
export interface DataAuth0ResourceServerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/resource_server#id DataAuth0ResourceServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/resource_server#identifier DataAuth0ResourceServer#identifier}
  */
  readonly identifier?: string;
  /**
  * The ID of the resource server. If not provided, `identifier` must be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/resource_server#resource_server_id DataAuth0ResourceServer#resource_server_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/resource_server auth0_resource_server}
*/
export class DataAuth0ResourceServer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0ResourceServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/resource_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/resource_server auth0_resource_server} Data Source
  *
  * @param scope The scope in which to define this construct
