// https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/pages
...
export interface PagesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/pages#id Pages#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/pages#change_password Pages#change_password}
  */
  readonly changePassword?: PagesChangePassword;
  /**
  * error block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/pages#error Pages#error}
  */
  readonly error?: PagesError;
  /**
  * guardian_mfa block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/pages#guardian_mfa Pages#guardian_mfa}
  */
  readonly guardianMfa?: PagesGuardianMfa;
  /**
  * login block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/pages#login Pages#login}
  */
...
export interface PagesChangePassword {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/pages#enabled Pages#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/pages#html Pages#html}
  */
...
export interface PagesError {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/pages#show_log_link Pages#show_log_link}
  */
  readonly showLogLink: boolean | cdktf.IResolvable;
  /**
  * URL to redirect to when an error occurs, instead of showing the default error page.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/pages#url Pages#url}
  */
  readonly url?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/pages auth0_pages}
*/
export class Pages extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Pages that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/pages#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/pages auth0_pages} Resource
  *
  * @param scope The scope in which to define this construct
