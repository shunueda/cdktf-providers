// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/connection_keys
...
export interface DataAuth0ConnectionKeysConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/connection_keys#connection_id DataAuth0ConnectionKeys#connection_id}
  */
  readonly connectionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/connection_keys#id DataAuth0ConnectionKeys#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/connection_keys auth0_connection_keys}
*/
export class DataAuth0ConnectionKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0ConnectionKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/connection_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/connection_keys auth0_connection_keys} Data Source
  *
  * @param scope The scope in which to define this construct
