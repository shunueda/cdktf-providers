// https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/organization_discovery_domain
...
export interface OrganizationDiscoveryDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/organization_discovery_domain#domain OrganizationDiscoveryDomain#domain}
  */
  readonly domain: string;
  /**
  * The ID of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/organization_discovery_domain#organization_id OrganizationDiscoveryDomain#organization_id}
  */
  readonly organizationId: string;
  /**
  * Verification status. Must be either 'pending' or 'verified'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/organization_discovery_domain#status OrganizationDiscoveryDomain#status}
  */
  readonly status: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/organization_discovery_domain auth0_organization_discovery_domain}
*/
export class OrganizationDiscoveryDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationDiscoveryDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/organization_discovery_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/organization_discovery_domain auth0_organization_discovery_domain} Resource
  *
  * @param scope The scope in which to define this construct
