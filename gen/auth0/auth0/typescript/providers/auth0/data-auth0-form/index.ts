// https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/form
...
export interface DataAuth0FormConfig extends cdktf.TerraformMetaArguments {
  ...
  * The id of the Form.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/form#id DataAuth0Form#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/form auth0_form}
*/
export class DataAuth0Form extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0Form that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/form#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/form auth0_form} Data Source
  *
  * @param scope The scope in which to define this construct
