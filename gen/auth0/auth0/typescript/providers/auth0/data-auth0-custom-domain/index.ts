// https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/custom_domain
...
export interface DataAuth0CustomDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/custom_domain#custom_domain_id DataAuth0CustomDomain#custom_domain_id}
  */
  readonly customDomainId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/custom_domain#id DataAuth0CustomDomain#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/custom_domain auth0_custom_domain}
*/
export class DataAuth0CustomDomain extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0CustomDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/custom_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/custom_domain auth0_custom_domain} Data Source
  *
  * @param scope The scope in which to define this construct
