// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/phone_provider
...
export interface DataAuth0PhoneProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/phone_provider#id DataAuth0PhoneProvider#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/phone_provider auth0_phone_provider}
*/
export class DataAuth0PhoneProvider extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0PhoneProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/phone_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/phone_provider auth0_phone_provider} Data Source
  *
  * @param scope The scope in which to define this construct
