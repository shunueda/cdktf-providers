// https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/data-sources/flow_vault_connection
...
export interface DataAuth0FlowVaultConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/data-sources/flow_vault_connection#id DataAuth0FlowVaultConnection#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/data-sources/flow_vault_connection auth0_flow_vault_connection}
*/
export class DataAuth0FlowVaultConnection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0FlowVaultConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/data-sources/flow_vault_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/data-sources/flow_vault_connection auth0_flow_vault_connection} Data Source
  *
  * @param scope The scope in which to define this construct
