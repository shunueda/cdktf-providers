// https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/role_permission
...
export interface RolePermissionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/role_permission#id RolePermission#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/role_permission#permission RolePermission#permission}
  */
  readonly permission: string;
  /**
  * Identifier of the resource server that the permission is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/role_permission#resource_server_identifier RolePermission#resource_server_identifier}
  */
  readonly resourceServerIdentifier: string;
  /**
  * ID of the role to associate the permission to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/role_permission#role_id RolePermission#role_id}
  */
  readonly roleId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/role_permission auth0_role_permission}
*/
export class RolePermission extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RolePermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/role_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/role_permission auth0_role_permission} Resource
  *
  * @param scope The scope in which to define this construct
