// https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/data-sources/outbound_ips
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/data-sources/outbound_ips auth0_outbound_ips}
*/
export class DataAuth0OutboundIps extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0OutboundIps that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/data-sources/outbound_ips#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/data-sources/outbound_ips auth0_outbound_ips} Data Source
  *
  * @param scope The scope in which to define this construct
