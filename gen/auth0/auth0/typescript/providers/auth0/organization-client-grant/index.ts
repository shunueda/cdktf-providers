// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_client_grant
...
export interface OrganizationClientGrantConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_client_grant#grant_id OrganizationClientGrant#grant_id}
  */
  readonly grantId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_client_grant#id OrganizationClientGrant#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_client_grant#organization_id OrganizationClientGrant#organization_id}
  */
  readonly organizationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_client_grant auth0_organization_client_grant}
*/
export class OrganizationClientGrant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationClientGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_client_grant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_client_grant auth0_organization_client_grant} Resource
  *
  * @param scope The scope in which to define this construct
