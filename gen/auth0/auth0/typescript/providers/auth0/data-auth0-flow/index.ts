// https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/flow
...
export interface DataAuth0FlowConfig extends cdktf.TerraformMetaArguments {
  ...
  * The id of the Flow.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/flow#id DataAuth0Flow#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/flow auth0_flow}
*/
export class DataAuth0Flow extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0Flow that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/flow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/flow auth0_flow} Data Source
  *
  * @param scope The scope in which to define this construct
