// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/event_stream
...
export interface DataAuth0EventStreamConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/event_stream#id DataAuth0EventStream#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/event_stream auth0_event_stream}
*/
export class DataAuth0EventStream extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0EventStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/event_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/event_stream auth0_event_stream} Data Source
  *
  * @param scope The scope in which to define this construct
