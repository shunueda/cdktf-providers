// https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/signing_keys
...
export interface DataAuth0SigningKeysConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/signing_keys#id DataAuth0SigningKeys#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/signing_keys auth0_signing_keys}
*/
export class DataAuth0SigningKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0SigningKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/signing_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/data-sources/signing_keys auth0_signing_keys} Data Source
  *
  * @param scope The scope in which to define this construct
