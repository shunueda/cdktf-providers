// https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials
...
export interface PromptScreenPartialsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials#id PromptScreenPartials#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials#prompt_type PromptScreenPartials#prompt_type}
  */
  readonly promptType: string;
  /**
  * screen_partials block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials#screen_partials PromptScreenPartials#screen_partials}
  */
...
export interface PromptScreenPartialsScreenPartialsInsertionPoints {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials#form_content PromptScreenPartials#form_content}
  */
  readonly formContent?: string;
  /**
  * Content that goes at the end of the form.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials#form_content_end PromptScreenPartials#form_content_end}
  */
  readonly formContentEnd?: string;
  /**
  * Content that goes at the start of the form.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials#form_content_start PromptScreenPartials#form_content_start}
  */
  readonly formContentStart?: string;
  /**
  * Footer content for the end of the footer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials#form_footer_end PromptScreenPartials#form_footer_end}
  */
  readonly formFooterEnd?: string;
  /**
  * Footer content for the start of the footer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials#form_footer_start PromptScreenPartials#form_footer_start}
  */
  readonly formFooterStart?: string;
  /**
  * Actions that go at the end of secondary actions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials#secondary_actions_end PromptScreenPartials#secondary_actions_end}
  */
  readonly secondaryActionsEnd?: string;
  /**
  * Actions that go at the start of secondary actions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials#secondary_actions_start PromptScreenPartials#secondary_actions_start}
  */
...
export interface PromptScreenPartialsScreenPartials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials#screen_name PromptScreenPartials#screen_name}
  */
  readonly screenName: string;
  /**
  * insertion_points block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials#insertion_points PromptScreenPartials#insertion_points}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials auth0_prompt_screen_partials}
*/
export class PromptScreenPartials extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PromptScreenPartials that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/prompt_screen_partials auth0_prompt_screen_partials} Resource
  *
  * @param scope The scope in which to define this construct
