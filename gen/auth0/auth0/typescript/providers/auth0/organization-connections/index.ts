// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_connections
...
export interface OrganizationConnectionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_connections#id OrganizationConnections#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_connections#organization_id OrganizationConnections#organization_id}
  */
  readonly organizationId: string;
  /**
  * enabled_connections block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_connections#enabled_connections OrganizationConnections#enabled_connections}
  */
...
export interface OrganizationConnectionsEnabledConnections {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_connections#assign_membership_on_login OrganizationConnections#assign_membership_on_login}
  */
  readonly assignMembershipOnLogin?: boolean | cdktf.IResolvable;
  /**
  * The ID of the connection to enable for the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_connections#connection_id OrganizationConnections#connection_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_connections#is_signup_enabled OrganizationConnections#is_signup_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_connections#show_as_button OrganizationConnections#show_as_button}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_connections auth0_organization_connections}
*/
export class OrganizationConnections extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationConnections that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_connections#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/organization_connections auth0_organization_connections} Resource
  *
  * @param scope The scope in which to define this construct
