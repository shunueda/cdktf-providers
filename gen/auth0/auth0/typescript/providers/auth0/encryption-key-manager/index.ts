// https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/encryption_key_manager
...
export interface EncryptionKeyManagerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/encryption_key_manager#id EncryptionKeyManager#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/encryption_key_manager#key_rotation_id EncryptionKeyManager#key_rotation_id}
  */
  readonly keyRotationId?: string;
  /**
  * customer_provided_root_key block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/encryption_key_manager#customer_provided_root_key EncryptionKeyManager#customer_provided_root_key}
  */
...
export interface EncryptionKeyManagerCustomerProvidedRootKey {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/encryption_key_manager#wrapped_key EncryptionKeyManager#wrapped_key}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/encryption_key_manager auth0_encryption_key_manager}
*/
export class EncryptionKeyManager extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EncryptionKeyManager that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/encryption_key_manager#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/encryption_key_manager auth0_encryption_key_manager} Resource
  *
  * @param scope The scope in which to define this construct
