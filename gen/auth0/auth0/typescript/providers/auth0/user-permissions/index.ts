// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/user_permissions
...
export interface UserPermissionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/user_permissions#id UserPermissions#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/user_permissions#user_id UserPermissions#user_id}
  */
  readonly userId: string;
  /**
  * permissions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/user_permissions#permissions UserPermissions#permissions}
  */
...
export interface UserPermissionsPermissions {
  ...
  * Name of permission.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/user_permissions#name UserPermissions#name}
  */
  readonly name: string;
  /**
  * Resource server identifier associated with the permission.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/user_permissions#resource_server_identifier UserPermissions#resource_server_identifier}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/user_permissions auth0_user_permissions}
*/
export class UserPermissions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserPermissions that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/user_permissions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/user_permissions auth0_user_permissions} Resource
  *
  * @param scope The scope in which to define this construct
