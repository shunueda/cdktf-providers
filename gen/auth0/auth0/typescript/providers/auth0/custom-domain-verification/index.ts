// https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/custom_domain_verification
...
export interface CustomDomainVerificationAConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/custom_domain_verification#custom_domain_id CustomDomainVerificationA#custom_domain_id}
  */
  readonly customDomainId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/custom_domain_verification#id CustomDomainVerificationA#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/custom_domain_verification#timeouts CustomDomainVerificationA#timeouts}
  */
  readonly timeouts?: CustomDomainVerificationTimeouts;
}
export interface CustomDomainVerificationTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/custom_domain_verification#create CustomDomainVerificationA#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/custom_domain_verification auth0_custom_domain_verification}
*/
export class CustomDomainVerificationA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomDomainVerificationA that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/custom_domain_verification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.34.0/docs/resources/custom_domain_verification auth0_custom_domain_verification} Resource
  *
  * @param scope The scope in which to define this construct
