// https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/risk_assessments_new_device
...
export interface RiskAssessmentsNewDeviceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/risk_assessments_new_device#id RiskAssessmentsNewDevice#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/risk_assessments_new_device#remember_for RiskAssessmentsNewDevice#remember_for}
  */
  readonly rememberFor: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/risk_assessments_new_device auth0_risk_assessments_new_device}
*/
export class RiskAssessmentsNewDevice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RiskAssessmentsNewDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/risk_assessments_new_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/risk_assessments_new_device auth0_risk_assessments_new_device} Resource
  *
  * @param scope The scope in which to define this construct
