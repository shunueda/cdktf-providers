// https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/connection_clients
...
export interface ConnectionClientsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/connection_clients#connection_id ConnectionClients#connection_id}
  */
  readonly connectionId: string;
  /**
  * IDs of the clients for which the connection is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/connection_clients#enabled_clients ConnectionClients#enabled_clients}
  */
  readonly enabledClients: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/connection_clients#id ConnectionClients#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/connection_clients auth0_connection_clients}
*/
export class ConnectionClients extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectionClients that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/connection_clients#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.36.0/docs/resources/connection_clients auth0_connection_clients} Resource
  *
  * @param scope The scope in which to define this construct
