// https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/custom_domain
...
export interface CustomDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/custom_domain#custom_client_ip_header CustomDomain#custom_client_ip_header}
  */
  readonly customClientIpHeader?: string;
  /**
  * Name of the custom domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/custom_domain#domain CustomDomain#domain}
  */
  readonly domain: string;
  /**
  * Metadata associated with the Custom Domain. Maximum of 10 metadata properties allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/custom_domain#domain_metadata CustomDomain#domain_metadata}
  */
  readonly domainMetadata?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/custom_domain#id CustomDomain#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/custom_domain#tls_policy CustomDomain#tls_policy}
  */
  readonly tlsPolicy?: string;
  /**
  * Provisioning type for the custom domain. Options include `auth0_managed_certs` and `self_managed_certs`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/custom_domain#type CustomDomain#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/custom_domain auth0_custom_domain}
*/
export class CustomDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/custom_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/resources/custom_domain auth0_custom_domain} Resource
  *
  * @param scope The scope in which to define this construct
