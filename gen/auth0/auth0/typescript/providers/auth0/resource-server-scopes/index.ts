// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/resource_server_scopes
...
export interface ResourceServerScopesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/resource_server_scopes#id ResourceServerScopes#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/resource_server_scopes#resource_server_identifier ResourceServerScopes#resource_server_identifier}
  */
  readonly resourceServerIdentifier: string;
  /**
  * scopes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/resource_server_scopes#scopes ResourceServerScopes#scopes}
  */
...
export interface ResourceServerScopesScopes {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/resource_server_scopes#description ResourceServerScopes#description}
  */
  readonly description?: string;
  /**
  * Name of the scope (permission). Examples include `read:appointments` or `delete:appointments`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/resource_server_scopes#name ResourceServerScopes#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/resource_server_scopes auth0_resource_server_scopes}
*/
export class ResourceServerScopes extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourceServerScopes that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/resource_server_scopes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/resources/resource_server_scopes auth0_resource_server_scopes} Resource
  *
  * @param scope The scope in which to define this construct
