// https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/branding_theme
...
export interface DataAuth0BrandingThemeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/branding_theme#id DataAuth0BrandingTheme#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/branding_theme auth0_branding_theme}
*/
export class DataAuth0BrandingTheme extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0BrandingTheme that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/branding_theme#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.37.0/docs/data-sources/branding_theme auth0_branding_theme} Data Source
  *
  * @param scope The scope in which to define this construct
