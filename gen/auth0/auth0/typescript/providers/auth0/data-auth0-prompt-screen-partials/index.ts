// https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/prompt_screen_partials
...
export interface DataAuth0PromptScreenPartialsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/prompt_screen_partials#id DataAuth0PromptScreenPartials#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/prompt_screen_partials#prompt_type DataAuth0PromptScreenPartials#prompt_type}
  */
  readonly promptType: string;
  /**
  * screen_partials block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/prompt_screen_partials#screen_partials DataAuth0PromptScreenPartials#screen_partials}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/prompt_screen_partials auth0_prompt_screen_partials}
*/
export class DataAuth0PromptScreenPartials extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAuth0PromptScreenPartials that should be imported. Refer to the {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/prompt_screen_partials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/auth0/auth0/1.33.0/docs/data-sources/prompt_screen_partials auth0_prompt_screen_partials} Data Source
  *
  * @param scope The scope in which to define this construct
