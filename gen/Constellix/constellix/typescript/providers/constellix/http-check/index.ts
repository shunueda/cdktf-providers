// https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check
...
export interface HttpCheckConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#check_sites HttpCheck#check_sites}
  */
  readonly checkSites: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#expected_status_code HttpCheck#expected_status_code}
  */
  readonly expectedStatusCode?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#fqdn HttpCheck#fqdn}
  */
  readonly fqdn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#host HttpCheck#host}
  */
  readonly host: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#id HttpCheck#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#interval HttpCheck#interval}
  */
  readonly interval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#interval_policy HttpCheck#interval_policy}
  */
  readonly intervalPolicy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#ip_version HttpCheck#ip_version}
  */
  readonly ipVersion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#name HttpCheck#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#notification_groups HttpCheck#notification_groups}
  */
  readonly notificationGroups?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#notification_report_timeout HttpCheck#notification_report_timeout}
  */
  readonly notificationReportTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#path HttpCheck#path}
  */
  readonly path?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#port HttpCheck#port}
  */
  readonly port: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#protocol_type HttpCheck#protocol_type}
  */
  readonly protocolType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#search_string HttpCheck#search_string}
  */
  readonly searchString?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#verification_policy HttpCheck#verification_policy}
  */
  readonly verificationPolicy?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check constellix_http_check}
*/
export class HttpCheck extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a HttpCheck resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the HttpCheck to import
  * @param importFromId The id of the existing HttpCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the HttpCheck to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/http_check constellix_http_check} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options HttpCheckConfig
  */
  public constructor(scope: Construct, id: string, config: HttpCheckConfig) {
    super(scope, id, {
  ...
  public get checkSites() {
    return cdktf.Token.asNumberList(cdktf.Fn.tolist(this.getNumberListAttribute('check_sites')));
  }
  ...
  public get notificationGroups() {
    return cdktf.Token.asNumberList(cdktf.Fn.tolist(this.getNumberListAttribute('notification_groups')));
  }
