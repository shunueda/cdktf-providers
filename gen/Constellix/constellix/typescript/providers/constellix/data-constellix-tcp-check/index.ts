// https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check
...
export interface DataConstellixTcpCheckConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check#check_sites DataConstellixTcpCheck#check_sites}
  */
  readonly checkSites?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check#host DataConstellixTcpCheck#host}
  */
  readonly host?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check#id DataConstellixTcpCheck#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check#interval DataConstellixTcpCheck#interval}
  */
  readonly interval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check#interval_policy DataConstellixTcpCheck#interval_policy}
  */
  readonly intervalPolicy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check#ip_version DataConstellixTcpCheck#ip_version}
  */
  readonly ipVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check#name DataConstellixTcpCheck#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check#notification_groups DataConstellixTcpCheck#notification_groups}
  */
  readonly notificationGroups?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check#notification_report_timeout DataConstellixTcpCheck#notification_report_timeout}
  */
  readonly notificationReportTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check#port DataConstellixTcpCheck#port}
  */
  readonly port?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check#string_to_receive DataConstellixTcpCheck#string_to_receive}
  */
  readonly stringToReceive?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check#string_to_send DataConstellixTcpCheck#string_to_send}
  */
  readonly stringToSend?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check#verification_policy DataConstellixTcpCheck#verification_policy}
  */
  readonly verificationPolicy?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check constellix_tcp_check}
*/
export class DataConstellixTcpCheck extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataConstellixTcpCheck resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataConstellixTcpCheck to import
  * @param importFromId The id of the existing DataConstellixTcpCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataConstellixTcpCheck to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/data-sources/tcp_check constellix_tcp_check} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataConstellixTcpCheckConfig
  */
  public constructor(scope: Construct, id: string, config: DataConstellixTcpCheckConfig) {
    super(scope, id, {
