// https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record
...
export interface CnameRecordConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#contact_ids CnameRecord#contact_ids}
  */
  readonly contactIds?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#domain_id CnameRecord#domain_id}
  */
  readonly domainId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#geo_location CnameRecord#geo_location}
  */
  readonly geoLocation?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#gtd_region CnameRecord#gtd_region}
  */
  readonly gtdRegion?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#host CnameRecord#host}
  */
  readonly host?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#id CnameRecord#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#name CnameRecord#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#noanswer CnameRecord#noanswer}
  */
  readonly noanswer?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#note CnameRecord#note}
  */
  readonly note?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#pools CnameRecord#pools}
  */
  readonly pools?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#record_failover_disable_flag CnameRecord#record_failover_disable_flag}
  */
  readonly recordFailoverDisableFlag?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#record_failover_failover_type CnameRecord#record_failover_failover_type}
  */
  readonly recordFailoverFailoverType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#record_option CnameRecord#record_option}
  */
  readonly recordOption?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#source_type CnameRecord#source_type}
  */
  readonly sourceType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#ttl CnameRecord#ttl}
  */
  readonly ttl: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#type CnameRecord#type}
  */
  readonly type?: string;
  /**
  * record_failover_values block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#record_failover_values CnameRecord#record_failover_values}
  */
  readonly recordFailoverValues?: CnameRecordRecordFailoverValues[] | cdktf.IResolvable;
}
export interface CnameRecordRecordFailoverValues {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#check_id CnameRecord#check_id}
  */
  readonly checkId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#disable_flag CnameRecord#disable_flag}
  */
  readonly disableFlag: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#sort_order CnameRecord#sort_order}
  */
  readonly sortOrder: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#value CnameRecord#value}
  */
  readonly value: string;
}

export function cnameRecordRecordFailoverValuesToTerraform(struct?: CnameRecordRecordFailoverValues | cdktf.IResolvable): any {
...
export function cnameRecordRecordFailoverValuesToHclTerraform(struct?: CnameRecordRecordFailoverValues | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CnameRecordRecordFailoverValuesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CnameRecordRecordFailoverValues | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: CnameRecordRecordFailoverValues | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class CnameRecordRecordFailoverValuesList extends cdktf.ComplexList {
  public internalValue? : CnameRecordRecordFailoverValues[] | cdktf.IResolvable
  ...
  */
  public get(index: number): CnameRecordRecordFailoverValuesOutputReference {
    return new CnameRecordRecordFailoverValuesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record constellix_cname_record}
*/
export class CnameRecord extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CnameRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/cname_record constellix_cname_record} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _recordFailoverValues = new CnameRecordRecordFailoverValuesList(this, "record_failover_values", true);
  public get recordFailoverValues() {
    return this._recordFailoverValues;
  }
  public putRecordFailoverValues(value: CnameRecordRecordFailoverValues[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      record_failover_values: cdktf.listMapper(cnameRecordRecordFailoverValuesToTerraform, true)(this._recordFailoverValues.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      record_failover_values: {
        value: cdktf.listMapperHcl(cnameRecordRecordFailoverValuesToHclTerraform, true)(this._recordFailoverValues.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "CnameRecordRecordFailoverValuesList",
      },
    };
