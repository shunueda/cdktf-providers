// https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record
...
export interface AnameRecordConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#contact_ids AnameRecord#contact_ids}
  */
  readonly contactIds?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#domain_id AnameRecord#domain_id}
  */
  readonly domainId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#geo_location AnameRecord#geo_location}
  */
  readonly geoLocation?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#gtd_region AnameRecord#gtd_region}
  */
  readonly gtdRegion?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#id AnameRecord#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#name AnameRecord#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#noanswer AnameRecord#noanswer}
  */
  readonly noanswer?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#note AnameRecord#note}
  */
  readonly note?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#pools AnameRecord#pools}
  */
  readonly pools?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#record_failover_disable_flag AnameRecord#record_failover_disable_flag}
  */
  readonly recordFailoverDisableFlag?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#record_failover_failover_type AnameRecord#record_failover_failover_type}
  */
  readonly recordFailoverFailoverType?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#record_option AnameRecord#record_option}
  */
  readonly recordOption?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#skip_lookup AnameRecord#skip_lookup}
  */
  readonly skipLookup?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#source_type AnameRecord#source_type}
  */
  readonly sourceType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#ttl AnameRecord#ttl}
  */
  readonly ttl: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#type AnameRecord#type}
  */
  readonly type?: string;
  /**
  * record_failover_values block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#record_failover_values AnameRecord#record_failover_values}
  */
  readonly recordFailoverValues?: AnameRecordRecordFailoverValues[] | cdktf.IResolvable;
  /**
  * roundrobin block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#roundrobin AnameRecord#roundrobin}
  */
  readonly roundrobin?: AnameRecordRoundrobin[] | cdktf.IResolvable;
}
export interface AnameRecordRecordFailoverValues {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#check_id AnameRecord#check_id}
  */
  readonly checkId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#disable_flag AnameRecord#disable_flag}
  */
  readonly disableFlag: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#sort_order AnameRecord#sort_order}
  */
  readonly sortOrder: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#value AnameRecord#value}
  */
  readonly value: string;
}

export function anameRecordRecordFailoverValuesToTerraform(struct?: AnameRecordRecordFailoverValues | cdktf.IResolvable): any {
...
export function anameRecordRecordFailoverValuesToHclTerraform(struct?: AnameRecordRecordFailoverValues | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AnameRecordRecordFailoverValuesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AnameRecordRecordFailoverValues | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AnameRecordRecordFailoverValues | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class AnameRecordRecordFailoverValuesList extends cdktf.ComplexList {
  public internalValue? : AnameRecordRecordFailoverValues[] | cdktf.IResolvable
  ...
  */
  public get(index: number): AnameRecordRecordFailoverValuesOutputReference {
    return new AnameRecordRecordFailoverValuesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function anameRecordRoundrobinToTerraform(struct?: AnameRecordRoundrobin | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function anameRecordRoundrobinToHclTerraform(struct?: AnameRecordRoundrobin | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AnameRecordRoundrobinOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): AnameRecordRoundrobin | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: AnameRecordRoundrobin | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._disableFlag = undefined;
...
export class AnameRecordRoundrobinList extends cdktf.ComplexList {
  public internalValue? : AnameRecordRoundrobin[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): AnameRecordRoundrobinOutputReference {
    return new AnameRecordRoundrobinOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record constellix_aname_record}
*/
export class AnameRecord extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a AnameRecord resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the AnameRecord to import
  * @param importFromId The id of the existing AnameRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AnameRecord to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/constellix/constellix/0.4.6/docs/resources/aname_record constellix_aname_record} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AnameRecordConfig
  */
  public constructor(scope: Construct, id: string, config: AnameRecordConfig) {
    super(scope, id, {
  ...
  private _recordFailoverValues = new AnameRecordRecordFailoverValuesList(this, "record_failover_values", true);
  public get recordFailoverValues() {
    return this._recordFailoverValues;
  }
  public putRecordFailoverValues(value: AnameRecordRecordFailoverValues[] | cdktf.IResolvable) {
  ...
  private _roundrobin = new AnameRecordRoundrobinList(this, "roundrobin", true);
  public get roundrobin() {
    return this._roundrobin;
  }
  public putRoundrobin(value: AnameRecordRoundrobin[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      record_failover_values: cdktf.listMapper(anameRecordRecordFailoverValuesToTerraform, true)(this._recordFailoverValues.internalValue),
      roundrobin: cdktf.listMapper(anameRecordRoundrobinToTerraform, true)(this._roundrobin.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      record_failover_values: {
        value: cdktf.listMapperHcl(anameRecordRecordFailoverValuesToHclTerraform, true)(this._recordFailoverValues.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AnameRecordRecordFailoverValuesList",
      },
      roundrobin: {
        value: cdktf.listMapperHcl(anameRecordRoundrobinToHclTerraform, true)(this._roundrobin.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AnameRecordRoundrobinList",
      },
    };
