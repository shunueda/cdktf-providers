// https://registry.terraform.io/providers/bluecatlabs/bluecat/2.2.1/docs/data-sources/ipv6block
...
export interface DataBluecatIpv6BlockConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bluecatlabs/bluecat/2.2.1/docs/data-sources/ipv6block#allowed_property_keys DataBluecatIpv6Block#allowed_property_keys}
  */
  readonly allowedPropertyKeys?: string[];
  /**
  * IPv4 Block's CIDR
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bluecatlabs/bluecat/2.2.1/docs/data-sources/ipv6block#cidr DataBluecatIpv6Block#cidr}
  */
  readonly cidr: string;
  /**
  * The Configuration. Getting the IPv4 Block in the default Configuration if doesn't specify
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bluecatlabs/bluecat/2.2.1/docs/data-sources/ipv6block#configuration DataBluecatIpv6Block#configuration}
  */
  readonly configuration?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bluecatlabs/bluecat/2.2.1/docs/data-sources/ipv6block#id DataBluecatIpv6Block#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bluecatlabs/bluecat/2.2.1/docs/data-sources/ipv6block#ip_version DataBluecatIpv6Block#ip_version}
  */
  readonly ipVersion?: string;
  /**
  * The Block name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bluecatlabs/bluecat/2.2.1/docs/data-sources/ipv6block#name DataBluecatIpv6Block#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bluecatlabs/bluecat/2.2.1/docs/data-sources/ipv6block bluecat_ipv6block}
*/
export class DataBluecatIpv6Block extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBluecatIpv6Block that should be imported. Refer to the {@link https://registry.terraform.io/providers/bluecatlabs/bluecat/2.2.1/docs/data-sources/ipv6block#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bluecatlabs/bluecat/2.2.1/docs/data-sources/ipv6block bluecat_ipv6block} Data Source
  *
  * @param scope The scope in which to define this construct
