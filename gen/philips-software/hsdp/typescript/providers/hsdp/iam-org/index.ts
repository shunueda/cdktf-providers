// https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_org
...
export interface IamOrgConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_org#description IamOrg#description}
  */
  readonly description?: string;
  /**
  * The display name to use for this organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_org#display_name IamOrg#display_name}
  */
  readonly displayName?: string;
  /**
  * An optional external identifier for this organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_org#external_id IamOrg#external_id}
  */
  readonly externalId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_org#id IamOrg#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_org#is_root_org IamOrg#is_root_org}
  */
  readonly isRootOrg?: boolean | cdktf.IResolvable;
  /**
  * The name of the IAM Organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_org#name IamOrg#name}
  */
  readonly name: string;
  /**
  * The parent organization ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_org#parent_org_id IamOrg#parent_org_id}
  */
  readonly parentOrgId?: string;
  /**
  * The organization type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_org#type IamOrg#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_org#wait_for_delete IamOrg#wait_for_delete}
  */
  readonly waitForDelete?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_org hsdp_iam_org}
*/
export class IamOrg extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamOrg that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_org#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_org hsdp_iam_org} Resource
  *
  * @param scope The scope in which to define this construct
