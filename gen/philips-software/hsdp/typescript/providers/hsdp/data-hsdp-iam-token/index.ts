// https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/iam_token
...
export interface DataHsdpIamTokenConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/iam_token#id DataHsdpIamToken#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/iam_token hsdp_iam_token}
*/
export class DataHsdpIamToken extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpIamToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/iam_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/iam_token hsdp_iam_token} Data Source
  *
  * @param scope The scope in which to define this construct
