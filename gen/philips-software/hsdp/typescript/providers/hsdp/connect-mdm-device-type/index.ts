// https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_device_type
...
export interface ConnectMdmDeviceTypeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_device_type#commercial_type_number ConnectMdmDeviceType#commercial_type_number}
  */
  readonly commercialTypeNumber: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_device_type#custom_type_attributes ConnectMdmDeviceType#custom_type_attributes}
  */
  readonly customTypeAttributes?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_device_type#default_iam_group_id ConnectMdmDeviceType#default_iam_group_id}
  */
  readonly defaultIamGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_device_type#description ConnectMdmDeviceType#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_device_type#device_group_id ConnectMdmDeviceType#device_group_id}
  */
  readonly deviceGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_device_type#id ConnectMdmDeviceType#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_device_type#name ConnectMdmDeviceType#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_device_type hsdp_connect_mdm_device_type}
*/
export class ConnectMdmDeviceType extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectMdmDeviceType that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_device_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_device_type hsdp_connect_mdm_device_type} Resource
  *
  * @param scope The scope in which to define this construct
