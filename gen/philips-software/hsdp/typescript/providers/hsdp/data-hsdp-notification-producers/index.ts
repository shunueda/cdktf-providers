// https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/notification_producers
...
export interface DataHsdpNotificationProducersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/notification_producers#id DataHsdpNotificationProducers#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/notification_producers#managing_organization_id DataHsdpNotificationProducers#managing_organization_id}
  */
  readonly managingOrganizationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/notification_producers hsdp_notification_producers}
*/
export class DataHsdpNotificationProducers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpNotificationProducers that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/notification_producers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/notification_producers hsdp_notification_producers} Data Source
  *
  * @param scope The scope in which to define this construct
