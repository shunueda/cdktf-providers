// https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service
...
export interface IamServiceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service#application_id IamService#application_id}
  */
  readonly applicationId: string;
  /**
  * Default scopes. You do not have to specify these explicitly when requesting a token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service#default_scopes IamService#default_scopes}
  */
  readonly defaultScopes: string[];
  /**
  * The service description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service#description IamService#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service#id IamService#id}
  *
  ...
  * The service name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service#name IamService#name}
  */
  readonly name: string;
  /**
  * List of supported scopes for this service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service#scopes IamService#scopes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service#self_managed_certificate IamService#self_managed_certificate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service#self_managed_certificate_nonsensitive IamService#self_managed_certificate_nonsensitive}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service#self_managed_expires_on IamService#self_managed_expires_on}
  */
  ...
  * Mutually exclusive with `self_managed_certificate`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service#self_managed_private_key IamService#self_managed_private_key}
  */
  readonly selfManagedPrivateKey?: string;
  /**
  * Access Token Lifetime (in seconds). Default: 1800 (30 minutes), Maximum: 2592000 (30 days).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service#token_validity IamService#token_validity}
  */
  readonly tokenValidity?: number;
  /**
  * The validity of the service credentials in months.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service#validity IamService#validity}
  */
  readonly validity?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service hsdp_iam_service}
*/
export class IamService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamService that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_service hsdp_iam_service} Resource
  *
  * @param scope The scope in which to define this construct
