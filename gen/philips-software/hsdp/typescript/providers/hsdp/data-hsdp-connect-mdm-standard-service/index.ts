// https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/connect_mdm_standard_service
...
export interface DataHsdpConnectMdmStandardServiceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/connect_mdm_standard_service#id DataHsdpConnectMdmStandardService#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/connect_mdm_standard_service#name DataHsdpConnectMdmStandardService#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/connect_mdm_standard_service hsdp_connect_mdm_standard_service}
*/
export class DataHsdpConnectMdmStandardService extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpConnectMdmStandardService that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/connect_mdm_standard_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/connect_mdm_standard_service hsdp_connect_mdm_standard_service} Data Source
  *
  * @param scope The scope in which to define this construct
