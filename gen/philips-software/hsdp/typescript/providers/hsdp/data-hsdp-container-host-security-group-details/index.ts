// https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/container_host_security_group_details
...
export interface DataHsdpContainerHostSecurityGroupDetailsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/container_host_security_group_details#id DataHsdpContainerHostSecurityGroupDetails#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/container_host_security_group_details#name DataHsdpContainerHostSecurityGroupDetails#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/container_host_security_group_details hsdp_container_host_security_group_details}
*/
export class DataHsdpContainerHostSecurityGroupDetails extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpContainerHostSecurityGroupDetails that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/container_host_security_group_details#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/container_host_security_group_details hsdp_container_host_security_group_details} Data Source
  *
  * @param scope The scope in which to define this construct
