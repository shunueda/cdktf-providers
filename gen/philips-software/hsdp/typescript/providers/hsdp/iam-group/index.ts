// https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_group
...
export interface IamGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_group#description IamGroup#description}
  */
  readonly description?: string;
  /**
  * The list of IAM device identity IDs to include in this group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_group#devices IamGroup#devices}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_group#drift_detection IamGroup#drift_detection}
  */
  readonly driftDetection?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_group#id IamGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_group#managing_organization IamGroup#managing_organization}
  */
  readonly managingOrganization: string;
  /**
  * The group name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_group#name IamGroup#name}
  */
  readonly name: string;
  /**
  * The list of role IDS to assign to this group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_group#roles IamGroup#roles}
  */
  readonly roles?: string[];
  /**
  * The list of service identity IDs to include in this group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_group#services IamGroup#services}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_group#users IamGroup#users}
  */
  readonly users?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_group hsdp_iam_group}
*/
export class IamGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_group hsdp_iam_group} Resource
  *
  * @param scope The scope in which to define this construct
