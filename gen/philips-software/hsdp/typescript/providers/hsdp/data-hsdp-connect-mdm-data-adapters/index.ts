// https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/connect_mdm_data_adapters
...
export interface DataHsdpConnectMdmDataAdaptersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/connect_mdm_data_adapters#id DataHsdpConnectMdmDataAdapters#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/connect_mdm_data_adapters hsdp_connect_mdm_data_adapters}
*/
export class DataHsdpConnectMdmDataAdapters extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpConnectMdmDataAdapters that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/connect_mdm_data_adapters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/connect_mdm_data_adapters hsdp_connect_mdm_data_adapters} Data Source
  *
  * @param scope The scope in which to define this construct
