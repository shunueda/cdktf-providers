// https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/notification_producer
...
export interface DataHsdpNotificationProducerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/notification_producer#id DataHsdpNotificationProducer#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/notification_producer#producer_id DataHsdpNotificationProducer#producer_id}
  */
  readonly producerId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/notification_producer hsdp_notification_producer}
*/
export class DataHsdpNotificationProducer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpNotificationProducer that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/notification_producer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/data-sources/notification_producer hsdp_notification_producer} Data Source
  *
  * @param scope The scope in which to define this construct
