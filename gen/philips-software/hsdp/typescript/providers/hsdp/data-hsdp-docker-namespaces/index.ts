// https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/docker_namespaces
...
export interface DataHsdpDockerNamespacesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/docker_namespaces#id DataHsdpDockerNamespaces#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/docker_namespaces hsdp_docker_namespaces}
*/
export class DataHsdpDockerNamespaces extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpDockerNamespaces that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/docker_namespaces#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/docker_namespaces hsdp_docker_namespaces} Data Source
  *
  * @param scope The scope in which to define this construct
