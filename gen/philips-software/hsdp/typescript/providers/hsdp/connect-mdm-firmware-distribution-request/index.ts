// https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/connect_mdm_firmware_distribution_request
...
export interface ConnectMdmFirmwareDistributionRequestConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/connect_mdm_firmware_distribution_request#description ConnectMdmFirmwareDistributionRequest#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/connect_mdm_firmware_distribution_request#distribution_target_device_groups_ids ConnectMdmFirmwareDistributionRequest#distribution_target_device_groups_ids}
  */
  readonly distributionTargetDeviceGroupsIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/connect_mdm_firmware_distribution_request#firmware_component_version_ids ConnectMdmFirmwareDistributionRequest#firmware_component_version_ids}
  */
  readonly firmwareComponentVersionIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/connect_mdm_firmware_distribution_request#firmware_version ConnectMdmFirmwareDistributionRequest#firmware_version}
  */
  readonly firmwareVersion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/connect_mdm_firmware_distribution_request#id ConnectMdmFirmwareDistributionRequest#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/connect_mdm_firmware_distribution_request#orchestration_mode ConnectMdmFirmwareDistributionRequest#orchestration_mode}
  */
  readonly orchestrationMode: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/connect_mdm_firmware_distribution_request#status ConnectMdmFirmwareDistributionRequest#status}
  */
  readonly status: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/connect_mdm_firmware_distribution_request#user_consent_required ConnectMdmFirmwareDistributionRequest#user_consent_required}
  */
  readonly userConsentRequired?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/connect_mdm_firmware_distribution_request hsdp_connect_mdm_firmware_distribution_request}
*/
export class ConnectMdmFirmwareDistributionRequest extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectMdmFirmwareDistributionRequest that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/connect_mdm_firmware_distribution_request#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/connect_mdm_firmware_distribution_request hsdp_connect_mdm_firmware_distribution_request} Resource
  *
  * @param scope The scope in which to define this construct
