// https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_blob_subscription
...
export interface ConnectMdmBlobSubscriptionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_blob_subscription#data_type_id ConnectMdmBlobSubscription#data_type_id}
  */
  readonly dataTypeId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_blob_subscription#description ConnectMdmBlobSubscription#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_blob_subscription#id ConnectMdmBlobSubscription#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_blob_subscription#name ConnectMdmBlobSubscription#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_blob_subscription#notification_topic_id ConnectMdmBlobSubscription#notification_topic_id}
  */
  readonly notificationTopicId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_blob_subscription hsdp_connect_mdm_blob_subscription}
*/
export class ConnectMdmBlobSubscription extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectMdmBlobSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_blob_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/resources/connect_mdm_blob_subscription hsdp_connect_mdm_blob_subscription} Resource
  *
  * @param scope The scope in which to define this construct
