// https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_role
...
export interface IamRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_role#description IamRole#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_role#id IamRole#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_role#managing_organization IamRole#managing_organization}
  */
  readonly managingOrganization: string;
  /**
  * The role name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_role#name IamRole#name}
  */
  readonly name: string;
  /**
  * List of permissions IDs assigned to this role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_role#permissions IamRole#permissions}
  */
  readonly permissions: string[];
  /**
  * Removal protection of some ticket only permissions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_role#ticket_protection IamRole#ticket_protection}
  */
  readonly ticketProtection?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_role hsdp_iam_role}
*/
export class IamRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/iam_role hsdp_iam_role} Resource
  *
  * @param scope The scope in which to define this construct
