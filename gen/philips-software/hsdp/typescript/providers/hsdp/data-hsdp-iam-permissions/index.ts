// https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/iam_permissions
...
export interface DataHsdpIamPermissionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/iam_permissions#id DataHsdpIamPermissions#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/iam_permissions hsdp_iam_permissions}
*/
export class DataHsdpIamPermissions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpIamPermissions that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/iam_permissions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/iam_permissions hsdp_iam_permissions} Data Source
  *
  * @param scope The scope in which to define this construct
