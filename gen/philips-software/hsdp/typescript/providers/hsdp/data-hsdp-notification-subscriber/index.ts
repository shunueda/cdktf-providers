// https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/notification_subscriber
...
export interface DataHsdpNotificationSubscriberConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/notification_subscriber#id DataHsdpNotificationSubscriber#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/notification_subscriber#subscriber_id DataHsdpNotificationSubscriber#subscriber_id}
  */
  readonly subscriberId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/notification_subscriber#subscriber_product_name DataHsdpNotificationSubscriber#subscriber_product_name}
  */
  readonly subscriberProductName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/notification_subscriber hsdp_notification_subscriber}
*/
export class DataHsdpNotificationSubscriber extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpNotificationSubscriber that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/notification_subscriber#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/notification_subscriber hsdp_notification_subscriber} Data Source
  *
  * @param scope The scope in which to define this construct
