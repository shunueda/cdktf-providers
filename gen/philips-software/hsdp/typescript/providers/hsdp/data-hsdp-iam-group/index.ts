// https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/iam_group
...
export interface DataHsdpIamGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/iam_group#id DataHsdpIamGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/iam_group#managing_organization_id DataHsdpIamGroup#managing_organization_id}
  */
  readonly managingOrganizationId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/iam_group#name DataHsdpIamGroup#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/iam_group hsdp_iam_group}
*/
export class DataHsdpIamGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpIamGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/iam_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/iam_group hsdp_iam_group} Data Source
  *
  * @param scope The scope in which to define this construct
