// https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/notification_topic
...
export interface DataHsdpNotificationTopicConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/notification_topic#id DataHsdpNotificationTopic#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/notification_topic#name DataHsdpNotificationTopic#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/notification_topic#topic_id DataHsdpNotificationTopic#topic_id}
  */
  readonly topicId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/notification_topic hsdp_notification_topic}
*/
export class DataHsdpNotificationTopic extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpNotificationTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/notification_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.71.0/docs/data-sources/notification_topic hsdp_notification_topic} Data Source
  *
  * @param scope The scope in which to define this construct
