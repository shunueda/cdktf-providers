// https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/dbs_sqs_subscriber
...
export interface DbsSqsSubscriberConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/dbs_sqs_subscriber#delivery_delay_seconds DbsSqsSubscriber#delivery_delay_seconds}
  */
  readonly deliveryDelaySeconds?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/dbs_sqs_subscriber#description DbsSqsSubscriber#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/dbs_sqs_subscriber#id DbsSqsSubscriber#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/dbs_sqs_subscriber#message_retention_period_seconds DbsSqsSubscriber#message_retention_period_seconds}
  */
  readonly messageRetentionPeriodSeconds?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/dbs_sqs_subscriber#name_infix DbsSqsSubscriber#name_infix}
  */
  readonly nameInfix: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/dbs_sqs_subscriber#queue_type DbsSqsSubscriber#queue_type}
  */
  readonly queueType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/dbs_sqs_subscriber#receive_wait_time_seconds DbsSqsSubscriber#receive_wait_time_seconds}
  */
  readonly receiveWaitTimeSeconds?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/dbs_sqs_subscriber#server_side_encryption DbsSqsSubscriber#server_side_encryption}
  */
  readonly serverSideEncryption?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/dbs_sqs_subscriber hsdp_dbs_sqs_subscriber}
*/
export class DbsSqsSubscriber extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbsSqsSubscriber that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/dbs_sqs_subscriber#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/dbs_sqs_subscriber hsdp_dbs_sqs_subscriber} Resource
  *
  * @param scope The scope in which to define this construct
