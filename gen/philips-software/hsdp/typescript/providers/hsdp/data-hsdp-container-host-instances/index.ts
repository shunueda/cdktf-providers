// https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/container_host_instances
...
export interface DataHsdpContainerHostInstancesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/container_host_instances#id DataHsdpContainerHostInstances#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/container_host_instances hsdp_container_host_instances}
*/
export class DataHsdpContainerHostInstances extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpContainerHostInstances that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/container_host_instances#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/container_host_instances hsdp_container_host_instances} Data Source
  *
  * @param scope The scope in which to define this construct
