// https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/connect_mdm_blob_data_contract
...
export interface ConnectMdmBlobDataContractConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/connect_mdm_blob_data_contract#bucket_id ConnectMdmBlobDataContract#bucket_id}
  */
  readonly bucketId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/connect_mdm_blob_data_contract#cross_region_replication_enabled ConnectMdmBlobDataContract#cross_region_replication_enabled}
  */
  readonly crossRegionReplicationEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/connect_mdm_blob_data_contract#data_type_id ConnectMdmBlobDataContract#data_type_id}
  */
  readonly dataTypeId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/connect_mdm_blob_data_contract#id ConnectMdmBlobDataContract#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/connect_mdm_blob_data_contract#logging_enabled ConnectMdmBlobDataContract#logging_enabled}
  */
  readonly loggingEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/connect_mdm_blob_data_contract#name ConnectMdmBlobDataContract#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/connect_mdm_blob_data_contract#root_path_in_bucket ConnectMdmBlobDataContract#root_path_in_bucket}
  */
  readonly rootPathInBucket: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/connect_mdm_blob_data_contract#storage_class_id ConnectMdmBlobDataContract#storage_class_id}
  */
  readonly storageClassId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/connect_mdm_blob_data_contract hsdp_connect_mdm_blob_data_contract}
*/
export class ConnectMdmBlobDataContract extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConnectMdmBlobDataContract that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/connect_mdm_blob_data_contract#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/1.0.0/docs/resources/connect_mdm_blob_data_contract hsdp_connect_mdm_blob_data_contract} Resource
  *
  * @param scope The scope in which to define this construct
