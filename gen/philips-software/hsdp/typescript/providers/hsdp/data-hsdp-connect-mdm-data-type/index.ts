// https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_data_type
...
export interface DataHsdpConnectMdmDataTypeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_data_type#id DataHsdpConnectMdmDataType#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_data_type#name DataHsdpConnectMdmDataType#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_data_type#proposition_id DataHsdpConnectMdmDataType#proposition_id}
  */
  readonly propositionId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_data_type hsdp_connect_mdm_data_type}
*/
export class DataHsdpConnectMdmDataType extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpConnectMdmDataType that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_data_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_data_type hsdp_connect_mdm_data_type} Data Source
  *
  * @param scope The scope in which to define this construct
