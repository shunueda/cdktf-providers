// https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/iam_role_sharing_policies
...
export interface DataHsdpIamRoleSharingPoliciesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/iam_role_sharing_policies#id DataHsdpIamRoleSharingPolicies#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/iam_role_sharing_policies#role_id DataHsdpIamRoleSharingPolicies#role_id}
  */
  readonly roleId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/iam_role_sharing_policies#sharing_policy DataHsdpIamRoleSharingPolicies#sharing_policy}
  */
  readonly sharingPolicy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/iam_role_sharing_policies#target_organization_id DataHsdpIamRoleSharingPolicies#target_organization_id}
  */
  readonly targetOrganizationId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/iam_role_sharing_policies hsdp_iam_role_sharing_policies}
*/
export class DataHsdpIamRoleSharingPolicies extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpIamRoleSharingPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/iam_role_sharing_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/iam_role_sharing_policies hsdp_iam_role_sharing_policies} Data Source
  *
  * @param scope The scope in which to define this construct
