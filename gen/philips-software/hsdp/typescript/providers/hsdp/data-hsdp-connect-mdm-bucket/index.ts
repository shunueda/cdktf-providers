// https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_bucket
...
export interface DataHsdpConnectMdmBucketConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_bucket#id DataHsdpConnectMdmBucket#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_bucket#name DataHsdpConnectMdmBucket#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_bucket#proposition_id DataHsdpConnectMdmBucket#proposition_id}
  */
  readonly propositionId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_bucket hsdp_connect_mdm_bucket}
*/
export class DataHsdpConnectMdmBucket extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpConnectMdmBucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_bucket hsdp_connect_mdm_bucket} Data Source
  *
  * @param scope The scope in which to define this construct
