// https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_oauth_client_scopes
...
export interface DataHsdpConnectMdmOauthClientScopesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_oauth_client_scopes#id DataHsdpConnectMdmOauthClientScopes#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_oauth_client_scopes hsdp_connect_mdm_oauth_client_scopes}
*/
export class DataHsdpConnectMdmOauthClientScopes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHsdpConnectMdmOauthClientScopes that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_oauth_client_scopes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/data-sources/connect_mdm_oauth_client_scopes hsdp_connect_mdm_oauth_client_scopes} Data Source
  *
  * @param scope The scope in which to define this construct
