// https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/dbs_topic_subscription
...
export interface DbsTopicSubscriptionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/dbs_topic_subscription#data_type DbsTopicSubscription#data_type}
  */
  readonly dataType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/dbs_topic_subscription#deliver_data_only DbsTopicSubscription#deliver_data_only}
  */
  readonly deliverDataOnly?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/dbs_topic_subscription#description DbsTopicSubscription#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/dbs_topic_subscription#id DbsTopicSubscription#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/dbs_topic_subscription#kinesis_stream_partition_key DbsTopicSubscription#kinesis_stream_partition_key}
  */
  readonly kinesisStreamPartitionKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/dbs_topic_subscription#name_infix DbsTopicSubscription#name_infix}
  */
  readonly nameInfix: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/dbs_topic_subscription#subscriber_id DbsTopicSubscription#subscriber_id}
  */
  readonly subscriberId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/dbs_topic_subscription hsdp_dbs_topic_subscription}
*/
export class DbsTopicSubscription extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbsTopicSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/dbs_topic_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-software/hsdp/0.70.0/docs/resources/dbs_topic_subscription hsdp_dbs_topic_subscription} Resource
  *
  * @param scope The scope in which to define this construct
