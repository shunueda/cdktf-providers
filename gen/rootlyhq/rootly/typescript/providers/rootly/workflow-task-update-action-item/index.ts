// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item
...
export interface WorkflowTaskUpdateActionItemConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#enabled WorkflowTaskUpdateActionItem#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#id WorkflowTaskUpdateActionItem#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#name WorkflowTaskUpdateActionItem#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#position WorkflowTaskUpdateActionItem#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#skip_on_failure WorkflowTaskUpdateActionItem#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#workflow_id WorkflowTaskUpdateActionItem#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#task_params WorkflowTaskUpdateActionItem#task_params}
  */
...
export interface WorkflowTaskUpdateActionItemTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#assigned_to_user WorkflowTaskUpdateActionItem#assigned_to_user}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#assigned_to_user_id WorkflowTaskUpdateActionItem#assigned_to_user_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#attribute_to_query_by WorkflowTaskUpdateActionItem#attribute_to_query_by}
  */
  readonly attributeToQueryBy: string;
  /**
  * Custom field mappings. Can contain liquid markup and need to be valid JSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#custom_fields_mapping WorkflowTaskUpdateActionItem#custom_fields_mapping}
  */
  readonly customFieldsMapping?: string;
  /**
  * The action item description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#description WorkflowTaskUpdateActionItem#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#group_ids WorkflowTaskUpdateActionItem#group_ids}
  */
  readonly groupIds?: string[];
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#post_to_incident_timeline WorkflowTaskUpdateActionItem#post_to_incident_timeline}
  */
  readonly postToIncidentTimeline?: boolean | cdktf.IResolvable;
  /**
  * The action item priority. Value must be one of `high`, `medium`, `low`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#priority WorkflowTaskUpdateActionItem#priority}
  */
  readonly priority?: string;
  /**
  * Value that attribute_to_query_by to uses to match against
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#query_value WorkflowTaskUpdateActionItem#query_value}
  */
  readonly queryValue: string;
  /**
  * The action item status. Value must be one of `open`, `in_progress`, `cancelled`, `done`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#status WorkflowTaskUpdateActionItem#status}
  */
  readonly status?: string;
  /**
  * Brief description of the action item
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#summary WorkflowTaskUpdateActionItem#summary}
  */
  readonly summary?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#task_type WorkflowTaskUpdateActionItem#task_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item rootly_workflow_task_update_action_item}
*/
export class WorkflowTaskUpdateActionItem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskUpdateActionItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_action_item rootly_workflow_task_update_action_item} Resource
  *
  * @param scope The scope in which to define this construct
