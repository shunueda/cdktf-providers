// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link
...
export interface WorkflowTaskCreateZendeskJiraLinkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link#enabled WorkflowTaskCreateZendeskJiraLink#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link#id WorkflowTaskCreateZendeskJiraLink#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link#name WorkflowTaskCreateZendeskJiraLink#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link#position WorkflowTaskCreateZendeskJiraLink#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link#skip_on_failure WorkflowTaskCreateZendeskJiraLink#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link#workflow_id WorkflowTaskCreateZendeskJiraLink#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link#task_params WorkflowTaskCreateZendeskJiraLink#task_params}
  */
...
export interface WorkflowTaskCreateZendeskJiraLinkTaskParams {
  ...
  * Jira Issue Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link#jira_issue_id WorkflowTaskCreateZendeskJiraLink#jira_issue_id}
  */
  readonly jiraIssueId: string;
  /**
  * Jira Issue Key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link#jira_issue_key WorkflowTaskCreateZendeskJiraLink#jira_issue_key}
  */
  readonly jiraIssueKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link#task_type WorkflowTaskCreateZendeskJiraLink#task_type}
  */
  readonly taskType?: string;
  /**
  * Zendesk Ticket Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link#zendesk_ticket_id WorkflowTaskCreateZendeskJiraLink#zendesk_ticket_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link rootly_workflow_task_create_zendesk_jira_link}
*/
export class WorkflowTaskCreateZendeskJiraLink extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateZendeskJiraLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_zendesk_jira_link rootly_workflow_task_create_zendesk_jira_link} Resource
  *
  * @param scope The scope in which to define this construct
