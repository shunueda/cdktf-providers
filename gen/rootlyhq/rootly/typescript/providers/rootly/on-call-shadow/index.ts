// https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/on_call_shadow
...
export interface OnCallShadowConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/on_call_shadow#ends_at OnCallShadow#ends_at}
  */
  readonly endsAt: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/on_call_shadow#id OnCallShadow#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/on_call_shadow#schedule_id OnCallShadow#schedule_id}
  */
  readonly scheduleId?: string;
  /**
  * Which user the shadow shift belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/on_call_shadow#shadow_user_id OnCallShadow#shadow_user_id}
  */
  readonly shadowUserId: number;
  /**
  * ID of schedule or user the shadow user is shadowing
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/on_call_shadow#shadowable_id OnCallShadow#shadowable_id}
  */
  readonly shadowableId: string;
  /**
  * Value must be one of `User`, `Schedule`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/on_call_shadow#shadowable_type OnCallShadow#shadowable_type}
  */
  readonly shadowableType?: string;
  /**
  * Start datetime of shadow shift
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/on_call_shadow#starts_at OnCallShadow#starts_at}
  */
  readonly startsAt: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/on_call_shadow rootly_on_call_shadow}
*/
export class OnCallShadow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OnCallShadow that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/on_call_shadow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/on_call_shadow rootly_on_call_shadow} Resource
  *
  * @param scope The scope in which to define this construct
