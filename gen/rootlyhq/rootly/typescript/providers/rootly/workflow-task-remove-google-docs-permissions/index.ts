// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions
...
export interface WorkflowTaskRemoveGoogleDocsPermissionsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions#enabled WorkflowTaskRemoveGoogleDocsPermissions#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions#id WorkflowTaskRemoveGoogleDocsPermissions#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions#name WorkflowTaskRemoveGoogleDocsPermissions#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions#position WorkflowTaskRemoveGoogleDocsPermissions#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions#skip_on_failure WorkflowTaskRemoveGoogleDocsPermissions#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions#workflow_id WorkflowTaskRemoveGoogleDocsPermissions#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions#task_params WorkflowTaskRemoveGoogleDocsPermissions#task_params}
  */
...
export interface WorkflowTaskRemoveGoogleDocsPermissionsTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions#attribute_to_query_by WorkflowTaskRemoveGoogleDocsPermissions#attribute_to_query_by}
  */
  readonly attributeToQueryBy: string;
  /**
  * The Google Doc file ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions#file_id WorkflowTaskRemoveGoogleDocsPermissions#file_id}
  */
  readonly fileId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions#task_type WorkflowTaskRemoveGoogleDocsPermissions#task_type}
  */
  readonly taskType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions#value WorkflowTaskRemoveGoogleDocsPermissions#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions rootly_workflow_task_remove_google_docs_permissions}
*/
export class WorkflowTaskRemoveGoogleDocsPermissions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskRemoveGoogleDocsPermissions that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_remove_google_docs_permissions rootly_workflow_task_remove_google_docs_permissions} Resource
  *
  * @param scope The scope in which to define this construct
