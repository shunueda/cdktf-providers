// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_incident_status_timestamp
...
export interface WorkflowTaskUpdateIncidentStatusTimestampConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_incident_status_timestamp#enabled WorkflowTaskUpdateIncidentStatusTimestamp#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_incident_status_timestamp#id WorkflowTaskUpdateIncidentStatusTimestamp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_incident_status_timestamp#name WorkflowTaskUpdateIncidentStatusTimestamp#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_incident_status_timestamp#position WorkflowTaskUpdateIncidentStatusTimestamp#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_incident_status_timestamp#skip_on_failure WorkflowTaskUpdateIncidentStatusTimestamp#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_incident_status_timestamp#workflow_id WorkflowTaskUpdateIncidentStatusTimestamp#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_incident_status_timestamp#task_params WorkflowTaskUpdateIncidentStatusTimestamp#task_params}
  */
...
export interface WorkflowTaskUpdateIncidentStatusTimestampTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_incident_status_timestamp#assigned_at WorkflowTaskUpdateIncidentStatusTimestamp#assigned_at}
  */
  readonly assignedAt: string;
  /**
  * Sub-status to update timestamp for
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_incident_status_timestamp#sub_status_id WorkflowTaskUpdateIncidentStatusTimestamp#sub_status_id}
  */
  readonly subStatusId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_incident_status_timestamp#task_type WorkflowTaskUpdateIncidentStatusTimestamp#task_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_incident_status_timestamp rootly_workflow_task_update_incident_status_timestamp}
*/
export class WorkflowTaskUpdateIncidentStatusTimestamp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskUpdateIncidentStatusTimestamp that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_incident_status_timestamp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_incident_status_timestamp rootly_workflow_task_update_incident_status_timestamp} Resource
  *
  * @param scope The scope in which to define this construct
