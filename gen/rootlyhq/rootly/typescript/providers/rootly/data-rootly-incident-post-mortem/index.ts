// https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_post_mortem
...
export interface DataRootlyIncidentPostMortemConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_post_mortem#created_at DataRootlyIncidentPostMortem#created_at}
  */
  readonly createdAt?: { [key: string]: string };
  /**
  * Filter by date range using 'lt' and 'gt'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_post_mortem#mitigated_at DataRootlyIncidentPostMortem#mitigated_at}
  */
  readonly mitigatedAt?: { [key: string]: string };
  /**
  * Filter by date range using 'lt' and 'gt'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_post_mortem#resolved_at DataRootlyIncidentPostMortem#resolved_at}
  */
  readonly resolvedAt?: { [key: string]: string };
  /**
  * Filter by date range using 'lt' and 'gt'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_post_mortem#started_at DataRootlyIncidentPostMortem#started_at}
  */
  readonly startedAt?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_post_mortem#status DataRootlyIncidentPostMortem#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_post_mortem rootly_incident_post_mortem}
*/
export class DataRootlyIncidentPostMortem extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyIncidentPostMortem that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_post_mortem#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_post_mortem rootly_incident_post_mortem} Data Source
  *
  * @param scope The scope in which to define this construct
