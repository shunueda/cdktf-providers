// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/escalation_level
...
export interface EscalationLevelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/escalation_level#delay EscalationLevel#delay}
  */
  readonly delay?: number;
  /**
  * The ID of the escalation policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/escalation_level#escalation_policy_id EscalationLevel#escalation_policy_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/escalation_level#escalation_policy_path_id EscalationLevel#escalation_policy_path_id}
  */
  readonly escalationPolicyPathId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/escalation_level#id EscalationLevel#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/escalation_level#paging_strategy_configuration_schedule_strategy EscalationLevel#paging_strategy_configuration_schedule_strategy}
  */
  readonly pagingStrategyConfigurationScheduleStrategy?: string;
  /**
  * Value must be one of `default`, `random`, `cycle`, `alert`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/escalation_level#paging_strategy_configuration_strategy EscalationLevel#paging_strategy_configuration_strategy}
  */
  readonly pagingStrategyConfigurationStrategy?: string;
  /**
  * Position of the escalation policy level
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/escalation_level#position EscalationLevel#position}
  */
  readonly position: number;
  /**
  * notification_target_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/escalation_level#notification_target_params EscalationLevel#notification_target_params}
  */
...
export interface EscalationLevelNotificationTargetParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/escalation_level#team_members EscalationLevel#team_members}
  */
  readonly teamMembers?: string;
  /**
  * The type of the notification target. Value must be one of `team`, `user`, `schedule`, `slack_channel`, `service`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/escalation_level#type EscalationLevel#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/escalation_level rootly_escalation_level}
*/
export class EscalationLevel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EscalationLevel that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/escalation_level#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/escalation_level rootly_escalation_level} Resource
  *
  * @param scope The scope in which to define this construct
