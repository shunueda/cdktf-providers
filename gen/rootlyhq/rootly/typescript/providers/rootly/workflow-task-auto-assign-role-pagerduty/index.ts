// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty
...
export interface WorkflowTaskAutoAssignRolePagerdutyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty#enabled WorkflowTaskAutoAssignRolePagerduty#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty#id WorkflowTaskAutoAssignRolePagerduty#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty#name WorkflowTaskAutoAssignRolePagerduty#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty#position WorkflowTaskAutoAssignRolePagerduty#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty#skip_on_failure WorkflowTaskAutoAssignRolePagerduty#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty#workflow_id WorkflowTaskAutoAssignRolePagerduty#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty#task_params WorkflowTaskAutoAssignRolePagerduty#task_params}
  */
...
export interface WorkflowTaskAutoAssignRolePagerdutyTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty#escalation_policy WorkflowTaskAutoAssignRolePagerduty#escalation_policy}
  */
  readonly escalationPolicy?: { [key: string]: string };
  /**
  * The role id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty#incident_role_id WorkflowTaskAutoAssignRolePagerduty#incident_role_id}
  */
  readonly incidentRoleId: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty#schedule WorkflowTaskAutoAssignRolePagerduty#schedule}
  */
  readonly schedule?: { [key: string]: string };
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty#service WorkflowTaskAutoAssignRolePagerduty#service}
  */
  readonly service?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty#task_type WorkflowTaskAutoAssignRolePagerduty#task_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty rootly_workflow_task_auto_assign_role_pagerduty}
*/
export class WorkflowTaskAutoAssignRolePagerduty extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskAutoAssignRolePagerduty that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_pagerduty rootly_workflow_task_auto_assign_role_pagerduty} Resource
  *
  * @param scope The scope in which to define this construct
