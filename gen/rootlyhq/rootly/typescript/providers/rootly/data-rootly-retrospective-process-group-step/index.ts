// https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/retrospective_process_group_step
...
export interface DataRootlyRetrospectiveProcessGroupStepConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/retrospective_process_group_step#retrospective_step_id DataRootlyRetrospectiveProcessGroupStep#retrospective_step_id}
  */
  readonly retrospectiveStepId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/retrospective_process_group_step rootly_retrospective_process_group_step}
*/
export class DataRootlyRetrospectiveProcessGroupStep extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyRetrospectiveProcessGroupStep that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/retrospective_process_group_step#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/retrospective_process_group_step rootly_retrospective_process_group_step} Data Source
  *
  * @param scope The scope in which to define this construct
