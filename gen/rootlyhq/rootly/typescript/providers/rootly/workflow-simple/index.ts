// https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple
...
export interface WorkflowSimpleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#cause_ids WorkflowSimple#cause_ids}
  */
  readonly causeIds?: string[];
  /**
  * Workflow command
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#command WorkflowSimple#command}
  */
  readonly command?: string;
  /**
  * This will notify you back when the workflow is starting. Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#command_feedback_enabled WorkflowSimple#command_feedback_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#continuously_repeat WorkflowSimple#continuously_repeat}
  */
  readonly continuouslyRepeat?: boolean | cdktf.IResolvable;
  /**
  * The description of the workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#description WorkflowSimple#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#enabled WorkflowSimple#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#environment_ids WorkflowSimple#environment_ids}
  */
  readonly environmentIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#functionality_ids WorkflowSimple#functionality_ids}
  */
  readonly functionalityIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#group_ids WorkflowSimple#group_ids}
  */
  readonly groupIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#id WorkflowSimple#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#incident_role_ids WorkflowSimple#incident_role_ids}
  */
  readonly incidentRoleIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#incident_type_ids WorkflowSimple#incident_type_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#locked WorkflowSimple#locked}
  */
  readonly locked?: boolean | cdktf.IResolvable;
  /**
  * The title of the workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#name WorkflowSimple#name}
  */
  readonly name: string;
  /**
  * The order which the workflow should run with other workflows.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#position WorkflowSimple#position}
  */
  readonly position?: number;
  /**
  * The workflow will stop repeating if its runtime since it's first workflow run exceeds the duration set in this field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#repeat_condition_duration_since_first_run WorkflowSimple#repeat_condition_duration_since_first_run}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#repeat_condition_number_of_repeats WorkflowSimple#repeat_condition_number_of_repeats}
  */
  readonly repeatConditionNumberOfRepeats?: number;
  /**
  * Repeat workflow every duration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#repeat_every_duration WorkflowSimple#repeat_every_duration}
  */
  readonly repeatEveryDuration?: string;
  /**
  * Repeat on weekdays. Value must be one of `S`, `M`, `T`, `W`, `R`, `F`, `U`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#repeat_on WorkflowSimple#repeat_on}
  */
  readonly repeatOn?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#service_ids WorkflowSimple#service_ids}
  */
  readonly serviceIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#severity_ids WorkflowSimple#severity_ids}
  */
  readonly severityIds?: string[];
  /**
  * The slug of the workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#slug WorkflowSimple#slug}
  */
  readonly slug?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#sub_status_ids WorkflowSimple#sub_status_ids}
  */
  readonly subStatusIds?: string[];
  /**
  * Wait this duration before executing
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#wait WorkflowSimple#wait}
  */
  readonly wait?: string;
  /**
  * The group this workflow belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#workflow_group_id WorkflowSimple#workflow_group_id}
  */
  readonly workflowGroupId?: string;
  /**
  * trigger_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#trigger_params WorkflowSimple#trigger_params}
  */
...
export interface WorkflowSimpleTriggerParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#trigger_type WorkflowSimple#trigger_type}
  */
  readonly triggerType?: string;
  /**
  * Actions that trigger the workflow. Value must be one of `slack_command`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#triggers WorkflowSimple#triggers}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple rootly_workflow_simple}
*/
export class WorkflowSimple extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowSimple that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_simple rootly_workflow_simple} Resource
  *
  * @param scope The scope in which to define this construct
