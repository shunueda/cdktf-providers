// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/schedule_rotation_user
...
export interface ScheduleRotationUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/schedule_rotation_user#id ScheduleRotationUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/schedule_rotation_user#position ScheduleRotationUser#position}
  */
  readonly position?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/schedule_rotation_user#schedule_rotation_id ScheduleRotationUser#schedule_rotation_id}
  */
  readonly scheduleRotationId?: string;
  /**
  * Schedule rotation user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/schedule_rotation_user#user_id ScheduleRotationUser#user_id}
  */
  readonly userId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/schedule_rotation_user rootly_schedule_rotation_user}
*/
export class ScheduleRotationUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScheduleRotationUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/schedule_rotation_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/schedule_rotation_user rootly_schedule_rotation_user} Resource
  *
  * @param scope The scope in which to define this construct
