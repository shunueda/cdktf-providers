// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/authorization
...
export interface DataRootlyAuthorizationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/authorization#authorizable_id DataRootlyAuthorization#authorizable_id}
  */
  readonly authorizableId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/authorization#authorizable_type DataRootlyAuthorization#authorizable_type}
  */
  readonly authorizableType?: string;
  /**
  * Filter by date range using 'lt' and 'gt'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/authorization#created_at DataRootlyAuthorization#created_at}
  */
  readonly createdAt?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/authorization#grantee_id DataRootlyAuthorization#grantee_id}
  */
  readonly granteeId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/authorization#grantee_type DataRootlyAuthorization#grantee_type}
  */
  readonly granteeType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/authorization rootly_authorization}
*/
export class DataRootlyAuthorization extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyAuthorization that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/authorization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/authorization rootly_authorization} Data Source
  *
  * @param scope The scope in which to define this construct
