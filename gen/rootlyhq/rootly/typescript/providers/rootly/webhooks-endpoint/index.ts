// https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/webhooks_endpoint
...
export interface WebhooksEndpointConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/webhooks_endpoint#enabled WebhooksEndpoint#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/webhooks_endpoint#event_types WebhooksEndpoint#event_types}
  */
  readonly eventTypes?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/webhooks_endpoint#id WebhooksEndpoint#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/webhooks_endpoint#name WebhooksEndpoint#name}
  */
  readonly name: string;
  /**
  * The webhook signing secret used to verify webhook requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/webhooks_endpoint#secret WebhooksEndpoint#secret}
  */
  readonly secret?: string;
  /**
  * The slug of the endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/webhooks_endpoint#slug WebhooksEndpoint#slug}
  */
  readonly slug?: string;
  /**
  * The URL of the endpoint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/webhooks_endpoint#url WebhooksEndpoint#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/webhooks_endpoint rootly_webhooks_endpoint}
*/
export class WebhooksEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebhooksEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/webhooks_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/webhooks_endpoint rootly_webhooks_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
