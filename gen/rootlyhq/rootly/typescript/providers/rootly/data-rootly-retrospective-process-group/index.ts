// https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/retrospective_process_group
...
export interface DataRootlyRetrospectiveProcessGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/retrospective_process_group#sub_status_id DataRootlyRetrospectiveProcessGroup#sub_status_id}
  */
  readonly subStatusId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/retrospective_process_group rootly_retrospective_process_group}
*/
export class DataRootlyRetrospectiveProcessGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyRetrospectiveProcessGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/retrospective_process_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/retrospective_process_group rootly_retrospective_process_group} Data Source
  *
  * @param scope The scope in which to define this construct
