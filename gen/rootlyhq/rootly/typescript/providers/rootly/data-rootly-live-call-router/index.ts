// https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/live_call_router
...
export interface DataRootlyLiveCallRouterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/live_call_router#created_at DataRootlyLiveCallRouter#created_at}
  */
  readonly createdAt?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/live_call_router#name DataRootlyLiveCallRouter#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/live_call_router rootly_live_call_router}
*/
export class DataRootlyLiveCallRouter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyLiveCallRouter that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/live_call_router#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/live_call_router rootly_live_call_router} Data Source
  *
  * @param scope The scope in which to define this construct
