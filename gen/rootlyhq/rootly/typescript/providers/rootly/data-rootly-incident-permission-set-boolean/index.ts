// https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_permission_set_boolean
...
export interface DataRootlyIncidentPermissionSetBooleanConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_permission_set_boolean#created_at DataRootlyIncidentPermissionSetBoolean#created_at}
  */
  readonly createdAt?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_permission_set_boolean#kind DataRootlyIncidentPermissionSetBoolean#kind}
  */
  readonly kind?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_permission_set_boolean rootly_incident_permission_set_boolean}
*/
export class DataRootlyIncidentPermissionSetBoolean extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyIncidentPermissionSetBoolean that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_permission_set_boolean#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/incident_permission_set_boolean rootly_incident_permission_set_boolean} Data Source
  *
  * @param scope The scope in which to define this construct
