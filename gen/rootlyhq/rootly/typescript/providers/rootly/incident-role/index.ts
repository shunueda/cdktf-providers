// https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_role
...
export interface IncidentRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_role#allow_multi_user_assignment IncidentRole#allow_multi_user_assignment}
  */
  readonly allowMultiUserAssignment?: boolean | cdktf.IResolvable;
  /**
  * The description of the incident role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_role#description IncidentRole#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_role#enabled IncidentRole#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_role#id IncidentRole#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_role#name IncidentRole#name}
  */
  readonly name: string;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_role#optional IncidentRole#optional}
  */
  readonly optional?: boolean | cdktf.IResolvable;
  /**
  * Position of the incident role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_role#position IncidentRole#position}
  */
  readonly position?: number;
  /**
  * The slug of the incident role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_role#slug IncidentRole#slug}
  */
  readonly slug?: string;
  /**
  * The summary of the incident role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_role#summary IncidentRole#summary}
  */
  readonly summary?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_role rootly_incident_role}
*/
export class IncidentRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IncidentRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_role rootly_incident_role} Resource
  *
  * @param scope The scope in which to define this construct
