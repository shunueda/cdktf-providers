// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/form_set_condition
...
export interface FormSetConditionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/form_set_condition#comparison FormSetCondition#comparison}
  */
  readonly comparison?: string;
  /**
  * The form field this condition applies.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/form_set_condition#form_field_id FormSetCondition#form_field_id}
  */
  readonly formFieldId: string;
  /**
  * The form set this condition applies.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/form_set_condition#form_set_id FormSetCondition#form_set_id}
  */
  readonly formSetId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/form_set_condition#id FormSetCondition#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/form_set_condition#values FormSetCondition#values}
  */
  readonly values: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/form_set_condition rootly_form_set_condition}
*/
export class FormSetCondition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FormSetCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/form_set_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/form_set_condition rootly_form_set_condition} Resource
  *
  * @param scope The scope in which to define this construct
