// https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/form_field_position
...
export interface DataRootlyFormFieldPositionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/form_field_position#form DataRootlyFormFieldPosition#form}
  */
  readonly form?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/form_field_position rootly_form_field_position}
*/
export class DataRootlyFormFieldPosition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyFormFieldPosition that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/form_field_position#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/data-sources/form_field_position rootly_form_field_position} Data Source
  *
  * @param scope The scope in which to define this construct
