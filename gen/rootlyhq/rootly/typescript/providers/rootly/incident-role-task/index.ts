// https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/incident_role_task
...
export interface IncidentRoleTaskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/incident_role_task#description IncidentRoleTask#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/incident_role_task#id IncidentRoleTask#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/incident_role_task#incident_role_id IncidentRoleTask#incident_role_id}
  */
  readonly incidentRoleId?: string;
  /**
  * The priority of the incident task. Value must be one of `high`, `medium`, `low`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/incident_role_task#priority IncidentRoleTask#priority}
  */
  readonly priority?: string;
  /**
  * The task of the incident task
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/incident_role_task#task IncidentRoleTask#task}
  */
  readonly task: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/incident_role_task rootly_incident_role_task}
*/
export class IncidentRoleTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IncidentRoleTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/incident_role_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/incident_role_task rootly_incident_role_task} Resource
  *
  * @param scope The scope in which to define this construct
