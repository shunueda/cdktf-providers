// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/override_shift
...
export interface OverrideShiftConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/override_shift#ends_at OverrideShift#ends_at}
  */
  readonly endsAt: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/override_shift#id OverrideShift#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/override_shift#is_override OverrideShift#is_override}
  */
  readonly isOverride?: boolean | cdktf.IResolvable;
  /**
  * ID of rotation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/override_shift#rotation_id OverrideShift#rotation_id}
  */
  readonly rotationId?: string;
  /**
  * ID of schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/override_shift#schedule_id OverrideShift#schedule_id}
  */
  readonly scheduleId?: string;
  /**
  * Override metadata
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/override_shift#shift_override OverrideShift#shift_override}
  */
  readonly shiftOverride?: { [key: string]: string };
  /**
  * Start datetime of shift
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/override_shift#starts_at OverrideShift#starts_at}
  */
  readonly startsAt: string;
  /**
  * User metadata
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/override_shift#user OverrideShift#user}
  */
  readonly user?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/override_shift rootly_override_shift}
*/
export class OverrideShift extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OverrideShift that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/override_shift#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/override_shift rootly_override_shift} Resource
  *
  * @param scope The scope in which to define this construct
