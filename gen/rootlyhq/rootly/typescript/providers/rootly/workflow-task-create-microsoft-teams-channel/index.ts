// https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel
...
export interface WorkflowTaskCreateMicrosoftTeamsChannelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel#enabled WorkflowTaskCreateMicrosoftTeamsChannel#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel#id WorkflowTaskCreateMicrosoftTeamsChannel#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel#name WorkflowTaskCreateMicrosoftTeamsChannel#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel#position WorkflowTaskCreateMicrosoftTeamsChannel#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel#skip_on_failure WorkflowTaskCreateMicrosoftTeamsChannel#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel#workflow_id WorkflowTaskCreateMicrosoftTeamsChannel#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel#task_params WorkflowTaskCreateMicrosoftTeamsChannel#task_params}
  */
...
export interface WorkflowTaskCreateMicrosoftTeamsChannelTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel#description WorkflowTaskCreateMicrosoftTeamsChannel#description}
  */
  readonly description?: string;
  /**
  * Value must be one of `auto`, `true`, `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel#private WorkflowTaskCreateMicrosoftTeamsChannel#private}
  */
  readonly private?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel#task_type WorkflowTaskCreateMicrosoftTeamsChannel#task_type}
  */
  readonly taskType?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel#team WorkflowTaskCreateMicrosoftTeamsChannel#team}
  */
  readonly team?: { [key: string]: string };
  /**
  * Microsoft Team channel title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel#title WorkflowTaskCreateMicrosoftTeamsChannel#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel rootly_workflow_task_create_microsoft_teams_channel}
*/
export class WorkflowTaskCreateMicrosoftTeamsChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateMicrosoftTeamsChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_microsoft_teams_channel rootly_workflow_task_create_microsoft_teams_channel} Resource
  *
  * @param scope The scope in which to define this construct
