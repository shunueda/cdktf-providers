// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition
...
export interface WorkflowFormFieldConditionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition#form_field_id WorkflowFormFieldCondition#form_field_id}
  */
  readonly formFieldId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition#id WorkflowFormFieldCondition#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition#incident_condition WorkflowFormFieldCondition#incident_condition}
  */
  readonly incidentCondition?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition#selected_catalog_entity_ids WorkflowFormFieldCondition#selected_catalog_entity_ids}
  */
  readonly selectedCatalogEntityIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition#selected_functionality_ids WorkflowFormFieldCondition#selected_functionality_ids}
  */
  readonly selectedFunctionalityIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition#selected_group_ids WorkflowFormFieldCondition#selected_group_ids}
  */
  readonly selectedGroupIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition#selected_option_ids WorkflowFormFieldCondition#selected_option_ids}
  */
  readonly selectedOptionIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition#selected_service_ids WorkflowFormFieldCondition#selected_service_ids}
  */
  readonly selectedServiceIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition#selected_user_ids WorkflowFormFieldCondition#selected_user_ids}
  */
  readonly selectedUserIds?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition#values WorkflowFormFieldCondition#values}
  */
  readonly values?: string[];
  /**
  * The workflow for this condition
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition#workflow_id WorkflowFormFieldCondition#workflow_id}
  */
  readonly workflowId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition rootly_workflow_form_field_condition}
*/
export class WorkflowFormFieldCondition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowFormFieldCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_form_field_condition rootly_workflow_form_field_condition} Resource
  *
  * @param scope The scope in which to define this construct
