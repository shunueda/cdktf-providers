// https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/form_field_placement
...
export interface FormFieldPlacementConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/form_field_placement#form FormFieldPlacement#form}
  */
  readonly form: string;
  /**
  * The form field that is placed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/form_field_placement#form_field_id FormFieldPlacement#form_field_id}
  */
  readonly formFieldId?: string;
  /**
  * The form set this field is placed in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/form_field_placement#form_set_id FormFieldPlacement#form_set_id}
  */
  readonly formSetId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/form_field_placement#id FormFieldPlacement#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/form_field_placement#non_editable FormFieldPlacement#non_editable}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/form_field_placement#placement_operator FormFieldPlacement#placement_operator}
  */
  readonly placementOperator?: string;
  /**
  * The position of the field placement.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/form_field_placement#position FormFieldPlacement#position}
  */
  readonly position?: number;
  /**
  * Whether the field is unconditionally required on this form.. Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/form_field_placement#required FormFieldPlacement#required}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/form_field_placement#required_operator FormFieldPlacement#required_operator}
  */
  readonly requiredOperator?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/form_field_placement rootly_form_field_placement}
*/
export class FormFieldPlacement extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FormFieldPlacement that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/form_field_placement#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/form_field_placement rootly_form_field_placement} Resource
  *
  * @param scope The scope in which to define this construct
