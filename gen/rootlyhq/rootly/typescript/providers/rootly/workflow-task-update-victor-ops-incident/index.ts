// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident
...
export interface WorkflowTaskUpdateVictorOpsIncidentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident#enabled WorkflowTaskUpdateVictorOpsIncident#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident#id WorkflowTaskUpdateVictorOpsIncident#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident#name WorkflowTaskUpdateVictorOpsIncident#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident#position WorkflowTaskUpdateVictorOpsIncident#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident#skip_on_failure WorkflowTaskUpdateVictorOpsIncident#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident#workflow_id WorkflowTaskUpdateVictorOpsIncident#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident#task_params WorkflowTaskUpdateVictorOpsIncident#task_params}
  */
...
export interface WorkflowTaskUpdateVictorOpsIncidentTaskParams {
  ...
  * Resolution message
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident#resolution_message WorkflowTaskUpdateVictorOpsIncident#resolution_message}
  */
  readonly resolutionMessage?: string;
  /**
  * Value must be one of `resolve`, `ack`, `auto`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident#status WorkflowTaskUpdateVictorOpsIncident#status}
  */
  readonly status: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident#task_type WorkflowTaskUpdateVictorOpsIncident#task_type}
  */
  readonly taskType?: string;
  /**
  * The victor_ops incident ID, this can also be a Rootly incident variable 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident#victor_ops_incident_id WorkflowTaskUpdateVictorOpsIncident#victor_ops_incident_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident rootly_workflow_task_update_victor_ops_incident}
*/
export class WorkflowTaskUpdateVictorOpsIncident extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskUpdateVictorOpsIncident that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_victor_ops_incident rootly_workflow_task_update_victor_ops_incident} Resource
  *
  * @param scope The scope in which to define this construct
