// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/playbook
...
export interface PlaybookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/playbook#environment_ids Playbook#environment_ids}
  */
  readonly environmentIds?: string[];
  /**
  * The external url of the playbook
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/playbook#external_url Playbook#external_url}
  */
  readonly externalUrl?: string;
  /**
  * The Functionality ID's to attach to the incident
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/playbook#functionality_ids Playbook#functionality_ids}
  */
  readonly functionalityIds?: string[];
  /**
  * The Team ID's to attach to the incident
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/playbook#group_ids Playbook#group_ids}
  */
  readonly groupIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/playbook#id Playbook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/playbook#incident_type_ids Playbook#incident_type_ids}
  */
  readonly incidentTypeIds?: string[];
  /**
  * The Service ID's to attach to the incident
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/playbook#service_ids Playbook#service_ids}
  */
  readonly serviceIds?: string[];
  /**
  * The Severity ID's to attach to the incident
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/playbook#severity_ids Playbook#severity_ids}
  */
  readonly severityIds?: string[];
  /**
  * The summary of the playbook
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/playbook#summary Playbook#summary}
  */
  readonly summary?: string;
  /**
  * The title of the playbook
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/playbook#title Playbook#title}
  */
  readonly title: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/playbook rootly_playbook}
*/
export class Playbook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Playbook that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/playbook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/playbook rootly_playbook} Resource
  *
  * @param scope The scope in which to define this construct
