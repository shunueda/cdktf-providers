// https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion
...
export interface WorkflowTaskCreateWatsonxChatCompletionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion#enabled WorkflowTaskCreateWatsonxChatCompletion#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion#id WorkflowTaskCreateWatsonxChatCompletion#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion#name WorkflowTaskCreateWatsonxChatCompletion#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion#position WorkflowTaskCreateWatsonxChatCompletion#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion#skip_on_failure WorkflowTaskCreateWatsonxChatCompletion#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion#workflow_id WorkflowTaskCreateWatsonxChatCompletion#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion#task_params WorkflowTaskCreateWatsonxChatCompletion#task_params}
  */
...
export interface WorkflowTaskCreateWatsonxChatCompletionTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion#model WorkflowTaskCreateWatsonxChatCompletion#model}
  */
  readonly model: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion#project_id WorkflowTaskCreateWatsonxChatCompletion#project_id}
  */
  readonly projectId: string;
  /**
  * The prompt to send to WatsonX
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion#prompt WorkflowTaskCreateWatsonxChatCompletion#prompt}
  */
  readonly prompt: string;
  /**
  * The system prompt to send to WatsonX (optional)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion#system_prompt WorkflowTaskCreateWatsonxChatCompletion#system_prompt}
  */
  readonly systemPrompt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion#task_type WorkflowTaskCreateWatsonxChatCompletion#task_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion rootly_workflow_task_create_watsonx_chat_completion}
*/
export class WorkflowTaskCreateWatsonxChatCompletion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateWatsonxChatCompletion that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_create_watsonx_chat_completion rootly_workflow_task_create_watsonx_chat_completion} Resource
  *
  * @param scope The scope in which to define this construct
