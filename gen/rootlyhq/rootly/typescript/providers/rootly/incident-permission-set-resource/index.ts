// https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_permission_set_resource
...
export interface IncidentPermissionSetResourceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_permission_set_resource#id IncidentPermissionSetResource#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_permission_set_resource#incident_permission_set_id IncidentPermissionSetResource#incident_permission_set_id}
  */
  readonly incidentPermissionSetId: string;
  /**
  * Value must be one of `severities`, `incident_types`, `statuses`, `sub_statuses`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_permission_set_resource#kind IncidentPermissionSetResource#kind}
  */
  readonly kind?: string;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_permission_set_resource#private IncidentPermissionSetResource#private}
  */
  readonly private?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_permission_set_resource#resource_id IncidentPermissionSetResource#resource_id}
  */
  readonly resourceId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_permission_set_resource#resource_type IncidentPermissionSetResource#resource_type}
  */
  readonly resourceType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_permission_set_resource rootly_incident_permission_set_resource}
*/
export class IncidentPermissionSetResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IncidentPermissionSetResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_permission_set_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/incident_permission_set_resource rootly_incident_permission_set_resource} Resource
  *
  * @param scope The scope in which to define this construct
