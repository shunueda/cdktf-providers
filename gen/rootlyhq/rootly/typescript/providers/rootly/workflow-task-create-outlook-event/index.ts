// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event
...
export interface WorkflowTaskCreateOutlookEventConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#enabled WorkflowTaskCreateOutlookEvent#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#id WorkflowTaskCreateOutlookEvent#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#name WorkflowTaskCreateOutlookEvent#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#position WorkflowTaskCreateOutlookEvent#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#skip_on_failure WorkflowTaskCreateOutlookEvent#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#workflow_id WorkflowTaskCreateOutlookEvent#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#task_params WorkflowTaskCreateOutlookEvent#task_params}
  */
...
export interface WorkflowTaskCreateOutlookEventTaskParams {
  ...
  * Emails of attendees
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#attendees WorkflowTaskCreateOutlookEvent#attendees}
  */
  readonly attendees?: string[];
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#calendar WorkflowTaskCreateOutlookEvent#calendar}
  */
  readonly calendar: { [key: string]: string };
  /**
  * The days until meeting
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#days_until_meeting WorkflowTaskCreateOutlookEvent#days_until_meeting}
  */
  readonly daysUntilMeeting: string;
  /**
  * The event description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#description WorkflowTaskCreateOutlookEvent#description}
  */
  readonly description: string;
  /**
  * Enable Microsoft Teams online meeting. Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#enable_online_meeting WorkflowTaskCreateOutlookEvent#enable_online_meeting}
  */
  readonly enableOnlineMeeting?: boolean | cdktf.IResolvable;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#exclude_weekends WorkflowTaskCreateOutlookEvent#exclude_weekends}
  */
  readonly excludeWeekends?: boolean | cdktf.IResolvable;
  /**
  * Meeting duration in format like '1 hour', '30 minutes'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#meeting_duration WorkflowTaskCreateOutlookEvent#meeting_duration}
  */
  readonly meetingDuration: string;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#post_to_incident_timeline WorkflowTaskCreateOutlookEvent#post_to_incident_timeline}
  */
  readonly postToIncidentTimeline?: boolean | cdktf.IResolvable;
  /**
  * The event summary
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#summary WorkflowTaskCreateOutlookEvent#summary}
  */
  readonly summary: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#task_type WorkflowTaskCreateOutlookEvent#task_type}
  */
  readonly taskType?: string;
  /**
  * Time of meeting in format HH:MM
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#time_of_meeting WorkflowTaskCreateOutlookEvent#time_of_meeting}
  */
  readonly timeOfMeeting: string;
  /**
  * A valid IANA time zone name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#time_zone WorkflowTaskCreateOutlookEvent#time_zone}
  */
  readonly timeZone?: string;
  /**
  * post_to_slack_channels block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#post_to_slack_channels WorkflowTaskCreateOutlookEvent#post_to_slack_channels}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event rootly_workflow_task_create_outlook_event}
*/
export class WorkflowTaskCreateOutlookEvent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateOutlookEvent that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_outlook_event rootly_workflow_task_create_outlook_event} Resource
  *
  * @param scope The scope in which to define this construct
