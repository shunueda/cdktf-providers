// https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/data-sources/retrospective_configuration
...
export interface DataRootlyRetrospectiveConfigurationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/data-sources/retrospective_configuration#kind DataRootlyRetrospectiveConfiguration#kind}
  */
  readonly kind?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/data-sources/retrospective_configuration rootly_retrospective_configuration}
*/
export class DataRootlyRetrospectiveConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyRetrospectiveConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/data-sources/retrospective_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/data-sources/retrospective_configuration rootly_retrospective_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
