// https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email
...
export interface WorkflowTaskSendEmailConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#enabled WorkflowTaskSendEmail#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#id WorkflowTaskSendEmail#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#name WorkflowTaskSendEmail#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#position WorkflowTaskSendEmail#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#skip_on_failure WorkflowTaskSendEmail#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#workflow_id WorkflowTaskSendEmail#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#task_params WorkflowTaskSendEmail#task_params}
  */
  readonly taskParams: WorkflowTaskSendEmailTaskParams;
}
export interface WorkflowTaskSendEmailTaskParams {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#bcc WorkflowTaskSendEmail#bcc}
  */
  readonly bcc?: string[];
  /**
  * The email body
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#body WorkflowTaskSendEmail#body}
  */
  readonly body: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#cc WorkflowTaskSendEmail#cc}
  */
  readonly cc?: string[];
  /**
  * URL to your custom email logo
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#custom_logo_url WorkflowTaskSendEmail#custom_logo_url}
  */
  readonly customLogoUrl?: string;
  /**
  * The from email address. Need to use SMTP integration if different than rootly.com
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#from WorkflowTaskSendEmail#from}
  */
  readonly from?: string;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#include_footer WorkflowTaskSendEmail#include_footer}
  */
  readonly includeFooter?: boolean | cdktf.IResolvable;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#include_header WorkflowTaskSendEmail#include_header}
  */
  readonly includeHeader?: boolean | cdktf.IResolvable;
  /**
  * The preheader
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#preheader WorkflowTaskSendEmail#preheader}
  */
  readonly preheader?: string;
  /**
  * The subject
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#subject WorkflowTaskSendEmail#subject}
  */
  readonly subject: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#task_type WorkflowTaskSendEmail#task_type}
  */
  readonly taskType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#to WorkflowTaskSendEmail#to}
  */
  readonly to: string[];
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email rootly_workflow_task_send_email}
*/
export class WorkflowTaskSendEmail extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskSendEmail that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_send_email rootly_workflow_task_send_email} Resource
  *
  * @param scope The scope in which to define this construct
