// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab
...
export interface WorkflowTaskAddMicrosoftTeamsTabConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab#enabled WorkflowTaskAddMicrosoftTeamsTab#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab#id WorkflowTaskAddMicrosoftTeamsTab#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab#name WorkflowTaskAddMicrosoftTeamsTab#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab#position WorkflowTaskAddMicrosoftTeamsTab#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab#skip_on_failure WorkflowTaskAddMicrosoftTeamsTab#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab#workflow_id WorkflowTaskAddMicrosoftTeamsTab#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab#task_params WorkflowTaskAddMicrosoftTeamsTab#task_params}
  */
...
export interface WorkflowTaskAddMicrosoftTeamsTabTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab#channel WorkflowTaskAddMicrosoftTeamsTab#channel}
  */
  readonly channel: { [key: string]: string };
  /**
  * The tab link. Required if not a playbook tab
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab#link WorkflowTaskAddMicrosoftTeamsTab#link}
  */
  readonly link?: string;
  /**
  * The playbook id if tab is of an incident playbook
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab#playbook_id WorkflowTaskAddMicrosoftTeamsTab#playbook_id}
  */
  readonly playbookId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab#task_type WorkflowTaskAddMicrosoftTeamsTab#task_type}
  */
  readonly taskType?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab#team WorkflowTaskAddMicrosoftTeamsTab#team}
  */
  readonly team: { [key: string]: string };
  /**
  * The tab title. Required if not a playbook tab
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab#title WorkflowTaskAddMicrosoftTeamsTab#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab rootly_workflow_task_add_microsoft_teams_tab}
*/
export class WorkflowTaskAddMicrosoftTeamsTab extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskAddMicrosoftTeamsTab that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_add_microsoft_teams_tab rootly_workflow_task_add_microsoft_teams_tab} Resource
  *
  * @param scope The scope in which to define this construct
