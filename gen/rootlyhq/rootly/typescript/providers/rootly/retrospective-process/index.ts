// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/retrospective_process
...
export interface RetrospectiveProcessConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/retrospective_process#copy_from RetrospectiveProcess#copy_from}
  */
  readonly copyFrom?: string;
  /**
  * The description of the retrospective process
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/retrospective_process#description RetrospectiveProcess#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/retrospective_process#id RetrospectiveProcess#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/retrospective_process#is_default RetrospectiveProcess#is_default}
  */
  readonly isDefault?: boolean | cdktf.IResolvable;
  /**
  * The name of the retrospective process
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/retrospective_process#name RetrospectiveProcess#name}
  */
  readonly name: string;
  /**
  * retrospective_process_matching_criteria block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/retrospective_process#retrospective_process_matching_criteria RetrospectiveProcess#retrospective_process_matching_criteria}
  */
...
export interface RetrospectiveProcessRetrospectiveProcessMatchingCriteria {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/retrospective_process#group_ids RetrospectiveProcess#group_ids}
  */
  readonly groupIds?: string[];
  /**
  * Incident types for process matching criteria.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/retrospective_process#incident_type_ids RetrospectiveProcess#incident_type_ids}
  */
  readonly incidentTypeIds?: string[];
  /**
  * Severities for process matching criteria.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/retrospective_process#severity_ids RetrospectiveProcess#severity_ids}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/retrospective_process rootly_retrospective_process}
*/
export class RetrospectiveProcess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RetrospectiveProcess that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/retrospective_process#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/retrospective_process rootly_retrospective_process} Resource
  *
  * @param scope The scope in which to define this construct
