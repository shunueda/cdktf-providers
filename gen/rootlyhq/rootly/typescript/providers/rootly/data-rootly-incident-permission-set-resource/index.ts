// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/incident_permission_set_resource
...
export interface DataRootlyIncidentPermissionSetResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/incident_permission_set_resource#created_at DataRootlyIncidentPermissionSetResource#created_at}
  */
  readonly createdAt?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/incident_permission_set_resource#kind DataRootlyIncidentPermissionSetResource#kind}
  */
  readonly kind?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/incident_permission_set_resource rootly_incident_permission_set_resource}
*/
export class DataRootlyIncidentPermissionSetResource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyIncidentPermissionSetResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/incident_permission_set_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/incident_permission_set_resource rootly_incident_permission_set_resource} Data Source
  *
  * @param scope The scope in which to define this construct
