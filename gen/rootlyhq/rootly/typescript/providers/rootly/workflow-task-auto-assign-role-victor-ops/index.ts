// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_auto_assign_role_victor_ops
...
export interface WorkflowTaskAutoAssignRoleVictorOpsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_auto_assign_role_victor_ops#enabled WorkflowTaskAutoAssignRoleVictorOps#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_auto_assign_role_victor_ops#id WorkflowTaskAutoAssignRoleVictorOps#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_auto_assign_role_victor_ops#name WorkflowTaskAutoAssignRoleVictorOps#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_auto_assign_role_victor_ops#position WorkflowTaskAutoAssignRoleVictorOps#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_auto_assign_role_victor_ops#skip_on_failure WorkflowTaskAutoAssignRoleVictorOps#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_auto_assign_role_victor_ops#workflow_id WorkflowTaskAutoAssignRoleVictorOps#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_auto_assign_role_victor_ops#task_params WorkflowTaskAutoAssignRoleVictorOps#task_params}
  */
...
export interface WorkflowTaskAutoAssignRoleVictorOpsTaskParams {
  ...
  * The role id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_auto_assign_role_victor_ops#incident_role_id WorkflowTaskAutoAssignRoleVictorOps#incident_role_id}
  */
  readonly incidentRoleId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_auto_assign_role_victor_ops#task_type WorkflowTaskAutoAssignRoleVictorOps#task_type}
  */
  readonly taskType?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_auto_assign_role_victor_ops#team WorkflowTaskAutoAssignRoleVictorOps#team}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_auto_assign_role_victor_ops rootly_workflow_task_auto_assign_role_victor_ops}
*/
export class WorkflowTaskAutoAssignRoleVictorOps extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskAutoAssignRoleVictorOps that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_auto_assign_role_victor_ops#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_auto_assign_role_victor_ops rootly_workflow_task_auto_assign_role_victor_ops} Resource
  *
  * @param scope The scope in which to define this construct
