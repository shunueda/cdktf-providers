// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/incident_sub_status
...
export interface IncidentSubStatusConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/incident_sub_status#assigned_at IncidentSubStatus#assigned_at}
  */
  readonly assignedAt: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/incident_sub_status#assigned_by_user_id IncidentSubStatus#assigned_by_user_id}
  */
  readonly assignedByUserId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/incident_sub_status#id IncidentSubStatus#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/incident_sub_status#incident_id IncidentSubStatus#incident_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/incident_sub_status#sub_status_id IncidentSubStatus#sub_status_id}
  */
  readonly subStatusId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/incident_sub_status rootly_incident_sub_status}
*/
export class IncidentSubStatus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IncidentSubStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/incident_sub_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/incident_sub_status rootly_incident_sub_status} Resource
  *
  * @param scope The scope in which to define this construct
