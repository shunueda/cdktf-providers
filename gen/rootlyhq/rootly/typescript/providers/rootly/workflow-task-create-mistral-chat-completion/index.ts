// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion
...
export interface WorkflowTaskCreateMistralChatCompletionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#enabled WorkflowTaskCreateMistralChatCompletion#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#id WorkflowTaskCreateMistralChatCompletion#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#name WorkflowTaskCreateMistralChatCompletion#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#position WorkflowTaskCreateMistralChatCompletion#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#skip_on_failure WorkflowTaskCreateMistralChatCompletion#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#workflow_id WorkflowTaskCreateMistralChatCompletion#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#task_params WorkflowTaskCreateMistralChatCompletion#task_params}
  */
...
export interface WorkflowTaskCreateMistralChatCompletionTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#max_tokens WorkflowTaskCreateMistralChatCompletion#max_tokens}
  */
  readonly maxTokens?: string;
  /**
  * Map must contain two fields, `id` and `name`. The Mistral model. eg: mistral-large-latest
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#model WorkflowTaskCreateMistralChatCompletion#model}
  */
  readonly model: { [key: string]: string };
  /**
  * The prompt to send to Mistral
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#prompt WorkflowTaskCreateMistralChatCompletion#prompt}
  */
  readonly prompt: string;
  /**
  * The system prompt to send to Mistral (optional)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#system_prompt WorkflowTaskCreateMistralChatCompletion#system_prompt}
  */
  readonly systemPrompt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#task_type WorkflowTaskCreateMistralChatCompletion#task_type}
  */
  readonly taskType?: string;
  /**
  * Sampling temperature (0.0-1.5). Higher values make output more random.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#temperature WorkflowTaskCreateMistralChatCompletion#temperature}
  */
  readonly temperature?: number;
  /**
  * Nucleus sampling parameter (0.0-1.0)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#top_p WorkflowTaskCreateMistralChatCompletion#top_p}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion rootly_workflow_task_create_mistral_chat_completion}
*/
export class WorkflowTaskCreateMistralChatCompletion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateMistralChatCompletion that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_mistral_chat_completion rootly_workflow_task_create_mistral_chat_completion} Resource
  *
  * @param scope The scope in which to define this construct
