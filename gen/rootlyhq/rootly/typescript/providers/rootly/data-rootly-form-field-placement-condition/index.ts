// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/data-sources/form_field_placement_condition
...
export interface DataRootlyFormFieldPlacementConditionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/data-sources/form_field_placement_condition#form_field_id DataRootlyFormFieldPlacementCondition#form_field_id}
  */
  readonly formFieldId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/data-sources/form_field_placement_condition rootly_form_field_placement_condition}
*/
export class DataRootlyFormFieldPlacementCondition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyFormFieldPlacementCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/data-sources/form_field_placement_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/data-sources/form_field_placement_condition rootly_form_field_placement_condition} Data Source
  *
  * @param scope The scope in which to define this construct
