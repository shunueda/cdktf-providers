// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record
...
export interface WorkflowTaskCreateAirtableTableRecordConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record#enabled WorkflowTaskCreateAirtableTableRecord#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record#id WorkflowTaskCreateAirtableTableRecord#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record#name WorkflowTaskCreateAirtableTableRecord#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record#position WorkflowTaskCreateAirtableTableRecord#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record#skip_on_failure WorkflowTaskCreateAirtableTableRecord#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record#workflow_id WorkflowTaskCreateAirtableTableRecord#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record#task_params WorkflowTaskCreateAirtableTableRecord#task_params}
  */
...
export interface WorkflowTaskCreateAirtableTableRecordTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record#base WorkflowTaskCreateAirtableTableRecord#base}
  */
  readonly base: { [key: string]: string };
  /**
  * Custom field mappings. Can contain liquid markup and need to be valid JSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record#custom_fields_mapping WorkflowTaskCreateAirtableTableRecord#custom_fields_mapping}
  */
  readonly customFieldsMapping?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record#table WorkflowTaskCreateAirtableTableRecord#table}
  */
  readonly table: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record#task_type WorkflowTaskCreateAirtableTableRecord#task_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record rootly_workflow_task_create_airtable_table_record}
*/
export class WorkflowTaskCreateAirtableTableRecord extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateAirtableTableRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_create_airtable_table_record rootly_workflow_task_create_airtable_table_record} Resource
  *
  * @param scope The scope in which to define this construct
