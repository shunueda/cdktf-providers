// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/escalation_policy
...
export interface DataRootlyEscalationPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/escalation_policy#created_at DataRootlyEscalationPolicy#created_at}
  */
  readonly createdAt?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/escalation_policy#name DataRootlyEscalationPolicy#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/escalation_policy rootly_escalation_policy}
*/
export class DataRootlyEscalationPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyEscalationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/escalation_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/data-sources/escalation_policy rootly_escalation_policy} Data Source
  *
  * @param scope The scope in which to define this construct
