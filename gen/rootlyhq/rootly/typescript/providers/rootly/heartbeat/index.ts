// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat
...
export interface HeartbeatConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#alert_description Heartbeat#alert_description}
  */
  readonly alertDescription?: string;
  /**
  * Summary of alerts triggered when heartbeat expires.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#alert_summary Heartbeat#alert_summary}
  */
  readonly alertSummary: string;
  /**
  * Urgency of alerts triggered when heartbeat expires.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#alert_urgency_id Heartbeat#alert_urgency_id}
  */
  readonly alertUrgencyId?: string;
  /**
  * The description of the heartbeat
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#description Heartbeat#description}
  */
  readonly description?: string;
  /**
  * Email address to receive heartbeat pings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#email_address Heartbeat#email_address}
  */
  readonly emailAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#enabled Heartbeat#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * When heartbeat expires
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#expires_at Heartbeat#expires_at}
  */
  readonly expiresAt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#id Heartbeat#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#interval Heartbeat#interval}
  */
  readonly interval: number;
  /**
  * Value must be one of `seconds`, `minutes`, `hours`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#interval_unit Heartbeat#interval_unit}
  */
  readonly intervalUnit?: string;
  /**
  * When the heartbeat was last pinged.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#last_pinged_at Heartbeat#last_pinged_at}
  */
  readonly lastPingedAt?: string;
  /**
  * The name of the heartbeat
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#name Heartbeat#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#notification_target_id Heartbeat#notification_target_id}
  */
  readonly notificationTargetId: string;
  /**
  * Value must be one of `User`, `Group`, `Service`, `EscalationPolicy`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#notification_target_type Heartbeat#notification_target_type}
  */
  readonly notificationTargetType?: string;
  /**
  * URL to receive heartbeat pings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#ping_url Heartbeat#ping_url}
  */
  readonly pingUrl?: string;
  /**
  * Secret used as bearer token when pinging heartbeat.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#secret Heartbeat#secret}
  */
  readonly secret?: string;
  /**
  * Value must be one of `waiting`, `active`, `expired`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#status Heartbeat#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat rootly_heartbeat}
*/
export class Heartbeat extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Heartbeat that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/heartbeat rootly_heartbeat} Resource
  *
  * @param scope The scope in which to define this construct
