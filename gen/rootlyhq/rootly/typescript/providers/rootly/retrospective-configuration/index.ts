// https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/retrospective_configuration
...
export interface RetrospectiveConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/retrospective_configuration#group_ids RetrospectiveConfiguration#group_ids}
  */
  readonly groupIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/retrospective_configuration#id RetrospectiveConfiguration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/retrospective_configuration#incident_type_ids RetrospectiveConfiguration#incident_type_ids}
  */
  readonly incidentTypeIds?: string[];
  /**
  * The kind of the retrospective configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/retrospective_configuration#kind RetrospectiveConfiguration#kind}
  */
  readonly kind?: string;
  /**
  * Severities associated with the retrospective configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/retrospective_configuration#severity_ids RetrospectiveConfiguration#severity_ids}
  */
  readonly severityIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/retrospective_configuration rootly_retrospective_configuration}
*/
export class RetrospectiveConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RetrospectiveConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/retrospective_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/retrospective_configuration rootly_retrospective_configuration} Resource
  *
  * @param scope The scope in which to define this construct
