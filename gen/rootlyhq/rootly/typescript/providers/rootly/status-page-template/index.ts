// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/status_page_template
...
export interface StatusPageTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/status_page_template#body StatusPageTemplate#body}
  */
  readonly body: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/status_page_template#enabled StatusPageTemplate#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/status_page_template#id StatusPageTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/status_page_template#kind StatusPageTemplate#kind}
  */
  readonly kind?: string;
  /**
  * Position of the workflow task
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/status_page_template#position StatusPageTemplate#position}
  */
  readonly position?: number;
  /**
  * Controls if incident subscribers should be notified. Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/status_page_template#should_notify_subscribers StatusPageTemplate#should_notify_subscribers}
  */
  readonly shouldNotifySubscribers?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/status_page_template#status_page_id StatusPageTemplate#status_page_id}
  */
  readonly statusPageId?: string;
  /**
  * Title of the template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/status_page_template#title StatusPageTemplate#title}
  */
  readonly title: string;
  /**
  * Status of the event the template will populate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/status_page_template#update_status StatusPageTemplate#update_status}
  */
  readonly updateStatus?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/status_page_template rootly_status_page_template}
*/
export class StatusPageTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StatusPageTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/status_page_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/status_page_template rootly_status_page_template} Resource
  *
  * @param scope The scope in which to define this construct
