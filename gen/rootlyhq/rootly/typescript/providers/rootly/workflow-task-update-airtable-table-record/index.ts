// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record
...
export interface WorkflowTaskUpdateAirtableTableRecordConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record#enabled WorkflowTaskUpdateAirtableTableRecord#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record#id WorkflowTaskUpdateAirtableTableRecord#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record#name WorkflowTaskUpdateAirtableTableRecord#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record#position WorkflowTaskUpdateAirtableTableRecord#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record#skip_on_failure WorkflowTaskUpdateAirtableTableRecord#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record#workflow_id WorkflowTaskUpdateAirtableTableRecord#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record#task_params WorkflowTaskUpdateAirtableTableRecord#task_params}
  */
...
export interface WorkflowTaskUpdateAirtableTableRecordTaskParams {
  ...
  * The base key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record#base_key WorkflowTaskUpdateAirtableTableRecord#base_key}
  */
  readonly baseKey: string;
  /**
  * Custom field mappings. Can contain liquid markup and need to be valid JSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record#custom_fields_mapping WorkflowTaskUpdateAirtableTableRecord#custom_fields_mapping}
  */
  readonly customFieldsMapping?: string;
  /**
  * The record id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record#record_id WorkflowTaskUpdateAirtableTableRecord#record_id}
  */
  readonly recordId: string;
  /**
  * The table name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record#table_name WorkflowTaskUpdateAirtableTableRecord#table_name}
  */
  readonly tableName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record#task_type WorkflowTaskUpdateAirtableTableRecord#task_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record rootly_workflow_task_update_airtable_table_record}
*/
export class WorkflowTaskUpdateAirtableTableRecord extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskUpdateAirtableTableRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_airtable_table_record rootly_workflow_task_update_airtable_table_record} Resource
  *
  * @param scope The scope in which to define this construct
