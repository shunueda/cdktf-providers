// https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark
...
export interface WorkflowTaskAddSlackBookmarkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark#enabled WorkflowTaskAddSlackBookmark#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark#id WorkflowTaskAddSlackBookmark#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark#name WorkflowTaskAddSlackBookmark#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark#position WorkflowTaskAddSlackBookmark#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark#skip_on_failure WorkflowTaskAddSlackBookmark#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark#workflow_id WorkflowTaskAddSlackBookmark#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark#task_params WorkflowTaskAddSlackBookmark#task_params}
  */
...
export interface WorkflowTaskAddSlackBookmarkTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark#channel WorkflowTaskAddSlackBookmark#channel}
  */
  readonly channel: { [key: string]: string };
  /**
  * The bookmark emoji
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark#emoji WorkflowTaskAddSlackBookmark#emoji}
  */
  readonly emoji?: string;
  /**
  * The bookmark link. Required if not a playbook bookmark
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark#link WorkflowTaskAddSlackBookmark#link}
  */
  readonly link?: string;
  /**
  * The playbook id if bookmark is of an incident playbook
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark#playbook_id WorkflowTaskAddSlackBookmark#playbook_id}
  */
  readonly playbookId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark#task_type WorkflowTaskAddSlackBookmark#task_type}
  */
  readonly taskType?: string;
  /**
  * The bookmark title. Required if not a playbook bookmark
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark#title WorkflowTaskAddSlackBookmark#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark rootly_workflow_task_add_slack_bookmark}
*/
export class WorkflowTaskAddSlackBookmark extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskAddSlackBookmark that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_add_slack_bookmark rootly_workflow_task_add_slack_bookmark} Resource
  *
  * @param scope The scope in which to define this construct
