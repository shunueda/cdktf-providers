// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/schedule
...
export interface ScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/schedule#all_time_coverage Schedule#all_time_coverage}
  */
  readonly allTimeCoverage?: boolean | cdktf.IResolvable;
  /**
  * The description of the schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/schedule#description Schedule#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/schedule#id Schedule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/schedule#name Schedule#name}
  */
  readonly name: string;
  /**
  * The owning teams for this schedules.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/schedule#owner_group_ids Schedule#owner_group_ids}
  */
  readonly ownerGroupIds?: string[];
  /**
  * ID of user assigned as owner of the schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/schedule#owner_user_id Schedule#owner_user_id}
  */
  readonly ownerUserId?: number;
  /**
  * Map must contain two fields, `id` and `name`. Synced slack channel of the schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/schedule#slack_channel Schedule#slack_channel}
  */
  readonly slackChannel?: { [key: string]: string };
  /**
  * Map must contain two fields, `id` and `name`. Synced slack group of the schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/schedule#slack_user_group Schedule#slack_user_group}
  */
  readonly slackUserGroup?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/schedule rootly_schedule}
*/
export class Schedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Schedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/schedule rootly_schedule} Resource
  *
  * @param scope The scope in which to define this construct
