// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/retrospective_step
...
export interface RetrospectiveStepConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/retrospective_step#description RetrospectiveStep#description}
  */
  readonly description?: string;
  /**
  * Due date in days
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/retrospective_step#due_after_days RetrospectiveStep#due_after_days}
  */
  readonly dueAfterDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/retrospective_step#id RetrospectiveStep#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/retrospective_step#incident_role_id RetrospectiveStep#incident_role_id}
  */
  readonly incidentRoleId?: string;
  /**
  * Position of the step
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/retrospective_step#position RetrospectiveStep#position}
  */
  readonly position?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/retrospective_step#retrospective_process_id RetrospectiveStep#retrospective_process_id}
  */
  readonly retrospectiveProcessId?: string;
  /**
  * Is the step skippable?. Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/retrospective_step#skippable RetrospectiveStep#skippable}
  */
  readonly skippable?: boolean | cdktf.IResolvable;
  /**
  * The slug of the step
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/retrospective_step#slug RetrospectiveStep#slug}
  */
  readonly slug?: string;
  /**
  * The name of the step
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/retrospective_step#title RetrospectiveStep#title}
  */
  readonly title: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/retrospective_step rootly_retrospective_step}
*/
export class RetrospectiveStep extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RetrospectiveStep that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/retrospective_step#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/retrospective_step rootly_retrospective_step} Resource
  *
  * @param scope The scope in which to define this construct
