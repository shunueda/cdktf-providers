// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_custom_field_selection
...
export interface WorkflowCustomFieldSelectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_custom_field_selection#custom_field_id WorkflowCustomFieldSelection#custom_field_id}
  */
  readonly customFieldId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_custom_field_selection#id WorkflowCustomFieldSelection#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_custom_field_selection#incident_condition WorkflowCustomFieldSelection#incident_condition}
  */
  readonly incidentCondition?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_custom_field_selection#selected_option_ids WorkflowCustomFieldSelection#selected_option_ids}
  */
  readonly selectedOptionIds?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_custom_field_selection#values WorkflowCustomFieldSelection#values}
  */
  readonly values?: string[];
  /**
  * The workflow for this selection
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_custom_field_selection#workflow_id WorkflowCustomFieldSelection#workflow_id}
  */
  readonly workflowId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_custom_field_selection rootly_workflow_custom_field_selection}
*/
export class WorkflowCustomFieldSelection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowCustomFieldSelection that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_custom_field_selection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_custom_field_selection rootly_workflow_custom_field_selection} Resource
  *
  * @param scope The scope in which to define this construct
