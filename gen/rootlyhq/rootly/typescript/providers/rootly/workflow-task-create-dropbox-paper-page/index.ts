// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page
...
export interface WorkflowTaskCreateDropboxPaperPageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#enabled WorkflowTaskCreateDropboxPaperPage#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#id WorkflowTaskCreateDropboxPaperPage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#name WorkflowTaskCreateDropboxPaperPage#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#position WorkflowTaskCreateDropboxPaperPage#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#skip_on_failure WorkflowTaskCreateDropboxPaperPage#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#workflow_id WorkflowTaskCreateDropboxPaperPage#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#task_params WorkflowTaskCreateDropboxPaperPage#task_params}
  */
...
export interface WorkflowTaskCreateDropboxPaperPageTaskParams {
  ...
  * The page content
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#content WorkflowTaskCreateDropboxPaperPage#content}
  */
  readonly content?: string;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#mark_post_mortem_as_published WorkflowTaskCreateDropboxPaperPage#mark_post_mortem_as_published}
  */
  readonly markPostMortemAsPublished?: boolean | cdktf.IResolvable;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#namespace WorkflowTaskCreateDropboxPaperPage#namespace}
  */
  readonly namespace?: { [key: string]: string };
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#parent_folder WorkflowTaskCreateDropboxPaperPage#parent_folder}
  */
  readonly parentFolder?: { [key: string]: string };
  /**
  * Retrospective template to use when creating page task, if desired
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#post_mortem_template_id WorkflowTaskCreateDropboxPaperPage#post_mortem_template_id}
  */
  readonly postMortemTemplateId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#task_type WorkflowTaskCreateDropboxPaperPage#task_type}
  */
  readonly taskType?: string;
  /**
  * The page task title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#title WorkflowTaskCreateDropboxPaperPage#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page rootly_workflow_task_create_dropbox_paper_page}
*/
export class WorkflowTaskCreateDropboxPaperPage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateDropboxPaperPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_dropbox_paper_page rootly_workflow_task_create_dropbox_paper_page} Resource
  *
  * @param scope The scope in which to define this construct
