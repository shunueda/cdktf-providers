// https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/incident_permission_set
...
export interface IncidentPermissionSetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/incident_permission_set#description IncidentPermissionSet#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/incident_permission_set#id IncidentPermissionSet#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/incident_permission_set#name IncidentPermissionSet#name}
  */
  readonly name: string;
  /**
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/incident_permission_set#private_incident_permissions IncidentPermissionSet#private_incident_permissions}
  */
  readonly privateIncidentPermissions?: string[];
  /**
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/incident_permission_set#public_incident_permissions IncidentPermissionSet#public_incident_permissions}
  */
  readonly publicIncidentPermissions?: string[];
  /**
  * The incident permission set slug.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/incident_permission_set#slug IncidentPermissionSet#slug}
  */
  readonly slug?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/incident_permission_set rootly_incident_permission_set}
*/
export class IncidentPermissionSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IncidentPermissionSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/incident_permission_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/incident_permission_set rootly_incident_permission_set} Resource
  *
  * @param scope The scope in which to define this construct
