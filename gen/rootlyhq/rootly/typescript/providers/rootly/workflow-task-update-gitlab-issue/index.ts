// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue
...
export interface WorkflowTaskUpdateGitlabIssueConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#enabled WorkflowTaskUpdateGitlabIssue#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#id WorkflowTaskUpdateGitlabIssue#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#name WorkflowTaskUpdateGitlabIssue#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#position WorkflowTaskUpdateGitlabIssue#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#skip_on_failure WorkflowTaskUpdateGitlabIssue#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#workflow_id WorkflowTaskUpdateGitlabIssue#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#task_params WorkflowTaskUpdateGitlabIssue#task_params}
  */
...
export interface WorkflowTaskUpdateGitlabIssueTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#completion WorkflowTaskUpdateGitlabIssue#completion}
  */
  readonly completion: { [key: string]: string };
  /**
  * The issue description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#description WorkflowTaskUpdateGitlabIssue#description}
  */
  readonly description?: string;
  /**
  * The due date
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#due_date WorkflowTaskUpdateGitlabIssue#due_date}
  */
  readonly dueDate?: string;
  /**
  * The issue id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#issue_id WorkflowTaskUpdateGitlabIssue#issue_id}
  */
  readonly issueId: string;
  /**
  * The issue type. Value must be one of `issue`, `incident`, `test_case`, `task`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#issue_type WorkflowTaskUpdateGitlabIssue#issue_type}
  */
  readonly issueType?: string;
  /**
  * The issue labels
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#labels WorkflowTaskUpdateGitlabIssue#labels}
  */
  readonly labels?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#task_type WorkflowTaskUpdateGitlabIssue#task_type}
  */
  readonly taskType?: string;
  /**
  * The issue title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#title WorkflowTaskUpdateGitlabIssue#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue rootly_workflow_task_update_gitlab_issue}
*/
export class WorkflowTaskUpdateGitlabIssue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskUpdateGitlabIssue that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_update_gitlab_issue rootly_workflow_task_update_gitlab_issue} Resource
  *
  * @param scope The scope in which to define this construct
