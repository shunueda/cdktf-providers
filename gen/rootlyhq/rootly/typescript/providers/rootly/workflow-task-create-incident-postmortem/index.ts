// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem
...
export interface WorkflowTaskCreateIncidentPostmortemConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem#enabled WorkflowTaskCreateIncidentPostmortem#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem#id WorkflowTaskCreateIncidentPostmortem#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem#name WorkflowTaskCreateIncidentPostmortem#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem#position WorkflowTaskCreateIncidentPostmortem#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem#skip_on_failure WorkflowTaskCreateIncidentPostmortem#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem#workflow_id WorkflowTaskCreateIncidentPostmortem#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem#task_params WorkflowTaskCreateIncidentPostmortem#task_params}
  */
...
export interface WorkflowTaskCreateIncidentPostmortemTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem#incident_id WorkflowTaskCreateIncidentPostmortem#incident_id}
  */
  readonly incidentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem#status WorkflowTaskCreateIncidentPostmortem#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem#task_type WorkflowTaskCreateIncidentPostmortem#task_type}
  */
  readonly taskType?: string;
  /**
  * Map must contain two fields, `id` and `name`. Retrospective template to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem#template WorkflowTaskCreateIncidentPostmortem#template}
  */
  readonly template?: { [key: string]: string };
  /**
  * The retrospective title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem#title WorkflowTaskCreateIncidentPostmortem#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem rootly_workflow_task_create_incident_postmortem}
*/
export class WorkflowTaskCreateIncidentPostmortem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateIncidentPostmortem that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_incident_postmortem rootly_workflow_task_create_incident_postmortem} Resource
  *
  * @param scope The scope in which to define this construct
