// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page
...
export interface WorkflowTaskUpdateGoogleDocsPageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page#enabled WorkflowTaskUpdateGoogleDocsPage#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page#id WorkflowTaskUpdateGoogleDocsPage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page#name WorkflowTaskUpdateGoogleDocsPage#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page#position WorkflowTaskUpdateGoogleDocsPage#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page#skip_on_failure WorkflowTaskUpdateGoogleDocsPage#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page#workflow_id WorkflowTaskUpdateGoogleDocsPage#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page#task_params WorkflowTaskUpdateGoogleDocsPage#task_params}
  */
...
export interface WorkflowTaskUpdateGoogleDocsPageTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page#content WorkflowTaskUpdateGoogleDocsPage#content}
  */
  readonly content?: string;
  /**
  * The Google Doc file ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page#file_id WorkflowTaskUpdateGoogleDocsPage#file_id}
  */
  readonly fileId: string;
  /**
  * Retrospective template to use when updating page, if desired
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page#post_mortem_template_id WorkflowTaskUpdateGoogleDocsPage#post_mortem_template_id}
  */
  readonly postMortemTemplateId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page#task_type WorkflowTaskUpdateGoogleDocsPage#task_type}
  */
  readonly taskType?: string;
  /**
  * The Google Doc file ID to use as a template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page#template_id WorkflowTaskUpdateGoogleDocsPage#template_id}
  */
  readonly templateId?: string;
  /**
  * The Google Doc title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page#title WorkflowTaskUpdateGoogleDocsPage#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page rootly_workflow_task_update_google_docs_page}
*/
export class WorkflowTaskUpdateGoogleDocsPage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskUpdateGoogleDocsPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_update_google_docs_page rootly_workflow_task_update_google_docs_page} Resource
  *
  * @param scope The scope in which to define this construct
