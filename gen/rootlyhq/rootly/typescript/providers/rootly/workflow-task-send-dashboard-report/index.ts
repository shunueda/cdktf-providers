// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report
...
export interface WorkflowTaskSendDashboardReportConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#enabled WorkflowTaskSendDashboardReport#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#id WorkflowTaskSendDashboardReport#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#name WorkflowTaskSendDashboardReport#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#position WorkflowTaskSendDashboardReport#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#skip_on_failure WorkflowTaskSendDashboardReport#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#workflow_id WorkflowTaskSendDashboardReport#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#task_params WorkflowTaskSendDashboardReport#task_params}
  */
...
export interface WorkflowTaskSendDashboardReportTaskParams {
  ...
  * The email body
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#body WorkflowTaskSendDashboardReport#body}
  */
  readonly body: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#dashboard_ids WorkflowTaskSendDashboardReport#dashboard_ids}
  */
  readonly dashboardIds: string[];
  /**
  * The from email address. Need to use SMTP integration if different than rootly.com
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#from WorkflowTaskSendDashboardReport#from}
  */
  readonly from?: string;
  /**
  * The preheader
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#preheader WorkflowTaskSendDashboardReport#preheader}
  */
  readonly preheader?: string;
  /**
  * The subject
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#subject WorkflowTaskSendDashboardReport#subject}
  */
  readonly subject: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#task_type WorkflowTaskSendDashboardReport#task_type}
  */
  readonly taskType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#to WorkflowTaskSendDashboardReport#to}
  */
  readonly to: string[];
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report rootly_workflow_task_send_dashboard_report}
*/
export class WorkflowTaskSendDashboardReport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskSendDashboardReport that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_send_dashboard_report rootly_workflow_task_send_dashboard_report} Resource
  *
  * @param scope The scope in which to define this construct
