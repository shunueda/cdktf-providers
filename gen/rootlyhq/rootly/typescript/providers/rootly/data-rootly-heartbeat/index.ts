// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/data-sources/heartbeat
...
export interface DataRootlyHeartbeatConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/data-sources/heartbeat#created_at DataRootlyHeartbeat#created_at}
  */
  readonly createdAt?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/data-sources/heartbeat#name DataRootlyHeartbeat#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/data-sources/heartbeat rootly_heartbeat}
*/
export class DataRootlyHeartbeat extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyHeartbeat that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/data-sources/heartbeat#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/data-sources/heartbeat rootly_heartbeat} Data Source
  *
  * @param scope The scope in which to define this construct
