// https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/ip_ranges
...
export interface DataRootlyIpRangesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/ip_ranges#id DataRootlyIpRanges#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/ip_ranges rootly_ip_ranges}
*/
export class DataRootlyIpRanges extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyIpRanges that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/ip_ranges#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/data-sources/ip_ranges rootly_ip_ranges} Data Source
  *
  * @param scope The scope in which to define this construct
