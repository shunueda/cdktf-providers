// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_change_slack_channel_privacy
...
export interface WorkflowTaskChangeSlackChannelPrivacyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_change_slack_channel_privacy#enabled WorkflowTaskChangeSlackChannelPrivacy#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_change_slack_channel_privacy#id WorkflowTaskChangeSlackChannelPrivacy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_change_slack_channel_privacy#name WorkflowTaskChangeSlackChannelPrivacy#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_change_slack_channel_privacy#position WorkflowTaskChangeSlackChannelPrivacy#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_change_slack_channel_privacy#skip_on_failure WorkflowTaskChangeSlackChannelPrivacy#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_change_slack_channel_privacy#workflow_id WorkflowTaskChangeSlackChannelPrivacy#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_change_slack_channel_privacy#task_params WorkflowTaskChangeSlackChannelPrivacy#task_params}
  */
...
export interface WorkflowTaskChangeSlackChannelPrivacyTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_change_slack_channel_privacy#channel WorkflowTaskChangeSlackChannelPrivacy#channel}
  */
  readonly channel?: { [key: string]: string };
  /**
  * Value must be one of `private`, `public`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_change_slack_channel_privacy#privacy WorkflowTaskChangeSlackChannelPrivacy#privacy}
  */
  readonly privacy: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_change_slack_channel_privacy#task_type WorkflowTaskChangeSlackChannelPrivacy#task_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_change_slack_channel_privacy rootly_workflow_task_change_slack_channel_privacy}
*/
export class WorkflowTaskChangeSlackChannelPrivacy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskChangeSlackChannelPrivacy that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_change_slack_channel_privacy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_change_slack_channel_privacy rootly_workflow_task_change_slack_channel_privacy} Resource
  *
  * @param scope The scope in which to define this construct
