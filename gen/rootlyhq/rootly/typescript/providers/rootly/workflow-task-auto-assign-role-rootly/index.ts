// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly
...
export interface WorkflowTaskAutoAssignRoleRootlyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#enabled WorkflowTaskAutoAssignRoleRootly#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#id WorkflowTaskAutoAssignRoleRootly#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#name WorkflowTaskAutoAssignRoleRootly#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#position WorkflowTaskAutoAssignRoleRootly#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#skip_on_failure WorkflowTaskAutoAssignRoleRootly#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#workflow_id WorkflowTaskAutoAssignRoleRootly#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#task_params WorkflowTaskAutoAssignRoleRootly#task_params}
  */
...
export interface WorkflowTaskAutoAssignRoleRootlyTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#escalation_policy_target WorkflowTaskAutoAssignRoleRootly#escalation_policy_target}
  */
  readonly escalationPolicyTarget?: { [key: string]: string };
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#group_target WorkflowTaskAutoAssignRoleRootly#group_target}
  */
  readonly groupTarget?: { [key: string]: string };
  /**
  * The role id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#incident_role_id WorkflowTaskAutoAssignRoleRootly#incident_role_id}
  */
  readonly incidentRoleId: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#schedule_target WorkflowTaskAutoAssignRoleRootly#schedule_target}
  */
  readonly scheduleTarget?: { [key: string]: string };
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#service_target WorkflowTaskAutoAssignRoleRootly#service_target}
  */
  readonly serviceTarget?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#task_type WorkflowTaskAutoAssignRoleRootly#task_type}
  */
  readonly taskType?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#user_target WorkflowTaskAutoAssignRoleRootly#user_target}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly rootly_workflow_task_auto_assign_role_rootly}
*/
export class WorkflowTaskAutoAssignRoleRootly extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskAutoAssignRoleRootly that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_rootly rootly_workflow_task_auto_assign_role_rootly} Resource
  *
  * @param scope The scope in which to define this construct
