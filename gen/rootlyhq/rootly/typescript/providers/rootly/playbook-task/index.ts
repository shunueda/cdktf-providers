// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/playbook_task
...
export interface PlaybookTaskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/playbook_task#description PlaybookTask#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/playbook_task#id PlaybookTask#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/playbook_task#playbook_id PlaybookTask#playbook_id}
  */
  readonly playbookId?: string;
  /**
  * The position of the task
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/playbook_task#position PlaybookTask#position}
  */
  readonly position?: number;
  /**
  * The task of the task
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/playbook_task#task PlaybookTask#task}
  */
  readonly task: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/playbook_task rootly_playbook_task}
*/
export class PlaybookTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PlaybookTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/playbook_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/playbook_task rootly_playbook_task} Resource
  *
  * @param scope The scope in which to define this construct
