// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page
...
export interface WorkflowTaskCreateCodaPageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#enabled WorkflowTaskCreateCodaPage#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#id WorkflowTaskCreateCodaPage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#name WorkflowTaskCreateCodaPage#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#position WorkflowTaskCreateCodaPage#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#skip_on_failure WorkflowTaskCreateCodaPage#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#workflow_id WorkflowTaskCreateCodaPage#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#task_params WorkflowTaskCreateCodaPage#task_params}
  */
...
export interface WorkflowTaskCreateCodaPageTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#content WorkflowTaskCreateCodaPage#content}
  */
  readonly content?: string;
  /**
  * Map must contain two fields, `id` and `name`. The Coda doc object with id and name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#doc WorkflowTaskCreateCodaPage#doc}
  */
  readonly doc?: { [key: string]: string };
  /**
  * The Coda folder id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#folder_id WorkflowTaskCreateCodaPage#folder_id}
  */
  readonly folderId?: string;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#mark_post_mortem_as_published WorkflowTaskCreateCodaPage#mark_post_mortem_as_published}
  */
  readonly markPostMortemAsPublished?: boolean | cdktf.IResolvable;
  /**
  * Retrospective template to use when creating page, if desired
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#post_mortem_template_id WorkflowTaskCreateCodaPage#post_mortem_template_id}
  */
  readonly postMortemTemplateId?: string;
  /**
  * The Coda page subtitle
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#subtitle WorkflowTaskCreateCodaPage#subtitle}
  */
  readonly subtitle?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#task_type WorkflowTaskCreateCodaPage#task_type}
  */
  readonly taskType?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#template WorkflowTaskCreateCodaPage#template}
  */
  readonly template?: { [key: string]: string };
  /**
  * The Coda page title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#title WorkflowTaskCreateCodaPage#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page rootly_workflow_task_create_coda_page}
*/
export class WorkflowTaskCreateCodaPage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateCodaPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_coda_page rootly_workflow_task_create_coda_page} Resource
  *
  * @param scope The scope in which to define this construct
