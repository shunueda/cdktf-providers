// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion
...
export interface WorkflowTaskCreateOpenaiChatCompletionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion#enabled WorkflowTaskCreateOpenaiChatCompletion#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion#id WorkflowTaskCreateOpenaiChatCompletion#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion#name WorkflowTaskCreateOpenaiChatCompletion#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion#position WorkflowTaskCreateOpenaiChatCompletion#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion#skip_on_failure WorkflowTaskCreateOpenaiChatCompletion#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion#workflow_id WorkflowTaskCreateOpenaiChatCompletion#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion#task_params WorkflowTaskCreateOpenaiChatCompletion#task_params}
  */
...
export interface WorkflowTaskCreateOpenaiChatCompletionTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion#model WorkflowTaskCreateOpenaiChatCompletion#model}
  */
  readonly model: { [key: string]: string };
  /**
  * The prompt to send to OpenAI
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion#prompt WorkflowTaskCreateOpenaiChatCompletion#prompt}
  */
  readonly prompt: string;
  /**
  * The system prompt to send to OpenAI (optional)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion#system_prompt WorkflowTaskCreateOpenaiChatCompletion#system_prompt}
  */
  readonly systemPrompt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion#task_type WorkflowTaskCreateOpenaiChatCompletion#task_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion rootly_workflow_task_create_openai_chat_completion}
*/
export class WorkflowTaskCreateOpenaiChatCompletion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateOpenaiChatCompletion that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_create_openai_chat_completion rootly_workflow_task_create_openai_chat_completion} Resource
  *
  * @param scope The scope in which to define this construct
