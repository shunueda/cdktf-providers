// https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item
...
export interface WorkflowTaskAddActionItemConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#enabled WorkflowTaskAddActionItem#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#id WorkflowTaskAddActionItem#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#name WorkflowTaskAddActionItem#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#position WorkflowTaskAddActionItem#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#skip_on_failure WorkflowTaskAddActionItem#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#workflow_id WorkflowTaskAddActionItem#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#task_params WorkflowTaskAddActionItem#task_params}
  */
...
export interface WorkflowTaskAddActionItemTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#assigned_to_user WorkflowTaskAddActionItem#assigned_to_user}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#assigned_to_user_id WorkflowTaskAddActionItem#assigned_to_user_id}
  */
  readonly assignedToUserId?: string;
  /**
  * Attribute of the Incident to match against. Value must be one of `jira_issue_id`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#attribute_to_query_by WorkflowTaskAddActionItem#attribute_to_query_by}
  */
  readonly attributeToQueryBy?: string;
  /**
  * Custom field mappings. Can contain liquid markup and need to be valid JSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#custom_fields_mapping WorkflowTaskAddActionItem#custom_fields_mapping}
  */
  readonly customFieldsMapping?: string;
  /**
  * The action item description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#description WorkflowTaskAddActionItem#description}
  */
  readonly description?: string;
  /**
  * The role id this action item is associated with
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#incident_role_id WorkflowTaskAddActionItem#incident_role_id}
  */
  readonly incidentRoleId?: string;
  /**
  * The action item kind
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#kind WorkflowTaskAddActionItem#kind}
  */
  readonly kind?: string;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#post_to_incident_timeline WorkflowTaskAddActionItem#post_to_incident_timeline}
  */
  readonly postToIncidentTimeline?: boolean | cdktf.IResolvable;
  /**
  * The action item priority. Value must be one of `high`, `medium`, `low`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#priority WorkflowTaskAddActionItem#priority}
  */
  readonly priority: string;
  /**
  * Value that attribute_to_query_by to uses to match against
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#query_value WorkflowTaskAddActionItem#query_value}
  */
  readonly queryValue?: string;
  /**
  * The action item status. Value must be one of `open`, `in_progress`, `cancelled`, `done`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#status WorkflowTaskAddActionItem#status}
  */
  readonly status: string;
  /**
  * The action item summary
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#summary WorkflowTaskAddActionItem#summary}
  */
  readonly summary: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#task_type WorkflowTaskAddActionItem#task_type}
  */
  readonly taskType?: string;
  /**
  * post_to_slack_channels block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#post_to_slack_channels WorkflowTaskAddActionItem#post_to_slack_channels}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item rootly_workflow_task_add_action_item}
*/
export class WorkflowTaskAddActionItem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskAddActionItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_add_action_item rootly_workflow_task_add_action_item} Resource
  *
  * @param scope The scope in which to define this construct
