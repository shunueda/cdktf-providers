// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/secret
...
export interface SecretConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/secret#hashicorp_vault_mount Secret#hashicorp_vault_mount}
  */
  readonly hashicorpVaultMount?: string;
  /**
  * The HashiCorp Vault secret path
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/secret#hashicorp_vault_path Secret#hashicorp_vault_path}
  */
  readonly hashicorpVaultPath?: string;
  /**
  * The HashiCorp Vault secret version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/secret#hashicorp_vault_version Secret#hashicorp_vault_version}
  */
  readonly hashicorpVaultVersion?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/secret#id Secret#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/secret#name Secret#name}
  */
  readonly name: string;
  /**
  * The redacted secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/secret#secret Secret#secret}
  */
  readonly secret?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/secret rootly_secret}
*/
export class Secret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Secret that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/secret rootly_secret} Resource
  *
  * @param scope The scope in which to define this construct
