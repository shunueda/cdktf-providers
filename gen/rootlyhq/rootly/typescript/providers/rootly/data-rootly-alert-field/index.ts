// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/data-sources/alert_field
...
export interface DataRootlyAlertFieldConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/data-sources/alert_field#created_at DataRootlyAlertField#created_at}
  */
  readonly createdAt?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/data-sources/alert_field#kind DataRootlyAlertField#kind}
  */
  readonly kind?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/data-sources/alert_field#name DataRootlyAlertField#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/data-sources/alert_field rootly_alert_field}
*/
export class DataRootlyAlertField extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyAlertField that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/data-sources/alert_field#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/data-sources/alert_field rootly_alert_field} Data Source
  *
  * @param scope The scope in which to define this construct
