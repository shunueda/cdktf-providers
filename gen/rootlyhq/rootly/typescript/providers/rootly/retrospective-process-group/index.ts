// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/retrospective_process_group
...
export interface RetrospectiveProcessGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/retrospective_process_group#id RetrospectiveProcessGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/retrospective_process_group#position RetrospectiveProcessGroup#position}
  */
  readonly position?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/retrospective_process_group#retrospective_process_id RetrospectiveProcessGroup#retrospective_process_id}
  */
  readonly retrospectiveProcessId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/retrospective_process_group#sub_status_id RetrospectiveProcessGroup#sub_status_id}
  */
  readonly subStatusId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/retrospective_process_group rootly_retrospective_process_group}
*/
export class RetrospectiveProcessGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RetrospectiveProcessGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/retrospective_process_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/retrospective_process_group rootly_retrospective_process_group} Resource
  *
  * @param scope The scope in which to define this construct
