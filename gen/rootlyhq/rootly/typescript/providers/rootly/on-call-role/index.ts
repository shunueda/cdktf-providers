// https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role
...
export interface OnCallRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#alert_sources_permissions OnCallRole#alert_sources_permissions}
  */
  readonly alertSourcesPermissions?: string[];
  /**
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#alert_urgency_permissions OnCallRole#alert_urgency_permissions}
  */
  readonly alertUrgencyPermissions?: string[];
  /**
  * Value must be one of `create`, `update`, `read`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#alerts_permissions OnCallRole#alerts_permissions}
  */
  readonly alertsPermissions?: string[];
  /**
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#api_keys_permissions OnCallRole#api_keys_permissions}
  */
  readonly apiKeysPermissions?: string[];
  /**
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#audits_permissions OnCallRole#audits_permissions}
  */
  readonly auditsPermissions?: string[];
  /**
  * Value must be one of `read`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#contacts_permissions OnCallRole#contacts_permissions}
  */
  readonly contactsPermissions?: string[];
  /**
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#escalation_policies_permissions OnCallRole#escalation_policies_permissions}
  */
  readonly escalationPoliciesPermissions?: string[];
  /**
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#groups_permissions OnCallRole#groups_permissions}
  */
  readonly groupsPermissions?: string[];
  /**
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#heartbeats_permissions OnCallRole#heartbeats_permissions}
  */
  readonly heartbeatsPermissions?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#id OnCallRole#id}
  *
  ...
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#integrations_permissions OnCallRole#integrations_permissions}
  */
  readonly integrationsPermissions?: string[];
  /**
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#invitations_permissions OnCallRole#invitations_permissions}
  */
  readonly invitationsPermissions?: string[];
  /**
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#live_call_routing_permissions OnCallRole#live_call_routing_permissions}
  */
  readonly liveCallRoutingPermissions?: string[];
  /**
  * The role name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#name OnCallRole#name}
  */
  readonly name: string;
  /**
  * Value must be one of `create`, `update`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#schedule_override_permissions OnCallRole#schedule_override_permissions}
  */
  readonly scheduleOverridePermissions?: string[];
  /**
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#schedules_permissions OnCallRole#schedules_permissions}
  */
  readonly schedulesPermissions?: string[];
  /**
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#services_permissions OnCallRole#services_permissions}
  */
  readonly servicesPermissions?: string[];
  /**
  * The role slug.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#slug OnCallRole#slug}
  */
  readonly slug?: string;
  /**
  * The kind of role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#system_role OnCallRole#system_role}
  */
  readonly systemRole?: string;
  /**
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#webhooks_permissions OnCallRole#webhooks_permissions}
  */
  readonly webhooksPermissions?: string[];
  /**
  * Value must be one of `create`, `read`, `update`, `delete`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#workflows_permissions OnCallRole#workflows_permissions}
  */
  readonly workflowsPermissions?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role rootly_on_call_role}
*/
export class OnCallRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OnCallRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/on_call_role rootly_on_call_role} Resource
  *
  * @param scope The scope in which to define this construct
