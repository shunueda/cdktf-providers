// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue
...
export interface WorkflowTaskUpdateJiraIssueConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#enabled WorkflowTaskUpdateJiraIssue#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#id WorkflowTaskUpdateJiraIssue#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#name WorkflowTaskUpdateJiraIssue#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#position WorkflowTaskUpdateJiraIssue#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#skip_on_failure WorkflowTaskUpdateJiraIssue#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#workflow_id WorkflowTaskUpdateJiraIssue#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#task_params WorkflowTaskUpdateJiraIssue#task_params}
  */
...
export interface WorkflowTaskUpdateJiraIssueTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#assign_user_email WorkflowTaskUpdateJiraIssue#assign_user_email}
  */
  readonly assignUserEmail?: string;
  /**
  * Custom field mappings. Can contain liquid markup and need to be valid JSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#custom_fields_mapping WorkflowTaskUpdateJiraIssue#custom_fields_mapping}
  */
  readonly customFieldsMapping?: string;
  /**
  * The issue description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#description WorkflowTaskUpdateJiraIssue#description}
  */
  readonly description?: string;
  /**
  * The due date
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#due_date WorkflowTaskUpdateJiraIssue#due_date}
  */
  readonly dueDate?: string;
  /**
  * The issue id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#issue_id WorkflowTaskUpdateJiraIssue#issue_id}
  */
  readonly issueId: string;
  /**
  * The issue labels
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#labels WorkflowTaskUpdateJiraIssue#labels}
  */
  readonly labels?: string;
  /**
  * Map must contain two fields, `id` and `name`. The priority id and display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#priority WorkflowTaskUpdateJiraIssue#priority}
  */
  readonly priority?: { [key: string]: string };
  /**
  * The project key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#project_key WorkflowTaskUpdateJiraIssue#project_key}
  */
  readonly projectKey: string;
  /**
  * The reporter user's email
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#reporter_user_email WorkflowTaskUpdateJiraIssue#reporter_user_email}
  */
  readonly reporterUserEmail?: string;
  /**
  * Map must contain two fields, `id` and `name`. The status id and display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#status WorkflowTaskUpdateJiraIssue#status}
  */
  readonly status?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#task_type WorkflowTaskUpdateJiraIssue#task_type}
  */
  readonly taskType?: string;
  /**
  * The issue title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#title WorkflowTaskUpdateJiraIssue#title}
  */
  readonly title?: string;
  /**
  * Update payload. Can contain liquid markup and need to be valid JSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#update_payload WorkflowTaskUpdateJiraIssue#update_payload}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue rootly_workflow_task_update_jira_issue}
*/
export class WorkflowTaskUpdateJiraIssue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskUpdateJiraIssue that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_update_jira_issue rootly_workflow_task_update_jira_issue} Resource
  *
  * @param scope The scope in which to define this construct
