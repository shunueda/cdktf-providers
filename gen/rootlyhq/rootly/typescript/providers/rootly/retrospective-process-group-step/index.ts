// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/retrospective_process_group_step
...
export interface RetrospectiveProcessGroupStepConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/retrospective_process_group_step#id RetrospectiveProcessGroupStep#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/retrospective_process_group_step#position RetrospectiveProcessGroupStep#position}
  */
  readonly position?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/retrospective_process_group_step#retrospective_process_group_id RetrospectiveProcessGroupStep#retrospective_process_group_id}
  */
  readonly retrospectiveProcessGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/retrospective_process_group_step#retrospective_step_id RetrospectiveProcessGroupStep#retrospective_step_id}
  */
  readonly retrospectiveStepId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/retrospective_process_group_step rootly_retrospective_process_group_step}
*/
export class RetrospectiveProcessGroupStep extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RetrospectiveProcessGroupStep that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/retrospective_process_group_step#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/retrospective_process_group_step rootly_retrospective_process_group_step} Resource
  *
  * @param scope The scope in which to define this construct
