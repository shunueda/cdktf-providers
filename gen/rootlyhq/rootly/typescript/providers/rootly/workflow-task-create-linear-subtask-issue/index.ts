// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue
...
export interface WorkflowTaskCreateLinearSubtaskIssueConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#enabled WorkflowTaskCreateLinearSubtaskIssue#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#id WorkflowTaskCreateLinearSubtaskIssue#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#name WorkflowTaskCreateLinearSubtaskIssue#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#position WorkflowTaskCreateLinearSubtaskIssue#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#skip_on_failure WorkflowTaskCreateLinearSubtaskIssue#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#workflow_id WorkflowTaskCreateLinearSubtaskIssue#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#task_params WorkflowTaskCreateLinearSubtaskIssue#task_params}
  */
...
export interface WorkflowTaskCreateLinearSubtaskIssueTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#assign_user_email WorkflowTaskCreateLinearSubtaskIssue#assign_user_email}
  */
  readonly assignUserEmail?: string;
  /**
  * The issue description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#description WorkflowTaskCreateLinearSubtaskIssue#description}
  */
  readonly description?: string;
  /**
  * The parent issue
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#parent_issue_id WorkflowTaskCreateLinearSubtaskIssue#parent_issue_id}
  */
  readonly parentIssueId: string;
  /**
  * Map must contain two fields, `id` and `name`. The priority id and display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#priority WorkflowTaskCreateLinearSubtaskIssue#priority}
  */
  readonly priority?: { [key: string]: string };
  /**
  * Map must contain two fields, `id` and `name`. The state id and display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#state WorkflowTaskCreateLinearSubtaskIssue#state}
  */
  readonly state: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#task_type WorkflowTaskCreateLinearSubtaskIssue#task_type}
  */
  readonly taskType?: string;
  /**
  * The issue title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#title WorkflowTaskCreateLinearSubtaskIssue#title}
  */
  readonly title: string;
  /**
  * labels block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#labels WorkflowTaskCreateLinearSubtaskIssue#labels}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue rootly_workflow_task_create_linear_subtask_issue}
*/
export class WorkflowTaskCreateLinearSubtaskIssue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateLinearSubtaskIssue that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/resources/workflow_task_create_linear_subtask_issue rootly_workflow_task_create_linear_subtask_issue} Resource
  *
  * @param scope The scope in which to define this construct
