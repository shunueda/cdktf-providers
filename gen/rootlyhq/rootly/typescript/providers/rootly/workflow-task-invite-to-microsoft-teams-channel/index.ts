// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel
...
export interface WorkflowTaskInviteToMicrosoftTeamsChannelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel#enabled WorkflowTaskInviteToMicrosoftTeamsChannel#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel#id WorkflowTaskInviteToMicrosoftTeamsChannel#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel#name WorkflowTaskInviteToMicrosoftTeamsChannel#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel#position WorkflowTaskInviteToMicrosoftTeamsChannel#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel#skip_on_failure WorkflowTaskInviteToMicrosoftTeamsChannel#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel#workflow_id WorkflowTaskInviteToMicrosoftTeamsChannel#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel#task_params WorkflowTaskInviteToMicrosoftTeamsChannel#task_params}
  */
...
export interface WorkflowTaskInviteToMicrosoftTeamsChannelTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel#channel WorkflowTaskInviteToMicrosoftTeamsChannel#channel}
  */
  readonly channel: { [key: string]: string };
  /**
  * Comma separated list of emails to invite
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel#emails WorkflowTaskInviteToMicrosoftTeamsChannel#emails}
  */
  readonly emails: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel#task_type WorkflowTaskInviteToMicrosoftTeamsChannel#task_type}
  */
  readonly taskType?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel#team WorkflowTaskInviteToMicrosoftTeamsChannel#team}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel rootly_workflow_task_invite_to_microsoft_teams_channel}
*/
export class WorkflowTaskInviteToMicrosoftTeamsChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskInviteToMicrosoftTeamsChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.10/docs/resources/workflow_task_invite_to_microsoft_teams_channel rootly_workflow_task_invite_to_microsoft_teams_channel} Resource
  *
  * @param scope The scope in which to define this construct
