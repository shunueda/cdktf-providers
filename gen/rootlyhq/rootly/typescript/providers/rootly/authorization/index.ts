// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/authorization
...
export interface AuthorizationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/authorization#authorizable_id Authorization#authorizable_id}
  */
  readonly authorizableId: string;
  /**
  * The type of resource being accessed.. Value must be one of `Dashboard`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/authorization#authorizable_type Authorization#authorizable_type}
  */
  readonly authorizableType?: string;
  /**
  * The resource id granted access.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/authorization#grantee_id Authorization#grantee_id}
  */
  readonly granteeId: string;
  /**
  * The type of resource granted access.. Value must be one of `User`, `Team`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/authorization#grantee_type Authorization#grantee_type}
  */
  readonly granteeType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/authorization#id Authorization#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/authorization#permissions Authorization#permissions}
  */
  readonly permissions: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/authorization rootly_authorization}
*/
export class Authorization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Authorization that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/authorization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/authorization rootly_authorization} Resource
  *
  * @param scope The scope in which to define this construct
