// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook
...
export interface WorkflowTaskCreateDatadogNotebookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#enabled WorkflowTaskCreateDatadogNotebook#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#id WorkflowTaskCreateDatadogNotebook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#name WorkflowTaskCreateDatadogNotebook#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#position WorkflowTaskCreateDatadogNotebook#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#skip_on_failure WorkflowTaskCreateDatadogNotebook#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#workflow_id WorkflowTaskCreateDatadogNotebook#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#task_params WorkflowTaskCreateDatadogNotebook#task_params}
  */
...
export interface WorkflowTaskCreateDatadogNotebookTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#content WorkflowTaskCreateDatadogNotebook#content}
  */
  readonly content?: string;
  /**
  * The notebook kind. Value must be one of `postmortem`, `runbook`, `investigation`, `documentation`, `report`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#kind WorkflowTaskCreateDatadogNotebook#kind}
  */
  readonly kind: string;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#mark_post_mortem_as_published WorkflowTaskCreateDatadogNotebook#mark_post_mortem_as_published}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#post_mortem_template_id WorkflowTaskCreateDatadogNotebook#post_mortem_template_id}
  */
  readonly postMortemTemplateId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#task_type WorkflowTaskCreateDatadogNotebook#task_type}
  */
  readonly taskType?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#template WorkflowTaskCreateDatadogNotebook#template}
  */
  readonly template?: { [key: string]: string };
  /**
  * The notebook title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#title WorkflowTaskCreateDatadogNotebook#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook rootly_workflow_task_create_datadog_notebook}
*/
export class WorkflowTaskCreateDatadogNotebook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateDatadogNotebook that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_create_datadog_notebook rootly_workflow_task_create_datadog_notebook} Resource
  *
  * @param scope The scope in which to define this construct
