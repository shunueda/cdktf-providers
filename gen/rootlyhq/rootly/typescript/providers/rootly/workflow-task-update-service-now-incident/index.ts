// https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident
...
export interface WorkflowTaskUpdateServiceNowIncidentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#enabled WorkflowTaskUpdateServiceNowIncident#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#id WorkflowTaskUpdateServiceNowIncident#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#name WorkflowTaskUpdateServiceNowIncident#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#position WorkflowTaskUpdateServiceNowIncident#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#skip_on_failure WorkflowTaskUpdateServiceNowIncident#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#workflow_id WorkflowTaskUpdateServiceNowIncident#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#task_params WorkflowTaskUpdateServiceNowIncident#task_params}
  */
...
export interface WorkflowTaskUpdateServiceNowIncidentTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#completion WorkflowTaskUpdateServiceNowIncident#completion}
  */
  readonly completion?: { [key: string]: string };
  /**
  * Custom field mappings. Can contain liquid markup and need to be valid JSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#custom_fields_mapping WorkflowTaskUpdateServiceNowIncident#custom_fields_mapping}
  */
  readonly customFieldsMapping?: string;
  /**
  * The incident description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#description WorkflowTaskUpdateServiceNowIncident#description}
  */
  readonly description?: string;
  /**
  * The incident id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#incident_id WorkflowTaskUpdateServiceNowIncident#incident_id}
  */
  readonly incidentId: string;
  /**
  * Map must contain two fields, `id` and `name`. The priority id and display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#priority WorkflowTaskUpdateServiceNowIncident#priority}
  */
  readonly priority?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#task_type WorkflowTaskUpdateServiceNowIncident#task_type}
  */
  readonly taskType?: string;
  /**
  * The incident title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#title WorkflowTaskUpdateServiceNowIncident#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident rootly_workflow_task_update_service_now_incident}
*/
export class WorkflowTaskUpdateServiceNowIncident extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskUpdateServiceNowIncident that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.0/docs/resources/workflow_task_update_service_now_incident rootly_workflow_task_update_service_now_incident} Resource
  *
  * @param scope The scope in which to define this construct
