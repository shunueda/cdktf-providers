// https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow
...
export interface WorkflowTaskTriggerWorkflowConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow#enabled WorkflowTaskTriggerWorkflow#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow#id WorkflowTaskTriggerWorkflow#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow#name WorkflowTaskTriggerWorkflow#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow#position WorkflowTaskTriggerWorkflow#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow#skip_on_failure WorkflowTaskTriggerWorkflow#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow#workflow_id WorkflowTaskTriggerWorkflow#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow#task_params WorkflowTaskTriggerWorkflow#task_params}
  */
...
export interface WorkflowTaskTriggerWorkflowTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow#attribute_to_query_by WorkflowTaskTriggerWorkflow#attribute_to_query_by}
  */
  readonly attributeToQueryBy: string;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow#check_workflow_conditions WorkflowTaskTriggerWorkflow#check_workflow_conditions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow#kind WorkflowTaskTriggerWorkflow#kind}
  */
  readonly kind: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow#resource WorkflowTaskTriggerWorkflow#resource}
  */
  readonly resource: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow#task_type WorkflowTaskTriggerWorkflow#task_type}
  */
  readonly taskType?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow#workflow WorkflowTaskTriggerWorkflow#workflow}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow rootly_workflow_task_trigger_workflow}
*/
export class WorkflowTaskTriggerWorkflow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskTriggerWorkflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_trigger_workflow rootly_workflow_task_trigger_workflow} Resource
  *
  * @param scope The scope in which to define this construct
