// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/form_set_condition
...
export interface DataRootlyFormSetConditionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/form_set_condition#form_field_id DataRootlyFormSetCondition#form_field_id}
  */
  readonly formFieldId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/form_set_condition rootly_form_set_condition}
*/
export class DataRootlyFormSetCondition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyFormSetCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/form_set_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/form_set_condition rootly_form_set_condition} Data Source
  *
  * @param scope The scope in which to define this construct
