// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item
...
export interface WorkflowActionItemConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#cause_ids WorkflowActionItem#cause_ids}
  */
  readonly causeIds?: string[];
  /**
  * Workflow command
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#command WorkflowActionItem#command}
  */
  readonly command?: string;
  /**
  * This will notify you back when the workflow is starting. Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#command_feedback_enabled WorkflowActionItem#command_feedback_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#continuously_repeat WorkflowActionItem#continuously_repeat}
  */
  readonly continuouslyRepeat?: boolean | cdktf.IResolvable;
  /**
  * The description of the workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#description WorkflowActionItem#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#enabled WorkflowActionItem#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#environment_ids WorkflowActionItem#environment_ids}
  */
  readonly environmentIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#functionality_ids WorkflowActionItem#functionality_ids}
  */
  readonly functionalityIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#group_ids WorkflowActionItem#group_ids}
  */
  readonly groupIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#id WorkflowActionItem#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_role_ids WorkflowActionItem#incident_role_ids}
  */
  readonly incidentRoleIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_type_ids WorkflowActionItem#incident_type_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#locked WorkflowActionItem#locked}
  */
  readonly locked?: boolean | cdktf.IResolvable;
  /**
  * The title of the workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#name WorkflowActionItem#name}
  */
  readonly name: string;
  /**
  * The order which the workflow should run with other workflows.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#position WorkflowActionItem#position}
  */
  readonly position?: number;
  /**
  * The workflow will stop repeating if its runtime since it's first workflow run exceeds the duration set in this field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#repeat_condition_duration_since_first_run WorkflowActionItem#repeat_condition_duration_since_first_run}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#repeat_condition_number_of_repeats WorkflowActionItem#repeat_condition_number_of_repeats}
  */
  readonly repeatConditionNumberOfRepeats?: number;
  /**
  * Repeat workflow every duration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#repeat_every_duration WorkflowActionItem#repeat_every_duration}
  */
  readonly repeatEveryDuration?: string;
  /**
  * Repeat on weekdays. Value must be one of `S`, `M`, `T`, `W`, `R`, `F`, `U`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#repeat_on WorkflowActionItem#repeat_on}
  */
  readonly repeatOn?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#service_ids WorkflowActionItem#service_ids}
  */
  readonly serviceIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#severity_ids WorkflowActionItem#severity_ids}
  */
  readonly severityIds?: string[];
  /**
  * The slug of the workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#slug WorkflowActionItem#slug}
  */
  readonly slug?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#sub_status_ids WorkflowActionItem#sub_status_ids}
  */
  readonly subStatusIds?: string[];
  /**
  * Wait this duration before executing
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#wait WorkflowActionItem#wait}
  */
  readonly wait?: string;
  /**
  * The group this workflow belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#workflow_group_id WorkflowActionItem#workflow_group_id}
  */
  readonly workflowGroupId?: string;
  /**
  * trigger_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#trigger_params WorkflowActionItem#trigger_params}
  */
...
export interface WorkflowActionItemTriggerParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_action_item_condition WorkflowActionItem#incident_action_item_condition}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_action_item_condition_group WorkflowActionItem#incident_action_item_condition_group}
  */
  readonly incidentActionItemConditionGroup?: string;
  /**
  * Value must be one off `IS`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_action_item_condition_kind WorkflowActionItem#incident_action_item_condition_kind}
  */
  readonly incidentActionItemConditionKind?: string;
  /**
  * Value must be one off `IS`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_action_item_condition_priority WorkflowActionItem#incident_action_item_condition_priority}
  */
  readonly incidentActionItemConditionPriority?: string;
  /**
  * Value must be one off `IS`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_action_item_condition_status WorkflowActionItem#incident_action_item_condition_status}
  */
  readonly incidentActionItemConditionStatus?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_action_item_group_ids WorkflowActionItem#incident_action_item_group_ids}
  */
  readonly incidentActionItemGroupIds?: string[];
  /**
  * Value must be one of `task`, `follow_up`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_action_item_kinds WorkflowActionItem#incident_action_item_kinds}
  */
  readonly incidentActionItemKinds?: string[];
  /**
  * Value must be one of `high`, `medium`, `low`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_action_item_priorities WorkflowActionItem#incident_action_item_priorities}
  */
  readonly incidentActionItemPriorities?: string[];
  /**
  * Value must be one of `open`, `in_progress`, `cancelled`, `done`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_action_item_statuses WorkflowActionItem#incident_action_item_statuses}
  */
  readonly incidentActionItemStatuses?: string[];
  /**
  * Value must be one off `ALL`, `ANY`, `NONE`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition WorkflowActionItem#incident_condition}
  */
  readonly incidentCondition?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_acknowledged_at WorkflowActionItem#incident_condition_acknowledged_at}
  */
  readonly incidentConditionAcknowledgedAt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_detected_at WorkflowActionItem#incident_condition_detected_at}
  */
  readonly incidentConditionDetectedAt?: string;
  /**
  * Value must be one off `IS`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_environment WorkflowActionItem#incident_condition_environment}
  */
  readonly incidentConditionEnvironment?: string;
  /**
  * Value must be one off `IS`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_functionality WorkflowActionItem#incident_condition_functionality}
  */
  readonly incidentConditionFunctionality?: string;
  /**
  * Value must be one off `IS`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_group WorkflowActionItem#incident_condition_group}
  */
  readonly incidentConditionGroup?: string;
  /**
  * Value must be one off `IS`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_incident_roles WorkflowActionItem#incident_condition_incident_roles}
  */
  readonly incidentConditionIncidentRoles?: string;
  /**
  * Value must be one off `IS`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_incident_type WorkflowActionItem#incident_condition_incident_type}
  */
  readonly incidentConditionIncidentType?: string;
  /**
  * Value must be one off `IS`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_kind WorkflowActionItem#incident_condition_kind}
  */
  readonly incidentConditionKind?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_mitigated_at WorkflowActionItem#incident_condition_mitigated_at}
  */
  readonly incidentConditionMitigatedAt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_resolved_at WorkflowActionItem#incident_condition_resolved_at}
  */
  readonly incidentConditionResolvedAt?: string;
  /**
  * Value must be one off `IS`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_service WorkflowActionItem#incident_condition_service}
  */
  readonly incidentConditionService?: string;
  /**
  * Value must be one off `IS`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_severity WorkflowActionItem#incident_condition_severity}
  */
  readonly incidentConditionSeverity?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_started_at WorkflowActionItem#incident_condition_started_at}
  */
  readonly incidentConditionStartedAt?: string;
  /**
  * Value must be one off `IS`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_status WorkflowActionItem#incident_condition_status}
  */
  readonly incidentConditionStatus?: string;
  /**
  * Value must be one off `IS`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_sub_status WorkflowActionItem#incident_condition_sub_status}
  */
  readonly incidentConditionSubStatus?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_summary WorkflowActionItem#incident_condition_summary}
  */
  readonly incidentConditionSummary?: string;
  /**
  * Value must be one off `IS`, `ANY`, `CONTAINS`, `CONTAINS_ALL`, `CONTAINS_NONE`, `NONE`, `SET`, `UNSET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_condition_visibility WorkflowActionItem#incident_condition_visibility}
  */
  readonly incidentConditionVisibility?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_conditional_inactivity WorkflowActionItem#incident_conditional_inactivity}
  */
  readonly incidentConditionalInactivity?: string;
  /**
  * ex. 10 min, 1h, 3 days, 2 weeks
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_inactivity_duration WorkflowActionItem#incident_inactivity_duration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_kinds WorkflowActionItem#incident_kinds}
  */
  readonly incidentKinds?: string[];
  /**
  * Value must be one of `in_triage`, `started`, `detected`, `acknowledged`, `mitigated`, `resolved`, `closed`, `cancelled`, `planning`, `scheduled`, `in_progress`, `verifying`, `completed`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_statuses WorkflowActionItem#incident_statuses}
  */
  readonly incidentStatuses?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#incident_visibilities WorkflowActionItem#incident_visibilities}
  */
  readonly incidentVisibilities?: string[];
  /**
  * Value must be one off `action_item`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#trigger_type WorkflowActionItem#trigger_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#triggers WorkflowActionItem#triggers}
  */
  readonly triggers?: string[];
}

export function workflowActionItemTriggerParamsToTerraform(struct?: WorkflowActionItemTriggerParamsOutputReference | WorkflowActionItemTriggerParams): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    incident_action_item_condition: cdktf.stringToTerraform(struct!.incidentActionItemCondition),
    incident_action_item_condition_group: cdktf.stringToTerraform(struct!.incidentActionItemConditionGroup),
    incident_action_item_condition_kind: cdktf.stringToTerraform(struct!.incidentActionItemConditionKind),
    incident_action_item_condition_priority: cdktf.stringToTerraform(struct!.incidentActionItemConditionPriority),
    incident_action_item_condition_status: cdktf.stringToTerraform(struct!.incidentActionItemConditionStatus),
    incident_action_item_group_ids: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.incidentActionItemGroupIds),
    incident_action_item_kinds: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.incidentActionItemKinds),
    incident_action_item_priorities: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.incidentActionItemPriorities),
    incident_action_item_statuses: cdktf.listMapper(cdktf.stringToTerraform, false)(struct!.incidentActionItemStatuses),
...
export function workflowActionItemTriggerParamsToHclTerraform(struct?: WorkflowActionItemTriggerParamsOutputReference | WorkflowActionItemTriggerParams): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    incident_action_item_condition: {
      value: cdktf.stringToHclTerraform(struct!.incidentActionItemCondition),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    incident_action_item_condition_group: {
      value: cdktf.stringToHclTerraform(struct!.incidentActionItemConditionGroup),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    incident_action_item_condition_kind: {
      value: cdktf.stringToHclTerraform(struct!.incidentActionItemConditionKind),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    incident_action_item_condition_priority: {
      value: cdktf.stringToHclTerraform(struct!.incidentActionItemConditionPriority),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    incident_action_item_condition_status: {
      value: cdktf.stringToHclTerraform(struct!.incidentActionItemConditionStatus),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    incident_action_item_group_ids: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.incidentActionItemGroupIds),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
    incident_action_item_kinds: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.incidentActionItemKinds),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
    incident_action_item_priorities: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.incidentActionItemPriorities),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
    incident_action_item_statuses: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.incidentActionItemStatuses),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
...
export class WorkflowActionItemTriggerParamsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): WorkflowActionItemTriggerParams | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._incidentActionItemCondition !== undefined) {
      hasAnyValues = true;
      internalValueResult.incidentActionItemCondition = this._incidentActionItemCondition;
    }
    if (this._incidentActionItemConditionGroup !== undefined) {
      hasAnyValues = true;
      internalValueResult.incidentActionItemConditionGroup = this._incidentActionItemConditionGroup;
    }
    if (this._incidentActionItemConditionKind !== undefined) {
      hasAnyValues = true;
      internalValueResult.incidentActionItemConditionKind = this._incidentActionItemConditionKind;
    }
    if (this._incidentActionItemConditionPriority !== undefined) {
      hasAnyValues = true;
      internalValueResult.incidentActionItemConditionPriority = this._incidentActionItemConditionPriority;
    }
    if (this._incidentActionItemConditionStatus !== undefined) {
      hasAnyValues = true;
      internalValueResult.incidentActionItemConditionStatus = this._incidentActionItemConditionStatus;
    }
    if (this._incidentActionItemGroupIds !== undefined) {
      hasAnyValues = true;
      internalValueResult.incidentActionItemGroupIds = this._incidentActionItemGroupIds;
    }
    if (this._incidentActionItemKinds !== undefined) {
      hasAnyValues = true;
      internalValueResult.incidentActionItemKinds = this._incidentActionItemKinds;
    }
    if (this._incidentActionItemPriorities !== undefined) {
      hasAnyValues = true;
      internalValueResult.incidentActionItemPriorities = this._incidentActionItemPriorities;
    }
    if (this._incidentActionItemStatuses !== undefined) {
      hasAnyValues = true;
      internalValueResult.incidentActionItemStatuses = this._incidentActionItemStatuses;
    }
  ...
  public set internalValue(value: WorkflowActionItemTriggerParams | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._incidentActionItemCondition = undefined;
      this._incidentActionItemConditionGroup = undefined;
      this._incidentActionItemConditionKind = undefined;
      this._incidentActionItemConditionPriority = undefined;
      this._incidentActionItemConditionStatus = undefined;
      this._incidentActionItemGroupIds = undefined;
      this._incidentActionItemKinds = undefined;
      this._incidentActionItemPriorities = undefined;
      this._incidentActionItemStatuses = undefined;
      ...
      this._incidentActionItemCondition = value.incidentActionItemCondition;
      this._incidentActionItemConditionGroup = value.incidentActionItemConditionGroup;
      this._incidentActionItemConditionKind = value.incidentActionItemConditionKind;
      this._incidentActionItemConditionPriority = value.incidentActionItemConditionPriority;
      this._incidentActionItemConditionStatus = value.incidentActionItemConditionStatus;
      this._incidentActionItemGroupIds = value.incidentActionItemGroupIds;
      this._incidentActionItemKinds = value.incidentActionItemKinds;
      this._incidentActionItemPriorities = value.incidentActionItemPriorities;
      this._incidentActionItemStatuses = value.incidentActionItemStatuses;
  ...
  // incident_action_item_condition - computed: false, optional: true, required: false
  private _incidentActionItemCondition?: string; 
  public get incidentActionItemCondition() {
    return this.getStringAttribute('incident_action_item_condition');
  }
  public set incidentActionItemCondition(value: string) {
    this._incidentActionItemCondition = value;
  }
  public resetIncidentActionItemCondition() {
    this._incidentActionItemCondition = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get incidentActionItemConditionInput() {
    return this._incidentActionItemCondition;
  }

  // incident_action_item_condition_group - computed: false, optional: true, required: false
  private _incidentActionItemConditionGroup?: string; 
  public get incidentActionItemConditionGroup() {
    return this.getStringAttribute('incident_action_item_condition_group');
  }
  public set incidentActionItemConditionGroup(value: string) {
    this._incidentActionItemConditionGroup = value;
  }
  public resetIncidentActionItemConditionGroup() {
    this._incidentActionItemConditionGroup = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get incidentActionItemConditionGroupInput() {
    return this._incidentActionItemConditionGroup;
  }

  // incident_action_item_condition_kind - computed: false, optional: true, required: false
  private _incidentActionItemConditionKind?: string; 
  public get incidentActionItemConditionKind() {
    return this.getStringAttribute('incident_action_item_condition_kind');
  }
  public set incidentActionItemConditionKind(value: string) {
    this._incidentActionItemConditionKind = value;
  }
  public resetIncidentActionItemConditionKind() {
    this._incidentActionItemConditionKind = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get incidentActionItemConditionKindInput() {
    return this._incidentActionItemConditionKind;
  }

  // incident_action_item_condition_priority - computed: false, optional: true, required: false
  private _incidentActionItemConditionPriority?: string; 
  public get incidentActionItemConditionPriority() {
    return this.getStringAttribute('incident_action_item_condition_priority');
  }
  public set incidentActionItemConditionPriority(value: string) {
    this._incidentActionItemConditionPriority = value;
  }
  public resetIncidentActionItemConditionPriority() {
    this._incidentActionItemConditionPriority = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get incidentActionItemConditionPriorityInput() {
    return this._incidentActionItemConditionPriority;
  }

  // incident_action_item_condition_status - computed: false, optional: true, required: false
  private _incidentActionItemConditionStatus?: string; 
  public get incidentActionItemConditionStatus() {
    return this.getStringAttribute('incident_action_item_condition_status');
  }
  public set incidentActionItemConditionStatus(value: string) {
    this._incidentActionItemConditionStatus = value;
  }
  public resetIncidentActionItemConditionStatus() {
    this._incidentActionItemConditionStatus = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get incidentActionItemConditionStatusInput() {
    return this._incidentActionItemConditionStatus;
  }

  // incident_action_item_group_ids - computed: true, optional: true, required: false
  private _incidentActionItemGroupIds?: string[]; 
  public get incidentActionItemGroupIds() {
    return this.getListAttribute('incident_action_item_group_ids');
  }
  public set incidentActionItemGroupIds(value: string[]) {
    this._incidentActionItemGroupIds = value;
  }
  public resetIncidentActionItemGroupIds() {
    this._incidentActionItemGroupIds = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get incidentActionItemGroupIdsInput() {
    return this._incidentActionItemGroupIds;
  }

  // incident_action_item_kinds - computed: true, optional: true, required: false
  private _incidentActionItemKinds?: string[]; 
  public get incidentActionItemKinds() {
    return this.getListAttribute('incident_action_item_kinds');
  }
  public set incidentActionItemKinds(value: string[]) {
    this._incidentActionItemKinds = value;
  }
  public resetIncidentActionItemKinds() {
    this._incidentActionItemKinds = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get incidentActionItemKindsInput() {
    return this._incidentActionItemKinds;
  }

  // incident_action_item_priorities - computed: true, optional: true, required: false
  private _incidentActionItemPriorities?: string[]; 
  public get incidentActionItemPriorities() {
    return this.getListAttribute('incident_action_item_priorities');
  }
  public set incidentActionItemPriorities(value: string[]) {
    this._incidentActionItemPriorities = value;
  }
  public resetIncidentActionItemPriorities() {
    this._incidentActionItemPriorities = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get incidentActionItemPrioritiesInput() {
    return this._incidentActionItemPriorities;
  }

  // incident_action_item_statuses - computed: true, optional: true, required: false
  private _incidentActionItemStatuses?: string[]; 
  public get incidentActionItemStatuses() {
    return this.getListAttribute('incident_action_item_statuses');
  }
  public set incidentActionItemStatuses(value: string[]) {
    this._incidentActionItemStatuses = value;
  }
  public resetIncidentActionItemStatuses() {
    this._incidentActionItemStatuses = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get incidentActionItemStatusesInput() {
    return this._incidentActionItemStatuses;
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item rootly_workflow_action_item}
*/
export class WorkflowActionItem extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "rootly_workflow_action_item";
  ...
  * @param importFromId The id of the existing WorkflowActionItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the WorkflowActionItem to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "rootly_workflow_action_item", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_action_item rootly_workflow_action_item} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options WorkflowActionItemConfig
  */
  public constructor(scope: Construct, id: string, config: WorkflowActionItemConfig) {
    super(scope, id, {
  ...
  private _triggerParams = new WorkflowActionItemTriggerParamsOutputReference(this, "trigger_params");
  public get triggerParams() {
    return this._triggerParams;
  }
  public putTriggerParams(value: WorkflowActionItemTriggerParams) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      trigger_params: workflowActionItemTriggerParamsToTerraform(this._triggerParams.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      trigger_params: {
        value: workflowActionItemTriggerParamsToHclTerraform(this._triggerParams.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "WorkflowActionItemTriggerParamsList",
      },
    };
