// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router
...
export interface LiveCallRouterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#alert_urgency_id LiveCallRouter#alert_urgency_id}
  */
  readonly alertUrgencyId?: string;
  /**
  * The caller greeting message of the live_call_router
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#caller_greeting LiveCallRouter#caller_greeting}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#calling_tree_prompt LiveCallRouter#calling_tree_prompt}
  */
  readonly callingTreePrompt?: string;
  /**
  * The country code of the live_call_router. Value must be one of `AU`, `CA`, `DE`, `NL`, `NZ`, `GB`, `US`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#country_code LiveCallRouter#country_code}
  */
  readonly countryCode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#enabled LiveCallRouter#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * This overrides the delay (seconds) in escalation levels
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#escalation_level_delay_in_seconds LiveCallRouter#escalation_level_delay_in_seconds}
  */
  readonly escalationLevelDelayInSeconds?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#escalation_policy_trigger_params LiveCallRouter#escalation_policy_trigger_params}
  */
  readonly escalationPolicyTriggerParams?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#id LiveCallRouter#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#kind LiveCallRouter#kind}
  */
  readonly kind?: string;
  /**
  * The name of the live_call_router
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#name LiveCallRouter#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#phone_number LiveCallRouter#phone_number}
  */
  readonly phoneNumber: string;
  /**
  * The phone type of the live_call_router. Value must be one of `local`, `toll_free`, `mobile`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#phone_type LiveCallRouter#phone_type}
  */
  readonly phoneType?: string;
  /**
  * The delay (seconds) after which the caller in redirected to voicemail
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#sent_to_voicemail_delay LiveCallRouter#sent_to_voicemail_delay}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#should_auto_resolve_alert_on_call_end LiveCallRouter#should_auto_resolve_alert_on_call_end}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#should_redirect_to_voicemail_on_no_answer LiveCallRouter#should_redirect_to_voicemail_on_no_answer}
  */
  readonly shouldRedirectToVoicemailOnNoAnswer?: boolean | cdktf.IResolvable;
  /**
  * The voicemail greeting of the live_call_router
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#voicemail_greeting LiveCallRouter#voicemail_greeting}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#waiting_music_url LiveCallRouter#waiting_music_url}
  */
  readonly waitingMusicUrl?: string;
  /**
  * paging_targets block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#paging_targets LiveCallRouter#paging_targets}
  */
...
export interface LiveCallRouterPagingTargets {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#type LiveCallRouter#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router rootly_live_call_router}
*/
export class LiveCallRouter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LiveCallRouter that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/live_call_router rootly_live_call_router} Resource
  *
  * @param scope The scope in which to define this construct
