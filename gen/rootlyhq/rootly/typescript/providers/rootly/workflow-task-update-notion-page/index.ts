// https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page
...
export interface WorkflowTaskUpdateNotionPageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#enabled WorkflowTaskUpdateNotionPage#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#id WorkflowTaskUpdateNotionPage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#name WorkflowTaskUpdateNotionPage#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#position WorkflowTaskUpdateNotionPage#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#skip_on_failure WorkflowTaskUpdateNotionPage#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#workflow_id WorkflowTaskUpdateNotionPage#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#task_params WorkflowTaskUpdateNotionPage#task_params}
  */
...
export interface WorkflowTaskUpdateNotionPageTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#content WorkflowTaskUpdateNotionPage#content}
  */
  readonly content?: string;
  /**
  * The Notion page ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#file_id WorkflowTaskUpdateNotionPage#file_id}
  */
  readonly fileId: string;
  /**
  * Retrospective template to use when creating page task, if desired
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#post_mortem_template_id WorkflowTaskUpdateNotionPage#post_mortem_template_id}
  */
  readonly postMortemTemplateId?: string;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#show_action_items_as_table WorkflowTaskUpdateNotionPage#show_action_items_as_table}
  */
  readonly showActionItemsAsTable?: boolean | cdktf.IResolvable;
  /**
  * Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#show_timeline_as_table WorkflowTaskUpdateNotionPage#show_timeline_as_table}
  */
  readonly showTimelineAsTable?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#task_type WorkflowTaskUpdateNotionPage#task_type}
  */
  readonly taskType?: string;
  /**
  * The Notion page title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#title WorkflowTaskUpdateNotionPage#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page rootly_workflow_task_update_notion_page}
*/
export class WorkflowTaskUpdateNotionPage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskUpdateNotionPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.1.0/docs/resources/workflow_task_update_notion_page rootly_workflow_task_update_notion_page} Resource
  *
  * @param scope The scope in which to define this construct
