// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story
...
export interface WorkflowTaskCreateShortcutStoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#enabled WorkflowTaskCreateShortcutStory#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#id WorkflowTaskCreateShortcutStory#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#name WorkflowTaskCreateShortcutStory#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#position WorkflowTaskCreateShortcutStory#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#skip_on_failure WorkflowTaskCreateShortcutStory#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#workflow_id WorkflowTaskCreateShortcutStory#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#task_params WorkflowTaskCreateShortcutStory#task_params}
  */
...
export interface WorkflowTaskCreateShortcutStoryTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#archivation WorkflowTaskCreateShortcutStory#archivation}
  */
  readonly archivation: { [key: string]: string };
  /**
  * The incident description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#description WorkflowTaskCreateShortcutStory#description}
  */
  readonly description?: string;
  /**
  * The due date
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#due_date WorkflowTaskCreateShortcutStory#due_date}
  */
  readonly dueDate?: string;
  /**
  * Map must contain two fields, `id` and `name`. The group id and display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#group WorkflowTaskCreateShortcutStory#group}
  */
  readonly group?: { [key: string]: string };
  /**
  * Value must be one of `bug`, `chore`, `feature`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#kind WorkflowTaskCreateShortcutStory#kind}
  */
  readonly kind: string;
  /**
  * The story labels
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#labels WorkflowTaskCreateShortcutStory#labels}
  */
  readonly labels?: string;
  /**
  * Map must contain two fields, `id` and `name`. The project id and display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#project WorkflowTaskCreateShortcutStory#project}
  */
  readonly project?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#task_type WorkflowTaskCreateShortcutStory#task_type}
  */
  readonly taskType?: string;
  /**
  * The incident title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#title WorkflowTaskCreateShortcutStory#title}
  */
  readonly title: string;
  /**
  * Map must contain two fields, `id` and `name`. The workflow state id workflow state name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#workflow_state WorkflowTaskCreateShortcutStory#workflow_state}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story rootly_workflow_task_create_shortcut_story}
*/
export class WorkflowTaskCreateShortcutStory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateShortcutStory that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.13/docs/resources/workflow_task_create_shortcut_story rootly_workflow_task_create_shortcut_story} Resource
  *
  * @param scope The scope in which to define this construct
