// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_opsgenie
...
export interface WorkflowTaskAutoAssignRoleOpsgenieConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_opsgenie#enabled WorkflowTaskAutoAssignRoleOpsgenie#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_opsgenie#id WorkflowTaskAutoAssignRoleOpsgenie#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_opsgenie#name WorkflowTaskAutoAssignRoleOpsgenie#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_opsgenie#position WorkflowTaskAutoAssignRoleOpsgenie#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_opsgenie#skip_on_failure WorkflowTaskAutoAssignRoleOpsgenie#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_opsgenie#workflow_id WorkflowTaskAutoAssignRoleOpsgenie#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_opsgenie#task_params WorkflowTaskAutoAssignRoleOpsgenie#task_params}
  */
...
export interface WorkflowTaskAutoAssignRoleOpsgenieTaskParams {
  ...
  * The role id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_opsgenie#incident_role_id WorkflowTaskAutoAssignRoleOpsgenie#incident_role_id}
  */
  readonly incidentRoleId: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_opsgenie#schedule WorkflowTaskAutoAssignRoleOpsgenie#schedule}
  */
  readonly schedule: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_opsgenie#task_type WorkflowTaskAutoAssignRoleOpsgenie#task_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_opsgenie rootly_workflow_task_auto_assign_role_opsgenie}
*/
export class WorkflowTaskAutoAssignRoleOpsgenie extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskAutoAssignRoleOpsgenie that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_opsgenie#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.7/docs/resources/workflow_task_auto_assign_role_opsgenie rootly_workflow_task_auto_assign_role_opsgenie} Resource
  *
  * @param scope The scope in which to define this construct
