// https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation
...
export interface ScheduleRotationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#active_all_week ScheduleRotation#active_all_week}
  */
  readonly activeAllWeek?: boolean | cdktf.IResolvable;
  /**
  * Value must be one of `S`, `M`, `T`, `W`, `R`, `F`, `U`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#active_days ScheduleRotation#active_days}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#active_time_type ScheduleRotation#active_time_type}
  */
  readonly activeTimeType?: string;
  /**
  * ISO8601 date and time when rotation ends. Shifts will only be created before this time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#end_time ScheduleRotation#end_time}
  */
  readonly endTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#id ScheduleRotation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#name ScheduleRotation#name}
  */
  readonly name: string;
  /**
  * Position of the schedule rotation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#position ScheduleRotation#position}
  */
  readonly position?: number;
  /**
  * The ID of parent schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#schedule_id ScheduleRotation#schedule_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#schedule_rotationable_attributes ScheduleRotation#schedule_rotationable_attributes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#schedule_rotationable_type ScheduleRotation#schedule_rotationable_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#start_time ScheduleRotation#start_time}
  */
  readonly startTime?: string;
  /**
  * A valid IANA time zone name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#time_zone ScheduleRotation#time_zone}
  */
  readonly timeZone?: string;
  /**
  * active_time_attributes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#active_time_attributes ScheduleRotation#active_time_attributes}
  */
  readonly activeTimeAttributes?: ScheduleRotationActiveTimeAttributes[] | cdktf.IResolvable;
  /**
  * schedule_rotation_members block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#schedule_rotation_members ScheduleRotation#schedule_rotation_members}
  */
...
export interface ScheduleRotationScheduleRotationMembers {
  ...
  * ID of the member
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#member_id ScheduleRotation#member_id}
  */
  readonly memberId?: string;
  /**
  * Type of member. Value must be one of `Schedule` or `User`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#member_type ScheduleRotation#member_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation rootly_schedule_rotation}
*/
export class ScheduleRotation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScheduleRotation that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/schedule_rotation rootly_schedule_rotation} Resource
  *
  * @param scope The scope in which to define this construct
