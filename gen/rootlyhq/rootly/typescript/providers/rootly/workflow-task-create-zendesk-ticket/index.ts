// https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket
...
export interface WorkflowTaskCreateZendeskTicketConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#enabled WorkflowTaskCreateZendeskTicket#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#id WorkflowTaskCreateZendeskTicket#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#name WorkflowTaskCreateZendeskTicket#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#position WorkflowTaskCreateZendeskTicket#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#skip_on_failure WorkflowTaskCreateZendeskTicket#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#workflow_id WorkflowTaskCreateZendeskTicket#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#task_params WorkflowTaskCreateZendeskTicket#task_params}
  */
...
export interface WorkflowTaskCreateZendeskTicketTaskParams {
  ...
  * The ticket comment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#comment WorkflowTaskCreateZendeskTicket#comment}
  */
  readonly comment?: string;
  /**
  * Map must contain two fields, `id` and `name`. The completion id and display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#completion WorkflowTaskCreateZendeskTicket#completion}
  */
  readonly completion?: { [key: string]: string };
  /**
  * Custom field mappings. Can contain liquid markup and need to be valid JSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#custom_fields_mapping WorkflowTaskCreateZendeskTicket#custom_fields_mapping}
  */
  readonly customFieldsMapping?: string;
  /**
  * Value must be one of `problem`, `incident`, `question`, `task`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#kind WorkflowTaskCreateZendeskTicket#kind}
  */
  readonly kind: string;
  /**
  * Map must contain two fields, `id` and `name`. The priority id and display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#priority WorkflowTaskCreateZendeskTicket#priority}
  */
  readonly priority?: { [key: string]: string };
  /**
  * The ticket subject
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#subject WorkflowTaskCreateZendeskTicket#subject}
  */
  readonly subject: string;
  /**
  * The ticket tags
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#tags WorkflowTaskCreateZendeskTicket#tags}
  */
  readonly tags?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#task_type WorkflowTaskCreateZendeskTicket#task_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#ticket_payload WorkflowTaskCreateZendeskTicket#ticket_payload}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket rootly_workflow_task_create_zendesk_ticket}
*/
export class WorkflowTaskCreateZendeskTicket extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskCreateZendeskTicket that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.2.1/docs/resources/workflow_task_create_zendesk_ticket rootly_workflow_task_create_zendesk_ticket} Resource
  *
  * @param scope The scope in which to define this construct
