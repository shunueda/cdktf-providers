// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task
...
export interface WorkflowTaskUpdateClickupTaskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#enabled WorkflowTaskUpdateClickupTask#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#id WorkflowTaskUpdateClickupTask#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#name WorkflowTaskUpdateClickupTask#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#position WorkflowTaskUpdateClickupTask#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#skip_on_failure WorkflowTaskUpdateClickupTask#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#workflow_id WorkflowTaskUpdateClickupTask#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#task_params WorkflowTaskUpdateClickupTask#task_params}
  */
...
export interface WorkflowTaskUpdateClickupTaskTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#custom_fields_mapping WorkflowTaskUpdateClickupTask#custom_fields_mapping}
  */
  readonly customFieldsMapping?: string;
  /**
  * The task description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#description WorkflowTaskUpdateClickupTask#description}
  */
  readonly description?: string;
  /**
  * The due date
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#due_date WorkflowTaskUpdateClickupTask#due_date}
  */
  readonly dueDate?: string;
  /**
  * Map must contain two fields, `id` and `name`. The priority id and display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#priority WorkflowTaskUpdateClickupTask#priority}
  */
  readonly priority?: { [key: string]: string };
  /**
  * The task tags
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#tags WorkflowTaskUpdateClickupTask#tags}
  */
  readonly tags?: string;
  /**
  * The task id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#task_id WorkflowTaskUpdateClickupTask#task_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#task_payload WorkflowTaskUpdateClickupTask#task_payload}
  */
  readonly taskPayload?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#task_type WorkflowTaskUpdateClickupTask#task_type}
  */
  readonly taskType?: string;
  /**
  * The task title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#title WorkflowTaskUpdateClickupTask#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task rootly_workflow_task_update_clickup_task}
*/
export class WorkflowTaskUpdateClickupTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskUpdateClickupTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.8/docs/resources/workflow_task_update_clickup_task rootly_workflow_task_update_clickup_task} Resource
  *
  * @param scope The scope in which to define this construct
