// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket
...
export interface WorkflowTaskUpdateZendeskTicketConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#enabled WorkflowTaskUpdateZendeskTicket#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#id WorkflowTaskUpdateZendeskTicket#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#name WorkflowTaskUpdateZendeskTicket#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#position WorkflowTaskUpdateZendeskTicket#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#skip_on_failure WorkflowTaskUpdateZendeskTicket#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#workflow_id WorkflowTaskUpdateZendeskTicket#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#task_params WorkflowTaskUpdateZendeskTicket#task_params}
  */
...
export interface WorkflowTaskUpdateZendeskTicketTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#completion WorkflowTaskUpdateZendeskTicket#completion}
  */
  readonly completion?: { [key: string]: string };
  /**
  * Custom field mappings. Can contain liquid markup and need to be valid JSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#custom_fields_mapping WorkflowTaskUpdateZendeskTicket#custom_fields_mapping}
  */
  readonly customFieldsMapping?: string;
  /**
  * Map must contain two fields, `id` and `name`. The priority id and display name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#priority WorkflowTaskUpdateZendeskTicket#priority}
  */
  readonly priority?: { [key: string]: string };
  /**
  * The ticket subject
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#subject WorkflowTaskUpdateZendeskTicket#subject}
  */
  readonly subject?: string;
  /**
  * The ticket tags
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#tags WorkflowTaskUpdateZendeskTicket#tags}
  */
  readonly tags?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#task_type WorkflowTaskUpdateZendeskTicket#task_type}
  */
  readonly taskType?: string;
  /**
  * The ticket id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#ticket_id WorkflowTaskUpdateZendeskTicket#ticket_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#ticket_payload WorkflowTaskUpdateZendeskTicket#ticket_payload}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket rootly_workflow_task_update_zendesk_ticket}
*/
export class WorkflowTaskUpdateZendeskTicket extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskUpdateZendeskTicket that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/workflow_task_update_zendesk_ticket rootly_workflow_task_update_zendesk_ticket} Resource
  *
  * @param scope The scope in which to define this construct
