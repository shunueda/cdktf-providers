// https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task
...
export interface WorkflowTaskUpdateAsanaTaskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#enabled WorkflowTaskUpdateAsanaTask#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#id WorkflowTaskUpdateAsanaTask#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#name WorkflowTaskUpdateAsanaTask#name}
  */
  readonly name?: string;
  /**
  * The position of the workflow task (1 being top of list)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#position WorkflowTaskUpdateAsanaTask#position}
  */
  readonly position?: number;
  /**
  * Skip workflow task if any failures
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#skip_on_failure WorkflowTaskUpdateAsanaTask#skip_on_failure}
  */
  readonly skipOnFailure?: boolean | cdktf.IResolvable;
  /**
  * The ID of the parent workflow
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#workflow_id WorkflowTaskUpdateAsanaTask#workflow_id}
  */
  readonly workflowId: string;
  /**
  * task_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#task_params WorkflowTaskUpdateAsanaTask#task_params}
  */
...
export interface WorkflowTaskUpdateAsanaTaskTaskParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#assign_user_email WorkflowTaskUpdateAsanaTask#assign_user_email}
  */
  readonly assignUserEmail?: string;
  /**
  * Map must contain two fields, `id` and `name`. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#completion WorkflowTaskUpdateAsanaTask#completion}
  */
  readonly completion: { [key: string]: string };
  /**
  * Custom field mappings. Can contain liquid markup and need to be valid JSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#custom_fields_mapping WorkflowTaskUpdateAsanaTask#custom_fields_mapping}
  */
  readonly customFieldsMapping?: string;
  /**
  * Value must be one of `blocking`, `blocked_by`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#dependency_direction WorkflowTaskUpdateAsanaTask#dependency_direction}
  */
  readonly dependencyDirection?: string;
  /**
  * Dependent task ids. Supports liquid syntax
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#dependent_task_ids WorkflowTaskUpdateAsanaTask#dependent_task_ids}
  */
  readonly dependentTaskIds?: string[];
  /**
  * The due date
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#due_date WorkflowTaskUpdateAsanaTask#due_date}
  */
  readonly dueDate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#notes WorkflowTaskUpdateAsanaTask#notes}
  */
  readonly notes?: string;
  /**
  * The task id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#task_id WorkflowTaskUpdateAsanaTask#task_id}
  */
  readonly taskId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#task_type WorkflowTaskUpdateAsanaTask#task_type}
  */
  readonly taskType?: string;
  /**
  * The task title
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#title WorkflowTaskUpdateAsanaTask#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task rootly_workflow_task_update_asana_task}
*/
export class WorkflowTaskUpdateAsanaTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowTaskUpdateAsanaTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/5.0.0/docs/resources/workflow_task_update_asana_task rootly_workflow_task_update_asana_task} Resource
  *
  * @param scope The scope in which to define this construct
