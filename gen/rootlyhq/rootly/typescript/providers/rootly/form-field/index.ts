// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field
...
export interface FormFieldConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field#default_values FormField#default_values}
  */
  readonly defaultValues?: string[];
  /**
  * The description of the form field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field#description FormField#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field#enabled FormField#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field#id FormField#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field#input_kind FormField#input_kind}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field#kind FormField#kind}
  */
  readonly kind?: string;
  /**
  * The name of the form field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field#name FormField#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field#required FormField#required}
  */
  readonly required?: string[];
  /**
  * Whether the form field is shown on the incident details panel. Value must be one of true or false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field#show_on_incident_details FormField#show_on_incident_details}
  */
  readonly showOnIncidentDetails?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field#shown FormField#shown}
  */
  readonly shown?: string[];
  /**
  * The slug of the form field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field#slug FormField#slug}
  */
  readonly slug?: string;
  /**
  * The value kind of the form field. Value must be one of `inherit`, `group`, `service`, `functionality`, `user`, `catalog_entity`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field#value_kind FormField#value_kind}
  */
  readonly valueKind?: string;
  /**
  * The ID of the catalog used when value_kind is `catalog_entity`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field#value_kind_catalog_id FormField#value_kind_catalog_id}
  */
  readonly valueKindCatalogId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field rootly_form_field}
*/
export class FormField extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FormField that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.9/docs/resources/form_field rootly_form_field} Resource
  *
  * @param scope The scope in which to define this construct
