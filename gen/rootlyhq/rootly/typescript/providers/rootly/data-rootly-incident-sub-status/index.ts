// https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/incident_sub_status
...
export interface DataRootlyIncidentSubStatusConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/incident_sub_status#assigned_at DataRootlyIncidentSubStatus#assigned_at}
  */
  readonly assignedAt?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/incident_sub_status#sub_status_id DataRootlyIncidentSubStatus#sub_status_id}
  */
  readonly subStatusId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/incident_sub_status rootly_incident_sub_status}
*/
export class DataRootlyIncidentSubStatus extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRootlyIncidentSubStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/incident_sub_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rootlyhq/rootly/4.3.11/docs/data-sources/incident_sub_status rootly_incident_sub_status} Data Source
  *
  * @param scope The scope in which to define this construct
