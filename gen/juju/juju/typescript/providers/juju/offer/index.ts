// https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/offer
...
export interface OfferConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/offer#application_name Offer#application_name}
  */
  readonly applicationName: string;
  /**
  * The endpoint names. Changing this value will cause the offer to be destroyed and recreated by terraform.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/offer#endpoints Offer#endpoints}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/offer#model_uuid Offer#model_uuid}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/offer#name Offer#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/offer juju_offer}
*/
export class Offer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Offer that should be imported. Refer to the {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/offer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/offer juju_offer} Resource
  *
  * @param scope The scope in which to define this construct
