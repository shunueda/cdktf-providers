// https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_offer
...
export interface AccessOfferConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_offer#admin AccessOffer#admin}
  */
  readonly admin?: string[];
  /**
  * List of users to grant consume access. "admin" user is not allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_offer#consume AccessOffer#consume}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_offer#offer_url AccessOffer#offer_url}
  */
  readonly offerUrl: string;
  /**
  * List of users to grant read access. "admin" user is not allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_offer#read AccessOffer#read}
  */
  readonly read?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_offer juju_access_offer}
*/
export class AccessOffer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccessOffer that should be imported. Refer to the {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_offer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_offer juju_access_offer} Resource
  *
  * @param scope The scope in which to define this construct
