// https://registry.terraform.io/providers/juju/juju/1.0.0/docs/data-sources/machine
...
export interface DataJujuMachineConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/data-sources/machine#machine_id DataJujuMachine#machine_id}
  */
  readonly machineId: string;
  /**
  * The UUID of the model.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/data-sources/machine#model_uuid DataJujuMachine#model_uuid}
  */
  readonly modelUuid: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/data-sources/machine juju_machine}
*/
export class DataJujuMachine extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataJujuMachine that should be imported. Refer to the {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/data-sources/machine#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/data-sources/machine juju_machine} Data Source
  *
  * @param scope The scope in which to define this construct
