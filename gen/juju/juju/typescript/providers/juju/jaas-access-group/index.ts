// https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/jaas_access_group
...
export interface JaasAccessGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/jaas_access_group#access JaasAccessGroup#access}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/jaas_access_group#group_id JaasAccessGroup#group_id}
  */
  readonly groupId: string;
  /**
  * List of groups to grant access. A valid group ID is the group's UUID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/jaas_access_group#groups JaasAccessGroup#groups}
  */
  readonly groups?: string[];
  /**
  * List of service accounts to grant access. A valid service account is the service account's name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/jaas_access_group#service_accounts JaasAccessGroup#service_accounts}
  */
  readonly serviceAccounts?: string[];
  /**
  * List of users to grant access. A valid user is the user's name or email.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/jaas_access_group#users JaasAccessGroup#users}
  */
  readonly users?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/jaas_access_group juju_jaas_access_group}
*/
export class JaasAccessGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing JaasAccessGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/jaas_access_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/jaas_access_group juju_jaas_access_group} Resource
  *
  * @param scope The scope in which to define this construct
