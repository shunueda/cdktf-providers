// https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/model
...
export interface ModelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/model#annotations Model#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Override default model configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/model#config Model#config}
  */
  readonly config?: { [key: string]: string };
  /**
  * Constraints imposed to this model
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/model#constraints Model#constraints}
  */
  readonly constraints?: string;
  /**
  * Credential used to add the model
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/model#credential Model#credential}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/model#name Model#name}
  */
  readonly name: string;
  /**
  * cloud block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/model#cloud Model#cloud}
  */
...
export interface ModelCloud {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/model#region Model#region}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/model juju_model}
*/
export class Model extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Model that should be imported. Refer to the {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/model#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juju/juju/1.0.0/docs/resources/model juju_model} Resource
  *
  * @param scope The scope in which to define this construct
