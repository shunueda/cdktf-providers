// https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/application
...
export interface DataJujuApplicationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/application#model_uuid DataJujuApplication#model_uuid}
  */
  readonly modelUuid: string;
  /**
  * Name of the application.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/application#name DataJujuApplication#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/application juju_application}
*/
export class DataJujuApplication extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataJujuApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/application juju_application} Data Source
  *
  * @param scope The scope in which to define this construct
