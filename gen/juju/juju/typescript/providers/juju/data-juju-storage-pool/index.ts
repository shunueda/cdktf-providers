...
export interface DataJujuStoragePoolConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DataJujuStoragePool extends cdktf.TerraformDataSource {
  ...
  * @param options DataJujuStoragePoolConfig
  */
  public constructor(scope: Construct, id: string, config: DataJujuStoragePoolConfig) {
    super(scope, id, {
