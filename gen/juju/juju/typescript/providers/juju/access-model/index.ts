// https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_model
...
export interface AccessModelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_model#access AccessModel#access}
  */
  readonly access: string;
  /**
  * The uuid of the model for access management
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_model#model_uuid AccessModel#model_uuid}
  */
  readonly modelUuid: string;
  /**
  * Set of users to grant access to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_model#users AccessModel#users}
  */
  readonly users: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_model juju_access_model}
*/
export class AccessModel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccessModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_model#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/resources/access_model juju_access_model} Resource
  *
  * @param scope The scope in which to define this construct
