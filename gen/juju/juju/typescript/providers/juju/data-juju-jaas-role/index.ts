// https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/jaas_role
...
export interface DataJujuJaasRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/jaas_role#name DataJujuJaasRole#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/jaas_role juju_jaas_role}
*/
export class DataJujuJaasRole extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataJujuJaasRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/jaas_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/jaas_role juju_jaas_role} Data Source
  *
  * @param scope The scope in which to define this construct
