// https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/jaas_group
...
export interface DataJujuJaasGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/jaas_group#name DataJujuJaasGroup#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/jaas_group juju_jaas_group}
*/
export class DataJujuJaasGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataJujuJaasGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/jaas_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/juju/juju/1.1.1/docs/data-sources/jaas_group juju_jaas_group} Data Source
  *
  * @param scope The scope in which to define this construct
