// https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs
...
export interface FluxProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#git FluxProvider#git}
  */
  readonly git?: FluxProviderGit;
  /**
  * Configuration block with settings for Kubernetes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#kubernetes FluxProvider#kubernetes}
  */
  readonly kubernetes?: FluxProviderKubernetes;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#alias FluxProvider#alias}
  */
...
export interface FluxProviderGitHttp {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#allow_insecure_http FluxProvider#allow_insecure_http}
  */
  readonly allowInsecureHttp?: boolean | cdktf.IResolvable;
  /**
  * Certificate authority to validate self-signed certificates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#certificate_authority FluxProvider#certificate_authority}
  */
  readonly certificateAuthority?: string;
  /**
  * Password for basic authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#password FluxProvider#password}
  */
  readonly password?: string;
  /**
  * Username for basic authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#username FluxProvider#username}
  */
...
export interface FluxProviderGitSsh {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#hostkey_algos FluxProvider#hostkey_algos}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#private_key FluxProvider#private_key}
  */
...
export interface FluxProviderGit {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#author_email FluxProvider#author_email}
  */
  readonly authorEmail?: string;
  /**
  * Author name for Git commits. Defaults to `Flux`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#author_name FluxProvider#author_name}
  */
  readonly authorName?: string;
  /**
  * Branch of the repository to reconcile from. Defaults to `main`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#branch FluxProvider#branch}
  */
  readonly branch?: string;
  /**
  * String to add to the commit messages.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#commit_message_appendix FluxProvider#commit_message_appendix}
  */
  readonly commitMessageAppendix?: string;
  /**
  * Key id for selecting a particular GPG key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#gpg_key_id FluxProvider#gpg_key_id}
  */
  readonly gpgKeyId?: string;
  /**
  * Path to the GPG key ring for signing commits.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#gpg_key_ring FluxProvider#gpg_key_ring}
  */
  readonly gpgKeyRing?: string;
  /**
  * Passphrase for decrypting GPG private key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#gpg_passphrase FluxProvider#gpg_passphrase}
  */
  readonly gpgPassphrase?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#http FluxProvider#http}
  */
  readonly http?: FluxProviderGitHttp;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#ssh FluxProvider#ssh}
  */
  readonly ssh?: FluxProviderGitSsh;
  /**
  * Url of Git repository to bootstrap from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#url FluxProvider#url}
  */
  readonly url: string;
}
...
export interface FluxProviderKubernetesExec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#api_version FluxProvider#api_version}
  */
  readonly apiVersion: string;
  /**
  * Client authentication exec command arguments.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#args FluxProvider#args}
  */
  readonly args?: string[];
  /**
  * Client authentication exec command.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#command FluxProvider#command}
  */
  readonly command: string;
  /**
  * Client authentication exec environment variables.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#env FluxProvider#env}
  */
...
export interface FluxProviderKubernetes {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#client_certificate FluxProvider#client_certificate}
  */
  readonly clientCertificate?: string;
  /**
  * PEM-encoded client certificate key for TLS authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#client_key FluxProvider#client_key}
  */
  readonly clientKey?: string;
  /**
  * PEM-encoded root certificates bundle for TLS authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#cluster_ca_certificate FluxProvider#cluster_ca_certificate}
  */
  readonly clusterCaCertificate?: string;
  /**
  * Context to choose from the config file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#config_context FluxProvider#config_context}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#config_context_auth_info FluxProvider#config_context_auth_info}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#config_context_cluster FluxProvider#config_context_cluster}
  */
  readonly configContextCluster?: string;
  /**
  * Path to the kube config file. Can be set with KUBE_CONFIG_PATH.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#config_path FluxProvider#config_path}
  */
  readonly configPath?: string;
  /**
  * A list of paths to kube config files. Can be set with KUBE_CONFIG_PATHS environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#config_paths FluxProvider#config_paths}
  */
  readonly configPaths?: string[];
  /**
  * Kubernetes client authentication exec plugin configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#exec FluxProvider#exec}
  */
  readonly exec?: FluxProviderKubernetesExec;
  /**
  * The hostname (in form of URI) of Kubernetes master.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#host FluxProvider#host}
  */
  readonly host?: string;
  /**
  * Whether server should be accessed without verifying the TLS certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#insecure FluxProvider#insecure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#proxy_url FluxProvider#proxy_url}
  */
  readonly proxyUrl?: string;
  /**
  * Token to authenticate an service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#token FluxProvider#token}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs flux}
*/
export class FluxProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing FluxProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fluxcd/flux/1.7.6/docs flux} Resource
  *
  * @param scope The scope in which to define this construct
