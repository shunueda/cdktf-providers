// https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain
...
export interface RegisteredDomainConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain#auto_renew_enabled RegisteredDomain#auto_renew_enabled}
  */
  readonly autoRenewEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain#contact_id RegisteredDomain#contact_id}
  */
  readonly contactId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain#dnssec_enabled RegisteredDomain#dnssec_enabled}
  */
  readonly dnssecEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain#extended_attributes RegisteredDomain#extended_attributes}
  */
  readonly extendedAttributes?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain#name RegisteredDomain#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain#premium_price RegisteredDomain#premium_price}
  */
  readonly premiumPrice?: string;
  /**
  * Timeouts for operations, given as a parsable string as in `10m` or `30s`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain#timeouts RegisteredDomain#timeouts}
  */
  readonly timeouts?: RegisteredDomainTimeouts;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain#transfer_lock_enabled RegisteredDomain#transfer_lock_enabled}
  */
  readonly transferLockEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain#whois_privacy_enabled RegisteredDomain#whois_privacy_enabled}
  */
  readonly whoisPrivacyEnabled?: boolean | cdktf.IResolvable;
}
export interface RegisteredDomainDomainRegistration {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain#state RegisteredDomain#state}
  */
...
export interface RegisteredDomainTimeouts {
  ...
  * Create timeout.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain#create RegisteredDomain#create}
  */
  readonly create?: string;
  /**
  * Delete timeout (currently unused).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain#delete RegisteredDomain#delete}
  */
  readonly delete?: string;
  /**
  * Update timeout.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain#update RegisteredDomain#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain dnsimple_registered_domain}
*/
export class RegisteredDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RegisteredDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/resources/registered_domain dnsimple_registered_domain} Resource
  *
  * @param scope The scope in which to define this construct
