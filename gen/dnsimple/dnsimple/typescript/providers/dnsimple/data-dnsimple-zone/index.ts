// https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/data-sources/zone
...
export interface DataDnsimpleZoneConfig extends cdktf.TerraformMetaArguments {
  ...
  * Zone Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/data-sources/zone#name DataDnsimpleZone#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/data-sources/zone dnsimple_zone}
*/
export class DataDnsimpleZone extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDnsimpleZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/data-sources/zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dnsimple/dnsimple/2.0.0/docs/data-sources/zone dnsimple_zone} Data Source
  *
  * @param scope The scope in which to define this construct
