// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_token
...
export interface DataOktaAppTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_token#client_id DataOktaAppToken#client_id}
  */
  readonly clientId: string;
  /**
  * The unique ID of this key record
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_token#id DataOktaAppToken#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_token okta_app_token}
*/
export class DataOktaAppToken extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAppToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_token okta_app_token} Data Source
  *
  * @param scope The scope in which to define this construct
