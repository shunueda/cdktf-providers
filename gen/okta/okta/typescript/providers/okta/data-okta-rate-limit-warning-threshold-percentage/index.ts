// https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/rate_limit_warning_threshold_percentage
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/rate_limit_warning_threshold_percentage okta_rate_limit_warning_threshold_percentage}
*/
export class DataOktaRateLimitWarningThresholdPercentage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaRateLimitWarningThresholdPercentage that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/rate_limit_warning_threshold_percentage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/rate_limit_warning_threshold_percentage okta_rate_limit_warning_threshold_percentage} Data Source
  *
  * @param scope The scope in which to define this construct
