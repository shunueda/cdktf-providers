// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/feature
...
export interface FeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/feature#feature_id Feature#feature_id}
  */
  readonly featureId: string;
  /**
  * Whether to `ENABLE` or `DISABLE` the feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/feature#life_cycle Feature#life_cycle}
  */
  readonly lifeCycle?: string;
  /**
  * Indicates if you want to force enable or disable a feature. Value is `true` meaning force
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/feature#mode Feature#mode}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/feature okta_feature}
*/
export class Feature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Feature that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/feature okta_feature} Resource
  *
  * @param scope The scope in which to define this construct
