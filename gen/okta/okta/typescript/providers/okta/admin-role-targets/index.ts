// https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/admin_role_targets
...
export interface AdminRoleTargetsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/admin_role_targets#apps AdminRoleTargets#apps}
  */
  readonly apps?: string[];
  /**
  * List of group IDs. Conflicts with apps
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/admin_role_targets#groups AdminRoleTargets#groups}
  */
  readonly groups?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/admin_role_targets#id AdminRoleTargets#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/admin_role_targets#role_type AdminRoleTargets#role_type}
  */
  readonly roleType: string;
  /**
  * User associated with the role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/admin_role_targets#user_id AdminRoleTargets#user_id}
  */
  readonly userId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/admin_role_targets okta_admin_role_targets}
*/
export class AdminRoleTargets extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdminRoleTargets that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/admin_role_targets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/admin_role_targets okta_admin_role_targets} Resource
  *
  * @param scope The scope in which to define this construct
