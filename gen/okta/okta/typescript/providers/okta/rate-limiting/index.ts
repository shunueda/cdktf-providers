// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/rate_limiting
...
export interface RateLimitingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/rate_limiting#default_mode RateLimiting#default_mode}
  */
  readonly defaultMode: string;
  /**
  * use_case_mode_overrides block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/rate_limiting#use_case_mode_overrides RateLimiting#use_case_mode_overrides}
  */
  readonly useCaseModeOverrides?: RateLimitingUseCaseModeOverrides;
}
export interface RateLimitingUseCaseModeOverrides {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/rate_limiting#login_page RateLimiting#login_page}
  */
  readonly loginPage?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/rate_limiting#oauth2_authorize RateLimiting#oauth2_authorize}
  */
  readonly oauth2Authorize?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/rate_limiting#oie_app_intent RateLimiting#oie_app_intent}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/rate_limiting okta_rate_limiting}
*/
export class RateLimiting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RateLimiting that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/rate_limiting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/rate_limiting okta_rate_limiting} Resource
  *
  * @param scope The scope in which to define this construct
