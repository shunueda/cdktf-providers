// https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon
...
export interface PolicyRuleSignonConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#access PolicyRuleSignon#access}
  */
  readonly access?: string;
  /**
  * Authentication entrypoint: `ANY`, `RADIUS` or `LDAP_INTERFACE`. Default: `ANY`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#authtype PolicyRuleSignon#authtype}
  */
  readonly authtype?: string;
  /**
  * List of behavior IDs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#behaviors PolicyRuleSignon#behaviors}
  */
  readonly behaviors?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#id PolicyRuleSignon#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#identity_provider PolicyRuleSignon#identity_provider}
  */
  readonly identityProvider?: string;
  /**
  * When identity_provider is `SPECIFIC_IDP` then this is the list of IdP IDs to apply the rule on
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#identity_provider_ids PolicyRuleSignon#identity_provider_ids}
  */
  readonly identityProviderIds?: string[];
  /**
  * Elapsed time before the next MFA challenge
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#mfa_lifetime PolicyRuleSignon#mfa_lifetime}
  */
  readonly mfaLifetime?: number;
  /**
  * Prompt for MFA based on the device used, a factor session lifetime, or every sign-on attempt: `DEVICE`, `SESSION` or`ALWAYS`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#mfa_prompt PolicyRuleSignon#mfa_prompt}
  */
  readonly mfaPrompt?: string;
  /**
  * Remember MFA device. Default: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#mfa_remember_device PolicyRuleSignon#mfa_remember_device}
  */
  readonly mfaRememberDevice?: boolean | cdktf.IResolvable;
  /**
  * Require MFA. Default: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#mfa_required PolicyRuleSignon#mfa_required}
  */
  readonly mfaRequired?: boolean | cdktf.IResolvable;
  /**
  * Policy Rule Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#name PolicyRuleSignon#name}
  */
  readonly name: string;
  /**
  * Network selection mode: `ANYWHERE`, `ZONE`, `ON_NETWORK`, or `OFF_NETWORK`. Default: `ANYWHERE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#network_connection PolicyRuleSignon#network_connection}
  */
  readonly networkConnection?: string;
  /**
  * Required if `network_connection` = `ZONE`. Indicates the network zones to exclude.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#network_excludes PolicyRuleSignon#network_excludes}
  */
  readonly networkExcludes?: string[];
  /**
  * Required if `network_connection` = `ZONE`. Indicates the network zones to include.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#network_includes PolicyRuleSignon#network_includes}
  */
  readonly networkIncludes?: string[];
  /**
  * Policy ID of the Rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#policy_id PolicyRuleSignon#policy_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#primary_factor PolicyRuleSignon#primary_factor}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#priority PolicyRuleSignon#priority}
  */
  readonly priority?: number;
  /**
  * Risc level: ANY, LOW, MEDIUM or HIGH. Default: `ANY`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#risc_level PolicyRuleSignon#risc_level}
  */
  readonly riscLevel?: string;
  /**
  * Risk level: ANY, LOW, MEDIUM or HIGH. Default: `ANY`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#risk_level PolicyRuleSignon#risk_level}
  */
  readonly riskLevel?: string;
  /**
  * Max minutes a session can be idle. Default: `120`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#session_idle PolicyRuleSignon#session_idle}
  */
  readonly sessionIdle?: number;
  /**
  * Max minutes a session is active: Disable = 0. Default: `120`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#session_lifetime PolicyRuleSignon#session_lifetime}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#session_persistent PolicyRuleSignon#session_persistent}
  */
  readonly sessionPersistent?: boolean | cdktf.IResolvable;
  /**
  * Policy Rule Status: `ACTIVE` or `INACTIVE`. Default: `ACTIVE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#status PolicyRuleSignon#status}
  */
  readonly status?: string;
  /**
  * Set of User IDs to Exclude
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#users_excluded PolicyRuleSignon#users_excluded}
  */
  readonly usersExcluded?: string[];
  /**
  * factor_sequence block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#factor_sequence PolicyRuleSignon#factor_sequence}
  */
...
export interface PolicyRuleSignonFactorSequenceSecondaryCriteria {
  ...
  * Type of a Factor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#factor_type PolicyRuleSignon#factor_type}
  */
  readonly factorType: string;
  /**
  * Factor provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#provider PolicyRuleSignon#provider}
  */
...
export interface PolicyRuleSignonFactorSequence {
  ...
  * Type of a Factor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#primary_criteria_factor_type PolicyRuleSignon#primary_criteria_factor_type}
  */
  readonly primaryCriteriaFactorType: string;
  /**
  * Factor provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#primary_criteria_provider PolicyRuleSignon#primary_criteria_provider}
  */
  readonly primaryCriteriaProvider: string;
  /**
  * secondary_criteria block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#secondary_criteria PolicyRuleSignon#secondary_criteria}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon okta_policy_rule_signon}
*/
export class PolicyRuleSignon extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyRuleSignon that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/policy_rule_signon okta_policy_rule_signon} Resource
  *
  * @param scope The scope in which to define this construct
