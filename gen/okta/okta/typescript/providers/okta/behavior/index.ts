// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/behavior
...
export interface BehaviorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/behavior#id Behavior#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/behavior#location_granularity_type Behavior#location_granularity_type}
  */
  readonly locationGranularityType?: string;
  /**
  * Name of the behavior
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/behavior#name Behavior#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/behavior#number_of_authentications Behavior#number_of_authentications}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/behavior#radius_from_location Behavior#radius_from_location}
  */
  readonly radiusFromLocation?: number;
  /**
  * Behavior status: ACTIVE or INACTIVE. Default: `ACTIVE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/behavior#status Behavior#status}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/behavior#type Behavior#type}
  */
  readonly type: string;
  /**
  * Velocity (in kilometers per hour). Should be at least 1. Required for `VELOCITY` behavior
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/behavior#velocity Behavior#velocity}
  */
  readonly velocity?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/behavior okta_behavior}
*/
export class Behavior extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Behavior that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/behavior#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/behavior okta_behavior} Resource
  *
  * @param scope The scope in which to define this construct
