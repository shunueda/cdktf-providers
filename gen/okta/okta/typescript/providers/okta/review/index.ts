// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/review
...
export interface ReviewConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/review#campaign_id Review#campaign_id}
  */
  readonly campaignId: string;
  /**
  * A note to justify the reassignment decision for the specified review.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/review#note Review#note}
  */
  readonly note: string;
  /**
  * A list of reviews (review id values) that are reassigned to the new reviewer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/review#review_ids Review#review_ids}
  */
  readonly reviewIds: string[];
  /**
  * The Okta user id of the new reviewer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/review#reviewer_id Review#reviewer_id}
  */
  readonly reviewerId: string;
  /**
  * Identifies the reviewer level of each reviews during access certification. Applicable for multi level campaigns only.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/review#reviewer_level Review#reviewer_level}
  */
  readonly reviewerLevel?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/review okta_review}
*/
export class Review extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Review that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/review#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/review okta_review} Resource
  *
  * @param scope The scope in which to define this construct
