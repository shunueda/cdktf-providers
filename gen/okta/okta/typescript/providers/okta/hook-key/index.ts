// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/hook_key
...
export interface HookKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/hook_key#name HookKey#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/hook_key okta_hook_key}
*/
export class HookKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HookKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/hook_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/hook_key okta_hook_key} Resource
  *
  * @param scope The scope in which to define this construct
