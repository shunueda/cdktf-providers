// https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/api_token
...
export interface DataOktaApiTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/api_token#id DataOktaApiToken#id}
  *
  ...
  * network block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/api_token#network DataOktaApiToken#network}
  */
...
export interface DataOktaApiTokenNetwork {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/api_token#exclude DataOktaApiToken#exclude}
  */
  readonly exclude?: string[];
  /**
  * The IP address the included zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/api_token#include DataOktaApiToken#include}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/api_token okta_api_token}
*/
export class DataOktaApiToken extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaApiToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/api_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/api_token okta_api_token} Data Source
  *
  * @param scope The scope in which to define this construct
