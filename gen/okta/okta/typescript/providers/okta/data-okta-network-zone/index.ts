// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/network_zone
...
export interface DataOktaNetworkZoneConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/network_zone#dynamic_locations_exclude DataOktaNetworkZone#dynamic_locations_exclude}
  */
  readonly dynamicLocationsExclude?: string[];
  /**
  * ID of the network zone to retrieve, conflicts with `name`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/network_zone#id DataOktaNetworkZone#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/network_zone#ip_service_categories_exclude DataOktaNetworkZone#ip_service_categories_exclude}
  */
  readonly ipServiceCategoriesExclude?: string[];
  /**
  * List of ip service included. Use with type `DYNAMIC_V2`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/network_zone#ip_service_categories_include DataOktaNetworkZone#ip_service_categories_include}
  */
  readonly ipServiceCategoriesInclude?: string[];
  /**
  * Name of the network zone to retrieve, conflicts with `id`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/network_zone#name DataOktaNetworkZone#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/network_zone okta_network_zone}
*/
export class DataOktaNetworkZone extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaNetworkZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/network_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/network_zone okta_network_zone} Data Source
  *
  * @param scope The scope in which to define this construct
