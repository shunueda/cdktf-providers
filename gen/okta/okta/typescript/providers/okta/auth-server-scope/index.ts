// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/auth_server_scope
...
export interface AuthServerScopeConfig extends cdktf.TerraformMetaArguments {
  ...
  * Auth server ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/auth_server_scope#auth_server_id AuthServerScope#auth_server_id}
  */
  readonly authServerId: string;
  /**
  * Indicates whether a consent dialog is needed for the scope. It can be set to `REQUIRED` or `IMPLICIT`. Default: `IMPLICIT`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/auth_server_scope#consent AuthServerScope#consent}
  */
  readonly consent?: string;
  /**
  * A default scope will be returned in an access token when the client omits the scope parameter in a token request, provided this scope is allowed as part of the access policy rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/auth_server_scope#default AuthServerScope#default}
  */
  readonly default?: boolean | cdktf.IResolvable;
  /**
  * Description of the Auth Server Scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/auth_server_scope#description AuthServerScope#description}
  */
  readonly description?: string;
  /**
  * Name of the end user displayed in a consent dialog box
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/auth_server_scope#display_name AuthServerScope#display_name}
  */
  readonly displayName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/auth_server_scope#id AuthServerScope#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/auth_server_scope#metadata_publish AuthServerScope#metadata_publish}
  */
  readonly metadataPublish?: string;
  /**
  * Auth server scope name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/auth_server_scope#name AuthServerScope#name}
  */
  readonly name: string;
  /**
  * Whether the scope optional
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/auth_server_scope#optional AuthServerScope#optional}
  */
  readonly optional?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/auth_server_scope okta_auth_server_scope}
*/
export class AuthServerScope extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthServerScope that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/auth_server_scope#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/auth_server_scope okta_auth_server_scope} Resource
  *
  * @param scope The scope in which to define this construct
