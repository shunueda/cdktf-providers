// https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/behaviors
...
export interface DataOktaBehaviorsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/behaviors#id DataOktaBehaviors#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/behaviors#q DataOktaBehaviors#q}
  */
  readonly q?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/behaviors okta_behaviors}
*/
export class DataOktaBehaviors extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaBehaviors that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/behaviors#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/behaviors okta_behaviors} Data Source
  *
  * @param scope The scope in which to define this construct
