// https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/principal_rate_limits
...
export interface DataOktaPrincipalRateLimitsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/principal_rate_limits#id DataOktaPrincipalRateLimits#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/principal_rate_limits okta_principal_rate_limits}
*/
export class DataOktaPrincipalRateLimits extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaPrincipalRateLimits that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/principal_rate_limits#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/principal_rate_limits okta_principal_rate_limits} Data Source
  *
  * @param scope The scope in which to define this construct
