// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/default_signin_page
...
export interface DataOktaDefaultSigninPageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/default_signin_page#brand_id DataOktaDefaultSigninPage#brand_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/default_signin_page okta_default_signin_page}
*/
export class DataOktaDefaultSigninPage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaDefaultSigninPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/default_signin_page#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/default_signin_page okta_default_signin_page} Data Source
  *
  * @param scope The scope in which to define this construct
