// https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/rate_limit_admin_notification_settings
...
export interface RateLimitAdminNotificationSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/rate_limit_admin_notification_settings#notifications_enabled RateLimitAdminNotificationSettings#notifications_enabled}
  */
  readonly notificationsEnabled: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/rate_limit_admin_notification_settings okta_rate_limit_admin_notification_settings}
*/
export class RateLimitAdminNotificationSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RateLimitAdminNotificationSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/rate_limit_admin_notification_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/rate_limit_admin_notification_settings okta_rate_limit_admin_notification_settings} Resource
  *
  * @param scope The scope in which to define this construct
