// https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection
...
export interface AppConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection#action AppConnection#action}
  */
  readonly action: string;
  /**
  * The base URL for the provisioning connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection#base_url AppConnection#base_url}
  */
  readonly baseUrl: string;
  /**
  * The application ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection#id AppConnection#id}
  *
  ...
  * profile block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection#profile AppConnection#profile}
  */
...
export interface AppConnectionProfileSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection#admin_password AppConnection#admin_password}
  */
  readonly adminPassword?: string;
  /**
  * Admin username for OAuth2.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection#admin_username AppConnection#admin_username}
  */
...
export interface AppConnectionProfileSigning {
  ...
  * Token rotation mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection#rotation_mode AppConnection#rotation_mode}
  */
...
export interface AppConnectionProfile {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection#auth_scheme AppConnection#auth_scheme}
  */
  readonly authScheme: string;
  /**
  * OAuth2 client ID (required for OAUTH2 auth scheme).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection#client_id AppConnection#client_id}
  */
  readonly clientId?: string;
  /**
  * Authentication token (required for TOKEN auth scheme).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection#token AppConnection#token}
  */
  readonly token?: string;
  /**
  * settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection#settings AppConnection#settings}
  */
  readonly settings?: AppConnectionProfileSettings;
  /**
  * signing block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection#signing AppConnection#signing}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection okta_app_connection}
*/
export class AppConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/app_connection okta_app_connection} Resource
  *
  * @param scope The scope in which to define this construct
