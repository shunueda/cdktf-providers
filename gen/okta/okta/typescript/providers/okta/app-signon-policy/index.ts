// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/app_signon_policy
...
export interface AppSignonPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/app_signon_policy#catch_all AppSignonPolicy#catch_all}
  */
  readonly catchAll?: boolean | cdktf.IResolvable;
  /**
  * Description of the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/app_signon_policy#description AppSignonPolicy#description}
  */
  readonly description: string;
  /**
  * Name of the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/app_signon_policy#name AppSignonPolicy#name}
  */
  readonly name: string;
  /**
  * Priority of the policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/app_signon_policy#priority AppSignonPolicy#priority}
  */
  readonly priority?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/app_signon_policy okta_app_signon_policy}
*/
export class AppSignonPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppSignonPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/app_signon_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/app_signon_policy okta_app_signon_policy} Resource
  *
  * @param scope The scope in which to define this construct
