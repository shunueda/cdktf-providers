// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/principal_rate_limits
...
export interface PrincipalRateLimitsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/principal_rate_limits#default_concurrency_percentage PrincipalRateLimits#default_concurrency_percentage}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/principal_rate_limits#default_percentage PrincipalRateLimits#default_percentage}
  */
  readonly defaultPercentage?: number;
  /**
  * The unique identifier of the principal. This is the ID of the API token or OAuth 2.0 app.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/principal_rate_limits#principal_id PrincipalRateLimits#principal_id}
  */
  readonly principalId: string;
  /**
  * The type of principal, either an API token or an OAuth 2.0 app.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/principal_rate_limits#principal_type PrincipalRateLimits#principal_type}
  */
  readonly principalType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/principal_rate_limits okta_principal_rate_limits}
*/
export class PrincipalRateLimits extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrincipalRateLimits that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/principal_rate_limits#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/principal_rate_limits okta_principal_rate_limits} Resource
  *
  * @param scope The scope in which to define this construct
