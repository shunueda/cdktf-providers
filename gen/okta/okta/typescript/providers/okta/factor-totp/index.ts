// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/factor_totp
...
export interface FactorTotpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/factor_totp#clock_drift_interval FactorTotp#clock_drift_interval}
  */
  readonly clockDriftInterval?: number;
  /**
  * HMAC Algorithm. Valid values: `HMacSHA1`, `HMacSHA256`, `HMacSHA512`. Default is `HMacSHA512`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/factor_totp#hmac_algorithm FactorTotp#hmac_algorithm}
  */
  readonly hmacAlgorithm?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/factor_totp#id FactorTotp#id}
  *
  ...
  * The TOTP name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/factor_totp#name FactorTotp#name}
  */
  readonly name: string;
  /**
  * Length of the password. Default is `6`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/factor_totp#otp_length FactorTotp#otp_length}
  */
  readonly otpLength?: number;
  /**
  * Shared secret encoding. Valid values: `base32`, `base64`, `hexadecimal`. Default is `base32`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/factor_totp#shared_secret_encoding FactorTotp#shared_secret_encoding}
  */
  readonly sharedSecretEncoding?: string;
  /**
  * Time step in seconds. Valid values: `15`, `30`, `60`. Default is `15`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/factor_totp#time_step FactorTotp#time_step}
  */
  readonly timeStep?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/factor_totp okta_factor_totp}
*/
export class FactorTotp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FactorTotp that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/factor_totp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/factor_totp okta_factor_totp} Resource
  *
  * @param scope The scope in which to define this construct
