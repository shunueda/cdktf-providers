// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_profile_enrollment_apps
...
export interface PolicyProfileEnrollmentAppsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_profile_enrollment_apps#apps PolicyProfileEnrollmentApps#apps}
  */
  readonly apps?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_profile_enrollment_apps#id PolicyProfileEnrollmentApps#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_profile_enrollment_apps#policy_id PolicyProfileEnrollmentApps#policy_id}
  */
  readonly policyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_profile_enrollment_apps okta_policy_profile_enrollment_apps}
*/
export class PolicyProfileEnrollmentApps extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyProfileEnrollmentApps that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_profile_enrollment_apps#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_profile_enrollment_apps okta_policy_profile_enrollment_apps} Resource
  *
  * @param scope The scope in which to define this construct
