// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/everyone_group
...
export interface DataOktaEveryoneGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/everyone_group#id DataOktaEveryoneGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/everyone_group#include_users DataOktaEveryoneGroup#include_users}
  */
  readonly includeUsers?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/everyone_group okta_everyone_group}
*/
export class DataOktaEveryoneGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaEveryoneGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/everyone_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/everyone_group okta_everyone_group} Data Source
  *
  * @param scope The scope in which to define this construct
