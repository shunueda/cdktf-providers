// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/user_profile_mapping_source
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/user_profile_mapping_source okta_user_profile_mapping_source}
*/
export class DataOktaUserProfileMappingSource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaUserProfileMappingSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/user_profile_mapping_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/user_profile_mapping_source okta_user_profile_mapping_source} Data Source
  *
  * @param scope The scope in which to define this construct
