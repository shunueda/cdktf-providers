// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/groups
...
export interface DataOktaGroupsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/groups#id DataOktaGroups#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/groups#limit DataOktaGroups#limit}
  */
  readonly limit?: number;
  /**
  * Searches the name property of groups for matching value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/groups#q DataOktaGroups#q}
  */
  readonly q?: string;
  /**
  * Searches for groups with a supported filtering expression for all attributes except for '_embedded', '_links', and 'objectClass'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/groups#search DataOktaGroups#search}
  */
  readonly search?: string;
  /**
  * Type of the group. When specified in the terraform resource, will act as a filter when searching for the groups
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/groups#type DataOktaGroups#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/groups okta_groups}
*/
export class DataOktaGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/groups okta_groups} Data Source
  *
  * @param scope The scope in which to define this construct
