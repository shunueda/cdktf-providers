// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/brand
...
export interface DataOktaBrandConfig extends cdktf.TerraformMetaArguments {
  ...
  * Brand ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/brand#brand_id DataOktaBrand#brand_id}
  */
  readonly brandId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/brand okta_brand}
*/
export class DataOktaBrand extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaBrand that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/brand#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/brand okta_brand} Data Source
  *
  * @param scope The scope in which to define this construct
