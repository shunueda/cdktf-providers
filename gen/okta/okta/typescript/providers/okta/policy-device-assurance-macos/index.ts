// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos
...
export interface PolicyDeviceAssuranceMacosConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#disk_encryption_type PolicyDeviceAssuranceMacos#disk_encryption_type}
  */
  readonly diskEncryptionType?: string[];
  /**
  * Name of the device assurance policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#name PolicyDeviceAssuranceMacos#name}
  */
  readonly name: string;
  /**
  * Minimum os version of the device in the device assurance policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#os_version PolicyDeviceAssuranceMacos#os_version}
  */
  readonly osVersion?: string;
  /**
  * List of screenlock type, can be `BIOMETRIC` or `BIOMETRIC, PASSCODE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#screenlock_type PolicyDeviceAssuranceMacos#screenlock_type}
  */
  readonly screenlockType?: string[];
  /**
  * Is the device secure with hardware in the device assurance policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#secure_hardware_present PolicyDeviceAssuranceMacos#secure_hardware_present}
  */
  readonly secureHardwarePresent?: boolean | cdktf.IResolvable;
  /**
  * Check to include third party signal provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#third_party_signal_providers PolicyDeviceAssuranceMacos#third_party_signal_providers}
  */
  readonly thirdPartySignalProviders?: boolean | cdktf.IResolvable;
  /**
  * Third party signal provider minimum browser version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#tpsp_browser_version PolicyDeviceAssuranceMacos#tpsp_browser_version}
  */
  readonly tpspBrowserVersion?: string;
  /**
  * Third party signal provider builtin dns client enable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#tpsp_builtin_dns_client_enabled PolicyDeviceAssuranceMacos#tpsp_builtin_dns_client_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#tpsp_chrome_remote_desktop_app_blocked PolicyDeviceAssuranceMacos#tpsp_chrome_remote_desktop_app_blocked}
  */
  readonly tpspChromeRemoteDesktopAppBlocked?: boolean | cdktf.IResolvable;
  /**
  * Third party signal provider device enrollment domain
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#tpsp_device_enrollment_domain PolicyDeviceAssuranceMacos#tpsp_device_enrollment_domain}
  */
  readonly tpspDeviceEnrollmentDomain?: string;
  /**
  * Third party signal provider disk encrypted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#tpsp_disk_encrypted PolicyDeviceAssuranceMacos#tpsp_disk_encrypted}
  */
  readonly tpspDiskEncrypted?: boolean | cdktf.IResolvable;
  /**
  * Third party signal provider key trust level
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#tpsp_key_trust_level PolicyDeviceAssuranceMacos#tpsp_key_trust_level}
  */
  readonly tpspKeyTrustLevel?: string;
  /**
  * Third party signal provider os firewall
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#tpsp_os_firewall PolicyDeviceAssuranceMacos#tpsp_os_firewall}
  */
  readonly tpspOsFirewall?: boolean | cdktf.IResolvable;
  /**
  * Third party signal provider minimum os version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#tpsp_os_version PolicyDeviceAssuranceMacos#tpsp_os_version}
  */
  readonly tpspOsVersion?: string;
  /**
  * Third party signal provider password protection warning trigger
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#tpsp_password_proctection_warning_trigger PolicyDeviceAssuranceMacos#tpsp_password_proctection_warning_trigger}
  */
  readonly tpspPasswordProctectionWarningTrigger?: string;
  /**
  * Third party signal provider realtime url check mode
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#tpsp_realtime_url_check_mode PolicyDeviceAssuranceMacos#tpsp_realtime_url_check_mode}
  */
  readonly tpspRealtimeUrlCheckMode?: boolean | cdktf.IResolvable;
  /**
  * Third party signal provider safe browsing protection level
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#tpsp_safe_browsing_protection_level PolicyDeviceAssuranceMacos#tpsp_safe_browsing_protection_level}
  */
  readonly tpspSafeBrowsingProtectionLevel?: string;
  /**
  * Third party signal provider screen lock secure
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#tpsp_screen_lock_secured PolicyDeviceAssuranceMacos#tpsp_screen_lock_secured}
  */
  readonly tpspScreenLockSecured?: boolean | cdktf.IResolvable;
  /**
  * Third party signal provider site isolation enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#tpsp_site_isolation_enabled PolicyDeviceAssuranceMacos#tpsp_site_isolation_enabled}
  */
  readonly tpspSiteIsolationEnabled?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos okta_policy_device_assurance_macos}
*/
export class PolicyDeviceAssuranceMacos extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyDeviceAssuranceMacos that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/policy_device_assurance_macos okta_policy_device_assurance_macos} Resource
  *
  * @param scope The scope in which to define this construct
