// https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/realm_assignment
...
export interface DataOktaRealmAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/realm_assignment#name DataOktaRealmAssignment#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/realm_assignment okta_realm_assignment}
*/
export class DataOktaRealmAssignment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaRealmAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/realm_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/realm_assignment okta_realm_assignment} Data Source
  *
  * @param scope The scope in which to define this construct
