// https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/user_factor_question
...
export interface UserFactorQuestionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/user_factor_question#answer UserFactorQuestion#answer}
  */
  readonly answer: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/user_factor_question#id UserFactorQuestion#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/user_factor_question#key UserFactorQuestion#key}
  */
  readonly key: string;
  /**
  * ID of the user. Resource will be recreated when `user_id` changes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/user_factor_question#user_id UserFactorQuestion#user_id}
  */
  readonly userId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/user_factor_question okta_user_factor_question}
*/
export class UserFactorQuestion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserFactorQuestion that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/user_factor_question#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/user_factor_question okta_user_factor_question} Resource
  *
  * @param scope The scope in which to define this construct
