// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/trusted_origins
...
export interface DataOktaTrustedOriginsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/trusted_origins#filter DataOktaTrustedOrigins#filter}
  */
  readonly filter?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/trusted_origins#id DataOktaTrustedOrigins#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/trusted_origins okta_trusted_origins}
*/
export class DataOktaTrustedOrigins extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaTrustedOrigins that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/trusted_origins#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/trusted_origins okta_trusted_origins} Data Source
  *
  * @param scope The scope in which to define this construct
