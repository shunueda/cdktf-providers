// https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/email_domain_verification
...
export interface EmailDomainVerificationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Email domain ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/email_domain_verification#email_domain_id EmailDomainVerification#email_domain_id}
  */
  readonly emailDomainId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/email_domain_verification#id EmailDomainVerification#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/email_domain_verification okta_email_domain_verification}
*/
export class EmailDomainVerification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailDomainVerification that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/email_domain_verification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/email_domain_verification okta_email_domain_verification} Resource
  *
  * @param scope The scope in which to define this construct
