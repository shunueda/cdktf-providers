// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/link_value
...
export interface LinkValueConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/link_value#associated_user_ids LinkValue#associated_user_ids}
  */
  readonly associatedUserIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/link_value#id LinkValue#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/link_value#primary_name LinkValue#primary_name}
  */
  readonly primaryName: string;
  /**
  * User ID to be assigned to `primary` for the 'associated' user in the specified relationship.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/link_value#primary_user_id LinkValue#primary_user_id}
  */
  readonly primaryUserId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/link_value okta_link_value}
*/
export class LinkValue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LinkValue that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/link_value#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/link_value okta_link_value} Resource
  *
  * @param scope The scope in which to define this construct
