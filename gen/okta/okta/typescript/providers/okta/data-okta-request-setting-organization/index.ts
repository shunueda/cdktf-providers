// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_setting_organization
...
export interface DataOktaRequestSettingOrganizationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_setting_organization#request_experiences DataOktaRequestSettingOrganization#request_experiences}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_setting_organization okta_request_setting_organization}
*/
export class DataOktaRequestSettingOrganization extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaRequestSettingOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_setting_organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_setting_organization okta_request_setting_organization} Data Source
  *
  * @param scope The scope in which to define this construct
