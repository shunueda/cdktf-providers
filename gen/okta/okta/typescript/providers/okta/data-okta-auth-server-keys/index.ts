// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/auth_server_keys
...
export interface DataOktaAuthServerKeysConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/auth_server_keys#auth_server_id DataOktaAuthServerKeys#auth_server_id}
  */
  readonly authServerId: string;
  /**
  * The ID of the certificate key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/auth_server_keys#key_id DataOktaAuthServerKeys#key_id}
  */
  readonly keyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/auth_server_keys okta_auth_server_keys}
*/
export class DataOktaAuthServerKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAuthServerKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/auth_server_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/auth_server_keys okta_auth_server_keys} Data Source
  *
  * @param scope The scope in which to define this construct
