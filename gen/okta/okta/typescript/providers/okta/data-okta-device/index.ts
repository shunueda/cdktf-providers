// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/device
...
export interface DataOktaDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/device#id DataOktaDevice#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/device okta_device}
*/
export class DataOktaDevice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/device okta_device} Data Source
  *
  * @param scope The scope in which to define this construct
