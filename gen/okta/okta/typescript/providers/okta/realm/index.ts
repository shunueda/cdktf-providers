// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/realm
...
export interface RealmConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/realm#name Realm#name}
  */
  readonly name: string;
  /**
  * The realm type. Valid values: `PARTNER` and `DEFAULT`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/realm#realm_type Realm#realm_type}
  */
  readonly realmType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/realm okta_realm}
*/
export class Realm extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Realm that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/realm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/realm okta_realm} Resource
  *
  * @param scope The scope in which to define this construct
