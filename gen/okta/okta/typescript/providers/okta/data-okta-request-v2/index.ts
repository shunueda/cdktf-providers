// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_v2
...
export interface DataOktaRequestV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_v2#id DataOktaRequestV2#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_v2 okta_request_v2}
*/
export class DataOktaRequestV2 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaRequestV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_v2 okta_request_v2} Data Source
  *
  * @param scope The scope in which to define this construct
