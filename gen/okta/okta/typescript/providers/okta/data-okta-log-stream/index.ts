// https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/log_stream
...
export interface DataOktaLogStreamConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/log_stream#id DataOktaLogStream#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/log_stream#name DataOktaLogStream#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/log_stream okta_log_stream}
*/
export class DataOktaLogStream extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaLogStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/log_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/log_stream okta_log_stream} Data Source
  *
  * @param scope The scope in which to define this construct
