// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/request_setting_organization
...
export interface RequestSettingOrganizationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/request_setting_organization#id RequestSettingOrganization#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/request_setting_organization#subprocessors_acknowledged RequestSettingOrganization#subprocessors_acknowledged}
  */
  readonly subprocessorsAcknowledged?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/request_setting_organization okta_request_setting_organization}
*/
export class RequestSettingOrganization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RequestSettingOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/request_setting_organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/request_setting_organization okta_request_setting_organization} Resource
  *
  * @param scope The scope in which to define this construct
