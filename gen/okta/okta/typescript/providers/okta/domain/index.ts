// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/domain
...
export interface DomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/domain#brand_id Domain#brand_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/domain#certificate_source_type Domain#certificate_source_type}
  */
  readonly certificateSourceType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/domain#id Domain#id}
  *
  ...
  * Custom Domain name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/domain#name Domain#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/domain okta_domain}
*/
export class Domain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Domain that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/domain okta_domain} Resource
  *
  * @param scope The scope in which to define this construct
