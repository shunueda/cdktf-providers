// https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/security_events_provider
...
export interface SecurityEventsProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/security_events_provider#is_enabled SecurityEventsProvider#is_enabled}
  */
  readonly isEnabled: string;
  /**
  * The name of the Security Events Provider instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/security_events_provider#name SecurityEventsProvider#name}
  */
  readonly name: string;
  /**
  * The application type of the Security Events Provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/security_events_provider#type SecurityEventsProvider#type}
  */
  readonly type: string;
  /**
  * settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/security_events_provider#settings SecurityEventsProvider#settings}
  */
...
export interface SecurityEventsProviderSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/security_events_provider#issuer SecurityEventsProvider#issuer}
  */
  readonly issuer?: string;
  /**
  * The public URL where the JWKS public key is uploaded. Use with issuer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/security_events_provider#jwks_url SecurityEventsProvider#jwks_url}
  */
  readonly jwksUrl?: string;
  /**
  * The published well-known URL of the Security Events Provider (the SSF transmitter).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/security_events_provider#well_known_url SecurityEventsProvider#well_known_url}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/security_events_provider okta_security_events_provider}
*/
export class SecurityEventsProvider extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityEventsProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/security_events_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/security_events_provider okta_security_events_provider} Resource
  *
  * @param scope The scope in which to define this construct
