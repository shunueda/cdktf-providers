// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_sequence
...
export interface DataOktaRequestSequenceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_sequence#id DataOktaRequestSequence#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_sequence#resource_id DataOktaRequestSequence#resource_id}
  */
  readonly resourceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_sequence okta_request_sequence}
*/
export class DataOktaRequestSequence extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaRequestSequence that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_sequence#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/request_sequence okta_request_sequence} Data Source
  *
  * @param scope The scope in which to define this construct
