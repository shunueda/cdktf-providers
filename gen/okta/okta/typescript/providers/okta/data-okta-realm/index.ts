// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/realm
...
export interface DataOktaRealmConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/realm#id DataOktaRealm#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/realm#name DataOktaRealm#name}
  */
  readonly name?: string;
  /**
  * The realm type. Valid values: `PARTNER` and `DEFAULT`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/realm#realm_type DataOktaRealm#realm_type}
  */
  readonly realmType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/realm okta_realm}
*/
export class DataOktaRealm extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaRealm that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/realm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/realm okta_realm} Data Source
  *
  * @param scope The scope in which to define this construct
