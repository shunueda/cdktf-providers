// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook
...
export interface InlineHookConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook#auth InlineHook#auth}
  */
  readonly auth?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook#channel InlineHook#channel}
  */
  readonly channel?: { [key: string]: string };
  /**
  * true channel object for the inline hook API contract
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook#channel_json InlineHook#channel_json}
  */
  readonly channelJson?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook#id InlineHook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook#name InlineHook#name}
  */
  readonly name: string;
  /**
  * Default to `ACTIVE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook#status InlineHook#status}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook#type InlineHook#type}
  */
  readonly type: string;
  /**
  * The version of the hook. The currently-supported version is `1.0.0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook#version InlineHook#version}
  */
  readonly version: string;
  /**
  * headers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook#headers InlineHook#headers}
  */
  readonly headers?: InlineHookHeaders[] | cdktf.IResolvable;
}
export interface InlineHookHeaders {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook#key InlineHook#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook#value InlineHook#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook okta_inline_hook}
*/
export class InlineHook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InlineHook that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/inline_hook okta_inline_hook} Resource
  *
  * @param scope The scope in which to define this construct
