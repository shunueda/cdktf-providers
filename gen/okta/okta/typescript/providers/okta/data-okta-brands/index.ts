// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/brands
...
export interface DataOktaBrandsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/brands#id DataOktaBrands#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/brands okta_brands}
*/
export class DataOktaBrands extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaBrands that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/brands#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/brands okta_brands} Data Source
  *
  * @param scope The scope in which to define this construct
