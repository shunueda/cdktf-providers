// https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/auth_server_scopes
...
export interface DataOktaAuthServerScopesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Auth server ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/auth_server_scopes#auth_server_id DataOktaAuthServerScopes#auth_server_id}
  */
  readonly authServerId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/auth_server_scopes#id DataOktaAuthServerScopes#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/auth_server_scopes okta_auth_server_scopes}
*/
export class DataOktaAuthServerScopes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAuthServerScopes that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/auth_server_scopes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/auth_server_scopes okta_auth_server_scopes} Data Source
  *
  * @param scope The scope in which to define this construct
