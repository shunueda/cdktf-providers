// https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone
...
export interface NetworkZoneConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone#asns NetworkZone#asns}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone#dynamic_locations NetworkZone#dynamic_locations}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone#dynamic_locations_exclude NetworkZone#dynamic_locations_exclude}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone#dynamic_proxy_type NetworkZone#dynamic_proxy_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone#gateways NetworkZone#gateways}
  */
  readonly gateways?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone#id NetworkZone#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone#ip_service_categories_exclude NetworkZone#ip_service_categories_exclude}
  */
  readonly ipServiceCategoriesExclude?: string[];
  /**
  * List of ip service included. Use with type `DYNAMIC_V2`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone#ip_service_categories_include NetworkZone#ip_service_categories_include}
  */
  readonly ipServiceCategoriesInclude?: string[];
  /**
  * Name of the Network Zone Resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone#name NetworkZone#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone#proxies NetworkZone#proxies}
  */
  readonly proxies?: string[];
  /**
  * Network Status - can either be `ACTIVE` or `INACTIVE` only
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone#status NetworkZone#status}
  */
  readonly status?: string;
  /**
  * Type of the Network Zone - can be `IP`, `DYNAMIC` or `DYNAMIC_V2` only
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone#type NetworkZone#type}
  */
  readonly type: string;
  /**
  * Usage of the Network Zone - can be either `POLICY` or `BLOCKLIST`. By default, it is `POLICY`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone#usage NetworkZone#usage}
  */
  readonly usage?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone okta_network_zone}
*/
export class NetworkZone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/resources/network_zone okta_network_zone} Resource
  *
  * @param scope The scope in which to define this construct
