// https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/rate_limit_warning_threshold_percentage
...
export interface RateLimitWarningThresholdPercentageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/rate_limit_warning_threshold_percentage#warning_threshold RateLimitWarningThresholdPercentage#warning_threshold}
  */
  readonly warningThreshold: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/rate_limit_warning_threshold_percentage okta_rate_limit_warning_threshold_percentage}
*/
export class RateLimitWarningThresholdPercentage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RateLimitWarningThresholdPercentage that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/rate_limit_warning_threshold_percentage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/rate_limit_warning_threshold_percentage okta_rate_limit_warning_threshold_percentage} Resource
  *
  * @param scope The scope in which to define this construct
