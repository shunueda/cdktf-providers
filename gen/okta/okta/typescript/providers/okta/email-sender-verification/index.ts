// https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/email_sender_verification
...
export interface EmailSenderVerificationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/email_sender_verification#id EmailSenderVerification#id}
  *
  ...
  * Email sender ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/email_sender_verification#sender_id EmailSenderVerification#sender_id}
  */
  readonly senderId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/email_sender_verification okta_email_sender_verification}
*/
export class EmailSenderVerification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailSenderVerification that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/email_sender_verification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/email_sender_verification okta_email_sender_verification} Resource
  *
  * @param scope The scope in which to define this construct
