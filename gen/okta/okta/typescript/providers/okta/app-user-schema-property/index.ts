// https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property
...
export interface AppUserSchemaPropertyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#app_id AppUserSchemaProperty#app_id}
  */
  readonly appId: string;
  /**
  * Array of values that an array property's items can be set to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#array_enum AppUserSchemaProperty#array_enum}
  */
  readonly arrayEnum?: string[];
  /**
  * The type of the array elements if `type` is set to `array`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#array_type AppUserSchemaProperty#array_type}
  */
  readonly arrayType?: string;
  /**
  * The description of the user schema property.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#description AppUserSchemaProperty#description}
  */
  readonly description?: string;
  /**
  * Array of values a primitive property can be set to. See `array_enum` for arrays.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#enum AppUserSchemaProperty#enum}
  */
  readonly enum?: string[];
  /**
  * External name of the user schema property.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#external_name AppUserSchemaProperty#external_name}
  */
  readonly externalName?: string;
  /**
  * External namespace of the user schema property.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#external_namespace AppUserSchemaProperty#external_namespace}
  */
  readonly externalNamespace?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#id AppUserSchemaProperty#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#index AppUserSchemaProperty#index}
  */
  readonly index: string;
  /**
  * Master priority for the user schema property. It can be set to `PROFILE_MASTER` or `OKTA`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#master AppUserSchemaProperty#master}
  */
  readonly master?: string;
  /**
  * The maximum length of the user property value. Only applies to type `string`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#max_length AppUserSchemaProperty#max_length}
  */
  readonly maxLength?: number;
  /**
  * The minimum length of the user property value. Only applies to type `string`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#min_length AppUserSchemaProperty#min_length}
  */
  readonly minLength?: number;
  /**
  * Access control permissions for the property. It can be set to `READ_WRITE`, `READ_ONLY`, `HIDE`. Default: `READ_ONLY`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#permissions AppUserSchemaProperty#permissions}
  */
  readonly permissions?: string;
  /**
  * Whether the subschema is required
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#required AppUserSchemaProperty#required}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#scope AppUserSchemaProperty#scope}
  */
  readonly scope?: string;
  /**
  * Subschema title (display name)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#title AppUserSchemaProperty#title}
  */
  readonly title: string;
  /**
  * The type of the schema property. It can be `string`, `boolean`, `number`, `integer`, `array`, or `object`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#type AppUserSchemaProperty#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#union AppUserSchemaProperty#union}
  */
  readonly union?: boolean | cdktf.IResolvable;
  /**
  * Whether the property should be unique. It can be set to `UNIQUE_VALIDATED` or `NOT_UNIQUE`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#unique AppUserSchemaProperty#unique}
  */
  readonly unique?: string;
  /**
  * User type ID. By default, it is `default`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#user_type AppUserSchemaProperty#user_type}
  */
  readonly userType?: string;
  /**
  * array_one_of block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#array_one_of AppUserSchemaProperty#array_one_of}
  */
  readonly arrayOneOf?: AppUserSchemaPropertyArrayOneOf[] | cdktf.IResolvable;
  /**
  * one_of block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#one_of AppUserSchemaProperty#one_of}
  */
...
export interface AppUserSchemaPropertyArrayOneOf {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#const AppUserSchemaProperty#const}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property okta_app_user_schema_property}
*/
export class AppUserSchemaProperty extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppUserSchemaProperty that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/app_user_schema_property okta_app_user_schema_property} Resource
  *
  * @param scope The scope in which to define this construct
