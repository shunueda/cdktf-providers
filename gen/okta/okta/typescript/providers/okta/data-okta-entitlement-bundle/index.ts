// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/entitlement_bundle
...
export interface DataOktaEntitlementBundleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/entitlement_bundle#id DataOktaEntitlementBundle#id}
  *
  ...
  * entitlements block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/entitlement_bundle#entitlements DataOktaEntitlementBundle#entitlements}
  */
...
export interface DataOktaEntitlementBundleEntitlements {
  ...
  * values block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/entitlement_bundle#values DataOktaEntitlementBundle#values}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/entitlement_bundle okta_entitlement_bundle}
*/
export class DataOktaEntitlementBundle extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaEntitlementBundle that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/entitlement_bundle#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/entitlement_bundle okta_entitlement_bundle} Data Source
  *
  * @param scope The scope in which to define this construct
