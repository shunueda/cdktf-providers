// https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/app_metadata_saml
...
export interface DataOktaAppMetadataSamlConfig extends cdktf.TerraformMetaArguments {
  ...
  * The application ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/app_metadata_saml#app_id DataOktaAppMetadataSaml#app_id}
  */
  readonly appId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/app_metadata_saml#id DataOktaAppMetadataSaml#id}
  *
  ...
  * Certificate Key ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/app_metadata_saml#key_id DataOktaAppMetadataSaml#key_id}
  */
  readonly keyId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/app_metadata_saml okta_app_metadata_saml}
*/
export class DataOktaAppMetadataSaml extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAppMetadataSaml that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/app_metadata_saml#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/app_metadata_saml okta_app_metadata_saml} Data Source
  *
  * @param scope The scope in which to define this construct
