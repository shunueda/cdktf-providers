// https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource
...
export interface RequestSettingResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource#id RequestSettingResource#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource#request_on_behalf_of_settings RequestSettingResource#request_on_behalf_of_settings}
  */
  readonly requestOnBehalfOfSettings?: RequestSettingResourceRequestOnBehalfOfSettings;
  /**
  * risk_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource#risk_settings RequestSettingResource#risk_settings}
  */
...
export interface RequestSettingResourceRequestOnBehalfOfSettingsOnlyFor {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource#type RequestSettingResource#type}
  */
...
export interface RequestSettingResourceRequestOnBehalfOfSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource#allowed RequestSettingResource#allowed}
  */
  readonly allowed?: boolean | cdktf.IResolvable;
  /**
  * only_for block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource#only_for RequestSettingResource#only_for}
  */
...
export interface RequestSettingResourceRiskSettingsDefaultSettingAccessDurationSettings {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource#duration RequestSettingResource#duration}
  */
...
export interface RequestSettingResourceRiskSettingsDefaultSetting {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource#approval_sequence_id RequestSettingResource#approval_sequence_id}
  */
  readonly approvalSequenceId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource#request_submission_type RequestSettingResource#request_submission_type}
  */
  readonly requestSubmissionType?: string;
  /**
  * access_duration_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource#access_duration_settings RequestSettingResource#access_duration_settings}
  */
...
export interface RequestSettingResourceRiskSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource#default_setting RequestSettingResource#default_setting}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource okta_request_setting_resource}
*/
export class RequestSettingResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RequestSettingResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/request_setting_resource okta_request_setting_resource} Resource
  *
  * @param scope The scope in which to define this construct
