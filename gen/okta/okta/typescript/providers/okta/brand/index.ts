// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/brand
...
export interface BrandConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/brand#agree_to_custom_privacy_policy Brand#agree_to_custom_privacy_policy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/brand#brand_id Brand#brand_id}
  */
  readonly brandId?: string;
  /**
  * Custom privacy policy URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/brand#custom_privacy_policy_url Brand#custom_privacy_policy_url}
  */
  readonly customPrivacyPolicyUrl?: string;
  /**
  * Default app app instance id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/brand#default_app_app_instance_id Brand#default_app_app_instance_id}
  */
  readonly defaultAppAppInstanceId?: string;
  /**
  * Default app app link name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/brand#default_app_app_link_name Brand#default_app_app_link_name}
  */
  readonly defaultAppAppLinkName?: string;
  /**
  * Default app classic application uri
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/brand#default_app_classic_application_uri Brand#default_app_classic_application_uri}
  */
  readonly defaultAppClassicApplicationUri?: string;
  /**
  * The language specified as an IETF BCP 47 language tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/brand#locale Brand#locale}
  */
  readonly locale?: string;
  /**
  * Name of the brand
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/brand#name Brand#name}
  */
  readonly name: string;
  /**
  * Removes "Powered by Okta" from the Okta-hosted sign-in page and "© 2021 Okta, Inc." from the Okta End-User Dashboard
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/brand#remove_powered_by_okta Brand#remove_powered_by_okta}
  */
  readonly removePoweredByOkta?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/brand okta_brand}
*/
export class Brand extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Brand that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/brand#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/brand okta_brand} Resource
  *
  * @param scope The scope in which to define this construct
