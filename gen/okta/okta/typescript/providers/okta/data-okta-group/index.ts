// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/group
...
export interface DataOktaGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/group#delay_read_seconds DataOktaGroup#delay_read_seconds}
  */
  readonly delayReadSeconds?: string;
  /**
  * ID of group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/group#id DataOktaGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/group#include_users DataOktaGroup#include_users}
  */
  readonly includeUsers?: boolean | cdktf.IResolvable;
  /**
  * Name of group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/group#name DataOktaGroup#name}
  */
  readonly name?: string;
  /**
  * Type of the group. When specified in the terraform resource, will act as a filter when searching for the group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/group#type DataOktaGroup#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/group okta_group}
*/
export class DataOktaGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/group okta_group} Data Source
  *
  * @param scope The scope in which to define this construct
