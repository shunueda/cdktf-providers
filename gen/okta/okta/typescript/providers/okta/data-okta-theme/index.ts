// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/theme
...
export interface DataOktaThemeConfig extends cdktf.TerraformMetaArguments {
  ...
  * Brand ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/theme#brand_id DataOktaTheme#brand_id}
  */
  readonly brandId: string;
  /**
  * Theme ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/theme#theme_id DataOktaTheme#theme_id}
  */
  readonly themeId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/theme okta_theme}
*/
export class DataOktaTheme extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaTheme that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/theme#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/theme okta_theme} Data Source
  *
  * @param scope The scope in which to define this construct
