// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/push_provider
...
export interface DataOktaPushProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/push_provider#id DataOktaPushProvider#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/push_provider okta_push_provider}
*/
export class DataOktaPushProvider extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaPushProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/push_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/push_provider okta_push_provider} Data Source
  *
  * @param scope The scope in which to define this construct
