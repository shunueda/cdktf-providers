// https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/email_template_settings
...
export interface EmailTemplateSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  * The ID of the brand.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/email_template_settings#brand_id EmailTemplateSettings#brand_id}
  */
  readonly brandId: string;
  /**
  * The recipients the emails of this template will be sent to - Valid values: `ALL_USERS`, `ADMINS_ONLY`, `NO_USERS`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/email_template_settings#recipients EmailTemplateSettings#recipients}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/email_template_settings#template_name EmailTemplateSettings#template_name}
  */
  readonly templateName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/email_template_settings okta_email_template_settings}
*/
export class EmailTemplateSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailTemplateSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/email_template_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/resources/email_template_settings okta_email_template_settings} Resource
  *
  * @param scope The scope in which to define this construct
