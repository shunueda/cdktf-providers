// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/org_metadata
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/org_metadata okta_org_metadata}
*/
export class DataOktaOrgMetadata extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaOrgMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/org_metadata#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/org_metadata okta_org_metadata} Data Source
  *
  * @param scope The scope in which to define this construct
