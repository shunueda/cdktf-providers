// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users
...
export interface DataOktaUsersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users#compound_search_operator DataOktaUsers#compound_search_operator}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users#delay_read_seconds DataOktaUsers#delay_read_seconds}
  */
  readonly delayReadSeconds?: string;
  /**
  * Find users based on group membership using the id of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users#group_id DataOktaUsers#group_id}
  */
  readonly groupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users#id DataOktaUsers#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users#include_groups DataOktaUsers#include_groups}
  */
  readonly includeGroups?: boolean | cdktf.IResolvable;
  /**
  * Fetch user roles for each user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users#include_roles DataOktaUsers#include_roles}
  */
  readonly includeRoles?: boolean | cdktf.IResolvable;
  /**
  * search block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users#search DataOktaUsers#search}
  */
...
export interface DataOktaUsersSearch {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users#comparison DataOktaUsers#comparison}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users#expression DataOktaUsers#expression}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users#name DataOktaUsers#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users#value DataOktaUsers#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users okta_users}
*/
export class DataOktaUsers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/users okta_users} Data Source
  *
  * @param scope The scope in which to define this construct
