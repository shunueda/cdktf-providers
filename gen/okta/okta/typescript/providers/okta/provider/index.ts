// https://registry.terraform.io/providers/okta/okta/6.4.0/docs
...
export interface OktaProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#access_token OktaProvider#access_token}
  */
  readonly accessToken?: string;
  /**
  * API Token granting privileges to Okta API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#api_token OktaProvider#api_token}
  */
  readonly apiToken?: string;
  /**
  * Use exponential back off strategy for rate limits.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#backoff OktaProvider#backoff}
  */
  readonly backoff?: boolean | cdktf.IResolvable;
  /**
  * The Okta url. (Use 'oktapreview.com' for Okta testing)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#base_url OktaProvider#base_url}
  */
  readonly baseUrl?: string;
  /**
  * API Token granting privileges to Okta API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#client_id OktaProvider#client_id}
  */
  readonly clientId?: string;
  /**
  * Alternate HTTP proxy of scheme://hostname or scheme://hostname:port format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#http_proxy OktaProvider#http_proxy}
  */
  readonly httpProxy?: string;
  /**
  * providers log level. Minimum is 1 (TRACE), and maximum is 5 (ERROR)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#log_level OktaProvider#log_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#max_api_capacity OktaProvider#max_api_capacity}
  */
  readonly maxApiCapacity?: number;
  /**
  * maximum number of retries to attempt before erroring out.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#max_retries OktaProvider#max_retries}
  */
  readonly maxRetries?: number;
  /**
  * maximum seconds to wait when rate limit is hit. We use exponential backoffs when backoff is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#max_wait_seconds OktaProvider#max_wait_seconds}
  */
  readonly maxWaitSeconds?: number;
  /**
  * minimum seconds to wait when rate limit is hit. We use exponential backoffs when backoff is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#min_wait_seconds OktaProvider#min_wait_seconds}
  */
  readonly minWaitSeconds?: number;
  /**
  * The organization to manage in Okta.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#org_name OktaProvider#org_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#parallelism OktaProvider#parallelism}
  */
  readonly parallelism?: number;
  /**
  * API Token granting privileges to Okta API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#private_key OktaProvider#private_key}
  */
  readonly privateKey?: string;
  /**
  * API Token Id granting privileges to Okta API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#private_key_id OktaProvider#private_key_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#request_timeout OktaProvider#request_timeout}
  */
  readonly requestTimeout?: number;
  /**
  * API Token granting privileges to Okta API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#scopes OktaProvider#scopes}
  */
  readonly scopes?: string[];
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#alias OktaProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs okta}
*/
export class OktaProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing OktaProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs okta} Resource
  *
  * @param scope The scope in which to define this construct
