// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/device
...
export interface DeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/device#action Device#action}
  */
  readonly action?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/device okta_device}
*/
export class Device extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Device that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/device okta_device} Resource
  *
  * @param scope The scope in which to define this construct
