// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/realm_assignment
...
export interface RealmAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/realm_assignment#condition_expression RealmAssignment#condition_expression}
  */
  readonly conditionExpression?: string;
  /**
  * The name of the Okta Realm Assignment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/realm_assignment#name RealmAssignment#name}
  */
  readonly name: string;
  /**
  * The Priority of the Realm Assignment. The lower the number, the higher the priority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/realm_assignment#priority RealmAssignment#priority}
  */
  readonly priority?: number;
  /**
  * The ID of the Profile Source.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/realm_assignment#profile_source_id RealmAssignment#profile_source_id}
  */
  readonly profileSourceId: string;
  /**
  * The ID of the Realm asscociated with the Realm Assignment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/realm_assignment#realm_id RealmAssignment#realm_id}
  */
  readonly realmId: string;
  /**
  * Defines whether the Realm Assignment is active or not. Valid values: `ACTIVE` and `INACTIVE`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/realm_assignment#status RealmAssignment#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/realm_assignment okta_realm_assignment}
*/
export class RealmAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RealmAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/realm_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/resources/realm_assignment okta_realm_assignment} Resource
  *
  * @param scope The scope in which to define this construct
