// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/apps
...
export interface DataOktaAppsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/apps#active_only DataOktaApps#active_only}
  */
  readonly activeOnly?: boolean | cdktf.IResolvable;
  /**
  * Specifies whether to include non-active, but not deleted apps in the results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/apps#include_non_deleted DataOktaApps#include_non_deleted}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/apps#label DataOktaApps#label}
  */
  readonly label?: string;
  /**
  * Searches for applications whose label or name property begins with this value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/apps#label_prefix DataOktaApps#label_prefix}
  */
  readonly labelPrefix?: string;
  /**
  * Searches for applications whose name or label properties that starts with this value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/apps#q DataOktaApps#q}
  */
  readonly q?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/apps#use_optimization DataOktaApps#use_optimization}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/apps okta_apps}
*/
export class DataOktaApps extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaApps that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/apps#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/apps okta_apps} Data Source
  *
  * @param scope The scope in which to define this construct
