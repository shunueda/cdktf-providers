// https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/idp_metadata_saml
...
export interface DataOktaIdpMetadataSamlConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/idp_metadata_saml#id DataOktaIdpMetadataSaml#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/idp_metadata_saml#idp_id DataOktaIdpMetadataSaml#idp_id}
  */
  readonly idpId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/idp_metadata_saml okta_idp_metadata_saml}
*/
export class DataOktaIdpMetadataSaml extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaIdpMetadataSaml that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/idp_metadata_saml#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/idp_metadata_saml okta_idp_metadata_saml} Data Source
  *
  * @param scope The scope in which to define this construct
