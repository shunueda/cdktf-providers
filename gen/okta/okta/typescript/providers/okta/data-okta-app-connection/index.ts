// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_connection
...
export interface DataOktaAppConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_connection#auth_scheme DataOktaAppConnection#auth_scheme}
  */
  readonly authScheme?: string;
  /**
  * The base URL for the provisioning connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_connection#base_url DataOktaAppConnection#base_url}
  */
  readonly baseUrl?: string;
  /**
  * The application ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_connection#id DataOktaAppConnection#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_connection okta_app_connection}
*/
export class DataOktaAppConnection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAppConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_connection okta_app_connection} Data Source
  *
  * @param scope The scope in which to define this construct
