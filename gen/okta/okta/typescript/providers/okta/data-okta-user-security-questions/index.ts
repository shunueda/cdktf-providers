// https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/user_security_questions
...
export interface DataOktaUserSecurityQuestionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/user_security_questions#id DataOktaUserSecurityQuestions#id}
  *
  ...
  * ID of a Okta User
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/user_security_questions#user_id DataOktaUserSecurityQuestions#user_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/user_security_questions okta_user_security_questions}
*/
export class DataOktaUserSecurityQuestions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaUserSecurityQuestions that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/user_security_questions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.1/docs/data-sources/user_security_questions okta_user_security_questions} Data Source
  *
  * @param scope The scope in which to define this construct
