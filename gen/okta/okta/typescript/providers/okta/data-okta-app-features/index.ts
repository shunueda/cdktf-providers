// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_features
...
export interface DataOktaAppFeaturesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_features#app_id DataOktaAppFeatures#app_id}
  */
  readonly appId: string;
  /**
  * Key name of the feature.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_features#name DataOktaAppFeatures#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_features okta_app_features}
*/
export class DataOktaAppFeatures extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaAppFeatures that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_features#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/app_features okta_app_features} Data Source
  *
  * @param scope The scope in which to define this construct
