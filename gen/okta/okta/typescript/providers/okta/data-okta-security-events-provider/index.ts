// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/security_events_provider
...
export interface DataOktaSecurityEventsProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/security_events_provider#id DataOktaSecurityEventsProvider#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/security_events_provider okta_security_events_provider}
*/
export class DataOktaSecurityEventsProvider extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaSecurityEventsProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/security_events_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/security_events_provider okta_security_events_provider} Data Source
  *
  * @param scope The scope in which to define this construct
