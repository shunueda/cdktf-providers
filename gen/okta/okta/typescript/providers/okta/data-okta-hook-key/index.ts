// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/hook_key
...
export interface DataOktaHookKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/hook_key#id DataOktaHookKey#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/hook_key okta_hook_key}
*/
export class DataOktaHookKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaHookKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/hook_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/data-sources/hook_key okta_hook_key} Data Source
  *
  * @param scope The scope in which to define this construct
