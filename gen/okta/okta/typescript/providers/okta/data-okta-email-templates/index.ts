// https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/email_templates
...
export interface DataOktaEmailTemplatesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Brand ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/email_templates#brand_id DataOktaEmailTemplates#brand_id}
  */
  readonly brandId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/email_templates#id DataOktaEmailTemplates#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/email_templates okta_email_templates}
*/
export class DataOktaEmailTemplates extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaEmailTemplates that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/email_templates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.4.0/docs/data-sources/email_templates okta_email_templates} Data Source
  *
  * @param scope The scope in which to define this construct
