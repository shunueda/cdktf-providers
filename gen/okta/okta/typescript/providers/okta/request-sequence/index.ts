// https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/request_sequence
...
export interface RequestSequenceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/request_sequence#id RequestSequence#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/request_sequence#resource_id RequestSequence#resource_id}
  */
  readonly resourceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/request_sequence okta_request_sequence}
*/
export class RequestSequence extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RequestSequence that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/request_sequence#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.2/docs/resources/request_sequence okta_request_sequence} Resource
  *
  * @param scope The scope in which to define this construct
