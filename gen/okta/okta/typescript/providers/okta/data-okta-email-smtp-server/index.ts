// https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/email_smtp_server
...
export interface DataOktaEmailSmtpServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/email_smtp_server#id DataOktaEmailSmtpServer#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/email_smtp_server okta_email_smtp_server}
*/
export class DataOktaEmailSmtpServer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOktaEmailSmtpServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/email_smtp_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/okta/6.5.0/docs/data-sources/email_smtp_server okta_email_smtp_server} Data Source
  *
  * @param scope The scope in which to define this construct
