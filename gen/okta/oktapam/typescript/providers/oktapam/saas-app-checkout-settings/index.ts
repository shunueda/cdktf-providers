// https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/saas_app_checkout_settings
...
export interface SaasAppCheckoutSettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/saas_app_checkout_settings#checkout_duration_in_seconds SaasAppCheckoutSettings#checkout_duration_in_seconds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/saas_app_checkout_settings#checkout_required SaasAppCheckoutSettings#checkout_required}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/saas_app_checkout_settings#exclude_list SaasAppCheckoutSettings#exclude_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/saas_app_checkout_settings#include_list SaasAppCheckoutSettings#include_list}
  */
  readonly includeList?: string[];
  /**
  * The UUID of a Project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/saas_app_checkout_settings#project SaasAppCheckoutSettings#project}
  */
  readonly project: string;
  /**
  * The UUID of a OktaPA Resource Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/saas_app_checkout_settings#resource_group SaasAppCheckoutSettings#resource_group}
  */
  readonly resourceGroup: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/saas_app_checkout_settings oktapam_saas_app_checkout_settings}
*/
export class SaasAppCheckoutSettings extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "oktapam_saas_app_checkout_settings";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a SaasAppCheckoutSettings resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the SaasAppCheckoutSettings to import
  * @param importFromId The id of the existing SaasAppCheckoutSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/saas_app_checkout_settings#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SaasAppCheckoutSettings to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "oktapam_saas_app_checkout_settings", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/saas_app_checkout_settings oktapam_saas_app_checkout_settings} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options SaasAppCheckoutSettingsConfig
  */
  public constructor(scope: Construct, id: string, config: SaasAppCheckoutSettingsConfig) {
    super(scope, id, {
      terraformResourceType: 'oktapam_saas_app_checkout_settings',
