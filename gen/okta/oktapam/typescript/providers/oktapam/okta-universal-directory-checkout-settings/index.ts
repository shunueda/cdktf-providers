// https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/okta_universal_directory_checkout_settings
...
export interface OktaUniversalDirectoryCheckoutSettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/okta_universal_directory_checkout_settings#checkout_duration_in_seconds OktaUniversalDirectoryCheckoutSettings#checkout_duration_in_seconds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/okta_universal_directory_checkout_settings#checkout_required OktaUniversalDirectoryCheckoutSettings#checkout_required}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/okta_universal_directory_checkout_settings#exclude_list OktaUniversalDirectoryCheckoutSettings#exclude_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/okta_universal_directory_checkout_settings#include_list OktaUniversalDirectoryCheckoutSettings#include_list}
  */
  readonly includeList?: string[];
  /**
  * The UUID of a Project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/okta_universal_directory_checkout_settings#project OktaUniversalDirectoryCheckoutSettings#project}
  */
  readonly project: string;
  /**
  * The UUID of a OktaPA Resource Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/okta_universal_directory_checkout_settings#resource_group OktaUniversalDirectoryCheckoutSettings#resource_group}
  */
  readonly resourceGroup: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/okta_universal_directory_checkout_settings oktapam_okta_universal_directory_checkout_settings}
*/
export class OktaUniversalDirectoryCheckoutSettings extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "oktapam_okta_universal_directory_checkout_settings";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a OktaUniversalDirectoryCheckoutSettings resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the OktaUniversalDirectoryCheckoutSettings to import
  * @param importFromId The id of the existing OktaUniversalDirectoryCheckoutSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/okta_universal_directory_checkout_settings#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the OktaUniversalDirectoryCheckoutSettings to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "oktapam_okta_universal_directory_checkout_settings", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/okta_universal_directory_checkout_settings oktapam_okta_universal_directory_checkout_settings} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options OktaUniversalDirectoryCheckoutSettingsConfig
  */
  public constructor(scope: Construct, id: string, config: OktaUniversalDirectoryCheckoutSettingsConfig) {
    super(scope, id, {
      terraformResourceType: 'oktapam_okta_universal_directory_checkout_settings',
