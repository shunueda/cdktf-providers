// https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings
...
export interface DatabasePasswordSettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings#enable_periodic_rotation DatabasePasswordSettings#enable_periodic_rotation}
  */
  readonly enablePeriodicRotation: boolean | cdktf.IResolvable;
  /**
  * The maximum length allowed for the password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings#max_length DatabasePasswordSettings#max_length}
  */
  readonly maxLength: number;
  /**
  * The minimum length allowed for the password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings#min_length DatabasePasswordSettings#min_length}
  */
  readonly minLength: number;
  /**
  * If `periodic_rotation` is enabled, specifies how often passwords are rotated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings#periodic_rotation_duration_in_seconds DatabasePasswordSettings#periodic_rotation_duration_in_seconds}
  */
  readonly periodicRotationDurationInSeconds?: number;
  /**
  * The UUID of a Project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings#project DatabasePasswordSettings#project}
  */
  readonly project: string;
  /**
  * The UUID of a OktaPA Resource Group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings#resource_group DatabasePasswordSettings#resource_group}
  */
  readonly resourceGroup: string;
  /**
  * character_options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings#character_options DatabasePasswordSettings#character_options}
  */
  readonly characterOptions: DatabasePasswordSettingsCharacterOptions;
}
export interface DatabasePasswordSettingsCharacterOptions {
  /**
  * If `true`, passwords can include one or more numeric characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings#digits DatabasePasswordSettings#digits}
  */
  readonly digits?: boolean | cdktf.IResolvable;
  /**
  * If `true`, passwords can include one or more lowercase characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings#lower_case DatabasePasswordSettings#lower_case}
  */
  readonly lowerCase?: boolean | cdktf.IResolvable;
  /**
  * If `true`, passwords can include one or more punctuation/symbol characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings#punctuation DatabasePasswordSettings#punctuation}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings#require_from_each_set DatabasePasswordSettings#require_from_each_set}
  */
  readonly requireFromEachSet?: boolean | cdktf.IResolvable;
  /**
  * If `true`, passwords can include one or more uppercase characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings#upper_case DatabasePasswordSettings#upper_case}
  */
  readonly upperCase?: boolean | cdktf.IResolvable;
}

export function databasePasswordSettingsCharacterOptionsToTerraform(struct?: DatabasePasswordSettingsCharacterOptionsOutputReference | DatabasePasswordSettingsCharacterOptions): any {
...
export function databasePasswordSettingsCharacterOptionsToHclTerraform(struct?: DatabasePasswordSettingsCharacterOptionsOutputReference | DatabasePasswordSettingsCharacterOptions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DatabasePasswordSettingsCharacterOptionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DatabasePasswordSettingsCharacterOptions | undefined {
  ...
  public set internalValue(value: DatabasePasswordSettingsCharacterOptions | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings oktapam_database_password_settings}
*/
export class DatabasePasswordSettings extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DatabasePasswordSettings resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DatabasePasswordSettings to import
  * @param importFromId The id of the existing DatabasePasswordSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DatabasePasswordSettings to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/okta/oktapam/0.6.2/docs/resources/database_password_settings oktapam_database_password_settings} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DatabasePasswordSettingsConfig
  */
  public constructor(scope: Construct, id: string, config: DatabasePasswordSettingsConfig) {
    super(scope, id, {
  ...
  private _characterOptions = new DatabasePasswordSettingsCharacterOptionsOutputReference(this, "character_options");
  public get characterOptions() {
    return this._characterOptions;
  }
  public putCharacterOptions(value: DatabasePasswordSettingsCharacterOptions) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      character_options: databasePasswordSettingsCharacterOptionsToTerraform(this._characterOptions.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      character_options: {
        value: databasePasswordSettingsCharacterOptionsToHclTerraform(this._characterOptions.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DatabasePasswordSettingsCharacterOptionsList",
      },
    };
