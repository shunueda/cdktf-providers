// https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check
...
export interface ComplianceCheckConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#azure_policy_id ComplianceCheck#azure_policy_id}
  */
  readonly azurePolicyId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#body ComplianceCheck#body}
  */
  readonly body?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#cloud_provider_id ComplianceCheck#cloud_provider_id}
  */
  readonly cloudProviderId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#compliance_check_type_id ComplianceCheck#compliance_check_type_id}
  */
  readonly complianceCheckTypeId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#created_by_user_id ComplianceCheck#created_by_user_id}
  */
  readonly createdByUserId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#description ComplianceCheck#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#frequency_minutes ComplianceCheck#frequency_minutes}
  */
  readonly frequencyMinutes?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#frequency_type_id ComplianceCheck#frequency_type_id}
  */
  readonly frequencyTypeId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#id ComplianceCheck#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#is_all_regions ComplianceCheck#is_all_regions}
  */
  readonly isAllRegions?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#is_auto_archived ComplianceCheck#is_auto_archived}
  */
  readonly isAutoArchived?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#last_updated ComplianceCheck#last_updated}
  */
  readonly lastUpdated?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#name ComplianceCheck#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#regions ComplianceCheck#regions}
  */
  readonly regions?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#severity_type_id ComplianceCheck#severity_type_id}
  */
  readonly severityTypeId?: number;
  /**
  * owner_user_groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#owner_user_groups ComplianceCheck#owner_user_groups}
  */
  readonly ownerUserGroups?: ComplianceCheckOwnerUserGroups[] | cdktf.IResolvable;
  /**
  * owner_users block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#owner_users ComplianceCheck#owner_users}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check cloudtamerio_compliance_check}
*/
export class ComplianceCheck extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cloudtamerio_compliance_check";
  ...
  * @param importFromId The id of the existing ComplianceCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ComplianceCheck to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "cloudtamerio_compliance_check", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudtamer-io/cloudtamerio/0.2.0/docs/resources/compliance_check cloudtamerio_compliance_check} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ComplianceCheckConfig) {
    super(scope, id, {
      terraformResourceType: 'cloudtamerio_compliance_check',
  ...
  private _ownerUserGroups = new ComplianceCheckOwnerUserGroupsList(this, "owner_user_groups", false);
  ...
  private _ownerUsers = new ComplianceCheckOwnerUsersList(this, "owner_users", false);
