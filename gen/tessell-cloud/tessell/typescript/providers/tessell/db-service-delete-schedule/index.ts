// https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/resources/db_service_delete_schedule
...
export interface DbServiceDeleteScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/resources/db_service_delete_schedule#delete_at DbServiceDeleteSchedule#delete_at}
  */
  readonly deleteAt: string;
  /**
  * The ID of the DB Service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/resources/db_service_delete_schedule#service_id DbServiceDeleteSchedule#service_id}
  */
  readonly serviceId: string;
  /**
  * deletion_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/resources/db_service_delete_schedule#deletion_config DbServiceDeleteSchedule#deletion_config}
  */
...
export interface DbServiceDeleteScheduleDeletionConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/resources/db_service_delete_schedule#retain_availability_machine DbServiceDeleteSchedule#retain_availability_machine}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/resources/db_service_delete_schedule tessell_db_service_delete_schedule}
*/
export class DbServiceDeleteSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbServiceDeleteSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/resources/db_service_delete_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/resources/db_service_delete_schedule tessell_db_service_delete_schedule} Resource
  *
  * @param scope The scope in which to define this construct
