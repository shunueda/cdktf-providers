// https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.27/docs/data-sources/sanitized_db_snapshots
...
export interface DataTessellSanitizedDbSnapshotsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.27/docs/data-sources/sanitized_db_snapshots#availability_machine_id DataTessellSanitizedDbSnapshots#availability_machine_id}
  */
  readonly availabilityMachineId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.27/docs/data-sources/sanitized_db_snapshots#id DataTessellSanitizedDbSnapshots#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.27/docs/data-sources/sanitized_db_snapshots#manual DataTessellSanitizedDbSnapshots#manual}
  */
  readonly manual?: boolean | cdktf.IResolvable;
  /**
  * Name of the DB Snapshot to filter with
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.27/docs/data-sources/sanitized_db_snapshots#name DataTessellSanitizedDbSnapshots#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.27/docs/data-sources/sanitized_db_snapshots tessell_sanitized_db_snapshots}
*/
export class DataTessellSanitizedDbSnapshots extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTessellSanitizedDbSnapshots that should be imported. Refer to the {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.27/docs/data-sources/sanitized_db_snapshots#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.27/docs/data-sources/sanitized_db_snapshots tessell_sanitized_db_snapshots} Data Source
  *
  * @param scope The scope in which to define this construct
