// https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/data-sources/dataflix
...
export interface DataTessellDataflixConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/data-sources/dataflix#availability_machine_id DataTessellDataflix#availability_machine_id}
  */
  readonly availabilityMachineId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/data-sources/dataflix#id DataTessellDataflix#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/data-sources/dataflix tessell_dataflix}
*/
export class DataTessellDataflix extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTessellDataflix that should be imported. Refer to the {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/data-sources/dataflix#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/data-sources/dataflix tessell_dataflix} Data Source
  *
  * @param scope The scope in which to define this construct
