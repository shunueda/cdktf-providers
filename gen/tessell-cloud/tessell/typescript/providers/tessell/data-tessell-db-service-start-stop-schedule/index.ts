// https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.27/docs/data-sources/db_service_start_stop_schedule
...
export interface DataTessellDbServiceStartStopScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.27/docs/data-sources/db_service_start_stop_schedule#id DataTessellDbServiceStartStopSchedule#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.27/docs/data-sources/db_service_start_stop_schedule tessell_db_service_start_stop_schedule}
*/
export class DataTessellDbServiceStartStopSchedule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTessellDbServiceStartStopSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.27/docs/data-sources/db_service_start_stop_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.27/docs/data-sources/db_service_start_stop_schedule tessell_db_service_start_stop_schedule} Data Source
  *
  * @param scope The scope in which to define this construct
