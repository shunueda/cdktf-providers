// https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/data-sources/db_backups
...
export interface DataTessellDbBackupsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/data-sources/db_backups#availability_machine_id DataTessellDbBackups#availability_machine_id}
  */
  readonly availabilityMachineId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/data-sources/db_backups#id DataTessellDbBackups#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/data-sources/db_backups#manual DataTessellDbBackups#manual}
  */
  readonly manual?: boolean | cdktf.IResolvable;
  /**
  * Name of the DB Snapshot to filter with
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/data-sources/db_backups#name DataTessellDbBackups#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/data-sources/db_backups tessell_db_backups}
*/
export class DataTessellDbBackups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTessellDbBackups that should be imported. Refer to the {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/data-sources/db_backups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs/data-sources/db_backups tessell_db_backups} Data Source
  *
  * @param scope The scope in which to define this construct
