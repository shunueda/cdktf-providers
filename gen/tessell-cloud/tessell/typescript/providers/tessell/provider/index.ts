// https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs
...
export interface TessellProviderConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs#api_address TessellProvider#api_address}
  */
  readonly apiAddress: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs#api_key TessellProvider#api_key}
  */
  readonly apiKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs#tenant_id TessellProvider#tenant_id}
  */
  readonly tenantId: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs#alias TessellProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs tessell}
*/
export class TessellProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing TessellProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tessell-cloud/tessell/0.0.29/docs tessell} Resource
  *
  * @param scope The scope in which to define this construct
