// https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route
...
export interface DomainRouteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route#domain_link DomainRoute#domain_link}
  */
  readonly domainLink: string;
  /**
  * The port the route corresponds to. Default: 443
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route#domain_port DomainRoute#domain_port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route#host_prefix DomainRoute#host_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route#host_regex DomainRoute#host_regex}
  */
  readonly hostRegex?: string;
  /**
  * For the linked workload, the port to route traffic to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route#port DomainRoute#port}
  */
  readonly port?: number;
  /**
  * The path will match any unmatched path prefixes for the subdomain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route#prefix DomainRoute#prefix}
  */
  readonly prefix?: string;
  /**
  * Used to match URI paths. Uses the google re2 regex syntax.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route#regex DomainRoute#regex}
  */
  readonly regex?: string;
  /**
  * A path prefix can be configured to be replaced when forwarding the request to the Workload.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route#replace_prefix DomainRoute#replace_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route#replica DomainRoute#replica}
  */
  readonly replica?: number;
  /**
  * The link of the workload to map the prefix to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route#workload_link DomainRoute#workload_link}
  */
  readonly workloadLink: string;
  /**
  * headers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route#headers DomainRoute#headers}
  */
...
export interface DomainRouteHeadersRequest {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route#set DomainRoute#set}
  */
...
export interface DomainRouteHeaders {
  ...
  * request block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route#request DomainRoute#request}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route cpln_domain_route}
*/
export class DomainRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DomainRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.19/docs/resources/domain_route cpln_domain_route} Resource
  *
  * @param scope The scope in which to define this construct
