// https://registry.terraform.io/providers/controlplane-com/cpln/1.2.14/docs/data-sources/location
...
export interface DataCplnLocationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.14/docs/data-sources/location#name DataCplnLocation#name}
  */
  readonly name: string;
  /**
  * Key-value map of resource tags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.14/docs/data-sources/location#tags DataCplnLocation#tags}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.14/docs/data-sources/location cpln_location}
*/
export class DataCplnLocation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCplnLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.14/docs/data-sources/location#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.14/docs/data-sources/location cpln_location} Data Source
  *
  * @param scope The scope in which to define this construct
