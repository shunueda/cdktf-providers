// https://registry.terraform.io/providers/controlplane-com/cpln/1.2.14/docs/data-sources/cloud_account
...
/**
* Represents a {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.14/docs/data-sources/cloud_account cpln_cloud_account}
*/
export class DataCplnCloudAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCplnCloudAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.14/docs/data-sources/cloud_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.14/docs/data-sources/cloud_account cpln_cloud_account} Data Source
  *
  * @param scope The scope in which to define this construct
