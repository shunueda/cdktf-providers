// https://registry.terraform.io/providers/controlplane-com/cpln/1.2.17/docs/resources/service_account_key
...
export interface ServiceAccountKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.17/docs/resources/service_account_key#description ServiceAccountKey#description}
  */
  readonly description: string;
  /**
  * The name of an existing Service Account this key will belong to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.17/docs/resources/service_account_key#service_account_name ServiceAccountKey#service_account_name}
  */
  readonly serviceAccountName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.17/docs/resources/service_account_key cpln_service_account_key}
*/
export class ServiceAccountKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccountKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.17/docs/resources/service_account_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/controlplane-com/cpln/1.2.17/docs/resources/service_account_key cpln_service_account_key} Resource
  *
  * @param scope The scope in which to define this construct
