// https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/resources/cloud_user_project_assignment
...
export interface CloudUserProjectAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/resources/cloud_user_project_assignment#project_id CloudUserProjectAssignment#project_id}
  */
  readonly projectId: string;
  /**
  * One or more project-level roles to assign the MongoDB Cloud user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/resources/cloud_user_project_assignment#roles CloudUserProjectAssignment#roles}
  */
  readonly roles: string[];
  /**
  * Email address that represents the username of the MongoDB Cloud user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/resources/cloud_user_project_assignment#username CloudUserProjectAssignment#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/resources/cloud_user_project_assignment mongodbatlas_cloud_user_project_assignment}
*/
export class CloudUserProjectAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudUserProjectAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/resources/cloud_user_project_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/resources/cloud_user_project_assignment mongodbatlas_cloud_user_project_assignment} Resource
  *
  * @param scope The scope in which to define this construct
