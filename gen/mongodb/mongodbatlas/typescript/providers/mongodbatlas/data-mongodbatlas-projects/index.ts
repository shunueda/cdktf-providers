// https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/projects
...
export interface DataMongodbatlasProjectsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/projects#items_per_page DataMongodbatlasProjects#items_per_page}
  */
  readonly itemsPerPage?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/projects#page_num DataMongodbatlasProjects#page_num}
  */
...
export interface DataMongodbatlasProjectsResultsUsers {
}

export function dataMongodbatlasProjectsResultsUsersToTerraform(struct?: DataMongodbatlasProjectsResultsUsers): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataMongodbatlasProjectsResultsUsersToHclTerraform(struct?: DataMongodbatlasProjectsResultsUsers): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataMongodbatlasProjectsResultsUsersOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataMongodbatlasProjectsResultsUsers | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataMongodbatlasProjectsResultsUsers | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataMongodbatlasProjectsResultsUsersList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataMongodbatlasProjectsResultsUsersOutputReference {
    return new DataMongodbatlasProjectsResultsUsersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataMongodbatlasProjectsResults {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/projects#name DataMongodbatlasProjects#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/projects#project_id DataMongodbatlasProjects#project_id}
  */
...
export class DataMongodbatlasProjectsResultsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _users = new DataMongodbatlasProjectsResultsUsersList(this, "users", false);
  public get users() {
    return this._users;
  }
}
...
export class DataMongodbatlasProjectsResultsList extends cdktf.ComplexList {
  public internalValue? : DataMongodbatlasProjectsResults[] | cdktf.IResolvable
...
/**
* Represents a {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/projects mongodbatlas_projects}
*/
export class DataMongodbatlasProjects extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMongodbatlasProjects that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/projects#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/projects mongodbatlas_projects} Data Source
  *
  * @param scope The scope in which to define this construct
