// https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/api_key
...
export interface DataMongodbatlasApiKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/api_key#api_key_id DataMongodbatlasApiKey#api_key_id}
  */
  readonly apiKeyId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/api_key#id DataMongodbatlasApiKey#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/api_key#org_id DataMongodbatlasApiKey#org_id}
  */
  readonly orgId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/api_key mongodbatlas_api_key}
*/
export class DataMongodbatlasApiKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMongodbatlasApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/api_key mongodbatlas_api_key} Data Source
  *
  * @param scope The scope in which to define this construct
