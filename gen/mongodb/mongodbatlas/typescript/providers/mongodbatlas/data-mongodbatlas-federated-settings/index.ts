// https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/data-sources/federated_settings
...
export interface DataMongodbatlasFederatedSettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/data-sources/federated_settings#org_id DataMongodbatlasFederatedSettings#org_id}
  */
  readonly orgId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/data-sources/federated_settings mongodbatlas_federated_settings}
*/
export class DataMongodbatlasFederatedSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMongodbatlasFederatedSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/data-sources/federated_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/data-sources/federated_settings mongodbatlas_federated_settings} Data Source
  *
  * @param scope The scope in which to define this construct
