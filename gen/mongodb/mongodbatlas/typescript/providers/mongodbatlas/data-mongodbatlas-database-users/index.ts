// https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/database_users
...
export interface DataMongodbatlasDatabaseUsersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/database_users#project_id DataMongodbatlasDatabaseUsers#project_id}
  */
...
export function dataMongodbatlasDatabaseUsersResultsLabelsToHclTerraform(struct?: DataMongodbatlasDatabaseUsersResultsLabels): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataMongodbatlasDatabaseUsersResultsRolesToHclTerraform(struct?: DataMongodbatlasDatabaseUsersResultsRoles): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataMongodbatlasDatabaseUsersResultsScopesToHclTerraform(struct?: DataMongodbatlasDatabaseUsersResultsScopes): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataMongodbatlasDatabaseUsersResultsToHclTerraform(struct?: DataMongodbatlasDatabaseUsersResults): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataMongodbatlasDatabaseUsersResultsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _roles = new DataMongodbatlasDatabaseUsersResultsRolesList(this, "roles", true);
  public get roles() {
    return this._roles;
  }

  // scopes - computed: true, optional: false, required: false
  private _scopes = new DataMongodbatlasDatabaseUsersResultsScopesList(this, "scopes", true);
  public get scopes() {
    return this._scopes;
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/database_users mongodbatlas_database_users}
*/
export class DataMongodbatlasDatabaseUsers extends cdktf.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataMongodbatlasDatabaseUsers to import
  * @param importFromId The id of the existing DataMongodbatlasDatabaseUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/database_users#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "mongodbatlas_database_users", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.3.0/docs/data-sources/database_users mongodbatlas_database_users} Data Source
  *
  * @param scope The scope in which to define this construct
