// https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/data-sources/network_container
...
export interface DataMongodbatlasNetworkContainerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/data-sources/network_container#container_id DataMongodbatlasNetworkContainer#container_id}
  */
  readonly containerId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/data-sources/network_container#id DataMongodbatlasNetworkContainer#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/data-sources/network_container#project_id DataMongodbatlasNetworkContainer#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/data-sources/network_container mongodbatlas_network_container}
*/
export class DataMongodbatlasNetworkContainer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMongodbatlasNetworkContainer that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/data-sources/network_container#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/2.1.0/docs/data-sources/network_container mongodbatlas_network_container} Data Source
  *
  * @param scope The scope in which to define this construct
