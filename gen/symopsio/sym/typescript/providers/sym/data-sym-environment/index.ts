// https://registry.terraform.io/providers/symopsio/sym/3.6.0/docs/data-sources/environment
...
export interface DataSymEnvironmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * The ID of the Error Logger
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/symopsio/sym/3.6.0/docs/data-sources/environment#error_logger_id DataSymEnvironment#error_logger_id}
  */
  readonly errorLoggerId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/symopsio/sym/3.6.0/docs/data-sources/environment#id DataSymEnvironment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/symopsio/sym/3.6.0/docs/data-sources/environment#integrations DataSymEnvironment#integrations}
  */
  readonly integrations?: { [key: string]: string };
  /**
  * An optional label for the Environment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/symopsio/sym/3.6.0/docs/data-sources/environment#label DataSymEnvironment#label}
  */
  readonly label?: string;
  /**
  * IDs for each Log Destination to funnel logs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/symopsio/sym/3.6.0/docs/data-sources/environment#log_destination_ids DataSymEnvironment#log_destination_ids}
  */
  readonly logDestinationIds?: string[];
  /**
  * The unique identifier for the Environment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/symopsio/sym/3.6.0/docs/data-sources/environment#name DataSymEnvironment#name}
  */
  readonly name: string;
  /**
  * The ID of the Runtime associated with this Environment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/symopsio/sym/3.6.0/docs/data-sources/environment#runtime_id DataSymEnvironment#runtime_id}
  */
  readonly runtimeId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/symopsio/sym/3.6.0/docs/data-sources/environment sym_environment}
*/
export class DataSymEnvironment extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataSymEnvironment resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataSymEnvironment to import
  * @param importFromId The id of the existing DataSymEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/symopsio/sym/3.6.0/docs/data-sources/environment#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataSymEnvironment to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/symopsio/sym/3.6.0/docs/data-sources/environment sym_environment} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataSymEnvironmentConfig
  */
  public constructor(scope: Construct, id: string, config: DataSymEnvironmentConfig) {
    super(scope, id, {
