// https://registry.terraform.io/providers/invidian/gpg/0.3.1/docs
...
export interface GpgProviderConfig {
  ...
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/invidian/gpg/0.3.1/docs#alias GpgProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/invidian/gpg/0.3.1/docs gpg}
*/
export class GpgProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing GpgProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/invidian/gpg/0.3.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/invidian/gpg/0.3.1/docs gpg} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: GpgProviderConfig = {}) {
    super(scope, id, {
      ...
      terraformProviderSource: 'invidian/gpg'
    });
