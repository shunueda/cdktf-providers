// https://registry.terraform.io/providers/azure/alz/0.20.1/docs/data-sources/metadata
...
/**
* Represents a {@link https://registry.terraform.io/providers/azure/alz/0.20.1/docs/data-sources/metadata alz_metadata}
*/
export class DataAlzMetadata extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAlzMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/azure/alz/0.20.1/docs/data-sources/metadata#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/azure/alz/0.20.1/docs/data-sources/metadata alz_metadata} Data Source
  *
  * @param scope The scope in which to define this construct
