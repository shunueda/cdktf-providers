// https://registry.terraform.io/providers/kestra-io/kestra/1.0.2/docs/data-sources/worker_group
...
export interface DataKestraWorkerGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * The worker group id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.2/docs/data-sources/worker_group#id DataKestraWorkerGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.2/docs/data-sources/worker_group#key DataKestraWorkerGroup#key}
  */
  readonly key: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.2/docs/data-sources/worker_group kestra_worker_group}
*/
export class DataKestraWorkerGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKestraWorkerGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.2/docs/data-sources/worker_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kestra-io/kestra/1.0.2/docs/data-sources/worker_group kestra_worker_group} Data Source
  *
  * @param scope The scope in which to define this construct
