// https://registry.terraform.io/providers/jetbrains/teamcity/0.0.86/docs/data-sources/user
...
export interface DataTeamcityUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.86/docs/data-sources/user#id DataTeamcityUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.86/docs/data-sources/user#username DataTeamcityUser#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.86/docs/data-sources/user teamcity_user}
*/
export class DataTeamcityUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTeamcityUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.86/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.86/docs/data-sources/user teamcity_user} Data Source
  *
  * @param scope The scope in which to define this construct
