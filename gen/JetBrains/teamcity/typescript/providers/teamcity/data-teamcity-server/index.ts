// https://registry.terraform.io/providers/jetbrains/teamcity/0.0.86/docs/data-sources/server
...
/**
* Represents a {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.86/docs/data-sources/server teamcity_server}
*/
export class DataTeamcityServer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTeamcityServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.86/docs/data-sources/server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.86/docs/data-sources/server teamcity_server} Data Source
  *
  * @param scope The scope in which to define this construct
