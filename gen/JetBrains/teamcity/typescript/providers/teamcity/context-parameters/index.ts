// https://registry.terraform.io/providers/jetbrains/teamcity/0.0.87/docs/resources/context_parameters
...
export interface ContextParametersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.87/docs/resources/context_parameters#params ContextParameters#params}
  */
  readonly params: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.87/docs/resources/context_parameters#project_id ContextParameters#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.87/docs/resources/context_parameters teamcity_context_parameters}
*/
export class ContextParameters extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContextParameters that should be imported. Refer to the {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.87/docs/resources/context_parameters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.87/docs/resources/context_parameters teamcity_context_parameters} Resource
  *
  * @param scope The scope in which to define this construct
