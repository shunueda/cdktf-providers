// https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/pool
...
export interface PoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/pool#name Pool#name}
  */
  readonly name: string;
  /**
  * Projects assigned to the given pool. List of Project IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/pool#projects Pool#projects}
  */
  readonly projects?: string[];
  /**
  * Agents capacity for the given pool, don't add for unlimited
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/pool#size Pool#size}
  */
  readonly size?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/pool teamcity_pool}
*/
export class Pool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Pool that should be imported. Refer to the {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/pool teamcity_pool} Resource
  *
  * @param scope The scope in which to define this construct
