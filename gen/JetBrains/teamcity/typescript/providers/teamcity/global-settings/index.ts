// https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings
...
export interface GlobalSettingsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings#artifact_directories GlobalSettings#artifact_directories}
  */
  readonly artifactDirectories?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings#artifacts_domain_isolation GlobalSettings#artifacts_domain_isolation}
  */
  readonly artifactsDomainIsolation?: GlobalSettingsArtifactsDomainIsolation;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings#default_execution_timeout GlobalSettings#default_execution_timeout}
  */
  readonly defaultExecutionTimeout?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings#default_quiet_period GlobalSettings#default_quiet_period}
  */
  readonly defaultQuietPeriod?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings#default_vcs_check_interval GlobalSettings#default_vcs_check_interval}
  */
  readonly defaultVcsCheckInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings#encryption GlobalSettings#encryption}
  */
  readonly encryption?: GlobalSettingsEncryption;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings#enforce_default_vcs_check_interval GlobalSettings#enforce_default_vcs_check_interval}
  */
  readonly enforceDefaultVcsCheckInterval?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings#max_artifact_number GlobalSettings#max_artifact_number}
  */
  readonly maxArtifactNumber?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings#max_artifact_size GlobalSettings#max_artifact_size}
  */
  readonly maxArtifactSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings#root_url GlobalSettings#root_url}
  */
  readonly rootUrl?: string;
}
export interface GlobalSettingsArtifactsDomainIsolation {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings#artifacts_url GlobalSettings#artifacts_url}
  */
  readonly artifactsUrl?: string;
  /**
  * Enabled by default, set false if it needs to be disabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings#enabled GlobalSettings#enabled}
  */
...
export interface GlobalSettingsEncryption {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings#key GlobalSettings#key}
  */
  readonly key: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings teamcity_global_settings}
*/
export class GlobalSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GlobalSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jetbrains/teamcity/0.0.85/docs/resources/global_settings teamcity_global_settings} Resource
  *
  * @param scope The scope in which to define this construct
