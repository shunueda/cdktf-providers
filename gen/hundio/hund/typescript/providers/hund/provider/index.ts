// https://registry.terraform.io/providers/hundio/hund/0.2.0/docs
...
export interface HundProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hundio/hund/0.2.0/docs#domain HundProvider#domain}
  */
  readonly domain?: string;
  /**
  * The [Hund API key](https://hund.io/help/api#section/Authentication) used to authenticate with the API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hundio/hund/0.2.0/docs#key HundProvider#key}
  */
  readonly key?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hundio/hund/0.2.0/docs#alias HundProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hundio/hund/0.2.0/docs hund}
*/
export class HundProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing HundProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hundio/hund/0.2.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hundio/hund/0.2.0/docs hund} Resource
  *
  * @param scope The scope in which to define this construct
