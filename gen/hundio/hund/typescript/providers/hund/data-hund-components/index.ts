// https://registry.terraform.io/providers/hundio/hund/0.2.0/docs/data-sources/components
...
export interface DataHundComponentsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hundio/hund/0.2.0/docs/data-sources/components#group DataHundComponents#group}
  */
  readonly group?: string;
  /**
  * Return the Components for the provided Issue ObjectId.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hundio/hund/0.2.0/docs/data-sources/components#issue DataHundComponents#issue}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hundio/hund/0.2.0/docs/data-sources/components hund_components}
*/
export class DataHundComponents extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHundComponents that should be imported. Refer to the {@link https://registry.terraform.io/providers/hundio/hund/0.2.0/docs/data-sources/components#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hundio/hund/0.2.0/docs/data-sources/components hund_components} Data Source
  *
  * @param scope The scope in which to define this construct
