// https://registry.terraform.io/providers/jianyuan/sentry/0.14.7/docs/data-sources/organization
...
export interface DataSentryOrganizationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.7/docs/data-sources/organization#slug DataSentryOrganization#slug}
  */
  readonly slug: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.7/docs/data-sources/organization sentry_organization}
*/
export class DataSentryOrganization extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSentryOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.7/docs/data-sources/organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jianyuan/sentry/0.14.7/docs/data-sources/organization sentry_organization} Data Source
  *
  * @param scope The scope in which to define this construct
