// https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/resources/private_connection
...
export interface PrivateConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/resources/private_connection#allow_list PrivateConnection#allow_list}
  */
  readonly allowList?: string;
  /**
  * VPC Endpoint ID for AWS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/resources/private_connection#kai_endpoint_id PrivateConnection#kai_endpoint_id}
  */
  readonly kaiEndpointId?: string;
  /**
  * The name of the private connection service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/resources/private_connection#service_name PrivateConnection#service_name}
  */
  readonly serviceName?: string;
  /**
  * The SQL port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/resources/private_connection#sql_port PrivateConnection#sql_port}
  */
  readonly sqlPort?: number;
  /**
  * The private connection type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/resources/private_connection#type PrivateConnection#type}
  */
  readonly type?: string;
  /**
  * The websockets port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/resources/private_connection#web_socket_port PrivateConnection#web_socket_port}
  */
  readonly webSocketPort?: number;
  /**
  * The ID of the workspace group containing the private connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/resources/private_connection#workspace_group_id PrivateConnection#workspace_group_id}
  */
  readonly workspaceGroupId: string;
  /**
  * The ID of the workspace to connect with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/resources/private_connection#workspace_id PrivateConnection#workspace_id}
  */
  readonly workspaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/resources/private_connection singlestoredb_private_connection}
*/
export class PrivateConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/resources/private_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/resources/private_connection singlestoredb_private_connection} Resource
  *
  * @param scope The scope in which to define this construct
