// https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/data-sources/invitation
...
export interface DataSinglestoredbInvitationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/data-sources/invitation#id DataSinglestoredbInvitation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/data-sources/invitation singlestoredb_invitation}
*/
export class DataSinglestoredbInvitation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSinglestoredbInvitation that should be imported. Refer to the {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/data-sources/invitation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.6/docs/data-sources/invitation singlestoredb_invitation} Data Source
  *
  * @param scope The scope in which to define this construct
