// https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace
...
export interface WorkspaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace#auto_scale Workspace#auto_scale}
  */
  readonly autoScale?: WorkspaceAutoScale;
  /**
  * Auto suspend settings for the workspace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace#auto_suspend Workspace#auto_suspend}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace#cache_config Workspace#cache_config}
  */
  readonly cacheConfig?: number;
  /**
  * Whether the Kai API is enabled for the workspace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace#kai_enabled Workspace#kai_enabled}
  */
  readonly kaiEnabled?: boolean | cdktf.IResolvable;
  /**
  * The name assigned to the workspace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace#name Workspace#name}
  */
  readonly name: string;
  /**
  * Specifies the scale factor for the workspace. The scale factor can be 1, 2 or 4. Default is 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace#scale_factor Workspace#scale_factor}
  */
  readonly scaleFactor?: number;
  /**
  * The size of the workspace, specified in workspace size notation (S-00, S-0, S-1, S-2).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace#size Workspace#size}
  */
  readonly size: string;
  /**
  * The status of the workspace. If true, the workspace is suspended.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace#suspended Workspace#suspended}
  */
  readonly suspended?: boolean | cdktf.IResolvable;
  /**
  * The unique identifier of the workspace group that the workspace belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace#workspace_group_id Workspace#workspace_group_id}
  */
...
export interface WorkspaceAutoScale {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace#max_scale_factor Workspace#max_scale_factor}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace#sensitivity Workspace#sensitivity}
  */
...
export interface WorkspaceAutoSuspend {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace#suspend_after_seconds Workspace#suspend_after_seconds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace#suspend_type Workspace#suspend_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace singlestoredb_workspace}
*/
export class Workspace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Workspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/resources/workspace singlestoredb_workspace} Resource
  *
  * @param scope The scope in which to define this construct
