// https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/data-sources/users
...
export interface DataSinglestoredbUsersUsers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/data-sources/users#email DataSinglestoredbUsers#email}
  */
  readonly email?: string;
  /**
  * The unique identifier of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/data-sources/users#id DataSinglestoredbUsers#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/data-sources/users singlestoredb_users}
*/
export class DataSinglestoredbUsers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSinglestoredbUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/data-sources/users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/singlestore-labs/singlestoredb/0.1.8/docs/data-sources/users singlestoredb_users} Data Source
  *
  * @param scope The scope in which to define this construct
