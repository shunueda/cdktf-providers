// https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_gateway_keepalive_config
...
export interface ControllerGatewayKeepaliveConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_gateway_keepalive_config#id ControllerGatewayKeepaliveConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_gateway_keepalive_config#keepalive_speed ControllerGatewayKeepaliveConfig#keepalive_speed}
  */
  readonly keepaliveSpeed: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_gateway_keepalive_config aviatrix_controller_gateway_keepalive_config}
*/
export class ControllerGatewayKeepaliveConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ControllerGatewayKeepaliveConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_gateway_keepalive_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_gateway_keepalive_config aviatrix_controller_gateway_keepalive_config} Resource
  *
  * @param scope The scope in which to define this construct
