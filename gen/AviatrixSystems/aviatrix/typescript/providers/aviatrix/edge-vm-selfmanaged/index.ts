...
export interface EdgeVmSelfmanagedConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface EdgeVmSelfmanagedInterfaces {
  /**
...
export function edgeVmSelfmanagedInterfacesToTerraform(struct?: EdgeVmSelfmanagedInterfaces | cdktf.IResolvable): any {
...
export function edgeVmSelfmanagedInterfacesToHclTerraform(struct?: EdgeVmSelfmanagedInterfaces | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class EdgeVmSelfmanagedInterfacesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EdgeVmSelfmanagedInterfaces | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: EdgeVmSelfmanagedInterfaces | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class EdgeVmSelfmanagedInterfacesList extends cdktf.ComplexList {
  public internalValue? : EdgeVmSelfmanagedInterfaces[] | cdktf.IResolvable
  ...
  */
  public get(index: number): EdgeVmSelfmanagedInterfacesOutputReference {
    return new EdgeVmSelfmanagedInterfacesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class EdgeVmSelfmanaged extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "aviatrix_edge_vm_selfmanaged";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aviatrix_edge_vm_selfmanaged", importId: importFromId, provider });
      }
  ...
  * @param options EdgeVmSelfmanagedConfig
  */
  public constructor(scope: Construct, id: string, config: EdgeVmSelfmanagedConfig) {
    super(scope, id, {
  ...
  private _interfaces = new EdgeVmSelfmanagedInterfacesList(this, "interfaces", true);
  public get interfaces() {
    return this._interfaces;
  }
  public putInterfaces(value: EdgeVmSelfmanagedInterfaces[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      interfaces: cdktf.listMapper(edgeVmSelfmanagedInterfacesToTerraform, true)(this._interfaces.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      interfaces: {
        value: cdktf.listMapperHcl(edgeVmSelfmanagedInterfacesToHclTerraform, true)(this._interfaces.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "EdgeVmSelfmanagedInterfacesList",
      },
    };
