// https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_intra_domain_inspection
...
export interface AwsTgwIntraDomainInspectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_intra_domain_inspection#firewall_domain_name AwsTgwIntraDomainInspection#firewall_domain_name}
  */
  readonly firewallDomainName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_intra_domain_inspection#id AwsTgwIntraDomainInspection#id}
  *
  ...
  * Route domain name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_intra_domain_inspection#route_domain_name AwsTgwIntraDomainInspection#route_domain_name}
  */
  readonly routeDomainName: string;
  /**
  * AWS TGW name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_intra_domain_inspection#tgw_name AwsTgwIntraDomainInspection#tgw_name}
  */
  readonly tgwName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_intra_domain_inspection aviatrix_aws_tgw_intra_domain_inspection}
*/
export class AwsTgwIntraDomainInspection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsTgwIntraDomainInspection that should be imported. Refer to the {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_intra_domain_inspection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_intra_domain_inspection aviatrix_aws_tgw_intra_domain_inspection} Resource
  *
  * @param scope The scope in which to define this construct
