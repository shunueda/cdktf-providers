...
export interface ControllerConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#aws_guard_duty_scanning_interval ControllerConfig#aws_guard_duty_scanning_interval}
  */
  readonly awsGuardDutyScanningInterval?: number;
  /**
  * This parameter represents the name of a Cloud-Account in Aviatrix controller.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#backup_account_name ControllerConfig#backup_account_name}
  */
  readonly backupAccountName?: string;
  /**
  * Bucket name. Required for AWS, AWSGov, GCP and OCI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#backup_bucket_name ControllerConfig#backup_bucket_name}
  */
  readonly backupBucketName?: string;
  /**
  * Type of cloud service provider, requires an integer value. Use 1 for AWS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#backup_cloud_type ControllerConfig#backup_cloud_type}
  */
  readonly backupCloudType?: number;
  /**
  * Switch to enable/disable controller cloudn backup config.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#backup_configuration ControllerConfig#backup_configuration}
  */
  readonly backupConfiguration?: boolean | cdktf.IResolvable;
  /**
  * Container name. Required for Azure.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#backup_container_name ControllerConfig#backup_container_name}
  */
  readonly backupContainerName?: string;
  /**
  * Name of region. Required for Azure and OCI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#backup_region ControllerConfig#backup_region}
  */
  readonly backupRegion?: string;
  /**
  * Storage name. Required for Azure.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#backup_storage_name ControllerConfig#backup_storage_name}
  */
  readonly backupStorageName?: string;
  /**
  * CA certificate file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#ca_certificate_file ControllerConfig#ca_certificate_file}
  */
  readonly caCertificateFile?: string;
  /**
  * File path to the CA certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#ca_certificate_file_path ControllerConfig#ca_certificate_file_path}
  */
  readonly caCertificateFilePath?: string;
  /**
  * Enable VPC/VNET DNS Server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#enable_vpc_dns_server ControllerConfig#enable_vpc_dns_server}
  */
  readonly enableVpcDnsServer?: boolean | cdktf.IResolvable;
  /**
  * A system-wide mode. Default: true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#fqdn_exception_rule ControllerConfig#fqdn_exception_rule}
  */
  readonly fqdnExceptionRule?: boolean | cdktf.IResolvable;
  /**
  * Switch for HTTP access. Default: false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#http_access ControllerConfig#http_access}
  */
  readonly httpAccess?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#id ControllerConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#manage_gateway_upgrades ControllerConfig#manage_gateway_upgrades}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#multiple_backups ControllerConfig#multiple_backups}
  */
  readonly multipleBackups?: boolean | cdktf.IResolvable;
  /**
  * Server private key file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#server_private_key_file ControllerConfig#server_private_key_file}
  */
  readonly serverPrivateKeyFile?: string;
  /**
  * File path to the server private key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#server_private_key_file_path ControllerConfig#server_private_key_file_path}
  */
  readonly serverPrivateKeyFilePath?: string;
  /**
  * Server public certificate file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#server_public_certificate_file ControllerConfig#server_public_certificate_file}
  */
  readonly serverPublicCertificateFile?: string;
  /**
  * File path to the server public certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#server_public_certificate_file_path ControllerConfig#server_public_certificate_file_path}
  */
  readonly serverPublicCertificateFilePath?: string;
  /**
  * The release version number to which the controller will be upgraded to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/controller_config#target_version ControllerConfig#target_version}
  */
