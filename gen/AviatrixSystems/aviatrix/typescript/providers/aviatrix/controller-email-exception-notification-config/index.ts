// https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_email_exception_notification_config
...
export interface ControllerEmailExceptionNotificationConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_email_exception_notification_config#enable_email_exception_notification ControllerEmailExceptionNotificationConfig#enable_email_exception_notification}
  */
  readonly enableEmailExceptionNotification?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_email_exception_notification_config#id ControllerEmailExceptionNotificationConfig#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_email_exception_notification_config aviatrix_controller_email_exception_notification_config}
*/
export class ControllerEmailExceptionNotificationConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ControllerEmailExceptionNotificationConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_email_exception_notification_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_email_exception_notification_config aviatrix_controller_email_exception_notification_config} Resource
  *
  * @param scope The scope in which to define this construct
