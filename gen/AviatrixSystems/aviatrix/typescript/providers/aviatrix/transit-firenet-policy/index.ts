// https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/transit_firenet_policy
...
export interface TransitFirenetPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/transit_firenet_policy#id TransitFirenetPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/transit_firenet_policy#inspected_resource_name TransitFirenetPolicy#inspected_resource_name}
  */
  readonly inspectedResourceName: string;
  /**
  * Name of the transit firenet gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/transit_firenet_policy#transit_firenet_gateway_name TransitFirenetPolicy#transit_firenet_gateway_name}
  */
  readonly transitFirenetGatewayName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/transit_firenet_policy aviatrix_transit_firenet_policy}
*/
export class TransitFirenetPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransitFirenetPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/transit_firenet_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/transit_firenet_policy aviatrix_transit_firenet_policy} Resource
  *
  * @param scope The scope in which to define this construct
