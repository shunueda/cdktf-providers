// https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_bgp_communities_global_config
...
export interface ControllerBgpCommunitiesGlobalConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_bgp_communities_global_config#bgp_communities_global ControllerBgpCommunitiesGlobalConfig#bgp_communities_global}
  */
  readonly bgpCommunitiesGlobal: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_bgp_communities_global_config#id ControllerBgpCommunitiesGlobalConfig#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_bgp_communities_global_config aviatrix_controller_bgp_communities_global_config}
*/
export class ControllerBgpCommunitiesGlobalConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ControllerBgpCommunitiesGlobalConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_bgp_communities_global_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/controller_bgp_communities_global_config aviatrix_controller_bgp_communities_global_config} Resource
  *
  * @param scope The scope in which to define this construct
