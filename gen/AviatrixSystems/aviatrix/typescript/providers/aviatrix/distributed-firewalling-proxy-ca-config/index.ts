// https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/distributed_firewalling_proxy_ca_config
...
export interface DistributedFirewallingProxyCaConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/distributed_firewalling_proxy_ca_config#ca_cert DistributedFirewallingProxyCaConfig#ca_cert}
  */
  readonly caCert: string;
  /**
  * Content of proxy ca cert key to create only one cert.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/distributed_firewalling_proxy_ca_config#ca_key DistributedFirewallingProxyCaConfig#ca_key}
  */
  readonly caKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/distributed_firewalling_proxy_ca_config#id DistributedFirewallingProxyCaConfig#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/distributed_firewalling_proxy_ca_config aviatrix_distributed_firewalling_proxy_ca_config}
*/
export class DistributedFirewallingProxyCaConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DistributedFirewallingProxyCaConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/distributed_firewalling_proxy_ca_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/resources/distributed_firewalling_proxy_ca_config aviatrix_distributed_firewalling_proxy_ca_config} Resource
  *
  * @param scope The scope in which to define this construct
