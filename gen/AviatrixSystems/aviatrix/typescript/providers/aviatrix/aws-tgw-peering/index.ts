// https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_peering
...
export interface AwsTgwPeeringConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_peering#id AwsTgwPeering#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_peering#tgw_name1 AwsTgwPeering#tgw_name1}
  */
  readonly tgwName1: string;
  /**
  * Name of the second AWS tgw to make a peer pair.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_peering#tgw_name2 AwsTgwPeering#tgw_name2}
  */
  readonly tgwName2: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_peering aviatrix_aws_tgw_peering}
*/
export class AwsTgwPeering extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsTgwPeering that should be imported. Refer to the {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_peering#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/aws_tgw_peering aviatrix_aws_tgw_peering} Resource
  *
  * @param scope The scope in which to define this construct
