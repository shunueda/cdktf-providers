// https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/data-sources/gateway_image
...
export interface DataAviatrixGatewayImageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/data-sources/gateway_image#cloud_type DataAviatrixGatewayImage#cloud_type}
  */
  readonly cloudType: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/data-sources/gateway_image#id DataAviatrixGatewayImage#id}
  *
  ...
  * Software version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/data-sources/gateway_image#software_version DataAviatrixGatewayImage#software_version}
  */
  readonly softwareVersion: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/data-sources/gateway_image aviatrix_gateway_image}
*/
export class DataAviatrixGatewayImage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAviatrixGatewayImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/data-sources/gateway_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.1.10/docs/data-sources/gateway_image aviatrix_gateway_image} Data Source
  *
  * @param scope The scope in which to define this construct
