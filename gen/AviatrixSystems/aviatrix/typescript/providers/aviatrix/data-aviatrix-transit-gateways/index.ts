// https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/data-sources/transit_gateways
...
export interface DataAviatrixTransitGatewaysConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/data-sources/transit_gateways#id DataAviatrixTransitGateways#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/data-sources/transit_gateways aviatrix_transit_gateways}
*/
export class DataAviatrixTransitGateways extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAviatrixTransitGateways that should be imported. Refer to the {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/data-sources/transit_gateways#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/data-sources/transit_gateways aviatrix_transit_gateways} Data Source
  *
  * @param scope The scope in which to define this construct
