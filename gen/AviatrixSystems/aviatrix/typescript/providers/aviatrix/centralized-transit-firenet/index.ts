// https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/centralized_transit_firenet
...
export interface CentralizedTransitFirenetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/centralized_transit_firenet#id CentralizedTransitFirenet#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/centralized_transit_firenet#primary_firenet_gw_name CentralizedTransitFirenet#primary_firenet_gw_name}
  */
  readonly primaryFirenetGwName: string;
  /**
  * Secondary firenet gateway name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/centralized_transit_firenet#secondary_firenet_gw_name CentralizedTransitFirenet#secondary_firenet_gw_name}
  */
  readonly secondaryFirenetGwName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/centralized_transit_firenet aviatrix_centralized_transit_firenet}
*/
export class CentralizedTransitFirenet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CentralizedTransitFirenet that should be imported. Refer to the {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/centralized_transit_firenet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aviatrixsystems/aviatrix/8.2.0/docs/resources/centralized_transit_firenet aviatrix_centralized_transit_firenet} Resource
  *
  * @param scope The scope in which to define this construct
