...
export interface EdgePlatformHaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Edge NEO device ID.
  *
...
export interface EdgePlatformHaInterfaces {
  /**
...
export function edgePlatformHaInterfacesToTerraform(struct?: EdgePlatformHaInterfaces | cdktf.IResolvable): any {
...
export function edgePlatformHaInterfacesToHclTerraform(struct?: EdgePlatformHaInterfaces | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class EdgePlatformHaInterfacesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EdgePlatformHaInterfaces | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: EdgePlatformHaInterfaces | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class EdgePlatformHaInterfacesList extends cdktf.ComplexList {
  public internalValue? : EdgePlatformHaInterfaces[] | cdktf.IResolvable
  ...
  */
  public get(index: number): EdgePlatformHaInterfacesOutputReference {
    return new EdgePlatformHaInterfacesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class EdgePlatformHa extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "aviatrix_edge_platform_ha";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aviatrix_edge_platform_ha", importId: importFromId, provider });
      }
  ...
  * @param options EdgePlatformHaConfig
  */
  public constructor(scope: Construct, id: string, config: EdgePlatformHaConfig) {
    super(scope, id, {
  ...
  private _interfaces = new EdgePlatformHaInterfacesList(this, "interfaces", true);
  public get interfaces() {
    return this._interfaces;
  }
  public putInterfaces(value: EdgePlatformHaInterfaces[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      interfaces: cdktf.listMapper(edgePlatformHaInterfacesToTerraform, true)(this._interfaces.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      interfaces: {
        value: cdktf.listMapperHcl(edgePlatformHaInterfacesToHclTerraform, true)(this._interfaces.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "EdgePlatformHaInterfacesList",
      },
    };
