// https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip
...
export interface ElasticIpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#address_family ElasticIp#address_family}
  */
  readonly addressFamily?: string;
  /**
  * A free-form text describing the Elastic IP (EIP).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#description ElasticIp#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#id ElasticIp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#labels ElasticIp#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Domain name for reverse DNS record.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#reverse_dns ElasticIp#reverse_dns}
  */
  readonly reverseDns?: string;
  /**
  * ❗ The Exoscale [Zone](https://www.exoscale.com/datacenters/) name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#zone ElasticIp#zone}
  */
  readonly zone: string;
  /**
  * healthcheck block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#healthcheck ElasticIp#healthcheck}
  */
  readonly healthcheck?: ElasticIpHealthcheck;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#timeouts ElasticIp#timeouts}
  */
...
export interface ElasticIpHealthcheck {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#interval ElasticIp#interval}
  */
  readonly interval?: number;
  /**
  * The healthcheck mode (`tcp`, `http` or `https`; may only be set at creation time).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#mode ElasticIp#mode}
  */
  readonly mode: string;
  /**
  * The healthcheck target port (must be between `1` and `65535`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#port ElasticIp#port}
  */
  readonly port: number;
  /**
  * The number of failed healthcheck attempts before considering the target unhealthy (must be between `1` and `20`; default: `2`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#strikes_fail ElasticIp#strikes_fail}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#strikes_ok ElasticIp#strikes_ok}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#timeout ElasticIp#timeout}
  */
  readonly timeout?: number;
  /**
  * Disable TLS certificate verification for healthcheck in `https` mode (boolean; default: `false`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#tls_skip_verify ElasticIp#tls_skip_verify}
  */
  readonly tlsSkipVerify?: boolean | cdktf.IResolvable;
  /**
  * The healthcheck server name to present with SNI in `https` mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#tls_sni ElasticIp#tls_sni}
  */
  readonly tlsSni?: string;
  /**
  * The healthcheck target URI (required in `http(s)` modes).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#uri ElasticIp#uri}
  */
  readonly uri?: string;
}
...
export interface ElasticIpTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#create ElasticIp#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#delete ElasticIp#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#read ElasticIp#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#update ElasticIp#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip exoscale_elastic_ip}
*/
export class ElasticIp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/elastic_ip exoscale_elastic_ip} Resource
  *
  * @param scope The scope in which to define this construct
