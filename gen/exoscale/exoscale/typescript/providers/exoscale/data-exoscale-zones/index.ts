// https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/data-sources/zones
...
/**
* Represents a {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/data-sources/zones exoscale_zones}
*/
export class DataExoscaleZones extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataExoscaleZones that should be imported. Refer to the {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/data-sources/zones#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/data-sources/zones exoscale_zones} Data Source
  *
  * @param scope The scope in which to define this construct
