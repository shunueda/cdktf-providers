// https://registry.terraform.io/providers/exoscale/exoscale/0.66.0/docs
...
export interface ExoscaleProviderConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.66.0/docs#delay ExoscaleProvider#delay}
  */
  readonly delay?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.66.0/docs#environment ExoscaleProvider#environment}
  */
  readonly environment?: string;
  /**
  * Exoscale API key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.66.0/docs#key ExoscaleProvider#key}
  */
  readonly key?: string;
  /**
  * Exoscale API secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.66.0/docs#secret ExoscaleProvider#secret}
  */
  readonly secret?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.66.0/docs#sos_endpoint ExoscaleProvider#sos_endpoint}
  */
  readonly sosEndpoint?: string;
  /**
  * Timeout in seconds for waiting on compute resources to become available (by default: 3600)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.66.0/docs#timeout ExoscaleProvider#timeout}
  */
  readonly timeout?: number;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.66.0/docs#alias ExoscaleProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/exoscale/exoscale/0.66.0/docs exoscale}
*/
export class ExoscaleProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ExoscaleProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/exoscale/exoscale/0.66.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/exoscale/exoscale/0.66.0/docs exoscale} Resource
  *
  * @param scope The scope in which to define this construct
