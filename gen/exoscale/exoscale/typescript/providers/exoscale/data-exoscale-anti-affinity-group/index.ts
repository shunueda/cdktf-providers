// https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/data-sources/anti_affinity_group
...
export interface DataExoscaleAntiAffinityGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/data-sources/anti_affinity_group#id DataExoscaleAntiAffinityGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/data-sources/anti_affinity_group#name DataExoscaleAntiAffinityGroup#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/data-sources/anti_affinity_group exoscale_anti_affinity_group}
*/
export class DataExoscaleAntiAffinityGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataExoscaleAntiAffinityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/data-sources/anti_affinity_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/data-sources/anti_affinity_group exoscale_anti_affinity_group} Data Source
  *
  * @param scope The scope in which to define this construct
