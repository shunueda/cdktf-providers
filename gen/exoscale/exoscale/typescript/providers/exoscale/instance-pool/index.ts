// https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool
...
export interface InstancePoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#affinity_group_ids InstancePool#affinity_group_ids}
  */
  readonly affinityGroupIds?: string[];
  /**
  * A list of [exoscale_anti_affinity_group](./anti_affinity_group.md) (IDs; may only be set at creation time).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#anti_affinity_group_ids InstancePool#anti_affinity_group_ids}
  */
  readonly antiAffinityGroupIds?: string[];
  /**
  * A deploy target ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#deploy_target_id InstancePool#deploy_target_id}
  */
  readonly deployTargetId?: string;
  /**
  * A free-form text describing the pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#description InstancePool#description}
  */
  readonly description?: string;
  /**
  * The managed instances disk size (GiB).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#disk_size InstancePool#disk_size}
  */
  readonly diskSize?: number;
  /**
  * A list of [exoscale_elastic_ip](./elastic_ip.md) (IDs).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#elastic_ip_ids InstancePool#elastic_ip_ids}
  */
  readonly elasticIpIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#id InstancePool#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#instance_prefix InstancePool#instance_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#instance_type InstancePool#instance_type}
  */
  readonly instanceType?: string;
  /**
  * Enable IPv6 on managed instances (boolean; default: `false`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#ipv6 InstancePool#ipv6}
  */
  readonly ipv6?: boolean | cdktf.IResolvable;
  /**
  * The [exoscale_ssh_key](./ssh_key.md) (name) to authorize in the managed instances.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#key_pair InstancePool#key_pair}
  */
  readonly keyPair?: string;
  /**
  * A map of key/value labels.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#labels InstancePool#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Minimum number of running Instances.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#min_available InstancePool#min_available}
  */
  readonly minAvailable?: number;
  /**
  * The instance pool name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#name InstancePool#name}
  */
  readonly name: string;
  /**
  * A list of [exoscale_private_network](./private_network.md) (IDs).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#network_ids InstancePool#network_ids}
  */
  readonly networkIds?: string[];
  /**
  * A list of [exoscale_security_group](./security_group.md) (IDs).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#security_group_ids InstancePool#security_group_ids}
  */
  readonly securityGroupIds?: string[];
  /**
  * The managed instances type. Please use the `instance_type` argument instead.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#service_offering InstancePool#service_offering}
  */
  readonly serviceOffering?: string;
  /**
  * The number of managed instances.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#size InstancePool#size}
  */
  readonly size: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#state InstancePool#state}
  */
  readonly state?: string;
  /**
  * The [exoscale_template](../data-sources/template.md) (ID) to use when creating the managed instances.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#template_id InstancePool#template_id}
  */
  readonly templateId: string;
  /**
  * [cloud-init](http://cloudinit.readthedocs.io/) configuration to apply to the managed instances.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#user_data InstancePool#user_data}
  */
  readonly userData?: string;
  /**
  * The list of managed instances (IDs). Please use the `instances.*.id` attribute instead.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#virtual_machines InstancePool#virtual_machines}
  */
  readonly virtualMachines?: string[];
  /**
  * ❗ The Exoscale [Zone](https://www.exoscale.com/datacenters/) name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#zone InstancePool#zone}
  */
  readonly zone: string;
  /**
  * instances block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#instances InstancePool#instances}
  */
  readonly instances?: InstancePoolInstances[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#timeouts InstancePool#timeouts}
  */
...
export interface InstancePoolTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#create InstancePool#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#delete InstancePool#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#read InstancePool#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#update InstancePool#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool exoscale_instance_pool}
*/
export class InstancePool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InstancePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/exoscale/exoscale/0.67.1/docs/resources/instance_pool exoscale_instance_pool} Resource
  *
  * @param scope The scope in which to define this construct
