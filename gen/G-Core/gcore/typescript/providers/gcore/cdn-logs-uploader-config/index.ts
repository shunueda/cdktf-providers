// https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/cdn_logs_uploader_config
...
export interface CdnLogsUploaderConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/cdn_logs_uploader_config#enabled CdnLogsUploaderConfig#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/cdn_logs_uploader_config#for_all_resources CdnLogsUploaderConfig#for_all_resources}
  */
  readonly forAllResources?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/cdn_logs_uploader_config#id CdnLogsUploaderConfig#id}
  *
  ...
  * Name of the config.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/cdn_logs_uploader_config#name CdnLogsUploaderConfig#name}
  */
  readonly name: string;
  /**
  * ID of the policy that should be assigned to given config.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/cdn_logs_uploader_config#policy CdnLogsUploaderConfig#policy}
  */
  readonly policy: number;
  /**
  * List of resource IDs to which the config should be applied.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/cdn_logs_uploader_config#resources CdnLogsUploaderConfig#resources}
  */
  readonly resources?: number[];
  /**
  * ID of the target to which logs should be uploaded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/cdn_logs_uploader_config#target CdnLogsUploaderConfig#target}
  */
  readonly target: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/cdn_logs_uploader_config gcore_cdn_logs_uploader_config}
*/
export class CdnLogsUploaderConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnLogsUploaderConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/cdn_logs_uploader_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/cdn_logs_uploader_config gcore_cdn_logs_uploader_config} Resource
  *
  * @param scope The scope in which to define this construct
