// https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/waap_policy
...
export interface WaapPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/waap_policy#domain_id WaapPolicy#domain_id}
  */
  readonly domainId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/waap_policy#id WaapPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/waap_policy#policies WaapPolicy#policies}
  */
  readonly policies: { [key: string]: (boolean | cdktf.IResolvable) };
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/waap_policy gcore_waap_policy}
*/
export class WaapPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WaapPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/waap_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/waap_policy gcore_waap_policy} Resource
  *
  * @param scope The scope in which to define this construct
