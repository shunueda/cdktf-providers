// https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/data-sources/waap_domain_policy
...
export interface DataGcoreWaapDomainPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  * The WAAP domain ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/data-sources/waap_domain_policy#domain_id DataGcoreWaapDomainPolicy#domain_id}
  */
  readonly domainId: number;
  /**
  * The policy group name to which the policy belongs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/data-sources/waap_domain_policy#group DataGcoreWaapDomainPolicy#group}
  */
  readonly group: string;
  /**
  * The name of the Domain Policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/data-sources/waap_domain_policy#name DataGcoreWaapDomainPolicy#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/data-sources/waap_domain_policy gcore_waap_domain_policy}
*/
export class DataGcoreWaapDomainPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGcoreWaapDomainPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/data-sources/waap_domain_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/data-sources/waap_domain_policy gcore_waap_domain_policy} Data Source
  *
  * @param scope The scope in which to define this construct
