// https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool
...
export interface LbpoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#id Lbpool#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#lb_algorithm Lbpool#lb_algorithm}
  */
  readonly lbAlgorithm: string;
  /**
  * ID of the target listener associated with load balancer to attach newly created pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#listener_id Lbpool#listener_id}
  */
  readonly listenerId?: string;
  /**
  * ID of the target load balancer to attach newly created pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#loadbalancer_id Lbpool#loadbalancer_id}
  */
  readonly loadbalancerId?: string;
  /**
  * Pool name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#name Lbpool#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#project_id Lbpool#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#project_name Lbpool#project_name}
  */
  readonly projectName?: string;
  /**
  * Available values are 'HTTP', 'HTTPS', 'TCP', 'UDP', 'PROXY', 'PROXYV2'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#protocol Lbpool#protocol}
  */
  readonly protocol: string;
  /**
  * ID of the desired region to create load balancer pool in. Alternative for `region_name`. One of them should be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#region_id Lbpool#region_id}
  */
  readonly regionId?: number;
  /**
  * Name of the desired region to create load balancer pool in. Alternative for `region_id`. One of them should be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#region_name Lbpool#region_name}
  */
  readonly regionName?: string;
  /**
  * health_monitor block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#health_monitor Lbpool#health_monitor}
  */
  readonly healthMonitor?: LbpoolHealthMonitor;
  /**
  * session_persistence block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#session_persistence Lbpool#session_persistence}
  */
  readonly sessionPersistence?: LbpoolSessionPersistence;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#timeouts Lbpool#timeouts}
  */
...
export interface LbpoolHealthMonitor {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#delay Lbpool#delay}
  */
  readonly delay: number;
  /**
  * The list of HTTP status codes expected in response from the member to declare it healthy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#expected_codes Lbpool#expected_codes}
  */
  readonly expectedCodes?: string;
  /**
  * The HTTP method that the health monitor uses for requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#http_method Lbpool#http_method}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#max_retries Lbpool#max_retries}
  */
  readonly maxRetries: number;
  /**
  * The number of allowed check failures before changing the operating status of the member to ERROR.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#max_retries_down Lbpool#max_retries_down}
  */
  readonly maxRetriesDown?: number;
  /**
  * The maximum time, in seconds, that a monitor waits to connect before it times out.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#timeout Lbpool#timeout}
  */
  readonly timeout: number;
  /**
  * Available values is 'HTTP', 'HTTPS', 'PING', 'TCP', 'TLS-HELLO', 'UDP-CONNECT
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#type Lbpool#type}
  */
  readonly type: string;
  /**
  * The HTTP URL path of the request sent by the monitor to test the health of a backend member.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#url_path Lbpool#url_path}
  */
...
export interface LbpoolSessionPersistence {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#cookie_name Lbpool#cookie_name}
  */
  readonly cookieName?: string;
  /**
  * The netmask used to determine SCTP or UDP SOURCE_IP session persistence.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#persistence_granularity Lbpool#persistence_granularity}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#persistence_timeout Lbpool#persistence_timeout}
  */
...
export interface LbpoolTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#create Lbpool#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#delete Lbpool#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#update Lbpool#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool gcore_lbpool}
*/
export class Lbpool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lbpool that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/lbpool gcore_lbpool} Resource
  *
  * @param scope The scope in which to define this construct
