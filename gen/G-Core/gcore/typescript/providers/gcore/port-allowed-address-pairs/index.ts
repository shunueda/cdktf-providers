// https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/port_allowed_address_pairs
...
export interface PortAllowedAddressPairsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/port_allowed_address_pairs#id PortAllowedAddressPairs#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/port_allowed_address_pairs#port_id PortAllowedAddressPairs#port_id}
  */
  readonly portId: string;
  /**
  * Project ID in which the port exists.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/port_allowed_address_pairs#project_id PortAllowedAddressPairs#project_id}
  */
  readonly projectId?: number;
  /**
  * Project name in which the port exists.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/port_allowed_address_pairs#project_name PortAllowedAddressPairs#project_name}
  */
  readonly projectName?: string;
  /**
  * Region ID where the port is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/port_allowed_address_pairs#region_id PortAllowedAddressPairs#region_id}
  */
  readonly regionId?: number;
  /**
  * Region name where the port is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/port_allowed_address_pairs#region_name PortAllowedAddressPairs#region_name}
  */
  readonly regionName?: string;
  /**
  * allowed_address_pair block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/port_allowed_address_pairs#allowed_address_pair PortAllowedAddressPairs#allowed_address_pair}
  */
...
export interface PortAllowedAddressPairsAllowedAddressPair {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/port_allowed_address_pairs#ip_address PortAllowedAddressPairs#ip_address}
  */
  readonly ipAddress: string;
  /**
  * MAC address of the allowed address pair. If omitted, port's MAC address will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/port_allowed_address_pairs#mac_address PortAllowedAddressPairs#mac_address}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/port_allowed_address_pairs gcore_port_allowed_address_pairs}
*/
export class PortAllowedAddressPairs extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PortAllowedAddressPairs that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/port_allowed_address_pairs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/port_allowed_address_pairs gcore_port_allowed_address_pairs} Resource
  *
  * @param scope The scope in which to define this construct
