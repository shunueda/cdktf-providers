// https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip
...
export interface ReservedfixedipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#fixed_ip_address Reservedfixedip#fixed_ip_address}
  */
  readonly fixedIpAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#id Reservedfixedip#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#ip_family Reservedfixedip#ip_family}
  */
  readonly ipFamily?: string;
  /**
  * Flag to indicate whether the port is a virtual IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#is_vip Reservedfixedip#is_vip}
  */
  readonly isVip?: boolean | cdktf.IResolvable;
  /**
  * ID of the desired network. Should be used together with `subnet_id`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#network_id Reservedfixedip#network_id}
  */
  readonly networkId?: string;
  /**
  * ID of the port underlying the reserved fixed IP. Can be passed with type `port` or retrieved after creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#port_id Reservedfixedip#port_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#project_id Reservedfixedip#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#project_name Reservedfixedip#project_name}
  */
  readonly projectName?: string;
  /**
  * ID of the desired region to create reserved fixed ip in. Alternative for `region_name`. One of them should be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#region_id Reservedfixedip#region_id}
  */
  readonly regionId?: number;
  /**
  * Name of the desired region to create reserved fixed ip in. Alternative for `region_id`. One of them should be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#region_name Reservedfixedip#region_name}
  */
  readonly regionName?: string;
  /**
  * ID of the desired subnet. Can be used together with `network_id`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#subnet_id Reservedfixedip#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * Type of the reserved fixed ip for create. Available values are 'external', 'subnet', 'any_subnet', 'ip_address', 'port'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#type Reservedfixedip#type}
  */
  readonly type: string;
  /**
  * allowed_address_pairs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#allowed_address_pairs Reservedfixedip#allowed_address_pairs}
  */
...
export interface ReservedfixedipAllowedAddressPairs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#ip_address Reservedfixedip#ip_address}
  */
  readonly ipAddress?: string;
  /**
  * MAC address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#mac_address Reservedfixedip#mac_address}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip gcore_reservedfixedip}
*/
export class Reservedfixedip extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Reservedfixedip that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.32.4/docs/resources/reservedfixedip gcore_reservedfixedip} Resource
  *
  * @param scope The scope in which to define this construct
