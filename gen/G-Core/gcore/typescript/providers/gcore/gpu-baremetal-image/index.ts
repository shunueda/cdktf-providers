// https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image
...
export interface GpuBaremetalImageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#architecture GpuBaremetalImage#architecture}
  */
  readonly architecture?: string;
  /**
  * When True, image cannot be deleted unless all volumes, created from it, are deleted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#cow_format GpuBaremetalImage#cow_format}
  */
  readonly cowFormat?: boolean | cdktf.IResolvable;
  /**
  * Specifies the type of firmware with which to boot the guest
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#hw_firmware_type GpuBaremetalImage#hw_firmware_type}
  */
  readonly hwFirmwareType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#id GpuBaremetalImage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#metadata GpuBaremetalImage#metadata}
  */
  readonly metadata?: { [key: string]: string };
  /**
  * Image name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#name GpuBaremetalImage#name}
  */
  readonly name: string;
  /**
  * OS Distribution, i.e. Debian, CentOS, Ubuntu, CoreOS etc
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#os_distro GpuBaremetalImage#os_distro}
  */
  readonly osDistro?: string;
  /**
  * The operating system installed on the image
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#os_type GpuBaremetalImage#os_type}
  */
  readonly osType?: string;
  /**
  * OS version, i.e. 19.04 (for Ubuntu) or 9.4 for Debian
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#os_version GpuBaremetalImage#os_version}
  */
  readonly osVersion?: string;
  /**
  * Project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#project_id GpuBaremetalImage#project_id}
  */
  readonly projectId?: number;
  /**
  * Project name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#project_name GpuBaremetalImage#project_name}
  */
  readonly projectName?: string;
  /**
  * Region ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#region_id GpuBaremetalImage#region_id}
  */
  readonly regionId?: number;
  /**
  * Region name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#region_name GpuBaremetalImage#region_name}
  */
  readonly regionName?: string;
  /**
  * Permission to use a ssh key in instances
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#ssh_key GpuBaremetalImage#ssh_key}
  */
  readonly sshKey?: string;
  /**
  * Image URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#url GpuBaremetalImage#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image gcore_gpu_baremetal_image}
*/
export class GpuBaremetalImage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GpuBaremetalImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/gpu_baremetal_image gcore_gpu_baremetal_image} Resource
  *
  * @param scope The scope in which to define this construct
