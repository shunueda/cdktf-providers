// https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp
...
export interface StorageSftpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp#client_id StorageSftp#client_id}
  */
  readonly clientId?: number;
  /**
  * A http sftp entry point for new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp#generated_http_endpoint StorageSftp#generated_http_endpoint}
  */
  readonly generatedHttpEndpoint?: string;
  /**
  * An auto generated sftp password for new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp#generated_password StorageSftp#generated_password}
  */
  readonly generatedPassword?: boolean | cdktf.IResolvable;
  /**
  * A ssh sftp entry point for new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp#generated_sftp_endpoint StorageSftp#generated_sftp_endpoint}
  */
  readonly generatedSftpEndpoint?: string;
  /**
  * A expires date of storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp#http_expires_header_value StorageSftp#http_expires_header_value}
  */
  readonly httpExpiresHeaderValue?: string;
  /**
  * An alias of storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp#http_servername_alias StorageSftp#http_servername_alias}
  */
  readonly httpServernameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp#id StorageSftp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp#location StorageSftp#location}
  */
  readonly location: string;
  /**
  * A name of new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp#name StorageSftp#name}
  */
  readonly name: string;
  /**
  * A sftp password for new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp#password StorageSftp#password}
  */
  readonly password?: string;
  /**
  * An ssh keys IDs to link with new sftp storage resource only. https://storage.gcore.com/ssh-key/list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp#ssh_key_id StorageSftp#ssh_key_id}
  */
  readonly sshKeyId?: number[];
  /**
  * An id of new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp#storage_id StorageSftp#storage_id}
  */
  readonly storageId?: number;
  /**
  * A temporary flag. An internal cheat, to skip update ssh keys. Skip it.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp#update_after_create StorageSftp#update_after_create}
  */
  readonly updateAfterCreate?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp gcore_storage_sftp}
*/
export class StorageSftp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageSftp that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/storage_sftp gcore_storage_sftp} Resource
  *
  * @param scope The scope in which to define this construct
