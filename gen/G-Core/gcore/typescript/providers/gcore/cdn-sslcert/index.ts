// https://registry.terraform.io/providers/g-core/gcore/0.32.1/docs/resources/cdn_sslcert
...
export interface CdnSslcertConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.1/docs/resources/cdn_sslcert#automated CdnSslcert#automated}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.1/docs/resources/cdn_sslcert#cert CdnSslcert#cert}
  */
  readonly cert?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.1/docs/resources/cdn_sslcert#id CdnSslcert#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.1/docs/resources/cdn_sslcert#name CdnSslcert#name}
  */
  readonly name: string;
  /**
  * The private key of the SSL certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.1/docs/resources/cdn_sslcert#private_key CdnSslcert#private_key}
  */
  readonly privateKey?: string;
  /**
  * Defines whether to check the SSL certificate for a signature from a trusted certificate authority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.1/docs/resources/cdn_sslcert#validate_root_ca CdnSslcert#validate_root_ca}
  */
  readonly validateRootCa?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.32.1/docs/resources/cdn_sslcert gcore_cdn_sslcert}
*/
export class CdnSslcert extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnSslcert that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.32.1/docs/resources/cdn_sslcert#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.32.1/docs/resources/cdn_sslcert gcore_cdn_sslcert} Resource
  *
  * @param scope The scope in which to define this construct
