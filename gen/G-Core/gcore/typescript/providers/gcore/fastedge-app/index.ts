// https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/fastedge_app
...
export interface FastedgeAppConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/fastedge_app#binary FastedgeApp#binary}
  */
  readonly binary?: number;
  /**
  * Application comment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/fastedge_app#comment FastedgeApp#comment}
  */
  readonly comment?: string;
  /**
  * Logging enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/fastedge_app#debug FastedgeApp#debug}
  */
  readonly debug?: boolean | cdktf.IResolvable;
  /**
  * Environment variables.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/fastedge_app#env FastedgeApp#env}
  */
  readonly env?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/fastedge_app#id FastedgeApp#id}
  *
  ...
  * Application name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/fastedge_app#name FastedgeApp#name}
  */
  readonly name?: string;
  /**
  * Response headers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/fastedge_app#rsp_headers FastedgeApp#rsp_headers}
  */
  readonly rspHeaders?: { [key: string]: string };
  /**
  * Secret variables.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/fastedge_app#secrets FastedgeApp#secrets}
  */
  readonly secrets?: { [key: string]: number };
  /**
  * Status code. Possible values are: enabled, disabled, suspended.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/fastedge_app#status FastedgeApp#status}
  */
  readonly status: string;
  /**
  * Application template id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/fastedge_app#template FastedgeApp#template}
  */
  readonly template?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/fastedge_app gcore_fastedge_app}
*/
export class FastedgeApp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FastedgeApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/fastedge_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.32.0/docs/resources/fastedge_app gcore_fastedge_app} Resource
  *
  * @param scope The scope in which to define this construct
