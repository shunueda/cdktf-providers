// https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/inference_secret
...
export interface InferenceSecretConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/inference_secret#data_aws_access_key_id InferenceSecret#data_aws_access_key_id}
  */
  readonly dataAwsAccessKeyId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/inference_secret#data_aws_secret_access_key InferenceSecret#data_aws_secret_access_key}
  */
  readonly dataAwsSecretAccessKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/inference_secret#id InferenceSecret#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/inference_secret#name InferenceSecret#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/inference_secret#project_id InferenceSecret#project_id}
  */
  readonly projectId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/inference_secret#project_name InferenceSecret#project_name}
  */
  readonly projectName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/inference_secret gcore_inference_secret}
*/
export class InferenceSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InferenceSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/inference_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/inference_secret gcore_inference_secret} Resource
  *
  * @param scope The scope in which to define this construct
