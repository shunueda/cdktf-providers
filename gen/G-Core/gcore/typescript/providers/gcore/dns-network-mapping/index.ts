// https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/dns_network_mapping
...
export interface DnsNetworkMappingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/dns_network_mapping#id DnsNetworkMapping#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/dns_network_mapping#name DnsNetworkMapping#name}
  */
  readonly name: string;
  /**
  * mapping block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/dns_network_mapping#mapping DnsNetworkMapping#mapping}
  */
  readonly mapping: DnsNetworkMappingMapping[] | cdktf.IResolvable;
}
export interface DnsNetworkMappingMapping {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/dns_network_mapping#cidr4 DnsNetworkMapping#cidr4}
  */
  readonly cidr4?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/dns_network_mapping#cidr6 DnsNetworkMapping#cidr6}
  */
  readonly cidr6?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/dns_network_mapping#tags DnsNetworkMapping#tags}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/dns_network_mapping gcore_dns_network_mapping}
*/
export class DnsNetworkMapping extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsNetworkMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/dns_network_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/dns_network_mapping gcore_dns_network_mapping} Resource
  *
  * @param scope The scope in which to define this construct
