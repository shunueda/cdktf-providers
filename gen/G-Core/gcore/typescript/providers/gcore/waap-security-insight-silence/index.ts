// https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/waap_security_insight_silence
...
export interface WaapSecurityInsightSilenceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/waap_security_insight_silence#author WaapSecurityInsightSilence#author}
  */
  readonly author: string;
  /**
  * A comment explaining the reason for the silence.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/waap_security_insight_silence#comment WaapSecurityInsightSilence#comment}
  */
  readonly comment: string;
  /**
  * The WAAP domain ID for which the insight silence is configured.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/waap_security_insight_silence#domain_id WaapSecurityInsightSilence#domain_id}
  */
  readonly domainId: number;
  /**
  * The date and time the silence expires in ISO 8601 format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/waap_security_insight_silence#expire_at WaapSecurityInsightSilence#expire_at}
  */
  readonly expireAt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/waap_security_insight_silence#id WaapSecurityInsightSilence#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/waap_security_insight_silence#insight_type WaapSecurityInsightSilence#insight_type}
  */
  readonly insightType: string;
  /**
  * A hash table of label names and values that apply to the insight silence.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/waap_security_insight_silence#labels WaapSecurityInsightSilence#labels}
  */
  readonly labels: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/waap_security_insight_silence gcore_waap_security_insight_silence}
*/
export class WaapSecurityInsightSilence extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WaapSecurityInsightSilence that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/waap_security_insight_silence#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/waap_security_insight_silence gcore_waap_security_insight_silence} Resource
  *
  * @param scope The scope in which to define this construct
