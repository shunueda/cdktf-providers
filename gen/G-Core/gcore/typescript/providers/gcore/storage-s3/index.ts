// https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/storage_s3
...
export interface StorageS3Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/storage_s3#client_id StorageS3#client_id}
  */
  readonly clientId?: number;
  /**
  * A s3 access key for new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/storage_s3#generated_access_key StorageS3#generated_access_key}
  */
  readonly generatedAccessKey?: string;
  /**
  * A s3 entry point for new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/storage_s3#generated_endpoint StorageS3#generated_endpoint}
  */
  readonly generatedEndpoint?: string;
  /**
  * A http s3 entry point for new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/storage_s3#generated_http_endpoint StorageS3#generated_http_endpoint}
  */
  readonly generatedHttpEndpoint?: string;
  /**
  * A s3 endpoint for new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/storage_s3#generated_s3_endpoint StorageS3#generated_s3_endpoint}
  */
  readonly generatedS3Endpoint?: string;
  /**
  * A s3 secret key for new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/storage_s3#generated_secret_key StorageS3#generated_secret_key}
  */
  readonly generatedSecretKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/storage_s3#id StorageS3#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/storage_s3#location StorageS3#location}
  */
  readonly location: string;
  /**
  * A name of new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/storage_s3#name StorageS3#name}
  */
  readonly name: string;
  /**
  * An id of new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/storage_s3#storage_id StorageS3#storage_id}
  */
  readonly storageId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/storage_s3 gcore_storage_s3}
*/
export class StorageS3 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageS3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/storage_s3#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.32.5/docs/resources/storage_s3 gcore_storage_s3} Resource
  *
  * @param scope The scope in which to define this construct
