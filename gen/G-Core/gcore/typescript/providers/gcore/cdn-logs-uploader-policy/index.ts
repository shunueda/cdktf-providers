// https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy
...
export interface CdnLogsUploaderPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#date_format CdnLogsUploaderPolicy#date_format}
  */
  readonly dateFormat?: string;
  /**
  * Description of the policy. Default value is empty string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#description CdnLogsUploaderPolicy#description}
  */
  readonly description?: string;
  /**
  * Field delimiter for logs. Default value is \".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#field_delimiter CdnLogsUploaderPolicy#field_delimiter}
  */
  readonly fieldDelimiter?: string;
  /**
  * Field separator for logs. Default value is a space character.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#field_separator CdnLogsUploaderPolicy#field_separator}
  */
  readonly fieldSeparator?: string;
  /**
  * List of fields to include in logs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#fields CdnLogsUploaderPolicy#fields}
  */
  readonly fields: string[];
  /**
  * Template for log file name. Default value is "{{YYYY}}/{{MM}}/{{DD}}/{{HH}}/{{mm}}/{{ss}}/{{HOST}}_{{CNAME}}_access.log.gz".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#file_name_template CdnLogsUploaderPolicy#file_name_template}
  */
  readonly fileNameTemplate?: string;
  /**
  * Format type for logs. Default value is empty string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#format_type CdnLogsUploaderPolicy#format_type}
  */
  readonly formatType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#id CdnLogsUploaderPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#include_empty_logs CdnLogsUploaderPolicy#include_empty_logs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#include_shield_logs CdnLogsUploaderPolicy#include_shield_logs}
  */
  readonly includeShieldLogs?: boolean | cdktf.IResolvable;
  /**
  * Name of the policy. Default value is "Policy".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#name CdnLogsUploaderPolicy#name}
  */
  readonly name?: string;
  /**
  * Interval in minutes to retry failed uploads. Default value is 60.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#retry_interval_minutes CdnLogsUploaderPolicy#retry_interval_minutes}
  */
  readonly retryIntervalMinutes?: number;
  /**
  * Interval in minutes to rotate logs. Default value is 5.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#rotate_interval_minutes CdnLogsUploaderPolicy#rotate_interval_minutes}
  */
  readonly rotateIntervalMinutes?: number;
  /**
  * Threshold in lines to rotate logs. Default value is 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#rotate_threshold_lines CdnLogsUploaderPolicy#rotate_threshold_lines}
  */
  readonly rotateThresholdLines?: number;
  /**
  * Threshold in MB to rotate logs. Default value is nil.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#rotate_threshold_mb CdnLogsUploaderPolicy#rotate_threshold_mb}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#tags CdnLogsUploaderPolicy#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy gcore_cdn_logs_uploader_policy}
*/
export class CdnLogsUploaderPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnLogsUploaderPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.32.2/docs/resources/cdn_logs_uploader_policy gcore_cdn_logs_uploader_policy} Resource
  *
  * @param scope The scope in which to define this construct
