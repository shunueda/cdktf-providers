// https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/cdn_applied_preset
...
export interface CdnAppliedPresetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/cdn_applied_preset#id CdnAppliedPreset#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/cdn_applied_preset#object_id CdnAppliedPreset#object_id}
  */
  readonly objectId: number;
  /**
  * ID of CDN preset which will be applied to the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/cdn_applied_preset#preset_id CdnAppliedPreset#preset_id}
  */
  readonly presetId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/cdn_applied_preset gcore_cdn_applied_preset}
*/
export class CdnAppliedPreset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnAppliedPreset that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/cdn_applied_preset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.31.4/docs/resources/cdn_applied_preset gcore_cdn_applied_preset} Resource
  *
  * @param scope The scope in which to define this construct
