// https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/waap_api_path
...
export interface WaapApiPathConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/waap_api_path#api_groups WaapApiPath#api_groups}
  */
  readonly apiGroups?: string[];
  /**
  * The API version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/waap_api_path#api_version WaapApiPath#api_version}
  */
  readonly apiVersion?: string;
  /**
  * The WAAP domain ID for which the API Path is configured.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/waap_api_path#domain_id WaapApiPath#domain_id}
  */
  readonly domainId: number;
  /**
  * The different HTTP schemes an API path can have. It must be one of these values: HTTP, HTTPS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/waap_api_path#http_scheme WaapApiPath#http_scheme}
  */
  readonly httpScheme: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/waap_api_path#id WaapApiPath#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/waap_api_path#method WaapApiPath#method}
  */
  readonly method: string;
  /**
  * The API path, locations that are saved for resource IDs will be put in curly brackets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/waap_api_path#path WaapApiPath#path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/waap_api_path#status WaapApiPath#status}
  */
  readonly status?: string;
  /**
  * An array of tags associated with the API path.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/waap_api_path#tags WaapApiPath#tags}
  */
  readonly tags?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/waap_api_path gcore_waap_api_path}
*/
export class WaapApiPath extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WaapApiPath that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/waap_api_path#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcore/0.31.3/docs/resources/waap_api_path gcore_waap_api_path} Resource
  *
  * @param scope The scope in which to define this construct
