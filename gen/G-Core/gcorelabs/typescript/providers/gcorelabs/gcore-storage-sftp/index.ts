// https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp
...
export interface GcoreStorageSftpConfig extends cdktf.TerraformMetaArguments {
  /**
  * An client id of new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp#client_id GcoreStorageSftp#client_id}
  */
  readonly clientId?: number;
  /**
  * A http sftp entry point for new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp#generated_http_endpoint GcoreStorageSftp#generated_http_endpoint}
  */
  readonly generatedHttpEndpoint?: string;
  /**
  * An auto generated sftp password for new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp#generated_password GcoreStorageSftp#generated_password}
  */
  readonly generatedPassword?: boolean | cdktf.IResolvable;
  /**
  * A ssh sftp entry point for new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp#generated_sftp_endpoint GcoreStorageSftp#generated_sftp_endpoint}
  */
  readonly generatedSftpEndpoint?: string;
  /**
  * A expires date of storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp#http_expires_header_value GcoreStorageSftp#http_expires_header_value}
  */
  readonly httpExpiresHeaderValue?: string;
  /**
  * An alias of storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp#http_servername_alias GcoreStorageSftp#http_servername_alias}
  */
  readonly httpServernameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp#id GcoreStorageSftp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp#location GcoreStorageSftp#location}
  */
  readonly location: string;
  /**
  * A name of new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp#name GcoreStorageSftp#name}
  */
  readonly name: string;
  /**
  * A sftp password for new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp#password GcoreStorageSftp#password}
  */
  readonly password?: string;
  /**
  * An ssh keys IDs to link with new sftp storage resource only. https://storage.gcorelabs.com/ssh-key/list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp#ssh_key_id GcoreStorageSftp#ssh_key_id}
  */
  readonly sshKeyId?: number[];
  /**
  * An id of new storage resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp#storage_id GcoreStorageSftp#storage_id}
  */
  readonly storageId?: number;
  /**
  * A temporary flag. An internal cheat, to skip update ssh keys. Skip it.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp#update_after_create GcoreStorageSftp#update_after_create}
  */
  readonly updateAfterCreate?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp gcore_storage_sftp}
*/
export class GcoreStorageSftp extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a GcoreStorageSftp resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the GcoreStorageSftp to import
  * @param importFromId The id of the existing GcoreStorageSftp that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GcoreStorageSftp to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_storage_sftp gcore_storage_sftp} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GcoreStorageSftpConfig
  */
  public constructor(scope: Construct, id: string, config: GcoreStorageSftpConfig) {
    super(scope, id, {
