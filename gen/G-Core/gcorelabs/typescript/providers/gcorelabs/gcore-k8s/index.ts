// https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s
...
export interface GcoreK8SConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#auto_healing_enabled GcoreK8S#auto_healing_enabled}
  */
  readonly autoHealingEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#external_dns_enabled GcoreK8S#external_dns_enabled}
  */
  readonly externalDnsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#fixed_network GcoreK8S#fixed_network}
  */
  readonly fixedNetwork: string;
  /**
  * Subnet should has router
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#fixed_subnet GcoreK8S#fixed_subnet}
  */
  readonly fixedSubnet: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#id GcoreK8S#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#keypair GcoreK8S#keypair}
  */
  readonly keypair: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#last_updated GcoreK8S#last_updated}
  */
  readonly lastUpdated?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#master_lb_floating_ip_enabled GcoreK8S#master_lb_floating_ip_enabled}
  */
  readonly masterLbFloatingIpEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#name GcoreK8S#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#pods_ip_pool GcoreK8S#pods_ip_pool}
  */
  readonly podsIpPool?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#project_id GcoreK8S#project_id}
  */
  readonly projectId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#project_name GcoreK8S#project_name}
  */
  readonly projectName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#region_id GcoreK8S#region_id}
  */
  readonly regionId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#region_name GcoreK8S#region_name}
  */
  readonly regionName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#services_ip_pool GcoreK8S#services_ip_pool}
  */
  readonly servicesIpPool?: string;
  /**
  * pool block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#pool GcoreK8S#pool}
  */
  readonly pool: GcoreK8SPool;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#timeouts GcoreK8S#timeouts}
  */
  readonly timeouts?: GcoreK8STimeouts;
}
export interface GcoreK8SPool {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#docker_volume_size GcoreK8S#docker_volume_size}
  */
  readonly dockerVolumeSize?: number;
  /**
  * Available value is 'standard', 'ssd_hiiops', 'cold', 'ultra'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#docker_volume_type GcoreK8S#docker_volume_type}
  */
  readonly dockerVolumeType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#flavor_id GcoreK8S#flavor_id}
  */
  readonly flavorId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#max_node_count GcoreK8S#max_node_count}
  */
  readonly maxNodeCount: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#min_node_count GcoreK8S#min_node_count}
  */
  ...
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#node_count GcoreK8S#node_count}
  */
  readonly nodeCount: number;
}

export function gcoreK8SPoolToTerraform(struct?: GcoreK8SPoolOutputReference | GcoreK8SPool): any {
...
export function gcoreK8SPoolToHclTerraform(struct?: GcoreK8SPoolOutputReference | GcoreK8SPool): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GcoreK8SPoolOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GcoreK8SPool | undefined {
  ...
  public set internalValue(value: GcoreK8SPool | undefined) {
    if (value === undefined) {
...
export interface GcoreK8STimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#create GcoreK8S#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#update GcoreK8S#update}
  */
  readonly update?: string;
}

export function gcoreK8STimeoutsToTerraform(struct?: GcoreK8STimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function gcoreK8STimeoutsToHclTerraform(struct?: GcoreK8STimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GcoreK8STimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GcoreK8STimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GcoreK8STimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s gcore_k8s}
*/
export class GcoreK8S extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a GcoreK8S resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the GcoreK8S to import
  * @param importFromId The id of the existing GcoreK8S that should be imported. Refer to the {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GcoreK8S to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/g-core/gcorelabs/0.3.63/docs/resources/gcore_k8s gcore_k8s} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GcoreK8SConfig
  */
  public constructor(scope: Construct, id: string, config: GcoreK8SConfig) {
    super(scope, id, {
    ...
    this._externalDnsEnabled = config.externalDnsEnabled;
  ...
  // external_dns_enabled - computed: false, optional: true, required: false
  private _externalDnsEnabled?: boolean | cdktf.IResolvable; 
  public get externalDnsEnabled() {
    return this.getBooleanAttribute('external_dns_enabled');
  }
  public set externalDnsEnabled(value: boolean | cdktf.IResolvable) {
    this._externalDnsEnabled = value;
  }
  public resetExternalDnsEnabled() {
    this._externalDnsEnabled = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get externalDnsEnabledInput() {
    return this._externalDnsEnabled;
  }
  ...
  private _pool = new GcoreK8SPoolOutputReference(this, "pool");
  public get pool() {
    return this._pool;
  }
  public putPool(value: GcoreK8SPool) {
  ...
  private _timeouts = new GcoreK8STimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GcoreK8STimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      external_dns_enabled: cdktf.booleanToTerraform(this._externalDnsEnabled),
      ...
      pool: gcoreK8SPoolToTerraform(this._pool.internalValue),
      timeouts: gcoreK8STimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      external_dns_enabled: {
        value: cdktf.booleanToHclTerraform(this._externalDnsEnabled),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      pool: {
        value: gcoreK8SPoolToHclTerraform(this._pool.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GcoreK8SPoolList",
      },
      timeouts: {
        value: gcoreK8STimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GcoreK8STimeouts",
      },
    };
