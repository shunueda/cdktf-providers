// https://registry.terraform.io/providers/gavinbunney/kubectl/1.19.0/docs/data-sources/server_version
...
export interface DataKubectlServerVersionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.19.0/docs/data-sources/server_version#id DataKubectlServerVersion#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.19.0/docs/data-sources/server_version kubectl_server_version}
*/
export class DataKubectlServerVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKubectlServerVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.19.0/docs/data-sources/server_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/gavinbunney/kubectl/1.19.0/docs/data-sources/server_version kubectl_server_version} Data Source
  *
  * @param scope The scope in which to define this construct
