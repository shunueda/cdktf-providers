// https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_azure
...
export interface IntegrationAzureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Azure client ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_azure#client_id IntegrationAzure#client_id}
  */
  readonly clientId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_azure#credentials IntegrationAzure#credentials}
  */
  readonly credentials: IntegrationAzureCredentials;
  /**
  * Name of the integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_azure#name IntegrationAzure#name}
  */
  readonly name: string;
  /**
  * Scan VMs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_azure#scan_vms IntegrationAzure#scan_vms}
  */
  readonly scanVms?: boolean | cdktf.IResolvable;
  /**
  * Mondoo space identifier. If there is no space ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_azure#space_id IntegrationAzure#space_id}
  */
  readonly spaceId?: string;
  /**
  * List of Azure subscriptions to scan.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_azure#subscription_allow_list IntegrationAzure#subscription_allow_list}
  */
  readonly subscriptionAllowList?: string[];
  /**
  * List of Azure subscriptions to exclude from scanning.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_azure#subscription_deny_list IntegrationAzure#subscription_deny_list}
  */
  readonly subscriptionDenyList?: string[];
  /**
  * Azure tenant ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_azure#tenant_id IntegrationAzure#tenant_id}
  */
...
export interface IntegrationAzureCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_azure#pem_file IntegrationAzure#pem_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_azure mondoo_integration_azure}
*/
export class IntegrationAzure extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationAzure that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_azure#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_azure mondoo_integration_azure} Resource
  *
  * @param scope The scope in which to define this construct
