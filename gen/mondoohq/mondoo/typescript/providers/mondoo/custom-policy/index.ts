// https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/custom_policy
...
export interface CustomPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/custom_policy#content CustomPolicy#content}
  */
  readonly content?: string;
  /**
  * If set to true, existing policies are overwritten.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/custom_policy#overwrite CustomPolicy#overwrite}
  */
  readonly overwrite?: boolean | cdktf.IResolvable;
  /**
  * Mondoo scope MRN. Provide this if not uploading to a space
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/custom_policy#scope_mrn CustomPolicy#scope_mrn}
  */
  readonly scopeMrn?: string;
  /**
  * A path to the data you want to upload. Must be defined if content is not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/custom_policy#source CustomPolicy#source}
  */
  readonly source?: string;
  /**
  * Mondoo space identifier. If there is no space ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/custom_policy#space_id CustomPolicy#space_id}
  */
  readonly spaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/custom_policy mondoo_custom_policy}
*/
export class CustomPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/custom_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/custom_policy mondoo_custom_policy} Resource
  *
  * @param scope The scope in which to define this construct
