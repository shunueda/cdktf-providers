// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/exception
...
export interface ExceptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/exception#action Exception#action}
  */
  readonly action?: string;
  /**
  * List of check MRNs to set exceptions for. If set, `vulnerability_mrns` must not be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/exception#check_mrns Exception#check_mrns}
  */
  readonly checkMrns?: string[];
  /**
  * The ID of the exception
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/exception#exception_id Exception#exception_id}
  */
  readonly exceptionId?: string;
  /**
  * Description why the exception is required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/exception#justification Exception#justification}
  */
  readonly justification?: string;
  /**
  * The MRN of the scope (either asset mrn or space mrn).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/exception#scope_mrn Exception#scope_mrn}
  */
  readonly scopeMrn?: string;
  /**
  * The date when the exception is no longer valid.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/exception#valid_until Exception#valid_until}
  */
  readonly validUntil?: string;
  /**
  * List of vulnerability MRNs to set exceptions for. If set, `check_mrns` must not be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/exception#vulnerability_mrns Exception#vulnerability_mrns}
  */
  readonly vulnerabilityMrns?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/exception mondoo_exception}
*/
export class Exception extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Exception that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/exception#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/exception mondoo_exception} Resource
  *
  * @param scope The scope in which to define this construct
