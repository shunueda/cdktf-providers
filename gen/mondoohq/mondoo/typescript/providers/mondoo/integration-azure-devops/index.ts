// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_azure_devops
...
export interface IntegrationAzureDevopsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_azure_devops#auto_close_tickets IntegrationAzureDevops#auto_close_tickets}
  */
  readonly autoCloseTickets: boolean | cdktf.IResolvable;
  /**
  * The AzureDevops AutoCreateTickets
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_azure_devops#auto_create_tickets IntegrationAzureDevops#auto_create_tickets}
  */
  readonly autoCreateTickets: boolean | cdktf.IResolvable;
  /**
  * The AzureDevops ClientSecret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_azure_devops#client_secret IntegrationAzureDevops#client_secret}
  */
  readonly clientSecret: string;
  /**
  * The AzureDevops DefaultProjectName
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_azure_devops#default_project_name IntegrationAzureDevops#default_project_name}
  */
  readonly defaultProjectName?: string;
  /**
  * Name of the integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_azure_devops#name IntegrationAzureDevops#name}
  */
  readonly name: string;
  /**
  * The AzureDevops OrganizationUrl
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_azure_devops#organization_url IntegrationAzureDevops#organization_url}
  */
  readonly organizationUrl: string;
  /**
  * The AzureDevops ServicePrincipalId
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_azure_devops#service_principal_id IntegrationAzureDevops#service_principal_id}
  */
  readonly servicePrincipalId: string;
  /**
  * Mondoo space identifier. If there is no space ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_azure_devops#space_id IntegrationAzureDevops#space_id}
  */
  readonly spaceId?: string;
  /**
  * The AzureDevops TenantId
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_azure_devops#tenant_id IntegrationAzureDevops#tenant_id}
  */
  readonly tenantId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_azure_devops mondoo_integration_azure_devops}
*/
export class IntegrationAzureDevops extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationAzureDevops that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_azure_devops#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_azure_devops mondoo_integration_azure_devops} Resource
  *
  * @param scope The scope in which to define this construct
