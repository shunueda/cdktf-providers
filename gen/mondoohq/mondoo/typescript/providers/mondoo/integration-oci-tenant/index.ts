// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_oci_tenant
...
export interface IntegrationOciTenantConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_oci_tenant#credentials IntegrationOciTenant#credentials}
  */
  readonly credentials: IntegrationOciTenantCredentials;
  /**
  * Name of the integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_oci_tenant#name IntegrationOciTenant#name}
  */
  readonly name?: string;
  /**
  * OCI region
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_oci_tenant#region IntegrationOciTenant#region}
  */
  readonly region: string;
  /**
  * Mondoo space identifier. If there is no space ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_oci_tenant#space_id IntegrationOciTenant#space_id}
  */
  readonly spaceId?: string;
  /**
  * OCI tenancy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_oci_tenant#tenancy IntegrationOciTenant#tenancy}
  */
  readonly tenancy: string;
  /**
  * OCI user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_oci_tenant#user IntegrationOciTenant#user}
  */
  readonly user: string;
}
export interface IntegrationOciTenantCredentials {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_oci_tenant#fingerprint IntegrationOciTenant#fingerprint}
  */
  readonly fingerprint: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_oci_tenant#private_key IntegrationOciTenant#private_key}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_oci_tenant mondoo_integration_oci_tenant}
*/
export class IntegrationOciTenant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationOciTenant that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_oci_tenant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_oci_tenant mondoo_integration_oci_tenant} Resource
  *
  * @param scope The scope in which to define this construct
