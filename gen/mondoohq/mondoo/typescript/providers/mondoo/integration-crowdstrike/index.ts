// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_crowdstrike
...
export interface IntegrationCrowdstrikeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_crowdstrike#client_id IntegrationCrowdstrike#client_id}
  */
  readonly clientId: string;
  /**
  * Client Secret used for authentication with CrowdStrike Falcon platform.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_crowdstrike#client_secret IntegrationCrowdstrike#client_secret}
  */
  readonly clientSecret: string;
  /**
  * The Falcon Cloud to connect.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_crowdstrike#cloud IntegrationCrowdstrike#cloud}
  */
  readonly cloud?: string;
  /**
  * CID selector for cases when the client ID and secret has access to multiple CIDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_crowdstrike#member_cid IntegrationCrowdstrike#member_cid}
  */
  readonly memberCid?: string;
  /**
  * Name of the integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_crowdstrike#name IntegrationCrowdstrike#name}
  */
  readonly name: string;
  /**
  * Mondoo space identifier. If there is no space ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_crowdstrike#space_id IntegrationCrowdstrike#space_id}
  */
  readonly spaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_crowdstrike mondoo_integration_crowdstrike}
*/
export class IntegrationCrowdstrike extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationCrowdstrike that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_crowdstrike#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_crowdstrike mondoo_integration_crowdstrike} Resource
  *
  * @param scope The scope in which to define this construct
