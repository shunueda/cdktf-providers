// https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/registration_token
...
export interface RegistrationTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/registration_token#description RegistrationToken#description}
  */
  readonly description?: string;
  /**
  * The date and time when the token will expire.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/registration_token#expires_at RegistrationToken#expires_at}
  */
  readonly expiresAt?: string;
  /**
  * The duration after which the token will expire. Format: 1h, 1d, 1w, 1m, 1y
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/registration_token#expires_in RegistrationToken#expires_in}
  */
  readonly expiresIn?: string;
  /**
  * If set to true, the token will not expire.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/registration_token#no_expiration RegistrationToken#no_expiration}
  */
  readonly noExpiration?: boolean | cdktf.IResolvable;
  /**
  * If set to true, the token is revoked.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/registration_token#revoked RegistrationToken#revoked}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/registration_token#space_id RegistrationToken#space_id}
  */
  readonly spaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/registration_token mondoo_registration_token}
*/
export class RegistrationToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RegistrationToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/registration_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/registration_token mondoo_registration_token} Resource
  *
  * @param scope The scope in which to define this construct
