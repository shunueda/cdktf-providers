// https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/iam_binding
...
export interface IamBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/iam_binding#identity_mrn IamBinding#identity_mrn}
  */
  readonly identityMrn: string;
  /**
  * MRN of the resource (organization, space, workspace, etc.) to grant access to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/iam_binding#resource_mrn IamBinding#resource_mrn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/iam_binding#roles IamBinding#roles}
  */
  readonly roles: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/iam_binding mondoo_iam_binding}
*/
export class IamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/iam_binding mondoo_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
