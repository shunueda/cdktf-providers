// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab
...
export interface IntegrationGitlabConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab#base_url IntegrationGitlab#base_url}
  */
  readonly baseUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab#credentials IntegrationGitlab#credentials}
  */
  readonly credentials: IntegrationGitlabCredentials;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab#discovery IntegrationGitlab#discovery}
  */
  readonly discovery?: IntegrationGitlabDiscovery;
  /**
  * Group to assign the integration to (by default all groups are discovered).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab#group IntegrationGitlab#group}
  */
  readonly group?: string;
  /**
  * Name of the integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab#name IntegrationGitlab#name}
  */
  readonly name: string;
  /**
  * Mondoo space identifier. If there is no space ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab#space_id IntegrationGitlab#space_id}
  */
...
export interface IntegrationGitlabCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab#token IntegrationGitlab#token}
  */
...
export interface IntegrationGitlabDiscovery {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab#groups IntegrationGitlab#groups}
  */
  readonly groups?: boolean | cdktf.IResolvable;
  /**
  * Enable discovery of Kubernetes manifests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab#k8s_manifests IntegrationGitlab#k8s_manifests}
  */
  readonly k8SManifests?: boolean | cdktf.IResolvable;
  /**
  * Enable discovery of GitLab projects.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab#projects IntegrationGitlab#projects}
  */
  readonly projects?: boolean | cdktf.IResolvable;
  /**
  * Enable discovery of Terraform configurations.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab#terraform IntegrationGitlab#terraform}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab mondoo_integration_gitlab}
*/
export class IntegrationGitlab extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationGitlab that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_gitlab mondoo_integration_gitlab} Resource
  *
  * @param scope The scope in which to define this construct
