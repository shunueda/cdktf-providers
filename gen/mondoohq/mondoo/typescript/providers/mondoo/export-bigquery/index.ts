// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/export_bigquery
...
export interface ExportBigqueryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/export_bigquery#dataset_id ExportBigquery#dataset_id}
  */
  readonly datasetId: string;
  /**
  * A descriptive name for the integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/export_bigquery#name ExportBigquery#name}
  */
  readonly name: string;
  /**
  * Google service account JSON key content.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/export_bigquery#service_account_key ExportBigquery#service_account_key}
  */
  readonly serviceAccountKey: string;
  /**
  * Mondoo space identifier. If there is no space ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/export_bigquery#space_id ExportBigquery#space_id}
  */
  readonly spaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/export_bigquery mondoo_export_bigquery}
*/
export class ExportBigquery extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExportBigquery that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/export_bigquery#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/export_bigquery mondoo_export_bigquery} Resource
  *
  * @param scope The scope in which to define this construct
