// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/querypack_assignment
...
export interface QuerypackAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/querypack_assignment#querypacks QuerypackAssignment#querypacks}
  */
  readonly querypacks?: string[];
  /**
  * Mondoo space identifier. If there is no space ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/querypack_assignment#space_id QuerypackAssignment#space_id}
  */
  readonly spaceId?: string;
  /**
  * QueryPack Assignment State (enabled or disabled).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/querypack_assignment#state QuerypackAssignment#state}
  */
  readonly state?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/querypack_assignment mondoo_querypack_assignment}
*/
export class QuerypackAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuerypackAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/querypack_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/querypack_assignment mondoo_querypack_assignment} Resource
  *
  * @param scope The scope in which to define this construct
