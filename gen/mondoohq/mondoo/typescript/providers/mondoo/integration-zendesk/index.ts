// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk
...
export interface IntegrationZendeskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk#auto_close IntegrationZendesk#auto_close}
  */
  readonly autoClose?: boolean | cdktf.IResolvable;
  /**
  * Automatically create tickets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk#auto_create IntegrationZendesk#auto_create}
  */
  readonly autoCreate?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk#credentials IntegrationZendesk#credentials}
  */
  readonly credentials: IntegrationZendeskCredentials;
  /**
  * Custom fields to add to the Zendesk ticket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk#custom_fields IntegrationZendesk#custom_fields}
  */
  readonly customFields?: IntegrationZendeskCustomFields[] | cdktf.IResolvable;
  /**
  * Zendesk email.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk#email IntegrationZendesk#email}
  */
  readonly email: string;
  /**
  * Name of the integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk#name IntegrationZendesk#name}
  */
  readonly name: string;
  /**
  * Mondoo space identifier. If there is no space ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk#space_id IntegrationZendesk#space_id}
  */
  readonly spaceId?: string;
  /**
  * Zendesk subdomain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk#subdomain IntegrationZendesk#subdomain}
  */
...
export interface IntegrationZendeskCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk#token IntegrationZendesk#token}
  */
...
export interface IntegrationZendeskCustomFields {
  ...
  * Custom field ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk#id IntegrationZendesk#id}
  *
  ...
  * Custom field value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk#value IntegrationZendesk#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk mondoo_integration_zendesk}
*/
export class IntegrationZendesk extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationZendesk that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/integration_zendesk mondoo_integration_zendesk} Resource
  *
  * @param scope The scope in which to define this construct
