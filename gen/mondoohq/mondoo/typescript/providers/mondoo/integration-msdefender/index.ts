// https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_msdefender
...
export interface IntegrationMsdefenderConfig extends cdktf.TerraformMetaArguments {
  ...
  * Azure client ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_msdefender#client_id IntegrationMsdefender#client_id}
  */
  readonly clientId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_msdefender#credentials IntegrationMsdefender#credentials}
  */
  readonly credentials: IntegrationMsdefenderCredentials;
  /**
  * Name of the integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_msdefender#name IntegrationMsdefender#name}
  */
  readonly name: string;
  /**
  * Mondoo space identifier. If there is no space ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_msdefender#space_id IntegrationMsdefender#space_id}
  */
  readonly spaceId?: string;
  /**
  * List of Azure subscriptions from which to import Defender data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_msdefender#subscription_allow_list IntegrationMsdefender#subscription_allow_list}
  */
  readonly subscriptionAllowList?: string[];
  /**
  * List of Azure subscriptions to exclude from imports.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_msdefender#subscription_deny_list IntegrationMsdefender#subscription_deny_list}
  */
  readonly subscriptionDenyList?: string[];
  /**
  * Azure tenant ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_msdefender#tenant_id IntegrationMsdefender#tenant_id}
  */
...
export interface IntegrationMsdefenderCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_msdefender#pem_file IntegrationMsdefender#pem_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_msdefender mondoo_integration_msdefender}
*/
export class IntegrationMsdefender extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationMsdefender that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_msdefender#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/integration_msdefender mondoo_integration_msdefender} Resource
  *
  * @param scope The scope in which to define this construct
