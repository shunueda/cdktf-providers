// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/data-sources/policies
...
export interface DataMondooPoliciesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/data-sources/policies#assigned_only DataMondooPolicies#assigned_only}
  */
  readonly assignedOnly?: boolean | cdktf.IResolvable;
  /**
  * Catalog type of either `ALL`, `POLICY` or `QUERYPACK`. Defaults to `ALL`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/data-sources/policies#catalog_type DataMondooPolicies#catalog_type}
  */
  readonly catalogType?: string;
  /**
  * Space ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/data-sources/policies#space_id DataMondooPolicies#space_id}
  */
  readonly spaceId?: string;
  /**
  * Space MRN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/data-sources/policies#space_mrn DataMondooPolicies#space_mrn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/data-sources/policies mondoo_policies}
*/
export class DataMondooPolicies extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMondooPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/data-sources/policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/data-sources/policies mondoo_policies} Data Source
  *
  * @param scope The scope in which to define this construct
