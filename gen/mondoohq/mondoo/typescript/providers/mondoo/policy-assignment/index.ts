// https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/policy_assignment
...
export interface PolicyAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/policy_assignment#policies PolicyAssignment#policies}
  */
  readonly policies: string[];
  /**
  * Mondoo space identifier. If there is no space ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/policy_assignment#space_id PolicyAssignment#space_id}
  */
  readonly spaceId?: string;
  /**
  * Policy assignment state (preview, enabled, or disabled).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/policy_assignment#state PolicyAssignment#state}
  */
  readonly state?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/policy_assignment mondoo_policy_assignment}
*/
export class PolicyAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/policy_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.34.0/docs/resources/policy_assignment mondoo_policy_assignment} Resource
  *
  * @param scope The scope in which to define this construct
