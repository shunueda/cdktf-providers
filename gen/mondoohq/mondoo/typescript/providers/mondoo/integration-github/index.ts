// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github
...
export interface IntegrationGithubConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github#credentials IntegrationGithub#credentials}
  */
  readonly credentials: IntegrationGithubCredentials;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github#discovery IntegrationGithub#discovery}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github#force_replace IntegrationGithub#force_replace}
  */
  readonly forceReplace?: boolean | cdktf.IResolvable;
  /**
  * Name of the integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github#name IntegrationGithub#name}
  */
  readonly name: string;
  /**
  * GitHub owner.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github#owner IntegrationGithub#owner}
  */
  readonly owner: string;
  /**
  * GitHub repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github#repository IntegrationGithub#repository}
  */
  readonly repository?: string;
  /**
  * List of GitHub repositories to scan.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github#repository_allow_list IntegrationGithub#repository_allow_list}
  */
  readonly repositoryAllowList?: string[];
  /**
  * List of GitHub repositories to exclude from scanning.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github#repository_deny_list IntegrationGithub#repository_deny_list}
  */
  readonly repositoryDenyList?: string[];
  /**
  * Mondoo space identifier. If there is no space ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github#space_id IntegrationGithub#space_id}
  */
...
export interface IntegrationGithubCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github#token IntegrationGithub#token}
  */
...
export interface IntegrationGithubDiscovery {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github#k8s_manifests IntegrationGithub#k8s_manifests}
  */
  readonly k8SManifests?: boolean | cdktf.IResolvable;
  /**
  * Enable discovery of Terraform configurations.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github#terraform IntegrationGithub#terraform}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github mondoo_integration_github}
*/
export class IntegrationGithub extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationGithub that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs/resources/integration_github mondoo_integration_github} Resource
  *
  * @param scope The scope in which to define this construct
