// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/framework_assignment
...
export interface FrameworkAssignmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/framework_assignment#enabled FrameworkAssignment#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Compliance framework MRN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/framework_assignment#framework_mrn FrameworkAssignment#framework_mrn}
  */
  readonly frameworkMrn: string[];
  /**
  * Mondoo space identifier. If there's no ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/framework_assignment#space_id FrameworkAssignment#space_id}
  */
  readonly spaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/framework_assignment mondoo_framework_assignment}
*/
export class FrameworkAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FrameworkAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/framework_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/framework_assignment mondoo_framework_assignment} Resource
  *
  * @param scope The scope in which to define this construct
