// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/iam_workload_identity_binding
...
export interface IamWorkloadIdentityBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/iam_workload_identity_binding#allowed_audiences IamWorkloadIdentityBinding#allowed_audiences}
  */
  readonly allowedAudiences?: string[];
  /**
  * Description of the binding.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/iam_workload_identity_binding#description IamWorkloadIdentityBinding#description}
  */
  readonly description?: string;
  /**
  * Expiration in seconds associated with the binding.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/iam_workload_identity_binding#expiration IamWorkloadIdentityBinding#expiration}
  */
  readonly expiration?: number;
  /**
  * URI for the token issuer, e.g. https://accounts.google.com.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/iam_workload_identity_binding#issuer_uri IamWorkloadIdentityBinding#issuer_uri}
  */
  readonly issuerUri: string;
  /**
  * List of additional configurations to confirm.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/iam_workload_identity_binding#mappings IamWorkloadIdentityBinding#mappings}
  */
  readonly mappings?: { [key: string]: string };
  /**
  * Name of the binding.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/iam_workload_identity_binding#name IamWorkloadIdentityBinding#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/iam_workload_identity_binding#roles IamWorkloadIdentityBinding#roles}
  */
  readonly roles?: string[];
  /**
  * The MRN of the scope (either space or organization). If there is no scope, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/iam_workload_identity_binding#scope_mrn IamWorkloadIdentityBinding#scope_mrn}
  */
  readonly scopeMrn?: string;
  /**
  * Unique identifier to confirm.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/iam_workload_identity_binding#subject IamWorkloadIdentityBinding#subject}
  */
  readonly subject: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/iam_workload_identity_binding mondoo_iam_workload_identity_binding}
*/
export class IamWorkloadIdentityBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamWorkloadIdentityBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/iam_workload_identity_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/iam_workload_identity_binding mondoo_iam_workload_identity_binding} Resource
  *
  * @param scope The scope in which to define this construct
