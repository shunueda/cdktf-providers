// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_google_workspace
...
export interface IntegrationGoogleWorkspaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_google_workspace#customer_id IntegrationGoogleWorkspace#customer_id}
  */
  readonly customerId: string;
  /**
  * The GoogleWorkspace ImpersonatedUserEmail
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_google_workspace#impersonated_user_email IntegrationGoogleWorkspace#impersonated_user_email}
  */
  readonly impersonatedUserEmail: string;
  /**
  * Name of the integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_google_workspace#name IntegrationGoogleWorkspace#name}
  */
  readonly name: string;
  /**
  * The GoogleWorkspace ServiceAccount
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_google_workspace#service_account IntegrationGoogleWorkspace#service_account}
  */
  readonly serviceAccount?: string;
  /**
  * Mondoo space identifier. If there is no space ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_google_workspace#space_id IntegrationGoogleWorkspace#space_id}
  */
  readonly spaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_google_workspace mondoo_integration_google_workspace}
*/
export class IntegrationGoogleWorkspace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationGoogleWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_google_workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.3/docs/resources/integration_google_workspace mondoo_integration_google_workspace} Resource
  *
  * @param scope The scope in which to define this construct
