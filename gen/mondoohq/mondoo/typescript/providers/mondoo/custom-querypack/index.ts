// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/custom_querypack
...
export interface CustomQuerypackConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/custom_querypack#content CustomQuerypack#content}
  */
  readonly content?: string;
  /**
  * If set to true, existing policies are overwritten.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/custom_querypack#overwrite CustomQuerypack#overwrite}
  */
  readonly overwrite?: boolean | cdktf.IResolvable;
  /**
  * A path to the data you want to upload. Must be defined if content is not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/custom_querypack#source CustomQuerypack#source}
  */
  readonly source?: string;
  /**
  * Mondoo space identifier. If there is no space ID, the provider space is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/custom_querypack#space_id CustomQuerypack#space_id}
  */
  readonly spaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/custom_querypack mondoo_custom_querypack}
*/
export class CustomQuerypack extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomQuerypack that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/custom_querypack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.0/docs/resources/custom_querypack mondoo_custom_querypack} Resource
  *
  * @param scope The scope in which to define this construct
