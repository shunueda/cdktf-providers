// https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs
...
export interface MondooProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs#credentials MondooProvider#credentials}
  */
  readonly credentials?: string;
  /**
  * The endpoint url of the server to manage resources.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs#endpoint MondooProvider#endpoint}
  */
  readonly endpoint?: string;
  /**
  * The default region to manage resources in. Valid regions are `us` or `eu`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs#region MondooProvider#region}
  */
  readonly region?: string;
  /**
  * The default space to manage resources in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs#space MondooProvider#space}
  */
  readonly space?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs#alias MondooProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs mondoo}
*/
export class MondooProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing MondooProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mondoohq/mondoo/0.35.2/docs mondoo} Resource
  *
  * @param scope The scope in which to define this construct
