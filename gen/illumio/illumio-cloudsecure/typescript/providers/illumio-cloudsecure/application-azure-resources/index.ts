// https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/application_azure_resources
...
export interface ApplicationAzureResourcesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/application_azure_resources#application_id ApplicationAzureResources#application_id}
  */
  readonly applicationId: string;
  /**
  * IDs of Azure resources to associate with the CloudSecure application.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/application_azure_resources#resource_ids ApplicationAzureResources#resource_ids}
  */
  readonly resourceIds?: string[];
  /**
  * ID of the Azure subscription the Azure resources belong to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/application_azure_resources#subscription_id ApplicationAzureResources#subscription_id}
  */
  readonly subscriptionId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/application_azure_resources illumio-cloudsecure_application_azure_resources}
*/
export class ApplicationAzureResources extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationAzureResources that should be imported. Refer to the {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/application_azure_resources#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/application_azure_resources illumio-cloudsecure_application_azure_resources} Resource
  *
  * @param scope The scope in which to define this construct
