// https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/aws_flow_logs_s3_bucket
...
export interface AwsFlowLogsS3BucketConfig extends cdktf.TerraformMetaArguments {
  ...
  * AWS account ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/aws_flow_logs_s3_bucket#account_id AwsFlowLogsS3Bucket#account_id}
  */
  readonly accountId: string;
  /**
  * ARN of the AWS S3 bucket containing flow logs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/aws_flow_logs_s3_bucket#s3_bucket_arn AwsFlowLogsS3Bucket#s3_bucket_arn}
  */
  readonly s3BucketArn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/aws_flow_logs_s3_bucket illumio-cloudsecure_aws_flow_logs_s3_bucket}
*/
export class AwsFlowLogsS3Bucket extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsFlowLogsS3Bucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/aws_flow_logs_s3_bucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/aws_flow_logs_s3_bucket illumio-cloudsecure_aws_flow_logs_s3_bucket} Resource
  *
  * @param scope The scope in which to define this construct
