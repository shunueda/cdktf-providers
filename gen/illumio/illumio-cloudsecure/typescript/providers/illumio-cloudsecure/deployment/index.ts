// https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment
...
export interface DeploymentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#aws_account_ids Deployment#aws_account_ids}
  */
  readonly awsAccountIds?: string[];
  /**
  * AWS regions included in this deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#aws_regions Deployment#aws_regions}
  */
  readonly awsRegions?: string[];
  /**
  * IDs of AWS subnets included in this deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#aws_subnet_ids Deployment#aws_subnet_ids}
  */
  readonly awsSubnetIds?: string[];
  /**
  * AWS tags included in this deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#aws_tags Deployment#aws_tags}
  */
  readonly awsTags?: DeploymentAwsTags[] | cdktf.IResolvable;
  /**
  * IDs of AWS VPCs included in this deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#aws_vpc_ids Deployment#aws_vpc_ids}
  */
  readonly awsVpcIds?: string[];
  /**
  * Azure regions included in this deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#azure_regions Deployment#azure_regions}
  */
  readonly azureRegions?: string[];
  /**
  * IDs of Azure subnets included in this deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#azure_subnet_ids Deployment#azure_subnet_ids}
  */
  readonly azureSubnetIds?: string[];
  /**
  * IDs of Azure subscriptions included in this deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#azure_subscription_ids Deployment#azure_subscription_ids}
  */
  readonly azureSubscriptionIds?: string[];
  /**
  * Azure tags included in this deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#azure_tags Deployment#azure_tags}
  */
  readonly azureTags?: DeploymentAzureTags[] | cdktf.IResolvable;
  /**
  * IDs of Azure VNets included in this deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#azure_vnet_ids Deployment#azure_vnet_ids}
  */
  readonly azureVnetIds?: string[];
  /**
  * Description of Cloudsecure deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#description Deployment#description}
  */
  readonly description?: string;
  /**
  * Name of the CloudSecure deployment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#name Deployment#name}
  */
  readonly name: string;
}
export interface DeploymentAwsTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#key Deployment#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#value Deployment#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment illumio-cloudsecure_deployment}
*/
export class Deployment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Deployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/deployment illumio-cloudsecure_deployment} Resource
  *
  * @param scope The scope in which to define this construct
