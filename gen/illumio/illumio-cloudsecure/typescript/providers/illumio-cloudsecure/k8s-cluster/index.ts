// https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/k8s_cluster
...
export interface K8SClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/k8s_cluster#illumio_region K8SCluster#illumio_region}
  */
  readonly illumioRegion: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/k8s_cluster illumio-cloudsecure_k8s_cluster}
*/
export class K8SCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing K8SCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/k8s_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/illumio/illumio-cloudsecure/1.7.0/docs/resources/k8s_cluster illumio-cloudsecure_k8s_cluster} Resource
  *
  * @param scope The scope in which to define this construct
