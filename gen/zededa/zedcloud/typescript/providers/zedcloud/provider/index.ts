// https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs
...
export interface ZedcloudProviderConfig {
  ...
  * ZEDCloud API token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs#zedcloud_token ZedcloudProvider#zedcloud_token}
  */
  readonly zedcloudToken?: string;
  /**
  * ZEDCloud url. Ex: https://zedcontrol.zededa.net
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs#zedcloud_url ZedcloudProvider#zedcloud_url}
  */
  readonly zedcloudUrl?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs#alias ZedcloudProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs zedcloud}
*/
export class ZedcloudProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ZedcloudProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs zedcloud} Resource
  *
  * @param scope The scope in which to define this construct
