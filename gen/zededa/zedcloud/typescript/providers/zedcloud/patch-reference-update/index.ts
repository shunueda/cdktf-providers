// https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs/resources/patch_reference_update
...
export interface PatchReferenceUpdateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs/resources/patch_reference_update#app_inst_id_list PatchReferenceUpdate#app_inst_id_list}
  */
  readonly appInstIdList: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs/resources/patch_reference_update#id PatchReferenceUpdate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs/resources/patch_reference_update#patchenvelope_id PatchReferenceUpdate#patchenvelope_id}
  */
  readonly patchenvelopeId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs/resources/patch_reference_update#project_id PatchReferenceUpdate#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs/resources/patch_reference_update zedcloud_patch_reference_update}
*/
export class PatchReferenceUpdate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PatchReferenceUpdate that should be imported. Refer to the {@link https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs/resources/patch_reference_update#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/zededa/zedcloud/2.5.0/docs/resources/patch_reference_update zedcloud_patch_reference_update} Resource
  *
  * @param scope The scope in which to define this construct
