// https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/domain_authentication
...
export interface DomainAuthenticationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/domain_authentication#automatic_security DomainAuthentication#automatic_security}
  */
  readonly automaticSecurity?: boolean | cdktf.IResolvable;
  /**
  * Add a custom DKIM selector. Accepts three letters or numbers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/domain_authentication#custom_dkim_selector DomainAuthentication#custom_dkim_selector}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/domain_authentication#custom_spf DomainAuthentication#custom_spf}
  */
  readonly customSpf?: boolean | cdktf.IResolvable;
  /**
  * Domain being authenticated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/domain_authentication#domain DomainAuthentication#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/domain_authentication#id DomainAuthentication#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/domain_authentication#ips DomainAuthentication#ips}
  */
  readonly ips?: string[];
  /**
  * Whether to use this authenticated domain as the fallback if no authenticated domains match the sender's domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/domain_authentication#is_default DomainAuthentication#is_default}
  */
  readonly isDefault?: boolean | cdktf.IResolvable;
  /**
  * The subdomain to use for this authenticated domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/domain_authentication#subdomain DomainAuthentication#subdomain}
  */
  readonly subdomain?: string;
  /**
  * Indicates if this is a valid authenticated domain or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/domain_authentication#valid DomainAuthentication#valid}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/domain_authentication sendgrid_domain_authentication}
*/
export class DomainAuthentication extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DomainAuthentication that should be imported. Refer to the {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/domain_authentication#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/domain_authentication sendgrid_domain_authentication} Resource
  *
  * @param scope The scope in which to define this construct
