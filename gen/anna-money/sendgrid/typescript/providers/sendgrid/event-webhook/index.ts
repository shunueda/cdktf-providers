// https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook
...
export interface EventWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#bounce EventWebhook#bounce}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#click EventWebhook#click}
  */
  readonly click?: boolean | cdktf.IResolvable;
  /**
  * Recipient's email server temporarily rejected message.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#deferred EventWebhook#deferred}
  */
  readonly deferred?: boolean | cdktf.IResolvable;
  /**
  * Message has been successfully delivered to the receiving server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#delivered EventWebhook#delivered}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#dropped EventWebhook#dropped}
  */
  readonly dropped?: boolean | cdktf.IResolvable;
  /**
  * Indicates if the event webhook is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#enabled EventWebhook#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#group_resubscribe EventWebhook#group_resubscribe}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#group_unsubscribe EventWebhook#group_unsubscribe}
  */
  readonly groupUnsubscribe?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#id EventWebhook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#oauth_client_id EventWebhook#oauth_client_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#oauth_client_secret EventWebhook#oauth_client_secret}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#oauth_token_url EventWebhook#oauth_token_url}
  */
  readonly oauthTokenUrl?: string;
  /**
  * Recipient has opened the HTML message. You need to enable Open Tracking for getting this type of event.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#open EventWebhook#open}
  */
  readonly open?: boolean | cdktf.IResolvable;
  /**
  * Message has been received and is ready to be delivered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#processed EventWebhook#processed}
  */
  readonly processed?: boolean | cdktf.IResolvable;
  /**
  * Should the event webhook use signing?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#signed EventWebhook#signed}
  */
  readonly signed?: boolean | cdktf.IResolvable;
  /**
  * Recipient marked a message as spam.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#spam_report EventWebhook#spam_report}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#unsubscribe EventWebhook#unsubscribe}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#url EventWebhook#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook sendgrid_event_webhook}
*/
export class EventWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/event_webhook sendgrid_event_webhook} Resource
  *
  * @param scope The scope in which to define this construct
