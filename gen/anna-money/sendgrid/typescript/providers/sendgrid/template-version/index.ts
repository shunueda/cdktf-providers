// https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/template_version
...
export interface TemplateVersionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/template_version#active TemplateVersion#active}
  */
  readonly active?: number;
  /**
  * The editor used in the UI, allowed values: code (default), design.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/template_version#editor TemplateVersion#editor}
  */
  readonly editor?: string;
  /**
  * If true (default), plain_content is always generated from html_content. If false, plain_content is not altered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/template_version#generate_plain_content TemplateVersion#generate_plain_content}
  */
  readonly generatePlainContent?: boolean | cdktf.IResolvable;
  /**
  * The HTML content of the version, maximum of 1048576 bytes allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/template_version#html_content TemplateVersion#html_content}
  */
  readonly htmlContent?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/template_version#id TemplateVersion#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/template_version#name TemplateVersion#name}
  */
  readonly name: string;
  /**
  * Text/plain content of the transactional template version, maximum of 1048576 bytes allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/template_version#plain_content TemplateVersion#plain_content}
  */
  readonly plainContent?: string;
  /**
  * Subject of the new transactional template version, max length: 255.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/template_version#subject TemplateVersion#subject}
  */
  readonly subject: string;
  /**
  * ID of the transactional template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/template_version#template_id TemplateVersion#template_id}
  */
  readonly templateId: string;
  /**
  * For dynamic templates only, the mock json data that will be used for template preview and test sends.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/template_version#test_data TemplateVersion#test_data}
  */
  readonly testData?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/template_version sendgrid_template_version}
*/
export class TemplateVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TemplateVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/template_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/anna-money/sendgrid/1.1.2/docs/resources/template_version sendgrid_template_version} Resource
  *
  * @param scope The scope in which to define this construct
