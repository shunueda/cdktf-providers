// https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet
...
export interface FirstFreeSubnetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#allow_ip_requests FirstFreeSubnet#allow_ip_requests}
  */
  readonly allowIpRequests?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#create_ptr_records FirstFreeSubnet#create_ptr_records}
  */
  readonly createPtrRecords?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#custom_fields FirstFreeSubnet#custom_fields}
  */
  readonly customFields?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#description FirstFreeSubnet#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#display_hostnames FirstFreeSubnet#display_hostnames}
  */
  readonly displayHostnames?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#host_discovery_enabled FirstFreeSubnet#host_discovery_enabled}
  */
  readonly hostDiscoveryEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#id FirstFreeSubnet#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#include_in_ping FirstFreeSubnet#include_in_ping}
  */
  readonly includeInPing?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#is_folder FirstFreeSubnet#is_folder}
  */
  readonly isFolder?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#is_full FirstFreeSubnet#is_full}
  */
  readonly isFull?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#linked_subnet_id FirstFreeSubnet#linked_subnet_id}
  */
  readonly linkedSubnetId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#location_id FirstFreeSubnet#location_id}
  */
  readonly locationId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#master_subnet_id FirstFreeSubnet#master_subnet_id}
  */
  readonly masterSubnetId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#nameserver_id FirstFreeSubnet#nameserver_id}
  */
  readonly nameserverId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#parent_subnet_id FirstFreeSubnet#parent_subnet_id}
  */
  readonly parentSubnetId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#resolve_dns FirstFreeSubnet#resolve_dns}
  */
  readonly resolveDns?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#scan_agent_id FirstFreeSubnet#scan_agent_id}
  */
  readonly scanAgentId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#section_id FirstFreeSubnet#section_id}
  */
  readonly sectionId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#show_name FirstFreeSubnet#show_name}
  */
  readonly showName?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#subnet_mask FirstFreeSubnet#subnet_mask}
  */
  readonly subnetMask: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#utilization_threshold FirstFreeSubnet#utilization_threshold}
  */
  readonly utilizationThreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#vlan_id FirstFreeSubnet#vlan_id}
  */
  readonly vlanId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#vrf_id FirstFreeSubnet#vrf_id}
  */
  readonly vrfId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet phpipam_first_free_subnet}
*/
export class FirstFreeSubnet extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a FirstFreeSubnet resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the FirstFreeSubnet to import
  * @param importFromId The id of the existing FirstFreeSubnet that should be imported. Refer to the {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the FirstFreeSubnet to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lord-kyron/phpipam/1.6.2/docs/resources/first_free_subnet phpipam_first_free_subnet} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options FirstFreeSubnetConfig
  */
  public constructor(scope: Construct, id: string, config: FirstFreeSubnetConfig) {
    super(scope, id, {
    ...
    this._parentSubnetId = config.parentSubnetId;
  ...
  // parent_subnet_id - computed: false, optional: false, required: true
  private _parentSubnetId?: number; 
  public get parentSubnetId() {
    return this.getNumberAttribute('parent_subnet_id');
  }
  public set parentSubnetId(value: number) {
    this._parentSubnetId = value;
  }
  // Temporarily expose input value. Use with caution.
  public get parentSubnetIdInput() {
    return this._parentSubnetId;
  }
  ...
  // subnet_address - computed: true, optional: false, required: false
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      parent_subnet_id: cdktf.numberToTerraform(this._parentSubnetId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      parent_subnet_id: {
        value: cdktf.numberToHclTerraform(this._parentSubnetId),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
