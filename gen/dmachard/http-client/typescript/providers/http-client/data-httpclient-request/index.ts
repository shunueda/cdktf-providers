// https://registry.terraform.io/providers/dmachard/http-client/0.4.0/docs/data-sources/httpclient_request
...
export interface DataHttpclientRequestConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dmachard/http-client/0.4.0/docs/data-sources/httpclient_request#id DataHttpclientRequest#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dmachard/http-client/0.4.0/docs/data-sources/httpclient_request#insecure DataHttpclientRequest#insecure}
  */
  readonly insecure?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dmachard/http-client/0.4.0/docs/data-sources/httpclient_request#password DataHttpclientRequest#password}
  */
  readonly password?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dmachard/http-client/0.4.0/docs/data-sources/httpclient_request#request_body DataHttpclientRequest#request_body}
  */
  readonly requestBody?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dmachard/http-client/0.4.0/docs/data-sources/httpclient_request#request_headers DataHttpclientRequest#request_headers}
  */
  readonly requestHeaders?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dmachard/http-client/0.4.0/docs/data-sources/httpclient_request#request_method DataHttpclientRequest#request_method}
  */
  readonly requestMethod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dmachard/http-client/0.4.0/docs/data-sources/httpclient_request#url DataHttpclientRequest#url}
  */
  readonly url: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dmachard/http-client/0.4.0/docs/data-sources/httpclient_request#username DataHttpclientRequest#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dmachard/http-client/0.4.0/docs/data-sources/httpclient_request httpclient_request}
*/
export class DataHttpclientRequest extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHttpclientRequest that should be imported. Refer to the {@link https://registry.terraform.io/providers/dmachard/http-client/0.4.0/docs/data-sources/httpclient_request#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dmachard/http-client/0.4.0/docs/data-sources/httpclient_request httpclient_request} Data Source
  *
  * @param scope The scope in which to define this construct
