// https://registry.terraform.io/providers/dmachard/http-client/0.9.0/docs
...
export interface HttpClientProviderConfig {
  ...
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dmachard/http-client/0.9.0/docs#alias HttpClientProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dmachard/http-client/0.9.0/docs http-client}
*/
export class HttpClientProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing HttpClientProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/dmachard/http-client/0.9.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dmachard/http-client/0.9.0/docs http-client} Resource
  *
  * @param scope The scope in which to define this construct
