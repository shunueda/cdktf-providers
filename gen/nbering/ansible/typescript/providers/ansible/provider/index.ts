// https://registry.terraform.io/providers/nbering/ansible/1.0.4/docs
...
export interface AnsibleProviderConfig {
  ...
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nbering/ansible/1.0.4/docs#alias AnsibleProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nbering/ansible/1.0.4/docs ansible}
*/
export class AnsibleProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing AnsibleProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/nbering/ansible/1.0.4/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nbering/ansible/1.0.4/docs ansible} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: AnsibleProviderConfig = {}) {
    super(scope, id, {
      ...
      terraformProviderSource: 'nbering/ansible'
    });
