// https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/private_endpoint_services
...
export interface PrivateEndpointServicesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/private_endpoint_services#cluster_id PrivateEndpointServices#cluster_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/private_endpoint_services cockroach_private_endpoint_services}
*/
export class PrivateEndpointServices extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateEndpointServices that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/private_endpoint_services#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/private_endpoint_services cockroach_private_endpoint_services} Resource
  *
  * @param scope The scope in which to define this construct
