// https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/client_ca_cert
...
export interface ClientCaCertConfig extends cdktf.TerraformMetaArguments {
  ...
  * Cluster ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/client_ca_cert#id ClientCaCert#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/client_ca_cert#x509_pem_cert ClientCaCert#x509_pem_cert}
  */
  readonly x509PemCert: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/client_ca_cert cockroach_client_ca_cert}
*/
export class ClientCaCert extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClientCaCert that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/client_ca_cert#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/client_ca_cert cockroach_client_ca_cert} Resource
  *
  * @param scope The scope in which to define this construct
