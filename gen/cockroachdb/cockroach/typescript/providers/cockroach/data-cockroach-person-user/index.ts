// https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/data-sources/person_user
...
export interface DataCockroachPersonUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/data-sources/person_user#email DataCockroachPersonUser#email}
  */
  readonly email: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/data-sources/person_user cockroach_person_user}
*/
export class DataCockroachPersonUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCockroachPersonUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/data-sources/person_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/data-sources/person_user cockroach_person_user} Data Source
  *
  * @param scope The scope in which to define this construct
