// https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/finalize_version_upgrade
...
export interface FinalizeVersionUpgradeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/finalize_version_upgrade#cockroach_version FinalizeVersionUpgrade#cockroach_version}
  */
  readonly cockroachVersion: string;
  /**
  * Cluster ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/finalize_version_upgrade#id FinalizeVersionUpgrade#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/finalize_version_upgrade cockroach_finalize_version_upgrade}
*/
export class FinalizeVersionUpgrade extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FinalizeVersionUpgrade that should be imported. Refer to the {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/finalize_version_upgrade#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cockroachdb/cockroach/1.17.0/docs/resources/finalize_version_upgrade cockroach_finalize_version_upgrade} Resource
  *
  * @param scope The scope in which to define this construct
