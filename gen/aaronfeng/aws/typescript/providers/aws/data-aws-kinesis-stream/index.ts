// https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/kinesis_stream
...
export interface DataAwsKinesisStreamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/kinesis_stream#id DataAwsKinesisStream#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/kinesis_stream#name DataAwsKinesisStream#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/kinesis_stream#tags DataAwsKinesisStream#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/kinesis_stream aws_kinesis_stream}
*/
export class DataAwsKinesisStream extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsKinesisStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/kinesis_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/kinesis_stream aws_kinesis_stream} Data Source
  *
  * @param scope The scope in which to define this construct
