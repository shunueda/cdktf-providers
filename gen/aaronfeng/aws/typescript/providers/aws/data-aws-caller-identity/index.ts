// https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/caller_identity
...
export interface DataAwsCallerIdentityConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/caller_identity#id DataAwsCallerIdentity#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/caller_identity aws_caller_identity}
*/
export class DataAwsCallerIdentity extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsCallerIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/caller_identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/caller_identity aws_caller_identity} Data Source
  *
  * @param scope The scope in which to define this construct
