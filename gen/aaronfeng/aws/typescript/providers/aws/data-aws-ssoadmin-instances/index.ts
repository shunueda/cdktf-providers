// https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/ssoadmin_instances
...
export interface DataAwsSsoadminInstancesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/ssoadmin_instances#id DataAwsSsoadminInstances#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/ssoadmin_instances aws_ssoadmin_instances}
*/
export class DataAwsSsoadminInstances extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsSsoadminInstances that should be imported. Refer to the {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/ssoadmin_instances#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/ssoadmin_instances aws_ssoadmin_instances} Data Source
  *
  * @param scope The scope in which to define this construct
