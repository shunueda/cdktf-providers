// https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/iam_account_alias
...
export interface DataAwsIamAccountAliasConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/iam_account_alias#id DataAwsIamAccountAlias#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/iam_account_alias aws_iam_account_alias}
*/
export class DataAwsIamAccountAlias extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsIamAccountAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/iam_account_alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/iam_account_alias aws_iam_account_alias} Data Source
  *
  * @param scope The scope in which to define this construct
