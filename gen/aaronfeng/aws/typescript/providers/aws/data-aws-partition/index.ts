// https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/partition
...
export interface DataAwsPartitionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/partition#id DataAwsPartition#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/partition aws_partition}
*/
export class DataAwsPartition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsPartition that should be imported. Refer to the {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/partition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/partition aws_partition} Data Source
  *
  * @param scope The scope in which to define this construct
