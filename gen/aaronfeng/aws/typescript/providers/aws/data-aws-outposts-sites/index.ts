// https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/outposts_sites
...
export interface DataAwsOutpostsSitesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/outposts_sites#id DataAwsOutpostsSites#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/outposts_sites aws_outposts_sites}
*/
export class DataAwsOutpostsSites extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsOutpostsSites that should be imported. Refer to the {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/outposts_sites#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/outposts_sites aws_outposts_sites} Data Source
  *
  * @param scope The scope in which to define this construct
