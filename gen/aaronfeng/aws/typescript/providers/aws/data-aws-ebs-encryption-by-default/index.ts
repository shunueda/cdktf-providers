// https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/ebs_encryption_by_default
...
export interface DataAwsEbsEncryptionByDefaultConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/ebs_encryption_by_default#id DataAwsEbsEncryptionByDefault#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/ebs_encryption_by_default aws_ebs_encryption_by_default}
*/
export class DataAwsEbsEncryptionByDefault extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAwsEbsEncryptionByDefault that should be imported. Refer to the {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/ebs_encryption_by_default#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aaronfeng/aws/3.29.6/docs/data-sources/ebs_encryption_by_default aws_ebs_encryption_by_default} Data Source
  *
  * @param scope The scope in which to define this construct
