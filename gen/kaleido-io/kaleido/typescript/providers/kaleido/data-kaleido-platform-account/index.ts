// https://registry.terraform.io/providers/kaleido-io/kaleido/1.2.0/docs/data-sources/platform_account
...
/**
* Represents a {@link https://registry.terraform.io/providers/kaleido-io/kaleido/1.2.0/docs/data-sources/platform_account kaleido_platform_account}
*/
export class DataKaleidoPlatformAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKaleidoPlatformAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/kaleido-io/kaleido/1.2.0/docs/data-sources/platform_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kaleido-io/kaleido/1.2.0/docs/data-sources/platform_account kaleido_platform_account} Data Source
  *
  * @param scope The scope in which to define this construct
