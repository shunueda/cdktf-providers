...
export interface DataBuddyEnvironmentsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataBuddyEnvironmentsEnvironments {
}

export function dataBuddyEnvironmentsEnvironmentsToTerraform(struct?: DataBuddyEnvironmentsEnvironments): any {
...
export function dataBuddyEnvironmentsEnvironmentsToHclTerraform(struct?: DataBuddyEnvironmentsEnvironments): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataBuddyEnvironmentsEnvironmentsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataBuddyEnvironmentsEnvironments | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataBuddyEnvironmentsEnvironments | undefined) {
    if (value === undefined) {
...
export class DataBuddyEnvironmentsEnvironmentsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataBuddyEnvironmentsEnvironmentsOutputReference {
    return new DataBuddyEnvironmentsEnvironmentsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataBuddyEnvironments extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "buddy_environments";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "buddy_environments", importId: importFromId, provider });
      }
  ...
  * @param options DataBuddyEnvironmentsConfig
  */
  public constructor(scope: Construct, id: string, config: DataBuddyEnvironmentsConfig) {
    super(scope, id, {
  ...
  private _environments = new DataBuddyEnvironmentsEnvironmentsList(this, "environments", true);
