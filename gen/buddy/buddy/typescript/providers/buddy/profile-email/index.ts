// https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/resources/profile_email
...
export interface ProfileEmailConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/resources/profile_email#email ProfileEmail#email}
  */
  readonly email: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/resources/profile_email buddy_profile_email}
*/
export class ProfileEmail extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProfileEmail that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/resources/profile_email#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/resources/profile_email buddy_profile_email} Resource
  *
  * @param scope The scope in which to define this construct
