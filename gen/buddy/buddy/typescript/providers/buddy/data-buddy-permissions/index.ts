// https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/permissions
...
export interface DataBuddyPermissionsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/permissions#domain DataBuddyPermissions#domain}
  */
  readonly domain: string;
  /**
  * The permission's name regular expression to match
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/permissions#name_regex DataBuddyPermissions#name_regex}
  */
  readonly nameRegex?: string;
  /**
  * Filter permissions by type (`CUSTOM`, `READ_ONLY`, `DEVELOPER`, `PROJECT_MANAGER`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/permissions#type DataBuddyPermissions#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/permissions buddy_permissions}
*/
export class DataBuddyPermissions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuddyPermissions that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/permissions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/permissions buddy_permissions} Data Source
  *
  * @param scope The scope in which to define this construct
