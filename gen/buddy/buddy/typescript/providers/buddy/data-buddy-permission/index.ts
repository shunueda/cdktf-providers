// https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/data-sources/permission
...
export interface DataBuddyPermissionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/data-sources/permission#domain DataBuddyPermission#domain}
  */
  readonly domain: string;
  /**
  * The permission's name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/data-sources/permission#name DataBuddyPermission#name}
  */
  readonly name?: string;
  /**
  * The permission's ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/data-sources/permission#permission_id DataBuddyPermission#permission_id}
  */
  readonly permissionId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/data-sources/permission buddy_permission}
*/
export class DataBuddyPermission extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuddyPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/data-sources/permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/data-sources/permission buddy_permission} Data Source
  *
  * @param scope The scope in which to define this construct
