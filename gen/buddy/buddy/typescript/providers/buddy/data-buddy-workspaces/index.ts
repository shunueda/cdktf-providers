...
export interface DataBuddyWorkspacesConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataBuddyWorkspacesWorkspaces {
}

export function dataBuddyWorkspacesWorkspacesToTerraform(struct?: DataBuddyWorkspacesWorkspaces): any {
...
export function dataBuddyWorkspacesWorkspacesToHclTerraform(struct?: DataBuddyWorkspacesWorkspaces): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataBuddyWorkspacesWorkspacesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataBuddyWorkspacesWorkspaces | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataBuddyWorkspacesWorkspaces | undefined) {
    if (value === undefined) {
...
export class DataBuddyWorkspacesWorkspacesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataBuddyWorkspacesWorkspacesOutputReference {
    return new DataBuddyWorkspacesWorkspacesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataBuddyWorkspaces extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "buddy_workspaces";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "buddy_workspaces", importId: importFromId, provider });
      }
  ...
  * @param options DataBuddyWorkspacesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataBuddyWorkspacesConfig = {}) {
    super(scope, id, {
  ...
  private _workspaces = new DataBuddyWorkspacesWorkspacesList(this, "workspaces", true);
