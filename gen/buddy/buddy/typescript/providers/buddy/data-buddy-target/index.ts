// https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/target
...
export interface DataBuddyTargetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/target#domain DataBuddyTarget#domain}
  */
  readonly domain: string;
  /**
  * The target's ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/target#target_id DataBuddyTarget#target_id}
  */
  readonly targetId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/target buddy_target}
*/
export class DataBuddyTarget extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuddyTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/target#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/target buddy_target} Data Source
  *
  * @param scope The scope in which to define this construct
