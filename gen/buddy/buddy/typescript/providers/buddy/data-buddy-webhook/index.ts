// https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/webhook
...
export interface DataBuddyWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/webhook#domain DataBuddyWebhook#domain}
  */
  readonly domain: string;
  /**
  * The webhook's target URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/webhook#target_url DataBuddyWebhook#target_url}
  */
  readonly targetUrl?: string;
  /**
  * The webhook's ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/webhook#webhook_id DataBuddyWebhook#webhook_id}
  */
  readonly webhookId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/webhook buddy_webhook}
*/
export class DataBuddyWebhook extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuddyWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/data-sources/webhook buddy_webhook} Data Source
  *
  * @param scope The scope in which to define this construct
