// https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/resources/domain
...
export interface DomainConfig extends cdktf.TerraformMetaArguments {
  ...
  * The domain's name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/resources/domain#domain Domain#domain}
  */
  readonly domain: string;
  /**
  * The workspace's URL handle
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/resources/domain#workspace_domain Domain#workspace_domain}
  */
  readonly workspaceDomain: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/resources/domain buddy_domain}
*/
export class Domain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Domain that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/resources/domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.38.0/docs/resources/domain buddy_domain} Resource
  *
  * @param scope The scope in which to define this construct
