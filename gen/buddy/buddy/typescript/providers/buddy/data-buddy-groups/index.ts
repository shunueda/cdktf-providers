// https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/data-sources/groups
...
export interface DataBuddyGroupsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/data-sources/groups#domain DataBuddyGroups#domain}
  */
  readonly domain: string;
  /**
  * The group's name regular expression to match
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/data-sources/groups#name_regex DataBuddyGroups#name_regex}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/data-sources/groups buddy_groups}
*/
export class DataBuddyGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuddyGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/data-sources/groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buddy/buddy/1.37.1/docs/data-sources/groups buddy_groups} Data Source
  *
  * @param scope The scope in which to define this construct
