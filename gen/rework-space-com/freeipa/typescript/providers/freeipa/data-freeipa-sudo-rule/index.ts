// https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/data-sources/sudo_rule
...
export interface DataFreeipaSudoRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/data-sources/sudo_rule#name DataFreeipaSudoRule#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/data-sources/sudo_rule freeipa_sudo_rule}
*/
export class DataFreeipaSudoRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFreeipaSudoRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/data-sources/sudo_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/data-sources/sudo_rule freeipa_sudo_rule} Data Source
  *
  * @param scope The scope in which to define this construct
