// https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/dns_record
...
export interface DataFreeipaDnsRecordConfig extends cdktf.TerraformMetaArguments {
  ...
  * Record name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/dns_record#record_name DataFreeipaDnsRecord#record_name}
  */
  readonly recordName: string;
  /**
  * Zone name (FQDN)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/dns_record#zone_name DataFreeipaDnsRecord#zone_name}
  */
  readonly zoneName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/dns_record freeipa_dns_record}
*/
export class DataFreeipaDnsRecord extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFreeipaDnsRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/dns_record#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/dns_record freeipa_dns_record} Data Source
  *
  * @param scope The scope in which to define this construct
