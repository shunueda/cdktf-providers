// https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/user_group_membership
...
export interface UserGroupMembershipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/user_group_membership#external_member UserGroupMembership#external_member}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/user_group_membership#external_members UserGroupMembership#external_members}
  */
  readonly externalMembers?: string[];
  /**
  * **deprecated** User group to add. Will be replaced by groups.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/user_group_membership#group UserGroupMembership#group}
  */
  readonly group?: string;
  /**
  * User groups to add as group members
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/user_group_membership#groups UserGroupMembership#groups}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/user_group_membership#identifier UserGroupMembership#identifier}
  */
  readonly identifier?: string;
  /**
  * Group name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/user_group_membership#name UserGroupMembership#name}
  */
  readonly name: string;
  /**
  * **deprecated** User to add. Will be replaced by users.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/user_group_membership#user UserGroupMembership#user}
  */
  readonly user?: string;
  /**
  * Users to add as group members
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/user_group_membership#users UserGroupMembership#users}
  */
  readonly users?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/user_group_membership freeipa_user_group_membership}
*/
export class UserGroupMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserGroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/user_group_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/user_group_membership freeipa_user_group_membership} Resource
  *
  * @param scope The scope in which to define this construct
