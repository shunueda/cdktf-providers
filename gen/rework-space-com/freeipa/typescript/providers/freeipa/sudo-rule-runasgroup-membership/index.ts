// https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_runasgroup_membership
...
export interface SudoRuleRunasgroupMembershipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_runasgroup_membership#identifier SudoRuleRunasgroupMembership#identifier}
  */
  readonly identifier?: string;
  /**
  * Sudo rule name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_runasgroup_membership#name SudoRuleRunasgroupMembership#name}
  */
  readonly name: string;
  /**
  * **deprecated** Run As Group to add to the sudo rule. Can be an external group (local group of ipa clients)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_runasgroup_membership#runasgroup SudoRuleRunasgroupMembership#runasgroup}
  */
  readonly runasgroup?: string;
  /**
  * List of Run As Group to add to the sudo rule. Can be an external group (local group of ipa clients)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_runasgroup_membership#runasgroups SudoRuleRunasgroupMembership#runasgroups}
  */
  readonly runasgroups?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_runasgroup_membership freeipa_sudo_rule_runasgroup_membership}
*/
export class SudoRuleRunasgroupMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SudoRuleRunasgroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_runasgroup_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_runasgroup_membership freeipa_sudo_rule_runasgroup_membership} Resource
  *
  * @param scope The scope in which to define this construct
