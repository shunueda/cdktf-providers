// https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/hbac_policy_service_membership
...
export interface HbacPolicyServiceMembershipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/hbac_policy_service_membership#identifier HbacPolicyServiceMembership#identifier}
  */
  readonly identifier?: string;
  /**
  * HBAC policy name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/hbac_policy_service_membership#name HbacPolicyServiceMembership#name}
  */
  readonly name: string;
  /**
  * **deprecated** Service name the policy is applied t
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/hbac_policy_service_membership#service HbacPolicyServiceMembership#service}
  */
  readonly service?: string;
  /**
  * **deprecated** Service group name the policy is applied to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/hbac_policy_service_membership#servicegroup HbacPolicyServiceMembership#servicegroup}
  */
  readonly servicegroup?: string;
  /**
  * List of service group name the policy is applied to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/hbac_policy_service_membership#servicegroups HbacPolicyServiceMembership#servicegroups}
  */
  readonly servicegroups?: string[];
  /**
  * List of service name the policy is applied t
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/hbac_policy_service_membership#services HbacPolicyServiceMembership#services}
  */
  readonly services?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/hbac_policy_service_membership freeipa_hbac_policy_service_membership}
*/
export class HbacPolicyServiceMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HbacPolicyServiceMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/hbac_policy_service_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/hbac_policy_service_membership freeipa_hbac_policy_service_membership} Resource
  *
  * @param scope The scope in which to define this construct
