// https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/sudo_rule_allowcmd_membership
...
export interface SudoRuleAllowcmdMembershipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/sudo_rule_allowcmd_membership#identifier SudoRuleAllowcmdMembership#identifier}
  */
  readonly identifier?: string;
  /**
  * Sudo rule name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/sudo_rule_allowcmd_membership#name SudoRuleAllowcmdMembership#name}
  */
  readonly name: string;
  /**
  * **deprecated** Sudo command to allow by the sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/sudo_rule_allowcmd_membership#sudocmd SudoRuleAllowcmdMembership#sudocmd}
  */
  readonly sudocmd?: string;
  /**
  * **deprecated** Sudo command group to allow by the sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/sudo_rule_allowcmd_membership#sudocmd_group SudoRuleAllowcmdMembership#sudocmd_group}
  */
  readonly sudocmdGroup?: string;
  /**
  * List of sudo command group to allow by the sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/sudo_rule_allowcmd_membership#sudocmd_groups SudoRuleAllowcmdMembership#sudocmd_groups}
  */
  readonly sudocmdGroups?: string[];
  /**
  * List of Sudo command to allow by the sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/sudo_rule_allowcmd_membership#sudocmds SudoRuleAllowcmdMembership#sudocmds}
  */
  readonly sudocmds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/sudo_rule_allowcmd_membership freeipa_sudo_rule_allowcmd_membership}
*/
export class SudoRuleAllowcmdMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SudoRuleAllowcmdMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/sudo_rule_allowcmd_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/sudo_rule_allowcmd_membership freeipa_sudo_rule_allowcmd_membership} Resource
  *
  * @param scope The scope in which to define this construct
