// https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/group
...
export interface GroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/group#addattr Group#addattr}
  */
  readonly addattr?: string[];
  /**
  * Group Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/group#description Group#description}
  */
  readonly description?: string;
  /**
  * Allow adding external non-IPA members from trusted domains
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/group#external Group#external}
  */
  readonly external?: boolean | cdktf.IResolvable;
  /**
  * GID (use this option to set it manually)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/group#gid_number Group#gid_number}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/group#name Group#name}
  */
  readonly name: string;
  /**
  * Create as a non-POSIX group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/group#nonposix Group#nonposix}
  */
  readonly nonposix?: boolean | cdktf.IResolvable;
  /**
  * Set an attribute to a name/value pair. Format is attr=value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/group#setattr Group#setattr}
  */
  readonly setattr?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/group freeipa_group}
*/
export class Group extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Group that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/group freeipa_group} Resource
  *
  * @param scope The scope in which to define this construct
