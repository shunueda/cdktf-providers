// https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/dns_record
...
export interface DnsRecordConfig extends cdktf.TerraformMetaArguments {
  ...
  * Record name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/dns_record#name DnsRecord#name}
  */
  readonly name: string;
  /**
  * A string list of records
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/dns_record#records DnsRecord#records}
  */
  readonly records: string[];
  /**
  * Unique identifier to differentiate records with routing policies from one another
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/dns_record#set_identifier DnsRecord#set_identifier}
  */
  readonly setIdentifier?: string;
  /**
  * Time to live
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/dns_record#ttl DnsRecord#ttl}
  */
  readonly ttl?: number;
  /**
  * The record type (A, AAAA, CNAME, MX, PTR, SRV, TXT, SSHFP, NS)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/dns_record#type DnsRecord#type}
  */
  readonly type: string;
  /**
  * Zone name (FQDN)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/dns_record#zone_name DnsRecord#zone_name}
  */
  readonly zoneName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/dns_record freeipa_dns_record}
*/
export class DnsRecord extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/dns_record#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/dns_record freeipa_dns_record} Resource
  *
  * @param scope The scope in which to define this construct
