// https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs
...
export interface FreeipaProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs#ca_certificate FreeipaProvider#ca_certificate}
  */
  readonly caCertificate?: string;
  /**
  * The FreeIPA host. Can be set through the environment variable `FREEIPA_HOST`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs#host FreeipaProvider#host}
  */
  readonly host: string;
  /**
  * Whether to verify the server's SSL certificate. Can be set through the environment variable `FREEIPA_INSECURE`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs#insecure FreeipaProvider#insecure}
  */
  readonly insecure?: boolean | cdktf.IResolvable;
  /**
  * Password to use for connection. Can be set through the environment variable `FREEIPA_PASSWORD`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs#password FreeipaProvider#password}
  */
  readonly password?: string;
  /**
  * Username to use for connection. Can be set through the environment variable `FREEIPA_USERNAME`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs#username FreeipaProvider#username}
  */
  readonly username?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs#alias FreeipaProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs freeipa}
*/
export class FreeipaProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing FreeipaProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs freeipa} Resource
  *
  * @param scope The scope in which to define this construct
