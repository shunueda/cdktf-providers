// https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/data-sources/host
...
export interface DataFreeipaHostConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/data-sources/host#name DataFreeipaHost#name}
  */
  readonly name: string;
  /**
  * Client credentials may be delegated to the service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/data-sources/host#trusted_for_delegation DataFreeipaHost#trusted_for_delegation}
  */
  readonly trustedForDelegation?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/data-sources/host freeipa_host}
*/
export class DataFreeipaHost extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFreeipaHost that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/data-sources/host#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/data-sources/host freeipa_host} Data Source
  *
  * @param scope The scope in which to define this construct
