// https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/sudo_rule_denycmd_membership
...
export interface SudoRuleDenycmdMembershipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/sudo_rule_denycmd_membership#identifier SudoRuleDenycmdMembership#identifier}
  */
  readonly identifier?: string;
  /**
  * Sudo rule name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/sudo_rule_denycmd_membership#name SudoRuleDenycmdMembership#name}
  */
  readonly name: string;
  /**
  * **deprecated** Sudo command to deny by the sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/sudo_rule_denycmd_membership#sudocmd SudoRuleDenycmdMembership#sudocmd}
  */
  readonly sudocmd?: string;
  /**
  * **deprecated** Sudo command group to deny by the sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/sudo_rule_denycmd_membership#sudocmd_group SudoRuleDenycmdMembership#sudocmd_group}
  */
  readonly sudocmdGroup?: string;
  /**
  * List of sudo command group to deny by the sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/sudo_rule_denycmd_membership#sudocmd_groups SudoRuleDenycmdMembership#sudocmd_groups}
  */
  readonly sudocmdGroups?: string[];
  /**
  * List of Sudo command to deny by the sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/sudo_rule_denycmd_membership#sudocmds SudoRuleDenycmdMembership#sudocmds}
  */
  readonly sudocmds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/sudo_rule_denycmd_membership freeipa_sudo_rule_denycmd_membership}
*/
export class SudoRuleDenycmdMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SudoRuleDenycmdMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/sudo_rule_denycmd_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/sudo_rule_denycmd_membership freeipa_sudo_rule_denycmd_membership} Resource
  *
  * @param scope The scope in which to define this construct
