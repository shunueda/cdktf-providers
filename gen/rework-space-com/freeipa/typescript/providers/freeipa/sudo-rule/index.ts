// https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule
...
export interface SudoRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule#commandcategory SudoRule#commandcategory}
  */
  readonly commandcategory?: string;
  /**
  * Sudo rule description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule#description SudoRule#description}
  */
  readonly description?: string;
  /**
  * Enable this sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule#enabled SudoRule#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Host category the sudo rule is applied to (allowed value: all)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule#hostcategory SudoRule#hostcategory}
  */
  readonly hostcategory?: string;
  /**
  * Name of the sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule#name SudoRule#name}
  */
  readonly name: string;
  /**
  * Sudo rule order (must be unique)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule#order SudoRule#order}
  */
  readonly order?: number;
  /**
  * Run as group category the sudo rule is applied to (allowed value: all)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule#runasgroupcategory SudoRule#runasgroupcategory}
  */
  readonly runasgroupcategory?: string;
  /**
  * Run as user category the sudo rule is applied to (allowed value: all)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule#runasusercategory SudoRule#runasusercategory}
  */
  readonly runasusercategory?: string;
  /**
  * User category the sudo rule is applied to (allowed value: all)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule#usercategory SudoRule#usercategory}
  */
  readonly usercategory?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule freeipa_sudo_rule}
*/
export class SudoRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SudoRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule freeipa_sudo_rule} Resource
  *
  * @param scope The scope in which to define this construct
