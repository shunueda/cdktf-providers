// https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/hbac_policy
...
export interface HbacPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/hbac_policy#description HbacPolicy#description}
  */
  readonly description?: string;
  /**
  * Enable this hbac policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/hbac_policy#enabled HbacPolicy#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Host category the hbac policy is applied to (allowed value: all)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/hbac_policy#hostcategory HbacPolicy#hostcategory}
  */
  readonly hostcategory?: string;
  /**
  * Name of the hbac policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/hbac_policy#name HbacPolicy#name}
  */
  readonly name: string;
  /**
  * Service category the hbac policy is applied to (allowed value: all)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/hbac_policy#servicecategory HbacPolicy#servicecategory}
  */
  readonly servicecategory?: string;
  /**
  * User category the hbac policy is applied to (allowed value: all)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/hbac_policy#usercategory HbacPolicy#usercategory}
  */
  readonly usercategory?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/hbac_policy freeipa_hbac_policy}
*/
export class HbacPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HbacPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/hbac_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/resources/hbac_policy freeipa_hbac_policy} Resource
  *
  * @param scope The scope in which to define this construct
