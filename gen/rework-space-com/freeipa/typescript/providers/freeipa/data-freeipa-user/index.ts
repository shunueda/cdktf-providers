// https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/data-sources/user
...
export interface DataFreeipaUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/data-sources/user#name DataFreeipaUser#name}
  */
  readonly name: string;
  /**
  * State of the account to lookup. Can be `active`, `disabled`, `staged` or `preserved`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/data-sources/user#state DataFreeipaUser#state}
  */
  readonly state?: string;
  /**
  * List of Base-64 encoded user certificates
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/data-sources/user#user_certificates DataFreeipaUser#user_certificates}
  */
  readonly userCertificates?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/data-sources/user freeipa_user}
*/
export class DataFreeipaUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFreeipaUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/data-sources/user freeipa_user} Data Source
  *
  * @param scope The scope in which to define this construct
