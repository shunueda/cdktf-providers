// https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/data-sources/group
...
export interface DataFreeipaGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/data-sources/group#name DataFreeipaGroup#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/data-sources/group freeipa_group}
*/
export class DataFreeipaGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFreeipaGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/data-sources/group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.1/docs/data-sources/group freeipa_group} Data Source
  *
  * @param scope The scope in which to define this construct
