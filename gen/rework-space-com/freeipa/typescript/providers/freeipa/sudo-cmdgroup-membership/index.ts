// https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/sudo_cmdgroup_membership
...
export interface SudoCmdgroupMembershipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/sudo_cmdgroup_membership#identifier SudoCmdgroupMembership#identifier}
  */
  readonly identifier?: string;
  /**
  * Name of the sudo command group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/sudo_cmdgroup_membership#name SudoCmdgroupMembership#name}
  */
  readonly name: string;
  /**
  * **deprecated** Sudo command to add as a member
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/sudo_cmdgroup_membership#sudocmd SudoCmdgroupMembership#sudocmd}
  */
  readonly sudocmd?: string;
  /**
  * List of sudo command to add as a member
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/sudo_cmdgroup_membership#sudocmds SudoCmdgroupMembership#sudocmds}
  */
  readonly sudocmds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/sudo_cmdgroup_membership freeipa_sudo_cmdgroup_membership}
*/
export class SudoCmdgroupMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SudoCmdgroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/sudo_cmdgroup_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.2.0/docs/resources/sudo_cmdgroup_membership freeipa_sudo_cmdgroup_membership} Resource
  *
  * @param scope The scope in which to define this construct
