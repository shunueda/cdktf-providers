// https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/dns_zone
...
export interface DataFreeipaDnsZoneConfig extends cdktf.TerraformMetaArguments {
  ...
  * Zone name (FQDN)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/dns_zone#zone_name DataFreeipaDnsZone#zone_name}
  */
  readonly zoneName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/dns_zone freeipa_dns_zone}
*/
export class DataFreeipaDnsZone extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFreeipaDnsZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/dns_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/dns_zone freeipa_dns_zone} Data Source
  *
  * @param scope The scope in which to define this construct
