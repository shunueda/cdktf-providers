// https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/hbac_policy
...
export interface DataFreeipaHbacPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/hbac_policy#name DataFreeipaHbacPolicy#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/hbac_policy freeipa_hbac_policy}
*/
export class DataFreeipaHbacPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFreeipaHbacPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/hbac_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/data-sources/hbac_policy freeipa_hbac_policy} Data Source
  *
  * @param scope The scope in which to define this construct
