// https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/automemberadd_condition
...
export interface AutomemberaddConditionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/automemberadd_condition#description AutomemberaddCondition#description}
  */
  readonly description?: string;
  /**
  * Regex expression for values that should be excluded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/automemberadd_condition#exclusiveregex AutomemberaddCondition#exclusiveregex}
  */
  readonly exclusiveregex?: string[];
  /**
  * Regex expression for values that should be included.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/automemberadd_condition#inclusiveregex AutomemberaddCondition#inclusiveregex}
  */
  readonly inclusiveregex?: string[];
  /**
  * Automember rule condition key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/automemberadd_condition#key AutomemberaddCondition#key}
  */
  readonly key: string;
  /**
  * Automember rule condition name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/automemberadd_condition#name AutomemberaddCondition#name}
  */
  readonly name: string;
  /**
  * Automember rule condition type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/automemberadd_condition#type AutomemberaddCondition#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/automemberadd_condition freeipa_automemberadd_condition}
*/
export class AutomemberaddCondition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutomemberaddCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/automemberadd_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.4/docs/resources/automemberadd_condition freeipa_automemberadd_condition} Resource
  *
  * @param scope The scope in which to define this construct
