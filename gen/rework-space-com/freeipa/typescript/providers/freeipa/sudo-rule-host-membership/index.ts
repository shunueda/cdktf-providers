// https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_host_membership
...
export interface SudoRuleHostMembershipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_host_membership#host SudoRuleHostMembership#host}
  */
  readonly host?: string;
  /**
  * **deprecated** Hostgroup to add to the sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_host_membership#hostgroup SudoRuleHostMembership#hostgroup}
  */
  readonly hostgroup?: string;
  /**
  * List of hostgroups to add to the sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_host_membership#hostgroups SudoRuleHostMembership#hostgroups}
  */
  readonly hostgroups?: string[];
  /**
  * List of hosts to add to the sudo rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_host_membership#hosts SudoRuleHostMembership#hosts}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_host_membership#identifier SudoRuleHostMembership#identifier}
  */
  readonly identifier?: string;
  /**
  * Sudo rule name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_host_membership#name SudoRuleHostMembership#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_host_membership freeipa_sudo_rule_host_membership}
*/
export class SudoRuleHostMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SudoRuleHostMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_host_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rework-space-com/freeipa/5.1.3/docs/resources/sudo_rule_host_membership freeipa_sudo_rule_host_membership} Resource
  *
  * @param scope The scope in which to define this construct
