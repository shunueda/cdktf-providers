// https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/organization
...
/**
* Represents a {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/organization orcasecurity_organization}
*/
export class DataOrcasecurityOrganization extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOrcasecurityOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/organization orcasecurity_organization} Data Source
  *
  * @param scope The scope in which to define this construct
