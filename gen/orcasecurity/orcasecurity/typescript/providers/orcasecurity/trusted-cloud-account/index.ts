// https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/trusted_cloud_account
...
export interface TrustedCloudAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/trusted_cloud_account#account_name TrustedCloudAccount#account_name}
  */
  readonly accountName: string;
  /**
  * Cloud Provider. Valid values are `alicloud`, `aws`, `azure`, `gcp`, and `oci`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/trusted_cloud_account#cloud_provider TrustedCloudAccount#cloud_provider}
  */
  readonly cloudProvider: string;
  /**
  * Account ID for the cloud account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/trusted_cloud_account#cloud_provider_id TrustedCloudAccount#cloud_provider_id}
  */
  readonly cloudProviderId: string;
  /**
  * Description of the trusted cloud account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/trusted_cloud_account#description TrustedCloudAccount#description}
  */
  readonly description: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/trusted_cloud_account orcasecurity_trusted_cloud_account}
*/
export class TrustedCloudAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrustedCloudAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/trusted_cloud_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/trusted_cloud_account orcasecurity_trusted_cloud_account} Resource
  *
  * @param scope The scope in which to define this construct
