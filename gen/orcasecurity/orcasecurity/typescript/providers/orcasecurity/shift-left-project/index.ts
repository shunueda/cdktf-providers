// https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/shift_left_project
...
export interface ShiftLeftProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/shift_left_project#default_policies ShiftLeftProject#default_policies}
  */
  readonly defaultPolicies: boolean | cdktf.IResolvable;
  /**
  * Shift Left project description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/shift_left_project#description ShiftLeftProject#description}
  */
  readonly description: string;
  /**
  * Exception lists to attach to this project, specified by their IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/shift_left_project#exceptions_ids ShiftLeftProject#exceptions_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/shift_left_project#git_default_baseline_branch ShiftLeftProject#git_default_baseline_branch}
  */
  readonly gitDefaultBaselineBranch?: string;
  /**
  * Shift Left key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/shift_left_project#key ShiftLeftProject#key}
  */
  readonly key: string;
  /**
  * Shift Left project name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/shift_left_project#name ShiftLeftProject#name}
  */
  readonly name: string;
  /**
  * Policies to attach to this project, specified by their IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/shift_left_project#policies_ids ShiftLeftProject#policies_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/shift_left_project#support_code_comments_via_cli ShiftLeftProject#support_code_comments_via_cli}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/shift_left_project#support_cve_exceptions_via_cli ShiftLeftProject#support_cve_exceptions_via_cli}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/shift_left_project#support_secret_detection_suppression_via_cli ShiftLeftProject#support_secret_detection_suppression_via_cli}
  */
  readonly supportSecretDetectionSuppressionViaCli?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/shift_left_project orcasecurity_shift_left_project}
*/
export class ShiftLeftProject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ShiftLeftProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/shift_left_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/shift_left_project orcasecurity_shift_left_project} Resource
  *
  * @param scope The scope in which to define this construct
