// https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/discovery_results
...
export interface DataOrcasecurityDiscoveryResultsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Result set limit
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/discovery_results#limit DataOrcasecurityDiscoveryResults#limit}
  */
  readonly limit: number;
  /**
  * The query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/discovery_results#query DataOrcasecurityDiscoveryResults#query}
  */
  readonly query: string;
  /**
  * Index to start results at
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/discovery_results#start_at_index DataOrcasecurityDiscoveryResults#start_at_index}
  */
  readonly startAtIndex: number;
}
export interface DataOrcasecurityDiscoveryResultsResults {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/discovery_results#data DataOrcasecurityDiscoveryResults#data}
  */
  readonly data: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/discovery_results#id DataOrcasecurityDiscoveryResults#id}
  *
  ...
  */
  readonly id: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/discovery_results#name DataOrcasecurityDiscoveryResults#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/discovery_results#type DataOrcasecurityDiscoveryResults#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/discovery_results orcasecurity_discovery_results}
*/
export class DataOrcasecurityDiscoveryResults extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOrcasecurityDiscoveryResults that should be imported. Refer to the {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/discovery_results#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/discovery_results orcasecurity_discovery_results} Data Source
  *
  * @param scope The scope in which to define this construct
