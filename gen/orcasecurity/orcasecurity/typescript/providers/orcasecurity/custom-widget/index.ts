// https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget
...
export interface CustomWidgetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#extra_params CustomWidget#extra_params}
  */
  readonly extraParams: CustomWidgetExtraParams;
  /**
  * An internal, unique name for the widget.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#name CustomWidget#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#organization_level CustomWidget#organization_level}
  */
...
export interface CustomWidgetExtraParamsSettingsField {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#type CustomWidget#type}
  */
...
export interface CustomWidgetExtraParamsSettingsRequestParams {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#enable_pagination CustomWidget#enable_pagination}
  */
  readonly enablePagination?: boolean | cdktf.IResolvable;
  /**
  * How to group the returned results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#group_by CustomWidget#group_by}
  */
  readonly groupBy: string[];
  /**
  * How to group the returned results. Do not use this option with the table-type widget
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#group_by_list CustomWidget#group_by_list}
  */
  readonly groupByList?: string[];
  /**
  * Number of items returned in query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#limit CustomWidget#limit}
  */
  readonly limit?: number;
  /**
  * How the returned items are ordered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#order_by CustomWidget#order_by}
  */
  readonly orderBy?: string[];
  /**
  * Discovery query that the widget will use for its data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#query CustomWidget#query}
  */
  readonly query: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#start_at_index CustomWidget#start_at_index}
  */
...
export interface CustomWidgetExtraParamsSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#columns CustomWidget#columns}
  */
  readonly columns?: string[];
  /**
  * The name and type are also required here for grouping. This field is only required for donut-type widgets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#field CustomWidget#field}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#request_params CustomWidget#request_params}
  */
...
export interface CustomWidgetExtraParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#default_size CustomWidget#default_size}
  */
  readonly defaultSize: string;
  /**
  * Custom widget description (the text that appears in the info bubble).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#description CustomWidget#description}
  */
  readonly description: string;
  /**
  * When no objects are returned by the widget's underlying Discovery query, the widget would present this message.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#empty_state_message CustomWidget#empty_state_message}
  */
  readonly emptyStateMessage: string;
  /**
  * Should be set to true for a widget you are creating for the first time in Terraform.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#is_new CustomWidget#is_new}
  */
  readonly isNew: boolean | cdktf.IResolvable;
  /**
  * These are the settings for the custom widget.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#settings CustomWidget#settings}
  */
  readonly settings: CustomWidgetExtraParamsSettings;
  /**
  * Custom widget subtitle that will be presented in the UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#subtitle CustomWidget#subtitle}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget orcasecurity_custom_widget}
*/
export class CustomWidget extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomWidget that should be imported. Refer to the {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/resources/custom_widget orcasecurity_custom_widget} Resource
  *
  * @param scope The scope in which to define this construct
