// https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/discovery_view
...
export interface DiscoveryViewConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/discovery_view#extra_params DiscoveryView#extra_params}
  */
  readonly extraParams: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/discovery_view#filter_data DiscoveryView#filter_data}
  */
  readonly filterData: DiscoveryViewFilterData;
  /**
  * Discovery view name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/discovery_view#name DiscoveryView#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/discovery_view#organization_level DiscoveryView#organization_level}
  */
  readonly organizationLevel: boolean | cdktf.IResolvable;
  /**
  * Should be set to 'discovery' for discovery views.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/discovery_view#view_type DiscoveryView#view_type}
  */
...
export interface DiscoveryViewFilterData {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/discovery_view#query DiscoveryView#query}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/discovery_view orcasecurity_discovery_view}
*/
export class DiscoveryView extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DiscoveryView that should be imported. Refer to the {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/discovery_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/discovery_view orcasecurity_discovery_view} Resource
  *
  * @param scope The scope in which to define this construct
