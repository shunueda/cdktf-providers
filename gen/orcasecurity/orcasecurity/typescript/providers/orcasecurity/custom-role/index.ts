// https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/custom_role
...
export interface CustomRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/custom_role#description CustomRole#description}
  */
  readonly description: string;
  /**
  * Custom role name. Must be unique across your Orca org.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/custom_role#name CustomRole#name}
  */
  readonly name: string;
  /**
  * Permissions to assign to the group. Possible permissions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/custom_role#permission_groups CustomRole#permission_groups}
  */
  readonly permissionGroups: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/custom_role orcasecurity_custom_role}
*/
export class CustomRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/custom_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.23/docs/resources/custom_role orcasecurity_custom_role} Resource
  *
  * @param scope The scope in which to define this construct
