// https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs
...
export interface OrcasecurityProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs#api_endpoint OrcasecurityProvider#api_endpoint}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs#api_token OrcasecurityProvider#api_token}
  */
  readonly apiToken?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs#alias OrcasecurityProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs orcasecurity}
*/
export class OrcasecurityProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing OrcasecurityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs orcasecurity} Resource
  *
  * @param scope The scope in which to define this construct
