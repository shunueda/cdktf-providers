// https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/webhook
...
export interface DataOrcasecurityWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/webhook#name DataOrcasecurityWebhook#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/webhook orcasecurity_webhook}
*/
export class DataOrcasecurityWebhook extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOrcasecurityWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/orcasecurity/orcasecurity/0.0.27/docs/data-sources/webhook orcasecurity_webhook} Data Source
  *
  * @param scope The scope in which to define this construct
