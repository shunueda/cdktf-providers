...
export interface IpMacConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class IpMac extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "solidserver_ip_mac";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "solidserver_ip_mac", importId: importFromId, provider });
      }
  ...
  * @param options IpMacConfig
  */
  public constructor(scope: Construct, id: string, config: IpMacConfig) {
    super(scope, id, {
