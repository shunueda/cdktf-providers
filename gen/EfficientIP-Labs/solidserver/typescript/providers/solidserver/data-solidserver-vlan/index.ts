// https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/data-sources/vlan
...
export interface DataSolidserverVlanConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/data-sources/vlan#id DataSolidserverVlan#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/data-sources/vlan#name DataSolidserverVlan#name}
  */
  readonly name: string;
  /**
  * The name of the vlan Domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/data-sources/vlan#vlan_domain DataSolidserverVlan#vlan_domain}
  */
  readonly vlanDomain: string;
  /**
  * The name of the vlan Range.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/data-sources/vlan#vlan_range DataSolidserverVlan#vlan_range}
  */
  readonly vlanRange?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/data-sources/vlan solidserver_vlan}
*/
export class DataSolidserverVlan extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSolidserverVlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/data-sources/vlan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/data-sources/vlan solidserver_vlan} Data Source
  *
  * @param scope The scope in which to define this construct
