// https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/resources/vlan_range
...
export interface VlanRangeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/resources/vlan_range#class VlanRange#class}
  */
  readonly class?: string;
  /**
  * The class parameters associated to VLAN Range.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/resources/vlan_range#class_parameters VlanRange#class_parameters}
  */
  readonly classParameters?: { [key: string]: string };
  /**
  * The vlan range's higher vlan ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/resources/vlan_range#end VlanRange#end}
  */
  readonly end: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/resources/vlan_range#id VlanRange#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/resources/vlan_range#name VlanRange#name}
  */
  readonly name: string;
  /**
  * The vlan range's lower vlan ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/resources/vlan_range#start VlanRange#start}
  */
  readonly start: number;
  /**
  * The name of the vlan Domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/resources/vlan_range#vlan_domain VlanRange#vlan_domain}
  */
  readonly vlanDomain: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/resources/vlan_range solidserver_vlan_range}
*/
export class VlanRange extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VlanRange that should be imported. Refer to the {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/resources/vlan_range#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/efficientip-labs/solidserver/1.1.26/docs/resources/vlan_range solidserver_vlan_range} Resource
  *
  * @param scope The scope in which to define this construct
