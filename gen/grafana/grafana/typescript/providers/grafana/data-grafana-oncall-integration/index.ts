// https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/oncall_integration
...
export interface DataGrafanaOncallIntegrationConfig extends cdktf.TerraformMetaArguments {
  ...
  * The integration ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/oncall_integration#id DataGrafanaOncallIntegration#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/oncall_integration grafana_oncall_integration}
*/
export class DataGrafanaOncallIntegration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaOncallIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/oncall_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/oncall_integration grafana_oncall_integration} Data Source
  *
  * @param scope The scope in which to define this construct
