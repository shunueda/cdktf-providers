// https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/k6_project_allowed_load_zones
...
export interface DataGrafanaK6ProjectAllowedLoadZonesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/k6_project_allowed_load_zones#project_id DataGrafanaK6ProjectAllowedLoadZones#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/k6_project_allowed_load_zones grafana_k6_project_allowed_load_zones}
*/
export class DataGrafanaK6ProjectAllowedLoadZones extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaK6ProjectAllowedLoadZones that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/k6_project_allowed_load_zones#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/k6_project_allowed_load_zones grafana_k6_project_allowed_load_zones} Data Source
  *
  * @param scope The scope in which to define this construct
