// https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/synthetic_monitoring_installation
...
export interface SyntheticMonitoringInstallationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/synthetic_monitoring_installation#id SyntheticMonitoringInstallation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/synthetic_monitoring_installation#metrics_publisher_key SyntheticMonitoringInstallation#metrics_publisher_key}
  */
  readonly metricsPublisherKey: string;
  /**
  * The ID or slug of the stack to install SM on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/synthetic_monitoring_installation#stack_id SyntheticMonitoringInstallation#stack_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/synthetic_monitoring_installation#stack_sm_api_url SyntheticMonitoringInstallation#stack_sm_api_url}
  */
  readonly stackSmApiUrl?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/synthetic_monitoring_installation grafana_synthetic_monitoring_installation}
*/
export class SyntheticMonitoringInstallation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SyntheticMonitoringInstallation that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/synthetic_monitoring_installation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/synthetic_monitoring_installation grafana_synthetic_monitoring_installation} Resource
  *
  * @param scope The scope in which to define this construct
