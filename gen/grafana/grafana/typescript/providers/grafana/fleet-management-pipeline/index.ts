// https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/fleet_management_pipeline
...
export interface FleetManagementPipelineConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/fleet_management_pipeline#contents FleetManagementPipeline#contents}
  */
  readonly contents: string;
  /**
  * Whether the pipeline is enabled for collectors
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/fleet_management_pipeline#enabled FleetManagementPipeline#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/fleet_management_pipeline#matchers FleetManagementPipeline#matchers}
  */
  readonly matchers?: string[];
  /**
  * Name of the pipeline which is the unique identifier for the pipeline
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/fleet_management_pipeline#name FleetManagementPipeline#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/fleet_management_pipeline grafana_fleet_management_pipeline}
*/
export class FleetManagementPipeline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FleetManagementPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/fleet_management_pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/fleet_management_pipeline grafana_fleet_management_pipeline} Resource
  *
  * @param scope The scope in which to define this construct
