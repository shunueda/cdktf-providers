// https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/synthetic_monitoring_probe
...
export interface SyntheticMonitoringProbeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/synthetic_monitoring_probe#disable_browser_checks SyntheticMonitoringProbe#disable_browser_checks}
  */
  readonly disableBrowserChecks?: boolean | cdktf.IResolvable;
  /**
  * Disables scripted checks for this probe. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/synthetic_monitoring_probe#disable_scripted_checks SyntheticMonitoringProbe#disable_scripted_checks}
  */
  readonly disableScriptedChecks?: boolean | cdktf.IResolvable;
  /**
  * Custom labels to be included with collected metrics and logs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/synthetic_monitoring_probe#labels SyntheticMonitoringProbe#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Latitude coordinates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/synthetic_monitoring_probe#latitude SyntheticMonitoringProbe#latitude}
  */
  readonly latitude: number;
  /**
  * Longitude coordinates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/synthetic_monitoring_probe#longitude SyntheticMonitoringProbe#longitude}
  */
  readonly longitude: number;
  /**
  * Name of the probe.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/synthetic_monitoring_probe#name SyntheticMonitoringProbe#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/synthetic_monitoring_probe#public SyntheticMonitoringProbe#public}
  */
  readonly public?: boolean | cdktf.IResolvable;
  /**
  * Region of the probe.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/synthetic_monitoring_probe#region SyntheticMonitoringProbe#region}
  */
  readonly region: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/synthetic_monitoring_probe grafana_synthetic_monitoring_probe}
*/
export class SyntheticMonitoringProbe extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SyntheticMonitoringProbe that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/synthetic_monitoring_probe#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/synthetic_monitoring_probe grafana_synthetic_monitoring_probe} Resource
  *
  * @param scope The scope in which to define this construct
