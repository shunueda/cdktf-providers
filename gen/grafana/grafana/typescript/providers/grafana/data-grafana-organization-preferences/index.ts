// https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/data-sources/organization_preferences
...
export interface DataGrafanaOrganizationPreferencesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/data-sources/organization_preferences#id DataGrafanaOrganizationPreferences#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/data-sources/organization_preferences#org_id DataGrafanaOrganizationPreferences#org_id}
  */
  readonly orgId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/data-sources/organization_preferences grafana_organization_preferences}
*/
export class DataGrafanaOrganizationPreferences extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaOrganizationPreferences that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/data-sources/organization_preferences#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/data-sources/organization_preferences grafana_organization_preferences} Data Source
  *
  * @param scope The scope in which to define this construct
