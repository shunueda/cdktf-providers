// https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_stack_service_account_rotating_token
...
export interface CloudStackServiceAccountRotatingTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_stack_service_account_rotating_token#delete_on_destroy CloudStackServiceAccountRotatingToken#delete_on_destroy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_stack_service_account_rotating_token#early_rotation_window_seconds CloudStackServiceAccountRotatingToken#early_rotation_window_seconds}
  */
  readonly earlyRotationWindowSeconds: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_stack_service_account_rotating_token#id CloudStackServiceAccountRotatingToken#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_stack_service_account_rotating_token#name_prefix CloudStackServiceAccountRotatingToken#name_prefix}
  */
  readonly namePrefix: string;
  /**
  * The token expiration in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_stack_service_account_rotating_token#seconds_to_live CloudStackServiceAccountRotatingToken#seconds_to_live}
  */
  readonly secondsToLive: number;
  /**
  * The ID of the service account to which the token belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_stack_service_account_rotating_token#service_account_id CloudStackServiceAccountRotatingToken#service_account_id}
  */
  readonly serviceAccountId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_stack_service_account_rotating_token#stack_slug CloudStackServiceAccountRotatingToken#stack_slug}
  */
  readonly stackSlug: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_stack_service_account_rotating_token grafana_cloud_stack_service_account_rotating_token}
*/
export class CloudStackServiceAccountRotatingToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudStackServiceAccountRotatingToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_stack_service_account_rotating_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_stack_service_account_rotating_token grafana_cloud_stack_service_account_rotating_token} Resource
  *
  * @param scope The scope in which to define this construct
