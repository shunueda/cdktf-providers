// https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/data-sources/cloud_provider_aws_account
...
export interface DataGrafanaCloudProviderAwsAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/data-sources/cloud_provider_aws_account#resource_id DataGrafanaCloudProviderAwsAccount#resource_id}
  */
  readonly resourceId: string;
  /**
  * The StackID of the Grafana Cloud instance. Part of the Terraform Resource ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/data-sources/cloud_provider_aws_account#stack_id DataGrafanaCloudProviderAwsAccount#stack_id}
  */
  readonly stackId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/data-sources/cloud_provider_aws_account grafana_cloud_provider_aws_account}
*/
export class DataGrafanaCloudProviderAwsAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaCloudProviderAwsAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/data-sources/cloud_provider_aws_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/data-sources/cloud_provider_aws_account grafana_cloud_provider_aws_account} Data Source
  *
  * @param scope The scope in which to define this construct
