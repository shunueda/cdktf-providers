// https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/organization_preferences
...
export interface OrganizationPreferencesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/organization_preferences#home_dashboard_uid OrganizationPreferences#home_dashboard_uid}
  */
  readonly homeDashboardUid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/organization_preferences#id OrganizationPreferences#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/organization_preferences#org_id OrganizationPreferences#org_id}
  */
  readonly orgId?: string;
  /**
  * The Organization theme. Available values are `light`, `dark`, `system`, or an empty string for the default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/organization_preferences#theme OrganizationPreferences#theme}
  */
  readonly theme?: string;
  /**
  * The Organization timezone. Available values are `utc`, `browser`, or an empty string for the default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/organization_preferences#timezone OrganizationPreferences#timezone}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/organization_preferences#week_start OrganizationPreferences#week_start}
  */
  readonly weekStart?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/organization_preferences grafana_organization_preferences}
*/
export class OrganizationPreferences extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationPreferences that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/organization_preferences#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/organization_preferences grafana_organization_preferences} Resource
  *
  * @param scope The scope in which to define this construct
