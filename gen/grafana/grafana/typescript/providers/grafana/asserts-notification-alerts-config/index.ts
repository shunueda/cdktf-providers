// https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/asserts_notification_alerts_config
...
export interface AssertsNotificationAlertsConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/asserts_notification_alerts_config#alert_labels AssertsNotificationAlertsConfig#alert_labels}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/asserts_notification_alerts_config#duration AssertsNotificationAlertsConfig#duration}
  */
  readonly duration?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/asserts_notification_alerts_config#id AssertsNotificationAlertsConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/asserts_notification_alerts_config#match_labels AssertsNotificationAlertsConfig#match_labels}
  */
  readonly matchLabels?: { [key: string]: string };
  /**
  * The name of the alert configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/asserts_notification_alerts_config#name AssertsNotificationAlertsConfig#name}
  */
  readonly name: string;
  /**
  * Whether this alert configuration is silenced. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/asserts_notification_alerts_config#silenced AssertsNotificationAlertsConfig#silenced}
  */
  readonly silenced?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/asserts_notification_alerts_config grafana_asserts_notification_alerts_config}
*/
export class AssertsNotificationAlertsConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AssertsNotificationAlertsConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/asserts_notification_alerts_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/asserts_notification_alerts_config grafana_asserts_notification_alerts_config} Resource
  *
  * @param scope The scope in which to define this construct
