// https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/library_panels
...
export interface DataGrafanaLibraryPanelsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/library_panels#org_id DataGrafanaLibraryPanels#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/library_panels grafana_library_panels}
*/
export class DataGrafanaLibraryPanels extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaLibraryPanels that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/library_panels#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/library_panels grafana_library_panels} Data Source
  *
  * @param scope The scope in which to define this construct
