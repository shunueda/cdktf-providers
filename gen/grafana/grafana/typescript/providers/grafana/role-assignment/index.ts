// https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/role_assignment
...
export interface RoleAssignmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/role_assignment#id RoleAssignment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/role_assignment#org_id RoleAssignment#org_id}
  */
  readonly orgId?: string;
  /**
  * Grafana RBAC role UID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/role_assignment#role_uid RoleAssignment#role_uid}
  */
  readonly roleUid: string;
  /**
  * IDs of service accounts that the role should be assigned to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/role_assignment#service_accounts RoleAssignment#service_accounts}
  */
  readonly serviceAccounts?: string[];
  /**
  * IDs of teams that the role should be assigned to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/role_assignment#teams RoleAssignment#teams}
  */
  readonly teams?: string[];
  /**
  * IDs of users that the role should be assigned to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/role_assignment#users RoleAssignment#users}
  */
  readonly users?: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/role_assignment grafana_role_assignment}
*/
export class RoleAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoleAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/role_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/role_assignment grafana_role_assignment} Resource
  *
  * @param scope The scope in which to define this construct
