// https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/data-sources/k6_load_tests
...
export interface DataGrafanaK6LoadTestsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/data-sources/k6_load_tests#name DataGrafanaK6LoadTests#name}
  */
  readonly name?: string;
  /**
  * The identifier of the project the load tests belong to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/data-sources/k6_load_tests#project_id DataGrafanaK6LoadTests#project_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/data-sources/k6_load_tests grafana_k6_load_tests}
*/
export class DataGrafanaK6LoadTests extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaK6LoadTests that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/data-sources/k6_load_tests#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/data-sources/k6_load_tests grafana_k6_load_tests} Data Source
  *
  * @param scope The scope in which to define this construct
