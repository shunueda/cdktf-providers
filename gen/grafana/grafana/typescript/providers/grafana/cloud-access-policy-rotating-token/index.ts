// https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_access_policy_rotating_token
...
export interface CloudAccessPolicyRotatingTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_access_policy_rotating_token#access_policy_id CloudAccessPolicyRotatingToken#access_policy_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_access_policy_rotating_token#delete_on_destroy CloudAccessPolicyRotatingToken#delete_on_destroy}
  */
  readonly deleteOnDestroy?: boolean | cdktf.IResolvable;
  /**
  * Display name of the access policy token. Defaults to the name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_access_policy_rotating_token#display_name CloudAccessPolicyRotatingToken#display_name}
  */
  readonly displayName?: string;
  /**
  * Duration of the window before expiring where the token can be rotated (e.g. '24h', '30m', '1h30m').
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_access_policy_rotating_token#early_rotation_window CloudAccessPolicyRotatingToken#early_rotation_window}
  */
  readonly earlyRotationWindow: string;
  /**
  * Duration after which the token will expire (e.g. '24h', '30m', '1h30m').
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_access_policy_rotating_token#expire_after CloudAccessPolicyRotatingToken#expire_after}
  */
  readonly expireAfter: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_access_policy_rotating_token#id CloudAccessPolicyRotatingToken#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_access_policy_rotating_token#name_prefix CloudAccessPolicyRotatingToken#name_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_access_policy_rotating_token#region CloudAccessPolicyRotatingToken#region}
  */
  readonly region: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_access_policy_rotating_token grafana_cloud_access_policy_rotating_token}
*/
export class CloudAccessPolicyRotatingToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudAccessPolicyRotatingToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_access_policy_rotating_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_access_policy_rotating_token grafana_cloud_access_policy_rotating_token} Resource
  *
  * @param scope The scope in which to define this construct
