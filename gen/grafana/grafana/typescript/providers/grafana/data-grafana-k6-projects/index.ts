// https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/data-sources/k6_projects
...
export interface DataGrafanaK6ProjectsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/data-sources/k6_projects#name DataGrafanaK6Projects#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/data-sources/k6_projects grafana_k6_projects}
*/
export class DataGrafanaK6Projects extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaK6Projects that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/data-sources/k6_projects#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/data-sources/k6_projects grafana_k6_projects} Data Source
  *
  * @param scope The scope in which to define this construct
