// https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector
...
export interface MachineLearningOutlierDetectorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector#datasource_type MachineLearningOutlierDetector#datasource_type}
  */
  readonly datasourceType: string;
  /**
  * The uid of the datasource to query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector#datasource_uid MachineLearningOutlierDetector#datasource_uid}
  */
  readonly datasourceUid: string;
  /**
  * A description of the outlier detector.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector#description MachineLearningOutlierDetector#description}
  */
  readonly description?: string;
  /**
  * The data interval in seconds to monitor. Defaults to `300`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector#interval MachineLearningOutlierDetector#interval}
  */
  readonly interval?: number;
  /**
  * The metric used to query the outlier detector results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector#metric MachineLearningOutlierDetector#metric}
  */
  readonly metric: string;
  /**
  * The name of the outlier detector.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector#name MachineLearningOutlierDetector#name}
  */
  readonly name: string;
  /**
  * An object representing the query params to query Grafana with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector#query_params MachineLearningOutlierDetector#query_params}
  */
  readonly queryParams: { [key: string]: string };
  /**
  * algorithm block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector#algorithm MachineLearningOutlierDetector#algorithm}
  */
...
export interface MachineLearningOutlierDetectorAlgorithmConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector#epsilon MachineLearningOutlierDetector#epsilon}
  */
...
export interface MachineLearningOutlierDetectorAlgorithm {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector#sensitivity MachineLearningOutlierDetector#sensitivity}
  */
  readonly sensitivity: number;
  /**
  * config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector#config MachineLearningOutlierDetector#config}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector grafana_machine_learning_outlier_detector}
*/
export class MachineLearningOutlierDetector extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MachineLearningOutlierDetector that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/machine_learning_outlier_detector grafana_machine_learning_outlier_detector} Resource
  *
  * @param scope The scope in which to define this construct
