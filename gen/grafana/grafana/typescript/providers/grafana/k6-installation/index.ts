// https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/k6_installation
...
export interface K6InstallationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/k6_installation#cloud_access_policy_token K6Installation#cloud_access_policy_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/k6_installation#grafana_sa_token K6Installation#grafana_sa_token}
  */
  readonly grafanaSaToken: string;
  /**
  * The user to use for the installation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/k6_installation#grafana_user K6Installation#grafana_user}
  */
  readonly grafanaUser: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/k6_installation#id K6Installation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/k6_installation#k6_api_url K6Installation#k6_api_url}
  */
  readonly k6ApiUrl?: string;
  /**
  * The identifier of the stack to install k6 on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/k6_installation#stack_id K6Installation#stack_id}
  */
  readonly stackId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/k6_installation grafana_k6_installation}
*/
export class K6Installation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing K6Installation that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/k6_installation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/k6_installation grafana_k6_installation} Resource
  *
  * @param scope The scope in which to define this construct
