// https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/frontend_o11y_app
...
export interface FrontendO11YAppConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/frontend_o11y_app#allowed_origins FrontendO11YApp#allowed_origins}
  */
  readonly allowedOrigins: string[];
  /**
  * The extra attributes to append in each signal.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/frontend_o11y_app#extra_log_attributes FrontendO11YApp#extra_log_attributes}
  */
  readonly extraLogAttributes: { [key: string]: string };
  /**
  * The name of Frontend Observability App. Part of the Terraform Resource ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/frontend_o11y_app#name FrontendO11YApp#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/frontend_o11y_app#settings FrontendO11YApp#settings}
  */
  readonly settings: { [key: string]: string };
  /**
  * The Stack ID of the Grafana Cloud instance. Part of the Terraform Resource ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/frontend_o11y_app#stack_id FrontendO11YApp#stack_id}
  */
  readonly stackId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/frontend_o11y_app grafana_frontend_o11y_app}
*/
export class FrontendO11YApp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FrontendO11YApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/frontend_o11y_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/frontend_o11y_app grafana_frontend_o11y_app} Resource
  *
  * @param scope The scope in which to define this construct
