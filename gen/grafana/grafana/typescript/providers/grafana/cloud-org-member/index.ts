// https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_org_member
...
export interface CloudOrgMemberConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_org_member#org CloudOrgMember#org}
  */
  readonly org: string;
  /**
  * Whether the user should receive billing emails.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_org_member#receive_billing_emails CloudOrgMember#receive_billing_emails}
  */
  readonly receiveBillingEmails?: boolean | cdktf.IResolvable;
  /**
  * The role to assign to the user in the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_org_member#role CloudOrgMember#role}
  */
  readonly role: string;
  /**
  * Username or ID of the user to add to the org's members.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_org_member#user CloudOrgMember#user}
  */
  readonly user: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_org_member grafana_cloud_org_member}
*/
export class CloudOrgMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudOrgMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_org_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_org_member grafana_cloud_org_member} Resource
  *
  * @param scope The scope in which to define this construct
