// https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/synthetic_monitoring_check_alerts
...
export interface SyntheticMonitoringCheckAlertsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/synthetic_monitoring_check_alerts#alerts SyntheticMonitoringCheckAlerts#alerts}
  */
  readonly alerts: SyntheticMonitoringCheckAlertsAlerts[] | cdktf.IResolvable;
  /**
  * The ID of the check to manage alerts for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/synthetic_monitoring_check_alerts#check_id SyntheticMonitoringCheckAlerts#check_id}
  */
  readonly checkId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/synthetic_monitoring_check_alerts#id SyntheticMonitoringCheckAlerts#id}
  *
...
export interface SyntheticMonitoringCheckAlertsAlerts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/synthetic_monitoring_check_alerts#name SyntheticMonitoringCheckAlerts#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/synthetic_monitoring_check_alerts#period SyntheticMonitoringCheckAlerts#period}
  */
  readonly period: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/synthetic_monitoring_check_alerts#runbook_url SyntheticMonitoringCheckAlerts#runbook_url}
  */
  readonly runbookUrl: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/synthetic_monitoring_check_alerts#threshold SyntheticMonitoringCheckAlerts#threshold}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/synthetic_monitoring_check_alerts grafana_synthetic_monitoring_check_alerts}
*/
export class SyntheticMonitoringCheckAlerts extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SyntheticMonitoringCheckAlerts that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/synthetic_monitoring_check_alerts#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/synthetic_monitoring_check_alerts grafana_synthetic_monitoring_check_alerts} Resource
  *
  * @param scope The scope in which to define this construct
