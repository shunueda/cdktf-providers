// https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/fleet_management_collector
...
export interface FleetManagementCollectorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/fleet_management_collector#enabled FleetManagementCollector#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * ID of the collector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/fleet_management_collector#id FleetManagementCollector#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/fleet_management_collector#remote_attributes FleetManagementCollector#remote_attributes}
  */
  readonly remoteAttributes?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/fleet_management_collector grafana_fleet_management_collector}
*/
export class FleetManagementCollector extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FleetManagementCollector that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/fleet_management_collector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/fleet_management_collector grafana_fleet_management_collector} Resource
  *
  * @param scope The scope in which to define this construct
