// https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/library_panel
...
export interface DataGrafanaLibraryPanelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/library_panel#id DataGrafanaLibraryPanel#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/library_panel#name DataGrafanaLibraryPanel#name}
  */
  readonly name?: string;
  /**
  * The Organization ID. If not set, the Org ID defined in the provider block will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/library_panel#org_id DataGrafanaLibraryPanel#org_id}
  */
  readonly orgId?: string;
  /**
  * The unique identifier (UID) of the library panel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/library_panel#uid DataGrafanaLibraryPanel#uid}
  */
  readonly uid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/library_panel grafana_library_panel}
*/
export class DataGrafanaLibraryPanel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaLibraryPanel that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/library_panel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/library_panel grafana_library_panel} Data Source
  *
  * @param scope The scope in which to define this construct
