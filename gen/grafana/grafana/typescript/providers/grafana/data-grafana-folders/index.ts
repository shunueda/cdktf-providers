// https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/data-sources/folders
...
export interface DataGrafanaFoldersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/data-sources/folders#id DataGrafanaFolders#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/data-sources/folders#org_id DataGrafanaFolders#org_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/data-sources/folders grafana_folders}
*/
export class DataGrafanaFolders extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaFolders that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/data-sources/folders#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/data-sources/folders grafana_folders} Data Source
  *
  * @param scope The scope in which to define this construct
