// https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/synthetic_monitoring_probe
...
export interface DataGrafanaSyntheticMonitoringProbeConfig extends cdktf.TerraformMetaArguments {
  ...
  * Name of the probe.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/synthetic_monitoring_probe#name DataGrafanaSyntheticMonitoringProbe#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/synthetic_monitoring_probe grafana_synthetic_monitoring_probe}
*/
export class DataGrafanaSyntheticMonitoringProbe extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaSyntheticMonitoringProbe that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/synthetic_monitoring_probe#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/synthetic_monitoring_probe grafana_synthetic_monitoring_probe} Data Source
  *
  * @param scope The scope in which to define this construct
