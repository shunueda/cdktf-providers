// https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule
...
export interface K6ScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule#load_test_id K6Schedule#load_test_id}
  */
  readonly loadTestId: string;
  /**
  * The start time for the schedule (RFC3339 format).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule#starts K6Schedule#starts}
  */
  readonly starts: string;
  /**
  * cron block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule#cron K6Schedule#cron}
  */
  readonly cron?: K6ScheduleCron;
  /**
  * recurrence_rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule#recurrence_rule K6Schedule#recurrence_rule}
  */
...
export interface K6ScheduleCron {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule#schedule K6Schedule#schedule}
  */
  readonly schedule?: string;
  /**
  * The timezone of the cron expression. For example, `UTC` or `Europe/London`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule#timezone K6Schedule#timezone}
  */
...
export interface K6ScheduleRecurrenceRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule#byday K6Schedule#byday}
  */
  readonly byday?: string[];
  /**
  * How many times the recurrence will repeat.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule#count K6Schedule#count}
  */
  readonly count?: number;
  /**
  * The frequency of the schedule (HOURLY, DAILY, WEEKLY, MONTHLY, YEARLY).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule#frequency K6Schedule#frequency}
  */
  readonly frequency?: string;
  /**
  * The interval between each frequency iteration (e.g., 2 = every 2 hours for HOURLY). Defaults to 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule#interval K6Schedule#interval}
  */
  readonly interval?: number;
  /**
  * The end time for the recurrence (RFC3339 format).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule#until K6Schedule#until}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule grafana_k6_schedule}
*/
export class K6Schedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing K6Schedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/k6_schedule grafana_k6_schedule} Resource
  *
  * @param scope The scope in which to define this construct
