// https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_access_policy_token
...
export interface CloudAccessPolicyTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_access_policy_token#access_policy_id CloudAccessPolicyToken#access_policy_id}
  */
  readonly accessPolicyId: string;
  /**
  * Display name of the access policy token. Defaults to the name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_access_policy_token#display_name CloudAccessPolicyToken#display_name}
  */
  readonly displayName?: string;
  /**
  * Expiration date of the access policy token. Does not expire by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_access_policy_token#expires_at CloudAccessPolicyToken#expires_at}
  */
  readonly expiresAt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_access_policy_token#id CloudAccessPolicyToken#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_access_policy_token#name CloudAccessPolicyToken#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_access_policy_token#region CloudAccessPolicyToken#region}
  */
  readonly region: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_access_policy_token grafana_cloud_access_policy_token}
*/
export class CloudAccessPolicyToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudAccessPolicyToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_access_policy_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_access_policy_token grafana_cloud_access_policy_token} Resource
  *
  * @param scope The scope in which to define this construct
