// https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/annotation
...
export interface AnnotationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/annotation#dashboard_uid Annotation#dashboard_uid}
  */
  readonly dashboardUid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/annotation#id Annotation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/annotation#org_id Annotation#org_id}
  */
  readonly orgId?: string;
  /**
  * The ID of the dashboard panel on which to create the annotation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/annotation#panel_id Annotation#panel_id}
  */
  readonly panelId?: number;
  /**
  * The tags to associate with the annotation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/annotation#tags Annotation#tags}
  */
  readonly tags?: string[];
  /**
  * The text to associate with the annotation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/annotation#text Annotation#text}
  */
  readonly text: string;
  /**
  * The RFC 3339-formatted time string indicating the annotation's time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/annotation#time Annotation#time}
  */
  readonly time?: string;
  /**
  * The RFC 3339-formatted time string indicating the annotation's end time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/annotation#time_end Annotation#time_end}
  */
  readonly timeEnd?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/annotation grafana_annotation}
*/
export class Annotation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Annotation that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/annotation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/annotation grafana_annotation} Resource
  *
  * @param scope The scope in which to define this construct
