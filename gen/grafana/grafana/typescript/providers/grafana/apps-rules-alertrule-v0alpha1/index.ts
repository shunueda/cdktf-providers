// https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1
...
export interface AppsRulesAlertruleV0Alpha1Config extends cdktf.TerraformMetaArguments {
  ...
  * metadata block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#metadata AppsRulesAlertruleV0Alpha1#metadata}
  */
  readonly metadata?: AppsRulesAlertruleV0Alpha1Metadata;
  /**
  * options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#options AppsRulesAlertruleV0Alpha1#options}
  */
  readonly options?: AppsRulesAlertruleV0Alpha1Options;
  /**
  * spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#spec AppsRulesAlertruleV0Alpha1#spec}
  */
...
export interface AppsRulesAlertruleV0Alpha1Metadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#folder_uid AppsRulesAlertruleV0Alpha1#folder_uid}
  */
  readonly folderUid?: string;
  /**
  * The unique identifier of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#uid AppsRulesAlertruleV0Alpha1#uid}
  */
  readonly uid: string;
}
...
export interface AppsRulesAlertruleV0Alpha1Options {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#overwrite AppsRulesAlertruleV0Alpha1#overwrite}
  */
...
export interface AppsRulesAlertruleV0Alpha1SpecNotificationSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#active_timings AppsRulesAlertruleV0Alpha1#active_timings}
  */
  readonly activeTimings?: string[];
  /**
  * The contact point to route notifications that match this rule to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#contact_point AppsRulesAlertruleV0Alpha1#contact_point}
  */
  readonly contactPoint: string;
  /**
  * A list of alert labels to group alerts into notifications by.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#group_by AppsRulesAlertruleV0Alpha1#group_by}
  */
  readonly groupBy?: string[];
  /**
  * Minimum time interval between two notifications for the same group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#group_interval AppsRulesAlertruleV0Alpha1#group_interval}
  */
  readonly groupInterval?: string;
  /**
  * Time to wait to buffer alerts of the same group before sending a notification.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#group_wait AppsRulesAlertruleV0Alpha1#group_wait}
  */
  readonly groupWait?: string;
  /**
  * A list of mute timing names to apply to alerts that match this policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#mute_timings AppsRulesAlertruleV0Alpha1#mute_timings}
  */
  readonly muteTimings?: string[];
  /**
  * Minimum time interval for re-sending a notification if an alert is still firing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#repeat_interval AppsRulesAlertruleV0Alpha1#repeat_interval}
  */
...
export interface AppsRulesAlertruleV0Alpha1SpecTrigger {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#interval AppsRulesAlertruleV0Alpha1#interval}
  */
...
export interface AppsRulesAlertruleV0Alpha1Spec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#annotations AppsRulesAlertruleV0Alpha1#annotations}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#exec_err_state AppsRulesAlertruleV0Alpha1#exec_err_state}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#expressions AppsRulesAlertruleV0Alpha1#expressions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#for AppsRulesAlertruleV0Alpha1#for}
  */
  readonly for?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#keep_firing_for AppsRulesAlertruleV0Alpha1#keep_firing_for}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#labels AppsRulesAlertruleV0Alpha1#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The number of missing series evaluations that must occur before the rule is considered to be resolved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#missing_series_evals_to_resolve AppsRulesAlertruleV0Alpha1#missing_series_evals_to_resolve}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#no_data_state AppsRulesAlertruleV0Alpha1#no_data_state}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#panel_ref AppsRulesAlertruleV0Alpha1#panel_ref}
  */
  readonly panelRef?: { [key: string]: string };
  /**
  * Sets whether the rule should be paused or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#paused AppsRulesAlertruleV0Alpha1#paused}
  */
  readonly paused?: boolean | cdktf.IResolvable;
  /**
  * The title of the alert rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#title AppsRulesAlertruleV0Alpha1#title}
  */
  readonly title: string;
  /**
  * notification_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#notification_settings AppsRulesAlertruleV0Alpha1#notification_settings}
  */
  readonly notificationSettings?: AppsRulesAlertruleV0Alpha1SpecNotificationSettings;
  /**
  * trigger block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#trigger AppsRulesAlertruleV0Alpha1#trigger}
  */
...
export function appsRulesAlertruleV0Alpha1SpecToTerraform(struct?: AppsRulesAlertruleV0Alpha1Spec | cdktf.IResolvable): any {
  ...
  return {
    ...
    panel_ref: cdktf.hashMapper(cdktf.stringToTerraform)(struct!.panelRef),
...
export function appsRulesAlertruleV0Alpha1SpecToHclTerraform(struct?: AppsRulesAlertruleV0Alpha1Spec | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    panel_ref: {
      value: cdktf.hashMapperHcl(cdktf.stringToHclTerraform)(struct!.panelRef),
      isBlock: false,
      type: "map",
      storageClassType: "stringMap",
    },
...
export class AppsRulesAlertruleV0Alpha1SpecOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _panelRef?: { [key: string]: string }; 
  public get panelRef() {
    return this.getStringMapAttribute('panel_ref');
  }
  public set panelRef(value: { [key: string]: string }) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1 grafana_apps_rules_alertrule_v0alpha1}
*/
export class AppsRulesAlertruleV0Alpha1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsRulesAlertruleV0Alpha1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/apps_rules_alertrule_v0alpha1 grafana_apps_rules_alertrule_v0alpha1} Resource
  *
  * @param scope The scope in which to define this construct
