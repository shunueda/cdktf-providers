// https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/k6_project_allowed_load_zones
...
export interface K6ProjectAllowedLoadZonesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/k6_project_allowed_load_zones#allowed_load_zones K6ProjectAllowedLoadZones#allowed_load_zones}
  */
  readonly allowedLoadZones: string[];
  /**
  * The identifier of the project to manage private allowed load zones for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/k6_project_allowed_load_zones#project_id K6ProjectAllowedLoadZones#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/k6_project_allowed_load_zones grafana_k6_project_allowed_load_zones}
*/
export class K6ProjectAllowedLoadZones extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing K6ProjectAllowedLoadZones that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/k6_project_allowed_load_zones#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/k6_project_allowed_load_zones grafana_k6_project_allowed_load_zones} Resource
  *
  * @param scope The scope in which to define this construct
