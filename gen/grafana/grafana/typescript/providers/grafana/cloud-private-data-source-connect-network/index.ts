// https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_private_data_source_connect_network
...
export interface CloudPrivateDataSourceConnectNetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_private_data_source_connect_network#display_name CloudPrivateDataSourceConnectNetwork#display_name}
  */
  readonly displayName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_private_data_source_connect_network#id CloudPrivateDataSourceConnectNetwork#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_private_data_source_connect_network#name CloudPrivateDataSourceConnectNetwork#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_private_data_source_connect_network#region CloudPrivateDataSourceConnectNetwork#region}
  */
  readonly region: string;
  /**
  * The identifier of the stack.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_private_data_source_connect_network#stack_identifier CloudPrivateDataSourceConnectNetwork#stack_identifier}
  */
  readonly stackIdentifier: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_private_data_source_connect_network grafana_cloud_private_data_source_connect_network}
*/
export class CloudPrivateDataSourceConnectNetwork extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudPrivateDataSourceConnectNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_private_data_source_connect_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.21.0/docs/resources/cloud_private_data_source_connect_network grafana_cloud_private_data_source_connect_network} Resource
  *
  * @param scope The scope in which to define this construct
