// https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/service_account_permission
...
export interface ServiceAccountPermissionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/service_account_permission#id ServiceAccountPermission#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/service_account_permission#org_id ServiceAccountPermission#org_id}
  */
  readonly orgId?: string;
  /**
  * The id of the service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/service_account_permission#service_account_id ServiceAccountPermission#service_account_id}
  */
  readonly serviceAccountId: string;
  /**
  * permissions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/service_account_permission#permissions ServiceAccountPermission#permissions}
  */
...
export interface ServiceAccountPermissionPermissions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/service_account_permission#permission ServiceAccountPermission#permission}
  */
  readonly permission: string;
  /**
  * ID of the team to manage permissions for. Defaults to `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/service_account_permission#team_id ServiceAccountPermission#team_id}
  */
  readonly teamId?: string;
  /**
  * ID of the user or service account to manage permissions for. Defaults to `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/service_account_permission#user_id ServiceAccountPermission#user_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/service_account_permission grafana_service_account_permission}
*/
export class ServiceAccountPermission extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccountPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/service_account_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/service_account_permission grafana_service_account_permission} Resource
  *
  * @param scope The scope in which to define this construct
