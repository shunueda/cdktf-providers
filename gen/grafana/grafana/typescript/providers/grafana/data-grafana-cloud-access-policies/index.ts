// https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/cloud_access_policies
...
export interface DataGrafanaCloudAccessPoliciesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/cloud_access_policies#name_filter DataGrafanaCloudAccessPolicies#name_filter}
  */
  readonly nameFilter?: string;
  /**
  * If set, only access policies in the specified region will be returned. This is faster than filtering in Terraform.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/cloud_access_policies#region_filter DataGrafanaCloudAccessPolicies#region_filter}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/cloud_access_policies grafana_cloud_access_policies}
*/
export class DataGrafanaCloudAccessPolicies extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaCloudAccessPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/cloud_access_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/cloud_access_policies grafana_cloud_access_policies} Data Source
  *
  * @param scope The scope in which to define this construct
