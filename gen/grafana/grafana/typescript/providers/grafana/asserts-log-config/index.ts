// https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config
...
export interface AssertsLogConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#data_source_uid AssertsLogConfig#data_source_uid}
  */
  readonly dataSourceUid: string;
  /**
  * Is it the default config, therefore undeletable?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#default_config AssertsLogConfig#default_config}
  */
  readonly defaultConfig: boolean | cdktf.IResolvable;
  /**
  * Mapping of entity properties to log labels.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#entity_property_to_log_label_mapping AssertsLogConfig#entity_property_to_log_label_mapping}
  */
  readonly entityPropertyToLogLabelMapping?: { [key: string]: string };
  /**
  * Error label to filter logs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#error_label AssertsLogConfig#error_label}
  */
  readonly errorLabel?: string;
  /**
  * Filter logs by span ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#filter_by_span_id AssertsLogConfig#filter_by_span_id}
  */
  readonly filterBySpanId?: boolean | cdktf.IResolvable;
  /**
  * Filter logs by trace ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#filter_by_trace_id AssertsLogConfig#filter_by_trace_id}
  */
  readonly filterByTraceId?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#id AssertsLogConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#name AssertsLogConfig#name}
  */
  readonly name: string;
  /**
  * Priority of the log configuration. A lower number means a higher priority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#priority AssertsLogConfig#priority}
  */
  readonly priority: number;
  /**
  * match block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#match AssertsLogConfig#match}
  */
  readonly match?: AssertsLogConfigMatch[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#timeouts AssertsLogConfig#timeouts}
  */
...
export interface AssertsLogConfigMatch {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#op AssertsLogConfig#op}
  */
  readonly op: string;
  /**
  * Entity property to match.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#property AssertsLogConfig#property}
  */
  readonly property: string;
  /**
  * Values to match against.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#values AssertsLogConfig#values}
  */
...
export interface AssertsLogConfigTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#create AssertsLogConfig#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#delete AssertsLogConfig#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#read AssertsLogConfig#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#update AssertsLogConfig#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config grafana_asserts_log_config}
*/
export class AssertsLogConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AssertsLogConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/asserts_log_config grafana_asserts_log_config} Resource
  *
  * @param scope The scope in which to define this construct
