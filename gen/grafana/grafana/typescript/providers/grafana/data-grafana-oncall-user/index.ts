// https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/oncall_user
...
export interface DataGrafanaOncallUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/oncall_user#username DataGrafanaOncallUser#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/oncall_user grafana_oncall_user}
*/
export class DataGrafanaOncallUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaOncallUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/oncall_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/oncall_user grafana_oncall_user} Data Source
  *
  * @param scope The scope in which to define this construct
