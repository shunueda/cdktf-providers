// https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job
...
export interface MachineLearningJobConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job#custom_labels MachineLearningJob#custom_labels}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job#datasource_type MachineLearningJob#datasource_type}
  */
  readonly datasourceType: string;
  /**
  * The uid of the datasource to query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job#datasource_uid MachineLearningJob#datasource_uid}
  */
  readonly datasourceUid: string;
  /**
  * A description of the job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job#description MachineLearningJob#description}
  */
  readonly description?: string;
  /**
  * A list of holiday IDs or names to take into account when training the model.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job#holidays MachineLearningJob#holidays}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job#hyper_params MachineLearningJob#hyper_params}
  */
  readonly hyperParams?: { [key: string]: string };
  /**
  * The data interval in seconds to train the data on. Defaults to `300`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job#interval MachineLearningJob#interval}
  */
  readonly interval?: number;
  /**
  * The metric used to query the job results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job#metric MachineLearningJob#metric}
  */
  readonly metric: string;
  /**
  * The name of the job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job#name MachineLearningJob#name}
  */
  readonly name: string;
  /**
  * An object representing the query params to query Grafana with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job#query_params MachineLearningJob#query_params}
  */
  readonly queryParams: { [key: string]: string };
  /**
  * The data interval in seconds to train the data on. Defaults to `7776000`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job#training_window MachineLearningJob#training_window}
  */
  readonly trainingWindow?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job grafana_machine_learning_job}
*/
export class MachineLearningJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MachineLearningJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/machine_learning_job grafana_machine_learning_job} Resource
  *
  * @param scope The scope in which to define this construct
