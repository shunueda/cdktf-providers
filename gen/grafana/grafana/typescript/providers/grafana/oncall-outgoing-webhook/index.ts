// https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook
...
export interface OncallOutgoingWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#authorization_header OncallOutgoingWebhook#authorization_header}
  */
  readonly authorizationHeader?: string;
  /**
  * The data of the webhook.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#data OncallOutgoingWebhook#data}
  */
  readonly data?: string;
  /**
  * Toggle to send the entire webhook payload instead of using the values in the Data field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#forward_whole_payload OncallOutgoingWebhook#forward_whole_payload}
  */
  readonly forwardWholePayload?: boolean | cdktf.IResolvable;
  /**
  * Headers to add to the outgoing webhook request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#headers OncallOutgoingWebhook#headers}
  */
  readonly headers?: string;
  /**
  * The HTTP method used in the request made by the outgoing webhook. Defaults to `POST`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#http_method OncallOutgoingWebhook#http_method}
  */
  readonly httpMethod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#id OncallOutgoingWebhook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#integration_filter OncallOutgoingWebhook#integration_filter}
  */
  readonly integrationFilter?: string[];
  /**
  * Controls whether the outgoing webhook will trigger or is ignored. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#is_webhook_enabled OncallOutgoingWebhook#is_webhook_enabled}
  */
  readonly isWebhookEnabled?: boolean | cdktf.IResolvable;
  /**
  * The name of the outgoing webhook.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#name OncallOutgoingWebhook#name}
  */
  readonly name: string;
  /**
  * The auth data of the webhook. Used for Basic authentication
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#password OncallOutgoingWebhook#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#preset OncallOutgoingWebhook#preset}
  */
  readonly preset?: string;
  /**
  * The ID of the OnCall team (using the `grafana_oncall_team` datasource).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#team_id OncallOutgoingWebhook#team_id}
  */
  readonly teamId?: string;
  /**
  * A template used to dynamically determine whether the webhook should execute based on the content of the payload.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#trigger_template OncallOutgoingWebhook#trigger_template}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#trigger_type OncallOutgoingWebhook#trigger_type}
  */
  readonly triggerType?: string;
  /**
  * The webhook URL. Required when not using a preset that controls this field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#url OncallOutgoingWebhook#url}
  */
  readonly url?: string;
  /**
  * Username to use when making the outgoing webhook request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#user OncallOutgoingWebhook#user}
  */
  readonly user?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook grafana_oncall_outgoing_webhook}
*/
export class OncallOutgoingWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OncallOutgoingWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/resources/oncall_outgoing_webhook grafana_oncall_outgoing_webhook} Resource
  *
  * @param scope The scope in which to define this construct
