// https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/dashboard_permission
...
export interface DashboardPermissionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/dashboard_permission#dashboard_uid DashboardPermission#dashboard_uid}
  */
  readonly dashboardUid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/dashboard_permission#id DashboardPermission#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/dashboard_permission#org_id DashboardPermission#org_id}
  */
  readonly orgId?: string;
  /**
  * permissions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/dashboard_permission#permissions DashboardPermission#permissions}
  */
...
export interface DashboardPermissionPermissions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/dashboard_permission#permission DashboardPermission#permission}
  */
  readonly permission: string;
  /**
  * Name of the basic role to manage permissions for. Options: `Viewer`, `Editor` or `Admin`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/dashboard_permission#role DashboardPermission#role}
  */
  readonly role?: string;
  /**
  * ID of the team to manage permissions for. Defaults to `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/dashboard_permission#team_id DashboardPermission#team_id}
  */
  readonly teamId?: string;
  /**
  * ID of the user or service account to manage permissions for. Defaults to `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/dashboard_permission#user_id DashboardPermission#user_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/dashboard_permission grafana_dashboard_permission}
*/
export class DashboardPermission extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DashboardPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/dashboard_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/dashboard_permission grafana_dashboard_permission} Resource
  *
  * @param scope The scope in which to define this construct
