// https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/data-sources/oncall_users
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/data-sources/oncall_users grafana_oncall_users}
*/
export class DataGrafanaOncallUsers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaOncallUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/data-sources/oncall_users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/data-sources/oncall_users grafana_oncall_users} Data Source
  *
  * @param scope The scope in which to define this construct
