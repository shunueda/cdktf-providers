// https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/data-sources/frontend_o11y_app
...
export interface DataGrafanaFrontendO11YAppConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/data-sources/frontend_o11y_app#name DataGrafanaFrontendO11YApp#name}
  */
  readonly name: string;
  /**
  * The Stack ID of the Grafana Cloud instance. Part of the Terraform Resource ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/data-sources/frontend_o11y_app#stack_id DataGrafanaFrontendO11YApp#stack_id}
  */
  readonly stackId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/data-sources/frontend_o11y_app grafana_frontend_o11y_app}
*/
export class DataGrafanaFrontendO11YApp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaFrontendO11YApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/data-sources/frontend_o11y_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/data-sources/frontend_o11y_app grafana_frontend_o11y_app} Data Source
  *
  * @param scope The scope in which to define this construct
