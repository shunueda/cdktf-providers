// https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/cloud_provider_azure_credential
...
export interface DataGrafanaCloudProviderAzureCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/cloud_provider_azure_credential#resource_id DataGrafanaCloudProviderAzureCredential#resource_id}
  */
  readonly resourceId: string;
  /**
  * The StackID of the Grafana Cloud instance. Part of the Terraform Resource ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/cloud_provider_azure_credential#stack_id DataGrafanaCloudProviderAzureCredential#stack_id}
  */
  readonly stackId: string;
  /**
  * auto_discovery_configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/cloud_provider_azure_credential#auto_discovery_configuration DataGrafanaCloudProviderAzureCredential#auto_discovery_configuration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/cloud_provider_azure_credential#resource_discovery_tag_filter DataGrafanaCloudProviderAzureCredential#resource_discovery_tag_filter}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/cloud_provider_azure_credential grafana_cloud_provider_azure_credential}
*/
export class DataGrafanaCloudProviderAzureCredential extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaCloudProviderAzureCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/cloud_provider_azure_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/cloud_provider_azure_credential grafana_cloud_provider_azure_credential} Data Source
  *
  * @param scope The scope in which to define this construct
