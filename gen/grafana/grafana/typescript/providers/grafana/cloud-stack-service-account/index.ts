// https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/cloud_stack_service_account
...
export interface CloudStackServiceAccountConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/cloud_stack_service_account#id CloudStackServiceAccount#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/cloud_stack_service_account#is_disabled CloudStackServiceAccount#is_disabled}
  */
  readonly isDisabled?: boolean | cdktf.IResolvable;
  /**
  * The name of the service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/cloud_stack_service_account#name CloudStackServiceAccount#name}
  */
  readonly name: string;
  /**
  * The basic role of the service account in the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/cloud_stack_service_account#role CloudStackServiceAccount#role}
  */
  readonly role: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/cloud_stack_service_account#stack_slug CloudStackServiceAccount#stack_slug}
  */
  readonly stackSlug: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/cloud_stack_service_account grafana_cloud_stack_service_account}
*/
export class CloudStackServiceAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudStackServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/cloud_stack_service_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/cloud_stack_service_account grafana_cloud_stack_service_account} Resource
  *
  * @param scope The scope in which to define this construct
