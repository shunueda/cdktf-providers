// https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/k6_project_limits
...
export interface K6ProjectLimitsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/k6_project_limits#duration_max_per_test K6ProjectLimits#duration_max_per_test}
  */
  readonly durationMaxPerTest?: number;
  /**
  * The identifier of the project to manage limits for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/k6_project_limits#project_id K6ProjectLimits#project_id}
  */
  readonly projectId: string;
  /**
  * Maximum number of concurrent browser virtual users (VUs) used in one test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/k6_project_limits#vu_browser_max_per_test K6ProjectLimits#vu_browser_max_per_test}
  */
  readonly vuBrowserMaxPerTest?: number;
  /**
  * Maximum number of concurrent virtual users (VUs) used in one test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/k6_project_limits#vu_max_per_test K6ProjectLimits#vu_max_per_test}
  */
  readonly vuMaxPerTest?: number;
  /**
  * Maximum amount of virtual user hours (VU/h) used per one calendar month.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/k6_project_limits#vuh_max_per_month K6ProjectLimits#vuh_max_per_month}
  */
  readonly vuhMaxPerMonth?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/k6_project_limits grafana_k6_project_limits}
*/
export class K6ProjectLimits extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing K6ProjectLimits that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/k6_project_limits#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/k6_project_limits grafana_k6_project_limits} Resource
  *
  * @param scope The scope in which to define this construct
