// https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/role_assignment_item
...
export interface RoleAssignmentItemConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/role_assignment_item#org_id RoleAssignmentItem#org_id}
  */
  readonly orgId?: string;
  /**
  * the role UID onto which to assign an actor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/role_assignment_item#role_uid RoleAssignmentItem#role_uid}
  */
  readonly roleUid: string;
  /**
  * the service account onto which the role is to be assigned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/role_assignment_item#service_account_id RoleAssignmentItem#service_account_id}
  */
  readonly serviceAccountId?: string;
  /**
  * the team onto which the role is to be assigned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/role_assignment_item#team_id RoleAssignmentItem#team_id}
  */
  readonly teamId?: string;
  /**
  * the user onto which the role is to be assigned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/role_assignment_item#user_id RoleAssignmentItem#user_id}
  */
  readonly userId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/role_assignment_item grafana_role_assignment_item}
*/
export class RoleAssignmentItem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoleAssignmentItem that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/role_assignment_item#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/role_assignment_item grafana_role_assignment_item} Resource
  *
  * @param scope The scope in which to define this construct
