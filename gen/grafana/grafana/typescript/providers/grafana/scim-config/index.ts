// https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/scim_config
...
export interface ScimConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/scim_config#enable_group_sync ScimConfig#enable_group_sync}
  */
  readonly enableGroupSync: boolean | cdktf.IResolvable;
  /**
  * Whether user synchronization is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/scim_config#enable_user_sync ScimConfig#enable_user_sync}
  */
  readonly enableUserSync: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/scim_config#id ScimConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/scim_config#org_id ScimConfig#org_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/scim_config#reject_non_provisioned_users ScimConfig#reject_non_provisioned_users}
  */
  readonly rejectNonProvisionedUsers: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/scim_config grafana_scim_config}
*/
export class ScimConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScimConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/scim_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/scim_config grafana_scim_config} Resource
  *
  * @param scope The scope in which to define this construct
