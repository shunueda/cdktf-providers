// https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/dashboard_public
...
export interface DashboardPublicConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/dashboard_public#access_token DashboardPublic#access_token}
  */
  readonly accessToken?: string;
  /**
  * Set to `true` to show annotations. The default value is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/dashboard_public#annotations_enabled DashboardPublic#annotations_enabled}
  */
  readonly annotationsEnabled?: boolean | cdktf.IResolvable;
  /**
  * The unique identifier of the original dashboard.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/dashboard_public#dashboard_uid DashboardPublic#dashboard_uid}
  */
  readonly dashboardUid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/dashboard_public#id DashboardPublic#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/dashboard_public#is_enabled DashboardPublic#is_enabled}
  */
  readonly isEnabled?: boolean | cdktf.IResolvable;
  /**
  * The Organization ID. If not set, the Org ID defined in the provider block will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/dashboard_public#org_id DashboardPublic#org_id}
  */
  readonly orgId?: string;
  /**
  * Set the share mode. The default value is `public`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/dashboard_public#share DashboardPublic#share}
  */
  readonly share?: string;
  /**
  * Set to `true` to enable the time picker in the public dashboard. The default value is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/dashboard_public#time_selection_enabled DashboardPublic#time_selection_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/dashboard_public#uid DashboardPublic#uid}
  */
  readonly uid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/dashboard_public grafana_dashboard_public}
*/
export class DashboardPublic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DashboardPublic that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/dashboard_public#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/dashboard_public grafana_dashboard_public} Resource
  *
  * @param scope The scope in which to define this construct
