// https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/machine_learning_holiday
...
export interface MachineLearningHolidayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/machine_learning_holiday#description MachineLearningHoliday#description}
  */
  readonly description?: string;
  /**
  * The timezone to use for events in the iCal file pointed to by ical_url.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/machine_learning_holiday#ical_timezone MachineLearningHoliday#ical_timezone}
  */
  readonly icalTimezone?: string;
  /**
  * A URL to an iCal file containing all occurrences of the holiday.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/machine_learning_holiday#ical_url MachineLearningHoliday#ical_url}
  */
  readonly icalUrl?: string;
  /**
  * The name of the holiday.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/machine_learning_holiday#name MachineLearningHoliday#name}
  */
  readonly name: string;
  /**
  * custom_periods block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/machine_learning_holiday#custom_periods MachineLearningHoliday#custom_periods}
  */
...
export interface MachineLearningHolidayCustomPeriods {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/machine_learning_holiday#end_time MachineLearningHoliday#end_time}
  */
  ...
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/machine_learning_holiday#start_time MachineLearningHoliday#start_time}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/machine_learning_holiday grafana_machine_learning_holiday}
*/
export class MachineLearningHoliday extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MachineLearningHoliday that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/machine_learning_holiday#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/machine_learning_holiday grafana_machine_learning_holiday} Resource
  *
  * @param scope The scope in which to define this construct
