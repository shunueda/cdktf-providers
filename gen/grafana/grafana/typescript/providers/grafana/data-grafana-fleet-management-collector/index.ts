// https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/fleet_management_collector
...
export interface DataGrafanaFleetManagementCollectorConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the collector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/fleet_management_collector#id DataGrafanaFleetManagementCollector#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/fleet_management_collector grafana_fleet_management_collector}
*/
export class DataGrafanaFleetManagementCollector extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaFleetManagementCollector that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/fleet_management_collector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/data-sources/fleet_management_collector grafana_fleet_management_collector} Data Source
  *
  * @param scope The scope in which to define this construct
