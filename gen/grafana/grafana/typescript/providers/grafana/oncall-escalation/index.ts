// https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation
...
export interface OncallEscalationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#action_to_trigger OncallEscalation#action_to_trigger}
  */
  readonly actionToTrigger?: string;
  /**
  * The duration of delay for wait type step. (60-86400) seconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#duration OncallEscalation#duration}
  */
  readonly duration?: number;
  /**
  * The ID of the escalation chain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#escalation_chain_id OncallEscalation#escalation_chain_id}
  */
  readonly escalationChainId: string;
  /**
  * The ID of a User Group for notify_user_group type step.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#group_to_notify OncallEscalation#group_to_notify}
  */
  readonly groupToNotify?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#id OncallEscalation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#important OncallEscalation#important}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#notify_if_time_from OncallEscalation#notify_if_time_from}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#notify_if_time_to OncallEscalation#notify_if_time_to}
  */
  readonly notifyIfTimeTo?: string;
  /**
  * ID of a Schedule for notify_on_call_from_schedule type step.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#notify_on_call_from_schedule OncallEscalation#notify_on_call_from_schedule}
  */
  readonly notifyOnCallFromSchedule?: string;
  /**
  * The ID of a Team for a notify_team_members type step.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#notify_to_team_members OncallEscalation#notify_to_team_members}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#num_alerts_in_window OncallEscalation#num_alerts_in_window}
  */
  readonly numAlertsInWindow?: number;
  /**
  * Time window in minutes to count alerts for notify_if_num_alerts_in_window type step.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#num_minutes_in_window OncallEscalation#num_minutes_in_window}
  */
  readonly numMinutesInWindow?: number;
  /**
  * The list of ID's of users for notify_persons type step.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#persons_to_notify OncallEscalation#persons_to_notify}
  */
  readonly personsToNotify?: string[];
  /**
  * The list of ID's of users for notify_person_next_each_time type step.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#persons_to_notify_next_each_time OncallEscalation#persons_to_notify_next_each_time}
  */
  readonly personsToNotifyNextEachTime?: string[];
  /**
  * The position of the escalation step (starts from 0).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#position OncallEscalation#position}
  */
  readonly position: number;
  /**
  * The severity of the incident for declare_incident type step.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#severity OncallEscalation#severity}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#type OncallEscalation#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation grafana_oncall_escalation}
*/
export class OncallEscalation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OncallEscalation that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/oncall_escalation grafana_oncall_escalation} Resource
  *
  * @param scope The scope in which to define this construct
