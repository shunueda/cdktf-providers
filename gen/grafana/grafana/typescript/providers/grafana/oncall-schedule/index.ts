// https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule
...
export interface OncallScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule#enable_web_overrides OncallSchedule#enable_web_overrides}
  */
  readonly enableWebOverrides?: boolean | cdktf.IResolvable;
  /**
  * The URL of external iCal calendar which override primary events.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule#ical_url_overrides OncallSchedule#ical_url_overrides}
  */
  readonly icalUrlOverrides?: string;
  /**
  * The URL of the external calendar iCal file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule#ical_url_primary OncallSchedule#ical_url_primary}
  */
  readonly icalUrlPrimary?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule#id OncallSchedule#id}
  *
  ...
  * The schedule's name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule#name OncallSchedule#name}
  */
  readonly name: string;
  /**
  * The list of ID's of on-call shifts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule#shifts OncallSchedule#shifts}
  */
  readonly shifts?: string[];
  /**
  * The ID of the OnCall team (using the `grafana_oncall_team` datasource).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule#team_id OncallSchedule#team_id}
  */
  readonly teamId?: string;
  /**
  * The schedule's time zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule#time_zone OncallSchedule#time_zone}
  */
  readonly timeZone?: string;
  /**
  * The schedule's type. Valid values are `ical`, `calendar`, `web`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule#type OncallSchedule#type}
  */
  readonly type: string;
  /**
  * slack block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule#slack OncallSchedule#slack}
  */
...
export interface OncallScheduleSlack {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule#channel_id OncallSchedule#channel_id}
  */
  readonly channelId?: string;
  /**
  * Slack user group id. Members of user group will be updated when on-call users change.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule#user_group_id OncallSchedule#user_group_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule grafana_oncall_schedule}
*/
export class OncallSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OncallSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/oncall_schedule grafana_oncall_schedule} Resource
  *
  * @param scope The scope in which to define this construct
