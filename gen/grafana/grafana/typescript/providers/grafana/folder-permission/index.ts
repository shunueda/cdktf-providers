// https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/folder_permission
...
export interface FolderPermissionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/folder_permission#folder_uid FolderPermission#folder_uid}
  */
  readonly folderUid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/folder_permission#id FolderPermission#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/folder_permission#org_id FolderPermission#org_id}
  */
  readonly orgId?: string;
  /**
  * permissions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/folder_permission#permissions FolderPermission#permissions}
  */
...
export interface FolderPermissionPermissions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/folder_permission#permission FolderPermission#permission}
  */
  readonly permission: string;
  /**
  * Name of the basic role to manage permissions for. Options: `Viewer`, `Editor` or `Admin`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/folder_permission#role FolderPermission#role}
  */
  readonly role?: string;
  /**
  * ID of the team to manage permissions for. Defaults to `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/folder_permission#team_id FolderPermission#team_id}
  */
  readonly teamId?: string;
  /**
  * ID of the user or service account to manage permissions for. Defaults to `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/folder_permission#user_id FolderPermission#user_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/folder_permission grafana_folder_permission}
*/
export class FolderPermission extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FolderPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/folder_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.2/docs/resources/folder_permission grafana_folder_permission} Resource
  *
  * @param scope The scope in which to define this construct
