// https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/data_source_config_lbac_rules
...
export interface DataSourceConfigLbacRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/data_source_config_lbac_rules#datasource_uid DataSourceConfigLbacRules#datasource_uid}
  */
  readonly datasourceUid: string;
  /**
  * JSON-encoded LBAC rules for the data source. Map of team UIDs to lists of rule strings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/data_source_config_lbac_rules#rules DataSourceConfigLbacRules#rules}
  */
  readonly rules: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/data_source_config_lbac_rules grafana_data_source_config_lbac_rules}
*/
export class DataSourceConfigLbacRules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataSourceConfigLbacRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/data_source_config_lbac_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/data_source_config_lbac_rules grafana_data_source_config_lbac_rules} Resource
  *
  * @param scope The scope in which to define this construct
