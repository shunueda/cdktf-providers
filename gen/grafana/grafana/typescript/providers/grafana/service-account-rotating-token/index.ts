// https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_rotating_token
...
export interface ServiceAccountRotatingTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_rotating_token#delete_on_destroy ServiceAccountRotatingToken#delete_on_destroy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_rotating_token#early_rotation_window_seconds ServiceAccountRotatingToken#early_rotation_window_seconds}
  */
  readonly earlyRotationWindowSeconds: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_rotating_token#id ServiceAccountRotatingToken#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_rotating_token#name_prefix ServiceAccountRotatingToken#name_prefix}
  */
  readonly namePrefix: string;
  /**
  * The token expiration in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_rotating_token#seconds_to_live ServiceAccountRotatingToken#seconds_to_live}
  */
  readonly secondsToLive: number;
  /**
  * The ID of the service account to which the token belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_rotating_token#service_account_id ServiceAccountRotatingToken#service_account_id}
  */
  readonly serviceAccountId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_rotating_token grafana_service_account_rotating_token}
*/
export class ServiceAccountRotatingToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccountRotatingToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_rotating_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_rotating_token grafana_service_account_rotating_token} Resource
  *
  * @param scope The scope in which to define this construct
