// https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job
...
export interface CloudProviderAwsResourceMetadataScrapeJobConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job#aws_account_resource_id CloudProviderAwsResourceMetadataScrapeJob#aws_account_resource_id}
  */
  readonly awsAccountResourceId: string;
  /**
  * Whether the AWS Resource Metadata Scrape Job is enabled or not. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job#enabled CloudProviderAwsResourceMetadataScrapeJob#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The name of the AWS Resource Metadata Scrape Job. Part of the Terraform Resource ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job#name CloudProviderAwsResourceMetadataScrapeJob#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job#regions_subset_override CloudProviderAwsResourceMetadataScrapeJob#regions_subset_override}
  */
  readonly regionsSubsetOverride?: string[];
  /**
  * The Stack ID of the Grafana Cloud instance. Part of the Terraform Resource ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job#stack_id CloudProviderAwsResourceMetadataScrapeJob#stack_id}
  */
  readonly stackId: string;
  /**
  * A set of static labels to add to all metrics exported by this scrape job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job#static_labels CloudProviderAwsResourceMetadataScrapeJob#static_labels}
  */
  readonly staticLabels?: { [key: string]: string };
  /**
  * service block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job#service CloudProviderAwsResourceMetadataScrapeJob#service}
  */
...
export interface CloudProviderAwsResourceMetadataScrapeJobServiceResourceDiscoveryTagFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job#key CloudProviderAwsResourceMetadataScrapeJob#key}
  */
  readonly key: string;
  /**
  * The value of the tag filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job#value CloudProviderAwsResourceMetadataScrapeJob#value}
  */
...
export interface CloudProviderAwsResourceMetadataScrapeJobService {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job#scrape_interval_seconds CloudProviderAwsResourceMetadataScrapeJob#scrape_interval_seconds}
  */
  readonly scrapeIntervalSeconds?: number;
  /**
  * resource_discovery_tag_filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job#resource_discovery_tag_filter CloudProviderAwsResourceMetadataScrapeJob#resource_discovery_tag_filter}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job grafana_cloud_provider_aws_resource_metadata_scrape_job}
*/
export class CloudProviderAwsResourceMetadataScrapeJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudProviderAwsResourceMetadataScrapeJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.1/docs/resources/cloud_provider_aws_resource_metadata_scrape_job grafana_cloud_provider_aws_resource_metadata_scrape_job} Resource
  *
  * @param scope The scope in which to define this construct
