// https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_stack
...
export interface CloudStackConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_stack#delete_protection CloudStack#delete_protection}
  */
  readonly deleteProtection?: boolean | cdktf.IResolvable;
  /**
  * Description of stack.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_stack#description CloudStack#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_stack#labels CloudStack#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Name of stack. Conventionally matches the url of the instance (e.g. `<stack_slug>.grafana.net`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_stack#name CloudStack#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_stack#region_slug CloudStack#region_slug}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_stack#slug CloudStack#slug}
  */
  readonly slug: string;
  /**
  * Custom URL for the Grafana instance. Must have a CNAME setup to point to `.grafana.net` before creating the stack
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_stack#url CloudStack#url}
  */
  readonly url?: string;
  /**
  * Whether to wait for readiness of the stack after creating it. The check is a HEAD request to the stack URL (Grafana instance). Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_stack#wait_for_readiness CloudStack#wait_for_readiness}
  */
  readonly waitForReadiness?: boolean | cdktf.IResolvable;
  /**
  * How long to wait for readiness (if enabled). Defaults to `5m0s`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_stack#wait_for_readiness_timeout CloudStack#wait_for_readiness_timeout}
  */
  readonly waitForReadinessTimeout?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_stack grafana_cloud_stack}
*/
export class CloudStack extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudStack that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_stack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/cloud_stack grafana_cloud_stack} Resource
  *
  * @param scope The scope in which to define this construct
