// https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/data-sources/fleet_management_collectors
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/data-sources/fleet_management_collectors grafana_fleet_management_collectors}
*/
export class DataGrafanaFleetManagementCollectors extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaFleetManagementCollectors that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/data-sources/fleet_management_collectors#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.12.2/docs/data-sources/fleet_management_collectors grafana_fleet_management_collectors} Data Source
  *
  * @param scope The scope in which to define this construct
