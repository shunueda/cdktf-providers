// https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/apps_dashboard_dashboard_v1beta1
...
export interface AppsDashboardDashboardV1Beta1Config extends cdktf.TerraformMetaArguments {
  ...
  * metadata block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/apps_dashboard_dashboard_v1beta1#metadata AppsDashboardDashboardV1Beta1#metadata}
  */
  readonly metadata?: AppsDashboardDashboardV1Beta1Metadata;
  /**
  * options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/apps_dashboard_dashboard_v1beta1#options AppsDashboardDashboardV1Beta1#options}
  */
  readonly options?: AppsDashboardDashboardV1Beta1Options;
  /**
  * spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/apps_dashboard_dashboard_v1beta1#spec AppsDashboardDashboardV1Beta1#spec}
  */
...
export interface AppsDashboardDashboardV1Beta1Metadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/apps_dashboard_dashboard_v1beta1#folder_uid AppsDashboardDashboardV1Beta1#folder_uid}
  */
  readonly folderUid?: string;
  /**
  * The unique identifier of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/apps_dashboard_dashboard_v1beta1#uid AppsDashboardDashboardV1Beta1#uid}
  */
  readonly uid: string;
}
...
export interface AppsDashboardDashboardV1Beta1Options {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/apps_dashboard_dashboard_v1beta1#overwrite AppsDashboardDashboardV1Beta1#overwrite}
  */
...
export interface AppsDashboardDashboardV1Beta1Spec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/apps_dashboard_dashboard_v1beta1#json AppsDashboardDashboardV1Beta1#json}
  */
  readonly json: string;
  /**
  * The tags of the dashboard. If not set, the tags will be derived from the JSON spec.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/apps_dashboard_dashboard_v1beta1#tags AppsDashboardDashboardV1Beta1#tags}
  */
  readonly tags?: string[];
  /**
  * The title of the dashboard. If not set, the title will be derived from the JSON spec.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/apps_dashboard_dashboard_v1beta1#title AppsDashboardDashboardV1Beta1#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/apps_dashboard_dashboard_v1beta1 grafana_apps_dashboard_dashboard_v1beta1}
*/
export class AppsDashboardDashboardV1Beta1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsDashboardDashboardV1Beta1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/apps_dashboard_dashboard_v1beta1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/resources/apps_dashboard_dashboard_v1beta1 grafana_apps_dashboard_dashboard_v1beta1} Resource
  *
  * @param scope The scope in which to define this construct
