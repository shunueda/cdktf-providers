// https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/k6_schedule
...
export interface DataGrafanaK6ScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/k6_schedule#load_test_id DataGrafanaK6Schedule#load_test_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/k6_schedule grafana_k6_schedule}
*/
export class DataGrafanaK6Schedule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaK6Schedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/k6_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/data-sources/k6_schedule grafana_k6_schedule} Data Source
  *
  * @param scope The scope in which to define this construct
