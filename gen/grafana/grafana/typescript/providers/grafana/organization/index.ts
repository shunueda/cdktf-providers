// https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/organization
...
export interface OrganizationConfig extends cdktf.TerraformMetaArguments {
  ...
  *  Defaults to `admin`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/organization#admin_user Organization#admin_user}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/organization#admins Organization#admins}
  */
  ...
  *  Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/organization#create_users Organization#create_users}
  */
  ...
  * Grafana unless 'create_users' is set to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/organization#editors Organization#editors}
  */
  readonly editors?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/organization#id Organization#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/organization#name Organization#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/organization#users_without_access Organization#users_without_access}
  */
  ...
  * Grafana unless 'create_users' is set to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/organization#viewers Organization#viewers}
  */
  readonly viewers?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/organization grafana_organization}
*/
export class Organization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Organization that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.18.0/docs/resources/organization grafana_organization} Resource
  *
  * @param scope The scope in which to define this construct
