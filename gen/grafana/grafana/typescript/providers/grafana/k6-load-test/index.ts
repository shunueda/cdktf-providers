// https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/k6_load_test
...
export interface K6LoadTestConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/k6_load_test#baseline_test_run_id K6LoadTest#baseline_test_run_id}
  */
  readonly baselineTestRunId?: string;
  /**
  * Human-friendly identifier of the load test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/k6_load_test#name K6LoadTest#name}
  */
  readonly name: string;
  /**
  * The identifier of the project this load test belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/k6_load_test#project_id K6LoadTest#project_id}
  */
  readonly projectId: string;
  /**
  * The k6 test script content. Can be provided inline or via the `file()` function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/k6_load_test#script K6LoadTest#script}
  */
  readonly script: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/k6_load_test grafana_k6_load_test}
*/
export class K6LoadTest extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing K6LoadTest that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/k6_load_test#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/k6_load_test grafana_k6_load_test} Resource
  *
  * @param scope The scope in which to define this construct
