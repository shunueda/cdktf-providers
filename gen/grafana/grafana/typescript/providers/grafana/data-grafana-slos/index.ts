// https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/slos
...
export interface DataGrafanaSlosConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/slos#id DataGrafanaSlos#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/slos grafana_slos}
*/
export class DataGrafanaSlos extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGrafanaSlos that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/slos#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.17.0/docs/data-sources/slos grafana_slos} Data Source
  *
  * @param scope The scope in which to define this construct
