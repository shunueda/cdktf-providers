// https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_private_data_source_connect_network_token
...
export interface CloudPrivateDataSourceConnectNetworkTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_private_data_source_connect_network_token#display_name CloudPrivateDataSourceConnectNetworkToken#display_name}
  */
  readonly displayName?: string;
  /**
  * Expiration date of the private data source network token. Does not expire by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_private_data_source_connect_network_token#expires_at CloudPrivateDataSourceConnectNetworkToken#expires_at}
  */
  readonly expiresAt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_private_data_source_connect_network_token#id CloudPrivateDataSourceConnectNetworkToken#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_private_data_source_connect_network_token#name CloudPrivateDataSourceConnectNetworkToken#name}
  */
  readonly name: string;
  /**
  * ID of the private data source network for which to create a token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_private_data_source_connect_network_token#pdc_network_id CloudPrivateDataSourceConnectNetworkToken#pdc_network_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_private_data_source_connect_network_token#region CloudPrivateDataSourceConnectNetworkToken#region}
  */
  readonly region: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_private_data_source_connect_network_token grafana_cloud_private_data_source_connect_network_token}
*/
export class CloudPrivateDataSourceConnectNetworkToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudPrivateDataSourceConnectNetworkToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_private_data_source_connect_network_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.14.0/docs/resources/cloud_private_data_source_connect_network_token grafana_cloud_private_data_source_connect_network_token} Resource
  *
  * @param scope The scope in which to define this construct
