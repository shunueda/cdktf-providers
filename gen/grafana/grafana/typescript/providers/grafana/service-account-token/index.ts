// https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_token
...
export interface ServiceAccountTokenConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_token#id ServiceAccountToken#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_token#name ServiceAccountToken#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_token#seconds_to_live ServiceAccountToken#seconds_to_live}
  */
  readonly secondsToLive?: number;
  /**
  * The ID of the service account to which the token belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_token#service_account_id ServiceAccountToken#service_account_id}
  */
  readonly serviceAccountId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_token grafana_service_account_token}
*/
export class ServiceAccountToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccountToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/grafana/grafana/4.20.0/docs/resources/service_account_token grafana_service_account_token} Resource
  *
  * @param scope The scope in which to define this construct
