// https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/cloud_project_kube_iprestrictions
...
export interface DataOvhCloudProjectKubeIprestrictionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/cloud_project_kube_iprestrictions#id DataOvhCloudProjectKubeIprestrictions#id}
  *
  ...
  * Kube ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/cloud_project_kube_iprestrictions#kube_id DataOvhCloudProjectKubeIprestrictions#kube_id}
  */
  readonly kubeId: string;
  /**
  * Service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/cloud_project_kube_iprestrictions#service_name DataOvhCloudProjectKubeIprestrictions#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/cloud_project_kube_iprestrictions ovh_cloud_project_kube_iprestrictions}
*/
export class DataOvhCloudProjectKubeIprestrictions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhCloudProjectKubeIprestrictions that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/cloud_project_kube_iprestrictions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/cloud_project_kube_iprestrictions ovh_cloud_project_kube_iprestrictions} Data Source
  *
  * @param scope The scope in which to define this construct
