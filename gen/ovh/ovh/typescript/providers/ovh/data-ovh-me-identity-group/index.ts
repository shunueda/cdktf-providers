// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_group
...
export interface DataOvhMeIdentityGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_group#id DataOvhMeIdentityGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_group#name DataOvhMeIdentityGroup#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_group ovh_me_identity_group}
*/
export class DataOvhMeIdentityGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhMeIdentityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_group ovh_me_identity_group} Data Source
  *
  * @param scope The scope in which to define this construct
