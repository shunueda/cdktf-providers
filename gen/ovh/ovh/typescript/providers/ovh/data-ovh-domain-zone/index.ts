// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/domain_zone
...
export interface DataOvhDomainZoneConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/domain_zone#id DataOvhDomainZone#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/domain_zone#name DataOvhDomainZone#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/domain_zone ovh_domain_zone}
*/
export class DataOvhDomainZone extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhDomainZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/domain_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/domain_zone ovh_domain_zone} Data Source
  *
  * @param scope The scope in which to define this construct
