// https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/dedicated_server_orderable_bandwidth_vrack
...
export interface DataOvhDedicatedServerOrderableBandwidthVrackConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/dedicated_server_orderable_bandwidth_vrack#id DataOvhDedicatedServerOrderableBandwidthVrack#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/dedicated_server_orderable_bandwidth_vrack#service_name DataOvhDedicatedServerOrderableBandwidthVrack#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/dedicated_server_orderable_bandwidth_vrack ovh_dedicated_server_orderable_bandwidth_vrack}
*/
export class DataOvhDedicatedServerOrderableBandwidthVrack extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhDedicatedServerOrderableBandwidthVrack that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/dedicated_server_orderable_bandwidth_vrack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/dedicated_server_orderable_bandwidth_vrack ovh_dedicated_server_orderable_bandwidth_vrack} Data Source
  *
  * @param scope The scope in which to define this construct
