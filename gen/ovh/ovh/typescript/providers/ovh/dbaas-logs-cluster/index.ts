// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/dbaas_logs_cluster
...
export interface DbaasLogsClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/dbaas_logs_cluster#archive_allowed_networks DbaasLogsCluster#archive_allowed_networks}
  */
  readonly archiveAllowedNetworks?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/dbaas_logs_cluster#cluster_id DbaasLogsCluster#cluster_id}
  */
  readonly clusterId?: string;
  /**
  * Allowed networks for DIRECT_INPUT flow type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/dbaas_logs_cluster#direct_input_allowed_networks DbaasLogsCluster#direct_input_allowed_networks}
  */
  readonly directInputAllowedNetworks?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/dbaas_logs_cluster#id DbaasLogsCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/dbaas_logs_cluster#query_allowed_networks DbaasLogsCluster#query_allowed_networks}
  */
  readonly queryAllowedNetworks?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/dbaas_logs_cluster#service_name DbaasLogsCluster#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/dbaas_logs_cluster ovh_dbaas_logs_cluster}
*/
export class DbaasLogsCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbaasLogsCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/dbaas_logs_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/dbaas_logs_cluster ovh_dbaas_logs_cluster} Resource
  *
  * @param scope The scope in which to define this construct
