// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/iploadbalancing_refresh
...
export interface IploadbalancingRefreshConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/iploadbalancing_refresh#id IploadbalancingRefresh#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/iploadbalancing_refresh#keepers IploadbalancingRefresh#keepers}
  */
  readonly keepers: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/iploadbalancing_refresh#service_name IploadbalancingRefresh#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/iploadbalancing_refresh ovh_iploadbalancing_refresh}
*/
export class IploadbalancingRefresh extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IploadbalancingRefresh that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/iploadbalancing_refresh#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/iploadbalancing_refresh ovh_iploadbalancing_refresh} Resource
  *
  * @param scope The scope in which to define this construct
