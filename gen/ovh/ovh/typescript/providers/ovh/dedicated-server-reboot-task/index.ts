// https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/resources/dedicated_server_reboot_task
...
export interface DedicatedServerRebootTaskConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/resources/dedicated_server_reboot_task#id DedicatedServerRebootTask#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/resources/dedicated_server_reboot_task#keepers DedicatedServerRebootTask#keepers}
  */
  readonly keepers: string[];
  /**
  * The internal name of your dedicated server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/resources/dedicated_server_reboot_task#service_name DedicatedServerRebootTask#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/resources/dedicated_server_reboot_task ovh_dedicated_server_reboot_task}
*/
export class DedicatedServerRebootTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DedicatedServerRebootTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/resources/dedicated_server_reboot_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/resources/dedicated_server_reboot_task ovh_dedicated_server_reboot_task} Resource
  *
  * @param scope The scope in which to define this construct
