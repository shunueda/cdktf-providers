// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/domain_zone_dnssec
...
export interface DomainZoneDnssecConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/domain_zone_dnssec#zone_name DomainZoneDnssec#zone_name}
  */
  readonly zoneName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/domain_zone_dnssec ovh_domain_zone_dnssec}
*/
export class DomainZoneDnssec extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DomainZoneDnssec that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/domain_zone_dnssec#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/domain_zone_dnssec ovh_domain_zone_dnssec} Resource
  *
  * @param scope The scope in which to define this construct
