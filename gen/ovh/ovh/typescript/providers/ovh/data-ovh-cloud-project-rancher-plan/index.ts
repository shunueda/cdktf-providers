// https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/cloud_project_rancher_plan
...
export interface DataOvhCloudProjectRancherPlanConfig extends cdktf.TerraformMetaArguments {
  ...
  * Project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/cloud_project_rancher_plan#project_id DataOvhCloudProjectRancherPlan#project_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/cloud_project_rancher_plan ovh_cloud_project_rancher_plan}
*/
export class DataOvhCloudProjectRancherPlan extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhCloudProjectRancherPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/cloud_project_rancher_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/cloud_project_rancher_plan ovh_cloud_project_rancher_plan} Data Source
  *
  * @param scope The scope in which to define this construct
