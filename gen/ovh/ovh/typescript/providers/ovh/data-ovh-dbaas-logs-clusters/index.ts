...
export class DataOvhDbaasLogsClusters extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "ovh_dbaas_logs_clusters";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "ovh_dbaas_logs_clusters", importId: importFromId, provider });
      }
  ...
  * @param options DataOvhDbaasLogsClustersConfig
  */
  public constructor(scope: Construct, id: string, config: DataOvhDbaasLogsClustersConfig) {
    super(scope, id, {
