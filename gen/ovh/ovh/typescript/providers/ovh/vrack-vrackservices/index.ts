// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_vrackservices
...
export interface VrackVrackservicesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_vrackservices#id VrackVrackservices#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_vrackservices#service_name VrackVrackservices#service_name}
  */
  readonly serviceName: string;
  /**
  * vrackServices service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_vrackservices#vrack_services VrackVrackservices#vrack_services}
  */
  readonly vrackServices: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_vrackservices ovh_vrack_vrackservices}
*/
export class VrackVrackservices extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VrackVrackservices that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_vrackservices#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_vrackservices ovh_vrack_vrackservices} Resource
  *
  * @param scope The scope in which to define this construct
