// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_iploadbalancing
...
export interface VrackIploadbalancingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_iploadbalancing#id VrackIploadbalancing#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_iploadbalancing#ip_loadbalancing VrackIploadbalancing#ip_loadbalancing}
  */
  readonly ipLoadbalancing: string;
  /**
  * The internal name of your vrack
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_iploadbalancing#service_name VrackIploadbalancing#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_iploadbalancing ovh_vrack_iploadbalancing}
*/
export class VrackIploadbalancing extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VrackIploadbalancing that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_iploadbalancing#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_iploadbalancing ovh_vrack_iploadbalancing} Resource
  *
  * @param scope The scope in which to define this construct
