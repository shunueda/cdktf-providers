// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_dedicated_cloud_datacenter
...
export interface VrackDedicatedCloudDatacenterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_dedicated_cloud_datacenter#datacenter VrackDedicatedCloudDatacenter#datacenter}
  */
  readonly datacenter: string;
  /**
  * The internal name of your vrack
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_dedicated_cloud_datacenter#service_name VrackDedicatedCloudDatacenter#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_dedicated_cloud_datacenter ovh_vrack_dedicated_cloud_datacenter}
*/
export class VrackDedicatedCloudDatacenter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VrackDedicatedCloudDatacenter that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_dedicated_cloud_datacenter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/vrack_dedicated_cloud_datacenter ovh_vrack_dedicated_cloud_datacenter} Resource
  *
  * @param scope The scope in which to define this construct
