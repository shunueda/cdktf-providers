// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/ovhcloud_connect_pop_datacenter_extra_config
...
export interface OvhcloudConnectPopDatacenterExtraConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  * BGP AS number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/ovhcloud_connect_pop_datacenter_extra_config#bgp_neighbor_area OvhcloudConnectPopDatacenterExtraConfig#bgp_neighbor_area}
  */
  readonly bgpNeighborArea?: number;
  /**
  * Router IP for BGP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/ovhcloud_connect_pop_datacenter_extra_config#bgp_neighbor_ip OvhcloudConnectPopDatacenterExtraConfig#bgp_neighbor_ip}
  */
  readonly bgpNeighborIp?: string;
  /**
  * ID of the datacenter configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/ovhcloud_connect_pop_datacenter_extra_config#config_datacenter_id OvhcloudConnectPopDatacenterExtraConfig#config_datacenter_id}
  */
  readonly configDatacenterId: number;
  /**
  * ID of the pop configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/ovhcloud_connect_pop_datacenter_extra_config#config_pop_id OvhcloudConnectPopDatacenterExtraConfig#config_pop_id}
  */
  readonly configPopId: number;
  /**
  * Static route next hop
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/ovhcloud_connect_pop_datacenter_extra_config#next_hop OvhcloudConnectPopDatacenterExtraConfig#next_hop}
  */
  readonly nextHop?: string;
  /**
  * Service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/ovhcloud_connect_pop_datacenter_extra_config#service_name OvhcloudConnectPopDatacenterExtraConfig#service_name}
  */
  readonly serviceName: string;
  /**
  * Static route ip
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/ovhcloud_connect_pop_datacenter_extra_config#subnet OvhcloudConnectPopDatacenterExtraConfig#subnet}
  */
  readonly subnet?: string;
  /**
  * Type of the configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/ovhcloud_connect_pop_datacenter_extra_config#type OvhcloudConnectPopDatacenterExtraConfig#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/ovhcloud_connect_pop_datacenter_extra_config ovh_ovhcloud_connect_pop_datacenter_extra_config}
*/
export class OvhcloudConnectPopDatacenterExtraConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OvhcloudConnectPopDatacenterExtraConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/ovhcloud_connect_pop_datacenter_extra_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/ovhcloud_connect_pop_datacenter_extra_config ovh_ovhcloud_connect_pop_datacenter_extra_config} Resource
  *
  * @param scope The scope in which to define this construct
