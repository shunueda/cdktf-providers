...
export class DataOvhMeApiOauth2Clients extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "ovh_me_api_oauth2_clients";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "ovh_me_api_oauth2_clients", importId: importFromId, provider });
      }
  ...
  * @param options DataOvhMeApiOauth2ClientsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataOvhMeApiOauth2ClientsConfig = {}) {
    super(scope, id, {
