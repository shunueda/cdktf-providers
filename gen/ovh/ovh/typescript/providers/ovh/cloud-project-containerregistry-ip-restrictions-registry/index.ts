// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/cloud_project_containerregistry_ip_restrictions_registry
...
export interface CloudProjectContainerregistryIpRestrictionsRegistryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/cloud_project_containerregistry_ip_restrictions_registry#id CloudProjectContainerregistryIpRestrictionsRegistry#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/cloud_project_containerregistry_ip_restrictions_registry#ip_restrictions CloudProjectContainerregistryIpRestrictionsRegistry#ip_restrictions}
  */
  readonly ipRestrictions: { [key: string]: string }[] | cdktf.IResolvable;
  /**
  * RegistryID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/cloud_project_containerregistry_ip_restrictions_registry#registry_id CloudProjectContainerregistryIpRestrictionsRegistry#registry_id}
  */
  readonly registryId: string;
  /**
  * Service name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/cloud_project_containerregistry_ip_restrictions_registry#service_name CloudProjectContainerregistryIpRestrictionsRegistry#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/cloud_project_containerregistry_ip_restrictions_registry ovh_cloud_project_containerregistry_ip_restrictions_registry}
*/
export class CloudProjectContainerregistryIpRestrictionsRegistry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudProjectContainerregistryIpRestrictionsRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/cloud_project_containerregistry_ip_restrictions_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/resources/cloud_project_containerregistry_ip_restrictions_registry ovh_cloud_project_containerregistry_ip_restrictions_registry} Resource
  *
  * @param scope The scope in which to define this construct
