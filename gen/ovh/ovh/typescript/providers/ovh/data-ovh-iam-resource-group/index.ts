// https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/iam_resource_group
...
export interface DataOvhIamResourceGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/iam_resource_group#id DataOvhIamResourceGroup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/iam_resource_group ovh_iam_resource_group}
*/
export class DataOvhIamResourceGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhIamResourceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/iam_resource_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.9.0/docs/data-sources/iam_resource_group ovh_iam_resource_group} Data Source
  *
  * @param scope The scope in which to define this construct
