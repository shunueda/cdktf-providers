...
export interface CloudProjectDatabaseM3DbUserConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function cloudProjectDatabaseM3DbUserTimeoutsToTerraform(struct?: CloudProjectDatabaseM3DbUserTimeouts | cdktf.IResolvable): any {
...
export function cloudProjectDatabaseM3DbUserTimeoutsToHclTerraform(struct?: CloudProjectDatabaseM3DbUserTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CloudProjectDatabaseM3DbUserTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CloudProjectDatabaseM3DbUserTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: CloudProjectDatabaseM3DbUserTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class CloudProjectDatabaseM3DbUser extends cdktf.TerraformResource {
  ...
  * @param options CloudProjectDatabaseM3DbUserConfig
  */
  public constructor(scope: Construct, id: string, config: CloudProjectDatabaseM3DbUserConfig) {
    super(scope, id, {
  ...
  private _timeouts = new CloudProjectDatabaseM3DbUserTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: CloudProjectDatabaseM3DbUserTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: cloudProjectDatabaseM3DbUserTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: cloudProjectDatabaseM3DbUserTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "CloudProjectDatabaseM3DbUserTimeouts",
      },
    };
