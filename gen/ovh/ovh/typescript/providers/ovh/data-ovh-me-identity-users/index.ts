// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_users
...
export interface DataOvhMeIdentityUsersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_users#id DataOvhMeIdentityUsers#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_users ovh_me_identity_users}
*/
export class DataOvhMeIdentityUsers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhMeIdentityUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_users ovh_me_identity_users} Data Source
  *
  * @param scope The scope in which to define this construct
