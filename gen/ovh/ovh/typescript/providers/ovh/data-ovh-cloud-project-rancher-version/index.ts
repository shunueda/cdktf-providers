// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/cloud_project_rancher_version
...
export interface DataOvhCloudProjectRancherVersionConfig extends cdktf.TerraformMetaArguments {
  ...
  * Project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/cloud_project_rancher_version#project_id DataOvhCloudProjectRancherVersion#project_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/cloud_project_rancher_version ovh_cloud_project_rancher_version}
*/
export class DataOvhCloudProjectRancherVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhCloudProjectRancherVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/cloud_project_rancher_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/cloud_project_rancher_version ovh_cloud_project_rancher_version} Data Source
  *
  * @param scope The scope in which to define this construct
