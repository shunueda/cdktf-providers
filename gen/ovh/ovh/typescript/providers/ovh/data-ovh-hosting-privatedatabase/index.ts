// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/hosting_privatedatabase
...
export interface DataOvhHostingPrivatedatabaseConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/hosting_privatedatabase#id DataOvhHostingPrivatedatabase#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/hosting_privatedatabase#service_name DataOvhHostingPrivatedatabase#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/hosting_privatedatabase ovh_hosting_privatedatabase}
*/
export class DataOvhHostingPrivatedatabase extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhHostingPrivatedatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/hosting_privatedatabase#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/hosting_privatedatabase ovh_hosting_privatedatabase} Data Source
  *
  * @param scope The scope in which to define this construct
