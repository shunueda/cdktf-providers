// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/cloud_project_database_kafka_topic
...
export interface DataOvhCloudProjectDatabaseKafkaTopicConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/cloud_project_database_kafka_topic#cluster_id DataOvhCloudProjectDatabaseKafkaTopic#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Topic ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/cloud_project_database_kafka_topic#id DataOvhCloudProjectDatabaseKafkaTopic#id}
  *
  ...
  */
  readonly id: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/cloud_project_database_kafka_topic#service_name DataOvhCloudProjectDatabaseKafkaTopic#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/cloud_project_database_kafka_topic ovh_cloud_project_database_kafka_topic}
*/
export class DataOvhCloudProjectDatabaseKafkaTopic extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhCloudProjectDatabaseKafkaTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/cloud_project_database_kafka_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/cloud_project_database_kafka_topic ovh_cloud_project_database_kafka_topic} Data Source
  *
  * @param scope The scope in which to define this construct
