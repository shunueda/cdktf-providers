...
export interface HostingPrivatedatabaseDatabaseConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class HostingPrivatedatabaseDatabase extends cdktf.TerraformResource {
  ...
  * @param options HostingPrivatedatabaseDatabaseConfig
  */
  public constructor(scope: Construct, id: string, config: HostingPrivatedatabaseDatabaseConfig) {
    super(scope, id, {
