...
export class CloudProjectContainerregistryIpRestrictionsManagement extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "ovh_cloud_project_containerregistry_ip_restrictions_management";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "ovh_cloud_project_containerregistry_ip_restrictions_management", importId: importFromId, provider });
      }
  ...
  * @param options CloudProjectContainerregistryIpRestrictionsManagementConfig
  */
  public constructor(scope: Construct, id: string, config: CloudProjectContainerregistryIpRestrictionsManagementConfig) {
    super(scope, id, {
