...
export interface CloudProjectDatabaseOpensearchPatternConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function cloudProjectDatabaseOpensearchPatternTimeoutsToTerraform(struct?: CloudProjectDatabaseOpensearchPatternTimeouts | cdktf.IResolvable): any {
...
export function cloudProjectDatabaseOpensearchPatternTimeoutsToHclTerraform(struct?: CloudProjectDatabaseOpensearchPatternTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CloudProjectDatabaseOpensearchPatternTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CloudProjectDatabaseOpensearchPatternTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: CloudProjectDatabaseOpensearchPatternTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class CloudProjectDatabaseOpensearchPattern extends cdktf.TerraformResource {
  ...
  * @param options CloudProjectDatabaseOpensearchPatternConfig
  */
  public constructor(scope: Construct, id: string, config: CloudProjectDatabaseOpensearchPatternConfig) {
    super(scope, id, {
    ...
    this._id = config.id;
    this._maxIndexCount = config.maxIndexCount;
  ...
  private _timeouts = new CloudProjectDatabaseOpensearchPatternTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: CloudProjectDatabaseOpensearchPatternTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      max_index_count: cdktf.numberToTerraform(this._maxIndexCount),
      pattern: cdktf.stringToTerraform(this._pattern),
      service_name: cdktf.stringToTerraform(this._serviceName),
      timeouts: cloudProjectDatabaseOpensearchPatternTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      max_index_count: {
        value: cdktf.numberToHclTerraform(this._maxIndexCount),
        isBlock: false,
        type: "simple",
      ...
      timeouts: {
        value: cloudProjectDatabaseOpensearchPatternTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "CloudProjectDatabaseOpensearchPatternTimeouts",
      },
    };
