...
export interface DataOvhDomainZoneDnssecConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DataOvhDomainZoneDnssec extends cdktf.TerraformDataSource {
  ...
  * @param options DataOvhDomainZoneDnssecConfig
  */
  public constructor(scope: Construct, id: string, config: DataOvhDomainZoneDnssecConfig) {
    super(scope, id, {
