// https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_user
...
export interface DataOvhMeIdentityUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_user#id DataOvhMeIdentityUser#id}
  *
  ...
  * User's login
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_user#user DataOvhMeIdentityUser#user}
  */
  readonly user: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_user ovh_me_identity_user}
*/
export class DataOvhMeIdentityUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOvhMeIdentityUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ovh/ovh/2.10.0/docs/data-sources/me_identity_user ovh_me_identity_user} Data Source
  *
  * @param scope The scope in which to define this construct
