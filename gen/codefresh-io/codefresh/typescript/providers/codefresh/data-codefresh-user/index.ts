// https://registry.terraform.io/providers/codefresh-io/codefresh/1.1.0/docs/data-sources/user
...
export interface DataCodefreshUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/codefresh-io/codefresh/1.1.0/docs/data-sources/user#email DataCodefreshUser#email}
  */
  readonly email: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/codefresh-io/codefresh/1.1.0/docs/data-sources/user#id DataCodefreshUser#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/codefresh-io/codefresh/1.1.0/docs/data-sources/user codefresh_user}
*/
export class DataCodefreshUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCodefreshUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/codefresh-io/codefresh/1.1.0/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/codefresh-io/codefresh/1.1.0/docs/data-sources/user codefresh_user} Data Source
  *
  * @param scope The scope in which to define this construct
