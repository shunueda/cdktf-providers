// https://registry.terraform.io/providers/codefresh-io/codefresh/1.2.0/docs/resources/service_account
...
export interface ServiceAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/codefresh-io/codefresh/1.2.0/docs/resources/service_account#assign_admin_role ServiceAccount#assign_admin_role}
  */
  readonly assignAdminRole?: boolean | cdktf.IResolvable;
  /**
  * A list of team IDs the service account is be assigned to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/codefresh-io/codefresh/1.2.0/docs/resources/service_account#assigned_teams ServiceAccount#assigned_teams}
  */
  readonly assignedTeams?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/codefresh-io/codefresh/1.2.0/docs/resources/service_account#id ServiceAccount#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/codefresh-io/codefresh/1.2.0/docs/resources/service_account#name ServiceAccount#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/codefresh-io/codefresh/1.2.0/docs/resources/service_account codefresh_service_account}
*/
export class ServiceAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/codefresh-io/codefresh/1.2.0/docs/resources/service_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/codefresh-io/codefresh/1.2.0/docs/resources/service_account codefresh_service_account} Resource
  *
  * @param scope The scope in which to define this construct
