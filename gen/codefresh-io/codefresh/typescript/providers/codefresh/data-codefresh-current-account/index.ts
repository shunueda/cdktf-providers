...
export function dataCodefreshCurrentAccountUsersToTerraform(struct?: DataCodefreshCurrentAccountUsers | cdktf.IResolvable): any {
...
export function dataCodefreshCurrentAccountUsersToHclTerraform(struct?: DataCodefreshCurrentAccountUsers | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCodefreshCurrentAccountUsersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCodefreshCurrentAccountUsers | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataCodefreshCurrentAccountUsers | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataCodefreshCurrentAccountUsersList extends cdktf.ComplexList {
  public internalValue? : DataCodefreshCurrentAccountUsers[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataCodefreshCurrentAccountUsersOutputReference {
    return new DataCodefreshCurrentAccountUsersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataCodefreshCurrentAccount extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "codefresh_current_account";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "codefresh_current_account", importId: importFromId, provider });
      }
  ...
  * @param options DataCodefreshCurrentAccountConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataCodefreshCurrentAccountConfig = {}) {
    super(scope, id, {
  ...
  private _users = new DataCodefreshCurrentAccountUsersList(this, "users", false);
  public get users() {
    return this._users;
  }
  public putUsers(value: DataCodefreshCurrentAccountUsers[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      users: cdktf.listMapper(dataCodefreshCurrentAccountUsersToTerraform, true)(this._users.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      users: {
        value: cdktf.listMapperHcl(dataCodefreshCurrentAccountUsersToHclTerraform, true)(this._users.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataCodefreshCurrentAccountUsersList",
      },
    };
