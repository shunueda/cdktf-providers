// https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port
...
export interface PortConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port#bonded Port#bonded}
  */
  readonly bonded: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port#id Port#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port#layer2 Port#layer2}
  */
  readonly layer2?: boolean | cdktf.IResolvable;
  /**
  * UUID of native VLAN of the port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port#native_vlan_id Port#native_vlan_id}
  */
  readonly nativeVlanId?: string;
  /**
  * UUID of the port to lookup
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port#port_id Port#port_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port#reset_on_delete Port#reset_on_delete}
  */
  readonly resetOnDelete?: boolean | cdktf.IResolvable;
  /**
  * UUIDs VLANs to attach. To avoid jitter, use the UUID and not the VXLAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port#vlan_ids Port#vlan_ids}
  */
  readonly vlanIds?: string[];
  /**
  * VLAN VXLAN ids to attach (example: [1000])
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port#vxlan_ids Port#vxlan_ids}
  */
  readonly vxlanIds?: number[];
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port#timeouts Port#timeouts}
  */
  readonly timeouts?: PortTimeouts;
}
export interface PortTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port#create Port#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port#delete Port#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port#update Port#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port metal_port}
*/
export class Port extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Port that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/metal/3.3.0/docs/resources/port metal_port} Resource
  *
  * @param scope The scope in which to define this construct
