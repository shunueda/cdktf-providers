// https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/network_device_type
...
export interface DataEquinixNetworkDeviceTypeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/network_device_type#category DataEquinixNetworkDeviceType#category}
  */
  readonly category?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/network_device_type#id DataEquinixNetworkDeviceType#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/network_device_type#metro_codes DataEquinixNetworkDeviceType#metro_codes}
  */
  readonly metroCodes?: string[];
  /**
  * Device type name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/network_device_type#name DataEquinixNetworkDeviceType#name}
  */
  readonly name?: string;
  /**
  * Device type vendor i.e. Cisco, Juniper Networks, VERSA Networks
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/network_device_type#vendor DataEquinixNetworkDeviceType#vendor}
  */
  readonly vendor?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/network_device_type equinix_network_device_type}
*/
export class DataEquinixNetworkDeviceType extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixNetworkDeviceType that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/network_device_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/network_device_type equinix_network_device_type} Data Source
  *
  * @param scope The scope in which to define this construct
