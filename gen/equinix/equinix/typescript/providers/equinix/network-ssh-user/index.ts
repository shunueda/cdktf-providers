// https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/network_ssh_user
...
export interface NetworkSshUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/network_ssh_user#device_ids NetworkSshUser#device_ids}
  */
  readonly deviceIds: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/network_ssh_user#id NetworkSshUser#id}
  *
  ...
  * SSH user password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/network_ssh_user#password NetworkSshUser#password}
  */
  readonly password: string;
  /**
  * SSH user login name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/network_ssh_user#username NetworkSshUser#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/network_ssh_user equinix_network_ssh_user}
*/
export class NetworkSshUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkSshUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/network_ssh_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/network_ssh_user equinix_network_ssh_user} Resource
  *
  * @param scope The scope in which to define this construct
