// https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/metal_vrf
...
export interface DataEquinixMetalVrfConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/metal_vrf#id DataEquinixMetalVrf#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/metal_vrf#vrf_id DataEquinixMetalVrf#vrf_id}
  */
  readonly vrfId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/metal_vrf equinix_metal_vrf}
*/
export class DataEquinixMetalVrf extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixMetalVrf that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/metal_vrf#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/metal_vrf equinix_metal_vrf} Data Source
  *
  * @param scope The scope in which to define this construct
