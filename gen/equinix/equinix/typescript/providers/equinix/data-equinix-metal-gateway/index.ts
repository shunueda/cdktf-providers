// https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/data-sources/metal_gateway
...
export interface DataEquinixMetalGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/data-sources/metal_gateway#gateway_id DataEquinixMetalGateway#gateway_id}
  */
  readonly gatewayId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/data-sources/metal_gateway equinix_metal_gateway}
*/
export class DataEquinixMetalGateway extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixMetalGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/data-sources/metal_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/data-sources/metal_gateway equinix_metal_gateway} Data Source
  *
  * @param scope The scope in which to define this construct
