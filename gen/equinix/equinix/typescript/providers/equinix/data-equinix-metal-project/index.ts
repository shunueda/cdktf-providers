// https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_project
...
export interface DataEquinixMetalProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_project#name DataEquinixMetalProject#name}
  */
  readonly name?: string;
  /**
  * ID of project to which the connection belongs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_project#project_id DataEquinixMetalProject#project_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_project equinix_metal_project}
*/
export class DataEquinixMetalProject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixMetalProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_project equinix_metal_project} Data Source
  *
  * @param scope The scope in which to define this construct
