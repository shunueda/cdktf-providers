// https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/fabric_stream_attachment
...
export interface DataEquinixFabricStreamAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/fabric_stream_attachment#asset DataEquinixFabricStreamAttachment#asset}
  */
  readonly asset: string;
  /**
  * Equinix defined UUID of the asset being attached to the stream
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/fabric_stream_attachment#asset_id DataEquinixFabricStreamAttachment#asset_id}
  */
  readonly assetId: string;
  /**
  * The uuid of the stream this data source should retrieve
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/fabric_stream_attachment#stream_id DataEquinixFabricStreamAttachment#stream_id}
  */
  readonly streamId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/fabric_stream_attachment equinix_fabric_stream_attachment}
*/
export class DataEquinixFabricStreamAttachment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixFabricStreamAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/fabric_stream_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/fabric_stream_attachment equinix_fabric_stream_attachment} Data Source
  *
  * @param scope The scope in which to define this construct
