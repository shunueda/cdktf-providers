// https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_precreated_ip_block
...
export interface DataEquinixMetalPrecreatedIpBlockConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_precreated_ip_block#address_family DataEquinixMetalPrecreatedIpBlock#address_family}
  */
  readonly addressFamily: number;
  /**
  * Facility of the searched block. (for non-global blocks).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_precreated_ip_block#facility DataEquinixMetalPrecreatedIpBlock#facility}
  */
  readonly facility?: string;
  /**
  * Whether to look for global block. Default is false for backward compatibility.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_precreated_ip_block#global DataEquinixMetalPrecreatedIpBlock#global}
  */
  readonly global?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_precreated_ip_block#id DataEquinixMetalPrecreatedIpBlock#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_precreated_ip_block#metro DataEquinixMetalPrecreatedIpBlock#metro}
  */
  readonly metro?: string;
  /**
  * ID of the project where the searched block should be.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_precreated_ip_block#project_id DataEquinixMetalPrecreatedIpBlock#project_id}
  */
  readonly projectId: string;
  /**
  * Whether to look for public or private block.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_precreated_ip_block#public DataEquinixMetalPrecreatedIpBlock#public}
  */
  readonly public: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_precreated_ip_block equinix_metal_precreated_ip_block}
*/
export class DataEquinixMetalPrecreatedIpBlock extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixMetalPrecreatedIpBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_precreated_ip_block#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_precreated_ip_block equinix_metal_precreated_ip_block} Data Source
  *
  * @param scope The scope in which to define this construct
