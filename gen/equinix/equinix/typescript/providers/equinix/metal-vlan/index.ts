// https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_vlan
...
export interface MetalVlanConfig extends cdktf.TerraformMetaArguments {
  ...
  * Description string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_vlan#description MetalVlan#description}
  */
  readonly description?: string;
  /**
  * Facility where to create the VLAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_vlan#facility MetalVlan#facility}
  */
  readonly facility?: string;
  /**
  * Metro in which to create the VLAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_vlan#metro MetalVlan#metro}
  */
  readonly metro?: string;
  /**
  * ID of parent project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_vlan#project_id MetalVlan#project_id}
  */
  readonly projectId: string;
  /**
  * VLAN ID, must be unique in metro
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_vlan#vxlan MetalVlan#vxlan}
  */
  readonly vxlan?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_vlan equinix_metal_vlan}
*/
export class MetalVlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MetalVlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_vlan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_vlan equinix_metal_vlan} Resource
  *
  * @param scope The scope in which to define this construct
