// https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port
...
export interface MetalPortConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port#bonded MetalPort#bonded}
  */
  readonly bonded: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port#id MetalPort#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port#layer2 MetalPort#layer2}
  */
  readonly layer2?: boolean | cdktf.IResolvable;
  /**
  * UUID of native VLAN of the port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port#native_vlan_id MetalPort#native_vlan_id}
  */
  readonly nativeVlanId?: string;
  /**
  * UUID of the port to lookup
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port#port_id MetalPort#port_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port#reset_on_delete MetalPort#reset_on_delete}
  */
  readonly resetOnDelete?: boolean | cdktf.IResolvable;
  /**
  * UUIDs VLANs to attach. To avoid jitter, use the UUID and not the VXLAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port#vlan_ids MetalPort#vlan_ids}
  */
  readonly vlanIds?: string[];
  /**
  * VLAN VXLAN ids to attach (example: [1000])
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port#vxlan_ids MetalPort#vxlan_ids}
  */
  readonly vxlanIds?: number[];
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port#timeouts MetalPort#timeouts}
  */
  readonly timeouts?: MetalPortTimeouts;
}
export interface MetalPortTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port#create MetalPort#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port#delete MetalPort#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port#update MetalPort#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port equinix_metal_port}
*/
export class MetalPort extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MetalPort that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/resources/metal_port equinix_metal_port} Resource
  *
  * @param scope The scope in which to define this construct
