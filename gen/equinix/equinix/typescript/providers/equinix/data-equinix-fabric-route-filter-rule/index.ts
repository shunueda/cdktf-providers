// https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/fabric_route_filter_rule
...
export interface DataEquinixFabricRouteFilterRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/fabric_route_filter_rule#id DataEquinixFabricRouteFilterRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/fabric_route_filter_rule#route_filter_id DataEquinixFabricRouteFilterRule#route_filter_id}
  */
  readonly routeFilterId: string;
  /**
  * Equinix Assigned ID for Route Filter Rule to retrieve data for
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/fabric_route_filter_rule#uuid DataEquinixFabricRouteFilterRule#uuid}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/fabric_route_filter_rule equinix_fabric_route_filter_rule}
*/
export class DataEquinixFabricRouteFilterRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixFabricRouteFilterRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/fabric_route_filter_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/fabric_route_filter_rule equinix_fabric_route_filter_rule} Data Source
  *
  * @param scope The scope in which to define this construct
