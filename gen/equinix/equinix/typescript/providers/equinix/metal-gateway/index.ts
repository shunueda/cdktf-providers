// https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_gateway
...
export interface MetalGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_gateway#ip_reservation_id MetalGateway#ip_reservation_id}
  */
  readonly ipReservationId?: string;
  /**
  * Size of the private IPv4 subnet to create for this gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_gateway#private_ipv4_subnet_size MetalGateway#private_ipv4_subnet_size}
  */
  readonly privateIpv4SubnetSize?: number;
  /**
  * UUID of the Project where the Gateway is scoped to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_gateway#project_id MetalGateway#project_id}
  */
  readonly projectId: string;
  /**
  * UUID of the VLAN to associate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_gateway#vlan_id MetalGateway#vlan_id}
  */
  readonly vlanId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_gateway#timeouts MetalGateway#timeouts}
  */
...
export interface MetalGatewayTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_gateway#delete MetalGateway#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_gateway equinix_metal_gateway}
*/
export class MetalGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MetalGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_gateway equinix_metal_gateway} Resource
  *
  * @param scope The scope in which to define this construct
