// https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/resources/network_ssh_key
...
export interface NetworkSshKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/resources/network_ssh_key#id NetworkSshKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/resources/network_ssh_key#name NetworkSshKey#name}
  */
  readonly name: string;
  /**
  * The unique identifier of Project Resource to which ssh key is scoped to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/resources/network_ssh_key#project_id NetworkSshKey#project_id}
  */
  readonly projectId?: string;
  /**
  * The SSH public key. If this is a file, it can be read using the file interpolation function
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/resources/network_ssh_key#public_key NetworkSshKey#public_key}
  */
  readonly publicKey: string;
  /**
  * The type of SSH key: RSA (default) or DSA
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/resources/network_ssh_key#type NetworkSshKey#type}
  */
  readonly type?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/resources/network_ssh_key#timeouts NetworkSshKey#timeouts}
  */
  readonly timeouts?: NetworkSshKeyTimeouts;
}
export interface NetworkSshKeyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/resources/network_ssh_key#create NetworkSshKey#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/resources/network_ssh_key equinix_network_ssh_key}
*/
export class NetworkSshKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkSshKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/resources/network_ssh_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/resources/network_ssh_key equinix_network_ssh_key} Resource
  *
  * @param scope The scope in which to define this construct
