// https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/resources/metal_organization_member
...
export interface MetalOrganizationMemberConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/resources/metal_organization_member#invitee MetalOrganizationMember#invitee}
  */
  readonly invitee: string;
  /**
  * A message to the invitee (only used during the invitation stage)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/resources/metal_organization_member#message MetalOrganizationMember#message}
  */
  readonly message?: string;
  /**
  * The organization to invite the user to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/resources/metal_organization_member#organization_id MetalOrganizationMember#organization_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/resources/metal_organization_member#projects_ids MetalOrganizationMember#projects_ids}
  */
  readonly projectsIds: string[];
  /**
  * Organization roles (owner, collaborator, limited_collaborator, billing)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/resources/metal_organization_member#roles MetalOrganizationMember#roles}
  */
  readonly roles: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/resources/metal_organization_member equinix_metal_organization_member}
*/
export class MetalOrganizationMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MetalOrganizationMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/resources/metal_organization_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/resources/metal_organization_member equinix_metal_organization_member} Resource
  *
  * @param scope The scope in which to define this construct
