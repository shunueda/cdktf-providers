// https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_bgp
...
export interface NetworkBgpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_bgp#authentication_key NetworkBgp#authentication_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_bgp#connection_id NetworkBgp#connection_id}
  */
  readonly connectionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_bgp#id NetworkBgp#id}
  *
  ...
  * Local ASN number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_bgp#local_asn NetworkBgp#local_asn}
  */
  readonly localAsn: number;
  /**
  * IP address in CIDR format of a local device
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_bgp#local_ip_address NetworkBgp#local_ip_address}
  */
  readonly localIpAddress: string;
  /**
  * Remote ASN number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_bgp#remote_asn NetworkBgp#remote_asn}
  */
  readonly remoteAsn: number;
  /**
  * IP address of remote peer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_bgp#remote_ip_address NetworkBgp#remote_ip_address}
  */
  readonly remoteIpAddress: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_bgp#timeouts NetworkBgp#timeouts}
  */
  readonly timeouts?: NetworkBgpTimeouts;
}
export interface NetworkBgpTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_bgp#create NetworkBgp#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_bgp equinix_network_bgp}
*/
export class NetworkBgp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkBgp that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_bgp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_bgp equinix_network_bgp} Resource
  *
  * @param scope The scope in which to define this construct
