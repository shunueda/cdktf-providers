// https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/metal_reserved_ip_block
...
export interface DataEquinixMetalReservedIpBlockConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/metal_reserved_ip_block#id DataEquinixMetalReservedIpBlock#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/metal_reserved_ip_block#ip_address DataEquinixMetalReservedIpBlock#ip_address}
  */
  readonly ipAddress?: string;
  /**
  * ID of the project where the searched block should be
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/metal_reserved_ip_block#project_id DataEquinixMetalReservedIpBlock#project_id}
  */
  readonly projectId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/metal_reserved_ip_block equinix_metal_reserved_ip_block}
*/
export class DataEquinixMetalReservedIpBlock extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixMetalReservedIpBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/metal_reserved_ip_block#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.11.1/docs/data-sources/metal_reserved_ip_block equinix_metal_reserved_ip_block} Data Source
  *
  * @param scope The scope in which to define this construct
