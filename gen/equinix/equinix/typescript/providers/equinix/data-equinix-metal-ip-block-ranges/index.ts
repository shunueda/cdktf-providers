// https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_ip_block_ranges
...
export interface DataEquinixMetalIpBlockRangesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_ip_block_ranges#facility DataEquinixMetalIpBlockRanges#facility}
  */
  readonly facility?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_ip_block_ranges#id DataEquinixMetalIpBlockRanges#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_ip_block_ranges#metro DataEquinixMetalIpBlockRanges#metro}
  */
  readonly metro?: string;
  /**
  * ID of the project from which to list the blocks
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_ip_block_ranges#project_id DataEquinixMetalIpBlockRanges#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_ip_block_ranges equinix_metal_ip_block_ranges}
*/
export class DataEquinixMetalIpBlockRanges extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixMetalIpBlockRanges that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_ip_block_ranges#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/metal_ip_block_ranges equinix_metal_ip_block_ranges} Data Source
  *
  * @param scope The scope in which to define this construct
