// https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/data-sources/metal_virtual_circuit
...
export interface DataEquinixMetalVirtualCircuitConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/data-sources/metal_virtual_circuit#customer_ipv6 DataEquinixMetalVirtualCircuit#customer_ipv6}
  */
  readonly customerIpv6?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/data-sources/metal_virtual_circuit#id DataEquinixMetalVirtualCircuit#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/data-sources/metal_virtual_circuit#metal_ipv6 DataEquinixMetalVirtualCircuit#metal_ipv6}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/data-sources/metal_virtual_circuit#subnet_ipv6 DataEquinixMetalVirtualCircuit#subnet_ipv6}
  */
  readonly subnetIpv6?: string;
  /**
  * ID of the virtual circuit to lookup
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/data-sources/metal_virtual_circuit#virtual_circuit_id DataEquinixMetalVirtualCircuit#virtual_circuit_id}
  */
  readonly virtualCircuitId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/data-sources/metal_virtual_circuit equinix_metal_virtual_circuit}
*/
export class DataEquinixMetalVirtualCircuit extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixMetalVirtualCircuit that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/data-sources/metal_virtual_circuit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/data-sources/metal_virtual_circuit equinix_metal_virtual_circuit} Data Source
  *
  * @param scope The scope in which to define this construct
