// https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/fabric_connection_route_aggregation
...
export interface DataEquinixFabricConnectionRouteAggregationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/fabric_connection_route_aggregation#connection_id DataEquinixFabricConnectionRouteAggregation#connection_id}
  */
  readonly connectionId: string;
  /**
  * The uuid of the route aggregation this data source should retrieve
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/fabric_connection_route_aggregation#route_aggregation_id DataEquinixFabricConnectionRouteAggregation#route_aggregation_id}
  */
  readonly routeAggregationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/fabric_connection_route_aggregation equinix_fabric_connection_route_aggregation}
*/
export class DataEquinixFabricConnectionRouteAggregation extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.8.0/docs/data-sources/fabric_connection_route_aggregation equinix_fabric_connection_route_aggregation} Data Source
  *
  * @param scope The scope in which to define this construct
