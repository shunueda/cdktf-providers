// https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_file
...
export interface NetworkFileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_file#byol NetworkFile#byol}
  */
  readonly byol: boolean | cdktf.IResolvable;
  /**
  * Uploaded file content, expected to be a UTF-8 encoded string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_file#content NetworkFile#content}
  */
  readonly content: string;
  /**
  * Device type code
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_file#device_type_code NetworkFile#device_type_code}
  */
  readonly deviceTypeCode: string;
  /**
  * File name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_file#file_name NetworkFile#file_name}
  */
  readonly fileName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_file#id NetworkFile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_file#metro_code NetworkFile#metro_code}
  */
  readonly metroCode: string;
  /**
  * File process type (LICENSE or CLOUD_INIT)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_file#process_type NetworkFile#process_type}
  */
  readonly processType: string;
  /**
  * Boolean value that determines device management mode: self-managed or equinix-managed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_file#self_managed NetworkFile#self_managed}
  */
  readonly selfManaged: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_file equinix_network_file}
*/
export class NetworkFile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.12.0/docs/resources/network_file equinix_network_file} Resource
  *
  * @param scope The scope in which to define this construct
