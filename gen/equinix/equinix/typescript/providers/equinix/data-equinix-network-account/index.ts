// https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/data-sources/network_account
...
export interface DataEquinixNetworkAccountConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/data-sources/network_account#id DataEquinixNetworkAccount#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/data-sources/network_account#metro_code DataEquinixNetworkAccount#metro_code}
  */
  readonly metroCode: string;
  /**
  * Account name for filtering
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/data-sources/network_account#name DataEquinixNetworkAccount#name}
  */
  readonly name?: string;
  /**
  * The unique identifier of Project Resource to which billing account is scoped to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/data-sources/network_account#project_id DataEquinixNetworkAccount#project_id}
  */
  readonly projectId?: string;
  /**
  * Account status for filtering. Possible values are Active, Processing, Submitted, Staged
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/data-sources/network_account#status DataEquinixNetworkAccount#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/data-sources/network_account equinix_network_account}
*/
export class DataEquinixNetworkAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixNetworkAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/data-sources/network_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.11.0/docs/data-sources/network_account equinix_network_account} Data Source
  *
  * @param scope The scope in which to define this construct
