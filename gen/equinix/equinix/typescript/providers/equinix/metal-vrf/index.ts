// https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_vrf
...
export interface MetalVrfConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_vrf#description MetalVrf#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_vrf#id MetalVrf#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_vrf#ip_ranges MetalVrf#ip_ranges}
  */
  readonly ipRanges?: string[];
  /**
  * The 4-byte ASN set on the VRF.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_vrf#local_asn MetalVrf#local_asn}
  */
  readonly localAsn?: number;
  /**
  * Metro ID or Code where the VRF will be deployed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_vrf#metro MetalVrf#metro}
  */
  readonly metro: string;
  /**
  * User-supplied name of the VRF, unique to the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_vrf#name MetalVrf#name}
  */
  readonly name: string;
  /**
  * Project ID where the VRF will be deployed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_vrf#project_id MetalVrf#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_vrf equinix_metal_vrf}
*/
export class MetalVrf extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MetalVrf that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_vrf#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/resources/metal_vrf equinix_metal_vrf} Resource
  *
  * @param scope The scope in which to define this construct
