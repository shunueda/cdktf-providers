// https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_vlan
...
export interface DataEquinixMetalVlanConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_vlan#facility DataEquinixMetalVlan#facility}
  */
  readonly facility?: string;
  /**
  * Metro where the VLAN is deployed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_vlan#metro DataEquinixMetalVlan#metro}
  */
  readonly metro?: string;
  /**
  * ID of parent project of the VLAN. Use together with vxlan and metro or facility
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_vlan#project_id DataEquinixMetalVlan#project_id}
  */
  readonly projectId?: string;
  /**
  * Metal UUID of the VLAN resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_vlan#vlan_id DataEquinixMetalVlan#vlan_id}
  */
  readonly vlanId?: string;
  /**
  * VXLAN numner of the VLAN. Unique in a project and facility or metro. Use with project_id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_vlan#vxlan DataEquinixMetalVlan#vxlan}
  */
  readonly vxlan?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_vlan equinix_metal_vlan}
*/
export class DataEquinixMetalVlan extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataEquinixMetalVlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_vlan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/equinix/equinix/4.10.0/docs/data-sources/metal_vlan equinix_metal_vlan} Data Source
  *
  * @param scope The scope in which to define this construct
