// https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database
...
export interface DatabaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database#allow_connections Database#allow_connections}
  */
  readonly allowConnections?: boolean | cdktf.IResolvable;
  /**
  * How many concurrent connections can be made to this database
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database#connection_limit Database#connection_limit}
  */
  readonly connectionLimit?: number;
  /**
  * Character set encoding to use in the new database
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database#encoding Database#encoding}
  */
  readonly encoding?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database#id Database#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database#is_template Database#is_template}
  */
  readonly isTemplate?: boolean | cdktf.IResolvable;
  /**
  * Collation order (LC_COLLATE) to use in the new database
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database#lc_collate Database#lc_collate}
  */
  readonly lcCollate?: string;
  /**
  * Character classification (LC_CTYPE) to use in the new database
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database#lc_ctype Database#lc_ctype}
  */
  readonly lcCtype?: string;
  /**
  * The PostgreSQL database name to connect to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database#name Database#name}
  */
  readonly name: string;
  /**
  * The ROLE which owns the database
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database#owner Database#owner}
  */
  readonly owner?: string;
  /**
  * Sets the database's search path
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database#search_path Database#search_path}
  */
  readonly searchPath?: string[];
  /**
  * The name of the tablespace that will be associated with the new database
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database#tablespace_name Database#tablespace_name}
  */
  readonly tablespaceName?: string;
  /**
  * The name of the template from which to create the new database
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database#template Database#template}
  */
  readonly template?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database postgresql_database}
*/
export class Database extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Database that should be imported. Refer to the {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/database postgresql_database} Resource
  *
  * @param scope The scope in which to define this construct
