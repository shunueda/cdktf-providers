// https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/server
...
export interface ServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/server#drop_cascade Server#drop_cascade}
  */
  readonly dropCascade?: boolean | cdktf.IResolvable;
  /**
  * The name of the foreign-data wrapper that manages the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/server#fdw_name Server#fdw_name}
  */
  readonly fdwName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/server#id Server#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/server#options Server#options}
  */
  readonly options?: { [key: string]: string };
  /**
  * The name of the foreign server to be created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/server#server_name Server#server_name}
  */
  readonly serverName: string;
  /**
  * The user name of the new owner of the foreign server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/server#server_owner Server#server_owner}
  */
  readonly serverOwner?: string;
  /**
  * Optional server type, potentially useful to foreign-data wrappers
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/server#server_type Server#server_type}
  */
  readonly serverType?: string;
  /**
  * Optional server version, potentially useful to foreign-data wrappers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/server#server_version Server#server_version}
  */
  readonly serverVersion?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/server postgresql_server}
*/
export class Server extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Server that should be imported. Refer to the {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nitrikx/postgresql/1.21.2/docs/resources/server postgresql_server} Resource
  *
  * @param scope The scope in which to define this construct
