// https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role
...
export interface DataAthenzRoleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#audit_enabled DataAthenzRole#audit_enabled}
  */
  readonly auditEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#delete_protection DataAthenzRole#delete_protection}
  */
  readonly deleteProtection?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#description DataAthenzRole#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#domain DataAthenzRole#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#id DataAthenzRole#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#last_reviewed_date DataAthenzRole#last_reviewed_date}
  */
  readonly lastReviewedDate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#name DataAthenzRole#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#notify_details DataAthenzRole#notify_details}
  */
  readonly notifyDetails?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#notify_roles DataAthenzRole#notify_roles}
  */
  readonly notifyRoles?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#principal_domain_filter DataAthenzRole#principal_domain_filter}
  */
  readonly principalDomainFilter?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#review_enabled DataAthenzRole#review_enabled}
  */
  readonly reviewEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#self_renew DataAthenzRole#self_renew}
  */
  readonly selfRenew?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#self_renew_mins DataAthenzRole#self_renew_mins}
  */
  readonly selfRenewMins?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#self_serve DataAthenzRole#self_serve}
  */
  readonly selfServe?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#sign_algorithm DataAthenzRole#sign_algorithm}
  */
  readonly signAlgorithm?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#tags DataAthenzRole#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The domain, which this role is trusted to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#trust DataAthenzRole#trust}
  */
  readonly trust?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#user_authority_expiration DataAthenzRole#user_authority_expiration}
  */
  readonly userAuthorityExpiration?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#user_authority_filter DataAthenzRole#user_authority_filter}
  */
  readonly userAuthorityFilter?: string;
  /**
  * member block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#member DataAthenzRole#member}
  */
  readonly member?: DataAthenzRoleMember[] | cdktf.IResolvable;
  /**
  * settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#settings DataAthenzRole#settings}
  */
  readonly settings?: DataAthenzRoleSettings;
}
export interface DataAthenzRoleMember {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#expiration DataAthenzRole#expiration}
  */
  ...
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#review DataAthenzRole#review}
  */
  readonly review?: string;
}

export function dataAthenzRoleMemberToTerraform(struct?: DataAthenzRoleMember | cdktf.IResolvable): any {
...
export function dataAthenzRoleMemberToHclTerraform(struct?: DataAthenzRoleMember | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAthenzRoleMemberOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAthenzRoleMember | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAthenzRoleMember | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAthenzRoleMemberList extends cdktf.ComplexList {
  public internalValue? : DataAthenzRoleMember[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataAthenzRoleMemberOutputReference {
    return new DataAthenzRoleMemberOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataAthenzRoleSettings {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#cert_expiry_mins DataAthenzRole#cert_expiry_mins}
  */
  readonly certExpiryMins?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#group_expiry_days DataAthenzRole#group_expiry_days}
  */
  readonly groupExpiryDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#group_review_days DataAthenzRole#group_review_days}
  */
  readonly groupReviewDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#max_members DataAthenzRole#max_members}
  */
  readonly maxMembers?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#service_expiry_days DataAthenzRole#service_expiry_days}
  */
  readonly serviceExpiryDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#service_review_days DataAthenzRole#service_review_days}
  */
  readonly serviceReviewDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#token_expiry_mins DataAthenzRole#token_expiry_mins}
  */
  readonly tokenExpiryMins?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#user_expiry_days DataAthenzRole#user_expiry_days}
  */
  readonly userExpiryDays?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#user_review_days DataAthenzRole#user_review_days}
  */
  readonly userReviewDays?: number;
}

export function dataAthenzRoleSettingsToTerraform(struct?: DataAthenzRoleSettingsOutputReference | DataAthenzRoleSettings): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataAthenzRoleSettingsToHclTerraform(struct?: DataAthenzRoleSettingsOutputReference | DataAthenzRoleSettings): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAthenzRoleSettingsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAthenzRoleSettings | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataAthenzRoleSettings | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role athenz_role}
*/
export class DataAthenzRole extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataAthenzRole resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAthenzRole to import
  * @param importFromId The id of the existing DataAthenzRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAthenzRole to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/athenz/athenz/1.0.49/docs/data-sources/role athenz_role} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAthenzRoleConfig
  */
  public constructor(scope: Construct, id: string, config: DataAthenzRoleConfig) {
    super(scope, id, {
  ...
  private _member = new DataAthenzRoleMemberList(this, "member", true);
  public get member() {
    return this._member;
  }
  public putMember(value: DataAthenzRoleMember[] | cdktf.IResolvable) {
  ...
  private _settings = new DataAthenzRoleSettingsOutputReference(this, "settings");
  public get settings() {
    return this._settings;
  }
  public putSettings(value: DataAthenzRoleSettings) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      member: cdktf.listMapper(dataAthenzRoleMemberToTerraform, true)(this._member.internalValue),
      settings: dataAthenzRoleSettingsToTerraform(this._settings.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      member: {
        value: cdktf.listMapperHcl(dataAthenzRoleMemberToHclTerraform, true)(this._member.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataAthenzRoleMemberList",
      },
      settings: {
        value: dataAthenzRoleSettingsToHclTerraform(this._settings.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataAthenzRoleSettingsList",
      },
    };
