// https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_page
...
export interface PortPageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_page#after PortPage#after}
  */
  readonly after?: string;
  /**
  * The blueprint for which the page is created, relevant only for pages of type "blueprint-entities"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_page#blueprint PortPage#blueprint}
  */
  readonly blueprint?: string;
  /**
  * The page description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_page#description PortPage#description}
  */
  readonly description?: string;
  /**
  * The icon of the page
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_page#icon PortPage#icon}
  */
  readonly icon?: string;
  /**
  * The Identifier of the page
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_page#identifier PortPage#identifier}
  */
  readonly identifier: string;
  /**
  * Whether the page is locked, if true, viewers will not be able to edit the page widgets and filters
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_page#locked PortPage#locked}
  */
  readonly locked?: boolean | cdktf.IResolvable;
  /**
  * The identifier of the folder in which the page is in, default is the root of the sidebar
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_page#parent PortPage#parent}
  */
  readonly parent?: string;
  /**
  * The title of the page
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_page#title PortPage#title}
  */
  readonly title?: string;
  /**
  * The type of the page, can be one of "blueprint-entities", "dashboard" or "home"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_page#type PortPage#type}
  */
  readonly type: string;
  /**
  * The widgets of the page
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_page#widgets PortPage#widgets}
  */
  readonly widgets?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_page port_page}
*/
export class PortPage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PortPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_page#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_page port_page} Resource
  *
  * @param scope The scope in which to define this construct
