// https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard
...
export interface PortScorecardConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard#blueprint PortScorecard#blueprint}
  */
  readonly blueprint: string;
  /**
  * The filter to apply on the entities before calculating the scorecard
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard#filter PortScorecard#filter}
  */
  readonly filter?: PortScorecardFilter;
  /**
  * The identifier of the scorecard
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard#identifier PortScorecard#identifier}
  */
  readonly identifier: string;
  /**
  * The levels of the scorecard. This overrides the default levels (Basic, Bronze, Silver, Gold) if provided
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard#levels PortScorecard#levels}
  */
  readonly levels?: PortScorecardLevels[] | cdktf.IResolvable;
  /**
  * The rules of the scorecard
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard#rules PortScorecard#rules}
  */
  readonly rules: PortScorecardRules[] | cdktf.IResolvable;
  /**
  * The title of the scorecard
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard#title PortScorecard#title}
  */
...
export interface PortScorecardFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard#combinator PortScorecard#combinator}
  */
  readonly combinator: string;
  /**
  * The conditions of the filter. Each condition object should be encoded to a string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard#conditions PortScorecard#conditions}
  */
...
export interface PortScorecardLevels {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard#color PortScorecard#color}
  */
...
export interface PortScorecardRules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard#description PortScorecard#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard#level PortScorecard#level}
  */
  readonly level: string;
  /**
  * The query of the rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard#query PortScorecard#query}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard port_scorecard}
*/
export class PortScorecard extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PortScorecard that should be imported. Refer to the {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/port-labs/port-labs/2.16.0/docs/resources/port_scorecard port_scorecard} Resource
  *
  * @param scope The scope in which to define this construct
