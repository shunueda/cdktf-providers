// https://registry.terraform.io/providers/port-labs/port-labs/2.17.4/docs/resources/port_organization_secret
...
export interface PortOrganizationSecretConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.4/docs/resources/port_organization_secret#description PortOrganizationSecret#description}
  */
  readonly description?: string;
  /**
  * The name of the organization secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.4/docs/resources/port_organization_secret#secret_name PortOrganizationSecret#secret_name}
  */
  readonly secretName: string;
  /**
  * The value of the organization secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.4/docs/resources/port_organization_secret#secret_value PortOrganizationSecret#secret_value}
  */
  readonly secretValue: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.4/docs/resources/port_organization_secret port_organization_secret}
*/
export class PortOrganizationSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PortOrganizationSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.4/docs/resources/port_organization_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.4/docs/resources/port_organization_secret port_organization_secret} Resource
  *
  * @param scope The scope in which to define this construct
