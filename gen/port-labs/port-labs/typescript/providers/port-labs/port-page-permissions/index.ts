// https://registry.terraform.io/providers/port-labs/port-labs/2.15.0/docs/resources/port_page_permissions
...
export interface PortPagePermissionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.15.0/docs/resources/port_page_permissions#page_identifier PortPagePermissions#page_identifier}
  */
  readonly pageIdentifier: string;
  /**
  * The permission to read the page
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.15.0/docs/resources/port_page_permissions#read PortPagePermissions#read}
  */
...
export interface PortPagePermissionsRead {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.15.0/docs/resources/port_page_permissions#roles PortPagePermissions#roles}
  */
  readonly roles?: string[];
  /**
  * The teams with read permission
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.15.0/docs/resources/port_page_permissions#teams PortPagePermissions#teams}
  */
  readonly teams?: string[];
  /**
  * The users with read permission
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.15.0/docs/resources/port_page_permissions#users PortPagePermissions#users}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/port-labs/port-labs/2.15.0/docs/resources/port_page_permissions port_page_permissions}
*/
export class PortPagePermissions extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PortPagePermissions that should be imported. Refer to the {@link https://registry.terraform.io/providers/port-labs/port-labs/2.15.0/docs/resources/port_page_permissions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/port-labs/port-labs/2.15.0/docs/resources/port_page_permissions port_page_permissions} Resource
  *
  * @param scope The scope in which to define this construct
