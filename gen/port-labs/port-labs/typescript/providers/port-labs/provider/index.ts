// https://registry.terraform.io/providers/port-labs/port-labs/2.14.4/docs
...
export interface PortLabsProviderConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.14.4/docs#base_url PortLabsProvider#base_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.14.4/docs#blueprint_property_type_change_protection PortLabsProvider#blueprint_property_type_change_protection}
  */
  readonly blueprintPropertyTypeChangeProtection?: boolean | cdktf.IResolvable;
  /**
  * Client ID for Port-labs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.14.4/docs#client_id PortLabsProvider#client_id}
  */
  readonly clientId?: string;
  /**
  * When set to `false` disables the default HTML escaping of json.Marshal when reading data from Port. Defaults to `true`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.14.4/docs#json_escape_html PortLabsProvider#json_escape_html}
  */
  readonly jsonEscapeHtml?: boolean | cdktf.IResolvable;
  /**
  * Client Secret for Port-labs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.14.4/docs#secret PortLabsProvider#secret}
  */
  readonly secret?: string;
  /**
  * Token for Port-labs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.14.4/docs#token PortLabsProvider#token}
  */
  readonly token?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.14.4/docs#alias PortLabsProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/port-labs/port-labs/2.14.4/docs port-labs}
*/
export class PortLabsProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing PortLabsProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/port-labs/port-labs/2.14.4/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/port-labs/port-labs/2.14.4/docs port-labs} Resource
  *
  * @param scope The scope in which to define this construct
