// https://registry.terraform.io/providers/port-labs/port-labs/2.17.5/docs/resources/port_integration
...
export interface PortIntegrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.5/docs/resources/port_integration#config PortIntegration#config}
  */
  readonly config?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.5/docs/resources/port_integration#installation_app_type PortIntegration#installation_app_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.5/docs/resources/port_integration#installation_id PortIntegration#installation_id}
  */
  readonly installationId: string;
  /**
  * The changelog destination of the blueprint (just an empty `{}`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.5/docs/resources/port_integration#kafka_changelog_destination PortIntegration#kafka_changelog_destination}
  */
  readonly kafkaChangelogDestination?: PortIntegrationKafkaChangelogDestination;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.5/docs/resources/port_integration#title PortIntegration#title}
  */
  readonly title?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.5/docs/resources/port_integration#version PortIntegration#version}
  */
  readonly version?: string;
  /**
  * The webhook changelog destination of the integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.5/docs/resources/port_integration#webhook_changelog_destination PortIntegration#webhook_changelog_destination}
  */
...
export interface PortIntegrationWebhookChangelogDestination {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.5/docs/resources/port_integration#agent PortIntegration#agent}
  */
  readonly agent?: boolean | cdktf.IResolvable;
  /**
  * The url of the webhook changelog destination
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.5/docs/resources/port_integration#url PortIntegration#url}
  */
  readonly url: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.5/docs/resources/port_integration port_integration}
*/
export class PortIntegration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PortIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.5/docs/resources/port_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/port-labs/port-labs/2.17.5/docs/resources/port_integration port_integration} Resource
  *
  * @param scope The scope in which to define this construct
