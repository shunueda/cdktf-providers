...
export class PropertyMappingProviderGoogleWorkspace extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "authentik_property_mapping_provider_google_workspace";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "authentik_property_mapping_provider_google_workspace", importId: importFromId, provider });
      }
  ...
  * @param options PropertyMappingProviderGoogleWorkspaceConfig
  */
  public constructor(scope: Construct, id: string, config: PropertyMappingProviderGoogleWorkspaceConfig) {
    super(scope, id, {
