// https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_dummy
...
export interface PolicyDummyConfig extends cdktf.TerraformMetaArguments {
  ...
  * Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_dummy#execution_logging PolicyDummy#execution_logging}
  */
  readonly executionLogging?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_dummy#id PolicyDummy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_dummy#name PolicyDummy#name}
  */
  readonly name: string;
  /**
  * Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_dummy#result PolicyDummy#result}
  */
  readonly result?: boolean | cdktf.IResolvable;
  /**
  * Defaults to `30`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_dummy#wait_max PolicyDummy#wait_max}
  */
  readonly waitMax?: number;
  /**
  * Defaults to `5`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_dummy#wait_min PolicyDummy#wait_min}
  */
  readonly waitMin?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_dummy authentik_policy_dummy}
*/
export class PolicyDummy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyDummy that should be imported. Refer to the {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_dummy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_dummy authentik_policy_dummy} Resource
  *
  * @param scope The scope in which to define this construct
