...
export class PropertyMappingLdap extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "authentik_property_mapping_ldap";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "authentik_property_mapping_ldap", importId: importFromId, provider });
      }
  ...
  * @param options PropertyMappingLdapConfig
  */
  public constructor(scope: Construct, id: string, config: PropertyMappingLdapConfig) {
    super(scope, id, {
