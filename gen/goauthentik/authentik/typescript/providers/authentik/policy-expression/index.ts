// https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_expression
...
export interface PolicyExpressionConfig extends cdktf.TerraformMetaArguments {
  ...
  * Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_expression#execution_logging PolicyExpression#execution_logging}
  */
  readonly executionLogging?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_expression#expression PolicyExpression#expression}
  */
  readonly expression: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_expression#id PolicyExpression#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_expression#name PolicyExpression#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_expression authentik_policy_expression}
*/
export class PolicyExpression extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolicyExpression that should be imported. Refer to the {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_expression#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/policy_expression authentik_policy_expression} Resource
  *
  * @param scope The scope in which to define this construct
