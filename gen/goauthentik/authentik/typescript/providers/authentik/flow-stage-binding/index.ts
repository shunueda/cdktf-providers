// https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/flow_stage_binding
...
export interface FlowStageBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/flow_stage_binding#evaluate_on_plan FlowStageBinding#evaluate_on_plan}
  */
  readonly evaluateOnPlan?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/flow_stage_binding#id FlowStageBinding#id}
  *
  ...
  *  Defaults to `retry`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/flow_stage_binding#invalid_response_action FlowStageBinding#invalid_response_action}
  */
  readonly invalidResponseAction?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/flow_stage_binding#order FlowStageBinding#order}
  */
  ...
  *  Defaults to `any`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/flow_stage_binding#policy_engine_mode FlowStageBinding#policy_engine_mode}
  */
  readonly policyEngineMode?: string;
  /**
  * Evaluate policies when the Stage is present to the user. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/flow_stage_binding#re_evaluate_policies FlowStageBinding#re_evaluate_policies}
  */
  readonly reEvaluatePolicies?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/flow_stage_binding#stage FlowStageBinding#stage}
  */
  readonly stage: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/flow_stage_binding#target FlowStageBinding#target}
  */
  readonly target: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/flow_stage_binding authentik_flow_stage_binding}
*/
export class FlowStageBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FlowStageBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/flow_stage_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/flow_stage_binding authentik_flow_stage_binding} Resource
  *
  * @param scope The scope in which to define this construct
