...
export class DataAuthentikPropertyMappingProviderRadius extends cdktf.TerraformDataSource {
  ...
  * @param options DataAuthentikPropertyMappingProviderRadiusConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAuthentikPropertyMappingProviderRadiusConfig = {}) {
    super(scope, id, {
