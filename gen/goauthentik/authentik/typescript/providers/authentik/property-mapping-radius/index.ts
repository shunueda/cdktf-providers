...
export class PropertyMappingRadius extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "authentik_property_mapping_radius";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "authentik_property_mapping_radius", importId: importFromId, provider });
      }
  ...
  * @param options PropertyMappingRadiusConfig
  */
  public constructor(scope: Construct, id: string, config: PropertyMappingRadiusConfig) {
    super(scope, id, {
