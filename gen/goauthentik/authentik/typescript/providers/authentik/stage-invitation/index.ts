// https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/stage_invitation
...
export interface StageInvitationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/stage_invitation#continue_flow_without_invitation StageInvitation#continue_flow_without_invitation}
  */
  readonly continueFlowWithoutInvitation?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/stage_invitation#id StageInvitation#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/stage_invitation#name StageInvitation#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/stage_invitation authentik_stage_invitation}
*/
export class StageInvitation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StageInvitation that should be imported. Refer to the {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/stage_invitation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.0/docs/resources/stage_invitation authentik_stage_invitation} Resource
  *
  * @param scope The scope in which to define this construct
