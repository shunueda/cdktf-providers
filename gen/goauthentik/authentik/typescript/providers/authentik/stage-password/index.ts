// https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/stage_password
...
export interface StagePasswordConfig extends cdktf.TerraformMetaArguments {
  ...
  * Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/stage_password#allow_show_password StagePassword#allow_show_password}
  */
  readonly allowShowPassword?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/stage_password#backends StagePassword#backends}
  */
  readonly backends: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/stage_password#configure_flow StagePassword#configure_flow}
  */
  readonly configureFlow?: string;
  /**
  * Defaults to `5`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/stage_password#failed_attempts_before_cancel StagePassword#failed_attempts_before_cancel}
  */
  readonly failedAttemptsBeforeCancel?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/stage_password#id StagePassword#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/stage_password#name StagePassword#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/stage_password authentik_stage_password}
*/
export class StagePassword extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StagePassword that should be imported. Refer to the {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/stage_password#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/goauthentik/authentik/2025.10.1/docs/resources/stage_password authentik_stage_password} Resource
  *
  * @param scope The scope in which to define this construct
