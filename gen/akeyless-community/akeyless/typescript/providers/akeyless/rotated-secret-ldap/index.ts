...
export interface RotatedSecretLdapConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class RotatedSecretLdap extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "akeyless_rotated_secret_ldap";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "akeyless_rotated_secret_ldap", importId: importFromId, provider });
      }
  ...
  * @param options RotatedSecretLdapConfig
  */
  public constructor(scope: Construct, id: string, config: RotatedSecretLdapConfig) {
    super(scope, id, {
