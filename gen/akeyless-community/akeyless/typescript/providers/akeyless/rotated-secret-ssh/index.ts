...
export interface RotatedSecretSshConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class RotatedSecretSsh extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "akeyless_rotated_secret_ssh";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "akeyless_rotated_secret_ssh", importId: importFromId, provider });
      }
  ...
  * @param options RotatedSecretSshConfig
  */
  public constructor(scope: Construct, id: string, config: RotatedSecretSshConfig) {
    super(scope, id, {
