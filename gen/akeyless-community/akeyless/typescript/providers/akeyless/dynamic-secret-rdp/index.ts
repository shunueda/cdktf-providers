...
export interface DynamicSecretRdpConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DynamicSecretRdp extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "akeyless_dynamic_secret_rdp";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "akeyless_dynamic_secret_rdp", importId: importFromId, provider });
      }
  ...
  * @param options DynamicSecretRdpConfig
  */
  public constructor(scope: Construct, id: string, config: DynamicSecretRdpConfig) {
    super(scope, id, {
