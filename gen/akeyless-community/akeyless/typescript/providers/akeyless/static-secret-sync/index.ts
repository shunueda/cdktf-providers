...
export class StaticSecretSync extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "akeyless_static_secret_sync";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "akeyless_static_secret_sync", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: StaticSecretSyncConfig) {
    super(scope, id, {
