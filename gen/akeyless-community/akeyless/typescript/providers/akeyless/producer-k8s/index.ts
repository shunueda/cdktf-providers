...
export interface ProducerK8SConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class ProducerK8S extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "akeyless_producer_k8s";
  ...
  */
  public constructor(scope: Construct, id: string, config: ProducerK8SConfig) {
    super(scope, id, {
