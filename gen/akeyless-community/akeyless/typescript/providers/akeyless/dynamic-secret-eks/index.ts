...
export class DynamicSecretEks extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "akeyless_dynamic_secret_eks";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "akeyless_dynamic_secret_eks", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: DynamicSecretEksConfig) {
    super(scope, id, {
