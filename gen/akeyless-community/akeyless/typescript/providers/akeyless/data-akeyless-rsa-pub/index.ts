// https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.2/docs/data-sources/rsa_pub
...
export interface DataAkeylessRsaPubConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.2/docs/data-sources/rsa_pub#id DataAkeylessRsaPub#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.2/docs/data-sources/rsa_pub#name DataAkeylessRsaPub#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.2/docs/data-sources/rsa_pub akeyless_rsa_pub}
*/
export class DataAkeylessRsaPub extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAkeylessRsaPub that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.2/docs/data-sources/rsa_pub#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.2/docs/data-sources/rsa_pub akeyless_rsa_pub} Data Source
  *
  * @param scope The scope in which to define this construct
