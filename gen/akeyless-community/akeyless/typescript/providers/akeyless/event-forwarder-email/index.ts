// https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email
...
export interface EventForwarderEmailConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#auth_methods_event_source_locations EventForwarderEmail#auth_methods_event_source_locations}
  */
  readonly authMethodsEventSourceLocations?: string[];
  /**
  * Description of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#description EventForwarderEmail#description}
  */
  readonly description?: string;
  /**
  * A comma seperated list of email addresses to send event to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#email_to EventForwarderEmail#email_to}
  */
  readonly emailTo?: string;
  /**
  * A comma-separated list of types of events to notify about
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#event_types EventForwarderEmail#event_types}
  */
  readonly eventTypes?: string[];
  /**
  * Rate of periodic runner repetition in hours
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#every EventForwarderEmail#every}
  */
  readonly every?: string;
  /**
  * Gateways event sources to forward events about,for example the relevant Gateways cluster urls,: http://localhost:8000.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#gateways_event_source_locations EventForwarderEmail#gateways_event_source_locations}
  */
  readonly gatewaysEventSourceLocations?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#id EventForwarderEmail#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#include_error EventForwarderEmail#include_error}
  */
  readonly includeError?: string;
  /**
  * Items event sources to forward events about, for example: /abc/*
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#items_event_source_locations EventForwarderEmail#items_event_source_locations}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#key EventForwarderEmail#key}
  */
  readonly key?: string;
  /**
  * Event Forwarder name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#name EventForwarderEmail#name}
  */
  readonly name: string;
  /**
  * Override Akeyless default URL with your Gateway url (port 18888)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#override_url EventForwarderEmail#override_url}
  */
  readonly overrideUrl?: string;
  /**
  * Event Forwarder runner type [immediate/periodic]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#runner_type EventForwarderEmail#runner_type}
  */
  readonly runnerType?: string;
  /**
  * Targets event sources to forward events about, for example: /abc/*
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#targets_event_source_locations EventForwarderEmail#targets_event_source_locations}
  */
  readonly targetsEventSourceLocations?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email akeyless_event_forwarder_email}
*/
export class EventForwarderEmail extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventForwarderEmail that should be imported. Refer to the {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/akeyless-community/akeyless/1.11.1/docs/resources/event_forwarder_email akeyless_event_forwarder_email} Resource
  *
  * @param scope The scope in which to define this construct
