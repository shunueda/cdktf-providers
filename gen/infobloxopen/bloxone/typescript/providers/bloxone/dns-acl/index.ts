...
export interface DnsAclConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DnsAclListTsigKey {
  /**
...
export function dnsAclListTsigKeyToTerraform(struct?: DnsAclListTsigKey | cdktf.IResolvable): any {
...
export function dnsAclListTsigKeyToHclTerraform(struct?: DnsAclListTsigKey | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DnsAclListTsigKeyOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DnsAclListTsigKey | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DnsAclListTsigKey | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export interface DnsAclListStruct {
  /**
...
export function dnsAclListStructToTerraform(struct?: DnsAclListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    tsig_key: dnsAclListTsigKeyToTerraform(struct!.tsigKey),
  }
}


export function dnsAclListStructToHclTerraform(struct?: DnsAclListStruct | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    tsig_key: {
      value: dnsAclListTsigKeyToHclTerraform(struct!.tsigKey),
      isBlock: true,
      type: "struct",
      storageClassType: "DnsAclListTsigKey",
    },
  };
...
export class DnsAclListStructOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): DnsAclListStruct | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DnsAclListStruct | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _tsigKey = new DnsAclListTsigKeyOutputReference(this, "tsig_key");
  public get tsigKey() {
    return this._tsigKey;
  }
  public putTsigKey(value: DnsAclListTsigKey) {
...
export class DnsAclListStructList extends cdktf.ComplexList {
  public internalValue? : DnsAclListStruct[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DnsAclListStructOutputReference {
    return new DnsAclListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DnsAcl extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "bloxone_dns_acl";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "bloxone_dns_acl", importId: importFromId, provider });
      }
  ...
  * @param options DnsAclConfig
  */
  public constructor(scope: Construct, id: string, config: DnsAclConfig) {
    super(scope, id, {
  ...
  private _list = new DnsAclListStructList(this, "list", false);
  public get list() {
    return this._list;
  }
  public putList(value: DnsAclListStruct[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      list: cdktf.listMapper(dnsAclListStructToTerraform, false)(this._list.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      list: {
        value: cdktf.listMapperHcl(dnsAclListStructToHclTerraform, false)(this._list.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DnsAclListStructList",
      },
      name: {
