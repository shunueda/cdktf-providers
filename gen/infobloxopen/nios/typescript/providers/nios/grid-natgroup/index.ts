...
export interface GridNatgroupConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GridNatgroup extends cdktf.TerraformResource {
  ...
  * @param options GridNatgroupConfig
  */
  public constructor(scope: Construct, id: string, config: GridNatgroupConfig) {
    super(scope, id, {
