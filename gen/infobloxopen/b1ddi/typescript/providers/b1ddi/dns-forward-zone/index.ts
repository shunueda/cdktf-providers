// https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone
...
export interface DnsForwardZoneConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone#comment DnsForwardZone#comment}
  */
  readonly comment?: string;
  /**
  * Optional. _true_ to disable object. A disabled object is effectively non-existent when generating configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone#disabled DnsForwardZone#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Optional. _true_ to only forward.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone#forward_only DnsForwardZone#forward_only}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone#fqdn DnsForwardZone#fqdn}
  */
  readonly fqdn: string;
  /**
  * The resource identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone#hosts DnsForwardZone#hosts}
  */
  readonly hosts?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone#id DnsForwardZone#id}
  *
  ...
  * The resource identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone#internal_forwarders DnsForwardZone#internal_forwarders}
  */
  readonly internalForwarders?: string[];
  /**
  * The resource identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone#nsgs DnsForwardZone#nsgs}
  */
  readonly nsgs?: string[];
  /**
  * The resource identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone#parent DnsForwardZone#parent}
  */
  readonly parent?: string;
  /**
  * Tagging specifics.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone#tags DnsForwardZone#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The resource identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone#view DnsForwardZone#view}
  */
  readonly view?: string;
  /**
  * external_forwarders block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone#external_forwarders DnsForwardZone#external_forwarders}
  */
...
export interface DnsForwardZoneExternalForwarders {
  ...
  * Server IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone#address DnsForwardZone#address}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone b1ddi_dns_forward_zone}
*/
export class DnsForwardZone extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "b1ddi_dns_forward_zone";
  ...
  * @param importFromId The id of the existing DnsForwardZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DnsForwardZone to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "b1ddi_dns_forward_zone", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_zone b1ddi_dns_forward_zone} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DnsForwardZoneConfig) {
    super(scope, id, {
      terraformResourceType: 'b1ddi_dns_forward_zone',
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      external_forwarders: cdktf.listMapper(dnsForwardZoneExternalForwardersToTerraform, true)(this._externalForwarders.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      external_forwarders: {
        value: cdktf.listMapperHcl(dnsForwardZoneExternalForwardersToHclTerraform, true)(this._externalForwarders.internalValue),
        isBlock: true,
        type: "list",
