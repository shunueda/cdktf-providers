// https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg
...
export interface DnsForwardNsgConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg#comment DnsForwardNsg#comment}
  */
  readonly comment?: string;
  /**
  * Optional. _true_ to only forward.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg#forwarders_only DnsForwardNsg#forwarders_only}
  */
  readonly forwardersOnly?: boolean | cdktf.IResolvable;
  /**
  * The resource identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg#hosts DnsForwardNsg#hosts}
  */
  readonly hosts?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg#id DnsForwardNsg#id}
  *
  ...
  * The resource identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg#internal_forwarders DnsForwardNsg#internal_forwarders}
  */
  readonly internalForwarders?: string[];
  /**
  * Name of the object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg#name DnsForwardNsg#name}
  */
  readonly name: string;
  /**
  * The resource identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg#nsgs DnsForwardNsg#nsgs}
  */
  readonly nsgs?: string[];
  /**
  * Tagging specifics.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg#tags DnsForwardNsg#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * external_forwarders block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg#external_forwarders DnsForwardNsg#external_forwarders}
  */
...
export interface DnsForwardNsgExternalForwarders {
  ...
  * Server IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg#address DnsForwardNsg#address}
  */
  readonly address: string;
  /**
  * Server FQDN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg#fqdn DnsForwardNsg#fqdn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg b1ddi_dns_forward_nsg}
*/
export class DnsForwardNsg extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "b1ddi_dns_forward_nsg";
  ...
  * @param importFromId The id of the existing DnsForwardNsg that should be imported. Refer to the {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DnsForwardNsg to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "b1ddi_dns_forward_nsg", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infobloxopen/b1ddi/0.1.5/docs/resources/dns_forward_nsg b1ddi_dns_forward_nsg} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DnsForwardNsgConfig) {
    super(scope, id, {
      terraformResourceType: 'b1ddi_dns_forward_nsg',
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      external_forwarders: cdktf.listMapper(dnsForwardNsgExternalForwardersToTerraform, true)(this._externalForwarders.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      external_forwarders: {
        value: cdktf.listMapperHcl(dnsForwardNsgExternalForwardersToHclTerraform, true)(this._externalForwarders.internalValue),
        isBlock: true,
        type: "list",
