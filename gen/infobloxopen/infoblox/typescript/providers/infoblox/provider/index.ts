// https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs
...
export interface InfobloxProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs#connect_timeout InfobloxProvider#connect_timeout}
  */
  readonly connectTimeout?: number;
  /**
  * Password to authenticate with Infoblox server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs#password InfobloxProvider#password}
  */
  readonly password?: string;
  /**
  * Maximum number of connections to establish to the Infoblox server. Zero means unlimited.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs#pool_connections InfobloxProvider#pool_connections}
  */
  readonly poolConnections?: number;
  /**
  * Port number used for connection for Infoblox Server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs#port InfobloxProvider#port}
  */
  readonly port?: string;
  /**
  * Infoblox server IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs#server InfobloxProvider#server}
  */
  readonly server: string;
  /**
  * If set, Infoblox client will permit unverifiable SSL certificates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs#sslmode InfobloxProvider#sslmode}
  */
  readonly sslmode?: boolean | cdktf.IResolvable;
  /**
  * User to authenticate with Infoblox server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs#username InfobloxProvider#username}
  */
  readonly username: string;
  /**
  * WAPI Version of Infoblox server defaults to v2.12.3
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs#wapi_version InfobloxProvider#wapi_version}
  */
  readonly wapiVersion?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs#alias InfobloxProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs infoblox}
*/
export class InfobloxProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing InfobloxProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs infoblox} Resource
  *
  * @param scope The scope in which to define this construct
