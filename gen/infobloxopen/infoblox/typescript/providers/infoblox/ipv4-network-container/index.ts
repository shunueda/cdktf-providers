// https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv4_network_container
...
export interface Ipv4NetworkContainerConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv4_network_container#allocate_prefix_len Ipv4NetworkContainer#allocate_prefix_len}
  */
  readonly allocatePrefixLen?: number;
  /**
  * The network container's address, in CIDR format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv4_network_container#cidr Ipv4NetworkContainer#cidr}
  */
  readonly cidr?: string;
  /**
  * A description of the network container.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv4_network_container#comment Ipv4NetworkContainer#comment}
  */
  readonly comment?: string;
  /**
  * The Extensible attributes of the network container to be added/updated, as a map in JSON format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv4_network_container#ext_attrs Ipv4NetworkContainer#ext_attrs}
  */
  readonly extAttrs?: string;
  /**
  * The parent network/network-container block's extensible attributes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv4_network_container#filter_params Ipv4NetworkContainer#filter_params}
  */
  readonly filterParams?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv4_network_container#id Ipv4NetworkContainer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv4_network_container#network_view Ipv4NetworkContainer#network_view}
  */
  readonly networkView?: string;
  /**
  * The parent network container block in CIDR format to allocate from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv4_network_container#parent_cidr Ipv4NetworkContainer#parent_cidr}
  */
  readonly parentCidr?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv4_network_container infoblox_ipv4_network_container}
*/
export class Ipv4NetworkContainer extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a Ipv4NetworkContainer resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the Ipv4NetworkContainer to import
  * @param importFromId The id of the existing Ipv4NetworkContainer that should be imported. Refer to the {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv4_network_container#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Ipv4NetworkContainer to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv4_network_container infoblox_ipv4_network_container} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options Ipv4NetworkContainerConfig = {}
  */
  public constructor(scope: Construct, id: string, config: Ipv4NetworkContainerConfig = {}) {
    super(scope, id, {
