// https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network
...
export interface Ipv6NetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network#allocate_prefix_len Ipv6Network#allocate_prefix_len}
  */
  readonly allocatePrefixLen?: number;
  /**
  * The network block in cidr format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network#cidr Ipv6Network#cidr}
  */
  readonly cidr?: string;
  /**
  * A string describing the network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network#comment Ipv6Network#comment}
  */
  readonly comment?: string;
  /**
  * The Extensible attributes of the Network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network#ext_attrs Ipv6Network#ext_attrs}
  */
  readonly extAttrs?: string;
  /**
  * The parent network/network-container block's extensible attributes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network#filter_params Ipv6Network#filter_params}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network#gateway Ipv6Network#gateway}
  */
  readonly gateway?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network#id Ipv6Network#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network#network_view Ipv6Network#network_view}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network#object Ipv6Network#object}
  */
  readonly object?: string;
  /**
  * The parent network container block in cidr format to allocate from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network#parent_cidr Ipv6Network#parent_cidr}
  */
  readonly parentCidr?: string;
  /**
  * The number of IP's you want to reserve in IPv4 Network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network#reserve_ip Ipv6Network#reserve_ip}
  */
  readonly reserveIp?: number;
  /**
  * The number of IP's you want to reserve in IPv6 Network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network#reserve_ipv6 Ipv6Network#reserve_ipv6}
  */
  readonly reserveIpv6?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network infoblox_ipv6_network}
*/
export class Ipv6Network extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ipv6Network that should be imported. Refer to the {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infobloxopen/infoblox/2.11.0/docs/resources/ipv6_network infoblox_ipv6_network} Resource
  *
  * @param scope The scope in which to define this construct
