// https://registry.terraform.io/providers/philips-labs/kong/6.630.0/docs
...
export interface KongProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-labs/kong/6.630.0/docs#kong_admin_password KongProvider#kong_admin_password}
  */
  readonly kongAdminPassword?: string;
  /**
  * API key for the kong api (Enterprise Edition)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-labs/kong/6.630.0/docs#kong_admin_token KongProvider#kong_admin_token}
  */
  readonly kongAdminToken?: string;
  /**
  * The address of the kong admin url e.g. http://localhost:8001
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-labs/kong/6.630.0/docs#kong_admin_uri KongProvider#kong_admin_uri}
  */
  readonly kongAdminUri?: string;
  /**
  * An basic auth user for kong admin
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-labs/kong/6.630.0/docs#kong_admin_username KongProvider#kong_admin_username}
  */
  readonly kongAdminUsername?: string;
  /**
  * API key for the kong api (if you have locked it down)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-labs/kong/6.630.0/docs#kong_api_key KongProvider#kong_api_key}
  */
  readonly kongApiKey?: string;
  /**
  * Workspace context (Enterprise Edition)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-labs/kong/6.630.0/docs#kong_workspace KongProvider#kong_workspace}
  */
  readonly kongWorkspace?: string;
  /**
  * Should plugins `config_json` field strictly match plugin configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-labs/kong/6.630.0/docs#strict_plugins_match KongProvider#strict_plugins_match}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-labs/kong/6.630.0/docs#tls_skip_verify KongProvider#tls_skip_verify}
  */
  readonly tlsSkipVerify?: boolean | cdktf.IResolvable;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/philips-labs/kong/6.630.0/docs#alias KongProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/philips-labs/kong/6.630.0/docs kong}
*/
export class KongProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing KongProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/philips-labs/kong/6.630.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/philips-labs/kong/6.630.0/docs kong} Resource
  *
  * @param scope The scope in which to define this construct
