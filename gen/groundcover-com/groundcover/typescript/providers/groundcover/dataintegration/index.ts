// https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.2/docs/resources/dataintegration
...
export interface DataintegrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.2/docs/resources/dataintegration#cluster Dataintegration#cluster}
  */
  readonly cluster?: string;
  /**
  * The JSON configuration for the data integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.2/docs/resources/dataintegration#config Dataintegration#config}
  */
  readonly config: string;
  /**
  * Whether the data integration is paused. Default: `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.2/docs/resources/dataintegration#is_paused Dataintegration#is_paused}
  */
  readonly isPaused?: boolean | cdktf.IResolvable;
  /**
  * The type of data integration (e.g., 'cloudwatch', etc.).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.2/docs/resources/dataintegration#type Dataintegration#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.2/docs/resources/dataintegration groundcover_dataintegration}
*/
export class Dataintegration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Dataintegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.2/docs/resources/dataintegration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.2/docs/resources/dataintegration groundcover_dataintegration} Resource
  *
  * @param scope The scope in which to define this construct
