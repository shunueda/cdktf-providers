// https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/metricsaggregation
...
export interface MetricsaggregationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/metricsaggregation#value Metricsaggregation#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/metricsaggregation groundcover_metricsaggregation}
*/
export class Metricsaggregation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Metricsaggregation that should be imported. Refer to the {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/metricsaggregation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/metricsaggregation groundcover_metricsaggregation} Resource
  *
  * @param scope The scope in which to define this construct
