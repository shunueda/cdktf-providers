// https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/monitor
...
export interface MonitorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/monitor#monitor_yaml Monitor#monitor_yaml}
  */
  readonly monitorYaml: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/monitor groundcover_monitor}
*/
export class Monitor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Monitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/monitor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/monitor groundcover_monitor} Resource
  *
  * @param scope The scope in which to define this construct
