// https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/apikey
...
export interface ApikeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/apikey#description Apikey#description}
  */
  readonly description?: string;
  /**
  * The expiration date for the API key (RFC3339 format). If not set, the key never expires.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/apikey#expiration_date Apikey#expiration_date}
  */
  readonly expirationDate?: string;
  /**
  * The name of the API key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/apikey#name Apikey#name}
  */
  readonly name: string;
  /**
  * The ID of the service account associated with the API key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/apikey#service_account_id Apikey#service_account_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/apikey groundcover_apikey}
*/
export class Apikey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Apikey that should be imported. Refer to the {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/apikey#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/apikey groundcover_apikey} Resource
  *
  * @param scope The scope in which to define this construct
