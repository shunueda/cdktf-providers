// https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs
...
export interface GroundcoverProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs#api_key GroundcoverProvider#api_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs#api_url GroundcoverProvider#api_url}
  */
  readonly apiUrl?: string;
  /**
  * groundcover Backend ID. Can also be set via the GROUNDCOVER_BACKEND_ID environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs#backend_id GroundcoverProvider#backend_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs#org_name GroundcoverProvider#org_name}
  */
  readonly orgName?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs#alias GroundcoverProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs groundcover}
*/
export class GroundcoverProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing GroundcoverProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs groundcover} Resource
  *
  * @param scope The scope in which to define this construct
