// https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/logspipeline
...
export interface LogspipelineConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/logspipeline#value Logspipeline#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/logspipeline groundcover_logspipeline}
*/
export class Logspipeline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Logspipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/logspipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/logspipeline groundcover_logspipeline} Resource
  *
  * @param scope The scope in which to define this construct
