// https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/ingestionkey
...
export interface IngestionkeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/ingestionkey#name Ingestionkey#name}
  */
  readonly name: string;
  /**
  * Indicates if the ingestion key is configured for remote configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/ingestionkey#remote_config Ingestionkey#remote_config}
  */
  readonly remoteConfig?: boolean | cdktf.IResolvable;
  /**
  * Tags associated with the ingestion key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/ingestionkey#tags Ingestionkey#tags}
  */
  readonly tags?: string[];
  /**
  * The type of the ingestion key (e.g., 'ingestion').
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/ingestionkey#type Ingestionkey#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/ingestionkey groundcover_ingestionkey}
*/
export class Ingestionkey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ingestionkey that should be imported. Refer to the {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/ingestionkey#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.0/docs/resources/ingestionkey groundcover_ingestionkey} Resource
  *
  * @param scope The scope in which to define this construct
