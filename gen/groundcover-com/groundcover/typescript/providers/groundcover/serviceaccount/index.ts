// https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs/resources/serviceaccount
...
export interface ServiceaccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs/resources/serviceaccount#description Serviceaccount#description}
  */
  readonly description?: string;
  /**
  * The email associated with the service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs/resources/serviceaccount#email Serviceaccount#email}
  */
  readonly email: string;
  /**
  * The name of the service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs/resources/serviceaccount#name Serviceaccount#name}
  */
  readonly name: string;
  /**
  * List of policy UUIDs to assign to the service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs/resources/serviceaccount#policy_uuids Serviceaccount#policy_uuids}
  */
  readonly policyUuids: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs/resources/serviceaccount groundcover_serviceaccount}
*/
export class Serviceaccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Serviceaccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs/resources/serviceaccount#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/groundcover-com/groundcover/1.5.1/docs/resources/serviceaccount groundcover_serviceaccount} Resource
  *
  * @param scope The scope in which to define this construct
