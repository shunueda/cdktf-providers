// https://registry.terraform.io/providers/timeplus-io/timeplus/0.2.0/docs/data-sources/view
...
export interface DataTimeplusViewConfig extends cdktf.TerraformMetaArguments {
  ...
  * The view name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.2.0/docs/data-sources/view#name DataTimeplusView#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.2.0/docs/data-sources/view timeplus_view}
*/
export class DataTimeplusView extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTimeplusView that should be imported. Refer to the {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.2.0/docs/data-sources/view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.2.0/docs/data-sources/view timeplus_view} Data Source
  *
  * @param scope The scope in which to define this construct
