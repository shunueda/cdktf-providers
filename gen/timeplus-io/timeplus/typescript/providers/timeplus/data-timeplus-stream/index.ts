// https://registry.terraform.io/providers/timeplus-io/timeplus/0.1.6/docs/data-sources/stream
...
export interface DataTimeplusStreamConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.1.6/docs/data-sources/stream#history_ttl DataTimeplusStream#history_ttl}
  */
  readonly historyTtl?: string;
  /**
  * The stream name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.1.6/docs/data-sources/stream#name DataTimeplusStream#name}
  */
  readonly name: string;
  /**
  * The retention size threadhold in bytes indicates how many data could be kept in the streaming store
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.1.6/docs/data-sources/stream#retention_bytes DataTimeplusStream#retention_bytes}
  */
  readonly retentionBytes?: number;
  /**
  * The retention period threadhold in millisecond indicates how long data could be kept in the streaming store
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.1.6/docs/data-sources/stream#retention_ms DataTimeplusStream#retention_ms}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.1.6/docs/data-sources/stream timeplus_stream}
*/
export class DataTimeplusStream extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTimeplusStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.1.6/docs/data-sources/stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.1.6/docs/data-sources/stream timeplus_stream} Data Source
  *
  * @param scope The scope in which to define this construct
