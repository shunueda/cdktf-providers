// https://registry.terraform.io/providers/timeplus-io/timeplus/0.2.0/docs/data-sources/javascript_function
...
export interface DataTimeplusJavascriptFunctionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.2.0/docs/data-sources/javascript_function#name DataTimeplusJavascriptFunction#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.2.0/docs/data-sources/javascript_function timeplus_javascript_function}
*/
export class DataTimeplusJavascriptFunction extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTimeplusJavascriptFunction that should be imported. Refer to the {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.2.0/docs/data-sources/javascript_function#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/timeplus-io/timeplus/0.2.0/docs/data-sources/javascript_function timeplus_javascript_function} Data Source
  *
  * @param scope The scope in which to define this construct
