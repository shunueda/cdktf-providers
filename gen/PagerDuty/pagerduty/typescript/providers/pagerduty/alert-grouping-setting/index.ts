// https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.5/docs/resources/alert_grouping_setting
...
export class AlertGroupingSettingConfigAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AlertGroupingSettingConfigA | cdktf.IResolvable | undefined {
    ...
    if (this._iagFields !== undefined) {
      hasAnyValues = true;
      internalValueResult.iagFields = this._iagFields;
    }
  ...
  public set internalValue(value: AlertGroupingSettingConfigA | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      ...
      this._iagFields = value.iagFields;
  ...
  // iag_fields - computed: true, optional: true, required: false
  private _iagFields?: string[]; 
  public get iagFields() {
    return this.getListAttribute('iag_fields');
  }
  public set iagFields(value: string[]) {
    this._iagFields = value;
  }
  public resetIagFields() {
    this._iagFields = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get iagFieldsInput() {
    return this._iagFields;
  }
...
export class AlertGroupingSetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AlertGroupingSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.5/docs/resources/alert_grouping_setting#import import section} in the documentation of this resource for the id to use
