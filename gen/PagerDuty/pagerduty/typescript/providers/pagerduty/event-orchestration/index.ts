// https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.7/docs/resources/event_orchestration
...
export class EventOrchestration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventOrchestration that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.7/docs/resources/event_orchestration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.7/docs/resources/event_orchestration pagerduty_event_orchestration} Resource
  *
  * @param scope The scope in which to define this construct
