// https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.7/docs/data-sources/license
...
export class DataPagerdutyLicense extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyLicense that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.7/docs/data-sources/license#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.7/docs/data-sources/license pagerduty_license} Data Source
  *
  * @param scope The scope in which to define this construct
