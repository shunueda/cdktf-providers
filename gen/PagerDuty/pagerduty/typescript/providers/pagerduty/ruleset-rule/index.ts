// https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/ruleset_rule
...
export class RulesetRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RulesetRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/ruleset_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/ruleset_rule pagerduty_ruleset_rule} Resource
  *
  * @param scope The scope in which to define this construct
