// https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/data-sources/standards
...
export class DataPagerdutyStandards extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyStandards that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/data-sources/standards#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/data-sources/standards pagerduty_standards} Data Source
  *
  * @param scope The scope in which to define this construct
