// https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.7/docs/data-sources/event_orchestration_service_cache_variable
...
export class DataPagerdutyEventOrchestrationServiceCacheVariable extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyEventOrchestrationServiceCacheVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.7/docs/data-sources/event_orchestration_service_cache_variable#import import section} in the documentation of this resource for the id to use
