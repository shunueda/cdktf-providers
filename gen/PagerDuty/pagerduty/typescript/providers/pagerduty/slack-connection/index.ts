// https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/slack_connection
...
export interface SlackConnectionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/slack_connection#channel_id SlackConnection#channel_id}
  */
  readonly channelId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/slack_connection#id SlackConnection#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/slack_connection#notification_type SlackConnection#notification_type}
  */
  readonly notificationType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/slack_connection#source_id SlackConnection#source_id}
  */
  readonly sourceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/slack_connection#source_type SlackConnection#source_type}
  */
  readonly sourceType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/slack_connection#workspace_id SlackConnection#workspace_id}
  */
  readonly workspaceId: string;
  /**
  * config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/slack_connection#config SlackConnection#config}
  */
  readonly config: SlackConnectionConfigA[] | cdktf.IResolvable;
}
export interface SlackConnectionConfigA {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/slack_connection#events SlackConnection#events}
  */
  readonly events: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/slack_connection#priorities SlackConnection#priorities}
  */
  readonly priorities?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/slack_connection#urgency SlackConnection#urgency}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/slack_connection pagerduty_slack_connection}
*/
export class SlackConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SlackConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/slack_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.30.6/docs/resources/slack_connection pagerduty_slack_connection} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  public constructor(scope: Construct, id: string, config: SlackConnectionConfig) {
    super(scope, id, {
      ...
      terraformGeneratorMetadata: {
        ...
        providerVersionConstraint: '3.30.6'
      },
