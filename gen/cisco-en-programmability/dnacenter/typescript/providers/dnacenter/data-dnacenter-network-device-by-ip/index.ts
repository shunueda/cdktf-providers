// https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/network_device_by_ip
...
export interface DataDnacenterNetworkDeviceByIpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/network_device_by_ip#id DataDnacenterNetworkDeviceByIp#id}
  *
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/network_device_by_ip#ip_address DataDnacenterNetworkDeviceByIp#ip_address}
  */
  readonly ipAddress: string;
}
export interface DataDnacenterNetworkDeviceByIpItem {
}

export function dataDnacenterNetworkDeviceByIpItemToTerraform(struct?: DataDnacenterNetworkDeviceByIpItem): any {
...
export function dataDnacenterNetworkDeviceByIpItemToHclTerraform(struct?: DataDnacenterNetworkDeviceByIpItem): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataDnacenterNetworkDeviceByIpItemOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataDnacenterNetworkDeviceByIpItem | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataDnacenterNetworkDeviceByIpItem | undefined) {
    if (value === undefined) {
...
export class DataDnacenterNetworkDeviceByIpItemList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataDnacenterNetworkDeviceByIpItemOutputReference {
    return new DataDnacenterNetworkDeviceByIpItemOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/network_device_by_ip dnacenter_network_device_by_ip}
*/
export class DataDnacenterNetworkDeviceByIp extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "dnacenter_network_device_by_ip";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataDnacenterNetworkDeviceByIp resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataDnacenterNetworkDeviceByIp to import
  * @param importFromId The id of the existing DataDnacenterNetworkDeviceByIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/network_device_by_ip#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataDnacenterNetworkDeviceByIp to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "dnacenter_network_device_by_ip", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/network_device_by_ip dnacenter_network_device_by_ip} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataDnacenterNetworkDeviceByIpConfig
  */
  public constructor(scope: Construct, id: string, config: DataDnacenterNetworkDeviceByIpConfig) {
    super(scope, id, {
  ...
  private _item = new DataDnacenterNetworkDeviceByIpItemList(this, "item", false);
  public get item() {
    return this._item;
  }
