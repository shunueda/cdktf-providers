// https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/network_device
...
export interface DataDnacenterNetworkDeviceConfig extends cdktf.TerraformMetaArguments {
  /**
  * id path parameter. Device ID
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/network_device#id DataDnacenterNetworkDevice#id}
  *
...
export interface DataDnacenterNetworkDeviceItem {
}

export function dataDnacenterNetworkDeviceItemToTerraform(struct?: DataDnacenterNetworkDeviceItem): any {
...
export function dataDnacenterNetworkDeviceItemToHclTerraform(struct?: DataDnacenterNetworkDeviceItem): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataDnacenterNetworkDeviceItemOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataDnacenterNetworkDeviceItem | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataDnacenterNetworkDeviceItem | undefined) {
    if (value === undefined) {
...
export class DataDnacenterNetworkDeviceItemList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataDnacenterNetworkDeviceItemOutputReference {
    return new DataDnacenterNetworkDeviceItemOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/network_device dnacenter_network_device}
*/
export class DataDnacenterNetworkDevice extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataDnacenterNetworkDevice resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataDnacenterNetworkDevice to import
  * @param importFromId The id of the existing DataDnacenterNetworkDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/network_device#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataDnacenterNetworkDevice to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/network_device dnacenter_network_device} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataDnacenterNetworkDeviceConfig
  */
  public constructor(scope: Construct, id: string, config: DataDnacenterNetworkDeviceConfig) {
    super(scope, id, {
  ...
  private _item = new DataDnacenterNetworkDeviceItemList(this, "item", false);
  public get item() {
    return this._item;
  }
