// https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/resources/network_device
...
export interface NetworkDeviceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/resources/network_device#id NetworkDevice#id}
  *
  ...
  * parameters block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/resources/network_device#parameters NetworkDevice#parameters}
  */
  readonly parameters: NetworkDeviceParameters;
}
export interface NetworkDeviceItem {
}

export function networkDeviceItemToTerraform(struct?: NetworkDeviceItem): any {
...
export function networkDeviceItemToHclTerraform(struct?: NetworkDeviceItem): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class NetworkDeviceItemOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NetworkDeviceItem | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: NetworkDeviceItem | undefined) {
    if (value === undefined) {
...
export class NetworkDeviceItemList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): NetworkDeviceItemOutputReference {
    return new NetworkDeviceItemOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface NetworkDeviceParameters {
  /**
...
export function networkDeviceParametersToTerraform(struct?: NetworkDeviceParametersOutputReference | NetworkDeviceParameters): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function networkDeviceParametersToHclTerraform(struct?: NetworkDeviceParametersOutputReference | NetworkDeviceParameters): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class NetworkDeviceParametersOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): NetworkDeviceParameters | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: NetworkDeviceParameters | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._id = undefined;
    }
...
/**
* Represents a {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/resources/network_device dnacenter_network_device}
*/
export class NetworkDevice extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "dnacenter_network_device";
  ...
  * @param importFromId The id of the existing NetworkDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/resources/network_device#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the NetworkDevice to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "dnacenter_network_device", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/resources/network_device dnacenter_network_device} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: NetworkDeviceConfig) {
    super(scope, id, {
      terraformResourceType: 'dnacenter_network_device',
  ...
  private _item = new NetworkDeviceItemList(this, "item", false);
  public get item() {
    return this._item;
  }
  ...
  private _parameters = new NetworkDeviceParametersOutputReference(this, "parameters");
  public get parameters() {
    return this._parameters;
  }
  public putParameters(value: NetworkDeviceParameters) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      parameters: networkDeviceParametersToTerraform(this._parameters.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      parameters: {
        value: networkDeviceParametersToHclTerraform(this._parameters.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "NetworkDeviceParametersList",
      },
    };
