// https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/discovery_device_range
...
export interface DataDnacenterDiscoveryDeviceRangeConfig extends cdktf.TerraformMetaArguments {
  /**
  * id path parameter. Discovery ID
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/discovery_device_range#id DataDnacenterDiscoveryDeviceRange#id}
  *
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/discovery_device_range#records_to_return DataDnacenterDiscoveryDeviceRange#records_to_return}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/discovery_device_range#start_index DataDnacenterDiscoveryDeviceRange#start_index}
  */
  readonly startIndex: number;
  /**
  * taskId query parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/discovery_device_range#task_id DataDnacenterDiscoveryDeviceRange#task_id}
  */
  readonly taskId?: string;
}
export interface DataDnacenterDiscoveryDeviceRangeItems {
}

export function dataDnacenterDiscoveryDeviceRangeItemsToTerraform(struct?: DataDnacenterDiscoveryDeviceRangeItems): any {
...
export function dataDnacenterDiscoveryDeviceRangeItemsToHclTerraform(struct?: DataDnacenterDiscoveryDeviceRangeItems): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataDnacenterDiscoveryDeviceRangeItemsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataDnacenterDiscoveryDeviceRangeItems | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataDnacenterDiscoveryDeviceRangeItems | undefined) {
    if (value === undefined) {
...
export class DataDnacenterDiscoveryDeviceRangeItemsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataDnacenterDiscoveryDeviceRangeItemsOutputReference {
    return new DataDnacenterDiscoveryDeviceRangeItemsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/discovery_device_range dnacenter_discovery_device_range}
*/
export class DataDnacenterDiscoveryDeviceRange extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "dnacenter_discovery_device_range";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataDnacenterDiscoveryDeviceRange resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataDnacenterDiscoveryDeviceRange to import
  * @param importFromId The id of the existing DataDnacenterDiscoveryDeviceRange that should be imported. Refer to the {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/discovery_device_range#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataDnacenterDiscoveryDeviceRange to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "dnacenter_discovery_device_range", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cisco-en-programmability/dnacenter/1.1.21/docs/data-sources/discovery_device_range dnacenter_discovery_device_range} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataDnacenterDiscoveryDeviceRangeConfig
  */
  public constructor(scope: Construct, id: string, config: DataDnacenterDiscoveryDeviceRangeConfig) {
    super(scope, id, {
      terraformResourceType: 'dnacenter_discovery_device_range',
  ...
  private _items = new DataDnacenterDiscoveryDeviceRangeItemsList(this, "items", false);
  public get items() {
    return this._items;
  }
