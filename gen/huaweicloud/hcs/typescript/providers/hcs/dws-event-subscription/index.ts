// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription
...
export interface DwsEventSubscriptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription#category DwsEventSubscription#category}
  */
  readonly category?: string;
  /**
  * whether the event subscription is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription#enable DwsEventSubscription#enable}
  */
  readonly enable: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription#id DwsEventSubscription#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription#name DwsEventSubscription#name}
  */
  readonly name: string;
  /**
  * The notification target.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription#notification_target DwsEventSubscription#notification_target}
  */
  readonly notificationTarget: string;
  /**
  * The name of notification target.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription#notification_target_name DwsEventSubscription#notification_target_name}
  */
  readonly notificationTargetName: string;
  /**
  * The type of notification target. Currently only **SMN** is supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription#notification_target_type DwsEventSubscription#notification_target_type}
  */
  readonly notificationTargetType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription#region DwsEventSubscription#region}
  */
  readonly region?: string;
  /**
  * The severity of source event.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription#severity DwsEventSubscription#severity}
  */
  readonly severity?: string;
  /**
  * ID of source event.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription#source_id DwsEventSubscription#source_id}
  */
  readonly sourceId?: string;
  /**
  * The type of source event.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription#source_type DwsEventSubscription#source_type}
  */
  readonly sourceType?: string;
  /**
  * The time_zone of the event subscription.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription#time_zone DwsEventSubscription#time_zone}
  */
  readonly timeZone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription hcs_dws_event_subscription}
*/
export class DwsEventSubscription extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_dws_event_subscription";
  ...
  * @param importFromId The id of the existing DwsEventSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_dws_event_subscription", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_event_subscription hcs_dws_event_subscription} Resource
  *
  * @param scope The scope in which to define this construct
