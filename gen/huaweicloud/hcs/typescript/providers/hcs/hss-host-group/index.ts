// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/hss_host_group
...
export interface HssHostGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/hss_host_group#enterprise_project_id HssHostGroup#enterprise_project_id}
  */
  readonly enterpriseProjectId?: string;
  /**
  * schema: Required; The list of host IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/hss_host_group#host_ids HssHostGroup#host_ids}
  */
  readonly hostIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/hss_host_group#id HssHostGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/hss_host_group#name HssHostGroup#name}
  */
  readonly name: string;
  /**
  * The region where the host group is located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/hss_host_group#region HssHostGroup#region}
  */
  readonly region?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/hss_host_group#timeouts HssHostGroup#timeouts}
  */
  readonly timeouts?: HssHostGroupTimeouts;
}
export interface HssHostGroupTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/hss_host_group#create HssHostGroup#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/hss_host_group#update HssHostGroup#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/hss_host_group hcs_hss_host_group}
*/
export class HssHostGroup extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_hss_host_group";
  ...
  * @param importFromId The id of the existing HssHostGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/hss_host_group#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the HssHostGroup to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_hss_host_group", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/hss_host_group hcs_hss_host_group} Resource
  *
  * @param scope The scope in which to define this construct
