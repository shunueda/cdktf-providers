// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/direct_connect
...
export interface DataHcsDirectConnectConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/direct_connect#dc_provider DataHcsDirectConnect#dc_provider}
  */
  readonly dcProvider?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/direct_connect#id DataHcsDirectConnect#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/direct_connect#name DataHcsDirectConnect#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/direct_connect#region DataHcsDirectConnect#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/direct_connect hcs_direct_connect}
*/
export class DataHcsDirectConnect extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcsDirectConnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/direct_connect#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/direct_connect hcs_direct_connect} Data Source
  *
  * @param scope The scope in which to define this construct
