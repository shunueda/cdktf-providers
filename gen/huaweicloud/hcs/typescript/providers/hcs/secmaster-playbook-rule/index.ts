// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule
...
export interface SecmasterPlaybookRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#cron SecmasterPlaybookRule#cron}
  */
  readonly cron?: string;
  /**
  * Specifies the playbook end time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#end_time SecmasterPlaybookRule#end_time}
  */
  readonly endTime?: string;
  /**
  * Specifies the playbook end type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#end_type SecmasterPlaybookRule#end_type}
  */
  readonly endType?: string;
  /**
  * Specifies the execution type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#execution_type SecmasterPlaybookRule#execution_type}
  */
  readonly executionType?: string;
  /**
  * Specifies the expression type of the rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#expression_type SecmasterPlaybookRule#expression_type}
  */
  readonly expressionType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#id SecmasterPlaybookRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#logics SecmasterPlaybookRule#logics}
  */
  readonly logics?: string[];
  /**
  * Specifies the repeat range.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#only_once SecmasterPlaybookRule#only_once}
  */
  readonly onlyOnce?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#region SecmasterPlaybookRule#region}
  */
  readonly region?: string;
  /**
  * Specifies the repeat range.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#repeat_range SecmasterPlaybookRule#repeat_range}
  */
  readonly repeatRange?: string;
  /**
  * Specifies the schedule type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#schedule_type SecmasterPlaybookRule#schedule_type}
  */
  readonly scheduleType?: string;
  /**
  * Specifies the playbook start type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#start_type SecmasterPlaybookRule#start_type}
  */
  readonly startType?: string;
  /**
  * Specifies playbook version ID of the rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#version_id SecmasterPlaybookRule#version_id}
  */
  readonly versionId: string;
  /**
  * Specifies the ID of the workspace to which the playbook rule belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#workspace_id SecmasterPlaybookRule#workspace_id}
  */
  readonly workspaceId: string;
  /**
  * conditions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#conditions SecmasterPlaybookRule#conditions}
  */
...
export interface SecmasterPlaybookRuleConditions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#data SecmasterPlaybookRule#data}
  */
  readonly data?: string[];
  /**
  * Specifies the condition detail.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#detail SecmasterPlaybookRule#detail}
  */
  readonly detail?: string;
  /**
  * Specifies the condition name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#name SecmasterPlaybookRule#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule hcs_secmaster_playbook_rule}
*/
export class SecmasterPlaybookRule extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_secmaster_playbook_rule";
  ...
  * @param importFromId The id of the existing SecmasterPlaybookRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_secmaster_playbook_rule", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_rule hcs_secmaster_playbook_rule} Resource
  *
  * @param scope The scope in which to define this construct
