// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/lts_streams
...
export interface DataHcsLtsStreamsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/lts_streams#id DataHcsLtsStreams#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/lts_streams#log_group_name DataHcsLtsStreams#log_group_name}
  */
  readonly logGroupName?: string;
  /**
  * The name of the log stream to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/lts_streams#log_stream_name DataHcsLtsStreams#log_stream_name}
  */
  readonly logStreamName?: string;
  /**
  * The region in which to query the log streams.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/lts_streams#region DataHcsLtsStreams#region}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/lts_streams hcs_lts_streams}
*/
export class DataHcsLtsStreams extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcsLtsStreams that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/lts_streams#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/data-sources/lts_streams hcs_lts_streams} Data Source
  *
  * @param scope The scope in which to define this construct
