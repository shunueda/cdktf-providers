// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection
...
export interface WafRuleCcProtectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#all_waf_instances WafRuleCcProtection#all_waf_instances}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#block_page_type WafRuleCcProtection#block_page_type}
  */
  readonly blockPageType?: string;
  /**
  * Specifies the description of WAF cc protection rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#description WafRuleCcProtection#description}
  */
  readonly description?: string;
  /**
  * Specifies the enterprise project ID of WAF cc protection rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#enterprise_project_id WafRuleCcProtection#enterprise_project_id}
  */
  readonly enterpriseProjectId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#id WafRuleCcProtection#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#limit_num WafRuleCcProtection#limit_num}
  */
  readonly limitNum: number;
  /**
  * Specifies the rate limiting period. The value ranges from 1 to 3,600 in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#limit_period WafRuleCcProtection#limit_period}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#lock_time WafRuleCcProtection#lock_time}
  */
  readonly lockTime?: number;
  /**
  * Specifies the rule name of WAF cc protection rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#name WafRuleCcProtection#name}
  */
  readonly name: string;
  /**
  * Specifies the other user identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#other_user_identifier WafRuleCcProtection#other_user_identifier}
  */
  readonly otherUserIdentifier?: string;
  /**
  * Specifies the content of the returned page.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#page_content WafRuleCcProtection#page_content}
  */
  readonly pageContent?: string;
  /**
  * Specifies the policy ID of WAF cc protection rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#policy_id WafRuleCcProtection#policy_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#protective_action WafRuleCcProtection#protective_action}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#rate_limit_mode WafRuleCcProtection#rate_limit_mode}
  */
  readonly rateLimitMode: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#region WafRuleCcProtection#region}
  */
  readonly region?: string;
  /**
  * Specifies whether to enable domain aggregation statistics. Default to false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#request_aggregation WafRuleCcProtection#request_aggregation}
  */
  readonly requestAggregation?: boolean | cdktf.IResolvable;
  /**
  * The status of a cc protection rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#status WafRuleCcProtection#status}
  */
  readonly status?: number;
  /**
  * Specifies the allowable frequency. The value ranges from 0 to 2,147,483,647.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#unlock_num WafRuleCcProtection#unlock_num}
  */
  readonly unlockNum?: number;
  /**
  * Specifies the user identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#user_identifier WafRuleCcProtection#user_identifier}
  */
  readonly userIdentifier?: string;
  /**
  * conditions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#conditions WafRuleCcProtection#conditions}
  */
...
export interface WafRuleCcProtectionConditions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#content WafRuleCcProtection#content}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#field WafRuleCcProtection#field}
  */
  readonly field: string;
  /**
  * Specifies the condition matching logic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#logic WafRuleCcProtection#logic}
  */
  readonly logic: string;
  /**
  * Specifies the reference table id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#reference_table_id WafRuleCcProtection#reference_table_id}
  */
  readonly referenceTableId?: string;
  /**
  * Specifies the subfield of the condition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#subfield WafRuleCcProtection#subfield}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection hcs_waf_rule_cc_protection}
*/
export class WafRuleCcProtection extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_waf_rule_cc_protection";
  ...
  * @param importFromId The id of the existing WafRuleCcProtection that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_waf_rule_cc_protection", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/waf_rule_cc_protection hcs_waf_rule_cc_protection} Resource
  *
  * @param scope The scope in which to define this construct
