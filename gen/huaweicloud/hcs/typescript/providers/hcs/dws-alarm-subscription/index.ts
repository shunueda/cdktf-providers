// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/dws_alarm_subscription
...
export interface DwsAlarmSubscriptionConfig extends cdktf.TerraformMetaArguments {
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/dws_alarm_subscription#alarm_level DwsAlarmSubscription#alarm_level}
  */
  readonly alarmLevel?: string;
  /**
  * whether the alarm subscription is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/dws_alarm_subscription#enable DwsAlarmSubscription#enable}
  */
  readonly enable: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/dws_alarm_subscription#id DwsAlarmSubscription#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/dws_alarm_subscription#name DwsAlarmSubscription#name}
  */
  readonly name: string;
  /**
  * The notification target.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/dws_alarm_subscription#notification_target DwsAlarmSubscription#notification_target}
  */
  readonly notificationTarget: string;
  /**
  * The name of notification target.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/dws_alarm_subscription#notification_target_name DwsAlarmSubscription#notification_target_name}
  */
  readonly notificationTargetName: string;
  /**
  * The type of notification target. Currently only **SMN** is supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/dws_alarm_subscription#notification_target_type DwsAlarmSubscription#notification_target_type}
  */
  readonly notificationTargetType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/dws_alarm_subscription#region DwsAlarmSubscription#region}
  */
  readonly region?: string;
  /**
  * The time_zone of the alarm subscription.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/dws_alarm_subscription#time_zone DwsAlarmSubscription#time_zone}
  */
  readonly timeZone: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/dws_alarm_subscription hcs_dws_alarm_subscription}
*/
export class DwsAlarmSubscription extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_dws_alarm_subscription";
  ...
  * @param importFromId The id of the existing DwsAlarmSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/dws_alarm_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_dws_alarm_subscription", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/dws_alarm_subscription hcs_dws_alarm_subscription} Resource
  *
  * @param scope The scope in which to define this construct
