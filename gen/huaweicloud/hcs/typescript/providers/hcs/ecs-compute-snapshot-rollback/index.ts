// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ecs_compute_snapshot_rollback
...
export interface EcsComputeSnapshotRollbackConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ecs_compute_snapshot_rollback#id EcsComputeSnapshotRollback#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ecs_compute_snapshot_rollback#instance_id EcsComputeSnapshotRollback#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ecs_compute_snapshot_rollback#snapshot_id EcsComputeSnapshotRollback#snapshot_id}
  */
  readonly snapshotId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ecs_compute_snapshot_rollback#timeouts EcsComputeSnapshotRollback#timeouts}
  */
  readonly timeouts?: EcsComputeSnapshotRollbackTimeouts;
}
export interface EcsComputeSnapshotRollbackTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ecs_compute_snapshot_rollback#create EcsComputeSnapshotRollback#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ecs_compute_snapshot_rollback#delete EcsComputeSnapshotRollback#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ecs_compute_snapshot_rollback hcs_ecs_compute_snapshot_rollback}
*/
export class EcsComputeSnapshotRollback extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsComputeSnapshotRollback that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ecs_compute_snapshot_rollback#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ecs_compute_snapshot_rollback hcs_ecs_compute_snapshot_rollback} Resource
  *
  * @param scope The scope in which to define this construct
