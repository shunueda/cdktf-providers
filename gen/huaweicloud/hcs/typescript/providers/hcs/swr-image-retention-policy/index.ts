// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/swr_image_retention_policy
...
export interface SwrImageRetentionPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/swr_image_retention_policy#id SwrImageRetentionPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/swr_image_retention_policy#number SwrImageRetentionPolicy#number}
  */
  readonly number: number;
  /**
  * Specifies the name of the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/swr_image_retention_policy#organization SwrImageRetentionPolicy#organization}
  */
  readonly organization: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/swr_image_retention_policy#region SwrImageRetentionPolicy#region}
  */
  readonly region?: string;
  /**
  * Specifies the name of the repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/swr_image_retention_policy#repository SwrImageRetentionPolicy#repository}
  */
  readonly repository: string;
  /**
  * Specifies the retention policy type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/swr_image_retention_policy#type SwrImageRetentionPolicy#type}
  */
  readonly type: string;
  /**
  * tag_selectors block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/swr_image_retention_policy#tag_selectors SwrImageRetentionPolicy#tag_selectors}
  */
...
export interface SwrImageRetentionPolicyTagSelectors {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/swr_image_retention_policy#kind SwrImageRetentionPolicy#kind}
  */
  readonly kind?: string;
  /**
  * Specifies the Matching pattern.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/swr_image_retention_policy#pattern SwrImageRetentionPolicy#pattern}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/swr_image_retention_policy hcs_swr_image_retention_policy}
*/
export class SwrImageRetentionPolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_swr_image_retention_policy";
  ...
  * @param importFromId The id of the existing SwrImageRetentionPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/swr_image_retention_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_swr_image_retention_policy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/swr_image_retention_policy hcs_swr_image_retention_policy} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SwrImageRetentionPolicyConfig) {
    super(scope, id, {
      terraformResourceType: 'hcs_swr_image_retention_policy',
