// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer
...
export interface LtsTransferConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#id LtsTransfer#id}
  *
  ...
  * Log group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#log_group_id LtsTransfer#log_group_id}
  */
  readonly logGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#region LtsTransfer#region}
  */
  readonly region?: string;
  /**
  * log_streams block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#log_streams LtsTransfer#log_streams}
  */
  readonly logStreams: LtsTransferLogStreams[] | cdktf.IResolvable;
  /**
  * log_transfer_info block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#log_transfer_info LtsTransfer#log_transfer_info}
  */
...
export interface LtsTransferLogStreams {
  ...
  * Log stream ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#log_stream_id LtsTransfer#log_stream_id}
  */
  readonly logStreamId: string;
  /**
  * Log stream name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#log_stream_name LtsTransfer#log_stream_name}
  */
...
export interface LtsTransferLogTransferInfoLogAgencyTransfer {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#agency_domain_id LtsTransfer#agency_domain_id}
  */
  readonly agencyDomainId: string;
  /**
  * Delegator account name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#agency_domain_name LtsTransfer#agency_domain_name}
  */
  readonly agencyDomainName: string;
  /**
  * The agency name created by the delegator.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#agency_name LtsTransfer#agency_name}
  */
  readonly agencyName: string;
  /**
  * Project ID of the delegator.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#agency_project_id LtsTransfer#agency_project_id}
  */
...
export interface LtsTransferLogTransferInfoLogTransferDetail {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#delivery_tags LtsTransfer#delivery_tags}
  */
  readonly deliveryTags?: string[];
  /**
  * DIS stream ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#dis_id LtsTransfer#dis_id}
  */
  readonly disId?: string;
  /**
  * DIS stream name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#dis_name LtsTransfer#dis_name}
  */
  readonly disName?: string;
  /**
  * Kafka ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#kafka_id LtsTransfer#kafka_id}
  */
  readonly kafkaId?: string;
  /**
  * Kafka topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#kafka_topic LtsTransfer#kafka_topic}
  */
  readonly kafkaTopic?: string;
  /**
  * OBS bucket name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#obs_bucket_name LtsTransfer#obs_bucket_name}
  */
  readonly obsBucketName?: string;
  /**
  * Custom transfer path of an OBS transfer task.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#obs_dir_prefix_name LtsTransfer#obs_dir_prefix_name}
  */
  readonly obsDirPrefixName?: string;
  /**
  * Whether OBS bucket encryption is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#obs_encrypted_enable LtsTransfer#obs_encrypted_enable}
  */
  readonly obsEncryptedEnable?: boolean | cdktf.IResolvable;
  /**
  * KMS key ID for an OBS transfer task.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#obs_encrypted_id LtsTransfer#obs_encrypted_id}
  */
  readonly obsEncryptedId?: string;
  /**
  * Enterprise project ID of an OBS transfer task.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#obs_eps_id LtsTransfer#obs_eps_id}
  */
  readonly obsEpsId?: string;
  /**
  * Length of the transfer interval for an OBS transfer task.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#obs_period LtsTransfer#obs_period}
  */
  readonly obsPeriod?: number;
  /**
  * Unit of the transfer interval for an OBS transfer task.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#obs_period_unit LtsTransfer#obs_period_unit}
  */
  readonly obsPeriodUnit?: string;
  /**
  * Transfer file prefix of an OBS transfer task.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#obs_prefix_name LtsTransfer#obs_prefix_name}
  */
  readonly obsPrefixName?: string;
  /**
  * Time zone for an OBS transfer task.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#obs_time_zone LtsTransfer#obs_time_zone}
  */
  readonly obsTimeZone?: string;
  /**
  * ID of the time zone for an OBS transfer task.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#obs_time_zone_id LtsTransfer#obs_time_zone_id}
  */
  readonly obsTimeZoneId?: string;
  /**
  * OBS bucket path, which is the log transfer destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#obs_transfer_path LtsTransfer#obs_transfer_path}
  */
...
export interface LtsTransferLogTransferInfo {
  ...
  * Log transfer format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#log_storage_format LtsTransfer#log_storage_format}
  */
  readonly logStorageFormat: string;
  /**
  * Log transfer mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#log_transfer_mode LtsTransfer#log_transfer_mode}
  */
  readonly logTransferMode: string;
  /**
  * Log transfer status.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#log_transfer_status LtsTransfer#log_transfer_status}
  */
  readonly logTransferStatus: string;
  /**
  * Log transfer type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#log_transfer_type LtsTransfer#log_transfer_type}
  */
  readonly logTransferType: string;
  /**
  * log_agency_transfer block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#log_agency_transfer LtsTransfer#log_agency_transfer}
  */
  readonly logAgencyTransfer?: LtsTransferLogTransferInfoLogAgencyTransfer;
  /**
  * log_transfer_detail block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#log_transfer_detail LtsTransfer#log_transfer_detail}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer hcs_lts_transfer}
*/
export class LtsTransfer extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_lts_transfer";
  ...
  * @param importFromId The id of the existing LtsTransfer that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the LtsTransfer to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_lts_transfer", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/lts_transfer hcs_lts_transfer} Resource
  *
  * @param scope The scope in which to define this construct
