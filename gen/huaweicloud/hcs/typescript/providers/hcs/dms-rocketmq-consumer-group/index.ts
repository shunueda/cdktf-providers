// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/dms_rocketmq_consumer_group
...
export interface DmsRocketmqConsumerGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/dms_rocketmq_consumer_group#broadcast DmsRocketmqConsumerGroup#broadcast}
  */
  readonly broadcast?: boolean | cdktf.IResolvable;
  /**
  * Specifies the list of associated brokers of the consumer group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/dms_rocketmq_consumer_group#brokers DmsRocketmqConsumerGroup#brokers}
  */
  readonly brokers?: string[];
  /**
  * Specifies whether to consume orderly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/dms_rocketmq_consumer_group#consume_orderly DmsRocketmqConsumerGroup#consume_orderly}
  */
  readonly consumeOrderly?: boolean | cdktf.IResolvable;
  /**
  * Specifies the description of the consumer group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/dms_rocketmq_consumer_group#description DmsRocketmqConsumerGroup#description}
  */
  readonly description?: string;
  /**
  * Specifies the consumer group is enabled or not. Default to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/dms_rocketmq_consumer_group#enabled DmsRocketmqConsumerGroup#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/dms_rocketmq_consumer_group#id DmsRocketmqConsumerGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/dms_rocketmq_consumer_group#instance_id DmsRocketmqConsumerGroup#instance_id}
  */
  readonly instanceId: string;
  /**
  * Specifies the name of the consumer group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/dms_rocketmq_consumer_group#name DmsRocketmqConsumerGroup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/dms_rocketmq_consumer_group#region DmsRocketmqConsumerGroup#region}
  */
  readonly region?: string;
  /**
  * Specifies the maximum number of retry times.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/dms_rocketmq_consumer_group#retry_max_times DmsRocketmqConsumerGroup#retry_max_times}
  */
  readonly retryMaxTimes: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/dms_rocketmq_consumer_group hcs_dms_rocketmq_consumer_group}
*/
export class DmsRocketmqConsumerGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsRocketmqConsumerGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/dms_rocketmq_consumer_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.20/docs/resources/dms_rocketmq_consumer_group hcs_dms_rocketmq_consumer_group} Resource
  *
  * @param scope The scope in which to define this construct
