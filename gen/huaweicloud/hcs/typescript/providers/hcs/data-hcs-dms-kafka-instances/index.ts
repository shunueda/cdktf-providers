// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/dms_kafka_instances
...
export interface DataHcsDmsKafkaInstancesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/dms_kafka_instances#enterprise_project_id DataHcsDmsKafkaInstances#enterprise_project_id}
  */
  readonly enterpriseProjectId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/dms_kafka_instances#fuzzy_match DataHcsDmsKafkaInstances#fuzzy_match}
  */
  readonly fuzzyMatch?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/dms_kafka_instances#id DataHcsDmsKafkaInstances#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/dms_kafka_instances#include_failure DataHcsDmsKafkaInstances#include_failure}
  */
  readonly includeFailure?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/dms_kafka_instances#instance_id DataHcsDmsKafkaInstances#instance_id}
  */
  readonly instanceId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/dms_kafka_instances#name DataHcsDmsKafkaInstances#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/dms_kafka_instances#region DataHcsDmsKafkaInstances#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/dms_kafka_instances#status DataHcsDmsKafkaInstances#status}
  */
  readonly status?: string;
}
export interface DataHcsDmsKafkaInstancesInstancesCrossVpcAccesses {
}

export function dataHcsDmsKafkaInstancesInstancesCrossVpcAccessesToTerraform(struct?: DataHcsDmsKafkaInstancesInstancesCrossVpcAccesses): any {
...
export function dataHcsDmsKafkaInstancesInstancesCrossVpcAccessesToHclTerraform(struct?: DataHcsDmsKafkaInstancesInstancesCrossVpcAccesses): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataHcsDmsKafkaInstancesInstancesCrossVpcAccessesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataHcsDmsKafkaInstancesInstancesCrossVpcAccesses | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataHcsDmsKafkaInstancesInstancesCrossVpcAccesses | undefined) {
    if (value === undefined) {
...
export class DataHcsDmsKafkaInstancesInstancesCrossVpcAccessesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataHcsDmsKafkaInstancesInstancesCrossVpcAccessesOutputReference {
    return new DataHcsDmsKafkaInstancesInstancesCrossVpcAccessesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataHcsDmsKafkaInstancesInstances {
}

export function dataHcsDmsKafkaInstancesInstancesToTerraform(struct?: DataHcsDmsKafkaInstancesInstances): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataHcsDmsKafkaInstancesInstancesToHclTerraform(struct?: DataHcsDmsKafkaInstancesInstances): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataHcsDmsKafkaInstancesInstancesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataHcsDmsKafkaInstancesInstances | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataHcsDmsKafkaInstancesInstances | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _crossVpcAccesses = new DataHcsDmsKafkaInstancesInstancesCrossVpcAccessesList(this, "cross_vpc_accesses", false);
...
export class DataHcsDmsKafkaInstancesInstancesList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataHcsDmsKafkaInstancesInstancesOutputReference {
    return new DataHcsDmsKafkaInstancesInstancesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/dms_kafka_instances hcs_dms_kafka_instances}
*/
export class DataHcsDmsKafkaInstances extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_dms_kafka_instances";
  ...
  * @param importFromId The id of the existing DataHcsDmsKafkaInstances that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/dms_kafka_instances#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_dms_kafka_instances", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/dms_kafka_instances hcs_dms_kafka_instances} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataHcsDmsKafkaInstancesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataHcsDmsKafkaInstancesConfig = {}) {
    super(scope, id, {
  ...
  private _instances = new DataHcsDmsKafkaInstancesInstancesList(this, "instances", false);
