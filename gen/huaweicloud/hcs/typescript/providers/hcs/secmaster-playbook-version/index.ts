// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version
...
export interface SecmasterPlaybookVersionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version#action_strategy SecmasterPlaybookVersion#action_strategy}
  */
  readonly actionStrategy?: string;
  /**
  * Specifies the data class ID of the playbook version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version#dataclass_id SecmasterPlaybookVersion#dataclass_id}
  */
  readonly dataclassId: string;
  /**
  * Specifies whether to trigger the playbook when data object is created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version#dataobject_create SecmasterPlaybookVersion#dataobject_create}
  */
  readonly dataobjectCreate?: boolean | cdktf.IResolvable;
  /**
  * Specifies whether to trigger the playbook when data object is deleted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version#dataobject_delete SecmasterPlaybookVersion#dataobject_delete}
  */
  readonly dataobjectDelete?: boolean | cdktf.IResolvable;
  /**
  * Specifies whether to trigger the playbook when data object is updated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version#dataobject_update SecmasterPlaybookVersion#dataobject_update}
  */
  readonly dataobjectUpdate?: boolean | cdktf.IResolvable;
  /**
  * Specifies the description of the playbook version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version#description SecmasterPlaybookVersion#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version#id SecmasterPlaybookVersion#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version#playbook_id SecmasterPlaybookVersion#playbook_id}
  */
  readonly playbookId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version#region SecmasterPlaybookVersion#region}
  */
  readonly region?: string;
  /**
  * Specifies whether to enable playbook rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version#rule_enable SecmasterPlaybookVersion#rule_enable}
  */
  readonly ruleEnable?: boolean | cdktf.IResolvable;
  /**
  * Specifies the playbook rule ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version#rule_id SecmasterPlaybookVersion#rule_id}
  */
  readonly ruleId?: string;
  /**
  * Specifies the trigger type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version#trigger_type SecmasterPlaybookVersion#trigger_type}
  */
  readonly triggerType?: string;
  /**
  * Specifies the ID of the workspace to which the playbook version belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version#workspace_id SecmasterPlaybookVersion#workspace_id}
  */
  readonly workspaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version hcs_secmaster_playbook_version}
*/
export class SecmasterPlaybookVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecmasterPlaybookVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook_version hcs_secmaster_playbook_version} Resource
  *
  * @param scope The scope in which to define this construct
