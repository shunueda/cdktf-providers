// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook
...
export interface SecmasterPlaybookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook#active_version_id SecmasterPlaybook#active_version_id}
  */
  readonly activeVersionId?: string;
  /**
  * Specifies the description of the playbook.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook#description SecmasterPlaybook#description}
  */
  readonly description?: string;
  /**
  * Specifies whether to enable the playbook.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook#enabled SecmasterPlaybook#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook#id SecmasterPlaybook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook#name SecmasterPlaybook#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook#region SecmasterPlaybook#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook#workspace_id SecmasterPlaybook#workspace_id}
  */
  readonly workspaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook hcs_secmaster_playbook}
*/
export class SecmasterPlaybook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecmasterPlaybook that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/secmaster_playbook hcs_secmaster_playbook} Resource
  *
  * @param scope The scope in which to define this construct
