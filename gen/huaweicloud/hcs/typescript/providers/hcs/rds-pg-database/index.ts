// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database
...
export interface RdsPgDatabaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#character_set RdsPgDatabase#character_set}
  */
  readonly characterSet?: string;
  /**
  * Specifies the database description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#description RdsPgDatabase#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#id RdsPgDatabase#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#instance_id RdsPgDatabase#instance_id}
  */
  readonly instanceId: string;
  /**
  * Specifies whether to revoke the PUBLIC CREATE permission of the public schema.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#is_revoke_public_privilege RdsPgDatabase#is_revoke_public_privilege}
  */
  readonly isRevokePublicPrivilege?: boolean | cdktf.IResolvable;
  /**
  * Specifies the database collocation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#lc_collate RdsPgDatabase#lc_collate}
  */
  readonly lcCollate?: string;
  /**
  * Specifies the database classification.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#lc_ctype RdsPgDatabase#lc_ctype}
  */
  readonly lcCtype?: string;
  /**
  * Specifies the database name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#name RdsPgDatabase#name}
  */
  readonly name: string;
  /**
  * Specifies the database user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#owner RdsPgDatabase#owner}
  */
  readonly owner?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#region RdsPgDatabase#region}
  */
  readonly region?: string;
  /**
  * Specifies the name of the database template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#template RdsPgDatabase#template}
  */
  readonly template?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#timeouts RdsPgDatabase#timeouts}
  */
  readonly timeouts?: RdsPgDatabaseTimeouts;
}
export interface RdsPgDatabaseTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#create RdsPgDatabase#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#delete RdsPgDatabase#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#update RdsPgDatabase#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database hcs_rds_pg_database}
*/
export class RdsPgDatabase extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_rds_pg_database";
  ...
  * @param importFromId The id of the existing RdsPgDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the RdsPgDatabase to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_rds_pg_database", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/rds_pg_database hcs_rds_pg_database} Resource
  *
  * @param scope The scope in which to define this construct
