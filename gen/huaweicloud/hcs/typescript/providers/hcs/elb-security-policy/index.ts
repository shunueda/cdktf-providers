// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/elb_security_policy
...
export interface ElbSecurityPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/elb_security_policy#ciphers ElbSecurityPolicy#ciphers}
  */
  readonly ciphers: string[];
  /**
  * Specifies the description of the ELB security policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/elb_security_policy#description ElbSecurityPolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/elb_security_policy#id ElbSecurityPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/elb_security_policy#name ElbSecurityPolicy#name}
  */
  readonly name?: string;
  /**
  * Specifies the TSL protocol list which the security policy select.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/elb_security_policy#protocols ElbSecurityPolicy#protocols}
  */
  readonly protocols: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/elb_security_policy#region ElbSecurityPolicy#region}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/elb_security_policy hcs_elb_security_policy}
*/
export class ElbSecurityPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElbSecurityPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/elb_security_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/elb_security_policy hcs_elb_security_policy} Resource
  *
  * @param scope The scope in which to define this construct
