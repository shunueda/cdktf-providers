// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source
...
export interface DwsExtDataSourceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#cluster_id DwsExtDataSource#cluster_id}
  */
  readonly clusterId: string;
  /**
  * The connection information of the external data source. It is mandatory when **type** is **OBS**.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#connect_info DwsExtDataSource#connect_info}
  */
  readonly connectInfo?: string;
  /**
  * ID of the external data source. It is mandatory when **type** is **MRS**.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#data_source_id DwsExtDataSource#data_source_id}
  */
  readonly dataSourceId?: string;
  /**
  * The description of the external data source.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#description DwsExtDataSource#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#id DwsExtDataSource#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#name DwsExtDataSource#name}
  */
  readonly name: string;
  /**
  * Whether to reboot the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#reboot DwsExtDataSource#reboot}
  */
  readonly reboot?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#region DwsExtDataSource#region}
  */
  readonly region?: string;
  /**
  * The type of the external data source.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#type DwsExtDataSource#type}
  */
  readonly type: string;
  /**
  * The user name of the external data source.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#user_name DwsExtDataSource#user_name}
  */
  readonly userName: string;
  /**
  * The password of the external data source. It is mandatory when **type** is **MRS**.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#user_pwd DwsExtDataSource#user_pwd}
  */
  readonly userPwd?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#timeouts DwsExtDataSource#timeouts}
  */
  readonly timeouts?: DwsExtDataSourceTimeouts;
}
export interface DwsExtDataSourceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#create DwsExtDataSource#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#delete DwsExtDataSource#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#update DwsExtDataSource#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source hcs_dws_ext_data_source}
*/
export class DwsExtDataSource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DwsExtDataSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/dws_ext_data_source hcs_dws_ext_data_source} Resource
  *
  * @param scope The scope in which to define this construct
