// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection
...
export interface WafRulePreciseProtectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#action WafRulePreciseProtection#action}
  */
  readonly action?: string;
  /**
  * Specifies the description of WAF precise protection rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#description WafRulePreciseProtection#description}
  */
  readonly description?: string;
  /**
  * Specifies the time when the precise protection rule expires.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#end_time WafRulePreciseProtection#end_time}
  */
  readonly endTime?: string;
  /**
  * Specifies the enterprise project ID of WAF precise protection rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#enterprise_project_id WafRulePreciseProtection#enterprise_project_id}
  */
  readonly enterpriseProjectId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#id WafRulePreciseProtection#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#known_attack_source_id WafRulePreciseProtection#known_attack_source_id}
  */
  readonly knownAttackSourceId?: string;
  /**
  * Specifies the name of WAF precise protection rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#name WafRulePreciseProtection#name}
  */
  readonly name: string;
  /**
  * Specifies the policy ID of WAF precise protection rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#policy_id WafRulePreciseProtection#policy_id}
  */
  readonly policyId: string;
  /**
  * Specifies the priority of a rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#priority WafRulePreciseProtection#priority}
  */
  readonly priority: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#region WafRulePreciseProtection#region}
  */
  readonly region?: string;
  /**
  * Specifies the time when the precise protection rule takes effect.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#start_time WafRulePreciseProtection#start_time}
  */
  readonly startTime?: string;
  /**
  * Specifies the status of WAF precise protection rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#status WafRulePreciseProtection#status}
  */
  readonly status?: number;
  /**
  * conditions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#conditions WafRulePreciseProtection#conditions}
  */
...
export interface WafRulePreciseProtectionConditions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#content WafRulePreciseProtection#content}
  */
  readonly content?: string;
  /**
  * Specifies the field of the condition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#field WafRulePreciseProtection#field}
  */
  readonly field: string;
  /**
  * Specifies the condition matching logic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#logic WafRulePreciseProtection#logic}
  */
  readonly logic: string;
  /**
  * Specifies the reference table id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#reference_table_id WafRulePreciseProtection#reference_table_id}
  */
  readonly referenceTableId?: string;
  /**
  * Specifies the subfield of the condition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#subfield WafRulePreciseProtection#subfield}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection hcs_waf_rule_precise_protection}
*/
export class WafRulePreciseProtection extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_waf_rule_precise_protection";
  ...
  * @param importFromId The id of the existing WafRulePreciseProtection that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_waf_rule_precise_protection", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/waf_rule_precise_protection hcs_waf_rule_precise_protection} Resource
  *
  * @param scope The scope in which to define this construct
