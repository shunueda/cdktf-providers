// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/as_groups
...
export interface DataHcsAsGroupsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/as_groups#enterprise_project_id DataHcsAsGroups#enterprise_project_id}
  */
  readonly enterpriseProjectId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/as_groups#id DataHcsAsGroups#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/as_groups#name DataHcsAsGroups#name}
  */
  readonly name?: string;
  /**
  * The region where the AS groups are located.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/as_groups#region DataHcsAsGroups#region}
  */
  readonly region?: string;
  /**
  * The AS group configuration id used to query group list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/as_groups#scaling_configuration_id DataHcsAsGroups#scaling_configuration_id}
  */
  readonly scalingConfigurationId?: string;
  /**
  * The AS group status used to query group list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/as_groups#status DataHcsAsGroups#status}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/as_groups hcs_as_groups}
*/
export class DataHcsAsGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataHcsAsGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/as_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/data-sources/as_groups hcs_as_groups} Data Source
  *
  * @param scope The scope in which to define this construct
