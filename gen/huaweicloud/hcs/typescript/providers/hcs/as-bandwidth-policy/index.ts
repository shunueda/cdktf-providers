// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy
...
export interface AsBandwidthPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#alarm_id AsBandwidthPolicy#alarm_id}
  */
  readonly alarmId?: string;
  /**
  * Specifies the scaling bandwidth ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#bandwidth_id AsBandwidthPolicy#bandwidth_id}
  */
  readonly bandwidthId: string;
  /**
  * Specifies the cooldown period (in seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#cool_down_time AsBandwidthPolicy#cool_down_time}
  */
  readonly coolDownTime?: number;
  /**
  * Specifies the description of the AS policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#description AsBandwidthPolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#id AsBandwidthPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#region AsBandwidthPolicy#region}
  */
  readonly region?: string;
  /**
  * Specifies the AS policy name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#scaling_policy_name AsBandwidthPolicy#scaling_policy_name}
  */
  readonly scalingPolicyName: string;
  /**
  * Specifies the AS policy type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#scaling_policy_type AsBandwidthPolicy#scaling_policy_type}
  */
  readonly scalingPolicyType: string;
  /**
  * scaling_policy_action block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#scaling_policy_action AsBandwidthPolicy#scaling_policy_action}
  */
  readonly scalingPolicyAction?: AsBandwidthPolicyScalingPolicyAction;
  /**
  * scheduled_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#scheduled_policy AsBandwidthPolicy#scheduled_policy}
  */
...
export interface AsBandwidthPolicyScalingPolicyAction {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#limits AsBandwidthPolicy#limits}
  */
  readonly limits?: number;
  /**
  * Specifies the operation to be performed. The default operation is ADD.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#operation AsBandwidthPolicy#operation}
  */
  readonly operation?: string;
  /**
  * Specifies the bandwidth (Mbit/s).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#size AsBandwidthPolicy#size}
  */
...
export interface AsBandwidthPolicyScheduledPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#end_time AsBandwidthPolicy#end_time}
  */
  readonly endTime?: string;
  /**
  * Specifies the time when the scaling action is triggered. The time format complies with UTC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#launch_time AsBandwidthPolicy#launch_time}
  */
  readonly launchTime: string;
  /**
  * Specifies the periodic triggering type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#recurrence_type AsBandwidthPolicy#recurrence_type}
  */
  readonly recurrenceType?: string;
  /**
  * Specifies the day when a periodic scaling action is triggered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#recurrence_value AsBandwidthPolicy#recurrence_value}
  */
  readonly recurrenceValue?: string;
  /**
  * Specifies the start time of the scaling action triggered periodically.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#start_time AsBandwidthPolicy#start_time}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy hcs_as_bandwidth_policy}
*/
export class AsBandwidthPolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_as_bandwidth_policy";
  ...
  * @param importFromId The id of the existing AsBandwidthPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AsBandwidthPolicy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_as_bandwidth_policy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/as_bandwidth_policy hcs_as_bandwidth_policy} Resource
  *
  * @param scope The scope in which to define this construct
