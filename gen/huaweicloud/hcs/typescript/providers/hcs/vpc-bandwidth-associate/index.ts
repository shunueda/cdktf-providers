// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_bandwidth_associate
...
export interface VpcBandwidthAssociateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_bandwidth_associate#bandwidth_id VpcBandwidthAssociate#bandwidth_id}
  */
  readonly bandwidthId: string;
  /**
  * The size (Mbits/s) after removal bandwidth.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_bandwidth_associate#bandwidth_size VpcBandwidthAssociate#bandwidth_size}
  */
  readonly bandwidthSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_bandwidth_associate#eip_id VpcBandwidthAssociate#eip_id}
  */
  readonly eipId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_bandwidth_associate#id VpcBandwidthAssociate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_bandwidth_associate#region VpcBandwidthAssociate#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_bandwidth_associate hcs_vpc_bandwidth_associate}
*/
export class VpcBandwidthAssociate extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_vpc_bandwidth_associate";
  ...
  * @param importFromId The id of the existing VpcBandwidthAssociate that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_bandwidth_associate#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_vpc_bandwidth_associate", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_bandwidth_associate hcs_vpc_bandwidth_associate} Resource
  *
  * @param scope The scope in which to define this construct
