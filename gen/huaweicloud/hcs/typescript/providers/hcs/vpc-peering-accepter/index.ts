// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_peering_accepter
...
export interface VpcPeeringAccepterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_peering_accepter#accept VpcPeeringAccepter#accept}
  */
  readonly accept?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_peering_accepter#id VpcPeeringAccepter#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_peering_accepter#region VpcPeeringAccepter#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_peering_accepter#vpc_peering_id VpcPeeringAccepter#vpc_peering_id}
  */
  readonly vpcPeeringId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_peering_accepter#timeouts VpcPeeringAccepter#timeouts}
  */
  readonly timeouts?: VpcPeeringAccepterTimeouts;
}
export interface VpcPeeringAccepterTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_peering_accepter#create VpcPeeringAccepter#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_peering_accepter#delete VpcPeeringAccepter#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_peering_accepter hcs_vpc_peering_accepter}
*/
export class VpcPeeringAccepter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcPeeringAccepter that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_peering_accepter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/vpc_peering_accepter hcs_vpc_peering_accepter} Resource
  *
  * @param scope The scope in which to define this construct
