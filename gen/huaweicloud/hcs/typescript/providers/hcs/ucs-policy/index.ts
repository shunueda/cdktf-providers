// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/ucs_policy
...
export interface UcsPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/ucs_policy#description UcsPolicy#description}
  */
  readonly description?: string;
  /**
  * Specifies the list of iam user IDs to associate to the policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/ucs_policy#iam_user_ids UcsPolicy#iam_user_ids}
  */
  readonly iamUserIds: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/ucs_policy#id UcsPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/ucs_policy#name UcsPolicy#name}
  */
  readonly name: string;
  /**
  * Specifies the type of the UCS policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/ucs_policy#type UcsPolicy#type}
  */
  readonly type: string;
  /**
  * details block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/ucs_policy#details UcsPolicy#details}
  */
...
export interface UcsPolicyDetails {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/ucs_policy#operations UcsPolicy#operations}
  */
  readonly operations?: string[];
  /**
  * Specifies the list of resources.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/ucs_policy#resources UcsPolicy#resources}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/ucs_policy hcs_ucs_policy}
*/
export class UcsPolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_ucs_policy";
  ...
  * @param importFromId The id of the existing UcsPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/ucs_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the UcsPolicy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_ucs_policy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.21/docs/resources/ucs_policy hcs_ucs_policy} Resource
  *
  * @param scope The scope in which to define this construct
