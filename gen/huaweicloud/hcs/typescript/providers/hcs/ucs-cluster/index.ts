// https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster
...
export interface UcsClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster#annotations UcsCluster#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * Specifies the category of the cloud.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster#category UcsCluster#category}
  */
  readonly category: string;
  /**
  * Specifies the city name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster#city UcsCluster#city}
  */
  readonly city?: string;
  /**
  * Specifies the cluster id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster#cluster_id UcsCluster#cluster_id}
  */
  readonly clusterId?: string;
  /**
  * Specifies the labels of the cluster to register.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster#cluster_labels UcsCluster#cluster_labels}
  */
  readonly clusterLabels?: { [key: string]: string };
  /**
  * Specifies the name of the cluster to register.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster#cluster_name UcsCluster#cluster_name}
  */
  readonly clusterName?: string;
  /**
  * Specifies the cluster project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster#cluster_project_id UcsCluster#cluster_project_id}
  */
  readonly clusterProjectId?: string;
  /**
  * Specifies the cluster region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster#cluster_region UcsCluster#cluster_region}
  */
  readonly clusterRegion?: string;
  /**
  * Specifies the cluster type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster#cluster_type UcsCluster#cluster_type}
  */
  readonly clusterType: string;
  /**
  * Specifies the country name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster#country UcsCluster#country}
  */
  readonly country?: string;
  /**
  * Specifies ID of the fleet to add the cluster into.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster#fleet_id UcsCluster#fleet_id}
  */
  readonly fleetId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster#id UcsCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster#service_provider UcsCluster#service_provider}
  */
  readonly serviceProvider?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster hcs_ucs_cluster}
*/
export class UcsCluster extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "hcs_ucs_cluster";
  ...
  * @param importFromId The id of the existing UcsCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the UcsCluster to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "hcs_ucs_cluster", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/huaweicloud/hcs/2.4.19/docs/resources/ucs_cluster hcs_ucs_cluster} Resource
  *
  * @param scope The scope in which to define this construct
