// https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/alert_attribute
...
export interface AlertAttributeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/alert_attribute#array AlertAttribute#array}
  */
  readonly array: boolean | cdktf.IResolvable;
  /**
  * Unique name of this attribute
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/alert_attribute#name AlertAttribute#name}
  */
  readonly name: string;
  /**
  * Whether this attribute is required. If this field is not set, the existing setting will be preserved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/alert_attribute#required AlertAttribute#required}
  */
  readonly required?: boolean | cdktf.IResolvable;
  /**
  * Engine resource name for this attribute
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/alert_attribute#type AlertAttribute#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/alert_attribute incident_alert_attribute}
*/
export class AlertAttribute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AlertAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/alert_attribute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/alert_attribute incident_alert_attribute} Resource
  *
  * @param scope The scope in which to define this construct
