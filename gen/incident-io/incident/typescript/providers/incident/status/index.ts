// https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/status
...
export interface StatusConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/status#category Status#category}
  */
  readonly category: string;
  /**
  * Rich text description of the incident status
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/status#description Status#description}
  */
  readonly description: string;
  /**
  * Unique name of this status
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/status#name Status#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/status incident_status}
*/
export class Status extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Status that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/status incident_status} Resource
  *
  * @param scope The scope in which to define this construct
