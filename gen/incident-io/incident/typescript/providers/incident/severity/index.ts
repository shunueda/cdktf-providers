// https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/severity
...
export interface SeverityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/severity#description Severity#description}
  */
  readonly description: string;
  /**
  * Human readable name of the severity
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/severity#name Severity#name}
  */
  readonly name: string;
  /**
  * Rank to help sort severities (lower numbers are less severe)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/severity#rank Severity#rank}
  */
  readonly rank?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/severity incident_severity}
*/
export class Severity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Severity that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/severity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/severity incident_severity} Resource
  *
  * @param scope The scope in which to define this construct
