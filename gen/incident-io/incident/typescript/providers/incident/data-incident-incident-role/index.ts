// https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/data-sources/incident_role
...
export interface DataIncidentIncidentRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/data-sources/incident_role#id DataIncidentIncidentRole#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/data-sources/incident_role incident_incident_role}
*/
export class DataIncidentIncidentRole extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIncidentIncidentRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/data-sources/incident_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/data-sources/incident_role incident_incident_role} Data Source
  *
  * @param scope The scope in which to define this construct
