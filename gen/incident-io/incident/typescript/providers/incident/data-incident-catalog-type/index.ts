// https://registry.terraform.io/providers/incident-io/incident/5.21.0/docs/data-sources/catalog_type
...
export interface DataIncidentCatalogTypeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.21.0/docs/data-sources/catalog_type#categories DataIncidentCatalogType#categories}
  */
  readonly categories?: string[];
  /**
  * Name is the human readable name of this type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.21.0/docs/data-sources/catalog_type#name DataIncidentCatalogType#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.21.0/docs/data-sources/catalog_type#type_name DataIncidentCatalogType#type_name}
  */
  readonly typeName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.21.0/docs/data-sources/catalog_type incident_catalog_type}
*/
export class DataIncidentCatalogType extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIncidentCatalogType that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.21.0/docs/data-sources/catalog_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.21.0/docs/data-sources/catalog_type incident_catalog_type} Data Source
  *
  * @param scope The scope in which to define this construct
