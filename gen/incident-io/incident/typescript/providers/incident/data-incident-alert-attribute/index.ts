// https://registry.terraform.io/providers/incident-io/incident/5.23.0/docs/data-sources/alert_attribute
...
export interface DataIncidentAlertAttributeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.23.0/docs/data-sources/alert_attribute#name DataIncidentAlertAttribute#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.23.0/docs/data-sources/alert_attribute incident_alert_attribute}
*/
export class DataIncidentAlertAttribute extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIncidentAlertAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.23.0/docs/data-sources/alert_attribute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.23.0/docs/data-sources/alert_attribute incident_alert_attribute} Data Source
  *
  * @param scope The scope in which to define this construct
