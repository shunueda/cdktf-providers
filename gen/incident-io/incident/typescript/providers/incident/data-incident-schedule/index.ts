// https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/data-sources/schedule
...
export interface DataIncidentScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/data-sources/schedule#id DataIncidentSchedule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/data-sources/schedule#name DataIncidentSchedule#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/data-sources/schedule incident_schedule}
*/
export class DataIncidentSchedule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIncidentSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/data-sources/schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/data-sources/schedule incident_schedule} Data Source
  *
  * @param scope The scope in which to define this construct
