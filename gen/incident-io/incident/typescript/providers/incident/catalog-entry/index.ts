// https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/catalog_entry
...
export interface CatalogEntryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/catalog_entry#aliases CatalogEntry#aliases}
  */
  readonly aliases?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/catalog_entry#attribute_values CatalogEntry#attribute_values}
  */
  readonly attributeValues: CatalogEntryAttributeValues[] | cdktf.IResolvable;
  /**
  * ID of this catalog type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/catalog_entry#catalog_type_id CatalogEntry#catalog_type_id}
  */
  readonly catalogTypeId: string;
  /**
  * An optional alternative ID for this entry, which is ensured to be unique for the type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/catalog_entry#external_id CatalogEntry#external_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/catalog_entry#managed_attributes CatalogEntry#managed_attributes}
  */
  readonly managedAttributes?: string[];
  /**
  * Name is the human readable name of this entry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/catalog_entry#name CatalogEntry#name}
  */
  readonly name: string;
  /**
  * When catalog type is ranked, this is used to help order things
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/catalog_entry#rank CatalogEntry#rank}
  */
...
export interface CatalogEntryAttributeValues {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/catalog_entry#array_value CatalogEntry#array_value}
  */
  readonly arrayValue?: string[];
  /**
  * The ID of this attribute, usually loaded from the incident_catalog_type_attribute resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/catalog_entry#attribute CatalogEntry#attribute}
  */
  readonly attribute: string;
  /**
  * The value of this attribute, in a format suitable for this attribute type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/catalog_entry#value CatalogEntry#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/catalog_entry incident_catalog_entry}
*/
export class CatalogEntry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CatalogEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/catalog_entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.24.1/docs/resources/catalog_entry incident_catalog_entry} Resource
  *
  * @param scope The scope in which to define this construct
