// https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/data-sources/catalog_entry
...
export interface DataIncidentCatalogEntryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/data-sources/catalog_entry#catalog_type_id DataIncidentCatalogEntry#catalog_type_id}
  */
  readonly catalogTypeId: string;
  /**
  * The identifier to use for finding the catalog entry. This can be a name, external ID, or alias.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/data-sources/catalog_entry#identifier DataIncidentCatalogEntry#identifier}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/data-sources/catalog_entry incident_catalog_entry}
*/
export class DataIncidentCatalogEntry extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIncidentCatalogEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/data-sources/catalog_entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/data-sources/catalog_entry incident_catalog_entry} Data Source
  *
  * @param scope The scope in which to define this construct
