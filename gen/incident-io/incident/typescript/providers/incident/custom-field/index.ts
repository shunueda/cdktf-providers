// https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/custom_field
...
export interface CustomFieldConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/custom_field#catalog_type_id CustomField#catalog_type_id}
  */
  readonly catalogTypeId?: string;
  /**
  * Description of the custom field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/custom_field#description CustomField#description}
  */
  readonly description: string;
  /**
  * Type of custom field. Possible values are: `single_select`, `multi_select`, `text`, `link`, `numeric`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/custom_field#field_type CustomField#field_type}
  */
  readonly fieldType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/custom_field#filter_by CustomField#filter_by}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/custom_field#group_by_catalog_attribute_id CustomField#group_by_catalog_attribute_id}
  */
  readonly groupByCatalogAttributeId?: string;
  /**
  * Which catalog attribute provides helptext for the options
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/custom_field#helptext_catalog_attribute_id CustomField#helptext_catalog_attribute_id}
  */
  readonly helptextCatalogAttributeId?: string;
  /**
  * Human readable name for the custom field
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/custom_field#name CustomField#name}
  */
...
export interface CustomFieldFilterBy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/custom_field#catalog_attribute_id CustomField#catalog_attribute_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/custom_field#custom_field_id CustomField#custom_field_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/custom_field incident_custom_field}
*/
export class CustomField extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomField that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/custom_field#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/custom_field incident_custom_field} Resource
  *
  * @param scope The scope in which to define this construct
