// https://registry.terraform.io/providers/incident-io/incident/5.23.0/docs/data-sources/custom_field
...
export interface DataIncidentCustomFieldConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.23.0/docs/data-sources/custom_field#name DataIncidentCustomField#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.23.0/docs/data-sources/custom_field incident_custom_field}
*/
export class DataIncidentCustomField extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIncidentCustomField that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.23.0/docs/data-sources/custom_field#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.23.0/docs/data-sources/custom_field incident_custom_field} Data Source
  *
  * @param scope The scope in which to define this construct
