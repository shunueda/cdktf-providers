// https://registry.terraform.io/providers/incident-io/incident/5.23.1/docs/data-sources/custom_field_option
...
export interface DataIncidentCustomFieldOptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.23.1/docs/data-sources/custom_field_option#custom_field_id DataIncidentCustomFieldOption#custom_field_id}
  */
  readonly customFieldId: string;
  /**
  * Sort key used to order the custom field options correctly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.23.1/docs/data-sources/custom_field_option#sort_key DataIncidentCustomFieldOption#sort_key}
  */
  readonly sortKey?: number;
  /**
  * Human readable name for the custom field option
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.23.1/docs/data-sources/custom_field_option#value DataIncidentCustomFieldOption#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.23.1/docs/data-sources/custom_field_option incident_custom_field_option}
*/
export class DataIncidentCustomFieldOption extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIncidentCustomFieldOption that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.23.1/docs/data-sources/custom_field_option#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.23.1/docs/data-sources/custom_field_option incident_custom_field_option} Data Source
  *
  * @param scope The scope in which to define this construct
