// https://registry.terraform.io/providers/incident-io/incident/5.18.0/docs/resources/incident_role
...
export interface IncidentRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.18.0/docs/resources/incident_role#description IncidentRole#description}
  */
  readonly description: string;
  /**
  * Provided to whoever is nominated for the role. Note that this will be empty for the 'reporter' role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.18.0/docs/resources/incident_role#instructions IncidentRole#instructions}
  */
  readonly instructions: string;
  /**
  * Human readable name of the incident role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.18.0/docs/resources/incident_role#name IncidentRole#name}
  */
  readonly name: string;
  /**
  * Short human readable name for Slack. Note that this will be empty for the 'reporter' role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.18.0/docs/resources/incident_role#shortform IncidentRole#shortform}
  */
  readonly shortform: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.18.0/docs/resources/incident_role incident_incident_role}
*/
export class IncidentRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IncidentRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.18.0/docs/resources/incident_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.18.0/docs/resources/incident_role incident_incident_role} Resource
  *
  * @param scope The scope in which to define this construct
