// https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/catalog_type
...
export interface CatalogTypeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/catalog_type#categories CatalogType#categories}
  */
  readonly categories?: string[];
  /**
  * Human readble description of this type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/catalog_type#description CatalogType#description}
  */
  readonly description: string;
  /**
  * Name is the human readable name of this type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/catalog_type#name CatalogType#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/catalog_type#source_repo_url CatalogType#source_repo_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/catalog_type#type_name CatalogType#type_name}
  */
  readonly typeName?: string;
  /**
  * If enabled, you can refer to entries of this type by their name, as well as their external ID and any aliases.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/catalog_type#use_name_as_identifier CatalogType#use_name_as_identifier}
  */
  readonly useNameAsIdentifier?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/catalog_type incident_catalog_type}
*/
export class CatalogType extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CatalogType that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/catalog_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.22.0/docs/resources/catalog_type incident_catalog_type} Resource
  *
  * @param scope The scope in which to define this construct
