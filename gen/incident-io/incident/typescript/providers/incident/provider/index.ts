// https://registry.terraform.io/providers/incident-io/incident/5.23.1/docs
...
export interface IncidentProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.23.1/docs#api_key IncidentProvider#api_key}
  */
  readonly apiKey?: string;
  /**
  * URL of the incident.io API
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.23.1/docs#endpoint IncidentProvider#endpoint}
  */
  readonly endpoint?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.23.1/docs#alias IncidentProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.23.1/docs incident}
*/
export class IncidentProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing IncidentProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.23.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.23.1/docs incident} Resource
  *
  * @param scope The scope in which to define this construct
