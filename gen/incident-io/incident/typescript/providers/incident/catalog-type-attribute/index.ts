// https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/catalog_type_attribute
...
export interface CatalogTypeAttributeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/catalog_type_attribute#array CatalogTypeAttribute#array}
  */
  readonly array?: boolean | cdktf.IResolvable;
  /**
  * If this is a backlink, the id of the attribute that it's linked from
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/catalog_type_attribute#backlink_attribute CatalogTypeAttribute#backlink_attribute}
  */
  readonly backlinkAttribute?: string;
  /**
  * ID of this catalog type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/catalog_type_attribute#catalog_type_id CatalogTypeAttribute#catalog_type_id}
  */
  readonly catalogTypeId: string;
  /**
  * The name of this attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/catalog_type_attribute#name CatalogTypeAttribute#name}
  */
  readonly name: string;
  /**
  * If this is a path attribute, the path that we should use to pull the data
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/catalog_type_attribute#path CatalogTypeAttribute#path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/catalog_type_attribute#schema_only CatalogTypeAttribute#schema_only}
  */
  readonly schemaOnly?: boolean | cdktf.IResolvable;
  /**
  * The type of this attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/catalog_type_attribute#type CatalogTypeAttribute#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/catalog_type_attribute incident_catalog_type_attribute}
*/
export class CatalogTypeAttribute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CatalogTypeAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/catalog_type_attribute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/incident-io/incident/5.19.0/docs/resources/catalog_type_attribute incident_catalog_type_attribute} Resource
  *
  * @param scope The scope in which to define this construct
