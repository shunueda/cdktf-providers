// https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/git_repository_branch
...
export interface GitRepositoryBranchConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/git_repository_branch#id GitRepositoryBranch#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/git_repository_branch#name GitRepositoryBranch#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/git_repository_branch#ref_branch GitRepositoryBranch#ref_branch}
  */
  readonly refBranch?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/git_repository_branch#ref_commit_id GitRepositoryBranch#ref_commit_id}
  */
  readonly refCommitId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/git_repository_branch#ref_tag GitRepositoryBranch#ref_tag}
  */
  readonly refTag?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/git_repository_branch#repository_id GitRepositoryBranch#repository_id}
  */
  readonly repositoryId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/git_repository_branch#timeouts GitRepositoryBranch#timeouts}
  */
  readonly timeouts?: GitRepositoryBranchTimeouts;
}
export interface GitRepositoryBranchTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/git_repository_branch#create GitRepositoryBranch#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/git_repository_branch#delete GitRepositoryBranch#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/git_repository_branch#read GitRepositoryBranch#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/git_repository_branch azuredevops_git_repository_branch}
*/
export class GitRepositoryBranch extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GitRepositoryBranch that should be imported. Refer to the {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/git_repository_branch#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/git_repository_branch azuredevops_git_repository_branch} Resource
  *
  * @param scope The scope in which to define this construct
