// https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings
...
export interface ProjectPipelineSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings#enforce_job_scope ProjectPipelineSettings#enforce_job_scope}
  */
  readonly enforceJobScope?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings#enforce_job_scope_for_release ProjectPipelineSettings#enforce_job_scope_for_release}
  */
  readonly enforceJobScopeForRelease?: boolean | cdktf.IResolvable;
  /**
  * Protect access to repositories in YAML pipelines
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings#enforce_referenced_repo_scoped_token ProjectPipelineSettings#enforce_referenced_repo_scoped_token}
  */
  readonly enforceReferencedRepoScopedToken?: boolean | cdktf.IResolvable;
  /**
  * Limit variables that can be set at queue time
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings#enforce_settable_var ProjectPipelineSettings#enforce_settable_var}
  */
  readonly enforceSettableVar?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings#id ProjectPipelineSettings#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings#project_id ProjectPipelineSettings#project_id}
  */
  readonly projectId: string;
  /**
  * Publish metadata from pipelines
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings#publish_pipeline_metadata ProjectPipelineSettings#publish_pipeline_metadata}
  */
  readonly publishPipelineMetadata?: boolean | cdktf.IResolvable;
  /**
  * Disable anonymous access to badges
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings#status_badges_are_private ProjectPipelineSettings#status_badges_are_private}
  */
  readonly statusBadgesArePrivate?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings#timeouts ProjectPipelineSettings#timeouts}
  */
  readonly timeouts?: ProjectPipelineSettingsTimeouts;
}
export interface ProjectPipelineSettingsTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings#create ProjectPipelineSettings#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings#delete ProjectPipelineSettings#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings#read ProjectPipelineSettings#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings#update ProjectPipelineSettings#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings azuredevops_project_pipeline_settings}
*/
export class ProjectPipelineSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectPipelineSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.11.2/docs/resources/project_pipeline_settings azuredevops_project_pipeline_settings} Resource
  *
  * @param scope The scope in which to define this construct
