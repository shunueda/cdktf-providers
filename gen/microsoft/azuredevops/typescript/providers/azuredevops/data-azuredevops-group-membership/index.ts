// https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/group_membership
...
export interface DataAzuredevopsGroupMembershipConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/group_membership#group_descriptor DataAzuredevopsGroupMembership#group_descriptor}
  */
  readonly groupDescriptor: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/group_membership#id DataAzuredevopsGroupMembership#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/group_membership#timeouts DataAzuredevopsGroupMembership#timeouts}
  */
  readonly timeouts?: DataAzuredevopsGroupMembershipTimeouts;
}
export interface DataAzuredevopsGroupMembershipTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/group_membership#read DataAzuredevopsGroupMembership#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/group_membership azuredevops_group_membership}
*/
export class DataAzuredevopsGroupMembership extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzuredevopsGroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/group_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/group_membership azuredevops_group_membership} Data Source
  *
  * @param scope The scope in which to define this construct
