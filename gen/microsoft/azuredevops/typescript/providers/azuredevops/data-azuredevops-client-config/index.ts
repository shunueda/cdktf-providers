// https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/client_config
...
export interface DataAzuredevopsClientConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/client_config#id DataAzuredevopsClientConfig#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/client_config#timeouts DataAzuredevopsClientConfig#timeouts}
  */
  readonly timeouts?: DataAzuredevopsClientConfigTimeouts;
}
export interface DataAzuredevopsClientConfigTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/client_config#read DataAzuredevopsClientConfig#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/client_config azuredevops_client_config}
*/
export class DataAzuredevopsClientConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzuredevopsClientConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/client_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.2/docs/data-sources/client_config azuredevops_client_config} Data Source
  *
  * @param scope The scope in which to define this construct
