// https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/data-sources/serviceendpoint_npm
...
export interface DataAzuredevopsServiceendpointNpmConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/data-sources/serviceendpoint_npm#id DataAzuredevopsServiceendpointNpm#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/data-sources/serviceendpoint_npm#project_id DataAzuredevopsServiceendpointNpm#project_id}
  */
  readonly projectId: string;
  /**
  * The ID of the serviceendpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/data-sources/serviceendpoint_npm#service_endpoint_id DataAzuredevopsServiceendpointNpm#service_endpoint_id}
  */
  readonly serviceEndpointId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/data-sources/serviceendpoint_npm#service_endpoint_name DataAzuredevopsServiceendpointNpm#service_endpoint_name}
  */
  readonly serviceEndpointName?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/data-sources/serviceendpoint_npm#timeouts DataAzuredevopsServiceendpointNpm#timeouts}
  */
  readonly timeouts?: DataAzuredevopsServiceendpointNpmTimeouts;
}
export interface DataAzuredevopsServiceendpointNpmTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/data-sources/serviceendpoint_npm#read DataAzuredevopsServiceendpointNpm#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/data-sources/serviceendpoint_npm azuredevops_serviceendpoint_npm}
*/
export class DataAzuredevopsServiceendpointNpm extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzuredevopsServiceendpointNpm that should be imported. Refer to the {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/data-sources/serviceendpoint_npm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/data-sources/serviceendpoint_npm azuredevops_serviceendpoint_npm} Data Source
  *
  * @param scope The scope in which to define this construct
