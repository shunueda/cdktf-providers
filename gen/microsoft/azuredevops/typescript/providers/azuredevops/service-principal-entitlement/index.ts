// https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/service_principal_entitlement
...
export interface ServicePrincipalEntitlementConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/service_principal_entitlement#account_license_type ServicePrincipalEntitlement#account_license_type}
  */
  readonly accountLicenseType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/service_principal_entitlement#id ServicePrincipalEntitlement#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/service_principal_entitlement#licensing_source ServicePrincipalEntitlement#licensing_source}
  */
  readonly licensingSource?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/service_principal_entitlement#origin ServicePrincipalEntitlement#origin}
  */
  readonly origin?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/service_principal_entitlement#origin_id ServicePrincipalEntitlement#origin_id}
  */
  readonly originId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/service_principal_entitlement#timeouts ServicePrincipalEntitlement#timeouts}
  */
  readonly timeouts?: ServicePrincipalEntitlementTimeouts;
}
export interface ServicePrincipalEntitlementTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/service_principal_entitlement#create ServicePrincipalEntitlement#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/service_principal_entitlement#delete ServicePrincipalEntitlement#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/service_principal_entitlement#read ServicePrincipalEntitlement#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/service_principal_entitlement#update ServicePrincipalEntitlement#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/service_principal_entitlement azuredevops_service_principal_entitlement}
*/
export class ServicePrincipalEntitlement extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicePrincipalEntitlement that should be imported. Refer to the {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/service_principal_entitlement#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/microsoft/azuredevops/1.12.1/docs/resources/service_principal_entitlement azuredevops_service_principal_entitlement} Resource
  *
  * @param scope The scope in which to define this construct
