// https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream
...
export interface EventstreamConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#definition Eventstream#definition}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#definition_update_enabled Eventstream#definition_update_enabled}
  */
  readonly definitionUpdateEnabled?: boolean | cdktf.IResolvable;
  /**
  * The Eventstream description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#description Eventstream#description}
  */
  readonly description?: string;
  /**
  * The Eventstream display name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#display_name Eventstream#display_name}
  */
  readonly displayName: string;
  /**
  * The Folder ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#folder_id Eventstream#folder_id}
  */
  readonly folderId?: string;
  /**
  * The Eventstream format. Possible values: `Default`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#format Eventstream#format}
  */
  readonly format?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#timeouts Eventstream#timeouts}
  */
  readonly timeouts?: EventstreamTimeouts;
  /**
  * The Workspace ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#workspace_id Eventstream#workspace_id}
  */
  readonly workspaceId: string;
}
export interface EventstreamDefinitionParameters {
  /**
  * The find value of the parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#find Eventstream#find}
  */
  readonly find: string;
  /**
  * Processing type of the parameters. Possible values: `JsonPathReplace`, `TextReplace`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#type Eventstream#type}
  */
  readonly type: string;
  /**
  * The value of the parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#value Eventstream#value}
  */
  readonly value: string;
}

export function eventstreamDefinitionParametersToTerraform(struct?: EventstreamDefinitionParameters | cdktf.IResolvable): any {
...
export function eventstreamDefinitionParametersToHclTerraform(struct?: EventstreamDefinitionParameters | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class EventstreamDefinitionParametersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EventstreamDefinitionParameters | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: EventstreamDefinitionParameters | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class EventstreamDefinitionParametersList extends cdktf.ComplexList {
  public internalValue? : EventstreamDefinitionParameters[] | cdktf.IResolvable
  ...
  */
  public get(index: number): EventstreamDefinitionParametersOutputReference {
    return new EventstreamDefinitionParametersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface EventstreamDefinition {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#parameters Eventstream#parameters}
  */
  readonly parameters?: EventstreamDefinitionParameters[] | cdktf.IResolvable;
  /**
  * Processing mode of the tokens/parameters. Possible values: `GoTemplate`, `None`, `Parameters`. Default `GoTemplate`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#processing_mode Eventstream#processing_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#source Eventstream#source}
  */
  readonly source: string;
  /**
  * A map of key/value pairs of tokens substitutes in the source.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#tokens Eventstream#tokens}
  */
  readonly tokens?: { [key: string]: string };
  /**
  * The delimiter for the tokens in the source content. Possible values: `<<>>`, `@{}@`, `____`, `{{}}`. Default: `{{}}`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#tokens_delimiter Eventstream#tokens_delimiter}
  */
...
export function eventstreamDefinitionToTerraform(struct?: EventstreamDefinition | cdktf.IResolvable): any {
  ...
  return {
    parameters: cdktf.listMapper(eventstreamDefinitionParametersToTerraform, false)(struct!.parameters),
...
export function eventstreamDefinitionToHclTerraform(struct?: EventstreamDefinition | cdktf.IResolvable): any {
  ...
  const attrs = {
    parameters: {
      value: cdktf.listMapperHcl(eventstreamDefinitionParametersToHclTerraform, false)(struct!.parameters),
      isBlock: true,
      type: "set",
      storageClassType: "EventstreamDefinitionParametersList",
    },
    processing_mode: {
...
export class EventstreamDefinitionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _parameters = new EventstreamDefinitionParametersList(this, "parameters", true);
  public get parameters() {
    return this._parameters;
  }
  public putParameters(value: EventstreamDefinitionParameters[] | cdktf.IResolvable) {
...
export interface EventstreamTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#create Eventstream#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#delete Eventstream#delete}
  */
  readonly delete?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Read operations occur during any refresh or planning operation when refresh is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#read Eventstream#read}
  */
  readonly read?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#update Eventstream#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream fabric_eventstream}
*/
export class Eventstream extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Eventstream that should be imported. Refer to the {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/eventstream fabric_eventstream} Resource
  *
  * @param scope The scope in which to define this construct
