// https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory
...
export interface MountedDataFactoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#definition MountedDataFactory#definition}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#definition_update_enabled MountedDataFactory#definition_update_enabled}
  */
  readonly definitionUpdateEnabled?: boolean | cdktf.IResolvable;
  /**
  * The Mounted Data Factory description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#description MountedDataFactory#description}
  */
  readonly description?: string;
  /**
  * The Mounted Data Factory display name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#display_name MountedDataFactory#display_name}
  */
  readonly displayName: string;
  /**
  * The Folder ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#folder_id MountedDataFactory#folder_id}
  */
  readonly folderId?: string;
  /**
  * The Mounted Data Factory format. Possible values: `Default`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#format MountedDataFactory#format}
  */
  readonly format: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#timeouts MountedDataFactory#timeouts}
  */
  readonly timeouts?: MountedDataFactoryTimeouts;
  /**
  * The Workspace ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#workspace_id MountedDataFactory#workspace_id}
  */
  readonly workspaceId: string;
}
export interface MountedDataFactoryDefinitionParameters {
  /**
  * The find value of the parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#find MountedDataFactory#find}
  */
  readonly find: string;
  /**
  * Processing type of the parameters. Possible values: `JsonPathReplace`, `TextReplace`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#type MountedDataFactory#type}
  */
  readonly type: string;
  /**
  * The value of the parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#value MountedDataFactory#value}
  */
  readonly value: string;
}

export function mountedDataFactoryDefinitionParametersToTerraform(struct?: MountedDataFactoryDefinitionParameters | cdktf.IResolvable): any {
...
export function mountedDataFactoryDefinitionParametersToHclTerraform(struct?: MountedDataFactoryDefinitionParameters | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class MountedDataFactoryDefinitionParametersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MountedDataFactoryDefinitionParameters | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: MountedDataFactoryDefinitionParameters | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class MountedDataFactoryDefinitionParametersList extends cdktf.ComplexList {
  public internalValue? : MountedDataFactoryDefinitionParameters[] | cdktf.IResolvable
  ...
  */
  public get(index: number): MountedDataFactoryDefinitionParametersOutputReference {
    return new MountedDataFactoryDefinitionParametersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface MountedDataFactoryDefinition {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#parameters MountedDataFactory#parameters}
  */
  readonly parameters?: MountedDataFactoryDefinitionParameters[] | cdktf.IResolvable;
  /**
  * Processing mode of the tokens/parameters. Possible values: `GoTemplate`, `None`, `Parameters`. Default `GoTemplate`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#processing_mode MountedDataFactory#processing_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#source MountedDataFactory#source}
  */
  readonly source: string;
  /**
  * A map of key/value pairs of tokens substitutes in the source.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#tokens MountedDataFactory#tokens}
  */
  readonly tokens?: { [key: string]: string };
  /**
  * The delimiter for the tokens in the source content. Possible values: `<<>>`, `@{}@`, `____`, `{{}}`. Default: `{{}}`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#tokens_delimiter MountedDataFactory#tokens_delimiter}
  */
...
export function mountedDataFactoryDefinitionToTerraform(struct?: MountedDataFactoryDefinition | cdktf.IResolvable): any {
  ...
  return {
    parameters: cdktf.listMapper(mountedDataFactoryDefinitionParametersToTerraform, false)(struct!.parameters),
...
export function mountedDataFactoryDefinitionToHclTerraform(struct?: MountedDataFactoryDefinition | cdktf.IResolvable): any {
  ...
  const attrs = {
    parameters: {
      value: cdktf.listMapperHcl(mountedDataFactoryDefinitionParametersToHclTerraform, false)(struct!.parameters),
      isBlock: true,
      type: "set",
      storageClassType: "MountedDataFactoryDefinitionParametersList",
    },
    processing_mode: {
...
export class MountedDataFactoryDefinitionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _parameters = new MountedDataFactoryDefinitionParametersList(this, "parameters", true);
  public get parameters() {
    return this._parameters;
  }
  public putParameters(value: MountedDataFactoryDefinitionParameters[] | cdktf.IResolvable) {
...
export interface MountedDataFactoryTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#create MountedDataFactory#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#delete MountedDataFactory#delete}
  */
  readonly delete?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Read operations occur during any refresh or planning operation when refresh is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#read MountedDataFactory#read}
  */
  readonly read?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#update MountedDataFactory#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory fabric_mounted_data_factory}
*/
export class MountedDataFactory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MountedDataFactory that should be imported. Refer to the {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/microsoft/fabric/1.7.0/docs/resources/mounted_data_factory fabric_mounted_data_factory} Resource
  *
  * @param scope The scope in which to define this construct
