...
export interface DomainWorkspaceAssignmentsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DomainWorkspaceAssignmentsTimeouts {
  /**
...
export function domainWorkspaceAssignmentsTimeoutsToTerraform(struct?: DomainWorkspaceAssignmentsTimeouts | cdktf.IResolvable): any {
...
export function domainWorkspaceAssignmentsTimeoutsToHclTerraform(struct?: DomainWorkspaceAssignmentsTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DomainWorkspaceAssignmentsTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DomainWorkspaceAssignmentsTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DomainWorkspaceAssignmentsTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DomainWorkspaceAssignments extends cdktf.TerraformResource {
  ...
  * @param options DomainWorkspaceAssignmentsConfig
  */
  public constructor(scope: Construct, id: string, config: DomainWorkspaceAssignmentsConfig) {
    super(scope, id, {
  ...
  private _timeouts = new DomainWorkspaceAssignmentsTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DomainWorkspaceAssignmentsTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: domainWorkspaceAssignmentsTimeoutsToTerraform(this._timeouts.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: domainWorkspaceAssignmentsTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DomainWorkspaceAssignmentsTimeouts",
      },
      workspace_ids: {
