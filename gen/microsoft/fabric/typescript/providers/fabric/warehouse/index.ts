...
export interface WarehouseConfig extends cdktf.TerraformMetaArguments {
  /**
  * The Warehouse creation configuration.
  * 
...
export function warehouseConfigurationToTerraform(struct?: WarehouseConfiguration | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    collation_type: cdktf.stringToTerraform(struct!.collationType),
  }
}


export function warehouseConfigurationToHclTerraform(struct?: WarehouseConfiguration | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    collation_type: {
      value: cdktf.stringToHclTerraform(struct!.collationType),
      isBlock: false,
      type: "simple",
...
export class WarehouseConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): WarehouseConfiguration | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._collationType !== undefined) {
      hasAnyValues = true;
      internalValueResult.collationType = this._collationType;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: WarehouseConfiguration | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._collationType = undefined;
    }
      ...
      this.resolvableValue = undefined;
      this._collationType = value.collationType;
    }
  }

  // collation_type - computed: false, optional: false, required: true
  private _collationType?: string; 
  public get collationType() {
    return this.getStringAttribute('collation_type');
  }
  public set collationType(value: string) {
    this._collationType = value;
  }
  // Temporarily expose input value. Use with caution.
  public get collationTypeInput() {
    return this._collationType;
  }
}
export interface WarehouseProperties {
}

export function warehousePropertiesToTerraform(struct?: WarehouseProperties): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function warehousePropertiesToHclTerraform(struct?: WarehouseProperties): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class WarehousePropertiesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): WarehouseProperties | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: WarehouseProperties | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class Warehouse extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fabric_warehouse";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fabric_warehouse", importId: importFromId, provider });
      }
  ...
  */
  ...
  private _configuration = new WarehouseConfigurationOutputReference(this, "configuration");
  public get configuration() {
    return this._configuration;
  }
  public putConfiguration(value: WarehouseConfiguration) {
  ...
  private _properties = new WarehousePropertiesOutputReference(this, "properties");
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      configuration: {
        value: warehouseConfigurationToHclTerraform(this._configuration.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "WarehouseConfiguration",
      },
      description: {
