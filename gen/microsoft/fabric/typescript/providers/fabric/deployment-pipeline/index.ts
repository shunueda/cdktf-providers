...
export interface DeploymentPipelineStages {
  /**
...
export function deploymentPipelineStagesToTerraform(struct?: DeploymentPipelineStages | cdktf.IResolvable): any {
...
export function deploymentPipelineStagesToHclTerraform(struct?: DeploymentPipelineStages | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DeploymentPipelineStagesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DeploymentPipelineStages | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DeploymentPipelineStages | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DeploymentPipelineStagesList extends cdktf.ComplexList {
  public internalValue? : DeploymentPipelineStages[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DeploymentPipelineStagesOutputReference {
    return new DeploymentPipelineStagesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DeploymentPipeline extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "fabric_deployment_pipeline";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "fabric_deployment_pipeline", importId: importFromId, provider });
      }
  ...
  */
  ...
  private _stages = new DeploymentPipelineStagesList(this, "stages", false);
  public get stages() {
    return this._stages;
  }
  public putStages(value: DeploymentPipelineStages[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      stages: cdktf.listMapper(deploymentPipelineStagesToTerraform, false)(this._stages.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      stages: {
        value: cdktf.listMapperHcl(deploymentPipelineStagesToHclTerraform, false)(this._stages.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DeploymentPipelineStagesList",
      },
      timeouts: {
