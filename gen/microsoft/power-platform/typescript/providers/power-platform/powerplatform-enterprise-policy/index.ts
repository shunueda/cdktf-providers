...
export interface PowerplatformEnterprisePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Environment id
  *
...
export interface PowerplatformEnterprisePolicyTimeouts {
  /**
...
export function powerplatformEnterprisePolicyTimeoutsToTerraform(struct?: PowerplatformEnterprisePolicyTimeouts | cdktf.IResolvable): any {
...
export function powerplatformEnterprisePolicyTimeoutsToHclTerraform(struct?: PowerplatformEnterprisePolicyTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PowerplatformEnterprisePolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PowerplatformEnterprisePolicyTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: PowerplatformEnterprisePolicyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class PowerplatformEnterprisePolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "powerplatform_enterprise_policy";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "powerplatform_enterprise_policy", importId: importFromId, provider });
      }
  ...
  * @param options PowerplatformEnterprisePolicyConfig
  */
  public constructor(scope: Construct, id: string, config: PowerplatformEnterprisePolicyConfig) {
    super(scope, id, {
  ...
  private _timeouts = new PowerplatformEnterprisePolicyTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: PowerplatformEnterprisePolicyTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: powerplatformEnterprisePolicyTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: powerplatformEnterprisePolicyTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "PowerplatformEnterprisePolicyTimeouts",
      },
    };
