...
export interface PowerplatformAdminManagementApplicationConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface PowerplatformAdminManagementApplicationTimeouts {
  /**
...
export function powerplatformAdminManagementApplicationTimeoutsToTerraform(struct?: PowerplatformAdminManagementApplicationTimeouts | cdktf.IResolvable): any {
...
export function powerplatformAdminManagementApplicationTimeoutsToHclTerraform(struct?: PowerplatformAdminManagementApplicationTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PowerplatformAdminManagementApplicationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PowerplatformAdminManagementApplicationTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: PowerplatformAdminManagementApplicationTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class PowerplatformAdminManagementApplication extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "powerplatform_admin_management_application";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "powerplatform_admin_management_application", importId: importFromId, provider });
      }
  ...
  * @param options PowerplatformAdminManagementApplicationConfig
  */
  public constructor(scope: Construct, id: string, config: PowerplatformAdminManagementApplicationConfig) {
    super(scope, id, {
  ...
  private _timeouts = new PowerplatformAdminManagementApplicationTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: PowerplatformAdminManagementApplicationTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: powerplatformAdminManagementApplicationTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: powerplatformAdminManagementApplicationTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "PowerplatformAdminManagementApplicationTimeouts",
      },
    };
