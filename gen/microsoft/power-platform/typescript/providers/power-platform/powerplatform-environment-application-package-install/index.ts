...
export interface PowerplatformEnvironmentApplicationPackageInstallConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface PowerplatformEnvironmentApplicationPackageInstallTimeouts {
  /**
...
export function powerplatformEnvironmentApplicationPackageInstallTimeoutsToTerraform(struct?: PowerplatformEnvironmentApplicationPackageInstallTimeouts | cdktf.IResolvable): any {
...
export function powerplatformEnvironmentApplicationPackageInstallTimeoutsToHclTerraform(struct?: PowerplatformEnvironmentApplicationPackageInstallTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PowerplatformEnvironmentApplicationPackageInstallTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PowerplatformEnvironmentApplicationPackageInstallTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: PowerplatformEnvironmentApplicationPackageInstallTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class PowerplatformEnvironmentApplicationPackageInstall extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "powerplatform_environment_application_package_install";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "powerplatform_environment_application_package_install", importId: importFromId, provider });
      }
  ...
  * @param options PowerplatformEnvironmentApplicationPackageInstallConfig
  */
  public constructor(scope: Construct, id: string, config: PowerplatformEnvironmentApplicationPackageInstallConfig) {
    super(scope, id, {
  ...
  private _timeouts = new PowerplatformEnvironmentApplicationPackageInstallTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: PowerplatformEnvironmentApplicationPackageInstallTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: powerplatformEnvironmentApplicationPackageInstallTimeoutsToTerraform(this._timeouts.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: powerplatformEnvironmentApplicationPackageInstallTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "PowerplatformEnvironmentApplicationPackageInstallTimeouts",
      },
      unique_name: {
