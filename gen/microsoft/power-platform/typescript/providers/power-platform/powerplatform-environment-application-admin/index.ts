...
export interface PowerplatformEnvironmentApplicationAdminConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface PowerplatformEnvironmentApplicationAdminTimeouts {
  /**
...
export function powerplatformEnvironmentApplicationAdminTimeoutsToTerraform(struct?: PowerplatformEnvironmentApplicationAdminTimeouts | cdktf.IResolvable): any {
...
export function powerplatformEnvironmentApplicationAdminTimeoutsToHclTerraform(struct?: PowerplatformEnvironmentApplicationAdminTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class PowerplatformEnvironmentApplicationAdminTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PowerplatformEnvironmentApplicationAdminTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: PowerplatformEnvironmentApplicationAdminTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class PowerplatformEnvironmentApplicationAdmin extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "powerplatform_environment_application_admin";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "powerplatform_environment_application_admin", importId: importFromId, provider });
      }
  ...
  * @param options PowerplatformEnvironmentApplicationAdminConfig
  */
  public constructor(scope: Construct, id: string, config: PowerplatformEnvironmentApplicationAdminConfig) {
    super(scope, id, {
  ...
  private _timeouts = new PowerplatformEnvironmentApplicationAdminTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: PowerplatformEnvironmentApplicationAdminTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: powerplatformEnvironmentApplicationAdminTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: powerplatformEnvironmentApplicationAdminTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "PowerplatformEnvironmentApplicationAdminTimeouts",
      },
    };
