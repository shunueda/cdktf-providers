// https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs
...
export interface VyProviderConfig {
  /**
  * The base url for the central-cognito service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs#central_cognito_base_url VyProvider#central_cognito_base_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs#deployment_service_environment VyProvider#deployment_service_environment}
  */
  readonly deploymentServiceEnvironment?: string;
  /**
  * The base url for the deployment enrollment service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs#enroll_account_base_url VyProvider#enroll_account_base_url}
  */
  readonly enrollAccountBaseUrl?: string;
  /**
  * The environment to provision in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs#environment VyProvider#environment}
  */
  readonly environment: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs#alias VyProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs vy}
*/
export class VyProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing VyProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs vy} Resource
  *
  * @param scope The scope in which to define this construct
