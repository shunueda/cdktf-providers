// https://registry.terraform.io/providers/nsbno/vy/1.1.0/docs/resources/deployment_account
...
export interface DeploymentAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nsbno/vy/1.1.0/docs/resources/deployment_account#slack_channel DeploymentAccount#slack_channel}
  */
  readonly slackChannel: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nsbno/vy/1.1.0/docs/resources/deployment_account vy_deployment_account}
*/
export class DeploymentAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeploymentAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/nsbno/vy/1.1.0/docs/resources/deployment_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nsbno/vy/1.1.0/docs/resources/deployment_account vy_deployment_account} Resource
  *
  * @param scope The scope in which to define this construct
