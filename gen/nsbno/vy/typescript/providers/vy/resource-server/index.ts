// https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/resources/resource_server
...
export interface ResourceServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/resources/resource_server#identifier ResourceServer#identifier}
  */
  readonly identifier: string;
  /**
  * The name of this resource server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/resources/resource_server#name ResourceServer#name}
  */
  readonly name: string;
  /**
  * Scopes for this resource server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/resources/resource_server#scopes ResourceServer#scopes}
  */
...
export interface ResourceServerScopes {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/resources/resource_server#description ResourceServer#description}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/resources/resource_server vy_resource_server}
*/
export class ResourceServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourceServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/resources/resource_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/resources/resource_server vy_resource_server} Resource
  *
  * @param scope The scope in which to define this construct
