// https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/data-sources/artifact_version
...
export interface DataVyArtifactVersionConfig extends cdktf.TerraformMetaArguments {
  /**
  * The application you want to find an artifact for
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/data-sources/artifact_version#application DataVyArtifactVersion#application}
  */
  readonly application: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/data-sources/artifact_version vy_artifact_version}
*/
export class DataVyArtifactVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVyArtifactVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/data-sources/artifact_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/data-sources/artifact_version vy_artifact_version} Data Source
  *
  * @param scope The scope in which to define this construct
