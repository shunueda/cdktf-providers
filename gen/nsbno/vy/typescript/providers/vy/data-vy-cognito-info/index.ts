// https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/data-sources/cognito_info
...
/**
* Represents a {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/data-sources/cognito_info vy_cognito_info}
*/
export class DataVyCognitoInfo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVyCognitoInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/data-sources/cognito_info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nsbno/vy/0.5.0/docs/data-sources/cognito_info vy_cognito_info} Data Source
  *
  * @param scope The scope in which to define this construct
