// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule
...
export interface LbL7RuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule#admin_state_up LbL7Rule#admin_state_up}
  */
  readonly adminStateUp?: boolean | cdktf.IResolvable;
  /**
  * The comparison type for the L7 rule - can either be CONTAINS, STARTS\_WITH, ENDS_WITH, EQUAL_TO or REGEX
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule#compare_type LbL7Rule#compare_type}
  */
  readonly compareType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule#id LbL7Rule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule#invert LbL7Rule#invert}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule#key LbL7Rule#key}
  */
  readonly key?: string;
  /**
  * The ID of the L7 Policy to query. Changing this creates a new L7 Rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule#l7policy_id LbL7Rule#l7policy_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule#region LbL7Rule#region}
  */
  readonly region?: string;
  /**
  * The L7 Rule type - can either be COOKIE, FILE\_TYPE, HEADER, HOST\_NAME or PATH.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule#type LbL7Rule#type}
  */
  readonly type: string;
  /**
  * The value to use for the comparison. For example, the file type to compare.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule#value LbL7Rule#value}
  */
  readonly value: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule#timeouts LbL7Rule#timeouts}
  */
  readonly timeouts?: LbL7RuleTimeouts;
}
export interface LbL7RuleTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule#create LbL7Rule#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule#delete LbL7Rule#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule#update LbL7Rule#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule vkcs_lb_l7rule}
*/
export class LbL7Rule extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "vkcs_lb_l7rule";
  ...
  * @param importFromId The id of the existing LbL7Rule that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the LbL7Rule to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "vkcs_lb_l7rule", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/lb_l7rule vkcs_lb_l7rule} Resource
  *
  * @param scope The scope in which to define this construct
