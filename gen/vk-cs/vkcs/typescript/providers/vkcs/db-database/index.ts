// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/db_database
...
export interface DbDatabaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/db_database#charset DbDatabase#charset}
  */
  readonly charset?: string;
  /**
  * Collate option of the database.  Changing this creates a new database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/db_database#collate DbDatabase#collate}
  */
  readonly collate?: string;
  /**
  * ID of the instance or cluster that database is created for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/db_database#dbms_id DbDatabase#dbms_id}
  */
  readonly dbmsId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/db_database#id DbDatabase#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/db_database#name DbDatabase#name}
  */
  readonly name: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/db_database#timeouts DbDatabase#timeouts}
  */
  readonly timeouts?: DbDatabaseTimeouts;
  /**
  * vendor_options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/db_database#vendor_options DbDatabase#vendor_options}
  */
  readonly vendorOptions?: DbDatabaseVendorOptions;
}
export interface DbDatabaseTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/db_database#create DbDatabase#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/db_database#delete DbDatabase#delete}
  */
...
export interface DbDatabaseVendorOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/db_database#force_deletion DbDatabase#force_deletion}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/db_database vkcs_db_database}
*/
export class DbDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/db_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/db_database vkcs_db_database} Resource
  *
  * @param scope The scope in which to define this construct
