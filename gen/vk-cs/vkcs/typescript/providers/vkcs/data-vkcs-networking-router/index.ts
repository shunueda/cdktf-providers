// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router
...
export interface DataVkcsNetworkingRouterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router#admin_state_up DataVkcsNetworkingRouter#admin_state_up}
  */
  readonly adminStateUp?: boolean | cdktf.IResolvable;
  /**
  * Human-readable description of the router.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router#description DataVkcsNetworkingRouter#description}
  */
  readonly description?: string;
  /**
  * The value that points out if the Source NAT is enabled on the router.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router#enable_snat DataVkcsNetworkingRouter#enable_snat}
  */
  readonly enableSnat?: boolean | cdktf.IResolvable;
  /**
  * The UUID of the router resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router#id DataVkcsNetworkingRouter#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router#name DataVkcsNetworkingRouter#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router#region DataVkcsNetworkingRouter#region}
  */
  readonly region?: string;
  /**
  * The UUID of the router resource. **Deprecated** This argument is deprecated, please, use the `id` attribute instead.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router#router_id DataVkcsNetworkingRouter#router_id}
  */
  readonly routerId?: string;
  /**
  * SDN to use for this resource. Must be one of following: "neutron", "sprut". Default value is project's default SDN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router#sdn DataVkcsNetworkingRouter#sdn}
  */
  readonly sdn?: string;
  /**
  * The status of the router (ACTIVE/DOWN).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router#status DataVkcsNetworkingRouter#status}
  */
  readonly status?: string;
  /**
  * The list of router tags to filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router#tags DataVkcsNetworkingRouter#tags}
  */
  readonly tags?: string[];
  /**
  * The owner of the router.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router#tenant_id DataVkcsNetworkingRouter#tenant_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router vkcs_networking_router}
*/
export class DataVkcsNetworkingRouter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVkcsNetworkingRouter that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_router vkcs_networking_router} Data Source
  *
  * @param scope The scope in which to define this construct
