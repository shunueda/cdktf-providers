// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/networking_router_interface
...
export interface NetworkingRouterInterfaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/networking_router_interface#id NetworkingRouterInterface#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/networking_router_interface#port_id NetworkingRouterInterface#port_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/networking_router_interface#region NetworkingRouterInterface#region}
  */
  readonly region?: string;
  /**
  * ID of the router this interface belongs to. Changing this creates a new router interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/networking_router_interface#router_id NetworkingRouterInterface#router_id}
  */
  readonly routerId: string;
  /**
  * SDN to use for this resource. Must be one of following: "neutron", "sprut". Default value is project's default SDN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/networking_router_interface#sdn NetworkingRouterInterface#sdn}
  */
  readonly sdn?: string;
  /**
  * ID of the subnet this interface connects to. Changing this creates a new router interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/networking_router_interface#subnet_id NetworkingRouterInterface#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/networking_router_interface#timeouts NetworkingRouterInterface#timeouts}
  */
  readonly timeouts?: NetworkingRouterInterfaceTimeouts;
}
export interface NetworkingRouterInterfaceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/networking_router_interface#create NetworkingRouterInterface#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/networking_router_interface#delete NetworkingRouterInterface#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/networking_router_interface vkcs_networking_router_interface}
*/
export class NetworkingRouterInterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkingRouterInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/networking_router_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/networking_router_interface vkcs_networking_router_interface} Resource
  *
  * @param scope The scope in which to define this construct
