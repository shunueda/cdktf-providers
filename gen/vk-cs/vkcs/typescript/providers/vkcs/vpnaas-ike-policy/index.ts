// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy
...
export interface VpnaasIkePolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#auth_algorithm VpnaasIkePolicy#auth_algorithm}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#description VpnaasIkePolicy#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#encryption_algorithm VpnaasIkePolicy#encryption_algorithm}
  */
  readonly encryptionAlgorithm?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#id VpnaasIkePolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#ike_version VpnaasIkePolicy#ike_version}
  */
  readonly ikeVersion?: string;
  /**
  * The name of the policy. Changing this updates the name of the existing policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#name VpnaasIkePolicy#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#pfs VpnaasIkePolicy#pfs}
  */
  readonly pfs?: string;
  /**
  * The IKE mode. A valid value is main, which is the default. Changing this updates the existing policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#phase1_negotiation_mode VpnaasIkePolicy#phase1_negotiation_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#region VpnaasIkePolicy#region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#sdn VpnaasIkePolicy#sdn}
  */
  readonly sdn?: string;
  /**
  * lifetime block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#lifetime VpnaasIkePolicy#lifetime}
  */
  readonly lifetime?: VpnaasIkePolicyLifetime[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#timeouts VpnaasIkePolicy#timeouts}
  */
...
export interface VpnaasIkePolicyLifetime {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#units VpnaasIkePolicy#units}
  */
  readonly units?: string;
  /**
  * The value for the lifetime of the security association. Must be a positive integer. Default is 3600.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#value VpnaasIkePolicy#value}
  */
...
export interface VpnaasIkePolicyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#create VpnaasIkePolicy#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy vkcs_vpnaas_ike_policy}
*/
export class VpnaasIkePolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "vkcs_vpnaas_ike_policy";
  ...
  * @param importFromId The id of the existing VpnaasIkePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the VpnaasIkePolicy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "vkcs_vpnaas_ike_policy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/vpnaas_ike_policy vkcs_vpnaas_ike_policy} Resource
  *
  * @param scope The scope in which to define this construct
