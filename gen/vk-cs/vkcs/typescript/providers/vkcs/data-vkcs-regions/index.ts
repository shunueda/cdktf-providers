// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/regions
...
/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/regions vkcs_regions}
*/
export class DataVkcsRegions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVkcsRegions that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/regions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/regions vkcs_regions} Data Source
  *
  * @param scope The scope in which to define this construct
