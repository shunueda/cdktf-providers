// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/db_database
...
export interface DataVkcsDbDatabaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/db_database#charset DataVkcsDbDatabase#charset}
  */
  readonly charset?: string;
  /**
  * Collate option of the database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/db_database#collate DataVkcsDbDatabase#collate}
  */
  readonly collate?: string;
  /**
  * ID of the instance or cluster that database is created for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/db_database#dbms_id DataVkcsDbDatabase#dbms_id}
  */
  readonly dbmsId?: string;
  /**
  * The id of the database in form "dbms_id/db_name".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/db_database#id DataVkcsDbDatabase#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/db_database#name DataVkcsDbDatabase#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/db_database vkcs_db_database}
*/
export class DataVkcsDbDatabase extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVkcsDbDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/db_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/db_database vkcs_db_database} Data Source
  *
  * @param scope The scope in which to define this construct
