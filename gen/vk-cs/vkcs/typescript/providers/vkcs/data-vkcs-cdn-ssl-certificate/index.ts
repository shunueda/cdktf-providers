// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/cdn_ssl_certificate
...
export interface DataVkcsCdnSslCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/cdn_ssl_certificate#name DataVkcsCdnSslCertificate#name}
  */
  readonly name: string;
  /**
  * The region in which to obtain the CDN client. If omitted, the `region` argument of the provider is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/cdn_ssl_certificate#region DataVkcsCdnSslCertificate#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/cdn_ssl_certificate vkcs_cdn_ssl_certificate}
*/
export class DataVkcsCdnSslCertificate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVkcsCdnSslCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/cdn_ssl_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/cdn_ssl_certificate vkcs_cdn_ssl_certificate} Data Source
  *
  * @param scope The scope in which to define this construct
