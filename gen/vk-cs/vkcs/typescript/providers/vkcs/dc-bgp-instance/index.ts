// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/dc_bgp_instance
...
export interface DcBgpInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/dc_bgp_instance#asn DcBgpInstance#asn}
  */
  readonly asn: number;
  /**
  * BGP Router ID (IP address that represent BGP router in BGP network). Changing this creates a new resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/dc_bgp_instance#bgp_router_id DcBgpInstance#bgp_router_id}
  */
  readonly bgpRouterId: string;
  /**
  * Direct Connect Router ID to attach. Changing this creates a new resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/dc_bgp_instance#dc_router_id DcBgpInstance#dc_router_id}
  */
  readonly dcRouterId: string;
  /**
  * Description of the router
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/dc_bgp_instance#description DcBgpInstance#description}
  */
  readonly description?: string;
  /**
  * Enable BGP ECMP behaviour on router. Default is false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/dc_bgp_instance#ecmp_enabled DcBgpInstance#ecmp_enabled}
  */
  readonly ecmpEnabled?: boolean | cdktf.IResolvable;
  /**
  * Enable or disable item. Default is true
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/dc_bgp_instance#enabled DcBgpInstance#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Enable BGP Graceful Restart feature. Default is false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/dc_bgp_instance#graceful_restart DcBgpInstance#graceful_restart}
  */
  readonly gracefulRestart?: boolean | cdktf.IResolvable;
  /**
  * Enable BGP Long Lived Graceful Restart feature. Default is false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/dc_bgp_instance#long_lived_graceful_restart DcBgpInstance#long_lived_graceful_restart}
  */
  readonly longLivedGracefulRestart?: boolean | cdktf.IResolvable;
  /**
  * Name of the router
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/dc_bgp_instance#name DcBgpInstance#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/dc_bgp_instance#region DcBgpInstance#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/dc_bgp_instance vkcs_dc_bgp_instance}
*/
export class DcBgpInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DcBgpInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/dc_bgp_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/dc_bgp_instance vkcs_dc_bgp_instance} Resource
  *
  * @param scope The scope in which to define this construct
