// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/cloud_monitoring
...
export interface CloudMonitoringConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/cloud_monitoring#image_id CloudMonitoring#image_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/cloud_monitoring#region CloudMonitoring#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/cloud_monitoring vkcs_cloud_monitoring}
*/
export class CloudMonitoring extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudMonitoring that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/cloud_monitoring#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/cloud_monitoring vkcs_cloud_monitoring} Resource
  *
  * @param scope The scope in which to define this construct
