// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone
...
export interface DataVkcsPublicdnsZoneConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone#admin_email DataVkcsPublicdnsZone#admin_email}
  */
  readonly adminEmail?: string;
  /**
  * The expire time of the zone SOA.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone#expire DataVkcsPublicdnsZone#expire}
  */
  readonly expire?: number;
  /**
  * The UUID of the DNS zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone#id DataVkcsPublicdnsZone#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone#primary_dns DataVkcsPublicdnsZone#primary_dns}
  */
  readonly primaryDns?: string;
  /**
  * The refresh time of the zone SOA.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone#refresh DataVkcsPublicdnsZone#refresh}
  */
  readonly refresh?: number;
  /**
  * The region in which to obtain the V2 Public DNS client. If omitted, the `region` argument of the provider is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone#region DataVkcsPublicdnsZone#region}
  */
  readonly region?: string;
  /**
  * The retry time of the zone SOA.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone#retry DataVkcsPublicdnsZone#retry}
  */
  readonly retry?: number;
  /**
  * The serial number of the zone SOA.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone#serial DataVkcsPublicdnsZone#serial}
  */
  readonly serial?: number;
  /**
  * The status of the zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone#status DataVkcsPublicdnsZone#status}
  */
  readonly status?: string;
  /**
  * The TTL (time to live) of the zone SOA.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone#ttl DataVkcsPublicdnsZone#ttl}
  */
  readonly ttl?: number;
  /**
  * The name of the zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone#zone DataVkcsPublicdnsZone#zone}
  */
  readonly zone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone vkcs_publicdns_zone}
*/
export class DataVkcsPublicdnsZone extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVkcsPublicdnsZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/publicdns_zone vkcs_publicdns_zone} Data Source
  *
  * @param scope The scope in which to define this construct
