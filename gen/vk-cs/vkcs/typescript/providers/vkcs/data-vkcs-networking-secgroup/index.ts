// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_secgroup
...
export interface DataVkcsNetworkingSecgroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_secgroup#description DataVkcsNetworkingSecgroup#description}
  */
  readonly description?: string;
  /**
  * The ID of the security group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_secgroup#id DataVkcsNetworkingSecgroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_secgroup#name DataVkcsNetworkingSecgroup#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_secgroup#region DataVkcsNetworkingSecgroup#region}
  */
  readonly region?: string;
  /**
  * SDN to use for this resource. Must be one of following: "neutron", "sprut". Default value is project's default SDN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_secgroup#sdn DataVkcsNetworkingSecgroup#sdn}
  */
  readonly sdn?: string;
  /**
  * The ID of the security group. **Deprecated** This argument is deprecated, please, use the `id` attribute instead.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_secgroup#secgroup_id DataVkcsNetworkingSecgroup#secgroup_id}
  */
  readonly secgroupId?: string;
  /**
  * The list of security group tags to filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_secgroup#tags DataVkcsNetworkingSecgroup#tags}
  */
  readonly tags?: string[];
  /**
  * The owner of the security group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_secgroup#tenant_id DataVkcsNetworkingSecgroup#tenant_id}
  */
  readonly tenantId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_secgroup vkcs_networking_secgroup}
*/
export class DataVkcsNetworkingSecgroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVkcsNetworkingSecgroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_secgroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_secgroup vkcs_networking_secgroup} Data Source
  *
  * @param scope The scope in which to define this construct
