// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network
...
export interface DataVkcsNetworkingNetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network#description DataVkcsNetworkingNetwork#description}
  */
  readonly description?: string;
  /**
  * The external routing facility of the network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network#external DataVkcsNetworkingNetwork#external}
  */
  readonly external?: boolean | cdktf.IResolvable;
  /**
  * The ID of the network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network#id DataVkcsNetworkingNetwork#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network#matching_subnet_cidr DataVkcsNetworkingNetwork#matching_subnet_cidr}
  */
  readonly matchingSubnetCidr?: string;
  /**
  * The name of the network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network#name DataVkcsNetworkingNetwork#name}
  */
  readonly name?: string;
  /**
  * The ID of the network. **Deprecated** This argument is deprecated, please, use the `id` attribute instead.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network#network_id DataVkcsNetworkingNetwork#network_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network#region DataVkcsNetworkingNetwork#region}
  */
  readonly region?: string;
  /**
  * SDN to use for this resource. Must be one of following: "neutron", "sprut". Default value is project's default SDN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network#sdn DataVkcsNetworkingNetwork#sdn}
  */
  readonly sdn?: string;
  /**
  * The status of the network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network#status DataVkcsNetworkingNetwork#status}
  */
  readonly status?: string;
  /**
  * The list of network tags to filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network#tags DataVkcsNetworkingNetwork#tags}
  */
  readonly tags?: string[];
  /**
  * The owner of the network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network#tenant_id DataVkcsNetworkingNetwork#tenant_id}
  */
  readonly tenantId?: string;
  /**
  * Specifies whether VKCS services access is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network#vkcs_services_access DataVkcsNetworkingNetwork#vkcs_services_access}
  */
  readonly vkcsServicesAccess?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network vkcs_networking_network}
*/
export class DataVkcsNetworkingNetwork extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVkcsNetworkingNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/networking_network vkcs_networking_network} Data Source
  *
  * @param scope The scope in which to define this construct
