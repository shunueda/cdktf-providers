// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/keymanager_container
...
export interface DataVkcsKeymanagerContainerConfig extends cdktf.TerraformMetaArguments {
  ...
  * The Container name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/keymanager_container#name DataVkcsKeymanagerContainer#name}
  */
  readonly name?: string;
  /**
  * The region in which to obtain the VKCS Key Manager client. If omitted, the `region` argument of the provider is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/keymanager_container#region DataVkcsKeymanagerContainer#region}
  */
...
export interface DataVkcsKeymanagerContainerConsumers {
  ...
  * The consumer URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/keymanager_container#url DataVkcsKeymanagerContainer#url}
  */
  readonly url?: string;
}
...
export interface DataVkcsKeymanagerContainerSecretRefs {
  ...
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/keymanager_container#secret_ref DataVkcsKeymanagerContainer#secret_ref}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/keymanager_container vkcs_keymanager_container}
*/
export class DataVkcsKeymanagerContainer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVkcsKeymanagerContainer that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/keymanager_container#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/keymanager_container vkcs_keymanager_container} Data Source
  *
  * @param scope The scope in which to define this construct
