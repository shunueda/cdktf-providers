// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_ssl_certificate
...
export interface CdnSslCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_ssl_certificate#certificate CdnSslCertificate#certificate}
  */
  readonly certificate: string;
  /**
  * SSL certificate name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_ssl_certificate#name CdnSslCertificate#name}
  */
  readonly name: string;
  /**
  * Private key of the SSL certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_ssl_certificate#private_key CdnSslCertificate#private_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_ssl_certificate#region CdnSslCertificate#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_ssl_certificate vkcs_cdn_ssl_certificate}
*/
export class CdnSslCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnSslCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_ssl_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_ssl_certificate vkcs_cdn_ssl_certificate} Resource
  *
  * @param scope The scope in which to define this construct
