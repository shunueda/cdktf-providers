// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor
...
export interface DcBgpNeighborConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor#add_paths DcBgpNeighbor#add_paths}
  */
  readonly addPaths?: string;
  /**
  * Control BGP session activity with BFD protocol. Default is false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor#bfd_enabled DcBgpNeighbor#bfd_enabled}
  */
  readonly bfdEnabled?: boolean | cdktf.IResolvable;
  /**
  * Direct Connect BGP ID to attach. Changing this creates a new resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor#dc_bgp_id DcBgpNeighbor#dc_bgp_id}
  */
  readonly dcBgpId: string;
  /**
  * Description of the BGP neighbor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor#description DcBgpNeighbor#description}
  */
  readonly description?: string;
  /**
  * Enable or disable item. Default is true
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor#enabled DcBgpNeighbor#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Input filter that pass incoming BGP prefixes (allow any)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor#filter_in DcBgpNeighbor#filter_in}
  */
  readonly filterIn?: string;
  /**
  * Output filter that pass incoming BGP prefixes (allow any)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor#filter_out DcBgpNeighbor#filter_out}
  */
  readonly filterOut?: string;
  /**
  * Force set IP address of next-hop on BGP prefix to self even in iBGP. Default is false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor#force_ibgp_next_hop_self DcBgpNeighbor#force_ibgp_next_hop_self}
  */
  readonly forceIbgpNextHopSelf?: boolean | cdktf.IResolvable;
  /**
  * Name of the BGP neighbor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor#name DcBgpNeighbor#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor#region DcBgpNeighbor#region}
  */
  readonly region?: string;
  /**
  * BGP Neighbor ASN. Changing this creates a new resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor#remote_asn DcBgpNeighbor#remote_asn}
  */
  readonly remoteAsn: number;
  /**
  * BGP Neighbor IP address. Changing this creates a new resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor#remote_ip DcBgpNeighbor#remote_ip}
  */
  readonly remoteIp: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor vkcs_dc_bgp_neighbor}
*/
export class DcBgpNeighbor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DcBgpNeighbor that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/resources/dc_bgp_neighbor vkcs_dc_bgp_neighbor} Resource
  *
  * @param scope The scope in which to define this construct
