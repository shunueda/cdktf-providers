// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_origin_group
...
export interface CdnOriginGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_origin_group#name CdnOriginGroup#name}
  */
  readonly name: string;
  /**
  * List of origin sources in the origin group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_origin_group#origins CdnOriginGroup#origins}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_origin_group#region CdnOriginGroup#region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_origin_group#use_next CdnOriginGroup#use_next}
  */
...
export interface CdnOriginGroupOrigins {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_origin_group#backup CdnOriginGroup#backup}
  */
  readonly backup?: boolean | cdktf.IResolvable;
  /**
  * Enables or disables an origin source in the origin group. Enabled by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_origin_group#enabled CdnOriginGroup#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * IP address or domain name of the origin and the port, if custom port is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_origin_group#source CdnOriginGroup#source}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_origin_group vkcs_cdn_origin_group}
*/
export class CdnOriginGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnOriginGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_origin_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/resources/cdn_origin_group vkcs_cdn_origin_group} Resource
  *
  * @param scope The scope in which to define this construct
