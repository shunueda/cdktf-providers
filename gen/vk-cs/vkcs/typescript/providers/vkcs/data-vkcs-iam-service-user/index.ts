// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/iam_service_user
...
export interface DataVkcsIamServiceUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/iam_service_user#id DataVkcsIamServiceUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/iam_service_user#name DataVkcsIamServiceUser#name}
  */
  readonly name?: string;
  /**
  * The region in which to obtain the IAM Service Users client. If omitted, the `region` argument of the provider is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/iam_service_user#region DataVkcsIamServiceUser#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/iam_service_user vkcs_iam_service_user}
*/
export class DataVkcsIamServiceUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVkcsIamServiceUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/iam_service_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/iam_service_user vkcs_iam_service_user} Data Source
  *
  * @param scope The scope in which to define this construct
