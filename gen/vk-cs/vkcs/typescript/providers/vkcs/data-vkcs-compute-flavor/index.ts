// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor
...
export interface DataVkcsComputeFlavorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor#disk DataVkcsComputeFlavor#disk}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor#extra_specs DataVkcsComputeFlavor#extra_specs}
  */
  readonly extraSpecs?: { [key: string]: string };
  /**
  * The ID of the flavor. Conflicts with the `name`, `min_ram` and `min_disk`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor#flavor_id DataVkcsComputeFlavor#flavor_id}
  */
  readonly flavorId?: string;
  /**
  * The flavor visibility.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor#is_public DataVkcsComputeFlavor#is_public}
  */
  readonly isPublic?: boolean | cdktf.IResolvable;
  /**
  * The minimum amount of disk (in gigabytes). Conflicts with the `flavor_id`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor#min_disk DataVkcsComputeFlavor#min_disk}
  */
  readonly minDisk?: number;
  /**
  * The minimum amount of RAM (in megabytes). Conflicts with the `flavor_id`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor#min_ram DataVkcsComputeFlavor#min_ram}
  */
  readonly minRam?: number;
  /**
  * The name of the flavor. Conflicts with the `flavor_id`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor#name DataVkcsComputeFlavor#name}
  */
  readonly name?: string;
  /**
  * The exact amount of RAM (in megabytes). Don't set ram, when min_ram is set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor#ram DataVkcsComputeFlavor#ram}
  */
  readonly ram?: number;
  /**
  * The region in which to obtain the Compute client. If omitted, the `region` argument of the provider is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor#region DataVkcsComputeFlavor#region}
  */
  readonly region?: string;
  /**
  * The `rx_tx_factor` of the flavor.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor#rx_tx_factor DataVkcsComputeFlavor#rx_tx_factor}
  */
  readonly rxTxFactor?: number;
  /**
  * The amount of swap (in gigabytes).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor#swap DataVkcsComputeFlavor#swap}
  */
  readonly swap?: number;
  /**
  * The amount of VCPUs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor#vcpus DataVkcsComputeFlavor#vcpus}
  */
  readonly vcpus?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor vkcs_compute_flavor}
*/
export class DataVkcsComputeFlavor extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVkcsComputeFlavor that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.2/docs/data-sources/compute_flavor vkcs_compute_flavor} Data Source
  *
  * @param scope The scope in which to define this construct
