// https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_floatingip
...
export interface DataVkcsNetworkingFloatingipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_floatingip#address DataVkcsNetworkingFloatingip#address}
  */
  readonly address?: string;
  /**
  * Human-readable description of the floating IP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_floatingip#description DataVkcsNetworkingFloatingip#description}
  */
  readonly description?: string;
  /**
  * The specific IP address of the internal port which should be associated with the floating IP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_floatingip#fixed_ip DataVkcsNetworkingFloatingip#fixed_ip}
  */
  readonly fixedIp?: string;
  /**
  * The name of the pool from which the floating IP belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_floatingip#pool DataVkcsNetworkingFloatingip#pool}
  */
  readonly pool?: string;
  /**
  * The ID of the port the floating IP is attached.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_floatingip#port_id DataVkcsNetworkingFloatingip#port_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_floatingip#region DataVkcsNetworkingFloatingip#region}
  */
  readonly region?: string;
  /**
  * SDN to use for this resource. Must be one of following: "neutron", "sprut". Default value is project's default SDN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_floatingip#sdn DataVkcsNetworkingFloatingip#sdn}
  */
  readonly sdn?: string;
  /**
  * Status of the floating IP (ACTIVE/DOWN).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_floatingip#status DataVkcsNetworkingFloatingip#status}
  */
  readonly status?: string;
  /**
  * The owner of the floating IP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_floatingip#tenant_id DataVkcsNetworkingFloatingip#tenant_id}
  */
  readonly tenantId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_floatingip vkcs_networking_floatingip}
*/
export class DataVkcsNetworkingFloatingip extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVkcsNetworkingFloatingip that should be imported. Refer to the {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_floatingip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vk-cs/vkcs/0.13.0/docs/data-sources/networking_floatingip vkcs_networking_floatingip} Data Source
  *
  * @param scope The scope in which to define this construct
