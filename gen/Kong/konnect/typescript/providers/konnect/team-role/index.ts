// https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/team_role
...
export interface TeamRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/team_role#entity_id TeamRole#entity_id}
  */
  readonly entityId?: string;
  /**
  * Region of the team. must be one of ["us", "eu", "au", "me", "in", "sg", "*"]; Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/team_role#entity_region TeamRole#entity_region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/team_role#entity_type_name TeamRole#entity_type_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/team_role#role_name TeamRole#role_name}
  */
  readonly roleName?: string;
  /**
  * The team ID. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/team_role#team_id TeamRole#team_id}
  */
  readonly teamId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/team_role konnect_team_role}
*/
export class TeamRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/team_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/team_role konnect_team_role} Resource
  *
  * @param scope The scope in which to define this construct
