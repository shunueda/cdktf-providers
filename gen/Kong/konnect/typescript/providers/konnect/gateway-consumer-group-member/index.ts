// https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_consumer_group_member
...
export interface GatewayConsumerGroupMemberConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_consumer_group_member#consumer_group_id GatewayConsumerGroupMember#consumer_group_id}
  */
  readonly consumerGroupId: string;
  /**
  * Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_consumer_group_member#consumer_id GatewayConsumerGroupMember#consumer_id}
  */
  readonly consumerId?: string;
  /**
  * The UUID of your control plane. This variable is available in the Konnect manager. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_consumer_group_member#control_plane_id GatewayConsumerGroupMember#control_plane_id}
  */
  readonly controlPlaneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_consumer_group_member konnect_gateway_consumer_group_member}
*/
export class GatewayConsumerGroupMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GatewayConsumerGroupMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_consumer_group_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_consumer_group_member konnect_gateway_consumer_group_member} Resource
  *
  * @param scope The scope in which to define this construct
