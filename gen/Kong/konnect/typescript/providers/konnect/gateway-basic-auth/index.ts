...
export interface GatewayBasicAuthConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class GatewayBasicAuth extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "konnect_gateway_basic_auth";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "konnect_gateway_basic_auth", importId: importFromId, provider });
      }
  ...
  * @param options GatewayBasicAuthConfig
  */
  public constructor(scope: Construct, id: string, config: GatewayBasicAuthConfig) {
    super(scope, id, {
