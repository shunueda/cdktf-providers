// https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/api_implementation
...
export interface ApiImplementationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/api_implementation#api_id ApiImplementation#api_id}
  */
  readonly apiId: string;
  /**
  * A gateway service that implements an API. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/api_implementation#service_reference ApiImplementation#service_reference}
  */
...
export interface ApiImplementationServiceReferenceService {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/api_implementation#control_plane_id ApiImplementation#control_plane_id}
  */
  readonly controlPlaneId?: string;
  /**
  * Not Null; Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/api_implementation#id ApiImplementation#id}
  *
...
export interface ApiImplementationServiceReference {
  ...
  * A Gateway service that implements an API. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/api_implementation#service ApiImplementation#service}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/api_implementation konnect_api_implementation}
*/
export class ApiImplementation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiImplementation that should be imported. Refer to the {@link https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/api_implementation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/api_implementation konnect_api_implementation} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // service_reference - computed: true, optional: true, required: false
