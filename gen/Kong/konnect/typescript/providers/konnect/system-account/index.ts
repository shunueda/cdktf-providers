// https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/system_account
...
export interface SystemAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/system_account#description SystemAccount#description}
  */
  readonly description: string;
  /**
  * The system account is managed by Konnect (true/false). Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/system_account#konnect_managed SystemAccount#konnect_managed}
  */
  readonly konnectManaged?: boolean | cdktf.IResolvable;
  /**
  * Name of the system account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/system_account#name SystemAccount#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/system_account konnect_system_account}
*/
export class SystemAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/system_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kong/konnect/3.4.2/docs/resources/system_account konnect_system_account} Resource
  *
  * @param scope The scope in which to define this construct
