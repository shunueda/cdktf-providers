...
export interface DataKonnectCloudGatewayProviderAccountListConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataKonnectCloudGatewayProviderAccountListData {
}

export function dataKonnectCloudGatewayProviderAccountListDataToTerraform(struct?: DataKonnectCloudGatewayProviderAccountListData): any {
...
export function dataKonnectCloudGatewayProviderAccountListDataToHclTerraform(struct?: DataKonnectCloudGatewayProviderAccountListData): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataKonnectCloudGatewayProviderAccountListDataOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataKonnectCloudGatewayProviderAccountListData | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataKonnectCloudGatewayProviderAccountListData | undefined) {
    if (value === undefined) {
...
export class DataKonnectCloudGatewayProviderAccountListDataList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataKonnectCloudGatewayProviderAccountListDataOutputReference {
    return new DataKonnectCloudGatewayProviderAccountListDataOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataKonnectCloudGatewayProviderAccountList extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "konnect_cloud_gateway_provider_account_list";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "konnect_cloud_gateway_provider_account_list", importId: importFromId, provider });
      }
  ...
  * @param options DataKonnectCloudGatewayProviderAccountListConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataKonnectCloudGatewayProviderAccountListConfig = {}) {
    super(scope, id, {
  ...
  private _data = new DataKonnectCloudGatewayProviderAccountListDataList(this, "data", false);
  public get data() {
    return this._data;
  }
