...
export interface AuditLogDestinationConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class AuditLogDestination extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "konnect_audit_log_destination";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "konnect_audit_log_destination", importId: importFromId, provider });
      }
  ...
  * @param options AuditLogDestinationConfig
  */
  public constructor(scope: Construct, id: string, config: AuditLogDestinationConfig) {
    super(scope, id, {
