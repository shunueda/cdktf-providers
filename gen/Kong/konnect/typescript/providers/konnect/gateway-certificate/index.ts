// https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_certificate
...
export interface GatewayCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_certificate#cert GatewayCertificate#cert}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_certificate#cert_alt GatewayCertificate#cert_alt}
  */
  readonly certAlt?: string;
  /**
  * The UUID of your control plane. This variable is available in the Konnect manager. Requires replacement if changed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_certificate#control_plane_id GatewayCertificate#control_plane_id}
  */
  readonly controlPlaneId: string;
  /**
  * Unix epoch when the resource was created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_certificate#created_at GatewayCertificate#created_at}
  */
  readonly createdAt?: number;
  /**
  * A string representing a UUID (universally unique identifier).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_certificate#id GatewayCertificate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_certificate#key GatewayCertificate#key}
  */
  readonly key: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_certificate#key_alt GatewayCertificate#key_alt}
  */
  readonly keyAlt?: string;
  /**
  * An optional set of strings associated with the Certificate for grouping and filtering.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_certificate#tags GatewayCertificate#tags}
  */
  readonly tags?: string[];
  /**
  * Unix epoch when the resource was last updated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_certificate#updated_at GatewayCertificate#updated_at}
  */
  readonly updatedAt?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_certificate konnect_gateway_certificate}
*/
export class GatewayCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GatewayCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kong/konnect/3.4.3/docs/resources/gateway_certificate konnect_gateway_certificate} Resource
  *
  * @param scope The scope in which to define this construct
