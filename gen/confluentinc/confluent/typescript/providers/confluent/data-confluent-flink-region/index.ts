// https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/data-sources/flink_region
...
export interface DataConfluentFlinkRegionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/data-sources/flink_region#cloud DataConfluentFlinkRegion#cloud}
  */
  readonly cloud: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/data-sources/flink_region#region DataConfluentFlinkRegion#region}
  */
  readonly region: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/data-sources/flink_region confluent_flink_region}
*/
export class DataConfluentFlinkRegion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentFlinkRegion that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/data-sources/flink_region#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/data-sources/flink_region confluent_flink_region} Data Source
  *
  * @param scope The scope in which to define this construct
