// https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/flink_compute_pool
...
export interface FlinkComputePoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/flink_compute_pool#cloud FlinkComputePool#cloud}
  */
  readonly cloud: string;
  /**
  * The name of the Flink compute pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/flink_compute_pool#display_name FlinkComputePool#display_name}
  */
  readonly displayName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/flink_compute_pool#id FlinkComputePool#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/flink_compute_pool#max_cfu FlinkComputePool#max_cfu}
  */
  readonly maxCfu?: number;
  /**
  * The cloud service provider region that hosts the Flink compute pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/flink_compute_pool#region FlinkComputePool#region}
  */
  readonly region: string;
  /**
  * environment block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/flink_compute_pool#environment FlinkComputePool#environment}
  */
  readonly environment: FlinkComputePoolEnvironment;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/flink_compute_pool#timeouts FlinkComputePool#timeouts}
  */
...
export interface FlinkComputePoolTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/flink_compute_pool#create FlinkComputePool#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/flink_compute_pool#delete FlinkComputePool#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/flink_compute_pool confluent_flink_compute_pool}
*/
export class FlinkComputePool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FlinkComputePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/flink_compute_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/flink_compute_pool confluent_flink_compute_pool} Resource
  *
  * @param scope The scope in which to define this construct
