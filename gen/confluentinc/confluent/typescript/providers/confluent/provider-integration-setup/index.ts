// https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_setup
...
export interface ProviderIntegrationSetupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_setup#cloud ProviderIntegrationSetup#cloud}
  */
  readonly cloud: string;
  /**
  * Display name of Provider Integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_setup#display_name ProviderIntegrationSetup#display_name}
  */
  readonly displayName: string;
  /**
  * environment block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_setup#environment ProviderIntegrationSetup#environment}
  */
...
export interface ProviderIntegrationSetupEnvironment {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_setup#id ProviderIntegrationSetup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_setup confluent_provider_integration_setup}
*/
export class ProviderIntegrationSetup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProviderIntegrationSetup that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_setup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_setup confluent_provider_integration_setup} Resource
  *
  * @param scope The scope in which to define this construct
