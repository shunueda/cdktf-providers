// https://registry.terraform.io/providers/confluentinc/confluent/2.54.0/docs/data-sources/environments
...
export interface DataConfluentEnvironmentsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.54.0/docs/data-sources/environments#id DataConfluentEnvironments#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.54.0/docs/data-sources/environments confluent_environments}
*/
export class DataConfluentEnvironments extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentEnvironments that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.54.0/docs/data-sources/environments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.54.0/docs/data-sources/environments confluent_environments} Data Source
  *
  * @param scope The scope in which to define this construct
