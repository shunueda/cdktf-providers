// https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/provider_integration
...
export interface ProviderIntegrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/provider_integration#display_name ProviderIntegration#display_name}
  */
  readonly displayName: string;
  /**
  * aws block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/provider_integration#aws ProviderIntegration#aws}
  */
  readonly aws?: ProviderIntegrationAws;
  /**
  * environment block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/provider_integration#environment ProviderIntegration#environment}
  */
...
export interface ProviderIntegrationAws {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/provider_integration#customer_role_arn ProviderIntegration#customer_role_arn}
  */
...
export interface ProviderIntegrationEnvironment {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/provider_integration#id ProviderIntegration#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/provider_integration confluent_provider_integration}
*/
export class ProviderIntegration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProviderIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/provider_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.52.0/docs/resources/provider_integration confluent_provider_integration} Resource
  *
  * @param scope The scope in which to define this construct
