// https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/data-sources/role_binding
...
export interface DataConfluentRoleBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/data-sources/role_binding#id DataConfluentRoleBinding#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/data-sources/role_binding confluent_role_binding}
*/
export class DataConfluentRoleBinding extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentRoleBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/data-sources/role_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/data-sources/role_binding confluent_role_binding} Data Source
  *
  * @param scope The scope in which to define this construct
