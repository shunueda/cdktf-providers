// https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_authorization
...
export interface ProviderIntegrationAuthorizationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_authorization#provider_integration_id ProviderIntegrationAuthorization#provider_integration_id}
  */
  readonly providerIntegrationId: string;
  /**
  * azure block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_authorization#azure ProviderIntegrationAuthorization#azure}
  */
  readonly azure?: ProviderIntegrationAuthorizationAzure;
  /**
  * environment block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_authorization#environment ProviderIntegrationAuthorization#environment}
  */
  readonly environment: ProviderIntegrationAuthorizationEnvironment;
  /**
  * gcp block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_authorization#gcp ProviderIntegrationAuthorization#gcp}
  */
...
export interface ProviderIntegrationAuthorizationAzure {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_authorization#customer_azure_tenant_id ProviderIntegrationAuthorization#customer_azure_tenant_id}
  */
...
export interface ProviderIntegrationAuthorizationEnvironment {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_authorization#id ProviderIntegrationAuthorization#id}
  *
...
export interface ProviderIntegrationAuthorizationGcp {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_authorization#customer_google_service_account ProviderIntegrationAuthorization#customer_google_service_account}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_authorization confluent_provider_integration_authorization}
*/
export class ProviderIntegrationAuthorization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProviderIntegrationAuthorization that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_authorization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/provider_integration_authorization confluent_provider_integration_authorization} Resource
  *
  * @param scope The scope in which to define this construct
