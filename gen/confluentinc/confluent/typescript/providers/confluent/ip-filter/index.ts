// https://registry.terraform.io/providers/confluentinc/confluent/2.57.0/docs/resources/ip_filter
...
export interface IpFilterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.57.0/docs/resources/ip_filter#filter_name IpFilter#filter_name}
  */
  readonly filterName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.57.0/docs/resources/ip_filter#id IpFilter#id}
  *
  ...
  * A list of IP Groups.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.57.0/docs/resources/ip_filter#ip_groups IpFilter#ip_groups}
  */
  readonly ipGroups: string[];
  /**
  * Scope of resources covered by this IP filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.57.0/docs/resources/ip_filter#operation_groups IpFilter#operation_groups}
  */
  readonly operationGroups?: string[];
  /**
  * Scope of resources covered by this IP filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.57.0/docs/resources/ip_filter#resource_group IpFilter#resource_group}
  */
  readonly resourceGroup: string;
  /**
  * A CRN that specifies the scope of the ip filter, specifically the organization or environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.57.0/docs/resources/ip_filter#resource_scope IpFilter#resource_scope}
  */
  readonly resourceScope?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.57.0/docs/resources/ip_filter confluent_ip_filter}
*/
export class IpFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.57.0/docs/resources/ip_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.57.0/docs/resources/ip_filter confluent_ip_filter} Resource
  *
  * @param scope The scope in which to define this construct
