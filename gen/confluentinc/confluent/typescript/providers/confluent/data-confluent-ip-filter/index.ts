// https://registry.terraform.io/providers/confluentinc/confluent/2.55.0/docs/data-sources/ip_filter
...
export interface DataConfluentIpFilterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.55.0/docs/data-sources/ip_filter#id DataConfluentIpFilter#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.55.0/docs/data-sources/ip_filter confluent_ip_filter}
*/
export class DataConfluentIpFilter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataConfluentIpFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.55.0/docs/data-sources/ip_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.55.0/docs/data-sources/ip_filter confluent_ip_filter} Data Source
  *
  * @param scope The scope in which to define this construct
