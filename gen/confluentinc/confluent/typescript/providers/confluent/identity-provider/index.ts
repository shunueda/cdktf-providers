// https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/identity_provider
...
export interface IdentityProviderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/identity_provider#description IdentityProvider#description}
  */
  readonly description: string;
  /**
  * A name for the Identity Provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/identity_provider#display_name IdentityProvider#display_name}
  */
  readonly displayName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/identity_provider#id IdentityProvider#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/identity_provider#identity_claim IdentityProvider#identity_claim}
  */
  readonly identityClaim?: string;
  /**
  * A publicly reachable issuer URI for the Identity Provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/identity_provider#issuer IdentityProvider#issuer}
  */
  readonly issuer: string;
  /**
  * A publicly reachable JWKS URI for the Identity Provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/identity_provider#jwks_uri IdentityProvider#jwks_uri}
  */
  readonly jwksUri: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/identity_provider confluent_identity_provider}
*/
export class IdentityProvider extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/identity_provider#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/confluentinc/confluent/2.53.0/docs/resources/identity_provider confluent_identity_provider} Resource
  *
  * @param scope The scope in which to define this construct
