// https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/data-sources/vpc
...
export interface DataVultrVpcConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/data-sources/vpc#id DataVultrVpc#id}
  *
  ...
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/data-sources/vpc#filter DataVultrVpc#filter}
  */
  readonly filter?: DataVultrVpcFilter[] | cdktf.IResolvable;
}
export interface DataVultrVpcFilter {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/data-sources/vpc#name DataVultrVpc#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/data-sources/vpc#values DataVultrVpc#values}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/data-sources/vpc vultr_vpc}
*/
export class DataVultrVpc extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVultrVpc that should be imported. Refer to the {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/data-sources/vpc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/data-sources/vpc vultr_vpc} Data Source
  *
  * @param scope The scope in which to define this construct
