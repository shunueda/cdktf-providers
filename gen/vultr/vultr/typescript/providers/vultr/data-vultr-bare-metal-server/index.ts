...
export function dataVultrBareMetalServerFilterToTerraform(struct?: DataVultrBareMetalServerFilter | cdktf.IResolvable): any {
...
export function dataVultrBareMetalServerFilterToHclTerraform(struct?: DataVultrBareMetalServerFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataVultrBareMetalServerFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataVultrBareMetalServerFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataVultrBareMetalServerFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataVultrBareMetalServerFilterList extends cdktf.ComplexList {
  public internalValue? : DataVultrBareMetalServerFilter[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataVultrBareMetalServerFilterOutputReference {
    return new DataVultrBareMetalServerFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataVultrBareMetalServer extends cdktf.TerraformDataSource {
  ...
  * @param options DataVultrBareMetalServerConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataVultrBareMetalServerConfig = {}) {
    super(scope, id, {
  ...
  private _filter = new DataVultrBareMetalServerFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: DataVultrBareMetalServerFilter[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataVultrBareMetalServerFilterToTerraform, true)(this._filter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktf.listMapperHcl(dataVultrBareMetalServerFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataVultrBareMetalServerFilterList",
      },
    };
