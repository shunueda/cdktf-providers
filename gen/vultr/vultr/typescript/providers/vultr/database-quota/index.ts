// https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/resources/database_quota
...
export interface DatabaseQuotaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/resources/database_quota#client_id DatabaseQuota#client_id}
  */
  readonly clientId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/resources/database_quota#consumer_byte_rate DatabaseQuota#consumer_byte_rate}
  */
  readonly consumerByteRate: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/resources/database_quota#database_id DatabaseQuota#database_id}
  */
  readonly databaseId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/resources/database_quota#id DatabaseQuota#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/resources/database_quota#producer_byte_rate DatabaseQuota#producer_byte_rate}
  */
  readonly producerByteRate: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/resources/database_quota#request_percentage DatabaseQuota#request_percentage}
  */
  readonly requestPercentage: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/resources/database_quota#user DatabaseQuota#user}
  */
  readonly user: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/resources/database_quota vultr_database_quota}
*/
export class DatabaseQuota extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseQuota that should be imported. Refer to the {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/resources/database_quota#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/resources/database_quota vultr_database_quota} Resource
  *
  * @param scope The scope in which to define this construct
