// https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/resources/snapshot_from_url
...
export interface SnapshotFromUrlConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/resources/snapshot_from_url#id SnapshotFromUrl#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/resources/snapshot_from_url#url SnapshotFromUrl#url}
  */
  readonly url: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/resources/snapshot_from_url#use_uefi SnapshotFromUrl#use_uefi}
  */
  readonly useUefi?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/resources/snapshot_from_url vultr_snapshot_from_url}
*/
export class SnapshotFromUrl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnapshotFromUrl that should be imported. Refer to the {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/resources/snapshot_from_url#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/resources/snapshot_from_url vultr_snapshot_from_url} Resource
  *
  * @param scope The scope in which to define this construct
