...
export function dataVultrFirewallGroupFilterToTerraform(struct?: DataVultrFirewallGroupFilter | cdktf.IResolvable): any {
...
export function dataVultrFirewallGroupFilterToHclTerraform(struct?: DataVultrFirewallGroupFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataVultrFirewallGroupFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataVultrFirewallGroupFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataVultrFirewallGroupFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataVultrFirewallGroupFilterList extends cdktf.ComplexList {
  public internalValue? : DataVultrFirewallGroupFilter[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataVultrFirewallGroupFilterOutputReference {
    return new DataVultrFirewallGroupFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataVultrFirewallGroup extends cdktf.TerraformDataSource {
  ...
  * @param options DataVultrFirewallGroupConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataVultrFirewallGroupConfig = {}) {
    super(scope, id, {
  ...
  private _filter = new DataVultrFirewallGroupFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: DataVultrFirewallGroupFilter[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataVultrFirewallGroupFilterToTerraform, true)(this._filter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktf.listMapperHcl(dataVultrFirewallGroupFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataVultrFirewallGroupFilterList",
      },
    };
