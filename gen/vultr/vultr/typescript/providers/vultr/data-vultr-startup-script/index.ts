...
export function dataVultrStartupScriptFilterToTerraform(struct?: DataVultrStartupScriptFilter | cdktf.IResolvable): any {
...
export function dataVultrStartupScriptFilterToHclTerraform(struct?: DataVultrStartupScriptFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataVultrStartupScriptFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataVultrStartupScriptFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataVultrStartupScriptFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataVultrStartupScriptFilterList extends cdktf.ComplexList {
  public internalValue? : DataVultrStartupScriptFilter[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataVultrStartupScriptFilterOutputReference {
    return new DataVultrStartupScriptFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataVultrStartupScript extends cdktf.TerraformDataSource {
  ...
  * @param options DataVultrStartupScriptConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataVultrStartupScriptConfig = {}) {
    super(scope, id, {
  ...
  private _filter = new DataVultrStartupScriptFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: DataVultrStartupScriptFilter[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataVultrStartupScriptFilterToTerraform, true)(this._filter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktf.listMapperHcl(dataVultrStartupScriptFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataVultrStartupScriptFilterList",
      },
    };
