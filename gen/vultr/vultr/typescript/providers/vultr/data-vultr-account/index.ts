// https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/data-sources/account
...
export interface DataVultrAccountConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/data-sources/account#id DataVultrAccount#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/data-sources/account vultr_account}
*/
export class DataVultrAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVultrAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/data-sources/account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/data-sources/account vultr_account} Data Source
  *
  * @param scope The scope in which to define this construct
