// https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/data-sources/bare_metal_plan
...
export interface DataVultrBareMetalPlanConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/data-sources/bare_metal_plan#id DataVultrBareMetalPlan#id}
  *
  ...
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/data-sources/bare_metal_plan#filter DataVultrBareMetalPlan#filter}
  */
  readonly filter?: DataVultrBareMetalPlanFilter[] | cdktf.IResolvable;
}
export interface DataVultrBareMetalPlanFilter {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/data-sources/bare_metal_plan#name DataVultrBareMetalPlan#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/data-sources/bare_metal_plan#values DataVultrBareMetalPlan#values}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/data-sources/bare_metal_plan vultr_bare_metal_plan}
*/
export class DataVultrBareMetalPlan extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataVultrBareMetalPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/data-sources/bare_metal_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vultr/vultr/2.27.1/docs/data-sources/bare_metal_plan vultr_bare_metal_plan} Data Source
  *
  * @param scope The scope in which to define this construct
