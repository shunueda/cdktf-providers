// https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/resources/iso_private
...
export interface IsoPrivateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/resources/iso_private#id IsoPrivate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/resources/iso_private#url IsoPrivate#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/resources/iso_private vultr_iso_private}
*/
export class IsoPrivate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IsoPrivate that should be imported. Refer to the {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/resources/iso_private#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/vultr/vultr/2.28.0/docs/resources/iso_private vultr_iso_private} Resource
  *
  * @param scope The scope in which to define this construct
