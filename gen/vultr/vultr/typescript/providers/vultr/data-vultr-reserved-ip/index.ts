...
export function dataVultrReservedIpFilterToTerraform(struct?: DataVultrReservedIpFilter | cdktf.IResolvable): any {
...
export function dataVultrReservedIpFilterToHclTerraform(struct?: DataVultrReservedIpFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataVultrReservedIpFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataVultrReservedIpFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataVultrReservedIpFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataVultrReservedIpFilterList extends cdktf.ComplexList {
  public internalValue? : DataVultrReservedIpFilter[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataVultrReservedIpFilterOutputReference {
    return new DataVultrReservedIpFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataVultrReservedIp extends cdktf.TerraformDataSource {
  ...
  * @param options DataVultrReservedIpConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataVultrReservedIpConfig = {}) {
    super(scope, id, {
  ...
  private _filter = new DataVultrReservedIpFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: DataVultrReservedIpFilter[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataVultrReservedIpFilterToTerraform, true)(this._filter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktf.listMapperHcl(dataVultrReservedIpFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataVultrReservedIpFilterList",
      },
    };
