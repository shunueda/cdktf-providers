...
export interface DataVultrSshKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * filter block
  *
...
export function dataVultrSshKeyFilterToTerraform(struct?: DataVultrSshKeyFilter | cdktf.IResolvable): any {
...
export function dataVultrSshKeyFilterToHclTerraform(struct?: DataVultrSshKeyFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataVultrSshKeyFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataVultrSshKeyFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataVultrSshKeyFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataVultrSshKeyFilterList extends cdktf.ComplexList {
  public internalValue? : DataVultrSshKeyFilter[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataVultrSshKeyFilterOutputReference {
    return new DataVultrSshKeyFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataVultrSshKey extends cdktf.TerraformDataSource {
  ...
  * @param options DataVultrSshKeyConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataVultrSshKeyConfig = {}) {
    super(scope, id, {
  ...
  private _filter = new DataVultrSshKeyFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: DataVultrSshKeyFilter[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      filter: cdktf.listMapper(dataVultrSshKeyFilterToTerraform, true)(this._filter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      filter: {
        value: cdktf.listMapperHcl(dataVultrSshKeyFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataVultrSshKeyFilterList",
      },
    };
