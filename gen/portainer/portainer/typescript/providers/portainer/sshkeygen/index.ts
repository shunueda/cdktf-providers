// https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/sshkeygen
...
export interface SshkeygenConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/sshkeygen#id Sshkeygen#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/sshkeygen portainer_sshkeygen}
*/
export class Sshkeygen extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sshkeygen that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/sshkeygen#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/sshkeygen portainer_sshkeygen} Resource
  *
  * @param scope The scope in which to define this construct
