// https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/edge_stack_webhook
...
export interface EdgeStackWebhookConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/edge_stack_webhook#id EdgeStackWebhook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/edge_stack_webhook#webhook_id EdgeStackWebhook#webhook_id}
  */
  readonly webhookId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/edge_stack_webhook portainer_edge_stack_webhook}
*/
export class EdgeStackWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EdgeStackWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/edge_stack_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/edge_stack_webhook portainer_edge_stack_webhook} Resource
  *
  * @param scope The scope in which to define this construct
