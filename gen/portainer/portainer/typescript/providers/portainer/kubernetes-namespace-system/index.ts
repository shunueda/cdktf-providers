// https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/kubernetes_namespace_system
...
export interface KubernetesNamespaceSystemConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/kubernetes_namespace_system#environment_id KubernetesNamespaceSystem#environment_id}
  */
  readonly environmentId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/kubernetes_namespace_system#id KubernetesNamespaceSystem#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/kubernetes_namespace_system#namespace KubernetesNamespaceSystem#namespace}
  */
  readonly namespace: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/kubernetes_namespace_system#system KubernetesNamespaceSystem#system}
  */
  readonly systemAttribute: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/kubernetes_namespace_system portainer_kubernetes_namespace_system}
*/
export class KubernetesNamespaceSystem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesNamespaceSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/kubernetes_namespace_system#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/kubernetes_namespace_system portainer_kubernetes_namespace_system} Resource
  *
  * @param scope The scope in which to define this construct
