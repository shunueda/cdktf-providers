// https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/settings_experimental
...
export interface SettingsExperimentalConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/settings_experimental#id SettingsExperimental#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/settings_experimental#openai_integration SettingsExperimental#openai_integration}
  */
  readonly openaiIntegration?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/settings_experimental portainer_settings_experimental}
*/
export class SettingsExperimental extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SettingsExperimental that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/settings_experimental#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/settings_experimental portainer_settings_experimental} Resource
  *
  * @param scope The scope in which to define this construct
