// https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/compose_convert
...
export interface ComposeConvertConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/compose_convert#compose_content ComposeConvert#compose_content}
  */
  readonly composeContent: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/compose_convert#id ComposeConvert#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/compose_convert portainer_compose_convert}
*/
export class ComposeConvert extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComposeConvert that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/compose_convert#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/compose_convert portainer_compose_convert} Resource
  *
  * @param scope The scope in which to define this construct
