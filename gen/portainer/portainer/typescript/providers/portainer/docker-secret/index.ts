// https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/docker_secret
...
export interface DockerSecretConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/docker_secret#data DockerSecret#data}
  */
  readonly data?: string;
  /**
  * Write-only secret data (supports ephemeral values; not stored in Terraform state).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/docker_secret#data_wo DockerSecret#data_wo}
  */
  readonly dataWo?: string;
  /**
  * Version flag for write-only data; must be set when using `data_wo` to trigger updates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/docker_secret#data_wo_version DockerSecret#data_wo_version}
  */
  readonly dataWoVersion?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/docker_secret#driver DockerSecret#driver}
  */
  readonly driver?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/docker_secret#endpoint_id DockerSecret#endpoint_id}
  */
  readonly endpointId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/docker_secret#id DockerSecret#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/docker_secret#labels DockerSecret#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/docker_secret#name DockerSecret#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/docker_secret#templating DockerSecret#templating}
  */
  readonly templating?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/docker_secret portainer_docker_secret}
*/
export class DockerSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DockerSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/docker_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/docker_secret portainer_docker_secret} Resource
  *
  * @param scope The scope in which to define this construct
