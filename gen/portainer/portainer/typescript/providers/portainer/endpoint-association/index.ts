// https://registry.terraform.io/providers/portainer/portainer/1.19.0/docs/resources/endpoint_association
...
export interface EndpointAssociationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.19.0/docs/resources/endpoint_association#endpoint_id EndpointAssociation#endpoint_id}
  */
  readonly endpointId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.19.0/docs/resources/endpoint_association#id EndpointAssociation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.19.0/docs/resources/endpoint_association portainer_endpoint_association}
*/
export class EndpointAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EndpointAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.19.0/docs/resources/endpoint_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.19.0/docs/resources/endpoint_association portainer_endpoint_association} Resource
  *
  * @param scope The scope in which to define this construct
