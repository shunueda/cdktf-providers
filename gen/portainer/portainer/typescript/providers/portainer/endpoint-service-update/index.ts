// https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/endpoint_service_update
...
export interface EndpointServiceUpdateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/endpoint_service_update#endpoint_id EndpointServiceUpdate#endpoint_id}
  */
  readonly endpointId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/endpoint_service_update#id EndpointServiceUpdate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/endpoint_service_update#pull_image EndpointServiceUpdate#pull_image}
  */
  readonly pullImage?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/endpoint_service_update#service_name EndpointServiceUpdate#service_name}
  */
  readonly serviceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/endpoint_service_update portainer_endpoint_service_update}
*/
export class EndpointServiceUpdate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EndpointServiceUpdate that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/endpoint_service_update#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/endpoint_service_update portainer_endpoint_service_update} Resource
  *
  * @param scope The scope in which to define this construct
