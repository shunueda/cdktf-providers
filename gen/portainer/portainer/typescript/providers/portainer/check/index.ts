// https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/check
...
export interface CheckConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/check#desired_state Check#desired_state}
  */
  readonly desiredState?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/check#endpoint_id Check#endpoint_id}
  */
  readonly endpointId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/check#id Check#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/check#max_retries Check#max_retries}
  */
  readonly maxRetries?: number;
  /**
  * Expected revision (image tag) of running containers/services.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/check#revision Check#revision}
  */
  readonly revision: string;
  /**
  * Comma-separated list of service names (without stack prefix).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/check#services_list Check#services_list}
  */
  readonly servicesList: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/check#stack_name Check#stack_name}
  */
  readonly stackName: string;
  /**
  * Initial wait before the first check (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/check#wait Check#wait}
  */
  readonly wait?: number;
  /**
  * Wait time between retry checks (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/check#wait_between_checks Check#wait_between_checks}
  */
  readonly waitBetweenChecks?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/check portainer_check}
*/
export class Check extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Check that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/check#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.18.1/docs/resources/check portainer_check} Resource
  *
  * @param scope The scope in which to define this construct
