// https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_ingresscontrollers
...
export interface KubernetesIngresscontrollersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_ingresscontrollers#environment_id KubernetesIngresscontrollers#environment_id}
  */
  readonly environmentId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_ingresscontrollers#id KubernetesIngresscontrollers#id}
  *
  ...
  * controllers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_ingresscontrollers#controllers KubernetesIngresscontrollers#controllers}
  */
...
export interface KubernetesIngresscontrollersControllers {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_ingresscontrollers#availability KubernetesIngresscontrollers#availability}
  */
  readonly availability: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_ingresscontrollers#class_name KubernetesIngresscontrollers#class_name}
  */
  readonly className: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_ingresscontrollers#name KubernetesIngresscontrollers#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_ingresscontrollers#new KubernetesIngresscontrollers#new}
  */
  readonly new: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_ingresscontrollers#type KubernetesIngresscontrollers#type}
  */
  readonly type: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_ingresscontrollers#used KubernetesIngresscontrollers#used}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_ingresscontrollers portainer_kubernetes_ingresscontrollers}
*/
export class KubernetesIngresscontrollers extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesIngresscontrollers that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_ingresscontrollers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_ingresscontrollers portainer_kubernetes_ingresscontrollers} Resource
  *
  * @param scope The scope in which to define this construct
