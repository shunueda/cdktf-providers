// https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment
...
export interface EnvironmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#environment_address Environment#environment_address}
  */
  readonly environmentAddress: string;
  /**
  * ID of the Portainer endpoint group. Default is 1 (Unassigned).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#group_id Environment#group_id}
  */
  readonly groupId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#id Environment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#name Environment#name}
  */
  readonly name: string;
  /**
  * Public IP/URL used by Portainer for Published Ports (maps to PublicURL).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#public_ip Environment#public_ip}
  */
  readonly publicIp?: string;
  /**
  * List of tag IDs to assign to the environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#tag_ids Environment#tag_ids}
  */
  readonly tagIds?: number[];
  /**
  * Map of team IDs to role IDs (e.g. teamID -> roleID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#team_access_policies Environment#team_access_policies}
  */
  readonly teamAccessPolicies?: { [key: string]: number };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#tls_ca_cert Environment#tls_ca_cert}
  */
  readonly tlsCaCert?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#tls_cert Environment#tls_cert}
  */
  readonly tlsCert?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#tls_enabled Environment#tls_enabled}
  */
  readonly tlsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#tls_key Environment#tls_key}
  */
  readonly tlsKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#tls_skip_client_verify Environment#tls_skip_client_verify}
  */
  readonly tlsSkipClientVerify?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#tls_skip_verify Environment#tls_skip_verify}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#type Environment#type}
  */
  readonly type: number;
  /**
  * Map of user IDs to role IDs (e.g. userID -> roleID)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#user_access_policies Environment#user_access_policies}
  */
  readonly userAccessPolicies?: { [key: string]: number };
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment portainer_environment}
*/
export class Environment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Environment that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/environment portainer_environment} Resource
  *
  * @param scope The scope in which to define this construct
