// https://registry.terraform.io/providers/portainer/portainer/1.19.0/docs/resources/endpoint_snapshot
...
export interface EndpointSnapshotConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.19.0/docs/resources/endpoint_snapshot#endpoint_id EndpointSnapshot#endpoint_id}
  */
  readonly endpointId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.19.0/docs/resources/endpoint_snapshot#id EndpointSnapshot#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.19.0/docs/resources/endpoint_snapshot portainer_endpoint_snapshot}
*/
export class EndpointSnapshot extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EndpointSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.19.0/docs/resources/endpoint_snapshot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.19.0/docs/resources/endpoint_snapshot portainer_endpoint_snapshot} Resource
  *
  * @param scope The scope in which to define this construct
