// https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_storage
...
export interface KubernetesStorageConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_storage#endpoint_id KubernetesStorage#endpoint_id}
  */
  readonly endpointId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_storage#id KubernetesStorage#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_storage#manifest KubernetesStorage#manifest}
  */
  readonly manifest: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_storage portainer_kubernetes_storage}
*/
export class KubernetesStorage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesStorage that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_storage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.16.1/docs/resources/kubernetes_storage portainer_kubernetes_storage} Resource
  *
  * @param scope The scope in which to define this construct
