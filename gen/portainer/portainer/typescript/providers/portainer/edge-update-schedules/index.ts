// https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/edge_update_schedules
...
export interface EdgeUpdateSchedulesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/edge_update_schedules#agent_image EdgeUpdateSchedules#agent_image}
  */
  readonly agentImage: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/edge_update_schedules#group_ids EdgeUpdateSchedules#group_ids}
  */
  readonly groupIds: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/edge_update_schedules#id EdgeUpdateSchedules#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/edge_update_schedules#name EdgeUpdateSchedules#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/edge_update_schedules#registry_id EdgeUpdateSchedules#registry_id}
  */
  readonly registryId: number;
  /**
  * Time in RFC3339 format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/edge_update_schedules#scheduled_time EdgeUpdateSchedules#scheduled_time}
  */
  readonly scheduledTime: string;
  /**
  * 0 = update, 1 = rollback
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/edge_update_schedules#type EdgeUpdateSchedules#type}
  */
  readonly type: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/edge_update_schedules#updater_image EdgeUpdateSchedules#updater_image}
  */
  readonly updaterImage: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/edge_update_schedules portainer_edge_update_schedules}
*/
export class EdgeUpdateSchedules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EdgeUpdateSchedules that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/edge_update_schedules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/edge_update_schedules portainer_edge_update_schedules} Resource
  *
  * @param scope The scope in which to define this construct
