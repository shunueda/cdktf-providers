// https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/kubernetes_namespace_access
...
export interface KubernetesNamespaceAccessConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/kubernetes_namespace_access#endpoint_id KubernetesNamespaceAccess#endpoint_id}
  */
  readonly endpointId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/kubernetes_namespace_access#id KubernetesNamespaceAccess#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/kubernetes_namespace_access#namespace_id KubernetesNamespaceAccess#namespace_id}
  */
  readonly namespaceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/kubernetes_namespace_access#teams_to_add KubernetesNamespaceAccess#teams_to_add}
  */
  readonly teamsToAdd?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/kubernetes_namespace_access#teams_to_remove KubernetesNamespaceAccess#teams_to_remove}
  */
  readonly teamsToRemove?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/kubernetes_namespace_access#users_to_add KubernetesNamespaceAccess#users_to_add}
  */
  readonly usersToAdd?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/kubernetes_namespace_access#users_to_remove KubernetesNamespaceAccess#users_to_remove}
  */
  readonly usersToRemove?: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/kubernetes_namespace_access portainer_kubernetes_namespace_access}
*/
export class KubernetesNamespaceAccess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesNamespaceAccess that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/kubernetes_namespace_access#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/kubernetes_namespace_access portainer_kubernetes_namespace_access} Resource
  *
  * @param scope The scope in which to define this construct
