// https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/open_amt_devices_features
...
export interface OpenAmtDevicesFeaturesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/open_amt_devices_features#device_id OpenAmtDevicesFeatures#device_id}
  */
  readonly deviceId: number;
  /**
  * Portainer environment (endpoint) ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/open_amt_devices_features#environment_id OpenAmtDevicesFeatures#environment_id}
  */
  readonly environmentId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/open_amt_devices_features#id OpenAmtDevicesFeatures#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/open_amt_devices_features#ider OpenAmtDevicesFeatures#ider}
  */
  readonly ider?: boolean | cdktf.IResolvable;
  /**
  * Enable KVM (Keyboard/Video/Mouse).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/open_amt_devices_features#kvm OpenAmtDevicesFeatures#kvm}
  */
  readonly kvm?: boolean | cdktf.IResolvable;
  /**
  * Enable redirection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/open_amt_devices_features#redirection OpenAmtDevicesFeatures#redirection}
  */
  readonly redirection?: boolean | cdktf.IResolvable;
  /**
  * Enable SOL (Serial Over LAN).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/open_amt_devices_features#sol OpenAmtDevicesFeatures#sol}
  */
  readonly sol?: boolean | cdktf.IResolvable;
  /**
  * User consent policy (e.g., 'none', 'all', 'kvmOnly').
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/open_amt_devices_features#user_consent OpenAmtDevicesFeatures#user_consent}
  */
  readonly userConsent?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/open_amt_devices_features portainer_open_amt_devices_features}
*/
export class OpenAmtDevicesFeatures extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpenAmtDevicesFeatures that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/open_amt_devices_features#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.18.2/docs/resources/open_amt_devices_features portainer_open_amt_devices_features} Resource
  *
  * @param scope The scope in which to define this construct
