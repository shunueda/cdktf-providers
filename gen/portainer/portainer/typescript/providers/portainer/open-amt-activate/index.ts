// https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/open_amt_activate
...
export interface OpenAmtActivateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/open_amt_activate#environment_id OpenAmtActivate#environment_id}
  */
  readonly environmentId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/open_amt_activate#id OpenAmtActivate#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/open_amt_activate portainer_open_amt_activate}
*/
export class OpenAmtActivate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpenAmtActivate that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/open_amt_activate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/open_amt_activate portainer_open_amt_activate} Resource
  *
  * @param scope The scope in which to define this construct
