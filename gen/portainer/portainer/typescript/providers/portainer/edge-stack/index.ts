// https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack
...
export interface EdgeStackConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#deployment_type EdgeStack#deployment_type}
  */
  readonly deploymentType: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#dryrun EdgeStack#dryrun}
  */
  readonly dryrun?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#edge_groups EdgeStack#edge_groups}
  */
  readonly edgeGroups: number[];
  /**
  * Environment variables for the Edge Stack
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#environment EdgeStack#environment}
  */
  readonly environment?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#file_path_in_repository EdgeStack#file_path_in_repository}
  */
  readonly filePathInRepository?: string;
  /**
  * Whether to prune unused services/networks during stack update (default: true)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#force_update EdgeStack#force_update}
  */
  readonly forceUpdate?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#git_repository_authentication EdgeStack#git_repository_authentication}
  */
  readonly gitRepositoryAuthentication?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#id EdgeStack#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#name EdgeStack#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#pre_pull_image EdgeStack#pre_pull_image}
  */
  readonly prePullImage?: boolean | cdktf.IResolvable;
  /**
  * Whether to force pull latest images during stack update (default: true)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#pull_image EdgeStack#pull_image}
  */
  readonly pullImage?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#registries EdgeStack#registries}
  */
  readonly registries?: number[];
  /**
  * Enable relative path volumes – also used as value for 'filesystemPath'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#relative_path EdgeStack#relative_path}
  */
  readonly relativePath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#repository_password EdgeStack#repository_password}
  */
  readonly repositoryPassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#repository_reference_name EdgeStack#repository_reference_name}
  */
  readonly repositoryReferenceName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#repository_url EdgeStack#repository_url}
  */
  readonly repositoryUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#repository_username EdgeStack#repository_username}
  */
  readonly repositoryUsername?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#retry_deploy EdgeStack#retry_deploy}
  */
  readonly retryDeploy?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#stack_file_content EdgeStack#stack_file_content}
  */
  readonly stackFileContent?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#stack_file_path EdgeStack#stack_file_path}
  */
  readonly stackFilePath?: string;
  /**
  * Enable autoUpdate webhook (GitOps).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#stack_webhook EdgeStack#stack_webhook}
  */
  readonly stackWebhook?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#update_interval EdgeStack#update_interval}
  */
  readonly updateInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#use_manifest_namespaces EdgeStack#use_manifest_namespaces}
  */
  readonly useManifestNamespaces?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack portainer_edge_stack}
*/
export class EdgeStack extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EdgeStack that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs/resources/edge_stack portainer_edge_stack} Resource
  *
  * @param scope The scope in which to define this construct
