// https://registry.terraform.io/providers/portainer/portainer/1.20.0/docs/resources/webhook_execute
...
export interface WebhookExecuteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.0/docs/resources/webhook_execute#edge_stack_id WebhookExecute#edge_stack_id}
  */
  readonly edgeStackId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.0/docs/resources/webhook_execute#id WebhookExecute#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.0/docs/resources/webhook_execute#stack_id WebhookExecute#stack_id}
  */
  readonly stackId?: string;
  /**
  * Webhook token for service restart webhook
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.0/docs/resources/webhook_execute#token WebhookExecute#token}
  */
  readonly token?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.20.0/docs/resources/webhook_execute portainer_webhook_execute}
*/
export class WebhookExecute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebhookExecute that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.20.0/docs/resources/webhook_execute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.20.0/docs/resources/webhook_execute portainer_webhook_execute} Resource
  *
  * @param scope The scope in which to define this construct
