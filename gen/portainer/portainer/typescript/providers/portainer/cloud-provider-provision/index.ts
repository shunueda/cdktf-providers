// https://registry.terraform.io/providers/portainer/portainer/1.18.0/docs/resources/cloud_provider_provision
...
export interface CloudProviderProvisionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.0/docs/resources/cloud_provider_provision#cloud_provider CloudProviderProvision#cloud_provider}
  */
  readonly cloudProvider: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.0/docs/resources/cloud_provider_provision#id CloudProviderProvision#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.18.0/docs/resources/cloud_provider_provision#payload CloudProviderProvision#payload}
  */
  readonly payload: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.18.0/docs/resources/cloud_provider_provision portainer_cloud_provider_provision}
*/
export class CloudProviderProvision extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudProviderProvision that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.18.0/docs/resources/cloud_provider_provision#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.18.0/docs/resources/cloud_provider_provision portainer_cloud_provider_provision} Resource
  *
  * @param scope The scope in which to define this construct
