// https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/stack_associate
...
export interface StackAssociateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/stack_associate#endpoint_id StackAssociate#endpoint_id}
  */
  readonly endpointId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/stack_associate#id StackAssociate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/stack_associate#orphaned_running StackAssociate#orphaned_running}
  */
  readonly orphanedRunning?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/stack_associate#stack_id StackAssociate#stack_id}
  */
  readonly stackId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/stack_associate#swarm_id StackAssociate#swarm_id}
  */
  readonly swarmId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/stack_associate portainer_stack_associate}
*/
export class StackAssociate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StackAssociate that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/stack_associate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.17.0/docs/resources/stack_associate portainer_stack_associate} Resource
  *
  * @param scope The scope in which to define this construct
