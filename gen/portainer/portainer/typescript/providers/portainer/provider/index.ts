// https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs
...
export interface PortainerProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs#api_key PortainerProvider#api_key}
  */
  readonly apiKey?: string;
  /**
  * Password for authentication. Must be used together with 'user'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs#api_password PortainerProvider#api_password}
  */
  readonly apiPassword?: string;
  /**
  * Username for authentication. Must be used together with 'password'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs#api_user PortainerProvider#api_user}
  */
  readonly apiUser?: string;
  /**
  * URL of the Portainer instance (e.g. https://portainer.example.com). '/api' will be appended automatically if missing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs#endpoint PortainerProvider#endpoint}
  */
  readonly endpoint: string;
  /**
  * Verify the SSL/TLS certificate for the Portainer endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs#skip_ssl_verify PortainerProvider#skip_ssl_verify}
  */
  readonly skipSslVerify?: boolean | cdktf.IResolvable;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs#alias PortainerProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs portainer}
*/
export class PortainerProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing PortainerProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/portainer/portainer/1.20.1/docs portainer} Resource
  *
  * @param scope The scope in which to define this construct
