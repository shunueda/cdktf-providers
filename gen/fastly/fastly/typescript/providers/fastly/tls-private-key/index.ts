// https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_private_key
...
export interface TlsPrivateKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_private_key#id TlsPrivateKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_private_key#key_pem TlsPrivateKey#key_pem}
  */
  readonly keyPem: string;
  /**
  * Customisable name of the private key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_private_key#name TlsPrivateKey#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_private_key fastly_tls_private_key}
*/
export class TlsPrivateKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TlsPrivateKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_private_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_private_key fastly_tls_private_key} Resource
  *
  * @param scope The scope in which to define this construct
