// https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_mutual_authentication
...
export interface TlsMutualAuthenticationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_mutual_authentication#activation_ids TlsMutualAuthentication#activation_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_mutual_authentication#cert_bundle TlsMutualAuthentication#cert_bundle}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_mutual_authentication#enforced TlsMutualAuthentication#enforced}
  */
  readonly enforced?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_mutual_authentication#id TlsMutualAuthentication#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_mutual_authentication#include TlsMutualAuthentication#include}
  */
  readonly include?: string;
  /**
  * A custom name for your mutual authentication. If name is not supplied we will auto-generate one.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_mutual_authentication#name TlsMutualAuthentication#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_mutual_authentication fastly_tls_mutual_authentication}
*/
export class TlsMutualAuthentication extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TlsMutualAuthentication that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_mutual_authentication#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_mutual_authentication fastly_tls_mutual_authentication} Resource
  *
  * @param scope The scope in which to define this construct
