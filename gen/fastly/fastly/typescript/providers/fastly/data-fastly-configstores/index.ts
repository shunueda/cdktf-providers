// https://registry.terraform.io/providers/fastly/fastly/8.5.0/docs/data-sources/configstores
...
export interface DataFastlyConfigstoresConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.5.0/docs/data-sources/configstores#id DataFastlyConfigstores#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.5.0/docs/data-sources/configstores fastly_configstores}
*/
export class DataFastlyConfigstores extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFastlyConfigstores that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.5.0/docs/data-sources/configstores#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.5.0/docs/data-sources/configstores fastly_configstores} Data Source
  *
  * @param scope The scope in which to define this construct
