// https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace
...
export interface NgwafWorkspaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace#client_ip_headers NgwafWorkspace#client_ip_headers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace#default_blocking_response_code NgwafWorkspace#default_blocking_response_code}
  */
  readonly defaultBlockingResponseCode?: number;
  /**
  * The redirect URL used if default_blocking_response_code is `301` or `302`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace#default_redirect_url NgwafWorkspace#default_redirect_url}
  */
  readonly defaultRedirectUrl?: string;
  /**
  * The description of the workspace
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace#description NgwafWorkspace#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace#id NgwafWorkspace#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace#ip_anonymization NgwafWorkspace#ip_anonymization}
  */
  readonly ipAnonymization?: string;
  /**
  * The operation mode of the workspace. Accepted values are `off`, `block`, and `log`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace#mode NgwafWorkspace#mode}
  */
  readonly mode: string;
  /**
  * The display name of the workspace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace#name NgwafWorkspace#name}
  */
  readonly name: string;
  /**
  * attack_signal_thresholds block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace#attack_signal_thresholds NgwafWorkspace#attack_signal_thresholds}
  */
...
export interface NgwafWorkspaceAttackSignalThresholds {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace#immediate NgwafWorkspace#immediate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace#one_hour NgwafWorkspace#one_hour}
  */
  readonly oneHour?: number;
  /**
  * The one-minute interval threshold. Minimum 1 and maximum 10,000. Default value 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace#one_minute NgwafWorkspace#one_minute}
  */
  readonly oneMinute?: number;
  /**
  * The ten-minute interval threshold. Minimum 1 and maximum 10,000. Default value 60.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace#ten_minutes NgwafWorkspace#ten_minutes}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace fastly_ngwaf_workspace}
*/
export class NgwafWorkspace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NgwafWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_workspace fastly_ngwaf_workspace} Resource
  *
  * @param scope The scope in which to define this construct
