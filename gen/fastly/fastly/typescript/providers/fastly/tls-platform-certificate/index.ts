// https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_platform_certificate
...
export interface TlsPlatformCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_platform_certificate#allow_untrusted_root TlsPlatformCertificate#allow_untrusted_root}
  */
  readonly allowUntrustedRoot?: boolean | cdktf.IResolvable;
  /**
  * PEM-formatted certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_platform_certificate#certificate_body TlsPlatformCertificate#certificate_body}
  */
  readonly certificateBody: string;
  /**
  * ID of TLS configuration to be used to terminate TLS traffic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_platform_certificate#configuration_id TlsPlatformCertificate#configuration_id}
  */
  readonly configurationId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_platform_certificate#id TlsPlatformCertificate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_platform_certificate#intermediates_blob TlsPlatformCertificate#intermediates_blob}
  */
  readonly intermediatesBlob: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_platform_certificate fastly_tls_platform_certificate}
*/
export class TlsPlatformCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TlsPlatformCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_platform_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/tls_platform_certificate fastly_tls_platform_certificate} Resource
  *
  * @param scope The scope in which to define this construct
