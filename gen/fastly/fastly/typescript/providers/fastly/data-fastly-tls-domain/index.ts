// https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_domain
...
export interface DataFastlyTlsDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_domain#domain DataFastlyTlsDomain#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_domain#id DataFastlyTlsDomain#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_domain fastly_tls_domain}
*/
export class DataFastlyTlsDomain extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFastlyTlsDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_domain fastly_tls_domain} Data Source
  *
  * @param scope The scope in which to define this construct
