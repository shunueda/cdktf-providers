// https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_account_signal
...
export interface NgwafAccountSignalConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_account_signal#applies_to NgwafAccountSignal#applies_to}
  */
  readonly appliesTo: string[];
  /**
  * The description of the signal.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_account_signal#description NgwafAccountSignal#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_account_signal#id NgwafAccountSignal#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_account_signal#name NgwafAccountSignal#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_account_signal fastly_ngwaf_account_signal}
*/
export class NgwafAccountSignal extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NgwafAccountSignal that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_account_signal#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/resources/ngwaf_account_signal fastly_ngwaf_account_signal} Resource
  *
  * @param scope The scope in which to define this construct
