// https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_platform_certificate_ids
...
export interface DataFastlyTlsPlatformCertificateIdsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_platform_certificate_ids#id DataFastlyTlsPlatformCertificateIds#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_platform_certificate_ids fastly_tls_platform_certificate_ids}
*/
export class DataFastlyTlsPlatformCertificateIds extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFastlyTlsPlatformCertificateIds that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_platform_certificate_ids#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_platform_certificate_ids fastly_tls_platform_certificate_ids} Data Source
  *
  * @param scope The scope in which to define this construct
