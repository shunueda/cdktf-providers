// https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/object_storage_access_keys
...
export interface ObjectStorageAccessKeysConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/object_storage_access_keys#buckets ObjectStorageAccessKeys#buckets}
  */
  readonly buckets?: string[];
  /**
  * The description of the access key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/object_storage_access_keys#description ObjectStorageAccessKeys#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/object_storage_access_keys#id ObjectStorageAccessKeys#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/object_storage_access_keys#permission ObjectStorageAccessKeys#permission}
  */
  readonly permission: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/object_storage_access_keys fastly_object_storage_access_keys}
*/
export class ObjectStorageAccessKeys extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ObjectStorageAccessKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/object_storage_access_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/object_storage_access_keys fastly_object_storage_access_keys} Resource
  *
  * @param scope The scope in which to define this construct
