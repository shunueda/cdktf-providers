// https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_activation
...
export interface DataFastlyTlsActivationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_activation#certificate_id DataFastlyTlsActivation#certificate_id}
  */
  readonly certificateId?: string;
  /**
  * ID of the TLS Configuration used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_activation#configuration_id DataFastlyTlsActivation#configuration_id}
  */
  readonly configurationId?: string;
  /**
  * Domain that TLS was enabled on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_activation#domain DataFastlyTlsActivation#domain}
  */
  readonly domain?: string;
  /**
  * Fastly Activation ID. Conflicts with all other filters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_activation#id DataFastlyTlsActivation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_activation fastly_tls_activation}
*/
export class DataFastlyTlsActivation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFastlyTlsActivation that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_activation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/data-sources/tls_activation fastly_tls_activation} Data Source
  *
  * @param scope The scope in which to define this construct
