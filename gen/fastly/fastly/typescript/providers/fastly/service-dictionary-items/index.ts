// https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_dictionary_items
...
export interface ServiceDictionaryItemsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_dictionary_items#dictionary_id ServiceDictionaryItems#dictionary_id}
  */
  readonly dictionaryId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_dictionary_items#id ServiceDictionaryItems#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_dictionary_items#items ServiceDictionaryItems#items}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_dictionary_items#manage_items ServiceDictionaryItems#manage_items}
  */
  readonly manageItems?: boolean | cdktf.IResolvable;
  /**
  * The ID of the service that the dictionary belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_dictionary_items#service_id ServiceDictionaryItems#service_id}
  */
  readonly serviceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_dictionary_items fastly_service_dictionary_items}
*/
export class ServiceDictionaryItems extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceDictionaryItems that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_dictionary_items#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_dictionary_items fastly_service_dictionary_items} Resource
  *
  * @param scope The scope in which to define this construct
