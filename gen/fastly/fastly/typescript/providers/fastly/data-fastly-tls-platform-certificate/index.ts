// https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/data-sources/tls_platform_certificate
...
export interface DataFastlyTlsPlatformCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/data-sources/tls_platform_certificate#domains DataFastlyTlsPlatformCertificate#domains}
  */
  readonly domains?: string[];
  /**
  * Unique ID assigned to certificate by Fastly. Conflicts with all the other filters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/data-sources/tls_platform_certificate#id DataFastlyTlsPlatformCertificate#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/data-sources/tls_platform_certificate fastly_tls_platform_certificate}
*/
export class DataFastlyTlsPlatformCertificate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFastlyTlsPlatformCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/data-sources/tls_platform_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.4.0/docs/data-sources/tls_platform_certificate fastly_tls_platform_certificate} Data Source
  *
  * @param scope The scope in which to define this construct
