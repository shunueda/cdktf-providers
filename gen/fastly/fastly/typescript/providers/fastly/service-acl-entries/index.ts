// https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_acl_entries
...
export interface ServiceAclEntriesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_acl_entries#acl_id ServiceAclEntries#acl_id}
  */
  readonly aclId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_acl_entries#id ServiceAclEntries#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_acl_entries#manage_entries ServiceAclEntries#manage_entries}
  */
  readonly manageEntries?: boolean | cdktf.IResolvable;
  /**
  * The ID of the Service that the ACL belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_acl_entries#service_id ServiceAclEntries#service_id}
  */
  readonly serviceId: string;
  /**
  * entry block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_acl_entries#entry ServiceAclEntries#entry}
  */
...
export interface ServiceAclEntriesEntry {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_acl_entries#comment ServiceAclEntries#comment}
  */
  readonly comment?: string;
  /**
  * An IP address that is the focus for the ACL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_acl_entries#ip ServiceAclEntries#ip}
  */
  readonly ip: string;
  /**
  * A boolean that will negate the match if true
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_acl_entries#negated ServiceAclEntries#negated}
  */
  readonly negated?: boolean | cdktf.IResolvable;
  /**
  * An optional subnet mask applied to the IP address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_acl_entries#subnet ServiceAclEntries#subnet}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_acl_entries fastly_service_acl_entries}
*/
export class ServiceAclEntries extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceAclEntries that should be imported. Refer to the {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_acl_entries#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/fastly/fastly/8.6.0/docs/resources/service_acl_entries fastly_service_acl_entries} Resource
  *
  * @param scope The scope in which to define this construct
