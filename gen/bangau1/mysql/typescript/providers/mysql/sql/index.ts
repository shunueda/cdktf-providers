// https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/sql
...
export interface SqlConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/sql#create_sql Sql#create_sql}
  */
  readonly createSql: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/sql#delete_sql Sql#delete_sql}
  */
  readonly deleteSql: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/sql#id Sql#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/sql#name Sql#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/sql mysql_sql}
*/
export class Sql extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sql that should be imported. Refer to the {@link https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/sql#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/sql mysql_sql} Resource
  *
  * @param scope The scope in which to define this construct
