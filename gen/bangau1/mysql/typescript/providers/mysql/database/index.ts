// https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/database
...
export interface DatabaseConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/database#default_character_set Database#default_character_set}
  */
  readonly defaultCharacterSet?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/database#default_collation Database#default_collation}
  */
  readonly defaultCollation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/database#id Database#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/database#name Database#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/database mysql_database}
*/
export class Database extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Database that should be imported. Refer to the {@link https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/bangau1/mysql/1.10.4/docs/resources/database mysql_database} Resource
  *
  * @param scope The scope in which to define this construct
