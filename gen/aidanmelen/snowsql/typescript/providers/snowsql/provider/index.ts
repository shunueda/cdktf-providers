// https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs
...
export interface SnowsqlProviderConfig {
  /**
  * The name of the Snowflake account. Can also come from the `SNOWFLAKE_ACCOUNT` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#account SnowsqlProvider#account}
  */
  readonly account: string;
  /**
  * Required when `oauth_refresh_token` is used. Can be sourced from `SNOWFLAKE_USE_BROWSER_AUTH` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#browser_auth SnowsqlProvider#browser_auth}
  */
  readonly browserAuth?: boolean | cdktf.IResolvable;
  /**
  * Supports passing in a custom host value to the snowflake go driver for use with privatelink.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#host SnowsqlProvider#host}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#oauth_access_token SnowsqlProvider#oauth_access_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#oauth_client_id SnowsqlProvider#oauth_client_id}
  */
  readonly oauthClientId?: string;
  /**
  * Required when `oauth_refresh_token` is used. Can be sourced from `SNOWFLAKE_OAUTH_CLIENT_SECRET` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#oauth_client_secret SnowsqlProvider#oauth_client_secret}
  */
  readonly oauthClientSecret?: string;
  /**
  * Required when `oauth_refresh_token` is used. Can be sourced from `SNOWFLAKE_OAUTH_ENDPOINT` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#oauth_endpoint SnowsqlProvider#oauth_endpoint}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#oauth_redirect_url SnowsqlProvider#oauth_redirect_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#oauth_refresh_token SnowsqlProvider#oauth_refresh_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#password SnowsqlProvider#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#port SnowsqlProvider#port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#private_key SnowsqlProvider#private_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#private_key_passphrase SnowsqlProvider#private_key_passphrase}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#private_key_path SnowsqlProvider#private_key_path}
  */
  readonly privateKeyPath?: string;
  /**
  * Support custom protocols to snowflake go driver. Can be sourced from `SNOWFLAKE_PROTOCOL` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#protocol SnowsqlProvider#protocol}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#region SnowsqlProvider#region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#role SnowsqlProvider#role}
  */
  readonly role?: string;
  /**
  * Username for username+password authentication. Can come from the `SNOWFLAKE_USER` environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#username SnowsqlProvider#username}
  */
  readonly username: string;
  /**
  * Sets the default warehouse. Optional. Can be sourced from SNOWFLAKE_WAREHOUSE environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#warehouse SnowsqlProvider#warehouse}
  */
  readonly warehouse?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#alias SnowsqlProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs snowsql}
*/
export class SnowsqlProvider extends cdktf.TerraformProvider {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "snowsql";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a SnowsqlProvider resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the SnowsqlProvider to import
  * @param importFromId The id of the existing SnowsqlProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SnowsqlProvider to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "snowsql", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aidanmelen/snowsql/1.3.3/docs snowsql} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options SnowsqlProviderConfig
  */
  public constructor(scope: Construct, id: string, config: SnowsqlProviderConfig) {
    super(scope, id, {
