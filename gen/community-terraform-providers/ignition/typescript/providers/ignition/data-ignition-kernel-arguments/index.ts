// https://registry.terraform.io/providers/community-terraform-providers/ignition/2.5.1/docs/data-sources/kernel_arguments
...
export interface DataIgnitionKernelArgumentsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/community-terraform-providers/ignition/2.5.1/docs/data-sources/kernel_arguments#id DataIgnitionKernelArguments#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/community-terraform-providers/ignition/2.5.1/docs/data-sources/kernel_arguments#shouldexist DataIgnitionKernelArguments#shouldexist}
  */
  readonly shouldexist?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/community-terraform-providers/ignition/2.5.1/docs/data-sources/kernel_arguments#shouldnotexist DataIgnitionKernelArguments#shouldnotexist}
  */
  readonly shouldnotexist?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/community-terraform-providers/ignition/2.5.1/docs/data-sources/kernel_arguments ignition_kernel_arguments}
*/
export class DataIgnitionKernelArguments extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/community-terraform-providers/ignition/2.5.1/docs/data-sources/kernel_arguments ignition_kernel_arguments} Data Source
  *
  * @param scope The scope in which to define this construct
