// https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/primary_ip
...
export interface PrimaryIpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/primary_ip#id PrimaryIp#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/primary_ip#ip_address_id PrimaryIp#ip_address_id}
  */
  readonly ipAddressId: number;
  /**
  * Defaults to `4`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/primary_ip#ip_address_version PrimaryIp#ip_address_version}
  */
  readonly ipAddressVersion?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/primary_ip#virtual_machine_id PrimaryIp#virtual_machine_id}
  */
  readonly virtualMachineId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/primary_ip netbox_primary_ip}
*/
export class PrimaryIp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrimaryIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/primary_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/primary_ip netbox_primary_ip} Resource
  *
  * @param scope The scope in which to define this construct
