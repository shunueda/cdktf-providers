...
export class DeviceConsoleServerPort extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "netbox_device_console_server_port";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "netbox_device_console_server_port", importId: importFromId, provider });
      }
  ...
  * @param options DeviceConsoleServerPortConfig
  */
  public constructor(scope: Construct, id: string, config: DeviceConsoleServerPortConfig) {
    super(scope, id, {
