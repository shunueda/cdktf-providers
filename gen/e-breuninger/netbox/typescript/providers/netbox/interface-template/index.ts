// https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/interface_template
...
export interface InterfaceTemplateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/interface_template#description InterfaceTemplate#description}
  */
  readonly description?: string;
  /**
  * Exactly one of `device_type_id` or `module_type_id` must be given.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/interface_template#device_type_id InterfaceTemplate#device_type_id}
  */
  readonly deviceTypeId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/interface_template#id InterfaceTemplate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/interface_template#label InterfaceTemplate#label}
  */
  readonly label?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/interface_template#mgmt_only InterfaceTemplate#mgmt_only}
  */
  readonly mgmtOnly?: boolean | cdktf.IResolvable;
  /**
  * Exactly one of `device_type_id` or `module_type_id` must be given.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/interface_template#module_type_id InterfaceTemplate#module_type_id}
  */
  readonly moduleTypeId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/interface_template#name InterfaceTemplate#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/interface_template#type InterfaceTemplate#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/interface_template netbox_interface_template}
*/
export class InterfaceTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfaceTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/interface_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/resources/interface_template netbox_interface_template} Resource
  *
  * @param scope The scope in which to define this construct
