// https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/data-sources/ip_range
...
export interface DataNetboxIpRangeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/data-sources/ip_range#contains DataNetboxIpRange#contains}
  */
  readonly contains: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/data-sources/ip_range netbox_ip_range}
*/
export class DataNetboxIpRange extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetboxIpRange that should be imported. Refer to the {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/data-sources/ip_range#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/data-sources/ip_range netbox_ip_range} Data Source
  *
  * @param scope The scope in which to define this construct
