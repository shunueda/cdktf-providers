// https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/data-sources/cluster
...
export interface DataNetboxClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/data-sources/cluster#cluster_group_id DataNetboxCluster#cluster_group_id}
  */
  readonly clusterGroupId?: number;
  /**
  * At least one of `name`, `site_id` or `id` must be given.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/data-sources/cluster#id DataNetboxCluster#id}
  *
  ...
  * At least one of `name`, `site_id` or `id` must be given.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/data-sources/cluster#name DataNetboxCluster#name}
  */
  readonly name?: string;
  /**
  * At least one of `name`, `site_id` or `id` must be given.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/data-sources/cluster#site_id DataNetboxCluster#site_id}
  */
  readonly siteId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/data-sources/cluster netbox_cluster}
*/
export class DataNetboxCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetboxCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/data-sources/cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.1/docs/data-sources/cluster netbox_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
