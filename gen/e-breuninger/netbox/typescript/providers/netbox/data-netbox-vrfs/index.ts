...
export interface DataNetboxVrfsVrfs {
}

export function dataNetboxVrfsVrfsToTerraform(struct?: DataNetboxVrfsVrfs): any {
...
export function dataNetboxVrfsVrfsToHclTerraform(struct?: DataNetboxVrfsVrfs): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataNetboxVrfsVrfsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataNetboxVrfsVrfs | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataNetboxVrfsVrfs | undefined) {
    if (value === undefined) {
...
export class DataNetboxVrfsVrfsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataNetboxVrfsVrfsOutputReference {
    return new DataNetboxVrfsVrfsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function dataNetboxVrfsFilterToTerraform(struct?: DataNetboxVrfsFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataNetboxVrfsFilterToHclTerraform(struct?: DataNetboxVrfsFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataNetboxVrfsFilterOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataNetboxVrfsFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataNetboxVrfsFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataNetboxVrfsFilterList extends cdktf.ComplexList {
  public internalValue? : DataNetboxVrfsFilter[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataNetboxVrfsFilterOutputReference {
    return new DataNetboxVrfsFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataNetboxVrfs extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "netbox_vrfs";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "netbox_vrfs", importId: importFromId, provider });
      }
  ...
  * @param options DataNetboxVrfsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataNetboxVrfsConfig = {}) {
    super(scope, id, {
  ...
  private _vrfs = new DataNetboxVrfsVrfsList(this, "vrfs", false);
  public get vrfs() {
    return this._vrfs;
  }

  // filter - computed: false, optional: true, required: false
  private _filter = new DataNetboxVrfsFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: DataNetboxVrfsFilter[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataNetboxVrfsFilterToTerraform, true)(this._filter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktf.listMapperHcl(dataNetboxVrfsFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataNetboxVrfsFilterList",
      },
    };
