// https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/resources/vpn_tunnel
...
export interface VpnTunnelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/resources/vpn_tunnel#description VpnTunnel#description}
  */
  readonly description?: string;
  /**
  * Valid values are `ipsec-transport`, `ipsec-tunnel`, `ip-ip` and `gre`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/resources/vpn_tunnel#encapsulation VpnTunnel#encapsulation}
  */
  readonly encapsulation: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/resources/vpn_tunnel#id VpnTunnel#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/resources/vpn_tunnel#name VpnTunnel#name}
  */
  readonly name: string;
  /**
  * Valid values are `planned`, `active` and `disabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/resources/vpn_tunnel#status VpnTunnel#status}
  */
  readonly status: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/resources/vpn_tunnel#tags VpnTunnel#tags}
  */
  readonly tags?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/resources/vpn_tunnel#tenant_id VpnTunnel#tenant_id}
  */
  readonly tenantId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/resources/vpn_tunnel#tunnel_group_id VpnTunnel#tunnel_group_id}
  */
  readonly tunnelGroupId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/resources/vpn_tunnel#tunnel_id VpnTunnel#tunnel_id}
  */
  readonly tunnelId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/resources/vpn_tunnel netbox_vpn_tunnel}
*/
export class VpnTunnel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnTunnel that should be imported. Refer to the {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/resources/vpn_tunnel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/e-breuninger/netbox/5.0.0/docs/resources/vpn_tunnel netbox_vpn_tunnel} Resource
  *
  * @param scope The scope in which to define this construct
