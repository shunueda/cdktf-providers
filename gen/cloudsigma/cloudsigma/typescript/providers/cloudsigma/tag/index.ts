// https://registry.terraform.io/providers/cloudsigma/cloudsigma/2.9.0/docs/resources/tag
...
export interface TagConfig extends cdktf.TerraformMetaArguments {
  ...
  * The tag name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudsigma/cloudsigma/2.9.0/docs/resources/tag#name Tag#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudsigma/cloudsigma/2.9.0/docs/resources/tag cloudsigma_tag}
*/
export class Tag extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Tag that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudsigma/cloudsigma/2.9.0/docs/resources/tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudsigma/cloudsigma/2.9.0/docs/resources/tag cloudsigma_tag} Resource
  *
  * @param scope The scope in which to define this construct
