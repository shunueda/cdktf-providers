// https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/team
...
export interface DataFirehydrantTeamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/team#id DataFirehydrantTeam#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/team firehydrant_team}
*/
export class DataFirehydrantTeam extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFirehydrantTeam that should be imported. Refer to the {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/team#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/team firehydrant_team} Data Source
  *
  * @param scope The scope in which to define this construct
