...
export * as dataFirehydrantEscalationPolicy from './data-firehydrant-escalation-policy';
...
export * as dataFirehydrantSignalRule from './data-firehydrant-signal-rule';
