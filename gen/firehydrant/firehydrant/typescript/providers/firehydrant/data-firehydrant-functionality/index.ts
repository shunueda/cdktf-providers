// https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/functionality
...
export interface DataFirehydrantFunctionalityConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/functionality#functionality_id DataFirehydrantFunctionality#functionality_id}
  */
  readonly functionalityId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/functionality#id DataFirehydrantFunctionality#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/functionality firehydrant_functionality}
*/
export class DataFirehydrantFunctionality extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFirehydrantFunctionality that should be imported. Refer to the {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/functionality#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/functionality firehydrant_functionality} Data Source
  *
  * @param scope The scope in which to define this construct
