// https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/ingest_url
...
export interface DataFirehydrantIngestUrlConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/ingest_url#escalation_policy_id DataFirehydrantIngestUrl#escalation_policy_id}
  */
  readonly escalationPolicyId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/ingest_url#id DataFirehydrantIngestUrl#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/ingest_url#on_call_schedule_id DataFirehydrantIngestUrl#on_call_schedule_id}
  */
  readonly onCallScheduleId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/ingest_url#team_id DataFirehydrantIngestUrl#team_id}
  */
  readonly teamId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/ingest_url#transposer DataFirehydrantIngestUrl#transposer}
  */
  readonly transposer?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/ingest_url#user_id DataFirehydrantIngestUrl#user_id}
  */
  readonly userId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/ingest_url firehydrant_ingest_url}
*/
export class DataFirehydrantIngestUrl extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFirehydrantIngestUrl that should be imported. Refer to the {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/ingest_url#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/ingest_url firehydrant_ingest_url} Data Source
  *
  * @param scope The scope in which to define this construct
