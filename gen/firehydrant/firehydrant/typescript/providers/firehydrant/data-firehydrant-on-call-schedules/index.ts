// https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/on_call_schedules
...
export interface DataFirehydrantOnCallSchedulesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/on_call_schedules#id DataFirehydrantOnCallSchedules#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/on_call_schedules#query DataFirehydrantOnCallSchedules#query}
  */
  readonly query?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/on_call_schedules#team_id DataFirehydrantOnCallSchedules#team_id}
  */
...
export function dataFirehydrantOnCallSchedulesOnCallSchedulesToTerraform(struct?: DataFirehydrantOnCallSchedulesOnCallSchedules): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataFirehydrantOnCallSchedulesOnCallSchedulesToHclTerraform(struct?: DataFirehydrantOnCallSchedulesOnCallSchedules): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataFirehydrantOnCallSchedulesOnCallSchedulesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataFirehydrantOnCallSchedulesOnCallSchedules | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataFirehydrantOnCallSchedulesOnCallSchedules | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataFirehydrantOnCallSchedulesOnCallSchedulesList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataFirehydrantOnCallSchedulesOnCallSchedulesOutputReference {
    return new DataFirehydrantOnCallSchedulesOnCallSchedulesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/on_call_schedules firehydrant_on_call_schedules}
*/
export class DataFirehydrantOnCallSchedules extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "firehydrant_on_call_schedules";
  ...
  * @param importFromId The id of the existing DataFirehydrantOnCallSchedules that should be imported. Refer to the {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/on_call_schedules#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "firehydrant_on_call_schedules", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.12/docs/data-sources/on_call_schedules firehydrant_on_call_schedules} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataFirehydrantOnCallSchedulesConfig
  */
  public constructor(scope: Construct, id: string, config: DataFirehydrantOnCallSchedulesConfig) {
    super(scope, id, {
  ...
  private _onCallSchedules = new DataFirehydrantOnCallSchedulesOnCallSchedulesList(this, "on_call_schedules", false);
