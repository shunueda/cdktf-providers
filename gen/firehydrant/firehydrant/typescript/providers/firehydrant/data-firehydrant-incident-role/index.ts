// https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/incident_role
...
export interface DataFirehydrantIncidentRoleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/incident_role#id DataFirehydrantIncidentRole#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/incident_role firehydrant_incident_role}
*/
export class DataFirehydrantIncidentRole extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFirehydrantIncidentRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/incident_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/incident_role firehydrant_incident_role} Data Source
  *
  * @param scope The scope in which to define this construct
