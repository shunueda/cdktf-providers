// https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/runbook_action
...
export interface DataFirehydrantRunbookActionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/runbook_action#integration_slug DataFirehydrantRunbookAction#integration_slug}
  */
  readonly integrationSlug: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/runbook_action#slug DataFirehydrantRunbookAction#slug}
  */
  readonly slug: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/runbook_action#type DataFirehydrantRunbookAction#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/runbook_action firehydrant_runbook_action}
*/
export class DataFirehydrantRunbookAction extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataFirehydrantRunbookAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/runbook_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/firehydrant/firehydrant/0.14.11/docs/data-sources/runbook_action firehydrant_runbook_action} Data Source
  *
  * @param scope The scope in which to define this construct
