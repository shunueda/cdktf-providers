// https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs
...
export interface IntegrationIdpAdfsConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#draft_alias IntegrationIdpAdfs#draft_alias}
  */
  readonly draftAlias?: string;
  /**
  * samlp block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#samlp IntegrationIdpAdfs#samlp}
  */
  readonly samlp: IntegrationIdpAdfsSamlp;
}
export interface IntegrationIdpAdfsSamlpConfig {
  /**
  * Clock skew in seconds that is tolerated when validating identity provider tokens. Defaults to `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#allowed_clock_skew IntegrationIdpAdfs#allowed_clock_skew}
  */
  readonly allowedClockSkew?: number;
  /**
  * Defaults to `false` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#back_channel_supported IntegrationIdpAdfs#back_channel_supported}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#base_64_saml_metadata_document IntegrationIdpAdfs#base_64_saml_metadata_document}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#disable_force_authentication IntegrationIdpAdfs#disable_force_authentication}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#disable_post_binding_authn_request IntegrationIdpAdfs#disable_post_binding_authn_request}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#disable_post_binding_logout IntegrationIdpAdfs#disable_post_binding_logout}
  */
  readonly disablePostBindingLogout?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether to respond to requests using `HTTP-POST` binding. If `true`, `HTTP-REDIRECT` binding will be used. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#disable_post_binding_response IntegrationIdpAdfs#disable_post_binding_response}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#disable_using_jwks_url IntegrationIdpAdfs#disable_using_jwks_url}
  */
  readonly disableUsingJwksUrl?: boolean | cdktf.IResolvable;
  /**
  * GUI order. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#gui_order IntegrationIdpAdfs#gui_order}
  */
  readonly guiOrder?: string;
  /**
  * Defaults to `false` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#hide_on_login_page IntegrationIdpAdfs#hide_on_login_page}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#ldap_group_attribute IntegrationIdpAdfs#ldap_group_attribute}
  */
  readonly ldapGroupAttribute?: string;
  /**
  * Defaults to `urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#name_id_policy_format IntegrationIdpAdfs#name_id_policy_format}
  */
  readonly nameIdPolicyFormat?: string;
  /**
  * Defaults to `SUBJECT` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#principal_type IntegrationIdpAdfs#principal_type}
  */
  readonly principalType?: string;
  /**
  * This is the full SAML metadata URL that was used to import the SAML configuration. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#saml_metadata_url IntegrationIdpAdfs#saml_metadata_url}
  */
  readonly samlMetadataUrl?: string;
  /**
  * Defaults to `KEY_ID` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#saml_xml_key_name_tranformer IntegrationIdpAdfs#saml_xml_key_name_tranformer}
  */
  readonly samlXmlKeyNameTranformer?: string;
  /**
  * Defaults to `RSA_SHA256` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#signature_type IntegrationIdpAdfs#signature_type}
  */
  readonly signatureType?: string;
  /**
  * Signing certificate used to validate signatures. Required if signature validation is enabled. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#signing_certificate IntegrationIdpAdfs#signing_certificate}
  */
  readonly signingCertificate?: string;
  /**
  * URL that must be used to send logout requests. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#single_logout_service_url IntegrationIdpAdfs#single_logout_service_url}
  */
  readonly singleLogoutServiceUrl?: string;
  /**
  * URL that must be used to send authentication requests (SAML AuthnRequest).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#single_sign_on_service_url IntegrationIdpAdfs#single_sign_on_service_url}
  */
  readonly singleSignOnServiceUrl: string;
  /**
  * Defaults to `FORCE` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#sync_mode IntegrationIdpAdfs#sync_mode}
  */
  readonly syncMode?: string;
  /**
  * Indicates whether the service provider expects an encrypted Assertion. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#want_assertions_encrypted IntegrationIdpAdfs#want_assertions_encrypted}
  */
  readonly wantAssertionsEncrypted?: boolean | cdktf.IResolvable;
  /**
  * Defaults to `KEY_ID` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#xml_sig_key_info_key_name_transformer IntegrationIdpAdfs#xml_sig_key_info_key_name_transformer}
  */
  readonly xmlSigKeyInfoKeyNameTransformer?: string;
}

export function integrationIdpAdfsSamlpConfigToTerraform(struct?: IntegrationIdpAdfsSamlpConfigOutputReference | IntegrationIdpAdfsSamlpConfig): any {
...
export function integrationIdpAdfsSamlpConfigToHclTerraform(struct?: IntegrationIdpAdfsSamlpConfigOutputReference | IntegrationIdpAdfsSamlpConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class IntegrationIdpAdfsSamlpConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IntegrationIdpAdfsSamlpConfig | undefined {
  ...
  public set internalValue(value: IntegrationIdpAdfsSamlpConfig | undefined) {
    if (value === undefined) {
...
export interface IntegrationIdpAdfsSamlp {
  /**
  * Adds read token role on creation. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#add_read_token_role_on_create IntegrationIdpAdfs#add_read_token_role_on_create}
  */
  readonly addReadTokenRoleOnCreate?: boolean | cdktf.IResolvable;
  /**
  * Disable maps to Keycloak's `enabled` field. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#disabled IntegrationIdpAdfs#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Name of the IdP Integration displayed in the control plane. Defaults to `Active Directory`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#display_name IntegrationIdpAdfs#display_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#first_broker_login_flow_alias IntegrationIdpAdfs#first_broker_login_flow_alias}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#link_only IntegrationIdpAdfs#link_only}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#post_broker_login_flow_alias IntegrationIdpAdfs#post_broker_login_flow_alias}
  */
  readonly postBrokerLoginFlowAlias?: string;
  /**
  * This is the provider ID of `saml`. Defaults to `saml`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#provider_id IntegrationIdpAdfs#provider_id}
  */
  readonly providerId?: string;
  /**
  * Enable if tokens must be stored after authenticating users. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#store_token IntegrationIdpAdfs#store_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#trust_email IntegrationIdpAdfs#trust_email}
  */
  readonly trustEmail?: boolean | cdktf.IResolvable;
  /**
  * config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#config IntegrationIdpAdfs#config}
  */
  readonly config: IntegrationIdpAdfsSamlpConfig;
}

export function integrationIdpAdfsSamlpToTerraform(struct?: IntegrationIdpAdfsSamlpOutputReference | IntegrationIdpAdfsSamlp): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    config: integrationIdpAdfsSamlpConfigToTerraform(struct!.config),
  }
}


export function integrationIdpAdfsSamlpToHclTerraform(struct?: IntegrationIdpAdfsSamlpOutputReference | IntegrationIdpAdfsSamlp): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    config: {
      value: integrationIdpAdfsSamlpConfigToHclTerraform(struct!.config),
      isBlock: true,
      type: "set",
      storageClassType: "IntegrationIdpAdfsSamlpConfigList",
    },
  };
...
export class IntegrationIdpAdfsSamlpOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): IntegrationIdpAdfsSamlp | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: IntegrationIdpAdfsSamlp | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _config = new IntegrationIdpAdfsSamlpConfigOutputReference(this, "config");
  public get config() {
    return this._config;
  }
  public putConfig(value: IntegrationIdpAdfsSamlpConfig) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs cyral_integration_idp_adfs}
*/
export class IntegrationIdpAdfs extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cyral_integration_idp_adfs";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a IntegrationIdpAdfs resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the IntegrationIdpAdfs to import
  * @param importFromId The id of the existing IntegrationIdpAdfs that should be imported. Refer to the {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IntegrationIdpAdfs to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "cyral_integration_idp_adfs", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_adfs cyral_integration_idp_adfs} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IntegrationIdpAdfsConfig
  */
  public constructor(scope: Construct, id: string, config: IntegrationIdpAdfsConfig) {
    super(scope, id, {
      terraformResourceType: 'cyral_integration_idp_adfs',
  ...
  private _samlp = new IntegrationIdpAdfsSamlpOutputReference(this, "samlp");
  public get samlp() {
    return this._samlp;
  }
  public putSamlp(value: IntegrationIdpAdfsSamlp) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      samlp: integrationIdpAdfsSamlpToTerraform(this._samlp.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      samlp: {
        value: integrationIdpAdfsSamlpToHclTerraform(this._samlp.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "IntegrationIdpAdfsSamlpList",
      },
    };
