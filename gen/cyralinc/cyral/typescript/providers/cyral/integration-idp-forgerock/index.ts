// https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock
...
export interface IntegrationIdpForgerockConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#draft_alias IntegrationIdpForgerock#draft_alias}
  */
  readonly draftAlias?: string;
  /**
  * samlp block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#samlp IntegrationIdpForgerock#samlp}
  */
  readonly samlp: IntegrationIdpForgerockSamlp;
}
export interface IntegrationIdpForgerockSamlpConfig {
  /**
  * Clock skew in seconds that is tolerated when validating identity provider tokens. Defaults to `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#allowed_clock_skew IntegrationIdpForgerock#allowed_clock_skew}
  */
  readonly allowedClockSkew?: number;
  /**
  * Defaults to `false` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#back_channel_supported IntegrationIdpForgerock#back_channel_supported}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#base_64_saml_metadata_document IntegrationIdpForgerock#base_64_saml_metadata_document}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#disable_force_authentication IntegrationIdpForgerock#disable_force_authentication}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#disable_post_binding_authn_request IntegrationIdpForgerock#disable_post_binding_authn_request}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#disable_post_binding_logout IntegrationIdpForgerock#disable_post_binding_logout}
  */
  readonly disablePostBindingLogout?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether to respond to requests using `HTTP-POST` binding. If `true`, `HTTP-REDIRECT` binding will be used. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#disable_post_binding_response IntegrationIdpForgerock#disable_post_binding_response}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#disable_using_jwks_url IntegrationIdpForgerock#disable_using_jwks_url}
  */
  readonly disableUsingJwksUrl?: boolean | cdktf.IResolvable;
  /**
  * GUI order. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#gui_order IntegrationIdpForgerock#gui_order}
  */
  readonly guiOrder?: string;
  /**
  * Defaults to `false` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#hide_on_login_page IntegrationIdpForgerock#hide_on_login_page}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#ldap_group_attribute IntegrationIdpForgerock#ldap_group_attribute}
  */
  readonly ldapGroupAttribute?: string;
  /**
  * Defaults to `urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#name_id_policy_format IntegrationIdpForgerock#name_id_policy_format}
  */
  readonly nameIdPolicyFormat?: string;
  /**
  * Defaults to `SUBJECT` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#principal_type IntegrationIdpForgerock#principal_type}
  */
  readonly principalType?: string;
  /**
  * This is the full SAML metadata URL that was used to import the SAML configuration. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#saml_metadata_url IntegrationIdpForgerock#saml_metadata_url}
  */
  readonly samlMetadataUrl?: string;
  /**
  * Defaults to `KEY_ID` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#saml_xml_key_name_tranformer IntegrationIdpForgerock#saml_xml_key_name_tranformer}
  */
  readonly samlXmlKeyNameTranformer?: string;
  /**
  * Defaults to `RSA_SHA256` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#signature_type IntegrationIdpForgerock#signature_type}
  */
  readonly signatureType?: string;
  /**
  * Signing certificate used to validate signatures. Required if signature validation is enabled. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#signing_certificate IntegrationIdpForgerock#signing_certificate}
  */
  readonly signingCertificate?: string;
  /**
  * URL that must be used to send logout requests. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#single_logout_service_url IntegrationIdpForgerock#single_logout_service_url}
  */
  readonly singleLogoutServiceUrl?: string;
  /**
  * URL that must be used to send authentication requests (SAML AuthnRequest).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#single_sign_on_service_url IntegrationIdpForgerock#single_sign_on_service_url}
  */
  readonly singleSignOnServiceUrl: string;
  /**
  * Defaults to `FORCE` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#sync_mode IntegrationIdpForgerock#sync_mode}
  */
  readonly syncMode?: string;
  /**
  * Indicates whether the service provider expects an encrypted Assertion. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#want_assertions_encrypted IntegrationIdpForgerock#want_assertions_encrypted}
  */
  readonly wantAssertionsEncrypted?: boolean | cdktf.IResolvable;
  /**
  * Defaults to `KEY_ID` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#xml_sig_key_info_key_name_transformer IntegrationIdpForgerock#xml_sig_key_info_key_name_transformer}
  */
  readonly xmlSigKeyInfoKeyNameTransformer?: string;
}

export function integrationIdpForgerockSamlpConfigToTerraform(struct?: IntegrationIdpForgerockSamlpConfigOutputReference | IntegrationIdpForgerockSamlpConfig): any {
...
export function integrationIdpForgerockSamlpConfigToHclTerraform(struct?: IntegrationIdpForgerockSamlpConfigOutputReference | IntegrationIdpForgerockSamlpConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class IntegrationIdpForgerockSamlpConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IntegrationIdpForgerockSamlpConfig | undefined {
  ...
  public set internalValue(value: IntegrationIdpForgerockSamlpConfig | undefined) {
    if (value === undefined) {
...
export interface IntegrationIdpForgerockSamlp {
  /**
  * Adds read token role on creation. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#add_read_token_role_on_create IntegrationIdpForgerock#add_read_token_role_on_create}
  */
  readonly addReadTokenRoleOnCreate?: boolean | cdktf.IResolvable;
  /**
  * Disable maps to Keycloak's `enabled` field. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#disabled IntegrationIdpForgerock#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Name of the IdP Integration displayed in the control plane. Defaults to `Forgerock`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#display_name IntegrationIdpForgerock#display_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#first_broker_login_flow_alias IntegrationIdpForgerock#first_broker_login_flow_alias}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#link_only IntegrationIdpForgerock#link_only}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#post_broker_login_flow_alias IntegrationIdpForgerock#post_broker_login_flow_alias}
  */
  readonly postBrokerLoginFlowAlias?: string;
  /**
  * This is the provider ID of `saml`. Defaults to `saml`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#provider_id IntegrationIdpForgerock#provider_id}
  */
  readonly providerId?: string;
  /**
  * Enable if tokens must be stored after authenticating users. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#store_token IntegrationIdpForgerock#store_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#trust_email IntegrationIdpForgerock#trust_email}
  */
  readonly trustEmail?: boolean | cdktf.IResolvable;
  /**
  * config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#config IntegrationIdpForgerock#config}
  */
  readonly config: IntegrationIdpForgerockSamlpConfig;
}

export function integrationIdpForgerockSamlpToTerraform(struct?: IntegrationIdpForgerockSamlpOutputReference | IntegrationIdpForgerockSamlp): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    config: integrationIdpForgerockSamlpConfigToTerraform(struct!.config),
  }
}


export function integrationIdpForgerockSamlpToHclTerraform(struct?: IntegrationIdpForgerockSamlpOutputReference | IntegrationIdpForgerockSamlp): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    config: {
      value: integrationIdpForgerockSamlpConfigToHclTerraform(struct!.config),
      isBlock: true,
      type: "set",
      storageClassType: "IntegrationIdpForgerockSamlpConfigList",
    },
  };
...
export class IntegrationIdpForgerockSamlpOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): IntegrationIdpForgerockSamlp | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: IntegrationIdpForgerockSamlp | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _config = new IntegrationIdpForgerockSamlpConfigOutputReference(this, "config");
  public get config() {
    return this._config;
  }
  public putConfig(value: IntegrationIdpForgerockSamlpConfig) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock cyral_integration_idp_forgerock}
*/
export class IntegrationIdpForgerock extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cyral_integration_idp_forgerock";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a IntegrationIdpForgerock resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the IntegrationIdpForgerock to import
  * @param importFromId The id of the existing IntegrationIdpForgerock that should be imported. Refer to the {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IntegrationIdpForgerock to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "cyral_integration_idp_forgerock", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_forgerock cyral_integration_idp_forgerock} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IntegrationIdpForgerockConfig
  */
  public constructor(scope: Construct, id: string, config: IntegrationIdpForgerockConfig) {
    super(scope, id, {
      terraformResourceType: 'cyral_integration_idp_forgerock',
  ...
  private _samlp = new IntegrationIdpForgerockSamlpOutputReference(this, "samlp");
  public get samlp() {
    return this._samlp;
  }
  public putSamlp(value: IntegrationIdpForgerockSamlp) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      samlp: integrationIdpForgerockSamlpToTerraform(this._samlp.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      samlp: {
        value: integrationIdpForgerockSamlpToHclTerraform(this._samlp.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "IntegrationIdpForgerockSamlpList",
      },
    };
