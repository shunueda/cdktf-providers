// https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad
...
export interface IntegrationIdpAadConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#draft_alias IntegrationIdpAad#draft_alias}
  */
  readonly draftAlias?: string;
  /**
  * samlp block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#samlp IntegrationIdpAad#samlp}
  */
  readonly samlp: IntegrationIdpAadSamlp;
}
export interface IntegrationIdpAadSamlpConfig {
  /**
  * Clock skew in seconds that is tolerated when validating identity provider tokens. Defaults to `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#allowed_clock_skew IntegrationIdpAad#allowed_clock_skew}
  */
  readonly allowedClockSkew?: number;
  /**
  * Defaults to `false` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#back_channel_supported IntegrationIdpAad#back_channel_supported}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#base_64_saml_metadata_document IntegrationIdpAad#base_64_saml_metadata_document}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#disable_force_authentication IntegrationIdpAad#disable_force_authentication}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#disable_post_binding_authn_request IntegrationIdpAad#disable_post_binding_authn_request}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#disable_post_binding_logout IntegrationIdpAad#disable_post_binding_logout}
  */
  readonly disablePostBindingLogout?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether to respond to requests using `HTTP-POST` binding. If `true`, `HTTP-REDIRECT` binding will be used. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#disable_post_binding_response IntegrationIdpAad#disable_post_binding_response}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#disable_using_jwks_url IntegrationIdpAad#disable_using_jwks_url}
  */
  readonly disableUsingJwksUrl?: boolean | cdktf.IResolvable;
  /**
  * GUI order. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#gui_order IntegrationIdpAad#gui_order}
  */
  readonly guiOrder?: string;
  /**
  * Defaults to `false` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#hide_on_login_page IntegrationIdpAad#hide_on_login_page}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#ldap_group_attribute IntegrationIdpAad#ldap_group_attribute}
  */
  readonly ldapGroupAttribute?: string;
  /**
  * Defaults to `urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#name_id_policy_format IntegrationIdpAad#name_id_policy_format}
  */
  readonly nameIdPolicyFormat?: string;
  /**
  * Defaults to `SUBJECT` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#principal_type IntegrationIdpAad#principal_type}
  */
  readonly principalType?: string;
  /**
  * This is the full SAML metadata URL that was used to import the SAML configuration. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#saml_metadata_url IntegrationIdpAad#saml_metadata_url}
  */
  readonly samlMetadataUrl?: string;
  /**
  * Defaults to `KEY_ID` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#saml_xml_key_name_tranformer IntegrationIdpAad#saml_xml_key_name_tranformer}
  */
  readonly samlXmlKeyNameTranformer?: string;
  /**
  * Defaults to `RSA_SHA256` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#signature_type IntegrationIdpAad#signature_type}
  */
  readonly signatureType?: string;
  /**
  * Signing certificate used to validate signatures. Required if signature validation is enabled. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#signing_certificate IntegrationIdpAad#signing_certificate}
  */
  readonly signingCertificate?: string;
  /**
  * URL that must be used to send logout requests. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#single_logout_service_url IntegrationIdpAad#single_logout_service_url}
  */
  readonly singleLogoutServiceUrl?: string;
  /**
  * URL that must be used to send authentication requests (SAML AuthnRequest).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#single_sign_on_service_url IntegrationIdpAad#single_sign_on_service_url}
  */
  readonly singleSignOnServiceUrl: string;
  /**
  * Defaults to `FORCE` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#sync_mode IntegrationIdpAad#sync_mode}
  */
  readonly syncMode?: string;
  /**
  * Indicates whether the service provider expects an encrypted Assertion. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#want_assertions_encrypted IntegrationIdpAad#want_assertions_encrypted}
  */
  readonly wantAssertionsEncrypted?: boolean | cdktf.IResolvable;
  /**
  * Defaults to `KEY_ID` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#xml_sig_key_info_key_name_transformer IntegrationIdpAad#xml_sig_key_info_key_name_transformer}
  */
  readonly xmlSigKeyInfoKeyNameTransformer?: string;
}

export function integrationIdpAadSamlpConfigToTerraform(struct?: IntegrationIdpAadSamlpConfigOutputReference | IntegrationIdpAadSamlpConfig): any {
...
export function integrationIdpAadSamlpConfigToHclTerraform(struct?: IntegrationIdpAadSamlpConfigOutputReference | IntegrationIdpAadSamlpConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class IntegrationIdpAadSamlpConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IntegrationIdpAadSamlpConfig | undefined {
  ...
  public set internalValue(value: IntegrationIdpAadSamlpConfig | undefined) {
    if (value === undefined) {
...
export interface IntegrationIdpAadSamlp {
  /**
  * Adds read token role on creation. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#add_read_token_role_on_create IntegrationIdpAad#add_read_token_role_on_create}
  */
  readonly addReadTokenRoleOnCreate?: boolean | cdktf.IResolvable;
  /**
  * Disable maps to Keycloak's `enabled` field. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#disabled IntegrationIdpAad#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Name of the IdP Integration displayed in the control plane. Defaults to `Azure Active Directory`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#display_name IntegrationIdpAad#display_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#first_broker_login_flow_alias IntegrationIdpAad#first_broker_login_flow_alias}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#link_only IntegrationIdpAad#link_only}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#post_broker_login_flow_alias IntegrationIdpAad#post_broker_login_flow_alias}
  */
  readonly postBrokerLoginFlowAlias?: string;
  /**
  * This is the provider ID of `saml`. Defaults to `saml`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#provider_id IntegrationIdpAad#provider_id}
  */
  readonly providerId?: string;
  /**
  * Enable if tokens must be stored after authenticating users. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#store_token IntegrationIdpAad#store_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#trust_email IntegrationIdpAad#trust_email}
  */
  readonly trustEmail?: boolean | cdktf.IResolvable;
  /**
  * config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#config IntegrationIdpAad#config}
  */
  readonly config: IntegrationIdpAadSamlpConfig;
}

export function integrationIdpAadSamlpToTerraform(struct?: IntegrationIdpAadSamlpOutputReference | IntegrationIdpAadSamlp): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    config: integrationIdpAadSamlpConfigToTerraform(struct!.config),
  }
}


export function integrationIdpAadSamlpToHclTerraform(struct?: IntegrationIdpAadSamlpOutputReference | IntegrationIdpAadSamlp): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    config: {
      value: integrationIdpAadSamlpConfigToHclTerraform(struct!.config),
      isBlock: true,
      type: "set",
      storageClassType: "IntegrationIdpAadSamlpConfigList",
    },
  };
...
export class IntegrationIdpAadSamlpOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): IntegrationIdpAadSamlp | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: IntegrationIdpAadSamlp | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _config = new IntegrationIdpAadSamlpConfigOutputReference(this, "config");
  public get config() {
    return this._config;
  }
  public putConfig(value: IntegrationIdpAadSamlpConfig) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad cyral_integration_idp_aad}
*/
export class IntegrationIdpAad extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cyral_integration_idp_aad";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a IntegrationIdpAad resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the IntegrationIdpAad to import
  * @param importFromId The id of the existing IntegrationIdpAad that should be imported. Refer to the {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IntegrationIdpAad to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "cyral_integration_idp_aad", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_aad cyral_integration_idp_aad} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IntegrationIdpAadConfig
  */
  public constructor(scope: Construct, id: string, config: IntegrationIdpAadConfig) {
    super(scope, id, {
      terraformResourceType: 'cyral_integration_idp_aad',
  ...
  private _samlp = new IntegrationIdpAadSamlpOutputReference(this, "samlp");
  public get samlp() {
    return this._samlp;
  }
  public putSamlp(value: IntegrationIdpAadSamlp) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      samlp: integrationIdpAadSamlpToTerraform(this._samlp.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      samlp: {
        value: integrationIdpAadSamlpToHclTerraform(this._samlp.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "IntegrationIdpAadSamlpList",
      },
    };
