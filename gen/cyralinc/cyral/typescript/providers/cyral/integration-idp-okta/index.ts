// https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta
...
export interface IntegrationIdpOktaConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#draft_alias IntegrationIdpOkta#draft_alias}
  */
  readonly draftAlias?: string;
  /**
  * samlp block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#samlp IntegrationIdpOkta#samlp}
  */
  readonly samlp: IntegrationIdpOktaSamlp;
}
export interface IntegrationIdpOktaSamlpConfig {
  /**
  * Clock skew in seconds that is tolerated when validating identity provider tokens. Defaults to `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#allowed_clock_skew IntegrationIdpOkta#allowed_clock_skew}
  */
  readonly allowedClockSkew?: number;
  /**
  * Defaults to `false` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#back_channel_supported IntegrationIdpOkta#back_channel_supported}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#base_64_saml_metadata_document IntegrationIdpOkta#base_64_saml_metadata_document}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#disable_force_authentication IntegrationIdpOkta#disable_force_authentication}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#disable_post_binding_authn_request IntegrationIdpOkta#disable_post_binding_authn_request}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#disable_post_binding_logout IntegrationIdpOkta#disable_post_binding_logout}
  */
  readonly disablePostBindingLogout?: boolean | cdktf.IResolvable;
  /**
  * Indicates whether to respond to requests using `HTTP-POST` binding. If `true`, `HTTP-REDIRECT` binding will be used. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#disable_post_binding_response IntegrationIdpOkta#disable_post_binding_response}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#disable_using_jwks_url IntegrationIdpOkta#disable_using_jwks_url}
  */
  readonly disableUsingJwksUrl?: boolean | cdktf.IResolvable;
  /**
  * GUI order. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#gui_order IntegrationIdpOkta#gui_order}
  */
  readonly guiOrder?: string;
  /**
  * Defaults to `false` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#hide_on_login_page IntegrationIdpOkta#hide_on_login_page}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#ldap_group_attribute IntegrationIdpOkta#ldap_group_attribute}
  */
  readonly ldapGroupAttribute?: string;
  /**
  * Defaults to `urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#name_id_policy_format IntegrationIdpOkta#name_id_policy_format}
  */
  readonly nameIdPolicyFormat?: string;
  /**
  * Defaults to `SUBJECT` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#principal_type IntegrationIdpOkta#principal_type}
  */
  readonly principalType?: string;
  /**
  * This is the full SAML metadata URL that was used to import the SAML configuration. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#saml_metadata_url IntegrationIdpOkta#saml_metadata_url}
  */
  readonly samlMetadataUrl?: string;
  /**
  * Defaults to `KEY_ID` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#saml_xml_key_name_tranformer IntegrationIdpOkta#saml_xml_key_name_tranformer}
  */
  readonly samlXmlKeyNameTranformer?: string;
  /**
  * Defaults to `RSA_SHA256` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#signature_type IntegrationIdpOkta#signature_type}
  */
  readonly signatureType?: string;
  /**
  * Signing certificate used to validate signatures. Required if signature validation is enabled. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#signing_certificate IntegrationIdpOkta#signing_certificate}
  */
  readonly signingCertificate?: string;
  /**
  * URL that must be used to send logout requests. Defaults to `""`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#single_logout_service_url IntegrationIdpOkta#single_logout_service_url}
  */
  readonly singleLogoutServiceUrl?: string;
  /**
  * URL that must be used to send authentication requests (SAML AuthnRequest).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#single_sign_on_service_url IntegrationIdpOkta#single_sign_on_service_url}
  */
  readonly singleSignOnServiceUrl: string;
  /**
  * Defaults to `FORCE` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#sync_mode IntegrationIdpOkta#sync_mode}
  */
  readonly syncMode?: string;
  /**
  * Indicates whether the service provider expects an encrypted Assertion. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#want_assertions_encrypted IntegrationIdpOkta#want_assertions_encrypted}
  */
  readonly wantAssertionsEncrypted?: boolean | cdktf.IResolvable;
  /**
  * Defaults to `KEY_ID` if unset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#xml_sig_key_info_key_name_transformer IntegrationIdpOkta#xml_sig_key_info_key_name_transformer}
  */
  readonly xmlSigKeyInfoKeyNameTransformer?: string;
}

export function integrationIdpOktaSamlpConfigToTerraform(struct?: IntegrationIdpOktaSamlpConfigOutputReference | IntegrationIdpOktaSamlpConfig): any {
...
export function integrationIdpOktaSamlpConfigToHclTerraform(struct?: IntegrationIdpOktaSamlpConfigOutputReference | IntegrationIdpOktaSamlpConfig): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class IntegrationIdpOktaSamlpConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IntegrationIdpOktaSamlpConfig | undefined {
  ...
  public set internalValue(value: IntegrationIdpOktaSamlpConfig | undefined) {
    if (value === undefined) {
...
export interface IntegrationIdpOktaSamlp {
  /**
  * Adds read token role on creation. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#add_read_token_role_on_create IntegrationIdpOkta#add_read_token_role_on_create}
  */
  readonly addReadTokenRoleOnCreate?: boolean | cdktf.IResolvable;
  /**
  * Disable maps to Keycloak's `enabled` field. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#disabled IntegrationIdpOkta#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Name of the IdP Integration displayed in the control plane. Defaults to `Okta`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#display_name IntegrationIdpOkta#display_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#first_broker_login_flow_alias IntegrationIdpOkta#first_broker_login_flow_alias}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#link_only IntegrationIdpOkta#link_only}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#post_broker_login_flow_alias IntegrationIdpOkta#post_broker_login_flow_alias}
  */
  readonly postBrokerLoginFlowAlias?: string;
  /**
  * This is the provider ID of `saml`. Defaults to `saml`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#provider_id IntegrationIdpOkta#provider_id}
  */
  readonly providerId?: string;
  /**
  * Enable if tokens must be stored after authenticating users. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#store_token IntegrationIdpOkta#store_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#trust_email IntegrationIdpOkta#trust_email}
  */
  readonly trustEmail?: boolean | cdktf.IResolvable;
  /**
  * config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#config IntegrationIdpOkta#config}
  */
  readonly config: IntegrationIdpOktaSamlpConfig;
}

export function integrationIdpOktaSamlpToTerraform(struct?: IntegrationIdpOktaSamlpOutputReference | IntegrationIdpOktaSamlp): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    config: integrationIdpOktaSamlpConfigToTerraform(struct!.config),
  }
}


export function integrationIdpOktaSamlpToHclTerraform(struct?: IntegrationIdpOktaSamlpOutputReference | IntegrationIdpOktaSamlp): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    config: {
      value: integrationIdpOktaSamlpConfigToHclTerraform(struct!.config),
      isBlock: true,
      type: "set",
      storageClassType: "IntegrationIdpOktaSamlpConfigList",
    },
  };
...
export class IntegrationIdpOktaSamlpOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): IntegrationIdpOktaSamlp | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: IntegrationIdpOktaSamlp | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _config = new IntegrationIdpOktaSamlpConfigOutputReference(this, "config");
  public get config() {
    return this._config;
  }
  public putConfig(value: IntegrationIdpOktaSamlpConfig) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta cyral_integration_idp_okta}
*/
export class IntegrationIdpOkta extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cyral_integration_idp_okta";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a IntegrationIdpOkta resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the IntegrationIdpOkta to import
  * @param importFromId The id of the existing IntegrationIdpOkta that should be imported. Refer to the {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IntegrationIdpOkta to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "cyral_integration_idp_okta", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cyralinc/cyral/4.16.3/docs/resources/integration_idp_okta cyral_integration_idp_okta} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IntegrationIdpOktaConfig
  */
  public constructor(scope: Construct, id: string, config: IntegrationIdpOktaConfig) {
    super(scope, id, {
      terraformResourceType: 'cyral_integration_idp_okta',
  ...
  private _samlp = new IntegrationIdpOktaSamlpOutputReference(this, "samlp");
  public get samlp() {
    return this._samlp;
  }
  public putSamlp(value: IntegrationIdpOktaSamlp) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      samlp: integrationIdpOktaSamlpToTerraform(this._samlp.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      samlp: {
        value: integrationIdpOktaSamlpToHclTerraform(this._samlp.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "IntegrationIdpOktaSamlpList",
      },
    };
