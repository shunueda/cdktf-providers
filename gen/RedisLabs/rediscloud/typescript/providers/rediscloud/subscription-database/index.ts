// https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database
...
export interface SubscriptionDatabaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#average_item_size_in_bytes SubscriptionDatabase#average_item_size_in_bytes}
  */
  readonly averageItemSizeInBytes?: number;
  /**
  * SSL certificate to authenticate user connections
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#client_ssl_certificate SubscriptionDatabase#client_ssl_certificate}
  */
  readonly clientSslCertificate?: string;
  /**
  * TLS certificates to authenticate user connections
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#client_tls_certificates SubscriptionDatabase#client_tls_certificates}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#data_eviction SubscriptionDatabase#data_eviction}
  */
  readonly dataEviction?: string;
  /**
  * Rate of database data persistence (in persistent storage)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#data_persistence SubscriptionDatabase#data_persistence}
  */
  readonly dataPersistence?: string;
  /**
  * Maximum amount of data in the dataset for this specific database in GB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#dataset_size_in_gb SubscriptionDatabase#dataset_size_in_gb}
  */
  readonly datasetSizeInGb?: number;
  /**
  * When 'true', enables connecting to the database with the 'default' user. Default: 'true'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#enable_default_user SubscriptionDatabase#enable_default_user}
  */
  readonly enableDefaultUser?: boolean | cdktf.IResolvable;
  /**
  * Use TLS for authentication
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#enable_tls SubscriptionDatabase#enable_tls}
  */
  readonly enableTls?: boolean | cdktf.IResolvable;
  /**
  * Should use the external endpoint for open-source (OSS) Cluster API
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#external_endpoint_for_oss_cluster_api SubscriptionDatabase#external_endpoint_for_oss_cluster_api}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#hashing_policy SubscriptionDatabase#hashing_policy}
  */
  readonly hashingPolicy?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#id SubscriptionDatabase#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#memory_limit_in_gb SubscriptionDatabase#memory_limit_in_gb}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#modules SubscriptionDatabase#modules}
  */
  readonly modules?: SubscriptionDatabaseModules[] | cdktf.IResolvable;
  /**
  * A meaningful name to identify the database
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#name SubscriptionDatabase#name}
  */
  readonly name: string;
  /**
  * Password used to access the database. If left empty, the password will be generated automatically
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#password SubscriptionDatabase#password}
  */
  readonly password?: string;
  /**
  * Path that will be used to store database backup files
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#periodic_backup_path SubscriptionDatabase#periodic_backup_path}
  */
  readonly periodicBackupPath?: string;
  /**
  * TCP port on which the database is available
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#port SubscriptionDatabase#port}
  */
  readonly port?: number;
  /**
  * The protocol that will be used to access the database (either ‘redis’ or 'memcached’)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#protocol SubscriptionDatabase#protocol}
  */
  readonly protocol?: string;
  /**
  * Query performance factor for this specific database
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#query_performance_factor SubscriptionDatabase#query_performance_factor}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#redis_version SubscriptionDatabase#redis_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#replica_of SubscriptionDatabase#replica_of}
  */
  readonly replicaOf?: string[];
  /**
  * Databases replication
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#replication SubscriptionDatabase#replication}
  */
  readonly replication?: boolean | cdktf.IResolvable;
  /**
  * The database's RESP version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#resp_version SubscriptionDatabase#resp_version}
  */
  readonly respVersion?: string;
  /**
  * Set of CIDR addresses to allow access to the database
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#source_ips SubscriptionDatabase#source_ips}
  */
  readonly sourceIps?: string[];
  /**
  * Identifier of the pro subscription
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#subscription_id SubscriptionDatabase#subscription_id}
  */
  readonly subscriptionId: number;
  /**
  * Support Redis open-source (OSS) Cluster API
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#support_oss_cluster_api SubscriptionDatabase#support_oss_cluster_api}
  */
  readonly supportOssClusterApi?: boolean | cdktf.IResolvable;
  /**
  * Tags for database management
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#tags SubscriptionDatabase#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Throughput measurement method, (either ‘number-of-shards’ or ‘operations-per-second’)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#throughput_measurement_by SubscriptionDatabase#throughput_measurement_by}
  */
  readonly throughputMeasurementBy: string;
  /**
  * Throughput value (as applies to selected measurement method)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#throughput_measurement_value SubscriptionDatabase#throughput_measurement_value}
  */
  readonly throughputMeasurementValue: number;
  /**
  * alert block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#alert SubscriptionDatabase#alert}
  */
  readonly alert?: SubscriptionDatabaseAlert[] | cdktf.IResolvable;
  /**
  * remote_backup block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#remote_backup SubscriptionDatabase#remote_backup}
  */
  readonly remoteBackup?: SubscriptionDatabaseRemoteBackup;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#timeouts SubscriptionDatabase#timeouts}
  */
...
export interface SubscriptionDatabaseAlert {
  ...
  * Alert value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#value SubscriptionDatabase#value}
  */
...
export interface SubscriptionDatabaseRemoteBackup {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#interval SubscriptionDatabase#interval}
  */
  readonly interval: string;
  /**
  * Defines a URI representing the backup storage location
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#storage_path SubscriptionDatabase#storage_path}
  */
  readonly storagePath: string;
  /**
  * Defines the provider of the storage location
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#storage_type SubscriptionDatabase#storage_type}
  */
  readonly storageType: string;
  /**
  * Defines the hour automatic backups are made - only applicable when interval is `every-12-hours` or `every-24-hours`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#time_utc SubscriptionDatabase#time_utc}
  */
...
export interface SubscriptionDatabaseTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#create SubscriptionDatabase#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#delete SubscriptionDatabase#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#read SubscriptionDatabase#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#update SubscriptionDatabase#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database rediscloud_subscription_database}
*/
export class SubscriptionDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SubscriptionDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/subscription_database rediscloud_subscription_database} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // source_ips - computed: true, optional: true, required: false
