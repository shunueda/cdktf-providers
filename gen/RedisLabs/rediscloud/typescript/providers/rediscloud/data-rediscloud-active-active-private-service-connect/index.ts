// https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_private_service_connect
...
export interface DataRediscloudActiveActivePrivateServiceConnectConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_private_service_connect#id DataRediscloudActiveActivePrivateServiceConnect#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_private_service_connect#region_id DataRediscloudActiveActivePrivateServiceConnect#region_id}
  */
  readonly regionId: number;
  /**
  * The ID of an Active-Active subscription
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_private_service_connect#subscription_id DataRediscloudActiveActivePrivateServiceConnect#subscription_id}
  */
  readonly subscriptionId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_private_service_connect rediscloud_active_active_private_service_connect}
*/
export class DataRediscloudActiveActivePrivateServiceConnect extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRediscloudActiveActivePrivateServiceConnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_private_service_connect#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_private_service_connect rediscloud_active_active_private_service_connect} Data Source
  *
  * @param scope The scope in which to define this construct
