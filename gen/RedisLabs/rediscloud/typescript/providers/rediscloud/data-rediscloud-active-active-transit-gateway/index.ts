// https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_transit_gateway
...
export interface DataRediscloudActiveActiveTransitGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_transit_gateway#aws_tgw_uid DataRediscloudActiveActiveTransitGateway#aws_tgw_uid}
  */
  readonly awsTgwUid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_transit_gateway#id DataRediscloudActiveActiveTransitGateway#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_transit_gateway#region_id DataRediscloudActiveActiveTransitGateway#region_id}
  */
  readonly regionId: number;
  /**
  * The id of an Active Active subscription
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_transit_gateway#subscription_id DataRediscloudActiveActiveTransitGateway#subscription_id}
  */
  readonly subscriptionId: string;
  /**
  * The id of the Transit Gateway relative to the associated subscription
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_transit_gateway#tgw_id DataRediscloudActiveActiveTransitGateway#tgw_id}
  */
  readonly tgwId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_transit_gateway rediscloud_active_active_transit_gateway}
*/
export class DataRediscloudActiveActiveTransitGateway extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRediscloudActiveActiveTransitGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_transit_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/active_active_transit_gateway rediscloud_active_active_transit_gateway} Data Source
  *
  * @param scope The scope in which to define this construct
