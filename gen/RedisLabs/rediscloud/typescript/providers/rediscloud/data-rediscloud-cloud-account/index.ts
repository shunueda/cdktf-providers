// https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/cloud_account
...
export interface DataRediscloudCloudAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/cloud_account#exclude_internal_account DataRediscloudCloudAccount#exclude_internal_account}
  */
  readonly excludeInternalAccount?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/cloud_account#id DataRediscloudCloudAccount#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/cloud_account#name DataRediscloudCloudAccount#name}
  */
  readonly name?: string;
  /**
  * The cloud provider of the cloud account, (either `AWS` or `GCP`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/cloud_account#provider_type DataRediscloudCloudAccount#provider_type}
  */
  readonly providerType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/cloud_account rediscloud_cloud_account}
*/
export class DataRediscloudCloudAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRediscloudCloudAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/cloud_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/cloud_account rediscloud_cloud_account} Data Source
  *
  * @param scope The scope in which to define this construct
