// https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account
...
export interface CloudAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account#access_key_id CloudAccount#access_key_id}
  */
  readonly accessKeyId: string;
  /**
  * Cloud provider secret key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account#access_secret_key CloudAccount#access_secret_key}
  */
  readonly accessSecretKey: string;
  /**
  * Cloud provider management console password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account#console_password CloudAccount#console_password}
  */
  readonly consolePassword: string;
  /**
  * Cloud provider management console username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account#console_username CloudAccount#console_username}
  */
  readonly consoleUsername: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account#id CloudAccount#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account#name CloudAccount#name}
  */
  readonly name: string;
  /**
  * Cloud provider type - either `AWS` or `GCP`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account#provider_type CloudAccount#provider_type}
  */
  readonly providerType: string;
  /**
  * Cloud provider management console login URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account#sign_in_login_url CloudAccount#sign_in_login_url}
  */
  readonly signInLoginUrl: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account#timeouts CloudAccount#timeouts}
  */
  readonly timeouts?: CloudAccountTimeouts;
}
export interface CloudAccountTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account#create CloudAccount#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account#delete CloudAccount#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account#read CloudAccount#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account#update CloudAccount#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account rediscloud_cloud_account}
*/
export class CloudAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/resources/cloud_account rediscloud_cloud_account} Resource
  *
  * @param scope The scope in which to define this construct
