// https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/essentials_subscription
...
export interface DataRediscloudEssentialsSubscriptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/essentials_subscription#id DataRediscloudEssentialsSubscription#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/essentials_subscription#name DataRediscloudEssentialsSubscription#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/essentials_subscription rediscloud_essentials_subscription}
*/
export class DataRediscloudEssentialsSubscription extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRediscloudEssentialsSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/essentials_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.7.3/docs/data-sources/essentials_subscription rediscloud_essentials_subscription} Data Source
  *
  * @param scope The scope in which to define this construct
