// https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/essentials_plan
...
export interface DataRediscloudEssentialsPlanConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/essentials_plan#availability DataRediscloudEssentialsPlan#availability}
  */
  readonly availability?: string;
  /**
  * The cloud provider: 'AWS', 'GCP' or 'Azure'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/essentials_plan#cloud_provider DataRediscloudEssentialsPlan#cloud_provider}
  */
  readonly cloudProvider?: string;
  /**
  * The plan's unique identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/essentials_plan#id DataRediscloudEssentialsPlan#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/essentials_plan#name DataRediscloudEssentialsPlan#name}
  */
  readonly name?: string;
  /**
  * The region to place databases in, format and availability dependent on cloud_provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/essentials_plan#region DataRediscloudEssentialsPlan#region}
  */
  readonly region?: string;
  /**
  * The capacity of databases created in this plan
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/essentials_plan#size DataRediscloudEssentialsPlan#size}
  */
  readonly size?: number;
  /**
  * The units of 'size', usually 'MB' or 'GB'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/essentials_plan#size_measurement_unit DataRediscloudEssentialsPlan#size_measurement_unit}
  */
  readonly sizeMeasurementUnit?: string;
  /**
  * Filter plans by what is available for a given subscription
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/essentials_plan#subscription_id DataRediscloudEssentialsPlan#subscription_id}
  */
  readonly subscriptionId?: number;
  /**
  * Self-explanatory
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/essentials_plan#support_data_persistence DataRediscloudEssentialsPlan#support_data_persistence}
  */
  readonly supportDataPersistence?: boolean | cdktf.IResolvable;
  /**
  * Self-explanatory
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/essentials_plan#support_replication DataRediscloudEssentialsPlan#support_replication}
  */
  readonly supportReplication?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/essentials_plan rediscloud_essentials_plan}
*/
export class DataRediscloudEssentialsPlan extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRediscloudEssentialsPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/essentials_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.10.0/docs/data-sources/essentials_plan rediscloud_essentials_plan} Data Source
  *
  * @param scope The scope in which to define this construct
