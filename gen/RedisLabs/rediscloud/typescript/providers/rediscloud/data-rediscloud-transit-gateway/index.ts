// https://registry.terraform.io/providers/redislabs/rediscloud/2.8.0/docs/data-sources/transit_gateway
...
export interface DataRediscloudTransitGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.8.0/docs/data-sources/transit_gateway#aws_tgw_uid DataRediscloudTransitGateway#aws_tgw_uid}
  */
  readonly awsTgwUid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.8.0/docs/data-sources/transit_gateway#id DataRediscloudTransitGateway#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.8.0/docs/data-sources/transit_gateway#subscription_id DataRediscloudTransitGateway#subscription_id}
  */
  readonly subscriptionId: string;
  /**
  * The id of the Transit Gateway relative to the associated subscription
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.8.0/docs/data-sources/transit_gateway#tgw_id DataRediscloudTransitGateway#tgw_id}
  */
  readonly tgwId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.8.0/docs/data-sources/transit_gateway rediscloud_transit_gateway}
*/
export class DataRediscloudTransitGateway extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRediscloudTransitGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.8.0/docs/data-sources/transit_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/redislabs/rediscloud/2.8.0/docs/data-sources/transit_gateway rediscloud_transit_gateway} Data Source
  *
  * @param scope The scope in which to define this construct
