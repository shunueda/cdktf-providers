...
export interface ActiveActiveTransitGatewayInvitationAcceptorConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function activeActiveTransitGatewayInvitationAcceptorTimeoutsToTerraform(struct?: ActiveActiveTransitGatewayInvitationAcceptorTimeouts | cdktf.IResolvable): any {
...
export function activeActiveTransitGatewayInvitationAcceptorTimeoutsToHclTerraform(struct?: ActiveActiveTransitGatewayInvitationAcceptorTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ActiveActiveTransitGatewayInvitationAcceptorTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ActiveActiveTransitGatewayInvitationAcceptorTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ActiveActiveTransitGatewayInvitationAcceptorTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ActiveActiveTransitGatewayInvitationAcceptor extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "rediscloud_active_active_transit_gateway_invitation_acceptor";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "rediscloud_active_active_transit_gateway_invitation_acceptor", importId: importFromId, provider });
      }
  ...
  * @param options ActiveActiveTransitGatewayInvitationAcceptorConfig
  */
  public constructor(scope: Construct, id: string, config: ActiveActiveTransitGatewayInvitationAcceptorConfig) {
    super(scope, id, {
    ...
    this._tgwInvitationId = config.tgwInvitationId;
  ...
  // tgw_invitation_id - computed: false, optional: false, required: true
  private _tgwInvitationId?: number; 
  public get tgwInvitationId() {
    return this.getNumberAttribute('tgw_invitation_id');
  }
  public set tgwInvitationId(value: number) {
    this._tgwInvitationId = value;
  }
  // Temporarily expose input value. Use with caution.
  public get tgwInvitationIdInput() {
    return this._tgwInvitationId;
  }

  // timeouts - computed: false, optional: true, required: false
  private _timeouts = new ActiveActiveTransitGatewayInvitationAcceptorTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ActiveActiveTransitGatewayInvitationAcceptorTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tgw_invitation_id: cdktf.numberToTerraform(this._tgwInvitationId),
      timeouts: activeActiveTransitGatewayInvitationAcceptorTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tgw_invitation_id: {
        value: cdktf.numberToHclTerraform(this._tgwInvitationId),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      timeouts: {
        value: activeActiveTransitGatewayInvitationAcceptorTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ActiveActiveTransitGatewayInvitationAcceptorTimeouts",
      },
    };
