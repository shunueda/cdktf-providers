...
export interface DataRediscloudTransitGatewayInvitationsInvitations {
}

export function dataRediscloudTransitGatewayInvitationsInvitationsToTerraform(struct?: DataRediscloudTransitGatewayInvitationsInvitations): any {
...
export function dataRediscloudTransitGatewayInvitationsInvitationsToHclTerraform(struct?: DataRediscloudTransitGatewayInvitationsInvitations): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataRediscloudTransitGatewayInvitationsInvitationsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataRediscloudTransitGatewayInvitationsInvitations | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataRediscloudTransitGatewayInvitationsInvitations | undefined) {
    if (value === undefined) {
...
export class DataRediscloudTransitGatewayInvitationsInvitationsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataRediscloudTransitGatewayInvitationsInvitationsOutputReference {
    return new DataRediscloudTransitGatewayInvitationsInvitationsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataRediscloudTransitGatewayInvitations extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "rediscloud_transit_gateway_invitations";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "rediscloud_transit_gateway_invitations", importId: importFromId, provider });
      }
  ...
  * @param options DataRediscloudTransitGatewayInvitationsConfig
  */
  public constructor(scope: Construct, id: string, config: DataRediscloudTransitGatewayInvitationsConfig) {
    super(scope, id, {
  ...
  private _invitations = new DataRediscloudTransitGatewayInvitationsInvitationsList(this, "invitations", false);
