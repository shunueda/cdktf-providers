// https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs
...
export interface RouterosProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs#ca_certificate RouterosProvider#ca_certificate}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs#hosturl RouterosProvider#hosturl}
  */
  readonly hosturl: string;
  /**
  * Whether to verify the SSL certificate or not (env: ROS_INSECURE | MIKROTIK_INSECURE).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs#insecure RouterosProvider#insecure}
  */
  readonly insecure?: boolean | cdktf.IResolvable;
  /**
  * Password for the MikroTik user (env: ROS_PASSWORD | MIKROTIK_PASSWORD).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs#password RouterosProvider#password}
  */
  readonly password?: string;
  /**
  * HTTP Client Timeout
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs#rest_timeout RouterosProvider#rest_timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs#routeros_version RouterosProvider#routeros_version}
  */
  readonly routerosVersion?: string;
  /**
  * Suppress the system object deletion warning (env: ROS_SUPPRESS_SYSO_DEL_WARN).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs#suppress_syso_del_warn RouterosProvider#suppress_syso_del_warn}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs#username RouterosProvider#username}
  */
  readonly username: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs#alias RouterosProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs routeros}
*/
export class RouterosProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing RouterosProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs routeros} Resource
  *
  * @param scope The scope in which to define this construct
