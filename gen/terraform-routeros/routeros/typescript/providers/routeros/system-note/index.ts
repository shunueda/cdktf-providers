// https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/system_note
...
export interface SystemNoteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/system_note#___path___ SystemNote#___path___}
  */
  readonly path?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/system_note#id SystemNote#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/system_note#note SystemNote#note}
  */
  readonly note: string;
  /**
  * Whether to show system note before telnet login prompt.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/system_note#show_at_cli_login SystemNote#show_at_cli_login}
  */
  readonly showAtCliLogin?: boolean | cdktf.IResolvable;
  /**
  * Whether to show system note on each login.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/system_note#show_at_login SystemNote#show_at_login}
  */
  readonly showAtLogin?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/system_note routeros_system_note}
*/
export class SystemNote extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemNote that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/system_note#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/system_note routeros_system_note} Resource
  *
  * @param scope The scope in which to define this construct
