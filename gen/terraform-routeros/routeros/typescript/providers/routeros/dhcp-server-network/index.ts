// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network
...
export interface DhcpServerNetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#___path___ DhcpServerNetwork#___path___}
  */
  readonly path?: string;
  /**
  * The network DHCP server(s) will lease addresses from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#address DhcpServerNetwork#address}
  */
  readonly address: string;
  /**
  * Boot filename.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#boot_file_name DhcpServerNetwork#boot_file_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#caps_manager DhcpServerNetwork#caps_manager}
  */
  readonly capsManager?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#comment DhcpServerNetwork#comment}
  */
  readonly comment?: string;
  /**
  * Add additional DHCP options from the option list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#dhcp_option DhcpServerNetwork#dhcp_option}
  */
  readonly dhcpOption?: string[];
  /**
  * Add an additional set of DHCP options.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#dhcp_option_set DhcpServerNetwork#dhcp_option_set}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#dns_none DhcpServerNetwork#dns_none}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#dns_server DhcpServerNetwork#dns_server}
  */
  readonly dnsServer?: string[];
  /**
  * The DHCP client will use this as the 'DNS domain' setting for the network adapter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#domain DhcpServerNetwork#domain}
  */
  readonly domain?: string;
  /**
  * The default gateway to be used by DHCP Client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#gateway DhcpServerNetwork#gateway}
  */
  readonly gateway?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#id DhcpServerNetwork#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#netmask DhcpServerNetwork#netmask}
  */
  readonly netmask?: number;
  /**
  * The IP address of the next server to use in bootstrap.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#next_server DhcpServerNetwork#next_server}
  */
  readonly nextServer?: string;
  /**
  * If set, then DHCP Server will not pass NTP servers configured on the router to the DHCP clients.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#ntp_none DhcpServerNetwork#ntp_none}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#ntp_server DhcpServerNetwork#ntp_server}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#wins_server DhcpServerNetwork#wins_server}
  */
  readonly winsServer?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network routeros_dhcp_server_network}
*/
export class DhcpServerNetwork extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "routeros_dhcp_server_network";
  ...
  * @param importFromId The id of the existing DhcpServerNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DhcpServerNetwork to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "routeros_dhcp_server_network", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/dhcp_server_network routeros_dhcp_server_network} Resource
  *
  * @param scope The scope in which to define this construct
