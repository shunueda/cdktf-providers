// https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller
...
export interface ZerotierControllerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#___path___ ZerotierController#___path___}
  */
  readonly path?: string;
  /**
  * An option to allow receiving broadcast packets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#broadcast ZerotierController#broadcast}
  */
  readonly broadcast?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#comment ZerotierController#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#disabled ZerotierController#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#id ZerotierController#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#instance ZerotierController#instance}
  */
  readonly instance: string;
  /**
  * An option to assign every member a `/80` address within a `/40` network with using NDP emulation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#ip6_6plane ZerotierController#ip6_6plane}
  */
  readonly ip66Plane?: boolean | cdktf.IResolvable;
  /**
  * The IPv6 range of the ZeroTier network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#ip6_range ZerotierController#ip6_range}
  */
  readonly ip6Range?: string;
  /**
  * An option to assign every member a `/128` address within a `/88` network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#ip6_rfc4193 ZerotierController#ip6_rfc4193}
  */
  readonly ip6Rfc4193?: boolean | cdktf.IResolvable;
  /**
  * The IP range of the ZeroTier network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#ip_range ZerotierController#ip_range}
  */
  readonly ipRange?: string;
  /**
  * Layer2 Maximum transmission unit. [See](https://wiki.mikrotik.com/wiki/Maximum_Transmission_Unit_on_RouterBoards).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#mtu ZerotierController#mtu}
  */
  readonly mtu?: number;
  /**
  * An option to limit the maximum recipients of a multicast packet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#multicast_limit ZerotierController#multicast_limit}
  */
  readonly multicastLimit?: number;
  /**
  * Name of the ZeroTier controller.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#name ZerotierController#name}
  */
  readonly name: string;
  /**
  * The ZeroTier network identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#network ZerotierController#network}
  */
  readonly network: string;
  /**
  * The ZeroTier network access control.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#private ZerotierController#private}
  */
  readonly private?: boolean | cdktf.IResolvable;
  /**
  * The routes list that will be pushed to the client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#routes ZerotierController#routes}
  */
  readonly routes?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller routeros_zerotier_controller}
*/
export class ZerotierController extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZerotierController that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_controller routeros_zerotier_controller} Resource
  *
  * @param scope The scope in which to define this construct
