// https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease
...
export interface DhcpServerLeaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#___path___ DhcpServerLease#___path___}
  */
  readonly path?: string;
  /**
  * The IP address of the DHCP lease to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#address DhcpServerLease#address}
  */
  readonly address: string;
  /**
  * Address list to which address will be added if lease is bound.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#address_lists DhcpServerLease#address_lists}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#allow_dual_stack_queue DhcpServerLease#allow_dual_stack_queue}
  */
  readonly allowDualStackQueue?: boolean | cdktf.IResolvable;
  /**
  * Send all replies as broadcasts.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#always_broadcast DhcpServerLease#always_broadcast}
  */
  readonly alwaysBroadcast?: boolean | cdktf.IResolvable;
  /**
  * Whether to block access for this DHCP client (true|false).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#block_access DhcpServerLease#block_access}
  */
  readonly blockAccess?: boolean | cdktf.IResolvable;
  /**
  * If specified, must match DHCP 'client identifier' option of the request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#client_id DhcpServerLease#client_id}
  */
  readonly clientId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#comment DhcpServerLease#comment}
  */
  readonly comment?: string;
  /**
  * Add additional DHCP options.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#dhcp_option DhcpServerLease#dhcp_option}
  */
  readonly dhcpOption?: string;
  /**
  * Add additional set of DHCP options.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#dhcp_option_set DhcpServerLease#dhcp_option_set}
  */
  readonly dhcpOptionSet?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#disabled DhcpServerLease#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#id DhcpServerLease#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#insert_queue_before DhcpServerLease#insert_queue_before}
  */
  readonly insertQueueBefore?: string;
  /**
  * Time that the client may use the address. If set to 0s lease will never expire.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#lease_time DhcpServerLease#lease_time}
  */
  readonly leaseTime?: string;
  /**
  * The MAC addreess of the DHCP lease to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#mac_address DhcpServerLease#mac_address}
  */
  readonly macAddress: string;
  /**
  * Adds a dynamic simple queue to limit IP's bandwidth to a specified rate. Requires the lease to be static.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#rate_limit DhcpServerLease#rate_limit}
  */
  readonly rateLimit?: string;
  /**
  * Server name which serves this client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#server DhcpServerLease#server}
  */
  readonly server?: string;
  /**
  * When this option is set server uses source MAC address instead of received CHADDR to assign address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#use_src_mac DhcpServerLease#use_src_mac}
  */
  readonly useSrcMac?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease routeros_dhcp_server_lease}
*/
export class DhcpServerLease extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DhcpServerLease that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server_lease routeros_dhcp_server_lease} Resource
  *
  * @param scope The scope in which to define this construct
