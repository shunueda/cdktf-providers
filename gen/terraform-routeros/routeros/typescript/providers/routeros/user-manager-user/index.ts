// https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user
...
export interface UserManagerUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user#___path___ UserManagerUser#___path___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user#attributes UserManagerUser#attributes}
  */
  readonly attributes?: string[];
  /**
  * Allow user's authentication with a specific Calling-Station-Id value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user#caller_id UserManagerUser#caller_id}
  */
  readonly callerId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user#comment UserManagerUser#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user#disabled UserManagerUser#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Name of the group the user is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user#group UserManagerUser#group}
  */
  readonly group?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user#id UserManagerUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user#name UserManagerUser#name}
  */
  readonly name: string;
  /**
  * A token of a one-time code that will be attached to the password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user#otp_secret UserManagerUser#otp_secret}
  */
  readonly otpSecret?: string;
  /**
  * The password of the user for session authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user#password UserManagerUser#password}
  */
  readonly password?: string;
  /**
  * The total amount of sessions the user can simultaneously establish.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user#shared_users UserManagerUser#shared_users}
  */
  readonly sharedUsers?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user routeros_user_manager_user}
*/
export class UserManagerUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserManagerUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_user routeros_user_manager_user} Resource
  *
  * @param scope The scope in which to define this construct
