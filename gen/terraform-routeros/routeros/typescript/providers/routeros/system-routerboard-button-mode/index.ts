// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_routerboard_button_mode
...
export interface SystemRouterboardButtonModeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_routerboard_button_mode#___path___ SystemRouterboardButtonMode#___path___}
  */
  readonly path?: string;
  /**
  * An option to enable the operation of the button.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_routerboard_button_mode#enabled SystemRouterboardButtonMode#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * An option to define the period within which the button should be pressed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_routerboard_button_mode#hold_time SystemRouterboardButtonMode#hold_time}
  */
  readonly holdTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_routerboard_button_mode#id SystemRouterboardButtonMode#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_routerboard_button_mode#on_event SystemRouterboardButtonMode#on_event}
  */
  readonly onEvent?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_routerboard_button_mode routeros_system_routerboard_button_mode}
*/
export class SystemRouterboardButtonMode extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemRouterboardButtonMode that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_routerboard_button_mode#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_routerboard_button_mode routeros_system_routerboard_button_mode} Resource
  *
  * @param scope The scope in which to define this construct
