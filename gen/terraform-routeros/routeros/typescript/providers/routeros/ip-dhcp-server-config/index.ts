// https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_dhcp_server_config
...
export interface IpDhcpServerConfigAConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_dhcp_server_config#___path___ IpDhcpServerConfigA#___path___}
  */
  readonly path?: string;
  /**
  * An option that enables accounting for DHCP leases.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_dhcp_server_config#accounting IpDhcpServerConfigA#accounting}
  */
  readonly accounting?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_dhcp_server_config#id IpDhcpServerConfigA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_dhcp_server_config#interim_update IpDhcpServerConfigA#interim_update}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_dhcp_server_config#radius_password IpDhcpServerConfigA#radius_password}
  */
  readonly radiusPassword?: string;
  /**
  * An option of how often the DHCP leases will be stored on disk.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_dhcp_server_config#store_leases_disk IpDhcpServerConfigA#store_leases_disk}
  */
  readonly storeLeasesDisk?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_dhcp_server_config routeros_ip_dhcp_server_config}
*/
export class IpDhcpServerConfigA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpDhcpServerConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_dhcp_server_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_dhcp_server_config routeros_ip_dhcp_server_config} Resource
  *
  * @param scope The scope in which to define this construct
