// https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/system_led_settings
...
export interface SystemLedSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/system_led_settings#___path___ SystemLedSettings#___path___}
  */
  readonly path?: string;
  /**
  * An option to set when all LEDs should be turned off. Possible values: `after-1h`, `after-1min`, `immediate`, `never`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/system_led_settings#all_leds_off SystemLedSettings#all_leds_off}
  */
  readonly allLedsOff?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/system_led_settings#id SystemLedSettings#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/system_led_settings routeros_system_led_settings}
*/
export class SystemLedSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemLedSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/system_led_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/system_led_settings routeros_system_led_settings} Resource
  *
  * @param scope The scope in which to define this construct
