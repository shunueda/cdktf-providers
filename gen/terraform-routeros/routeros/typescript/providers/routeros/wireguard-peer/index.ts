// https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer
...
export interface WireguardPeerConfig extends cdktf.TerraformMetaArguments {
  /**
  * <em>Resource path for CRUD operations. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#___path___ WireguardPeer#___path___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#allowed_address WireguardPeer#allowed_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#client_address WireguardPeer#client_address}
  */
  readonly clientAddress?: string;
  /**
  * Specify when using WireGuard Server as a VPN gateway for peer traffic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#client_dns WireguardPeer#client_dns}
  */
  readonly clientDns?: string;
  /**
  * The IP address and port number of the WireGuard Server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#client_endpoint WireguardPeer#client_endpoint}
  */
  readonly clientEndpoint?: string;
  /**
  * Same as persistent-keepalive but from peer side.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#client_keepalive WireguardPeer#client_keepalive}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#client_listen_port WireguardPeer#client_listen_port}
  */
  readonly clientListenPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#comment WireguardPeer#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#disabled WireguardPeer#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * An endpoint IP or hostname can be left blank to allow remote connection from any address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#endpoint_address WireguardPeer#endpoint_address}
  */
  readonly endpointAddress?: string;
  /**
  * An endpoint port can be left blank to allow remote connection from any port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#endpoint_port WireguardPeer#endpoint_port}
  */
  readonly endpointPort?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#id WireguardPeer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#interface WireguardPeer#interface}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#is_responder WireguardPeer#is_responder}
  */
  readonly isResponder?: boolean | cdktf.IResolvable;
  /**
  * Name of the tunnel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#name WireguardPeer#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#persistent_keepalive WireguardPeer#persistent_keepalive}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#preshared_key WireguardPeer#preshared_key}
  */
  readonly presharedKey?: string;
  /**
  * A base64 private key. If not specified, it will be automatically generated upon interface creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#private_key WireguardPeer#private_key}
  */
  readonly privateKey?: string;
  /**
  * The remote peer's calculated public key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#public_key WireguardPeer#public_key}
  */
  readonly publicKey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer routeros_wireguard_peer}
*/
export class WireguardPeer extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "routeros_wireguard_peer";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a WireguardPeer resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the WireguardPeer to import
  * @param importFromId The id of the existing WireguardPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the WireguardPeer to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "routeros_wireguard_peer", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/wireguard_peer routeros_wireguard_peer} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options WireguardPeerConfig
  */
  public constructor(scope: Construct, id: string, config: WireguardPeerConfig) {
    super(scope, id, {
      terraformResourceType: 'routeros_wireguard_peer',
