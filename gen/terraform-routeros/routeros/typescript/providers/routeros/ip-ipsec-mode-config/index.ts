// https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config
...
export interface IpIpsecModeConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#___path___ IpIpsecModeConfig#___path___}
  */
  readonly path?: string;
  /**
  * Single IP address for the initiator instead of specifying a whole address pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#address IpIpsecModeConfig#address}
  */
  readonly address?: string;
  /**
  * Name of the address pool from which the responder will try to assign address if mode-config is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#address_pool IpIpsecModeConfig#address_pool}
  */
  readonly addressPool?: string;
  /**
  * Prefix length (netmask) of the assigned address from the pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#address_prefix_length IpIpsecModeConfig#address_prefix_length}
  */
  readonly addressPrefixLength?: number;
  /**
  * Firewall connection mark.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#connection_mark IpIpsecModeConfig#connection_mark}
  */
  readonly connectionMark?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#id IpIpsecModeConfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#name IpIpsecModeConfig#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#responder IpIpsecModeConfig#responder}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#split_dns IpIpsecModeConfig#split_dns}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#split_include IpIpsecModeConfig#split_include}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#src_address_list IpIpsecModeConfig#src_address_list}
  */
  readonly srcAddressList?: string;
  /**
  * Manually specified DNS server's IP address to be sent to the client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#static_dns IpIpsecModeConfig#static_dns}
  */
  readonly staticDns?: string;
  /**
  * When this option is enabled DNS addresses will be taken from `/ip dns`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#system_dns IpIpsecModeConfig#system_dns}
  */
  readonly systemDns?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#use_responder_dns IpIpsecModeConfig#use_responder_dns}
  */
  readonly useResponderDns?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config routeros_ip_ipsec_mode_config}
*/
export class IpIpsecModeConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpIpsecModeConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_mode_config routeros_ip_ipsec_mode_config} Resource
  *
  * @param scope The scope in which to define this construct
