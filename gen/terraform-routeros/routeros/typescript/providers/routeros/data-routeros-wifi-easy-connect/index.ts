// https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/data-sources/wifi_easy_connect
...
export interface DataRouterosWifiEasyConnectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/data-sources/wifi_easy_connect#eap_anonymous DataRouterosWifiEasyConnect#eap_anonymous}
  */
  readonly eapAnonymous?: boolean | cdktf.IResolvable;
  /**
  * (WPA2-EAP only) Identity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/data-sources/wifi_easy_connect#eap_identity DataRouterosWifiEasyConnect#eap_identity}
  */
  readonly eapIdentity?: string;
  /**
  * (WPA2-EAP only) EAP method, like TTLS or PWD.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/data-sources/wifi_easy_connect#eap_method DataRouterosWifiEasyConnect#eap_method}
  */
  readonly eapMethod?: string;
  /**
  * (WPA2-EAP only) Phase 2 method, like `MSCHAPV2`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/data-sources/wifi_easy_connect#eap_phase2 DataRouterosWifiEasyConnect#eap_phase2}
  */
  readonly eapPhase2?: string;
  /**
  * True if the network SSID is hidden.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/data-sources/wifi_easy_connect#hidden DataRouterosWifiEasyConnect#hidden}
  */
  readonly hidden?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/data-sources/wifi_easy_connect#id DataRouterosWifiEasyConnect#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/data-sources/wifi_easy_connect#password DataRouterosWifiEasyConnect#password}
  */
  readonly password: string;
  /**
  * Network SSID. Required. Enclose in double quotes if it is an ASCII name, but could be interpreted as hex (i.e. "ABCD").
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/data-sources/wifi_easy_connect#ssid DataRouterosWifiEasyConnect#ssid}
  */
  readonly ssid: string;
  /**
  * Authentication type; can be WEP or WPA or WPA2-EAP, or nopass for no password. Or, omit for no password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/data-sources/wifi_easy_connect#type DataRouterosWifiEasyConnect#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/data-sources/wifi_easy_connect routeros_wifi_easy_connect}
*/
export class DataRouterosWifiEasyConnect extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRouterosWifiEasyConnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/data-sources/wifi_easy_connect#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/data-sources/wifi_easy_connect routeros_wifi_easy_connect} Data Source
  *
  * @param scope The scope in which to define this construct
