// https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_attribute
...
export interface UserManagerAttributeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_attribute#___path___ UserManagerAttribute#___path___}
  */
  readonly path?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_attribute#id UserManagerAttribute#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_attribute#name UserManagerAttribute#name}
  */
  readonly name: string;
  /**
  * A set of `access-accept` and `access-challenge`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_attribute#packet_types UserManagerAttribute#packet_types}
  */
  readonly packetTypes?: string[];
  /**
  * Attribute identification number from the specific vendor's attribute database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_attribute#type_id UserManagerAttribute#type_id}
  */
  readonly typeId: number;
  /**
  * The attribute's value type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_attribute#value_type UserManagerAttribute#value_type}
  */
  readonly valueType?: string;
  /**
  * IANA allocated a specific enterprise identification number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_attribute#vendor_id UserManagerAttribute#vendor_id}
  */
  readonly vendorId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_attribute routeros_user_manager_attribute}
*/
export class UserManagerAttribute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserManagerAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_attribute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_attribute routeros_user_manager_attribute} Resource
  *
  * @param scope The scope in which to define this construct
