...
export interface IpDhcpServerOptionSetsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class IpDhcpServerOptionSets extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "routeros_ip_dhcp_server_option_sets";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "routeros_ip_dhcp_server_option_sets", importId: importFromId, provider });
      }
  ...
  * @param options IpDhcpServerOptionSetsConfig
  */
  public constructor(scope: Construct, id: string, config: IpDhcpServerOptionSetsConfig) {
    super(scope, id, {
