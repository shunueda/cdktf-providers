// https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy
...
export interface IpIpsecPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#___path___ IpIpsecPolicy#___path___}
  */
  readonly path?: string;
  /**
  * <em>A set of transformations for field names. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#___skip___ IpIpsecPolicy#___skip___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#action IpIpsecPolicy#action}
  */
  readonly action?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#comment IpIpsecPolicy#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#disabled IpIpsecPolicy#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#dst_address IpIpsecPolicy#dst_address}
  */
  readonly dstAddress?: string;
  /**
  * Destination port to be matched in packets. If set to any all ports will be matched.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#dst_port IpIpsecPolicy#dst_port}
  */
  readonly dstPort?: string;
  /**
  * Name of the policy group to which this **template** is assigned.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#group IpIpsecPolicy#group}
  */
  readonly group?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#id IpIpsecPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#ipsec_protocols IpIpsecPolicy#ipsec_protocols}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#level IpIpsecPolicy#level}
  */
  readonly level?: string;
  /**
  * Name of the peer on which the policy applies.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#peer IpIpsecPolicy#peer}
  */
  readonly peer?: string;
  /**
  * Name of the proposal template that will be sent by IKE daemon to establish SAs for this policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#proposal IpIpsecPolicy#proposal}
  */
  readonly proposal?: string;
  /**
  * IP packet protocol to match.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#protocol IpIpsecPolicy#protocol}
  */
  readonly protocol?: string;
  /**
  * Source address to be matched in packets. Applicable when tunnel mode (`tunnel=yes`) or template (`template=yes`) is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#src_address IpIpsecPolicy#src_address}
  */
  readonly srcAddress?: string;
  /**
  * Source port to be matched in packets. If set to any all ports will be matched.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#src_port IpIpsecPolicy#src_port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#template IpIpsecPolicy#template}
  */
  readonly template?: boolean | cdktf.IResolvable;
  /**
  * Specifies whether to use tunnel mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#tunnel IpIpsecPolicy#tunnel}
  */
  readonly tunnel?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy routeros_ip_ipsec_policy}
*/
export class IpIpsecPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpIpsecPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/ip_ipsec_policy routeros_ip_ipsec_policy} Resource
  *
  * @param scope The scope in which to define this construct
