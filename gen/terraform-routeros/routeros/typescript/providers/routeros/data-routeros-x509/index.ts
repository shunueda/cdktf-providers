// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/data-sources/x509
...
export interface DataRouterosX509Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/data-sources/x509#data DataRouterosX509#data}
  */
  readonly data: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/data-sources/x509 routeros_x509}
*/
export class DataRouterosX509 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRouterosX509 that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/data-sources/x509#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/data-sources/x509 routeros_x509} Data Source
  *
  * @param scope The scope in which to define this construct
