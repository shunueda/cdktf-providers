// https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action
...
export interface SystemLoggingActionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#___path___ SystemLoggingAction#___path___}
  */
  readonly path?: string;
  /**
  * Whether to use bsd-syslog as defined in RFC 3164.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#bsd_syslog SystemLoggingAction#bsd_syslog}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#cef_event_delimiter SystemLoggingAction#cef_event_delimiter}
  */
  readonly cefEventDelimiter?: string;
  /**
  * Specifies number of files used to store log messages, applicable only if `action=disk`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#disk_file_count SystemLoggingAction#disk_file_count}
  */
  readonly diskFileCount?: number;
  /**
  * Name of the file used to store log messages, applicable only if `action=disk`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#disk_file_name SystemLoggingAction#disk_file_name}
  */
  readonly diskFileName?: string;
  /**
  * Specifies maximum size of file in lines, applicable only if `action=disk`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#disk_lines_per_file SystemLoggingAction#disk_lines_per_file}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#disk_stop_on_full SystemLoggingAction#disk_stop_on_full}
  */
  readonly diskStopOnFull?: boolean | cdktf.IResolvable;
  /**
  * Whether to use tls when sending email, applicable only if `action=email`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#email_start_tls SystemLoggingAction#email_start_tls}
  */
  readonly emailStartTls?: boolean | cdktf.IResolvable;
  /**
  * Email address where logs are sent, applicable only if `action=email`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#email_to SystemLoggingAction#email_to}
  */
  readonly emailTo?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#id SystemLoggingAction#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#memory_lines SystemLoggingAction#memory_lines}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#memory_stop_on_full SystemLoggingAction#memory_stop_on_full}
  */
  readonly memoryStopOnFull?: boolean | cdktf.IResolvable;
  /**
  * Name of an action.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#name SystemLoggingAction#name}
  */
  readonly name: string;
  /**
  * Whether to keep log messages, which have not yet been displayed in console, applicable if `action=echo`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#remember SystemLoggingAction#remember}
  */
  readonly remember?: boolean | cdktf.IResolvable;
  /**
  * Remote logging server's IP/IPv6 address, applicable if `action=remote`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#remote SystemLoggingAction#remote}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#remote_log_format SystemLoggingAction#remote_log_format}
  */
  readonly remoteLogFormat?: string;
  /**
  * Remote logging server's UDP port, applicable if `action=remote`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#remote_port SystemLoggingAction#remote_port}
  */
  readonly remotePort?: number;
  /**
  * Protocol for remote logging messages.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#remote_protocol SystemLoggingAction#remote_protocol}
  */
  readonly remoteProtocol?: string;
  /**
  * Source address used when sending packets to remote server, applicable if `action=remote`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#src_address SystemLoggingAction#src_address}
  */
  readonly srcAddress?: string;
  /**
  * SYSLOG facility, applicable if `action=remote`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#syslog_facility SystemLoggingAction#syslog_facility}
  */
  readonly syslogFacility?: string;
  /**
  * Severity level indicator defined in RFC 3164, applicable if `action=remote`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#syslog_severity SystemLoggingAction#syslog_severity}
  */
  readonly syslogSeverity?: string;
  /**
  * SYSLOG time format (`bsd-syslog` or `iso8601`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#syslog_time_format SystemLoggingAction#syslog_time_format}
  */
  readonly syslogTimeFormat?: string;
  /**
  * Storage facility or target of log messages.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#target SystemLoggingAction#target}
  */
  readonly target: string;
  /**
  * The VRF table this resource operates on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#vrf SystemLoggingAction#vrf}
  */
  readonly vrf?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action routeros_system_logging_action}
*/
export class SystemLoggingAction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemLoggingAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_logging_action routeros_system_logging_action} Resource
  *
  * @param scope The scope in which to define this construct
