// https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server
...
export interface Ipv6DhcpServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#___path___ Ipv6DhcpServer#___path___}
  */
  readonly path?: string;
  /**
  * IPv6 pool, from which to take IPv6 prefix for the clients.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#address_pool Ipv6DhcpServer#address_pool}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#allow_dual_stack_queue Ipv6DhcpServer#allow_dual_stack_queue}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#binding_script Ipv6DhcpServer#binding_script}
  */
  readonly bindingScript?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#comment Ipv6DhcpServer#comment}
  */
  readonly comment?: string;
  /**
  * Add additional DHCP options from option list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#dhcp_option Ipv6DhcpServer#dhcp_option}
  */
  readonly dhcpOption?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#disabled Ipv6DhcpServer#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#id Ipv6DhcpServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#ignore_ia_na_bindings Ipv6DhcpServer#ignore_ia_na_bindings}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#insert_queue_before Ipv6DhcpServer#insert_queue_before}
  */
  readonly insertQueueBefore?: string;
  /**
  * The interface on which server will be running.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#interface Ipv6DhcpServer#interface}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#lease_time Ipv6DhcpServer#lease_time}
  */
  readonly leaseTime?: string;
  /**
  * Reference name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#name Ipv6DhcpServer#name}
  */
  readonly name: string;
  /**
  * A dynamically created queue for this lease will be configured as a child queue of the specified parent queue.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#parent_queue Ipv6DhcpServer#parent_queue}
  */
  readonly parentQueue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#preference Ipv6DhcpServer#preference}
  */
  readonly preference?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#rapid_commit Ipv6DhcpServer#rapid_commit}
  */
  readonly rapidCommit?: boolean | cdktf.IResolvable;
  /**
  * Distance of the route.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#route_distance Ipv6DhcpServer#route_distance}
  */
  readonly routeDistance?: number;
  /**
  * Whether to use RADIUS server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#use_radius Ipv6DhcpServer#use_radius}
  */
  readonly useRadius?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server routeros_ipv6_dhcp_server}
*/
export class Ipv6DhcpServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ipv6DhcpServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/ipv6_dhcp_server routeros_ipv6_dhcp_server} Resource
  *
  * @param scope The scope in which to define this construct
