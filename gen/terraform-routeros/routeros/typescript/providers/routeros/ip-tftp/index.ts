// https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp
...
export interface IpTftpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp#___path___ IpTftp#___path___}
  */
  readonly path?: string;
  /**
  * <em>A set of transformations for field names. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp#___skip___ IpTftp#___skip___}
  */
  readonly skip?: string;
  /**
  * Allow connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp#allow IpTftp#allow}
  */
  readonly allow?: boolean | cdktf.IResolvable;
  /**
  * If `true`, overwriting the file is allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp#allow_overwrite IpTftp#allow_overwrite}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp#allow_rollover IpTftp#allow_rollover}
  */
  readonly allowRollover?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp#disabled IpTftp#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp#id IpTftp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp#ip_addresses IpTftp#ip_addresses}
  */
  readonly ipAddresses?: string[];
  /**
  * Sets if file can be written to. If set to `false` write attempts will fail with an error.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp#read_only IpTftp#read_only}
  */
  readonly readOnly?: boolean | cdktf.IResolvable;
  /**
  * TFTP Windowsize option value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp#reading_window_size IpTftp#reading_window_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp#real_filename IpTftp#real_filename}
  */
  readonly realFilename?: string;
  /**
  * Requested filename as regular expression (regex) if field is left empty it defaults to `.*`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp#req_filename IpTftp#req_filename}
  */
  readonly reqFilename?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp routeros_ip_tftp}
*/
export class IpTftp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpTftp that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_tftp routeros_ip_tftp} Resource
  *
  * @param scope The scope in which to define this construct
