// https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle
...
export interface IpFirewallMangleConfig extends cdktf.TerraformMetaArguments {
  /**
  * <em>Resource path for CRUD operations. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#___path___ IpFirewallMangle#___path___}
  */
  readonly path?: string;
  /**
  * <em>A set of transformations for field names. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#___skip___ IpFirewallMangle#___skip___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#___unset___ IpFirewallMangle#___unset___}
  */
  readonly unset?: string;
  /**
  * Action to take if a packet is matched by the rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#action IpFirewallMangle#action}
  */
  readonly action: string;
  /**
  * Name of the address list to be used. Applicable if action is add-dst-to-address-list or add-src-to-address-list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#address_list IpFirewallMangle#address_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#address_list_timeout IpFirewallMangle#address_list_timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#chain IpFirewallMangle#chain}
  */
  readonly chain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#comment IpFirewallMangle#comment}
  */
  readonly comment?: string;
  /**
  * Matches packets only if a given amount of bytes has been transfered through the particular connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#connection_bytes IpFirewallMangle#connection_bytes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#connection_limit IpFirewallMangle#connection_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#connection_mark IpFirewallMangle#connection_mark}
  */
  readonly connectionMark?: string;
  /**
  * Can match connections that are srcnatted, dstnatted or both.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#connection_nat_state IpFirewallMangle#connection_nat_state}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#connection_rate IpFirewallMangle#connection_rate}
  */
  readonly connectionRate?: string;
  /**
  * Interprets the connection tracking analysis data for a particular packet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#connection_state IpFirewallMangle#connection_state}
  */
  readonly connectionState?: string;
  /**
  * Matches packets from related connections based on information from their connection tracking helpers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#connection_type IpFirewallMangle#connection_type}
  */
  readonly connectionType?: string;
  /**
  * Match packets that contain specified text.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#content IpFirewallMangle#content}
  */
  readonly content?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#disabled IpFirewallMangle#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Matches DSCP IP header field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#dscp IpFirewallMangle#dscp}
  */
  readonly dscp?: number;
  /**
  * Matches packets which destination is equal to specified IP or falls into specified IP range.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#dst_address IpFirewallMangle#dst_address}
  */
  readonly dstAddress?: string;
  /**
  * Matches destination address of a packet against user-defined address list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#dst_address_list IpFirewallMangle#dst_address_list}
  */
  readonly dstAddressList?: string;
  /**
  * Matches destination address type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#dst_address_type IpFirewallMangle#dst_address_type}
  */
  readonly dstAddressType?: string;
  /**
  * Matches packets until a given rate is exceeded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#dst_limit IpFirewallMangle#dst_limit}
  */
  readonly dstLimit?: string;
  /**
  * List of destination port numbers or port number ranges.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#dst_port IpFirewallMangle#dst_port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#fragment IpFirewallMangle#fragment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#hotspot IpFirewallMangle#hotspot}
  */
  readonly hotspot?: string;
  /**
  * Matches ICMP type: code fields.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#icmp_options IpFirewallMangle#icmp_options}
  */
  readonly icmpOptions?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#id IpFirewallMangle#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#in_bridge_port IpFirewallMangle#in_bridge_port}
  */
  readonly inBridgePort?: string;
  /**
  * Set of interfaces defined in interface list. Works the same as in-bridge-port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#in_bridge_port_list IpFirewallMangle#in_bridge_port_list}
  */
  readonly inBridgePortList?: string;
  /**
  * Interface the packet has entered the router.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#in_interface IpFirewallMangle#in_interface}
  */
  readonly inInterface?: string;
  /**
  * Set of interfaces defined in interface list. Works the same as in-interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#in_interface_list IpFirewallMangle#in_interface_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#ingress_priority IpFirewallMangle#ingress_priority}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#ipsec_policy IpFirewallMangle#ipsec_policy}
  */
  readonly ipsecPolicy?: string;
  /**
  * Matches IPv4 header options.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#ipv4_options IpFirewallMangle#ipv4_options}
  */
  readonly ipv4Options?: string;
  /**
  * Name of the target chain to jump to. Applicable only if action=jump.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#jump_target IpFirewallMangle#jump_target}
  */
  readonly jumpTarget?: string;
  /**
  * Layer7 filter name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#layer7_protocol IpFirewallMangle#layer7_protocol}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#limit IpFirewallMangle#limit}
  */
  readonly limit?: string;
  /**
  * Add a message to the system log.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#log IpFirewallMangle#log}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#log_prefix IpFirewallMangle#log_prefix}
  */
  readonly logPrefix?: string;
  /**
  * Sets a new connection-mark value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#new_connection_mark IpFirewallMangle#new_connection_mark}
  */
  readonly newConnectionMark?: string;
  /**
  * Sets a new DSCP value for a packet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#new_dscp IpFirewallMangle#new_dscp}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#new_mss IpFirewallMangle#new_mss}
  */
  readonly newMss?: string;
  /**
  * Sets a new packet-mark value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#new_packet_mark IpFirewallMangle#new_packet_mark}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#new_priority IpFirewallMangle#new_priority}
  */
  readonly newPriority?: string;
  /**
  * Sets a new routing-mark value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#new_routing_mark IpFirewallMangle#new_routing_mark}
  */
  readonly newRoutingMark?: string;
  /**
  * Sets a new TTL for a packet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#new_ttl IpFirewallMangle#new_ttl}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#nth IpFirewallMangle#nth}
  */
  readonly nth?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#out_bridge_port IpFirewallMangle#out_bridge_port}
  */
  readonly outBridgePort?: string;
  /**
  * Set of interfaces defined in interface list. Works the same as out-bridge-port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#out_bridge_port_list IpFirewallMangle#out_bridge_port_list}
  */
  readonly outBridgePortList?: string;
  /**
  * Interface the packet is leaving the router.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#out_interface IpFirewallMangle#out_interface}
  */
  readonly outInterface?: string;
  /**
  * Set of interfaces defined in interface list. Works the same as out-interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#out_interface_list IpFirewallMangle#out_interface_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#packet_mark IpFirewallMangle#packet_mark}
  */
  readonly packetMark?: string;
  /**
  * Matches packets of specified size or size range in bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#packet_size IpFirewallMangle#packet_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#passthrough IpFirewallMangle#passthrough}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#per_connection_classifier IpFirewallMangle#per_connection_classifier}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#place_before IpFirewallMangle#place_before}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#port IpFirewallMangle#port}
  */
  readonly port?: string;
  /**
  * Matches particular IP protocol specified by protocol name or number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#protocol IpFirewallMangle#protocol}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#psd IpFirewallMangle#psd}
  */
  readonly psd?: string;
  /**
  * Matches packets randomly with a given probability.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#random IpFirewallMangle#random}
  */
  readonly random?: number;
  /**
  * Matches packets with a specific gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#route_dst IpFirewallMangle#route_dst}
  */
  readonly routeDst?: string;
  /**
  * Matches packets marked by mangle facility with particular routing mark.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#routing_mark IpFirewallMangle#routing_mark}
  */
  readonly routingMark?: string;
  /**
  * Matches packets which source is equal to specified IP or falls into a specified IP range.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#src_address IpFirewallMangle#src_address}
  */
  readonly srcAddress?: string;
  /**
  * Matches source address of a packet against user-defined address list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#src_address_list IpFirewallMangle#src_address_list}
  */
  readonly srcAddressList?: string;
  /**
  * Matches source address type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#src_address_type IpFirewallMangle#src_address_type}
  */
  readonly srcAddressType?: string;
  /**
  * Matches source MAC address of the packet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#src_mac_address IpFirewallMangle#src_mac_address}
  */
  readonly srcMacAddress?: string;
  /**
  * List of source ports and ranges of source ports. Applicable only if a protocol is TCP or UDP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#src_port IpFirewallMangle#src_port}
  */
  readonly srcPort?: string;
  /**
  * Matches specified TCP flags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#tcp_flags IpFirewallMangle#tcp_flags}
  */
  readonly tcpFlags?: string;
  /**
  * Matches TCP MSS value of an IP packet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#tcp_mss IpFirewallMangle#tcp_mss}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#time IpFirewallMangle#time}
  */
  readonly time?: string;
  /**
  * Allows matching HTTPS traffic based on TLS SNI hostname.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#tls_host IpFirewallMangle#tls_host}
  */
  readonly tlsHost?: string;
  /**
  * Matches packets TTL value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#ttl IpFirewallMangle#ttl}
  */
  readonly ttl?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle routeros_ip_firewall_mangle}
*/
export class IpFirewallMangle extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "routeros_ip_firewall_mangle";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a IpFirewallMangle resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the IpFirewallMangle to import
  * @param importFromId The id of the existing IpFirewallMangle that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IpFirewallMangle to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "routeros_ip_firewall_mangle", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_mangle routeros_ip_firewall_mangle} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IpFirewallMangleConfig
  */
  public constructor(scope: Construct, id: string, config: IpFirewallMangleConfig) {
    super(scope, id, {
      terraformResourceType: 'routeros_ip_firewall_mangle',
    ...
    this._routeDst = config.routeDst;
  ...
  // route_dst - computed: false, optional: true, required: false
  private _routeDst?: string; 
  public get routeDst() {
    return this.getStringAttribute('route_dst');
  }
  public set routeDst(value: string) {
    this._routeDst = value;
  }
  public resetRouteDst() {
    this._routeDst = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get routeDstInput() {
    return this._routeDst;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      route_dst: cdktf.stringToTerraform(this._routeDst),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      route_dst: {
        value: cdktf.stringToHclTerraform(this._routeDst),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
