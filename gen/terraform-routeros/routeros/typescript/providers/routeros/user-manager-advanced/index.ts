// https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_advanced
...
export interface UserManagerAdvancedConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_advanced#___path___ UserManagerAdvanced#___path___}
  */
  readonly path?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_advanced#id UserManagerAdvanced#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_advanced#paypal_allow UserManagerAdvanced#paypal_allow}
  */
  readonly paypalAllow?: boolean | cdktf.IResolvable;
  /**
  * The currency related to price setting in which users will be billed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_advanced#paypal_currency UserManagerAdvanced#paypal_currency}
  */
  readonly paypalCurrency?: string;
  /**
  * The password of the PayPal API account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_advanced#paypal_password UserManagerAdvanced#paypal_password}
  */
  readonly paypalPassword?: string;
  /**
  * The signature of the PayPal API account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_advanced#paypal_signature UserManagerAdvanced#paypal_signature}
  */
  readonly paypalSignature?: string;
  /**
  * An option whether to use PayPal's sandbox environment for testing purposes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_advanced#paypal_use_sandbox UserManagerAdvanced#paypal_use_sandbox}
  */
  readonly paypalUseSandbox?: boolean | cdktf.IResolvable;
  /**
  * The username of the PayPal API account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_advanced#paypal_user UserManagerAdvanced#paypal_user}
  */
  readonly paypalUser?: string;
  /**
  * The password for accessing `/um/PRIVATE/` section over HTTP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_advanced#web_private_password UserManagerAdvanced#web_private_password}
  */
  readonly webPrivatePassword?: string;
  /**
  * The username for accessing `/um/PRIVATE/` section over HTTP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_advanced#web_private_username UserManagerAdvanced#web_private_username}
  */
  readonly webPrivateUsername?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_advanced routeros_user_manager_advanced}
*/
export class UserManagerAdvanced extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserManagerAdvanced that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_advanced#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_advanced routeros_user_manager_advanced} Resource
  *
  * @param scope The scope in which to define this construct
