// https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/data-sources/ip_routes
...
export interface DataRouterosIpRoutesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/data-sources/ip_routes#___path___ DataRouterosIpRoutes#___path___}
  */
  readonly path?: string;
  /**
  * Additional request filtering options.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/data-sources/ip_routes#filter DataRouterosIpRoutes#filter}
  */
  readonly filter?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/data-sources/ip_routes#id DataRouterosIpRoutes#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/data-sources/ip_routes routeros_ip_routes}
*/
export class DataRouterosIpRoutes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRouterosIpRoutes that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/data-sources/ip_routes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/data-sources/ip_routes routeros_ip_routes} Data Source
  *
  * @param scope The scope in which to define this construct
