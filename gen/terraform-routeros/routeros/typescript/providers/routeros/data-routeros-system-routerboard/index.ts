// https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/data-sources/system_routerboard
...
export interface DataRouterosSystemRouterboardConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/data-sources/system_routerboard#___path___ DataRouterosSystemRouterboard#___path___}
  */
  readonly path?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/data-sources/system_routerboard#id DataRouterosSystemRouterboard#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/data-sources/system_routerboard routeros_system_routerboard}
*/
export class DataRouterosSystemRouterboard extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRouterosSystemRouterboard that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/data-sources/system_routerboard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/data-sources/system_routerboard routeros_system_routerboard} Data Source
  *
  * @param scope The scope in which to define this construct
