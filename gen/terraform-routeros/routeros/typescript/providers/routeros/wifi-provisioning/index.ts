// https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning
...
export interface WifiProvisioningConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#___path___ WifiProvisioning#___path___}
  */
  readonly path?: string;
  /**
  * Provisioning action.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#action WifiProvisioning#action}
  */
  readonly action?: string;
  /**
  * Match CAPs by IPs within configured address ranges.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#address_ranges WifiProvisioning#address_ranges}
  */
  readonly addressRanges?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#comment WifiProvisioning#comment}
  */
  readonly comment?: string;
  /**
  * Regular expression to match radios by common name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#common_name_regexp WifiProvisioning#common_name_regexp}
  */
  readonly commonNameRegexp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#disabled WifiProvisioning#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#id WifiProvisioning#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#identity_regexp WifiProvisioning#identity_regexp}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#master_configuration WifiProvisioning#master_configuration}
  */
  readonly masterConfiguration?: string;
  /**
  * Specify the format of the CAP interface name creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#name_format WifiProvisioning#name_format}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#radio_mac WifiProvisioning#radio_mac}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#slave_configurations WifiProvisioning#slave_configurations}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#slave_name_format WifiProvisioning#slave_name_format}
  */
  readonly slaveNameFormat?: string;
  /**
  * Match CAPs by supported modes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#supported_bands WifiProvisioning#supported_bands}
  */
  readonly supportedBands?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning routeros_wifi_provisioning}
*/
export class WifiProvisioning extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WifiProvisioning that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/wifi_provisioning routeros_wifi_provisioning} Resource
  *
  * @param scope The scope in which to define this construct
