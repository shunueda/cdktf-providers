// https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch
...
export interface ToolNetwatchConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#___path___ ToolNetwatch#___path___}
  */
  readonly path?: string;
  /**
  * <em>A set of transformations for field names. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#___skip___ ToolNetwatch#___skip___}
  */
  readonly skip?: string;
  /**
  * If the ICMP `time exceeded` message should be considered a valid response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#accept_icmp_time_exceeded ToolNetwatch#accept_icmp_time_exceeded}
  */
  readonly acceptIcmpTimeExceeded?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#comment ToolNetwatch#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#disabled ToolNetwatch#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * The DNS server that the probe should send its requests to, if not specified it will use the value from `/ip dns`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#dns_server ToolNetwatch#dns_server}
  */
  readonly dnsServer?: string;
  /**
  * Script to execute on the event of probe state change `OK` --> `fail`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#down_script ToolNetwatch#down_script}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#early_failure_detection ToolNetwatch#early_failure_detection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#early_success_detection ToolNetwatch#early_success_detection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#host ToolNetwatch#host}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#http_code_max ToolNetwatch#http_code_max}
  */
  readonly httpCodeMax?: number;
  /**
  * OK/fail criteria for HTTP response code.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#http_code_min ToolNetwatch#http_code_min}
  */
  readonly httpCodeMin?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#id ToolNetwatch#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#interval ToolNetwatch#interval}
  */
  readonly interval?: string;
  /**
  * Task name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#name ToolNetwatch#name}
  */
  readonly name: string;
  /**
  * Total count of ICMP packets to send out within a single test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#packet_count ToolNetwatch#packet_count}
  */
  readonly packetCount?: number;
  /**
  * The time between ICMP-request packet send.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#packet_interval ToolNetwatch#packet_interval}
  */
  readonly packetInterval?: string;
  /**
  * The total size of the IP ICMP packet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#packet_size ToolNetwatch#packet_size}
  */
  readonly packetSize?: number;
  /**
  * TCP port (for both tcp-conn and http-get probes)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#port ToolNetwatch#port}
  */
  readonly port?: number;
  /**
  * Record type that will be used for DNS probe.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#record_type ToolNetwatch#record_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#src_address ToolNetwatch#src_address}
  */
  readonly srcAddress?: string;
  /**
  * Time to wait before starting probe (on add, enable, or system start).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#start_delay ToolNetwatch#start_delay}
  */
  readonly startDelay?: string;
  /**
  * Time to wait until starting Netwatch probe after system startup.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#startup_delay ToolNetwatch#startup_delay}
  */
  readonly startupDelay?: string;
  /**
  * Script to execute at the end of every probe test.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#test_script ToolNetwatch#test_script}
  */
  readonly testScript?: string;
  /**
  * Fail threshold for rtt-avg.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#thr_avg ToolNetwatch#thr_avg}
  */
  readonly thrAvg?: string;
  /**
  * Fail threshold for http-resp-time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#thr_http_time ToolNetwatch#thr_http_time}
  */
  readonly thrHttpTime?: string;
  /**
  * Fail threshold for rtt-jitter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#thr_jitter ToolNetwatch#thr_jitter}
  */
  readonly thrJitter?: string;
  /**
  * Fail threshold for loss-count.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#thr_loss_count ToolNetwatch#thr_loss_count}
  */
  readonly thrLossCount?: number;
  /**
  * Fail threshold for loss-percent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#thr_loss_percent ToolNetwatch#thr_loss_percent}
  */
  readonly thrLossPercent?: number;
  /**
  * Fail threshold for rtt-max (a value above thr-max is a probe fail).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#thr_max ToolNetwatch#thr_max}
  */
  readonly thrMax?: string;
  /**
  * Fail threshold for rtt-stdev.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#thr_stdev ToolNetwatch#thr_stdev}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#thr_tcp_conn_time ToolNetwatch#thr_tcp_conn_time}
  */
  readonly thrTcpConnTime?: string;
  /**
  * Max time limit to wait for a response.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#timeout ToolNetwatch#timeout}
  */
  readonly timeout?: string;
  /**
  * Manually set time to live value for ICMP packet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#ttl ToolNetwatch#ttl}
  */
  readonly ttl?: number;
  /**
  * Type of the probe:
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#type ToolNetwatch#type}
  */
  readonly type?: string;
  /**
  * Script to execute on the event of probe state change `fail` --> `OK`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#up_script ToolNetwatch#up_script}
  */
  readonly upScript?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch routeros_tool_netwatch}
*/
export class ToolNetwatch extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ToolNetwatch that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/tool_netwatch routeros_tool_netwatch} Resource
  *
  * @param scope The scope in which to define this construct
