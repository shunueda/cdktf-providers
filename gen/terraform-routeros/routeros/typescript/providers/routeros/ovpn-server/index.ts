// https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server
...
export interface OvpnServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#___path___ OvpnServer#___path___}
  */
  readonly path?: string;
  /**
  * Authentication methods that the server will accept.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#auth OvpnServer#auth}
  */
  readonly auth?: string[];
  /**
  * Name of the certificate that the OVPN server will use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#certificate OvpnServer#certificate}
  */
  readonly certificate?: string;
  /**
  * Allowed ciphers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#cipher OvpnServer#cipher}
  */
  readonly cipher?: string[];
  /**
  * Default profile to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#default_profile OvpnServer#default_profile}
  */
  readonly defaultProfile?: string;
  /**
  * Specifies if IPv6 IP tunneling mode should be possible with this OVPN server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#enable_tun_ipv6 OvpnServer#enable_tun_ipv6}
  */
  readonly enableTunIpv6?: boolean | cdktf.IResolvable;
  /**
  * Defines whether the OVPN server is enabled or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#enabled OvpnServer#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#id OvpnServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#ipv6_prefix_len OvpnServer#ipv6_prefix_len}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#keepalive_timeout OvpnServer#keepalive_timeout}
  */
  readonly keepaliveTimeout?: string;
  /**
  * Automatically generated MAC address of the server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#mac_address OvpnServer#mac_address}
  */
  readonly macAddress?: string;
  /**
  * Maximum Transmission Unit. Max packet size that the OVPN interface will be able to send without packet fragmentation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#max_mtu OvpnServer#max_mtu}
  */
  readonly maxMtu?: number;
  /**
  * Layer3 or layer2 tunnel mode (alternatively tun, tap)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#mode OvpnServer#mode}
  */
  readonly mode?: string;
  /**
  * Subnet mask to be applied to the client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#netmask OvpnServer#netmask}
  */
  readonly netmask?: number;
  /**
  * Port to run the server on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#port OvpnServer#port}
  */
  readonly port?: number;
  /**
  * indicates the protocol to use when connecting with the remote endpoint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#protocol OvpnServer#protocol}
  */
  readonly protocol?: string;
  /**
  * Push routes to the VPN client (available since RouterOS 7.14).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#push_routes OvpnServer#push_routes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#redirect_gateway OvpnServer#redirect_gateway}
  */
  readonly redirectGateway?: string[];
  /**
  * Renegotiate data channel key after n seconds (default=3600).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#reneg_sec OvpnServer#reneg_sec}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#require_client_certificate OvpnServer#require_client_certificate}
  */
  readonly requireClientCertificate?: boolean | cdktf.IResolvable;
  /**
  * Specifies which TLS versions to allow.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#tls_version OvpnServer#tls_version}
  */
  readonly tlsVersion?: string;
  /**
  * IPv6 prefix address which will be used when generating the OVPN interface on the server side.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#tun_server_ipv6 OvpnServer#tun_server_ipv6}
  */
  readonly tunServerIpv6?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server routeros_ovpn_server}
*/
export class OvpnServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OvpnServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ovpn_server routeros_ovpn_server} Resource
  *
  * @param scope The scope in which to define this construct
