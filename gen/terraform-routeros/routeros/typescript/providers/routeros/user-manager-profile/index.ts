// https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_profile
...
export interface UserManagerProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_profile#___path___ UserManagerProfile#___path___}
  */
  readonly path?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_profile#id UserManagerProfile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_profile#name UserManagerProfile#name}
  */
  readonly name: string;
  /**
  * The name that will be shown to users in the web interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_profile#name_for_users UserManagerProfile#name_for_users}
  */
  readonly nameForUsers?: string;
  /**
  * An option whether to allow multiple sessions with the same user name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_profile#override_shared_users UserManagerProfile#override_shared_users}
  */
  readonly overrideSharedUsers?: string;
  /**
  * The price of the profile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_profile#price UserManagerProfile#price}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_profile#starts_when UserManagerProfile#starts_when}
  */
  readonly startsWhen?: string;
  /**
  * The total amount of time a user can use this profile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_profile#validity UserManagerProfile#validity}
  */
  readonly validity?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_profile routeros_user_manager_profile}
*/
export class UserManagerProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserManagerProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/user_manager_profile routeros_user_manager_profile} Resource
  *
  * @param scope The scope in which to define this construct
