// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ssh_server
...
export interface IpSshServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ssh_server#___path___ IpSshServer#___path___}
  */
  readonly path?: string;
  /**
  * Whether to allow connection if cryptographic algorithms are set to none.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ssh_server#allow_none_crypto IpSshServer#allow_none_crypto}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ssh_server#always_allow_password_login IpSshServer#always_allow_password_login}
  */
  readonly alwaysAllowPasswordLogin?: boolean | cdktf.IResolvable;
  /**
  * Allow to configure SSH ciphers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ssh_server#ciphers IpSshServer#ciphers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ssh_server#forwarding_enabled IpSshServer#forwarding_enabled}
  */
  readonly forwardingEnabled?: string;
  /**
  * RSA key size when host key is being regenerated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ssh_server#host_key_size IpSshServer#host_key_size}
  */
  readonly hostKeySize?: number;
  /**
  * Select host key type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ssh_server#host_key_type IpSshServer#host_key_type}
  */
  readonly hostKeyType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ssh_server#id IpSshServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ssh_server#strong_crypto IpSshServer#strong_crypto}
  */
  readonly strongCrypto?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ssh_server routeros_ip_ssh_server}
*/
export class IpSshServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpSshServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ssh_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ssh_server routeros_ip_ssh_server} Resource
  *
  * @param scope The scope in which to define this construct
