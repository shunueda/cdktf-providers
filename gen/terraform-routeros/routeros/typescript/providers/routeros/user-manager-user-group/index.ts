// https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/user_manager_user_group
...
export interface UserManagerUserGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/user_manager_user_group#___path___ UserManagerUserGroup#___path___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/user_manager_user_group#attributes UserManagerUserGroup#attributes}
  */
  readonly attributes?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/user_manager_user_group#id UserManagerUserGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/user_manager_user_group#inner_auths UserManagerUserGroup#inner_auths}
  */
  readonly innerAuths?: string[];
  /**
  * Unique name of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/user_manager_user_group#name UserManagerUserGroup#name}
  */
  readonly name: string;
  /**
  * A set of allowed authentication methods (`pap`, `chap`, `mschap1`, `mschap2`, `eap-tls`, `eap-ttls`, `eap-peap`, `eap-mschap2`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/user_manager_user_group#outer_auths UserManagerUserGroup#outer_auths}
  */
  readonly outerAuths?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/user_manager_user_group routeros_user_manager_user_group}
*/
export class UserManagerUserGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserManagerUserGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/user_manager_user_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/user_manager_user_group routeros_user_manager_user_group} Resource
  *
  * @param scope The scope in which to define this construct
