// https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance
...
export interface RoutingBgpInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance#___path___ RoutingBgpInstance#___path___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance#as RoutingBgpInstance#as}
  */
  readonly as?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance#cluster_id RoutingBgpInstance#cluster_id}
  */
  readonly clusterId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance#comment RoutingBgpInstance#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance#disabled RoutingBgpInstance#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance#id RoutingBgpInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance#ignore_as_path_len RoutingBgpInstance#ignore_as_path_len}
  */
  readonly ignoreAsPathLen?: boolean | cdktf.IResolvable;
  /**
  * Instance name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance#name RoutingBgpInstance#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance#router_id RoutingBgpInstance#router_id}
  */
  readonly routerId?: string;
  /**
  * Name of the routing table, to install routes in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance#routing_table RoutingBgpInstance#routing_table}
  */
  readonly routingTable?: string;
  /**
  * Name of the VRF BGP connections operates on. By default always use the `main` routing table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance#vrf RoutingBgpInstance#vrf}
  */
  readonly vrf?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance routeros_routing_bgp_instance}
*/
export class RoutingBgpInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoutingBgpInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/routing_bgp_instance routeros_routing_bgp_instance} Resource
  *
  * @param scope The scope in which to define this construct
