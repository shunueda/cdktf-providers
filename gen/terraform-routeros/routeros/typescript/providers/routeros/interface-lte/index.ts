// https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte
...
export interface InterfaceLteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#___path___ InterfaceLte#___path___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#allow_roaming InterfaceLte#allow_roaming}
  */
  readonly allowRoaming?: boolean | cdktf.IResolvable;
  /**
  * Which APN profile to use for this interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#apn_profiles InterfaceLte#apn_profiles}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#band InterfaceLte#band}
  */
  readonly band?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#comment InterfaceLte#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#disabled InterfaceLte#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#id InterfaceLte#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#modem_init InterfaceLte#modem_init}
  */
  readonly modemInit?: string;
  /**
  * Layer3 Maximum transmission unit ('auto', 0 .. 65535)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#mtu InterfaceLte#mtu}
  */
  readonly mtu?: string;
  /**
  * Descriptive name of the interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#name InterfaceLte#name}
  */
  readonly name: string;
  /**
  * Select/force mode for LTE interface to operate with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#network_mode InterfaceLte#network_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#nr_band InterfaceLte#nr_band}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#operator InterfaceLte#operator}
  */
  readonly operator?: number;
  /**
  * SIM Card's PIN code.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#pin InterfaceLte#pin}
  */
  readonly pin?: string;
  /**
  * SMS functionality. `mbim`: uses MBIM driver. `at`: uses AT-Commands. `auto`: selects the appropriate option depending on the modem.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#sms_protocol InterfaceLte#sms_protocol}
  */
  readonly smsProtocol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#sms_read InterfaceLte#sms_read}
  */
  readonly smsRead?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte routeros_interface_lte}
*/
export class InterfaceLte extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfaceLte that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/interface_lte routeros_interface_lte} Resource
  *
  * @param scope The scope in which to define this construct
