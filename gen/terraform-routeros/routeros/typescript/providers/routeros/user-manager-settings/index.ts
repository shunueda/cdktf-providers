// https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_settings
...
export interface UserManagerSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_settings#___path___ UserManagerSettings#___path___}
  */
  readonly path?: string;
  /**
  * Port to listen for RADIUS accounting requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_settings#accounting_port UserManagerSettings#accounting_port}
  */
  readonly accountingPort?: number;
  /**
  * Port to listen for RADIUS authentication requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_settings#authentication_port UserManagerSettings#authentication_port}
  */
  readonly authenticationPort?: number;
  /**
  * Certificate for use in EAP TLS-type authentication methods.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_settings#certificate UserManagerSettings#certificate}
  */
  readonly certificate?: string;
  /**
  * An option whether the User Manager functionality is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_settings#enabled UserManagerSettings#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_settings#id UserManagerSettings#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_settings#require_message_auth UserManagerSettings#require_message_auth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_settings#use_profiles UserManagerSettings#use_profiles}
  */
  readonly useProfiles?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_settings routeros_user_manager_settings}
*/
export class UserManagerSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserManagerSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_settings routeros_user_manager_settings} Resource
  *
  * @param scope The scope in which to define this construct
