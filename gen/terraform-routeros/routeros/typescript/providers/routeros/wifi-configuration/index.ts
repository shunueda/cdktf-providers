// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration
...
export interface WifiConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#___path___ WifiConfiguration#___path___}
  */
  readonly path?: string;
  /**
  * <em>A set of transformations for field names. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#___ts___ WifiConfiguration#___ts___}
  */
  readonly ts?: string;
  /**
  * AAA inline settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#aaa WifiConfiguration#aaa}
  */
  readonly aaa?: { [key: string]: string };
  /**
  * An option overrides the default antenna gain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#antenna_gain WifiConfiguration#antenna_gain}
  */
  readonly antennaGain?: number;
  /**
  * Time interval between beacon frames.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#beacon_interval WifiConfiguration#beacon_interval}
  */
  readonly beaconInterval?: string;
  /**
  * Radio chains to use for receiving signals.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#chains WifiConfiguration#chains}
  */
  readonly chains?: number[];
  /**
  * Channel inline settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#channel WifiConfiguration#channel}
  */
  readonly channel?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#comment WifiConfiguration#comment}
  */
  readonly comment?: string;
  /**
  * An option determines which regulatory domain restrictions are applied to an interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#country WifiConfiguration#country}
  */
  readonly country?: string;
  /**
  * Datapath inline settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#datapath WifiConfiguration#datapath}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#deprioritize_unii_3_4 WifiConfiguration#deprioritize_unii_3_4}
  */
  readonly deprioritizeUnii34?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#disabled WifiConfiguration#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#dtim_period WifiConfiguration#dtim_period}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#hide_ssid WifiConfiguration#hide_ssid}
  */
  readonly hideSsid?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#id WifiConfiguration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#interworking WifiConfiguration#interworking}
  */
  readonly interworking?: { [key: string]: string };
  /**
  * An option to specify the remote CAP mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#manager WifiConfiguration#manager}
  */
  readonly manager?: string;
  /**
  * An option to specify the access point operational mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#mode WifiConfiguration#mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#multicast_enhance WifiConfiguration#multicast_enhance}
  */
  readonly multicastEnhance?: string;
  /**
  * Name of the configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#name WifiConfiguration#name}
  */
  readonly name: string;
  /**
  * An option to specify the QoS classifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#qos_classifier WifiConfiguration#qos_classifier}
  */
  readonly qosClassifier?: string;
  /**
  * Security inline settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#security WifiConfiguration#security}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#ssid WifiConfiguration#ssid}
  */
  readonly ssid?: string;
  /**
  * Steering inline settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#steering WifiConfiguration#steering}
  */
  readonly steering?: { [key: string]: string };
  /**
  * Radio chains to use for transmitting signals.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#tx_chains WifiConfiguration#tx_chains}
  */
  readonly txChains?: number[];
  /**
  * A limit on the transmit power (in dBm) of the interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#tx_power WifiConfiguration#tx_power}
  */
  readonly txPower?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration routeros_wifi_configuration}
*/
export class WifiConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WifiConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_configuration routeros_wifi_configuration} Resource
  *
  * @param scope The scope in which to define this construct
