// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ipsec_proposal
...
export interface IpIpsecProposalConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ipsec_proposal#___path___ IpIpsecProposal#___path___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ipsec_proposal#auth_algorithms IpIpsecProposal#auth_algorithms}
  */
  readonly authAlgorithms?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ipsec_proposal#comment IpIpsecProposal#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ipsec_proposal#disabled IpIpsecProposal#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Allowed algorithms and key lengths to use for SAs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ipsec_proposal#enc_algorithms IpIpsecProposal#enc_algorithms}
  */
  readonly encAlgorithms?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ipsec_proposal#id IpIpsecProposal#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ipsec_proposal#lifetime IpIpsecProposal#lifetime}
  */
  readonly lifetime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ipsec_proposal#name IpIpsecProposal#name}
  */
  readonly name: string;
  /**
  * The diffie-Helman group used for Perfect Forward Secrecy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ipsec_proposal#pfs_group IpIpsecProposal#pfs_group}
  */
  readonly pfsGroup?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ipsec_proposal routeros_ip_ipsec_proposal}
*/
export class IpIpsecProposal extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpIpsecProposal that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ipsec_proposal#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_ipsec_proposal routeros_ip_ipsec_proposal} Resource
  *
  * @param scope The scope in which to define this construct
