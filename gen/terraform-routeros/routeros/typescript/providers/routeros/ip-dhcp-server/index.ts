// https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server
...
export interface IpDhcpServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#___path___ IpDhcpServer#___path___}
  */
  readonly path?: string;
  /**
  * Whether to add dynamic ARP entry. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#add_arp IpDhcpServer#add_arp}
  */
  readonly addArp?: boolean | cdktf.IResolvable;
  /**
  * Address list to which address will be added if lease is bound.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#address_lists IpDhcpServer#address_lists}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#address_pool IpDhcpServer#address_pool}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#allow_dual_stack_queue IpDhcpServer#allow_dual_stack_queue}
  */
  readonly allowDualStackQueue?: boolean | cdktf.IResolvable;
  /**
  * Always send replies as broadcasts even if destination IP is known.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#always_broadcast IpDhcpServer#always_broadcast}
  */
  readonly alwaysBroadcast?: boolean | cdktf.IResolvable;
  /**
  * Option changes the way how a server responds to DHCP requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#authoritative IpDhcpServer#authoritative}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#bootp_lease_time IpDhcpServer#bootp_lease_time}
  */
  readonly bootpLeaseTime?: string;
  /**
  * Support for BOOTP clients.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#bootp_support IpDhcpServer#bootp_support}
  */
  readonly bootpSupport?: string;
  /**
  * Specifies whether to limit specific number of clients per single MAC address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#client_mac_limit IpDhcpServer#client_mac_limit}
  */
  readonly clientMacLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#comment IpDhcpServer#comment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#conflict_detection IpDhcpServer#conflict_detection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#delay_threshold IpDhcpServer#delay_threshold}
  */
  readonly delayThreshold?: string;
  /**
  * Use custom set of DHCP options defined in option sets menu.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#dhcp_option_set IpDhcpServer#dhcp_option_set}
  */
  readonly dhcpOptionSet?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#disabled IpDhcpServer#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Dynamic lease identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#dynamic_lease_identifiers IpDhcpServer#dynamic_lease_identifiers}
  */
  readonly dynamicLeaseIdentifiers?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#id IpDhcpServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#insert_queue_before IpDhcpServer#insert_queue_before}
  */
  readonly insertQueueBefore?: string;
  /**
  * Name of the interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#interface IpDhcpServer#interface}
  */
  readonly interface: string;
  /**
  * A script that will be executed after a lease is assigned or de-assigned.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#lease_script IpDhcpServer#lease_script}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#lease_time IpDhcpServer#lease_time}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#name IpDhcpServer#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#parent_queue IpDhcpServer#parent_queue}
  */
  readonly parentQueue?: string;
  /**
  * The IP address of the relay this DHCP server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#relay IpDhcpServer#relay}
  */
  readonly relay?: string;
  /**
  * The address which the DHCP client must send requests to in order to renew an IP address lease.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#src_address IpDhcpServer#src_address}
  */
  readonly srcAddress?: string;
  /**
  * Support broadband TR101
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#support_broadband_tr101 IpDhcpServer#support_broadband_tr101}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#use_framed_as_classless IpDhcpServer#use_framed_as_classless}
  */
  readonly useFramedAsClassless?: boolean | cdktf.IResolvable;
  /**
  * Whether to use RADIUS server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#use_radius IpDhcpServer#use_radius}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#use_reconfigure IpDhcpServer#use_reconfigure}
  */
  readonly useReconfigure?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server routeros_ip_dhcp_server}
*/
export class IpDhcpServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpDhcpServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_dhcp_server routeros_ip_dhcp_server} Resource
  *
  * @param scope The scope in which to define this construct
