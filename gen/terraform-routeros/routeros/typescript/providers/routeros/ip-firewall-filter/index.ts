// https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter
...
export interface IpFirewallFilterConfig extends cdktf.TerraformMetaArguments {
  /**
  * <em>Resource path for CRUD operations. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#___path___ IpFirewallFilter#___path___}
  */
  readonly path?: string;
  /**
  * <em>A set of transformations for field names. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#___skip___ IpFirewallFilter#___skip___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#___unset___ IpFirewallFilter#___unset___}
  */
  readonly unset?: string;
  /**
  * Action to take if a packet is matched by the rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#action IpFirewallFilter#action}
  */
  readonly action: string;
  /**
  * Name of the address list used in 'add-dst-to-address-list' and 'add-src-to-address-list' actions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#address_list IpFirewallFilter#address_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#address_list_timeout IpFirewallFilter#address_list_timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#chain IpFirewallFilter#chain}
  */
  readonly chain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#comment IpFirewallFilter#comment}
  */
  readonly comment?: string;
  /**
  * Matches packets only if a given amount of bytes has been transfered through the particular connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#connection_bytes IpFirewallFilter#connection_bytes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#connection_limit IpFirewallFilter#connection_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#connection_mark IpFirewallFilter#connection_mark}
  */
  readonly connectionMark?: string;
  /**
  * Can match connections that are srcnatted, dstnatted or both.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#connection_nat_state IpFirewallFilter#connection_nat_state}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#connection_rate IpFirewallFilter#connection_rate}
  */
  readonly connectionRate?: string;
  /**
  * Interprets the connection tracking analysis data for a particular packet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#connection_state IpFirewallFilter#connection_state}
  */
  readonly connectionState?: string;
  /**
  * Matches packets from related connections based on information from their connection tracking helpers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#connection_type IpFirewallFilter#connection_type}
  */
  readonly connectionType?: string;
  /**
  * Match packets that contain specified text.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#content IpFirewallFilter#content}
  */
  readonly content?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#disabled IpFirewallFilter#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Matches DSCP IP header field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#dscp IpFirewallFilter#dscp}
  */
  readonly dscp?: number;
  /**
  * Matches packets which destination is equal to specified IP or falls into specified IP range.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#dst_address IpFirewallFilter#dst_address}
  */
  readonly dstAddress?: string;
  /**
  * Matches destination address of a packet against user-defined address list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#dst_address_list IpFirewallFilter#dst_address_list}
  */
  readonly dstAddressList?: string;
  /**
  * Matches destination address type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#dst_address_type IpFirewallFilter#dst_address_type}
  */
  readonly dstAddressType?: string;
  /**
  * Matches packets until a given rate is exceeded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#dst_limit IpFirewallFilter#dst_limit}
  */
  readonly dstLimit?: string;
  /**
  * List of destination port numbers or port number ranges.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#dst_port IpFirewallFilter#dst_port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#fragment IpFirewallFilter#fragment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#hotspot IpFirewallFilter#hotspot}
  */
  readonly hotspot?: string;
  /**
  * Connection offloading for Fasttrack.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#hw_offload IpFirewallFilter#hw_offload}
  */
  readonly hwOffload?: boolean | cdktf.IResolvable;
  /**
  * Matches ICMP type: code fields.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#icmp_options IpFirewallFilter#icmp_options}
  */
  readonly icmpOptions?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#id IpFirewallFilter#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#in_bridge_port IpFirewallFilter#in_bridge_port}
  */
  readonly inBridgePort?: string;
  /**
  * Set of interfaces defined in interface list. Works the same as in-bridge-port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#in_bridge_port_list IpFirewallFilter#in_bridge_port_list}
  */
  readonly inBridgePortList?: string;
  /**
  * Interface the packet has entered the router.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#in_interface IpFirewallFilter#in_interface}
  */
  readonly inInterface?: string;
  /**
  * Set of interfaces defined in interface list. Works the same as in-interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#in_interface_list IpFirewallFilter#in_interface_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#ingress_priority IpFirewallFilter#ingress_priority}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#ipsec_policy IpFirewallFilter#ipsec_policy}
  */
  readonly ipsecPolicy?: string;
  /**
  * Matches IPv4 header options.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#ipv4_options IpFirewallFilter#ipv4_options}
  */
  readonly ipv4Options?: string;
  /**
  * Name of the target chain to jump to. Applicable only if action=jump.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#jump_target IpFirewallFilter#jump_target}
  */
  readonly jumpTarget?: string;
  /**
  * Layer7 filter name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#layer7_protocol IpFirewallFilter#layer7_protocol}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#limit IpFirewallFilter#limit}
  */
  readonly limit?: string;
  /**
  * Add a message to the system log.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#log IpFirewallFilter#log}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#log_prefix IpFirewallFilter#log_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#nth IpFirewallFilter#nth}
  */
  readonly nth?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#out_bridge_port IpFirewallFilter#out_bridge_port}
  */
  readonly outBridgePort?: string;
  /**
  * Set of interfaces defined in interface list. Works the same as out-bridge-port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#out_bridge_port_list IpFirewallFilter#out_bridge_port_list}
  */
  readonly outBridgePortList?: string;
  /**
  * Interface the packet is leaving the router.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#out_interface IpFirewallFilter#out_interface}
  */
  readonly outInterface?: string;
  /**
  * Set of interfaces defined in interface list. Works the same as out-interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#out_interface_list IpFirewallFilter#out_interface_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#packet_mark IpFirewallFilter#packet_mark}
  */
  readonly packetMark?: string;
  /**
  * Matches packets of specified size or size range in bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#packet_size IpFirewallFilter#packet_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#per_connection_classifier IpFirewallFilter#per_connection_classifier}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#place_before IpFirewallFilter#place_before}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#port IpFirewallFilter#port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#priority IpFirewallFilter#priority}
  */
  readonly priority?: number;
  /**
  * Matches particular IP protocol specified by protocol name or number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#protocol IpFirewallFilter#protocol}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#psd IpFirewallFilter#psd}
  */
  readonly psd?: string;
  /**
  * Matches packets randomly with a given probability.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#random IpFirewallFilter#random}
  */
  readonly random?: number;
  /**
  * Specifies ICMP error to be sent back if the packet is rejected. Applicable if action=reject.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#reject_with IpFirewallFilter#reject_with}
  */
  readonly rejectWith?: string;
  /**
  * Matches packets marked by mangle facility with particular routing mark.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#routing_mark IpFirewallFilter#routing_mark}
  */
  readonly routingMark?: string;
  /**
  * Matches packets which destination address is resolved in specific a routing table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#routing_table IpFirewallFilter#routing_table}
  */
  readonly routingTable?: string;
  /**
  * Matches packets which source is equal to specified IP or falls into a specified IP range.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#src_address IpFirewallFilter#src_address}
  */
  readonly srcAddress?: string;
  /**
  * Matches source address of a packet against user-defined address list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#src_address_list IpFirewallFilter#src_address_list}
  */
  readonly srcAddressList?: string;
  /**
  * Matches source address type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#src_address_type IpFirewallFilter#src_address_type}
  */
  readonly srcAddressType?: string;
  /**
  * Matches source MAC address of the packet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#src_mac_address IpFirewallFilter#src_mac_address}
  */
  readonly srcMacAddress?: string;
  /**
  * List of source ports and ranges of source ports. Applicable only if a protocol is TCP or UDP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#src_port IpFirewallFilter#src_port}
  */
  readonly srcPort?: string;
  /**
  * Matches specified TCP flags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#tcp_flags IpFirewallFilter#tcp_flags}
  */
  readonly tcpFlags?: string;
  /**
  * Matches TCP MSS value of an IP packet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#tcp_mss IpFirewallFilter#tcp_mss}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#time IpFirewallFilter#time}
  */
  readonly time?: string;
  /**
  * Allows matching HTTPS traffic based on TLS SNI hostname.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#tls_host IpFirewallFilter#tls_host}
  */
  readonly tlsHost?: string;
  /**
  * Matches packets TTL value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#ttl IpFirewallFilter#ttl}
  */
  readonly ttl?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter routeros_ip_firewall_filter}
*/
export class IpFirewallFilter extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "routeros_ip_firewall_filter";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a IpFirewallFilter resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the IpFirewallFilter to import
  * @param importFromId The id of the existing IpFirewallFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IpFirewallFilter to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "routeros_ip_firewall_filter", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_firewall_filter routeros_ip_firewall_filter} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IpFirewallFilterConfig
  */
  public constructor(scope: Construct, id: string, config: IpFirewallFilterConfig) {
    super(scope, id, {
      terraformResourceType: 'routeros_ip_firewall_filter',
