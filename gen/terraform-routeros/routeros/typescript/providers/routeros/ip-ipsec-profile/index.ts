// https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile
...
export interface IpIpsecProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile#___path___ IpIpsecProfile#___path___}
  */
  readonly path?: string;
  /**
  * Diffie-Hellman group (cipher strength).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile#dh_group IpIpsecProfile#dh_group}
  */
  readonly dhGroup?: string[];
  /**
  * Dead peer detection interval. If set to disable-dpd, dead peer detection will not be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile#dpd_interval IpIpsecProfile#dpd_interval}
  */
  readonly dpdInterval?: string;
  /**
  * Maximum count of failures until peer is considered to be dead. Applicable if DPD is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile#dpd_maximum_failures IpIpsecProfile#dpd_maximum_failures}
  */
  readonly dpdMaximumFailures?: number;
  /**
  * List of encryption algorithms that will be used by the peer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile#enc_algorithm IpIpsecProfile#enc_algorithm}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile#hash_algorithm IpIpsecProfile#hash_algorithm}
  */
  readonly hashAlgorithm?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile#id IpIpsecProfile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile#lifebytes IpIpsecProfile#lifebytes}
  */
  readonly lifebytes?: number;
  /**
  * Phase 1 lifetime: specifies how long the SA will be valid.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile#lifetime IpIpsecProfile#lifetime}
  */
  readonly lifetime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile#name IpIpsecProfile#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile#nat_traversal IpIpsecProfile#nat_traversal}
  */
  readonly natTraversal?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile#prf_algorithm IpIpsecProfile#prf_algorithm}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile#proposal_check IpIpsecProfile#proposal_check}
  */
  readonly proposalCheck?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile routeros_ip_ipsec_profile}
*/
export class IpIpsecProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpIpsecProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/ip_ipsec_profile routeros_ip_ipsec_profile} Resource
  *
  * @param scope The scope in which to define this construct
