// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/container_config
...
export interface ContainerConfigAConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/container_config#___path___ ContainerConfigA#___path___}
  */
  readonly path?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/container_config#id ContainerConfigA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/container_config#layer_dir ContainerConfigA#layer_dir}
  */
  readonly layerDir?: string;
  /**
  * Specifies the password for authentication (starting from ROS 7.8)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/container_config#password ContainerConfigA#password}
  */
  readonly password?: string;
  /**
  * RAM usage limit. (0 for unlimited)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/container_config#ram_high ContainerConfigA#ram_high}
  */
  readonly ramHigh?: string;
  /**
  * External registry url from where the container will be downloaded.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/container_config#registry_url ContainerConfigA#registry_url}
  */
  readonly registryUrl?: string;
  /**
  * Container extraction directory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/container_config#tmpdir ContainerConfigA#tmpdir}
  */
  readonly tmpdir?: string;
  /**
  * Specifies the username for authentication (starting from ROS 7.8)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/container_config#username ContainerConfigA#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/container_config routeros_container_config}
*/
export class ContainerConfigA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/container_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/container_config routeros_container_config} Resource
  *
  * @param scope The scope in which to define this construct
