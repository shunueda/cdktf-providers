// https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route
...
export interface Ipv6RouteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#___path___ Ipv6Route#___path___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#blackhole Ipv6Route#blackhole}
  */
  readonly blackhole?: boolean | cdktf.IResolvable;
  /**
  * Currently used check-gateway option.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#check_gateway Ipv6Route#check_gateway}
  */
  readonly checkGateway?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#comment Ipv6Route#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#disabled Ipv6Route#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Value used in route selection. Routes with smaller distance value are given preference.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#distance Ipv6Route#distance}
  */
  readonly distance?: number;
  /**
  * IP prefix of route, specifies destination addresses that this route can be used for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#dst_address Ipv6Route#dst_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#gateway Ipv6Route#gateway}
  */
  readonly gateway: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#id Ipv6Route#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#pref_src Ipv6Route#pref_src}
  */
  readonly prefSrc?: string;
  /**
  * Routing table this route belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#routing_table Ipv6Route#routing_table}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#scope Ipv6Route#scope}
  */
  readonly scope?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#suppress_hw_offload Ipv6Route#suppress_hw_offload}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#target_scope Ipv6Route#target_scope}
  */
  readonly targetScope?: number;
  /**
  * VRF interface name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#vrf_interface Ipv6Route#vrf_interface}
  */
  readonly vrfInterface?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route routeros_ipv6_route}
*/
export class Ipv6Route extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Ipv6Route that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/ipv6_route routeros_ipv6_route} Resource
  *
  * @param scope The scope in which to define this construct
