// https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g
...
export interface InterfaceW60GConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#___path___ InterfaceW60G#___path___}
  */
  readonly path?: string;
  /**
  * <em>A set of transformations for field names. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#___skip___ InterfaceW60G#___skip___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#arp InterfaceW60G#arp}
  */
  readonly arp?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#arp_timeout InterfaceW60G#arp_timeout}
  */
  readonly arpTimeout?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#comment InterfaceW60G#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#disabled InterfaceW60G#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Frequency used in communication (Only active on bridge device).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#frequency InterfaceW60G#frequency}
  */
  readonly frequency?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#id InterfaceW60G#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#isolate_stations InterfaceW60G#isolate_stations}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#l2mtu InterfaceW60G#l2mtu}
  */
  readonly l2Mtu?: number;
  /**
  * MAC address of the radio interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#mac_address InterfaceW60G#mac_address}
  */
  readonly macAddress?: string;
  /**
  * Experimental feature working only on wAP60Gx3 devices, providing better point to multi point stability in some cases.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#mdmg_fix InterfaceW60G#mdmg_fix}
  */
  readonly mdmgFix?: boolean | cdktf.IResolvable;
  /**
  * Operation mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#mode InterfaceW60G#mode}
  */
  readonly mode?: string;
  /**
  * Layer3 Maximum transmission unit ('auto', 0 .. 65535). Look for the exact minimum value in the MikroTik documentation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#mtu InterfaceW60G#mtu}
  */
  readonly mtu?: string;
  /**
  * Name of the interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#name InterfaceW60G#name}
  */
  readonly name: string;
  /**
  * Password used for AES encryption.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#password InterfaceW60G#password}
  */
  readonly password?: string;
  /**
  * Put newly created station device interfaces in this bridge.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#put_stations_in_bridge InterfaceW60G#put_stations_in_bridge}
  */
  readonly putStationsInBridge?: string;
  /**
  * Parameter to limit frequency use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#region InterfaceW60G#region}
  */
  readonly region?: string;
  /**
  * Scan list to limit connectivity over frequencies in station mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#scan_list InterfaceW60G#scan_list}
  */
  readonly scanList?: string[];
  /**
  * SSID (service set identifier) is a name that identifies wireless network (0..32 char).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#ssid InterfaceW60G#ssid}
  */
  readonly ssid?: string;
  /**
  * Disables beamforming and locks to selected radiation pattern.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#tx_sector InterfaceW60G#tx_sector}
  */
  readonly txSector?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g routeros_interface_w60g}
*/
export class InterfaceW60G extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfaceW60G that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_w60g routeros_interface_w60g} Resource
  *
  * @param scope The scope in which to define this construct
