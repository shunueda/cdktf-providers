// https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/tool_bandwidth_server
...
export interface ToolBandwidthServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/tool_bandwidth_server#___path___ ToolBandwidthServer#___path___}
  */
  readonly path?: string;
  /**
  * Beginning of UDP port range.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/tool_bandwidth_server#allocate_udp_ports_from ToolBandwidthServer#allocate_udp_ports_from}
  */
  readonly allocateUdpPortsFrom?: number;
  /**
  * IPv4 allowed networks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/tool_bandwidth_server#allowed_addresses4 ToolBandwidthServer#allowed_addresses4}
  */
  readonly allowedAddresses4?: string[];
  /**
  * Ipv6 allowed networks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/tool_bandwidth_server#allowed_addresses6 ToolBandwidthServer#allowed_addresses6}
  */
  readonly allowedAddresses6?: string[];
  /**
  * Communicate only with authenticated clients.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/tool_bandwidth_server#authenticate ToolBandwidthServer#authenticate}
  */
  readonly authenticate?: boolean | cdktf.IResolvable;
  /**
  * Defines whether bandwidth server is enabled or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/tool_bandwidth_server#enabled ToolBandwidthServer#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/tool_bandwidth_server#id ToolBandwidthServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/tool_bandwidth_server#max_sessions ToolBandwidthServer#max_sessions}
  */
  readonly maxSessions?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/tool_bandwidth_server routeros_tool_bandwidth_server}
*/
export class ToolBandwidthServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ToolBandwidthServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/tool_bandwidth_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/tool_bandwidth_server routeros_tool_bandwidth_server} Resource
  *
  * @param scope The scope in which to define this construct
