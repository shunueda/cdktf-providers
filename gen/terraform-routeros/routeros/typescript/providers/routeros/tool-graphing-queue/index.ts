// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/tool_graphing_queue
...
export interface ToolGraphingQueueConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/tool_graphing_queue#___path___ ToolGraphingQueue#___path___}
  */
  readonly path?: string;
  /**
  * IP address range from which is allowed to access graphing information.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/tool_graphing_queue#allow_address ToolGraphingQueue#allow_address}
  */
  readonly allowAddress?: string;
  /**
  * Whether to allow access to graphs from queue's target-address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/tool_graphing_queue#allow_target ToolGraphingQueue#allow_target}
  */
  readonly allowTarget?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/tool_graphing_queue#disabled ToolGraphingQueue#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/tool_graphing_queue#id ToolGraphingQueue#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/tool_graphing_queue#simple_queue ToolGraphingQueue#simple_queue}
  */
  readonly simpleQueue: string;
  /**
  * Defines whether to store collected information on system drive.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/tool_graphing_queue#store_on_disk ToolGraphingQueue#store_on_disk}
  */
  readonly storeOnDisk?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/tool_graphing_queue routeros_tool_graphing_queue}
*/
export class ToolGraphingQueue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ToolGraphingQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/tool_graphing_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/tool_graphing_queue routeros_tool_graphing_queue} Resource
  *
  * @param scope The scope in which to define this construct
