// https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/data-sources/ipv6_addresses
...
export interface DataRouterosIpv6AddressesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/data-sources/ipv6_addresses#___path___ DataRouterosIpv6Addresses#___path___}
  */
  readonly path?: string;
  /**
  * Additional request filtering options.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/data-sources/ipv6_addresses#filter DataRouterosIpv6Addresses#filter}
  */
  readonly filter?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/data-sources/ipv6_addresses#id DataRouterosIpv6Addresses#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/data-sources/ipv6_addresses routeros_ipv6_addresses}
*/
export class DataRouterosIpv6Addresses extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRouterosIpv6Addresses that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/data-sources/ipv6_addresses#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/data-sources/ipv6_addresses routeros_ipv6_addresses} Data Source
  *
  * @param scope The scope in which to define this construct
