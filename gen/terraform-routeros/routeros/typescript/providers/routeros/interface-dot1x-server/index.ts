// https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server
...
export interface InterfaceDot1XServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#___path___ InterfaceDot1XServer#___path___}
  */
  readonly path?: string;
  /**
  * Whether to send RADIUS accounting requests to the authentication server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#accounting InterfaceDot1XServer#accounting}
  */
  readonly accounting?: boolean | cdktf.IResolvable;
  /**
  * Total time available for EAP authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#auth_timeout InterfaceDot1XServer#auth_timeout}
  */
  readonly authTimeout?: string;
  /**
  * Used authentication type on a server interface. Comma-separated list of `dot1x` and `mac-auth`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#auth_types InterfaceDot1XServer#auth_types}
  */
  readonly authTypes?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#comment InterfaceDot1XServer#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#disabled InterfaceDot1XServer#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Assigned VLAN when end devices do not support dot1x authentication and no mac-auth fallback is configured.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#guest_vlan_id InterfaceDot1XServer#guest_vlan_id}
  */
  readonly guestVlanId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#id InterfaceDot1XServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#interface InterfaceDot1XServer#interface}
  */
  readonly interface: string;
  /**
  * Interval between scheduled RADIUS Interim-Update messages.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#interim_update InterfaceDot1XServer#interim_update}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#mac_auth_mode InterfaceDot1XServer#mac_auth_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#radius_mac_format InterfaceDot1XServer#radius_mac_format}
  */
  readonly radiusMacFormat?: string;
  /**
  * An option that enables server port re-authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#reauth_timeout InterfaceDot1XServer#reauth_timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#reject_vlan_id InterfaceDot1XServer#reject_vlan_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#retrans_timeout InterfaceDot1XServer#retrans_timeout}
  */
  readonly retransTimeout?: string;
  /**
  * Assigned VLAN when RADIUS server is not responding and request timed out.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#server_fail_vlan_id InterfaceDot1XServer#server_fail_vlan_id}
  */
  readonly serverFailVlanId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server routeros_interface_dot1x_server}
*/
export class InterfaceDot1XServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfaceDot1XServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_dot1x_server routeros_interface_dot1x_server} Resource
  *
  * @param scope The scope in which to define this construct
