// https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/zerotier
...
export interface ZerotierConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/zerotier#___path___ Zerotier#___path___}
  */
  readonly path?: string;
  /**
  * <em>A set of transformations for field names. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/zerotier#___ts___ Zerotier#___ts___}
  */
  readonly ts?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/zerotier#comment Zerotier#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/zerotier#disabled Zerotier#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/zerotier#id Zerotier#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/zerotier#identity Zerotier#identity}
  */
  readonly identity?: string;
  /**
  * The interfaces to discover ZeroTier peers by ARP and IP type connections.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/zerotier#interfaces Zerotier#interfaces}
  */
  readonly interfaces?: string[];
  /**
  * Name of the ZeroTier instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/zerotier#name Zerotier#name}
  */
  readonly name: string;
  /**
  * The port number the instance listens to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/zerotier#port Zerotier#port}
  */
  readonly port?: number;
  /**
  * The route distance for routes obtained from the planet/moon server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/zerotier#route_distance Zerotier#route_distance}
  */
  readonly routeDistance?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/zerotier routeros_zerotier}
*/
export class Zerotier extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Zerotier that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/zerotier#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/zerotier routeros_zerotier} Resource
  *
  * @param scope The scope in which to define this construct
