// https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface
...
export interface CapsmanInterfaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#___path___ CapsmanInterface#___path___}
  */
  readonly path?: string;
  /**
  * <em>A set of transformations for field names. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#___skip___ CapsmanInterface#___skip___}
  */
  readonly skip?: string;
  /**
  * <em>A set of transformations for field names. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#___ts___ CapsmanInterface#___ts___}
  */
  readonly ts?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#arp_timeout CapsmanInterface#arp_timeout}
  */
  readonly arpTimeout?: string;
  /**
  * Channel inline settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#channel CapsmanInterface#channel}
  */
  readonly channel?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#comment CapsmanInterface#comment}
  */
  readonly comment?: string;
  /**
  * Configuration inline settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#configuration CapsmanInterface#configuration}
  */
  readonly configuration?: { [key: string]: string };
  /**
  * Datapath inline settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#datapath CapsmanInterface#datapath}
  */
  readonly datapath?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#disabled CapsmanInterface#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#id CapsmanInterface#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#mac_address CapsmanInterface#mac_address}
  */
  readonly macAddress?: string;
  /**
  * The corresponding master interface of the virtual one.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#master_interface CapsmanInterface#master_interface}
  */
  readonly masterInterface?: string;
  /**
  * Name of the interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#name CapsmanInterface#name}
  */
  readonly name: string;
  /**
  * The MAC address of the associated radio.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#radio_mac CapsmanInterface#radio_mac}
  */
  readonly radioMac?: string;
  /**
  * Name of the associated radio.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#radio_name CapsmanInterface#radio_name}
  */
  readonly radioName?: string;
  /**
  * Rates inline settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#rates CapsmanInterface#rates}
  */
  readonly rates?: { [key: string]: string };
  /**
  * Security inline settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#security CapsmanInterface#security}
  */
  readonly security?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface routeros_capsman_interface}
*/
export class CapsmanInterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CapsmanInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/capsman_interface routeros_capsman_interface} Resource
  *
  * @param scope The scope in which to define this construct
