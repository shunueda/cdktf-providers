// https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_profile_limitation
...
export interface UserManagerProfileLimitationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_profile_limitation#___path___ UserManagerProfileLimitation#___path___}
  */
  readonly path?: string;
  /**
  * Time of the day when the limitation should take place.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_profile_limitation#from_time UserManagerProfileLimitation#from_time}
  */
  readonly fromTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_profile_limitation#id UserManagerProfileLimitation#id}
  *
  ...
  * The limitation name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_profile_limitation#limitation UserManagerProfileLimitation#limitation}
  */
  readonly limitation: string;
  /**
  * The profile name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_profile_limitation#profile UserManagerProfileLimitation#profile}
  */
  readonly profile: string;
  /**
  * Time of the day when the limitation should end.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_profile_limitation#till_time UserManagerProfileLimitation#till_time}
  */
  readonly tillTime?: string;
  /**
  * Days of the week when the limitation is active.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_profile_limitation#weekdays UserManagerProfileLimitation#weekdays}
  */
  readonly weekdays?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_profile_limitation routeros_user_manager_profile_limitation}
*/
export class UserManagerProfileLimitation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserManagerProfileLimitation that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_profile_limitation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/user_manager_profile_limitation routeros_user_manager_profile_limitation} Resource
  *
  * @param scope The scope in which to define this construct
