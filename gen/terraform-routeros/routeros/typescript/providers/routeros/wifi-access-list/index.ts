// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list
...
export interface WifiAccessListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#___path___ WifiAccessList#___path___}
  */
  readonly path?: string;
  /**
  * An action to take when a client matches.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#action WifiAccessList#action}
  */
  readonly action?: string;
  /**
  * An option that permits the client's signal to be out of the range always or for some time interval.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#allow_signal_out_of_range WifiAccessList#allow_signal_out_of_range}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#client_isolation WifiAccessList#client_isolation}
  */
  readonly clientIsolation?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#comment WifiAccessList#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#disabled WifiAccessList#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#id WifiAccessList#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#interface WifiAccessList#interface}
  */
  readonly interface?: string;
  /**
  * MAC address of the client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#mac_address WifiAccessList#mac_address}
  */
  readonly macAddress?: string;
  /**
  * MAC address mask to apply when comparing clients' addresses.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#mac_address_mask WifiAccessList#mac_address_mask}
  */
  readonly macAddressMask?: string;
  /**
  * PSK passphrase for the client if some PSK authentication algorithm is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#passphrase WifiAccessList#passphrase}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#place_before WifiAccessList#place_before}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#radius_accounting WifiAccessList#radius_accounting}
  */
  readonly radiusAccounting?: boolean | cdktf.IResolvable;
  /**
  * The range in which the client signal must fall.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#signal_range WifiAccessList#signal_range}
  */
  readonly signalRange?: string;
  /**
  * The regular expression to compare the actual SSID the client connects to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#ssid_regexp WifiAccessList#ssid_regexp}
  */
  readonly ssidRegexp?: string;
  /**
  * Time of the day and days of the week when the rule is applicable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#time WifiAccessList#time}
  */
  readonly time?: string;
  /**
  * VLAN ID to use for VLAN tagging or `none`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#vlan_id WifiAccessList#vlan_id}
  */
  readonly vlanId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list routeros_wifi_access_list}
*/
export class WifiAccessList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WifiAccessList that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_access_list routeros_wifi_access_list} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public get lastLoggedIn() {
    return this.getStringAttribute('last_logged_in');
  }
  ...
  // match_count - computed: true, optional: false, required: false
