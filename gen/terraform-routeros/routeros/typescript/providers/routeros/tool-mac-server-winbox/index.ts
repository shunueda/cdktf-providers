// https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/tool_mac_server_winbox
...
export interface ToolMacServerWinboxConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/tool_mac_server_winbox#___path___ ToolMacServerWinbox#___path___}
  */
  readonly path?: string;
  /**
  * List of interfaces for MAC WinBox access.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/tool_mac_server_winbox#allowed_interface_list ToolMacServerWinbox#allowed_interface_list}
  */
  readonly allowedInterfaceList: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/tool_mac_server_winbox#id ToolMacServerWinbox#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/tool_mac_server_winbox routeros_tool_mac_server_winbox}
*/
export class ToolMacServerWinbox extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ToolMacServerWinbox that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/tool_mac_server_winbox#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/tool_mac_server_winbox routeros_tool_mac_server_winbox} Resource
  *
  * @param scope The scope in which to define this construct
