// https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container
...
export interface ContainerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#___path___ Container#___path___}
  */
  readonly path?: string;
  /**
  * <em>A set of transformations for field names. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#___skip___ Container#___skip___}
  */
  readonly skip?: string;
  /**
  * Specify an interval at which Container will be restarted on Container failure.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#auto_restart_interval Container#auto_restart_interval}
  */
  readonly autoRestartInterval?: string;
  /**
  * Enables trust chain validation from local certificate store.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#check_certificate Container#check_certificate}
  */
  readonly checkCertificate?: boolean | cdktf.IResolvable;
  /**
  * The main purpose of a CMD is to provide defaults for an executing container. These defaults can include an executable, or they can omit the executable, in which case you must specify an ENTRYPOINT instruction as well.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#cmd Container#cmd}
  */
  readonly cmd?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#comment Container#comment}
  */
  readonly comment?: string;
  /**
  * Passes through physical device to the container.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#devices Container#devices}
  */
  readonly devices?: string[];
  /**
  * Set custom DNS servers
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#dns Container#dns}
  */
  readonly dns?: string;
  /**
  * Container NIS domain name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#domain_name Container#domain_name}
  */
  readonly domainName?: string;
  /**
  * An ENTRYPOINT allows to specify executable to run when starting container. Example: /bin/sh
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#entrypoint Container#entrypoint}
  */
  readonly entrypoint?: string;
  /**
  * list of environmental variables (configured under /container envs ) to be used with container
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#envlist Container#envlist}
  */
  readonly envlist?: string;
  /**
  * container *tar.gz tarball if the container is imported from a file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#file Container#file}
  */
  readonly file?: string;
  /**
  * Container host name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#hostname Container#hostname}
  */
  readonly hostname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#id Container#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#interface Container#interface}
  */
  readonly interface: string;
  /**
  * if set to yes, all container-generated output will be shown in the RouterOS log
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#logging Container#logging}
  */
  readonly logging?: boolean | cdktf.IResolvable;
  /**
  * RAM usage limit in bytes for a specific container (string value).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#memory_high Container#memory_high}
  */
  readonly memoryHigh?: string;
  /**
  * Mounts from /container/mounts/ sub-menu to be used with this container
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#mounts Container#mounts}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#remote_image Container#remote_image}
  */
  readonly remoteImage?: string;
  /**
  * Used to save container store outside main memory
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#root_dir Container#root_dir}
  */
  readonly rootDir?: string;
  /**
  * Container state.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#running Container#running}
  */
  readonly running?: boolean | cdktf.IResolvable;
  /**
  * Start the container on boot
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#start_on_boot Container#start_on_boot}
  */
  readonly startOnBoot?: boolean | cdktf.IResolvable;
  /**
  * Signal to stop the container.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#stop_signal Container#stop_signal}
  */
  readonly stopSignal?: string;
  /**
  * Sets the username used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#user Container#user}
  */
  readonly user?: string;
  /**
  * The working directory for cmd entrypoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#workdir Container#workdir}
  */
  readonly workdir?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#timeouts Container#timeouts}
  */
  readonly timeouts?: ContainerTimeouts;
}
export interface ContainerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#create Container#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#delete Container#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container routeros_container}
*/
export class Container extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Container that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/container routeros_container} Resource
  *
  * @param scope The scope in which to define this construct
