// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_user_aaa
...
export interface SystemUserAaaConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_user_aaa#___path___ SystemUserAaa#___path___}
  */
  readonly path?: string;
  /**
  * An option that enables accounting for users.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_user_aaa#accounting SystemUserAaa#accounting}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_user_aaa#default_group SystemUserAaa#default_group}
  */
  readonly defaultGroup?: string;
  /**
  * A set of groups that are not allowed for users authenticated by RADIUS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_user_aaa#exclude_groups SystemUserAaa#exclude_groups}
  */
  readonly excludeGroups?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_user_aaa#id SystemUserAaa#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_user_aaa#interim_update SystemUserAaa#interim_update}
  */
  readonly interimUpdate?: string;
  /**
  * An option whether to use RADIUS server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_user_aaa#use_radius SystemUserAaa#use_radius}
  */
  readonly useRadius?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_user_aaa routeros_system_user_aaa}
*/
export class SystemUserAaa extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemUserAaa that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_user_aaa#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/system_user_aaa routeros_system_user_aaa} Resource
  *
  * @param scope The scope in which to define this construct
