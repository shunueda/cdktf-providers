// https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/interface_detect_internet
...
export interface InterfaceDetectInternetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/interface_detect_internet#___path___ InterfaceDetectInternet#___path___}
  */
  readonly path?: string;
  /**
  * All interfaces in the list will be monitored by Detect Internet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/interface_detect_internet#detect_interface_list InterfaceDetectInternet#detect_interface_list}
  */
  readonly detectInterfaceList?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/interface_detect_internet#id InterfaceDetectInternet#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/interface_detect_internet#internet_interface_list InterfaceDetectInternet#internet_interface_list}
  */
  readonly internetInterfaceList?: string;
  /**
  * Interfaces with state Lan will be dynamically added to this list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/interface_detect_internet#lan_interface_list InterfaceDetectInternet#lan_interface_list}
  */
  readonly lanInterfaceList?: string;
  /**
  * Interfaces with state Wan will be dynamically added to this list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/interface_detect_internet#wan_interface_list InterfaceDetectInternet#wan_interface_list}
  */
  readonly wanInterfaceList?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/interface_detect_internet routeros_interface_detect_internet}
*/
export class InterfaceDetectInternet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfaceDetectInternet that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/interface_detect_internet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/interface_detect_internet routeros_interface_detect_internet} Resource
  *
  * @param scope The scope in which to define this construct
