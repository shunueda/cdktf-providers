// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_tftp_settings
...
export interface IpTftpSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_tftp_settings#___path___ IpTftpSettings#___path___}
  */
  readonly path?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_tftp_settings#id IpTftpSettings#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_tftp_settings#max_block_size IpTftpSettings#max_block_size}
  */
  readonly maxBlockSize?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_tftp_settings routeros_ip_tftp_settings}
*/
export class IpTftpSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpTftpSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_tftp_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ip_tftp_settings routeros_ip_tftp_settings} Resource
  *
  * @param scope The scope in which to define this construct
