// https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user
...
export interface IpHotspotUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#___path___ IpHotspotUser#___path___}
  */
  readonly path?: string;
  /**
  * <em>A set of transformations for field names. This is an internal service field, setting a value is not required.</em>
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#___skip___ IpHotspotUser#___skip___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#address IpHotspotUser#address}
  */
  readonly address?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#comment IpHotspotUser#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#disabled IpHotspotUser#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * HotSpot client's e-mail, informational value for the HotSpot user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#email IpHotspotUser#email}
  */
  readonly email?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#id IpHotspotUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#limit_bytes_in IpHotspotUser#limit_bytes_in}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#limit_bytes_out IpHotspotUser#limit_bytes_out}
  */
  readonly limitBytesOut?: number;
  /**
  * (limit-bytes-in+limit-bytes-out). User is disconnected from HotSpot after the limit is reached.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#limit_bytes_total IpHotspotUser#limit_bytes_total}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#limit_uptime IpHotspotUser#limit_uptime}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#mac_address IpHotspotUser#mac_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#name IpHotspotUser#name}
  */
  readonly name: string;
  /**
  * User password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#password IpHotspotUser#password}
  */
  readonly password?: string;
  /**
  * User profile configured in `/ip hotspot user profile`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#profile IpHotspotUser#profile}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#routes IpHotspotUser#routes}
  */
  readonly routes?: string;
  /**
  * HotSpot server's name to which user is allowed login.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#server IpHotspotUser#server}
  */
  readonly server?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user routeros_ip_hotspot_user}
*/
export class IpHotspotUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpHotspotUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/ip_hotspot_user routeros_ip_hotspot_user} Resource
  *
  * @param scope The scope in which to define this construct
