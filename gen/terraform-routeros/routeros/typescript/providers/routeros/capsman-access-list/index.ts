// https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list
...
export interface CapsmanAccessListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#___path___ CapsmanAccessList#___path___}
  */
  readonly path?: string;
  /**
  * An action to take when a client matches.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#action CapsmanAccessList#action}
  */
  readonly action?: string;
  /**
  * An option that permits the client's signal to be out of the range always or for some time interval.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#allow_signal_out_of_range CapsmanAccessList#allow_signal_out_of_range}
  */
  readonly allowSignalOutOfRange?: string;
  /**
  * Transmission speed limit in the direction of the client..
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#ap_tx_limit CapsmanAccessList#ap_tx_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#client_to_client_forwarding CapsmanAccessList#client_to_client_forwarding}
  */
  readonly clientToClientForwarding?: boolean | cdktf.IResolvable;
  /**
  * Transmission speed limit in the direction of the access point.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#client_tx_limit CapsmanAccessList#client_tx_limit}
  */
  readonly clientTxLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#comment CapsmanAccessList#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#disabled CapsmanAccessList#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#id CapsmanAccessList#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#interface CapsmanAccessList#interface}
  */
  readonly interface?: string;
  /**
  * MAC address of the client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#mac_address CapsmanAccessList#mac_address}
  */
  readonly macAddress?: string;
  /**
  * MAC address mask to apply when comparing clients' addresses.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#mac_mask CapsmanAccessList#mac_mask}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#place_before CapsmanAccessList#place_before}
  */
  readonly placeBefore?: string;
  /**
  * PSK passphrase for the client if some PSK authentication algorithm is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#private_passphrase CapsmanAccessList#private_passphrase}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#radius_accounting CapsmanAccessList#radius_accounting}
  */
  readonly radiusAccounting?: boolean | cdktf.IResolvable;
  /**
  * The range in which the client signal must fall.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#signal_range CapsmanAccessList#signal_range}
  */
  readonly signalRange?: string;
  /**
  * The regular expression to compare the actual SSID the client connects to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#ssid_regexp CapsmanAccessList#ssid_regexp}
  */
  readonly ssidRegexp?: string;
  /**
  * Time of the day and days of the week when the rule is applicable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#time CapsmanAccessList#time}
  */
  readonly time?: string;
  /**
  * VLAN ID to use if vlan-mode enables use of VLAN tagging.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#vlan_id CapsmanAccessList#vlan_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#vlan_mode CapsmanAccessList#vlan_mode}
  */
  readonly vlanMode?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list routeros_capsman_access_list}
*/
export class CapsmanAccessList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CapsmanAccessList that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/capsman_access_list routeros_capsman_access_list} Resource
  *
  * @param scope The scope in which to define this construct
