// https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath
...
export interface CapsmanDatapathConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#___path___ CapsmanDatapath#___path___}
  */
  readonly path?: string;
  /**
  * ARP mode. See [docs](https://wiki.mikrotik.com/wiki/Manual:IP/ARP#ARP_Modes) for info.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#arp CapsmanDatapath#arp}
  */
  readonly arp?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#bridge CapsmanDatapath#bridge}
  */
  readonly bridge?: string;
  /**
  * Bridge port cost to use when adding as bridge port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#bridge_cost CapsmanDatapath#bridge_cost}
  */
  readonly bridgeCost?: number;
  /**
  * Bridge horizon to use when adding as bridge port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#bridge_horizon CapsmanDatapath#bridge_horizon}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#client_to_client_forwarding CapsmanDatapath#client_to_client_forwarding}
  */
  readonly clientToClientForwarding?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#comment CapsmanDatapath#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#id CapsmanDatapath#id}
  *
  ...
  * Interface list name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#interface_list CapsmanDatapath#interface_list}
  */
  readonly interfaceList?: string;
  /**
  * Layer2 MTU size.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#l2mtu CapsmanDatapath#l2mtu}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#local_forwarding CapsmanDatapath#local_forwarding}
  */
  readonly localForwarding?: boolean | cdktf.IResolvable;
  /**
  * MTU size.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#mtu CapsmanDatapath#mtu}
  */
  readonly mtu?: number;
  /**
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#name CapsmanDatapath#name}
  */
  readonly name: string;
  /**
  * OpenFlow switch to add interface to, as port when enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#openflow_switch CapsmanDatapath#openflow_switch}
  */
  readonly openflowSwitch?: string;
  /**
  * VLAN ID to assign to interface if vlan-mode enables use of VLAN tagging.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#vlan_id CapsmanDatapath#vlan_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#vlan_mode CapsmanDatapath#vlan_mode}
  */
  readonly vlanMode?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath routeros_capsman_datapath}
*/
export class CapsmanDatapath extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CapsmanDatapath that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.91.0/docs/resources/capsman_datapath routeros_capsman_datapath} Resource
  *
  * @param scope The scope in which to define this construct
