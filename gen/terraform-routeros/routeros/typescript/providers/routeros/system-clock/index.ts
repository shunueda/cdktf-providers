// https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_clock
...
export interface SystemClockConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_clock#___path___ SystemClock#___path___}
  */
  readonly path?: string;
  /**
  * Date.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_clock#date SystemClock#date}
  */
  readonly date?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_clock#id SystemClock#id}
  *
  ...
  * Time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_clock#time SystemClock#time}
  */
  readonly time?: string;
  /**
  * Feature available from v6.27. If enabled, the time zone will be set automatically.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_clock#time_zone_autodetect SystemClock#time_zone_autodetect}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_clock#time_zone_name SystemClock#time_zone_name}
  */
  readonly timeZoneName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_clock routeros_system_clock}
*/
export class SystemClock extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemClock that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_clock#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/system_clock routeros_system_clock} Resource
  *
  * @param scope The scope in which to define this construct
