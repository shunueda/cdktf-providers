// https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface
...
export interface ZerotierInterfaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface#___path___ ZerotierInterface#___path___}
  */
  readonly path?: string;
  /**
  * An option to override the default route.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface#allow_default ZerotierInterface#allow_default}
  */
  readonly allowDefault?: boolean | cdktf.IResolvable;
  /**
  * An option to allow overlapping public IP space by the ZeroTier routes. .
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface#allow_global ZerotierInterface#allow_global}
  */
  readonly allowGlobal?: boolean | cdktf.IResolvable;
  /**
  * An option to allow assignment of managed IPs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface#allow_managed ZerotierInterface#allow_managed}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface#arp_timeout ZerotierInterface#arp_timeout}
  */
  readonly arpTimeout?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface#comment ZerotierInterface#comment}
  */
  readonly comment?: string;
  /**
  * An option to force the `running` property to true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface#disable_running_check ZerotierInterface#disable_running_check}
  */
  readonly disableRunningCheck?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface#disabled ZerotierInterface#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface#id ZerotierInterface#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface#instance ZerotierInterface#instance}
  */
  readonly instance: string;
  /**
  * Name of the ZeroTier interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface#name ZerotierInterface#name}
  */
  readonly name: string;
  /**
  * The ZeroTier network identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface#network ZerotierInterface#network}
  */
  readonly network: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface routeros_zerotier_interface}
*/
export class ZerotierInterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ZerotierInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/zerotier_interface routeros_zerotier_interface} Resource
  *
  * @param scope The scope in which to define this construct
