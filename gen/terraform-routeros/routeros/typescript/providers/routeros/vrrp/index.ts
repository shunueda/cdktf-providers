// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp
...
export interface VrrpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#___path___ Vrrp#___path___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#arp Vrrp#arp}
  */
  readonly arp?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#arp_timeout Vrrp#arp_timeout}
  */
  readonly arpTimeout?: string;
  /**
  * Authentication method to use for VRRP advertisement packets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#authentication Vrrp#authentication}
  */
  readonly authentication?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#comment Vrrp#comment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#connection_tracking_mode Vrrp#connection_tracking_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#connection_tracking_port Vrrp#connection_tracking_port}
  */
  readonly connectionTrackingPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#disabled Vrrp#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#group_authority Vrrp#group_authority}
  */
  readonly groupAuthority?: string;
  /**
  * Allows combining multiple VRRP interfaces to maintain the same VRRP status within the group. `group_authority` was previously called `group_master`, `group_master` is kept for compatibility with scripts, but if both are set only `group_authority` will be taken into account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#group_master Vrrp#group_master}
  */
  readonly groupMaster?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#id Vrrp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#interface Vrrp#interface}
  */
  readonly interface: string;
  /**
  * VRRP update interval in seconds. Defines how often master sends advertisement packets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#interval Vrrp#interval}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#name Vrrp#name}
  */
  readonly name: string;
  /**
  * Script to execute when the node is switched to the backup state.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#on_backup Vrrp#on_backup}
  */
  readonly onBackup?: string;
  /**
  * Script to execute when the node fails.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#on_fail Vrrp#on_fail}
  */
  readonly onFail?: string;
  /**
  * Script to execute when the node is switched to master state.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#on_master Vrrp#on_master}
  */
  readonly onMaster?: string;
  /**
  * Password required for authentication. Can be ignored if authentication is not used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#password Vrrp#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#preemption_mode Vrrp#preemption_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#priority Vrrp#priority}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#remote_address Vrrp#remote_address}
  */
  readonly remoteAddress?: string;
  /**
  * Synchronize connection tracking entries from Master to Backup device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#sync_connection_tracking Vrrp#sync_connection_tracking}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#v3_protocol Vrrp#v3_protocol}
  */
  readonly v3Protocol?: string;
  /**
  * Which VRRP version to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#version Vrrp#version}
  */
  readonly version?: number;
  /**
  * Virtual Router identifier. Each Virtual router must have a unique id number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#vrid Vrrp#vrid}
  */
  readonly vrid?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp routeros_vrrp}
*/
export class Vrrp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Vrrp that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/vrrp routeros_vrrp} Resource
  *
  * @param scope The scope in which to define this construct
