// https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client
...
export interface IpDhcpClientConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#___path___ IpDhcpClient#___path___}
  */
  readonly path?: string;
  /**
  * Whether to install default route in routing table received from DHCP server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#add_default_route IpDhcpClient#add_default_route}
  */
  readonly addDefaultRoute?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#allow_reconfigure IpDhcpClient#allow_reconfigure}
  */
  readonly allowReconfigure?: boolean | cdktf.IResolvable;
  /**
  * Method on how to check gateway reachability.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#check_gateway IpDhcpClient#check_gateway}
  */
  readonly checkGateway?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#comment IpDhcpClient#comment}
  */
  readonly comment?: string;
  /**
  * Distance of default route. Applicable if add-default-route is set to yes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#default_route_distance IpDhcpClient#default_route_distance}
  */
  readonly defaultRouteDistance?: number;
  /**
  * Default route tables.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#default_route_tables IpDhcpClient#default_route_tables}
  */
  readonly defaultRouteTables?: string[];
  /**
  * Options that are sent to the DHCP server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#dhcp_options IpDhcpClient#dhcp_options}
  */
  readonly dhcpOptions?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#disabled IpDhcpClient#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#dscp IpDhcpClient#dscp}
  */
  readonly dscp?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#id IpDhcpClient#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#interface IpDhcpClient#interface}
  */
  readonly interface: string;
  /**
  * A script.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#script IpDhcpClient#script}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#use_broadcast IpDhcpClient#use_broadcast}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#use_peer_dns IpDhcpClient#use_peer_dns}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#use_peer_ntp IpDhcpClient#use_peer_ntp}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#use_reconfigure IpDhcpClient#use_reconfigure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#vlan_priority IpDhcpClient#vlan_priority}
  */
  readonly vlanPriority?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client routeros_ip_dhcp_client}
*/
export class IpDhcpClient extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpDhcpClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/ip_dhcp_client routeros_ip_dhcp_client} Resource
  *
  * @param scope The scope in which to define this construct
