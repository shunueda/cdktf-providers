// https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn
...
export interface InterfaceLteApnConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#___path___ InterfaceLteApn#___path___}
  */
  readonly path?: string;
  /**
  * Whether to add a default route to forward all traffic over the LTE interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#add_default_route InterfaceLteApn#add_default_route}
  */
  readonly addDefaultRoute?: boolean | cdktf.IResolvable;
  /**
  * Service Provider's Access Point Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#apn InterfaceLteApn#apn}
  */
  readonly apn?: string;
  /**
  * Allowed protocol to use for authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#authentication InterfaceLteApn#authentication}
  */
  readonly authentication?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#comment InterfaceLteApn#comment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#default_route_distance InterfaceLteApn#default_route_distance}
  */
  readonly defaultRouteDistance?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#id InterfaceLteApn#id}
  *
  ...
  * Requested PDN type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#ip_type InterfaceLteApn#ip_type}
  */
  readonly ipType?: string;
  /**
  * Interface on which to advertise IPv6 prefix.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#ipv6_interface InterfaceLteApn#ipv6_interface}
  */
  readonly ipv6Interface?: string;
  /**
  * APN profile name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#name InterfaceLteApn#name}
  */
  readonly name: string;
  /**
  * APN profile number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#number InterfaceLteApn#number}
  */
  readonly number?: number;
  /**
  * Interface to passthrough IP configuration (activates passthrough).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#passthrough_interface InterfaceLteApn#passthrough_interface}
  */
  readonly passthroughInterface?: string;
  /**
  * If set to auto, then will learn MAC from the first packet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#passthrough_mac InterfaceLteApn#passthrough_mac}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#passthrough_subnet_selection InterfaceLteApn#passthrough_subnet_selection}
  */
  readonly passthroughSubnetSelection?: string;
  /**
  * Password used if any of the authentication protocols are active.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#password InterfaceLteApn#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#use_network_apn InterfaceLteApn#use_network_apn}
  */
  readonly useNetworkApn?: boolean | cdktf.IResolvable;
  /**
  * If set to yes, uses DNS received from LTE interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#use_peer_dns InterfaceLteApn#use_peer_dns}
  */
  readonly usePeerDns?: boolean | cdktf.IResolvable;
  /**
  * Username used if any of the authentication protocols are active.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#user InterfaceLteApn#user}
  */
  readonly user?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn routeros_interface_lte_apn}
*/
export class InterfaceLteApn extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfaceLteApn that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/interface_lte_apn routeros_interface_lte_apn} Resource
  *
  * @param scope The scope in which to define this construct
