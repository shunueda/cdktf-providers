// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/disk_settings
...
export interface DiskSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/disk_settings#___path___ DiskSettings#___path___}
  */
  readonly path?: string;
  /**
  * Interface that will be used in dynamic instance for ip/media when new disk/partition item is added in '/disk'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/disk_settings#auto_media_interface DiskSettings#auto_media_interface}
  */
  readonly autoMediaInterface?: string;
  /**
  * Enables media dynamically when new disk/partition item is added in '/disk'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/disk_settings#auto_media_sharing DiskSettings#auto_media_sharing}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/disk_settings#auto_smb_sharing DiskSettings#auto_smb_sharing}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/disk_settings#auto_smb_user DiskSettings#auto_smb_user}
  */
  readonly autoSmbUser?: string;
  /**
  * Sets the default mount point template for each item added in `/disk`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/disk_settings#default_mount_point_template DiskSettings#default_mount_point_template}
  */
  readonly defaultMountPointTemplate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/disk_settings#id DiskSettings#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/disk_settings routeros_disk_settings}
*/
export class DiskSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DiskSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/disk_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/disk_settings routeros_disk_settings} Resource
  *
  * @param scope The scope in which to define this construct
