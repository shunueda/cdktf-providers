// https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server
...
export interface SystemNtpServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server#___path___ SystemNtpServer#___path___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server#auth_key SystemNtpServer#auth_key}
  */
  readonly authKey?: string;
  /**
  * Enable certain NTP server mode, for this mode to work you have to set up broadcast-addresses field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server#broadcast SystemNtpServer#broadcast}
  */
  readonly broadcast?: boolean | cdktf.IResolvable;
  /**
  * Set broadcast address to use for NTP server broadcast mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server#broadcast_addresses SystemNtpServer#broadcast_addresses}
  */
  readonly broadcastAddresses?: string;
  /**
  * Enable NTP server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server#enabled SystemNtpServer#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server#id SystemNtpServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server#local_clock_stratum SystemNtpServer#local_clock_stratum}
  */
  readonly localClockStratum?: number;
  /**
  * Enable certain NTP server mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server#manycast SystemNtpServer#manycast}
  */
  readonly manycast?: boolean | cdktf.IResolvable;
  /**
  * Enable certain NTP server mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server#multicast SystemNtpServer#multicast}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server#use_local_clock SystemNtpServer#use_local_clock}
  */
  readonly useLocalClock?: boolean | cdktf.IResolvable;
  /**
  * The VRF table this resource operates on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server#vrf SystemNtpServer#vrf}
  */
  readonly vrf?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server routeros_system_ntp_server}
*/
export class SystemNtpServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemNtpServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_ntp_server routeros_system_ntp_server} Resource
  *
  * @param scope The scope in which to define this construct
