// https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type
...
export interface QueueTypeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#___path___ QueueType#___path___}
  */
  readonly path?: string;
  /**
  * Maximum number of bytes that the BFIFO queue can hold. Applies if `kind` is `bfifo`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#bfifo_limit QueueType#bfifo_limit}
  */
  readonly bfifoLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#cake_ack_filter QueueType#cake_ack_filter}
  */
  readonly cakeAckFilter?: string;
  /**
  * Compensates for ATM cell framing, which is normally found on ADSL links.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#cake_atm QueueType#cake_atm}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#cake_autorate_ingress QueueType#cake_autorate_ingress}
  */
  readonly cakeAutorateIngress?: boolean | cdktf.IResolvable;
  /**
  * Sets the shaper bandwidth.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#cake_bandwidth QueueType#cake_bandwidth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#cake_diffserv QueueType#cake_diffserv}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#cake_flowmode QueueType#cake_flowmode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#cake_memlimit QueueType#cake_memlimit}
  */
  readonly cakeMemlimit?: number;
  /**
  * Rounds each packet (including overhead) up to a minimum length BYTES. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#cake_mpu QueueType#cake_mpu}
  */
  readonly cakeMpu?: number;
  /**
  * Instructs Cake to perform a NAT lookup before applying a flow-isolation rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#cake_nat QueueType#cake_nat}
  */
  readonly cakeNat?: boolean | cdktf.IResolvable;
  /**
  * Adds BYTES to the size of each packet. BYTES may be negative.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#cake_overhead QueueType#cake_overhead}
  */
  readonly cakeOverhead?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#cake_overhead_scheme QueueType#cake_overhead_scheme}
  */
  readonly cakeOverheadScheme?: string;
  /**
  * Manually specify an RTT. Default 100ms is suitable for most Internet traffic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#cake_rtt QueueType#cake_rtt}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#cake_rtt_scheme QueueType#cake_rtt_scheme}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#cake_wash QueueType#cake_wash}
  */
  readonly cakeWash?: boolean | cdktf.IResolvable;
  /**
  * Marks packets above a configured threshold with ECN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#codel_ce_threshold QueueType#codel_ce_threshold}
  */
  readonly codelCeThreshold?: number;
  /**
  * An option is used to mark packets instead of dropping them.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#codel_ecn QueueType#codel_ecn}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#codel_interval QueueType#codel_interval}
  */
  readonly codelInterval?: string;
  /**
  * Queue limit, when the limit is reached, incoming packets are dropped.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#codel_limit QueueType#codel_limit}
  */
  readonly codelLimit?: number;
  /**
  * Represents an acceptable minimum persistent queue delay.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#codel_target QueueType#codel_target}
  */
  readonly codelTarget?: string;
  /**
  * Marks packets above a configured threshold with ECN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#fq_codel_ce_threshold QueueType#fq_codel_ce_threshold}
  */
  readonly fqCodelCeThreshold?: number;
  /**
  * An option is used to mark packets instead of dropping them.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#fq_codel_ecn QueueType#fq_codel_ecn}
  */
  readonly fqCodelEcn?: boolean | cdktf.IResolvable;
  /**
  * A number of flows into which the incoming packets are classified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#fq_codel_flows QueueType#fq_codel_flows}
  */
  readonly fqCodelFlows?: number;
  /**
  * Interval should be set on the order of the worst-case RTT through the bottleneck giving endpoints sufficient time to react.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#fq_codel_interval QueueType#fq_codel_interval}
  */
  readonly fqCodelInterval?: string;
  /**
  * Queue limit, when the limit is reached, incoming packets are dropped.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#fq_codel_limit QueueType#fq_codel_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#fq_codel_memlimit QueueType#fq_codel_memlimit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#fq_codel_quantum QueueType#fq_codel_quantum}
  */
  readonly fqCodelQuantum?: number;
  /**
  * Represents an acceptable minimum persistent queue delay.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#fq_codel_target QueueType#fq_codel_target}
  */
  readonly fqCodelTarget?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#id QueueType#id}
  *
  ...
  * Queue kind.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#kind QueueType#kind}
  */
  readonly kind: string;
  /**
  * Multi-queue PFIFO limit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#mq_pfifo_limit QueueType#mq_pfifo_limit}
  */
  readonly mqPfifoLimit?: number;
  /**
  * Type name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#name QueueType#name}
  */
  readonly name: string;
  /**
  * Maximal upload/download data rate which can be reached while the burst for substream is allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#pcq_burst_rate QueueType#pcq_burst_rate}
  */
  readonly pcqBurstRate?: number;
  /**
  * This is value of burst on/off switch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#pcq_burst_threshold QueueType#pcq_burst_threshold}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#pcq_burst_time QueueType#pcq_burst_time}
  */
  readonly pcqBurstTime?: string;
  /**
  * Selection of sub-stream identifiers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#pcq_classifier QueueType#pcq_classifier}
  */
  readonly pcqClassifier?: string[];
  /**
  * Size of IPV6 network that will be used as dst-address sub-stream identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#pcq_dst_address6_mask QueueType#pcq_dst_address6_mask}
  */
  readonly pcqDstAddress6Mask?: number;
  /**
  * Size of IPv4 network that will be used as dst-address sub-stream identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#pcq_dst_address_mask QueueType#pcq_dst_address_mask}
  */
  readonly pcqDstAddressMask?: number;
  /**
  * Queue size of a single sub-stream (in kilobytes).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#pcq_limit QueueType#pcq_limit}
  */
  readonly pcqLimit?: number;
  /**
  * Maximal available data rate of each sub-steam.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#pcq_rate QueueType#pcq_rate}
  */
  readonly pcqRate?: number;
  /**
  * Size of IPV6 network that will be used as src-address sub-stream identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#pcq_src_address6_mask QueueType#pcq_src_address6_mask}
  */
  readonly pcqSrcAddress6Mask?: number;
  /**
  * Size of IPv4 network that will be used as src-address sub-stream identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#pcq_src_address_mask QueueType#pcq_src_address_mask}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#pcq_total_limit QueueType#pcq_total_limit}
  */
  readonly pcqTotalLimit?: number;
  /**
  * Maximum number of packets that the PFIFO queue can hold. Applies if `kind` is `pfifo`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#pfifo_limit QueueType#pfifo_limit}
  */
  readonly pfifoLimit?: number;
  /**
  * Used by RED for average queue size calculations (for packet to byte translation).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#red_avg_packet QueueType#red_avg_packet}
  */
  readonly redAvgPacket?: number;
  /**
  * Number of packets allowed for bursts of packets when there are no packets in the queue.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#red_burst QueueType#red_burst}
  */
  readonly redBurst?: number;
  /**
  * RED queue limit in packets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#red_limit QueueType#red_limit}
  */
  readonly redLimit?: number;
  /**
  * The average queue size at which packet marking probability is the highest.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#red_max_threshold QueueType#red_max_threshold}
  */
  readonly redMaxThreshold?: number;
  /**
  * Average queue size in bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#red_min_threshold QueueType#red_min_threshold}
  */
  readonly redMinThreshold?: number;
  /**
  * Amount of data in bytes that can be sent in one round-robin round.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#sfq_allot QueueType#sfq_allot}
  */
  readonly sfqAllot?: number;
  /**
  * How often hash function must be refreshed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#sfq_perturb QueueType#sfq_perturb}
  */
  readonly sfqPerturb?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type routeros_queue_type}
*/
export class QueueType extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QueueType that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/queue_type routeros_queue_type} Resource
  *
  * @param scope The scope in which to define this construct
