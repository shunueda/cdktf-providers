// https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/move_items
...
export interface MoveItemsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/move_items#___path___ MoveItems#___path___}
  */
  readonly path?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/move_items#id MoveItems#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/move_items#resource_name MoveItems#resource_name}
  */
  readonly resourceName?: string;
  /**
  * URL path of the resource in the notation ```/ip/firewall/filter```.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/move_items#resource_path MoveItems#resource_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/move_items#sequence MoveItems#sequence}
  */
  readonly sequence: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/move_items routeros_move_items}
*/
export class MoveItems extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MoveItems that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/move_items#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.93.0/docs/resources/move_items routeros_move_items} Resource
  *
  * @param scope The scope in which to define this construct
