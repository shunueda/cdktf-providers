// https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa
...
export interface WifiAaaConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa#___path___ WifiAaa#___path___}
  */
  readonly path?: string;
  /**
  * Format of the `Called-Station-Id` RADIUS attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa#called_format WifiAaa#called_format}
  */
  readonly calledFormat?: string;
  /**
  * Format of the `Calling-Station-Id` RADIUS attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa#calling_format WifiAaa#calling_format}
  */
  readonly callingFormat?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa#comment WifiAaa#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa#disabled WifiAaa#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa#id WifiAaa#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa#interim_update WifiAaa#interim_update}
  */
  readonly interimUpdate?: string;
  /**
  * Time to cache RADIUS server replies when MAC address authentication is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa#mac_caching WifiAaa#mac_caching}
  */
  readonly macCaching?: string;
  /**
  * Name of the AAA profile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa#name WifiAaa#name}
  */
  readonly name: string;
  /**
  * Value of the `NAS-Identifier` RADIUS attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa#nas_identifier WifiAaa#nas_identifier}
  */
  readonly nasIdentifier?: string;
  /**
  * Format of the `User-Password` RADIUS attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa#password_format WifiAaa#password_format}
  */
  readonly passwordFormat?: string;
  /**
  * Format of the `User-Name` RADIUS attribute.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa#username_format WifiAaa#username_format}
  */
  readonly usernameFormat?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa routeros_wifi_aaa}
*/
export class WifiAaa extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WifiAaa that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_aaa routeros_wifi_aaa} Resource
  *
  * @param scope The scope in which to define this construct
