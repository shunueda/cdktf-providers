// https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/wifi_steering
...
export interface WifiSteeringConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/wifi_steering#___path___ WifiSteering#___path___}
  */
  readonly path?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/wifi_steering#comment WifiSteering#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/wifi_steering#disabled WifiSteering#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/wifi_steering#id WifiSteering#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/wifi_steering#name WifiSteering#name}
  */
  readonly name: string;
  /**
  * Neighbor group of potential roaming candidates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/wifi_steering#neighbor_group WifiSteering#neighbor_group}
  */
  readonly neighborGroup?: string[];
  /**
  * An option to enable sending 802.11k neighbor reports.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/wifi_steering#rrm WifiSteering#rrm}
  */
  readonly rrm?: boolean | cdktf.IResolvable;
  /**
  * An option to enable sending 802.11v BSS transition management requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/wifi_steering#wnm WifiSteering#wnm}
  */
  readonly wnm?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/wifi_steering routeros_wifi_steering}
*/
export class WifiSteering extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WifiSteering that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/wifi_steering#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/wifi_steering routeros_wifi_steering} Resource
  *
  * @param scope The scope in which to define this construct
