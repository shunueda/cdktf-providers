// https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client
...
export interface InterfacePppoeClientConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#___path___ InterfacePppoeClient#___path___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#ac_name InterfacePppoeClient#ac_name}
  */
  readonly acName?: string;
  /**
  * Enable/Disable whether to add default route automatically.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#add_default_route InterfacePppoeClient#add_default_route}
  */
  readonly addDefaultRoute?: boolean | cdktf.IResolvable;
  /**
  * Allowed authentication methods, by default all methods are allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#allow InterfacePppoeClient#allow}
  */
  readonly allow?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#comment InterfacePppoeClient#comment}
  */
  readonly comment?: string;
  /**
  * sets distance value applied to auto created default route, if add-default-route is also selected.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#default_route_distance InterfacePppoeClient#default_route_distance}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#dial_on_demand InterfacePppoeClient#dial_on_demand}
  */
  readonly dialOnDemand?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#disabled InterfacePppoeClient#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#host_uniq InterfacePppoeClient#host_uniq}
  */
  readonly hostUniq?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#id InterfacePppoeClient#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#interface InterfacePppoeClient#interface}
  */
  readonly interface: string;
  /**
  * Sets keepalive timeout in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#keepalive_timeout InterfacePppoeClient#keepalive_timeout}
  */
  readonly keepaliveTimeout?: number;
  /**
  * Maximum Receive Unit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#max_mru InterfacePppoeClient#max_mru}
  */
  readonly maxMru?: string;
  /**
  * Maximum Transmission Unit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#max_mtu InterfacePppoeClient#max_mtu}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#mrru InterfacePppoeClient#mrru}
  */
  readonly mrru?: string;
  /**
  * Name of the PPPoE interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#name InterfacePppoeClient#name}
  */
  readonly name: string;
  /**
  * Password used to authenticate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#password InterfacePppoeClient#password}
  */
  readonly password?: string;
  /**
  * Specifies which PPP profile configuration will be used when establishing the tunnel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#profile InterfacePppoeClient#profile}
  */
  readonly profile?: string;
  /**
  * Specifies the service name set on the access concentrator, can be left blank to connect to any PPPoE server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#service_name InterfacePppoeClient#service_name}
  */
  readonly serviceName?: string;
  /**
  * Enable/disable getting DNS settings from the peer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#use_peer_dns InterfacePppoeClient#use_peer_dns}
  */
  readonly usePeerDns?: boolean | cdktf.IResolvable;
  /**
  * Username used for authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#user InterfacePppoeClient#user}
  */
  readonly user?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client routeros_interface_pppoe_client}
*/
export class InterfacePppoeClient extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfacePppoeClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.96.0/docs/resources/interface_pppoe_client routeros_interface_pppoe_client} Resource
  *
  * @param scope The scope in which to define this construct
