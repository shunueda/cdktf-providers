// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret
...
export interface PppSecretConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#___path___ PppSecret#___path___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#caller_id PppSecret#caller_id}
  */
  readonly callerId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#comment PppSecret#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#disabled PppSecret#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#id PppSecret#id}
  *
  ...
  * IPv6 routes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#ipv6_routes PppSecret#ipv6_routes}
  */
  readonly ipv6Routes?: string[];
  /**
  * Maximal amount of bytes for a session that client can upload.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#limit_bytes_in PppSecret#limit_bytes_in}
  */
  readonly limitBytesIn?: number;
  /**
  * Maximal amount of bytes for a session that client can download.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#limit_bytes_out PppSecret#limit_bytes_out}
  */
  readonly limitBytesOut?: number;
  /**
  * IP address that will be set locally on ppp interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#local_address PppSecret#local_address}
  */
  readonly localAddress?: string;
  /**
  * Name used for authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#name PppSecret#name}
  */
  readonly name: string;
  /**
  * Password used for authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#password PppSecret#password}
  */
  readonly password?: string;
  /**
  * Which user profile to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#profile PppSecret#profile}
  */
  readonly profile?: string;
  /**
  * IP address that will be assigned to remote ppp interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#remote_address PppSecret#remote_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#remote_ipv6_prefix PppSecret#remote_ipv6_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#routes PppSecret#routes}
  */
  readonly routes?: string[];
  /**
  * Specifies the services that particular user will be able to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#service PppSecret#service}
  */
  readonly service?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret routeros_ppp_secret}
*/
export class PppSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PppSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/ppp_secret routeros_ppp_secret} Resource
  *
  * @param scope The scope in which to define this construct
