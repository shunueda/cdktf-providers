// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_capsman
...
export interface WifiCapsmanConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_capsman#___path___ WifiCapsman#___path___}
  */
  readonly path?: string;
  /**
  * Device CA certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_capsman#ca_certificate WifiCapsman#ca_certificate}
  */
  readonly caCertificate?: string;
  /**
  * Device certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_capsman#certificate WifiCapsman#certificate}
  */
  readonly certificate?: string;
  /**
  * Disable or enable CAPsMAN functionality.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_capsman#enabled WifiCapsman#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_capsman#id WifiCapsman#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_capsman#interfaces WifiCapsman#interfaces}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_capsman#package_path WifiCapsman#package_path}
  */
  readonly packagePath?: string;
  /**
  * Require all connecting CAPs to have a valid certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_capsman#require_peer_certificate WifiCapsman#require_peer_certificate}
  */
  readonly requirePeerCertificate?: boolean | cdktf.IResolvable;
  /**
  * Upgrade policy options.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_capsman#upgrade_policy WifiCapsman#upgrade_policy}
  */
  readonly upgradePolicy?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_capsman routeros_wifi_capsman}
*/
export class WifiCapsman extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WifiCapsman that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_capsman#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/resources/wifi_capsman routeros_wifi_capsman} Resource
  *
  * @param scope The scope in which to define this construct
