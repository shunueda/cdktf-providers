// https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_certificate_scep_server
...
export interface SystemCertificateScepServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_certificate_scep_server#ca_cert SystemCertificateScepServer#ca_cert}
  */
  readonly caCert: string;
  /**
  * The number of days to sign certificates for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_certificate_scep_server#days_valid SystemCertificateScepServer#days_valid}
  */
  readonly daysValid?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_certificate_scep_server#disabled SystemCertificateScepServer#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_certificate_scep_server#id SystemCertificateScepServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_certificate_scep_server#next_ca_cert SystemCertificateScepServer#next_ca_cert}
  */
  readonly nextCaCert?: string;
  /**
  * HTTP path starting with `/scep/`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_certificate_scep_server#path SystemCertificateScepServer#path}
  */
  readonly path: string;
  /**
  * Request lifetime (5m minimum).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_certificate_scep_server#request_lifetime SystemCertificateScepServer#request_lifetime}
  */
  readonly requestLifetime?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_certificate_scep_server routeros_system_certificate_scep_server}
*/
export class SystemCertificateScepServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemCertificateScepServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_certificate_scep_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/system_certificate_scep_server routeros_system_certificate_scep_server} Resource
  *
  * @param scope The scope in which to define this construct
