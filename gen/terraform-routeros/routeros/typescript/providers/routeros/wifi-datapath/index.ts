// https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath
...
export interface WifiDatapathConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath#___path___ WifiDatapath#___path___}
  */
  readonly path?: string;
  /**
  * Bridge interface to add the interface as a bridge port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath#bridge WifiDatapath#bridge}
  */
  readonly bridge?: string;
  /**
  * Spanning tree protocol cost of the bridge port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath#bridge_cost WifiDatapath#bridge_cost}
  */
  readonly bridgeCost?: string;
  /**
  * Bridge horizon to use when adding as a bridge port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath#bridge_horizon WifiDatapath#bridge_horizon}
  */
  readonly bridgeHorizon?: string;
  /**
  * An option to toggle communication between clients connected to the same AP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath#client_isolation WifiDatapath#client_isolation}
  */
  readonly clientIsolation?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath#comment WifiDatapath#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath#disabled WifiDatapath#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath#id WifiDatapath#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath#interface_list WifiDatapath#interface_list}
  */
  readonly interfaceList?: string;
  /**
  * Name of the datapath.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath#name WifiDatapath#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath#traffic_processing WifiDatapath#traffic_processing}
  */
  readonly trafficProcessing?: string;
  /**
  * Default VLAN ID to assign to client devices connecting to this interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath#vlan_id WifiDatapath#vlan_id}
  */
  readonly vlanId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath routeros_wifi_datapath}
*/
export class WifiDatapath extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WifiDatapath that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.92.1/docs/resources/wifi_datapath routeros_wifi_datapath} Resource
  *
  * @param scope The scope in which to define this construct
