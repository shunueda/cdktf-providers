// https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/tool_graphing_resource
...
export interface ToolGraphingResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/tool_graphing_resource#___path___ ToolGraphingResource#___path___}
  */
  readonly path?: string;
  /**
  * IP address range from which is allowed to access graphing information.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/tool_graphing_resource#allow_address ToolGraphingResource#allow_address}
  */
  readonly allowAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/tool_graphing_resource#disabled ToolGraphingResource#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/tool_graphing_resource#id ToolGraphingResource#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/tool_graphing_resource#store_on_disk ToolGraphingResource#store_on_disk}
  */
  readonly storeOnDisk?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/tool_graphing_resource routeros_tool_graphing_resource}
*/
export class ToolGraphingResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ToolGraphingResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/tool_graphing_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/tool_graphing_resource routeros_tool_graphing_resource} Resource
  *
  * @param scope The scope in which to define this construct
