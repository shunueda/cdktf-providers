// https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap
...
export interface WifiCapConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap#___path___ WifiCap#___path___}
  */
  readonly path?: string;
  /**
  * List of Manager IP addresses that CAP will attempt to contact during discovery.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap#caps_man_addresses WifiCap#caps_man_addresses}
  */
  readonly capsManAddresses?: string[];
  /**
  * List of manager certificate common names that CAP will connect to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap#caps_man_certificate_common_names WifiCap#caps_man_certificate_common_names}
  */
  readonly capsManCertificateCommonNames?: string[];
  /**
  * An ordered list of CAPs Manager names that the CAP will connect to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap#caps_man_names WifiCap#caps_man_names}
  */
  readonly capsManNames?: string[];
  /**
  * Certificate to use for authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap#certificate WifiCap#certificate}
  */
  readonly certificate?: string;
  /**
  * List of interfaces over which CAP should attempt to discover CAPs Manager.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap#discovery_interfaces WifiCap#discovery_interfaces}
  */
  readonly discoveryInterfaces?: string[];
  /**
  * Disable or enable the CAP functionality.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap#enabled WifiCap#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap#id WifiCap#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap#lock_to_caps_man WifiCap#lock_to_caps_man}
  */
  readonly lockToCapsMan?: boolean | cdktf.IResolvable;
  /**
  * Name of the bridge interface the CAP will be added to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap#slaves_datapath WifiCap#slaves_datapath}
  */
  readonly slavesDatapath?: string;
  /**
  * An option that creates static virtual interfaces.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap#slaves_static WifiCap#slaves_static}
  */
  readonly slavesStatic?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap routeros_wifi_cap}
*/
export class WifiCap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WifiCap that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/wifi_cap routeros_wifi_cap} Resource
  *
  * @param scope The scope in which to define this construct
