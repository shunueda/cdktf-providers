// https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius
...
export interface RadiusConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#___path___ Radius#___path___}
  */
  readonly path?: string;
  /**
  * An option whether the configuration is for the backup RADIUS server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#accounting_backup Radius#accounting_backup}
  */
  readonly accountingBackup?: boolean | cdktf.IResolvable;
  /**
  * RADIUS server port used for accounting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#accounting_port Radius#accounting_port}
  */
  readonly accountingPort?: number;
  /**
  * IPv4 or IPv6 address of RADIUS server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#address Radius#address}
  */
  readonly address: string;
  /**
  * RADIUS server port used for authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#authentication_port Radius#authentication_port}
  */
  readonly authenticationPort?: number;
  /**
  * RADIUS calling station identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#called_id Radius#called_id}
  */
  readonly calledId?: string;
  /**
  * Certificate to use for communication with RADIUS Server with RadSec enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#certificate Radius#certificate}
  */
  readonly certificate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#comment Radius#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#disabled Radius#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Microsoft Windows domain of client passed to RADIUS servers that require domain validation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#domain Radius#domain}
  */
  readonly domain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#id Radius#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#protocol Radius#protocol}
  */
  readonly protocol?: string;
  /**
  * Timeout after which the request should be resent over RadSec protocol.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#radsec_timeout Radius#radsec_timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#realm Radius#realm}
  */
  readonly realm?: string;
  /**
  * An option whether to require `Message-Authenticator` in received Access-Accept/Challenge/Reject messages.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#require_message_auth Radius#require_message_auth}
  */
  readonly requireMessageAuth?: string;
  /**
  * The shared secret to access the RADIUS server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#secret Radius#secret}
  */
  readonly secret?: string;
  /**
  * A set of router services that will use the RADIUS server. Possible values: `hotspot`, `login`, `ppp`, `wireless`, `dhcp`, `ipsec`, `dot1x`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#service Radius#service}
  */
  readonly service?: string[];
  /**
  * Source IPv4/IPv6 address of the packets sent to the RADIUS server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#src_address Radius#src_address}
  */
  readonly srcAddress?: string;
  /**
  * A timeout, after which the request should be resent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#timeout Radius#timeout}
  */
  readonly timeout?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius routeros_radius}
*/
export class Radius extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Radius that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.90.0/docs/resources/radius routeros_radius} Resource
  *
  * @param scope The scope in which to define this construct
