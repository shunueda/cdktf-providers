// https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp
...
export interface InterfaceVrrpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#___path___ InterfaceVrrp#___path___}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#arp InterfaceVrrp#arp}
  */
  readonly arp?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#arp_timeout InterfaceVrrp#arp_timeout}
  */
  readonly arpTimeout?: string;
  /**
  * Authentication method to use for VRRP advertisement packets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#authentication InterfaceVrrp#authentication}
  */
  readonly authentication?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#comment InterfaceVrrp#comment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#connection_tracking_mode InterfaceVrrp#connection_tracking_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#connection_tracking_port InterfaceVrrp#connection_tracking_port}
  */
  readonly connectionTrackingPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#disabled InterfaceVrrp#disabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#group_authority InterfaceVrrp#group_authority}
  */
  readonly groupAuthority?: string;
  /**
  * Allows combining multiple VRRP interfaces to maintain the same VRRP status within the group. `group_authority` was previously called `group_master`, `group_master` is kept for compatibility with scripts, but if both are set only `group_authority` will be taken into account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#group_master InterfaceVrrp#group_master}
  */
  readonly groupMaster?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#id InterfaceVrrp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#interface InterfaceVrrp#interface}
  */
  readonly interface: string;
  /**
  * VRRP update interval in seconds. Defines how often master sends advertisement packets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#interval InterfaceVrrp#interval}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#name InterfaceVrrp#name}
  */
  readonly name: string;
  /**
  * Script to execute when the node is switched to the backup state.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#on_backup InterfaceVrrp#on_backup}
  */
  readonly onBackup?: string;
  /**
  * Script to execute when the node fails.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#on_fail InterfaceVrrp#on_fail}
  */
  readonly onFail?: string;
  /**
  * Script to execute when the node is switched to master state.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#on_master InterfaceVrrp#on_master}
  */
  readonly onMaster?: string;
  /**
  * Password required for authentication. Can be ignored if authentication is not used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#password InterfaceVrrp#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#preemption_mode InterfaceVrrp#preemption_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#priority InterfaceVrrp#priority}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#remote_address InterfaceVrrp#remote_address}
  */
  readonly remoteAddress?: string;
  /**
  * Synchronize connection tracking entries from Master to Backup device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#sync_connection_tracking InterfaceVrrp#sync_connection_tracking}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#v3_protocol InterfaceVrrp#v3_protocol}
  */
  readonly v3Protocol?: string;
  /**
  * Which VRRP version to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#version InterfaceVrrp#version}
  */
  readonly version?: number;
  /**
  * Virtual Router identifier. Each Virtual router must have a unique id number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#vrid InterfaceVrrp#vrid}
  */
  readonly vrid?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp routeros_interface_vrrp}
*/
export class InterfaceVrrp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfaceVrrp that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.97.0/docs/resources/interface_vrrp routeros_interface_vrrp} Resource
  *
  * @param scope The scope in which to define this construct
