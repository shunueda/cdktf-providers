// https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/data-sources/ip_arp
...
export interface DataRouterosIpArpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/data-sources/ip_arp#___path___ DataRouterosIpArp#___path___}
  */
  readonly path?: string;
  /**
  * Additional request filtering options.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/data-sources/ip_arp#filter DataRouterosIpArp#filter}
  */
  readonly filter?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/data-sources/ip_arp#id DataRouterosIpArp#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/data-sources/ip_arp routeros_ip_arp}
*/
export class DataRouterosIpArp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRouterosIpArp that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/data-sources/ip_arp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.98.0/docs/data-sources/ip_arp routeros_ip_arp} Data Source
  *
  * @param scope The scope in which to define this construct
