// https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community
...
export interface SnmpCommunityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community#___path___ SnmpCommunity#___path___}
  */
  readonly path?: string;
  /**
  * Set of IP (v4 or v6) addresses or CIDR networks from which connections to SNMP server are allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community#addresses SnmpCommunity#addresses}
  */
  readonly addresses?: string[];
  /**
  * Password used to authenticate the connection to the server (SNMPv3).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community#authentication_password SnmpCommunity#authentication_password}
  */
  readonly authenticationPassword?: string;
  /**
  * The protocol used for authentication (SNMPv3).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community#authentication_protocol SnmpCommunity#authentication_protocol}
  */
  readonly authenticationProtocol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community#comment SnmpCommunity#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community#disabled SnmpCommunity#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * The password used for encryption (SNMPv3).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community#encryption_password SnmpCommunity#encryption_password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community#encryption_protocol SnmpCommunity#encryption_protocol}
  */
  readonly encryptionProtocol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community#id SnmpCommunity#id}
  *
  ...
  * Community Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community#name SnmpCommunity#name}
  */
  readonly name?: string;
  /**
  * Whether read access is enabled for this community.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community#read_access SnmpCommunity#read_access}
  */
  readonly readAccess?: boolean | cdktf.IResolvable;
  /**
  * Security features.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community#security SnmpCommunity#security}
  */
  readonly security?: string;
  /**
  * Whether write access is enabled for this community.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community#write_access SnmpCommunity#write_access}
  */
  readonly writeAccess?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community routeros_snmp_community}
*/
export class SnmpCommunity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnmpCommunity that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/snmp_community routeros_snmp_community} Resource
  *
  * @param scope The scope in which to define this construct
