// https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server
...
export interface DhcpServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#___path___ DhcpServer#___path___}
  */
  readonly path?: string;
  /**
  * Whether to add dynamic ARP entry. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#add_arp DhcpServer#add_arp}
  */
  readonly addArp?: boolean | cdktf.IResolvable;
  /**
  * Address list to which address will be added if lease is bound.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#address_lists DhcpServer#address_lists}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#address_pool DhcpServer#address_pool}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#allow_dual_stack_queue DhcpServer#allow_dual_stack_queue}
  */
  readonly allowDualStackQueue?: boolean | cdktf.IResolvable;
  /**
  * Always send replies as broadcasts even if destination IP is known.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#always_broadcast DhcpServer#always_broadcast}
  */
  readonly alwaysBroadcast?: boolean | cdktf.IResolvable;
  /**
  * Option changes the way how a server responds to DHCP requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#authoritative DhcpServer#authoritative}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#bootp_lease_time DhcpServer#bootp_lease_time}
  */
  readonly bootpLeaseTime?: string;
  /**
  * Support for BOOTP clients.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#bootp_support DhcpServer#bootp_support}
  */
  readonly bootpSupport?: string;
  /**
  * Specifies whether to limit specific number of clients per single MAC address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#client_mac_limit DhcpServer#client_mac_limit}
  */
  readonly clientMacLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#comment DhcpServer#comment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#conflict_detection DhcpServer#conflict_detection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#delay_threshold DhcpServer#delay_threshold}
  */
  readonly delayThreshold?: string;
  /**
  * Use custom set of DHCP options defined in option sets menu.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#dhcp_option_set DhcpServer#dhcp_option_set}
  */
  readonly dhcpOptionSet?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#disabled DhcpServer#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Dynamic lease identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#dynamic_lease_identifiers DhcpServer#dynamic_lease_identifiers}
  */
  readonly dynamicLeaseIdentifiers?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#id DhcpServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#insert_queue_before DhcpServer#insert_queue_before}
  */
  readonly insertQueueBefore?: string;
  /**
  * Name of the interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#interface DhcpServer#interface}
  */
  readonly interface: string;
  /**
  * A script that will be executed after a lease is assigned or de-assigned.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#lease_script DhcpServer#lease_script}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#lease_time DhcpServer#lease_time}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#name DhcpServer#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#parent_queue DhcpServer#parent_queue}
  */
  readonly parentQueue?: string;
  /**
  * The IP address of the relay this DHCP server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#relay DhcpServer#relay}
  */
  readonly relay?: string;
  /**
  * The address which the DHCP client must send requests to in order to renew an IP address lease.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#src_address DhcpServer#src_address}
  */
  readonly srcAddress?: string;
  /**
  * Support broadband TR101
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#support_broadband_tr101 DhcpServer#support_broadband_tr101}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#use_framed_as_classless DhcpServer#use_framed_as_classless}
  */
  readonly useFramedAsClassless?: boolean | cdktf.IResolvable;
  /**
  * Whether to use RADIUS server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#use_radius DhcpServer#use_radius}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#use_reconfigure DhcpServer#use_reconfigure}
  */
  readonly useReconfigure?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server routeros_dhcp_server}
*/
export class DhcpServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DhcpServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.95.0/docs/resources/dhcp_server routeros_dhcp_server} Resource
  *
  * @param scope The scope in which to define this construct
