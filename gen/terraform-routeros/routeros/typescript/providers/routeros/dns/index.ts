// https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns
...
export interface DnsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#___path___ Dns#___path___}
  */
  readonly path?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#address_list_extra_time Dns#address_list_extra_time}
  */
  readonly addressListExtraTime?: string;
  /**
  * Specifies whether to allow network requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#allow_remote_requests Dns#allow_remote_requests}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#cache_max_ttl Dns#cache_max_ttl}
  */
  readonly cacheMaxTtl?: string;
  /**
  * Specifies the size of DNS cache in KiB (64..4294967295). *Default: 2048*
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#cache_size Dns#cache_size}
  */
  readonly cacheSize?: number;
  /**
  * Specifies how many DoH concurrent queries are allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#doh_max_concurrent_queries Dns#doh_max_concurrent_queries}
  */
  readonly dohMaxConcurrentQueries?: number;
  /**
  * Specifies how many concurrent connections to the DoH server are allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#doh_max_server_connections Dns#doh_max_server_connections}
  */
  readonly dohMaxServerConnections?: number;
  /**
  * Specifies how long to wait for query response from the DoH server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#doh_timeout Dns#doh_timeout}
  */
  readonly dohTimeout?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#id Dns#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#max_concurrent_queries Dns#max_concurrent_queries}
  */
  readonly maxConcurrentQueries?: number;
  /**
  * Specifies how much concurrent TCP sessions are allowed. *Default: 20*
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#max_concurrent_tcp_sessions Dns#max_concurrent_tcp_sessions}
  */
  readonly maxConcurrentTcpSessions?: number;
  /**
  * Maximum size of allowed UDP packet. *Default: 4096*
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#max_udp_packet_size Dns#max_udp_packet_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#mdns_repeat_ifaces Dns#mdns_repeat_ifaces}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#query_server_timeout Dns#query_server_timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#query_total_timeout Dns#query_total_timeout}
  */
  readonly queryTotalTimeout?: string;
  /**
  * List of DNS server IPv4/IPv6 addresses.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#servers Dns#servers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#use_doh_server Dns#use_doh_server}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#verify_doh_cert Dns#verify_doh_cert}
  */
  readonly verifyDohCert?: boolean | cdktf.IResolvable;
  /**
  * The VRF table this resource operates on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#vrf Dns#vrf}
  */
  readonly vrf?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns routeros_dns}
*/
export class Dns extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Dns that should be imported. Refer to the {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/terraform-routeros/routeros/1.94.0/docs/resources/dns routeros_dns} Resource
  *
  * @param scope The scope in which to define this construct
