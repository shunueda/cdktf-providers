// https://registry.terraform.io/providers/lukasaron/stripe/3.4.0/docs/resources/entitlements_feature
...
export interface EntitlementsFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lukasaron/stripe/3.4.0/docs/resources/entitlements_feature#lookup_key EntitlementsFeature#lookup_key}
  */
  readonly lookupKey: string;
  /**
  * Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lukasaron/stripe/3.4.0/docs/resources/entitlements_feature#metadata EntitlementsFeature#metadata}
  */
  readonly metadata?: { [key: string]: string };
  /**
  * The feature’s name, for your own purpose, not meant to be displayable to the customer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lukasaron/stripe/3.4.0/docs/resources/entitlements_feature#name EntitlementsFeature#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/lukasaron/stripe/3.4.0/docs/resources/entitlements_feature stripe_entitlements_feature}
*/
export class EntitlementsFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EntitlementsFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/lukasaron/stripe/3.4.0/docs/resources/entitlements_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lukasaron/stripe/3.4.0/docs/resources/entitlements_feature stripe_entitlements_feature} Resource
  *
  * @param scope The scope in which to define this construct
