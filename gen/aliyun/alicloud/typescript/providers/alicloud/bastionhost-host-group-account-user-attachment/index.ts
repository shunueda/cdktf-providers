// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_attachment
...
export interface BastionhostHostGroupAccountUserAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_attachment#host_account_names BastionhostHostGroupAccountUserAttachment#host_account_names}
  */
  readonly hostAccountNames: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_attachment#host_group_id BastionhostHostGroupAccountUserAttachment#host_group_id}
  */
  readonly hostGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_attachment#id BastionhostHostGroupAccountUserAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_attachment#instance_id BastionhostHostGroupAccountUserAttachment#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_attachment#user_id BastionhostHostGroupAccountUserAttachment#user_id}
  */
  readonly userId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_attachment alicloud_bastionhost_host_group_account_user_attachment}
*/
export class BastionhostHostGroupAccountUserAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BastionhostHostGroupAccountUserAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_attachment alicloud_bastionhost_host_group_account_user_attachment} Resource
  *
  * @param scope The scope in which to define this construct
