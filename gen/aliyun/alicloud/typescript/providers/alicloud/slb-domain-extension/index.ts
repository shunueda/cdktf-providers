// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_domain_extension
...
export interface SlbDomainExtensionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_domain_extension#delete_protection_validation SlbDomainExtension#delete_protection_validation}
  */
  readonly deleteProtectionValidation?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_domain_extension#domain SlbDomainExtension#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_domain_extension#frontend_port SlbDomainExtension#frontend_port}
  */
  readonly frontendPort: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_domain_extension#id SlbDomainExtension#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_domain_extension#load_balancer_id SlbDomainExtension#load_balancer_id}
  */
  readonly loadBalancerId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_domain_extension#server_certificate_id SlbDomainExtension#server_certificate_id}
  */
  readonly serverCertificateId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_domain_extension alicloud_slb_domain_extension}
*/
export class SlbDomainExtension extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SlbDomainExtension that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_domain_extension#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_domain_extension alicloud_slb_domain_extension} Resource
  *
  * @param scope The scope in which to define this construct
