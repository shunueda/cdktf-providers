// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/event_bridge_event_source
...
export interface EventBridgeEventSourceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/event_bridge_event_source#description EventBridgeEventSource#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/event_bridge_event_source#event_bus_name EventBridgeEventSource#event_bus_name}
  */
  readonly eventBusName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/event_bridge_event_source#event_source_name EventBridgeEventSource#event_source_name}
  */
  readonly eventSourceName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/event_bridge_event_source#external_source_config EventBridgeEventSource#external_source_config}
  */
  readonly externalSourceConfig?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/event_bridge_event_source#external_source_type EventBridgeEventSource#external_source_type}
  */
  readonly externalSourceType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/event_bridge_event_source#id EventBridgeEventSource#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/event_bridge_event_source#linked_external_source EventBridgeEventSource#linked_external_source}
  */
  readonly linkedExternalSource?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/event_bridge_event_source alicloud_event_bridge_event_source}
*/
export class EventBridgeEventSource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventBridgeEventSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/event_bridge_event_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/event_bridge_event_source alicloud_event_bridge_event_source} Resource
  *
  * @param scope The scope in which to define this construct
