// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_audit_policy
...
export interface MongodbAuditPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_audit_policy#audit_status MongodbAuditPolicy#audit_status}
  */
  readonly auditStatus: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_audit_policy#db_instance_id MongodbAuditPolicy#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_audit_policy#id MongodbAuditPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_audit_policy#storage_period MongodbAuditPolicy#storage_period}
  */
  readonly storagePeriod?: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_audit_policy#timeouts MongodbAuditPolicy#timeouts}
  */
  readonly timeouts?: MongodbAuditPolicyTimeouts;
}
export interface MongodbAuditPolicyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_audit_policy#create MongodbAuditPolicy#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_audit_policy#delete MongodbAuditPolicy#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_audit_policy#update MongodbAuditPolicy#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_audit_policy alicloud_mongodb_audit_policy}
*/
export class MongodbAuditPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MongodbAuditPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_audit_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_audit_policy alicloud_mongodb_audit_policy} Resource
  *
  * @param scope The scope in which to define this construct
