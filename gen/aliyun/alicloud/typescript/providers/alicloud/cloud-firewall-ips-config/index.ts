// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config
...
export interface CloudFirewallIpsConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config#basic_rules CloudFirewallIpsConfig#basic_rules}
  */
  readonly basicRules?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config#cti_rules CloudFirewallIpsConfig#cti_rules}
  */
  readonly ctiRules?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config#id CloudFirewallIpsConfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config#lang CloudFirewallIpsConfig#lang}
  */
  readonly lang?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config#max_sdl CloudFirewallIpsConfig#max_sdl}
  */
  readonly maxSdl?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config#patch_rules CloudFirewallIpsConfig#patch_rules}
  */
  readonly patchRules?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config#rule_class CloudFirewallIpsConfig#rule_class}
  */
  readonly ruleClass?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config#run_mode CloudFirewallIpsConfig#run_mode}
  */
  readonly runMode?: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config#timeouts CloudFirewallIpsConfig#timeouts}
  */
  readonly timeouts?: CloudFirewallIpsConfigTimeouts;
}
export interface CloudFirewallIpsConfigTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config#create CloudFirewallIpsConfig#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config#delete CloudFirewallIpsConfig#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config#update CloudFirewallIpsConfig#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config alicloud_cloud_firewall_ips_config}
*/
export class CloudFirewallIpsConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudFirewallIpsConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_firewall_ips_config alicloud_cloud_firewall_ips_config} Resource
  *
  * @param scope The scope in which to define this construct
