// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance
...
export interface RosStackInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance#id RosStackInstance#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance#operation_description RosStackInstance#operation_description}
  */
  readonly operationDescription?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance#operation_preferences RosStackInstance#operation_preferences}
  */
  readonly operationPreferences?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance#retain_stacks RosStackInstance#retain_stacks}
  */
  readonly retainStacks?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance#stack_group_name RosStackInstance#stack_group_name}
  */
  readonly stackGroupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance#stack_instance_account_id RosStackInstance#stack_instance_account_id}
  */
  readonly stackInstanceAccountId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance#stack_instance_region_id RosStackInstance#stack_instance_region_id}
  */
  readonly stackInstanceRegionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance#timeout_in_minutes RosStackInstance#timeout_in_minutes}
  */
  readonly timeoutInMinutes?: string;
  /**
  * parameter_overrides block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance#parameter_overrides RosStackInstance#parameter_overrides}
  */
  readonly parameterOverrides?: RosStackInstanceParameterOverrides[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance#timeouts RosStackInstance#timeouts}
  */
  readonly timeouts?: RosStackInstanceTimeouts;
}
export interface RosStackInstanceParameterOverrides {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance#parameter_key RosStackInstance#parameter_key}
  */
  readonly parameterKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance#parameter_value RosStackInstance#parameter_value}
  */
...
export interface RosStackInstanceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance#create RosStackInstance#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance alicloud_ros_stack_instance}
*/
export class RosStackInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RosStackInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ros_stack_instance alicloud_ros_stack_instance} Resource
  *
  * @param scope The scope in which to define this construct
