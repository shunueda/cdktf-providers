// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_vul_whitelist
...
export interface ThreatDetectionVulWhitelistConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_vul_whitelist#id ThreatDetectionVulWhitelist#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_vul_whitelist#reason ThreatDetectionVulWhitelist#reason}
  */
  readonly reason?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_vul_whitelist#target_info ThreatDetectionVulWhitelist#target_info}
  */
  readonly targetInfo?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_vul_whitelist#whitelist ThreatDetectionVulWhitelist#whitelist}
  */
  readonly whitelist: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_vul_whitelist#timeouts ThreatDetectionVulWhitelist#timeouts}
  */
  readonly timeouts?: ThreatDetectionVulWhitelistTimeouts;
}
export interface ThreatDetectionVulWhitelistTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_vul_whitelist#create ThreatDetectionVulWhitelist#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_vul_whitelist#delete ThreatDetectionVulWhitelist#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_vul_whitelist#update ThreatDetectionVulWhitelist#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_vul_whitelist alicloud_threat_detection_vul_whitelist}
*/
export class ThreatDetectionVulWhitelist extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ThreatDetectionVulWhitelist that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_vul_whitelist#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_vul_whitelist alicloud_threat_detection_vul_whitelist} Resource
  *
  * @param scope The scope in which to define this construct
