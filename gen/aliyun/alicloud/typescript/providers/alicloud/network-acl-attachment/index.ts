// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/network_acl_attachment
...
export interface NetworkAclAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/network_acl_attachment#id NetworkAclAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/network_acl_attachment#network_acl_id NetworkAclAttachment#network_acl_id}
  */
  readonly networkAclId: string;
  /**
  * resources block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/network_acl_attachment#resources NetworkAclAttachment#resources}
  */
  readonly resources: NetworkAclAttachmentResources[] | cdktf.IResolvable;
}
export interface NetworkAclAttachmentResources {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/network_acl_attachment#resource_id NetworkAclAttachment#resource_id}
  */
  readonly resourceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/network_acl_attachment#resource_type NetworkAclAttachment#resource_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/network_acl_attachment alicloud_network_acl_attachment}
*/
export class NetworkAclAttachment extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alicloud_network_acl_attachment";
  ...
  * @param importFromId The id of the existing NetworkAclAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/network_acl_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alicloud_network_acl_attachment", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/network_acl_attachment alicloud_network_acl_attachment} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: NetworkAclAttachmentConfig) {
    super(scope, id, {
      terraformResourceType: 'alicloud_network_acl_attachment',
