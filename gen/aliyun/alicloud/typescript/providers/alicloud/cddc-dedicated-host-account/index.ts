// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cddc_dedicated_host_account
...
export interface CddcDedicatedHostAccountConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cddc_dedicated_host_account#account_name CddcDedicatedHostAccount#account_name}
  */
  readonly accountName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cddc_dedicated_host_account#account_password CddcDedicatedHostAccount#account_password}
  */
  readonly accountPassword: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cddc_dedicated_host_account#account_type CddcDedicatedHostAccount#account_type}
  */
  readonly accountType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cddc_dedicated_host_account#dedicated_host_id CddcDedicatedHostAccount#dedicated_host_id}
  */
  readonly dedicatedHostId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cddc_dedicated_host_account#id CddcDedicatedHostAccount#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cddc_dedicated_host_account alicloud_cddc_dedicated_host_account}
*/
export class CddcDedicatedHostAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CddcDedicatedHostAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cddc_dedicated_host_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cddc_dedicated_host_account alicloud_cddc_dedicated_host_account} Resource
  *
  * @param scope The scope in which to define this construct
