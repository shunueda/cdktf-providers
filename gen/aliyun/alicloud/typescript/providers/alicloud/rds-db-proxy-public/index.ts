// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/rds_db_proxy_public
...
export interface RdsDbProxyPublicConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/rds_db_proxy_public#connection_string_prefix RdsDbProxyPublic#connection_string_prefix}
  */
  readonly connectionStringPrefix: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/rds_db_proxy_public#db_instance_id RdsDbProxyPublic#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/rds_db_proxy_public#db_proxy_connection_string_net_type RdsDbProxyPublic#db_proxy_connection_string_net_type}
  */
  readonly dbProxyConnectionStringNetType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/rds_db_proxy_public#db_proxy_endpoint_id RdsDbProxyPublic#db_proxy_endpoint_id}
  */
  readonly dbProxyEndpointId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/rds_db_proxy_public#db_proxy_new_connect_string_port RdsDbProxyPublic#db_proxy_new_connect_string_port}
  */
  readonly dbProxyNewConnectStringPort?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/rds_db_proxy_public#id RdsDbProxyPublic#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/rds_db_proxy_public#timeouts RdsDbProxyPublic#timeouts}
  */
  readonly timeouts?: RdsDbProxyPublicTimeouts;
}
export interface RdsDbProxyPublicTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/rds_db_proxy_public#create RdsDbProxyPublic#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/rds_db_proxy_public#delete RdsDbProxyPublic#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/rds_db_proxy_public#update RdsDbProxyPublic#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/rds_db_proxy_public alicloud_rds_db_proxy_public}
*/
export class RdsDbProxyPublic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RdsDbProxyPublic that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/rds_db_proxy_public#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/rds_db_proxy_public alicloud_rds_db_proxy_public} Resource
  *
  * @param scope The scope in which to define this construct
