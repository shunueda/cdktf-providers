// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_session_manager_status
...
export interface EcsSessionManagerStatusConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_session_manager_status#id EcsSessionManagerStatus#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_session_manager_status#session_manager_status_name EcsSessionManagerStatus#session_manager_status_name}
  */
  readonly sessionManagerStatusName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_session_manager_status#status EcsSessionManagerStatus#status}
  */
  readonly status: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_session_manager_status alicloud_ecs_session_manager_status}
*/
export class EcsSessionManagerStatus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsSessionManagerStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_session_manager_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_session_manager_status alicloud_ecs_session_manager_status} Resource
  *
  * @param scope The scope in which to define this construct
