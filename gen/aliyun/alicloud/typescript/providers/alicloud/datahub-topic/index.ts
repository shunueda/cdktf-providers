// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/datahub_topic
...
export interface DatahubTopicConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/datahub_topic#comment DatahubTopic#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/datahub_topic#id DatahubTopic#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/datahub_topic#life_cycle DatahubTopic#life_cycle}
  */
  readonly lifeCycle?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/datahub_topic#name DatahubTopic#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/datahub_topic#project_name DatahubTopic#project_name}
  */
  readonly projectName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/datahub_topic#record_schema DatahubTopic#record_schema}
  */
  readonly recordSchema?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/datahub_topic#record_type DatahubTopic#record_type}
  */
  readonly recordType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/datahub_topic#shard_count DatahubTopic#shard_count}
  */
  readonly shardCount?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/datahub_topic alicloud_datahub_topic}
*/
export class DatahubTopic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatahubTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/datahub_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/datahub_topic alicloud_datahub_topic} Resource
  *
  * @param scope The scope in which to define this construct
