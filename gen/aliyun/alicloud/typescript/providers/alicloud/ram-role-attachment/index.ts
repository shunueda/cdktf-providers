// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ram_role_attachment
...
export interface RamRoleAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ram_role_attachment#id RamRoleAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ram_role_attachment#instance_ids RamRoleAttachment#instance_ids}
  */
  readonly instanceIds: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ram_role_attachment#role_name RamRoleAttachment#role_name}
  */
  readonly roleName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ram_role_attachment alicloud_ram_role_attachment}
*/
export class RamRoleAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RamRoleAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ram_role_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ram_role_attachment alicloud_ram_role_attachment} Resource
  *
  * @param scope The scope in which to define this construct
