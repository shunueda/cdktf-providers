// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cddc_dedicated_host_group
...
export interface CddcDedicatedHostGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cddc_dedicated_host_group#allocation_policy CddcDedicatedHostGroup#allocation_policy}
  */
  readonly allocationPolicy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cddc_dedicated_host_group#cpu_allocation_ratio CddcDedicatedHostGroup#cpu_allocation_ratio}
  */
  readonly cpuAllocationRatio?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cddc_dedicated_host_group#dedicated_host_group_desc CddcDedicatedHostGroup#dedicated_host_group_desc}
  */
  readonly dedicatedHostGroupDesc?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cddc_dedicated_host_group#disk_allocation_ratio CddcDedicatedHostGroup#disk_allocation_ratio}
  */
  readonly diskAllocationRatio?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cddc_dedicated_host_group#engine CddcDedicatedHostGroup#engine}
  */
  readonly engine: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cddc_dedicated_host_group#host_replace_policy CddcDedicatedHostGroup#host_replace_policy}
  */
  readonly hostReplacePolicy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cddc_dedicated_host_group#id CddcDedicatedHostGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cddc_dedicated_host_group#mem_allocation_ratio CddcDedicatedHostGroup#mem_allocation_ratio}
  */
  readonly memAllocationRatio?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cddc_dedicated_host_group#open_permission CddcDedicatedHostGroup#open_permission}
  */
  readonly openPermission?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cddc_dedicated_host_group#vpc_id CddcDedicatedHostGroup#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cddc_dedicated_host_group alicloud_cddc_dedicated_host_group}
*/
export class CddcDedicatedHostGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CddcDedicatedHostGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cddc_dedicated_host_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cddc_dedicated_host_group alicloud_cddc_dedicated_host_group} Resource
  *
  * @param scope The scope in which to define this construct
