// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_ipam_ipam_pool_allocation
...
export interface VpcIpamIpamPoolAllocationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_ipam_ipam_pool_allocation#cidr VpcIpamIpamPoolAllocation#cidr}
  */
  readonly cidr?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_ipam_ipam_pool_allocation#cidr_mask VpcIpamIpamPoolAllocation#cidr_mask}
  */
  readonly cidrMask?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_ipam_ipam_pool_allocation#id VpcIpamIpamPoolAllocation#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_ipam_ipam_pool_allocation#ipam_pool_allocation_description VpcIpamIpamPoolAllocation#ipam_pool_allocation_description}
  */
  readonly ipamPoolAllocationDescription?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_ipam_ipam_pool_allocation#ipam_pool_allocation_name VpcIpamIpamPoolAllocation#ipam_pool_allocation_name}
  */
  readonly ipamPoolAllocationName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_ipam_ipam_pool_allocation#ipam_pool_id VpcIpamIpamPoolAllocation#ipam_pool_id}
  */
  readonly ipamPoolId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_ipam_ipam_pool_allocation#timeouts VpcIpamIpamPoolAllocation#timeouts}
  */
  readonly timeouts?: VpcIpamIpamPoolAllocationTimeouts;
}
export interface VpcIpamIpamPoolAllocationTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_ipam_ipam_pool_allocation#create VpcIpamIpamPoolAllocation#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_ipam_ipam_pool_allocation#delete VpcIpamIpamPoolAllocation#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_ipam_ipam_pool_allocation#update VpcIpamIpamPoolAllocation#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_ipam_ipam_pool_allocation alicloud_vpc_ipam_ipam_pool_allocation}
*/
export class VpcIpamIpamPoolAllocation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcIpamIpamPoolAllocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_ipam_ipam_pool_allocation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_ipam_ipam_pool_allocation alicloud_vpc_ipam_ipam_pool_allocation} Resource
  *
  * @param scope The scope in which to define this construct
