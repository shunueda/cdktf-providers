// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_traffic_qos
...
export interface ExpressConnectTrafficQosConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_traffic_qos#id ExpressConnectTrafficQos#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_traffic_qos#qos_description ExpressConnectTrafficQos#qos_description}
  */
  readonly qosDescription?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_traffic_qos#qos_name ExpressConnectTrafficQos#qos_name}
  */
  readonly qosName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_traffic_qos#resource_group_id ExpressConnectTrafficQos#resource_group_id}
  */
  readonly resourceGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_traffic_qos#tags ExpressConnectTrafficQos#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_traffic_qos#timeouts ExpressConnectTrafficQos#timeouts}
  */
  readonly timeouts?: ExpressConnectTrafficQosTimeouts;
}
export interface ExpressConnectTrafficQosTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_traffic_qos#create ExpressConnectTrafficQos#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_traffic_qos#delete ExpressConnectTrafficQos#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_traffic_qos#update ExpressConnectTrafficQos#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_traffic_qos alicloud_express_connect_traffic_qos}
*/
export class ExpressConnectTrafficQos extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExpressConnectTrafficQos that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_traffic_qos#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_traffic_qos alicloud_express_connect_traffic_qos} Resource
  *
  * @param scope The scope in which to define this construct
