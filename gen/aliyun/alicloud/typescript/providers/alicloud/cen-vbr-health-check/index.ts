// https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check
...
export interface CenVbrHealthCheckConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check#cen_id CenVbrHealthCheck#cen_id}
  */
  readonly cenId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check#health_check_interval CenVbrHealthCheck#health_check_interval}
  */
  readonly healthCheckInterval?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check#health_check_source_ip CenVbrHealthCheck#health_check_source_ip}
  */
  readonly healthCheckSourceIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check#health_check_target_ip CenVbrHealthCheck#health_check_target_ip}
  */
  readonly healthCheckTargetIp: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check#healthy_threshold CenVbrHealthCheck#healthy_threshold}
  */
  readonly healthyThreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check#id CenVbrHealthCheck#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check#vbr_instance_id CenVbrHealthCheck#vbr_instance_id}
  */
  readonly vbrInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check#vbr_instance_owner_id CenVbrHealthCheck#vbr_instance_owner_id}
  */
  readonly vbrInstanceOwnerId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check#vbr_instance_region_id CenVbrHealthCheck#vbr_instance_region_id}
  */
  readonly vbrInstanceRegionId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check#timeouts CenVbrHealthCheck#timeouts}
  */
  readonly timeouts?: CenVbrHealthCheckTimeouts;
}
export interface CenVbrHealthCheckTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check#create CenVbrHealthCheck#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check#delete CenVbrHealthCheck#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check#update CenVbrHealthCheck#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check alicloud_cen_vbr_health_check}
*/
export class CenVbrHealthCheck extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CenVbrHealthCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/cen_vbr_health_check alicloud_cen_vbr_health_check} Resource
  *
  * @param scope The scope in which to define this construct
