// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment
...
export interface CloudSsoAccessAssignmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment#access_configuration_id CloudSsoAccessAssignment#access_configuration_id}
  */
  readonly accessConfigurationId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment#deprovision_strategy CloudSsoAccessAssignment#deprovision_strategy}
  */
  readonly deprovisionStrategy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment#directory_id CloudSsoAccessAssignment#directory_id}
  */
  readonly directoryId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment#id CloudSsoAccessAssignment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment#principal_id CloudSsoAccessAssignment#principal_id}
  */
  readonly principalId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment#principal_type CloudSsoAccessAssignment#principal_type}
  */
  readonly principalType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment#target_id CloudSsoAccessAssignment#target_id}
  */
  readonly targetId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment#target_type CloudSsoAccessAssignment#target_type}
  */
  readonly targetType: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment#timeouts CloudSsoAccessAssignment#timeouts}
  */
  readonly timeouts?: CloudSsoAccessAssignmentTimeouts;
}
export interface CloudSsoAccessAssignmentTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment#create CloudSsoAccessAssignment#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment#delete CloudSsoAccessAssignment#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment alicloud_cloud_sso_access_assignment}
*/
export class CloudSsoAccessAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudSsoAccessAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_sso_access_assignment alicloud_cloud_sso_access_assignment} Resource
  *
  * @param scope The scope in which to define this construct
