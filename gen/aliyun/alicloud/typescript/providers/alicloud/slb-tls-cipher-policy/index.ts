// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/slb_tls_cipher_policy
...
export interface SlbTlsCipherPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/slb_tls_cipher_policy#ciphers SlbTlsCipherPolicy#ciphers}
  */
  readonly ciphers: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/slb_tls_cipher_policy#id SlbTlsCipherPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/slb_tls_cipher_policy#tls_cipher_policy_name SlbTlsCipherPolicy#tls_cipher_policy_name}
  */
  readonly tlsCipherPolicyName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/slb_tls_cipher_policy#tls_versions SlbTlsCipherPolicy#tls_versions}
  */
  readonly tlsVersions: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/slb_tls_cipher_policy alicloud_slb_tls_cipher_policy}
*/
export class SlbTlsCipherPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SlbTlsCipherPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/slb_tls_cipher_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/slb_tls_cipher_policy alicloud_slb_tls_cipher_policy} Resource
  *
  * @param scope The scope in which to define this construct
