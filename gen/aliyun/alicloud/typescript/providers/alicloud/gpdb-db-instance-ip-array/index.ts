// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_db_instance_ip_array
...
export interface GpdbDbInstanceIpArrayConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_db_instance_ip_array#db_instance_id GpdbDbInstanceIpArray#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_db_instance_ip_array#db_instance_ip_array_attribute GpdbDbInstanceIpArray#db_instance_ip_array_attribute}
  */
  readonly dbInstanceIpArrayAttribute?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_db_instance_ip_array#db_instance_ip_array_name GpdbDbInstanceIpArray#db_instance_ip_array_name}
  */
  readonly dbInstanceIpArrayName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_db_instance_ip_array#id GpdbDbInstanceIpArray#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_db_instance_ip_array#modify_mode GpdbDbInstanceIpArray#modify_mode}
  */
  readonly modifyMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_db_instance_ip_array#security_ip_list GpdbDbInstanceIpArray#security_ip_list}
  */
  readonly securityIpList: string[];
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_db_instance_ip_array#timeouts GpdbDbInstanceIpArray#timeouts}
  */
  readonly timeouts?: GpdbDbInstanceIpArrayTimeouts;
}
export interface GpdbDbInstanceIpArrayTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_db_instance_ip_array#create GpdbDbInstanceIpArray#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_db_instance_ip_array#delete GpdbDbInstanceIpArray#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_db_instance_ip_array#update GpdbDbInstanceIpArray#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_db_instance_ip_array alicloud_gpdb_db_instance_ip_array}
*/
export class GpdbDbInstanceIpArray extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GpdbDbInstanceIpArray that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_db_instance_ip_array#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_db_instance_ip_array alicloud_gpdb_db_instance_ip_array} Resource
  *
  * @param scope The scope in which to define this construct
