// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/cdn_ip_info
...
export interface DataAlicloudCdnIpInfoConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/cdn_ip_info#id DataAlicloudCdnIpInfo#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/cdn_ip_info#ip DataAlicloudCdnIpInfo#ip}
  */
  readonly ip: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/cdn_ip_info alicloud_cdn_ip_info}
*/
export class DataAlicloudCdnIpInfo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAlicloudCdnIpInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/cdn_ip_info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/cdn_ip_info alicloud_cdn_ip_info} Data Source
  *
  * @param scope The scope in which to define this construct
