// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dcdn_waf_policy_domain_attachment
...
export interface DcdnWafPolicyDomainAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dcdn_waf_policy_domain_attachment#domain_name DcdnWafPolicyDomainAttachment#domain_name}
  */
  readonly domainName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dcdn_waf_policy_domain_attachment#id DcdnWafPolicyDomainAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dcdn_waf_policy_domain_attachment#policy_id DcdnWafPolicyDomainAttachment#policy_id}
  */
  readonly policyId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dcdn_waf_policy_domain_attachment#timeouts DcdnWafPolicyDomainAttachment#timeouts}
  */
  readonly timeouts?: DcdnWafPolicyDomainAttachmentTimeouts;
}
export interface DcdnWafPolicyDomainAttachmentTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dcdn_waf_policy_domain_attachment#create DcdnWafPolicyDomainAttachment#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dcdn_waf_policy_domain_attachment#delete DcdnWafPolicyDomainAttachment#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dcdn_waf_policy_domain_attachment alicloud_dcdn_waf_policy_domain_attachment}
*/
export class DcdnWafPolicyDomainAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DcdnWafPolicyDomainAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dcdn_waf_policy_domain_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dcdn_waf_policy_domain_attachment alicloud_dcdn_waf_policy_domain_attachment} Resource
  *
  * @param scope The scope in which to define this construct
