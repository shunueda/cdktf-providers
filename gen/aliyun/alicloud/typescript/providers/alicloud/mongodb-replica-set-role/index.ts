// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_replica_set_role
...
export interface MongodbReplicaSetRoleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_replica_set_role#connection_port MongodbReplicaSetRole#connection_port}
  */
  readonly connectionPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_replica_set_role#connection_prefix MongodbReplicaSetRole#connection_prefix}
  */
  readonly connectionPrefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_replica_set_role#db_instance_id MongodbReplicaSetRole#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_replica_set_role#id MongodbReplicaSetRole#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_replica_set_role#network_type MongodbReplicaSetRole#network_type}
  */
  readonly networkType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_replica_set_role#role_id MongodbReplicaSetRole#role_id}
  */
  readonly roleId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_replica_set_role alicloud_mongodb_replica_set_role}
*/
export class MongodbReplicaSetRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MongodbReplicaSetRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_replica_set_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/mongodb_replica_set_role alicloud_mongodb_replica_set_role} Resource
  *
  * @param scope The scope in which to define this construct
