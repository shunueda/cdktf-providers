// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_bgp_peer
...
export interface VpcBgpPeerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_bgp_peer#bfd_multi_hop VpcBgpPeer#bfd_multi_hop}
  */
  readonly bfdMultiHop?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_bgp_peer#bgp_group_id VpcBgpPeer#bgp_group_id}
  */
  readonly bgpGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_bgp_peer#enable_bfd VpcBgpPeer#enable_bfd}
  */
  readonly enableBfd?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_bgp_peer#id VpcBgpPeer#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_bgp_peer#ip_version VpcBgpPeer#ip_version}
  */
  readonly ipVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_bgp_peer#peer_ip_address VpcBgpPeer#peer_ip_address}
  */
  readonly peerIpAddress?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_bgp_peer#timeouts VpcBgpPeer#timeouts}
  */
  readonly timeouts?: VpcBgpPeerTimeouts;
}
export interface VpcBgpPeerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_bgp_peer#create VpcBgpPeer#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_bgp_peer#delete VpcBgpPeer#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_bgp_peer#update VpcBgpPeer#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_bgp_peer alicloud_vpc_bgp_peer}
*/
export class VpcBgpPeer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcBgpPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_bgp_peer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_bgp_peer alicloud_vpc_bgp_peer} Resource
  *
  * @param scope The scope in which to define this construct
