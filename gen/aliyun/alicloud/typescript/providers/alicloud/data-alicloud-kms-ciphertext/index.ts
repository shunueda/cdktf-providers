// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/kms_ciphertext
...
export interface DataAlicloudKmsCiphertextConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/kms_ciphertext#encryption_context DataAlicloudKmsCiphertext#encryption_context}
  */
  readonly encryptionContext?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/kms_ciphertext#id DataAlicloudKmsCiphertext#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/kms_ciphertext#key_id DataAlicloudKmsCiphertext#key_id}
  */
  readonly keyId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/kms_ciphertext#plaintext DataAlicloudKmsCiphertext#plaintext}
  */
  readonly plaintext: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/kms_ciphertext alicloud_kms_ciphertext}
*/
export class DataAlicloudKmsCiphertext extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAlicloudKmsCiphertext that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/kms_ciphertext#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/kms_ciphertext alicloud_kms_ciphertext} Data Source
  *
  * @param scope The scope in which to define this construct
