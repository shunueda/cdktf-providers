// https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/vpc_public_ip_address_pool_cidr_block
...
export interface VpcPublicIpAddressPoolCidrBlockConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/vpc_public_ip_address_pool_cidr_block#cidr_block VpcPublicIpAddressPoolCidrBlock#cidr_block}
  */
  readonly cidrBlock?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/vpc_public_ip_address_pool_cidr_block#cidr_mask VpcPublicIpAddressPoolCidrBlock#cidr_mask}
  */
  readonly cidrMask?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/vpc_public_ip_address_pool_cidr_block#id VpcPublicIpAddressPoolCidrBlock#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/vpc_public_ip_address_pool_cidr_block#public_ip_address_pool_id VpcPublicIpAddressPoolCidrBlock#public_ip_address_pool_id}
  */
  readonly publicIpAddressPoolId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/vpc_public_ip_address_pool_cidr_block#timeouts VpcPublicIpAddressPoolCidrBlock#timeouts}
  */
  readonly timeouts?: VpcPublicIpAddressPoolCidrBlockTimeouts;
}
export interface VpcPublicIpAddressPoolCidrBlockTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/vpc_public_ip_address_pool_cidr_block#create VpcPublicIpAddressPoolCidrBlock#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/vpc_public_ip_address_pool_cidr_block#delete VpcPublicIpAddressPoolCidrBlock#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/vpc_public_ip_address_pool_cidr_block#update VpcPublicIpAddressPoolCidrBlock#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/vpc_public_ip_address_pool_cidr_block alicloud_vpc_public_ip_address_pool_cidr_block}
*/
export class VpcPublicIpAddressPoolCidrBlock extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcPublicIpAddressPoolCidrBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/vpc_public_ip_address_pool_cidr_block#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/vpc_public_ip_address_pool_cidr_block alicloud_vpc_public_ip_address_pool_cidr_block} Resource
  *
  * @param scope The scope in which to define this construct
