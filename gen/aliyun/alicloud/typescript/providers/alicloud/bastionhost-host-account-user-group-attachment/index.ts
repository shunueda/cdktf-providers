// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_account_user_group_attachment
...
export interface BastionhostHostAccountUserGroupAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_account_user_group_attachment#host_account_ids BastionhostHostAccountUserGroupAttachment#host_account_ids}
  */
  readonly hostAccountIds: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_account_user_group_attachment#host_id BastionhostHostAccountUserGroupAttachment#host_id}
  */
  readonly hostId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_account_user_group_attachment#id BastionhostHostAccountUserGroupAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_account_user_group_attachment#instance_id BastionhostHostAccountUserGroupAttachment#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_account_user_group_attachment#user_group_id BastionhostHostAccountUserGroupAttachment#user_group_id}
  */
  readonly userGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_account_user_group_attachment alicloud_bastionhost_host_account_user_group_attachment}
*/
export class BastionhostHostAccountUserGroupAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BastionhostHostAccountUserGroupAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_account_user_group_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_account_user_group_attachment alicloud_bastionhost_host_account_user_group_attachment} Resource
  *
  * @param scope The scope in which to define this construct
