// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/kms_plaintext
...
export interface DataAlicloudKmsPlaintextConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/kms_plaintext#ciphertext_blob DataAlicloudKmsPlaintext#ciphertext_blob}
  */
  readonly ciphertextBlob: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/kms_plaintext#encryption_context DataAlicloudKmsPlaintext#encryption_context}
  */
  readonly encryptionContext?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/kms_plaintext#id DataAlicloudKmsPlaintext#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/kms_plaintext alicloud_kms_plaintext}
*/
export class DataAlicloudKmsPlaintext extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAlicloudKmsPlaintext that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/kms_plaintext#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/kms_plaintext alicloud_kms_plaintext} Data Source
  *
  * @param scope The scope in which to define this construct
