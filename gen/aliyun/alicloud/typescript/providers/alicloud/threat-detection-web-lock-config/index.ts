// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_web_lock_config
...
export interface ThreatDetectionWebLockConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_web_lock_config#defence_mode ThreatDetectionWebLockConfig#defence_mode}
  */
  readonly defenceMode: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_web_lock_config#dir ThreatDetectionWebLockConfig#dir}
  */
  readonly dir: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_web_lock_config#exclusive_dir ThreatDetectionWebLockConfig#exclusive_dir}
  */
  readonly exclusiveDir?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_web_lock_config#exclusive_file ThreatDetectionWebLockConfig#exclusive_file}
  */
  readonly exclusiveFile?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_web_lock_config#exclusive_file_type ThreatDetectionWebLockConfig#exclusive_file_type}
  */
  readonly exclusiveFileType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_web_lock_config#id ThreatDetectionWebLockConfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_web_lock_config#inclusive_file_type ThreatDetectionWebLockConfig#inclusive_file_type}
  */
  readonly inclusiveFileType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_web_lock_config#local_backup_dir ThreatDetectionWebLockConfig#local_backup_dir}
  */
  readonly localBackupDir: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_web_lock_config#mode ThreatDetectionWebLockConfig#mode}
  */
  readonly mode: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_web_lock_config#uuid ThreatDetectionWebLockConfig#uuid}
  */
  readonly uuid: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_web_lock_config alicloud_threat_detection_web_lock_config}
*/
export class ThreatDetectionWebLockConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ThreatDetectionWebLockConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_web_lock_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_web_lock_config alicloud_threat_detection_web_lock_config} Resource
  *
  * @param scope The scope in which to define this construct
