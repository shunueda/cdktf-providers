// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_image_pipeline_execution
...
export interface EcsImagePipelineExecutionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_image_pipeline_execution#id EcsImagePipelineExecution#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_image_pipeline_execution#image_pipeline_id EcsImagePipelineExecution#image_pipeline_id}
  */
  readonly imagePipelineId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_image_pipeline_execution#status EcsImagePipelineExecution#status}
  */
  readonly status?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_image_pipeline_execution#timeouts EcsImagePipelineExecution#timeouts}
  */
  readonly timeouts?: EcsImagePipelineExecutionTimeouts;
}
export interface EcsImagePipelineExecutionTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_image_pipeline_execution#create EcsImagePipelineExecution#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_image_pipeline_execution#delete EcsImagePipelineExecution#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_image_pipeline_execution#update EcsImagePipelineExecution#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_image_pipeline_execution alicloud_ecs_image_pipeline_execution}
*/
export class EcsImagePipelineExecution extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsImagePipelineExecution that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_image_pipeline_execution#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ecs_image_pipeline_execution alicloud_ecs_image_pipeline_execution} Resource
  *
  * @param scope The scope in which to define this construct
