// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/ram_group_membership
...
export interface RamGroupMembershipConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/ram_group_membership#group_name RamGroupMembership#group_name}
  */
  readonly groupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/ram_group_membership#id RamGroupMembership#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/ram_group_membership#user_names RamGroupMembership#user_names}
  */
  readonly userNames: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/ram_group_membership alicloud_ram_group_membership}
*/
export class RamGroupMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RamGroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/ram_group_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/ram_group_membership alicloud_ram_group_membership} Resource
  *
  * @param scope The scope in which to define this construct
