// https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ssl_vpn_client_cert
...
export interface SslVpnClientCertConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ssl_vpn_client_cert#id SslVpnClientCert#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ssl_vpn_client_cert#name SslVpnClientCert#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ssl_vpn_client_cert#ssl_vpn_server_id SslVpnClientCert#ssl_vpn_server_id}
  */
  readonly sslVpnServerId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ssl_vpn_client_cert alicloud_ssl_vpn_client_cert}
*/
export class SslVpnClientCert extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslVpnClientCert that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ssl_vpn_client_cert#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ssl_vpn_client_cert alicloud_ssl_vpn_client_cert} Resource
  *
  * @param scope The scope in which to define this construct
