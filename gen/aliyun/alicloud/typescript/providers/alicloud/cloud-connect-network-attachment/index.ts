// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_connect_network_attachment
...
export interface CloudConnectNetworkAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_connect_network_attachment#ccn_id CloudConnectNetworkAttachment#ccn_id}
  */
  readonly ccnId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_connect_network_attachment#id CloudConnectNetworkAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_connect_network_attachment#sag_id CloudConnectNetworkAttachment#sag_id}
  */
  readonly sagId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_connect_network_attachment alicloud_cloud_connect_network_attachment}
*/
export class CloudConnectNetworkAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudConnectNetworkAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_connect_network_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_connect_network_attachment alicloud_cloud_connect_network_attachment} Resource
  *
  * @param scope The scope in which to define this construct
