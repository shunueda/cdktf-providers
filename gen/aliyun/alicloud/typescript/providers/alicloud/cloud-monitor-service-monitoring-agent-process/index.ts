// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_monitor_service_monitoring_agent_process
...
export interface CloudMonitorServiceMonitoringAgentProcessConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_monitor_service_monitoring_agent_process#id CloudMonitorServiceMonitoringAgentProcess#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_monitor_service_monitoring_agent_process#instance_id CloudMonitorServiceMonitoringAgentProcess#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_monitor_service_monitoring_agent_process#process_name CloudMonitorServiceMonitoringAgentProcess#process_name}
  */
  readonly processName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_monitor_service_monitoring_agent_process#process_user CloudMonitorServiceMonitoringAgentProcess#process_user}
  */
  readonly processUser?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_monitor_service_monitoring_agent_process#timeouts CloudMonitorServiceMonitoringAgentProcess#timeouts}
  */
...
export interface CloudMonitorServiceMonitoringAgentProcessTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_monitor_service_monitoring_agent_process#create CloudMonitorServiceMonitoringAgentProcess#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_monitor_service_monitoring_agent_process#delete CloudMonitorServiceMonitoringAgentProcess#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_monitor_service_monitoring_agent_process alicloud_cloud_monitor_service_monitoring_agent_process}
*/
export class CloudMonitorServiceMonitoringAgentProcess extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudMonitorServiceMonitoringAgentProcess that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_monitor_service_monitoring_agent_process#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_monitor_service_monitoring_agent_process alicloud_cloud_monitor_service_monitoring_agent_process} Resource
  *
  * @param scope The scope in which to define this construct
