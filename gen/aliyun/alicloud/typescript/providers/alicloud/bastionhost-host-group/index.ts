// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/bastionhost_host_group
...
export interface BastionhostHostGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/bastionhost_host_group#comment BastionhostHostGroup#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/bastionhost_host_group#host_group_name BastionhostHostGroup#host_group_name}
  */
  readonly hostGroupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/bastionhost_host_group#id BastionhostHostGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/bastionhost_host_group#instance_id BastionhostHostGroup#instance_id}
  */
  readonly instanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/bastionhost_host_group alicloud_bastionhost_host_group}
*/
export class BastionhostHostGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BastionhostHostGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/bastionhost_host_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/bastionhost_host_group alicloud_bastionhost_host_group} Resource
  *
  * @param scope The scope in which to define this construct
