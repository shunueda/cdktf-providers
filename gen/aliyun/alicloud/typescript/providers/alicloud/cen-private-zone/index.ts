// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_private_zone
...
export interface CenPrivateZoneConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_private_zone#access_region_id CenPrivateZone#access_region_id}
  */
  readonly accessRegionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_private_zone#cen_id CenPrivateZone#cen_id}
  */
  readonly cenId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_private_zone#host_region_id CenPrivateZone#host_region_id}
  */
  readonly hostRegionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_private_zone#host_vpc_id CenPrivateZone#host_vpc_id}
  */
  readonly hostVpcId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_private_zone#id CenPrivateZone#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_private_zone#timeouts CenPrivateZone#timeouts}
  */
  readonly timeouts?: CenPrivateZoneTimeouts;
}
export interface CenPrivateZoneTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_private_zone#create CenPrivateZone#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_private_zone#delete CenPrivateZone#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_private_zone alicloud_cen_private_zone}
*/
export class CenPrivateZone extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CenPrivateZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_private_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_private_zone alicloud_cen_private_zone} Resource
  *
  * @param scope The scope in which to define this construct
