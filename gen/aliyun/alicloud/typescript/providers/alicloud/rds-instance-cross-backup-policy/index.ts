// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/rds_instance_cross_backup_policy
...
export interface RdsInstanceCrossBackupPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/rds_instance_cross_backup_policy#cross_backup_region RdsInstanceCrossBackupPolicy#cross_backup_region}
  */
  readonly crossBackupRegion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/rds_instance_cross_backup_policy#id RdsInstanceCrossBackupPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/rds_instance_cross_backup_policy#instance_id RdsInstanceCrossBackupPolicy#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/rds_instance_cross_backup_policy#log_backup_enabled RdsInstanceCrossBackupPolicy#log_backup_enabled}
  */
  readonly logBackupEnabled?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/rds_instance_cross_backup_policy#retention RdsInstanceCrossBackupPolicy#retention}
  */
  readonly retention?: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/rds_instance_cross_backup_policy#timeouts RdsInstanceCrossBackupPolicy#timeouts}
  */
  readonly timeouts?: RdsInstanceCrossBackupPolicyTimeouts;
}
export interface RdsInstanceCrossBackupPolicyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/rds_instance_cross_backup_policy#create RdsInstanceCrossBackupPolicy#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/rds_instance_cross_backup_policy#delete RdsInstanceCrossBackupPolicy#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/rds_instance_cross_backup_policy#update RdsInstanceCrossBackupPolicy#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/rds_instance_cross_backup_policy alicloud_rds_instance_cross_backup_policy}
*/
export class RdsInstanceCrossBackupPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RdsInstanceCrossBackupPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/rds_instance_cross_backup_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/rds_instance_cross_backup_policy alicloud_rds_instance_cross_backup_policy} Resource
  *
  * @param scope The scope in which to define this construct
