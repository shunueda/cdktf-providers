// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point
...
export interface OssAccessPointConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point#access_point_name OssAccessPoint#access_point_name}
  */
  readonly accessPointName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point#bucket OssAccessPoint#bucket}
  */
  readonly bucket: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point#id OssAccessPoint#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point#network_origin OssAccessPoint#network_origin}
  */
  readonly networkOrigin: string;
  /**
  * public_access_block_configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point#public_access_block_configuration OssAccessPoint#public_access_block_configuration}
  */
  readonly publicAccessBlockConfiguration?: OssAccessPointPublicAccessBlockConfiguration;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point#timeouts OssAccessPoint#timeouts}
  */
  readonly timeouts?: OssAccessPointTimeouts;
  /**
  * vpc_configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point#vpc_configuration OssAccessPoint#vpc_configuration}
  */
  readonly vpcConfiguration?: OssAccessPointVpcConfiguration;
}
export interface OssAccessPointPublicAccessBlockConfiguration {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point#block_public_access OssAccessPoint#block_public_access}
  */
...
export interface OssAccessPointTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point#create OssAccessPoint#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point#delete OssAccessPoint#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point#update OssAccessPoint#update}
  */
...
export interface OssAccessPointVpcConfiguration {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point#vpc_id OssAccessPoint#vpc_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point alicloud_oss_access_point}
*/
export class OssAccessPoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OssAccessPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/oss_access_point alicloud_oss_access_point} Resource
  *
  * @param scope The scope in which to define this construct
