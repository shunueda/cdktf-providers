// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/brain_industrial_pid_project
...
export interface BrainIndustrialPidProjectConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/brain_industrial_pid_project#id BrainIndustrialPidProject#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/brain_industrial_pid_project#pid_organization_id BrainIndustrialPidProject#pid_organization_id}
  */
  readonly pidOrganizationId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/brain_industrial_pid_project#pid_project_desc BrainIndustrialPidProject#pid_project_desc}
  */
  readonly pidProjectDesc?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/brain_industrial_pid_project#pid_project_name BrainIndustrialPidProject#pid_project_name}
  */
  readonly pidProjectName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/brain_industrial_pid_project alicloud_brain_industrial_pid_project}
*/
export class BrainIndustrialPidProject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BrainIndustrialPidProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/brain_industrial_pid_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/brain_industrial_pid_project alicloud_brain_industrial_pid_project} Resource
  *
  * @param scope The scope in which to define this construct
