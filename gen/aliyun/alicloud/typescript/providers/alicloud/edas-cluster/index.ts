// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/edas_cluster
...
export interface EdasClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/edas_cluster#cluster_name EdasCluster#cluster_name}
  */
  readonly clusterName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/edas_cluster#cluster_type EdasCluster#cluster_type}
  */
  readonly clusterType: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/edas_cluster#id EdasCluster#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/edas_cluster#logical_region_id EdasCluster#logical_region_id}
  */
  readonly logicalRegionId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/edas_cluster#network_mode EdasCluster#network_mode}
  */
  readonly networkMode: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/edas_cluster#vpc_id EdasCluster#vpc_id}
  */
  readonly vpcId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/edas_cluster alicloud_edas_cluster}
*/
export class EdasCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EdasCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/edas_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/edas_cluster alicloud_edas_cluster} Resource
  *
  * @param scope The scope in which to define this construct
