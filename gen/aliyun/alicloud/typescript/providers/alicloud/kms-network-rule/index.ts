// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/kms_network_rule
...
export interface KmsNetworkRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/kms_network_rule#description KmsNetworkRule#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/kms_network_rule#id KmsNetworkRule#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/kms_network_rule#network_rule_name KmsNetworkRule#network_rule_name}
  */
  readonly networkRuleName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/kms_network_rule#source_private_ip KmsNetworkRule#source_private_ip}
  */
  readonly sourcePrivateIp: string[];
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/kms_network_rule#timeouts KmsNetworkRule#timeouts}
  */
  readonly timeouts?: KmsNetworkRuleTimeouts;
}
export interface KmsNetworkRuleTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/kms_network_rule#create KmsNetworkRule#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/kms_network_rule#delete KmsNetworkRule#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/kms_network_rule#update KmsNetworkRule#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/kms_network_rule alicloud_kms_network_rule}
*/
export class KmsNetworkRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsNetworkRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/kms_network_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/kms_network_rule alicloud_kms_network_rule} Resource
  *
  * @param scope The scope in which to define this construct
