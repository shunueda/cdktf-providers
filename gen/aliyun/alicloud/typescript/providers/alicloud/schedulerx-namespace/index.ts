// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/schedulerx_namespace
...
export interface SchedulerxNamespaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/schedulerx_namespace#description SchedulerxNamespace#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/schedulerx_namespace#id SchedulerxNamespace#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/schedulerx_namespace#namespace_name SchedulerxNamespace#namespace_name}
  */
  readonly namespaceName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/schedulerx_namespace#namespace_uid SchedulerxNamespace#namespace_uid}
  */
  readonly namespaceUid?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/schedulerx_namespace#timeouts SchedulerxNamespace#timeouts}
  */
  readonly timeouts?: SchedulerxNamespaceTimeouts;
}
export interface SchedulerxNamespaceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/schedulerx_namespace#create SchedulerxNamespace#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/schedulerx_namespace#delete SchedulerxNamespace#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/schedulerx_namespace alicloud_schedulerx_namespace}
*/
export class SchedulerxNamespace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchedulerxNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/schedulerx_namespace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/schedulerx_namespace alicloud_schedulerx_namespace} Resource
  *
  * @param scope The scope in which to define this construct
