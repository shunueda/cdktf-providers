// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses
...
export interface DataAlicloudEipAddressesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#address_name DataAlicloudEipAddresses#address_name}
  */
  readonly addressName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#associated_instance_id DataAlicloudEipAddresses#associated_instance_id}
  */
  readonly associatedInstanceId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#associated_instance_type DataAlicloudEipAddresses#associated_instance_type}
  */
  readonly associatedInstanceType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#dry_run DataAlicloudEipAddresses#dry_run}
  */
  readonly dryRun?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#enable_details DataAlicloudEipAddresses#enable_details}
  */
  readonly enableDetails?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#id DataAlicloudEipAddresses#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#ids DataAlicloudEipAddresses#ids}
  */
  readonly ids?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#in_use DataAlicloudEipAddresses#in_use}
  */
  readonly inUse?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#include_reservation_data DataAlicloudEipAddresses#include_reservation_data}
  */
  readonly includeReservationData?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#ip_address DataAlicloudEipAddresses#ip_address}
  */
  readonly ipAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#ip_addresses DataAlicloudEipAddresses#ip_addresses}
  */
  readonly ipAddresses?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#isp DataAlicloudEipAddresses#isp}
  */
  readonly isp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#lock_reason DataAlicloudEipAddresses#lock_reason}
  */
  readonly lockReason?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#name_regex DataAlicloudEipAddresses#name_regex}
  */
  readonly nameRegex?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#output_file DataAlicloudEipAddresses#output_file}
  */
  readonly outputFile?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#payment_type DataAlicloudEipAddresses#payment_type}
  */
  readonly paymentType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#resource_group_id DataAlicloudEipAddresses#resource_group_id}
  */
  readonly resourceGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#segment_instance_id DataAlicloudEipAddresses#segment_instance_id}
  */
  readonly segmentInstanceId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#status DataAlicloudEipAddresses#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#tags DataAlicloudEipAddresses#tags}
  */
  readonly tags?: { [key: string]: string };
}
export interface DataAlicloudEipAddressesAddresses {
}

export function dataAlicloudEipAddressesAddressesToTerraform(struct?: DataAlicloudEipAddressesAddresses): any {
...
export function dataAlicloudEipAddressesAddressesToHclTerraform(struct?: DataAlicloudEipAddressesAddresses): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAlicloudEipAddressesAddressesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAlicloudEipAddressesAddresses | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAlicloudEipAddressesAddresses | undefined) {
    if (value === undefined) {
...
export class DataAlicloudEipAddressesAddressesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAlicloudEipAddressesAddressesOutputReference {
    return new DataAlicloudEipAddressesAddressesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataAlicloudEipAddressesEips {
}

export function dataAlicloudEipAddressesEipsToTerraform(struct?: DataAlicloudEipAddressesEips): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataAlicloudEipAddressesEipsToHclTerraform(struct?: DataAlicloudEipAddressesEips): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAlicloudEipAddressesEipsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAlicloudEipAddressesEips | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAlicloudEipAddressesEips | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataAlicloudEipAddressesEipsList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataAlicloudEipAddressesEipsOutputReference {
    return new DataAlicloudEipAddressesEipsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses alicloud_eip_addresses}
*/
export class DataAlicloudEipAddresses extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alicloud_eip_addresses";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataAlicloudEipAddresses resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAlicloudEipAddresses to import
  * @param importFromId The id of the existing DataAlicloudEipAddresses that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAlicloudEipAddresses to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alicloud_eip_addresses", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/data-sources/eip_addresses alicloud_eip_addresses} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAlicloudEipAddressesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAlicloudEipAddressesConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'alicloud_eip_addresses',
  ...
  private _addresses = new DataAlicloudEipAddressesAddressesList(this, "addresses", false);
  ...
  private _eips = new DataAlicloudEipAddressesEipsList(this, "eips", false);
  public get eips() {
    return this._eips;
  }
