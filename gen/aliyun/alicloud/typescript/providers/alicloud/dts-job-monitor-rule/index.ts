// https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/dts_job_monitor_rule
...
export interface DtsJobMonitorRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/dts_job_monitor_rule#delay_rule_time DtsJobMonitorRule#delay_rule_time}
  */
  readonly delayRuleTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/dts_job_monitor_rule#dts_job_id DtsJobMonitorRule#dts_job_id}
  */
  readonly dtsJobId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/dts_job_monitor_rule#id DtsJobMonitorRule#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/dts_job_monitor_rule#phone DtsJobMonitorRule#phone}
  */
  readonly phone?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/dts_job_monitor_rule#state DtsJobMonitorRule#state}
  */
  readonly state?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/dts_job_monitor_rule#type DtsJobMonitorRule#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/dts_job_monitor_rule alicloud_dts_job_monitor_rule}
*/
export class DtsJobMonitorRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DtsJobMonitorRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/dts_job_monitor_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/dts_job_monitor_rule alicloud_dts_job_monitor_rule} Resource
  *
  * @param scope The scope in which to define this construct
