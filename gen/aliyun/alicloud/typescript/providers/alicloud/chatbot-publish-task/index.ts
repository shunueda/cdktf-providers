// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/chatbot_publish_task
...
export interface ChatbotPublishTaskConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/chatbot_publish_task#agent_key ChatbotPublishTask#agent_key}
  */
  readonly agentKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/chatbot_publish_task#biz_type ChatbotPublishTask#biz_type}
  */
  readonly bizType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/chatbot_publish_task#data_id_list ChatbotPublishTask#data_id_list}
  */
  readonly dataIdList?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/chatbot_publish_task#id ChatbotPublishTask#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/chatbot_publish_task#timeouts ChatbotPublishTask#timeouts}
  */
  readonly timeouts?: ChatbotPublishTaskTimeouts;
}
export interface ChatbotPublishTaskTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/chatbot_publish_task#create ChatbotPublishTask#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/chatbot_publish_task alicloud_chatbot_publish_task}
*/
export class ChatbotPublishTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChatbotPublishTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/chatbot_publish_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/chatbot_publish_task alicloud_chatbot_publish_task} Resource
  *
  * @param scope The scope in which to define this construct
