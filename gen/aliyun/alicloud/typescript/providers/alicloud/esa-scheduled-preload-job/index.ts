// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/esa_scheduled_preload_job
...
export interface EsaScheduledPreloadJobConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/esa_scheduled_preload_job#id EsaScheduledPreloadJob#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/esa_scheduled_preload_job#insert_way EsaScheduledPreloadJob#insert_way}
  */
  readonly insertWay: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/esa_scheduled_preload_job#oss_url EsaScheduledPreloadJob#oss_url}
  */
  readonly ossUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/esa_scheduled_preload_job#scheduled_preload_job_name EsaScheduledPreloadJob#scheduled_preload_job_name}
  */
  readonly scheduledPreloadJobName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/esa_scheduled_preload_job#site_id EsaScheduledPreloadJob#site_id}
  */
  readonly siteId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/esa_scheduled_preload_job#url_list EsaScheduledPreloadJob#url_list}
  */
  readonly urlList?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/esa_scheduled_preload_job#timeouts EsaScheduledPreloadJob#timeouts}
  */
  readonly timeouts?: EsaScheduledPreloadJobTimeouts;
}
export interface EsaScheduledPreloadJobTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/esa_scheduled_preload_job#create EsaScheduledPreloadJob#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/esa_scheduled_preload_job#delete EsaScheduledPreloadJob#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/esa_scheduled_preload_job#update EsaScheduledPreloadJob#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/esa_scheduled_preload_job alicloud_esa_scheduled_preload_job}
*/
export class EsaScheduledPreloadJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EsaScheduledPreloadJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/esa_scheduled_preload_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/esa_scheduled_preload_job alicloud_esa_scheduled_preload_job} Resource
  *
  * @param scope The scope in which to define this construct
