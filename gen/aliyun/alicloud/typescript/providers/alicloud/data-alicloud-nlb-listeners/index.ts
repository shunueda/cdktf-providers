// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/nlb_listeners
...
export interface DataAlicloudNlbListenersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/nlb_listeners#id DataAlicloudNlbListeners#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/nlb_listeners#ids DataAlicloudNlbListeners#ids}
  */
  readonly ids?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/nlb_listeners#listener_protocol DataAlicloudNlbListeners#listener_protocol}
  */
  readonly listenerProtocol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/nlb_listeners#load_balancer_ids DataAlicloudNlbListeners#load_balancer_ids}
  */
  readonly loadBalancerIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/nlb_listeners#output_file DataAlicloudNlbListeners#output_file}
  */
  readonly outputFile?: string;
}
export interface DataAlicloudNlbListenersListeners {
}

export function dataAlicloudNlbListenersListenersToTerraform(struct?: DataAlicloudNlbListenersListeners): any {
...
export function dataAlicloudNlbListenersListenersToHclTerraform(struct?: DataAlicloudNlbListenersListeners): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAlicloudNlbListenersListenersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAlicloudNlbListenersListeners | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAlicloudNlbListenersListeners | undefined) {
    if (value === undefined) {
  ...
  // alpn_enabled - computed: true, optional: false, required: false
  ...
  // ca_enabled - computed: true, optional: false, required: false
  ...
  // mss - computed: true, optional: false, required: false
  public get mss() {
  ...
  // sec_sensor_enabled - computed: true, optional: false, required: false
...
export class DataAlicloudNlbListenersListenersList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAlicloudNlbListenersListenersOutputReference {
    return new DataAlicloudNlbListenersListenersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/nlb_listeners alicloud_nlb_listeners}
*/
export class DataAlicloudNlbListeners extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alicloud_nlb_listeners";
  ...
  * @param importFromId The id of the existing DataAlicloudNlbListeners that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/nlb_listeners#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alicloud_nlb_listeners", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/nlb_listeners alicloud_nlb_listeners} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAlicloudNlbListenersConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAlicloudNlbListenersConfig = {}) {
    super(scope, id, {
  ...
  private _listeners = new DataAlicloudNlbListenersListenersList(this, "listeners", false);
