// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/hbr_hana_backup_client
...
export interface HbrHanaBackupClientConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/hbr_hana_backup_client#alert_setting HbrHanaBackupClient#alert_setting}
  */
  readonly alertSetting?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/hbr_hana_backup_client#client_info HbrHanaBackupClient#client_info}
  */
  readonly clientInfo?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/hbr_hana_backup_client#id HbrHanaBackupClient#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/hbr_hana_backup_client#use_https HbrHanaBackupClient#use_https}
  */
  readonly useHttps?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/hbr_hana_backup_client#vault_id HbrHanaBackupClient#vault_id}
  */
  readonly vaultId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/hbr_hana_backup_client#timeouts HbrHanaBackupClient#timeouts}
  */
  readonly timeouts?: HbrHanaBackupClientTimeouts;
}
export interface HbrHanaBackupClientTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/hbr_hana_backup_client#create HbrHanaBackupClient#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/hbr_hana_backup_client#delete HbrHanaBackupClient#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/hbr_hana_backup_client alicloud_hbr_hana_backup_client}
*/
export class HbrHanaBackupClient extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HbrHanaBackupClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/hbr_hana_backup_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/hbr_hana_backup_client alicloud_hbr_hana_backup_client} Resource
  *
  * @param scope The scope in which to define this construct
