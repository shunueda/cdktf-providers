// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/arms_remote_write
...
export interface ArmsRemoteWriteConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/arms_remote_write#cluster_id ArmsRemoteWrite#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/arms_remote_write#id ArmsRemoteWrite#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/arms_remote_write#remote_write_yaml ArmsRemoteWrite#remote_write_yaml}
  */
  readonly remoteWriteYaml: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/arms_remote_write#timeouts ArmsRemoteWrite#timeouts}
  */
  readonly timeouts?: ArmsRemoteWriteTimeouts;
}
export interface ArmsRemoteWriteTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/arms_remote_write#create ArmsRemoteWrite#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/arms_remote_write#delete ArmsRemoteWrite#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/arms_remote_write#update ArmsRemoteWrite#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/arms_remote_write alicloud_arms_remote_write}
*/
export class ArmsRemoteWrite extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ArmsRemoteWrite that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/arms_remote_write#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/arms_remote_write alicloud_arms_remote_write} Resource
  *
  * @param scope The scope in which to define this construct
