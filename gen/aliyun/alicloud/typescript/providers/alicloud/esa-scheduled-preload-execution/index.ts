// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/esa_scheduled_preload_execution
...
export interface EsaScheduledPreloadExecutionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/esa_scheduled_preload_execution#end_time EsaScheduledPreloadExecution#end_time}
  */
  readonly endTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/esa_scheduled_preload_execution#id EsaScheduledPreloadExecution#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/esa_scheduled_preload_execution#interval EsaScheduledPreloadExecution#interval}
  */
  readonly interval: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/esa_scheduled_preload_execution#scheduled_preload_job_id EsaScheduledPreloadExecution#scheduled_preload_job_id}
  */
  readonly scheduledPreloadJobId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/esa_scheduled_preload_execution#slice_len EsaScheduledPreloadExecution#slice_len}
  */
  readonly sliceLen: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/esa_scheduled_preload_execution#start_time EsaScheduledPreloadExecution#start_time}
  */
  readonly startTime?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/esa_scheduled_preload_execution#timeouts EsaScheduledPreloadExecution#timeouts}
  */
  readonly timeouts?: EsaScheduledPreloadExecutionTimeouts;
}
export interface EsaScheduledPreloadExecutionTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/esa_scheduled_preload_execution#create EsaScheduledPreloadExecution#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/esa_scheduled_preload_execution#delete EsaScheduledPreloadExecution#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/esa_scheduled_preload_execution#update EsaScheduledPreloadExecution#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/esa_scheduled_preload_execution alicloud_esa_scheduled_preload_execution}
*/
export class EsaScheduledPreloadExecution extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EsaScheduledPreloadExecution that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/esa_scheduled_preload_execution#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/esa_scheduled_preload_execution alicloud_esa_scheduled_preload_execution} Resource
  *
  * @param scope The scope in which to define this construct
