// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/db_read_write_splitting_connection
...
export interface DbReadWriteSplittingConnectionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/db_read_write_splitting_connection#connection_prefix DbReadWriteSplittingConnection#connection_prefix}
  */
  readonly connectionPrefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/db_read_write_splitting_connection#distribution_type DbReadWriteSplittingConnection#distribution_type}
  */
  readonly distributionType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/db_read_write_splitting_connection#id DbReadWriteSplittingConnection#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/db_read_write_splitting_connection#instance_id DbReadWriteSplittingConnection#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/db_read_write_splitting_connection#max_delay_time DbReadWriteSplittingConnection#max_delay_time}
  */
  readonly maxDelayTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/db_read_write_splitting_connection#port DbReadWriteSplittingConnection#port}
  */
  readonly port?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/db_read_write_splitting_connection#weight DbReadWriteSplittingConnection#weight}
  */
  readonly weight?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/db_read_write_splitting_connection alicloud_db_read_write_splitting_connection}
*/
export class DbReadWriteSplittingConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbReadWriteSplittingConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/db_read_write_splitting_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/db_read_write_splitting_connection alicloud_db_read_write_splitting_connection} Resource
  *
  * @param scope The scope in which to define this construct
