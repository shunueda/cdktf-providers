// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/iot_device_group
...
export interface IotDeviceGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/iot_device_group#group_desc IotDeviceGroup#group_desc}
  */
  readonly groupDesc?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/iot_device_group#group_name IotDeviceGroup#group_name}
  */
  readonly groupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/iot_device_group#id IotDeviceGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/iot_device_group#iot_instance_id IotDeviceGroup#iot_instance_id}
  */
  readonly iotInstanceId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/iot_device_group#super_group_id IotDeviceGroup#super_group_id}
  */
  readonly superGroupId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/iot_device_group alicloud_iot_device_group}
*/
export class IotDeviceGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotDeviceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/iot_device_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/iot_device_group alicloud_iot_device_group} Resource
  *
  * @param scope The scope in which to define this construct
