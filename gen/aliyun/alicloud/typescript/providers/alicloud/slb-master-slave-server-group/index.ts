// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group
...
export interface SlbMasterSlaveServerGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group#delete_protection_validation SlbMasterSlaveServerGroup#delete_protection_validation}
  */
  readonly deleteProtectionValidation?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group#id SlbMasterSlaveServerGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group#load_balancer_id SlbMasterSlaveServerGroup#load_balancer_id}
  */
  readonly loadBalancerId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group#name SlbMasterSlaveServerGroup#name}
  */
  readonly name: string;
  /**
  * servers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group#servers SlbMasterSlaveServerGroup#servers}
  */
  readonly servers?: SlbMasterSlaveServerGroupServers[] | cdktf.IResolvable;
}
export interface SlbMasterSlaveServerGroupServers {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group#is_backup SlbMasterSlaveServerGroup#is_backup}
  */
  readonly isBackup?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group#port SlbMasterSlaveServerGroup#port}
  */
  readonly port: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group#server_id SlbMasterSlaveServerGroup#server_id}
  */
  readonly serverId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group#server_type SlbMasterSlaveServerGroup#server_type}
  */
  readonly serverType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group#type SlbMasterSlaveServerGroup#type}
  */
  readonly type?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group#weight SlbMasterSlaveServerGroup#weight}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group alicloud_slb_master_slave_server_group}
*/
export class SlbMasterSlaveServerGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SlbMasterSlaveServerGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/slb_master_slave_server_group alicloud_slb_master_slave_server_group} Resource
  *
  * @param scope The scope in which to define this construct
