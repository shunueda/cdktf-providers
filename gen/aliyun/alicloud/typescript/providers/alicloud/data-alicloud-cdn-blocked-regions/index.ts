// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/cdn_blocked_regions
...
export interface DataAlicloudCdnBlockedRegionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/cdn_blocked_regions#id DataAlicloudCdnBlockedRegions#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/cdn_blocked_regions#language DataAlicloudCdnBlockedRegions#language}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/cdn_blocked_regions alicloud_cdn_blocked_regions}
*/
export class DataAlicloudCdnBlockedRegions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAlicloudCdnBlockedRegions that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/cdn_blocked_regions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/cdn_blocked_regions alicloud_cdn_blocked_regions} Data Source
  *
  * @param scope The scope in which to define this construct
