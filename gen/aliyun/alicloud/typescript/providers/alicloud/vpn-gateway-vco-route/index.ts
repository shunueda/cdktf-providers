// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpn_gateway_vco_route
...
export interface VpnGatewayVcoRouteConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpn_gateway_vco_route#id VpnGatewayVcoRoute#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpn_gateway_vco_route#next_hop VpnGatewayVcoRoute#next_hop}
  */
  readonly nextHop: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpn_gateway_vco_route#overlay_mode VpnGatewayVcoRoute#overlay_mode}
  */
  readonly overlayMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpn_gateway_vco_route#route_dest VpnGatewayVcoRoute#route_dest}
  */
  readonly routeDest: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpn_gateway_vco_route#vpn_connection_id VpnGatewayVcoRoute#vpn_connection_id}
  */
  readonly vpnConnectionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpn_gateway_vco_route#weight VpnGatewayVcoRoute#weight}
  */
  readonly weight: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpn_gateway_vco_route#timeouts VpnGatewayVcoRoute#timeouts}
  */
  readonly timeouts?: VpnGatewayVcoRouteTimeouts;
}
export interface VpnGatewayVcoRouteTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpn_gateway_vco_route#create VpnGatewayVcoRoute#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpn_gateway_vco_route#delete VpnGatewayVcoRoute#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpn_gateway_vco_route alicloud_vpn_gateway_vco_route}
*/
export class VpnGatewayVcoRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnGatewayVcoRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpn_gateway_vco_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpn_gateway_vco_route alicloud_vpn_gateway_vco_route} Resource
  *
  * @param scope The scope in which to define this construct
