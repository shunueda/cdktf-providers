// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/actiontrail_global_events_storage_region
...
export interface DataAlicloudActiontrailGlobalEventsStorageRegionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/actiontrail_global_events_storage_region#id DataAlicloudActiontrailGlobalEventsStorageRegion#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/actiontrail_global_events_storage_region alicloud_actiontrail_global_events_storage_region}
*/
export class DataAlicloudActiontrailGlobalEventsStorageRegion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAlicloudActiontrailGlobalEventsStorageRegion that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/actiontrail_global_events_storage_region#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/data-sources/actiontrail_global_events_storage_region alicloud_actiontrail_global_events_storage_region} Data Source
  *
  * @param scope The scope in which to define this construct
