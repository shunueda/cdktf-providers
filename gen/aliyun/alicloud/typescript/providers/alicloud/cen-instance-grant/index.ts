// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_instance_grant
...
export interface CenInstanceGrantConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_instance_grant#cen_id CenInstanceGrant#cen_id}
  */
  readonly cenId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_instance_grant#cen_owner_id CenInstanceGrant#cen_owner_id}
  */
  readonly cenOwnerId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_instance_grant#child_instance_id CenInstanceGrant#child_instance_id}
  */
  readonly childInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_instance_grant#id CenInstanceGrant#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_instance_grant alicloud_cen_instance_grant}
*/
export class CenInstanceGrant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CenInstanceGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_instance_grant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_instance_grant alicloud_cen_instance_grant} Resource
  *
  * @param scope The scope in which to define this construct
