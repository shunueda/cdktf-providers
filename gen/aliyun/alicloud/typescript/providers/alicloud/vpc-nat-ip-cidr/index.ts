// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_nat_ip_cidr
...
export interface VpcNatIpCidrConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_nat_ip_cidr#dry_run VpcNatIpCidr#dry_run}
  */
  readonly dryRun?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_nat_ip_cidr#id VpcNatIpCidr#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_nat_ip_cidr#nat_gateway_id VpcNatIpCidr#nat_gateway_id}
  */
  readonly natGatewayId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_nat_ip_cidr#nat_ip_cidr VpcNatIpCidr#nat_ip_cidr}
  */
  readonly natIpCidr?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_nat_ip_cidr#nat_ip_cidr_description VpcNatIpCidr#nat_ip_cidr_description}
  */
  readonly natIpCidrDescription?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_nat_ip_cidr#nat_ip_cidr_name VpcNatIpCidr#nat_ip_cidr_name}
  */
  readonly natIpCidrName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_nat_ip_cidr alicloud_vpc_nat_ip_cidr}
*/
export class VpcNatIpCidr extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcNatIpCidr that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_nat_ip_cidr#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/vpc_nat_ip_cidr alicloud_vpc_nat_ip_cidr} Resource
  *
  * @param scope The scope in which to define this construct
