// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_sso_scim_server_credential
...
export interface CloudSsoScimServerCredentialConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_sso_scim_server_credential#credential_secret_file CloudSsoScimServerCredential#credential_secret_file}
  */
  readonly credentialSecretFile?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_sso_scim_server_credential#directory_id CloudSsoScimServerCredential#directory_id}
  */
  readonly directoryId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_sso_scim_server_credential#id CloudSsoScimServerCredential#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_sso_scim_server_credential#status CloudSsoScimServerCredential#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_sso_scim_server_credential alicloud_cloud_sso_scim_server_credential}
*/
export class CloudSsoScimServerCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudSsoScimServerCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_sso_scim_server_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloud_sso_scim_server_credential alicloud_cloud_sso_scim_server_credential} Resource
  *
  * @param scope The scope in which to define this construct
