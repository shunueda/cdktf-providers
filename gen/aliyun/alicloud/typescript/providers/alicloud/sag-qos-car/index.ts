// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car
...
export interface SagQosCarConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car#description SagQosCar#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car#id SagQosCar#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car#limit_type SagQosCar#limit_type}
  */
  readonly limitType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car#max_bandwidth_abs SagQosCar#max_bandwidth_abs}
  */
  readonly maxBandwidthAbs?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car#max_bandwidth_percent SagQosCar#max_bandwidth_percent}
  */
  readonly maxBandwidthPercent?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car#min_bandwidth_abs SagQosCar#min_bandwidth_abs}
  */
  readonly minBandwidthAbs?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car#min_bandwidth_percent SagQosCar#min_bandwidth_percent}
  */
  readonly minBandwidthPercent?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car#name SagQosCar#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car#percent_source_type SagQosCar#percent_source_type}
  */
  readonly percentSourceType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car#priority SagQosCar#priority}
  */
  readonly priority: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car#qos_id SagQosCar#qos_id}
  */
  readonly qosId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car alicloud_sag_qos_car}
*/
export class SagQosCar extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SagQosCar that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sag_qos_car alicloud_sag_qos_car} Resource
  *
  * @param scope The scope in which to define this construct
