// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ga_accelerator_spare_ip_attachment
...
export interface GaAcceleratorSpareIpAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ga_accelerator_spare_ip_attachment#accelerator_id GaAcceleratorSpareIpAttachment#accelerator_id}
  */
  readonly acceleratorId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ga_accelerator_spare_ip_attachment#dry_run GaAcceleratorSpareIpAttachment#dry_run}
  */
  readonly dryRun?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ga_accelerator_spare_ip_attachment#id GaAcceleratorSpareIpAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ga_accelerator_spare_ip_attachment#spare_ip GaAcceleratorSpareIpAttachment#spare_ip}
  */
  readonly spareIp: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ga_accelerator_spare_ip_attachment#timeouts GaAcceleratorSpareIpAttachment#timeouts}
  */
  readonly timeouts?: GaAcceleratorSpareIpAttachmentTimeouts;
}
export interface GaAcceleratorSpareIpAttachmentTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ga_accelerator_spare_ip_attachment#create GaAcceleratorSpareIpAttachment#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ga_accelerator_spare_ip_attachment#delete GaAcceleratorSpareIpAttachment#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ga_accelerator_spare_ip_attachment alicloud_ga_accelerator_spare_ip_attachment}
*/
export class GaAcceleratorSpareIpAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GaAcceleratorSpareIpAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ga_accelerator_spare_ip_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/ga_accelerator_spare_ip_attachment alicloud_ga_accelerator_spare_ip_attachment} Resource
  *
  * @param scope The scope in which to define this construct
