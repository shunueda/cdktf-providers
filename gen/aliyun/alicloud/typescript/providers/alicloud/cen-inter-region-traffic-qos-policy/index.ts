// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_inter_region_traffic_qos_policy
...
export interface CenInterRegionTrafficQosPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_inter_region_traffic_qos_policy#bandwidth_guarantee_mode CenInterRegionTrafficQosPolicy#bandwidth_guarantee_mode}
  */
  readonly bandwidthGuaranteeMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_inter_region_traffic_qos_policy#id CenInterRegionTrafficQosPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_inter_region_traffic_qos_policy#inter_region_traffic_qos_policy_description CenInterRegionTrafficQosPolicy#inter_region_traffic_qos_policy_description}
  */
  readonly interRegionTrafficQosPolicyDescription?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_inter_region_traffic_qos_policy#inter_region_traffic_qos_policy_name CenInterRegionTrafficQosPolicy#inter_region_traffic_qos_policy_name}
  */
  readonly interRegionTrafficQosPolicyName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_inter_region_traffic_qos_policy#transit_router_attachment_id CenInterRegionTrafficQosPolicy#transit_router_attachment_id}
  */
  readonly transitRouterAttachmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_inter_region_traffic_qos_policy#transit_router_id CenInterRegionTrafficQosPolicy#transit_router_id}
  */
  readonly transitRouterId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_inter_region_traffic_qos_policy#timeouts CenInterRegionTrafficQosPolicy#timeouts}
  */
  readonly timeouts?: CenInterRegionTrafficQosPolicyTimeouts;
}
export interface CenInterRegionTrafficQosPolicyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_inter_region_traffic_qos_policy#create CenInterRegionTrafficQosPolicy#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_inter_region_traffic_qos_policy#delete CenInterRegionTrafficQosPolicy#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_inter_region_traffic_qos_policy#update CenInterRegionTrafficQosPolicy#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_inter_region_traffic_qos_policy alicloud_cen_inter_region_traffic_qos_policy}
*/
export class CenInterRegionTrafficQosPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CenInterRegionTrafficQosPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_inter_region_traffic_qos_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_inter_region_traffic_qos_policy alicloud_cen_inter_region_traffic_qos_policy} Resource
  *
  * @param scope The scope in which to define this construct
