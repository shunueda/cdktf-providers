// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloudauth_face_config
...
export interface CloudauthFaceConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloudauth_face_config#biz_name CloudauthFaceConfig#biz_name}
  */
  readonly bizName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloudauth_face_config#biz_type CloudauthFaceConfig#biz_type}
  */
  readonly bizType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloudauth_face_config#id CloudauthFaceConfig#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloudauth_face_config alicloud_cloudauth_face_config}
*/
export class CloudauthFaceConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudauthFaceConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloudauth_face_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/cloudauth_face_config alicloud_cloudauth_face_config} Resource
  *
  * @param scope The scope in which to define this construct
