// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cloud_storage_gateway_gateway_cache_disk
...
export interface CloudStorageGatewayGatewayCacheDiskConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cloud_storage_gateway_gateway_cache_disk#cache_disk_category CloudStorageGatewayGatewayCacheDisk#cache_disk_category}
  */
  readonly cacheDiskCategory?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cloud_storage_gateway_gateway_cache_disk#cache_disk_size_in_gb CloudStorageGatewayGatewayCacheDisk#cache_disk_size_in_gb}
  */
  readonly cacheDiskSizeInGb: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cloud_storage_gateway_gateway_cache_disk#gateway_id CloudStorageGatewayGatewayCacheDisk#gateway_id}
  */
  readonly gatewayId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cloud_storage_gateway_gateway_cache_disk#id CloudStorageGatewayGatewayCacheDisk#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cloud_storage_gateway_gateway_cache_disk#performance_level CloudStorageGatewayGatewayCacheDisk#performance_level}
  */
  readonly performanceLevel?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cloud_storage_gateway_gateway_cache_disk alicloud_cloud_storage_gateway_gateway_cache_disk}
*/
export class CloudStorageGatewayGatewayCacheDisk extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudStorageGatewayGatewayCacheDisk that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cloud_storage_gateway_gateway_cache_disk#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cloud_storage_gateway_gateway_cache_disk alicloud_cloud_storage_gateway_gateway_cache_disk} Resource
  *
  * @param scope The scope in which to define this construct
