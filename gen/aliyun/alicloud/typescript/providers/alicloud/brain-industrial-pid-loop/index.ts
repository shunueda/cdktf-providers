// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/brain_industrial_pid_loop
...
export interface BrainIndustrialPidLoopConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/brain_industrial_pid_loop#id BrainIndustrialPidLoop#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/brain_industrial_pid_loop#pid_loop_configuration BrainIndustrialPidLoop#pid_loop_configuration}
  */
  readonly pidLoopConfiguration: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/brain_industrial_pid_loop#pid_loop_dcs_type BrainIndustrialPidLoop#pid_loop_dcs_type}
  */
  readonly pidLoopDcsType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/brain_industrial_pid_loop#pid_loop_desc BrainIndustrialPidLoop#pid_loop_desc}
  */
  readonly pidLoopDesc?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/brain_industrial_pid_loop#pid_loop_is_crucial BrainIndustrialPidLoop#pid_loop_is_crucial}
  */
  readonly pidLoopIsCrucial: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/brain_industrial_pid_loop#pid_loop_name BrainIndustrialPidLoop#pid_loop_name}
  */
  readonly pidLoopName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/brain_industrial_pid_loop#pid_loop_type BrainIndustrialPidLoop#pid_loop_type}
  */
  readonly pidLoopType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/brain_industrial_pid_loop#pid_project_id BrainIndustrialPidLoop#pid_project_id}
  */
  readonly pidProjectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/brain_industrial_pid_loop alicloud_brain_industrial_pid_loop}
*/
export class BrainIndustrialPidLoop extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BrainIndustrialPidLoop that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/brain_industrial_pid_loop#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/brain_industrial_pid_loop alicloud_brain_industrial_pid_loop} Resource
  *
  * @param scope The scope in which to define this construct
