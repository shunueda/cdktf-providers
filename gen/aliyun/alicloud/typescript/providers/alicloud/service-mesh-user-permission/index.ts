// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission
...
export interface ServiceMeshUserPermissionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission#id ServiceMeshUserPermission#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission#sub_account_user_id ServiceMeshUserPermission#sub_account_user_id}
  */
  readonly subAccountUserId: string;
  /**
  * permissions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission#permissions ServiceMeshUserPermission#permissions}
  */
  readonly permissions?: ServiceMeshUserPermissionPermissions[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission#timeouts ServiceMeshUserPermission#timeouts}
  */
  readonly timeouts?: ServiceMeshUserPermissionTimeouts;
}
export interface ServiceMeshUserPermissionPermissions {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission#is_custom ServiceMeshUserPermission#is_custom}
  */
  readonly isCustom?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission#is_ram_role ServiceMeshUserPermission#is_ram_role}
  */
  readonly isRamRole?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission#role_name ServiceMeshUserPermission#role_name}
  */
  readonly roleName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission#role_type ServiceMeshUserPermission#role_type}
  */
  readonly roleType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission#service_mesh_id ServiceMeshUserPermission#service_mesh_id}
  */
...
export interface ServiceMeshUserPermissionTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission#create ServiceMeshUserPermission#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission#update ServiceMeshUserPermission#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission alicloud_service_mesh_user_permission}
*/
export class ServiceMeshUserPermission extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceMeshUserPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/service_mesh_user_permission alicloud_service_mesh_user_permission} Resource
  *
  * @param scope The scope in which to define this construct
