// https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ga_custom_routing_endpoint
...
export interface GaCustomRoutingEndpointConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ga_custom_routing_endpoint#endpoint GaCustomRoutingEndpoint#endpoint}
  */
  readonly endpoint: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ga_custom_routing_endpoint#endpoint_group_id GaCustomRoutingEndpoint#endpoint_group_id}
  */
  readonly endpointGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ga_custom_routing_endpoint#id GaCustomRoutingEndpoint#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ga_custom_routing_endpoint#traffic_to_endpoint_policy GaCustomRoutingEndpoint#traffic_to_endpoint_policy}
  */
  readonly trafficToEndpointPolicy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ga_custom_routing_endpoint#type GaCustomRoutingEndpoint#type}
  */
  readonly type: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ga_custom_routing_endpoint#timeouts GaCustomRoutingEndpoint#timeouts}
  */
  readonly timeouts?: GaCustomRoutingEndpointTimeouts;
}
export interface GaCustomRoutingEndpointTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ga_custom_routing_endpoint#create GaCustomRoutingEndpoint#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ga_custom_routing_endpoint#delete GaCustomRoutingEndpoint#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ga_custom_routing_endpoint#update GaCustomRoutingEndpoint#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ga_custom_routing_endpoint alicloud_ga_custom_routing_endpoint}
*/
export class GaCustomRoutingEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GaCustomRoutingEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ga_custom_routing_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/ga_custom_routing_endpoint alicloud_ga_custom_routing_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
