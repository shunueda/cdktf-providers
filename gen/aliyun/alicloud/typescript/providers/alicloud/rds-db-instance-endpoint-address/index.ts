// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/rds_db_instance_endpoint_address
...
export interface RdsDbInstanceEndpointAddressConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/rds_db_instance_endpoint_address#connection_string_prefix RdsDbInstanceEndpointAddress#connection_string_prefix}
  */
  readonly connectionStringPrefix: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/rds_db_instance_endpoint_address#db_instance_endpoint_id RdsDbInstanceEndpointAddress#db_instance_endpoint_id}
  */
  readonly dbInstanceEndpointId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/rds_db_instance_endpoint_address#db_instance_id RdsDbInstanceEndpointAddress#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/rds_db_instance_endpoint_address#id RdsDbInstanceEndpointAddress#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/rds_db_instance_endpoint_address#port RdsDbInstanceEndpointAddress#port}
  */
  readonly port: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/rds_db_instance_endpoint_address#timeouts RdsDbInstanceEndpointAddress#timeouts}
  */
  readonly timeouts?: RdsDbInstanceEndpointAddressTimeouts;
}
export interface RdsDbInstanceEndpointAddressTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/rds_db_instance_endpoint_address#create RdsDbInstanceEndpointAddress#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/rds_db_instance_endpoint_address#delete RdsDbInstanceEndpointAddress#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/rds_db_instance_endpoint_address#update RdsDbInstanceEndpointAddress#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/rds_db_instance_endpoint_address alicloud_rds_db_instance_endpoint_address}
*/
export class RdsDbInstanceEndpointAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RdsDbInstanceEndpointAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/rds_db_instance_endpoint_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/rds_db_instance_endpoint_address alicloud_rds_db_instance_endpoint_address} Resource
  *
  * @param scope The scope in which to define this construct
