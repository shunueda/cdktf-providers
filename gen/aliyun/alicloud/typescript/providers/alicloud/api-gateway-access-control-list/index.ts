// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/api_gateway_access_control_list
...
export interface ApiGatewayAccessControlListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/api_gateway_access_control_list#access_control_list_name ApiGatewayAccessControlList#access_control_list_name}
  */
  readonly accessControlListName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/api_gateway_access_control_list#address_ip_version ApiGatewayAccessControlList#address_ip_version}
  */
  readonly addressIpVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/api_gateway_access_control_list#id ApiGatewayAccessControlList#id}
  *
  ...
  * acl_entrys block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/api_gateway_access_control_list#acl_entrys ApiGatewayAccessControlList#acl_entrys}
  */
  readonly aclEntrys?: ApiGatewayAccessControlListAclEntrys[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/api_gateway_access_control_list#timeouts ApiGatewayAccessControlList#timeouts}
  */
  readonly timeouts?: ApiGatewayAccessControlListTimeouts;
}
export interface ApiGatewayAccessControlListAclEntrys {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/api_gateway_access_control_list#acl_entry_comment ApiGatewayAccessControlList#acl_entry_comment}
  */
  readonly aclEntryComment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/api_gateway_access_control_list#acl_entry_ip ApiGatewayAccessControlList#acl_entry_ip}
  */
...
export interface ApiGatewayAccessControlListTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/api_gateway_access_control_list#create ApiGatewayAccessControlList#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/api_gateway_access_control_list#delete ApiGatewayAccessControlList#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/api_gateway_access_control_list#update ApiGatewayAccessControlList#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/api_gateway_access_control_list alicloud_api_gateway_access_control_list}
*/
export class ApiGatewayAccessControlList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayAccessControlList that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/api_gateway_access_control_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/api_gateway_access_control_list alicloud_api_gateway_access_control_list} Resource
  *
  * @param scope The scope in which to define this construct
