// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/message_service_endpoint_acl
...
export interface MessageServiceEndpointAclConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/message_service_endpoint_acl#acl_strategy MessageServiceEndpointAcl#acl_strategy}
  */
  readonly aclStrategy: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/message_service_endpoint_acl#cidr MessageServiceEndpointAcl#cidr}
  */
  readonly cidr: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/message_service_endpoint_acl#endpoint_type MessageServiceEndpointAcl#endpoint_type}
  */
  readonly endpointType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/message_service_endpoint_acl#id MessageServiceEndpointAcl#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/message_service_endpoint_acl#timeouts MessageServiceEndpointAcl#timeouts}
  */
  readonly timeouts?: MessageServiceEndpointAclTimeouts;
}
export interface MessageServiceEndpointAclTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/message_service_endpoint_acl#create MessageServiceEndpointAcl#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/message_service_endpoint_acl#delete MessageServiceEndpointAcl#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/message_service_endpoint_acl alicloud_message_service_endpoint_acl}
*/
export class MessageServiceEndpointAcl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MessageServiceEndpointAcl that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/message_service_endpoint_acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/message_service_endpoint_acl alicloud_message_service_endpoint_acl} Resource
  *
  * @param scope The scope in which to define this construct
