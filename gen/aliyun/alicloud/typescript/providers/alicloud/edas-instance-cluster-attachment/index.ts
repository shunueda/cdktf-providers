// https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/edas_instance_cluster_attachment
...
export interface EdasInstanceClusterAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/edas_instance_cluster_attachment#cluster_id EdasInstanceClusterAttachment#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/edas_instance_cluster_attachment#id EdasInstanceClusterAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/edas_instance_cluster_attachment#instance_ids EdasInstanceClusterAttachment#instance_ids}
  */
  readonly instanceIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/edas_instance_cluster_attachment alicloud_edas_instance_cluster_attachment}
*/
export class EdasInstanceClusterAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EdasInstanceClusterAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/edas_instance_cluster_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/edas_instance_cluster_attachment alicloud_edas_instance_cluster_attachment} Resource
  *
  * @param scope The scope in which to define this construct
