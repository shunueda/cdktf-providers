// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sae_load_balancer_internet
...
export interface SaeLoadBalancerInternetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sae_load_balancer_internet#app_id SaeLoadBalancerInternet#app_id}
  */
  readonly appId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sae_load_balancer_internet#id SaeLoadBalancerInternet#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sae_load_balancer_internet#internet_slb_id SaeLoadBalancerInternet#internet_slb_id}
  */
  readonly internetSlbId?: string;
  /**
  * internet block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sae_load_balancer_internet#internet SaeLoadBalancerInternet#internet}
  */
  readonly internet: SaeLoadBalancerInternetInternet[] | cdktf.IResolvable;
}
export interface SaeLoadBalancerInternetInternet {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sae_load_balancer_internet#https_cert_id SaeLoadBalancerInternet#https_cert_id}
  */
  readonly httpsCertId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sae_load_balancer_internet#port SaeLoadBalancerInternet#port}
  */
  readonly port?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sae_load_balancer_internet#protocol SaeLoadBalancerInternet#protocol}
  */
  readonly protocol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sae_load_balancer_internet#target_port SaeLoadBalancerInternet#target_port}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sae_load_balancer_internet alicloud_sae_load_balancer_internet}
*/
export class SaeLoadBalancerInternet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SaeLoadBalancerInternet that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sae_load_balancer_internet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/sae_load_balancer_internet alicloud_sae_load_balancer_internet} Resource
  *
  * @param scope The scope in which to define this construct
