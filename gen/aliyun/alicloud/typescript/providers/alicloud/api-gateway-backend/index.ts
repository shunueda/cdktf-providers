// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/api_gateway_backend
...
export interface ApiGatewayBackendConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/api_gateway_backend#backend_name ApiGatewayBackend#backend_name}
  */
  readonly backendName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/api_gateway_backend#backend_type ApiGatewayBackend#backend_type}
  */
  readonly backendType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/api_gateway_backend#create_event_bridge_service_linked_role ApiGatewayBackend#create_event_bridge_service_linked_role}
  */
  readonly createEventBridgeServiceLinkedRole?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/api_gateway_backend#description ApiGatewayBackend#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/api_gateway_backend#id ApiGatewayBackend#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/api_gateway_backend alicloud_api_gateway_backend}
*/
export class ApiGatewayBackend extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayBackend that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/api_gateway_backend#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/api_gateway_backend alicloud_api_gateway_backend} Resource
  *
  * @param scope The scope in which to define this construct
