// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/direct_mail_receivers
...
export interface DirectMailReceiversConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/direct_mail_receivers#description DirectMailReceivers#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/direct_mail_receivers#id DirectMailReceivers#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/direct_mail_receivers#receivers_alias DirectMailReceivers#receivers_alias}
  */
  readonly receiversAlias: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/direct_mail_receivers#receivers_name DirectMailReceivers#receivers_name}
  */
  readonly receiversName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/direct_mail_receivers alicloud_direct_mail_receivers}
*/
export class DirectMailReceivers extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectMailReceivers that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/direct_mail_receivers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/direct_mail_receivers alicloud_direct_mail_receivers} Resource
  *
  * @param scope The scope in which to define this construct
