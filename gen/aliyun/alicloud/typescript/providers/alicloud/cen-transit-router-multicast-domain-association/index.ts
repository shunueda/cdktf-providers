// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_transit_router_multicast_domain_association
...
export interface CenTransitRouterMulticastDomainAssociationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_transit_router_multicast_domain_association#id CenTransitRouterMulticastDomainAssociation#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_transit_router_multicast_domain_association#transit_router_attachment_id CenTransitRouterMulticastDomainAssociation#transit_router_attachment_id}
  */
  readonly transitRouterAttachmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_transit_router_multicast_domain_association#transit_router_multicast_domain_id CenTransitRouterMulticastDomainAssociation#transit_router_multicast_domain_id}
  */
  readonly transitRouterMulticastDomainId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_transit_router_multicast_domain_association#vswitch_id CenTransitRouterMulticastDomainAssociation#vswitch_id}
  */
  readonly vswitchId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_transit_router_multicast_domain_association#timeouts CenTransitRouterMulticastDomainAssociation#timeouts}
  */
...
export interface CenTransitRouterMulticastDomainAssociationTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_transit_router_multicast_domain_association#create CenTransitRouterMulticastDomainAssociation#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_transit_router_multicast_domain_association#delete CenTransitRouterMulticastDomainAssociation#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_transit_router_multicast_domain_association alicloud_cen_transit_router_multicast_domain_association}
*/
export class CenTransitRouterMulticastDomainAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CenTransitRouterMulticastDomainAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_transit_router_multicast_domain_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/cen_transit_router_multicast_domain_association alicloud_cen_transit_router_multicast_domain_association} Resource
  *
  * @param scope The scope in which to define this construct
