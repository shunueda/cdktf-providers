// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/alidns_address_pool
...
export interface AlidnsAddressPoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/alidns_address_pool#address_pool_name AlidnsAddressPool#address_pool_name}
  */
  readonly addressPoolName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/alidns_address_pool#id AlidnsAddressPool#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/alidns_address_pool#instance_id AlidnsAddressPool#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/alidns_address_pool#lba_strategy AlidnsAddressPool#lba_strategy}
  */
  readonly lbaStrategy: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/alidns_address_pool#type AlidnsAddressPool#type}
  */
  readonly type: string;
  /**
  * address block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/alidns_address_pool#address AlidnsAddressPool#address}
  */
...
export interface AlidnsAddressPoolAddress {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/alidns_address_pool#attribute_info AlidnsAddressPool#attribute_info}
  */
  readonly attributeInfo: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/alidns_address_pool#lba_weight AlidnsAddressPool#lba_weight}
  */
  readonly lbaWeight?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/alidns_address_pool#mode AlidnsAddressPool#mode}
  */
  readonly mode: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/alidns_address_pool#remark AlidnsAddressPool#remark}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/alidns_address_pool alicloud_alidns_address_pool}
*/
export class AlidnsAddressPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AlidnsAddressPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/alidns_address_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/alidns_address_pool alicloud_alidns_address_pool} Resource
  *
  * @param scope The scope in which to define this construct
