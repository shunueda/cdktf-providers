// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group
...
export interface CmsSlsGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group#id CmsSlsGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group#sls_group_description CmsSlsGroup#sls_group_description}
  */
  readonly slsGroupDescription?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group#sls_group_name CmsSlsGroup#sls_group_name}
  */
  readonly slsGroupName: string;
  /**
  * sls_group_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group#sls_group_config CmsSlsGroup#sls_group_config}
  */
  readonly slsGroupConfig: CmsSlsGroupSlsGroupConfig[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group#timeouts CmsSlsGroup#timeouts}
  */
  readonly timeouts?: CmsSlsGroupTimeouts;
}
export interface CmsSlsGroupSlsGroupConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group#sls_logstore CmsSlsGroup#sls_logstore}
  */
  readonly slsLogstore: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group#sls_project CmsSlsGroup#sls_project}
  */
  readonly slsProject: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group#sls_region CmsSlsGroup#sls_region}
  */
  readonly slsRegion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group#sls_user_id CmsSlsGroup#sls_user_id}
  */
...
export interface CmsSlsGroupTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group#create CmsSlsGroup#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group#delete CmsSlsGroup#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group#update CmsSlsGroup#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group alicloud_cms_sls_group}
*/
export class CmsSlsGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CmsSlsGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cms_sls_group alicloud_cms_sls_group} Resource
  *
  * @param scope The scope in which to define this construct
