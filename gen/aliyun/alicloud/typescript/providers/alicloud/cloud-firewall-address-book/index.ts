// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book
...
export interface CloudFirewallAddressBookConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book#address_list CloudFirewallAddressBook#address_list}
  */
  readonly addressList?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book#auto_add_tag_ecs CloudFirewallAddressBook#auto_add_tag_ecs}
  */
  readonly autoAddTagEcs?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book#description CloudFirewallAddressBook#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book#group_name CloudFirewallAddressBook#group_name}
  */
  readonly groupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book#group_type CloudFirewallAddressBook#group_type}
  */
  readonly groupType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book#id CloudFirewallAddressBook#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book#lang CloudFirewallAddressBook#lang}
  */
  readonly lang?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book#tag_relation CloudFirewallAddressBook#tag_relation}
  */
  readonly tagRelation?: string;
  /**
  * ecs_tags block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book#ecs_tags CloudFirewallAddressBook#ecs_tags}
  */
  readonly ecsTags?: CloudFirewallAddressBookEcsTags[] | cdktf.IResolvable;
}
export interface CloudFirewallAddressBookEcsTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book#tag_key CloudFirewallAddressBook#tag_key}
  */
  readonly tagKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book#tag_value CloudFirewallAddressBook#tag_value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book alicloud_cloud_firewall_address_book}
*/
export class CloudFirewallAddressBook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudFirewallAddressBook that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_address_book alicloud_cloud_firewall_address_book} Resource
  *
  * @param scope The scope in which to define this construct
