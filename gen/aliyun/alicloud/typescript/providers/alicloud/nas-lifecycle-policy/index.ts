// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/nas_lifecycle_policy
...
export interface NasLifecyclePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/nas_lifecycle_policy#file_system_id NasLifecyclePolicy#file_system_id}
  */
  readonly fileSystemId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/nas_lifecycle_policy#id NasLifecyclePolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/nas_lifecycle_policy#lifecycle_policy_name NasLifecyclePolicy#lifecycle_policy_name}
  */
  readonly lifecyclePolicyName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/nas_lifecycle_policy#lifecycle_rule_name NasLifecyclePolicy#lifecycle_rule_name}
  */
  readonly lifecycleRuleName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/nas_lifecycle_policy#paths NasLifecyclePolicy#paths}
  */
  readonly paths: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/nas_lifecycle_policy#storage_type NasLifecyclePolicy#storage_type}
  */
  readonly storageType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/nas_lifecycle_policy alicloud_nas_lifecycle_policy}
*/
export class NasLifecyclePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NasLifecyclePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/nas_lifecycle_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/nas_lifecycle_policy alicloud_nas_lifecycle_policy} Resource
  *
  * @param scope The scope in which to define this construct
