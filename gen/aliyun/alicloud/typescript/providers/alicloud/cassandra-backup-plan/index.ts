// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cassandra_backup_plan
...
export interface CassandraBackupPlanConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cassandra_backup_plan#active CassandraBackupPlan#active}
  */
  readonly active?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cassandra_backup_plan#backup_period CassandraBackupPlan#backup_period}
  */
  readonly backupPeriod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cassandra_backup_plan#backup_time CassandraBackupPlan#backup_time}
  */
  readonly backupTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cassandra_backup_plan#cluster_id CassandraBackupPlan#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cassandra_backup_plan#data_center_id CassandraBackupPlan#data_center_id}
  */
  readonly dataCenterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cassandra_backup_plan#id CassandraBackupPlan#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cassandra_backup_plan#retention_period CassandraBackupPlan#retention_period}
  */
  readonly retentionPeriod?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cassandra_backup_plan alicloud_cassandra_backup_plan}
*/
export class CassandraBackupPlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CassandraBackupPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cassandra_backup_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cassandra_backup_plan alicloud_cassandra_backup_plan} Resource
  *
  * @param scope The scope in which to define this construct
