// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cr_chart_repository
...
export interface CrChartRepositoryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cr_chart_repository#id CrChartRepository#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cr_chart_repository#instance_id CrChartRepository#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cr_chart_repository#repo_name CrChartRepository#repo_name}
  */
  readonly repoName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cr_chart_repository#repo_namespace_name CrChartRepository#repo_namespace_name}
  */
  readonly repoNamespaceName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cr_chart_repository#repo_type CrChartRepository#repo_type}
  */
  readonly repoType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cr_chart_repository#summary CrChartRepository#summary}
  */
  readonly summary?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cr_chart_repository alicloud_cr_chart_repository}
*/
export class CrChartRepository extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CrChartRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cr_chart_repository#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cr_chart_repository alicloud_cr_chart_repository} Resource
  *
  * @param scope The scope in which to define this construct
