// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/router_interface_connection
...
export interface RouterInterfaceConnectionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/router_interface_connection#id RouterInterfaceConnection#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/router_interface_connection#interface_id RouterInterfaceConnection#interface_id}
  */
  readonly interfaceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/router_interface_connection#opposite_interface_id RouterInterfaceConnection#opposite_interface_id}
  */
  readonly oppositeInterfaceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/router_interface_connection#opposite_interface_owner_id RouterInterfaceConnection#opposite_interface_owner_id}
  */
  readonly oppositeInterfaceOwnerId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/router_interface_connection#opposite_router_id RouterInterfaceConnection#opposite_router_id}
  */
  readonly oppositeRouterId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/router_interface_connection#opposite_router_type RouterInterfaceConnection#opposite_router_type}
  */
  readonly oppositeRouterType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/router_interface_connection alicloud_router_interface_connection}
*/
export class RouterInterfaceConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RouterInterfaceConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/router_interface_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/router_interface_connection alicloud_router_interface_connection} Resource
  *
  * @param scope The scope in which to define this construct
