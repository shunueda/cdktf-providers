// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation
...
export interface ConfigRemediationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation#config_rule_id ConfigRemediation#config_rule_id}
  */
  readonly configRuleId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation#id ConfigRemediation#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation#invoke_type ConfigRemediation#invoke_type}
  */
  readonly invokeType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation#params ConfigRemediation#params}
  */
  readonly params: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation#remediation_source_type ConfigRemediation#remediation_source_type}
  */
  readonly remediationSourceType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation#remediation_template_id ConfigRemediation#remediation_template_id}
  */
  readonly remediationTemplateId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation#remediation_type ConfigRemediation#remediation_type}
  */
  readonly remediationType: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation#timeouts ConfigRemediation#timeouts}
  */
  readonly timeouts?: ConfigRemediationTimeouts;
}
export interface ConfigRemediationTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation#create ConfigRemediation#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation#delete ConfigRemediation#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation#update ConfigRemediation#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation alicloud_config_remediation}
*/
export class ConfigRemediation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigRemediation that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/config_remediation alicloud_config_remediation} Resource
  *
  * @param scope The scope in which to define this construct
