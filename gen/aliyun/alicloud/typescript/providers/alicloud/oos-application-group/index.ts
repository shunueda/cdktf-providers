// https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/oos_application_group
...
export interface OosApplicationGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/oos_application_group#application_group_name OosApplicationGroup#application_group_name}
  */
  readonly applicationGroupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/oos_application_group#application_name OosApplicationGroup#application_name}
  */
  readonly applicationName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/oos_application_group#deploy_region_id OosApplicationGroup#deploy_region_id}
  */
  readonly deployRegionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/oos_application_group#description OosApplicationGroup#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/oos_application_group#id OosApplicationGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/oos_application_group#import_tag_key OosApplicationGroup#import_tag_key}
  */
  readonly importTagKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/oos_application_group#import_tag_value OosApplicationGroup#import_tag_value}
  */
  readonly importTagValue?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/oos_application_group alicloud_oos_application_group}
*/
export class OosApplicationGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OosApplicationGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/oos_application_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/oos_application_group alicloud_oos_application_group} Resource
  *
  * @param scope The scope in which to define this construct
