// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/database_gateway_gateway
...
export interface DatabaseGatewayGatewayConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/database_gateway_gateway#gateway_desc DatabaseGatewayGateway#gateway_desc}
  */
  readonly gatewayDesc?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/database_gateway_gateway#gateway_name DatabaseGatewayGateway#gateway_name}
  */
  readonly gatewayName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/database_gateway_gateway#id DatabaseGatewayGateway#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/database_gateway_gateway alicloud_database_gateway_gateway}
*/
export class DatabaseGatewayGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseGatewayGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/database_gateway_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/database_gateway_gateway alicloud_database_gateway_gateway} Resource
  *
  * @param scope The scope in which to define this construct
