// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client
...
export interface HbrEcsBackupClientConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#data_network_type HbrEcsBackupClient#data_network_type}
  */
  readonly dataNetworkType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#data_proxy_setting HbrEcsBackupClient#data_proxy_setting}
  */
  readonly dataProxySetting?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#id HbrEcsBackupClient#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#instance_id HbrEcsBackupClient#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#max_cpu_core HbrEcsBackupClient#max_cpu_core}
  */
  readonly maxCpuCore?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#max_worker HbrEcsBackupClient#max_worker}
  */
  readonly maxWorker?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#proxy_host HbrEcsBackupClient#proxy_host}
  */
  readonly proxyHost?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#proxy_password HbrEcsBackupClient#proxy_password}
  */
  readonly proxyPassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#proxy_port HbrEcsBackupClient#proxy_port}
  */
  readonly proxyPort?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#proxy_user HbrEcsBackupClient#proxy_user}
  */
  readonly proxyUser?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#status HbrEcsBackupClient#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#use_https HbrEcsBackupClient#use_https}
  */
  readonly useHttps?: boolean | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#timeouts HbrEcsBackupClient#timeouts}
  */
  readonly timeouts?: HbrEcsBackupClientTimeouts;
}
export interface HbrEcsBackupClientTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#create HbrEcsBackupClient#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client alicloud_hbr_ecs_backup_client}
*/
export class HbrEcsBackupClient extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HbrEcsBackupClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_ecs_backup_client alicloud_hbr_ecs_backup_client} Resource
  *
  * @param scope The scope in which to define this construct
