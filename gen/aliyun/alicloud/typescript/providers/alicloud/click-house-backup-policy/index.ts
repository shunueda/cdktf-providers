// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/click_house_backup_policy
...
export interface ClickHouseBackupPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/click_house_backup_policy#backup_retention_period ClickHouseBackupPolicy#backup_retention_period}
  */
  readonly backupRetentionPeriod?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/click_house_backup_policy#db_cluster_id ClickHouseBackupPolicy#db_cluster_id}
  */
  readonly dbClusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/click_house_backup_policy#id ClickHouseBackupPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/click_house_backup_policy#preferred_backup_period ClickHouseBackupPolicy#preferred_backup_period}
  */
  readonly preferredBackupPeriod: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/click_house_backup_policy#preferred_backup_time ClickHouseBackupPolicy#preferred_backup_time}
  */
  readonly preferredBackupTime: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/click_house_backup_policy#timeouts ClickHouseBackupPolicy#timeouts}
  */
  readonly timeouts?: ClickHouseBackupPolicyTimeouts;
}
export interface ClickHouseBackupPolicyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/click_house_backup_policy#create ClickHouseBackupPolicy#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/click_house_backup_policy alicloud_click_house_backup_policy}
*/
export class ClickHouseBackupPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClickHouseBackupPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/click_house_backup_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/click_house_backup_policy alicloud_click_house_backup_policy} Resource
  *
  * @param scope The scope in which to define this construct
