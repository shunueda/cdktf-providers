// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_firewall_threat_intelligence_switch
...
export interface CloudFirewallThreatIntelligenceSwitchConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_firewall_threat_intelligence_switch#action CloudFirewallThreatIntelligenceSwitch#action}
  */
  readonly action?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_firewall_threat_intelligence_switch#category_id CloudFirewallThreatIntelligenceSwitch#category_id}
  */
  readonly categoryId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_firewall_threat_intelligence_switch#enable_status CloudFirewallThreatIntelligenceSwitch#enable_status}
  */
  readonly enableStatus?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_firewall_threat_intelligence_switch#id CloudFirewallThreatIntelligenceSwitch#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_firewall_threat_intelligence_switch#timeouts CloudFirewallThreatIntelligenceSwitch#timeouts}
  */
...
export interface CloudFirewallThreatIntelligenceSwitchTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_firewall_threat_intelligence_switch#create CloudFirewallThreatIntelligenceSwitch#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_firewall_threat_intelligence_switch#delete CloudFirewallThreatIntelligenceSwitch#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_firewall_threat_intelligence_switch#update CloudFirewallThreatIntelligenceSwitch#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_firewall_threat_intelligence_switch alicloud_cloud_firewall_threat_intelligence_switch}
*/
export class CloudFirewallThreatIntelligenceSwitch extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudFirewallThreatIntelligenceSwitch that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_firewall_threat_intelligence_switch#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_firewall_threat_intelligence_switch alicloud_cloud_firewall_threat_intelligence_switch} Resource
  *
  * @param scope The scope in which to define this construct
