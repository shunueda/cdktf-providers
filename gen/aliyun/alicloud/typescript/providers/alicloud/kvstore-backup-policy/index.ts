// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/kvstore_backup_policy
...
export interface KvstoreBackupPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/kvstore_backup_policy#backup_period KvstoreBackupPolicy#backup_period}
  */
  readonly backupPeriod?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/kvstore_backup_policy#backup_time KvstoreBackupPolicy#backup_time}
  */
  readonly backupTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/kvstore_backup_policy#id KvstoreBackupPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/kvstore_backup_policy#instance_id KvstoreBackupPolicy#instance_id}
  */
  readonly instanceId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/kvstore_backup_policy#timeouts KvstoreBackupPolicy#timeouts}
  */
  readonly timeouts?: KvstoreBackupPolicyTimeouts;
}
export interface KvstoreBackupPolicyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/kvstore_backup_policy#update KvstoreBackupPolicy#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/kvstore_backup_policy alicloud_kvstore_backup_policy}
*/
export class KvstoreBackupPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KvstoreBackupPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/kvstore_backup_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/kvstore_backup_policy alicloud_kvstore_backup_policy} Resource
  *
  * @param scope The scope in which to define this construct
