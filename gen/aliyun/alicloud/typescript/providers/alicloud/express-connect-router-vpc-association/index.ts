// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/express_connect_router_vpc_association
...
export interface ExpressConnectRouterVpcAssociationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/express_connect_router_vpc_association#allowed_prefixes ExpressConnectRouterVpcAssociation#allowed_prefixes}
  */
  readonly allowedPrefixes?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/express_connect_router_vpc_association#association_region_id ExpressConnectRouterVpcAssociation#association_region_id}
  */
  readonly associationRegionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/express_connect_router_vpc_association#ecr_id ExpressConnectRouterVpcAssociation#ecr_id}
  */
  readonly ecrId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/express_connect_router_vpc_association#id ExpressConnectRouterVpcAssociation#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/express_connect_router_vpc_association#vpc_id ExpressConnectRouterVpcAssociation#vpc_id}
  */
  readonly vpcId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/express_connect_router_vpc_association#vpc_owner_id ExpressConnectRouterVpcAssociation#vpc_owner_id}
  */
  readonly vpcOwnerId?: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/express_connect_router_vpc_association#timeouts ExpressConnectRouterVpcAssociation#timeouts}
  */
  readonly timeouts?: ExpressConnectRouterVpcAssociationTimeouts;
}
export interface ExpressConnectRouterVpcAssociationTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/express_connect_router_vpc_association#create ExpressConnectRouterVpcAssociation#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/express_connect_router_vpc_association#delete ExpressConnectRouterVpcAssociation#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/express_connect_router_vpc_association#update ExpressConnectRouterVpcAssociation#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/express_connect_router_vpc_association alicloud_express_connect_router_vpc_association}
*/
export class ExpressConnectRouterVpcAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExpressConnectRouterVpcAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/express_connect_router_vpc_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/express_connect_router_vpc_association alicloud_express_connect_router_vpc_association} Resource
  *
  * @param scope The scope in which to define this construct
