// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_instance_member
...
export interface CloudFirewallInstanceMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_instance_member#id CloudFirewallInstanceMember#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_instance_member#member_desc CloudFirewallInstanceMember#member_desc}
  */
  readonly memberDesc?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_instance_member#member_uid CloudFirewallInstanceMember#member_uid}
  */
  readonly memberUid: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_instance_member#timeouts CloudFirewallInstanceMember#timeouts}
  */
  readonly timeouts?: CloudFirewallInstanceMemberTimeouts;
}
export interface CloudFirewallInstanceMemberTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_instance_member#create CloudFirewallInstanceMember#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_instance_member#delete CloudFirewallInstanceMember#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_instance_member alicloud_cloud_firewall_instance_member}
*/
export class CloudFirewallInstanceMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudFirewallInstanceMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_instance_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cloud_firewall_instance_member alicloud_cloud_firewall_instance_member} Resource
  *
  * @param scope The scope in which to define this construct
