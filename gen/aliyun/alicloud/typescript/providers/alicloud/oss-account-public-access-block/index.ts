// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/oss_account_public_access_block
...
export interface OssAccountPublicAccessBlockConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/oss_account_public_access_block#block_public_access OssAccountPublicAccessBlock#block_public_access}
  */
  readonly blockPublicAccess: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/oss_account_public_access_block#id OssAccountPublicAccessBlock#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/oss_account_public_access_block#timeouts OssAccountPublicAccessBlock#timeouts}
  */
  readonly timeouts?: OssAccountPublicAccessBlockTimeouts;
}
export interface OssAccountPublicAccessBlockTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/oss_account_public_access_block#create OssAccountPublicAccessBlock#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/oss_account_public_access_block#delete OssAccountPublicAccessBlock#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/oss_account_public_access_block#update OssAccountPublicAccessBlock#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/oss_account_public_access_block alicloud_oss_account_public_access_block}
*/
export class OssAccountPublicAccessBlock extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OssAccountPublicAccessBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/oss_account_public_access_block#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/oss_account_public_access_block alicloud_oss_account_public_access_block} Resource
  *
  * @param scope The scope in which to define this construct
