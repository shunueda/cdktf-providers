// https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/imp_app_template
...
export interface ImpAppTemplateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/imp_app_template#app_template_name ImpAppTemplate#app_template_name}
  */
  readonly appTemplateName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/imp_app_template#component_list ImpAppTemplate#component_list}
  */
  readonly componentList: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/imp_app_template#id ImpAppTemplate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/imp_app_template#integration_mode ImpAppTemplate#integration_mode}
  */
  readonly integrationMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/imp_app_template#scene ImpAppTemplate#scene}
  */
  readonly scene?: string;
  /**
  * config_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/imp_app_template#config_list ImpAppTemplate#config_list}
  */
  readonly configList?: ImpAppTemplateConfigListStruct[] | cdktf.IResolvable;
}
export interface ImpAppTemplateConfigListStruct {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/imp_app_template#key ImpAppTemplate#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/imp_app_template#value ImpAppTemplate#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/imp_app_template alicloud_imp_app_template}
*/
export class ImpAppTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImpAppTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/imp_app_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/imp_app_template alicloud_imp_app_template} Resource
  *
  * @param scope The scope in which to define this construct
