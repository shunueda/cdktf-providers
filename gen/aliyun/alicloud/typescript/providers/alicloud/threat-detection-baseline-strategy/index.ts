// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_baseline_strategy
...
export interface ThreatDetectionBaselineStrategyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_baseline_strategy#baseline_strategy_name ThreatDetectionBaselineStrategy#baseline_strategy_name}
  */
  readonly baselineStrategyName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_baseline_strategy#custom_type ThreatDetectionBaselineStrategy#custom_type}
  */
  readonly customType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_baseline_strategy#cycle_days ThreatDetectionBaselineStrategy#cycle_days}
  */
  readonly cycleDays: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_baseline_strategy#cycle_start_time ThreatDetectionBaselineStrategy#cycle_start_time}
  */
  readonly cycleStartTime?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_baseline_strategy#end_time ThreatDetectionBaselineStrategy#end_time}
  */
  readonly endTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_baseline_strategy#id ThreatDetectionBaselineStrategy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_baseline_strategy#risk_sub_type_name ThreatDetectionBaselineStrategy#risk_sub_type_name}
  */
  readonly riskSubTypeName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_baseline_strategy#start_time ThreatDetectionBaselineStrategy#start_time}
  */
  readonly startTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_baseline_strategy#target_type ThreatDetectionBaselineStrategy#target_type}
  */
  readonly targetType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_baseline_strategy alicloud_threat_detection_baseline_strategy}
*/
export class ThreatDetectionBaselineStrategy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ThreatDetectionBaselineStrategy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_baseline_strategy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/threat_detection_baseline_strategy alicloud_threat_detection_baseline_strategy} Resource
  *
  * @param scope The scope in which to define this construct
