// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ecd_network_package
...
export interface EcdNetworkPackageConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ecd_network_package#bandwidth EcdNetworkPackage#bandwidth}
  */
  readonly bandwidth: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ecd_network_package#id EcdNetworkPackage#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ecd_network_package#office_site_id EcdNetworkPackage#office_site_id}
  */
  readonly officeSiteId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ecd_network_package alicloud_ecd_network_package}
*/
export class EcdNetworkPackage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcdNetworkPackage that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ecd_network_package#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ecd_network_package alicloud_ecd_network_package} Resource
  *
  * @param scope The scope in which to define this construct
