// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_storage_gateway_express_sync
...
export interface CloudStorageGatewayExpressSyncConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_storage_gateway_express_sync#bucket_name CloudStorageGatewayExpressSync#bucket_name}
  */
  readonly bucketName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_storage_gateway_express_sync#bucket_prefix CloudStorageGatewayExpressSync#bucket_prefix}
  */
  readonly bucketPrefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_storage_gateway_express_sync#bucket_region CloudStorageGatewayExpressSync#bucket_region}
  */
  readonly bucketRegion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_storage_gateway_express_sync#description CloudStorageGatewayExpressSync#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_storage_gateway_express_sync#express_sync_name CloudStorageGatewayExpressSync#express_sync_name}
  */
  readonly expressSyncName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_storage_gateway_express_sync#id CloudStorageGatewayExpressSync#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_storage_gateway_express_sync#timeouts CloudStorageGatewayExpressSync#timeouts}
  */
  readonly timeouts?: CloudStorageGatewayExpressSyncTimeouts;
}
export interface CloudStorageGatewayExpressSyncTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_storage_gateway_express_sync#delete CloudStorageGatewayExpressSync#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_storage_gateway_express_sync alicloud_cloud_storage_gateway_express_sync}
*/
export class CloudStorageGatewayExpressSync extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudStorageGatewayExpressSync that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_storage_gateway_express_sync#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cloud_storage_gateway_express_sync alicloud_cloud_storage_gateway_express_sync} Resource
  *
  * @param scope The scope in which to define this construct
