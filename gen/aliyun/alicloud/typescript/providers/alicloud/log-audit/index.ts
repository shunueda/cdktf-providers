// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/log_audit
...
export interface LogAuditConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/log_audit#aliuid LogAudit#aliuid}
  */
  readonly aliuid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/log_audit#display_name LogAudit#display_name}
  */
  readonly displayName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/log_audit#id LogAudit#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/log_audit#multi_account LogAudit#multi_account}
  */
  readonly multiAccount?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/log_audit#resource_directory_type LogAudit#resource_directory_type}
  */
  readonly resourceDirectoryType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/log_audit#variable_map LogAudit#variable_map}
  */
  readonly variableMap?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/log_audit alicloud_log_audit}
*/
export class LogAudit extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogAudit that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/log_audit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/log_audit alicloud_log_audit} Resource
  *
  * @param scope The scope in which to define this construct
