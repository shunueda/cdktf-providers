// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/nas_recycle_bin
...
export interface NasRecycleBinConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/nas_recycle_bin#file_system_id NasRecycleBin#file_system_id}
  */
  readonly fileSystemId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/nas_recycle_bin#id NasRecycleBin#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/nas_recycle_bin#reserved_days NasRecycleBin#reserved_days}
  */
  readonly reservedDays?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/nas_recycle_bin alicloud_nas_recycle_bin}
*/
export class NasRecycleBin extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NasRecycleBin that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/nas_recycle_bin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/nas_recycle_bin alicloud_nas_recycle_bin} Resource
  *
  * @param scope The scope in which to define this construct
