// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/oos_service_setting
...
export interface OosServiceSettingConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/oos_service_setting#delivery_oss_bucket_name OosServiceSetting#delivery_oss_bucket_name}
  */
  readonly deliveryOssBucketName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/oos_service_setting#delivery_oss_enabled OosServiceSetting#delivery_oss_enabled}
  */
  readonly deliveryOssEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/oos_service_setting#delivery_oss_key_prefix OosServiceSetting#delivery_oss_key_prefix}
  */
  readonly deliveryOssKeyPrefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/oos_service_setting#delivery_sls_enabled OosServiceSetting#delivery_sls_enabled}
  */
  readonly deliverySlsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/oos_service_setting#delivery_sls_project_name OosServiceSetting#delivery_sls_project_name}
  */
  readonly deliverySlsProjectName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/oos_service_setting#id OosServiceSetting#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/oos_service_setting alicloud_oos_service_setting}
*/
export class OosServiceSetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OosServiceSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/oos_service_setting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/oos_service_setting alicloud_oos_service_setting} Resource
  *
  * @param scope The scope in which to define this construct
