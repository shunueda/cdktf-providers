// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/polardb_account_privilege
...
export interface PolardbAccountPrivilegeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/polardb_account_privilege#account_name PolardbAccountPrivilege#account_name}
  */
  readonly accountName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/polardb_account_privilege#account_privilege PolardbAccountPrivilege#account_privilege}
  */
  readonly accountPrivilege?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/polardb_account_privilege#db_cluster_id PolardbAccountPrivilege#db_cluster_id}
  */
  readonly dbClusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/polardb_account_privilege#db_names PolardbAccountPrivilege#db_names}
  */
  readonly dbNames: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/polardb_account_privilege#id PolardbAccountPrivilege#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/polardb_account_privilege alicloud_polardb_account_privilege}
*/
export class PolardbAccountPrivilege extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolardbAccountPrivilege that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/polardb_account_privilege#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/polardb_account_privilege alicloud_polardb_account_privilege} Resource
  *
  * @param scope The scope in which to define this construct
