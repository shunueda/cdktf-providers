// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ga_access_log
...
export interface GaAccessLogConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ga_access_log#accelerator_id GaAccessLog#accelerator_id}
  */
  readonly acceleratorId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ga_access_log#endpoint_group_id GaAccessLog#endpoint_group_id}
  */
  readonly endpointGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ga_access_log#id GaAccessLog#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ga_access_log#listener_id GaAccessLog#listener_id}
  */
  readonly listenerId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ga_access_log#sls_log_store_name GaAccessLog#sls_log_store_name}
  */
  readonly slsLogStoreName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ga_access_log#sls_project_name GaAccessLog#sls_project_name}
  */
  readonly slsProjectName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ga_access_log#sls_region_id GaAccessLog#sls_region_id}
  */
  readonly slsRegionId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ga_access_log#timeouts GaAccessLog#timeouts}
  */
  readonly timeouts?: GaAccessLogTimeouts;
}
export interface GaAccessLogTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ga_access_log#create GaAccessLog#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ga_access_log#delete GaAccessLog#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ga_access_log alicloud_ga_access_log}
*/
export class GaAccessLog extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GaAccessLog that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ga_access_log#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/ga_access_log alicloud_ga_access_log} Resource
  *
  * @param scope The scope in which to define this construct
