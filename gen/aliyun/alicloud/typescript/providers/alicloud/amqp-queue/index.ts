// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue
...
export interface AmqpQueueConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue#auto_delete_state AmqpQueue#auto_delete_state}
  */
  readonly autoDeleteState?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue#auto_expire_state AmqpQueue#auto_expire_state}
  */
  readonly autoExpireState?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue#dead_letter_exchange AmqpQueue#dead_letter_exchange}
  */
  readonly deadLetterExchange?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue#dead_letter_routing_key AmqpQueue#dead_letter_routing_key}
  */
  readonly deadLetterRoutingKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue#exclusive_state AmqpQueue#exclusive_state}
  */
  readonly exclusiveState?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue#id AmqpQueue#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue#instance_id AmqpQueue#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue#max_length AmqpQueue#max_length}
  */
  readonly maxLength?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue#maximum_priority AmqpQueue#maximum_priority}
  */
  readonly maximumPriority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue#message_ttl AmqpQueue#message_ttl}
  */
  readonly messageTtl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue#queue_name AmqpQueue#queue_name}
  */
  readonly queueName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue#virtual_host_name AmqpQueue#virtual_host_name}
  */
  readonly virtualHostName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue alicloud_amqp_queue}
*/
export class AmqpQueue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AmqpQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/amqp_queue alicloud_amqp_queue} Resource
  *
  * @param scope The scope in which to define this construct
