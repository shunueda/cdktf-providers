// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/dbfs_instance_attachment
...
export interface DbfsInstanceAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/dbfs_instance_attachment#ecs_id DbfsInstanceAttachment#ecs_id}
  */
  readonly ecsId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/dbfs_instance_attachment#id DbfsInstanceAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/dbfs_instance_attachment#instance_id DbfsInstanceAttachment#instance_id}
  */
  readonly instanceId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/dbfs_instance_attachment#timeouts DbfsInstanceAttachment#timeouts}
  */
  readonly timeouts?: DbfsInstanceAttachmentTimeouts;
}
export interface DbfsInstanceAttachmentTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/dbfs_instance_attachment#create DbfsInstanceAttachment#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/dbfs_instance_attachment#delete DbfsInstanceAttachment#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/dbfs_instance_attachment alicloud_dbfs_instance_attachment}
*/
export class DbfsInstanceAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbfsInstanceAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/dbfs_instance_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/dbfs_instance_attachment alicloud_dbfs_instance_attachment} Resource
  *
  * @param scope The scope in which to define this construct
