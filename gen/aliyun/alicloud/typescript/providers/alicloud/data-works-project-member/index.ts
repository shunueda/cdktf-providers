// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/data_works_project_member
...
export interface DataWorksProjectMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/data_works_project_member#id DataWorksProjectMember#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/data_works_project_member#project_id DataWorksProjectMember#project_id}
  */
  readonly projectId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/data_works_project_member#user_id DataWorksProjectMember#user_id}
  */
  readonly userId: string;
  /**
  * roles block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/data_works_project_member#roles DataWorksProjectMember#roles}
  */
  readonly roles?: DataWorksProjectMemberRoles[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/data_works_project_member#timeouts DataWorksProjectMember#timeouts}
  */
  readonly timeouts?: DataWorksProjectMemberTimeouts;
}
export interface DataWorksProjectMemberRoles {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/data_works_project_member#code DataWorksProjectMember#code}
  */
...
export interface DataWorksProjectMemberTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/data_works_project_member#create DataWorksProjectMember#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/data_works_project_member#delete DataWorksProjectMember#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/data_works_project_member#update DataWorksProjectMember#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/data_works_project_member alicloud_data_works_project_member}
*/
export class DataWorksProjectMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataWorksProjectMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/data_works_project_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/data_works_project_member alicloud_data_works_project_member} Resource
  *
  * @param scope The scope in which to define this construct
