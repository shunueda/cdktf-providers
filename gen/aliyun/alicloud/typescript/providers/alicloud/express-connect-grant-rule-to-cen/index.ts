// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_grant_rule_to_cen
...
export interface ExpressConnectGrantRuleToCenConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_grant_rule_to_cen#cen_id ExpressConnectGrantRuleToCen#cen_id}
  */
  readonly cenId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_grant_rule_to_cen#cen_owner_id ExpressConnectGrantRuleToCen#cen_owner_id}
  */
  readonly cenOwnerId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_grant_rule_to_cen#id ExpressConnectGrantRuleToCen#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_grant_rule_to_cen#instance_id ExpressConnectGrantRuleToCen#instance_id}
  */
  readonly instanceId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_grant_rule_to_cen#timeouts ExpressConnectGrantRuleToCen#timeouts}
  */
  readonly timeouts?: ExpressConnectGrantRuleToCenTimeouts;
}
export interface ExpressConnectGrantRuleToCenTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_grant_rule_to_cen#create ExpressConnectGrantRuleToCen#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_grant_rule_to_cen#delete ExpressConnectGrantRuleToCen#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_grant_rule_to_cen alicloud_express_connect_grant_rule_to_cen}
*/
export class ExpressConnectGrantRuleToCen extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExpressConnectGrantRuleToCen that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_grant_rule_to_cen#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_grant_rule_to_cen alicloud_express_connect_grant_rule_to_cen} Resource
  *
  * @param scope The scope in which to define this construct
