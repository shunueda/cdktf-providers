// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/brain_industrial_pid_organization
...
export interface BrainIndustrialPidOrganizationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/brain_industrial_pid_organization#id BrainIndustrialPidOrganization#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/brain_industrial_pid_organization#parent_pid_organization_id BrainIndustrialPidOrganization#parent_pid_organization_id}
  */
  readonly parentPidOrganizationId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/brain_industrial_pid_organization#pid_organization_name BrainIndustrialPidOrganization#pid_organization_name}
  */
  readonly pidOrganizationName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/brain_industrial_pid_organization alicloud_brain_industrial_pid_organization}
*/
export class BrainIndustrialPidOrganization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BrainIndustrialPidOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/brain_industrial_pid_organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/brain_industrial_pid_organization alicloud_brain_industrial_pid_organization} Resource
  *
  * @param scope The scope in which to define this construct
