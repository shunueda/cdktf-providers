// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_router_grant_association
...
export interface ExpressConnectRouterGrantAssociationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_router_grant_association#ecr_id ExpressConnectRouterGrantAssociation#ecr_id}
  */
  readonly ecrId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_router_grant_association#ecr_owner_ali_uid ExpressConnectRouterGrantAssociation#ecr_owner_ali_uid}
  */
  readonly ecrOwnerAliUid: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_router_grant_association#id ExpressConnectRouterGrantAssociation#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_router_grant_association#instance_id ExpressConnectRouterGrantAssociation#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_router_grant_association#instance_region_id ExpressConnectRouterGrantAssociation#instance_region_id}
  */
  readonly instanceRegionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_router_grant_association#instance_type ExpressConnectRouterGrantAssociation#instance_type}
  */
  readonly instanceType: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_router_grant_association#timeouts ExpressConnectRouterGrantAssociation#timeouts}
  */
...
export interface ExpressConnectRouterGrantAssociationTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_router_grant_association#create ExpressConnectRouterGrantAssociation#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_router_grant_association#delete ExpressConnectRouterGrantAssociation#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_router_grant_association alicloud_express_connect_router_grant_association}
*/
export class ExpressConnectRouterGrantAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExpressConnectRouterGrantAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_router_grant_association#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/express_connect_router_grant_association alicloud_express_connect_router_grant_association} Resource
  *
  * @param scope The scope in which to define this construct
