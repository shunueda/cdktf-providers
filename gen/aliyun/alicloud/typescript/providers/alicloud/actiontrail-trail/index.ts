// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail
...
export interface ActiontrailTrailConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#data_event_trail_region ActiontrailTrail#data_event_trail_region}
  */
  readonly dataEventTrailRegion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#event_rw ActiontrailTrail#event_rw}
  */
  readonly eventRw?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#event_selectors ActiontrailTrail#event_selectors}
  */
  readonly eventSelectors?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#id ActiontrailTrail#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#is_organization_trail ActiontrailTrail#is_organization_trail}
  */
  readonly isOrganizationTrail?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#max_compute_project_arn ActiontrailTrail#max_compute_project_arn}
  */
  readonly maxComputeProjectArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#max_compute_write_role_arn ActiontrailTrail#max_compute_write_role_arn}
  */
  readonly maxComputeWriteRoleArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#mns_topic_arn ActiontrailTrail#mns_topic_arn}
  */
  readonly mnsTopicArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#name ActiontrailTrail#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#oss_bucket_name ActiontrailTrail#oss_bucket_name}
  */
  readonly ossBucketName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#oss_key_prefix ActiontrailTrail#oss_key_prefix}
  */
  readonly ossKeyPrefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#oss_write_role_arn ActiontrailTrail#oss_write_role_arn}
  */
  readonly ossWriteRoleArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#role_name ActiontrailTrail#role_name}
  */
  readonly roleName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#sls_project_arn ActiontrailTrail#sls_project_arn}
  */
  readonly slsProjectArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#sls_write_role_arn ActiontrailTrail#sls_write_role_arn}
  */
  readonly slsWriteRoleArn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#status ActiontrailTrail#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#trail_name ActiontrailTrail#trail_name}
  */
  readonly trailName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#trail_region ActiontrailTrail#trail_region}
  */
  readonly trailRegion?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#timeouts ActiontrailTrail#timeouts}
  */
  readonly timeouts?: ActiontrailTrailTimeouts;
}
export interface ActiontrailTrailTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#create ActiontrailTrail#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#delete ActiontrailTrail#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#update ActiontrailTrail#update}
  */
  readonly update?: string;
}

export function actiontrailTrailTimeoutsToTerraform(struct?: ActiontrailTrailTimeouts | cdktf.IResolvable): any {
...
export function actiontrailTrailTimeoutsToHclTerraform(struct?: ActiontrailTrailTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ActiontrailTrailTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ActiontrailTrailTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ActiontrailTrailTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail alicloud_actiontrail_trail}
*/
export class ActiontrailTrail extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alicloud_actiontrail_trail";
  ...
  * @param importFromId The id of the existing ActiontrailTrail that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ActiontrailTrail to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alicloud_actiontrail_trail", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/actiontrail_trail alicloud_actiontrail_trail} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ActiontrailTrailConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ActiontrailTrailConfig = {}) {
    super(scope, id, {
  ...
  private _timeouts = new ActiontrailTrailTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ActiontrailTrailTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: actiontrailTrailTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: actiontrailTrailTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ActiontrailTrailTimeouts",
      },
    };
