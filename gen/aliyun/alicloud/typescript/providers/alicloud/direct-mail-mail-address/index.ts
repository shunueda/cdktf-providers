// https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/direct_mail_mail_address
...
export interface DirectMailMailAddressConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/direct_mail_mail_address#account_name DirectMailMailAddress#account_name}
  */
  readonly accountName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/direct_mail_mail_address#id DirectMailMailAddress#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/direct_mail_mail_address#password DirectMailMailAddress#password}
  */
  readonly password?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/direct_mail_mail_address#reply_address DirectMailMailAddress#reply_address}
  */
  readonly replyAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/direct_mail_mail_address#sendtype DirectMailMailAddress#sendtype}
  */
  readonly sendtype: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/direct_mail_mail_address alicloud_direct_mail_mail_address}
*/
export class DirectMailMailAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DirectMailMailAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/direct_mail_mail_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.265.0/docs/resources/direct_mail_mail_address alicloud_direct_mail_mail_address} Resource
  *
  * @param scope The scope in which to define this construct
