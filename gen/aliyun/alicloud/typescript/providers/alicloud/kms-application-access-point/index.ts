// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/kms_application_access_point
...
export interface KmsApplicationAccessPointConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/kms_application_access_point#application_access_point_name KmsApplicationAccessPoint#application_access_point_name}
  */
  readonly applicationAccessPointName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/kms_application_access_point#description KmsApplicationAccessPoint#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/kms_application_access_point#id KmsApplicationAccessPoint#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/kms_application_access_point#policies KmsApplicationAccessPoint#policies}
  */
  readonly policies: string[];
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/kms_application_access_point#timeouts KmsApplicationAccessPoint#timeouts}
  */
  readonly timeouts?: KmsApplicationAccessPointTimeouts;
}
export interface KmsApplicationAccessPointTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/kms_application_access_point#create KmsApplicationAccessPoint#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/kms_application_access_point#delete KmsApplicationAccessPoint#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/kms_application_access_point#update KmsApplicationAccessPoint#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/kms_application_access_point alicloud_kms_application_access_point}
*/
export class KmsApplicationAccessPoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsApplicationAccessPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/kms_application_access_point#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/kms_application_access_point alicloud_kms_application_access_point} Resource
  *
  * @param scope The scope in which to define this construct
