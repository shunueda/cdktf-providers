// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault
...
export interface HbrReplicationVaultConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault#description HbrReplicationVault#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault#encrypt_type HbrReplicationVault#encrypt_type}
  */
  readonly encryptType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault#id HbrReplicationVault#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault#kms_key_id HbrReplicationVault#kms_key_id}
  */
  readonly kmsKeyId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault#replication_source_region_id HbrReplicationVault#replication_source_region_id}
  */
  readonly replicationSourceRegionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault#replication_source_vault_id HbrReplicationVault#replication_source_vault_id}
  */
  readonly replicationSourceVaultId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault#vault_name HbrReplicationVault#vault_name}
  */
  readonly vaultName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault#vault_storage_class HbrReplicationVault#vault_storage_class}
  */
  readonly vaultStorageClass?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault#timeouts HbrReplicationVault#timeouts}
  */
  readonly timeouts?: HbrReplicationVaultTimeouts;
}
export interface HbrReplicationVaultTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault#create HbrReplicationVault#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault#delete HbrReplicationVault#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault#update HbrReplicationVault#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault alicloud_hbr_replication_vault}
*/
export class HbrReplicationVault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HbrReplicationVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/hbr_replication_vault alicloud_hbr_replication_vault} Resource
  *
  * @param scope The scope in which to define this construct
