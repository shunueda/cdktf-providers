// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dbfs_service_linked_role
...
export interface DbfsServiceLinkedRoleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dbfs_service_linked_role#id DbfsServiceLinkedRole#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dbfs_service_linked_role#product_name DbfsServiceLinkedRole#product_name}
  */
  readonly productName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dbfs_service_linked_role alicloud_dbfs_service_linked_role}
*/
export class DbfsServiceLinkedRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbfsServiceLinkedRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dbfs_service_linked_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dbfs_service_linked_role alicloud_dbfs_service_linked_role} Resource
  *
  * @param scope The scope in which to define this construct
