// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_instance_attachment
...
export interface CenInstanceAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_instance_attachment#cen_owner_id CenInstanceAttachment#cen_owner_id}
  */
  readonly cenOwnerId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_instance_attachment#child_instance_id CenInstanceAttachment#child_instance_id}
  */
  readonly childInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_instance_attachment#child_instance_owner_id CenInstanceAttachment#child_instance_owner_id}
  */
  readonly childInstanceOwnerId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_instance_attachment#child_instance_region_id CenInstanceAttachment#child_instance_region_id}
  */
  readonly childInstanceRegionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_instance_attachment#child_instance_type CenInstanceAttachment#child_instance_type}
  */
  readonly childInstanceType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_instance_attachment#id CenInstanceAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_instance_attachment#instance_id CenInstanceAttachment#instance_id}
  */
  readonly instanceId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_instance_attachment#timeouts CenInstanceAttachment#timeouts}
  */
  readonly timeouts?: CenInstanceAttachmentTimeouts;
}
export interface CenInstanceAttachmentTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_instance_attachment#create CenInstanceAttachment#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_instance_attachment#delete CenInstanceAttachment#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_instance_attachment alicloud_cen_instance_attachment}
*/
export class CenInstanceAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CenInstanceAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_instance_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cen_instance_attachment alicloud_cen_instance_attachment} Resource
  *
  * @param scope The scope in which to define this construct
