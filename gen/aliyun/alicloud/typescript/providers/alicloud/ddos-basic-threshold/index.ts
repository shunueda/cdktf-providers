// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ddos_basic_threshold
...
export interface DdosBasicThresholdConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ddos_basic_threshold#bps DdosBasicThreshold#bps}
  */
  readonly bps: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ddos_basic_threshold#id DdosBasicThreshold#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ddos_basic_threshold#instance_id DdosBasicThreshold#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ddos_basic_threshold#instance_type DdosBasicThreshold#instance_type}
  */
  readonly instanceType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ddos_basic_threshold#internet_ip DdosBasicThreshold#internet_ip}
  */
  readonly internetIp: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ddos_basic_threshold#pps DdosBasicThreshold#pps}
  */
  readonly pps: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ddos_basic_threshold#timeouts DdosBasicThreshold#timeouts}
  */
  readonly timeouts?: DdosBasicThresholdTimeouts;
}
export interface DdosBasicThresholdTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ddos_basic_threshold#create DdosBasicThreshold#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ddos_basic_threshold#update DdosBasicThreshold#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ddos_basic_threshold alicloud_ddos_basic_threshold}
*/
export class DdosBasicThreshold extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DdosBasicThreshold that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ddos_basic_threshold#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/ddos_basic_threshold alicloud_ddos_basic_threshold} Resource
  *
  * @param scope The scope in which to define this construct
