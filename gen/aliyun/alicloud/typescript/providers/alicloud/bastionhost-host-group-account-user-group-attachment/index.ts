// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_group_attachment
...
export interface BastionhostHostGroupAccountUserGroupAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_group_attachment#host_account_names BastionhostHostGroupAccountUserGroupAttachment#host_account_names}
  */
  readonly hostAccountNames: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_group_attachment#host_group_id BastionhostHostGroupAccountUserGroupAttachment#host_group_id}
  */
  readonly hostGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_group_attachment#id BastionhostHostGroupAccountUserGroupAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_group_attachment#instance_id BastionhostHostGroupAccountUserGroupAttachment#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_group_attachment#user_group_id BastionhostHostGroupAccountUserGroupAttachment#user_group_id}
  */
  readonly userGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_group_attachment alicloud_bastionhost_host_group_account_user_group_attachment}
*/
export class BastionhostHostGroupAccountUserGroupAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BastionhostHostGroupAccountUserGroupAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_group_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host_group_account_user_group_attachment alicloud_bastionhost_host_group_account_user_group_attachment} Resource
  *
  * @param scope The scope in which to define this construct
