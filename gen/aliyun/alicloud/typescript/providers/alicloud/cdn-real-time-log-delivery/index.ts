// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cdn_real_time_log_delivery
...
export interface CdnRealTimeLogDeliveryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cdn_real_time_log_delivery#domain CdnRealTimeLogDelivery#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cdn_real_time_log_delivery#id CdnRealTimeLogDelivery#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cdn_real_time_log_delivery#logstore CdnRealTimeLogDelivery#logstore}
  */
  readonly logstore: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cdn_real_time_log_delivery#project CdnRealTimeLogDelivery#project}
  */
  readonly project: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cdn_real_time_log_delivery#sls_region CdnRealTimeLogDelivery#sls_region}
  */
  readonly slsRegion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cdn_real_time_log_delivery#status CdnRealTimeLogDelivery#status}
  */
  readonly status?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cdn_real_time_log_delivery#timeouts CdnRealTimeLogDelivery#timeouts}
  */
  readonly timeouts?: CdnRealTimeLogDeliveryTimeouts;
}
export interface CdnRealTimeLogDeliveryTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cdn_real_time_log_delivery#create CdnRealTimeLogDelivery#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cdn_real_time_log_delivery#delete CdnRealTimeLogDelivery#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cdn_real_time_log_delivery#update CdnRealTimeLogDelivery#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cdn_real_time_log_delivery alicloud_cdn_real_time_log_delivery}
*/
export class CdnRealTimeLogDelivery extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnRealTimeLogDelivery that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cdn_real_time_log_delivery#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/cdn_real_time_log_delivery alicloud_cdn_real_time_log_delivery} Resource
  *
  * @param scope The scope in which to define this construct
