// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/esa_origin_protection
...
export interface EsaOriginProtectionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/esa_origin_protection#id EsaOriginProtection#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/esa_origin_protection#origin_converge EsaOriginProtection#origin_converge}
  */
  readonly originConverge?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/esa_origin_protection#site_id EsaOriginProtection#site_id}
  */
  readonly siteId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/esa_origin_protection#timeouts EsaOriginProtection#timeouts}
  */
  readonly timeouts?: EsaOriginProtectionTimeouts;
}
export interface EsaOriginProtectionTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/esa_origin_protection#create EsaOriginProtection#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/esa_origin_protection#delete EsaOriginProtection#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/esa_origin_protection#update EsaOriginProtection#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/esa_origin_protection alicloud_esa_origin_protection}
*/
export class EsaOriginProtection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EsaOriginProtection that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/esa_origin_protection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/esa_origin_protection alicloud_esa_origin_protection} Resource
  *
  * @param scope The scope in which to define this construct
