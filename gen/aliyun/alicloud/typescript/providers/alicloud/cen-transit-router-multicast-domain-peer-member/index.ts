// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_transit_router_multicast_domain_peer_member
...
export interface CenTransitRouterMulticastDomainPeerMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_transit_router_multicast_domain_peer_member#dry_run CenTransitRouterMulticastDomainPeerMember#dry_run}
  */
  readonly dryRun?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_transit_router_multicast_domain_peer_member#group_ip_address CenTransitRouterMulticastDomainPeerMember#group_ip_address}
  */
  readonly groupIpAddress: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_transit_router_multicast_domain_peer_member#id CenTransitRouterMulticastDomainPeerMember#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_transit_router_multicast_domain_peer_member#peer_transit_router_multicast_domain_id CenTransitRouterMulticastDomainPeerMember#peer_transit_router_multicast_domain_id}
  */
  readonly peerTransitRouterMulticastDomainId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_transit_router_multicast_domain_peer_member#transit_router_multicast_domain_id CenTransitRouterMulticastDomainPeerMember#transit_router_multicast_domain_id}
  */
  readonly transitRouterMulticastDomainId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_transit_router_multicast_domain_peer_member#timeouts CenTransitRouterMulticastDomainPeerMember#timeouts}
  */
...
export interface CenTransitRouterMulticastDomainPeerMemberTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_transit_router_multicast_domain_peer_member#create CenTransitRouterMulticastDomainPeerMember#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_transit_router_multicast_domain_peer_member#delete CenTransitRouterMulticastDomainPeerMember#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_transit_router_multicast_domain_peer_member alicloud_cen_transit_router_multicast_domain_peer_member}
*/
export class CenTransitRouterMulticastDomainPeerMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CenTransitRouterMulticastDomainPeerMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_transit_router_multicast_domain_peer_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/cen_transit_router_multicast_domain_peer_member alicloud_cen_transit_router_multicast_domain_peer_member} Resource
  *
  * @param scope The scope in which to define this construct
