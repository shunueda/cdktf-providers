// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/msc_sub_webhook
...
export interface MscSubWebhookConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/msc_sub_webhook#id MscSubWebhook#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/msc_sub_webhook#server_url MscSubWebhook#server_url}
  */
  readonly serverUrl: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/msc_sub_webhook#webhook_name MscSubWebhook#webhook_name}
  */
  readonly webhookName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/msc_sub_webhook alicloud_msc_sub_webhook}
*/
export class MscSubWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MscSubWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/msc_sub_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/msc_sub_webhook alicloud_msc_sub_webhook} Resource
  *
  * @param scope The scope in which to define this construct
