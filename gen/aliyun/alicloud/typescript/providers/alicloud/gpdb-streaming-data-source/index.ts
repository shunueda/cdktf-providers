// https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source
...
export interface GpdbStreamingDataSourceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source#data_source_config GpdbStreamingDataSource#data_source_config}
  */
  readonly dataSourceConfig: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source#data_source_description GpdbStreamingDataSource#data_source_description}
  */
  readonly dataSourceDescription?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source#data_source_name GpdbStreamingDataSource#data_source_name}
  */
  readonly dataSourceName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source#data_source_type GpdbStreamingDataSource#data_source_type}
  */
  readonly dataSourceType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source#db_instance_id GpdbStreamingDataSource#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source#id GpdbStreamingDataSource#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source#service_id GpdbStreamingDataSource#service_id}
  */
  readonly serviceId: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source#timeouts GpdbStreamingDataSource#timeouts}
  */
  readonly timeouts?: GpdbStreamingDataSourceTimeouts;
}
export interface GpdbStreamingDataSourceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source#create GpdbStreamingDataSource#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source#delete GpdbStreamingDataSource#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source#update GpdbStreamingDataSource#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source alicloud_gpdb_streaming_data_source}
*/
export class GpdbStreamingDataSource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GpdbStreamingDataSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/gpdb_streaming_data_source alicloud_gpdb_streaming_data_source} Resource
  *
  * @param scope The scope in which to define this construct
