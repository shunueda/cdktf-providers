// https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/msc_sub_subscription
...
export interface MscSubSubscriptionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/msc_sub_subscription#contact_ids MscSubSubscription#contact_ids}
  */
  readonly contactIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/msc_sub_subscription#email_status MscSubSubscription#email_status}
  */
  readonly emailStatus?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/msc_sub_subscription#id MscSubSubscription#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/msc_sub_subscription#item_name MscSubSubscription#item_name}
  */
  readonly itemName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/msc_sub_subscription#pmsg_status MscSubSubscription#pmsg_status}
  */
  readonly pmsgStatus?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/msc_sub_subscription#sms_status MscSubSubscription#sms_status}
  */
  readonly smsStatus?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/msc_sub_subscription#tts_status MscSubSubscription#tts_status}
  */
  readonly ttsStatus?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/msc_sub_subscription#webhook_ids MscSubSubscription#webhook_ids}
  */
  readonly webhookIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/msc_sub_subscription#webhook_status MscSubSubscription#webhook_status}
  */
  readonly webhookStatus?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/msc_sub_subscription alicloud_msc_sub_subscription}
*/
export class MscSubSubscription extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MscSubSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/msc_sub_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.263.0/docs/resources/msc_sub_subscription alicloud_msc_sub_subscription} Resource
  *
  * @param scope The scope in which to define this construct
