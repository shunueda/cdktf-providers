// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool
...
export interface VpcPublicIpAddressPoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool#biz_type VpcPublicIpAddressPool#biz_type}
  */
  readonly bizType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool#description VpcPublicIpAddressPool#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool#id VpcPublicIpAddressPool#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool#isp VpcPublicIpAddressPool#isp}
  */
  readonly isp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool#public_ip_address_pool_name VpcPublicIpAddressPool#public_ip_address_pool_name}
  */
  readonly publicIpAddressPoolName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool#resource_group_id VpcPublicIpAddressPool#resource_group_id}
  */
  readonly resourceGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool#security_protection_types VpcPublicIpAddressPool#security_protection_types}
  */
  readonly securityProtectionTypes?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool#tags VpcPublicIpAddressPool#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool#timeouts VpcPublicIpAddressPool#timeouts}
  */
  readonly timeouts?: VpcPublicIpAddressPoolTimeouts;
}
export interface VpcPublicIpAddressPoolTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool#create VpcPublicIpAddressPool#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool#delete VpcPublicIpAddressPool#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool#update VpcPublicIpAddressPool#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool alicloud_vpc_public_ip_address_pool}
*/
export class VpcPublicIpAddressPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcPublicIpAddressPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/vpc_public_ip_address_pool alicloud_vpc_public_ip_address_pool} Resource
  *
  * @param scope The scope in which to define this construct
