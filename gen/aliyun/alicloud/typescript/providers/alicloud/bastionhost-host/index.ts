// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host
...
export interface BastionhostHostConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host#active_address_type BastionhostHost#active_address_type}
  */
  readonly activeAddressType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host#comment BastionhostHost#comment}
  */
  readonly comment?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host#host_name BastionhostHost#host_name}
  */
  readonly hostName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host#host_private_address BastionhostHost#host_private_address}
  */
  readonly hostPrivateAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host#host_public_address BastionhostHost#host_public_address}
  */
  readonly hostPublicAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host#id BastionhostHost#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host#instance_id BastionhostHost#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host#instance_region_id BastionhostHost#instance_region_id}
  */
  readonly instanceRegionId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host#os_type BastionhostHost#os_type}
  */
  readonly osType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host#source BastionhostHost#source}
  */
  readonly source: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host#source_instance_id BastionhostHost#source_instance_id}
  */
  readonly sourceInstanceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host alicloud_bastionhost_host}
*/
export class BastionhostHost extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BastionhostHost that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/bastionhost_host alicloud_bastionhost_host} Resource
  *
  * @param scope The scope in which to define this construct
