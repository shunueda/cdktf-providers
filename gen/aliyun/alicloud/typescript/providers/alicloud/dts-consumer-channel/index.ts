// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dts_consumer_channel
...
export interface DtsConsumerChannelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dts_consumer_channel#consumer_group_name DtsConsumerChannel#consumer_group_name}
  */
  readonly consumerGroupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dts_consumer_channel#consumer_group_password DtsConsumerChannel#consumer_group_password}
  */
  readonly consumerGroupPassword: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dts_consumer_channel#consumer_group_user_name DtsConsumerChannel#consumer_group_user_name}
  */
  readonly consumerGroupUserName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dts_consumer_channel#dts_instance_id DtsConsumerChannel#dts_instance_id}
  */
  readonly dtsInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dts_consumer_channel#id DtsConsumerChannel#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dts_consumer_channel alicloud_dts_consumer_channel}
*/
export class DtsConsumerChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DtsConsumerChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dts_consumer_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dts_consumer_channel alicloud_dts_consumer_channel} Resource
  *
  * @param scope The scope in which to define this construct
