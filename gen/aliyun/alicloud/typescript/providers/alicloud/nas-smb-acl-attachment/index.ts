// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/nas_smb_acl_attachment
...
export interface NasSmbAclAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/nas_smb_acl_attachment#enable_anonymous_access NasSmbAclAttachment#enable_anonymous_access}
  */
  readonly enableAnonymousAccess?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/nas_smb_acl_attachment#encrypt_data NasSmbAclAttachment#encrypt_data}
  */
  readonly encryptData?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/nas_smb_acl_attachment#file_system_id NasSmbAclAttachment#file_system_id}
  */
  readonly fileSystemId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/nas_smb_acl_attachment#home_dir_path NasSmbAclAttachment#home_dir_path}
  */
  readonly homeDirPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/nas_smb_acl_attachment#id NasSmbAclAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/nas_smb_acl_attachment#keytab NasSmbAclAttachment#keytab}
  */
  readonly keytab: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/nas_smb_acl_attachment#keytab_md5 NasSmbAclAttachment#keytab_md5}
  */
  readonly keytabMd5: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/nas_smb_acl_attachment#reject_unencrypted_access NasSmbAclAttachment#reject_unencrypted_access}
  */
  readonly rejectUnencryptedAccess?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/nas_smb_acl_attachment#super_admin_sid NasSmbAclAttachment#super_admin_sid}
  */
  readonly superAdminSid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/nas_smb_acl_attachment alicloud_nas_smb_acl_attachment}
*/
export class NasSmbAclAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NasSmbAclAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/nas_smb_acl_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/nas_smb_acl_attachment alicloud_nas_smb_acl_attachment} Resource
  *
  * @param scope The scope in which to define this construct
