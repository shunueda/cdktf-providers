// https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dms_enterprise_authority_template
...
export interface DmsEnterpriseAuthorityTemplateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dms_enterprise_authority_template#authority_template_name DmsEnterpriseAuthorityTemplate#authority_template_name}
  */
  readonly authorityTemplateName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dms_enterprise_authority_template#description DmsEnterpriseAuthorityTemplate#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dms_enterprise_authority_template#id DmsEnterpriseAuthorityTemplate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dms_enterprise_authority_template#tid DmsEnterpriseAuthorityTemplate#tid}
  */
  readonly tid: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dms_enterprise_authority_template#timeouts DmsEnterpriseAuthorityTemplate#timeouts}
  */
  readonly timeouts?: DmsEnterpriseAuthorityTemplateTimeouts;
}
export interface DmsEnterpriseAuthorityTemplateTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dms_enterprise_authority_template#create DmsEnterpriseAuthorityTemplate#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dms_enterprise_authority_template#delete DmsEnterpriseAuthorityTemplate#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dms_enterprise_authority_template#update DmsEnterpriseAuthorityTemplate#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dms_enterprise_authority_template alicloud_dms_enterprise_authority_template}
*/
export class DmsEnterpriseAuthorityTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DmsEnterpriseAuthorityTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dms_enterprise_authority_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.264.0/docs/resources/dms_enterprise_authority_template alicloud_dms_enterprise_authority_template} Resource
  *
  * @param scope The scope in which to define this construct
