// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy
...
export interface GpdbBackupPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy#backup_retention_period GpdbBackupPolicy#backup_retention_period}
  */
  readonly backupRetentionPeriod?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy#db_instance_id GpdbBackupPolicy#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy#enable_recovery_point GpdbBackupPolicy#enable_recovery_point}
  */
  readonly enableRecoveryPoint?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy#id GpdbBackupPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy#preferred_backup_period GpdbBackupPolicy#preferred_backup_period}
  */
  readonly preferredBackupPeriod: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy#preferred_backup_time GpdbBackupPolicy#preferred_backup_time}
  */
  readonly preferredBackupTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy#recovery_point_period GpdbBackupPolicy#recovery_point_period}
  */
  readonly recoveryPointPeriod?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy#timeouts GpdbBackupPolicy#timeouts}
  */
  readonly timeouts?: GpdbBackupPolicyTimeouts;
}
export interface GpdbBackupPolicyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy#create GpdbBackupPolicy#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy#delete GpdbBackupPolicy#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy#update GpdbBackupPolicy#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy alicloud_gpdb_backup_policy}
*/
export class GpdbBackupPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GpdbBackupPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/gpdb_backup_policy alicloud_gpdb_backup_policy} Resource
  *
  * @param scope The scope in which to define this construct
