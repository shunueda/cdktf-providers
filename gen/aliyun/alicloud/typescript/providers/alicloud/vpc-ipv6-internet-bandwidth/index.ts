// https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpc_ipv6_internet_bandwidth
...
export interface VpcIpv6InternetBandwidthConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpc_ipv6_internet_bandwidth#bandwidth VpcIpv6InternetBandwidth#bandwidth}
  */
  readonly bandwidth: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpc_ipv6_internet_bandwidth#id VpcIpv6InternetBandwidth#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpc_ipv6_internet_bandwidth#internet_charge_type VpcIpv6InternetBandwidth#internet_charge_type}
  */
  readonly internetChargeType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpc_ipv6_internet_bandwidth#ipv6_address_id VpcIpv6InternetBandwidth#ipv6_address_id}
  */
  readonly ipv6AddressId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpc_ipv6_internet_bandwidth#ipv6_gateway_id VpcIpv6InternetBandwidth#ipv6_gateway_id}
  */
  readonly ipv6GatewayId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpc_ipv6_internet_bandwidth#timeouts VpcIpv6InternetBandwidth#timeouts}
  */
  readonly timeouts?: VpcIpv6InternetBandwidthTimeouts;
}
export interface VpcIpv6InternetBandwidthTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpc_ipv6_internet_bandwidth#create VpcIpv6InternetBandwidth#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpc_ipv6_internet_bandwidth#delete VpcIpv6InternetBandwidth#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpc_ipv6_internet_bandwidth#update VpcIpv6InternetBandwidth#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpc_ipv6_internet_bandwidth alicloud_vpc_ipv6_internet_bandwidth}
*/
export class VpcIpv6InternetBandwidth extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcIpv6InternetBandwidth that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpc_ipv6_internet_bandwidth#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.262.1/docs/resources/vpc_ipv6_internet_bandwidth alicloud_vpc_ipv6_internet_bandwidth} Resource
  *
  * @param scope The scope in which to define this construct
