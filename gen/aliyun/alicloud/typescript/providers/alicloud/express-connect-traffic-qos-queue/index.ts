// https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_traffic_qos_queue
...
export interface ExpressConnectTrafficQosQueueConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_traffic_qos_queue#bandwidth_percent ExpressConnectTrafficQosQueue#bandwidth_percent}
  */
  readonly bandwidthPercent?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_traffic_qos_queue#id ExpressConnectTrafficQosQueue#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_traffic_qos_queue#qos_id ExpressConnectTrafficQosQueue#qos_id}
  */
  readonly qosId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_traffic_qos_queue#queue_description ExpressConnectTrafficQosQueue#queue_description}
  */
  readonly queueDescription?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_traffic_qos_queue#queue_name ExpressConnectTrafficQosQueue#queue_name}
  */
  readonly queueName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_traffic_qos_queue#queue_type ExpressConnectTrafficQosQueue#queue_type}
  */
  readonly queueType: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_traffic_qos_queue#timeouts ExpressConnectTrafficQosQueue#timeouts}
  */
  readonly timeouts?: ExpressConnectTrafficQosQueueTimeouts;
}
export interface ExpressConnectTrafficQosQueueTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_traffic_qos_queue#create ExpressConnectTrafficQosQueue#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_traffic_qos_queue#delete ExpressConnectTrafficQosQueue#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_traffic_qos_queue#update ExpressConnectTrafficQosQueue#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_traffic_qos_queue alicloud_express_connect_traffic_qos_queue}
*/
export class ExpressConnectTrafficQosQueue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExpressConnectTrafficQosQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_traffic_qos_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alicloud/1.266.0/docs/resources/express_connect_traffic_qos_queue alicloud_express_connect_traffic_qos_queue} Resource
  *
  * @param scope The scope in which to define this construct
