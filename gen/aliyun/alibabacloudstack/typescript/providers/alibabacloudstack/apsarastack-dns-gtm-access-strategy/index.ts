// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy
...
export interface ApsarastackDnsGtmAccessStrategyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy#default_gtm_address_pool_id ApsarastackDnsGtmAccessStrategy#default_gtm_address_pool_id}
  */
  readonly defaultGtmAddressPoolId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy#default_gtm_address_pool_type ApsarastackDnsGtmAccessStrategy#default_gtm_address_pool_type}
  */
  readonly defaultGtmAddressPoolType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy#default_min_available_addr_num ApsarastackDnsGtmAccessStrategy#default_min_available_addr_num}
  */
  readonly defaultMinAvailableAddrNum: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy#failover_gtm_address_pool_id ApsarastackDnsGtmAccessStrategy#failover_gtm_address_pool_id}
  */
  readonly failoverGtmAddressPoolId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy#failover_gtm_address_pool_type ApsarastackDnsGtmAccessStrategy#failover_gtm_address_pool_type}
  */
  readonly failoverGtmAddressPoolType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy#failover_min_available_addr_num ApsarastackDnsGtmAccessStrategy#failover_min_available_addr_num}
  */
  readonly failoverMinAvailableAddrNum?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy#gtm_instance_id ApsarastackDnsGtmAccessStrategy#gtm_instance_id}
  */
  readonly gtmInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy#line_ids ApsarastackDnsGtmAccessStrategy#line_ids}
  */
  readonly lineIds: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy#name ApsarastackDnsGtmAccessStrategy#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy#specified_gtm_address_pool ApsarastackDnsGtmAccessStrategy#specified_gtm_address_pool}
  */
  readonly specifiedGtmAddressPool?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy#switch_mode ApsarastackDnsGtmAccessStrategy#switch_mode}
  */
  readonly switchMode: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy apsarastack_dns_gtm_access_strategy}
*/
export class ApsarastackDnsGtmAccessStrategy extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_dns_gtm_access_strategy";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a ApsarastackDnsGtmAccessStrategy resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ApsarastackDnsGtmAccessStrategy to import
  * @param importFromId The id of the existing ApsarastackDnsGtmAccessStrategy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ApsarastackDnsGtmAccessStrategy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_dns_gtm_access_strategy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_dns_gtm_access_strategy apsarastack_dns_gtm_access_strategy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ApsarastackDnsGtmAccessStrategyConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackDnsGtmAccessStrategyConfig) {
    super(scope, id, {
      terraformResourceType: 'apsarastack_dns_gtm_access_strategy',
