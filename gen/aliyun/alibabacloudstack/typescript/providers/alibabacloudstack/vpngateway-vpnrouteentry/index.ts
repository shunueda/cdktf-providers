// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/vpngateway_vpnrouteentry
...
export interface VpngatewayVpnrouteentryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/vpngateway_vpnrouteentry#id VpngatewayVpnrouteentry#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/vpngateway_vpnrouteentry#next_hop VpngatewayVpnrouteentry#next_hop}
  */
  readonly nextHop: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/vpngateway_vpnrouteentry#publish_vpc VpngatewayVpnrouteentry#publish_vpc}
  */
  readonly publishVpc: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/vpngateway_vpnrouteentry#route_dest VpngatewayVpnrouteentry#route_dest}
  */
  readonly routeDest: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/vpngateway_vpnrouteentry#vpn_gateway_id VpngatewayVpnrouteentry#vpn_gateway_id}
  */
  readonly vpnGatewayId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/vpngateway_vpnrouteentry#weight VpngatewayVpnrouteentry#weight}
  */
  readonly weight: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/vpngateway_vpnrouteentry alibabacloudstack_vpngateway_vpnrouteentry}
*/
export class VpngatewayVpnrouteentry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpngatewayVpnrouteentry that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/vpngateway_vpnrouteentry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/vpngateway_vpnrouteentry alibabacloudstack_vpngateway_vpnrouteentry} Resource
  *
  * @param scope The scope in which to define this construct
