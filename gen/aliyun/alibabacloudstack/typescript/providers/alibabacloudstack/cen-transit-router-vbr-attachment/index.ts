// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment
...
export interface CenTransitRouterVbrAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment#cen_id CenTransitRouterVbrAttachment#cen_id}
  */
  readonly cenId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment#id CenTransitRouterVbrAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment#route_table_association_enabled CenTransitRouterVbrAttachment#route_table_association_enabled}
  */
  readonly routeTableAssociationEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment#route_table_propagation_enabled CenTransitRouterVbrAttachment#route_table_propagation_enabled}
  */
  readonly routeTablePropagationEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment#transit_router_attachment_description CenTransitRouterVbrAttachment#transit_router_attachment_description}
  */
  readonly transitRouterAttachmentDescription?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment#transit_router_attachment_name CenTransitRouterVbrAttachment#transit_router_attachment_name}
  */
  readonly transitRouterAttachmentName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment#transit_router_id CenTransitRouterVbrAttachment#transit_router_id}
  */
  readonly transitRouterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment#vbr_id CenTransitRouterVbrAttachment#vbr_id}
  */
  readonly vbrId: string;
  /**
  * tags block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment#tags CenTransitRouterVbrAttachment#tags}
  */
  readonly tags?: CenTransitRouterVbrAttachmentTags[] | cdktf.IResolvable;
}
export interface CenTransitRouterVbrAttachmentTags {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment#tag_key CenTransitRouterVbrAttachment#tag_key}
  */
  readonly tagKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment#tag_value CenTransitRouterVbrAttachment#tag_value}
  */
  readonly tagValue?: string;
}

export function cenTransitRouterVbrAttachmentTagsToTerraform(struct?: CenTransitRouterVbrAttachmentTags | cdktf.IResolvable): any {
...
export function cenTransitRouterVbrAttachmentTagsToHclTerraform(struct?: CenTransitRouterVbrAttachmentTags | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CenTransitRouterVbrAttachmentTagsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CenTransitRouterVbrAttachmentTags | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: CenTransitRouterVbrAttachmentTags | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class CenTransitRouterVbrAttachmentTagsList extends cdktf.ComplexList {
  public internalValue? : CenTransitRouterVbrAttachmentTags[] | cdktf.IResolvable
  ...
  */
  public get(index: number): CenTransitRouterVbrAttachmentTagsOutputReference {
    return new CenTransitRouterVbrAttachmentTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment alibabacloudstack_cen_transit_router_vbr_attachment}
*/
export class CenTransitRouterVbrAttachment extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_cen_transit_router_vbr_attachment";
  ...
  * @param importFromId The id of the existing CenTransitRouterVbrAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_cen_transit_router_vbr_attachment", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_vbr_attachment alibabacloudstack_cen_transit_router_vbr_attachment} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: CenTransitRouterVbrAttachmentConfig) {
    super(scope, id, {
      terraformResourceType: 'alibabacloudstack_cen_transit_router_vbr_attachment',
  ...
  private _tags = new CenTransitRouterVbrAttachmentTagsList(this, "tags", true);
  public get tags() {
    return this._tags;
  }
  public putTags(value: CenTransitRouterVbrAttachmentTags[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tags: cdktf.listMapper(cenTransitRouterVbrAttachmentTagsToTerraform, true)(this._tags.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tags: {
        value: cdktf.listMapperHcl(cenTransitRouterVbrAttachmentTagsToHclTerraform, true)(this._tags.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "CenTransitRouterVbrAttachmentTagsList",
      },
    };
