...
export class ApsarastackDmsenterpriseUser extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_dmsenterprise_user";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_dmsenterprise_user", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackDmsenterpriseUserConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackDmsenterpriseUserConfig) {
    super(scope, id, {
