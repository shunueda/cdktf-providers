// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scaling_rule
...
export interface EssScalingRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scaling_rule#adjustment_type EssScalingRule#adjustment_type}
  */
  readonly adjustmentType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scaling_rule#adjustment_value EssScalingRule#adjustment_value}
  */
  readonly adjustmentValue: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scaling_rule#cooldown EssScalingRule#cooldown}
  */
  readonly cooldown?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scaling_rule#id EssScalingRule#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scaling_rule#scaling_group_id EssScalingRule#scaling_group_id}
  */
  readonly scalingGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scaling_rule#scaling_rule_name EssScalingRule#scaling_rule_name}
  */
  readonly scalingRuleName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scaling_rule alibabacloudstack_ess_scaling_rule}
*/
export class EssScalingRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EssScalingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scaling_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scaling_rule alibabacloudstack_ess_scaling_rule} Resource
  *
  * @param scope The scope in which to define this construct
