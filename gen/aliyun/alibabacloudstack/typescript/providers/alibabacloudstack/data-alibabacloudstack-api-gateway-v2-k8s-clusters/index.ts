...
export interface DataAlibabacloudstackApiGatewayV2K8SClustersConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataAlibabacloudstackApiGatewayV2K8SClustersClusters {
}

export function dataAlibabacloudstackApiGatewayV2K8SClustersClustersToTerraform(struct?: DataAlibabacloudstackApiGatewayV2K8SClustersClusters): any {
...
export function dataAlibabacloudstackApiGatewayV2K8SClustersClustersToHclTerraform(struct?: DataAlibabacloudstackApiGatewayV2K8SClustersClusters): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAlibabacloudstackApiGatewayV2K8SClustersClustersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAlibabacloudstackApiGatewayV2K8SClustersClusters | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAlibabacloudstackApiGatewayV2K8SClustersClusters | undefined) {
    if (value === undefined) {
...
export class DataAlibabacloudstackApiGatewayV2K8SClustersClustersList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAlibabacloudstackApiGatewayV2K8SClustersClustersOutputReference {
    return new DataAlibabacloudstackApiGatewayV2K8SClustersClustersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAlibabacloudstackApiGatewayV2K8SClusters extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_api_gateway_v2_k8s_clusters";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_api_gateway_v2_k8s_clusters", importId: importFromId, provider });
      }
  ...
  * @param options DataAlibabacloudstackApiGatewayV2K8SClustersConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAlibabacloudstackApiGatewayV2K8SClustersConfig = {}) {
    super(scope, id, {
  ...
  private _clusters = new DataAlibabacloudstackApiGatewayV2K8SClustersClustersList(this, "clusters", false);
  public get clusters() {
