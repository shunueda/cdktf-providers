// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_backendserver
...
export interface SlbBackendserverConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_backendserver#delete_protection_validation SlbBackendserver#delete_protection_validation}
  */
  readonly deleteProtectionValidation?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_backendserver#id SlbBackendserver#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_backendserver#load_balancer_id SlbBackendserver#load_balancer_id}
  */
  readonly loadBalancerId: string;
  /**
  * backend_servers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_backendserver#backend_servers SlbBackendserver#backend_servers}
  */
  readonly backendServers?: SlbBackendserverBackendServers[] | cdktf.IResolvable;
}
export interface SlbBackendserverBackendServers {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_backendserver#server_id SlbBackendserver#server_id}
  */
  readonly serverId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_backendserver#weight SlbBackendserver#weight}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_backendserver alibabacloudstack_slb_backendserver}
*/
export class SlbBackendserver extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SlbBackendserver that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_backendserver#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_backendserver alibabacloudstack_slb_backendserver} Resource
  *
  * @param scope The scope in which to define this construct
