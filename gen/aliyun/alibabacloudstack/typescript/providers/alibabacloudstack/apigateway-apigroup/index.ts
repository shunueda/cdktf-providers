// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/apigateway_apigroup
...
export interface ApigatewayApigroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/apigateway_apigroup#api_group_name ApigatewayApigroup#api_group_name}
  */
  readonly apiGroupName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/apigateway_apigroup#description ApigatewayApigroup#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/apigateway_apigroup#id ApigatewayApigroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/apigateway_apigroup#name ApigatewayApigroup#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/apigateway_apigroup alibabacloudstack_apigateway_apigroup}
*/
export class ApigatewayApigroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigatewayApigroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/apigateway_apigroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/apigateway_apigroup alibabacloudstack_apigateway_apigroup} Resource
  *
  * @param scope The scope in which to define this construct
