...
export class UniversalDnsLine extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_universal_dns_line";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_universal_dns_line", importId: importFromId, provider });
      }
  ...
  * @param options UniversalDnsLineConfig
  */
  public constructor(scope: Construct, id: string, config: UniversalDnsLineConfig) {
    super(scope, id, {
