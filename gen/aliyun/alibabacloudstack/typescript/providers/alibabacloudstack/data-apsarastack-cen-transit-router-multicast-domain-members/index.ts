...
export interface DataApsarastackCenTransitRouterMulticastDomainMembersTransitRouterMulticastGroups {
}

export function dataApsarastackCenTransitRouterMulticastDomainMembersTransitRouterMulticastGroupsToTerraform(struct?: DataApsarastackCenTransitRouterMulticastDomainMembersTransitRouterMulticastGroups): any {
...
export function dataApsarastackCenTransitRouterMulticastDomainMembersTransitRouterMulticastGroupsToHclTerraform(struct?: DataApsarastackCenTransitRouterMulticastDomainMembersTransitRouterMulticastGroups): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackCenTransitRouterMulticastDomainMembersTransitRouterMulticastGroupsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackCenTransitRouterMulticastDomainMembersTransitRouterMulticastGroups | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackCenTransitRouterMulticastDomainMembersTransitRouterMulticastGroups | undefined) {
    if (value === undefined) {
...
export class DataApsarastackCenTransitRouterMulticastDomainMembersTransitRouterMulticastGroupsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackCenTransitRouterMulticastDomainMembersTransitRouterMulticastGroupsOutputReference {
    return new DataApsarastackCenTransitRouterMulticastDomainMembersTransitRouterMulticastGroupsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackCenTransitRouterMulticastDomainMembers extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_cen_transit_router_multicast_domain_members";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_cen_transit_router_multicast_domain_members", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackCenTransitRouterMulticastDomainMembersConfig
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackCenTransitRouterMulticastDomainMembersConfig) {
    super(scope, id, {
  ...
  private _transitRouterMulticastGroups = new DataApsarastackCenTransitRouterMulticastDomainMembersTransitRouterMulticastGroupsList(this, "transit_router_multicast_groups", false);
