// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_listeners
...
export interface DataAlibabacloudstackSlbListenersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_listeners#description_regex DataAlibabacloudstackSlbListeners#description_regex}
  */
  readonly descriptionRegex?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_listeners#frontend_port DataAlibabacloudstackSlbListeners#frontend_port}
  */
  readonly frontendPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_listeners#id DataAlibabacloudstackSlbListeners#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_listeners#load_balancer_id DataAlibabacloudstackSlbListeners#load_balancer_id}
  */
  readonly loadBalancerId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_listeners#output_file DataAlibabacloudstackSlbListeners#output_file}
  */
  readonly outputFile?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_listeners#protocol DataAlibabacloudstackSlbListeners#protocol}
  */
  readonly protocol?: string;
}
export interface DataAlibabacloudstackSlbListenersSlbListeners {
}

export function dataAlibabacloudstackSlbListenersSlbListenersToTerraform(struct?: DataAlibabacloudstackSlbListenersSlbListeners): any {
...
export function dataAlibabacloudstackSlbListenersSlbListenersToHclTerraform(struct?: DataAlibabacloudstackSlbListenersSlbListeners): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAlibabacloudstackSlbListenersSlbListenersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAlibabacloudstackSlbListenersSlbListeners | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAlibabacloudstackSlbListenersSlbListeners | undefined) {
    if (value === undefined) {
...
export class DataAlibabacloudstackSlbListenersSlbListenersList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAlibabacloudstackSlbListenersSlbListenersOutputReference {
    return new DataAlibabacloudstackSlbListenersSlbListenersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_listeners alibabacloudstack_slb_listeners}
*/
export class DataAlibabacloudstackSlbListeners extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_slb_listeners";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataAlibabacloudstackSlbListeners resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAlibabacloudstackSlbListeners to import
  * @param importFromId The id of the existing DataAlibabacloudstackSlbListeners that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_listeners#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAlibabacloudstackSlbListeners to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_slb_listeners", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_listeners alibabacloudstack_slb_listeners} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAlibabacloudstackSlbListenersConfig
  */
  public constructor(scope: Construct, id: string, config: DataAlibabacloudstackSlbListenersConfig) {
    super(scope, id, {
      terraformResourceType: 'alibabacloudstack_slb_listeners',
  ...
  private _slbListeners = new DataAlibabacloudstackSlbListenersSlbListenersList(this, "slb_listeners", false);
