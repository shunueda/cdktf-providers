// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_multicast_domain_association
...
export interface CenTransitRouterMulticastDomainAssociationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_multicast_domain_association#id CenTransitRouterMulticastDomainAssociation#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_multicast_domain_association#transit_router_attachment_id CenTransitRouterMulticastDomainAssociation#transit_router_attachment_id}
  */
  readonly transitRouterAttachmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_multicast_domain_association#transit_router_multicast_domain_id CenTransitRouterMulticastDomainAssociation#transit_router_multicast_domain_id}
  */
  readonly transitRouterMulticastDomainId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_multicast_domain_association#vswitch_id CenTransitRouterMulticastDomainAssociation#vswitch_id}
  */
  readonly vswitchId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_multicast_domain_association alibabacloudstack_cen_transit_router_multicast_domain_association}
*/
export class CenTransitRouterMulticastDomainAssociation extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/cen_transit_router_multicast_domain_association alibabacloudstack_cen_transit_router_multicast_domain_association} Resource
  *
  * @param scope The scope in which to define this construct
