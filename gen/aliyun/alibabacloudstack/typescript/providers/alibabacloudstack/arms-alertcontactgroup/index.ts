// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/arms_alertcontactgroup
...
export interface ArmsAlertcontactgroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/arms_alertcontactgroup#alert_contact_group_name ArmsAlertcontactgroup#alert_contact_group_name}
  */
  readonly alertContactGroupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/arms_alertcontactgroup#contact_ids ArmsAlertcontactgroup#contact_ids}
  */
  readonly contactIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/arms_alertcontactgroup#id ArmsAlertcontactgroup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/arms_alertcontactgroup alibabacloudstack_arms_alertcontactgroup}
*/
export class ArmsAlertcontactgroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ArmsAlertcontactgroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/arms_alertcontactgroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/arms_alertcontactgroup alibabacloudstack_arms_alertcontactgroup} Resource
  *
  * @param scope The scope in which to define this construct
