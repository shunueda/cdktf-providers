...
export interface ApsarastackApiGatewayV2InstanceAccessMode {
}

export function apsarastackApiGatewayV2InstanceAccessModeToTerraform(struct?: ApsarastackApiGatewayV2InstanceAccessMode): any {
...
export function apsarastackApiGatewayV2InstanceAccessModeToHclTerraform(struct?: ApsarastackApiGatewayV2InstanceAccessMode): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ApsarastackApiGatewayV2InstanceAccessModeOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApsarastackApiGatewayV2InstanceAccessMode | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ApsarastackApiGatewayV2InstanceAccessMode | undefined) {
    if (value === undefined) {
...
export class ApsarastackApiGatewayV2InstanceAccessModeList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): ApsarastackApiGatewayV2InstanceAccessModeOutputReference {
    return new ApsarastackApiGatewayV2InstanceAccessModeOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function apsarastackApiGatewayV2InstanceEdasAppInfosToTerraform(struct?: ApsarastackApiGatewayV2InstanceEdasAppInfos | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function apsarastackApiGatewayV2InstanceEdasAppInfosToHclTerraform(struct?: ApsarastackApiGatewayV2InstanceEdasAppInfos | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ApsarastackApiGatewayV2InstanceEdasAppInfosOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ApsarastackApiGatewayV2InstanceEdasAppInfos | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ApsarastackApiGatewayV2InstanceEdasAppInfos | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class ApsarastackApiGatewayV2InstanceEdasAppInfosList extends cdktf.ComplexList {
  public internalValue? : ApsarastackApiGatewayV2InstanceEdasAppInfos[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): ApsarastackApiGatewayV2InstanceEdasAppInfosOutputReference {
    return new ApsarastackApiGatewayV2InstanceEdasAppInfosOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ApsarastackApiGatewayV2Instance extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_api_gateway_v2_instance";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_api_gateway_v2_instance", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackApiGatewayV2InstanceConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackApiGatewayV2InstanceConfig) {
    super(scope, id, {
  ...
  private _accessMode = new ApsarastackApiGatewayV2InstanceAccessModeList(this, "access_mode", true);
  ...
  private _edasAppInfos = new ApsarastackApiGatewayV2InstanceEdasAppInfosList(this, "edas_app_infos", true);
  public get edasAppInfos() {
    return this._edasAppInfos;
  }
  public putEdasAppInfos(value: ApsarastackApiGatewayV2InstanceEdasAppInfos[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      edas_app_infos: cdktf.listMapper(apsarastackApiGatewayV2InstanceEdasAppInfosToTerraform, true)(this._edasAppInfos.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      edas_app_infos: {
        value: cdktf.listMapperHcl(apsarastackApiGatewayV2InstanceEdasAppInfosToHclTerraform, true)(this._edasAppInfos.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "ApsarastackApiGatewayV2InstanceEdasAppInfosList",
      },
    };
