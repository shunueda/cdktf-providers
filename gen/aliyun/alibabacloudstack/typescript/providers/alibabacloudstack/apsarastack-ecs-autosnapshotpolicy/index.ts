...
export class ApsarastackEcsAutosnapshotpolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_ecs_autosnapshotpolicy";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_ecs_autosnapshotpolicy", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackEcsAutosnapshotpolicyConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackEcsAutosnapshotpolicyConfig) {
    super(scope, id, {
