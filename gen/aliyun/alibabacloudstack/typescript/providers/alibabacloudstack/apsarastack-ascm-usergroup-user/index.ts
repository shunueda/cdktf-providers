// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_usergroup_user
...
export interface ApsarastackAscmUsergroupUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_usergroup_user#id ApsarastackAscmUsergroupUser#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_usergroup_user#login_names ApsarastackAscmUsergroupUser#login_names}
  */
  readonly loginNames?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_usergroup_user#user_group_id ApsarastackAscmUsergroupUser#user_group_id}
  */
  readonly userGroupId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_usergroup_user apsarastack_ascm_usergroup_user}
*/
export class ApsarastackAscmUsergroupUser extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_usergroup_user apsarastack_ascm_usergroup_user} Resource
  *
  * @param scope The scope in which to define this construct
