...
export class ApsarastackSlbDomainExtension extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_slb_domain_extension";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_slb_domain_extension", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackSlbDomainExtensionConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackSlbDomainExtensionConfig) {
    super(scope, id, {
