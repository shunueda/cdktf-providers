// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template
...
export interface EhpcJobTemplateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#array_request EhpcJobTemplate#array_request}
  */
  readonly arrayRequest?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#clock_time EhpcJobTemplate#clock_time}
  */
  readonly clockTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#command_line EhpcJobTemplate#command_line}
  */
  readonly commandLine: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#gpu EhpcJobTemplate#gpu}
  */
  readonly gpu?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#id EhpcJobTemplate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#job_template_name EhpcJobTemplate#job_template_name}
  */
  readonly jobTemplateName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#mem EhpcJobTemplate#mem}
  */
  readonly mem?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#node EhpcJobTemplate#node}
  */
  readonly nodeAttribute?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#package_path EhpcJobTemplate#package_path}
  */
  readonly packagePath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#priority EhpcJobTemplate#priority}
  */
  readonly priority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#queue EhpcJobTemplate#queue}
  */
  readonly queue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#re_runable EhpcJobTemplate#re_runable}
  */
  readonly reRunable?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#runas_user EhpcJobTemplate#runas_user}
  */
  readonly runasUser?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#stderr_redirect_path EhpcJobTemplate#stderr_redirect_path}
  */
  readonly stderrRedirectPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#stdout_redirect_path EhpcJobTemplate#stdout_redirect_path}
  */
  readonly stdoutRedirectPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#task EhpcJobTemplate#task}
  */
  readonly task?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#thread EhpcJobTemplate#thread}
  */
  readonly thread?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#variables EhpcJobTemplate#variables}
  */
  readonly variables?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template alibabacloudstack_ehpc_job_template}
*/
export class EhpcJobTemplate extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_ehpc_job_template";
  ...
  * @param importFromId The id of the existing EhpcJobTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the EhpcJobTemplate to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_ehpc_job_template", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ehpc_job_template alibabacloudstack_ehpc_job_template} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: EhpcJobTemplateConfig) {
    super(scope, id, {
      terraformResourceType: 'alibabacloudstack_ehpc_job_template',
