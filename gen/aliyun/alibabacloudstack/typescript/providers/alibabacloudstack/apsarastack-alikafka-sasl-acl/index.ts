...
export class ApsarastackAlikafkaSaslAcl extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_alikafka_sasl_acl";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_alikafka_sasl_acl", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackAlikafkaSaslAclConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackAlikafkaSaslAclConfig) {
    super(scope, id, {
