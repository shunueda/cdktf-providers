...
export class ApsarastackOtsInstanceattachment extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_ots_instanceattachment";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_ots_instanceattachment", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackOtsInstanceattachmentConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackOtsInstanceattachmentConfig) {
    super(scope, id, {
