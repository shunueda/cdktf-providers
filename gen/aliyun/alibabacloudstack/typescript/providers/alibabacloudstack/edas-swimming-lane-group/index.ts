// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/edas_swimming_lane_group
...
export interface EdasSwimmingLaneGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/edas_swimming_lane_group#apps EdasSwimmingLaneGroup#apps}
  */
  readonly apps: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/edas_swimming_lane_group#entry_app_id EdasSwimmingLaneGroup#entry_app_id}
  */
  readonly entryAppId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/edas_swimming_lane_group#id EdasSwimmingLaneGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/edas_swimming_lane_group#logical_region_id EdasSwimmingLaneGroup#logical_region_id}
  */
  readonly logicalRegionId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/edas_swimming_lane_group#name EdasSwimmingLaneGroup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/edas_swimming_lane_group#strategy_type EdasSwimmingLaneGroup#strategy_type}
  */
  readonly strategyType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/edas_swimming_lane_group alibabacloudstack_edas_swimming_lane_group}
*/
export class EdasSwimmingLaneGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EdasSwimmingLaneGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/edas_swimming_lane_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/edas_swimming_lane_group alibabacloudstack_edas_swimming_lane_group} Resource
  *
  * @param scope The scope in which to define this construct
