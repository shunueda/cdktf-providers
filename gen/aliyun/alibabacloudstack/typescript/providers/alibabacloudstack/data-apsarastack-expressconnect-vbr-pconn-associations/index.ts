...
export interface DataApsarastackExpressconnectVbrPconnAssociationsVbrPconnAssociations {
}

export function dataApsarastackExpressconnectVbrPconnAssociationsVbrPconnAssociationsToTerraform(struct?: DataApsarastackExpressconnectVbrPconnAssociationsVbrPconnAssociations): any {
...
export function dataApsarastackExpressconnectVbrPconnAssociationsVbrPconnAssociationsToHclTerraform(struct?: DataApsarastackExpressconnectVbrPconnAssociationsVbrPconnAssociations): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackExpressconnectVbrPconnAssociationsVbrPconnAssociationsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackExpressconnectVbrPconnAssociationsVbrPconnAssociations | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackExpressconnectVbrPconnAssociationsVbrPconnAssociations | undefined) {
    if (value === undefined) {
...
export class DataApsarastackExpressconnectVbrPconnAssociationsVbrPconnAssociationsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackExpressconnectVbrPconnAssociationsVbrPconnAssociationsOutputReference {
    return new DataApsarastackExpressconnectVbrPconnAssociationsVbrPconnAssociationsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackExpressconnectVbrPconnAssociations extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_expressconnect_vbr_pconn_associations";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_expressconnect_vbr_pconn_associations", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackExpressconnectVbrPconnAssociationsConfig
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackExpressconnectVbrPconnAssociationsConfig) {
    super(scope, id, {
  ...
  private _vbrPconnAssociations = new DataApsarastackExpressconnectVbrPconnAssociationsVbrPconnAssociationsList(this, "vbr_pconn_associations", false);
