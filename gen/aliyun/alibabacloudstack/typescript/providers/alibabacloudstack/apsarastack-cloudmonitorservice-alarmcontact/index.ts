...
export class ApsarastackCloudmonitorserviceAlarmcontact extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_cloudmonitorservice_alarmcontact";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_cloudmonitorservice_alarmcontact", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackCloudmonitorserviceAlarmcontactConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackCloudmonitorserviceAlarmcontactConfig) {
    super(scope, id, {
