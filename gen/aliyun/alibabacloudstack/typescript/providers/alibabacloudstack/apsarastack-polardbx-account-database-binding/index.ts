...
export function apsarastackPolardbxAccountDatabaseBindingDbPrivilegesToTerraform(struct?: ApsarastackPolardbxAccountDatabaseBindingDbPrivileges | cdktf.IResolvable): any {
...
export function apsarastackPolardbxAccountDatabaseBindingDbPrivilegesToHclTerraform(struct?: ApsarastackPolardbxAccountDatabaseBindingDbPrivileges | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ApsarastackPolardbxAccountDatabaseBindingDbPrivilegesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApsarastackPolardbxAccountDatabaseBindingDbPrivileges | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ApsarastackPolardbxAccountDatabaseBindingDbPrivileges | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ApsarastackPolardbxAccountDatabaseBindingDbPrivilegesList extends cdktf.ComplexList {
  public internalValue? : ApsarastackPolardbxAccountDatabaseBindingDbPrivileges[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ApsarastackPolardbxAccountDatabaseBindingDbPrivilegesOutputReference {
    return new ApsarastackPolardbxAccountDatabaseBindingDbPrivilegesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ApsarastackPolardbxAccountDatabaseBinding extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_polardbx_account_database_binding";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_polardbx_account_database_binding", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackPolardbxAccountDatabaseBindingConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackPolardbxAccountDatabaseBindingConfig) {
    super(scope, id, {
  ...
  private _dbPrivileges = new ApsarastackPolardbxAccountDatabaseBindingDbPrivilegesList(this, "db_privileges", true);
  public get dbPrivileges() {
    return this._dbPrivileges;
  }
  public putDbPrivileges(value: ApsarastackPolardbxAccountDatabaseBindingDbPrivileges[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      db_privileges: cdktf.listMapper(apsarastackPolardbxAccountDatabaseBindingDbPrivilegesToTerraform, true)(this._dbPrivileges.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      db_privileges: {
        value: cdktf.listMapperHcl(apsarastackPolardbxAccountDatabaseBindingDbPrivilegesToHclTerraform, true)(this._dbPrivileges.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "ApsarastackPolardbxAccountDatabaseBindingDbPrivilegesList",
      },
    };
