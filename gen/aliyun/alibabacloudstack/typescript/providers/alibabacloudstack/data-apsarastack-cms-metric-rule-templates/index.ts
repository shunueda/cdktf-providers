...
export interface DataApsarastackCmsMetricRuleTemplatesTemplates {
}

export function dataApsarastackCmsMetricRuleTemplatesTemplatesToTerraform(struct?: DataApsarastackCmsMetricRuleTemplatesTemplates): any {
...
export function dataApsarastackCmsMetricRuleTemplatesTemplatesToHclTerraform(struct?: DataApsarastackCmsMetricRuleTemplatesTemplates): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackCmsMetricRuleTemplatesTemplatesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackCmsMetricRuleTemplatesTemplates | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackCmsMetricRuleTemplatesTemplates | undefined) {
    if (value === undefined) {
...
export class DataApsarastackCmsMetricRuleTemplatesTemplatesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackCmsMetricRuleTemplatesTemplatesOutputReference {
    return new DataApsarastackCmsMetricRuleTemplatesTemplatesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackCmsMetricRuleTemplates extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_cms_metric_rule_templates";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_cms_metric_rule_templates", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackCmsMetricRuleTemplatesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackCmsMetricRuleTemplatesConfig = {}) {
    super(scope, id, {
  ...
  private _templates = new DataApsarastackCmsMetricRuleTemplatesTemplatesList(this, "templates", false);
