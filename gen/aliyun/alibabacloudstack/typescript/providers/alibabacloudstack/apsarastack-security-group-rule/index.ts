...
export class ApsarastackSecurityGroupRule extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_security_group_rule";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_security_group_rule", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackSecurityGroupRuleConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackSecurityGroupRuleConfig) {
    super(scope, id, {
