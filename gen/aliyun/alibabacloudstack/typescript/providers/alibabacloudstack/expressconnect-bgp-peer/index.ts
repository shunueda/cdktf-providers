// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_peer
...
export interface ExpressconnectBgpPeerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_peer#auth_key ExpressconnectBgpPeer#auth_key}
  */
  readonly authKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_peer#bfd_multi_hop ExpressconnectBgpPeer#bfd_multi_hop}
  */
  readonly bfdMultiHop?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_peer#bgp_group_id ExpressconnectBgpPeer#bgp_group_id}
  */
  readonly bgpGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_peer#bgp_peer_name ExpressconnectBgpPeer#bgp_peer_name}
  */
  readonly bgpPeerName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_peer#description ExpressconnectBgpPeer#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_peer#enable_bfd ExpressconnectBgpPeer#enable_bfd}
  */
  readonly enableBfd?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_peer#id ExpressconnectBgpPeer#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_peer#peer_ip_address ExpressconnectBgpPeer#peer_ip_address}
  */
  readonly peerIpAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_peer#router_id ExpressconnectBgpPeer#router_id}
  */
  readonly routerId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_peer#status ExpressconnectBgpPeer#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_peer alibabacloudstack_expressconnect_bgp_peer}
*/
export class ExpressconnectBgpPeer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExpressconnectBgpPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_peer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_peer alibabacloudstack_expressconnect_bgp_peer} Resource
  *
  * @param scope The scope in which to define this construct
