...
export class ApsarastackPolardbxBackupPolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_polardbx_backup_policy";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_polardbx_backup_policy", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackPolardbxBackupPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackPolardbxBackupPolicyConfig) {
    super(scope, id, {
