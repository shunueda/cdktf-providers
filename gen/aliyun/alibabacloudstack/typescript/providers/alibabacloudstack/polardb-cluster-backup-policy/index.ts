// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/polardb_cluster_backup_policy
...
export interface PolardbClusterBackupPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/polardb_cluster_backup_policy#data_level1_backup_period PolardbClusterBackupPolicy#data_level1_backup_period}
  */
  readonly dataLevel1BackupPeriod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/polardb_cluster_backup_policy#data_level1_backup_retention_period PolardbClusterBackupPolicy#data_level1_backup_retention_period}
  */
  readonly dataLevel1BackupRetentionPeriod?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/polardb_cluster_backup_policy#data_level1_backup_time PolardbClusterBackupPolicy#data_level1_backup_time}
  */
  readonly dataLevel1BackupTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/polardb_cluster_backup_policy#db_cluster_id PolardbClusterBackupPolicy#db_cluster_id}
  */
  readonly dbClusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/polardb_cluster_backup_policy#id PolardbClusterBackupPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/polardb_cluster_backup_policy#log_backup_retention_period PolardbClusterBackupPolicy#log_backup_retention_period}
  */
  readonly logBackupRetentionPeriod?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/polardb_cluster_backup_policy alibabacloudstack_polardb_cluster_backup_policy}
*/
export class PolardbClusterBackupPolicy extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_polardb_cluster_backup_policy";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a PolardbClusterBackupPolicy resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the PolardbClusterBackupPolicy to import
  * @param importFromId The id of the existing PolardbClusterBackupPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/polardb_cluster_backup_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the PolardbClusterBackupPolicy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_polardb_cluster_backup_policy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/polardb_cluster_backup_policy alibabacloudstack_polardb_cluster_backup_policy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options PolardbClusterBackupPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: PolardbClusterBackupPolicyConfig) {
    super(scope, id, {
      terraformResourceType: 'alibabacloudstack_polardb_cluster_backup_policy',
