// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/slb_masterslaveservergroup
...
export interface SlbMasterslaveservergroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/slb_masterslaveservergroup#delete_protection_validation SlbMasterslaveservergroup#delete_protection_validation}
  */
  readonly deleteProtectionValidation?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/slb_masterslaveservergroup#id SlbMasterslaveservergroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/slb_masterslaveservergroup#load_balancer_id SlbMasterslaveservergroup#load_balancer_id}
  */
  readonly loadBalancerId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/slb_masterslaveservergroup#master_slave_server_group_name SlbMasterslaveservergroup#master_slave_server_group_name}
  */
  readonly masterSlaveServerGroupName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/slb_masterslaveservergroup#name SlbMasterslaveservergroup#name}
  */
  readonly name?: string;
  /**
  * servers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/slb_masterslaveservergroup#servers SlbMasterslaveservergroup#servers}
  */
  readonly servers?: SlbMasterslaveservergroupServers[] | cdktf.IResolvable;
}
export interface SlbMasterslaveservergroupServers {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/slb_masterslaveservergroup#port SlbMasterslaveservergroup#port}
  */
  readonly port: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/slb_masterslaveservergroup#server_id SlbMasterslaveservergroup#server_id}
  */
  readonly serverId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/slb_masterslaveservergroup#server_type SlbMasterslaveservergroup#server_type}
  */
  readonly serverType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/slb_masterslaveservergroup#weight SlbMasterslaveservergroup#weight}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/slb_masterslaveservergroup alibabacloudstack_slb_masterslaveservergroup}
*/
export class SlbMasterslaveservergroup extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_slb_masterslaveservergroup";
  ...
  * @param importFromId The id of the existing SlbMasterslaveservergroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/slb_masterslaveservergroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_slb_masterslaveservergroup", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/slb_masterslaveservergroup alibabacloudstack_slb_masterslaveservergroup} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: SlbMasterslaveservergroupConfig) {
    super(scope, id, {
      terraformResourceType: 'alibabacloudstack_slb_masterslaveservergroup',
