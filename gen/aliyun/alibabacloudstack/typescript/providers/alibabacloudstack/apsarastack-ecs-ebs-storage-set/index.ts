...
export class ApsarastackEcsEbsStorageSet extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_ecs_ebs_storage_set";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_ecs_ebs_storage_set", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackEcsEbsStorageSetConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackEcsEbsStorageSetConfig) {
    super(scope, id, {
