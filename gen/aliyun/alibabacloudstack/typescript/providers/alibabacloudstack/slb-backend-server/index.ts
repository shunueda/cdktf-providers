// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/slb_backend_server
...
export interface SlbBackendServerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/slb_backend_server#delete_protection_validation SlbBackendServer#delete_protection_validation}
  */
  readonly deleteProtectionValidation?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/slb_backend_server#id SlbBackendServer#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/slb_backend_server#load_balancer_id SlbBackendServer#load_balancer_id}
  */
  readonly loadBalancerId: string;
  /**
  * backend_servers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/slb_backend_server#backend_servers SlbBackendServer#backend_servers}
  */
  readonly backendServers?: SlbBackendServerBackendServers[] | cdktf.IResolvable;
}
export interface SlbBackendServerBackendServers {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/slb_backend_server#server_id SlbBackendServer#server_id}
  */
  readonly serverId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/slb_backend_server#weight SlbBackendServer#weight}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/slb_backend_server alibabacloudstack_slb_backend_server}
*/
export class SlbBackendServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SlbBackendServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/slb_backend_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/slb_backend_server alibabacloudstack_slb_backend_server} Resource
  *
  * @param scope The scope in which to define this construct
