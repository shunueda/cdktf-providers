...
export interface DataApsarastackSlbDomainextensionsExtensions {
}

export function dataApsarastackSlbDomainextensionsExtensionsToTerraform(struct?: DataApsarastackSlbDomainextensionsExtensions): any {
...
export function dataApsarastackSlbDomainextensionsExtensionsToHclTerraform(struct?: DataApsarastackSlbDomainextensionsExtensions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackSlbDomainextensionsExtensionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackSlbDomainextensionsExtensions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackSlbDomainextensionsExtensions | undefined) {
    if (value === undefined) {
...
export class DataApsarastackSlbDomainextensionsExtensionsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackSlbDomainextensionsExtensionsOutputReference {
    return new DataApsarastackSlbDomainextensionsExtensionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackSlbDomainextensions extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_slb_domainextensions";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_slb_domainextensions", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackSlbDomainextensionsConfig
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackSlbDomainextensionsConfig) {
    super(scope, id, {
  ...
  private _extensions = new DataApsarastackSlbDomainextensionsExtensionsList(this, "extensions", false);
