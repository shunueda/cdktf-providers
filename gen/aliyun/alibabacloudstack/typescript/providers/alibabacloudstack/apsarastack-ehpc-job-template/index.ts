// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template
...
export interface ApsarastackEhpcJobTemplateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#array_request ApsarastackEhpcJobTemplate#array_request}
  */
  readonly arrayRequest?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#clock_time ApsarastackEhpcJobTemplate#clock_time}
  */
  readonly clockTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#command_line ApsarastackEhpcJobTemplate#command_line}
  */
  readonly commandLine: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#gpu ApsarastackEhpcJobTemplate#gpu}
  */
  readonly gpu?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#id ApsarastackEhpcJobTemplate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#job_template_name ApsarastackEhpcJobTemplate#job_template_name}
  */
  readonly jobTemplateName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#mem ApsarastackEhpcJobTemplate#mem}
  */
  readonly mem?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#node ApsarastackEhpcJobTemplate#node}
  */
  readonly nodeAttribute?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#package_path ApsarastackEhpcJobTemplate#package_path}
  */
  readonly packagePath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#priority ApsarastackEhpcJobTemplate#priority}
  */
  readonly priority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#queue ApsarastackEhpcJobTemplate#queue}
  */
  readonly queue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#re_runable ApsarastackEhpcJobTemplate#re_runable}
  */
  readonly reRunable?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#runas_user ApsarastackEhpcJobTemplate#runas_user}
  */
  readonly runasUser?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#stderr_redirect_path ApsarastackEhpcJobTemplate#stderr_redirect_path}
  */
  readonly stderrRedirectPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#stdout_redirect_path ApsarastackEhpcJobTemplate#stdout_redirect_path}
  */
  readonly stdoutRedirectPath?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#task ApsarastackEhpcJobTemplate#task}
  */
  readonly task?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#thread ApsarastackEhpcJobTemplate#thread}
  */
  readonly thread?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#variables ApsarastackEhpcJobTemplate#variables}
  */
  readonly variables?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template apsarastack_ehpc_job_template}
*/
export class ApsarastackEhpcJobTemplate extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_ehpc_job_template";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a ApsarastackEhpcJobTemplate resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ApsarastackEhpcJobTemplate to import
  * @param importFromId The id of the existing ApsarastackEhpcJobTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ApsarastackEhpcJobTemplate to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_ehpc_job_template", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ehpc_job_template apsarastack_ehpc_job_template} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ApsarastackEhpcJobTemplateConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackEhpcJobTemplateConfig) {
    super(scope, id, {
      terraformResourceType: 'apsarastack_ehpc_job_template',
