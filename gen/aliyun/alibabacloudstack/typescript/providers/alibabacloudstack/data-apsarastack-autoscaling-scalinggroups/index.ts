...
export interface DataApsarastackAutoscalingScalinggroupsGroups {
}

export function dataApsarastackAutoscalingScalinggroupsGroupsToTerraform(struct?: DataApsarastackAutoscalingScalinggroupsGroups): any {
...
export function dataApsarastackAutoscalingScalinggroupsGroupsToHclTerraform(struct?: DataApsarastackAutoscalingScalinggroupsGroups): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackAutoscalingScalinggroupsGroupsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackAutoscalingScalinggroupsGroups | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackAutoscalingScalinggroupsGroups | undefined) {
    if (value === undefined) {
...
export class DataApsarastackAutoscalingScalinggroupsGroupsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackAutoscalingScalinggroupsGroupsOutputReference {
    return new DataApsarastackAutoscalingScalinggroupsGroupsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackAutoscalingScalinggroups extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_autoscaling_scalinggroups";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_autoscaling_scalinggroups", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackAutoscalingScalinggroupsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackAutoscalingScalinggroupsConfig = {}) {
    super(scope, id, {
  ...
  private _groups = new DataApsarastackAutoscalingScalinggroupsGroupsList(this, "groups", false);
  public get groups() {
    return this._groups;
  }
