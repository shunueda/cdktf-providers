...
export interface DataApsarastackCenTransitRouterConnectAttachmentsTransitrouterattachments {
}

export function dataApsarastackCenTransitRouterConnectAttachmentsTransitrouterattachmentsToTerraform(struct?: DataApsarastackCenTransitRouterConnectAttachmentsTransitrouterattachments): any {
...
export function dataApsarastackCenTransitRouterConnectAttachmentsTransitrouterattachmentsToHclTerraform(struct?: DataApsarastackCenTransitRouterConnectAttachmentsTransitrouterattachments): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackCenTransitRouterConnectAttachmentsTransitrouterattachmentsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackCenTransitRouterConnectAttachmentsTransitrouterattachments | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackCenTransitRouterConnectAttachmentsTransitrouterattachments | undefined) {
    if (value === undefined) {
...
export class DataApsarastackCenTransitRouterConnectAttachmentsTransitrouterattachmentsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackCenTransitRouterConnectAttachmentsTransitrouterattachmentsOutputReference {
    return new DataApsarastackCenTransitRouterConnectAttachmentsTransitrouterattachmentsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackCenTransitRouterConnectAttachments extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_cen_transit_router_connect_attachments";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_cen_transit_router_connect_attachments", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackCenTransitRouterConnectAttachmentsConfig
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackCenTransitRouterConnectAttachmentsConfig) {
    super(scope, id, {
  ...
  private _transitrouterattachments = new DataApsarastackCenTransitRouterConnectAttachmentsTransitrouterattachmentsList(this, "transitrouterattachments", true);
