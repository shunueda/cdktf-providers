...
export interface DataApsarastackAscmRegionsByProductRegionListStruct {
}

export function dataApsarastackAscmRegionsByProductRegionListStructToTerraform(struct?: DataApsarastackAscmRegionsByProductRegionListStruct): any {
...
export function dataApsarastackAscmRegionsByProductRegionListStructToHclTerraform(struct?: DataApsarastackAscmRegionsByProductRegionListStruct): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackAscmRegionsByProductRegionListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackAscmRegionsByProductRegionListStruct | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackAscmRegionsByProductRegionListStruct | undefined) {
    if (value === undefined) {
...
export class DataApsarastackAscmRegionsByProductRegionListStructList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackAscmRegionsByProductRegionListStructOutputReference {
    return new DataApsarastackAscmRegionsByProductRegionListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackAscmRegionsByProduct extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_ascm_regions_by_product";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_ascm_regions_by_product", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackAscmRegionsByProductConfig
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackAscmRegionsByProductConfig) {
    super(scope, id, {
  ...
  private _regionList = new DataApsarastackAscmRegionsByProductRegionListStructList(this, "region_list", false);
