// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/router_interface_connection
...
export interface RouterInterfaceConnectionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/router_interface_connection#id RouterInterfaceConnection#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/router_interface_connection#interface_id RouterInterfaceConnection#interface_id}
  */
  readonly interfaceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/router_interface_connection#opposite_interface_id RouterInterfaceConnection#opposite_interface_id}
  */
  readonly oppositeInterfaceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/router_interface_connection#opposite_interface_owner_id RouterInterfaceConnection#opposite_interface_owner_id}
  */
  readonly oppositeInterfaceOwnerId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/router_interface_connection#opposite_router_id RouterInterfaceConnection#opposite_router_id}
  */
  readonly oppositeRouterId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/router_interface_connection#opposite_router_type RouterInterfaceConnection#opposite_router_type}
  */
  readonly oppositeRouterType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/router_interface_connection alibabacloudstack_router_interface_connection}
*/
export class RouterInterfaceConnection extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_router_interface_connection";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_router_interface_connection", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/router_interface_connection alibabacloudstack_router_interface_connection} Resource
  *
  * @param scope The scope in which to define this construct
