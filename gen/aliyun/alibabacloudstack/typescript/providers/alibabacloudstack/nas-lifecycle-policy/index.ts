// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/nas_lifecycle_policy
...
export interface NasLifecyclePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/nas_lifecycle_policy#file_system_id NasLifecyclePolicy#file_system_id}
  */
  readonly fileSystemId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/nas_lifecycle_policy#id NasLifecyclePolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/nas_lifecycle_policy#lifecycle_policy_name NasLifecyclePolicy#lifecycle_policy_name}
  */
  readonly lifecyclePolicyName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/nas_lifecycle_policy#lifecycle_rule_name NasLifecyclePolicy#lifecycle_rule_name}
  */
  readonly lifecycleRuleName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/nas_lifecycle_policy#oss_bucket NasLifecyclePolicy#oss_bucket}
  */
  readonly ossBucket: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/nas_lifecycle_policy#path NasLifecyclePolicy#path}
  */
  readonly path: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/nas_lifecycle_policy#recursive NasLifecyclePolicy#recursive}
  */
  readonly recursive?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/nas_lifecycle_policy#storage_type NasLifecyclePolicy#storage_type}
  */
  readonly storageType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/nas_lifecycle_policy alibabacloudstack_nas_lifecycle_policy}
*/
export class NasLifecyclePolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_nas_lifecycle_policy";
  ...
  * @param importFromId The id of the existing NasLifecyclePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/nas_lifecycle_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the NasLifecyclePolicy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_nas_lifecycle_policy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/nas_lifecycle_policy alibabacloudstack_nas_lifecycle_policy} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: NasLifecyclePolicyConfig) {
    super(scope, id, {
      terraformResourceType: 'alibabacloudstack_nas_lifecycle_policy',
