// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc
...
export interface VpcVpcConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#cidr_block VpcVpc#cidr_block}
  */
  readonly cidrBlock?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#description VpcVpc#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#dry_run VpcVpc#dry_run}
  */
  readonly dryRun?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#enable_ipv6 VpcVpc#enable_ipv6}
  */
  readonly enableIpv6?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#id VpcVpc#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#name VpcVpc#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#resource_group_id VpcVpc#resource_group_id}
  */
  readonly resourceGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#secondary_cidr_blocks VpcVpc#secondary_cidr_blocks}
  */
  readonly secondaryCidrBlocks?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#tags VpcVpc#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#user_cidrs VpcVpc#user_cidrs}
  */
  readonly userCidrs?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#vpc_name VpcVpc#vpc_name}
  */
  readonly vpcName?: string;
  /**
  * ipv6_cidr_blocks block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#ipv6_cidr_blocks VpcVpc#ipv6_cidr_blocks}
  */
  readonly ipv6CidrBlocks?: VpcVpcIpv6CidrBlocks[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#timeouts VpcVpc#timeouts}
  */
  readonly timeouts?: VpcVpcTimeouts;
}
export interface VpcVpcIpv6CidrBlocks {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#ipv6_cidr_block VpcVpc#ipv6_cidr_block}
  */
  readonly ipv6CidrBlock: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#ipv6_isp VpcVpc#ipv6_isp}
  */
  readonly ipv6Isp: string;
}

export function vpcVpcIpv6CidrBlocksToTerraform(struct?: VpcVpcIpv6CidrBlocks | cdktf.IResolvable): any {
...
export function vpcVpcIpv6CidrBlocksToHclTerraform(struct?: VpcVpcIpv6CidrBlocks | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class VpcVpcIpv6CidrBlocksOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): VpcVpcIpv6CidrBlocks | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: VpcVpcIpv6CidrBlocks | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class VpcVpcIpv6CidrBlocksList extends cdktf.ComplexList {
  public internalValue? : VpcVpcIpv6CidrBlocks[] | cdktf.IResolvable
  ...
  */
  public get(index: number): VpcVpcIpv6CidrBlocksOutputReference {
    return new VpcVpcIpv6CidrBlocksOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface VpcVpcTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#create VpcVpc#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#delete VpcVpc#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc alibabacloudstack_vpc_vpc}
*/
export class VpcVpc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcVpc that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/vpc_vpc alibabacloudstack_vpc_vpc} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _ipv6CidrBlocks = new VpcVpcIpv6CidrBlocksList(this, "ipv6_cidr_blocks", true);
  public get ipv6CidrBlocks() {
    return this._ipv6CidrBlocks;
  }
  public putIpv6CidrBlocks(value: VpcVpcIpv6CidrBlocks[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ipv6_cidr_blocks: cdktf.listMapper(vpcVpcIpv6CidrBlocksToTerraform, true)(this._ipv6CidrBlocks.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ipv6_cidr_blocks: {
        value: cdktf.listMapperHcl(vpcVpcIpv6CidrBlocksToHclTerraform, true)(this._ipv6CidrBlocks.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "VpcVpcIpv6CidrBlocksList",
      },
      timeouts: {
