// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_server_certificates
...
export interface DataAlibabacloudstackSlbServerCertificatesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_server_certificates#id DataAlibabacloudstackSlbServerCertificates#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_server_certificates#ids DataAlibabacloudstackSlbServerCertificates#ids}
  */
  readonly ids?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_server_certificates#name_regex DataAlibabacloudstackSlbServerCertificates#name_regex}
  */
  readonly nameRegex?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_server_certificates#output_file DataAlibabacloudstackSlbServerCertificates#output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_server_certificates alibabacloudstack_slb_server_certificates}
*/
export class DataAlibabacloudstackSlbServerCertificates extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_slb_server_certificates";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_slb_server_certificates", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/data-sources/slb_server_certificates alibabacloudstack_slb_server_certificates} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAlibabacloudstackSlbServerCertificatesConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'alibabacloudstack_slb_server_certificates',
