...
export interface DataApsarastackEhpcJobTemplatesTemplates {
}

export function dataApsarastackEhpcJobTemplatesTemplatesToTerraform(struct?: DataApsarastackEhpcJobTemplatesTemplates): any {
...
export function dataApsarastackEhpcJobTemplatesTemplatesToHclTerraform(struct?: DataApsarastackEhpcJobTemplatesTemplates): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackEhpcJobTemplatesTemplatesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackEhpcJobTemplatesTemplates | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackEhpcJobTemplatesTemplates | undefined) {
    if (value === undefined) {
...
export class DataApsarastackEhpcJobTemplatesTemplatesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackEhpcJobTemplatesTemplatesOutputReference {
    return new DataApsarastackEhpcJobTemplatesTemplatesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackEhpcJobTemplates extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_ehpc_job_templates";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_ehpc_job_templates", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackEhpcJobTemplatesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackEhpcJobTemplatesConfig = {}) {
    super(scope, id, {
  ...
  private _templates = new DataApsarastackEhpcJobTemplatesTemplatesList(this, "templates", false);
