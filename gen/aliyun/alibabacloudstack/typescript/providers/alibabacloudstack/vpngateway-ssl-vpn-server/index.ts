// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/vpngateway_ssl_vpn_server
...
export interface VpngatewaySslVpnServerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/vpngateway_ssl_vpn_server#cipher VpngatewaySslVpnServer#cipher}
  */
  readonly cipher?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/vpngateway_ssl_vpn_server#client_ip_pool VpngatewaySslVpnServer#client_ip_pool}
  */
  readonly clientIpPool: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/vpngateway_ssl_vpn_server#compress VpngatewaySslVpnServer#compress}
  */
  readonly compress?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/vpngateway_ssl_vpn_server#id VpngatewaySslVpnServer#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/vpngateway_ssl_vpn_server#local_subnet VpngatewaySslVpnServer#local_subnet}
  */
  readonly localSubnet: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/vpngateway_ssl_vpn_server#port VpngatewaySslVpnServer#port}
  */
  readonly port?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/vpngateway_ssl_vpn_server#proto VpngatewaySslVpnServer#proto}
  */
  readonly proto?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/vpngateway_ssl_vpn_server#ssl_vpn_server_name VpngatewaySslVpnServer#ssl_vpn_server_name}
  */
  readonly sslVpnServerName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/vpngateway_ssl_vpn_server#vpn_gateway_id VpngatewaySslVpnServer#vpn_gateway_id}
  */
  readonly vpnGatewayId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/vpngateway_ssl_vpn_server alibabacloudstack_vpngateway_ssl_vpn_server}
*/
export class VpngatewaySslVpnServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpngatewaySslVpnServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/vpngateway_ssl_vpn_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/vpngateway_ssl_vpn_server alibabacloudstack_vpngateway_ssl_vpn_server} Resource
  *
  * @param scope The scope in which to define this construct
