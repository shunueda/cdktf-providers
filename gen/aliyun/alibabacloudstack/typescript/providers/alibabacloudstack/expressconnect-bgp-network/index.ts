// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_network
...
export interface ExpressconnectBgpNetworkConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_network#dst_cidr_block ExpressconnectBgpNetwork#dst_cidr_block}
  */
  readonly dstCidrBlock: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_network#id ExpressconnectBgpNetwork#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_network#router_id ExpressconnectBgpNetwork#router_id}
  */
  readonly routerId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_network alibabacloudstack_expressconnect_bgp_network}
*/
export class ExpressconnectBgpNetwork extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExpressconnectBgpNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/expressconnect_bgp_network alibabacloudstack_expressconnect_bgp_network} Resource
  *
  * @param scope The scope in which to define this construct
