// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert
...
export interface PrometheusV2AlertConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#id PrometheusV2Alert#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#is_check_all PrometheusV2Alert#is_check_all}
  */
  readonly isCheckAll?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#name PrometheusV2Alert#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#notification PrometheusV2Alert#notification}
  */
  readonly notification: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#notify_group_ids PrometheusV2Alert#notify_group_ids}
  */
  readonly notifyGroupIds?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#notify_interval PrometheusV2Alert#notify_interval}
  */
  readonly notifyInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#notify_recovered PrometheusV2Alert#notify_recovered}
  */
  readonly notifyRecovered?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#notify_types PrometheusV2Alert#notify_types}
  */
  readonly notifyTypes?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#recover_notification PrometheusV2Alert#recover_notification}
  */
  readonly recoverNotification: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#tag_set PrometheusV2Alert#tag_set}
  */
  readonly tagSet?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#trigger_clusters PrometheusV2Alert#trigger_clusters}
  */
  readonly triggerClusters?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#trigger_cron PrometheusV2Alert#trigger_cron}
  */
  readonly triggerCron?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#trigger_period PrometheusV2Alert#trigger_period}
  */
  readonly triggerPeriod: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#trigger_promql PrometheusV2Alert#trigger_promql}
  */
  readonly triggerPromql: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#trigger_severity PrometheusV2Alert#trigger_severity}
  */
  readonly triggerSeverity: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert alibabacloudstack_prometheus_v2_alert}
*/
export class PrometheusV2Alert extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_prometheus_v2_alert";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a PrometheusV2Alert resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the PrometheusV2Alert to import
  * @param importFromId The id of the existing PrometheusV2Alert that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the PrometheusV2Alert to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_prometheus_v2_alert", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/prometheus_v2_alert alibabacloudstack_prometheus_v2_alert} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options PrometheusV2AlertConfig
  */
  public constructor(scope: Construct, id: string, config: PrometheusV2AlertConfig) {
    super(scope, id, {
      terraformResourceType: 'alibabacloudstack_prometheus_v2_alert',
