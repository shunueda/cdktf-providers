...
export function alibabacloudstackProviderEndpointsToTerraform(struct?: AlibabacloudstackProviderEndpoints | cdktf.IResolvable): any {
  ...
  return {
    ...
    csb2: cdktf.stringToTerraform(struct!.csb2),
    ...
    ons_inner: cdktf.stringToTerraform(struct!.onsInner),
    ...
    universaldns: cdktf.stringToTerraform(struct!.universaldns),
...
export function alibabacloudstackProviderEndpointsToHclTerraform(struct?: AlibabacloudstackProviderEndpoints | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    csb2: {
      value: cdktf.stringToHclTerraform(struct!.csb2),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    ...
    ons_inner: {
      value: cdktf.stringToHclTerraform(struct!.onsInner),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    ...
    universaldns: {
      value: cdktf.stringToHclTerraform(struct!.universaldns),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
