...
export function apsarastackEdasK8SServicePortMappingsToTerraform(struct?: ApsarastackEdasK8SServicePortMappings | cdktf.IResolvable): any {
...
export function apsarastackEdasK8SServicePortMappingsToHclTerraform(struct?: ApsarastackEdasK8SServicePortMappings | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ApsarastackEdasK8SServicePortMappingsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApsarastackEdasK8SServicePortMappings | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ApsarastackEdasK8SServicePortMappings | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ApsarastackEdasK8SServicePortMappingsList extends cdktf.ComplexList {
  public internalValue? : ApsarastackEdasK8SServicePortMappings[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ApsarastackEdasK8SServicePortMappingsOutputReference {
    return new ApsarastackEdasK8SServicePortMappingsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ApsarastackEdasK8SService extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_edas_k8s_service";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_edas_k8s_service", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackEdasK8SServiceConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackEdasK8SServiceConfig) {
    super(scope, id, {
  ...
  private _portMappings = new ApsarastackEdasK8SServicePortMappingsList(this, "port_mappings", false);
  public get portMappings() {
    return this._portMappings;
  }
  public putPortMappings(value: ApsarastackEdasK8SServicePortMappings[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      port_mappings: cdktf.listMapper(apsarastackEdasK8SServicePortMappingsToTerraform, true)(this._portMappings.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      port_mappings: {
        value: cdktf.listMapperHcl(apsarastackEdasK8SServicePortMappingsToHclTerraform, true)(this._portMappings.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ApsarastackEdasK8SServicePortMappingsList",
      },
    };
