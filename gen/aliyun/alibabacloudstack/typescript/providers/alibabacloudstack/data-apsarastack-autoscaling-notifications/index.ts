...
export interface DataApsarastackAutoscalingNotificationsNotifications {
}

export function dataApsarastackAutoscalingNotificationsNotificationsToTerraform(struct?: DataApsarastackAutoscalingNotificationsNotifications): any {
...
export function dataApsarastackAutoscalingNotificationsNotificationsToHclTerraform(struct?: DataApsarastackAutoscalingNotificationsNotifications): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackAutoscalingNotificationsNotificationsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackAutoscalingNotificationsNotifications | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackAutoscalingNotificationsNotifications | undefined) {
    if (value === undefined) {
...
export class DataApsarastackAutoscalingNotificationsNotificationsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackAutoscalingNotificationsNotificationsOutputReference {
    return new DataApsarastackAutoscalingNotificationsNotificationsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackAutoscalingNotifications extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_autoscaling_notifications";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_autoscaling_notifications", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackAutoscalingNotificationsConfig
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackAutoscalingNotificationsConfig) {
    super(scope, id, {
  ...
  private _notifications = new DataApsarastackAutoscalingNotificationsNotificationsList(this, "notifications", false);
