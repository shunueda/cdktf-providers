// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/data-sources/apsarastack_polardb_cluster_backup_policies
...
export interface DataApsarastackPolardbClusterBackupPoliciesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/data-sources/apsarastack_polardb_cluster_backup_policies#db_cluster_id DataApsarastackPolardbClusterBackupPolicies#db_cluster_id}
  */
  readonly dbClusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/data-sources/apsarastack_polardb_cluster_backup_policies#id DataApsarastackPolardbClusterBackupPolicies#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/data-sources/apsarastack_polardb_cluster_backup_policies apsarastack_polardb_cluster_backup_policies}
*/
export class DataApsarastackPolardbClusterBackupPolicies extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_polardb_cluster_backup_policies";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataApsarastackPolardbClusterBackupPolicies resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataApsarastackPolardbClusterBackupPolicies to import
  * @param importFromId The id of the existing DataApsarastackPolardbClusterBackupPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/data-sources/apsarastack_polardb_cluster_backup_policies#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataApsarastackPolardbClusterBackupPolicies to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_polardb_cluster_backup_policies", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/data-sources/apsarastack_polardb_cluster_backup_policies apsarastack_polardb_cluster_backup_policies} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataApsarastackPolardbClusterBackupPoliciesConfig
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackPolardbClusterBackupPoliciesConfig) {
    super(scope, id, {
      terraformResourceType: 'apsarastack_polardb_cluster_backup_policies',
