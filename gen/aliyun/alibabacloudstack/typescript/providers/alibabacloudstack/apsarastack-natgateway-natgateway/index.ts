...
export function apsarastackNatgatewayNatgatewayBandwidthPackagesToTerraform(struct?: ApsarastackNatgatewayNatgatewayBandwidthPackages | cdktf.IResolvable): any {
...
export function apsarastackNatgatewayNatgatewayBandwidthPackagesToHclTerraform(struct?: ApsarastackNatgatewayNatgatewayBandwidthPackages | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ApsarastackNatgatewayNatgatewayBandwidthPackagesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApsarastackNatgatewayNatgatewayBandwidthPackages | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ApsarastackNatgatewayNatgatewayBandwidthPackages | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ApsarastackNatgatewayNatgatewayBandwidthPackagesList extends cdktf.ComplexList {
  public internalValue? : ApsarastackNatgatewayNatgatewayBandwidthPackages[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ApsarastackNatgatewayNatgatewayBandwidthPackagesOutputReference {
    return new ApsarastackNatgatewayNatgatewayBandwidthPackagesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ApsarastackNatgatewayNatgateway extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_natgateway_natgateway";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_natgateway_natgateway", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackNatgatewayNatgatewayConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackNatgatewayNatgatewayConfig) {
    super(scope, id, {
  ...
  private _bandwidthPackages = new ApsarastackNatgatewayNatgatewayBandwidthPackagesList(this, "bandwidth_packages", false);
  public get bandwidthPackages() {
    return this._bandwidthPackages;
  }
  public putBandwidthPackages(value: ApsarastackNatgatewayNatgatewayBandwidthPackages[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      bandwidth_packages: cdktf.listMapper(apsarastackNatgatewayNatgatewayBandwidthPackagesToTerraform, true)(this._bandwidthPackages.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      bandwidth_packages: {
        value: cdktf.listMapperHcl(apsarastackNatgatewayNatgatewayBandwidthPackagesToHclTerraform, true)(this._bandwidthPackages.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ApsarastackNatgatewayNatgatewayBandwidthPackagesList",
      },
    };
