...
export interface DataApsarastackAscmPasswordPoliciesPolicies {
}

export function dataApsarastackAscmPasswordPoliciesPoliciesToTerraform(struct?: DataApsarastackAscmPasswordPoliciesPolicies): any {
...
export function dataApsarastackAscmPasswordPoliciesPoliciesToHclTerraform(struct?: DataApsarastackAscmPasswordPoliciesPolicies): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackAscmPasswordPoliciesPoliciesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackAscmPasswordPoliciesPolicies | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackAscmPasswordPoliciesPolicies | undefined) {
    if (value === undefined) {
...
export class DataApsarastackAscmPasswordPoliciesPoliciesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackAscmPasswordPoliciesPoliciesOutputReference {
    return new DataApsarastackAscmPasswordPoliciesPoliciesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackAscmPasswordPolicies extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_ascm_password_policies";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_ascm_password_policies", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackAscmPasswordPoliciesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackAscmPasswordPoliciesConfig = {}) {
    super(scope, id, {
  ...
  private _policies = new DataApsarastackAscmPasswordPoliciesPoliciesList(this, "policies", false);
  public get policies() {
