...
export class ApiGatewayV2CascadeLink extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_api_gateway_v2_cascade_link";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_api_gateway_v2_cascade_link", importId: importFromId, provider });
      }
  ...
  * @param options ApiGatewayV2CascadeLinkConfig
  */
  public constructor(scope: Construct, id: string, config: ApiGatewayV2CascadeLinkConfig) {
    super(scope, id, {
