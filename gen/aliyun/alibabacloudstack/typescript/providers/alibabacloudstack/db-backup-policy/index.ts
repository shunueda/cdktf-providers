// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy
...
export interface DbBackupPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#archive_backup_keep_count DbBackupPolicy#archive_backup_keep_count}
  */
  readonly archiveBackupKeepCount?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#archive_backup_keep_policy DbBackupPolicy#archive_backup_keep_policy}
  */
  readonly archiveBackupKeepPolicy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#archive_backup_retention_period DbBackupPolicy#archive_backup_retention_period}
  */
  readonly archiveBackupRetentionPeriod?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#backup_retention_period DbBackupPolicy#backup_retention_period}
  */
  readonly backupRetentionPeriod?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#compress_type DbBackupPolicy#compress_type}
  */
  readonly compressType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#enable_backup_log DbBackupPolicy#enable_backup_log}
  */
  readonly enableBackupLog?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#high_space_usage_protection DbBackupPolicy#high_space_usage_protection}
  */
  readonly highSpaceUsageProtection?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#id DbBackupPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#instance_id DbBackupPolicy#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#local_log_retention_hours DbBackupPolicy#local_log_retention_hours}
  */
  readonly localLogRetentionHours?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#local_log_retention_space DbBackupPolicy#local_log_retention_space}
  */
  readonly localLogRetentionSpace?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#log_backup_frequency DbBackupPolicy#log_backup_frequency}
  */
  readonly logBackupFrequency?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#log_backup_retention_period DbBackupPolicy#log_backup_retention_period}
  */
  readonly logBackupRetentionPeriod?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#preferred_backup_period DbBackupPolicy#preferred_backup_period}
  */
  readonly preferredBackupPeriod?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#preferred_backup_time DbBackupPolicy#preferred_backup_time}
  */
  readonly preferredBackupTime?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy alibabacloudstack_db_backup_policy}
*/
export class DbBackupPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbBackupPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_backup_policy alibabacloudstack_db_backup_policy} Resource
  *
  * @param scope The scope in which to define this construct
