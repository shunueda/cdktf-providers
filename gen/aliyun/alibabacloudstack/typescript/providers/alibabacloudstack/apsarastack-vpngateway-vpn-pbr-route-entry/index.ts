...
export class ApsarastackVpngatewayVpnPbrRouteEntry extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_vpngateway_vpn_pbr_route_entry";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_vpngateway_vpn_pbr_route_entry", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackVpngatewayVpnPbrRouteEntryConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackVpngatewayVpnPbrRouteEntryConfig) {
    super(scope, id, {
