// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/quick_bi_user_group
...
export interface QuickBiUserGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/quick_bi_user_group#id QuickBiUserGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/quick_bi_user_group#parent_user_group_id QuickBiUserGroup#parent_user_group_id}
  */
  readonly parentUserGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/quick_bi_user_group#user_group_description QuickBiUserGroup#user_group_description}
  */
  readonly userGroupDescription: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/quick_bi_user_group#user_group_id QuickBiUserGroup#user_group_id}
  */
  readonly userGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/quick_bi_user_group#user_group_name QuickBiUserGroup#user_group_name}
  */
  readonly userGroupName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/quick_bi_user_group alibabacloudstack_quick_bi_user_group}
*/
export class QuickBiUserGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuickBiUserGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/quick_bi_user_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/quick_bi_user_group alibabacloudstack_quick_bi_user_group} Resource
  *
  * @param scope The scope in which to define this construct
