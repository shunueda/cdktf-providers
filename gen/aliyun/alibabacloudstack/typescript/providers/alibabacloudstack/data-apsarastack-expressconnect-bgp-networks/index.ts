...
export interface DataApsarastackExpressconnectBgpNetworksBgpNetworks {
}

export function dataApsarastackExpressconnectBgpNetworksBgpNetworksToTerraform(struct?: DataApsarastackExpressconnectBgpNetworksBgpNetworks): any {
...
export function dataApsarastackExpressconnectBgpNetworksBgpNetworksToHclTerraform(struct?: DataApsarastackExpressconnectBgpNetworksBgpNetworks): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackExpressconnectBgpNetworksBgpNetworksOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackExpressconnectBgpNetworksBgpNetworks | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackExpressconnectBgpNetworksBgpNetworks | undefined) {
    if (value === undefined) {
...
export class DataApsarastackExpressconnectBgpNetworksBgpNetworksList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackExpressconnectBgpNetworksBgpNetworksOutputReference {
    return new DataApsarastackExpressconnectBgpNetworksBgpNetworksOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackExpressconnectBgpNetworks extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_expressconnect_bgp_networks";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_expressconnect_bgp_networks", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackExpressconnectBgpNetworksConfig
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackExpressconnectBgpNetworksConfig) {
    super(scope, id, {
  ...
  private _bgpNetworks = new DataApsarastackExpressconnectBgpNetworksBgpNetworksList(this, "bgp_networks", false);
