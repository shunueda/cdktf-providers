...
export class ApsarastackEssScheduledTask extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_ess_scheduled_task";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_ess_scheduled_task", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackEssScheduledTaskConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackEssScheduledTaskConfig) {
    super(scope, id, {
