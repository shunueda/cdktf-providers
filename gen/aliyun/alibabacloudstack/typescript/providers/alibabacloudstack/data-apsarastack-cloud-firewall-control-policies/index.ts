...
export interface DataApsarastackCloudFirewallControlPoliciesPolicies {
}

export function dataApsarastackCloudFirewallControlPoliciesPoliciesToTerraform(struct?: DataApsarastackCloudFirewallControlPoliciesPolicies): any {
...
export function dataApsarastackCloudFirewallControlPoliciesPoliciesToHclTerraform(struct?: DataApsarastackCloudFirewallControlPoliciesPolicies): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackCloudFirewallControlPoliciesPoliciesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackCloudFirewallControlPoliciesPolicies | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackCloudFirewallControlPoliciesPolicies | undefined) {
    if (value === undefined) {
...
export class DataApsarastackCloudFirewallControlPoliciesPoliciesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackCloudFirewallControlPoliciesPoliciesOutputReference {
    return new DataApsarastackCloudFirewallControlPoliciesPoliciesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackCloudFirewallControlPolicies extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_cloud_firewall_control_policies";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_cloud_firewall_control_policies", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackCloudFirewallControlPoliciesConfig
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackCloudFirewallControlPoliciesConfig) {
    super(scope, id, {
  ...
  private _policies = new DataApsarastackCloudFirewallControlPoliciesPoliciesList(this, "policies", false);
  public get policies() {
