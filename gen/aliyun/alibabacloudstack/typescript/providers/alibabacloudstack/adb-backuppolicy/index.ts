// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/adb_backuppolicy
...
export interface AdbBackuppolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/adb_backuppolicy#db_cluster_id AdbBackuppolicy#db_cluster_id}
  */
  readonly dbClusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/adb_backuppolicy#id AdbBackuppolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/adb_backuppolicy#preferred_backup_period AdbBackuppolicy#preferred_backup_period}
  */
  readonly preferredBackupPeriod: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/adb_backuppolicy#preferred_backup_time AdbBackuppolicy#preferred_backup_time}
  */
  readonly preferredBackupTime: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/adb_backuppolicy alibabacloudstack_adb_backuppolicy}
*/
export class AdbBackuppolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdbBackuppolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/adb_backuppolicy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/adb_backuppolicy alibabacloudstack_adb_backuppolicy} Resource
  *
  * @param scope The scope in which to define this construct
