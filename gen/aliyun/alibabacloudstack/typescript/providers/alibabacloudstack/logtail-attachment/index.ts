// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/logtail_attachment
...
export interface LogtailAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/logtail_attachment#id LogtailAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/logtail_attachment#logtail_config_name LogtailAttachment#logtail_config_name}
  */
  readonly logtailConfigName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/logtail_attachment#machine_group_name LogtailAttachment#machine_group_name}
  */
  readonly machineGroupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/logtail_attachment#project LogtailAttachment#project}
  */
  readonly project: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/logtail_attachment alibabacloudstack_logtail_attachment}
*/
export class LogtailAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogtailAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/logtail_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/logtail_attachment alibabacloudstack_logtail_attachment} Resource
  *
  * @param scope The scope in which to define this construct
