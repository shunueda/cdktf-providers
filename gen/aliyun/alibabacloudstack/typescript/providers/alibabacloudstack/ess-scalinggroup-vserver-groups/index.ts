// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scalinggroup_vserver_groups
...
export interface EssScalinggroupVserverGroupsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scalinggroup_vserver_groups#force EssScalinggroupVserverGroups#force}
  */
  readonly force?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scalinggroup_vserver_groups#id EssScalinggroupVserverGroups#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scalinggroup_vserver_groups#scaling_group_id EssScalinggroupVserverGroups#scaling_group_id}
  */
  readonly scalingGroupId: string;
  /**
  * vserver_groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scalinggroup_vserver_groups#vserver_groups EssScalinggroupVserverGroups#vserver_groups}
  */
...
export interface EssScalinggroupVserverGroupsVserverGroupsVserverAttributes {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scalinggroup_vserver_groups#port EssScalinggroupVserverGroups#port}
  */
  readonly port: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scalinggroup_vserver_groups#vserver_group_id EssScalinggroupVserverGroups#vserver_group_id}
  */
  readonly vserverGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scalinggroup_vserver_groups#weight EssScalinggroupVserverGroups#weight}
  */
...
export interface EssScalinggroupVserverGroupsVserverGroups {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scalinggroup_vserver_groups#loadbalancer_id EssScalinggroupVserverGroups#loadbalancer_id}
  */
  readonly loadbalancerId: string;
  /**
  * vserver_attributes block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scalinggroup_vserver_groups#vserver_attributes EssScalinggroupVserverGroups#vserver_attributes}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scalinggroup_vserver_groups alibabacloudstack_ess_scalinggroup_vserver_groups}
*/
export class EssScalinggroupVserverGroups extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_ess_scalinggroup_vserver_groups";
  ...
  * @param importFromId The id of the existing EssScalinggroupVserverGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scalinggroup_vserver_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_ess_scalinggroup_vserver_groups", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/ess_scalinggroup_vserver_groups alibabacloudstack_ess_scalinggroup_vserver_groups} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: EssScalinggroupVserverGroupsConfig) {
    super(scope, id, {
      terraformResourceType: 'alibabacloudstack_ess_scalinggroup_vserver_groups',
