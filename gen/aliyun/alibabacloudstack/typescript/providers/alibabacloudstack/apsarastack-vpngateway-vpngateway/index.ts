...
export class ApsarastackVpngatewayVpngateway extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_vpngateway_vpngateway";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_vpngateway_vpngateway", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackVpngatewayVpngatewayConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackVpngatewayVpngatewayConfig) {
    super(scope, id, {
