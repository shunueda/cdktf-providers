// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy
...
export interface DbProxyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#causal_consist_read DbProxy#causal_consist_read}
  */
  readonly causalConsistRead?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#connection_persist DbProxy#connection_persist}
  */
  readonly connectionPersist?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#db_instance_id DbProxy#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#db_proxy_connect_string DbProxy#db_proxy_connect_string}
  */
  readonly dbProxyConnectString?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#db_proxy_connect_string_port DbProxy#db_proxy_connect_string_port}
  */
  readonly dbProxyConnectStringPort?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#db_proxy_endpoint_aliases DbProxy#db_proxy_endpoint_aliases}
  */
  readonly dbProxyEndpointAliases?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#db_proxy_endpoint_name DbProxy#db_proxy_endpoint_name}
  */
  readonly dbProxyEndpointName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#db_proxy_endpoint_type DbProxy#db_proxy_endpoint_type}
  */
  readonly dbProxyEndpointType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#db_proxy_instance_num DbProxy#db_proxy_instance_num}
  */
  readonly dbProxyInstanceNum?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#db_proxy_instance_status DbProxy#db_proxy_instance_status}
  */
  readonly dbProxyInstanceStatus?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#db_proxy_read_write_mode DbProxy#db_proxy_read_write_mode}
  */
  readonly dbProxyReadWriteMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#effective_specific_time DbProxy#effective_specific_time}
  */
  readonly effectiveSpecificTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#effective_time DbProxy#effective_time}
  */
  readonly effectiveTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#id DbProxy#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#timeouts DbProxy#timeouts}
  */
  readonly timeouts?: DbProxyTimeouts;
}
export interface DbProxyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#create DbProxy#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#delete DbProxy#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#update DbProxy#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy alibabacloudstack_db_proxy}
*/
export class DbProxy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_db_proxy";
  ...
  * @param importFromId The id of the existing DbProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DbProxy to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_db_proxy", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/db_proxy alibabacloudstack_db_proxy} Resource
  *
  * @param scope The scope in which to define this construct
