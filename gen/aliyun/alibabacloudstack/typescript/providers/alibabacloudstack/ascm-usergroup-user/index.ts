// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ascm_usergroup_user
...
export interface AscmUsergroupUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ascm_usergroup_user#id AscmUsergroupUser#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ascm_usergroup_user#login_names AscmUsergroupUser#login_names}
  */
  readonly loginNames?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ascm_usergroup_user#user_group_id AscmUsergroupUser#user_group_id}
  */
  readonly userGroupId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ascm_usergroup_user alibabacloudstack_ascm_usergroup_user}
*/
export class AscmUsergroupUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AscmUsergroupUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ascm_usergroup_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/ascm_usergroup_user alibabacloudstack_ascm_usergroup_user} Resource
  *
  * @param scope The scope in which to define this construct
