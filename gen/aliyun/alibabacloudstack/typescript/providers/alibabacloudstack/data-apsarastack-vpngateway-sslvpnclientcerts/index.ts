// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/data-sources/apsarastack_vpngateway_sslvpnclientcerts
...
export interface DataApsarastackVpngatewaySslvpnclientcertsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/data-sources/apsarastack_vpngateway_sslvpnclientcerts#id DataApsarastackVpngatewaySslvpnclientcerts#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/data-sources/apsarastack_vpngateway_sslvpnclientcerts#ids DataApsarastackVpngatewaySslvpnclientcerts#ids}
  */
  readonly ids?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/data-sources/apsarastack_vpngateway_sslvpnclientcerts#name_regex DataApsarastackVpngatewaySslvpnclientcerts#name_regex}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/data-sources/apsarastack_vpngateway_sslvpnclientcerts apsarastack_vpngateway_sslvpnclientcerts}
*/
export class DataApsarastackVpngatewaySslvpnclientcerts extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_vpngateway_sslvpnclientcerts";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_vpngateway_sslvpnclientcerts", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/data-sources/apsarastack_vpngateway_sslvpnclientcerts apsarastack_vpngateway_sslvpnclientcerts} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackVpngatewaySslvpnclientcertsConfig = {}) {
    super(scope, id, {
      terraformResourceType: 'apsarastack_vpngateway_sslvpnclientcerts',
