...
export function apsarastackVpcIpv6GatewayTimeoutsAToTerraform(struct?: ApsarastackVpcIpv6GatewayTimeoutsA | cdktf.IResolvable): any {
...
export function apsarastackVpcIpv6GatewayTimeoutsAToHclTerraform(struct?: ApsarastackVpcIpv6GatewayTimeoutsA | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ApsarastackVpcIpv6GatewayTimeoutsAOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApsarastackVpcIpv6GatewayTimeoutsA | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ApsarastackVpcIpv6GatewayTimeoutsA | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ApsarastackVpcIpv6GatewayA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_vpc_ipv6gateway";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_vpc_ipv6gateway", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackVpcIpv6GatewayAConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackVpcIpv6GatewayAConfig) {
    super(scope, id, {
  ...
  private _timeouts = new ApsarastackVpcIpv6GatewayTimeoutsAOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ApsarastackVpcIpv6GatewayTimeoutsA) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: apsarastackVpcIpv6GatewayTimeoutsAToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: apsarastackVpcIpv6GatewayTimeoutsAToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ApsarastackVpcIpv6GatewayTimeoutsA",
      },
    };
