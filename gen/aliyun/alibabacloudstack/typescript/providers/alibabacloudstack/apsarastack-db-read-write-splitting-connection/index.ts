...
export class ApsarastackDbReadWriteSplittingConnection extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_db_read_write_splitting_connection";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_db_read_write_splitting_connection", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackDbReadWriteSplittingConnectionConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackDbReadWriteSplittingConnectionConfig) {
    super(scope, id, {
