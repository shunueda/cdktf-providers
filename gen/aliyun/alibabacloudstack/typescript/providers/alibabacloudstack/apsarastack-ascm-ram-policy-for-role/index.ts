...
export class ApsarastackAscmRamPolicyForRole extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_ascm_ram_policy_for_role";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_ascm_ram_policy_for_role", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackAscmRamPolicyForRoleConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackAscmRamPolicyForRoleConfig) {
    super(scope, id, {
