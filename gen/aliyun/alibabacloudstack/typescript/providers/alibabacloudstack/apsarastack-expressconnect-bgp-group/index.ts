...
export function apsarastackExpressconnectBgpGroupTimeoutsToTerraform(struct?: ApsarastackExpressconnectBgpGroupTimeouts | cdktf.IResolvable): any {
...
export function apsarastackExpressconnectBgpGroupTimeoutsToHclTerraform(struct?: ApsarastackExpressconnectBgpGroupTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ApsarastackExpressconnectBgpGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApsarastackExpressconnectBgpGroupTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ApsarastackExpressconnectBgpGroupTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ApsarastackExpressconnectBgpGroup extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_expressconnect_bgp_group";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_expressconnect_bgp_group", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackExpressconnectBgpGroupConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackExpressconnectBgpGroupConfig) {
    super(scope, id, {
  ...
  private _timeouts = new ApsarastackExpressconnectBgpGroupTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ApsarastackExpressconnectBgpGroupTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: apsarastackExpressconnectBgpGroupTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: apsarastackExpressconnectBgpGroupTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ApsarastackExpressconnectBgpGroupTimeouts",
      },
    };
