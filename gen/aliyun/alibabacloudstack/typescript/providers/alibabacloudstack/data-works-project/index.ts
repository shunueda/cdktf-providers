// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/data_works_project
...
export interface DataWorksProjectConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/data_works_project#id DataWorksProject#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/data_works_project#project_name DataWorksProject#project_name}
  */
  readonly projectName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/data_works_project#task_auth_type DataWorksProject#task_auth_type}
  */
  readonly taskAuthType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/data_works_project alibabacloudstack_data_works_project}
*/
export class DataWorksProject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataWorksProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/data_works_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/data_works_project alibabacloudstack_data_works_project} Resource
  *
  * @param scope The scope in which to define this construct
