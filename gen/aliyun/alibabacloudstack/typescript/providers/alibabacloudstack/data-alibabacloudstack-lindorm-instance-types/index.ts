...
export interface DataAlibabacloudstackLindormInstanceTypesInstanceTypes {
}

export function dataAlibabacloudstackLindormInstanceTypesInstanceTypesToTerraform(struct?: DataAlibabacloudstackLindormInstanceTypesInstanceTypes): any {
...
export function dataAlibabacloudstackLindormInstanceTypesInstanceTypesToHclTerraform(struct?: DataAlibabacloudstackLindormInstanceTypesInstanceTypes): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAlibabacloudstackLindormInstanceTypesInstanceTypesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAlibabacloudstackLindormInstanceTypesInstanceTypes | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAlibabacloudstackLindormInstanceTypesInstanceTypes | undefined) {
    if (value === undefined) {
...
export class DataAlibabacloudstackLindormInstanceTypesInstanceTypesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAlibabacloudstackLindormInstanceTypesInstanceTypesOutputReference {
    return new DataAlibabacloudstackLindormInstanceTypesInstanceTypesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAlibabacloudstackLindormInstanceTypes extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "alibabacloudstack_lindorm_instance_types";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "alibabacloudstack_lindorm_instance_types", importId: importFromId, provider });
      }
  ...
  * @param options DataAlibabacloudstackLindormInstanceTypesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAlibabacloudstackLindormInstanceTypesConfig = {}) {
    super(scope, id, {
  ...
  private _instanceTypes = new DataAlibabacloudstackLindormInstanceTypesInstanceTypesList(this, "instance_types", false);
