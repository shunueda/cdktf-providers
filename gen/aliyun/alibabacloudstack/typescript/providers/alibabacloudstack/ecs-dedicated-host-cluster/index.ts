// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/ecs_dedicated_host_cluster
...
export interface EcsDedicatedHostClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/ecs_dedicated_host_cluster#dedicated_host_cluster_name EcsDedicatedHostCluster#dedicated_host_cluster_name}
  */
  readonly dedicatedHostClusterName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/ecs_dedicated_host_cluster#description EcsDedicatedHostCluster#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/ecs_dedicated_host_cluster#id EcsDedicatedHostCluster#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/ecs_dedicated_host_cluster#zone_id EcsDedicatedHostCluster#zone_id}
  */
  readonly zoneId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/ecs_dedicated_host_cluster alibabacloudstack_ecs_dedicated_host_cluster}
*/
export class EcsDedicatedHostCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcsDedicatedHostCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/ecs_dedicated_host_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/ecs_dedicated_host_cluster alibabacloudstack_ecs_dedicated_host_cluster} Resource
  *
  * @param scope The scope in which to define this construct
