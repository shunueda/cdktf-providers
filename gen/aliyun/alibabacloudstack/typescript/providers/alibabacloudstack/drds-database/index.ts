// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/drds_database
...
export interface DrdsDatabaseConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/drds_database#drds_database_name DrdsDatabase#drds_database_name}
  */
  readonly drdsDatabaseName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/drds_database#encode DrdsDatabase#encode}
  */
  readonly encode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/drds_database#id DrdsDatabase#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/drds_database#instance_id DrdsDatabase#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/drds_database#ip_white_list DrdsDatabase#ip_white_list}
  */
  readonly ipWhiteList?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/drds_database#password DrdsDatabase#password}
  */
  readonly password: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/drds_database#rds_instance_ids DrdsDatabase#rds_instance_ids}
  */
  readonly rdsInstanceIds: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/drds_database#split_mode DrdsDatabase#split_mode}
  */
  readonly splitMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/drds_database#storage_type DrdsDatabase#storage_type}
  */
  readonly storageType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/drds_database alibabacloudstack_drds_database}
*/
export class DrdsDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DrdsDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/drds_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/drds_database alibabacloudstack_drds_database} Resource
  *
  * @param scope The scope in which to define this construct
