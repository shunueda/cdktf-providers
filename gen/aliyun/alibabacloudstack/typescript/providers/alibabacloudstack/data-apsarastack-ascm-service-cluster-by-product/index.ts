...
export interface DataApsarastackAscmServiceClusterByProductClusterListStruct {
}

export function dataApsarastackAscmServiceClusterByProductClusterListStructToTerraform(struct?: DataApsarastackAscmServiceClusterByProductClusterListStruct): any {
...
export function dataApsarastackAscmServiceClusterByProductClusterListStructToHclTerraform(struct?: DataApsarastackAscmServiceClusterByProductClusterListStruct): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackAscmServiceClusterByProductClusterListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackAscmServiceClusterByProductClusterListStruct | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackAscmServiceClusterByProductClusterListStruct | undefined) {
    if (value === undefined) {
...
export class DataApsarastackAscmServiceClusterByProductClusterListStructList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackAscmServiceClusterByProductClusterListStructOutputReference {
    return new DataApsarastackAscmServiceClusterByProductClusterListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackAscmServiceClusterByProduct extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_ascm_service_cluster_by_product";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_ascm_service_cluster_by_product", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackAscmServiceClusterByProductConfig
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackAscmServiceClusterByProductConfig) {
    super(scope, id, {
  ...
  private _clusterList = new DataApsarastackAscmServiceClusterByProductClusterListStructList(this, "cluster_list", false);
