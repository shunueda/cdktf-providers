// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_vpngateway_ssl_vpn_client_cert
...
export interface ApsarastackVpngatewaySslVpnClientCertConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_vpngateway_ssl_vpn_client_cert#id ApsarastackVpngatewaySslVpnClientCert#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_vpngateway_ssl_vpn_client_cert#ssl_vpn_client_cert_name ApsarastackVpngatewaySslVpnClientCert#ssl_vpn_client_cert_name}
  */
  readonly sslVpnClientCertName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_vpngateway_ssl_vpn_client_cert#ssl_vpn_server_id ApsarastackVpngatewaySslVpnClientCert#ssl_vpn_server_id}
  */
  readonly sslVpnServerId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_vpngateway_ssl_vpn_client_cert#vpn_gateway_id ApsarastackVpngatewaySslVpnClientCert#vpn_gateway_id}
  */
  readonly vpnGatewayId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_vpngateway_ssl_vpn_client_cert apsarastack_vpngateway_ssl_vpn_client_cert}
*/
export class ApsarastackVpngatewaySslVpnClientCert extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_vpngateway_ssl_vpn_client_cert";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_vpngateway_ssl_vpn_client_cert", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/apsarastack_vpngateway_ssl_vpn_client_cert apsarastack_vpngateway_ssl_vpn_client_cert} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ApsarastackVpngatewaySslVpnClientCertConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackVpngatewaySslVpnClientCertConfig) {
    super(scope, id, {
      terraformResourceType: 'apsarastack_vpngateway_ssl_vpn_client_cert',
