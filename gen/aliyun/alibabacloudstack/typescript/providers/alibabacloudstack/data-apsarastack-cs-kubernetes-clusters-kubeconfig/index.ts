...
export class DataApsarastackCsKubernetesClustersKubeconfig extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_cs_kubernetes_clusters_kubeconfig";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_cs_kubernetes_clusters_kubeconfig", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackCsKubernetesClustersKubeconfigConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackCsKubernetesClustersKubeconfigConfig = {}) {
    super(scope, id, {
