...
export interface DataApsarastackEssScheduledTasksTasks {
}

export function dataApsarastackEssScheduledTasksTasksToTerraform(struct?: DataApsarastackEssScheduledTasksTasks): any {
...
export function dataApsarastackEssScheduledTasksTasksToHclTerraform(struct?: DataApsarastackEssScheduledTasksTasks): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackEssScheduledTasksTasksOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackEssScheduledTasksTasks | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackEssScheduledTasksTasks | undefined) {
    if (value === undefined) {
...
export class DataApsarastackEssScheduledTasksTasksList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackEssScheduledTasksTasksOutputReference {
    return new DataApsarastackEssScheduledTasksTasksOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackEssScheduledTasks extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_ess_scheduled_tasks";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_ess_scheduled_tasks", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackEssScheduledTasksConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackEssScheduledTasksConfig = {}) {
    super(scope, id, {
  ...
  private _tasks = new DataApsarastackEssScheduledTasksTasksList(this, "tasks", false);
  public get tasks() {
    return this._tasks;
  }
