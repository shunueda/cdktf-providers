// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_cen_transit_router_route_table_association
...
export interface ApsarastackCenTransitRouterRouteTableAssociationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_cen_transit_router_route_table_association#id ApsarastackCenTransitRouterRouteTableAssociation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_cen_transit_router_route_table_association#transit_router_attachment_id ApsarastackCenTransitRouterRouteTableAssociation#transit_router_attachment_id}
  */
  readonly transitRouterAttachmentId: string;
  /**
  * The ID of the transit router route table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_cen_transit_router_route_table_association#transit_router_route_table_id ApsarastackCenTransitRouterRouteTableAssociation#transit_router_route_table_id}
  */
  readonly transitRouterRouteTableId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_cen_transit_router_route_table_association apsarastack_cen_transit_router_route_table_association}
*/
export class ApsarastackCenTransitRouterRouteTableAssociation extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_cen_transit_router_route_table_association apsarastack_cen_transit_router_route_table_association} Resource
  *
  * @param scope The scope in which to define this construct
