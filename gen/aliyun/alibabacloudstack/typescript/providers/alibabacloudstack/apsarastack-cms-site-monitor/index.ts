...
export function apsarastackCmsSiteMonitorIspCitiesToTerraform(struct?: ApsarastackCmsSiteMonitorIspCities | cdktf.IResolvable): any {
...
export function apsarastackCmsSiteMonitorIspCitiesToHclTerraform(struct?: ApsarastackCmsSiteMonitorIspCities | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ApsarastackCmsSiteMonitorIspCitiesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApsarastackCmsSiteMonitorIspCities | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ApsarastackCmsSiteMonitorIspCities | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ApsarastackCmsSiteMonitorIspCitiesList extends cdktf.ComplexList {
  public internalValue? : ApsarastackCmsSiteMonitorIspCities[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ApsarastackCmsSiteMonitorIspCitiesOutputReference {
    return new ApsarastackCmsSiteMonitorIspCitiesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ApsarastackCmsSiteMonitor extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_cms_site_monitor";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_cms_site_monitor", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackCmsSiteMonitorConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackCmsSiteMonitorConfig) {
    super(scope, id, {
  ...
  private _ispCities = new ApsarastackCmsSiteMonitorIspCitiesList(this, "isp_cities", true);
  public get ispCities() {
    return this._ispCities;
  }
  public putIspCities(value: ApsarastackCmsSiteMonitorIspCities[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      isp_cities: cdktf.listMapper(apsarastackCmsSiteMonitorIspCitiesToTerraform, true)(this._ispCities.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      isp_cities: {
        value: cdktf.listMapperHcl(apsarastackCmsSiteMonitorIspCitiesToHclTerraform, true)(this._ispCities.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "ApsarastackCmsSiteMonitorIspCitiesList",
      },
    };
