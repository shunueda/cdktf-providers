// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/adb_backup_policy
...
export interface AdbBackupPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/adb_backup_policy#db_cluster_id AdbBackupPolicy#db_cluster_id}
  */
  readonly dbClusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/adb_backup_policy#id AdbBackupPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/adb_backup_policy#preferred_backup_period AdbBackupPolicy#preferred_backup_period}
  */
  readonly preferredBackupPeriod: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/adb_backup_policy#preferred_backup_time AdbBackupPolicy#preferred_backup_time}
  */
  readonly preferredBackupTime: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/adb_backup_policy alibabacloudstack_adb_backup_policy}
*/
export class AdbBackupPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdbBackupPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/adb_backup_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/adb_backup_policy alibabacloudstack_adb_backup_policy} Resource
  *
  * @param scope The scope in which to define this construct
