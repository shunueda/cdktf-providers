// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/dbs_backupplan
...
export interface DbsBackupplanConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/dbs_backupplan#backup_method DbsBackupplan#backup_method}
  */
  readonly backupMethod: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/dbs_backupplan#backup_plan_name DbsBackupplan#backup_plan_name}
  */
  readonly backupPlanName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/dbs_backupplan#database_region DbsBackupplan#database_region}
  */
  readonly databaseRegion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/dbs_backupplan#database_type DbsBackupplan#database_type}
  */
  readonly databaseType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/dbs_backupplan#from_app DbsBackupplan#from_app}
  */
  readonly fromApp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/dbs_backupplan#id DbsBackupplan#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/dbs_backupplan#instance_class DbsBackupplan#instance_class}
  */
  readonly instanceClass: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/dbs_backupplan#instance_type DbsBackupplan#instance_type}
  */
  readonly instanceType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/dbs_backupplan#storage_region DbsBackupplan#storage_region}
  */
  readonly storageRegion?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/dbs_backupplan alibabacloudstack_dbs_backupplan}
*/
export class DbsBackupplan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbsBackupplan that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/dbs_backupplan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/dbs_backupplan alibabacloudstack_dbs_backupplan} Resource
  *
  * @param scope The scope in which to define this construct
