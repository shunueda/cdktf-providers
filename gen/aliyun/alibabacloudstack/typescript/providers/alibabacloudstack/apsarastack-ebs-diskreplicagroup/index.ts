...
export class ApsarastackEbsDiskreplicagroup extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_ebs_diskreplicagroup";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_ebs_diskreplicagroup", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackEbsDiskreplicagroupConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackEbsDiskreplicagroupConfig) {
    super(scope, id, {
