...
export interface DataApsarastackAscmOrganizationsOrganizations {
}

export function dataApsarastackAscmOrganizationsOrganizationsToTerraform(struct?: DataApsarastackAscmOrganizationsOrganizations): any {
...
export function dataApsarastackAscmOrganizationsOrganizationsToHclTerraform(struct?: DataApsarastackAscmOrganizationsOrganizations): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackAscmOrganizationsOrganizationsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackAscmOrganizationsOrganizations | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackAscmOrganizationsOrganizations | undefined) {
    if (value === undefined) {
...
export class DataApsarastackAscmOrganizationsOrganizationsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackAscmOrganizationsOrganizationsOutputReference {
    return new DataApsarastackAscmOrganizationsOrganizationsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackAscmOrganizations extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_ascm_organizations";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_ascm_organizations", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackAscmOrganizationsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackAscmOrganizationsConfig = {}) {
    super(scope, id, {
  ...
  private _organizations = new DataApsarastackAscmOrganizationsOrganizationsList(this, "organizations", false);
