// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/ess_notification
...
export interface EssNotificationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/ess_notification#id EssNotification#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/ess_notification#notification_arn EssNotification#notification_arn}
  */
  readonly notificationArn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/ess_notification#notification_types EssNotification#notification_types}
  */
  readonly notificationTypes: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/ess_notification#scaling_group_id EssNotification#scaling_group_id}
  */
  readonly scalingGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/ess_notification alibabacloudstack_ess_notification}
*/
export class EssNotification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EssNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/ess_notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/ess_notification alibabacloudstack_ess_notification} Resource
  *
  * @param scope The scope in which to define this construct
