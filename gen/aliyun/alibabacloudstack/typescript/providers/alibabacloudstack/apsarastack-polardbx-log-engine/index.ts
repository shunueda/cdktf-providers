...
export function apsarastackPolardbxLogEngineMultiStreamToTerraform(struct?: ApsarastackPolardbxLogEngineMultiStream | cdktf.IResolvable): any {
...
export function apsarastackPolardbxLogEngineMultiStreamToHclTerraform(struct?: ApsarastackPolardbxLogEngineMultiStream | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ApsarastackPolardbxLogEngineMultiStreamOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApsarastackPolardbxLogEngineMultiStream | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ApsarastackPolardbxLogEngineMultiStream | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ApsarastackPolardbxLogEngineMultiStreamList extends cdktf.ComplexList {
  public internalValue? : ApsarastackPolardbxLogEngineMultiStream[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ApsarastackPolardbxLogEngineMultiStreamOutputReference {
    return new ApsarastackPolardbxLogEngineMultiStreamOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ApsarastackPolardbxLogEngine extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_polardbx_log_engine";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_polardbx_log_engine", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackPolardbxLogEngineConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackPolardbxLogEngineConfig) {
    super(scope, id, {
  ...
  private _multiStream = new ApsarastackPolardbxLogEngineMultiStreamList(this, "multi_stream", true);
  public get multiStream() {
    return this._multiStream;
  }
  public putMultiStream(value: ApsarastackPolardbxLogEngineMultiStream[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      multi_stream: cdktf.listMapper(apsarastackPolardbxLogEngineMultiStreamToTerraform, true)(this._multiStream.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      multi_stream: {
        value: cdktf.listMapperHcl(apsarastackPolardbxLogEngineMultiStreamToHclTerraform, true)(this._multiStream.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "ApsarastackPolardbxLogEngineMultiStreamList",
      },
    };
