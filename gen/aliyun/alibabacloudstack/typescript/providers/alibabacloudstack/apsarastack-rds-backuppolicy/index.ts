...
export class ApsarastackRdsBackuppolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_rds_backuppolicy";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_rds_backuppolicy", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackRdsBackuppolicyConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackRdsBackuppolicyConfig) {
    super(scope, id, {
