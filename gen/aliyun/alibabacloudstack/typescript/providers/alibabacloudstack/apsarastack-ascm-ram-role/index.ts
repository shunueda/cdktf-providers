// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_ram_role
...
export interface ApsarastackAscmRamRoleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_ram_role#description ApsarastackAscmRamRole#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_ram_role#id ApsarastackAscmRamRole#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_ram_role#organization_visibility ApsarastackAscmRamRole#organization_visibility}
  */
  readonly organizationVisibility: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_ram_role#role_name ApsarastackAscmRamRole#role_name}
  */
  readonly roleName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_ram_role#role_range ApsarastackAscmRamRole#role_range}
  */
  readonly roleRange: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_ram_role apsarastack_ascm_ram_role}
*/
export class ApsarastackAscmRamRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApsarastackAscmRamRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_ram_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.20/docs/resources/apsarastack_ascm_ram_role apsarastack_ascm_ram_role} Resource
  *
  * @param scope The scope in which to define this construct
