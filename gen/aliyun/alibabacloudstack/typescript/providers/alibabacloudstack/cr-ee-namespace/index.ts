// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/cr_ee_namespace
...
export interface CrEeNamespaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/cr_ee_namespace#auto_create CrEeNamespace#auto_create}
  */
  readonly autoCreate: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/cr_ee_namespace#default_visibility CrEeNamespace#default_visibility}
  */
  readonly defaultVisibility: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/cr_ee_namespace#id CrEeNamespace#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/cr_ee_namespace#instance_id CrEeNamespace#instance_id}
  */
  readonly instanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/cr_ee_namespace#name CrEeNamespace#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/cr_ee_namespace alibabacloudstack_cr_ee_namespace}
*/
export class CrEeNamespace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CrEeNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/cr_ee_namespace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.16.21/docs/resources/cr_ee_namespace alibabacloudstack_cr_ee_namespace} Resource
  *
  * @param scope The scope in which to define this construct
