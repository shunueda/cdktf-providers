// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/polardb_cluster_proxy
...
export interface PolardbClusterProxyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/polardb_cluster_proxy#db_cluster_id PolardbClusterProxy#db_cluster_id}
  */
  readonly dbClusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/polardb_cluster_proxy#db_proxy_cluster_class PolardbClusterProxy#db_proxy_cluster_class}
  */
  readonly dbProxyClusterClass: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/polardb_cluster_proxy#id PolardbClusterProxy#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/polardb_cluster_proxy alibabacloudstack_polardb_cluster_proxy}
*/
export class PolardbClusterProxy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PolardbClusterProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/polardb_cluster_proxy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/polardb_cluster_proxy alibabacloudstack_polardb_cluster_proxy} Resource
  *
  * @param scope The scope in which to define this construct
