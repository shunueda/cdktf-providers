...
export interface DataApsarastackExpressconnectBgpPeersBgpPeers {
}

export function dataApsarastackExpressconnectBgpPeersBgpPeersToTerraform(struct?: DataApsarastackExpressconnectBgpPeersBgpPeers): any {
...
export function dataApsarastackExpressconnectBgpPeersBgpPeersToHclTerraform(struct?: DataApsarastackExpressconnectBgpPeersBgpPeers): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackExpressconnectBgpPeersBgpPeersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackExpressconnectBgpPeersBgpPeers | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackExpressconnectBgpPeersBgpPeers | undefined) {
    if (value === undefined) {
...
export class DataApsarastackExpressconnectBgpPeersBgpPeersList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackExpressconnectBgpPeersBgpPeersOutputReference {
    return new DataApsarastackExpressconnectBgpPeersBgpPeersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackExpressconnectBgpPeers extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_expressconnect_bgp_peers";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_expressconnect_bgp_peers", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackExpressconnectBgpPeersConfig
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackExpressconnectBgpPeersConfig) {
    super(scope, id, {
  ...
  private _bgpPeers = new DataApsarastackExpressconnectBgpPeersBgpPeersList(this, "bgp_peers", false);
  public get bgpPeers() {
