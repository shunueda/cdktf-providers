...
export function apsarastackCloudmonitorserviceSitemonitorIspCitiesToTerraform(struct?: ApsarastackCloudmonitorserviceSitemonitorIspCities | cdktf.IResolvable): any {
...
export function apsarastackCloudmonitorserviceSitemonitorIspCitiesToHclTerraform(struct?: ApsarastackCloudmonitorserviceSitemonitorIspCities | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ApsarastackCloudmonitorserviceSitemonitorIspCitiesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApsarastackCloudmonitorserviceSitemonitorIspCities | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ApsarastackCloudmonitorserviceSitemonitorIspCities | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ApsarastackCloudmonitorserviceSitemonitorIspCitiesList extends cdktf.ComplexList {
  public internalValue? : ApsarastackCloudmonitorserviceSitemonitorIspCities[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ApsarastackCloudmonitorserviceSitemonitorIspCitiesOutputReference {
    return new ApsarastackCloudmonitorserviceSitemonitorIspCitiesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ApsarastackCloudmonitorserviceSitemonitor extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_cloudmonitorservice_sitemonitor";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_cloudmonitorservice_sitemonitor", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackCloudmonitorserviceSitemonitorConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackCloudmonitorserviceSitemonitorConfig) {
    super(scope, id, {
  ...
  private _ispCities = new ApsarastackCloudmonitorserviceSitemonitorIspCitiesList(this, "isp_cities", true);
  public get ispCities() {
    return this._ispCities;
  }
  public putIspCities(value: ApsarastackCloudmonitorserviceSitemonitorIspCities[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      isp_cities: cdktf.listMapper(apsarastackCloudmonitorserviceSitemonitorIspCitiesToTerraform, true)(this._ispCities.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      isp_cities: {
        value: cdktf.listMapperHcl(apsarastackCloudmonitorserviceSitemonitorIspCitiesToHclTerraform, true)(this._ispCities.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "ApsarastackCloudmonitorserviceSitemonitorIspCitiesList",
      },
    };
