...
export class ApsarastackEdasSwimmingLaneGroup extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_edas_swimming_lane_group";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_edas_swimming_lane_group", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackEdasSwimmingLaneGroupConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackEdasSwimmingLaneGroupConfig) {
    super(scope, id, {
