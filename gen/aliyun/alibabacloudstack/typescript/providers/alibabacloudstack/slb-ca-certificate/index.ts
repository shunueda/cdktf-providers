// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_ca_certificate
...
export interface SlbCaCertificateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_ca_certificate#ca_certificate SlbCaCertificate#ca_certificate}
  */
  readonly caCertificate: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_ca_certificate#ca_certificate_name SlbCaCertificate#ca_certificate_name}
  */
  readonly caCertificateName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_ca_certificate#id SlbCaCertificate#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_ca_certificate#name SlbCaCertificate#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_ca_certificate alibabacloudstack_slb_ca_certificate}
*/
export class SlbCaCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SlbCaCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_ca_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.19/docs/resources/slb_ca_certificate alibabacloudstack_slb_ca_certificate} Resource
  *
  * @param scope The scope in which to define this construct
