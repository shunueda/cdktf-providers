// https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance
...
export interface MqttInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance#cluster_name MqttInstance#cluster_name}
  */
  readonly clusterName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance#id MqttInstance#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance#independent_naming MqttInstance#independent_naming}
  */
  readonly independentNaming?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance#instance_name MqttInstance#instance_name}
  */
  readonly instanceName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance#max_conn MqttInstance#max_conn}
  */
  readonly maxConn?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance#max_down_tps MqttInstance#max_down_tps}
  */
  readonly maxDownTps?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance#max_sub MqttInstance#max_sub}
  */
  readonly maxSub?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance#max_up_tps MqttInstance#max_up_tps}
  */
  readonly maxUpTps?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance#remark MqttInstance#remark}
  */
  readonly remark?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance#store_instance_id MqttInstance#store_instance_id}
  */
  readonly storeInstanceId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance#store_type MqttInstance#store_type}
  */
  readonly storeType?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance alibabacloudstack_mqtt_instance}
*/
export class MqttInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MqttInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aliyun/alibabacloudstack/3.18.21/docs/resources/mqtt_instance alibabacloudstack_mqtt_instance} Resource
  *
  * @param scope The scope in which to define this construct
