...
export interface DataApsarastackCloudmonitorserviceMetricruletemplatesTemplates {
}

export function dataApsarastackCloudmonitorserviceMetricruletemplatesTemplatesToTerraform(struct?: DataApsarastackCloudmonitorserviceMetricruletemplatesTemplates): any {
...
export function dataApsarastackCloudmonitorserviceMetricruletemplatesTemplatesToHclTerraform(struct?: DataApsarastackCloudmonitorserviceMetricruletemplatesTemplates): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataApsarastackCloudmonitorserviceMetricruletemplatesTemplatesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataApsarastackCloudmonitorserviceMetricruletemplatesTemplates | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataApsarastackCloudmonitorserviceMetricruletemplatesTemplates | undefined) {
    if (value === undefined) {
...
export class DataApsarastackCloudmonitorserviceMetricruletemplatesTemplatesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataApsarastackCloudmonitorserviceMetricruletemplatesTemplatesOutputReference {
    return new DataApsarastackCloudmonitorserviceMetricruletemplatesTemplatesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataApsarastackCloudmonitorserviceMetricruletemplates extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_cloudmonitorservice_metricruletemplates";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_cloudmonitorservice_metricruletemplates", importId: importFromId, provider });
      }
  ...
  * @param options DataApsarastackCloudmonitorserviceMetricruletemplatesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataApsarastackCloudmonitorserviceMetricruletemplatesConfig = {}) {
    super(scope, id, {
  ...
  private _templates = new DataApsarastackCloudmonitorserviceMetricruletemplatesTemplatesList(this, "templates", false);
