...
export class ApsarastackAutoscalingAlarmtask extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_autoscaling_alarmtask";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_autoscaling_alarmtask", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackAutoscalingAlarmtaskConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackAutoscalingAlarmtaskConfig) {
    super(scope, id, {
