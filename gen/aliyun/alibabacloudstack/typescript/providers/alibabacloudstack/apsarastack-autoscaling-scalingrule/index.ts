...
export class ApsarastackAutoscalingScalingrule extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "apsarastack_autoscaling_scalingrule";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "apsarastack_autoscaling_scalingrule", importId: importFromId, provider });
      }
  ...
  * @param options ApsarastackAutoscalingScalingruleConfig
  */
  public constructor(scope: Construct, id: string, config: ApsarastackAutoscalingScalingruleConfig) {
    super(scope, id, {
