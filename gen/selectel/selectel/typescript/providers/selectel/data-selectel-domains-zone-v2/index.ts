// https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/data-sources/domains_zone_v2
...
export interface DataSelectelDomainsZoneV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/data-sources/domains_zone_v2#id DataSelectelDomainsZoneV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/data-sources/domains_zone_v2#name DataSelectelDomainsZoneV2#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/data-sources/domains_zone_v2#project_id DataSelectelDomainsZoneV2#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/data-sources/domains_zone_v2 selectel_domains_zone_v2}
*/
export class DataSelectelDomainsZoneV2 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSelectelDomainsZoneV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/data-sources/domains_zone_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/data-sources/domains_zone_v2 selectel_domains_zone_v2} Data Source
  *
  * @param scope The scope in which to define this construct
