// https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/iam_saml_federation_v1
...
export interface IamSamlFederationV1Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/iam_saml_federation_v1#description IamSamlFederationV1#description}
  */
  readonly description?: string;
  /**
  * Enable forced authentication at every login.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/iam_saml_federation_v1#force_authn IamSamlFederationV1#force_authn}
  */
  readonly forceAuthn?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/iam_saml_federation_v1#id IamSamlFederationV1#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/iam_saml_federation_v1#issuer IamSamlFederationV1#issuer}
  */
  readonly issuer: string;
  /**
  * Name of the Federation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/iam_saml_federation_v1#name IamSamlFederationV1#name}
  */
  readonly name: string;
  /**
  * Session lifetime.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/iam_saml_federation_v1#session_max_age_hours IamSamlFederationV1#session_max_age_hours}
  */
  readonly sessionMaxAgeHours: number;
  /**
  * Should sign authentication requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/iam_saml_federation_v1#sign_authn_requests IamSamlFederationV1#sign_authn_requests}
  */
  readonly signAuthnRequests?: boolean | cdktf.IResolvable;
  /**
  * Single sign-on endpoint URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/iam_saml_federation_v1#sso_url IamSamlFederationV1#sso_url}
  */
  readonly ssoUrl: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/iam_saml_federation_v1 selectel_iam_saml_federation_v1}
*/
export class IamSamlFederationV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamSamlFederationV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/iam_saml_federation_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/iam_saml_federation_v1 selectel_iam_saml_federation_v1} Resource
  *
  * @param scope The scope in which to define this construct
