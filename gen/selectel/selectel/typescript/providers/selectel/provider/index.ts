// https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs
...
export interface SelectelProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs#auth_region SelectelProvider#auth_region}
  */
  readonly authRegion: string;
  /**
  * Base url to work with auth API (Keystone URL).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs#auth_url SelectelProvider#auth_url}
  */
  readonly authUrl: string;
  /**
  * Your domain name i.e. your account id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs#domain_name SelectelProvider#domain_name}
  */
  readonly domainName: string;
  /**
  * Service user password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs#password SelectelProvider#password}
  */
  readonly password: string;
  /**
  * VPC project ID to import resources that need the project scope auth token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs#project_id SelectelProvider#project_id}
  */
  readonly projectId?: string;
  /**
  * VPC region to import resources associated with the specific region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs#region SelectelProvider#region}
  */
  readonly region?: string;
  /**
  * Used for service accounts in other domain. If you don't know exactly what this field means then don't use it
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs#user_domain_name SelectelProvider#user_domain_name}
  */
  readonly userDomainName?: string;
  /**
  * Service user username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs#username SelectelProvider#username}
  */
  readonly username: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs#alias SelectelProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs selectel}
*/
export class SelectelProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing SelectelProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs selectel} Resource
  *
  * @param scope The scope in which to define this construct
