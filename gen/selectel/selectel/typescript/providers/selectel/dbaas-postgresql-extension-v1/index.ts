// https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/resources/dbaas_postgresql_extension_v1
...
export interface DbaasPostgresqlExtensionV1Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/resources/dbaas_postgresql_extension_v1#available_extension_id DbaasPostgresqlExtensionV1#available_extension_id}
  */
  readonly availableExtensionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/resources/dbaas_postgresql_extension_v1#database_id DbaasPostgresqlExtensionV1#database_id}
  */
  readonly databaseId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/resources/dbaas_postgresql_extension_v1#datastore_id DbaasPostgresqlExtensionV1#datastore_id}
  */
  readonly datastoreId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/resources/dbaas_postgresql_extension_v1#id DbaasPostgresqlExtensionV1#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/resources/dbaas_postgresql_extension_v1#project_id DbaasPostgresqlExtensionV1#project_id}
  */
  readonly projectId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/resources/dbaas_postgresql_extension_v1#region DbaasPostgresqlExtensionV1#region}
  */
  readonly region: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/resources/dbaas_postgresql_extension_v1#timeouts DbaasPostgresqlExtensionV1#timeouts}
  */
  readonly timeouts?: DbaasPostgresqlExtensionV1Timeouts;
}
export interface DbaasPostgresqlExtensionV1Timeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/resources/dbaas_postgresql_extension_v1#create DbaasPostgresqlExtensionV1#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/resources/dbaas_postgresql_extension_v1#delete DbaasPostgresqlExtensionV1#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/resources/dbaas_postgresql_extension_v1#update DbaasPostgresqlExtensionV1#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/resources/dbaas_postgresql_extension_v1 selectel_dbaas_postgresql_extension_v1}
*/
export class DbaasPostgresqlExtensionV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbaasPostgresqlExtensionV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/resources/dbaas_postgresql_extension_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/selectel/selectel/7.2.1/docs/resources/dbaas_postgresql_extension_v1 selectel_dbaas_postgresql_extension_v1} Resource
  *
  * @param scope The scope in which to define this construct
