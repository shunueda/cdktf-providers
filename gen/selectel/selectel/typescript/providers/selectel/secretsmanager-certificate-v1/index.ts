// https://registry.terraform.io/providers/selectel/selectel/7.1.0/docs/resources/secretsmanager_certificate_v1
...
export interface SecretsmanagerCertificateV1Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.1.0/docs/resources/secretsmanager_certificate_v1#certificates SecretsmanagerCertificateV1#certificates}
  */
  readonly certificates: string[];
  /**
  * name of the certificate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.1.0/docs/resources/secretsmanager_certificate_v1#name SecretsmanagerCertificateV1#name}
  */
  readonly name: string;
  /**
  * that should start with -----BEGIN PRIVATE KEY----- and end with -----END PRIVATE KEY-----
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.1.0/docs/resources/secretsmanager_certificate_v1#private_key SecretsmanagerCertificateV1#private_key}
  */
  readonly privateKey: string;
  /**
  * id of a project where secret is used
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.1.0/docs/resources/secretsmanager_certificate_v1#project_id SecretsmanagerCertificateV1#project_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/selectel/selectel/7.1.0/docs/resources/secretsmanager_certificate_v1 selectel_secretsmanager_certificate_v1}
*/
export class SecretsmanagerCertificateV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretsmanagerCertificateV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/selectel/selectel/7.1.0/docs/resources/secretsmanager_certificate_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/selectel/selectel/7.1.0/docs/resources/secretsmanager_certificate_v1 selectel_secretsmanager_certificate_v1} Resource
  *
  * @param scope The scope in which to define this construct
