// https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/craas_token_v2
...
export interface CraasTokenV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/craas_token_v2#all_registries CraasTokenV2#all_registries}
  */
  readonly allRegistries: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/craas_token_v2#expires_at CraasTokenV2#expires_at}
  */
  readonly expiresAt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/craas_token_v2#id CraasTokenV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/craas_token_v2#is_set CraasTokenV2#is_set}
  */
  readonly isSet: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/craas_token_v2#mode_rw CraasTokenV2#mode_rw}
  */
  readonly modeRw: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/craas_token_v2#name CraasTokenV2#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/craas_token_v2#project_id CraasTokenV2#project_id}
  */
  readonly projectId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/craas_token_v2#registry_ids CraasTokenV2#registry_ids}
  */
  readonly registryIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/craas_token_v2 selectel_craas_token_v2}
*/
export class CraasTokenV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CraasTokenV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/craas_token_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/selectel/selectel/7.3.0/docs/resources/craas_token_v2 selectel_craas_token_v2} Resource
  *
  * @param scope The scope in which to define this construct
