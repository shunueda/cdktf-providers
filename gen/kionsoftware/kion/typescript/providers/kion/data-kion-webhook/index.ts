// https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/webhook
...
export interface DataKionWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/webhook#id DataKionWebhook#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/webhook kion_webhook}
*/
export class DataKionWebhook extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKionWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/webhook kion_webhook} Data Source
  *
  * @param scope The scope in which to define this construct
