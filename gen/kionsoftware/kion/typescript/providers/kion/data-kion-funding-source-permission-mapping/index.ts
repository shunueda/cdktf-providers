// https://registry.terraform.io/providers/kionsoftware/kion/0.3.30/docs/data-sources/funding_source_permission_mapping
...
export interface DataKionFundingSourcePermissionMappingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.30/docs/data-sources/funding_source_permission_mapping#funding_source_id DataKionFundingSourcePermissionMapping#funding_source_id}
  */
  readonly fundingSourceId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.30/docs/data-sources/funding_source_permission_mapping#id DataKionFundingSourcePermissionMapping#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.30/docs/data-sources/funding_source_permission_mapping kion_funding_source_permission_mapping}
*/
export class DataKionFundingSourcePermissionMapping extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKionFundingSourcePermissionMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.30/docs/data-sources/funding_source_permission_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.30/docs/data-sources/funding_source_permission_mapping kion_funding_source_permission_mapping} Data Source
  *
  * @param scope The scope in which to define this construct
