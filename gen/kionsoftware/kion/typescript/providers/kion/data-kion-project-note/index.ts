// https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/project_note
...
export interface DataKionProjectNoteConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/project_note#id DataKionProjectNote#id}
  *
  ...
  */
  readonly id: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/project_note#project_id DataKionProjectNote#project_id}
  */
  readonly projectId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/project_note kion_project_note}
*/
export class DataKionProjectNote extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKionProjectNote that should be imported. Refer to the {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/project_note#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/project_note kion_project_note} Data Source
  *
  * @param scope The scope in which to define this construct
