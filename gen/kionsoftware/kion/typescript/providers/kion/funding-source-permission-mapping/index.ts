// https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/resources/funding_source_permission_mapping
...
export interface FundingSourcePermissionMappingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/resources/funding_source_permission_mapping#app_role_id FundingSourcePermissionMapping#app_role_id}
  */
  readonly appRoleId: number;
  /**
  * ID of the Funding Source to manage permission mappings for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/resources/funding_source_permission_mapping#funding_source_id FundingSourcePermissionMapping#funding_source_id}
  */
  readonly fundingSourceId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/resources/funding_source_permission_mapping#id FundingSourcePermissionMapping#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/resources/funding_source_permission_mapping#user_groups_ids FundingSourcePermissionMapping#user_groups_ids}
  */
  readonly userGroupsIds: number[];
  /**
  * Set of user IDs for the permission mapping (must be provided in numerical order).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/resources/funding_source_permission_mapping#user_ids FundingSourcePermissionMapping#user_ids}
  */
  readonly userIds: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/resources/funding_source_permission_mapping kion_funding_source_permission_mapping}
*/
export class FundingSourcePermissionMapping extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FundingSourcePermissionMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/resources/funding_source_permission_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/resources/funding_source_permission_mapping kion_funding_source_permission_mapping} Resource
  *
  * @param scope The scope in which to define this construct
