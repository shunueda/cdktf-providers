// https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/ou_cloud_access_role
...
export interface DataKionOuCloudAccessRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/ou_cloud_access_role#id DataKionOuCloudAccessRole#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/ou_cloud_access_role kion_ou_cloud_access_role}
*/
export class DataKionOuCloudAccessRole extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKionOuCloudAccessRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/ou_cloud_access_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.29/docs/data-sources/ou_cloud_access_role kion_ou_cloud_access_role} Data Source
  *
  * @param scope The scope in which to define this construct
