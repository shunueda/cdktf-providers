...
export class CloudRule extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "kion_cloud_rule";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "kion_cloud_rule", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: CloudRuleConfig) {
    ...
    this._concurrentCftSync = config.concurrentCftSync;
  ...
  // concurrent_cft_sync - computed: false, optional: true, required: false
  private _concurrentCftSync?: boolean | cdktf.IResolvable; 
  public get concurrentCftSync() {
    return this.getBooleanAttribute('concurrent_cft_sync');
  }
  public set concurrentCftSync(value: boolean | cdktf.IResolvable) {
    this._concurrentCftSync = value;
  }
  public resetConcurrentCftSync() {
    this._concurrentCftSync = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get concurrentCftSyncInput() {
    return this._concurrentCftSync;
  }
  ...
  private _awsIamPolicies = new CloudRuleAwsIamPoliciesList(this, "aws_iam_policies", true);
  ...
  private _azurePolicyDefinitions = new CloudRuleAzurePolicyDefinitionsList(this, "azure_policy_definitions", true);
  ...
  private _azureRoleDefinitions = new CloudRuleAzureRoleDefinitionsList(this, "azure_role_definitions", true);
  ...
  private _complianceStandards = new CloudRuleComplianceStandardsList(this, "compliance_standards", true);
  ...
  private _gcpIamRoles = new CloudRuleGcpIamRolesList(this, "gcp_iam_roles", true);
  ...
  private _internalAwsAmis = new CloudRuleInternalAwsAmisList(this, "internal_aws_amis", true);
  ...
  private _internalAwsServiceCatalogPortfolios = new CloudRuleInternalAwsServiceCatalogPortfoliosList(this, "internal_aws_service_catalog_portfolios", true);
  ...
  private _ous = new CloudRuleOusList(this, "ous", true);
  public get ous() {
    return this._ous;
  }
  ...
  private _ownerUserGroups = new CloudRuleOwnerUserGroupsList(this, "owner_user_groups", true);
  ...
  private _ownerUsers = new CloudRuleOwnerUsersList(this, "owner_users", true);
  ...
  private _projects = new CloudRuleProjectsList(this, "projects", true);
  public get projects() {
  ...
  private _serviceControlPolicies = new CloudRuleServiceControlPoliciesList(this, "service_control_policies", true);
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      concurrent_cft_sync: cdktf.booleanToTerraform(this._concurrentCftSync),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      concurrent_cft_sync: {
        value: cdktf.booleanToHclTerraform(this._concurrentCftSync),
        isBlock: false,
        type: "simple",
