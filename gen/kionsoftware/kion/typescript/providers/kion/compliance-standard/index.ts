...
export class ComplianceStandard extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "kion_compliance_standard";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "kion_compliance_standard", importId: importFromId, provider });
      }
  ...
  */
  ...
  private _complianceChecks = new ComplianceStandardComplianceChecksList(this, "compliance_checks", true);
  ...
  private _ownerUserGroups = new ComplianceStandardOwnerUserGroupsList(this, "owner_user_groups", true);
  ...
  private _ownerUsers = new ComplianceStandardOwnerUsersList(this, "owner_users", true);
