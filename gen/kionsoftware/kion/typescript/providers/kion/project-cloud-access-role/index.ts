...
export function projectCloudAccessRoleGcpIamRolesToTerraform(struct?: ProjectCloudAccessRoleGcpIamRoles | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function projectCloudAccessRoleGcpIamRolesToHclTerraform(struct?: ProjectCloudAccessRoleGcpIamRoles | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ProjectCloudAccessRoleGcpIamRolesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): ProjectCloudAccessRoleGcpIamRoles | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ProjectCloudAccessRoleGcpIamRoles | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._id = undefined;
...
export class ProjectCloudAccessRoleGcpIamRolesList extends cdktf.ComplexList {
  public internalValue? : ProjectCloudAccessRoleGcpIamRoles[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): ProjectCloudAccessRoleGcpIamRolesOutputReference {
    return new ProjectCloudAccessRoleGcpIamRolesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ProjectCloudAccessRole extends cdktf.TerraformResource {
  ...
  */
  ...
  private _accounts = new ProjectCloudAccessRoleAccountsList(this, "accounts", true);
  public get accounts() {
  ...
  private _awsIamPolicies = new ProjectCloudAccessRoleAwsIamPoliciesList(this, "aws_iam_policies", true);
  ...
  private _azureRoleDefinitions = new ProjectCloudAccessRoleAzureRoleDefinitionsList(this, "azure_role_definitions", true);
  ...
  private _gcpIamRoles = new ProjectCloudAccessRoleGcpIamRolesList(this, "gcp_iam_roles", true);
  public get gcpIamRoles() {
    return this._gcpIamRoles;
  }
  public putGcpIamRoles(value: ProjectCloudAccessRoleGcpIamRoles[] | cdktf.IResolvable) {
  ...
  private _userGroups = new ProjectCloudAccessRoleUserGroupsList(this, "user_groups", true);
  ...
  private _users = new ProjectCloudAccessRoleUsersList(this, "users", true);
  public get users() {
    return this._users;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      gcp_iam_roles: cdktf.listMapper(projectCloudAccessRoleGcpIamRolesToTerraform, true)(this._gcpIamRoles.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      gcp_iam_roles: {
        value: cdktf.listMapperHcl(projectCloudAccessRoleGcpIamRolesToHclTerraform, true)(this._gcpIamRoles.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "ProjectCloudAccessRoleGcpIamRolesList",
      },
      user_groups: {
