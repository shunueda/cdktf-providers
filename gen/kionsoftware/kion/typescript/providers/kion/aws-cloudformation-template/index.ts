...
export class AwsCloudformationTemplate extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "kion_aws_cloudformation_template";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "kion_aws_cloudformation_template", importId: importFromId, provider });
      }
  ...
  */
  ...
  private _ownerUserGroups = new AwsCloudformationTemplateOwnerUserGroupsList(this, "owner_user_groups", true);
  ...
  private _ownerUsers = new AwsCloudformationTemplateOwnerUsersList(this, "owner_users", true);
