// https://registry.terraform.io/providers/kionsoftware/kion/0.3.30/docs/data-sources/project_cloud_access_role
...
export interface DataKionProjectCloudAccessRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.30/docs/data-sources/project_cloud_access_role#id DataKionProjectCloudAccessRole#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.30/docs/data-sources/project_cloud_access_role kion_project_cloud_access_role}
*/
export class DataKionProjectCloudAccessRole extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKionProjectCloudAccessRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.30/docs/data-sources/project_cloud_access_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/kionsoftware/kion/0.3.30/docs/data-sources/project_cloud_access_role kion_project_cloud_access_role} Data Source
  *
  * @param scope The scope in which to define this construct
