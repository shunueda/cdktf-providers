...
export class GcpIamRole extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "kion_gcp_iam_role";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "kion_gcp_iam_role", importId: importFromId, provider });
      }
  ...
  */
  ...
  public get rolePermissions() {
    return cdktf.Fn.tolist(this.getListAttribute('role_permissions'));
  }
  ...
  private _ownerUserGroups = new GcpIamRoleOwnerUserGroupsList(this, "owner_user_groups", true);
  ...
  private _ownerUsers = new GcpIamRoleOwnerUsersList(this, "owner_users", true);
