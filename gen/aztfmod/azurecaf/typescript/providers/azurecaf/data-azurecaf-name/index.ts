// https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name
...
export interface DataAzurecafNameConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name#clean_input DataAzurecafName#clean_input}
  */
  readonly cleanInput?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name#id DataAzurecafName#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name#name DataAzurecafName#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name#passthrough DataAzurecafName#passthrough}
  */
  readonly passthrough?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name#prefixes DataAzurecafName#prefixes}
  */
  readonly prefixes?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name#random_length DataAzurecafName#random_length}
  */
  readonly randomLength?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name#random_seed DataAzurecafName#random_seed}
  */
  readonly randomSeed?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name#resource_type DataAzurecafName#resource_type}
  */
  readonly resourceType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name#separator DataAzurecafName#separator}
  */
  readonly separator?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name#suffixes DataAzurecafName#suffixes}
  */
  readonly suffixes?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name#use_slug DataAzurecafName#use_slug}
  */
  readonly useSlug?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name azurecaf_name}
*/
export class DataAzurecafName extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataAzurecafName resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAzurecafName to import
  * @param importFromId The id of the existing DataAzurecafName that should be imported. Refer to the {@link https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAzurecafName to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/aztfmod/azurecaf/1.2.31/docs/data-sources/name azurecaf_name} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAzurecafNameConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAzurecafNameConfig = {}) {
    super(scope, id, {
