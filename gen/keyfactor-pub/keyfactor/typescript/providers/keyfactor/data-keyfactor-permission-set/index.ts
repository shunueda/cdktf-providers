...
export interface DataKeyfactorPermissionSetConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DataKeyfactorPermissionSet extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "keyfactor_permission_set";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "keyfactor_permission_set", importId: importFromId, provider });
      }
  ...
  * @param options DataKeyfactorPermissionSetConfig
  */
  public constructor(scope: Construct, id: string, config: DataKeyfactorPermissionSetConfig) {
    super(scope, id, {
