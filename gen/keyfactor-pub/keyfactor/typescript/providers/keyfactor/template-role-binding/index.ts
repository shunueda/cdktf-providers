// https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.7.0/docs/resources/template_role_binding
...
export interface TemplateRoleBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.7.0/docs/resources/template_role_binding#role_name TemplateRoleBinding#role_name}
  */
  readonly roleName: string;
  /**
  * A list of certificate template short name in Keyfactor that the role will be attached to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.7.0/docs/resources/template_role_binding#template_short_names TemplateRoleBinding#template_short_names}
  */
  readonly templateShortNames?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.7.0/docs/resources/template_role_binding keyfactor_template_role_binding}
*/
export class TemplateRoleBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TemplateRoleBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.7.0/docs/resources/template_role_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.7.0/docs/resources/template_role_binding keyfactor_template_role_binding} Resource
  *
  * @param scope The scope in which to define this construct
