// https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.6.0/docs/resources/identity
...
export interface IdentityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.6.0/docs/resources/identity#account_name Identity#account_name}
  */
  readonly accountName: string;
  /**
  * An array containing the role IDs that the identity is attached to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.6.0/docs/resources/identity#roles Identity#roles}
  */
  readonly roles?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.6.0/docs/resources/identity keyfactor_identity}
*/
export class Identity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Identity that should be imported. Refer to the {@link https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.6.0/docs/resources/identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.6.0/docs/resources/identity keyfactor_identity} Resource
  *
  * @param scope The scope in which to define this construct
