// https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.7.0/docs/data-sources/agent
...
export interface DataKeyfactorAgentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.7.0/docs/data-sources/agent#agent_identifier DataKeyfactorAgent#agent_identifier}
  */
  readonly agentIdentifier: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.7.0/docs/data-sources/agent keyfactor_agent}
*/
export class DataKeyfactorAgent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKeyfactorAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.7.0/docs/data-sources/agent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/keyfactor-pub/keyfactor/2.7.0/docs/data-sources/agent keyfactor_agent} Data Source
  *
  * @param scope The scope in which to define this construct
