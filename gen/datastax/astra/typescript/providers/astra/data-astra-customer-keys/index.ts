// https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/customer_keys
...
export interface DataAstraCustomerKeysConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/customer_keys#id DataAstraCustomerKeys#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/customer_keys astra_customer_keys}
*/
export class DataAstraCustomerKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAstraCustomerKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/customer_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/customer_keys astra_customer_keys} Data Source
  *
  * @param scope The scope in which to define this construct
