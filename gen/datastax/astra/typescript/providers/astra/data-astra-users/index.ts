// https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/users
...
export interface DataAstraUsersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/users#id DataAstraUsers#id}
  *
  ...
  * Organization Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/users#org_name DataAstraUsers#org_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/users astra_users}
*/
export class DataAstraUsers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAstraUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/users astra_users} Data Source
  *
  * @param scope The scope in which to define this construct
