...
export interface DataAstraKeyspacesConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataAstraKeyspacesResults {
}

export function dataAstraKeyspacesResultsToTerraform(struct?: DataAstraKeyspacesResults): any {
...
export function dataAstraKeyspacesResultsToHclTerraform(struct?: DataAstraKeyspacesResults): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAstraKeyspacesResultsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAstraKeyspacesResults | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAstraKeyspacesResults | undefined) {
    if (value === undefined) {
...
export class DataAstraKeyspacesResultsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAstraKeyspacesResultsOutputReference {
    return new DataAstraKeyspacesResultsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAstraKeyspaces extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "astra_keyspaces";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "astra_keyspaces", importId: importFromId, provider });
      }
  ...
  * @param options DataAstraKeyspacesConfig
  */
  public constructor(scope: Construct, id: string, config: DataAstraKeyspacesConfig) {
    super(scope, id, {
  ...
  private _results = new DataAstraKeyspacesResultsList(this, "results", false);
  public get results() {
