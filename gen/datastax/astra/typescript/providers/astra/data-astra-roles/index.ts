...
export interface DataAstraRolesResults {
}

export function dataAstraRolesResultsToTerraform(struct?: DataAstraRolesResults): any {
...
export function dataAstraRolesResultsToHclTerraform(struct?: DataAstraRolesResults): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAstraRolesResultsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAstraRolesResults | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAstraRolesResults | undefined) {
    if (value === undefined) {
...
export class DataAstraRolesResultsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAstraRolesResultsOutputReference {
    return new DataAstraRolesResultsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAstraRoles extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "astra_roles";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "astra_roles", importId: importFromId, provider });
      }
  ...
  * @param options DataAstraRolesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataAstraRolesConfig = {}) {
    super(scope, id, {
  ...
  private _results = new DataAstraRolesResultsList(this, "results", false);
  public get results() {
