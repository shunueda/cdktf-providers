// https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/secure_connect_bundle_url
...
export interface DataAstraSecureConnectBundleUrlConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/secure_connect_bundle_url#database_id DataAstraSecureConnectBundleUrl#database_id}
  */
  readonly databaseId: string;
  /**
  * The ID of the Astra datacenter. If omitted, all bundles will be fetched.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/secure_connect_bundle_url#datacenter_id DataAstraSecureConnectBundleUrl#datacenter_id}
  */
  readonly datacenterId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/secure_connect_bundle_url#id DataAstraSecureConnectBundleUrl#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/secure_connect_bundle_url astra_secure_connect_bundle_url}
*/
export class DataAstraSecureConnectBundleUrl extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAstraSecureConnectBundleUrl that should be imported. Refer to the {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/secure_connect_bundle_url#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/secure_connect_bundle_url astra_secure_connect_bundle_url} Data Source
  *
  * @param scope The scope in which to define this construct
