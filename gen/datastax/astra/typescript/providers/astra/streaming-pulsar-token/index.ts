// https://registry.terraform.io/providers/datastax/astra/2.3.18/docs/resources/streaming_pulsar_token
...
export interface StreamingPulsarTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datastax/astra/2.3.18/docs/resources/streaming_pulsar_token#cluster StreamingPulsarToken#cluster}
  */
  readonly cluster: string;
  /**
  * Name of the tenant.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datastax/astra/2.3.18/docs/resources/streaming_pulsar_token#tenant StreamingPulsarToken#tenant}
  */
  readonly tenant: string;
  /**
  * The relative time until the token expires.  For example 1h, 1d, 1y, etc.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datastax/astra/2.3.18/docs/resources/streaming_pulsar_token#time_to_live StreamingPulsarToken#time_to_live}
  */
  readonly timeToLive?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datastax/astra/2.3.18/docs/resources/streaming_pulsar_token astra_streaming_pulsar_token}
*/
export class StreamingPulsarToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamingPulsarToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/datastax/astra/2.3.18/docs/resources/streaming_pulsar_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datastax/astra/2.3.18/docs/resources/streaming_pulsar_token astra_streaming_pulsar_token} Resource
  *
  * @param scope The scope in which to define this construct
