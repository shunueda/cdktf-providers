...
export interface DataAstraPrivateLinkEndpointsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataAstraPrivateLinkEndpointsResults {
}

export function dataAstraPrivateLinkEndpointsResultsToTerraform(struct?: DataAstraPrivateLinkEndpointsResults): any {
...
export function dataAstraPrivateLinkEndpointsResultsToHclTerraform(struct?: DataAstraPrivateLinkEndpointsResults): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAstraPrivateLinkEndpointsResultsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAstraPrivateLinkEndpointsResults | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAstraPrivateLinkEndpointsResults | undefined) {
    if (value === undefined) {
...
export class DataAstraPrivateLinkEndpointsResultsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAstraPrivateLinkEndpointsResultsOutputReference {
    return new DataAstraPrivateLinkEndpointsResultsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAstraPrivateLinkEndpoints extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "astra_private_link_endpoints";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "astra_private_link_endpoints", importId: importFromId, provider });
      }
  ...
  * @param options DataAstraPrivateLinkEndpointsConfig
  */
  public constructor(scope: Construct, id: string, config: DataAstraPrivateLinkEndpointsConfig) {
    super(scope, id, {
  ...
  private _results = new DataAstraPrivateLinkEndpointsResultsList(this, "results", false);
  public get results() {
