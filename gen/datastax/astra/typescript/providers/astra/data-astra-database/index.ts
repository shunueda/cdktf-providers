// https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/database
...
export interface DataAstraDatabaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/database#database_id DataAstraDatabase#database_id}
  */
  readonly databaseId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/database#id DataAstraDatabase#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/database astra_database}
*/
export class DataAstraDatabase extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAstraDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datastax/astra/2.4.0/docs/data-sources/database astra_database} Data Source
  *
  * @param scope The scope in which to define this construct
