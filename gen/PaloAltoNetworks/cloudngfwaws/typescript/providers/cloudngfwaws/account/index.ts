// https://registry.terraform.io/providers/paloaltonetworks/cloudngfwaws/3.0.4/docs/resources/account
...
export interface AccountConfig extends cdktf.TerraformMetaArguments {
  ...
  * The account ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/cloudngfwaws/3.0.4/docs/resources/account#account_id Account#account_id}
  */
  readonly accountId?: string;
  /**
  * The CFT URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/cloudngfwaws/3.0.4/docs/resources/account#cft_url Account#cft_url}
  */
  readonly cftUrl?: string;
  /**
  * The external ID of the account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/cloudngfwaws/3.0.4/docs/resources/account#external_id Account#external_id}
  */
  readonly externalId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/cloudngfwaws/3.0.4/docs/resources/account#id Account#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/cloudngfwaws/3.0.4/docs/resources/account#onboarding_status Account#onboarding_status}
  */
  readonly onboardingStatus?: string;
  /**
  * Origin of account onboarding
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/cloudngfwaws/3.0.4/docs/resources/account#origin Account#origin}
  */
  readonly origin?: string;
  /**
  * The account ID of cloud NGFW service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/cloudngfwaws/3.0.4/docs/resources/account#service_account_id Account#service_account_id}
  */
  readonly serviceAccountId?: string;
  /**
  * The SNS topic ARN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/cloudngfwaws/3.0.4/docs/resources/account#sns_topic_arn Account#sns_topic_arn}
  */
  readonly snsTopicArn?: string;
  /**
  * The trusted account ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/cloudngfwaws/3.0.4/docs/resources/account#trusted_account Account#trusted_account}
  */
  readonly trustedAccount?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/cloudngfwaws/3.0.4/docs/resources/account cloudngfwaws_account}
*/
export class Account extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Account that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/cloudngfwaws/3.0.4/docs/resources/account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/cloudngfwaws/3.0.4/docs/resources/account cloudngfwaws_account} Resource
  *
  * @param scope The scope in which to define this construct
