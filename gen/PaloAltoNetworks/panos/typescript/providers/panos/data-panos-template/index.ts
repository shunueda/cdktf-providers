// https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.5/docs/data-sources/template
...
export interface DataPanosTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  * The description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.5/docs/data-sources/template#description DataPanosTemplate#description}
  */
  readonly description?: string;
  /**
  * The location of this object.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.5/docs/data-sources/template#location DataPanosTemplate#location}
  */
  readonly location: DataPanosTemplateLocation;
  /**
  * The name of the service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.5/docs/data-sources/template#name DataPanosTemplate#name}
  */
...
export interface DataPanosTemplateLocationPanorama {
  ...
  * The Panorama device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.5/docs/data-sources/template#panorama_device DataPanosTemplate#panorama_device}
  */
...
export interface DataPanosTemplateLocation {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.5/docs/data-sources/template#panorama DataPanosTemplate#panorama}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.5/docs/data-sources/template panos_template}
*/
export class DataPanosTemplate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPanosTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.5/docs/data-sources/template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.5/docs/data-sources/template panos_template} Data Source
  *
  * @param scope The scope in which to define this construct
