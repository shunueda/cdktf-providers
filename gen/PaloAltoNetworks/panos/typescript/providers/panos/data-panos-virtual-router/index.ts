...
export interface DataPanosVirtualRouterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.7/docs/data-sources/virtual_router#administrative_distances DataPanosVirtualRouter#administrative_distances}
  */
  readonly administrativeDistances?: DataPanosVirtualRouterAdministrativeDistances;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.7/docs/data-sources/virtual_router#ecmp DataPanosVirtualRouter#ecmp}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.7/docs/data-sources/virtual_router#location DataPanosVirtualRouter#location}
  */
  readonly location: DataPanosVirtualRouterLocation;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.7/docs/data-sources/virtual_router#multicast DataPanosVirtualRouter#multicast}
  */
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.7/docs/data-sources/virtual_router#protocol DataPanosVirtualRouter#protocol}
  */
  readonly protocol?: DataPanosVirtualRouterProtocol;
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.7/docs/data-sources/virtual_router panos_virtual_router}
*/
export class DataPanosVirtualRouter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPanosVirtualRouter that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.7/docs/data-sources/virtual_router#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/panos/2.0.7/docs/data-sources/virtual_router panos_virtual_router} Data Source
  *
  * @param scope The scope in which to define this construct
