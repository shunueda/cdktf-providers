// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/dos_protection_rule
...
export interface DataScmDosProtectionRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/dos_protection_rule#device DataScmDosProtectionRule#device}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/dos_protection_rule#folder DataScmDosProtectionRule#folder}
  */
  readonly folder?: string;
  /**
  * The UUID of the DNS security profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/dos_protection_rule#id DataScmDosProtectionRule#id}
  *
  ...
  * Rule name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/dos_protection_rule#name DataScmDosProtectionRule#name}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/dos_protection_rule#snippet DataScmDosProtectionRule#snippet}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/dos_protection_rule scm_dos_protection_rule}
*/
export class DataScmDosProtectionRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScmDosProtectionRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/dos_protection_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/dos_protection_rule scm_dos_protection_rule} Data Source
  *
  * @param scope The scope in which to define this construct
