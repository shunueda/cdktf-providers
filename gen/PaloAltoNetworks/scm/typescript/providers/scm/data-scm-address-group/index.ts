// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/address_group
...
export interface DataScmAddressGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/address_group#device DataScmAddressGroup#device}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/address_group#folder DataScmAddressGroup#folder}
  */
  readonly folder?: string;
  /**
  * The UUID of the address group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/address_group#id DataScmAddressGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/address_group#name DataScmAddressGroup#name}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/address_group#snippet DataScmAddressGroup#snippet}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/address_group scm_address_group}
*/
export class DataScmAddressGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScmAddressGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/address_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/address_group scm_address_group} Data Source
  *
  * @param scope The scope in which to define this construct
