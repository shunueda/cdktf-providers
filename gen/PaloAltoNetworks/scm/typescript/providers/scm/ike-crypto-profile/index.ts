// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile
...
export interface IkeCryptoProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile#authentication_multiple IkeCryptoProfile#authentication_multiple}
  */
  readonly authenticationMultiple?: number;
  /**
  * The device in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile#device IkeCryptoProfile#device}
  */
  readonly device?: string;
  /**
  * Dh group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile#dh_group IkeCryptoProfile#dh_group}
  */
  readonly dhGroup: string[];
  /**
  * Encryption algorithm
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile#encryption IkeCryptoProfile#encryption}
  */
  readonly encryption: string[];
  /**
  * The folder in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile#folder IkeCryptoProfile#folder}
  */
  readonly folder?: string;
  /**
  * Hash
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile#hash IkeCryptoProfile#hash}
  */
  readonly hash: string[];
  /**
  * Ike crypto profile lifetime
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile#lifetime IkeCryptoProfile#lifetime}
  */
  readonly lifetime?: IkeCryptoProfileLifetime;
  /**
  * Alphanumeric string begin with letter: [0-9a-zA-Z._-]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile#name IkeCryptoProfile#name}
  */
  readonly name: string;
  /**
  * The snippet in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile#snippet IkeCryptoProfile#snippet}
  */
...
export interface IkeCryptoProfileLifetime {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile#days IkeCryptoProfile#days}
  */
  readonly days?: number;
  /**
  * specify lifetime in hours
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile#hours IkeCryptoProfile#hours}
  */
  readonly hours?: number;
  /**
  * specify lifetime in minutes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile#minutes IkeCryptoProfile#minutes}
  */
  readonly minutes?: number;
  /**
  * specify lifetime in seconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile#seconds IkeCryptoProfile#seconds}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile scm_ike_crypto_profile}
*/
export class IkeCryptoProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IkeCryptoProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/resources/ike_crypto_profile scm_ike_crypto_profile} Resource
  *
  * @param scope The scope in which to define this construct
