// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group
...
export interface ProfileGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Ai security
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group#ai_security ProfileGroup#ai_security}
  */
  readonly aiSecurity?: string[];
  /**
  * Data filtering
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group#data_filtering ProfileGroup#data_filtering}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group#device ProfileGroup#device}
  */
  readonly device?: string;
  /**
  * Dns security
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group#dns_security ProfileGroup#dns_security}
  */
  readonly dnsSecurity?: string[];
  /**
  * File blocking
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group#file_blocking ProfileGroup#file_blocking}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group#folder ProfileGroup#folder}
  */
  readonly folder?: string;
  /**
  * The name of the profile group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group#name ProfileGroup#name}
  */
  readonly name: string;
  /**
  * Saas security
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group#saas_security ProfileGroup#saas_security}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group#snippet ProfileGroup#snippet}
  */
  readonly snippet?: string;
  /**
  * Spyware
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group#spyware ProfileGroup#spyware}
  */
  readonly spyware?: string[];
  /**
  * Url filtering
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group#url_filtering ProfileGroup#url_filtering}
  */
  readonly urlFiltering?: string[];
  /**
  * Virus and wildfire analysis
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group#virus_and_wildfire_analysis ProfileGroup#virus_and_wildfire_analysis}
  */
  readonly virusAndWildfireAnalysis?: string[];
  /**
  * Vulnerability
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group#vulnerability ProfileGroup#vulnerability}
  */
  readonly vulnerability?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group scm_profile_group}
*/
export class ProfileGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProfileGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/profile_group scm_profile_group} Resource
  *
  * @param scope The scope in which to define this construct
