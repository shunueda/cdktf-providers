// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/authentication_sequence
...
export interface AuthenticationSequenceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/authentication_sequence#authentication_profiles AuthenticationSequence#authentication_profiles}
  */
  readonly authenticationProfiles?: string[];
  /**
  * The device in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/authentication_sequence#device AuthenticationSequence#device}
  */
  readonly device?: string;
  /**
  * The folder in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/authentication_sequence#folder AuthenticationSequence#folder}
  */
  readonly folder?: string;
  /**
  * The name of the authentication sequence
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/authentication_sequence#name AuthenticationSequence#name}
  */
  readonly name: string;
  /**
  * The snippet in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/authentication_sequence#snippet AuthenticationSequence#snippet}
  */
  readonly snippet?: string;
  /**
  * Use domain to determine authentication profile?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/authentication_sequence#use_domain_find_profile AuthenticationSequence#use_domain_find_profile}
  */
  readonly useDomainFindProfile?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/authentication_sequence scm_authentication_sequence}
*/
export class AuthenticationSequence extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthenticationSequence that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/authentication_sequence#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/authentication_sequence scm_authentication_sequence} Resource
  *
  * @param scope The scope in which to define this construct
