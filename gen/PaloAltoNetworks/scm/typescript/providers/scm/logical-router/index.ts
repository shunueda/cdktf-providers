...
export interface LogicalRouterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/logical_router#device LogicalRouter#device}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/logical_router#folder LogicalRouter#folder}
  */
  ...
  * Routing stack
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/logical_router#routing_stack LogicalRouter#routing_stack}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/logical_router#snippet LogicalRouter#snippet}
  */
  readonly snippet?: string;
  /**
  * Vrf
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/logical_router#vrf LogicalRouter#vrf}
  */
  readonly vrf?: LogicalRouterVrf[] | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/logical_router scm_logical_router}
*/
export class LogicalRouter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogicalRouter that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/logical_router#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/logical_router scm_logical_router} Resource
  *
  * @param scope The scope in which to define this construct
