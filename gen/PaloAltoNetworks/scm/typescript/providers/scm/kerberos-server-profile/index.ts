// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/kerberos_server_profile
...
export interface KerberosServerProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/kerberos_server_profile#device KerberosServerProfile#device}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/kerberos_server_profile#folder KerberosServerProfile#folder}
  */
  readonly folder?: string;
  /**
  * The name of the Kerberos server profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/kerberos_server_profile#name KerberosServerProfile#name}
  */
  readonly name: string;
  /**
  * The Kerberos server configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/kerberos_server_profile#server KerberosServerProfile#server}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/kerberos_server_profile#snippet KerberosServerProfile#snippet}
  */
...
export interface KerberosServerProfileServer {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/kerberos_server_profile#host KerberosServerProfile#host}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/kerberos_server_profile#port KerberosServerProfile#port}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/kerberos_server_profile scm_kerberos_server_profile}
*/
export class KerberosServerProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KerberosServerProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/kerberos_server_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/kerberos_server_profile scm_kerberos_server_profile} Resource
  *
  * @param scope The scope in which to define this construct
