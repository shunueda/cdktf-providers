// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule
...
export interface SdwanRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  * Action
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#action SdwanRule#action}
  */
  readonly action: SdwanRuleAction;
  /**
  * List of applications
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#application SdwanRule#application}
  */
  readonly application: string[];
  /**
  * Rule description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#description SdwanRule#description}
  */
  readonly description?: string;
  /**
  * List of destination addresses
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#destination SdwanRule#destination}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#device SdwanRule#device}
  */
  readonly device?: string;
  /**
  * Disable rule?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#disabled SdwanRule#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Error correction profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#error_correction_profile SdwanRule#error_correction_profile}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#folder SdwanRule#folder}
  */
  readonly folder?: string;
  /**
  * List of source zones
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#from SdwanRule#from}
  */
  readonly from: string[];
  /**
  * Rule name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#name SdwanRule#name}
  */
  readonly name: string;
  /**
  * Negate destination address(es)?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#negate_destination SdwanRule#negate_destination}
  */
  readonly negateDestination?: boolean | cdktf.IResolvable;
  /**
  * Negate source address(es)?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#negate_source SdwanRule#negate_source}
  */
  readonly negateSource?: boolean | cdktf.IResolvable;
  /**
  * Path quality profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#path_quality_profile SdwanRule#path_quality_profile}
  */
  readonly pathQualityProfile: string;
  /**
  * Rule postion relative to device rules
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#position SdwanRule#position}
  */
  readonly position: string;
  /**
  * SaaS quality profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#saas_quality_profile SdwanRule#saas_quality_profile}
  */
  readonly saasQualityProfile?: string;
  /**
  * List of services
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#service SdwanRule#service}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#snippet SdwanRule#snippet}
  */
  readonly snippet?: string;
  /**
  * List of source addresses
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#source SdwanRule#source}
  */
  readonly source: string[];
  /**
  * List of source users
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#source_user SdwanRule#source_user}
  */
  readonly sourceUser: string[];
  /**
  * List of tags
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#tag SdwanRule#tag}
  */
  readonly tag?: string[];
  /**
  * List of destination zones
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#to SdwanRule#to}
  */
  readonly to: string[];
}
export interface SdwanRuleAction {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#traffic_distribution_profile SdwanRule#traffic_distribution_profile}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule scm_sdwan_rule}
*/
export class SdwanRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SdwanRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/sdwan_rule scm_sdwan_rule} Resource
  *
  * @param scope The scope in which to define this construct
