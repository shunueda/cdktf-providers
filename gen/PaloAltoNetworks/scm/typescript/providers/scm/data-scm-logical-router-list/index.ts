...
export interface DataScmLogicalRouterListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/data-sources/logical_router_list#device DataScmLogicalRouterList#device}
  */
  readonly device?: string;
  /**
  * The folder of the item. Default: Shared.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/data-sources/logical_router_list#folder DataScmLogicalRouterList#folder}
  */
  readonly folder?: string;
  /**
  * The max number of items to return. Default: 200.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/data-sources/logical_router_list#limit DataScmLogicalRouterList#limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/data-sources/logical_router_list#offset DataScmLogicalRouterList#offset}
  */
  readonly offset?: number;
  /**
  * The parameter to mention if the response should be paginated. By default, its set to false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/data-sources/logical_router_list#pagination DataScmLogicalRouterList#pagination}
  */
  readonly pagination?: boolean | cdktf.IResolvable;
  /**
  * The snippet of the item.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/data-sources/logical_router_list#snippet DataScmLogicalRouterList#snippet}
  */
  readonly snippet?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/data-sources/logical_router_list scm_logical_router_list}
*/
export class DataScmLogicalRouterList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScmLogicalRouterList that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/data-sources/logical_router_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.4/docs/data-sources/logical_router_list scm_logical_router_list} Data Source
  *
  * @param scope The scope in which to define this construct
