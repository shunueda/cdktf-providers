// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/internal_dns_server
...
export interface InternalDnsServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/internal_dns_server#domain_name InternalDnsServer#domain_name}
  */
  readonly domainName: string[];
  /**
  * The name of the internet DNS server resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/internal_dns_server#name InternalDnsServer#name}
  */
  readonly name: string;
  /**
  * The IP address of the primary DNS server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/internal_dns_server#primary InternalDnsServer#primary}
  */
  readonly primary: string;
  /**
  * The IP address of the secondary DNS server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/internal_dns_server#secondary InternalDnsServer#secondary}
  */
  readonly secondary?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/internal_dns_server scm_internal_dns_server}
*/
export class InternalDnsServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InternalDnsServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/internal_dns_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/internal_dns_server scm_internal_dns_server} Resource
  *
  * @param scope The scope in which to define this construct
