// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/syslog_server_profile
...
export interface DataScmSyslogServerProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/syslog_server_profile#device DataScmSyslogServerProfile#device}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/syslog_server_profile#folder DataScmSyslogServerProfile#folder}
  */
  readonly folder?: string;
  /**
  * The UUID of the syslog server profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/syslog_server_profile#id DataScmSyslogServerProfile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/syslog_server_profile#name DataScmSyslogServerProfile#name}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/syslog_server_profile#snippet DataScmSyslogServerProfile#snippet}
  */
...
export interface DataScmSyslogServerProfileServer {
}

export function dataScmSyslogServerProfileServerToTerraform(struct?: DataScmSyslogServerProfileServer): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataScmSyslogServerProfileServerToHclTerraform(struct?: DataScmSyslogServerProfileServer): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataScmSyslogServerProfileServerOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataScmSyslogServerProfileServer | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataScmSyslogServerProfileServer | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataScmSyslogServerProfileServerList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataScmSyslogServerProfileServerOutputReference {
    return new DataScmSyslogServerProfileServerOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/syslog_server_profile scm_syslog_server_profile}
*/
export class DataScmSyslogServerProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScmSyslogServerProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/syslog_server_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/syslog_server_profile scm_syslog_server_profile} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // server - computed: true, optional: false, required: false
  private _server = new DataScmSyslogServerProfileServerList(this, "server", false);
  public get server() {
    return this._server;
  }
