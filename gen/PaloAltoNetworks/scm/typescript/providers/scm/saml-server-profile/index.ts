// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile
...
export interface SamlServerProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile#certificate SamlServerProfile#certificate}
  */
  readonly certificate: string;
  /**
  * The device in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile#device SamlServerProfile#device}
  */
  readonly device?: string;
  /**
  * The identity provider ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile#entity_id SamlServerProfile#entity_id}
  */
  readonly entityId: string;
  /**
  * The folder in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile#folder SamlServerProfile#folder}
  */
  readonly folder?: string;
  /**
  * Maxiumum clock skew
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile#max_clock_skew SamlServerProfile#max_clock_skew}
  */
  readonly maxClockSkew?: number;
  /**
  * The name of the SAML server profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile#name SamlServerProfile#name}
  */
  readonly name: string;
  /**
  * SAML HTTP binding for SLO requests to the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile#slo_bindings SamlServerProfile#slo_bindings}
  */
  readonly sloBindings?: string;
  /**
  * The snippet in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile#snippet SamlServerProfile#snippet}
  */
  readonly snippet?: string;
  /**
  * SAML HTTP binding for SSO requests to the identity provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile#sso_bindings SamlServerProfile#sso_bindings}
  */
  readonly ssoBindings: string;
  /**
  * Identity provider SSO URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile#sso_url SamlServerProfile#sso_url}
  */
  readonly ssoUrl: string;
  /**
  * Validate the identity provider certificate?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile#validate_idp_certificate SamlServerProfile#validate_idp_certificate}
  */
  readonly validateIdpCertificate?: boolean | cdktf.IResolvable;
  /**
  * Sign SAML message to the identity provider?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile#want_auth_requests_signed SamlServerProfile#want_auth_requests_signed}
  */
  readonly wantAuthRequestsSigned?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile scm_saml_server_profile}
*/
export class SamlServerProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SamlServerProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/saml_server_profile scm_saml_server_profile} Resource
  *
  * @param scope The scope in which to define this construct
