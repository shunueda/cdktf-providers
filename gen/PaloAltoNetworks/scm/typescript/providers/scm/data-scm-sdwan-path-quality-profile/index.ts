// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/sdwan_path_quality_profile
...
export interface DataScmSdwanPathQualityProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/sdwan_path_quality_profile#device DataScmSdwanPathQualityProfile#device}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/sdwan_path_quality_profile#folder DataScmSdwanPathQualityProfile#folder}
  */
  readonly folder?: string;
  /**
  * UUID of the resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/sdwan_path_quality_profile#id DataScmSdwanPathQualityProfile#id}
  *
  ...
  * Profile name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/sdwan_path_quality_profile#name DataScmSdwanPathQualityProfile#name}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/sdwan_path_quality_profile#snippet DataScmSdwanPathQualityProfile#snippet}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/sdwan_path_quality_profile scm_sdwan_path_quality_profile}
*/
export class DataScmSdwanPathQualityProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScmSdwanPathQualityProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/sdwan_path_quality_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/sdwan_path_quality_profile scm_sdwan_path_quality_profile} Data Source
  *
  * @param scope The scope in which to define this construct
