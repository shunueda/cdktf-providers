// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/file_blocking_profile
...
export interface FileBlockingProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  * Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/file_blocking_profile#description FileBlockingProfile#description}
  */
  readonly description?: string;
  /**
  * The device in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/file_blocking_profile#device FileBlockingProfile#device}
  */
  readonly device?: string;
  /**
  * The folder in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/file_blocking_profile#folder FileBlockingProfile#folder}
  */
  readonly folder?: string;
  /**
  * The name of the file blocking profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/file_blocking_profile#name FileBlockingProfile#name}
  */
  readonly name: string;
  /**
  * A list of file blocking rules
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/file_blocking_profile#rules FileBlockingProfile#rules}
  */
  readonly rules?: FileBlockingProfileRules[] | cdktf.IResolvable;
  /**
  * The snippet in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/file_blocking_profile#snippet FileBlockingProfile#snippet}
  */
...
export interface FileBlockingProfileRules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/file_blocking_profile#action FileBlockingProfile#action}
  */
  readonly action: string;
  /**
  * The application transferring the files (App-ID naming)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/file_blocking_profile#application FileBlockingProfile#application}
  */
  readonly application: string[];
  /**
  * The direction of the file transfer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/file_blocking_profile#direction FileBlockingProfile#direction}
  */
  readonly direction: string;
  /**
  * The file type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/file_blocking_profile#file_type FileBlockingProfile#file_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/file_blocking_profile scm_file_blocking_profile}
*/
export class FileBlockingProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FileBlockingProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/file_blocking_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/file_blocking_profile scm_file_blocking_profile} Resource
  *
  * @param scope The scope in which to define this construct
