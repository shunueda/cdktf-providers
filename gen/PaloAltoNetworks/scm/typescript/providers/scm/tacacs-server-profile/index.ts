// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile
...
export interface TacacsServerProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile#device TacacsServerProfile#device}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile#folder TacacsServerProfile#folder}
  */
  readonly folder?: string;
  /**
  * The name of the TACACS+ server profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile#name TacacsServerProfile#name}
  */
  readonly name: string;
  /**
  * The TACACS+ authentication protocol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile#protocol TacacsServerProfile#protocol}
  */
  readonly protocol: string;
  /**
  * The TACACS+ server configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile#server TacacsServerProfile#server}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile#snippet TacacsServerProfile#snippet}
  */
  readonly snippet?: string;
  /**
  * The TACACS+ timeout (seconds)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile#timeout TacacsServerProfile#timeout}
  */
  readonly timeout?: number;
  /**
  * Use a single TACACS+ connection?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile#use_single_connection TacacsServerProfile#use_single_connection}
  */
...
export interface TacacsServerProfileServer {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile#address TacacsServerProfile#address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile#port TacacsServerProfile#port}
  */
  readonly port?: number;
  /**
  * The TACACS+ secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile#secret TacacsServerProfile#secret}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile scm_tacacs_server_profile}
*/
export class TacacsServerProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TacacsServerProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/tacacs_server_profile scm_tacacs_server_profile} Resource
  *
  * @param scope The scope in which to define this construct
