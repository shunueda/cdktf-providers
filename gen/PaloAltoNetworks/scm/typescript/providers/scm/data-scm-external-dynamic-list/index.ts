// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/external_dynamic_list
...
export interface DataScmExternalDynamicListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/external_dynamic_list#device DataScmExternalDynamicList#device}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/external_dynamic_list#folder DataScmExternalDynamicList#folder}
  */
  readonly folder?: string;
  /**
  * The UUID of the external dynamic list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/external_dynamic_list#id DataScmExternalDynamicList#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/external_dynamic_list#name DataScmExternalDynamicList#name}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/external_dynamic_list#snippet DataScmExternalDynamicList#snippet}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/external_dynamic_list scm_external_dynamic_list}
*/
export class DataScmExternalDynamicList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScmExternalDynamicList that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/external_dynamic_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/external_dynamic_list scm_external_dynamic_list} Data Source
  *
  * @param scope The scope in which to define this construct
