// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile
...
export interface LdapServerProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  * The base DN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#base LdapServerProfile#base}
  */
  readonly base?: string;
  /**
  * The bind DN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#bind_dn LdapServerProfile#bind_dn}
  */
  readonly bindDn?: string;
  /**
  * The bind password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#bind_password LdapServerProfile#bind_password}
  */
  readonly bindPassword?: string;
  /**
  * The bind timeout (seconds)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#bind_timelimit LdapServerProfile#bind_timelimit}
  */
  readonly bindTimelimit?: string;
  /**
  * The device in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#device LdapServerProfile#device}
  */
  readonly device?: string;
  /**
  * The folder in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#folder LdapServerProfile#folder}
  */
  readonly folder?: string;
  /**
  * The LDAP server time
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#ldap_type LdapServerProfile#ldap_type}
  */
  readonly ldapType?: string;
  /**
  * The name of the LDAP server profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#name LdapServerProfile#name}
  */
  readonly name: string;
  /**
  * The search retry interval (seconds)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#retry_interval LdapServerProfile#retry_interval}
  */
  readonly retryInterval?: number;
  /**
  * The LDAP server configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#server LdapServerProfile#server}
  */
  readonly server: LdapServerProfileServer[] | cdktf.IResolvable;
  /**
  * The snippet in which the resource is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#snippet LdapServerProfile#snippet}
  */
  readonly snippet?: string;
  /**
  * Require SSL/TLS secured connection?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#ssl LdapServerProfile#ssl}
  */
  readonly ssl?: boolean | cdktf.IResolvable;
  /**
  * The search timeout (seconds)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#timelimit LdapServerProfile#timelimit}
  */
  readonly timelimit?: number;
  /**
  * Verify server certificate for SSL sessions?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#verify_server_certificate LdapServerProfile#verify_server_certificate}
  */
...
export interface LdapServerProfileServer {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#address LdapServerProfile#address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#port LdapServerProfile#port}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile scm_ldap_server_profile}
*/
export class LdapServerProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LdapServerProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.3/docs/resources/ldap_server_profile scm_ldap_server_profile} Resource
  *
  * @param scope The scope in which to define this construct
