// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/interface_management_profile_list
...
export interface DataScmInterfaceManagementProfileListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/interface_management_profile_list#device DataScmInterfaceManagementProfileList#device}
  */
  readonly device?: string;
  /**
  * The folder of the item. Default: Shared.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/interface_management_profile_list#folder DataScmInterfaceManagementProfileList#folder}
  */
  readonly folder?: string;
  /**
  * The max number of items to return. Default: 200.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/interface_management_profile_list#limit DataScmInterfaceManagementProfileList#limit}
  */
  readonly limit?: number;
  /**
  * The name of the item.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/interface_management_profile_list#name DataScmInterfaceManagementProfileList#name}
  */
  readonly name?: string;
  /**
  * The offset of the first item to return.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/interface_management_profile_list#offset DataScmInterfaceManagementProfileList#offset}
  */
  readonly offset?: number;
  /**
  * The snippet of the item.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/interface_management_profile_list#snippet DataScmInterfaceManagementProfileList#snippet}
  */
  readonly snippet?: string;
}
export interface DataScmInterfaceManagementProfileListDataPermittedIp {
}

export function dataScmInterfaceManagementProfileListDataPermittedIpToTerraform(struct?: DataScmInterfaceManagementProfileListDataPermittedIp): any {
...
export function dataScmInterfaceManagementProfileListDataPermittedIpToHclTerraform(struct?: DataScmInterfaceManagementProfileListDataPermittedIp): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataScmInterfaceManagementProfileListDataPermittedIpOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataScmInterfaceManagementProfileListDataPermittedIp | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataScmInterfaceManagementProfileListDataPermittedIp | undefined) {
    if (value === undefined) {
...
export class DataScmInterfaceManagementProfileListDataPermittedIpList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataScmInterfaceManagementProfileListDataPermittedIpOutputReference {
    return new DataScmInterfaceManagementProfileListDataPermittedIpOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataScmInterfaceManagementProfileListData {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/interface_management_profile_list#id DataScmInterfaceManagementProfileList#id}
  *
...
export class DataScmInterfaceManagementProfileListDataOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _permittedIp = new DataScmInterfaceManagementProfileListDataPermittedIpList(this, "permitted_ip", false);
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/interface_management_profile_list scm_interface_management_profile_list}
*/
export class DataScmInterfaceManagementProfileList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScmInterfaceManagementProfileList that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/interface_management_profile_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/data-sources/interface_management_profile_list scm_interface_management_profile_list} Data Source
  *
  * @param scope The scope in which to define this construct
