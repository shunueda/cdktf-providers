// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.5/docs/resources/service_connection_group
...
export interface ServiceConnectionGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Disable snat
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.5/docs/resources/service_connection_group#disable_snat ServiceConnectionGroup#disable_snat}
  */
  readonly disableSnat?: boolean | cdktf.IResolvable;
  /**
  * Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.5/docs/resources/service_connection_group#name ServiceConnectionGroup#name}
  */
  readonly name: string;
  /**
  * Pbf only
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.5/docs/resources/service_connection_group#pbf_only ServiceConnectionGroup#pbf_only}
  */
  readonly pbfOnly?: boolean | cdktf.IResolvable;
  /**
  * Target
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.5/docs/resources/service_connection_group#target ServiceConnectionGroup#target}
  */
  readonly target: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.5/docs/resources/service_connection_group scm_service_connection_group}
*/
export class ServiceConnectionGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceConnectionGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.5/docs/resources/service_connection_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.5/docs/resources/service_connection_group scm_service_connection_group} Resource
  *
  * @param scope The scope in which to define this construct
