// https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule
...
export interface DecryptionRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#action DecryptionRule#action}
  */
  readonly action: string;
  /**
  * The destination URL category
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#category DecryptionRule#category}
  */
  readonly category: string[];
  /**
  * The description of the decryption rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#description DecryptionRule#description}
  */
  readonly description?: string;
  /**
  * The destination addresses
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#destination DecryptionRule#destination}
  */
  readonly destination: string[];
  /**
  * The Host Integrity Profile of the destination host
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#destination_hip DecryptionRule#destination_hip}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#device DecryptionRule#device}
  */
  readonly device?: string;
  /**
  * Is the rule disabled?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#disabled DecryptionRule#disabled}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#folder DecryptionRule#folder}
  */
  readonly folder?: string;
  /**
  * The source security zone
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#from DecryptionRule#from}
  */
  readonly from: string[];
  /**
  * Log failed decryption events?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#log_fail DecryptionRule#log_fail}
  */
  readonly logFail?: boolean | cdktf.IResolvable;
  /**
  * The log settings of the decryption rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#log_setting DecryptionRule#log_setting}
  */
  readonly logSetting?: string;
  /**
  * Log successful decryption events?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#log_success DecryptionRule#log_success}
  */
  readonly logSuccess?: boolean | cdktf.IResolvable;
  /**
  * The name of the decryption rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#name DecryptionRule#name}
  */
  readonly name: string;
  /**
  * Negate the destination addresses?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#negate_destination DecryptionRule#negate_destination}
  */
  readonly negateDestination?: boolean | cdktf.IResolvable;
  /**
  * Negate the source addresses?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#negate_source DecryptionRule#negate_source}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#position DecryptionRule#position}
  */
  readonly position?: string;
  /**
  * The decryption profile associated with the decryption rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#profile DecryptionRule#profile}
  */
  readonly profile?: string;
  /**
  * Relative positioning rule. String must be one of these: `"before"`, `"after"`, `"top"`, `"bottom"`. If not specified, rule is created at the bottom of the ruleset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#relative_position DecryptionRule#relative_position}
  */
  readonly relativePosition?: string;
  /**
  * The destination services and/or service groups
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#service DecryptionRule#service}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `device`, `folder`, and `snippet`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#snippet DecryptionRule#snippet}
  */
  readonly snippet?: string;
  /**
  * The source addresses
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#source DecryptionRule#source}
  */
  readonly source: string[];
  /**
  * Source hip
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#source_hip DecryptionRule#source_hip}
  */
  readonly sourceHip?: string[];
  /**
  * List of source users and/or groups.  Reserved words include `any`, `pre-login`, `known-user`, and `unknown`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#source_user DecryptionRule#source_user}
  */
  readonly sourceUser: string[];
  /**
  * The tags associated with the decryption rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#tag DecryptionRule#tag}
  */
  readonly tag?: string[];
  /**
  * The name or UUID of the rule to position this rule relative to. Required when `relative_position` is `"before"` or `"after"`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#target_rule DecryptionRule#target_rule}
  */
  readonly targetRule?: string;
  /**
  * The destination security zone
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#to DecryptionRule#to}
  */
  readonly to: string[];
  /**
  * The type of decryption
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#type DecryptionRule#type}
  */
...
export interface DecryptionRuleType {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#ssl_forward_proxy DecryptionRule#ssl_forward_proxy}
  */
  ...
  * > ℹ️ **Note:** You must specify exactly one of `ssl_forward_proxy` and `ssl_inbound_inspection`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#ssl_inbound_inspection DecryptionRule#ssl_inbound_inspection}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule scm_decryption_rule}
*/
export class DecryptionRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DecryptionRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/scm/1.0.6/docs/resources/decryption_rule scm_decryption_rule} Resource
  *
  * @param scope The scope in which to define this construct
