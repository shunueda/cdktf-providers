// https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer
...
export interface MobileUserLoadBalancerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer#cluster MobileUserLoadBalancer#cluster}
  */
  readonly cluster?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer#config_hash MobileUserLoadBalancer#config_hash}
  */
  readonly configHash: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer#content_library_name MobileUserLoadBalancer#content_library_name}
  */
  readonly contentLibraryName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer#datacenter MobileUserLoadBalancer#datacenter}
  */
  readonly datacenter?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer#dataplane_inside_network MobileUserLoadBalancer#dataplane_inside_network}
  */
  readonly dataplaneInsideNetwork?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer#dataplane_outside_network MobileUserLoadBalancer#dataplane_outside_network}
  */
  readonly dataplaneOutsideNetwork?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer#datastore MobileUserLoadBalancer#datastore}
  */
  readonly datastore?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer#deployment_folder MobileUserLoadBalancer#deployment_folder}
  */
  readonly deploymentFolder?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer#id MobileUserLoadBalancer#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer#last_updated MobileUserLoadBalancer#last_updated}
  */
  readonly lastUpdated?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer#management_network MobileUserLoadBalancer#management_network}
  */
  readonly managementNetwork?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer#name MobileUserLoadBalancer#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer#resource_pool MobileUserLoadBalancer#resource_pool}
  */
  readonly resourcePool?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer prismasase-vmware_mobile_user_load_balancer}
*/
export class MobileUserLoadBalancer extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "prismasase-vmware_mobile_user_load_balancer";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a MobileUserLoadBalancer resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the MobileUserLoadBalancer to import
  * @param importFromId The id of the existing MobileUserLoadBalancer that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the MobileUserLoadBalancer to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "prismasase-vmware_mobile_user_load_balancer", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/mobile_user_load_balancer prismasase-vmware_mobile_user_load_balancer} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options MobileUserLoadBalancerConfig
  */
  public constructor(scope: Construct, id: string, config: MobileUserLoadBalancerConfig) {
    super(scope, id, {
      terraformResourceType: 'prismasase-vmware_mobile_user_load_balancer',
