// https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node
...
export interface LocalInspectionNodeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#cluster LocalInspectionNode#cluster}
  */
  readonly cluster?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#config_hash LocalInspectionNode#config_hash}
  */
  readonly configHash: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#content_library_name LocalInspectionNode#content_library_name}
  */
  readonly contentLibraryName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#datacenter LocalInspectionNode#datacenter}
  */
  readonly datacenter?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#dataplane_inside_network LocalInspectionNode#dataplane_inside_network}
  */
  readonly dataplaneInsideNetwork?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#dataplane_outside_network LocalInspectionNode#dataplane_outside_network}
  */
  readonly dataplaneOutsideNetwork?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#datastore LocalInspectionNode#datastore}
  */
  readonly datastore?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#deployment_folder LocalInspectionNode#deployment_folder}
  */
  readonly deploymentFolder?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#id LocalInspectionNode#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#last_updated LocalInspectionNode#last_updated}
  */
  readonly lastUpdated?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#management_network LocalInspectionNode#management_network}
  */
  readonly managementNetwork?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#name LocalInspectionNode#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#resource_pool LocalInspectionNode#resource_pool}
  */
  readonly resourcePool?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#vm_id LocalInspectionNode#vm_id}
  */
  readonly vmId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node prismasase-vmware_local_inspection_node}
*/
export class LocalInspectionNode extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "prismasase-vmware_local_inspection_node";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a LocalInspectionNode resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the LocalInspectionNode to import
  * @param importFromId The id of the existing LocalInspectionNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the LocalInspectionNode to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "prismasase-vmware_local_inspection_node", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/local_inspection_node prismasase-vmware_local_inspection_node} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options LocalInspectionNodeConfig
  */
  public constructor(scope: Construct, id: string, config: LocalInspectionNodeConfig) {
    super(scope, id, {
