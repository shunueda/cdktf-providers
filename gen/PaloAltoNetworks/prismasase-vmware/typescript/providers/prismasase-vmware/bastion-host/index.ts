// https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host
...
export interface BastionHostConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host#cluster BastionHost#cluster}
  */
  readonly cluster?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host#config_hash BastionHost#config_hash}
  */
  readonly configHash: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host#content_library_name BastionHost#content_library_name}
  */
  readonly contentLibraryName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host#datacenter BastionHost#datacenter}
  */
  readonly datacenter?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host#dataplane_inside_network BastionHost#dataplane_inside_network}
  */
  readonly dataplaneInsideNetwork?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host#dataplane_outside_network BastionHost#dataplane_outside_network}
  */
  readonly dataplaneOutsideNetwork?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host#datastore BastionHost#datastore}
  */
  readonly datastore?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host#deployment_folder BastionHost#deployment_folder}
  */
  readonly deploymentFolder?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host#id BastionHost#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host#last_updated BastionHost#last_updated}
  */
  readonly lastUpdated?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host#management_network BastionHost#management_network}
  */
  readonly managementNetwork?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host#name BastionHost#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host#resource_pool BastionHost#resource_pool}
  */
  readonly resourcePool?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host prismasase-vmware_bastion_host}
*/
export class BastionHost extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "prismasase-vmware_bastion_host";
  ...
  * @param importFromId The id of the existing BastionHost that should be imported. Refer to the {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the BastionHost to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "prismasase-vmware_bastion_host", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/paloaltonetworks/prismasase-vmware/1.0.7/docs/resources/bastion_host prismasase-vmware_bastion_host} Resource
  *
  * @param scope The scope in which to define this construct
