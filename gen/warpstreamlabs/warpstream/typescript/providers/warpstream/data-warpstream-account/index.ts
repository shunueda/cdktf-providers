// https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.5/docs/data-sources/account
...
/**
* Represents a {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.5/docs/data-sources/account warpstream_account}
*/
export class DataWarpstreamAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataWarpstreamAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.5/docs/data-sources/account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.5/docs/data-sources/account warpstream_account} Data Source
  *
  * @param scope The scope in which to define this construct
