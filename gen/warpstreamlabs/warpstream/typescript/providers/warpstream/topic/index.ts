// https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/topic
...
export interface TopicConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/topic#enable_deletion_protection Topic#enable_deletion_protection}
  */
  readonly enableDeletionProtection?: boolean | cdktf.IResolvable;
  /**
  * Partition Count of the topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/topic#partition_count Topic#partition_count}
  */
  readonly partitionCount: number;
  /**
  * Topic Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/topic#topic_name Topic#topic_name}
  */
  readonly topicName: string;
  /**
  * Virtual Cluster ID associated with the Topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/topic#virtual_cluster_id Topic#virtual_cluster_id}
  */
  readonly virtualClusterId: string;
  /**
  * config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/topic#config Topic#config}
  */
  readonly config?: TopicConfigA[] | cdktf.IResolvable;
}
export interface TopicConfigA {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/topic#name Topic#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/topic#value Topic#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/topic warpstream_topic}
*/
export class Topic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Topic that should be imported. Refer to the {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/topic warpstream_topic} Resource
  *
  * @param scope The scope in which to define this construct
