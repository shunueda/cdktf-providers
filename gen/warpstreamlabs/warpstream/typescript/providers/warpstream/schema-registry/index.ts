// https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.1/docs/resources/schema_registry
...
export interface SchemaRegistryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.1/docs/resources/schema_registry#cloud SchemaRegistry#cloud}
  */
  readonly cloud?: SchemaRegistryCloud;
  /**
  * Schema Registry Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.1/docs/resources/schema_registry#name SchemaRegistry#name}
  */
...
export interface SchemaRegistryCloud {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.1/docs/resources/schema_registry#provider SchemaRegistry#provider}
  */
  readonly provider?: string;
  /**
  * Cloud Region. Defaults to `us-east-1`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.1/docs/resources/schema_registry#region SchemaRegistry#region}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.1/docs/resources/schema_registry warpstream_schema_registry}
*/
export class SchemaRegistry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchemaRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.1/docs/resources/schema_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.1/docs/resources/schema_registry warpstream_schema_registry} Resource
  *
  * @param scope The scope in which to define this construct
