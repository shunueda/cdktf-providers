// https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/acl
...
export interface AclConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/acl#host Acl#host}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/acl#operation Acl#operation}
  */
  readonly operation: string;
  /**
  * The pattern type for the ACL. Accepted values are `LITERAL` or `PREFIXED`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/acl#pattern_type Acl#pattern_type}
  */
  readonly patternType: string;
  /**
  * The permission for the ACL. Accepted values are: `ALLOW` or `DENY`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/acl#permission_type Acl#permission_type}
  */
  readonly permissionType: string;
  /**
  * The principal for the ACL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/acl#principal Acl#principal}
  */
  readonly principal: string;
  /**
  * The resource name for the ACL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/acl#resource_name Acl#resource_name}
  */
  readonly resourceName: string;
  /**
  * The type of the resource. Accepted values are: `TOPIC`, `GROUP`, `CLUSTER`, `TRANSACTIONAL_ID` or `DELEGATION_TOKEN`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/acl#resource_type Acl#resource_type}
  */
  readonly resourceType: string;
  /**
  * The ID of the Virtual Cluster that the ACL applies to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/acl#virtual_cluster_id Acl#virtual_cluster_id}
  */
  readonly virtualClusterId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/acl warpstream_acl}
*/
export class Acl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Acl that should be imported. Refer to the {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/acl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/acl warpstream_acl} Resource
  *
  * @param scope The scope in which to define this construct
