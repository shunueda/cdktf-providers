// https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.2.2/docs/data-sources/workspace
...
export interface DataWarpstreamWorkspaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.2.2/docs/data-sources/workspace#id DataWarpstreamWorkspace#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.2.2/docs/data-sources/workspace warpstream_workspace}
*/
export class DataWarpstreamWorkspace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataWarpstreamWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.2.2/docs/data-sources/workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.2.2/docs/data-sources/workspace warpstream_workspace} Data Source
  *
  * @param scope The scope in which to define this construct
