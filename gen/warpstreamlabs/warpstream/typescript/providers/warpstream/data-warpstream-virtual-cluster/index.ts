// https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.5/docs/data-sources/virtual_cluster
...
export interface DataWarpstreamVirtualClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.5/docs/data-sources/virtual_cluster#default DataWarpstreamVirtualCluster#default}
  */
  readonly default?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.5/docs/data-sources/virtual_cluster#id DataWarpstreamVirtualCluster#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.5/docs/data-sources/virtual_cluster#name DataWarpstreamVirtualCluster#name}
  */
...
export class DataWarpstreamVirtualClusterConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // enable_acl_shadowing - computed: true, optional: false, required: false
  ...
  // enable_soft_topic_deletion - computed: true, optional: false, required: false
  public get enableSoftTopicDeletion() {
    return this.getBooleanAttribute('enable_soft_topic_deletion');
  }

  // soft_topic_deletion_ttl_millis - computed: true, optional: false, required: false
...
/**
* Represents a {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.5/docs/data-sources/virtual_cluster warpstream_virtual_cluster}
*/
export class DataWarpstreamVirtualCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataWarpstreamVirtualCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.5/docs/data-sources/virtual_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.5/docs/data-sources/virtual_cluster warpstream_virtual_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
