// https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/virtual_cluster_credentials
...
export interface VirtualClusterCredentialsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Deprecated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/virtual_cluster_credentials#agent_pool VirtualClusterCredentials#agent_pool}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/virtual_cluster_credentials#cluster_superuser VirtualClusterCredentials#cluster_superuser}
  */
  readonly clusterSuperuser?: boolean | cdktf.IResolvable;
  /**
  * Virtual Cluster Credentials Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/virtual_cluster_credentials#name VirtualClusterCredentials#name}
  */
  readonly name: string;
  /**
  * Virtual Cluster ID. Deprecated in favor of `virtual_cluster_id`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/virtual_cluster_credentials#virtual_cluster VirtualClusterCredentials#virtual_cluster}
  */
  readonly virtualCluster?: string;
  /**
  * Virtual Cluster ID. Required unless `virtual_cluster` is set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/virtual_cluster_credentials#virtual_cluster_id VirtualClusterCredentials#virtual_cluster_id}
  */
  readonly virtualClusterId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/virtual_cluster_credentials warpstream_virtual_cluster_credentials}
*/
export class VirtualClusterCredentials extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualClusterCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/virtual_cluster_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/virtual_cluster_credentials warpstream_virtual_cluster_credentials} Resource
  *
  * @param scope The scope in which to define this construct
