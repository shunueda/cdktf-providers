// https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/agent_key
...
export interface AgentKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/agent_key#name AgentKey#name}
  */
  readonly name: string;
  /**
  * Virtual Cluster ID associated with the Agent Key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/agent_key#virtual_cluster_id AgentKey#virtual_cluster_id}
  */
  readonly virtualClusterId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/agent_key warpstream_agent_key}
*/
export class AgentKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AgentKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/agent_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/resources/agent_key warpstream_agent_key} Resource
  *
  * @param scope The scope in which to define this construct
