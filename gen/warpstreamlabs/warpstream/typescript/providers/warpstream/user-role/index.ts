// https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.2.3/docs/resources/user_role
...
export interface UserRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.2.3/docs/resources/user_role#access_grants UserRole#access_grants}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.2.3/docs/resources/user_role#name UserRole#name}
  */
...
export interface UserRoleAccessGrants {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.2.3/docs/resources/user_role#grant_type UserRole#grant_type}
  */
  readonly grantType: string;
  /**
  * ID of a workspace that the role has access to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.2.3/docs/resources/user_role#workspace_id UserRole#workspace_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.2.3/docs/resources/user_role warpstream_user_role}
*/
export class UserRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.2.3/docs/resources/user_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.2.3/docs/resources/user_role warpstream_user_role} Resource
  *
  * @param scope The scope in which to define this construct
