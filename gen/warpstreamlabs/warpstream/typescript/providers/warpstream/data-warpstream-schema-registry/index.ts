// https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/data-sources/schema_registry
...
export interface DataWarpstreamSchemaRegistryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/data-sources/schema_registry#id DataWarpstreamSchemaRegistry#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/data-sources/schema_registry#name DataWarpstreamSchemaRegistry#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/data-sources/schema_registry warpstream_schema_registry}
*/
export class DataWarpstreamSchemaRegistry extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataWarpstreamSchemaRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/data-sources/schema_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.4/docs/data-sources/schema_registry warpstream_schema_registry} Data Source
  *
  * @param scope The scope in which to define this construct
