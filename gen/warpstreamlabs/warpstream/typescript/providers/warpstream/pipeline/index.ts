// https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/pipeline
...
export interface PipelineConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/pipeline#configuration_yaml Pipeline#configuration_yaml}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/pipeline#name Pipeline#name}
  */
  readonly name: string;
  /**
  * The desired operational state of the pipeline. Valid values are 'running' or 'paused'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/pipeline#state Pipeline#state}
  */
  readonly state: string;
  /**
  * Pipeline type. Valid types are: `bento` (default), `orbit`, `schema_linking`, `tableflow`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/pipeline#type Pipeline#type}
  */
  readonly type?: string;
  /**
  * The ID of the virtual cluster associated with the pipeline.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/pipeline#virtual_cluster_id Pipeline#virtual_cluster_id}
  */
  readonly virtualClusterId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/pipeline warpstream_pipeline}
*/
export class Pipeline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Pipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/warpstreamlabs/warpstream/2.3.2/docs/resources/pipeline warpstream_pipeline} Resource
  *
  * @param scope The scope in which to define this construct
