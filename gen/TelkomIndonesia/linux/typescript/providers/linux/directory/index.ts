// https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory
...
export interface DirectoryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#group Directory#group}
  */
  readonly group?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#id Directory#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#mode Directory#mode}
  */
  readonly mode?: string;
  /**
  * If true, existing directory on remote will be replaced on create or update. This doesn't affect the content of the directory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#overwrite Directory#overwrite}
  */
  readonly overwrite?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#owner Directory#owner}
  */
  readonly owner?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#path Directory#path}
  */
  readonly path: string;
  /**
  * Path to parent directory of a generated-unix-timestamp directory where the directory will be placed on destroy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#recycle_path Directory#recycle_path}
  */
  readonly recyclePath?: string;
  /**
  * provider_override block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#provider_override Directory#provider_override}
  */
  readonly providerOverride?: DirectoryProviderOverride;
}
export interface DirectoryProviderOverride {
  /**
  * Set to `false` to disable using ssh-agent to authenticate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#agent Directory#agent}
  */
  readonly agent?: boolean | cdktf.IResolvable;
  /**
  * The preferred identity from the ssh agent for authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#agent_identity Directory#agent_identity}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#bastion_certificate Directory#bastion_certificate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#bastion_host Directory#bastion_host}
  */
  readonly bastionHost?: string;
  /**
  * The public key from the remote host or the signing CA, used to verify the host connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#bastion_host_key Directory#bastion_host_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#bastion_password Directory#bastion_password}
  */
  readonly bastionPassword?: string;
  /**
  * The port to use connect to the bastion host. Defaults to the value of the `port` field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#bastion_port Directory#bastion_port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#bastion_private_key Directory#bastion_private_key}
  */
  readonly bastionPrivateKey?: string;
  /**
  * The user for the connection to the bastion host. Defaults to the value of the `user` field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#bastion_user Directory#bastion_user}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#certificate Directory#certificate}
  */
  readonly certificate?: string;
  /**
  * The address of the resource to connect to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#host Directory#host}
  */
  readonly host?: string;
  /**
  * The public key from the remote host or the signing CA, used to verify the connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#host_key Directory#host_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#password Directory#password}
  */
  readonly password?: string;
  /**
  * The port to connect to. Defaults to `22`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#port Directory#port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#private_key Directory#private_key}
  */
  readonly privateKey?: string;
  /**
  * The path used to copy scripts meant for remote execution.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#script_path Directory#script_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#timeout Directory#timeout}
  */
  readonly timeout?: string;
  /**
  * The user that we should use for the connection. Defaults to `root`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#user Directory#user}
  */
  readonly user?: string;
}

export function directoryProviderOverrideToTerraform(struct?: DirectoryProviderOverrideOutputReference | DirectoryProviderOverride): any {
...
export function directoryProviderOverrideToHclTerraform(struct?: DirectoryProviderOverrideOutputReference | DirectoryProviderOverride): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DirectoryProviderOverrideOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DirectoryProviderOverride | undefined {
  ...
  public set internalValue(value: DirectoryProviderOverride | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory linux_directory}
*/
export class Directory extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "linux_directory";
  ...
  * @param importFromId The id of the existing Directory that should be imported. Refer to the {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Directory to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "linux_directory", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/directory linux_directory} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DirectoryConfig) {
    super(scope, id, {
      terraformResourceType: 'linux_directory',
    ...
    this._recyclePath = config.recyclePath;
  ...
  // recycle_path - computed: false, optional: true, required: false
  private _recyclePath?: string; 
  public get recyclePath() {
    return this.getStringAttribute('recycle_path');
  }
  public set recyclePath(value: string) {
    this._recyclePath = value;
  }
  public resetRecyclePath() {
    this._recyclePath = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get recyclePathInput() {
    return this._recyclePath;
  }

  // provider_override - computed: false, optional: true, required: false
  private _providerOverride = new DirectoryProviderOverrideOutputReference(this, "provider_override");
  public get providerOverride() {
    return this._providerOverride;
  }
  public putProviderOverride(value: DirectoryProviderOverride) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      recycle_path: cdktf.stringToTerraform(this._recyclePath),
      provider_override: directoryProviderOverrideToTerraform(this._providerOverride.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      recycle_path: {
        value: cdktf.stringToHclTerraform(this._recyclePath),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      provider_override: {
        value: directoryProviderOverrideToHclTerraform(this._providerOverride.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DirectoryProviderOverrideList",
      },
    };
