// https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script
...
export interface DataLinuxScriptConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#environment DataLinuxScript#environment}
  */
  readonly environment?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#id DataLinuxScript#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#interpreter DataLinuxScript#interpreter}
  */
  readonly interpreter?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#sensitive_environment DataLinuxScript#sensitive_environment}
  */
  readonly sensitiveEnvironment?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#working_directory DataLinuxScript#working_directory}
  */
  readonly workingDirectory?: string;
  /**
  * lifecycle_commands block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#lifecycle_commands DataLinuxScript#lifecycle_commands}
  */
  readonly lifecycleCommands: DataLinuxScriptLifecycleCommands;
  /**
  * provider_override block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#provider_override DataLinuxScript#provider_override}
  */
  readonly providerOverride?: DataLinuxScriptProviderOverride;
}
export interface DataLinuxScriptLifecycleCommands {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#read DataLinuxScript#read}
  */
  readonly read: string;
}

export function dataLinuxScriptLifecycleCommandsToTerraform(struct?: DataLinuxScriptLifecycleCommandsOutputReference | DataLinuxScriptLifecycleCommands): any {
...
export function dataLinuxScriptLifecycleCommandsToHclTerraform(struct?: DataLinuxScriptLifecycleCommandsOutputReference | DataLinuxScriptLifecycleCommands): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataLinuxScriptLifecycleCommandsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataLinuxScriptLifecycleCommands | undefined {
  ...
  public set internalValue(value: DataLinuxScriptLifecycleCommands | undefined) {
    if (value === undefined) {
...
export interface DataLinuxScriptProviderOverride {
  /**
  * Set to `false` to disable using ssh-agent to authenticate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#agent DataLinuxScript#agent}
  */
  readonly agent?: boolean | cdktf.IResolvable;
  /**
  * The preferred identity from the ssh agent for authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#agent_identity DataLinuxScript#agent_identity}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#bastion_certificate DataLinuxScript#bastion_certificate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#bastion_host DataLinuxScript#bastion_host}
  */
  readonly bastionHost?: string;
  /**
  * The public key from the remote host or the signing CA, used to verify the host connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#bastion_host_key DataLinuxScript#bastion_host_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#bastion_password DataLinuxScript#bastion_password}
  */
  readonly bastionPassword?: string;
  /**
  * The port to use connect to the bastion host. Defaults to the value of the `port` field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#bastion_port DataLinuxScript#bastion_port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#bastion_private_key DataLinuxScript#bastion_private_key}
  */
  readonly bastionPrivateKey?: string;
  /**
  * The user for the connection to the bastion host. Defaults to the value of the `user` field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#bastion_user DataLinuxScript#bastion_user}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#certificate DataLinuxScript#certificate}
  */
  readonly certificate?: string;
  /**
  * The address of the resource to connect to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#host DataLinuxScript#host}
  */
  readonly host?: string;
  /**
  * The public key from the remote host or the signing CA, used to verify the connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#host_key DataLinuxScript#host_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#password DataLinuxScript#password}
  */
  readonly password?: string;
  /**
  * The port to connect to. Defaults to `22`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#port DataLinuxScript#port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#private_key DataLinuxScript#private_key}
  */
  readonly privateKey?: string;
  /**
  * The path used to copy scripts meant for remote execution.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#script_path DataLinuxScript#script_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#timeout DataLinuxScript#timeout}
  */
  readonly timeout?: string;
  /**
  * The user that we should use for the connection. Defaults to `root`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#user DataLinuxScript#user}
  */
  readonly user?: string;
}

export function dataLinuxScriptProviderOverrideToTerraform(struct?: DataLinuxScriptProviderOverrideOutputReference | DataLinuxScriptProviderOverride): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataLinuxScriptProviderOverrideToHclTerraform(struct?: DataLinuxScriptProviderOverrideOutputReference | DataLinuxScriptProviderOverride): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataLinuxScriptProviderOverrideOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataLinuxScriptProviderOverride | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataLinuxScriptProviderOverride | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script linux_script}
*/
export class DataLinuxScript extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataLinuxScript resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataLinuxScript to import
  * @param importFromId The id of the existing DataLinuxScript that should be imported. Refer to the {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataLinuxScript to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/data-sources/script linux_script} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataLinuxScriptConfig
  */
  public constructor(scope: Construct, id: string, config: DataLinuxScriptConfig) {
    super(scope, id, {
  ...
  private _lifecycleCommands = new DataLinuxScriptLifecycleCommandsOutputReference(this, "lifecycle_commands");
  public get lifecycleCommands() {
    return this._lifecycleCommands;
  }
  public putLifecycleCommands(value: DataLinuxScriptLifecycleCommands) {
  ...
  private _providerOverride = new DataLinuxScriptProviderOverrideOutputReference(this, "provider_override");
  public get providerOverride() {
    return this._providerOverride;
  }
  public putProviderOverride(value: DataLinuxScriptProviderOverride) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      lifecycle_commands: dataLinuxScriptLifecycleCommandsToTerraform(this._lifecycleCommands.internalValue),
      provider_override: dataLinuxScriptProviderOverrideToTerraform(this._providerOverride.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      lifecycle_commands: {
        value: dataLinuxScriptLifecycleCommandsToHclTerraform(this._lifecycleCommands.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataLinuxScriptLifecycleCommandsList",
      },
      provider_override: {
        value: dataLinuxScriptProviderOverrideToHclTerraform(this._providerOverride.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataLinuxScriptProviderOverrideList",
      },
    };
