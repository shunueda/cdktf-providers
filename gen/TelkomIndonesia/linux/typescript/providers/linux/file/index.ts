// https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file
...
export interface FileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#content File#content}
  */
  readonly content?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#group File#group}
  */
  readonly group?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#id File#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * If true, `content` will be ignored and won't be included in schema diff
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#ignore_content File#ignore_content}
  */
  readonly ignoreContent?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#mode File#mode}
  */
  readonly mode?: string;
  /**
  * If true, existing file on remote will be replaced on create or update
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#overwrite File#overwrite}
  */
  readonly overwrite?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#owner File#owner}
  */
  readonly owner?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#path File#path}
  */
  readonly path: string;
  /**
  * Path to parent directory of a generated-unix-timestamp directory where the file will be placed on destroy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#recycle_path File#recycle_path}
  */
  readonly recyclePath?: string;
  /**
  * provider_override block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#provider_override File#provider_override}
  */
  readonly providerOverride?: FileProviderOverride;
}
export interface FileProviderOverride {
  /**
  * Set to `false` to disable using ssh-agent to authenticate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#agent File#agent}
  */
  readonly agent?: boolean | cdktf.IResolvable;
  /**
  * The preferred identity from the ssh agent for authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#agent_identity File#agent_identity}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#bastion_certificate File#bastion_certificate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#bastion_host File#bastion_host}
  */
  readonly bastionHost?: string;
  /**
  * The public key from the remote host or the signing CA, used to verify the host connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#bastion_host_key File#bastion_host_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#bastion_password File#bastion_password}
  */
  readonly bastionPassword?: string;
  /**
  * The port to use connect to the bastion host. Defaults to the value of the `port` field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#bastion_port File#bastion_port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#bastion_private_key File#bastion_private_key}
  */
  readonly bastionPrivateKey?: string;
  /**
  * The user for the connection to the bastion host. Defaults to the value of the `user` field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#bastion_user File#bastion_user}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#certificate File#certificate}
  */
  readonly certificate?: string;
  /**
  * The address of the resource to connect to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#host File#host}
  */
  readonly host?: string;
  /**
  * The public key from the remote host or the signing CA, used to verify the connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#host_key File#host_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#password File#password}
  */
  readonly password?: string;
  /**
  * The port to connect to. Defaults to `22`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#port File#port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#private_key File#private_key}
  */
  readonly privateKey?: string;
  /**
  * The path used to copy scripts meant for remote execution.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#script_path File#script_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#timeout File#timeout}
  */
  readonly timeout?: string;
  /**
  * The user that we should use for the connection. Defaults to `root`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#user File#user}
  */
  readonly user?: string;
}

export function fileProviderOverrideToTerraform(struct?: FileProviderOverrideOutputReference | FileProviderOverride): any {
...
export function fileProviderOverrideToHclTerraform(struct?: FileProviderOverrideOutputReference | FileProviderOverride): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class FileProviderOverrideOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): FileProviderOverride | undefined {
  ...
  public set internalValue(value: FileProviderOverride | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file linux_file}
*/
export class File extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "linux_file";
  ...
  * @param importFromId The id of the existing File that should be imported. Refer to the {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the File to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "linux_file", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/telkomindonesia/linux/0.7.1/docs/resources/file linux_file} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: FileConfig) {
    ...
    this._id = config.id;
    this._ignoreContent = config.ignoreContent;
  ...
  // ignore_content - computed: false, optional: true, required: false
  private _ignoreContent?: boolean | cdktf.IResolvable; 
  public get ignoreContent() {
    return this.getBooleanAttribute('ignore_content');
  }
  public set ignoreContent(value: boolean | cdktf.IResolvable) {
    this._ignoreContent = value;
  }
  public resetIgnoreContent() {
    this._ignoreContent = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get ignoreContentInput() {
  ...
  private _providerOverride = new FileProviderOverrideOutputReference(this, "provider_override");
  public get providerOverride() {
    return this._providerOverride;
  }
  public putProviderOverride(value: FileProviderOverride) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ignore_content: cdktf.booleanToTerraform(this._ignoreContent),
      ...
      provider_override: fileProviderOverrideToTerraform(this._providerOverride.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ignore_content: {
        value: cdktf.booleanToHclTerraform(this._ignoreContent),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      provider_override: {
        value: fileProviderOverrideToHclTerraform(this._providerOverride.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "FileProviderOverrideList",
      },
    };
