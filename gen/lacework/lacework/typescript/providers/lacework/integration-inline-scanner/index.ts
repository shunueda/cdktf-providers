...
export function integrationInlineScannerIdentifierTagToHclTerraform(struct?: IntegrationInlineScannerIdentifierTag | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class IntegrationInlineScanner extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "lacework_integration_inline_scanner", importId: importFromId, provider });
      }
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      limit_num_scan: {
        value: cdktf.numberToHclTerraform(this._limitNumScan),
        isBlock: false,
        type: "simple",
      ...
      identifier_tag: {
        value: cdktf.listMapperHcl(integrationInlineScannerIdentifierTagToHclTerraform, true)(this._identifierTag.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "IntegrationInlineScannerIdentifierTagList",
      },
    };
