// https://registry.terraform.io/providers/lacework/lacework/2.0.11/docs/resources/external_id
...
export interface ExternalIdConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lacework/lacework/2.0.11/docs/resources/external_id#account_id ExternalId#account_id}
  */
  readonly accountId: string;
  /**
  * The Cloud Service Provider (aws, google, oci, azure)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lacework/lacework/2.0.11/docs/resources/external_id#csp ExternalId#csp}
  */
  readonly csp: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lacework/lacework/2.0.11/docs/resources/external_id#id ExternalId#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/lacework/lacework/2.0.11/docs/resources/external_id lacework_external_id}
*/
export class ExternalId extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExternalId that should be imported. Refer to the {@link https://registry.terraform.io/providers/lacework/lacework/2.0.11/docs/resources/external_id#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lacework/lacework/2.0.11/docs/resources/external_id lacework_external_id} Resource
  *
  * @param scope The scope in which to define this construct
