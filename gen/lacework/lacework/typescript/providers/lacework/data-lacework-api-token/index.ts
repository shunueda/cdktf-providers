// https://registry.terraform.io/providers/lacework/lacework/2.0.11/docs/data-sources/api_token
...
export interface DataLaceworkApiTokenConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/lacework/lacework/2.0.11/docs/data-sources/api_token#id DataLaceworkApiToken#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/lacework/lacework/2.0.11/docs/data-sources/api_token lacework_api_token}
*/
export class DataLaceworkApiToken extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataLaceworkApiToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/lacework/lacework/2.0.11/docs/data-sources/api_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/lacework/lacework/2.0.11/docs/data-sources/api_token lacework_api_token} Data Source
  *
  * @param scope The scope in which to define this construct
