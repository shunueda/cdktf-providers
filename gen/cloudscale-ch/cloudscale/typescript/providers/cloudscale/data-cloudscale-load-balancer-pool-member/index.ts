...
export class DataCloudscaleLoadBalancerPoolMember extends cdktf.TerraformDataSource {
  ...
  * @param options DataCloudscaleLoadBalancerPoolMemberConfig
  */
  public constructor(scope: Construct, id: string, config: DataCloudscaleLoadBalancerPoolMemberConfig) {
    super(scope, id, {
