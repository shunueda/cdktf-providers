// https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/server
...
export interface DataCloudscaleServerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/server#id DataCloudscaleServer#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/server#name DataCloudscaleServer#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/server#status DataCloudscaleServer#status}
  */
  readonly status?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/server#tags DataCloudscaleServer#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/server#zone_slug DataCloudscaleServer#zone_slug}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/server cloudscale_server}
*/
export class DataCloudscaleServer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudscaleServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/server cloudscale_server} Data Source
  *
  * @param scope The scope in which to define this construct
