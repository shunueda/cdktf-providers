// https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/load_balancer_pool
...
export interface DataCloudscaleLoadBalancerPoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/load_balancer_pool#id DataCloudscaleLoadBalancerPool#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/load_balancer_pool#load_balancer_uuid DataCloudscaleLoadBalancerPool#load_balancer_uuid}
  */
  readonly loadBalancerUuid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/load_balancer_pool#name DataCloudscaleLoadBalancerPool#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/load_balancer_pool#tags DataCloudscaleLoadBalancerPool#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/load_balancer_pool cloudscale_load_balancer_pool}
*/
export class DataCloudscaleLoadBalancerPool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudscaleLoadBalancerPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/load_balancer_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudscale-ch/cloudscale/5.0.1/docs/data-sources/load_balancer_pool cloudscale_load_balancer_pool} Data Source
  *
  * @param scope The scope in which to define this construct
