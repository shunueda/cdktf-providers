// https://registry.terraform.io/providers/sap-cloud-infrastructure/sci/2.2.1/docs/data-sources/ccloud_billing_project_masterdata
...
export interface DataCcloudBillingProjectMasterdataConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sap-cloud-infrastructure/sci/2.2.1/docs/data-sources/ccloud_billing_project_masterdata#id DataCcloudBillingProjectMasterdata#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sap-cloud-infrastructure/sci/2.2.1/docs/data-sources/ccloud_billing_project_masterdata#project_id DataCcloudBillingProjectMasterdata#project_id}
  */
  readonly projectId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sap-cloud-infrastructure/sci/2.2.1/docs/data-sources/ccloud_billing_project_masterdata#region DataCcloudBillingProjectMasterdata#region}
  */
  readonly region?: string;
}
export interface DataCcloudBillingProjectMasterdataCostObject {
}

export function dataCcloudBillingProjectMasterdataCostObjectToTerraform(struct?: DataCcloudBillingProjectMasterdataCostObject): any {
...
export function dataCcloudBillingProjectMasterdataCostObjectToHclTerraform(struct?: DataCcloudBillingProjectMasterdataCostObject): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCcloudBillingProjectMasterdataCostObjectOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCcloudBillingProjectMasterdataCostObject | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCcloudBillingProjectMasterdataCostObject | undefined) {
    if (value === undefined) {
...
export class DataCcloudBillingProjectMasterdataCostObjectList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataCcloudBillingProjectMasterdataCostObjectOutputReference {
    return new DataCcloudBillingProjectMasterdataCostObjectOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataCcloudBillingProjectMasterdataExtCertification {
}

export function dataCcloudBillingProjectMasterdataExtCertificationToTerraform(struct?: DataCcloudBillingProjectMasterdataExtCertification): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataCcloudBillingProjectMasterdataExtCertificationToHclTerraform(struct?: DataCcloudBillingProjectMasterdataExtCertification): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCcloudBillingProjectMasterdataExtCertificationOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCcloudBillingProjectMasterdataExtCertification | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCcloudBillingProjectMasterdataExtCertification | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataCcloudBillingProjectMasterdataExtCertificationList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataCcloudBillingProjectMasterdataExtCertificationOutputReference {
    return new DataCcloudBillingProjectMasterdataExtCertificationOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/sap-cloud-infrastructure/sci/2.2.1/docs/data-sources/ccloud_billing_project_masterdata ccloud_billing_project_masterdata}
*/
export class DataCcloudBillingProjectMasterdata extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataCcloudBillingProjectMasterdata resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataCcloudBillingProjectMasterdata to import
  * @param importFromId The id of the existing DataCcloudBillingProjectMasterdata that should be imported. Refer to the {@link https://registry.terraform.io/providers/sap-cloud-infrastructure/sci/2.2.1/docs/data-sources/ccloud_billing_project_masterdata#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataCcloudBillingProjectMasterdata to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sap-cloud-infrastructure/sci/2.2.1/docs/data-sources/ccloud_billing_project_masterdata ccloud_billing_project_masterdata} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataCcloudBillingProjectMasterdataConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataCcloudBillingProjectMasterdataConfig = {}) {
    super(scope, id, {
  ...
  private _costObject = new DataCcloudBillingProjectMasterdataCostObjectList(this, "cost_object", false);
  ...
  private _extCertification = new DataCcloudBillingProjectMasterdataExtCertificationList(this, "ext_certification", false);
