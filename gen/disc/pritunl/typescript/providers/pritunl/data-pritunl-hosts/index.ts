// https://registry.terraform.io/providers/disc/pritunl/0.6.1/docs/data-sources/hosts
...
export interface DataPritunlHostsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disc/pritunl/0.6.1/docs/data-sources/hosts#id DataPritunlHosts#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/disc/pritunl/0.6.1/docs/data-sources/hosts pritunl_hosts}
*/
export class DataPritunlHosts extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPritunlHosts that should be imported. Refer to the {@link https://registry.terraform.io/providers/disc/pritunl/0.6.1/docs/data-sources/hosts#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/disc/pritunl/0.6.1/docs/data-sources/hosts pritunl_hosts} Data Source
  *
  * @param scope The scope in which to define this construct
