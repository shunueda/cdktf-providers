// https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/otel_metrics_ingestion
...
export interface OtelMetricsIngestionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/otel_metrics_ingestion#id OtelMetricsIngestion#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/otel_metrics_ingestion#resource_attributes OtelMetricsIngestion#resource_attributes}
  */
...
export interface OtelMetricsIngestionResourceAttributes {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/otel_metrics_ingestion#exclude_keys OtelMetricsIngestion#exclude_keys}
  */
  readonly excludeKeys?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/otel_metrics_ingestion#filter_mode OtelMetricsIngestion#filter_mode}
  */
  readonly filterMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/otel_metrics_ingestion#flatten_mode OtelMetricsIngestion#flatten_mode}
  */
  readonly flattenMode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/otel_metrics_ingestion#generate_target_info OtelMetricsIngestion#generate_target_info}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/otel_metrics_ingestion chronosphere_otel_metrics_ingestion}
*/
export class OtelMetricsIngestion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OtelMetricsIngestion that should be imported. Refer to the {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/otel_metrics_ingestion#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/otel_metrics_ingestion chronosphere_otel_metrics_ingestion} Resource
  *
  * @param scope The scope in which to define this construct
