...
export class RollupRule extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: RollupRuleConfig) {
    ...
    this._skipOnConflict = config.skipOnConflict;
  ...
  // skip_on_conflict - computed: false, optional: true, required: false
  private _skipOnConflict?: boolean | cdktf.IResolvable; 
  public get skipOnConflict() {
    return this.getBooleanAttribute('skip_on_conflict');
  }
  public set skipOnConflict(value: boolean | cdktf.IResolvable) {
    this._skipOnConflict = value;
  }
  public resetSkipOnConflict() {
    this._skipOnConflict = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get skipOnConflictInput() {
    return this._skipOnConflict;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      skip_on_conflict: cdktf.booleanToTerraform(this._skipOnConflict),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      skip_on_conflict: {
        value: cdktf.booleanToHclTerraform(this._skipOnConflict),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
