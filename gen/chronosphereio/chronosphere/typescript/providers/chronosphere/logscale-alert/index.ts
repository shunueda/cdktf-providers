// https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert
...
export interface LogscaleAlertConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#action_ids LogscaleAlert#action_ids}
  */
  readonly actionIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#alert_type LogscaleAlert#alert_type}
  */
  readonly alertType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#description LogscaleAlert#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#disabled LogscaleAlert#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#id LogscaleAlert#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#name LogscaleAlert#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#query LogscaleAlert#query}
  */
  readonly query?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#repository LogscaleAlert#repository}
  */
  readonly repository: string;
  /**
  * Email of the user that the alert runs on behalf of
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#run_as_user LogscaleAlert#run_as_user}
  */
  readonly runAsUser: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#slug LogscaleAlert#slug}
  */
  readonly slug?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#tags LogscaleAlert#tags}
  */
  readonly tags?: string[];
  /**
  * Required for STANDARD type alerts, optional for FILTER type alerts
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#throttle_duration LogscaleAlert#throttle_duration}
  */
  readonly throttleDuration?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#throttle_field LogscaleAlert#throttle_field}
  */
  readonly throttleField?: string;
  /**
  * Required for STANDARD type alerts, ignored for FILTER type alerts
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#time_window LogscaleAlert#time_window}
  */
  readonly timeWindow?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert chronosphere_logscale_alert}
*/
export class LogscaleAlert extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogscaleAlert that should be imported. Refer to the {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/logscale_alert chronosphere_logscale_alert} Resource
  *
  * @param scope The scope in which to define this construct
