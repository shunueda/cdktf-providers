// https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule
...
export interface DropRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule#activated_drop_duration DropRule#activated_drop_duration}
  */
  readonly activatedDropDuration?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule#active DropRule#active}
  */
  readonly active?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule#conditional_drop DropRule#conditional_drop}
  */
  readonly conditionalDrop?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule#drop_nan_value DropRule#drop_nan_value}
  */
  readonly dropNanValue?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule#id DropRule#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule#mode DropRule#mode}
  */
  readonly mode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule#name DropRule#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule#query DropRule#query}
  */
  readonly query: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule#rate_limit_threshold DropRule#rate_limit_threshold}
  */
  readonly rateLimitThreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule#slug DropRule#slug}
  */
  readonly slug?: string;
  /**
  * value_based_drop block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule#value_based_drop DropRule#value_based_drop}
  */
  readonly valueBasedDrop?: DropRuleValueBasedDrop;
}
export interface DropRuleValueBasedDrop {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule#target_drop_value DropRule#target_drop_value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule chronosphere_drop_rule}
*/
export class DropRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DropRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.19.0/docs/resources/drop_rule chronosphere_drop_rule} Resource
  *
  * @param scope The scope in which to define this construct
