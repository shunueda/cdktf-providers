// https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/gcp_metrics_integration
...
export interface GcpMetricsIntegrationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/gcp_metrics_integration#id GcpMetricsIntegration#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/gcp_metrics_integration#name GcpMetricsIntegration#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/gcp_metrics_integration#slug GcpMetricsIntegration#slug}
  */
  readonly slug?: string;
  /**
  * metric_groups block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/gcp_metrics_integration#metric_groups GcpMetricsIntegration#metric_groups}
  */
  readonly metricGroups?: GcpMetricsIntegrationMetricGroups[] | cdktf.IResolvable;
  /**
  * service_account block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/gcp_metrics_integration#service_account GcpMetricsIntegration#service_account}
  */
  readonly serviceAccount?: GcpMetricsIntegrationServiceAccount;
}
export interface GcpMetricsIntegrationMetricGroups {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/gcp_metrics_integration#prefixes GcpMetricsIntegration#prefixes}
  */
  readonly prefixes?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/gcp_metrics_integration#project_id GcpMetricsIntegration#project_id}
  */
...
export interface GcpMetricsIntegrationServiceAccount {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/gcp_metrics_integration#client_email GcpMetricsIntegration#client_email}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/gcp_metrics_integration chronosphere_gcp_metrics_integration}
*/
export class GcpMetricsIntegration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GcpMetricsIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/gcp_metrics_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/chronosphereio/chronosphere/1.17.0/docs/resources/gcp_metrics_integration chronosphere_gcp_metrics_integration} Resource
  *
  * @param scope The scope in which to define this construct
