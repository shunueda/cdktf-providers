// https://registry.terraform.io/providers/upcloudltd/upcloud/5.32.0/docs/resources/storage
...
export class Storage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Storage that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.32.0/docs/resources/storage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.32.0/docs/resources/storage upcloud_storage} Resource
  *
  * @param scope The scope in which to define this construct
