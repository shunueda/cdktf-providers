// https://registry.terraform.io/providers/upcloudltd/upcloud/5.32.0/docs/resources/managed_database_valkey
...
export interface ManagedDatabaseValkeyConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly additionalDiskSpaceGib?: number;
  /**
...
export class ManagedDatabaseValkey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedDatabaseValkey that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.32.0/docs/resources/managed_database_valkey#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.32.0/docs/resources/managed_database_valkey upcloud_managed_database_valkey} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ManagedDatabaseValkeyConfig) {
    ...
    this._additionalDiskSpaceGib = config.additionalDiskSpaceGib;
    this._id = config.id;
  ...
  // additional_disk_space_gib - computed: true, optional: true, required: false
  private _additionalDiskSpaceGib?: number; 
  public get additionalDiskSpaceGib() {
    return this.getNumberAttribute('additional_disk_space_gib');
  }
  public set additionalDiskSpaceGib(value: number) {
    this._additionalDiskSpaceGib = value;
  }
  public resetAdditionalDiskSpaceGib() {
    this._additionalDiskSpaceGib = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get additionalDiskSpaceGibInput() {
    return this._additionalDiskSpaceGib;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      additional_disk_space_gib: cdktf.numberToTerraform(this._additionalDiskSpaceGib),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      additional_disk_space_gib: {
        value: cdktf.numberToHclTerraform(this._additionalDiskSpaceGib),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
