// https://registry.terraform.io/providers/upcloudltd/upcloud/5.31.0/docs/data-sources/networks
...
export class DataUpcloudNetworks extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataUpcloudNetworks that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.31.0/docs/data-sources/networks#import import section} in the documentation of this resource for the id to use
