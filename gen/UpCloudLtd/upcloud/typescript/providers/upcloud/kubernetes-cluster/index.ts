// https://registry.terraform.io/providers/upcloudltd/upcloud/5.31.0/docs/resources/kubernetes_cluster
...
export class KubernetesCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.31.0/docs/resources/kubernetes_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: KubernetesClusterConfig) {
    ...
    this._upgradeStrategyType = config.upgradeStrategyType;
  ...
  // upgrade_strategy_type - computed: false, optional: true, required: false
  private _upgradeStrategyType?: string; 
  public get upgradeStrategyType() {
    return this.getStringAttribute('upgrade_strategy_type');
  }
  public set upgradeStrategyType(value: string) {
    this._upgradeStrategyType = value;
  }
  public resetUpgradeStrategyType() {
    this._upgradeStrategyType = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get upgradeStrategyTypeInput() {
    return this._upgradeStrategyType;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      upgrade_strategy_type: cdktf.stringToTerraform(this._upgradeStrategyType),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      upgrade_strategy_type: {
        value: cdktf.stringToHclTerraform(this._upgradeStrategyType),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
