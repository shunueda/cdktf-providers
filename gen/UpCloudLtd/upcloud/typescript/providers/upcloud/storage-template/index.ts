// https://registry.terraform.io/providers/upcloudltd/upcloud/5.31.1/docs/resources/storage_template
...
export interface StorageTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.31.1/docs/resources/storage_template#labels StorageTemplate#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The source storage that is used as a base for this storage template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.31.1/docs/resources/storage_template#source_storage StorageTemplate#source_storage}
  */
  readonly sourceStorage: string;
  /**
  * The title of the storage.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.31.1/docs/resources/storage_template#title StorageTemplate#title}
  */
  readonly title: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.31.1/docs/resources/storage_template upcloud_storage_template}
*/
export class StorageTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.31.1/docs/resources/storage_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.31.1/docs/resources/storage_template upcloud_storage_template} Resource
  *
  * @param scope The scope in which to define this construct
