// https://registry.terraform.io/providers/upcloudltd/upcloud/5.32.0/docs/resources/loadbalancer_frontend_rule
...
export class LoadbalancerFrontendRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LoadbalancerFrontendRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/upcloudltd/upcloud/5.32.0/docs/resources/loadbalancer_frontend_rule#import import section} in the documentation of this resource for the id to use
