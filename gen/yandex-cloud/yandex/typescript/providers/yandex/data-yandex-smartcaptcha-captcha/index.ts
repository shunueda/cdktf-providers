// https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/smartcaptcha_captcha
...
export interface DataYandexSmartcaptchaCaptchaConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the Captcha.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/smartcaptcha_captcha#captcha_id DataYandexSmartcaptchaCaptcha#captcha_id}
  */
  readonly captchaId?: string;
  /**
  * The `Cloud ID` which resource belongs to. If it is not provided, the default provider `cloud-id` is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/smartcaptcha_captcha#cloud_id DataYandexSmartcaptchaCaptcha#cloud_id}
  */
  readonly cloudId?: string;
  /**
  * The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/smartcaptcha_captcha#folder_id DataYandexSmartcaptchaCaptcha#folder_id}
  */
  readonly folderId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/smartcaptcha_captcha#id DataYandexSmartcaptchaCaptcha#id}
  *
  ...
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/smartcaptcha_captcha#name DataYandexSmartcaptchaCaptcha#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/smartcaptcha_captcha yandex_smartcaptcha_captcha}
*/
export class DataYandexSmartcaptchaCaptcha extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataYandexSmartcaptchaCaptcha that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/smartcaptcha_captcha#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/smartcaptcha_captcha yandex_smartcaptcha_captcha} Data Source
  *
  * @param scope The scope in which to define this construct
