// https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/serverless_container_iam_binding
...
export interface ServerlessContainerIamBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/serverless_container_iam_binding#container_id ServerlessContainerIamBinding#container_id}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/serverless_container_iam_binding#members ServerlessContainerIamBinding#members}
  */
  readonly members: string[];
  /**
  * The role that should be assigned. Only one yandex_serverless_container_iam_binding can be used per role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/serverless_container_iam_binding#role ServerlessContainerIamBinding#role}
  */
  readonly role: string;
  /**
  * For test purposes, to compensate IAM operations delay
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/serverless_container_iam_binding#sleep_after ServerlessContainerIamBinding#sleep_after}
  */
  readonly sleepAfter?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/serverless_container_iam_binding yandex_serverless_container_iam_binding}
*/
export class ServerlessContainerIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServerlessContainerIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/serverless_container_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/serverless_container_iam_binding yandex_serverless_container_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
