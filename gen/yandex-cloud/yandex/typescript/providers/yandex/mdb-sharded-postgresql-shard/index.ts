// https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/resources/mdb_sharded_postgresql_shard
...
export interface MdbShardedPostgresqlShardConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/resources/mdb_sharded_postgresql_shard#cluster_id MdbShardedPostgresqlShard#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Name of the Sharded PostgreSQL shard. Provided by the client when the shard is added.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/resources/mdb_sharded_postgresql_shard#name MdbShardedPostgresqlShard#name}
  */
  readonly name: string;
  /**
  * Shard specification required to add shard into cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/resources/mdb_sharded_postgresql_shard#shard_spec MdbShardedPostgresqlShard#shard_spec}
  */
...
export interface MdbShardedPostgresqlShardShardSpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/resources/mdb_sharded_postgresql_shard#mdb_postgresql MdbShardedPostgresqlShard#mdb_postgresql}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/resources/mdb_sharded_postgresql_shard yandex_mdb_sharded_postgresql_shard}
*/
export class MdbShardedPostgresqlShard extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MdbShardedPostgresqlShard that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/resources/mdb_sharded_postgresql_shard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/resources/mdb_sharded_postgresql_shard yandex_mdb_sharded_postgresql_shard} Resource
  *
  * @param scope The scope in which to define this construct
