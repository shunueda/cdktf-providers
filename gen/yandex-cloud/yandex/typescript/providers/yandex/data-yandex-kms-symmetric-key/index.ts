// https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/kms_symmetric_key
...
export interface DataYandexKmsSymmetricKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/kms_symmetric_key#default_algorithm DataYandexKmsSymmetricKey#default_algorithm}
  */
  readonly defaultAlgorithm?: string;
  /**
  * The `true` value means that resource is protected from accidental deletion.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/kms_symmetric_key#deletion_protection DataYandexKmsSymmetricKey#deletion_protection}
  */
  readonly deletionProtection?: boolean | cdktf.IResolvable;
  /**
  * The resource description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/kms_symmetric_key#description DataYandexKmsSymmetricKey#description}
  */
  readonly description?: string;
  /**
  * The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/kms_symmetric_key#folder_id DataYandexKmsSymmetricKey#folder_id}
  */
  readonly folderId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/kms_symmetric_key#id DataYandexKmsSymmetricKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/kms_symmetric_key#labels DataYandexKmsSymmetricKey#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/kms_symmetric_key#name DataYandexKmsSymmetricKey#name}
  */
  readonly name?: string;
  /**
  * Interval between automatic rotations. To disable automatic rotation, omit this parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/kms_symmetric_key#rotation_period DataYandexKmsSymmetricKey#rotation_period}
  */
  readonly rotationPeriod?: string;
  /**
  * The symmetric key ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/kms_symmetric_key#symmetric_key_id DataYandexKmsSymmetricKey#symmetric_key_id}
  */
  readonly symmetricKeyId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/kms_symmetric_key yandex_kms_symmetric_key}
*/
export class DataYandexKmsSymmetricKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataYandexKmsSymmetricKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/kms_symmetric_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/kms_symmetric_key yandex_kms_symmetric_key} Data Source
  *
  * @param scope The scope in which to define this construct
