// https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device
...
export interface IotCoreDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device#aliases IotCoreDevice#aliases}
  */
  readonly aliases?: { [key: string]: string };
  /**
  * A set of certificate's fingerprints for the IoT Core Device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device#certificates IotCoreDevice#certificates}
  */
  readonly certificates?: string[];
  /**
  * The resource description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device#description IotCoreDevice#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device#id IotCoreDevice#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device#labels IotCoreDevice#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device#name IotCoreDevice#name}
  */
  readonly name: string;
  /**
  * A set of passwords's id for the IoT Core Device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device#passwords IotCoreDevice#passwords}
  */
  readonly passwords?: string[];
  /**
  * IoT Core Registry ID for the IoT Core Device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device#registry_id IotCoreDevice#registry_id}
  */
  readonly registryId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device#timeouts IotCoreDevice#timeouts}
  */
  readonly timeouts?: IotCoreDeviceTimeouts;
}
export interface IotCoreDeviceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device#create IotCoreDevice#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device#delete IotCoreDevice#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device#update IotCoreDevice#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device yandex_iot_core_device}
*/
export class IotCoreDevice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotCoreDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/iot_core_device yandex_iot_core_device} Resource
  *
  * @param scope The scope in which to define this construct
