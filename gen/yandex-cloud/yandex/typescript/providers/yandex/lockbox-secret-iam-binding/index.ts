// https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/lockbox_secret_iam_binding
...
export interface LockboxSecretIamBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/lockbox_secret_iam_binding#members LockboxSecretIamBinding#members}
  */
  readonly members: string[];
  /**
  * The role that should be assigned. Only one yandex_lockbox_secret_iam_binding can be used per role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/lockbox_secret_iam_binding#role LockboxSecretIamBinding#role}
  */
  readonly role: string;
  /**
  * The ID of the compute `secret` to attach the policy to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/lockbox_secret_iam_binding#secret_id LockboxSecretIamBinding#secret_id}
  */
  readonly secretId: string;
  /**
  * For test purposes, to compensate IAM operations delay
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/lockbox_secret_iam_binding#sleep_after LockboxSecretIamBinding#sleep_after}
  */
  readonly sleepAfter?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/lockbox_secret_iam_binding yandex_lockbox_secret_iam_binding}
*/
export class LockboxSecretIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LockboxSecretIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/lockbox_secret_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/lockbox_secret_iam_binding yandex_lockbox_secret_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
