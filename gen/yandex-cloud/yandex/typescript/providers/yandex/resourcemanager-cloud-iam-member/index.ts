// https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/resourcemanager_cloud_iam_member
...
export interface ResourcemanagerCloudIamMemberConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/resourcemanager_cloud_iam_member#cloud_id ResourcemanagerCloudIamMember#cloud_id}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/resourcemanager_cloud_iam_member#member ResourcemanagerCloudIamMember#member}
  */
  readonly member: string;
  /**
  * The role that should be assigned. Only one yandex_resourcemanager_cloud_iam_member can be used per role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/resourcemanager_cloud_iam_member#role ResourcemanagerCloudIamMember#role}
  */
  readonly role: string;
  /**
  * For test purposes, to compensate IAM operations delay
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/resourcemanager_cloud_iam_member#sleep_after ResourcemanagerCloudIamMember#sleep_after}
  */
  readonly sleepAfter?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/resourcemanager_cloud_iam_member yandex_resourcemanager_cloud_iam_member}
*/
export class ResourcemanagerCloudIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResourcemanagerCloudIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/resourcemanager_cloud_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/resourcemanager_cloud_iam_member yandex_resourcemanager_cloud_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
