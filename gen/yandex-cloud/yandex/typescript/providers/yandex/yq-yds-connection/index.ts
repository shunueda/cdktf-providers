// https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/yq_yds_connection
...
export interface YqYdsConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/yq_yds_connection#database_id YqYdsConnection#database_id}
  */
  readonly databaseId: string;
  /**
  * The resource description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/yq_yds_connection#description YqYdsConnection#description}
  */
  readonly description?: string;
  /**
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/yq_yds_connection#name YqYdsConnection#name}
  */
  readonly name: string;
  /**
  * The service account ID to access resources on behalf of.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/yq_yds_connection#service_account_id YqYdsConnection#service_account_id}
  */
  readonly serviceAccountId?: string;
  /**
  * Whether to enable shared reading by different queries from the same connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/yq_yds_connection#shared_reading YqYdsConnection#shared_reading}
  */
  readonly sharedReading?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/yq_yds_connection yandex_yq_yds_connection}
*/
export class YqYdsConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing YqYdsConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/yq_yds_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/yq_yds_connection yandex_yq_yds_connection} Resource
  *
  * @param scope The scope in which to define this construct
