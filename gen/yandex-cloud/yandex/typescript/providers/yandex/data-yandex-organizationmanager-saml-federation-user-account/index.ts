// https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/data-sources/organizationmanager_saml_federation_user_account
...
export interface DataYandexOrganizationmanagerSamlFederationUserAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/data-sources/organizationmanager_saml_federation_user_account#federation_id DataYandexOrganizationmanagerSamlFederationUserAccount#federation_id}
  */
  readonly federationId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/data-sources/organizationmanager_saml_federation_user_account#id DataYandexOrganizationmanagerSamlFederationUserAccount#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/data-sources/organizationmanager_saml_federation_user_account#name_id DataYandexOrganizationmanagerSamlFederationUserAccount#name_id}
  */
  readonly nameId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/data-sources/organizationmanager_saml_federation_user_account yandex_organizationmanager_saml_federation_user_account}
*/
export class DataYandexOrganizationmanagerSamlFederationUserAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataYandexOrganizationmanagerSamlFederationUserAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/data-sources/organizationmanager_saml_federation_user_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/data-sources/organizationmanager_saml_federation_user_account yandex_organizationmanager_saml_federation_user_account} Data Source
  *
  * @param scope The scope in which to define this construct
