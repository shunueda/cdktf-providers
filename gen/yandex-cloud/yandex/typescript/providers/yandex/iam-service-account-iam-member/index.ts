// https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/iam_service_account_iam_member
...
export interface IamServiceAccountIamMemberConfig extends cdktf.TerraformMetaArguments {
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/iam_service_account_iam_member#member IamServiceAccountIamMember#member}
  */
  readonly member: string;
  /**
  * The role that should be assigned. Only one yandex_iam_service_account_iam_member can be used per role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/iam_service_account_iam_member#role IamServiceAccountIamMember#role}
  */
  readonly role: string;
  /**
  * The ID of the compute `service_account` to attach the policy to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/iam_service_account_iam_member#service_account_id IamServiceAccountIamMember#service_account_id}
  */
  readonly serviceAccountId: string;
  /**
  * For test purposes, to compensate IAM operations delay
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/iam_service_account_iam_member#sleep_after IamServiceAccountIamMember#sleep_after}
  */
  readonly sleepAfter?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/iam_service_account_iam_member yandex_iam_service_account_iam_member}
*/
export class IamServiceAccountIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamServiceAccountIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/iam_service_account_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/iam_service_account_iam_member yandex_iam_service_account_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
