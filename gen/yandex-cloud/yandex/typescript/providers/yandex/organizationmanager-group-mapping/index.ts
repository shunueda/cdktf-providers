// https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/organizationmanager_group_mapping
...
export interface OrganizationmanagerGroupMappingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/organizationmanager_group_mapping#enabled OrganizationmanagerGroupMapping#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * ID of the SAML Federation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/organizationmanager_group_mapping#federation_id OrganizationmanagerGroupMapping#federation_id}
  */
  readonly federationId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/organizationmanager_group_mapping#id OrganizationmanagerGroupMapping#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/organizationmanager_group_mapping#timeouts OrganizationmanagerGroupMapping#timeouts}
  */
  readonly timeouts?: OrganizationmanagerGroupMappingTimeouts;
}
export interface OrganizationmanagerGroupMappingTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/organizationmanager_group_mapping#create OrganizationmanagerGroupMapping#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/organizationmanager_group_mapping#delete OrganizationmanagerGroupMapping#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/organizationmanager_group_mapping#read OrganizationmanagerGroupMapping#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/organizationmanager_group_mapping#update OrganizationmanagerGroupMapping#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/organizationmanager_group_mapping yandex_organizationmanager_group_mapping}
*/
export class OrganizationmanagerGroupMapping extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationmanagerGroupMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/organizationmanager_group_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/organizationmanager_group_mapping yandex_organizationmanager_group_mapping} Resource
  *
  * @param scope The scope in which to define this construct
