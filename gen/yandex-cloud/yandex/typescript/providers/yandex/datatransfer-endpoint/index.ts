...
export interface DatatransferEndpointConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/datatransfer_endpoint#description DatatransferEndpoint#description}
  */
  readonly description?: string;
  /**
  * The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/datatransfer_endpoint#folder_id DatatransferEndpoint#folder_id}
  */
  readonly folderId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/datatransfer_endpoint#id DatatransferEndpoint#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/datatransfer_endpoint#labels DatatransferEndpoint#labels}
  */
  ...
  * settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/datatransfer_endpoint#settings DatatransferEndpoint#settings}
  */
  readonly settings?: DatatransferEndpointSettings;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/datatransfer_endpoint yandex_datatransfer_endpoint}
*/
export class DatatransferEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatatransferEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/datatransfer_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/datatransfer_endpoint yandex_datatransfer_endpoint} Resource
  *
  * @param scope The scope in which to define this construct
