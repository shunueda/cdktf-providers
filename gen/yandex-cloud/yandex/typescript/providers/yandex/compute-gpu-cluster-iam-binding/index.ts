// https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/compute_gpu_cluster_iam_binding
...
export interface ComputeGpuClusterIamBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/compute_gpu_cluster_iam_binding#gpu_cluster_id ComputeGpuClusterIamBinding#gpu_cluster_id}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/compute_gpu_cluster_iam_binding#members ComputeGpuClusterIamBinding#members}
  */
  readonly members: string[];
  /**
  * The role that should be assigned. Only one yandex_compute_gpu_cluster_iam_binding can be used per role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/compute_gpu_cluster_iam_binding#role ComputeGpuClusterIamBinding#role}
  */
  readonly role: string;
  /**
  * For test purposes, to compensate IAM operations delay
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/compute_gpu_cluster_iam_binding#sleep_after ComputeGpuClusterIamBinding#sleep_after}
  */
  readonly sleepAfter?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/compute_gpu_cluster_iam_binding yandex_compute_gpu_cluster_iam_binding}
*/
export class ComputeGpuClusterIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeGpuClusterIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/compute_gpu_cluster_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/compute_gpu_cluster_iam_binding yandex_compute_gpu_cluster_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
