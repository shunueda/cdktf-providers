// https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic
...
export interface MdbKafkaTopicConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#cluster_id MdbKafkaTopic#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#id MdbKafkaTopic#id}
  *
  ...
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#name MdbKafkaTopic#name}
  */
  readonly name: string;
  /**
  * The number of the topic's partitions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#partitions MdbKafkaTopic#partitions}
  */
  readonly partitions: number;
  /**
  * Amount of data copies (replicas) for the topic in the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#replication_factor MdbKafkaTopic#replication_factor}
  */
  readonly replicationFactor: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#timeouts MdbKafkaTopic#timeouts}
  */
  readonly timeouts?: MdbKafkaTopicTimeouts;
  /**
  * topic_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#topic_config MdbKafkaTopic#topic_config}
  */
  readonly topicConfig?: MdbKafkaTopicTopicConfig;
}
export interface MdbKafkaTopicTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#create MdbKafkaTopic#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#delete MdbKafkaTopic#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#read MdbKafkaTopic#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#update MdbKafkaTopic#update}
  */
...
export interface MdbKafkaTopicTopicConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#cleanup_policy MdbKafkaTopic#cleanup_policy}
  */
  readonly cleanupPolicy?: string;
  /**
  * Compression type of kafka topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#compression_type MdbKafkaTopic#compression_type}
  */
  readonly compressionType?: string;
  /**
  * The amount of time to retain delete tombstone markers for log compacted topics.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#delete_retention_ms MdbKafkaTopic#delete_retention_ms}
  */
  readonly deleteRetentionMs?: string;
  /**
  * The time to wait before deleting a file from the filesystem.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#file_delete_delay_ms MdbKafkaTopic#file_delete_delay_ms}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#flush_messages MdbKafkaTopic#flush_messages}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#flush_ms MdbKafkaTopic#flush_ms}
  */
  readonly flushMs?: string;
  /**
  * The largest record batch size allowed by Kafka (after compression if compression is enabled).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#max_message_bytes MdbKafkaTopic#max_message_bytes}
  */
  readonly maxMessageBytes?: string;
  /**
  * The minimum time a message will remain uncompacted in the log. Only applicable for logs that are being compacted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#min_compaction_lag_ms MdbKafkaTopic#min_compaction_lag_ms}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#min_insync_replicas MdbKafkaTopic#min_insync_replicas}
  */
  readonly minInsyncReplicas?: string;
  /**
  * True if we should preallocate the file on disk when creating a new log segment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#preallocate MdbKafkaTopic#preallocate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#retention_bytes MdbKafkaTopic#retention_bytes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#retention_ms MdbKafkaTopic#retention_ms}
  */
  readonly retentionMs?: string;
  /**
  * This configuration controls the segment file size for the log.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#segment_bytes MdbKafkaTopic#segment_bytes}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic yandex_mdb_kafka_topic}
*/
export class MdbKafkaTopic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MdbKafkaTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/mdb_kafka_topic yandex_mdb_kafka_topic} Resource
  *
  * @param scope The scope in which to define this construct
