// https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/kms_symmetric_key_iam_member
...
export interface KmsSymmetricKeyIamMemberConfig extends cdktf.TerraformMetaArguments {
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/kms_symmetric_key_iam_member#member KmsSymmetricKeyIamMember#member}
  */
  readonly member: string;
  /**
  * The role that should be assigned. Only one yandex_kms_symmetric_key_iam_member can be used per role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/kms_symmetric_key_iam_member#role KmsSymmetricKeyIamMember#role}
  */
  readonly role: string;
  /**
  * For test purposes, to compensate IAM operations delay
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/kms_symmetric_key_iam_member#sleep_after KmsSymmetricKeyIamMember#sleep_after}
  */
  readonly sleepAfter?: number;
  /**
  * The ID of the compute `symmetric_key` to attach the policy to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/kms_symmetric_key_iam_member#symmetric_key_id KmsSymmetricKeyIamMember#symmetric_key_id}
  */
  readonly symmetricKeyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/kms_symmetric_key_iam_member yandex_kms_symmetric_key_iam_member}
*/
export class KmsSymmetricKeyIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsSymmetricKeyIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/kms_symmetric_key_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/kms_symmetric_key_iam_member yandex_kms_symmetric_key_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
