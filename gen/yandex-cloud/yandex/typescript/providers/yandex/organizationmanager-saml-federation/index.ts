// https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation
...
export interface OrganizationmanagerSamlFederationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#auto_create_account_on_login OrganizationmanagerSamlFederation#auto_create_account_on_login}
  */
  readonly autoCreateAccountOnLogin?: boolean | cdktf.IResolvable;
  /**
  * Use case-insensitive name IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#case_insensitive_name_ids OrganizationmanagerSamlFederation#case_insensitive_name_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#cookie_max_age OrganizationmanagerSamlFederation#cookie_max_age}
  */
  readonly cookieMaxAge?: string;
  /**
  * The resource description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#description OrganizationmanagerSamlFederation#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#id OrganizationmanagerSamlFederation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#issuer OrganizationmanagerSamlFederation#issuer}
  */
  readonly issuer: string;
  /**
  * A set of key/value label pairs which assigned to resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#labels OrganizationmanagerSamlFederation#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#name OrganizationmanagerSamlFederation#name}
  */
  readonly name: string;
  /**
  * The organization to attach this SAML Federation to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#organization_id OrganizationmanagerSamlFederation#organization_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#sso_binding OrganizationmanagerSamlFederation#sso_binding}
  */
  readonly ssoBinding: string;
  /**
  * Single sign-on (SSO) endpoint URL. Specify the link to the IdP login page here.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#sso_url OrganizationmanagerSamlFederation#sso_url}
  */
  readonly ssoUrl: string;
  /**
  * security_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#security_settings OrganizationmanagerSamlFederation#security_settings}
  */
  readonly securitySettings?: OrganizationmanagerSamlFederationSecuritySettings;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#timeouts OrganizationmanagerSamlFederation#timeouts}
  */
...
export interface OrganizationmanagerSamlFederationSecuritySettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#encrypted_assertions OrganizationmanagerSamlFederation#encrypted_assertions}
  */
  readonly encryptedAssertions?: boolean | cdktf.IResolvable;
  /**
  * Force authentication on session expiration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#force_authn OrganizationmanagerSamlFederation#force_authn}
  */
...
export function organizationmanagerSamlFederationSecuritySettingsToHclTerraform(struct?: OrganizationmanagerSamlFederationSecuritySettingsOutputReference | OrganizationmanagerSamlFederationSecuritySettings): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    encrypted_assertions: {
      value: cdktf.booleanToHclTerraform(struct!.encryptedAssertions),
      isBlock: false,
      type: "simple",
...
export class OrganizationmanagerSamlFederationSecuritySettingsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // encrypted_assertions - computed: true, optional: true, required: false
  ...
  public resetEncryptedAssertions() {
    this._encryptedAssertions = undefined;
  }
...
export interface OrganizationmanagerSamlFederationTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#create OrganizationmanagerSamlFederation#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#delete OrganizationmanagerSamlFederation#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#read OrganizationmanagerSamlFederation#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#update OrganizationmanagerSamlFederation#update}
  */
  readonly update?: string;
}

export function organizationmanagerSamlFederationTimeoutsToTerraform(struct?: OrganizationmanagerSamlFederationTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function organizationmanagerSamlFederationTimeoutsToHclTerraform(struct?: OrganizationmanagerSamlFederationTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation yandex_organizationmanager_saml_federation}
*/
export class OrganizationmanagerSamlFederation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationmanagerSamlFederation that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/organizationmanager_saml_federation yandex_organizationmanager_saml_federation} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      security_settings: {
        value: organizationmanagerSamlFederationSecuritySettingsToHclTerraform(this._securitySettings.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OrganizationmanagerSamlFederationSecuritySettingsList",
      },
      timeouts: {
        value: organizationmanagerSamlFederationTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "OrganizationmanagerSamlFederationTimeouts",
      },
    };
