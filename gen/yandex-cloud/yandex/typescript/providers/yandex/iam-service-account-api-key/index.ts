// https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_api_key
...
export interface IamServiceAccountApiKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_api_key#description IamServiceAccountApiKey#description}
  */
  readonly description?: string;
  /**
  * The key will be no longer valid after expiration timestamp.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_api_key#expires_at IamServiceAccountApiKey#expires_at}
  */
  readonly expiresAt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_api_key#id IamServiceAccountApiKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_api_key#pgp_key IamServiceAccountApiKey#pgp_key}
  */
  readonly pgpKey?: string;
  /**
  * The scope of the key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_api_key#scope IamServiceAccountApiKey#scope}
  */
  readonly scope?: string;
  /**
  * The list of scopes of the key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_api_key#scopes IamServiceAccountApiKey#scopes}
  */
  readonly scopes?: string[];
  /**
  * ID of the service account to an API key for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_api_key#service_account_id IamServiceAccountApiKey#service_account_id}
  */
  readonly serviceAccountId: string;
  /**
  * output_to_lockbox block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_api_key#output_to_lockbox IamServiceAccountApiKey#output_to_lockbox}
  */
...
export interface IamServiceAccountApiKeyOutputToLockbox {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_api_key#entry_for_secret_key IamServiceAccountApiKey#entry_for_secret_key}
  */
  readonly entryForSecretKey: string;
  /**
  * ID of the Lockbox secret where to store the sensible values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_api_key#secret_id IamServiceAccountApiKey#secret_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_api_key yandex_iam_service_account_api_key}
*/
export class IamServiceAccountApiKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamServiceAccountApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_api_key yandex_iam_service_account_api_key} Resource
  *
  * @param scope The scope in which to define this construct
