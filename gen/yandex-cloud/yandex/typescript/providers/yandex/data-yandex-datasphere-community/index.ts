// https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/datasphere_community
...
export interface DataYandexDatasphereCommunityConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/datasphere_community#billing_account_id DataYandexDatasphereCommunity#billing_account_id}
  */
  readonly billingAccountId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/datasphere_community#id DataYandexDatasphereCommunity#id}
  *
  ...
  */
  readonly id: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/datasphere_community#timeouts DataYandexDatasphereCommunity#timeouts}
  */
...
export interface DataYandexDatasphereCommunityTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/datasphere_community#create DataYandexDatasphereCommunity#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/datasphere_community#delete DataYandexDatasphereCommunity#delete}
  */
  readonly delete?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/datasphere_community#update DataYandexDatasphereCommunity#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/datasphere_community yandex_datasphere_community}
*/
export class DataYandexDatasphereCommunity extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataYandexDatasphereCommunity that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/datasphere_community#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/datasphere_community yandex_datasphere_community} Data Source
  *
  * @param scope The scope in which to define this construct
