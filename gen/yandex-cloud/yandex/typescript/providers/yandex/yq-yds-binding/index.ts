// https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/yq_yds_binding
...
export interface YqYdsBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/yq_yds_binding#compression YqYdsBinding#compression}
  */
  readonly compression?: string;
  /**
  * The connection identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/yq_yds_binding#connection_id YqYdsBinding#connection_id}
  */
  readonly connectionId: string;
  /**
  * The resource description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/yq_yds_binding#description YqYdsBinding#description}
  */
  readonly description?: string;
  /**
  * The data format, e.g. csv_with_names, json_as_string, json_each_row, json_list, parquet, raw, tsv_with_names.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/yq_yds_binding#format YqYdsBinding#format}
  */
  readonly format: string;
  /**
  * Special format setting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/yq_yds_binding#format_setting YqYdsBinding#format_setting}
  */
  readonly formatSetting?: { [key: string]: string };
  /**
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/yq_yds_binding#name YqYdsBinding#name}
  */
  readonly name: string;
  /**
  * The stream name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/yq_yds_binding#stream YqYdsBinding#stream}
  */
  readonly stream: string;
  /**
  * column block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/yq_yds_binding#column YqYdsBinding#column}
  */
...
export interface YqYdsBindingColumn {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/yq_yds_binding#not_null YqYdsBinding#not_null}
  */
  readonly notNull?: boolean | cdktf.IResolvable;
  /**
  * Column data type. YQL data types are used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/yq_yds_binding#type YqYdsBinding#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/yq_yds_binding yandex_yq_yds_binding}
*/
export class YqYdsBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing YqYdsBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/yq_yds_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/yq_yds_binding yandex_yq_yds_binding} Resource
  *
  * @param scope The scope in which to define this construct
