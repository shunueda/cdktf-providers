// https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/iam_user
...
export interface DataYandexIamUserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/iam_user#id DataYandexIamUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/iam_user#login DataYandexIamUser#login}
  */
  readonly login?: string;
  /**
  * User ID used to manage IAM access bindings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/iam_user#user_id DataYandexIamUser#user_id}
  */
  readonly userId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/iam_user yandex_iam_user}
*/
export class DataYandexIamUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataYandexIamUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/iam_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/iam_user yandex_iam_user} Data Source
  *
  * @param scope The scope in which to define this construct
