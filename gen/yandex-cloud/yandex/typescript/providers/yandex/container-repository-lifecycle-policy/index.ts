// https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy
...
export interface ContainerRepositoryLifecyclePolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy#description ContainerRepositoryLifecyclePolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy#id ContainerRepositoryLifecyclePolicy#id}
  *
  ...
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy#name ContainerRepositoryLifecyclePolicy#name}
  */
  readonly name?: string;
  /**
  * The ID of the repository that the resource belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy#repository_id ContainerRepositoryLifecyclePolicy#repository_id}
  */
  readonly repositoryId: string;
  /**
  * The status of lifecycle policy. Must be `active` or `disabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy#status ContainerRepositoryLifecyclePolicy#status}
  */
  readonly status: string;
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy#rule ContainerRepositoryLifecyclePolicy#rule}
  */
  readonly rule?: ContainerRepositoryLifecyclePolicyRule[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy#timeouts ContainerRepositoryLifecyclePolicy#timeouts}
  */
...
export interface ContainerRepositoryLifecyclePolicyRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy#expire_period ContainerRepositoryLifecyclePolicy#expire_period}
  */
  readonly expirePeriod?: string;
  /**
  * The number of images to be retained even if the `expire_period` already expired.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy#retained_top ContainerRepositoryLifecyclePolicy#retained_top}
  */
  readonly retainedTop?: number;
  /**
  * Tag to specify a filter as a regular expression. For example `.*` - all images with tags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy#tag_regexp ContainerRepositoryLifecyclePolicy#tag_regexp}
  */
  readonly tagRegexp?: string;
  /**
  * If enabled, rules apply to untagged Docker images.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy#untagged ContainerRepositoryLifecyclePolicy#untagged}
  */
...
export interface ContainerRepositoryLifecyclePolicyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy#default ContainerRepositoryLifecyclePolicy#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy yandex_container_repository_lifecycle_policy}
*/
export class ContainerRepositoryLifecyclePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerRepositoryLifecyclePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/resources/container_repository_lifecycle_policy yandex_container_repository_lifecycle_policy} Resource
  *
  * @param scope The scope in which to define this construct
