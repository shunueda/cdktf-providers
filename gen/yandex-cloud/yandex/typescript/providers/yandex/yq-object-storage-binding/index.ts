// https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding
...
export interface YqObjectStorageBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding#compression YqObjectStorageBinding#compression}
  */
  readonly compression?: string;
  /**
  * The connection identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding#connection_id YqObjectStorageBinding#connection_id}
  */
  readonly connectionId: string;
  /**
  * The resource description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding#description YqObjectStorageBinding#description}
  */
  readonly description?: string;
  /**
  * The data format, e.g. csv_with_names, json_as_string, json_each_row, json_list, parquet, raw, tsv_with_names.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding#format YqObjectStorageBinding#format}
  */
  readonly format: string;
  /**
  * Special format setting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding#format_setting YqObjectStorageBinding#format_setting}
  */
  readonly formatSetting?: { [key: string]: string };
  /**
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding#name YqObjectStorageBinding#name}
  */
  readonly name: string;
  /**
  * The list of partitioning column names.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding#partitioned_by YqObjectStorageBinding#partitioned_by}
  */
  readonly partitionedBy?: string[];
  /**
  * The path pattern within Object Storage's bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding#path_pattern YqObjectStorageBinding#path_pattern}
  */
  readonly pathPattern: string;
  /**
  * Projection rules.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding#projection YqObjectStorageBinding#projection}
  */
  readonly projection?: { [key: string]: string };
  /**
  * column block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding#column YqObjectStorageBinding#column}
  */
...
export interface YqObjectStorageBindingColumn {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding#not_null YqObjectStorageBinding#not_null}
  */
  readonly notNull?: boolean | cdktf.IResolvable;
  /**
  * Column data type. YQL data types are used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding#type YqObjectStorageBinding#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding yandex_yq_object_storage_binding}
*/
export class YqObjectStorageBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing YqObjectStorageBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/yq_object_storage_binding yandex_yq_object_storage_binding} Resource
  *
  * @param scope The scope in which to define this construct
