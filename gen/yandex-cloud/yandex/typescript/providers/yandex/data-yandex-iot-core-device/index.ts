// https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/iot_core_device
...
export interface DataYandexIotCoreDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/iot_core_device#device_id DataYandexIotCoreDevice#device_id}
  */
  readonly deviceId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/iot_core_device#id DataYandexIotCoreDevice#id}
  *
  ...
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/iot_core_device#name DataYandexIotCoreDevice#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/iot_core_device yandex_iot_core_device}
*/
export class DataYandexIotCoreDevice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataYandexIotCoreDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/iot_core_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/data-sources/iot_core_device yandex_iot_core_device} Data Source
  *
  * @param scope The scope in which to define this construct
