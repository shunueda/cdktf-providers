// https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image
...
export interface ComputeImageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#description ComputeImage#description}
  */
  readonly description?: string;
  /**
  * The name of the image family to which this image belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#family ComputeImage#family}
  */
  readonly family?: string;
  /**
  * The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#folder_id ComputeImage#folder_id}
  */
  readonly folderId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#id ComputeImage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#labels ComputeImage#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Minimum size in GB of the disk that will be created from this image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#min_disk_size ComputeImage#min_disk_size}
  */
  readonly minDiskSize?: number;
  /**
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#name ComputeImage#name}
  */
  readonly name?: string;
  /**
  * Operating system type that is contained in the image. Possible values: `LINUX`, `WINDOWS`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#os_type ComputeImage#os_type}
  */
  readonly osType?: string;
  /**
  * Optimize the image to create a disk.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#pooled ComputeImage#pooled}
  */
  readonly pooled?: boolean | cdktf.IResolvable;
  /**
  * License IDs that indicate which licenses are attached to this image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#product_ids ComputeImage#product_ids}
  */
  readonly productIds?: string[];
  /**
  * The ID of a disk to use as the source of the image. Changing this ID forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#source_disk ComputeImage#source_disk}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#source_family ComputeImage#source_family}
  */
  readonly sourceFamily?: string;
  /**
  * The ID of an existing image to use as the source of the image. Changing this ID forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#source_image ComputeImage#source_image}
  */
  readonly sourceImage?: string;
  /**
  * The ID of a snapshot to use as the source of the image. Changing this ID forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#source_snapshot ComputeImage#source_snapshot}
  */
  readonly sourceSnapshot?: string;
  /**
  * The URL to use as the source of the image. Changing this URL forces a new resource to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#source_url ComputeImage#source_url}
  */
  readonly sourceUrl?: string;
  /**
  * hardware_generation block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#hardware_generation ComputeImage#hardware_generation}
  */
  readonly hardwareGeneration?: ComputeImageHardwareGeneration;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#timeouts ComputeImage#timeouts}
  */
...
export interface ComputeImageHardwareGenerationLegacyFeatures {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#pci_topology ComputeImage#pci_topology}
  */
...
export interface ComputeImageHardwareGeneration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#generation2_features ComputeImage#generation2_features}
  */
  readonly generation2Features?: ComputeImageHardwareGenerationGeneration2Features;
  /**
  * legacy_features block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#legacy_features ComputeImage#legacy_features}
  */
...
export interface ComputeImageTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#create ComputeImage#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#delete ComputeImage#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#update ComputeImage#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image yandex_compute_image}
*/
export class ComputeImage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/compute_image yandex_compute_image} Resource
  *
  * @param scope The scope in which to define this construct
