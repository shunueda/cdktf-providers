// https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/datasphere_project_iam_binding
...
export interface DatasphereProjectIamBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/datasphere_project_iam_binding#members DatasphereProjectIamBinding#members}
  */
  readonly members: string[];
  /**
  * The ID of the compute `project` to attach the policy to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/datasphere_project_iam_binding#project_id DatasphereProjectIamBinding#project_id}
  */
  readonly projectId: string;
  /**
  * The role that should be assigned. Only one yandex_datasphere_project_iam_binding can be used per role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/datasphere_project_iam_binding#role DatasphereProjectIamBinding#role}
  */
  readonly role: string;
  /**
  * For test purposes, to compensate IAM operations delay
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/datasphere_project_iam_binding#sleep_after DatasphereProjectIamBinding#sleep_after}
  */
  readonly sleepAfter?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/datasphere_project_iam_binding yandex_datasphere_project_iam_binding}
*/
export class DatasphereProjectIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatasphereProjectIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/datasphere_project_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/datasphere_project_iam_binding yandex_datasphere_project_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
