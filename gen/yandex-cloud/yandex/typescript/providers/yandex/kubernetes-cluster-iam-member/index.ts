// https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/kubernetes_cluster_iam_member
...
export interface KubernetesClusterIamMemberConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/kubernetes_cluster_iam_member#cluster_id KubernetesClusterIamMember#cluster_id}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/kubernetes_cluster_iam_member#member KubernetesClusterIamMember#member}
  */
  readonly member: string;
  /**
  * The role that should be assigned. Only one yandex_kubernetes_cluster_iam_member can be used per role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/kubernetes_cluster_iam_member#role KubernetesClusterIamMember#role}
  */
  readonly role: string;
  /**
  * For test purposes, to compensate IAM operations delay
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/kubernetes_cluster_iam_member#sleep_after KubernetesClusterIamMember#sleep_after}
  */
  readonly sleepAfter?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/kubernetes_cluster_iam_member yandex_kubernetes_cluster_iam_member}
*/
export class KubernetesClusterIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesClusterIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/kubernetes_cluster_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/kubernetes_cluster_iam_member yandex_kubernetes_cluster_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
