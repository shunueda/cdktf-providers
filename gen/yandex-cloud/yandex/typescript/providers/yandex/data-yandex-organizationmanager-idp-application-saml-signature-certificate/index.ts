// https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/organizationmanager_idp_application_saml_signature_certificate
...
export interface DataYandexOrganizationmanagerIdpApplicationSamlSignatureCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/organizationmanager_idp_application_saml_signature_certificate#id DataYandexOrganizationmanagerIdpApplicationSamlSignatureCertificate#id}
  *
  ...
  * ID of the signature certificate to return.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/organizationmanager_idp_application_saml_signature_certificate#signature_certificate_id DataYandexOrganizationmanagerIdpApplicationSamlSignatureCertificate#signature_certificate_id}
  */
  readonly signatureCertificateId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/organizationmanager_idp_application_saml_signature_certificate#timeouts DataYandexOrganizationmanagerIdpApplicationSamlSignatureCertificate#timeouts}
  */
...
export interface DataYandexOrganizationmanagerIdpApplicationSamlSignatureCertificateTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/organizationmanager_idp_application_saml_signature_certificate#create DataYandexOrganizationmanagerIdpApplicationSamlSignatureCertificate#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/organizationmanager_idp_application_saml_signature_certificate#delete DataYandexOrganizationmanagerIdpApplicationSamlSignatureCertificate#delete}
  */
  readonly delete?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Read operations occur during any refresh or planning operation when refresh is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/organizationmanager_idp_application_saml_signature_certificate#read DataYandexOrganizationmanagerIdpApplicationSamlSignatureCertificate#read}
  */
  readonly read?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/organizationmanager_idp_application_saml_signature_certificate#update DataYandexOrganizationmanagerIdpApplicationSamlSignatureCertificate#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/organizationmanager_idp_application_saml_signature_certificate yandex_organizationmanager_idp_application_saml_signature_certificate}
*/
export class DataYandexOrganizationmanagerIdpApplicationSamlSignatureCertificate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataYandexOrganizationmanagerIdpApplicationSamlSignatureCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/organizationmanager_idp_application_saml_signature_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.175.0/docs/data-sources/organizationmanager_idp_application_saml_signature_certificate yandex_organizationmanager_idp_application_saml_signature_certificate} Data Source
  *
  * @param scope The scope in which to define this construct
