// https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/compute_snapshot_iam_binding
...
export interface ComputeSnapshotIamBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/compute_snapshot_iam_binding#members ComputeSnapshotIamBinding#members}
  */
  readonly members: string[];
  /**
  * The role that should be assigned. Only one yandex_compute_snapshot_iam_binding can be used per role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/compute_snapshot_iam_binding#role ComputeSnapshotIamBinding#role}
  */
  readonly role: string;
  /**
  * For test purposes, to compensate IAM operations delay
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/compute_snapshot_iam_binding#sleep_after ComputeSnapshotIamBinding#sleep_after}
  */
  readonly sleepAfter?: number;
  /**
  * The ID of the compute `snapshot` to attach the policy to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/compute_snapshot_iam_binding#snapshot_id ComputeSnapshotIamBinding#snapshot_id}
  */
  readonly snapshotId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/compute_snapshot_iam_binding yandex_compute_snapshot_iam_binding}
*/
export class ComputeSnapshotIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeSnapshotIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/compute_snapshot_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/compute_snapshot_iam_binding yandex_compute_snapshot_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
