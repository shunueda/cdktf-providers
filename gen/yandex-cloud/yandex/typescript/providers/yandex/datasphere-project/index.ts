// https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project
...
export interface DatasphereProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#community_id DatasphereProject#community_id}
  */
  readonly communityId: string;
  /**
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#description DatasphereProject#description}
  */
  readonly description?: string;
  /**
  * A set of key/value label pairs which assigned to resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#labels DatasphereProject#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Datasphere Project limits configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#limits DatasphereProject#limits}
  */
  readonly limits?: DatasphereProjectLimits;
  /**
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#name DatasphereProject#name}
  */
  readonly name: string;
  /**
  * Datasphere Project settings configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#settings DatasphereProject#settings}
  */
  readonly settings?: DatasphereProjectSettings;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#timeouts DatasphereProject#timeouts}
  */
...
export interface DatasphereProjectLimits {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#balance DatasphereProject#balance}
  */
  readonly balance?: number;
  /**
  * The number of units that can be spent on the one execution.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#max_units_per_execution DatasphereProject#max_units_per_execution}
  */
  readonly maxUnitsPerExecution?: number;
  /**
  * The number of units that can be spent per hour.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#max_units_per_hour DatasphereProject#max_units_per_hour}
  */
...
export interface DatasphereProjectSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#data_proc_cluster_id DatasphereProject#data_proc_cluster_id}
  */
  readonly dataProcClusterId?: string;
  /**
  * Default project folder ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#default_folder_id DatasphereProject#default_folder_id}
  */
  readonly defaultFolderId?: string;
  /**
  * The list of security groups applied to resource or their components.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#security_group_ids DatasphereProject#security_group_ids}
  */
  readonly securityGroupIds?: string[];
  /**
  * [Service account](https://yandex.cloud/docs/iam/concepts/users/service-accounts) which linked to the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#service_account_id DatasphereProject#service_account_id}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#stale_exec_timeout_mode DatasphereProject#stale_exec_timeout_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#subnet_id DatasphereProject#subnet_id}
  */
...
export interface DatasphereProjectTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#create DatasphereProject#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#delete DatasphereProject#delete}
  */
  readonly delete?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#update DatasphereProject#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project yandex_datasphere_project}
*/
export class DatasphereProject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatasphereProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/datasphere_project yandex_datasphere_project} Resource
  *
  * @param scope The scope in which to define this construct
