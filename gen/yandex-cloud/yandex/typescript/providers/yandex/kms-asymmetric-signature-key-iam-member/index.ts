// https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/kms_asymmetric_signature_key_iam_member
...
export interface KmsAsymmetricSignatureKeyIamMemberConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/kms_asymmetric_signature_key_iam_member#asymmetric_signature_key_id KmsAsymmetricSignatureKeyIamMember#asymmetric_signature_key_id}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/kms_asymmetric_signature_key_iam_member#member KmsAsymmetricSignatureKeyIamMember#member}
  */
  readonly member: string;
  /**
  * The role that should be assigned. Only one yandex_kms_asymmetric_signature_key_iam_member can be used per role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/kms_asymmetric_signature_key_iam_member#role KmsAsymmetricSignatureKeyIamMember#role}
  */
  readonly role: string;
  /**
  * For test purposes, to compensate IAM operations delay
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/kms_asymmetric_signature_key_iam_member#sleep_after KmsAsymmetricSignatureKeyIamMember#sleep_after}
  */
  readonly sleepAfter?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/kms_asymmetric_signature_key_iam_member yandex_kms_asymmetric_signature_key_iam_member}
*/
export class KmsAsymmetricSignatureKeyIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsAsymmetricSignatureKeyIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/kms_asymmetric_signature_key_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/resources/kms_asymmetric_signature_key_iam_member yandex_kms_asymmetric_signature_key_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
