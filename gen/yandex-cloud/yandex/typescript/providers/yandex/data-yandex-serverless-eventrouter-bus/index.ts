// https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/serverless_eventrouter_bus
...
export interface DataYandexServerlessEventrouterBusConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the bus
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/serverless_eventrouter_bus#bus_id DataYandexServerlessEventrouterBus#bus_id}
  */
  readonly busId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/serverless_eventrouter_bus#id DataYandexServerlessEventrouterBus#id}
  *
  ...
  * Name of the bus
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/serverless_eventrouter_bus#name DataYandexServerlessEventrouterBus#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/serverless_eventrouter_bus yandex_serverless_eventrouter_bus}
*/
export class DataYandexServerlessEventrouterBus extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataYandexServerlessEventrouterBus that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/serverless_eventrouter_bus#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.171.0/docs/data-sources/serverless_eventrouter_bus yandex_serverless_eventrouter_bus} Data Source
  *
  * @param scope The scope in which to define this construct
