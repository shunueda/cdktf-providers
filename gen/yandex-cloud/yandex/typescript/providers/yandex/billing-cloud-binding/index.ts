// https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/billing_cloud_binding
...
export interface BillingCloudBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/billing_cloud_binding#billing_account_id BillingCloudBinding#billing_account_id}
  */
  readonly billingAccountId: string;
  /**
  * Service Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/billing_cloud_binding#cloud_id BillingCloudBinding#cloud_id}
  */
  readonly cloudId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/billing_cloud_binding yandex_billing_cloud_binding}
*/
export class BillingCloudBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BillingCloudBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/billing_cloud_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/billing_cloud_binding yandex_billing_cloud_binding} Resource
  *
  * @param scope The scope in which to define this construct
