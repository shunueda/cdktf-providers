// https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/dns_zone_iam_binding
...
export interface DnsZoneIamBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/dns_zone_iam_binding#dns_zone_id DnsZoneIamBinding#dns_zone_id}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/dns_zone_iam_binding#members DnsZoneIamBinding#members}
  */
  readonly members: string[];
  /**
  * The role that should be assigned. Only one yandex_dns_zone_iam_binding can be used per role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/dns_zone_iam_binding#role DnsZoneIamBinding#role}
  */
  readonly role: string;
  /**
  * For test purposes, to compensate IAM operations delay
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/dns_zone_iam_binding#sleep_after DnsZoneIamBinding#sleep_after}
  */
  readonly sleepAfter?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/dns_zone_iam_binding yandex_dns_zone_iam_binding}
*/
export class DnsZoneIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsZoneIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/dns_zone_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/resources/dns_zone_iam_binding yandex_dns_zone_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
