// https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/data-sources/cm_certificate
...
export interface DataYandexCmCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  * Certificate Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/data-sources/cm_certificate#certificate_id DataYandexCmCertificate#certificate_id}
  */
  readonly certificateId?: string;
  /**
  * The resource description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/data-sources/cm_certificate#description DataYandexCmCertificate#description}
  */
  readonly description?: string;
  /**
  * The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/data-sources/cm_certificate#folder_id DataYandexCmCertificate#folder_id}
  */
  readonly folderId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/data-sources/cm_certificate#id DataYandexCmCertificate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/data-sources/cm_certificate#labels DataYandexCmCertificate#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/data-sources/cm_certificate#name DataYandexCmCertificate#name}
  */
  readonly name?: string;
  /**
  * If `true`, the operation won't be completed while the certificate is in `VALIDATING`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/data-sources/cm_certificate#wait_validation DataYandexCmCertificate#wait_validation}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/data-sources/cm_certificate yandex_cm_certificate}
*/
export class DataYandexCmCertificate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataYandexCmCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/data-sources/cm_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.170.0/docs/data-sources/cm_certificate yandex_cm_certificate} Data Source
  *
  * @param scope The scope in which to define this construct
