// https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret
...
export interface LockboxSecretConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#deletion_protection LockboxSecret#deletion_protection}
  */
  readonly deletionProtection?: boolean | cdktf.IResolvable;
  /**
  * The resource description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#description LockboxSecret#description}
  */
  readonly description?: string;
  /**
  * The folder identifier that resource belongs to. If it is not provided, the default provider `folder-id` is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#folder_id LockboxSecret#folder_id}
  */
  readonly folderId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#id LockboxSecret#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#kms_key_id LockboxSecret#kms_key_id}
  */
  readonly kmsKeyId?: string;
  /**
  * A set of key/value label pairs which assigned to resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#labels LockboxSecret#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The resource name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#name LockboxSecret#name}
  */
  readonly name?: string;
  /**
  * password_payload_specification block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#password_payload_specification LockboxSecret#password_payload_specification}
  */
  readonly passwordPayloadSpecification?: LockboxSecretPasswordPayloadSpecification;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#timeouts LockboxSecret#timeouts}
  */
...
export interface LockboxSecretPasswordPayloadSpecification {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#excluded_punctuation LockboxSecret#excluded_punctuation}
  */
  readonly excludedPunctuation?: string;
  /**
  * Use digits in the generated password. Default is true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#include_digits LockboxSecret#include_digits}
  */
  readonly includeDigits?: boolean | cdktf.IResolvable;
  /**
  * Use lowercase letters in the generated password. Default is true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#include_lowercase LockboxSecret#include_lowercase}
  */
  readonly includeLowercase?: boolean | cdktf.IResolvable;
  /**
  * Use punctuations (`!"#$%&'()*+,-./:;<=>?@[\]^_`{|}~`) in the generated password. Default is true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#include_punctuation LockboxSecret#include_punctuation}
  */
  readonly includePunctuation?: boolean | cdktf.IResolvable;
  /**
  * Use capital letters in the generated password. Default is true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#include_uppercase LockboxSecret#include_uppercase}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#included_punctuation LockboxSecret#included_punctuation}
  */
  readonly includedPunctuation?: string;
  /**
  * Length of generated password. Default is `36`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#length LockboxSecret#length}
  */
  readonly length?: number;
  /**
  * The key with which the generated password will be placed in the secret version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#password_key LockboxSecret#password_key}
  */
...
export interface LockboxSecretTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#create LockboxSecret#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#delete LockboxSecret#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#read LockboxSecret#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#update LockboxSecret#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret yandex_lockbox_secret}
*/
export class LockboxSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LockboxSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.173.0/docs/resources/lockbox_secret yandex_lockbox_secret} Resource
  *
  * @param scope The scope in which to define this construct
