// https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user
...
export interface MdbShardedPostgresqlUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user#cluster_id MdbShardedPostgresqlUser#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user#grants MdbShardedPostgresqlUser#grants}
  */
  readonly grants?: string[];
  /**
  * Name of the Sharded PostgreSQL user. Provided by the client when the user is created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user#name MdbShardedPostgresqlUser#name}
  */
  readonly name: string;
  /**
  * Password of the Sharded PostgreSQL user. Provided by the client when the user is created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user#password MdbShardedPostgresqlUser#password}
  */
  readonly password?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user#settings MdbShardedPostgresqlUser#settings}
  */
  readonly settings?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user#timeouts MdbShardedPostgresqlUser#timeouts}
  */
  readonly timeouts?: MdbShardedPostgresqlUserTimeouts;
  /**
  * permissions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user#permissions MdbShardedPostgresqlUser#permissions}
  */
...
export interface MdbShardedPostgresqlUserTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user#create MdbShardedPostgresqlUser#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user#delete MdbShardedPostgresqlUser#delete}
  */
  readonly delete?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user#update MdbShardedPostgresqlUser#update}
  */
...
export interface MdbShardedPostgresqlUserPermissions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user#database MdbShardedPostgresqlUser#database}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user yandex_mdb_sharded_postgresql_user}
*/
export class MdbShardedPostgresqlUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MdbShardedPostgresqlUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.176.0/docs/resources/mdb_sharded_postgresql_user yandex_mdb_sharded_postgresql_user} Resource
  *
  * @param scope The scope in which to define this construct
