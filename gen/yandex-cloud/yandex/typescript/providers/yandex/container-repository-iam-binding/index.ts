// https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/container_repository_iam_binding
...
export interface ContainerRepositoryIamBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/container_repository_iam_binding#members ContainerRepositoryIamBinding#members}
  */
  readonly members: string[];
  /**
  * The ID of the compute `repository` to attach the policy to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/container_repository_iam_binding#repository_id ContainerRepositoryIamBinding#repository_id}
  */
  readonly repositoryId: string;
  /**
  * The role that should be assigned. Only one yandex_container_repository_iam_binding can be used per role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/container_repository_iam_binding#role ContainerRepositoryIamBinding#role}
  */
  readonly role: string;
  /**
  * For test purposes, to compensate IAM operations delay
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/container_repository_iam_binding#sleep_after ContainerRepositoryIamBinding#sleep_after}
  */
  readonly sleepAfter?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/container_repository_iam_binding yandex_container_repository_iam_binding}
*/
export class ContainerRepositoryIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerRepositoryIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/container_repository_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.177.0/docs/resources/container_repository_iam_binding yandex_container_repository_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
