// https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/iam_service_account_static_access_key
...
export interface IamServiceAccountStaticAccessKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/iam_service_account_static_access_key#description IamServiceAccountStaticAccessKey#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/iam_service_account_static_access_key#id IamServiceAccountStaticAccessKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/iam_service_account_static_access_key#pgp_key IamServiceAccountStaticAccessKey#pgp_key}
  */
  readonly pgpKey?: string;
  /**
  * ID of the service account which is used to get a static key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/iam_service_account_static_access_key#service_account_id IamServiceAccountStaticAccessKey#service_account_id}
  */
  readonly serviceAccountId: string;
  /**
  * output_to_lockbox block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/iam_service_account_static_access_key#output_to_lockbox IamServiceAccountStaticAccessKey#output_to_lockbox}
  */
...
export interface IamServiceAccountStaticAccessKeyOutputToLockbox {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/iam_service_account_static_access_key#entry_for_access_key IamServiceAccountStaticAccessKey#entry_for_access_key}
  */
  readonly entryForAccessKey: string;
  /**
  * entry that will store the value of secret_key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/iam_service_account_static_access_key#entry_for_secret_key IamServiceAccountStaticAccessKey#entry_for_secret_key}
  */
  readonly entryForSecretKey: string;
  /**
  * ID of the Lockbox secret where to store the sensible values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/iam_service_account_static_access_key#secret_id IamServiceAccountStaticAccessKey#secret_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/iam_service_account_static_access_key yandex_iam_service_account_static_access_key}
*/
export class IamServiceAccountStaticAccessKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamServiceAccountStaticAccessKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/iam_service_account_static_access_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.169.0/docs/resources/iam_service_account_static_access_key yandex_iam_service_account_static_access_key} Resource
  *
  * @param scope The scope in which to define this construct
