// https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/kms_symmetric_key_iam_binding
...
export interface KmsSymmetricKeyIamBindingConfig extends cdktf.TerraformMetaArguments {
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/kms_symmetric_key_iam_binding#members KmsSymmetricKeyIamBinding#members}
  */
  readonly members: string[];
  /**
  * The role that should be assigned. Only one yandex_kms_symmetric_key_iam_binding can be used per role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/kms_symmetric_key_iam_binding#role KmsSymmetricKeyIamBinding#role}
  */
  readonly role: string;
  /**
  * For test purposes, to compensate IAM operations delay
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/kms_symmetric_key_iam_binding#sleep_after KmsSymmetricKeyIamBinding#sleep_after}
  */
  readonly sleepAfter?: number;
  /**
  * The ID of the compute `symmetric_key` to attach the policy to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/kms_symmetric_key_iam_binding#symmetric_key_id KmsSymmetricKeyIamBinding#symmetric_key_id}
  */
  readonly symmetricKeyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/kms_symmetric_key_iam_binding yandex_kms_symmetric_key_iam_binding}
*/
export class KmsSymmetricKeyIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsSymmetricKeyIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/kms_symmetric_key_iam_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/kms_symmetric_key_iam_binding yandex_kms_symmetric_key_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
