// https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_key
...
export interface IamServiceAccountKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_key#description IamServiceAccountKey#description}
  */
  readonly description?: string;
  /**
  * The output format of the keys. `PEM_FILE` is the default format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_key#format IamServiceAccountKey#format}
  */
  readonly format?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_key#id IamServiceAccountKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_key#key_algorithm IamServiceAccountKey#key_algorithm}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_key#pgp_key IamServiceAccountKey#pgp_key}
  */
  readonly pgpKey?: string;
  /**
  * ID of the service account to create a pair for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_key#service_account_id IamServiceAccountKey#service_account_id}
  */
  readonly serviceAccountId: string;
  /**
  * output_to_lockbox block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_key#output_to_lockbox IamServiceAccountKey#output_to_lockbox}
  */
...
export interface IamServiceAccountKeyOutputToLockbox {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_key#entry_for_private_key IamServiceAccountKey#entry_for_private_key}
  */
  readonly entryForPrivateKey: string;
  /**
  * ID of the Lockbox secret where to store the sensible values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_key#secret_id IamServiceAccountKey#secret_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_key yandex_iam_service_account_key}
*/
export class IamServiceAccountKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamServiceAccountKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.174.0/docs/resources/iam_service_account_key yandex_iam_service_account_key} Resource
  *
  * @param scope The scope in which to define this construct
