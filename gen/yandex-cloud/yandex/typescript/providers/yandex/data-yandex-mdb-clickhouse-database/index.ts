// https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/mdb_clickhouse_database
...
export interface DataYandexMdbClickhouseDatabaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/mdb_clickhouse_database#cluster_id DataYandexMdbClickhouseDatabase#cluster_id}
  */
  readonly clusterId: string;
  /**
  * The name of the database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/mdb_clickhouse_database#name DataYandexMdbClickhouseDatabase#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/mdb_clickhouse_database#timeouts DataYandexMdbClickhouseDatabase#timeouts}
  */
...
export interface DataYandexMdbClickhouseDatabaseTimeouts {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/mdb_clickhouse_database#create DataYandexMdbClickhouseDatabase#create}
  */
  readonly create?: string;
  /**
  * A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/mdb_clickhouse_database#delete DataYandexMdbClickhouseDatabase#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/mdb_clickhouse_database yandex_mdb_clickhouse_database}
*/
export class DataYandexMdbClickhouseDatabase extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataYandexMdbClickhouseDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/mdb_clickhouse_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/yandex-cloud/yandex/0.172.0/docs/data-sources/mdb_clickhouse_database yandex_mdb_clickhouse_database} Data Source
  *
  * @param scope The scope in which to define this construct
