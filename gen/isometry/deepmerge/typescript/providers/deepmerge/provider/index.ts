// https://registry.terraform.io/providers/isometry/deepmerge/1.2.1/docs
...
export interface DeepmergeProviderConfig {
  ...
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/isometry/deepmerge/1.2.1/docs#alias DeepmergeProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/isometry/deepmerge/1.2.1/docs deepmerge}
*/
export class DeepmergeProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing DeepmergeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/isometry/deepmerge/1.2.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/isometry/deepmerge/1.2.1/docs deepmerge} Resource
  *
  * @param scope The scope in which to define this construct
