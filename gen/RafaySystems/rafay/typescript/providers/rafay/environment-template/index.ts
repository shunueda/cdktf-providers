...
export interface EnvironmentTemplateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/environment_template#id EnvironmentTemplate#id}
  *
  ...
  * metadata block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/environment_template#metadata EnvironmentTemplate#metadata}
  */
  readonly metadata?: EnvironmentTemplateMetadata;
  /**
  * spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/environment_template#spec EnvironmentTemplate#spec}
  */
  readonly spec?: EnvironmentTemplateSpec;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/environment_template#timeouts EnvironmentTemplate#timeouts}
  */
  readonly timeouts?: EnvironmentTemplateTimeouts;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/environment_template rafay_environment_template}
*/
export class EnvironmentTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnvironmentTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/environment_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/environment_template rafay_environment_template} Resource
  *
  * @param scope The scope in which to define this construct
