// https://registry.terraform.io/providers/rafaysystems/rafay/1.1.54/docs/data-sources/mks_cluster
...
export interface DataRafayMksClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.54/docs/data-sources/mks_cluster#metadata DataRafayMksCluster#metadata}
  */
...
export interface DataRafayMksClusterMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.54/docs/data-sources/mks_cluster#name DataRafayMksCluster#name}
  */
  readonly name: string;
  /**
  * Project of the resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.54/docs/data-sources/mks_cluster#project DataRafayMksCluster#project}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.54/docs/data-sources/mks_cluster rafay_mks_cluster}
*/
export class DataRafayMksCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRafayMksCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.54/docs/data-sources/mks_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.54/docs/data-sources/mks_cluster rafay_mks_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
