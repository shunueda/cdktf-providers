// https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/download_kubeconfig
...
export interface DataRafayDownloadKubeconfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/download_kubeconfig#cluster DataRafayDownloadKubeconfig#cluster}
  */
  readonly cluster?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/download_kubeconfig#id DataRafayDownloadKubeconfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/download_kubeconfig#kubeconfig DataRafayDownloadKubeconfig#kubeconfig}
  */
  readonly kubeconfig?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/download_kubeconfig#namespace DataRafayDownloadKubeconfig#namespace}
  */
  readonly namespace?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/download_kubeconfig#username DataRafayDownloadKubeconfig#username}
  */
  readonly username?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/download_kubeconfig#timeouts DataRafayDownloadKubeconfig#timeouts}
  */
  readonly timeouts?: DataRafayDownloadKubeconfigTimeouts;
}
export interface DataRafayDownloadKubeconfigTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/download_kubeconfig#read DataRafayDownloadKubeconfig#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/download_kubeconfig rafay_download_kubeconfig}
*/
export class DataRafayDownloadKubeconfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRafayDownloadKubeconfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/download_kubeconfig#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/download_kubeconfig rafay_download_kubeconfig} Data Source
  *
  * @param scope The scope in which to define this construct
