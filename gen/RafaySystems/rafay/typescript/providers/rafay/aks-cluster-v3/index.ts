...
export interface AksClusterV3Config extends cdktf.TerraformMetaArguments {
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.54/docs/resources/aks_cluster_v3#timeouts AksClusterV3#timeouts}
  */
  readonly timeouts?: AksClusterV3Timeouts;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.54/docs/resources/aks_cluster_v3 rafay_aks_cluster_v3}
*/
export class AksClusterV3 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AksClusterV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.54/docs/resources/aks_cluster_v3#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.54/docs/resources/aks_cluster_v3 rafay_aks_cluster_v3} Resource
  *
  * @param scope The scope in which to define this construct
