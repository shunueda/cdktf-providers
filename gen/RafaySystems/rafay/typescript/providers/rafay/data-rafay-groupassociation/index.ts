// https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation
...
export interface DataRafayGroupassociationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation#add_users DataRafayGroupassociation#add_users}
  */
  readonly addUsers?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation#custom_roles DataRafayGroupassociation#custom_roles}
  */
  readonly customRoles?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation#group DataRafayGroupassociation#group}
  */
  readonly group: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation#id DataRafayGroupassociation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation#idp_user DataRafayGroupassociation#idp_user}
  */
  readonly idpUser?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation#namespaces DataRafayGroupassociation#namespaces}
  */
  readonly namespaces?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation#project DataRafayGroupassociation#project}
  */
  readonly project: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation#remove_users DataRafayGroupassociation#remove_users}
  */
  readonly removeUsers?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation#roles DataRafayGroupassociation#roles}
  */
  readonly roles?: string[];
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation#timeouts DataRafayGroupassociation#timeouts}
  */
  readonly timeouts?: DataRafayGroupassociationTimeouts;
}
export interface DataRafayGroupassociationTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation#read DataRafayGroupassociation#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation rafay_groupassociation}
*/
export class DataRafayGroupassociation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRafayGroupassociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/groupassociation rafay_groupassociation} Data Source
  *
  * @param scope The scope in which to define this construct
