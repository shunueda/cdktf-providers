// https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec
...
export interface AksClusterSpecAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec#checkdiff AksClusterSpecA#checkdiff}
  */
  readonly checkdiff?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec#id AksClusterSpecA#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec#name AksClusterSpecA#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec#projectname AksClusterSpecA#projectname}
  */
  readonly projectname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec#waitflag AksClusterSpecA#waitflag}
  */
  readonly waitflag?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec#yamlfilepath AksClusterSpecA#yamlfilepath}
  */
  readonly yamlfilepath: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec#yamlfileversion AksClusterSpecA#yamlfileversion}
  */
  readonly yamlfileversion: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec#timeouts AksClusterSpecA#timeouts}
  */
  readonly timeouts?: AksClusterSpecTimeouts;
}
export interface AksClusterSpecTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec#create AksClusterSpecA#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec#delete AksClusterSpecA#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec#update AksClusterSpecA#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec rafay_aks_cluster_spec}
*/
export class AksClusterSpecA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AksClusterSpecA that should be imported. Refer to the {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/resources/aks_cluster_spec rafay_aks_cluster_spec} Resource
  *
  * @param scope The scope in which to define this construct
