// https://registry.terraform.io/providers/rafaysystems/rafay/1.1.53/docs/data-sources/clusters
...
export interface DataRafayClustersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.53/docs/data-sources/clusters#id DataRafayClusters#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.53/docs/data-sources/clusters#projectname DataRafayClusters#projectname}
  */
  readonly projectname: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.53/docs/data-sources/clusters#timeouts DataRafayClusters#timeouts}
  */
...
export interface DataRafayClustersTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.53/docs/data-sources/clusters#read DataRafayClusters#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.53/docs/data-sources/clusters rafay_clusters}
*/
export class DataRafayClusters extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRafayClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.53/docs/data-sources/clusters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.53/docs/data-sources/clusters rafay_clusters} Data Source
  *
  * @param scope The scope in which to define this construct
