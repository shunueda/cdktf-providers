...
export interface DataRafayAksClusterV3Config extends cdktf.TerraformMetaArguments {
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/aks_cluster_v3#timeouts DataRafayAksClusterV3#timeouts}
  */
  readonly timeouts?: DataRafayAksClusterV3Timeouts;
}

/**
* Represents a {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/aks_cluster_v3 rafay_aks_cluster_v3}
*/
export class DataRafayAksClusterV3 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRafayAksClusterV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/aks_cluster_v3#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.55/docs/data-sources/aks_cluster_v3 rafay_aks_cluster_v3} Data Source
  *
  * @param scope The scope in which to define this construct
