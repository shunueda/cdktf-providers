// https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity
...
export interface EksPodIdentityConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#id EksPodIdentity#id}
  *
  ...
  * metadata block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#metadata EksPodIdentity#metadata}
  */
  readonly metadata: EksPodIdentityMetadata;
  /**
  * spec block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#spec EksPodIdentity#spec}
  */
  readonly spec: EksPodIdentitySpec;
}
export interface EksPodIdentityMetadata {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#cluster_name EksPodIdentity#cluster_name}
  */
  readonly clusterName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#project_name EksPodIdentity#project_name}
  */
...
export interface EksPodIdentitySpecWellKnownPolicies {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#auto_scaler EksPodIdentity#auto_scaler}
  */
  readonly autoScaler?: boolean | cdktf.IResolvable;
  /**
  * adds policies for using the aws-load-balancer-controller.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#aws_load_balancer_controller EksPodIdentity#aws_load_balancer_controller}
  */
  readonly awsLoadBalancerController?: boolean | cdktf.IResolvable;
  /**
  * adds cert-manager policies.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#cert_manager EksPodIdentity#cert_manager}
  */
  readonly certManager?: boolean | cdktf.IResolvable;
  /**
  * adds cert-manager policies.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#ebs_csi_controller EksPodIdentity#ebs_csi_controller}
  */
  readonly ebsCsiController?: boolean | cdktf.IResolvable;
  /**
  * adds policies for using the ebs-csi-controller.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#efs_csi_controller EksPodIdentity#efs_csi_controller}
  */
  readonly efsCsiController?: boolean | cdktf.IResolvable;
  /**
  * adds external-dns policies for Amazon Route 53.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#external_dns EksPodIdentity#external_dns}
  */
  readonly externalDns?: boolean | cdktf.IResolvable;
  /**
  * allows for full ECR (Elastic Container Registry) access.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#image_builder EksPodIdentity#image_builder}
  */
...
export interface EksPodIdentitySpec {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#create_service_account EksPodIdentity#create_service_account}
  */
  readonly createServiceAccount?: boolean | cdktf.IResolvable;
  /**
  * namespace of service account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#namespace EksPodIdentity#namespace}
  */
  readonly namespace: string;
  /**
  * permission boundary ARN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#permission_boundary_arn EksPodIdentity#permission_boundary_arn}
  */
  readonly permissionBoundaryArn?: string;
  /**
  * permission policy document
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#permission_policy EksPodIdentity#permission_policy}
  */
  readonly permissionPolicy?: string;
  /**
  * permission policy ARNs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#permission_policy_arns EksPodIdentity#permission_policy_arns}
  */
  readonly permissionPolicyArns?: string[];
  /**
  * role ARN of AWS role to associate with service account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#role_arn EksPodIdentity#role_arn}
  */
  readonly roleArn?: string;
  /**
  * aws role name to associate
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#role_name EksPodIdentity#role_name}
  */
  readonly roleName?: string;
  /**
  * name of service account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#service_account_name EksPodIdentity#service_account_name}
  */
  readonly serviceAccountName: string;
  /**
  * AWS tags for the service account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#tags EksPodIdentity#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * well_known_policies block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#well_known_policies EksPodIdentity#well_known_policies}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity rafay_eks_pod_identity}
*/
export class EksPodIdentity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EksPodIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/rafaysystems/rafay/1.1.52/docs/resources/eks_pod_identity rafay_eks_pod_identity} Resource
  *
  * @param scope The scope in which to define this construct
