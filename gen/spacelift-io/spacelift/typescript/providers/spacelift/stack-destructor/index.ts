// https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_destructor
...
export interface StackDestructorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_destructor#deactivated StackDestructor#deactivated}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_destructor#discard_runs StackDestructor#discard_runs}
  */
  readonly discardRuns?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_destructor#id StackDestructor#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_destructor#stack_id StackDestructor#stack_id}
  */
  readonly stackId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_destructor#timeouts StackDestructor#timeouts}
  */
  readonly timeouts?: StackDestructorTimeouts;
}
export interface StackDestructorTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_destructor#delete StackDestructor#delete}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_destructor spacelift_stack_destructor}
*/
export class StackDestructor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StackDestructor that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_destructor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_destructor spacelift_stack_destructor} Resource
  *
  * @param scope The scope in which to define this construct
