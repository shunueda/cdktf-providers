// https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/worker_pool_recycle
...
export interface WorkerPoolRecycleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/worker_pool_recycle#id WorkerPoolRecycle#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/worker_pool_recycle#keepers WorkerPoolRecycle#keepers}
  */
  readonly keepers?: { [key: string]: string };
  /**
  * ID of the worker pool to recycle
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/worker_pool_recycle#worker_pool_id WorkerPoolRecycle#worker_pool_id}
  */
  readonly workerPoolId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/worker_pool_recycle spacelift_worker_pool_recycle}
*/
export class WorkerPoolRecycle extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkerPoolRecycle that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/worker_pool_recycle#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/worker_pool_recycle spacelift_worker_pool_recycle} Resource
  *
  * @param scope The scope in which to define this construct
