...
export * as defaultRunnerImage from './default-runner-image';
...
export * as pluginTemplate from './plugin-template';
...
export * as dataSpaceliftPlugin from './data-spacelift-plugin';
export * as dataSpaceliftPluginTemplate from './data-spacelift-plugin-template';
