// https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/scheduled_delete_stack
...
export interface ScheduledDeleteStackConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/scheduled_delete_stack#at ScheduledDeleteStack#at}
  */
  readonly at: number;
  /**
  * Indicates whether the resources of the stack should be deleted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/scheduled_delete_stack#delete_resources ScheduledDeleteStack#delete_resources}
  */
  readonly deleteResources?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/scheduled_delete_stack#id ScheduledDeleteStack#id}
  *
  ...
  * ID of the schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/scheduled_delete_stack#schedule_id ScheduledDeleteStack#schedule_id}
  */
  readonly scheduleId?: string;
  /**
  * ID of the stack for which to set up scheduling
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/scheduled_delete_stack#stack_id ScheduledDeleteStack#stack_id}
  */
  readonly stackId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/scheduled_delete_stack spacelift_scheduled_delete_stack}
*/
export class ScheduledDeleteStack extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScheduledDeleteStack that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/scheduled_delete_stack#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/scheduled_delete_stack spacelift_scheduled_delete_stack} Resource
  *
  * @param scope The scope in which to define this construct
