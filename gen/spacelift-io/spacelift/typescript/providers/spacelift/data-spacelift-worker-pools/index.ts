// https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/data-sources/worker_pools
...
export interface DataSpaceliftWorkerPoolsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/data-sources/worker_pools#id DataSpaceliftWorkerPools#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/data-sources/worker_pools spacelift_worker_pools}
*/
export class DataSpaceliftWorkerPools extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpaceliftWorkerPools that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/data-sources/worker_pools#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/data-sources/worker_pools spacelift_worker_pools} Data Source
  *
  * @param scope The scope in which to define this construct
