// https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs/resources/worker_pool
...
export interface WorkerPoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs/resources/worker_pool#csr WorkerPool#csr}
  */
  readonly csr?: string;
  /**
  * description of the worker pool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs/resources/worker_pool#description WorkerPool#description}
  */
  readonly description?: string;
  /**
  * Limit of how many concurrent drift detection runs are allowed per worker pool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs/resources/worker_pool#drift_detection_run_limit WorkerPool#drift_detection_run_limit}
  */
  readonly driftDetectionRunLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs/resources/worker_pool#id WorkerPool#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs/resources/worker_pool#labels WorkerPool#labels}
  */
  readonly labels?: string[];
  /**
  * name of the worker pool
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs/resources/worker_pool#name WorkerPool#name}
  */
  readonly name: string;
  /**
  * ID (slug) of the space the worker pool is in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs/resources/worker_pool#space_id WorkerPool#space_id}
  */
  readonly spaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs/resources/worker_pool spacelift_worker_pool}
*/
export class WorkerPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkerPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs/resources/worker_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs/resources/worker_pool spacelift_worker_pool} Resource
  *
  * @param scope The scope in which to define this construct
