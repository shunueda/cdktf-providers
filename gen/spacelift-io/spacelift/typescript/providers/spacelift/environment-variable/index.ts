// https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/environment_variable
...
export interface EnvironmentVariableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/environment_variable#context_id EnvironmentVariable#context_id}
  */
  readonly contextId?: string;
  /**
  * Description of the environment variable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/environment_variable#description EnvironmentVariable#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/environment_variable#id EnvironmentVariable#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/environment_variable#module_id EnvironmentVariable#module_id}
  */
  readonly moduleId?: string;
  /**
  * Name of the environment variable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/environment_variable#name EnvironmentVariable#name}
  */
  readonly name: string;
  /**
  * ID of the stack on which the environment variable is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/environment_variable#stack_id EnvironmentVariable#stack_id}
  */
  readonly stackId?: string;
  /**
  * Value of the environment variable. Defaults to an empty string.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/environment_variable#value EnvironmentVariable#value}
  */
  readonly value?: string;
  /**
  * Indicates whether the value is secret or not. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/environment_variable#write_only EnvironmentVariable#write_only}
  */
  readonly writeOnly?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/environment_variable spacelift_environment_variable}
*/
export class EnvironmentVariable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnvironmentVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/environment_variable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/environment_variable spacelift_environment_variable} Resource
  *
  * @param scope The scope in which to define this construct
