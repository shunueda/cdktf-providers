// https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/plugin_template
...
export interface PluginTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/plugin_template#description PluginTemplate#description}
  */
  readonly description?: string;
  /**
  * Labels to apply to the plugin template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/plugin_template#labels PluginTemplate#labels}
  */
  readonly labels?: string[];
  /**
  * The plugin manifest defining the plugin's behavior
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/plugin_template#manifest PluginTemplate#manifest}
  */
  readonly manifest: string;
  /**
  * Name of the plugin template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/plugin_template#name PluginTemplate#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/plugin_template spacelift_plugin_template}
*/
export class PluginTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PluginTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/plugin_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/plugin_template spacelift_plugin_template} Resource
  *
  * @param scope The scope in which to define this construct
