// https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/version
...
export interface VersionResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/version#commit_sha VersionResource#commit_sha}
  */
  readonly commitSha?: string;
  /**
  * Arbitrary map of values that, when changed, will trigger recreation of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/version#keepers VersionResource#keepers}
  */
  readonly keepers?: { [key: string]: string };
  /**
  * ID of the module on which the version creation is to be triggered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/version#module_id VersionResource#module_id}
  */
  readonly moduleId: string;
  /**
  * A semantic version number to set for the triggered version, example: 0.11.2
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/version#version_number VersionResource#version_number}
  */
  readonly versionNumber?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/version spacelift_version}
*/
export class VersionResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VersionResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/version spacelift_version} Resource
  *
  * @param scope The scope in which to define this construct
