// https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/data-sources/space_by_path
...
export interface DataSpaceliftSpaceByPathConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/data-sources/space_by_path#id DataSpaceliftSpaceByPath#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/data-sources/space_by_path#space_path DataSpaceliftSpaceByPath#space_path}
  */
  readonly spacePath: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/data-sources/space_by_path spacelift_space_by_path}
*/
export class DataSpaceliftSpaceByPath extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpaceliftSpaceByPath that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/data-sources/space_by_path#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/data-sources/space_by_path spacelift_space_by_path} Data Source
  *
  * @param scope The scope in which to define this construct
