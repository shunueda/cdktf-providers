// https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/stack_gcp_service_account
...
export interface StackGcpServiceAccountConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/stack_gcp_service_account#id StackGcpServiceAccount#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/stack_gcp_service_account#module_id StackGcpServiceAccount#module_id}
  */
  readonly moduleId?: string;
  /**
  * ID of the stack which uses GCP service account credentials
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/stack_gcp_service_account#stack_id StackGcpServiceAccount#stack_id}
  */
  readonly stackId?: string;
  /**
  * List of scopes that will be requested when generating temporary GCP service account credentials
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/stack_gcp_service_account#token_scopes StackGcpServiceAccount#token_scopes}
  */
  readonly tokenScopes: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/stack_gcp_service_account spacelift_stack_gcp_service_account}
*/
export class StackGcpServiceAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StackGcpServiceAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/stack_gcp_service_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/stack_gcp_service_account spacelift_stack_gcp_service_account} Resource
  *
  * @param scope The scope in which to define this construct
