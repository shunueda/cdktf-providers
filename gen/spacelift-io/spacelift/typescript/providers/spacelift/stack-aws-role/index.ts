// https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_aws_role
...
export interface StackAwsRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_aws_role#duration_seconds StackAwsRole#duration_seconds}
  */
  readonly durationSeconds?: number;
  /**
  * Custom external ID (works only for private workers).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_aws_role#external_id StackAwsRole#external_id}
  */
  readonly externalId?: string;
  /**
  * Generate AWS credentials in the private worker. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_aws_role#generate_credentials_in_worker StackAwsRole#generate_credentials_in_worker}
  */
  readonly generateCredentialsInWorker?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_aws_role#id StackAwsRole#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_aws_role#module_id StackAwsRole#module_id}
  */
  readonly moduleId?: string;
  /**
  * AWS region to select a regional AWS STS endpoint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_aws_role#region StackAwsRole#region}
  */
  readonly region?: string;
  /**
  * ARN of the AWS IAM role to attach
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_aws_role#role_arn StackAwsRole#role_arn}
  */
  readonly roleArn: string;
  /**
  * ID of the stack which assumes the AWS IAM role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_aws_role#stack_id StackAwsRole#stack_id}
  */
  readonly stackId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_aws_role spacelift_stack_aws_role}
*/
export class StackAwsRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StackAwsRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_aws_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_aws_role spacelift_stack_aws_role} Resource
  *
  * @param scope The scope in which to define this construct
