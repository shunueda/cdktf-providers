// https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency
...
export interface StackDependencyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency#depends_on_stack_id StackDependency#depends_on_stack_id}
  */
  readonly dependsOnStackId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency#id StackDependency#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency#stack_id StackDependency#stack_id}
  */
  readonly stackId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency spacelift_stack_dependency}
*/
export class StackDependency extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StackDependency that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency spacelift_stack_dependency} Resource
  *
  * @param scope The scope in which to define this construct
