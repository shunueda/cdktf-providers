// https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs
...
export interface SpaceliftProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs#api_key_endpoint SpaceliftProvider#api_key_endpoint}
  */
  readonly apiKeyEndpoint?: string;
  /**
  * ID of the API key to use when executing outside of Spacelift
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs#api_key_id SpaceliftProvider#api_key_id}
  */
  readonly apiKeyId?: string;
  /**
  * API key secret to use when executing outside of Spacelift
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs#api_key_secret SpaceliftProvider#api_key_secret}
  */
  readonly apiKeySecret?: string;
  /**
  * Spacelift token generated by a run, only useful from within Spacelift
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs#api_token SpaceliftProvider#api_token}
  */
  readonly apiToken?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs#alias SpaceliftProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs spacelift}
*/
export class SpaceliftProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing SpaceliftProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.37.0/docs spacelift} Resource
  *
  * @param scope The scope in which to define this construct
