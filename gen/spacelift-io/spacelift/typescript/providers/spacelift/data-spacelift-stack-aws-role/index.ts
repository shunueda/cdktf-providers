// https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/data-sources/stack_aws_role
...
export interface DataSpaceliftStackAwsRoleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/data-sources/stack_aws_role#id DataSpaceliftStackAwsRole#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/data-sources/stack_aws_role#module_id DataSpaceliftStackAwsRole#module_id}
  */
  readonly moduleId?: string;
  /**
  * ID of the stack which assumes the AWS IAM role
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/data-sources/stack_aws_role#stack_id DataSpaceliftStackAwsRole#stack_id}
  */
  readonly stackId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/data-sources/stack_aws_role spacelift_stack_aws_role}
*/
export class DataSpaceliftStackAwsRole extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpaceliftStackAwsRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/data-sources/stack_aws_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/data-sources/stack_aws_role spacelift_stack_aws_role} Data Source
  *
  * @param scope The scope in which to define this construct
