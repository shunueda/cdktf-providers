// https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/webhook
...
export interface DataSpaceliftWebhookConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/webhook#id DataSpaceliftWebhook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/webhook#module_id DataSpaceliftWebhook#module_id}
  */
  readonly moduleId?: string;
  /**
  * ID of the stack which triggers the webhooks
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/webhook#stack_id DataSpaceliftWebhook#stack_id}
  */
  readonly stackId?: string;
  /**
  * ID of the webhook
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/webhook#webhook_id DataSpaceliftWebhook#webhook_id}
  */
  readonly webhookId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/webhook spacelift_webhook}
*/
export class DataSpaceliftWebhook extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpaceliftWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/webhook spacelift_webhook} Data Source
  *
  * @param scope The scope in which to define this construct
