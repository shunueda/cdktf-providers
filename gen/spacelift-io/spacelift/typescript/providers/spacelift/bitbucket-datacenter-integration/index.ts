// https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration
...
export interface BitbucketDatacenterIntegrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration#access_token BitbucketDatacenterIntegration#access_token}
  */
  readonly accessToken: string;
  /**
  * The API host where requests will be sent
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration#api_host BitbucketDatacenterIntegration#api_host}
  */
  readonly apiHost: string;
  /**
  * Bitbucket Datacenter integration description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration#description BitbucketDatacenterIntegration#description}
  */
  readonly description?: string;
  /**
  * Bitbucket Datacenter integration is default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration#is_default BitbucketDatacenterIntegration#is_default}
  */
  readonly isDefault: boolean | cdktf.IResolvable;
  /**
  * Bitbucket Datacenter integration labels
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration#labels BitbucketDatacenterIntegration#labels}
  */
  readonly labels?: string[];
  /**
  * Bitbucket Datacenter integration name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration#name BitbucketDatacenterIntegration#name}
  */
  readonly name: string;
  /**
  * Bitbucket Datacenter integration space id. Defaults to `root`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration#space_id BitbucketDatacenterIntegration#space_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration#use_git_checkout BitbucketDatacenterIntegration#use_git_checkout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration#user_facing_host BitbucketDatacenterIntegration#user_facing_host}
  */
  readonly userFacingHost: string;
  /**
  * Username which will be used to authenticate requests for cloning repositories
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration#username BitbucketDatacenterIntegration#username}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration#vcs_checks BitbucketDatacenterIntegration#vcs_checks}
  */
  readonly vcsChecks?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration spacelift_bitbucket_datacenter_integration}
*/
export class BitbucketDatacenterIntegration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BitbucketDatacenterIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/bitbucket_datacenter_integration spacelift_bitbucket_datacenter_integration} Resource
  *
  * @param scope The scope in which to define this construct
