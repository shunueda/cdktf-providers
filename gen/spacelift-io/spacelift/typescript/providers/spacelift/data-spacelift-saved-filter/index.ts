// https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/data-sources/saved_filter
...
export interface DataSpaceliftSavedFilterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/data-sources/saved_filter#filter_id DataSpaceliftSavedFilter#filter_id}
  */
  readonly filterId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/data-sources/saved_filter spacelift_saved_filter}
*/
export class DataSpaceliftSavedFilter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpaceliftSavedFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/data-sources/saved_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/data-sources/saved_filter spacelift_saved_filter} Data Source
  *
  * @param scope The scope in which to define this construct
