// https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/mounted_file
...
export interface MountedFileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/mounted_file#content MountedFile#content}
  */
  readonly content: string;
  /**
  * ID of the context on which the mounted file is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/mounted_file#context_id MountedFile#context_id}
  */
  readonly contextId?: string;
  /**
  * Free-form description of the mounted file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/mounted_file#description MountedFile#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/mounted_file#id MountedFile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/mounted_file#module_id MountedFile#module_id}
  */
  readonly moduleId?: string;
  /**
  * Relative path to the mounted file, without the /mnt/workspace/ prefix
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/mounted_file#relative_path MountedFile#relative_path}
  */
  readonly relativePath: string;
  /**
  * ID of the stack on which the mounted file is defined
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/mounted_file#stack_id MountedFile#stack_id}
  */
  readonly stackId?: string;
  /**
  * Indicates whether the content can be read back outside a Run. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/mounted_file#write_only MountedFile#write_only}
  */
  readonly writeOnly?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/mounted_file spacelift_mounted_file}
*/
export class MountedFile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MountedFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/mounted_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/mounted_file spacelift_mounted_file} Resource
  *
  * @param scope The scope in which to define this construct
