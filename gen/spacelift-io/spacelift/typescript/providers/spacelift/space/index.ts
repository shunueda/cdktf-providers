// https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/space
...
export interface SpaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/space#description Space#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/space#id Space#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/space#inherit_entities Space#inherit_entities}
  */
  readonly inheritEntities?: boolean | cdktf.IResolvable;
  /**
  * list of labels describing a space
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/space#labels Space#labels}
  */
  readonly labels?: string[];
  /**
  * name of the space
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/space#name Space#name}
  */
  readonly name: string;
  /**
  * immutable ID (slug) of parent space. Defaults to `root`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/space#parent_space_id Space#parent_space_id}
  */
  readonly parentSpaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/space spacelift_space}
*/
export class Space extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Space that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/space#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/resources/space spacelift_space} Resource
  *
  * @param scope The scope in which to define this construct
