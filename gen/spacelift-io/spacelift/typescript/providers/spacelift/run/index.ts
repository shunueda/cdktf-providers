// https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/run
...
export interface RunConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/run#commit_sha Run#commit_sha}
  */
  readonly commitSha?: string;
  /**
  * Arbitrary map of values that, when changed, will trigger recreation of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/run#keepers Run#keepers}
  */
  readonly keepers?: { [key: string]: string };
  /**
  * Whether the run is a proposed run. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/run#proposed Run#proposed}
  */
  readonly proposed?: boolean | cdktf.IResolvable;
  /**
  * ID of the stack on which the run is to be triggered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/run#stack_id Run#stack_id}
  */
  readonly stackId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/run#timeouts Run#timeouts}
  */
  readonly timeouts?: RunTimeouts;
  /**
  * wait block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/run#wait Run#wait}
  */
  readonly wait?: RunWait;
}
export interface RunTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/run#create Run#create}
  */
...
export interface RunWait {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/run#continue_on_state Run#continue_on_state}
  */
  readonly continueOnState?: string[];
  /**
  * Continue if run timed out, i.e. did not reach any defined end state in time. Default: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/run#continue_on_timeout Run#continue_on_timeout}
  */
  readonly continueOnTimeout?: boolean | cdktf.IResolvable;
  /**
  * Whether waiting for a job is disabled or not. Default: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/run#disabled Run#disabled}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/run spacelift_run}
*/
export class Run extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Run that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/run#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/run spacelift_run} Resource
  *
  * @param scope The scope in which to define this construct
