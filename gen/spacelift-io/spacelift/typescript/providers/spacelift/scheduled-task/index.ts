// https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/scheduled_task
...
export interface ScheduledTaskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/scheduled_task#at ScheduledTask#at}
  */
  readonly at?: number;
  /**
  * Command that will be run.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/scheduled_task#command ScheduledTask#command}
  */
  readonly command: string;
  /**
  * List of cron schedule expressions based on which the scheduled task should be triggered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/scheduled_task#every ScheduledTask#every}
  */
  readonly every?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/scheduled_task#id ScheduledTask#id}
  *
  ...
  * ID of the schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/scheduled_task#schedule_id ScheduledTask#schedule_id}
  */
  readonly scheduleId?: string;
  /**
  * ID of the stack for which to set up the scheduled task
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/scheduled_task#stack_id ScheduledTask#stack_id}
  */
  readonly stackId: string;
  /**
  * Timezone in which the schedule is expressed. Defaults to `UTC`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/scheduled_task#timezone ScheduledTask#timezone}
  */
  readonly timezone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/scheduled_task spacelift_scheduled_task}
*/
export class ScheduledTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScheduledTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/scheduled_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/scheduled_task spacelift_scheduled_task} Resource
  *
  * @param scope The scope in which to define this construct
