// https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/named_webhook
...
export interface DataSpaceliftNamedWebhookConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/named_webhook#id DataSpaceliftNamedWebhook#id}
  *
  ...
  * ID of the webhook
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/named_webhook#webhook_id DataSpaceliftNamedWebhook#webhook_id}
  */
  readonly webhookId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/named_webhook spacelift_named_webhook}
*/
export class DataSpaceliftNamedWebhook extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpaceliftNamedWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/named_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/named_webhook spacelift_named_webhook} Data Source
  *
  * @param scope The scope in which to define this construct
