// https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/role_attachment
...
export interface RoleAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/role_attachment#api_key_id RoleAttachment#api_key_id}
  */
  readonly apiKeyId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/role_attachment#id RoleAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/role_attachment#idp_group_mapping_id RoleAttachment#idp_group_mapping_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/role_attachment#role_id RoleAttachment#role_id}
  */
  readonly roleId: string;
  /**
  * ID of the space where the role attachment should be created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/role_attachment#space_id RoleAttachment#space_id}
  */
  readonly spaceId: string;
  /**
  * Slug of the Stack to attach to the role. For example: `my-stack`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/role_attachment#stack_id RoleAttachment#stack_id}
  */
  readonly stackId?: string;
  /**
  * ID of the user (ULID format) to attach to the role. For example: `01F8Z5K4Y3D1G2H3J4K5L6M7N8`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/role_attachment#user_id RoleAttachment#user_id}
  */
  readonly userId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/role_attachment spacelift_role_attachment}
*/
export class RoleAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoleAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/role_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/role_attachment spacelift_role_attachment} Resource
  *
  * @param scope The scope in which to define this construct
