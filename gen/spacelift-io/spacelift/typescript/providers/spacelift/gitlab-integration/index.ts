// https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/gitlab_integration
...
export interface GitlabIntegrationConfig extends cdktf.TerraformMetaArguments {
  ...
  * API host URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/gitlab_integration#api_host GitlabIntegration#api_host}
  */
  readonly apiHost: string;
  /**
  * Description of the integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/gitlab_integration#description GitlabIntegration#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/gitlab_integration#is_default GitlabIntegration#is_default}
  */
  readonly isDefault?: boolean | cdktf.IResolvable;
  /**
  * Labels to set on the integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/gitlab_integration#labels GitlabIntegration#labels}
  */
  readonly labels?: string[];
  /**
  * The friendly name of the integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/gitlab_integration#name GitlabIntegration#name}
  */
  readonly name: string;
  /**
  * The GitLab API Token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/gitlab_integration#private_token GitlabIntegration#private_token}
  */
  readonly privateToken: string;
  /**
  * ID (slug) of the space the integration is in; Default: `root`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/gitlab_integration#space_id GitlabIntegration#space_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/gitlab_integration#use_git_checkout GitlabIntegration#use_git_checkout}
  */
  readonly useGitCheckout?: boolean | cdktf.IResolvable;
  /**
  * User facing host URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/gitlab_integration#user_facing_host GitlabIntegration#user_facing_host}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/gitlab_integration#vcs_checks GitlabIntegration#vcs_checks}
  */
  readonly vcsChecks?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/gitlab_integration spacelift_gitlab_integration}
*/
export class GitlabIntegration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GitlabIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/gitlab_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/gitlab_integration spacelift_gitlab_integration} Resource
  *
  * @param scope The scope in which to define this construct
