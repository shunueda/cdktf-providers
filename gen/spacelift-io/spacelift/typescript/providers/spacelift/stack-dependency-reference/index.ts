// https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency_reference
...
export interface StackDependencyReferenceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency_reference#id StackDependencyReference#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency_reference#input_name StackDependencyReference#input_name}
  */
  readonly inputName: string;
  /**
  * Name of the output of stack to depend on
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency_reference#output_name StackDependencyReference#output_name}
  */
  readonly outputName: string;
  /**
  * Immutable ID of stack dependency
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency_reference#stack_dependency_id StackDependencyReference#stack_dependency_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency_reference#trigger_always StackDependencyReference#trigger_always}
  */
  readonly triggerAlways?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency_reference spacelift_stack_dependency_reference}
*/
export class StackDependencyReference extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StackDependencyReference that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency_reference#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/resources/stack_dependency_reference spacelift_stack_dependency_reference} Resource
  *
  * @param scope The scope in which to define this construct
