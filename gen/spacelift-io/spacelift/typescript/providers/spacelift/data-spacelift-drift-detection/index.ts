// https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/data-sources/drift_detection
...
export interface DataSpaceliftDriftDetectionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/data-sources/drift_detection#id DataSpaceliftDriftDetection#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/data-sources/drift_detection#ignore_state DataSpaceliftDriftDetection#ignore_state}
  */
  readonly ignoreState?: boolean | cdktf.IResolvable;
  /**
  * ID of the stack for which to set up drift detection
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/data-sources/drift_detection#stack_id DataSpaceliftDriftDetection#stack_id}
  */
  readonly stackId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/data-sources/drift_detection spacelift_drift_detection}
*/
export class DataSpaceliftDriftDetection extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpaceliftDriftDetection that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/data-sources/drift_detection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.39.0/docs/data-sources/drift_detection spacelift_drift_detection} Data Source
  *
  * @param scope The scope in which to define this construct
