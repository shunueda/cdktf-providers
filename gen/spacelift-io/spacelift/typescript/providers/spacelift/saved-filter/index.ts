// https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/saved_filter
...
export interface SavedFilterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/saved_filter#data SavedFilter#data}
  */
  readonly data: string;
  /**
  * Toggle whether the filter is public or not. If set to true, everyone can use it in the account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/saved_filter#is_public SavedFilter#is_public}
  */
  readonly isPublic: boolean | cdktf.IResolvable;
  /**
  * Name of the saved filter
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/saved_filter#name SavedFilter#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/saved_filter#type SavedFilter#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/saved_filter spacelift_saved_filter}
*/
export class SavedFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SavedFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/saved_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/resources/saved_filter spacelift_saved_filter} Resource
  *
  * @param scope The scope in which to define this construct
