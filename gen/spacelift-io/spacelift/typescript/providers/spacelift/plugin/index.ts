// https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/plugin
...
export interface PluginConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/plugin#labels Plugin#labels}
  */
  readonly labels?: string[];
  /**
  * Name of the plugin
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/plugin#name Plugin#name}
  */
  readonly name: string;
  /**
  * Map of parameter ids to values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/plugin#parameters Plugin#parameters}
  */
  readonly parameters?: { [key: string]: string };
  /**
  * ID of the plugin template to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/plugin#plugin_template_id Plugin#plugin_template_id}
  */
  readonly pluginTemplateId: string;
  /**
  * ID of the space the plugin is in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/plugin#space_id Plugin#space_id}
  */
  readonly spaceId?: string;
  /**
  * Label to use when attaching the plugin to stacks
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/plugin#stack_label Plugin#stack_label}
  */
  readonly stackLabel: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/plugin spacelift_plugin}
*/
export class Plugin extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Plugin that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/plugin#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.40.0/docs/resources/plugin spacelift_plugin} Resource
  *
  * @param scope The scope in which to define this construct
