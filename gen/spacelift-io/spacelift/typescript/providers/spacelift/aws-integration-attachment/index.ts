// https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/aws_integration_attachment
...
export interface AwsIntegrationAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/aws_integration_attachment#id AwsIntegrationAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/aws_integration_attachment#integration_id AwsIntegrationAttachment#integration_id}
  */
  readonly integrationId: string;
  /**
  * ID of the module to attach the integration to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/aws_integration_attachment#module_id AwsIntegrationAttachment#module_id}
  */
  readonly moduleId?: string;
  /**
  * Indicates whether this attachment is used for read operations. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/aws_integration_attachment#read AwsIntegrationAttachment#read}
  */
  readonly read?: boolean | cdktf.IResolvable;
  /**
  * ID of the stack to attach the integration to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/aws_integration_attachment#stack_id AwsIntegrationAttachment#stack_id}
  */
  readonly stackId?: string;
  /**
  * Indicates whether this attachment is used for write operations. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/aws_integration_attachment#write AwsIntegrationAttachment#write}
  */
  readonly write?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/aws_integration_attachment spacelift_aws_integration_attachment}
*/
export class AwsIntegrationAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsIntegrationAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/aws_integration_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/aws_integration_attachment spacelift_aws_integration_attachment} Resource
  *
  * @param scope The scope in which to define this construct
