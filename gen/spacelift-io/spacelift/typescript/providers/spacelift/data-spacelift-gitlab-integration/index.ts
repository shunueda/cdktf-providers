// https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/data-sources/gitlab_integration
...
export interface DataSpaceliftGitlabIntegrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/data-sources/gitlab_integration#id DataSpaceliftGitlabIntegration#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/data-sources/gitlab_integration spacelift_gitlab_integration}
*/
export class DataSpaceliftGitlabIntegration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpaceliftGitlabIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/data-sources/gitlab_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.38.0/docs/data-sources/gitlab_integration spacelift_gitlab_integration} Data Source
  *
  * @param scope The scope in which to define this construct
