// https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/named_webhook
...
export interface NamedWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/named_webhook#enabled NamedWebhook#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * endpoint to send the requests to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/named_webhook#endpoint NamedWebhook#endpoint}
  */
  readonly endpoint: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/named_webhook#id NamedWebhook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/named_webhook#labels NamedWebhook#labels}
  */
  readonly labels?: string[];
  /**
  * the name for the webhook which will also be used to generate the id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/named_webhook#name NamedWebhook#name}
  */
  readonly name: string;
  /**
  * whether to retry the webhook in case of failure. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/named_webhook#retry_on_failure NamedWebhook#retry_on_failure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/named_webhook#secret NamedWebhook#secret}
  */
  readonly secret?: string;
  /**
  * ID of the space the webhook is in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/named_webhook#space_id NamedWebhook#space_id}
  */
  readonly spaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/named_webhook spacelift_named_webhook}
*/
export class NamedWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NamedWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/named_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/named_webhook spacelift_named_webhook} Resource
  *
  * @param scope The scope in which to define this construct
