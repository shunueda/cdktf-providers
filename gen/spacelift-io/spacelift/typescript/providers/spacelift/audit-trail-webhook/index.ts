// https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/audit_trail_webhook
...
export interface AuditTrailWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/audit_trail_webhook#custom_headers AuditTrailWebhook#custom_headers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/audit_trail_webhook#enabled AuditTrailWebhook#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * `endpoint` is the URL to which Spacelift will send POST requests about audit events.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/audit_trail_webhook#endpoint AuditTrailWebhook#endpoint}
  */
  readonly endpoint: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/audit_trail_webhook#id AuditTrailWebhook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/audit_trail_webhook#include_runs AuditTrailWebhook#include_runs}
  */
  readonly includeRuns?: boolean | cdktf.IResolvable;
  /**
  * whether to retry the webhook in case of failure. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/audit_trail_webhook#retry_on_failure AuditTrailWebhook#retry_on_failure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/audit_trail_webhook#secret AuditTrailWebhook#secret}
  */
  readonly secret: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/audit_trail_webhook spacelift_audit_trail_webhook}
*/
export class AuditTrailWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuditTrailWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/audit_trail_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.36.0/docs/resources/audit_trail_webhook spacelift_audit_trail_webhook} Resource
  *
  * @param scope The scope in which to define this construct
