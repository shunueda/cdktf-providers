// https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/drift_detection
...
export interface DriftDetectionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/drift_detection#id DriftDetection#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/drift_detection#ignore_state DriftDetection#ignore_state}
  */
  readonly ignoreState?: boolean | cdktf.IResolvable;
  /**
  * Whether a tracked run should be triggered when drift is detected.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/drift_detection#reconcile DriftDetection#reconcile}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/drift_detection#schedule DriftDetection#schedule}
  */
  readonly schedule: string[];
  /**
  * ID of the stack for which to set up drift detection
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/drift_detection#stack_id DriftDetection#stack_id}
  */
  readonly stackId: string;
  /**
  * Timezone in which the schedule is expressed. Defaults to `UTC`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/drift_detection#timezone DriftDetection#timezone}
  */
  readonly timezone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/drift_detection spacelift_drift_detection}
*/
export class DriftDetection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DriftDetection that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/drift_detection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.41.0/docs/resources/drift_detection spacelift_drift_detection} Resource
  *
  * @param scope The scope in which to define this construct
