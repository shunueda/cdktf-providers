// https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/azure_integration
...
export interface DataSpaceliftAzureIntegrationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/azure_integration#id DataSpaceliftAzureIntegration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/azure_integration#integration_id DataSpaceliftAzureIntegration#integration_id}
  */
  readonly integrationId?: string;
  /**
  * The friendly name of the integration. Either `integration_id` or `name` must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/azure_integration#name DataSpaceliftAzureIntegration#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/azure_integration spacelift_azure_integration}
*/
export class DataSpaceliftAzureIntegration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSpaceliftAzureIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/azure_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spacelift-io/spacelift/1.42.0/docs/data-sources/azure_integration spacelift_azure_integration} Data Source
  *
  * @param scope The scope in which to define this construct
