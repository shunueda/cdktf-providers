// https://registry.terraform.io/providers/clickhouse/clickhousedbops/1.3.2/docs
...
export interface ClickhousedbopsProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clickhouse/clickhousedbops/1.3.2/docs#auth_config ClickhousedbopsProvider#auth_config}
  */
  readonly authConfig: ClickhousedbopsProviderAuthConfig;
  /**
  * The hostname to use to connect to the clickhouse instance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clickhouse/clickhousedbops/1.3.2/docs#host ClickhousedbopsProvider#host}
  */
  readonly host: string;
  /**
  * The port to use to connect to the clickhouse instance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clickhouse/clickhousedbops/1.3.2/docs#port ClickhousedbopsProvider#port}
  */
  readonly port: number;
  /**
  * The protocol to use to connect to clickhouse instance. Valid options are: native, nativesecure, http, https
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clickhouse/clickhousedbops/1.3.2/docs#protocol ClickhousedbopsProvider#protocol}
  */
  readonly protocol: string;
  /**
  * TLS configuration options
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clickhouse/clickhousedbops/1.3.2/docs#tls_config ClickhousedbopsProvider#tls_config}
  */
  readonly tlsConfig?: ClickhousedbopsProviderTlsConfig;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clickhouse/clickhousedbops/1.3.2/docs#alias ClickhousedbopsProvider#alias}
  */
...
export interface ClickhousedbopsProviderAuthConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clickhouse/clickhousedbops/1.3.2/docs#password ClickhousedbopsProvider#password}
  */
  readonly password?: string;
  /**
  * The authentication method to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clickhouse/clickhousedbops/1.3.2/docs#strategy ClickhousedbopsProvider#strategy}
  */
  readonly strategy: string;
  /**
  * The username to use to authenticate to ClickHouse
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clickhouse/clickhousedbops/1.3.2/docs#username ClickhousedbopsProvider#username}
  */
...
export interface ClickhousedbopsProviderTlsConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/clickhouse/clickhousedbops/1.3.2/docs#insecure_skip_verify ClickhousedbopsProvider#insecure_skip_verify}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/clickhouse/clickhousedbops/1.3.2/docs clickhousedbops}
*/
export class ClickhousedbopsProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ClickhousedbopsProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/clickhouse/clickhousedbops/1.3.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/clickhouse/clickhousedbops/1.3.2/docs clickhousedbops} Resource
  *
  * @param scope The scope in which to define this construct
