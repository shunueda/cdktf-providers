// https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service_repository
...
export interface ServiceRepositoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service_repository#base_directory ServiceRepository#base_directory}
  */
  readonly baseDirectory?: string;
  /**
  * The name displayed in the UI for the service repository.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service_repository#name ServiceRepository#name}
  */
  readonly name?: string;
  /**
  * The id of the repository that this will be added to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service_repository#repository ServiceRepository#repository}
  */
  readonly repository?: string;
  /**
  * The alias of the repository that this will be added to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service_repository#repository_alias ServiceRepository#repository_alias}
  */
  readonly repositoryAlias?: string;
  /**
  * The id of the service that this will be added to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service_repository#service ServiceRepository#service}
  */
  readonly service?: string;
  /**
  * The alias of the service that this will be added to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service_repository#service_alias ServiceRepository#service_alias}
  */
  readonly serviceAlias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service_repository opslevel_service_repository}
*/
export class ServiceRepository extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service_repository#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service_repository opslevel_service_repository} Resource
  *
  * @param scope The scope in which to define this construct
