// https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file
...
export interface CheckRepositoryFileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#category CheckRepositoryFile#category}
  */
  readonly category: string;
  /**
  * Whether the check looks for the existence of a directory instead of a file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#directory_search CheckRepositoryFile#directory_search}
  */
  ...
  *  
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#enable_on CheckRepositoryFile#enable_on}
  */
  readonly enableOn?: string;
  /**
  * Whether the check is enabled or not.  Do not use this field in tandem with 'enable_on'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#enabled CheckRepositoryFile#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#file_contents_predicate CheckRepositoryFile#file_contents_predicate}
  */
  readonly fileContentsPredicate?: CheckRepositoryFileFileContentsPredicate;
  /**
  * Restrict the search to certain file paths.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#filepaths CheckRepositoryFile#filepaths}
  */
  readonly filepaths: string[];
  /**
  * The id of the filter of the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#filter CheckRepositoryFile#filter}
  */
  readonly filter?: string;
  /**
  * The id of the level the check belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#level CheckRepositoryFile#level}
  */
  readonly level: string;
  /**
  * The display name of the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#name CheckRepositoryFile#name}
  */
  readonly name: string;
  /**
  * Additional information to display to the service owner about the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#notes CheckRepositoryFile#notes}
  */
  readonly notes?: string;
  /**
  * The id of the team that owns the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#owner CheckRepositoryFile#owner}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#use_absolute_root CheckRepositoryFile#use_absolute_root}
  */
...
export interface CheckRepositoryFileFileContentsPredicate {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#type CheckRepositoryFile#type}
  */
  readonly type: string;
  /**
  * The condition value used by the predicate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#value CheckRepositoryFile#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file opslevel_check_repository_file}
*/
export class CheckRepositoryFile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CheckRepositoryFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_repository_file opslevel_check_repository_file} Resource
  *
  * @param scope The scope in which to define this construct
