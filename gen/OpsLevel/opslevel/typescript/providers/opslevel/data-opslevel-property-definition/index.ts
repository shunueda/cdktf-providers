// https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/data-sources/property_definition
...
export interface DataOpslevelPropertyDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/data-sources/property_definition#identifier DataOpslevelPropertyDefinition#identifier}
  */
  readonly identifier: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/data-sources/property_definition opslevel_property_definition}
*/
export class DataOpslevelPropertyDefinition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpslevelPropertyDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/data-sources/property_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/data-sources/property_definition opslevel_property_definition} Data Source
  *
  * @param scope The scope in which to define this construct
