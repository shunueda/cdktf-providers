// https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_contact
...
export interface TeamContactConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_contact#name TeamContact#name}
  */
  readonly name: string;
  /**
  * The id or alias of the team the contact belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_contact#team TeamContact#team}
  */
  readonly team: string;
  /**
  * The method of contact. One of `email`, `github`, `microsoft_teams`, `slack`, `slack_handle`, `web`, `any`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_contact#type TeamContact#type}
  */
  readonly type: string;
  /**
  * The contact value. Examples: support@company.com for type email, https://opslevel.com for type web, #devs for type slack
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_contact#value TeamContact#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_contact opslevel_team_contact}
*/
export class TeamContact extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamContact that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_contact#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_contact opslevel_team_contact} Resource
  *
  * @param scope The scope in which to define this construct
