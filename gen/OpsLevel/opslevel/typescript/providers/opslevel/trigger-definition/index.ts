// https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition
...
export interface TriggerDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#access_control TriggerDefinition#access_control}
  */
  readonly accessControl: string;
  /**
  * The action that will be triggered by the Trigger Definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#action TriggerDefinition#action}
  */
  readonly action: string;
  /**
  * Flag indicating approval is required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#approval_required TriggerDefinition#approval_required}
  */
  readonly approvalRequired?: boolean | cdktf.IResolvable;
  /**
  * Teams that can approve this Trigger Definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#approval_teams TriggerDefinition#approval_teams}
  */
  readonly approvalTeams?: string[];
  /**
  * Users that can approve this Trigger Definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#approval_users TriggerDefinition#approval_users}
  */
  readonly approvalUsers?: string[];
  /**
  * The description of what the Trigger Definition will do.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#description TriggerDefinition#description}
  */
  readonly description?: string;
  /**
  * The entity type to associate with the Trigger Definition. One of `GLOBAL`, `SERVICE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#entity_type TriggerDefinition#entity_type}
  */
  readonly entityType?: string;
  /**
  * The set of additional teams who can invoke this Trigger Definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#extended_team_access TriggerDefinition#extended_team_access}
  */
  readonly extendedTeamAccess?: string[];
  /**
  * A filter defining which services this Trigger Definition applies to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#filter TriggerDefinition#filter}
  */
  readonly filter?: string;
  /**
  * The YAML definition of any custom inputs for this Trigger Definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#manual_inputs_definition TriggerDefinition#manual_inputs_definition}
  */
  readonly manualInputsDefinition?: string;
  /**
  * The name of the Trigger Definition
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#name TriggerDefinition#name}
  */
  readonly name: string;
  /**
  * The owner of the Trigger Definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#owner TriggerDefinition#owner}
  */
  readonly owner: string;
  /**
  * The published state of the Custom Action; true if the Trigger Definition is ready for use; false if it is a draft.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#published TriggerDefinition#published}
  */
  readonly published: boolean | cdktf.IResolvable;
  /**
  * The liquid template used to parse the response from the Webhook Action.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#response_template TriggerDefinition#response_template}
  */
  readonly responseTemplate?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition opslevel_trigger_definition}
*/
export class TriggerDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TriggerDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/trigger_definition opslevel_trigger_definition} Resource
  *
  * @param scope The scope in which to define this construct
