// https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage
...
export interface CheckAlertSourceUsageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage#alert_name_predicate CheckAlertSourceUsage#alert_name_predicate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage#alert_type CheckAlertSourceUsage#alert_type}
  */
  readonly alertType: string;
  /**
  * The id of the category the check belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage#category CheckAlertSourceUsage#category}
  */
  ...
  *  
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage#enable_on CheckAlertSourceUsage#enable_on}
  */
  readonly enableOn?: string;
  /**
  * Whether the check is enabled or not.  Do not use this field in tandem with 'enable_on'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage#enabled CheckAlertSourceUsage#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The id of the filter of the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage#filter CheckAlertSourceUsage#filter}
  */
  readonly filter?: string;
  /**
  * The id of the level the check belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage#level CheckAlertSourceUsage#level}
  */
  readonly level: string;
  /**
  * The display name of the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage#name CheckAlertSourceUsage#name}
  */
  readonly name: string;
  /**
  * Additional information to display to the service owner about the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage#notes CheckAlertSourceUsage#notes}
  */
  readonly notes?: string;
  /**
  * The id of the team that owns the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage#owner CheckAlertSourceUsage#owner}
  */
...
export interface CheckAlertSourceUsageAlertNamePredicate {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage#type CheckAlertSourceUsage#type}
  */
  readonly type: string;
  /**
  * The condition value used by the predicate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage#value CheckAlertSourceUsage#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage opslevel_check_alert_source_usage}
*/
export class CheckAlertSourceUsage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CheckAlertSourceUsage that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_alert_source_usage opslevel_check_alert_source_usage} Resource
  *
  * @param scope The scope in which to define this construct
