// https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/webhook_action
...
export interface WebhookActionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/webhook_action#async WebhookAction#async}
  */
  readonly async?: boolean | cdktf.IResolvable;
  /**
  * The description of the Webhook Action.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/webhook_action#description WebhookAction#description}
  */
  readonly description?: string;
  /**
  * HTTP headers to be passed along with your webhook when triggered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/webhook_action#headers WebhookAction#headers}
  */
  readonly headers?: { [key: string]: string };
  /**
  * The http method used to call the Webhook Action. One of `DELETE`, `GET`, `PATCH`, `POST`, `PUT`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/webhook_action#method WebhookAction#method}
  */
  readonly method: string;
  /**
  * The name of the Webhook Action.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/webhook_action#name WebhookAction#name}
  */
  readonly name: string;
  /**
  * Template that can be used to generate a webhook payload.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/webhook_action#payload WebhookAction#payload}
  */
  readonly payload: string;
  /**
  * The URL of the Webhook Action.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/webhook_action#url WebhookAction#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/webhook_action opslevel_webhook_action}
*/
export class WebhookAction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebhookAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/webhook_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/webhook_action opslevel_webhook_action} Resource
  *
  * @param scope The scope in which to define this construct
