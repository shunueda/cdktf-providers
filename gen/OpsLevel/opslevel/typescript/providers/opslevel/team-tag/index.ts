// https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_tag
...
export interface TeamTagConfig extends cdktf.TerraformMetaArguments {
  ...
  * The tag's key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_tag#key TeamTag#key}
  */
  readonly key: string;
  /**
  * The id of the team that this will be added to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_tag#team TeamTag#team}
  */
  readonly team?: string;
  /**
  * The alias of the team that this will be added to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_tag#team_alias TeamTag#team_alias}
  */
  readonly teamAlias?: string;
  /**
  * The tag's value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_tag#value TeamTag#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_tag opslevel_team_tag}
*/
export class TeamTag extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/team_tag opslevel_team_tag} Resource
  *
  * @param scope The scope in which to define this construct
