// https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/scorecard
...
export interface ScorecardConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/scorecard#affects_overall_service_levels Scorecard#affects_overall_service_levels}
  */
  readonly affectsOverallServiceLevels: boolean | cdktf.IResolvable;
  /**
  * The scorecard's description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/scorecard#description Scorecard#description}
  */
  readonly description?: string;
  /**
  * The scorecard's filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/scorecard#filter_id Scorecard#filter_id}
  */
  readonly filterId?: string;
  /**
  * The scorecard's name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/scorecard#name Scorecard#name}
  */
  readonly name: string;
  /**
  * The scorecard's owner.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/scorecard#owner_id Scorecard#owner_id}
  */
  readonly ownerId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/scorecard opslevel_scorecard}
*/
export class Scorecard extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Scorecard that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/scorecard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/scorecard opslevel_scorecard} Resource
  *
  * @param scope The scope in which to define this construct
