// https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/data-sources/lifecycle
...
export interface DataOpslevelLifecycleConfig extends cdktf.TerraformMetaArguments {
  ...
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/data-sources/lifecycle#filter DataOpslevelLifecycle#filter}
  */
...
export interface DataOpslevelLifecycleFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/data-sources/lifecycle#field DataOpslevelLifecycle#field}
  */
  readonly field: string;
  /**
  * The field value of the target resource to match.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/data-sources/lifecycle#value DataOpslevelLifecycle#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/data-sources/lifecycle opslevel_lifecycle}
*/
export class DataOpslevelLifecycle extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpslevelLifecycle that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/data-sources/lifecycle#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/data-sources/lifecycle opslevel_lifecycle} Data Source
  *
  * @param scope The scope in which to define this construct
