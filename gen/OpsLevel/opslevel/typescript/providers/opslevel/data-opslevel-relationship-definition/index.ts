// https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/data-sources/relationship_definition
...
export interface DataOpslevelRelationshipDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/data-sources/relationship_definition#identifier DataOpslevelRelationshipDefinition#identifier}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/data-sources/relationship_definition opslevel_relationship_definition}
*/
export class DataOpslevelRelationshipDefinition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpslevelRelationshipDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/data-sources/relationship_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/data-sources/relationship_definition opslevel_relationship_definition} Data Source
  *
  * @param scope The scope in which to define this construct
