// https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/integration_azure_resources
...
export interface IntegrationAzureResourcesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/integration_azure_resources#client_id IntegrationAzureResources#client_id}
  */
  readonly clientId: string;
  /**
  * The client secret OpsLevel uses to access the Azure account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/integration_azure_resources#client_secret IntegrationAzureResources#client_secret}
  */
  readonly clientSecret: string;
  /**
  * The name of the integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/integration_azure_resources#name IntegrationAzureResources#name}
  */
  readonly name: string;
  /**
  * An Array of tag keys used to associate ownership from an integration. Max 5 (default = ["owner"])
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/integration_azure_resources#ownership_tag_keys IntegrationAzureResources#ownership_tag_keys}
  */
  readonly ownershipTagKeys?: string[];
  /**
  * Allow tags imported from Azure to override ownership set in OpsLevel directly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/integration_azure_resources#ownership_tag_overrides IntegrationAzureResources#ownership_tag_overrides}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/integration_azure_resources#subscription_id IntegrationAzureResources#subscription_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/integration_azure_resources#tenant_id IntegrationAzureResources#tenant_id}
  */
  readonly tenantId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/integration_azure_resources opslevel_integration_azure_resources}
*/
export class IntegrationAzureResources extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationAzureResources that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/integration_azure_resources#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs/resources/integration_azure_resources opslevel_integration_azure_resources} Resource
  *
  * @param scope The scope in which to define this construct
