// https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/data-sources/integrations
...
/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/data-sources/integrations opslevel_integrations}
*/
export class DataOpslevelIntegrations extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpslevelIntegrations that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/data-sources/integrations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/data-sources/integrations opslevel_integrations} Data Source
  *
  * @param scope The scope in which to define this construct
