// https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_tool
...
export interface ServiceToolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_tool#category ServiceTool#category}
  */
  readonly category: string;
  /**
  * The environment that the tool belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_tool#environment ServiceTool#environment}
  */
  readonly environment?: string;
  /**
  * The display name of the tool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_tool#name ServiceTool#name}
  */
  readonly name: string;
  /**
  * The id of the service that this will be added to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_tool#service ServiceTool#service}
  */
  readonly service?: string;
  /**
  * The alias of the service that this will be added to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_tool#service_alias ServiceTool#service_alias}
  */
  readonly serviceAlias?: string;
  /**
  * The URL of the tool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_tool#url ServiceTool#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_tool opslevel_service_tool}
*/
export class ServiceTool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceTool that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_tool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_tool opslevel_service_tool} Resource
  *
  * @param scope The scope in which to define this construct
