// https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/service_dependency
...
export interface ServiceDependencyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/service_dependency#depends_upon ServiceDependency#depends_upon}
  */
  readonly dependsUpon: string;
  /**
  * Notes for service dependency.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/service_dependency#note ServiceDependency#note}
  */
  readonly note?: string;
  /**
  * The ID or alias of the service with the dependency.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/service_dependency#service ServiceDependency#service}
  */
  readonly service: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/service_dependency opslevel_service_dependency}
*/
export class ServiceDependency extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceDependency that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/service_dependency#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/service_dependency opslevel_service_dependency} Resource
  *
  * @param scope The scope in which to define this construct
