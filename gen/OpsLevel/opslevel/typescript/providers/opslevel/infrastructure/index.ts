// https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/infrastructure
...
export interface InfrastructureConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/infrastructure#aliases Infrastructure#aliases}
  */
  readonly aliases?: string[];
  /**
  * The data of the infrastructure resource in JSON format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/infrastructure#data Infrastructure#data}
  */
  readonly data: string;
  /**
  * The id of the team that owns the infrastructure resource. Does not support aliases!
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/infrastructure#owner Infrastructure#owner}
  */
  readonly owner: string;
  /**
  * The provider specific data for the infrastructure resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/infrastructure#provider_data Infrastructure#provider_data}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/infrastructure#schema Infrastructure#schema}
  */
...
export interface InfrastructureProviderData {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/infrastructure#account Infrastructure#account}
  */
  readonly account: string;
  /**
  * The name of the provider of the infrastructure resource. (eg. AWS, GCP, Azure)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/infrastructure#name Infrastructure#name}
  */
  readonly name?: string;
  /**
  * The type of the infrastructure resource as defined by its provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/infrastructure#type Infrastructure#type}
  */
  readonly type?: string;
  /**
  * The url for the provider of the infrastructure resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/infrastructure#url Infrastructure#url}
  */
  readonly url?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/infrastructure opslevel_infrastructure}
*/
export class Infrastructure extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Infrastructure that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/infrastructure#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/infrastructure opslevel_infrastructure} Resource
  *
  * @param scope The scope in which to define this construct
