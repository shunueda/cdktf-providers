// https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/integration_aws
...
export interface IntegrationAwsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/integration_aws#external_id IntegrationAws#external_id}
  */
  readonly externalId: string;
  /**
  * The IAM role OpsLevel uses in order to access the AWS account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/integration_aws#iam_role IntegrationAws#iam_role}
  */
  readonly iamRole: string;
  /**
  * The name of the integration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/integration_aws#name IntegrationAws#name}
  */
  readonly name: string;
  /**
  * Allow tags imported from AWS to override ownership set in OpsLevel directly. Max 5 (default = ["owner"])
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/integration_aws#ownership_tag_keys IntegrationAws#ownership_tag_keys}
  */
  readonly ownershipTagKeys?: string[];
  /**
  * Allow tags imported from AWS to override ownership set in OpsLevel directly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/integration_aws#ownership_tag_overrides IntegrationAws#ownership_tag_overrides}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/integration_aws#region_override IntegrationAws#region_override}
  */
  readonly regionOverride?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/integration_aws opslevel_integration_aws}
*/
export class IntegrationAws extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationAws that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/integration_aws#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/integration_aws opslevel_integration_aws} Resource
  *
  * @param scope The scope in which to define this construct
