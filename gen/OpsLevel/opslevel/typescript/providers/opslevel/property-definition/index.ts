// https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/property_definition
...
export interface PropertyDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/property_definition#allowed_in_config_files PropertyDefinition#allowed_in_config_files}
  */
  readonly allowedInConfigFiles: boolean | cdktf.IResolvable;
  /**
  * The description of the property definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/property_definition#description PropertyDefinition#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/property_definition#locked_status PropertyDefinition#locked_status}
  */
  readonly lockedStatus: string;
  /**
  * The display name of the property definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/property_definition#name PropertyDefinition#name}
  */
  readonly name: string;
  /**
  * The display status of a custom property on service pages. One of `hidden`, `visible`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/property_definition#property_display_status PropertyDefinition#property_display_status}
  */
  readonly propertyDisplayStatus: string;
  /**
  * The schema of the property definition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/property_definition#schema PropertyDefinition#schema}
  */
  readonly schema: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/property_definition opslevel_property_definition}
*/
export class PropertyDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PropertyDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/property_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/property_definition opslevel_property_definition} Resource
  *
  * @param scope The scope in which to define this construct
