// https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership
...
export interface CheckServiceOwnershipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#category CheckServiceOwnership#category}
  */
  readonly category: string;
  /**
  * The type of contact method that is required. One of `email`, `github`, `microsoft_teams`, `slack`, `slack_handle`, `web`, `any`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#contact_method CheckServiceOwnership#contact_method}
  */
  ...
  *  
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#enable_on CheckServiceOwnership#enable_on}
  */
  readonly enableOn?: string;
  /**
  * Whether the check is enabled or not.  Do not use this field in tandem with 'enable_on'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#enabled CheckServiceOwnership#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The id of the filter of the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#filter CheckServiceOwnership#filter}
  */
  readonly filter?: string;
  /**
  * The id of the level the check belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#level CheckServiceOwnership#level}
  */
  readonly level: string;
  /**
  * The display name of the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#name CheckServiceOwnership#name}
  */
  readonly name: string;
  /**
  * Additional information to display to the service owner about the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#notes CheckServiceOwnership#notes}
  */
  readonly notes?: string;
  /**
  * The id of the team that owns the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#owner CheckServiceOwnership#owner}
  */
  readonly owner?: string;
  /**
  * True if a service's owner must have a contact method, False otherwise.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#require_contact_method CheckServiceOwnership#require_contact_method}
  */
  readonly requireContactMethod?: boolean | cdktf.IResolvable;
  /**
  * The tag key where the tag predicate should be applied.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#tag_key CheckServiceOwnership#tag_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#tag_predicate CheckServiceOwnership#tag_predicate}
  */
...
export interface CheckServiceOwnershipTagPredicate {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#type CheckServiceOwnership#type}
  */
  readonly type: string;
  /**
  * The condition value used by the predicate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#value CheckServiceOwnership#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership opslevel_check_service_ownership}
*/
export class CheckServiceOwnership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CheckServiceOwnership that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_service_ownership opslevel_check_service_ownership} Resource
  *
  * @param scope The scope in which to define this construct
