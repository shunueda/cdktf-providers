// https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs
...
export interface OpslevelProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs#api_timeout OpslevelProvider#api_timeout}
  */
  readonly apiTimeout?: number;
  /**
  * The API authorization token. It can also be sourced from the OPSLEVEL_API_TOKEN environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs#api_token OpslevelProvider#api_token}
  */
  readonly apiToken?: string;
  /**
  * The url of the OpsLevel API to. It can also be sourced from the OPSLEVEL_API_URL environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs#api_url OpslevelProvider#api_url}
  */
  readonly apiUrl?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs#alias OpslevelProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs opslevel}
*/
export class OpslevelProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing OpslevelProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.7.0/docs opslevel} Resource
  *
  * @param scope The scope in which to define this construct
