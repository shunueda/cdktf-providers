// https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/rubric_category
...
export interface RubricCategoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/rubric_category#name RubricCategory#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/rubric_category opslevel_rubric_category}
*/
export class RubricCategory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RubricCategory that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/rubric_category#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/rubric_category opslevel_rubric_category} Resource
  *
  * @param scope The scope in which to define this construct
