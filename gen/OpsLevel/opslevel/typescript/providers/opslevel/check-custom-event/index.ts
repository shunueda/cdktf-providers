// https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event
...
export interface CheckCustomEventConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event#category CheckCustomEvent#category}
  */
  ...
  *  
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event#enable_on CheckCustomEvent#enable_on}
  */
  readonly enableOn?: string;
  /**
  * Whether the check is enabled or not.  Do not use this field in tandem with 'enable_on'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event#enabled CheckCustomEvent#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The id of the filter of the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event#filter CheckCustomEvent#filter}
  */
  readonly filter?: string;
  /**
  * The integration id this check will use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event#integration CheckCustomEvent#integration}
  */
  readonly integration: string;
  /**
  * The id of the level the check belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event#level CheckCustomEvent#level}
  */
  readonly level: string;
  /**
  * The check result message template. It is compiled with Liquid and formatted in Markdown.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event#message CheckCustomEvent#message}
  */
  readonly message?: string;
  /**
  * The display name of the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event#name CheckCustomEvent#name}
  */
  readonly name: string;
  /**
  * Additional information to display to the service owner about the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event#notes CheckCustomEvent#notes}
  */
  readonly notes?: string;
  /**
  * The id of the team that owns the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event#owner CheckCustomEvent#owner}
  */
  readonly owner?: string;
  /**
  * True if this check should pass by default. Otherwise the default 'pending' state counts as a failure.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event#pass_pending CheckCustomEvent#pass_pending}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event#service_selector CheckCustomEvent#service_selector}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event#success_condition CheckCustomEvent#success_condition}
  */
  readonly successCondition: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event opslevel_check_custom_event}
*/
export class CheckCustomEvent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CheckCustomEvent that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.6.3/docs/resources/check_custom_event opslevel_check_custom_event} Resource
  *
  * @param scope The scope in which to define this construct
