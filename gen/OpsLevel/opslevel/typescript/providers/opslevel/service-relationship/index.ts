// https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_relationship
...
export interface ServiceRelationshipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_relationship#service ServiceRelationship#service}
  */
  readonly service: string;
  /**
  * The ID or alias of the system tied to the service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_relationship#system ServiceRelationship#system}
  */
  readonly systemAttribute: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_relationship opslevel_service_relationship}
*/
export class ServiceRelationship extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceRelationship that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_relationship#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/service_relationship opslevel_service_relationship} Resource
  *
  * @param scope The scope in which to define this construct
