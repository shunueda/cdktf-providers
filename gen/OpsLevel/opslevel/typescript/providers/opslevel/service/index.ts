// https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service
...
export interface ServiceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#aliases Service#aliases}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#api_document_path Service#api_document_path}
  */
  readonly apiDocumentPath?: string;
  /**
  * A brief description of the service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#description Service#description}
  */
  readonly description?: string;
  /**
  * The primary software development framework that the service uses.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#framework Service#framework}
  */
  readonly framework?: string;
  /**
  * The primary programming language that the service is written in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#language Service#language}
  */
  readonly language?: string;
  /**
  * The lifecycle stage of the service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#lifecycle_alias Service#lifecycle_alias}
  */
  readonly lifecycleAlias?: string;
  /**
  * The display name of the service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#name Service#name}
  */
  readonly name: string;
  /**
  * Additional information about the service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#note Service#note}
  */
  readonly note?: string;
  /**
  * The team that owns the service. ID or Alias may be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#owner Service#owner}
  */
  readonly owner?: string;
  /**
  * The id or alias of the parent system of this service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#parent Service#parent}
  */
  readonly parent?: string;
  /**
  * The API document source (PULL or PUSH) used to determine the displayed document. If null, defaults to PUSH.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#preferred_api_document_source Service#preferred_api_document_source}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#product Service#product}
  */
  readonly product?: string;
  /**
  * A list of tags applied to the service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#tags Service#tags}
  */
  readonly tags?: string[];
  /**
  * The software tier that the service belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#tier_alias Service#tier_alias}
  */
  readonly tierAlias?: string;
  /**
  * The component type of the service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#type Service#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service opslevel_service}
*/
export class Service extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Service that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/service opslevel_service} Resource
  *
  * @param scope The scope in which to define this construct
