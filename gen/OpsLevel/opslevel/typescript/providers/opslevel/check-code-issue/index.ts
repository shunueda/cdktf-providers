// https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue
...
export interface CheckCodeIssueConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#category CheckCodeIssue#category}
  */
  readonly category: string;
  /**
  * The type of constraint used in evaluation the code issues check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#constraint CheckCodeIssue#constraint}
  */
  ...
  *  
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#enable_on CheckCodeIssue#enable_on}
  */
  readonly enableOn?: string;
  /**
  * Whether the check is enabled or not.  Do not use this field in tandem with 'enable_on'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#enabled CheckCodeIssue#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The id of the filter of the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#filter CheckCodeIssue#filter}
  */
  readonly filter?: string;
  /**
  * The issue name used for code issue lookup.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#issue_name CheckCodeIssue#issue_name}
  */
  readonly issueName?: string;
  /**
  * The types of code issues to consider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#issue_type CheckCodeIssue#issue_type}
  */
  readonly issueType?: string[];
  /**
  * The id of the level the check belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#level CheckCodeIssue#level}
  */
  readonly level: string;
  /**
  * The threshold count of code issues beyond which the check starts failing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#max_allowed CheckCodeIssue#max_allowed}
  */
  readonly maxAllowed?: number;
  /**
  * The display name of the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#name CheckCodeIssue#name}
  */
  readonly name: string;
  /**
  * Additional information to display to the service owner about the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#notes CheckCodeIssue#notes}
  */
  readonly notes?: string;
  /**
  * The id of the team that owns the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#owner CheckCodeIssue#owner}
  */
  readonly owner?: string;
  /**
  * Defines the minimum frequency of the updates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#resolution_time CheckCodeIssue#resolution_time}
  */
  readonly resolutionTime?: CheckCodeIssueResolutionTime;
  /**
  * The severity levels of the issue.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#severity CheckCodeIssue#severity}
  */
...
export interface CheckCodeIssueResolutionTime {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#unit CheckCodeIssue#unit}
  */
  readonly unit: string;
  /**
  * The count value of the specified unit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#value CheckCodeIssue#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue opslevel_check_code_issue}
*/
export class CheckCodeIssue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CheckCodeIssue that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.1/docs/resources/check_code_issue opslevel_check_code_issue} Resource
  *
  * @param scope The scope in which to define this construct
