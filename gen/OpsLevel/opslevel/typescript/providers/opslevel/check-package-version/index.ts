// https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version
...
export interface CheckPackageVersionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#category CheckPackageVersion#category}
  */
  ...
  *  
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#enable_on CheckPackageVersion#enable_on}
  */
  readonly enableOn?: string;
  /**
  * Whether the check is enabled or not.  Do not use this field in tandem with 'enable_on'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#enabled CheckPackageVersion#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The id of the filter of the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#filter CheckPackageVersion#filter}
  */
  readonly filter?: string;
  /**
  * The id of the level the check belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#level CheckPackageVersion#level}
  */
  readonly level: string;
  /**
  * The check result if the package isn't being used by a service. (Optional.)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#missing_package_result CheckPackageVersion#missing_package_result}
  */
  readonly missingPackageResult?: string;
  /**
  * The display name of the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#name CheckPackageVersion#name}
  */
  readonly name: string;
  /**
  * Additional information to display to the service owner about the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#notes CheckPackageVersion#notes}
  */
  readonly notes?: string;
  /**
  * The id of the team that owns the check.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#owner CheckPackageVersion#owner}
  */
  readonly owner?: string;
  /**
  * The package constraint the service is to be checked for. (Required.)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#package_constraint CheckPackageVersion#package_constraint}
  */
  readonly packageConstraint: string;
  /**
  * The package manager (ecosystem) this package relates to. (Required.)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#package_manager CheckPackageVersion#package_manager}
  */
  readonly packageManager: string;
  /**
  * The name of the package to be checked. (Required.)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#package_name CheckPackageVersion#package_name}
  */
  readonly packageName: string;
  /**
  * Whether or not the value in the package name field is a regular expression. (Optional.)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#package_name_is_regex CheckPackageVersion#package_name_is_regex}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#version_constraint_predicate CheckPackageVersion#version_constraint_predicate}
  */
...
export interface CheckPackageVersionVersionConstraintPredicate {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#type CheckPackageVersion#type}
  */
  readonly type: string;
  /**
  * The condition value used by the predicate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#value CheckPackageVersion#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version opslevel_check_package_version}
*/
export class CheckPackageVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CheckPackageVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opslevel/opslevel/1.8.0/docs/resources/check_package_version opslevel_check_package_version} Resource
  *
  * @param scope The scope in which to define this construct
