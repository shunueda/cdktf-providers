...
export * as scimGroupPartialPermissions from './scim-group-partial-permissions';
...
export * as sparkCredential from './spark-credential';
...
export * as dataDbtcloudSparkCredential from './data-dbtcloud-spark-credential';
