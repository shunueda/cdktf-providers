// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/databricks_credential
...
export interface DatabricksCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/databricks_credential#adapter_type DatabricksCredential#adapter_type}
  */
  readonly adapterType?: string;
  /**
  * The catalog where to create models (only for the databricks adapter)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/databricks_credential#catalog DatabricksCredential#catalog}
  */
  readonly catalog?: string;
  /**
  * Project ID to create the Databricks credential in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/databricks_credential#project_id DatabricksCredential#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/databricks_credential#schema DatabricksCredential#schema}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/databricks_credential#semantic_layer_credential DatabricksCredential#semantic_layer_credential}
  */
  readonly semanticLayerCredential?: boolean | cdktf.IResolvable;
  /**
  * Target name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/databricks_credential#target_name DatabricksCredential#target_name}
  */
  readonly targetName?: string;
  /**
  * Token for Databricks user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/databricks_credential#token DatabricksCredential#token}
  */
  readonly token: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/databricks_credential dbtcloud_databricks_credential}
*/
export class DatabricksCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabricksCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/databricks_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/databricks_credential dbtcloud_databricks_credential} Resource
  *
  * @param scope The scope in which to define this construct
