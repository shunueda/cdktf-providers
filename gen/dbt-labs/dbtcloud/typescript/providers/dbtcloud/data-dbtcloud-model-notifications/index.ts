// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/data-sources/model_notifications
...
export interface DataDbtcloudModelNotificationsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/data-sources/model_notifications#environment_id DataDbtcloudModelNotifications#environment_id}
  */
  readonly environmentId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/data-sources/model_notifications dbtcloud_model_notifications}
*/
export class DataDbtcloudModelNotifications extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDbtcloudModelNotifications that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/data-sources/model_notifications#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/data-sources/model_notifications dbtcloud_model_notifications} Data Source
  *
  * @param scope The scope in which to define this construct
