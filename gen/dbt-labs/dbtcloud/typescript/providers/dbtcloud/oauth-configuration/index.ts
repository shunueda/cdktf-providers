// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/oauth_configuration
...
export interface OauthConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/oauth_configuration#application_id_uri OauthConfiguration#application_id_uri}
  */
  readonly applicationIdUri?: string;
  /**
  * The Authorize URL for the OAuth integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/oauth_configuration#authorize_url OauthConfiguration#authorize_url}
  */
  readonly authorizeUrl: string;
  /**
  * The Client ID for the OAuth integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/oauth_configuration#client_id OauthConfiguration#client_id}
  */
  readonly clientId: string;
  /**
  * The Client secret for the OAuth integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/oauth_configuration#client_secret OauthConfiguration#client_secret}
  */
  readonly clientSecret: string;
  /**
  * The name of OAuth integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/oauth_configuration#name OauthConfiguration#name}
  */
  readonly name: string;
  /**
  * The redirect URL for the OAuth integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/oauth_configuration#redirect_uri OauthConfiguration#redirect_uri}
  */
  readonly redirectUri: string;
  /**
  * The Token URL for the OAuth integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/oauth_configuration#token_url OauthConfiguration#token_url}
  */
  readonly tokenUrl: string;
  /**
  * The type of OAuth integration (`entra` or `okta`)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/oauth_configuration#type OauthConfiguration#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/oauth_configuration dbtcloud_oauth_configuration}
*/
export class OauthConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OauthConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/oauth_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/oauth_configuration dbtcloud_oauth_configuration} Resource
  *
  * @param scope The scope in which to define this construct
