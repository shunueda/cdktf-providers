// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/semantic_layer_credential_service_token_mapping
...
export interface SemanticLayerCredentialServiceTokenMappingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/semantic_layer_credential_service_token_mapping#project_id SemanticLayerCredentialServiceTokenMapping#project_id}
  */
  readonly projectId: number;
  /**
  * The ID of the semantic layer credential to map.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/semantic_layer_credential_service_token_mapping#semantic_layer_credential_id SemanticLayerCredentialServiceTokenMapping#semantic_layer_credential_id}
  */
  readonly semanticLayerCredentialId: number;
  /**
  * The ID of the service token to map to the semantic layer credential.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/semantic_layer_credential_service_token_mapping#service_token_id SemanticLayerCredentialServiceTokenMapping#service_token_id}
  */
  readonly serviceTokenId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/semantic_layer_credential_service_token_mapping dbtcloud_semantic_layer_credential_service_token_mapping}
*/
export class SemanticLayerCredentialServiceTokenMapping extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SemanticLayerCredentialServiceTokenMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/semantic_layer_credential_service_token_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/semantic_layer_credential_service_token_mapping dbtcloud_semantic_layer_credential_service_token_mapping} Resource
  *
  * @param scope The scope in which to define this construct
