// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/license_map
...
export interface LicenseMapConfig extends cdktf.TerraformMetaArguments {
  ...
  * License type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/license_map#license_type LicenseMap#license_type}
  */
  readonly licenseType: string;
  /**
  * SSO license mapping group names for this group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/license_map#sso_license_mapping_groups LicenseMap#sso_license_mapping_groups}
  */
  readonly ssoLicenseMappingGroups?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/license_map dbtcloud_license_map}
*/
export class LicenseMap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LicenseMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/license_map#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/license_map dbtcloud_license_map} Resource
  *
  * @param scope The scope in which to define this construct
