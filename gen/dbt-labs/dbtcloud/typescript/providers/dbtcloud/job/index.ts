// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job
...
export interface JobConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#compare_changes_flags Job#compare_changes_flags}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#dbt_version Job#dbt_version}
  */
  readonly dbtVersion?: string;
  /**
  * Environment identifier that this job defers to (new deferring approach)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#deferring_environment_id Job#deferring_environment_id}
  */
  readonly deferringEnvironmentId?: number;
  /**
  * Job identifier that this job defers to (legacy deferring approach)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#deferring_job_id Job#deferring_job_id}
  */
  readonly deferringJobId?: number;
  /**
  * Description for the job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#description Job#description}
  */
  readonly description?: string;
  /**
  * Environment ID to create the job in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#environment_id Job#environment_id}
  */
  readonly environmentId: number;
  /**
  * Whether the CI job should fail when a lint error is found. Only used when `run_lint` is set to `true`. Defaults to `true`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#errors_on_lint_failure Job#errors_on_lint_failure}
  */
  readonly errorsOnLintFailure?: boolean | cdktf.IResolvable;
  /**
  * List of commands to execute for the job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#execute_steps Job#execute_steps}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#force_node_selection Job#force_node_selection}
  */
  readonly forceNodeSelection?: boolean | cdktf.IResolvable;
  /**
  * Flag for whether the job should generate documentation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#generate_docs Job#generate_docs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#is_active Job#is_active}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#job_type Job#job_type}
  */
  readonly jobType?: string;
  /**
  * Job name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#name Job#name}
  */
  readonly name: string;
  /**
  * Number of threads to use in the job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#num_threads Job#num_threads}
  */
  readonly numThreads?: number;
  /**
  * Project ID to create the job in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#project_id Job#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#run_compare_changes Job#run_compare_changes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#run_generate_sources Job#run_generate_sources}
  */
  readonly runGenerateSources?: boolean | cdktf.IResolvable;
  /**
  * Whether the CI job should lint SQL changes. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#run_lint Job#run_lint}
  */
  readonly runLint?: boolean | cdktf.IResolvable;
  /**
  * Custom cron expression for schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#schedule_cron Job#schedule_cron}
  */
  readonly scheduleCron?: string;
  /**
  * List of days of week as numbers (0 = Sunday, 7 = Saturday) to execute the job at if running on a schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#schedule_days Job#schedule_days}
  */
  readonly scheduleDays?: number[];
  /**
  * List of hours to execute the job at if running on a schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#schedule_hours Job#schedule_hours}
  */
  readonly scheduleHours?: number[];
  /**
  * Number of hours between job executions if running on a schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#schedule_interval Job#schedule_interval}
  */
  readonly scheduleInterval?: number;
  /**
  * Type of schedule to use, one of every_day/ days_of_week/ custom_cron/ interval_cron
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#schedule_type Job#schedule_type}
  */
  readonly scheduleType?: string;
  /**
  *  Whether this job defers on a previous run of itself
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#self_deferring Job#self_deferring}
  */
  readonly selfDeferring?: boolean | cdktf.IResolvable;
  /**
  * Target name for the dbt profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#target_name Job#target_name}
  */
  readonly targetName?: string;
  /**
  * [Deprectated - Moved to execution.timeout_seconds] Number of seconds to allow the job to run before timing out
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#timeout_seconds Job#timeout_seconds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#triggers Job#triggers}
  */
  readonly triggers: JobTriggers;
  /**
  * Whether the CI job should be automatically triggered on draft PRs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#triggers_on_draft_pr Job#triggers_on_draft_pr}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#validate_execute_steps Job#validate_execute_steps}
  */
  readonly validateExecuteSteps?: boolean | cdktf.IResolvable;
  /**
  * job_completion_trigger_condition block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#job_completion_trigger_condition Job#job_completion_trigger_condition}
  */
...
export interface JobTriggers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#git_provider_webhook Job#git_provider_webhook}
  */
  readonly gitProviderWebhook?: boolean | cdktf.IResolvable;
  /**
  * Whether the job runs automatically on PR creation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#github_webhook Job#github_webhook}
  */
  readonly githubWebhook?: boolean | cdktf.IResolvable;
  /**
  * Whether the job runs automatically once a PR is merged
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#on_merge Job#on_merge}
  */
  readonly onMerge?: boolean | cdktf.IResolvable;
  /**
  * Whether the job runs on a schedule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#schedule Job#schedule}
  */
...
export interface JobJobCompletionTriggerCondition {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#job_id Job#job_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#statuses Job#statuses}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job dbtcloud_job}
*/
export class Job extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Job that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/job dbtcloud_job} Resource
  *
  * @param scope The scope in which to define this construct
