// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/environment_variable
...
export interface DataDbtcloudEnvironmentVariableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/environment_variable#name DataDbtcloudEnvironmentVariable#name}
  */
  readonly name: string;
  /**
  * Project ID to create the environment variable in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/environment_variable#project_id DataDbtcloudEnvironmentVariable#project_id}
  */
  readonly projectId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/environment_variable dbtcloud_environment_variable}
*/
export class DataDbtcloudEnvironmentVariable extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDbtcloudEnvironmentVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/environment_variable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/environment_variable dbtcloud_environment_variable} Data Source
  *
  * @param scope The scope in which to define this construct
