// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository
...
export interface RepositoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository#azure_active_directory_project_id Repository#azure_active_directory_project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository#azure_active_directory_repository_id Repository#azure_active_directory_repository_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository#azure_bypass_webhook_registration_failure Repository#azure_bypass_webhook_registration_failure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository#fetch_deploy_key Repository#fetch_deploy_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository#git_clone_strategy Repository#git_clone_strategy}
  */
  readonly gitCloneStrategy?: string;
  /**
  * Identifier for the GitHub App - (for GitHub native integration only)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository#github_installation_id Repository#github_installation_id}
  */
  readonly githubInstallationId?: number;
  /**
  * Identifier for the Gitlab project -  (for GitLab native integration only)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository#gitlab_project_id Repository#gitlab_project_id}
  */
  readonly gitlabProjectId?: number;
  /**
  * Whether the repository is active
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository#is_active Repository#is_active}
  */
  readonly isActive?: boolean | cdktf.IResolvable;
  /**
  * Identifier for the PrivateLink endpoint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository#private_link_endpoint_id Repository#private_link_endpoint_id}
  */
  readonly privateLinkEndpointId?: string;
  /**
  * Project ID to create the repository in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository#project_id Repository#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository#pull_request_url_template Repository#pull_request_url_template}
  */
  readonly pullRequestUrlTemplate?: string;
  /**
  * Git URL for the repository or \<Group>/\<Project> for Gitlab
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository#remote_url Repository#remote_url}
  */
  readonly remoteUrl: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository dbtcloud_repository}
*/
export class Repository extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Repository that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/repository dbtcloud_repository} Resource
  *
  * @param scope The scope in which to define this construct
