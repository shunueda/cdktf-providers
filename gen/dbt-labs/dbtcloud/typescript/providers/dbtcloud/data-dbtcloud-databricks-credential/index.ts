// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/databricks_credential
...
export interface DataDbtcloudDatabricksCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  * Credential ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/databricks_credential#credential_id DataDbtcloudDatabricksCredential#credential_id}
  */
  readonly credentialId: number;
  /**
  * Project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/databricks_credential#project_id DataDbtcloudDatabricksCredential#project_id}
  */
  readonly projectId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/databricks_credential dbtcloud_databricks_credential}
*/
export class DataDbtcloudDatabricksCredential extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDbtcloudDatabricksCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/databricks_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/databricks_credential dbtcloud_databricks_credential} Data Source
  *
  * @param scope The scope in which to define this construct
