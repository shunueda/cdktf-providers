// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/global_connections
...
/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/global_connections dbtcloud_global_connections}
*/
export class DataDbtcloudGlobalConnections extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDbtcloudGlobalConnections that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/global_connections#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/global_connections dbtcloud_global_connections} Data Source
  *
  * @param scope The scope in which to define this construct
