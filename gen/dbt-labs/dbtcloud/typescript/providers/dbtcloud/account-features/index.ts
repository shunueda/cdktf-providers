// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/account_features
...
export interface AccountFeaturesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/account_features#advanced_ci AccountFeatures#advanced_ci}
  */
  readonly advancedCi?: boolean | cdktf.IResolvable;
  /**
  * Whether AI features are enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/account_features#ai_features AccountFeatures#ai_features}
  */
  readonly aiFeatures?: boolean | cdktf.IResolvable;
  /**
  * Whether partial parsing is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/account_features#partial_parsing AccountFeatures#partial_parsing}
  */
  readonly partialParsing?: boolean | cdktf.IResolvable;
  /**
  * Whether repository caching is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/account_features#repo_caching AccountFeatures#repo_caching}
  */
  readonly repoCaching?: boolean | cdktf.IResolvable;
  /**
  * Whether warehouse cost visibility is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/account_features#warehouse_cost_visibility AccountFeatures#warehouse_cost_visibility}
  */
  readonly warehouseCostVisibility?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/account_features dbtcloud_account_features}
*/
export class AccountFeatures extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountFeatures that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/account_features#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/account_features dbtcloud_account_features} Resource
  *
  * @param scope The scope in which to define this construct
