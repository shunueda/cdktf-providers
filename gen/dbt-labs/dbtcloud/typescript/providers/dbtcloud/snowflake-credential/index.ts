// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential
...
export interface SnowflakeCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential#auth_type SnowflakeCredential#auth_type}
  */
  readonly authType: string;
  /**
  * The catalog to connect use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential#database SnowflakeCredential#database}
  */
  readonly database?: string;
  /**
  * Whether the Snowflake credential is active
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential#is_active SnowflakeCredential#is_active}
  */
  readonly isActive?: boolean | cdktf.IResolvable;
  /**
  * Number of threads to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential#num_threads SnowflakeCredential#num_threads}
  */
  readonly numThreads: number;
  /**
  * The password for the Snowflake account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential#password SnowflakeCredential#password}
  */
  readonly password?: string;
  /**
  * The private key for the Snowflake account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential#private_key SnowflakeCredential#private_key}
  */
  readonly privateKey?: string;
  /**
  * The passphrase for the private key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential#private_key_passphrase SnowflakeCredential#private_key_passphrase}
  */
  readonly privateKeyPassphrase?: string;
  /**
  * Project ID to create the Snowflake credential in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential#project_id SnowflakeCredential#project_id}
  */
  readonly projectId: number;
  /**
  * The role to assume
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential#role SnowflakeCredential#role}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential#schema SnowflakeCredential#schema}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential#semantic_layer_credential SnowflakeCredential#semantic_layer_credential}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential#user SnowflakeCredential#user}
  */
  readonly user?: string;
  /**
  * The warehouse to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential#warehouse SnowflakeCredential#warehouse}
  */
  readonly warehouse?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential dbtcloud_snowflake_credential}
*/
export class SnowflakeCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnowflakeCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/snowflake_credential dbtcloud_snowflake_credential} Resource
  *
  * @param scope The scope in which to define this construct
