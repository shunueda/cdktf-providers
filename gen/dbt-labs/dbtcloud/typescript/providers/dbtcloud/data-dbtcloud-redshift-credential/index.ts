// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/data-sources/redshift_credential
...
export interface DataDbtcloudRedshiftCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  * Credential ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/data-sources/redshift_credential#credential_id DataDbtcloudRedshiftCredential#credential_id}
  */
  readonly credentialId: number;
  /**
  * Default schema name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/data-sources/redshift_credential#default_schema DataDbtcloudRedshiftCredential#default_schema}
  */
  readonly defaultSchema: string;
  /**
  * Project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/data-sources/redshift_credential#project_id DataDbtcloudRedshiftCredential#project_id}
  */
  readonly projectId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/data-sources/redshift_credential dbtcloud_redshift_credential}
*/
export class DataDbtcloudRedshiftCredential extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDbtcloudRedshiftCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/data-sources/redshift_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/data-sources/redshift_credential dbtcloud_redshift_credential} Data Source
  *
  * @param scope The scope in which to define this construct
