// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/project_artefacts
...
export interface ProjectArtefactsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Docs Job ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/project_artefacts#docs_job_id ProjectArtefacts#docs_job_id}
  */
  readonly docsJobId?: number;
  /**
  * Freshness Job ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/project_artefacts#freshness_job_id ProjectArtefacts#freshness_job_id}
  */
  readonly freshnessJobId?: number;
  /**
  * Project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/project_artefacts#project_id ProjectArtefacts#project_id}
  */
  readonly projectId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/project_artefacts dbtcloud_project_artefacts}
*/
export class ProjectArtefacts extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectArtefacts that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/project_artefacts#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/project_artefacts dbtcloud_project_artefacts} Resource
  *
  * @param scope The scope in which to define this construct
