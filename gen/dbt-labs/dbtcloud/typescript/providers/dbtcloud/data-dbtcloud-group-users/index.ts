// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/group_users
...
export interface DataDbtcloudGroupUsersConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/group_users#group_id DataDbtcloudGroupUsers#group_id}
  */
...
export interface DataDbtcloudGroupUsersUsers {
  ...
  * Email of the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/group_users#email DataDbtcloudGroupUsers#email}
  */
  readonly email: string;
  /**
  * ID of the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/group_users#id DataDbtcloudGroupUsers#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/group_users dbtcloud_group_users}
*/
export class DataDbtcloudGroupUsers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDbtcloudGroupUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/group_users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/data-sources/group_users dbtcloud_group_users} Data Source
  *
  * @param scope The scope in which to define this construct
