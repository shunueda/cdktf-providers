// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_notification
...
export interface PartialNotificationConfig extends cdktf.TerraformMetaArguments {
  /**
  * The external email to receive the notification [global, used as identifier]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_notification#external_email PartialNotification#external_email}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_notification#notification_type PartialNotification#notification_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_notification#on_cancel PartialNotification#on_cancel}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_notification#on_failure PartialNotification#on_failure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_notification#on_success PartialNotification#on_success}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_notification#on_warning PartialNotification#on_warning}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_notification#slack_channel_id PartialNotification#slack_channel_id}
  */
  readonly slackChannelId?: string;
  /**
  * The name of the slack channel [global, used as identifier]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_notification#slack_channel_name PartialNotification#slack_channel_name}
  */
  readonly slackChannelName?: string;
  /**
  * State of the notification (1 = active (default), 2 = inactive) [global]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_notification#state PartialNotification#state}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_notification#user_id PartialNotification#user_id}
  */
  readonly userId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_notification dbtcloud_partial_notification}
*/
export class PartialNotification extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "dbtcloud_partial_notification";
  ...
  * @param importFromId The id of the existing PartialNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "dbtcloud_partial_notification", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_notification dbtcloud_partial_notification} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options PartialNotificationConfig
  */
  public constructor(scope: Construct, id: string, config: PartialNotificationConfig) {
    super(scope, id, {
