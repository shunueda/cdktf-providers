// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/data-sources/extended_attributes
...
export interface DataDbtcloudExtendedAttributesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/data-sources/extended_attributes#extended_attributes_id DataDbtcloudExtendedAttributes#extended_attributes_id}
  */
  readonly extendedAttributesId: number;
  /**
  * Project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/data-sources/extended_attributes#project_id DataDbtcloudExtendedAttributes#project_id}
  */
  readonly projectId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/data-sources/extended_attributes dbtcloud_extended_attributes}
*/
export class DataDbtcloudExtendedAttributes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDbtcloudExtendedAttributes that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/data-sources/extended_attributes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/data-sources/extended_attributes dbtcloud_extended_attributes} Data Source
  *
  * @param scope The scope in which to define this construct
