// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/environment
...
export interface DataDbtcloudEnvironmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/environment#environment_id DataDbtcloudEnvironment#environment_id}
  */
  readonly environmentId: number;
  /**
  * The project ID to which the environment belongs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/environment#project_id DataDbtcloudEnvironment#project_id}
  */
  readonly projectId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/environment dbtcloud_environment}
*/
export class DataDbtcloudEnvironment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDbtcloudEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/environment dbtcloud_environment} Data Source
  *
  * @param scope The scope in which to define this construct
