// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_environment_variable
...
export interface PartialEnvironmentVariableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_environment_variable#environment_values PartialEnvironmentVariable#environment_values}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_environment_variable#name PartialEnvironmentVariable#name}
  */
  readonly name: string;
  /**
  * Project ID to create or update the environment variable in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_environment_variable#project_id PartialEnvironmentVariable#project_id}
  */
  readonly projectId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_environment_variable dbtcloud_partial_environment_variable}
*/
export class PartialEnvironmentVariable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PartialEnvironmentVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_environment_variable#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/partial_environment_variable dbtcloud_partial_environment_variable} Resource
  *
  * @param scope The scope in which to define this construct
