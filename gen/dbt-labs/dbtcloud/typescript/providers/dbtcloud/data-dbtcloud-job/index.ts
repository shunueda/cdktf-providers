// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/job
...
export interface DataDbtcloudJobConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/job#job_completion_trigger_condition DataDbtcloudJob#job_completion_trigger_condition}
  */
  readonly jobCompletionTriggerCondition?: DataDbtcloudJobJobCompletionTriggerCondition[] | cdktf.IResolvable;
  /**
  * The ID of the job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/job#job_id DataDbtcloudJob#job_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/job dbtcloud_job}
*/
export class DataDbtcloudJob extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDbtcloudJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/job dbtcloud_job} Data Source
  *
  * @param scope The scope in which to define this construct
