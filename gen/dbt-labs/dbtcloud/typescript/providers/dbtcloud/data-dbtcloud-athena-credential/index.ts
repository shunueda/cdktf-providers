// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/data-sources/athena_credential
...
export interface DataDbtcloudAthenaCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  * Credential ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/data-sources/athena_credential#credential_id DataDbtcloudAthenaCredential#credential_id}
  */
  readonly credentialId: number;
  /**
  * Project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/data-sources/athena_credential#project_id DataDbtcloudAthenaCredential#project_id}
  */
  readonly projectId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/data-sources/athena_credential dbtcloud_athena_credential}
*/
export class DataDbtcloudAthenaCredential extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDbtcloudAthenaCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/data-sources/athena_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/data-sources/athena_credential dbtcloud_athena_credential} Data Source
  *
  * @param scope The scope in which to define this construct
