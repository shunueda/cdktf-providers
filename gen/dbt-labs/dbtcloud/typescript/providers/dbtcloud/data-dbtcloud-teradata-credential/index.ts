// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/teradata_credential
...
export interface DataDbtcloudTeradataCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  * Credential ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/teradata_credential#credential_id DataDbtcloudTeradataCredential#credential_id}
  */
  readonly credentialId: number;
  /**
  * Project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/teradata_credential#project_id DataDbtcloudTeradataCredential#project_id}
  */
  readonly projectId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/teradata_credential dbtcloud_teradata_credential}
*/
export class DataDbtcloudTeradataCredential extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDbtcloudTeradataCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/teradata_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/teradata_credential dbtcloud_teradata_credential} Data Source
  *
  * @param scope The scope in which to define this construct
