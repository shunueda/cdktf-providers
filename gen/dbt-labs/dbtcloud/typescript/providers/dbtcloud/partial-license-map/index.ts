// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/partial_license_map
...
export interface PartialLicenseMapConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/partial_license_map#license_type PartialLicenseMap#license_type}
  */
  readonly licenseType: string;
  /**
  * List of SSO groups to map to the license type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/partial_license_map#sso_license_mapping_groups PartialLicenseMap#sso_license_mapping_groups}
  */
  readonly ssoLicenseMappingGroups: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/partial_license_map dbtcloud_partial_license_map}
*/
export class PartialLicenseMap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PartialLicenseMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/partial_license_map#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/partial_license_map dbtcloud_partial_license_map} Resource
  *
  * @param scope The scope in which to define this construct
