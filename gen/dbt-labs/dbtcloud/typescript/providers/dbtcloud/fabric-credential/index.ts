// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/fabric_credential
...
export interface FabricCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/fabric_credential#adapter_type FabricCredential#adapter_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/fabric_credential#client_id FabricCredential#client_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/fabric_credential#client_secret FabricCredential#client_secret}
  */
  readonly clientSecret?: string;
  /**
  * The password for the account to connect to. Only used when connection with AD user/pass
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/fabric_credential#password FabricCredential#password}
  */
  readonly password?: string;
  /**
  * Project ID to create the Fabric credential in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/fabric_credential#project_id FabricCredential#project_id}
  */
  readonly projectId: number;
  /**
  * The schema where to create the dbt models
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/fabric_credential#schema FabricCredential#schema}
  */
  readonly schema: string;
  /**
  * Optionally set this to the principal who should own the schemas created by dbt
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/fabric_credential#schema_authorization FabricCredential#schema_authorization}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/fabric_credential#tenant_id FabricCredential#tenant_id}
  */
  readonly tenantId?: string;
  /**
  * The username of the Fabric account to connect to. Only used when connection with AD user/pass
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/fabric_credential#user FabricCredential#user}
  */
  readonly user?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/fabric_credential dbtcloud_fabric_credential}
*/
export class FabricCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FabricCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/fabric_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/fabric_credential dbtcloud_fabric_credential} Resource
  *
  * @param scope The scope in which to define this construct
