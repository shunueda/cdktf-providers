// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/webhook
...
export interface WebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/webhook#active Webhook#active}
  */
  readonly active?: boolean | cdktf.IResolvable;
  /**
  * Webhooks Client URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/webhook#client_url Webhook#client_url}
  */
  readonly clientUrl: string;
  /**
  * Webhooks Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/webhook#description Webhook#description}
  */
  readonly description?: string;
  /**
  * Webhooks Event Types
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/webhook#event_types Webhook#event_types}
  */
  readonly eventTypes: string[];
  /**
  * List of job IDs to trigger the webhook. When null or empty, the webhook will trigger on all jobs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/webhook#job_ids Webhook#job_ids}
  */
  readonly jobIds?: number[];
  /**
  * Webhooks Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/webhook#name Webhook#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/webhook dbtcloud_webhook}
*/
export class Webhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Webhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.1/docs/resources/webhook dbtcloud_webhook} Resource
  *
  * @param scope The scope in which to define this construct
