// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment
...
export interface EnvironmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment#connection_id Environment#connection_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment#credential_id Environment#credential_id}
  */
  readonly credentialId?: number;
  /**
  * The custom branch name to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment#custom_branch Environment#custom_branch}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment#dbt_version Environment#dbt_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment#deployment_type Environment#deployment_type}
  */
  readonly deploymentType?: string;
  /**
  * Whether to enable model query history in this environment. As of Oct 2024, works only for Snowflake and BigQuery.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment#enable_model_query_history Environment#enable_model_query_history}
  */
  readonly enableModelQueryHistory?: boolean | cdktf.IResolvable;
  /**
  * The ID of the extended attributes applied
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment#extended_attributes_id Environment#extended_attributes_id}
  */
  readonly extendedAttributesId?: number;
  /**
  * Whether the environment is active
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment#is_active Environment#is_active}
  */
  readonly isActive?: boolean | cdktf.IResolvable;
  /**
  * The name of the environment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment#name Environment#name}
  */
  readonly name: string;
  /**
  * Project ID to create the environment in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment#project_id Environment#project_id}
  */
  readonly projectId: number;
  /**
  * The type of environment (must be either development or deployment)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment#type Environment#type}
  */
  readonly type: string;
  /**
  * Whether to use a custom git branch in this environment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment#use_custom_branch Environment#use_custom_branch}
  */
  readonly useCustomBranch?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment dbtcloud_environment}
*/
export class Environment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Environment that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment dbtcloud_environment} Resource
  *
  * @param scope The scope in which to define this construct
