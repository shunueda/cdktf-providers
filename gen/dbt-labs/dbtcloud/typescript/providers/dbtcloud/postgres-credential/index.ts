// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/postgres_credential
...
export interface PostgresCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/postgres_credential#default_schema PostgresCredential#default_schema}
  */
  readonly defaultSchema?: string;
  /**
  * Whether the Postgres/Redshift/AlloyDB credential is active
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/postgres_credential#is_active PostgresCredential#is_active}
  */
  readonly isActive?: boolean | cdktf.IResolvable;
  /**
  * Number of threads to use (required for Redshift)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/postgres_credential#num_threads PostgresCredential#num_threads}
  */
  readonly numThreads?: number;
  /**
  * Password for Postgres/Redshift/AlloyDB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/postgres_credential#password PostgresCredential#password}
  */
  readonly password?: string;
  /**
  * Project ID to create the Postgres/Redshift/AlloyDB credential in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/postgres_credential#project_id PostgresCredential#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/postgres_credential#semantic_layer_credential PostgresCredential#semantic_layer_credential}
  */
  readonly semanticLayerCredential?: boolean | cdktf.IResolvable;
  /**
  * Default schema name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/postgres_credential#target_name PostgresCredential#target_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/postgres_credential#type PostgresCredential#type}
  */
  readonly type?: string;
  /**
  * Username for Postgres/Redshift/AlloyDB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/postgres_credential#username PostgresCredential#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/postgres_credential dbtcloud_postgres_credential}
*/
export class PostgresCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/postgres_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/postgres_credential dbtcloud_postgres_credential} Resource
  *
  * @param scope The scope in which to define this construct
