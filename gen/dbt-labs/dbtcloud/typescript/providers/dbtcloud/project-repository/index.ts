// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/project_repository
...
export interface ProjectRepositoryConfig extends cdktf.TerraformMetaArguments {
  ...
  * Project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/project_repository#project_id ProjectRepository#project_id}
  */
  readonly projectId: number;
  /**
  * Repository ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/project_repository#repository_id ProjectRepository#repository_id}
  */
  readonly repositoryId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/project_repository dbtcloud_project_repository}
*/
export class ProjectRepository extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/project_repository#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/project_repository dbtcloud_project_repository} Resource
  *
  * @param scope The scope in which to define this construct
