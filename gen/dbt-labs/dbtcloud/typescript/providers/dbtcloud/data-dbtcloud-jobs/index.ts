// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/jobs
...
export interface DataDbtcloudJobsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/jobs#environment_id DataDbtcloudJobs#environment_id}
  */
  readonly environmentId?: number;
  /**
  * The ID of the project for which we want to retrieve the jobs (one of `project_id` or `environment_id` must be set)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/jobs#project_id DataDbtcloudJobs#project_id}
  */
...
export interface DataDbtcloudJobsJobs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/jobs#job_completion_trigger_condition DataDbtcloudJobs#job_completion_trigger_condition}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/jobs dbtcloud_jobs}
*/
export class DataDbtcloudJobs extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDbtcloudJobs that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/jobs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/data-sources/jobs dbtcloud_jobs} Data Source
  *
  * @param scope The scope in which to define this construct
