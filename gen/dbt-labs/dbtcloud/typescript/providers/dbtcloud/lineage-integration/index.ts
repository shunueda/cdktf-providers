// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/lineage_integration
...
export interface LineageIntegrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/lineage_integration#host LineageIntegration#host}
  */
  readonly host: string;
  /**
  * The dbt Cloud project ID for the integration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/lineage_integration#project_id LineageIntegration#project_id}
  */
  readonly projectId: number;
  /**
  * The sitename for the collections of dashboards (see docs for more details)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/lineage_integration#site_id LineageIntegration#site_id}
  */
  readonly siteId: string;
  /**
  * The secret token value to use to authenticate to the BI server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/lineage_integration#token LineageIntegration#token}
  */
  readonly token: string;
  /**
  * The token to use to authenticate to the BI server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/lineage_integration#token_name LineageIntegration#token_name}
  */
  readonly tokenName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/lineage_integration dbtcloud_lineage_integration}
*/
export class LineageIntegration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LineageIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/lineage_integration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/lineage_integration dbtcloud_lineage_integration} Resource
  *
  * @param scope The scope in which to define this construct
