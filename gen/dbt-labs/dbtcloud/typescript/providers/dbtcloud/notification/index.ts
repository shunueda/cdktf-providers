// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/notification
...
export interface NotificationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/notification#external_email Notification#external_email}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/notification#notification_type Notification#notification_type}
  */
  readonly notificationType?: number;
  /**
  * List of job IDs to trigger the webhook on cancel
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/notification#on_cancel Notification#on_cancel}
  */
  readonly onCancel?: number[];
  /**
  * List of job IDs to trigger the webhook on failure
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/notification#on_failure Notification#on_failure}
  */
  readonly onFailure?: number[];
  /**
  * List of job IDs to trigger the webhook on success
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/notification#on_success Notification#on_success}
  */
  readonly onSuccess?: number[];
  /**
  * List of job IDs to trigger the webhook on warning
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/notification#on_warning Notification#on_warning}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/notification#slack_channel_id Notification#slack_channel_id}
  */
  readonly slackChannelId?: string;
  /**
  * The name of the slack channel
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/notification#slack_channel_name Notification#slack_channel_name}
  */
  readonly slackChannelName?: string;
  /**
  * State of the notification (1 = active (default), 2 = inactive)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/notification#state Notification#state}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/notification#user_id Notification#user_id}
  */
  readonly userId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/notification dbtcloud_notification}
*/
export class Notification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Notification that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/notification dbtcloud_notification} Resource
  *
  * @param scope The scope in which to define this construct
