// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/model_notifications
...
export interface ModelNotificationsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/model_notifications#enabled ModelNotifications#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the dbt Cloud environment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/model_notifications#environment_id ModelNotifications#environment_id}
  */
  readonly environmentId: string;
  /**
  * Whether to send notifications for failed model runs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/model_notifications#on_failure ModelNotifications#on_failure}
  */
  readonly onFailure?: boolean | cdktf.IResolvable;
  /**
  * Whether to send notifications for skipped model runs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/model_notifications#on_skipped ModelNotifications#on_skipped}
  */
  readonly onSkipped?: boolean | cdktf.IResolvable;
  /**
  * Whether to send notifications for successful model runs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/model_notifications#on_success ModelNotifications#on_success}
  */
  readonly onSuccess?: boolean | cdktf.IResolvable;
  /**
  * Whether to send notifications for model runs with warnings
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/model_notifications#on_warning ModelNotifications#on_warning}
  */
  readonly onWarning?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/model_notifications dbtcloud_model_notifications}
*/
export class ModelNotifications extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ModelNotifications that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/model_notifications#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.4.2/docs/resources/model_notifications dbtcloud_model_notifications} Resource
  *
  * @param scope The scope in which to define this construct
