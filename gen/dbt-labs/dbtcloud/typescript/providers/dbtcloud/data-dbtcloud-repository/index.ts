// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/repository
...
export interface DataDbtcloudRepositoryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/repository#fetch_deploy_key DataDbtcloudRepository#fetch_deploy_key}
  */
  readonly fetchDeployKey?: boolean | cdktf.IResolvable;
  /**
  * Project ID to create the repository in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/repository#project_id DataDbtcloudRepository#project_id}
  */
  readonly projectId: number;
  /**
  * ID for the repository
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/repository#repository_id DataDbtcloudRepository#repository_id}
  */
  readonly repositoryId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/repository dbtcloud_repository}
*/
export class DataDbtcloudRepository extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDbtcloudRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/repository#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/repository dbtcloud_repository} Data Source
  *
  * @param scope The scope in which to define this construct
