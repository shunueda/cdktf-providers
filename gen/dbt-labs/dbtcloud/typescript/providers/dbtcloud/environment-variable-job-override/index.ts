// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment_variable_job_override
...
export interface EnvironmentVariableJobOverrideConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment_variable_job_override#job_definition_id EnvironmentVariableJobOverride#job_definition_id}
  */
  readonly jobDefinitionId: number;
  /**
  * The environment variable name to override
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment_variable_job_override#name EnvironmentVariableJobOverride#name}
  */
  readonly name: string;
  /**
  * Project ID to create the environment variable job override in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment_variable_job_override#project_id EnvironmentVariableJobOverride#project_id}
  */
  readonly projectId: number;
  /**
  * The value for the override of the environment variable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment_variable_job_override#raw_value EnvironmentVariableJobOverride#raw_value}
  */
  readonly rawValue: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment_variable_job_override dbtcloud_environment_variable_job_override}
*/
export class EnvironmentVariableJobOverride extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EnvironmentVariableJobOverride that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment_variable_job_override#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/environment_variable_job_override dbtcloud_environment_variable_job_override} Resource
  *
  * @param scope The scope in which to define this construct
