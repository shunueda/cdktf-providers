// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/redshift_credential
...
export interface RedshiftCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  * Default schema name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/redshift_credential#default_schema RedshiftCredential#default_schema}
  */
  readonly defaultSchema: string;
  /**
  * Whether the Redshift credential is active
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/redshift_credential#is_active RedshiftCredential#is_active}
  */
  readonly isActive?: boolean | cdktf.IResolvable;
  /**
  * Number of threads to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/redshift_credential#num_threads RedshiftCredential#num_threads}
  */
  readonly numThreads: number;
  /**
  * The password for the Redshift account
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/redshift_credential#password RedshiftCredential#password}
  */
  readonly password?: string;
  /**
  * Project ID to create the Redshift credential in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/redshift_credential#project_id RedshiftCredential#project_id}
  */
  readonly projectId: number;
  /**
  * The username for the Redshift account. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/redshift_credential#username RedshiftCredential#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/redshift_credential dbtcloud_redshift_credential}
*/
export class RedshiftCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedshiftCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/redshift_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.1/docs/resources/redshift_credential dbtcloud_redshift_credential} Resource
  *
  * @param scope The scope in which to define this construct
