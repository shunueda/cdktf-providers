// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/extended_attributes
...
export interface ExtendedAttributesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/extended_attributes#extended_attributes ExtendedAttributes#extended_attributes}
  */
  readonly extendedAttributes: string;
  /**
  * Project ID to create the extended attributes in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/extended_attributes#project_id ExtendedAttributes#project_id}
  */
  readonly projectId: number;
  /**
  * The state of the extended attributes (1 = active, 2 = inactive)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/extended_attributes#state ExtendedAttributes#state}
  */
  readonly state?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/extended_attributes dbtcloud_extended_attributes}
*/
export class ExtendedAttributes extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExtendedAttributes that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/extended_attributes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/resources/extended_attributes dbtcloud_extended_attributes} Resource
  *
  * @param scope The scope in which to define this construct
