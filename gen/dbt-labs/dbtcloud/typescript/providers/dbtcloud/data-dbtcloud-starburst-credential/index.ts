// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/starburst_credential
...
export interface DataDbtcloudStarburstCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  * Credential ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/starburst_credential#credential_id DataDbtcloudStarburstCredential#credential_id}
  */
  readonly credentialId: number;
  /**
  * Project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/starburst_credential#project_id DataDbtcloudStarburstCredential#project_id}
  */
  readonly projectId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/starburst_credential dbtcloud_starburst_credential}
*/
export class DataDbtcloudStarburstCredential extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDbtcloudStarburstCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/starburst_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.5.0/docs/data-sources/starburst_credential dbtcloud_starburst_credential} Data Source
  *
  * @param scope The scope in which to define this construct
