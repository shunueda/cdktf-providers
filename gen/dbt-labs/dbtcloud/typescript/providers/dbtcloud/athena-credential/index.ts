// https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/athena_credential
...
export interface AthenaCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/athena_credential#aws_access_key_id AthenaCredential#aws_access_key_id}
  */
  readonly awsAccessKeyId: string;
  /**
  * AWS secret access key for Athena user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/athena_credential#aws_secret_access_key AthenaCredential#aws_secret_access_key}
  */
  readonly awsSecretAccessKey: string;
  /**
  * Project ID to create the Athena credential in
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/athena_credential#project_id AthenaCredential#project_id}
  */
  readonly projectId: number;
  /**
  * The schema where to create models
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/athena_credential#schema AthenaCredential#schema}
  */
  readonly schema: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/athena_credential dbtcloud_athena_credential}
*/
export class AthenaCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AthenaCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/athena_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/dbt-labs/dbtcloud/1.3.0/docs/resources/athena_credential dbtcloud_athena_credential} Resource
  *
  * @param scope The scope in which to define this construct
