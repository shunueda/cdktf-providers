// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window
...
export interface RecurringWindowConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window#annotation RecurringWindow#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window#concur_cap RecurringWindow#concur_cap}
  */
  readonly concurCap?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window#day RecurringWindow#day}
  */
  readonly day?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window#hour RecurringWindow#hour}
  */
  readonly hour?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window#id RecurringWindow#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window#minute RecurringWindow#minute}
  */
  readonly minute?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window#name RecurringWindow#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window#name_alias RecurringWindow#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window#node_upg_interval RecurringWindow#node_upg_interval}
  */
  readonly nodeUpgInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window#proc_break RecurringWindow#proc_break}
  */
  readonly procBreak?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window#proc_cap RecurringWindow#proc_cap}
  */
  readonly procCap?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window#scheduler_dn RecurringWindow#scheduler_dn}
  */
  readonly schedulerDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window#time_cap RecurringWindow#time_cap}
  */
  readonly timeCap?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window aci_recurring_window}
*/
export class RecurringWindow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RecurringWindow that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/recurring_window aci_recurring_window} Resource
  *
  * @param scope The scope in which to define this construct
