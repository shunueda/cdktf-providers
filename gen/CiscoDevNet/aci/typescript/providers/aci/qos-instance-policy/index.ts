// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy
...
export interface QosInstancePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy#annotation QosInstancePolicy#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy#ctrl QosInstancePolicy#ctrl}
  */
  readonly ctrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy#description QosInstancePolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy#etrap_age_timer QosInstancePolicy#etrap_age_timer}
  */
  readonly etrapAgeTimer?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy#etrap_bw_thresh QosInstancePolicy#etrap_bw_thresh}
  */
  readonly etrapBwThresh?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy#etrap_byte_ct QosInstancePolicy#etrap_byte_ct}
  */
  readonly etrapByteCt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy#etrap_st QosInstancePolicy#etrap_st}
  */
  readonly etrapSt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy#fabric_flush_interval QosInstancePolicy#fabric_flush_interval}
  */
  readonly fabricFlushInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy#fabric_flush_st QosInstancePolicy#fabric_flush_st}
  */
  readonly fabricFlushSt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy#id QosInstancePolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy#name_alias QosInstancePolicy#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy#uburst_spine_queues QosInstancePolicy#uburst_spine_queues}
  */
  readonly uburstSpineQueues?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy#uburst_tor_queues QosInstancePolicy#uburst_tor_queues}
  */
  readonly uburstTorQueues?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy aci_qos_instance_policy}
*/
export class QosInstancePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QosInstancePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/qos_instance_policy aci_qos_instance_policy} Resource
  *
  * @param scope The scope in which to define this construct
