// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security
...
export interface GlobalSecurityConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#annotation GlobalSecurity#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#block_duration GlobalSecurity#block_duration}
  */
  readonly blockDuration?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#change_count GlobalSecurity#change_count}
  */
  readonly changeCount?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#change_during_interval GlobalSecurity#change_during_interval}
  */
  readonly changeDuringInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#change_interval GlobalSecurity#change_interval}
  */
  readonly changeInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#description GlobalSecurity#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#enable_login_block GlobalSecurity#enable_login_block}
  */
  readonly enableLoginBlock?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#expiration_warn_time GlobalSecurity#expiration_warn_time}
  */
  readonly expirationWarnTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#history_count GlobalSecurity#history_count}
  */
  readonly historyCount?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#id GlobalSecurity#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#max_failed_attempts GlobalSecurity#max_failed_attempts}
  */
  readonly maxFailedAttempts?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#max_failed_attempts_window GlobalSecurity#max_failed_attempts_window}
  */
  readonly maxFailedAttemptsWindow?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#maximum_validity_period GlobalSecurity#maximum_validity_period}
  */
  readonly maximumValidityPeriod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#name_alias GlobalSecurity#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#no_change_interval GlobalSecurity#no_change_interval}
  */
  readonly noChangeInterval?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#pwd_strength_check GlobalSecurity#pwd_strength_check}
  */
  readonly pwdStrengthCheck?: string;
  /**
  * Create relation to aaa:UserEp
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#relation_aaa_rs_to_user_ep GlobalSecurity#relation_aaa_rs_to_user_ep}
  */
  readonly relationAaaRsToUserEp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#session_record_flags GlobalSecurity#session_record_flags}
  */
  readonly sessionRecordFlags?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#ui_idle_timeout_seconds GlobalSecurity#ui_idle_timeout_seconds}
  */
  readonly uiIdleTimeoutSeconds?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#webtoken_timeout_seconds GlobalSecurity#webtoken_timeout_seconds}
  */
  readonly webtokenTimeoutSeconds?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security aci_global_security}
*/
export class GlobalSecurity extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a GlobalSecurity resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the GlobalSecurity to import
  * @param importFromId The id of the existing GlobalSecurity that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GlobalSecurity to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/global_security aci_global_security} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GlobalSecurityConfig = {}
  */
  public constructor(scope: Construct, id: string, config: GlobalSecurityConfig = {}) {
    super(scope, id, {
    ...
    this._relationAaaRsToUserEp = config.relationAaaRsToUserEp;
  ...
  // relation_aaa_rs_to_user_ep - computed: false, optional: true, required: false
  private _relationAaaRsToUserEp?: string; 
  public get relationAaaRsToUserEp() {
    return this.getStringAttribute('relation_aaa_rs_to_user_ep');
  }
  public set relationAaaRsToUserEp(value: string) {
    this._relationAaaRsToUserEp = value;
  }
  public resetRelationAaaRsToUserEp() {
    this._relationAaaRsToUserEp = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get relationAaaRsToUserEpInput() {
    return this._relationAaaRsToUserEp;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      relation_aaa_rs_to_user_ep: cdktf.stringToTerraform(this._relationAaaRsToUserEp),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      relation_aaa_rs_to_user_ep: {
        value: cdktf.stringToHclTerraform(this._relationAaaRsToUserEp),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
