// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy
...
export interface IpSlaMonitoringPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#annotation IpSlaMonitoringPolicy#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#description IpSlaMonitoringPolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#http_uri IpSlaMonitoringPolicy#http_uri}
  */
  readonly httpUri?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#http_version IpSlaMonitoringPolicy#http_version}
  */
  readonly httpVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#id IpSlaMonitoringPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#name IpSlaMonitoringPolicy#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#name_alias IpSlaMonitoringPolicy#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#request_data_size IpSlaMonitoringPolicy#request_data_size}
  */
  readonly requestDataSize?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#sla_detect_multiplier IpSlaMonitoringPolicy#sla_detect_multiplier}
  */
  readonly slaDetectMultiplier?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#sla_frequency IpSlaMonitoringPolicy#sla_frequency}
  */
  readonly slaFrequency?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#sla_port IpSlaMonitoringPolicy#sla_port}
  */
  readonly slaPort?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#sla_type IpSlaMonitoringPolicy#sla_type}
  */
  readonly slaType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#tenant_dn IpSlaMonitoringPolicy#tenant_dn}
  */
  readonly tenantDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#threshold IpSlaMonitoringPolicy#threshold}
  */
  readonly threshold?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#timeout IpSlaMonitoringPolicy#timeout}
  */
  readonly timeout?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#traffic_class_value IpSlaMonitoringPolicy#traffic_class_value}
  */
  readonly trafficClassValue?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#type_of_service IpSlaMonitoringPolicy#type_of_service}
  */
  readonly typeOfService?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy aci_ip_sla_monitoring_policy}
*/
export class IpSlaMonitoringPolicy extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a IpSlaMonitoringPolicy resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the IpSlaMonitoringPolicy to import
  * @param importFromId The id of the existing IpSlaMonitoringPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IpSlaMonitoringPolicy to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/ip_sla_monitoring_policy aci_ip_sla_monitoring_policy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IpSlaMonitoringPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: IpSlaMonitoringPolicyConfig) {
    super(scope, id, {
