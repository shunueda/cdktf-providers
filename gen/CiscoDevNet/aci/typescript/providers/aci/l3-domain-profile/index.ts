// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3_domain_profile
...
export interface L3DomainProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3_domain_profile#annotation L3DomainProfile#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3_domain_profile#id L3DomainProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3_domain_profile#name L3DomainProfile#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3_domain_profile#name_alias L3DomainProfile#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3_domain_profile#relation_extnw_rs_out L3DomainProfile#relation_extnw_rs_out}
  */
  readonly relationExtnwRsOut?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3_domain_profile#relation_infra_rs_dom_vxlan_ns_def L3DomainProfile#relation_infra_rs_dom_vxlan_ns_def}
  */
  readonly relationInfraRsDomVxlanNsDef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3_domain_profile#relation_infra_rs_vip_addr_ns L3DomainProfile#relation_infra_rs_vip_addr_ns}
  */
  readonly relationInfraRsVipAddrNs?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3_domain_profile#relation_infra_rs_vlan_ns L3DomainProfile#relation_infra_rs_vlan_ns}
  */
  readonly relationInfraRsVlanNs?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3_domain_profile#relation_infra_rs_vlan_ns_def L3DomainProfile#relation_infra_rs_vlan_ns_def}
  */
  readonly relationInfraRsVlanNsDef?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3_domain_profile aci_l3_domain_profile}
*/
export class L3DomainProfile extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "aci_l3_domain_profile";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a L3DomainProfile resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the L3DomainProfile to import
  * @param importFromId The id of the existing L3DomainProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3_domain_profile#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the L3DomainProfile to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "aci_l3_domain_profile", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3_domain_profile aci_l3_domain_profile} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options L3DomainProfileConfig
  */
  public constructor(scope: Construct, id: string, config: L3DomainProfileConfig) {
    super(scope, id, {
