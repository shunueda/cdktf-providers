// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy
...
export interface ServiceRedirectPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#annotation ServiceRedirectPolicy#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#anycast_enabled ServiceRedirectPolicy#anycast_enabled}
  */
  readonly anycastEnabled?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#description ServiceRedirectPolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#dest_type ServiceRedirectPolicy#dest_type}
  */
  readonly destType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#hashing_algorithm ServiceRedirectPolicy#hashing_algorithm}
  */
  readonly hashingAlgorithm?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#id ServiceRedirectPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#max_threshold_percent ServiceRedirectPolicy#max_threshold_percent}
  */
  readonly maxThresholdPercent?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#min_threshold_percent ServiceRedirectPolicy#min_threshold_percent}
  */
  readonly minThresholdPercent?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#name ServiceRedirectPolicy#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#name_alias ServiceRedirectPolicy#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#program_local_pod_only ServiceRedirectPolicy#program_local_pod_only}
  */
  readonly programLocalPodOnly?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#relation_vns_rs_ipsla_monitoring_pol ServiceRedirectPolicy#relation_vns_rs_ipsla_monitoring_pol}
  */
  readonly relationVnsRsIpslaMonitoringPol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#resilient_hash_enabled ServiceRedirectPolicy#resilient_hash_enabled}
  */
  readonly resilientHashEnabled?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#tenant_dn ServiceRedirectPolicy#tenant_dn}
  */
  readonly tenantDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#threshold_down_action ServiceRedirectPolicy#threshold_down_action}
  */
  readonly thresholdDownAction?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#threshold_enable ServiceRedirectPolicy#threshold_enable}
  */
  readonly thresholdEnable?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy aci_service_redirect_policy}
*/
export class ServiceRedirectPolicy extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a ServiceRedirectPolicy resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ServiceRedirectPolicy to import
  * @param importFromId The id of the existing ServiceRedirectPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ServiceRedirectPolicy to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/service_redirect_policy aci_service_redirect_policy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ServiceRedirectPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: ServiceRedirectPolicyConfig) {
    super(scope, id, {
    ...
    this._relationVnsRsIpslaMonitoringPol = config.relationVnsRsIpslaMonitoringPol;
  ...
  // relation_vns_rs_ipsla_monitoring_pol - computed: false, optional: true, required: false
  private _relationVnsRsIpslaMonitoringPol?: string; 
  public get relationVnsRsIpslaMonitoringPol() {
    return this.getStringAttribute('relation_vns_rs_ipsla_monitoring_pol');
  }
  public set relationVnsRsIpslaMonitoringPol(value: string) {
    this._relationVnsRsIpslaMonitoringPol = value;
  }
  public resetRelationVnsRsIpslaMonitoringPol() {
    this._relationVnsRsIpslaMonitoringPol = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get relationVnsRsIpslaMonitoringPolInput() {
    return this._relationVnsRsIpslaMonitoringPol;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      relation_vns_rs_ipsla_monitoring_pol: cdktf.stringToTerraform(this._relationVnsRsIpslaMonitoringPol),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      relation_vns_rs_ipsla_monitoring_pol: {
        value: cdktf.stringToHclTerraform(this._relationVnsRsIpslaMonitoringPol),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
