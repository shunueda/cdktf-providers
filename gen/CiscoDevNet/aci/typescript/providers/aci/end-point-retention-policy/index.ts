// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy
...
export interface EndPointRetentionPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy#annotation EndPointRetentionPolicy#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy#bounce_age_intvl EndPointRetentionPolicy#bounce_age_intvl}
  */
  readonly bounceAgeIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy#bounce_trig EndPointRetentionPolicy#bounce_trig}
  */
  readonly bounceTrig?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy#description EndPointRetentionPolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy#hold_intvl EndPointRetentionPolicy#hold_intvl}
  */
  readonly holdIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy#id EndPointRetentionPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy#local_ep_age_intvl EndPointRetentionPolicy#local_ep_age_intvl}
  */
  readonly localEpAgeIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy#move_freq EndPointRetentionPolicy#move_freq}
  */
  readonly moveFreq?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy#name EndPointRetentionPolicy#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy#name_alias EndPointRetentionPolicy#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy#remote_ep_age_intvl EndPointRetentionPolicy#remote_ep_age_intvl}
  */
  readonly remoteEpAgeIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy#tenant_dn EndPointRetentionPolicy#tenant_dn}
  */
  readonly tenantDn: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy aci_end_point_retention_policy}
*/
export class EndPointRetentionPolicy extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a EndPointRetentionPolicy resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the EndPointRetentionPolicy to import
  * @param importFromId The id of the existing EndPointRetentionPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the EndPointRetentionPolicy to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/end_point_retention_policy aci_end_point_retention_policy} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options EndPointRetentionPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: EndPointRetentionPolicyConfig) {
    super(scope, id, {
