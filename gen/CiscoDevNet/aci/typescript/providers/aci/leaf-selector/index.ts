// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/leaf_selector
...
export interface LeafSelectorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/leaf_selector#annotation LeafSelector#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/leaf_selector#description LeafSelector#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/leaf_selector#id LeafSelector#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/leaf_selector#leaf_profile_dn LeafSelector#leaf_profile_dn}
  */
  readonly leafProfileDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/leaf_selector#name LeafSelector#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/leaf_selector#name_alias LeafSelector#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/leaf_selector#relation_infra_rs_acc_node_p_grp LeafSelector#relation_infra_rs_acc_node_p_grp}
  */
  readonly relationInfraRsAccNodePGrp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/leaf_selector#switch_association_type LeafSelector#switch_association_type}
  */
  readonly switchAssociationType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/leaf_selector aci_leaf_selector}
*/
export class LeafSelector extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LeafSelector that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/leaf_selector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/leaf_selector aci_leaf_selector} Resource
  *
  * @param scope The scope in which to define this construct
