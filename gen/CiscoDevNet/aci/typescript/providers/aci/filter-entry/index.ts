// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry
...
export interface FilterEntryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#annotation FilterEntry#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#apply_to_frag FilterEntry#apply_to_frag}
  */
  readonly applyToFrag?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#arp_opc FilterEntry#arp_opc}
  */
  readonly arpOpc?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#d_from_port FilterEntry#d_from_port}
  */
  readonly dFromPort?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#d_to_port FilterEntry#d_to_port}
  */
  readonly dToPort?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#description FilterEntry#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#ether_t FilterEntry#ether_t}
  */
  readonly etherT?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#filter_dn FilterEntry#filter_dn}
  */
  readonly filterDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#icmpv4_t FilterEntry#icmpv4_t}
  */
  readonly icmpv4T?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#icmpv6_t FilterEntry#icmpv6_t}
  */
  readonly icmpv6T?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#id FilterEntry#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#match_dscp FilterEntry#match_dscp}
  */
  readonly matchDscp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#name FilterEntry#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#name_alias FilterEntry#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#prot FilterEntry#prot}
  */
  readonly prot?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#s_from_port FilterEntry#s_from_port}
  */
  readonly sFromPort?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#s_to_port FilterEntry#s_to_port}
  */
  readonly sToPort?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#stateful FilterEntry#stateful}
  */
  readonly stateful?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#tcp_rules FilterEntry#tcp_rules}
  */
  readonly tcpRules?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry aci_filter_entry}
*/
export class FilterEntry extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a FilterEntry resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the FilterEntry to import
  * @param importFromId The id of the existing FilterEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the FilterEntry to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/filter_entry aci_filter_entry} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options FilterEntryConfig
  */
  public constructor(scope: Construct, id: string, config: FilterEntryConfig) {
    super(scope, id, {
  ...
  public get tcpRules() {
    return this.getListAttribute('tcp_rules');
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tcp_rules: cdktf.listMapper(cdktf.stringToTerraform, false)(this._tcpRules),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tcp_rules: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._tcpRules),
        isBlock: false,
        type: "list",
