// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device
...
export interface L4L7DeviceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#active L4L7Device#active}
  */
  readonly active?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#annotation L4L7Device#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#context_aware L4L7Device#context_aware}
  */
  readonly contextAware?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#description L4L7Device#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#device_type L4L7Device#device_type}
  */
  readonly deviceType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#function_type L4L7Device#function_type}
  */
  readonly functionType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#id L4L7Device#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#is_copy L4L7Device#is_copy}
  */
  readonly isCopy?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#managed L4L7Device#managed}
  */
  readonly managed?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#mode L4L7Device#mode}
  */
  readonly mode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#name L4L7Device#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#name_alias L4L7Device#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#promiscuous_mode L4L7Device#promiscuous_mode}
  */
  readonly promiscuousMode?: string;
  /**
  * Create relation to phys:DomP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#relation_vns_rs_al_dev_to_phys_dom_p L4L7Device#relation_vns_rs_al_dev_to_phys_dom_p}
  */
  readonly relationVnsRsAlDevToPhysDomP?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#service_type L4L7Device#service_type}
  */
  readonly serviceType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#tenant_dn L4L7Device#tenant_dn}
  */
  readonly tenantDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#trunking L4L7Device#trunking}
  */
  readonly trunking?: string;
  /**
  * relation_vns_rs_al_dev_to_dom_p block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#relation_vns_rs_al_dev_to_dom_p L4L7Device#relation_vns_rs_al_dev_to_dom_p}
  */
  readonly relationVnsRsAlDevToDomP?: L4L7DeviceRelationVnsRsAlDevToDomP;
}
export interface L4L7DeviceRelationVnsRsAlDevToDomP {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#domain_dn L4L7Device#domain_dn}
  */
  readonly domainDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#switching_mode L4L7Device#switching_mode}
  */
  readonly switchingMode?: string;
}

export function l4L7DeviceRelationVnsRsAlDevToDomPToTerraform(struct?: L4L7DeviceRelationVnsRsAlDevToDomPOutputReference | L4L7DeviceRelationVnsRsAlDevToDomP): any {
...
export function l4L7DeviceRelationVnsRsAlDevToDomPToHclTerraform(struct?: L4L7DeviceRelationVnsRsAlDevToDomPOutputReference | L4L7DeviceRelationVnsRsAlDevToDomP): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class L4L7DeviceRelationVnsRsAlDevToDomPOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): L4L7DeviceRelationVnsRsAlDevToDomP | undefined {
  ...
  public set internalValue(value: L4L7DeviceRelationVnsRsAlDevToDomP | undefined) {
    if (value === undefined) {
  ...
  // domain_dn - computed: false, optional: false, required: true
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device aci_l4_l7_device}
*/
export class L4L7Device extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a L4L7Device resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the L4L7Device to import
  * @param importFromId The id of the existing L4L7Device that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the L4L7Device to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l4_l7_device aci_l4_l7_device} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options L4L7DeviceConfig
  */
  public constructor(scope: Construct, id: string, config: L4L7DeviceConfig) {
    super(scope, id, {
  ...
  private _relationVnsRsAlDevToDomP = new L4L7DeviceRelationVnsRsAlDevToDomPOutputReference(this, "relation_vns_rs_al_dev_to_dom_p");
  public get relationVnsRsAlDevToDomP() {
    return this._relationVnsRsAlDevToDomP;
  }
  public putRelationVnsRsAlDevToDomP(value: L4L7DeviceRelationVnsRsAlDevToDomP) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      relation_vns_rs_al_dev_to_dom_p: l4L7DeviceRelationVnsRsAlDevToDomPToTerraform(this._relationVnsRsAlDevToDomP.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      relation_vns_rs_al_dev_to_dom_p: {
        value: l4L7DeviceRelationVnsRsAlDevToDomPToHclTerraform(this._relationVnsRsAlDevToDomP.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "L4L7DeviceRelationVnsRsAlDevToDomPList",
      },
    };
