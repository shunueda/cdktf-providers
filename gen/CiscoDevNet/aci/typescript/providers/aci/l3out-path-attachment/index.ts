// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment
...
export interface L3OutPathAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#addr L3OutPathAttachment#addr}
  */
  readonly addr?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#annotation L3OutPathAttachment#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#autostate L3OutPathAttachment#autostate}
  */
  readonly autostate?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#description L3OutPathAttachment#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#encap L3OutPathAttachment#encap}
  */
  readonly encap?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#encap_scope L3OutPathAttachment#encap_scope}
  */
  readonly encapScope?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#id L3OutPathAttachment#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#if_inst_t L3OutPathAttachment#if_inst_t}
  */
  readonly ifInstT: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#ipv6_dad L3OutPathAttachment#ipv6_dad}
  */
  readonly ipv6Dad?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#ll_addr L3OutPathAttachment#ll_addr}
  */
  readonly llAddr?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#logical_interface_profile_dn L3OutPathAttachment#logical_interface_profile_dn}
  */
  readonly logicalInterfaceProfileDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#mac L3OutPathAttachment#mac}
  */
  readonly mac?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#mode L3OutPathAttachment#mode}
  */
  readonly mode?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#mtu L3OutPathAttachment#mtu}
  */
  readonly mtu?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#target_dn L3OutPathAttachment#target_dn}
  */
  readonly targetDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#target_dscp L3OutPathAttachment#target_dscp}
  */
  readonly targetDscp?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment aci_l3out_path_attachment}
*/
export class L3OutPathAttachment extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a L3OutPathAttachment resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the L3OutPathAttachment to import
  * @param importFromId The id of the existing L3OutPathAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the L3OutPathAttachment to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/l3out_path_attachment aci_l3out_path_attachment} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options L3OutPathAttachmentConfig
  */
  public constructor(scope: Construct, id: string, config: L3OutPathAttachmentConfig) {
    super(scope, id, {
  ...
  // if_inst_t - computed: false, optional: false, required: true
