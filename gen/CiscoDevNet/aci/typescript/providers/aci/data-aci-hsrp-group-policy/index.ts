// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy
...
export interface DataAciHsrpGroupPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#annotation DataAciHsrpGroupPolicy#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#ctrl DataAciHsrpGroupPolicy#ctrl}
  */
  readonly ctrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#description DataAciHsrpGroupPolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#hello_intvl DataAciHsrpGroupPolicy#hello_intvl}
  */
  readonly helloIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#hold_intvl DataAciHsrpGroupPolicy#hold_intvl}
  */
  readonly holdIntvl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#hsrp_group_policy_type DataAciHsrpGroupPolicy#hsrp_group_policy_type}
  */
  readonly hsrpGroupPolicyType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#id DataAciHsrpGroupPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#key DataAciHsrpGroupPolicy#key}
  */
  readonly key?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#name DataAciHsrpGroupPolicy#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#name_alias DataAciHsrpGroupPolicy#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#preempt_delay_min DataAciHsrpGroupPolicy#preempt_delay_min}
  */
  readonly preemptDelayMin?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#preempt_delay_reload DataAciHsrpGroupPolicy#preempt_delay_reload}
  */
  readonly preemptDelayReload?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#preempt_delay_sync DataAciHsrpGroupPolicy#preempt_delay_sync}
  */
  readonly preemptDelaySync?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#prio DataAciHsrpGroupPolicy#prio}
  */
  readonly prio?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#tenant_dn DataAciHsrpGroupPolicy#tenant_dn}
  */
  readonly tenantDn: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#timeout DataAciHsrpGroupPolicy#timeout}
  */
  readonly timeout?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy aci_hsrp_group_policy}
*/
export class DataAciHsrpGroupPolicy extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataAciHsrpGroupPolicy resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataAciHsrpGroupPolicy to import
  * @param importFromId The id of the existing DataAciHsrpGroupPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAciHsrpGroupPolicy to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/hsrp_group_policy aci_hsrp_group_policy} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataAciHsrpGroupPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: DataAciHsrpGroupPolicyConfig) {
    super(scope, id, {
