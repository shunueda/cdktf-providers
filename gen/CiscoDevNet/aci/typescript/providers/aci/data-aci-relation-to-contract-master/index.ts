// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/relation_to_contract_master
...
export interface DataAciRelationToContractMasterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/relation_to_contract_master#parent_dn DataAciRelationToContractMaster#parent_dn}
  */
  readonly parentDn: string;
  /**
  * The distinguished name of the target.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/relation_to_contract_master#target_dn DataAciRelationToContractMaster#target_dn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/relation_to_contract_master aci_relation_to_contract_master}
*/
export class DataAciRelationToContractMaster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciRelationToContractMaster that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/relation_to_contract_master#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/relation_to_contract_master aci_relation_to_contract_master} Data Source
  *
  * @param scope The scope in which to define this construct
