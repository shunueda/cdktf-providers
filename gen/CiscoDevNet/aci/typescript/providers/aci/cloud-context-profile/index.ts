// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile
...
export interface CloudContextProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#access_policy_type CloudContextProfile#access_policy_type}
  */
  readonly accessPolicyType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#annotation CloudContextProfile#annotation}
  */
  readonly annotation?: string;
  /**
  * Import Brownfield Virtual Network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#cloud_brownfield CloudContextProfile#cloud_brownfield}
  */
  readonly cloudBrownfield?: string;
  /**
  * Name of the vendor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#cloud_vendor CloudContextProfile#cloud_vendor}
  */
  readonly cloudVendor: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#description CloudContextProfile#description}
  */
  readonly description?: string;
  /**
  * hub network to enable transit gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#hub_network CloudContextProfile#hub_network}
  */
  readonly hubNetwork?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#id CloudContextProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#name CloudContextProfile#name}
  */
  readonly name: string;
  /**
  * Mo doc not defined in techpub!!!
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#name_alias CloudContextProfile#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Primary CIDR block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#primary_cidr CloudContextProfile#primary_cidr}
  */
  readonly primaryCidr: string;
  /**
  * region
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#region CloudContextProfile#region}
  */
  readonly region: string;
  /**
  * Create relation to cloudAwsFlowLogPol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#relation_cloud_rs_ctx_to_flow_log CloudContextProfile#relation_cloud_rs_ctx_to_flow_log}
  */
  readonly relationCloudRsCtxToFlowLog?: string;
  /**
  * Create relation to fvCtx
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#relation_cloud_rs_to_ctx CloudContextProfile#relation_cloud_rs_to_ctx}
  */
  readonly relationCloudRsToCtx: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#tenant_dn CloudContextProfile#tenant_dn}
  */
  readonly tenantDn: string;
  /**
  * component type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#type CloudContextProfile#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile aci_cloud_context_profile}
*/
export class CloudContextProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudContextProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/cloud_context_profile aci_cloud_context_profile} Resource
  *
  * @param scope The scope in which to define this construct
