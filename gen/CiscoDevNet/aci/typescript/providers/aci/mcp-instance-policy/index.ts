// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy
...
export interface McpInstancePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy#admin_st McpInstancePolicy#admin_st}
  */
  readonly adminSt?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy#annotation McpInstancePolicy#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy#ctrl McpInstancePolicy#ctrl}
  */
  readonly ctrl?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy#description McpInstancePolicy#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy#id McpInstancePolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy#init_delay_time McpInstancePolicy#init_delay_time}
  */
  readonly initDelayTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy#key McpInstancePolicy#key}
  */
  readonly key: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy#loop_detect_mult McpInstancePolicy#loop_detect_mult}
  */
  readonly loopDetectMult?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy#loop_protect_act McpInstancePolicy#loop_protect_act}
  */
  readonly loopProtectAct?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy#name_alias McpInstancePolicy#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy#tx_freq McpInstancePolicy#tx_freq}
  */
  readonly txFreq?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy#tx_freq_msec McpInstancePolicy#tx_freq_msec}
  */
  readonly txFreqMsec?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy aci_mcp_instance_policy}
*/
export class McpInstancePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing McpInstancePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/mcp_instance_policy aci_mcp_instance_policy} Resource
  *
  * @param scope The scope in which to define this construct
