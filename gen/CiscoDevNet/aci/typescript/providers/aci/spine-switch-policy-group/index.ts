// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group
...
export interface SpineSwitchPolicyGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group#annotation SpineSwitchPolicyGroup#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group#description SpineSwitchPolicyGroup#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group#id SpineSwitchPolicyGroup#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group#name SpineSwitchPolicyGroup#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group#name_alias SpineSwitchPolicyGroup#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Create relation to iacl:SpineProfile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group#relation_infra_rs_iacl_spine_profile SpineSwitchPolicyGroup#relation_infra_rs_iacl_spine_profile}
  */
  readonly relationInfraRsIaclSpineProfile?: string;
  /**
  * Create relation to bfd:Ipv4InstPol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group#relation_infra_rs_spine_bfd_ipv4_inst_pol SpineSwitchPolicyGroup#relation_infra_rs_spine_bfd_ipv4_inst_pol}
  */
  readonly relationInfraRsSpineBfdIpv4InstPol?: string;
  /**
  * Create relation to bfd:Ipv6InstPol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group#relation_infra_rs_spine_bfd_ipv6_inst_pol SpineSwitchPolicyGroup#relation_infra_rs_spine_bfd_ipv6_inst_pol}
  */
  readonly relationInfraRsSpineBfdIpv6InstPol?: string;
  /**
  * Create relation to copp:SpineProfile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group#relation_infra_rs_spine_copp_profile SpineSwitchPolicyGroup#relation_infra_rs_spine_copp_profile}
  */
  readonly relationInfraRsSpineCoppProfile?: string;
  /**
  * Create relation to cdp:IfPol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group#relation_infra_rs_spine_p_grp_to_cdp_if_pol SpineSwitchPolicyGroup#relation_infra_rs_spine_p_grp_to_cdp_if_pol}
  */
  readonly relationInfraRsSpinePGrpToCdpIfPol?: string;
  /**
  * Create relation to lldp:IfPol
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group#relation_infra_rs_spine_p_grp_to_lldp_if_pol SpineSwitchPolicyGroup#relation_infra_rs_spine_p_grp_to_lldp_if_pol}
  */
  readonly relationInfraRsSpinePGrpToLldpIfPol?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group aci_spine_switch_policy_group}
*/
export class SpineSwitchPolicyGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpineSwitchPolicyGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/resources/spine_switch_policy_group aci_spine_switch_policy_group} Resource
  *
  * @param scope The scope in which to define this construct
