// https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/l3_domain_profile
...
export interface DataAciL3DomainProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/l3_domain_profile#annotation DataAciL3DomainProfile#annotation}
  */
  readonly annotation?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/l3_domain_profile#id DataAciL3DomainProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/l3_domain_profile#name DataAciL3DomainProfile#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/l3_domain_profile#name_alias DataAciL3DomainProfile#name_alias}
  */
  readonly nameAlias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/l3_domain_profile#relation_extnw_rs_out DataAciL3DomainProfile#relation_extnw_rs_out}
  */
  readonly relationExtnwRsOut?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/l3_domain_profile#relation_infra_rs_dom_vxlan_ns_def DataAciL3DomainProfile#relation_infra_rs_dom_vxlan_ns_def}
  */
  readonly relationInfraRsDomVxlanNsDef?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/l3_domain_profile#relation_infra_rs_vip_addr_ns DataAciL3DomainProfile#relation_infra_rs_vip_addr_ns}
  */
  readonly relationInfraRsVipAddrNs?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/l3_domain_profile#relation_infra_rs_vlan_ns DataAciL3DomainProfile#relation_infra_rs_vlan_ns}
  */
  readonly relationInfraRsVlanNs?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/l3_domain_profile#relation_infra_rs_vlan_ns_def DataAciL3DomainProfile#relation_infra_rs_vlan_ns_def}
  */
  readonly relationInfraRsVlanNsDef?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/l3_domain_profile aci_l3_domain_profile}
*/
export class DataAciL3DomainProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAciL3DomainProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/l3_domain_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/aci/2.18.0/docs/data-sources/l3_domain_profile aci_l3_domain_profile} Data Source
  *
  * @param scope The scope in which to define this construct
