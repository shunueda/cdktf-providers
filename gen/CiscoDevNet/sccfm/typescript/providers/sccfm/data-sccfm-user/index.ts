// https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/data-sources/user
...
export interface DataSccfmUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/data-sources/user#is_api_only_user DataSccfmUser#is_api_only_user}
  */
  readonly isApiOnlyUser: boolean | cdktf.IResolvable;
  /**
  * Name of the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/data-sources/user#name DataSccfmUser#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/data-sources/user sccfm_user}
*/
export class DataSccfmUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSccfmUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/data-sources/user sccfm_user} Data Source
  *
  * @param scope The scope in which to define this construct
