// https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/data-sources/ftd_device
...
export interface DataSccfmFtdDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/data-sources/ftd_device#name DataSccfmFtdDevice#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/data-sources/ftd_device sccfm_ftd_device}
*/
export class DataSccfmFtdDevice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSccfmFtdDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/data-sources/ftd_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/data-sources/ftd_device sccfm_ftd_device} Data Source
  *
  * @param scope The scope in which to define this construct
