// https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/sdc
...
export interface SdcConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/sdc#name Sdc#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/sdc sccfm_sdc}
*/
export class Sdc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sdc that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/sdc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/sdc sccfm_sdc} Resource
  *
  * @param scope The scope in which to define this construct
