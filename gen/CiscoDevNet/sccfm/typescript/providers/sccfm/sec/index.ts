// https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/resources/sec
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/resources/sec sccfm_sec}
*/
export class Sec extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sec that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/resources/sec#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/resources/sec sccfm_sec} Resource
  *
  * @param scope The scope in which to define this construct
