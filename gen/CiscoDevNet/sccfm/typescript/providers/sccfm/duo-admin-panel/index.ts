// https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/duo_admin_panel
...
export interface DuoAdminPanelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/duo_admin_panel#grouped_labels DuoAdminPanel#grouped_labels}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/duo_admin_panel#host DuoAdminPanel#host}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/duo_admin_panel#integration_key DuoAdminPanel#integration_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/duo_admin_panel#labels DuoAdminPanel#labels}
  */
  readonly labels?: string[];
  /**
  * A human-readable name for the Duo Admin Panel.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/duo_admin_panel#name DuoAdminPanel#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/duo_admin_panel#secret_key DuoAdminPanel#secret_key}
  */
  readonly secretKey: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/duo_admin_panel sccfm_duo_admin_panel}
*/
export class DuoAdminPanel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DuoAdminPanel that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/duo_admin_panel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/duo_admin_panel sccfm_duo_admin_panel} Resource
  *
  * @param scope The scope in which to define this construct
