// https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/ftd_device_onboarding
...
export interface FtdDeviceOnboardingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/ftd_device_onboarding#ftd_uid FtdDeviceOnboarding#ftd_uid}
  */
  readonly ftdUid: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/ftd_device_onboarding sccfm_ftd_device_onboarding}
*/
export class FtdDeviceOnboarding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FtdDeviceOnboarding that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/ftd_device_onboarding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.2.5/docs/resources/ftd_device_onboarding sccfm_ftd_device_onboarding} Resource
  *
  * @param scope The scope in which to define this construct
