// https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/data-sources/asa_device
...
export interface DataSccfmAsaDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/data-sources/asa_device#name DataSccfmAsaDevice#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/data-sources/asa_device sccfm_asa_device}
*/
export class DataSccfmAsaDevice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSccfmAsaDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/data-sources/asa_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/data-sources/asa_device sccfm_asa_device} Data Source
  *
  * @param scope The scope in which to define this construct
