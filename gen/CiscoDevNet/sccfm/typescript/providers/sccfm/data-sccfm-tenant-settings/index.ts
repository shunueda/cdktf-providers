// https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/data-sources/tenant_settings
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/data-sources/tenant_settings sccfm_tenant_settings}
*/
export class DataSccfmTenantSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSccfmTenantSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/data-sources/tenant_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/data-sources/tenant_settings sccfm_tenant_settings} Data Source
  *
  * @param scope The scope in which to define this construct
