// https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/resources/ftd_device_version
...
export interface FtdDeviceVersionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/resources/ftd_device_version#ftd_uid FtdDeviceVersion#ftd_uid}
  */
  readonly ftdUid: string;
  /**
  * The software version to upgrade the FTD device to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/resources/ftd_device_version#software_version FtdDeviceVersion#software_version}
  */
  readonly softwareVersion: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/resources/ftd_device_version sccfm_ftd_device_version}
*/
export class FtdDeviceVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FtdDeviceVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/resources/ftd_device_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.2/docs/resources/ftd_device_version sccfm_ftd_device_version} Resource
  *
  * @param scope The scope in which to define this construct
