// https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.0/docs/resources/msp_managed_tenant_user_api_token
...
export interface MspManagedTenantUserApiTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.0/docs/resources/msp_managed_tenant_user_api_token#tenant_uid MspManagedTenantUserApiToken#tenant_uid}
  */
  readonly tenantUid: string;
  /**
  * Universally unique identifier of the user for whom the API token should be generated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.0/docs/resources/msp_managed_tenant_user_api_token#user_uid MspManagedTenantUserApiToken#user_uid}
  */
  readonly userUid: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.0/docs/resources/msp_managed_tenant_user_api_token sccfm_msp_managed_tenant_user_api_token}
*/
export class MspManagedTenantUserApiToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MspManagedTenantUserApiToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.0/docs/resources/msp_managed_tenant_user_api_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sccfm/0.3.0/docs/resources/msp_managed_tenant_user_api_token sccfm_msp_managed_tenant_user_api_token} Resource
  *
  * @param scope The scope in which to define this construct
