// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature
...
export interface TransportRoutePolicyFeatureConfig extends cdktf.TerraformMetaArguments {
  /**
  * Default Action
  *   - Choices: `reject`, `accept`
  *   - Default value: `reject`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#default_action TransportRoutePolicyFeature#default_action}
  */
  readonly defaultAction?: string;
  /**
  * The description of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#description TransportRoutePolicyFeature#description}
  */
  readonly description?: string;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#feature_profile_id TransportRoutePolicyFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The name of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#name TransportRoutePolicyFeature#name}
  */
  readonly name: string;
  /**
  * Route Policy List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#sequences TransportRoutePolicyFeature#sequences}
  */
  readonly sequences?: TransportRoutePolicyFeatureSequences[] | cdktf.IResolvable;
}
export interface TransportRoutePolicyFeatureSequencesActions {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#as_path_prepend TransportRoutePolicyFeature#as_path_prepend}
  */
  readonly asPathPrepend?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#community TransportRoutePolicyFeature#community}
  */
  ...
  *   - Default value: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#community_additive TransportRoutePolicyFeature#community_additive}
  */
  readonly communityAdditive?: boolean | cdktf.IResolvable;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#community_variable TransportRoutePolicyFeature#community_variable}
  */
  readonly communityVariable?: string;
  /**
  * Set Ipv4 Next Hop
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#ipv4_next_hop TransportRoutePolicyFeature#ipv4_next_hop}
  */
  readonly ipv4NextHop?: string;
  /**
  * Set Ipv6 Next Hop
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#ipv6_next_hop TransportRoutePolicyFeature#ipv6_next_hop}
  */
  ...
  *   - Range: `0`-`4294967295`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#local_preference TransportRoutePolicyFeature#local_preference}
  */
  ...
  *   - Range: `0`-`4294967295`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#metric TransportRoutePolicyFeature#metric}
  */
  ...
  *   - Choices: `type1`, `type2`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#metric_type TransportRoutePolicyFeature#metric_type}
  */
  ...
  *   - Range: `0`-`4294967295`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#omp_tag TransportRoutePolicyFeature#omp_tag}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#origin TransportRoutePolicyFeature#origin}
  */
  ...
  *   - Range: `0`-`4294967295`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#ospf_tag TransportRoutePolicyFeature#ospf_tag}
  */
  ...
  *   - Range: `0`-`65535`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#weight TransportRoutePolicyFeature#weight}
  */
  readonly weight?: number;
}

export function transportRoutePolicyFeatureSequencesActionsToTerraform(struct?: TransportRoutePolicyFeatureSequencesActions | cdktf.IResolvable): any {
...
export function transportRoutePolicyFeatureSequencesActionsToHclTerraform(struct?: TransportRoutePolicyFeatureSequencesActions | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class TransportRoutePolicyFeatureSequencesActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): TransportRoutePolicyFeatureSequencesActions | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: TransportRoutePolicyFeatureSequencesActions | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class TransportRoutePolicyFeatureSequencesActionsList extends cdktf.ComplexList {
  public internalValue? : TransportRoutePolicyFeatureSequencesActions[] | cdktf.IResolvable
  ...
  */
  public get(index: number): TransportRoutePolicyFeatureSequencesActionsOutputReference {
    return new TransportRoutePolicyFeatureSequencesActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface TransportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityLists {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#id TransportRoutePolicyFeature#id}
  *
...
export function transportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityListsToTerraform(struct?: TransportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityLists | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function transportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityListsToHclTerraform(struct?: TransportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityLists | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class TransportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityListsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): TransportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityLists | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: TransportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityLists | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._id = undefined;
...
export class TransportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityListsList extends cdktf.ComplexList {
  public internalValue? : TransportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityLists[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): TransportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityListsOutputReference {
    return new TransportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityListsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface TransportRoutePolicyFeatureSequencesMatchEntries {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#as_path_list_id TransportRoutePolicyFeature#as_path_list_id}
  */
  ...
  *   - Range: `0`-`4294967295`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#bgp_local_preference TransportRoutePolicyFeature#bgp_local_preference}
  */
  readonly bgpLocalPreference?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#expanded_community_list_id TransportRoutePolicyFeature#expanded_community_list_id}
  */
  readonly expandedCommunityListId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#extended_community_list_id TransportRoutePolicyFeature#extended_community_list_id}
  */
  readonly extendedCommunityListId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#ipv4_address_prefix_list_id TransportRoutePolicyFeature#ipv4_address_prefix_list_id}
  */
  readonly ipv4AddressPrefixListId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#ipv4_next_hop_prefix_list_id TransportRoutePolicyFeature#ipv4_next_hop_prefix_list_id}
  */
  readonly ipv4NextHopPrefixListId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#ipv6_address_prefix_list_id TransportRoutePolicyFeature#ipv6_address_prefix_list_id}
  */
  readonly ipv6AddressPrefixListId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#ipv6_next_hop_prefix_list_id TransportRoutePolicyFeature#ipv6_next_hop_prefix_list_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#standard_community_list_criteria TransportRoutePolicyFeature#standard_community_list_criteria}
  */
  readonly standardCommunityListCriteria?: string;
  /**
  * Select a standard community list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#standard_community_lists TransportRoutePolicyFeature#standard_community_lists}
  */
  readonly standardCommunityLists?: TransportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityLists[] | cdktf.IResolvable;
}

export function transportRoutePolicyFeatureSequencesMatchEntriesToTerraform(struct?: TransportRoutePolicyFeatureSequencesMatchEntries | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    standard_community_lists: cdktf.listMapper(transportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityListsToTerraform, false)(struct!.standardCommunityLists),
  }
}


export function transportRoutePolicyFeatureSequencesMatchEntriesToHclTerraform(struct?: TransportRoutePolicyFeatureSequencesMatchEntries | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    standard_community_lists: {
      value: cdktf.listMapperHcl(transportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityListsToHclTerraform, false)(struct!.standardCommunityLists),
      isBlock: true,
      type: "list",
      storageClassType: "TransportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityListsList",
    },
  };
...
export class TransportRoutePolicyFeatureSequencesMatchEntriesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): TransportRoutePolicyFeatureSequencesMatchEntries | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: TransportRoutePolicyFeatureSequencesMatchEntries | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _standardCommunityLists = new TransportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityListsList(this, "standard_community_lists", false);
  public get standardCommunityLists() {
    return this._standardCommunityLists;
  }
  public putStandardCommunityLists(value: TransportRoutePolicyFeatureSequencesMatchEntriesStandardCommunityLists[] | cdktf.IResolvable) {
...
export class TransportRoutePolicyFeatureSequencesMatchEntriesList extends cdktf.ComplexList {
  public internalValue? : TransportRoutePolicyFeatureSequencesMatchEntries[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): TransportRoutePolicyFeatureSequencesMatchEntriesOutputReference {
    return new TransportRoutePolicyFeatureSequencesMatchEntriesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface TransportRoutePolicyFeatureSequences {
  /**
  * Define list of actions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#actions TransportRoutePolicyFeature#actions}
  */
  readonly actions?: TransportRoutePolicyFeatureSequencesActions[] | cdktf.IResolvable;
  /**
  * Base Action
  *   - Choices: `reject`, `accept`
  *   - Default value: `reject`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#base_action TransportRoutePolicyFeature#base_action}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#match_entries TransportRoutePolicyFeature#match_entries}
  */
  readonly matchEntries?: TransportRoutePolicyFeatureSequencesMatchEntries[] | cdktf.IResolvable;
  /**
  * Sequence Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#name TransportRoutePolicyFeature#name}
  ...
  *   - Default value: `IPV4`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#protocol TransportRoutePolicyFeature#protocol}
  */
  readonly protocol?: string;
}

export function transportRoutePolicyFeatureSequencesToTerraform(struct?: TransportRoutePolicyFeatureSequences | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    actions: cdktf.listMapper(transportRoutePolicyFeatureSequencesActionsToTerraform, false)(struct!.actions),
    base_action: cdktf.stringToTerraform(struct!.baseAction),
    id: cdktf.numberToTerraform(struct!.id),
    match_entries: cdktf.listMapper(transportRoutePolicyFeatureSequencesMatchEntriesToTerraform, false)(struct!.matchEntries),
...
export function transportRoutePolicyFeatureSequencesToHclTerraform(struct?: TransportRoutePolicyFeatureSequences | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    actions: {
      value: cdktf.listMapperHcl(transportRoutePolicyFeatureSequencesActionsToHclTerraform, false)(struct!.actions),
      isBlock: true,
      type: "list",
      storageClassType: "TransportRoutePolicyFeatureSequencesActionsList",
    },
    base_action: {
    ...
    match_entries: {
      value: cdktf.listMapperHcl(transportRoutePolicyFeatureSequencesMatchEntriesToHclTerraform, false)(struct!.matchEntries),
      isBlock: true,
      type: "list",
      storageClassType: "TransportRoutePolicyFeatureSequencesMatchEntriesList",
    },
    name: {
...
export class TransportRoutePolicyFeatureSequencesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): TransportRoutePolicyFeatureSequences | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: TransportRoutePolicyFeatureSequences | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _actions = new TransportRoutePolicyFeatureSequencesActionsList(this, "actions", false);
  public get actions() {
    return this._actions;
  }
  public putActions(value: TransportRoutePolicyFeatureSequencesActions[] | cdktf.IResolvable) {
  ...
  private _matchEntries = new TransportRoutePolicyFeatureSequencesMatchEntriesList(this, "match_entries", false);
  public get matchEntries() {
    return this._matchEntries;
  }
  public putMatchEntries(value: TransportRoutePolicyFeatureSequencesMatchEntries[] | cdktf.IResolvable) {
...
export class TransportRoutePolicyFeatureSequencesList extends cdktf.ComplexList {
  public internalValue? : TransportRoutePolicyFeatureSequences[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): TransportRoutePolicyFeatureSequencesOutputReference {
    return new TransportRoutePolicyFeatureSequencesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature sdwan_transport_route_policy_feature}
*/
export class TransportRoutePolicyFeature extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a TransportRoutePolicyFeature resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TransportRoutePolicyFeature to import
  * @param importFromId The id of the existing TransportRoutePolicyFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TransportRoutePolicyFeature to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_route_policy_feature sdwan_transport_route_policy_feature} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options TransportRoutePolicyFeatureConfig
  */
  public constructor(scope: Construct, id: string, config: TransportRoutePolicyFeatureConfig) {
    super(scope, id, {
  ...
  private _sequences = new TransportRoutePolicyFeatureSequencesList(this, "sequences", false);
  public get sequences() {
    return this._sequences;
  }
  public putSequences(value: TransportRoutePolicyFeatureSequences[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sequences: cdktf.listMapper(transportRoutePolicyFeatureSequencesToTerraform, false)(this._sequences.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sequences: {
        value: cdktf.listMapperHcl(transportRoutePolicyFeatureSequencesToHclTerraform, false)(this._sequences.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "TransportRoutePolicyFeatureSequencesList",
      },
    };
