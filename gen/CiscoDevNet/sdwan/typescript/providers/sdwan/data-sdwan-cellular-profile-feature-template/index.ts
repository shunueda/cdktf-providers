// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/cellular_profile_feature_template
...
export interface DataSdwanCellularProfileFeatureTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/cellular_profile_feature_template#id DataSdwanCellularProfileFeatureTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/cellular_profile_feature_template#name DataSdwanCellularProfileFeatureTemplate#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/cellular_profile_feature_template sdwan_cellular_profile_feature_template}
*/
export class DataSdwanCellularProfileFeatureTemplate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanCellularProfileFeatureTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/cellular_profile_feature_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/cellular_profile_feature_template sdwan_cellular_profile_feature_template} Data Source
  *
  * @param scope The scope in which to define this construct
