// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_wan_vpn_interface_ethernet_feature_associate_tracker_feature
...
export interface TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_wan_vpn_interface_ethernet_feature_associate_tracker_feature#feature_profile_id TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * Transport Tracker Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_wan_vpn_interface_ethernet_feature_associate_tracker_feature#transport_tracker_feature_id TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature#transport_tracker_feature_id}
  */
  readonly transportTrackerFeatureId: string;
  /**
  * Transport WAN VPN Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_wan_vpn_interface_ethernet_feature_associate_tracker_feature#transport_wan_vpn_feature_id TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature#transport_wan_vpn_feature_id}
  */
  readonly transportWanVpnFeatureId: string;
  /**
  * Transport WAN VPN Interface Ethernet Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_wan_vpn_interface_ethernet_feature_associate_tracker_feature#transport_wan_vpn_interface_ethernet_feature_id TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature#transport_wan_vpn_interface_ethernet_feature_id}
  */
  readonly transportWanVpnInterfaceEthernetFeatureId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_wan_vpn_interface_ethernet_feature_associate_tracker_feature sdwan_transport_wan_vpn_interface_ethernet_feature_associate_tracker_feature}
*/
export class TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransportWanVpnInterfaceEthernetFeatureAssociateTrackerFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_wan_vpn_interface_ethernet_feature_associate_tracker_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_wan_vpn_interface_ethernet_feature_associate_tracker_feature sdwan_transport_wan_vpn_interface_ethernet_feature_associate_tracker_feature} Resource
  *
  * @param scope The scope in which to define this construct
