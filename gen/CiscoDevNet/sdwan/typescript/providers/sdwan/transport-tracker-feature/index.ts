// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature
...
export interface TransportTrackerFeatureConfig extends cdktf.TerraformMetaArguments {
  /**
  * The description of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#description TransportTrackerFeature#description}
  */
  readonly description?: string;
  /**
  * API url of endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#endpoint_api_url TransportTrackerFeature#endpoint_api_url}
  */
  readonly endpointApiUrl?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#endpoint_api_url_variable TransportTrackerFeature#endpoint_api_url_variable}
  */
  readonly endpointApiUrlVariable?: string;
  /**
  * Endpoint DNS Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#endpoint_dns_name TransportTrackerFeature#endpoint_dns_name}
  */
  readonly endpointDnsName?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#endpoint_dns_name_variable TransportTrackerFeature#endpoint_dns_name_variable}
  */
  readonly endpointDnsNameVariable?: string;
  /**
  * Endpoint IP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#endpoint_ip TransportTrackerFeature#endpoint_ip}
  */
  readonly endpointIp?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#endpoint_ip_variable TransportTrackerFeature#endpoint_ip_variable}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#endpoint_tracker_type TransportTrackerFeature#endpoint_tracker_type}
  */
  readonly endpointTrackerType?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#endpoint_tracker_type_variable TransportTrackerFeature#endpoint_tracker_type_variable}
  */
  readonly endpointTrackerTypeVariable?: string;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#feature_profile_id TransportTrackerFeature#feature_profile_id}
  */
  ...
  *   - Default value: `60`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#interval TransportTrackerFeature#interval}
  */
  readonly interval?: number;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#interval_variable TransportTrackerFeature#interval_variable}
  */
  ...
  *   - Default value: `3`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#multiplier TransportTrackerFeature#multiplier}
  */
  readonly multiplier?: number;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#multiplier_variable TransportTrackerFeature#multiplier_variable}
  */
  readonly multiplierVariable?: string;
  /**
  * The name of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#name TransportTrackerFeature#name}
  */
  ...
  *   - Default value: `300`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#threshold TransportTrackerFeature#threshold}
  */
  readonly threshold?: number;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#threshold_variable TransportTrackerFeature#threshold_variable}
  */
  readonly thresholdVariable?: string;
  /**
  * Tracker Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#tracker_name TransportTrackerFeature#tracker_name}
  */
  readonly trackerName?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#tracker_name_variable TransportTrackerFeature#tracker_name_variable}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#tracker_type TransportTrackerFeature#tracker_type}
  */
  readonly trackerType?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#tracker_type_variable TransportTrackerFeature#tracker_type_variable}
  */
  readonly trackerTypeVariable?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature sdwan_transport_tracker_feature}
*/
export class TransportTrackerFeature extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sdwan_transport_tracker_feature";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a TransportTrackerFeature resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the TransportTrackerFeature to import
  * @param importFromId The id of the existing TransportTrackerFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the TransportTrackerFeature to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sdwan_transport_tracker_feature", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/transport_tracker_feature sdwan_transport_tracker_feature} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options TransportTrackerFeatureConfig
  */
  public constructor(scope: Construct, id: string, config: TransportTrackerFeatureConfig) {
    super(scope, id, {
      terraformResourceType: 'sdwan_transport_tracker_feature',
