// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/policy_object_preferred_color_group
...
export interface DataSdwanPolicyObjectPreferredColorGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/policy_object_preferred_color_group#feature_profile_id DataSdwanPolicyObjectPreferredColorGroup#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The id of the Policy_object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/policy_object_preferred_color_group#id DataSdwanPolicyObjectPreferredColorGroup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/policy_object_preferred_color_group sdwan_policy_object_preferred_color_group}
*/
export class DataSdwanPolicyObjectPreferredColorGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanPolicyObjectPreferredColorGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/policy_object_preferred_color_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/policy_object_preferred_color_group sdwan_policy_object_preferred_color_group} Data Source
  *
  * @param scope The scope in which to define this construct
