// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature
...
export interface ServiceTrackerFeatureConfig extends cdktf.TerraformMetaArguments {
  /**
  * The description of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#description ServiceTrackerFeature#description}
  */
  readonly description?: string;
  /**
  * API url of endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#endpoint_api_url ServiceTrackerFeature#endpoint_api_url}
  */
  readonly endpointApiUrl?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#endpoint_api_url_variable ServiceTrackerFeature#endpoint_api_url_variable}
  */
  readonly endpointApiUrlVariable?: string;
  /**
  * Endpoint DNS Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#endpoint_dns_name ServiceTrackerFeature#endpoint_dns_name}
  */
  readonly endpointDnsName?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#endpoint_dns_name_variable ServiceTrackerFeature#endpoint_dns_name_variable}
  */
  readonly endpointDnsNameVariable?: string;
  /**
  * Endpoint IP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#endpoint_ip ServiceTrackerFeature#endpoint_ip}
  */
  readonly endpointIp?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#endpoint_ip_variable ServiceTrackerFeature#endpoint_ip_variable}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#endpoint_tracker_type ServiceTrackerFeature#endpoint_tracker_type}
  */
  readonly endpointTrackerType?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#endpoint_tracker_type_variable ServiceTrackerFeature#endpoint_tracker_type_variable}
  */
  readonly endpointTrackerTypeVariable?: string;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#feature_profile_id ServiceTrackerFeature#feature_profile_id}
  */
  ...
  *   - Default value: `60`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#interval ServiceTrackerFeature#interval}
  */
  readonly interval?: number;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#interval_variable ServiceTrackerFeature#interval_variable}
  */
  ...
  *   - Default value: `3`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#multiplier ServiceTrackerFeature#multiplier}
  */
  readonly multiplier?: number;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#multiplier_variable ServiceTrackerFeature#multiplier_variable}
  */
  readonly multiplierVariable?: string;
  /**
  * The name of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#name ServiceTrackerFeature#name}
  */
  ...
  *   - Range: `1`-`65535`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#port ServiceTrackerFeature#port}
  */
  readonly port?: number;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#port_variable ServiceTrackerFeature#port_variable}
  */
  ...
  *   - Choices: `tcp`, `udp`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#protocol ServiceTrackerFeature#protocol}
  */
  readonly protocol?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#protocol_variable ServiceTrackerFeature#protocol_variable}
  */
  ...
  *   - Default value: `300`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#threshold ServiceTrackerFeature#threshold}
  */
  readonly threshold?: number;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#threshold_variable ServiceTrackerFeature#threshold_variable}
  */
  readonly thresholdVariable?: string;
  /**
  * Tracker Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#tracker_name ServiceTrackerFeature#tracker_name}
  */
  readonly trackerName?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#tracker_name_variable ServiceTrackerFeature#tracker_name_variable}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#tracker_type ServiceTrackerFeature#tracker_type}
  */
  readonly trackerType?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#tracker_type_variable ServiceTrackerFeature#tracker_type_variable}
  */
  readonly trackerTypeVariable?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature sdwan_service_tracker_feature}
*/
export class ServiceTrackerFeature extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sdwan_service_tracker_feature";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a ServiceTrackerFeature resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ServiceTrackerFeature to import
  * @param importFromId The id of the existing ServiceTrackerFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ServiceTrackerFeature to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sdwan_service_tracker_feature", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_tracker_feature sdwan_service_tracker_feature} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ServiceTrackerFeatureConfig
  */
  public constructor(scope: Construct, id: string, config: ServiceTrackerFeatureConfig) {
    super(scope, id, {
    ...
    this._portVariable = config.portVariable;
    this._protocol = config.protocol;
    this._protocolVariable = config.protocolVariable;
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      port_variable: cdktf.stringToTerraform(this._portVariable),
      protocol: cdktf.stringToTerraform(this._protocol),
      protocol_variable: cdktf.stringToTerraform(this._protocolVariable),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      port_variable: {
        value: cdktf.stringToHclTerraform(this._portVariable),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      protocol_variable: {
        value: cdktf.stringToHclTerraform(this._protocolVariable),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
