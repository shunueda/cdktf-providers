// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_tracker_feature
...
export interface DataSdwanTransportTrackerFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_tracker_feature#feature_profile_id DataSdwanTransportTrackerFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The id of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_tracker_feature#id DataSdwanTransportTrackerFeature#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_tracker_feature sdwan_transport_tracker_feature}
*/
export class DataSdwanTransportTrackerFeature extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanTransportTrackerFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_tracker_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_tracker_feature sdwan_transport_tracker_feature} Data Source
  *
  * @param scope The scope in which to define this construct
