// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature
...
export interface ServiceIpv4AclFeatureConfig extends cdktf.TerraformMetaArguments {
  /**
  * Default Action
  *   - Choices: `drop`, `accept`
  *   - Default value: `drop`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#default_action ServiceIpv4AclFeature#default_action}
  */
  readonly defaultAction?: string;
  /**
  * The description of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#description ServiceIpv4AclFeature#description}
  */
  readonly description?: string;
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#feature_profile_id ServiceIpv4AclFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The name of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#name ServiceIpv4AclFeature#name}
  */
  readonly name: string;
  /**
  * Access Control List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#sequences ServiceIpv4AclFeature#sequences}
  */
  readonly sequences?: ServiceIpv4AclFeatureSequences[] | cdktf.IResolvable;
}
export interface ServiceIpv4AclFeatureSequencesActions {
  /**
  * Counter Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#accept_counter_name ServiceIpv4AclFeature#accept_counter_name}
  */
  ...
  *   - Default value: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#accept_log ServiceIpv4AclFeature#accept_log}
  */
  readonly acceptLog?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#accept_mirror_list_id ServiceIpv4AclFeature#accept_mirror_list_id}
  */
  readonly acceptMirrorListId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#accept_policer_id ServiceIpv4AclFeature#accept_policer_id}
  */
  ...
  *   - Range: `0`-`63`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#accept_set_dscp ServiceIpv4AclFeature#accept_set_dscp}
  */
  readonly acceptSetDscp?: number;
  /**
  * Set Next Hop (IPV4 address)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#accept_set_next_hop ServiceIpv4AclFeature#accept_set_next_hop}
  */
  readonly acceptSetNextHop?: string;
  /**
  * Counter Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#drop_counter_name ServiceIpv4AclFeature#drop_counter_name}
  */
  ...
  *   - Default value: `false`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#drop_log ServiceIpv4AclFeature#drop_log}
  */
  readonly dropLog?: boolean | cdktf.IResolvable;
}

export function serviceIpv4AclFeatureSequencesActionsToTerraform(struct?: ServiceIpv4AclFeatureSequencesActions | cdktf.IResolvable): any {
...
export function serviceIpv4AclFeatureSequencesActionsToHclTerraform(struct?: ServiceIpv4AclFeatureSequencesActions | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ServiceIpv4AclFeatureSequencesActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ServiceIpv4AclFeatureSequencesActions | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ServiceIpv4AclFeatureSequencesActions | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ServiceIpv4AclFeatureSequencesActionsList extends cdktf.ComplexList {
  public internalValue? : ServiceIpv4AclFeatureSequencesActions[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ServiceIpv4AclFeatureSequencesActionsOutputReference {
    return new ServiceIpv4AclFeatureSequencesActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface ServiceIpv4AclFeatureSequencesMatchEntriesDestinationPorts {
  /**
  * destination port range or individual port number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#port ServiceIpv4AclFeature#port}
  */
  readonly port?: string;
}

export function serviceIpv4AclFeatureSequencesMatchEntriesDestinationPortsToTerraform(struct?: ServiceIpv4AclFeatureSequencesMatchEntriesDestinationPorts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function serviceIpv4AclFeatureSequencesMatchEntriesDestinationPortsToHclTerraform(struct?: ServiceIpv4AclFeatureSequencesMatchEntriesDestinationPorts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ServiceIpv4AclFeatureSequencesMatchEntriesDestinationPortsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): ServiceIpv4AclFeatureSequencesMatchEntriesDestinationPorts | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ServiceIpv4AclFeatureSequencesMatchEntriesDestinationPorts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class ServiceIpv4AclFeatureSequencesMatchEntriesDestinationPortsList extends cdktf.ComplexList {
  public internalValue? : ServiceIpv4AclFeatureSequencesMatchEntriesDestinationPorts[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): ServiceIpv4AclFeatureSequencesMatchEntriesDestinationPortsOutputReference {
    return new ServiceIpv4AclFeatureSequencesMatchEntriesDestinationPortsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface ServiceIpv4AclFeatureSequencesMatchEntriesSourcePorts {
  /**
...
export function serviceIpv4AclFeatureSequencesMatchEntriesSourcePortsToTerraform(struct?: ServiceIpv4AclFeatureSequencesMatchEntriesSourcePorts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function serviceIpv4AclFeatureSequencesMatchEntriesSourcePortsToHclTerraform(struct?: ServiceIpv4AclFeatureSequencesMatchEntriesSourcePorts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ServiceIpv4AclFeatureSequencesMatchEntriesSourcePortsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): ServiceIpv4AclFeatureSequencesMatchEntriesSourcePorts | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ServiceIpv4AclFeatureSequencesMatchEntriesSourcePorts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._port = undefined;
...
export class ServiceIpv4AclFeatureSequencesMatchEntriesSourcePortsList extends cdktf.ComplexList {
  public internalValue? : ServiceIpv4AclFeatureSequencesMatchEntriesSourcePorts[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): ServiceIpv4AclFeatureSequencesMatchEntriesSourcePortsOutputReference {
    return new ServiceIpv4AclFeatureSequencesMatchEntriesSourcePortsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface ServiceIpv4AclFeatureSequencesMatchEntries {
  /**
  * Destination Data IP Prefix
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#destination_data_prefix ServiceIpv4AclFeature#destination_data_prefix}
  */
  readonly destinationDataPrefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#destination_data_prefix_list_id ServiceIpv4AclFeature#destination_data_prefix_list_id}
  */
  readonly destinationDataPrefixListId?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#destination_data_prefix_variable ServiceIpv4AclFeature#destination_data_prefix_variable}
  */
  readonly destinationDataPrefixVariable?: string;
  /**
  * Destination Port List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#destination_ports ServiceIpv4AclFeature#destination_ports}
  */
  readonly destinationPorts?: ServiceIpv4AclFeatureSequencesMatchEntriesDestinationPorts[] | cdktf.IResolvable;
  /**
  * DSCP number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#dscps ServiceIpv4AclFeature#dscps}
  */
  readonly dscps?: number[];
  /**
  * ICMP Message
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#icmp_messages ServiceIpv4AclFeature#icmp_messages}
  */
  readonly icmpMessages?: string[];
  /**
  * Packet Length
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#packet_length ServiceIpv4AclFeature#packet_length}
  */
  readonly packetLength?: string;
  /**
  * protocol number list with at least one item
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#protocols ServiceIpv4AclFeature#protocols}
  */
  readonly protocols?: number[];
  /**
  * Source Data IP Prefix
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#source_data_prefix ServiceIpv4AclFeature#source_data_prefix}
  */
  readonly sourceDataPrefix?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#source_data_prefix_list_id ServiceIpv4AclFeature#source_data_prefix_list_id}
  */
  readonly sourceDataPrefixListId?: string;
  /**
  * Variable name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#source_data_prefix_variable ServiceIpv4AclFeature#source_data_prefix_variable}
  */
  readonly sourceDataPrefixVariable?: string;
  /**
  * Source Port List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#source_ports ServiceIpv4AclFeature#source_ports}
  */
  readonly sourcePorts?: ServiceIpv4AclFeatureSequencesMatchEntriesSourcePorts[] | cdktf.IResolvable;
  /**
  * TCP States
  *   - Choices: `syn`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#tcp_state ServiceIpv4AclFeature#tcp_state}
  */
  readonly tcpState?: string;
}

export function serviceIpv4AclFeatureSequencesMatchEntriesToTerraform(struct?: ServiceIpv4AclFeatureSequencesMatchEntries | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    destination_ports: cdktf.listMapper(serviceIpv4AclFeatureSequencesMatchEntriesDestinationPortsToTerraform, false)(struct!.destinationPorts),
    ...
    source_ports: cdktf.listMapper(serviceIpv4AclFeatureSequencesMatchEntriesSourcePortsToTerraform, false)(struct!.sourcePorts),
    tcp_state: cdktf.stringToTerraform(struct!.tcpState),
  }
}


export function serviceIpv4AclFeatureSequencesMatchEntriesToHclTerraform(struct?: ServiceIpv4AclFeatureSequencesMatchEntries | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    destination_ports: {
      value: cdktf.listMapperHcl(serviceIpv4AclFeatureSequencesMatchEntriesDestinationPortsToHclTerraform, false)(struct!.destinationPorts),
      isBlock: true,
      type: "list",
      storageClassType: "ServiceIpv4AclFeatureSequencesMatchEntriesDestinationPortsList",
    },
    dscps: {
    ...
    source_ports: {
      value: cdktf.listMapperHcl(serviceIpv4AclFeatureSequencesMatchEntriesSourcePortsToHclTerraform, false)(struct!.sourcePorts),
      isBlock: true,
      type: "list",
      storageClassType: "ServiceIpv4AclFeatureSequencesMatchEntriesSourcePortsList",
    },
    tcp_state: {
...
export class ServiceIpv4AclFeatureSequencesMatchEntriesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): ServiceIpv4AclFeatureSequencesMatchEntries | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ServiceIpv4AclFeatureSequencesMatchEntries | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _destinationPorts = new ServiceIpv4AclFeatureSequencesMatchEntriesDestinationPortsList(this, "destination_ports", false);
  public get destinationPorts() {
    return this._destinationPorts;
  }
  public putDestinationPorts(value: ServiceIpv4AclFeatureSequencesMatchEntriesDestinationPorts[] | cdktf.IResolvable) {
  ...
  private _sourcePorts = new ServiceIpv4AclFeatureSequencesMatchEntriesSourcePortsList(this, "source_ports", false);
  public get sourcePorts() {
    return this._sourcePorts;
  }
  public putSourcePorts(value: ServiceIpv4AclFeatureSequencesMatchEntriesSourcePorts[] | cdktf.IResolvable) {
...
export class ServiceIpv4AclFeatureSequencesMatchEntriesList extends cdktf.ComplexList {
  public internalValue? : ServiceIpv4AclFeatureSequencesMatchEntries[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): ServiceIpv4AclFeatureSequencesMatchEntriesOutputReference {
    return new ServiceIpv4AclFeatureSequencesMatchEntriesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface ServiceIpv4AclFeatureSequences {
  /**
  * Define list of actions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#actions ServiceIpv4AclFeature#actions}
  */
  readonly actions?: ServiceIpv4AclFeatureSequencesActions[] | cdktf.IResolvable;
  /**
  * Base Action
  *   - Choices: `drop`, `accept`
  *   - Default value: `accept`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#base_action ServiceIpv4AclFeature#base_action}
  */
  readonly baseAction?: string;
  /**
  * Define match conditions
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#match_entries ServiceIpv4AclFeature#match_entries}
  */
  readonly matchEntries?: ServiceIpv4AclFeatureSequencesMatchEntries[] | cdktf.IResolvable;
  /**
  * Sequence Id
  *   - Range: `1`-`65536`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#sequence_id ServiceIpv4AclFeature#sequence_id}
  */
  readonly sequenceId?: number;
  /**
  * Sequence Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#sequence_name ServiceIpv4AclFeature#sequence_name}
  */
  readonly sequenceName?: string;
}

export function serviceIpv4AclFeatureSequencesToTerraform(struct?: ServiceIpv4AclFeatureSequences | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    actions: cdktf.listMapper(serviceIpv4AclFeatureSequencesActionsToTerraform, false)(struct!.actions),
    base_action: cdktf.stringToTerraform(struct!.baseAction),
    match_entries: cdktf.listMapper(serviceIpv4AclFeatureSequencesMatchEntriesToTerraform, false)(struct!.matchEntries),
...
export function serviceIpv4AclFeatureSequencesToHclTerraform(struct?: ServiceIpv4AclFeatureSequences | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    actions: {
      value: cdktf.listMapperHcl(serviceIpv4AclFeatureSequencesActionsToHclTerraform, false)(struct!.actions),
      isBlock: true,
      type: "list",
      storageClassType: "ServiceIpv4AclFeatureSequencesActionsList",
    },
    base_action: {
    ...
    match_entries: {
      value: cdktf.listMapperHcl(serviceIpv4AclFeatureSequencesMatchEntriesToHclTerraform, false)(struct!.matchEntries),
      isBlock: true,
      type: "list",
      storageClassType: "ServiceIpv4AclFeatureSequencesMatchEntriesList",
    },
    sequence_id: {
...
export class ServiceIpv4AclFeatureSequencesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): ServiceIpv4AclFeatureSequences | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ServiceIpv4AclFeatureSequences | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _actions = new ServiceIpv4AclFeatureSequencesActionsList(this, "actions", false);
  public get actions() {
    return this._actions;
  }
  public putActions(value: ServiceIpv4AclFeatureSequencesActions[] | cdktf.IResolvable) {
  ...
  private _matchEntries = new ServiceIpv4AclFeatureSequencesMatchEntriesList(this, "match_entries", false);
  public get matchEntries() {
    return this._matchEntries;
  }
  public putMatchEntries(value: ServiceIpv4AclFeatureSequencesMatchEntries[] | cdktf.IResolvable) {
...
export class ServiceIpv4AclFeatureSequencesList extends cdktf.ComplexList {
  public internalValue? : ServiceIpv4AclFeatureSequences[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): ServiceIpv4AclFeatureSequencesOutputReference {
    return new ServiceIpv4AclFeatureSequencesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature sdwan_service_ipv4_acl_feature}
*/
export class ServiceIpv4AclFeature extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a ServiceIpv4AclFeature resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ServiceIpv4AclFeature to import
  * @param importFromId The id of the existing ServiceIpv4AclFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ServiceIpv4AclFeature to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/resources/service_ipv4_acl_feature sdwan_service_ipv4_acl_feature} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ServiceIpv4AclFeatureConfig
  */
  public constructor(scope: Construct, id: string, config: ServiceIpv4AclFeatureConfig) {
    super(scope, id, {
  ...
  private _sequences = new ServiceIpv4AclFeatureSequencesList(this, "sequences", false);
  public get sequences() {
    return this._sequences;
  }
  public putSequences(value: ServiceIpv4AclFeatureSequences[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sequences: cdktf.listMapper(serviceIpv4AclFeatureSequencesToTerraform, false)(this._sequences.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sequences: {
        value: cdktf.listMapperHcl(serviceIpv4AclFeatureSequencesToHclTerraform, false)(this._sequences.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ServiceIpv4AclFeatureSequencesList",
      },
    };
