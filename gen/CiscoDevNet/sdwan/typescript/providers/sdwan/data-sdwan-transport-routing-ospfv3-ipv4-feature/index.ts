// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_routing_ospfv3_ipv4_feature
...
export interface DataSdwanTransportRoutingOspfv3Ipv4FeatureConfig extends cdktf.TerraformMetaArguments {
  /**
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_routing_ospfv3_ipv4_feature#feature_profile_id DataSdwanTransportRoutingOspfv3Ipv4Feature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The id of the Feature
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_routing_ospfv3_ipv4_feature#id DataSdwanTransportRoutingOspfv3Ipv4Feature#id}
  *
...
export interface DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasInterfaces {
}

export function dataSdwanTransportRoutingOspfv3Ipv4FeatureAreasInterfacesToTerraform(struct?: DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasInterfaces): any {
...
export function dataSdwanTransportRoutingOspfv3Ipv4FeatureAreasInterfacesToHclTerraform(struct?: DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasInterfaces): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasInterfacesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasInterfaces | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasInterfaces | undefined) {
    if (value === undefined) {
...
export class DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasInterfacesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasInterfacesOutputReference {
    return new DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasInterfacesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasRanges {
}

export function dataSdwanTransportRoutingOspfv3Ipv4FeatureAreasRangesToTerraform(struct?: DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasRanges): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataSdwanTransportRoutingOspfv3Ipv4FeatureAreasRangesToHclTerraform(struct?: DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasRanges): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasRangesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasRanges | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasRanges | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasRangesList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasRangesOutputReference {
    return new DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasRangesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataSdwanTransportRoutingOspfv3Ipv4FeatureAreas {
}

export function dataSdwanTransportRoutingOspfv3Ipv4FeatureAreasToTerraform(struct?: DataSdwanTransportRoutingOspfv3Ipv4FeatureAreas): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataSdwanTransportRoutingOspfv3Ipv4FeatureAreasToHclTerraform(struct?: DataSdwanTransportRoutingOspfv3Ipv4FeatureAreas): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSdwanTransportRoutingOspfv3Ipv4FeatureAreas | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSdwanTransportRoutingOspfv3Ipv4FeatureAreas | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _interfaces = new DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasInterfacesList(this, "interfaces", false);
  ...
  private _ranges = new DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasRangesList(this, "ranges", false);
  public get ranges() {
    return this._ranges;
  }
}

export class DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasOutputReference {
    return new DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataSdwanTransportRoutingOspfv3Ipv4FeatureRedistributes {
}

export function dataSdwanTransportRoutingOspfv3Ipv4FeatureRedistributesToTerraform(struct?: DataSdwanTransportRoutingOspfv3Ipv4FeatureRedistributes): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataSdwanTransportRoutingOspfv3Ipv4FeatureRedistributesToHclTerraform(struct?: DataSdwanTransportRoutingOspfv3Ipv4FeatureRedistributes): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSdwanTransportRoutingOspfv3Ipv4FeatureRedistributesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSdwanTransportRoutingOspfv3Ipv4FeatureRedistributes | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSdwanTransportRoutingOspfv3Ipv4FeatureRedistributes | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataSdwanTransportRoutingOspfv3Ipv4FeatureRedistributesList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataSdwanTransportRoutingOspfv3Ipv4FeatureRedistributesOutputReference {
    return new DataSdwanTransportRoutingOspfv3Ipv4FeatureRedistributesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_routing_ospfv3_ipv4_feature sdwan_transport_routing_ospfv3_ipv4_feature}
*/
export class DataSdwanTransportRoutingOspfv3Ipv4Feature extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sdwan_transport_routing_ospfv3_ipv4_feature";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataSdwanTransportRoutingOspfv3Ipv4Feature resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataSdwanTransportRoutingOspfv3Ipv4Feature to import
  * @param importFromId The id of the existing DataSdwanTransportRoutingOspfv3Ipv4Feature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_routing_ospfv3_ipv4_feature#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataSdwanTransportRoutingOspfv3Ipv4Feature to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sdwan_transport_routing_ospfv3_ipv4_feature", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_routing_ospfv3_ipv4_feature sdwan_transport_routing_ospfv3_ipv4_feature} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataSdwanTransportRoutingOspfv3Ipv4FeatureConfig
  */
  public constructor(scope: Construct, id: string, config: DataSdwanTransportRoutingOspfv3Ipv4FeatureConfig) {
    super(scope, id, {
  ...
  private _areas = new DataSdwanTransportRoutingOspfv3Ipv4FeatureAreasList(this, "areas", false);
  public get areas() {
    return this._areas;
  }
  ...
  private _redistributes = new DataSdwanTransportRoutingOspfv3Ipv4FeatureRedistributesList(this, "redistributes", false);
