// https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_wan_vpn_interface_gre_feature_associate_tracker_feature
...
export interface DataSdwanTransportWanVpnInterfaceGreFeatureAssociateTrackerFeatureConfig extends cdktf.TerraformMetaArguments {
  ...
  * Feature Profile ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_wan_vpn_interface_gre_feature_associate_tracker_feature#feature_profile_id DataSdwanTransportWanVpnInterfaceGreFeatureAssociateTrackerFeature#feature_profile_id}
  */
  readonly featureProfileId: string;
  /**
  * The id of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_wan_vpn_interface_gre_feature_associate_tracker_feature#id DataSdwanTransportWanVpnInterfaceGreFeatureAssociateTrackerFeature#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_wan_vpn_interface_gre_feature_associate_tracker_feature#transport_wan_vpn_feature_id DataSdwanTransportWanVpnInterfaceGreFeatureAssociateTrackerFeature#transport_wan_vpn_feature_id}
  */
  readonly transportWanVpnFeatureId: string;
  /**
  * Transport WAN VPN Interface GRE Feature ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_wan_vpn_interface_gre_feature_associate_tracker_feature#transport_wan_vpn_interface_gre_feature_id DataSdwanTransportWanVpnInterfaceGreFeatureAssociateTrackerFeature#transport_wan_vpn_interface_gre_feature_id}
  */
  readonly transportWanVpnInterfaceGreFeatureId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_wan_vpn_interface_gre_feature_associate_tracker_feature sdwan_transport_wan_vpn_interface_gre_feature_associate_tracker_feature}
*/
export class DataSdwanTransportWanVpnInterfaceGreFeatureAssociateTrackerFeature extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSdwanTransportWanVpnInterfaceGreFeatureAssociateTrackerFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_wan_vpn_interface_gre_feature_associate_tracker_feature#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/sdwan/0.8.1/docs/data-sources/transport_wan_vpn_interface_gre_feature_associate_tracker_feature sdwan_transport_wan_vpn_interface_gre_feature_associate_tracker_feature} Data Source
  *
  * @param scope The scope in which to define this construct
