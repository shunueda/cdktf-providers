// https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/filter
...
export interface FilterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/filter#app_scope_id Filter#app_scope_id}
  */
  readonly appScopeId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/filter#id Filter#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/filter#name Filter#name}
  */
  readonly name: string;
  /**
  * (Optional) When true, the filter is restricted to the ownership scope.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/filter#primary Filter#primary}
  */
  readonly primary?: boolean | cdktf.IResolvable;
  /**
  * (Optional) When true the filter provides a service for its scope. Must also be primary/scope restricted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/filter#public Filter#public}
  */
  readonly public?: boolean | cdktf.IResolvable;
  /**
  * JSON object representation of an inventory filter query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/filter#query Filter#query}
  */
  readonly query: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/filter tetration_filter}
*/
export class Filter extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "tetration_filter";
  ...
  * @param importFromId The id of the existing Filter that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/filter#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Filter to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "tetration_filter", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/filter tetration_filter} Resource
  *
  * @param scope The scope in which to define this construct
