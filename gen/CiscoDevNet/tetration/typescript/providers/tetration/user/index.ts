// https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/user
...
export interface UserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/user#app_scope_id User#app_scope_id}
  */
  readonly appScopeId?: string;
  /**
  * Email address associated with the user account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/user#email User#email}
  */
  readonly email: string;
  /**
  * If true, and an existing but disabled user with the same email exists they will be enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/user#enable_existing User#enable_existing}
  */
  readonly enableExisting?: boolean | cdktf.IResolvable;
  /**
  * Userʼs first name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/user#first_name User#first_name}
  */
  readonly firstName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/user#id User#id}
  *
  ...
  * Userʼs last name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/user#last_name User#last_name}
  */
  readonly lastName: string;
  /**
  * (Optional) A list of roles to be assigned to the user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/user#role_ids User#role_ids}
  */
  readonly roleIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/user tetration_user}
*/
export class User extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "tetration_user";
  ...
  * @param importFromId The id of the existing User that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/user#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the User to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "tetration_user", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/tetration/0.1.1/docs/resources/user tetration_user} Resource
  *
  * @param scope The scope in which to define this construct
