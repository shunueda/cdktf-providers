// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/update_device_management_address
...
export interface UpdateDeviceManagementAddressConfig extends cdktf.TerraformMetaArguments {
  ...
  * The device ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/update_device_management_address#device_id UpdateDeviceManagementAddress#device_id}
  */
  readonly deviceId: string;
  /**
  * New IP Address of the device to be Updated
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/update_device_management_address#new_ip UpdateDeviceManagementAddress#new_ip}
  */
  readonly newIp?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/update_device_management_address catalystcenter_update_device_management_address}
*/
export class UpdateDeviceManagementAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UpdateDeviceManagementAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/update_device_management_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/update_device_management_address catalystcenter_update_device_management_address} Resource
  *
  * @param scope The scope in which to define this construct
