// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_l3_virtual_network
...
export interface DataCatalystcenterFabricL3VirtualNetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_l3_virtual_network#virtual_network_name DataCatalystcenterFabricL3VirtualNetwork#virtual_network_name}
  */
  readonly virtualNetworkName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_l3_virtual_network catalystcenter_fabric_l3_virtual_network}
*/
export class DataCatalystcenterFabricL3VirtualNetwork extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterFabricL3VirtualNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_l3_virtual_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_l3_virtual_network catalystcenter_fabric_l3_virtual_network} Data Source
  *
  * @param scope The scope in which to define this construct
