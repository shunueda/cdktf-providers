// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit
...
export interface FabricL3HandoffIpTransitConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit#external_connectivity_ip_pool_name FabricL3HandoffIpTransit#external_connectivity_ip_pool_name}
  */
  readonly externalConnectivityIpPoolName?: string;
  /**
  * ID of the fabric this device belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit#fabric_id FabricL3HandoffIpTransit#fabric_id}
  */
  readonly fabricId: string;
  /**
  * Interface name of the layer 3 handoff ip transit
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit#interface_name FabricL3HandoffIpTransit#interface_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit#local_ip_address FabricL3HandoffIpTransit#local_ip_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit#local_ipv6_address FabricL3HandoffIpTransit#local_ipv6_address}
  */
  readonly localIpv6Address?: string;
  /**
  * Network device ID of the fabric device
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit#network_device_id FabricL3HandoffIpTransit#network_device_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit#remote_ip_address FabricL3HandoffIpTransit#remote_ip_address}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit#remote_ipv6_address FabricL3HandoffIpTransit#remote_ipv6_address}
  */
  ...
  *   - Range: `500`-`1440`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit#tcp_mss_adjustment FabricL3HandoffIpTransit#tcp_mss_adjustment}
  */
  readonly tcpMssAdjustment?: number;
  /**
  * ID of the transit network of the layer 3 handoff ip transit
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit#transit_network_id FabricL3HandoffIpTransit#transit_network_id}
  */
  readonly transitNetworkId: string;
  /**
  * Name of the virtual network associated with this fabric site
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit#virtual_network_name FabricL3HandoffIpTransit#virtual_network_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit#vlan_id FabricL3HandoffIpTransit#vlan_id}
  */
  readonly vlanId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit catalystcenter_fabric_l3_handoff_ip_transit}
*/
export class FabricL3HandoffIpTransit extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FabricL3HandoffIpTransit that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l3_handoff_ip_transit catalystcenter_fabric_l3_handoff_ip_transit} Resource
  *
  * @param scope The scope in which to define this construct
