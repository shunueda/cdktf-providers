// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery
...
export interface DiscoveryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#cdp_level Discovery#cdp_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#discovery_type Discovery#discovery_type}
  */
  readonly discoveryType: string;
  /**
  * Enable passwords of the devices to be discovered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#enable_password_list Discovery#enable_password_list}
  */
  readonly enablePasswordList?: string[];
  /**
  * A list of IDs, which must include SNMP credential and CLI credential.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#global_credential_id_list Discovery#global_credential_id_list}
  */
  readonly globalCredentialIdList?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#http_read_credential Discovery#http_read_credential}
  */
  readonly httpReadCredential?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#http_write_credential Discovery#http_write_credential}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#ip_address_list Discovery#ip_address_list}
  */
  readonly ipAddressList?: string;
  /**
  * A list of IP address ranges to exclude from the discovery.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#ip_filter_list Discovery#ip_filter_list}
  */
  readonly ipFilterList?: string[];
  /**
  * LLDP level to which neighbor devices to be discovered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#lldp_level Discovery#lldp_level}
  */
  readonly lldpLevel?: number;
  /**
  * A name of the discovery.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#name Discovery#name}
  */
  readonly name: string;
  /**
  * Port number for netconf as a string. It requires SSH protocol to work.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#netconf_port Discovery#netconf_port}
  */
  readonly netconfPort?: string;
  /**
  * Passwords of the devices to be discovered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#password_list Discovery#password_list}
  */
  ...
  *   - Default value: `None`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#preferred_mgmt_ip_method Discovery#preferred_mgmt_ip_method}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#protocol_order Discovery#protocol_order}
  */
  readonly protocolOrder: string;
  /**
  * Number of times to try establishing SSH/Telnet connection to a device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#retry Discovery#retry}
  */
  readonly retry?: number;
  /**
  * Auth passphrase for SNMP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#snmp_auth_passphrase Discovery#snmp_auth_passphrase}
  */
  ...
  *   - Choices: `SHA`, `MD5`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#snmp_auth_protocol Discovery#snmp_auth_protocol}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#snmp_mode Discovery#snmp_mode}
  */
  readonly snmpMode?: string;
  /**
  * Passphrase for SNMP privacy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#snmp_priv_passphrase Discovery#snmp_priv_passphrase}
  */
  ...
  *   - Choices: `DES`, `AES128`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#snmp_priv_protocol Discovery#snmp_priv_protocol}
  */
  readonly snmpPrivProtocol?: string;
  /**
  * SNMP RO community of the devices to be discovered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#snmp_ro_community Discovery#snmp_ro_community}
  */
  readonly snmpRoCommunity?: string;
  /**
  * Description for snmp_ro_community.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#snmp_ro_community_desc Discovery#snmp_ro_community_desc}
  */
  readonly snmpRoCommunityDesc?: string;
  /**
  * SNMP RW community of the devices to be discovered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#snmp_rw_community Discovery#snmp_rw_community}
  */
  readonly snmpRwCommunity?: string;
  /**
  * Description for snmp_rw_community
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#snmp_rw_community_desc Discovery#snmp_rw_community_desc}
  */
  readonly snmpRwCommunityDesc?: string;
  /**
  * SNMP username of the devices to be discovered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#snmp_user_name Discovery#snmp_user_name}
  */
  ...
  *   - Choices: `v2`, `v3`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#snmp_version Discovery#snmp_version}
  */
  readonly snmpVersion?: string;
  /**
  * Number of seconds to wait for each SSH/Telnet connection to a device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#timeout_seconds Discovery#timeout_seconds}
  */
  readonly timeoutSeconds?: number;
  /**
  * Usernames for the devices to be discovered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#user_name_list Discovery#user_name_list}
  */
  readonly userNameList?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery catalystcenter_discovery}
*/
export class Discovery extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Discovery that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/discovery catalystcenter_discovery} Resource
  *
  * @param scope The scope in which to define this construct
