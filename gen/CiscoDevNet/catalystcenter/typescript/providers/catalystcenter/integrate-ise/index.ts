// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/integrate_ise
...
export interface IntegrateIseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/integrate_ise#ise_instance_id IntegrateIse#ise_instance_id}
  */
  readonly iseInstanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/integrate_ise catalystcenter_integrate_ise}
*/
export class IntegrateIse extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrateIse that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/integrate_ise#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/integrate_ise catalystcenter_integrate_ise} Resource
  *
  * @param scope The scope in which to define this construct
