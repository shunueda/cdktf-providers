// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_vlan_to_ssid
...
export interface DataCatalystcenterFabricVlanToSsidConfig extends cdktf.TerraformMetaArguments {
  ...
  * Fabric ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_vlan_to_ssid#fabric_id DataCatalystcenterFabricVlanToSsid#fabric_id}
  */
  readonly fabricId: string;
  /**
  * The id of the object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_vlan_to_ssid#id DataCatalystcenterFabricVlanToSsid#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_vlan_to_ssid catalystcenter_fabric_vlan_to_ssid}
*/
export class DataCatalystcenterFabricVlanToSsid extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterFabricVlanToSsid that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_vlan_to_ssid#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_vlan_to_ssid catalystcenter_fabric_vlan_to_ssid} Data Source
  *
  * @param scope The scope in which to define this construct
