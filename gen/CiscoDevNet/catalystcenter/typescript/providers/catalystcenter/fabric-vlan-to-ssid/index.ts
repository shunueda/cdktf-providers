// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_vlan_to_ssid
...
export interface FabricVlanToSsidConfig extends cdktf.TerraformMetaArguments {
  ...
  * Fabric ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_vlan_to_ssid#fabric_id FabricVlanToSsid#fabric_id}
  */
  readonly fabricId: string;
  /**
  * List of VLAN to SSID mappings
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_vlan_to_ssid#mappings FabricVlanToSsid#mappings}
  */
...
export interface FabricVlanToSsidMappingsSsidDetails {
  ...
  * Name of the SSID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_vlan_to_ssid#name FabricVlanToSsid#name}
  */
  readonly name: string;
  /**
  * Represents the name of the Security Group. Example: Auditors, BYOD, Developers, etc.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_vlan_to_ssid#security_group_tag FabricVlanToSsid#security_group_tag}
  */
...
export interface FabricVlanToSsidMappings {
  ...
  * SSID Details
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_vlan_to_ssid#ssid_details FabricVlanToSsid#ssid_details}
  */
  readonly ssidDetails?: FabricVlanToSsidMappingsSsidDetails[] | cdktf.IResolvable;
  /**
  * VLAN Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_vlan_to_ssid#vlan_name FabricVlanToSsid#vlan_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_vlan_to_ssid catalystcenter_fabric_vlan_to_ssid}
*/
export class FabricVlanToSsid extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FabricVlanToSsid that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_vlan_to_ssid#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_vlan_to_ssid catalystcenter_fabric_vlan_to_ssid} Resource
  *
  * @param scope The scope in which to define this construct
