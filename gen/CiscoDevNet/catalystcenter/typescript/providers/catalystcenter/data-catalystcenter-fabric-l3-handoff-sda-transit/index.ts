// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/fabric_l3_handoff_sda_transit
...
export interface DataCatalystcenterFabricL3HandoffSdaTransitConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/fabric_l3_handoff_sda_transit#fabric_id DataCatalystcenterFabricL3HandoffSdaTransit#fabric_id}
  */
  readonly fabricId: string;
  /**
  * Network device ID of the fabric device
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/fabric_l3_handoff_sda_transit#network_device_id DataCatalystcenterFabricL3HandoffSdaTransit#network_device_id}
  */
  readonly networkDeviceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/fabric_l3_handoff_sda_transit catalystcenter_fabric_l3_handoff_sda_transit}
*/
export class DataCatalystcenterFabricL3HandoffSdaTransit extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterFabricL3HandoffSdaTransit that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/fabric_l3_handoff_sda_transit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/fabric_l3_handoff_sda_transit catalystcenter_fabric_l3_handoff_sda_transit} Data Source
  *
  * @param scope The scope in which to define this construct
