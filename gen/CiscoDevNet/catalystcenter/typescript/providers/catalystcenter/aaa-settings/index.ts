// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings
...
export interface AaaSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings#client_aaa_pan AaaSettings#client_aaa_pan}
  */
  readonly clientAaaPan?: string;
  /**
  * The server to use as a primary
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings#client_aaa_primary_server_ip AaaSettings#client_aaa_primary_server_ip}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings#client_aaa_protocol AaaSettings#client_aaa_protocol}
  */
  readonly clientAaaProtocol?: string;
  /**
  * The server to use as a secondary
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings#client_aaa_secondary_server_ip AaaSettings#client_aaa_secondary_server_ip}
  */
  ...
  *   - Choices: `AAA`, `ISE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings#client_aaa_server_type AaaSettings#client_aaa_server_type}
  */
  readonly clientAaaServerType?: string;
  /**
  * Only relevant for server type `ISE`, shared secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings#client_aaa_shared_secret AaaSettings#client_aaa_shared_secret}
  */
  readonly clientAaaSharedSecret?: string;
  /**
  * Administration Node. Required for ISE
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings#network_aaa_pan AaaSettings#network_aaa_pan}
  */
  readonly networkAaaPan?: string;
  /**
  * The server to use as a primary
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings#network_aaa_primary_server_ip AaaSettings#network_aaa_primary_server_ip}
  */
  ...
  *   - Choices: `RADIUS`, `TACACS`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings#network_aaa_protocol AaaSettings#network_aaa_protocol}
  */
  readonly networkAaaProtocol?: string;
  /**
  * The server to use as a secondary
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings#network_aaa_secondary_server_ip AaaSettings#network_aaa_secondary_server_ip}
  */
  ...
  *   - Choices: `AAA`, `ISE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings#network_aaa_server_type AaaSettings#network_aaa_server_type}
  */
  readonly networkAaaServerType?: string;
  /**
  * Only relevant for server type `ISE`, shared secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings#network_aaa_shared_secret AaaSettings#network_aaa_shared_secret}
  */
  readonly networkAaaSharedSecret?: string;
  /**
  * The site ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings#site_id AaaSettings#site_id}
  */
  readonly siteId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings catalystcenter_aaa_settings}
*/
export class AaaSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AaaSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/aaa_settings catalystcenter_aaa_settings} Resource
  *
  * @param scope The scope in which to define this construct
