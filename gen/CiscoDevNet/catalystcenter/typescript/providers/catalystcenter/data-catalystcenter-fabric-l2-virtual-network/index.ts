// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/fabric_l2_virtual_network
...
export interface DataCatalystcenterFabricL2VirtualNetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/fabric_l2_virtual_network#fabric_id DataCatalystcenterFabricL2VirtualNetwork#fabric_id}
  */
  readonly fabricId: string;
  /**
  * Name of the VLAN of the layer 2 virtual network. Must contain only alphanumeric characters, underscores, and hyphens
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/fabric_l2_virtual_network#vlan_name DataCatalystcenterFabricL2VirtualNetwork#vlan_name}
  */
  readonly vlanName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/fabric_l2_virtual_network catalystcenter_fabric_l2_virtual_network}
*/
export class DataCatalystcenterFabricL2VirtualNetwork extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterFabricL2VirtualNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/fabric_l2_virtual_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/fabric_l2_virtual_network catalystcenter_fabric_l2_virtual_network} Data Source
  *
  * @param scope The scope in which to define this construct
