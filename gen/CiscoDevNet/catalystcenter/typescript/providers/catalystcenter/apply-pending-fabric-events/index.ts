// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/apply_pending_fabric_events
...
export interface ApplyPendingFabricEventsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/apply_pending_fabric_events#event_id ApplyPendingFabricEvents#event_id}
  */
  readonly eventId?: string;
  /**
  * ID of the fabric (used as GET query parameter and as the Terraform resource ID).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/apply_pending_fabric_events#fabric_id ApplyPendingFabricEvents#fabric_id}
  */
  readonly fabricId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/apply_pending_fabric_events catalystcenter_apply_pending_fabric_events}
*/
export class ApplyPendingFabricEvents extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplyPendingFabricEvents that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/apply_pending_fabric_events#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/apply_pending_fabric_events catalystcenter_apply_pending_fabric_events} Resource
  *
  * @param scope The scope in which to define this construct
