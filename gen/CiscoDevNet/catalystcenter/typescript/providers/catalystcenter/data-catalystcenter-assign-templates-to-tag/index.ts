// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/assign_templates_to_tag
...
export interface DataCatalystcenterAssignTemplatesToTagConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/assign_templates_to_tag#tag_id DataCatalystcenterAssignTemplatesToTag#tag_id}
  */
  readonly tagId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/assign_templates_to_tag catalystcenter_assign_templates_to_tag}
*/
export class DataCatalystcenterAssignTemplatesToTag extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterAssignTemplatesToTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/assign_templates_to_tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/assign_templates_to_tag catalystcenter_assign_templates_to_tag} Data Source
  *
  * @param scope The scope in which to define this construct
