// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/assign_devices_to_tag
...
export interface AssignDevicesToTagConfig extends cdktf.TerraformMetaArguments {
  ...
  * Device Ids List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/assign_devices_to_tag#device_ids AssignDevicesToTag#device_ids}
  */
  readonly deviceIds?: string[];
  /**
  * Tag Id to be associated with the device
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/assign_devices_to_tag#tag_id AssignDevicesToTag#tag_id}
  */
  readonly tagId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/assign_devices_to_tag catalystcenter_assign_devices_to_tag}
*/
export class AssignDevicesToTag extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AssignDevicesToTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/assign_devices_to_tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/assign_devices_to_tag catalystcenter_assign_devices_to_tag} Resource
  *
  * @param scope The scope in which to define this construct
