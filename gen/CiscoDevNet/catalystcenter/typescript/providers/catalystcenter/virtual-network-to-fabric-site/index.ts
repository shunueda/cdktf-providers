// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/virtual_network_to_fabric_site
...
export interface VirtualNetworkToFabricSiteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/virtual_network_to_fabric_site#fabric_site_id VirtualNetworkToFabricSite#fabric_site_id}
  */
  readonly fabricSiteId: string;
  /**
  * ID of the Virtual Network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/virtual_network_to_fabric_site#virtual_network_id VirtualNetworkToFabricSite#virtual_network_id}
  */
  readonly virtualNetworkId: string;
  /**
  * Virtual Network Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/virtual_network_to_fabric_site#virtual_network_name VirtualNetworkToFabricSite#virtual_network_name}
  */
  readonly virtualNetworkName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/virtual_network_to_fabric_site catalystcenter_virtual_network_to_fabric_site}
*/
export class VirtualNetworkToFabricSite extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualNetworkToFabricSite that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/virtual_network_to_fabric_site#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/virtual_network_to_fabric_site catalystcenter_virtual_network_to_fabric_site} Resource
  *
  * @param scope The scope in which to define this construct
