// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/credentials_snmpv2_read
...
export interface CredentialsSnmpv2ReadConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/credentials_snmpv2_read#description CredentialsSnmpv2Read#description}
  */
  readonly description: string;
  /**
  * Read community
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/credentials_snmpv2_read#read_community CredentialsSnmpv2Read#read_community}
  */
  readonly readCommunity: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/credentials_snmpv2_read catalystcenter_credentials_snmpv2_read}
*/
export class CredentialsSnmpv2Read extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CredentialsSnmpv2Read that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/credentials_snmpv2_read#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/credentials_snmpv2_read catalystcenter_credentials_snmpv2_read} Resource
  *
  * @param scope The scope in which to define this construct
