// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/assign_managed_ap_locations
...
export interface AssignManagedApLocationsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Device Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/assign_managed_ap_locations#device_id AssignManagedApLocations#device_id}
  */
  readonly deviceId: string;
  /**
  * Site IDs of Primary Managed AP Locations
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/assign_managed_ap_locations#primary_managed_ap_locations_site_ids AssignManagedApLocations#primary_managed_ap_locations_site_ids}
  */
  readonly primaryManagedApLocationsSiteIds?: string[];
  /**
  * Site IDs of Secondary Managed AP Locations
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/assign_managed_ap_locations#secondary_managed_ap_locations_site_ids AssignManagedApLocations#secondary_managed_ap_locations_site_ids}
  */
  readonly secondaryManagedApLocationsSiteIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/assign_managed_ap_locations catalystcenter_assign_managed_ap_locations}
*/
export class AssignManagedApLocations extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AssignManagedApLocations that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/assign_managed_ap_locations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/assign_managed_ap_locations catalystcenter_assign_managed_ap_locations} Resource
  *
  * @param scope The scope in which to define this construct
