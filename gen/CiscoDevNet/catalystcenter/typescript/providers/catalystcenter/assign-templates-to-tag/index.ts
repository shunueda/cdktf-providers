// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/assign_templates_to_tag
...
export interface AssignTemplatesToTagConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/assign_templates_to_tag#tag_id AssignTemplatesToTag#tag_id}
  */
  readonly tagId: string;
  /**
  * Template Ids List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/assign_templates_to_tag#template_ids AssignTemplatesToTag#template_ids}
  */
  readonly templateIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/assign_templates_to_tag catalystcenter_assign_templates_to_tag}
*/
export class AssignTemplatesToTag extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AssignTemplatesToTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/assign_templates_to_tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/assign_templates_to_tag catalystcenter_assign_templates_to_tag} Resource
  *
  * @param scope The scope in which to define this construct
