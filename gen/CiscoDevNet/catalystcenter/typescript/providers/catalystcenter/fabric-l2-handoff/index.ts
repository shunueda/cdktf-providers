// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l2_handoff
...
export interface FabricL2HandoffConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l2_handoff#external_vlan_id FabricL2Handoff#external_vlan_id}
  */
  readonly externalVlanId: number;
  /**
  * ID of the fabric this device belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l2_handoff#fabric_id FabricL2Handoff#fabric_id}
  */
  readonly fabricId: string;
  /**
  * Interface name of the layer 2 handoff. E.g., GigabitEthernet1/0/4
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l2_handoff#interface_name FabricL2Handoff#interface_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l2_handoff#internal_vlan_id FabricL2Handoff#internal_vlan_id}
  */
  readonly internalVlanId: number;
  /**
  * Network device ID of the fabric device
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l2_handoff#network_device_id FabricL2Handoff#network_device_id}
  */
  readonly networkDeviceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l2_handoff catalystcenter_fabric_l2_handoff}
*/
export class FabricL2Handoff extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FabricL2Handoff that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l2_handoff#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/fabric_l2_handoff catalystcenter_fabric_l2_handoff} Resource
  *
  * @param scope The scope in which to define this construct
