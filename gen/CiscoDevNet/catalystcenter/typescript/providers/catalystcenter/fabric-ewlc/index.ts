// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_ewlc
...
export interface FabricEwlcConfig extends cdktf.TerraformMetaArguments {
  ...
  *   - Choices: `5`, `15`, `25`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_ewlc#ap_reboot_percentage FabricEwlc#ap_reboot_percentage}
  */
  readonly apRebootPercentage?: number;
  /**
  * Flag to enable or disable rolling AP upgrades
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_ewlc#enable_rolling_ap_upgrade FabricEwlc#enable_rolling_ap_upgrade}
  */
  readonly enableRollingApUpgrade?: boolean | cdktf.IResolvable;
  /**
  * Flag to enable or disable embedded wireless capabilities
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_ewlc#enable_wireless FabricEwlc#enable_wireless}
  */
  readonly enableWireless: boolean | cdktf.IResolvable;
  /**
  * Fabric Site ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_ewlc#fabric_id FabricEwlc#fabric_id}
  */
  readonly fabricId: string;
  /**
  * Network Device ID of the wireless capable switch
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_ewlc#network_device_id FabricEwlc#network_device_id}
  */
  readonly networkDeviceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_ewlc catalystcenter_fabric_ewlc}
*/
export class FabricEwlc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FabricEwlc that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_ewlc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_ewlc catalystcenter_fabric_ewlc} Resource
  *
  * @param scope The scope in which to define this construct
