// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway
...
export interface AnycastGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#auto_generate_vlan_name AnycastGateway#auto_generate_vlan_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#critical_pool AnycastGateway#critical_pool}
  */
  readonly criticalPool?: boolean | cdktf.IResolvable;
  /**
  * ID of the fabric to contain this anycast gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#fabric_id AnycastGateway#fabric_id}
  */
  readonly fabricId: string;
  /**
  * Enable/disable Group-Based Policy Enforcement (applicable only to INFRA_VN; defaults to false)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#group_based_policy_enforcement_enabled AnycastGateway#group_based_policy_enforcement_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#intra_subnet_routing_enabled AnycastGateway#intra_subnet_routing_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#ip_directed_broadcast AnycastGateway#ip_directed_broadcast}
  */
  readonly ipDirectedBroadcast?: boolean | cdktf.IResolvable;
  /**
  * Name of the IP pool associated with the anycast gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#ip_pool_name AnycastGateway#ip_pool_name}
  */
  readonly ipPoolName: string;
  /**
  * Enable/disable layer 2 flooding (not applicable to INFRA_VN)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#l2_flooding_enabled AnycastGateway#l2_flooding_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#multiple_ip_to_mac_addresses AnycastGateway#multiple_ip_to_mac_addresses}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#pool_type AnycastGateway#pool_type}
  */
  readonly poolType?: string;
  /**
  * Name of the associated Security Group (not applicable to INFRA_VN)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#security_group_name AnycastGateway#security_group_name}
  */
  readonly securityGroupName?: string;
  /**
  * Enable/disable Supplicant-Based Extended Node Onboarding (applicable only to INFRA_VN)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#supplicant_based_extended_node_onboarding AnycastGateway#supplicant_based_extended_node_onboarding}
  */
  ...
  *   - Range: `500`-`1440`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#tcp_mss_adjustment AnycastGateway#tcp_mss_adjustment}
  */
  ...
  *   - Choices: `DATA`, `VOICE`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#traffic_type AnycastGateway#traffic_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#virtual_network_name AnycastGateway#virtual_network_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#vlan_id AnycastGateway#vlan_id}
  */
  readonly vlanId?: number;
  /**
  * Name of the VLAN of the anycast gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#vlan_name AnycastGateway#vlan_name}
  */
  readonly vlanName?: string;
  /**
  * Enable/disable fabric-enabled wireless (not applicable to INFRA_VN)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#wireless_pool AnycastGateway#wireless_pool}
  */
  readonly wirelessPool?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway catalystcenter_anycast_gateway}
*/
export class AnycastGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AnycastGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/anycast_gateway catalystcenter_anycast_gateway} Resource
  *
  * @param scope The scope in which to define this construct
