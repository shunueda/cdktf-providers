// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/transit_network
...
export interface TransitNetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/transit_network#autonomous_system_number TransitNetwork#autonomous_system_number}
  */
  readonly autonomousSystemNumber?: string;
  /**
  * List of network device IDs that will be used as control plane nodes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/transit_network#control_plane_network_device_ids TransitNetwork#control_plane_network_device_ids}
  */
  readonly controlPlaneNetworkDeviceIds?: string[];
  /**
  * Set this to true to enable multicast over SD-Access transit
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/transit_network#is_multicast_over_transit_enabled TransitNetwork#is_multicast_over_transit_enabled}
  */
  readonly isMulticastOverTransitEnabled?: boolean | cdktf.IResolvable;
  /**
  * Transit Network Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/transit_network#name TransitNetwork#name}
  */
  ...
  *   - Choices: `BGP`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/transit_network#routing_protocol_name TransitNetwork#routing_protocol_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/transit_network#type TransitNetwork#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/transit_network catalystcenter_transit_network}
*/
export class TransitNetwork extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TransitNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/transit_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/transit_network catalystcenter_transit_network} Resource
  *
  * @param scope The scope in which to define this construct
