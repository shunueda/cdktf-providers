// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs
...
export interface CatalystcenterProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs#allow_existing_on_create CatalystcenterProvider#allow_existing_on_create}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs#insecure CatalystcenterProvider#insecure}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs#max_timeout CatalystcenterProvider#max_timeout}
  */
  readonly maxTimeout?: number;
  /**
  * Password for the Catalyst Center instance. This can also be set as the CC_PASSWORD environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs#password CatalystcenterProvider#password}
  */
  readonly password?: string;
  /**
  * Number of retries for REST API calls. This can also be set as the CC_RETRIES environment variable. Defaults to `3`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs#retries CatalystcenterProvider#retries}
  */
  readonly retries?: number;
  /**
  * URL of the Catalyst Center instance. This can also be set as the CC_URL environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs#url CatalystcenterProvider#url}
  */
  readonly url?: string;
  /**
  * Username for the Catalyst Center instance. This can also be set as the CC_USERNAME environment variable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs#username CatalystcenterProvider#username}
  */
  readonly username?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs#alias CatalystcenterProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs catalystcenter}
*/
export class CatalystcenterProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing CatalystcenterProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs catalystcenter} Resource
  *
  * @param scope The scope in which to define this construct
