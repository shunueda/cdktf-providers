// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/wireless_rf_profile
...
export interface DataCatalystcenterWirelessRfProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  * RF Profile Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/wireless_rf_profile#rf_profile_name DataCatalystcenterWirelessRfProfile#rf_profile_name}
  */
  readonly rfProfileName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/wireless_rf_profile catalystcenter_wireless_rf_profile}
*/
export class DataCatalystcenterWirelessRfProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterWirelessRfProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/wireless_rf_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/wireless_rf_profile catalystcenter_wireless_rf_profile} Data Source
  *
  * @param scope The scope in which to define this construct
