// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/provision_device
...
export interface ProvisionDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/provision_device#network_device_id ProvisionDevice#network_device_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/provision_device#reprovision ProvisionDevice#reprovision}
  */
  readonly reprovision?: boolean | cdktf.IResolvable;
  /**
  * ID of the site this network device needs to be provisioned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/provision_device#site_id ProvisionDevice#site_id}
  */
  readonly siteId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/provision_device catalystcenter_provision_device}
*/
export class ProvisionDevice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProvisionDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/provision_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/resources/provision_device catalystcenter_provision_device} Resource
  *
  * @param scope The scope in which to define this construct
