// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/anycast_gateway
...
export interface DataCatalystcenterAnycastGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/anycast_gateway#fabric_id DataCatalystcenterAnycastGateway#fabric_id}
  */
  readonly fabricId: string;
  /**
  * Name of the IP pool associated with the anycast gateway
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/anycast_gateway#ip_pool_name DataCatalystcenterAnycastGateway#ip_pool_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/anycast_gateway#virtual_network_name DataCatalystcenterAnycastGateway#virtual_network_name}
  */
  readonly virtualNetworkName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/anycast_gateway catalystcenter_anycast_gateway}
*/
export class DataCatalystcenterAnycastGateway extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterAnycastGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/anycast_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/anycast_gateway catalystcenter_anycast_gateway} Data Source
  *
  * @param scope The scope in which to define this construct
