// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_devices
...
export interface DataCatalystcenterFabricDevicesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_devices#fabric_id DataCatalystcenterFabricDevices#fabric_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_devices catalystcenter_fabric_devices}
*/
export class DataCatalystcenterFabricDevices extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterFabricDevices that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_devices#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/data-sources/fabric_devices catalystcenter_fabric_devices} Data Source
  *
  * @param scope The scope in which to define this construct
