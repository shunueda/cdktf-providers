// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_site
...
export interface FabricSiteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_site#authentication_profile_name FabricSite#authentication_profile_name}
  */
  readonly authenticationProfileName: string;
  /**
  * Specifies whether this fabric site will use pub/sub for control nodes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_site#pub_sub_enabled FabricSite#pub_sub_enabled}
  */
  readonly pubSubEnabled: boolean | cdktf.IResolvable;
  /**
  * ID of the network hierarchy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_site#site_id FabricSite#site_id}
  */
  readonly siteId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_site catalystcenter_fabric_site}
*/
export class FabricSite extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FabricSite that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_site#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/fabric_site catalystcenter_fabric_site} Resource
  *
  * @param scope The scope in which to define this construct
