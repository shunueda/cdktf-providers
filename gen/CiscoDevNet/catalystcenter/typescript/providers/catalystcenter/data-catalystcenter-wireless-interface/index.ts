// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/wireless_interface
...
export interface DataCatalystcenterWirelessInterfaceConfig extends cdktf.TerraformMetaArguments {
  ...
  * Interface Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/wireless_interface#interface_name DataCatalystcenterWirelessInterface#interface_name}
  */
  readonly interfaceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/wireless_interface catalystcenter_wireless_interface}
*/
export class DataCatalystcenterWirelessInterface extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterWirelessInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/wireless_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/wireless_interface catalystcenter_wireless_interface} Data Source
  *
  * @param scope The scope in which to define this construct
