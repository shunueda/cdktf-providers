// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/extranet_policy
...
export interface ExtranetPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/extranet_policy#extranet_policy_name ExtranetPolicy#extranet_policy_name}
  */
  readonly extranetPolicyName: string;
  /**
  * IDs of the fabric sites to be associated with this extranet policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/extranet_policy#fabric_ids ExtranetPolicy#fabric_ids}
  */
  readonly fabricIds?: string[];
  /**
  * Name of the existing provider virtual network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/extranet_policy#provider_virtual_network_name ExtranetPolicy#provider_virtual_network_name}
  */
  readonly providerVirtualNetworkName: string;
  /**
  * Name of the subscriber virtual networks
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/extranet_policy#subscriber_virtual_network_names ExtranetPolicy#subscriber_virtual_network_names}
  */
  readonly subscriberVirtualNetworkNames: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/extranet_policy catalystcenter_extranet_policy}
*/
export class ExtranetPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExtranetPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/extranet_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/extranet_policy catalystcenter_extranet_policy} Resource
  *
  * @param scope The scope in which to define this construct
