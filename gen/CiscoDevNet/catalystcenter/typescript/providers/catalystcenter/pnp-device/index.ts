// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/pnp_device
...
export interface PnpDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  * Device hostname
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/pnp_device#hostname PnpDevice#hostname}
  */
  readonly hostname: string;
  /**
  * Device product ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/pnp_device#pid PnpDevice#pid}
  */
  readonly pid: string;
  /**
  * Device serial number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/pnp_device#serial_number PnpDevice#serial_number}
  */
  readonly serialNumber: string;
  /**
  * Device is a stacked switch
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/pnp_device#stack PnpDevice#stack}
  */
  readonly stack?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/pnp_device catalystcenter_pnp_device}
*/
export class PnpDevice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PnpDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/pnp_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/pnp_device catalystcenter_pnp_device} Resource
  *
  * @param scope The scope in which to define this construct
