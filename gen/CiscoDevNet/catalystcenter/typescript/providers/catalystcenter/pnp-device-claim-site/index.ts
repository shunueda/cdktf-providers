// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site
...
export interface PnpDeviceClaimSiteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#config_id PnpDeviceClaimSite#config_id}
  */
  readonly configId?: string;
  /**
  * List of config (temaplate) parameters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#config_parameters PnpDeviceClaimSite#config_parameters}
  */
  readonly configParameters?: PnpDeviceClaimSiteConfigParameters[] | cdktf.IResolvable;
  /**
  * The device ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#device_id PnpDeviceClaimSite#device_id}
  */
  readonly deviceId: string;
  /**
  * Gateway IP. Required if `type` is `CatalystWLC` or `MobilityExpress`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#gateway PnpDeviceClaimSite#gateway}
  */
  readonly gateway?: string;
  /**
  * Image ID. Required if `type` is `Default` or `StackSwitch`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#image_id PnpDeviceClaimSite#image_id}
  */
  readonly imageId?: string;
  /**
  * Skip image provisioning.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#image_skip PnpDeviceClaimSite#image_skip}
  */
  readonly imageSkip?: boolean | cdktf.IResolvable;
  /**
  * IP interface name. Required for Catalyst 9800 WLC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#ip_interface_name PnpDeviceClaimSite#ip_interface_name}
  */
  readonly ipInterfaceName?: string;
  /**
  * RF profile. Required if `type` is `AccessPoint`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#rf_profile PnpDeviceClaimSite#rf_profile}
  */
  readonly rfProfile?: string;
  /**
  * Sensor profile. Required if `type` is `Sensor`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#sensor_profile PnpDeviceClaimSite#sensor_profile}
  */
  readonly sensorProfile?: string;
  /**
  * The site ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#site_id PnpDeviceClaimSite#site_id}
  */
  readonly siteId: string;
  /**
  * Static IP address. Required if `type` is `CatalystWLC` or `MobilityExpress`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#static_ip PnpDeviceClaimSite#static_ip}
  */
  readonly staticIp?: string;
  /**
  * Subnet mask. Required if `type` is `CatalystWLC` or `MobilityExpress`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#subnet_mask PnpDeviceClaimSite#subnet_mask}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#type PnpDeviceClaimSite#type}
  */
  readonly type: string;
  /**
  * Vlan ID. Required for Catalyst 9800 WLC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#vlan_id PnpDeviceClaimSite#vlan_id}
  */
...
export interface PnpDeviceClaimSiteConfigParameters {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#name PnpDeviceClaimSite#name}
  */
  readonly name: string;
  /**
  * Value of config parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#value PnpDeviceClaimSite#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site catalystcenter_pnp_device_claim_site}
*/
export class PnpDeviceClaimSite extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PnpDeviceClaimSite that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/pnp_device_claim_site catalystcenter_pnp_device_claim_site} Resource
  *
  * @param scope The scope in which to define this construct
