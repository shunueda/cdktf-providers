// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/sp_profile
...
export interface SpProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/sp_profile#model SpProfile#model}
  */
  readonly model: string;
  /**
  * The name of the SP profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/sp_profile#name SpProfile#name}
  */
  readonly name: string;
  /**
  * The WAN provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/sp_profile#wan_provider SpProfile#wan_provider}
  */
  readonly wanProvider: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/sp_profile catalystcenter_sp_profile}
*/
export class SpProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/sp_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/sp_profile catalystcenter_sp_profile} Resource
  *
  * @param scope The scope in which to define this construct
