// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/provision_devices
...
export interface ProvisionDevicesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/provision_devices#provision_devices ProvisionDevices#provision_devices}
  */
  readonly provisionDevices: ProvisionDevicesProvisionDevices[] | cdktf.IResolvable;
  /**
  * Site Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/provision_devices#site_id ProvisionDevices#site_id}
  */
...
export interface ProvisionDevicesProvisionDevices {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/provision_devices#network_device_id ProvisionDevices#network_device_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/provision_devices#reprovision ProvisionDevices#reprovision}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/provision_devices catalystcenter_provision_devices}
*/
export class ProvisionDevices extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProvisionDevices that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/provision_devices#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/resources/provision_devices catalystcenter_provision_devices} Resource
  *
  * @param scope The scope in which to define this construct
