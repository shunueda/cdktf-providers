// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/data-sources/assign_device_to_site
...
export interface DataCatalystcenterAssignDeviceToSiteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/data-sources/assign_device_to_site#site_id DataCatalystcenterAssignDeviceToSite#site_id}
  */
  readonly siteId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/data-sources/assign_device_to_site catalystcenter_assign_device_to_site}
*/
export class DataCatalystcenterAssignDeviceToSite extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterAssignDeviceToSite that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/data-sources/assign_device_to_site#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/data-sources/assign_device_to_site catalystcenter_assign_device_to_site} Data Source
  *
  * @param scope The scope in which to define this construct
