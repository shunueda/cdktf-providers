// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/assign_credentials
...
export interface DataCatalystcenterAssignCredentialsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/assign_credentials#id DataCatalystcenterAssignCredentials#id}
  *
  ...
  * The site ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/assign_credentials#site_id DataCatalystcenterAssignCredentials#site_id}
  */
  readonly siteId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/assign_credentials catalystcenter_assign_credentials}
*/
export class DataCatalystcenterAssignCredentials extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterAssignCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/assign_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/assign_credentials catalystcenter_assign_credentials} Data Source
  *
  * @param scope The scope in which to define this construct
