// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/device_detail
...
export interface DataCatalystcenterDeviceDetailConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/device_detail#id DataCatalystcenterDeviceDetail#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/device_detail catalystcenter_device_detail}
*/
export class DataCatalystcenterDeviceDetail extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterDeviceDetail that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/device_detail#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/device_detail catalystcenter_device_detail} Data Source
  *
  * @param scope The scope in which to define this construct
