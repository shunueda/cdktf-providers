// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_l3_handoff_sda_transit
...
export interface FabricL3HandoffSdaTransitConfig extends cdktf.TerraformMetaArguments {
  ...
  *   - Range: `0`-`2147483647`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_l3_handoff_sda_transit#affinity_id_decider FabricL3HandoffSdaTransit#affinity_id_decider}
  */
  ...
  *   - Range: `0`-`2147483647`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_l3_handoff_sda_transit#affinity_id_prime FabricL3HandoffSdaTransit#affinity_id_prime}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_l3_handoff_sda_transit#connected_to_internet FabricL3HandoffSdaTransit#connected_to_internet}
  */
  readonly connectedToInternet?: boolean | cdktf.IResolvable;
  /**
  * ID of the fabric this device is assigned to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_l3_handoff_sda_transit#fabric_id FabricL3HandoffSdaTransit#fabric_id}
  */
  readonly fabricId: string;
  /**
  * Set this true to configure native multicast over multiple sites that are connected to an sd-access transit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_l3_handoff_sda_transit#is_multicast_over_transit_enabled FabricL3HandoffSdaTransit#is_multicast_over_transit_enabled}
  */
  readonly isMulticastOverTransitEnabled?: boolean | cdktf.IResolvable;
  /**
  * Network device ID of the fabric device
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_l3_handoff_sda_transit#network_device_id FabricL3HandoffSdaTransit#network_device_id}
  */
  readonly networkDeviceId: string;
  /**
  * ID of the transit network of the layer 3 handoff sda transit
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_l3_handoff_sda_transit#transit_network_id FabricL3HandoffSdaTransit#transit_network_id}
  */
  readonly transitNetworkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_l3_handoff_sda_transit catalystcenter_fabric_l3_handoff_sda_transit}
*/
export class FabricL3HandoffSdaTransit extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FabricL3HandoffSdaTransit that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_l3_handoff_sda_transit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/fabric_l3_handoff_sda_transit catalystcenter_fabric_l3_handoff_sda_transit} Resource
  *
  * @param scope The scope in which to define this construct
