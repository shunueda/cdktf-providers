// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/credentials_snmpv2_write
...
export interface CredentialsSnmpv2WriteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/credentials_snmpv2_write#description CredentialsSnmpv2Write#description}
  */
  readonly description: string;
  /**
  * Write community
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/credentials_snmpv2_write#write_community CredentialsSnmpv2Write#write_community}
  */
  readonly writeCommunity: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/credentials_snmpv2_write catalystcenter_credentials_snmpv2_write}
*/
export class CredentialsSnmpv2Write extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CredentialsSnmpv2Write that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/credentials_snmpv2_write#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/credentials_snmpv2_write catalystcenter_credentials_snmpv2_write} Resource
  *
  * @param scope The scope in which to define this construct
