// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/extranet_policy
...
export interface DataCatalystcenterExtranetPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/extranet_policy#extranet_policy_name DataCatalystcenterExtranetPolicy#extranet_policy_name}
  */
  readonly extranetPolicyName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/extranet_policy catalystcenter_extranet_policy}
*/
export class DataCatalystcenterExtranetPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterExtranetPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/extranet_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.5/docs/data-sources/extranet_policy catalystcenter_extranet_policy} Data Source
  *
  * @param scope The scope in which to define this construct
