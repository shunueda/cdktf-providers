// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/dns_settings
...
export interface DataCatalystcenterDnsSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  * The site ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/dns_settings#site_id DataCatalystcenterDnsSettings#site_id}
  */
  readonly siteId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/dns_settings catalystcenter_dns_settings}
*/
export class DataCatalystcenterDnsSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterDnsSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/dns_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.3/docs/data-sources/dns_settings catalystcenter_dns_settings} Data Source
  *
  * @param scope The scope in which to define this construct
