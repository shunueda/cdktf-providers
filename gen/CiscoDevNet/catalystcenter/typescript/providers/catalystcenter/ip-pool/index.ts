// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/ip_pool
...
export interface IpPoolConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/ip_pool#address_space_dhcp_servers IpPool#address_space_dhcp_servers}
  */
  readonly addressSpaceDhcpServers?: string[];
  /**
  * The DNS server(s) for this subnet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/ip_pool#address_space_dns_servers IpPool#address_space_dns_servers}
  */
  readonly addressSpaceDnsServers?: string[];
  /**
  * The gateway IP address for this subnet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/ip_pool#address_space_gateway IpPool#address_space_gateway}
  */
  readonly addressSpaceGateway?: string;
  /**
  * The network mask component, as a decimal, for the CIDR notation of this subnet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/ip_pool#address_space_prefix_length IpPool#address_space_prefix_length}
  */
  readonly addressSpacePrefixLength: number;
  /**
  * The IP address component of the CIDR notation for this subnet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/ip_pool#address_space_subnet IpPool#address_space_subnet}
  */
  readonly addressSpaceSubnet: string;
  /**
  * The name for this global IP pool. Only letters, numbers, '-', '_', '.', and '/' are allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/ip_pool#name IpPool#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/ip_pool#pool_type IpPool#pool_type}
  */
  readonly poolType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/ip_pool catalystcenter_ip_pool}
*/
export class IpPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/ip_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/resources/ip_pool catalystcenter_ip_pool} Resource
  *
  * @param scope The scope in which to define this construct
