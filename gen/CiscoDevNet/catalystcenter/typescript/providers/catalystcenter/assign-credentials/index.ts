// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/assign_credentials
...
export interface AssignCredentialsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/assign_credentials#cli_id AssignCredentials#cli_id}
  */
  readonly cliId?: string;
  /**
  * The ID of the HTTP(S) Read credentials.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/assign_credentials#https_read_id AssignCredentials#https_read_id}
  */
  readonly httpsReadId?: string;
  /**
  * The ID of the HTTP(S) Write credentials.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/assign_credentials#https_write_id AssignCredentials#https_write_id}
  */
  readonly httpsWriteId?: string;
  /**
  * The site ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/assign_credentials#site_id AssignCredentials#site_id}
  */
  readonly siteId: string;
  /**
  * The ID of the SNMPv2c Read credentials.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/assign_credentials#snmp_v2_read_id AssignCredentials#snmp_v2_read_id}
  */
  readonly snmpV2ReadId?: string;
  /**
  * The ID of the SNMPv2c Write credentials.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/assign_credentials#snmp_v2_write_id AssignCredentials#snmp_v2_write_id}
  */
  readonly snmpV2WriteId?: string;
  /**
  * The ID of the SNMPv3 credentials.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/assign_credentials#snmp_v3_id AssignCredentials#snmp_v3_id}
  */
  readonly snmpV3Id?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/assign_credentials catalystcenter_assign_credentials}
*/
export class AssignCredentials extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AssignCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/assign_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.2/docs/resources/assign_credentials catalystcenter_assign_credentials} Resource
  *
  * @param scope The scope in which to define this construct
