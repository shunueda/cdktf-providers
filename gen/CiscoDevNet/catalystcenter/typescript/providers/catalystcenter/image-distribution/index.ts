// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/image_distribution
...
export interface ImageDistributionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/image_distribution#device_uuid ImageDistribution#device_uuid}
  */
  readonly deviceUuid?: string;
  /**
  * The UUID of the software image to copy. It could be obtained for example from `catalystcenter_image.id`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/image_distribution#image_uuid ImageDistribution#image_uuid}
  */
  readonly imageUuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/image_distribution catalystcenter_image_distribution}
*/
export class ImageDistribution extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImageDistribution that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/image_distribution#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.6/docs/resources/image_distribution catalystcenter_image_distribution} Resource
  *
  * @param scope The scope in which to define this construct
