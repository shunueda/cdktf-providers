// https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/banner_settings
...
export interface DataCatalystcenterBannerSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  * The site ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/banner_settings#site_id DataCatalystcenterBannerSettings#site_id}
  */
  readonly siteId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/banner_settings catalystcenter_banner_settings}
*/
export class DataCatalystcenterBannerSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCatalystcenterBannerSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/banner_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/catalystcenter/0.4.4/docs/data-sources/banner_settings catalystcenter_banner_settings} Data Source
  *
  * @param scope The scope in which to define this construct
