// https://registry.terraform.io/providers/ciscodevnet/ndfc/0.2.1/docs/resources/vpc_pair
...
export interface VpcPairConfig extends cdktf.TerraformMetaArguments {
  ...
  * Deploy vPC pair
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ndfc/0.2.1/docs/resources/vpc_pair#deploy VpcPair#deploy}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ndfc/0.2.1/docs/resources/vpc_pair#serial_numbers VpcPair#serial_numbers}
  */
  readonly serialNumbers: string[];
  /**
  * Set to true to use virtual peer link
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ndfc/0.2.1/docs/resources/vpc_pair#use_virtual_peerlink VpcPair#use_virtual_peerlink}
  */
  readonly useVirtualPeerlink: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ndfc/0.2.1/docs/resources/vpc_pair ndfc_vpc_pair}
*/
export class VpcPair extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcPair that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ndfc/0.2.1/docs/resources/vpc_pair#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ndfc/0.2.1/docs/resources/vpc_pair ndfc_vpc_pair} Resource
  *
  * @param scope The scope in which to define this construct
