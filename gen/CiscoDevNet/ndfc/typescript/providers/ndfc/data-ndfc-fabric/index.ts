// https://registry.terraform.io/providers/ciscodevnet/ndfc/0.2.1/docs/data-sources/fabric
...
export interface DataNdfcFabricConfig extends cdktf.TerraformMetaArguments {
  ...
  * Fabric name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ndfc/0.2.1/docs/data-sources/fabric#fabric_name DataNdfcFabric#fabric_name}
  */
  readonly fabricName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ndfc/0.2.1/docs/data-sources/fabric ndfc_fabric}
*/
export class DataNdfcFabric extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNdfcFabric that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ndfc/0.2.1/docs/data-sources/fabric#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ndfc/0.2.1/docs/data-sources/fabric ndfc_fabric} Data Source
  *
  * @param scope The scope in which to define this construct
