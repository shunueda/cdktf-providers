// https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/spoke_vpc
...
export interface SpokeVpcConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/spoke_vpc#id SpokeVpc#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/spoke_vpc#service_vpc_id SpokeVpc#service_vpc_id}
  */
  readonly serviceVpcId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/spoke_vpc#spoke_vpc_csp_account_name SpokeVpc#spoke_vpc_csp_account_name}
  */
  readonly spokeVpcCspAccountName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/spoke_vpc#spoke_vpc_id SpokeVpc#spoke_vpc_id}
  */
  readonly spokeVpcId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/spoke_vpc#spoke_vpc_region SpokeVpc#spoke_vpc_region}
  */
  readonly spokeVpcRegion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/spoke_vpc#transit_gateway_attachment_subnets SpokeVpc#transit_gateway_attachment_subnets}
  */
  readonly transitGatewayAttachmentSubnets?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/spoke_vpc ciscomcd_spoke_vpc}
*/
export class SpokeVpc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpokeVpc that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/spoke_vpc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/spoke_vpc ciscomcd_spoke_vpc} Resource
  *
  * @param scope The scope in which to define this construct
