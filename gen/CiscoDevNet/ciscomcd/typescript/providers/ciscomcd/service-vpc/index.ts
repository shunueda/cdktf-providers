// https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc
...
export interface ServiceVpcConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#attachment_type ServiceVpc#attachment_type}
  */
  readonly attachmentType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#availability_zones ServiceVpc#availability_zones}
  */
  readonly availabilityZones: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#azure_resource_group ServiceVpc#azure_resource_group}
  */
  readonly azureResourceGroup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#cidr ServiceVpc#cidr}
  */
  readonly cidr: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#core_network_id ServiceVpc#core_network_id}
  */
  readonly coreNetworkId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#csp_account_name ServiceVpc#csp_account_name}
  */
  readonly cspAccountName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#id ServiceVpc#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#management_cidr ServiceVpc#management_cidr}
  */
  readonly managementCidr?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#name ServiceVpc#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#network_function_group ServiceVpc#network_function_group}
  */
  readonly networkFunctionGroup?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#region ServiceVpc#region}
  */
  readonly region: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#transit_gateway_id ServiceVpc#transit_gateway_id}
  */
  readonly transitGatewayId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#use_nat_gateway ServiceVpc#use_nat_gateway}
  */
  readonly useNatGateway?: boolean | cdktf.IResolvable;
  /**
  * azure_vwan_details block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#azure_vwan_details ServiceVpc#azure_vwan_details}
  */
  readonly azureVwanDetails?: ServiceVpcAzureVwanDetails[] | cdktf.IResolvable;
}
export interface ServiceVpcAzureVwanDetails {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#propagate_cidrs ServiceVpc#propagate_cidrs}
  */
  readonly propagateCidrs?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#spokevpc_cidrs ServiceVpc#spokevpc_cidrs}
  */
  readonly spokevpcCidrs?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#vhub_association_route_table_id ServiceVpc#vhub_association_route_table_id}
  */
  readonly vhubAssociationRouteTableId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#vhub_name ServiceVpc#vhub_name}
  */
  readonly vhubName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#vhub_propagation_route_table_ids ServiceVpc#vhub_propagation_route_table_ids}
  */
  readonly vhubPropagationRouteTableIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#vhub_resource_group ServiceVpc#vhub_resource_group}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc ciscomcd_service_vpc}
*/
export class ServiceVpc extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "ciscomcd_service_vpc";
  ...
  * @param importFromId The id of the existing ServiceVpc that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ServiceVpc to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "ciscomcd_service_vpc", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/service_vpc ciscomcd_service_vpc} Resource
  *
  * @param scope The scope in which to define this construct
