// https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules
...
export interface PolicyRulesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#id PolicyRules#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#rule_set_id PolicyRules#rule_set_id}
  */
  readonly ruleSetId: number;
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#rule PolicyRules#rule}
  */
  readonly rule?: PolicyRulesRule[] | cdktf.IResolvable;
}
export interface PolicyRulesRule {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#action PolicyRules#action}
  */
  readonly action: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#anti_malware_profile PolicyRules#anti_malware_profile}
  */
  readonly antiMalwareProfile?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#anti_virus_profile PolicyRules#anti_virus_profile}
  */
  readonly antiVirusProfile?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#description PolicyRules#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#destination PolicyRules#destination}
  */
  readonly destination?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#dlp_profile PolicyRules#dlp_profile}
  */
  readonly dlpProfile?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#fqdn_filter_profile PolicyRules#fqdn_filter_profile}
  */
  readonly fqdnFilterProfile?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#fqdn_match_profile PolicyRules#fqdn_match_profile}
  */
  readonly fqdnMatchProfile?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#malicious_ip_profile PolicyRules#malicious_ip_profile}
  */
  readonly maliciousIpProfile?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#malicious_src_profile PolicyRules#malicious_src_profile}
  */
  readonly maliciousSrcProfile?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#name PolicyRules#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#network_intrusion_profile PolicyRules#network_intrusion_profile}
  */
  readonly networkIntrusionProfile?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#packet_capture_enabled PolicyRules#packet_capture_enabled}
  */
  readonly packetCaptureEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#send_deny_reset PolicyRules#send_deny_reset}
  */
  readonly sendDenyReset?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#service PolicyRules#service}
  */
  readonly service: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#source PolicyRules#source}
  */
  readonly source?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#state PolicyRules#state}
  */
  readonly state?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#type PolicyRules#type}
  */
  readonly type: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#url_filter PolicyRules#url_filter}
  */
  readonly urlFilter?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#web_protection_profile PolicyRules#web_protection_profile}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules ciscomcd_policy_rules}
*/
export class PolicyRules extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "ciscomcd_policy_rules";
  ...
  * @param importFromId The id of the existing PolicyRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the PolicyRules to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "ciscomcd_policy_rules", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/policy_rules ciscomcd_policy_rules} Resource
  *
  * @param scope The scope in which to define this construct
