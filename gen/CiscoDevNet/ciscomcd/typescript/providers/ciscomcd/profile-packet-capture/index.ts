// https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/profile_packet_capture
...
export interface ProfilePacketCaptureConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/profile_packet_capture#azure_blob_container_name ProfilePacketCapture#azure_blob_container_name}
  */
  readonly azureBlobContainerName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/profile_packet_capture#azure_storage_access_key ProfilePacketCapture#azure_storage_access_key}
  */
  readonly azureStorageAccessKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/profile_packet_capture#azure_storage_accnt_name ProfilePacketCapture#azure_storage_accnt_name}
  */
  readonly azureStorageAccntName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/profile_packet_capture#csp_account ProfilePacketCapture#csp_account}
  */
  readonly cspAccount: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/profile_packet_capture#description ProfilePacketCapture#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/profile_packet_capture#id ProfilePacketCapture#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/profile_packet_capture#name ProfilePacketCapture#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/profile_packet_capture#storage_upload_path ProfilePacketCapture#storage_upload_path}
  */
  readonly storageUploadPath?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/profile_packet_capture ciscomcd_profile_packet_capture}
*/
export class ProfilePacketCapture extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProfilePacketCapture that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/profile_packet_capture#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ciscomcd/25.9.2/docs/resources/profile_packet_capture ciscomcd_profile_packet_capture} Resource
  *
  * @param scope The scope in which to define this construct
