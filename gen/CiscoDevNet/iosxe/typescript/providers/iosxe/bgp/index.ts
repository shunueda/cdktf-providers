// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp
...
export interface BgpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp#asn Bgp#asn}
  */
  readonly asn: string;
  /**
  * Graceful restart capability parameters
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp#bgp_graceful_restart Bgp#bgp_graceful_restart}
  */
  ...
  *   - Range: `1`-`3600`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp#bgp_update_delay Bgp#bgp_update_delay}
  */
  readonly bgpUpdateDelay?: number;
  /**
  * Activate ipv4-unicast for a peer by default
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp#default_ipv4_unicast Bgp#default_ipv4_unicast}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp#delete_mode Bgp#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp#device Bgp#device}
  */
  readonly device?: string;
  /**
  * Log neighbor up/down and reset reason
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp#log_neighbor_changes Bgp#log_neighbor_changes}
  */
  readonly logNeighborChanges?: boolean | cdktf.IResolvable;
  /**
  * Manually configured router identifier
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp#router_id_ip Bgp#router_id_ip}
  */
  ...
  *   - Range: `0`-`2147483647`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp#router_id_loopback Bgp#router_id_loopback}
  */
  readonly routerIdLoopback?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp iosxe_bgp}
*/
export class Bgp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Bgp that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp iosxe_bgp} Resource
  *
  * @param scope The scope in which to define this construct
