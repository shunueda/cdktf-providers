// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/evpn_profile
...
export interface EvpnProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/evpn_profile#delete_mode EvpnProfile#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/evpn_profile#device EvpnProfile#device}
  */
  ...
  *   - Range: `0`-`65535`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/evpn_profile#evi_base EvpnProfile#evi_base}
  */
  ...
  *   - Range: `4096`-`16777215`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/evpn_profile#l2vni_base EvpnProfile#l2vni_base}
  */
  readonly l2VniBase?: number;
  /**
  * EVPN L2 profile name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/evpn_profile#name EvpnProfile#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/evpn_profile iosxe_evpn_profile}
*/
export class EvpnProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EvpnProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/evpn_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/evpn_profile iosxe_evpn_profile} Resource
  *
  * @param scope The scope in which to define this construct
