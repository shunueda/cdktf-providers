// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_ipv6_unicast_neighbor
...
export interface DataIosxeBgpIpv6UnicastNeighborConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_ipv6_unicast_neighbor#asn DataIosxeBgpIpv6UnicastNeighbor#asn}
  */
  readonly asn: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_ipv6_unicast_neighbor#device DataIosxeBgpIpv6UnicastNeighbor#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_ipv6_unicast_neighbor#ip DataIosxeBgpIpv6UnicastNeighbor#ip}
  */
  readonly ip: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_ipv6_unicast_neighbor iosxe_bgp_ipv6_unicast_neighbor}
*/
export class DataIosxeBgpIpv6UnicastNeighbor extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeBgpIpv6UnicastNeighbor that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_ipv6_unicast_neighbor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_ipv6_unicast_neighbor iosxe_bgp_ipv6_unicast_neighbor} Data Source
  *
  * @param scope The scope in which to define this construct
