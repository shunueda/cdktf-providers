// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/spanning_tree
...
export interface DataIosxeSpanningTreeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/spanning_tree#device DataIosxeSpanningTree#device}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/spanning_tree iosxe_spanning_tree}
*/
export class DataIosxeSpanningTree extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeSpanningTree that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/spanning_tree#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/spanning_tree iosxe_spanning_tree} Data Source
  *
  * @param scope The scope in which to define this construct
