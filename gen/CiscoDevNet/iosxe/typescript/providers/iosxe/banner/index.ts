// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/banner
...
export interface BannerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/banner#delete_mode Banner#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/banner#device Banner#device}
  */
  readonly device?: string;
  /**
  * Banner message
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/banner#exec_banner Banner#exec_banner}
  */
  readonly execBanner?: string;
  /**
  * Banner message
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/banner#login_banner Banner#login_banner}
  */
  readonly loginBanner?: string;
  /**
  * Banner message
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/banner#motd_banner Banner#motd_banner}
  */
  readonly motdBanner?: string;
  /**
  * Banner message
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/banner#prompt_timeout_banner Banner#prompt_timeout_banner}
  */
  readonly promptTimeoutBanner?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/banner iosxe_banner}
*/
export class Banner extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Banner that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/banner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/banner iosxe_banner} Resource
  *
  * @param scope The scope in which to define this construct
