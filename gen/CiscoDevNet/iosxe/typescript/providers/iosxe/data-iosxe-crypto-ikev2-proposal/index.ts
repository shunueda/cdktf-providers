// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/data-sources/crypto_ikev2_proposal
...
export interface DataIosxeCryptoIkev2ProposalConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/data-sources/crypto_ikev2_proposal#device DataIosxeCryptoIkev2Proposal#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/data-sources/crypto_ikev2_proposal#name DataIosxeCryptoIkev2Proposal#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/data-sources/crypto_ikev2_proposal iosxe_crypto_ikev2_proposal}
*/
export class DataIosxeCryptoIkev2Proposal extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeCryptoIkev2Proposal that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/data-sources/crypto_ikev2_proposal#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/data-sources/crypto_ikev2_proposal iosxe_crypto_ikev2_proposal} Data Source
  *
  * @param scope The scope in which to define this construct
