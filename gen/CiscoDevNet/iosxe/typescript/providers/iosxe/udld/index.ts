// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/udld
...
export interface UdldConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/udld#aggressive Udld#aggressive}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/udld#delete_mode Udld#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/udld#device Udld#device}
  */
  readonly device?: string;
  /**
  * Enable UDLD protocol on fiber ports except where locally configured
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/udld#enable Udld#enable}
  */
  ...
  *   - Range: `1`-`90`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/udld#message_time Udld#message_time}
  */
  ...
  *   - Range: `30`-`86400`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/udld#recovery_interval Udld#recovery_interval}
  */
  readonly recoveryInterval?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/udld iosxe_udld}
*/
export class Udld extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Udld that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/udld#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/udld iosxe_udld} Resource
  *
  * @param scope The scope in which to define this construct
