// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2
...
export interface CryptoIkev2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2#delete_mode CryptoIkev2#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2#device CryptoIkev2#device}
  */
  ...
  *   - Range: `10`-`3600`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2#dpd CryptoIkev2#dpd}
  */
  readonly dpd?: number;
  /**
  * 
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2#dpd_query CryptoIkev2#dpd_query}
  */
  ...
  *   - Range: `2`-`60`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2#dpd_retry_interval CryptoIkev2#dpd_retry_interval}
  */
  readonly dpdRetryInterval?: number;
  /**
  * Enable certificate lookup based on HTTP-based URL
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2#http_url_cert CryptoIkev2#http_url_cert}
  */
  ...
  *   - Range: `5`-`3600`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2#nat_keepalive CryptoIkev2#nat_keepalive}
  */
  readonly natKeepalive?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2 iosxe_crypto_ikev2}
*/
export class CryptoIkev2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CryptoIkev2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2 iosxe_crypto_ikev2} Resource
  *
  * @param scope The scope in which to define this construct
