// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto
...
export interface CryptoConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto#device Crypto#device}
  */
  readonly device?: string;
  /**
  * Allow weak crypto to be configured
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto#engine_compliance_shield_disable Crypto#engine_compliance_shield_disable}
  */
  readonly engineComplianceShieldDisable?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto iosxe_crypto}
*/
export class Crypto extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Crypto that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto iosxe_crypto} Resource
  *
  * @param scope The scope in which to define this construct
