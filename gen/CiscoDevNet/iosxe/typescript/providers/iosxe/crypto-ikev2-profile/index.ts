// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile
...
export interface CryptoIkev2ProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  * Pre-Shared Key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#authentication_local_pre_share CryptoIkev2Profile#authentication_local_pre_share}
  */
  readonly authenticationLocalPreShare?: boolean | cdktf.IResolvable;
  /**
  * Pre-Shared Key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#authentication_remote_pre_share CryptoIkev2Profile#authentication_remote_pre_share}
  */
  readonly authenticationRemotePreShare?: boolean | cdktf.IResolvable;
  /**
  * enable config-exchange request
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#config_exchange_request CryptoIkev2Profile#config_exchange_request}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#delete_mode CryptoIkev2Profile#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * Specify a description of this profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#description CryptoIkev2Profile#description}
  */
  readonly description?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#device CryptoIkev2Profile#device}
  */
  ...
  *   - Range: `10`-`3600`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#dpd_interval CryptoIkev2Profile#dpd_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#dpd_query CryptoIkev2Profile#dpd_query}
  */
  ...
  *   - Range: `2`-`60`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#dpd_retry CryptoIkev2Profile#dpd_retry}
  */
  readonly dpdRetry?: number;
  /**
  * address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#identity_local_address CryptoIkev2Profile#identity_local_address}
  */
  readonly identityLocalAddress?: string;
  /**
  * key-id opaque string - proprietary types of identification key-id string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#identity_local_key_id CryptoIkev2Profile#identity_local_key_id}
  */
  readonly identityLocalKeyId?: string;
  /**
  * I-VRF of the profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#ivrf CryptoIkev2Profile#ivrf}
  */
  readonly ivrf?: string;
  /**
  * Keyring name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#keyring_local CryptoIkev2Profile#keyring_local}
  */
  readonly keyringLocal?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#match_address_local_ip CryptoIkev2Profile#match_address_local_ip}
  */
  readonly matchAddressLocalIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#match_fvrf CryptoIkev2Profile#match_fvrf}
  */
  readonly matchFvrf?: string;
  /**
  * Any fvrf
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#match_fvrf_any CryptoIkev2Profile#match_fvrf_any}
  */
  readonly matchFvrfAny?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#match_identity_remote_ipv4_addresses CryptoIkev2Profile#match_identity_remote_ipv4_addresses}
  */
  readonly matchIdentityRemoteIpv4Addresses?: CryptoIkev2ProfileMatchIdentityRemoteIpv4Addresses[] | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#match_identity_remote_ipv6_prefixes CryptoIkev2Profile#match_identity_remote_ipv6_prefixes}
  */
  readonly matchIdentityRemoteIpv6Prefixes?: string[];
  /**
  * key-id opaque string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#match_identity_remote_keys CryptoIkev2Profile#match_identity_remote_keys}
  */
  readonly matchIdentityRemoteKeys?: string[];
  /**
  * Match the profile for incoming connections only
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#match_inbound_only CryptoIkev2Profile#match_inbound_only}
  */
  readonly matchInboundOnly?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#name CryptoIkev2Profile#name}
  */
  readonly name: string;
}
export interface CryptoIkev2ProfileMatchIdentityRemoteIpv4Addresses {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#address CryptoIkev2Profile#address}
  */
  readonly address: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#mask CryptoIkev2Profile#mask}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile iosxe_crypto_ikev2_profile}
*/
export class CryptoIkev2Profile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CryptoIkev2Profile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ikev2_profile iosxe_crypto_ikev2_profile} Resource
  *
  * @param scope The scope in which to define this construct
