// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/platform
...
export interface PlatformConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/platform#device Platform#device}
  */
  readonly device?: string;
  /**
  * Disable IOSXE kernel core generation for keepalive fault
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/platform#punt_keepalive_disable_kernel_core Platform#punt_keepalive_disable_kernel_core}
  */
  ...
  *   - Range: `15`-`60`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/platform#punt_keepalive_settings_fatal_count Platform#punt_keepalive_settings_fatal_count}
  */
  ...
  *   - Range: `2`-`30`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/platform#punt_keepalive_settings_transmit_interval Platform#punt_keepalive_settings_transmit_interval}
  */
  ...
  *   - Range: `10`-`60`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/platform#punt_keepalive_settings_warning_count Platform#punt_keepalive_settings_warning_count}
  */
  readonly puntKeepaliveSettingsWarningCount?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/platform iosxe_platform}
*/
export class Platform extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Platform that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/platform#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/platform iosxe_platform} Resource
  *
  * @param scope The scope in which to define this construct
