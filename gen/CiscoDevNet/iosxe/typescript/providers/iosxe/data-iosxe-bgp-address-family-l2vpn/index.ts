// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/data-sources/bgp_address_family_l2vpn
...
export interface DataIosxeBgpAddressFamilyL2VpnConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/data-sources/bgp_address_family_l2vpn#af_name DataIosxeBgpAddressFamilyL2Vpn#af_name}
  */
  readonly afName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/data-sources/bgp_address_family_l2vpn#asn DataIosxeBgpAddressFamilyL2Vpn#asn}
  */
  readonly asn: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/data-sources/bgp_address_family_l2vpn#device DataIosxeBgpAddressFamilyL2Vpn#device}
  */
  readonly device?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/data-sources/bgp_address_family_l2vpn iosxe_bgp_address_family_l2vpn}
*/
export class DataIosxeBgpAddressFamilyL2Vpn extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeBgpAddressFamilyL2Vpn that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/data-sources/bgp_address_family_l2vpn#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/data-sources/bgp_address_family_l2vpn iosxe_bgp_address_family_l2vpn} Data Source
  *
  * @param scope The scope in which to define this construct
