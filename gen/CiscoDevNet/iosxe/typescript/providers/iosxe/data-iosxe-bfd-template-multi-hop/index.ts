// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/data-sources/bfd_template_multi_hop
...
export interface DataIosxeBfdTemplateMultiHopConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/data-sources/bfd_template_multi_hop#device DataIosxeBfdTemplateMultiHop#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/data-sources/bfd_template_multi_hop#name DataIosxeBfdTemplateMultiHop#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/data-sources/bfd_template_multi_hop iosxe_bfd_template_multi_hop}
*/
export class DataIosxeBfdTemplateMultiHop extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeBfdTemplateMultiHop that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/data-sources/bfd_template_multi_hop#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/data-sources/bfd_template_multi_hop iosxe_bfd_template_multi_hop} Data Source
  *
  * @param scope The scope in which to define this construct
