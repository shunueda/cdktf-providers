// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/crypto_ipsec_transform_set
...
export interface DataIosxeCryptoIpsecTransformSetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/crypto_ipsec_transform_set#device DataIosxeCryptoIpsecTransformSet#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/crypto_ipsec_transform_set#name DataIosxeCryptoIpsecTransformSet#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/crypto_ipsec_transform_set iosxe_crypto_ipsec_transform_set}
*/
export class DataIosxeCryptoIpsecTransformSet extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/crypto_ipsec_transform_set iosxe_crypto_ipsec_transform_set} Data Source
  *
  * @param scope The scope in which to define this construct
