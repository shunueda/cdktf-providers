// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan
...
export interface VlanConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan#device Vlan#device}
  */
  readonly device?: string;
  /**
  * Ascii name of the VLAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan#name Vlan#name}
  */
  readonly name?: string;
  /**
  * Configure association between private VLANs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan#private_vlan_association Vlan#private_vlan_association}
  */
  readonly privateVlanAssociation?: string;
  /**
  * Configure the VLAN as a community private VLAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan#private_vlan_community Vlan#private_vlan_community}
  */
  readonly privateVlanCommunity?: boolean | cdktf.IResolvable;
  /**
  * Configure the VLAN as an isolated private VLAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan#private_vlan_isolated Vlan#private_vlan_isolated}
  */
  readonly privateVlanIsolated?: boolean | cdktf.IResolvable;
  /**
  * Configure the VLAN as a primary private VLAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan#private_vlan_primary Vlan#private_vlan_primary}
  */
  readonly privateVlanPrimary?: boolean | cdktf.IResolvable;
  /**
  * Configure as Remote SPAN VLAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan#remote_span Vlan#remote_span}
  */
  readonly remoteSpan?: boolean | cdktf.IResolvable;
  /**
  * Shutdown VLAN switching
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan#shutdown Vlan#shutdown}
  */
  ...
  *   - Range: `1`-`4094`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan#vlan_id Vlan#vlan_id}
  */
  readonly vlanId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan iosxe_vlan}
*/
export class Vlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Vlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan iosxe_vlan} Resource
  *
  * @param scope The scope in which to define this construct
