// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/cli
...
export interface CliConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/cli#cli Cli#cli}
  */
  readonly cli: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/cli#device Cli#device}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/cli#raw Cli#raw}
  */
  readonly raw?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/cli iosxe_cli}
*/
export class Cli extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cli that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/cli#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/cli iosxe_cli} Resource
  *
  * @param scope The scope in which to define this construct
