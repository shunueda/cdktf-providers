// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp
...
export interface CdpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp#device Cdp#device}
  */
  readonly device?: string;
  /**
  * Apply tlv-list globally
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp#filter_tlv_list Cdp#filter_tlv_list}
  */
  ...
  *   - Range: `10`-`255`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp#holdtime Cdp#holdtime}
  */
  readonly holdtime?: number;
  /**
  * Enable CDP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp#run Cdp#run}
  */
  ...
  *   - Range: `5`-`254`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp#timer Cdp#timer}
  */
  readonly timer?: number;
  /**
  * Configure tlv-list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp#tlv_lists Cdp#tlv_lists}
  */
...
export interface CdpTlvLists {
  ...
  * Select cos TLV
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp#cos Cdp#cos}
  */
  readonly cos?: boolean | cdktf.IResolvable;
  /**
  * Select duplex TLV
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp#duplex Cdp#duplex}
  */
  readonly duplex?: boolean | cdktf.IResolvable;
  /**
  * Tlv-list
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp#name Cdp#name}
  */
  readonly name: string;
  /**
  * Select trust TLV
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp#trust Cdp#trust}
  */
  readonly trust?: boolean | cdktf.IResolvable;
  /**
  * Select version TLV
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp#version Cdp#version}
  */
  readonly version?: boolean | cdktf.IResolvable;
  /**
  * Select vtp mgmt domain TLV
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp#vtp_mgmt_domain Cdp#vtp_mgmt_domain}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp iosxe_cdp}
*/
export class Cdp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Cdp that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/cdp iosxe_cdp} Resource
  *
  * @param scope The scope in which to define this construct
