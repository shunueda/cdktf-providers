// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp
...
export interface LldpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp#delete_mode Lldp#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp#device Lldp#device}
  */
  ...
  *   - Range: `0`-`65535`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp#holdtime Lldp#holdtime}
  */
  readonly holdtime?: number;
  /**
  * IPV4 address List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp#ipv4_management_addresses Lldp#ipv4_management_addresses}
  */
  readonly ipv4ManagementAddresses?: string[];
  /**
  * IPV6 address List
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp#ipv6_management_addresses Lldp#ipv6_management_addresses}
  */
  ...
  *   - Range: `1`-`4095`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp#management_vlan Lldp#management_vlan}
  */
  readonly managementVlan?: number;
  /**
  * Enable LLDP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp#run Lldp#run}
  */
  readonly run?: boolean | cdktf.IResolvable;
  /**
  * System name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp#system_names Lldp#system_names}
  */
  ...
  *   - Range: `5`-`65534`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp#timer Lldp#timer}
  */
...
export interface LldpSystemNames {
  ...
  * System name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp#name Lldp#name}
  */
  ...
  *   - Range: `0`-`17`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp#switch_id Lldp#switch_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp iosxe_lldp}
*/
export class Lldp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lldp that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/lldp iosxe_lldp} Resource
  *
  * @param scope The scope in which to define this construct
