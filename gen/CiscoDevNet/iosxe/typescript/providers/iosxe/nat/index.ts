// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/nat
...
export interface NatConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/nat#delete_mode Nat#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/nat#device Nat#device}
  */
  readonly device?: string;
  /**
  * Specify access list describing local addresses
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/nat#inside_source_interfaces Nat#inside_source_interfaces}
  */
...
export interface NatInsideSourceInterfacesInterfaces {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/nat#interface Nat#interface}
  */
  readonly interface: string;
  /**
  * Overload an address translation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/nat#overload Nat#overload}
  */
...
export interface NatInsideSourceInterfaces {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/nat#id Nat#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/nat#interfaces Nat#interfaces}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/nat iosxe_nat}
*/
export class Nat extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Nat that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/nat#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/nat iosxe_nat} Resource
  *
  * @param scope The scope in which to define this construct
