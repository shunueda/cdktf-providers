// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/vlan_access_map
...
export interface DataIosxeVlanAccessMapConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/vlan_access_map#device DataIosxeVlanAccessMap#device}
  */
  readonly device?: string;
  /**
  * Vlan access map tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/vlan_access_map#name DataIosxeVlanAccessMap#name}
  */
  readonly name: string;
  /**
  * Sequence to insert to/delete from existing vlan access-map entry
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/vlan_access_map#sequence DataIosxeVlanAccessMap#sequence}
  */
  readonly sequence: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/vlan_access_map iosxe_vlan_access_map}
*/
export class DataIosxeVlanAccessMap extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeVlanAccessMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/vlan_access_map#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/vlan_access_map iosxe_vlan_access_map} Data Source
  *
  * @param scope The scope in which to define this construct
