// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/data-sources/policy_map_event
...
export interface DataIosxePolicyMapEventConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/data-sources/policy_map_event#device DataIosxePolicyMapEvent#device}
  */
  readonly device?: string;
  /**
  * The event this control class-map triggers upon
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/data-sources/policy_map_event#event_type DataIosxePolicyMapEvent#event_type}
  */
  readonly eventType: string;
  /**
  * Name of the policy map
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/data-sources/policy_map_event#name DataIosxePolicyMapEvent#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/data-sources/policy_map_event iosxe_policy_map_event}
*/
export class DataIosxePolicyMapEvent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxePolicyMapEvent that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/data-sources/policy_map_event#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/data-sources/policy_map_event iosxe_policy_map_event} Data Source
  *
  * @param scope The scope in which to define this construct
