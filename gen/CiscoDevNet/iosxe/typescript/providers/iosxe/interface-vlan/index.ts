// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan
...
export interface InterfaceVlanConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#autostate InterfaceVlan#autostate}
  */
  readonly autostate?: boolean | cdktf.IResolvable;
  /**
  * Use echo adjunct as bfd detection mechanism
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#bfd_echo InterfaceVlan#bfd_echo}
  */
  readonly bfdEcho?: boolean | cdktf.IResolvable;
  /**
  * Enable BFD under the interface
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#bfd_enable InterfaceVlan#bfd_enable}
  */
  ...
  *   - Range: `50`-`9999`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#bfd_interval InterfaceVlan#bfd_interval}
  */
  ...
  *   - Range: `50`-`9999`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#bfd_interval_min_rx InterfaceVlan#bfd_interval_min_rx}
  */
  ...
  *   - Range: `3`-`50`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#bfd_interval_multiplier InterfaceVlan#bfd_interval_multiplier}
  */
  readonly bfdIntervalMultiplier?: number;
  /**
  * The Source IP address to be used for BFD sessions over this interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#bfd_local_address InterfaceVlan#bfd_local_address}
  */
  readonly bfdLocalAddress?: string;
  /**
  * BFD template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#bfd_template InterfaceVlan#bfd_template}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#delete_mode InterfaceVlan#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * Interface specific description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#description InterfaceVlan#description}
  */
  readonly description?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#device InterfaceVlan#device}
  */
  readonly device?: string;
  /**
  * Specify a destination address for UDP broadcasts
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#helper_addresses InterfaceVlan#helper_addresses}
  */
  readonly helperAddresses?: InterfaceVlanHelperAddresses[] | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ip_access_group_in InterfaceVlan#ip_access_group_in}
  */
  readonly ipAccessGroupIn?: string;
  /**
  * inbound packets
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ip_access_group_in_enable InterfaceVlan#ip_access_group_in_enable}
  */
  readonly ipAccessGroupInEnable?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ip_access_group_out InterfaceVlan#ip_access_group_out}
  */
  readonly ipAccessGroupOut?: string;
  /**
  * outbound packets
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ip_access_group_out_enable InterfaceVlan#ip_access_group_out_enable}
  */
  readonly ipAccessGroupOutEnable?: boolean | cdktf.IResolvable;
  /**
  * Enable vpn-id support on this interface
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ip_dhcp_relay_information_option_vpn_id InterfaceVlan#ip_dhcp_relay_information_option_vpn_id}
  */
  readonly ipDhcpRelayInformationOptionVpnId?: boolean | cdktf.IResolvable;
  /**
  * Set source interface for relayed messages
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ip_dhcp_relay_source_interface InterfaceVlan#ip_dhcp_relay_source_interface}
  */
  ...
  *   - Range: `1`-`3`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ip_igmp_version InterfaceVlan#ip_igmp_version}
  */
  readonly ipIgmpVersion?: number;
  /**
  * Enable local-proxy ARP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ip_local_proxy_arp InterfaceVlan#ip_local_proxy_arp}
  */
  readonly ipLocalProxyArp?: boolean | cdktf.IResolvable;
  /**
  * Inside interface for address translation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ip_nat_inside InterfaceVlan#ip_nat_inside}
  */
  readonly ipNatInside?: boolean | cdktf.IResolvable;
  /**
  * Outside interface for address translation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ip_nat_outside InterfaceVlan#ip_nat_outside}
  */
  readonly ipNatOutside?: boolean | cdktf.IResolvable;
  /**
  * Enable proxy ARP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ip_proxy_arp InterfaceVlan#ip_proxy_arp}
  */
  readonly ipProxyArp?: boolean | cdktf.IResolvable;
  /**
  * Enable sending ICMP Redirect messages
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ip_redirects InterfaceVlan#ip_redirects}
  */
  readonly ipRedirects?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ip_router_isis InterfaceVlan#ip_router_isis}
  */
  readonly ipRouterIsis?: string;
  /**
  * Enable sending ICMP Unreachable messages
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ip_unreachables InterfaceVlan#ip_unreachables}
  */
  readonly ipUnreachables?: boolean | cdktf.IResolvable;
  /**
  * Ip address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ipv4_address InterfaceVlan#ipv4_address}
  */
  readonly ipv4Address?: string;
  /**
  * Ip subnet mask
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ipv4_address_mask InterfaceVlan#ipv4_address_mask}
  */
  readonly ipv4AddressMask?: string;
  /**
  * Insert default route
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ipv6_address_autoconfig_default InterfaceVlan#ipv6_address_autoconfig_default}
  */
  readonly ipv6AddressAutoconfigDefault?: boolean | cdktf.IResolvable;
  /**
  * Obtain IPv6 address from DHCP server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ipv6_address_dhcp InterfaceVlan#ipv6_address_dhcp}
  */
  readonly ipv6AddressDhcp?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ipv6_addresses InterfaceVlan#ipv6_addresses}
  */
  readonly ipv6Addresses?: InterfaceVlanIpv6Addresses[] | cdktf.IResolvable;
  /**
  * Enable IPv6 on interface
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ipv6_enable InterfaceVlan#ipv6_enable}
  */
  readonly ipv6Enable?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ipv6_link_local_addresses InterfaceVlan#ipv6_link_local_addresses}
  */
  ...
  *   - Range: `1280`-`9976`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ipv6_mtu InterfaceVlan#ipv6_mtu}
  */
  readonly ipv6Mtu?: number;
  /**
  * Suppress all IPv6 RA
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#ipv6_nd_ra_suppress_all InterfaceVlan#ipv6_nd_ra_suppress_all}
  */
  ...
  *   - Range: `30`-`600`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#load_interval InterfaceVlan#load_interval}
  */
  readonly loadInterval?: number;
  /**
  * Manually set interface MAC address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#mac_address InterfaceVlan#mac_address}
  */
  ...
  *   - Range: `1`-`4094`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#name InterfaceVlan#name}
  */
  readonly name: number;
  /**
  * Shutdown the selected interface
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#shutdown InterfaceVlan#shutdown}
  */
  readonly shutdown?: boolean | cdktf.IResolvable;
  /**
  * Enable IP processing without an explicit address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#unnumbered InterfaceVlan#unnumbered}
  */
  readonly unnumbered?: string;
  /**
  * Configure forwarding table
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#vrf_forwarding InterfaceVlan#vrf_forwarding}
  */
...
export interface InterfaceVlanHelperAddresses {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#address InterfaceVlan#address}
  */
  readonly address: string;
  /**
  * Helper-address is global
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#global InterfaceVlan#global}
  */
  readonly global?: boolean | cdktf.IResolvable;
  /**
  * VRF name for helper-address (if different from interface VRF)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#vrf InterfaceVlan#vrf}
  */
  readonly vrf?: string;
}
...
export interface InterfaceVlanIpv6Addresses {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#eui_64 InterfaceVlan#eui_64}
  */
  readonly eui64?: boolean | cdktf.IResolvable;
  /**
  * IPv6 prefix
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#prefix InterfaceVlan#prefix}
  */
...
export interface InterfaceVlanIpv6LinkLocalAddresses {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#link_local InterfaceVlan#link_local}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan iosxe_interface_vlan}
*/
export class InterfaceVlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfaceVlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/interface_vlan iosxe_interface_vlan} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: InterfaceVlanConfig) {
    ...
    this._ipLocalProxyArp = config.ipLocalProxyArp;
  ...
  // ip_local_proxy_arp - computed: false, optional: true, required: false
  private _ipLocalProxyArp?: boolean | cdktf.IResolvable; 
  public get ipLocalProxyArp() {
    return this.getBooleanAttribute('ip_local_proxy_arp');
  }
  public set ipLocalProxyArp(value: boolean | cdktf.IResolvable) {
    this._ipLocalProxyArp = value;
  }
  public resetIpLocalProxyArp() {
    this._ipLocalProxyArp = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get ipLocalProxyArpInput() {
    return this._ipLocalProxyArp;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ip_local_proxy_arp: cdktf.booleanToTerraform(this._ipLocalProxyArp),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ip_local_proxy_arp: {
        value: cdktf.booleanToHclTerraform(this._ipLocalProxyArp),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
