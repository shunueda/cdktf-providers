// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/logging
...
export interface DataIosxeLoggingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/logging#device DataIosxeLogging#device}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/logging iosxe_logging}
*/
export class DataIosxeLogging extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeLogging that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/logging#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/logging iosxe_logging} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // buffered_severity_legacy - computed: true, optional: false, required: false
  ...
  // buffered_size_legacy - computed: true, optional: false, required: false
