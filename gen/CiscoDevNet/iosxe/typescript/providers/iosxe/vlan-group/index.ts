// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/vlan_group
...
export interface VlanGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/vlan_group#device VlanGroup#device}
  */
  readonly device?: string;
  /**
  * Group name starts with alphabet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/vlan_group#name VlanGroup#name}
  */
  readonly name: string;
  /**
  * VLANs in the vlan group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/vlan_group#vlan_lists VlanGroup#vlan_lists}
  */
  readonly vlanLists: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/vlan_group iosxe_vlan_group}
*/
export class VlanGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VlanGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/vlan_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/vlan_group iosxe_vlan_group} Resource
  *
  * @param scope The scope in which to define this construct
