// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration
...
export interface VlanConfigurationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Enter VFI name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration#access_vfi VlanConfiguration#access_vfi}
  */
  readonly accessVfi?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration#device VlanConfiguration#device}
  */
  ...
  *   - Range: `1`-`65535`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration#evpn_instance VlanConfiguration#evpn_instance}
  */
  ...
  *   - Range: `1`-`65535`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration#evpn_instance_legacy VlanConfiguration#evpn_instance_legacy}
  */
  readonly evpnInstanceLegacy?: number;
  /**
  * EVPN instance profile name. Use for IOS-XE >= 17.15.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration#evpn_instance_profile VlanConfiguration#evpn_instance_profile}
  */
  readonly evpnInstanceProfile?: string;
  /**
  * Enable local peer to peer blocking for auto EVI with profile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration#evpn_instance_profile_protected VlanConfiguration#evpn_instance_profile_protected}
  */
  readonly evpnInstanceProfileProtected?: boolean | cdktf.IResolvable;
  /**
  * Enable local peer to peer blocking for EVI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration#evpn_instance_protected VlanConfiguration#evpn_instance_protected}
  */
  ...
  *   - Range: `4096`-`16777215`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration#evpn_instance_vni VlanConfiguration#evpn_instance_vni}
  */
  ...
  *   - Range: `4096`-`16777215`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration#evpn_instance_vni_legacy VlanConfiguration#evpn_instance_vni_legacy}
  */
  readonly evpnInstanceVniLegacy?: number;
  /**
  * VLAN ID List Eg. 1-10,15
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration#vlan_id VlanConfiguration#vlan_id}
  */
  ...
  *   - Range: `4096`-`16777215`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration#vni VlanConfiguration#vni}
  */
  readonly vni?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration iosxe_vlan_configuration}
*/
export class VlanConfiguration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VlanConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/resources/vlan_configuration iosxe_vlan_configuration} Resource
  *
  * @param scope The scope in which to define this construct
