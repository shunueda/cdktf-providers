// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/vlan_access_map
...
export interface VlanAccessMapConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/vlan_access_map#action VlanAccessMap#action}
  */
  readonly action?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/vlan_access_map#device VlanAccessMap#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/vlan_access_map#match_ip_address VlanAccessMap#match_ip_address}
  */
  readonly matchIpAddress?: string[];
  /**
  * Match IPv6 address to access control.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/vlan_access_map#match_ipv6_address VlanAccessMap#match_ipv6_address}
  */
  readonly matchIpv6Address?: string[];
  /**
  * Vlan access map tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/vlan_access_map#name VlanAccessMap#name}
  */
  ...
  *   - Range: `0`-`65535`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/vlan_access_map#sequence VlanAccessMap#sequence}
  */
  readonly sequence: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/vlan_access_map iosxe_vlan_access_map}
*/
export class VlanAccessMap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VlanAccessMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/vlan_access_map#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/vlan_access_map iosxe_vlan_access_map} Resource
  *
  * @param scope The scope in which to define this construct
