// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/bgp_l2vpn_evpn_neighbor
...
export interface BgpL2VpnEvpnNeighborConfig extends cdktf.TerraformMetaArguments {
  ...
  *   - Default value: `true`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/bgp_l2vpn_evpn_neighbor#activate BgpL2VpnEvpnNeighbor#activate}
  */
  readonly activate?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/bgp_l2vpn_evpn_neighbor#asn BgpL2VpnEvpnNeighbor#asn}
  */
  readonly asn: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/bgp_l2vpn_evpn_neighbor#delete_mode BgpL2VpnEvpnNeighbor#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/bgp_l2vpn_evpn_neighbor#device BgpL2VpnEvpnNeighbor#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/bgp_l2vpn_evpn_neighbor#ip BgpL2VpnEvpnNeighbor#ip}
  */
  readonly ip: string;
  /**
  * Configure a neighbor as Route Reflector client
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/bgp_l2vpn_evpn_neighbor#route_reflector_client BgpL2VpnEvpnNeighbor#route_reflector_client}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/bgp_l2vpn_evpn_neighbor#send_community BgpL2VpnEvpnNeighbor#send_community}
  */
  ...
  *   - Choices: `inbound`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/bgp_l2vpn_evpn_neighbor#soft_reconfiguration BgpL2VpnEvpnNeighbor#soft_reconfiguration}
  */
  readonly softReconfiguration?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/bgp_l2vpn_evpn_neighbor iosxe_bgp_l2vpn_evpn_neighbor}
*/
export class BgpL2VpnEvpnNeighbor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BgpL2VpnEvpnNeighbor that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/bgp_l2vpn_evpn_neighbor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/bgp_l2vpn_evpn_neighbor iosxe_bgp_l2vpn_evpn_neighbor} Resource
  *
  * @param scope The scope in which to define this construct
