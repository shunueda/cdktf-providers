// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ipsec_transform_set
...
export interface CryptoIpsecTransformSetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ipsec_transform_set#device CryptoIpsecTransformSet#device}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ipsec_transform_set#esp CryptoIpsecTransformSet#esp}
  */
  readonly esp: string;
  /**
  * 
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ipsec_transform_set#esp_hmac CryptoIpsecTransformSet#esp_hmac}
  */
  readonly espHmac: string;
  /**
  * tunnel (datagram encapsulation) mode
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ipsec_transform_set#mode_tunnel CryptoIpsecTransformSet#mode_tunnel}
  */
  readonly modeTunnel?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ipsec_transform_set#name CryptoIpsecTransformSet#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ipsec_transform_set iosxe_crypto_ipsec_transform_set}
*/
export class CryptoIpsecTransformSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CryptoIpsecTransformSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ipsec_transform_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/crypto_ipsec_transform_set iosxe_crypto_ipsec_transform_set} Resource
  *
  * @param scope The scope in which to define this construct
