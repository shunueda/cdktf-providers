// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/eem
...
export interface DataIosxeEemConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/eem#device DataIosxeEem#device}
  */
...
export class DataIosxeEemAppletsActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // string_trim_first_string_op_1 - computed: true, optional: false, required: false
  public get stringTrimFirstStringOp1() {
    return this.getStringAttribute('string_trim_first_string_op_1');
  }

  // string_trim_first_string_op_2 - computed: true, optional: false, required: false
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/eem iosxe_eem}
*/
export class DataIosxeEem extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeEem that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/eem#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/eem iosxe_eem} Data Source
  *
  * @param scope The scope in which to define this construct
