// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim
...
export interface InterfacePimConfig extends cdktf.TerraformMetaArguments {
  ...
  * Configure BFD
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim#bfd InterfacePim#bfd}
  */
  readonly bfd?: boolean | cdktf.IResolvable;
  /**
  * Border of PIM domain
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim#border InterfacePim#border}
  */
  readonly border?: boolean | cdktf.IResolvable;
  /**
  * Border of PIM domain
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim#bsr_border InterfacePim#bsr_border}
  */
  readonly bsrBorder?: boolean | cdktf.IResolvable;
  /**
  * Enable PIM dense-mode operation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim#dense_mode InterfacePim#dense_mode}
  */
  readonly denseMode?: boolean | cdktf.IResolvable;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim#device InterfacePim#device}
  */
  ...
  *   - Range: `0`-`4294967294`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim#dr_priority InterfacePim#dr_priority}
  */
  readonly drPriority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim#name InterfacePim#name}
  */
  readonly name: string;
  /**
  * Enable PIM passive interface operation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim#passive InterfacePim#passive}
  */
  readonly passive?: boolean | cdktf.IResolvable;
  /**
  * Enable PIM sparse-dense-mode operation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim#sparse_dense_mode InterfacePim#sparse_dense_mode}
  */
  readonly sparseDenseMode?: boolean | cdktf.IResolvable;
  /**
  * Enable PIM sparse-mode operation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim#sparse_mode InterfacePim#sparse_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim#type InterfacePim#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim iosxe_interface_pim}
*/
export class InterfacePim extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfacePim that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/interface_pim iosxe_interface_pim} Resource
  *
  * @param scope The scope in which to define this construct
