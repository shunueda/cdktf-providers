// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/save_config
...
export interface SaveConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/save_config#device SaveConfig#device}
  */
  readonly device?: string;
  /**
  * This attribute is only used internally.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/save_config#save SaveConfig#save}
  */
  readonly save?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/save_config iosxe_save_config}
*/
export class SaveConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SaveConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/save_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.4/docs/resources/save_config iosxe_save_config} Resource
  *
  * @param scope The scope in which to define this construct
