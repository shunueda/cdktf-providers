// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/resources/tacacs_server
...
export interface TacacsServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/resources/tacacs_server#attribute_allow_unknown TacacsServer#attribute_allow_unknown}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/resources/tacacs_server#delete_mode TacacsServer#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/resources/tacacs_server#device TacacsServer#device}
  */
  readonly device?: string;
  /**
  * Allow user to specify tacacs server to use with `@server'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/resources/tacacs_server#directed_request TacacsServer#directed_request}
  */
  readonly directedRequest?: boolean | cdktf.IResolvable;
  /**
  * Do not truncate the @hostname from username.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/resources/tacacs_server#directed_request_no_truncate TacacsServer#directed_request_no_truncate}
  */
  readonly directedRequestNoTruncate?: boolean | cdktf.IResolvable;
  /**
  * restrict queries to directed request servers only
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/resources/tacacs_server#directed_request_restricted TacacsServer#directed_request_restricted}
  */
  ...
  *   - Choices: `0`, `6`, `7`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/resources/tacacs_server#encryption TacacsServer#encryption}
  */
  readonly encryption?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/resources/tacacs_server#key TacacsServer#key}
  */
  readonly key?: string;
  /**
  ...
  *   - Range: `1`-`1000`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/resources/tacacs_server#timeout TacacsServer#timeout}
  */
  readonly timeout?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/resources/tacacs_server iosxe_tacacs_server}
*/
export class TacacsServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TacacsServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/resources/tacacs_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.11.0/docs/resources/tacacs_server iosxe_tacacs_server} Resource
  *
  * @param scope The scope in which to define this construct
