// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/data-sources/bgp_address_family_ipv4
...
export interface DataIosxeBgpAddressFamilyIpv4Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/data-sources/bgp_address_family_ipv4#af_name DataIosxeBgpAddressFamilyIpv4#af_name}
  */
  readonly afName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/data-sources/bgp_address_family_ipv4#asn DataIosxeBgpAddressFamilyIpv4#asn}
  */
  readonly asn: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/data-sources/bgp_address_family_ipv4#device DataIosxeBgpAddressFamilyIpv4#device}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/data-sources/bgp_address_family_ipv4 iosxe_bgp_address_family_ipv4}
*/
export class DataIosxeBgpAddressFamilyIpv4 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeBgpAddressFamilyIpv4 that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/data-sources/bgp_address_family_ipv4#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.13.0/docs/data-sources/bgp_address_family_ipv4 iosxe_bgp_address_family_ipv4} Data Source
  *
  * @param scope The scope in which to define this construct
