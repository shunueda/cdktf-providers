// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template
...
export interface BgpPeerSessionTemplateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template#asn BgpPeerSessionTemplate#asn}
  */
  readonly asn: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template#delete_mode BgpPeerSessionTemplate#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * Neighbor specific description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template#description BgpPeerSessionTemplate#description}
  */
  readonly description?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template#device BgpPeerSessionTemplate#device}
  */
  readonly device?: string;
  /**
  * one-hop away EBGP peer using loopback address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template#disable_connected_check BgpPeerSessionTemplate#disable_connected_check}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template#ebgp_multihop BgpPeerSessionTemplate#ebgp_multihop}
  */
  ...
  *   - Range: `2`-`255`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template#ebgp_multihop_max_hop BgpPeerSessionTemplate#ebgp_multihop_max_hop}
  */
  readonly ebgpMultihopMaxHop?: number;
  /**
  * Inherit a peer-session template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template#inherit_peer_session BgpPeerSessionTemplate#inherit_peer_session}
  */
  readonly inheritPeerSession?: string;
  /**
  * Specify a BGP neighbor remote-as
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template#remote_as BgpPeerSessionTemplate#remote_as}
  */
  readonly remoteAs?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template#template_name BgpPeerSessionTemplate#template_name}
  */
  readonly templateName: string;
  /**
  * Loopback interface
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template#update_source_interface_loopback BgpPeerSessionTemplate#update_source_interface_loopback}
  */
  readonly updateSourceInterfaceLoopback?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template iosxe_bgp_peer_session_template}
*/
export class BgpPeerSessionTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BgpPeerSessionTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/bgp_peer_session_template iosxe_bgp_peer_session_template} Resource
  *
  * @param scope The scope in which to define this construct
