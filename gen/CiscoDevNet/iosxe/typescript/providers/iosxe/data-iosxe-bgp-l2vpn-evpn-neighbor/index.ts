// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_l2vpn_evpn_neighbor
...
export interface DataIosxeBgpL2VpnEvpnNeighborConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_l2vpn_evpn_neighbor#asn DataIosxeBgpL2VpnEvpnNeighbor#asn}
  */
  readonly asn: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_l2vpn_evpn_neighbor#device DataIosxeBgpL2VpnEvpnNeighbor#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_l2vpn_evpn_neighbor#ip DataIosxeBgpL2VpnEvpnNeighbor#ip}
  */
  readonly ip: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_l2vpn_evpn_neighbor iosxe_bgp_l2vpn_evpn_neighbor}
*/
export class DataIosxeBgpL2VpnEvpnNeighbor extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeBgpL2VpnEvpnNeighbor that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_l2vpn_evpn_neighbor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_l2vpn_evpn_neighbor iosxe_bgp_l2vpn_evpn_neighbor} Data Source
  *
  * @param scope The scope in which to define this construct
