// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_ipv4_unicast_neighbor
...
export interface DataIosxeBgpIpv4UnicastNeighborConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_ipv4_unicast_neighbor#asn DataIosxeBgpIpv4UnicastNeighbor#asn}
  */
  readonly asn: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_ipv4_unicast_neighbor#device DataIosxeBgpIpv4UnicastNeighbor#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_ipv4_unicast_neighbor#ip DataIosxeBgpIpv4UnicastNeighbor#ip}
  */
  readonly ip: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_ipv4_unicast_neighbor iosxe_bgp_ipv4_unicast_neighbor}
*/
export class DataIosxeBgpIpv4UnicastNeighbor extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeBgpIpv4UnicastNeighbor that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_ipv4_unicast_neighbor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/data-sources/bgp_ipv4_unicast_neighbor iosxe_bgp_ipv4_unicast_neighbor} Data Source
  *
  * @param scope The scope in which to define this construct
