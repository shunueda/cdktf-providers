// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/bgp_ipv4_mvpn_neighbor
...
export interface BgpIpv4MvpnNeighborConfig extends cdktf.TerraformMetaArguments {
  ...
  *   - Default value: `true`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/bgp_ipv4_mvpn_neighbor#activate BgpIpv4MvpnNeighbor#activate}
  */
  readonly activate?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/bgp_ipv4_mvpn_neighbor#asn BgpIpv4MvpnNeighbor#asn}
  */
  readonly asn: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/bgp_ipv4_mvpn_neighbor#delete_mode BgpIpv4MvpnNeighbor#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/bgp_ipv4_mvpn_neighbor#device BgpIpv4MvpnNeighbor#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/bgp_ipv4_mvpn_neighbor#ip BgpIpv4MvpnNeighbor#ip}
  */
  readonly ip: string;
  /**
  * 
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/bgp_ipv4_mvpn_neighbor#send_community BgpIpv4MvpnNeighbor#send_community}
  */
  readonly sendCommunity?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/bgp_ipv4_mvpn_neighbor iosxe_bgp_ipv4_mvpn_neighbor}
*/
export class BgpIpv4MvpnNeighbor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BgpIpv4MvpnNeighbor that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/bgp_ipv4_mvpn_neighbor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/bgp_ipv4_mvpn_neighbor iosxe_bgp_ipv4_mvpn_neighbor} Resource
  *
  * @param scope The scope in which to define this construct
