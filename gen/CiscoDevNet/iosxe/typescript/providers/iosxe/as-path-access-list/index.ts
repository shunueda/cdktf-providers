// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/as_path_access_list
...
export interface AsPathAccessListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/as_path_access_list#device AsPathAccessList#device}
  */
  readonly device?: string;
  /**
  * Specify community list to accept or deny
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/as_path_access_list#entries AsPathAccessList#entries}
  */
  ...
  *   - Range: `1`-`500`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/as_path_access_list#name AsPathAccessList#name}
  */
...
export interface AsPathAccessListEntries {
  ...
  *   - Choices: `deny`, `permit`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/as_path_access_list#action AsPathAccessList#action}
  */
  readonly action: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/as_path_access_list#regex AsPathAccessList#regex}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/as_path_access_list iosxe_as_path_access_list}
*/
export class AsPathAccessList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AsPathAccessList that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/as_path_access_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/resources/as_path_access_list iosxe_as_path_access_list} Resource
  *
  * @param scope The scope in which to define this construct
