// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/community_list_standard
...
export interface DataIosxeCommunityListStandardConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/community_list_standard#device DataIosxeCommunityListStandard#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/community_list_standard#name DataIosxeCommunityListStandard#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/community_list_standard iosxe_community_list_standard}
*/
export class DataIosxeCommunityListStandard extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeCommunityListStandard that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/community_list_standard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/community_list_standard iosxe_community_list_standard} Data Source
  *
  * @param scope The scope in which to define this construct
