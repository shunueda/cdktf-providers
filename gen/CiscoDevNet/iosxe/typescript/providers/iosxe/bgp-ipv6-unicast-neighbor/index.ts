// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor
...
export interface BgpIpv6UnicastNeighborConfig extends cdktf.TerraformMetaArguments {
  /**
  * Enable the address family for this neighbor
  *   - Default value: `true`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor#activate BgpIpv6UnicastNeighbor#activate}
  */
  readonly activate?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor#asn BgpIpv6UnicastNeighbor#asn}
  */
  readonly asn: string;
  /**
  * Originate default route to this neighbor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor#default_originate BgpIpv6UnicastNeighbor#default_originate}
  */
  readonly defaultOriginate?: boolean | cdktf.IResolvable;
  /**
  * Route-map to specify criteria to originate default
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor#default_originate_route_map BgpIpv6UnicastNeighbor#default_originate_route_map}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor#delete_mode BgpIpv6UnicastNeighbor#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor#device BgpIpv6UnicastNeighbor#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor#ip BgpIpv6UnicastNeighbor#ip}
  */
  readonly ip: string;
  /**
  * Apply route map to neighbor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor#route_maps BgpIpv6UnicastNeighbor#route_maps}
  */
  readonly routeMaps?: BgpIpv6UnicastNeighborRouteMaps[] | cdktf.IResolvable;
  /**
  * Configure a neighbor as Route Reflector client
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor#route_reflector_client BgpIpv6UnicastNeighbor#route_reflector_client}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor#send_community BgpIpv6UnicastNeighbor#send_community}
  */
  ...
  *   - Choices: `inbound`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor#soft_reconfiguration BgpIpv6UnicastNeighbor#soft_reconfiguration}
  */
  readonly softReconfiguration?: string;
}
export interface BgpIpv6UnicastNeighborRouteMaps {
  /**
  * 
  *   - Choices: `in`, `out`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor#in_out BgpIpv6UnicastNeighbor#in_out}
  */
  readonly inOut: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor#route_map_name BgpIpv6UnicastNeighbor#route_map_name}
  */
  readonly routeMapName: string;
}

export function bgpIpv6UnicastNeighborRouteMapsToTerraform(struct?: BgpIpv6UnicastNeighborRouteMaps | cdktf.IResolvable): any {
...
export function bgpIpv6UnicastNeighborRouteMapsToHclTerraform(struct?: BgpIpv6UnicastNeighborRouteMaps | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class BgpIpv6UnicastNeighborRouteMapsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): BgpIpv6UnicastNeighborRouteMaps | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: BgpIpv6UnicastNeighborRouteMaps | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class BgpIpv6UnicastNeighborRouteMapsList extends cdktf.ComplexList {
  public internalValue? : BgpIpv6UnicastNeighborRouteMaps[] | cdktf.IResolvable
  ...
  */
  public get(index: number): BgpIpv6UnicastNeighborRouteMapsOutputReference {
    return new BgpIpv6UnicastNeighborRouteMapsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor iosxe_bgp_ipv6_unicast_neighbor}
*/
export class BgpIpv6UnicastNeighbor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BgpIpv6UnicastNeighbor that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.15.0/docs/resources/bgp_ipv6_unicast_neighbor iosxe_bgp_ipv6_unicast_neighbor} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options BgpIpv6UnicastNeighborConfig
  */
  public constructor(scope: Construct, id: string, config: BgpIpv6UnicastNeighborConfig) {
    super(scope, id, {
  ...
  private _routeMaps = new BgpIpv6UnicastNeighborRouteMapsList(this, "route_maps", false);
  public get routeMaps() {
    return this._routeMaps;
  }
  public putRouteMaps(value: BgpIpv6UnicastNeighborRouteMaps[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      route_maps: cdktf.listMapper(bgpIpv6UnicastNeighborRouteMapsToTerraform, false)(this._routeMaps.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      route_maps: {
        value: cdktf.listMapperHcl(bgpIpv6UnicastNeighborRouteMapsToHclTerraform, false)(this._routeMaps.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "BgpIpv6UnicastNeighborRouteMapsList",
      },
