// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/data-sources/access_list_role_based
...
export interface DataIosxeAccessListRoleBasedConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/data-sources/access_list_role_based#device DataIosxeAccessListRoleBased#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/data-sources/access_list_role_based#name DataIosxeAccessListRoleBased#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/data-sources/access_list_role_based iosxe_access_list_role_based}
*/
export class DataIosxeAccessListRoleBased extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeAccessListRoleBased that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/data-sources/access_list_role_based#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/data-sources/access_list_role_based iosxe_access_list_role_based} Data Source
  *
  * @param scope The scope in which to define this construct
