// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/evpn
...
export interface DataIosxeEvpnConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/evpn#device DataIosxeEvpn#device}
  */
  readonly device?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/evpn iosxe_evpn}
*/
export class DataIosxeEvpn extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeEvpn that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/evpn#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/data-sources/evpn iosxe_evpn} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // flooding_suppression_address_resolution_disable - computed: true, optional: false, required: false
  ...
  // multicast_advertise - computed: true, optional: false, required: false
