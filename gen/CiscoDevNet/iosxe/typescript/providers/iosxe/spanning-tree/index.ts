// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree
...
export interface SpanningTreeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree#device SpanningTree#device}
  */
  readonly device?: string;
  /**
  * Extend system-id into priority portion of the bridge id (PVST & Rapid PVST only)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree#extend_system_id SpanningTree#extend_system_id}
  */
  readonly extendSystemId?: boolean | cdktf.IResolvable;
  /**
  * Enable Spanning tree logging
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree#logging SpanningTree#logging}
  */
  readonly logging?: boolean | cdktf.IResolvable;
  /**
  * Enable loopguard by default on all ports
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree#loopguard_default SpanningTree#loopguard_default}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree#mode SpanningTree#mode}
  */
  readonly mode?: string;
  /**
  * Map vlans to an MST instance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree#mst_instances SpanningTree#mst_instances}
  */
  readonly mstInstances?: SpanningTreeMstInstances[] | cdktf.IResolvable;
  /**
  * Enable bpdu guard by default on all portfast edge ports
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree#portfast_bpduguard_default SpanningTree#portfast_bpduguard_default}
  */
  readonly portfastBpduguardDefault?: boolean | cdktf.IResolvable;
  /**
  * Enable portfast by default on all access ports
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree#portfast_default SpanningTree#portfast_default}
  */
  readonly portfastDefault?: boolean | cdktf.IResolvable;
  /**
  * VLAN Switch Spanning Tree
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree#vlans SpanningTree#vlans}
  */
...
export interface SpanningTreeMstInstances {
  ...
  *   - Range: `0`-`4094`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree#id SpanningTree#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree#vlan_ids SpanningTree#vlan_ids}
  */
...
export interface SpanningTreeVlans {
  ...
  *   - Range: `0`-`61440`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree#priority SpanningTree#priority}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree iosxe_spanning_tree}
*/
export class SpanningTree extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpanningTree that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/spanning_tree iosxe_spanning_tree} Resource
  *
  * @param scope The scope in which to define this construct
