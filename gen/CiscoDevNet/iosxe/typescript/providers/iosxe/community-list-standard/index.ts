// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/community_list_standard
...
export interface CommunityListStandardConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/community_list_standard#deny_entries CommunityListStandard#deny_entries}
  */
  readonly denyEntries?: string[];
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/community_list_standard#device CommunityListStandard#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/community_list_standard#name CommunityListStandard#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/community_list_standard#permit_entries CommunityListStandard#permit_entries}
  */
  readonly permitEntries?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/community_list_standard iosxe_community_list_standard}
*/
export class CommunityListStandard extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CommunityListStandard that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/community_list_standard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.6/docs/resources/community_list_standard iosxe_community_list_standard} Resource
  *
  * @param scope The scope in which to define this construct
