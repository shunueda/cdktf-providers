// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/data-sources/bgp_address_family_ipv6
...
export interface DataIosxeBgpAddressFamilyIpv6Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/data-sources/bgp_address_family_ipv6#af_name DataIosxeBgpAddressFamilyIpv6#af_name}
  */
  readonly afName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/data-sources/bgp_address_family_ipv6#asn DataIosxeBgpAddressFamilyIpv6#asn}
  */
  readonly asn: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/data-sources/bgp_address_family_ipv6#device DataIosxeBgpAddressFamilyIpv6#device}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/data-sources/bgp_address_family_ipv6 iosxe_bgp_address_family_ipv6}
*/
export class DataIosxeBgpAddressFamilyIpv6 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeBgpAddressFamilyIpv6 that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/data-sources/bgp_address_family_ipv6#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/data-sources/bgp_address_family_ipv6 iosxe_bgp_address_family_ipv6} Data Source
  *
  * @param scope The scope in which to define this construct
