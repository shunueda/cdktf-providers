...
export interface InterfaceSwitchportConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#access_vlan InterfaceSwitchport#access_vlan}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#delete_mode InterfaceSwitchport#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#device InterfaceSwitchport#device}
  */
  readonly device?: string;
  /**
  * Set port host
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#host InterfaceSwitchport#host}
  */
  readonly host?: boolean | cdktf.IResolvable;
  /**
  * Set trunking mode to ACCESS unconditionally
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#mode_access InterfaceSwitchport#mode_access}
  */
  readonly modeAccess?: boolean | cdktf.IResolvable;
  /**
  * set trunking mode to TUNNEL unconditionally
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#mode_dot1q_tunnel InterfaceSwitchport#mode_dot1q_tunnel}
  */
  readonly modeDot1QTunnel?: boolean | cdktf.IResolvable;
  /**
  * Set the mode to private-vlan host
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#mode_private_vlan_host InterfaceSwitchport#mode_private_vlan_host}
  */
  readonly modePrivateVlanHost?: boolean | cdktf.IResolvable;
  /**
  * Set the mode to private-vlan promiscuous
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#mode_private_vlan_promiscuous InterfaceSwitchport#mode_private_vlan_promiscuous}
  */
  readonly modePrivateVlanPromiscuous?: boolean | cdktf.IResolvable;
  /**
  * Set the mode to private-vlan trunk
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#mode_private_vlan_trunk InterfaceSwitchport#mode_private_vlan_trunk}
  */
  readonly modePrivateVlanTrunk?: boolean | cdktf.IResolvable;
  /**
  * Set trunking mode to TRUNK unconditionally
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#mode_trunk InterfaceSwitchport#mode_trunk}
  */
  readonly modeTrunk?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#name InterfaceSwitchport#name}
  */
  readonly name: string;
  /**
  * Device will not engage in negotiation protocol on this interface
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#nonegotiate InterfaceSwitchport#nonegotiate}
  */
  readonly nonegotiate?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#trunk_allowed_vlans InterfaceSwitchport#trunk_allowed_vlans}
  */
  readonly trunkAllowedVlans?: string;
  /**
  * no VLANs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#trunk_allowed_vlans_none InterfaceSwitchport#trunk_allowed_vlans_none}
  */
  ...
  *   - Range: `1`-`4094`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#trunk_native_vlan InterfaceSwitchport#trunk_native_vlan}
  */
  readonly trunkNativeVlan?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#trunk_native_vlan_tag InterfaceSwitchport#trunk_native_vlan_tag}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#type InterfaceSwitchport#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport iosxe_interface_switchport}
*/
export class InterfaceSwitchport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfaceSwitchport that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.2/docs/resources/interface_switchport iosxe_interface_switchport} Resource
  *
  * @param scope The scope in which to define this construct
