// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/sla
...
export interface SlaConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/sla#device Sla#device}
  */
  readonly device?: string;
  /**
  * Entries
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/sla#entries Sla#entries}
  */
  readonly entries?: SlaEntries[] | cdktf.IResolvable;
  /**
  * Schedules
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/sla#schedules Sla#schedules}
  */
...
export interface SlaEntries {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/sla#icmp_echo_destination Sla#icmp_echo_destination}
  */
  readonly icmpEchoDestination?: string;
  /**
  * Source Address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/sla#icmp_echo_source_ip Sla#icmp_echo_source_ip}
  */
  readonly icmpEchoSourceIp?: string;
  /**
  * Entry Number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/sla#number Sla#number}
  */
...
export interface SlaSchedules {
  ...
  * Entry number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/sla#entry_number Sla#entry_number}
  */
  readonly entryNumber: number;
  /**
  * Length of time to execute in seconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/sla#life Sla#life}
  */
  readonly life?: number;
  /**
  * Start now
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/sla#start_time_now Sla#start_time_now}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/sla iosxe_sla}
*/
export class Sla extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Sla that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/sla#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/sla iosxe_sla} Resource
  *
  * @param scope The scope in which to define this construct
