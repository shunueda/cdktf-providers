// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/interface_pim_ipv6
...
export interface InterfacePimIpv6Config extends cdktf.TerraformMetaArguments {
  ...
  * Configure BFD
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/interface_pim_ipv6#bfd InterfacePimIpv6#bfd}
  */
  readonly bfd?: boolean | cdktf.IResolvable;
  /**
  * Border of PIM BSR domain
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/interface_pim_ipv6#bsr_border InterfacePimIpv6#bsr_border}
  */
  readonly bsrBorder?: boolean | cdktf.IResolvable;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/interface_pim_ipv6#device InterfacePimIpv6#device}
  */
  ...
  *   - Range: `0`-`4294967295`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/interface_pim_ipv6#dr_priority InterfacePimIpv6#dr_priority}
  */
  readonly drPriority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/interface_pim_ipv6#name InterfacePimIpv6#name}
  */
  readonly name: string;
  /**
  * PIM interface commands
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/interface_pim_ipv6#pim InterfacePimIpv6#pim}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/interface_pim_ipv6#type InterfacePimIpv6#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/interface_pim_ipv6 iosxe_interface_pim_ipv6}
*/
export class InterfacePimIpv6 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfacePimIpv6 that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/interface_pim_ipv6#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/resources/interface_pim_ipv6 iosxe_interface_pim_ipv6} Resource
  *
  * @param scope The scope in which to define this construct
