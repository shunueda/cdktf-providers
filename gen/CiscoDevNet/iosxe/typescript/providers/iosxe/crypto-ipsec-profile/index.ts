// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/crypto_ipsec_profile
...
export interface CryptoIpsecProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/crypto_ipsec_profile#device CryptoIpsecProfile#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/crypto_ipsec_profile#name CryptoIpsecProfile#name}
  */
  readonly name: string;
  /**
  * Specify ikev2 Profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/crypto_ipsec_profile#set_ikev2_profile CryptoIpsecProfile#set_ikev2_profile}
  */
  readonly setIkev2Profile?: string;
  /**
  * Specify isakmp Profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/crypto_ipsec_profile#set_isakmp_profile CryptoIpsecProfile#set_isakmp_profile}
  */
  readonly setIsakmpProfile?: string;
  /**
  * Specify list of transform sets in priority order
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/crypto_ipsec_profile#set_transform_set CryptoIpsecProfile#set_transform_set}
  */
  readonly setTransformSet?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/crypto_ipsec_profile iosxe_crypto_ipsec_profile}
*/
export class CryptoIpsecProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CryptoIpsecProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/crypto_ipsec_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/resources/crypto_ipsec_profile iosxe_crypto_ipsec_profile} Resource
  *
  * @param scope The scope in which to define this construct
