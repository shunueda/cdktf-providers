// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/bgp_peer_policy_template
...
export interface DataIosxeBgpPeerPolicyTemplateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/bgp_peer_policy_template#asn DataIosxeBgpPeerPolicyTemplate#asn}
  */
  readonly asn: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/bgp_peer_policy_template#device DataIosxeBgpPeerPolicyTemplate#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/bgp_peer_policy_template#name DataIosxeBgpPeerPolicyTemplate#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/bgp_peer_policy_template iosxe_bgp_peer_policy_template}
*/
export class DataIosxeBgpPeerPolicyTemplate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeBgpPeerPolicyTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/bgp_peer_policy_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.10.0/docs/data-sources/bgp_peer_policy_template iosxe_bgp_peer_policy_template} Data Source
  *
  * @param scope The scope in which to define this construct
