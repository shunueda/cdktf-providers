// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/data-sources/bfd_template_single_hop
...
export interface DataIosxeBfdTemplateSingleHopConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/data-sources/bfd_template_single_hop#device DataIosxeBfdTemplateSingleHop#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/data-sources/bfd_template_single_hop#name DataIosxeBfdTemplateSingleHop#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/data-sources/bfd_template_single_hop iosxe_bfd_template_single_hop}
*/
export class DataIosxeBfdTemplateSingleHop extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeBfdTemplateSingleHop that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/data-sources/bfd_template_single_hop#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.9.3/docs/data-sources/bfd_template_single_hop iosxe_bfd_template_single_hop} Data Source
  *
  * @param scope The scope in which to define this construct
