// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template
...
export interface BgpPeerPolicyTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *   - Range: `1`-`10`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template#allowas_in_as_number BgpPeerPolicyTemplate#allowas_in_as_number}
  */
  readonly allowasInAsNumber?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template#as_override_split_horizon BgpPeerPolicyTemplate#as_override_split_horizon}
  */
  readonly asOverrideSplitHorizon?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template#asn BgpPeerPolicyTemplate#asn}
  */
  readonly asn: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template#delete_mode BgpPeerPolicyTemplate#delete_mode}
  */
  readonly deleteMode?: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template#device BgpPeerPolicyTemplate#device}
  */
  readonly device?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template#name BgpPeerPolicyTemplate#name}
  */
  readonly name: string;
  /**
  * Apply route map to neighbor
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template#route_maps BgpPeerPolicyTemplate#route_maps}
  */
  readonly routeMaps?: BgpPeerPolicyTemplateRouteMaps[] | cdktf.IResolvable;
  /**
  * Configure a neighbor as Route Reflector client
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template#route_reflector_client BgpPeerPolicyTemplate#route_reflector_client}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template#send_community BgpPeerPolicyTemplate#send_community}
  */
...
export interface BgpPeerPolicyTemplateRouteMaps {
  ...
  *   - Choices: `in`, `out`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template#in_out BgpPeerPolicyTemplate#in_out}
  */
  readonly inOut: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template#route_map_name BgpPeerPolicyTemplate#route_map_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template iosxe_bgp_peer_policy_template}
*/
export class BgpPeerPolicyTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BgpPeerPolicyTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.14.5/docs/resources/bgp_peer_policy_template iosxe_bgp_peer_policy_template} Resource
  *
  * @param scope The scope in which to define this construct
