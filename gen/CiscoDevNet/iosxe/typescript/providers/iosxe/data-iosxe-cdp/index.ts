// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/data-sources/cdp
...
export interface DataIosxeCdpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/data-sources/cdp#device DataIosxeCdp#device}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/data-sources/cdp iosxe_cdp}
*/
export class DataIosxeCdp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeCdp that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/data-sources/cdp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/data-sources/cdp iosxe_cdp} Data Source
  *
  * @param scope The scope in which to define this construct
