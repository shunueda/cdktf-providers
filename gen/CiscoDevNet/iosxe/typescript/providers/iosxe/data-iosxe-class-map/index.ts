// https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/data-sources/class_map
...
export interface DataIosxeClassMapConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/data-sources/class_map#device DataIosxeClassMap#device}
  */
  readonly device?: string;
  /**
  * name of the class map
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/data-sources/class_map#name DataIosxeClassMap#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/data-sources/class_map iosxe_class_map}
*/
export class DataIosxeClassMap extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIosxeClassMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/data-sources/class_map#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxe/0.12.0/docs/data-sources/class_map iosxe_class_map} Data Source
  *
  * @param scope The scope in which to define this construct
