// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_device_wireless_profiles
...
export interface CameraDeviceWirelessProfilesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_device_wireless_profiles#ids_backup CameraDeviceWirelessProfiles#ids_backup}
  */
  readonly idsBackup?: string;
  /**
  * The id of the primary wireless profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_device_wireless_profiles#ids_primary CameraDeviceWirelessProfiles#ids_primary}
  */
  readonly idsPrimary: string;
  /**
  * The id of the secondary wireless profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_device_wireless_profiles#ids_secondary CameraDeviceWirelessProfiles#ids_secondary}
  */
  readonly idsSecondary: string;
  /**
  * Device serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_device_wireless_profiles#serial CameraDeviceWirelessProfiles#serial}
  */
  readonly serial: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_device_wireless_profiles meraki_camera_device_wireless_profiles}
*/
export class CameraDeviceWirelessProfiles extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CameraDeviceWirelessProfiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_device_wireless_profiles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_device_wireless_profiles meraki_camera_device_wireless_profiles} Resource
  *
  * @param scope The scope in which to define this construct
