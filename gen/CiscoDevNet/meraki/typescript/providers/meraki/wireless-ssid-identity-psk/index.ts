// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_identity_psk
...
export interface WirelessSsidIdentityPskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_identity_psk#expires_at WirelessSsidIdentityPsk#expires_at}
  */
  readonly expiresAt?: string;
  /**
  * The group policy to be applied to clients
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_identity_psk#group_policy_id WirelessSsidIdentityPsk#group_policy_id}
  */
  readonly groupPolicyId: string;
  /**
  * The name of the Identity PSK
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_identity_psk#name WirelessSsidIdentityPsk#name}
  */
  readonly name: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_identity_psk#network_id WirelessSsidIdentityPsk#network_id}
  */
  readonly networkId: string;
  /**
  * Wireless SSID number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_identity_psk#number WirelessSsidIdentityPsk#number}
  */
  readonly number: string;
  /**
  * The passphrase for client authentication. If left blank, one will be auto-generated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_identity_psk#passphrase WirelessSsidIdentityPsk#passphrase}
  */
  readonly passphrase?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_identity_psk meraki_wireless_ssid_identity_psk}
*/
export class WirelessSsidIdentityPsk extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WirelessSsidIdentityPsk that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_identity_psk#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_identity_psk meraki_wireless_ssid_identity_psk} Resource
  *
  * @param scope The scope in which to define this construct
