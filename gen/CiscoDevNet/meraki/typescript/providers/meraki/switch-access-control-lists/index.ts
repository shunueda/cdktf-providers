// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists
...
export interface SwitchAccessControlListsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists#network_id SwitchAccessControlLists#network_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists#rules SwitchAccessControlLists#rules}
  */
...
export interface SwitchAccessControlListsRules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists#comment SwitchAccessControlLists#comment}
  */
  readonly comment?: string;
  /**
  * Destination IP address (in IP or CIDR notation) or `any`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists#dst_cidr SwitchAccessControlLists#dst_cidr}
  */
  readonly dstCidr: string;
  /**
  * Destination port. Must be in the range of 1-65535 or `any`. Default is `any`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists#dst_port SwitchAccessControlLists#dst_port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists#ip_version SwitchAccessControlLists#ip_version}
  */
  ...
  *   - Choices: `allow`, `deny`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists#policy SwitchAccessControlLists#policy}
  */
  ...
  *   - Choices: `any`, `tcp`, `udp`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists#protocol SwitchAccessControlLists#protocol}
  */
  readonly protocol: string;
  /**
  * Source IP address (in IP or CIDR notation) or `any`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists#src_cidr SwitchAccessControlLists#src_cidr}
  */
  readonly srcCidr: string;
  /**
  * Source port. Must be in the range of 1-65535 or `any`. Default is `any`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists#src_port SwitchAccessControlLists#src_port}
  */
  readonly srcPort?: string;
  /**
  * Incoming traffic VLAN. Must be in the range of 1-4095 or `any`. Default is `any`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists#vlan SwitchAccessControlLists#vlan}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists meraki_switch_access_control_lists}
*/
export class SwitchAccessControlLists extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchAccessControlLists that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_access_control_lists meraki_switch_access_control_lists} Resource
  *
  * @param scope The scope in which to define this construct
