// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/sensor_mqtt_broker
...
export interface SensorMqttBrokerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/sensor_mqtt_broker#enabled SensorMqttBroker#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * MQTT Broker ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/sensor_mqtt_broker#mqtt_broker_id SensorMqttBroker#mqtt_broker_id}
  */
  readonly mqttBrokerId: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/sensor_mqtt_broker#network_id SensorMqttBroker#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/sensor_mqtt_broker meraki_sensor_mqtt_broker}
*/
export class SensorMqttBroker extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SensorMqttBroker that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/sensor_mqtt_broker#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/sensor_mqtt_broker meraki_sensor_mqtt_broker} Resource
  *
  * @param scope The scope in which to define this construct
