// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_location_scanning
...
export interface WirelessLocationScanningConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_location_scanning#api_enabled WirelessLocationScanning#api_enabled}
  */
  readonly apiEnabled: boolean | cdktf.IResolvable;
  /**
  * Collect location and scanning analytics
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_location_scanning#enabled WirelessLocationScanning#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_location_scanning#network_id WirelessLocationScanning#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_location_scanning meraki_wireless_location_scanning}
*/
export class WirelessLocationScanning extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WirelessLocationScanning that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_location_scanning#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_location_scanning meraki_wireless_location_scanning} Resource
  *
  * @param scope The scope in which to define this construct
