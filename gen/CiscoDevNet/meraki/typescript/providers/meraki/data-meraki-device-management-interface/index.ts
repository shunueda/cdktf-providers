// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/device_management_interface
...
export interface DataMerakiDeviceManagementInterfaceConfig extends cdktf.TerraformMetaArguments {
  ...
  * Device serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/device_management_interface#serial DataMerakiDeviceManagementInterface#serial}
  */
  readonly serial: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/device_management_interface meraki_device_management_interface}
*/
export class DataMerakiDeviceManagementInterface extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiDeviceManagementInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/device_management_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/device_management_interface meraki_device_management_interface} Data Source
  *
  * @param scope The scope in which to define this construct
