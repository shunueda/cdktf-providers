// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ports
...
export interface AppliancePortsConfig extends cdktf.TerraformMetaArguments {
  ...
  * The list of items
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ports#items AppliancePorts#items}
  */
  readonly items: AppliancePortsItems[] | cdktf.IResolvable;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ports#network_id AppliancePorts#network_id}
  */
  readonly networkId: string;
  /**
  * The organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ports#organization_id AppliancePorts#organization_id}
  */
...
export interface AppliancePortsItems {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ports#access_policy AppliancePorts#access_policy}
  */
  readonly accessPolicy?: string;
  /**
  * Comma-delimited list of the VLAN ID`s allowed on the port, or `all` to permit all VLAN`s on the port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ports#allowed_vlans AppliancePorts#allowed_vlans}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ports#drop_untagged_traffic AppliancePorts#drop_untagged_traffic}
  */
  readonly dropUntaggedTraffic?: boolean | cdktf.IResolvable;
  /**
  * The status of the port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ports#enabled AppliancePorts#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Port ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ports#port_id AppliancePorts#port_id}
  */
  readonly portId: string;
  /**
  * The type of the port: `access` or `trunk`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ports#type AppliancePorts#type}
  */
  readonly type?: string;
  /**
  * Native VLAN when the port is in Trunk mode. Access VLAN when the port is in Access mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ports#vlan AppliancePorts#vlan}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ports meraki_appliance_ports}
*/
export class AppliancePorts extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppliancePorts that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ports#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ports meraki_appliance_ports} Resource
  *
  * @param scope The scope in which to define this construct
