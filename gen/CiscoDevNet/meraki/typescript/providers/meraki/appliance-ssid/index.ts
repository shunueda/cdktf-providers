// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid
...
export interface ApplianceSsidConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#auth_mode ApplianceSsid#auth_mode}
  */
  readonly authMode?: string;
  /**
  * The VLAN ID of the VLAN associated to this SSID. This parameter is only valid if the network is in routed mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#default_vlan_id ApplianceSsid#default_vlan_id}
  */
  readonly defaultVlanId?: number;
  /**
  * Enable DCHP Enforced Deauthentication on the SSID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#dhcp_enforced_deauthentication_enabled ApplianceSsid#dhcp_enforced_deauthentication_enabled}
  */
  readonly dhcpEnforcedDeauthenticationEnabled?: boolean | cdktf.IResolvable;
  /**
  * Whether 802.11w is enabled or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#dot11w_enabled ApplianceSsid#dot11w_enabled}
  */
  readonly dot11WEnabled?: boolean | cdktf.IResolvable;
  /**
  * (Optional) Whether 802.11w is required or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#dot11w_required ApplianceSsid#dot11w_required}
  */
  readonly dot11WRequired?: boolean | cdktf.IResolvable;
  /**
  * Whether or not the SSID is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#enabled ApplianceSsid#enabled}
  */
  ...
  *   - Choices: `wep`, `wpa`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#encryption_mode ApplianceSsid#encryption_mode}
  */
  readonly encryptionMode?: string;
  /**
  * The name of the SSID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#name ApplianceSsid#name}
  */
  readonly name?: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#network_id ApplianceSsid#network_id}
  */
  readonly networkId: string;
  /**
  * Wireless SSID number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#number ApplianceSsid#number}
  */
  readonly number: string;
  /**
  * The passkey for the SSID. This param is only valid if the authMode is `psk`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#psk ApplianceSsid#psk}
  */
  readonly psk?: string;
  /**
  * The RADIUS 802.1x servers to be used for authentication. This param is only valid if the authMode is `8021x-radius`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#radius_servers ApplianceSsid#radius_servers}
  */
  readonly radiusServers?: ApplianceSsidRadiusServers[] | cdktf.IResolvable;
  /**
  * Boolean indicating whether the MX should advertise or hide this SSID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#visible ApplianceSsid#visible}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#wpa_encryption_mode ApplianceSsid#wpa_encryption_mode}
  */
...
export interface ApplianceSsidRadiusServers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#host ApplianceSsid#host}
  */
  readonly host?: string;
  /**
  * The UDP port your RADIUS servers listens on for Access-requests.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#port ApplianceSsid#port}
  */
  readonly port?: number;
  /**
  * The RADIUS client shared secret.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#secret ApplianceSsid#secret}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid meraki_appliance_ssid}
*/
export class ApplianceSsid extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplianceSsid that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_ssid meraki_appliance_ssid} Resource
  *
  * @param scope The scope in which to define this construct
