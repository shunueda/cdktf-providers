// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_lan
...
export interface DataMerakiCellularGatewayLanConfig extends cdktf.TerraformMetaArguments {
  ...
  * Device serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_lan#serial DataMerakiCellularGatewayLan#serial}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_lan meraki_cellular_gateway_lan}
*/
export class DataMerakiCellularGatewayLan extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiCellularGatewayLan that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_lan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_lan meraki_cellular_gateway_lan} Data Source
  *
  * @param scope The scope in which to define this construct
