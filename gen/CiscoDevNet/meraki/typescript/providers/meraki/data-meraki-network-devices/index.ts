// https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_devices
...
export interface DataMerakiNetworkDevicesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_devices#network_id DataMerakiNetworkDevices#network_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_devices meraki_network_devices}
*/
export class DataMerakiNetworkDevices extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiNetworkDevices that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_devices#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_devices meraki_network_devices} Data Source
  *
  * @param scope The scope in which to define this construct
