// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/network_floor_plan
...
export interface DataMerakiNetworkFloorPlanConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/network_floor_plan#id DataMerakiNetworkFloorPlan#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/network_floor_plan#name DataMerakiNetworkFloorPlan#name}
  */
  readonly name?: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/network_floor_plan#network_id DataMerakiNetworkFloorPlan#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/network_floor_plan meraki_network_floor_plan}
*/
export class DataMerakiNetworkFloorPlan extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiNetworkFloorPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/network_floor_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/network_floor_plan meraki_network_floor_plan} Data Source
  *
  * @param scope The scope in which to define this construct
