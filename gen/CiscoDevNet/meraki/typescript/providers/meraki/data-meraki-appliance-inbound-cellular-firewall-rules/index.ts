// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_inbound_cellular_firewall_rules
...
export interface DataMerakiApplianceInboundCellularFirewallRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_inbound_cellular_firewall_rules#network_id DataMerakiApplianceInboundCellularFirewallRules#network_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_inbound_cellular_firewall_rules meraki_appliance_inbound_cellular_firewall_rules}
*/
export class DataMerakiApplianceInboundCellularFirewallRules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiApplianceInboundCellularFirewallRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_inbound_cellular_firewall_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_inbound_cellular_firewall_rules meraki_appliance_inbound_cellular_firewall_rules} Data Source
  *
  * @param scope The scope in which to define this construct
