// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/cellular_gateway_dhcp
...
export interface CellularGatewayDhcpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/cellular_gateway_dhcp#dhcp_lease_time CellularGatewayDhcp#dhcp_lease_time}
  */
  readonly dhcpLeaseTime: string;
  /**
  * list of fixed IPs representing the the DNS Name servers when the mode is `custom`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/cellular_gateway_dhcp#dns_custom_nameservers CellularGatewayDhcp#dns_custom_nameservers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/cellular_gateway_dhcp#dns_nameservers CellularGatewayDhcp#dns_nameservers}
  */
  readonly dnsNameservers: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/cellular_gateway_dhcp#network_id CellularGatewayDhcp#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/cellular_gateway_dhcp meraki_cellular_gateway_dhcp}
*/
export class CellularGatewayDhcp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CellularGatewayDhcp that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/cellular_gateway_dhcp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/cellular_gateway_dhcp meraki_cellular_gateway_dhcp} Resource
  *
  * @param scope The scope in which to define this construct
