// https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_traffic_shaping_uplink_bandwidth
...
export interface DataMerakiApplianceTrafficShapingUplinkBandwidthConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_traffic_shaping_uplink_bandwidth#network_id DataMerakiApplianceTrafficShapingUplinkBandwidth#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_traffic_shaping_uplink_bandwidth meraki_appliance_traffic_shaping_uplink_bandwidth}
*/
export class DataMerakiApplianceTrafficShapingUplinkBandwidth extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiApplianceTrafficShapingUplinkBandwidth that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_traffic_shaping_uplink_bandwidth#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_traffic_shaping_uplink_bandwidth meraki_appliance_traffic_shaping_uplink_bandwidth} Data Source
  *
  * @param scope The scope in which to define this construct
