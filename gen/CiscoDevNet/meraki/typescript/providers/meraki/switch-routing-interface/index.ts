// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface
...
export interface SwitchRoutingInterfaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#default_gateway SwitchRoutingInterface#default_gateway}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#interface_ip SwitchRoutingInterface#interface_ip}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#ipv6_address SwitchRoutingInterface#ipv6_address}
  */
  readonly ipv6Address?: string;
  /**
  * The IPv6 assignment mode for the interface. Can be either `eui-64` or `static`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#ipv6_assignment_mode SwitchRoutingInterface#ipv6_assignment_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#ipv6_gateway SwitchRoutingInterface#ipv6_gateway}
  */
  readonly ipv6Gateway?: string;
  /**
  * The IPv6 prefix of the interface. Required if IPv6 object is included.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#ipv6_prefix SwitchRoutingInterface#ipv6_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#mode SwitchRoutingInterface#mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#multicast_routing SwitchRoutingInterface#multicast_routing}
  */
  readonly multicastRouting?: string;
  /**
  * A friendly name or description for the interface or VLAN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#name SwitchRoutingInterface#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#ospf_settings_area SwitchRoutingInterface#ospf_settings_area}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#ospf_settings_cost SwitchRoutingInterface#ospf_settings_cost}
  */
  readonly ospfSettingsCost?: number;
  /**
  * When enabled, OSPF will not run on the interface, but the subnet will still be advertised.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#ospf_settings_is_passive_enabled SwitchRoutingInterface#ospf_settings_is_passive_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#ospf_settings_network_type SwitchRoutingInterface#ospf_settings_network_type}
  */
  readonly ospfSettingsNetworkType?: string;
  /**
  * Switch serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#serial SwitchRoutingInterface#serial}
  */
  readonly serial: string;
  /**
  * The network that this routed interface is on, in CIDR notation (ex. 10.1.1.0/24).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#subnet SwitchRoutingInterface#subnet}
  */
  readonly subnet?: string;
  /**
  * Switch Port ID when in Routed mode (CS 17.18 or higher required)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#switch_port_id SwitchRoutingInterface#switch_port_id}
  */
  readonly switchPortId?: string;
  /**
  * The VLAN this routed interface is on. VLAN must be between 1 and 4094.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#vlan_id SwitchRoutingInterface#vlan_id}
  */
  readonly vlanId?: number;
  /**
  * The name of the VRF this interface belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#vrf_name SwitchRoutingInterface#vrf_name}
  */
  readonly vrfName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface meraki_switch_routing_interface}
*/
export class SwitchRoutingInterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchRoutingInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_interface meraki_switch_routing_interface} Resource
  *
  * @param scope The scope in which to define this construct
