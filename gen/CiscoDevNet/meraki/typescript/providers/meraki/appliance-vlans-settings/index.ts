// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_vlans_settings
...
export interface ApplianceVlansSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_vlans_settings#network_id ApplianceVlansSettings#network_id}
  */
  readonly networkId: string;
  /**
  * Boolean indicating whether to enable (true) or disable (false) VLANs for the network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_vlans_settings#vlans_enabled ApplianceVlansSettings#vlans_enabled}
  */
  readonly vlansEnabled: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_vlans_settings meraki_appliance_vlans_settings}
*/
export class ApplianceVlansSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplianceVlansSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_vlans_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_vlans_settings meraki_appliance_vlans_settings} Resource
  *
  * @param scope The scope in which to define this construct
