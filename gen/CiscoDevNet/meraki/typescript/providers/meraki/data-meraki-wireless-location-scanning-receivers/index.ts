// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_location_scanning_receivers
...
export interface DataMerakiWirelessLocationScanningReceiversConfig extends cdktf.TerraformMetaArguments {
  ...
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_location_scanning_receivers#organization_id DataMerakiWirelessLocationScanningReceivers#organization_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_location_scanning_receivers meraki_wireless_location_scanning_receivers}
*/
export class DataMerakiWirelessLocationScanningReceivers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiWirelessLocationScanningReceivers that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_location_scanning_receivers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_location_scanning_receivers meraki_wireless_location_scanning_receivers} Data Source
  *
  * @param scope The scope in which to define this construct
