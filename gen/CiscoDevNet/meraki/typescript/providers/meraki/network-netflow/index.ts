// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_netflow
...
export interface NetworkNetflowConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_netflow#collector_ip NetworkNetflow#collector_ip}
  */
  readonly collectorIp?: string;
  /**
  * The port that the NetFlow collector will be listening on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_netflow#collector_port NetworkNetflow#collector_port}
  */
  readonly collectorPort?: number;
  /**
  * The port that the Encrypted Traffic Analytics collector will be listening on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_netflow#eta_dst_port NetworkNetflow#eta_dst_port}
  */
  readonly etaDstPort?: number;
  /**
  * Boolean indicating whether Encrypted Traffic Analytics is enabled (true) or disabled (false).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_netflow#eta_enabled NetworkNetflow#eta_enabled}
  */
  readonly etaEnabled?: boolean | cdktf.IResolvable;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_netflow#network_id NetworkNetflow#network_id}
  */
  readonly networkId: string;
  /**
  * Boolean indicating whether NetFlow traffic reporting is enabled (true) or disabled (false).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_netflow#reporting_enabled NetworkNetflow#reporting_enabled}
  */
  readonly reportingEnabled?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_netflow meraki_network_netflow}
*/
export class NetworkNetflow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkNetflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_netflow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_netflow meraki_network_netflow} Resource
  *
  * @param scope The scope in which to define this construct
