// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_lan
...
export interface CellularGatewayLanConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_lan#fixed_ip_assignments CellularGatewayLan#fixed_ip_assignments}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_lan#reserved_ip_ranges CellularGatewayLan#reserved_ip_ranges}
  */
  readonly reservedIpRanges: CellularGatewayLanReservedIpRanges[] | cdktf.IResolvable;
  /**
  * Device serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_lan#serial CellularGatewayLan#serial}
  */
...
export interface CellularGatewayLanFixedIpAssignments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_lan#ip CellularGatewayLan#ip}
  */
  readonly ip: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_lan#mac CellularGatewayLan#mac}
  */
  readonly mac: string;
  /**
  * A descriptive name of the assignment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_lan#name CellularGatewayLan#name}
  */
...
export interface CellularGatewayLanReservedIpRanges {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_lan#comment CellularGatewayLan#comment}
  */
  readonly comment: string;
  /**
  * Ending IP included in the reserved range of IPs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_lan#end CellularGatewayLan#end}
  */
  readonly end: string;
  /**
  * Starting IP included in the reserved range of IPs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_lan#start CellularGatewayLan#start}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_lan meraki_cellular_gateway_lan}
*/
export class CellularGatewayLan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CellularGatewayLan that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_lan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_lan meraki_cellular_gateway_lan} Resource
  *
  * @param scope The scope in which to define this construct
