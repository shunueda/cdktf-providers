// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_dhcp
...
export interface DataMerakiCellularGatewayDhcpConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_dhcp#network_id DataMerakiCellularGatewayDhcp#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_dhcp meraki_cellular_gateway_dhcp}
*/
export class DataMerakiCellularGatewayDhcp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiCellularGatewayDhcp that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_dhcp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_dhcp meraki_cellular_gateway_dhcp} Data Source
  *
  * @param scope The scope in which to define this construct
