// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule_order
...
export interface SwitchQosRuleOrderConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule_order#network_id SwitchQosRuleOrder#network_id}
  */
  readonly networkId: string;
  /**
  * A list of quality of service rule IDs arranged in order in which they should be processed by the switch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule_order#rule_ids SwitchQosRuleOrder#rule_ids}
  */
  readonly ruleIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule_order meraki_switch_qos_rule_order}
*/
export class SwitchQosRuleOrder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchQosRuleOrder that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule_order#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule_order meraki_switch_qos_rule_order} Resource
  *
  * @param scope The scope in which to define this construct
