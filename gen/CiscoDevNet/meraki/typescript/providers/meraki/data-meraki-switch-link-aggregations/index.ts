// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/switch_link_aggregations
...
export interface DataMerakiSwitchLinkAggregationsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/switch_link_aggregations#network_id DataMerakiSwitchLinkAggregations#network_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/switch_link_aggregations meraki_switch_link_aggregations}
*/
export class DataMerakiSwitchLinkAggregations extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiSwitchLinkAggregations that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/switch_link_aggregations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/switch_link_aggregations meraki_switch_link_aggregations} Data Source
  *
  * @param scope The scope in which to define this construct
