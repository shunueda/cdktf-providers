// https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/wireless_network_electronic_shelf_label
...
export interface DataMerakiWirelessNetworkElectronicShelfLabelConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/wireless_network_electronic_shelf_label#network_id DataMerakiWirelessNetworkElectronicShelfLabel#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/wireless_network_electronic_shelf_label meraki_wireless_network_electronic_shelf_label}
*/
export class DataMerakiWirelessNetworkElectronicShelfLabel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiWirelessNetworkElectronicShelfLabel that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/wireless_network_electronic_shelf_label#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/wireless_network_electronic_shelf_label meraki_wireless_network_electronic_shelf_label} Data Source
  *
  * @param scope The scope in which to define this construct
