// https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_vpn_firewall_rules
...
export interface DataMerakiApplianceVpnFirewallRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_vpn_firewall_rules#organization_id DataMerakiApplianceVpnFirewallRules#organization_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_vpn_firewall_rules meraki_appliance_vpn_firewall_rules}
*/
export class DataMerakiApplianceVpnFirewallRules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiApplianceVpnFirewallRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_vpn_firewall_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_vpn_firewall_rules meraki_appliance_vpn_firewall_rules} Data Source
  *
  * @param scope The scope in which to define this construct
