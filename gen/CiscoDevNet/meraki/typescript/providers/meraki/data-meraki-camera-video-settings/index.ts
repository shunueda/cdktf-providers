// https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/camera_video_settings
...
export interface DataMerakiCameraVideoSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Device serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/camera_video_settings#serial DataMerakiCameraVideoSettings#serial}
  */
  readonly serial: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/camera_video_settings meraki_camera_video_settings}
*/
export class DataMerakiCameraVideoSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiCameraVideoSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/camera_video_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/camera_video_settings meraki_camera_video_settings} Data Source
  *
  * @param scope The scope in which to define this construct
