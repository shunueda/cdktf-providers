// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/organization_branding_policies_priorities
...
export interface DataMerakiOrganizationBrandingPoliciesPrioritiesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/organization_branding_policies_priorities#organization_id DataMerakiOrganizationBrandingPoliciesPriorities#organization_id}
  */
  readonly organizationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/organization_branding_policies_priorities meraki_organization_branding_policies_priorities}
*/
export class DataMerakiOrganizationBrandingPoliciesPriorities extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiOrganizationBrandingPoliciesPriorities that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/organization_branding_policies_priorities#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/organization_branding_policies_priorities meraki_organization_branding_policies_priorities} Data Source
  *
  * @param scope The scope in which to define this construct
