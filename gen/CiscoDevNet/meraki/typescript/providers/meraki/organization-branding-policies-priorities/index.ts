// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_branding_policies_priorities
...
export interface OrganizationBrandingPoliciesPrioritiesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_branding_policies_priorities#branding_policy_ids OrganizationBrandingPoliciesPriorities#branding_policy_ids}
  */
  readonly brandingPolicyIds?: string[];
  /**
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_branding_policies_priorities#organization_id OrganizationBrandingPoliciesPriorities#organization_id}
  */
  readonly organizationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_branding_policies_priorities meraki_organization_branding_policies_priorities}
*/
export class OrganizationBrandingPoliciesPriorities extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationBrandingPoliciesPriorities that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_branding_policies_priorities#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_branding_policies_priorities meraki_organization_branding_policies_priorities} Resource
  *
  * @param scope The scope in which to define this construct
