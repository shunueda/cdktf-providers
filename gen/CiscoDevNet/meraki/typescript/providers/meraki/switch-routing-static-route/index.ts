// https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/switch_routing_static_route
...
export interface SwitchRoutingStaticRouteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/switch_routing_static_route#advertise_via_ospf_enabled SwitchRoutingStaticRoute#advertise_via_ospf_enabled}
  */
  readonly advertiseViaOspfEnabled?: boolean | cdktf.IResolvable;
  /**
  * Name or description for layer 3 static route
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/switch_routing_static_route#name SwitchRoutingStaticRoute#name}
  */
  readonly name?: string;
  /**
  * IP address of the next hop device to which the device sends its traffic for the subnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/switch_routing_static_route#next_hop_ip SwitchRoutingStaticRoute#next_hop_ip}
  */
  readonly nextHopIp: string;
  /**
  * Option to prefer static route over OSPF routes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/switch_routing_static_route#prefer_over_ospf_routes_enabled SwitchRoutingStaticRoute#prefer_over_ospf_routes_enabled}
  */
  readonly preferOverOspfRoutesEnabled?: boolean | cdktf.IResolvable;
  /**
  * Switch serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/switch_routing_static_route#serial SwitchRoutingStaticRoute#serial}
  */
  readonly serial: string;
  /**
  * The subnet which is routed via this static route and should be specified in CIDR notation (ex. 1.2.3.0/24)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/switch_routing_static_route#subnet SwitchRoutingStaticRoute#subnet}
  */
  readonly subnet: string;
  /**
  * Whether or not next-hop IP is reachable via default VRF
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/switch_routing_static_route#vrf_leak_route_to_default_vrf SwitchRoutingStaticRoute#vrf_leak_route_to_default_vrf}
  */
  readonly vrfLeakRouteToDefaultVrf?: boolean | cdktf.IResolvable;
  /**
  * The name of the VRF this static route belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/switch_routing_static_route#vrf_name SwitchRoutingStaticRoute#vrf_name}
  */
  readonly vrfName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/switch_routing_static_route meraki_switch_routing_static_route}
*/
export class SwitchRoutingStaticRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchRoutingStaticRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/switch_routing_static_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/switch_routing_static_route meraki_switch_routing_static_route} Resource
  *
  * @param scope The scope in which to define this construct
