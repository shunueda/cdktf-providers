// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_network_bluetooth_settings
...
export interface WirelessNetworkBluetoothSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_network_bluetooth_settings#advertising_enabled WirelessNetworkBluetoothSettings#advertising_enabled}
  */
  readonly advertisingEnabled?: boolean | cdktf.IResolvable;
  /**
  * The major number to be used in the beacon identifier. Only valid in `Non-unique` mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_network_bluetooth_settings#major WirelessNetworkBluetoothSettings#major}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_network_bluetooth_settings#major_minor_assignment_mode WirelessNetworkBluetoothSettings#major_minor_assignment_mode}
  */
  readonly majorMinorAssignmentMode?: string;
  /**
  * The minor number to be used in the beacon identifier. Only valid in `Non-unique` mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_network_bluetooth_settings#minor WirelessNetworkBluetoothSettings#minor}
  */
  readonly minor?: number;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_network_bluetooth_settings#network_id WirelessNetworkBluetoothSettings#network_id}
  */
  readonly networkId: string;
  /**
  * Whether APs will scan for Bluetooth enabled clients.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_network_bluetooth_settings#scanning_enabled WirelessNetworkBluetoothSettings#scanning_enabled}
  */
  readonly scanningEnabled?: boolean | cdktf.IResolvable;
  /**
  * The UUID to be used in the beacon identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_network_bluetooth_settings#uuid WirelessNetworkBluetoothSettings#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_network_bluetooth_settings meraki_wireless_network_bluetooth_settings}
*/
export class WirelessNetworkBluetoothSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WirelessNetworkBluetoothSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_network_bluetooth_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_network_bluetooth_settings meraki_wireless_network_bluetooth_settings} Resource
  *
  * @param scope The scope in which to define this construct
