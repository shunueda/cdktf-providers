// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_alerts_profiles
...
export interface DataMerakiOrganizationAlertsProfilesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_alerts_profiles#organization_id DataMerakiOrganizationAlertsProfiles#organization_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_alerts_profiles meraki_organization_alerts_profiles}
*/
export class DataMerakiOrganizationAlertsProfiles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiOrganizationAlertsProfiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_alerts_profiles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_alerts_profiles meraki_organization_alerts_profiles} Data Source
  *
  * @param scope The scope in which to define this construct
