// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_inventory_devices
...
export interface DataMerakiOrganizationInventoryDevicesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_inventory_devices#organization_id DataMerakiOrganizationInventoryDevices#organization_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_inventory_devices meraki_organization_inventory_devices}
*/
export class DataMerakiOrganizationInventoryDevices extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiOrganizationInventoryDevices that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_inventory_devices#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_inventory_devices meraki_organization_inventory_devices} Data Source
  *
  * @param scope The scope in which to define this construct
