// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_content_filtering
...
export interface ApplianceContentFilteringConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_content_filtering#allowed_url_patterns ApplianceContentFiltering#allowed_url_patterns}
  */
  readonly allowedUrlPatterns?: string[];
  /**
  * A list of URL categories to block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_content_filtering#blocked_url_categories ApplianceContentFiltering#blocked_url_categories}
  */
  readonly blockedUrlCategories?: string[];
  /**
  * A list of URL patterns that are blocked
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_content_filtering#blocked_url_patterns ApplianceContentFiltering#blocked_url_patterns}
  */
  readonly blockedUrlPatterns?: string[];
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_content_filtering#network_id ApplianceContentFiltering#network_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_content_filtering#url_category_list_size ApplianceContentFiltering#url_category_list_size}
  */
  readonly urlCategoryListSize?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_content_filtering meraki_appliance_content_filtering}
*/
export class ApplianceContentFiltering extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplianceContentFiltering that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_content_filtering#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_content_filtering meraki_appliance_content_filtering} Resource
  *
  * @param scope The scope in which to define this construct
