// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_warm_spare
...
export interface ApplianceWarmSpareConfig extends cdktf.TerraformMetaArguments {
  ...
  * Enable warm spare
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_warm_spare#enabled ApplianceWarmSpare#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_warm_spare#network_id ApplianceWarmSpare#network_id}
  */
  readonly networkId: string;
  /**
  * Serial number of the warm spare appliance
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_warm_spare#spare_serial ApplianceWarmSpare#spare_serial}
  */
  readonly spareSerial?: string;
  /**
  * Uplink mode, either virtual or public
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_warm_spare#uplink_mode ApplianceWarmSpare#uplink_mode}
  */
  readonly uplinkMode?: string;
  /**
  * The WAN 1 shared IP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_warm_spare#virtual_ip1 ApplianceWarmSpare#virtual_ip1}
  */
  readonly virtualIp1?: string;
  /**
  * The WAN 2 shared IP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_warm_spare#virtual_ip2 ApplianceWarmSpare#virtual_ip2}
  */
  readonly virtualIp2?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_warm_spare meraki_appliance_warm_spare}
*/
export class ApplianceWarmSpare extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplianceWarmSpare that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_warm_spare#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_warm_spare meraki_appliance_warm_spare} Resource
  *
  * @param scope The scope in which to define this construct
