// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/sensor_network_relationships
...
export interface DataMerakiSensorNetworkRelationshipsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/sensor_network_relationships#network_id DataMerakiSensorNetworkRelationships#network_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/sensor_network_relationships meraki_sensor_network_relationships}
*/
export class DataMerakiSensorNetworkRelationships extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiSensorNetworkRelationships that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/sensor_network_relationships#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/sensor_network_relationships meraki_sensor_network_relationships} Data Source
  *
  * @param scope The scope in which to define this construct
