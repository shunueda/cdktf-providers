// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_air_marshal_settings
...
export interface WirelessAirMarshalSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *   - Choices: `allow`, `block`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_air_marshal_settings#default_policy WirelessAirMarshalSettings#default_policy}
  */
  readonly defaultPolicy: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_air_marshal_settings#network_id WirelessAirMarshalSettings#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_air_marshal_settings meraki_wireless_air_marshal_settings}
*/
export class WirelessAirMarshalSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WirelessAirMarshalSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_air_marshal_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_air_marshal_settings meraki_wireless_air_marshal_settings} Resource
  *
  * @param scope The scope in which to define this construct
