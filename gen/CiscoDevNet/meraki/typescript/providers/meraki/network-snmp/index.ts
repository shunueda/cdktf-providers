// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_snmp
...
export interface NetworkSnmpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_snmp#access NetworkSnmp#access}
  */
  readonly access?: string;
  /**
  * The SNMP community string. Only relevant if `access` is set to `community`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_snmp#community_string NetworkSnmp#community_string}
  */
  readonly communityString?: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_snmp#network_id NetworkSnmp#network_id}
  */
  readonly networkId: string;
  /**
  * The list of SNMP users. Only relevant if `access` is set to `users`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_snmp#users NetworkSnmp#users}
  */
...
export interface NetworkSnmpUsers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_snmp#passphrase NetworkSnmp#passphrase}
  */
  readonly passphrase: string;
  /**
  * The username for the SNMP user. Required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_snmp#username NetworkSnmp#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_snmp meraki_network_snmp}
*/
export class NetworkSnmp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkSnmp that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_snmp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_snmp meraki_network_snmp} Resource
  *
  * @param scope The scope in which to define this construct
