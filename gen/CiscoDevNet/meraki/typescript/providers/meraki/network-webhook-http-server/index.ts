// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/network_webhook_http_server
...
export interface NetworkWebhookHttpServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/network_webhook_http_server#name NetworkWebhookHttpServer#name}
  */
  readonly name: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/network_webhook_http_server#network_id NetworkWebhookHttpServer#network_id}
  */
  readonly networkId: string;
  /**
  * The name of the payload template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/network_webhook_http_server#payload_template_name NetworkWebhookHttpServer#payload_template_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/network_webhook_http_server#payload_template_payload_template_id NetworkWebhookHttpServer#payload_template_payload_template_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/network_webhook_http_server#shared_secret NetworkWebhookHttpServer#shared_secret}
  */
  readonly sharedSecret?: string;
  /**
  * The URL of the HTTP server. Once set, cannot be updated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/network_webhook_http_server#url NetworkWebhookHttpServer#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/network_webhook_http_server meraki_network_webhook_http_server}
*/
export class NetworkWebhookHttpServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkWebhookHttpServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/network_webhook_http_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/network_webhook_http_server meraki_network_webhook_http_server} Resource
  *
  * @param scope The scope in which to define this construct
