// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_dns_local_profile_assignments
...
export interface ApplianceDnsLocalProfileAssignmentsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_dns_local_profile_assignments#items ApplianceDnsLocalProfileAssignments#items}
  */
  readonly items: ApplianceDnsLocalProfileAssignmentsItems[] | cdktf.IResolvable;
  /**
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_dns_local_profile_assignments#organization_id ApplianceDnsLocalProfileAssignments#organization_id}
  */
...
export interface ApplianceDnsLocalProfileAssignmentsItems {
  ...
  * ID of the network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_dns_local_profile_assignments#network_id ApplianceDnsLocalProfileAssignments#network_id}
  */
  readonly networkId: string;
  /**
  * ID of the profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_dns_local_profile_assignments#profile_id ApplianceDnsLocalProfileAssignments#profile_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_dns_local_profile_assignments meraki_appliance_dns_local_profile_assignments}
*/
export class ApplianceDnsLocalProfileAssignments extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplianceDnsLocalProfileAssignments that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_dns_local_profile_assignments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_dns_local_profile_assignments meraki_appliance_dns_local_profile_assignments} Resource
  *
  * @param scope The scope in which to define this construct
