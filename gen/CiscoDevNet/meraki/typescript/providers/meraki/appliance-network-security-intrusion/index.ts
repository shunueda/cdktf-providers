// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_network_security_intrusion
...
export interface ApplianceNetworkSecurityIntrusionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_network_security_intrusion#ids_rulesets ApplianceNetworkSecurityIntrusion#ids_rulesets}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_network_security_intrusion#mode ApplianceNetworkSecurityIntrusion#mode}
  */
  readonly mode?: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_network_security_intrusion#network_id ApplianceNetworkSecurityIntrusion#network_id}
  */
  readonly networkId: string;
  /**
  * list of IP addresses or subnets being excluded from protection (required if `useDefault` is false)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_network_security_intrusion#protected_networks_excluded_cidr ApplianceNetworkSecurityIntrusion#protected_networks_excluded_cidr}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_network_security_intrusion#protected_networks_included_cidr ApplianceNetworkSecurityIntrusion#protected_networks_included_cidr}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_network_security_intrusion#protected_networks_use_default ApplianceNetworkSecurityIntrusion#protected_networks_use_default}
  */
  readonly protectedNetworksUseDefault?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_network_security_intrusion meraki_appliance_network_security_intrusion}
*/
export class ApplianceNetworkSecurityIntrusion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplianceNetworkSecurityIntrusion that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_network_security_intrusion#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_network_security_intrusion meraki_appliance_network_security_intrusion} Resource
  *
  * @param scope The scope in which to define this construct
