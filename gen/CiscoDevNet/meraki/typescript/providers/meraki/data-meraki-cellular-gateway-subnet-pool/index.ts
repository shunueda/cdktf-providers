// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_subnet_pool
...
export interface DataMerakiCellularGatewaySubnetPoolConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_subnet_pool#network_id DataMerakiCellularGatewaySubnetPool#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_subnet_pool meraki_cellular_gateway_subnet_pool}
*/
export class DataMerakiCellularGatewaySubnetPool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiCellularGatewaySubnetPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_subnet_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_subnet_pool meraki_cellular_gateway_subnet_pool} Data Source
  *
  * @param scope The scope in which to define this construct
