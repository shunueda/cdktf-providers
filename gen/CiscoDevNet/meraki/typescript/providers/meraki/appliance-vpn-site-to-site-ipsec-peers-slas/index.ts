// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_vpn_site_to_site_ipsec_peers_slas
...
export interface ApplianceVpnSiteToSiteIpsecPeersSlasConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_vpn_site_to_site_ipsec_peers_slas#items ApplianceVpnSiteToSiteIpsecPeersSlas#items}
  */
  readonly items: ApplianceVpnSiteToSiteIpsecPeersSlasItems[] | cdktf.IResolvable;
  /**
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_vpn_site_to_site_ipsec_peers_slas#organization_id ApplianceVpnSiteToSiteIpsecPeersSlas#organization_id}
  */
...
export interface ApplianceVpnSiteToSiteIpsecPeersSlasItems {
  ...
  * SLA policy name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_vpn_site_to_site_ipsec_peers_slas#name ApplianceVpnSiteToSiteIpsecPeersSlas#name}
  */
  readonly name: string;
  /**
  * Endpoint for testing SLA
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_vpn_site_to_site_ipsec_peers_slas#uri ApplianceVpnSiteToSiteIpsecPeersSlas#uri}
  */
  readonly uri: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_vpn_site_to_site_ipsec_peers_slas meraki_appliance_vpn_site_to_site_ipsec_peers_slas}
*/
export class ApplianceVpnSiteToSiteIpsecPeersSlas extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplianceVpnSiteToSiteIpsecPeersSlas that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_vpn_site_to_site_ipsec_peers_slas#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_vpn_site_to_site_ipsec_peers_slas meraki_appliance_vpn_site_to_site_ipsec_peers_slas} Resource
  *
  * @param scope The scope in which to define this construct
