// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/appliance_rf_profiles
...
export interface DataMerakiApplianceRfProfilesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/appliance_rf_profiles#network_id DataMerakiApplianceRfProfiles#network_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/appliance_rf_profiles meraki_appliance_rf_profiles}
*/
export class DataMerakiApplianceRfProfiles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiApplianceRfProfiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/appliance_rf_profiles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/appliance_rf_profiles meraki_appliance_rf_profiles} Data Source
  *
  * @param scope The scope in which to define this construct
