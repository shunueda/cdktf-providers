// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_stp
...
export interface SwitchStpConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_stp#network_id SwitchStp#network_id}
  */
  readonly networkId: string;
  /**
  * The spanning tree protocol status in network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_stp#rstp_enabled SwitchStp#rstp_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_stp#stp_bridge_priority SwitchStp#stp_bridge_priority}
  */
...
export interface SwitchStpStpBridgePriority {
  ...
  * List of stack IDs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_stp#stacks SwitchStp#stacks}
  */
  readonly stacks?: string[];
  /**
  * STP priority for switch, stacks, or switch templates
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_stp#stp_priority SwitchStp#stp_priority}
  */
  readonly stpPriority: number;
  /**
  * List of switch template IDs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_stp#switch_profiles SwitchStp#switch_profiles}
  */
  readonly switchProfiles?: string[];
  /**
  * List of switch serial numbers
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_stp#switches SwitchStp#switches}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_stp meraki_switch_stp}
*/
export class SwitchStp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchStp that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_stp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_stp meraki_switch_stp} Resource
  *
  * @param scope The scope in which to define this construct
