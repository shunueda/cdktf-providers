// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_adaptive_policy_groups
...
export interface DataMerakiOrganizationAdaptivePolicyGroupsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_adaptive_policy_groups#organization_id DataMerakiOrganizationAdaptivePolicyGroups#organization_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_adaptive_policy_groups meraki_organization_adaptive_policy_groups}
*/
export class DataMerakiOrganizationAdaptivePolicyGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiOrganizationAdaptivePolicyGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_adaptive_policy_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_adaptive_policy_groups meraki_organization_adaptive_policy_groups} Data Source
  *
  * @param scope The scope in which to define this construct
