// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_sense
...
export interface CameraSenseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_sense#audio_detection_enabled CameraSense#audio_detection_enabled}
  */
  readonly audioDetectionEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the object detection model
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_sense#detection_model_id CameraSense#detection_model_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_sense#mqtt_broker_id CameraSense#mqtt_broker_id}
  */
  readonly mqttBrokerId?: string;
  /**
  * Boolean indicating if sense(license) is enabled(true) or disabled(false) on the camera
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_sense#sense_enabled CameraSense#sense_enabled}
  */
  readonly senseEnabled?: boolean | cdktf.IResolvable;
  /**
  * Device serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_sense#serial CameraSense#serial}
  */
  readonly serial: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_sense meraki_camera_sense}
*/
export class CameraSense extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CameraSense that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_sense#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_sense meraki_camera_sense} Resource
  *
  * @param scope The scope in which to define this construct
