// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/wireless_zigbee_door_lock
...
export interface DataMerakiWirelessZigbeeDoorLockConfig extends cdktf.TerraformMetaArguments {
  ...
  * Door lock ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/wireless_zigbee_door_lock#door_lock_id DataMerakiWirelessZigbeeDoorLock#door_lock_id}
  */
  readonly doorLockId: string;
  /**
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/wireless_zigbee_door_lock#organization_id DataMerakiWirelessZigbeeDoorLock#organization_id}
  */
  readonly organizationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/wireless_zigbee_door_lock meraki_wireless_zigbee_door_lock}
*/
export class DataMerakiWirelessZigbeeDoorLock extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiWirelessZigbeeDoorLock that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/wireless_zigbee_door_lock#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/wireless_zigbee_door_lock meraki_wireless_zigbee_door_lock} Data Source
  *
  * @param scope The scope in which to define this construct
