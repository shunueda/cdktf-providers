// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_alternate_management_interface
...
export interface SwitchAlternateManagementInterfaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_alternate_management_interface#enabled SwitchAlternateManagementInterface#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_alternate_management_interface#network_id SwitchAlternateManagementInterface#network_id}
  */
  readonly networkId: string;
  /**
  * Can be one or more of the following values: `radius`, `snmp` or `syslog`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_alternate_management_interface#protocols SwitchAlternateManagementInterface#protocols}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_alternate_management_interface#switches SwitchAlternateManagementInterface#switches}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_alternate_management_interface#vlan_id SwitchAlternateManagementInterface#vlan_id}
  */
...
export interface SwitchAlternateManagementInterfaceSwitches {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_alternate_management_interface#alternate_management_ip SwitchAlternateManagementInterface#alternate_management_ip}
  */
  readonly alternateManagementIp: string;
  /**
  * Switch gateway must be in IP format. Only and must be specified for Polaris switches
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_alternate_management_interface#gateway SwitchAlternateManagementInterface#gateway}
  */
  readonly gateway?: string;
  /**
  * Switch serial number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_alternate_management_interface#serial SwitchAlternateManagementInterface#serial}
  */
  readonly serial: string;
  /**
  * Switch subnet mask must be in IP format. Only and must be specified for Polaris switches
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_alternate_management_interface#subnet_mask SwitchAlternateManagementInterface#subnet_mask}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_alternate_management_interface meraki_switch_alternate_management_interface}
*/
export class SwitchAlternateManagementInterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchAlternateManagementInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_alternate_management_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_alternate_management_interface meraki_switch_alternate_management_interface} Resource
  *
  * @param scope The scope in which to define this construct
