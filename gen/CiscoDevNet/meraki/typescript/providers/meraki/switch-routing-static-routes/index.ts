// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_static_routes
...
export interface SwitchRoutingStaticRoutesConfig extends cdktf.TerraformMetaArguments {
  ...
  * The list of items
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_static_routes#items SwitchRoutingStaticRoutes#items}
  */
  readonly items: SwitchRoutingStaticRoutesItems[] | cdktf.IResolvable;
  /**
  * The organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_static_routes#organization_id SwitchRoutingStaticRoutes#organization_id}
  */
  readonly organizationId: string;
  /**
  * Switch serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_static_routes#serial SwitchRoutingStaticRoutes#serial}
  */
...
export interface SwitchRoutingStaticRoutesItems {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_static_routes#advertise_via_ospf_enabled SwitchRoutingStaticRoutes#advertise_via_ospf_enabled}
  */
  readonly advertiseViaOspfEnabled?: boolean | cdktf.IResolvable;
  /**
  * Name or description for layer 3 static route
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_static_routes#name SwitchRoutingStaticRoutes#name}
  */
  readonly name?: string;
  /**
  * IP address of the next hop device to which the device sends its traffic for the subnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_static_routes#next_hop_ip SwitchRoutingStaticRoutes#next_hop_ip}
  */
  readonly nextHopIp: string;
  /**
  * Option to prefer static route over OSPF routes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_static_routes#prefer_over_ospf_routes_enabled SwitchRoutingStaticRoutes#prefer_over_ospf_routes_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_static_routes#subnet SwitchRoutingStaticRoutes#subnet}
  */
  readonly subnet: string;
  /**
  * Whether or not next-hop IP is reachable via default VRF
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_static_routes#vrf_leak_route_to_default_vrf SwitchRoutingStaticRoutes#vrf_leak_route_to_default_vrf}
  */
  readonly vrfLeakRouteToDefaultVrf?: boolean | cdktf.IResolvable;
  /**
  * The name of the VRF this static route belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_static_routes#vrf_name SwitchRoutingStaticRoutes#vrf_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_static_routes meraki_switch_routing_static_routes}
*/
export class SwitchRoutingStaticRoutes extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchRoutingStaticRoutes that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_static_routes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_static_routes meraki_switch_routing_static_routes} Resource
  *
  * @param scope The scope in which to define this construct
