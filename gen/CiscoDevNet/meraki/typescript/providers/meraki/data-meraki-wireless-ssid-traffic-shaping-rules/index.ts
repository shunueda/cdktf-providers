// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_ssid_traffic_shaping_rules
...
export interface DataMerakiWirelessSsidTrafficShapingRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_ssid_traffic_shaping_rules#network_id DataMerakiWirelessSsidTrafficShapingRules#network_id}
  */
  readonly networkId: string;
  /**
  * Wireless SSID number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_ssid_traffic_shaping_rules#number DataMerakiWirelessSsidTrafficShapingRules#number}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_ssid_traffic_shaping_rules meraki_wireless_ssid_traffic_shaping_rules}
*/
export class DataMerakiWirelessSsidTrafficShapingRules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiWirelessSsidTrafficShapingRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_ssid_traffic_shaping_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_ssid_traffic_shaping_rules meraki_wireless_ssid_traffic_shaping_rules} Data Source
  *
  * @param scope The scope in which to define this construct
