// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee_door_lock
...
export interface WirelessZigbeeDoorLockConfig extends cdktf.TerraformMetaArguments {
  ...
  * Door lock ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee_door_lock#door_lock_id WirelessZigbeeDoorLock#door_lock_id}
  */
  readonly doorLockId: string;
  /**
  * Door lock name to update
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee_door_lock#name WirelessZigbeeDoorLock#name}
  */
  readonly name?: string;
  /**
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee_door_lock#organization_id WirelessZigbeeDoorLock#organization_id}
  */
  readonly organizationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee_door_lock meraki_wireless_zigbee_door_lock}
*/
export class WirelessZigbeeDoorLock extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WirelessZigbeeDoorLock that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee_door_lock#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee_door_lock meraki_wireless_zigbee_door_lock} Resource
  *
  * @param scope The scope in which to define this construct
