// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_point
...
export interface SwitchRoutingMulticastRendezvousPointConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_point#interface_ip SwitchRoutingMulticastRendezvousPoint#interface_ip}
  */
  readonly interfaceIp: string;
  /**
  * `Any`, or the IP address of a multicast group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_point#multicast_group SwitchRoutingMulticastRendezvousPoint#multicast_group}
  */
  readonly multicastGroup: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_point#network_id SwitchRoutingMulticastRendezvousPoint#network_id}
  */
  readonly networkId: string;
  /**
  * The name of the VRF
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_point#vrf_name SwitchRoutingMulticastRendezvousPoint#vrf_name}
  */
  readonly vrfName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_point meraki_switch_routing_multicast_rendezvous_point}
*/
export class SwitchRoutingMulticastRendezvousPoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchRoutingMulticastRendezvousPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_point#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_point meraki_switch_routing_multicast_rendezvous_point} Resource
  *
  * @param scope The scope in which to define this construct
