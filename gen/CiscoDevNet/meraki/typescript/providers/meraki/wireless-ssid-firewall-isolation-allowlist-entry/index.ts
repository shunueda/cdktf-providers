// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_firewall_isolation_allowlist_entry
...
export interface WirelessSsidFirewallIsolationAllowlistEntryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_firewall_isolation_allowlist_entry#client_mac WirelessSsidFirewallIsolationAllowlistEntry#client_mac}
  */
  readonly clientMac: string;
  /**
  * The description of mac address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_firewall_isolation_allowlist_entry#description WirelessSsidFirewallIsolationAllowlistEntry#description}
  */
  readonly description?: string;
  /**
  * The ID of network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_firewall_isolation_allowlist_entry#network_id WirelessSsidFirewallIsolationAllowlistEntry#network_id}
  */
  readonly networkId: string;
  /**
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_firewall_isolation_allowlist_entry#organization_id WirelessSsidFirewallIsolationAllowlistEntry#organization_id}
  */
  readonly organizationId: string;
  /**
  * The number of SSID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_firewall_isolation_allowlist_entry#ssid_number WirelessSsidFirewallIsolationAllowlistEntry#ssid_number}
  */
  readonly ssidNumber: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_firewall_isolation_allowlist_entry meraki_wireless_ssid_firewall_isolation_allowlist_entry}
*/
export class WirelessSsidFirewallIsolationAllowlistEntry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WirelessSsidFirewallIsolationAllowlistEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_firewall_isolation_allowlist_entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/wireless_ssid_firewall_isolation_allowlist_entry meraki_wireless_ssid_firewall_isolation_allowlist_entry} Resource
  *
  * @param scope The scope in which to define this construct
