// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces
...
export interface SwitchRoutingInterfacesConfig extends cdktf.TerraformMetaArguments {
  ...
  * The list of items
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#items SwitchRoutingInterfaces#items}
  */
  readonly items: SwitchRoutingInterfacesItems[] | cdktf.IResolvable;
  /**
  * The organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#organization_id SwitchRoutingInterfaces#organization_id}
  */
  readonly organizationId: string;
  /**
  * Switch serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#serial SwitchRoutingInterfaces#serial}
  */
...
export interface SwitchRoutingInterfacesItems {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#default_gateway SwitchRoutingInterfaces#default_gateway}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#interface_ip SwitchRoutingInterfaces#interface_ip}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#ipv6_address SwitchRoutingInterfaces#ipv6_address}
  */
  readonly ipv6Address?: string;
  /**
  * The IPv6 assignment mode for the interface. Can be either `eui-64` or `static`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#ipv6_assignment_mode SwitchRoutingInterfaces#ipv6_assignment_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#ipv6_gateway SwitchRoutingInterfaces#ipv6_gateway}
  */
  readonly ipv6Gateway?: string;
  /**
  * The IPv6 prefix of the interface. Required if IPv6 object is included.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#ipv6_prefix SwitchRoutingInterfaces#ipv6_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#mode SwitchRoutingInterfaces#mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#multicast_routing SwitchRoutingInterfaces#multicast_routing}
  */
  readonly multicastRouting?: string;
  /**
  * A friendly name or description for the interface or VLAN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#name SwitchRoutingInterfaces#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#ospf_settings_area SwitchRoutingInterfaces#ospf_settings_area}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#ospf_settings_cost SwitchRoutingInterfaces#ospf_settings_cost}
  */
  readonly ospfSettingsCost?: number;
  /**
  * When enabled, OSPF will not run on the interface, but the subnet will still be advertised.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#ospf_settings_is_passive_enabled SwitchRoutingInterfaces#ospf_settings_is_passive_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#ospf_settings_network_type SwitchRoutingInterfaces#ospf_settings_network_type}
  */
  readonly ospfSettingsNetworkType?: string;
  /**
  * The network that this routed interface is on, in CIDR notation (ex. 10.1.1.0/24).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#subnet SwitchRoutingInterfaces#subnet}
  */
  readonly subnet?: string;
  /**
  * Switch Port ID when in Routed mode (CS 17.18 or higher required)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#switch_port_id SwitchRoutingInterfaces#switch_port_id}
  */
  readonly switchPortId?: string;
  /**
  * The VLAN this routed interface is on. VLAN must be between 1 and 4094.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#vlan_id SwitchRoutingInterfaces#vlan_id}
  */
  readonly vlanId?: number;
  /**
  * The name of the VRF this interface belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#vrf_name SwitchRoutingInterfaces#vrf_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces meraki_switch_routing_interfaces}
*/
export class SwitchRoutingInterfaces extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchRoutingInterfaces that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/switch_routing_interfaces meraki_switch_routing_interfaces} Resource
  *
  * @param scope The scope in which to define this construct
