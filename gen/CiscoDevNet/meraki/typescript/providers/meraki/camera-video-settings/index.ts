// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_video_settings
...
export interface CameraVideoSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_video_settings#external_rtsp_enabled CameraVideoSettings#external_rtsp_enabled}
  */
  readonly externalRtspEnabled: boolean | cdktf.IResolvable;
  /**
  * Device serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_video_settings#serial CameraVideoSettings#serial}
  */
  readonly serial: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_video_settings meraki_camera_video_settings}
*/
export class CameraVideoSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CameraVideoSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_video_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/camera_video_settings meraki_camera_video_settings} Resource
  *
  * @param scope The scope in which to define this construct
