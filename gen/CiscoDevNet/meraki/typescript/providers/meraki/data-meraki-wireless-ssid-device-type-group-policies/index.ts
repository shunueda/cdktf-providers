// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_ssid_device_type_group_policies
...
export interface DataMerakiWirelessSsidDeviceTypeGroupPoliciesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_ssid_device_type_group_policies#network_id DataMerakiWirelessSsidDeviceTypeGroupPolicies#network_id}
  */
  readonly networkId: string;
  /**
  * Wireless SSID number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_ssid_device_type_group_policies#number DataMerakiWirelessSsidDeviceTypeGroupPolicies#number}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_ssid_device_type_group_policies meraki_wireless_ssid_device_type_group_policies}
*/
export class DataMerakiWirelessSsidDeviceTypeGroupPolicies extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiWirelessSsidDeviceTypeGroupPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_ssid_device_type_group_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/wireless_ssid_device_type_group_policies meraki_wireless_ssid_device_type_group_policies} Data Source
  *
  * @param scope The scope in which to define this construct
