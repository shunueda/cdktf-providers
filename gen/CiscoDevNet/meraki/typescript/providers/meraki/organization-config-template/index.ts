// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_config_template
...
export interface OrganizationConfigTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_config_template#copy_from_network_id OrganizationConfigTemplate#copy_from_network_id}
  */
  readonly copyFromNetworkId?: string;
  /**
  * The name of the configuration template
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_config_template#name OrganizationConfigTemplate#name}
  */
  readonly name: string;
  /**
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_config_template#organization_id OrganizationConfigTemplate#organization_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_config_template#time_zone OrganizationConfigTemplate#time_zone}
  */
  readonly timeZone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_config_template meraki_organization_config_template}
*/
export class OrganizationConfigTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationConfigTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_config_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_config_template meraki_organization_config_template} Resource
  *
  * @param scope The scope in which to define this construct
