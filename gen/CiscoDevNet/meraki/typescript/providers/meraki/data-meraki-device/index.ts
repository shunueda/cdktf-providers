// https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/device
...
export interface DataMerakiDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  * Switch serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/device#serial DataMerakiDevice#serial}
  */
  readonly serial: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/device meraki_device}
*/
export class DataMerakiDevice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/device meraki_device} Data Source
  *
  * @param scope The scope in which to define this construct
