// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_uplink
...
export interface DataMerakiCellularGatewayUplinkConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_uplink#network_id DataMerakiCellularGatewayUplink#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_uplink meraki_cellular_gateway_uplink}
*/
export class DataMerakiCellularGatewayUplink extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiCellularGatewayUplink that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_uplink#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/cellular_gateway_uplink meraki_cellular_gateway_uplink} Data Source
  *
  * @param scope The scope in which to define this construct
