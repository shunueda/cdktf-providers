// https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/camera_quality_retention_profiles
...
export interface DataMerakiCameraQualityRetentionProfilesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/camera_quality_retention_profiles#network_id DataMerakiCameraQualityRetentionProfiles#network_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/camera_quality_retention_profiles meraki_camera_quality_retention_profiles}
*/
export class DataMerakiCameraQualityRetentionProfiles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiCameraQualityRetentionProfiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/camera_quality_retention_profiles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/camera_quality_retention_profiles meraki_camera_quality_retention_profiles} Data Source
  *
  * @param scope The scope in which to define this construct
