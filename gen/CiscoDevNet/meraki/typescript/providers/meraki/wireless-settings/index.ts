// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_settings
...
export interface WirelessSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_settings#ipv6_bridge_enabled WirelessSettings#ipv6_bridge_enabled}
  */
  readonly ipv6BridgeEnabled?: boolean | cdktf.IResolvable;
  /**
  * Toggle for enabling or disabling LED lights on all APs in the network (making them run dark)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_settings#led_lights_on WirelessSettings#led_lights_on}
  */
  readonly ledLightsOn?: boolean | cdktf.IResolvable;
  /**
  * Toggle for enabling or disabling location analytics for your network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_settings#location_analytics_enabled WirelessSettings#location_analytics_enabled}
  */
  readonly locationAnalyticsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Toggle for enabling or disabling meshing in a network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_settings#meshing_enabled WirelessSettings#meshing_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_settings#named_vlans_pool_dhcp_monitoring_duration WirelessSettings#named_vlans_pool_dhcp_monitoring_duration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_settings#named_vlans_pool_dhcp_monitoring_enabled WirelessSettings#named_vlans_pool_dhcp_monitoring_enabled}
  */
  readonly namedVlansPoolDhcpMonitoringEnabled?: boolean | cdktf.IResolvable;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_settings#network_id WirelessSettings#network_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_settings#upgrade_strategy WirelessSettings#upgrade_strategy}
  */
  readonly upgradeStrategy?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_settings meraki_wireless_settings}
*/
export class WirelessSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WirelessSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_settings meraki_wireless_settings} Resource
  *
  * @param scope The scope in which to define this construct
