// https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_vlan_profile_assignments_by_device
...
export interface DataMerakiNetworkVlanProfileAssignmentsByDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_vlan_profile_assignments_by_device#network_id DataMerakiNetworkVlanProfileAssignmentsByDevice#network_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_vlan_profile_assignments_by_device meraki_network_vlan_profile_assignments_by_device}
*/
export class DataMerakiNetworkVlanProfileAssignmentsByDevice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiNetworkVlanProfileAssignmentsByDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_vlan_profile_assignments_by_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_vlan_profile_assignments_by_device meraki_network_vlan_profile_assignments_by_device} Data Source
  *
  * @param scope The scope in which to define this construct
