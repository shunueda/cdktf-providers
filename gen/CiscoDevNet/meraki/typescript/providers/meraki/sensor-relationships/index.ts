// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/sensor_relationships
...
export interface SensorRelationshipsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/sensor_relationships#livestream_related_devices SensorRelationships#livestream_related_devices}
  */
  readonly livestreamRelatedDevices?: SensorRelationshipsLivestreamRelatedDevices[] | cdktf.IResolvable;
  /**
  * Device serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/sensor_relationships#serial SensorRelationships#serial}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/sensor_relationships meraki_sensor_relationships}
*/
export class SensorRelationships extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SensorRelationships that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/sensor_relationships#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/sensor_relationships meraki_sensor_relationships} Resource
  *
  * @param scope The scope in which to define this construct
