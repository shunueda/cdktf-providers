// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/switch_stack_routing_static_routes
...
export interface DataMerakiSwitchStackRoutingStaticRoutesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/switch_stack_routing_static_routes#network_id DataMerakiSwitchStackRoutingStaticRoutes#network_id}
  */
  readonly networkId: string;
  /**
  * Switch stack ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/switch_stack_routing_static_routes#switch_stack_id DataMerakiSwitchStackRoutingStaticRoutes#switch_stack_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/switch_stack_routing_static_routes meraki_switch_stack_routing_static_routes}
*/
export class DataMerakiSwitchStackRoutingStaticRoutes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiSwitchStackRoutingStaticRoutes that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/switch_stack_routing_static_routes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/switch_stack_routing_static_routes meraki_switch_stack_routing_static_routes} Data Source
  *
  * @param scope The scope in which to define this construct
