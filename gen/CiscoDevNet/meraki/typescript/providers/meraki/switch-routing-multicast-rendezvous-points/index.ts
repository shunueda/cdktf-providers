// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_points
...
export interface SwitchRoutingMulticastRendezvousPointsConfig extends cdktf.TerraformMetaArguments {
  ...
  * The list of items
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_points#items SwitchRoutingMulticastRendezvousPoints#items}
  */
  readonly items: SwitchRoutingMulticastRendezvousPointsItems[] | cdktf.IResolvable;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_points#network_id SwitchRoutingMulticastRendezvousPoints#network_id}
  */
  readonly networkId: string;
  /**
  * The organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_points#organization_id SwitchRoutingMulticastRendezvousPoints#organization_id}
  */
...
export interface SwitchRoutingMulticastRendezvousPointsItems {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_points#interface_ip SwitchRoutingMulticastRendezvousPoints#interface_ip}
  */
  readonly interfaceIp: string;
  /**
  * `Any`, or the IP address of a multicast group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_points#multicast_group SwitchRoutingMulticastRendezvousPoints#multicast_group}
  */
  readonly multicastGroup: string;
  /**
  * The name of the VRF
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_points#vrf_name SwitchRoutingMulticastRendezvousPoints#vrf_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_points meraki_switch_routing_multicast_rendezvous_points}
*/
export class SwitchRoutingMulticastRendezvousPoints extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchRoutingMulticastRendezvousPoints that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_points#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_routing_multicast_rendezvous_points meraki_switch_routing_multicast_rendezvous_points} Resource
  *
  * @param scope The scope in which to define this construct
