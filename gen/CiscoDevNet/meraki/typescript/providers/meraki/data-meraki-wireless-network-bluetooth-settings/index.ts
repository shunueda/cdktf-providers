// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/wireless_network_bluetooth_settings
...
export interface DataMerakiWirelessNetworkBluetoothSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/wireless_network_bluetooth_settings#network_id DataMerakiWirelessNetworkBluetoothSettings#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/wireless_network_bluetooth_settings meraki_wireless_network_bluetooth_settings}
*/
export class DataMerakiWirelessNetworkBluetoothSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiWirelessNetworkBluetoothSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/wireless_network_bluetooth_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/wireless_network_bluetooth_settings meraki_wireless_network_bluetooth_settings} Data Source
  *
  * @param scope The scope in which to define this construct
