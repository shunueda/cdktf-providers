// https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_settings
...
export interface DataMerakiNetworkSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_settings#network_id DataMerakiNetworkSettings#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_settings meraki_network_settings}
*/
export class DataMerakiNetworkSettings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiNetworkSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/network_settings meraki_network_settings} Data Source
  *
  * @param scope The scope in which to define this construct
