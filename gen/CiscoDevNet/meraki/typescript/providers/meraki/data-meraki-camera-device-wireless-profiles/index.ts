// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/camera_device_wireless_profiles
...
export interface DataMerakiCameraDeviceWirelessProfilesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Device serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/camera_device_wireless_profiles#serial DataMerakiCameraDeviceWirelessProfiles#serial}
  */
  readonly serial: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/camera_device_wireless_profiles meraki_camera_device_wireless_profiles}
*/
export class DataMerakiCameraDeviceWirelessProfiles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiCameraDeviceWirelessProfiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/camera_device_wireless_profiles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/camera_device_wireless_profiles meraki_camera_device_wireless_profiles} Data Source
  *
  * @param scope The scope in which to define this construct
