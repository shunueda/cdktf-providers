// https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_connectivity_monitoring_destinations
...
export interface DataMerakiApplianceConnectivityMonitoringDestinationsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_connectivity_monitoring_destinations#network_id DataMerakiApplianceConnectivityMonitoringDestinations#network_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_connectivity_monitoring_destinations meraki_appliance_connectivity_monitoring_destinations}
*/
export class DataMerakiApplianceConnectivityMonitoringDestinations extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiApplianceConnectivityMonitoringDestinations that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_connectivity_monitoring_destinations#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/appliance_connectivity_monitoring_destinations meraki_appliance_connectivity_monitoring_destinations} Data Source
  *
  * @param scope The scope in which to define this construct
