// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces
...
export interface SwitchStackRoutingInterfacesConfig extends cdktf.TerraformMetaArguments {
  ...
  * The list of items
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#items SwitchStackRoutingInterfaces#items}
  */
  readonly items: SwitchStackRoutingInterfacesItems[] | cdktf.IResolvable;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#network_id SwitchStackRoutingInterfaces#network_id}
  */
  readonly networkId: string;
  /**
  * The organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#organization_id SwitchStackRoutingInterfaces#organization_id}
  */
  readonly organizationId: string;
  /**
  * Switch stack ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#switch_stack_id SwitchStackRoutingInterfaces#switch_stack_id}
  */
...
export interface SwitchStackRoutingInterfacesItems {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#default_gateway SwitchStackRoutingInterfaces#default_gateway}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#interface_ip SwitchStackRoutingInterfaces#interface_ip}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#ipv6_address SwitchStackRoutingInterfaces#ipv6_address}
  */
  readonly ipv6Address?: string;
  /**
  * The IPv6 assignment mode for the interface. Can be either `eui-64` or `static`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#ipv6_assignment_mode SwitchStackRoutingInterfaces#ipv6_assignment_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#ipv6_gateway SwitchStackRoutingInterfaces#ipv6_gateway}
  */
  readonly ipv6Gateway?: string;
  /**
  * The IPv6 prefix of the interface. Required if IPv6 object is included.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#ipv6_prefix SwitchStackRoutingInterfaces#ipv6_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#mode SwitchStackRoutingInterfaces#mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#multicast_routing SwitchStackRoutingInterfaces#multicast_routing}
  */
  readonly multicastRouting?: string;
  /**
  * A friendly name or description for the interface or VLAN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#name SwitchStackRoutingInterfaces#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#ospf_settings_area SwitchStackRoutingInterfaces#ospf_settings_area}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#ospf_settings_cost SwitchStackRoutingInterfaces#ospf_settings_cost}
  */
  readonly ospfSettingsCost?: number;
  /**
  * When enabled, OSPF will not run on the interface, but the subnet will still be advertised.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#ospf_settings_is_passive_enabled SwitchStackRoutingInterfaces#ospf_settings_is_passive_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#ospf_settings_network_type SwitchStackRoutingInterfaces#ospf_settings_network_type}
  */
  readonly ospfSettingsNetworkType?: string;
  /**
  * The network that this routed interface is on, in CIDR notation (ex. 10.1.1.0/24).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#subnet SwitchStackRoutingInterfaces#subnet}
  */
  readonly subnet?: string;
  /**
  * Switch Port ID when in Routed mode (CS 17.18 or higher required)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#switch_port_id SwitchStackRoutingInterfaces#switch_port_id}
  */
  readonly switchPortId?: string;
  /**
  * The VLAN this routed interface is on. VLAN must be between 1 and 4094.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#vlan_id SwitchStackRoutingInterfaces#vlan_id}
  */
  readonly vlanId: number;
  /**
  * The name of the VRF this interface belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#vrf_name SwitchStackRoutingInterfaces#vrf_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces meraki_switch_stack_routing_interfaces}
*/
export class SwitchStackRoutingInterfaces extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchStackRoutingInterfaces that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_stack_routing_interfaces meraki_switch_stack_routing_interfaces} Resource
  *
  * @param scope The scope in which to define this construct
