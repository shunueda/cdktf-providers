// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn
...
export interface WirelessSsidVpnConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#concentrator_network_id WirelessSsidVpn#concentrator_network_id}
  */
  readonly concentratorNetworkId?: string;
  /**
  * The VLAN that should be tagged for the concentrator.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#concentrator_vlan_id WirelessSsidVpn#concentrator_vlan_id}
  */
  readonly concentratorVlanId?: number;
  /**
  * Idle timer interval in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#failover_heartbeat_interval WirelessSsidVpn#failover_heartbeat_interval}
  */
  readonly failoverHeartbeatInterval?: number;
  /**
  * Idle timer timeout in seconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#failover_idle_timeout WirelessSsidVpn#failover_idle_timeout}
  */
  readonly failoverIdleTimeout?: number;
  /**
  * IP addressed reserved on DHCP server where SSID will terminate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#failover_request_ip WirelessSsidVpn#failover_request_ip}
  */
  readonly failoverRequestIp?: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#network_id WirelessSsidVpn#network_id}
  */
  readonly networkId: string;
  /**
  * Wireless SSID number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#number WirelessSsidVpn#number}
  */
  readonly number: string;
  /**
  * If true, VPN split tunnel is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#split_tunnel_enabled WirelessSsidVpn#split_tunnel_enabled}
  */
  readonly splitTunnelEnabled?: boolean | cdktf.IResolvable;
  /**
  * List of VPN split tunnel rules.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#split_tunnel_rules WirelessSsidVpn#split_tunnel_rules}
  */
...
export interface WirelessSsidVpnSplitTunnelRules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#comment WirelessSsidVpn#comment}
  */
  readonly comment?: string;
  /**
  * Destination for this split tunnel rule. IP address, fully-qualified domain names (FQDN) or `any`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#dest_cidr WirelessSsidVpn#dest_cidr}
  */
  readonly destCidr: string;
  /**
  * Destination port for this split tunnel rule, (integer in the range 1-65535), or `any`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#dest_port WirelessSsidVpn#dest_port}
  */
  readonly destPort?: string;
  /**
  * Traffic policy specified for this split tunnel rule, `allow` or `deny`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#policy WirelessSsidVpn#policy}
  */
  ...
  *   - Choices: `Any`, `TCP`, `UDP`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#protocol WirelessSsidVpn#protocol}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn meraki_wireless_ssid_vpn}
*/
export class WirelessSsidVpn extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WirelessSsidVpn that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_ssid_vpn meraki_wireless_ssid_vpn} Resource
  *
  * @param scope The scope in which to define this construct
