// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dscp_to_cos_mappings
...
export interface SwitchDscpToCosMappingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dscp_to_cos_mappings#mappings SwitchDscpToCosMappings#mappings}
  */
  readonly mappings: SwitchDscpToCosMappingsMappings[] | cdktf.IResolvable;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dscp_to_cos_mappings#network_id SwitchDscpToCosMappings#network_id}
  */
...
export interface SwitchDscpToCosMappingsMappings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dscp_to_cos_mappings#cos SwitchDscpToCosMappings#cos}
  */
  readonly cos: number;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dscp_to_cos_mappings#dscp SwitchDscpToCosMappings#dscp}
  */
  readonly dscp: number;
  /**
  * Label for the mapping (optional).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dscp_to_cos_mappings#title SwitchDscpToCosMappings#title}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dscp_to_cos_mappings meraki_switch_dscp_to_cos_mappings}
*/
export class SwitchDscpToCosMappings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchDscpToCosMappings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dscp_to_cos_mappings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dscp_to_cos_mappings meraki_switch_dscp_to_cos_mappings} Resource
  *
  * @param scope The scope in which to define this construct
