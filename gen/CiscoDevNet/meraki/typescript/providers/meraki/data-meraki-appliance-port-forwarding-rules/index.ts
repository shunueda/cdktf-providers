// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_port_forwarding_rules
...
export interface DataMerakiAppliancePortForwardingRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_port_forwarding_rules#network_id DataMerakiAppliancePortForwardingRules#network_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_port_forwarding_rules meraki_appliance_port_forwarding_rules}
*/
export class DataMerakiAppliancePortForwardingRules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiAppliancePortForwardingRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_port_forwarding_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_port_forwarding_rules meraki_appliance_port_forwarding_rules} Data Source
  *
  * @param scope The scope in which to define this construct
