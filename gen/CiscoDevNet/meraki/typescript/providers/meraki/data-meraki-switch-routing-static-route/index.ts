// https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/switch_routing_static_route
...
export interface DataMerakiSwitchRoutingStaticRouteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/switch_routing_static_route#id DataMerakiSwitchRoutingStaticRoute#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/switch_routing_static_route#name DataMerakiSwitchRoutingStaticRoute#name}
  */
  readonly name?: string;
  /**
  * Switch serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/switch_routing_static_route#serial DataMerakiSwitchRoutingStaticRoute#serial}
  */
  readonly serial: string;
  /**
  * The name of the VRF this static route belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/switch_routing_static_route#vrf_name DataMerakiSwitchRoutingStaticRoute#vrf_name}
  */
  readonly vrfName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/switch_routing_static_route meraki_switch_routing_static_route}
*/
export class DataMerakiSwitchRoutingStaticRoute extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiSwitchRoutingStaticRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/switch_routing_static_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/switch_routing_static_route meraki_switch_routing_static_route} Data Source
  *
  * @param scope The scope in which to define this construct
