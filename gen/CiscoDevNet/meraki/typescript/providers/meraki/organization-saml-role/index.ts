// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_saml_role
...
export interface OrganizationSamlRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_saml_role#networks OrganizationSamlRole#networks}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_saml_role#org_access OrganizationSamlRole#org_access}
  */
  readonly orgAccess: string;
  /**
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_saml_role#organization_id OrganizationSamlRole#organization_id}
  */
  readonly organizationId: string;
  /**
  * The role of the SAML administrator
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_saml_role#role OrganizationSamlRole#role}
  */
  readonly role: string;
  /**
  * The list of tags that the SAML administrator has privileges on
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_saml_role#tags OrganizationSamlRole#tags}
  */
  readonly tags?: OrganizationSamlRoleTags[] | cdktf.IResolvable;
}
export interface OrganizationSamlRoleNetworks {
  /**
  * The privilege of the SAML administrator on the network. Can be one of `full`, `read-only`, `guest-ambassador`, `monitor-only`, `ssid-admin`, `port-tags`, `switchport` or `custom-role`
  *   - Choices: `full`, `guest-ambassador`, `monitor-only`, `read-only`, `ssid-admin`, `port-tags`, `switchport`, `custom-role`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_saml_role#access OrganizationSamlRole#access}
  */
  readonly access: string;
  /**
  * The network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_saml_role#id OrganizationSamlRole#id}
  *
...
export interface OrganizationSamlRoleTags {
  ...
  * The name of the tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_saml_role#tag OrganizationSamlRole#tag}
  */
  readonly tag: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_saml_role meraki_organization_saml_role}
*/
export class OrganizationSamlRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationSamlRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_saml_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_saml_role meraki_organization_saml_role} Resource
  *
  * @param scope The scope in which to define this construct
