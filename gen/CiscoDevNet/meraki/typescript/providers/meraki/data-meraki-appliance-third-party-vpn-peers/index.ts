// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_third_party_vpn_peers
...
export interface DataMerakiApplianceThirdPartyVpnPeersConfig extends cdktf.TerraformMetaArguments {
  ...
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_third_party_vpn_peers#organization_id DataMerakiApplianceThirdPartyVpnPeers#organization_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_third_party_vpn_peers meraki_appliance_third_party_vpn_peers}
*/
export class DataMerakiApplianceThirdPartyVpnPeers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiApplianceThirdPartyVpnPeers that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_third_party_vpn_peers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_third_party_vpn_peers meraki_appliance_third_party_vpn_peers} Data Source
  *
  * @param scope The scope in which to define this construct
