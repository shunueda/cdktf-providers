// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_saml_idps
...
export interface DataMerakiOrganizationSamlIdpsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_saml_idps#organization_id DataMerakiOrganizationSamlIdps#organization_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_saml_idps meraki_organization_saml_idps}
*/
export class DataMerakiOrganizationSamlIdps extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiOrganizationSamlIdps that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_saml_idps#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_saml_idps meraki_organization_saml_idps} Data Source
  *
  * @param scope The scope in which to define this construct
