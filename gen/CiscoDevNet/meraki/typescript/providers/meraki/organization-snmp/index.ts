// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_snmp
...
export interface OrganizationSnmpConfig extends cdktf.TerraformMetaArguments {
  ...
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_snmp#organization_id OrganizationSnmp#organization_id}
  */
  readonly organizationId: string;
  /**
  * The list of IPv4 addresses that are allowed to access the SNMP server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_snmp#peer_ips OrganizationSnmp#peer_ips}
  */
  readonly peerIps?: string[];
  /**
  * Boolean indicating whether SNMP version 2c is enabled for the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_snmp#v2c_enabled OrganizationSnmp#v2c_enabled}
  */
  ...
  *   - Choices: `MD5`, `SHA`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_snmp#v3_auth_mode OrganizationSnmp#v3_auth_mode}
  */
  readonly v3AuthMode?: string;
  /**
  * The SNMP version 3 authentication password. Must be at least 8 characters if specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_snmp#v3_auth_pass OrganizationSnmp#v3_auth_pass}
  */
  readonly v3AuthPass?: string;
  /**
  * Boolean indicating whether SNMP version 3 is enabled for the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_snmp#v3_enabled OrganizationSnmp#v3_enabled}
  */
  ...
  *   - Choices: `AES128`, `DES`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_snmp#v3_priv_mode OrganizationSnmp#v3_priv_mode}
  */
  readonly v3PrivMode?: string;
  /**
  * The SNMP version 3 privacy password. Must be at least 8 characters if specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_snmp#v3_priv_pass OrganizationSnmp#v3_priv_pass}
  */
  readonly v3PrivPass?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_snmp meraki_organization_snmp}
*/
export class OrganizationSnmp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationSnmp that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_snmp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_snmp meraki_organization_snmp} Resource
  *
  * @param scope The scope in which to define this construct
