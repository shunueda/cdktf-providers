// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/network_policies_by_client
...
export interface DataMerakiNetworkPoliciesByClientConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/network_policies_by_client#network_id DataMerakiNetworkPoliciesByClient#network_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/network_policies_by_client meraki_network_policies_by_client}
*/
export class DataMerakiNetworkPoliciesByClient extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiNetworkPoliciesByClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/network_policies_by_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/network_policies_by_client meraki_network_policies_by_client} Data Source
  *
  * @param scope The scope in which to define this construct
