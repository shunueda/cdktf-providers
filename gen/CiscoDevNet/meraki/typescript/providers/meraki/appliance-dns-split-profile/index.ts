// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_dns_split_profile
...
export interface ApplianceDnsSplitProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_dns_split_profile#hostnames ApplianceDnsSplitProfile#hostnames}
  */
  readonly hostnames: string[];
  /**
  * Name of profile
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_dns_split_profile#name ApplianceDnsSplitProfile#name}
  */
  readonly name: string;
  /**
  * The nameserver address(es) to use for redirection. A maximum of one address is supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_dns_split_profile#nameservers_addresses ApplianceDnsSplitProfile#nameservers_addresses}
  */
  readonly nameserversAddresses: string[];
  /**
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_dns_split_profile#organization_id ApplianceDnsSplitProfile#organization_id}
  */
  readonly organizationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_dns_split_profile meraki_appliance_dns_split_profile}
*/
export class ApplianceDnsSplitProfile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplianceDnsSplitProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_dns_split_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_dns_split_profile meraki_appliance_dns_split_profile} Resource
  *
  * @param scope The scope in which to define this construct
