// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_device_bluetooth_settings
...
export interface WirelessDeviceBluetoothSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_device_bluetooth_settings#major WirelessDeviceBluetoothSettings#major}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_device_bluetooth_settings#minor WirelessDeviceBluetoothSettings#minor}
  */
  readonly minor?: number;
  /**
  * Wireless AP serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_device_bluetooth_settings#serial WirelessDeviceBluetoothSettings#serial}
  */
  readonly serial: string;
  /**
  * Desired UUID of the beacon. If the value is set to null it will reset to Dashboard`s automatically generated value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_device_bluetooth_settings#uuid WirelessDeviceBluetoothSettings#uuid}
  */
  readonly uuid?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_device_bluetooth_settings meraki_wireless_device_bluetooth_settings}
*/
export class WirelessDeviceBluetoothSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WirelessDeviceBluetoothSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_device_bluetooth_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_device_bluetooth_settings meraki_wireless_device_bluetooth_settings} Resource
  *
  * @param scope The scope in which to define this construct
