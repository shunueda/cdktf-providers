// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dhcp_server_policy
...
export interface SwitchDhcpServerPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dhcp_server_policy#alerts_email_enabled SwitchDhcpServerPolicy#alerts_email_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dhcp_server_policy#allowed_servers SwitchDhcpServerPolicy#allowed_servers}
  */
  readonly allowedServers?: string[];
  /**
  * Enable or disable Dynamic ARP Inspection on the network. Default value is false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dhcp_server_policy#arp_inspection_enabled SwitchDhcpServerPolicy#arp_inspection_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dhcp_server_policy#blocked_servers SwitchDhcpServerPolicy#blocked_servers}
  */
  ...
  *   - Choices: `allow`, `block`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dhcp_server_policy#default_policy SwitchDhcpServerPolicy#default_policy}
  */
  readonly defaultPolicy?: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dhcp_server_policy#network_id SwitchDhcpServerPolicy#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dhcp_server_policy meraki_switch_dhcp_server_policy}
*/
export class SwitchDhcpServerPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchDhcpServerPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dhcp_server_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_dhcp_server_policy meraki_switch_dhcp_server_policy} Resource
  *
  * @param scope The scope in which to define this construct
