// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_site_to_site_vpn
...
export interface DataMerakiApplianceSiteToSiteVpnConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_site_to_site_vpn#network_id DataMerakiApplianceSiteToSiteVpn#network_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_site_to_site_vpn meraki_appliance_site_to_site_vpn}
*/
export class DataMerakiApplianceSiteToSiteVpn extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiApplianceSiteToSiteVpn that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_site_to_site_vpn#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/appliance_site_to_site_vpn meraki_appliance_site_to_site_vpn} Data Source
  *
  * @param scope The scope in which to define this construct
