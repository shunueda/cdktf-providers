// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_auth_radius_server
...
export interface OrganizationAuthRadiusServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_auth_radius_server#address OrganizationAuthRadiusServer#address}
  */
  readonly address: string;
  /**
  * Available server modes
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_auth_radius_server#modes OrganizationAuthRadiusServer#modes}
  */
  readonly modes: OrganizationAuthRadiusServerModes[] | cdktf.IResolvable;
  /**
  * The name of the RADIUS server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_auth_radius_server#name OrganizationAuthRadiusServer#name}
  */
  readonly name?: string;
  /**
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_auth_radius_server#organization_id OrganizationAuthRadiusServer#organization_id}
  */
  readonly organizationId: string;
  /**
  * Shared secret of the RADIUS server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_auth_radius_server#secret OrganizationAuthRadiusServer#secret}
  */
...
export interface OrganizationAuthRadiusServerModes {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_auth_radius_server#mode OrganizationAuthRadiusServer#mode}
  */
  readonly mode: string;
  /**
  * TCP port number for the corresponding server mode
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_auth_radius_server#port OrganizationAuthRadiusServer#port}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_auth_radius_server meraki_organization_auth_radius_server}
*/
export class OrganizationAuthRadiusServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationAuthRadiusServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_auth_radius_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/organization_auth_radius_server meraki_organization_auth_radius_server} Resource
  *
  * @param scope The scope in which to define this construct
