// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_traffic_shaping_custom_performance_class
...
export interface ApplianceTrafficShapingCustomPerformanceClassConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_traffic_shaping_custom_performance_class#max_jitter ApplianceTrafficShapingCustomPerformanceClass#max_jitter}
  */
  readonly maxJitter?: number;
  /**
  * Maximum latency in milliseconds
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_traffic_shaping_custom_performance_class#max_latency ApplianceTrafficShapingCustomPerformanceClass#max_latency}
  */
  readonly maxLatency?: number;
  /**
  * Maximum percentage of packet loss
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_traffic_shaping_custom_performance_class#max_loss_percentage ApplianceTrafficShapingCustomPerformanceClass#max_loss_percentage}
  */
  readonly maxLossPercentage?: number;
  /**
  * Name of the custom performance class
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_traffic_shaping_custom_performance_class#name ApplianceTrafficShapingCustomPerformanceClass#name}
  */
  readonly name: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_traffic_shaping_custom_performance_class#network_id ApplianceTrafficShapingCustomPerformanceClass#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_traffic_shaping_custom_performance_class meraki_appliance_traffic_shaping_custom_performance_class}
*/
export class ApplianceTrafficShapingCustomPerformanceClass extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplianceTrafficShapingCustomPerformanceClass that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_traffic_shaping_custom_performance_class#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_traffic_shaping_custom_performance_class meraki_appliance_traffic_shaping_custom_performance_class} Resource
  *
  * @param scope The scope in which to define this construct
