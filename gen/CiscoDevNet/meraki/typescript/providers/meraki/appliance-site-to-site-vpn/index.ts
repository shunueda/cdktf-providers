// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn
...
export interface ApplianceSiteToSiteVpnConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn#hubs ApplianceSiteToSiteVpn#hubs}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn#mode ApplianceSiteToSiteVpn#mode}
  */
  readonly mode: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn#network_id ApplianceSiteToSiteVpn#network_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn#subnet_nat_is_allowed ApplianceSiteToSiteVpn#subnet_nat_is_allowed}
  */
  readonly subnetNatIsAllowed?: boolean | cdktf.IResolvable;
  /**
  * The list of subnets and their VPN presence.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn#subnets ApplianceSiteToSiteVpn#subnets}
  */
...
export interface ApplianceSiteToSiteVpnHubs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn#hub_id ApplianceSiteToSiteVpn#hub_id}
  */
  readonly hubId: string;
  /**
  * Only valid in `spoke` mode. Indicates whether default route traffic should be sent to this hub.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn#use_default_route ApplianceSiteToSiteVpn#use_default_route}
  */
...
export interface ApplianceSiteToSiteVpnSubnets {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn#local_subnet ApplianceSiteToSiteVpn#local_subnet}
  */
  readonly localSubnet: string;
  /**
  * Whether or not VPN subnet translation is enabled for the subnet
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn#nat_enabled ApplianceSiteToSiteVpn#nat_enabled}
  */
  readonly natEnabled?: boolean | cdktf.IResolvable;
  /**
  * The translated subnet to be used in the VPN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn#nat_remote_subnet ApplianceSiteToSiteVpn#nat_remote_subnet}
  */
  readonly natRemoteSubnet?: string;
  /**
  * Indicates the presence of the subnet in the VPN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn#use_vpn ApplianceSiteToSiteVpn#use_vpn}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn meraki_appliance_site_to_site_vpn}
*/
export class ApplianceSiteToSiteVpn extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplianceSiteToSiteVpn that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_site_to_site_vpn meraki_appliance_site_to_site_vpn} Resource
  *
  * @param scope The scope in which to define this construct
