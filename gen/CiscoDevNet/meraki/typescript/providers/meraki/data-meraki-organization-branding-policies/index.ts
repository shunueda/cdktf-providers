// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_branding_policies
...
export interface DataMerakiOrganizationBrandingPoliciesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_branding_policies#organization_id DataMerakiOrganizationBrandingPolicies#organization_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_branding_policies meraki_organization_branding_policies}
*/
export class DataMerakiOrganizationBrandingPolicies extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiOrganizationBrandingPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_branding_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/data-sources/organization_branding_policies meraki_organization_branding_policies} Data Source
  *
  * @param scope The scope in which to define this construct
