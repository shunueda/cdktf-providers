// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee
...
export interface WirelessZigbeeConfig extends cdktf.TerraformMetaArguments {
  ...
  * Channel
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee#defaults_channel WirelessZigbee#defaults_channel}
  */
  ...
  *   - Range: `10`-`20`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee#defaults_transmit_power_level WirelessZigbee#defaults_transmit_power_level}
  */
  readonly defaultsTransmitPowerLevel?: number;
  /**
  * To enable/disable Zigbee on the network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee#enabled WirelessZigbee#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Device Serial number
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee#iot_controller_serial WirelessZigbee#iot_controller_serial}
  */
  readonly iotControllerSerial?: string;
  /**
  * Host Address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee#lock_management_address WirelessZigbee#lock_management_address}
  */
  readonly lockManagementAddress?: string;
  /**
  * Password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee#lock_management_password WirelessZigbee#lock_management_password}
  */
  readonly lockManagementPassword?: string;
  /**
  * Username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee#lock_management_username WirelessZigbee#lock_management_username}
  */
  readonly lockManagementUsername?: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee#network_id WirelessZigbee#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee meraki_wireless_zigbee}
*/
export class WirelessZigbee extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WirelessZigbee that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_zigbee meraki_wireless_zigbee} Resource
  *
  * @param scope The scope in which to define this construct
