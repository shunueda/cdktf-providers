// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule
...
export interface SwitchQosRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule#dscp SwitchQosRule#dscp}
  */
  readonly dscp?: number;
  /**
  * The destination port of the incoming packet. Applicable only if protocol is TCP or UDP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule#dst_port SwitchQosRule#dst_port}
  */
  readonly dstPort?: number;
  /**
  * The destination port range of the incoming packet. Applicable only if protocol is set to TCP or UDP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule#dst_port_range SwitchQosRule#dst_port_range}
  */
  readonly dstPortRange?: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule#network_id SwitchQosRule#network_id}
  */
  ...
  *   - Choices: `ANY`, `TCP`, `UDP`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule#protocol SwitchQosRule#protocol}
  */
  readonly protocol?: string;
  /**
  * The source port of the incoming packet. Applicable only if protocol is TCP or UDP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule#src_port SwitchQosRule#src_port}
  */
  readonly srcPort?: number;
  /**
  * The source port range of the incoming packet. Applicable only if protocol is set to TCP or UDP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule#src_port_range SwitchQosRule#src_port_range}
  */
  readonly srcPortRange?: string;
  /**
  * The VLAN of the incoming packet. A null value will match any VLAN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule#vlan SwitchQosRule#vlan}
  */
  readonly vlan: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule meraki_switch_qos_rule}
*/
export class SwitchQosRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchQosRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_qos_rule meraki_switch_qos_rule} Resource
  *
  * @param scope The scope in which to define this construct
