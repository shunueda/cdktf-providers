// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/insight_monitored_media_server
...
export interface InsightMonitoredMediaServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/insight_monitored_media_server#address InsightMonitoredMediaServer#address}
  */
  readonly address: string;
  /**
  * Indicates that if the media server doesn`t respond to ICMP pings, the nearest hop will be used in its stead.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/insight_monitored_media_server#best_effort_monitoring_enabled InsightMonitoredMediaServer#best_effort_monitoring_enabled}
  */
  readonly bestEffortMonitoringEnabled?: boolean | cdktf.IResolvable;
  /**
  * The name of the VoIP provider
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/insight_monitored_media_server#name InsightMonitoredMediaServer#name}
  */
  readonly name: string;
  /**
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/insight_monitored_media_server#organization_id InsightMonitoredMediaServer#organization_id}
  */
  readonly organizationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/insight_monitored_media_server meraki_insight_monitored_media_server}
*/
export class InsightMonitoredMediaServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InsightMonitoredMediaServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/insight_monitored_media_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/insight_monitored_media_server meraki_insight_monitored_media_server} Resource
  *
  * @param scope The scope in which to define this construct
