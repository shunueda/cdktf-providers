// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/sensor_alerts_profiles
...
export interface DataMerakiSensorAlertsProfilesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/sensor_alerts_profiles#network_id DataMerakiSensorAlertsProfiles#network_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/sensor_alerts_profiles meraki_sensor_alerts_profiles}
*/
export class DataMerakiSensorAlertsProfiles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiSensorAlertsProfiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/sensor_alerts_profiles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/sensor_alerts_profiles meraki_sensor_alerts_profiles} Data Source
  *
  * @param scope The scope in which to define this construct
