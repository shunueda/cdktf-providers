// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_firewall_multicast_forwarding
...
export interface ApplianceFirewallMulticastForwardingConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_firewall_multicast_forwarding#network_id ApplianceFirewallMulticastForwarding#network_id}
  */
  readonly networkId: string;
  /**
  * Static multicast forwarding rules. Pass an empty array to clear all rules.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_firewall_multicast_forwarding#rules ApplianceFirewallMulticastForwarding#rules}
  */
...
export interface ApplianceFirewallMulticastForwardingRules {
  ...
  * IP address
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_firewall_multicast_forwarding#address ApplianceFirewallMulticastForwarding#address}
  */
  readonly address: string;
  /**
  * Forwarding rule description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_firewall_multicast_forwarding#description ApplianceFirewallMulticastForwarding#description}
  */
  readonly description: string;
  /**
  * List of VLAN IDs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_firewall_multicast_forwarding#vlan_ids ApplianceFirewallMulticastForwarding#vlan_ids}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_firewall_multicast_forwarding meraki_appliance_firewall_multicast_forwarding}
*/
export class ApplianceFirewallMulticastForwarding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplianceFirewallMulticastForwarding that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_firewall_multicast_forwarding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/appliance_firewall_multicast_forwarding meraki_appliance_firewall_multicast_forwarding} Resource
  *
  * @param scope The scope in which to define this construct
