// https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/appliance_firewall_settings
...
export interface ApplianceFirewallSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/appliance_firewall_settings#network_id ApplianceFirewallSettings#network_id}
  */
  ...
  *   - Choices: `block`, `log`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/appliance_firewall_settings#spoofing_protection_ip_source_guard_mode ApplianceFirewallSettings#spoofing_protection_ip_source_guard_mode}
  */
  readonly spoofingProtectionIpSourceGuardMode?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/appliance_firewall_settings meraki_appliance_firewall_settings}
*/
export class ApplianceFirewallSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplianceFirewallSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/appliance_firewall_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/resources/appliance_firewall_settings meraki_appliance_firewall_settings} Resource
  *
  * @param scope The scope in which to define this construct
