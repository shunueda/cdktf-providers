// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_storm_control
...
export interface SwitchStormControlConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_storm_control#broadcast_threshold SwitchStormControl#broadcast_threshold}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_storm_control#multicast_threshold SwitchStormControl#multicast_threshold}
  */
  readonly multicastThreshold?: number;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_storm_control#network_id SwitchStormControl#network_id}
  */
  readonly networkId: string;
  /**
  * Grouped traffic types
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_storm_control#treat_these_traffic_types_as_one_threshold SwitchStormControl#treat_these_traffic_types_as_one_threshold}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_storm_control#unknown_unicast_threshold SwitchStormControl#unknown_unicast_threshold}
  */
  readonly unknownUnicastThreshold?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_storm_control meraki_switch_storm_control}
*/
export class SwitchStormControl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SwitchStormControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_storm_control#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/switch_storm_control meraki_switch_storm_control} Resource
  *
  * @param scope The scope in which to define this construct
