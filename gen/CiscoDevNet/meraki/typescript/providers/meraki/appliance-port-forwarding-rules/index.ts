// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_port_forwarding_rules
...
export interface AppliancePortForwardingRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_port_forwarding_rules#network_id AppliancePortForwardingRules#network_id}
  */
  readonly networkId: string;
  /**
  * An array of port forwarding params
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_port_forwarding_rules#rules AppliancePortForwardingRules#rules}
  */
...
export interface AppliancePortForwardingRulesRules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_port_forwarding_rules#allowed_ips AppliancePortForwardingRules#allowed_ips}
  */
  readonly allowedIps: string[];
  /**
  * The IP address of the server or device that hosts the internal resource that you wish to make available on the WAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_port_forwarding_rules#lan_ip AppliancePortForwardingRules#lan_ip}
  */
  readonly lanIp: string;
  /**
  * A port or port ranges that will receive the forwarded traffic from the WAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_port_forwarding_rules#local_port AppliancePortForwardingRules#local_port}
  */
  readonly localPort: string;
  /**
  * A descriptive name for the rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_port_forwarding_rules#name AppliancePortForwardingRules#name}
  */
  ...
  *   - Choices: `tcp`, `udp`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_port_forwarding_rules#protocol AppliancePortForwardingRules#protocol}
  */
  readonly protocol: string;
  /**
  * A port or port ranges that will be forwarded to the host on the LAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_port_forwarding_rules#public_port AppliancePortForwardingRules#public_port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_port_forwarding_rules#uplink AppliancePortForwardingRules#uplink}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_port_forwarding_rules meraki_appliance_port_forwarding_rules}
*/
export class AppliancePortForwardingRules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppliancePortForwardingRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_port_forwarding_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/appliance_port_forwarding_rules meraki_appliance_port_forwarding_rules} Resource
  *
  * @param scope The scope in which to define this construct
