// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_mqtt_broker
...
export interface NetworkMqttBrokerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_mqtt_broker#authentication_password NetworkMqttBroker#authentication_password}
  */
  readonly authenticationPassword?: string;
  /**
  * Username for the MQTT broker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_mqtt_broker#authentication_username NetworkMqttBroker#authentication_username}
  */
  readonly authenticationUsername?: string;
  /**
  * Host name/IP address where the MQTT broker runs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_mqtt_broker#host NetworkMqttBroker#host}
  */
  readonly host: string;
  /**
  * Name of the MQTT broker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_mqtt_broker#name NetworkMqttBroker#name}
  */
  readonly name: string;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_mqtt_broker#network_id NetworkMqttBroker#network_id}
  */
  readonly networkId: string;
  /**
  * Host port though which the MQTT broker can be reached.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_mqtt_broker#port NetworkMqttBroker#port}
  */
  readonly port: number;
  /**
  * Security protocol of the MQTT broker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_mqtt_broker#security_mode NetworkMqttBroker#security_mode}
  */
  readonly securityMode?: string;
  /**
  * CA Certificate of the MQTT broker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_mqtt_broker#security_tls_ca_certificate NetworkMqttBroker#security_tls_ca_certificate}
  */
  readonly securityTlsCaCertificate?: string;
  /**
  * Whether the TLS hostname verification is enabled for the MQTT broker.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_mqtt_broker#security_tls_verify_hostnames NetworkMqttBroker#security_tls_verify_hostnames}
  */
  readonly securityTlsVerifyHostnames?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_mqtt_broker meraki_network_mqtt_broker}
*/
export class NetworkMqttBroker extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkMqttBroker that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_mqtt_broker#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/network_mqtt_broker meraki_network_mqtt_broker} Resource
  *
  * @param scope The scope in which to define this construct
