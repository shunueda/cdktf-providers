// https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface
...
export interface WirelessAlternateManagementInterfaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface#access_points WirelessAlternateManagementInterface#access_points}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface#enabled WirelessAlternateManagementInterface#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface#network_id WirelessAlternateManagementInterface#network_id}
  */
  readonly networkId: string;
  /**
  * Can be one or more of the following values: `radius`, `snmp`, `syslog` or `ldap`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface#protocols WirelessAlternateManagementInterface#protocols}
  */
  readonly protocols?: string[];
  /**
  * Alternate management interface VLAN, must be between 1 and 4094
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface#vlan_id WirelessAlternateManagementInterface#vlan_id}
  */
...
export interface WirelessAlternateManagementInterfaceAccessPoints {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface#alternate_management_ip WirelessAlternateManagementInterface#alternate_management_ip}
  */
  readonly alternateManagementIp: string;
  /**
  * Primary DNS must be in IP format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface#dns1 WirelessAlternateManagementInterface#dns1}
  */
  readonly dns1?: string;
  /**
  * Optional secondary DNS must be in IP format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface#dns2 WirelessAlternateManagementInterface#dns2}
  */
  readonly dns2?: string;
  /**
  * Gateway must be in IP format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface#gateway WirelessAlternateManagementInterface#gateway}
  */
  readonly gateway?: string;
  /**
  * Serial number of access point to be configured with alternate management IP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface#serial WirelessAlternateManagementInterface#serial}
  */
  readonly serial: string;
  /**
  * Subnet mask must be in IP format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface#subnet_mask WirelessAlternateManagementInterface#subnet_mask}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface meraki_wireless_alternate_management_interface}
*/
export class WirelessAlternateManagementInterface extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WirelessAlternateManagementInterface that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.9.0/docs/resources/wireless_alternate_management_interface meraki_wireless_alternate_management_interface} Resource
  *
  * @param scope The scope in which to define this construct
