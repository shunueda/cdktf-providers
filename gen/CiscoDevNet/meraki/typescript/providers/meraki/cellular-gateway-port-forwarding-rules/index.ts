// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_port_forwarding_rules
...
export interface CellularGatewayPortForwardingRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_port_forwarding_rules#rules CellularGatewayPortForwardingRules#rules}
  */
  readonly rules: CellularGatewayPortForwardingRulesRules[] | cdktf.IResolvable;
  /**
  * Device serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_port_forwarding_rules#serial CellularGatewayPortForwardingRules#serial}
  */
...
export interface CellularGatewayPortForwardingRulesRules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_port_forwarding_rules#access CellularGatewayPortForwardingRules#access}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_port_forwarding_rules#allowed_ips CellularGatewayPortForwardingRules#allowed_ips}
  */
  readonly allowedIps?: string[];
  /**
  * The IP address of the server or device that hosts the internal resource that you wish to make available on the WAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_port_forwarding_rules#lan_ip CellularGatewayPortForwardingRules#lan_ip}
  */
  readonly lanIp: string;
  /**
  * A port or port ranges that will receive the forwarded traffic from the WAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_port_forwarding_rules#local_port CellularGatewayPortForwardingRules#local_port}
  */
  readonly localPort: string;
  /**
  * A descriptive name for the rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_port_forwarding_rules#name CellularGatewayPortForwardingRules#name}
  */
  readonly name?: string;
  /**
  * TCP or UDP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_port_forwarding_rules#protocol CellularGatewayPortForwardingRules#protocol}
  */
  readonly protocol: string;
  /**
  * A port or port ranges that will be forwarded to the host on the LAN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_port_forwarding_rules#public_port CellularGatewayPortForwardingRules#public_port}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_port_forwarding_rules meraki_cellular_gateway_port_forwarding_rules}
*/
export class CellularGatewayPortForwardingRules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CellularGatewayPortForwardingRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_port_forwarding_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/cellular_gateway_port_forwarding_rules meraki_cellular_gateway_port_forwarding_rules} Resource
  *
  * @param scope The scope in which to define this construct
