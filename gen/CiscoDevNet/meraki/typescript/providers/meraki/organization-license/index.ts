// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_license
...
export interface OrganizationLicenseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_license#device_serial OrganizationLicense#device_serial}
  */
  readonly deviceSerial?: string;
  /**
  * License ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_license#license_id OrganizationLicense#license_id}
  */
  readonly licenseId: string;
  /**
  * Organization ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_license#organization_id OrganizationLicense#organization_id}
  */
  readonly organizationId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_license meraki_organization_license}
*/
export class OrganizationLicense extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationLicense that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_license#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/resources/organization_license meraki_organization_license} Resource
  *
  * @param scope The scope in which to define this construct
