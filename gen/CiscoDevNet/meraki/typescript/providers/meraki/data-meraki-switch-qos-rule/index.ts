// https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/switch_qos_rule
...
export interface DataMerakiSwitchQosRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/switch_qos_rule#id DataMerakiSwitchQosRule#id}
  *
  ...
  * Network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/switch_qos_rule#network_id DataMerakiSwitchQosRule#network_id}
  */
  readonly networkId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/switch_qos_rule meraki_switch_qos_rule}
*/
export class DataMerakiSwitchQosRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiSwitchQosRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/switch_qos_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.7.1/docs/data-sources/switch_qos_rule meraki_switch_qos_rule} Data Source
  *
  * @param scope The scope in which to define this construct
