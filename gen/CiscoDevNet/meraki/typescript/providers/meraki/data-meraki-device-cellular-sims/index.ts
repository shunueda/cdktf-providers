// https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/device_cellular_sims
...
export interface DataMerakiDeviceCellularSimsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Device serial
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/device_cellular_sims#serial DataMerakiDeviceCellularSims#serial}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/device_cellular_sims meraki_device_cellular_sims}
*/
export class DataMerakiDeviceCellularSims extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMerakiDeviceCellularSims that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/device_cellular_sims#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/meraki/1.8.0/docs/data-sources/device_cellular_sims meraki_device_cellular_sims} Data Source
  *
  * @param scope The scope in which to define this construct
