...
export class DataIntersightStoragePhysicalDiskResultsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // health_resolution - computed: true, optional: false, required: false
  public get healthResolution() {
    return this.getStringAttribute('health_resolution');
  }
...
export class DataIntersightStoragePhysicalDisk extends cdktf.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataIntersightStoragePhysicalDiskConfig = {}) {
    ...
    this._healthMessage = config.healthMessage;
    this._healthResolution = config.healthResolution;
  ...
  // health_resolution - computed: false, optional: true, required: false
  private _healthResolution?: string; 
  public get healthResolution() {
    return this.getStringAttribute('health_resolution');
  }
  public set healthResolution(value: string) {
    this._healthResolution = value;
  }
  public resetHealthResolution() {
    this._healthResolution = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get healthResolutionInput() {
    return this._healthResolution;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      health_message: cdktf.stringToTerraform(this._healthMessage),
      health_resolution: cdktf.stringToTerraform(this._healthResolution),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      health_message: {
        value: cdktf.stringToHclTerraform(this._healthMessage),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      health_resolution: {
        value: cdktf.stringToHclTerraform(this._healthResolution),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
