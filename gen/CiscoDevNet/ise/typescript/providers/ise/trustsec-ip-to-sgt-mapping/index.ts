// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/trustsec_ip_to_sgt_mapping
...
export interface TrustsecIpToSgtMappingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/trustsec_ip_to_sgt_mapping#deploy_to TrustsecIpToSgtMapping#deploy_to}
  */
  ...
  *   - Choices: `ALL`, `ND`, `NDG`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/trustsec_ip_to_sgt_mapping#deploy_type TrustsecIpToSgtMapping#deploy_type}
  */
  readonly deployType?: string;
  /**
  * Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/trustsec_ip_to_sgt_mapping#description TrustsecIpToSgtMapping#description}
  */
  readonly description?: string;
  /**
  * Mandatory if `host_name` is empty
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/trustsec_ip_to_sgt_mapping#host_ip TrustsecIpToSgtMapping#host_ip}
  */
  readonly hostIp?: string;
  /**
  * Mandatory if `host_ip` is empty
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/trustsec_ip_to_sgt_mapping#host_name TrustsecIpToSgtMapping#host_name}
  */
  readonly hostName?: string;
  /**
  * IP to SGT Mapping Group ID. Mandatory unless `sgt` and `deploy_to` and `deploy_type` are set
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/trustsec_ip_to_sgt_mapping#mapping_group TrustsecIpToSgtMapping#mapping_group}
  */
  readonly mappingGroup?: string;
  /**
  * The name of the IP to SGT mapping
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/trustsec_ip_to_sgt_mapping#name TrustsecIpToSgtMapping#name}
  */
  readonly name: string;
  /**
  * Trustsec Security Group ID. Mandatory unless `mapping_group` is set
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/trustsec_ip_to_sgt_mapping#sgt TrustsecIpToSgtMapping#sgt}
  */
  readonly sgt?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/trustsec_ip_to_sgt_mapping ise_trustsec_ip_to_sgt_mapping}
*/
export class TrustsecIpToSgtMapping extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrustsecIpToSgtMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/trustsec_ip_to_sgt_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/trustsec_ip_to_sgt_mapping ise_trustsec_ip_to_sgt_mapping} Resource
  *
  * @param scope The scope in which to define this construct
