// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/trustsec_security_group
...
export interface TrustsecSecurityGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/trustsec_security_group#description TrustsecSecurityGroup#description}
  */
  readonly description?: string;
  /**
  * Read-only
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/trustsec_security_group#is_read_only TrustsecSecurityGroup#is_read_only}
  */
  readonly isReadOnly?: boolean | cdktf.IResolvable;
  /**
  * The name of the security group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/trustsec_security_group#name TrustsecSecurityGroup#name}
  */
  readonly name: string;
  /**
  * Propagate to APIC (ACI)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/trustsec_security_group#propogate_to_apic TrustsecSecurityGroup#propogate_to_apic}
  */
  ...
  *   - Range: `-1`-`65519`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/trustsec_security_group#value TrustsecSecurityGroup#value}
  */
  readonly value: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/trustsec_security_group ise_trustsec_security_group}
*/
export class TrustsecSecurityGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrustsecSecurityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/trustsec_security_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/trustsec_security_group ise_trustsec_security_group} Resource
  *
  * @param scope The scope in which to define this construct
