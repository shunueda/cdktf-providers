// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/network_device_group
...
export interface NetworkDeviceGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/network_device_group#description NetworkDeviceGroup#description}
  */
  readonly description?: string;
  /**
  * The name of the network device group including its hierarchy, e.g. `Device Type#All Device Types#ACCESS`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/network_device_group#name NetworkDeviceGroup#name}
  */
  readonly name: string;
  /**
  * The name of the root device group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/network_device_group#root_group NetworkDeviceGroup#root_group}
  */
  readonly rootGroup: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/network_device_group ise_network_device_group}
*/
export class NetworkDeviceGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkDeviceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/network_device_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/network_device_group ise_network_device_group} Resource
  *
  * @param scope The scope in which to define this construct
