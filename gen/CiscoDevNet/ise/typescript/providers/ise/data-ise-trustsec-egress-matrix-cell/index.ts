// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/trustsec_egress_matrix_cell
...
export interface DataIseTrustsecEgressMatrixCellConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/trustsec_egress_matrix_cell#id DataIseTrustsecEgressMatrixCell#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/trustsec_egress_matrix_cell ise_trustsec_egress_matrix_cell}
*/
export class DataIseTrustsecEgressMatrixCell extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIseTrustsecEgressMatrixCell that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/trustsec_egress_matrix_cell#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/trustsec_egress_matrix_cell ise_trustsec_egress_matrix_cell} Data Source
  *
  * @param scope The scope in which to define this construct
