// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/sxp_domain_filter
...
export interface DataIseSxpDomainFilterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/sxp_domain_filter#id DataIseSxpDomainFilter#id}
  *
  ...
  * Resource name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/sxp_domain_filter#name DataIseSxpDomainFilter#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/sxp_domain_filter ise_sxp_domain_filter}
*/
export class DataIseSxpDomainFilter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIseSxpDomainFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/sxp_domain_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/sxp_domain_filter ise_sxp_domain_filter} Data Source
  *
  * @param scope The scope in which to define this construct
