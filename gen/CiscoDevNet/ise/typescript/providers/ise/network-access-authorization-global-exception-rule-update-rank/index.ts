// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/network_access_authorization_global_exception_rule_update_rank
...
export interface NetworkAccessAuthorizationGlobalExceptionRuleUpdateRankConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/network_access_authorization_global_exception_rule_update_rank#rank NetworkAccessAuthorizationGlobalExceptionRuleUpdateRank#rank}
  */
  readonly rank: number;
  /**
  * Authorization global exception rule ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/network_access_authorization_global_exception_rule_update_rank#rule_id NetworkAccessAuthorizationGlobalExceptionRuleUpdateRank#rule_id}
  */
  readonly ruleId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/network_access_authorization_global_exception_rule_update_rank ise_network_access_authorization_global_exception_rule_update_rank}
*/
export class NetworkAccessAuthorizationGlobalExceptionRuleUpdateRank extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkAccessAuthorizationGlobalExceptionRuleUpdateRank that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/network_access_authorization_global_exception_rule_update_rank#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/network_access_authorization_global_exception_rule_update_rank ise_network_access_authorization_global_exception_rule_update_rank} Resource
  *
  * @param scope The scope in which to define this construct
