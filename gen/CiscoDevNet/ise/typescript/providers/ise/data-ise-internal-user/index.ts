// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/internal_user
...
export interface DataIseInternalUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/internal_user#id DataIseInternalUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/internal_user#name DataIseInternalUser#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/internal_user ise_internal_user}
*/
export class DataIseInternalUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIseInternalUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/internal_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/internal_user ise_internal_user} Data Source
  *
  * @param scope The scope in which to define this construct
