// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/network_device_group
...
export interface DataIseNetworkDeviceGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/network_device_group#id DataIseNetworkDeviceGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/network_device_group#name DataIseNetworkDeviceGroup#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/network_device_group ise_network_device_group}
*/
export class DataIseNetworkDeviceGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIseNetworkDeviceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/network_device_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/network_device_group ise_network_device_group} Data Source
  *
  * @param scope The scope in which to define this construct
