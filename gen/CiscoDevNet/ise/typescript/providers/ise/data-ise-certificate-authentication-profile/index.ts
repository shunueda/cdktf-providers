// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/certificate_authentication_profile
...
export interface DataIseCertificateAuthenticationProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/certificate_authentication_profile#id DataIseCertificateAuthenticationProfile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/certificate_authentication_profile#name DataIseCertificateAuthenticationProfile#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/certificate_authentication_profile ise_certificate_authentication_profile}
*/
export class DataIseCertificateAuthenticationProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIseCertificateAuthenticationProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/certificate_authentication_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/certificate_authentication_profile ise_certificate_authentication_profile} Data Source
  *
  * @param scope The scope in which to define this construct
