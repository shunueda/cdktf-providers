// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/device_admin_policy_set_update_rank
...
export interface DeviceAdminPolicySetUpdateRankConfig extends cdktf.TerraformMetaArguments {
  ...
  * Policy set ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/device_admin_policy_set_update_rank#policy_set_id DeviceAdminPolicySetUpdateRank#policy_set_id}
  */
  readonly policySetId: string;
  /**
  * The rank (priority) in relation to other rules. Lower rank is higher priority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/device_admin_policy_set_update_rank#rank DeviceAdminPolicySetUpdateRank#rank}
  */
  readonly rank: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/device_admin_policy_set_update_rank ise_device_admin_policy_set_update_rank}
*/
export class DeviceAdminPolicySetUpdateRank extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeviceAdminPolicySetUpdateRank that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/device_admin_policy_set_update_rank#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/device_admin_policy_set_update_rank ise_device_admin_policy_set_update_rank} Resource
  *
  * @param scope The scope in which to define this construct
