// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/active_directory_join_point
...
export interface DataIseActiveDirectoryJoinPointConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/active_directory_join_point#id DataIseActiveDirectoryJoinPoint#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/active_directory_join_point ise_active_directory_join_point}
*/
export class DataIseActiveDirectoryJoinPoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIseActiveDirectoryJoinPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/active_directory_join_point#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/active_directory_join_point ise_active_directory_join_point} Data Source
  *
  * @param scope The scope in which to define this construct
