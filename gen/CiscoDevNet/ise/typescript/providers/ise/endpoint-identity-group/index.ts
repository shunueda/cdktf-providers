// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/endpoint_identity_group
...
export interface EndpointIdentityGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/endpoint_identity_group#description EndpointIdentityGroup#description}
  */
  readonly description?: string;
  /**
  * The name of the endpoint identity group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/endpoint_identity_group#name EndpointIdentityGroup#name}
  */
  readonly name: string;
  /**
  * Parent endpoint identity group ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/endpoint_identity_group#parent_endpoint_identity_group_id EndpointIdentityGroup#parent_endpoint_identity_group_id}
  */
  readonly parentEndpointIdentityGroupId?: string;
  /**
  * System defined endpoint identity group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/endpoint_identity_group#system_defined EndpointIdentityGroup#system_defined}
  */
  readonly systemDefined?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/endpoint_identity_group ise_endpoint_identity_group}
*/
export class EndpointIdentityGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EndpointIdentityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/endpoint_identity_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/endpoint_identity_group ise_endpoint_identity_group} Resource
  *
  * @param scope The scope in which to define this construct
