// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/trustsec_egress_matrix_cell_default
...
export interface DataIseTrustsecEgressMatrixCellDefaultConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/trustsec_egress_matrix_cell_default#id DataIseTrustsecEgressMatrixCellDefault#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/trustsec_egress_matrix_cell_default ise_trustsec_egress_matrix_cell_default}
*/
export class DataIseTrustsecEgressMatrixCellDefault extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIseTrustsecEgressMatrixCellDefault that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/trustsec_egress_matrix_cell_default#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/trustsec_egress_matrix_cell_default ise_trustsec_egress_matrix_cell_default} Data Source
  *
  * @param scope The scope in which to define this construct
