// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/allowed_protocols_tacacs
...
export interface AllowedProtocolsTacacsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Allow CHAP
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/allowed_protocols_tacacs#allow_chap AllowedProtocolsTacacs#allow_chap}
  */
  readonly allowChap: boolean | cdktf.IResolvable;
  /**
  * Allow MS CHAP v1
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/allowed_protocols_tacacs#allow_ms_chap_v1 AllowedProtocolsTacacs#allow_ms_chap_v1}
  */
  readonly allowMsChapV1: boolean | cdktf.IResolvable;
  /**
  * Allow PAP ASCII
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/allowed_protocols_tacacs#allow_pap_ascii AllowedProtocolsTacacs#allow_pap_ascii}
  */
  readonly allowPapAscii: boolean | cdktf.IResolvable;
  /**
  * Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/allowed_protocols_tacacs#description AllowedProtocolsTacacs#description}
  */
  readonly description?: string;
  /**
  * The name of the allowed protocols
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/allowed_protocols_tacacs#name AllowedProtocolsTacacs#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/allowed_protocols_tacacs ise_allowed_protocols_tacacs}
*/
export class AllowedProtocolsTacacs extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AllowedProtocolsTacacs that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/allowed_protocols_tacacs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/allowed_protocols_tacacs ise_allowed_protocols_tacacs} Resource
  *
  * @param scope The scope in which to define this construct
