// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/identity_source_sequence
...
export interface IdentitySourceSequenceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/identity_source_sequence#break_on_store_fail IdentitySourceSequence#break_on_store_fail}
  */
  readonly breakOnStoreFail: boolean | cdktf.IResolvable;
  /**
  * Certificate Authentication Profile, empty if doesn't exist
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/identity_source_sequence#certificate_authentication_profile IdentitySourceSequence#certificate_authentication_profile}
  */
  readonly certificateAuthenticationProfile: string;
  /**
  * Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/identity_source_sequence#description IdentitySourceSequence#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/identity_source_sequence#identity_sources IdentitySourceSequence#identity_sources}
  */
  readonly identitySources: IdentitySourceSequenceIdentitySources[] | cdktf.IResolvable;
  /**
  * The name of the identity source sequence
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/identity_source_sequence#name IdentitySourceSequence#name}
  */
...
export interface IdentitySourceSequenceIdentitySources {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/identity_source_sequence#order IdentitySourceSequence#order}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/identity_source_sequence ise_identity_source_sequence}
*/
export class IdentitySourceSequence extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentitySourceSequence that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/identity_source_sequence#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/identity_source_sequence ise_identity_source_sequence} Resource
  *
  * @param scope The scope in which to define this construct
