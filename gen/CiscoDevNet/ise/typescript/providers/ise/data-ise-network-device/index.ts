// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/network_device
...
export interface DataIseNetworkDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/network_device#id DataIseNetworkDevice#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/network_device#name DataIseNetworkDevice#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/network_device ise_network_device}
*/
export class DataIseNetworkDevice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIseNetworkDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/network_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/network_device ise_network_device} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // snmp_auth_password - computed: true, optional: false, required: false
  ...
  // snmp_privacy_password - computed: true, optional: false, required: false
  public get snmpPrivacyPassword() {
    return this.getStringAttribute('snmp_privacy_password');
  }

  // snmp_privacy_protocol - computed: true, optional: false, required: false
  ...
  // snmp_security_level - computed: true, optional: false, required: false
  public get snmpSecurityLevel() {
    return this.getStringAttribute('snmp_security_level');
  }

  // snmp_username - computed: true, optional: false, required: false
