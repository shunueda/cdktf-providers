...
export class NetworkDevice extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: NetworkDeviceConfig) {
    ...
    this._snmpPrivacyPassword = config.snmpPrivacyPassword;
    this._snmpPrivacyProtocol = config.snmpPrivacyProtocol;
  ...
  // snmp_auth_password - computed: false, optional: true, required: false
  private _snmpAuthPassword?: string; 
  public get snmpAuthPassword() {
    return this.getStringAttribute('snmp_auth_password');
  }
  ...
  // snmp_privacy_password - computed: false, optional: true, required: false
  private _snmpPrivacyPassword?: string; 
  public get snmpPrivacyPassword() {
    return this.getStringAttribute('snmp_privacy_password');
  }
  public set snmpPrivacyPassword(value: string) {
    this._snmpPrivacyPassword = value;
  }
  public resetSnmpPrivacyPassword() {
    this._snmpPrivacyPassword = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get snmpPrivacyPasswordInput() {
    return this._snmpPrivacyPassword;
  }

  // snmp_privacy_protocol - computed: false, optional: true, required: false
  private _snmpPrivacyProtocol?: string; 
  public get snmpPrivacyProtocol() {
    return this.getStringAttribute('snmp_privacy_protocol');
  }
  public set snmpPrivacyProtocol(value: string) {
    this._snmpPrivacyProtocol = value;
  }
  public resetSnmpPrivacyProtocol() {
    this._snmpPrivacyProtocol = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get snmpPrivacyProtocolInput() {
    return this._snmpPrivacyProtocol;
  }
  ...
  // snmp_security_level - computed: false, optional: true, required: false
  private _snmpSecurityLevel?: string; 
  public get snmpSecurityLevel() {
    return this.getStringAttribute('snmp_security_level');
  }
  ...
  // snmp_username - computed: false, optional: true, required: false
  private _snmpUsername?: string; 
  public get snmpUsername() {
    return this.getStringAttribute('snmp_username');
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      snmp_auth_password: cdktf.stringToTerraform(this._snmpAuthPassword),
      ...
      snmp_privacy_password: cdktf.stringToTerraform(this._snmpPrivacyPassword),
      snmp_privacy_protocol: cdktf.stringToTerraform(this._snmpPrivacyProtocol),
      snmp_ro_community: cdktf.stringToTerraform(this._snmpRoCommunity),
      snmp_security_level: cdktf.stringToTerraform(this._snmpSecurityLevel),
      snmp_username: cdktf.stringToTerraform(this._snmpUsername),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      snmp_privacy_password: {
        value: cdktf.stringToHclTerraform(this._snmpPrivacyPassword),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      snmp_privacy_protocol: {
        value: cdktf.stringToHclTerraform(this._snmpPrivacyProtocol),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
