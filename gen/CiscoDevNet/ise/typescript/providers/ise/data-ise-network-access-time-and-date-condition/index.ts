// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.13/docs/data-sources/network_access_time_and_date_condition
...
export interface DataIseNetworkAccessTimeAndDateConditionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.13/docs/data-sources/network_access_time_and_date_condition#id DataIseNetworkAccessTimeAndDateCondition#id}
  *
  ...
  * Condition name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.13/docs/data-sources/network_access_time_and_date_condition#name DataIseNetworkAccessTimeAndDateCondition#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.13/docs/data-sources/network_access_time_and_date_condition ise_network_access_time_and_date_condition}
*/
export class DataIseNetworkAccessTimeAndDateCondition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIseNetworkAccessTimeAndDateCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.13/docs/data-sources/network_access_time_and_date_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.13/docs/data-sources/network_access_time_and_date_condition ise_network_access_time_and_date_condition} Data Source
  *
  * @param scope The scope in which to define this construct
