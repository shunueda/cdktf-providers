// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/endpoint_custom_attribute
...
export interface EndpointCustomAttributeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/endpoint_custom_attribute#attribute_name EndpointCustomAttribute#attribute_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/endpoint_custom_attribute#attribute_type EndpointCustomAttribute#attribute_type}
  */
  readonly attributeType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/endpoint_custom_attribute ise_endpoint_custom_attribute}
*/
export class EndpointCustomAttribute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EndpointCustomAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/endpoint_custom_attribute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/resources/endpoint_custom_attribute ise_endpoint_custom_attribute} Resource
  *
  * @param scope The scope in which to define this construct
