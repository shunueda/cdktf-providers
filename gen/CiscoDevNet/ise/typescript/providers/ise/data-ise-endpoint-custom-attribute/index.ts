// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.13/docs/data-sources/endpoint_custom_attribute
...
export interface DataIseEndpointCustomAttributeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.13/docs/data-sources/endpoint_custom_attribute#id DataIseEndpointCustomAttribute#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.13/docs/data-sources/endpoint_custom_attribute ise_endpoint_custom_attribute}
*/
export class DataIseEndpointCustomAttribute extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIseEndpointCustomAttribute that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.13/docs/data-sources/endpoint_custom_attribute#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.13/docs/data-sources/endpoint_custom_attribute ise_endpoint_custom_attribute} Data Source
  *
  * @param scope The scope in which to define this construct
