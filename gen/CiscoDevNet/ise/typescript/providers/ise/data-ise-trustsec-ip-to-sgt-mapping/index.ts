// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/trustsec_ip_to_sgt_mapping
...
export interface DataIseTrustsecIpToSgtMappingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/trustsec_ip_to_sgt_mapping#id DataIseTrustsecIpToSgtMapping#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/trustsec_ip_to_sgt_mapping#name DataIseTrustsecIpToSgtMapping#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/trustsec_ip_to_sgt_mapping ise_trustsec_ip_to_sgt_mapping}
*/
export class DataIseTrustsecIpToSgtMapping extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIseTrustsecIpToSgtMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/trustsec_ip_to_sgt_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.12/docs/data-sources/trustsec_ip_to_sgt_mapping ise_trustsec_ip_to_sgt_mapping} Data Source
  *
  * @param scope The scope in which to define this construct
