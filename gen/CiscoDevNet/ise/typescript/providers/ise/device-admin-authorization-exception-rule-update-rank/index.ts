// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/device_admin_authorization_exception_rule_update_rank
...
export interface DeviceAdminAuthorizationExceptionRuleUpdateRankConfig extends cdktf.TerraformMetaArguments {
  ...
  * Policy set ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/device_admin_authorization_exception_rule_update_rank#policy_set_id DeviceAdminAuthorizationExceptionRuleUpdateRank#policy_set_id}
  */
  readonly policySetId: string;
  /**
  * The rank (priority) in relation to other rules. Lower rank is higher priority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/device_admin_authorization_exception_rule_update_rank#rank DeviceAdminAuthorizationExceptionRuleUpdateRank#rank}
  */
  readonly rank: number;
  /**
  * Authorization exception rule ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/device_admin_authorization_exception_rule_update_rank#rule_id DeviceAdminAuthorizationExceptionRuleUpdateRank#rule_id}
  */
  readonly ruleId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/device_admin_authorization_exception_rule_update_rank ise_device_admin_authorization_exception_rule_update_rank}
*/
export class DeviceAdminAuthorizationExceptionRuleUpdateRank extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeviceAdminAuthorizationExceptionRuleUpdateRank that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/device_admin_authorization_exception_rule_update_rank#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/resources/device_admin_authorization_exception_rule_update_rank ise_device_admin_authorization_exception_rule_update_rank} Resource
  *
  * @param scope The scope in which to define this construct
