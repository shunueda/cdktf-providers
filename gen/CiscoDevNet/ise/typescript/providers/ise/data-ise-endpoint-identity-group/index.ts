// https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/endpoint_identity_group
...
export interface DataIseEndpointIdentityGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/endpoint_identity_group#id DataIseEndpointIdentityGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/endpoint_identity_group#name DataIseEndpointIdentityGroup#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/endpoint_identity_group ise_endpoint_identity_group}
*/
export class DataIseEndpointIdentityGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataIseEndpointIdentityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/endpoint_identity_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/ise/0.2.14/docs/data-sources/endpoint_identity_group ise_endpoint_identity_group} Data Source
  *
  * @param scope The scope in which to define this construct
