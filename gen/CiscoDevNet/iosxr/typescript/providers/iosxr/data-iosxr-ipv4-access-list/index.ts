// https://registry.terraform.io/providers/ciscodevnet/iosxr/0.6.0/docs/data-sources/ipv4_access_list
...
export interface DataIosxrIpv4AccessListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Access list name - maximum 128 characters
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxr/0.6.0/docs/data-sources/ipv4_access_list#access_list_name DataIosxrIpv4AccessList#access_list_name}
  */
  readonly accessListName: string;
  /**
  * A device name from the provider configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/iosxr/0.6.0/docs/data-sources/ipv4_access_list#device DataIosxrIpv4AccessList#device}
  */
  readonly device?: string;
}
export interface DataIosxrIpv4AccessListSequences {
}

export function dataIosxrIpv4AccessListSequencesToTerraform(struct?: DataIosxrIpv4AccessListSequences): any {
...
export function dataIosxrIpv4AccessListSequencesToHclTerraform(struct?: DataIosxrIpv4AccessListSequences): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataIosxrIpv4AccessListSequencesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataIosxrIpv4AccessListSequences | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataIosxrIpv4AccessListSequences | undefined) {
    if (value === undefined) {
  ...
  // deny_default - computed: true, optional: false, required: false
  ...
  // deny_fragments - computed: true, optional: false, required: false
  ...
  // deny_igmp_type - computed: true, optional: false, required: false
  ...
  // permit_default - computed: true, optional: false, required: false
  ...
  // permit_fragments - computed: true, optional: false, required: false
  ...
  // permit_igmp_type - computed: true, optional: false, required: false
  ...
  // permit_nexthop1_ipv4 - computed: true, optional: false, required: false
  ...
  // permit_nexthop2_ipv4 - computed: true, optional: false, required: false
  ...
  // permit_nexthop3_ipv4 - computed: true, optional: false, required: false
...
export class DataIosxrIpv4AccessListSequencesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataIosxrIpv4AccessListSequencesOutputReference {
    return new DataIosxrIpv4AccessListSequencesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/iosxr/0.6.0/docs/data-sources/ipv4_access_list iosxr_ipv4_access_list}
*/
export class DataIosxrIpv4AccessList extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataIosxrIpv4AccessList resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataIosxrIpv4AccessList to import
  * @param importFromId The id of the existing DataIosxrIpv4AccessList that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/iosxr/0.6.0/docs/data-sources/ipv4_access_list#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataIosxrIpv4AccessList to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/iosxr/0.6.0/docs/data-sources/ipv4_access_list iosxr_ipv4_access_list} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataIosxrIpv4AccessListConfig
  */
  public constructor(scope: Construct, id: string, config: DataIosxrIpv4AccessListConfig) {
    super(scope, id, {
  ...
  private _sequences = new DataIosxrIpv4AccessListSequencesList(this, "sequences", false);
