// https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/fabric_policies_vlan_pool
...
export interface DataMsoFabricPoliciesVlanPoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/fabric_policies_vlan_pool#id DataMsoFabricPoliciesVlanPool#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/fabric_policies_vlan_pool#name DataMsoFabricPoliciesVlanPool#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/fabric_policies_vlan_pool#template_id DataMsoFabricPoliciesVlanPool#template_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/fabric_policies_vlan_pool mso_fabric_policies_vlan_pool}
*/
export class DataMsoFabricPoliciesVlanPool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMsoFabricPoliciesVlanPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/fabric_policies_vlan_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/fabric_policies_vlan_pool mso_fabric_policies_vlan_pool} Data Source
  *
  * @param scope The scope in which to define this construct
