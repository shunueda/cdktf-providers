// https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/system_config
...
export interface SystemConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/system_config#alias SystemConfig#alias}
  */
  readonly alias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/system_config#change_control SystemConfig#change_control}
  */
  readonly changeControl?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/system_config#id SystemConfig#id}
  *
  ...
  * banner block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/system_config#banner SystemConfig#banner}
  */
  readonly banner?: SystemConfigBanner;
}
export interface SystemConfigBanner {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/system_config#message SystemConfig#message}
  */
  readonly message: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/system_config#state SystemConfig#state}
  */
  readonly state: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/system_config#type SystemConfig#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/system_config mso_system_config}
*/
export class SystemConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SystemConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/system_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/system_config mso_system_config} Resource
  *
  * @param scope The scope in which to define this construct
