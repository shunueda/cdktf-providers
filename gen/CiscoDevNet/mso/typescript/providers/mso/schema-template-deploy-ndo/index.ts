// https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy_ndo
...
export interface SchemaTemplateDeployNdoConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy_ndo#force_apply SchemaTemplateDeployNdo#force_apply}
  */
  readonly forceApply?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy_ndo#id SchemaTemplateDeployNdo#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy_ndo#re_deploy SchemaTemplateDeployNdo#re_deploy}
  */
  readonly reDeploy?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy_ndo#schema_id SchemaTemplateDeployNdo#schema_id}
  */
  readonly schemaId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy_ndo#template_id SchemaTemplateDeployNdo#template_id}
  */
  readonly templateId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy_ndo#template_name SchemaTemplateDeployNdo#template_name}
  */
  readonly templateName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy_ndo#template_type SchemaTemplateDeployNdo#template_type}
  */
  readonly templateType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy_ndo mso_schema_template_deploy_ndo}
*/
export class SchemaTemplateDeployNdo extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchemaTemplateDeployNdo that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy_ndo#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy_ndo mso_schema_template_deploy_ndo} Resource
  *
  * @param scope The scope in which to define this construct
