// https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy
...
export interface SchemaTemplateDeployConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy#force_apply SchemaTemplateDeploy#force_apply}
  */
  readonly forceApply?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy#id SchemaTemplateDeploy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy#schema_id SchemaTemplateDeploy#schema_id}
  */
  readonly schemaId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy#site_id SchemaTemplateDeploy#site_id}
  */
  readonly siteId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy#template_name SchemaTemplateDeploy#template_name}
  */
  readonly templateName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy#undeploy SchemaTemplateDeploy#undeploy}
  */
  readonly undeploy?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy mso_schema_template_deploy}
*/
export class SchemaTemplateDeploy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchemaTemplateDeploy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/resources/schema_template_deploy mso_schema_template_deploy} Resource
  *
  * @param scope The scope in which to define this construct
