// https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/fabric_policies_synce_interface_policy
...
export interface DataMsoFabricPoliciesSynceInterfacePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/fabric_policies_synce_interface_policy#id DataMsoFabricPoliciesSynceInterfacePolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/fabric_policies_synce_interface_policy#name DataMsoFabricPoliciesSynceInterfacePolicy#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/fabric_policies_synce_interface_policy#template_id DataMsoFabricPoliciesSynceInterfacePolicy#template_id}
  */
  readonly templateId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/fabric_policies_synce_interface_policy mso_fabric_policies_synce_interface_policy}
*/
export class DataMsoFabricPoliciesSynceInterfacePolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMsoFabricPoliciesSynceInterfacePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/fabric_policies_synce_interface_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/fabric_policies_synce_interface_policy mso_fabric_policies_synce_interface_policy} Data Source
  *
  * @param scope The scope in which to define this construct
