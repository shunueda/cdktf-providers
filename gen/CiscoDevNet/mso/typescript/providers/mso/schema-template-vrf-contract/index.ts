// https://registry.terraform.io/providers/ciscodevnet/mso/1.6.0/docs/resources/schema_template_vrf_contract
...
export interface SchemaTemplateVrfContractConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.6.0/docs/resources/schema_template_vrf_contract#contract_name SchemaTemplateVrfContract#contract_name}
  */
  readonly contractName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.6.0/docs/resources/schema_template_vrf_contract#contract_schema_id SchemaTemplateVrfContract#contract_schema_id}
  */
  readonly contractSchemaId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.6.0/docs/resources/schema_template_vrf_contract#contract_template_name SchemaTemplateVrfContract#contract_template_name}
  */
  readonly contractTemplateName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.6.0/docs/resources/schema_template_vrf_contract#id SchemaTemplateVrfContract#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.6.0/docs/resources/schema_template_vrf_contract#relationship_type SchemaTemplateVrfContract#relationship_type}
  */
  readonly relationshipType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.6.0/docs/resources/schema_template_vrf_contract#schema_id SchemaTemplateVrfContract#schema_id}
  */
  readonly schemaId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.6.0/docs/resources/schema_template_vrf_contract#template_name SchemaTemplateVrfContract#template_name}
  */
  readonly templateName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.6.0/docs/resources/schema_template_vrf_contract#vrf_name SchemaTemplateVrfContract#vrf_name}
  */
  readonly vrfName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.6.0/docs/resources/schema_template_vrf_contract mso_schema_template_vrf_contract}
*/
export class SchemaTemplateVrfContract extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchemaTemplateVrfContract that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.6.0/docs/resources/schema_template_vrf_contract#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.6.0/docs/resources/schema_template_vrf_contract mso_schema_template_vrf_contract} Resource
  *
  * @param scope The scope in which to define this construct
