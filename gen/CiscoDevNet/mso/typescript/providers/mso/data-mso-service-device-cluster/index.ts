// https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/service_device_cluster
...
export interface DataMsoServiceDeviceClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/service_device_cluster#id DataMsoServiceDeviceCluster#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/service_device_cluster#name DataMsoServiceDeviceCluster#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/service_device_cluster#template_id DataMsoServiceDeviceCluster#template_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/service_device_cluster mso_service_device_cluster}
*/
export class DataMsoServiceDeviceCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMsoServiceDeviceCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/service_device_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/ciscodevnet/mso/1.7.0/docs/data-sources/service_device_cluster mso_service_device_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
