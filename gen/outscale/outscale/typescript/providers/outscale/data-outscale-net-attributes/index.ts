...
export interface DataOutscaleNetAttributesTags {
}

export function dataOutscaleNetAttributesTagsToTerraform(struct?: DataOutscaleNetAttributesTags): any {
...
export function dataOutscaleNetAttributesTagsToHclTerraform(struct?: DataOutscaleNetAttributesTags): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataOutscaleNetAttributesTagsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataOutscaleNetAttributesTags | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataOutscaleNetAttributesTags | undefined) {
    if (value === undefined) {
...
export class DataOutscaleNetAttributesTagsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataOutscaleNetAttributesTagsOutputReference {
    return new DataOutscaleNetAttributesTagsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataOutscaleNetAttributes extends cdktf.TerraformDataSource {
  ...
  * @param options DataOutscaleNetAttributesConfig
  */
  public constructor(scope: Construct, id: string, config: DataOutscaleNetAttributesConfig) {
    super(scope, id, {
