...
export function dataOutscaleServerCertificateFilterToTerraform(struct?: DataOutscaleServerCertificateFilter | cdktf.IResolvable): any {
...
export function dataOutscaleServerCertificateFilterToHclTerraform(struct?: DataOutscaleServerCertificateFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataOutscaleServerCertificateFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataOutscaleServerCertificateFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataOutscaleServerCertificateFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataOutscaleServerCertificateFilterList extends cdktf.ComplexList {
  public internalValue? : DataOutscaleServerCertificateFilter[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataOutscaleServerCertificateFilterOutputReference {
    return new DataOutscaleServerCertificateFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataOutscaleServerCertificate extends cdktf.TerraformDataSource {
  ...
  * @param options DataOutscaleServerCertificateConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataOutscaleServerCertificateConfig = {}) {
    super(scope, id, {
  ...
  private _filter = new DataOutscaleServerCertificateFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: DataOutscaleServerCertificateFilter[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataOutscaleServerCertificateFilterToTerraform, true)(this._filter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktf.listMapperHcl(dataOutscaleServerCertificateFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataOutscaleServerCertificateFilterList",
      },
    };
