// https://registry.terraform.io/providers/outscale/outscale/1.3.0/docs/resources/api_access_rule
...
export interface ApiAccessRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.3.0/docs/resources/api_access_rule#ca_ids ApiAccessRule#ca_ids}
  */
  readonly caIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.3.0/docs/resources/api_access_rule#cns ApiAccessRule#cns}
  */
  readonly cns?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.3.0/docs/resources/api_access_rule#description ApiAccessRule#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.3.0/docs/resources/api_access_rule#id ApiAccessRule#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.3.0/docs/resources/api_access_rule#ip_ranges ApiAccessRule#ip_ranges}
  */
  readonly ipRanges?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/outscale/outscale/1.3.0/docs/resources/api_access_rule outscale_api_access_rule}
*/
export class ApiAccessRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiAccessRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/outscale/outscale/1.3.0/docs/resources/api_access_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/outscale/outscale/1.3.0/docs/resources/api_access_rule outscale_api_access_rule} Resource
  *
  * @param scope The scope in which to define this construct
