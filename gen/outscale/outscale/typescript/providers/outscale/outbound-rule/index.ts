// https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule
...
export interface OutboundRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#flow OutboundRule#flow}
  */
  readonly flow: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#from_port_range OutboundRule#from_port_range}
  */
  readonly fromPortRange?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#id OutboundRule#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#ip_protocol OutboundRule#ip_protocol}
  */
  readonly ipProtocol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#ip_range OutboundRule#ip_range}
  */
  readonly ipRange?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#security_group_account_id_to_link OutboundRule#security_group_account_id_to_link}
  */
  readonly securityGroupAccountIdToLink?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#security_group_id OutboundRule#security_group_id}
  */
  readonly securityGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#security_group_name_to_link OutboundRule#security_group_name_to_link}
  */
  readonly securityGroupNameToLink?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#to_port_range OutboundRule#to_port_range}
  */
  readonly toPortRange?: number;
  /**
  * rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#rules OutboundRule#rules}
  */
  readonly rules?: OutboundRuleRules[] | cdktf.IResolvable;
}
export interface OutboundRuleRulesSecurityGroupsMembers {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#account_id OutboundRule#account_id}
  */
  ...
  */
  readonly securityGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#security_group_name OutboundRule#security_group_name}
  */
  readonly securityGroupName?: string;
}

export function outboundRuleRulesSecurityGroupsMembersToTerraform(struct?: OutboundRuleRulesSecurityGroupsMembers | cdktf.IResolvable): any {
...
export function outboundRuleRulesSecurityGroupsMembersToHclTerraform(struct?: OutboundRuleRulesSecurityGroupsMembers | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class OutboundRuleRulesSecurityGroupsMembersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OutboundRuleRulesSecurityGroupsMembers | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: OutboundRuleRulesSecurityGroupsMembers | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class OutboundRuleRulesSecurityGroupsMembersList extends cdktf.ComplexList {
  public internalValue? : OutboundRuleRulesSecurityGroupsMembers[] | cdktf.IResolvable
  ...
  */
  public get(index: number): OutboundRuleRulesSecurityGroupsMembersOutputReference {
    return new OutboundRuleRulesSecurityGroupsMembersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface OutboundRuleRules {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#from_port_range OutboundRule#from_port_range}
  */
  readonly fromPortRange?: number;
  ...
  */
  readonly ipProtocol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#ip_ranges OutboundRule#ip_ranges}
  */
  readonly ipRanges?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#service_ids OutboundRule#service_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#security_groups_members OutboundRule#security_groups_members}
  */
  readonly securityGroupsMembers?: OutboundRuleRulesSecurityGroupsMembers[] | cdktf.IResolvable;
}

export function outboundRuleRulesToTerraform(struct?: OutboundRuleRules | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    security_groups_members: cdktf.listMapper(outboundRuleRulesSecurityGroupsMembersToTerraform, true)(struct!.securityGroupsMembers),
  }
}


export function outboundRuleRulesToHclTerraform(struct?: OutboundRuleRules | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    security_groups_members: {
      value: cdktf.listMapperHcl(outboundRuleRulesSecurityGroupsMembersToHclTerraform, true)(struct!.securityGroupsMembers),
      isBlock: true,
      type: "list",
      storageClassType: "OutboundRuleRulesSecurityGroupsMembersList",
    },
  };
...
export class OutboundRuleRulesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): OutboundRuleRules | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: OutboundRuleRules | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  private _securityGroupsMembers = new OutboundRuleRulesSecurityGroupsMembersList(this, "security_groups_members", false);
  public get securityGroupsMembers() {
    return this._securityGroupsMembers;
  }
  public putSecurityGroupsMembers(value: OutboundRuleRulesSecurityGroupsMembers[] | cdktf.IResolvable) {
...
export class OutboundRuleRulesList extends cdktf.ComplexList {
  public internalValue? : OutboundRuleRules[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): OutboundRuleRulesOutputReference {
    return new OutboundRuleRulesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule outscale_outbound_rule}
*/
export class OutboundRule extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "outscale_outbound_rule";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a OutboundRule resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the OutboundRule to import
  * @param importFromId The id of the existing OutboundRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the OutboundRule to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "outscale_outbound_rule", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/outscale/outscale/1.2.1/docs/resources/outbound_rule outscale_outbound_rule} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options OutboundRuleConfig
  */
  public constructor(scope: Construct, id: string, config: OutboundRuleConfig) {
    super(scope, id, {
      terraformResourceType: 'outscale_outbound_rule',
  ...
  private _rules = new OutboundRuleRulesList(this, "rules", false);
  public get rules() {
    return this._rules;
  }
  public putRules(value: OutboundRuleRules[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rules: cdktf.listMapper(outboundRuleRulesToTerraform, true)(this._rules.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      rules: {
        value: cdktf.listMapperHcl(outboundRuleRulesToHclTerraform, true)(this._rules.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OutboundRuleRulesList",
      },
    };
