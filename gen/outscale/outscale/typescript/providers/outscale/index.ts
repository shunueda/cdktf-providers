...
export * as oksCluster from './oks-cluster';
export * as oksProject from './oks-project';
...
export * as dataOutscaleOksKubeconfig from './data-outscale-oks-kubeconfig';
export * as dataOutscaleOksQuotas from './data-outscale-oks-quotas';
