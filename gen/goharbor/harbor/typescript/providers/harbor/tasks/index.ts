// https://registry.terraform.io/providers/goharbor/harbor/3.11.2/docs/resources/tasks
...
export interface TasksConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.2/docs/resources/tasks#id Tasks#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.2/docs/resources/tasks#vulnerability_scan_policy Tasks#vulnerability_scan_policy}
  */
  readonly vulnerabilityScanPolicy: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.2/docs/resources/tasks harbor_tasks}
*/
export class Tasks extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Tasks that should be imported. Refer to the {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.2/docs/resources/tasks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.2/docs/resources/tasks harbor_tasks} Resource
  *
  * @param scope The scope in which to define this construct
