...
export interface DataHarborProjectMemberGroupsProjectMemberGroups {
}

export function dataHarborProjectMemberGroupsProjectMemberGroupsToTerraform(struct?: DataHarborProjectMemberGroupsProjectMemberGroups): any {
...
export function dataHarborProjectMemberGroupsProjectMemberGroupsToHclTerraform(struct?: DataHarborProjectMemberGroupsProjectMemberGroups): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataHarborProjectMemberGroupsProjectMemberGroupsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataHarborProjectMemberGroupsProjectMemberGroups | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataHarborProjectMemberGroupsProjectMemberGroups | undefined) {
    if (value === undefined) {
...
export class DataHarborProjectMemberGroupsProjectMemberGroupsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataHarborProjectMemberGroupsProjectMemberGroupsOutputReference {
    return new DataHarborProjectMemberGroupsProjectMemberGroupsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataHarborProjectMemberGroups extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "harbor_project_member_groups";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "harbor_project_member_groups", importId: importFromId, provider });
      }
  ...
  * @param options DataHarborProjectMemberGroupsConfig
  */
  public constructor(scope: Construct, id: string, config: DataHarborProjectMemberGroupsConfig) {
    super(scope, id, {
  ...
  // project_member_groups - computed: true, optional: false, required: false
  private _projectMemberGroups = new DataHarborProjectMemberGroupsProjectMemberGroupsList(this, "project_member_groups", false);
  public get projectMemberGroups() {
    return this._projectMemberGroups;
  }
