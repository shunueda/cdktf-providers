// https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook
...
export interface ProjectWebhookConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook#address ProjectWebhook#address}
  */
  readonly address: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook#auth_header ProjectWebhook#auth_header}
  */
  readonly authHeader?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook#description ProjectWebhook#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook#enabled ProjectWebhook#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook#events_types ProjectWebhook#events_types}
  */
  readonly eventsTypes: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook#id ProjectWebhook#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook#name ProjectWebhook#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook#notify_type ProjectWebhook#notify_type}
  */
  readonly notifyType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook#payload_format ProjectWebhook#payload_format}
  */
  readonly payloadFormat?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook#project_id ProjectWebhook#project_id}
  */
  readonly projectId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook#skip_cert_verify ProjectWebhook#skip_cert_verify}
  */
  readonly skipCertVerify?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook harbor_project_webhook}
*/
export class ProjectWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/project_webhook harbor_project_webhook} Resource
  *
  * @param scope The scope in which to define this construct
