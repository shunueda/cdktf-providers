// https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/config_security
...
export interface ConfigSecurityConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/config_security#cve_allowlist ConfigSecurity#cve_allowlist}
  */
  readonly cveAllowlist: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/config_security#expires_at ConfigSecurity#expires_at}
  */
  readonly expiresAt?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/config_security#id ConfigSecurity#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/config_security harbor_config_security}
*/
export class ConfigSecurity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigSecurity that should be imported. Refer to the {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/config_security#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/goharbor/harbor/3.11.3/docs/resources/config_security harbor_config_security} Resource
  *
  * @param scope The scope in which to define this construct
