...
export interface DownloadClientQbittorrentCategories {
  /**
  * List of categories.
  *
...
export function downloadClientQbittorrentCategoriesToTerraform(struct?: DownloadClientQbittorrentCategories): any {
...
export function downloadClientQbittorrentCategoriesToHclTerraform(struct?: DownloadClientQbittorrentCategories): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DownloadClientQbittorrentCategoriesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DownloadClientQbittorrentCategories | undefined {
  ...
  public set internalValue(value: DownloadClientQbittorrentCategories | undefined) {
    if (value === undefined) {
...
export class DownloadClientQbittorrentCategoriesList extends cdktf.ComplexList {
  public internalValue? : DownloadClientQbittorrentCategories[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DownloadClientQbittorrentCategoriesOutputReference {
    return new DownloadClientQbittorrentCategoriesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DownloadClientQbittorrent extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "prowlarr_download_client_qbittorrent";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "prowlarr_download_client_qbittorrent", importId: importFromId, provider });
      }
  ...
  */
  ...
  private _categories = new DownloadClientQbittorrentCategoriesList(this, "categories", true);
  public get categories() {
    return this._categories;
  }
