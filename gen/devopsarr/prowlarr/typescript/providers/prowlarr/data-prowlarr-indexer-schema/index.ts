// https://registry.terraform.io/providers/devopsarr/prowlarr/3.1.0/docs/data-sources/indexer_schema
...
export interface DataProwlarrIndexerSchemaConfig extends cdktf.TerraformMetaArguments {
  ...
  * Indexer name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.1.0/docs/data-sources/indexer_schema#name DataProwlarrIndexerSchema#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.1.0/docs/data-sources/indexer_schema prowlarr_indexer_schema}
*/
export class DataProwlarrIndexerSchema extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataProwlarrIndexerSchema that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.1.0/docs/data-sources/indexer_schema#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.1.0/docs/data-sources/indexer_schema prowlarr_indexer_schema} Data Source
  *
  * @param scope The scope in which to define this construct
