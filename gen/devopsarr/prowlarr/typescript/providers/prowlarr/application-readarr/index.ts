...
export interface ApplicationReadarrConfig extends cdktf.TerraformMetaArguments {
  /**
  * API key.
  *
...
export class ApplicationReadarr extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "prowlarr_application_readarr";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "prowlarr_application_readarr", importId: importFromId, provider });
      }
  ...
  * @param options ApplicationReadarrConfig
  */
  public constructor(scope: Construct, id: string, config: ApplicationReadarrConfig) {
    super(scope, id, {
