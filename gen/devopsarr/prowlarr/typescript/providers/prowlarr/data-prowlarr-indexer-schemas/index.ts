// https://registry.terraform.io/providers/devopsarr/prowlarr/3.1.0/docs/data-sources/indexer_schemas
...
/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.1.0/docs/data-sources/indexer_schemas prowlarr_indexer_schemas}
*/
export class DataProwlarrIndexerSchemas extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataProwlarrIndexerSchemas that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.1.0/docs/data-sources/indexer_schemas#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.1.0/docs/data-sources/indexer_schemas prowlarr_indexer_schemas} Data Source
  *
  * @param scope The scope in which to define this construct
