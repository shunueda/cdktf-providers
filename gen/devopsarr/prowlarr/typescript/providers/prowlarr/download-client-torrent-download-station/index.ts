...
export interface DownloadClientTorrentDownloadStationCategories {
  /**
  * List of categories.
  *
...
export function downloadClientTorrentDownloadStationCategoriesToTerraform(struct?: DownloadClientTorrentDownloadStationCategories): any {
...
export function downloadClientTorrentDownloadStationCategoriesToHclTerraform(struct?: DownloadClientTorrentDownloadStationCategories): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DownloadClientTorrentDownloadStationCategoriesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DownloadClientTorrentDownloadStationCategories | undefined {
  ...
  public set internalValue(value: DownloadClientTorrentDownloadStationCategories | undefined) {
    if (value === undefined) {
...
export class DownloadClientTorrentDownloadStationCategoriesList extends cdktf.ComplexList {
  public internalValue? : DownloadClientTorrentDownloadStationCategories[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DownloadClientTorrentDownloadStationCategoriesOutputReference {
    return new DownloadClientTorrentDownloadStationCategoriesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DownloadClientTorrentDownloadStation extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "prowlarr_download_client_torrent_download_station";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "prowlarr_download_client_torrent_download_station", importId: importFromId, provider });
      }
  ...
  */
  ...
  private _categories = new DownloadClientTorrentDownloadStationCategoriesList(this, "categories", true);
  public get categories() {
    return this._categories;
  }
