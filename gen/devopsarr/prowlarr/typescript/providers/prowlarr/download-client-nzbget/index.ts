...
export interface DownloadClientNzbgetCategories {
  /**
  * List of categories.
  *
...
export function downloadClientNzbgetCategoriesToTerraform(struct?: DownloadClientNzbgetCategories): any {
...
export function downloadClientNzbgetCategoriesToHclTerraform(struct?: DownloadClientNzbgetCategories): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DownloadClientNzbgetCategoriesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DownloadClientNzbgetCategories | undefined {
  ...
  public set internalValue(value: DownloadClientNzbgetCategories | undefined) {
    if (value === undefined) {
...
export class DownloadClientNzbgetCategoriesList extends cdktf.ComplexList {
  public internalValue? : DownloadClientNzbgetCategories[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DownloadClientNzbgetCategoriesOutputReference {
    return new DownloadClientNzbgetCategoriesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DownloadClientNzbget extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "prowlarr_download_client_nzbget";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "prowlarr_download_client_nzbget", importId: importFromId, provider });
      }
  ...
  */
  ...
  private _categories = new DownloadClientNzbgetCategoriesList(this, "categories", true);
  public get categories() {
    return this._categories;
  }
