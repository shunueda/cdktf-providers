// https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise
...
export interface NotificationAppriseConfig extends cdktf.TerraformMetaArguments {
  ...
  * AuthPassword.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#auth_password NotificationApprise#auth_password}
  */
  readonly authPassword?: string;
  /**
  * AuthUsername.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#auth_username NotificationApprise#auth_username}
  */
  readonly authUsername?: string;
  /**
  * ConfigurationKey.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#configuration_key NotificationApprise#configuration_key}
  */
  readonly configurationKey?: string;
  /**
  * Tags and emojis.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#field_tags NotificationApprise#field_tags}
  */
  readonly fieldTags?: string[];
  /**
  * Include health warnings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#include_health_warnings NotificationApprise#include_health_warnings}
  */
  readonly includeHealthWarnings?: boolean | cdktf.IResolvable;
  /**
  * Include manual grab flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#include_manual_grabs NotificationApprise#include_manual_grabs}
  */
  readonly includeManualGrabs?: boolean | cdktf.IResolvable;
  /**
  * NotificationApprise name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#name NotificationApprise#name}
  */
  readonly name: string;
  /**
  * Notification type. `0` Info, `1` Success, `2` Warning, `3` Failure.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#notification_type NotificationApprise#notification_type}
  */
  readonly notificationType?: number;
  /**
  * On application update flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#on_application_update NotificationApprise#on_application_update}
  */
  readonly onApplicationUpdate?: boolean | cdktf.IResolvable;
  /**
  * On release grab flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#on_grab NotificationApprise#on_grab}
  */
  readonly onGrab?: boolean | cdktf.IResolvable;
  /**
  * On health issue flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#on_health_issue NotificationApprise#on_health_issue}
  */
  readonly onHealthIssue?: boolean | cdktf.IResolvable;
  /**
  * On health restored flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#on_health_restored NotificationApprise#on_health_restored}
  */
  readonly onHealthRestored?: boolean | cdktf.IResolvable;
  /**
  * Server URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#server_url NotificationApprise#server_url}
  */
  readonly serverUrl?: string;
  /**
  * Comma separated stateless URLs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#stateless_urls NotificationApprise#stateless_urls}
  */
  readonly statelessUrls?: string;
  /**
  * List of associated tags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#tags NotificationApprise#tags}
  */
  readonly tags?: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise prowlarr_notification_apprise}
*/
export class NotificationApprise extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NotificationApprise that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/resources/notification_apprise prowlarr_notification_apprise} Resource
  *
  * @param scope The scope in which to define this construct
