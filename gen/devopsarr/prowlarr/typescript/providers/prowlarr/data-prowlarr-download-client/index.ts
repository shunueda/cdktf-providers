// https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/data-sources/download_client
...
export interface DataProwlarrDownloadClientConfig extends cdktf.TerraformMetaArguments {
  /**
  * Download Client name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/data-sources/download_client#name DataProwlarrDownloadClient#name}
  */
  readonly name: string;
}
export interface DataProwlarrDownloadClientCategories {
}

export function dataProwlarrDownloadClientCategoriesToTerraform(struct?: DataProwlarrDownloadClientCategories): any {
...
export function dataProwlarrDownloadClientCategoriesToHclTerraform(struct?: DataProwlarrDownloadClientCategories): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataProwlarrDownloadClientCategoriesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataProwlarrDownloadClientCategories | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataProwlarrDownloadClientCategories | undefined) {
    if (value === undefined) {
...
export class DataProwlarrDownloadClientCategoriesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataProwlarrDownloadClientCategoriesOutputReference {
    return new DataProwlarrDownloadClientCategoriesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/data-sources/download_client prowlarr_download_client}
*/
export class DataProwlarrDownloadClient extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataProwlarrDownloadClient resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataProwlarrDownloadClient to import
  * @param importFromId The id of the existing DataProwlarrDownloadClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/data-sources/download_client#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataProwlarrDownloadClient to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/prowlarr/3.0.2/docs/data-sources/download_client prowlarr_download_client} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataProwlarrDownloadClientConfig
  */
  public constructor(scope: Construct, id: string, config: DataProwlarrDownloadClientConfig) {
    super(scope, id, {
  ...
  // categories - computed: true, optional: false, required: false
  private _categories = new DataProwlarrDownloadClientCategoriesList(this, "categories", true);
  public get categories() {
