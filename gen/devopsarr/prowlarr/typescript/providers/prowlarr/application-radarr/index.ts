...
export interface ApplicationRadarrConfig extends cdktf.TerraformMetaArguments {
  /**
  * API key.
  *
...
export class ApplicationRadarr extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "prowlarr_application_radarr";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "prowlarr_application_radarr", importId: importFromId, provider });
      }
  ...
  * @param options ApplicationRadarrConfig
  */
  public constructor(scope: Construct, id: string, config: ApplicationRadarrConfig) {
    super(scope, id, {
