// https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/data-sources/notifications
...
export interface DataSonarrNotificationsConfig extends cdktf.TerraformMetaArguments {
}
export interface DataSonarrNotificationsNotifications {
  /**
  * Notification name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/data-sources/notifications#name DataSonarrNotifications#name}
  */
  readonly name: string;
}

export function dataSonarrNotificationsNotificationsToTerraform(struct?: DataSonarrNotificationsNotifications): any {
...
export function dataSonarrNotificationsNotificationsToHclTerraform(struct?: DataSonarrNotificationsNotifications): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSonarrNotificationsNotificationsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSonarrNotificationsNotifications | undefined {
  ...
  public set internalValue(value: DataSonarrNotificationsNotifications | undefined) {
    if (value === undefined) {
...
export class DataSonarrNotificationsNotificationsList extends cdktf.ComplexList {
  public internalValue? : DataSonarrNotificationsNotifications[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataSonarrNotificationsNotificationsOutputReference {
    return new DataSonarrNotificationsNotificationsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/data-sources/notifications sonarr_notifications}
*/
export class DataSonarrNotifications extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sonarr_notifications";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataSonarrNotifications resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataSonarrNotifications to import
  * @param importFromId The id of the existing DataSonarrNotifications that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/data-sources/notifications#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataSonarrNotifications to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sonarr_notifications", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/data-sources/notifications sonarr_notifications} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataSonarrNotificationsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataSonarrNotificationsConfig = {}) {
    super(scope, id, {
  ...
  private _notifications = new DataSonarrNotificationsNotificationsList(this, "notifications", true);
