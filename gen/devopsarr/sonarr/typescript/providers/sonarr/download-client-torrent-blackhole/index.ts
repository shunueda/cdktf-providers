// https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole
...
export interface DownloadClientTorrentBlackholeConfig extends cdktf.TerraformMetaArguments {
  ...
  * Enable flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole#enable DownloadClientTorrentBlackhole#enable}
  */
  readonly enable?: boolean | cdktf.IResolvable;
  /**
  * Magnet file extension.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole#magnet_file_extension DownloadClientTorrentBlackhole#magnet_file_extension}
  */
  readonly magnetFileExtension?: string;
  /**
  * Download Client name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole#name DownloadClientTorrentBlackhole#name}
  */
  readonly name: string;
  /**
  * Priority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole#priority DownloadClientTorrentBlackhole#priority}
  */
  readonly priority?: number;
  /**
  * Read only flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole#read_only DownloadClientTorrentBlackhole#read_only}
  */
  readonly readOnly?: boolean | cdktf.IResolvable;
  /**
  * Remove completed downloads flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole#remove_completed_downloads DownloadClientTorrentBlackhole#remove_completed_downloads}
  */
  readonly removeCompletedDownloads?: boolean | cdktf.IResolvable;
  /**
  * Remove failed downloads flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole#remove_failed_downloads DownloadClientTorrentBlackhole#remove_failed_downloads}
  */
  readonly removeFailedDownloads?: boolean | cdktf.IResolvable;
  /**
  * Save magnet files flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole#save_magnet_files DownloadClientTorrentBlackhole#save_magnet_files}
  */
  readonly saveMagnetFiles?: boolean | cdktf.IResolvable;
  /**
  * List of associated tags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole#tags DownloadClientTorrentBlackhole#tags}
  */
  readonly tags?: number[];
  /**
  * Torrent folder.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole#torrent_folder DownloadClientTorrentBlackhole#torrent_folder}
  */
  readonly torrentFolder: string;
  /**
  * Watch folder flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole#watch_folder DownloadClientTorrentBlackhole#watch_folder}
  */
  readonly watchFolder: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole sonarr_download_client_torrent_blackhole}
*/
export class DownloadClientTorrentBlackhole extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sonarr_download_client_torrent_blackhole";
  ...
  * @param importFromId The id of the existing DownloadClientTorrentBlackhole that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sonarr_download_client_torrent_blackhole", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/download_client_torrent_blackhole sonarr_download_client_torrent_blackhole} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DownloadClientTorrentBlackholeConfig) {
    super(scope, id, {
      terraformResourceType: 'sonarr_download_client_torrent_blackhole',
