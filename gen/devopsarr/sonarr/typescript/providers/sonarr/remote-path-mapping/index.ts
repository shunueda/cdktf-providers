// https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/remote_path_mapping
...
export interface RemotePathMappingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/remote_path_mapping#host RemotePathMapping#host}
  */
  readonly host: string;
  /**
  * Local path.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/remote_path_mapping#local_path RemotePathMapping#local_path}
  */
  readonly localPath: string;
  /**
  * Download Client remote path.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/remote_path_mapping#remote_path RemotePathMapping#remote_path}
  */
  readonly remotePath: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/remote_path_mapping sonarr_remote_path_mapping}
*/
export class RemotePathMapping extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RemotePathMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/remote_path_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/remote_path_mapping sonarr_remote_path_mapping} Resource
  *
  * @param scope The scope in which to define this construct
