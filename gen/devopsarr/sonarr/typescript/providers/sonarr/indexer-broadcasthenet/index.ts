// https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet
...
export interface IndexerBroadcasthenetConfig extends cdktf.TerraformMetaArguments {
  /**
  * API key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet#api_key IndexerBroadcasthenet#api_key}
  */
  readonly apiKey: string;
  /**
  * Base URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet#base_url IndexerBroadcasthenet#base_url}
  */
  readonly baseUrl: string;
  /**
  * Download client ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet#download_client_id IndexerBroadcasthenet#download_client_id}
  */
  readonly downloadClientId?: number;
  /**
  * Enable automatic search flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet#enable_automatic_search IndexerBroadcasthenet#enable_automatic_search}
  */
  readonly enableAutomaticSearch?: boolean | cdktf.IResolvable;
  /**
  * Enable interactive search flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet#enable_interactive_search IndexerBroadcasthenet#enable_interactive_search}
  */
  readonly enableInteractiveSearch?: boolean | cdktf.IResolvable;
  /**
  * Enable RSS flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet#enable_rss IndexerBroadcasthenet#enable_rss}
  */
  readonly enableRss?: boolean | cdktf.IResolvable;
  /**
  * Minimum seeders.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet#minimum_seeders IndexerBroadcasthenet#minimum_seeders}
  */
  readonly minimumSeeders?: number;
  /**
  * IndexerBroadcastheNet name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet#name IndexerBroadcasthenet#name}
  */
  readonly name: string;
  /**
  * Priority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet#priority IndexerBroadcasthenet#priority}
  */
  readonly priority?: number;
  /**
  * Season seed time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet#season_pack_seed_time IndexerBroadcasthenet#season_pack_seed_time}
  */
  readonly seasonPackSeedTime?: number;
  /**
  * Seed ratio.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet#seed_ratio IndexerBroadcasthenet#seed_ratio}
  */
  readonly seedRatio?: number;
  /**
  * Seed time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet#seed_time IndexerBroadcasthenet#seed_time}
  */
  readonly seedTime?: number;
  /**
  * List of associated tags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet#tags IndexerBroadcasthenet#tags}
  */
  readonly tags?: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet sonarr_indexer_broadcasthenet}
*/
export class IndexerBroadcasthenet extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sonarr_indexer_broadcasthenet";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a IndexerBroadcasthenet resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the IndexerBroadcasthenet to import
  * @param importFromId The id of the existing IndexerBroadcasthenet that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IndexerBroadcasthenet to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sonarr_indexer_broadcasthenet", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/resources/indexer_broadcasthenet sonarr_indexer_broadcasthenet} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IndexerBroadcasthenetConfig
  */
  public constructor(scope: Construct, id: string, config: IndexerBroadcasthenetConfig) {
    super(scope, id, {
      terraformResourceType: 'sonarr_indexer_broadcasthenet',
