// https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/data-sources/indexers
...
export interface DataSonarrIndexersConfig extends cdktf.TerraformMetaArguments {
}
export interface DataSonarrIndexersIndexers {
}

export function dataSonarrIndexersIndexersToTerraform(struct?: DataSonarrIndexersIndexers): any {
...
export function dataSonarrIndexersIndexersToHclTerraform(struct?: DataSonarrIndexersIndexers): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSonarrIndexersIndexersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSonarrIndexersIndexers | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSonarrIndexersIndexers | undefined) {
    if (value === undefined) {
...
export class DataSonarrIndexersIndexersList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSonarrIndexersIndexersOutputReference {
    return new DataSonarrIndexersIndexersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/data-sources/indexers sonarr_indexers}
*/
export class DataSonarrIndexers extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sonarr_indexers";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataSonarrIndexers resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataSonarrIndexers to import
  * @param importFromId The id of the existing DataSonarrIndexers that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/data-sources/indexers#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataSonarrIndexers to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sonarr_indexers", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/sonarr/3.4.0/docs/data-sources/indexers sonarr_indexers} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataSonarrIndexersConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataSonarrIndexersConfig = {}) {
    super(scope, id, {
  ...
  private _indexers = new DataSonarrIndexersIndexersList(this, "indexers", true);
  public get indexers() {
