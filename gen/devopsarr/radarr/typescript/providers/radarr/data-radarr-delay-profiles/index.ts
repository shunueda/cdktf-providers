// https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/delay_profiles
...
/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/delay_profiles radarr_delay_profiles}
*/
export class DataRadarrDelayProfiles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRadarrDelayProfiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/delay_profiles#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/delay_profiles radarr_delay_profiles} Data Source
  *
  * @param scope The scope in which to define this construct
