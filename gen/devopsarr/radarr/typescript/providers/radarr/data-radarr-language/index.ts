// https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/language
...
export interface DataRadarrLanguageConfig extends cdktf.TerraformMetaArguments {
  ...
  * Language.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/language#name DataRadarrLanguage#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/language radarr_language}
*/
export class DataRadarrLanguage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRadarrLanguage that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/language#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/language radarr_language} Data Source
  *
  * @param scope The scope in which to define this construct
