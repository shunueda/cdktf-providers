// https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs
...
export interface RadarrProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs#api_key RadarrProvider#api_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs#extra_headers RadarrProvider#extra_headers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs#url RadarrProvider#url}
  */
  readonly url?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs#alias RadarrProvider#alias}
  */
...
export interface RadarrProviderExtraHeaders {
  ...
  * Header name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs#name RadarrProvider#name}
  */
  readonly name: string;
  /**
  * Header value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs#value RadarrProvider#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs radarr}
*/
export class RadarrProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing RadarrProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs radarr} Resource
  *
  * @param scope The scope in which to define this construct
