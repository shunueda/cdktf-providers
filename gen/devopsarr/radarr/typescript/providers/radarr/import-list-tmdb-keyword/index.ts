...
export interface ImportListTmdbKeywordConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class ImportListTmdbKeyword extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "radarr_import_list_tmdb_keyword";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "radarr_import_list_tmdb_keyword", importId: importFromId, provider });
      }
  ...
  * @param options ImportListTmdbKeywordConfig
  */
  public constructor(scope: Construct, id: string, config: ImportListTmdbKeywordConfig) {
    super(scope, id, {
  ...
  // keyword_id - computed: false, optional: false, required: true
