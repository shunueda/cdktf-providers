// https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/remote_path_mapping
...
export interface DataRadarrRemotePathMappingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/remote_path_mapping#id DataRadarrRemotePathMapping#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/remote_path_mapping radarr_remote_path_mapping}
*/
export class DataRadarrRemotePathMapping extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRadarrRemotePathMapping that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/remote_path_mapping#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/remote_path_mapping radarr_remote_path_mapping} Data Source
  *
  * @param scope The scope in which to define this construct
