// https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/resources/root_folder
...
export interface RootFolderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/resources/root_folder#path RootFolder#path}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/resources/root_folder radarr_root_folder}
*/
export class RootFolder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RootFolder that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/resources/root_folder#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/resources/root_folder radarr_root_folder} Resource
  *
  * @param scope The scope in which to define this construct
