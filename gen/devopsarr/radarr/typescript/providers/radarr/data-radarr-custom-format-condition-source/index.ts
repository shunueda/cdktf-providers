...
export interface DataRadarrCustomFormatConditionSourceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Specification name.
  *
...
export class DataRadarrCustomFormatConditionSource extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "radarr_custom_format_condition_source";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "radarr_custom_format_condition_source", importId: importFromId, provider });
      }
  ...
  * @param options DataRadarrCustomFormatConditionSourceConfig
  */
  public constructor(scope: Construct, id: string, config: DataRadarrCustomFormatConditionSourceConfig) {
    super(scope, id, {
