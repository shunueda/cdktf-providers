// https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/indexer
...
export interface DataRadarrIndexerConfig extends cdktf.TerraformMetaArguments {
  ...
  * Indexer name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/indexer#name DataRadarrIndexer#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/indexer radarr_indexer}
*/
export class DataRadarrIndexer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRadarrIndexer that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/indexer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/indexer radarr_indexer} Data Source
  *
  * @param scope The scope in which to define this construct
