...
export interface DataRadarrQualityDefinitionsConfig extends cdktf.TerraformMetaArguments {
}
export interface DataRadarrQualityDefinitionsQualityDefinitions {
  /**
  * Minimum size MB/min.
  *
...
export function dataRadarrQualityDefinitionsQualityDefinitionsToTerraform(struct?: DataRadarrQualityDefinitionsQualityDefinitions): any {
...
export function dataRadarrQualityDefinitionsQualityDefinitionsToHclTerraform(struct?: DataRadarrQualityDefinitionsQualityDefinitions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataRadarrQualityDefinitionsQualityDefinitionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataRadarrQualityDefinitionsQualityDefinitions | undefined {
  ...
  public set internalValue(value: DataRadarrQualityDefinitionsQualityDefinitions | undefined) {
    if (value === undefined) {
...
export class DataRadarrQualityDefinitionsQualityDefinitionsList extends cdktf.ComplexList {
  public internalValue? : DataRadarrQualityDefinitionsQualityDefinitions[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataRadarrQualityDefinitionsQualityDefinitionsOutputReference {
    return new DataRadarrQualityDefinitionsQualityDefinitionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataRadarrQualityDefinitions extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "radarr_quality_definitions";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "radarr_quality_definitions", importId: importFromId, provider });
      }
  ...
  * @param options DataRadarrQualityDefinitionsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataRadarrQualityDefinitionsConfig = {}) {
    super(scope, id, {
  ...
  private _qualityDefinitions = new DataRadarrQualityDefinitionsQualityDefinitionsList(this, "quality_definitions", true);
