// https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/resources/quality_definition
...
export interface QualityDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/resources/quality_definition#id QualityDefinition#id}
  *
  ...
  * Maximum size MB/min.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/resources/quality_definition#max_size QualityDefinition#max_size}
  */
  readonly maxSize?: number;
  /**
  * Minimum size MB/min.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/resources/quality_definition#min_size QualityDefinition#min_size}
  */
  readonly minSize?: number;
  /**
  * Preferred size MB/min.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/resources/quality_definition#preferred_size QualityDefinition#preferred_size}
  */
  readonly preferredSize?: number;
  /**
  * Quality Definition Title.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/resources/quality_definition#title QualityDefinition#title}
  */
  readonly title: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/resources/quality_definition radarr_quality_definition}
*/
export class QualityDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QualityDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/resources/quality_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/resources/quality_definition radarr_quality_definition} Resource
  *
  * @param scope The scope in which to define this construct
