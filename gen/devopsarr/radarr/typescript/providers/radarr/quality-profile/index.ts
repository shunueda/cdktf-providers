...
export function qualityProfileLanguageToTerraform(struct?: QualityProfileLanguage | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function qualityProfileLanguageToHclTerraform(struct?: QualityProfileLanguage | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class QualityProfileLanguageOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): QualityProfileLanguage | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: QualityProfileLanguage | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._id = undefined;
...
export class QualityProfile extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: QualityProfileConfig) {
    ...
    this._language.internalValue = config.language;
  ...
  private _language = new QualityProfileLanguageOutputReference(this, "language");
  public get language() {
    return this._language;
  }
  public putLanguage(value: QualityProfileLanguage) {
    this._language.internalValue = value;
  }
  // Temporarily expose input value. Use with caution.
  public get languageInput() {
    return this._language.internalValue;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      language: qualityProfileLanguageToTerraform(this._language.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      language: {
        value: qualityProfileLanguageToHclTerraform(this._language.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "QualityProfileLanguage",
      },
      min_format_score: {
