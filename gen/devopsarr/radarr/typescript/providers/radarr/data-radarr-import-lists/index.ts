// https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/import_lists
...
/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/import_lists radarr_import_lists}
*/
export class DataRadarrImportLists extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRadarrImportLists that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/import_lists#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/import_lists radarr_import_lists} Data Source
  *
  * @param scope The scope in which to define this construct
