...
export interface DataRadarrAutoTagConditionGenresConfig extends cdktf.TerraformMetaArguments {
  /**
  * Specification name.
  *
...
export class DataRadarrAutoTagConditionGenres extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "radarr_auto_tag_condition_genres";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "radarr_auto_tag_condition_genres", importId: importFromId, provider });
      }
  ...
  * @param options DataRadarrAutoTagConditionGenresConfig
  */
  public constructor(scope: Construct, id: string, config: DataRadarrAutoTagConditionGenresConfig) {
    super(scope, id, {
