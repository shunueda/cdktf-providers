// https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/indexer_config
...
/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/indexer_config radarr_indexer_config}
*/
export class DataRadarrIndexerConfigA extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRadarrIndexerConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/indexer_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/indexer_config radarr_indexer_config} Data Source
  *
  * @param scope The scope in which to define this construct
