...
export interface DataRadarrCustomFormatConfig extends cdktf.TerraformMetaArguments {
  /**
  * Custom Format name.
  *
...
export interface DataRadarrCustomFormatSpecifications {
}

export function dataRadarrCustomFormatSpecificationsToTerraform(struct?: DataRadarrCustomFormatSpecifications): any {
...
export function dataRadarrCustomFormatSpecificationsToHclTerraform(struct?: DataRadarrCustomFormatSpecifications): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataRadarrCustomFormatSpecificationsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataRadarrCustomFormatSpecifications | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataRadarrCustomFormatSpecifications | undefined) {
    if (value === undefined) {
...
export class DataRadarrCustomFormatSpecificationsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataRadarrCustomFormatSpecificationsOutputReference {
    return new DataRadarrCustomFormatSpecificationsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataRadarrCustomFormat extends cdktf.TerraformDataSource {
  ...
  * @param options DataRadarrCustomFormatConfig
  */
  public constructor(scope: Construct, id: string, config: DataRadarrCustomFormatConfig) {
    super(scope, id, {
  ...
  private _specifications = new DataRadarrCustomFormatSpecificationsList(this, "specifications", true);
