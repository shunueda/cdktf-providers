// https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/download_client_config
...
/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/download_client_config radarr_download_client_config}
*/
export class DataRadarrDownloadClientConfigA extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRadarrDownloadClientConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/download_client_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/download_client_config radarr_download_client_config} Data Source
  *
  * @param scope The scope in which to define this construct
