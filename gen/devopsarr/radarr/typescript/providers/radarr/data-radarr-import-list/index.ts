// https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/import_list
...
export interface DataRadarrImportListConfig extends cdktf.TerraformMetaArguments {
  ...
  * Import List name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/import_list#name DataRadarrImportList#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/import_list radarr_import_list}
*/
export class DataRadarrImportList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRadarrImportList that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/import_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/import_list radarr_import_list} Data Source
  *
  * @param scope The scope in which to define this construct
