// https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/resources/import_list_config
...
export interface ImportListConfigAConfig extends cdktf.TerraformMetaArguments {
  ...
  * Clean library level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/resources/import_list_config#sync_level ImportListConfigA#sync_level}
  */
  readonly syncLevel: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/resources/import_list_config radarr_import_list_config}
*/
export class ImportListConfigA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImportListConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/resources/import_list_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/resources/import_list_config radarr_import_list_config} Resource
  *
  * @param scope The scope in which to define this construct
