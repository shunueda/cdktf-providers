...
export interface DataRadarrCustomFormatConditionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Implementation.
  *
...
export class DataRadarrCustomFormatCondition extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "radarr_custom_format_condition";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "radarr_custom_format_condition", importId: importFromId, provider });
      }
  ...
  * @param options DataRadarrCustomFormatConditionConfig
  */
  public constructor(scope: Construct, id: string, config: DataRadarrCustomFormatConditionConfig) {
    super(scope, id, {
