...
export interface DataRadarrCustomFormatConditionIndexerFlagConfig extends cdktf.TerraformMetaArguments {
  /**
  * Specification name.
  *
...
export class DataRadarrCustomFormatConditionIndexerFlag extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "radarr_custom_format_condition_indexer_flag";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "radarr_custom_format_condition_indexer_flag", importId: importFromId, provider });
      }
  ...
  * @param options DataRadarrCustomFormatConditionIndexerFlagConfig
  */
  public constructor(scope: Construct, id: string, config: DataRadarrCustomFormatConditionIndexerFlagConfig) {
    super(scope, id, {
