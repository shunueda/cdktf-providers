// https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/delay_profile
...
export interface DataRadarrDelayProfileConfig extends cdktf.TerraformMetaArguments {
  ...
  * Delay Profile ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/delay_profile#id DataRadarrDelayProfile#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/delay_profile radarr_delay_profile}
*/
export class DataRadarrDelayProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRadarrDelayProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/delay_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/delay_profile radarr_delay_profile} Data Source
  *
  * @param scope The scope in which to define this construct
