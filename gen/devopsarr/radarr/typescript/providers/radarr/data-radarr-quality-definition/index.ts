// https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/quality_definition
...
export interface DataRadarrQualityDefinitionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/quality_definition#id DataRadarrQualityDefinition#id}
  *
  ...
  * Minimum size MB/min.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/quality_definition#min_size DataRadarrQualityDefinition#min_size}
  */
  readonly minSize?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/quality_definition radarr_quality_definition}
*/
export class DataRadarrQualityDefinition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRadarrQualityDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/quality_definition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.4/docs/data-sources/quality_definition radarr_quality_definition} Data Source
  *
  * @param scope The scope in which to define this construct
