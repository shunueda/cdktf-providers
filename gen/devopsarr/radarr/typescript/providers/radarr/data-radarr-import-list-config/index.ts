// https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/import_list_config
...
/**
* Represents a {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/import_list_config radarr_import_list_config}
*/
export class DataRadarrImportListConfigA extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataRadarrImportListConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/import_list_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/devopsarr/radarr/2.3.3/docs/data-sources/import_list_config radarr_import_list_config} Data Source
  *
  * @param scope The scope in which to define this construct
