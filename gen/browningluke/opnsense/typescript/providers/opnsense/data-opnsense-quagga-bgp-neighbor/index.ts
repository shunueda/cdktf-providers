// https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_neighbor
...
export interface DataOpnsenseQuaggaBgpNeighborConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_neighbor#id DataOpnsenseQuaggaBgpNeighbor#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_neighbor opnsense_quagga_bgp_neighbor}
*/
export class DataOpnsenseQuaggaBgpNeighbor extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpnsenseQuaggaBgpNeighbor that should be imported. Refer to the {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_neighbor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_neighbor opnsense_quagga_bgp_neighbor} Data Source
  *
  * @param scope The scope in which to define this construct
