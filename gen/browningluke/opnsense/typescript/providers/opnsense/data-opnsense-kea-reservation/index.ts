// https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/kea_reservation
...
export interface DataOpnsenseKeaReservationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/kea_reservation#id DataOpnsenseKeaReservation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/kea_reservation opnsense_kea_reservation}
*/
export class DataOpnsenseKeaReservation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpnsenseKeaReservation that should be imported. Refer to the {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/kea_reservation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/kea_reservation opnsense_kea_reservation} Data Source
  *
  * @param scope The scope in which to define this construct
