// https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_domain_override
...
export interface DataOpnsenseUnboundDomainOverrideConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_domain_override#id DataOpnsenseUnboundDomainOverride#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_domain_override opnsense_unbound_domain_override}
*/
export class DataOpnsenseUnboundDomainOverride extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpnsenseUnboundDomainOverride that should be imported. Refer to the {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_domain_override#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_domain_override opnsense_unbound_domain_override} Data Source
  *
  * @param scope The scope in which to define this construct
