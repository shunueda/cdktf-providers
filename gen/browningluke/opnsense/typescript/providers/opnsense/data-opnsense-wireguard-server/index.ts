// https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/wireguard_server
...
export interface DataOpnsenseWireguardServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/wireguard_server#id DataOpnsenseWireguardServer#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/wireguard_server opnsense_wireguard_server}
*/
export class DataOpnsenseWireguardServer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpnsenseWireguardServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/wireguard_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/wireguard_server opnsense_wireguard_server} Data Source
  *
  * @param scope The scope in which to define this construct
