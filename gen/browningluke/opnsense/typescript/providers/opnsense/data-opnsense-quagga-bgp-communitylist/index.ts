// https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_communitylist
...
export interface DataOpnsenseQuaggaBgpCommunitylistConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_communitylist#id DataOpnsenseQuaggaBgpCommunitylist#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_communitylist opnsense_quagga_bgp_communitylist}
*/
export class DataOpnsenseQuaggaBgpCommunitylist extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpnsenseQuaggaBgpCommunitylist that should be imported. Refer to the {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_communitylist#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_communitylist opnsense_quagga_bgp_communitylist} Data Source
  *
  * @param scope The scope in which to define this construct
