// https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_host_alias
...
export interface DataOpnsenseUnboundHostAliasConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_host_alias#id DataOpnsenseUnboundHostAlias#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_host_alias opnsense_unbound_host_alias}
*/
export class DataOpnsenseUnboundHostAlias extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpnsenseUnboundHostAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_host_alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_host_alias opnsense_unbound_host_alias} Data Source
  *
  * @param scope The scope in which to define this construct
