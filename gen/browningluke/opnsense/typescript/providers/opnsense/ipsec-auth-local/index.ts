...
export interface IpsecAuthLocalConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class IpsecAuthLocal extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "opnsense_ipsec_auth_local";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "opnsense_ipsec_auth_local", importId: importFromId, provider });
      }
  ...
  * @param options IpsecAuthLocalConfig
  */
  public constructor(scope: Construct, id: string, config: IpsecAuthLocalConfig) {
    super(scope, id, {
