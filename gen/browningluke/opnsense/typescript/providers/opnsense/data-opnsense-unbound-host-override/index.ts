// https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_host_override
...
export interface DataOpnsenseUnboundHostOverrideConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_host_override#id DataOpnsenseUnboundHostOverride#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_host_override opnsense_unbound_host_override}
*/
export class DataOpnsenseUnboundHostOverride extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpnsenseUnboundHostOverride that should be imported. Refer to the {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_host_override#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/unbound_host_override opnsense_unbound_host_override} Data Source
  *
  * @param scope The scope in which to define this construct
