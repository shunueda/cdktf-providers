// https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_aspath
...
export interface DataOpnsenseQuaggaBgpAspathConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_aspath#id DataOpnsenseQuaggaBgpAspath#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_aspath opnsense_quagga_bgp_aspath}
*/
export class DataOpnsenseQuaggaBgpAspath extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpnsenseQuaggaBgpAspath that should be imported. Refer to the {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_aspath#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/quagga_bgp_aspath opnsense_quagga_bgp_aspath} Data Source
  *
  * @param scope The scope in which to define this construct
