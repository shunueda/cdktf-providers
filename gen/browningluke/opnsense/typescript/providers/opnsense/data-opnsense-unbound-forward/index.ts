// https://registry.terraform.io/providers/browningluke/opnsense/0.16.0/docs/data-sources/unbound_forward
...
export interface DataOpnsenseUnboundForwardConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.0/docs/data-sources/unbound_forward#id DataOpnsenseUnboundForward#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.0/docs/data-sources/unbound_forward opnsense_unbound_forward}
*/
export class DataOpnsenseUnboundForward extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpnsenseUnboundForward that should be imported. Refer to the {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.0/docs/data-sources/unbound_forward#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.0/docs/data-sources/unbound_forward opnsense_unbound_forward} Data Source
  *
  * @param scope The scope in which to define this construct
