// https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/wireguard_client
...
export interface DataOpnsenseWireguardClientConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/wireguard_client#id DataOpnsenseWireguardClient#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/wireguard_client opnsense_wireguard_client}
*/
export class DataOpnsenseWireguardClient extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpnsenseWireguardClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/wireguard_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/browningluke/opnsense/0.16.1/docs/data-sources/wireguard_client opnsense_wireguard_client} Data Source
  *
  * @param scope The scope in which to define this construct
