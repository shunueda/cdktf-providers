// https://registry.terraform.io/providers/stileeducation/stile/0.0.25/docs
...
export interface StileProviderConfig {
  ...
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/stileeducation/stile/0.0.25/docs#alias StileProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/stileeducation/stile/0.0.25/docs stile}
*/
export class StileProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing StileProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/stileeducation/stile/0.0.25/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/stileeducation/stile/0.0.25/docs stile} Resource
  *
  * @param scope The scope in which to define this construct
