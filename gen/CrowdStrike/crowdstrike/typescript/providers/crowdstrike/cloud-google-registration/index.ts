// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration
...
export interface CloudGoogleRegistrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#deployment_method CloudGoogleRegistration#deployment_method}
  */
  readonly deploymentMethod?: string;
  /**
  * Regex patterns to exclude specific projects from registration. Each pattern must start with 'sys-' (case insensitive)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#excluded_project_patterns CloudGoogleRegistration#excluded_project_patterns}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#folders CloudGoogleRegistration#folders}
  */
  readonly folders?: string[];
  /**
  * The Google Cloud project ID where CrowdStrike infrastructure resources will be created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#infra_project CloudGoogleRegistration#infra_project}
  */
  readonly infraProject: string;
  /**
  * Google Cloud labels to apply to created resources
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#labels CloudGoogleRegistration#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The name of the registration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#name CloudGoogleRegistration#name}
  */
  readonly name: string;
  /**
  * Google Cloud organization ID to register. Must be numeric. Mutually exclusive with `folders` and `projects`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#organization CloudGoogleRegistration#organization}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#projects CloudGoogleRegistration#projects}
  */
  readonly projects?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#realtime_visibility CloudGoogleRegistration#realtime_visibility}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#resource_name_prefix CloudGoogleRegistration#resource_name_prefix}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#resource_name_suffix CloudGoogleRegistration#resource_name_suffix}
  */
  readonly resourceNameSuffix?: string;
  /**
  * Google Cloud tags to apply to created resources
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#tags CloudGoogleRegistration#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The Google Cloud project ID for Workload Identity Federation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#wif_project CloudGoogleRegistration#wif_project}
  */
  readonly wifProject: string;
  /**
  * Google Cloud project number for Workload Identity Federation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#wif_project_number CloudGoogleRegistration#wif_project_number}
  */
...
export interface CloudGoogleRegistrationRealtimeVisibility {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#enabled CloudGoogleRegistration#enabled}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration crowdstrike_cloud_google_registration}
*/
export class CloudGoogleRegistration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudGoogleRegistration that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/cloud_google_registration crowdstrike_cloud_google_registration} Resource
  *
  * @param scope The scope in which to define this construct
