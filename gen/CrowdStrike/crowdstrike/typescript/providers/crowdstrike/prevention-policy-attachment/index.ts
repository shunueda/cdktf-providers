// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/prevention_policy_attachment
...
export interface PreventionPolicyAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/prevention_policy_attachment#host_groups PreventionPolicyAttachment#host_groups}
  */
  readonly hostGroups?: string[];
  /**
  * The prevention policy id you want to attach to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/prevention_policy_attachment#id PreventionPolicyAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/prevention_policy_attachment#ioa_rule_groups PreventionPolicyAttachment#ioa_rule_groups}
  */
  readonly ioaRuleGroups?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/prevention_policy_attachment crowdstrike_prevention_policy_attachment}
*/
export class PreventionPolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PreventionPolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/prevention_policy_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/prevention_policy_attachment crowdstrike_prevention_policy_attachment} Resource
  *
  * @param scope The scope in which to define this construct
