// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/data-sources/cloud_compliance_framework_controls
...
export interface DataCrowdstrikeCloudComplianceFrameworkControlsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/data-sources/cloud_compliance_framework_controls#benchmark DataCrowdstrikeCloudComplianceFrameworkControls#benchmark}
  */
  readonly benchmark?: string;
  /**
  * Name of the control. Examples: `Ensure security contact phone is set`, `Ensure that Azure Defender*`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/data-sources/cloud_compliance_framework_controls#control_name DataCrowdstrikeCloudComplianceFrameworkControls#control_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/data-sources/cloud_compliance_framework_controls#fql DataCrowdstrikeCloudComplianceFrameworkControls#fql}
  */
  readonly fql?: string;
  /**
  * Requirement of the control(s) within the framework. Examples: `2.*`, `1.1`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/data-sources/cloud_compliance_framework_controls#requirement DataCrowdstrikeCloudComplianceFrameworkControls#requirement}
  */
  readonly requirement?: string;
  /**
  * Section of the benchmark where the control(s) reside. Examples: `Data Protection`, `Data*`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/data-sources/cloud_compliance_framework_controls#section DataCrowdstrikeCloudComplianceFrameworkControls#section}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/data-sources/cloud_compliance_framework_controls crowdstrike_cloud_compliance_framework_controls}
*/
export class DataCrowdstrikeCloudComplianceFrameworkControls extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCrowdstrikeCloudComplianceFrameworkControls that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/data-sources/cloud_compliance_framework_controls#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/data-sources/cloud_compliance_framework_controls crowdstrike_cloud_compliance_framework_controls} Data Source
  *
  * @param scope The scope in which to define this construct
