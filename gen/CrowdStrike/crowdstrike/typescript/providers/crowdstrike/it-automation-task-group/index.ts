// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.51/docs/resources/it_automation_task_group
...
export interface ItAutomationTaskGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.51/docs/resources/it_automation_task_group#access_type ItAutomationTaskGroup#access_type}
  */
  readonly accessType: string;
  /**
  * Assigned user IDs of the group, when access_type is Shared. Required when access_type is 'Shared'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.51/docs/resources/it_automation_task_group#assigned_user_ids ItAutomationTaskGroup#assigned_user_ids}
  */
  readonly assignedUserIds?: string[];
  /**
  * Description of the task group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.51/docs/resources/it_automation_task_group#description ItAutomationTaskGroup#description}
  */
  readonly description?: string;
  /**
  * Name of the task group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.51/docs/resources/it_automation_task_group#name ItAutomationTaskGroup#name}
  */
  readonly name: string;
  /**
  * Assigned task IDs of the group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.51/docs/resources/it_automation_task_group#task_ids ItAutomationTaskGroup#task_ids}
  */
  readonly taskIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.51/docs/resources/it_automation_task_group crowdstrike_it_automation_task_group}
*/
export class ItAutomationTaskGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ItAutomationTaskGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.51/docs/resources/it_automation_task_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.51/docs/resources/it_automation_task_group crowdstrike_it_automation_task_group} Resource
  *
  * @param scope The scope in which to define this construct
