// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/it_automation_policy_precedence
...
export interface ItAutomationPolicyPrecedenceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/it_automation_policy_precedence#enforcement ItAutomationPolicyPrecedence#enforcement}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/it_automation_policy_precedence#ids ItAutomationPolicyPrecedence#ids}
  */
  readonly ids: string[];
  /**
  * The platform of the IT automation policies (Windows, Linux, Mac).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/it_automation_policy_precedence#platform_name ItAutomationPolicyPrecedence#platform_name}
  */
  readonly platformName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/it_automation_policy_precedence crowdstrike_it_automation_policy_precedence}
*/
export class ItAutomationPolicyPrecedence extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ItAutomationPolicyPrecedence that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/it_automation_policy_precedence#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/it_automation_policy_precedence crowdstrike_it_automation_policy_precedence} Resource
  *
  * @param scope The scope in which to define this construct
