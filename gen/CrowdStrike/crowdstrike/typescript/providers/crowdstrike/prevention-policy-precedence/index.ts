// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/prevention_policy_precedence
...
export interface PreventionPolicyPrecedenceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/prevention_policy_precedence#enforcement PreventionPolicyPrecedence#enforcement}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/prevention_policy_precedence#ids PreventionPolicyPrecedence#ids}
  */
  readonly ids: string[];
  /**
  * That platform of the prevention policies. (Windows, Mac, Linux)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/prevention_policy_precedence#platform_name PreventionPolicyPrecedence#platform_name}
  */
  readonly platformName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/prevention_policy_precedence crowdstrike_prevention_policy_precedence}
*/
export class PreventionPolicyPrecedence extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PreventionPolicyPrecedence that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/prevention_policy_precedence#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/prevention_policy_precedence crowdstrike_prevention_policy_precedence} Resource
  *
  * @param scope The scope in which to define this construct
