// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.52/docs/resources/cloud_google_registration_logging_settings
...
export interface CloudGoogleRegistrationLoggingSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.52/docs/resources/cloud_google_registration_logging_settings#log_ingestion_sink_name CloudGoogleRegistrationLoggingSettings#log_ingestion_sink_name}
  */
  readonly logIngestionSinkName?: string;
  /**
  * The Pub/Sub subscription name for log ingestion.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.52/docs/resources/cloud_google_registration_logging_settings#log_ingestion_subscription_name CloudGoogleRegistrationLoggingSettings#log_ingestion_subscription_name}
  */
  readonly logIngestionSubscriptionName?: string;
  /**
  * The Pub/Sub topic ID for log ingestion.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.52/docs/resources/cloud_google_registration_logging_settings#log_ingestion_topic_id CloudGoogleRegistrationLoggingSettings#log_ingestion_topic_id}
  */
  readonly logIngestionTopicId?: string;
  /**
  * The Google Cloud registration ID to configure log ingestion settings for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.52/docs/resources/cloud_google_registration_logging_settings#registration_id CloudGoogleRegistrationLoggingSettings#registration_id}
  */
  readonly registrationId: string;
  /**
  * The Google Cloud project ID for Workload Identity Federation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.52/docs/resources/cloud_google_registration_logging_settings#wif_project CloudGoogleRegistrationLoggingSettings#wif_project}
  */
  readonly wifProject: string;
  /**
  * The Google Cloud project number for Workload Identity Federation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.52/docs/resources/cloud_google_registration_logging_settings#wif_project_number CloudGoogleRegistrationLoggingSettings#wif_project_number}
  */
  readonly wifProjectNumber: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.52/docs/resources/cloud_google_registration_logging_settings crowdstrike_cloud_google_registration_logging_settings}
*/
export class CloudGoogleRegistrationLoggingSettings extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.52/docs/resources/cloud_google_registration_logging_settings crowdstrike_cloud_google_registration_logging_settings} Resource
  *
  * @param scope The scope in which to define this construct
