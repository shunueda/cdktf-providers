// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/sensor_visibility_exclusion
...
export interface SensorVisibilityExclusionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/sensor_visibility_exclusion#apply_globally SensorVisibilityExclusion#apply_globally}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/sensor_visibility_exclusion#apply_to_descendant_processes SensorVisibilityExclusion#apply_to_descendant_processes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/sensor_visibility_exclusion#host_groups SensorVisibilityExclusion#host_groups}
  */
  readonly hostGroups?: string[];
  /**
  * The file path or pattern to exclude from sensor visibility. Use wildcards (*) for pattern matching.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/sensor_visibility_exclusion#value SensorVisibilityExclusion#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/sensor_visibility_exclusion crowdstrike_sensor_visibility_exclusion}
*/
export class SensorVisibilityExclusion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SensorVisibilityExclusion that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/sensor_visibility_exclusion#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/sensor_visibility_exclusion crowdstrike_sensor_visibility_exclusion} Resource
  *
  * @param scope The scope in which to define this construct
