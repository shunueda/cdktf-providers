// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy
...
export interface ContentUpdatePolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy#description ContentUpdatePolicy#description}
  */
  readonly description: string;
  /**
  * Enable the content update policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy#enabled ContentUpdatePolicy#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Host Group IDs to attach to the content update policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy#host_groups ContentUpdatePolicy#host_groups}
  */
  readonly hostGroups?: string[];
  /**
  * Name of the content update policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy#name ContentUpdatePolicy#name}
  */
  readonly name: string;
  /**
  * Ring assignment settings for rapid response allow/block listing content category.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy#rapid_response ContentUpdatePolicy#rapid_response}
  */
  readonly rapidResponse: ContentUpdatePolicyRapidResponse;
  /**
  * Ring assignment settings for sensor operations content category.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy#sensor_operations ContentUpdatePolicy#sensor_operations}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy#system_critical ContentUpdatePolicy#system_critical}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy#vulnerability_management ContentUpdatePolicy#vulnerability_management}
  */
...
export interface ContentUpdatePolicyRapidResponse {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy#delay_hours ContentUpdatePolicy#delay_hours}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy#pinned_content_version ContentUpdatePolicy#pinned_content_version}
  */
  readonly pinnedContentVersion?: string;
  /**
  * Ring assignment for the content category (ga, ea, pause).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy#ring_assignment ContentUpdatePolicy#ring_assignment}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy crowdstrike_content_update_policy}
*/
export class ContentUpdatePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContentUpdatePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/resources/content_update_policy crowdstrike_content_update_policy} Resource
  *
  * @param scope The scope in which to define this construct
