// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs
...
export interface CrowdstrikeProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs#client_id CrowdstrikeProvider#client_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs#client_secret CrowdstrikeProvider#client_secret}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs#cloud CrowdstrikeProvider#cloud}
  */
  readonly cloud?: string;
  /**
  * For MSSP Master CIDs, optionally lock the token to act on behalf of this member CID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs#member_cid CrowdstrikeProvider#member_cid}
  */
  readonly memberCid?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs#alias CrowdstrikeProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs crowdstrike}
*/
export class CrowdstrikeProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing CrowdstrikeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs crowdstrike} Resource
  *
  * @param scope The scope in which to define this construct
