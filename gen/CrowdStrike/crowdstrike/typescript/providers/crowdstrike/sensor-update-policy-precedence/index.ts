// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/sensor_update_policy_precedence
...
export interface SensorUpdatePolicyPrecedenceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/sensor_update_policy_precedence#enforcement SensorUpdatePolicyPrecedence#enforcement}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/sensor_update_policy_precedence#ids SensorUpdatePolicyPrecedence#ids}
  */
  readonly ids: string[];
  /**
  * That platform of the sensor update policies. (Windows, Mac, Linux)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/sensor_update_policy_precedence#platform_name SensorUpdatePolicyPrecedence#platform_name}
  */
  readonly platformName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/sensor_update_policy_precedence crowdstrike_sensor_update_policy_precedence}
*/
export class SensorUpdatePolicyPrecedence extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SensorUpdatePolicyPrecedence that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/sensor_update_policy_precedence#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/sensor_update_policy_precedence crowdstrike_sensor_update_policy_precedence} Resource
  *
  * @param scope The scope in which to define this construct
