// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy
...
export interface ItAutomationDefaultPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#concurrent_host_file_transfer_limit ItAutomationDefaultPolicy#concurrent_host_file_transfer_limit}
  */
  readonly concurrentHostFileTransferLimit: number;
  /**
  * Maximum number of hosts that can run operations simultaneously (1-100000).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#concurrent_host_limit ItAutomationDefaultPolicy#concurrent_host_limit}
  */
  readonly concurrentHostLimit: number;
  /**
  * Maximum number of tasks that can run in parallel (1-5).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#concurrent_task_limit ItAutomationDefaultPolicy#concurrent_task_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#cpu_scheduling_priority ItAutomationDefaultPolicy#cpu_scheduling_priority}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#cpu_throttle ItAutomationDefaultPolicy#cpu_throttle}
  */
  readonly cpuThrottle?: number;
  /**
  * Description of the default policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#description ItAutomationDefaultPolicy#description}
  */
  readonly description: string;
  /**
  * Whether OSQuery functionality is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#enable_os_query ItAutomationDefaultPolicy#enable_os_query}
  */
  readonly enableOsQuery: boolean | cdktf.IResolvable;
  /**
  * Whether Python script execution is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#enable_python_execution ItAutomationDefaultPolicy#enable_python_execution}
  */
  readonly enablePythonExecution: boolean | cdktf.IResolvable;
  /**
  * Whether script execution is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#enable_script_execution ItAutomationDefaultPolicy#enable_script_execution}
  */
  readonly enableScriptExecution: boolean | cdktf.IResolvable;
  /**
  * Maximum time a script can run before timing out.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#execution_timeout ItAutomationDefaultPolicy#execution_timeout}
  */
  readonly executionTimeout: number;
  /**
  * Unit of time for execution timeout.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#execution_timeout_unit ItAutomationDefaultPolicy#execution_timeout_unit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#memory_allocation ItAutomationDefaultPolicy#memory_allocation}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#memory_allocation_unit ItAutomationDefaultPolicy#memory_allocation_unit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#memory_pressure_level ItAutomationDefaultPolicy#memory_pressure_level}
  */
  readonly memoryPressureLevel?: string;
  /**
  * Platform for the default policy (Windows, Linux, Mac).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#platform_name ItAutomationDefaultPolicy#platform_name}
  */
  readonly platformName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy crowdstrike_it_automation_default_policy}
*/
export class ItAutomationDefaultPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ItAutomationDefaultPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/it_automation_default_policy crowdstrike_it_automation_default_policy} Resource
  *
  * @param scope The scope in which to define this construct
