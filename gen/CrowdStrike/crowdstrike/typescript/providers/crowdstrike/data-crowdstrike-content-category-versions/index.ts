// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.51/docs/data-sources/content_category_versions
...
/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.51/docs/data-sources/content_category_versions crowdstrike_content_category_versions}
*/
export class DataCrowdstrikeContentCategoryVersions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCrowdstrikeContentCategoryVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.51/docs/data-sources/content_category_versions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.51/docs/data-sources/content_category_versions crowdstrike_content_category_versions} Data Source
  *
  * @param scope The scope in which to define this construct
