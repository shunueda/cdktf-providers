// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/data-sources/sensor_update_policy_builds
...
/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/data-sources/sensor_update_policy_builds crowdstrike_sensor_update_policy_builds}
*/
export class DataCrowdstrikeSensorUpdatePolicyBuilds extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCrowdstrikeSensorUpdatePolicyBuilds that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/data-sources/sensor_update_policy_builds#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/data-sources/sensor_update_policy_builds crowdstrike_sensor_update_policy_builds} Data Source
  *
  * @param scope The scope in which to define this construct
