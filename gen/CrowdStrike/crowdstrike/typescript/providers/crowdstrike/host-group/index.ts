// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.43/docs/resources/host_group
...
export interface HostGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.43/docs/resources/host_group#assignment_rule HostGroup#assignment_rule}
  */
  readonly assignmentRule?: string;
  /**
  * A description for the host group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.43/docs/resources/host_group#description HostGroup#description}
  */
  readonly description: string;
  /**
  * A set of host IDs to include in a staticByID host group. Required if `type` is `staticByID`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.43/docs/resources/host_group#host_ids HostGroup#host_ids}
  */
  readonly hostIds?: string[];
  /**
  * A set of hostnames to include in a static host group. Required if `type` is `static`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.43/docs/resources/host_group#hostnames HostGroup#hostnames}
  */
  readonly hostnames?: string[];
  /**
  * The display name for the host group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.43/docs/resources/host_group#name HostGroup#name}
  */
  readonly name: string;
  /**
  * The type of host group. Valid values: `dynamic`, `static`, `staticByID`. This value is case sensitive.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.43/docs/resources/host_group#type HostGroup#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.43/docs/resources/host_group crowdstrike_host_group}
*/
export class HostGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HostGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.43/docs/resources/host_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.43/docs/resources/host_group crowdstrike_host_group} Resource
  *
  * @param scope The scope in which to define this construct
