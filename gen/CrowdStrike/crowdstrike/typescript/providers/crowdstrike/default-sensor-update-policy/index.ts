// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy
...
export interface DefaultSensorUpdatePolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy#build DefaultSensorUpdatePolicy#build}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy#build_arm64 DefaultSensorUpdatePolicy#build_arm64}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy#platform_name DefaultSensorUpdatePolicy#platform_name}
  */
  readonly platformName: string;
  /**
  * Prohibit sensor updates during a set of time blocks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy#schedule DefaultSensorUpdatePolicy#schedule}
  */
  readonly schedule: DefaultSensorUpdatePolicySchedule;
  /**
  * Enable uninstall protection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy#uninstall_protection DefaultSensorUpdatePolicy#uninstall_protection}
  */
...
export interface DefaultSensorUpdatePolicyScheduleTimeBlocks {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy#days DefaultSensorUpdatePolicy#days}
  */
  readonly days: string[];
  /**
  * The end time for the time block in 24HR format. Must be atleast 1 hour more than start_time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy#end_time DefaultSensorUpdatePolicy#end_time}
  */
  readonly endTime: string;
  /**
  * The start time for the time block in 24HR format. Must be atleast 1 hour before end_time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy#start_time DefaultSensorUpdatePolicy#start_time}
  */
...
export interface DefaultSensorUpdatePolicySchedule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy#enabled DefaultSensorUpdatePolicy#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * The time block to prevent sensor updates. Only set when enabled is true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy#time_blocks DefaultSensorUpdatePolicy#time_blocks}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy#timezone DefaultSensorUpdatePolicy#timezone}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy crowdstrike_default_sensor_update_policy}
*/
export class DefaultSensorUpdatePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DefaultSensorUpdatePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.47/docs/resources/default_sensor_update_policy crowdstrike_default_sensor_update_policy} Resource
  *
  * @param scope The scope in which to define this construct
