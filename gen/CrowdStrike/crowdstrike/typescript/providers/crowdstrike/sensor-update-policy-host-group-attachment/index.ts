// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/sensor_update_policy_host_group_attachment
...
export interface SensorUpdatePolicyHostGroupAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/sensor_update_policy_host_group_attachment#host_groups SensorUpdatePolicyHostGroupAttachment#host_groups}
  */
  readonly hostGroups?: string[];
  /**
  * The sensor update policy id you want to attach to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/sensor_update_policy_host_group_attachment#id SensorUpdatePolicyHostGroupAttachment#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/sensor_update_policy_host_group_attachment crowdstrike_sensor_update_policy_host_group_attachment}
*/
export class SensorUpdatePolicyHostGroupAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SensorUpdatePolicyHostGroupAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/sensor_update_policy_host_group_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.49/docs/resources/sensor_update_policy_host_group_attachment crowdstrike_sensor_update_policy_host_group_attachment} Resource
  *
  * @param scope The scope in which to define this construct
