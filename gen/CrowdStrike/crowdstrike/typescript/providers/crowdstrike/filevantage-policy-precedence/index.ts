// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/filevantage_policy_precedence
...
export interface FilevantagePolicyPrecedenceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/filevantage_policy_precedence#enforcement FilevantagePolicyPrecedence#enforcement}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/filevantage_policy_precedence#ids FilevantagePolicyPrecedence#ids}
  */
  readonly ids: string[];
  /**
  * That platform of the filevantage policies. (Windows, Mac, Linux)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/filevantage_policy_precedence#platform_name FilevantagePolicyPrecedence#platform_name}
  */
  readonly platformName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/filevantage_policy_precedence crowdstrike_filevantage_policy_precedence}
*/
export class FilevantagePolicyPrecedence extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FilevantagePolicyPrecedence that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/filevantage_policy_precedence#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.48/docs/resources/filevantage_policy_precedence crowdstrike_filevantage_policy_precedence} Resource
  *
  * @param scope The scope in which to define this construct
