// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/content_update_policy_precedence
...
export interface ContentUpdatePolicyPrecedenceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/content_update_policy_precedence#enforcement ContentUpdatePolicyPrecedence#enforcement}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/content_update_policy_precedence#ids ContentUpdatePolicyPrecedence#ids}
  */
  readonly ids: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/content_update_policy_precedence crowdstrike_content_update_policy_precedence}
*/
export class ContentUpdatePolicyPrecedence extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContentUpdatePolicyPrecedence that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/content_update_policy_precedence#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.46/docs/resources/content_update_policy_precedence crowdstrike_content_update_policy_precedence} Resource
  *
  * @param scope The scope in which to define this construct
