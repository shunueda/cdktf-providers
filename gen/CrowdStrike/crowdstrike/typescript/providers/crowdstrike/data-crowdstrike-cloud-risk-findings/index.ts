// https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/data-sources/cloud_risk_findings
...
export interface DataCrowdstrikeCloudRiskFindingsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/data-sources/cloud_risk_findings#filter DataCrowdstrikeCloudRiskFindings#filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/data-sources/cloud_risk_findings#sort DataCrowdstrikeCloudRiskFindings#sort}
  */
...
export class DataCrowdstrikeCloudRiskFindings extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCrowdstrikeCloudRiskFindings that should be imported. Refer to the {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/data-sources/cloud_risk_findings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/crowdstrike/crowdstrike/0.0.53/docs/data-sources/cloud_risk_findings crowdstrike_cloud_risk_findings} Data Source
  *
  * @param scope The scope in which to define this construct
