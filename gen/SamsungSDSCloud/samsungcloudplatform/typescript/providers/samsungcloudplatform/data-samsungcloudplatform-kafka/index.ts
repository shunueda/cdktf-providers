// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/kafka
...
export interface DataSamsungcloudplatformKafkaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/kafka#id DataSamsungcloudplatformKafka#id}
  *
  ...
  * Kafka Cluster Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/kafka#kafka_cluster_id DataSamsungcloudplatformKafka#kafka_cluster_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/kafka samsungcloudplatform_kafka}
*/
export class DataSamsungcloudplatformKafka extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSamsungcloudplatformKafka that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/kafka#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/kafka samsungcloudplatform_kafka} Data Source
  *
  * @param scope The scope in which to define this construct
