// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.15.0/docs/resources/transit_gateway_peering_approve
...
export interface TransitGatewayPeeringApproveConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.15.0/docs/resources/transit_gateway_peering_approve#id TransitGatewayPeeringApprove#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.15.0/docs/resources/transit_gateway_peering_approve#transit_gateway_peering_id TransitGatewayPeeringApprove#transit_gateway_peering_id}
  */
  readonly transitGatewayPeeringId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.15.0/docs/resources/transit_gateway_peering_approve samsungcloudplatform_transit_gateway_peering_approve}
*/
export class TransitGatewayPeeringApprove extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.15.0/docs/resources/transit_gateway_peering_approve samsungcloudplatform_transit_gateway_peering_approve} Resource
  *
  * @param scope The scope in which to define this construct
