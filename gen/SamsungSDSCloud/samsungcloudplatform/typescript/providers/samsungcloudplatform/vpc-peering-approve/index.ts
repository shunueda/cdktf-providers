// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering_approve
...
export interface VpcPeeringApproveConfig extends cdktf.TerraformMetaArguments {
  ...
  * Firewall Enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering_approve#firewall_enabled VpcPeeringApprove#firewall_enabled}
  */
  readonly firewallEnabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering_approve#id VpcPeeringApprove#id}
  *
  ...
  * Vpc Peering Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering_approve#vpc_peering_id VpcPeeringApprove#vpc_peering_id}
  */
  readonly vpcPeeringId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering_approve samsungcloudplatform_vpc_peering_approve}
*/
export class VpcPeeringApprove extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcPeeringApprove that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering_approve#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering_approve samsungcloudplatform_vpc_peering_approve} Resource
  *
  * @param scope The scope in which to define this construct
