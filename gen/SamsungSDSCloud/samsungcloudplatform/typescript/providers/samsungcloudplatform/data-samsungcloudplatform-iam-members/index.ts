...
export interface DataSamsungcloudplatformIamMembersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Company name
  *
...
export interface DataSamsungcloudplatformIamMembersContents {
}

export function dataSamsungcloudplatformIamMembersContentsToTerraform(struct?: DataSamsungcloudplatformIamMembersContents): any {
...
export function dataSamsungcloudplatformIamMembersContentsToHclTerraform(struct?: DataSamsungcloudplatformIamMembersContents): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSamsungcloudplatformIamMembersContentsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSamsungcloudplatformIamMembersContents | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSamsungcloudplatformIamMembersContents | undefined) {
    if (value === undefined) {
...
export class DataSamsungcloudplatformIamMembersContentsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSamsungcloudplatformIamMembersContentsOutputReference {
    return new DataSamsungcloudplatformIamMembersContentsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataSamsungcloudplatformIamMembersFilter {
  /**
...
export function dataSamsungcloudplatformIamMembersFilterToTerraform(struct?: DataSamsungcloudplatformIamMembersFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataSamsungcloudplatformIamMembersFilterToHclTerraform(struct?: DataSamsungcloudplatformIamMembersFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSamsungcloudplatformIamMembersFilterOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSamsungcloudplatformIamMembersFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataSamsungcloudplatformIamMembersFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataSamsungcloudplatformIamMembersFilterList extends cdktf.ComplexList {
  public internalValue? : DataSamsungcloudplatformIamMembersFilter[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataSamsungcloudplatformIamMembersFilterOutputReference {
    return new DataSamsungcloudplatformIamMembersFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSamsungcloudplatformIamMembers extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "samsungcloudplatform_iam_members";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "samsungcloudplatform_iam_members", importId: importFromId, provider });
      }
  ...
  * @param options DataSamsungcloudplatformIamMembersConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataSamsungcloudplatformIamMembersConfig = {}) {
    super(scope, id, {
  ...
  private _contents = new DataSamsungcloudplatformIamMembersContentsList(this, "contents", false);
  public get contents() {
  ...
  private _filter = new DataSamsungcloudplatformIamMembersFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: DataSamsungcloudplatformIamMembersFilter[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataSamsungcloudplatformIamMembersFilterToTerraform, true)(this._filter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktf.listMapperHcl(dataSamsungcloudplatformIamMembersFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataSamsungcloudplatformIamMembersFilterList",
      },
    };
