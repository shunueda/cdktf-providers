...
export interface DataSamsungcloudplatformLoggingauditUsersContents {
}

export function dataSamsungcloudplatformLoggingauditUsersContentsToTerraform(struct?: DataSamsungcloudplatformLoggingauditUsersContents): any {
...
export function dataSamsungcloudplatformLoggingauditUsersContentsToHclTerraform(struct?: DataSamsungcloudplatformLoggingauditUsersContents): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSamsungcloudplatformLoggingauditUsersContentsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSamsungcloudplatformLoggingauditUsersContents | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSamsungcloudplatformLoggingauditUsersContents | undefined) {
    if (value === undefined) {
...
export class DataSamsungcloudplatformLoggingauditUsersContentsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSamsungcloudplatformLoggingauditUsersContentsOutputReference {
    return new DataSamsungcloudplatformLoggingauditUsersContentsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataSamsungcloudplatformLoggingauditUsersFilter {
  /**
...
export function dataSamsungcloudplatformLoggingauditUsersFilterToTerraform(struct?: DataSamsungcloudplatformLoggingauditUsersFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataSamsungcloudplatformLoggingauditUsersFilterToHclTerraform(struct?: DataSamsungcloudplatformLoggingauditUsersFilter | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSamsungcloudplatformLoggingauditUsersFilterOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataSamsungcloudplatformLoggingauditUsersFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataSamsungcloudplatformLoggingauditUsersFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataSamsungcloudplatformLoggingauditUsersFilterList extends cdktf.ComplexList {
  public internalValue? : DataSamsungcloudplatformLoggingauditUsersFilter[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataSamsungcloudplatformLoggingauditUsersFilterOutputReference {
    return new DataSamsungcloudplatformLoggingauditUsersFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSamsungcloudplatformLoggingauditUsers extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "samsungcloudplatform_loggingaudit_users";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "samsungcloudplatform_loggingaudit_users", importId: importFromId, provider });
      }
  ...
  * @param options DataSamsungcloudplatformLoggingauditUsersConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataSamsungcloudplatformLoggingauditUsersConfig = {}) {
    super(scope, id, {
  ...
  private _contents = new DataSamsungcloudplatformLoggingauditUsersContentsList(this, "contents", false);
  public get contents() {
  ...
  private _filter = new DataSamsungcloudplatformLoggingauditUsersFilterList(this, "filter", true);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: DataSamsungcloudplatformLoggingauditUsersFilter[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(dataSamsungcloudplatformLoggingauditUsersFilterToTerraform, true)(this._filter.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      filter: {
        value: cdktf.listMapperHcl(dataSamsungcloudplatformLoggingauditUsersFilterToHclTerraform, true)(this._filter.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "DataSamsungcloudplatformLoggingauditUsersFilterList",
      },
    };
