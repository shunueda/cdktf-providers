// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/epas
...
export interface DataSamsungcloudplatformEpasConfig extends cdktf.TerraformMetaArguments {
  ...
  * EPAS Cluster Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/epas#epas_cluster_id DataSamsungcloudplatformEpas#epas_cluster_id}
  */
  readonly epasClusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/epas#id DataSamsungcloudplatformEpas#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/epas samsungcloudplatform_epas}
*/
export class DataSamsungcloudplatformEpas extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSamsungcloudplatformEpas that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/epas#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/epas samsungcloudplatform_epas} Data Source
  *
  * @param scope The scope in which to define this construct
