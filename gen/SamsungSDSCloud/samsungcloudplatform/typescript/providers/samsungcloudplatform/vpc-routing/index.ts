// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_routing
...
export interface VpcRoutingConfig extends cdktf.TerraformMetaArguments {
  ...
  * Network CIDR
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_routing#destination_network_cidr VpcRouting#destination_network_cidr}
  */
  readonly destinationNetworkCidr: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_routing#id VpcRouting#id}
  *
  ...
  * Routing Table id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_routing#routing_table_id VpcRouting#routing_table_id}
  */
  readonly routingTableId: string;
  /**
  * Source Interface Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_routing#source_service_interface_id VpcRouting#source_service_interface_id}
  */
  readonly sourceServiceInterfaceId: string;
  /**
  * Source Interface Name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_routing#source_service_interface_name VpcRouting#source_service_interface_name}
  */
  readonly sourceServiceInterfaceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_routing samsungcloudplatform_vpc_routing}
*/
export class VpcRouting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcRouting that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_routing#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_routing samsungcloudplatform_vpc_routing} Resource
  *
  * @param scope The scope in which to define this construct
