...
export interface DataSamsungcloudplatformVpcRoutingRoutesContents {
}

export function dataSamsungcloudplatformVpcRoutingRoutesContentsToTerraform(struct?: DataSamsungcloudplatformVpcRoutingRoutesContents | cdktf.IResolvable): any {
...
export function dataSamsungcloudplatformVpcRoutingRoutesContentsToHclTerraform(struct?: DataSamsungcloudplatformVpcRoutingRoutesContents | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSamsungcloudplatformVpcRoutingRoutesContentsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSamsungcloudplatformVpcRoutingRoutesContents | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataSamsungcloudplatformVpcRoutingRoutesContents | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataSamsungcloudplatformVpcRoutingRoutesContentsList extends cdktf.ComplexList {
  public internalValue? : DataSamsungcloudplatformVpcRoutingRoutesContents[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataSamsungcloudplatformVpcRoutingRoutesContentsOutputReference {
    return new DataSamsungcloudplatformVpcRoutingRoutesContentsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSamsungcloudplatformVpcRoutingRoutes extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "samsungcloudplatform_vpc_routing_routes";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "samsungcloudplatform_vpc_routing_routes", importId: importFromId, provider });
      }
  ...
  * @param options DataSamsungcloudplatformVpcRoutingRoutesConfig
  */
  public constructor(scope: Construct, id: string, config: DataSamsungcloudplatformVpcRoutingRoutesConfig) {
    super(scope, id, {
  ...
  private _contents = new DataSamsungcloudplatformVpcRoutingRoutesContentsList(this, "contents", false);
  public get contents() {
    return this._contents;
  }
  public putContents(value: DataSamsungcloudplatformVpcRoutingRoutesContents[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      contents: cdktf.listMapper(dataSamsungcloudplatformVpcRoutingRoutesContentsToTerraform, true)(this._contents.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      contents: {
        value: cdktf.listMapperHcl(dataSamsungcloudplatformVpcRoutingRoutesContentsToHclTerraform, true)(this._contents.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataSamsungcloudplatformVpcRoutingRoutesContentsList",
      },
    };
