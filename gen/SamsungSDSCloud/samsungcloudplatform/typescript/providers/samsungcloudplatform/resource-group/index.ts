...
export function resourceGroupTargetResourceTagToTerraform(struct?: ResourceGroupTargetResourceTag): any {
...
export function resourceGroupTargetResourceTagToHclTerraform(struct?: ResourceGroupTargetResourceTag): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ResourceGroupTargetResourceTagOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ResourceGroupTargetResourceTag | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ResourceGroupTargetResourceTag | undefined) {
    if (value === undefined) {
...
export class ResourceGroupTargetResourceTagList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): ResourceGroupTargetResourceTagOutputReference {
    return new ResourceGroupTargetResourceTagOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ResourceGroup extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "samsungcloudplatform_resource_group";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "samsungcloudplatform_resource_group", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: ResourceGroupConfig) {
    ...
    this._targetResourceTags = config.targetResourceTags;
  ...
  private _targetResourceTag = new ResourceGroupTargetResourceTagList(this, "target_resource_tag", false);
  public get targetResourceTag() {
    return this._targetResourceTag;
  }

  // target_resource_tags - computed: false, optional: true, required: false
  private _targetResourceTags?: { [key: string]: string }; 
  public get targetResourceTags() {
    return this.getStringMapAttribute('target_resource_tags');
  }
  public set targetResourceTags(value: { [key: string]: string }) {
    this._targetResourceTags = value;
  }
  public resetTargetResourceTags() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      target_resource_tags: cdktf.hashMapper(cdktf.stringToTerraform)(this._targetResourceTags),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      target_resource_tags: {
        value: cdktf.hashMapperHcl(cdktf.stringToHclTerraform)(this._targetResourceTags),
        isBlock: false,
        type: "map",
