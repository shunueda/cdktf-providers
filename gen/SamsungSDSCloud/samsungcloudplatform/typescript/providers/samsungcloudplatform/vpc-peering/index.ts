// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering
...
export interface VpcPeeringConfig extends cdktf.TerraformMetaArguments {
  ...
  * Approver VPC Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering#approver_vpc_id VpcPeering#approver_vpc_id}
  */
  readonly approverVpcId: string;
  /**
  * Firewall Enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering#firewall_enabled VpcPeering#firewall_enabled}
  */
  readonly firewallEnabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering#id VpcPeering#id}
  *
  ...
  * Requester VPC Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering#requester_vpc_id VpcPeering#requester_vpc_id}
  */
  readonly requesterVpcId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering#tags VpcPeering#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * VPC Peering Description
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering#vpc_peering_description VpcPeering#vpc_peering_description}
  */
  readonly vpcPeeringDescription?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering samsungcloudplatform_vpc_peering}
*/
export class VpcPeering extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcPeering that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/vpc_peering samsungcloudplatform_vpc_peering} Resource
  *
  * @param scope The scope in which to define this construct
