// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/dcon_vpc_connection
...
export interface DconVpcConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/dcon_vpc_connection#description DconVpcConnection#description}
  */
  readonly description?: string;
  /**
  * Direct connect id of requester
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/dcon_vpc_connection#direct_connect_id DconVpcConnection#direct_connect_id}
  */
  readonly directConnectId: string;
  /**
  * Firewall enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/dcon_vpc_connection#firewall_enabled DconVpcConnection#firewall_enabled}
  */
  readonly firewallEnabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/dcon_vpc_connection#id DconVpcConnection#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/dcon_vpc_connection#tags DconVpcConnection#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Vpc id of approver
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/dcon_vpc_connection#vpc_id DconVpcConnection#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/dcon_vpc_connection samsungcloudplatform_dcon_vpc_connection}
*/
export class DconVpcConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DconVpcConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/dcon_vpc_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/resources/dcon_vpc_connection samsungcloudplatform_dcon_vpc_connection} Resource
  *
  * @param scope The scope in which to define this construct
