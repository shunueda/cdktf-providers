// https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/redis
...
export interface DataSamsungcloudplatformRedisConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/redis#id DataSamsungcloudplatformRedis#id}
  *
  ...
  * redis  Id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/redis#redis_id DataSamsungcloudplatformRedis#redis_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/redis samsungcloudplatform_redis}
*/
export class DataSamsungcloudplatformRedis extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSamsungcloudplatformRedis that should be imported. Refer to the {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/redis#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/samsungsdscloud/samsungcloudplatform/3.16.0/docs/data-sources/redis samsungcloudplatform_redis} Data Source
  *
  * @param scope The scope in which to define this construct
