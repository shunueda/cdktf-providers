...
export interface DataSamsungcloudplatformKubernetesEngineVersionsContents {
}

export function dataSamsungcloudplatformKubernetesEngineVersionsContentsToTerraform(struct?: DataSamsungcloudplatformKubernetesEngineVersionsContents | cdktf.IResolvable): any {
...
export function dataSamsungcloudplatformKubernetesEngineVersionsContentsToHclTerraform(struct?: DataSamsungcloudplatformKubernetesEngineVersionsContents | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSamsungcloudplatformKubernetesEngineVersionsContentsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSamsungcloudplatformKubernetesEngineVersionsContents | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataSamsungcloudplatformKubernetesEngineVersionsContents | cdktf.IResolvable | undefined) {
    if (value === undefined) {
  ...
  // eos_date - computed: true, optional: false, required: false
  public get eosDate() {
    return this.getStringAttribute('eos_date');
  }
  ...
  // k8s_version_description - computed: true, optional: false, required: false
  public get k8SVersionDescription() {
    return this.getStringAttribute('k8s_version_description');
  }
...
export class DataSamsungcloudplatformKubernetesEngineVersionsContentsList extends cdktf.ComplexList {
  public internalValue? : DataSamsungcloudplatformKubernetesEngineVersionsContents[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataSamsungcloudplatformKubernetesEngineVersionsContentsOutputReference {
    return new DataSamsungcloudplatformKubernetesEngineVersionsContentsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSamsungcloudplatformKubernetesEngineVersions extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "samsungcloudplatform_kubernetes_engine_versions";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "samsungcloudplatform_kubernetes_engine_versions", importId: importFromId, provider });
      }
  ...
  * @param options DataSamsungcloudplatformKubernetesEngineVersionsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataSamsungcloudplatformKubernetesEngineVersionsConfig = {}) {
    super(scope, id, {
  ...
  private _contents = new DataSamsungcloudplatformKubernetesEngineVersionsContentsList(this, "contents", false);
  public get contents() {
    return this._contents;
  }
  public putContents(value: DataSamsungcloudplatformKubernetesEngineVersionsContents[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      contents: cdktf.listMapper(dataSamsungcloudplatformKubernetesEngineVersionsContentsToTerraform, true)(this._contents.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      contents: {
        value: cdktf.listMapperHcl(dataSamsungcloudplatformKubernetesEngineVersionsContentsToHclTerraform, true)(this._contents.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataSamsungcloudplatformKubernetesEngineVersionsContentsList",
      },
    };
