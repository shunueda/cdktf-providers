// https://registry.terraform.io/providers/commvault/commvault/1.2.10/docs/data-sources/kubernetes_labels
...
export interface DataCommvaultKubernetesLabelsConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class DataCommvaultKubernetesLabels extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "commvault_kubernetes_labels";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataCommvaultKubernetesLabels resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataCommvaultKubernetesLabels to import
  * @param importFromId The id of the existing DataCommvaultKubernetesLabels that should be imported. Refer to the {@link https://registry.terraform.io/providers/commvault/commvault/1.2.10/docs/data-sources/kubernetes_labels#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "commvault_kubernetes_labels", importId: importFromId, provider });
      }
  ...
  * @param options DataCommvaultKubernetesLabelsConfig
  */
  public constructor(scope: Construct, id: string, config: DataCommvaultKubernetesLabelsConfig) {
    super(scope, id, {
