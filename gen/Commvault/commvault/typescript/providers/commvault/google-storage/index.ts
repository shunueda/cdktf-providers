// https://registry.terraform.io/providers/commvault/commvault/1.2.10/docs/resources/google_storage
...
export interface GoogleStorageConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class GoogleStorage extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "commvault_google_storage";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a GoogleStorage resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the GoogleStorage to import
  * @param importFromId The id of the existing GoogleStorage that should be imported. Refer to the {@link https://registry.terraform.io/providers/commvault/commvault/1.2.10/docs/resources/google_storage#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GoogleStorage to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "commvault_google_storage", importId: importFromId, provider });
      }
  ...
  * @param options GoogleStorageConfig
  */
  public constructor(scope: Construct, id: string, config: GoogleStorageConfig) {
    super(scope, id, {
      terraformResourceType: 'commvault_google_storage',
