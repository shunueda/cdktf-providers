// https://registry.terraform.io/providers/navercloudplatform/ncloud/4.0.4/docs/data-sources/mysql
...
export interface DataNcloudMysqlConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/navercloudplatform/ncloud/4.0.4/docs/data-sources/mysql#id DataNcloudMysql#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/navercloudplatform/ncloud/4.0.4/docs/data-sources/mysql#service_name DataNcloudMysql#service_name}
  */
  readonly serviceName?: string;
}
export interface DataNcloudMysqlMysqlServerListStruct {
}

export function dataNcloudMysqlMysqlServerListStructToTerraform(struct?: DataNcloudMysqlMysqlServerListStruct): any {
...
export function dataNcloudMysqlMysqlServerListStructToHclTerraform(struct?: DataNcloudMysqlMysqlServerListStruct): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataNcloudMysqlMysqlServerListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataNcloudMysqlMysqlServerListStruct | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataNcloudMysqlMysqlServerListStruct | undefined) {
    if (value === undefined) {
...
export class DataNcloudMysqlMysqlServerListStructList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataNcloudMysqlMysqlServerListStructOutputReference {
    return new DataNcloudMysqlMysqlServerListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/navercloudplatform/ncloud/4.0.4/docs/data-sources/mysql ncloud_mysql}
*/
export class DataNcloudMysql extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataNcloudMysql resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataNcloudMysql to import
  * @param importFromId The id of the existing DataNcloudMysql that should be imported. Refer to the {@link https://registry.terraform.io/providers/navercloudplatform/ncloud/4.0.4/docs/data-sources/mysql#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataNcloudMysql to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/navercloudplatform/ncloud/4.0.4/docs/data-sources/mysql ncloud_mysql} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataNcloudMysqlConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataNcloudMysqlConfig = {}) {
    super(scope, id, {
  ...
  // is_multi_zone - computed: true, optional: false, required: false
  public get isMultiZone() {
    return this.getBooleanAttribute('is_multi_zone');
  }

  // is_storage_encryption - computed: true, optional: false, required: false
  ...
  private _mysqlServerList = new DataNcloudMysqlMysqlServerListStructList(this, "mysql_server_list", false);
