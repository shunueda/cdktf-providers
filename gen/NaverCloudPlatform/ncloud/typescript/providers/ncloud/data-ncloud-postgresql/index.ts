// https://registry.terraform.io/providers/navercloudplatform/ncloud/4.0.4/docs/data-sources/postgresql
...
export interface DataNcloudPostgresqlConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/navercloudplatform/ncloud/4.0.4/docs/data-sources/postgresql#id DataNcloudPostgresql#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/navercloudplatform/ncloud/4.0.4/docs/data-sources/postgresql#service_name DataNcloudPostgresql#service_name}
  */
  readonly serviceName?: string;
}
export interface DataNcloudPostgresqlPostgresqlServerListStruct {
}

export function dataNcloudPostgresqlPostgresqlServerListStructToTerraform(struct?: DataNcloudPostgresqlPostgresqlServerListStruct): any {
...
export function dataNcloudPostgresqlPostgresqlServerListStructToHclTerraform(struct?: DataNcloudPostgresqlPostgresqlServerListStruct): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataNcloudPostgresqlPostgresqlServerListStructOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataNcloudPostgresqlPostgresqlServerListStruct | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataNcloudPostgresqlPostgresqlServerListStruct | undefined) {
    if (value === undefined) {
...
export class DataNcloudPostgresqlPostgresqlServerListStructList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataNcloudPostgresqlPostgresqlServerListStructOutputReference {
    return new DataNcloudPostgresqlPostgresqlServerListStructOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/navercloudplatform/ncloud/4.0.4/docs/data-sources/postgresql ncloud_postgresql}
*/
export class DataNcloudPostgresql extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataNcloudPostgresql resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataNcloudPostgresql to import
  * @param importFromId The id of the existing DataNcloudPostgresql that should be imported. Refer to the {@link https://registry.terraform.io/providers/navercloudplatform/ncloud/4.0.4/docs/data-sources/postgresql#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataNcloudPostgresql to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/navercloudplatform/ncloud/4.0.4/docs/data-sources/postgresql ncloud_postgresql} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataNcloudPostgresqlConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataNcloudPostgresqlConfig = {}) {
    super(scope, id, {
  ...
  private _postgresqlServerList = new DataNcloudPostgresqlPostgresqlServerListStructList(this, "postgresql_server_list", false);
  ...
  // storage_encryption - computed: true, optional: false, required: false
