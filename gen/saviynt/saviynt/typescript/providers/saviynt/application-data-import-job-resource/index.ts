// https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/application_data_import_job_resource
...
export interface ApplicationDataImportJobResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/application_data_import_job_resource#jobs ApplicationDataImportJobResource#jobs}
  */
...
export interface ApplicationDataImportJobResourceJobs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/application_data_import_job_resource#accounts_or_access ApplicationDataImportJobResource#accounts_or_access}
  */
  readonly accountsOrAccess?: string;
  /**
  * Cron expression defining the schedule for the trigger. Example: "0 0 2 * * ?"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/application_data_import_job_resource#cron_expression ApplicationDataImportJobResource#cron_expression}
  */
  readonly cronExpression: string;
  /**
  * External connection configuration
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/application_data_import_job_resource#external_conn ApplicationDataImportJobResource#external_conn}
  */
  readonly externalConn?: string;
  /**
  * Full or incremental import type
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/application_data_import_job_resource#full_or_incremental ApplicationDataImportJobResource#full_or_incremental}
  */
  readonly fullOrIncremental?: string;
  /**
  * Name of the job group associated with the trigger. Example: "utility"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/application_data_import_job_resource#job_group ApplicationDataImportJobResource#job_group}
  */
  readonly jobGroup: string;
  /**
  * Security system for the application data import
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/application_data_import_job_resource#security_system ApplicationDataImportJobResource#security_system}
  */
  readonly securitySystem: string;
  /**
  * Group classification for the trigger. Example: "GRAILS_JOBS"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/application_data_import_job_resource#trigger_group ApplicationDataImportJobResource#trigger_group}
  */
  readonly triggerGroup?: string;
  /**
  * Unique name of the trigger. Example: "MyTrigger_001"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/application_data_import_job_resource#trigger_name ApplicationDataImportJobResource#trigger_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/application_data_import_job_resource saviynt_application_data_import_job_resource}
*/
export class ApplicationDataImportJobResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationDataImportJobResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/application_data_import_job_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/application_data_import_job_resource saviynt_application_data_import_job_resource} Resource
  *
  * @param scope The scope in which to define this construct
