// https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource
...
export interface SecuritySystemResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#access_add_workflow SecuritySystemResource#access_add_workflow}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#access_remove_workflow SecuritySystemResource#access_remove_workflow}
  */
  readonly accessRemoveWorkflow?: string;
  /**
  * Workflow for adding a service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#add_service_account_workflow SecuritySystemResource#add_service_account_workflow}
  */
  readonly addServiceAccountWorkflow?: string;
  /**
  * Specify true to enable automated provisioning.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#automated_provisioning SecuritySystemResource#automated_provisioning}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#connection_parameters SecuritySystemResource#connection_parameters}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#connectionname SecuritySystemResource#connectionname}
  */
  readonly connectionname?: string;
  /**
  * Specify a user-friendly display name that is shown on the the user interface.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#display_name SecuritySystemResource#display_name}
  */
  readonly displayName: string;
  /**
  * Contains JSON configuration for external risk connections and is applicable only for a few connections like SAP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#external_risk_connection_json SecuritySystemResource#external_risk_connection_json}
  */
  readonly externalRiskConnectionJson?: string;
  /**
  * Firefighter ID Request Access Workflow.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#firefighterid_request_access_workflow SecuritySystemResource#firefighterid_request_access_workflow}
  */
  readonly firefighteridRequestAccessWorkflow?: string;
  /**
  * Firefighter ID Workflow.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#firefighterid_workflow SecuritySystemResource#firefighterid_workflow}
  */
  readonly firefighteridWorkflow?: string;
  /**
  * Security system for which you want to create an endpoint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#hostname SecuritySystemResource#hostname}
  */
  readonly hostname?: string;
  /**
  * You can use this option used to filter out columns in SOD.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#inherent_sod_report_fields SecuritySystemResource#inherent_sod_report_fields}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#instant_provision SecuritySystemResource#instant_provision}
  */
  readonly instantProvision?: string;
  /**
  * Use this setting to assign the password policy for the security system.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#policy_rule SecuritySystemResource#policy_rule}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#policy_rule_service_account SecuritySystemResource#policy_rule_service_account}
  */
  readonly policyRuleServiceAccount?: string;
  /**
  * Description for the endpoint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#port SecuritySystemResource#port}
  */
  readonly port?: string;
  /**
  * Query to filter the access and display of the endpoint to specific users. If you do not define a query, the endpoint is displayed for all users
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#proposed_account_owners_workflow SecuritySystemResource#proposed_account_owners_workflow}
  */
  readonly proposedAccountOwnersWorkflow?: string;
  /**
  * Specify relevant comments for performing provisioning.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#provisioning_comments SecuritySystemResource#provisioning_comments}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#provisioning_connection SecuritySystemResource#provisioning_connection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#provisioning_tries SecuritySystemResource#provisioning_tries}
  */
  readonly provisioningTries?: string;
  /**
  * Specify true to import data from the endpoint associated to the security system.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#recon_application SecuritySystemResource#recon_application}
  */
  readonly reconApplication?: string;
  /**
  * Workflow for removing a service account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#remove_service_account_workflow SecuritySystemResource#remove_service_account_workflow}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#service_desk_connection SecuritySystemResource#service_desk_connection}
  */
  readonly serviceDeskConnection?: string;
  /**
  * Name of the security system.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#systemname SecuritySystemResource#systemname}
  */
  readonly systemname: string;
  /**
  * Specify true to enable the connectivity with any system over the open-source connectors such as REST.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#use_open_connector SecuritySystemResource#use_open_connector}
  */
  readonly useOpenConnector?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource saviynt_security_system_resource}
*/
export class SecuritySystemResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecuritySystemResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/security_system_resource saviynt_security_system_resource} Resource
  *
  * @param scope The scope in which to define this construct
