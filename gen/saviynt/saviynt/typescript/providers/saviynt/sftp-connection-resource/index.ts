// https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource
...
export interface SftpConnectionResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#auth_credential_type SftpConnectionResource#auth_credential_type}
  */
  readonly authCredentialType: string;
  /**
  * Authentication credential (password or private key path).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#auth_credential_value SftpConnectionResource#auth_credential_value}
  */
  readonly authCredentialValue?: string;
  /**
  * Authentication credential (write-only).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#auth_credential_value_wo SftpConnectionResource#auth_credential_value_wo}
  */
  readonly authCredentialValueWo?: string;
  /**
  * Name of the connection. Example: "Active Directory_Doc"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#connection_name SftpConnectionResource#connection_name}
  */
  readonly connectionName: string;
  /**
  * Default SAV roles for managing the connection. Example: "ROLE_ORG"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#defaultsavroles SftpConnectionResource#defaultsavroles}
  */
  readonly defaultsavroles?: string;
  /**
  * Description for the connection. Example: "ORG_AD"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#description SftpConnectionResource#description}
  */
  readonly description?: string;
  /**
  * Email template for notifications. Example: "New Account Task Creation"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#email_template SftpConnectionResource#email_template}
  */
  readonly emailTemplate?: string;
  /**
  * Files to download from SFTP server. Example: "*.csv"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#files_to_get SftpConnectionResource#files_to_get}
  */
  readonly filesToGet?: string;
  /**
  * Files to upload to SFTP server. Example: "upload/*.txt"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#files_to_put SftpConnectionResource#files_to_put}
  */
  readonly filesToPut?: string;
  /**
  * SFTP server hostname or IP address. Example: "sftp.example.com"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#host_name SftpConnectionResource#host_name}
  */
  readonly hostName: string;
  /**
  * PAM configuration for SFTP connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#pam_config SftpConnectionResource#pam_config}
  */
  readonly pamConfig?: string;
  /**
  * Passphrase for encrypted private key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#passphrase SftpConnectionResource#passphrase}
  */
  readonly passphrase?: string;
  /**
  * Passphrase for encrypted private key (write-only).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#passphrase_wo SftpConnectionResource#passphrase_wo}
  */
  readonly passphraseWo?: string;
  /**
  * SFTP server port number. Default is 22. Example: "22"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#port_number SftpConnectionResource#port_number}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#save_in_vault SftpConnectionResource#save_in_vault}
  */
  readonly saveInVault?: string;
  /**
  * Username for SFTP authentication. Example: "sftpuser"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#username SftpConnectionResource#username}
  */
  readonly username: string;
  /**
  * JSON string specifying vault configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#vault_configuration SftpConnectionResource#vault_configuration}
  */
  readonly vaultConfiguration?: string;
  /**
  * Specifies the type of vault connection being used (e.g., 'Hashicorp'). Example: "Hashicorp"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#vault_connection SftpConnectionResource#vault_connection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#wo_version SftpConnectionResource#wo_version}
  */
  readonly woVersion?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource saviynt_sftp_connection_resource}
*/
export class SftpConnectionResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SftpConnectionResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/sftp_connection_resource saviynt_sftp_connection_resource} Resource
  *
  * @param scope The scope in which to define this construct
