// https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/data-sources/sap_connection_datasource
...
export interface DataSaviyntSapConnectionDatasourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/data-sources/sap_connection_datasource#authenticate DataSaviyntSapConnectionDatasource#authenticate}
  */
  readonly authenticate: boolean | cdktf.IResolvable;
  /**
  * The key of the connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/data-sources/sap_connection_datasource#connection_key DataSaviyntSapConnectionDatasource#connection_key}
  */
  readonly connectionKey?: number;
  /**
  * The name of the connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/data-sources/sap_connection_datasource#connection_name DataSaviyntSapConnectionDatasource#connection_name}
  */
...
export class DataSaviyntSapConnectionDatasourceConnectionAttributesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // role_default_date - computed: true, optional: false, required: false
...
/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/data-sources/sap_connection_datasource saviynt_sap_connection_datasource}
*/
export class DataSaviyntSapConnectionDatasource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSaviyntSapConnectionDatasource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/data-sources/sap_connection_datasource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/data-sources/sap_connection_datasource saviynt_sap_connection_datasource} Data Source
  *
  * @param scope The scope in which to define this construct
