// https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/schema_user_job_resource
...
export interface SchemaUserJobResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/schema_user_job_resource#jobs SchemaUserJobResource#jobs}
  */
...
export interface SchemaUserJobResourceJobs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/schema_user_job_resource#cron_exp SchemaUserJobResource#cron_exp}
  */
  readonly cronExp: string;
  /**
  * Group classification for the trigger. Example: "GRAILS_JOBS"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/schema_user_job_resource#group SchemaUserJobResource#group}
  */
  readonly group: string;
  /**
  * Name of the job group associated with the trigger. Example: "utility"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/schema_user_job_resource#job_group SchemaUserJobResource#job_group}
  */
  readonly jobGroup: string;
  /**
  * Unique name of the trigger. Example: "MyTrigger_001"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/schema_user_job_resource#name SchemaUserJobResource#name}
  */
  readonly name: string;
  /**
  * Schema file names for the user job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/schema_user_job_resource#schema_file_names SchemaUserJobResource#schema_file_names}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/schema_user_job_resource saviynt_schema_user_job_resource}
*/
export class SchemaUserJobResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchemaUserJobResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/schema_user_job_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/schema_user_job_resource saviynt_schema_user_job_resource} Resource
  *
  * @param scope The scope in which to define this construct
