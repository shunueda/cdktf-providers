// https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/job_control_resource
...
export interface JobControlResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/job_control_resource#run_jobs JobControlResource#run_jobs}
  */
...
export interface JobControlResourceRunJobs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/job_control_resource#job_group JobControlResource#job_group}
  */
  readonly jobGroup: string;
  /**
  * Name of the job to run
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/job_control_resource#job_name JobControlResource#job_name}
  */
  readonly jobName: string;
  /**
  * Version identifier to trigger job run. Change this value to trigger re-run of the job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/job_control_resource#run_job_version JobControlResource#run_job_version}
  */
  readonly runJobVersion?: string;
  /**
  * Trigger name for the job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/job_control_resource#trigger_name JobControlResource#trigger_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/job_control_resource saviynt_job_control_resource}
*/
export class JobControlResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing JobControlResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/job_control_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/job_control_resource saviynt_job_control_resource} Resource
  *
  * @param scope The scope in which to define this construct
