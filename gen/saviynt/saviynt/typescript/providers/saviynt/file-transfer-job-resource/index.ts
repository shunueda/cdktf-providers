// https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/file_transfer_job_resource
...
export interface FileTransferJobResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/file_transfer_job_resource#jobs FileTransferJobResource#jobs}
  */
...
export interface FileTransferJobResourceJobs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/file_transfer_job_resource#cron_exp FileTransferJobResource#cron_exp}
  */
  readonly cronExp: string;
  /**
  * External connection key for file transfer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/file_transfer_job_resource#external_connection_key FileTransferJobResource#external_connection_key}
  */
  readonly externalConnectionKey: string;
  /**
  * File transfer action (UPLOAD or DOWNLOAD)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/file_transfer_job_resource#file_transfer_action FileTransferJobResource#file_transfer_action}
  */
  readonly fileTransferAction: string;
  /**
  * Group classification for the trigger. Example: "GRAILS_JOBS"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/file_transfer_job_resource#group FileTransferJobResource#group}
  */
  readonly group: string;
  /**
  * Name of the job group associated with the trigger. Example: "utility"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/file_transfer_job_resource#job_group FileTransferJobResource#job_group}
  */
  readonly jobGroup: string;
  /**
  * Unique name of the trigger. Example: "MyTrigger_001"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/file_transfer_job_resource#name FileTransferJobResource#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/file_transfer_job_resource saviynt_file_transfer_job_resource}
*/
export class FileTransferJobResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FileTransferJobResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/file_transfer_job_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.2/docs/resources/file_transfer_job_resource saviynt_file_transfer_job_resource} Resource
  *
  * @param scope The scope in which to define this construct
