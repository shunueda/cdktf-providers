// https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource
...
export interface GithubRestConnectionResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#access_tokens GithubRestConnectionResource#access_tokens}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#access_tokens_wo GithubRestConnectionResource#access_tokens_wo}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#connection_json GithubRestConnectionResource#connection_json}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#connection_json_wo GithubRestConnectionResource#connection_json_wo}
  */
  readonly connectionJsonWo?: string;
  /**
  * Name of the connection. Example: "Active Directory_Doc"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#connection_name GithubRestConnectionResource#connection_name}
  */
  readonly connectionName: string;
  /**
  * Default SAV roles for managing the connection. Example: "ROLE_ORG"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#defaultsavroles GithubRestConnectionResource#defaultsavroles}
  */
  readonly defaultsavroles?: string;
  /**
  * Description for the connection. Example: "ORG_AD"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#description GithubRestConnectionResource#description}
  */
  readonly description?: string;
  /**
  * Email template for notifications. Example: "New Account Task Creation"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#email_template GithubRestConnectionResource#email_template}
  */
  readonly emailTemplate?: string;
  /**
  * Property for ImportAccountEntJSON
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#import_account_ent_json GithubRestConnectionResource#import_account_ent_json}
  */
  readonly importAccountEntJson?: string;
  /**
  * Property for ORGANIZATION_LIST
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#organization_list GithubRestConnectionResource#organization_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#save_in_vault GithubRestConnectionResource#save_in_vault}
  */
  readonly saveInVault?: string;
  /**
  * Property for STATUS_THRESHOLD_CONFIG
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#status_threshold_config GithubRestConnectionResource#status_threshold_config}
  */
  readonly statusThresholdConfig?: string;
  /**
  * JSON string specifying vault configuration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#vault_configuration GithubRestConnectionResource#vault_configuration}
  */
  readonly vaultConfiguration?: string;
  /**
  * Specifies the type of vault connection being used (e.g., 'Hashicorp'). Example: "Hashicorp"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#vault_connection GithubRestConnectionResource#vault_connection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#wo_version GithubRestConnectionResource#wo_version}
  */
  readonly woVersion?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource saviynt_github_rest_connection_resource}
*/
export class GithubRestConnectionResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GithubRestConnectionResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/github_rest_connection_resource saviynt_github_rest_connection_resource} Resource
  *
  * @param scope The scope in which to define this construct
