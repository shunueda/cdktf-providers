// https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/import_transport_package_resource
...
export interface ImportTransportPackageResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/import_transport_package_resource#business_justification ImportTransportPackageResource#business_justification}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/import_transport_package_resource#import_package_version ImportTransportPackageResource#import_package_version}
  */
  readonly importPackageVersion?: string;
  /**
  * Complete path of the package that needs to be imported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/import_transport_package_resource#package_path ImportTransportPackageResource#package_path}
  */
  readonly packagePath: string;
  /**
  * Username of the user importing the package.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/import_transport_package_resource#update_user ImportTransportPackageResource#update_user}
  */
  readonly updateUser?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/import_transport_package_resource saviynt_import_transport_package_resource}
*/
export class ImportTransportPackageResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ImportTransportPackageResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/import_transport_package_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/import_transport_package_resource saviynt_import_transport_package_resource} Resource
  *
  * @param scope The scope in which to define this construct
