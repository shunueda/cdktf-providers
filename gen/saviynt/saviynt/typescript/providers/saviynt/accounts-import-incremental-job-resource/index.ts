// https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/accounts_import_incremental_job_resource
...
export interface AccountsImportIncrementalJobResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/accounts_import_incremental_job_resource#jobs AccountsImportIncrementalJobResource#jobs}
  */
...
export interface AccountsImportIncrementalJobResourceJobs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/accounts_import_incremental_job_resource#connection_name AccountsImportIncrementalJobResource#connection_name}
  */
  readonly connectionName?: string;
  /**
  * Cron expression defining the schedule for the trigger. Example: "0 0 2 * * ?"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/accounts_import_incremental_job_resource#cron_exp AccountsImportIncrementalJobResource#cron_exp}
  */
  readonly cronExp: string;
  /**
  * Group classification for the trigger. Example: "GRAILS_JOBS"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/accounts_import_incremental_job_resource#group AccountsImportIncrementalJobResource#group}
  */
  readonly group: string;
  /**
  * Name of the job group associated with the trigger. Example: "utility"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/accounts_import_incremental_job_resource#job_group AccountsImportIncrementalJobResource#job_group}
  */
  readonly jobGroup: string;
  /**
  * Unique name of the trigger. Example: "MyTrigger_001"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/accounts_import_incremental_job_resource#name AccountsImportIncrementalJobResource#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/accounts_import_incremental_job_resource saviynt_accounts_import_incremental_job_resource}
*/
export class AccountsImportIncrementalJobResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountsImportIncrementalJobResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/accounts_import_incremental_job_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.2.13/docs/resources/accounts_import_incremental_job_resource saviynt_accounts_import_incremental_job_resource} Resource
  *
  * @param scope The scope in which to define this construct
