// https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/ecm_sap_user_job_resource
...
export interface EcmSapUserJobResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/ecm_sap_user_job_resource#jobs EcmSapUserJobResource#jobs}
  */
...
export interface EcmSapUserJobResourceJobs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/ecm_sap_user_job_resource#cron_expression EcmSapUserJobResource#cron_expression}
  */
  readonly cronExpression: string;
  /**
  * Name of the job group associated with the trigger. Example: "utility"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/ecm_sap_user_job_resource#job_group EcmSapUserJobResource#job_group}
  */
  readonly jobGroup: string;
  /**
  * Action to take on failure
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/ecm_sap_user_job_resource#on_failure EcmSapUserJobResource#on_failure}
  */
  readonly onFailure?: string;
  /**
  * Group classification for the trigger. Example: "GRAILS_JOBS"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/ecm_sap_user_job_resource#trigger_group EcmSapUserJobResource#trigger_group}
  */
  readonly triggerGroup?: string;
  /**
  * Unique name of the trigger. Example: "MyTrigger_001"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/ecm_sap_user_job_resource#trigger_name EcmSapUserJobResource#trigger_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/ecm_sap_user_job_resource saviynt_ecm_sap_user_job_resource}
*/
export class EcmSapUserJobResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EcmSapUserJobResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/ecm_sap_user_job_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/ecm_sap_user_job_resource saviynt_ecm_sap_user_job_resource} Resource
  *
  * @param scope The scope in which to define this construct
