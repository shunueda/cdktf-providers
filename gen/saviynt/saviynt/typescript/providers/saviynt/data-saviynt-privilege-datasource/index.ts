// https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/data-sources/privilege_datasource
...
export interface DataSaviyntPrivilegeDatasourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/data-sources/privilege_datasource#authenticate DataSaviyntPrivilegeDatasource#authenticate}
  */
  readonly authenticate: boolean | cdktf.IResolvable;
  /**
  * The name of the endpoint to query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/data-sources/privilege_datasource#endpoint DataSaviyntPrivilegeDatasource#endpoint}
  */
  readonly endpoint: string;
  /**
  * The name of the entitlement type to query.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/data-sources/privilege_datasource#entitlement_type DataSaviyntPrivilegeDatasource#entitlement_type}
  */
  readonly entitlementType?: string;
  /**
  * Maximum number of privileges to retrieve.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/data-sources/privilege_datasource#max DataSaviyntPrivilegeDatasource#max}
  */
  readonly max?: string;
  /**
  * Pagination offset for retrieving privileges.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/data-sources/privilege_datasource#offset DataSaviyntPrivilegeDatasource#offset}
  */
...
export interface DataSaviyntPrivilegeDatasourcePrivilegesListStruct {
  ...
  * Hide on create
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/data-sources/privilege_datasource#hide_on_create DataSaviyntPrivilegeDatasource#hide_on_create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/data-sources/privilege_datasource saviynt_privilege_datasource}
*/
export class DataSaviyntPrivilegeDatasource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSaviyntPrivilegeDatasource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/data-sources/privilege_datasource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/data-sources/privilege_datasource saviynt_privilege_datasource} Data Source
  *
  * @param scope The scope in which to define this construct
