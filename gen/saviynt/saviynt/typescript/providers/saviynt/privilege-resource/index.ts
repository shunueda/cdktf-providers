// https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource
...
export interface PrivilegeResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#endpoint PrivilegeResource#endpoint}
  */
  readonly endpoint: string;
  /**
  * Name of the entitlement type for the privilege
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#entitlement_type PrivilegeResource#entitlement_type}
  */
  readonly entitlementType: string;
  /**
  * Map of privileges to create/manage
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#privileges PrivilegeResource#privileges}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#security_system PrivilegeResource#security_system}
  */
...
export interface PrivilegeResourcePrivileges {
  ...
  * Action string
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#action_string PrivilegeResource#action_string}
  */
  readonly actionString?: string;
  /**
  * Configuration type for the attribute
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#attribute_config PrivilegeResource#attribute_config}
  */
  readonly attributeConfig: string;
  /**
  * Attribute group
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#attribute_group PrivilegeResource#attribute_group}
  */
  readonly attributeGroup?: string;
  /**
  * Attribute name for the privilege
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#attribute_name PrivilegeResource#attribute_name}
  */
  readonly attributeName: string;
  /**
  * Type of the attribute/privilege
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#attribute_type PrivilegeResource#attribute_type}
  */
  readonly attributeType: string;
  /**
  * Child action
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#child_action PrivilegeResource#child_action}
  */
  readonly childAction?: string;
  /**
  * Default value for the privilege
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#default_value PrivilegeResource#default_value}
  */
  readonly defaultValue?: string;
  /**
  * Description for the privilege
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#description PrivilegeResource#description}
  */
  readonly description?: string;
  /**
  * Hide on create
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#hide_on_create PrivilegeResource#hide_on_create}
  */
  readonly hideOnCreate?: boolean | cdktf.IResolvable;
  /**
  * Hide on update
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#hide_on_update PrivilegeResource#hide_on_update}
  */
  readonly hideOnUpdate?: boolean | cdktf.IResolvable;
  /**
  * Label for the privilege
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#label PrivilegeResource#label}
  */
  readonly label?: string;
  /**
  * Order index
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#order_index PrivilegeResource#order_index}
  */
  readonly orderIndex?: string;
  /**
  * Parent attribute for the given privilege
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#parent_attribute PrivilegeResource#parent_attribute}
  */
  readonly parentAttribute?: string;
  /**
  * Is requestable
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#requestable PrivilegeResource#requestable}
  */
  readonly requestable?: boolean | cdktf.IResolvable;
  /**
  * Is required
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#required PrivilegeResource#required}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource saviynt_privilege_resource}
*/
export class PrivilegeResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivilegeResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.1/docs/resources/privilege_resource saviynt_privilege_resource} Resource
  *
  * @param scope The scope in which to define this construct
