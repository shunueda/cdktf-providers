// https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/ws_retry_blocking_job_resource
...
export interface WsRetryBlockingJobResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/ws_retry_blocking_job_resource#jobs WsRetryBlockingJobResource#jobs}
  */
...
export interface WsRetryBlockingJobResourceJobs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/ws_retry_blocking_job_resource#cron_expression WsRetryBlockingJobResource#cron_expression}
  */
  readonly cronExpression: string;
  /**
  * Name of the job group associated with the trigger. Example: "utility"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/ws_retry_blocking_job_resource#job_group WsRetryBlockingJobResource#job_group}
  */
  readonly jobGroup: string;
  /**
  * List of security systems for the WS blocking retry job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/ws_retry_blocking_job_resource#security_systems WsRetryBlockingJobResource#security_systems}
  */
  readonly securitySystems?: string[];
  /**
  * Task types for the WS blocking retry job
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/ws_retry_blocking_job_resource#task_types WsRetryBlockingJobResource#task_types}
  */
  readonly taskTypes?: string;
  /**
  * Group classification for the trigger. Example: "GRAILS_JOBS"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/ws_retry_blocking_job_resource#trigger_group WsRetryBlockingJobResource#trigger_group}
  */
  readonly triggerGroup?: string;
  /**
  * Unique name of the trigger. Example: "MyTrigger_001"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/ws_retry_blocking_job_resource#trigger_name WsRetryBlockingJobResource#trigger_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/ws_retry_blocking_job_resource saviynt_ws_retry_blocking_job_resource}
*/
export class WsRetryBlockingJobResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WsRetryBlockingJobResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/ws_retry_blocking_job_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/ws_retry_blocking_job_resource saviynt_ws_retry_blocking_job_resource} Resource
  *
  * @param scope The scope in which to define this construct
