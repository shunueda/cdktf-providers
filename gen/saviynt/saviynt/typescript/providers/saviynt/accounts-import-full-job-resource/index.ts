// https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/accounts_import_full_job_resource
...
export interface AccountsImportFullJobResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/accounts_import_full_job_resource#jobs AccountsImportFullJobResource#jobs}
  */
...
export interface AccountsImportFullJobResourceJobs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/accounts_import_full_job_resource#connection_name AccountsImportFullJobResource#connection_name}
  */
  readonly connectionName: string;
  /**
  * Cron expression defining the schedule for the trigger. Example: "0 0 2 * * ?"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/accounts_import_full_job_resource#cron_expression AccountsImportFullJobResource#cron_expression}
  */
  readonly cronExpression: string;
  /**
  * Name of the job group associated with the trigger. Example: "utility"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/accounts_import_full_job_resource#job_group AccountsImportFullJobResource#job_group}
  */
  readonly jobGroup: string;
  /**
  * Group classification for the trigger. Example: "GRAILS_JOBS"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/accounts_import_full_job_resource#trigger_group AccountsImportFullJobResource#trigger_group}
  */
  readonly triggerGroup?: string;
  /**
  * Unique name of the trigger. Example: "MyTrigger_001"
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/accounts_import_full_job_resource#trigger_name AccountsImportFullJobResource#trigger_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/accounts_import_full_job_resource saviynt_accounts_import_full_job_resource}
*/
export class AccountsImportFullJobResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountsImportFullJobResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/accounts_import_full_job_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/saviynt/saviynt/0.3.0/docs/resources/accounts_import_full_job_resource saviynt_accounts_import_full_job_resource} Resource
  *
  * @param scope The scope in which to define this construct
