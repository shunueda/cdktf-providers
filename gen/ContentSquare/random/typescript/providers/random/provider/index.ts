// https://registry.terraform.io/providers/contentsquare/random/3.1.0/docs
...
export interface RandomProviderConfig {
  ...
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/contentsquare/random/3.1.0/docs#alias RandomProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/contentsquare/random/3.1.0/docs random}
*/
export class RandomProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing RandomProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/contentsquare/random/3.1.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/contentsquare/random/3.1.0/docs random} Resource
  *
  * @param scope The scope in which to define this construct
