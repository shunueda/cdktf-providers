// https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/data-sources/template_version
...
export interface DataSendgridTemplateVersionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/data-sources/template_version#id DataSendgridTemplateVersion#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/data-sources/template_version#template_id DataSendgridTemplateVersion#template_id}
  */
  readonly templateId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/data-sources/template_version sendgrid_template_version}
*/
export class DataSendgridTemplateVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSendgridTemplateVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/data-sources/template_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/data-sources/template_version sendgrid_template_version} Data Source
  *
  * @param scope The scope in which to define this construct
