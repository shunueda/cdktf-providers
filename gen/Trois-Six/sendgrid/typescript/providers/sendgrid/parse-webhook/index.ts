// https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/resources/parse_webhook
...
export interface ParseWebhookConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/resources/parse_webhook#hostname ParseWebhook#hostname}
  */
  readonly hostname: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/resources/parse_webhook#id ParseWebhook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/resources/parse_webhook#send_raw ParseWebhook#send_raw}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/resources/parse_webhook#spam_check ParseWebhook#spam_check}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/resources/parse_webhook#url ParseWebhook#url}
  */
  readonly url: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/resources/parse_webhook sendgrid_parse_webhook}
*/
export class ParseWebhook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ParseWebhook that should be imported. Refer to the {@link https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/resources/parse_webhook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/trois-six/sendgrid/0.2.1/docs/resources/parse_webhook sendgrid_parse_webhook} Resource
  *
  * @param scope The scope in which to define this construct
