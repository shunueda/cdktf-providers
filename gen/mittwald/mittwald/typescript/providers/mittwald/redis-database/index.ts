// https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/redis_database
...
export interface RedisDatabaseConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/redis_database#configuration RedisDatabase#configuration}
  */
  readonly configuration?: RedisDatabaseConfiguration;
  /**
  * Description for your redis_database
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/redis_database#description RedisDatabase#description}
  */
  readonly description: string;
  /**
  * The ID of the project the redis_database belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/redis_database#project_id RedisDatabase#project_id}
  */
  readonly projectId: string;
  /**
  * Version of the database, e.g. `7.0`
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/redis_database#version RedisDatabase#version}
  */
...
export interface RedisDatabaseConfiguration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/redis_database#additional_flags RedisDatabase#additional_flags}
  */
  readonly additionalFlags?: string[];
  /**
  * The database's maximum memory in MiB
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/redis_database#max_memory_mb RedisDatabase#max_memory_mb}
  */
  readonly maxMemoryMb?: number;
  /**
  * The database's key eviction policy. See the Redis documentation on key evictions for more information.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/redis_database#max_memory_policy RedisDatabase#max_memory_policy}
  */
  readonly maxMemoryPolicy?: string;
  /**
  * Enable persistent storage for this database
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/redis_database#persistent RedisDatabase#persistent}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/redis_database mittwald_redis_database}
*/
export class RedisDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/redis_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/redis_database mittwald_redis_database} Resource
  *
  * @param scope The scope in which to define this construct
