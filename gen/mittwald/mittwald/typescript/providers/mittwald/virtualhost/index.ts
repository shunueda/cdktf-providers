// https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/virtualhost
...
export interface VirtualhostConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/virtualhost#hostname Virtualhost#hostname}
  */
  readonly hostname: string;
  /**
  * The desired paths for the virtualhost.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/virtualhost#paths Virtualhost#paths}
  */
  readonly paths: { [key: string]: VirtualhostPaths } | cdktf.IResolvable;
  /**
  * The ID of the project the virtualhost belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/virtualhost#project_id Virtualhost#project_id}
  */
...
export interface VirtualhostPathsContainer {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/virtualhost#container_id Virtualhost#container_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/virtualhost#port Virtualhost#port}
  */
...
export interface VirtualhostPaths {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/virtualhost#app Virtualhost#app}
  */
  readonly app?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/virtualhost#container Virtualhost#container}
  */
  readonly container?: VirtualhostPathsContainer;
  /**
  * The URL to redirect to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/virtualhost#redirect Virtualhost#redirect}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/virtualhost mittwald_virtualhost}
*/
export class Virtualhost extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Virtualhost that should be imported. Refer to the {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/virtualhost#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.1/docs/resources/virtualhost mittwald_virtualhost} Resource
  *
  * @param scope The scope in which to define this construct
