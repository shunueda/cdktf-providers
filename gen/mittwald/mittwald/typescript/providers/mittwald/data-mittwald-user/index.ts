// https://registry.terraform.io/providers/mittwald/mittwald/1.5.0/docs/data-sources/user
...
export interface DataMittwaldUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.0/docs/data-sources/user#id DataMittwaldUser#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.0/docs/data-sources/user mittwald_user}
*/
export class DataMittwaldUser extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMittwaldUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.0/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mittwald/mittwald/1.5.0/docs/data-sources/user mittwald_user} Data Source
  *
  * @param scope The scope in which to define this construct
