// https://registry.terraform.io/providers/mittwald/mittwald/1.4.5/docs/data-sources/container_image
...
export interface DataMittwaldContainerImageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.5/docs/data-sources/container_image#image DataMittwaldContainerImage#image}
  */
  readonly image: string;
  /**
  * The ID of the project where the image is stored. This attribute (or `registry_id`)  is required if the image is not public.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.5/docs/data-sources/container_image#project_id DataMittwaldContainerImage#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.5/docs/data-sources/container_image#registry_id DataMittwaldContainerImage#registry_id}
  */
  readonly registryId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.5/docs/data-sources/container_image mittwald_container_image}
*/
export class DataMittwaldContainerImage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMittwaldContainerImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.5/docs/data-sources/container_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.5/docs/data-sources/container_image mittwald_container_image} Data Source
  *
  * @param scope The scope in which to define this construct
