// https://registry.terraform.io/providers/mittwald/mittwald/1.4.5/docs/data-sources/app
...
export interface DataMittwaldAppConfig extends cdktf.TerraformMetaArguments {
  ...
  * The app name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.5/docs/data-sources/app#name DataMittwaldApp#name}
  */
  readonly name: string;
  /**
  * Set this to just select the recommended version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.5/docs/data-sources/app#recommended DataMittwaldApp#recommended}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.5/docs/data-sources/app#selector DataMittwaldApp#selector}
  */
  readonly selector?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.5/docs/data-sources/app mittwald_app}
*/
export class DataMittwaldApp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMittwaldApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.5/docs/data-sources/app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/mittwald/mittwald/1.4.5/docs/data-sources/app mittwald_app} Data Source
  *
  * @param scope The scope in which to define this construct
