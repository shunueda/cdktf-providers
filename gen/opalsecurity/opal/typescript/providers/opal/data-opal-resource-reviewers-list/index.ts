// https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/resource_reviewers_list
...
export interface DataOpalResourceReviewersListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/resource_reviewers_list#resource_id DataOpalResourceReviewersList#resource_id}
  */
  readonly resourceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/resource_reviewers_list opal_resource_reviewers_list}
*/
export class DataOpalResourceReviewersList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalResourceReviewersList that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/resource_reviewers_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/resource_reviewers_list opal_resource_reviewers_list} Data Source
  *
  * @param scope The scope in which to define this construct
