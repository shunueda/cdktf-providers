// https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs
...
export interface OpalProviderConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs#bearer_auth OpalProvider#bearer_auth}
  */
  readonly bearerAuth?: string;
  /**
  * HTTP headers to include in all requests
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs#http_headers OpalProvider#http_headers}
  */
  readonly httpHeaders?: { [key: string]: string };
  /**
  * Server URL (defaults to https://api.opal.dev/v1)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs#server_url OpalProvider#server_url}
  */
  readonly serverUrl?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs#alias OpalProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs opal}
*/
export class OpalProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing OpalProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs opal} Resource
  *
  * @param scope The scope in which to define this construct
