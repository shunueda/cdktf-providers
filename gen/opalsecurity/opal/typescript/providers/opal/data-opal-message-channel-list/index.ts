// https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/message_channel_list
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/message_channel_list opal_message_channel_list}
*/
export class DataOpalMessageChannelList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalMessageChannelList that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/message_channel_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/message_channel_list opal_message_channel_list} Data Source
  *
  * @param scope The scope in which to define this construct
