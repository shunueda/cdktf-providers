// https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/message_channel
...
export interface DataOpalMessageChannelConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/message_channel#id DataOpalMessageChannel#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/message_channel opal_message_channel}
*/
export class DataOpalMessageChannel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalMessageChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/message_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/message_channel opal_message_channel} Data Source
  *
  * @param scope The scope in which to define this construct
