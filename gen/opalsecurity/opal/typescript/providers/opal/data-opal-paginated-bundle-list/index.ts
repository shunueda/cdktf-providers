...
export interface DataOpalPaginatedBundleListConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataOpalPaginatedBundleListBundles {
}

export function dataOpalPaginatedBundleListBundlesToTerraform(struct?: DataOpalPaginatedBundleListBundles): any {
...
export function dataOpalPaginatedBundleListBundlesToHclTerraform(struct?: DataOpalPaginatedBundleListBundles): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataOpalPaginatedBundleListBundlesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataOpalPaginatedBundleListBundles | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataOpalPaginatedBundleListBundles | undefined) {
    if (value === undefined) {
...
export class DataOpalPaginatedBundleListBundlesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataOpalPaginatedBundleListBundlesOutputReference {
    return new DataOpalPaginatedBundleListBundlesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataOpalPaginatedBundleList extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "opal_paginated_bundle_list";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "opal_paginated_bundle_list", importId: importFromId, provider });
      }
  ...
  * @param options DataOpalPaginatedBundleListConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataOpalPaginatedBundleListConfig = {}) {
    super(scope, id, {
  ...
  private _bundles = new DataOpalPaginatedBundleListBundlesList(this, "bundles", false);
  public get bundles() {
