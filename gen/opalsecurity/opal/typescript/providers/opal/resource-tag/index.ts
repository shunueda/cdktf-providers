...
export interface ResourceTagConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class ResourceTag extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "opal_resource_tag";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "opal_resource_tag", importId: importFromId, provider });
      }
  ...
  * @param options ResourceTagConfig
  */
  public constructor(scope: Construct, id: string, config: ResourceTagConfig) {
    super(scope, id, {
