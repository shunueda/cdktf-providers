// https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/bundle_visibility
...
export interface DataOpalBundleVisibilityConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/bundle_visibility#bundle_id DataOpalBundleVisibility#bundle_id}
  */
  readonly bundleId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/bundle_visibility opal_bundle_visibility}
*/
export class DataOpalBundleVisibility extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOpalBundleVisibility that should be imported. Refer to the {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/bundle_visibility#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/opalsecurity/opal/3.4.0/docs/data-sources/bundle_visibility opal_bundle_visibility} Data Source
  *
  * @param scope The scope in which to define this construct
