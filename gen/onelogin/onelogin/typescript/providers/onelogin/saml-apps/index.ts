// https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps
...
export interface SamlAppsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#allow_assumed_signin SamlApps#allow_assumed_signin}
  */
  readonly allowAssumedSignin?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#brand_id SamlApps#brand_id}
  */
  readonly brandId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#configuration SamlApps#configuration}
  */
  readonly configuration?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#connector_id SamlApps#connector_id}
  */
  readonly connectorId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#description SamlApps#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#id SamlApps#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#name SamlApps#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#notes SamlApps#notes}
  */
  readonly notes?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#provisioning SamlApps#provisioning}
  */
  readonly provisioning?: { [key: string]: (boolean | cdktf.IResolvable) };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#sso SamlApps#sso}
  */
  readonly sso?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#visible SamlApps#visible}
  */
  readonly visible?: boolean | cdktf.IResolvable;
  /**
  * parameters block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#parameters SamlApps#parameters}
  */
  readonly parameters?: SamlAppsParameters[] | cdktf.IResolvable;
}
export interface SamlAppsParameters {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#attributes_transformations SamlApps#attributes_transformations}
  */
  readonly attributesTransformations?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#default_values SamlApps#default_values}
  */
  readonly defaultValues?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#include_in_saml_assertion SamlApps#include_in_saml_assertion}
  */
  readonly includeInSamlAssertion?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#label SamlApps#label}
  */
  readonly label?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#param_key_name SamlApps#param_key_name}
  */
  readonly paramKeyName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#provisioned_entitlements SamlApps#provisioned_entitlements}
  */
  readonly provisionedEntitlements?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#safe_entitlements_enabled SamlApps#safe_entitlements_enabled}
  */
  readonly safeEntitlementsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#skip_if_blank SamlApps#skip_if_blank}
  */
  readonly skipIfBlank?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#user_attribute_macros SamlApps#user_attribute_macros}
  */
  readonly userAttributeMacros?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#user_attribute_mappings SamlApps#user_attribute_mappings}
  */
  readonly userAttributeMappings?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#values SamlApps#values}
  */
  readonly values?: string;
}

export function samlAppsParametersToTerraform(struct?: SamlAppsParameters | cdktf.IResolvable): any {
...
export function samlAppsParametersToHclTerraform(struct?: SamlAppsParameters | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SamlAppsParametersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SamlAppsParameters | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SamlAppsParameters | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SamlAppsParametersList extends cdktf.ComplexList {
  public internalValue? : SamlAppsParameters[] | cdktf.IResolvable
  ...
  */
  public get(index: number): SamlAppsParametersOutputReference {
    return new SamlAppsParametersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps onelogin_saml_apps}
*/
export class SamlApps extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "onelogin_saml_apps";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a SamlApps resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the SamlApps to import
  * @param importFromId The id of the existing SamlApps that should be imported. Refer to the {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the SamlApps to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "onelogin_saml_apps", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/saml_apps onelogin_saml_apps} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options SamlAppsConfig
  */
  public constructor(scope: Construct, id: string, config: SamlAppsConfig) {
    super(scope, id, {
      terraformResourceType: 'onelogin_saml_apps',
  ...
  private _sso?: { [key: string]: string }; 
  public get sso() {
    return this.getStringMapAttribute('sso');
  }
  public set sso(value: { [key: string]: string }) {
    this._sso = value;
  }
  public resetSso() {
    this._sso = undefined;
  ...
  private _parameters = new SamlAppsParametersList(this, "parameters", true);
  public get parameters() {
    return this._parameters;
  }
  public putParameters(value: SamlAppsParameters[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sso: cdktf.hashMapper(cdktf.stringToTerraform)(this._sso),
      visible: cdktf.booleanToTerraform(this._visible),
      parameters: cdktf.listMapper(samlAppsParametersToTerraform, true)(this._parameters.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sso: {
        value: cdktf.hashMapperHcl(cdktf.stringToHclTerraform)(this._sso),
        isBlock: false,
        type: "map",
        storageClassType: "stringMap",
      },
      ...
      parameters: {
        value: cdktf.listMapperHcl(samlAppsParametersToHclTerraform, true)(this._parameters.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "SamlAppsParametersList",
      },
    };
