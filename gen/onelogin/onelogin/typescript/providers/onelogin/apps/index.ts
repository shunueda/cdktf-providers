// https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps
...
export interface AppsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#allow_assumed_signin Apps#allow_assumed_signin}
  */
  readonly allowAssumedSignin?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#brand_id Apps#brand_id}
  */
  readonly brandId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#connector_id Apps#connector_id}
  */
  readonly connectorId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#description Apps#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#id Apps#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#name Apps#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#notes Apps#notes}
  */
  readonly notes?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#provisioning Apps#provisioning}
  */
  readonly provisioning?: { [key: string]: (boolean | cdktf.IResolvable) };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#visible Apps#visible}
  */
  readonly visible?: boolean | cdktf.IResolvable;
  /**
  * parameters block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#parameters Apps#parameters}
  */
  readonly parameters?: AppsParameters[] | cdktf.IResolvable;
}
export interface AppsParameters {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#attributes_transformations Apps#attributes_transformations}
  */
  readonly attributesTransformations?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#default_values Apps#default_values}
  */
  readonly defaultValues?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#include_in_saml_assertion Apps#include_in_saml_assertion}
  */
  readonly includeInSamlAssertion?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#label Apps#label}
  */
  readonly label?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#param_key_name Apps#param_key_name}
  */
  readonly paramKeyName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#provisioned_entitlements Apps#provisioned_entitlements}
  */
  readonly provisionedEntitlements?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#safe_entitlements_enabled Apps#safe_entitlements_enabled}
  */
  readonly safeEntitlementsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#skip_if_blank Apps#skip_if_blank}
  */
  readonly skipIfBlank?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#user_attribute_macros Apps#user_attribute_macros}
  */
  readonly userAttributeMacros?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#user_attribute_mappings Apps#user_attribute_mappings}
  */
  readonly userAttributeMappings?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#values Apps#values}
  */
  readonly values?: string;
}

export function appsParametersToTerraform(struct?: AppsParameters | cdktf.IResolvable): any {
...
export function appsParametersToHclTerraform(struct?: AppsParameters | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AppsParametersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AppsParameters | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AppsParameters | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class AppsParametersList extends cdktf.ComplexList {
  public internalValue? : AppsParameters[] | cdktf.IResolvable
  ...
  */
  public get(index: number): AppsParametersOutputReference {
    return new AppsParametersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps onelogin_apps}
*/
export class Apps extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "onelogin_apps";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a Apps resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the Apps to import
  * @param importFromId The id of the existing Apps that should be imported. Refer to the {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Apps to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "onelogin_apps", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/onelogin/onelogin/0.11.2/docs/resources/apps onelogin_apps} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AppsConfig
  */
  public constructor(scope: Construct, id: string, config: AppsConfig) {
    super(scope, id, {
      terraformResourceType: 'onelogin_apps',
  ...
  private _parameters = new AppsParametersList(this, "parameters", true);
  public get parameters() {
    return this._parameters;
  }
  public putParameters(value: AppsParameters[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      parameters: cdktf.listMapper(appsParametersToTerraform, true)(this._parameters.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      parameters: {
        value: cdktf.listMapperHcl(appsParametersToHclTerraform, true)(this._parameters.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "AppsParametersList",
      },
    };
