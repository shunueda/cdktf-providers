// https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/data-sources/organization
...
/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/data-sources/organization buildkite_organization}
*/
export class DataBuildkiteOrganization extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuildkiteOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/data-sources/organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/data-sources/organization buildkite_organization} Data Source
  *
  * @param scope The scope in which to define this construct
