// https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/team
...
export interface TeamConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/team#default_member_role Team#default_member_role}
  */
  readonly defaultMemberRole: string;
  /**
  * Whether this is the default team for the organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/team#default_team Team#default_team}
  */
  readonly defaultTeam: boolean | cdktf.IResolvable;
  /**
  * A description for the team. This is displayed in the Buildkite UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/team#description Team#description}
  */
  readonly description?: string;
  /**
  * Whether members of the team can create Pipelines.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/team#members_can_create_pipelines Team#members_can_create_pipelines}
  */
  readonly membersCanCreatePipelines?: boolean | cdktf.IResolvable;
  /**
  * The name of the team.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/team#name Team#name}
  */
  readonly name: string;
  /**
  * The privacy setting for the team. This can be either `VISIBLE` or `SECRET`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/team#privacy Team#privacy}
  */
  readonly privacy: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/team buildkite_team}
*/
export class Team extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Team that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/team#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/team buildkite_team} Resource
  *
  * @param scope The scope in which to define this construct
