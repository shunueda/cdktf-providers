// https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_template
...
export interface PipelineTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_template#available PipelineTemplate#available}
  */
  readonly available?: boolean | cdktf.IResolvable;
  /**
  * The YAML step configuration for the pipeline template. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_template#configuration PipelineTemplate#configuration}
  */
  readonly configuration: string;
  /**
  * A description for the pipeline template. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_template#description PipelineTemplate#description}
  */
  readonly description?: string;
  /**
  * The name of the pipeline template. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_template#name PipelineTemplate#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_template buildkite_pipeline_template}
*/
export class PipelineTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PipelineTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_template buildkite_pipeline_template} Resource
  *
  * @param scope The scope in which to define this construct
