// https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/cluster_agent_token
...
export interface ClusterAgentTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/cluster_agent_token#allowed_ip_addresses ClusterAgentToken#allowed_ip_addresses}
  */
  readonly allowedIpAddresses?: string[];
  /**
  * The GraphQL ID of the Cluster that this Cluster Agent Token belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/cluster_agent_token#cluster_id ClusterAgentToken#cluster_id}
  */
  readonly clusterId: string;
  /**
  * A description about what this cluster agent token is used for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/cluster_agent_token#description ClusterAgentToken#description}
  */
  readonly description: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/cluster_agent_token buildkite_cluster_agent_token}
*/
export class ClusterAgentToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusterAgentToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/cluster_agent_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/cluster_agent_token buildkite_cluster_agent_token} Resource
  *
  * @param scope The scope in which to define this construct
