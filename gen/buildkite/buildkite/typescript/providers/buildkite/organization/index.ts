// https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/resources/organization
...
export interface OrganizationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/resources/organization#allowed_api_ip_addresses Organization#allowed_api_ip_addresses}
  */
  readonly allowedApiIpAddresses?: string[];
  /**
  * Sets whether the organization requires two-factor authentication for all members.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/resources/organization#enforce_2fa Organization#enforce_2fa}
  */
  readonly enforce2Fa?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/resources/organization buildkite_organization}
*/
export class Organization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Organization that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/resources/organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/resources/organization buildkite_organization} Resource
  *
  * @param scope The scope in which to define this construct
