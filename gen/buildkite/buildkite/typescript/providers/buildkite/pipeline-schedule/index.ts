// https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_schedule
...
export interface PipelineScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_schedule#branch PipelineSchedule#branch}
  */
  readonly branch: string;
  /**
  * The commit that the schedule should run on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_schedule#commit PipelineSchedule#commit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_schedule#cronline PipelineSchedule#cronline}
  */
  readonly cronline: string;
  /**
  * Whether the schedule is enabled or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_schedule#enabled PipelineSchedule#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The environment variables that scheduled builds should use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_schedule#env PipelineSchedule#env}
  */
  readonly env?: { [key: string]: string };
  /**
  * A label to describe the schedule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_schedule#label PipelineSchedule#label}
  */
  readonly label: string;
  /**
  * The message the builds show for builds created by this schedule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_schedule#message PipelineSchedule#message}
  */
  readonly message?: string;
  /**
  * The GraphQL ID of the pipeline that this schedule belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_schedule#pipeline_id PipelineSchedule#pipeline_id}
  */
  readonly pipelineId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_schedule buildkite_pipeline_schedule}
*/
export class PipelineSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PipelineSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/pipeline_schedule buildkite_pipeline_schedule} Resource
  *
  * @param scope The scope in which to define this construct
