// https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite_team
...
export interface TestSuiteTeamConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite_team#access_level TestSuiteTeam#access_level}
  */
  readonly accessLevel: string;
  /**
  * The GraphQL ID of the team.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite_team#team_id TestSuiteTeam#team_id}
  */
  readonly teamId: string;
  /**
  * The GraphQL ID of the test suite.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite_team#test_suite_id TestSuiteTeam#test_suite_id}
  */
  readonly testSuiteId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite_team buildkite_test_suite_team}
*/
export class TestSuiteTeam extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TestSuiteTeam that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite_team#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite_team buildkite_test_suite_team} Resource
  *
  * @param scope The scope in which to define this construct
