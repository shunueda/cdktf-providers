// https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/data-sources/pipeline
...
export interface DataBuildkitePipelineConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/data-sources/pipeline#slug DataBuildkitePipeline#slug}
  */
  readonly slug: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/data-sources/pipeline buildkite_pipeline}
*/
export class DataBuildkitePipeline extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuildkitePipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/data-sources/pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/data-sources/pipeline buildkite_pipeline} Data Source
  *
  * @param scope The scope in which to define this construct
