// https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline
...
export interface PipelineConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#allow_rebuilds Pipeline#allow_rebuilds}
  */
  readonly allowRebuilds?: boolean | cdktf.IResolvable;
  /**
  * Configure the pipeline to only build on this branch conditional.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#branch_configuration Pipeline#branch_configuration}
  */
  readonly branchConfiguration?: string;
  /**
  * Whether to cancel builds when a new commit is pushed to a matching branch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#cancel_intermediate_builds Pipeline#cancel_intermediate_builds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#cancel_intermediate_builds_branch_filter Pipeline#cancel_intermediate_builds_branch_filter}
  */
  readonly cancelIntermediateBuildsBranchFilter?: string;
  /**
  * Attach this pipeline to the given cluster GraphQL ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#cluster_id Pipeline#cluster_id}
  */
  readonly clusterId?: string;
  /**
  * A color hex code to represent this pipeline.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#color Pipeline#color}
  */
  readonly color?: string;
  /**
  * Default branch of the pipeline.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#default_branch Pipeline#default_branch}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#default_team_id Pipeline#default_team_id}
  */
  readonly defaultTeamId?: string;
  /**
  * Set pipeline wide timeout for command steps.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#default_timeout_in_minutes Pipeline#default_timeout_in_minutes}
  */
  readonly defaultTimeoutInMinutes?: number;
  /**
  * Description for the pipeline. Can include emoji 🙌.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#description Pipeline#description}
  */
  readonly description?: string;
  /**
  * An emoji that represents this pipeline.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#emoji Pipeline#emoji}
  */
  readonly emoji?: string;
  /**
  * Set pipeline wide maximum timeout for command steps.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#maximum_timeout_in_minutes Pipeline#maximum_timeout_in_minutes}
  */
  readonly maximumTimeoutInMinutes?: number;
  /**
  * Name to give the pipeline.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#name Pipeline#name}
  */
  readonly name: string;
  /**
  * The GraphQL ID of the pipeline template applied to this pipeline.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#pipeline_template_id Pipeline#pipeline_template_id}
  */
  readonly pipelineTemplateId?: string;
  /**
  * Control settings depending on the VCS provider used in `repository`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#provider_settings Pipeline#provider_settings}
  */
  readonly providerSettings?: PipelineProviderSettings;
  /**
  * URL to the repository this pipeline is configured for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#repository Pipeline#repository}
  */
  readonly repository: string;
  /**
  * Whether to skip queued builds if a new commit is pushed to a matching branch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#skip_intermediate_builds Pipeline#skip_intermediate_builds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#skip_intermediate_builds_branch_filter Pipeline#skip_intermediate_builds_branch_filter}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#slug Pipeline#slug}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#steps Pipeline#steps}
  */
  readonly steps?: string;
  /**
  * Tags to attribute to the pipeline. Useful for searching by in the UI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#tags Pipeline#tags}
  */
...
export interface PipelineProviderSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#build_branches Pipeline#build_branches}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#build_merge_group_checks_requested Pipeline#build_merge_group_checks_requested}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#build_pull_request_base_branch_changed Pipeline#build_pull_request_base_branch_changed}
  */
  readonly buildPullRequestBaseBranchChanged?: boolean | cdktf.IResolvable;
  /**
  * Whether to create builds for pull requests from third-party forks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#build_pull_request_forks Pipeline#build_pull_request_forks}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#build_pull_request_labels_changed Pipeline#build_pull_request_labels_changed}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#build_pull_request_ready_for_review Pipeline#build_pull_request_ready_for_review}
  */
  readonly buildPullRequestReadyForReview?: boolean | cdktf.IResolvable;
  /**
  * Whether to create builds for commits that are part of a pull request.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#build_pull_requests Pipeline#build_pull_requests}
  */
  readonly buildPullRequests?: boolean | cdktf.IResolvable;
  /**
  * Whether to create builds when tags are pushed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#build_tags Pipeline#build_tags}
  */
  readonly buildTags?: boolean | cdktf.IResolvable;
  /**
  * Automatically cancel running builds for a branch if the branch is deleted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#cancel_deleted_branch_builds Pipeline#cancel_deleted_branch_builds}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#cancel_when_merge_group_destroyed Pipeline#cancel_when_merge_group_destroyed}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#filter_condition Pipeline#filter_condition}
  */
  readonly filterCondition?: string;
  /**
  * Whether to filter builds to only run when the condition in `filter_condition` is true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#filter_enabled Pipeline#filter_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#ignore_default_branch_pull_requests Pipeline#ignore_default_branch_pull_requests}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#prefix_pull_request_fork_branch_names Pipeline#prefix_pull_request_fork_branch_names}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#publish_blocked_as_pending Pipeline#publish_blocked_as_pending}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#publish_commit_status Pipeline#publish_commit_status}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#publish_commit_status_per_step Pipeline#publish_commit_status_per_step}
  */
  readonly publishCommitStatusPerStep?: boolean | cdktf.IResolvable;
  /**
  * Filter pull requests builds by the branch filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#pull_request_branch_filter_configuration Pipeline#pull_request_branch_filter_configuration}
  */
  readonly pullRequestBranchFilterConfiguration?: string;
  /**
  * Filter pull request builds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#pull_request_branch_filter_enabled Pipeline#pull_request_branch_filter_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#separate_pull_request_statuses Pipeline#separate_pull_request_statuses}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#skip_builds_for_existing_commits Pipeline#skip_builds_for_existing_commits}
  */
  readonly skipBuildsForExistingCommits?: boolean | cdktf.IResolvable;
  /**
  * Whether to skip creating a new build for a pull request if an existing build for the commit and branch already exists.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#skip_pull_request_builds_for_existing_commits Pipeline#skip_pull_request_builds_for_existing_commits}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#trigger_mode Pipeline#trigger_mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#use_merge_group_base_commit_for_git_diff_base Pipeline#use_merge_group_base_commit_for_git_diff_base}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline buildkite_pipeline}
*/
export class Pipeline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Pipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.26.0/docs/resources/pipeline buildkite_pipeline} Resource
  *
  * @param scope The scope in which to define this construct
