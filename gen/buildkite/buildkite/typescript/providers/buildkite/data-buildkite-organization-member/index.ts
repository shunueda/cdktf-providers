// https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/data-sources/organization_member
...
export interface DataBuildkiteOrganizationMemberConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/data-sources/organization_member#email DataBuildkiteOrganizationMember#email}
  */
  readonly email: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/data-sources/organization_member buildkite_organization_member}
*/
export class DataBuildkiteOrganizationMember extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuildkiteOrganizationMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/data-sources/organization_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/data-sources/organization_member buildkite_organization_member} Data Source
  *
  * @param scope The scope in which to define this construct
