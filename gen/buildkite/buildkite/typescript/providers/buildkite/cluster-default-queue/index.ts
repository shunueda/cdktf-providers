// https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/cluster_default_queue
...
export interface ClusterDefaultQueueConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/cluster_default_queue#cluster_id ClusterDefaultQueue#cluster_id}
  */
  readonly clusterId: string;
  /**
  * The GraphQL ID of the cluster queue to set as default on the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/cluster_default_queue#queue_id ClusterDefaultQueue#queue_id}
  */
  readonly queueId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/cluster_default_queue buildkite_cluster_default_queue}
*/
export class ClusterDefaultQueue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusterDefaultQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/cluster_default_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.1/docs/resources/cluster_default_queue buildkite_cluster_default_queue} Resource
  *
  * @param scope The scope in which to define this construct
