// https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite
...
export interface TestSuiteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite#default_branch TestSuite#default_branch}
  */
  readonly defaultBranch: string;
  /**
  * The emoji associated with this test suite, eg :buildkite:
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite#emoji TestSuite#emoji}
  */
  readonly emoji?: string;
  /**
  * The name to give the test suite.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite#name TestSuite#name}
  */
  readonly name: string;
  /**
  * The GraphQL ID of the team to mark as the owner/admin of the test suite.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite#team_owner_id TestSuite#team_owner_id}
  */
  readonly teamOwnerId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite buildkite_test_suite}
*/
export class TestSuite extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TestSuite that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/test_suite buildkite_test_suite} Resource
  *
  * @param scope The scope in which to define this construct
