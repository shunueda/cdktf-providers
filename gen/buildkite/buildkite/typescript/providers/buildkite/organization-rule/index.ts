// https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/resources/organization_rule
...
export interface OrganizationRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/resources/organization_rule#description OrganizationRule#description}
  */
  readonly description?: string;
  /**
  * The type of organization rule. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/resources/organization_rule#type OrganizationRule#type}
  */
  readonly type: string;
  /**
  * The JSON document that this organization rule implements. 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/resources/organization_rule#value OrganizationRule#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/resources/organization_rule buildkite_organization_rule}
*/
export class OrganizationRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/resources/organization_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/resources/organization_rule buildkite_organization_rule} Resource
  *
  * @param scope The scope in which to define this construct
