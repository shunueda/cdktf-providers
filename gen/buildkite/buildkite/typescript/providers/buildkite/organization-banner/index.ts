// https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/organization_banner
...
export interface OrganizationBannerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/organization_banner#message OrganizationBanner#message}
  */
  readonly message: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/organization_banner buildkite_organization_banner}
*/
export class OrganizationBanner extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationBanner that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/organization_banner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/resources/organization_banner buildkite_organization_banner} Resource
  *
  * @param scope The scope in which to define this construct
