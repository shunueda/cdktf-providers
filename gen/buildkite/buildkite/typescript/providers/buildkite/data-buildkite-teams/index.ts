// https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/data-sources/teams
...
/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/data-sources/teams buildkite_teams}
*/
export class DataBuildkiteTeams extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuildkiteTeams that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/data-sources/teams#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.28.0/docs/data-sources/teams buildkite_teams} Data Source
  *
  * @param scope The scope in which to define this construct
