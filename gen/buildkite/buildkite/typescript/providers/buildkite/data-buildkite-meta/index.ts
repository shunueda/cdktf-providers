// https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/data-sources/meta
...
/**
* Represents a {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/data-sources/meta buildkite_meta}
*/
export class DataBuildkiteMeta extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataBuildkiteMeta that should be imported. Refer to the {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/data-sources/meta#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/buildkite/buildkite/1.27.0/docs/data-sources/meta buildkite_meta} Data Source
  *
  * @param scope The scope in which to define this construct
