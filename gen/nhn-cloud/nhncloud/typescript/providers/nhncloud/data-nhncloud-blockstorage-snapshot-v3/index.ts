...
export class DataNhncloudBlockstorageSnapshotV3 extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "nhncloud_blockstorage_snapshot_v3";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "nhncloud_blockstorage_snapshot_v3", importId: importFromId, provider });
      }
  ...
  * @param options DataNhncloudBlockstorageSnapshotV3Config = {}
  */
  public constructor(scope: Construct, id: string, config: DataNhncloudBlockstorageSnapshotV3Config = {}) {
    super(scope, id, {
