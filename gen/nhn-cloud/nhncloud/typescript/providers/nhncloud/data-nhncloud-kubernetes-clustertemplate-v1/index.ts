// https://registry.terraform.io/providers/nhn-cloud/nhncloud/1.0.7/docs/data-sources/kubernetes_clustertemplate_v1
...
export interface DataNhncloudKubernetesClustertemplateV1Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nhn-cloud/nhncloud/1.0.7/docs/data-sources/kubernetes_clustertemplate_v1#id DataNhncloudKubernetesClustertemplateV1#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nhn-cloud/nhncloud/1.0.7/docs/data-sources/kubernetes_clustertemplate_v1#name DataNhncloudKubernetesClustertemplateV1#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nhn-cloud/nhncloud/1.0.7/docs/data-sources/kubernetes_clustertemplate_v1#region DataNhncloudKubernetesClustertemplateV1#region}
  */
  readonly region?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nhn-cloud/nhncloud/1.0.7/docs/data-sources/kubernetes_clustertemplate_v1 nhncloud_kubernetes_clustertemplate_v1}
*/
export class DataNhncloudKubernetesClustertemplateV1 extends cdktf.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "nhncloud_kubernetes_clustertemplate_v1";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a DataNhncloudKubernetesClustertemplateV1 resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataNhncloudKubernetesClustertemplateV1 to import
  * @param importFromId The id of the existing DataNhncloudKubernetesClustertemplateV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/nhn-cloud/nhncloud/1.0.7/docs/data-sources/kubernetes_clustertemplate_v1#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataNhncloudKubernetesClustertemplateV1 to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "nhncloud_kubernetes_clustertemplate_v1", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nhn-cloud/nhncloud/1.0.7/docs/data-sources/kubernetes_clustertemplate_v1 nhncloud_kubernetes_clustertemplate_v1} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataNhncloudKubernetesClustertemplateV1Config
  */
  public constructor(scope: Construct, id: string, config: DataNhncloudKubernetesClustertemplateV1Config) {
    super(scope, id, {
      terraformResourceType: 'nhncloud_kubernetes_clustertemplate_v1',
