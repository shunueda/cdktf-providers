// https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/project
...
export interface DataStackitProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/project#container_id DataStackitProject#container_id}
  */
  readonly containerId: string;
  /**
  * Extend project information with custom label values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/project#labels DataStackitProject#labels}
  */
  readonly labels?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/project stackit_project}
*/
export class DataStackitProject extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/project stackit_project} Data Source
  *
  * @param scope The scope in which to define this construct
