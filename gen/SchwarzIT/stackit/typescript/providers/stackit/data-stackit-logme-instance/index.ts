// https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/logme_instance
...
export interface DataStackitLogmeInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/logme_instance#name DataStackitLogmeInstance#name}
  */
  readonly name: string;
  /**
  * The project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/logme_instance#project_id DataStackitLogmeInstance#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/logme_instance stackit_logme_instance}
*/
export class DataStackitLogmeInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitLogmeInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/logme_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/logme_instance stackit_logme_instance} Data Source
  *
  * @param scope The scope in which to define this construct
