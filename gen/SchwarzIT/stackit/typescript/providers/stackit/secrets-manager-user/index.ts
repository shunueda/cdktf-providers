// https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/resources/secrets_manager_user
...
export interface SecretsManagerUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/resources/secrets_manager_user#description SecretsManagerUser#description}
  */
  readonly description?: string;
  /**
  * Specifies the instance id. Changing this value requires the resource to be recreated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/resources/secrets_manager_user#instance_id SecretsManagerUser#instance_id}
  */
  readonly instanceId: string;
  /**
  * The project UUID. Changing this value requires the resource to be recreated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/resources/secrets_manager_user#project_id SecretsManagerUser#project_id}
  */
  readonly projectId: string;
  /**
  * Specifies if the user can write secrets. `false` by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/resources/secrets_manager_user#write_enabled SecretsManagerUser#write_enabled}
  */
  readonly writeEnabled?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/resources/secrets_manager_user stackit_secrets_manager_user}
*/
export class SecretsManagerUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretsManagerUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/resources/secrets_manager_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/resources/secrets_manager_user stackit_secrets_manager_user} Resource
  *
  * @param scope The scope in which to define this construct
