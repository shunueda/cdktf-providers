...
export function opensearchInstanceTimeoutsToTerraform(struct?: OpensearchInstanceTimeouts | cdktf.IResolvable): any {
...
export function opensearchInstanceTimeoutsToHclTerraform(struct?: OpensearchInstanceTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class OpensearchInstanceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OpensearchInstanceTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: OpensearchInstanceTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class OpensearchInstance extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new OpensearchInstanceTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: OpensearchInstanceTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: opensearchInstanceTimeoutsToTerraform(this._timeouts.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: opensearchInstanceTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "OpensearchInstanceTimeouts",
      },
      version: {
