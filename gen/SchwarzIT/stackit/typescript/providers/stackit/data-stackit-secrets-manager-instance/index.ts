// https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/secrets_manager_instance
...
export interface DataStackitSecretsManagerInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/secrets_manager_instance#id DataStackitSecretsManagerInstance#id}
  *
  ...
  * The project UUID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/secrets_manager_instance#project_id DataStackitSecretsManagerInstance#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/secrets_manager_instance stackit_secrets_manager_instance}
*/
export class DataStackitSecretsManagerInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitSecretsManagerInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/secrets_manager_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/secrets_manager_instance stackit_secrets_manager_instance} Data Source
  *
  * @param scope The scope in which to define this construct
