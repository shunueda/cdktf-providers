...
export interface ElasticsearchCredentialConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class ElasticsearchCredential extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "stackit_elasticsearch_credential";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "stackit_elasticsearch_credential", importId: importFromId, provider });
      }
  ...
  * @param options ElasticsearchCredentialConfig
  */
  public constructor(scope: Construct, id: string, config: ElasticsearchCredentialConfig) {
    super(scope, id, {
