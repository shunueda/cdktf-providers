// https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/logme_credential
...
export interface DataStackitLogmeCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/logme_credential#id DataStackitLogmeCredential#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/logme_credential#instance_id DataStackitLogmeCredential#instance_id}
  */
  readonly instanceId: string;
  /**
  * Project ID the credential belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/logme_credential#project_id DataStackitLogmeCredential#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/logme_credential stackit_logme_credential}
*/
export class DataStackitLogmeCredential extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataStackitLogmeCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/logme_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.3/docs/data-sources/logme_credential stackit_logme_credential} Data Source
  *
  * @param scope The scope in which to define this construct
