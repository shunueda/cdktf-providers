// https://registry.terraform.io/providers/schwarzit/stackit/1.34.4/docs/resources/opensearch_credential
...
export interface OpensearchCredentialConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.4/docs/resources/opensearch_credential#instance_id OpensearchCredential#instance_id}
  */
  readonly instanceId: string;
  /**
  * Project ID the credential belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.4/docs/resources/opensearch_credential#project_id OpensearchCredential#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.4/docs/resources/opensearch_credential stackit_opensearch_credential}
*/
export class OpensearchCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpensearchCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.4/docs/resources/opensearch_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/schwarzit/stackit/1.34.4/docs/resources/opensearch_credential stackit_opensearch_credential} Resource
  *
  * @param scope The scope in which to define this construct
