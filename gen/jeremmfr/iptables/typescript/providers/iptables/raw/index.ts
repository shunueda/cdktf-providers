// https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw
...
export interface RawConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#id Raw#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#name Raw#name}
  */
  readonly name: string;
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#rule Raw#rule}
  */
  readonly rule: RawRule[] | cdktf.IResolvable;
}
export interface RawRule {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#action Raw#action}
  */
  readonly action?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#chain Raw#chain}
  */
  readonly chain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#dst_cidr_blocks Raw#dst_cidr_blocks}
  */
  readonly dstCidrBlocks?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#from_port Raw#from_port}
  */
  readonly fromPort?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#iface_in Raw#iface_in}
  */
  readonly ifaceIn?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#iface_out Raw#iface_out}
  */
  readonly ifaceOut?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#notrack Raw#notrack}
  */
  readonly notrack?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#position Raw#position}
  */
  readonly position?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#protocol Raw#protocol}
  */
  readonly protocol?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#src_cidr_blocks Raw#src_cidr_blocks}
  */
  readonly srcCidrBlocks?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#tcpflags_comp Raw#tcpflags_comp}
  */
  readonly tcpflagsComp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#tcpflags_mask Raw#tcpflags_mask}
  */
  readonly tcpflagsMask?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#tcpmss Raw#tcpmss}
  */
  readonly tcpmss?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#to_port Raw#to_port}
  */
  readonly toPort?: string;
}

export function rawRuleToTerraform(struct?: RawRule | cdktf.IResolvable): any {
...
export function rawRuleToHclTerraform(struct?: RawRule | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class RawRuleOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RawRule | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: RawRule | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class RawRuleList extends cdktf.ComplexList {
  public internalValue? : RawRule[] | cdktf.IResolvable
  ...
  */
  public get(index: number): RawRuleOutputReference {
    return new RawRuleOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw iptables_raw}
*/
export class Raw extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "iptables_raw";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a Raw resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the Raw to import
  * @param importFromId The id of the existing Raw that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Raw to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "iptables_raw", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/iptables/1.2.1/docs/resources/raw iptables_raw} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options RawConfig
  */
  public constructor(scope: Construct, id: string, config: RawConfig) {
    super(scope, id, {
      terraformResourceType: 'iptables_raw',
  ...
  private _rule = new RawRuleList(this, "rule", true);
  public get rule() {
    return this._rule;
  }
  public putRule(value: RawRule[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rule: cdktf.listMapper(rawRuleToTerraform, true)(this._rule.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      rule: {
        value: cdktf.listMapperHcl(rawRuleToHclTerraform, true)(this._rule.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "RawRuleList",
      },
    };
