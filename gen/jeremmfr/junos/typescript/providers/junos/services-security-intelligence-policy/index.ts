...
export interface ServicesSecurityIntelligencePolicyConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface ServicesSecurityIntelligencePolicyCategory {
  /**
...
export function servicesSecurityIntelligencePolicyCategoryToTerraform(struct?: ServicesSecurityIntelligencePolicyCategory | cdktf.IResolvable): any {
...
export function servicesSecurityIntelligencePolicyCategoryToHclTerraform(struct?: ServicesSecurityIntelligencePolicyCategory | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ServicesSecurityIntelligencePolicyCategoryOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ServicesSecurityIntelligencePolicyCategory | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ServicesSecurityIntelligencePolicyCategory | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ServicesSecurityIntelligencePolicyCategoryList extends cdktf.ComplexList {
  public internalValue? : ServicesSecurityIntelligencePolicyCategory[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ServicesSecurityIntelligencePolicyCategoryOutputReference {
    return new ServicesSecurityIntelligencePolicyCategoryOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ServicesSecurityIntelligencePolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "junos_services_security_intelligence_policy";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "junos_services_security_intelligence_policy", importId: importFromId, provider });
      }
  ...
  * @param options ServicesSecurityIntelligencePolicyConfig
  */
  public constructor(scope: Construct, id: string, config: ServicesSecurityIntelligencePolicyConfig) {
    super(scope, id, {
  ...
  private _category = new ServicesSecurityIntelligencePolicyCategoryList(this, "category", false);
  public get category() {
    return this._category;
  }
  public putCategory(value: ServicesSecurityIntelligencePolicyCategory[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      category: cdktf.listMapper(servicesSecurityIntelligencePolicyCategoryToTerraform, true)(this._category.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      category: {
        value: cdktf.listMapperHcl(servicesSecurityIntelligencePolicyCategoryToHclTerraform, true)(this._category.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ServicesSecurityIntelligencePolicyCategoryList",
      },
    };
