// https://registry.terraform.io/providers/jeremmfr/junos/2.16.0/docs/resources/security_screen_whitelist
...
export interface SecurityScreenWhitelistConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.16.0/docs/resources/security_screen_whitelist#address SecurityScreenWhitelist#address}
  */
  readonly address: string[];
  /**
  * White-list name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.16.0/docs/resources/security_screen_whitelist#name SecurityScreenWhitelist#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.16.0/docs/resources/security_screen_whitelist junos_security_screen_whitelist}
*/
export class SecurityScreenWhitelist extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityScreenWhitelist that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.16.0/docs/resources/security_screen_whitelist#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.16.0/docs/resources/security_screen_whitelist junos_security_screen_whitelist} Resource
  *
  * @param scope The scope in which to define this construct
