// https://registry.terraform.io/providers/jeremmfr/junos/2.15.0/docs/resources/interface_st0_unit
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.15.0/docs/resources/interface_st0_unit junos_interface_st0_unit}
*/
export class InterfaceSt0Unit extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterfaceSt0Unit that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.15.0/docs/resources/interface_st0_unit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.15.0/docs/resources/interface_st0_unit junos_interface_st0_unit} Resource
  *
  * @param scope The scope in which to define this construct
