// https://registry.terraform.io/providers/jeremmfr/junos/2.16.0/docs/data-sources/system_information
...
/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.16.0/docs/data-sources/system_information junos_system_information}
*/
export class DataJunosSystemInformation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataJunosSystemInformation that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.16.0/docs/data-sources/system_information#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.16.0/docs/data-sources/system_information junos_system_information} Data Source
  *
  * @param scope The scope in which to define this construct
