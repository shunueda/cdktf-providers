// https://registry.terraform.io/providers/jeremmfr/junos/2.15.0/docs/resources/snmp_view
...
export interface SnmpViewConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.15.0/docs/resources/snmp_view#name SnmpView#name}
  */
  readonly name: string;
  /**
  * OID exclude list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.15.0/docs/resources/snmp_view#oid_exclude SnmpView#oid_exclude}
  */
  readonly oidExclude?: string[];
  /**
  * OID include list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/jeremmfr/junos/2.15.0/docs/resources/snmp_view#oid_include SnmpView#oid_include}
  */
  readonly oidInclude?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/jeremmfr/junos/2.15.0/docs/resources/snmp_view junos_snmp_view}
*/
export class SnmpView extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SnmpView that should be imported. Refer to the {@link https://registry.terraform.io/providers/jeremmfr/junos/2.15.0/docs/resources/snmp_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/jeremmfr/junos/2.15.0/docs/resources/snmp_view junos_snmp_view} Resource
  *
  * @param scope The scope in which to define this construct
