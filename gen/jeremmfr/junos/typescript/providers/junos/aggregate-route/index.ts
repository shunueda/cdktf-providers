...
export interface AggregateRouteConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class AggregateRoute extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "junos_aggregate_route";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "junos_aggregate_route", importId: importFromId, provider });
      }
  ...
  * @param options AggregateRouteConfig
  */
  public constructor(scope: Construct, id: string, config: AggregateRouteConfig) {
    super(scope, id, {
