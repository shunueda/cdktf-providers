// https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_rule_filesystem
...
export interface DataSysdigSecureRuleFilesystemConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_rule_filesystem#name DataSysdigSecureRuleFilesystem#name}
  */
  readonly name: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_rule_filesystem#timeouts DataSysdigSecureRuleFilesystem#timeouts}
  */
...
export interface DataSysdigSecureRuleFilesystemTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_rule_filesystem#read DataSysdigSecureRuleFilesystem#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_rule_filesystem sysdig_secure_rule_filesystem}
*/
export class DataSysdigSecureRuleFilesystem extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSysdigSecureRuleFilesystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_rule_filesystem#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_rule_filesystem sysdig_secure_rule_filesystem} Data Source
  *
  * @param scope The scope in which to define this construct
