// https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/monitor_team
...
export interface DataSysdigMonitorTeamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/monitor_team#id DataSysdigMonitorTeam#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/monitor_team sysdig_monitor_team}
*/
export class DataSysdigMonitorTeam extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSysdigMonitorTeam that should be imported. Refer to the {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/monitor_team#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/monitor_team sysdig_monitor_team} Data Source
  *
  * @param scope The scope in which to define this construct
