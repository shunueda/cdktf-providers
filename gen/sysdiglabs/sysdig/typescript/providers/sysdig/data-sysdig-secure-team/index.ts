// https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/secure_team
...
export interface DataSysdigSecureTeamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/secure_team#id DataSysdigSecureTeam#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/secure_team sysdig_secure_team}
*/
export class DataSysdigSecureTeam extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSysdigSecureTeam that should be imported. Refer to the {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/secure_team#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/secure_team sysdig_secure_team} Data Source
  *
  * @param scope The scope in which to define this construct
