// https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_rule_container
...
export interface DataSysdigSecureRuleContainerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_rule_container#name DataSysdigSecureRuleContainer#name}
  */
  readonly name: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_rule_container#timeouts DataSysdigSecureRuleContainer#timeouts}
  */
  readonly timeouts?: DataSysdigSecureRuleContainerTimeouts;
}
export interface DataSysdigSecureRuleContainerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_rule_container#read DataSysdigSecureRuleContainer#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_rule_container sysdig_secure_rule_container}
*/
export class DataSysdigSecureRuleContainer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSysdigSecureRuleContainer that should be imported. Refer to the {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_rule_container#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_rule_container sysdig_secure_rule_container} Data Source
  *
  * @param scope The scope in which to define this construct
