// https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_custom_role_permissions
...
export interface DataSysdigSecureCustomRolePermissionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_custom_role_permissions#id DataSysdigSecureCustomRolePermissions#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_custom_role_permissions#requested_permissions DataSysdigSecureCustomRolePermissions#requested_permissions}
  */
  readonly requestedPermissions: string[];
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_custom_role_permissions#timeouts DataSysdigSecureCustomRolePermissions#timeouts}
  */
...
export interface DataSysdigSecureCustomRolePermissionsTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_custom_role_permissions#read DataSysdigSecureCustomRolePermissions#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_custom_role_permissions sysdig_secure_custom_role_permissions}
*/
export class DataSysdigSecureCustomRolePermissions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSysdigSecureCustomRolePermissions that should be imported. Refer to the {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_custom_role_permissions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.1.0/docs/data-sources/secure_custom_role_permissions sysdig_secure_custom_role_permissions} Data Source
  *
  * @param scope The scope in which to define this construct
