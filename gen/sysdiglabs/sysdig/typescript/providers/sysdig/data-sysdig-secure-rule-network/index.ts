// https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/secure_rule_network
...
export interface DataSysdigSecureRuleNetworkConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/secure_rule_network#name DataSysdigSecureRuleNetwork#name}
  */
  readonly name: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/secure_rule_network#timeouts DataSysdigSecureRuleNetwork#timeouts}
  */
  readonly timeouts?: DataSysdigSecureRuleNetworkTimeouts;
  /**
  * udp block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/secure_rule_network#udp DataSysdigSecureRuleNetwork#udp}
  */
...
export interface DataSysdigSecureRuleNetworkTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/secure_rule_network#read DataSysdigSecureRuleNetwork#read}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/secure_rule_network sysdig_secure_rule_network}
*/
export class DataSysdigSecureRuleNetwork extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSysdigSecureRuleNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/secure_rule_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sysdiglabs/sysdig/3.3.1/docs/data-sources/secure_rule_network sysdig_secure_rule_network} Data Source
  *
  * @param scope The scope in which to define this construct
