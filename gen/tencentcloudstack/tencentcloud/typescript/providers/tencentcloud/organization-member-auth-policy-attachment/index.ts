// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_member_auth_policy_attachment
...
export interface OrganizationMemberAuthPolicyAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_member_auth_policy_attachment#id OrganizationMemberAuthPolicyAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_member_auth_policy_attachment#org_sub_account_uin OrganizationMemberAuthPolicyAttachment#org_sub_account_uin}
  */
  readonly orgSubAccountUin: number;
  /**
  * Pilicy ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_member_auth_policy_attachment#policy_id OrganizationMemberAuthPolicyAttachment#policy_id}
  */
  readonly policyId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_member_auth_policy_attachment tencentcloud_organization_member_auth_policy_attachment}
*/
export class OrganizationMemberAuthPolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationMemberAuthPolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_member_auth_policy_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_member_auth_policy_attachment tencentcloud_organization_member_auth_policy_attachment} Resource
  *
  * @param scope The scope in which to define this construct
