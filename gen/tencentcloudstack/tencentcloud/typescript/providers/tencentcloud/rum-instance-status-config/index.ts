// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/rum_instance_status_config
...
export interface RumInstanceStatusConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/rum_instance_status_config#id RumInstanceStatusConfig#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/rum_instance_status_config#instance_id RumInstanceStatusConfig#instance_id}
  */
  readonly instanceId: string;
  /**
  * `resume`, `stop`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/rum_instance_status_config#operate RumInstanceStatusConfig#operate}
  */
  readonly operate: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/rum_instance_status_config tencentcloud_rum_instance_status_config}
*/
export class RumInstanceStatusConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RumInstanceStatusConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/rum_instance_status_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/rum_instance_status_config tencentcloud_rum_instance_status_config} Resource
  *
  * @param scope The scope in which to define this construct
