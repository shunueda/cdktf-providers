// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table
...
export interface TcaplusTableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table#cluster_id TcaplusTable#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Description of the TcaplusDB table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table#description TcaplusTable#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table#id TcaplusTable#id}
  *
  ...
  * ID of the IDL File.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table#idl_id TcaplusTable#idl_id}
  */
  readonly idlId: string;
  /**
  * Reserved read capacity units of the TcaplusDB table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table#reserved_read_cu TcaplusTable#reserved_read_cu}
  */
  readonly reservedReadCu: number;
  /**
  * Reserved storage capacity of the TcaplusDB table (unit: GB).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table#reserved_volume TcaplusTable#reserved_volume}
  */
  readonly reservedVolume: number;
  /**
  * Reserved write capacity units of the TcaplusDB table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table#reserved_write_cu TcaplusTable#reserved_write_cu}
  */
  readonly reservedWriteCu: number;
  /**
  * IDL type of the TcaplusDB table. Valid values: `PROTO` and `TDR`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table#table_idl_type TcaplusTable#table_idl_type}
  */
  readonly tableIdlType: string;
  /**
  * Name of the TcaplusDB table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table#table_name TcaplusTable#table_name}
  */
  readonly tableName: string;
  /**
  * Type of the TcaplusDB table. Valid values are `GENERIC` and `LIST`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table#table_type TcaplusTable#table_type}
  */
  readonly tableType: string;
  /**
  * ID of the table group to which the table belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table#tablegroup_id TcaplusTable#tablegroup_id}
  */
  readonly tablegroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table tencentcloud_tcaplus_table}
*/
export class TcaplusTable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TcaplusTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tcaplus_table tencentcloud_tcaplus_table} Resource
  *
  * @param scope The scope in which to define this construct
