// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/api_gateway_strategy_attachment
...
export interface ApiGatewayStrategyAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/api_gateway_strategy_attachment#bind_api_id ApiGatewayStrategyAttachment#bind_api_id}
  */
  readonly bindApiId: string;
  /**
  * The environment of the strategy association. Valid values: `test`, `release`, `prepub`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/api_gateway_strategy_attachment#environment_name ApiGatewayStrategyAttachment#environment_name}
  */
  readonly environmentName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/api_gateway_strategy_attachment#id ApiGatewayStrategyAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/api_gateway_strategy_attachment#service_id ApiGatewayStrategyAttachment#service_id}
  */
  readonly serviceId: string;
  /**
  * The ID of the API gateway strategy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/api_gateway_strategy_attachment#strategy_id ApiGatewayStrategyAttachment#strategy_id}
  */
  readonly strategyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/api_gateway_strategy_attachment tencentcloud_api_gateway_strategy_attachment}
*/
export class ApiGatewayStrategyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayStrategyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/api_gateway_strategy_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/api_gateway_strategy_attachment tencentcloud_api_gateway_strategy_attachment} Resource
  *
  * @param scope The scope in which to define this construct
