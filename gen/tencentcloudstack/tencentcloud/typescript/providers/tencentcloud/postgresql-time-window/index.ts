// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/postgresql_time_window
...
export interface PostgresqlTimeWindowConfig extends cdktf.TerraformMetaArguments {
  ...
  * Instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/postgresql_time_window#db_instance_id PostgresqlTimeWindow#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/postgresql_time_window#id PostgresqlTimeWindow#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/postgresql_time_window#maintain_duration PostgresqlTimeWindow#maintain_duration}
  */
  readonly maintainDuration?: number;
  /**
  * Maintenance start time. Time zone is UTC+8.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/postgresql_time_window#maintain_start_time PostgresqlTimeWindow#maintain_start_time}
  */
  readonly maintainStartTime?: string;
  /**
  * Maintenance cycle.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/postgresql_time_window#maintain_week_days PostgresqlTimeWindow#maintain_week_days}
  */
  readonly maintainWeekDays?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/postgresql_time_window tencentcloud_postgresql_time_window}
*/
export class PostgresqlTimeWindow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresqlTimeWindow that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/postgresql_time_window#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/postgresql_time_window tencentcloud_postgresql_time_window} Resource
  *
  * @param scope The scope in which to define this construct
