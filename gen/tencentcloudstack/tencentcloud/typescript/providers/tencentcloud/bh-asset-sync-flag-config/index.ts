// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/bh_asset_sync_flag_config
...
export interface BhAssetSyncFlagConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/bh_asset_sync_flag_config#auto_sync BhAssetSyncFlagConfig#auto_sync}
  */
  readonly autoSync: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/bh_asset_sync_flag_config#id BhAssetSyncFlagConfig#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/bh_asset_sync_flag_config tencentcloud_bh_asset_sync_flag_config}
*/
export class BhAssetSyncFlagConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BhAssetSyncFlagConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/bh_asset_sync_flag_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/bh_asset_sync_flag_config tencentcloud_bh_asset_sync_flag_config} Resource
  *
  * @param scope The scope in which to define this construct
