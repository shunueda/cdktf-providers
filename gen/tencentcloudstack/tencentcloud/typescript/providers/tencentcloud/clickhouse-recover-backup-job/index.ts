// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/clickhouse_recover_backup_job
...
export interface ClickhouseRecoverBackupJobConfig extends cdktf.TerraformMetaArguments {
  ...
  * Back up job id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/clickhouse_recover_backup_job#back_up_job_id ClickhouseRecoverBackupJob#back_up_job_id}
  */
  readonly backUpJobId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/clickhouse_recover_backup_job#id ClickhouseRecoverBackupJob#id}
  *
  ...
  * Instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/clickhouse_recover_backup_job#instance_id ClickhouseRecoverBackupJob#instance_id}
  */
  readonly instanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/clickhouse_recover_backup_job tencentcloud_clickhouse_recover_backup_job}
*/
export class ClickhouseRecoverBackupJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClickhouseRecoverBackupJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/clickhouse_recover_backup_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/clickhouse_recover_backup_job tencentcloud_clickhouse_recover_backup_job} Resource
  *
  * @param scope The scope in which to define this construct
