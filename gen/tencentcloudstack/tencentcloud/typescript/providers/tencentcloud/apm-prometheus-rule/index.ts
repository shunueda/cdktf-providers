// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/apm_prometheus_rule
...
export interface ApmPrometheusRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/apm_prometheus_rule#id ApmPrometheusRule#id}
  *
  ...
  * Business system ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/apm_prometheus_rule#instance_id ApmPrometheusRule#instance_id}
  */
  readonly instanceId: string;
  /**
  * Match type: 0 - precision match, 1 - prefix match, 2 - suffix match.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/apm_prometheus_rule#metric_match_type ApmPrometheusRule#metric_match_type}
  */
  readonly metricMatchType: number;
  /**
  * Specifies the rule for customer-defined metric names with cache hit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/apm_prometheus_rule#metric_name_rule ApmPrometheusRule#metric_name_rule}
  */
  readonly metricNameRule: string;
  /**
  * Metric match rule name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/apm_prometheus_rule#name ApmPrometheusRule#name}
  */
  readonly name: string;
  /**
  * Applications where the rule takes effect. input an empty string for all applications.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/apm_prometheus_rule#service_name ApmPrometheusRule#service_name}
  */
  readonly serviceName: string;
  /**
  * Rule status. 1 - enabled, 2 - disabled. Default value: 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/apm_prometheus_rule#status ApmPrometheusRule#status}
  */
  readonly status?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/apm_prometheus_rule tencentcloud_apm_prometheus_rule}
*/
export class ApmPrometheusRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApmPrometheusRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/apm_prometheus_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/apm_prometheus_rule tencentcloud_apm_prometheus_rule} Resource
  *
  * @param scope The scope in which to define this construct
