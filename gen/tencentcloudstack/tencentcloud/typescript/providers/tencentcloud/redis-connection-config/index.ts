// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/redis_connection_config
...
export interface RedisConnectionConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/redis_connection_config#add_bandwidth RedisConnectionConfig#add_bandwidth}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/redis_connection_config#client_limit RedisConnectionConfig#client_limit}
  */
  readonly clientLimit?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/redis_connection_config#id RedisConnectionConfig#id}
  *
  ...
  * The ID of instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/redis_connection_config#instance_id RedisConnectionConfig#instance_id}
  */
  readonly instanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/redis_connection_config tencentcloud_redis_connection_config}
*/
export class RedisConnectionConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisConnectionConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/redis_connection_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/redis_connection_config tencentcloud_redis_connection_config} Resource
  *
  * @param scope The scope in which to define this construct
