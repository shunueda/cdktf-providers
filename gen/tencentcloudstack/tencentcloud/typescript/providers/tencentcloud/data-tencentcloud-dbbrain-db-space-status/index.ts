// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_db_space_status
...
export interface DataTencentcloudDbbrainDbSpaceStatusConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_db_space_status#id DataTencentcloudDbbrainDbSpaceStatus#id}
  *
  ...
  * instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_db_space_status#instance_id DataTencentcloudDbbrainDbSpaceStatus#instance_id}
  */
  readonly instanceId: string;
  /**
  * Service product type, supported values include: mysql - cloud database MySQL, cynosdb - cloud database CynosDB for MySQL, the default is mysql.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_db_space_status#product DataTencentcloudDbbrainDbSpaceStatus#product}
  */
  readonly product?: string;
  /**
  * The number of days in the time period, the deadline is the current day, and the default is 7 days.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_db_space_status#range_days DataTencentcloudDbbrainDbSpaceStatus#range_days}
  */
  readonly rangeDays?: number;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_db_space_status#result_output_file DataTencentcloudDbbrainDbSpaceStatus#result_output_file}
  */
  readonly resultOutputFile?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_db_space_status tencentcloud_dbbrain_db_space_status}
*/
export class DataTencentcloudDbbrainDbSpaceStatus extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudDbbrainDbSpaceStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_db_space_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_db_space_status tencentcloud_dbbrain_db_space_status} Data Source
  *
  * @param scope The scope in which to define this construct
