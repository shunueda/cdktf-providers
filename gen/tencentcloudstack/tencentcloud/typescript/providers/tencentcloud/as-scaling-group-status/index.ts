// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/as_scaling_group_status
...
export interface AsScalingGroupStatusConfig extends cdktf.TerraformMetaArguments {
  ...
  * Scaling group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/as_scaling_group_status#auto_scaling_group_id AsScalingGroupStatus#auto_scaling_group_id}
  */
  readonly autoScalingGroupId: string;
  /**
  * If enable auto scaling group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/as_scaling_group_status#enable AsScalingGroupStatus#enable}
  */
  readonly enable: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/as_scaling_group_status#id AsScalingGroupStatus#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/as_scaling_group_status tencentcloud_as_scaling_group_status}
*/
export class AsScalingGroupStatus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AsScalingGroupStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/as_scaling_group_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/as_scaling_group_status tencentcloud_as_scaling_group_status} Resource
  *
  * @param scope The scope in which to define this construct
