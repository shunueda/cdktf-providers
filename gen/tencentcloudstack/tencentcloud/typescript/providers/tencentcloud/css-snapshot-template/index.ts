// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template
...
export interface CssSnapshotTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  * Cos application ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template#cos_app_id CssSnapshotTemplate#cos_app_id}
  */
  readonly cosAppId: number;
  /**
  * Cos bucket name. Note: The CosBucket parameter value cannot include the - [appid] part.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template#cos_bucket CssSnapshotTemplate#cos_bucket}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template#cos_file_name CssSnapshotTemplate#cos_file_name}
  */
  readonly cosFileName?: string;
  /**
  * Cos Bucket folder prefix. If it is empty, set according to the default value /{Year}-{Month}-{Day}/.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template#cos_prefix CssSnapshotTemplate#cos_prefix}
  */
  readonly cosPrefix?: string;
  /**
  * Cos region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template#cos_region CssSnapshotTemplate#cos_region}
  */
  readonly cosRegion: string;
  /**
  * Description information. Maximum length: 1024 bytes. Only `Chinese`, `English`, `numbers`, `_`, `-` are supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template#description CssSnapshotTemplate#description}
  */
  readonly description?: string;
  /**
  * Screenshot height. Default: 0 (original height). Range: 0-2000.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template#height CssSnapshotTemplate#height}
  */
  readonly height?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template#id CssSnapshotTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template#porn_flag CssSnapshotTemplate#porn_flag}
  */
  readonly pornFlag?: number;
  /**
  * Screenshot interval, unit: s, default: 10s. Range: 2s~300s.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template#snapshot_interval CssSnapshotTemplate#snapshot_interval}
  */
  readonly snapshotInterval?: number;
  /**
  * Template name. Maximum length: 255 bytes. Only Chinese, English, numbers, `_`, `-` are supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template#template_name CssSnapshotTemplate#template_name}
  */
  readonly templateName: string;
  /**
  * Screenshot width. Default: 0 (original width). Range: 0-3000.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template#width CssSnapshotTemplate#width}
  */
  readonly width?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template tencentcloud_css_snapshot_template}
*/
export class CssSnapshotTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CssSnapshotTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_snapshot_template tencentcloud_css_snapshot_template} Resource
  *
  * @param scope The scope in which to define this construct
