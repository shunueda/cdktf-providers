// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/api_gateway_ip_strategy
...
export interface ApiGatewayIpStrategyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/api_gateway_ip_strategy#id ApiGatewayIpStrategy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/api_gateway_ip_strategy#service_id ApiGatewayIpStrategy#service_id}
  */
  readonly serviceId: string;
  /**
  * IP address data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/api_gateway_ip_strategy#strategy_data ApiGatewayIpStrategy#strategy_data}
  */
  readonly strategyData: string;
  /**
  * User defined strategy name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/api_gateway_ip_strategy#strategy_name ApiGatewayIpStrategy#strategy_name}
  */
  readonly strategyName: string;
  /**
  * Blacklist or whitelist.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/api_gateway_ip_strategy#strategy_type ApiGatewayIpStrategy#strategy_type}
  */
  readonly strategyType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/api_gateway_ip_strategy tencentcloud_api_gateway_ip_strategy}
*/
export class ApiGatewayIpStrategy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayIpStrategy that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/api_gateway_ip_strategy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/api_gateway_ip_strategy tencentcloud_api_gateway_ip_strategy} Resource
  *
  * @param scope The scope in which to define this construct
