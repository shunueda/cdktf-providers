// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/ha_vip_eip_attachment
...
export interface HaVipEipAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/ha_vip_eip_attachment#address_ip HaVipEipAttachment#address_ip}
  */
  readonly addressIp: string;
  /**
  * ID of the attached HA VIP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/ha_vip_eip_attachment#havip_id HaVipEipAttachment#havip_id}
  */
  readonly havipId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/ha_vip_eip_attachment#id HaVipEipAttachment#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/ha_vip_eip_attachment tencentcloud_ha_vip_eip_attachment}
*/
export class HaVipEipAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HaVipEipAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/ha_vip_eip_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/ha_vip_eip_attachment tencentcloud_ha_vip_eip_attachment} Resource
  *
  * @param scope The scope in which to define this construct
