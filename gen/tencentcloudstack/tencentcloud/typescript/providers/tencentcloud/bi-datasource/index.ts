// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource
...
export interface BiDatasourceConfig extends cdktf.TerraformMetaArguments {
  ...
  * Catalog.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#catalog BiDatasource#catalog}
  */
  readonly catalog?: string;
  /**
  * Charset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#charset BiDatasource#charset}
  */
  readonly charset: string;
  /**
  * Third-party datasource identification, this parameter can be ignored.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#data_origin BiDatasource#data_origin}
  */
  readonly dataOrigin?: string;
  /**
  * Third-party datasource project id, this parameter can be ignored.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#data_origin_datasource_id BiDatasource#data_origin_datasource_id}
  */
  readonly dataOriginDatasourceId?: string;
  /**
  * Third-party datasource project id, this parameter can be ignored.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#data_origin_project_id BiDatasource#data_origin_project_id}
  */
  readonly dataOriginProjectId?: string;
  /**
  * Host.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#db_host BiDatasource#db_host}
  */
  readonly dbHost: string;
  /**
  * Database name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#db_name BiDatasource#db_name}
  */
  readonly dbName: string;
  /**
  * Port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#db_port BiDatasource#db_port}
  */
  readonly dbPort: number;
  /**
  * Password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#db_pwd BiDatasource#db_pwd}
  */
  readonly dbPwd: string;
  /**
  * `MYSQL`, `MSSQL`, `POSTGRE`, `ORACLE`, `CLICKHOUSE`, `TIDB`, `HIVE`, `PRESTO`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#db_type BiDatasource#db_type}
  */
  readonly dbType: string;
  /**
  * User name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#db_user BiDatasource#db_user}
  */
  readonly dbUser: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#id BiDatasource#id}
  *
  ...
  * Project id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#project_id BiDatasource#project_id}
  */
  readonly projectId: number;
  /**
  * Own or Cloud, default: `Own`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#service_type BiDatasource#service_type}
  */
  readonly serviceType?: string;
  /**
  * Datasource name in BI.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#source_name BiDatasource#source_name}
  */
  readonly sourceName: string;
  /**
  * Tencent cloud private network unified identity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#uniq_vpc_id BiDatasource#uniq_vpc_id}
  */
  readonly uniqVpcId?: string;
  /**
  * Tencent cloud private network identity.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#vpc_id BiDatasource#vpc_id}
  */
  readonly vpcId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource tencentcloud_bi_datasource}
*/
export class BiDatasource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BiDatasource that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bi_datasource tencentcloud_bi_datasource} Resource
  *
  * @param scope The scope in which to define this construct
