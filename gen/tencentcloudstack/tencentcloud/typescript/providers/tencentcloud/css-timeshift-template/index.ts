// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_timeshift_template
...
export interface CssTimeshiftTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_timeshift_template#area CssTimeshiftTemplate#area}
  */
  readonly area?: string;
  /**
  * The template description.Only letters, numbers, underscores, and hyphens are supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_timeshift_template#description CssTimeshiftTemplate#description}
  */
  readonly description?: string;
  /**
  * The time shifting duration.Unit: Second.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_timeshift_template#duration CssTimeshiftTemplate#duration}
  */
  readonly duration: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_timeshift_template#id CssTimeshiftTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_timeshift_template#item_duration CssTimeshiftTemplate#item_duration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_timeshift_template#remove_watermark CssTimeshiftTemplate#remove_watermark}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_timeshift_template#template_name CssTimeshiftTemplate#template_name}
  */
  readonly templateName: string;
  /**
  * The transcoding template IDs.This API works only if `RemoveWatermark` is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_timeshift_template#transcode_template_ids CssTimeshiftTemplate#transcode_template_ids}
  */
  readonly transcodeTemplateIds?: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_timeshift_template tencentcloud_css_timeshift_template}
*/
export class CssTimeshiftTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CssTimeshiftTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_timeshift_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/css_timeshift_template tencentcloud_css_timeshift_template} Resource
  *
  * @param scope The scope in which to define this construct
