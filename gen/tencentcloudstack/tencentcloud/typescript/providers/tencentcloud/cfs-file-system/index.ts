// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system
...
export interface CfsFileSystemConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#access_group_id CfsFileSystem#access_group_id}
  */
  readonly accessGroupId: string;
  /**
  * The available zone that the file system locates at.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#availability_zone CfsFileSystem#availability_zone}
  */
  readonly availabilityZone: string;
  /**
  * File system capacity, in GiB (required for the Turbo series). For Standard Turbo, the minimum purchase required is 40,960 GiB (40 TiB) and the expansion increment is 20,480 GiB (20 TiB). For High-Performance Turbo, the minimum purchase required is 20,480 GiB (20 TiB) and the expansion increment is 10,240 GiB (10 TiB).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#capacity CfsFileSystem#capacity}
  */
  readonly capacity?: number;
  /**
  * CCN instance ID (required if the network type is CCN).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#ccn_id CfsFileSystem#ccn_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#cidr_block CfsFileSystem#cidr_block}
  */
  readonly cidrBlock?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#id CfsFileSystem#id}
  *
  ...
  * IP of mount point.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#mount_ip CfsFileSystem#mount_ip}
  */
  readonly mountIp?: string;
  /**
  * Name of a file system.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#name CfsFileSystem#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#net_interface CfsFileSystem#net_interface}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#protocol CfsFileSystem#protocol}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#storage_type CfsFileSystem#storage_type}
  */
  readonly storageType?: string;
  /**
  * ID of a subnet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#subnet_id CfsFileSystem#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * Instance tags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#tags CfsFileSystem#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * ID of a VPC network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#vpc_id CfsFileSystem#vpc_id}
  */
  readonly vpcId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system tencentcloud_cfs_file_system}
*/
export class CfsFileSystem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CfsFileSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfs_file_system tencentcloud_cfs_file_system} Resource
  *
  * @param scope The scope in which to define this construct
