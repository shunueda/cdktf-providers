// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_switch_master_slave_operation
...
export interface MysqlSwitchMasterSlaveOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_switch_master_slave_operation#dst_slave MysqlSwitchMasterSlaveOperation#dst_slave}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_switch_master_slave_operation#force_switch MysqlSwitchMasterSlaveOperation#force_switch}
  */
  readonly forceSwitch?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_switch_master_slave_operation#id MysqlSwitchMasterSlaveOperation#id}
  *
  ...
  * instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_switch_master_slave_operation#instance_id MysqlSwitchMasterSlaveOperation#instance_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_switch_master_slave_operation#wait_switch MysqlSwitchMasterSlaveOperation#wait_switch}
  */
  readonly waitSwitch?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_switch_master_slave_operation tencentcloud_mysql_switch_master_slave_operation}
*/
export class MysqlSwitchMasterSlaveOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlSwitchMasterSlaveOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_switch_master_slave_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_switch_master_slave_operation tencentcloud_mysql_switch_master_slave_operation} Resource
  *
  * @param scope The scope in which to define this construct
