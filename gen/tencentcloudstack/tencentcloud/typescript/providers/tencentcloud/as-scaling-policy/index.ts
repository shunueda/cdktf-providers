// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy
...
export interface AsScalingPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#adjustment_type AsScalingPolicy#adjustment_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#adjustment_value AsScalingPolicy#adjustment_value}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#comparison_operator AsScalingPolicy#comparison_operator}
  */
  readonly comparisonOperator: string;
  /**
  * Retry times. Valid value ranges: (1~10).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#continuous_time AsScalingPolicy#continuous_time}
  */
  readonly continuousTime: number;
  /**
  * Cooldwon time in second. Default is `30`0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#cooldown AsScalingPolicy#cooldown}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#disable_scale_in AsScalingPolicy#disable_scale_in}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#estimated_instance_warmup AsScalingPolicy#estimated_instance_warmup}
  */
  readonly estimatedInstanceWarmup?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#id AsScalingPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#metric_name AsScalingPolicy#metric_name}
  */
  readonly metricName: string;
  /**
  * An ID group of users to be notified when an alarm is triggered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#notification_user_group_ids AsScalingPolicy#notification_user_group_ids}
  */
  readonly notificationUserGroupIds?: string[];
  /**
  * Time period in second. Valid values: `60` and `300`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#period AsScalingPolicy#period}
  */
  readonly period: number;
  /**
  * Name of a policy used to define a reaction when an alarm is triggered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#policy_name AsScalingPolicy#policy_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#policy_type AsScalingPolicy#policy_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#predefined_metric_type AsScalingPolicy#predefined_metric_type}
  */
  readonly predefinedMetricType?: string;
  /**
  * ID of a scaling group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#scaling_group_id AsScalingPolicy#scaling_group_id}
  */
  readonly scalingGroupId: string;
  /**
  * Statistic types. Valid values: `AVERAGE`, `MAXIMUM` and `MINIMUM`. Default is `AVERAGE`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#statistic AsScalingPolicy#statistic}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#target_value AsScalingPolicy#target_value}
  */
  readonly targetValue?: number;
  /**
  * Alarm threshold.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#threshold AsScalingPolicy#threshold}
  */
  readonly threshold: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy tencentcloud_as_scaling_policy}
*/
export class AsScalingPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AsScalingPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/as_scaling_policy tencentcloud_as_scaling_policy} Resource
  *
  * @param scope The scope in which to define this construct
