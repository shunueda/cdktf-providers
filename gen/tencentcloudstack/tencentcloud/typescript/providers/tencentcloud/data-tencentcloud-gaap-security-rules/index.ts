// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/gaap_security_rules
...
export interface DataTencentcloudGaapSecurityRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/gaap_security_rules#action DataTencentcloudGaapSecurityRules#action}
  */
  readonly action?: string;
  /**
  * A network address block of the request source to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/gaap_security_rules#cidr_ip DataTencentcloudGaapSecurityRules#cidr_ip}
  */
  readonly cidrIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/gaap_security_rules#id DataTencentcloudGaapSecurityRules#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/gaap_security_rules#name DataTencentcloudGaapSecurityRules#name}
  */
  readonly name?: string;
  /**
  * ID of the security policy to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/gaap_security_rules#policy_id DataTencentcloudGaapSecurityRules#policy_id}
  */
  readonly policyId: string;
  /**
  * Port of the security policy rule to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/gaap_security_rules#port DataTencentcloudGaapSecurityRules#port}
  */
  readonly port?: string;
  /**
  * Protocol of the security policy rule to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/gaap_security_rules#protocol DataTencentcloudGaapSecurityRules#protocol}
  */
  readonly protocol?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/gaap_security_rules#result_output_file DataTencentcloudGaapSecurityRules#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * ID of the security policy rules to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/gaap_security_rules#rule_id DataTencentcloudGaapSecurityRules#rule_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/gaap_security_rules tencentcloud_gaap_security_rules}
*/
export class DataTencentcloudGaapSecurityRules extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudGaapSecurityRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/gaap_security_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/gaap_security_rules tencentcloud_gaap_security_rules} Data Source
  *
  * @param scope The scope in which to define this construct
