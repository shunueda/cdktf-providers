// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/as_start_instances
...
export interface AsStartInstancesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/as_start_instances#auto_scaling_group_id AsStartInstances#auto_scaling_group_id}
  */
  readonly autoScalingGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/as_start_instances#id AsStartInstances#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/as_start_instances#instance_ids AsStartInstances#instance_ids}
  */
  readonly instanceIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/as_start_instances tencentcloud_as_start_instances}
*/
export class AsStartInstances extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AsStartInstances that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/as_start_instances#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/as_start_instances tencentcloud_as_start_instances} Resource
  *
  * @param scope The scope in which to define this construct
