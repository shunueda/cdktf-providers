// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dcdb_slow_logs
...
export interface DataTencentcloudDcdbSlowLogsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Specific name of the database to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dcdb_slow_logs#db DataTencentcloudDcdbSlowLogs#db}
  */
  readonly db?: string;
  /**
  * Query end time in the format of 2016-08-22 14:55:20.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dcdb_slow_logs#end_time DataTencentcloudDcdbSlowLogs#end_time}
  */
  readonly endTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dcdb_slow_logs#id DataTencentcloudDcdbSlowLogs#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dcdb_slow_logs#instance_id DataTencentcloudDcdbSlowLogs#instance_id}
  */
  readonly instanceId: string;
  /**
  * Sorting metric. Valid values: query_time_sum, query_count.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dcdb_slow_logs#order_by DataTencentcloudDcdbSlowLogs#order_by}
  */
  readonly orderBy?: string;
  /**
  * Sorting order. Valid values: desc, asc.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dcdb_slow_logs#order_by_type DataTencentcloudDcdbSlowLogs#order_by_type}
  */
  readonly orderByType?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dcdb_slow_logs#result_output_file DataTencentcloudDcdbSlowLogs#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Instance shard ID in the format of `shard-rc754ljk`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dcdb_slow_logs#shard_id DataTencentcloudDcdbSlowLogs#shard_id}
  */
  readonly shardId: string;
  /**
  * Query slow queries from either the primary or the replica. Valid values: 0 (primary), 1 (replica).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dcdb_slow_logs#slave DataTencentcloudDcdbSlowLogs#slave}
  */
  readonly slave?: number;
  /**
  * Query start time in the format of 2016-07-23 14:55:20.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dcdb_slow_logs#start_time DataTencentcloudDcdbSlowLogs#start_time}
  */
  readonly startTime: string;
}
export interface DataTencentcloudDcdbSlowLogsData {
}

export function dataTencentcloudDcdbSlowLogsDataToTerraform(struct?: DataTencentcloudDcdbSlowLogsData): any {
...
export function dataTencentcloudDcdbSlowLogsDataToHclTerraform(struct?: DataTencentcloudDcdbSlowLogsData): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataTencentcloudDcdbSlowLogsDataOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataTencentcloudDcdbSlowLogsData | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataTencentcloudDcdbSlowLogsData | undefined) {
    if (value === undefined) {
...
export class DataTencentcloudDcdbSlowLogsDataList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataTencentcloudDcdbSlowLogsDataOutputReference {
    return new DataTencentcloudDcdbSlowLogsDataOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dcdb_slow_logs tencentcloud_dcdb_slow_logs}
*/
export class DataTencentcloudDcdbSlowLogs extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "tencentcloud_dcdb_slow_logs";
  ...
  * @param importFromId The id of the existing DataTencentcloudDcdbSlowLogs that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dcdb_slow_logs#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "tencentcloud_dcdb_slow_logs", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dcdb_slow_logs tencentcloud_dcdb_slow_logs} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataTencentcloudDcdbSlowLogsConfig
  */
  public constructor(scope: Construct, id: string, config: DataTencentcloudDcdbSlowLogsConfig) {
    super(scope, id, {
  ...
  private _data = new DataTencentcloudDcdbSlowLogsDataList(this, "data", false);
  public get data() {
    return this._data;
  }
