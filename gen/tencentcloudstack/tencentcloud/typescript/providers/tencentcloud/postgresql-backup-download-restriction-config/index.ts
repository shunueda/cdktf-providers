// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_download_restriction_config
...
export interface PostgresqlBackupDownloadRestrictionConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_download_restriction_config#id PostgresqlBackupDownloadRestrictionConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_download_restriction_config#ip_restriction_effect PostgresqlBackupDownloadRestrictionConfig#ip_restriction_effect}
  */
  readonly ipRestrictionEffect?: string;
  /**
  * The list of ips that are allowed or denied to download backup files.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_download_restriction_config#ip_set PostgresqlBackupDownloadRestrictionConfig#ip_set}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_download_restriction_config#restriction_type PostgresqlBackupDownloadRestrictionConfig#restriction_type}
  */
  readonly restrictionType: string;
  /**
  * The list of vpcIds that allow or deny downloading of backup files.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_download_restriction_config#vpc_id_set PostgresqlBackupDownloadRestrictionConfig#vpc_id_set}
  */
  readonly vpcIdSet?: string[];
  /**
  * vpc limit Strategy: ALLOW, DENY.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_download_restriction_config#vpc_restriction_effect PostgresqlBackupDownloadRestrictionConfig#vpc_restriction_effect}
  */
  readonly vpcRestrictionEffect?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_download_restriction_config tencentcloud_postgresql_backup_download_restriction_config}
*/
export class PostgresqlBackupDownloadRestrictionConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresqlBackupDownloadRestrictionConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_download_restriction_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_download_restriction_config tencentcloud_postgresql_backup_download_restriction_config} Resource
  *
  * @param scope The scope in which to define this construct
