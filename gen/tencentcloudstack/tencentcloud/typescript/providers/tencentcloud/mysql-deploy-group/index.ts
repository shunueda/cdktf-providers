// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_deploy_group
...
export interface MysqlDeployGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_deploy_group#deploy_group_name MysqlDeployGroup#deploy_group_name}
  */
  readonly deployGroupName: string;
  /**
  * The description of deploy group. the maximum length cannot exceed 200 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_deploy_group#description MysqlDeployGroup#description}
  */
  readonly description?: string;
  /**
  * The device class of deploy group. optional value is SH12+SH02, TS85, etc.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_deploy_group#dev_class MysqlDeployGroup#dev_class}
  */
  readonly devClass?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_deploy_group#id MysqlDeployGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_deploy_group#limit_num MysqlDeployGroup#limit_num}
  */
  readonly limitNum?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_deploy_group tencentcloud_mysql_deploy_group}
*/
export class MysqlDeployGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlDeployGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_deploy_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_deploy_group tencentcloud_mysql_deploy_group} Resource
  *
  * @param scope The scope in which to define this construct
