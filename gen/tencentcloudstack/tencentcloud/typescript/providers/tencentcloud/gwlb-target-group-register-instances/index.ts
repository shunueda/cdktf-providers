// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/gwlb_target_group_register_instances
...
export interface GwlbTargetGroupRegisterInstancesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/gwlb_target_group_register_instances#id GwlbTargetGroupRegisterInstances#id}
  *
  ...
  * Target group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/gwlb_target_group_register_instances#target_group_id GwlbTargetGroupRegisterInstances#target_group_id}
  */
  readonly targetGroupId: string;
  /**
  * target_group_instances block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/gwlb_target_group_register_instances#target_group_instances GwlbTargetGroupRegisterInstances#target_group_instances}
  */
...
export interface GwlbTargetGroupRegisterInstancesTargetGroupInstances {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/gwlb_target_group_register_instances#bind_ip GwlbTargetGroupRegisterInstances#bind_ip}
  */
  readonly bindIp: string;
  /**
  * Port of target group instance. Only 6081 is supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/gwlb_target_group_register_instances#port GwlbTargetGroupRegisterInstances#port}
  */
  readonly port?: number;
  /**
  * Weight of target group instance. Only 0 or 16 is supported, and non-0 is uniformly treated as 16.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/gwlb_target_group_register_instances#weight GwlbTargetGroupRegisterInstances#weight}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/gwlb_target_group_register_instances tencentcloud_gwlb_target_group_register_instances}
*/
export class GwlbTargetGroupRegisterInstances extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GwlbTargetGroupRegisterInstances that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/gwlb_target_group_register_instances#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/gwlb_target_group_register_instances tencentcloud_gwlb_target_group_register_instances} Resource
  *
  * @param scope The scope in which to define this construct
