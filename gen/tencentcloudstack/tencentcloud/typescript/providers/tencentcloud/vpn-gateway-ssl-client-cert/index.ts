// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpn_gateway_ssl_client_cert
...
export interface VpnGatewaySslClientCertConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpn_gateway_ssl_client_cert#id VpnGatewaySslClientCert#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpn_gateway_ssl_client_cert#ssl_vpn_client_id VpnGatewaySslClientCert#ssl_vpn_client_id}
  */
  readonly sslVpnClientId: string;
  /**
  * `on`: Enable, `off`: Disable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpn_gateway_ssl_client_cert#switch VpnGatewaySslClientCert#switch}
  */
  readonly switch?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpn_gateway_ssl_client_cert tencentcloud_vpn_gateway_ssl_client_cert}
*/
export class VpnGatewaySslClientCert extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnGatewaySslClientCert that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpn_gateway_ssl_client_cert#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpn_gateway_ssl_client_cert tencentcloud_vpn_gateway_ssl_client_cert} Resource
  *
  * @param scope The scope in which to define this construct
