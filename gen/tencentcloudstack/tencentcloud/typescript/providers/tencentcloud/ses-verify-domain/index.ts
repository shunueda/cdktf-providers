// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/ses_verify_domain
...
export interface SesVerifyDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/ses_verify_domain#email_identity SesVerifyDomain#email_identity}
  */
  readonly emailIdentity: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/ses_verify_domain#id SesVerifyDomain#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/ses_verify_domain tencentcloud_ses_verify_domain}
*/
export class SesVerifyDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SesVerifyDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/ses_verify_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/ses_verify_domain tencentcloud_ses_verify_domain} Resource
  *
  * @param scope The scope in which to define this construct
