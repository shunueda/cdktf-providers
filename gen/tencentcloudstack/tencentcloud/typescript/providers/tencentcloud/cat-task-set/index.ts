// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set
...
export interface CatTaskSetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set#cron CatTaskSet#cron}
  */
  readonly cron?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set#id CatTaskSet#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set#interval CatTaskSet#interval}
  */
  readonly interval: number;
  /**
  * `0`-Unlimit ip type, `1`-IPv4, `2`-IPv6.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set#node_ip_type CatTaskSet#node_ip_type}
  */
  readonly nodeIpType?: number;
  /**
  * Task Nodes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set#nodes CatTaskSet#nodes}
  */
  readonly nodes: string[];
  /**
  * The input is valid when the parameter is modified, `suspend`/`resume`, used to suspend/resume the dial test task.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set#operate CatTaskSet#operate}
  */
  readonly operate?: string;
  /**
  * tasks parameters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set#parameters CatTaskSet#parameters}
  */
  readonly parameters: string;
  /**
  * Tag description list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set#tags CatTaskSet#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Task category,1:PC,2:Mobile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set#task_category CatTaskSet#task_category}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set#task_type CatTaskSet#task_type}
  */
  readonly taskType: number;
  /**
  * batch_tasks block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set#batch_tasks CatTaskSet#batch_tasks}
  */
...
export interface CatTaskSetBatchTasks {
  ...
  * Task name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set#name CatTaskSet#name}
  */
  readonly name: string;
  /**
  * Target address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set#target_address CatTaskSet#target_address}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set tencentcloud_cat_task_set}
*/
export class CatTaskSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CatTaskSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/cat_task_set tencentcloud_cat_task_set} Resource
  *
  * @param scope The scope in which to define this construct
