// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/vpc_net_detect
...
export interface VpcNetDetectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/vpc_net_detect#detect_destination_ip VpcNetDetect#detect_destination_ip}
  */
  readonly detectDestinationIp: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/vpc_net_detect#id VpcNetDetect#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/vpc_net_detect#net_detect_description VpcNetDetect#net_detect_description}
  */
  readonly netDetectDescription?: string;
  /**
  * Network probe name, the maximum length cannot exceed 60 bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/vpc_net_detect#net_detect_name VpcNetDetect#net_detect_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/vpc_net_detect#next_hop_destination VpcNetDetect#next_hop_destination}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/vpc_net_detect#next_hop_type VpcNetDetect#next_hop_type}
  */
  readonly nextHopType?: string;
  /**
  * Subnet instance ID. Such as:subnet-12345678.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/vpc_net_detect#subnet_id VpcNetDetect#subnet_id}
  */
  readonly subnetId: string;
  /**
  * `VPC` instance `ID`. Such as:`vpc-12345678`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/vpc_net_detect#vpc_id VpcNetDetect#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/vpc_net_detect tencentcloud_vpc_net_detect}
*/
export class VpcNetDetect extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcNetDetect that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/vpc_net_detect#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/vpc_net_detect tencentcloud_vpc_net_detect} Resource
  *
  * @param scope The scope in which to define this construct
