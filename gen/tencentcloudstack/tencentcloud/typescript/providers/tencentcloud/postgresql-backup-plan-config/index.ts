// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_plan_config
...
export interface PostgresqlBackupPlanConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_plan_config#backup_period PostgresqlBackupPlanConfig#backup_period}
  */
  readonly backupPeriod?: string[];
  /**
  * Backup retention period in days. Value range:7-1830.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_plan_config#base_backup_retention_period PostgresqlBackupPlanConfig#base_backup_retention_period}
  */
  readonly baseBackupRetentionPeriod?: number;
  /**
  * instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_plan_config#db_instance_id PostgresqlBackupPlanConfig#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_plan_config#id PostgresqlBackupPlanConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_plan_config#max_backup_start_time PostgresqlBackupPlanConfig#max_backup_start_time}
  */
  readonly maxBackupStartTime?: string;
  /**
  * The earliest time to start a backup.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_plan_config#min_backup_start_time PostgresqlBackupPlanConfig#min_backup_start_time}
  */
  readonly minBackupStartTime?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_plan_config tencentcloud_postgresql_backup_plan_config}
*/
export class PostgresqlBackupPlanConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresqlBackupPlanConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_plan_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_backup_plan_config tencentcloud_postgresql_backup_plan_config} Resource
  *
  * @param scope The scope in which to define this construct
