// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user
...
export interface CamUserConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user#console_login CamUser#console_login}
  */
  readonly consoleLogin?: boolean | cdktf.IResolvable;
  /**
  * Country code of the phone number, for example: '86'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user#country_code CamUser#country_code}
  */
  readonly countryCode?: string;
  /**
  * Email of the CAM user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user#email CamUser#email}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user#force_delete CamUser#force_delete}
  */
  readonly forceDelete?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user#id CamUser#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user#name CamUser#name}
  */
  readonly name: string;
  /**
  * Indicate whether the CAM user need to reset the password when first logins.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user#need_reset_password CamUser#need_reset_password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user#password CamUser#password}
  */
  readonly password?: string;
  /**
  * Phone number of the CAM user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user#phone_num CamUser#phone_num}
  */
  readonly phoneNum?: string;
  /**
  * Remark of the CAM user.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user#remark CamUser#remark}
  */
  readonly remark?: string;
  /**
  * A list of tags used to associate different resources.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user#tags CamUser#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Indicate whether to generate the API secret key or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user#use_api CamUser#use_api}
  */
  readonly useApi?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user tencentcloud_cam_user}
*/
export class CamUser extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CamUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user tencentcloud_cam_user} Resource
  *
  * @param scope The scope in which to define this construct
