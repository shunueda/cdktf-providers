// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy
...
export interface CfwEdgePolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  * Description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy#description CfwEdgePolicy#description}
  */
  readonly description?: string;
  /**
  * Rule direction: 1, inbound; 0, outbound.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy#direction CfwEdgePolicy#direction}
  */
  readonly direction: number;
  /**
  * Rule status, true means enabled, false means disabled. Default is true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy#enable CfwEdgePolicy#enable}
  */
  readonly enable?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy#id CfwEdgePolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy#param_template_id CfwEdgePolicy#param_template_id}
  */
  readonly paramTemplateId?: string;
  /**
  * The port for the access control policy. Value: -1/-1: All ports 80: Port 80.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy#port CfwEdgePolicy#port}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy#protocol CfwEdgePolicy#protocol}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy#rule_action CfwEdgePolicy#rule_action}
  */
  readonly ruleAction: string;
  /**
  * Effective range. serial: serial; side: bypass; all: global, Default is all.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy#scope CfwEdgePolicy#scope}
  */
  readonly scope?: string;
  /**
  * Access source example: net:IP/CIDR(192.168.0.2).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy#source_content CfwEdgePolicy#source_content}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy#source_type CfwEdgePolicy#source_type}
  */
  readonly sourceType: string;
  /**
  * Example of access purpose: net: IP/CIDR(192.168.0.2) domain: domain name rules, such as *.qq.com.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy#target_content CfwEdgePolicy#target_content}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy#target_type CfwEdgePolicy#target_type}
  */
  readonly targetType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy tencentcloud_cfw_edge_policy}
*/
export class CfwEdgePolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CfwEdgePolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cfw_edge_policy tencentcloud_cfw_edge_policy} Resource
  *
  * @param scope The scope in which to define this construct
