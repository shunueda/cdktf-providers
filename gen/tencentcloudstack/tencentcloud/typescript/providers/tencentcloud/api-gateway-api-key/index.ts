// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/api_gateway_api_key
...
export interface ApiGatewayApiKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/api_gateway_api_key#access_key_id ApiGatewayApiKey#access_key_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/api_gateway_api_key#access_key_secret ApiGatewayApiKey#access_key_secret}
  */
  readonly accessKeySecret?: string;
  /**
  * Key type, supports both auto and manual (custom keys), defaults to auto.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/api_gateway_api_key#access_key_type ApiGatewayApiKey#access_key_type}
  */
  readonly accessKeyType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/api_gateway_api_key#id ApiGatewayApiKey#id}
  *
  ...
  * Custom key name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/api_gateway_api_key#secret_name ApiGatewayApiKey#secret_name}
  */
  readonly secretName: string;
  /**
  * Key status. Valid values: `on`, `off`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/api_gateway_api_key#status ApiGatewayApiKey#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/api_gateway_api_key tencentcloud_api_gateway_api_key}
*/
export class ApiGatewayApiKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/api_gateway_api_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/api_gateway_api_key tencentcloud_api_gateway_api_key} Resource
  *
  * @param scope The scope in which to define this construct
