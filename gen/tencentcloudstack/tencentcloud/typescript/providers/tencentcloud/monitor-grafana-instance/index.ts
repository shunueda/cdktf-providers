// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/monitor_grafana_instance
...
export interface MonitorGrafanaInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/monitor_grafana_instance#auto_voucher MonitorGrafanaInstance#auto_voucher}
  */
  readonly autoVoucher?: boolean | cdktf.IResolvable;
  /**
  * Control whether grafana could be accessed by internet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/monitor_grafana_instance#enable_internet MonitorGrafanaInstance#enable_internet}
  */
  readonly enableInternet?: boolean | cdktf.IResolvable;
  /**
  * Grafana server admin password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/monitor_grafana_instance#grafana_init_password MonitorGrafanaInstance#grafana_init_password}
  */
  readonly grafanaInitPassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/monitor_grafana_instance#id MonitorGrafanaInstance#id}
  *
  ...
  * Instance name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/monitor_grafana_instance#instance_name MonitorGrafanaInstance#instance_name}
  */
  readonly instanceName: string;
  /**
  * Whether to clean up completely, the default is false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/monitor_grafana_instance#is_destroy MonitorGrafanaInstance#is_destroy}
  */
  readonly isDestroy?: boolean | cdktf.IResolvable;
  /**
  * Whether to clean up completely, the default is false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/monitor_grafana_instance#is_distroy MonitorGrafanaInstance#is_distroy}
  */
  readonly isDistroy?: boolean | cdktf.IResolvable;
  /**
  * Subnet Id array.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/monitor_grafana_instance#subnet_ids MonitorGrafanaInstance#subnet_ids}
  */
  readonly subnetIds?: string[];
  /**
  * Tag description list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/monitor_grafana_instance#tags MonitorGrafanaInstance#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Vpc Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/monitor_grafana_instance#vpc_id MonitorGrafanaInstance#vpc_id}
  */
  readonly vpcId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/monitor_grafana_instance tencentcloud_monitor_grafana_instance}
*/
export class MonitorGrafanaInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorGrafanaInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/monitor_grafana_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/monitor_grafana_instance tencentcloud_monitor_grafana_instance} Resource
  *
  * @param scope The scope in which to define this construct
