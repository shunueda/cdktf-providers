// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_cc_session
...
export interface WafCcSessionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_cc_session#category WafCcSession#category}
  */
  readonly category: string;
  /**
  * Domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_cc_session#domain WafCcSession#domain}
  */
  readonly domain: string;
  /**
  * Waf edition. clb-waf means clb-waf, sparta-waf means saas-waf.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_cc_session#edition WafCcSession#edition}
  */
  readonly edition: string;
  /**
  * Session end identifier, when Category is match.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_cc_session#end_mat WafCcSession#end_mat}
  */
  readonly endMat: string;
  /**
  * End offset position, when Category is location.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_cc_session#end_offset WafCcSession#end_offset}
  */
  readonly endOffset: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_cc_session#id WafCcSession#id}
  *
  ...
  * Session identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_cc_session#key_or_start_mat WafCcSession#key_or_start_mat}
  */
  readonly keyOrStartMat: string;
  /**
  * Session Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_cc_session#session_name WafCcSession#session_name}
  */
  readonly sessionName: string;
  /**
  * Session matching position, Optional locations are get, post, header, cookie.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_cc_session#source WafCcSession#source}
  */
  readonly source: string;
  /**
  * Starting offset position, when Category is location.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_cc_session#start_offset WafCcSession#start_offset}
  */
  readonly startOffset: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_cc_session tencentcloud_waf_cc_session}
*/
export class WafCcSession extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafCcSession that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_cc_session#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_cc_session tencentcloud_waf_cc_session} Resource
  *
  * @param scope The scope in which to define this construct
