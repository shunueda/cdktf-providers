// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory
...
export interface BhUserDirectoryConfig extends cdktf.TerraformMetaArguments {
  ...
  * Directory ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory#dir_id BhUserDirectory#dir_id}
  */
  readonly dirId: number;
  /**
  * Directory name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory#dir_name BhUserDirectory#dir_name}
  */
  readonly dirName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory#id BhUserDirectory#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory#source BhUserDirectory#source}
  */
  readonly source: number;
  /**
  * IOA associated user source name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory#source_name BhUserDirectory#source_name}
  */
  readonly sourceName: string;
  /**
  * user_org_set block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory#user_org_set BhUserDirectory#user_org_set}
  */
...
export interface BhUserDirectoryUserOrgSet {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory#org_id BhUserDirectory#org_id}
  */
  readonly orgId: number;
  /**
  * IOA user organization ID path.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory#org_id_path BhUserDirectory#org_id_path}
  */
  readonly orgIdPath: string;
  /**
  * IOA user organization name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory#org_name BhUserDirectory#org_name}
  */
  readonly orgName: string;
  /**
  * IOA user organization name path.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory#org_name_path BhUserDirectory#org_name_path}
  */
  readonly orgNamePath: string;
  /**
  * Number of users under the IOA user organization ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory#user_total BhUserDirectory#user_total}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory tencentcloud_bh_user_directory}
*/
export class BhUserDirectory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BhUserDirectory that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_directory tencentcloud_bh_user_directory} Resource
  *
  * @param scope The scope in which to define this construct
