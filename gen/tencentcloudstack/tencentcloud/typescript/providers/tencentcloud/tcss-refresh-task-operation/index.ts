// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/tcss_refresh_task_operation
...
export interface TcssRefreshTaskOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Cluster Id list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/tcss_refresh_task_operation#cluster_ids TcssRefreshTaskOperation#cluster_ids}
  */
  readonly clusterIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/tcss_refresh_task_operation#id TcssRefreshTaskOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/tcss_refresh_task_operation#is_sync_list_only TcssRefreshTaskOperation#is_sync_list_only}
  */
  readonly isSyncListOnly?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/tcss_refresh_task_operation tencentcloud_tcss_refresh_task_operation}
*/
export class TcssRefreshTaskOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TcssRefreshTaskOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/tcss_refresh_task_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/tcss_refresh_task_operation tencentcloud_tcss_refresh_task_operation} Resource
  *
  * @param scope The scope in which to define this construct
