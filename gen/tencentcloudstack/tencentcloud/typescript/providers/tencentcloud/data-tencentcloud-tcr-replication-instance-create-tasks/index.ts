// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/tcr_replication_instance_create_tasks
...
export interface DataTencentcloudTcrReplicationInstanceCreateTasksConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/tcr_replication_instance_create_tasks#id DataTencentcloudTcrReplicationInstanceCreateTasks#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/tcr_replication_instance_create_tasks#replication_region_id DataTencentcloudTcrReplicationInstanceCreateTasks#replication_region_id}
  */
  readonly replicationRegionId: number;
  /**
  * synchronization instance Id, see RegistryId in DescribeReplicationInstances.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/tcr_replication_instance_create_tasks#replication_registry_id DataTencentcloudTcrReplicationInstanceCreateTasks#replication_registry_id}
  */
  readonly replicationRegistryId: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/tcr_replication_instance_create_tasks#result_output_file DataTencentcloudTcrReplicationInstanceCreateTasks#result_output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/tcr_replication_instance_create_tasks tencentcloud_tcr_replication_instance_create_tasks}
*/
export class DataTencentcloudTcrReplicationInstanceCreateTasks extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudTcrReplicationInstanceCreateTasks that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/tcr_replication_instance_create_tasks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/tcr_replication_instance_create_tasks tencentcloud_tcr_replication_instance_create_tasks} Data Source
  *
  * @param scope The scope in which to define this construct
