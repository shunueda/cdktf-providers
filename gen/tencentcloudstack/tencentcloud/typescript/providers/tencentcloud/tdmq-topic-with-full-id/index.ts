// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tdmq_topic_with_full_id
...
export interface TdmqTopicWithFullIdConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tdmq_topic_with_full_id#cluster_id TdmqTopicWithFullId#cluster_id}
  */
  readonly clusterId: string;
  /**
  * The name of tdmq namespace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tdmq_topic_with_full_id#environ_id TdmqTopicWithFullId#environ_id}
  */
  readonly environId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tdmq_topic_with_full_id#id TdmqTopicWithFullId#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tdmq_topic_with_full_id#partitions TdmqTopicWithFullId#partitions}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tdmq_topic_with_full_id#pulsar_topic_type TdmqTopicWithFullId#pulsar_topic_type}
  */
  readonly pulsarTopicType?: number;
  /**
  * Description of the namespace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tdmq_topic_with_full_id#remark TdmqTopicWithFullId#remark}
  */
  readonly remark?: string;
  /**
  * The name of topic to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tdmq_topic_with_full_id#topic_name TdmqTopicWithFullId#topic_name}
  */
  readonly topicName: string;
  /**
  * The type of topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tdmq_topic_with_full_id#topic_type TdmqTopicWithFullId#topic_type}
  */
  readonly topicType?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tdmq_topic_with_full_id tencentcloud_tdmq_topic_with_full_id}
*/
export class TdmqTopicWithFullId extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TdmqTopicWithFullId that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tdmq_topic_with_full_id#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tdmq_topic_with_full_id tencentcloud_tdmq_topic_with_full_id} Resource
  *
  * @param scope The scope in which to define this construct
