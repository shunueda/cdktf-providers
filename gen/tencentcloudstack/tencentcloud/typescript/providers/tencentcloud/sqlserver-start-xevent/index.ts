// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sqlserver_start_xevent
...
export interface SqlserverStartXeventConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sqlserver_start_xevent#id SqlserverStartXevent#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sqlserver_start_xevent#instance_id SqlserverStartXevent#instance_id}
  */
  readonly instanceId: string;
  /**
  * event_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sqlserver_start_xevent#event_config SqlserverStartXevent#event_config}
  */
...
export interface SqlserverStartXeventEventConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sqlserver_start_xevent#event_type SqlserverStartXevent#event_type}
  */
  readonly eventType: string;
  /**
  * Threshold in milliseconds. Valid values: 0(disable), non-zero (enable).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sqlserver_start_xevent#threshold SqlserverStartXevent#threshold}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sqlserver_start_xevent tencentcloud_sqlserver_start_xevent}
*/
export class SqlserverStartXevent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlserverStartXevent that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sqlserver_start_xevent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sqlserver_start_xevent tencentcloud_sqlserver_start_xevent} Resource
  *
  * @param scope The scope in which to define this construct
