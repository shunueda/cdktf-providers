// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mysql_local_binlog_config
...
export interface MysqlLocalBinlogConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mysql_local_binlog_config#id MysqlLocalBinlogConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mysql_local_binlog_config#instance_id MysqlLocalBinlogConfig#instance_id}
  */
  readonly instanceId: string;
  /**
  * Space utilization of local binlog. Value range: [30,50].
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mysql_local_binlog_config#max_usage MysqlLocalBinlogConfig#max_usage}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mysql_local_binlog_config#save_hours MysqlLocalBinlogConfig#save_hours}
  */
  readonly saveHours: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mysql_local_binlog_config tencentcloud_mysql_local_binlog_config}
*/
export class MysqlLocalBinlogConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlLocalBinlogConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mysql_local_binlog_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mysql_local_binlog_config tencentcloud_mysql_local_binlog_config} Resource
  *
  * @param scope The scope in which to define this construct
