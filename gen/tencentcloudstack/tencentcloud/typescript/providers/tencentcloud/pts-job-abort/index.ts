// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/pts_job_abort
...
export interface PtsJobAbortConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/pts_job_abort#abort_reason PtsJobAbort#abort_reason}
  */
  readonly abortReason?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/pts_job_abort#id PtsJobAbort#id}
  *
  ...
  * Job ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/pts_job_abort#job_id PtsJobAbort#job_id}
  */
  readonly jobId: string;
  /**
  * Project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/pts_job_abort#project_id PtsJobAbort#project_id}
  */
  readonly projectId: string;
  /**
  * Scenario ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/pts_job_abort#scenario_id PtsJobAbort#scenario_id}
  */
  readonly scenarioId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/pts_job_abort tencentcloud_pts_job_abort}
*/
export class PtsJobAbort extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PtsJobAbort that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/pts_job_abort#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/pts_job_abort tencentcloud_pts_job_abort} Resource
  *
  * @param scope The scope in which to define this construct
