// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/waf_ip_access_control
...
export interface WafIpAccessControlConfig extends cdktf.TerraformMetaArguments {
  ...
  * Domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/waf_ip_access_control#domain WafIpAccessControl#domain}
  */
  readonly domain: string;
  /**
  * Waf edition. clb-waf means clb-waf, sparta-waf means saas-waf.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/waf_ip_access_control#edition WafIpAccessControl#edition}
  */
  readonly edition: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/waf_ip_access_control#id WafIpAccessControl#id}
  *
  ...
  * Waf instance Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/waf_ip_access_control#instance_id WafIpAccessControl#instance_id}
  */
  readonly instanceId: string;
  /**
  * items block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/waf_ip_access_control#items WafIpAccessControl#items}
  */
...
export interface WafIpAccessControlItems {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/waf_ip_access_control#action WafIpAccessControl#action}
  */
  readonly action: number;
  /**
  * IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/waf_ip_access_control#ip WafIpAccessControl#ip}
  */
  readonly ip: string;
  /**
  * Note info.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/waf_ip_access_control#note WafIpAccessControl#note}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/waf_ip_access_control#valid_ts WafIpAccessControl#valid_ts}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/waf_ip_access_control tencentcloud_waf_ip_access_control}
*/
export class WafIpAccessControl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafIpAccessControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/waf_ip_access_control#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/waf_ip_access_control tencentcloud_waf_ip_access_control} Resource
  *
  * @param scope The scope in which to define this construct
