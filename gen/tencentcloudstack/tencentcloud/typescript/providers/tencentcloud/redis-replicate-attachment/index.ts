// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_replicate_attachment
...
export interface RedisReplicateAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  * The ID of group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_replicate_attachment#group_id RedisReplicateAttachment#group_id}
  */
  readonly groupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_replicate_attachment#id RedisReplicateAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_replicate_attachment#instance_ids RedisReplicateAttachment#instance_ids}
  */
  readonly instanceIds: string[];
  /**
  * The ID of master instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_replicate_attachment#master_instance_id RedisReplicateAttachment#master_instance_id}
  */
  readonly masterInstanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_replicate_attachment tencentcloud_redis_replicate_attachment}
*/
export class RedisReplicateAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisReplicateAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_replicate_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_replicate_attachment tencentcloud_redis_replicate_attachment} Resource
  *
  * @param scope The scope in which to define this construct
