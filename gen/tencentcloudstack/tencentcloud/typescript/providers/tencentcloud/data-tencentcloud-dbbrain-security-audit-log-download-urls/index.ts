// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_security_audit_log_download_urls
...
export interface DataTencentcloudDbbrainSecurityAuditLogDownloadUrlsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_security_audit_log_download_urls#async_request_id DataTencentcloudDbbrainSecurityAuditLogDownloadUrls#async_request_id}
  */
  readonly asyncRequestId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_security_audit_log_download_urls#id DataTencentcloudDbbrainSecurityAuditLogDownloadUrls#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_security_audit_log_download_urls#product DataTencentcloudDbbrainSecurityAuditLogDownloadUrls#product}
  */
  readonly product: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_security_audit_log_download_urls#result_output_file DataTencentcloudDbbrainSecurityAuditLogDownloadUrls#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Security audit group Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_security_audit_log_download_urls#sec_audit_group_id DataTencentcloudDbbrainSecurityAuditLogDownloadUrls#sec_audit_group_id}
  */
  readonly secAuditGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_security_audit_log_download_urls tencentcloud_dbbrain_security_audit_log_download_urls}
*/
export class DataTencentcloudDbbrainSecurityAuditLogDownloadUrls extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudDbbrainSecurityAuditLogDownloadUrls that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_security_audit_log_download_urls#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/dbbrain_security_audit_log_download_urls tencentcloud_dbbrain_security_audit_log_download_urls} Data Source
  *
  * @param scope The scope in which to define this construct
