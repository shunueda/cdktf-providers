// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_nat_instance
...
export interface CfwNatInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_nat_instance#cross_a_zone CfwNatInstance#cross_a_zone}
  */
  readonly crossAZone?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_nat_instance#id CfwNatInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_nat_instance#mode CfwNatInstance#mode}
  */
  readonly mode: number;
  /**
  * Firewall instance name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_nat_instance#name CfwNatInstance#name}
  */
  readonly name: string;
  /**
  * A list of nat gateways connected to the access mode, at least one of NewModeItems and NatgwList is passed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_nat_instance#nat_gw_list CfwNatInstance#nat_gw_list}
  */
  readonly natGwList?: string[];
  /**
  * Bandwidth.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_nat_instance#width CfwNatInstance#width}
  */
  readonly width: number;
  /**
  * Zone list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_nat_instance#zone_set CfwNatInstance#zone_set}
  */
  readonly zoneSet: string[];
  /**
  * new_mode_items block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_nat_instance#new_mode_items CfwNatInstance#new_mode_items}
  */
...
export interface CfwNatInstanceNewModeItems {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_nat_instance#eips CfwNatInstance#eips}
  */
  readonly eips: string[];
  /**
  * List of vpcs connected in new mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_nat_instance#vpc_list CfwNatInstance#vpc_list}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_nat_instance tencentcloud_cfw_nat_instance}
*/
export class CfwNatInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CfwNatInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_nat_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_nat_instance tencentcloud_cfw_nat_instance} Resource
  *
  * @param scope The scope in which to define this construct
