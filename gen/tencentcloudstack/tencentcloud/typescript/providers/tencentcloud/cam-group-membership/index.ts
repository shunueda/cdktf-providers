// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_group_membership
...
export interface CamGroupMembershipConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of CAM group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_group_membership#group_id CamGroupMembership#group_id}
  */
  readonly groupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_group_membership#id CamGroupMembership#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_group_membership#user_ids CamGroupMembership#user_ids}
  */
  readonly userIds?: string[];
  /**
  * User name set as ID of the CAM group members.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_group_membership#user_names CamGroupMembership#user_names}
  */
  readonly userNames?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_group_membership tencentcloud_cam_group_membership}
*/
export class CamGroupMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CamGroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_group_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_group_membership tencentcloud_cam_group_membership} Resource
  *
  * @param scope The scope in which to define this construct
