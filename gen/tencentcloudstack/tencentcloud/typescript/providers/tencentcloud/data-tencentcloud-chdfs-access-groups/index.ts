// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/chdfs_access_groups
...
export interface DataTencentcloudChdfsAccessGroupsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/chdfs_access_groups#id DataTencentcloudChdfsAccessGroups#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/chdfs_access_groups#owner_uin DataTencentcloudChdfsAccessGroups#owner_uin}
  */
  readonly ownerUin?: number;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/chdfs_access_groups#result_output_file DataTencentcloudChdfsAccessGroups#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * get groups belongs to the vpc id, must set but only can use one of VpcId and OwnerUin to get the groups.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/chdfs_access_groups#vpc_id DataTencentcloudChdfsAccessGroups#vpc_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/chdfs_access_groups tencentcloud_chdfs_access_groups}
*/
export class DataTencentcloudChdfsAccessGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudChdfsAccessGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/chdfs_access_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/chdfs_access_groups tencentcloud_chdfs_access_groups} Data Source
  *
  * @param scope The scope in which to define this construct
