// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/postgresql_parameter_template
...
export interface PostgresqlParameterTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/postgresql_parameter_template#db_engine PostgresqlParameterTemplate#db_engine}
  */
  readonly dbEngine: string;
  /**
  * The major database version number, such as 11, 12, 13.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/postgresql_parameter_template#db_major_version PostgresqlParameterTemplate#db_major_version}
  */
  readonly dbMajorVersion: string;
  /**
  * The set of parameters that need to be deleted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/postgresql_parameter_template#delete_param_set PostgresqlParameterTemplate#delete_param_set}
  */
  readonly deleteParamSet?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/postgresql_parameter_template#id PostgresqlParameterTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/postgresql_parameter_template#template_description PostgresqlParameterTemplate#template_description}
  */
  readonly templateDescription?: string;
  /**
  * Template name, which can contain 1-60 letters, digits, and symbols (-_./()+=:@).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/postgresql_parameter_template#template_name PostgresqlParameterTemplate#template_name}
  */
  readonly templateName: string;
  /**
  * modify_param_entry_set block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/postgresql_parameter_template#modify_param_entry_set PostgresqlParameterTemplate#modify_param_entry_set}
  */
...
export interface PostgresqlParameterTemplateModifyParamEntrySet {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/postgresql_parameter_template#expected_value PostgresqlParameterTemplate#expected_value}
  */
  readonly expectedValue: string;
  /**
  * The parameter name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/postgresql_parameter_template#name PostgresqlParameterTemplate#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/postgresql_parameter_template tencentcloud_postgresql_parameter_template}
*/
export class PostgresqlParameterTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresqlParameterTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/postgresql_parameter_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/postgresql_parameter_template tencentcloud_postgresql_parameter_template} Resource
  *
  * @param scope The scope in which to define this construct
