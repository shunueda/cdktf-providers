// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_end_point_service_white_list
...
export interface VpcEndPointServiceWhiteListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_end_point_service_white_list#description VpcEndPointServiceWhiteList#description}
  */
  readonly description?: string;
  /**
  * ID of endpoint service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_end_point_service_white_list#end_point_service_id VpcEndPointServiceWhiteList#end_point_service_id}
  */
  readonly endPointServiceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_end_point_service_white_list#id VpcEndPointServiceWhiteList#id}
  *
  ...
  * UIN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_end_point_service_white_list#user_uin VpcEndPointServiceWhiteList#user_uin}
  */
  readonly userUin: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_end_point_service_white_list tencentcloud_vpc_end_point_service_white_list}
*/
export class VpcEndPointServiceWhiteList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcEndPointServiceWhiteList that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_end_point_service_white_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_end_point_service_white_list tencentcloud_vpc_end_point_service_white_list} Resource
  *
  * @param scope The scope in which to define this construct
