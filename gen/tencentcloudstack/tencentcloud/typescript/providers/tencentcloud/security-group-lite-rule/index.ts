// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/security_group_lite_rule
...
export interface SecurityGroupLiteRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/security_group_lite_rule#egress SecurityGroupLiteRule#egress}
  */
  readonly egress?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/security_group_lite_rule#id SecurityGroupLiteRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/security_group_lite_rule#ingress SecurityGroupLiteRule#ingress}
  */
  readonly ingress?: string[];
  /**
  * ID of the security group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/security_group_lite_rule#security_group_id SecurityGroupLiteRule#security_group_id}
  */
  readonly securityGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/security_group_lite_rule tencentcloud_security_group_lite_rule}
*/
export class SecurityGroupLiteRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityGroupLiteRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/security_group_lite_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/security_group_lite_rule tencentcloud_security_group_lite_rule} Resource
  *
  * @param scope The scope in which to define this construct
