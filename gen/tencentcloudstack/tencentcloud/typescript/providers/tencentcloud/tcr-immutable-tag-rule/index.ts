// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_immutable_tag_rule
...
export interface TcrImmutableTagRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_immutable_tag_rule#id TcrImmutableTagRule#id}
  *
  ...
  * namespace name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_immutable_tag_rule#namespace_name TcrImmutableTagRule#namespace_name}
  */
  readonly namespaceName: string;
  /**
  * instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_immutable_tag_rule#registry_id TcrImmutableTagRule#registry_id}
  */
  readonly registryId: string;
  /**
  * Tag description list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_immutable_tag_rule#tags TcrImmutableTagRule#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_immutable_tag_rule#rule TcrImmutableTagRule#rule}
  */
...
export interface TcrImmutableTagRuleRule {
  ...
  * disable rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_immutable_tag_rule#disabled TcrImmutableTagRule#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * repository decoration type:repoMatches or repoExcludes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_immutable_tag_rule#repository_decoration TcrImmutableTagRule#repository_decoration}
  */
  readonly repositoryDecoration: string;
  /**
  * repository matching rules.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_immutable_tag_rule#repository_pattern TcrImmutableTagRule#repository_pattern}
  */
  readonly repositoryPattern: string;
  /**
  * tag decoration type: matches or excludes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_immutable_tag_rule#tag_decoration TcrImmutableTagRule#tag_decoration}
  */
  readonly tagDecoration: string;
  /**
  * tag matching rules.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_immutable_tag_rule#tag_pattern TcrImmutableTagRule#tag_pattern}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_immutable_tag_rule tencentcloud_tcr_immutable_tag_rule}
*/
export class TcrImmutableTagRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TcrImmutableTagRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_immutable_tag_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_immutable_tag_rule tencentcloud_tcr_immutable_tag_rule} Resource
  *
  * @param scope The scope in which to define this construct
