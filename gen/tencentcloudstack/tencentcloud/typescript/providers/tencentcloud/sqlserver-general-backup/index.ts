// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_general_backup
...
export interface SqlserverGeneralBackupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_general_backup#backup_name SqlserverGeneralBackup#backup_name}
  */
  readonly backupName?: string;
  /**
  * List of names of databases to be backed up (required only for multi-database backup).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_general_backup#db_names SqlserverGeneralBackup#db_names}
  */
  readonly dbNames?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_general_backup#id SqlserverGeneralBackup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_general_backup#instance_id SqlserverGeneralBackup#instance_id}
  */
  readonly instanceId: string;
  /**
  * Backup policy (0: instance backup, 1: multi-database backup).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_general_backup#strategy SqlserverGeneralBackup#strategy}
  */
  readonly strategy?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_general_backup tencentcloud_sqlserver_general_backup}
*/
export class SqlserverGeneralBackup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlserverGeneralBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_general_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_general_backup tencentcloud_sqlserver_general_backup} Resource
  *
  * @param scope The scope in which to define this construct
