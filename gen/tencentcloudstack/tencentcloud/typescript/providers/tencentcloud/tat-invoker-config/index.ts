// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/tat_invoker_config
...
export interface TatInvokerConfigAConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/tat_invoker_config#id TatInvokerConfigA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/tat_invoker_config#invoker_id TatInvokerConfigA#invoker_id}
  */
  readonly invokerId: string;
  /**
  * Invoker on and off state, Values: `on`, `off`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/tat_invoker_config#invoker_status TatInvokerConfigA#invoker_status}
  */
  readonly invokerStatus: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/tat_invoker_config tencentcloud_tat_invoker_config}
*/
export class TatInvokerConfigA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TatInvokerConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/tat_invoker_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/tat_invoker_config tencentcloud_tat_invoker_config} Resource
  *
  * @param scope The scope in which to define this construct
