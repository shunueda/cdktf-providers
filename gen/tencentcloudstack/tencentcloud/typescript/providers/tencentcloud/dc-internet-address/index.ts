// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dc_internet_address
...
export interface DcInternetAddressConfig extends cdktf.TerraformMetaArguments {
  ...
  * 0: IPv4, 1: IPv6.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dc_internet_address#addr_proto DcInternetAddress#addr_proto}
  */
  readonly addrProto: number;
  /**
  * 0: BGP, 1: china telecom, 2: china mobile, 3: china unicom.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dc_internet_address#addr_type DcInternetAddress#addr_type}
  */
  readonly addrType: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dc_internet_address#id DcInternetAddress#id}
  *
  ...
  * CIDR address mask.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dc_internet_address#mask_len DcInternetAddress#mask_len}
  */
  readonly maskLen: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dc_internet_address tencentcloud_dc_internet_address}
*/
export class DcInternetAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DcInternetAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dc_internet_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dc_internet_address tencentcloud_dc_internet_address} Resource
  *
  * @param scope The scope in which to define this construct
