// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/address_template_group
...
export interface AddressTemplateGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/address_template_group#id AddressTemplateGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/address_template_group#name AddressTemplateGroup#name}
  */
  readonly name: string;
  /**
  * Template ID list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/address_template_group#template_ids AddressTemplateGroup#template_ids}
  */
  readonly templateIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/address_template_group tencentcloud_address_template_group}
*/
export class AddressTemplateGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AddressTemplateGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/address_template_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/address_template_group tencentcloud_address_template_group} Resource
  *
  * @param scope The scope in which to define this construct
