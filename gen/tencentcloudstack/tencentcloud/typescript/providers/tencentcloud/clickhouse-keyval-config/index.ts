// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/clickhouse_keyval_config
...
export interface ClickhouseKeyvalConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/clickhouse_keyval_config#id ClickhouseKeyvalConfig#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/clickhouse_keyval_config#instance_id ClickhouseKeyvalConfig#instance_id}
  */
  readonly instanceId: string;
  /**
  * items block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/clickhouse_keyval_config#items ClickhouseKeyvalConfig#items}
  */
...
export interface ClickhouseKeyvalConfigItems {
  ...
  * Instance config key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/clickhouse_keyval_config#conf_key ClickhouseKeyvalConfig#conf_key}
  */
  readonly confKey: string;
  /**
  * Instance config value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/clickhouse_keyval_config#conf_value ClickhouseKeyvalConfig#conf_value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/clickhouse_keyval_config tencentcloud_clickhouse_keyval_config}
*/
export class ClickhouseKeyvalConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClickhouseKeyvalConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/clickhouse_keyval_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/clickhouse_keyval_config tencentcloud_clickhouse_keyval_config} Resource
  *
  * @param scope The scope in which to define this construct
