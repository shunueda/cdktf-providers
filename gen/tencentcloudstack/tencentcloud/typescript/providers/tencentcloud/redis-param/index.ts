// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_param
...
export interface RedisParamConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_param#id RedisParam#id}
  *
  ...
  * The ID of instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_param#instance_id RedisParam#instance_id}
  */
  readonly instanceId: string;
  /**
  * A list of parameters modified by the instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_param#instance_params RedisParam#instance_params}
  */
  readonly instanceParams: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_param tencentcloud_redis_param}
*/
export class RedisParam extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisParam that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_param#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/redis_param tencentcloud_redis_param} Resource
  *
  * @param scope The scope in which to define this construct
