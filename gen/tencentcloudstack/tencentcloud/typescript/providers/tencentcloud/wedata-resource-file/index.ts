// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_resource_file
...
export interface WedataResourceFileConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_resource_file#bucket_name WedataResourceFile#bucket_name}
  */
  readonly bucketName: string;
  /**
  * bundle client ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_resource_file#bundle_id WedataResourceFile#bundle_id}
  */
  readonly bundleId?: string;
  /**
  * bundle client information.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_resource_file#bundle_info WedataResourceFile#bundle_info}
  */
  readonly bundleInfo?: string;
  /**
  * The cos bucket area corresponding to the BucketName bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_resource_file#cos_region WedataResourceFile#cos_region}
  */
  readonly cosRegion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_resource_file#id WedataResourceFile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_resource_file#parent_folder_path WedataResourceFile#parent_folder_path}
  */
  readonly parentFolderPath: string;
  /**
  * Project id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_resource_file#project_id WedataResourceFile#project_id}
  */
  ...
  * .
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_resource_file#resource_file WedataResourceFile#resource_file}
  */
  readonly resourceFile: string;
  /**
  * The resource file name should be consistent with the uploaded file name as much as possible.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_resource_file#resource_name WedataResourceFile#resource_name}
  */
  readonly resourceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_resource_file tencentcloud_wedata_resource_file}
*/
export class WedataResourceFile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WedataResourceFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_resource_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_resource_file tencentcloud_wedata_resource_file} Resource
  *
  * @param scope The scope in which to define this construct
