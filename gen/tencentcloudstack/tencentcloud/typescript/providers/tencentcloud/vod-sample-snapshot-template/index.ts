// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template
...
export interface VodSampleSnapshotTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template#comment VodSampleSnapshotTemplate#comment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template#fill_type VodSampleSnapshotTemplate#fill_type}
  */
  readonly fillType?: string;
  /**
  * Image format. Valid values: jpg, png. Default value: jpg.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template#format VodSampleSnapshotTemplate#format}
  */
  readonly format?: string;
  /**
  * Maximum value of the height (or short side) of a screenshot in px. Value range: 0 and [128, 4,096]. If both `Width` and `Height` are 0, the resolution will be the same as that of the source video; If `Width` is 0, but `Height` is not 0, `Width` will be proportionally scaled; If `Width` is not 0, but `Height` is 0, `Height` will be proportionally scaled; If both `Width` and `Height` are not 0, the custom resolution will be used.Default value: 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template#height VodSampleSnapshotTemplate#height}
  */
  readonly height?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template#id VodSampleSnapshotTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template#name VodSampleSnapshotTemplate#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template#resolution_adaptive VodSampleSnapshotTemplate#resolution_adaptive}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template#sample_interval VodSampleSnapshotTemplate#sample_interval}
  */
  readonly sampleInterval: number;
  /**
  * Sampled screencapturing type. Valid values: Percent: by percent. Time: by time interval.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template#sample_type VodSampleSnapshotTemplate#sample_type}
  */
  readonly sampleType: string;
  /**
  * The VOD [application](https://intl.cloud.tencent.com/document/product/266/14574) ID. For customers who activate VOD service from December 25, 2023, if they want to access resources in a VOD application (whether it's the default application or a newly created one), they must fill in this field with the application ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template#sub_app_id VodSampleSnapshotTemplate#sub_app_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template#width VodSampleSnapshotTemplate#width}
  */
  readonly width?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template tencentcloud_vod_sample_snapshot_template}
*/
export class VodSampleSnapshotTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VodSampleSnapshotTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/vod_sample_snapshot_template tencentcloud_vod_sample_snapshot_template} Resource
  *
  * @param scope The scope in which to define this construct
