// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mqtt_device_certificate
...
export interface MqttDeviceCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mqtt_device_certificate#ca_sn MqttDeviceCertificate#ca_sn}
  */
  readonly caSn: string;
  /**
  * Client ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mqtt_device_certificate#client_id MqttDeviceCertificate#client_id}
  */
  readonly clientId?: string;
  /**
  * Device certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mqtt_device_certificate#device_certificate MqttDeviceCertificate#device_certificate}
  */
  readonly deviceCertificate: string;
  /**
  * Certificate format, Default is PEM.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mqtt_device_certificate#format MqttDeviceCertificate#format}
  */
  readonly format?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mqtt_device_certificate#id MqttDeviceCertificate#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mqtt_device_certificate#instance_id MqttDeviceCertificate#instance_id}
  */
  readonly instanceId: string;
  /**
  * Certificate status, Default is ACTIVE.\n  ACTIVE activation;\n  INACTIVE not active.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mqtt_device_certificate#status MqttDeviceCertificate#status}
  */
  readonly status?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mqtt_device_certificate tencentcloud_mqtt_device_certificate}
*/
export class MqttDeviceCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MqttDeviceCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mqtt_device_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mqtt_device_certificate tencentcloud_mqtt_device_certificate} Resource
  *
  * @param scope The scope in which to define this construct
