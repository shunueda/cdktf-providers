// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/mongodb_instance_backup
...
export interface MongodbInstanceBackupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/mongodb_instance_backup#backup_method MongodbInstanceBackup#backup_method}
  */
  readonly backupMethod: number;
  /**
  * backup notes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/mongodb_instance_backup#backup_remark MongodbInstanceBackup#backup_remark}
  */
  readonly backupRemark?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/mongodb_instance_backup#id MongodbInstanceBackup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/mongodb_instance_backup#instance_id MongodbInstanceBackup#instance_id}
  */
  readonly instanceId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/mongodb_instance_backup#timeouts MongodbInstanceBackup#timeouts}
  */
  readonly timeouts?: MongodbInstanceBackupTimeouts;
}
export interface MongodbInstanceBackupTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/mongodb_instance_backup#create MongodbInstanceBackup#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/mongodb_instance_backup tencentcloud_mongodb_instance_backup}
*/
export class MongodbInstanceBackup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MongodbInstanceBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/mongodb_instance_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/mongodb_instance_backup tencentcloud_mongodb_instance_backup} Resource
  *
  * @param scope The scope in which to define this construct
