// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_security_group_attachment
...
export interface ClbSecurityGroupAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_security_group_attachment#id ClbSecurityGroupAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_security_group_attachment#load_balancer_ids ClbSecurityGroupAttachment#load_balancer_ids}
  */
  readonly loadBalancerIds: string[];
  /**
  * Security group ID, such as esg-12345678.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_security_group_attachment#security_group ClbSecurityGroupAttachment#security_group}
  */
  readonly securityGroup: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_security_group_attachment tencentcloud_clb_security_group_attachment}
*/
export class ClbSecurityGroupAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClbSecurityGroupAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_security_group_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_security_group_attachment tencentcloud_clb_security_group_attachment} Resource
  *
  * @param scope The scope in which to define this construct
