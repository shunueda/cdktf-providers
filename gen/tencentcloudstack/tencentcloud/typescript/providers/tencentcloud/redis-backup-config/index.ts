// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/redis_backup_config
...
export interface RedisBackupConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/redis_backup_config#backup_period RedisBackupConfig#backup_period}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/redis_backup_config#backup_time RedisBackupConfig#backup_time}
  */
  readonly backupTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/redis_backup_config#id RedisBackupConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/redis_backup_config#redis_id RedisBackupConfig#redis_id}
  */
  readonly redisId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/redis_backup_config tencentcloud_redis_backup_config}
*/
export class RedisBackupConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisBackupConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/redis_backup_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/redis_backup_config tencentcloud_redis_backup_config} Resource
  *
  * @param scope The scope in which to define this construct
