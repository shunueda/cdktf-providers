// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/mysql_backup_overview
...
export interface DataTencentcloudMysqlBackupOverviewConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/mysql_backup_overview#id DataTencentcloudMysqlBackupOverview#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/mysql_backup_overview#product DataTencentcloudMysqlBackupOverview#product}
  */
  readonly product: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/mysql_backup_overview#result_output_file DataTencentcloudMysqlBackupOverview#result_output_file}
  */
  readonly resultOutputFile?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/mysql_backup_overview tencentcloud_mysql_backup_overview}
*/
export class DataTencentcloudMysqlBackupOverview extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudMysqlBackupOverview that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/mysql_backup_overview#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/mysql_backup_overview tencentcloud_mysql_backup_overview} Data Source
  *
  * @param scope The scope in which to define this construct
