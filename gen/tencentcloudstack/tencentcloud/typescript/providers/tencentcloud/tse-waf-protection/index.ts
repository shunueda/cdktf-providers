// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tse_waf_protection
...
export interface TseWafProtectionConfig extends cdktf.TerraformMetaArguments {
  ...
  * Gateway ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tse_waf_protection#gateway_id TseWafProtection#gateway_id}
  */
  readonly gatewayId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tse_waf_protection#id TseWafProtection#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tse_waf_protection#list TseWafProtection#list}
  */
  readonly list?: string[];
  /**
  * `open`: open the protection, `close`: close the protection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tse_waf_protection#operate TseWafProtection#operate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tse_waf_protection#type TseWafProtection#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tse_waf_protection tencentcloud_tse_waf_protection}
*/
export class TseWafProtection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TseWafProtection that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tse_waf_protection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tse_waf_protection tencentcloud_tse_waf_protection} Resource
  *
  * @param scope The scope in which to define this construct
