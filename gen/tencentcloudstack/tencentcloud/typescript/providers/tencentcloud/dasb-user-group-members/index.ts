// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dasb_user_group_members
...
export interface DasbUserGroupMembersConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dasb_user_group_members#id DasbUserGroupMembers#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dasb_user_group_members#member_id_set DasbUserGroupMembers#member_id_set}
  */
  readonly memberIdSet: number[];
  /**
  * User Group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dasb_user_group_members#user_group_id DasbUserGroupMembers#user_group_id}
  */
  readonly userGroupId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dasb_user_group_members tencentcloud_dasb_user_group_members}
*/
export class DasbUserGroupMembers extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DasbUserGroupMembers that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dasb_user_group_members#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dasb_user_group_members tencentcloud_dasb_user_group_members} Resource
  *
  * @param scope The scope in which to define this construct
