// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance
...
export interface MongodbReadonlyInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#auto_renew_flag MongodbReadonlyInstance#auto_renew_flag}
  */
  readonly autoRenewFlag?: number;
  /**
  * The available zone of the Mongodb.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#available_zone MongodbReadonlyInstance#available_zone}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#charge_type MongodbReadonlyInstance#charge_type}
  */
  readonly chargeType?: string;
  /**
  * Instance schema type.	- REPLSET: Replset cluster;	- SHARD: Shard cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#cluster_type MongodbReadonlyInstance#cluster_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#engine_version MongodbReadonlyInstance#engine_version}
  */
  readonly engineVersion: string;
  /**
  * Indicates the main instance ID of readonly instances.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#father_instance_id MongodbReadonlyInstance#father_instance_id}
  */
  readonly fatherInstanceId: string;
  /**
  * Indicates the region of main instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#father_instance_region MongodbReadonlyInstance#father_instance_region}
  */
  readonly fatherInstanceRegion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#id MongodbReadonlyInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#in_maintenance MongodbReadonlyInstance#in_maintenance}
  */
  readonly inMaintenance?: number;
  /**
  * Name of the Mongodb instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#instance_name MongodbReadonlyInstance#instance_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#machine_type MongodbReadonlyInstance#machine_type}
  */
  readonly machineType: string;
  /**
  * Memory size. The minimum value is 2, and unit is GB. Memory and volume must be upgraded or degraded simultaneously.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#memory MongodbReadonlyInstance#memory}
  */
  readonly memory: number;
  /**
  * Number of mongos cpu.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#mongos_cpu MongodbReadonlyInstance#mongos_cpu}
  */
  readonly mongosCpu?: number;
  /**
  * Mongos memory size in GB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#mongos_memory MongodbReadonlyInstance#mongos_memory}
  */
  readonly mongosMemory?: number;
  /**
  * Number of mongos.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#mongos_node_num MongodbReadonlyInstance#mongos_node_num}
  */
  readonly mongosNodeNum?: number;
  /**
  * The number of nodes in each replica set. Default value: 3.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#node_num MongodbReadonlyInstance#node_num}
  */
  readonly nodeNum?: number;
  /**
  * Number of nodes per shard, at least 3(one master and two slaves).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#nodes_per_shard MongodbReadonlyInstance#nodes_per_shard}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#prepaid_period MongodbReadonlyInstance#prepaid_period}
  */
  readonly prepaidPeriod?: number;
  /**
  * ID of the project which the instance belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#project_id MongodbReadonlyInstance#project_id}
  */
  readonly projectId?: number;
  /**
  * ID of the security group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#security_groups MongodbReadonlyInstance#security_groups}
  */
  readonly securityGroups?: string[];
  /**
  * Number of sharding.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#shard_quantity MongodbReadonlyInstance#shard_quantity}
  */
  readonly shardQuantity?: number;
  /**
  * ID of the subnet within this VPC. The value is required if `vpc_id` is set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#subnet_id MongodbReadonlyInstance#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * The tags of the Mongodb. Key name `project` is system reserved and can't be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#tags MongodbReadonlyInstance#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Disk size. The minimum value is 25, and unit is GB. Memory and volume must be upgraded or degraded simultaneously.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#volume MongodbReadonlyInstance#volume}
  */
  readonly volume: number;
  /**
  * ID of the VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#vpc_id MongodbReadonlyInstance#vpc_id}
  */
  readonly vpcId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance tencentcloud_mongodb_readonly_instance}
*/
export class MongodbReadonlyInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MongodbReadonlyInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mongodb_readonly_instance tencentcloud_mongodb_readonly_instance} Resource
  *
  * @param scope The scope in which to define this construct
