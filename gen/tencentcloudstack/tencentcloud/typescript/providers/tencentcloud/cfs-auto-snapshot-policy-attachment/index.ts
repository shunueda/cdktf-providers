// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/cfs_auto_snapshot_policy_attachment
...
export interface CfsAutoSnapshotPolicyAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/cfs_auto_snapshot_policy_attachment#auto_snapshot_policy_id CfsAutoSnapshotPolicyAttachment#auto_snapshot_policy_id}
  */
  readonly autoSnapshotPolicyId: string;
  /**
  * List of IDs of the file systems to be unbound, separated by comma.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/cfs_auto_snapshot_policy_attachment#file_system_ids CfsAutoSnapshotPolicyAttachment#file_system_ids}
  */
  readonly fileSystemIds: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/cfs_auto_snapshot_policy_attachment#id CfsAutoSnapshotPolicyAttachment#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/cfs_auto_snapshot_policy_attachment tencentcloud_cfs_auto_snapshot_policy_attachment}
*/
export class CfsAutoSnapshotPolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CfsAutoSnapshotPolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/cfs_auto_snapshot_policy_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/cfs_auto_snapshot_policy_attachment tencentcloud_cfs_auto_snapshot_policy_attachment} Resource
  *
  * @param scope The scope in which to define this construct
