// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule
...
export interface GaapHttpRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#connect_timeout GaapHttpRule#connect_timeout}
  */
  readonly connectTimeout?: number;
  /**
  * Forward domain of the forward rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#domain GaapHttpRule#domain}
  */
  readonly domain: string;
  /**
  * The default value of requested host which is forwarded to the realserver by the listener is `default`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#forward_host GaapHttpRule#forward_host}
  */
  readonly forwardHost?: string;
  /**
  * Indicates whether health check is enable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#health_check GaapHttpRule#health_check}
  */
  readonly healthCheck: boolean | cdktf.IResolvable;
  /**
  * Method of the health check. Valid value: `GET` and `HEAD`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#health_check_method GaapHttpRule#health_check_method}
  */
  readonly healthCheckMethod?: string;
  /**
  * Path of health check. Maximum length is 80.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#health_check_path GaapHttpRule#health_check_path}
  */
  readonly healthCheckPath?: string;
  /**
  * Return code of confirmed normal. Valid value: `100`, `200`, `300`, `400` and `500`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#health_check_status_codes GaapHttpRule#health_check_status_codes}
  */
  readonly healthCheckStatusCodes?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#id GaapHttpRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#interval GaapHttpRule#interval}
  */
  readonly interval?: number;
  /**
  * ID of the layer7 listener.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#listener_id GaapHttpRule#listener_id}
  */
  readonly listenerId: string;
  /**
  * Path of the forward rule. Maximum length is 80.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#path GaapHttpRule#path}
  */
  readonly path: string;
  /**
  * Type of the realserver. Valid value: `IP` and `DOMAIN`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#realserver_type GaapHttpRule#realserver_type}
  */
  readonly realserverType: string;
  /**
  * Scheduling policy of the forward rule, default value is `rr`. Valid value: `rr`, `wrr` and `lc`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#scheduler GaapHttpRule#scheduler}
  */
  readonly scheduler?: string;
  /**
  * ServerNameIndication (SNI) is required when the SNI switch is turned on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#sni GaapHttpRule#sni}
  */
  readonly sni?: string;
  /**
  * ServerNameIndication (SNI) switch. ON means on and OFF means off.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#sni_switch GaapHttpRule#sni_switch}
  */
  readonly sniSwitch?: string;
  /**
  * realservers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#realservers GaapHttpRule#realservers}
  */
...
export interface GaapHttpRuleRealservers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#ip GaapHttpRule#ip}
  */
  readonly ip: string;
  /**
  * Port of the GAAP realserver.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#port GaapHttpRule#port}
  */
  readonly port: number;
  /**
  * Scheduling weight, default value is `1`. Valid value ranges: (1~100).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#weight GaapHttpRule#weight}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule tencentcloud_gaap_http_rule}
*/
export class GaapHttpRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GaapHttpRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/gaap_http_rule tencentcloud_gaap_http_rule} Resource
  *
  * @param scope The scope in which to define this construct
