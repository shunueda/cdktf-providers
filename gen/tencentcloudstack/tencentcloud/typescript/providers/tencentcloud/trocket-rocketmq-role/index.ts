// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/trocket_rocketmq_role
...
export interface TrocketRocketmqRoleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/trocket_rocketmq_role#id TrocketRocketmqRole#id}
  *
  ...
  * ID of instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/trocket_rocketmq_role#instance_id TrocketRocketmqRole#instance_id}
  */
  readonly instanceId: string;
  /**
  * Whether to enable consumption permission.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/trocket_rocketmq_role#perm_read TrocketRocketmqRole#perm_read}
  */
  readonly permRead: boolean | cdktf.IResolvable;
  /**
  * Whether to enable production permission.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/trocket_rocketmq_role#perm_write TrocketRocketmqRole#perm_write}
  */
  readonly permWrite: boolean | cdktf.IResolvable;
  /**
  * remark.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/trocket_rocketmq_role#remark TrocketRocketmqRole#remark}
  */
  readonly remark: string;
  /**
  * Name of role.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/trocket_rocketmq_role#role TrocketRocketmqRole#role}
  */
  readonly role: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/trocket_rocketmq_role tencentcloud_trocket_rocketmq_role}
*/
export class TrocketRocketmqRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrocketRocketmqRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/trocket_rocketmq_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/trocket_rocketmq_role tencentcloud_trocket_rocketmq_role} Resource
  *
  * @param scope The scope in which to define this construct
