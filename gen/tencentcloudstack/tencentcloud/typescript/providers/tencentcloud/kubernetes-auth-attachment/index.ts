// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/kubernetes_auth_attachment
...
export interface KubernetesAuthAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/kubernetes_auth_attachment#auto_create_client_id KubernetesAuthAttachment#auto_create_client_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/kubernetes_auth_attachment#auto_create_discovery_anonymous_auth KubernetesAuthAttachment#auto_create_discovery_anonymous_auth}
  */
  readonly autoCreateDiscoveryAnonymousAuth?: boolean | cdktf.IResolvable;
  /**
  * Creating an identity provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/kubernetes_auth_attachment#auto_create_oidc_config KubernetesAuthAttachment#auto_create_oidc_config}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/kubernetes_auth_attachment#auto_install_pod_identity_webhook_addon KubernetesAuthAttachment#auto_install_pod_identity_webhook_addon}
  */
  readonly autoInstallPodIdentityWebhookAddon?: boolean | cdktf.IResolvable;
  /**
  * ID of clusters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/kubernetes_auth_attachment#cluster_id KubernetesAuthAttachment#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/kubernetes_auth_attachment#id KubernetesAuthAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/kubernetes_auth_attachment#issuer KubernetesAuthAttachment#issuer}
  */
  readonly issuer?: string;
  /**
  * Specify service-account-jwks-uri. If use_tke_default is set to `true`, please do not set this field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/kubernetes_auth_attachment#jwks_uri KubernetesAuthAttachment#jwks_uri}
  */
  readonly jwksUri?: string;
  /**
  * If set to `true`, the issuer and jwks_uri will be generated automatically by tke, please do not set issuer and jwks_uri.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/kubernetes_auth_attachment#use_tke_default KubernetesAuthAttachment#use_tke_default}
  */
  readonly useTkeDefault?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/kubernetes_auth_attachment tencentcloud_kubernetes_auth_attachment}
*/
export class KubernetesAuthAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesAuthAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/kubernetes_auth_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/kubernetes_auth_attachment tencentcloud_kubernetes_auth_attachment} Resource
  *
  * @param scope The scope in which to define this construct
