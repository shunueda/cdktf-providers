// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_rabbitmq_user_permission
...
export interface TdmqRabbitmqUserPermissionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_rabbitmq_user_permission#config_regexp TdmqRabbitmqUserPermission#config_regexp}
  */
  readonly configRegexp: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_rabbitmq_user_permission#id TdmqRabbitmqUserPermission#id}
  *
  ...
  * Cluster instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_rabbitmq_user_permission#instance_id TdmqRabbitmqUserPermission#instance_id}
  */
  readonly instanceId: string;
  /**
  * Read permission regexp, controls which resources can be read.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_rabbitmq_user_permission#read_regexp TdmqRabbitmqUserPermission#read_regexp}
  */
  readonly readRegexp: string;
  /**
  * Username.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_rabbitmq_user_permission#user TdmqRabbitmqUserPermission#user}
  */
  readonly user: string;
  /**
  * VirtualHost name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_rabbitmq_user_permission#virtual_host TdmqRabbitmqUserPermission#virtual_host}
  */
  readonly virtualHost: string;
  /**
  * Write permission regexp, controls which resources can be written.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_rabbitmq_user_permission#write_regexp TdmqRabbitmqUserPermission#write_regexp}
  */
  readonly writeRegexp: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_rabbitmq_user_permission tencentcloud_tdmq_rabbitmq_user_permission}
*/
export class TdmqRabbitmqUserPermission extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TdmqRabbitmqUserPermission that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_rabbitmq_user_permission#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_rabbitmq_user_permission tencentcloud_tdmq_rabbitmq_user_permission} Resource
  *
  * @param scope The scope in which to define this construct
