// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/vod_event_config
...
export interface VodEventConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/vod_event_config#delete_media_complete_event_switch VodEventConfig#delete_media_complete_event_switch}
  */
  readonly deleteMediaCompleteEventSwitch?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/vod_event_config#id VodEventConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/vod_event_config#mode VodEventConfig#mode}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/vod_event_config#notification_url VodEventConfig#notification_url}
  */
  readonly notificationUrl?: string;
  /**
  * Sub app id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/vod_event_config#sub_app_id VodEventConfig#sub_app_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/vod_event_config#upload_media_complete_event_switch VodEventConfig#upload_media_complete_event_switch}
  */
  readonly uploadMediaCompleteEventSwitch?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/vod_event_config tencentcloud_vod_event_config}
*/
export class VodEventConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VodEventConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/vod_event_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/vod_event_config tencentcloud_vod_event_config} Resource
  *
  * @param scope The scope in which to define this construct
