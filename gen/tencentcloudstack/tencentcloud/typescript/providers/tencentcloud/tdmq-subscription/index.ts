// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_subscription
...
export interface TdmqSubscriptionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_subscription#auto_create_policy_topic TdmqSubscription#auto_create_policy_topic}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_subscription#auto_delete_policy_topic TdmqSubscription#auto_delete_policy_topic}
  */
  readonly autoDeletePolicyTopic?: boolean | cdktf.IResolvable;
  /**
  * Pulsar cluster ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_subscription#cluster_id TdmqSubscription#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Environment (namespace) name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_subscription#environment_id TdmqSubscription#environment_id}
  */
  readonly environmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_subscription#id TdmqSubscription#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_subscription#remark TdmqSubscription#remark}
  */
  readonly remark?: string;
  /**
  * Subscriber name, which can contain up to 128 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_subscription#subscription_name TdmqSubscription#subscription_name}
  */
  readonly subscriptionName: string;
  /**
  * Topic name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_subscription#topic_name TdmqSubscription#topic_name}
  */
  readonly topicName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_subscription tencentcloud_tdmq_subscription}
*/
export class TdmqSubscription extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TdmqSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_subscription#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/tdmq_subscription tencentcloud_tdmq_subscription} Resource
  *
  * @param scope The scope in which to define this construct
