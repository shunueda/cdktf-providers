// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/chdfs_access_rule
...
export interface ChdfsAccessRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  * access group id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/chdfs_access_rule#access_group_id ChdfsAccessRule#access_group_id}
  */
  readonly accessGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/chdfs_access_rule#id ChdfsAccessRule#id}
  *
  ...
  * access_rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/chdfs_access_rule#access_rule ChdfsAccessRule#access_rule}
  */
...
export interface ChdfsAccessRuleAccessRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/chdfs_access_rule#access_mode ChdfsAccessRule#access_mode}
  */
  readonly accessMode?: number;
  /**
  * rule address, IP OR IP SEG.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/chdfs_access_rule#address ChdfsAccessRule#address}
  */
  readonly address?: string;
  /**
  * rule priority, range 1 - 100, value less higher priority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/chdfs_access_rule#priority ChdfsAccessRule#priority}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/chdfs_access_rule tencentcloud_chdfs_access_rule}
*/
export class ChdfsAccessRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChdfsAccessRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/chdfs_access_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/chdfs_access_rule tencentcloud_chdfs_access_rule} Resource
  *
  * @param scope The scope in which to define this construct
