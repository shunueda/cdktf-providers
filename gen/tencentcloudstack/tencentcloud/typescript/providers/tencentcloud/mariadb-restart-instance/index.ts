// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/mariadb_restart_instance
...
export interface MariadbRestartInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/mariadb_restart_instance#id MariadbRestartInstance#id}
  *
  ...
  * instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/mariadb_restart_instance#instance_id MariadbRestartInstance#instance_id}
  */
  readonly instanceId: string;
  /**
  * expected restart time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/mariadb_restart_instance#restart_time MariadbRestartInstance#restart_time}
  */
  readonly restartTime?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/mariadb_restart_instance tencentcloud_mariadb_restart_instance}
*/
export class MariadbRestartInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MariadbRestartInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/mariadb_restart_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/mariadb_restart_instance tencentcloud_mariadb_restart_instance} Resource
  *
  * @param scope The scope in which to define this construct
