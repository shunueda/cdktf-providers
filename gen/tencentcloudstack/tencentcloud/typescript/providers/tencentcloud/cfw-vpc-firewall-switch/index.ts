// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cfw_vpc_firewall_switch
...
export interface CfwVpcFirewallSwitchConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cfw_vpc_firewall_switch#enable CfwVpcFirewallSwitch#enable}
  */
  readonly enable: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cfw_vpc_firewall_switch#id CfwVpcFirewallSwitch#id}
  *
  ...
  * Firewall switch ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cfw_vpc_firewall_switch#switch_id CfwVpcFirewallSwitch#switch_id}
  */
  readonly switchId: string;
  /**
  * Firewall instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cfw_vpc_firewall_switch#vpc_ins_id CfwVpcFirewallSwitch#vpc_ins_id}
  */
  readonly vpcInsId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cfw_vpc_firewall_switch tencentcloud_cfw_vpc_firewall_switch}
*/
export class CfwVpcFirewallSwitch extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CfwVpcFirewallSwitch that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cfw_vpc_firewall_switch#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cfw_vpc_firewall_switch tencentcloud_cfw_vpc_firewall_switch} Resource
  *
  * @param scope The scope in which to define this construct
