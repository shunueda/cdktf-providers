// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group
...
export interface TsfApiGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group#auth_type TsfApiGroup#auth_type}
  */
  readonly authType?: string;
  /**
  * remarks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group#description TsfApiGroup#description}
  */
  readonly description?: string;
  /**
  * gateway entity ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group#gateway_instance_id TsfApiGroup#gateway_instance_id}
  */
  readonly gatewayInstanceId?: string;
  /**
  * grouping context.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group#group_context TsfApiGroup#group_context}
  */
  readonly groupContext: string;
  /**
  * group name, cannot contain Chinese.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group#group_name TsfApiGroup#group_name}
  */
  readonly groupName: string;
  /**
  * grouping type, default ms. ms: microservice grouping; external: external Api grouping.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group#group_type TsfApiGroup#group_type}
  */
  readonly groupType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group#id TsfApiGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group#namespace_name_key TsfApiGroup#namespace_name_key}
  */
  readonly namespaceNameKey?: string;
  /**
  * namespace parameter position, path, header or query, the default is path.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group#namespace_name_key_position TsfApiGroup#namespace_name_key_position}
  */
  readonly namespaceNameKeyPosition?: string;
  /**
  * microservice name parameter key value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group#service_name_key TsfApiGroup#service_name_key}
  */
  readonly serviceNameKey?: string;
  /**
  * microservice name parameter position, path, header or query, the default is path.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group#service_name_key_position TsfApiGroup#service_name_key_position}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group tencentcloud_tsf_api_group}
*/
export class TsfApiGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TsfApiGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tsf_api_group tencentcloud_tsf_api_group} Resource
  *
  * @param scope The scope in which to define this construct
