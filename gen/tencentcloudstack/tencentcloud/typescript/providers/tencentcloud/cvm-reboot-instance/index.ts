// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cvm_reboot_instance
...
export interface CvmRebootInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cvm_reboot_instance#force_reboot CvmRebootInstance#force_reboot}
  */
  readonly forceReboot?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cvm_reboot_instance#id CvmRebootInstance#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cvm_reboot_instance#instance_id CvmRebootInstance#instance_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cvm_reboot_instance#stop_type CvmRebootInstance#stop_type}
  */
  readonly stopType?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cvm_reboot_instance tencentcloud_cvm_reboot_instance}
*/
export class CvmRebootInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CvmRebootInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cvm_reboot_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cvm_reboot_instance tencentcloud_cvm_reboot_instance} Resource
  *
  * @param scope The scope in which to define this construct
