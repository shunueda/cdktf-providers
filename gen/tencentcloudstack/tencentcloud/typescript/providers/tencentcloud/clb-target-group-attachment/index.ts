// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_target_group_attachment
...
export interface ClbTargetGroupAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the CLB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_target_group_attachment#clb_id ClbTargetGroupAttachment#clb_id}
  */
  readonly clbId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_target_group_attachment#id ClbTargetGroupAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_target_group_attachment#listener_id ClbTargetGroupAttachment#listener_id}
  */
  readonly listenerId?: string;
  /**
  * ID of the CLB listener rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_target_group_attachment#rule_id ClbTargetGroupAttachment#rule_id}
  */
  readonly ruleId?: string;
  /**
  * ID of the CLB target group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_target_group_attachment#target_group_id ClbTargetGroupAttachment#target_group_id}
  */
  readonly targetGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_target_group_attachment tencentcloud_clb_target_group_attachment}
*/
export class ClbTargetGroupAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClbTargetGroupAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_target_group_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_target_group_attachment tencentcloud_clb_target_group_attachment} Resource
  *
  * @param scope The scope in which to define this construct
