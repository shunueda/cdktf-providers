// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vod_snapshot_by_time_offset_template
...
export interface VodSnapshotByTimeOffsetTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vod_snapshot_by_time_offset_template#comment VodSnapshotByTimeOffsetTemplate#comment}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vod_snapshot_by_time_offset_template#fill_type VodSnapshotByTimeOffsetTemplate#fill_type}
  */
  readonly fillType?: string;
  /**
  * Image format. Valid values: `jpg`, `png`. Default value: `jpg`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vod_snapshot_by_time_offset_template#format VodSnapshotByTimeOffsetTemplate#format}
  */
  readonly format?: string;
  /**
  * Maximum value of the `height` (or short side) of a screenshot in px. Value range: 0 and [128, 4,096]. If both `width` and `height` are `0`, the resolution will be the same as that of the source video; If `width` is `0`, but `height` is not `0`, `width` will be proportionally scaled; If `width` is not `0`, but `height` is `0`, `height` will be proportionally scaled; If both `width` and `height` are not `0`, the custom resolution will be used. Default value: `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vod_snapshot_by_time_offset_template#height VodSnapshotByTimeOffsetTemplate#height}
  */
  readonly height?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vod_snapshot_by_time_offset_template#id VodSnapshotByTimeOffsetTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vod_snapshot_by_time_offset_template#name VodSnapshotByTimeOffsetTemplate#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vod_snapshot_by_time_offset_template#resolution_adaptive VodSnapshotByTimeOffsetTemplate#resolution_adaptive}
  */
  readonly resolutionAdaptive?: boolean | cdktf.IResolvable;
  /**
  * The VOD [application](https://intl.cloud.tencent.com/document/product/266/14574) ID. For customers who activate VOD service from December 25, 2023, if they want to access resources in a VOD application (whether it's the default application or a newly created one), they must fill in this field with the application ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vod_snapshot_by_time_offset_template#sub_app_id VodSnapshotByTimeOffsetTemplate#sub_app_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vod_snapshot_by_time_offset_template#width VodSnapshotByTimeOffsetTemplate#width}
  */
  readonly width?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vod_snapshot_by_time_offset_template tencentcloud_vod_snapshot_by_time_offset_template}
*/
export class VodSnapshotByTimeOffsetTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VodSnapshotByTimeOffsetTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vod_snapshot_by_time_offset_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vod_snapshot_by_time_offset_template tencentcloud_vod_snapshot_by_time_offset_template} Resource
  *
  * @param scope The scope in which to define this construct
