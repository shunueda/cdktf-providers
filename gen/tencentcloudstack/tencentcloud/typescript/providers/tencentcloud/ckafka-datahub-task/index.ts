...
export interface CkafkaDatahubTaskConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/ckafka_datahub_task#id CkafkaDatahubTask#id}
  *
  ...
  * SchemaId.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/ckafka_datahub_task#schema_id CkafkaDatahubTask#schema_id}
  */
  readonly schemaId?: string;
  /**
  * name of the task.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/ckafka_datahub_task#task_name CkafkaDatahubTask#task_name}
  */
  readonly taskName: string;
  /**
  * type of the task, SOURCE(data input), SINK(data output).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/ckafka_datahub_task#task_type CkafkaDatahubTask#task_type}
  */
  readonly taskType: string;
  /**
  * source_resource block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/ckafka_datahub_task#source_resource CkafkaDatahubTask#source_resource}
  */
  readonly sourceResource?: CkafkaDatahubTaskSourceResource;
  /**
  * target_resource block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/ckafka_datahub_task#target_resource CkafkaDatahubTask#target_resource}
  */
  readonly targetResource?: CkafkaDatahubTaskTargetResource;
  /**
  * transform_param block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/ckafka_datahub_task#transform_param CkafkaDatahubTask#transform_param}
  */
  readonly transformParam?: CkafkaDatahubTaskTransformParam;
  /**
  * transforms_param block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/ckafka_datahub_task#transforms_param CkafkaDatahubTask#transforms_param}
  */
  readonly transformsParam?: CkafkaDatahubTaskTransformsParam;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/ckafka_datahub_task tencentcloud_ckafka_datahub_task}
*/
export class CkafkaDatahubTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CkafkaDatahubTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/ckafka_datahub_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/ckafka_datahub_task tencentcloud_ckafka_datahub_task} Resource
  *
  * @param scope The scope in which to define this construct
