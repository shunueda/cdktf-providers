// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/cynosdb_wan
...
export interface CynosdbWanConfig extends cdktf.TerraformMetaArguments {
  ...
  * Cluster ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/cynosdb_wan#cluster_id CynosdbWan#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/cynosdb_wan#id CynosdbWan#id}
  *
  ...
  * Instance Group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/cynosdb_wan#instance_grp_id CynosdbWan#instance_grp_id}
  */
  readonly instanceGrpId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/cynosdb_wan tencentcloud_cynosdb_wan}
*/
export class CynosdbWan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CynosdbWan that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/cynosdb_wan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/cynosdb_wan tencentcloud_cynosdb_wan} Resource
  *
  * @param scope The scope in which to define this construct
