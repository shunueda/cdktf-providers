// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_access_rule
...
export interface CfsAccessRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_access_rule#access_group_id CfsAccessRule#access_group_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_access_rule#auth_client_ip CfsAccessRule#auth_client_ip}
  */
  readonly authClientIp: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_access_rule#id CfsAccessRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_access_rule#priority CfsAccessRule#priority}
  */
  readonly priority: number;
  /**
  * Read and write permissions. Valid values are `RO` and `RW`. and default is `RO`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_access_rule#rw_permission CfsAccessRule#rw_permission}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_access_rule#user_permission CfsAccessRule#user_permission}
  */
  readonly userPermission?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_access_rule tencentcloud_cfs_access_rule}
*/
export class CfsAccessRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CfsAccessRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_access_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_access_rule tencentcloud_cfs_access_rule} Resource
  *
  * @param scope The scope in which to define this construct
