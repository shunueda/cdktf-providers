// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tsf_path_rewrite
...
export interface TsfPathRewriteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tsf_path_rewrite#blocked TsfPathRewrite#blocked}
  */
  readonly blocked: string;
  /**
  * gateway deployment group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tsf_path_rewrite#gateway_group_id TsfPathRewrite#gateway_group_id}
  */
  readonly gatewayGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tsf_path_rewrite#id TsfPathRewrite#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tsf_path_rewrite#order TsfPathRewrite#order}
  */
  readonly order: number;
  /**
  * regular expression.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tsf_path_rewrite#regex TsfPathRewrite#regex}
  */
  readonly regex: string;
  /**
  * content to replace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tsf_path_rewrite#replacement TsfPathRewrite#replacement}
  */
  readonly replacement: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tsf_path_rewrite tencentcloud_tsf_path_rewrite}
*/
export class TsfPathRewrite extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TsfPathRewrite that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tsf_path_rewrite#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/tsf_path_rewrite tencentcloud_tsf_path_rewrite} Resource
  *
  * @param scope The scope in which to define this construct
