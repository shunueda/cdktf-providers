// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/postgresql_readonly_attachment
...
export interface PostgresqlReadonlyAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/postgresql_readonly_attachment#db_instance_id PostgresqlReadonlyAttachment#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/postgresql_readonly_attachment#id PostgresqlReadonlyAttachment#id}
  *
  ...
  * Read only group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/postgresql_readonly_attachment#read_only_group_id PostgresqlReadonlyAttachment#read_only_group_id}
  */
  readonly readOnlyGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/postgresql_readonly_attachment tencentcloud_postgresql_readonly_attachment}
*/
export class PostgresqlReadonlyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresqlReadonlyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/postgresql_readonly_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/postgresql_readonly_attachment tencentcloud_postgresql_readonly_attachment} Resource
  *
  * @param scope The scope in which to define this construct
