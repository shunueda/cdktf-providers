// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service
...
export interface ApiGatewayServiceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service#exclusive_set_name ApiGatewayService#exclusive_set_name}
  */
  readonly exclusiveSetName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service#id ApiGatewayService#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service#instance_id ApiGatewayService#instance_id}
  */
  readonly instanceId?: string;
  /**
  * IP version number. Valid values: `IPv4`, `IPv6`. Default value: `IPv4`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service#ip_version ApiGatewayService#ip_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service#net_type ApiGatewayService#net_type}
  */
  readonly netType: string[];
  /**
  * API QPS value. Enter a positive number to limit the API query rate per second `QPS`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service#pre_limit ApiGatewayService#pre_limit}
  */
  readonly preLimit?: number;
  /**
  * Service frontend request type. Valid values: `http`, `https`, `http&https`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service#protocol ApiGatewayService#protocol}
  */
  readonly protocol: string;
  /**
  * API QPS value. Enter a positive number to limit the API query rate per second `QPS`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service#release_limit ApiGatewayService#release_limit}
  */
  readonly releaseLimit?: number;
  /**
  * Custom service description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service#service_desc ApiGatewayService#service_desc}
  */
  readonly serviceDesc?: string;
  /**
  * Custom service name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service#service_name ApiGatewayService#service_name}
  */
  readonly serviceName: string;
  /**
  * Tag description list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service#tags ApiGatewayService#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * API QPS value. Enter a positive number to limit the API query rate per second `QPS`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service#test_limit ApiGatewayService#test_limit}
  */
  readonly testLimit?: number;
  /**
  * VPC ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service#uniq_vpc_id ApiGatewayService#uniq_vpc_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service tencentcloud_api_gateway_service}
*/
export class ApiGatewayService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayService that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/api_gateway_service tencentcloud_api_gateway_service} Resource
  *
  * @param scope The scope in which to define this construct
