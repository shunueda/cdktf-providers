// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule
...
export interface WafCustomWhiteRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#bypass WafCustomWhiteRule#bypass}
  */
  readonly bypass: string;
  /**
  * Domain name that needs to add policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#domain WafCustomWhiteRule#domain}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#expire_time WafCustomWhiteRule#expire_time}
  */
  readonly expireTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#id WafCustomWhiteRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#job_type WafCustomWhiteRule#job_type}
  */
  readonly jobType?: string;
  /**
  * Logical operator of configuration mode, and/or.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#logical_op WafCustomWhiteRule#logical_op}
  */
  readonly logicalOp?: string;
  /**
  * Rule Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#name WafCustomWhiteRule#name}
  */
  readonly name: string;
  /**
  * Priority, value range 1-100, The smaller the number, the higher the execution priority of this rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#sort_id WafCustomWhiteRule#sort_id}
  */
  readonly sortId: string;
  /**
  * The status of the switch, 1 is on, 0 is off, default 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#status WafCustomWhiteRule#status}
  */
  readonly status?: string;
  /**
  * job_date_time block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#job_date_time WafCustomWhiteRule#job_date_time}
  */
  readonly jobDateTime?: WafCustomWhiteRuleJobDateTime;
  /**
  * strategies block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#strategies WafCustomWhiteRule#strategies}
  */
  readonly strategies: WafCustomWhiteRuleStrategies[] | cdktf.IResolvable;
}
export interface WafCustomWhiteRuleJobDateTimeCron {
  /**
  * Days in each month for execution. Note: This field may return null, indicating that no valid values can be obtained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#days WafCustomWhiteRule#days}
  */
  readonly days?: number[];
  /**
  * End time. Note: This field may return null, indicating that no valid values can be obtained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#end_time WafCustomWhiteRule#end_time}
  */
  readonly endTime?: string;
  /**
  * Start time. Note: This field may return null, indicating that no valid values can be obtained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#start_time WafCustomWhiteRule#start_time}
  */
  readonly startTime?: string;
  /**
  * Days of each week for execution. Note: This field may return null, indicating that no valid values can be obtained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#w_days WafCustomWhiteRule#w_days}
  */
  readonly wDays?: number[];
}

export function wafCustomWhiteRuleJobDateTimeCronToTerraform(struct?: WafCustomWhiteRuleJobDateTimeCron | cdktf.IResolvable): any {
...
export function wafCustomWhiteRuleJobDateTimeCronToHclTerraform(struct?: WafCustomWhiteRuleJobDateTimeCron | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class WafCustomWhiteRuleJobDateTimeCronOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): WafCustomWhiteRuleJobDateTimeCron | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: WafCustomWhiteRuleJobDateTimeCron | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class WafCustomWhiteRuleJobDateTimeCronList extends cdktf.ComplexList {
  public internalValue? : WafCustomWhiteRuleJobDateTimeCron[] | cdktf.IResolvable
  ...
  */
  public get(index: number): WafCustomWhiteRuleJobDateTimeCronOutputReference {
    return new WafCustomWhiteRuleJobDateTimeCronOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface WafCustomWhiteRuleJobDateTimeTimed {
  /**
  * End timestamp, in seconds. Note: This field may return null, indicating that no valid values can be obtained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#end_date_time WafCustomWhiteRule#end_date_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#start_date_time WafCustomWhiteRule#start_date_time}
  */
  readonly startDateTime?: number;
}

export function wafCustomWhiteRuleJobDateTimeTimedToTerraform(struct?: WafCustomWhiteRuleJobDateTimeTimed | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function wafCustomWhiteRuleJobDateTimeTimedToHclTerraform(struct?: WafCustomWhiteRuleJobDateTimeTimed | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class WafCustomWhiteRuleJobDateTimeTimedOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): WafCustomWhiteRuleJobDateTimeTimed | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: WafCustomWhiteRuleJobDateTimeTimed | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class WafCustomWhiteRuleJobDateTimeTimedList extends cdktf.ComplexList {
  public internalValue? : WafCustomWhiteRuleJobDateTimeTimed[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): WafCustomWhiteRuleJobDateTimeTimedOutputReference {
    return new WafCustomWhiteRuleJobDateTimeTimedOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface WafCustomWhiteRuleJobDateTime {
  /**
  * Time zone. Note: This field may return null, indicating that no valid values can be obtained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#time_t_zone WafCustomWhiteRule#time_t_zone}
  */
  readonly timeTZone?: string;
  /**
  * cron block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#cron WafCustomWhiteRule#cron}
  */
  readonly cron?: WafCustomWhiteRuleJobDateTimeCron[] | cdktf.IResolvable;
  /**
  * timed block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#timed WafCustomWhiteRule#timed}
  */
  readonly timed?: WafCustomWhiteRuleJobDateTimeTimed[] | cdktf.IResolvable;
}

export function wafCustomWhiteRuleJobDateTimeToTerraform(struct?: WafCustomWhiteRuleJobDateTimeOutputReference | WafCustomWhiteRuleJobDateTime): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    ...
    cron: cdktf.listMapper(wafCustomWhiteRuleJobDateTimeCronToTerraform, true)(struct!.cron),
    timed: cdktf.listMapper(wafCustomWhiteRuleJobDateTimeTimedToTerraform, true)(struct!.timed),
  }
}


export function wafCustomWhiteRuleJobDateTimeToHclTerraform(struct?: WafCustomWhiteRuleJobDateTimeOutputReference | WafCustomWhiteRuleJobDateTime): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    cron: {
      value: cdktf.listMapperHcl(wafCustomWhiteRuleJobDateTimeCronToHclTerraform, true)(struct!.cron),
      isBlock: true,
      type: "list",
      storageClassType: "WafCustomWhiteRuleJobDateTimeCronList",
    },
    timed: {
      value: cdktf.listMapperHcl(wafCustomWhiteRuleJobDateTimeTimedToHclTerraform, true)(struct!.timed),
      isBlock: true,
      type: "list",
      storageClassType: "WafCustomWhiteRuleJobDateTimeTimedList",
    },
  };
...
export class WafCustomWhiteRuleJobDateTimeOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): WafCustomWhiteRuleJobDateTime | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: WafCustomWhiteRuleJobDateTime | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _cron = new WafCustomWhiteRuleJobDateTimeCronList(this, "cron", false);
  public get cron() {
    return this._cron;
  }
  public putCron(value: WafCustomWhiteRuleJobDateTimeCron[] | cdktf.IResolvable) {
  ...
  private _timed = new WafCustomWhiteRuleJobDateTimeTimedList(this, "timed", false);
  public get timed() {
    return this._timed;
  }
  public putTimed(value: WafCustomWhiteRuleJobDateTimeTimed[] | cdktf.IResolvable) {
...
export interface WafCustomWhiteRuleStrategies {
  /**
  * Matching parameter
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#arg WafCustomWhiteRule#arg}
  */
  readonly arg: string;
  /**
  * 0: case-sensitive, 1: case-insensitive. Note: This field may return null, indicating that no valid values can be obtained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#case_not_sensitive WafCustomWhiteRule#case_not_sensitive}
  */
  ...
  *                         Note: This field may return null, indicating that no valid values can be obtained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#compare_func WafCustomWhiteRule#compare_func}
  */
  ...
  *                         Note: This field may return null, indicating that no valid values can be obtained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#content WafCustomWhiteRule#content}
  */
  ...
  *           	  				Note: This field may return null, indicating that no valid values can be obtained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#field WafCustomWhiteRule#field}
  */
  readonly field: string;
}

export function wafCustomWhiteRuleStrategiesToTerraform(struct?: WafCustomWhiteRuleStrategies | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function wafCustomWhiteRuleStrategiesToHclTerraform(struct?: WafCustomWhiteRuleStrategies | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class WafCustomWhiteRuleStrategiesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): WafCustomWhiteRuleStrategies | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: WafCustomWhiteRuleStrategies | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._arg = undefined;
...
export class WafCustomWhiteRuleStrategiesList extends cdktf.ComplexList {
  public internalValue? : WafCustomWhiteRuleStrategies[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): WafCustomWhiteRuleStrategiesOutputReference {
    return new WafCustomWhiteRuleStrategiesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule tencentcloud_waf_custom_white_rule}
*/
export class WafCustomWhiteRule extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "tencentcloud_waf_custom_white_rule";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a WafCustomWhiteRule resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the WafCustomWhiteRule to import
  * @param importFromId The id of the existing WafCustomWhiteRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the WafCustomWhiteRule to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "tencentcloud_waf_custom_white_rule", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_custom_white_rule tencentcloud_waf_custom_white_rule} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options WafCustomWhiteRuleConfig
  */
  public constructor(scope: Construct, id: string, config: WafCustomWhiteRuleConfig) {
    super(scope, id, {
      terraformResourceType: 'tencentcloud_waf_custom_white_rule',
  ...
  private _jobDateTime = new WafCustomWhiteRuleJobDateTimeOutputReference(this, "job_date_time");
  public get jobDateTime() {
    return this._jobDateTime;
  }
  public putJobDateTime(value: WafCustomWhiteRuleJobDateTime) {
  ...
  private _strategies = new WafCustomWhiteRuleStrategiesList(this, "strategies", false);
  public get strategies() {
    return this._strategies;
  }
  public putStrategies(value: WafCustomWhiteRuleStrategies[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      job_date_time: wafCustomWhiteRuleJobDateTimeToTerraform(this._jobDateTime.internalValue),
      strategies: cdktf.listMapper(wafCustomWhiteRuleStrategiesToTerraform, true)(this._strategies.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      job_date_time: {
        value: wafCustomWhiteRuleJobDateTimeToHclTerraform(this._jobDateTime.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "WafCustomWhiteRuleJobDateTimeList",
      },
      strategies: {
        value: cdktf.listMapperHcl(wafCustomWhiteRuleStrategiesToHclTerraform, true)(this._strategies.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "WafCustomWhiteRuleStrategiesList",
      },
    };
