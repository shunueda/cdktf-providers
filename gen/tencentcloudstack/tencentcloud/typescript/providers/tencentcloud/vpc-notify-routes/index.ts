// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_notify_routes
...
export interface VpcNotifyRoutesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_notify_routes#id VpcNotifyRoutes#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_notify_routes#route_item_ids VpcNotifyRoutes#route_item_ids}
  */
  readonly routeItemIds: string[];
  /**
  * The unique ID of the routing table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_notify_routes#route_table_id VpcNotifyRoutes#route_table_id}
  */
  readonly routeTableId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_notify_routes tencentcloud_vpc_notify_routes}
*/
export class VpcNotifyRoutes extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcNotifyRoutes that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_notify_routes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/vpc_notify_routes tencentcloud_vpc_notify_routes} Resource
  *
  * @param scope The scope in which to define this construct
