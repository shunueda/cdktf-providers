// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cls_cloud_product_log_task
...
export interface ClsCloudProductLogTaskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cls_cloud_product_log_task#assumer_name ClsCloudProductLogTask#assumer_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cls_cloud_product_log_task#cloud_product_region ClsCloudProductLogTask#cloud_product_region}
  */
  readonly cloudProductRegion: string;
  /**
  * CLS target region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cls_cloud_product_log_task#cls_region ClsCloudProductLogTask#cls_region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cls_cloud_product_log_task#extend ClsCloudProductLogTask#extend}
  */
  readonly extend?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cls_cloud_product_log_task#id ClsCloudProductLogTask#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cls_cloud_product_log_task#instance_id ClsCloudProductLogTask#instance_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cls_cloud_product_log_task#log_type ClsCloudProductLogTask#log_type}
  */
  readonly logType: string;
  /**
  * Log set name, it will be automatically created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cls_cloud_product_log_task#logset_name ClsCloudProductLogTask#logset_name}
  */
  readonly logsetName?: string;
  /**
  * The name of the log topic, it will be automatically created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cls_cloud_product_log_task#topic_name ClsCloudProductLogTask#topic_name}
  */
  readonly topicName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cls_cloud_product_log_task tencentcloud_cls_cloud_product_log_task}
*/
export class ClsCloudProductLogTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClsCloudProductLogTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cls_cloud_product_log_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cls_cloud_product_log_task tencentcloud_cls_cloud_product_log_task} Resource
  *
  * @param scope The scope in which to define this construct
