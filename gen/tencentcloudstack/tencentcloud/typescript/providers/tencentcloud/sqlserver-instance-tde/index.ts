// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/sqlserver_instance_tde
...
export interface SqlserverInstanceTdeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/sqlserver_instance_tde#certificate_attribution SqlserverInstanceTde#certificate_attribution}
  */
  readonly certificateAttribution: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/sqlserver_instance_tde#id SqlserverInstanceTde#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/sqlserver_instance_tde#instance_id SqlserverInstanceTde#instance_id}
  */
  readonly instanceId: string;
  /**
  * Other referenced main account IDs, required when CertificateAttribute is others.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/sqlserver_instance_tde#quote_uin SqlserverInstanceTde#quote_uin}
  */
  readonly quoteUin?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/sqlserver_instance_tde tencentcloud_sqlserver_instance_tde}
*/
export class SqlserverInstanceTde extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlserverInstanceTde that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/sqlserver_instance_tde#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/sqlserver_instance_tde tencentcloud_sqlserver_instance_tde} Resource
  *
  * @param scope The scope in which to define this construct
