// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_sync_devices_to_ioa_operation
...
export interface BhSyncDevicesToIoaOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_sync_devices_to_ioa_operation#device_id_set BhSyncDevicesToIoaOperation#device_id_set}
  */
  readonly deviceIdSet: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_sync_devices_to_ioa_operation#id BhSyncDevicesToIoaOperation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_sync_devices_to_ioa_operation tencentcloud_bh_sync_devices_to_ioa_operation}
*/
export class BhSyncDevicesToIoaOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BhSyncDevicesToIoaOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_sync_devices_to_ioa_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_sync_devices_to_ioa_operation tencentcloud_bh_sync_devices_to_ioa_operation} Resource
  *
  * @param scope The scope in which to define this construct
