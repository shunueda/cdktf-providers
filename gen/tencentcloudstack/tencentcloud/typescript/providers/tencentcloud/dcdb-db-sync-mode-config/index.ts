// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/dcdb_db_sync_mode_config
...
export interface DcdbDbSyncModeConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/dcdb_db_sync_mode_config#id DcdbDbSyncModeConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/dcdb_db_sync_mode_config#instance_id DcdbDbSyncModeConfig#instance_id}
  */
  readonly instanceId: string;
  /**
  * Sync mode. Valid values: `0` (async), `1` (strong sync), `2` (downgradable strong sync).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/dcdb_db_sync_mode_config#sync_mode DcdbDbSyncModeConfig#sync_mode}
  */
  readonly syncMode: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/dcdb_db_sync_mode_config tencentcloud_dcdb_db_sync_mode_config}
*/
export class DcdbDbSyncModeConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DcdbDbSyncModeConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/dcdb_db_sync_mode_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/dcdb_db_sync_mode_config tencentcloud_dcdb_db_sync_mode_config} Resource
  *
  * @param scope The scope in which to define this construct
