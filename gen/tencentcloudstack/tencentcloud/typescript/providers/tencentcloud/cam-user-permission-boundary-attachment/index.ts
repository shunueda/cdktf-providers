// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user_permission_boundary_attachment
...
export interface CamUserPermissionBoundaryAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user_permission_boundary_attachment#id CamUserPermissionBoundaryAttachment#id}
  *
  ...
  * Policy ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user_permission_boundary_attachment#policy_id CamUserPermissionBoundaryAttachment#policy_id}
  */
  readonly policyId: number;
  /**
  * Sub account Uin.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user_permission_boundary_attachment#target_uin CamUserPermissionBoundaryAttachment#target_uin}
  */
  readonly targetUin: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user_permission_boundary_attachment tencentcloud_cam_user_permission_boundary_attachment}
*/
export class CamUserPermissionBoundaryAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CamUserPermissionBoundaryAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user_permission_boundary_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cam_user_permission_boundary_attachment tencentcloud_cam_user_permission_boundary_attachment} Resource
  *
  * @param scope The scope in which to define this construct
