// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_scim_synchronization_status
...
export interface IdentityCenterScimSynchronizationStatusConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_scim_synchronization_status#id IdentityCenterScimSynchronizationStatus#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_scim_synchronization_status#scim_synchronization_status IdentityCenterScimSynchronizationStatus#scim_synchronization_status}
  */
  readonly scimSynchronizationStatus: string;
  /**
  * Space ID. z-prefix starts with 12 random digits/lowercase letters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_scim_synchronization_status#zone_id IdentityCenterScimSynchronizationStatus#zone_id}
  */
  readonly zoneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_scim_synchronization_status tencentcloud_identity_center_scim_synchronization_status}
*/
export class IdentityCenterScimSynchronizationStatus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityCenterScimSynchronizationStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_scim_synchronization_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_scim_synchronization_status tencentcloud_identity_center_scim_synchronization_status} Resource
  *
  * @param scope The scope in which to define this construct
