// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance
...
export interface SqlserverInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#auto_renew SqlserverInstance#auto_renew}
  */
  readonly autoRenew?: number;
  /**
  * Whether to use the voucher automatically; 1 for yes, 0 for no, the default is 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#auto_voucher SqlserverInstance#auto_voucher}
  */
  readonly autoVoucher?: number;
  /**
  * Availability zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#availability_zone SqlserverInstance#availability_zone}
  */
  readonly availabilityZone?: string;
  /**
  * Pay type of the SQL Server instance. Available values `PREPAID`, `POSTPAID_BY_HOUR`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#charge_type SqlserverInstance#charge_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#engine_version SqlserverInstance#engine_version}
  */
  readonly engineVersion?: string;
  /**
  * Instance type. `DUAL` (dual-server high availability), `CLUSTER` (cluster). Default is `DUAL`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#ha_type SqlserverInstance#ha_type}
  */
  readonly haType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#id SqlserverInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#maintenance_start_time SqlserverInstance#maintenance_start_time}
  */
  readonly maintenanceStartTime?: string;
  /**
  * The timespan of maintenance in one day, unit is hour.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#maintenance_time_span SqlserverInstance#maintenance_time_span}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#maintenance_week_set SqlserverInstance#maintenance_week_set}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#memory SqlserverInstance#memory}
  */
  readonly memory: number;
  /**
  * Indicate whether to deploy across availability zones.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#multi_zones SqlserverInstance#multi_zones}
  */
  readonly multiZones?: boolean | cdktf.IResolvable;
  /**
  * Name of the SQL Server instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#name SqlserverInstance#name}
  */
  readonly name: string;
  /**
  * Purchase instance period in month. The value does not exceed 48.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#period SqlserverInstance#period}
  */
  readonly period?: number;
  /**
  * Project ID, default value is 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#project_id SqlserverInstance#project_id}
  */
  readonly projectId?: number;
  /**
  * Security group bound to the instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#security_groups SqlserverInstance#security_groups}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#storage SqlserverInstance#storage}
  */
  readonly storage: number;
  /**
  * ID of subnet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#subnet_id SqlserverInstance#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * The tags of the SQL Server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#tags SqlserverInstance#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * System time zone, default: `China Standard Time`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#time_zone SqlserverInstance#time_zone}
  */
  readonly timeZone?: string;
  /**
  * An array of voucher IDs, currently only one can be used for a single order.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#voucher_ids SqlserverInstance#voucher_ids}
  */
  readonly voucherIds?: string[];
  /**
  * ID of VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#vpc_id SqlserverInstance#vpc_id}
  */
  readonly vpcId?: string;
  /**
  * The way to execute the allocation. Supported values include: 0 - execute immediately, 1 - execute in maintenance window.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#wait_switch SqlserverInstance#wait_switch}
  */
  readonly waitSwitch?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance tencentcloud_sqlserver_instance}
*/
export class SqlserverInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlserverInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_instance tencentcloud_sqlserver_instance} Resource
  *
  * @param scope The scope in which to define this construct
