// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/cvm_program_fpga_image
...
export interface CvmProgramFpgaImageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/cvm_program_fpga_image#dbd_fs CvmProgramFpgaImage#dbd_fs}
  */
  readonly dbdFs?: string[];
  /**
  * Trial run, will not perform the actual burning action, the default is False.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/cvm_program_fpga_image#dry_run CvmProgramFpgaImage#dry_run}
  */
  readonly dryRun?: boolean | cdktf.IResolvable;
  /**
  * COS URL address of the FPGA image file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/cvm_program_fpga_image#fpga_url CvmProgramFpgaImage#fpga_url}
  */
  readonly fpgaUrl: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/cvm_program_fpga_image#id CvmProgramFpgaImage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/cvm_program_fpga_image#instance_id CvmProgramFpgaImage#instance_id}
  */
  readonly instanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/cvm_program_fpga_image tencentcloud_cvm_program_fpga_image}
*/
export class CvmProgramFpgaImage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CvmProgramFpgaImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/cvm_program_fpga_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/cvm_program_fpga_image tencentcloud_cvm_program_fpga_image} Resource
  *
  * @param scope The scope in which to define this construct
