// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc
...
export interface WafCcConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#action_type WafCc#action_type}
  */
  readonly actionType: string;
  /**
  * Advanced mode (whether to use session detection). 0(disabled) 1(enabled).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#advance WafCc#advance}
  */
  readonly advance: string;
  /**
  * Cel expression.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#cel_rule WafCc#cel_rule}
  */
  readonly celRule?: string;
  /**
  * Domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#domain WafCc#domain}
  */
  readonly domain: string;
  /**
  * WAF edition. clb-waf means clb-waf, sparta-waf means saas-waf.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#edition WafCc#edition}
  */
  readonly edition: string;
  /**
  * Event ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#event_id WafCc#event_id}
  */
  readonly eventId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#id WafCc#id}
  *
  ...
  * CC detection cycle.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#interval WafCc#interval}
  */
  readonly interval: string;
  /**
  * CC detection threshold.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#limit WafCc#limit}
  */
  readonly limit: string;
  /**
  * Frequency limiting method.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#limit_method WafCc#limit_method}
  */
  readonly limitMethod?: string;
  /**
  * Logical operator of configuration mode, and/or.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#logical_op WafCc#logical_op}
  */
  readonly logicalOp?: string;
  /**
  * Match method, 0(equal), 1(prefix), 2(contains), 3(not equal), 6(suffix), 7(not contains).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#match_func WafCc#match_func}
  */
  readonly matchFunc: number;
  /**
  * Rule Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#name WafCc#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#options_arr WafCc#options_arr}
  */
  readonly optionsArr?: string;
  /**
  * Rule Priority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#priority WafCc#priority}
  */
  readonly priority: number;
  /**
  * Session ID that needs to be enabled for the rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#session_applied WafCc#session_applied}
  */
  readonly sessionApplied?: number[];
  /**
  * Rule Status, 0 rule close, 1 rule open.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#status WafCc#status}
  */
  readonly status: number;
  /**
  * Operate Type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#type WafCc#type}
  */
  readonly type?: number;
  /**
  * Detection URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#url WafCc#url}
  */
  readonly url: string;
  /**
  * Action ValidTime, minute unit. Min: 60, Max: 604800.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#valid_time WafCc#valid_time}
  */
  readonly validTime: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc tencentcloud_waf_cc}
*/
export class WafCc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafCc that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_cc tencentcloud_waf_cc} Resource
  *
  * @param scope The scope in which to define this construct
