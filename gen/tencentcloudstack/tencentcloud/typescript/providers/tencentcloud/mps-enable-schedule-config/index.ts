// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mps_enable_schedule_config
...
export interface MpsEnableScheduleConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mps_enable_schedule_config#enabled MpsEnableScheduleConfig#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mps_enable_schedule_config#id MpsEnableScheduleConfig#id}
  *
  ...
  * The scheme ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mps_enable_schedule_config#schedule_id MpsEnableScheduleConfig#schedule_id}
  */
  readonly scheduleId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mps_enable_schedule_config tencentcloud_mps_enable_schedule_config}
*/
export class MpsEnableScheduleConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MpsEnableScheduleConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mps_enable_schedule_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/mps_enable_schedule_config tencentcloud_mps_enable_schedule_config} Resource
  *
  * @param scope The scope in which to define this construct
