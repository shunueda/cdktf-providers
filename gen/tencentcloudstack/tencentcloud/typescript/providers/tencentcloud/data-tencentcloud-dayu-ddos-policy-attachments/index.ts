// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dayu_ddos_policy_attachments
...
export interface DataTencentcloudDayuDdosPolicyAttachmentsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dayu_ddos_policy_attachments#id DataTencentcloudDayuDdosPolicyAttachments#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dayu_ddos_policy_attachments#policy_id DataTencentcloudDayuDdosPolicyAttachments#policy_id}
  */
  readonly policyId?: string;
  /**
  * ID of the attached resource to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dayu_ddos_policy_attachments#resource_id DataTencentcloudDayuDdosPolicyAttachments#resource_id}
  */
  readonly resourceId?: string;
  /**
  * Type of the resource that the DDoS policy works for, valid values are `bgpip`, `bgp`, `bgp-multip` and `net`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dayu_ddos_policy_attachments#resource_type DataTencentcloudDayuDdosPolicyAttachments#resource_type}
  */
  readonly resourceType: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dayu_ddos_policy_attachments#result_output_file DataTencentcloudDayuDdosPolicyAttachments#result_output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dayu_ddos_policy_attachments tencentcloud_dayu_ddos_policy_attachments}
*/
export class DataTencentcloudDayuDdosPolicyAttachments extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudDayuDdosPolicyAttachments that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dayu_ddos_policy_attachments#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dayu_ddos_policy_attachments tencentcloud_dayu_ddos_policy_attachments} Data Source
  *
  * @param scope The scope in which to define this construct
