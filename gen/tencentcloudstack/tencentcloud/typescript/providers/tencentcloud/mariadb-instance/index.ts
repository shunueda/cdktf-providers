// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance
...
export interface MariadbInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#auto_renew_flag MariadbInstance#auto_renew_flag}
  */
  readonly autoRenewFlag?: number;
  /**
  * Whether to automatically use the voucher for payment, the default is not used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#auto_voucher MariadbInstance#auto_voucher}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#db_version_id MariadbInstance#db_version_id}
  */
  readonly dbVersionId?: string;
  /**
  * DCN source instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#dcn_instance_id MariadbInstance#dcn_instance_id}
  */
  readonly dcnInstanceId?: string;
  /**
  * DCN source region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#dcn_region MariadbInstance#dcn_region}
  */
  readonly dcnRegion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#id MariadbInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#instance_name MariadbInstance#instance_name}
  */
  readonly instanceName?: string;
  /**
  * Whether IPv6 is supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#ipv6_flag MariadbInstance#ipv6_flag}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#memory MariadbInstance#memory}
  */
  readonly memory: number;
  /**
  * Number of nodes, 2 is one master and one slave, 3 is one master and two slaves.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#node_count MariadbInstance#node_count}
  */
  readonly nodeCount: number;
  /**
  * The duration of the purchase, unit: month.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#period MariadbInstance#period}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#project_id MariadbInstance#project_id}
  */
  readonly projectId?: number;
  /**
  * Security group ID list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#security_group_ids MariadbInstance#security_group_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#storage MariadbInstance#storage}
  */
  readonly storage: number;
  /**
  * Virtual private network subnet ID, required when VpcId is not empty.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#subnet_id MariadbInstance#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * tag list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#tags MariadbInstance#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Intranet IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#vip MariadbInstance#vip}
  */
  readonly vip?: string;
  /**
  * A list of voucher IDs. Currently, only one voucher can be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#voucher_ids MariadbInstance#voucher_ids}
  */
  readonly voucherIds?: string[];
  /**
  * Virtual private network ID, if not passed, it means that it is created as a basic network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#vpc_id MariadbInstance#vpc_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#zones MariadbInstance#zones}
  */
  readonly zones: string[];
  /**
  * init_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#init_params MariadbInstance#init_params}
  */
...
export interface MariadbInstanceInitParams {
  ...
  * parameter name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#param MariadbInstance#param}
  */
  readonly param: string;
  /**
  * parameter value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#value MariadbInstance#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance tencentcloud_mariadb_instance}
*/
export class MariadbInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MariadbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mariadb_instance tencentcloud_mariadb_instance} Resource
  *
  * @param scope The scope in which to define this construct
