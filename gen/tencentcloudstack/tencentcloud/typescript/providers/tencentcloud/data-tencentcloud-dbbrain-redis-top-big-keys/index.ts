// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/dbbrain_redis_top_big_keys
...
export interface DataTencentcloudDbbrainRedisTopBigKeysConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/dbbrain_redis_top_big_keys#date DataTencentcloudDbbrainRedisTopBigKeys#date}
  */
  readonly date: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/dbbrain_redis_top_big_keys#id DataTencentcloudDbbrainRedisTopBigKeys#id}
  *
  ...
  * instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/dbbrain_redis_top_big_keys#instance_id DataTencentcloudDbbrainRedisTopBigKeys#instance_id}
  */
  readonly instanceId: string;
  /**
  * Key type filter condition, the default is no filter, the value includes `string`, `list`, `set`, `hash`, `sortedset`, `stream`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/dbbrain_redis_top_big_keys#key_type DataTencentcloudDbbrainRedisTopBigKeys#key_type}
  */
  readonly keyType?: string;
  /**
  * Service product type, supported values include `redis` - cloud database Redis.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/dbbrain_redis_top_big_keys#product DataTencentcloudDbbrainRedisTopBigKeys#product}
  */
  readonly product: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/dbbrain_redis_top_big_keys#result_output_file DataTencentcloudDbbrainRedisTopBigKeys#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Sorting field, the value includes `Capacity` - memory, `ItemCount` - number of elements, the default is `Capacity`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/dbbrain_redis_top_big_keys#sort_by DataTencentcloudDbbrainRedisTopBigKeys#sort_by}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/dbbrain_redis_top_big_keys tencentcloud_dbbrain_redis_top_big_keys}
*/
export class DataTencentcloudDbbrainRedisTopBigKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudDbbrainRedisTopBigKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/dbbrain_redis_top_big_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/dbbrain_redis_top_big_keys tencentcloud_dbbrain_redis_top_big_keys} Data Source
  *
  * @param scope The scope in which to define this construct
