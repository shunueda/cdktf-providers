// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance
...
export interface DcInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#access_point_id DcInstance#access_point_id}
  */
  readonly accessPointId: string;
  /**
  * Connection port bandwidth in Mbps. Value range: [2,10240]. Default value: 1000.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#bandwidth DcInstance#bandwidth}
  */
  readonly bandwidth?: number;
  /**
  * Circuit code of a connection, which is provided by the ISP or connection provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#circuit_code DcInstance#circuit_code}
  */
  readonly circuitCode?: string;
  /**
  * User-side IP address for connection debugging, which is automatically assigned by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#customer_address DcInstance#customer_address}
  */
  readonly customerAddress?: string;
  /**
  * Email address of connection applicant, which is obtained from the account system by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#customer_contact_mail DcInstance#customer_contact_mail}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#customer_contact_number DcInstance#customer_contact_number}
  */
  readonly customerContactNumber?: string;
  /**
  * Name of connection applicant, which is obtained from the account system by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#customer_name DcInstance#customer_name}
  */
  readonly customerName?: string;
  /**
  * Connection name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#direct_connect_name DcInstance#direct_connect_name}
  */
  readonly directConnectName: string;
  /**
  * Fault reporting contact number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#fault_report_contact_number DcInstance#fault_report_contact_number}
  */
  readonly faultReportContactNumber?: string;
  /**
  * Fault reporting contact person.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#fault_report_contact_person DcInstance#fault_report_contact_person}
  */
  readonly faultReportContactPerson?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#id DcInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#line_operator DcInstance#line_operator}
  */
  readonly lineOperator: string;
  /**
  * Local IDC location.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#location DcInstance#location}
  */
  readonly location?: string;
  /**
  * Port type of connection. Valid values: 100Base-T (100-Megabit electrical Ethernet interface), 1000Base-T (1-Gigabit electrical Ethernet interface), 1000Base-LX (1-Gigabit single-module optical Ethernet interface; 10 KM), 10GBase-T (10-Gigabit electrical Ethernet interface), 10GBase-LR (10-Gigabit single-module optical Ethernet interface; 10 KM). Default value: 1000Base-LX.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#port_type DcInstance#port_type}
  */
  readonly portType: string;
  /**
  * ID of redundant connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#redundant_direct_connect_id DcInstance#redundant_direct_connect_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#sign_law DcInstance#sign_law}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#tencent_address DcInstance#tencent_address}
  */
  readonly tencentAddress?: string;
  /**
  * VLAN for connection debugging, which is enabled and automatically assigned by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#vlan DcInstance#vlan}
  */
  readonly vlan?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance tencentcloud_dc_instance}
*/
export class DcInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DcInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/dc_instance tencentcloud_dc_instance} Resource
  *
  * @param scope The scope in which to define this construct
