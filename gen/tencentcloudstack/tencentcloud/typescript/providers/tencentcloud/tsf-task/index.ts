// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task
...
export interface TsfTaskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#execute_type TsfTask#execute_type}
  */
  readonly executeType: string;
  /**
  * deployment group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#group_id TsfTask#group_id}
  */
  readonly groupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#id TsfTask#id}
  *
  ...
  * Program id list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#program_id_list TsfTask#program_id_list}
  */
  readonly programIdList?: string[];
  /**
  * number of retries, 0 &amp;lt;= RetryCount&amp;lt;= 10.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#retry_count TsfTask#retry_count}
  */
  readonly retryCount?: number;
  /**
  * retry interval, 0 &amp;lt;= RetryInterval &amp;lt;= 600000, time unit ms.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#retry_interval TsfTask#retry_interval}
  */
  readonly retryInterval?: number;
  /**
  * number of shards.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#shard_count TsfTask#shard_count}
  */
  readonly shardCount?: number;
  /**
  * the operator to judge the success of the task.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#success_operator TsfTask#success_operator}
  */
  readonly successOperator?: string;
  /**
  * The threshold for judging the success rate of the task, such as 100.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#success_ratio TsfTask#success_ratio}
  */
  readonly successRatio?: string;
  /**
  * task parameters, the length limit is 10000 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#task_argument TsfTask#task_argument}
  */
  readonly taskArgument?: string;
  /**
  * task content, length limit 65536 bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#task_content TsfTask#task_content}
  */
  readonly taskContent: string;
  /**
  * task name, task length 64 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#task_name TsfTask#task_name}
  */
  readonly taskName: string;
  /**
  * task type, java.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#task_type TsfTask#task_type}
  */
  readonly taskType: string;
  /**
  * task timeout, time unit ms.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#time_out TsfTask#time_out}
  */
  readonly timeOut: number;
  /**
  * advance_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#advance_settings TsfTask#advance_settings}
  */
  readonly advanceSettings?: TsfTaskAdvanceSettings;
  /**
  * shard_arguments block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#shard_arguments TsfTask#shard_arguments}
  */
  readonly shardArguments?: TsfTaskShardArguments[] | cdktf.IResolvable;
  /**
  * task_rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#task_rule TsfTask#task_rule}
  */
...
export interface TsfTaskAdvanceSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#sub_task_concurrency TsfTask#sub_task_concurrency}
  */
...
export interface TsfTaskShardArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#shard_key TsfTask#shard_key}
  */
  readonly shardKey: number;
  /**
  * Shard parameter VALUE.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#shard_value TsfTask#shard_value}
  */
...
export interface TsfTaskTaskRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#expression TsfTask#expression}
  */
  readonly expression?: string;
  /**
  * time interval, in milliseconds.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#repeat_interval TsfTask#repeat_interval}
  */
  readonly repeatInterval?: number;
  /**
  * trigger rule type, Cron/Repeat.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#rule_type TsfTask#rule_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task tencentcloud_tsf_task}
*/
export class TsfTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TsfTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_task tencentcloud_tsf_task} Resource
  *
  * @param scope The scope in which to define this construct
