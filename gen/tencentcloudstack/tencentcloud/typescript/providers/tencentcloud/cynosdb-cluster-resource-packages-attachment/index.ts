// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cynosdb_cluster_resource_packages_attachment
...
export interface CynosdbClusterResourcePackagesAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  * Cluster ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cynosdb_cluster_resource_packages_attachment#cluster_id CynosdbClusterResourcePackagesAttachment#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cynosdb_cluster_resource_packages_attachment#id CynosdbClusterResourcePackagesAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cynosdb_cluster_resource_packages_attachment#package_ids CynosdbClusterResourcePackagesAttachment#package_ids}
  */
  readonly packageIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cynosdb_cluster_resource_packages_attachment tencentcloud_cynosdb_cluster_resource_packages_attachment}
*/
export class CynosdbClusterResourcePackagesAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CynosdbClusterResourcePackagesAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cynosdb_cluster_resource_packages_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cynosdb_cluster_resource_packages_attachment tencentcloud_cynosdb_cluster_resource_packages_attachment} Resource
  *
  * @param scope The scope in which to define this construct
