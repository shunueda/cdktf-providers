// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/oceanus_job
...
export interface OceanusJobConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/oceanus_job#cluster_id OceanusJob#cluster_id}
  */
  readonly clusterId?: string;
  /**
  * The type of the cluster. 1 indicates shared cluster, and 2 indicates exclusive cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/oceanus_job#cluster_type OceanusJob#cluster_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/oceanus_job#cu_mem OceanusJob#cu_mem}
  */
  readonly cuMem?: number;
  /**
  * The Flink version that the job runs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/oceanus_job#flink_version OceanusJob#flink_version}
  */
  readonly flinkVersion?: string;
  /**
  * The folder ID to which the job name belongs. The root directory is root.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/oceanus_job#folder_id OceanusJob#folder_id}
  */
  readonly folderId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/oceanus_job#id OceanusJob#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/oceanus_job#job_type OceanusJob#job_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/oceanus_job#name OceanusJob#name}
  */
  readonly name: string;
  /**
  * The remark information of the job. It can be set arbitrarily.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/oceanus_job#remark OceanusJob#remark}
  */
  readonly remark?: string;
  /**
  * The workspace SerialId.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/oceanus_job#work_space_id OceanusJob#work_space_id}
  */
  readonly workSpaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/oceanus_job tencentcloud_oceanus_job}
*/
export class OceanusJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OceanusJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/oceanus_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/oceanus_job tencentcloud_oceanus_job} Resource
  *
  * @param scope The scope in which to define this construct
