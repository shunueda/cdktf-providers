// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dayu_eip
...
export interface DayuEipConfig extends cdktf.TerraformMetaArguments {
  ...
  * Resource id to bind.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dayu_eip#bind_resource_id DayuEip#bind_resource_id}
  */
  readonly bindResourceId: string;
  /**
  * Resource region to bind.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dayu_eip#bind_resource_region DayuEip#bind_resource_region}
  */
  readonly bindResourceRegion: string;
  /**
  * Resource type to bind, value range [`clb`, `cvm`].
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dayu_eip#bind_resource_type DayuEip#bind_resource_type}
  */
  readonly bindResourceType: string;
  /**
  * Eip of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dayu_eip#eip DayuEip#eip}
  */
  readonly eip: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dayu_eip#id DayuEip#id}
  *
  ...
  * ID of the resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dayu_eip#resource_id DayuEip#resource_id}
  */
  readonly resourceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dayu_eip tencentcloud_dayu_eip}
*/
export class DayuEip extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DayuEip that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dayu_eip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dayu_eip tencentcloud_dayu_eip} Resource
  *
  * @param scope The scope in which to define this construct
