// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpc_resume_snapshot_instance
...
export interface VpcResumeSnapshotInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpc_resume_snapshot_instance#id VpcResumeSnapshotInstance#id}
  *
  ...
  * InstanceId.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpc_resume_snapshot_instance#instance_id VpcResumeSnapshotInstance#instance_id}
  */
  readonly instanceId: string;
  /**
  * Snapshot file Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpc_resume_snapshot_instance#snapshot_file_id VpcResumeSnapshotInstance#snapshot_file_id}
  */
  readonly snapshotFileId: string;
  /**
  * Snapshot policy Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpc_resume_snapshot_instance#snapshot_policy_id VpcResumeSnapshotInstance#snapshot_policy_id}
  */
  readonly snapshotPolicyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpc_resume_snapshot_instance tencentcloud_vpc_resume_snapshot_instance}
*/
export class VpcResumeSnapshotInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcResumeSnapshotInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpc_resume_snapshot_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpc_resume_snapshot_instance tencentcloud_vpc_resume_snapshot_instance} Resource
  *
  * @param scope The scope in which to define this construct
