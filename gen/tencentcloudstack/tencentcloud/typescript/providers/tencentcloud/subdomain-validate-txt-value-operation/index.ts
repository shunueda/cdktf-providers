// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/subdomain_validate_txt_value_operation
...
export interface SubdomainValidateTxtValueOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/subdomain_validate_txt_value_operation#domain_zone SubdomainValidateTxtValueOperation#domain_zone}
  */
  readonly domainZone: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/subdomain_validate_txt_value_operation#id SubdomainValidateTxtValueOperation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/subdomain_validate_txt_value_operation tencentcloud_subdomain_validate_txt_value_operation}
*/
export class SubdomainValidateTxtValueOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SubdomainValidateTxtValueOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/subdomain_validate_txt_value_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/subdomain_validate_txt_value_operation tencentcloud_subdomain_validate_txt_value_operation} Resource
  *
  * @param scope The scope in which to define this construct
