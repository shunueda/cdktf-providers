// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/sqlserver_upload_backup_info
...
export interface DataTencentcloudSqlserverUploadBackupInfoConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/sqlserver_upload_backup_info#backup_migration_id DataTencentcloudSqlserverUploadBackupInfo#backup_migration_id}
  */
  readonly backupMigrationId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/sqlserver_upload_backup_info#id DataTencentcloudSqlserverUploadBackupInfo#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/sqlserver_upload_backup_info#instance_id DataTencentcloudSqlserverUploadBackupInfo#instance_id}
  */
  readonly instanceId: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/sqlserver_upload_backup_info#result_output_file DataTencentcloudSqlserverUploadBackupInfo#result_output_file}
  */
  readonly resultOutputFile?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/sqlserver_upload_backup_info tencentcloud_sqlserver_upload_backup_info}
*/
export class DataTencentcloudSqlserverUploadBackupInfo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudSqlserverUploadBackupInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/sqlserver_upload_backup_info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/sqlserver_upload_backup_info tencentcloud_sqlserver_upload_backup_info} Data Source
  *
  * @param scope The scope in which to define this construct
