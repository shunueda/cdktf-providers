// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dlc_user_vpc_connection
...
export interface DlcUserVpcConnectionConfig extends cdktf.TerraformMetaArguments {
  ...
  * Engine network ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dlc_user_vpc_connection#engine_network_id DlcUserVpcConnection#engine_network_id}
  */
  readonly engineNetworkId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dlc_user_vpc_connection#id DlcUserVpcConnection#id}
  *
  ...
  * User subnet ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dlc_user_vpc_connection#user_subnet_id DlcUserVpcConnection#user_subnet_id}
  */
  readonly userSubnetId: string;
  /**
  * User vpc endpoint name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dlc_user_vpc_connection#user_vpc_endpoint_name DlcUserVpcConnection#user_vpc_endpoint_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dlc_user_vpc_connection#user_vpc_endpoint_vip DlcUserVpcConnection#user_vpc_endpoint_vip}
  */
  readonly userVpcEndpointVip?: string;
  /**
  * User vpc ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dlc_user_vpc_connection#user_vpc_id DlcUserVpcConnection#user_vpc_id}
  */
  readonly userVpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dlc_user_vpc_connection tencentcloud_dlc_user_vpc_connection}
*/
export class DlcUserVpcConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DlcUserVpcConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dlc_user_vpc_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dlc_user_vpc_connection tencentcloud_dlc_user_vpc_connection} Resource
  *
  * @param scope The scope in which to define this construct
