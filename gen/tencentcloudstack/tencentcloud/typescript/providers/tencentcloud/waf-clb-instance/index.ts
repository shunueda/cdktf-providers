// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/waf_clb_instance
...
export interface WafClbInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/waf_clb_instance#api_security WafClbInstance#api_security}
  */
  readonly apiSecurity?: number;
  /**
  * Auto renew flag, 1: enable, 0: disable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/waf_clb_instance#auto_renew_flag WafClbInstance#auto_renew_flag}
  */
  readonly autoRenewFlag?: number;
  /**
  * Whether to purchase Bot management, 1: yes, 0: no. Default is 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/waf_clb_instance#bot_management WafClbInstance#bot_management}
  */
  readonly botManagement?: number;
  /**
  * Is elastic billing enabled, 1: enable, 0: disable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/waf_clb_instance#elastic_mode WafClbInstance#elastic_mode}
  */
  readonly elasticMode?: number;
  /**
  * Billing order parameters. support: premium_clb, enterprise_clb, ultimate_clb.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/waf_clb_instance#goods_category WafClbInstance#goods_category}
  */
  readonly goodsCategory: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/waf_clb_instance#id WafClbInstance#id}
  *
  ...
  * Waf instance name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/waf_clb_instance#instance_name WafClbInstance#instance_name}
  */
  readonly instanceName?: string;
  /**
  * QPS Limit, Minimum setting 10000. Only `elastic_mode` is 1, can be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/waf_clb_instance#qps_limit WafClbInstance#qps_limit}
  */
  readonly qpsLimit?: number;
  /**
  * Time interval.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/waf_clb_instance#time_span WafClbInstance#time_span}
  */
  readonly timeSpan?: number;
  /**
  * Time unit, support d, m, y. d: day, m: month, y: year.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/waf_clb_instance#time_unit WafClbInstance#time_unit}
  */
  readonly timeUnit?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/waf_clb_instance tencentcloud_waf_clb_instance}
*/
export class WafClbInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafClbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/waf_clb_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/waf_clb_instance tencentcloud_waf_clb_instance} Resource
  *
  * @param scope The scope in which to define this construct
