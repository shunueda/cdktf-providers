// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/rum_taw_instance
...
export interface DataTencentcloudRumTawInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  * Region ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/rum_taw_instance#area_ids DataTencentcloudRumTawInstance#area_ids}
  */
  readonly areaIds?: number[];
  /**
  * Billing status.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/rum_taw_instance#charge_statuses DataTencentcloudRumTawInstance#charge_statuses}
  */
  readonly chargeStatuses?: number[];
  /**
  * Billing type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/rum_taw_instance#charge_types DataTencentcloudRumTawInstance#charge_types}
  */
  readonly chargeTypes?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/rum_taw_instance#id DataTencentcloudRumTawInstance#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/rum_taw_instance#instance_ids DataTencentcloudRumTawInstance#instance_ids}
  */
  readonly instanceIds?: string[];
  /**
  * Instance status (`1`: creating; `2`: running; `3`: exceptional; `4`: restarting; `5`: stopping; `6`: stopped; `7`: terminating; `8`: terminated).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/rum_taw_instance#instance_statuses DataTencentcloudRumTawInstance#instance_statuses}
  */
  readonly instanceStatuses?: number[];
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/rum_taw_instance#result_output_file DataTencentcloudRumTawInstance#result_output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/rum_taw_instance tencentcloud_rum_taw_instance}
*/
export class DataTencentcloudRumTawInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudRumTawInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/rum_taw_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/rum_taw_instance tencentcloud_rum_taw_instance} Data Source
  *
  * @param scope The scope in which to define this construct
