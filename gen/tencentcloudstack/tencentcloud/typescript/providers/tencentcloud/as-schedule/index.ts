// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/as_schedule
...
export interface AsScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/as_schedule#desired_capacity AsSchedule#desired_capacity}
  */
  readonly desiredCapacity: number;
  /**
  * The time for this action to end, in "YYYY-MM-DDThh:mm:ss+08:00" format (UTC+8).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/as_schedule#end_time AsSchedule#end_time}
  */
  readonly endTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/as_schedule#id AsSchedule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/as_schedule#max_size AsSchedule#max_size}
  */
  readonly maxSize: number;
  /**
  * The minimum size for the Auto Scaling group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/as_schedule#min_size AsSchedule#min_size}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/as_schedule#recurrence AsSchedule#recurrence}
  */
  readonly recurrence?: string;
  /**
  * ID of a scaling group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/as_schedule#scaling_group_id AsSchedule#scaling_group_id}
  */
  readonly scalingGroupId: string;
  /**
  * The name of this scaling action.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/as_schedule#schedule_action_name AsSchedule#schedule_action_name}
  */
  readonly scheduleActionName: string;
  /**
  * The time for this action to start, in "YYYY-MM-DDThh:mm:ss+08:00" format (UTC+8).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/as_schedule#start_time AsSchedule#start_time}
  */
  readonly startTime: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/as_schedule tencentcloud_as_schedule}
*/
export class AsSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AsSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/as_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/as_schedule tencentcloud_as_schedule} Resource
  *
  * @param scope The scope in which to define this construct
