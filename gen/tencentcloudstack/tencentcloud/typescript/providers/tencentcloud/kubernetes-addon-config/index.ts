// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/kubernetes_addon_config
...
export interface KubernetesAddonConfigAConfig extends cdktf.TerraformMetaArguments {
  ...
  * Name of addon.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/kubernetes_addon_config#addon_name KubernetesAddonConfigA#addon_name}
  */
  readonly addonName: string;
  /**
  * Version of addon.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/kubernetes_addon_config#addon_version KubernetesAddonConfigA#addon_version}
  */
  readonly addonVersion?: string;
  /**
  * ID of cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/kubernetes_addon_config#cluster_id KubernetesAddonConfigA#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/kubernetes_addon_config#id KubernetesAddonConfigA#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/kubernetes_addon_config#raw_values KubernetesAddonConfigA#raw_values}
  */
  readonly rawValues?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/kubernetes_addon_config tencentcloud_kubernetes_addon_config}
*/
export class KubernetesAddonConfigA extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesAddonConfigA that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/kubernetes_addon_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/kubernetes_addon_config tencentcloud_kubernetes_addon_config} Resource
  *
  * @param scope The scope in which to define this construct
