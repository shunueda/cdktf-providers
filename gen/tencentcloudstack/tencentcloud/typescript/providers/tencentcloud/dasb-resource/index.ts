// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource
...
export interface DasbResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource#auto_renew_flag DasbResource#auto_renew_flag}
  */
  readonly autoRenewFlag: number;
  /**
  * Subnet segments that require service activation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource#cidr_block DasbResource#cidr_block}
  */
  readonly cidrBlock: string;
  /**
  * Deploy region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource#deploy_region DasbResource#deploy_region}
  */
  readonly deployRegion: string;
  /**
  * Deploy zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource#deploy_zone DasbResource#deploy_zone}
  */
  readonly deployZone: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource#id DasbResource#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource#package_bandwidth DasbResource#package_bandwidth}
  */
  readonly packageBandwidth?: number;
  /**
  * Resource type.Value:standard/pro.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource#resource_edition DasbResource#resource_edition}
  */
  readonly resourceEdition: string;
  /**
  * Number of resource nodes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource#resource_node DasbResource#resource_node}
  */
  readonly resourceNode: number;
  /**
  * Deploy resource subnetId.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource#subnet_id DasbResource#subnet_id}
  */
  readonly subnetId: string;
  /**
  * Billing time. This field is mandatory, with a minimum value of 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource#time_span DasbResource#time_span}
  */
  readonly timeSpan?: number;
  /**
  * Billing cycle, only support m: month. This field is mandatory, fill in m.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource#time_unit DasbResource#time_unit}
  */
  readonly timeUnit?: string;
  /**
  * The network segment corresponding to the VPC that requires service activation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource#vpc_cidr_block DasbResource#vpc_cidr_block}
  */
  readonly vpcCidrBlock: string;
  /**
  * Deploy resource vpcId.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource#vpc_id DasbResource#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource tencentcloud_dasb_resource}
*/
export class DasbResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DasbResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dasb_resource tencentcloud_dasb_resource} Resource
  *
  * @param scope The scope in which to define this construct
