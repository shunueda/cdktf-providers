// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/vpn_connection_reset
...
export interface VpnConnectionResetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/vpn_connection_reset#id VpnConnectionReset#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/vpn_connection_reset#vpn_connection_id VpnConnectionReset#vpn_connection_id}
  */
  readonly vpnConnectionId: string;
  /**
  * VPN GATEWAY INSTANCE ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/vpn_connection_reset#vpn_gateway_id VpnConnectionReset#vpn_gateway_id}
  */
  readonly vpnGatewayId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/vpn_connection_reset tencentcloud_vpn_connection_reset}
*/
export class VpnConnectionReset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnConnectionReset that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/vpn_connection_reset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/vpn_connection_reset tencentcloud_vpn_connection_reset} Resource
  *
  * @param scope The scope in which to define this construct
