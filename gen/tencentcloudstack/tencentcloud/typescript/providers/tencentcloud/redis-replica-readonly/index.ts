// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_replica_readonly
...
export interface RedisReplicaReadonlyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_replica_readonly#id RedisReplicaReadonly#id}
  *
  ...
  * The ID of instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_replica_readonly#instance_id RedisReplicaReadonly#instance_id}
  */
  readonly instanceId: string;
  /**
  * The replica is read-only, `enable` - enable read-write splitting, `disable`- disable read-write splitting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_replica_readonly#operate RedisReplicaReadonly#operate}
  */
  readonly operate: string;
  /**
  * Routing policy: Enter `master` or `replication`, which indicates the master node or slave node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_replica_readonly#readonly_policy RedisReplicaReadonly#readonly_policy}
  */
  readonly readonlyPolicy?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_replica_readonly tencentcloud_redis_replica_readonly}
*/
export class RedisReplicaReadonly extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisReplicaReadonly that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_replica_readonly#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_replica_readonly tencentcloud_redis_replica_readonly} Resource
  *
  * @param scope The scope in which to define this construct
