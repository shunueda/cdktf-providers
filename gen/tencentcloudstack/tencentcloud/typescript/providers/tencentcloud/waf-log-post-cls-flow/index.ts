// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/waf_log_post_cls_flow
...
export interface WafLogPostClsFlowConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/waf_log_post_cls_flow#cls_region WafLogPostClsFlow#cls_region}
  */
  readonly clsRegion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/waf_log_post_cls_flow#id WafLogPostClsFlow#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/waf_log_post_cls_flow#log_topic_name WafLogPostClsFlow#log_topic_name}
  */
  readonly logTopicName?: string;
  /**
  * 1- Access log, 2- Attack log, the default is access log.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/waf_log_post_cls_flow#log_type WafLogPostClsFlow#log_type}
  */
  readonly logType?: number;
  /**
  * The name of the log set where the delivered CLS is located. The default value is waf_post_logset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/waf_log_post_cls_flow#logset_name WafLogPostClsFlow#logset_name}
  */
  readonly logsetName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/waf_log_post_cls_flow tencentcloud_waf_log_post_cls_flow}
*/
export class WafLogPostClsFlow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafLogPostClsFlow that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/waf_log_post_cls_flow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/waf_log_post_cls_flow tencentcloud_waf_log_post_cls_flow} Resource
  *
  * @param scope The scope in which to define this construct
