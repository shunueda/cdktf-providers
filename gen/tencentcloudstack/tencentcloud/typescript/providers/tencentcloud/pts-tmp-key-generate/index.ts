// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_tmp_key_generate
...
export interface PtsTmpKeyGenerateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_tmp_key_generate#id PtsTmpKeyGenerate#id}
  *
  ...
  * Project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_tmp_key_generate#project_id PtsTmpKeyGenerate#project_id}
  */
  readonly projectId: string;
  /**
  * Scenario ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_tmp_key_generate#scenario_id PtsTmpKeyGenerate#scenario_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_tmp_key_generate tencentcloud_pts_tmp_key_generate}
*/
export class PtsTmpKeyGenerate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PtsTmpKeyGenerate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_tmp_key_generate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_tmp_key_generate tencentcloud_pts_tmp_key_generate} Resource
  *
  * @param scope The scope in which to define this construct
