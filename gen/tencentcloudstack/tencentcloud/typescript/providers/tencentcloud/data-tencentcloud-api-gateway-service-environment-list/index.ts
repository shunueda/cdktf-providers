// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/api_gateway_service_environment_list
...
export interface DataTencentcloudApiGatewayServiceEnvironmentListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/api_gateway_service_environment_list#id DataTencentcloudApiGatewayServiceEnvironmentList#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/api_gateway_service_environment_list#result_output_file DataTencentcloudApiGatewayServiceEnvironmentList#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * The unique ID of the service to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/api_gateway_service_environment_list#service_id DataTencentcloudApiGatewayServiceEnvironmentList#service_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/api_gateway_service_environment_list tencentcloud_api_gateway_service_environment_list}
*/
export class DataTencentcloudApiGatewayServiceEnvironmentList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudApiGatewayServiceEnvironmentList that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/api_gateway_service_environment_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/api_gateway_service_environment_list tencentcloud_api_gateway_service_environment_list} Data Source
  *
  * @param scope The scope in which to define this construct
