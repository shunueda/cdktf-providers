// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpc_private_nat_gateway_translation_nat_rule
...
export interface VpcPrivateNatGatewayTranslationNatRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpc_private_nat_gateway_translation_nat_rule#id VpcPrivateNatGatewayTranslationNatRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpc_private_nat_gateway_translation_nat_rule#nat_gateway_id VpcPrivateNatGatewayTranslationNatRule#nat_gateway_id}
  */
  readonly natGatewayId: string;
  /**
  * translation_nat_rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpc_private_nat_gateway_translation_nat_rule#translation_nat_rules VpcPrivateNatGatewayTranslationNatRule#translation_nat_rules}
  */
...
export interface VpcPrivateNatGatewayTranslationNatRuleTranslationNatRules {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpc_private_nat_gateway_translation_nat_rule#description VpcPrivateNatGatewayTranslationNatRule#description}
  */
  readonly description: string;
  /**
  * Source IP, valid when translation rule type is network layer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpc_private_nat_gateway_translation_nat_rule#original_ip VpcPrivateNatGatewayTranslationNatRule#original_ip}
  */
  readonly originalIp?: string;
  /**
  * Translation rule target, optional values "LOCAL","PEER".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpc_private_nat_gateway_translation_nat_rule#translation_direction VpcPrivateNatGatewayTranslationNatRule#translation_direction}
  */
  readonly translationDirection: string;
  /**
  * Translation IP, when translation rule type is transport layer, it is an IP pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpc_private_nat_gateway_translation_nat_rule#translation_ip VpcPrivateNatGatewayTranslationNatRule#translation_ip}
  */
  readonly translationIp: string;
  /**
  * Translation rule type, optional values "NETWORK_LAYER","TRANSPORT_LAYER".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpc_private_nat_gateway_translation_nat_rule#translation_type VpcPrivateNatGatewayTranslationNatRule#translation_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpc_private_nat_gateway_translation_nat_rule tencentcloud_vpc_private_nat_gateway_translation_nat_rule}
*/
export class VpcPrivateNatGatewayTranslationNatRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcPrivateNatGatewayTranslationNatRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpc_private_nat_gateway_translation_nat_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpc_private_nat_gateway_translation_nat_rule tencentcloud_vpc_private_nat_gateway_translation_nat_rule} Resource
  *
  * @param scope The scope in which to define this construct
