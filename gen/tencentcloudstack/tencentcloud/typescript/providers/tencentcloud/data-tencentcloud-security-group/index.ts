// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/security_group
...
export interface DataTencentcloudSecurityGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/security_group#id DataTencentcloudSecurityGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/security_group#name DataTencentcloudSecurityGroup#name}
  */
  readonly name?: string;
  /**
  * ID of the security group to be queried. Conflict with `name`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/security_group#security_group_id DataTencentcloudSecurityGroup#security_group_id}
  */
  readonly securityGroupId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/security_group tencentcloud_security_group}
*/
export class DataTencentcloudSecurityGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudSecurityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/security_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/security_group tencentcloud_security_group} Data Source
  *
  * @param scope The scope in which to define this construct
