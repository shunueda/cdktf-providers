// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter
...
export interface DbbrainSqlFilterConfig extends cdktf.TerraformMetaArguments {
  ...
  * filter duration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter#duration DbbrainSqlFilter#duration}
  */
  readonly duration: number;
  /**
  * filter key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter#filter_key DbbrainSqlFilter#filter_key}
  */
  readonly filterKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter#id DbbrainSqlFilter#id}
  *
  ...
  * instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter#instance_id DbbrainSqlFilter#instance_id}
  */
  readonly instanceId: string;
  /**
  * maximum concurreny.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter#max_concurrency DbbrainSqlFilter#max_concurrency}
  */
  readonly maxConcurrency: number;
  /**
  * product, optional value is &amp;#39;mysql&amp;#39;, &amp;#39;cynosdb&amp;#39;.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter#product DbbrainSqlFilter#product}
  */
  readonly product?: string;
  /**
  * sql type, optional value is SELECT, UPDATE, DELETE, INSERT, REPLACE.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter#sql_type DbbrainSqlFilter#sql_type}
  */
  readonly sqlType: string;
  /**
  * filter status.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter#status DbbrainSqlFilter#status}
  */
  readonly status?: string;
  /**
  * session_token block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter#session_token DbbrainSqlFilter#session_token}
  */
...
export interface DbbrainSqlFilterSessionToken {
  ...
  * password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter#password DbbrainSqlFilter#password}
  */
  readonly password: string;
  /**
  * user name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter#user DbbrainSqlFilter#user}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter tencentcloud_dbbrain_sql_filter}
*/
export class DbbrainSqlFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbbrainSqlFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/dbbrain_sql_filter tencentcloud_dbbrain_sql_filter} Resource
  *
  * @param scope The scope in which to define this construct
