// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_ipv6_eni_address
...
export interface VpcIpv6EniAddressConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_ipv6_eni_address#id VpcIpv6EniAddress#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_ipv6_eni_address#network_interface_id VpcIpv6EniAddress#network_interface_id}
  */
  readonly networkInterfaceId: string;
  /**
  * VPC `ID`, in the form of `vpc-m6dyj72l`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_ipv6_eni_address#vpc_id VpcIpv6EniAddress#vpc_id}
  */
  readonly vpcId: string;
  /**
  * ipv6_addresses block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_ipv6_eni_address#ipv6_addresses VpcIpv6EniAddress#ipv6_addresses}
  */
...
export interface VpcIpv6EniAddressIpv6Addresses {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_ipv6_eni_address#address VpcIpv6EniAddress#address}
  */
  readonly address: string;
  /**
  * `EIP` instance `ID`, such as:`eip-hxlqja90`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_ipv6_eni_address#address_id VpcIpv6EniAddress#address_id}
  */
  readonly addressId?: string;
  /**
  * Description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_ipv6_eni_address#description VpcIpv6EniAddress#description}
  */
  readonly description?: string;
  /**
  * Whether the public network IP is blocked.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_ipv6_eni_address#is_wan_ip_blocked VpcIpv6EniAddress#is_wan_ip_blocked}
  */
  readonly isWanIpBlocked?: boolean | cdktf.IResolvable;
  /**
  * Whether to master `IP`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_ipv6_eni_address#primary VpcIpv6EniAddress#primary}
  */
  readonly primary?: boolean | cdktf.IResolvable;
  /**
  * `IPv6` address status: `PENDING`: pending, `MIGRATING`: migrating, `DELETING`: deleting, `AVAILABLE`: available.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_ipv6_eni_address#state VpcIpv6EniAddress#state}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_ipv6_eni_address tencentcloud_vpc_ipv6_eni_address}
*/
export class VpcIpv6EniAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcIpv6EniAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_ipv6_eni_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_ipv6_eni_address tencentcloud_vpc_ipv6_eni_address} Resource
  *
  * @param scope The scope in which to define this construct
