// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/api_gateway_api_doc
...
export interface ApiGatewayApiDocConfig extends cdktf.TerraformMetaArguments {
  ...
  * Api Document name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/api_gateway_api_doc#api_doc_name ApiGatewayApiDoc#api_doc_name}
  */
  readonly apiDocName: string;
  /**
  * List of APIs for generating documents.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/api_gateway_api_doc#api_ids ApiGatewayApiDoc#api_ids}
  */
  readonly apiIds: string[];
  /**
  * Env name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/api_gateway_api_doc#environment ApiGatewayApiDoc#environment}
  */
  readonly environment: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/api_gateway_api_doc#id ApiGatewayApiDoc#id}
  *
  ...
  * Service name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/api_gateway_api_doc#service_id ApiGatewayApiDoc#service_id}
  */
  readonly serviceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/api_gateway_api_doc tencentcloud_api_gateway_api_doc}
*/
export class ApiGatewayApiDoc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayApiDoc that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/api_gateway_api_doc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/api_gateway_api_doc tencentcloud_api_gateway_api_doc} Resource
  *
  * @param scope The scope in which to define this construct
