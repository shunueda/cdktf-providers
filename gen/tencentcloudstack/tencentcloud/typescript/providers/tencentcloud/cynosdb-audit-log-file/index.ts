// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file
...
export interface CynosdbAuditLogFileConfig extends cdktf.TerraformMetaArguments {
  ...
  * End time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#end_time CynosdbAuditLogFile#end_time}
  */
  readonly endTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#id CynosdbAuditLogFile#id}
  *
  ...
  * The ID of instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#instance_id CynosdbAuditLogFile#instance_id}
  */
  readonly instanceId: string;
  /**
  * Sort by. Supported values are: `ASC` - ascending, `DESC` - descending.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#order CynosdbAuditLogFile#order}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#order_by CynosdbAuditLogFile#order_by}
  */
  readonly orderBy?: string;
  /**
  * Start time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#start_time CynosdbAuditLogFile#start_time}
  */
  readonly startTime: string;
  /**
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#filter CynosdbAuditLogFile#filter}
  */
...
export interface CynosdbAuditLogFileFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#affect_rows CynosdbAuditLogFile#affect_rows}
  */
  readonly affectRows?: number;
  /**
  * The name of database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#db_name CynosdbAuditLogFile#db_name}
  */
  readonly dbName?: string[];
  /**
  * Execution time. The unit is: ms. Indicates to filter audit logs whose execution time is greater than this value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#exec_time CynosdbAuditLogFile#exec_time}
  */
  readonly execTime?: number;
  /**
  * Client host.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#host CynosdbAuditLogFile#host}
  */
  readonly host?: string[];
  /**
  * The name of audit policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#policy_name CynosdbAuditLogFile#policy_name}
  */
  readonly policyName?: string[];
  /**
  * Return the number of rows.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#sent_rows CynosdbAuditLogFile#sent_rows}
  */
  readonly sentRows?: number;
  /**
  * SQL statement. Support fuzzy matching.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#sql CynosdbAuditLogFile#sql}
  */
  readonly sql?: string;
  /**
  * SQL type. currently supported: SELECT, INSERT, UPDATE, DELETE, CREATE, DROP, ALTER, SET, REPLACE, EXECUTE.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#sql_type CynosdbAuditLogFile#sql_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#sql_types CynosdbAuditLogFile#sql_types}
  */
  readonly sqlTypes?: string[];
  /**
  * SQL statement. Support passing multiple sql statements.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#sqls CynosdbAuditLogFile#sqls}
  */
  readonly sqls?: string[];
  /**
  * The name of table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#table_name CynosdbAuditLogFile#table_name}
  */
  readonly tableName?: string[];
  /**
  * The ID of thread.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#thread_id CynosdbAuditLogFile#thread_id}
  */
  readonly threadId?: string[];
  /**
  * User name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#user CynosdbAuditLogFile#user}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file tencentcloud_cynosdb_audit_log_file}
*/
export class CynosdbAuditLogFile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CynosdbAuditLogFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cynosdb_audit_log_file tencentcloud_cynosdb_audit_log_file} Resource
  *
  * @param scope The scope in which to define this construct
