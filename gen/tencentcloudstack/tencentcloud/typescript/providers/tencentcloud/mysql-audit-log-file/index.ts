// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file
...
export interface MysqlAuditLogFileConfig extends cdktf.TerraformMetaArguments {
  ...
  * end time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#end_time MysqlAuditLogFile#end_time}
  */
  readonly endTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#id MysqlAuditLogFile#id}
  *
  ...
  * The ID of instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#instance_id MysqlAuditLogFile#instance_id}
  */
  readonly instanceId: string;
  /**
  * Sort by. supported values are: `ASC`- ascending order, `DESC`- descending order.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#order MysqlAuditLogFile#order}
  */
  readonly order?: string;
  /**
  * Sort field. supported values include:`timestamp` - timestamp; `affectRows` - affected rows; `execTime` - execution time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#order_by MysqlAuditLogFile#order_by}
  */
  readonly orderBy?: string;
  /**
  * start time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#start_time MysqlAuditLogFile#start_time}
  */
  readonly startTime: string;
  /**
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#filter MysqlAuditLogFile#filter}
  */
...
export interface MysqlAuditLogFileFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#affect_rows MysqlAuditLogFile#affect_rows}
  */
  readonly affectRows?: number;
  /**
  * Database name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#db_name MysqlAuditLogFile#db_name}
  */
  readonly dbName?: string[];
  /**
  * Execution time. The unit is: ms. Indicates to filter audit logs whose execution time is greater than this value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#exec_time MysqlAuditLogFile#exec_time}
  */
  readonly execTime?: number;
  /**
  * Client address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#host MysqlAuditLogFile#host}
  */
  readonly host?: string[];
  /**
  * The name of policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#policy_name MysqlAuditLogFile#policy_name}
  */
  readonly policyName?: string[];
  /**
  * SQL statement. support fuzzy matching.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#sql MysqlAuditLogFile#sql}
  */
  readonly sql?: string;
  /**
  * SQL type. Currently supported: SELECT, INSERT, UPDATE, DELETE, CREATE, DROP, ALTER, SET, REPLACE, EXECUTE.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#sql_type MysqlAuditLogFile#sql_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#sql_types MysqlAuditLogFile#sql_types}
  */
  readonly sqlTypes?: string[];
  /**
  * SQL statement. Support passing multiple sql statements.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#sqls MysqlAuditLogFile#sqls}
  */
  readonly sqls?: string[];
  /**
  * Table name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#table_name MysqlAuditLogFile#table_name}
  */
  readonly tableName?: string[];
  /**
  * User name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#user MysqlAuditLogFile#user}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file tencentcloud_mysql_audit_log_file}
*/
export class MysqlAuditLogFile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlAuditLogFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_audit_log_file tencentcloud_mysql_audit_log_file} Resource
  *
  * @param scope The scope in which to define this construct
