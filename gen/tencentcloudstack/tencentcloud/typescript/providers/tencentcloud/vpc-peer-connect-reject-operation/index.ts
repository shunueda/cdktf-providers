// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_reject_operation
...
export interface VpcPeerConnectRejectOperationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_reject_operation#id VpcPeerConnectRejectOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_reject_operation#peering_connection_id VpcPeerConnectRejectOperation#peering_connection_id}
  */
  readonly peeringConnectionId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_reject_operation tencentcloud_vpc_peer_connect_reject_operation}
*/
export class VpcPeerConnectRejectOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcPeerConnectRejectOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_reject_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_reject_operation tencentcloud_vpc_peer_connect_reject_operation} Resource
  *
  * @param scope The scope in which to define this construct
