// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/gaap_global_domain_dns
...
export interface GaapGlobalDomainDnsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Domain Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/gaap_global_domain_dns#domain_id GaapGlobalDomainDns#domain_id}
  */
  readonly domainId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/gaap_global_domain_dns#id GaapGlobalDomainDns#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/gaap_global_domain_dns#nation_country_inner_codes GaapGlobalDomainDns#nation_country_inner_codes}
  */
  readonly nationCountryInnerCodes: string[];
  /**
  * Proxy Id List.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/gaap_global_domain_dns#proxy_id_list GaapGlobalDomainDns#proxy_id_list}
  */
  readonly proxyIdList: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/gaap_global_domain_dns tencentcloud_gaap_global_domain_dns}
*/
export class GaapGlobalDomainDns extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GaapGlobalDomainDns that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/gaap_global_domain_dns#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/gaap_global_domain_dns tencentcloud_gaap_global_domain_dns} Resource
  *
  * @param scope The scope in which to define this construct
