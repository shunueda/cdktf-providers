// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/chdfs_access_group
...
export interface ChdfsAccessGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/chdfs_access_group#access_group_name ChdfsAccessGroup#access_group_name}
  */
  readonly accessGroupName: string;
  /**
  * Permission group description, default empty.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/chdfs_access_group#description ChdfsAccessGroup#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/chdfs_access_group#id ChdfsAccessGroup#id}
  *
  ...
  * VPC ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/chdfs_access_group#vpc_id ChdfsAccessGroup#vpc_id}
  */
  readonly vpcId: string;
  /**
  * vpc network type(1:CVM, 2:BM 1.0).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/chdfs_access_group#vpc_type ChdfsAccessGroup#vpc_type}
  */
  readonly vpcType: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/chdfs_access_group tencentcloud_chdfs_access_group}
*/
export class ChdfsAccessGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChdfsAccessGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/chdfs_access_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/chdfs_access_group tencentcloud_chdfs_access_group} Resource
  *
  * @param scope The scope in which to define this construct
