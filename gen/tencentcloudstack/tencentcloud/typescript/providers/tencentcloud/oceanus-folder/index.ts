// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/oceanus_folder
...
export interface OceanusFolderConfig extends cdktf.TerraformMetaArguments {
  ...
  * New file name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/oceanus_folder#folder_name OceanusFolder#folder_name}
  */
  readonly folderName: string;
  /**
  * Folder type, 0: job folder, 1: resource folder. Default is 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/oceanus_folder#folder_type OceanusFolder#folder_type}
  */
  readonly folderType?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/oceanus_folder#id OceanusFolder#id}
  *
  ...
  * Parent folder id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/oceanus_folder#parent_id OceanusFolder#parent_id}
  */
  readonly parentId: string;
  /**
  * Workspace SerialId.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/oceanus_folder#work_space_id OceanusFolder#work_space_id}
  */
  readonly workSpaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/oceanus_folder tencentcloud_oceanus_folder}
*/
export class OceanusFolder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OceanusFolder that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/oceanus_folder#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/oceanus_folder tencentcloud_oceanus_folder} Resource
  *
  * @param scope The scope in which to define this construct
