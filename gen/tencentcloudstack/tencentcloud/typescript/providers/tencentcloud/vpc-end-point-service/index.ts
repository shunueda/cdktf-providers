// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_end_point_service
...
export interface VpcEndPointServiceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_end_point_service#auto_accept_flag VpcEndPointService#auto_accept_flag}
  */
  readonly autoAcceptFlag: boolean | cdktf.IResolvable;
  /**
  * Name of end point service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_end_point_service#end_point_service_name VpcEndPointService#end_point_service_name}
  */
  readonly endPointServiceName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_end_point_service#id VpcEndPointService#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_end_point_service#service_instance_id VpcEndPointService#service_instance_id}
  */
  readonly serviceInstanceId: string;
  /**
  * Type of service instance, like `CLB`, `CDB`, `CRS`, default is `CLB`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_end_point_service#service_type VpcEndPointService#service_type}
  */
  readonly serviceType?: string;
  /**
  * ID of vpc instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_end_point_service#vpc_id VpcEndPointService#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_end_point_service tencentcloud_vpc_end_point_service}
*/
export class VpcEndPointService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcEndPointService that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_end_point_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_end_point_service tencentcloud_vpc_end_point_service} Resource
  *
  * @param scope The scope in which to define this construct
