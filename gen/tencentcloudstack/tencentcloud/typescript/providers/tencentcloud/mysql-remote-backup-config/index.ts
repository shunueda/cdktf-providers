// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_remote_backup_config
...
export interface MysqlRemoteBackupConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_remote_backup_config#expire_days MysqlRemoteBackupConfig#expire_days}
  */
  readonly expireDays: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_remote_backup_config#id MysqlRemoteBackupConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_remote_backup_config#instance_id MysqlRemoteBackupConfig#instance_id}
  */
  readonly instanceId: string;
  /**
  * Remote data backup switch, off - disable remote backup, on - enable remote backup.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_remote_backup_config#remote_backup_save MysqlRemoteBackupConfig#remote_backup_save}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_remote_backup_config#remote_binlog_save MysqlRemoteBackupConfig#remote_binlog_save}
  */
  readonly remoteBinlogSave: string;
  /**
  * User settings off-site backup region list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_remote_backup_config#remote_region MysqlRemoteBackupConfig#remote_region}
  */
  readonly remoteRegion: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_remote_backup_config tencentcloud_mysql_remote_backup_config}
*/
export class MysqlRemoteBackupConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlRemoteBackupConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_remote_backup_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_remote_backup_config tencentcloud_mysql_remote_backup_config} Resource
  *
  * @param scope The scope in which to define this construct
