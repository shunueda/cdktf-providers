// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/ssl_update_certificate_record_rollback_operation
...
export interface SslUpdateCertificateRecordRollbackOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/ssl_update_certificate_record_rollback_operation#deploy_record_id SslUpdateCertificateRecordRollbackOperation#deploy_record_id}
  */
  readonly deployRecordId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/ssl_update_certificate_record_rollback_operation#id SslUpdateCertificateRecordRollbackOperation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/ssl_update_certificate_record_rollback_operation tencentcloud_ssl_update_certificate_record_rollback_operation}
*/
export class SslUpdateCertificateRecordRollbackOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslUpdateCertificateRecordRollbackOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/ssl_update_certificate_record_rollback_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/ssl_update_certificate_record_rollback_operation tencentcloud_ssl_update_certificate_record_rollback_operation} Resource
  *
  * @param scope The scope in which to define this construct
