// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_isolate_db_instance_operation
...
export interface PostgresqlIsolateDbInstanceOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_isolate_db_instance_operation#db_instance_id_set PostgresqlIsolateDbInstanceOperation#db_instance_id_set}
  */
  readonly dbInstanceIdSet: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_isolate_db_instance_operation#id PostgresqlIsolateDbInstanceOperation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_isolate_db_instance_operation tencentcloud_postgresql_isolate_db_instance_operation}
*/
export class PostgresqlIsolateDbInstanceOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresqlIsolateDbInstanceOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_isolate_db_instance_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_isolate_db_instance_operation tencentcloud_postgresql_isolate_db_instance_operation} Resource
  *
  * @param scope The scope in which to define this construct
