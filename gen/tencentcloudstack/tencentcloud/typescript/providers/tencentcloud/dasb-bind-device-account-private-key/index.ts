// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dasb_bind_device_account_private_key
...
export interface DasbBindDeviceAccountPrivateKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  * Host account ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dasb_bind_device_account_private_key#device_account_id DasbBindDeviceAccountPrivateKey#device_account_id}
  */
  readonly deviceAccountId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dasb_bind_device_account_private_key#id DasbBindDeviceAccountPrivateKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dasb_bind_device_account_private_key#private_key DasbBindDeviceAccountPrivateKey#private_key}
  */
  readonly privateKey: string;
  /**
  * Host account private key password, maximum length 256 bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dasb_bind_device_account_private_key#private_key_password DasbBindDeviceAccountPrivateKey#private_key_password}
  */
  readonly privateKeyPassword?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dasb_bind_device_account_private_key tencentcloud_dasb_bind_device_account_private_key}
*/
export class DasbBindDeviceAccountPrivateKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DasbBindDeviceAccountPrivateKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dasb_bind_device_account_private_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dasb_bind_device_account_private_key tencentcloud_dasb_bind_device_account_private_key} Resource
  *
  * @param scope The scope in which to define this construct
