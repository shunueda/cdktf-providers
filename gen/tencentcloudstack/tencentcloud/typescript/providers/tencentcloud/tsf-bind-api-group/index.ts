// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/tsf_bind_api_group
...
export interface TsfBindApiGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * gateway group id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/tsf_bind_api_group#gateway_deploy_group_id TsfBindApiGroup#gateway_deploy_group_id}
  */
  readonly gatewayDeployGroupId: string;
  /**
  * group id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/tsf_bind_api_group#group_id TsfBindApiGroup#group_id}
  */
  readonly groupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/tsf_bind_api_group#id TsfBindApiGroup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/tsf_bind_api_group tencentcloud_tsf_bind_api_group}
*/
export class TsfBindApiGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TsfBindApiGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/tsf_bind_api_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/tsf_bind_api_group tencentcloud_tsf_bind_api_group} Resource
  *
  * @param scope The scope in which to define this construct
