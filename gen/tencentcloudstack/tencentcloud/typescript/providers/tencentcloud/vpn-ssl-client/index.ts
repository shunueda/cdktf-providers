// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpn_ssl_client
...
export interface VpnSslClientConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpn_ssl_client#id VpnSslClient#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpn_ssl_client#ssl_vpn_client_name VpnSslClient#ssl_vpn_client_name}
  */
  readonly sslVpnClientName: string;
  /**
  * VPN ssl server id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpn_ssl_client#ssl_vpn_server_id VpnSslClient#ssl_vpn_server_id}
  */
  readonly sslVpnServerId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpn_ssl_client tencentcloud_vpn_ssl_client}
*/
export class VpnSslClient extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnSslClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpn_ssl_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/vpn_ssl_client tencentcloud_vpn_ssl_client} Resource
  *
  * @param scope The scope in which to define this construct
