// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ssl_deploy_certificate_record_rollback_operation
...
export interface SslDeployCertificateRecordRollbackOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ssl_deploy_certificate_record_rollback_operation#deploy_record_id SslDeployCertificateRecordRollbackOperation#deploy_record_id}
  */
  readonly deployRecordId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ssl_deploy_certificate_record_rollback_operation#id SslDeployCertificateRecordRollbackOperation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ssl_deploy_certificate_record_rollback_operation tencentcloud_ssl_deploy_certificate_record_rollback_operation}
*/
export class SslDeployCertificateRecordRollbackOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslDeployCertificateRecordRollbackOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ssl_deploy_certificate_record_rollback_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ssl_deploy_certificate_record_rollback_operation tencentcloud_ssl_deploy_certificate_record_rollback_operation} Resource
  *
  * @param scope The scope in which to define this construct
