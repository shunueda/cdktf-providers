// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_role_configuration_permission_custom_policy_attachment
...
export interface IdentityCenterRoleConfigurationPermissionCustomPolicyAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_role_configuration_permission_custom_policy_attachment#id IdentityCenterRoleConfigurationPermissionCustomPolicyAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_role_configuration_permission_custom_policy_attachment#role_configuration_id IdentityCenterRoleConfigurationPermissionCustomPolicyAttachment#role_configuration_id}
  */
  readonly roleConfigurationId: string;
  /**
  * Role policy document.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_role_configuration_permission_custom_policy_attachment#role_policy_document IdentityCenterRoleConfigurationPermissionCustomPolicyAttachment#role_policy_document}
  */
  readonly rolePolicyDocument: string;
  /**
  * Role policy name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_role_configuration_permission_custom_policy_attachment#role_policy_name IdentityCenterRoleConfigurationPermissionCustomPolicyAttachment#role_policy_name}
  */
  readonly rolePolicyName: string;
  /**
  * Space ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_role_configuration_permission_custom_policy_attachment#zone_id IdentityCenterRoleConfigurationPermissionCustomPolicyAttachment#zone_id}
  */
  readonly zoneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_role_configuration_permission_custom_policy_attachment tencentcloud_identity_center_role_configuration_permission_custom_policy_attachment}
*/
export class IdentityCenterRoleConfigurationPermissionCustomPolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityCenterRoleConfigurationPermissionCustomPolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_role_configuration_permission_custom_policy_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/identity_center_role_configuration_permission_custom_policy_attachment tencentcloud_identity_center_role_configuration_permission_custom_policy_attachment} Resource
  *
  * @param scope The scope in which to define this construct
