// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dlc_modify_data_engine_description_operation
...
export interface DlcModifyDataEngineDescriptionOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dlc_modify_data_engine_description_operation#data_engine_name DlcModifyDataEngineDescriptionOperation#data_engine_name}
  */
  readonly dataEngineName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dlc_modify_data_engine_description_operation#id DlcModifyDataEngineDescriptionOperation#id}
  *
  ...
  * Engine description and its maximum length is 250 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dlc_modify_data_engine_description_operation#message DlcModifyDataEngineDescriptionOperation#message}
  */
  readonly message: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dlc_modify_data_engine_description_operation tencentcloud_dlc_modify_data_engine_description_operation}
*/
export class DlcModifyDataEngineDescriptionOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DlcModifyDataEngineDescriptionOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dlc_modify_data_engine_description_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dlc_modify_data_engine_description_operation tencentcloud_dlc_modify_data_engine_description_operation} Resource
  *
  * @param scope The scope in which to define this construct
