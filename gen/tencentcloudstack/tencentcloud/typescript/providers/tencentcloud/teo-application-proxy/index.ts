// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy
...
export interface TeoApplicationProxyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy#accelerate_type TeoApplicationProxy#accelerate_type}
  */
  readonly accelerateType: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy#id TeoApplicationProxy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy#plat_type TeoApplicationProxy#plat_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy#proxy_name TeoApplicationProxy#proxy_name}
  */
  readonly proxyName: string;
  /**
  * Layer 4 proxy mode. Valid values:- `hostname`: subdomain mode.- `instance`: instance mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy#proxy_type TeoApplicationProxy#proxy_type}
  */
  readonly proxyType?: string;
  /**
  * - `0`: Disable security protection.- `1`: Enable security protection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy#security_type TeoApplicationProxy#security_type}
  */
  readonly securityType: number;
  /**
  * Session persistence duration. Value range: 30-3600 (in seconds), default value is 600.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy#session_persist_time TeoApplicationProxy#session_persist_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy#status TeoApplicationProxy#status}
  */
  readonly status?: string;
  /**
  * Site ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy#zone_id TeoApplicationProxy#zone_id}
  */
  readonly zoneId: string;
  /**
  * ipv6 block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy#ipv6 TeoApplicationProxy#ipv6}
  */
...
export interface TeoApplicationProxyIpv6 {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy#switch TeoApplicationProxy#switch}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy tencentcloud_teo_application_proxy}
*/
export class TeoApplicationProxy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeoApplicationProxy that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/teo_application_proxy tencentcloud_teo_application_proxy} Resource
  *
  * @param scope The scope in which to define this construct
