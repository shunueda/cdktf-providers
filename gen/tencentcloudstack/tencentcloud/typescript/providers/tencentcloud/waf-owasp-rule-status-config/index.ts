// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_owasp_rule_status_config
...
export interface WafOwaspRuleStatusConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  * Domain name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_owasp_rule_status_config#domain WafOwaspRuleStatusConfig#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_owasp_rule_status_config#id WafOwaspRuleStatusConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_owasp_rule_status_config#reason WafOwaspRuleStatusConfig#reason}
  */
  readonly reason?: number;
  /**
  * Rule ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_owasp_rule_status_config#rule_id WafOwaspRuleStatusConfig#rule_id}
  */
  readonly ruleId: string;
  /**
  * Rule switch. valid values: 0 (disabled), 1 (enabled), 2 (observation only).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_owasp_rule_status_config#rule_status WafOwaspRuleStatusConfig#rule_status}
  */
  readonly ruleStatus: number;
  /**
  * If reverse requires the input of data type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_owasp_rule_status_config#type_id WafOwaspRuleStatusConfig#type_id}
  */
  readonly typeId?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_owasp_rule_status_config tencentcloud_waf_owasp_rule_status_config}
*/
export class WafOwaspRuleStatusConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafOwaspRuleStatusConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_owasp_rule_status_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/waf_owasp_rule_status_config tencentcloud_waf_owasp_rule_status_config} Resource
  *
  * @param scope The scope in which to define this construct
