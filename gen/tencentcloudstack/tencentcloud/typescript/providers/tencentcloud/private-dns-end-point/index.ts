// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/private_dns_end_point
...
export interface PrivateDnsEndPointConfig extends cdktf.TerraformMetaArguments {
  ...
  * Endpoint name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/private_dns_end_point#end_point_name PrivateDnsEndPoint#end_point_name}
  */
  readonly endPointName: string;
  /**
  * Endpoint region, which should be consistent with the region of the endpoint service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/private_dns_end_point#end_point_region PrivateDnsEndPoint#end_point_region}
  */
  readonly endPointRegion: string;
  /**
  * Endpoint service ID (namely, VPC endpoint service ID).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/private_dns_end_point#end_point_service_id PrivateDnsEndPoint#end_point_service_id}
  */
  readonly endPointServiceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/private_dns_end_point#id PrivateDnsEndPoint#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/private_dns_end_point#ip_num PrivateDnsEndPoint#ip_num}
  */
  readonly ipNum?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/private_dns_end_point tencentcloud_private_dns_end_point}
*/
export class PrivateDnsEndPoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateDnsEndPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/private_dns_end_point#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/private_dns_end_point tencentcloud_private_dns_end_point} Resource
  *
  * @param scope The scope in which to define this construct
