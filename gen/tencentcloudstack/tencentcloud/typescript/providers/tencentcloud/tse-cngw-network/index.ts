// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network
...
export interface TseCngwNetworkConfig extends cdktf.TerraformMetaArguments {
  ...
  * description of clb.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network#description TseCngwNetwork#description}
  */
  readonly description?: string;
  /**
  * gateway ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network#gateway_id TseCngwNetwork#gateway_id}
  */
  readonly gatewayId: string;
  /**
  * gateway group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network#group_id TseCngwNetwork#group_id}
  */
  readonly groupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network#id TseCngwNetwork#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network#internet_address_version TseCngwNetwork#internet_address_version}
  */
  readonly internetAddressVersion?: string;
  /**
  * public network bandwidth.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network#internet_max_bandwidth_out TseCngwNetwork#internet_max_bandwidth_out}
  */
  readonly internetMaxBandwidthOut?: number;
  /**
  * trade type of internet. Reference value:`BANDWIDTH` (default value), `TRAFFIC`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network#internet_pay_mode TseCngwNetwork#internet_pay_mode}
  */
  readonly internetPayMode?: string;
  /**
  * primary availability zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network#master_zone_id TseCngwNetwork#master_zone_id}
  */
  readonly masterZoneId?: string;
  /**
  * Whether load balancing has multiple availability zones.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network#multi_zone_flag TseCngwNetwork#multi_zone_flag}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network#sla_type TseCngwNetwork#sla_type}
  */
  readonly slaType?: string;
  /**
  * alternate availability zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network#slave_zone_id TseCngwNetwork#slave_zone_id}
  */
  readonly slaveZoneId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network tencentcloud_tse_cngw_network}
*/
export class TseCngwNetwork extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TseCngwNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tse_cngw_network tencentcloud_tse_cngw_network} Resource
  *
  * @param scope The scope in which to define this construct
