// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/lighthouse_apply_disk_backup
...
export interface LighthouseApplyDiskBackupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Disk backup ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/lighthouse_apply_disk_backup#disk_backup_id LighthouseApplyDiskBackup#disk_backup_id}
  */
  readonly diskBackupId: string;
  /**
  * Disk ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/lighthouse_apply_disk_backup#disk_id LighthouseApplyDiskBackup#disk_id}
  */
  readonly diskId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/lighthouse_apply_disk_backup#id LighthouseApplyDiskBackup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/lighthouse_apply_disk_backup tencentcloud_lighthouse_apply_disk_backup}
*/
export class LighthouseApplyDiskBackup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LighthouseApplyDiskBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/lighthouse_apply_disk_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/lighthouse_apply_disk_backup tencentcloud_lighthouse_apply_disk_backup} Resource
  *
  * @param scope The scope in which to define this construct
