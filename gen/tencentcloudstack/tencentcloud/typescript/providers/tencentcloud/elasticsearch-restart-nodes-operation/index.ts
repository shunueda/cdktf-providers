// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/elasticsearch_restart_nodes_operation
...
export interface ElasticsearchRestartNodesOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/elasticsearch_restart_nodes_operation#force_restart ElasticsearchRestartNodesOperation#force_restart}
  */
  readonly forceRestart?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/elasticsearch_restart_nodes_operation#id ElasticsearchRestartNodesOperation#id}
  *
  ...
  * Instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/elasticsearch_restart_nodes_operation#instance_id ElasticsearchRestartNodesOperation#instance_id}
  */
  readonly instanceId: string;
  /**
  * Node status, used in blue-green mode; off-line node blue-green is risky.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/elasticsearch_restart_nodes_operation#is_offline ElasticsearchRestartNodesOperation#is_offline}
  */
  readonly isOffline?: boolean | cdktf.IResolvable;
  /**
  * List of node names.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/elasticsearch_restart_nodes_operation#node_names ElasticsearchRestartNodesOperation#node_names}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/elasticsearch_restart_nodes_operation#restart_mode ElasticsearchRestartNodesOperation#restart_mode}
  */
  readonly restartMode?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/elasticsearch_restart_nodes_operation tencentcloud_elasticsearch_restart_nodes_operation}
*/
export class ElasticsearchRestartNodesOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticsearchRestartNodesOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/elasticsearch_restart_nodes_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/elasticsearch_restart_nodes_operation tencentcloud_elasticsearch_restart_nodes_operation} Resource
  *
  * @param scope The scope in which to define this construct
