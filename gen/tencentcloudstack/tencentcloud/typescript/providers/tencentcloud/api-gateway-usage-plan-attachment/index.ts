// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/api_gateway_usage_plan_attachment
...
export interface ApiGatewayUsagePlanAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/api_gateway_usage_plan_attachment#access_key_ids ApiGatewayUsagePlanAttachment#access_key_ids}
  */
  readonly accessKeyIds?: string[];
  /**
  * ID of the API. This parameter will be required when `bind_type` is `API`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/api_gateway_usage_plan_attachment#api_id ApiGatewayUsagePlanAttachment#api_id}
  */
  readonly apiId?: string;
  /**
  * Binding type. Valid values: `API`, `SERVICE`. Default value is `SERVICE`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/api_gateway_usage_plan_attachment#bind_type ApiGatewayUsagePlanAttachment#bind_type}
  */
  readonly bindType?: string;
  /**
  * The environment to be bound. Valid values: `test`, `prepub`, `release`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/api_gateway_usage_plan_attachment#environment ApiGatewayUsagePlanAttachment#environment}
  */
  readonly environment: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/api_gateway_usage_plan_attachment#id ApiGatewayUsagePlanAttachment#id}
  *
  ...
  * ID of the service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/api_gateway_usage_plan_attachment#service_id ApiGatewayUsagePlanAttachment#service_id}
  */
  readonly serviceId: string;
  /**
  * ID of the usage plan.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/api_gateway_usage_plan_attachment#usage_plan_id ApiGatewayUsagePlanAttachment#usage_plan_id}
  */
  readonly usagePlanId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/api_gateway_usage_plan_attachment tencentcloud_api_gateway_usage_plan_attachment}
*/
export class ApiGatewayUsagePlanAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayUsagePlanAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/api_gateway_usage_plan_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/api_gateway_usage_plan_attachment tencentcloud_api_gateway_usage_plan_attachment} Resource
  *
  * @param scope The scope in which to define this construct
