// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/trocket_rocketmq_consumer_group
...
export interface TrocketRocketmqConsumerGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/trocket_rocketmq_consumer_group#consume_enable TrocketRocketmqConsumerGroup#consume_enable}
  */
  readonly consumeEnable: boolean | cdktf.IResolvable;
  /**
  * `true`: Sequential delivery, `false`: Concurrent delivery.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/trocket_rocketmq_consumer_group#consume_message_orderly TrocketRocketmqConsumerGroup#consume_message_orderly}
  */
  readonly consumeMessageOrderly: boolean | cdktf.IResolvable;
  /**
  * Name of consumer group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/trocket_rocketmq_consumer_group#consumer_group TrocketRocketmqConsumerGroup#consumer_group}
  */
  readonly consumerGroup: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/trocket_rocketmq_consumer_group#id TrocketRocketmqConsumerGroup#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/trocket_rocketmq_consumer_group#instance_id TrocketRocketmqConsumerGroup#instance_id}
  */
  readonly instanceId: string;
  /**
  * Max retry times.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/trocket_rocketmq_consumer_group#max_retry_times TrocketRocketmqConsumerGroup#max_retry_times}
  */
  readonly maxRetryTimes: number;
  /**
  * remark.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/trocket_rocketmq_consumer_group#remark TrocketRocketmqConsumerGroup#remark}
  */
  readonly remark?: string;
  /**
  * Tag of consumer group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/trocket_rocketmq_consumer_group#tags TrocketRocketmqConsumerGroup#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/trocket_rocketmq_consumer_group tencentcloud_trocket_rocketmq_consumer_group}
*/
export class TrocketRocketmqConsumerGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrocketRocketmqConsumerGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/trocket_rocketmq_consumer_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/trocket_rocketmq_consumer_group tencentcloud_trocket_rocketmq_consumer_group} Resource
  *
  * @param scope The scope in which to define this construct
