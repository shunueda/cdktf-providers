// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/monitor_binding_receiver
...
export interface MonitorBindingReceiverConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/monitor_binding_receiver#group_id MonitorBindingReceiver#group_id}
  */
  readonly groupId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/monitor_binding_receiver#id MonitorBindingReceiver#id}
  *
  ...
  * receivers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/monitor_binding_receiver#receivers MonitorBindingReceiver#receivers}
  */
...
export interface MonitorBindingReceiverReceivers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/monitor_binding_receiver#end_time MonitorBindingReceiver#end_time}
  */
  readonly endTime?: number;
  /**
  * Method of warning notification.Optional `CALL`,`EMAIL`,`SITE`,`SMS`,`WECHAT`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/monitor_binding_receiver#notify_way MonitorBindingReceiver#notify_way}
  */
  readonly notifyWay: string[];
  /**
  * Alert sending language. Optional `en-US`,`zh-CN`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/monitor_binding_receiver#receive_language MonitorBindingReceiver#receive_language}
  */
  readonly receiveLanguage?: string;
  /**
  * Alarm receive group ID list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/monitor_binding_receiver#receiver_group_list MonitorBindingReceiver#receiver_group_list}
  */
  readonly receiverGroupList?: number[];
  /**
  * Receive type. Optional `group`,`user`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/monitor_binding_receiver#receiver_type MonitorBindingReceiver#receiver_type}
  */
  readonly receiverType: string;
  /**
  * Alarm receiver ID list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/monitor_binding_receiver#receiver_user_list MonitorBindingReceiver#receiver_user_list}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/monitor_binding_receiver#start_time MonitorBindingReceiver#start_time}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/monitor_binding_receiver tencentcloud_monitor_binding_receiver}
*/
export class MonitorBindingReceiver extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorBindingReceiver that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/monitor_binding_receiver#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/monitor_binding_receiver tencentcloud_monitor_binding_receiver} Resource
  *
  * @param scope The scope in which to define this construct
