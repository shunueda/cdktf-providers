// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/rum_project
...
export interface RumProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/rum_project#desc RumProject#desc}
  */
  readonly desc?: string;
  /**
  * Whether to enable aggregation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/rum_project#enable_url_group RumProject#enable_url_group}
  */
  readonly enableUrlGroup: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/rum_project#id RumProject#id}
  *
  ...
  * Business system ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/rum_project#instance_id RumProject#instance_id}
  */
  readonly instanceId: string;
  /**
  * Name of the created project (required and up to 200 characters).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/rum_project#name RumProject#name}
  */
  readonly name: string;
  /**
  * Project sampling rate (greater than or equal to 0).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/rum_project#rate RumProject#rate}
  */
  readonly rate: string;
  /**
  * Repository address of the project (optional and up to 256 characters).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/rum_project#repo RumProject#repo}
  */
  readonly repo?: string;
  /**
  * Project type (valid values: `web`, `mp`, `android`, `ios`, `node`, `hippy`, `weex`, `viola`, `rn`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/rum_project#type RumProject#type}
  */
  readonly type: string;
  /**
  * Webpage address of the project (optional and up to 256 characters).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/rum_project#url RumProject#url}
  */
  readonly url?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/rum_project tencentcloud_rum_project}
*/
export class RumProject extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RumProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/rum_project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/rum_project tencentcloud_rum_project} Resource
  *
  * @param scope The scope in which to define this construct
