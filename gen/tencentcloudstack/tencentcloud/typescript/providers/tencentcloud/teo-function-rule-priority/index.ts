// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/teo_function_rule_priority
...
export interface TeoFunctionRulePriorityConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the Function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/teo_function_rule_priority#function_id TeoFunctionRulePriority#function_id}
  */
  readonly functionId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/teo_function_rule_priority#id TeoFunctionRulePriority#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/teo_function_rule_priority#rule_ids TeoFunctionRulePriority#rule_ids}
  */
  readonly ruleIds: string[];
  /**
  * ID of the site.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/teo_function_rule_priority#zone_id TeoFunctionRulePriority#zone_id}
  */
  readonly zoneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/teo_function_rule_priority tencentcloud_teo_function_rule_priority}
*/
export class TeoFunctionRulePriority extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeoFunctionRulePriority that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/teo_function_rule_priority#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/teo_function_rule_priority tencentcloud_teo_function_rule_priority} Resource
  *
  * @param scope The scope in which to define this construct
