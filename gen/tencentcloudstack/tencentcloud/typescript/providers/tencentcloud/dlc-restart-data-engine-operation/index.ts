// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dlc_restart_data_engine_operation
...
export interface DlcRestartDataEngineOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Engine ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dlc_restart_data_engine_operation#data_engine_id DlcRestartDataEngineOperation#data_engine_id}
  */
  readonly dataEngineId: string;
  /**
  * Whether to restart by force and ignore tasks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dlc_restart_data_engine_operation#forced_operation DlcRestartDataEngineOperation#forced_operation}
  */
  readonly forcedOperation?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dlc_restart_data_engine_operation#id DlcRestartDataEngineOperation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dlc_restart_data_engine_operation tencentcloud_dlc_restart_data_engine_operation}
*/
export class DlcRestartDataEngineOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DlcRestartDataEngineOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dlc_restart_data_engine_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dlc_restart_data_engine_operation tencentcloud_dlc_restart_data_engine_operation} Resource
  *
  * @param scope The scope in which to define this construct
