// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/ssl_check_certificate_domain_verification_operation
...
export interface SslCheckCertificateDomainVerificationOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  * The certificate ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/ssl_check_certificate_domain_verification_operation#certificate_id SslCheckCertificateDomainVerificationOperation#certificate_id}
  */
  readonly certificateId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/ssl_check_certificate_domain_verification_operation#id SslCheckCertificateDomainVerificationOperation#id}
  *
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/ssl_check_certificate_domain_verification_operation#timeouts SslCheckCertificateDomainVerificationOperation#timeouts}
  */
...
export interface SslCheckCertificateDomainVerificationOperationTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/ssl_check_certificate_domain_verification_operation#create SslCheckCertificateDomainVerificationOperation#create}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/ssl_check_certificate_domain_verification_operation tencentcloud_ssl_check_certificate_domain_verification_operation}
*/
export class SslCheckCertificateDomainVerificationOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslCheckCertificateDomainVerificationOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/ssl_check_certificate_domain_verification_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/ssl_check_certificate_domain_verification_operation tencentcloud_ssl_check_certificate_domain_verification_operation} Resource
  *
  * @param scope The scope in which to define this construct
