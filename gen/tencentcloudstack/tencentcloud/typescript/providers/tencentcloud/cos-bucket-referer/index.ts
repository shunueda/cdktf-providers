// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cos_bucket_referer
...
export interface CosBucketRefererConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cos_bucket_referer#bucket CosBucketReferer#bucket}
  */
  readonly bucket: string;
  /**
  * A list of domain names in the blocklist/allowlist.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cos_bucket_referer#domain_list CosBucketReferer#domain_list}
  */
  readonly domainList: string[];
  /**
  * Whether to allow access with an empty referer. Enumerated values: `Allow`, `Deny` (default).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cos_bucket_referer#empty_refer_configuration CosBucketReferer#empty_refer_configuration}
  */
  readonly emptyReferConfiguration?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cos_bucket_referer#id CosBucketReferer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cos_bucket_referer#referer_type CosBucketReferer#referer_type}
  */
  readonly refererType: string;
  /**
  * Whether to enable hotlink protection. Enumerated values: `Enabled`, `Disabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cos_bucket_referer#status CosBucketReferer#status}
  */
  readonly status: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cos_bucket_referer tencentcloud_cos_bucket_referer}
*/
export class CosBucketReferer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CosBucketReferer that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cos_bucket_referer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cos_bucket_referer tencentcloud_cos_bucket_referer} Resource
  *
  * @param scope The scope in which to define this construct
