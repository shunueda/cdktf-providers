// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/elasticsearch_index
...
export interface ElasticsearchIndexConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/elasticsearch_index#id ElasticsearchIndex#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/elasticsearch_index#index_meta_json ElasticsearchIndex#index_meta_json}
  */
  readonly indexMetaJson?: string;
  /**
  * index name to create.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/elasticsearch_index#index_name ElasticsearchIndex#index_name}
  */
  readonly indexName: string;
  /**
  * type of the index to be created. auto: autonomous index. normal: indicates a common index.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/elasticsearch_index#index_type ElasticsearchIndex#index_type}
  */
  readonly indexType: string;
  /**
  * es instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/elasticsearch_index#instance_id ElasticsearchIndex#instance_id}
  */
  readonly instanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/elasticsearch_index tencentcloud_elasticsearch_index}
*/
export class ElasticsearchIndex extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticsearchIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/elasticsearch_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/elasticsearch_index tencentcloud_elasticsearch_index} Resource
  *
  * @param scope The scope in which to define this construct
