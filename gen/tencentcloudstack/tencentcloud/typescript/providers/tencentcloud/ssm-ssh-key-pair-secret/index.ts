// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ssm_ssh_key_pair_secret
...
export interface SsmSshKeyPairSecretConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ssm_ssh_key_pair_secret#clean_ssh_key SsmSshKeyPairSecret#clean_ssh_key}
  */
  readonly cleanSshKey?: boolean | cdktf.IResolvable;
  /**
  * Description, such as what it is used for. It contains up to 2,048 bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ssm_ssh_key_pair_secret#description SsmSshKeyPairSecret#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ssm_ssh_key_pair_secret#id SsmSshKeyPairSecret#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ssm_ssh_key_pair_secret#kms_key_id SsmSshKeyPairSecret#kms_key_id}
  */
  readonly kmsKeyId?: string;
  /**
  * ID of the project to which the created SSH key belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ssm_ssh_key_pair_secret#project_id SsmSshKeyPairSecret#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ssm_ssh_key_pair_secret#secret_name SsmSshKeyPairSecret#secret_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ssm_ssh_key_pair_secret#ssh_key_name SsmSshKeyPairSecret#ssh_key_name}
  */
  readonly sshKeyName?: string;
  /**
  * Enable or Disable Secret. Valid values is `Enabled` or `Disabled`. Default is `Enabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ssm_ssh_key_pair_secret#status SsmSshKeyPairSecret#status}
  */
  readonly status?: string;
  /**
  * Tags of secret.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ssm_ssh_key_pair_secret#tags SsmSshKeyPairSecret#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ssm_ssh_key_pair_secret tencentcloud_ssm_ssh_key_pair_secret}
*/
export class SsmSshKeyPairSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SsmSshKeyPairSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ssm_ssh_key_pair_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ssm_ssh_key_pair_secret tencentcloud_ssm_ssh_key_pair_secret} Resource
  *
  * @param scope The scope in which to define this construct
