// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_isolate_instance
...
export interface MysqlIsolateInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_isolate_instance#id MysqlIsolateInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_isolate_instance#instance_id MysqlIsolateInstance#instance_id}
  */
  readonly instanceId: string;
  /**
  * Manipulate instance, `isolate` - isolate instance, `recover`- recover isolated instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_isolate_instance#operate MysqlIsolateInstance#operate}
  */
  readonly operate: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_isolate_instance tencentcloud_mysql_isolate_instance}
*/
export class MysqlIsolateInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlIsolateInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_isolate_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_isolate_instance tencentcloud_mysql_isolate_instance} Resource
  *
  * @param scope The scope in which to define this construct
