// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_project_member
...
export interface WedataProjectMemberConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_project_member#id WedataProjectMember#id}
  *
  ...
  * Project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_project_member#project_id WedataProjectMember#project_id}
  */
  readonly projectId: string;
  /**
  * Role ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_project_member#role_ids WedataProjectMember#role_ids}
  */
  readonly roleIds: string[];
  /**
  * User ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_project_member#user_uin WedataProjectMember#user_uin}
  */
  readonly userUin: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_project_member tencentcloud_wedata_project_member}
*/
export class WedataProjectMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WedataProjectMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_project_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_project_member tencentcloud_wedata_project_member} Resource
  *
  * @param scope The scope in which to define this construct
