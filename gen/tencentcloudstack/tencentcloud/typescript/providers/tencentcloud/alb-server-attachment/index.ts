// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/alb_server_attachment
...
export interface AlbServerAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/alb_server_attachment#id AlbServerAttachment#id}
  *
  ...
  * listener ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/alb_server_attachment#listener_id AlbServerAttachment#listener_id}
  */
  readonly listenerId: string;
  /**
  * loadbalancer ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/alb_server_attachment#loadbalancer_id AlbServerAttachment#loadbalancer_id}
  */
  readonly loadbalancerId: string;
  /**
  * location ID, only support for layer 7 loadbalancer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/alb_server_attachment#location_id AlbServerAttachment#location_id}
  */
  readonly locationId?: string;
  /**
  * backends block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/alb_server_attachment#backends AlbServerAttachment#backends}
  */
...
export interface AlbServerAttachmentBackends {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/alb_server_attachment#instance_id AlbServerAttachment#instance_id}
  */
  readonly instanceId: string;
  /**
  * The port used by the backend server. Valid value range: [1-65535].
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/alb_server_attachment#port AlbServerAttachment#port}
  */
  readonly port: number;
  /**
  * Weight of the backend server. Valid value range: [0-100]. Default to 10.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/alb_server_attachment#weight AlbServerAttachment#weight}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/alb_server_attachment tencentcloud_alb_server_attachment}
*/
export class AlbServerAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AlbServerAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/alb_server_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/alb_server_attachment tencentcloud_alb_server_attachment} Resource
  *
  * @param scope The scope in which to define this construct
