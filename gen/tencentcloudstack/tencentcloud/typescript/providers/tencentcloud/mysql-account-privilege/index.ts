// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_account_privilege
...
export interface MysqlAccountPrivilegeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_account_privilege#account_host MysqlAccountPrivilege#account_host}
  */
  readonly accountHost?: string;
  /**
  * Account name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_account_privilege#account_name MysqlAccountPrivilege#account_name}
  */
  readonly accountName: string;
  /**
  * List of specified database name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_account_privilege#database_names MysqlAccountPrivilege#database_names}
  */
  readonly databaseNames: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_account_privilege#id MysqlAccountPrivilege#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_account_privilege#mysql_id MysqlAccountPrivilege#mysql_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_account_privilege#privileges MysqlAccountPrivilege#privileges}
  */
  readonly privileges?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_account_privilege tencentcloud_mysql_account_privilege}
*/
export class MysqlAccountPrivilege extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlAccountPrivilege that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_account_privilege#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_account_privilege tencentcloud_mysql_account_privilege} Resource
  *
  * @param scope The scope in which to define this construct
