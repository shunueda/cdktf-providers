// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_backup_download_restriction
...
export interface MysqlBackupDownloadRestrictionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_backup_download_restriction#id MysqlBackupDownloadRestriction#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_backup_download_restriction#ip_comparison_symbol MysqlBackupDownloadRestriction#ip_comparison_symbol}
  */
  readonly ipComparisonSymbol?: string;
  /**
  * ip settings to limit downloads.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_backup_download_restriction#limit_ip MysqlBackupDownloadRestriction#limit_ip}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_backup_download_restriction#limit_type MysqlBackupDownloadRestriction#limit_type}
  */
  readonly limitType: string;
  /**
  * This parameter only supports In, which means that the vpc specified by LimitVpc can be downloaded. The default is In.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_backup_download_restriction#vpc_comparison_symbol MysqlBackupDownloadRestriction#vpc_comparison_symbol}
  */
  readonly vpcComparisonSymbol?: string;
  /**
  * limit_vpc block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_backup_download_restriction#limit_vpc MysqlBackupDownloadRestriction#limit_vpc}
  */
...
export interface MysqlBackupDownloadRestrictionLimitVpc {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_backup_download_restriction#region MysqlBackupDownloadRestriction#region}
  */
  readonly region: string;
  /**
  * List of vpcs to limit downloads.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_backup_download_restriction#vpc_list MysqlBackupDownloadRestriction#vpc_list}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_backup_download_restriction tencentcloud_mysql_backup_download_restriction}
*/
export class MysqlBackupDownloadRestriction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlBackupDownloadRestriction that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_backup_download_restriction#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/mysql_backup_download_restriction tencentcloud_mysql_backup_download_restriction} Resource
  *
  * @param scope The scope in which to define this construct
