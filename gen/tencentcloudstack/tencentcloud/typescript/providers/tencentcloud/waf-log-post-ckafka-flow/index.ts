// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow
...
export interface WafLogPostCkafkaFlowConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#brokers WafLogPostCkafkaFlow#brokers}
  */
  readonly brokers: string;
  /**
  * CKafka ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#ckafka_id WafLogPostCkafkaFlow#ckafka_id}
  */
  readonly ckafkaId: string;
  /**
  * The region where CKafka is located for delivery.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#ckafka_region WafLogPostCkafkaFlow#ckafka_region}
  */
  readonly ckafkaRegion: string;
  /**
  * Default to none, supports snappy, gzip, and lz4 compression, recommended snappy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#compression WafLogPostCkafkaFlow#compression}
  */
  readonly compression: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#id WafLogPostCkafkaFlow#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#kafka_version WafLogPostCkafkaFlow#kafka_version}
  */
  readonly kafkaVersion: string;
  /**
  * 1- Access log, 2- Attack log, the default is access log.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#log_type WafLogPostCkafkaFlow#log_type}
  */
  readonly logType: number;
  /**
  * Whether to enable SASL verification, default not enabled, 0-off, 1-on.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#sasl_enable WafLogPostCkafkaFlow#sasl_enable}
  */
  readonly saslEnable?: number;
  /**
  * SASL password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#sasl_password WafLogPostCkafkaFlow#sasl_password}
  */
  readonly saslPassword?: string;
  /**
  * SASL username.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#sasl_user WafLogPostCkafkaFlow#sasl_user}
  */
  readonly saslUser?: string;
  /**
  * Theme name, default not to pass or pass empty string, default value is waf_post_access_log.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#topic WafLogPostCkafkaFlow#topic}
  */
  readonly topic: string;
  /**
  * 1. External network TGW, 2. Supporting environment, default is supporting environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#vip_type WafLogPostCkafkaFlow#vip_type}
  */
  readonly vipType: number;
  /**
  * write_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#write_config WafLogPostCkafkaFlow#write_config}
  */
...
export interface WafLogPostCkafkaFlowWriteConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#enable_body WafLogPostCkafkaFlow#enable_body}
  */
  readonly enableBody?: number;
  /**
  * 1: Enable 0: Do not enable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#enable_bot WafLogPostCkafkaFlow#enable_bot}
  */
  readonly enableBot?: number;
  /**
  * 1: Enable 0: Do not enable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#enable_headers WafLogPostCkafkaFlow#enable_headers}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow tencentcloud_waf_log_post_ckafka_flow}
*/
export class WafLogPostCkafkaFlow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafLogPostCkafkaFlow that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/waf_log_post_ckafka_flow tencentcloud_waf_log_post_ckafka_flow} Resource
  *
  * @param scope The scope in which to define this construct
