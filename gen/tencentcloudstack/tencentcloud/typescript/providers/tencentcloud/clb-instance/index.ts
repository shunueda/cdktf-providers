// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance
...
export interface ClbInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#address_ip_version ClbInstance#address_ip_version}
  */
  readonly addressIpVersion?: string;
  /**
  * The associated terminal node ID; passing an empty string indicates unassociating the node.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#associate_endpoint ClbInstance#associate_endpoint}
  */
  readonly associateEndpoint?: string;
  /**
  * Bandwidth package id. If set, the `internet_charge_type` must be `BANDWIDTH_PACKAGE`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#bandwidth_package_id ClbInstance#bandwidth_package_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#clb_name ClbInstance#clb_name}
  */
  readonly clbName: string;
  /**
  * Cluster ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#cluster_id ClbInstance#cluster_id}
  */
  readonly clusterId?: string;
  /**
  * Whether to enable delete protection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#delete_protect ClbInstance#delete_protect}
  */
  readonly deleteProtect?: boolean | cdktf.IResolvable;
  /**
  * If create dynamic vip CLB instance, `true` or `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#dynamic_vip ClbInstance#dynamic_vip}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#eip_address_id ClbInstance#eip_address_id}
  */
  readonly eipAddressId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#id ClbInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#internet_bandwidth_max_out ClbInstance#internet_bandwidth_max_out}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#internet_charge_type ClbInstance#internet_charge_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#load_balancer_pass_to_target ClbInstance#load_balancer_pass_to_target}
  */
  readonly loadBalancerPassToTarget?: boolean | cdktf.IResolvable;
  /**
  * The id of log set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#log_set_id ClbInstance#log_set_id}
  */
  readonly logSetId?: string;
  /**
  * The id of log topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#log_topic_id ClbInstance#log_topic_id}
  */
  readonly logTopicId?: string;
  /**
  * Setting master zone id of cross available zone disaster recovery, only applicable to open CLB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#master_zone_id ClbInstance#master_zone_id}
  */
  readonly masterZoneId?: string;
  /**
  * Type of CLB instance. Valid values: `OPEN` and `INTERNAL`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#network_type ClbInstance#network_type}
  */
  readonly networkType: string;
  /**
  * ID of the project within the CLB instance, `0` - Default Project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#project_id ClbInstance#project_id}
  */
  readonly projectId?: number;
  /**
  * Security groups of the CLB instance. Supports both `OPEN` and `INTERNAL` CLBs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#security_groups ClbInstance#security_groups}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#sla_type ClbInstance#sla_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#slave_zone_id ClbInstance#slave_zone_id}
  */
  readonly slaveZoneId?: string;
  /**
  * Indicates whether Binding IPs of other VPCs feature switch.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#snat_pro ClbInstance#snat_pro}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#subnet_id ClbInstance#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * The available tags within this CLB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#tags ClbInstance#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Region information of backend services are attached the CLB instance. Only supports `OPEN` CLBs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#target_region_info_region ClbInstance#target_region_info_region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#target_region_info_vpc_id ClbInstance#target_region_info_vpc_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#vip ClbInstance#vip}
  */
  readonly vip?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#vip_isp ClbInstance#vip_isp}
  */
  readonly vipIsp?: string;
  /**
  * VPC ID of the CLB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#vpc_id ClbInstance#vpc_id}
  */
  readonly vpcId?: string;
  /**
  * Available zone id, only applicable to open CLB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#zone_id ClbInstance#zone_id}
  */
  readonly zoneId?: string;
  /**
  * snat_ips block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#snat_ips ClbInstance#snat_ips}
  */
...
export interface ClbInstanceSnatIps {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#ip ClbInstance#ip}
  */
  readonly ip?: string;
  /**
  * Snat subnet ID.
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance tencentcloud_clb_instance}
*/
export class ClbInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance tencentcloud_clb_instance} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ClbInstanceConfig) {
    ...
    this._associateEndpoint = config.associateEndpoint;
  ...
  // associate_endpoint - computed: false, optional: true, required: false
  private _associateEndpoint?: string; 
  public get associateEndpoint() {
    return this.getStringAttribute('associate_endpoint');
  }
  public set associateEndpoint(value: string) {
    this._associateEndpoint = value;
  }
  public resetAssociateEndpoint() {
    this._associateEndpoint = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get associateEndpointInput() {
    return this._associateEndpoint;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      associate_endpoint: cdktf.stringToTerraform(this._associateEndpoint),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      associate_endpoint: {
        value: cdktf.stringToHclTerraform(this._associateEndpoint),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
