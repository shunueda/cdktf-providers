// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis
...
export interface DataTencentcloudEnisConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis#description DataTencentcloudEnis#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis#id DataTencentcloudEnis#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis#ids DataTencentcloudEnis#ids}
  */
  readonly ids?: string[];
  /**
  * ID of the instance which bind the ENI. Conflict with `ids`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis#instance_id DataTencentcloudEnis#instance_id}
  */
  readonly instanceId?: string;
  /**
  * Intranet IP of the ENI. Conflict with `ids`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis#ipv4 DataTencentcloudEnis#ipv4}
  */
  readonly ipv4?: string;
  /**
  * Name of the ENI to be queried. Conflict with `ids`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis#name DataTencentcloudEnis#name}
  */
  readonly name?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis#result_output_file DataTencentcloudEnis#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * A set of security group IDs which bind the ENI. Conflict with `ids`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis#security_group DataTencentcloudEnis#security_group}
  */
  readonly securityGroup?: string;
  /**
  * ID of the subnet within this vpc to be queried. Conflict with `ids`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis#subnet_id DataTencentcloudEnis#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * Tags of the ENI. Conflict with `ids`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis#tags DataTencentcloudEnis#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * ID of the vpc to be queried. Conflict with `ids`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis#vpc_id DataTencentcloudEnis#vpc_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis tencentcloud_enis}
*/
export class DataTencentcloudEnis extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudEnis that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/enis tencentcloud_enis} Data Source
  *
  * @param scope The scope in which to define this construct
