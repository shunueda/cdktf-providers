// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cam_access_key
...
export interface CamAccessKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cam_access_key#access_key CamAccessKey#access_key}
  */
  readonly accessKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cam_access_key#id CamAccessKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cam_access_key#pgp_key CamAccessKey#pgp_key}
  */
  readonly pgpKey?: string;
  /**
  * Key status, activated (Active) or inactive (Inactive), required when updating.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cam_access_key#status CamAccessKey#status}
  */
  readonly status?: string;
  /**
  * Specify user Uin, if not filled, the access key is created for the current user by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cam_access_key#target_uin CamAccessKey#target_uin}
  */
  readonly targetUin?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cam_access_key tencentcloud_cam_access_key}
*/
export class CamAccessKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CamAccessKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cam_access_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cam_access_key tencentcloud_cam_access_key} Resource
  *
  * @param scope The scope in which to define this construct
