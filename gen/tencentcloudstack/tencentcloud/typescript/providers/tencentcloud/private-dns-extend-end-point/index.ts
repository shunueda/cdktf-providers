// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/private_dns_extend_end_point
...
export interface PrivateDnsExtendEndPointConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/private_dns_extend_end_point#end_point_name PrivateDnsExtendEndPoint#end_point_name}
  */
  readonly endPointName: string;
  /**
  * The region of the outbound endpoint must be consistent with the region of the forwarding target VIP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/private_dns_extend_end_point#end_point_region PrivateDnsExtendEndPoint#end_point_region}
  */
  readonly endPointRegion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/private_dns_extend_end_point#id PrivateDnsExtendEndPoint#id}
  *
  ...
  * forward_ip block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/private_dns_extend_end_point#forward_ip PrivateDnsExtendEndPoint#forward_ip}
  */
...
export interface PrivateDnsExtendEndPointForwardIp {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/private_dns_extend_end_point#access_gateway_id PrivateDnsExtendEndPoint#access_gateway_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/private_dns_extend_end_point#access_type PrivateDnsExtendEndPoint#access_type}
  */
  readonly accessType: string;
  /**
  * Forwarding target IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/private_dns_extend_end_point#host PrivateDnsExtendEndPoint#host}
  */
  readonly host: string;
  /**
  * Specifies the forwarding IP port number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/private_dns_extend_end_point#port PrivateDnsExtendEndPoint#port}
  */
  readonly port: number;
  /**
  * Unique VPC ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/private_dns_extend_end_point#vpc_id PrivateDnsExtendEndPoint#vpc_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/private_dns_extend_end_point tencentcloud_private_dns_extend_end_point}
*/
export class PrivateDnsExtendEndPoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivateDnsExtendEndPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/private_dns_extend_end_point#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/private_dns_extend_end_point tencentcloud_private_dns_extend_end_point} Resource
  *
  * @param scope The scope in which to define this construct
