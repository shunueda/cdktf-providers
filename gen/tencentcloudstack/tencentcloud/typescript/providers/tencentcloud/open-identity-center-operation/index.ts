// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/open_identity_center_operation
...
export interface OpenIdentityCenterOperationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/open_identity_center_operation#id OpenIdentityCenterOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/open_identity_center_operation#zone_name OpenIdentityCenterOperation#zone_name}
  */
  readonly zoneName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/open_identity_center_operation tencentcloud_open_identity_center_operation}
*/
export class OpenIdentityCenterOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpenIdentityCenterOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/open_identity_center_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/open_identity_center_operation tencentcloud_open_identity_center_operation} Resource
  *
  * @param scope The scope in which to define this construct
