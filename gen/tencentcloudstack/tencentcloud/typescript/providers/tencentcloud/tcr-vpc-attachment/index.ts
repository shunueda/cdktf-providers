// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcr_vpc_attachment
...
export interface TcrVpcAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcr_vpc_attachment#enable_public_domain_dns TcrVpcAttachment#enable_public_domain_dns}
  */
  readonly enablePublicDomainDns?: boolean | cdktf.IResolvable;
  /**
  * Whether to enable vpc domain dns. Default value is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcr_vpc_attachment#enable_vpc_domain_dns TcrVpcAttachment#enable_vpc_domain_dns}
  */
  readonly enableVpcDomainDns?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcr_vpc_attachment#id TcrVpcAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcr_vpc_attachment#instance_id TcrVpcAttachment#instance_id}
  */
  readonly instanceId: string;
  /**
  * ID of region. Conflict with region_name, can not be set at the same time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcr_vpc_attachment#region_id TcrVpcAttachment#region_id}
  */
  readonly regionId?: number;
  /**
  * Name of region. Conflict with region_id, can not be set at the same time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcr_vpc_attachment#region_name TcrVpcAttachment#region_name}
  */
  readonly regionName?: string;
  /**
  * ID of subnet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcr_vpc_attachment#subnet_id TcrVpcAttachment#subnet_id}
  */
  readonly subnetId: string;
  /**
  * ID of VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcr_vpc_attachment#vpc_id TcrVpcAttachment#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcr_vpc_attachment tencentcloud_tcr_vpc_attachment}
*/
export class TcrVpcAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TcrVpcAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcr_vpc_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcr_vpc_attachment tencentcloud_tcr_vpc_attachment} Resource
  *
  * @param scope The scope in which to define this construct
