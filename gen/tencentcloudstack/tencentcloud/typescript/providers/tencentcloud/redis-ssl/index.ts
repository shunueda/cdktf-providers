// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_ssl
...
export interface RedisSslConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_ssl#id RedisSsl#id}
  *
  ...
  * The ID of instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_ssl#instance_id RedisSsl#instance_id}
  */
  readonly instanceId: string;
  /**
  * The SSL configuration status of the instance: `enabled`,`disabled`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_ssl#ssl_config RedisSsl#ssl_config}
  */
  readonly sslConfig: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_ssl tencentcloud_redis_ssl}
*/
export class RedisSsl extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisSsl that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_ssl#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/redis_ssl tencentcloud_redis_ssl} Resource
  *
  * @param scope The scope in which to define this construct
