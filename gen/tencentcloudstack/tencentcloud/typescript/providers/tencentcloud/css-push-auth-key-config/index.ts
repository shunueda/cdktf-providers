// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/css_push_auth_key_config
...
export interface CssPushAuthKeyConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/css_push_auth_key_config#auth_delta CssPushAuthKeyConfig#auth_delta}
  */
  readonly authDelta?: number;
  /**
  * Standby authentication key. No transfer means that the current value is not modified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/css_push_auth_key_config#backup_auth_key CssPushAuthKeyConfig#backup_auth_key}
  */
  readonly backupAuthKey?: string;
  /**
  * Domain Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/css_push_auth_key_config#domain_name CssPushAuthKeyConfig#domain_name}
  */
  readonly domainName: string;
  /**
  * Enable or not, 0: Close, 1: Enable. No transfer means that the current value is not modified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/css_push_auth_key_config#enable CssPushAuthKeyConfig#enable}
  */
  readonly enable?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/css_push_auth_key_config#id CssPushAuthKeyConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/css_push_auth_key_config#master_auth_key CssPushAuthKeyConfig#master_auth_key}
  */
  readonly masterAuthKey?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/css_push_auth_key_config tencentcloud_css_push_auth_key_config}
*/
export class CssPushAuthKeyConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CssPushAuthKeyConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/css_push_auth_key_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/css_push_auth_key_config tencentcloud_css_push_auth_key_config} Resource
  *
  * @param scope The scope in which to define this construct
