// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_ops_stop_task_async
...
export interface WedataOpsStopTaskAsyncConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_ops_stop_task_async#id WedataOpsStopTaskAsync#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_ops_stop_task_async#kill_instance WedataOpsStopTaskAsync#kill_instance}
  */
  readonly killInstance?: boolean | cdktf.IResolvable;
  /**
  * Project id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_ops_stop_task_async#project_id WedataOpsStopTaskAsync#project_id}
  */
  readonly projectId: string;
  /**
  * Task id list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_ops_stop_task_async#task_ids WedataOpsStopTaskAsync#task_ids}
  */
  readonly taskIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_ops_stop_task_async tencentcloud_wedata_ops_stop_task_async}
*/
export class WedataOpsStopTaskAsync extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WedataOpsStopTaskAsync that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_ops_stop_task_async#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/wedata_ops_stop_task_async tencentcloud_wedata_ops_stop_task_async} Resource
  *
  * @param scope The scope in which to define this construct
