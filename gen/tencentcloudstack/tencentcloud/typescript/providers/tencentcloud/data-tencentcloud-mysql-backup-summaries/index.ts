// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/mysql_backup_summaries
...
export interface DataTencentcloudMysqlBackupSummariesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/mysql_backup_summaries#id DataTencentcloudMysqlBackupSummaries#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/mysql_backup_summaries#order_by DataTencentcloudMysqlBackupSummaries#order_by}
  */
  readonly orderBy?: string;
  /**
  * Specify the sorting direction, optional values include: ASC: forward order, DESC: reverse order. The default is ASC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/mysql_backup_summaries#order_direction DataTencentcloudMysqlBackupSummaries#order_direction}
  */
  readonly orderDirection?: string;
  /**
  * The type of cloud database product to be queried, currently only supports `mysql`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/mysql_backup_summaries#product DataTencentcloudMysqlBackupSummaries#product}
  */
  readonly product: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/mysql_backup_summaries#result_output_file DataTencentcloudMysqlBackupSummaries#result_output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/mysql_backup_summaries tencentcloud_mysql_backup_summaries}
*/
export class DataTencentcloudMysqlBackupSummaries extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudMysqlBackupSummaries that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/mysql_backup_summaries#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/data-sources/mysql_backup_summaries tencentcloud_mysql_backup_summaries} Data Source
  *
  * @param scope The scope in which to define this construct
