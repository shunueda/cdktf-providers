// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/sms_sign
...
export interface SmsSignConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/sms_sign#commission_image SmsSign#commission_image}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/sms_sign#document_type SmsSign#document_type}
  */
  readonly documentType: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/sms_sign#id SmsSign#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/sms_sign#international SmsSign#international}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/sms_sign#proof_image SmsSign#proof_image}
  */
  readonly proofImage: string;
  /**
  * Signature application remarks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/sms_sign#remark SmsSign#remark}
  */
  readonly remark?: string;
  /**
  * Sms sign name, unique.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/sms_sign#sign_name SmsSign#sign_name}
  */
  readonly signName: string;
  /**
  * Signature purpose: 0: for personal use; 1: for others.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/sms_sign#sign_purpose SmsSign#sign_purpose}
  */
  readonly signPurpose: number;
  /**
  * Sms sign type: 0, 1, 2, 3, 4, 5, 6.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/sms_sign#sign_type SmsSign#sign_type}
  */
  readonly signType: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/sms_sign tencentcloud_sms_sign}
*/
export class SmsSign extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SmsSign that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/sms_sign#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/sms_sign tencentcloud_sms_sign} Resource
  *
  * @param scope The scope in which to define this construct
