// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule
...
export interface DayuL7RuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#domain DayuL7Rule#domain}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#health_check_code DayuL7Rule#health_check_code}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#health_check_health_num DayuL7Rule#health_check_health_num}
  */
  readonly healthCheckHealthNum?: number;
  /**
  * Interval time of health check. Valid value ranges: [10~60]sec. The default is 15 sec.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#health_check_interval DayuL7Rule#health_check_interval}
  */
  readonly healthCheckInterval?: number;
  /**
  * Methods of health check. The default is 'HEAD', the available value are 'HEAD' and 'GET'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#health_check_method DayuL7Rule#health_check_method}
  */
  readonly healthCheckMethod?: string;
  /**
  * Path of health check. The default is `/`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#health_check_path DayuL7Rule#health_check_path}
  */
  readonly healthCheckPath?: string;
  /**
  * Indicates whether health check is enabled. The default is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#health_check_switch DayuL7Rule#health_check_switch}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#health_check_unhealth_num DayuL7Rule#health_check_unhealth_num}
  */
  readonly healthCheckUnhealthNum?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#id DayuL7Rule#id}
  *
  ...
  * Name of the rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#name DayuL7Rule#name}
  */
  readonly name: string;
  /**
  * Protocol of the rule. Valid values: `http`, `https`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#protocol DayuL7Rule#protocol}
  */
  readonly protocol: string;
  /**
  * ID of the resource that the layer 7 rule works for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#resource_id DayuL7Rule#resource_id}
  */
  readonly resourceId: string;
  /**
  * Type of the resource that the layer 7 rule works for, valid value is `bgpip`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#resource_type DayuL7Rule#resource_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#source_list DayuL7Rule#source_list}
  */
  readonly sourceList: string[];
  /**
  * Source type, `1` for source of host, `2` for source of IP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#source_type DayuL7Rule#source_type}
  */
  readonly sourceType: number;
  /**
  * SSL ID, when the `protocol` is `https`, the field should be set with valid SSL id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#ssl_id DayuL7Rule#ssl_id}
  */
  readonly sslId?: string;
  /**
  * Indicate the rule will take effect or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#switch DayuL7Rule#switch}
  */
  readonly switch: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule tencentcloud_dayu_l7_rule}
*/
export class DayuL7Rule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DayuL7Rule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dayu_l7_rule tencentcloud_dayu_l7_rule} Resource
  *
  * @param scope The scope in which to define this construct
