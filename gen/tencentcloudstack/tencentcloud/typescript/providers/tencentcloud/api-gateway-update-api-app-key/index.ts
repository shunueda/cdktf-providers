// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_update_api_app_key
...
export interface ApiGatewayUpdateApiAppKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_update_api_app_key#api_app_id ApiGatewayUpdateApiAppKey#api_app_id}
  */
  readonly apiAppId: string;
  /**
  * Key of the application.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_update_api_app_key#api_app_key ApiGatewayUpdateApiAppKey#api_app_key}
  */
  readonly apiAppKey: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_update_api_app_key#id ApiGatewayUpdateApiAppKey#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_update_api_app_key tencentcloud_api_gateway_update_api_app_key}
*/
export class ApiGatewayUpdateApiAppKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayUpdateApiAppKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_update_api_app_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_update_api_app_key tencentcloud_api_gateway_update_api_app_key} Resource
  *
  * @param scope The scope in which to define this construct
