// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/mysql_backup_list
...
export interface DataTencentcloudMysqlBackupListConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/mysql_backup_list#id DataTencentcloudMysqlBackupList#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/mysql_backup_list#max_number DataTencentcloudMysqlBackupList#max_number}
  */
  readonly maxNumber?: number;
  /**
  * Instance ID, such as `cdb-c1nl9rpv`. It is identical to the instance ID displayed in the database console page.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/mysql_backup_list#mysql_id DataTencentcloudMysqlBackupList#mysql_id}
  */
  readonly mysqlId: string;
  /**
  * Used to store results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/mysql_backup_list#result_output_file DataTencentcloudMysqlBackupList#result_output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/mysql_backup_list tencentcloud_mysql_backup_list}
*/
export class DataTencentcloudMysqlBackupList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudMysqlBackupList that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/mysql_backup_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/mysql_backup_list tencentcloud_mysql_backup_list} Data Source
  *
  * @param scope The scope in which to define this construct
