// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/teo_l7_acc_rule_priority_operation
...
export interface TeoL7AccRulePriorityOperationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/teo_l7_acc_rule_priority_operation#id TeoL7AccRulePriorityOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/teo_l7_acc_rule_priority_operation#rule_ids TeoL7AccRulePriorityOperation#rule_ids}
  */
  readonly ruleIds: string[];
  /**
  * Zone id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/teo_l7_acc_rule_priority_operation#zone_id TeoL7AccRulePriorityOperation#zone_id}
  */
  readonly zoneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/teo_l7_acc_rule_priority_operation tencentcloud_teo_l7_acc_rule_priority_operation}
*/
export class TeoL7AccRulePriorityOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeoL7AccRulePriorityOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/teo_l7_acc_rule_priority_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/teo_l7_acc_rule_priority_operation tencentcloud_teo_l7_acc_rule_priority_operation} Resource
  *
  * @param scope The scope in which to define this construct
