// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway
...
export interface NatGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway#assigned_eip_set NatGateway#assigned_eip_set}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway#bandwidth NatGateway#bandwidth}
  */
  readonly bandwidth?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway#id NatGateway#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway#max_concurrent NatGateway#max_concurrent}
  */
  readonly maxConcurrent?: number;
  /**
  * Name of the NAT gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway#name NatGateway#name}
  */
  readonly name: string;
  /**
  * 1: traditional NAT, 2: standard NAT, default value is 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway#nat_product_version NatGateway#nat_product_version}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway#stock_public_ip_addresses_bandwidth_out NatGateway#stock_public_ip_addresses_bandwidth_out}
  */
  readonly stockPublicIpAddressesBandwidthOut?: number;
  /**
  * Subnet of NAT.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway#subnet_id NatGateway#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * The available tags within this NAT gateway.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway#tags NatGateway#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * ID of the vpc.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway#vpc_id NatGateway#vpc_id}
  */
  readonly vpcId: string;
  /**
  * The availability zone, such as `ap-guangzhou-3`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway#zone NatGateway#zone}
  */
  readonly zone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway tencentcloud_nat_gateway}
*/
export class NatGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NatGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway tencentcloud_nat_gateway} Resource
  *
  * @param scope The scope in which to define this construct
