// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_service_linked_role
...
export interface CamServiceLinkedRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_service_linked_role#custom_suffix CamServiceLinkedRole#custom_suffix}
  */
  readonly customSuffix?: string;
  /**
  * role description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_service_linked_role#description CamServiceLinkedRole#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_service_linked_role#id CamServiceLinkedRole#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_service_linked_role#qcs_service_name CamServiceLinkedRole#qcs_service_name}
  */
  readonly qcsServiceName: string[];
  /**
  * Tag description list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_service_linked_role#tags CamServiceLinkedRole#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_service_linked_role tencentcloud_cam_service_linked_role}
*/
export class CamServiceLinkedRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CamServiceLinkedRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_service_linked_role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cam_service_linked_role tencentcloud_cam_service_linked_role} Resource
  *
  * @param scope The scope in which to define this construct
