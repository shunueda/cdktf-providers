// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_snapshot_policy
...
export interface CbsSnapshotPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_snapshot_policy#id CbsSnapshotPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_snapshot_policy#repeat_hours CbsSnapshotPolicy#repeat_hours}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_snapshot_policy#repeat_weekdays CbsSnapshotPolicy#repeat_weekdays}
  */
  readonly repeatWeekdays: number[];
  /**
  * Retention days of the snapshot, and the default value is 7.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_snapshot_policy#retention_days CbsSnapshotPolicy#retention_days}
  */
  readonly retentionDays?: number;
  /**
  * Name of snapshot policy. The maximum length can not exceed 60 bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_snapshot_policy#snapshot_policy_name CbsSnapshotPolicy#snapshot_policy_name}
  */
  readonly snapshotPolicyName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_snapshot_policy tencentcloud_cbs_snapshot_policy}
*/
export class CbsSnapshotPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CbsSnapshotPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_snapshot_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_snapshot_policy tencentcloud_cbs_snapshot_policy} Resource
  *
  * @param scope The scope in which to define this construct
