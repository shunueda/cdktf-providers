// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_redirection
...
export interface ClbRedirectionConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of CLB instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_redirection#clb_id ClbRedirection#clb_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_redirection#delete_all_auto_rewrite ClbRedirection#delete_all_auto_rewrite}
  */
  readonly deleteAllAutoRewrite?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_redirection#id ClbRedirection#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_redirection#is_auto_rewrite ClbRedirection#is_auto_rewrite}
  */
  readonly isAutoRewrite?: boolean | cdktf.IResolvable;
  /**
  * ID of source listener.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_redirection#source_listener_id ClbRedirection#source_listener_id}
  */
  readonly sourceListenerId?: string;
  /**
  * Rule ID of source listener.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_redirection#source_rule_id ClbRedirection#source_rule_id}
  */
  readonly sourceRuleId?: string;
  /**
  * ID of source listener.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_redirection#target_listener_id ClbRedirection#target_listener_id}
  */
  readonly targetListenerId: string;
  /**
  * Rule ID of target listener.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_redirection#target_rule_id ClbRedirection#target_rule_id}
  */
  readonly targetRuleId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_redirection tencentcloud_clb_redirection}
*/
export class ClbRedirection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClbRedirection that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_redirection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_redirection tencentcloud_clb_redirection} Resource
  *
  * @param scope The scope in which to define this construct
