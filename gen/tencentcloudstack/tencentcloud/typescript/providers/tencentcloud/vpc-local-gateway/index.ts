// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_local_gateway
...
export interface VpcLocalGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  * CDC instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_local_gateway#cdc_id VpcLocalGateway#cdc_id}
  */
  readonly cdcId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_local_gateway#id VpcLocalGateway#id}
  *
  ...
  * Local gateway name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_local_gateway#local_gateway_name VpcLocalGateway#local_gateway_name}
  */
  readonly localGatewayName: string;
  /**
  * VPC instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_local_gateway#vpc_id VpcLocalGateway#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_local_gateway tencentcloud_vpc_local_gateway}
*/
export class VpcLocalGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcLocalGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_local_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/vpc_local_gateway tencentcloud_vpc_local_gateway} Resource
  *
  * @param scope The scope in which to define this construct
