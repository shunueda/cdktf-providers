// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cdn_url_purge
...
export interface CdnUrlPurgeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cdn_url_purge#area CdnUrlPurge#area}
  */
  readonly area?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cdn_url_purge#id CdnUrlPurge#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cdn_url_purge#redo CdnUrlPurge#redo}
  */
  readonly redo?: number;
  /**
  * Whether to encode urls, if set to `true` will auto encode instead of manual process.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cdn_url_purge#url_encode CdnUrlPurge#url_encode}
  */
  readonly urlEncode?: boolean | cdktf.IResolvable;
  /**
  * List of url to purge. NOTE: urls need include protocol prefix `http://` or `https://`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cdn_url_purge#urls CdnUrlPurge#urls}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cdn_url_purge tencentcloud_cdn_url_purge}
*/
export class CdnUrlPurge extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnUrlPurge that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cdn_url_purge#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cdn_url_purge tencentcloud_cdn_url_purge} Resource
  *
  * @param scope The scope in which to define this construct
