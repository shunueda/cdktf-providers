// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route
...
export interface TseCngwRouteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#destination_ports TseCngwRoute#destination_ports}
  */
  readonly destinationPorts?: number[];
  /**
  * whether to enable forced HTTPS, no longer use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#force_https TseCngwRoute#force_https}
  */
  readonly forceHttps?: boolean | cdktf.IResolvable;
  /**
  * gateway ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#gateway_id TseCngwRoute#gateway_id}
  */
  readonly gatewayId: string;
  /**
  * host list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#hosts TseCngwRoute#hosts}
  */
  readonly hosts?: string[];
  /**
  * https redirection status code.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#https_redirect_status_code TseCngwRoute#https_redirect_status_code}
  */
  readonly httpsRedirectStatusCode?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#id TseCngwRoute#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#methods TseCngwRoute#methods}
  */
  readonly methods?: string[];
  /**
  * path list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#paths TseCngwRoute#paths}
  */
  readonly paths?: string[];
  /**
  * whether to keep the host when forwarding to the backend.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#preserve_host TseCngwRoute#preserve_host}
  */
  readonly preserveHost?: boolean | cdktf.IResolvable;
  /**
  * the protocol list of route.Reference value:`https`,`http`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#protocols TseCngwRoute#protocols}
  */
  readonly protocols?: string[];
  /**
  * the name of the route, unique in the instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#route_name TseCngwRoute#route_name}
  */
  readonly routeName?: string;
  /**
  * ID of the service which the route belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#service_id TseCngwRoute#service_id}
  */
  readonly serviceId: string;
  /**
  * whether to strip path when forwarding to the backend.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#strip_path TseCngwRoute#strip_path}
  */
  readonly stripPath?: boolean | cdktf.IResolvable;
  /**
  * headers block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#headers TseCngwRoute#headers}
  */
...
export interface TseCngwRouteHeaders {
  ...
  * key of header.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#key TseCngwRoute#key}
  */
  readonly key?: string;
  /**
  * value of header.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#value TseCngwRoute#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route tencentcloud_tse_cngw_route}
*/
export class TseCngwRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TseCngwRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/tse_cngw_route tencentcloud_tse_cngw_route} Resource
  *
  * @param scope The scope in which to define this construct
