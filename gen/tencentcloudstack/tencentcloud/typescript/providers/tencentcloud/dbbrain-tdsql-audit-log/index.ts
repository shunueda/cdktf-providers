// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log
...
export interface DbbrainTdsqlAuditLogConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log#end_time DbbrainTdsqlAuditLog#end_time}
  */
  readonly endTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log#id DbbrainTdsqlAuditLog#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log#instance_id DbbrainTdsqlAuditLog#instance_id}
  */
  readonly instanceId: string;
  /**
  * Consistent with Product. For example: dcdb, mariadb.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log#node_request_type DbbrainTdsqlAuditLog#node_request_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log#product DbbrainTdsqlAuditLog#product}
  */
  readonly product: string;
  /**
  * Start time, such as `2019-09-10 12:13:14`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log#start_time DbbrainTdsqlAuditLog#start_time}
  */
  readonly startTime: string;
  /**
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log#filter DbbrainTdsqlAuditLog#filter}
  */
...
export interface DbbrainTdsqlAuditLogFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log#affect_rows DbbrainTdsqlAuditLog#affect_rows}
  */
  readonly affectRows?: number;
  /**
  * Database name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log#db_name DbbrainTdsqlAuditLog#db_name}
  */
  readonly dbName?: string[];
  /**
  * Execution time. The unit is: us. It means to filter the audit logs whose execution time is greater than this value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log#exec_time DbbrainTdsqlAuditLog#exec_time}
  */
  readonly execTime?: number;
  /**
  * Client Address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log#host DbbrainTdsqlAuditLog#host}
  */
  readonly host?: string[];
  /**
  * Return the number of rows. It means to filter the audit log with the number of returned rows greater than this value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log#sent_rows DbbrainTdsqlAuditLog#sent_rows}
  */
  readonly sentRows?: number;
  /**
  * Username.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log#user DbbrainTdsqlAuditLog#user}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log tencentcloud_dbbrain_tdsql_audit_log}
*/
export class DbbrainTdsqlAuditLog extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbbrainTdsqlAuditLog that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dbbrain_tdsql_audit_log tencentcloud_dbbrain_tdsql_audit_log} Resource
  *
  * @param scope The scope in which to define this construct
