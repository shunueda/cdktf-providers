// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform
...
export interface EbEventTransformConfig extends cdktf.TerraformMetaArguments {
  ...
  * event bus Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#event_bus_id EbEventTransform#event_bus_id}
  */
  readonly eventBusId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#id EbEventTransform#id}
  *
  ...
  * ruleId.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#rule_id EbEventTransform#rule_id}
  */
  readonly ruleId: string;
  /**
  * transformations block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#transformations EbEventTransform#transformations}
  */
...
export interface EbEventTransformTransformationsEtlFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#filter EbEventTransform#filter}
  */
...
export interface EbEventTransformTransformationsExtractionTextParams {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#regex EbEventTransform#regex}
  */
  readonly regex?: string;
  /**
  * `Comma`, `|`, `tab`, `space`, `newline`, `%`, `#`, the limit length is 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#separator EbEventTransform#separator}
  */
...
export interface EbEventTransformTransformationsExtraction {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#extraction_input_path EbEventTransform#extraction_input_path}
  */
  readonly extractionInputPath: string;
  /**
  * Value: `TEXT`, `JSON`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#format EbEventTransform#format}
  */
  readonly format: string;
  /**
  * text_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#text_params EbEventTransform#text_params}
  */
...
export interface EbEventTransformTransformationsTransformOutputStructs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#key EbEventTransform#key}
  */
  readonly key: string;
  /**
  * You can fill in the json-path and also support constants or built-in keyword date types.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#value EbEventTransform#value}
  */
  readonly value: string;
  /**
  * The data type of value, optional values: `STRING`, `NUMBER`, `BOOLEAN`, `NULL`, `SYS_VARIABLE`, `JSONPATH`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#value_type EbEventTransform#value_type}
  */
...
export interface EbEventTransformTransformationsTransform {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#output_structs EbEventTransform#output_structs}
  */
...
export interface EbEventTransformTransformations {
  ...
  * etl_filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#etl_filter EbEventTransform#etl_filter}
  */
  readonly etlFilter?: EbEventTransformTransformationsEtlFilter;
  /**
  * extraction block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#extraction EbEventTransform#extraction}
  */
  readonly extraction?: EbEventTransformTransformationsExtraction;
  /**
  * transform block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#transform EbEventTransform#transform}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform tencentcloud_eb_event_transform}
*/
export class EbEventTransform extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EbEventTransform that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/eb_event_transform tencentcloud_eb_event_transform} Resource
  *
  * @param scope The scope in which to define this construct
