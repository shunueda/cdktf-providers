// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config
...
export interface TemLogConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  * application ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config#application_id TemLogConfig#application_id}
  */
  readonly applicationId: string;
  /**
  * regex pattern.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config#beginning_regex TemLogConfig#beginning_regex}
  */
  readonly beginningRegex?: string;
  /**
  * environment ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config#environment_id TemLogConfig#environment_id}
  */
  readonly environmentId: string;
  /**
  * file name pattern if container_file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config#file_pattern TemLogConfig#file_pattern}
  */
  readonly filePattern?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config#id TemLogConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config#input_type TemLogConfig#input_type}
  */
  readonly inputType: string;
  /**
  * directory if container_file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config#log_path TemLogConfig#log_path}
  */
  readonly logPath?: string;
  /**
  * minimalist_log or multiline_log.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config#log_type TemLogConfig#log_type}
  */
  readonly logType: string;
  /**
  * logset.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config#logset_id TemLogConfig#logset_id}
  */
  readonly logsetId: string;
  /**
  * appConfig name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config#name TemLogConfig#name}
  */
  readonly name: string;
  /**
  * topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config#topic_id TemLogConfig#topic_id}
  */
  readonly topicId: string;
  /**
  * application ID, which is combined by environment ID and application ID, like `en-o5edaepv#app-3j29aa2p`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config#workload_id TemLogConfig#workload_id}
  */
  readonly workloadId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config tencentcloud_tem_log_config}
*/
export class TemLogConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TemLogConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tem_log_config tencentcloud_tem_log_config} Resource
  *
  * @param scope The scope in which to define this construct
