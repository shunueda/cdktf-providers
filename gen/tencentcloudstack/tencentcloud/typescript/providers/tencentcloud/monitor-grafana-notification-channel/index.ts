// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_grafana_notification_channel
...
export interface MonitorGrafanaNotificationChannelConfig extends cdktf.TerraformMetaArguments {
  ...
  * channel name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_grafana_notification_channel#channel_name MonitorGrafanaNotificationChannel#channel_name}
  */
  readonly channelName?: string;
  /**
  * extra grafana organization id list, default to 1 representing Main Org.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_grafana_notification_channel#extra_org_ids MonitorGrafanaNotificationChannel#extra_org_ids}
  */
  readonly extraOrgIds?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_grafana_notification_channel#id MonitorGrafanaNotificationChannel#id}
  *
  ...
  * grafana instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_grafana_notification_channel#instance_id MonitorGrafanaNotificationChannel#instance_id}
  */
  readonly instanceId: string;
  /**
  * Grafana organization which channel will be installed, default to 1 representing Main Org.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_grafana_notification_channel#org_id MonitorGrafanaNotificationChannel#org_id}
  */
  readonly orgId?: number;
  /**
  * cloud monitor notification template notice-id list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_grafana_notification_channel#receivers MonitorGrafanaNotificationChannel#receivers}
  */
  readonly receivers?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_grafana_notification_channel tencentcloud_monitor_grafana_notification_channel}
*/
export class MonitorGrafanaNotificationChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorGrafanaNotificationChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_grafana_notification_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_grafana_notification_channel tencentcloud_monitor_grafana_notification_channel} Resource
  *
  * @param scope The scope in which to define this construct
