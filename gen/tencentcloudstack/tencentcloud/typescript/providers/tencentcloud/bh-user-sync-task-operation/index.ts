// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_sync_task_operation
...
export interface BhUserSyncTaskOperationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_sync_task_operation#id BhUserSyncTaskOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_sync_task_operation#user_kind BhUserSyncTaskOperation#user_kind}
  */
  readonly userKind: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_sync_task_operation tencentcloud_bh_user_sync_task_operation}
*/
export class BhUserSyncTaskOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BhUserSyncTaskOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_sync_task_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/bh_user_sync_task_operation tencentcloud_bh_user_sync_task_operation} Resource
  *
  * @param scope The scope in which to define this construct
