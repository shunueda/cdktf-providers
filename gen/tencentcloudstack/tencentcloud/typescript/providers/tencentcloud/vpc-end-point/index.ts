// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/vpc_end_point
...
export interface VpcEndPointConfig extends cdktf.TerraformMetaArguments {
  ...
  * Name of endpoint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/vpc_end_point#end_point_name VpcEndPoint#end_point_name}
  */
  readonly endPointName: string;
  /**
  * ID of endpoint service.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/vpc_end_point#end_point_service_id VpcEndPoint#end_point_service_id}
  */
  readonly endPointServiceId: string;
  /**
  * VIP of endpoint ip.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/vpc_end_point#end_point_vip VpcEndPoint#end_point_vip}
  */
  readonly endPointVip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/vpc_end_point#id VpcEndPoint#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/vpc_end_point#security_groups_ids VpcEndPoint#security_groups_ids}
  */
  readonly securityGroupsIds?: string[];
  /**
  * ID of subnet instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/vpc_end_point#subnet_id VpcEndPoint#subnet_id}
  */
  readonly subnetId: string;
  /**
  * ID of vpc instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/vpc_end_point#vpc_id VpcEndPoint#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/vpc_end_point tencentcloud_vpc_end_point}
*/
export class VpcEndPoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcEndPoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/vpc_end_point#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/vpc_end_point tencentcloud_vpc_end_point} Resource
  *
  * @param scope The scope in which to define this construct
