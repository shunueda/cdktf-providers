// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/antiddos_port_acl_config
...
export interface AntiddosPortAclConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/antiddos_port_acl_config#id AntiddosPortAclConfig#id}
  *
  ...
  * InstanceIdList.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/antiddos_port_acl_config#instance_id AntiddosPortAclConfig#instance_id}
  */
  readonly instanceId: string;
  /**
  * acl_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/antiddos_port_acl_config#acl_config AntiddosPortAclConfig#acl_config}
  */
...
export interface AntiddosPortAclConfigAclConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/antiddos_port_acl_config#action AntiddosPortAclConfig#action}
  */
  readonly action: string;
  /**
  * end from port, with a range of 0~65535 values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/antiddos_port_acl_config#d_port_end AntiddosPortAclConfig#d_port_end}
  */
  readonly dPortEnd: number;
  /**
  * Starting from port, with a range of 0~65535 values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/antiddos_port_acl_config#d_port_start AntiddosPortAclConfig#d_port_start}
  */
  readonly dPortStart: number;
  /**
  * Protocol type, can take TCP, udp, all values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/antiddos_port_acl_config#forward_protocol AntiddosPortAclConfig#forward_protocol}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/antiddos_port_acl_config#priority AntiddosPortAclConfig#priority}
  */
  readonly priority?: number;
  /**
  * end from the source port, with a value range of 0~65535.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/antiddos_port_acl_config#s_port_end AntiddosPortAclConfig#s_port_end}
  */
  readonly sPortEnd: number;
  /**
  * Starting from the source port, with a value range of 0~65535.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/antiddos_port_acl_config#s_port_start AntiddosPortAclConfig#s_port_start}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/antiddos_port_acl_config tencentcloud_antiddos_port_acl_config}
*/
export class AntiddosPortAclConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AntiddosPortAclConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/antiddos_port_acl_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/antiddos_port_acl_config tencentcloud_antiddos_port_acl_config} Resource
  *
  * @param scope The scope in which to define this construct
