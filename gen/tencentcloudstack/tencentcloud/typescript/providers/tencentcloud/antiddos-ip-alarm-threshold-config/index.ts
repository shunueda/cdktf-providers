// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/antiddos_ip_alarm_threshold_config
...
export interface AntiddosIpAlarmThresholdConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/antiddos_ip_alarm_threshold_config#alarm_threshold AntiddosIpAlarmThresholdConfig#alarm_threshold}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/antiddos_ip_alarm_threshold_config#alarm_type AntiddosIpAlarmThresholdConfig#alarm_type}
  */
  readonly alarmType: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/antiddos_ip_alarm_threshold_config#id AntiddosIpAlarmThresholdConfig#id}
  *
  ...
  * Instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/antiddos_ip_alarm_threshold_config#instance_id AntiddosIpAlarmThresholdConfig#instance_id}
  */
  readonly instanceId: string;
  /**
  * Instance ip.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/antiddos_ip_alarm_threshold_config#instance_ip AntiddosIpAlarmThresholdConfig#instance_ip}
  */
  readonly instanceIp: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/antiddos_ip_alarm_threshold_config tencentcloud_antiddos_ip_alarm_threshold_config}
*/
export class AntiddosIpAlarmThresholdConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AntiddosIpAlarmThresholdConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/antiddos_ip_alarm_threshold_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/antiddos_ip_alarm_threshold_config tencentcloud_antiddos_ip_alarm_threshold_config} Resource
  *
  * @param scope The scope in which to define this construct
