// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script
...
export interface WedataSqlScriptConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script#access_scope WedataSqlScript#access_scope}
  */
  readonly accessScope?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script#id WedataSqlScript#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script#parent_folder_path WedataSqlScript#parent_folder_path}
  */
  readonly parentFolderPath?: string;
  /**
  * Project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script#project_id WedataSqlScript#project_id}
  */
  readonly projectId: string;
  /**
  * Script content, if there is a value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script#script_content WedataSqlScript#script_content}
  */
  readonly scriptContent?: string;
  /**
  * Script name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script#script_name WedataSqlScript#script_name}
  */
  readonly scriptName: string;
  /**
  * script_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script#script_config WedataSqlScript#script_config}
  */
...
export interface WedataSqlScriptScriptConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script#advance_config WedataSqlScript#advance_config}
  */
  readonly advanceConfig?: string;
  /**
  * Computing resource.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script#compute_resource WedataSqlScript#compute_resource}
  */
  readonly computeResource?: string;
  /**
  * Data source environment.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script#datasource_env WedataSqlScript#datasource_env}
  */
  readonly datasourceEnv?: string;
  /**
  * Data source ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script#datasource_id WedataSqlScript#datasource_id}
  */
  readonly datasourceId?: string;
  /**
  * Execution resource group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script#executor_group_id WedataSqlScript#executor_group_id}
  */
  readonly executorGroupId?: string;
  /**
  * Advanced runtime parameters, variable substitution, map-json String,String.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script#params WedataSqlScript#params}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script tencentcloud_wedata_sql_script}
*/
export class WedataSqlScript extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WedataSqlScript that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/wedata_sql_script tencentcloud_wedata_sql_script} Resource
  *
  * @param scope The scope in which to define this construct
