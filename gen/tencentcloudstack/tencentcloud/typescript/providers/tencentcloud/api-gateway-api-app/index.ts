// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/api_gateway_api_app
...
export interface ApiGatewayApiAppConfig extends cdktf.TerraformMetaArguments {
  ...
  * App description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/api_gateway_api_app#api_app_desc ApiGatewayApiApp#api_app_desc}
  */
  readonly apiAppDesc?: string;
  /**
  * Api app name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/api_gateway_api_app#api_app_name ApiGatewayApiApp#api_app_name}
  */
  readonly apiAppName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/api_gateway_api_app#id ApiGatewayApiApp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/api_gateway_api_app#tags ApiGatewayApiApp#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/api_gateway_api_app tencentcloud_api_gateway_api_app}
*/
export class ApiGatewayApiApp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayApiApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/api_gateway_api_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/api_gateway_api_app tencentcloud_api_gateway_api_app} Resource
  *
  * @param scope The scope in which to define this construct
