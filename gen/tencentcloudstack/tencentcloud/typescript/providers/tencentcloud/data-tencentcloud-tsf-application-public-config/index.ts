// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/tsf_application_public_config
...
export interface DataTencentcloudTsfApplicationPublicConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/tsf_application_public_config#config_id DataTencentcloudTsfApplicationPublicConfig#config_id}
  */
  readonly configId?: string;
  /**
  * Config ID list. Query all items if not passed, low priority.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/tsf_application_public_config#config_id_list DataTencentcloudTsfApplicationPublicConfig#config_id_list}
  */
  readonly configIdList?: string[];
  /**
  * Config name. Exact query. Query all items if not passed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/tsf_application_public_config#config_name DataTencentcloudTsfApplicationPublicConfig#config_name}
  */
  readonly configName?: string;
  /**
  * Config version. Exact query. Query all items if not passed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/tsf_application_public_config#config_version DataTencentcloudTsfApplicationPublicConfig#config_version}
  */
  readonly configVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/tsf_application_public_config#id DataTencentcloudTsfApplicationPublicConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/tsf_application_public_config#result_output_file DataTencentcloudTsfApplicationPublicConfig#result_output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/tsf_application_public_config tencentcloud_tsf_application_public_config}
*/
export class DataTencentcloudTsfApplicationPublicConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudTsfApplicationPublicConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/tsf_application_public_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/tsf_application_public_config tencentcloud_tsf_application_public_config} Data Source
  *
  * @param scope The scope in which to define this construct
