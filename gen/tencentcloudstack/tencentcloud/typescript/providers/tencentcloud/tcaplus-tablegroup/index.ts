// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tcaplus_tablegroup
...
export interface TcaplusTablegroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tcaplus_tablegroup#cluster_id TcaplusTablegroup#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tcaplus_tablegroup#id TcaplusTablegroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tcaplus_tablegroup#tablegroup_name TcaplusTablegroup#tablegroup_name}
  */
  readonly tablegroupName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tcaplus_tablegroup tencentcloud_tcaplus_tablegroup}
*/
export class TcaplusTablegroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TcaplusTablegroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tcaplus_tablegroup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tcaplus_tablegroup tencentcloud_tcaplus_tablegroup} Resource
  *
  * @param scope The scope in which to define this construct
