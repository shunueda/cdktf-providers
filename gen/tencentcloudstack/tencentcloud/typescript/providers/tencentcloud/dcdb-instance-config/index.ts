// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dcdb_instance_config
...
export interface DcdbInstanceConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dcdb_instance_config#id DcdbInstanceConfig#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dcdb_instance_config#instance_id DcdbInstanceConfig#instance_id}
  */
  readonly instanceId: string;
  /**
  * RS nearest access mode, 0-no policy, 1-nearest access.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dcdb_instance_config#rs_access_strategy DcdbInstanceConfig#rs_access_strategy}
  */
  readonly rsAccessStrategy: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dcdb_instance_config tencentcloud_dcdb_instance_config}
*/
export class DcdbInstanceConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DcdbInstanceConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dcdb_instance_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dcdb_instance_config tencentcloud_dcdb_instance_config} Resource
  *
  * @param scope The scope in which to define this construct
