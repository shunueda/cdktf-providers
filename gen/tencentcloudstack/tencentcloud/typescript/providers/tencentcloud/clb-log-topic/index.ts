// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/clb_log_topic
...
export interface ClbLogTopicConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/clb_log_topic#id ClbLogTopic#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/clb_log_topic#log_set_id ClbLogTopic#log_set_id}
  */
  readonly logSetId: string;
  /**
  * The status of log topic. true: enable; false: disable. Default is true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/clb_log_topic#status ClbLogTopic#status}
  */
  readonly status?: boolean | cdktf.IResolvable;
  /**
  * Log topic of CLB instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/clb_log_topic#topic_name ClbLogTopic#topic_name}
  */
  readonly topicName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/clb_log_topic tencentcloud_clb_log_topic}
*/
export class ClbLogTopic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClbLogTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/clb_log_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/clb_log_topic tencentcloud_clb_log_topic} Resource
  *
  * @param scope The scope in which to define this construct
