// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/redis_log_delivery
...
export interface RedisLogDeliveryConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/redis_log_delivery#create_index RedisLogDelivery#create_index}
  */
  readonly createIndex?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/redis_log_delivery#id RedisLogDelivery#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/redis_log_delivery#instance_id RedisLogDelivery#instance_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/redis_log_delivery#log_region RedisLogDelivery#log_region}
  */
  readonly logRegion?: string;
  /**
  * The ID of the log set being delivered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/redis_log_delivery#logset_id RedisLogDelivery#logset_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/redis_log_delivery#logset_name RedisLogDelivery#logset_name}
  */
  readonly logsetName?: string;
  /**
  * Log storage time, defaults to 30 days, with an optional range of 1-3600 days.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/redis_log_delivery#period RedisLogDelivery#period}
  */
  readonly period?: number;
  /**
  * The ID of the topic being delivered.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/redis_log_delivery#topic_id RedisLogDelivery#topic_id}
  */
  readonly topicId?: string;
  /**
  * Log topic name, required when TopicId is empty, a new log topic will be automatically created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/redis_log_delivery#topic_name RedisLogDelivery#topic_name}
  */
  readonly topicName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/redis_log_delivery tencentcloud_redis_log_delivery}
*/
export class RedisLogDelivery extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisLogDelivery that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/redis_log_delivery#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/redis_log_delivery tencentcloud_redis_log_delivery} Resource
  *
  * @param scope The scope in which to define this construct
