// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/oceanus_job_events
...
export interface DataTencentcloudOceanusJobEventsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/oceanus_job_events#end_timestamp DataTencentcloudOceanusJobEvents#end_timestamp}
  */
  readonly endTimestamp: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/oceanus_job_events#id DataTencentcloudOceanusJobEvents#id}
  *
  ...
  * Job ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/oceanus_job_events#job_id DataTencentcloudOceanusJobEvents#job_id}
  */
  readonly jobId: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/oceanus_job_events#result_output_file DataTencentcloudOceanusJobEvents#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Filter condition:Start Unix timestamp (seconds).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/oceanus_job_events#start_timestamp DataTencentcloudOceanusJobEvents#start_timestamp}
  */
  readonly startTimestamp: number;
  /**
  * Event types. If not passed, data of all types will be returned.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/oceanus_job_events#types DataTencentcloudOceanusJobEvents#types}
  */
  readonly types?: string[];
  /**
  * Workspace SerialId.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/oceanus_job_events#work_space_id DataTencentcloudOceanusJobEvents#work_space_id}
  */
...
export class DataTencentcloudOceanusJobEvents extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudOceanusJobEvents that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/oceanus_job_events#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/oceanus_job_events tencentcloud_oceanus_job_events} Data Source
  *
  * @param scope The scope in which to define this construct
