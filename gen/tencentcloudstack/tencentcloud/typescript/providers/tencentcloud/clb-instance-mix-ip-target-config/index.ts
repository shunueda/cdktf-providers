// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance_mix_ip_target_config
...
export interface ClbInstanceMixIpTargetConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance_mix_ip_target_config#id ClbInstanceMixIpTargetConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance_mix_ip_target_config#load_balancer_id ClbInstanceMixIpTargetConfig#load_balancer_id}
  */
  readonly loadBalancerId: string;
  /**
  * False: closed True:open.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance_mix_ip_target_config#mix_ip_target ClbInstanceMixIpTargetConfig#mix_ip_target}
  */
  readonly mixIpTarget: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance_mix_ip_target_config tencentcloud_clb_instance_mix_ip_target_config}
*/
export class ClbInstanceMixIpTargetConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClbInstanceMixIpTargetConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance_mix_ip_target_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/clb_instance_mix_ip_target_config tencentcloud_clb_instance_mix_ip_target_config} Resource
  *
  * @param scope The scope in which to define this construct
