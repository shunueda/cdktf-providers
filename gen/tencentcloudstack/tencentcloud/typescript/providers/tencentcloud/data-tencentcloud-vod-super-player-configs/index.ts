// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_super_player_configs
...
export interface DataTencentcloudVodSuperPlayerConfigsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_super_player_configs#id DataTencentcloudVodSuperPlayerConfigs#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_super_player_configs#name DataTencentcloudVodSuperPlayerConfigs#name}
  */
  readonly name?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_super_player_configs#result_output_file DataTencentcloudVodSuperPlayerConfigs#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Subapplication ID in VOD. If you need to access a resource in a subapplication, enter the subapplication ID in this field; otherwise, leave it empty.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_super_player_configs#sub_app_id DataTencentcloudVodSuperPlayerConfigs#sub_app_id}
  */
  readonly subAppId?: number;
  /**
  * Config type filter. Valid values: `Preset`, `Custom`. `Preset`: preset template; `Custom`: custom template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_super_player_configs#type DataTencentcloudVodSuperPlayerConfigs#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_super_player_configs tencentcloud_vod_super_player_configs}
*/
export class DataTencentcloudVodSuperPlayerConfigs extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudVodSuperPlayerConfigs that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_super_player_configs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_super_player_configs tencentcloud_vod_super_player_configs} Data Source
  *
  * @param scope The scope in which to define this construct
