// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_disisolate_db_instance_operation
...
export interface PostgresqlDisisolateDbInstanceOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_disisolate_db_instance_operation#auto_voucher PostgresqlDisisolateDbInstanceOperation#auto_voucher}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_disisolate_db_instance_operation#db_instance_id_set PostgresqlDisisolateDbInstanceOperation#db_instance_id_set}
  */
  readonly dbInstanceIdSet: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_disisolate_db_instance_operation#id PostgresqlDisisolateDbInstanceOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_disisolate_db_instance_operation#period PostgresqlDisisolateDbInstanceOperation#period}
  */
  readonly period?: number;
  /**
  * Voucher ID list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_disisolate_db_instance_operation#voucher_ids PostgresqlDisisolateDbInstanceOperation#voucher_ids}
  */
  readonly voucherIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_disisolate_db_instance_operation tencentcloud_postgresql_disisolate_db_instance_operation}
*/
export class PostgresqlDisisolateDbInstanceOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresqlDisisolateDbInstanceOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_disisolate_db_instance_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/postgresql_disisolate_db_instance_operation tencentcloud_postgresql_disisolate_db_instance_operation} Resource
  *
  * @param scope The scope in which to define this construct
