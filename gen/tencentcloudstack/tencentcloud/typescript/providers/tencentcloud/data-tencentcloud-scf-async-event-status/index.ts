// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/scf_async_event_status
...
export interface DataTencentcloudScfAsyncEventStatusConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/scf_async_event_status#id DataTencentcloudScfAsyncEventStatus#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/scf_async_event_status#invoke_request_id DataTencentcloudScfAsyncEventStatus#invoke_request_id}
  */
  readonly invokeRequestId: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/scf_async_event_status#result_output_file DataTencentcloudScfAsyncEventStatus#result_output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/scf_async_event_status tencentcloud_scf_async_event_status}
*/
export class DataTencentcloudScfAsyncEventStatus extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudScfAsyncEventStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/scf_async_event_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/scf_async_event_status tencentcloud_scf_async_event_status} Data Source
  *
  * @param scope The scope in which to define this construct
