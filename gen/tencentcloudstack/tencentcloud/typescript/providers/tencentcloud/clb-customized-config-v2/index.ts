// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_customized_config_v2
...
export interface ClbCustomizedConfigV2Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_customized_config_v2#config_content ClbCustomizedConfigV2#config_content}
  */
  readonly configContent: string;
  /**
  * Name of Customized Config.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_customized_config_v2#config_name ClbCustomizedConfigV2#config_name}
  */
  readonly configName: string;
  /**
  * Type of Customized Config. Valid values: `SERVER` and `LOCATION`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_customized_config_v2#config_type ClbCustomizedConfigV2#config_type}
  */
  readonly configType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_customized_config_v2#id ClbCustomizedConfigV2#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_customized_config_v2 tencentcloud_clb_customized_config_v2}
*/
export class ClbCustomizedConfigV2 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClbCustomizedConfigV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_customized_config_v2#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/clb_customized_config_v2 tencentcloud_clb_customized_config_v2} Resource
  *
  * @param scope The scope in which to define this construct
