// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dlc_work_group
...
export interface DlcWorkGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dlc_work_group#id DlcWorkGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dlc_work_group#work_group_description DlcWorkGroup#work_group_description}
  */
  readonly workGroupDescription?: string;
  /**
  * Working group name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dlc_work_group#work_group_name DlcWorkGroup#work_group_name}
  */
  readonly workGroupName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dlc_work_group tencentcloud_dlc_work_group}
*/
export class DlcWorkGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DlcWorkGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dlc_work_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dlc_work_group tencentcloud_dlc_work_group} Resource
  *
  * @param scope The scope in which to define this construct
