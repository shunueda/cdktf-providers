// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/postgresql_renew_db_instance_operation
...
export interface PostgresqlRenewDbInstanceOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/postgresql_renew_db_instance_operation#auto_voucher PostgresqlRenewDbInstanceOperation#auto_voucher}
  */
  readonly autoVoucher?: number;
  /**
  * Instance ID in the format of postgres-6fego161.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/postgresql_renew_db_instance_operation#db_instance_id PostgresqlRenewDbInstanceOperation#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/postgresql_renew_db_instance_operation#id PostgresqlRenewDbInstanceOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/postgresql_renew_db_instance_operation#period PostgresqlRenewDbInstanceOperation#period}
  */
  readonly period: number;
  /**
  * Voucher ID list (only one voucher can be specified currently).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/postgresql_renew_db_instance_operation#voucher_ids PostgresqlRenewDbInstanceOperation#voucher_ids}
  */
  readonly voucherIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/postgresql_renew_db_instance_operation tencentcloud_postgresql_renew_db_instance_operation}
*/
export class PostgresqlRenewDbInstanceOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresqlRenewDbInstanceOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/postgresql_renew_db_instance_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/postgresql_renew_db_instance_operation tencentcloud_postgresql_renew_db_instance_operation} Resource
  *
  * @param scope The scope in which to define this construct
