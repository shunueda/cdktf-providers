// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mysql_backup_encryption_status
...
export interface MysqlBackupEncryptionStatusConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mysql_backup_encryption_status#encryption_status MysqlBackupEncryptionStatus#encryption_status}
  */
  readonly encryptionStatus: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mysql_backup_encryption_status#id MysqlBackupEncryptionStatus#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mysql_backup_encryption_status#instance_id MysqlBackupEncryptionStatus#instance_id}
  */
  readonly instanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mysql_backup_encryption_status tencentcloud_mysql_backup_encryption_status}
*/
export class MysqlBackupEncryptionStatus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlBackupEncryptionStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mysql_backup_encryption_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mysql_backup_encryption_status tencentcloud_mysql_backup_encryption_status} Resource
  *
  * @param scope The scope in which to define this construct
