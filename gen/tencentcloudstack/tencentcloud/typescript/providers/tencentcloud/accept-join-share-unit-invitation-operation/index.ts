// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/accept_join_share_unit_invitation_operation
...
export interface AcceptJoinShareUnitInvitationOperationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/accept_join_share_unit_invitation_operation#id AcceptJoinShareUnitInvitationOperation#id}
  *
  ...
  * Shared unit ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/accept_join_share_unit_invitation_operation#unit_id AcceptJoinShareUnitInvitationOperation#unit_id}
  */
  readonly unitId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/accept_join_share_unit_invitation_operation tencentcloud_accept_join_share_unit_invitation_operation}
*/
export class AcceptJoinShareUnitInvitationOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AcceptJoinShareUnitInvitationOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/accept_join_share_unit_invitation_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/accept_join_share_unit_invitation_operation tencentcloud_accept_join_share_unit_invitation_operation} Resource
  *
  * @param scope The scope in which to define this construct
