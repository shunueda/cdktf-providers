// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/postgresql_rebalance_readonly_group_operation
...
export interface PostgresqlRebalanceReadonlyGroupOperationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/postgresql_rebalance_readonly_group_operation#id PostgresqlRebalanceReadonlyGroupOperation#id}
  *
  ...
  * readonly Group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/postgresql_rebalance_readonly_group_operation#read_only_group_id PostgresqlRebalanceReadonlyGroupOperation#read_only_group_id}
  */
  readonly readOnlyGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/postgresql_rebalance_readonly_group_operation tencentcloud_postgresql_rebalance_readonly_group_operation}
*/
export class PostgresqlRebalanceReadonlyGroupOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresqlRebalanceReadonlyGroupOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/postgresql_rebalance_readonly_group_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/postgresql_rebalance_readonly_group_operation tencentcloud_postgresql_rebalance_readonly_group_operation} Resource
  *
  * @param scope The scope in which to define this construct
