// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcaplus_cluster
...
export interface TcaplusClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcaplus_cluster#cluster_name TcaplusCluster#cluster_name}
  */
  readonly clusterName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcaplus_cluster#id TcaplusCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcaplus_cluster#idl_type TcaplusCluster#idl_type}
  */
  readonly idlType: string;
  /**
  * Expiration time of old password after password update, unit: second.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcaplus_cluster#old_password_expire_last TcaplusCluster#old_password_expire_last}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcaplus_cluster#password TcaplusCluster#password}
  */
  readonly password: string;
  /**
  * Subnet id of the TcaplusDB cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcaplus_cluster#subnet_id TcaplusCluster#subnet_id}
  */
  readonly subnetId: string;
  /**
  * VPC id of the TcaplusDB cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcaplus_cluster#vpc_id TcaplusCluster#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcaplus_cluster tencentcloud_tcaplus_cluster}
*/
export class TcaplusCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TcaplusCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcaplus_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcaplus_cluster tencentcloud_tcaplus_cluster} Resource
  *
  * @param scope The scope in which to define this construct
