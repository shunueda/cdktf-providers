// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template
...
export interface MonitorTmpTkeTemplateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#id MonitorTmpTkeTemplate#id}
  *
  ...
  * template block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#template MonitorTmpTkeTemplate#template}
  */
...
export interface MonitorTmpTkeTemplateTemplatePodMonitors {
  ...
  * Config.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#config MonitorTmpTkeTemplate#config}
  */
  readonly config: string;
  /**
  * Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#name MonitorTmpTkeTemplate#name}
  */
  readonly name: string;
  /**
  * Used for the argument, if the configuration comes to the template, the template id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#template_id MonitorTmpTkeTemplate#template_id}
  */
...
export interface MonitorTmpTkeTemplateTemplate {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#describe MonitorTmpTkeTemplate#describe}
  */
  readonly describe?: string;
  /**
  * Whether the system-supplied default template is used for outgoing references.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#is_default MonitorTmpTkeTemplate#is_default}
  */
  readonly isDefault?: boolean | cdktf.IResolvable;
  /**
  * Template dimensions, the following types are supported `instance` instance level, `cluster` cluster level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#level MonitorTmpTkeTemplate#level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#update_time MonitorTmpTkeTemplate#update_time}
  */
  readonly updateTime?: string;
  /**
  * Whether the system-supplied default template is used for outgoing references.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#version MonitorTmpTkeTemplate#version}
  */
  readonly version?: string;
  /**
  * pod_monitors block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#pod_monitors MonitorTmpTkeTemplate#pod_monitors}
  */
  readonly podMonitors?: MonitorTmpTkeTemplateTemplatePodMonitors[] | cdktf.IResolvable;
  /**
  * raw_jobs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#raw_jobs MonitorTmpTkeTemplate#raw_jobs}
  */
  readonly rawJobs?: MonitorTmpTkeTemplateTemplateRawJobs[] | cdktf.IResolvable;
  /**
  * record_rules block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#record_rules MonitorTmpTkeTemplate#record_rules}
  */
  readonly recordRules?: MonitorTmpTkeTemplateTemplateRecordRules[] | cdktf.IResolvable;
  /**
  * service_monitors block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#service_monitors MonitorTmpTkeTemplate#service_monitors}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template tencentcloud_monitor_tmp_tke_template}
*/
export class MonitorTmpTkeTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorTmpTkeTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/monitor_tmp_tke_template tencentcloud_monitor_tmp_tke_template} Resource
  *
  * @param scope The scope in which to define this construct
