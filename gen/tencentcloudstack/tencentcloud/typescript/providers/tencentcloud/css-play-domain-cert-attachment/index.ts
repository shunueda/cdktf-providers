// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/css_play_domain_cert_attachment
...
export interface CssPlayDomainCertAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/css_play_domain_cert_attachment#cloud_cert_id CssPlayDomainCertAttachment#cloud_cert_id}
  */
  readonly cloudCertId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/css_play_domain_cert_attachment#id CssPlayDomainCertAttachment#id}
  *
  ...
  * domain_info block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/css_play_domain_cert_attachment#domain_info CssPlayDomainCertAttachment#domain_info}
  */
...
export interface CssPlayDomainCertAttachmentDomainInfo {
  ...
  * domain name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/css_play_domain_cert_attachment#domain_name CssPlayDomainCertAttachment#domain_name}
  */
  readonly domainName: string;
  /**
  * Whether to enable the https rule for the domain name. 1: enable, 0: disabled, -1: remain unchanged.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/css_play_domain_cert_attachment#status CssPlayDomainCertAttachment#status}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/css_play_domain_cert_attachment tencentcloud_css_play_domain_cert_attachment}
*/
export class CssPlayDomainCertAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CssPlayDomainCertAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/css_play_domain_cert_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/css_play_domain_cert_attachment tencentcloud_css_play_domain_cert_attachment} Resource
  *
  * @param scope The scope in which to define this construct
