// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/cam_account_summary
...
export interface DataTencentcloudCamAccountSummaryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/cam_account_summary#id DataTencentcloudCamAccountSummary#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/cam_account_summary#result_output_file DataTencentcloudCamAccountSummary#result_output_file}
  */
  readonly resultOutputFile?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/cam_account_summary tencentcloud_cam_account_summary}
*/
export class DataTencentcloudCamAccountSummary extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudCamAccountSummary that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/cam_account_summary#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/cam_account_summary tencentcloud_cam_account_summary} Data Source
  *
  * @param scope The scope in which to define this construct
