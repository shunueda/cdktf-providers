// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages
...
export interface DataTencentcloudCbsStoragesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#availability_zone DataTencentcloudCbsStorages#availability_zone}
  */
  readonly availabilityZone?: string;
  /**
  * List filter by disk charge type (`POSTPAID_BY_HOUR` | `PREPAID` | `CDCPAID` | `DEDICATED_CLUSTER_PAID`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#charge_type DataTencentcloudCbsStorages#charge_type}
  */
  readonly chargeType?: string[];
  /**
  * Exclusive cluster id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#dedicated_cluster_id DataTencentcloudCbsStorages#dedicated_cluster_id}
  */
  readonly dedicatedClusterId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#id DataTencentcloudCbsStorages#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#instance_ips DataTencentcloudCbsStorages#instance_ips}
  */
  readonly instanceIps?: string[];
  /**
  * List filter by attached instance name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#instance_name DataTencentcloudCbsStorages#instance_name}
  */
  readonly instanceName?: string[];
  /**
  * Filter by whether the disk is portable (Boolean `true` or `false`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#portable DataTencentcloudCbsStorages#portable}
  */
  readonly portable?: boolean | cdktf.IResolvable;
  /**
  * ID of the project with which the CBS is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#project_id DataTencentcloudCbsStorages#project_id}
  */
  readonly projectId?: number;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#result_output_file DataTencentcloudCbsStorages#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * ID of the CBS to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#storage_id DataTencentcloudCbsStorages#storage_id}
  */
  readonly storageId?: string;
  /**
  * Name of the CBS to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#storage_name DataTencentcloudCbsStorages#storage_name}
  */
  readonly storageName?: string;
  /**
  * List filter by disk state (`UNATTACHED` | `ATTACHING` | `ATTACHED` | `DETACHING` | `EXPANDING` | `ROLLBACKING` | `TORECYCLE`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#storage_state DataTencentcloudCbsStorages#storage_state}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#storage_type DataTencentcloudCbsStorages#storage_type}
  */
  readonly storageType?: string;
  /**
  * Filter by cloud disk type (`SYSTEM_DISK`: system disk | `DATA_DISK`: data disk).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#storage_usage DataTencentcloudCbsStorages#storage_usage}
  */
  readonly storageUsage?: string;
  /**
  * List filter by tag keys.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#tag_keys DataTencentcloudCbsStorages#tag_keys}
  */
  readonly tagKeys?: string[];
  /**
  * List filter by tag values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#tag_values DataTencentcloudCbsStorages#tag_values}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages tencentcloud_cbs_storages}
*/
export class DataTencentcloudCbsStorages extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudCbsStorages that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/cbs_storages tencentcloud_cbs_storages} Data Source
  *
  * @param scope The scope in which to define this construct
