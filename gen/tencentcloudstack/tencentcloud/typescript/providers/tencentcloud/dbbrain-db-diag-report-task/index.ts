// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dbbrain_db_diag_report_task
...
export interface DbbrainDbDiagReportTaskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dbbrain_db_diag_report_task#contact_group DbbrainDbDiagReportTask#contact_group}
  */
  readonly contactGroup?: number[];
  /**
  * An array of contact IDs to receive emails from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dbbrain_db_diag_report_task#contact_person DbbrainDbDiagReportTask#contact_person}
  */
  readonly contactPerson?: number[];
  /**
  * End time, such as 2020-11-09T14:00:00+08:00.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dbbrain_db_diag_report_task#end_time DbbrainDbDiagReportTask#end_time}
  */
  readonly endTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dbbrain_db_diag_report_task#id DbbrainDbDiagReportTask#id}
  *
  ...
  * instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dbbrain_db_diag_report_task#instance_id DbbrainDbDiagReportTask#instance_id}
  */
  readonly instanceId: string;
  /**
  * Service product type, supported values include: mysql - cloud database MySQL, cynosdb - cloud database CynosDB for MySQL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dbbrain_db_diag_report_task#product DbbrainDbDiagReportTask#product}
  */
  readonly product: string;
  /**
  * Whether to send mail: 0 - no, 1 - yes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dbbrain_db_diag_report_task#send_mail_flag DbbrainDbDiagReportTask#send_mail_flag}
  */
  readonly sendMailFlag: number;
  /**
  * Start time, such as 2020-11-08T14:00:00+08:00.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dbbrain_db_diag_report_task#start_time DbbrainDbDiagReportTask#start_time}
  */
  readonly startTime: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dbbrain_db_diag_report_task tencentcloud_dbbrain_db_diag_report_task}
*/
export class DbbrainDbDiagReportTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbbrainDbDiagReportTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dbbrain_db_diag_report_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/dbbrain_db_diag_report_task tencentcloud_dbbrain_db_diag_report_task} Resource
  *
  * @param scope The scope in which to define this construct
