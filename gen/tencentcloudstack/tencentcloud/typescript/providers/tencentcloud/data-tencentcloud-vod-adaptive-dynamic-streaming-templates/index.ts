// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vod_adaptive_dynamic_streaming_templates
...
export interface DataTencentcloudVodAdaptiveDynamicStreamingTemplatesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vod_adaptive_dynamic_streaming_templates#definition DataTencentcloudVodAdaptiveDynamicStreamingTemplates#definition}
  */
  readonly definition?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vod_adaptive_dynamic_streaming_templates#id DataTencentcloudVodAdaptiveDynamicStreamingTemplates#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vod_adaptive_dynamic_streaming_templates#result_output_file DataTencentcloudVodAdaptiveDynamicStreamingTemplates#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Subapplication ID in VOD. If you need to access a resource in a subapplication, enter the subapplication ID in this field; otherwise, leave it empty.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vod_adaptive_dynamic_streaming_templates#sub_app_id DataTencentcloudVodAdaptiveDynamicStreamingTemplates#sub_app_id}
  */
  readonly subAppId?: number;
  /**
  * Template type filter. Valid values: `Preset`, `Custom`. `Preset`: preset template; `Custom`: custom template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vod_adaptive_dynamic_streaming_templates#type DataTencentcloudVodAdaptiveDynamicStreamingTemplates#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vod_adaptive_dynamic_streaming_templates tencentcloud_vod_adaptive_dynamic_streaming_templates}
*/
export class DataTencentcloudVodAdaptiveDynamicStreamingTemplates extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudVodAdaptiveDynamicStreamingTemplates that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vod_adaptive_dynamic_streaming_templates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vod_adaptive_dynamic_streaming_templates tencentcloud_vod_adaptive_dynamic_streaming_templates} Data Source
  *
  * @param scope The scope in which to define this construct
