// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline
...
export interface ElasticsearchLogstashPipelineConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline#id ElasticsearchLogstashPipeline#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline#instance_id ElasticsearchLogstashPipeline#instance_id}
  */
  readonly instanceId: string;
  /**
  * Operation type. 1: save only; 2: save and deploy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline#op_type ElasticsearchLogstashPipeline#op_type}
  */
  readonly opType: number;
  /**
  * pipeline block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline#pipeline ElasticsearchLogstashPipeline#pipeline}
  */
...
export interface ElasticsearchLogstashPipelinePipeline {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline#batch_delay ElasticsearchLogstashPipeline#batch_delay}
  */
  readonly batchDelay: number;
  /**
  * Pipe batch size.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline#batch_size ElasticsearchLogstashPipeline#batch_size}
  */
  readonly batchSize: number;
  /**
  * Pipeline configuration content.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline#config ElasticsearchLogstashPipeline#config}
  */
  readonly config: string;
  /**
  * Pipeline description information.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline#pipeline_desc ElasticsearchLogstashPipeline#pipeline_desc}
  */
  readonly pipelineDesc: string;
  /**
  * Pipeline id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline#pipeline_id ElasticsearchLogstashPipeline#pipeline_id}
  */
  readonly pipelineId: string;
  /**
  * Number of pipeline buffer queue checkpoint writes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline#queue_check_point_writes ElasticsearchLogstashPipeline#queue_check_point_writes}
  */
  readonly queueCheckPointWrites: number;
  /**
  * Pipeline buffer queue size.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline#queue_max_bytes ElasticsearchLogstashPipeline#queue_max_bytes}
  */
  readonly queueMaxBytes: string;
  /**
  * Pipeline buffer queue type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline#queue_type ElasticsearchLogstashPipeline#queue_type}
  */
  readonly queueType: string;
  /**
  * Number of Worker of pipe.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline#workers ElasticsearchLogstashPipeline#workers}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline tencentcloud_elasticsearch_logstash_pipeline}
*/
export class ElasticsearchLogstashPipeline extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticsearchLogstashPipeline that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/elasticsearch_logstash_pipeline tencentcloud_elasticsearch_logstash_pipeline} Resource
  *
  * @param scope The scope in which to define this construct
