// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/css_play_auth_key_config
...
export interface CssPlayAuthKeyConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/css_play_auth_key_config#auth_back_key CssPlayAuthKeyConfig#auth_back_key}
  */
  readonly authBackKey?: string;
  /**
  * Valid time, unit: second. No transfer means that the current value is not modified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/css_play_auth_key_config#auth_delta CssPlayAuthKeyConfig#auth_delta}
  */
  readonly authDelta?: number;
  /**
  * Authentication key. No transfer means that the current value is not modified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/css_play_auth_key_config#auth_key CssPlayAuthKeyConfig#auth_key}
  */
  readonly authKey?: string;
  /**
  * Domain Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/css_play_auth_key_config#domain_name CssPlayAuthKeyConfig#domain_name}
  */
  readonly domainName: string;
  /**
  * Enable or not, 0: Close, 1: Enable. No transfer means that the current value is not modified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/css_play_auth_key_config#enable CssPlayAuthKeyConfig#enable}
  */
  readonly enable?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/css_play_auth_key_config#id CssPlayAuthKeyConfig#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/css_play_auth_key_config tencentcloud_css_play_auth_key_config}
*/
export class CssPlayAuthKeyConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CssPlayAuthKeyConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/css_play_auth_key_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/css_play_auth_key_config tencentcloud_css_play_auth_key_config} Resource
  *
  * @param scope The scope in which to define this construct
