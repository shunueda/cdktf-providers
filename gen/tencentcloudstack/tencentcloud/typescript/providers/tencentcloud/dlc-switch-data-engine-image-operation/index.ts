// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/dlc_switch_data_engine_image_operation
...
export interface DlcSwitchDataEngineImageOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Engine ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/dlc_switch_data_engine_image_operation#data_engine_id DlcSwitchDataEngineImageOperation#data_engine_id}
  */
  readonly dataEngineId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/dlc_switch_data_engine_image_operation#id DlcSwitchDataEngineImageOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/dlc_switch_data_engine_image_operation#new_image_version_id DlcSwitchDataEngineImageOperation#new_image_version_id}
  */
  readonly newImageVersionId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/dlc_switch_data_engine_image_operation tencentcloud_dlc_switch_data_engine_image_operation}
*/
export class DlcSwitchDataEngineImageOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DlcSwitchDataEngineImageOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/dlc_switch_data_engine_image_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/dlc_switch_data_engine_image_operation tencentcloud_dlc_switch_data_engine_image_operation} Resource
  *
  * @param scope The scope in which to define this construct
