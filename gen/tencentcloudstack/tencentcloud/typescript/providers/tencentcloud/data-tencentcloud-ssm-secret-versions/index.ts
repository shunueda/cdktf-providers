// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/ssm_secret_versions
...
export interface DataTencentcloudSsmSecretVersionsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/ssm_secret_versions#id DataTencentcloudSsmSecretVersions#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/ssm_secret_versions#result_output_file DataTencentcloudSsmSecretVersions#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Secret name used to filter result.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/ssm_secret_versions#secret_name DataTencentcloudSsmSecretVersions#secret_name}
  */
  readonly secretName: string;
  /**
  * VersionId used to filter result.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/ssm_secret_versions#version_id DataTencentcloudSsmSecretVersions#version_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/ssm_secret_versions tencentcloud_ssm_secret_versions}
*/
export class DataTencentcloudSsmSecretVersions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudSsmSecretVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/ssm_secret_versions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/ssm_secret_versions tencentcloud_ssm_secret_versions} Data Source
  *
  * @param scope The scope in which to define this construct
