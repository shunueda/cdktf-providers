// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/css_backup_stream
...
export interface CssBackupStreamConfig extends cdktf.TerraformMetaArguments {
  ...
  * App name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/css_backup_stream#app_name CssBackupStream#app_name}
  */
  readonly appName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/css_backup_stream#id CssBackupStream#id}
  *
  ...
  * Push domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/css_backup_stream#push_domain_name CssBackupStream#push_domain_name}
  */
  readonly pushDomainName: string;
  /**
  * Stream id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/css_backup_stream#stream_name CssBackupStream#stream_name}
  */
  readonly streamName: string;
  /**
  * Sequence.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/css_backup_stream#upstream_sequence CssBackupStream#upstream_sequence}
  */
  readonly upstreamSequence: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/css_backup_stream tencentcloud_css_backup_stream}
*/
export class CssBackupStream extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CssBackupStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/css_backup_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/css_backup_stream tencentcloud_css_backup_stream} Resource
  *
  * @param scope The scope in which to define this construct
