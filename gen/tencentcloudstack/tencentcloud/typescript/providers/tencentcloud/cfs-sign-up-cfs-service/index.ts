// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/cfs_sign_up_cfs_service
...
export interface CfsSignUpCfsServiceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/cfs_sign_up_cfs_service#id CfsSignUpCfsService#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/cfs_sign_up_cfs_service tencentcloud_cfs_sign_up_cfs_service}
*/
export class CfsSignUpCfsService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CfsSignUpCfsService that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/cfs_sign_up_cfs_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/cfs_sign_up_cfs_service tencentcloud_cfs_sign_up_cfs_service} Resource
  *
  * @param scope The scope in which to define this construct
