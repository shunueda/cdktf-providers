// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cvm_export_images
...
export interface CvmExportImagesConfig extends cdktf.TerraformMetaArguments {
  ...
  * COS bucket name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cvm_export_images#bucket_name CvmExportImages#bucket_name}
  */
  readonly bucketName: string;
  /**
  * Check whether the image can be exported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cvm_export_images#dry_run CvmExportImages#dry_run}
  */
  readonly dryRun?: boolean | cdktf.IResolvable;
  /**
  * Format of the exported image file. Valid values: RAW, QCOW2, VHD and VMDK. Default value: RAW.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cvm_export_images#export_format CvmExportImages#export_format}
  */
  readonly exportFormat?: string;
  /**
  * Prefix of exported file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cvm_export_images#file_name_prefix CvmExportImages#file_name_prefix}
  */
  readonly fileNamePrefix: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cvm_export_images#id CvmExportImages#id}
  *
  ...
  * Image ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cvm_export_images#image_id CvmExportImages#image_id}
  */
  readonly imageId: string;
  /**
  * Whether to export only the system disk.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cvm_export_images#only_export_root_disk CvmExportImages#only_export_root_disk}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cvm_export_images#role_name CvmExportImages#role_name}
  */
  readonly roleName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cvm_export_images tencentcloud_cvm_export_images}
*/
export class CvmExportImages extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CvmExportImages that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cvm_export_images#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cvm_export_images tencentcloud_cvm_export_images} Resource
  *
  * @param scope The scope in which to define this construct
