// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/rum_whitelist
...
export interface RumWhitelistConfig extends cdktf.TerraformMetaArguments {
  ...
  * Business identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/rum_whitelist#aid RumWhitelist#aid}
  */
  readonly aid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/rum_whitelist#id RumWhitelist#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/rum_whitelist#instance_id RumWhitelist#instance_id}
  */
  readonly instanceId: string;
  /**
  * Remarks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/rum_whitelist#remark RumWhitelist#remark}
  */
  readonly remark: string;
  /**
  * uin: business identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/rum_whitelist#whitelist_uin RumWhitelist#whitelist_uin}
  */
  readonly whitelistUin: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/rum_whitelist tencentcloud_rum_whitelist}
*/
export class RumWhitelist extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RumWhitelist that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/rum_whitelist#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/rum_whitelist tencentcloud_rum_whitelist} Resource
  *
  * @param scope The scope in which to define this construct
