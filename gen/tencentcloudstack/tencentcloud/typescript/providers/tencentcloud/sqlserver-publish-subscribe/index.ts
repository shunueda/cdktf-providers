// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/sqlserver_publish_subscribe
...
export interface SqlserverPublishSubscribeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/sqlserver_publish_subscribe#delete_subscribe_db SqlserverPublishSubscribe#delete_subscribe_db}
  */
  readonly deleteSubscribeDb?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/sqlserver_publish_subscribe#id SqlserverPublishSubscribe#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/sqlserver_publish_subscribe#publish_instance_id SqlserverPublishSubscribe#publish_instance_id}
  */
  readonly publishInstanceId: string;
  /**
  * The name of the Publish and Subscribe. Default is `default_name`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/sqlserver_publish_subscribe#publish_subscribe_name SqlserverPublishSubscribe#publish_subscribe_name}
  */
  readonly publishSubscribeName?: string;
  /**
  * ID of the SQL Server instance which subscribe.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/sqlserver_publish_subscribe#subscribe_instance_id SqlserverPublishSubscribe#subscribe_instance_id}
  */
  readonly subscribeInstanceId: string;
  /**
  * database_tuples block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/sqlserver_publish_subscribe#database_tuples SqlserverPublishSubscribe#database_tuples}
  */
...
export interface SqlserverPublishSubscribeDatabaseTuples {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/sqlserver_publish_subscribe#publish_database SqlserverPublishSubscribe#publish_database}
  */
  readonly publishDatabase: string;
  /**
  * Subscribe the database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/sqlserver_publish_subscribe#subscribe_database SqlserverPublishSubscribe#subscribe_database}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/sqlserver_publish_subscribe tencentcloud_sqlserver_publish_subscribe}
*/
export class SqlserverPublishSubscribe extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlserverPublishSubscribe that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/sqlserver_publish_subscribe#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/sqlserver_publish_subscribe tencentcloud_sqlserver_publish_subscribe} Resource
  *
  * @param scope The scope in which to define this construct
