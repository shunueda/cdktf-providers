// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/igtm_address_pool
...
export interface IgtmAddressPoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/igtm_address_pool#id IgtmAddressPool#id}
  *
  ...
  * Monitor ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/igtm_address_pool#monitor_id IgtmAddressPool#monitor_id}
  */
  readonly monitorId?: number;
  /**
  * Address pool name, duplicates are not allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/igtm_address_pool#pool_name IgtmAddressPool#pool_name}
  */
  readonly poolName: string;
  /**
  * Traffic strategy: WEIGHT for load balancing, ALL for resolving all healthy addresses.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/igtm_address_pool#traffic_strategy IgtmAddressPool#traffic_strategy}
  */
  readonly trafficStrategy: string;
  /**
  * address_set block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/igtm_address_pool#address_set IgtmAddressPool#address_set}
  */
...
export interface IgtmAddressPoolAddressSet {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/igtm_address_pool#addr IgtmAddressPool#addr}
  */
  readonly addr: string;
  /**
  * Whether to enable: DISABLED for disabled, ENABLED for enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/igtm_address_pool#is_enable IgtmAddressPool#is_enable}
  */
  readonly isEnable: string;
  /**
  * Address name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/igtm_address_pool#location IgtmAddressPool#location}
  */
  readonly location?: string;
  /**
  * Weight, required when traffic strategy is WEIGHT; range 1-100.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/igtm_address_pool#weight IgtmAddressPool#weight}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/igtm_address_pool tencentcloud_igtm_address_pool}
*/
export class IgtmAddressPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IgtmAddressPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/igtm_address_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/igtm_address_pool tencentcloud_igtm_address_pool} Resource
  *
  * @param scope The scope in which to define this construct
