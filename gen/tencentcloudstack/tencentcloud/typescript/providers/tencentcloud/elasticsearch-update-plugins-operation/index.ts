// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/elasticsearch_update_plugins_operation
...
export interface ElasticsearchUpdatePluginsOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/elasticsearch_update_plugins_operation#force_restart ElasticsearchUpdatePluginsOperation#force_restart}
  */
  readonly forceRestart?: boolean | cdktf.IResolvable;
  /**
  * Whether to reinstall, default value false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/elasticsearch_update_plugins_operation#force_update ElasticsearchUpdatePluginsOperation#force_update}
  */
  readonly forceUpdate?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/elasticsearch_update_plugins_operation#id ElasticsearchUpdatePluginsOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/elasticsearch_update_plugins_operation#install_plugin_list ElasticsearchUpdatePluginsOperation#install_plugin_list}
  */
  readonly installPluginList?: string[];
  /**
  * Instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/elasticsearch_update_plugins_operation#instance_id ElasticsearchUpdatePluginsOperation#instance_id}
  */
  readonly instanceId: string;
  /**
  * Plugin type. 0: system plugin.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/elasticsearch_update_plugins_operation#plugin_type ElasticsearchUpdatePluginsOperation#plugin_type}
  */
  readonly pluginType?: number;
  /**
  * List of plugins that need to be uninstalled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/elasticsearch_update_plugins_operation#remove_plugin_list ElasticsearchUpdatePluginsOperation#remove_plugin_list}
  */
  readonly removePluginList?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/elasticsearch_update_plugins_operation tencentcloud_elasticsearch_update_plugins_operation}
*/
export class ElasticsearchUpdatePluginsOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticsearchUpdatePluginsOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/elasticsearch_update_plugins_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/elasticsearch_update_plugins_operation tencentcloud_elasticsearch_update_plugins_operation} Resource
  *
  * @param scope The scope in which to define this construct
