// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list
...
export interface DataTencentcloudDbbrainMysqlProcessListConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list#command DataTencentcloudDbbrainMysqlProcessList#command}
  */
  readonly command?: string;
  /**
  * The threads operations database, used to filter the thread list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list#db DataTencentcloudDbbrainMysqlProcessList#db}
  */
  readonly db?: string;
  /**
  * The operating host address of the thread, used to filter the thread list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list#host DataTencentcloudDbbrainMysqlProcessList#host}
  */
  readonly host?: string;
  /**
  * thread ID, used to filter the thread list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list#id DataTencentcloudDbbrainMysqlProcessList#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list#info DataTencentcloudDbbrainMysqlProcessList#info}
  */
  readonly info?: string;
  /**
  * instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list#instance_id DataTencentcloudDbbrainMysqlProcessList#instance_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list#product DataTencentcloudDbbrainMysqlProcessList#product}
  */
  readonly product?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list#result_output_file DataTencentcloudDbbrainMysqlProcessList#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * The operational state of the thread, used to filter the thread list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list#state DataTencentcloudDbbrainMysqlProcessList#state}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list#time DataTencentcloudDbbrainMysqlProcessList#time}
  */
  readonly time?: number;
  /**
  * The operating account name of the thread, used to filter the thread list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list#user DataTencentcloudDbbrainMysqlProcessList#user}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list tencentcloud_dbbrain_mysql_process_list}
*/
export class DataTencentcloudDbbrainMysqlProcessList extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudDbbrainMysqlProcessList that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_mysql_process_list tencentcloud_dbbrain_mysql_process_list} Data Source
  *
  * @param scope The scope in which to define this construct
