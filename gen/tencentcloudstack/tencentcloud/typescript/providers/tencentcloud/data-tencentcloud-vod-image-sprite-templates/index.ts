// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_image_sprite_templates
...
export interface DataTencentcloudVodImageSpriteTemplatesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_image_sprite_templates#definition DataTencentcloudVodImageSpriteTemplates#definition}
  */
  readonly definition?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_image_sprite_templates#id DataTencentcloudVodImageSpriteTemplates#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_image_sprite_templates#result_output_file DataTencentcloudVodImageSpriteTemplates#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Subapplication ID in VOD. If you need to access a resource in a subapplication, enter the subapplication ID in this field; otherwise, leave it empty.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_image_sprite_templates#sub_app_id DataTencentcloudVodImageSpriteTemplates#sub_app_id}
  */
  readonly subAppId?: number;
  /**
  * Template type filter. Valid values: `Preset`, `Custom`. `Preset`: preset template; `Custom`: custom template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_image_sprite_templates#type DataTencentcloudVodImageSpriteTemplates#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_image_sprite_templates tencentcloud_vod_image_sprite_templates}
*/
export class DataTencentcloudVodImageSpriteTemplates extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudVodImageSpriteTemplates that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_image_sprite_templates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/vod_image_sprite_templates tencentcloud_vod_image_sprite_templates} Data Source
  *
  * @param scope The scope in which to define this construct
