// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_config_database_ct
...
export interface SqlserverConfigDatabaseCtConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_config_database_ct#change_retention_day SqlserverConfigDatabaseCt#change_retention_day}
  */
  readonly changeRetentionDay?: number;
  /**
  * database name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_config_database_ct#db_name SqlserverConfigDatabaseCt#db_name}
  */
  readonly dbName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_config_database_ct#id SqlserverConfigDatabaseCt#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_config_database_ct#instance_id SqlserverConfigDatabaseCt#instance_id}
  */
  readonly instanceId: string;
  /**
  * Enable or disable CT. Valid values: enable, disable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_config_database_ct#modify_type SqlserverConfigDatabaseCt#modify_type}
  */
  readonly modifyType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_config_database_ct tencentcloud_sqlserver_config_database_ct}
*/
export class SqlserverConfigDatabaseCt extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlserverConfigDatabaseCt that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_config_database_ct#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_config_database_ct tencentcloud_sqlserver_config_database_ct} Resource
  *
  * @param scope The scope in which to define this construct
