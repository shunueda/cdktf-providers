// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_full_backup_migration
...
export interface SqlserverFullBackupMigrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_full_backup_migration#backup_files SqlserverFullBackupMigration#backup_files}
  */
  readonly backupFiles?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_full_backup_migration#id SqlserverFullBackupMigration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_full_backup_migration#instance_id SqlserverFullBackupMigration#instance_id}
  */
  readonly instanceId: string;
  /**
  * Task name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_full_backup_migration#migration_name SqlserverFullBackupMigration#migration_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_full_backup_migration#recovery_type SqlserverFullBackupMigration#recovery_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_full_backup_migration#upload_type SqlserverFullBackupMigration#upload_type}
  */
  readonly uploadType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_full_backup_migration tencentcloud_sqlserver_full_backup_migration}
*/
export class SqlserverFullBackupMigration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlserverFullBackupMigration that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_full_backup_migration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_full_backup_migration tencentcloud_sqlserver_full_backup_migration} Resource
  *
  * @param scope The scope in which to define this construct
