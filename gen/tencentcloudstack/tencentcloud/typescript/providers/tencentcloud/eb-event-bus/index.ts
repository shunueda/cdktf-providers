// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/eb_event_bus
...
export interface EbEventBusConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/eb_event_bus#description EbEventBus#description}
  */
  readonly description?: string;
  /**
  * Whether the EB storage is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/eb_event_bus#enable_store EbEventBus#enable_store}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/eb_event_bus#event_bus_name EbEventBus#event_bus_name}
  */
  readonly eventBusName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/eb_event_bus#id EbEventBus#id}
  *
  ...
  * EB storage duration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/eb_event_bus#save_days EbEventBus#save_days}
  */
  readonly saveDays?: number;
  /**
  * Tag description list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/eb_event_bus#tags EbEventBus#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/eb_event_bus tencentcloud_eb_event_bus}
*/
export class EbEventBus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EbEventBus that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/eb_event_bus#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/eb_event_bus tencentcloud_eb_event_bus} Resource
  *
  * @param scope The scope in which to define this construct
