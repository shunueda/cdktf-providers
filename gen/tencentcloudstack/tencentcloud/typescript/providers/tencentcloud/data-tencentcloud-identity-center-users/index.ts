// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/identity_center_users
...
export interface DataTencentcloudIdentityCenterUsersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/identity_center_users#filter DataTencentcloudIdentityCenterUsers#filter}
  */
  readonly filter?: string;
  /**
  * Filtered user group. IsSelected=1 will be returned for the sub-user associated with this user group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/identity_center_users#filter_groups DataTencentcloudIdentityCenterUsers#filter_groups}
  */
  readonly filterGroups?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/identity_center_users#id DataTencentcloudIdentityCenterUsers#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/identity_center_users#result_output_file DataTencentcloudIdentityCenterUsers#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Sorting field, which currently only supports CreateTime. The default is the CreateTime field.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/identity_center_users#sort_field DataTencentcloudIdentityCenterUsers#sort_field}
  */
  readonly sortField?: string;
  /**
  * Sorting type. Desc: descending order; Asc: ascending order. It should be set along with SortField.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/identity_center_users#sort_type DataTencentcloudIdentityCenterUsers#sort_type}
  */
  readonly sortType?: string;
  /**
  * User status: Enabled, Disabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/identity_center_users#user_status DataTencentcloudIdentityCenterUsers#user_status}
  */
  readonly userStatus?: string;
  /**
  * User type. Manual: manually created; Synchronized: externally imported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/identity_center_users#user_type DataTencentcloudIdentityCenterUsers#user_type}
  */
  readonly userType?: string;
  /**
  * Space ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/identity_center_users#zone_id DataTencentcloudIdentityCenterUsers#zone_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/identity_center_users tencentcloud_identity_center_users}
*/
export class DataTencentcloudIdentityCenterUsers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudIdentityCenterUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/identity_center_users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/identity_center_users tencentcloud_identity_center_users} Data Source
  *
  * @param scope The scope in which to define this construct
