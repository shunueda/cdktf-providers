// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cynosdb_reload_proxy_node
...
export interface CynosdbReloadProxyNodeConfig extends cdktf.TerraformMetaArguments {
  ...
  * cluster id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cynosdb_reload_proxy_node#cluster_id CynosdbReloadProxyNode#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cynosdb_reload_proxy_node#id CynosdbReloadProxyNode#id}
  *
  ...
  * proxy group id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cynosdb_reload_proxy_node#proxy_group_id CynosdbReloadProxyNode#proxy_group_id}
  */
  readonly proxyGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cynosdb_reload_proxy_node tencentcloud_cynosdb_reload_proxy_node}
*/
export class CynosdbReloadProxyNode extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CynosdbReloadProxyNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cynosdb_reload_proxy_node#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/cynosdb_reload_proxy_node tencentcloud_cynosdb_reload_proxy_node} Resource
  *
  * @param scope The scope in which to define this construct
