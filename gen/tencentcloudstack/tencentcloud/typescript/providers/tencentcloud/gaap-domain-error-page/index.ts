// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/gaap_domain_error_page
...
export interface GaapDomainErrorPageConfig extends cdktf.TerraformMetaArguments {
  ...
  * New response body.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/gaap_domain_error_page#body GaapDomainErrorPage#body}
  */
  readonly body: string;
  /**
  * Response headers to be removed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/gaap_domain_error_page#clear_headers GaapDomainErrorPage#clear_headers}
  */
  readonly clearHeaders?: string[];
  /**
  * HTTP domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/gaap_domain_error_page#domain GaapDomainErrorPage#domain}
  */
  readonly domain: string;
  /**
  * Original error codes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/gaap_domain_error_page#error_codes GaapDomainErrorPage#error_codes}
  */
  readonly errorCodes: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/gaap_domain_error_page#id GaapDomainErrorPage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/gaap_domain_error_page#listener_id GaapDomainErrorPage#listener_id}
  */
  readonly listenerId: string;
  /**
  * New error code.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/gaap_domain_error_page#new_error_code GaapDomainErrorPage#new_error_code}
  */
  readonly newErrorCode?: number;
  /**
  * Response headers to be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/gaap_domain_error_page#set_headers GaapDomainErrorPage#set_headers}
  */
  readonly setHeaders?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/gaap_domain_error_page tencentcloud_gaap_domain_error_page}
*/
export class GaapDomainErrorPage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GaapDomainErrorPage that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/gaap_domain_error_page#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/gaap_domain_error_page tencentcloud_gaap_domain_error_page} Resource
  *
  * @param scope The scope in which to define this construct
