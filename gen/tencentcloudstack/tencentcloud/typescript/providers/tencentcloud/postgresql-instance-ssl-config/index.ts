// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_instance_ssl_config
...
export interface PostgresqlInstanceSslConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_instance_ssl_config#connect_address PostgresqlInstanceSslConfig#connect_address}
  */
  readonly connectAddress?: string;
  /**
  * Postgres instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_instance_ssl_config#db_instance_id PostgresqlInstanceSslConfig#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_instance_ssl_config#id PostgresqlInstanceSslConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_instance_ssl_config#ssl_enabled PostgresqlInstanceSslConfig#ssl_enabled}
  */
  readonly sslEnabled: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_instance_ssl_config tencentcloud_postgresql_instance_ssl_config}
*/
export class PostgresqlInstanceSslConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresqlInstanceSslConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_instance_ssl_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/postgresql_instance_ssl_config tencentcloud_postgresql_instance_ssl_config} Resource
  *
  * @param scope The scope in which to define this construct
