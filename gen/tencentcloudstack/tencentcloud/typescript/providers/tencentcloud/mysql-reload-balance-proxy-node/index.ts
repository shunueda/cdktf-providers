// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/mysql_reload_balance_proxy_node
...
export interface MysqlReloadBalanceProxyNodeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/mysql_reload_balance_proxy_node#id MysqlReloadBalanceProxyNode#id}
  *
  ...
  * Proxy address id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/mysql_reload_balance_proxy_node#proxy_address_id MysqlReloadBalanceProxyNode#proxy_address_id}
  */
  readonly proxyAddressId?: string;
  /**
  * Proxy id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/mysql_reload_balance_proxy_node#proxy_group_id MysqlReloadBalanceProxyNode#proxy_group_id}
  */
  readonly proxyGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/mysql_reload_balance_proxy_node tencentcloud_mysql_reload_balance_proxy_node}
*/
export class MysqlReloadBalanceProxyNode extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlReloadBalanceProxyNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/mysql_reload_balance_proxy_node#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/mysql_reload_balance_proxy_node tencentcloud_mysql_reload_balance_proxy_node} Resource
  *
  * @param scope The scope in which to define this construct
