// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/subscribe_private_zone_service
...
export interface SubscribePrivateZoneServiceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/subscribe_private_zone_service#id SubscribePrivateZoneService#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/subscribe_private_zone_service tencentcloud_subscribe_private_zone_service}
*/
export class SubscribePrivateZoneService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SubscribePrivateZoneService that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/subscribe_private_zone_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/subscribe_private_zone_service tencentcloud_subscribe_private_zone_service} Resource
  *
  * @param scope The scope in which to define this construct
