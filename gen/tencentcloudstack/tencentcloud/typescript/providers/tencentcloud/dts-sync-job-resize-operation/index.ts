// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/dts_sync_job_resize_operation
...
export interface DtsSyncJobResizeOperationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/dts_sync_job_resize_operation#id DtsSyncJobResizeOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/dts_sync_job_resize_operation#job_id DtsSyncJobResizeOperation#job_id}
  */
  readonly jobId: string;
  /**
  * Task specification.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/dts_sync_job_resize_operation#new_instance_class DtsSyncJobResizeOperation#new_instance_class}
  */
  readonly newInstanceClass: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/dts_sync_job_resize_operation tencentcloud_dts_sync_job_resize_operation}
*/
export class DtsSyncJobResizeOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DtsSyncJobResizeOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/dts_sync_job_resize_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/dts_sync_job_resize_operation tencentcloud_dts_sync_job_resize_operation} Resource
  *
  * @param scope The scope in which to define this construct
