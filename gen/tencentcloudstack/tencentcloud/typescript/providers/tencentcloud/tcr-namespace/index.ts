// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tcr_namespace
...
export interface TcrNamespaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tcr_namespace#id TcrNamespace#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tcr_namespace#instance_id TcrNamespace#instance_id}
  */
  readonly instanceId: string;
  /**
  * Scanning level, `True` is automatic, `False` is manual. Default is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tcr_namespace#is_auto_scan TcrNamespace#is_auto_scan}
  */
  readonly isAutoScan?: boolean | cdktf.IResolvable;
  /**
  * Blocking switch, `True` is open, `False` is closed. Default is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tcr_namespace#is_prevent_vul TcrNamespace#is_prevent_vul}
  */
  readonly isPreventVul?: boolean | cdktf.IResolvable;
  /**
  * Indicate that the namespace is public or not. Default is `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tcr_namespace#is_public TcrNamespace#is_public}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tcr_namespace#name TcrNamespace#name}
  */
  readonly name: string;
  /**
  * Block vulnerability level, currently only supports `low`, `medium`, `high`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tcr_namespace#severity TcrNamespace#severity}
  */
  readonly severity?: string;
  /**
  * cve_whitelist_items block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tcr_namespace#cve_whitelist_items TcrNamespace#cve_whitelist_items}
  */
...
export interface TcrNamespaceCveWhitelistItems {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tcr_namespace#cve_id TcrNamespace#cve_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tcr_namespace tencentcloud_tcr_namespace}
*/
export class TcrNamespace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TcrNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tcr_namespace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/tcr_namespace tencentcloud_tcr_namespace} Resource
  *
  * @param scope The scope in which to define this construct
