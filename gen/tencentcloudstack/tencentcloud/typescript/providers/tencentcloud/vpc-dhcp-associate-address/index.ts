// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/vpc_dhcp_associate_address
...
export interface VpcDhcpAssociateAddressConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/vpc_dhcp_associate_address#address_ip VpcDhcpAssociateAddress#address_ip}
  */
  readonly addressIp: string;
  /**
  * `DhcpIp` unique `ID`, like: `dhcpip-9o233uri`. Must be a `DhcpIp` that is not bound to `EIP`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/vpc_dhcp_associate_address#dhcp_ip_id VpcDhcpAssociateAddress#dhcp_ip_id}
  */
  readonly dhcpIpId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/vpc_dhcp_associate_address#id VpcDhcpAssociateAddress#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/vpc_dhcp_associate_address tencentcloud_vpc_dhcp_associate_address}
*/
export class VpcDhcpAssociateAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcDhcpAssociateAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/vpc_dhcp_associate_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/vpc_dhcp_associate_address tencentcloud_vpc_dhcp_associate_address} Resource
  *
  * @param scope The scope in which to define this construct
