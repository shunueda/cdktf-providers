// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mysql_binlog_backup_overview
...
export interface DataTencentcloudMysqlBinlogBackupOverviewConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mysql_binlog_backup_overview#id DataTencentcloudMysqlBinlogBackupOverview#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mysql_binlog_backup_overview#product DataTencentcloudMysqlBinlogBackupOverview#product}
  */
  readonly product: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mysql_binlog_backup_overview#result_output_file DataTencentcloudMysqlBinlogBackupOverview#result_output_file}
  */
  readonly resultOutputFile?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mysql_binlog_backup_overview tencentcloud_mysql_binlog_backup_overview}
*/
export class DataTencentcloudMysqlBinlogBackupOverview extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudMysqlBinlogBackupOverview that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mysql_binlog_backup_overview#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mysql_binlog_backup_overview tencentcloud_mysql_binlog_backup_overview} Data Source
  *
  * @param scope The scope in which to define this construct
