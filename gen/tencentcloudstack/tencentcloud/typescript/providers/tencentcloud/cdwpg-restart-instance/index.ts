// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cdwpg_restart_instance
...
export interface CdwpgRestartInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cdwpg_restart_instance#id CdwpgRestartInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cdwpg_restart_instance#instance_id CdwpgRestartInstance#instance_id}
  */
  readonly instanceId: string;
  /**
  * Node ids to restart (specify nodes to reboot).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cdwpg_restart_instance#node_ids CdwpgRestartInstance#node_ids}
  */
  readonly nodeIds?: string[];
  /**
  * Node types to restart (gtm/cn/dn).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cdwpg_restart_instance#node_types CdwpgRestartInstance#node_types}
  */
  readonly nodeTypes?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cdwpg_restart_instance tencentcloud_cdwpg_restart_instance}
*/
export class CdwpgRestartInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdwpgRestartInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cdwpg_restart_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/cdwpg_restart_instance tencentcloud_cdwpg_restart_instance} Resource
  *
  * @param scope The scope in which to define this construct
