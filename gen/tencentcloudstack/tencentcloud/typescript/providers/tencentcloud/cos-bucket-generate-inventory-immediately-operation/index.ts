// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cos_bucket_generate_inventory_immediately_operation
...
export interface CosBucketGenerateInventoryImmediatelyOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Bucket.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cos_bucket_generate_inventory_immediately_operation#bucket CosBucketGenerateInventoryImmediatelyOperation#bucket}
  */
  readonly bucket: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cos_bucket_generate_inventory_immediately_operation#id CosBucketGenerateInventoryImmediatelyOperation#id}
  *
  ...
  * The id of inventory.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cos_bucket_generate_inventory_immediately_operation#inventory_id CosBucketGenerateInventoryImmediatelyOperation#inventory_id}
  */
  readonly inventoryId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cos_bucket_generate_inventory_immediately_operation tencentcloud_cos_bucket_generate_inventory_immediately_operation}
*/
export class CosBucketGenerateInventoryImmediatelyOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CosBucketGenerateInventoryImmediatelyOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cos_bucket_generate_inventory_immediately_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cos_bucket_generate_inventory_immediately_operation tencentcloud_cos_bucket_generate_inventory_immediately_operation} Resource
  *
  * @param scope The scope in which to define this construct
