// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule
...
export interface CkafkaAclRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule#id CkafkaAclRule#id}
  *
  ...
  * instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule#instance_id CkafkaAclRule#instance_id}
  */
  readonly instanceId: string;
  /**
  * Whether the preset ACL rule is applied to the newly added topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule#is_applied CkafkaAclRule#is_applied}
  */
  readonly isApplied?: number;
  /**
  * A value representing the prefix that the prefix matches.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule#pattern CkafkaAclRule#pattern}
  */
  readonly pattern?: string;
  /**
  * Match type, currently supports prefix matching and preset strategy, enumeration value list{PREFIXED/PRESET}.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule#pattern_type CkafkaAclRule#pattern_type}
  */
  readonly patternType: string;
  /**
  * Acl resource type, currently only supports Topic, enumeration value list{Topic}.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule#resource_type CkafkaAclRule#resource_type}
  */
  readonly resourceType: string;
  /**
  * rule name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule#rule_name CkafkaAclRule#rule_name}
  */
  readonly ruleName: string;
  /**
  * rule_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule#rule_list CkafkaAclRule#rule_list}
  */
...
export interface CkafkaAclRuleRuleListStruct {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule#host CkafkaAclRule#host}
  */
  readonly host: string;
  /**
  * Acl operation mode, enumeration value (all operations All, read Read, write Write).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule#operation CkafkaAclRule#operation}
  */
  readonly operation: string;
  /**
  * permission type, (Deny|Allow).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule#permission_type CkafkaAclRule#permission_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule#principal CkafkaAclRule#principal}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule tencentcloud_ckafka_acl_rule}
*/
export class CkafkaAclRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CkafkaAclRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ckafka_acl_rule tencentcloud_ckafka_acl_rule} Resource
  *
  * @param scope The scope in which to define this construct
