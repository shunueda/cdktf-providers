// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway_snat
...
export interface NatGatewaySnatConfig extends cdktf.TerraformMetaArguments {
  ...
  * Description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway_snat#description NatGatewaySnat#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway_snat#id NatGatewaySnat#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway_snat#instance_id NatGatewaySnat#instance_id}
  */
  readonly instanceId?: string;
  /**
  * Private IPs of the instance's primary ENI, required when `resource_type` is NETWORKINTERFACE.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway_snat#instance_private_ip_addr NatGatewaySnat#instance_private_ip_addr}
  */
  readonly instancePrivateIpAddr?: string;
  /**
  * NAT gateway ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway_snat#nat_gateway_id NatGatewaySnat#nat_gateway_id}
  */
  readonly natGatewayId: string;
  /**
  * Elastic IP address pool.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway_snat#public_ip_addr NatGatewaySnat#public_ip_addr}
  */
  readonly publicIpAddr: string[];
  /**
  * Resource type. Valid values: SUBNET, NETWORKINTERFACE.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway_snat#resource_type NatGatewaySnat#resource_type}
  */
  readonly resourceType: string;
  /**
  * The IPv4 CIDR of the subnet, required when `resource_type` is SUBNET.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway_snat#subnet_cidr_block NatGatewaySnat#subnet_cidr_block}
  */
  readonly subnetCidrBlock?: string;
  /**
  * Subnet instance ID, required when `resource_type` is SUBNET.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway_snat#subnet_id NatGatewaySnat#subnet_id}
  */
  readonly subnetId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway_snat tencentcloud_nat_gateway_snat}
*/
export class NatGatewaySnat extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NatGatewaySnat that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway_snat#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/nat_gateway_snat tencentcloud_nat_gateway_snat} Resource
  *
  * @param scope The scope in which to define this construct
