// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ses_email_address
...
export interface SesEmailAddressConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ses_email_address#email_address SesEmailAddress#email_address}
  */
  readonly emailAddress: string;
  /**
  * Sender name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ses_email_address#email_sender_name SesEmailAddress#email_sender_name}
  */
  readonly emailSenderName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ses_email_address#id SesEmailAddress#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ses_email_address#smtp_password SesEmailAddress#smtp_password}
  */
  readonly smtpPassword?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ses_email_address tencentcloud_ses_email_address}
*/
export class SesEmailAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SesEmailAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ses_email_address#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ses_email_address tencentcloud_ses_email_address} Resource
  *
  * @param scope The scope in which to define this construct
