// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_private_nat_gateway
...
export interface VpcPrivateNatGatewayConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_private_nat_gateway#ccn_id VpcPrivateNatGateway#ccn_id}
  */
  readonly ccnId?: string;
  /**
  * Cross-domain parameters. Cross-domain binding of VPCs is supported only when the value is True.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_private_nat_gateway#cross_domain VpcPrivateNatGateway#cross_domain}
  */
  readonly crossDomain?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_private_nat_gateway#id VpcPrivateNatGateway#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_private_nat_gateway#nat_gateway_name VpcPrivateNatGateway#nat_gateway_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_private_nat_gateway#vpc_id VpcPrivateNatGateway#vpc_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_private_nat_gateway#vpc_type VpcPrivateNatGateway#vpc_type}
  */
  readonly vpcType?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_private_nat_gateway tencentcloud_vpc_private_nat_gateway}
*/
export class VpcPrivateNatGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcPrivateNatGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_private_nat_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_private_nat_gateway tencentcloud_vpc_private_nat_gateway} Resource
  *
  * @param scope The scope in which to define this construct
