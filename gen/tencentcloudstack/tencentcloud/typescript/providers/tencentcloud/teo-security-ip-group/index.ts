// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/teo_security_ip_group
...
export interface TeoSecurityIpGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/teo_security_ip_group#id TeoSecurityIpGroup#id}
  *
  ...
  * Site ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/teo_security_ip_group#zone_id TeoSecurityIpGroup#zone_id}
  */
  readonly zoneId: string;
  /**
  * ip_group block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/teo_security_ip_group#ip_group TeoSecurityIpGroup#ip_group}
  */
...
export interface TeoSecurityIpGroupIpGroup {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/teo_security_ip_group#content TeoSecurityIpGroup#content}
  */
  readonly content: string[];
  /**
  * Group name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/teo_security_ip_group#name TeoSecurityIpGroup#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/teo_security_ip_group tencentcloud_teo_security_ip_group}
*/
export class TeoSecurityIpGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeoSecurityIpGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/teo_security_ip_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/teo_security_ip_group tencentcloud_teo_security_ip_group} Resource
  *
  * @param scope The scope in which to define this construct
