// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dnspod_domain_lock
...
export interface DnspodDomainLockConfig extends cdktf.TerraformMetaArguments {
  ...
  * Domain name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dnspod_domain_lock#domain DnspodDomainLock#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dnspod_domain_lock#id DnspodDomainLock#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dnspod_domain_lock#lock_days DnspodDomainLock#lock_days}
  */
  readonly lockDays: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dnspod_domain_lock tencentcloud_dnspod_domain_lock}
*/
export class DnspodDomainLock extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnspodDomainLock that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dnspod_domain_lock#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dnspod_domain_lock tencentcloud_dnspod_domain_lock} Resource
  *
  * @param scope The scope in which to define this construct
