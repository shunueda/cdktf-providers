// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_cls_log_attachment
...
export interface MysqlClsLogAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  * Cls region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_cls_log_attachment#cls_region MysqlClsLogAttachment#cls_region}
  */
  readonly clsRegion?: string;
  /**
  * Whether to create index.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_cls_log_attachment#create_index MysqlClsLogAttachment#create_index}
  */
  readonly createIndex?: boolean | cdktf.IResolvable;
  /**
  * Whether to create log set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_cls_log_attachment#create_log_set MysqlClsLogAttachment#create_log_set}
  */
  readonly createLogSet?: boolean | cdktf.IResolvable;
  /**
  * Whether to create log topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_cls_log_attachment#create_log_topic MysqlClsLogAttachment#create_log_topic}
  */
  readonly createLogTopic?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_cls_log_attachment#id MysqlClsLogAttachment#id}
  *
  ...
  * The id of instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_cls_log_attachment#instance_id MysqlClsLogAttachment#instance_id}
  */
  readonly instanceId: string;
  /**
  * If `create_log_set` is `true`, use log set name, Else use log set Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_cls_log_attachment#log_set MysqlClsLogAttachment#log_set}
  */
  readonly logSet: string;
  /**
  * If `create_log_topic` is `true`, use log topic name, Else use log topic Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_cls_log_attachment#log_topic MysqlClsLogAttachment#log_topic}
  */
  readonly logTopic: string;
  /**
  * Log type. Support `error` or `slowlog`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_cls_log_attachment#log_type MysqlClsLogAttachment#log_type}
  */
  readonly logType: string;
  /**
  * The validity period of the log theme is 30 days by default when not filled in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_cls_log_attachment#period MysqlClsLogAttachment#period}
  */
  readonly period?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_cls_log_attachment tencentcloud_mysql_cls_log_attachment}
*/
export class MysqlClsLogAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlClsLogAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_cls_log_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/mysql_cls_log_attachment tencentcloud_mysql_cls_log_attachment} Resource
  *
  * @param scope The scope in which to define this construct
