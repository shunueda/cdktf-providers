// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/organization_org_member_auth_identity_attachment
...
export interface OrganizationOrgMemberAuthIdentityAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/organization_org_member_auth_identity_attachment#id OrganizationOrgMemberAuthIdentityAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/organization_org_member_auth_identity_attachment#identity_ids OrganizationOrgMemberAuthIdentityAttachment#identity_ids}
  */
  readonly identityIds: number[];
  /**
  * Member Uin.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/organization_org_member_auth_identity_attachment#member_uin OrganizationOrgMemberAuthIdentityAttachment#member_uin}
  */
  readonly memberUin: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/organization_org_member_auth_identity_attachment tencentcloud_organization_org_member_auth_identity_attachment}
*/
export class OrganizationOrgMemberAuthIdentityAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationOrgMemberAuthIdentityAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/organization_org_member_auth_identity_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/organization_org_member_auth_identity_attachment tencentcloud_organization_org_member_auth_identity_attachment} Resource
  *
  * @param scope The scope in which to define this construct
