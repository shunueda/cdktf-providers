// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/ssl_certificates
...
export interface DataTencentcloudSslCertificatesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/ssl_certificates#id DataTencentcloudSslCertificates#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/ssl_certificates#name DataTencentcloudSslCertificates#name}
  */
  readonly name?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/ssl_certificates#result_output_file DataTencentcloudSslCertificates#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Type of the SSL certificate to be queried. Available values includes: `CA` and `SVR`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/ssl_certificates#type DataTencentcloudSslCertificates#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/ssl_certificates tencentcloud_ssl_certificates}
*/
export class DataTencentcloudSslCertificates extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudSslCertificates that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/ssl_certificates#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/ssl_certificates tencentcloud_ssl_certificates} Data Source
  *
  * @param scope The scope in which to define this construct
