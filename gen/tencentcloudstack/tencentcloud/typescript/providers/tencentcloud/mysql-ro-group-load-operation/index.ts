// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_ro_group_load_operation
...
export interface MysqlRoGroupLoadOperationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_ro_group_load_operation#id MysqlRoGroupLoadOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_ro_group_load_operation#ro_group_id MysqlRoGroupLoadOperation#ro_group_id}
  */
  readonly roGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_ro_group_load_operation tencentcloud_mysql_ro_group_load_operation}
*/
export class MysqlRoGroupLoadOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlRoGroupLoadOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_ro_group_load_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_ro_group_load_operation tencentcloud_mysql_ro_group_load_operation} Resource
  *
  * @param scope The scope in which to define this construct
