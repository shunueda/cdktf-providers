// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance
...
export interface SqlserverBasicInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#auto_renew SqlserverBasicInstance#auto_renew}
  */
  readonly autoRenew?: number;
  /**
  * Whether to use the voucher automatically; 1 for yes, 0 for no, the default is 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#auto_voucher SqlserverBasicInstance#auto_voucher}
  */
  readonly autoVoucher?: number;
  /**
  * Availability zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#availability_zone SqlserverBasicInstance#availability_zone}
  */
  readonly availabilityZone?: string;
  /**
  * Pay type of the SQL Server basic instance. For now, only `POSTPAID_BY_HOUR` is valid.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#charge_type SqlserverBasicInstance#charge_type}
  */
  readonly chargeType?: string;
  /**
  * System character set sorting rule, default: Chinese_PRC_CI_AS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#collation SqlserverBasicInstance#collation}
  */
  readonly collation?: string;
  /**
  * The CPU number of the SQL Server basic instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#cpu SqlserverBasicInstance#cpu}
  */
  readonly cpu: number;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#engine_version SqlserverBasicInstance#engine_version}
  */
  readonly engineVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#id SqlserverBasicInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#machine_type SqlserverBasicInstance#machine_type}
  */
  readonly machineType: string;
  /**
  * Start time of the maintenance in one day, format like `HH:mm`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#maintenance_start_time SqlserverBasicInstance#maintenance_start_time}
  */
  readonly maintenanceStartTime?: string;
  /**
  * The timespan of maintenance in one day, unit is hour.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#maintenance_time_span SqlserverBasicInstance#maintenance_time_span}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#maintenance_week_set SqlserverBasicInstance#maintenance_week_set}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#memory SqlserverBasicInstance#memory}
  */
  readonly memory: number;
  /**
  * Name of the SQL Server basic instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#name SqlserverBasicInstance#name}
  */
  readonly name: string;
  /**
  * Purchase instance period, the default value is 1, which means one month. The value does not exceed 48.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#period SqlserverBasicInstance#period}
  */
  readonly period?: number;
  /**
  * Project ID, default value is 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#project_id SqlserverBasicInstance#project_id}
  */
  readonly projectId?: number;
  /**
  * Security group bound to the instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#security_groups SqlserverBasicInstance#security_groups}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#storage SqlserverBasicInstance#storage}
  */
  readonly storage: number;
  /**
  * ID of subnet.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#subnet_id SqlserverBasicInstance#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * The tags of the SQL Server basic instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#tags SqlserverBasicInstance#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * An array of voucher IDs, currently only one can be used for a single order.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#voucher_ids SqlserverBasicInstance#voucher_ids}
  */
  readonly voucherIds?: string[];
  /**
  * ID of VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#vpc_id SqlserverBasicInstance#vpc_id}
  */
  readonly vpcId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance tencentcloud_sqlserver_basic_instance}
*/
export class SqlserverBasicInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlserverBasicInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/sqlserver_basic_instance tencentcloud_sqlserver_basic_instance} Resource
  *
  * @param scope The scope in which to define this construct
