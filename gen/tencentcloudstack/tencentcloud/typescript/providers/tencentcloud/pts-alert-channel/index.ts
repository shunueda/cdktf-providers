// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_alert_channel
...
export interface PtsAlertChannelConfig extends cdktf.TerraformMetaArguments {
  ...
  * AMP Consumer ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_alert_channel#amp_consumer_id PtsAlertChannel#amp_consumer_id}
  */
  readonly ampConsumerId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_alert_channel#id PtsAlertChannel#id}
  *
  ...
  * Notice ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_alert_channel#notice_id PtsAlertChannel#notice_id}
  */
  readonly noticeId: string;
  /**
  * Project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_alert_channel#project_id PtsAlertChannel#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_alert_channel tencentcloud_pts_alert_channel}
*/
export class PtsAlertChannel extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PtsAlertChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_alert_channel#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/pts_alert_channel tencentcloud_pts_alert_channel} Resource
  *
  * @param scope The scope in which to define this construct
