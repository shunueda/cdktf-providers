// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/vpc_traffic_package
...
export interface VpcTrafficPackageConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/vpc_traffic_package#id VpcTrafficPackage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/vpc_traffic_package#traffic_amount VpcTrafficPackage#traffic_amount}
  */
  readonly trafficAmount: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/vpc_traffic_package tencentcloud_vpc_traffic_package}
*/
export class VpcTrafficPackage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcTrafficPackage that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/vpc_traffic_package#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/vpc_traffic_package tencentcloud_vpc_traffic_package} Resource
  *
  * @param scope The scope in which to define this construct
