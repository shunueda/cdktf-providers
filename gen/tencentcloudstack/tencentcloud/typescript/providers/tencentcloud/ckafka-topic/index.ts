// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic
...
export interface CkafkaTopicConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#clean_up_policy CkafkaTopic#clean_up_policy}
  */
  readonly cleanUpPolicy?: string;
  /**
  * Whether to open the ip whitelist, `true`: open, `false`: close.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#enable_white_list CkafkaTopic#enable_white_list}
  */
  readonly enableWhiteList?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#id CkafkaTopic#id}
  *
  ...
  * Ckafka instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#instance_id CkafkaTopic#instance_id}
  */
  readonly instanceId: string;
  /**
  * Ip whitelist, quota limit, required when enableWhileList=true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#ip_white_list CkafkaTopic#ip_white_list}
  */
  readonly ipWhiteList?: string[];
  /**
  * Max message bytes. min: 1024 Byte(1KB), max: 8388608 Byte(8MB).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#max_message_bytes CkafkaTopic#max_message_bytes}
  */
  readonly maxMessageBytes?: number;
  /**
  * The subject note. It must start with a letter, and the remaining part can contain letters, numbers and dashes (-).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#note CkafkaTopic#note}
  */
  readonly note?: string;
  /**
  * The number of partition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#partition_num CkafkaTopic#partition_num}
  */
  readonly partitionNum: number;
  /**
  * The number of replica.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#replica_num CkafkaTopic#replica_num}
  */
  readonly replicaNum: number;
  /**
  * Message can be selected. Retention time, unit is ms, the current minimum value is 60000ms.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#retention CkafkaTopic#retention}
  */
  readonly retention?: number;
  /**
  * Segment scrolling time, in ms, the current minimum is 3600000ms.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#segment CkafkaTopic#segment}
  */
  readonly segment?: number;
  /**
  * Min number of sync replicas, Default is `1`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#sync_replica_min_num CkafkaTopic#sync_replica_min_num}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#topic_name CkafkaTopic#topic_name}
  */
  readonly topicName: string;
  /**
  * Whether to allow unsynchronized replicas to be selected as leader, default is `false`, `true: `allowed, `false`: not allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#unclean_leader_election_enable CkafkaTopic#unclean_leader_election_enable}
  */
  readonly uncleanLeaderElectionEnable?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic tencentcloud_ckafka_topic}
*/
export class CkafkaTopic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CkafkaTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/ckafka_topic tencentcloud_ckafka_topic} Resource
  *
  * @param scope The scope in which to define this construct
