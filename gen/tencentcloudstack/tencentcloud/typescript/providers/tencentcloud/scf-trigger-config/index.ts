// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/scf_trigger_config
...
export interface ScfTriggerConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/scf_trigger_config#custom_argument ScfTriggerConfig#custom_argument}
  */
  readonly customArgument?: string;
  /**
  * Trigger description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/scf_trigger_config#description ScfTriggerConfig#description}
  */
  readonly description?: string;
  /**
  * Status of trigger. Values: OPEN (enabled); CLOSE disabled).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/scf_trigger_config#enable ScfTriggerConfig#enable}
  */
  readonly enable?: string;
  /**
  * Function name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/scf_trigger_config#function_name ScfTriggerConfig#function_name}
  */
  readonly functionName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/scf_trigger_config#id ScfTriggerConfig#id}
  *
  ...
  * Function namespace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/scf_trigger_config#namespace ScfTriggerConfig#namespace}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/scf_trigger_config#qualifier ScfTriggerConfig#qualifier}
  */
  readonly qualifier?: string;
  /**
  * TriggerDesc parameter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/scf_trigger_config#trigger_desc ScfTriggerConfig#trigger_desc}
  */
  readonly triggerDesc?: string;
  /**
  * Trigger Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/scf_trigger_config#trigger_name ScfTriggerConfig#trigger_name}
  */
  readonly triggerName: string;
  /**
  * Trigger type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/scf_trigger_config#type ScfTriggerConfig#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/scf_trigger_config tencentcloud_scf_trigger_config}
*/
export class ScfTriggerConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScfTriggerConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/scf_trigger_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/scf_trigger_config tencentcloud_scf_trigger_config} Resource
  *
  * @param scope The scope in which to define this construct
