// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_datahub_topic
...
export interface CkafkaDatahubTopicConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_datahub_topic#id CkafkaDatahubTopic#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_datahub_topic#name CkafkaDatahubTopic#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_datahub_topic#note CkafkaDatahubTopic#note}
  */
  readonly note?: string;
  /**
  * Number of Partitions, greater than 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_datahub_topic#partition_num CkafkaDatahubTopic#partition_num}
  */
  readonly partitionNum: number;
  /**
  * Message retention time, in ms, the current minimum value is 60000 ms.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_datahub_topic#retention_ms CkafkaDatahubTopic#retention_ms}
  */
  readonly retentionMs: number;
  /**
  * Tags of dataHub topic.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_datahub_topic#tags CkafkaDatahubTopic#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_datahub_topic tencentcloud_ckafka_datahub_topic}
*/
export class CkafkaDatahubTopic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CkafkaDatahubTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_datahub_topic#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_datahub_topic tencentcloud_ckafka_datahub_topic} Resource
  *
  * @param scope The scope in which to define this construct
