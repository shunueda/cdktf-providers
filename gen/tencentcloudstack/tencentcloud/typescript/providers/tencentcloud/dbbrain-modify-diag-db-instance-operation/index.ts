// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dbbrain_modify_diag_db_instance_operation
...
export interface DbbrainModifyDiagDbInstanceOperationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dbbrain_modify_diag_db_instance_operation#id DbbrainModifyDiagDbInstanceOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dbbrain_modify_diag_db_instance_operation#instance_ids DbbrainModifyDiagDbInstanceOperation#instance_ids}
  */
  readonly instanceIds?: string[];
  /**
  * Service product type, supported values include: mysql - cloud database MySQL, cynosdb - cloud database CynosDB for MySQL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dbbrain_modify_diag_db_instance_operation#product DbbrainModifyDiagDbInstanceOperation#product}
  */
  readonly product: string;
  /**
  * Effective instance region, the value is All, which means all regions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dbbrain_modify_diag_db_instance_operation#regions DbbrainModifyDiagDbInstanceOperation#regions}
  */
  readonly regions?: string;
  /**
  * instance_confs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dbbrain_modify_diag_db_instance_operation#instance_confs DbbrainModifyDiagDbInstanceOperation#instance_confs}
  */
...
export interface DbbrainModifyDiagDbInstanceOperationInstanceConfs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dbbrain_modify_diag_db_instance_operation#daily_inspection DbbrainModifyDiagDbInstanceOperation#daily_inspection}
  */
  readonly dailyInspection?: string;
  /**
  * Instance overview switch, Yes/No.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dbbrain_modify_diag_db_instance_operation#overview_display DbbrainModifyDiagDbInstanceOperation#overview_display}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dbbrain_modify_diag_db_instance_operation tencentcloud_dbbrain_modify_diag_db_instance_operation}
*/
export class DbbrainModifyDiagDbInstanceOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbbrainModifyDiagDbInstanceOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dbbrain_modify_diag_db_instance_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/dbbrain_modify_diag_db_instance_operation tencentcloud_dbbrain_modify_diag_db_instance_operation} Resource
  *
  * @param scope The scope in which to define this construct
