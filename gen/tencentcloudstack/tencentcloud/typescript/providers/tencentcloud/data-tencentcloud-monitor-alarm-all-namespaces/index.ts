// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/monitor_alarm_all_namespaces
...
export interface DataTencentcloudMonitorAlarmAllNamespacesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/monitor_alarm_all_namespaces#id DataTencentcloudMonitorAlarmAllNamespaces#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/monitor_alarm_all_namespaces#ids DataTencentcloudMonitorAlarmAllNamespaces#ids}
  */
  readonly ids?: string[];
  /**
  * Fixed value, as `monitor`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/monitor_alarm_all_namespaces#module DataTencentcloudMonitorAlarmAllNamespaces#module}
  */
  readonly module: string;
  /**
  * Filter based on monitoring type, do not fill in default, check all types MT_QCE=cloud product monitoring.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/monitor_alarm_all_namespaces#monitor_types DataTencentcloudMonitorAlarmAllNamespaces#monitor_types}
  */
  readonly monitorTypes?: string[];
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/monitor_alarm_all_namespaces#result_output_file DataTencentcloudMonitorAlarmAllNamespaces#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Currently, only ST_ALARM=alarm type is filtered based on usage scenarios.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/monitor_alarm_all_namespaces#scene_type DataTencentcloudMonitorAlarmAllNamespaces#scene_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/monitor_alarm_all_namespaces tencentcloud_monitor_alarm_all_namespaces}
*/
export class DataTencentcloudMonitorAlarmAllNamespaces extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudMonitorAlarmAllNamespaces that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/monitor_alarm_all_namespaces#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/monitor_alarm_all_namespaces tencentcloud_monitor_alarm_all_namespaces} Data Source
  *
  * @param scope The scope in which to define this construct
