// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_start_backup_incremental_migration
...
export interface SqlserverStartBackupIncrementalMigrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_start_backup_incremental_migration#backup_migration_id SqlserverStartBackupIncrementalMigration#backup_migration_id}
  */
  readonly backupMigrationId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_start_backup_incremental_migration#id SqlserverStartBackupIncrementalMigration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_start_backup_incremental_migration#incremental_migration_id SqlserverStartBackupIncrementalMigration#incremental_migration_id}
  */
  readonly incrementalMigrationId: string;
  /**
  * ID of imported target instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_start_backup_incremental_migration#instance_id SqlserverStartBackupIncrementalMigration#instance_id}
  */
  readonly instanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_start_backup_incremental_migration tencentcloud_sqlserver_start_backup_incremental_migration}
*/
export class SqlserverStartBackupIncrementalMigration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlserverStartBackupIncrementalMigration that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_start_backup_incremental_migration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/sqlserver_start_backup_incremental_migration tencentcloud_sqlserver_start_backup_incremental_migration} Resource
  *
  * @param scope The scope in which to define this construct
