// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ssl_check_certificate_chain_operation
...
export interface SslCheckCertificateChainOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ssl_check_certificate_chain_operation#certificate_chain SslCheckCertificateChainOperation#certificate_chain}
  */
  readonly certificateChain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ssl_check_certificate_chain_operation#id SslCheckCertificateChainOperation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ssl_check_certificate_chain_operation tencentcloud_ssl_check_certificate_chain_operation}
*/
export class SslCheckCertificateChainOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslCheckCertificateChainOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ssl_check_certificate_chain_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/ssl_check_certificate_chain_operation tencentcloud_ssl_check_certificate_chain_operation} Resource
  *
  * @param scope The scope in which to define this construct
