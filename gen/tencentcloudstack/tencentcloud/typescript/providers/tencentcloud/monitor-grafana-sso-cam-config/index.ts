// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/monitor_grafana_sso_cam_config
...
export interface MonitorGrafanaSsoCamConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/monitor_grafana_sso_cam_config#enable_sso_cam_check MonitorGrafanaSsoCamConfig#enable_sso_cam_check}
  */
  readonly enableSsoCamCheck: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/monitor_grafana_sso_cam_config#id MonitorGrafanaSsoCamConfig#id}
  *
  ...
  * Grafana instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/monitor_grafana_sso_cam_config#instance_id MonitorGrafanaSsoCamConfig#instance_id}
  */
  readonly instanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/monitor_grafana_sso_cam_config tencentcloud_monitor_grafana_sso_cam_config}
*/
export class MonitorGrafanaSsoCamConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorGrafanaSsoCamConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/monitor_grafana_sso_cam_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/monitor_grafana_sso_cam_config tencentcloud_monitor_grafana_sso_cam_config} Resource
  *
  * @param scope The scope in which to define this construct
