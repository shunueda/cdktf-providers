// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_bot_scene_status_config
...
export interface WafBotSceneStatusConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  * Domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_bot_scene_status_config#domain WafBotSceneStatusConfig#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_bot_scene_status_config#id WafBotSceneStatusConfig#id}
  *
  ...
  * Scene ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_bot_scene_status_config#scene_id WafBotSceneStatusConfig#scene_id}
  */
  readonly sceneId: string;
  /**
  * Bot status. true - enable; false - disable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_bot_scene_status_config#status WafBotSceneStatusConfig#status}
  */
  readonly status: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_bot_scene_status_config tencentcloud_waf_bot_scene_status_config}
*/
export class WafBotSceneStatusConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafBotSceneStatusConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_bot_scene_status_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_bot_scene_status_config tencentcloud_waf_bot_scene_status_config} Resource
  *
  * @param scope The scope in which to define this construct
