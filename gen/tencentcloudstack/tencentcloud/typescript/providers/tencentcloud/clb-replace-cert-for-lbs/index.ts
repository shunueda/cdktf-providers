// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs
...
export interface ClbReplaceCertForLbsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs#id ClbReplaceCertForLbs#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs#old_certificate_id ClbReplaceCertForLbs#old_certificate_id}
  */
  readonly oldCertificateId: string;
  /**
  * certificate block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs#certificate ClbReplaceCertForLbs#certificate}
  */
...
export interface ClbReplaceCertForLbsCertificate {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs#cert_ca_content ClbReplaceCertForLbs#cert_ca_content}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs#cert_ca_id ClbReplaceCertForLbs#cert_ca_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs#cert_ca_name ClbReplaceCertForLbs#cert_ca_name}
  */
  readonly certCaName?: string;
  /**
  * Content of the uploaded server certificate. If there is no CertId, this parameter is required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs#cert_content ClbReplaceCertForLbs#cert_content}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs#cert_id ClbReplaceCertForLbs#cert_id}
  */
  readonly certId?: string;
  /**
  * Key of the uploaded server certificate. If there is no CertId, this parameter is required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs#cert_key ClbReplaceCertForLbs#cert_key}
  */
  readonly certKey?: string;
  /**
  * Name of the uploaded server certificate. If there is no CertId, this parameter is required.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs#cert_name ClbReplaceCertForLbs#cert_name}
  */
  readonly certName?: string;
  /**
  * Authentication type. Value range: UNIDIRECTIONAL (unidirectional authentication), MUTUAL (mutual authentication).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs#ssl_mode ClbReplaceCertForLbs#ssl_mode}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs tencentcloud_clb_replace_cert_for_lbs}
*/
export class ClbReplaceCertForLbs extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClbReplaceCertForLbs that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/clb_replace_cert_for_lbs tencentcloud_clb_replace_cert_for_lbs} Resource
  *
  * @param scope The scope in which to define this construct
