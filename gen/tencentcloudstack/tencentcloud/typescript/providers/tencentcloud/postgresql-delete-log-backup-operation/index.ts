// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/postgresql_delete_log_backup_operation
...
export interface PostgresqlDeleteLogBackupOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/postgresql_delete_log_backup_operation#db_instance_id PostgresqlDeleteLogBackupOperation#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/postgresql_delete_log_backup_operation#id PostgresqlDeleteLogBackupOperation#id}
  *
  ...
  * Log backup ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/postgresql_delete_log_backup_operation#log_backup_id PostgresqlDeleteLogBackupOperation#log_backup_id}
  */
  readonly logBackupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/postgresql_delete_log_backup_operation tencentcloud_postgresql_delete_log_backup_operation}
*/
export class PostgresqlDeleteLogBackupOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresqlDeleteLogBackupOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/postgresql_delete_log_backup_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/postgresql_delete_log_backup_operation tencentcloud_postgresql_delete_log_backup_operation} Resource
  *
  * @param scope The scope in which to define this construct
