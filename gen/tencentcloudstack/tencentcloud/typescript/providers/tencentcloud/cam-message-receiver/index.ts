// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cam_message_receiver
...
export interface CamMessageReceiverConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cam_message_receiver#country_code CamMessageReceiver#country_code}
  */
  readonly countryCode: string;
  /**
  * Email address, for example: 57*****@qq.com.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cam_message_receiver#email CamMessageReceiver#email}
  */
  readonly email: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cam_message_receiver#id CamMessageReceiver#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cam_message_receiver#name CamMessageReceiver#name}
  */
  readonly name: string;
  /**
  * Mobile phone number, for example: 132****2492.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cam_message_receiver#phone_number CamMessageReceiver#phone_number}
  */
  readonly phoneNumber: string;
  /**
  * Recipient's notes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cam_message_receiver#remark CamMessageReceiver#remark}
  */
  readonly remark?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cam_message_receiver tencentcloud_cam_message_receiver}
*/
export class CamMessageReceiver extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CamMessageReceiver that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cam_message_receiver#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cam_message_receiver tencentcloud_cam_message_receiver} Resource
  *
  * @param scope The scope in which to define this construct
