// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/ccn_routes
...
export interface CcnRoutesConfig extends cdktf.TerraformMetaArguments {
  ...
  * CCN Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/ccn_routes#ccn_id CcnRoutes#ccn_id}
  */
  readonly ccnId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/ccn_routes#id CcnRoutes#id}
  *
  ...
  * CCN Route Id List.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/ccn_routes#route_id CcnRoutes#route_id}
  */
  readonly routeId: string;
  /**
  * `on`: Enable, `off`: Disable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/ccn_routes#switch CcnRoutes#switch}
  */
  readonly switch: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/ccn_routes tencentcloud_ccn_routes}
*/
export class CcnRoutes extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CcnRoutes that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/ccn_routes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/ccn_routes tencentcloud_ccn_routes} Resource
  *
  * @param scope The scope in which to define this construct
