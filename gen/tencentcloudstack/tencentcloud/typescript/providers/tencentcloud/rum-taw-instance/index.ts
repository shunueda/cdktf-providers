// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/rum_taw_instance
...
export interface RumTawInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/rum_taw_instance#area_id RumTawInstance#area_id}
  */
  readonly areaId: number;
  /**
  * Billing type (1: Pay-as-you-go).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/rum_taw_instance#charge_type RumTawInstance#charge_type}
  */
  readonly chargeType: number;
  /**
  * Data retention period (at least greater than 0).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/rum_taw_instance#data_retention_days RumTawInstance#data_retention_days}
  */
  readonly dataRetentionDays: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/rum_taw_instance#id RumTawInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/rum_taw_instance#instance_desc RumTawInstance#instance_desc}
  */
  readonly instanceDesc?: string;
  /**
  * Instance name (up to 255 bytes).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/rum_taw_instance#instance_name RumTawInstance#instance_name}
  */
  readonly instanceName: string;
  /**
  * Tag description list. Up to 10 tag key-value pairs are supported and must be unique.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/rum_taw_instance#tags RumTawInstance#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/rum_taw_instance tencentcloud_rum_taw_instance}
*/
export class RumTawInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RumTawInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/rum_taw_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/rum_taw_instance tencentcloud_rum_taw_instance} Resource
  *
  * @param scope The scope in which to define this construct
