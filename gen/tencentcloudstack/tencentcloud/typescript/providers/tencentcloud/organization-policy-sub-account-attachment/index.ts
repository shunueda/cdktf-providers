// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_policy_sub_account_attachment
...
export interface OrganizationPolicySubAccountAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_policy_sub_account_attachment#id OrganizationPolicySubAccountAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_policy_sub_account_attachment#member_uin OrganizationPolicySubAccountAttachment#member_uin}
  */
  readonly memberUin: number;
  /**
  * Organization administrator sub account uin list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_policy_sub_account_attachment#org_sub_account_uin OrganizationPolicySubAccountAttachment#org_sub_account_uin}
  */
  readonly orgSubAccountUin: number;
  /**
  * Policy ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_policy_sub_account_attachment#policy_id OrganizationPolicySubAccountAttachment#policy_id}
  */
  readonly policyId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_policy_sub_account_attachment tencentcloud_organization_policy_sub_account_attachment}
*/
export class OrganizationPolicySubAccountAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationPolicySubAccountAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_policy_sub_account_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_policy_sub_account_attachment tencentcloud_organization_policy_sub_account_attachment} Resource
  *
  * @param scope The scope in which to define this construct
