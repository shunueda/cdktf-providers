// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dasb_device_group_members
...
export interface DasbDeviceGroupMembersConfig extends cdktf.TerraformMetaArguments {
  ...
  * Device Group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dasb_device_group_members#device_group_id DasbDeviceGroupMembers#device_group_id}
  */
  readonly deviceGroupId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dasb_device_group_members#id DasbDeviceGroupMembers#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dasb_device_group_members#member_id_set DasbDeviceGroupMembers#member_id_set}
  */
  readonly memberIdSet: number[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dasb_device_group_members tencentcloud_dasb_device_group_members}
*/
export class DasbDeviceGroupMembers extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DasbDeviceGroupMembers that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dasb_device_group_members#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dasb_device_group_members tencentcloud_dasb_device_group_members} Resource
  *
  * @param scope The scope in which to define this construct
