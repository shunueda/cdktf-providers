// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_time_window
...
export interface MysqlTimeWindowConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_time_window#id MysqlTimeWindow#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_time_window#instance_id MysqlTimeWindow#instance_id}
  */
  readonly instanceId: string;
  /**
  * Data delay threshold. It takes effect only for source instance and disaster recovery instance. Default value: 10.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_time_window#max_delay_time MysqlTimeWindow#max_delay_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_time_window#time_ranges MysqlTimeWindow#time_ranges}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_time_window#weekdays MysqlTimeWindow#weekdays}
  */
  readonly weekdays?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_time_window tencentcloud_mysql_time_window}
*/
export class MysqlTimeWindow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlTimeWindow that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_time_window#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mysql_time_window tencentcloud_mysql_time_window} Resource
  *
  * @param scope The scope in which to define this construct
