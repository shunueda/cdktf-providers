// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ccn_route_table_associate_instance_config
...
export interface CcnRouteTableAssociateInstanceConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the CCN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ccn_route_table_associate_instance_config#ccn_id CcnRouteTableAssociateInstanceConfig#ccn_id}
  */
  readonly ccnId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ccn_route_table_associate_instance_config#id CcnRouteTableAssociateInstanceConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ccn_route_table_associate_instance_config#route_table_id CcnRouteTableAssociateInstanceConfig#route_table_id}
  */
  readonly routeTableId: string;
  /**
  * instances block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ccn_route_table_associate_instance_config#instances CcnRouteTableAssociateInstanceConfig#instances}
  */
...
export interface CcnRouteTableAssociateInstanceConfigInstances {
  ...
  * Instances ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ccn_route_table_associate_instance_config#instance_id CcnRouteTableAssociateInstanceConfig#instance_id}
  */
  readonly instanceId: string;
  /**
  * Cloud networking supports instance types: VPC, DIRECTCONNECT, BMVPC, EDGE, EDGE_TUNNEL, EDGE_VPNGW, VPNGW.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ccn_route_table_associate_instance_config#instance_type CcnRouteTableAssociateInstanceConfig#instance_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ccn_route_table_associate_instance_config tencentcloud_ccn_route_table_associate_instance_config}
*/
export class CcnRouteTableAssociateInstanceConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CcnRouteTableAssociateInstanceConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ccn_route_table_associate_instance_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/ccn_route_table_associate_instance_config tencentcloud_ccn_route_table_associate_instance_config} Resource
  *
  * @param scope The scope in which to define this construct
