// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dasb_device
...
export interface DasbDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dasb_device#department_id DasbDevice#department_id}
  */
  readonly departmentId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dasb_device#id DasbDevice#id}
  *
  ...
  * IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dasb_device#ip DasbDevice#ip}
  */
  readonly ip: string;
  /**
  * Asset multi-node: fields ip and port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dasb_device#ip_port_set DasbDevice#ip_port_set}
  */
  readonly ipPortSet?: string[];
  /**
  * Hostname, can be empty.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dasb_device#name DasbDevice#name}
  */
  readonly name?: string;
  /**
  * Operating system name, only Linux, Windows or MySQL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dasb_device#os_name DasbDevice#os_name}
  */
  readonly osName: string;
  /**
  * Management port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dasb_device#port DasbDevice#port}
  */
  readonly port: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dasb_device tencentcloud_dasb_device}
*/
export class DasbDevice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DasbDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dasb_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/dasb_device tencentcloud_dasb_device} Resource
  *
  * @param scope The scope in which to define this construct
