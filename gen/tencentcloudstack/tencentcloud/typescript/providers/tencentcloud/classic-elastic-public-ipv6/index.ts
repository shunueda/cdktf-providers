// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/classic_elastic_public_ipv6
...
export interface ClassicElasticPublicIpv6Config extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/classic_elastic_public_ipv6#bandwidth_package_id ClassicElasticPublicIpv6#bandwidth_package_id}
  */
  readonly bandwidthPackageId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/classic_elastic_public_ipv6#id ClassicElasticPublicIpv6#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/classic_elastic_public_ipv6#internet_charge_type ClassicElasticPublicIpv6#internet_charge_type}
  */
  readonly internetChargeType?: string;
  /**
  * Bandwidth in Mbps. Default is 1Mbps.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/classic_elastic_public_ipv6#internet_max_bandwidth_out ClassicElasticPublicIpv6#internet_max_bandwidth_out}
  */
  readonly internetMaxBandwidthOut?: number;
  /**
  * IPV6 addresses that require public network access.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/classic_elastic_public_ipv6#ip6_address ClassicElasticPublicIpv6#ip6_address}
  */
  readonly ip6Address: string;
  /**
  * Tags.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/classic_elastic_public_ipv6#tags ClassicElasticPublicIpv6#tags}
  */
  readonly tags?: { [key: string]: string };
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/classic_elastic_public_ipv6 tencentcloud_classic_elastic_public_ipv6}
*/
export class ClassicElasticPublicIpv6 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClassicElasticPublicIpv6 that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/classic_elastic_public_ipv6#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/classic_elastic_public_ipv6 tencentcloud_classic_elastic_public_ipv6} Resource
  *
  * @param scope The scope in which to define this construct
