// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mps_manage_task_operation
...
export interface MpsManageTaskOperationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mps_manage_task_operation#id MpsManageTaskOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mps_manage_task_operation#operation_type MpsManageTaskOperation#operation_type}
  */
  readonly operationType: string;
  /**
  * Video processing task ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mps_manage_task_operation#task_id MpsManageTaskOperation#task_id}
  */
  readonly taskId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mps_manage_task_operation tencentcloud_mps_manage_task_operation}
*/
export class MpsManageTaskOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MpsManageTaskOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mps_manage_task_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mps_manage_task_operation tencentcloud_mps_manage_task_operation} Resource
  *
  * @param scope The scope in which to define this construct
