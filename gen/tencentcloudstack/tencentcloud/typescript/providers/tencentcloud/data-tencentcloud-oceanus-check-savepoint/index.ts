// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/oceanus_check_savepoint
...
export interface DataTencentcloudOceanusCheckSavepointConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/oceanus_check_savepoint#id DataTencentcloudOceanusCheckSavepoint#id}
  *
  ...
  * Job id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/oceanus_check_savepoint#job_id DataTencentcloudOceanusCheckSavepoint#job_id}
  */
  readonly jobId: string;
  /**
  * Snapshot type. 1:savepoint; 2:checkpoint; 3:cancelWithSavepoint.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/oceanus_check_savepoint#record_type DataTencentcloudOceanusCheckSavepoint#record_type}
  */
  readonly recordType: number;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/oceanus_check_savepoint#result_output_file DataTencentcloudOceanusCheckSavepoint#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Snapshot path, currently only supports COS path.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/oceanus_check_savepoint#savepoint_path DataTencentcloudOceanusCheckSavepoint#savepoint_path}
  */
  readonly savepointPath: string;
  /**
  * Snapshot resource ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/oceanus_check_savepoint#serial_id DataTencentcloudOceanusCheckSavepoint#serial_id}
  */
  readonly serialId: string;
  /**
  * Workspace ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/oceanus_check_savepoint#work_space_id DataTencentcloudOceanusCheckSavepoint#work_space_id}
  */
  readonly workSpaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/oceanus_check_savepoint tencentcloud_oceanus_check_savepoint}
*/
export class DataTencentcloudOceanusCheckSavepoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudOceanusCheckSavepoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/oceanus_check_savepoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/data-sources/oceanus_check_savepoint tencentcloud_oceanus_check_savepoint} Data Source
  *
  * @param scope The scope in which to define this construct
