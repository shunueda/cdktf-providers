// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/gaap_proxies
...
export interface DataTencentcloudGaapProxiesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/gaap_proxies#access_region DataTencentcloudGaapProxies#access_region}
  */
  readonly accessRegion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/gaap_proxies#id DataTencentcloudGaapProxies#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/gaap_proxies#ids DataTencentcloudGaapProxies#ids}
  */
  readonly ids?: string[];
  /**
  * Project ID of the GAAP proxy to be queried. Conflict with `ids`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/gaap_proxies#project_id DataTencentcloudGaapProxies#project_id}
  */
  readonly projectId?: number;
  /**
  * Region of the GAAP realserver to be queried. Conflict with `ids`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/gaap_proxies#realserver_region DataTencentcloudGaapProxies#realserver_region}
  */
  readonly realserverRegion?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/gaap_proxies#result_output_file DataTencentcloudGaapProxies#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Tags of the GAAP proxy to be queried. Support up to 5, display the information as long as it matches one.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/gaap_proxies#tags DataTencentcloudGaapProxies#tags}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/gaap_proxies tencentcloud_gaap_proxies}
*/
export class DataTencentcloudGaapProxies extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudGaapProxies that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/gaap_proxies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/gaap_proxies tencentcloud_gaap_proxies} Data Source
  *
  * @param scope The scope in which to define this construct
