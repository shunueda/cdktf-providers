// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/redis_upgrade_cache_version_operation
...
export interface RedisUpgradeCacheVersionOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/redis_upgrade_cache_version_operation#current_redis_version RedisUpgradeCacheVersionOperation#current_redis_version}
  */
  readonly currentRedisVersion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/redis_upgrade_cache_version_operation#id RedisUpgradeCacheVersionOperation#id}
  *
  ...
  * The ID of instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/redis_upgrade_cache_version_operation#instance_id RedisUpgradeCacheVersionOperation#instance_id}
  */
  readonly instanceId: string;
  /**
  * Switch mode:1 - Upgrade now0 - Maintenance window upgrade.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/redis_upgrade_cache_version_operation#instance_type_upgrade_now RedisUpgradeCacheVersionOperation#instance_type_upgrade_now}
  */
  readonly instanceTypeUpgradeNow: number;
  /**
  * Upgradeable redis version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/redis_upgrade_cache_version_operation#upgrade_redis_version RedisUpgradeCacheVersionOperation#upgrade_redis_version}
  */
  readonly upgradeRedisVersion: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/redis_upgrade_cache_version_operation tencentcloud_redis_upgrade_cache_version_operation}
*/
export class RedisUpgradeCacheVersionOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisUpgradeCacheVersionOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/redis_upgrade_cache_version_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/redis_upgrade_cache_version_operation tencentcloud_redis_upgrade_cache_version_operation} Resource
  *
  * @param scope The scope in which to define this construct
