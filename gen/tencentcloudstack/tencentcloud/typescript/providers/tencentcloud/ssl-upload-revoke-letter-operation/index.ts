// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ssl_upload_revoke_letter_operation
...
export interface SslUploadRevokeLetterOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Certificate ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ssl_upload_revoke_letter_operation#certificate_id SslUploadRevokeLetterOperation#certificate_id}
  */
  readonly certificateId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ssl_upload_revoke_letter_operation#id SslUploadRevokeLetterOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ssl_upload_revoke_letter_operation#revoke_letter SslUploadRevokeLetterOperation#revoke_letter}
  */
  readonly revokeLetter: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ssl_upload_revoke_letter_operation tencentcloud_ssl_upload_revoke_letter_operation}
*/
export class SslUploadRevokeLetterOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslUploadRevokeLetterOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ssl_upload_revoke_letter_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ssl_upload_revoke_letter_operation tencentcloud_ssl_upload_revoke_letter_operation} Resource
  *
  * @param scope The scope in which to define this construct
