// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/cam_role_detail
...
export interface DataTencentcloudCamRoleDetailConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/cam_role_detail#id DataTencentcloudCamRoleDetail#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/cam_role_detail#result_output_file DataTencentcloudCamRoleDetail#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Role ID, used to specify role. Input either `RoleId` or `RoleName`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/cam_role_detail#role_id DataTencentcloudCamRoleDetail#role_id}
  */
  readonly roleId?: string;
  /**
  * Role name, used to specify role. Input either `RoleId` or `RoleName`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/cam_role_detail#role_name DataTencentcloudCamRoleDetail#role_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/cam_role_detail tencentcloud_cam_role_detail}
*/
export class DataTencentcloudCamRoleDetail extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudCamRoleDetail that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/cam_role_detail#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/cam_role_detail tencentcloud_cam_role_detail} Data Source
  *
  * @param scope The scope in which to define this construct
