// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/identity_center_role_configuration_permission_policy_attachment
...
export interface IdentityCenterRoleConfigurationPermissionPolicyAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/identity_center_role_configuration_permission_policy_attachment#id IdentityCenterRoleConfigurationPermissionPolicyAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/identity_center_role_configuration_permission_policy_attachment#role_configuration_id IdentityCenterRoleConfigurationPermissionPolicyAttachment#role_configuration_id}
  */
  readonly roleConfigurationId: string;
  /**
  * Role policy id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/identity_center_role_configuration_permission_policy_attachment#role_policy_id IdentityCenterRoleConfigurationPermissionPolicyAttachment#role_policy_id}
  */
  readonly rolePolicyId: number;
  /**
  * Role policy name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/identity_center_role_configuration_permission_policy_attachment#role_policy_name IdentityCenterRoleConfigurationPermissionPolicyAttachment#role_policy_name}
  */
  readonly rolePolicyName?: string;
  /**
  * Space ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/identity_center_role_configuration_permission_policy_attachment#zone_id IdentityCenterRoleConfigurationPermissionPolicyAttachment#zone_id}
  */
  readonly zoneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/identity_center_role_configuration_permission_policy_attachment tencentcloud_identity_center_role_configuration_permission_policy_attachment}
*/
export class IdentityCenterRoleConfigurationPermissionPolicyAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityCenterRoleConfigurationPermissionPolicyAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/identity_center_role_configuration_permission_policy_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/identity_center_role_configuration_permission_policy_attachment tencentcloud_identity_center_role_configuration_permission_policy_attachment} Resource
  *
  * @param scope The scope in which to define this construct
