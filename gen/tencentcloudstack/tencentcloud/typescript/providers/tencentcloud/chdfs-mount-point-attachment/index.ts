// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/chdfs_mount_point_attachment
...
export interface ChdfsMountPointAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/chdfs_mount_point_attachment#access_group_ids ChdfsMountPointAttachment#access_group_ids}
  */
  readonly accessGroupIds: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/chdfs_mount_point_attachment#id ChdfsMountPointAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/chdfs_mount_point_attachment#mount_point_id ChdfsMountPointAttachment#mount_point_id}
  */
  readonly mountPointId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/chdfs_mount_point_attachment tencentcloud_chdfs_mount_point_attachment}
*/
export class ChdfsMountPointAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChdfsMountPointAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/chdfs_mount_point_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/chdfs_mount_point_attachment tencentcloud_chdfs_mount_point_attachment} Resource
  *
  * @param scope The scope in which to define this construct
