// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dc_internet_address_quota
...
export interface DataTencentcloudDcInternetAddressQuotaConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dc_internet_address_quota#id DataTencentcloudDcInternetAddressQuota#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dc_internet_address_quota#result_output_file DataTencentcloudDcInternetAddressQuota#result_output_file}
  */
  readonly resultOutputFile?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dc_internet_address_quota tencentcloud_dc_internet_address_quota}
*/
export class DataTencentcloudDcInternetAddressQuota extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudDcInternetAddressQuota that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dc_internet_address_quota#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/dc_internet_address_quota tencentcloud_dc_internet_address_quota} Data Source
  *
  * @param scope The scope in which to define this construct
