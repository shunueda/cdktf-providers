// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/chdfs_file_system
...
export interface ChdfsFileSystemConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/chdfs_file_system#capacity_quota ChdfsFileSystem#capacity_quota}
  */
  readonly capacityQuota: number;
  /**
  * desc of the file system.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/chdfs_file_system#description ChdfsFileSystem#description}
  */
  readonly description?: string;
  /**
  * check the ranger address or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/chdfs_file_system#enable_ranger ChdfsFileSystem#enable_ranger}
  */
  readonly enableRanger?: boolean | cdktf.IResolvable;
  /**
  * file system name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/chdfs_file_system#file_system_name ChdfsFileSystem#file_system_name}
  */
  readonly fileSystemName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/chdfs_file_system#id ChdfsFileSystem#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/chdfs_file_system#posix_acl ChdfsFileSystem#posix_acl}
  */
  readonly posixAcl: boolean | cdktf.IResolvable;
  /**
  * ranger address list, default empty.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/chdfs_file_system#ranger_service_addresses ChdfsFileSystem#ranger_service_addresses}
  */
  readonly rangerServiceAddresses?: string[];
  /**
  * super users of the file system, default empty.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/chdfs_file_system#super_users ChdfsFileSystem#super_users}
  */
  readonly superUsers?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/chdfs_file_system tencentcloud_chdfs_file_system}
*/
export class ChdfsFileSystem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChdfsFileSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/chdfs_file_system#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/chdfs_file_system tencentcloud_chdfs_file_system} Resource
  *
  * @param scope The scope in which to define this construct
