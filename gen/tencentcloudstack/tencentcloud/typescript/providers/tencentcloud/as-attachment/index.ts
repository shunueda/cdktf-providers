// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/as_attachment
...
export interface AsAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/as_attachment#id AsAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/as_attachment#instance_ids AsAttachment#instance_ids}
  */
  readonly instanceIds: string[];
  /**
  * ID of a scaling group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/as_attachment#scaling_group_id AsAttachment#scaling_group_id}
  */
  readonly scalingGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/as_attachment tencentcloud_as_attachment}
*/
export class AsAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AsAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/as_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/as_attachment tencentcloud_as_attachment} Resource
  *
  * @param scope The scope in which to define this construct
