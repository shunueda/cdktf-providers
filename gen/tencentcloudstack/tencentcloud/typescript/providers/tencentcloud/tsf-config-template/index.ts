// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_config_template
...
export interface TsfConfigTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_config_template#config_template_desc TsfConfigTemplate#config_template_desc}
  */
  readonly configTemplateDesc?: string;
  /**
  * Configuration template name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_config_template#config_template_name TsfConfigTemplate#config_template_name}
  */
  readonly configTemplateName: string;
  /**
  * Configure the microservice framework corresponding to the template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_config_template#config_template_type TsfConfigTemplate#config_template_type}
  */
  readonly configTemplateType: string;
  /**
  * Configure template data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_config_template#config_template_value TsfConfigTemplate#config_template_value}
  */
  readonly configTemplateValue: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_config_template#id TsfConfigTemplate#id}
  *
  ...
  * Program id list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_config_template#program_id_list TsfConfigTemplate#program_id_list}
  */
  readonly programIdList?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_config_template tencentcloud_tsf_config_template}
*/
export class TsfConfigTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TsfConfigTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_config_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/tsf_config_template tencentcloud_tsf_config_template} Resource
  *
  * @param scope The scope in which to define this construct
