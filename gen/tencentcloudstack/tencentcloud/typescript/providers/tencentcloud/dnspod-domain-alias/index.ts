// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dnspod_domain_alias
...
export interface DnspodDomainAliasConfig extends cdktf.TerraformMetaArguments {
  ...
  * Domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dnspod_domain_alias#domain DnspodDomainAlias#domain}
  */
  readonly domain: string;
  /**
  * Domain alias.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dnspod_domain_alias#domain_alias DnspodDomainAlias#domain_alias}
  */
  readonly domainAlias: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dnspod_domain_alias#id DnspodDomainAlias#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dnspod_domain_alias tencentcloud_dnspod_domain_alias}
*/
export class DnspodDomainAlias extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnspodDomainAlias that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dnspod_domain_alias#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/dnspod_domain_alias tencentcloud_dnspod_domain_alias} Resource
  *
  * @param scope The scope in which to define this construct
