// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_manager
...
export interface VpcPeerConnectManagerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_manager#bandwidth VpcPeerConnectManager#bandwidth}
  */
  readonly bandwidth?: number;
  /**
  * Billing mode, daily peak value POSTPAID_BY_DAY_MAX, monthly value 95 POSTPAID_BY_MONTH_95.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_manager#charge_type VpcPeerConnectManager#charge_type}
  */
  readonly chargeType?: string;
  /**
  * Peer region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_manager#destination_region VpcPeerConnectManager#destination_region}
  */
  readonly destinationRegion: string;
  /**
  * Peer user UIN.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_manager#destination_uin VpcPeerConnectManager#destination_uin}
  */
  readonly destinationUin: string;
  /**
  * The unique ID of the peer VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_manager#destination_vpc_id VpcPeerConnectManager#destination_vpc_id}
  */
  readonly destinationVpcId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_manager#id VpcPeerConnectManager#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_manager#peering_connection_name VpcPeerConnectManager#peering_connection_name}
  */
  readonly peeringConnectionName: string;
  /**
  * Service classification PT, AU, AG.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_manager#qos_level VpcPeerConnectManager#qos_level}
  */
  readonly qosLevel?: string;
  /**
  * The unique ID of the local VPC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_manager#source_vpc_id VpcPeerConnectManager#source_vpc_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_manager#type VpcPeerConnectManager#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_manager tencentcloud_vpc_peer_connect_manager}
*/
export class VpcPeerConnectManager extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcPeerConnectManager that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_manager#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/vpc_peer_connect_manager tencentcloud_vpc_peer_connect_manager} Resource
  *
  * @param scope The scope in which to define this construct
