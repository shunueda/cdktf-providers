// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy
...
export interface DayuCcHttpPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy#action DayuCcHttpPolicy#action}
  */
  readonly action?: string;
  /**
  * Max frequency per minute, only valid when `smode` is `speedlimit`, the valid value ranges from 1 to 10000.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy#frequency DayuCcHttpPolicy#frequency}
  */
  readonly frequency?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy#id DayuCcHttpPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy#ip DayuCcHttpPolicy#ip}
  */
  readonly ip?: string;
  /**
  * Name of the CC self-define http policy. Length should between 1 and 20.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy#name DayuCcHttpPolicy#name}
  */
  readonly name: string;
  /**
  * ID of the resource that the CC self-define http policy works for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy#resource_id DayuCcHttpPolicy#resource_id}
  */
  readonly resourceId: string;
  /**
  * Type of the resource that the CC self-define http policy works for, valid values are `bgpip`, `bgp`, `bgp-multip` and `net`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy#resource_type DayuCcHttpPolicy#resource_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy#smode DayuCcHttpPolicy#smode}
  */
  readonly smode?: string;
  /**
  * Indicate the CC self-define http policy takes effect or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy#switch DayuCcHttpPolicy#switch}
  */
  readonly switch?: boolean | cdktf.IResolvable;
  /**
  * rule_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy#rule_list DayuCcHttpPolicy#rule_list}
  */
...
export interface DayuCcHttpPolicyRuleListStruct {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy#operator DayuCcHttpPolicy#operator}
  */
  readonly operator?: string;
  /**
  * Key of the rule. Valid values: `host`, `cgi`, `ua`, `referer`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy#skey DayuCcHttpPolicy#skey}
  */
  readonly skey?: string;
  /**
  * Rule value, then length should be less than 31 bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy#value DayuCcHttpPolicy#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy tencentcloud_dayu_cc_http_policy}
*/
export class DayuCcHttpPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DayuCcHttpPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dayu_cc_http_policy tencentcloud_dayu_cc_http_policy} Resource
  *
  * @param scope The scope in which to define this construct
