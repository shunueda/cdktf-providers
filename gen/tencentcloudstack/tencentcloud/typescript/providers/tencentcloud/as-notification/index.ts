// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_notification
...
export interface AsNotificationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_notification#id AsNotification#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_notification#notification_types AsNotification#notification_types}
  */
  readonly notificationTypes: string[];
  /**
  * A group of user IDs to be notified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_notification#notification_user_group_ids AsNotification#notification_user_group_ids}
  */
  readonly notificationUserGroupIds: string[];
  /**
  * ID of a scaling group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_notification#scaling_group_id AsNotification#scaling_group_id}
  */
  readonly scalingGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_notification tencentcloud_as_notification}
*/
export class AsNotification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AsNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_notification tencentcloud_as_notification} Resource
  *
  * @param scope The scope in which to define this construct
