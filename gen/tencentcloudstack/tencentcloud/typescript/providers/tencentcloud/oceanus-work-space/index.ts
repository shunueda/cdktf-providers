// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/oceanus_work_space
...
export interface OceanusWorkSpaceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/oceanus_work_space#description OceanusWorkSpace#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/oceanus_work_space#id OceanusWorkSpace#id}
  *
  ...
  * Workspace name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/oceanus_work_space#work_space_name OceanusWorkSpace#work_space_name}
  */
  readonly workSpaceName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/oceanus_work_space tencentcloud_oceanus_work_space}
*/
export class OceanusWorkSpace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OceanusWorkSpace that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/oceanus_work_space#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/oceanus_work_space tencentcloud_oceanus_work_space} Resource
  *
  * @param scope The scope in which to define this construct
