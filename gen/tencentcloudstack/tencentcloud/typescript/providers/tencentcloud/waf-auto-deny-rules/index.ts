// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_auto_deny_rules
...
export interface WafAutoDenyRulesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_auto_deny_rules#attack_threshold WafAutoDenyRules#attack_threshold}
  */
  readonly attackThreshold: number;
  /**
  * The IP autodeny time after triggering the IP autodeny, ranging from 5 to 360 minutes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_auto_deny_rules#deny_time_threshold WafAutoDenyRules#deny_time_threshold}
  */
  readonly denyTimeThreshold: number;
  /**
  * Domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_auto_deny_rules#domain WafAutoDenyRules#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_auto_deny_rules#id WafAutoDenyRules#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_auto_deny_rules#time_threshold WafAutoDenyRules#time_threshold}
  */
  readonly timeThreshold: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_auto_deny_rules tencentcloud_waf_auto_deny_rules}
*/
export class WafAutoDenyRules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafAutoDenyRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_auto_deny_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_auto_deny_rules tencentcloud_waf_auto_deny_rules} Resource
  *
  * @param scope The scope in which to define this construct
