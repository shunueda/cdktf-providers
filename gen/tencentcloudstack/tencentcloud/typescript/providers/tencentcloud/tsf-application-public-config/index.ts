// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/tsf_application_public_config
...
export interface TsfApplicationPublicConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  * Config Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/tsf_application_public_config#config_name TsfApplicationPublicConfig#config_name}
  */
  readonly configName: string;
  /**
  * Config type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/tsf_application_public_config#config_type TsfApplicationPublicConfig#config_type}
  */
  readonly configType?: string;
  /**
  * config value, only yaml file allowed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/tsf_application_public_config#config_value TsfApplicationPublicConfig#config_value}
  */
  readonly configValue: string;
  /**
  * config version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/tsf_application_public_config#config_version TsfApplicationPublicConfig#config_version}
  */
  readonly configVersion: string;
  /**
  * Config version description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/tsf_application_public_config#config_version_desc TsfApplicationPublicConfig#config_version_desc}
  */
  readonly configVersionDesc?: string;
  /**
  * the config value is encoded with base64 or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/tsf_application_public_config#encode_with_base64 TsfApplicationPublicConfig#encode_with_base64}
  */
  readonly encodeWithBase64?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/tsf_application_public_config#id TsfApplicationPublicConfig#id}
  *
  ...
  * datasource for auth.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/tsf_application_public_config#program_id_list TsfApplicationPublicConfig#program_id_list}
  */
  readonly programIdList?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/tsf_application_public_config tencentcloud_tsf_application_public_config}
*/
export class TsfApplicationPublicConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TsfApplicationPublicConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/tsf_application_public_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/tsf_application_public_config tencentcloud_tsf_application_public_config} Resource
  *
  * @param scope The scope in which to define this construct
