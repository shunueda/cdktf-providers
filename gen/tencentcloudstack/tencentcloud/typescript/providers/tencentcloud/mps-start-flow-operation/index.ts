// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mps_start_flow_operation
...
export interface MpsStartFlowOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Flow Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mps_start_flow_operation#flow_id MpsStartFlowOperation#flow_id}
  */
  readonly flowId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mps_start_flow_operation#id MpsStartFlowOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mps_start_flow_operation#start MpsStartFlowOperation#start}
  */
  readonly start: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mps_start_flow_operation tencentcloud_mps_start_flow_operation}
*/
export class MpsStartFlowOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MpsStartFlowOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mps_start_flow_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/mps_start_flow_operation tencentcloud_mps_start_flow_operation} Resource
  *
  * @param scope The scope in which to define this construct
