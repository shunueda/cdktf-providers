// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mariadb_backup_time
...
export interface MariadbBackupTimeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mariadb_backup_time#end_backup_time MariadbBackupTime#end_backup_time}
  */
  readonly endBackupTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mariadb_backup_time#id MariadbBackupTime#id}
  *
  ...
  * instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mariadb_backup_time#instance_id MariadbBackupTime#instance_id}
  */
  readonly instanceId: string;
  /**
  * Start time of daily backup window in the format of `mm:ss`, such as 22:00.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mariadb_backup_time#start_backup_time MariadbBackupTime#start_backup_time}
  */
  readonly startBackupTime: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mariadb_backup_time tencentcloud_mariadb_backup_time}
*/
export class MariadbBackupTime extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MariadbBackupTime that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mariadb_backup_time#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/mariadb_backup_time tencentcloud_mariadb_backup_time} Resource
  *
  * @param scope The scope in which to define this construct
