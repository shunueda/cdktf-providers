// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/sms_template
...
export interface SmsTemplateConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/sms_template#id SmsTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/sms_template#international SmsTemplate#international}
  */
  readonly international: number;
  /**
  * Template remarks, such as reason for application and use case.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/sms_template#remark SmsTemplate#remark}
  */
  readonly remark: string;
  /**
  * SMS type. 0: regular SMS, 1: marketing SMS.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/sms_template#sms_type SmsTemplate#sms_type}
  */
  readonly smsType: number;
  /**
  * Message Template Content.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/sms_template#template_content SmsTemplate#template_content}
  */
  readonly templateContent: string;
  /**
  * Message Template name, which must be unique.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/sms_template#template_name SmsTemplate#template_name}
  */
  readonly templateName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/sms_template tencentcloud_sms_template}
*/
export class SmsTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SmsTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/sms_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/sms_template tencentcloud_sms_template} Resource
  *
  * @param scope The scope in which to define this construct
