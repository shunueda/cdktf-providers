// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_submit_task_operation
...
export interface WedataSubmitTaskOperationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_submit_task_operation#id WedataSubmitTaskOperation#id}
  *
  ...
  * Project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_submit_task_operation#project_id WedataSubmitTaskOperation#project_id}
  */
  readonly projectId: string;
  /**
  * Task ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_submit_task_operation#task_id WedataSubmitTaskOperation#task_id}
  */
  readonly taskId: string;
  /**
  * Version remarks.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_submit_task_operation#version_remark WedataSubmitTaskOperation#version_remark}
  */
  readonly versionRemark: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_submit_task_operation tencentcloud_wedata_submit_task_operation}
*/
export class WedataSubmitTaskOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WedataSubmitTaskOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_submit_task_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_submit_task_operation tencentcloud_wedata_submit_task_operation} Resource
  *
  * @param scope The scope in which to define this construct
