// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dlc_upgrade_data_engine_image_operation
...
export interface DlcUpgradeDataEngineImageOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Engine ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dlc_upgrade_data_engine_image_operation#data_engine_id DlcUpgradeDataEngineImageOperation#data_engine_id}
  */
  readonly dataEngineId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dlc_upgrade_data_engine_image_operation#id DlcUpgradeDataEngineImageOperation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dlc_upgrade_data_engine_image_operation tencentcloud_dlc_upgrade_data_engine_image_operation}
*/
export class DlcUpgradeDataEngineImageOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DlcUpgradeDataEngineImageOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dlc_upgrade_data_engine_image_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dlc_upgrade_data_engine_image_operation tencentcloud_dlc_upgrade_data_engine_image_operation} Resource
  *
  * @param scope The scope in which to define this construct
