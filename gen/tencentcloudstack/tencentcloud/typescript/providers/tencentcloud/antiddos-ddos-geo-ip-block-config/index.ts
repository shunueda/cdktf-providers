// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/antiddos_ddos_geo_ip_block_config
...
export interface AntiddosDdosGeoIpBlockConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/antiddos_ddos_geo_ip_block_config#id AntiddosDdosGeoIpBlockConfig#id}
  *
  ...
  * InstanceId.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/antiddos_ddos_geo_ip_block_config#instance_id AntiddosDdosGeoIpBlockConfig#instance_id}
  */
  readonly instanceId: string;
  /**
  * ddos_geo_ip_block_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/antiddos_ddos_geo_ip_block_config#ddos_geo_ip_block_config AntiddosDdosGeoIpBlockConfig#ddos_geo_ip_block_config}
  */
...
export interface AntiddosDdosGeoIpBlockConfigDdosGeoIpBlockConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/antiddos_ddos_geo_ip_block_config#action AntiddosDdosGeoIpBlockConfig#action}
  */
  readonly action: string;
  /**
  * When RegionType is customized, an AreaList must be filled in, with a maximum of 128 entries;.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/antiddos_ddos_geo_ip_block_config#area_list AntiddosDdosGeoIpBlockConfig#area_list}
  */
  readonly areaList?: number[];
  /**
  * Region type, value [oversea (overseas) China (domestic) customized (custom region)].
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/antiddos_ddos_geo_ip_block_config#region_type AntiddosDdosGeoIpBlockConfig#region_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/antiddos_ddos_geo_ip_block_config tencentcloud_antiddos_ddos_geo_ip_block_config}
*/
export class AntiddosDdosGeoIpBlockConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AntiddosDdosGeoIpBlockConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/antiddos_ddos_geo_ip_block_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/antiddos_ddos_geo_ip_block_config tencentcloud_antiddos_ddos_geo_ip_block_config} Resource
  *
  * @param scope The scope in which to define this construct
