// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/data-sources/ssm_rotation_detail
...
export interface DataTencentcloudSsmRotationDetailConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/data-sources/ssm_rotation_detail#id DataTencentcloudSsmRotationDetail#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/data-sources/ssm_rotation_detail#result_output_file DataTencentcloudSsmRotationDetail#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Secret name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/data-sources/ssm_rotation_detail#secret_name DataTencentcloudSsmRotationDetail#secret_name}
  */
  readonly secretName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/data-sources/ssm_rotation_detail tencentcloud_ssm_rotation_detail}
*/
export class DataTencentcloudSsmRotationDetail extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudSsmRotationDetail that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/data-sources/ssm_rotation_detail#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/data-sources/ssm_rotation_detail tencentcloud_ssm_rotation_detail} Data Source
  *
  * @param scope The scope in which to define this construct
