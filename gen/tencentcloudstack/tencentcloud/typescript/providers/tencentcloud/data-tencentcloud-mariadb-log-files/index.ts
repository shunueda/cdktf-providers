// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mariadb_log_files
...
export interface DataTencentcloudMariadbLogFilesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mariadb_log_files#id DataTencentcloudMariadbLogFiles#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mariadb_log_files#instance_id DataTencentcloudMariadbLogFiles#instance_id}
  */
  readonly instanceId: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mariadb_log_files#result_output_file DataTencentcloudMariadbLogFiles#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Requested log type. Valid values: 1 (binlog), 2 (cold backup), 3 (errlog), 4 (slowlog).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mariadb_log_files#type DataTencentcloudMariadbLogFiles#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mariadb_log_files tencentcloud_mariadb_log_files}
*/
export class DataTencentcloudMariadbLogFiles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudMariadbLogFiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mariadb_log_files#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/data-sources/mariadb_log_files tencentcloud_mariadb_log_files} Data Source
  *
  * @param scope The scope in which to define this construct
