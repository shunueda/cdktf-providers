// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/sqlserver_config_instance_security_groups
...
export interface SqlserverConfigInstanceSecurityGroupsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/sqlserver_config_instance_security_groups#id SqlserverConfigInstanceSecurityGroups#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/sqlserver_config_instance_security_groups#instance_id SqlserverConfigInstanceSecurityGroups#instance_id}
  */
  readonly instanceId: string;
  /**
  * A list of security group IDs to modify, an array of one or more security group IDs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/sqlserver_config_instance_security_groups#security_group_id_set SqlserverConfigInstanceSecurityGroups#security_group_id_set}
  */
  readonly securityGroupIdSet: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/sqlserver_config_instance_security_groups tencentcloud_sqlserver_config_instance_security_groups}
*/
export class SqlserverConfigInstanceSecurityGroups extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlserverConfigInstanceSecurityGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/sqlserver_config_instance_security_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/sqlserver_config_instance_security_groups tencentcloud_sqlserver_config_instance_security_groups} Resource
  *
  * @param scope The scope in which to define this construct
