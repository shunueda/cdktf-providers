// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/bh_access_white_list_config
...
export interface BhAccessWhiteListConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/bh_access_white_list_config#allow_any BhAccessWhiteListConfig#allow_any}
  */
  readonly allowAny?: boolean | cdktf.IResolvable;
  /**
  * true: allow automatically added IPs; false: do not allow automatically added IPs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/bh_access_white_list_config#allow_auto BhAccessWhiteListConfig#allow_auto}
  */
  readonly allowAuto?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/bh_access_white_list_config#id BhAccessWhiteListConfig#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/bh_access_white_list_config tencentcloud_bh_access_white_list_config}
*/
export class BhAccessWhiteListConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BhAccessWhiteListConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/bh_access_white_list_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/bh_access_white_list_config tencentcloud_bh_access_white_list_config} Resource
  *
  * @param scope The scope in which to define this construct
