// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy
...
export interface DayuCcHttpsPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy#action DayuCcHttpsPolicy#action}
  */
  readonly action?: string;
  /**
  * Domain that the CC self-define https policy works for, only valid when `protocol` is `https`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy#domain DayuCcHttpsPolicy#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy#id DayuCcHttpsPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy#name DayuCcHttpsPolicy#name}
  */
  readonly name: string;
  /**
  * ID of the resource that the CC self-define https policy works for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy#resource_id DayuCcHttpsPolicy#resource_id}
  */
  readonly resourceId: string;
  /**
  * Type of the resource that the CC self-define https policy works for, valid value is `bgpip`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy#resource_type DayuCcHttpsPolicy#resource_type}
  */
  readonly resourceType: string;
  /**
  * Rule id of the domain that the CC self-define https policy works for, only valid when `protocol` is `https`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy#rule_id DayuCcHttpsPolicy#rule_id}
  */
  readonly ruleId: string;
  /**
  * Indicate the CC self-define https policy takes effect or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy#switch DayuCcHttpsPolicy#switch}
  */
  readonly switch?: boolean | cdktf.IResolvable;
  /**
  * rule_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy#rule_list DayuCcHttpsPolicy#rule_list}
  */
...
export interface DayuCcHttpsPolicyRuleListStruct {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy#operator DayuCcHttpsPolicy#operator}
  */
  readonly operator: string;
  /**
  * Key of the rule. Valid values are `cgi`, `ua` and `referer`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy#skey DayuCcHttpsPolicy#skey}
  */
  readonly skey: string;
  /**
  * Rule value, then length should be less than 31 bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy#value DayuCcHttpsPolicy#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy tencentcloud_dayu_cc_https_policy}
*/
export class DayuCcHttpsPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DayuCcHttpsPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/dayu_cc_https_policy tencentcloud_dayu_cc_https_policy} Resource
  *
  * @param scope The scope in which to define this construct
