// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/cbs_disk_backup_rollback_operation
...
export interface CbsDiskBackupRollbackOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/cbs_disk_backup_rollback_operation#disk_backup_id CbsDiskBackupRollbackOperation#disk_backup_id}
  */
  readonly diskBackupId: string;
  /**
  * Cloud disk backup point original cloud disk ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/cbs_disk_backup_rollback_operation#disk_id CbsDiskBackupRollbackOperation#disk_id}
  */
  readonly diskId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/cbs_disk_backup_rollback_operation#id CbsDiskBackupRollbackOperation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/cbs_disk_backup_rollback_operation tencentcloud_cbs_disk_backup_rollback_operation}
*/
export class CbsDiskBackupRollbackOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CbsDiskBackupRollbackOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/cbs_disk_backup_rollback_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/cbs_disk_backup_rollback_operation tencentcloud_cbs_disk_backup_rollback_operation} Resource
  *
  * @param scope The scope in which to define this construct
