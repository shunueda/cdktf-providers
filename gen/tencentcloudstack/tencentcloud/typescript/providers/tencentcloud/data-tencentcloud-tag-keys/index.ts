// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/tag_keys
...
export interface DataTencentcloudTagKeysConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/tag_keys#category DataTencentcloudTagKeys#category}
  */
  readonly category?: string;
  /**
  * Creator `Uin`. If not specified, `Uin` is only used as the query condition.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/tag_keys#create_uin DataTencentcloudTagKeys#create_uin}
  */
  readonly createUin?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/tag_keys#id DataTencentcloudTagKeys#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/tag_keys#result_output_file DataTencentcloudTagKeys#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Whether to show project. Allow values: 0: no, 1: yes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/tag_keys#show_project DataTencentcloudTagKeys#show_project}
  */
  readonly showProject?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/tag_keys tencentcloud_tag_keys}
*/
export class DataTencentcloudTagKeys extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudTagKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/tag_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/tag_keys tencentcloud_tag_keys} Data Source
  *
  * @param scope The scope in which to define this construct
