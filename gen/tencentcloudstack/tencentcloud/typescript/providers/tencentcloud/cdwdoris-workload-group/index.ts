// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cdwdoris_workload_group
...
export interface CdwdorisWorkloadGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cdwdoris_workload_group#id CdwdorisWorkloadGroup#id}
  *
  ...
  * Instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cdwdoris_workload_group#instance_id CdwdorisWorkloadGroup#instance_id}
  */
  readonly instanceId: string;
  /**
  * workload_group block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cdwdoris_workload_group#workload_group CdwdorisWorkloadGroup#workload_group}
  */
...
export interface CdwdorisWorkloadGroupWorkloadGroup {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cdwdoris_workload_group#cpu_hard_limit CdwdorisWorkloadGroup#cpu_hard_limit}
  */
  readonly cpuHardLimit?: string;
  /**
  * CPU weight. Note: This field may return null, indicating that no valid value can be obtained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cdwdoris_workload_group#cpu_share CdwdorisWorkloadGroup#cpu_share}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cdwdoris_workload_group#enable_memory_over_commit CdwdorisWorkloadGroup#enable_memory_over_commit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cdwdoris_workload_group#memory_limit CdwdorisWorkloadGroup#memory_limit}
  */
  readonly memoryLimit?: number;
  /**
  * Workload group name. Note: This field may return null, indicating that no valid value can be obtained.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cdwdoris_workload_group#workload_group_name CdwdorisWorkloadGroup#workload_group_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cdwdoris_workload_group tencentcloud_cdwdoris_workload_group}
*/
export class CdwdorisWorkloadGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdwdorisWorkloadGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cdwdoris_workload_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/cdwdoris_workload_group tencentcloud_cdwdoris_workload_group} Resource
  *
  * @param scope The scope in which to define this construct
