// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cynosdb_cluster_password_complexity
...
export interface CynosdbClusterPasswordComplexityConfig extends cdktf.TerraformMetaArguments {
  ...
  * Cluster ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cynosdb_cluster_password_complexity#cluster_id CynosdbClusterPasswordComplexity#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cynosdb_cluster_password_complexity#id CynosdbClusterPasswordComplexity#id}
  *
  ...
  * Data dictionary.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cynosdb_cluster_password_complexity#validate_password_dictionary CynosdbClusterPasswordComplexity#validate_password_dictionary}
  */
  readonly validatePasswordDictionary?: string[];
  /**
  * Password length.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cynosdb_cluster_password_complexity#validate_password_length CynosdbClusterPasswordComplexity#validate_password_length}
  */
  readonly validatePasswordLength: number;
  /**
  * Number of uppercase and lowercase characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cynosdb_cluster_password_complexity#validate_password_mixed_case_count CynosdbClusterPasswordComplexity#validate_password_mixed_case_count}
  */
  readonly validatePasswordMixedCaseCount: number;
  /**
  * Number of digits.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cynosdb_cluster_password_complexity#validate_password_number_count CynosdbClusterPasswordComplexity#validate_password_number_count}
  */
  readonly validatePasswordNumberCount: number;
  /**
  * Password strength (MEDIUM, STRONG).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cynosdb_cluster_password_complexity#validate_password_policy CynosdbClusterPasswordComplexity#validate_password_policy}
  */
  readonly validatePasswordPolicy: string;
  /**
  * Number of special characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cynosdb_cluster_password_complexity#validate_password_special_char_count CynosdbClusterPasswordComplexity#validate_password_special_char_count}
  */
  readonly validatePasswordSpecialCharCount: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cynosdb_cluster_password_complexity tencentcloud_cynosdb_cluster_password_complexity}
*/
export class CynosdbClusterPasswordComplexity extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CynosdbClusterPasswordComplexity that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cynosdb_cluster_password_complexity#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/cynosdb_cluster_password_complexity tencentcloud_cynosdb_cluster_password_complexity} Resource
  *
  * @param scope The scope in which to define this construct
