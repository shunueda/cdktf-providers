// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group
...
export interface SqlserverConfigInstanceRoGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group#auto_weight SqlserverConfigInstanceRoGroup#auto_weight}
  */
  readonly autoWeight?: number;
  /**
  * 0-do not rebalance the load, 1-rebalance the load, the default is 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group#balance_weight SqlserverConfigInstanceRoGroup#balance_weight}
  */
  readonly balanceWeight?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group#id SqlserverConfigInstanceRoGroup#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group#instance_id SqlserverConfigInstanceRoGroup#instance_id}
  */
  readonly instanceId: string;
  /**
  * Whether to enable timeout culling function. 0- Disable the culling function. 1- Enable the culling function.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group#is_offline_delay SqlserverConfigInstanceRoGroup#is_offline_delay}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group#min_read_only_in_group SqlserverConfigInstanceRoGroup#min_read_only_in_group}
  */
  readonly minReadOnlyInGroup?: number;
  /**
  * Read-only group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group#read_only_group_id SqlserverConfigInstanceRoGroup#read_only_group_id}
  */
  readonly readOnlyGroupId: string;
  /**
  * Read-only group name. If this parameter is not specified, it is not modified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group#read_only_group_name SqlserverConfigInstanceRoGroup#read_only_group_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group#read_only_max_delay_time SqlserverConfigInstanceRoGroup#read_only_max_delay_time}
  */
  readonly readOnlyMaxDelayTime?: number;
  /**
  * weight_pairs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group#weight_pairs SqlserverConfigInstanceRoGroup#weight_pairs}
  */
...
export interface SqlserverConfigInstanceRoGroupWeightPairs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group#read_only_instance_id SqlserverConfigInstanceRoGroup#read_only_instance_id}
  */
  readonly readOnlyInstanceId: string;
  /**
  * Read-only instance weight, the range is 0-100.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group#read_only_weight SqlserverConfigInstanceRoGroup#read_only_weight}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group tencentcloud_sqlserver_config_instance_ro_group}
*/
export class SqlserverConfigInstanceRoGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlserverConfigInstanceRoGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/sqlserver_config_instance_ro_group tencentcloud_sqlserver_config_instance_ro_group} Resource
  *
  * @param scope The scope in which to define this construct
