// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/kubernetes_log_config
...
export interface KubernetesLogConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  * Cluster ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/kubernetes_log_config#cluster_id KubernetesLogConfig#cluster_id}
  */
  readonly clusterId: string;
  /**
  * The current cluster type supports tke and eks, default is tke.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/kubernetes_log_config#cluster_type KubernetesLogConfig#cluster_type}
  */
  readonly clusterType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/kubernetes_log_config#id KubernetesLogConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/kubernetes_log_config#log_config KubernetesLogConfig#log_config}
  */
  readonly logConfig: string;
  /**
  * Log config name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/kubernetes_log_config#log_config_name KubernetesLogConfig#log_config_name}
  */
  readonly logConfigName: string;
  /**
  * CLS log set ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/kubernetes_log_config#logset_id KubernetesLogConfig#logset_id}
  */
  readonly logsetId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/kubernetes_log_config tencentcloud_kubernetes_log_config}
*/
export class KubernetesLogConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesLogConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/kubernetes_log_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/kubernetes_log_config tencentcloud_kubernetes_log_config} Resource
  *
  * @param scope The scope in which to define this construct
