// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async
...
export interface WedataTaskRerunInstanceAsyncConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async#check_parent_type WedataTaskRerunInstanceAsync#check_parent_type}
  */
  readonly checkParentType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async#id WedataTaskRerunInstanceAsync#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async#instance_key_list WedataTaskRerunInstanceAsync#instance_key_list}
  */
  readonly instanceKeyList: string[];
  /**
  * Project Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async#project_id WedataTaskRerunInstanceAsync#project_id}
  */
  readonly projectId: string;
  /**
  * Customize the instance running concurrency. If not configured, the original self-dependency of the task will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async#redefine_parallel_num WedataTaskRerunInstanceAsync#redefine_parallel_num}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async#redefine_self_workflow_dependency WedataTaskRerunInstanceAsync#redefine_self_workflow_dependency}
  */
  readonly redefineSelfWorkflowDependency?: string;
  /**
  * Rerun type, 1: self; 3: children; 2: self and children, default 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async#rerun_type WedataTaskRerunInstanceAsync#rerun_type}
  */
  readonly rerunType?: string;
  /**
  * Whether to ignore event monitoring when rerunning.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async#skip_event_listening WedataTaskRerunInstanceAsync#skip_event_listening}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async#son_range_type WedataTaskRerunInstanceAsync#son_range_type}
  */
  readonly sonRangeType?: string;
  /**
  * redefine_param_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async#redefine_param_list WedataTaskRerunInstanceAsync#redefine_param_list}
  */
...
export interface WedataTaskRerunInstanceAsyncRedefineParamListStruct {
  ...
  * Key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async#k WedataTaskRerunInstanceAsync#k}
  */
  readonly k?: string;
  /**
  * Value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async#v WedataTaskRerunInstanceAsync#v}
  */
  readonly v?: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async tencentcloud_wedata_task_rerun_instance_async}
*/
export class WedataTaskRerunInstanceAsync extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WedataTaskRerunInstanceAsync that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/wedata_task_rerun_instance_async tencentcloud_wedata_task_rerun_instance_async} Resource
  *
  * @param scope The scope in which to define this construct
