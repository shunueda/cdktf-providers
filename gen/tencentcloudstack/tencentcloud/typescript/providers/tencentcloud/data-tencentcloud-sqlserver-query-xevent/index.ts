// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/sqlserver_query_xevent
...
export interface DataTencentcloudSqlserverQueryXeventConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/sqlserver_query_xevent#end_time DataTencentcloudSqlserverQueryXevent#end_time}
  */
  readonly endTime: string;
  /**
  * Event type. Valid values: slow (Slow SQL event), blocked (blocking event), deadlock` (deadlock event).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/sqlserver_query_xevent#event_type DataTencentcloudSqlserverQueryXevent#event_type}
  */
  readonly eventType: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/sqlserver_query_xevent#id DataTencentcloudSqlserverQueryXevent#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/sqlserver_query_xevent#instance_id DataTencentcloudSqlserverQueryXevent#instance_id}
  */
  readonly instanceId: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/sqlserver_query_xevent#result_output_file DataTencentcloudSqlserverQueryXevent#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Generation start time of an extended file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/sqlserver_query_xevent#start_time DataTencentcloudSqlserverQueryXevent#start_time}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/sqlserver_query_xevent tencentcloud_sqlserver_query_xevent}
*/
export class DataTencentcloudSqlserverQueryXevent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudSqlserverQueryXevent that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/sqlserver_query_xevent#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/data-sources/sqlserver_query_xevent tencentcloud_sqlserver_query_xevent} Data Source
  *
  * @param scope The scope in which to define this construct
