// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain
...
export interface WafClbDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#alb_type WafClbDomain#alb_type}
  */
  readonly albType?: string;
  /**
  * Whether to enable api safe, 1 enable, 0 disable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#api_safe_status WafClbDomain#api_safe_status}
  */
  readonly apiSafeStatus?: number;
  /**
  * Whether to enable bot, 1 enable, 0 disable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#bot_status WafClbDomain#bot_status}
  */
  readonly botStatus?: number;
  /**
  * Whether to enable access logs, 1 enable, 0 disable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#cls_status WafClbDomain#cls_status}
  */
  readonly clsStatus?: number;
  /**
  * Domain name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#domain WafClbDomain#domain}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#engine WafClbDomain#engine}
  */
  readonly engine?: number;
  /**
  * WAF traffic mode, 1 cleaning mode, 0 mirroring mode.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#flow_mode WafClbDomain#flow_mode}
  */
  readonly flowMode?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#id WafClbDomain#id}
  *
  ...
  * Instance unique ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#instance_id WafClbDomain#instance_id}
  */
  readonly instanceId: string;
  /**
  * When is_cdn=3, this parameter needs to be filled in to indicate a custom header.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#ip_headers WafClbDomain#ip_headers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#is_cdn WafClbDomain#is_cdn}
  */
  readonly isCdn?: number;
  /**
  * Regions of LB bound by domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#region WafClbDomain#region}
  */
  readonly region: string;
  /**
  * Binding status between waf and LB, 0:not bind, 1:binding.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#status WafClbDomain#status}
  */
  readonly status?: number;
  /**
  * load_balancer_set block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#load_balancer_set WafClbDomain#load_balancer_set}
  */
...
export interface WafClbDomainLoadBalancerSet {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#listener_id WafClbDomain#listener_id}
  */
  readonly listenerId: string;
  /**
  * Listener name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#listener_name WafClbDomain#listener_name}
  */
  readonly listenerName: string;
  /**
  * LoadBalancer unique ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#load_balancer_id WafClbDomain#load_balancer_id}
  */
  readonly loadBalancerId: string;
  /**
  * LoadBalancer name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#load_balancer_name WafClbDomain#load_balancer_name}
  */
  readonly loadBalancerName: string;
  /**
  * Network type for load balancer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#load_balancer_type WafClbDomain#load_balancer_type}
  */
  readonly loadBalancerType?: string;
  /**
  * VPCID for load balancer, public network is -1, and internal network is filled in according to actual conditions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#numerical_vpc_id WafClbDomain#numerical_vpc_id}
  */
  readonly numericalVpcId?: number;
  /**
  * Protocol of listener, http or https.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#protocol WafClbDomain#protocol}
  */
  ...
  * LoadBalancer IP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#vip WafClbDomain#vip}
  */
  readonly vip: string;
  /**
  * LoadBalancer port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#vport WafClbDomain#vport}
  */
  readonly vport: number;
  /**
  * LoadBalancer zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#zone WafClbDomain#zone}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain tencentcloud_waf_clb_domain}
*/
export class WafClbDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafClbDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/waf_clb_domain tencentcloud_waf_clb_domain} Resource
  *
  * @param scope The scope in which to define this construct
