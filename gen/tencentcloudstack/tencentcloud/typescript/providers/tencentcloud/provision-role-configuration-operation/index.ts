// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/provision_role_configuration_operation
...
export interface ProvisionRoleConfigurationOperationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/provision_role_configuration_operation#id ProvisionRoleConfigurationOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/provision_role_configuration_operation#role_configuration_id ProvisionRoleConfigurationOperation#role_configuration_id}
  */
  readonly roleConfigurationId: string;
  /**
  * Type of the synchronized target account of the Tencent Cloud Organization. ManagerUin: admin account; MemberUin: member account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/provision_role_configuration_operation#target_type ProvisionRoleConfigurationOperation#target_type}
  */
  readonly targetType: string;
  /**
  * UIN of the target account of the Tencent Cloud Organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/provision_role_configuration_operation#target_uin ProvisionRoleConfigurationOperation#target_uin}
  */
  readonly targetUin: number;
  /**
  * Space ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/provision_role_configuration_operation#zone_id ProvisionRoleConfigurationOperation#zone_id}
  */
  readonly zoneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/provision_role_configuration_operation tencentcloud_provision_role_configuration_operation}
*/
export class ProvisionRoleConfigurationOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProvisionRoleConfigurationOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/provision_role_configuration_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/provision_role_configuration_operation tencentcloud_provision_role_configuration_operation} Resource
  *
  * @param scope The scope in which to define this construct
