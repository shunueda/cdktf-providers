// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group
...
export interface PostgresqlReadonlyGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group#id PostgresqlReadonlyGroup#id}
  *
  ...
  * Primary instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group#master_db_instance_id PostgresqlReadonlyGroup#master_db_instance_id}
  */
  readonly masterDbInstanceId: string;
  /**
  * Delay threshold in ms.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group#max_replay_lag PostgresqlReadonlyGroup#max_replay_lag}
  */
  readonly maxReplayLag: number;
  /**
  * Delayed log size threshold in MB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group#max_replay_latency PostgresqlReadonlyGroup#max_replay_latency}
  */
  readonly maxReplayLatency: number;
  /**
  * The minimum number of read-only replicas that must be retained in an RO group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group#min_delay_eliminate_reserve PostgresqlReadonlyGroup#min_delay_eliminate_reserve}
  */
  readonly minDelayEliminateReserve: number;
  /**
  * RO group name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group#name PostgresqlReadonlyGroup#name}
  */
  readonly name: string;
  /**
  * Project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group#project_id PostgresqlReadonlyGroup#project_id}
  */
  readonly projectId: number;
  /**
  * Whether to remove a read-only replica from an RO group if the delay between the read-only replica and the primary instance exceeds the threshold. Valid values: 0 (no), 1 (yes).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group#replay_lag_eliminate PostgresqlReadonlyGroup#replay_lag_eliminate}
  */
  readonly replayLagEliminate: number;
  /**
  * Whether to remove a read-only replica from an RO group if the sync log size difference between the read-only replica and the primary instance exceeds the threshold. Valid values: 0 (no), 1 (yes).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group#replay_latency_eliminate PostgresqlReadonlyGroup#replay_latency_eliminate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group#security_groups_ids PostgresqlReadonlyGroup#security_groups_ids}
  */
  readonly securityGroupsIds?: string[];
  /**
  * VPC subnet ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group#subnet_id PostgresqlReadonlyGroup#subnet_id}
  */
  readonly subnetId: string;
  /**
  * VPC ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group#vpc_id PostgresqlReadonlyGroup#vpc_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group tencentcloud_postgresql_readonly_group}
*/
export class PostgresqlReadonlyGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PostgresqlReadonlyGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/postgresql_readonly_group tencentcloud_postgresql_readonly_group} Resource
  *
  * @param scope The scope in which to define this construct
