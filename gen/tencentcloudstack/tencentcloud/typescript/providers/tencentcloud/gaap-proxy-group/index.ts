// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/gaap_proxy_group
...
export interface GaapProxyGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Channel group alias.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/gaap_proxy_group#group_name GaapProxyGroup#group_name}
  */
  readonly groupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/gaap_proxy_group#id GaapProxyGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/gaap_proxy_group#ip_address_version GaapProxyGroup#ip_address_version}
  */
  readonly ipAddressVersion?: string;
  /**
  * Package type of channel group. Available values: Thunder and Accelerator. Default is Thunder.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/gaap_proxy_group#package_type GaapProxyGroup#package_type}
  */
  readonly packageType?: string;
  /**
  * ID of the project to which the proxy group belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/gaap_proxy_group#project_id GaapProxyGroup#project_id}
  */
  readonly projectId: number;
  /**
  * real server region, refer to the interface DescribeDestRegions to return the RegionId in the parameter RegionDetail.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/gaap_proxy_group#real_server_region GaapProxyGroup#real_server_region}
  */
  readonly realServerRegion: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/gaap_proxy_group tencentcloud_gaap_proxy_group}
*/
export class GaapProxyGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GaapProxyGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/gaap_proxy_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/gaap_proxy_group tencentcloud_gaap_proxy_group} Resource
  *
  * @param scope The scope in which to define this construct
