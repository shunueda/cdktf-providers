// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_tag_retention_rule
...
export interface TcrTagRetentionRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_tag_retention_rule#cron_setting TcrTagRetentionRule#cron_setting}
  */
  readonly cronSetting: string;
  /**
  * Whether to disable the rule, with the default value of false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_tag_retention_rule#disabled TcrTagRetentionRule#disabled}
  */
  readonly disabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_tag_retention_rule#id TcrTagRetentionRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_tag_retention_rule#namespace_name TcrTagRetentionRule#namespace_name}
  */
  readonly namespaceName: string;
  /**
  * The main instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_tag_retention_rule#registry_id TcrTagRetentionRule#registry_id}
  */
  readonly registryId: string;
  /**
  * retention_rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_tag_retention_rule#retention_rule TcrTagRetentionRule#retention_rule}
  */
...
export interface TcrTagRetentionRuleRetentionRule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_tag_retention_rule#key TcrTagRetentionRule#key}
  */
  readonly key: string;
  /**
  * corresponding values for rule settings.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_tag_retention_rule#value TcrTagRetentionRule#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_tag_retention_rule tencentcloud_tcr_tag_retention_rule}
*/
export class TcrTagRetentionRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TcrTagRetentionRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_tag_retention_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/tcr_tag_retention_rule tencentcloud_tcr_tag_retention_rule} Resource
  *
  * @param scope The scope in which to define this construct
