// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/bi_embed_token_apply
...
export interface BiEmbedTokenApplyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/bi_embed_token_apply#expire_time BiEmbedTokenApply#expire_time}
  */
  readonly expireTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/bi_embed_token_apply#id BiEmbedTokenApply#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/bi_embed_token_apply#page_id BiEmbedTokenApply#page_id}
  */
  readonly pageId?: number;
  /**
  * Share project id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/bi_embed_token_apply#project_id BiEmbedTokenApply#project_id}
  */
  readonly projectId?: number;
  /**
  * Page means embedding the page, and panel means embedding the entire board.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/bi_embed_token_apply#scope BiEmbedTokenApply#scope}
  */
  readonly scope?: string;
  /**
  * Access limit, the limit range is 1-99999, if it is empty, no access limit will be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/bi_embed_token_apply#ticket_num BiEmbedTokenApply#ticket_num}
  */
  readonly ticketNum?: number;
  /**
  * User enterprise ID (for multi-user only).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/bi_embed_token_apply#user_corp_id BiEmbedTokenApply#user_corp_id}
  */
  readonly userCorpId?: string;
  /**
  * UserId (for multi-user only).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/bi_embed_token_apply#user_id BiEmbedTokenApply#user_id}
  */
  readonly userId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/bi_embed_token_apply tencentcloud_bi_embed_token_apply}
*/
export class BiEmbedTokenApply extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BiEmbedTokenApply that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/bi_embed_token_apply#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/bi_embed_token_apply tencentcloud_bi_embed_token_apply} Resource
  *
  * @param scope The scope in which to define this construct
