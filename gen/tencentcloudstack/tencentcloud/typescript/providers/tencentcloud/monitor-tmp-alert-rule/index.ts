// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule
...
export interface MonitorTmpAlertRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  * Rule alarm duration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule#duration MonitorTmpAlertRule#duration}
  */
  readonly duration?: string;
  /**
  * Rule expression, reference documentation: `https://prometheus.io/docs/prometheus/latest/configuration/alerting_rules/`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule#expr MonitorTmpAlertRule#expr}
  */
  readonly expr: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule#id MonitorTmpAlertRule#id}
  *
  ...
  * Instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule#instance_id MonitorTmpAlertRule#instance_id}
  */
  readonly instanceId: string;
  /**
  * Alarm notification template id list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule#receivers MonitorTmpAlertRule#receivers}
  */
  readonly receivers: string[];
  /**
  * Rule name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule#rule_name MonitorTmpAlertRule#rule_name}
  */
  readonly ruleName: string;
  /**
  * Rule state code.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule#rule_state MonitorTmpAlertRule#rule_state}
  */
  readonly ruleState?: number;
  /**
  * Alarm Policy Template Classification.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule#type MonitorTmpAlertRule#type}
  */
  readonly type?: string;
  /**
  * annotations block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule#annotations MonitorTmpAlertRule#annotations}
  */
  readonly annotations?: MonitorTmpAlertRuleAnnotations[] | cdktf.IResolvable;
  /**
  * labels block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule#labels MonitorTmpAlertRule#labels}
  */
...
export interface MonitorTmpAlertRuleAnnotations {
  ...
  * key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule#key MonitorTmpAlertRule#key}
  */
  readonly key: string;
  /**
  * value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule#value MonitorTmpAlertRule#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule tencentcloud_monitor_tmp_alert_rule}
*/
export class MonitorTmpAlertRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorTmpAlertRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/monitor_tmp_alert_rule tencentcloud_monitor_tmp_alert_rule} Resource
  *
  * @param scope The scope in which to define this construct
