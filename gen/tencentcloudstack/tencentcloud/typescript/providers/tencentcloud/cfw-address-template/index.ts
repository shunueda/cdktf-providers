// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_address_template
...
export interface CfwAddressTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  * Template Detail.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_address_template#detail CfwAddressTemplate#detail}
  */
  readonly detail: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_address_template#id CfwAddressTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_address_template#ip_string CfwAddressTemplate#ip_string}
  */
  readonly ipString: string;
  /**
  * Template name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_address_template#name CfwAddressTemplate#name}
  */
  readonly name: string;
  /**
  * 1: ip template; 5: domain name templates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_address_template#type CfwAddressTemplate#type}
  */
  readonly type: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_address_template tencentcloud_cfw_address_template}
*/
export class CfwAddressTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CfwAddressTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_address_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cfw_address_template tencentcloud_cfw_address_template} Resource
  *
  * @param scope The scope in which to define this construct
