// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate
...
export interface SslFreeCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate#alias SslFreeCertificate#alias}
  */
  readonly alias?: string;
  /**
  * Email address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate#contact_email SslFreeCertificate#contact_email}
  */
  readonly contactEmail?: string;
  /**
  * Phone number.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate#contact_phone SslFreeCertificate#contact_phone}
  */
  readonly contactPhone?: string;
  /**
  * Specify CSR encrypt algorithm, only support `RSA` for now.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate#csr_encrypt_algo SslFreeCertificate#csr_encrypt_algo}
  */
  readonly csrEncryptAlgo?: string;
  /**
  * Specify CSR key parameter, only support `"2048"` for now.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate#csr_key_parameter SslFreeCertificate#csr_key_parameter}
  */
  readonly csrKeyParameter?: string;
  /**
  * Specify CSR key password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate#csr_key_password SslFreeCertificate#csr_key_password}
  */
  readonly csrKeyPassword?: string;
  /**
  * Specify domain name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate#domain SslFreeCertificate#domain}
  */
  readonly domain: string;
  /**
  * Specify DV authorize method. Available values: `DNS_AUTO` - automatic DNS auth, `DNS` - manual DNS auth, `FILE` - auth by file.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate#dv_auth_method SslFreeCertificate#dv_auth_method}
  */
  readonly dvAuthMethod: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate#id SslFreeCertificate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate#old_certificate_id SslFreeCertificate#old_certificate_id}
  */
  readonly oldCertificateId?: string;
  /**
  * Type of package. Only support `"83"` (TrustAsia TLS RSA CA).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate#package_type SslFreeCertificate#package_type}
  */
  readonly packageType?: string;
  /**
  * ID of projects which this certification belong to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate#project_id SslFreeCertificate#project_id}
  */
  readonly projectId?: number;
  /**
  * Specify validity period in month, only support `"3"` months for now.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate#validity_period SslFreeCertificate#validity_period}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate tencentcloud_ssl_free_certificate}
*/
export class SslFreeCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslFreeCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/ssl_free_certificate tencentcloud_ssl_free_certificate} Resource
  *
  * @param scope The scope in which to define this construct
