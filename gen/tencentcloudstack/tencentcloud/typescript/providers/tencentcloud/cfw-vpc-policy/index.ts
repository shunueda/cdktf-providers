// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy
...
export interface CfwVpcPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  * Describe.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy#description CfwVpcPolicy#description}
  */
  readonly description: string;
  /**
  * Access purpose example: net:IP/CIDR(192.168.0.2) domain:domain rule, for example*.qq.com.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy#dest_content CfwVpcPolicy#dest_content}
  */
  readonly destContent: string;
  /**
  * Access purpose type, the type can be: net, template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy#dest_type CfwVpcPolicy#dest_type}
  */
  readonly destType: string;
  /**
  * Rule status, true means enabled, false means disabled. Default is true.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy#enable CfwVpcPolicy#enable}
  */
  readonly enable?: string;
  /**
  * Firewall instance ID where the rule takes effect. Default is ALL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy#fw_group_id CfwVpcPolicy#fw_group_id}
  */
  readonly fwGroupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy#id CfwVpcPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy#port CfwVpcPolicy#port}
  */
  readonly port: string;
  /**
  * Protocol, optional value:TCP, UDP, ICMP, ANY, HTTP, HTTPS, HTTP/HTTPS, SMTP, SMTPS, SMTP/SMTPS, FTP, DNS, TLS/SSL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy#protocol CfwVpcPolicy#protocol}
  */
  readonly protocol: string;
  /**
  * How traffic set in the access control policy passes through the cloud firewall. Value: accept:accept, drop:drop, log:log.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy#rule_action CfwVpcPolicy#rule_action}
  */
  readonly ruleAction: string;
  /**
  * Access source examplnet:IP/CIDR(192.168.0.2).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy#source_content CfwVpcPolicy#source_content}
  */
  readonly sourceContent: string;
  /**
  * Access source type, the type can be: net, template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy#source_type CfwVpcPolicy#source_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy tencentcloud_cfw_vpc_policy}
*/
export class CfwVpcPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CfwVpcPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cfw_vpc_policy tencentcloud_cfw_vpc_policy} Resource
  *
  * @param scope The scope in which to define this construct
