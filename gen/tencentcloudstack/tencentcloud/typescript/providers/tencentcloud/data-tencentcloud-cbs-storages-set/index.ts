// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set
...
export interface DataTencentcloudCbsStoragesSetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#availability_zone DataTencentcloudCbsStoragesSet#availability_zone}
  */
  readonly availabilityZone?: string;
  /**
  * List filter by disk charge type (`POSTPAID_BY_HOUR` | `PREPAID` | `CDCPAID` | `DEDICATED_CLUSTER_PAID`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#charge_type DataTencentcloudCbsStoragesSet#charge_type}
  */
  readonly chargeType?: string[];
  /**
  * Exclusive cluster id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#dedicated_cluster_id DataTencentcloudCbsStoragesSet#dedicated_cluster_id}
  */
  readonly dedicatedClusterId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#id DataTencentcloudCbsStoragesSet#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#instance_ips DataTencentcloudCbsStoragesSet#instance_ips}
  */
  readonly instanceIps?: string[];
  /**
  * List filter by attached instance name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#instance_name DataTencentcloudCbsStoragesSet#instance_name}
  */
  readonly instanceName?: string[];
  /**
  * Filter by whether the disk is portable (Boolean `true` or `false`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#portable DataTencentcloudCbsStoragesSet#portable}
  */
  readonly portable?: boolean | cdktf.IResolvable;
  /**
  * ID of the project with which the CBS is associated.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#project_id DataTencentcloudCbsStoragesSet#project_id}
  */
  readonly projectId?: number;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#result_output_file DataTencentcloudCbsStoragesSet#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * ID of the CBS to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#storage_id DataTencentcloudCbsStoragesSet#storage_id}
  */
  readonly storageId?: string;
  /**
  * Name of the CBS to be queried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#storage_name DataTencentcloudCbsStoragesSet#storage_name}
  */
  readonly storageName?: string;
  /**
  * List filter by disk state (`UNATTACHED` | `ATTACHING` | `ATTACHED` | `DETACHING` | `EXPANDING` | `ROLLBACKING` | `TORECYCLE`).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#storage_state DataTencentcloudCbsStoragesSet#storage_state}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#storage_type DataTencentcloudCbsStoragesSet#storage_type}
  */
  readonly storageType?: string;
  /**
  * Filter by cloud disk type (`SYSTEM_DISK`: system disk | `DATA_DISK`: data disk).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#storage_usage DataTencentcloudCbsStoragesSet#storage_usage}
  */
  readonly storageUsage?: string;
  /**
  * List filter by tag keys.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#tag_keys DataTencentcloudCbsStoragesSet#tag_keys}
  */
  readonly tagKeys?: string[];
  /**
  * List filter by tag values.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#tag_values DataTencentcloudCbsStoragesSet#tag_values}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set tencentcloud_cbs_storages_set}
*/
export class DataTencentcloudCbsStoragesSet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudCbsStoragesSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/cbs_storages_set tencentcloud_cbs_storages_set} Data Source
  *
  * @param scope The scope in which to define this construct
