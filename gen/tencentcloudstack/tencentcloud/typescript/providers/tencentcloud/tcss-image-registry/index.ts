// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry
...
export interface TcssImageRegistryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#id TcssImageRegistry#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#insecure TcssImageRegistry#insecure}
  */
  readonly insecure?: number;
  /**
  * Repository name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#name TcssImageRegistry#name}
  */
  readonly name: string;
  /**
  * Whether to scan the latest image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#need_scan TcssImageRegistry#need_scan}
  */
  readonly needScan?: boolean | cdktf.IResolvable;
  /**
  * Network type, which can be `public` (public network).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#net_type TcssImageRegistry#net_type}
  */
  readonly netType: string;
  /**
  * Password.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#password TcssImageRegistry#password}
  */
  readonly password: string;
  /**
  * Region. Default value: `default`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#registry_region TcssImageRegistry#registry_region}
  */
  readonly registryRegion?: string;
  /**
  * Repository type, which can be `harbor`. Valid values: harbor, quay, jfrog, aws, azure, other-tcr.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#registry_type TcssImageRegistry#registry_type}
  */
  readonly registryType: string;
  /**
  * Repository version.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#registry_version TcssImageRegistry#registry_version}
  */
  readonly registryVersion?: string;
  /**
  * Speed limit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#speed_limit TcssImageRegistry#speed_limit}
  */
  readonly speedLimit?: number;
  /**
  * Repository URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#url TcssImageRegistry#url}
  */
  readonly url: string;
  /**
  * Username.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#username TcssImageRegistry#username}
  */
  readonly username: string;
  /**
  * conn_detect_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#conn_detect_config TcssImageRegistry#conn_detect_config}
  */
...
export interface TcssImageRegistryConnDetectConfig {
  ...
  * Host Quuid.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#quuid TcssImageRegistry#quuid}
  */
  readonly quuid?: string;
  /**
  * Host uuid.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#uuid TcssImageRegistry#uuid}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry tencentcloud_tcss_image_registry}
*/
export class TcssImageRegistry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TcssImageRegistry that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/tcss_image_registry tencentcloud_tcss_image_registry} Resource
  *
  * @param scope The scope in which to define this construct
