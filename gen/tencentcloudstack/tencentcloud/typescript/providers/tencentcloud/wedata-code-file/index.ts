// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/wedata_code_file
...
export interface WedataCodeFileConfig extends cdktf.TerraformMetaArguments {
  ...
  * Code file content.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/wedata_code_file#code_file_content WedataCodeFile#code_file_content}
  */
  readonly codeFileContent?: string;
  /**
  * Code file name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/wedata_code_file#code_file_name WedataCodeFile#code_file_name}
  */
  readonly codeFileName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/wedata_code_file#id WedataCodeFile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/wedata_code_file#parent_folder_path WedataCodeFile#parent_folder_path}
  */
  readonly parentFolderPath: string;
  /**
  * Project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/wedata_code_file#project_id WedataCodeFile#project_id}
  */
  readonly projectId: string;
  /**
  * code_file_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/wedata_code_file#code_file_config WedataCodeFile#code_file_config}
  */
...
export interface WedataCodeFileCodeFileConfigNotebookSessionInfo {
  ...
  * Session ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/wedata_code_file#notebook_session_id WedataCodeFile#notebook_session_id}
  */
  readonly notebookSessionId?: string;
  /**
  * Session name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/wedata_code_file#notebook_session_name WedataCodeFile#notebook_session_name}
  */
...
export interface WedataCodeFileCodeFileConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/wedata_code_file#params WedataCodeFile#params}
  */
  readonly params?: string;
  /**
  * notebook_session_info block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/wedata_code_file#notebook_session_info WedataCodeFile#notebook_session_info}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/wedata_code_file tencentcloud_wedata_code_file}
*/
export class WedataCodeFile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WedataCodeFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/wedata_code_file#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/wedata_code_file tencentcloud_wedata_code_file} Resource
  *
  * @param scope The scope in which to define this construct
