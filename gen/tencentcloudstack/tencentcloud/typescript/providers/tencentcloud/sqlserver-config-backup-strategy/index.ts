// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy
...
export interface SqlserverConfigBackupStrategyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy#backup_cycle SqlserverConfigBackupStrategy#backup_cycle}
  */
  readonly backupCycle?: number[];
  /**
  * Backup interval in days when the BackupType is daily. The current value can only be 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy#backup_day SqlserverConfigBackupStrategy#backup_day}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy#backup_model SqlserverConfigBackupStrategy#backup_model}
  */
  readonly backupModel?: string;
  /**
  * Data (log) backup retention period. Value range: 3-1830 days, default value: 7 days.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy#backup_save_days SqlserverConfigBackupStrategy#backup_save_days}
  */
  readonly backupSaveDays?: number;
  /**
  * Backup time. Value range: an integer from 0 to 23.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy#backup_time SqlserverConfigBackupStrategy#backup_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy#backup_type SqlserverConfigBackupStrategy#backup_type}
  */
  readonly backupType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy#id SqlserverConfigBackupStrategy#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy#instance_id SqlserverConfigBackupStrategy#instance_id}
  */
  readonly instanceId: string;
  /**
  * The number of retained archive backups. Default value: 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy#regular_backup_counts SqlserverConfigBackupStrategy#regular_backup_counts}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy#regular_backup_enable SqlserverConfigBackupStrategy#regular_backup_enable}
  */
  readonly regularBackupEnable?: string;
  /**
  * Archive backup retention days. Value range: 90-3650 days. Default value: 365 days.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy#regular_backup_save_days SqlserverConfigBackupStrategy#regular_backup_save_days}
  */
  readonly regularBackupSaveDays?: number;
  /**
  * Archive backup start date in YYYY-MM-DD format, which is the current time by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy#regular_backup_start_time SqlserverConfigBackupStrategy#regular_backup_start_time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy#regular_backup_strategy SqlserverConfigBackupStrategy#regular_backup_strategy}
  */
  readonly regularBackupStrategy?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy tencentcloud_sqlserver_config_backup_strategy}
*/
export class SqlserverConfigBackupStrategy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlserverConfigBackupStrategy that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_config_backup_strategy tencentcloud_sqlserver_config_backup_strategy} Resource
  *
  * @param scope The scope in which to define this construct
