// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dbbrain_security_audit_log_export_task
...
export interface DbbrainSecurityAuditLogExportTaskConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dbbrain_security_audit_log_export_task#danger_levels DbbrainSecurityAuditLogExportTask#danger_levels}
  */
  readonly dangerLevels?: number[];
  /**
  * end time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dbbrain_security_audit_log_export_task#end_time DbbrainSecurityAuditLogExportTask#end_time}
  */
  readonly endTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dbbrain_security_audit_log_export_task#id DbbrainSecurityAuditLogExportTask#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dbbrain_security_audit_log_export_task#product DbbrainSecurityAuditLogExportTask#product}
  */
  readonly product: string;
  /**
  * security audit group id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dbbrain_security_audit_log_export_task#sec_audit_group_id DbbrainSecurityAuditLogExportTask#sec_audit_group_id}
  */
  readonly secAuditGroupId: string;
  /**
  * start time.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dbbrain_security_audit_log_export_task#start_time DbbrainSecurityAuditLogExportTask#start_time}
  */
  readonly startTime: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dbbrain_security_audit_log_export_task tencentcloud_dbbrain_security_audit_log_export_task}
*/
export class DbbrainSecurityAuditLogExportTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DbbrainSecurityAuditLogExportTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dbbrain_security_audit_log_export_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/dbbrain_security_audit_log_export_task tencentcloud_dbbrain_security_audit_log_export_task} Resource
  *
  * @param scope The scope in which to define this construct
