// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/scf_sync_invoke_function
...
export interface ScfSyncInvokeFunctionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/scf_sync_invoke_function#event ScfSyncInvokeFunction#event}
  */
  readonly event?: string;
  /**
  * Function name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/scf_sync_invoke_function#function_name ScfSyncInvokeFunction#function_name}
  */
  readonly functionName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/scf_sync_invoke_function#id ScfSyncInvokeFunction#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/scf_sync_invoke_function#log_type ScfSyncInvokeFunction#log_type}
  */
  readonly logType?: string;
  /**
  * Namespace. default is used if it's left empty.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/scf_sync_invoke_function#namespace ScfSyncInvokeFunction#namespace}
  */
  readonly namespace?: string;
  /**
  * Version or alias of the function. It defaults to $DEFAULT.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/scf_sync_invoke_function#qualifier ScfSyncInvokeFunction#qualifier}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/scf_sync_invoke_function#routing_key ScfSyncInvokeFunction#routing_key}
  */
  readonly routingKey?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/scf_sync_invoke_function tencentcloud_scf_sync_invoke_function}
*/
export class ScfSyncInvokeFunction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScfSyncInvokeFunction that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/scf_sync_invoke_function#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/scf_sync_invoke_function tencentcloud_scf_sync_invoke_function} Resource
  *
  * @param scope The scope in which to define this construct
