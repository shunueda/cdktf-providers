// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job
...
export interface OceanusRunJobConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job#id OceanusRunJob#id}
  *
  ...
  * Workspace SerialId.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job#work_space_id OceanusRunJob#work_space_id}
  */
  readonly workSpaceId?: string;
  /**
  * run_job_descriptions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job#run_job_descriptions OceanusRunJob#run_job_descriptions}
  */
...
export interface OceanusRunJobRunJobDescriptions {
  ...
  * Custom timestamp.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job#custom_timestamp OceanusRunJob#custom_timestamp}
  */
  readonly customTimestamp?: number;
  /**
  * A certain version of the current job(Not passed by default as a non-draft job version).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job#job_config_version OceanusRunJob#job_config_version}
  */
  readonly jobConfigVersion?: number;
  /**
  * Job ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job#job_id OceanusRunJob#job_id}
  */
  readonly jobId: string;
  /**
  * The type of the run. 1 indicates start, and 2 indicates resume.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job#run_type OceanusRunJob#run_type}
  */
  readonly runType: number;
  /**
  * Savepoint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job#savepoint_id OceanusRunJob#savepoint_id}
  */
  readonly savepointId?: string;
  /**
  * Savepoint path.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job#savepoint_path OceanusRunJob#savepoint_path}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job#start_mode OceanusRunJob#start_mode}
  */
  readonly startMode?: string;
  /**
  * Use the historical version of the system dependency.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job#use_old_system_connector OceanusRunJob#use_old_system_connector}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job tencentcloud_oceanus_run_job}
*/
export class OceanusRunJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OceanusRunJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/oceanus_run_job tencentcloud_oceanus_run_job} Resource
  *
  * @param scope The scope in which to define this construct
