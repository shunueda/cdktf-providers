// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_service_assign
...
export interface OrganizationServiceAssignConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_service_assign#id OrganizationServiceAssign#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_service_assign#management_scope OrganizationServiceAssign#management_scope}
  */
  readonly managementScope?: number;
  /**
  * ID list of the managed departments. This parameter is valid when `management_scope` is `2`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_service_assign#management_scope_node_ids OrganizationServiceAssign#management_scope_node_ids}
  */
  readonly managementScopeNodeIds?: number[];
  /**
  * Uin list of the managed members. This parameter is valid when `management_scope` is `2`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_service_assign#management_scope_uins OrganizationServiceAssign#management_scope_uins}
  */
  readonly managementScopeUins?: number[];
  /**
  * Uin list of the delegated admins, Including up to 20 items.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_service_assign#member_uins OrganizationServiceAssign#member_uins}
  */
  readonly memberUins: number[];
  /**
  * Organization service ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_service_assign#service_id OrganizationServiceAssign#service_id}
  */
  readonly serviceId: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_service_assign tencentcloud_organization_service_assign}
*/
export class OrganizationServiceAssign extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationServiceAssign that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_service_assign#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/organization_service_assign tencentcloud_organization_service_assign} Resource
  *
  * @param scope The scope in which to define this construct
