// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpn_ssl_server
...
export interface VpnSslServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpn_ssl_server#compress VpnSslServer#compress}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpn_ssl_server#encrypt_algorithm VpnSslServer#encrypt_algorithm}
  */
  readonly encryptAlgorithm?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpn_ssl_server#id VpnSslServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpn_ssl_server#integrity_algorithm VpnSslServer#integrity_algorithm}
  */
  readonly integrityAlgorithm?: string;
  /**
  * List of local CIDR.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpn_ssl_server#local_address VpnSslServer#local_address}
  */
  readonly localAddress: string[];
  /**
  * Remote CIDR for client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpn_ssl_server#remote_address VpnSslServer#remote_address}
  */
  readonly remoteAddress: string;
  /**
  * The port of ssl vpn. Currently only supports UDP. Default value: 1194.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpn_ssl_server#ssl_vpn_port VpnSslServer#ssl_vpn_port}
  */
  readonly sslVpnPort?: number;
  /**
  * The protocol of ssl vpn. Default value: UDP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpn_ssl_server#ssl_vpn_protocol VpnSslServer#ssl_vpn_protocol}
  */
  readonly sslVpnProtocol?: string;
  /**
  * The name of ssl vpn server to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpn_ssl_server#ssl_vpn_server_name VpnSslServer#ssl_vpn_server_name}
  */
  readonly sslVpnServerName: string;
  /**
  * VPN gateway ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpn_ssl_server#vpn_gateway_id VpnSslServer#vpn_gateway_id}
  */
  readonly vpnGatewayId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpn_ssl_server tencentcloud_vpn_ssl_server}
*/
export class VpnSslServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpnSslServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpn_ssl_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/resources/vpn_ssl_server tencentcloud_vpn_ssl_server} Resource
  *
  * @param scope The scope in which to define this construct
