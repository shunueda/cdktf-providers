// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/dlc_check_data_engine_image_can_be_upgrade
...
export interface DataTencentcloudDlcCheckDataEngineImageCanBeUpgradeConfig extends cdktf.TerraformMetaArguments {
  ...
  * Unique engine ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/dlc_check_data_engine_image_can_be_upgrade#data_engine_id DataTencentcloudDlcCheckDataEngineImageCanBeUpgrade#data_engine_id}
  */
  readonly dataEngineId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/dlc_check_data_engine_image_can_be_upgrade#id DataTencentcloudDlcCheckDataEngineImageCanBeUpgrade#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/dlc_check_data_engine_image_can_be_upgrade#result_output_file DataTencentcloudDlcCheckDataEngineImageCanBeUpgrade#result_output_file}
  */
  readonly resultOutputFile?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/dlc_check_data_engine_image_can_be_upgrade tencentcloud_dlc_check_data_engine_image_can_be_upgrade}
*/
export class DataTencentcloudDlcCheckDataEngineImageCanBeUpgrade extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudDlcCheckDataEngineImageCanBeUpgrade that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/dlc_check_data_engine_image_can_be_upgrade#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/dlc_check_data_engine_image_can_be_upgrade tencentcloud_dlc_check_data_engine_image_can_be_upgrade} Data Source
  *
  * @param scope The scope in which to define this construct
