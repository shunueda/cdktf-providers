// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/eb_put_events
...
export interface EbPutEventsConfig extends cdktf.TerraformMetaArguments {
  ...
  * event bus Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/eb_put_events#event_bus_id EbPutEvents#event_bus_id}
  */
  readonly eventBusId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/eb_put_events#id EbPutEvents#id}
  *
  ...
  * event_list block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/eb_put_events#event_list EbPutEvents#event_list}
  */
...
export interface EbPutEventsEventListStruct {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/eb_put_events#data EbPutEvents#data}
  */
  readonly data: string;
  /**
  * Event source information, new product reporting must comply with EB specifications.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/eb_put_events#source EbPutEvents#source}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/eb_put_events#subject EbPutEvents#subject}
  */
  readonly subject: string;
  /**
  * The timestamp in milliseconds when the event occurred,time.Now().UnixNano()/1e6.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/eb_put_events#time EbPutEvents#time}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/eb_put_events#type EbPutEvents#type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/eb_put_events tencentcloud_eb_put_events}
*/
export class EbPutEvents extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EbPutEvents that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/eb_put_events#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/eb_put_events tencentcloud_eb_put_events} Resource
  *
  * @param scope The scope in which to define this construct
