// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment
...
export interface ClbAttachmentConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the CLB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment#clb_id ClbAttachment#clb_id}
  */
  readonly clbId: string;
  /**
  * Domain of the target forwarding rule. Does not take effect when parameter `rule_id` is provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment#domain ClbAttachment#domain}
  */
  readonly domain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment#id ClbAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment#listener_id ClbAttachment#listener_id}
  */
  readonly listenerId: string;
  /**
  * ID of the CLB listener rule. Only supports listeners of `HTTPS` and `HTTP` protocol.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment#rule_id ClbAttachment#rule_id}
  */
  readonly ruleId?: string;
  /**
  * URL of the target forwarding rule. Does not take effect when parameter `rule_id` is provided.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment#url ClbAttachment#url}
  */
  readonly url?: string;
  /**
  * targets block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment#targets ClbAttachment#targets}
  */
...
export interface ClbAttachmentTargets {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment#eni_ip ClbAttachment#eni_ip}
  */
  readonly eniIp?: string;
  /**
  * CVM Instance Id of the backend server, conflict with `eni_ip` but must specify one of them.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment#instance_id ClbAttachment#instance_id}
  */
  readonly instanceId?: string;
  /**
  * Port of the backend server. Valid value ranges: (0~65535).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment#port ClbAttachment#port}
  */
  readonly port: number;
  /**
  * Forwarding weight of the backend service. Valid value ranges: (0~100). defaults to `10`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment#weight ClbAttachment#weight}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment tencentcloud_clb_attachment}
*/
export class ClbAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClbAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/clb_attachment tencentcloud_clb_attachment} Resource
  *
  * @param scope The scope in which to define this construct
