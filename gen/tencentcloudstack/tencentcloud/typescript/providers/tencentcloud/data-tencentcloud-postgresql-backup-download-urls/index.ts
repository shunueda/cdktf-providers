// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls
...
export interface DataTencentcloudPostgresqlBackupDownloadUrlsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Unique backup ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls#backup_id DataTencentcloudPostgresqlBackupDownloadUrls#backup_id}
  */
  readonly backupId: string;
  /**
  * Backup type. Valid values: `LogBackup`, `BaseBackup`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls#backup_type DataTencentcloudPostgresqlBackupDownloadUrls#backup_type}
  */
  readonly backupType: string;
  /**
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls#db_instance_id DataTencentcloudPostgresqlBackupDownloadUrls#db_instance_id}
  */
  readonly dbInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls#id DataTencentcloudPostgresqlBackupDownloadUrls#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls#result_output_file DataTencentcloudPostgresqlBackupDownloadUrls#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Validity period of a URL, which is 12 hours by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls#url_expire_time DataTencentcloudPostgresqlBackupDownloadUrls#url_expire_time}
  */
  readonly urlExpireTime?: number;
  /**
  * backup_download_restriction block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls#backup_download_restriction DataTencentcloudPostgresqlBackupDownloadUrls#backup_download_restriction}
  */
...
export interface DataTencentcloudPostgresqlBackupDownloadUrlsBackupDownloadRestriction {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls#ip_restriction_effect DataTencentcloudPostgresqlBackupDownloadUrls#ip_restriction_effect}
  */
  readonly ipRestrictionEffect?: string;
  /**
  * Whether it is allowed to download IP list of the backup files.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls#ip_set DataTencentcloudPostgresqlBackupDownloadUrls#ip_set}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls#restriction_type DataTencentcloudPostgresqlBackupDownloadUrls#restriction_type}
  */
  readonly restrictionType?: string;
  /**
  * Whether it is allowed to download the VPC ID list of the backup files.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls#vpc_id_set DataTencentcloudPostgresqlBackupDownloadUrls#vpc_id_set}
  */
  readonly vpcIdSet?: string[];
  /**
  * Whether VPC is allowed. Valid values: `ALLOW` (allow), `DENY` (deny).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls#vpc_restriction_effect DataTencentcloudPostgresqlBackupDownloadUrls#vpc_restriction_effect}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls tencentcloud_postgresql_backup_download_urls}
*/
export class DataTencentcloudPostgresqlBackupDownloadUrls extends cdktf.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/postgresql_backup_download_urls tencentcloud_postgresql_backup_download_urls} Data Source
  *
  * @param scope The scope in which to define this construct
