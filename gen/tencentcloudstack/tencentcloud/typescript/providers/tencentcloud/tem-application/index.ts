// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tem_application
...
export interface TemApplicationConfig extends cdktf.TerraformMetaArguments {
  ...
  * application name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tem_application#application_name TemApplication#application_name}
  */
  readonly applicationName: string;
  /**
  * program language, like JAVA.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tem_application#coding_language TemApplication#coding_language}
  */
  readonly codingLanguage: string;
  /**
  * application description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tem_application#description TemApplication#description}
  */
  readonly description: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tem_application#id TemApplication#id}
  *
  ...
  * tcr instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tem_application#instance_id TemApplication#instance_id}
  */
  readonly instanceId?: string;
  /**
  * repository name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tem_application#repo_name TemApplication#repo_name}
  */
  readonly repoName?: string;
  /**
  * registry address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tem_application#repo_server TemApplication#repo_server}
  */
  readonly repoServer?: string;
  /**
  * repo type, 0: tcr personal, 1: tcr enterprise, 2: public repository, 3: tcr hosted by tem, 4: demo image.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tem_application#repo_type TemApplication#repo_type}
  */
  readonly repoType?: number;
  /**
  * application tag list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tem_application#tags TemApplication#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * create image repo or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tem_application#use_default_image_service TemApplication#use_default_image_service}
  */
  readonly useDefaultImageService?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tem_application tencentcloud_tem_application}
*/
export class TemApplication extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TemApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tem_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/tem_application tencentcloud_tem_application} Resource
  *
  * @param scope The scope in which to define this construct
