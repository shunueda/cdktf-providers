// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dlc_check_data_engine_image_can_be_rollback
...
export interface DataTencentcloudDlcCheckDataEngineImageCanBeRollbackConfig extends cdktf.TerraformMetaArguments {
  ...
  * Unique engine ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dlc_check_data_engine_image_can_be_rollback#data_engine_id DataTencentcloudDlcCheckDataEngineImageCanBeRollback#data_engine_id}
  */
  readonly dataEngineId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dlc_check_data_engine_image_can_be_rollback#id DataTencentcloudDlcCheckDataEngineImageCanBeRollback#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dlc_check_data_engine_image_can_be_rollback#result_output_file DataTencentcloudDlcCheckDataEngineImageCanBeRollback#result_output_file}
  */
  readonly resultOutputFile?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dlc_check_data_engine_image_can_be_rollback tencentcloud_dlc_check_data_engine_image_can_be_rollback}
*/
export class DataTencentcloudDlcCheckDataEngineImageCanBeRollback extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudDlcCheckDataEngineImageCanBeRollback that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dlc_check_data_engine_image_can_be_rollback#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dlc_check_data_engine_image_can_be_rollback tencentcloud_dlc_check_data_engine_image_can_be_rollback} Data Source
  *
  * @param scope The scope in which to define this construct
