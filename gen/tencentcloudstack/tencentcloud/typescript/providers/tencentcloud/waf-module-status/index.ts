// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_module_status
...
export interface WafModuleStatusConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_module_status#access_control WafModuleStatus#access_control}
  */
  readonly accessControl: number;
  /**
  * Anti leakage module status, 0:closed, 1:opened.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_module_status#anti_leakage WafModuleStatus#anti_leakage}
  */
  readonly antiLeakage?: number;
  /**
  * Anti tamper module status, 0:closed, 1:opened.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_module_status#anti_tamper WafModuleStatus#anti_tamper}
  */
  readonly antiTamper?: number;
  /**
  * API security module status, 0:closed, 1:opened.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_module_status#api_protection WafModuleStatus#api_protection}
  */
  readonly apiProtection: number;
  /**
  * CC module status, 0:closed, 1:opened.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_module_status#cc_protection WafModuleStatus#cc_protection}
  */
  readonly ccProtection: number;
  /**
  * Domain.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_module_status#domain WafModuleStatus#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_module_status#id WafModuleStatus#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_module_status#web_security WafModuleStatus#web_security}
  */
  readonly webSecurity: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_module_status tencentcloud_waf_module_status}
*/
export class WafModuleStatus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafModuleStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_module_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/waf_module_status tencentcloud_waf_module_status} Resource
  *
  * @param scope The scope in which to define this construct
