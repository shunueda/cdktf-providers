// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/clb_target_groups
...
export interface DataTencentcloudClbTargetGroupsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/clb_target_groups#id DataTencentcloudClbTargetGroups#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/clb_target_groups#result_output_file DataTencentcloudClbTargetGroups#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * ID of Target group. Mutually exclusive with `vpc_id` and `target_group_name`. `target_group_id` is preferred.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/clb_target_groups#target_group_id DataTencentcloudClbTargetGroups#target_group_id}
  */
  readonly targetGroupId?: string;
  /**
  * Name of target group. Mutually exclusive with `target_group_id`. `target_group_id` is preferred.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/clb_target_groups#target_group_name DataTencentcloudClbTargetGroups#target_group_name}
  */
  readonly targetGroupName?: string;
  /**
  * Target group VPC ID. Mutually exclusive with `target_group_id`. `target_group_id` is preferred.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/clb_target_groups#vpc_id DataTencentcloudClbTargetGroups#vpc_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/clb_target_groups tencentcloud_clb_target_groups}
*/
export class DataTencentcloudClbTargetGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudClbTargetGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/clb_target_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/clb_target_groups tencentcloud_clb_target_groups} Data Source
  *
  * @param scope The scope in which to define this construct
