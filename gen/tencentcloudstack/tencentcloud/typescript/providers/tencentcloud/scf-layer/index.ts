// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/scf_layer
...
export interface ScfLayerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/scf_layer#compatible_runtimes ScfLayer#compatible_runtimes}
  */
  readonly compatibleRuntimes: string[];
  /**
  * The description of layer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/scf_layer#description ScfLayer#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/scf_layer#id ScfLayer#id}
  *
  ...
  * The name of layer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/scf_layer#layer_name ScfLayer#layer_name}
  */
  readonly layerName: string;
  /**
  * The license info of layer.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/scf_layer#license_info ScfLayer#license_info}
  */
  readonly licenseInfo?: string;
  /**
  * content block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/scf_layer#content ScfLayer#content}
  */
...
export interface ScfLayerContent {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/scf_layer#cos_bucket_name ScfLayer#cos_bucket_name}
  */
  readonly cosBucketName?: string;
  /**
  * Cos bucket region of the SCF layer, conflict with `zip_file`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/scf_layer#cos_bucket_region ScfLayer#cos_bucket_region}
  */
  readonly cosBucketRegion?: string;
  /**
  * Cos object name of the SCF layer, should have suffix `.zip` or `.jar`, conflict with `zip_file`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/scf_layer#cos_object_name ScfLayer#cos_object_name}
  */
  readonly cosObjectName?: string;
  /**
  * Zip file of the SCF layer, conflict with `cos_bucket_name`, `cos_object_name`, `cos_bucket_region`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/scf_layer#zip_file ScfLayer#zip_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/scf_layer tencentcloud_scf_layer}
*/
export class ScfLayer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScfLayer that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/scf_layer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/scf_layer tencentcloud_scf_layer} Resource
  *
  * @param scope The scope in which to define this construct
