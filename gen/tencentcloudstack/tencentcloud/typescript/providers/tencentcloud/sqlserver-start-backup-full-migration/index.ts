// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/sqlserver_start_backup_full_migration
...
export interface SqlserverStartBackupFullMigrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/sqlserver_start_backup_full_migration#backup_migration_id SqlserverStartBackupFullMigration#backup_migration_id}
  */
  readonly backupMigrationId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/sqlserver_start_backup_full_migration#id SqlserverStartBackupFullMigration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/sqlserver_start_backup_full_migration#instance_id SqlserverStartBackupFullMigration#instance_id}
  */
  readonly instanceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/sqlserver_start_backup_full_migration tencentcloud_sqlserver_start_backup_full_migration}
*/
export class SqlserverStartBackupFullMigration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlserverStartBackupFullMigration that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/sqlserver_start_backup_full_migration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/sqlserver_start_backup_full_migration tencentcloud_sqlserver_start_backup_full_migration} Resource
  *
  * @param scope The scope in which to define this construct
