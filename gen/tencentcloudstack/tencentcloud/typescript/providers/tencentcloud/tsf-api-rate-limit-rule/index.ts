// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tsf_api_rate_limit_rule
...
export interface TsfApiRateLimitRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  * Api Id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tsf_api_rate_limit_rule#api_id TsfApiRateLimitRule#api_id}
  */
  readonly apiId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tsf_api_rate_limit_rule#id TsfApiRateLimitRule#id}
  *
  ...
  * qps value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tsf_api_rate_limit_rule#max_qps TsfApiRateLimitRule#max_qps}
  */
  readonly maxQps: number;
  /**
  * Enabled/disabled, enabled/disabled, if not passed, it is enabled by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tsf_api_rate_limit_rule#usable_status TsfApiRateLimitRule#usable_status}
  */
  readonly usableStatus?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tsf_api_rate_limit_rule tencentcloud_tsf_api_rate_limit_rule}
*/
export class TsfApiRateLimitRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TsfApiRateLimitRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tsf_api_rate_limit_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/tsf_api_rate_limit_rule tencentcloud_tsf_api_rate_limit_rule} Resource
  *
  * @param scope The scope in which to define this construct
