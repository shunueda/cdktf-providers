// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cls_machine_group
...
export interface ClsMachineGroupConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cls_machine_group#auto_update ClsMachineGroup#auto_update}
  */
  readonly autoUpdate?: boolean | cdktf.IResolvable;
  /**
  * Machine group name, which must be unique.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cls_machine_group#group_name ClsMachineGroup#group_name}
  */
  readonly groupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cls_machine_group#id ClsMachineGroup#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cls_machine_group#service_logging ClsMachineGroup#service_logging}
  */
  readonly serviceLogging?: boolean | cdktf.IResolvable;
  /**
  * Tag description list. Up to 10 tag key-value pairs are supported and must be unique.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cls_machine_group#tags ClsMachineGroup#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Update end time. We recommend you update LogListener during off-peak hours.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cls_machine_group#update_end_time ClsMachineGroup#update_end_time}
  */
  readonly updateEndTime?: string;
  /**
  * Update start time. We recommend you update LogListener during off-peak hours.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cls_machine_group#update_start_time ClsMachineGroup#update_start_time}
  */
  readonly updateStartTime?: string;
  /**
  * machine_group_type block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cls_machine_group#machine_group_type ClsMachineGroup#machine_group_type}
  */
...
export interface ClsMachineGroupMachineGroupType {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cls_machine_group#type ClsMachineGroup#type}
  */
  readonly type: string;
  /**
  * Machine description list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cls_machine_group#values ClsMachineGroup#values}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cls_machine_group tencentcloud_cls_machine_group}
*/
export class ClsMachineGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClsMachineGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cls_machine_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/cls_machine_group tencentcloud_cls_machine_group} Resource
  *
  * @param scope The scope in which to define this construct
