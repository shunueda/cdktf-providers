// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/kubernetes_addon
...
export interface KubernetesAddonConfig extends cdktf.TerraformMetaArguments {
  ...
  * Name of addon.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/kubernetes_addon#addon_name KubernetesAddon#addon_name}
  */
  readonly addonName: string;
  /**
  * Version of addon. If no set, the latest version will be installed by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/kubernetes_addon#addon_version KubernetesAddon#addon_version}
  */
  readonly addonVersion?: string;
  /**
  * ID of cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/kubernetes_addon#cluster_id KubernetesAddon#cluster_id}
  */
  readonly clusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/kubernetes_addon#id KubernetesAddon#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/kubernetes_addon#raw_values KubernetesAddon#raw_values}
  */
  readonly rawValues?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/kubernetes_addon#timeouts KubernetesAddon#timeouts}
  */
  readonly timeouts?: KubernetesAddonTimeouts;
}
export interface KubernetesAddonTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/kubernetes_addon#create KubernetesAddon#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/kubernetes_addon#delete KubernetesAddon#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/kubernetes_addon#update KubernetesAddon#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/kubernetes_addon tencentcloud_kubernetes_addon}
*/
export class KubernetesAddon extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesAddon that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/kubernetes_addon#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/kubernetes_addon tencentcloud_kubernetes_addon} Resource
  *
  * @param scope The scope in which to define this construct
