// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/mysql_db_import_job_operation
...
export interface MysqlDbImportJobOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/mysql_db_import_job_operation#cos_url MysqlDbImportJobOperation#cos_url}
  */
  readonly cosUrl?: string;
  /**
  * The name of the imported target database, if it is not passed, it means that no database is specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/mysql_db_import_job_operation#db_name MysqlDbImportJobOperation#db_name}
  */
  readonly dbName?: string;
  /**
  * file name. This file refers to the file that the user has uploaded to Tencent Cloud, and only .sql files are supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/mysql_db_import_job_operation#file_name MysqlDbImportJobOperation#file_name}
  */
  readonly fileName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/mysql_db_import_job_operation#id MysqlDbImportJobOperation#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/mysql_db_import_job_operation#instance_id MysqlDbImportJobOperation#instance_id}
  */
  readonly instanceId: string;
  /**
  * The password of the user account of the cloud database instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/mysql_db_import_job_operation#password MysqlDbImportJobOperation#password}
  */
  readonly password?: string;
  /**
  * The username of the cloud database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/mysql_db_import_job_operation#user MysqlDbImportJobOperation#user}
  */
  readonly user: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/mysql_db_import_job_operation tencentcloud_mysql_db_import_job_operation}
*/
export class MysqlDbImportJobOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlDbImportJobOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/mysql_db_import_job_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/mysql_db_import_job_operation tencentcloud_mysql_db_import_job_operation} Resource
  *
  * @param scope The scope in which to define this construct
