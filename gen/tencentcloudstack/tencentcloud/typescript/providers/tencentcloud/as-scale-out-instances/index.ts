// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/as_scale_out_instances
...
export interface AsScaleOutInstancesConfig extends cdktf.TerraformMetaArguments {
  ...
  * Scaling group ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/as_scale_out_instances#auto_scaling_group_id AsScaleOutInstances#auto_scaling_group_id}
  */
  readonly autoScalingGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/as_scale_out_instances#id AsScaleOutInstances#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/as_scale_out_instances#scale_out_number AsScaleOutInstances#scale_out_number}
  */
  readonly scaleOutNumber: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/as_scale_out_instances tencentcloud_as_scale_out_instances}
*/
export class AsScaleOutInstances extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AsScaleOutInstances that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/as_scale_out_instances#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/as_scale_out_instances tencentcloud_as_scale_out_instances} Resource
  *
  * @param scope The scope in which to define this construct
