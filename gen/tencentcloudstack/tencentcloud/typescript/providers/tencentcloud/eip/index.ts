// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip
...
export interface EipConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#anti_ddos_package_id Eip#anti_ddos_package_id}
  */
  readonly antiDdosPackageId?: string;
  /**
  * The zone of anycast. Valid value: `ANYCAST_ZONE_GLOBAL` and `ANYCAST_ZONE_OVERSEAS`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#anycast_zone Eip#anycast_zone}
  */
  readonly anycastZone?: string;
  /**
  * Indicates whether the anycast eip can be associated to a CLB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#applicable_for_clb Eip#applicable_for_clb}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#auto_renew_flag Eip#auto_renew_flag}
  */
  readonly autoRenewFlag?: number;
  /**
  * ID of bandwidth package, it will set when `internet_charge_type` is `BANDWIDTH_PACKAGE`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#bandwidth_package_id Eip#bandwidth_package_id}
  */
  readonly bandwidthPackageId?: string;
  /**
  * CDC Unique ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#cdc_id Eip#cdc_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#egress Eip#egress}
  */
  readonly egress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#id Eip#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#internet_charge_type Eip#internet_charge_type}
  */
  readonly internetChargeType?: string;
  /**
  * The bandwidth limit of EIP, unit is Mbps.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#internet_max_bandwidth_out Eip#internet_max_bandwidth_out}
  */
  readonly internetMaxBandwidthOut?: number;
  /**
  * Internet service provider of eip. Valid value: `BGP`, `CMCC`, `CTCC` and `CUCC`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#internet_service_provider Eip#internet_service_provider}
  */
  readonly internetServiceProvider?: string;
  /**
  * The name of eip.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#name Eip#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#prepaid_period Eip#prepaid_period}
  */
  readonly prepaidPeriod?: number;
  /**
  * The tags of eip.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#tags Eip#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * The type of eip. Valid value:  `EIP` and `AnycastEIP` and `HighQualityEIP` and `AntiDDoSEIP`. Default is `EIP`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#type Eip#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip tencentcloud_eip}
*/
export class Eip extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Eip that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/eip tencentcloud_eip} Resource
  *
  * @param scope The scope in which to define this construct
