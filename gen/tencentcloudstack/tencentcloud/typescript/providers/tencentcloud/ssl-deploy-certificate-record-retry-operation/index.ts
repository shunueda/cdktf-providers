// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/ssl_deploy_certificate_record_retry_operation
...
export interface SslDeployCertificateRecordRetryOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/ssl_deploy_certificate_record_retry_operation#deploy_record_detail_id SslDeployCertificateRecordRetryOperation#deploy_record_detail_id}
  */
  readonly deployRecordDetailId?: number;
  /**
  * Deployment record ID to be retried.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/ssl_deploy_certificate_record_retry_operation#deploy_record_id SslDeployCertificateRecordRetryOperation#deploy_record_id}
  */
  readonly deployRecordId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/ssl_deploy_certificate_record_retry_operation#id SslDeployCertificateRecordRetryOperation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/ssl_deploy_certificate_record_retry_operation tencentcloud_ssl_deploy_certificate_record_retry_operation}
*/
export class SslDeployCertificateRecordRetryOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SslDeployCertificateRecordRetryOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/ssl_deploy_certificate_record_retry_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/ssl_deploy_certificate_record_retry_operation tencentcloud_ssl_deploy_certificate_record_retry_operation} Resource
  *
  * @param scope The scope in which to define this construct
