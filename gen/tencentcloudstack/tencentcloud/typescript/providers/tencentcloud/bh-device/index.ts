// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device
...
export interface BhDeviceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#account_id BhDevice#account_id}
  */
  readonly accountId?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#id BhDevice#id}
  *
  ...
  * device_set block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#device_set BhDevice#device_set}
  */
...
export interface BhDeviceDeviceSet {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#ap_code BhDevice#ap_code}
  */
  readonly apCode?: string;
  /**
  * Region name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#ap_name BhDevice#ap_name}
  */
  readonly apName?: string;
  /**
  * Department ID to which the asset belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#department_id BhDevice#department_id}
  */
  readonly departmentId?: string;
  /**
  * Whether to enable SSL, 1: enable, 0: disable, only supports Redis assets.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#enable_ssl BhDevice#enable_ssl}
  */
  readonly enableSsl?: number;
  /**
  * Asset instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#instance_id BhDevice#instance_id}
  */
  readonly instanceId?: string;
  /**
  * IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#ip BhDevice#ip}
  */
  readonly ip: string;
  /**
  * Asset multi-node: IP and port fields.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#ip_port_set BhDevice#ip_port_set}
  */
  readonly ipPortSet?: string[];
  /**
  * Host name, can be empty.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#name BhDevice#name}
  */
  readonly name?: string;
  /**
  * Operating system name, can only be Linux, Windows or MySQL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#os_name BhDevice#os_name}
  */
  readonly osName: string;
  /**
  * Management port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#port BhDevice#port}
  */
  readonly port: number;
  /**
  * Public IP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#public_ip BhDevice#public_ip}
  */
  readonly publicIp?: string;
  /**
  * SSL certificate, required when EnableSSL is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#ssl_cert BhDevice#ssl_cert}
  */
  readonly sslCert?: string;
  /**
  * SSL certificate name, required when EnableSSL is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#ssl_cert_name BhDevice#ssl_cert_name}
  */
  readonly sslCertName?: string;
  /**
  * Subnet to which the asset belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#subnet_id BhDevice#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * VPC to which the asset belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#vpc_id BhDevice#vpc_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device tencentcloud_bh_device}
*/
export class BhDevice extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BhDevice that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/bh_device tencentcloud_bh_device} Resource
  *
  * @param scope The scope in which to define this construct
