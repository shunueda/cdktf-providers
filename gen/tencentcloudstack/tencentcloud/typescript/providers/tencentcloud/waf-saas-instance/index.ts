// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance
...
export interface WafSaasInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Whether to purchase API Security, 1: yes, 0: no. Default is 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance#api_security WafSaasInstance#api_security}
  */
  readonly apiSecurity?: number;
  /**
  * Auto renew flag, 1: enable, 0: disable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance#auto_renew_flag WafSaasInstance#auto_renew_flag}
  */
  readonly autoRenewFlag?: number;
  /**
  * Whether to purchase Bot management, 1: yes, 0: no. Default is 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance#bot_management WafSaasInstance#bot_management}
  */
  readonly botManagement?: number;
  /**
  * Is elastic billing enabled, 1: enable, 0: disable.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance#elastic_mode WafSaasInstance#elastic_mode}
  */
  readonly elasticMode?: number;
  /**
  * Billing order parameters. support premium_saas, enterprise_saas, ultimate_saas.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance#goods_category WafSaasInstance#goods_category}
  */
  readonly goodsCategory: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance#id WafSaasInstance#id}
  *
  ...
  * Waf instance name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance#instance_name WafSaasInstance#instance_name}
  */
  readonly instanceName?: string;
  /**
  * QPS Limit, Minimum setting 10000. Only `elastic_mode` is 1, can be set.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance#qps_limit WafSaasInstance#qps_limit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance#real_region WafSaasInstance#real_region}
  */
  readonly realRegion?: string;
  /**
  * Time interval.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance#time_span WafSaasInstance#time_span}
  */
  readonly timeSpan?: number;
  /**
  * Time unit, support d, m, y. d: day, m: month, y: year.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance#time_unit WafSaasInstance#time_unit}
  */
  readonly timeUnit?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance tencentcloud_waf_saas_instance}
*/
export class WafSaasInstance extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "tencentcloud_waf_saas_instance";
  ...
  * @param importFromId The id of the existing WafSaasInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the WafSaasInstance to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "tencentcloud_waf_saas_instance", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_saas_instance tencentcloud_waf_saas_instance} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options WafSaasInstanceConfig
  */
  public constructor(scope: Construct, id: string, config: WafSaasInstanceConfig) {
    super(scope, id, {
    ...
    this._realRegion = config.realRegion;
  ...
  // real_region - computed: false, optional: true, required: false
  private _realRegion?: string; 
  public get realRegion() {
    return this.getStringAttribute('real_region');
  }
  public set realRegion(value: string) {
    this._realRegion = value;
  }
  public resetRealRegion() {
    this._realRegion = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get realRegionInput() {
    return this._realRegion;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      real_region: cdktf.stringToTerraform(this._realRegion),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      real_region: {
        value: cdktf.stringToHclTerraform(this._realRegion),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
