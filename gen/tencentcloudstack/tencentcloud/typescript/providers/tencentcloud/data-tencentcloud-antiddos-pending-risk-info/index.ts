// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/antiddos_pending_risk_info
...
export interface DataTencentcloudAntiddosPendingRiskInfoConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/antiddos_pending_risk_info#id DataTencentcloudAntiddosPendingRiskInfo#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/antiddos_pending_risk_info#result_output_file DataTencentcloudAntiddosPendingRiskInfo#result_output_file}
  */
  readonly resultOutputFile?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/antiddos_pending_risk_info tencentcloud_antiddos_pending_risk_info}
*/
export class DataTencentcloudAntiddosPendingRiskInfo extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudAntiddosPendingRiskInfo that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/antiddos_pending_risk_info#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/data-sources/antiddos_pending_risk_info tencentcloud_antiddos_pending_risk_info} Data Source
  *
  * @param scope The scope in which to define this construct
