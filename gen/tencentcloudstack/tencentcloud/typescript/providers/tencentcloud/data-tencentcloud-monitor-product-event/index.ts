// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event
...
export interface DataTencentcloudMonitorProductEventConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#end_time DataTencentcloudMonitorProductEvent#end_time}
  */
  readonly endTime?: number;
  /**
  * Event name filtering, such as `guest_reboot` indicates that the machine restart.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#event_name DataTencentcloudMonitorProductEvent#event_name}
  */
  readonly eventName?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#id DataTencentcloudMonitorProductEvent#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#instance_id DataTencentcloudMonitorProductEvent#instance_id}
  */
  readonly instanceId?: string[];
  /**
  * Alarm status configuration filter, 1means configured, 0(default) means not configured.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#is_alarm_config DataTencentcloudMonitorProductEvent#is_alarm_config}
  */
  readonly isAlarmConfig?: number;
  /**
  * Product type filtering, such as `cvm` for cloud server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#product_name DataTencentcloudMonitorProductEvent#product_name}
  */
  readonly productName?: string[];
  /**
  * Project ID filter.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#project_id DataTencentcloudMonitorProductEvent#project_id}
  */
  readonly projectId?: string[];
  /**
  * Region filter, such as `gz`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#region_list DataTencentcloudMonitorProductEvent#region_list}
  */
  readonly regionList?: string[];
  /**
  * Used to store results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#result_output_file DataTencentcloudMonitorProductEvent#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Start timestamp for this query, eg:`1588230000`. Default start time is `now-3600`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#start_time DataTencentcloudMonitorProductEvent#start_time}
  */
  readonly startTime?: number;
  /**
  * Event status filter, value range `-`,`alarm`,`recover`, indicating recovered, unrecovered and stateless.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#status DataTencentcloudMonitorProductEvent#status}
  */
  readonly status?: string[];
  /**
  * Event type filtering, with value range `abnormal`,`status_change`, indicating state change and abnormal events.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#type DataTencentcloudMonitorProductEvent#type}
  */
  readonly type?: string[];
  /**
  * dimensions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#dimensions DataTencentcloudMonitorProductEvent#dimensions}
  */
...
export interface DataTencentcloudMonitorProductEventDimensions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#name DataTencentcloudMonitorProductEvent#name}
  */
  readonly name?: string;
  /**
  * Instance dimension value, eg: `119.119.119.119` for internet ip.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#value DataTencentcloudMonitorProductEvent#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event tencentcloud_monitor_product_event}
*/
export class DataTencentcloudMonitorProductEvent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudMonitorProductEvent that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/data-sources/monitor_product_event tencentcloud_monitor_product_event} Data Source
  *
  * @param scope The scope in which to define this construct
