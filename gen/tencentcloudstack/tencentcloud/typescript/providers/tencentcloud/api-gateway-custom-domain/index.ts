// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_custom_domain
...
export interface ApiGatewayCustomDomainConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_custom_domain#certificate_id ApiGatewayCustomDomain#certificate_id}
  */
  readonly certificateId?: string;
  /**
  * Default domain name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_custom_domain#default_domain ApiGatewayCustomDomain#default_domain}
  */
  readonly defaultDomain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_custom_domain#id ApiGatewayCustomDomain#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_custom_domain#is_default_mapping ApiGatewayCustomDomain#is_default_mapping}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_custom_domain#is_forced_https ApiGatewayCustomDomain#is_forced_https}
  */
  readonly isForcedHttps?: boolean | cdktf.IResolvable;
  /**
  * Network type. Valid values: `OUTER`, `INNER`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_custom_domain#net_type ApiGatewayCustomDomain#net_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_custom_domain#path_mappings ApiGatewayCustomDomain#path_mappings}
  */
  readonly pathMappings?: string[];
  /**
  * Protocol supported by service. Valid values: `http`, `https`, `http&https`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_custom_domain#protocol ApiGatewayCustomDomain#protocol}
  */
  readonly protocol: string;
  /**
  * Unique service ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_custom_domain#service_id ApiGatewayCustomDomain#service_id}
  */
  readonly serviceId: string;
  /**
  * Custom domain name to be bound.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_custom_domain#sub_domain ApiGatewayCustomDomain#sub_domain}
  */
  readonly subDomain: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_custom_domain tencentcloud_api_gateway_custom_domain}
*/
export class ApiGatewayCustomDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiGatewayCustomDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_custom_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/api_gateway_custom_domain tencentcloud_api_gateway_custom_domain} Resource
  *
  * @param scope The scope in which to define this construct
