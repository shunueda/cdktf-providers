// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/dts_compare_task_stop_operation
...
export interface DtsCompareTaskStopOperationConfig extends cdktf.TerraformMetaArguments {
  ...
  * Compare task id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/dts_compare_task_stop_operation#compare_task_id DtsCompareTaskStopOperation#compare_task_id}
  */
  readonly compareTaskId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/dts_compare_task_stop_operation#id DtsCompareTaskStopOperation#id}
  *
  ...
  * job id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/dts_compare_task_stop_operation#job_id DtsCompareTaskStopOperation#job_id}
  */
  readonly jobId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/dts_compare_task_stop_operation tencentcloud_dts_compare_task_stop_operation}
*/
export class DtsCompareTaskStopOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DtsCompareTaskStopOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/dts_compare_task_stop_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/dts_compare_task_stop_operation tencentcloud_dts_compare_task_stop_operation} Resource
  *
  * @param scope The scope in which to define this construct
