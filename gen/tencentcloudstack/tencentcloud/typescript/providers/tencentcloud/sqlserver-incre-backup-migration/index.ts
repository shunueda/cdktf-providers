// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_incre_backup_migration
...
export interface SqlserverIncreBackupMigrationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_incre_backup_migration#backup_files SqlserverIncreBackupMigration#backup_files}
  */
  readonly backupFiles?: string[];
  /**
  * Backup import task ID, which is returned through the API CreateBackupMigration.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_incre_backup_migration#backup_migration_id SqlserverIncreBackupMigration#backup_migration_id}
  */
  readonly backupMigrationId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_incre_backup_migration#id SqlserverIncreBackupMigration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_incre_backup_migration#instance_id SqlserverIncreBackupMigration#instance_id}
  */
  readonly instanceId: string;
  /**
  * Whether restoration is required. No: not required. Yes: required. Not required by default.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_incre_backup_migration#is_recovery SqlserverIncreBackupMigration#is_recovery}
  */
  readonly isRecovery?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_incre_backup_migration tencentcloud_sqlserver_incre_backup_migration}
*/
export class SqlserverIncreBackupMigration extends cdktf.TerraformResource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/sqlserver_incre_backup_migration tencentcloud_sqlserver_incre_backup_migration} Resource
  *
  * @param scope The scope in which to define this construct
