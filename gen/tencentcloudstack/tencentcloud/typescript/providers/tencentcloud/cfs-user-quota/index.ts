// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_user_quota
...
export interface CfsUserQuotaConfig extends cdktf.TerraformMetaArguments {
  ...
  * Capacity Limit(GB).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_user_quota#capacity_hard_limit CfsUserQuota#capacity_hard_limit}
  */
  readonly capacityHardLimit?: number;
  /**
  * File limit.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_user_quota#file_hard_limit CfsUserQuota#file_hard_limit}
  */
  readonly fileHardLimit?: number;
  /**
  * File system ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_user_quota#file_system_id CfsUserQuota#file_system_id}
  */
  readonly fileSystemId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_user_quota#id CfsUserQuota#id}
  *
  ...
  * Info of UID/GID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_user_quota#user_id CfsUserQuota#user_id}
  */
  readonly userId: string;
  /**
  * Quota type. Valid value: `Uid`, `Gid`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_user_quota#user_type CfsUserQuota#user_type}
  */
  readonly userType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_user_quota tencentcloud_cfs_user_quota}
*/
export class CfsUserQuota extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CfsUserQuota that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_user_quota#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_user_quota tencentcloud_cfs_user_quota} Resource
  *
  * @param scope The scope in which to define this construct
