// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vpc_snapshot_files
...
export interface DataTencentcloudVpcSnapshotFilesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vpc_snapshot_files#business_type DataTencentcloudVpcSnapshotFiles#business_type}
  */
  readonly businessType: string;
  /**
  * End date in the format %Y-%m-%d %H:%M:%S.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vpc_snapshot_files#end_date DataTencentcloudVpcSnapshotFiles#end_date}
  */
  readonly endDate: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vpc_snapshot_files#id DataTencentcloudVpcSnapshotFiles#id}
  *
  ...
  * InstanceId.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vpc_snapshot_files#instance_id DataTencentcloudVpcSnapshotFiles#instance_id}
  */
  readonly instanceId: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vpc_snapshot_files#result_output_file DataTencentcloudVpcSnapshotFiles#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Start date in the format %Y-%m-%d %H:%M:%S.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vpc_snapshot_files#start_date DataTencentcloudVpcSnapshotFiles#start_date}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vpc_snapshot_files tencentcloud_vpc_snapshot_files}
*/
export class DataTencentcloudVpcSnapshotFiles extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudVpcSnapshotFiles that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vpc_snapshot_files#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/data-sources/vpc_snapshot_files tencentcloud_vpc_snapshot_files} Data Source
  *
  * @param scope The scope in which to define this construct
