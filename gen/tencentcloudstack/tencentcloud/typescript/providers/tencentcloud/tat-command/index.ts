// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command
...
export interface TatCommandConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#command_name TatCommand#command_name}
  */
  readonly commandName: string;
  /**
  * Command type. `SHELL`, `POWERSHELL` and `BAT` are supported. The default value is `SHELL`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#command_type TatCommand#command_type}
  */
  readonly commandType?: string;
  /**
  * Command content. The maximum length is 64 KB.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#content TatCommand#content}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#default_parameters TatCommand#default_parameters}
  */
  readonly defaultParameters?: string;
  /**
  * Command description. The maximum length is 120 characters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#description TatCommand#description}
  */
  readonly description?: string;
  /**
  * Whether to enable the custom parameter feature.This cannot be modified once created.Default value: `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#enable_parameter TatCommand#enable_parameter}
  */
  readonly enableParameter?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#id TatCommand#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#output_cos_bucket_url TatCommand#output_cos_bucket_url}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#output_cos_key_prefix TatCommand#output_cos_key_prefix}
  */
  readonly outputCosKeyPrefix?: string;
  /**
  * Command timeout period. Default value: 60 seconds. Value range: [1, 86400].
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#timeout TatCommand#timeout}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#username TatCommand#username}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#working_directory TatCommand#working_directory}
  */
  readonly workingDirectory?: string;
  /**
  * tags block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#tags TatCommand#tags}
  */
...
export interface TatCommandTags {
  ...
  * Tag key.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#key TatCommand#key}
  */
  readonly key: string;
  /**
  * Tag value.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#value TatCommand#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command tencentcloud_tat_command}
*/
export class TatCommand extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TatCommand that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/tat_command tencentcloud_tat_command} Resource
  *
  * @param scope The scope in which to define this construct
