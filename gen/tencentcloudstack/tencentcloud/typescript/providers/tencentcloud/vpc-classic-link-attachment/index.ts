// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/vpc_classic_link_attachment
...
export interface VpcClassicLinkAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/vpc_classic_link_attachment#id VpcClassicLinkAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/vpc_classic_link_attachment#instance_ids VpcClassicLinkAttachment#instance_ids}
  */
  readonly instanceIds: string[];
  /**
  * VPC instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/vpc_classic_link_attachment#vpc_id VpcClassicLinkAttachment#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/vpc_classic_link_attachment tencentcloud_vpc_classic_link_attachment}
*/
export class VpcClassicLinkAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcClassicLinkAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/vpc_classic_link_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.46/docs/resources/vpc_classic_link_attachment tencentcloud_vpc_classic_link_attachment} Resource
  *
  * @param scope The scope in which to define this construct
