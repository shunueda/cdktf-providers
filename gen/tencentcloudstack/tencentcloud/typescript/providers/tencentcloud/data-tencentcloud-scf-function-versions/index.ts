// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/scf_function_versions
...
export interface DataTencentcloudScfFunctionVersionsConfig extends cdktf.TerraformMetaArguments {
  ...
  * Function Name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/scf_function_versions#function_name DataTencentcloudScfFunctionVersions#function_name}
  */
  readonly functionName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/scf_function_versions#id DataTencentcloudScfFunctionVersions#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/scf_function_versions#namespace DataTencentcloudScfFunctionVersions#namespace}
  */
  readonly namespace?: string;
  /**
  * It specifies whether to return the results in ascending or descending order. The value is `ASC` or `DESC`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/scf_function_versions#order DataTencentcloudScfFunctionVersions#order}
  */
  readonly order?: string;
  /**
  * It specifies the sorting order of the results according to a specified field, such as `AddTime`, `ModTime`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/scf_function_versions#order_by DataTencentcloudScfFunctionVersions#order_by}
  */
  readonly orderBy?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/scf_function_versions#result_output_file DataTencentcloudScfFunctionVersions#result_output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/scf_function_versions tencentcloud_scf_function_versions}
*/
export class DataTencentcloudScfFunctionVersions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudScfFunctionVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/scf_function_versions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/data-sources/scf_function_versions tencentcloud_scf_function_versions} Data Source
  *
  * @param scope The scope in which to define this construct
