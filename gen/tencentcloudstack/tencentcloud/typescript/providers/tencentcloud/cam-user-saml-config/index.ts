// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cam_user_saml_config
...
export interface CamUserSamlConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cam_user_saml_config#auxiliary_domain CamUserSamlConfig#auxiliary_domain}
  */
  readonly auxiliaryDomain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cam_user_saml_config#id CamUserSamlConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cam_user_saml_config#metadata_document_file CamUserSamlConfig#metadata_document_file}
  */
  readonly metadataDocumentFile?: string;
  /**
  * SAML metadata document, xml format, support string content or file path.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cam_user_saml_config#saml_metadata_document CamUserSamlConfig#saml_metadata_document}
  */
  readonly samlMetadataDocument: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cam_user_saml_config tencentcloud_cam_user_saml_config}
*/
export class CamUserSamlConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CamUserSamlConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cam_user_saml_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/cam_user_saml_config tencentcloud_cam_user_saml_config} Resource
  *
  * @param scope The scope in which to define this construct
