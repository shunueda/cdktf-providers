// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mps_animated_graphics_template
...
export interface MpsAnimatedGraphicsTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mps_animated_graphics_template#comment MpsAnimatedGraphicsTemplate#comment}
  */
  readonly comment?: string;
  /**
  * Animation format, the values are gif and webp. Default is gif.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mps_animated_graphics_template#format MpsAnimatedGraphicsTemplate#format}
  */
  readonly format?: string;
  /**
  * Frame rate, value range: [1, 30], unit: Hz.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mps_animated_graphics_template#fps MpsAnimatedGraphicsTemplate#fps}
  */
  readonly fps: number;
  /**
  * The maximum value of the animation height (or short side), value range: 0 and [128, 4096], unit: px.When Width and Height are both 0, the resolution is the same.When Width is 0 and Height is not 0, Width is scaled proportionally.When Width is not 0 and Height is 0, Height is scaled proportionally.When both Width and Height are not 0, the resolution is specified by the user.Default value: 0.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mps_animated_graphics_template#height MpsAnimatedGraphicsTemplate#height}
  */
  readonly height?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mps_animated_graphics_template#id MpsAnimatedGraphicsTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mps_animated_graphics_template#name MpsAnimatedGraphicsTemplate#name}
  */
  readonly name?: string;
  /**
  * Image quality, value range: [1, 100], default value is 75.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mps_animated_graphics_template#quality MpsAnimatedGraphicsTemplate#quality}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mps_animated_graphics_template#resolution_adaptive MpsAnimatedGraphicsTemplate#resolution_adaptive}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mps_animated_graphics_template#width MpsAnimatedGraphicsTemplate#width}
  */
  readonly width?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mps_animated_graphics_template tencentcloud_mps_animated_graphics_template}
*/
export class MpsAnimatedGraphicsTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MpsAnimatedGraphicsTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mps_animated_graphics_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.48/docs/resources/mps_animated_graphics_template tencentcloud_mps_animated_graphics_template} Resource
  *
  * @param scope The scope in which to define this construct
