// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/identity_center_scim_credential
...
export interface IdentityCenterScimCredentialConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/identity_center_scim_credential#id IdentityCenterScimCredential#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/identity_center_scim_credential#zone_id IdentityCenterScimCredential#zone_id}
  */
  readonly zoneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/identity_center_scim_credential tencentcloud_identity_center_scim_credential}
*/
export class IdentityCenterScimCredential extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityCenterScimCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/identity_center_scim_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/identity_center_scim_credential tencentcloud_identity_center_scim_credential} Resource
  *
  * @param scope The scope in which to define this construct
