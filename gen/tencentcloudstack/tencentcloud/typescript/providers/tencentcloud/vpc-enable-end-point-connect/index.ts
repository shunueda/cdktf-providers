// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/vpc_enable_end_point_connect
...
export interface VpcEnableEndPointConnectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/vpc_enable_end_point_connect#accept_flag VpcEnableEndPointConnect#accept_flag}
  */
  readonly acceptFlag: boolean | cdktf.IResolvable;
  /**
  * Endpoint ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/vpc_enable_end_point_connect#end_point_id VpcEnableEndPointConnect#end_point_id}
  */
  readonly endPointId: string[];
  /**
  * Endpoint service ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/vpc_enable_end_point_connect#end_point_service_id VpcEnableEndPointConnect#end_point_service_id}
  */
  readonly endPointServiceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/vpc_enable_end_point_connect#id VpcEnableEndPointConnect#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/vpc_enable_end_point_connect tencentcloud_vpc_enable_end_point_connect}
*/
export class VpcEnableEndPointConnect extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcEnableEndPointConnect that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/vpc_enable_end_point_connect#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/vpc_enable_end_point_connect tencentcloud_vpc_enable_end_point_connect} Resource
  *
  * @param scope The scope in which to define this construct
