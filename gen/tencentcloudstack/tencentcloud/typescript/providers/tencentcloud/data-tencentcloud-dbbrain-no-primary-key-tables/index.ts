// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_no_primary_key_tables
...
export interface DataTencentcloudDbbrainNoPrimaryKeyTablesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_no_primary_key_tables#date DataTencentcloudDbbrainNoPrimaryKeyTables#date}
  */
  readonly date: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_no_primary_key_tables#id DataTencentcloudDbbrainNoPrimaryKeyTables#id}
  *
  ...
  * instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_no_primary_key_tables#instance_id DataTencentcloudDbbrainNoPrimaryKeyTables#instance_id}
  */
  readonly instanceId: string;
  /**
  * Service product type, supported values: `mysql` - ApsaraDB for MySQL, the default is `mysql`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_no_primary_key_tables#product DataTencentcloudDbbrainNoPrimaryKeyTables#product}
  */
  readonly product?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_no_primary_key_tables#result_output_file DataTencentcloudDbbrainNoPrimaryKeyTables#result_output_file}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_no_primary_key_tables tencentcloud_dbbrain_no_primary_key_tables}
*/
export class DataTencentcloudDbbrainNoPrimaryKeyTables extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudDbbrainNoPrimaryKeyTables that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_no_primary_key_tables#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/data-sources/dbbrain_no_primary_key_tables tencentcloud_dbbrain_no_primary_key_tables} Data Source
  *
  * @param scope The scope in which to define this construct
