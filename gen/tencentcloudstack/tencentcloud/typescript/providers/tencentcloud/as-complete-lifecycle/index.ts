// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_complete_lifecycle
...
export interface AsCompleteLifecycleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_complete_lifecycle#id AsCompleteLifecycle#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_complete_lifecycle#instance_id AsCompleteLifecycle#instance_id}
  */
  readonly instanceId?: string;
  /**
  * Result of the lifecycle action. Value range: `CONTINUE`, `ABANDON`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_complete_lifecycle#lifecycle_action_result AsCompleteLifecycle#lifecycle_action_result}
  */
  readonly lifecycleActionResult: string;
  /**
  * Either InstanceId or LifecycleActionToken must be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_complete_lifecycle#lifecycle_action_token AsCompleteLifecycle#lifecycle_action_token}
  */
  readonly lifecycleActionToken?: string;
  /**
  * Lifecycle hook ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_complete_lifecycle#lifecycle_hook_id AsCompleteLifecycle#lifecycle_hook_id}
  */
  readonly lifecycleHookId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_complete_lifecycle tencentcloud_as_complete_lifecycle}
*/
export class AsCompleteLifecycle extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AsCompleteLifecycle that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_complete_lifecycle#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/resources/as_complete_lifecycle tencentcloud_as_complete_lifecycle} Resource
  *
  * @param scope The scope in which to define this construct
