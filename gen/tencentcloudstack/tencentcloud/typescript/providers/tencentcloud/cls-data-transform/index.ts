// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cls_data_transform
...
export interface ClsDataTransformConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cls_data_transform#enable_flag ClsDataTransform#enable_flag}
  */
  readonly enableFlag?: number;
  /**
  * Data transform content. If `func_type` is `2`, must use `log_auto_output`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cls_data_transform#etl_content ClsDataTransform#etl_content}
  */
  readonly etlContent: string;
  /**
  * Task type. `1`: Specify the theme; `2`: Dynamic creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cls_data_transform#func_type ClsDataTransform#func_type}
  */
  readonly funcType: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cls_data_transform#id ClsDataTransform#id}
  *
  ...
  * Task name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cls_data_transform#name ClsDataTransform#name}
  */
  readonly name: string;
  /**
  * Source topic ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cls_data_transform#src_topic_id ClsDataTransform#src_topic_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cls_data_transform#task_type ClsDataTransform#task_type}
  */
  readonly taskType: number;
  /**
  * dst_resources block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cls_data_transform#dst_resources ClsDataTransform#dst_resources}
  */
...
export interface ClsDataTransformDstResources {
  ...
  * Alias.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cls_data_transform#alias ClsDataTransform#alias}
  */
  readonly alias: string;
  /**
  * Dst topic ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cls_data_transform#topic_id ClsDataTransform#topic_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cls_data_transform tencentcloud_cls_data_transform}
*/
export class ClsDataTransform extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClsDataTransform that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cls_data_transform#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/cls_data_transform tencentcloud_cls_data_transform} Resource
  *
  * @param scope The scope in which to define this construct
