// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_ro_instance_ip
...
export interface MysqlRoInstanceIpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_ro_instance_ip#id MysqlRoInstanceIp#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_ro_instance_ip#instance_id MysqlRoInstanceIp#instance_id}
  */
  readonly instanceId: string;
  /**
  * Subnet descriptor, for example: subnet-1typ0s7d.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_ro_instance_ip#uniq_subnet_id MysqlRoInstanceIp#uniq_subnet_id}
  */
  readonly uniqSubnetId?: string;
  /**
  * vpc descriptor, for example: vpc-a23yt67j, if this field is passed, UniqSubnetId must be passed.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_ro_instance_ip#uniq_vpc_id MysqlRoInstanceIp#uniq_vpc_id}
  */
  readonly uniqVpcId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_ro_instance_ip tencentcloud_mysql_ro_instance_ip}
*/
export class MysqlRoInstanceIp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlRoInstanceIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_ro_instance_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/mysql_ro_instance_ip tencentcloud_mysql_ro_instance_ip} Resource
  *
  * @param scope The scope in which to define this construct
