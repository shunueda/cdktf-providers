// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/antiddos_list_listener
...
export interface DataTencentcloudAntiddosListListenerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/antiddos_list_listener#id DataTencentcloudAntiddosListListener#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/antiddos_list_listener#result_output_file DataTencentcloudAntiddosListListener#result_output_file}
  */
...
export class DataTencentcloudAntiddosListListener extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudAntiddosListListener that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/antiddos_list_listener#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.49/docs/data-sources/antiddos_list_listener tencentcloud_antiddos_list_listener} Data Source
  *
  * @param scope The scope in which to define this construct
