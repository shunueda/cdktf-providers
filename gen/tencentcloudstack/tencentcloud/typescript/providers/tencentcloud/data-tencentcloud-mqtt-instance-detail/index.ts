// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/mqtt_instance_detail
...
export interface DataTencentcloudMqttInstanceDetailConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/mqtt_instance_detail#id DataTencentcloudMqttInstanceDetail#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/mqtt_instance_detail#instance_id DataTencentcloudMqttInstanceDetail#instance_id}
  */
  readonly instanceId: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/mqtt_instance_detail#result_output_file DataTencentcloudMqttInstanceDetail#result_output_file}
  */
  readonly resultOutputFile?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/mqtt_instance_detail tencentcloud_mqtt_instance_detail}
*/
export class DataTencentcloudMqttInstanceDetail extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudMqttInstanceDetail that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/mqtt_instance_detail#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/data-sources/mqtt_instance_detail tencentcloud_mqtt_instance_detail} Data Source
  *
  * @param scope The scope in which to define this construct
