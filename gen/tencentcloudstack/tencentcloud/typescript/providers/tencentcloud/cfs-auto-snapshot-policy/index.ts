// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_auto_snapshot_policy
...
export interface CfsAutoSnapshotPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_auto_snapshot_policy#alive_days CfsAutoSnapshotPolicy#alive_days}
  */
  readonly aliveDays?: number;
  /**
  * The specific day (day 1 to day 31) of the month on which to create a snapshot.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_auto_snapshot_policy#day_of_month CfsAutoSnapshotPolicy#day_of_month}
  */
  readonly dayOfMonth?: string;
  /**
  * The day of the week on which to repeat the snapshot operation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_auto_snapshot_policy#day_of_week CfsAutoSnapshotPolicy#day_of_week}
  */
  readonly dayOfWeek?: string;
  /**
  * The time point when to repeat the snapshot operation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_auto_snapshot_policy#hour CfsAutoSnapshotPolicy#hour}
  */
  readonly hour: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_auto_snapshot_policy#id CfsAutoSnapshotPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_auto_snapshot_policy#interval_days CfsAutoSnapshotPolicy#interval_days}
  */
  readonly intervalDays?: number;
  /**
  * Policy name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_auto_snapshot_policy#policy_name CfsAutoSnapshotPolicy#policy_name}
  */
  readonly policyName?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_auto_snapshot_policy tencentcloud_cfs_auto_snapshot_policy}
*/
export class CfsAutoSnapshotPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CfsAutoSnapshotPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_auto_snapshot_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cfs_auto_snapshot_policy tencentcloud_cfs_auto_snapshot_policy} Resource
  *
  * @param scope The scope in which to define this construct
