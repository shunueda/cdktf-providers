// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule
...
export interface SgRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule#enable SgRule#enable}
  */
  readonly enable?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule#id SgRule#id}
  *
  ...
  * data block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule#data SgRule#data}
  */
...
export interface SgRuleData {
  ...
  * Description.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule#description SgRule#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule#dest_content SgRule#dest_content}
  */
  readonly destContent: string;
  /**
  * Access destination type. Valid values: net|template|instance|resourcegroup|tag|region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule#dest_type SgRule#dest_type}
  */
  readonly destType: string;
  /**
  * The port to apply access control rules. Valid values: `-1/-1`: all ports, `80`: port 80.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule#port SgRule#port}
  */
  readonly port?: string;
  /**
  * Protocol. TCP/UDP/ICMP/ANY.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule#protocol SgRule#protocol}
  */
  readonly protocol?: string;
  /**
  * The action that Cloud Firewall performs on the traffic. Valid values: `accept`: allow, `drop`: deny.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule#rule_action SgRule#rule_action}
  */
  readonly ruleAction: string;
  /**
  * Parameter template ID of port and protocol type; mutually exclusive with Protocol and Port.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule#service_template_id SgRule#service_template_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule#source_content SgRule#source_content}
  */
  readonly sourceContent: string;
  /**
  * Access source type. Valid values: net|template|instance|resourcegroup|tag|region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule#source_type SgRule#source_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule tencentcloud_sg_rule}
*/
export class SgRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SgRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.39/docs/resources/sg_rule tencentcloud_sg_rule} Resource
  *
  * @param scope The scope in which to define this construct
