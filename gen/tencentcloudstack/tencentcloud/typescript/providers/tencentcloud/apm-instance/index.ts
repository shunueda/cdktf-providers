// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/apm_instance
...
export interface ApmInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/apm_instance#description ApmInstance#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/apm_instance#id ApmInstance#id}
  *
  ...
  * Name Of Instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/apm_instance#name ApmInstance#name}
  */
  readonly name: string;
  /**
  * Modify the billing mode: `1` means prepaid, `0` means pay-as-you-go, the default value is `0`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/apm_instance#pay_mode ApmInstance#pay_mode}
  */
  readonly payMode?: number;
  /**
  * Quota Of Instance Reporting.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/apm_instance#span_daily_counters ApmInstance#span_daily_counters}
  */
  readonly spanDailyCounters?: number;
  /**
  * Tag description list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/apm_instance#tags ApmInstance#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * Duration Of Trace Data.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/apm_instance#trace_duration ApmInstance#trace_duration}
  */
  readonly traceDuration?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/apm_instance tencentcloud_apm_instance}
*/
export class ApmInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApmInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/apm_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/apm_instance tencentcloud_apm_instance} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // trace_duration - computed: false, optional: true, required: false
