// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/rum_offline_log_config_attachment
...
export interface RumOfflineLogConfigAttachmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/rum_offline_log_config_attachment#id RumOfflineLogConfigAttachment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/rum_offline_log_config_attachment#project_key RumOfflineLogConfigAttachment#project_key}
  */
  readonly projectKey: string;
  /**
  * Unique identifier of the user to be listened on(aid or uin).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/rum_offline_log_config_attachment#unique_id RumOfflineLogConfigAttachment#unique_id}
  */
  readonly uniqueId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/rum_offline_log_config_attachment tencentcloud_rum_offline_log_config_attachment}
*/
export class RumOfflineLogConfigAttachment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RumOfflineLogConfigAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/rum_offline_log_config_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/rum_offline_log_config_attachment tencentcloud_rum_offline_log_config_attachment} Resource
  *
  * @param scope The scope in which to define this construct
