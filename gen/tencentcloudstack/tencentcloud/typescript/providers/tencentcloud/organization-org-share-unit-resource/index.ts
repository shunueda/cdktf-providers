// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_org_share_unit_resource
...
export interface OrganizationOrgShareUnitResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  * Shared unit area.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_org_share_unit_resource#area OrganizationOrgShareUnitResource#area}
  */
  readonly area: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_org_share_unit_resource#id OrganizationOrgShareUnitResource#id}
  *
  ...
  * Product Resource ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_org_share_unit_resource#product_resource_id OrganizationOrgShareUnitResource#product_resource_id}
  */
  readonly productResourceId: string;
  /**
  * Shared resource type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_org_share_unit_resource#type OrganizationOrgShareUnitResource#type}
  */
  readonly type: string;
  /**
  * Shared unit ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_org_share_unit_resource#unit_id OrganizationOrgShareUnitResource#unit_id}
  */
  readonly unitId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_org_share_unit_resource tencentcloud_organization_org_share_unit_resource}
*/
export class OrganizationOrgShareUnitResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationOrgShareUnitResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_org_share_unit_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/organization_org_share_unit_resource tencentcloud_organization_org_share_unit_resource} Resource
  *
  * @param scope The scope in which to define this construct
