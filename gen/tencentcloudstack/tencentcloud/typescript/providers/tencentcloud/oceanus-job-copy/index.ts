// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/oceanus_job_copy
...
export interface OceanusJobCopyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/oceanus_job_copy#id OceanusJobCopy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/oceanus_job_copy#job_type OceanusJobCopy#job_type}
  */
  readonly jobType?: number;
  /**
  * The serial ID of the job to be copied.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/oceanus_job_copy#source_id OceanusJobCopy#source_id}
  */
  readonly sourceId: string;
  /**
  * The name of the job to be copied.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/oceanus_job_copy#source_name OceanusJobCopy#source_name}
  */
  readonly sourceName?: string;
  /**
  * The cluster serial ID of the target cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/oceanus_job_copy#target_cluster_id OceanusJobCopy#target_cluster_id}
  */
  readonly targetClusterId: string;
  /**
  * The directory ID of the new job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/oceanus_job_copy#target_folder_id OceanusJobCopy#target_folder_id}
  */
  readonly targetFolderId?: string;
  /**
  * The name of the new job.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/oceanus_job_copy#target_name OceanusJobCopy#target_name}
  */
  readonly targetName?: string;
  /**
  * Workspace SerialId.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/oceanus_job_copy#work_space_id OceanusJobCopy#work_space_id}
  */
  readonly workSpaceId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/oceanus_job_copy tencentcloud_oceanus_job_copy}
*/
export class OceanusJobCopy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OceanusJobCopy that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/oceanus_job_copy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.41/docs/resources/oceanus_job_copy tencentcloud_oceanus_job_copy} Resource
  *
  * @param scope The scope in which to define this construct
