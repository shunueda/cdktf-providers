// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/vpc_private_ip_addresses
...
export interface DataTencentcloudVpcPrivateIpAddressesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/vpc_private_ip_addresses#id DataTencentcloudVpcPrivateIpAddresses#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/vpc_private_ip_addresses#private_ip_addresses DataTencentcloudVpcPrivateIpAddresses#private_ip_addresses}
  */
  readonly privateIpAddresses: string[];
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/vpc_private_ip_addresses#result_output_file DataTencentcloudVpcPrivateIpAddresses#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * The `ID` of the `VPC`, such as `vpc-f49l6u0z`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/vpc_private_ip_addresses#vpc_id DataTencentcloudVpcPrivateIpAddresses#vpc_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/vpc_private_ip_addresses tencentcloud_vpc_private_ip_addresses}
*/
export class DataTencentcloudVpcPrivateIpAddresses extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudVpcPrivateIpAddresses that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/vpc_private_ip_addresses#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/vpc_private_ip_addresses tencentcloud_vpc_private_ip_addresses} Data Source
  *
  * @param scope The scope in which to define this construct
