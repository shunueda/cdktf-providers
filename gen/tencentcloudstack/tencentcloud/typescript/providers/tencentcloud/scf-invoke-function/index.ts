// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/scf_invoke_function
...
export interface ScfInvokeFunctionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/scf_invoke_function#client_context ScfInvokeFunction#client_context}
  */
  readonly clientContext?: string;
  /**
  * Function name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/scf_invoke_function#function_name ScfInvokeFunction#function_name}
  */
  readonly functionName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/scf_invoke_function#id ScfInvokeFunction#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/scf_invoke_function#invocation_type ScfInvokeFunction#invocation_type}
  */
  readonly invocationType?: string;
  /**
  * Null for async invocations.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/scf_invoke_function#log_type ScfInvokeFunction#log_type}
  */
  readonly logType?: string;
  /**
  * Namespace.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/scf_invoke_function#namespace ScfInvokeFunction#namespace}
  */
  readonly namespace?: string;
  /**
  * The version or alias of the triggered function. It defaults to $LATEST.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/scf_invoke_function#qualifier ScfInvokeFunction#qualifier}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/scf_invoke_function#routing_key ScfInvokeFunction#routing_key}
  */
  readonly routingKey?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/scf_invoke_function tencentcloud_scf_invoke_function}
*/
export class ScfInvokeFunction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ScfInvokeFunction that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/scf_invoke_function#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.42/docs/resources/scf_invoke_function tencentcloud_scf_invoke_function} Resource
  *
  * @param scope The scope in which to define this construct
