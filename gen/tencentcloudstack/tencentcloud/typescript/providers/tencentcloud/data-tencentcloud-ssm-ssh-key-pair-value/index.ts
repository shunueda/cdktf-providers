// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/ssm_ssh_key_pair_value
...
export interface DataTencentcloudSsmSshKeyPairValueConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/ssm_ssh_key_pair_value#id DataTencentcloudSsmSshKeyPairValue#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/ssm_ssh_key_pair_value#result_output_file DataTencentcloudSsmSshKeyPairValue#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Secret name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/ssm_ssh_key_pair_value#secret_name DataTencentcloudSsmSshKeyPairValue#secret_name}
  */
  readonly secretName?: string;
  /**
  * The key pair ID is the unique identifier of the key pair in the cloud server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/ssm_ssh_key_pair_value#ssh_key_id DataTencentcloudSsmSshKeyPairValue#ssh_key_id}
  */
  readonly sshKeyId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/ssm_ssh_key_pair_value tencentcloud_ssm_ssh_key_pair_value}
*/
export class DataTencentcloudSsmSshKeyPairValue extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudSsmSshKeyPairValue that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/ssm_ssh_key_pair_value#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/data-sources/ssm_ssh_key_pair_value tencentcloud_ssm_ssh_key_pair_value} Data Source
  *
  * @param scope The scope in which to define this construct
