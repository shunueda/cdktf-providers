// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dlc_suspend_resume_data_engine
...
export interface DlcSuspendResumeDataEngineConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dlc_suspend_resume_data_engine#data_engine_name DlcSuspendResumeDataEngine#data_engine_name}
  */
  readonly dataEngineName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dlc_suspend_resume_data_engine#id DlcSuspendResumeDataEngine#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dlc_suspend_resume_data_engine#operate DlcSuspendResumeDataEngine#operate}
  */
  readonly operate: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dlc_suspend_resume_data_engine tencentcloud_dlc_suspend_resume_data_engine}
*/
export class DlcSuspendResumeDataEngine extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DlcSuspendResumeDataEngine that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dlc_suspend_resume_data_engine#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/dlc_suspend_resume_data_engine tencentcloud_dlc_suspend_resume_data_engine} Resource
  *
  * @param scope The scope in which to define this construct
