// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/css_callback_template
...
export interface CssCallbackTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/css_callback_template#callback_key CssCallbackTemplate#callback_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/css_callback_template#description CssCallbackTemplate#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/css_callback_template#id CssCallbackTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/css_callback_template#porn_censorship_notify_url CssCallbackTemplate#porn_censorship_notify_url}
  */
  readonly pornCensorshipNotifyUrl?: string;
  /**
  * Streaming Exception Callback URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/css_callback_template#push_exception_notify_url CssCallbackTemplate#push_exception_notify_url}
  */
  readonly pushExceptionNotifyUrl?: string;
  /**
  * Recording callback URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/css_callback_template#record_notify_url CssCallbackTemplate#record_notify_url}
  */
  readonly recordNotifyUrl?: string;
  /**
  * Snapshot callback URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/css_callback_template#snapshot_notify_url CssCallbackTemplate#snapshot_notify_url}
  */
  readonly snapshotNotifyUrl?: string;
  /**
  * Launch callback URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/css_callback_template#stream_begin_notify_url CssCallbackTemplate#stream_begin_notify_url}
  */
  readonly streamBeginNotifyUrl?: string;
  /**
  * Cutoff callback URL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/css_callback_template#stream_end_notify_url CssCallbackTemplate#stream_end_notify_url}
  */
  readonly streamEndNotifyUrl?: string;
  /**
  * Template name.Maximum length: 255 bytes. Only `Chinese`, `English`, `numbers`, `_`, `-` are supported.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/css_callback_template#template_name CssCallbackTemplate#template_name}
  */
  readonly templateName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/css_callback_template tencentcloud_css_callback_template}
*/
export class CssCallbackTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CssCallbackTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/css_callback_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/css_callback_template tencentcloud_css_callback_template} Resource
  *
  * @param scope The scope in which to define this construct
