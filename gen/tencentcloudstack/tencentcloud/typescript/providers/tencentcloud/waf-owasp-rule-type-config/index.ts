// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_owasp_rule_type_config
...
export interface WafOwaspRuleTypeConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  * Domain name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_owasp_rule_type_config#domain WafOwaspRuleTypeConfig#domain}
  */
  readonly domain: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_owasp_rule_type_config#id WafOwaspRuleTypeConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_owasp_rule_type_config#rule_type_action WafOwaspRuleTypeConfig#rule_type_action}
  */
  readonly ruleTypeAction?: number;
  /**
  * Protection level of the rule. valid values: 100 (loose), 200 (normal), 300 (strict), 400 (ultra-strict).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_owasp_rule_type_config#rule_type_level WafOwaspRuleTypeConfig#rule_type_level}
  */
  readonly ruleTypeLevel?: number;
  /**
  * The switch status of the rule type. valid values: 0 (disabled), 1 (enabled).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_owasp_rule_type_config#rule_type_status WafOwaspRuleTypeConfig#rule_type_status}
  */
  readonly ruleTypeStatus?: number;
  /**
  * Rule type ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_owasp_rule_type_config#type_id WafOwaspRuleTypeConfig#type_id}
  */
  readonly typeId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_owasp_rule_type_config tencentcloud_waf_owasp_rule_type_config}
*/
export class WafOwaspRuleTypeConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WafOwaspRuleTypeConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_owasp_rule_type_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/waf_owasp_rule_type_config tencentcloud_waf_owasp_rule_type_config} Resource
  *
  * @param scope The scope in which to define this construct
