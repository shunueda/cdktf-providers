// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_route
...
export interface CkafkaRouteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_route#access_type CkafkaRoute#access_type}
  */
  readonly accessType?: number;
  /**
  * Auth flag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_route#auth_flag CkafkaRoute#auth_flag}
  */
  readonly authFlag?: number;
  /**
  * Caller appid.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_route#caller_appid CkafkaRoute#caller_appid}
  */
  readonly callerAppid?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_route#id CkafkaRoute#id}
  *
  ...
  * Instance id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_route#instance_id CkafkaRoute#instance_id}
  */
  readonly instanceId: string;
  /**
  * Ip.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_route#ip CkafkaRoute#ip}
  */
  readonly ip?: string;
  /**
  * Public network.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_route#public_network CkafkaRoute#public_network}
  */
  readonly publicNetwork?: number;
  /**
  * Subnet id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_route#subnet_id CkafkaRoute#subnet_id}
  */
  readonly subnetId?: string;
  /**
  * Routing network type (3:vpc routing; 4: standard support routing; 7: professional support routing).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_route#vip_type CkafkaRoute#vip_type}
  */
  readonly vipType: number;
  /**
  * Vpc id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_route#vpc_id CkafkaRoute#vpc_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_route tencentcloud_ckafka_route}
*/
export class CkafkaRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CkafkaRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.35/docs/resources/ckafka_route tencentcloud_ckafka_route} Resource
  *
  * @param scope The scope in which to define this construct
