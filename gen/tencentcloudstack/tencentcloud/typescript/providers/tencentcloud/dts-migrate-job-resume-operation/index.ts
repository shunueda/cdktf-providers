// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dts_migrate_job_resume_operation
...
export interface DtsMigrateJobResumeOperationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dts_migrate_job_resume_operation#id DtsMigrateJobResumeOperation#id}
  *
  ...
  * job id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dts_migrate_job_resume_operation#job_id DtsMigrateJobResumeOperation#job_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dts_migrate_job_resume_operation#resume_option DtsMigrateJobResumeOperation#resume_option}
  */
  readonly resumeOption: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dts_migrate_job_resume_operation tencentcloud_dts_migrate_job_resume_operation}
*/
export class DtsMigrateJobResumeOperation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DtsMigrateJobResumeOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dts_migrate_job_resume_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.37/docs/resources/dts_migrate_job_resume_operation tencentcloud_dts_migrate_job_resume_operation} Resource
  *
  * @param scope The scope in which to define this construct
