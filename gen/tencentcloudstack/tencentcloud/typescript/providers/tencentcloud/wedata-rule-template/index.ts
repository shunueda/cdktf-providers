// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template
...
export interface WedataRuleTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template#description WedataRuleTemplate#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template#id WedataRuleTemplate#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template#multi_source_flag WedataRuleTemplate#multi_source_flag}
  */
  readonly multiSourceFlag?: boolean | cdktf.IResolvable;
  /**
  * Template name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template#name WedataRuleTemplate#name}
  */
  readonly name?: string;
  /**
  * Project ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template#project_id WedataRuleTemplate#project_id}
  */
  readonly projectId: string;
  /**
  * Quality inspection dimensions. `1`: Accuracy, `2`: Uniqueness, `3`: Completeness, `4`: Consistency, `5`: Timeliness, `6`: Effectiveness.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template#quality_dim WedataRuleTemplate#quality_dim}
  */
  readonly qualityDim?: number;
  /**
  * The engine type corresponding to the source. `2`: hive,`4`: spark, `16`: dlc.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template#source_engine_types WedataRuleTemplate#source_engine_types}
  */
  readonly sourceEngineTypes?: number[];
  /**
  * Source data object type. `1`: Constant, `2`: Offline table level, `3`: Offline field level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template#source_object_type WedataRuleTemplate#source_object_type}
  */
  readonly sourceObjectType?: number;
  /**
  * SQL Expression.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template#sql_expression WedataRuleTemplate#sql_expression}
  */
  readonly sqlExpression?: string;
  /**
  * Template type. `1` means System template, `2` means Custom template.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template#type WedataRuleTemplate#type}
  */
  readonly type?: number;
  /**
  * If add where.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template#where_flag WedataRuleTemplate#where_flag}
  */
  readonly whereFlag?: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template tencentcloud_wedata_rule_template}
*/
export class WedataRuleTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WedataRuleTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.38/docs/resources/wedata_rule_template tencentcloud_wedata_rule_template} Resource
  *
  * @param scope The scope in which to define this construct
