// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/dbbrain_slow_log_time_series_stats
...
export interface DataTencentcloudDbbrainSlowLogTimeSeriesStatsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/dbbrain_slow_log_time_series_stats#end_time DataTencentcloudDbbrainSlowLogTimeSeriesStats#end_time}
  */
  readonly endTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/dbbrain_slow_log_time_series_stats#id DataTencentcloudDbbrainSlowLogTimeSeriesStats#id}
  *
  ...
  * Instance ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/dbbrain_slow_log_time_series_stats#instance_id DataTencentcloudDbbrainSlowLogTimeSeriesStats#instance_id}
  */
  readonly instanceId: string;
  /**
  * Service product type, supported values include: `mysql` - cloud database MySQL, `cynosdb` - cloud database CynosDB for MySQL, the default is `mysql`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/dbbrain_slow_log_time_series_stats#product DataTencentcloudDbbrainSlowLogTimeSeriesStats#product}
  */
  readonly product?: string;
  /**
  * Used to save results.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/dbbrain_slow_log_time_series_stats#result_output_file DataTencentcloudDbbrainSlowLogTimeSeriesStats#result_output_file}
  */
  readonly resultOutputFile?: string;
  /**
  * Start time, such as `2019-09-10 12:13:14`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/dbbrain_slow_log_time_series_stats#start_time DataTencentcloudDbbrainSlowLogTimeSeriesStats#start_time}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/dbbrain_slow_log_time_series_stats tencentcloud_dbbrain_slow_log_time_series_stats}
*/
export class DataTencentcloudDbbrainSlowLogTimeSeriesStats extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataTencentcloudDbbrainSlowLogTimeSeriesStats that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/dbbrain_slow_log_time_series_stats#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.43/docs/data-sources/dbbrain_slow_log_time_series_stats tencentcloud_dbbrain_slow_log_time_series_stats} Data Source
  *
  * @param scope The scope in which to define this construct
