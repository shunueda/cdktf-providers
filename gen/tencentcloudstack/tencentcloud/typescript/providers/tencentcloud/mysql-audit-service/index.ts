// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_audit_service
...
export interface MysqlAuditServiceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_audit_service#audit_all MysqlAuditService#audit_all}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_audit_service#high_log_expire_day MysqlAuditService#high_log_expire_day}
  */
  readonly highLogExpireDay?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_audit_service#id MysqlAuditService#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_audit_service#instance_id MysqlAuditService#instance_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_audit_service#log_expire_day MysqlAuditService#log_expire_day}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_audit_service#rule_template_ids MysqlAuditService#rule_template_ids}
  */
  readonly ruleTemplateIds?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_audit_service tencentcloud_mysql_audit_service}
*/
export class MysqlAuditService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlAuditService that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_audit_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.44/docs/resources/mysql_audit_service tencentcloud_mysql_audit_service} Resource
  *
  * @param scope The scope in which to define this construct
