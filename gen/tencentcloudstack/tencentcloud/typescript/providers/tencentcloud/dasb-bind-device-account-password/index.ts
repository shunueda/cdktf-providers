// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dasb_bind_device_account_password
...
export interface DasbBindDeviceAccountPasswordConfig extends cdktf.TerraformMetaArguments {
  ...
  * Host account ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dasb_bind_device_account_password#device_account_id DasbBindDeviceAccountPassword#device_account_id}
  */
  readonly deviceAccountId: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dasb_bind_device_account_password#id DasbBindDeviceAccountPassword#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dasb_bind_device_account_password#password DasbBindDeviceAccountPassword#password}
  */
  readonly password: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dasb_bind_device_account_password tencentcloud_dasb_bind_device_account_password}
*/
export class DasbBindDeviceAccountPassword extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DasbBindDeviceAccountPassword that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dasb_bind_device_account_password#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.47/docs/resources/dasb_bind_device_account_password tencentcloud_dasb_bind_device_account_password} Resource
  *
  * @param scope The scope in which to define this construct
