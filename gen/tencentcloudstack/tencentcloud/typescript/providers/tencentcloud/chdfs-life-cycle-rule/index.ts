// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/chdfs_life_cycle_rule
...
export interface ChdfsLifeCycleRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  * file system id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/chdfs_life_cycle_rule#file_system_id ChdfsLifeCycleRule#file_system_id}
  */
  readonly fileSystemId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/chdfs_life_cycle_rule#id ChdfsLifeCycleRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/chdfs_life_cycle_rule#life_cycle_rule ChdfsLifeCycleRule#life_cycle_rule}
  */
...
export interface ChdfsLifeCycleRuleLifeCycleRuleTransitions {
  ...
  * trigger days(n day).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/chdfs_life_cycle_rule#days ChdfsLifeCycleRule#days}
  */
  readonly days: number;
  /**
  * transition type, 1: archive, 2: delete, 3: low rate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/chdfs_life_cycle_rule#type ChdfsLifeCycleRule#type}
  */
...
export interface ChdfsLifeCycleRuleLifeCycleRule {
  ...
  * rule name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/chdfs_life_cycle_rule#life_cycle_rule_name ChdfsLifeCycleRule#life_cycle_rule_name}
  */
  readonly lifeCycleRuleName?: string;
  /**
  * rule op path.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/chdfs_life_cycle_rule#path ChdfsLifeCycleRule#path}
  */
  readonly path?: string;
  /**
  * rule status, 1:open, 2:close.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/chdfs_life_cycle_rule#status ChdfsLifeCycleRule#status}
  */
  readonly status?: number;
  /**
  * transitions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/chdfs_life_cycle_rule#transitions ChdfsLifeCycleRule#transitions}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/chdfs_life_cycle_rule tencentcloud_chdfs_life_cycle_rule}
*/
export class ChdfsLifeCycleRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChdfsLifeCycleRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/chdfs_life_cycle_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.36/docs/resources/chdfs_life_cycle_rule tencentcloud_chdfs_life_cycle_rule} Resource
  *
  * @param scope The scope in which to define this construct
