// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_disk_backup
...
export interface CbsDiskBackupConfig extends cdktf.TerraformMetaArguments {
  ...
  * Backup point name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_disk_backup#disk_backup_name CbsDiskBackup#disk_backup_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_disk_backup#disk_id CbsDiskBackup#disk_id}
  */
  readonly diskId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_disk_backup#id CbsDiskBackup#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_disk_backup tencentcloud_cbs_disk_backup}
*/
export class CbsDiskBackup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CbsDiskBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_disk_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/cbs_disk_backup tencentcloud_cbs_disk_backup} Resource
  *
  * @param scope The scope in which to define this construct
