// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule
...
export interface TeoApplicationProxyRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule#forward_client_ip TeoApplicationProxyRule#forward_client_ip}
  */
  readonly forwardClientIp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule#id TeoApplicationProxyRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule#origin_port TeoApplicationProxyRule#origin_port}
  */
  readonly originPort: string;
  /**
  * Origin server type. Valid values: `custom`: Specified origins; `origins`: An origin group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule#origin_type TeoApplicationProxyRule#origin_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule#origin_value TeoApplicationProxyRule#origin_value}
  */
  readonly originValue: string[];
  /**
  * Valid values: `80` means port 80; `81-90` means port range 81-90.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule#port TeoApplicationProxyRule#port}
  */
  readonly port: string[];
  /**
  * Protocol. Valid values: `TCP`, `UDP`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule#proto TeoApplicationProxyRule#proto}
  */
  readonly proto: string;
  /**
  * Proxy ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule#proxy_id TeoApplicationProxyRule#proxy_id}
  */
  readonly proxyId: string;
  /**
  * Specifies whether to enable session persistence. Default value is false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule#session_persist TeoApplicationProxyRule#session_persist}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule#status TeoApplicationProxyRule#status}
  */
  readonly status?: string;
  /**
  * Site ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule#zone_id TeoApplicationProxyRule#zone_id}
  */
  readonly zoneId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule tencentcloud_teo_application_proxy_rule}
*/
export class TeoApplicationProxyRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeoApplicationProxyRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.45/docs/resources/teo_application_proxy_rule tencentcloud_teo_application_proxy_rule} Resource
  *
  * @param scope The scope in which to define this construct
