// https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor
...
export interface IgtmMonitorConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#check_interval IgtmMonitor#check_interval}
  */
  readonly checkInterval: number;
  /**
  * Detection protocol, optional values `PING`, `TCP`, `HTTP`, `HTTPS`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#check_protocol IgtmMonitor#check_protocol}
  */
  readonly checkProtocol: string;
  /**
  * Continuous period count, optional values 1-5.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#continue_period IgtmMonitor#continue_period}
  */
  readonly continuePeriod?: number;
  /**
  * Detector group ID list separated by commas.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#detector_group_ids IgtmMonitor#detector_group_ids}
  */
  readonly detectorGroupIds: number[];
  /**
  * Monitoring node type, optional values AUTO INTERNAL OVERSEAS IPV6 ALL.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#detector_style IgtmMonitor#detector_style}
  */
  readonly detectorStyle: string;
  /**
  * Follow 3XX redirect, DISABLED for disabled, ENABLED for enabled, default disabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#enable_redirect IgtmMonitor#enable_redirect}
  */
  readonly enableRedirect?: string;
  /**
  * Enable SNI, DISABLED for disabled, ENABLED for enabled, default disabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#enable_sni IgtmMonitor#enable_sni}
  */
  readonly enableSni?: string;
  /**
  * Failure rate, values 20 30 40 50 60 70 80 100, default value 50.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#fail_rate IgtmMonitor#fail_rate}
  */
  readonly failRate: number;
  /**
  * Retry count, optional values 0, 1, 2.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#fail_times IgtmMonitor#fail_times}
  */
  readonly failTimes: number;
  /**
  * Host setting, default is business domain name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#host IgtmMonitor#host}
  */
  readonly host?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#id IgtmMonitor#id}
  *
  ...
  * Monitor name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#monitor_name IgtmMonitor#monitor_name}
  */
  readonly monitorName: string;
  /**
  * Packet loss rate alarm threshold, required when CheckProtocol=ping, values 10 30 50 80 90 100.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#packet_loss_rate IgtmMonitor#packet_loss_rate}
  */
  readonly packetLossRate?: number;
  /**
  * URL path, default is "/".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#path IgtmMonitor#path}
  */
  readonly path?: string;
  /**
  * PING packet count, required when CheckProtocol=ping, optional values 20 50 100.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#ping_num IgtmMonitor#ping_num}
  */
  readonly pingNum?: number;
  /**
  * Return error code threshold, optional values 400 and 500, default value 500.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#return_code_threshold IgtmMonitor#return_code_threshold}
  */
  readonly returnCodeThreshold?: number;
  /**
  * Check port, optional values between 1-65535.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#tcp_port IgtmMonitor#tcp_port}
  */
  readonly tcpPort?: number;
  /**
  * Timeout time, unit seconds, optional values 2 3 5 10.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#timeout IgtmMonitor#timeout}
  */
  readonly timeout: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor tencentcloud_igtm_monitor}
*/
export class IgtmMonitor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IgtmMonitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/tencentcloudstack/tencentcloud/1.82.40/docs/resources/igtm_monitor tencentcloud_igtm_monitor} Resource
  *
  * @param scope The scope in which to define this construct
