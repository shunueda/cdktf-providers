// https://registry.terraform.io/providers/petoju/mysql/3.0.87/docs/resources/rds_config
...
export interface RdsConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/petoju/mysql/3.0.87/docs/resources/rds_config#binlog_retention_hours RdsConfig#binlog_retention_hours}
  */
  readonly binlogRetentionHours?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/petoju/mysql/3.0.87/docs/resources/rds_config#id RdsConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/petoju/mysql/3.0.87/docs/resources/rds_config#replication_target_delay RdsConfig#replication_target_delay}
  */
  readonly replicationTargetDelay?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/petoju/mysql/3.0.87/docs/resources/rds_config mysql_rds_config}
*/
export class RdsConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RdsConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/petoju/mysql/3.0.87/docs/resources/rds_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/petoju/mysql/3.0.87/docs/resources/rds_config mysql_rds_config} Resource
  *
  * @param scope The scope in which to define this construct
