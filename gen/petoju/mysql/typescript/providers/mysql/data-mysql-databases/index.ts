// https://registry.terraform.io/providers/petoju/mysql/3.0.86/docs/data-sources/databases
...
export interface DataMysqlDatabasesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/petoju/mysql/3.0.86/docs/data-sources/databases#id DataMysqlDatabases#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/petoju/mysql/3.0.86/docs/data-sources/databases#pattern DataMysqlDatabases#pattern}
  */
  readonly pattern?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/petoju/mysql/3.0.86/docs/data-sources/databases mysql_databases}
*/
export class DataMysqlDatabases extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataMysqlDatabases that should be imported. Refer to the {@link https://registry.terraform.io/providers/petoju/mysql/3.0.86/docs/data-sources/databases#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/petoju/mysql/3.0.86/docs/data-sources/databases mysql_databases} Data Source
  *
  * @param scope The scope in which to define this construct
