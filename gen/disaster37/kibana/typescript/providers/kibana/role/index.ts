// https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role
...
export interface RoleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#id Role#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#metadata Role#metadata}
  */
  readonly metadata?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#name Role#name}
  */
  readonly name: string;
  /**
  * elasticsearch block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#elasticsearch Role#elasticsearch}
  */
  readonly elasticsearch?: RoleElasticsearch[] | cdktf.IResolvable;
  /**
  * kibana block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#kibana Role#kibana}
  */
  readonly kibana?: RoleKibana;
}
export interface RoleElasticsearchIndices {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#field_security Role#field_security}
  */
  readonly fieldSecurity?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#names Role#names}
  */
  readonly names: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#privileges Role#privileges}
  */
  readonly privileges: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#query Role#query}
  */
...
export interface RoleElasticsearch {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#cluster Role#cluster}
  */
  readonly cluster?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#run_as Role#run_as}
  */
  readonly runAs?: string[];
  /**
  * indices block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#indices Role#indices}
  */
...
export interface RoleKibanaFeatures {
  ...
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#permissions Role#permissions}
  */
...
export interface RoleKibana {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#base Role#base}
  */
  readonly base?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#spaces Role#spaces}
  */
  readonly spaces: string[];
  /**
  * features block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#features Role#features}
  */
  readonly features?: RoleKibanaFeatures[] | cdktf.IResolvable;
}

export function roleKibanaToTerraform(struct?: RoleKibanaOutputReference | RoleKibana): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function roleKibanaToHclTerraform(struct?: RoleKibanaOutputReference | RoleKibana): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class RoleKibanaOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RoleKibana | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: RoleKibana | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role kibana_role}
*/
export class Role extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Role that should be imported. Refer to the {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/disaster37/kibana/8.5.3/docs/resources/role kibana_role} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _kibana = new RoleKibanaOutputReference(this, "kibana");
  public get kibana() {
    return this._kibana;
  }
  public putKibana(value: RoleKibana) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      kibana: roleKibanaToTerraform(this._kibana.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      kibana: {
        value: roleKibanaToHclTerraform(this._kibana.internalValue),
        isBlock: true,
        type: "set",
