// https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/ns_device_profile
...
export interface DataNetscalersdxNsDeviceProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * The ID of this resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/ns_device_profile#id DataNetscalersdxNsDeviceProfile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/ns_device_profile#name DataNetscalersdxNsDeviceProfile#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/ns_device_profile netscalersdx_ns_device_profile}
*/
export class DataNetscalersdxNsDeviceProfile extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataNetscalersdxNsDeviceProfile resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataNetscalersdxNsDeviceProfile to import
  * @param importFromId The id of the existing DataNetscalersdxNsDeviceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/ns_device_profile#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataNetscalersdxNsDeviceProfile to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/ns_device_profile netscalersdx_ns_device_profile} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataNetscalersdxNsDeviceProfileConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataNetscalersdxNsDeviceProfileConfig = {}) {
    super(scope, id, {
