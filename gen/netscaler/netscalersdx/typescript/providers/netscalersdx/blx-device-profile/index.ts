// https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile
...
export interface BlxDeviceProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Profile Name, This is one of the already created Citrix SD-WAN profiles.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#cb_profile_name BlxDeviceProfile#cb_profile_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#host_password BlxDeviceProfile#host_password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#host_username BlxDeviceProfile#host_username}
  */
  readonly hostUsername?: string;
  /**
  * HTTP port to connect to the device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#http_port BlxDeviceProfile#http_port}
  */
  readonly httpPort?: number;
  /**
  * HTTPS port to connect to the device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#https_port BlxDeviceProfile#https_port}
  */
  readonly httpsPort?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#id BlxDeviceProfile#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#max_wait_time_reboot BlxDeviceProfile#max_wait_time_reboot}
  */
  readonly maxWaitTimeReboot?: string;
  /**
  * Profile Name. Minimum length =  1 Maximum length =  128
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#name BlxDeviceProfile#name}
  */
  readonly name: string;
  /**
  * Profile Name, This is one of the already created Citrix ADC profiles.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#ns_profile_name BlxDeviceProfile#ns_profile_name}
  */
  readonly nsProfileName?: string;
  /**
  * Passphrase with which private key is encrypted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#passphrase BlxDeviceProfile#passphrase}
  */
  readonly passphrase?: string;
  /**
  * Instance credentials.Password for this profile. Minimum length =  1 Maximum length =  127
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#password BlxDeviceProfile#password}
  */
  readonly password?: string;
  /**
  * SNMP v3 auth password for this profile. Minimum length =  8 Maximum length =  31
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#snmpauthpassword BlxDeviceProfile#snmpauthpassword}
  */
  readonly snmpauthpassword?: string;
  /**
  * SNMP v3 auth protocol for this profile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#snmpauthprotocol BlxDeviceProfile#snmpauthprotocol}
  */
  readonly snmpauthprotocol?: string;
  /**
  * SNMP community for this profile. Maximum length =  31
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#snmpcommunity BlxDeviceProfile#snmpcommunity}
  */
  readonly snmpcommunity?: string;
  /**
  * SNMP v3 priv password for this profile. Minimum length =  8 Maximum length =  31
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#snmpprivpassword BlxDeviceProfile#snmpprivpassword}
  */
  readonly snmpprivpassword?: string;
  /**
  * SNMP v3 priv protocol for this profile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#snmpprivprotocol BlxDeviceProfile#snmpprivprotocol}
  */
  readonly snmpprivprotocol?: string;
  /**
  * SNMP v3 security level for this profile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#snmpsecuritylevel BlxDeviceProfile#snmpsecuritylevel}
  */
  readonly snmpsecuritylevel?: string;
  /**
  * SNMP v3 security name for this profile. Maximum length =  31
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#snmpsecurityname BlxDeviceProfile#snmpsecurityname}
  */
  readonly snmpsecurityname?: string;
  /**
  * SNMP version for this profile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#snmpversion BlxDeviceProfile#snmpversion}
  */
  readonly snmpversion?: string;
  /**
  * SSH port to connect to the device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#ssh_port BlxDeviceProfile#ssh_port}
  */
  readonly sshPort?: string;
  /**
  * SSL Certificate for certificate based authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#ssl_cert BlxDeviceProfile#ssl_cert}
  */
  readonly sslCert?: string;
  /**
  * SSL Private Key for key based authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#ssl_private_key BlxDeviceProfile#ssl_private_key}
  */
  readonly sslPrivateKey?: string;
  /**
  * Communication protocol (http or https) with Instances. Minimum length =  1 Maximum length =  10
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#svm_ns_comm BlxDeviceProfile#svm_ns_comm}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#type BlxDeviceProfile#type}
  */
  readonly type?: string;
  /**
  * True, if the communication with Instance needs to be global and not device specific.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#use_global_setting_for_communication_with_ns BlxDeviceProfile#use_global_setting_for_communication_with_ns}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#username BlxDeviceProfile#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile netscalersdx_blx_device_profile}
*/
export class BlxDeviceProfile extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a BlxDeviceProfile resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the BlxDeviceProfile to import
  * @param importFromId The id of the existing BlxDeviceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the BlxDeviceProfile to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/blx_device_profile netscalersdx_blx_device_profile} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options BlxDeviceProfileConfig
  */
  public constructor(scope: Construct, id: string, config: BlxDeviceProfileConfig) {
    super(scope, id, {
