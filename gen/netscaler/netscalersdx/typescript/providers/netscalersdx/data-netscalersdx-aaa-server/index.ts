// https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/aaa_server
...
export interface DataNetscalersdxAaaServerConfig extends cdktf.TerraformMetaArguments {
  /**
  * List of external servers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/aaa_server#external_servers DataNetscalersdxAaaServer#external_servers}
  */
  readonly externalServers?: DataNetscalersdxAaaServerExternalServers[] | cdktf.IResolvable;
  /**
  * Enable local fallback authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/aaa_server#fallback_local_authentication DataNetscalersdxAaaServer#fallback_local_authentication}
  */
  readonly fallbackLocalAuthentication?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/aaa_server#id DataNetscalersdxAaaServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/aaa_server#log_ext_group_info DataNetscalersdxAaaServer#log_ext_group_info}
  */
  readonly logExtGroupInfo?: boolean | cdktf.IResolvable;
  /**
  * Name of primary server name. Minimum length =  1 Maximum length =  128
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/aaa_server#primary_server_name DataNetscalersdxAaaServer#primary_server_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/aaa_server#primary_server_type DataNetscalersdxAaaServer#primary_server_type}
  */
  readonly primaryServerType?: string;
}
export interface DataNetscalersdxAaaServerExternalServers {
  /**
  * Name of external server. Minimum length =  1 Maximum length =  128
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/aaa_server#external_server_name DataNetscalersdxAaaServer#external_server_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/aaa_server#external_server_type DataNetscalersdxAaaServer#external_server_type}
  */
  readonly externalServerType: string;
  /**
  * Priority of external server. Minimum value =  2 Maximum value =  
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/aaa_server#priority DataNetscalersdxAaaServer#priority}
  */
  readonly priority: number;
}

export function dataNetscalersdxAaaServerExternalServersToTerraform(struct?: DataNetscalersdxAaaServerExternalServers | cdktf.IResolvable): any {
...
export function dataNetscalersdxAaaServerExternalServersToHclTerraform(struct?: DataNetscalersdxAaaServerExternalServers | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataNetscalersdxAaaServerExternalServersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataNetscalersdxAaaServerExternalServers | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataNetscalersdxAaaServerExternalServers | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataNetscalersdxAaaServerExternalServersList extends cdktf.ComplexList {
  public internalValue? : DataNetscalersdxAaaServerExternalServers[] | cdktf.IResolvable
  ...
  */
  public get(index: number): DataNetscalersdxAaaServerExternalServersOutputReference {
    return new DataNetscalersdxAaaServerExternalServersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}

/**
* Represents a {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/aaa_server netscalersdx_aaa_server}
*/
export class DataNetscalersdxAaaServer extends cdktf.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a DataNetscalersdxAaaServer resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataNetscalersdxAaaServer to import
  * @param importFromId The id of the existing DataNetscalersdxAaaServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/aaa_server#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataNetscalersdxAaaServer to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/data-sources/aaa_server netscalersdx_aaa_server} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataNetscalersdxAaaServerConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataNetscalersdxAaaServerConfig = {}) {
    super(scope, id, {
  ...
  private _externalServers = new DataNetscalersdxAaaServerExternalServersList(this, "external_servers", false);
  public get externalServers() {
    return this._externalServers;
  }
  public putExternalServers(value: DataNetscalersdxAaaServerExternalServers[] | cdktf.IResolvable) {
  ...
  // primary_server_type - computed: true, optional: true, required: false
  ...
  public resetPrimaryServerType() {
    this._primaryServerType = undefined;
  }
  // Temporarily expose input value. Use with caution.
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      external_servers: cdktf.listMapper(dataNetscalersdxAaaServerExternalServersToTerraform, false)(this._externalServers.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      external_servers: {
        value: cdktf.listMapperHcl(dataNetscalersdxAaaServerExternalServersToHclTerraform, false)(this._externalServers.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataNetscalersdxAaaServerExternalServersList",
      },
