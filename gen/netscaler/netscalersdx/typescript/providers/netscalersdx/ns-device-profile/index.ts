// https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile
...
export interface NsDeviceProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Profile Name, This is one of the already created NetScaler SD-WAN profiles.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#cb_profile_name NsDeviceProfile#cb_profile_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#host_password NsDeviceProfile#host_password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#host_username NsDeviceProfile#host_username}
  */
  readonly hostUsername?: string;
  /**
  * HTTP port to connect to the device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#http_port NsDeviceProfile#http_port}
  */
  readonly httpPort?: number;
  /**
  * HTTPS port to connect to the device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#https_port NsDeviceProfile#https_port}
  */
  readonly httpsPort?: number;
  /**
  * Id is system generated key for all the device profiles.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#id NsDeviceProfile#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Max waiting time to reboot NetScaler ADC.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#max_wait_time_reboot NsDeviceProfile#max_wait_time_reboot}
  */
  readonly maxWaitTimeReboot?: string;
  /**
  * Profile Name. Minimum length =  1 Maximum length =  128
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#name NsDeviceProfile#name}
  */
  readonly name: string;
  /**
  * Profile Name, This is one of the already created NetScaler ADC profiles.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#ns_profile_name NsDeviceProfile#ns_profile_name}
  */
  readonly nsProfileName?: string;
  /**
  * Passphrase with which private key is encrypted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#passphrase NsDeviceProfile#passphrase}
  */
  readonly passphrase?: string;
  /**
  * Instance credentials.Password for this profile. Minimum length =  1 Maximum length =  127
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#password NsDeviceProfile#password}
  */
  readonly password: string;
  /**
  * SNMP v3 auth password for this profile. Minimum length =  8 Maximum length =  31
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#snmpauthpassword NsDeviceProfile#snmpauthpassword}
  */
  readonly snmpauthpassword?: string;
  /**
  * SNMP v3 auth protocol for this profile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#snmpauthprotocol NsDeviceProfile#snmpauthprotocol}
  */
  readonly snmpauthprotocol?: string;
  /**
  * SNMP community for this profile. Maximum length =  31
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#snmpcommunity NsDeviceProfile#snmpcommunity}
  */
  readonly snmpcommunity?: string;
  /**
  * SNMP v3 priv password for this profile. Minimum length =  8 Maximum length =  31
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#snmpprivpassword NsDeviceProfile#snmpprivpassword}
  */
  readonly snmpprivpassword?: string;
  /**
  * SNMP v3 priv protocol for this profile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#snmpprivprotocol NsDeviceProfile#snmpprivprotocol}
  */
  readonly snmpprivprotocol?: string;
  /**
  * SNMP v3 security level for this profile. Possible values: ['NoAuthNoPriv', 'AuthNoPriv', 'AuthPriv']
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#snmpsecuritylevel NsDeviceProfile#snmpsecuritylevel}
  */
  readonly snmpsecuritylevel?: string;
  /**
  * SNMP v3 security name for this profile. Maximum length =  31
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#snmpsecurityname NsDeviceProfile#snmpsecurityname}
  */
  readonly snmpsecurityname?: string;
  /**
  * SNMP version for this profile.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#snmpversion NsDeviceProfile#snmpversion}
  */
  readonly snmpversion?: string;
  /**
  * SSH port to connect to the device.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#ssh_port NsDeviceProfile#ssh_port}
  */
  readonly sshPort?: string;
  /**
  * SSL Certificate for certificate based authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#ssl_cert NsDeviceProfile#ssl_cert}
  */
  readonly sslCert?: string;
  /**
  * SSL Private Key for key based authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#ssl_private_key NsDeviceProfile#ssl_private_key}
  */
  readonly sslPrivateKey?: string;
  /**
  * Communication protocol (http or https) with Instances. Minimum length =  1 Maximum length =  10
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#svm_ns_comm NsDeviceProfile#svm_ns_comm}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#type NsDeviceProfile#type}
  */
  readonly type?: string;
  /**
  * True, if the communication with Instance needs to be global and not device specific.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#use_global_setting_for_communication_with_ns NsDeviceProfile#use_global_setting_for_communication_with_ns}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#username NsDeviceProfile#username}
  */
  readonly username: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile netscalersdx_ns_device_profile}
*/
export class NsDeviceProfile extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "netscalersdx_ns_device_profile";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a NsDeviceProfile resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the NsDeviceProfile to import
  * @param importFromId The id of the existing NsDeviceProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the NsDeviceProfile to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "netscalersdx_ns_device_profile", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netscaler/netscalersdx/0.7.2/docs/resources/ns_device_profile netscalersdx_ns_device_profile} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options NsDeviceProfileConfig
  */
  public constructor(scope: Construct, id: string, config: NsDeviceProfileConfig) {
    super(scope, id, {
      terraformResourceType: 'netscalersdx_ns_device_profile',
