// https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/identity_token_auth
...
export interface IdentityTokenAuthConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/identity_token_auth#access_token_max_ttl IdentityTokenAuth#access_token_max_ttl}
  */
  readonly accessTokenMaxTtl?: number;
  /**
  * The maximum number of times that an access token can be used; a value of 0 implies infinite number of uses. Default:0
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/identity_token_auth#access_token_num_uses_limit IdentityTokenAuth#access_token_num_uses_limit}
  */
  readonly accessTokenNumUsesLimit?: number;
  /**
  * A list of IPs or CIDR ranges that access tokens can be used from. You can use 0.0.0.0/0, to allow usage from any network address...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/identity_token_auth#access_token_trusted_ips IdentityTokenAuth#access_token_trusted_ips}
  */
  readonly accessTokenTrustedIps?: IdentityTokenAuthAccessTokenTrustedIps[] | cdktf.IResolvable;
  /**
  * The lifetime for an access token in seconds. This value will be referenced at renewal time. Default: 2592000
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/identity_token_auth#access_token_ttl IdentityTokenAuth#access_token_ttl}
  */
  readonly accessTokenTtl?: number;
  /**
  * The ID of the identity to attach the configuration onto.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/identity_token_auth#identity_id IdentityTokenAuth#identity_id}
  */
  readonly identityId: string;
}
export interface IdentityTokenAuthAccessTokenTrustedIps {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/identity_token_auth#ip_address IdentityTokenAuth#ip_address}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/identity_token_auth infisical_identity_token_auth}
*/
export class IdentityTokenAuth extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityTokenAuth that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/identity_token_auth#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/identity_token_auth infisical_identity_token_auth} Resource
  *
  * @param scope The scope in which to define this construct
