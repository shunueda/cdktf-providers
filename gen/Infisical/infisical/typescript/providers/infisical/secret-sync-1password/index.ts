// https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password
...
export interface SecretSync1PasswordConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#auto_sync_enabled SecretSync1Password#auto_sync_enabled}
  */
  readonly autoSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the 1password Connection to use for syncing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#connection_id SecretSync1Password#connection_id}
  */
  readonly connectionId: string;
  /**
  * An optional description for the 1Password sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#description SecretSync1Password#description}
  */
  readonly description?: string;
  /**
  * The destination configuration for the secret sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#destination_config SecretSync1Password#destination_config}
  */
  readonly destinationConfig: SecretSync1PasswordDestinationConfig;
  /**
  * The slug of the project environment to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#environment SecretSync1Password#environment}
  */
  readonly environment: string;
  /**
  * The name of the 1Password sync to create. Must be slug-friendly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#name SecretSync1Password#name}
  */
  readonly name: string;
  /**
  * The ID of the Infisical project to create the sync in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#project_id SecretSync1Password#project_id}
  */
  readonly projectId: string;
  /**
  * The folder path to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#secret_path SecretSync1Password#secret_path}
  */
  readonly secretPath: string;
  /**
  * Parameters to modify how secrets are synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#sync_options SecretSync1Password#sync_options}
  */
...
export interface SecretSync1PasswordDestinationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#value_label SecretSync1Password#value_label}
  */
  readonly valueLabel?: string;
  /**
  * The ID of the 1Password vault to sync secrets to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#vault_id SecretSync1Password#vault_id}
  */
...
export interface SecretSync1PasswordSyncOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#disable_secret_deletion SecretSync1Password#disable_secret_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#initial_sync_behavior SecretSync1Password#initial_sync_behavior}
  */
  readonly initialSyncBehavior: string;
  /**
  * The format to use for structuring secret keys in the 1Password destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#key_schema SecretSync1Password#key_schema}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password infisical_secret_sync_1password}
*/
export class SecretSync1Password extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretSync1Password that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_1password infisical_secret_sync_1password} Resource
  *
  * @param scope The scope in which to define this construct
