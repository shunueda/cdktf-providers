// https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault
...
export interface SecretSyncAzureKeyVaultConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault#auto_sync_enabled SecretSyncAzureKeyVault#auto_sync_enabled}
  */
  readonly autoSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the azure Connection to use for syncing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault#connection_id SecretSyncAzureKeyVault#connection_id}
  */
  readonly connectionId: string;
  /**
  * An optional description for the Azure Key Vault sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault#description SecretSyncAzureKeyVault#description}
  */
  readonly description?: string;
  /**
  * The destination configuration for the secret sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault#destination_config SecretSyncAzureKeyVault#destination_config}
  */
  readonly destinationConfig: SecretSyncAzureKeyVaultDestinationConfig;
  /**
  * The slug of the project environment to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault#environment SecretSyncAzureKeyVault#environment}
  */
  readonly environment: string;
  /**
  * The name of the Azure Key Vault sync to create. Must be slug-friendly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault#name SecretSyncAzureKeyVault#name}
  */
  readonly name: string;
  /**
  * The ID of the Infisical project to create the sync in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault#project_id SecretSyncAzureKeyVault#project_id}
  */
  readonly projectId: string;
  /**
  * The folder path to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault#secret_path SecretSyncAzureKeyVault#secret_path}
  */
  readonly secretPath: string;
  /**
  * Parameters to modify how secrets are synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault#sync_options SecretSyncAzureKeyVault#sync_options}
  */
...
export interface SecretSyncAzureKeyVaultDestinationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault#vault_base_url SecretSyncAzureKeyVault#vault_base_url}
  */
...
export interface SecretSyncAzureKeyVaultSyncOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault#disable_secret_deletion SecretSyncAzureKeyVault#disable_secret_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault#initial_sync_behavior SecretSyncAzureKeyVault#initial_sync_behavior}
  */
  readonly initialSyncBehavior: string;
  /**
  * The format to use for structuring secret keys in the Azure Key Vault destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault#key_schema SecretSyncAzureKeyVault#key_schema}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault infisical_secret_sync_azure_key_vault}
*/
export class SecretSyncAzureKeyVault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretSyncAzureKeyVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_sync_azure_key_vault infisical_secret_sync_azure_key_vault} Resource
  *
  * @param scope The scope in which to define this construct
