// https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb
...
export interface AppConnectionOracledbConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb#credentials AppConnectionOracledb#credentials}
  */
  readonly credentials: AppConnectionOracledbCredentials;
  /**
  * An optional description for the Oracle Database App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb#description AppConnectionOracledb#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with Oracle Database. Possible values are: username-and-password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb#method AppConnectionOracledb#method}
  */
  readonly method: string;
  /**
  * The name of the Oracle Database App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb#name AppConnectionOracledb#name}
  */
...
export interface AppConnectionOracledbCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb#database AppConnectionOracledb#database}
  */
  readonly database: string;
  /**
  * The hostname of the database server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb#host AppConnectionOracledb#host}
  */
  readonly host: string;
  /**
  * The password to connect to the database with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb#password AppConnectionOracledb#password}
  */
  readonly password: string;
  /**
  * The port number of the database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb#port AppConnectionOracledb#port}
  */
  readonly port?: number;
  /**
  * The SSL certificate to use for connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb#ssl_certificate AppConnectionOracledb#ssl_certificate}
  */
  readonly sslCertificate?: string;
  /**
  * Whether or not to use SSL when connecting to the database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb#ssl_enabled AppConnectionOracledb#ssl_enabled}
  */
  readonly sslEnabled?: boolean | cdktf.IResolvable;
  /**
  * Whether or not to reject unauthorized SSL certificates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb#ssl_reject_unauthorized AppConnectionOracledb#ssl_reject_unauthorized}
  */
  readonly sslRejectUnauthorized?: boolean | cdktf.IResolvable;
  /**
  * The username to connect to the database with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb#username AppConnectionOracledb#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb infisical_app_connection_oracledb}
*/
export class AppConnectionOracledb extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionOracledb that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/app_connection_oracledb infisical_app_connection_oracledb} Resource
  *
  * @param scope The scope in which to define this construct
