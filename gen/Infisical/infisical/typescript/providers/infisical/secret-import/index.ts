// https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_import
...
export interface SecretImportConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_import#environment_slug SecretImport#environment_slug}
  */
  readonly environmentSlug: string;
  /**
  * The path where the secret should be imported
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_import#folder_path SecretImport#folder_path}
  */
  readonly folderPath: string;
  /**
  * The environment slug of the secret import to modify/create
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_import#import_environment_slug SecretImport#import_environment_slug}
  */
  readonly importEnvironmentSlug: string;
  /**
  * The path where the secret should be imported from
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_import#import_folder_path SecretImport#import_folder_path}
  */
  readonly importFolderPath: string;
  /**
  * The is_replication of the secret import to modify/create
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_import#is_replication SecretImport#is_replication}
  */
  readonly isReplication: boolean | cdktf.IResolvable;
  /**
  * The Infisical project ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_import#project_id SecretImport#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_import infisical_secret_import}
*/
export class SecretImport extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretImport that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_import#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_import infisical_secret_import} Resource
  *
  * @param scope The scope in which to define this construct
