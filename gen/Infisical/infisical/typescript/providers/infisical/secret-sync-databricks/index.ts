// https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks
...
export interface SecretSyncDatabricksConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks#auto_sync_enabled SecretSyncDatabricks#auto_sync_enabled}
  */
  readonly autoSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the databricks Connection to use for syncing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks#connection_id SecretSyncDatabricks#connection_id}
  */
  readonly connectionId: string;
  /**
  * An optional description for the Databricks sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks#description SecretSyncDatabricks#description}
  */
  readonly description?: string;
  /**
  * The destination configuration for the secret sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks#destination_config SecretSyncDatabricks#destination_config}
  */
  readonly destinationConfig: SecretSyncDatabricksDestinationConfig;
  /**
  * The slug of the project environment to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks#environment SecretSyncDatabricks#environment}
  */
  readonly environment: string;
  /**
  * The name of the Databricks sync to create. Must be slug-friendly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks#name SecretSyncDatabricks#name}
  */
  readonly name: string;
  /**
  * The ID of the Infisical project to create the sync in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks#project_id SecretSyncDatabricks#project_id}
  */
  readonly projectId: string;
  /**
  * The folder path to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks#secret_path SecretSyncDatabricks#secret_path}
  */
  readonly secretPath: string;
  /**
  * Parameters to modify how secrets are synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks#sync_options SecretSyncDatabricks#sync_options}
  */
...
export interface SecretSyncDatabricksDestinationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks#scope SecretSyncDatabricks#scope}
  */
...
export interface SecretSyncDatabricksSyncOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks#disable_secret_deletion SecretSyncDatabricks#disable_secret_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks#initial_sync_behavior SecretSyncDatabricks#initial_sync_behavior}
  */
  readonly initialSyncBehavior: string;
  /**
  * The format to use for structuring secret keys in the Databricks destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks#key_schema SecretSyncDatabricks#key_schema}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks infisical_secret_sync_databricks}
*/
export class SecretSyncDatabricks extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretSyncDatabricks that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_databricks infisical_secret_sync_databricks} Resource
  *
  * @param scope The scope in which to define this construct
