// https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager
...
export interface SecretSyncAwsSecretsManagerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#auto_sync_enabled SecretSyncAwsSecretsManager#auto_sync_enabled}
  */
  readonly autoSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the aws Connection to use for syncing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#connection_id SecretSyncAwsSecretsManager#connection_id}
  */
  readonly connectionId: string;
  /**
  * An optional description for the AWS Secrets Manager sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#description SecretSyncAwsSecretsManager#description}
  */
  readonly description?: string;
  /**
  * The destination configuration for the secret sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#destination_config SecretSyncAwsSecretsManager#destination_config}
  */
  readonly destinationConfig: SecretSyncAwsSecretsManagerDestinationConfig;
  /**
  * The slug of the project environment to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#environment SecretSyncAwsSecretsManager#environment}
  */
  readonly environment: string;
  /**
  * The name of the AWS Secrets Manager sync to create. Must be slug-friendly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#name SecretSyncAwsSecretsManager#name}
  */
  readonly name: string;
  /**
  * The ID of the Infisical project to create the sync in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#project_id SecretSyncAwsSecretsManager#project_id}
  */
  readonly projectId: string;
  /**
  * The folder path to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#secret_path SecretSyncAwsSecretsManager#secret_path}
  */
  readonly secretPath: string;
  /**
  * Parameters to modify how secrets are synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#sync_options SecretSyncAwsSecretsManager#sync_options}
  */
...
export interface SecretSyncAwsSecretsManagerDestinationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#aws_region SecretSyncAwsSecretsManager#aws_region}
  */
  readonly awsRegion: string;
  /**
  * The name of the AWS secret to map to. This only applies when mapping_behavior is set to 'many-to-one'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#aws_secrets_manager_secret_name SecretSyncAwsSecretsManager#aws_secrets_manager_secret_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#mapping_behavior SecretSyncAwsSecretsManager#mapping_behavior}
  */
...
export interface SecretSyncAwsSecretsManagerSyncOptionsTags {
  ...
  * The key of the tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#key SecretSyncAwsSecretsManager#key}
  */
  readonly key: string;
  /**
  * The value of the tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#value SecretSyncAwsSecretsManager#value}
  */
...
export interface SecretSyncAwsSecretsManagerSyncOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#aws_kms_key_id SecretSyncAwsSecretsManager#aws_kms_key_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#disable_secret_deletion SecretSyncAwsSecretsManager#disable_secret_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#initial_sync_behavior SecretSyncAwsSecretsManager#initial_sync_behavior}
  */
  readonly initialSyncBehavior: string;
  /**
  * The format to use for structuring secret keys in the AWS Secrets Manager destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#key_schema SecretSyncAwsSecretsManager#key_schema}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#sync_secret_metadata_as_tags SecretSyncAwsSecretsManager#sync_secret_metadata_as_tags}
  */
  readonly syncSecretMetadataAsTags?: boolean | cdktf.IResolvable;
  /**
  * The tags to sync to the secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#tags SecretSyncAwsSecretsManager#tags}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager infisical_secret_sync_aws_secrets_manager}
*/
export class SecretSyncAwsSecretsManager extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretSyncAwsSecretsManager that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/secret_sync_aws_secrets_manager infisical_secret_sync_aws_secrets_manager} Resource
  *
  * @param scope The scope in which to define this construct
