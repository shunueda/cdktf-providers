// https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/data-sources/kms_key_public_key
...
export interface DataInfisicalKmsKeyPublicKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/data-sources/kms_key_public_key#key_id DataInfisicalKmsKeyPublicKey#key_id}
  */
  readonly keyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/data-sources/kms_key_public_key infisical_kms_key_public_key}
*/
export class DataInfisicalKmsKeyPublicKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataInfisicalKmsKeyPublicKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/data-sources/kms_key_public_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/data-sources/kms_key_public_key infisical_kms_key_public_key} Data Source
  *
  * @param scope The scope in which to define this construct
