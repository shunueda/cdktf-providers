// https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_gcp
...
export interface AppConnectionGcpConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_gcp#credentials AppConnectionGcp#credentials}
  */
  readonly credentials: AppConnectionGcpCredentials;
  /**
  * An optional description for the GCP App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_gcp#description AppConnectionGcp#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with GCP. Possible values are: service-account-impersonation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_gcp#method AppConnectionGcp#method}
  */
  readonly method: string;
  /**
  * The name of the GCP App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_gcp#name AppConnectionGcp#name}
  */
...
export interface AppConnectionGcpCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_gcp#service_account_email AppConnectionGcp#service_account_email}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_gcp infisical_app_connection_gcp}
*/
export class AppConnectionGcp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionGcp that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_gcp#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_gcp infisical_app_connection_gcp} Resource
  *
  * @param scope The scope in which to define this construct
