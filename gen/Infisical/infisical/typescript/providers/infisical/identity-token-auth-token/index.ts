// https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/identity_token_auth_token
...
export interface IdentityTokenAuthTokenConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/identity_token_auth_token#identity_id IdentityTokenAuthToken#identity_id}
  */
  readonly identityId: string;
  /**
  * The name of the token auth token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/identity_token_auth_token#name IdentityTokenAuthToken#name}
  */
  readonly name?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/identity_token_auth_token infisical_identity_token_auth_token}
*/
export class IdentityTokenAuthToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityTokenAuthToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/identity_token_auth_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/identity_token_auth_token infisical_identity_token_auth_token} Resource
  *
  * @param scope The scope in which to define this construct
