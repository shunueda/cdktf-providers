// https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db
...
export interface DynamicSecretMongoDbConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#configuration DynamicSecretMongoDb#configuration}
  */
  readonly configuration: DynamicSecretMongoDbConfiguration;
  /**
  * The default TTL that will be applied for all the leases.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#default_ttl DynamicSecretMongoDb#default_ttl}
  */
  readonly defaultTtl: string;
  /**
  * The slug of the environment to create the dynamic secret in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#environment_slug DynamicSecretMongoDb#environment_slug}
  */
  readonly environmentSlug: string;
  /**
  * The maximum limit a TTL can be leased or renewed for.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#max_ttl DynamicSecretMongoDb#max_ttl}
  */
  readonly maxTtl?: string;
  /**
  * The metadata associated with this dynamic secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#metadata DynamicSecretMongoDb#metadata}
  */
  readonly metadata?: DynamicSecretMongoDbMetadata[] | cdktf.IResolvable;
  /**
  * The name of the dynamic secret.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#name DynamicSecretMongoDb#name}
  */
  readonly name: string;
  /**
  * The path to create the dynamic secret in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#path DynamicSecretMongoDb#path}
  */
  readonly path: string;
  /**
  * The slug of the project to create dynamic secret in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#project_slug DynamicSecretMongoDb#project_slug}
  */
  readonly projectSlug: string;
  /**
  * The username template of the dynamic secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#username_template DynamicSecretMongoDb#username_template}
  */
...
export interface DynamicSecretMongoDbConfiguration {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#ca DynamicSecretMongoDb#ca}
  */
  readonly ca?: string;
  /**
  * The name of the database to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#database DynamicSecretMongoDb#database}
  */
  readonly database: string;
  /**
  * The host of the database server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#host DynamicSecretMongoDb#host}
  */
  readonly host: string;
  /**
  * The password to use to connect to the database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#password DynamicSecretMongoDb#password}
  */
  readonly password: string;
  /**
  * The port of the database server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#port DynamicSecretMongoDb#port}
  */
  readonly port?: number;
  /**
  * A list of role names to assign to the user. The role names can either be built-in or custom.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#roles DynamicSecretMongoDb#roles}
  */
  readonly roles: string[];
  /**
  * The username to use to connect to the database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#username DynamicSecretMongoDb#username}
  */
...
export interface DynamicSecretMongoDbMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#key DynamicSecretMongoDb#key}
  */
  readonly key: string;
  /**
  * The value of the metadata object
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#value DynamicSecretMongoDb#value}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db infisical_dynamic_secret_mongo_db}
*/
export class DynamicSecretMongoDb extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DynamicSecretMongoDb that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/dynamic_secret_mongo_db infisical_dynamic_secret_mongo_db} Resource
  *
  * @param scope The scope in which to define this construct
