// https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth
...
export interface IdentityOidcAuthConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth#access_token_max_ttl IdentityOidcAuth#access_token_max_ttl}
  */
  readonly accessTokenMaxTtl?: number;
  /**
  * The maximum number of times that an access token can be used; a value of 0 implies infinite number of uses. Default:0
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth#access_token_num_uses_limit IdentityOidcAuth#access_token_num_uses_limit}
  */
  readonly accessTokenNumUsesLimit?: number;
  /**
  * A list of IPs or CIDR ranges that access tokens can be used from. You can use 0.0.0.0/0, to allow usage from any network address...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth#access_token_trusted_ips IdentityOidcAuth#access_token_trusted_ips}
  */
  readonly accessTokenTrustedIps?: IdentityOidcAuthAccessTokenTrustedIps[] | cdktf.IResolvable;
  /**
  * The lifetime for an access token in seconds. This value will be referenced at renewal time. Default: 2592000
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth#access_token_ttl IdentityOidcAuth#access_token_ttl}
  */
  readonly accessTokenTtl?: number;
  /**
  * The comma-separated list of intended recipients.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth#bound_audiences IdentityOidcAuth#bound_audiences}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth#bound_claims IdentityOidcAuth#bound_claims}
  */
  readonly boundClaims?: { [key: string]: string };
  /**
  * The unique identifier of the identity provider issuing the OIDC tokens.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth#bound_issuer IdentityOidcAuth#bound_issuer}
  */
  readonly boundIssuer: string;
  /**
  * The expected principal that is the subject of the JWT.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth#bound_subject IdentityOidcAuth#bound_subject}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth#claim_metadata_mapping IdentityOidcAuth#claim_metadata_mapping}
  */
  readonly claimMetadataMapping?: { [key: string]: string };
  /**
  * The ID of the identity to attach the configuration onto.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth#identity_id IdentityOidcAuth#identity_id}
  */
  readonly identityId: string;
  /**
  * The PEM-encoded CA cert for establishing secure communication with the Identity Provider endpoints
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth#oidc_ca_certificate IdentityOidcAuth#oidc_ca_certificate}
  */
  readonly oidcCaCertificate?: string;
  /**
  * The URL used to retrieve the OpenID Connect configuration from the identity provider.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth#oidc_discovery_url IdentityOidcAuth#oidc_discovery_url}
  */
  readonly oidcDiscoveryUrl: string;
}
export interface IdentityOidcAuthAccessTokenTrustedIps {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth#ip_address IdentityOidcAuth#ip_address}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth infisical_identity_oidc_auth}
*/
export class IdentityOidcAuth extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityOidcAuth that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/identity_oidc_auth infisical_identity_oidc_auth} Resource
  *
  * @param scope The scope in which to define this construct
