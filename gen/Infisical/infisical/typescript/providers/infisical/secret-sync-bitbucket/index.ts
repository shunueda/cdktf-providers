// https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket
...
export interface SecretSyncBitbucketConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#auto_sync_enabled SecretSyncBitbucket#auto_sync_enabled}
  */
  readonly autoSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the bitbucket Connection to use for syncing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#connection_id SecretSyncBitbucket#connection_id}
  */
  readonly connectionId: string;
  /**
  * An optional description for the Bitbucket sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#description SecretSyncBitbucket#description}
  */
  readonly description?: string;
  /**
  * The destination configuration for the secret sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#destination_config SecretSyncBitbucket#destination_config}
  */
  readonly destinationConfig: SecretSyncBitbucketDestinationConfig;
  /**
  * The slug of the project environment to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#environment SecretSyncBitbucket#environment}
  */
  readonly environment: string;
  /**
  * The name of the Bitbucket sync to create. Must be slug-friendly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#name SecretSyncBitbucket#name}
  */
  readonly name: string;
  /**
  * The ID of the Infisical project to create the sync in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#project_id SecretSyncBitbucket#project_id}
  */
  readonly projectId: string;
  /**
  * The folder path to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#secret_path SecretSyncBitbucket#secret_path}
  */
  readonly secretPath: string;
  /**
  * Parameters to modify how secrets are synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#sync_options SecretSyncBitbucket#sync_options}
  */
...
export interface SecretSyncBitbucketDestinationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#environment_id SecretSyncBitbucket#environment_id}
  */
  readonly environmentId?: string;
  /**
  * The Bitbucket repository slug to sync secrets to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#repository_slug SecretSyncBitbucket#repository_slug}
  */
  readonly repositorySlug: string;
  /**
  * The Bitbucket workspace slug.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#workspace_slug SecretSyncBitbucket#workspace_slug}
  */
...
export interface SecretSyncBitbucketSyncOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#disable_secret_deletion SecretSyncBitbucket#disable_secret_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#initial_sync_behavior SecretSyncBitbucket#initial_sync_behavior}
  */
  readonly initialSyncBehavior: string;
  /**
  * The format to use for structuring secret keys in the Bitbucket destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#key_schema SecretSyncBitbucket#key_schema}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket infisical_secret_sync_bitbucket}
*/
export class SecretSyncBitbucket extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretSyncBitbucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_bitbucket infisical_secret_sync_bitbucket} Resource
  *
  * @param scope The scope in which to define this construct
