// https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store
...
export interface SecretSyncAwsParameterStoreConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#auto_sync_enabled SecretSyncAwsParameterStore#auto_sync_enabled}
  */
  readonly autoSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the aws Connection to use for syncing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#connection_id SecretSyncAwsParameterStore#connection_id}
  */
  readonly connectionId: string;
  /**
  * An optional description for the AWS Parameter Store sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#description SecretSyncAwsParameterStore#description}
  */
  readonly description?: string;
  /**
  * The destination configuration for the secret sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#destination_config SecretSyncAwsParameterStore#destination_config}
  */
  readonly destinationConfig: SecretSyncAwsParameterStoreDestinationConfig;
  /**
  * The slug of the project environment to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#environment SecretSyncAwsParameterStore#environment}
  */
  readonly environment: string;
  /**
  * The name of the AWS Parameter Store sync to create. Must be slug-friendly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#name SecretSyncAwsParameterStore#name}
  */
  readonly name: string;
  /**
  * The ID of the Infisical project to create the sync in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#project_id SecretSyncAwsParameterStore#project_id}
  */
  readonly projectId: string;
  /**
  * The folder path to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#secret_path SecretSyncAwsParameterStore#secret_path}
  */
  readonly secretPath: string;
  /**
  * Parameters to modify how secrets are synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#sync_options SecretSyncAwsParameterStore#sync_options}
  */
...
export interface SecretSyncAwsParameterStoreDestinationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#aws_region SecretSyncAwsParameterStore#aws_region}
  */
  readonly awsRegion: string;
  /**
  * The path in the AWS Parameter Store where the secrets will be stored, Example: /example/path/
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#path SecretSyncAwsParameterStore#path}
  */
...
export interface SecretSyncAwsParameterStoreSyncOptionsTags {
  ...
  * The key of the tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#key SecretSyncAwsParameterStore#key}
  */
  readonly key: string;
  /**
  * The value of the tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#value SecretSyncAwsParameterStore#value}
  */
...
export interface SecretSyncAwsParameterStoreSyncOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#aws_kms_key_id SecretSyncAwsParameterStore#aws_kms_key_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#disable_secret_deletion SecretSyncAwsParameterStore#disable_secret_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#initial_sync_behavior SecretSyncAwsParameterStore#initial_sync_behavior}
  */
  readonly initialSyncBehavior: string;
  /**
  * The format to use for structuring secret keys in the AWS Parameter Store destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#key_schema SecretSyncAwsParameterStore#key_schema}
  */
  readonly keySchema?: string;
  /**
  * Whether to sync the secret metadata as tags
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#sync_secret_metadata_as_tags SecretSyncAwsParameterStore#sync_secret_metadata_as_tags}
  */
  readonly syncSecretMetadataAsTags?: boolean | cdktf.IResolvable;
  /**
  * The tags to sync to the secret
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#tags SecretSyncAwsParameterStore#tags}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store infisical_secret_sync_aws_parameter_store}
*/
export class SecretSyncAwsParameterStore extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretSyncAwsParameterStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_aws_parameter_store infisical_secret_sync_aws_parameter_store} Resource
  *
  * @param scope The scope in which to define this construct
