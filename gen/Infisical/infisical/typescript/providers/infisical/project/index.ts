// https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/project
...
export interface ProjectConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/project#audit_log_retention_days Project#audit_log_retention_days}
  */
  readonly auditLogRetentionDays?: number;
  /**
  * The description of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/project#description Project#description}
  */
  readonly description?: string;
  /**
  * Whether the project has delete protection, defaults to false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/project#has_delete_protection Project#has_delete_protection}
  */
  readonly hasDeleteProtection?: boolean | cdktf.IResolvable;
  /**
  * The ID of the KMS secret manager key to use for the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/project#kms_secret_manager_key_id Project#kms_secret_manager_key_id}
  */
  readonly kmsSecretManagerKeyId?: string;
  /**
  * The name of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/project#name Project#name}
  */
  readonly name: string;
  /**
  * Whether to create default environments for the project (dev, staging, prod), defaults to true
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/project#should_create_default_envs Project#should_create_default_envs}
  */
  readonly shouldCreateDefaultEnvs?: boolean | cdktf.IResolvable;
  /**
  * The slug of the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/project#slug Project#slug}
  */
  readonly slug: string;
  /**
  * The name of the template to use for the project
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/project#template_name Project#template_name}
  */
  readonly templateName?: string;
  /**
  * The type of the project. Supported values: secret-manager, kms. Defaults to 'secret-manager'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/project#type Project#type}
  */
  readonly type?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/project infisical_project}
*/
export class Project extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Project that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/project#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/project infisical_project} Resource
  *
  * @param scope The scope in which to define this construct
