// https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab
...
export interface SecretSyncGitlabConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#auto_sync_enabled SecretSyncGitlab#auto_sync_enabled}
  */
  readonly autoSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the gitlab Connection to use for syncing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#connection_id SecretSyncGitlab#connection_id}
  */
  readonly connectionId: string;
  /**
  * An optional description for the GitLab sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#description SecretSyncGitlab#description}
  */
  readonly description?: string;
  /**
  * The destination configuration for the secret sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#destination_config SecretSyncGitlab#destination_config}
  */
  readonly destinationConfig: SecretSyncGitlabDestinationConfig;
  /**
  * The slug of the project environment to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#environment SecretSyncGitlab#environment}
  */
  readonly environment: string;
  /**
  * The name of the GitLab sync to create. Must be slug-friendly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#name SecretSyncGitlab#name}
  */
  readonly name: string;
  /**
  * The ID of the Infisical project to create the sync in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#project_id SecretSyncGitlab#project_id}
  */
  readonly projectId: string;
  /**
  * The folder path to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#secret_path SecretSyncGitlab#secret_path}
  */
  readonly secretPath: string;
  /**
  * Parameters to modify how secrets are synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#sync_options SecretSyncGitlab#sync_options}
  */
...
export interface SecretSyncGitlabDestinationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#group_id SecretSyncGitlab#group_id}
  */
  readonly groupId?: string;
  /**
  * The GitLab Group Name to sync secrets to. Optional when scope is 'group'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#group_name SecretSyncGitlab#group_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#project_name SecretSyncGitlab#project_name}
  */
  readonly projectName?: string;
  /**
  * The GitLab scope that secrets should be synced to. Supported options: 'project', 'group'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#scope SecretSyncGitlab#scope}
  */
  readonly scope: string;
  /**
  * Whether variables should be hidden
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#should_hide_secrets SecretSyncGitlab#should_hide_secrets}
  */
  readonly shouldHideSecrets?: boolean | cdktf.IResolvable;
  /**
  * Whether variables should be masked in logs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#should_mask_secrets SecretSyncGitlab#should_mask_secrets}
  */
  readonly shouldMaskSecrets?: boolean | cdktf.IResolvable;
  /**
  * Whether variables should be protected
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#should_protect_secrets SecretSyncGitlab#should_protect_secrets}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#target_environment SecretSyncGitlab#target_environment}
  */
...
export interface SecretSyncGitlabSyncOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#disable_secret_deletion SecretSyncGitlab#disable_secret_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#initial_sync_behavior SecretSyncGitlab#initial_sync_behavior}
  */
  readonly initialSyncBehavior: string;
  /**
  * The format to use for structuring secret keys in the GitLab destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#key_schema SecretSyncGitlab#key_schema}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab infisical_secret_sync_gitlab}
*/
export class SecretSyncGitlab extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretSyncGitlab that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/secret_sync_gitlab infisical_secret_sync_gitlab} Resource
  *
  * @param scope The scope in which to define this construct
