// https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/identity_azure_auth
...
export interface IdentityAzureAuthConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/identity_azure_auth#access_token_max_ttl IdentityAzureAuth#access_token_max_ttl}
  */
  readonly accessTokenMaxTtl?: number;
  /**
  * The maximum number of times that an access token can be used; a value of 0 implies infinite number of uses. Default:0
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/identity_azure_auth#access_token_num_uses_limit IdentityAzureAuth#access_token_num_uses_limit}
  */
  readonly accessTokenNumUsesLimit?: number;
  /**
  * A list of IPs or CIDR ranges that access tokens can be used from. You can use 0.0.0.0/0, to allow usage from any network address..
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/identity_azure_auth#access_token_trusted_ips IdentityAzureAuth#access_token_trusted_ips}
  */
  readonly accessTokenTrustedIps?: IdentityAzureAuthAccessTokenTrustedIps[] | cdktf.IResolvable;
  /**
  * The lifetime for an access token in seconds. This value will be referenced at renewal time. Default: 2592000
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/identity_azure_auth#access_token_ttl IdentityAzureAuth#access_token_ttl}
  */
  readonly accessTokenTtl?: number;
  /**
  * List of Azure AD service principal IDs that are allowed to authenticate with Infisical
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/identity_azure_auth#allowed_service_principal_ids IdentityAzureAuth#allowed_service_principal_ids}
  */
  readonly allowedServicePrincipalIds?: string[];
  /**
  * The ID of the identity to attach the configuration onto.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/identity_azure_auth#identity_id IdentityAzureAuth#identity_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/identity_azure_auth#resource_url IdentityAzureAuth#resource_url}
  */
  readonly resourceUrl?: string;
  /**
  *  The [tenant ID](https://learn.microsoft.com/en-us/entra/fundamentals/how-to-find-tenant) for the Azure AD organization.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/identity_azure_auth#tenant_id IdentityAzureAuth#tenant_id}
  */
  readonly tenantId: string;
}
export interface IdentityAzureAuthAccessTokenTrustedIps {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/identity_azure_auth#ip_address IdentityAzureAuth#ip_address}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/identity_azure_auth infisical_identity_azure_auth}
*/
export class IdentityAzureAuth extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityAzureAuth that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/identity_azure_auth#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/identity_azure_auth infisical_identity_azure_auth} Resource
  *
  * @param scope The scope in which to define this construct
