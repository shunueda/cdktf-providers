// https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_1password
...
export interface AppConnection1PasswordConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_1password#credentials AppConnection1Password#credentials}
  */
  readonly credentials: AppConnection1PasswordCredentials;
  /**
  * An optional description for the 1Password App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_1password#description AppConnection1Password#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with 1Password. Possible values are: api-token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_1password#method AppConnection1Password#method}
  */
  readonly method: string;
  /**
  * The name of the 1Password App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_1password#name AppConnection1Password#name}
  */
...
export interface AppConnection1PasswordCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_1password#api_token AppConnection1Password#api_token}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_1password#instance_url AppConnection1Password#instance_url}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_1password infisical_app_connection_1password}
*/
export class AppConnection1Password extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnection1Password that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_1password#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_1password infisical_app_connection_1password} Resource
  *
  * @param scope The scope in which to define this construct
