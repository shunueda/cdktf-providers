// https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy
...
export interface SecretApprovalPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy#allow_self_approval SecretApprovalPolicy#allow_self_approval}
  */
  readonly allowSelfApproval?: boolean | cdktf.IResolvable;
  /**
  * The required approvers
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy#approvers SecretApprovalPolicy#approvers}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy#enforcement_level SecretApprovalPolicy#enforcement_level}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy#environment_slug SecretApprovalPolicy#environment_slug}
  */
  readonly environmentSlug?: string;
  /**
  * The environments to apply the secret approval policy to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy#environment_slugs SecretApprovalPolicy#environment_slugs}
  */
  readonly environmentSlugs?: string[];
  /**
  * The name of the secret approval policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy#name SecretApprovalPolicy#name}
  */
  readonly name?: string;
  /**
  * The ID of the project to add the secret approval policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy#project_id SecretApprovalPolicy#project_id}
  */
  readonly projectId: string;
  /**
  * The number of required approvers
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy#required_approvals SecretApprovalPolicy#required_approvals}
  */
  readonly requiredApprovals: number;
  /**
  * The secret path to apply the secret approval policy to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy#secret_path SecretApprovalPolicy#secret_path}
  */
...
export interface SecretApprovalPolicyApprovers {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy#id SecretApprovalPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy#type SecretApprovalPolicy#type}
  */
  readonly type: string;
  /**
  * The username of the approver. By default, this is the email
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy#username SecretApprovalPolicy#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy infisical_secret_approval_policy}
*/
export class SecretApprovalPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretApprovalPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/secret_approval_policy infisical_secret_approval_policy} Resource
  *
  * @param scope The scope in which to define this construct
