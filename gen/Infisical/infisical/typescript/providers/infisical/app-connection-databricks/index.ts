// https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/app_connection_databricks
...
export interface AppConnectionDatabricksConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/app_connection_databricks#credentials AppConnectionDatabricks#credentials}
  */
  readonly credentials: AppConnectionDatabricksCredentials;
  /**
  * An optional description for the Databricks App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/app_connection_databricks#description AppConnectionDatabricks#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with Databricks. Possible values are: service-principal
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/app_connection_databricks#method AppConnectionDatabricks#method}
  */
  readonly method: string;
  /**
  * The name of the Databricks App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/app_connection_databricks#name AppConnectionDatabricks#name}
  */
...
export interface AppConnectionDatabricksCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/app_connection_databricks#client_id AppConnectionDatabricks#client_id}
  */
  readonly clientId: string;
  /**
  * The client secret of the Databricks service principal.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/app_connection_databricks#client_secret AppConnectionDatabricks#client_secret}
  */
  readonly clientSecret: string;
  /**
  * The workspace URL of the Databricks instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/app_connection_databricks#workspace_url AppConnectionDatabricks#workspace_url}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/app_connection_databricks infisical_app_connection_databricks}
*/
export class AppConnectionDatabricks extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionDatabricks that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/app_connection_databricks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/app_connection_databricks infisical_app_connection_databricks} Resource
  *
  * @param scope The scope in which to define this construct
