// https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_supabase
...
export interface AppConnectionSupabaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_supabase#credentials AppConnectionSupabase#credentials}
  */
  readonly credentials: AppConnectionSupabaseCredentials;
  /**
  * An optional description for the Supabase App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_supabase#description AppConnectionSupabase#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with Supabase. Possible values are: access-token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_supabase#method AppConnectionSupabase#method}
  */
  readonly method: string;
  /**
  * The name of the Supabase App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_supabase#name AppConnectionSupabase#name}
  */
...
export interface AppConnectionSupabaseCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_supabase#access_key AppConnectionSupabase#access_key}
  */
  readonly accessKey: string;
  /**
  * The Supabase instance URL (e.g., https://your-domain.com).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_supabase#instance_url AppConnectionSupabase#instance_url}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_supabase infisical_app_connection_supabase}
*/
export class AppConnectionSupabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionSupabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_supabase#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_supabase infisical_app_connection_supabase} Resource
  *
  * @param scope The scope in which to define this construct
