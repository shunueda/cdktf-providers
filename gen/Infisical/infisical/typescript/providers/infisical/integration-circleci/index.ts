// https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/integration_circleci
...
export interface IntegrationCircleciConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/integration_circleci#circleci_org_slug IntegrationCircleci#circleci_org_slug}
  */
  readonly circleciOrgSlug: string;
  /**
  * The project ID of your CircleCI project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/integration_circleci#circleci_project_id IntegrationCircleci#circleci_project_id}
  */
  readonly circleciProjectId: string;
  /**
  * Your personal CircleCI token to authenticate with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/integration_circleci#circleci_token IntegrationCircleci#circleci_token}
  */
  readonly circleciToken: string;
  /**
  * The slug of the environment to sync to CircleCI (prod, dev, staging, etc).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/integration_circleci#environment IntegrationCircleci#environment}
  */
  readonly environment: string;
  /**
  * The ID of your Infisical project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/integration_circleci#project_id IntegrationCircleci#project_id}
  */
  readonly projectId: string;
  /**
  * The secret path in Infisical to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/integration_circleci#secret_path IntegrationCircleci#secret_path}
  */
  readonly secretPath: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/integration_circleci infisical_integration_circleci}
*/
export class IntegrationCircleci extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationCircleci that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/integration_circleci#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/resources/integration_circleci infisical_integration_circleci} Resource
  *
  * @param scope The scope in which to define this construct
