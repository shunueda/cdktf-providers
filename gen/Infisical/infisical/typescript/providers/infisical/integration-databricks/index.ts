// https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/integration_databricks
...
export interface IntegrationDatabricksConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/integration_databricks#databricks_host IntegrationDatabricks#databricks_host}
  */
  readonly databricksHost: string;
  /**
  * The Databricks secret scope. Example: your-secret-scope
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/integration_databricks#databricks_secret_scope IntegrationDatabricks#databricks_secret_scope}
  */
  readonly databricksSecretScope: string;
  /**
  * The Databricks access token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/integration_databricks#databricks_token IntegrationDatabricks#databricks_token}
  */
  readonly databricksToken: string;
  /**
  * The slug of the environment to sync to Databricks (prod, dev, staging, etc).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/integration_databricks#environment IntegrationDatabricks#environment}
  */
  readonly environment: string;
  /**
  * The ID of your Infisical project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/integration_databricks#project_id IntegrationDatabricks#project_id}
  */
  readonly projectId: string;
  /**
  * The secret path in Infisical to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/integration_databricks#secret_path IntegrationDatabricks#secret_path}
  */
  readonly secretPath: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/integration_databricks infisical_integration_databricks}
*/
export class IntegrationDatabricks extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationDatabricks that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/integration_databricks#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/integration_databricks infisical_integration_databricks} Resource
  *
  * @param scope The scope in which to define this construct
