// https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_ldap
...
export interface AppConnectionLdapConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_ldap#credentials AppConnectionLdap#credentials}
  */
  readonly credentials: AppConnectionLdapCredentials;
  /**
  * An optional description for the LDAP App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_ldap#description AppConnectionLdap#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with LDAP. Possible values are: simple-bind
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_ldap#method AppConnectionLdap#method}
  */
  readonly method: string;
  /**
  * The name of the LDAP App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_ldap#name AppConnectionLdap#name}
  */
...
export interface AppConnectionLdapCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_ldap#dn AppConnectionLdap#dn}
  */
  readonly dn: string;
  /**
  * The password to bind with for authentication.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_ldap#password AppConnectionLdap#password}
  */
  readonly password: string;
  /**
  * The LDAP provider (e.g., 'active-directory').
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_ldap#provider AppConnectionLdap#provider}
  */
  readonly provider: string;
  /**
  * The SSL certificate (PEM format) to use for secure connection when using ldaps:// with a self-signed certificate.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_ldap#ssl_certificate AppConnectionLdap#ssl_certificate}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_ldap#ssl_reject_unauthorized AppConnectionLdap#ssl_reject_unauthorized}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_ldap#url AppConnectionLdap#url}
  */
  readonly url: string;
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_ldap infisical_app_connection_ldap}
*/
export class AppConnectionLdap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionLdap that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_ldap#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_ldap infisical_app_connection_ldap} Resource
  *
  * @param scope The scope in which to define this construct
