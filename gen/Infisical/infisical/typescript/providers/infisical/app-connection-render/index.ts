// https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_render
...
export interface AppConnectionRenderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_render#credentials AppConnectionRender#credentials}
  */
  readonly credentials: AppConnectionRenderCredentials;
  /**
  * An optional description for the Render App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_render#description AppConnectionRender#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with Render. Possible values are: api-key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_render#method AppConnectionRender#method}
  */
  readonly method: string;
  /**
  * The name of the Render App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_render#name AppConnectionRender#name}
  */
...
export interface AppConnectionRenderCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_render#api_key AppConnectionRender#api_key}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_render infisical_app_connection_render}
*/
export class AppConnectionRender extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionRender that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_render#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/app_connection_render infisical_app_connection_render} Resource
  *
  * @param scope The scope in which to define this construct
