// https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/app_connection_bitbucket
...
export interface AppConnectionBitbucketConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/app_connection_bitbucket#credentials AppConnectionBitbucket#credentials}
  */
  readonly credentials: AppConnectionBitbucketCredentials;
  /**
  * An optional description for the Bitbucket App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/app_connection_bitbucket#description AppConnectionBitbucket#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with Bitbucket. Possible values are: api-token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/app_connection_bitbucket#method AppConnectionBitbucket#method}
  */
  readonly method: string;
  /**
  * The name of the Bitbucket App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/app_connection_bitbucket#name AppConnectionBitbucket#name}
  */
...
export interface AppConnectionBitbucketCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/app_connection_bitbucket#api_token AppConnectionBitbucket#api_token}
  */
  readonly apiToken: string;
  /**
  * The email address associated with the Bitbucket API token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/app_connection_bitbucket#email AppConnectionBitbucket#email}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/app_connection_bitbucket infisical_app_connection_bitbucket}
*/
export class AppConnectionBitbucket extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionBitbucket that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/app_connection_bitbucket#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/app_connection_bitbucket infisical_app_connection_bitbucket} Resource
  *
  * @param scope The scope in which to define this construct
