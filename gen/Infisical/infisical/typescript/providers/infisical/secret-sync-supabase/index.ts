// https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase
...
export interface SecretSyncSupabaseConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase#auto_sync_enabled SecretSyncSupabase#auto_sync_enabled}
  */
  readonly autoSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the supabase Connection to use for syncing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase#connection_id SecretSyncSupabase#connection_id}
  */
  readonly connectionId: string;
  /**
  * An optional description for the Supabase sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase#description SecretSyncSupabase#description}
  */
  readonly description?: string;
  /**
  * The destination configuration for the secret sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase#destination_config SecretSyncSupabase#destination_config}
  */
  readonly destinationConfig: SecretSyncSupabaseDestinationConfig;
  /**
  * The slug of the project environment to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase#environment SecretSyncSupabase#environment}
  */
  readonly environment: string;
  /**
  * The name of the Supabase sync to create. Must be slug-friendly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase#name SecretSyncSupabase#name}
  */
  readonly name: string;
  /**
  * The ID of the Infisical project to create the sync in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase#project_id SecretSyncSupabase#project_id}
  */
  readonly projectId: string;
  /**
  * The folder path to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase#secret_path SecretSyncSupabase#secret_path}
  */
  readonly secretPath: string;
  /**
  * Parameters to modify how secrets are synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase#sync_options SecretSyncSupabase#sync_options}
  */
...
export interface SecretSyncSupabaseDestinationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase#project_name SecretSyncSupabase#project_name}
  */
...
export interface SecretSyncSupabaseSyncOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase#disable_secret_deletion SecretSyncSupabase#disable_secret_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase#initial_sync_behavior SecretSyncSupabase#initial_sync_behavior}
  */
  readonly initialSyncBehavior: string;
  /**
  * The format to use for structuring secret keys in the Supabase destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase#key_schema SecretSyncSupabase#key_schema}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase infisical_secret_sync_supabase}
*/
export class SecretSyncSupabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretSyncSupabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.46/docs/resources/secret_sync_supabase infisical_secret_sync_supabase} Resource
  *
  * @param scope The scope in which to define this construct
