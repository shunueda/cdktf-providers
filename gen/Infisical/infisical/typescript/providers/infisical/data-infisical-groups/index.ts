// https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/data-sources/groups
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/data-sources/groups infisical_groups}
*/
export class DataInfisicalGroups extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataInfisicalGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/data-sources/groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.45/docs/data-sources/groups infisical_groups} Data Source
  *
  * @param scope The scope in which to define this construct
