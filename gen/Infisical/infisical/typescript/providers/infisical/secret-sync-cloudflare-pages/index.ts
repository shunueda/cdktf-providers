// https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages
...
export interface SecretSyncCloudflarePagesConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages#auto_sync_enabled SecretSyncCloudflarePages#auto_sync_enabled}
  */
  readonly autoSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the cloudflare Connection to use for syncing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages#connection_id SecretSyncCloudflarePages#connection_id}
  */
  readonly connectionId: string;
  /**
  * An optional description for the Cloudflare Pages sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages#description SecretSyncCloudflarePages#description}
  */
  readonly description?: string;
  /**
  * The destination configuration for the secret sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages#destination_config SecretSyncCloudflarePages#destination_config}
  */
  readonly destinationConfig: SecretSyncCloudflarePagesDestinationConfig;
  /**
  * The slug of the project environment to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages#environment SecretSyncCloudflarePages#environment}
  */
  readonly environment: string;
  /**
  * The name of the Cloudflare Pages sync to create. Must be slug-friendly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages#name SecretSyncCloudflarePages#name}
  */
  readonly name: string;
  /**
  * The ID of the Infisical project to create the sync in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages#project_id SecretSyncCloudflarePages#project_id}
  */
  readonly projectId: string;
  /**
  * The folder path to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages#secret_path SecretSyncCloudflarePages#secret_path}
  */
  readonly secretPath: string;
  /**
  * Parameters to modify how secrets are synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages#sync_options SecretSyncCloudflarePages#sync_options}
  */
...
export interface SecretSyncCloudflarePagesDestinationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages#project_name SecretSyncCloudflarePages#project_name}
  */
...
export interface SecretSyncCloudflarePagesSyncOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages#disable_secret_deletion SecretSyncCloudflarePages#disable_secret_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages#initial_sync_behavior SecretSyncCloudflarePages#initial_sync_behavior}
  */
  readonly initialSyncBehavior: string;
  /**
  * The format to use for structuring secret keys in the Cloudflare Pages destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages#key_schema SecretSyncCloudflarePages#key_schema}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages infisical_secret_sync_cloudflare_pages}
*/
export class SecretSyncCloudflarePages extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretSyncCloudflarePages that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/resources/secret_sync_cloudflare_pages infisical_secret_sync_cloudflare_pages} Resource
  *
  * @param scope The scope in which to define this construct
