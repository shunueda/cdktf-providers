// https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render
...
export interface SecretSyncRenderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#auto_sync_enabled SecretSyncRender#auto_sync_enabled}
  */
  readonly autoSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the render Connection to use for syncing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#connection_id SecretSyncRender#connection_id}
  */
  readonly connectionId: string;
  /**
  * An optional description for the Render sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#description SecretSyncRender#description}
  */
  readonly description?: string;
  /**
  * The destination configuration for the secret sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#destination_config SecretSyncRender#destination_config}
  */
  readonly destinationConfig: SecretSyncRenderDestinationConfig;
  /**
  * The slug of the project environment to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#environment SecretSyncRender#environment}
  */
  readonly environment: string;
  /**
  * The name of the Render sync to create. Must be slug-friendly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#name SecretSyncRender#name}
  */
  readonly name: string;
  /**
  * The ID of the Infisical project to create the sync in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#project_id SecretSyncRender#project_id}
  */
  readonly projectId: string;
  /**
  * The folder path to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#secret_path SecretSyncRender#secret_path}
  */
  readonly secretPath: string;
  /**
  * Parameters to modify how secrets are synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#sync_options SecretSyncRender#sync_options}
  */
...
export interface SecretSyncRenderDestinationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#scope SecretSyncRender#scope}
  */
  readonly scope: string;
  /**
  * The ID of the Render service to sync secrets to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#service_id SecretSyncRender#service_id}
  */
  readonly serviceId: string;
  /**
  * The Render resource type to sync secrets to. Supported options: env, file
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#type SecretSyncRender#type}
  */
...
export interface SecretSyncRenderSyncOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#disable_secret_deletion SecretSyncRender#disable_secret_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#initial_sync_behavior SecretSyncRender#initial_sync_behavior}
  */
  readonly initialSyncBehavior: string;
  /**
  * The format to use for structuring secret keys in the Render destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#key_schema SecretSyncRender#key_schema}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render infisical_secret_sync_render}
*/
export class SecretSyncRender extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretSyncRender that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_render infisical_secret_sync_render} Resource
  *
  * @param scope The scope in which to define this construct
