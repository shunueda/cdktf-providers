// https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops
...
export interface SecretSyncAzureDevopsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops#auto_sync_enabled SecretSyncAzureDevops#auto_sync_enabled}
  */
  readonly autoSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the azure Connection to use for syncing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops#connection_id SecretSyncAzureDevops#connection_id}
  */
  readonly connectionId: string;
  /**
  * An optional description for the Azure DevOps sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops#description SecretSyncAzureDevops#description}
  */
  readonly description?: string;
  /**
  * The destination configuration for the secret sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops#destination_config SecretSyncAzureDevops#destination_config}
  */
  readonly destinationConfig: SecretSyncAzureDevopsDestinationConfig;
  /**
  * The slug of the project environment to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops#environment SecretSyncAzureDevops#environment}
  */
  readonly environment: string;
  /**
  * The name of the Azure DevOps sync to create. Must be slug-friendly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops#name SecretSyncAzureDevops#name}
  */
  readonly name: string;
  /**
  * The ID of the Infisical project to create the sync in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops#project_id SecretSyncAzureDevops#project_id}
  */
  readonly projectId: string;
  /**
  * The folder path to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops#secret_path SecretSyncAzureDevops#secret_path}
  */
  readonly secretPath: string;
  /**
  * Parameters to modify how secrets are synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops#sync_options SecretSyncAzureDevops#sync_options}
  */
...
export interface SecretSyncAzureDevopsDestinationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops#devops_project_id SecretSyncAzureDevops#devops_project_id}
  */
...
export interface SecretSyncAzureDevopsSyncOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops#disable_secret_deletion SecretSyncAzureDevops#disable_secret_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops#key_schema SecretSyncAzureDevops#key_schema}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops infisical_secret_sync_azure_devops}
*/
export class SecretSyncAzureDevops extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretSyncAzureDevops that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.48/docs/resources/secret_sync_azure_devops infisical_secret_sync_azure_devops} Resource
  *
  * @param scope The scope in which to define this construct
