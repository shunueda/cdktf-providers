// https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/integration_gcp_secret_manager
...
export interface IntegrationGcpSecretManagerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/integration_gcp_secret_manager#environment IntegrationGcpSecretManager#environment}
  */
  readonly environment: string;
  /**
  * The ID of the GCP project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/integration_gcp_secret_manager#gcp_project_id IntegrationGcpSecretManager#gcp_project_id}
  */
  readonly gcpProjectId: string;
  /**
  * Integration options
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/integration_gcp_secret_manager#options IntegrationGcpSecretManager#options}
  */
  readonly options?: IntegrationGcpSecretManagerOptions;
  /**
  * The ID of your Infisical project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/integration_gcp_secret_manager#project_id IntegrationGcpSecretManager#project_id}
  */
  readonly projectId: string;
  /**
  * The secret path in Infisical to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/integration_gcp_secret_manager#secret_path IntegrationGcpSecretManager#secret_path}
  */
  readonly secretPath: string;
  /**
  * Service account json for the GCP project.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/integration_gcp_secret_manager#service_account_json IntegrationGcpSecretManager#service_account_json}
  */
...
export interface IntegrationGcpSecretManagerOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/integration_gcp_secret_manager#secret_prefix IntegrationGcpSecretManager#secret_prefix}
  */
  readonly secretPrefix?: string;
  /**
  * The suffix to add to the secret name in GCP Secret Manager.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/integration_gcp_secret_manager#secret_suffix IntegrationGcpSecretManager#secret_suffix}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/integration_gcp_secret_manager infisical_integration_gcp_secret_manager}
*/
export class IntegrationGcpSecretManager extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationGcpSecretManager that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/integration_gcp_secret_manager#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/integration_gcp_secret_manager infisical_integration_gcp_secret_manager} Resource
  *
  * @param scope The scope in which to define this construct
