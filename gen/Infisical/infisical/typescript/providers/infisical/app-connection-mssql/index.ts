// https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql
...
export interface AppConnectionMssqlConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql#credentials AppConnectionMssql#credentials}
  */
  readonly credentials: AppConnectionMssqlCredentials;
  /**
  * An optional description for the MsSQL App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql#description AppConnectionMssql#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with MsSQL. Possible values are: username-and-password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql#method AppConnectionMssql#method}
  */
  readonly method: string;
  /**
  * The name of the MsSQL App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql#name AppConnectionMssql#name}
  */
...
export interface AppConnectionMssqlCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql#database AppConnectionMssql#database}
  */
  readonly database: string;
  /**
  * The hostname of the database server.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql#host AppConnectionMssql#host}
  */
  readonly host: string;
  /**
  * The password to connect to the database with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql#password AppConnectionMssql#password}
  */
  readonly password: string;
  /**
  * The port number of the database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql#port AppConnectionMssql#port}
  */
  readonly port?: number;
  /**
  * The SSL certificate to use for connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql#ssl_certificate AppConnectionMssql#ssl_certificate}
  */
  readonly sslCertificate?: string;
  /**
  * Whether or not to use SSL when connecting to the database.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql#ssl_enabled AppConnectionMssql#ssl_enabled}
  */
  readonly sslEnabled?: boolean | cdktf.IResolvable;
  /**
  * Whether or not to reject unauthorized SSL certificates.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql#ssl_reject_unauthorized AppConnectionMssql#ssl_reject_unauthorized}
  */
  readonly sslRejectUnauthorized?: boolean | cdktf.IResolvable;
  /**
  * The username to connect to the database with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql#username AppConnectionMssql#username}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql infisical_app_connection_mssql}
*/
export class AppConnectionMssql extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionMssql that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.53/docs/resources/app_connection_mssql infisical_app_connection_mssql} Resource
  *
  * @param scope The scope in which to define this construct
