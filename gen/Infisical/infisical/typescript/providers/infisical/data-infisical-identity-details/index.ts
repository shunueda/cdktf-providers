// https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/data-sources/identity_details
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/data-sources/identity_details infisical_identity_details}
*/
export class DataInfisicalIdentityDetails extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataInfisicalIdentityDetails that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/data-sources/identity_details#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/data-sources/identity_details infisical_identity_details} Data Source
  *
  * @param scope The scope in which to define this construct
