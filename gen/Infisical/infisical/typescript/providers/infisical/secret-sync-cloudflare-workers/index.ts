// https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers
...
export interface SecretSyncCloudflareWorkersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers#auto_sync_enabled SecretSyncCloudflareWorkers#auto_sync_enabled}
  */
  readonly autoSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the cloudflare Connection to use for syncing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers#connection_id SecretSyncCloudflareWorkers#connection_id}
  */
  readonly connectionId: string;
  /**
  * An optional description for the Cloudflare Workers sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers#description SecretSyncCloudflareWorkers#description}
  */
  readonly description?: string;
  /**
  * The destination configuration for the secret sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers#destination_config SecretSyncCloudflareWorkers#destination_config}
  */
  readonly destinationConfig: SecretSyncCloudflareWorkersDestinationConfig;
  /**
  * The slug of the project environment to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers#environment SecretSyncCloudflareWorkers#environment}
  */
  readonly environment: string;
  /**
  * The name of the Cloudflare Workers sync to create. Must be slug-friendly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers#name SecretSyncCloudflareWorkers#name}
  */
  readonly name: string;
  /**
  * The ID of the Infisical project to create the sync in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers#project_id SecretSyncCloudflareWorkers#project_id}
  */
  readonly projectId: string;
  /**
  * The folder path to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers#secret_path SecretSyncCloudflareWorkers#secret_path}
  */
  readonly secretPath: string;
  /**
  * Parameters to modify how secrets are synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers#sync_options SecretSyncCloudflareWorkers#sync_options}
  */
...
export interface SecretSyncCloudflareWorkersDestinationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers#script_id SecretSyncCloudflareWorkers#script_id}
  */
...
export interface SecretSyncCloudflareWorkersSyncOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers#disable_secret_deletion SecretSyncCloudflareWorkers#disable_secret_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers#initial_sync_behavior SecretSyncCloudflareWorkers#initial_sync_behavior}
  */
  readonly initialSyncBehavior: string;
  /**
  * The format to use for structuring secret keys in the Cloudflare Workers destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers#key_schema SecretSyncCloudflareWorkers#key_schema}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers infisical_secret_sync_cloudflare_workers}
*/
export class SecretSyncCloudflareWorkers extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretSyncCloudflareWorkers that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.56/docs/resources/secret_sync_cloudflare_workers infisical_secret_sync_cloudflare_workers} Resource
  *
  * @param scope The scope in which to define this construct
