// https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/data-sources/secret_folders
...
export interface DataInfisicalSecretFoldersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/data-sources/secret_folders#environment_slug DataInfisicalSecretFolders#environment_slug}
  */
  readonly environmentSlug: string;
  /**
  * The secret path from where folders should be fetched from
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/data-sources/secret_folders#folder_path DataInfisicalSecretFolders#folder_path}
  */
  readonly folderPath: string;
  /**
  * The ID of the project where the folder resides
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/data-sources/secret_folders#project_id DataInfisicalSecretFolders#project_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/data-sources/secret_folders infisical_secret_folders}
*/
export class DataInfisicalSecretFolders extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataInfisicalSecretFolders that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/data-sources/secret_folders#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.50/docs/data-sources/secret_folders infisical_secret_folders} Data Source
  *
  * @param scope The scope in which to define this construct
