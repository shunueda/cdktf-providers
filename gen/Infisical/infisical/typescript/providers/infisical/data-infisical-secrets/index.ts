// https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/data-sources/secrets
...
export interface DataInfisicalSecretsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/data-sources/secrets#env_slug DataInfisicalSecrets#env_slug}
  */
  readonly envSlug: string;
  /**
  * The path to the folder from where secrets should be fetched from
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/data-sources/secrets#folder_path DataInfisicalSecrets#folder_path}
  */
  readonly folderPath: string;
  /**
  * The Infisical project ID (Required for Machine Identity auth, and service tokens with multiple scopes)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/data-sources/secrets#workspace_id DataInfisicalSecrets#workspace_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/data-sources/secrets infisical_secrets}
*/
export class DataInfisicalSecrets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataInfisicalSecrets that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/data-sources/secrets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/data-sources/secrets infisical_secrets} Data Source
  *
  * @param scope The scope in which to define this construct
