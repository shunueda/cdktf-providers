// https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_flyio
...
export interface AppConnectionFlyioConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_flyio#credentials AppConnectionFlyio#credentials}
  */
  readonly credentials: AppConnectionFlyioCredentials;
  /**
  * An optional description for the Fly.io App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_flyio#description AppConnectionFlyio#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with Fly.io. Possible values are: access-token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_flyio#method AppConnectionFlyio#method}
  */
  readonly method: string;
  /**
  * The name of the Fly.io App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_flyio#name AppConnectionFlyio#name}
  */
...
export interface AppConnectionFlyioCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_flyio#access_token AppConnectionFlyio#access_token}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_flyio infisical_app_connection_flyio}
*/
export class AppConnectionFlyio extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionFlyio that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_flyio#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_flyio infisical_app_connection_flyio} Resource
  *
  * @param scope The scope in which to define this construct
