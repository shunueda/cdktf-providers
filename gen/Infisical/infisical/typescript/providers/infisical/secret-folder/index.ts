// https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_folder
...
export interface SecretFolderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_folder#environment_slug SecretFolder#environment_slug}
  */
  readonly environmentSlug: string;
  /**
  * The path where the folder should be created/updated
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_folder#folder_path SecretFolder#folder_path}
  */
  readonly folderPath: string;
  /**
  * Whether to force delete the folder even if it contains resources.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_folder#force_delete SecretFolder#force_delete}
  */
  readonly forceDelete?: boolean | cdktf.IResolvable;
  /**
  * The name for the folder
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_folder#name SecretFolder#name}
  */
  readonly name: string;
  /**
  * The Infisical project ID (Required for Machine Identity auth, and service tokens with multiple scopes)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_folder#project_id SecretFolder#project_id}
  */
  readonly projectId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_folder infisical_secret_folder}
*/
export class SecretFolder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretFolder that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_folder#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.47/docs/resources/secret_folder infisical_secret_folder} Resource
  *
  * @param scope The scope in which to define this construct
