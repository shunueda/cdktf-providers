// https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_gitlab
...
export interface AppConnectionGitlabConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_gitlab#credentials AppConnectionGitlab#credentials}
  */
  readonly credentials: AppConnectionGitlabCredentials;
  /**
  * An optional description for the GitLab App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_gitlab#description AppConnectionGitlab#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with GitLab. Possible values are: access-token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_gitlab#method AppConnectionGitlab#method}
  */
  readonly method: string;
  /**
  * The name of the GitLab App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_gitlab#name AppConnectionGitlab#name}
  */
...
export interface AppConnectionGitlabCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_gitlab#access_token AppConnectionGitlab#access_token}
  */
  readonly accessToken: string;
  /**
  * The type of token used to connect with GitLab. Supported options: 'project' and 'personal'
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_gitlab#access_token_type AppConnectionGitlab#access_token_type}
  */
  readonly accessTokenType: string;
  /**
  * The GitLab instance URL to connect with. (default: https://gitlab.com)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_gitlab#instance_url AppConnectionGitlab#instance_url}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_gitlab infisical_app_connection_gitlab}
*/
export class AppConnectionGitlab extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionGitlab that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_gitlab#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/app_connection_gitlab infisical_app_connection_gitlab} Resource
  *
  * @param scope The scope in which to define this construct
