// https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager
...
export interface SecretSyncGcpSecretManagerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager#auto_sync_enabled SecretSyncGcpSecretManager#auto_sync_enabled}
  */
  readonly autoSyncEnabled?: boolean | cdktf.IResolvable;
  /**
  * The ID of the GCP Connection to use for syncing.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager#connection_id SecretSyncGcpSecretManager#connection_id}
  */
  readonly connectionId: string;
  /**
  * An optional description for the GCP Secret Manager sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager#description SecretSyncGcpSecretManager#description}
  */
  readonly description?: string;
  /**
  * The destination configuration for the secret sync.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager#destination_config SecretSyncGcpSecretManager#destination_config}
  */
  readonly destinationConfig: SecretSyncGcpSecretManagerDestinationConfig;
  /**
  * The slug of the project environment to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager#environment SecretSyncGcpSecretManager#environment}
  */
  readonly environment: string;
  /**
  * The name of the GCP Secret Manager sync to create. Must be slug-friendly.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager#name SecretSyncGcpSecretManager#name}
  */
  readonly name: string;
  /**
  * The ID of the Infisical project to create the sync in.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager#project_id SecretSyncGcpSecretManager#project_id}
  */
  readonly projectId: string;
  /**
  * The folder path to sync secrets from.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager#secret_path SecretSyncGcpSecretManager#secret_path}
  */
  readonly secretPath: string;
  /**
  * Parameters to modify how secrets are synced.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager#sync_options SecretSyncGcpSecretManager#sync_options}
  */
...
export interface SecretSyncGcpSecretManagerDestinationConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager#scope SecretSyncGcpSecretManager#scope}
  */
...
export interface SecretSyncGcpSecretManagerSyncOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager#disable_secret_deletion SecretSyncGcpSecretManager#disable_secret_deletion}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager#initial_sync_behavior SecretSyncGcpSecretManager#initial_sync_behavior}
  */
  readonly initialSyncBehavior: string;
  /**
  * The format to use for structuring secret keys in the GCP Secret Manager destination.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager#key_schema SecretSyncGcpSecretManager#key_schema}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager infisical_secret_sync_gcp_secret_manager}
*/
export class SecretSyncGcpSecretManager extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretSyncGcpSecretManager that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.54/docs/resources/secret_sync_gcp_secret_manager infisical_secret_sync_gcp_secret_manager} Resource
  *
  * @param scope The scope in which to define this construct
