// https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_cloudflare
...
export interface AppConnectionCloudflareConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_cloudflare#credentials AppConnectionCloudflare#credentials}
  */
  readonly credentials: AppConnectionCloudflareCredentials;
  /**
  * An optional description for the Cloudflare App Connection.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_cloudflare#description AppConnectionCloudflare#description}
  */
  readonly description?: string;
  /**
  * The method used to authenticate with Cloudflare. Possible values are: api-token
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_cloudflare#method AppConnectionCloudflare#method}
  */
  readonly method: string;
  /**
  * The name of the Cloudflare App Connection to create. Must be slug-friendly
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_cloudflare#name AppConnectionCloudflare#name}
  */
...
export interface AppConnectionCloudflareCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_cloudflare#account_id AppConnectionCloudflare#account_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_cloudflare#api_token AppConnectionCloudflare#api_token}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_cloudflare infisical_app_connection_cloudflare}
*/
export class AppConnectionCloudflare extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppConnectionCloudflare that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_cloudflare#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.55/docs/resources/app_connection_cloudflare infisical_app_connection_cloudflare} Resource
  *
  * @param scope The scope in which to define this construct
