// https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/identity_universal_auth_client_secret
...
export interface IdentityUniversalAuthClientSecretConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/identity_universal_auth_client_secret#description IdentityUniversalAuthClientSecret#description}
  */
  readonly description?: string;
  /**
  * The ID of the identity to create a client secret for
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/identity_universal_auth_client_secret#identity_id IdentityUniversalAuthClientSecret#identity_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/identity_universal_auth_client_secret#number_of_uses_limit IdentityUniversalAuthClientSecret#number_of_uses_limit}
  */
  readonly numberOfUsesLimit?: number;
  /**
  * The lifetime for the client secret in seconds. Default: 0 - not expiring
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/identity_universal_auth_client_secret#ttl IdentityUniversalAuthClientSecret#ttl}
  */
  readonly ttl?: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/identity_universal_auth_client_secret infisical_identity_universal_auth_client_secret}
*/
export class IdentityUniversalAuthClientSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IdentityUniversalAuthClientSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/identity_universal_auth_client_secret#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/infisical/infisical/0.15.52/docs/resources/identity_universal_auth_client_secret infisical_identity_universal_auth_client_secret} Resource
  *
  * @param scope The scope in which to define this construct
