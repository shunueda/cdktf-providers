...
export interface DataSbercloudKpsRunningTasksTasks {
}

export function dataSbercloudKpsRunningTasksTasksToTerraform(struct?: DataSbercloudKpsRunningTasksTasks): any {
...
export function dataSbercloudKpsRunningTasksTasksToHclTerraform(struct?: DataSbercloudKpsRunningTasksTasks): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudKpsRunningTasksTasksOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudKpsRunningTasksTasks | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudKpsRunningTasksTasks | undefined) {
    if (value === undefined) {
...
export class DataSbercloudKpsRunningTasksTasksList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudKpsRunningTasksTasksOutputReference {
    return new DataSbercloudKpsRunningTasksTasksOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudKpsRunningTasks extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_kps_running_tasks";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_kps_running_tasks", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudKpsRunningTasksConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudKpsRunningTasksConfig = {}) {
    super(scope, id, {
  ...
  private _tasks = new DataSbercloudKpsRunningTasksTasksList(this, "tasks", false);
  public get tasks() {
    return this._tasks;
  }
