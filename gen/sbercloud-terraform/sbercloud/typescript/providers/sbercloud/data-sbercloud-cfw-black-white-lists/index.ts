...
export interface DataSbercloudCfwBlackWhiteListsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudCfwBlackWhiteListsRecords {
}

export function dataSbercloudCfwBlackWhiteListsRecordsToTerraform(struct?: DataSbercloudCfwBlackWhiteListsRecords): any {
...
export function dataSbercloudCfwBlackWhiteListsRecordsToHclTerraform(struct?: DataSbercloudCfwBlackWhiteListsRecords): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudCfwBlackWhiteListsRecordsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudCfwBlackWhiteListsRecords | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudCfwBlackWhiteListsRecords | undefined) {
    if (value === undefined) {
...
export class DataSbercloudCfwBlackWhiteListsRecordsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudCfwBlackWhiteListsRecordsOutputReference {
    return new DataSbercloudCfwBlackWhiteListsRecordsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudCfwBlackWhiteLists extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_cfw_black_white_lists";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_cfw_black_white_lists", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudCfwBlackWhiteListsConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudCfwBlackWhiteListsConfig) {
    super(scope, id, {
  ...
  private _records = new DataSbercloudCfwBlackWhiteListsRecordsList(this, "records", false);
  public get records() {
