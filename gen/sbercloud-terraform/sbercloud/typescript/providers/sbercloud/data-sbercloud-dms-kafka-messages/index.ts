...
export interface DataSbercloudDmsKafkaMessagesConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudDmsKafkaMessagesMessages {
}

export function dataSbercloudDmsKafkaMessagesMessagesToTerraform(struct?: DataSbercloudDmsKafkaMessagesMessages): any {
...
export function dataSbercloudDmsKafkaMessagesMessagesToHclTerraform(struct?: DataSbercloudDmsKafkaMessagesMessages): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudDmsKafkaMessagesMessagesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudDmsKafkaMessagesMessages | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudDmsKafkaMessagesMessages | undefined) {
    if (value === undefined) {
...
export class DataSbercloudDmsKafkaMessagesMessagesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudDmsKafkaMessagesMessagesOutputReference {
    return new DataSbercloudDmsKafkaMessagesMessagesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudDmsKafkaMessages extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_dms_kafka_messages";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_dms_kafka_messages", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudDmsKafkaMessagesConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudDmsKafkaMessagesConfig) {
    super(scope, id, {
  ...
  private _messages = new DataSbercloudDmsKafkaMessagesMessagesList(this, "messages", false);
  public get messages() {
