...
export function dataSbercloudIdentityProjectsProjectsToTerraform(struct?: DataSbercloudIdentityProjectsProjects): any {
...
export function dataSbercloudIdentityProjectsProjectsToHclTerraform(struct?: DataSbercloudIdentityProjectsProjects): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudIdentityProjectsProjectsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudIdentityProjectsProjects | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudIdentityProjectsProjects | undefined) {
    if (value === undefined) {
...
export class DataSbercloudIdentityProjectsProjectsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudIdentityProjectsProjectsOutputReference {
    return new DataSbercloudIdentityProjectsProjectsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudIdentityProjects extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_identity_projects";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_identity_projects", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudIdentityProjectsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudIdentityProjectsConfig = {}) {
    super(scope, id, {
