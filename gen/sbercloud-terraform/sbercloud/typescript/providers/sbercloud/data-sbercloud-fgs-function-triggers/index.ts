...
export interface DataSbercloudFgsFunctionTriggersTriggers {
}

export function dataSbercloudFgsFunctionTriggersTriggersToTerraform(struct?: DataSbercloudFgsFunctionTriggersTriggers): any {
...
export function dataSbercloudFgsFunctionTriggersTriggersToHclTerraform(struct?: DataSbercloudFgsFunctionTriggersTriggers): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudFgsFunctionTriggersTriggersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudFgsFunctionTriggersTriggers | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudFgsFunctionTriggersTriggers | undefined) {
    if (value === undefined) {
...
export class DataSbercloudFgsFunctionTriggersTriggersList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudFgsFunctionTriggersTriggersOutputReference {
    return new DataSbercloudFgsFunctionTriggersTriggersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudFgsFunctionTriggers extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_fgs_function_triggers";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_fgs_function_triggers", importId: importFromId, provider });
      }
  ...
  */
  ...
  private _triggers = new DataSbercloudFgsFunctionTriggersTriggersList(this, "triggers", false);
  public get triggers() {
