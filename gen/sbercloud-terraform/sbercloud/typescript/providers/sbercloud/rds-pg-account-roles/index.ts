...
export function rdsPgAccountRolesTimeoutsToTerraform(struct?: RdsPgAccountRolesTimeouts | cdktf.IResolvable): any {
...
export function rdsPgAccountRolesTimeoutsToHclTerraform(struct?: RdsPgAccountRolesTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class RdsPgAccountRolesTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RdsPgAccountRolesTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: RdsPgAccountRolesTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class RdsPgAccountRoles extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_rds_pg_account_roles";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_rds_pg_account_roles", importId: importFromId, provider });
      }
  ...
  * @param options RdsPgAccountRolesConfig
  */
  public constructor(scope: Construct, id: string, config: RdsPgAccountRolesConfig) {
    super(scope, id, {
  ...
  private _timeouts = new RdsPgAccountRolesTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: RdsPgAccountRolesTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: rdsPgAccountRolesTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: rdsPgAccountRolesTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "RdsPgAccountRolesTimeouts",
      },
    };
