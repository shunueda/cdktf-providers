...
export interface DataSbercloudDmsRocketmqMigrationTasksTasks {
}

export function dataSbercloudDmsRocketmqMigrationTasksTasksToTerraform(struct?: DataSbercloudDmsRocketmqMigrationTasksTasks): any {
...
export function dataSbercloudDmsRocketmqMigrationTasksTasksToHclTerraform(struct?: DataSbercloudDmsRocketmqMigrationTasksTasks): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudDmsRocketmqMigrationTasksTasksOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudDmsRocketmqMigrationTasksTasks | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudDmsRocketmqMigrationTasksTasks | undefined) {
    if (value === undefined) {
...
export class DataSbercloudDmsRocketmqMigrationTasksTasksList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudDmsRocketmqMigrationTasksTasksOutputReference {
    return new DataSbercloudDmsRocketmqMigrationTasksTasksOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudDmsRocketmqMigrationTasks extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_dms_rocketmq_migration_tasks";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_dms_rocketmq_migration_tasks", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudDmsRocketmqMigrationTasksConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudDmsRocketmqMigrationTasksConfig) {
    super(scope, id, {
  ...
  private _tasks = new DataSbercloudDmsRocketmqMigrationTasksTasksList(this, "tasks", false);
  public get tasks() {
    return this._tasks;
  }
