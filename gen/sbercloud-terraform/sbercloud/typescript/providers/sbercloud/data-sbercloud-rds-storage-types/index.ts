...
export interface DataSbercloudRdsStorageTypesConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudRdsStorageTypesStorageTypes {
}

export function dataSbercloudRdsStorageTypesStorageTypesToTerraform(struct?: DataSbercloudRdsStorageTypesStorageTypes): any {
...
export function dataSbercloudRdsStorageTypesStorageTypesToHclTerraform(struct?: DataSbercloudRdsStorageTypesStorageTypes): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudRdsStorageTypesStorageTypesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudRdsStorageTypesStorageTypes | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudRdsStorageTypesStorageTypes | undefined) {
    if (value === undefined) {
...
export class DataSbercloudRdsStorageTypesStorageTypesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudRdsStorageTypesStorageTypesOutputReference {
    return new DataSbercloudRdsStorageTypesStorageTypesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudRdsStorageTypes extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_rds_storage_types";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_rds_storage_types", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudRdsStorageTypesConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudRdsStorageTypesConfig) {
    super(scope, id, {
  ...
  private _storageTypes = new DataSbercloudRdsStorageTypesStorageTypesList(this, "storage_types", false);
