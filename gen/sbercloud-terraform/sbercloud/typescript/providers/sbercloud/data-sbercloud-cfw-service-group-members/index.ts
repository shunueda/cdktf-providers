...
export interface DataSbercloudCfwServiceGroupMembersConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudCfwServiceGroupMembersRecords {
}

export function dataSbercloudCfwServiceGroupMembersRecordsToTerraform(struct?: DataSbercloudCfwServiceGroupMembersRecords): any {
...
export function dataSbercloudCfwServiceGroupMembersRecordsToHclTerraform(struct?: DataSbercloudCfwServiceGroupMembersRecords): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudCfwServiceGroupMembersRecordsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudCfwServiceGroupMembersRecords | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudCfwServiceGroupMembersRecords | undefined) {
    if (value === undefined) {
...
export class DataSbercloudCfwServiceGroupMembersRecordsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudCfwServiceGroupMembersRecordsOutputReference {
    return new DataSbercloudCfwServiceGroupMembersRecordsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudCfwServiceGroupMembers extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_cfw_service_group_members";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_cfw_service_group_members", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudCfwServiceGroupMembersConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudCfwServiceGroupMembersConfig) {
    super(scope, id, {
  ...
  private _records = new DataSbercloudCfwServiceGroupMembersRecordsList(this, "records", false);
  public get records() {
