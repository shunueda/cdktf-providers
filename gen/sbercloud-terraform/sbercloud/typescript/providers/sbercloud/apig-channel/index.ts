...
export function apigChannelMemberGroupToTerraform(struct?: ApigChannelMemberGroup | cdktf.IResolvable): any {
  ...
  return {
    ...
    name: cdktf.stringToTerraform(struct!.name),
    reference_vpc_channel_id: cdktf.stringToTerraform(struct!.referenceVpcChannelId),
    weight: cdktf.numberToTerraform(struct!.weight),
  }
}
...
export function apigChannelMemberGroupToHclTerraform(struct?: ApigChannelMemberGroup | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    reference_vpc_channel_id: {
      value: cdktf.stringToHclTerraform(struct!.referenceVpcChannelId),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class ApigChannelMemberGroupOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApigChannelMemberGroup | cdktf.IResolvable | undefined {
    ...
    if (this._referenceVpcChannelId !== undefined) {
      hasAnyValues = true;
      internalValueResult.referenceVpcChannelId = this._referenceVpcChannelId;
    }
    if (this._weight !== undefined) {
      hasAnyValues = true;
      internalValueResult.weight = this._weight;
  ...
  public set internalValue(value: ApigChannelMemberGroup | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      ...
      this._name = undefined;
      this._referenceVpcChannelId = undefined;
      this._weight = undefined;
    }
    else if (cdktf.Tokenization.isResolvable(value)) {
      this.isEmptyObject = false;
      ...
      this._name = value.name;
      this._referenceVpcChannelId = value.referenceVpcChannelId;
      this._weight = value.weight;
    }
  }
  ...
  // reference_vpc_channel_id - computed: true, optional: true, required: false
  private _referenceVpcChannelId?: string; 
  public get referenceVpcChannelId() {
    return this.getStringAttribute('reference_vpc_channel_id');
  }
  public set referenceVpcChannelId(value: string) {
    this._referenceVpcChannelId = value;
  }
  public resetReferenceVpcChannelId() {
    this._referenceVpcChannelId = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get referenceVpcChannelIdInput() {
    return this._referenceVpcChannelId;
  }
...
export class ApigChannel extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_apig_channel";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_apig_channel", importId: importFromId, provider });
      }
  ...
  */
  ...
  private _memberGroup = new ApigChannelMemberGroupList(this, "member_group", true);
