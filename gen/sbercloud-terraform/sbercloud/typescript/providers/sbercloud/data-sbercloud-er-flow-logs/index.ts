...
export interface DataSbercloudErFlowLogsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudErFlowLogsFlowLogs {
}

export function dataSbercloudErFlowLogsFlowLogsToTerraform(struct?: DataSbercloudErFlowLogsFlowLogs): any {
...
export function dataSbercloudErFlowLogsFlowLogsToHclTerraform(struct?: DataSbercloudErFlowLogsFlowLogs): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudErFlowLogsFlowLogsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudErFlowLogsFlowLogs | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudErFlowLogsFlowLogs | undefined) {
    if (value === undefined) {
...
export class DataSbercloudErFlowLogsFlowLogsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudErFlowLogsFlowLogsOutputReference {
    return new DataSbercloudErFlowLogsFlowLogsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudErFlowLogs extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_er_flow_logs";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_er_flow_logs", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudErFlowLogsConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudErFlowLogsConfig) {
    super(scope, id, {
  ...
  private _flowLogs = new DataSbercloudErFlowLogsFlowLogsList(this, "flow_logs", false);
  public get flowLogs() {
