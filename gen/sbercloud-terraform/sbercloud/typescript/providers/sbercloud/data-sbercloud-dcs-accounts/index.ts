...
export interface DataSbercloudDcsAccountsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudDcsAccountsAccounts {
}

export function dataSbercloudDcsAccountsAccountsToTerraform(struct?: DataSbercloudDcsAccountsAccounts): any {
...
export function dataSbercloudDcsAccountsAccountsToHclTerraform(struct?: DataSbercloudDcsAccountsAccounts): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudDcsAccountsAccountsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudDcsAccountsAccounts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudDcsAccountsAccounts | undefined) {
    if (value === undefined) {
...
export class DataSbercloudDcsAccountsAccountsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudDcsAccountsAccountsOutputReference {
    return new DataSbercloudDcsAccountsAccountsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudDcsAccounts extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_dcs_accounts";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_dcs_accounts", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudDcsAccountsConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudDcsAccountsConfig) {
    super(scope, id, {
  ...
  private _accounts = new DataSbercloudDcsAccountsAccountsList(this, "accounts", false);
  public get accounts() {
