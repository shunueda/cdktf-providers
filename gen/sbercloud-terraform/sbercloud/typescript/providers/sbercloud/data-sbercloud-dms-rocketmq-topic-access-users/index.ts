...
export interface DataSbercloudDmsRocketmqTopicAccessUsersPolicies {
}

export function dataSbercloudDmsRocketmqTopicAccessUsersPoliciesToTerraform(struct?: DataSbercloudDmsRocketmqTopicAccessUsersPolicies): any {
...
export function dataSbercloudDmsRocketmqTopicAccessUsersPoliciesToHclTerraform(struct?: DataSbercloudDmsRocketmqTopicAccessUsersPolicies): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudDmsRocketmqTopicAccessUsersPoliciesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudDmsRocketmqTopicAccessUsersPolicies | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudDmsRocketmqTopicAccessUsersPolicies | undefined) {
    if (value === undefined) {
...
export class DataSbercloudDmsRocketmqTopicAccessUsersPoliciesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudDmsRocketmqTopicAccessUsersPoliciesOutputReference {
    return new DataSbercloudDmsRocketmqTopicAccessUsersPoliciesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudDmsRocketmqTopicAccessUsers extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_dms_rocketmq_topic_access_users";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_dms_rocketmq_topic_access_users", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudDmsRocketmqTopicAccessUsersConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudDmsRocketmqTopicAccessUsersConfig) {
    super(scope, id, {
  ...
  private _policies = new DataSbercloudDmsRocketmqTopicAccessUsersPoliciesList(this, "policies", false);
  public get policies() {
