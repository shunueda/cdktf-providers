...
export interface DataSbercloudSfsTurboPermRulesRules {
}

export function dataSbercloudSfsTurboPermRulesRulesToTerraform(struct?: DataSbercloudSfsTurboPermRulesRules): any {
...
export function dataSbercloudSfsTurboPermRulesRulesToHclTerraform(struct?: DataSbercloudSfsTurboPermRulesRules): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudSfsTurboPermRulesRulesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudSfsTurboPermRulesRules | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudSfsTurboPermRulesRules | undefined) {
    if (value === undefined) {
...
export class DataSbercloudSfsTurboPermRulesRulesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudSfsTurboPermRulesRulesOutputReference {
    return new DataSbercloudSfsTurboPermRulesRulesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudSfsTurboPermRules extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_sfs_turbo_perm_rules";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_sfs_turbo_perm_rules", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudSfsTurboPermRulesConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudSfsTurboPermRulesConfig) {
    super(scope, id, {
  ...
  private _rules = new DataSbercloudSfsTurboPermRulesRulesList(this, "rules", false);
  public get rules() {
    return this._rules;
  }
