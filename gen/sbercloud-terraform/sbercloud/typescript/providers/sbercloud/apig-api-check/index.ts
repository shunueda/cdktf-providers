// https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check
...
export interface ApigApiCheckConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check#api_id ApigApiCheck#api_id}
  */
  readonly apiId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check#enable_force_new ApigApiCheck#enable_force_new}
  */
  readonly enableForceNew?: string;
  /**
  * The ID of the group to which the API belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check#group_id ApigApiCheck#group_id}
  */
  readonly groupId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check#id ApigApiCheck#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check#instance_id ApigApiCheck#instance_id}
  */
  readonly instanceId: string;
  /**
  * The matching mode of the API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check#match_mode ApigApiCheck#match_mode}
  */
  readonly matchMode?: string;
  /**
  * The name of the API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check#name ApigApiCheck#name}
  */
  readonly name?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check#region ApigApiCheck#region}
  */
  readonly region?: string;
  /**
  * The request method of the API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check#req_method ApigApiCheck#req_method}
  */
  readonly reqMethod?: string;
  /**
  * The request path of the API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check#req_uri ApigApiCheck#req_uri}
  */
  readonly reqUri?: string;
  /**
  * The type of the API to be checked.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check#type ApigApiCheck#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check sbercloud_apig_api_check}
*/
export class ApigApiCheck extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigApiCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/apig_api_check sbercloud_apig_api_check} Resource
  *
  * @param scope The scope in which to define this construct
