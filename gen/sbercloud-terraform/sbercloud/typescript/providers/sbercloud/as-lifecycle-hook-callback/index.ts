// https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/as_lifecycle_hook_callback
...
export interface AsLifecycleHookCallbackConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/as_lifecycle_hook_callback#id AsLifecycleHookCallback#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/as_lifecycle_hook_callback#instance_id AsLifecycleHookCallback#instance_id}
  */
  readonly instanceId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/as_lifecycle_hook_callback#lifecycle_action_key AsLifecycleHookCallback#lifecycle_action_key}
  */
  readonly lifecycleActionKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/as_lifecycle_hook_callback#lifecycle_action_result AsLifecycleHookCallback#lifecycle_action_result}
  */
  readonly lifecycleActionResult: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/as_lifecycle_hook_callback#lifecycle_hook_name AsLifecycleHookCallback#lifecycle_hook_name}
  */
  readonly lifecycleHookName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/as_lifecycle_hook_callback#region AsLifecycleHookCallback#region}
  */
  readonly region?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/as_lifecycle_hook_callback#scaling_group_id AsLifecycleHookCallback#scaling_group_id}
  */
  readonly scalingGroupId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/as_lifecycle_hook_callback sbercloud_as_lifecycle_hook_callback}
*/
export class AsLifecycleHookCallback extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_as_lifecycle_hook_callback";
  ...
  * @param importFromId The id of the existing AsLifecycleHookCallback that should be imported. Refer to the {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/as_lifecycle_hook_callback#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_as_lifecycle_hook_callback", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/as_lifecycle_hook_callback sbercloud_as_lifecycle_hook_callback} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: AsLifecycleHookCallbackConfig) {
    super(scope, id, {
      terraformResourceType: 'sbercloud_as_lifecycle_hook_callback',
