...
export interface DataSbercloudApigApiAssociatedPluginsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudApigApiAssociatedPluginsPlugins {
}

export function dataSbercloudApigApiAssociatedPluginsPluginsToTerraform(struct?: DataSbercloudApigApiAssociatedPluginsPlugins): any {
...
export function dataSbercloudApigApiAssociatedPluginsPluginsToHclTerraform(struct?: DataSbercloudApigApiAssociatedPluginsPlugins): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudApigApiAssociatedPluginsPluginsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudApigApiAssociatedPluginsPlugins | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudApigApiAssociatedPluginsPlugins | undefined) {
    if (value === undefined) {
...
export class DataSbercloudApigApiAssociatedPluginsPluginsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudApigApiAssociatedPluginsPluginsOutputReference {
    return new DataSbercloudApigApiAssociatedPluginsPluginsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudApigApiAssociatedPlugins extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_apig_api_associated_plugins";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_apig_api_associated_plugins", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudApigApiAssociatedPluginsConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudApigApiAssociatedPluginsConfig) {
    super(scope, id, {
  ...
  private _plugins = new DataSbercloudApigApiAssociatedPluginsPluginsList(this, "plugins", false);
  public get plugins() {
