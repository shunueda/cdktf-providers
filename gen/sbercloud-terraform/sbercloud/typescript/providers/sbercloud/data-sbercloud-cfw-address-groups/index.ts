...
export interface DataSbercloudCfwAddressGroupsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudCfwAddressGroupsAddressGroups {
}

export function dataSbercloudCfwAddressGroupsAddressGroupsToTerraform(struct?: DataSbercloudCfwAddressGroupsAddressGroups): any {
...
export function dataSbercloudCfwAddressGroupsAddressGroupsToHclTerraform(struct?: DataSbercloudCfwAddressGroupsAddressGroups): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudCfwAddressGroupsAddressGroupsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudCfwAddressGroupsAddressGroups | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudCfwAddressGroupsAddressGroups | undefined) {
    if (value === undefined) {
...
export class DataSbercloudCfwAddressGroupsAddressGroupsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudCfwAddressGroupsAddressGroupsOutputReference {
    return new DataSbercloudCfwAddressGroupsAddressGroupsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudCfwAddressGroups extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_cfw_address_groups";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_cfw_address_groups", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudCfwAddressGroupsConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudCfwAddressGroupsConfig) {
    super(scope, id, {
  ...
  private _addressGroups = new DataSbercloudCfwAddressGroupsAddressGroupsList(this, "address_groups", false);
