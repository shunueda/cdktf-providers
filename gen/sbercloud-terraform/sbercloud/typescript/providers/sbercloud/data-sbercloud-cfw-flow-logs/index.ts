...
export interface DataSbercloudCfwFlowLogsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudCfwFlowLogsRecords {
}

export function dataSbercloudCfwFlowLogsRecordsToTerraform(struct?: DataSbercloudCfwFlowLogsRecords): any {
...
export function dataSbercloudCfwFlowLogsRecordsToHclTerraform(struct?: DataSbercloudCfwFlowLogsRecords): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudCfwFlowLogsRecordsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudCfwFlowLogsRecords | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudCfwFlowLogsRecords | undefined) {
    if (value === undefined) {
...
export class DataSbercloudCfwFlowLogsRecordsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudCfwFlowLogsRecordsOutputReference {
    return new DataSbercloudCfwFlowLogsRecordsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudCfwFlowLogs extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_cfw_flow_logs";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_cfw_flow_logs", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudCfwFlowLogsConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudCfwFlowLogsConfig) {
    super(scope, id, {
  ...
  private _records = new DataSbercloudCfwFlowLogsRecordsList(this, "records", false);
  public get records() {
