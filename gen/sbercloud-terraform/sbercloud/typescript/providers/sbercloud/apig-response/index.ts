...
export interface ApigResponseRuleHeaders {
  /**
...
export function apigResponseRuleHeadersToTerraform(struct?: ApigResponseRuleHeaders | cdktf.IResolvable): any {
...
export function apigResponseRuleHeadersToHclTerraform(struct?: ApigResponseRuleHeaders | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ApigResponseRuleHeadersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApigResponseRuleHeaders | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ApigResponseRuleHeaders | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ApigResponseRuleHeadersList extends cdktf.ComplexList {
  public internalValue? : ApigResponseRuleHeaders[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ApigResponseRuleHeadersOutputReference {
    return new ApigResponseRuleHeadersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function apigResponseRuleToTerraform(struct?: ApigResponseRule | cdktf.IResolvable): any {
  ...
  return {
    ...
    headers: cdktf.listMapper(apigResponseRuleHeadersToTerraform, true)(struct!.headers),
  }
}
...
export function apigResponseRuleToHclTerraform(struct?: ApigResponseRule | cdktf.IResolvable): any {
  ...
  const attrs = {
    ...
    headers: {
      value: cdktf.listMapperHcl(apigResponseRuleHeadersToHclTerraform, true)(struct!.headers),
      isBlock: true,
      type: "set",
      storageClassType: "ApigResponseRuleHeadersList",
    },
  };
...
export class ApigResponseRuleOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _headers = new ApigResponseRuleHeadersList(this, "headers", true);
  public get headers() {
    return this._headers;
  }
  public putHeaders(value: ApigResponseRuleHeaders[] | cdktf.IResolvable) {
...
export class ApigResponse extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_apig_response";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_apig_response", importId: importFromId, provider });
      }
