...
export class DataSbercloudIdentityRoleV3 extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_identity_role_v3";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_identity_role_v3", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudIdentityRoleV3Config = {}
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudIdentityRoleV3Config = {}) {
    super(scope, id, {
