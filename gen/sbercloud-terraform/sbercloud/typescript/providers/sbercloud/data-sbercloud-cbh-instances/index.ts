...
export interface DataSbercloudCbhInstancesConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudCbhInstancesInstances {
}

export function dataSbercloudCbhInstancesInstancesToTerraform(struct?: DataSbercloudCbhInstancesInstances): any {
...
export function dataSbercloudCbhInstancesInstancesToHclTerraform(struct?: DataSbercloudCbhInstancesInstances): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudCbhInstancesInstancesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudCbhInstancesInstances | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudCbhInstancesInstances | undefined) {
    if (value === undefined) {
...
export class DataSbercloudCbhInstancesInstancesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudCbhInstancesInstancesOutputReference {
    return new DataSbercloudCbhInstancesInstancesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudCbhInstances extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_cbh_instances";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_cbh_instances", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudCbhInstancesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudCbhInstancesConfig = {}) {
    super(scope, id, {
  ...
  private _instances = new DataSbercloudCbhInstancesInstancesList(this, "instances", false);
