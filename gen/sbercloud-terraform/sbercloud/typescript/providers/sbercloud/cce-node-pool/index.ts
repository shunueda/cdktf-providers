...
export class CceNodePoolDataVolumesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // hw_passthrough - computed: true, optional: true, required: false
...
export function cceNodePoolExtendParamsToTerraform(struct?: CceNodePoolExtendParamsOutputReference | CceNodePoolExtendParams): any {
  ...
  return {
    ...
    security_reinforcement_type: cdktf.stringToTerraform(struct!.securityReinforcementType),
...
export function cceNodePoolExtendParamsToHclTerraform(struct?: CceNodePoolExtendParamsOutputReference | CceNodePoolExtendParams): any {
  ...
  const attrs = {
    ...
    security_reinforcement_type: {
      value: cdktf.stringToHclTerraform(struct!.securityReinforcementType),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class CceNodePoolExtendParamsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CceNodePoolExtendParams | undefined {
    ...
    if (this._securityReinforcementType !== undefined) {
      hasAnyValues = true;
      internalValueResult.securityReinforcementType = this._securityReinforcementType;
    }
  ...
  public set internalValue(value: CceNodePoolExtendParams | undefined) {
    if (value === undefined) {
      ...
      this._securityReinforcementType = undefined;
      ...
      this._securityReinforcementType = value.securityReinforcementType;
  ...
  // docker_base_size - computed: true, optional: true, required: false
  ...
  // kube_reserved_mem - computed: true, optional: true, required: false
  ...
  // nic_threshold - computed: true, optional: true, required: false
  ...
  // node_multi_queue - computed: true, optional: true, required: false
  ...
  // security_reinforcement_type - computed: true, optional: true, required: false
  private _securityReinforcementType?: string; 
  public get securityReinforcementType() {
    return this.getStringAttribute('security_reinforcement_type');
  }
  public set securityReinforcementType(value: string) {
    this._securityReinforcementType = value;
  }
  public resetSecurityReinforcementType() {
    this._securityReinforcementType = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get securityReinforcementTypeInput() {
    return this._securityReinforcementType;
  }
  ...
  // system_reserved_mem - computed: true, optional: true, required: false
...
export class CceNodePoolExtensionScaleGroupsSpecAutoscalingOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // extension_priority - computed: true, optional: true, required: false
...
export class CceNodePool extends cdktf.TerraformResource {
  ...
  */
  public constructor(scope: Construct, id: string, config: CceNodePoolConfig) {
    ...
    this._id = config.id;
    this._ignoreInitialNodeCount = config.ignoreInitialNodeCount;
  ...
  // ignore_initial_node_count - computed: false, optional: true, required: false
  private _ignoreInitialNodeCount?: boolean | cdktf.IResolvable; 
  public get ignoreInitialNodeCount() {
    return this.getBooleanAttribute('ignore_initial_node_count');
  }
  public set ignoreInitialNodeCount(value: boolean | cdktf.IResolvable) {
    this._ignoreInitialNodeCount = value;
  }
  public resetIgnoreInitialNodeCount() {
    this._ignoreInitialNodeCount = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get ignoreInitialNodeCountInput() {
    return this._ignoreInitialNodeCount;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ignore_initial_node_count: cdktf.booleanToTerraform(this._ignoreInitialNodeCount),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ignore_initial_node_count: {
        value: cdktf.booleanToHclTerraform(this._ignoreInitialNodeCount),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
