...
export interface DataSbercloudFgsApplicationTemplatesConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudFgsApplicationTemplatesTemplates {
}

export function dataSbercloudFgsApplicationTemplatesTemplatesToTerraform(struct?: DataSbercloudFgsApplicationTemplatesTemplates): any {
...
export function dataSbercloudFgsApplicationTemplatesTemplatesToHclTerraform(struct?: DataSbercloudFgsApplicationTemplatesTemplates): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudFgsApplicationTemplatesTemplatesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudFgsApplicationTemplatesTemplates | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudFgsApplicationTemplatesTemplates | undefined) {
    if (value === undefined) {
...
export class DataSbercloudFgsApplicationTemplatesTemplatesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudFgsApplicationTemplatesTemplatesOutputReference {
    return new DataSbercloudFgsApplicationTemplatesTemplatesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudFgsApplicationTemplates extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_fgs_application_templates";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_fgs_application_templates", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudFgsApplicationTemplatesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudFgsApplicationTemplatesConfig = {}) {
    super(scope, id, {
  ...
  private _templates = new DataSbercloudFgsApplicationTemplatesTemplatesList(this, "templates", false);
