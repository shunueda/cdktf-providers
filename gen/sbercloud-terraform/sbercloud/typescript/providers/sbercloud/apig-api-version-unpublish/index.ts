...
export class ApigApiVersionUnpublish extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_apig_api_version_unpublish";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_apig_api_version_unpublish", importId: importFromId, provider });
      }
  ...
  * @param options ApigApiVersionUnpublishConfig
  */
  public constructor(scope: Construct, id: string, config: ApigApiVersionUnpublishConfig) {
    super(scope, id, {
