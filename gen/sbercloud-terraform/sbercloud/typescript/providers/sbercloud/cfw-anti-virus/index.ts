// https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/cfw_anti_virus
...
export interface CfwAntiVirusConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/cfw_anti_virus#enable_force_new CfwAntiVirus#enable_force_new}
  */
  readonly enableForceNew?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/cfw_anti_virus#id CfwAntiVirus#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/cfw_anti_virus#object_id CfwAntiVirus#object_id}
  */
  readonly objectId: string;
  /**
  * The region in which to create the resource. If omitted, the provider-level region will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/cfw_anti_virus#region CfwAntiVirus#region}
  */
  readonly region?: string;
  /**
  * scan_protocol_configs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/cfw_anti_virus#scan_protocol_configs CfwAntiVirus#scan_protocol_configs}
  */
...
export interface CfwAntiVirusScanProtocolConfigs {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/cfw_anti_virus#action CfwAntiVirus#action}
  */
  readonly action: number;
  /**
  * The protocol type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/cfw_anti_virus#protocol_type CfwAntiVirus#protocol_type}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/cfw_anti_virus sbercloud_cfw_anti_virus}
*/
export class CfwAntiVirus extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CfwAntiVirus that should be imported. Refer to the {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/cfw_anti_virus#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/sbercloud-terraform/sbercloud/1.12.15/docs/resources/cfw_anti_virus sbercloud_cfw_anti_virus} Resource
  *
  * @param scope The scope in which to define this construct
