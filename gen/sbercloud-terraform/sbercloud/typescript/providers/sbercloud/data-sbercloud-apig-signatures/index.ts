...
export interface DataSbercloudApigSignaturesConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudApigSignaturesSignatures {
}

export function dataSbercloudApigSignaturesSignaturesToTerraform(struct?: DataSbercloudApigSignaturesSignatures): any {
...
export function dataSbercloudApigSignaturesSignaturesToHclTerraform(struct?: DataSbercloudApigSignaturesSignatures): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudApigSignaturesSignaturesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudApigSignaturesSignatures | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudApigSignaturesSignatures | undefined) {
    if (value === undefined) {
...
export class DataSbercloudApigSignaturesSignaturesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudApigSignaturesSignaturesOutputReference {
    return new DataSbercloudApigSignaturesSignaturesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudApigSignatures extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_apig_signatures";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_apig_signatures", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudApigSignaturesConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudApigSignaturesConfig) {
    super(scope, id, {
  ...
  private _signatures = new DataSbercloudApigSignaturesSignaturesList(this, "signatures", false);
