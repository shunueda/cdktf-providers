...
export function dataSbercloudIdentityUsersUsersToTerraform(struct?: DataSbercloudIdentityUsersUsers): any {
...
export function dataSbercloudIdentityUsersUsersToHclTerraform(struct?: DataSbercloudIdentityUsersUsers): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudIdentityUsersUsersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudIdentityUsersUsers | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudIdentityUsersUsers | undefined) {
    if (value === undefined) {
...
export class DataSbercloudIdentityUsersUsersList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudIdentityUsersUsersOutputReference {
    return new DataSbercloudIdentityUsersUsersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudIdentityUsers extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_identity_users";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_identity_users", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudIdentityUsersConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudIdentityUsersConfig = {}) {
    super(scope, id, {
