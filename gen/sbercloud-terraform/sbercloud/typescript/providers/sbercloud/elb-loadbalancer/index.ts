...
export class ElbLoadbalancer extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_elb_loadbalancer";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_elb_loadbalancer", importId: importFromId, provider });
      }
  ...
  */
  ...
  // elb_virsubnet_type - computed: true, optional: false, required: false
  public get elbVirsubnetType() {
    return this.getStringAttribute('elb_virsubnet_type');
  }
