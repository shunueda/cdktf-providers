...
export interface DmsKafkaInstancePortProtocols {
}

export function dmsKafkaInstancePortProtocolsToTerraform(struct?: DmsKafkaInstancePortProtocols): any {
...
export function dmsKafkaInstancePortProtocolsToHclTerraform(struct?: DmsKafkaInstancePortProtocols): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DmsKafkaInstancePortProtocolsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DmsKafkaInstancePortProtocols | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DmsKafkaInstancePortProtocols | undefined) {
    if (value === undefined) {
...
export class DmsKafkaInstancePortProtocolsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DmsKafkaInstancePortProtocolsOutputReference {
    return new DmsKafkaInstancePortProtocolsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function dmsKafkaInstancePortProtocolToTerraform(struct?: DmsKafkaInstancePortProtocolOutputReference | DmsKafkaInstancePortProtocol): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    private_plain_enable: cdktf.booleanToTerraform(struct!.privatePlainEnable),
    private_sasl_plaintext_enable: cdktf.booleanToTerraform(struct!.privateSaslPlaintextEnable),
    private_sasl_ssl_enable: cdktf.booleanToTerraform(struct!.privateSaslSslEnable),
    public_plain_enable: cdktf.booleanToTerraform(struct!.publicPlainEnable),
    public_sasl_plaintext_enable: cdktf.booleanToTerraform(struct!.publicSaslPlaintextEnable),
    public_sasl_ssl_enable: cdktf.booleanToTerraform(struct!.publicSaslSslEnable),
  }
}


export function dmsKafkaInstancePortProtocolToHclTerraform(struct?: DmsKafkaInstancePortProtocolOutputReference | DmsKafkaInstancePortProtocol): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    private_plain_enable: {
      value: cdktf.booleanToHclTerraform(struct!.privatePlainEnable),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    private_sasl_plaintext_enable: {
      value: cdktf.booleanToHclTerraform(struct!.privateSaslPlaintextEnable),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    private_sasl_ssl_enable: {
      value: cdktf.booleanToHclTerraform(struct!.privateSaslSslEnable),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    public_plain_enable: {
      value: cdktf.booleanToHclTerraform(struct!.publicPlainEnable),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    public_sasl_plaintext_enable: {
      value: cdktf.booleanToHclTerraform(struct!.publicSaslPlaintextEnable),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    public_sasl_ssl_enable: {
      value: cdktf.booleanToHclTerraform(struct!.publicSaslSslEnable),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
...
export class DmsKafkaInstancePortProtocolOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DmsKafkaInstancePortProtocol | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._privatePlainEnable !== undefined) {
      hasAnyValues = true;
      internalValueResult.privatePlainEnable = this._privatePlainEnable;
    }
    if (this._privateSaslPlaintextEnable !== undefined) {
      hasAnyValues = true;
      internalValueResult.privateSaslPlaintextEnable = this._privateSaslPlaintextEnable;
    }
    if (this._privateSaslSslEnable !== undefined) {
      hasAnyValues = true;
      internalValueResult.privateSaslSslEnable = this._privateSaslSslEnable;
    }
    if (this._publicPlainEnable !== undefined) {
      hasAnyValues = true;
      internalValueResult.publicPlainEnable = this._publicPlainEnable;
    }
    if (this._publicSaslPlaintextEnable !== undefined) {
      hasAnyValues = true;
      internalValueResult.publicSaslPlaintextEnable = this._publicSaslPlaintextEnable;
    }
    if (this._publicSaslSslEnable !== undefined) {
      hasAnyValues = true;
      internalValueResult.publicSaslSslEnable = this._publicSaslSslEnable;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DmsKafkaInstancePortProtocol | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._privatePlainEnable = undefined;
      this._privateSaslPlaintextEnable = undefined;
      this._privateSaslSslEnable = undefined;
      this._publicPlainEnable = undefined;
      this._publicSaslPlaintextEnable = undefined;
      this._publicSaslSslEnable = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._privatePlainEnable = value.privatePlainEnable;
      this._privateSaslPlaintextEnable = value.privateSaslPlaintextEnable;
      this._privateSaslSslEnable = value.privateSaslSslEnable;
      this._publicPlainEnable = value.publicPlainEnable;
      this._publicSaslPlaintextEnable = value.publicSaslPlaintextEnable;
      this._publicSaslSslEnable = value.publicSaslSslEnable;
    }
  }
  ...
  // private_plain_enable - computed: true, optional: true, required: false
  private _privatePlainEnable?: boolean | cdktf.IResolvable; 
  public get privatePlainEnable() {
    return this.getBooleanAttribute('private_plain_enable');
  }
  public set privatePlainEnable(value: boolean | cdktf.IResolvable) {
    this._privatePlainEnable = value;
  }
  public resetPrivatePlainEnable() {
    this._privatePlainEnable = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get privatePlainEnableInput() {
    return this._privatePlainEnable;
  }
  ...
  // private_sasl_plaintext_enable - computed: true, optional: true, required: false
  private _privateSaslPlaintextEnable?: boolean | cdktf.IResolvable; 
  public get privateSaslPlaintextEnable() {
    return this.getBooleanAttribute('private_sasl_plaintext_enable');
  }
  public set privateSaslPlaintextEnable(value: boolean | cdktf.IResolvable) {
    this._privateSaslPlaintextEnable = value;
  }
  public resetPrivateSaslPlaintextEnable() {
    this._privateSaslPlaintextEnable = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get privateSaslPlaintextEnableInput() {
    return this._privateSaslPlaintextEnable;
  }
  ...
  // private_sasl_ssl_enable - computed: true, optional: true, required: false
  private _privateSaslSslEnable?: boolean | cdktf.IResolvable; 
  public get privateSaslSslEnable() {
    return this.getBooleanAttribute('private_sasl_ssl_enable');
  }
  public set privateSaslSslEnable(value: boolean | cdktf.IResolvable) {
    this._privateSaslSslEnable = value;
  }
  public resetPrivateSaslSslEnable() {
    this._privateSaslSslEnable = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get privateSaslSslEnableInput() {
    return this._privateSaslSslEnable;
  }
  ...
  // public_plain_enable - computed: true, optional: true, required: false
  private _publicPlainEnable?: boolean | cdktf.IResolvable; 
  public get publicPlainEnable() {
    return this.getBooleanAttribute('public_plain_enable');
  }
  public set publicPlainEnable(value: boolean | cdktf.IResolvable) {
    this._publicPlainEnable = value;
  }
  public resetPublicPlainEnable() {
    this._publicPlainEnable = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get publicPlainEnableInput() {
    return this._publicPlainEnable;
  }
  ...
  // public_sasl_plaintext_enable - computed: true, optional: true, required: false
  private _publicSaslPlaintextEnable?: boolean | cdktf.IResolvable; 
  public get publicSaslPlaintextEnable() {
    return this.getBooleanAttribute('public_sasl_plaintext_enable');
  }
  public set publicSaslPlaintextEnable(value: boolean | cdktf.IResolvable) {
    this._publicSaslPlaintextEnable = value;
  }
  public resetPublicSaslPlaintextEnable() {
    this._publicSaslPlaintextEnable = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get publicSaslPlaintextEnableInput() {
    return this._publicSaslPlaintextEnable;
  }
  ...
  // public_sasl_ssl_enable - computed: true, optional: true, required: false
  private _publicSaslSslEnable?: boolean | cdktf.IResolvable; 
  public get publicSaslSslEnable() {
    return this.getBooleanAttribute('public_sasl_ssl_enable');
  }
  public set publicSaslSslEnable(value: boolean | cdktf.IResolvable) {
    this._publicSaslSslEnable = value;
  }
  public resetPublicSaslSslEnable() {
    this._publicSaslSslEnable = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get publicSaslSslEnableInput() {
    return this._publicSaslSslEnable;
  }
}
...
export class DmsKafkaInstance extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_dms_kafka_instance";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_dms_kafka_instance", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: DmsKafkaInstanceConfig) {
    ...
    this._portProtocol.internalValue = config.portProtocol;
  ...
  private _portProtocols = new DmsKafkaInstancePortProtocolsList(this, "port_protocols", false);
  ...
  private _portProtocol = new DmsKafkaInstancePortProtocolOutputReference(this, "port_protocol");
  public get portProtocol() {
    return this._portProtocol;
  }
  public putPortProtocol(value: DmsKafkaInstancePortProtocol) {
    this._portProtocol.internalValue = value;
  }
  public resetPortProtocol() {
    this._portProtocol.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get portProtocolInput() {
    return this._portProtocol.internalValue;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      port_protocol: dmsKafkaInstancePortProtocolToTerraform(this._portProtocol.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      port_protocol: {
        value: dmsKafkaInstancePortProtocolToHclTerraform(this._portProtocol.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DmsKafkaInstancePortProtocolList",
      },
      timeouts: {
