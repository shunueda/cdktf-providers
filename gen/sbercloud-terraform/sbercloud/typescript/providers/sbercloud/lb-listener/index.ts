...
export function lbListenerInsertHeadersToTerraform(struct?: LbListenerInsertHeadersOutputReference | LbListenerInsertHeaders): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    x_forwarded_elb_ip: cdktf.stringToTerraform(struct!.xForwardedElbIp),
    x_forwarded_host: cdktf.stringToTerraform(struct!.xForwardedHost),
  }
}


export function lbListenerInsertHeadersToHclTerraform(struct?: LbListenerInsertHeadersOutputReference | LbListenerInsertHeaders): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    x_forwarded_elb_ip: {
      value: cdktf.stringToHclTerraform(struct!.xForwardedElbIp),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    x_forwarded_host: {
      value: cdktf.stringToHclTerraform(struct!.xForwardedHost),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class LbListenerInsertHeadersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): LbListenerInsertHeaders | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._xForwardedElbIp !== undefined) {
      hasAnyValues = true;
      internalValueResult.xForwardedElbIp = this._xForwardedElbIp;
    }
  ...
  public set internalValue(value: LbListenerInsertHeaders | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._xForwardedElbIp = undefined;
      this._xForwardedHost = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._xForwardedElbIp = value.xForwardedElbIp;
      this._xForwardedHost = value.xForwardedHost;
    }
  }

  // x_forwarded_elb_ip - computed: true, optional: true, required: false
  private _xForwardedElbIp?: string; 
  public get xForwardedElbIp() {
    return this.getStringAttribute('x_forwarded_elb_ip');
  }
  public set xForwardedElbIp(value: string) {
    this._xForwardedElbIp = value;
  }
  public resetXForwardedElbIp() {
    this._xForwardedElbIp = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get xForwardedElbIpInput() {
    return this._xForwardedElbIp;
  }
...
export class LbListener extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_lb_listener";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_lb_listener", importId: importFromId, provider });
      }
  ...
  */
  ...
  // sni_container_refs - computed: true, optional: true, required: false
  ...
  private _insertHeaders = new LbListenerInsertHeadersOutputReference(this, "insert_headers");
  public get insertHeaders() {
    return this._insertHeaders;
  }
  public putInsertHeaders(value: LbListenerInsertHeaders) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      insert_headers: lbListenerInsertHeadersToTerraform(this._insertHeaders.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      insert_headers: {
        value: lbListenerInsertHeadersToHclTerraform(this._insertHeaders.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "LbListenerInsertHeadersList",
      },
      timeouts: {
