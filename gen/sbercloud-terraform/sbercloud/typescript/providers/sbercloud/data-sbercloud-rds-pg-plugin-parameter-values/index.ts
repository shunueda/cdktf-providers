...
export class DataSbercloudRdsPgPluginParameterValues extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_rds_pg_plugin_parameter_values";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_rds_pg_plugin_parameter_values", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudRdsPgPluginParameterValuesConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudRdsPgPluginParameterValuesConfig) {
    super(scope, id, {
