...
export interface DataSbercloudKpsKeypairsKeypairs {
}

export function dataSbercloudKpsKeypairsKeypairsToTerraform(struct?: DataSbercloudKpsKeypairsKeypairs): any {
...
export function dataSbercloudKpsKeypairsKeypairsToHclTerraform(struct?: DataSbercloudKpsKeypairsKeypairs): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudKpsKeypairsKeypairsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudKpsKeypairsKeypairs | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudKpsKeypairsKeypairs | undefined) {
    if (value === undefined) {
...
export class DataSbercloudKpsKeypairsKeypairsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudKpsKeypairsKeypairsOutputReference {
    return new DataSbercloudKpsKeypairsKeypairsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudKpsKeypairs extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_kps_keypairs";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_kps_keypairs", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudKpsKeypairsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudKpsKeypairsConfig = {}) {
    super(scope, id, {
  ...
  private _keypairs = new DataSbercloudKpsKeypairsKeypairsList(this, "keypairs", false);
  public get keypairs() {
