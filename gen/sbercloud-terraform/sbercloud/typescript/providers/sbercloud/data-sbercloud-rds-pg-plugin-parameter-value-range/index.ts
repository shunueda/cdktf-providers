...
export class DataSbercloudRdsPgPluginParameterValueRange extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_rds_pg_plugin_parameter_value_range";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_rds_pg_plugin_parameter_value_range", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudRdsPgPluginParameterValueRangeConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudRdsPgPluginParameterValueRangeConfig) {
    super(scope, id, {
