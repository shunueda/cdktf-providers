...
export interface DataSbercloudSfsTurboDataTasksTasks {
}

export function dataSbercloudSfsTurboDataTasksTasksToTerraform(struct?: DataSbercloudSfsTurboDataTasksTasks): any {
...
export function dataSbercloudSfsTurboDataTasksTasksToHclTerraform(struct?: DataSbercloudSfsTurboDataTasksTasks): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudSfsTurboDataTasksTasksOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudSfsTurboDataTasksTasks | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudSfsTurboDataTasksTasks | undefined) {
    if (value === undefined) {
  ...
  // dest_prefix - computed: true, optional: false, required: false
  public get destPrefix() {
    return this.getStringAttribute('dest_prefix');
  }

  // dest_target - computed: true, optional: false, required: false
  ...
  // src_prefix - computed: true, optional: false, required: false
  public get srcPrefix() {
    return this.getStringAttribute('src_prefix');
  }

  // src_target - computed: true, optional: false, required: false
...
export class DataSbercloudSfsTurboDataTasksTasksList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudSfsTurboDataTasksTasksOutputReference {
    return new DataSbercloudSfsTurboDataTasksTasksOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudSfsTurboDataTasks extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_sfs_turbo_data_tasks";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_sfs_turbo_data_tasks", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudSfsTurboDataTasksConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudSfsTurboDataTasksConfig) {
    super(scope, id, {
  ...
  private _tasks = new DataSbercloudSfsTurboDataTasksTasksList(this, "tasks", false);
  public get tasks() {
    return this._tasks;
  }
