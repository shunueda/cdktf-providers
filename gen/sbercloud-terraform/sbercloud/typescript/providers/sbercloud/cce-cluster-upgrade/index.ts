...
export class CceClusterUpgrade extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_cce_cluster_upgrade";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_cce_cluster_upgrade", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: CceClusterUpgradeConfig) {
    ...
    this._id = config.id;
    this._isPostcheck = config.isPostcheck;
  ...
  // is_postcheck - computed: false, optional: true, required: false
  private _isPostcheck?: boolean | cdktf.IResolvable; 
  public get isPostcheck() {
    return this.getBooleanAttribute('is_postcheck');
  }
  public set isPostcheck(value: boolean | cdktf.IResolvable) {
    this._isPostcheck = value;
  }
  public resetIsPostcheck() {
    this._isPostcheck = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get isPostcheckInput() {
    return this._isPostcheck;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      is_postcheck: cdktf.booleanToTerraform(this._isPostcheck),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      is_postcheck: {
        value: cdktf.booleanToHclTerraform(this._isPostcheck),
        isBlock: false,
        type: "simple",
