...
export class SfsTurbo extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_sfs_turbo";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_sfs_turbo", importId: importFromId, provider });
      }
  ...
  */
  public constructor(scope: Construct, id: string, config: SfsTurboConfig) {
    ...
    this._autoCreateSecurityGroupRules = config.autoCreateSecurityGroupRules;
  ...
  // auto_create_security_group_rules - computed: false, optional: true, required: false
  private _autoCreateSecurityGroupRules?: string; 
  public get autoCreateSecurityGroupRules() {
    return this.getStringAttribute('auto_create_security_group_rules');
  }
  public set autoCreateSecurityGroupRules(value: string) {
    this._autoCreateSecurityGroupRules = value;
  }
  public resetAutoCreateSecurityGroupRules() {
    this._autoCreateSecurityGroupRules = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get autoCreateSecurityGroupRulesInput() {
    return this._autoCreateSecurityGroupRules;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      auto_create_security_group_rules: cdktf.stringToTerraform(this._autoCreateSecurityGroupRules),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      auto_create_security_group_rules: {
        value: cdktf.stringToHclTerraform(this._autoCreateSecurityGroupRules),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
