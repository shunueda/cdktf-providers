...
export interface DataSbercloudApigApiAssociatedApplicationsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudApigApiAssociatedApplicationsApplications {
}

export function dataSbercloudApigApiAssociatedApplicationsApplicationsToTerraform(struct?: DataSbercloudApigApiAssociatedApplicationsApplications): any {
...
export function dataSbercloudApigApiAssociatedApplicationsApplicationsToHclTerraform(struct?: DataSbercloudApigApiAssociatedApplicationsApplications): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudApigApiAssociatedApplicationsApplicationsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudApigApiAssociatedApplicationsApplications | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudApigApiAssociatedApplicationsApplications | undefined) {
    if (value === undefined) {
...
export class DataSbercloudApigApiAssociatedApplicationsApplicationsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudApigApiAssociatedApplicationsApplicationsOutputReference {
    return new DataSbercloudApigApiAssociatedApplicationsApplicationsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudApigApiAssociatedApplications extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_apig_api_associated_applications";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_apig_api_associated_applications", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudApigApiAssociatedApplicationsConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudApigApiAssociatedApplicationsConfig) {
    super(scope, id, {
  ...
  private _applications = new DataSbercloudApigApiAssociatedApplicationsApplicationsList(this, "applications", false);
