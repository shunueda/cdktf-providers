...
export interface DataSbercloudRdsPgPluginsConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudRdsPgPluginsPlugins {
}

export function dataSbercloudRdsPgPluginsPluginsToTerraform(struct?: DataSbercloudRdsPgPluginsPlugins): any {
...
export function dataSbercloudRdsPgPluginsPluginsToHclTerraform(struct?: DataSbercloudRdsPgPluginsPlugins): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudRdsPgPluginsPluginsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudRdsPgPluginsPlugins | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudRdsPgPluginsPlugins | undefined) {
    if (value === undefined) {
...
export class DataSbercloudRdsPgPluginsPluginsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudRdsPgPluginsPluginsOutputReference {
    return new DataSbercloudRdsPgPluginsPluginsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudRdsPgPlugins extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_rds_pg_plugins";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_rds_pg_plugins", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudRdsPgPluginsConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudRdsPgPluginsConfig) {
    super(scope, id, {
  ...
  private _plugins = new DataSbercloudRdsPgPluginsPluginsList(this, "plugins", false);
  public get plugins() {
