...
export interface DataSbercloudApigApiAssociatedSignaturesConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataSbercloudApigApiAssociatedSignaturesSignatures {
}

export function dataSbercloudApigApiAssociatedSignaturesSignaturesToTerraform(struct?: DataSbercloudApigApiAssociatedSignaturesSignatures): any {
...
export function dataSbercloudApigApiAssociatedSignaturesSignaturesToHclTerraform(struct?: DataSbercloudApigApiAssociatedSignaturesSignatures): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSbercloudApigApiAssociatedSignaturesSignaturesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSbercloudApigApiAssociatedSignaturesSignatures | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSbercloudApigApiAssociatedSignaturesSignatures | undefined) {
    if (value === undefined) {
...
export class DataSbercloudApigApiAssociatedSignaturesSignaturesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSbercloudApigApiAssociatedSignaturesSignaturesOutputReference {
    return new DataSbercloudApigApiAssociatedSignaturesSignaturesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSbercloudApigApiAssociatedSignatures extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "sbercloud_apig_api_associated_signatures";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "sbercloud_apig_api_associated_signatures", importId: importFromId, provider });
      }
  ...
  * @param options DataSbercloudApigApiAssociatedSignaturesConfig
  */
  public constructor(scope: Construct, id: string, config: DataSbercloudApigApiAssociatedSignaturesConfig) {
    super(scope, id, {
  ...
  private _signatures = new DataSbercloudApigApiAssociatedSignaturesSignaturesList(this, "signatures", false);
