// https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check
...
export interface CheckConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#encryption Check#encryption}
  */
  readonly encryption?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#expectedip Check#expectedip}
  */
  readonly expectedip?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#host Check#host}
  */
  readonly host: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#id Check#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#integrationids Check#integrationids}
  */
  readonly integrationids?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#name Check#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#nameserver Check#nameserver}
  */
  readonly nameserver?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#notifyagainevery Check#notifyagainevery}
  */
  readonly notifyagainevery?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#notifywhenbackup Check#notifywhenbackup}
  */
  readonly notifywhenbackup?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#password Check#password}
  */
  readonly password?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#paused Check#paused}
  */
  readonly paused?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#port Check#port}
  */
  readonly port?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#postdata Check#postdata}
  */
  readonly postdata?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#probefilters Check#probefilters}
  */
  readonly probefilters?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#requestheaders Check#requestheaders}
  */
  readonly requestheaders?: { [key: string]: string };
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#resolution Check#resolution}
  */
  readonly resolution?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#responsetime_threshold Check#responsetime_threshold}
  */
  readonly responsetimeThreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#sendnotificationwhendown Check#sendnotificationwhendown}
  */
  readonly sendnotificationwhendown?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#shouldcontain Check#shouldcontain}
  */
  readonly shouldcontain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#shouldnotcontain Check#shouldnotcontain}
  */
  readonly shouldnotcontain?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#stringtoexpect Check#stringtoexpect}
  */
  readonly stringtoexpect?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#stringtosend Check#stringtosend}
  */
  readonly stringtosend?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#tags Check#tags}
  */
  readonly tags?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#teamids Check#teamids}
  */
  readonly teamids?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#type Check#type}
  */
  readonly type: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#url Check#url}
  */
  readonly url?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#userids Check#userids}
  */
  readonly userids?: number[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#username Check#username}
  */
  readonly username?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check pingdom_check}
*/
export class Check extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Check that should be imported. Refer to the {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/spring-media/pingdom/1.21.3/docs/resources/check pingdom_check} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: CheckConfig) {
    ...
    this._expectedip = config.expectedip;
  ...
  // expectedip - computed: false, optional: true, required: false
  private _expectedip?: string; 
  public get expectedip() {
    return this.getStringAttribute('expectedip');
  }
  public set expectedip(value: string) {
    this._expectedip = value;
  }
  public resetExpectedip() {
    this._expectedip = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get expectedipInput() {
    return this._expectedip;
  }
  ...
  // notifyagainevery - computed: true, optional: true, required: false
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      expectedip: cdktf.stringToTerraform(this._expectedip),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      expectedip: {
        value: cdktf.stringToHclTerraform(this._expectedip),
        isBlock: false,
        type: "simple",
