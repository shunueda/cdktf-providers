// https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/organization_settings
...
export class OrganizationSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/organization_settings#import import section} in the documentation of this resource for the id to use
