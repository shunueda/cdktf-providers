// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/rum_retention_filters_order
...
export interface RumRetentionFiltersOrderConfig extends cdktf.TerraformMetaArguments {
  ...
  * RUM application ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/rum_retention_filters_order#application_id RumRetentionFiltersOrder#application_id}
  */
  readonly applicationId: string;
  /**
  * RUM retention filter ID list. The order of IDs in this attribute defines the order of RUM retention filters.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/rum_retention_filters_order#retention_filter_ids RumRetentionFiltersOrder#retention_filter_ids}
  */
  readonly retentionFilterIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/rum_retention_filters_order datadog_rum_retention_filters_order}
*/
export class RumRetentionFiltersOrder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RumRetentionFiltersOrder that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/rum_retention_filters_order#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/rum_retention_filters_order datadog_rum_retention_filters_order} Resource
  *
  * @param scope The scope in which to define this construct
