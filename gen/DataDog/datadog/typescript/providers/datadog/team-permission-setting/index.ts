// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/team_permission_setting
...
export interface TeamPermissionSettingConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/team_permission_setting#action TeamPermissionSetting#action}
  */
  readonly action: string;
  /**
  * ID of the team the team permission setting is associated with.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/team_permission_setting#team_id TeamPermissionSetting#team_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/team_permission_setting#value TeamPermissionSetting#value}
  */
  readonly value: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/team_permission_setting datadog_team_permission_setting}
*/
export class TeamPermissionSetting extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TeamPermissionSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/team_permission_setting#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/team_permission_setting datadog_team_permission_setting} Resource
  *
  * @param scope The scope in which to define this construct
