// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/logs_metric
...
export interface LogsMetricConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/logs_metric#id LogsMetric#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/logs_metric#name LogsMetric#name}
  */
  readonly name: string;
  /**
  * compute block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/logs_metric#compute LogsMetric#compute}
  */
  readonly compute: LogsMetricCompute;
  /**
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/logs_metric#filter LogsMetric#filter}
  */
  readonly filter: LogsMetricFilter;
  /**
  * group_by block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/logs_metric#group_by LogsMetric#group_by}
  */
...
export interface LogsMetricCompute {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/logs_metric#aggregation_type LogsMetric#aggregation_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/logs_metric#include_percentiles LogsMetric#include_percentiles}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/logs_metric#path LogsMetric#path}
  */
...
export interface LogsMetricFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/logs_metric#query LogsMetric#query}
  */
...
export interface LogsMetricGroupBy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/logs_metric#tag_name LogsMetric#tag_name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/logs_metric datadog_logs_metric}
*/
export class LogsMetric extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsMetric that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/logs_metric#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/logs_metric datadog_logs_metric} Resource
  *
  * @param scope The scope in which to define this construct
