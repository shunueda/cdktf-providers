// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/metric_metadata
...
export interface MetricMetadataConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/metric_metadata#description MetricMetadata#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/metric_metadata#id MetricMetadata#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/metric_metadata#metric MetricMetadata#metric}
  */
  readonly metric: string;
  /**
  * Per unit of the metric such as `second` in `bytes per second`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/metric_metadata#per_unit MetricMetadata#per_unit}
  */
  readonly perUnit?: string;
  /**
  * A short name of the metric.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/metric_metadata#short_name MetricMetadata#short_name}
  */
  readonly shortName?: string;
  /**
  * If applicable, statsd flush interval in seconds for the metric.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/metric_metadata#statsd_interval MetricMetadata#statsd_interval}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/metric_metadata#type MetricMetadata#type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/metric_metadata#unit MetricMetadata#unit}
  */
  readonly unit?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/metric_metadata datadog_metric_metadata}
*/
export class MetricMetadata extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MetricMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/metric_metadata#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/metric_metadata datadog_metric_metadata} Resource
  *
  * @param scope The scope in which to define this construct
