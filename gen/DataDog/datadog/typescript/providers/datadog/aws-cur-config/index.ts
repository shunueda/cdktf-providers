// https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/aws_cur_config
...
export class AwsCurConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsCurConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/aws_cur_config#import import section} in the documentation of this resource for the id to use
