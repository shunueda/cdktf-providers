// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/rum_retention_filters
...
export interface DataDatadogRumRetentionFiltersConfig extends cdktf.TerraformMetaArguments {
  ...
  * RUM application ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/rum_retention_filters#application_id DataDatadogRumRetentionFilters#application_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/rum_retention_filters datadog_rum_retention_filters}
*/
export class DataDatadogRumRetentionFilters extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogRumRetentionFilters that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/rum_retention_filters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/rum_retention_filters datadog_rum_retention_filters} Data Source
  *
  * @param scope The scope in which to define this construct
