// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/apm_retention_filter_order
...
export interface ApmRetentionFilterOrderConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/apm_retention_filter_order#filter_ids ApmRetentionFilterOrder#filter_ids}
  */
  readonly filterIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/apm_retention_filter_order datadog_apm_retention_filter_order}
*/
export class ApmRetentionFilterOrder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApmRetentionFilterOrder that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/apm_retention_filter_order#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/apm_retention_filter_order datadog_apm_retention_filter_order} Resource
  *
  * @param scope The scope in which to define this construct
