// https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/apm_retention_filter_order
...
export class ApmRetentionFilterOrder extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApmRetentionFilterOrder that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/apm_retention_filter_order#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/apm_retention_filter_order datadog_apm_retention_filter_order} Resource
  *
  * @param scope The scope in which to define this construct
