// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/workflow_automation
...
export interface WorkflowAutomationConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/workflow_automation#description WorkflowAutomation#description}
  */
  readonly description: string;
  /**
  * Name of the workflow. String length must be at least 1.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/workflow_automation#name WorkflowAutomation#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/workflow_automation#published WorkflowAutomation#published}
  */
  readonly published: boolean | cdktf.IResolvable;
  /**
  * The spec defines what the workflow does.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/workflow_automation#spec_json WorkflowAutomation#spec_json}
  */
  readonly specJson: string;
  /**
  * Tags of the workflow.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/workflow_automation#tags WorkflowAutomation#tags}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/workflow_automation#webhook_secret WorkflowAutomation#webhook_secret}
  */
  readonly webhookSecret?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/workflow_automation datadog_workflow_automation}
*/
export class WorkflowAutomation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowAutomation that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/workflow_automation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/workflow_automation datadog_workflow_automation} Resource
  *
  * @param scope The scope in which to define this construct
