// https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/workflow_automation
...
export class WorkflowAutomation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowAutomation that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/workflow_automation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/workflow_automation datadog_workflow_automation} Resource
  *
  * @param scope The scope in which to define this construct
