// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/dataset
...
export interface DatasetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/dataset#name Dataset#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/dataset#principals Dataset#principals}
  */
  readonly principals: string[];
  /**
  * product_filters block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/dataset#product_filters Dataset#product_filters}
  */
...
export interface DatasetProductFilters {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/dataset#filters Dataset#filters}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/dataset#product Dataset#product}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/dataset datadog_dataset}
*/
export class Dataset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Dataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/dataset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/dataset datadog_dataset} Resource
  *
  * @param scope The scope in which to define this construct
