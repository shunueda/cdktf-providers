// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/role_users
...
export interface DataDatadogRoleUsersConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/role_users#exact_match DataDatadogRoleUsers#exact_match}
  */
  readonly exactMatch?: boolean | cdktf.IResolvable;
  /**
  * Search query, can be user name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/role_users#filter DataDatadogRoleUsers#filter}
  */
  readonly filter?: string;
  /**
  * The role's identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/role_users#role_id DataDatadogRoleUsers#role_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/role_users datadog_role_users}
*/
export class DataDatadogRoleUsers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogRoleUsers that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/role_users#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/role_users datadog_role_users} Data Source
  *
  * @param scope The scope in which to define this construct
