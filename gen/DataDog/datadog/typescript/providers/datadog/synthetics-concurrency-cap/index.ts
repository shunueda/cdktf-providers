// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/synthetics_concurrency_cap
...
export interface SyntheticsConcurrencyCapConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/synthetics_concurrency_cap#on_demand_concurrency_cap SyntheticsConcurrencyCap#on_demand_concurrency_cap}
  */
  readonly onDemandConcurrencyCap: number;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/synthetics_concurrency_cap datadog_synthetics_concurrency_cap}
*/
export class SyntheticsConcurrencyCap extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SyntheticsConcurrencyCap that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/synthetics_concurrency_cap#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/synthetics_concurrency_cap datadog_synthetics_concurrency_cap} Resource
  *
  * @param scope The scope in which to define this construct
