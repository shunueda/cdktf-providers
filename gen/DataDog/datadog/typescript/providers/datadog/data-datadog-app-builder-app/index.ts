// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/app_builder_app
...
export interface DataDatadogAppBuilderAppConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID for the App.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/app_builder_app#id DataDatadogAppBuilderApp#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/app_builder_app datadog_app_builder_app}
*/
export class DataDatadogAppBuilderApp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogAppBuilderApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/app_builder_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/app_builder_app datadog_app_builder_app} Data Source
  *
  * @param scope The scope in which to define this construct
