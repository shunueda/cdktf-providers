// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/apm_retention_filters_order
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/apm_retention_filters_order datadog_apm_retention_filters_order}
*/
export class DataDatadogApmRetentionFiltersOrder extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogApmRetentionFiltersOrder that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/apm_retention_filters_order#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/apm_retention_filters_order datadog_apm_retention_filters_order} Data Source
  *
  * @param scope The scope in which to define this construct
