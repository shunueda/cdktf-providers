// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/csm_threats_policies
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/csm_threats_policies datadog_csm_threats_policies}
*/
export class DataDatadogCsmThreatsPolicies extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogCsmThreatsPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/csm_threats_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/csm_threats_policies datadog_csm_threats_policies} Data Source
  *
  * @param scope The scope in which to define this construct
