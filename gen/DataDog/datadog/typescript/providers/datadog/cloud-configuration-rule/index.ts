// https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/cloud_configuration_rule
...
export interface CloudConfigurationRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/cloud_configuration_rule#group_by CloudConfigurationRule#group_by}
  */
...
export class CloudConfigurationRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudConfigurationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/cloud_configuration_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/cloud_configuration_rule datadog_cloud_configuration_rule} Resource
  *
  * @param scope The scope in which to define this construct
