// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule
...
export interface CloudConfigurationRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#enabled CloudConfigurationRule#enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#group_by CloudConfigurationRule#group_by}
  */
  readonly groupBy?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#id CloudConfigurationRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#message CloudConfigurationRule#message}
  */
  readonly message: string;
  /**
  * The name of the cloud configuration rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#name CloudConfigurationRule#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#notifications CloudConfigurationRule#notifications}
  */
  readonly notifications?: string[];
  /**
  * Policy written in Rego format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#policy CloudConfigurationRule#policy}
  */
  readonly policy: string;
  /**
  * Related resource types to be checked by the rule. Defaults to empty list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#related_resource_types CloudConfigurationRule#related_resource_types}
  */
  readonly relatedResourceTypes?: string[];
  /**
  * Main resource type to be checked by the rule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#resource_type CloudConfigurationRule#resource_type}
  */
  readonly resourceType: string;
  /**
  * Severity of the rule and associated signals. Valid values are `info`, `low`, `medium`, `high`, `critical`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#severity CloudConfigurationRule#severity}
  */
  readonly severity: string;
  /**
  * Tags of the rule, propagated to findings and signals. Defaults to empty list.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#tags CloudConfigurationRule#tags}
  */
  readonly tags?: string[];
  /**
  * filter block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#filter CloudConfigurationRule#filter}
  */
...
export interface CloudConfigurationRuleFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#action CloudConfigurationRule#action}
  */
  readonly action: string;
  /**
  * Query for selecting logs to apply the filtering action.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#query CloudConfigurationRule#query}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule datadog_cloud_configuration_rule}
*/
export class CloudConfigurationRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudConfigurationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/cloud_configuration_rule datadog_cloud_configuration_rule} Resource
  *
  * @param scope The scope in which to define this construct
