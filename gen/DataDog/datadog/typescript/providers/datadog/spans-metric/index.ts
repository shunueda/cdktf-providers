// https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/spans_metric
...
export class SpansMetric extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpansMetric that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/spans_metric#import import section} in the documentation of this resource for the id to use
