// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy
...
export interface OnCallEscalationPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy#name OnCallEscalationPolicy#name}
  */
  readonly name: string;
  /**
  * If true, pages will be automatically resolved if unacknowledged after the final step. Defaults to `false`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy#resolve_page_on_policy_end OnCallEscalationPolicy#resolve_page_on_policy_end}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy#retries OnCallEscalationPolicy#retries}
  */
  readonly retries?: number;
  /**
  * A list of team ids associated with the escalation policy.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy#teams OnCallEscalationPolicy#teams}
  */
  readonly teams?: string[];
  /**
  * step block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy#step OnCallEscalationPolicy#step}
  */
...
export interface OnCallEscalationPolicyStepTarget {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy#position OnCallEscalationPolicy#position}
  */
  readonly position?: string;
  /**
  * Targeted schedule ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy#schedule OnCallEscalationPolicy#schedule}
  */
  readonly schedule?: string;
  /**
  * Targeted team ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy#team OnCallEscalationPolicy#team}
  */
  readonly team?: string;
  /**
  * Targeted user ID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy#user OnCallEscalationPolicy#user}
  */
...
export interface OnCallEscalationPolicyStep {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy#assignment OnCallEscalationPolicy#assignment}
  */
  readonly assignment?: string;
  /**
  * Defines how many seconds to wait before escalating to the next step. Value must be between 60 and 36000.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy#escalate_after_seconds OnCallEscalationPolicy#escalate_after_seconds}
  */
  readonly escalateAfterSeconds: number;
  /**
  * target block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy#target OnCallEscalationPolicy#target}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy datadog_on_call_escalation_policy}
*/
export class OnCallEscalationPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OnCallEscalationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/on_call_escalation_policy datadog_on_call_escalation_policy} Resource
  *
  * @param scope The scope in which to define this construct
