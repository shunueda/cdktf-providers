// https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/ip_allowlist
...
export class IpAllowlist extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpAllowlist that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/ip_allowlist#import import section} in the documentation of this resource for the id to use
