// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/ip_allowlist
...
export interface IpAllowlistConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/ip_allowlist#enabled IpAllowlist#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
  /**
  * entry block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/ip_allowlist#entry IpAllowlist#entry}
  */
...
export interface IpAllowlistEntry {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/ip_allowlist#cidr_block IpAllowlist#cidr_block}
  */
  readonly cidrBlock: string;
  /**
  * Note accompanying IP address.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/ip_allowlist#note IpAllowlist#note}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/ip_allowlist datadog_ip_allowlist}
*/
export class IpAllowlist extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IpAllowlist that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/ip_allowlist#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/ip_allowlist datadog_ip_allowlist} Resource
  *
  * @param scope The scope in which to define this construct
