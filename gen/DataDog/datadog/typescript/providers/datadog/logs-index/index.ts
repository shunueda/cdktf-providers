// https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/logs_index
...
export class LogsIndex extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogsIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/logs_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/logs_index datadog_logs_index} Resource
  *
  * @param scope The scope in which to define this construct
