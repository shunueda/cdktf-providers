// https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/app_builder_app
...
export class AppBuilderApp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppBuilderApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/app_builder_app#import import section} in the documentation of this resource for the id to use
