// https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/appsec_waf_exclusion_filter
...
export class AppsecWafExclusionFilter extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppsecWafExclusionFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/appsec_waf_exclusion_filter#import import section} in the documentation of this resource for the id to use
