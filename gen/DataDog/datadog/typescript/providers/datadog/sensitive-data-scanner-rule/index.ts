// https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/sensitive_data_scanner_rule
...
export class SensitiveDataScannerRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SensitiveDataScannerRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/sensitive_data_scanner_rule#import import section} in the documentation of this resource for the id to use
