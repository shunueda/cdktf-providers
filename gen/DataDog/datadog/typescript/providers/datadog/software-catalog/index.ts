// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/software_catalog
...
export interface SoftwareCatalogConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/software_catalog#entity SoftwareCatalog#entity}
  */
  readonly entity: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/software_catalog datadog_software_catalog}
*/
export class SoftwareCatalog extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SoftwareCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/software_catalog#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/software_catalog datadog_software_catalog} Resource
  *
  * @param scope The scope in which to define this construct
