// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/teams
...
export interface DataDatadogTeamsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/teams#filter_keyword DataDatadogTeams#filter_keyword}
  */
  readonly filterKeyword?: string;
  /**
  * When true, only returns teams the current user belongs to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/teams#filter_me DataDatadogTeams#filter_me}
  */
  readonly filterMe?: boolean | cdktf.IResolvable;
  /**
  * teams block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/teams#teams DataDatadogTeams#teams}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/teams datadog_teams}
*/
export class DataDatadogTeams extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogTeams that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/teams#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/teams datadog_teams} Data Source
  *
  * @param scope The scope in which to define this construct
