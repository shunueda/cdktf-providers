// https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/security_monitoring_rule
...
export class SecurityMonitoringRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityMonitoringRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/security_monitoring_rule#import import section} in the documentation of this resource for the id to use
