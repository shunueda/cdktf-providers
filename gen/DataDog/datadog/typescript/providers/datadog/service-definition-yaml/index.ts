// https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/service_definition_yaml
...
export class ServiceDefinitionYaml extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceDefinitionYaml that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/service_definition_yaml#import import section} in the documentation of this resource for the id to use
