// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/gcp_uc_config
...
export interface GcpUcConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/gcp_uc_config#billing_account_id GcpUcConfig#billing_account_id}
  */
  readonly billingAccountId: string;
  /**
  * The Google Cloud bucket name used to store the Usage Cost export.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/gcp_uc_config#bucket_name GcpUcConfig#bucket_name}
  */
  readonly bucketName: string;
  /**
  * The export dataset name used for the Google Cloud Usage Cost report.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/gcp_uc_config#export_dataset_name GcpUcConfig#export_dataset_name}
  */
  readonly exportDatasetName: string;
  /**
  * The export prefix used for the Google Cloud Usage Cost report.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/gcp_uc_config#export_prefix GcpUcConfig#export_prefix}
  */
  readonly exportPrefix?: string;
  /**
  * The name of the Google Cloud Usage Cost report.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/gcp_uc_config#export_project_name GcpUcConfig#export_project_name}
  */
  readonly exportProjectName: string;
  /**
  * The unique Google Cloud service account email.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/gcp_uc_config#service_account GcpUcConfig#service_account}
  */
  readonly serviceAccount: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/gcp_uc_config datadog_gcp_uc_config}
*/
export class GcpUcConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GcpUcConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/gcp_uc_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/gcp_uc_config datadog_gcp_uc_config} Resource
  *
  * @param scope The scope in which to define this construct
