// https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule
...
export interface DowntimeScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#display_timezone DowntimeSchedule#display_timezone}
  */
  readonly displayTimezone?: string;
  /**
  * A message to include with notifications for this downtime. Email notifications can be sent to specific users by using the same `@username` notation as events.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#message DowntimeSchedule#message}
  */
  readonly message?: string;
  /**
  * If the first recovery notification during a downtime should be muted.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#mute_first_recovery_notification DowntimeSchedule#mute_first_recovery_notification}
  */
  readonly muteFirstRecoveryNotification?: boolean | cdktf.IResolvable;
  /**
  * States that will trigger a monitor notification when the `notify_end_types` action occurs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#notify_end_states DowntimeSchedule#notify_end_states}
  */
  readonly notifyEndStates?: string[];
  /**
  * Actions that will trigger a monitor notification if the downtime is in the `notify_end_types` state.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#notify_end_types DowntimeSchedule#notify_end_types}
  */
  readonly notifyEndTypes?: string[];
  /**
  * The scope to which the downtime applies. Must follow the [common search syntax](https://docs.datadoghq.com/logs/explorer/search_syntax/).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#scope DowntimeSchedule#scope}
  */
  readonly scope: string;
  /**
  * monitor_identifier block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#monitor_identifier DowntimeSchedule#monitor_identifier}
  */
  readonly monitorIdentifier?: DowntimeScheduleMonitorIdentifier;
  /**
  * one_time_schedule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#one_time_schedule DowntimeSchedule#one_time_schedule}
  */
  readonly oneTimeSchedule?: DowntimeScheduleOneTimeSchedule;
  /**
  * recurring_schedule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#recurring_schedule DowntimeSchedule#recurring_schedule}
  */
...
export interface DowntimeScheduleMonitorIdentifier {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#monitor_id DowntimeSchedule#monitor_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#monitor_tags DowntimeSchedule#monitor_tags}
  */
...
export interface DowntimeScheduleOneTimeSchedule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#end DowntimeSchedule#end}
  */
  readonly end?: string;
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#start DowntimeSchedule#start}
  */
...
export interface DowntimeScheduleRecurringScheduleRecurrence {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#duration DowntimeSchedule#duration}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#rrule DowntimeSchedule#rrule}
  */
...
export interface DowntimeScheduleRecurringSchedule {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#timezone DowntimeSchedule#timezone}
  */
  readonly timezone?: string;
  /**
  * recurrence block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#recurrence DowntimeSchedule#recurrence}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule datadog_downtime_schedule}
*/
export class DowntimeSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DowntimeSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/downtime_schedule datadog_downtime_schedule} Resource
  *
  * @param scope The scope in which to define this construct
