// https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/domain_allowlist
...
export class DomainAllowlist extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DomainAllowlist that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/domain_allowlist#import import section} in the documentation of this resource for the id to use
