// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/domain_allowlist
...
export interface DomainAllowlistConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/domain_allowlist#domains DomainAllowlist#domains}
  */
  readonly domains: string[];
  /**
  * Whether the Email Domain Allowlist is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/domain_allowlist#enabled DomainAllowlist#enabled}
  */
  readonly enabled: boolean | cdktf.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/domain_allowlist datadog_domain_allowlist}
*/
export class DomainAllowlist extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DomainAllowlist that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/domain_allowlist#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/domain_allowlist datadog_domain_allowlist} Resource
  *
  * @param scope The scope in which to define this construct
