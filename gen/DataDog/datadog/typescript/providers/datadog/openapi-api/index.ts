// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/openapi_api
...
export interface OpenapiApiConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/openapi_api#spec OpenapiApi#spec}
  */
  readonly spec: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/openapi_api datadog_openapi_api}
*/
export class OpenapiApi extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OpenapiApi that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/openapi_api#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/openapi_api datadog_openapi_api} Resource
  *
  * @param scope The scope in which to define this construct
