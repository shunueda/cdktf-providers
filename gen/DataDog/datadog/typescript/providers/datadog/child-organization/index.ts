// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/child_organization
...
export interface ChildOrganizationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/child_organization#id ChildOrganization#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/child_organization#name ChildOrganization#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/child_organization datadog_child_organization}
*/
export class ChildOrganization extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChildOrganization that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/child_organization#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/child_organization datadog_child_organization} Resource
  *
  * @param scope The scope in which to define this construct
