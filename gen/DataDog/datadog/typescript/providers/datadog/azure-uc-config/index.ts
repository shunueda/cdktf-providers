// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/azure_uc_config
...
export interface AzureUcConfigConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/azure_uc_config#account_id AzureUcConfig#account_id}
  */
  readonly accountId: string;
  /**
  * The client ID of the Azure account.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/azure_uc_config#client_id AzureUcConfig#client_id}
  */
  readonly clientId: string;
  /**
  * The scope of your observed subscription.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/azure_uc_config#scope AzureUcConfig#scope}
  */
  readonly scope: string;
  /**
  * actual_bill_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/azure_uc_config#actual_bill_config AzureUcConfig#actual_bill_config}
  */
  readonly actualBillConfig: AzureUcConfigActualBillConfig;
  /**
  * amortized_bill_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/azure_uc_config#amortized_bill_config AzureUcConfig#amortized_bill_config}
  */
...
export interface AzureUcConfigActualBillConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/azure_uc_config#export_name AzureUcConfig#export_name}
  */
  readonly exportName: string;
  /**
  * The path where the Azure Export is saved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/azure_uc_config#export_path AzureUcConfig#export_path}
  */
  readonly exportPath: string;
  /**
  * The name of the storage account where the Azure Export is saved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/azure_uc_config#storage_account AzureUcConfig#storage_account}
  */
  readonly storageAccount: string;
  /**
  * The name of the storage container where the Azure Export is saved.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/azure_uc_config#storage_container AzureUcConfig#storage_container}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/azure_uc_config datadog_azure_uc_config}
*/
export class AzureUcConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AzureUcConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/azure_uc_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/azure_uc_config datadog_azure_uc_config} Resource
  *
  * @param scope The scope in which to define this construct
