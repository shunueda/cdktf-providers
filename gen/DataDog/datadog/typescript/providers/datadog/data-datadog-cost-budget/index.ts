// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/cost_budget
...
export interface DataDatadogCostBudgetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/cost_budget#id DataDatadogCostBudget#id}
  *
  ...
  * entries block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/cost_budget#entries DataDatadogCostBudget#entries}
  */
...
export interface DataDatadogCostBudgetEntries {
  ...
  * tag_filters block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/cost_budget#tag_filters DataDatadogCostBudget#tag_filters}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/cost_budget datadog_cost_budget}
*/
export class DataDatadogCostBudget extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogCostBudget that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/cost_budget#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/cost_budget datadog_cost_budget} Data Source
  *
  * @param scope The scope in which to define this construct
