// https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/csm_threats_policy
...
export class CsmThreatsPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CsmThreatsPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/csm_threats_policy#import import section} in the documentation of this resource for the id to use
