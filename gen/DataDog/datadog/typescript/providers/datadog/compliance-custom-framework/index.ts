// https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/compliance_custom_framework
...
export class ComplianceCustomFramework extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComplianceCustomFramework that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/compliance_custom_framework#import import section} in the documentation of this resource for the id to use
