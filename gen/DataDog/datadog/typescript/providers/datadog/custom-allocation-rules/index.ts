// https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/custom_allocation_rules
...
export class CustomAllocationRules extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomAllocationRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/custom_allocation_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/custom_allocation_rules datadog_custom_allocation_rules} Resource
  *
  * @param scope The scope in which to define this construct
