// https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/integration_ms_teams_tenant_based_handle
...
export class IntegrationMsTeamsTenantBasedHandle extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationMsTeamsTenantBasedHandle that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/integration_ms_teams_tenant_based_handle#import import section} in the documentation of this resource for the id to use
