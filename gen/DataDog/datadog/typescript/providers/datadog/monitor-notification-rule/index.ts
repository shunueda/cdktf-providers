// https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/monitor_notification_rule
...
export class MonitorNotificationRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorNotificationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.79.0/docs/resources/monitor_notification_rule#import import section} in the documentation of this resource for the id to use
