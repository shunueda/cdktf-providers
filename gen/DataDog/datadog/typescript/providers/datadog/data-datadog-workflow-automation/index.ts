// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/workflow_automation
...
export interface DataDatadogWorkflowAutomationConfig extends cdktf.TerraformMetaArguments {
  ...
  * ID of the workflow.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/workflow_automation#id DataDatadogWorkflowAutomation#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/workflow_automation datadog_workflow_automation}
*/
export class DataDatadogWorkflowAutomation extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataDatadogWorkflowAutomation that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/workflow_automation#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/data-sources/workflow_automation datadog_workflow_automation} Data Source
  *
  * @param scope The scope in which to define this construct
