// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/monitor_config_policy
...
export interface MonitorConfigPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/monitor_config_policy#id MonitorConfigPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/monitor_config_policy#policy_type MonitorConfigPolicy#policy_type}
  */
  readonly policyType: string;
  /**
  * tag_policy block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/monitor_config_policy#tag_policy MonitorConfigPolicy#tag_policy}
  */
...
export interface MonitorConfigPolicyTagPolicy {
  ...
  * The key of the tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/monitor_config_policy#tag_key MonitorConfigPolicy#tag_key}
  */
  readonly tagKey: string;
  /**
  * If a tag key is required for monitor creation
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/monitor_config_policy#tag_key_required MonitorConfigPolicy#tag_key_required}
  */
  readonly tagKeyRequired: boolean | cdktf.IResolvable;
  /**
  * Valid values for the tag
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/monitor_config_policy#valid_tag_values MonitorConfigPolicy#valid_tag_values}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/monitor_config_policy datadog_monitor_config_policy}
*/
export class MonitorConfigPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorConfigPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/monitor_config_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/monitor_config_policy datadog_monitor_config_policy} Resource
  *
  * @param scope The scope in which to define this construct
