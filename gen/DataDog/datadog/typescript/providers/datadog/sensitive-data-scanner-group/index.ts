// https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/sensitive_data_scanner_group
...
export class SensitiveDataScannerGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SensitiveDataScannerGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.81.0/docs/resources/sensitive_data_scanner_group#import import section} in the documentation of this resource for the id to use
