// https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/tag_pipeline_rulesets
...
export interface TagPipelineRulesetsConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/tag_pipeline_rulesets#override_ui_defined_resources TagPipelineRulesets#override_ui_defined_resources}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/tag_pipeline_rulesets#ruleset_ids TagPipelineRulesets#ruleset_ids}
  */
  readonly rulesetIds: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/tag_pipeline_rulesets datadog_tag_pipeline_rulesets}
*/
export class TagPipelineRulesets extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TagPipelineRulesets that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/tag_pipeline_rulesets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/datadog/datadog/3.83.0/docs/resources/tag_pipeline_rulesets datadog_tag_pipeline_rulesets} Resource
  *
  * @param scope The scope in which to define this construct
