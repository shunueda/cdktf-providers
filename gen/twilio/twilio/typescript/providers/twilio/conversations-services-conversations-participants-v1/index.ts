// https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1
...
export interface ConversationsServicesConversationsParticipantsV1Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#attributes ConversationsServicesConversationsParticipantsV1#attributes}
  */
  readonly attributes?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#chat_service_sid ConversationsServicesConversationsParticipantsV1#chat_service_sid}
  */
  readonly chatServiceSid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#conversation_sid ConversationsServicesConversationsParticipantsV1#conversation_sid}
  */
  readonly conversationSid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#date_created ConversationsServicesConversationsParticipantsV1#date_created}
  */
  readonly dateCreated?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#date_updated ConversationsServicesConversationsParticipantsV1#date_updated}
  */
  readonly dateUpdated?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#id ConversationsServicesConversationsParticipantsV1#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#identity ConversationsServicesConversationsParticipantsV1#identity}
  */
  readonly identity?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#last_read_message_index ConversationsServicesConversationsParticipantsV1#last_read_message_index}
  */
  readonly lastReadMessageIndex?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#last_read_timestamp ConversationsServicesConversationsParticipantsV1#last_read_timestamp}
  */
  readonly lastReadTimestamp?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#messaging_binding_address ConversationsServicesConversationsParticipantsV1#messaging_binding_address}
  */
  readonly messagingBindingAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#messaging_binding_projected_address ConversationsServicesConversationsParticipantsV1#messaging_binding_projected_address}
  */
  readonly messagingBindingProjectedAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#messaging_binding_proxy_address ConversationsServicesConversationsParticipantsV1#messaging_binding_proxy_address}
  */
  readonly messagingBindingProxyAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#role_sid ConversationsServicesConversationsParticipantsV1#role_sid}
  */
  readonly roleSid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#x_twilio_webhook_enabled ConversationsServicesConversationsParticipantsV1#x_twilio_webhook_enabled}
  */
  readonly xTwilioWebhookEnabled?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1 twilio_conversations_services_conversations_participants_v1}
*/
export class ConversationsServicesConversationsParticipantsV1 extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "twilio_conversations_services_conversations_participants_v1";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a ConversationsServicesConversationsParticipantsV1 resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ConversationsServicesConversationsParticipantsV1 to import
  * @param importFromId The id of the existing ConversationsServicesConversationsParticipantsV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ConversationsServicesConversationsParticipantsV1 to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "twilio_conversations_services_conversations_participants_v1", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_participants_v1 twilio_conversations_services_conversations_participants_v1} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ConversationsServicesConversationsParticipantsV1Config
  */
  public constructor(scope: Construct, id: string, config: ConversationsServicesConversationsParticipantsV1Config) {
    super(scope, id, {
      terraformResourceType: 'twilio_conversations_services_conversations_participants_v1',
