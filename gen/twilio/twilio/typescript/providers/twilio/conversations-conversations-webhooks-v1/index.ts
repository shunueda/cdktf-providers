// https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_conversations_webhooks_v1
...
export interface ConversationsConversationsWebhooksV1Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_conversations_webhooks_v1#configuration_filters ConversationsConversationsWebhooksV1#configuration_filters}
  */
  readonly configurationFilters?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_conversations_webhooks_v1#configuration_flow_sid ConversationsConversationsWebhooksV1#configuration_flow_sid}
  */
  readonly configurationFlowSid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_conversations_webhooks_v1#configuration_method ConversationsConversationsWebhooksV1#configuration_method}
  */
  readonly configurationMethod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_conversations_webhooks_v1#configuration_replay_after ConversationsConversationsWebhooksV1#configuration_replay_after}
  */
  readonly configurationReplayAfter?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_conversations_webhooks_v1#configuration_triggers ConversationsConversationsWebhooksV1#configuration_triggers}
  */
  readonly configurationTriggers?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_conversations_webhooks_v1#configuration_url ConversationsConversationsWebhooksV1#configuration_url}
  */
  readonly configurationUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_conversations_webhooks_v1#conversation_sid ConversationsConversationsWebhooksV1#conversation_sid}
  */
  readonly conversationSid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_conversations_webhooks_v1#id ConversationsConversationsWebhooksV1#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_conversations_webhooks_v1#target ConversationsConversationsWebhooksV1#target}
  */
  readonly target: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_conversations_webhooks_v1 twilio_conversations_conversations_webhooks_v1}
*/
export class ConversationsConversationsWebhooksV1 extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "twilio_conversations_conversations_webhooks_v1";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a ConversationsConversationsWebhooksV1 resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ConversationsConversationsWebhooksV1 to import
  * @param importFromId The id of the existing ConversationsConversationsWebhooksV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_conversations_webhooks_v1#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ConversationsConversationsWebhooksV1 to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "twilio_conversations_conversations_webhooks_v1", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_conversations_webhooks_v1 twilio_conversations_conversations_webhooks_v1} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ConversationsConversationsWebhooksV1Config
  */
  public constructor(scope: Construct, id: string, config: ConversationsConversationsWebhooksV1Config) {
    super(scope, id, {
      terraformResourceType: 'twilio_conversations_conversations_webhooks_v1',
