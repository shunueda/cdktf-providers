// https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1
...
export interface ConversationsServicesConversationsV1Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#attributes ConversationsServicesConversationsV1#attributes}
  */
  readonly attributes?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#bindings_email_address ConversationsServicesConversationsV1#bindings_email_address}
  */
  readonly bindingsEmailAddress?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#bindings_email_name ConversationsServicesConversationsV1#bindings_email_name}
  */
  readonly bindingsEmailName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#chat_service_sid ConversationsServicesConversationsV1#chat_service_sid}
  */
  readonly chatServiceSid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#date_created ConversationsServicesConversationsV1#date_created}
  */
  readonly dateCreated?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#date_updated ConversationsServicesConversationsV1#date_updated}
  */
  readonly dateUpdated?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#friendly_name ConversationsServicesConversationsV1#friendly_name}
  */
  readonly friendlyName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#id ConversationsServicesConversationsV1#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#messaging_service_sid ConversationsServicesConversationsV1#messaging_service_sid}
  */
  readonly messagingServiceSid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#state ConversationsServicesConversationsV1#state}
  */
  readonly state?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#timers_closed ConversationsServicesConversationsV1#timers_closed}
  */
  readonly timersClosed?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#timers_inactive ConversationsServicesConversationsV1#timers_inactive}
  */
  readonly timersInactive?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#unique_name ConversationsServicesConversationsV1#unique_name}
  */
  readonly uniqueName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#x_twilio_webhook_enabled ConversationsServicesConversationsV1#x_twilio_webhook_enabled}
  */
  readonly xTwilioWebhookEnabled?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1 twilio_conversations_services_conversations_v1}
*/
export class ConversationsServicesConversationsV1 extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "twilio_conversations_services_conversations_v1";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a ConversationsServicesConversationsV1 resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ConversationsServicesConversationsV1 to import
  * @param importFromId The id of the existing ConversationsServicesConversationsV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ConversationsServicesConversationsV1 to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "twilio_conversations_services_conversations_v1", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/conversations_services_conversations_v1 twilio_conversations_services_conversations_v1} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ConversationsServicesConversationsV1Config
  */
  public constructor(scope: Construct, id: string, config: ConversationsServicesConversationsV1Config) {
    super(scope, id, {
      terraformResourceType: 'twilio_conversations_services_conversations_v1',
