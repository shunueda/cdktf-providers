// https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/chat_services_channels_webhooks_v2
...
export interface ChatServicesChannelsWebhooksV2Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/chat_services_channels_webhooks_v2#channel_sid ChatServicesChannelsWebhooksV2#channel_sid}
  */
  readonly channelSid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/chat_services_channels_webhooks_v2#configuration_filters ChatServicesChannelsWebhooksV2#configuration_filters}
  */
  readonly configurationFilters?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/chat_services_channels_webhooks_v2#configuration_flow_sid ChatServicesChannelsWebhooksV2#configuration_flow_sid}
  */
  readonly configurationFlowSid?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/chat_services_channels_webhooks_v2#configuration_method ChatServicesChannelsWebhooksV2#configuration_method}
  */
  readonly configurationMethod?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/chat_services_channels_webhooks_v2#configuration_retry_count ChatServicesChannelsWebhooksV2#configuration_retry_count}
  */
  readonly configurationRetryCount?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/chat_services_channels_webhooks_v2#configuration_triggers ChatServicesChannelsWebhooksV2#configuration_triggers}
  */
  readonly configurationTriggers?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/chat_services_channels_webhooks_v2#configuration_url ChatServicesChannelsWebhooksV2#configuration_url}
  */
  readonly configurationUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/chat_services_channels_webhooks_v2#id ChatServicesChannelsWebhooksV2#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/chat_services_channels_webhooks_v2#service_sid ChatServicesChannelsWebhooksV2#service_sid}
  */
  readonly serviceSid: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/chat_services_channels_webhooks_v2#type ChatServicesChannelsWebhooksV2#type}
  */
  readonly type: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/chat_services_channels_webhooks_v2 twilio_chat_services_channels_webhooks_v2}
*/
export class ChatServicesChannelsWebhooksV2 extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "twilio_chat_services_channels_webhooks_v2";

  // ==============
  // STATIC Methods
  // ==============
  /**
  * Generates CDKTF code for importing a ChatServicesChannelsWebhooksV2 resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the ChatServicesChannelsWebhooksV2 to import
  * @param importFromId The id of the existing ChatServicesChannelsWebhooksV2 that should be imported. Refer to the {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/chat_services_channels_webhooks_v2#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ChatServicesChannelsWebhooksV2 to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "twilio_chat_services_channels_webhooks_v2", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/twilio/twilio/0.18.46/docs/resources/chat_services_channels_webhooks_v2 twilio_chat_services_channels_webhooks_v2} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ChatServicesChannelsWebhooksV2Config
  */
  public constructor(scope: Construct, id: string, config: ChatServicesChannelsWebhooksV2Config) {
    super(scope, id, {
      terraformResourceType: 'twilio_chat_services_channels_webhooks_v2',
