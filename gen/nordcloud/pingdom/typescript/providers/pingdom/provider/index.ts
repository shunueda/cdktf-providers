// https://registry.terraform.io/providers/nordcloud/pingdom/1.1.4/docs
...
export interface PingdomProviderConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pingdom/1.1.4/docs#api_token PingdomProvider#api_token}
  */
  readonly apiToken?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pingdom/1.1.4/docs#alias PingdomProvider#alias}
  */
  readonly alias?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nordcloud/pingdom/1.1.4/docs pingdom}
*/
export class PingdomProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing PingdomProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/nordcloud/pingdom/1.1.4/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nordcloud/pingdom/1.1.4/docs pingdom} Resource
  *
  * @param scope The scope in which to define this construct
