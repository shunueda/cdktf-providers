// https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/user_notification_rule
...
export interface UserNotificationRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/user_notification_rule#id UserNotificationRule#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/user_notification_rule#start_delay_in_minutes UserNotificationRule#start_delay_in_minutes}
  */
  readonly startDelayInMinutes: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/user_notification_rule#urgency UserNotificationRule#urgency}
  */
  readonly urgency: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/user_notification_rule#user_id UserNotificationRule#user_id}
  */
  readonly userId: string;
  /**
  * contact_method block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/user_notification_rule#contact_method UserNotificationRule#contact_method}
  */
...
export interface UserNotificationRuleContactMethod {
  ...
  */
  readonly id: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/user_notification_rule#type UserNotificationRule#type}
  */
  readonly type: string;
}

export function userNotificationRuleContactMethodToTerraform(struct?: UserNotificationRuleContactMethodOutputReference | UserNotificationRuleContactMethod): any {
...
export function userNotificationRuleContactMethodToHclTerraform(struct?: UserNotificationRuleContactMethodOutputReference | UserNotificationRuleContactMethod): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class UserNotificationRuleContactMethodOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): UserNotificationRuleContactMethod | undefined {
  ...
  public set internalValue(value: UserNotificationRuleContactMethod | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/user_notification_rule pagerduty_user_notification_rule}
*/
export class UserNotificationRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UserNotificationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/user_notification_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/user_notification_rule pagerduty_user_notification_rule} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      contact_method: {
        ...
        isBlock: true,
        type: "list",
        storageClassType: "UserNotificationRuleContactMethodList",
      },
    };
