// https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/data-sources/ruleset
...
export interface DataPagerdutyRulesetConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/data-sources/ruleset#id DataPagerdutyRuleset#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/data-sources/ruleset#name DataPagerdutyRuleset#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/data-sources/ruleset pagerduty_ruleset}
*/
export class DataPagerdutyRuleset extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyRuleset that should be imported. Refer to the {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/data-sources/ruleset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/data-sources/ruleset pagerduty_ruleset} Data Source
  *
  * @param scope The scope in which to define this construct
