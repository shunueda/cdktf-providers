// https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/automation_actions_runner
...
export interface AutomationActionsRunnerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/automation_actions_runner#description AutomationActionsRunner#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/automation_actions_runner#id AutomationActionsRunner#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/automation_actions_runner#last_seen AutomationActionsRunner#last_seen}
  */
  readonly lastSeen?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/automation_actions_runner#name AutomationActionsRunner#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/automation_actions_runner#runbook_api_key AutomationActionsRunner#runbook_api_key}
  */
  readonly runbookApiKey?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/automation_actions_runner#runbook_base_uri AutomationActionsRunner#runbook_base_uri}
  */
  readonly runbookBaseUri?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/automation_actions_runner#runner_type AutomationActionsRunner#runner_type}
  */
  readonly runnerType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/automation_actions_runner pagerduty_automation_actions_runner}
*/
export class AutomationActionsRunner extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutomationActionsRunner that should be imported. Refer to the {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/automation_actions_runner#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/automation_actions_runner pagerduty_automation_actions_runner} Resource
  *
  * @param scope The scope in which to define this construct
