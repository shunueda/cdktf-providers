// https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/data-sources/event_orchestration
...
export interface DataPagerdutyEventOrchestrationConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/data-sources/event_orchestration#id DataPagerdutyEventOrchestration#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/data-sources/event_orchestration#name DataPagerdutyEventOrchestration#name}
  */
  readonly name: string;
  /**
  * integration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/data-sources/event_orchestration#integration DataPagerdutyEventOrchestration#integration}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/data-sources/event_orchestration pagerduty_event_orchestration}
*/
export class DataPagerdutyEventOrchestration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataPagerdutyEventOrchestration that should be imported. Refer to the {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/data-sources/event_orchestration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/data-sources/event_orchestration pagerduty_event_orchestration} Data Source
  *
  * @param scope The scope in which to define this construct
