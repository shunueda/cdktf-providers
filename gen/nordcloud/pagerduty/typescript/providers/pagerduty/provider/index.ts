// https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs
...
export interface PagerdutyProviderConfig {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs#api_url_override PagerdutyProvider#api_url_override}
  */
  readonly apiUrlOverride?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs#service_region PagerdutyProvider#service_region}
  */
  readonly serviceRegion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs#skip_credentials_validation PagerdutyProvider#skip_credentials_validation}
  */
  readonly skipCredentialsValidation?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs#token PagerdutyProvider#token}
  */
  readonly token?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs#user_token PagerdutyProvider#user_token}
  */
  readonly userToken?: string;
  /**
  * Alias name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs#alias PagerdutyProvider#alias}
  */
  readonly alias?: string;
  /**
  * use_app_oauth_scoped_token block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs#use_app_oauth_scoped_token PagerdutyProvider#use_app_oauth_scoped_token}
  */
...
export interface PagerdutyProviderUseAppOauthScopedToken {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs#pd_client_id PagerdutyProvider#pd_client_id}
  */
  readonly pdClientId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs#pd_client_secret PagerdutyProvider#pd_client_secret}
  */
  readonly pdClientSecret?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs#pd_subdomain PagerdutyProvider#pd_subdomain}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs pagerduty}
*/
export class PagerdutyProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing PagerdutyProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs pagerduty} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: PagerdutyProviderConfig = {}) {
    super(scope, id, {
      ...
      terraformProviderSource: 'nordcloud/pagerduty'
    });
