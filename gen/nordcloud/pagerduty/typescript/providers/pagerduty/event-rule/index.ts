// https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/event_rule
...
export interface EventRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/event_rule#action_json EventRule#action_json}
  */
  readonly actionJson: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/event_rule#advanced_condition_json EventRule#advanced_condition_json}
  */
  readonly advancedConditionJson?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/event_rule#condition_json EventRule#condition_json}
  */
  readonly conditionJson: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/event_rule#id EventRule#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/event_rule pagerduty_event_rule}
*/
export class EventRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/event_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/event_rule pagerduty_event_rule} Resource
  *
  * @param scope The scope in which to define this construct
