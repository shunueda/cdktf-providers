// https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play
...
export interface ResponsePlayConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play#conference_number ResponsePlay#conference_number}
  */
  readonly conferenceNumber?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play#conference_url ResponsePlay#conference_url}
  */
  readonly conferenceUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play#description ResponsePlay#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play#from ResponsePlay#from}
  */
  readonly from: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play#id ResponsePlay#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play#name ResponsePlay#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play#responders_message ResponsePlay#responders_message}
  */
  readonly respondersMessage?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play#runnability ResponsePlay#runnability}
  */
  readonly runnability?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play#subscribers_message ResponsePlay#subscribers_message}
  */
  readonly subscribersMessage?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play#team ResponsePlay#team}
  */
  readonly team?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play#type ResponsePlay#type}
  */
  readonly type?: string;
  /**
  * responder block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play#responder ResponsePlay#responder}
  */
  readonly responder?: ResponsePlayResponder[] | cdktf.IResolvable;
  /**
  * subscriber block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play#subscriber ResponsePlay#subscriber}
  */
...
export interface ResponsePlayResponderTeams {
}

export function responsePlayResponderTeamsToTerraform(struct?: ResponsePlayResponderTeams): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function responsePlayResponderTeamsToHclTerraform(struct?: ResponsePlayResponderTeams): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ResponsePlayResponderTeamsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ResponsePlayResponderTeams | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ResponsePlayResponderTeams | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class ResponsePlayResponderTeamsList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): ResponsePlayResponderTeamsOutputReference {
    return new ResponsePlayResponderTeamsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ResponsePlayResponderOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _teams = new ResponsePlayResponderTeamsList(this, "teams", false);
  public get teams() {
    return this._teams;
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play pagerduty_response_play}
*/
export class ResponsePlay extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ResponsePlay that should be imported. Refer to the {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/response_play pagerduty_response_play} Resource
  *
  * @param scope The scope in which to define this construct
