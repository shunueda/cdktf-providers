// https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/business_service_subscriber
...
export interface BusinessServiceSubscriberConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/business_service_subscriber#business_service_id BusinessServiceSubscriber#business_service_id}
  */
  readonly businessServiceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/business_service_subscriber#id BusinessServiceSubscriber#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/business_service_subscriber#subscriber_id BusinessServiceSubscriber#subscriber_id}
  */
  readonly subscriberId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/business_service_subscriber#subscriber_type BusinessServiceSubscriber#subscriber_type}
  */
  readonly subscriberType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/business_service_subscriber pagerduty_business_service_subscriber}
*/
export class BusinessServiceSubscriber extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BusinessServiceSubscriber that should be imported. Refer to the {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/business_service_subscriber#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/nordcloud/pagerduty/4.1.2/docs/resources/business_service_subscriber pagerduty_business_service_subscriber} Resource
  *
  * @param scope The scope in which to define this construct
