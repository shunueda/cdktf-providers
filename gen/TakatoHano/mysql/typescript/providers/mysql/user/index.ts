// https://registry.terraform.io/providers/takatohano/mysql/1.2.1/docs/resources/user
...
export interface UserConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/takatohano/mysql/1.2.1/docs/resources/user#auth_plugin User#auth_plugin}
  */
  readonly authPlugin?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/takatohano/mysql/1.2.1/docs/resources/user#host User#host}
  */
  readonly host?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/takatohano/mysql/1.2.1/docs/resources/user#id User#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/takatohano/mysql/1.2.1/docs/resources/user#password User#password}
  */
  readonly password?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/takatohano/mysql/1.2.1/docs/resources/user#plaintext_password User#plaintext_password}
  */
  readonly plaintextPassword?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/takatohano/mysql/1.2.1/docs/resources/user#tls_option User#tls_option}
  */
  readonly tlsOption?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/takatohano/mysql/1.2.1/docs/resources/user#user User#user}
  */
  readonly user: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/takatohano/mysql/1.2.1/docs/resources/user mysql_user}
*/
export class User extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing User that should be imported. Refer to the {@link https://registry.terraform.io/providers/takatohano/mysql/1.2.1/docs/resources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/takatohano/mysql/1.2.1/docs/resources/user mysql_user} Resource
  *
  * @param scope The scope in which to define this construct
