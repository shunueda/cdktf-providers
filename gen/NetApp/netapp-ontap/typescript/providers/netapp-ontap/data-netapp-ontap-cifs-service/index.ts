// https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cifs_service
...
export interface DataNetappOntapCifsServiceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cifs_service#cx_profile_name DataNetappOntapCifsService#cx_profile_name}
  */
  readonly cxProfileName: string;
  /**
  * Name of the CIFS server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cifs_service#name DataNetappOntapCifsService#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cifs_service netapp-ontap_cifs_service}
*/
export class DataNetappOntapCifsService extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetappOntapCifsService that should be imported. Refer to the {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cifs_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cifs_service netapp-ontap_cifs_service} Data Source
  *
  * @param scope The scope in which to define this construct
