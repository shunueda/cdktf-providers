// https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cluster_schedule
...
export interface DataNetappOntapClusterScheduleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cluster_schedule#cx_profile_name DataNetappOntapClusterSchedule#cx_profile_name}
  */
  readonly cxProfileName: string;
  /**
  * Schedule name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cluster_schedule#name DataNetappOntapClusterSchedule#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cluster_schedule netapp-ontap_cluster_schedule}
*/
export class DataNetappOntapClusterSchedule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetappOntapClusterSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cluster_schedule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cluster_schedule netapp-ontap_cluster_schedule} Data Source
  *
  * @param scope The scope in which to define this construct
