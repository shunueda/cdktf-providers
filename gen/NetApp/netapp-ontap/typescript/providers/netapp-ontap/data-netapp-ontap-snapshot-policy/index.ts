// https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/snapshot_policy
...
export interface DataNetappOntapSnapshotPolicyConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/snapshot_policy#cx_profile_name DataNetappOntapSnapshotPolicy#cx_profile_name}
  */
  readonly cxProfileName: string;
  /**
  * SnapshotPolicy name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/snapshot_policy#name DataNetappOntapSnapshotPolicy#name}
  */
...
export interface DataNetappOntapSnapshotPolicyCopies {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/snapshot_policy#schedule DataNetappOntapSnapshotPolicy#schedule}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/snapshot_policy netapp-ontap_snapshot_policy}
*/
export class DataNetappOntapSnapshotPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetappOntapSnapshotPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/snapshot_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/snapshot_policy netapp-ontap_snapshot_policy} Data Source
  *
  * @param scope The scope in which to define this construct
