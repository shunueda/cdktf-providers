...
export interface ClusterScheduleCron {
  /**
...
export function clusterScheduleCronToTerraform(struct?: ClusterScheduleCron | cdktf.IResolvable): any {
...
export function clusterScheduleCronToHclTerraform(struct?: ClusterScheduleCron | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ClusterScheduleCronOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ClusterScheduleCron | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ClusterScheduleCron | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ClusterSchedule extends cdktf.TerraformResource {
  ...
  * @param options ClusterScheduleConfig
  */
  public constructor(scope: Construct, id: string, config: ClusterScheduleConfig) {
    super(scope, id, {
  ...
  private _cron = new ClusterScheduleCronOutputReference(this, "cron");
  public get cron() {
    return this._cron;
  }
  public putCron(value: ClusterScheduleCron) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      cron: clusterScheduleCronToTerraform(this._cron.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      cron: {
        value: clusterScheduleCronToHclTerraform(this._cron.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ClusterScheduleCron",
      },
      cx_profile_name: {
