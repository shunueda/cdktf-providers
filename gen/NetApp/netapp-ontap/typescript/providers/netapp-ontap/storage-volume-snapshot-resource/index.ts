...
export interface StorageVolumeSnapshotResourceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Comment
  *
...
export class StorageVolumeSnapshotResource extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "netapp-ontap_storage_volume_snapshot_resource";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "netapp-ontap_storage_volume_snapshot_resource", importId: importFromId, provider });
      }
  ...
  * @param options StorageVolumeSnapshotResourceConfig
  */
  public constructor(scope: Construct, id: string, config: StorageVolumeSnapshotResourceConfig) {
    super(scope, id, {
