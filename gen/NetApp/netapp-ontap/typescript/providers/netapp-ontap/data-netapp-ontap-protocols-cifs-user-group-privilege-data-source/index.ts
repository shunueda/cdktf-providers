// https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/protocols_cifs_user_group_privilege_data_source
...
export interface DataNetappOntapProtocolsCifsUserGroupPrivilegeDataSourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/protocols_cifs_user_group_privilege_data_source#cx_profile_name DataNetappOntapProtocolsCifsUserGroupPrivilegeDataSource#cx_profile_name}
  */
  readonly cxProfileName: string;
  /**
  * CifsUserGroupPrivilege name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/protocols_cifs_user_group_privilege_data_source#name DataNetappOntapProtocolsCifsUserGroupPrivilegeDataSource#name}
  */
  readonly name: string;
  /**
  * IPInterface svm name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/protocols_cifs_user_group_privilege_data_source#svm_name DataNetappOntapProtocolsCifsUserGroupPrivilegeDataSource#svm_name}
  */
  readonly svmName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/protocols_cifs_user_group_privilege_data_source netapp-ontap_protocols_cifs_user_group_privilege_data_source}
*/
export class DataNetappOntapProtocolsCifsUserGroupPrivilegeDataSource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetappOntapProtocolsCifsUserGroupPrivilegeDataSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/protocols_cifs_user_group_privilege_data_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/protocols_cifs_user_group_privilege_data_source netapp-ontap_protocols_cifs_user_group_privilege_data_source} Data Source
  *
  * @param scope The scope in which to define this construct
