// https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/nfs_export_policy_rule
...
export interface DataNetappOntapNfsExportPolicyRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/nfs_export_policy_rule#cx_profile_name DataNetappOntapNfsExportPolicyRule#cx_profile_name}
  */
  readonly cxProfileName: string;
  /**
  * Export policy name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/nfs_export_policy_rule#export_policy_name DataNetappOntapNfsExportPolicyRule#export_policy_name}
  */
  readonly exportPolicyName: string;
  /**
  * rule index
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/nfs_export_policy_rule#index DataNetappOntapNfsExportPolicyRule#index}
  */
  readonly index: number;
  /**
  * Name of the svm to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/nfs_export_policy_rule#svm_name DataNetappOntapNfsExportPolicyRule#svm_name}
  */
  readonly svmName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/nfs_export_policy_rule netapp-ontap_nfs_export_policy_rule}
*/
export class DataNetappOntapNfsExportPolicyRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetappOntapNfsExportPolicyRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/nfs_export_policy_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/nfs_export_policy_rule netapp-ontap_nfs_export_policy_rule} Data Source
  *
  * @param scope The scope in which to define this construct
