...
export interface ExampleConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class Example extends cdktf.TerraformResource {
  ...
  * @param options ExampleConfig = {}
  */
  public constructor(scope: Construct, id: string, config: ExampleConfig = {}) {
    super(scope, id, {
