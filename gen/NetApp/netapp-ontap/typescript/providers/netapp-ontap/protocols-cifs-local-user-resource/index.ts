...
export interface ProtocolsCifsLocalUserResourceConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function protocolsCifsLocalUserResourceMembershipToTerraform(struct?: ProtocolsCifsLocalUserResourceMembership): any {
...
export function protocolsCifsLocalUserResourceMembershipToHclTerraform(struct?: ProtocolsCifsLocalUserResourceMembership): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ProtocolsCifsLocalUserResourceMembershipOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ProtocolsCifsLocalUserResourceMembership | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ProtocolsCifsLocalUserResourceMembership | undefined) {
    if (value === undefined) {
...
export class ProtocolsCifsLocalUserResourceMembershipList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): ProtocolsCifsLocalUserResourceMembershipOutputReference {
    return new ProtocolsCifsLocalUserResourceMembershipOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ProtocolsCifsLocalUserResource extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "netapp-ontap_protocols_cifs_local_user_resource";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "netapp-ontap_protocols_cifs_local_user_resource", importId: importFromId, provider });
      }
  ...
  * @param options ProtocolsCifsLocalUserResourceConfig
  */
  public constructor(scope: Construct, id: string, config: ProtocolsCifsLocalUserResourceConfig) {
    super(scope, id, {
  ...
  private _membership = new ProtocolsCifsLocalUserResourceMembershipList(this, "membership", true);
