// https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service
...
export interface CifsServiceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Ad domain
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#ad_domain CifsService#ad_domain}
  */
  readonly adDomain: CifsServiceAdDomain;
  /**
  * Text comment of up to 48 characters about the CIFS server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#comment CifsService#comment}
  */
  readonly comment?: string;
  /**
  * Connection profile name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#cx_profile_name CifsService#cx_profile_name}
  */
  readonly cxProfileName: string;
  /**
  * Default unix user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#default_unix_user CifsService#default_unix_user}
  */
  readonly defaultUnixUser?: string;
  /**
  * Specifies if the CIFS service is administratively enabled
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#enabled CifsService#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Specifies if the CIFS service is administratively enabled (9.11)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#force CifsService#force}
  */
  readonly force?: boolean | cdktf.IResolvable;
  /**
  * CifsService name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#name CifsService#name}
  */
  readonly name: string;
  /**
  * Netbios
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#netbios CifsService#netbios}
  */
  readonly netbios?: CifsServiceNetbios;
  /**
  * Security
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#security CifsService#security}
  */
  readonly security?: CifsServiceSecurity;
  /**
  * CifsService svm name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#svm_name CifsService#svm_name}
  */
  readonly svmName: string;
}
export interface CifsServiceAdDomain {
  /**
  *  Fully qualified domain name of the Windows Active Directory to which this CIFS server belongs
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#fqdn CifsService#fqdn}
  */
  readonly fqdn: string;
  /**
  * Organizational unit
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#organizational_unit CifsService#organizational_unit}
  */
  readonly organizationalUnit?: string;
  /**
  * Account password used to add this CIFS server to the Active Directory
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#password CifsService#password}
  */
  readonly password: string;
  /**
  * User account with the access to add the CIFS server to the Active Directory
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#user CifsService#user}
  */
  readonly user: string;
}

export function cifsServiceAdDomainToTerraform(struct?: CifsServiceAdDomain | cdktf.IResolvable): any {
...
export function cifsServiceAdDomainToHclTerraform(struct?: CifsServiceAdDomain | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CifsServiceAdDomainOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CifsServiceAdDomain | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: CifsServiceAdDomain | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export interface CifsServiceNetbios {
  /**
  * list of one or more NetBIOS aliases for the CIFS server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#aliases CifsService#aliases}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#wins_servers CifsService#wins_servers}
  */
  readonly winsServers?: string[];
}

export function cifsServiceNetbiosToTerraform(struct?: CifsServiceNetbios | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function cifsServiceNetbiosToHclTerraform(struct?: CifsServiceNetbios | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CifsServiceNetbiosOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): CifsServiceNetbios | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: CifsServiceNetbios | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export interface CifsServiceSecurity {
  /**
  * List of advertised KDC encryptions (9.12)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#advertised_kdc_encryptions CifsService#advertised_kdc_encryptions}
  */
  readonly advertisedKdcEncryptions?: string[];
  /**
  * An AES session key is enabled for the Netlogon channel (9.10)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#aes_netlogon_enabled CifsService#aes_netlogon_enabled}
  */
  readonly aesNetlogonEnabled?: boolean | cdktf.IResolvable;
  /**
  * Encryption is required for domain controller connections (9.8)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#encrypt_dc_connection CifsService#encrypt_dc_connection}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#kdc_encryption CifsService#kdc_encryption}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#ldap_referral_enabled CifsService#ldap_referral_enabled}
  */
  readonly ldapReferralEnabled?: boolean | cdktf.IResolvable;
  /**
  * CIFS server minimum security level
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#lm_compatibility_level CifsService#lm_compatibility_level}
  */
  readonly lmCompatibilityLevel?: string;
  /**
  * Specifies what level of access an anonymous user is granted
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#restrict_anonymous CifsService#restrict_anonymous}
  */
  readonly restrictAnonymous?: string;
  /**
  * Client session security for AD LDAP connections (9.10)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#session_security CifsService#session_security}
  */
  readonly sessionSecurity?: string;
  /**
  * Specifies if encryption is required for incoming CIFS traffic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#smb_encryption CifsService#smb_encryption}
  */
  readonly smbEncryption?: boolean | cdktf.IResolvable;
  /**
  * Specifies if signing is required for incoming CIFS traffic
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#smb_signing CifsService#smb_signing}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#try_ldap_channel_binding CifsService#try_ldap_channel_binding}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#use_ldaps CifsService#use_ldaps}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#use_start_tls CifsService#use_start_tls}
  */
  readonly useStartTls?: boolean | cdktf.IResolvable;
}

export function cifsServiceSecurityToTerraform(struct?: CifsServiceSecurity | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function cifsServiceSecurityToHclTerraform(struct?: CifsServiceSecurity | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CifsServiceSecurityOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): CifsServiceSecurity | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: CifsServiceSecurity | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
/**
* Represents a {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service netapp-ontap_cifs_service}
*/
export class CifsService extends cdktf.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTF code for importing a CifsService resource upon running "cdktf plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the CifsService to import
  * @param importFromId The id of the existing CifsService that should be imported. Refer to the {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the CifsService to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/cifs_service netapp-ontap_cifs_service} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options CifsServiceConfig
  */
  public constructor(scope: Construct, id: string, config: CifsServiceConfig) {
    super(scope, id, {
  ...
  private _adDomain = new CifsServiceAdDomainOutputReference(this, "ad_domain");
  public get adDomain() {
    return this._adDomain;
  }
  public putAdDomain(value: CifsServiceAdDomain) {
  ...
  private _netbios = new CifsServiceNetbiosOutputReference(this, "netbios");
  public get netbios() {
    return this._netbios;
  }
  public putNetbios(value: CifsServiceNetbios) {
  ...
  private _security = new CifsServiceSecurityOutputReference(this, "security");
  public get security() {
    return this._security;
  }
  public putSecurity(value: CifsServiceSecurity) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ad_domain: cifsServiceAdDomainToTerraform(this._adDomain.internalValue),
      ...
      netbios: cifsServiceNetbiosToTerraform(this._netbios.internalValue),
      security: cifsServiceSecurityToTerraform(this._security.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ad_domain: {
        value: cifsServiceAdDomainToHclTerraform(this._adDomain.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "CifsServiceAdDomain",
      },
      comment: {
      ...
      netbios: {
        value: cifsServiceNetbiosToHclTerraform(this._netbios.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "CifsServiceNetbios",
      },
      security: {
        value: cifsServiceSecurityToHclTerraform(this._security.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "CifsServiceSecurity",
      },
      svm_name: {
