...
export interface ProtocolsCifsShareResourceAcls {
  /**
...
export function protocolsCifsShareResourceAclsToTerraform(struct?: ProtocolsCifsShareResourceAcls | cdktf.IResolvable): any {
...
export function protocolsCifsShareResourceAclsToHclTerraform(struct?: ProtocolsCifsShareResourceAcls | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ProtocolsCifsShareResourceAclsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ProtocolsCifsShareResourceAcls | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ProtocolsCifsShareResourceAcls | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ProtocolsCifsShareResourceAclsList extends cdktf.ComplexList {
  public internalValue? : ProtocolsCifsShareResourceAcls[] | cdktf.IResolvable
  ...
  */
  public get(index: number): ProtocolsCifsShareResourceAclsOutputReference {
    return new ProtocolsCifsShareResourceAclsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class ProtocolsCifsShareResource extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "netapp-ontap_protocols_cifs_share_resource";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "netapp-ontap_protocols_cifs_share_resource", importId: importFromId, provider });
      }
  ...
  * @param options ProtocolsCifsShareResourceConfig
  */
  public constructor(scope: Construct, id: string, config: ProtocolsCifsShareResourceConfig) {
    super(scope, id, {
  ...
  public putAcls(value: ProtocolsCifsShareResourceAcls[] | cdktf.IResolvable) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      acls: {
        ...
        isBlock: true,
        type: "set",
        storageClassType: "ProtocolsCifsShareResourceAclsList",
      },
      change_notify: {
