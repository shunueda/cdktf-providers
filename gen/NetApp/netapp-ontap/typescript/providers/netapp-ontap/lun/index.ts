// https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/lun
...
export interface LunConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/lun#cx_profile_name Lun#cx_profile_name}
  */
  readonly cxProfileName: string;
  /**
  * The base name component of the LUN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/lun#logical_unit Lun#logical_unit}
  */
  readonly logicalUnit?: string;
  /**
  * Path for the LUN you want to create or modify. Example of correct LUN path: /vol/vol1/lun1
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/lun#name Lun#name}
  */
  readonly name?: string;
  /**
  * The operating system type of the LUN
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/lun#os_type Lun#os_type}
  */
  readonly osType: string;
  /**
  * QoS policy name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/lun#qos_policy_name Lun#qos_policy_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/lun#scsi_thin_provisioning_support_enabled Lun#scsi_thin_provisioning_support_enabled}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/lun#size Lun#size}
  */
  readonly size: number;
  /**
  * The unit used to interpret the size parameter
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/lun#size_unit Lun#size_unit}
  */
  readonly sizeUnit?: string;
  /**
  * The name of the SVM in which the LUN is located
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/lun#svm_name Lun#svm_name}
  */
  readonly svmName: string;
  /**
  * The volume in which the LUN is located
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/lun#volume_name Lun#volume_name}
  */
  readonly volumeName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/lun netapp-ontap_lun}
*/
export class Lun extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lun that should be imported. Refer to the {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/lun#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/lun netapp-ontap_lun} Resource
  *
  * @param scope The scope in which to define this construct
