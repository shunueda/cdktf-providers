...
export interface NameServicesLdapConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class NameServicesLdap extends cdktf.TerraformResource {
  ...
  * @param options NameServicesLdapConfig
  */
  public constructor(scope: Construct, id: string, config: NameServicesLdapConfig) {
    super(scope, id, {
