// https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/resources/cluster_licensing_license_resource
...
export interface ClusterLicensingLicenseResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/resources/cluster_licensing_license_resource#cx_profile_name ClusterLicensingLicenseResource#cx_profile_name}
  */
  readonly cxProfileName: string;
  /**
  * List of NLF or 26-character keys
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/resources/cluster_licensing_license_resource#keys ClusterLicensingLicenseResource#keys}
  */
  readonly keys: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/resources/cluster_licensing_license_resource netapp-ontap_cluster_licensing_license_resource}
*/
export class ClusterLicensingLicenseResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusterLicensingLicenseResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/resources/cluster_licensing_license_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/resources/cluster_licensing_license_resource netapp-ontap_cluster_licensing_license_resource} Resource
  *
  * @param scope The scope in which to define this construct
