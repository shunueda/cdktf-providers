// https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource
...
export interface StorageAggregateResourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource#cx_profile_name StorageAggregateResource#cx_profile_name}
  */
  readonly cxProfileName: string;
  /**
  * Class of disk to use to build aggregate. capacity_flash is listed in swagger, but rejected as invalid by ONTAP.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource#disk_class StorageAggregateResource#disk_class}
  */
  ...
  * 				
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource#disk_count StorageAggregateResource#disk_count}
  */
  readonly diskCount: number;
  /**
  * Disk size to use in 4K block size.  Disks within 10 precent of specified size will be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource#disk_size StorageAggregateResource#disk_size}
  */
  readonly diskSize?: number;
  /**
  * Disk size to use in the specified unit. This is converted to bytes, assuming K=1024.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource#disk_size_unit StorageAggregateResource#disk_size_unit}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource#encryption StorageAggregateResource#encryption}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource#is_mirrored StorageAggregateResource#is_mirrored}
  */
  readonly isMirrored?: boolean | cdktf.IResolvable;
  /**
  * The name of the aggregate to manage
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource#name StorageAggregateResource#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource#node StorageAggregateResource#node}
  */
  readonly nodeAttribute: string;
  /**
  * Sets the maximum number of drives per raid group.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource#raid_size StorageAggregateResource#raid_size}
  */
  readonly raidSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource#raid_type StorageAggregateResource#raid_type}
  */
  readonly raidType?: string;
  /**
  * Type of snaplock for the aggregate being created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource#snaplock_type StorageAggregateResource#snaplock_type}
  */
  readonly snaplockType?: string;
  /**
  * Whether the specified aggregate should be enabled or disabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource#state StorageAggregateResource#state}
  */
  readonly state?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource netapp-ontap_storage_aggregate_resource}
*/
export class StorageAggregateResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageAggregateResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.3.0/docs/resources/storage_aggregate_resource netapp-ontap_storage_aggregate_resource} Resource
  *
  * @param scope The scope in which to define this construct
