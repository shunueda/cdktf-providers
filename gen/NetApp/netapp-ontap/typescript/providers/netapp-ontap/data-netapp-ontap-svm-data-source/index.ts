// https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/svm_data_source
...
export interface DataNetappOntapSvmDataSourceConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/svm_data_source#cx_profile_name DataNetappOntapSvmDataSource#cx_profile_name}
  */
  readonly cxProfileName: string;
  /**
  * Svm name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/svm_data_source#name DataNetappOntapSvmDataSource#name}
  */
  readonly name: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/svm_data_source netapp-ontap_svm_data_source}
*/
export class DataNetappOntapSvmDataSource extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetappOntapSvmDataSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/svm_data_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/svm_data_source netapp-ontap_svm_data_source} Data Source
  *
  * @param scope The scope in which to define this construct
