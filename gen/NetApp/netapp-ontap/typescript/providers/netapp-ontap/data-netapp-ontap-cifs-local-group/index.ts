...
export interface DataNetappOntapCifsLocalGroupConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataNetappOntapCifsLocalGroupMembers {
}

export function dataNetappOntapCifsLocalGroupMembersToTerraform(struct?: DataNetappOntapCifsLocalGroupMembers): any {
...
export function dataNetappOntapCifsLocalGroupMembersToHclTerraform(struct?: DataNetappOntapCifsLocalGroupMembers): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataNetappOntapCifsLocalGroupMembersOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataNetappOntapCifsLocalGroupMembers | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataNetappOntapCifsLocalGroupMembers | undefined) {
    if (value === undefined) {
...
export class DataNetappOntapCifsLocalGroupMembersList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataNetappOntapCifsLocalGroupMembersOutputReference {
    return new DataNetappOntapCifsLocalGroupMembersOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataNetappOntapCifsLocalGroup extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "netapp-ontap_cifs_local_group";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "netapp-ontap_cifs_local_group", importId: importFromId, provider });
      }
  ...
  * @param options DataNetappOntapCifsLocalGroupConfig
  */
  public constructor(scope: Construct, id: string, config: DataNetappOntapCifsLocalGroupConfig) {
    super(scope, id, {
  ...
  private _members = new DataNetappOntapCifsLocalGroupMembersList(this, "members", false);
  public get members() {
