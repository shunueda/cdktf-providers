...
export interface DataNetappOntapSnapmirrorPolicyDataSourceConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface DataNetappOntapSnapmirrorPolicyDataSourceRetention {
}

export function dataNetappOntapSnapmirrorPolicyDataSourceRetentionToTerraform(struct?: DataNetappOntapSnapmirrorPolicyDataSourceRetention): any {
...
export function dataNetappOntapSnapmirrorPolicyDataSourceRetentionToHclTerraform(struct?: DataNetappOntapSnapmirrorPolicyDataSourceRetention): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataNetappOntapSnapmirrorPolicyDataSourceRetentionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataNetappOntapSnapmirrorPolicyDataSourceRetention | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataNetappOntapSnapmirrorPolicyDataSourceRetention | undefined) {
    if (value === undefined) {
...
export class DataNetappOntapSnapmirrorPolicyDataSourceRetentionList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataNetappOntapSnapmirrorPolicyDataSourceRetentionOutputReference {
    return new DataNetappOntapSnapmirrorPolicyDataSourceRetentionOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataNetappOntapSnapmirrorPolicyDataSource extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "netapp-ontap_snapmirror_policy_data_source";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "netapp-ontap_snapmirror_policy_data_source", importId: importFromId, provider });
      }
  ...
  * @param options DataNetappOntapSnapmirrorPolicyDataSourceConfig
  */
  public constructor(scope: Construct, id: string, config: DataNetappOntapSnapmirrorPolicyDataSourceConfig) {
    super(scope, id, {
  ...
  private _retention = new DataNetappOntapSnapmirrorPolicyDataSourceRetentionList(this, "retention", false);
