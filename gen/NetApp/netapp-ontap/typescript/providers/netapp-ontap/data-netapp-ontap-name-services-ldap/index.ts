// https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/name_services_ldap
...
export interface DataNetappOntapNameServicesLdapConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/name_services_ldap#cx_profile_name DataNetappOntapNameServicesLdap#cx_profile_name}
  */
  readonly cxProfileName: string;
  /**
  * IPInterface svm name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/name_services_ldap#svm_name DataNetappOntapNameServicesLdap#svm_name}
  */
  readonly svmName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/name_services_ldap netapp-ontap_name_services_ldap}
*/
export class DataNetappOntapNameServicesLdap extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetappOntapNameServicesLdap that should be imported. Refer to the {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/name_services_ldap#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/name_services_ldap netapp-ontap_name_services_ldap} Data Source
  *
  * @param scope The scope in which to define this construct
