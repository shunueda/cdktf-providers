...
export interface NetworkingIpRouteResourceConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function networkingIpRouteResourceDestinationToTerraform(struct?: NetworkingIpRouteResourceDestination | cdktf.IResolvable): any {
...
export function networkingIpRouteResourceDestinationToHclTerraform(struct?: NetworkingIpRouteResourceDestination | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class NetworkingIpRouteResourceDestinationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NetworkingIpRouteResourceDestination | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: NetworkingIpRouteResourceDestination | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class NetworkingIpRouteResource extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "netapp-ontap_networking_ip_route_resource";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "netapp-ontap_networking_ip_route_resource", importId: importFromId, provider });
      }
  ...
  * @param options NetworkingIpRouteResourceConfig
  */
  public constructor(scope: Construct, id: string, config: NetworkingIpRouteResourceConfig) {
    super(scope, id, {
  ...
  private _destination = new NetworkingIpRouteResourceDestinationOutputReference(this, "destination");
  public get destination() {
    return this._destination;
  }
  public putDestination(value: NetworkingIpRouteResourceDestination) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      destination: networkingIpRouteResourceDestinationToTerraform(this._destination.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      destination: {
        value: networkingIpRouteResourceDestinationToHclTerraform(this._destination.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "NetworkingIpRouteResourceDestination",
      },
      gateway: {
