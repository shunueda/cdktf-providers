// https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cifs_user_group_privilege
...
export interface DataNetappOntapCifsUserGroupPrivilegeConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cifs_user_group_privilege#cx_profile_name DataNetappOntapCifsUserGroupPrivilege#cx_profile_name}
  */
  readonly cxProfileName: string;
  /**
  * CifsUserGroupPrivilege name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cifs_user_group_privilege#name DataNetappOntapCifsUserGroupPrivilege#name}
  */
  readonly name: string;
  /**
  * IPInterface svm name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cifs_user_group_privilege#svm_name DataNetappOntapCifsUserGroupPrivilege#svm_name}
  */
  readonly svmName: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cifs_user_group_privilege netapp-ontap_cifs_user_group_privilege}
*/
export class DataNetappOntapCifsUserGroupPrivilege extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNetappOntapCifsUserGroupPrivilege that should be imported. Refer to the {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cifs_user_group_privilege#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/netapp/netapp-ontap/2.4.0/docs/data-sources/cifs_user_group_privilege netapp-ontap_cifs_user_group_privilege} Data Source
  *
  * @param scope The scope in which to define this construct
