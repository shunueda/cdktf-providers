...
export interface DataNetappOntapProtocolsNfsExportPolicyRuleDataSourceConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DataNetappOntapProtocolsNfsExportPolicyRuleDataSource extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "netapp-ontap_protocols_nfs_export_policy_rule_data_source";
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "netapp-ontap_protocols_nfs_export_policy_rule_data_source", importId: importFromId, provider });
      }
  ...
  * @param options DataNetappOntapProtocolsNfsExportPolicyRuleDataSourceConfig
  */
  public constructor(scope: Construct, id: string, config: DataNetappOntapProtocolsNfsExportPolicyRuleDataSourceConfig) {
    super(scope, id, {
